 ...
 *     queries</a>
 */
public class StructuredQuery<V extends java.lang.Object> extends Query<V> {
  ...
  public static final class CompositeFilter extends Filter {
    ...
    @Override protected com.google.datastore.v1beta3.Filter toPb() {
  ...
  public static final class PropertyFilter extends Filter {
    ...
    @Override public boolean equals(Object obj) {
      ...
      return property.equals(other.property) && operator == other.operator && Objects.equals(value, other.value);
    }
  ...
  public static final class OrderBy implements Serializable {
    ...
    @Override public boolean equals(Object obj) {
      ...
      return property.equals(other.property) && direction == other.direction;
    }
  ...
  static class BaseBuilder<V extends java.lang.Object, B extends BaseBuilder<V, B>> {
    ...
    @SuppressWarnings(value = { "unchecked" }) B self() {
      return (B) this;
    }
  ...
  static final class Builder<V extends java.lang.Object> extends BaseBuilder<V, Builder<V>> {
  ...
  public static final class EntityQueryBuilder extends BaseBuilder<Entity, EntityQueryBuilder> {
    ...
    @Override public StructuredQuery<Entity> build() {
      return new StructuredQuery<>(this);
    }
  }
  ...
  public static final class KeyQueryBuilder extends BaseBuilder<Key, KeyQueryBuilder> {
    ...
    @Override protected KeyQueryBuilder mergeFrom(com.google.datastore.v1beta3.Query queryPb) {
    ...
    @Override public StructuredQuery<Key> build() {
      return new StructuredQuery<>(this);
    }
  }
  ...
  public static final class ProjectionEntityQueryBuilder extends BaseBuilder<ProjectionEntity, ProjectionEntityQueryBuilder> {
    ...
    @Override public StructuredQuery<ProjectionEntity> build() {
      return new StructuredQuery<>(this);
    }

    @Override public ProjectionEntityQueryBuilder clearProjection() {
      return super.clearProjection();
    }

    @Override public ProjectionEntityQueryBuilder projection(String projection, String... others) {
      return super.projection(projection, others);
    }

    @Override public ProjectionEntityQueryBuilder addProjection(String projection, String... others) {
      return super.addProjection(projection, others);
    }

    @Override public ProjectionEntityQueryBuilder clearDistinctOn() {
      return super.clearDistinctOn();
    }

    @Override public ProjectionEntityQueryBuilder distinctOn(String property, String... others) {
      return super.distinctOn(property, others);
    }

    @Override public ProjectionEntityQueryBuilder addDistinctOn(String property, String... others) {
  ...
  @Override protected void populatePb(com.google.datastore.v1beta3.RunQueryRequest.Builder requestPb) {
    requestPb.setQuery(toPb());
  }

  @Override protected Query<V> nextQuery(com.google.datastore.v1beta3.RunQueryResponse responsePb) {
  ...
  @Override protected com.google.datastore.v1beta3.Query toPb() {
  ...
  @Override protected Object fromPb(ResultType<V> resultType, String namespace, byte[] bytesPb) throws InvalidProtocolBufferException {
    return fromPb(resultType, namespace, com.google.datastore.v1beta3.Query.parseFrom(bytesPb));
  }

  @SuppressWarnings(value = { "unchecked" }) static <V extends java.lang.Object> StructuredQuery<V> fromPb(ResultType<?> resultType, String namespace, com.google.datastore.v1beta3.Query queryPb) {
    BaseBuilder<?, ?> builder;
    if (resultType.equals(ResultType.ENTITY)) {
      builder = new EntityQueryBuilder();
    } else {
      if (resultType.equals(ResultType.KEY)) {
