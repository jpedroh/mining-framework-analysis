...
public class DatastoreOptionsTest {
  ...
  @Before public void setUp() throws IOException, InterruptedException {
    ...
    options = DatastoreOptions.builder().normalizeDataset(false).serviceRpcFactory(datastoreRpcFactory).projectId(PROJECT_ID).host("http://localhost:" + PORT);
  ...
  @Test public void testProjectId() throws Exception {
