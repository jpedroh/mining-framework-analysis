...
@Service public class LitemallAdminService {
  private final Column[] result = new Column[] { Column.id, Column.username, Column.avatar };

  @Resource private LitemallAdminMapper adminMapper;

  @Resource private LitemallAdminRoleMapper adminRoleMapper;

  @Resource private LitemallRoleResourceMapper roleResourceMapper;

  @Resource private LitemallResourceMapper resourceMapper;
