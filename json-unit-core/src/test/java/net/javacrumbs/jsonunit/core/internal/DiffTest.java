...
public class DiffTest {
  ...
  @Test public void testGetStartNodeRoot() throws IOException {
  ...
  @Test public void testGetStartNodeSimple() throws IOException {
  ...
  @Test public void testGetStartNodeTwoSteps() throws IOException {
  ...
  @Test public void testGetStartNodeArrays() throws IOException {
  ...
  @Test public void testGetStartNodeArrays2() throws IOException {
  ...
  @Test public void testGetStartNodeArraysRootComplex() throws IOException {
    JsonNode startNode = Diff.getStartNode(MAPPER.readTree("[{\"values\":[1,2]}, {\"values\":[3,4]}]"), "[1].values[1]");
    assertEquals("4", MAPPER.writeValueAsString(startNode));
  }

  @Test public void testGetStartNodeArraysConvoluted() throws IOException {
    JsonNode startNode = Diff.getStartNode(MAPPER.readTree("{\"test\":[{\"values\":[1,2]}, {\"values\":[3,4]}]}"), "test.[1].values.[1]");
    assertEquals("4", MAPPER.writeValueAsString(startNode));
  }

  @Test public void testGetStartNodeArraysRoot() throws IOException {
    JsonNode startNode = Diff.getStartNode(MAPPER.readTree("[1,2]"), "[0]");
    assertEquals("1", MAPPER.writeValueAsString(startNode));
  }

  @Test public void testGetStartNodeNonexisting() throws IOException {
