...
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/06954336878e4182eeda187689589623367e26e7/integration-test/src/test/java/org/cloudfoundry/uaa/TokensTest.java/left.java
    flatMap((token) -> this.uaaClient.tokens().check(CheckTokenRequest.builder().token(token).clientId(this.clientId).clientSecret(this.clientSecret).scope("password.write", "scim.userids").build()))
=======
    then((token) -> this.uaaClient.tokens().check(CheckTokenRequest.builder().token(token).clientId(this.clientId).clientSecret(this.clientSecret).scopes("password.write", "scim.userids").build()))
>>>>>>> /usr/src/app/output/cloudfoundry/cf-java-client/06954336878e4182eeda187689589623367e26e7/integration-test/src/test/java/org/cloudfoundry/uaa/TokensTest.java/right.java
