...
public final class UsersTest extends AbstractIntegrationTest {
  ...
  @IfCloudFoundryVersion(greaterThanOrEqualTo = CloudFoundryVersion.PCF_1_10) @Test public void expirePassword() {
    String userName = this.nameFactory.getUserName();
  ...
  @IfCloudFoundryVersion(equalTo = CloudFoundryVersion.PCF_1_9) @Test public void expirePassword19() {
    String userName = this.nameFactory.getUserName();
