...
public final class ApplicationsTest extends AbstractIntegrationTest {
  ...
  @Test public void deleteApplicationAndRoutes() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void deleteApplicationWithServiceBindings() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void getEvents() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void getHealthCheck() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void getManifest() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @IfCloudFoundryVersion(greaterThanOrEqualTo = CloudFoundryVersion.PCF_1_11) @Test public void listTasks() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void pushExisting() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    createApplication(this.cloudFoundryOperations, new ClassPathResource("test-application.zip").getFile().toPath(), applicationName, false).then(this.cloudFoundryOperations.applications().push(PushApplicationRequest.builder().path(new ClassPathResource("test-application.zip").getFile().toPath()).buildpack("staticfile_buildpack").diskQuota(512).memory(64).name(applicationName).build())).as(StepVerifier::create).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void pushMultipleRoutes() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void pushNew() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    createApplication(this.cloudFoundryOperations, new ClassPathResource("test-application.zip").getFile().toPath(), applicationName, false).as(StepVerifier::create).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void pushNewDocker() {
    String applicationName = this.nameFactory.getApplicationName();
    createDockerApplication(this.cloudFoundryOperations, applicationName, false).as(StepVerifier::create).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void pushNoHostName() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void pushNoRoute() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void pushPrivateDomain() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
    createDomain(this.cloudFoundryOperations, domainName, this.organizationName).then(this.cloudFoundryOperations.applications().push(PushApplicationRequest.builder().path(new ClassPathResource("test-application.zip").getFile().toPath()).buildpack("staticfile_buildpack").diskQuota(512).domain(domainName).memory(64).name(applicationName).build())).as(StepVerifier::create).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void pushRouteAndRoutePath() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void pushRoutePath() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String routePath = this.nameFactory.getPath();
  ...
  @Test public void pushTcpRoute() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
    requestCreateTcpDomain(this.cloudFoundryOperations, domainName, DEFAULT_ROUTER_GROUP).then(this.cloudFoundryOperations.applications().pushManifest(PushApplicationManifestRequest.builder().manifest(ApplicationManifest.builder().path(new ClassPathResource("test-application.zip").getFile().toPath()).buildpack("staticfile_buildpack").disk(512).healthCheckType(ApplicationHealthCheck.PROCESS).memory(64).name(applicationName).randomRoute(true).route(Route.builder().route(domainName).build()).build()).noStart(true).build())).then(this.cloudFoundryOperations.applications().getApplicationManifest(GetApplicationManifestRequest.builder().name(applicationName).build())).map((manifest) -> manifest.getRoutes().get(0).getRoute()).as(StepVerifier::create).consumeNextWith((route) -> assertThat(route).matches(domainName + "+?:\\d+$")).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void pushUpdateRoute() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void pushUpdateTcpRoute() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void pushWithHost() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void restartNotStarted() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    createApplication(this.cloudFoundryOperations, new ClassPathResource("test-application.zip").getFile().toPath(), applicationName, true).then(this.cloudFoundryOperations.applications().restart(RestartApplicationRequest.builder().name(applicationName).build())).as(StepVerifier::create).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void restartStarted() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    createApplication(this.cloudFoundryOperations, new ClassPathResource("test-application.zip").getFile().toPath(), applicationName, false).then(this.cloudFoundryOperations.applications().restart(RestartApplicationRequest.builder().name(applicationName).build())).as(StepVerifier::create).expectComplete().verify(Duration.ofMinutes(5));
  }

  @IfCloudFoundryVersion(greaterThanOrEqualTo = CloudFoundryVersion.PCF_1_11) @Test public void runTask() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String taskName = this.nameFactory.getTaskName();
  ...
  @Test public void scale() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void setEnvironmentVariable() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void unsetEnvironmentVariableComplete() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String variableName1 = this.nameFactory.getVariableName();
    String variableName2 = this.nameFactory.getVariableName();
    String variableValue1 = this.nameFactory.getVariableValue();
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void unsetEnvironmentVariablePartial() throws IOException {
    String applicationName = this.nameFactory.getApplicationName();
    String variableName1 = this.nameFactory.getVariableName();
    String variableName2 = this.nameFactory.getVariableName();
    String variableValue1 = this.nameFactory.getVariableValue();
  ...
  private static Mono<Void> bindServiceToApplication(CloudFoundryOperations cloudFoundryOperations, String applicationName, String serviceInstanceName) {
    return cloudFoundryOperations.services().createUserProvidedInstance(CreateUserProvidedServiceInstanceRequest.builder().name(serviceInstanceName).build()).then(cloudFoundryOperations.services().bind(BindServiceInstanceRequest.builder().serviceInstanceName(serviceInstanceName).applicationName(applicationName).build()));
  }
  ...
  private static Mono<Void> createApplication(CloudFoundryOperations cloudFoundryOperations, Path application, String name, Boolean noStart) {
    return cloudFoundryOperations.applications().push(PushApplicationRequest.builder().buildpack("staticfile_buildpack").diskQuota(512).healthCheckType(ApplicationHealthCheck.NONE).memory(64).name(name).noStart(noStart).path(application).build());
  }
  ...
  private static Mono<Void> createApplicationTcp(CloudFoundryOperations cloudFoundryOperations, String applicationName, String domainName) throws IOException {
    return cloudFoundryOperations.applications().pushManifest(PushApplicationManifestRequest.builder().manifest(ApplicationManifest.builder().buildpack("staticfile_buildpack").disk(512).healthCheckType(ApplicationHealthCheck.PROCESS).memory(64).name(applicationName).path(new ClassPathResource("test-application.zip").getFile().toPath()).randomRoute(true).route(Route.builder().route(domainName).build()).build()).noStart(true).build());
  }
  ...
  private static Mono<Void> createDockerApplication(CloudFoundryOperations cloudFoundryOperations, String name, Boolean noStart) {
    return cloudFoundryOperations.applications().push(PushApplicationRequest.builder().diskQuota(512).dockerImage("cloudfoundry/lattice-app").healthCheckType(ApplicationHealthCheck.PORT).memory(64).name(name).noStart(noStart).build());
  }
  ...
  private static Mono<Void> createDomain(CloudFoundryOperations cloudFoundryOperations, String domainName, String organizationName) {
    return cloudFoundryOperations.domains().create(CreateDomainRequest.builder().domain(domainName).organization(organizationName).build());
  }
  ...
  private static Mono<Void> createServiceInstance(CloudFoundryOperations cloudFoundryOperations, String planName, String serviceInstanceName, String serviceName) {
    return cloudFoundryOperations.services().createInstance(CreateServiceInstanceRequest.builder().planName(planName).serviceInstanceName(serviceInstanceName).serviceName(serviceName).build());
  }
  ...
  private static Mono<Integer> getLongLivedTaskId(CloudFoundryOperations cloudFoundryOperations, String applicationName, String taskName) {
    return requestCreateLongLivedTask(cloudFoundryOperations, applicationName, taskName).map(Task::getSequenceId);
  }
  ...
  private static Mono<ServiceInstance> getServiceInstance(CloudFoundryOperations cloudFoundryOperations, String serviceInstanceName) {
    return cloudFoundryOperations.services().getInstance(GetServiceInstanceRequest.builder().name(serviceInstanceName).build());
  }
  ...
  private static Mono<Task> requestCreateLongLivedTask(CloudFoundryOperations cloudFoundryOperations, String applicationName, String taskName) {
    return cloudFoundryOperations.applications().runTask(RunApplicationTaskRequest.builder().applicationName(applicationName).command("sleep 99").disk(64).memory(64).taskName(taskName).build());
  }
  ...
  private static Mono<Task> requestCreateTask(CloudFoundryOperations cloudFoundryOperations, String applicationName, String taskName) {
    return cloudFoundryOperations.applications().runTask(RunApplicationTaskRequest.builder().applicationName(applicationName).command("ls").disk(64).memory(64).taskName(taskName).build());
  }
  ...
  private static Mono<Void> requestCreateTcpDomain(CloudFoundryOperations cloudFoundryOperations, String domainName, String routerGroup) {
    return cloudFoundryOperations.domains().createShared(CreateSharedDomainRequest.builder().domain(domainName).routerGroup(routerGroup).build());
  }
  ...
  private static Mono<ApplicationDetail> requestGetApplication(CloudFoundryOperations cloudFoundryOperations, String applicationtName) {
    return cloudFoundryOperations.applications().get(GetApplicationRequest.builder().name(applicationtName).build());
  }
  ...
  private static Mono<ApplicationHealthCheck> requestGetHealthCheck(CloudFoundryOperations cloudFoundryOperations, String applicationName) {
    return cloudFoundryOperations.applications().getHealthCheck(GetApplicationHealthCheckRequest.builder().name(applicationName).build());
  }
  ...
  private static Flux<org.cloudfoundry.operations.routes.Route> requestListRoutes(CloudFoundryOperations cloudFoundryOperations) {
    return cloudFoundryOperations.routes().list(ListRoutesRequest.builder().build());
  }

  private static Flux<Task> requestListTasks(CloudFoundryOperations cloudFoundryOperations, String applicationName) {
    return cloudFoundryOperations.applications().listTasks(ListApplicationTasksRequest.builder().name(applicationName).build());
  }

  private static Mono<Boolean> requestSshEnabled(CloudFoundryOperations cloudFoundryOperations, String applicationName) {
    return cloudFoundryOperations.applications().sshEnabled(ApplicationSshEnabledRequest.builder().name(applicationName).build());
  }
}