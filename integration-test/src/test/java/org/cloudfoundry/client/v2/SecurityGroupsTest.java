...
public final class SecurityGroupsTest extends AbstractIntegrationTest {
  ...
  @Test public void listRunningDefaults() {
  ...
  @Test public void listStagingDefaults() {
    String securityGroupName1 = this.nameFactory.getSecurityGroupName();
    String securityGroupName2 = this.nameFactory.getSecurityGroupName();
  ...
  @Test public void setRunningDefault() {
    String securityGroupName = this.nameFactory.getSecurityGroupName();
  ...
  @Test public void setStagingDefault() {
    String securityGroupName = this.nameFactory.getSecurityGroupName();
  ...
  @Test public void unsetRunningDefault() {
    String securityGroupName = this.nameFactory.getSecurityGroupName();
  ...
  @Test public void unsetStagingDefault() {
    String securityGroupName = this.nameFactory.getSecurityGroupName();
  ...
  private static Mono<AssociateSecurityGroupSpaceResponse> associateSpace(CloudFoundryClient cloudFoundryClient, String spaceId, String securityGroupId) {
    return cloudFoundryClient.securityGroups().associateSpace(AssociateSecurityGroupSpaceRequest.builder().securityGroupId(securityGroupId).spaceId(spaceId).build());
  }
  ...
  private static Flux<SecurityGroupResource> requestListRunningDefaults(CloudFoundryClient cloudFoundryClient) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.securityGroups().listRunningDefaults(ListSecurityGroupRunningDefaultsRequest.builder().build()));
  }
  ...
  private static Flux<SpaceResource> requestListSecurityGroupSpaces(CloudFoundryClient cloudFoundryClient, String spaceId, String securityGroupId) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.securityGroups().listSpaces(ListSecurityGroupSpacesRequest.builder().page(page).securityGroupId(securityGroupId).spaceId(spaceId).build()));
  }
  ...
  private static Flux<SecurityGroupResource> requestListSecurityGroups(CloudFoundryClient cloudFoundryClient, String securityGroupName) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.securityGroups().list(ListSecurityGroupsRequest.builder().name(securityGroupName).page(page).build()));
  }

  private static Flux<SecurityGroupResource> requestListStagingDefaults(CloudFoundryClient cloudFoundryClient) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.securityGroups().listStagingDefaults(ListSecurityGroupStagingDefaultsRequest.builder().build()));
  }
  ...
  private static Mono<SetSecurityGroupRunningDefaultResponse> requestSetRunningDefault(CloudFoundryClient cloudFoundryClient, String securityGroupId) {
    return cloudFoundryClient.securityGroups().setRunningDefault(SetSecurityGroupRunningDefaultRequest.builder().securityGroupId(securityGroupId).build());
  }
  ...
  private static Mono<SetSecurityGroupStagingDefaultResponse> requestSetStagingDefault(CloudFoundryClient cloudFoundryClient, String securityGroupId) {
    return cloudFoundryClient.securityGroups().setStagingDefault(SetSecurityGroupStagingDefaultRequest.builder().securityGroupId(securityGroupId).build());
  }
}