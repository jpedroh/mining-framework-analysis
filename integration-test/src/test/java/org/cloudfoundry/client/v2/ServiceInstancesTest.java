...
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/38b5a2a415bc2535d60f12f33237f5a17d44e3be/integration-test/src/test/java/org/cloudfoundry/client/v2/ServiceInstancesTest.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  private static Mono<String> createServiceInstanceId(CloudFoundryClient cloudFoundryClient, Mono<String> serviceBrokerId, String serviceInstanceName, String serviceName, String spaceId) {
    return serviceBrokerId.flatMap((s) -> getPlanId(cloudFoundryClient, s, serviceName)).flatMap((planId) -> requestCreateServiceInstance(cloudFoundryClient, planId, serviceInstanceName, spaceId)).map(ResourceUtils::getId);
  }
