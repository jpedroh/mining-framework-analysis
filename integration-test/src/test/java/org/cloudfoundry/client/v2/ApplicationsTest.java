...
public final class ApplicationsTest extends AbstractIntegrationTest {
  ...
  @Test public void associateRoute() throws TimeoutException, InterruptedException {
  ...
  @Test public void copy() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void downloadDroplet() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void environment() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @IfCloudFoundryVersion(greaterThanOrEqualTo = CloudFoundryVersion.PCF_1_9) @Test public void getPermissions() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void listFilterByDiego() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void listFilterBySpaceId() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void listFilterByStackId() {
    String applicationName = this.nameFactory.getApplicationName();
    Mono.zip(this.stackId, this.spaceId.flatMap((spaceId) -> createApplicationId(this.cloudFoundryClient, spaceId, applicationName))).flatMap(function((stackId, applicationId) -> Mono.zip(Mono.just(applicationId), PaginationUtils.requestClientV2Resources((page) -> this.cloudFoundryClient.applicationsV2().list(ListApplicationsRequest.builder().stackId(stackId).page(page).build())).filter((resource) -> ResourceUtils.getId(resource).equals(applicationId)).single().cast(AbstractApplicationResource.class)))).as(StepVerifier::create).consumeNextWith(applicationIdAndNameEquality(applicationName)).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void listRoutes() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void listRoutesFilterByDomainId() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void listRoutesFilterByHost() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void listRoutesFilterByPath() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void listRoutesFilterByPort() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void listServiceBindings() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void listServiceBindingsFilterByServiceInstanceId() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
    String serviceInstanceName = this.nameFactory.getServiceInstanceName();
  ...
  @Test public void removeRoute() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void removeServiceBinding() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
    String serviceInstanceName = this.nameFactory.getServiceInstanceName();
  ...
  @Test public void restage() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void statistics() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void summary() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void terminateInstance() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void uploadAndDownload() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @Test public void uploadAndDownloadAsyncFalse() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
  ...
  @IfCloudFoundryVersion(greaterThanOrEqualTo = CloudFoundryVersion.PCF_1_9) @Test public void uploadDroplet() throws TimeoutException, InterruptedException {
    String applicationName = this.nameFactory.getApplicationName();
    this.spaceId.flatMap((spaceId) -> createApplicationId(this.cloudFoundryClient, spaceId, applicationName)).flatMap((applicationId) -> {
      try {
  ...
  private static Mono<String> createApplicationId(CloudFoundryClient cloudFoundryClient, String spaceId, String applicationName) {
    return requestCreateApplication(cloudFoundryClient, spaceId, applicationName, "staticfile_buildpack", true, 512, 64).map(ResourceUtils::getId);
  }
  ...
  private static Mono<CreateApplicationResponse> requestCreateApplication(CloudFoundryClient cloudFoundryClient, String spaceId, String applicationName, String buildpack, Boolean diego, Integer diskQuota, Integer memory) {
    return cloudFoundryClient.applicationsV2().create(CreateApplicationRequest.builder().buildpack(buildpack).diego(diego).diskQuota(diskQuota).memory(memory).name(applicationName).spaceId(spaceId).build());
  }
