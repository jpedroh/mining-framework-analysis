...
public final class ServicesTest extends AbstractIntegrationTest {
  ...
  @Test public void deletePurge() {
    ...
    String spaceName = this.nameFactory.getSpaceName();
    ServiceBrokerUtils.ServiceBrokerMetadata serviceBrokerMetadata = this.organizationId.flatMap((organizationId) -> createSpaceId(this.cloudFoundryClient, organizationId, spaceName)).flatMap((spaceId) -> createServiceBroker(this.cloudFoundryClient, this.nameFactory, planName, serviceBrokerName, serviceName, spaceId, true)).block(Duration.ofMinutes(5));
    getServiceId(this.cloudFoundryClient, serviceName).flatMap((serviceId) -> this.cloudFoundryClient.services().delete(DeleteServiceRequest.builder().async(true).purge(true).serviceId(serviceId).build())).flatMap((job) -> JobUtils.waitForCompletion(this.cloudFoundryClient, Duration.ofMinutes(5), job)).thenMany(requestListServices(this.cloudFoundryClient, serviceBrokerMetadata.serviceBrokerId)).filter((resource) -> serviceName.equals(ResourceUtils.getEntity(resource).getLabel())).as(StepVerifier::create).expectComplete().verify(Duration.ofMinutes(1));
    deleteServiceBroker(this.cloudFoundryClient, serviceBrokerMetadata.applicationMetadata.applicationId).block(Duration.ofMinutes(5));
  }

  @Test public void get() {
    this.serviceBrokerId.
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/fcc8e8fb113e3caadf856f92b566e5fef15ee52c/integration-test/src/test/java/org/cloudfoundry/client/v2/ServicesTest.java/left.java
    flatMap((serviceBrokerId) -> getServiceId(this.cloudFoundryClient, serviceBrokerId))
=======
    then((serviceBrokerId) -> getServiceId(this.cloudFoundryClient, this.serviceName))
>>>>>>> /usr/src/app/output/cloudfoundry/cf-java-client/fcc8e8fb113e3caadf856f92b566e5fef15ee52c/integration-test/src/test/java/org/cloudfoundry/client/v2/ServicesTest.java/right.java
    .flatMap((serviceId) -> this.cloudFoundryClient.services().get(GetServiceRequest.builder().serviceId(serviceId).build())).map((response) -> response.getEntity().getLabel()).as(StepVerifier::create).expectNext(this.serviceName).expectComplete().verify(Duration.ofMinutes(5));
  }
  ...
  @Test public void listFilterByActive() {
  ...
  @Test public void listFilterByLabels() {
  ...
  @Test public void listFilterByServiceBrokerIds() {
  ...
  @Test public void listNoneFound() {
    PaginationUtils.requestClientV2Resources((page) -> this.cloudFoundryClient.services().list(ListServicesRequest.builder().label("unmatched-filter").page(page).build())).map((response) -> response.getEntity().getLabel()).as(StepVerifier::create).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void listServicePlans() {
    this.serviceBrokerId.
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/fcc8e8fb113e3caadf856f92b566e5fef15ee52c/integration-test/src/test/java/org/cloudfoundry/client/v2/ServicesTest.java/left.java
    flatMap((serviceBrokerId) -> getServiceId(this.cloudFoundryClient, serviceBrokerId))
=======
    then((serviceBrokerId) -> getServiceId(this.cloudFoundryClient, this.serviceName))
>>>>>>> /usr/src/app/output/cloudfoundry/cf-java-client/fcc8e8fb113e3caadf856f92b566e5fef15ee52c/integration-test/src/test/java/org/cloudfoundry/client/v2/ServicesTest.java/right.java
    .flatMapMany((serviceId) -> PaginationUtils.requestClientV2Resources((page) -> this.cloudFoundryClient.services().listServicePlans(ListServiceServicePlansRequest.builder().serviceId(serviceId).page(page).build()))).map((response) -> response.getEntity().getName()).as(StepVerifier::create).expectNext(this.planName).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void listServicePlansFilterByActive() {
    this.serviceBrokerId.
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/fcc8e8fb113e3caadf856f92b566e5fef15ee52c/integration-test/src/test/java/org/cloudfoundry/client/v2/ServicesTest.java/left.java
    flatMap((serviceBrokerId) -> getServiceId(this.cloudFoundryClient, serviceBrokerId))
=======
    then((serviceBrokerId) -> getServiceId(this.cloudFoundryClient, this.serviceName))
>>>>>>> /usr/src/app/output/cloudfoundry/cf-java-client/fcc8e8fb113e3caadf856f92b566e5fef15ee52c/integration-test/src/test/java/org/cloudfoundry/client/v2/ServicesTest.java/right.java
    .flatMapMany((serviceId) -> PaginationUtils.requestClientV2Resources((page) -> this.cloudFoundryClient.services().listServicePlans(ListServiceServicePlansRequest.builder().active(true).serviceId(serviceId).page(page).build()))).map((response) -> response.getEntity().getName()).as(StepVerifier::create).expectNext(this.planName).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void listServicePlansFilterByServiceInstanceIds() {
    String serviceInstanceName = this.nameFactory.getServiceInstanceName();
    this.serviceBrokerId.
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/fcc8e8fb113e3caadf856f92b566e5fef15ee52c/integration-test/src/test/java/org/cloudfoundry/client/v2/ServicesTest.java/left.java
    flatMap((serviceBrokerId) -> Mono.zip(getServiceId(this.cloudFoundryClient, serviceBrokerId), this.spaceId))
=======
    then((serviceBrokerId) -> Mono.when(getServiceId(this.cloudFoundryClient, this.serviceName), this.spaceId))
>>>>>>> /usr/src/app/output/cloudfoundry/cf-java-client/fcc8e8fb113e3caadf856f92b566e5fef15ee52c/integration-test/src/test/java/org/cloudfoundry/client/v2/ServicesTest.java/right.java
    .flatMap(function((serviceId, spaceId) -> Mono.zip(Mono.just(serviceId), createServiceInstanceId(this.cloudFoundryClient, serviceInstanceName, serviceId, spaceId)))).flatMapMany(function((serviceId, serviceInstanceId) -> PaginationUtils.requestClientV2Resources((page) -> this.cloudFoundryClient.services().listServicePlans(ListServiceServicePlansRequest.builder().serviceId(serviceId).serviceInstanceId(serviceInstanceId).page(page).build())))).map((response) -> response.getEntity().getName()).as(StepVerifier::create).expectNext(this.planName).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void listServicePlansNoneFound() {
    this.serviceBrokerId.
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/fcc8e8fb113e3caadf856f92b566e5fef15ee52c/integration-test/src/test/java/org/cloudfoundry/client/v2/ServicesTest.java/left.java
    flatMap((serviceBrokerId) -> getServiceId(this.cloudFoundryClient, serviceBrokerId))
=======
    then((serviceBrokerId) -> getServiceId(this.cloudFoundryClient, this.serviceName))
>>>>>>> /usr/src/app/output/cloudfoundry/cf-java-client/fcc8e8fb113e3caadf856f92b566e5fef15ee52c/integration-test/src/test/java/org/cloudfoundry/client/v2/ServicesTest.java/right.java
    .flatMapMany((serviceId) -> PaginationUtils.requestClientV2Resources((page) -> this.cloudFoundryClient.services().listServicePlans(ListServiceServicePlansRequest.builder().serviceId(serviceId).serviceInstanceId("unmatched-filter").page(page).build()))).map((response) -> response.getEntity().getName()).as(StepVerifier::create).expectComplete().verify(Duration.ofMinutes(5));
  }
  ...
  private static Flux<DeleteServicePlanResponse> deleteServicePlans(CloudFoundryClient cloudFoundryClient, String serviceBrokerId, String serviceId) {
    return listServicePlanIds(cloudFoundryClient, serviceBrokerId, serviceId).flatMap((servicePlanId) -> requestDeleteServicePlan(cloudFoundryClient, servicePlanId));
  }

  private static Mono<String> getServiceId(CloudFoundryClient cloudFoundryClient, String serviceName) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.services().list(ListServicesRequest.builder().page(page).build())).filter((resource) -> serviceName.equals(ResourceUtils.getEntity(resource).getLabel())).single().map(ResourceUtils::getId);
  }
  ...
  private static Flux<String> listServicePlanIds(CloudFoundryClient cloudFoundryClient, String serviceBrokerId, String serviceId) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.servicePlans().list(ListServicePlansRequest.builder().page(page).serviceBrokerId(serviceBrokerId).serviceId(serviceId).build())).map(ResourceUtils::getId);
  }
  ...
  private static Mono<CreateServiceInstanceResponse> requestCreateServiceInstance(CloudFoundryClient cloudFoundryClient, String name, String servicePlanId, String spaceId) {
    return cloudFoundryClient.serviceInstances().create(CreateServiceInstanceRequest.builder().name(name).servicePlanId(servicePlanId).spaceId(spaceId).build());
  }
  ...
  private static Mono<DeleteServicePlanResponse> requestDeleteServicePlan(CloudFoundryClient cloudFoundryClient, String servicePlanId) {
    return cloudFoundryClient.servicePlans().delete(DeleteServicePlanRequest.builder().servicePlanId(servicePlanId).build());
  }

  private static Flux<ServicePlanResource> requestListServicePlans(CloudFoundryClient cloudFoundryClient, String serviceId) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.services().listServicePlans(ListServiceServicePlansRequest.builder().page(page).serviceId(serviceId).build()));
  }

  private static Flux<ServiceResource> requestListServices(CloudFoundryClient cloudFoundryClient, String serviceBrokerId) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.services().list(ListServicesRequest.builder().serviceBrokerId(serviceBrokerId).page(page).build()));
  }
  ...
  private Mono<String> createServiceInstanceId(CloudFoundryClient cloudFoundryClient, String name, String serviceId, String spaceId) {
    return requestListServicePlans(cloudFoundryClient, serviceId).single().map(ResourceUtils::getId).flatMap((servicePlanId) -> requestCreateServiceInstance(cloudFoundryClient, name, servicePlanId, spaceId).map(ResourceUtils::getId));
  }
}