...
public final class OrganizationsTest extends AbstractIntegrationTest {
  ...
  @Autowired private Mono<String> userId;
...
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/0f8da5d9f59b2a9208c97b26695f7931ccf3f0ba/integration-test/src/test/java/org/cloudfoundry/client/v2/OrganizationsTest.java/left.java
    flatMap((organizationId) -> Mono.zip(Mono.just(organizationId), this.cloudFoundryClient.organizations().associateAuditorByUsername(AssociateOrganizationAuditorByUsernameRequest.builder().organizationId(organizationId).username(this.username).build()).map(ResourceUtils::getId)))
=======
    then((organizationId) -> Mono.when(Mono.just(organizationId), this.cloudFoundryClient.organizations().associateAuditorByUsername(AssociateOrganizationAuditorByUsernameRequest.builder().origin("uaa").organizationId(organizationId).username(this.username).build()).map(ResourceUtils::getId)))
>>>>>>> /usr/src/app/output/cloudfoundry/cf-java-client/0f8da5d9f59b2a9208c97b26695f7931ccf3f0ba/integration-test/src/test/java/org/cloudfoundry/client/v2/OrganizationsTest.java/right.java
    .as(StepVerifier::create).consumeNextWith(tupleEquality()).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void associateBillingManager() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void associateBillingManagerByUsername() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void associatePrivateDomain() {
  ...
  @Test public void associateUser() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void associateUserByUsername() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void create() {
    String organizationName = this.nameFactory.getOrganizationName();
    this.cloudFoundryClient.organizations().create(CreateOrganizationRequest.builder().name(organizationName).build()).map(ResourceUtils::getEntity).map(OrganizationEntity::getName).as(StepVerifier::create).expectNext(organizationName).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void delete() {
    String organizationName = this.nameFactory.getOrganizationName();
    createOrganizationId(this.cloudFoundryClient, organizationName).delayUntil((organizationId) -> this.cloudFoundryClient.organizations().delete(DeleteOrganizationRequest.builder().organizationId(organizationId).async(true).build()).flatMap((job) -> JobUtils.waitForCompletion(this.cloudFoundryClient, Duration.ofMinutes(5), job))).flatMap((organizationId) -> requestGetOrganization(this.cloudFoundryClient, organizationId)).as(StepVerifier::create).consumeErrorWith((t) -> assertThat(t).isInstanceOf(ClientV2Exception.class).hasMessageMatching("CF-OrganizationNotFound\\([0-9]+\\): The organization could not be found: .*")).verify(Duration.ofMinutes(5));
  }
  ...
  @Test public void getInstanceUsage() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void getMemoryUsage() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void list() {
    String organizationName = this.nameFactory.getOrganizationName();
    createOrganizationId(this.cloudFoundryClient, organizationName).flatMapMany((organizationId) -> requestListOrganizations(this.cloudFoundryClient).map(ResourceUtils::getId).filter(organizationId::equals)).as(StepVerifier::create).expectNextCount(1).expectComplete().verify(Duration.ofMinutes(5));
  }
  ...
  @Test public void listAuditorsFilterByAuditedOrganizationId() {
  ...
  @Test public void listAuditorsFilterByAuditedSpaceId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
  ...
  @Test public void listAuditorsFilterByBillingManagedOrganizationId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
  ...
  @Test public void listAuditorsFilterByManagedOrganizationId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
  ...
  @Test public void listAuditorsFilterByManagedSpaceId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
    String spaceName = this.nameFactory.getSpaceName();
  ...
  @Test public void listAuditorsFilterBySpaceId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
    String spaceName = this.nameFactory.getSpaceName();
  ...
  @Test public void listBillingManagers() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void listBillingManagersFilterByAuditedOrganizationId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
  ...
  @Test public void listBillingManagersFilterByAuditedSpaceId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
    String spaceName = this.nameFactory.getSpaceName();
  ...
  @Test public void listBillingManagersFilterByBillingManagedOrganizationId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
  ...
  @Test public void listBillingManagersFilterByManagedOrganizationId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
  ...
  @Test public void listBillingManagersFilterByManagedSpaceId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
    String spaceName = this.nameFactory.getSpaceName();
  ...
  @Test public void listBillingManagersFilterBySpaceId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
    String spaceName = this.nameFactory.getSpaceName();
  ...
  @Test public void listFilterByAuditorId() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void listFilterByBillingManagerId() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void listFilterByManagerId() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void listFilterByName() {
    String organizationName = this.nameFactory.getOrganizationName();
    requestCreateOrganization(this.cloudFoundryClient, organizationName).thenMany(requestListOrganizations(this.cloudFoundryClient, (builder) -> builder.name(organizationName))).as(StepVerifier::create).expectNextCount(1).expectComplete().verify(Duration.ofMinutes(5));
  }
  ...
  @Test public void listManagersFilterBySpaceId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
    String spaceName = this.nameFactory.getSpaceName();
  ...
  @Test public void listPrivateDomains() {
    String domainName = this.nameFactory.getDomainName();
  ...
  @Test public void listPrivateDomainsFilterByName() {
    String organizationName = this.nameFactory.getOrganizationName();
    String privateDomainName = this.nameFactory.getDomainName();
  ...
  @Test public void listUsersFilterByAuditedOrganizationId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
  ...
  @Test public void listUsersFilterByAuditedSpaceId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
    String spaceName = this.nameFactory.getSpaceName();
  ...
  @Test public void listUsersFilterByBillingManagedOrganizationId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
  ...
  @Test public void listUsersFilterByManagedOrganizationId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
  ...
  @Test public void listUsersFilterByManagedSpaceId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
    String spaceName = this.nameFactory.getSpaceName();
  ...
  @Test public void listUsersFilterBySpaceId() {
    String organizationName1 = this.nameFactory.getOrganizationName();
    String organizationName2 = this.nameFactory.getOrganizationName();
    String spaceName = this.nameFactory.getSpaceName();
  ...
  @Test public void removeBillingManager() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void removeBillingManagerByUsername() {
    String organizationName = this.nameFactory.getOrganizationName();
    Mono.zip(createOrganizationId(this.cloudFoundryClient, organizationName), this.userId).delayUntil(function((organizationId, userId) -> requestAssociateBillingManager(this.cloudFoundryClient, organizationId, userId))).
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/0f8da5d9f59b2a9208c97b26695f7931ccf3f0ba/integration-test/src/test/java/org/cloudfoundry/client/v2/OrganizationsTest.java/left.java
    delayUntil(function((organizationId, userId) -> this.cloudFoundryClient.organizations().removeBillingManagerByUsername(RemoveOrganizationBillingManagerByUsernameRequest.builder().username(this.username).organizationId(organizationId).build())))
=======
    as(thenKeep(function((organizationId, userId) -> this.cloudFoundryClient.organizations().removeBillingManagerByUsername(RemoveOrganizationBillingManagerByUsernameRequest.builder().origin("uaa").username(this.username).organizationId(organizationId).build()))))
>>>>>>> /usr/src/app/output/cloudfoundry/cf-java-client/0f8da5d9f59b2a9208c97b26695f7931ccf3f0ba/integration-test/src/test/java/org/cloudfoundry/client/v2/OrganizationsTest.java/right.java
    .flatMapMany(function((organizationId, userId) -> requestListOrganizationBillingManagers(this.cloudFoundryClient, organizationId))).as(StepVerifier::create).expectComplete().verify(Duration.ofMinutes(5));
  }
  ...
  @Test public void removePrivateDomain() {
    String domainName = this.nameFactory.getDomainName();
    String defaultOrganizationName = this.nameFactory.getOrganizationName();
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  @Test public void removeUserByUsername() {
    String organizationName = this.nameFactory.getOrganizationName();
  ...
  private static Mono<String> createPrivateDomainId(CloudFoundryClient cloudFoundryClient, String organizationId, String domainName) {
    return requestCreatePrivateDomain(cloudFoundryClient, domainName, organizationId).map(ResourceUtils::getId);
  }
  ...
  private static Mono<String> getUserDefaultSpaceId(CloudFoundryClient cloudFoundryClient, String userId) {
    return requestListUsers(cloudFoundryClient).filter((resource) -> userId.equals(ResourceUtils.getId(resource))).single().map((resource) -> ResourceUtils.getEntity(resource).getDefaultSpaceId());
  }
  ...
  private static Mono<AssociateOrganizationPrivateDomainResponse> requestAssociatePrivateDomain(CloudFoundryClient cloudFoundryClient, String organizationId, String privateDomainId) {
    return cloudFoundryClient.organizations().associatePrivateDomain(AssociateOrganizationPrivateDomainRequest.builder().organizationId(organizationId).privateDomainId(privateDomainId).build());
  }
  ...
  private static Mono<AssociateSpaceDeveloperResponse> requestAssociateSpaceDeveloper(CloudFoundryClient cloudFoundryClient, String spaceId, String userId) {
    return cloudFoundryClient.spaces().associateDeveloper(AssociateSpaceDeveloperRequest.builder().spaceId(spaceId).developerId(userId).build());
  }
  ...
  private static Mono<CreateOrganizationResponse> requestCreateOrganization(CloudFoundryClient cloudFoundryClient, String organizationName, UnaryOperator<CreateOrganizationRequest.Builder> transformer) {
    return cloudFoundryClient.organizations().create(transformer.apply(CreateOrganizationRequest.builder()).name(organizationName).build());
  }
  ...
  private static Mono<CreatePrivateDomainResponse> requestCreatePrivateDomain(CloudFoundryClient cloudFoundryClient, String domainName, String organizationId) {
    return cloudFoundryClient.privateDomains().create(CreatePrivateDomainRequest.builder().name(domainName).owningOrganizationId(organizationId).build());
  }
  ...
  private static Flux<UserResource> requestListOrganizationAuditors(CloudFoundryClient cloudFoundryClient, String organizationId, UnaryOperator<ListOrganizationAuditorsRequest.Builder> transformer) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.organizations().listAuditors(transformer.apply(ListOrganizationAuditorsRequest.builder()).page(page).organizationId(organizationId).build()));
  }
  ...
  private static Flux<UserResource> requestListOrganizationBillingManagers(CloudFoundryClient cloudFoundryClient, String organizationId, UnaryOperator<ListOrganizationBillingManagersRequest.Builder> transformer) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.organizations().listBillingManagers(transformer.apply(ListOrganizationBillingManagersRequest.builder()).page(page).organizationId(organizationId).build()));
  }
  ...
  private static Flux<UserResource> requestListOrganizationManagers(CloudFoundryClient cloudFoundryClient, String organizationId, UnaryOperator<ListOrganizationManagersRequest.Builder> transformer) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.organizations().listManagers(transformer.apply(ListOrganizationManagersRequest.builder()).page(page).organizationId(organizationId).build()));
  }
  ...
  private static Flux<PrivateDomainResource> requestListOrganizationPrivateDomains(CloudFoundryClient cloudFoundryClient, String organizationId, UnaryOperator<ListOrganizationPrivateDomainsRequest.Builder> transformer) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.organizations().listPrivateDomains(transformer.apply(ListOrganizationPrivateDomainsRequest.builder()).page(page).organizationId(organizationId).build()));
  }
  ...
  private static Flux<ServiceResource> requestListOrganizationServices(CloudFoundryClient cloudFoundryClient, String organizationId, UnaryOperator<ListOrganizationServicesRequest.Builder> transformer) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.organizations().listServices(transformer.apply(ListOrganizationServicesRequest.builder()).organizationId(organizationId).page(page).build()));
  }
  ...
  private static Flux<SpaceResource> requestListOrganizationSpaces(CloudFoundryClient cloudFoundryClient, String organizationId, UnaryOperator<ListOrganizationSpacesRequest.Builder> transformer) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.organizations().listSpaces(transformer.apply(ListOrganizationSpacesRequest.builder()).organizationId(organizationId).page(page).build()));
  }
  ...
  private static Flux<UserResource> requestListOrganizationUsers(CloudFoundryClient cloudFoundryClient, String organizationId, UnaryOperator<ListOrganizationUsersRequest.Builder> transformer) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.organizations().listUsers(transformer.apply(ListOrganizationUsersRequest.builder()).page(page).organizationId(organizationId).build()));
  }
  ...
  private static Flux<OrganizationResource> requestListOrganizations(CloudFoundryClient cloudFoundryClient, UnaryOperator<ListOrganizationsRequest.Builder> transformer) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.organizations().list(transformer.apply(ListOrganizationsRequest.builder()).page(page).build()));
  }

  private static Flux<ServiceResource> requestListServices(CloudFoundryClient cloudFoundryClient) {
    return PaginationUtils.requestClientV2Resources((page) -> cloudFoundryClient.services().list(ListServicesRequest.builder().build()));
  }
