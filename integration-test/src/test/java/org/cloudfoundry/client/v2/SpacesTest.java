...
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/38b5a2a415bc2535d60f12f33237f5a17d44e3be/integration-test/src/test/java/org/cloudfoundry/client/v2/SpacesTest.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void listServices() {
    this.spaceId.flatMapMany((spaceId) -> requestListSpaceServices(this.cloudFoundryClient, spaceId).filter((resource) -> this.serviceName.equals(ResourceUtils.getEntity(resource).getLabel()))).as(StepVerifier::create).expectNextCount(1).expectComplete().verify(Duration.ofMinutes(5));
  }

  @Test public void listServicesFilterByActive() {
    this.spaceId.flatMapMany((spaceId) -> requestListSpaceServices(this.cloudFoundryClient, spaceId).filter((resource) -> this.serviceName.equals(ResourceUtils.getEntity(resource).getLabel()))).map((response) -> response.getEntity().getLabel()).as(StepVerifier::create).expectNextCount(1).expectComplete().verify(Duration.ofMinutes(5));
  }
