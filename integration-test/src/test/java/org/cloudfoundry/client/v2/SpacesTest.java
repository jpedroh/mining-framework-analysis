...
=======
    then(function((organizationId, stackId) -> Mono.when(createSpaceId(this.cloudFoundryClient, organizationId, spaceName), Mono.just(stackId))))
...
>>>>>>> /usr/src/app/output/cloudfoundry/cf-java-client/9ad9ac0c3a11b7fb0ab081acf01ce35a93c5b687/integration-test/src/test/java/org/cloudfoundry/client/v2/SpacesTest.java/right.java
    .
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/9ad9ac0c3a11b7fb0ab081acf01ce35a93c5b687/integration-test/src/test/java/org/cloudfoundry/client/v2/SpacesTest.java/left.java
    flatMap((spaceId) -> Mono.zip(Mono.just(spaceId), PaginationUtils.requestClientV2Resources((page) -> this.cloudFoundryClient.stacks().list(ListStacksRequest.builder().name(this.stackName).page(page).build())).single().map(ResourceUtils::getId)))
=======
...
>>>>>>> /usr/src/app/output/cloudfoundry/cf-java-client/9ad9ac0c3a11b7fb0ab081acf01ce35a93c5b687/integration-test/src/test/java/org/cloudfoundry/client/v2/SpacesTest.java/right.java
    .map((response) -> ResourceUtils.getEntity(response).getName()).as(StepVerifier::create).expectNext(applicationName).expectComplete().verify(Duration.ofMinutes(5));
  }
  ...
  private static Mono<String> createApplicationId(CloudFoundryClient cloudFoundryClient, String spaceId, String applicationName, String stackId) {
    return requestCreateApplication(cloudFoundryClient, spaceId, applicationName, stackId).map(ResourceUtils::getId);
  }
  ...
  private static Mono<CreateApplicationResponse> requestCreateApplication(CloudFoundryClient cloudFoundryClient, String spaceId, String applicationName, String stackId) {
    return cloudFoundryClient.applicationsV2().create(CreateApplicationRequest.builder().diego(true).name(applicationName).spaceId(spaceId).stackId(stackId).build());
  }
