...
public final class Classes {
  ...
  private static final ClassLoaderAccessor THREAD_CL_ACCESSOR = new ExceptionIgnoringAccessor() {
    @Override protected ClassLoader doGetClassLoader() throws Throwable {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> Class<T> forName(String fqcn) throws UnknownClassException {
  ...
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> T newInstance(String fqcn) {
    return (T) newInstance(forName(fqcn));
  }

  public static <T extends java.lang.Object> T newInstance(String fqcn, Class[] ctorArgTypes, Object... args) {
    Class<T> clazz = forName(fqcn);
    Constructor<T> ctor = getConstructor(clazz, ctorArgTypes);
    return instantiate(ctor, args);
  }

  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> T newInstance(String fqcn, Object... args) {
    return (T) newInstance(forName(fqcn), args);
  }

  public static <T extends java.lang.Object> T newInstance(Class<T> clazz) {
    if (clazz == null) {
  ...
  public static <T extends java.lang.Object> T newInstance(Class<T> clazz, Object... args) {
  ...
  public static <T extends java.lang.Object> Constructor<T> getConstructor(Class<T> clazz, Class... argTypes) {
    try {
  ...
  public static <T extends java.lang.Object> T instantiate(Constructor<T> ctor, Object... args) {
    try {
  ...
  /**
     * @since 0.10.0
     */
  public static <T extends java.lang.Object> T invokeStatic(String fqcn, String methodName, Class<?>[] argTypes, Object... args) {
    try {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> T invokeStatic(Class<?> clazz, String methodName, Class<?>[] argTypes, Object... args) {
    try {
