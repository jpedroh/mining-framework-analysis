...
public final class Objects {
  ...
  /**
     ...
     */
  public static <A extends java.lang.Object, O extends A> A[] addObjectToArray(A[] array, O obj) {
    ...
    @SuppressWarnings(value = { "unchecked" }) A[] newArr = (A[]) Array.newInstance(compType, newArrLength);
    if (array != null) {
