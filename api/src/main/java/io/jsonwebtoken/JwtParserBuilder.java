 ...
 * @since 0.11.0
 */
@SuppressWarnings(value = { "JavadocLinkAsPlainText" }) public interface JwtParserBuilder extends Builder<JwtParser> {
  /**
  ...
  /**
     ...
     */
  @Deprecated JwtParserBuilder setSigningKey(String base64EncodedSecretKey);
  ...
  /**
     ...
     * @return the parser builder for method chaining.
     */
  @SuppressWarnings(value = { "DeprecatedIsStillUsed" }) @Deprecated JwtParserBuilder setSigningKeyResolver(SigningKeyResolver signingKeyResolver);
