 ...
 *
 */
@DeclareRoles(value = { "org.imixs.ACCESSLEVEL.MANAGERACCESS" }) @RunAs(value = "org.imixs.ACCESSLEVEL.MANAGERACCESS") @Stateless @LocalBean public class JobHandlerRebuildIndex implements JobHandler {
  private static final String BLOCK_SIZE_DEFAULT = "500";

  private static final String TIMEOUT_DEFAULT = "120";

  @Inject @ConfigProperty(name = "lucene.rebuild.block_size", defaultValue = BLOCK_SIZE_DEFAULT) int block_size;

  @Inject @ConfigProperty(name = "lucene.rebuild.time_out", defaultValue = TIMEOUT_DEFAULT) int time_out;
  ...
  /**
     ...
     */
  @Override @TransactionAttribute(value = TransactionAttributeType.REQUIRES_NEW) public ItemCollection run(ItemCollection adminp) throws AdminPException {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) private List<Document> findNextDocumentsBySyncPoint(long lSyncpoint) {
