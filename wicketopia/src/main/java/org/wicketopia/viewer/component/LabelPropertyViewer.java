...
public class LabelPropertyViewer extends Label implements ViewerBuilder {
  ...
  @Override public Component build() {
    return this;
  }

  @Override public void visible(boolean viewable) {
    setVisible(viewable);
  }

  private static final class Provider implements PropertyViewerProvider {
    @Override public ViewerBuilder createPropertyViewer(String componentId, PropertyMetaData propertyMetadata, IModel<?> propertyModel) {
