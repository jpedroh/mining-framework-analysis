...
public class Wicketopia {
  ...
  public <T extends java.lang.Object> List<IColumn<T>> createColumns(Class<T> beanType, PropertyComponentFactory<T> factory, Context context, String... properties) {
  ...
  public <T extends java.lang.Object> PropertyComponentFactory<T> createEditorFactory(Class<T> beanType) {
  ...
  public <T extends java.lang.Object> PropertyComponentFactory<T> createViewerFactory(Class<T> beanType) {
