...
public class QueryExecute extends Example {
  ...
  private void writeRecords(IAerospikeClient client, Parameters params, String keyPrefix, String binName1, String binName2, int size) throws Exception {
  ...
  private void runQueryExecute(IAerospikeClient client, Parameters params, String indexName, String binName1, String binName2) throws Exception {
    int begin = 3;
    int end = 9;
  ...
  private void validateRecords(IAerospikeClient client, Parameters params, String indexName, String binName1, String binName2, int size) throws Exception {
    int begin = 1;
    int end = size + 100;
    ...
    try {
      ...
      while (rs.next()) {
        ...
        if (val1 == 5) {
          ...
          if (value1 != expectedList[value2 - 1]) {
