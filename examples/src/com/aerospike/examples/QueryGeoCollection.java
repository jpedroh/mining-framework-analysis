...
public class QueryGeoCollection extends Example {
  ...
  private void createIndex(IAerospikeClient client, Parameters params, IndexCollectionType indexType, String indexName, String binName) throws Exception {
  ...
  private void writeMapRecords(IAerospikeClient client, Parameters params, String keyPrefix, String binName, String binName2, String valuePrefix, int size) throws Exception {
  ...
  private void writeMapKeyRecords(IAerospikeClient client, Parameters params, String keyPrefix, String binName, String binName2, String valuePrefix, int size) throws Exception {
    for (int i = 0; i < size; i++) {
      Key key = new Key(params.namespace, params.set, keyPrefix + i);
  ...
  private void writeListRecords(IAerospikeClient client, Parameters params, String keyPrefix, String binName, String binName2, int size) throws Exception {
    for (int i = 0; i < size; i++) {
      Key key = new Key(params.namespace, params.set, keyPrefix + i);
  ...
  private void runQuery(IAerospikeClient client, Parameters params, String binName, String binName2, IndexCollectionType indexType) throws Exception {
  ...
  private void deleteRecords(IAerospikeClient client, Parameters params, String keyPrefix, int size) throws Exception {
    for (int i = 0; i < size; i++) {
      Key key = new Key(params.namespace, params.set, keyPrefix + i);
  ...
  private String generatePolygon(double rlat, double rlng) {
    return String.format("{ \"type\": \"Polygon\", \"coordinates\": [ [[%f, %f], [%f, %f], [%f, %f], [%f, %f], [%f, %f]] ] }", rlng - 0.001, rlat - 0.001, rlng + 0.001, rlat - 0.001, rlng + 0.001, rlat + 0.001, rlng - 0.001, rlat + 0.001, rlng - 0.001, rlat - 0.001);
  }
}