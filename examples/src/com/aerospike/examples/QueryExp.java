...
public class QueryExp extends Example {
  ...
  private void writeRecords(IAerospikeClient client, Parameters params, String binName, int size) throws Exception {
  ...
  private void runQuery1(IAerospikeClient client, Parameters params, String binName) throws Exception {
    int begin = 10;
    int end = 40;
  ...
  private void runQuery2(IAerospikeClient client, Parameters params, String binName) throws Exception {
    int begin = 10;
    int end = 40;
  ...
  private void runQuery3(IAerospikeClient client, Parameters params, String binName) throws Exception {
    int begin = 20;
    int end = 30;
