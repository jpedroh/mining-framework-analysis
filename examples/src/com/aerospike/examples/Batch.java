...
public class Batch extends Example {
  ...
  /**
	 ...
	 */
  private void batchExists(IAerospikeClient client, Parameters params, String keyPrefix, int size) throws Exception {
    ...
    for (int i = 0; i < existsArray.length; i++) {
      ...
      console.info("Record: ns=%s set=%s key=%s exists=%s", key.namespace, key.setName, key.userKey, exists);
    }
  }
  ...
  /**
	 ...
	 */
  private void batchReads(IAerospikeClient client, Parameters params, String keyPrefix, String binName, int size) throws Exception {
    Key[] keys = new Key[size];
    for (int i = 0; i < size; i++) {
      keys[i] = new Key(params.namespace, params.set, keyPrefix + (i + 1));
    }
  ...
  /**
	 ...
	 */
  private void batchReadHeaders(IAerospikeClient client, Parameters params, String keyPrefix, int size) throws Exception {
    Key[] keys = new Key[size];
    for (int i = 0; i < size; i++) {
      keys[i] = new Key(params.namespace, params.set, keyPrefix + (i + 1));
    }
  ...
  /**
	 ...
	 */
  private void batchReadComplex(IAerospikeClient client, Parameters params, String keyPrefix, String binName) throws Exception {
