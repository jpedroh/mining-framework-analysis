...
public class QueryPage extends Example {
  ...
  private void createIndex(IAerospikeClient client, Parameters params, String setName, String indexName, String binName) throws Exception {
    console.info("Create index: ns=%s set=%s index=%s bin=%s", params.namespace, setName, indexName, binName);
