...
public class Main extends JPanel {
  ...
  private static final String[] ExampleNames = new String[] { "ServerInfo", "PutGet", "Replace", "Add", "Append", "Prepend", "Batch", "Generation", "Expire", "Touch", "StoreKey", "DeleteBin", "ListMap", "Operate", "OperateBit", "OperateList", "OperateMap", "ScanPage", "ScanParallel", "ScanResume", "ScanSeries", "UserDefinedFunction", "QueryInteger", "QueryString", "QueryFilter", "QueryExp", "QueryPage", "QueryResume", "QuerySum", "QueryAverage", "QueryCollection", "QueryRegion", "QueryRegionFilter", "QueryGeoCollection", "QueryExecute", "AsyncPutGet", "AsyncBatch", "AsyncQuery", "AsyncScan", "AsyncScanPage", "AsyncUserDefinedFunction" };
