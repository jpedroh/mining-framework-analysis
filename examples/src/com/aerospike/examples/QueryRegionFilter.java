...
public class QueryRegionFilter extends Example {
  ...
  private void register(IAerospikeClient client, Parameters params) throws Exception {
    RegisterTask task = client.register(params.policy, "udf/geo_filter_example.lua", "geo_filter_example.lua", Language.LUA);
  ...
  private void runQuery(IAerospikeClient client, Parameters params, String indexName, String binName1, String binName2) throws Exception {
