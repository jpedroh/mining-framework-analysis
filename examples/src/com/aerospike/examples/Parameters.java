...
<<<<<<< /usr/src/app/output/aerospike/aerospike-client-java/7d8ed0bd0bed83cf7595427938f6f24ac8acbd83/examples/src/com/aerospike/examples/Parameters.java/left.java
  /**
  ...
  protected void setServerSpecific(IAerospikeClient client) throws Exception {
    ...
    if (namespaceTokens == null) {
      throw new Exception(String.format("Failed to get namespace info: host=%s port=%d namespace=%s", host, port, namespace));
    }
