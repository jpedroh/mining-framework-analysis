...
public class QueryRegion extends Example {
  ...
  private void writeRecords(IAerospikeClient client, Parameters params, String keyPrefix, String binName, int size) throws Exception {
  ...
  private void runQuery(IAerospikeClient client, Parameters params, String indexName, String binName) throws Exception {
  ...
  private void runRadiusQuery(IAerospikeClient client, Parameters params, String indexName, String binName) throws Exception {
    double lon = -122.0;
    double lat = 37.5;
