 ...
 * @throws IOException 
  ...
  public static void main(String[] args) throws JMetalException, IOException {
    ...
    double epsilon = 0.01;
    algorithm = new WASFGAMeasures<DoubleSolution>(problem, 100, 250, crossover, mutation, selection, new SequentialSolutionListEvaluator<DoubleSolution>(), epsilon, referencePoint);
