...
public class ValidationFactory {
  @SuppressWarnings(value = { "rawtypes" }) private Map<Class<? extends Spec>, SpecValidation> validations = new HashMap<>();
  ...
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public static SpecValidation<? extends Spec> getValidation(Spec spec, PageValidation pageValidation) {
