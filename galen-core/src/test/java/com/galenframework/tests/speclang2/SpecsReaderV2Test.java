...
public class SpecsReaderV2Test {
  ...
  @BeforeMethod public void configureApproximation() {
    System.setProperty("galen.range.approximation", "2");
  }

  @AfterMethod public void clearApproximation() {
    System.getProperties().remove("galen.range.approximation");
  }

  @Test public void shouldReadSpec_inside() {
  ...
  @Test public void shouldReadSpec_inside_object_10px_right() {
  ...
  @Test public void shouldReadSpec_inside_partly_object_10px_right() {
  ...
  @Test public void shouldReadSpec_inside_object_10_to_30px_left() {
  ...
  @Test public void shouldReadSpec_inside_object_25px_top_left() {
  ...
  @Test public void shouldReadSpec_inside_object_25px_top_left_comma_10_to_20px_bottom() {
    SpecInside spec = (SpecInside) readSpec("inside object 25px top left, 10 to 20px bottom");
    List<Location> locations = spec.getLocations();
    assertThat(locations.size(), is(2));
    assertThat(spec.getLocations(), contains(new Location(Range.exact(25), sides(TOP, LEFT)), new Location(Range.between(10, 20), sides(BOTTOM))));
    assertThat(spec.getOriginalText(), is("inside object 25px top left, 10 to 20px bottom"));
  }

  @Test public void shouldReadSpec_inside_object_25px_bottom_right() {
  ...
  @Test public void shouldReadSpec_inside_object_25px_top_left_right_bottom() {
  ...
  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Missing object name") public void shouldGiveError_inside_withoutObjects() {
    readSpec("inside");
  }

  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Missing object name") public void shouldGiveError_inside_partly_withoutObjects() {
    readSpec("inside partly");
  }

  @Test public void shouldReadSpec_contains() {
  ...
  @Test public void shouldReadSpec_contains_with_regex() {
  ...
  @Test public void shouldReadSpec_contains_partly() {
  ...
  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Missing object name") public void shouldGiveError_contains_withoutObjects() {
    readSpec("contains");
  }

  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Missing object name") public void shouldGiveError_contains_partly_withoutObjects() {
    readSpec("contains partly");
  }

  @Test public void shouldReadSpec_near_button_10_to_20px_left() {
  ...
  @Test public void shouldReadSpec_near_button_10_to_20px_top_right() {
  ...
  @Test public void shouldReadSpec_near_button_approx_0px_left() {
  ...
  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Missing object name") public void shouldGiveError_near() {
    readSpec("near");
  }

  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Missing location") public void shouldGiveError_near_button() {
    readSpec("near button");
  }

  @Test public void shouldReadSpec_aligned_horizontally_centered() throws IOException {
  ...
  @Test public void shouldReadSpec_aligned_horizontally_top() throws IOException {
  ...
  @Test public void shouldReadSpec_aligned_horizontally_bottom() throws IOException {
  ...
  @Test public void shouldReadSpec_aligned_horizontally_all() throws IOException {
  ...
  @Test public void shouldReadSpec_aligned_vertically_centered() throws IOException {
  ...
  @Test public void shouldReadSpec_aligned_vertically_left() throws IOException {
  ...
  @Test public void shouldReadSpec_aligned_vertically_right() throws IOException {
  ...
  @Test public void shouldReadSpec_aligned_vertically_all() throws IOException {
  ...
  @Test public void shouldReadSpec_aligned_vertically_with_error_rate_10px() throws IOException {
  ...
  @Test public void shouldReadSpec_aligned_vertically_with_error_rate_10_px() throws IOException {
  ...
  @Test public void shouldReadSpec_aligned_horizontally_with_error_rate_10px() throws IOException {
  ...
  @Test public void shouldReadSpec_aligned_horizontally_with_error_rate_10_px() throws IOException {
  ...
  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Incorrect alignment direction. Expected \'vertically\' or \'horizontally\' but got: object") public void shouldGiveError_aligned_object() {
    readSpec("aligned object");
  }

  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Incorrect side for vertical alignment: top") public void shouldGiveError_aligned_vertically_top_object() {
    readSpec("aligned vertically top object");
  }

  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Incorrect side for horizontal alignment: left") public void shouldGiveError_aligned_horizontally_left_object() {
    readSpec("aligned horizontally left object");
  }

  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Missing object name") public void shouldGiveError_aligned_horizontally_left() {
    readSpec("aligned horizontally left");
  }

  @Test public void shouldReadSpec_absent() throws IOException {
    Spec spec = readSpec("absent");
    assertThat(spec, instanceOf(SpecAbsent.class));
    assertThat(spec.getOriginalText(), is("absent"));
  }

  @Test public void shouldReadSpec_visible() throws IOException {
    Spec spec = readSpec("visible");
    assertThat(spec, instanceOf(SpecVisible.class));
    assertThat(spec.getOriginalText(), is("visible"));
  }

  @Test public void shouldReadSpec_width_10px() throws IOException {
  ...
  @Test public void shouldReadSpec_width_5_to_8px() throws IOException {
  ...
  @Test public void shouldReadSpec_width_100_percent_of_other_object_width() throws IOException {
  ...
  @Test public void shouldReadSpec_height_10px() throws IOException {
    SpecHeight spec = (SpecHeight) readSpec("height 10px");
    assertThat(spec.getRange(), is(Range.exact(10)));
    assertThat(spec.getOriginalText(), is("height 10px"));
  }

  @Test public void shouldReadSpec_height_5_to_8px() throws IOException {
    SpecHeight spec = (SpecHeight) readSpec("height 5 to 8px");
    assertThat(spec.getRange(), is(Range.between(5, 8)));
    assertThat(spec.getOriginalText(), is("height 5 to 8px"));
  }

  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Unexpected token: 1234 px") public void shouldGiveError_width_unexcpected_token() {
    readSpec("width 10 to 40 px 1234 px ");
  }

  @Test public void shouldReadSpec_text_is_some_text() throws IOException {
  ...
  @Test public void shouldReadSpec_text_lowercase_uppercase_is() throws IOException {
  ...
  @Test public void shouldReadSpec_text_singleline() throws IOException {
  ...
  @Test public void shouldReadSpec_css_fontsize_is_18px() throws IOException {
  ...
  @Test public void shouldReadSpec_css_fontsize_starts() throws IOException {
  ...
  @Test public void shouldReadSpec_css_fontsize_ends() throws IOException {
  ...
  @Test public void shouldReadSpec_css_fontsize_contains() throws IOException {
  ...
  @Test public void shouldReadSpec_css_fontsize_matches() throws IOException {
  ...
  @Test public void shouldReadSpec_above_object_20px() throws IOException {
    SpecAbove spec = (SpecAbove) readSpec("above object 20px");
    assertThat(spec.getObject(), is("object"));
    assertThat(spec.getRange(), is(Range.exact(20)));
  }

  @Test public void shouldReadSpec_above_object_10_20px() throws IOException {
    SpecAbove spec = (SpecAbove) readSpec("above object 10 to 20px");
    assertThat(spec.getObject(), is("object"));
    assertThat(spec.getRange(), is(Range.between(10, 20)));
  }

  @Test public void shouldReadSpec_above() throws IOException {
    SpecAbove spec = (SpecAbove) readSpec("above object");
    assertThat(spec.getObject(), is("object"));
    assertThat(spec.getRange(), is(Range.greaterThanOrEquals(0)));
  }

  @Test public void shouldReadSpec_below() throws IOException {
    SpecBelow spec = (SpecBelow) readSpec("below object");
    assertThat(spec.getObject(), is("object"));
    assertThat(spec.getRange(), is(Range.greaterThanOrEquals(0)));
  }

  @Test public void shouldReadSpec_below_object_20px() throws IOException {
    SpecBelow spec = (SpecBelow) readSpec("below object 20px");
    assertThat(spec.getObject(), is("object"));
    assertThat(spec.getRange(), is(Range.exact(20)));
  }

  @Test public void shouldReadSpec_below_object_10_to_20px() throws IOException {
    SpecBelow spec = (SpecBelow) readSpec("below object 10 to 20px");
    assertThat(spec.getObject(), is("object"));
    assertThat(spec.getRange(), is(Range.between(10, 20)));
  }

  @Test public void shouldReadSpec_left_of_object_10px() throws IOException {
  ...
  @Test public void shouldReadSpec_right_of_object_10_to_20px() throws IOException {
  ...
  @Test public void shouldReadSpec_right_of_object() throws IOException {
  ...
  @Test(expectedExceptions = { SyntaxException.class }, expectedExceptionsMessageRegExp = "Missing validation type \\(is, contains, starts, ends, matches\\)") public void shouldGiveException_empty_css_spec() throws IOException {
    readSpec("css  \"18px\"");
  }

  @Test(expectedExceptions = { SyntaxException.class }, expectedExceptionsMessageRegExp = "Unknown validation type: \"18px\"") public void shouldGiveException_css_without_type() throws IOException {
    readSpec("css font-size \"18px\"");
  }

  @Test public void shouldReadSpec_centered_inside_object() throws IOException {
  ...
  @Test public void shouldReadSpec_centered_horizontally_inside_object() throws IOException {
  ...
  @Test public void shouldReadSpec_centered_vertically_inside_object() throws IOException {
  ...
  @Test public void shouldReadSpec_centered_all_inside_object() throws IOException {
  ...
  @Test public void shouldReadSpec_centered_all_on_object() throws IOException {
  ...
  @Test public void shouldReadSpec_centered_on_object() throws IOException {
  ...
  @Test public void shouldReadSpec_centered_horizontally_on_object() throws IOException {
  ...
  @Test public void shouldReadSpec_centered_horizontally_on_object_25px() throws IOException {
  ...
  @Test public void shouldReadSpec_centered_horizontally_on_object_25_px() throws IOException {
  ...
  @Test public void shouldReadSpec_centered_vertically_on_object() throws IOException {
  ...
  @Test public void shoulReadSpec_on_object_10px_left() throws IOException {
  ...
  @Test public void shoulReadSpec_on_object_10px_left_20px_top() throws IOException {
  ...
  @Test public void shouldReadSpec_on_top_object_10px_top_right() throws Exception {
  ...
  @Test public void shouldReadSpec_on_left_object_10px_top_right() throws Exception {
  ...
  @Test public void shouldReadSpec_on_bottom_right_object_10px_top_right() throws Exception {
  ...
  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Missing \"edge\"") public void shouldGiveError_missingEdges_forSpec_on() throws Exception {
    readSpec("on top left object 10px");
  }

  @Test public void shouldReadSpec_color_scheme_40percent_black_approx_30percent_white() throws Exception {
  ...
  @Test public void shouldReadSpec_color_scheme_greater_than_40percent_ffaa03() throws Exception {
  ...
  @Test public void shouldReadSpec_color_scheme_40_to_50percent_ffaa03() throws Exception {
  ...
  @Test public void shouldReadSpec_color_withShorthand_hexColorNotation() throws Exception {
  ...
  @Test public void shouldReadSpec_color_withGradients() throws Exception {
    SpecColorScheme spec = (SpecColorScheme) readSpec("color-scheme 40% white-green-blue");
    List<ColorRange> colors = spec.getColorRanges();
    assertThat(colors.size(), is(1));
    assertThat(colors.get(0).getRange(), is(Range.exact(40)));
    assertThat(colors.get(0).getColorClassifier(), is(new GradientColorClassifier("white-green-blue", asList(new Color(255, 255, 255), new Color(0, 255, 0), new Color(0, 0, 255)))));
  }

  @Test public void shouldReadSpec_color_withGradients_2() throws Exception {
    ...
    assertThat(colors.get(1).getColorClassifier(), is(new GradientColorClassifier("#a3f - #00e", asList(new Color(170, 51, 255), new Color(0, 0, 238)))));
  }

  @Test public void shouldReadSpec_image_withMaxPercentageError() throws IOException {
  ...
  @Test public void shouldReadSpec_image_withMaxPixelsError() throws IOException {
  ...
  @Test public void shouldReadSpec_image_withMaxPixelsError_tolerance5() throws IOException {
  ...
  @Test public void shouldReadSpec_image_withMaxPixelsError_tolerance5_stretch() throws IOException {
  ...
  @Test public void shouldReadSpec_image_withCropIfOutside() throws IOException {
    SpecImage spec = (SpecImage) readSpec("image file imgs/image.png, crop-if-outside");
    assertThat(spec.getImagePaths(), contains("imgs/image.png"));
    assertThat(spec.isCropIfOutside(), is(true));
  }

  @Test public void shouldReadSpec_image_withMaxPixelsError_tolerance5_filterBlur2() throws IOException {
  ...
  @Test public void shouldReadSpec_image_withMaxPixelsError_tolerance5_filterABlur2() throws IOException {
  ...
  @Test public void shouldReadSpec_image_withMaxPixelsError_tolerance5_filterBBlur2() throws IOException {
  ...
  @Test public void shouldReadSpec_image_withMaxPixelsError_tolerance5_filterBlur2_filterDenoise1() throws IOException {
  ...
  @Test public void shouldReadSpec_image_withMaxPixelsError_tolerance5_filterBlur2_filterSaturation10_mapFilterDenoise1() throws IOException {
  ...
  @Test public void shouldReadSpec_image_withMask() throws IOException {
  ...
  @Test public void shouldReadSpec_image_withMaxPixelsError_andArea() throws IOException {
  ...
  @Test public void shouldReadSpec_image_withAnalyzeOffset() throws IOException {
    SpecImage spec = (SpecImage) readSpec("image file imgs/image.png, analyze-offset 5");
    assertThat(spec.getImagePaths(), contains("imgs/image.png"));
    assertThat(spec.getAnalyzeOffset(), is(5));
  }

  @Test public void shouldReadSpec_image_andBuildImagePath_withContextPath() throws IOException {
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void shouldReadSpec_image_toleranceAndErrorRate_fromConfig() throws IOException {
  ...
  @Test public void shouldReadSpec_image_replaceColors() throws IOException {
  ...
  @Test public void shouldReadSpec_image_ignoredObjects() throws IOException {
  ...
  @Test public void shouldReadSpec_component() throws IOException {
  ...
  @Test public void shouldReadSpec_component_frame() throws IOException {
  ...
  @Test public void shouldReadSpec_component_withArguments_andRecogniseBasicTypes() throws IOException {
  ...
  @Test public void shouldReadSpec_count_any_pattern_is_6() throws IOException {
  ...
  @Test public void shouldReadSpec_count_visible_pattern_is_6() throws IOException {
  ...
  @Test public void shouldReadSpec_absent_visible_pattern_is_6() throws IOException {
  ...
  @Test public void shouldReadSpec_count_pattern_in_double_qoutes_is_6() throws IOException {
  ...
  @Test public void shouldReadSpec_count_pattern_is_6_to_8() throws IOException {
  ...
  @Test public void shouldReadSpec_count_pattern_is__lessThan_8() throws IOException {
  ...
  @Test public void shouldReadSpec_count_pattern_is__biggerThan_8() throws IOException {
    SpecCount spec = (SpecCount) readSpec("count any menu-item-* is > 8");
    assertThat(spec.getPattern(), is("menu-item-*"));
  ...
  @Test(expectedExceptions = SyntaxException.class, expectedExceptionsMessageRegExp = "Couldn\'t process: whatever non parsed arguments") public void shouldThrowError_whenSpecHasNotParsed_theWholeText() {
