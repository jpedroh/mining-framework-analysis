 ...
 */
@ExtendWith(value = CdiTestJunitExtension.class) @ExtendWith(value = MockitoExtension.class) class MockProxyTest {
  @Inject private SampleService sampleService;

  @Test void createPersonWithMockBackend(@Mock BackendService backendService) {
