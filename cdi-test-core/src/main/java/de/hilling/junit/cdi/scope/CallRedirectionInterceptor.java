 ...
 */
@Replaceable @Interceptor @Dependent @Priority(value = 0) public class CallRedirectionInterceptor implements Serializable {
  private static final long serialVersionUID = 1L;

  @Inject private transient Instance<InvocationTargetManager> invocationTargetManager;

  @AroundInvoke public Object invokeMockableBean(InvocationContext ctx) throws Throwable {
  ...
  @SuppressWarnings(value = { "squid:S00112" }) private Object callAlternative(InvocationContext ctx, Class<?> javaClass) throws Throwable {
  ...
  @SuppressWarnings(value = { "squid:S00112" }) private Object callMock(InvocationContext ctx, Class<?> javaClass) throws Throwable {
    try {
