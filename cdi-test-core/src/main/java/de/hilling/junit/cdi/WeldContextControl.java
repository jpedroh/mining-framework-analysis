 ...
 * </p>
 */
@Dependent public class WeldContextControl implements ContextControl {
  ...
  @Inject private Instance<BoundRequestContext> requestContextFactory;

  @Inject private BoundConversationContext conversationContext;

  @Override public void startContexts() {
  ...
  @Override public void startContext(Class<? extends Annotation> scopeClass) {
    if (scopeClass.isAssignableFrom(ApplicationScoped.class)) {
      ...
      if (scopeClass.isAssignableFrom(SessionScoped.class)) {
        startSessionScope();
      } else {
        if (scopeClass.isAssignableFrom(RequestScoped.class)) {
          startRequestScope();
        } else {
          if (scopeClass.isAssignableFrom(ConversationScoped.class)) {
            startConversationScope();
          }
        }
      }
  ...
  /**
     ...
     * {@inheritDoc}
     */
  @Override public void stopContexts() {
  ...
  @Override public void stopContext(Class<? extends Annotation> scopeClass) {
    if (scopeClass.isAssignableFrom(ApplicationScoped.class)) {
      stopApplicationScope();
    } else {
      if (scopeClass.isAssignableFrom(SessionScoped.class)) {
