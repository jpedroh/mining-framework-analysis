 ...
 */
@BypassTestInterceptor public class ContextControlWrapper {
  ...
  @SuppressWarnings(value = { "unchecked" }) public <T extends java.lang.Object> T getContextualReference(Class<T> beanType, Annotation... qualifiers) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private <T extends java.lang.Object> Bean<T> resolveBean(Class<T> beanType, Annotation[] qualifiers) {
    Set<Bean<?>> beans = weldManager.getBeans(beanType, qualifiers);
    return (Bean<T>) weldManager.resolve(beans);
  }

  public <T extends java.lang.Object> boolean hasNormalScope(Class<T> beanType, Annotation... qualifiers) {
