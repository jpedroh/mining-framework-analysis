 ...
 */
@Data @Accessors(fluent = true) public class LeaseManagementConfig {
...
<<<<<<< /usr/src/app/output/awslabs/amazon-kinesis-client/cc1a641641360af9459a0f68a6b58a08285cb9a8/amazon-kinesis-client/src/main/java/software/amazon/kinesis/leases/LeaseManagementConfig.java/left.java
  /**
...
>>>>>>> /usr/src/app/output/awslabs/amazon-kinesis-client/cc1a641641360af9459a0f68a6b58a08285cb9a8/amazon-kinesis-client/src/main/java/software/amazon/kinesis/leases/LeaseManagementConfig.java/right.java
  ...
  @Deprecated public LeaseManagementConfig(String tableName, DynamoDbAsyncClient dynamoDBClient, KinesisAsyncClient kinesisClient, String streamName, String workerIdentifier) {
  ...
  /**
     ...
     */
  @Deprecated public LeaseManagementConfig metricsFactory(final MetricsFactory metricsFactory) {
  ...
  public LeaseManagementFactory leaseManagementFactory(final LeaseSerializer leaseSerializer, boolean isMultiStreamingMode) {
    if (leaseManagementFactory == null) {
      leaseManagementFactory = new DynamoDBLeaseManagementFactory(kinesisClient(), dynamoDBClient(), tableName(), workerIdentifier(), executorService(), failoverTimeMillis(), epsilonMillis(), leaseTakerIntervalMillis, maxLeasesForWorker(), maxLeasesToStealAtOneTime(), maxLeaseRenewalThreads(), cleanupLeasesUponShardCompletion(), ignoreUnexpectedChildShards(), shardSyncIntervalMillis(), consistentReads(), listShardsBackoffTimeInMillis(), maxListShardsRetryAttempts(), maxCacheMissesBeforeReload(), listShardsCacheAllowedAgeInSeconds(), cacheMissWarningModulus(), initialLeaseTableReadCapacity(), initialLeaseTableWriteCapacity(), hierarchicalShardSyncer(), tableCreatorCallback(), dynamoDbRequestTimeout(), billingMode(), tags(), leaseSerializer, customShardDetectorProvider(), isMultiStreamingMode, leaseCleanupConfig());
    }
    return leaseManagementFactory;
  }
