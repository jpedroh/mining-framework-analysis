...
@RunWith(value = MockitoJUnitRunner.class) public class ConfigsBuilderTest {
  private KinesisAsyncClient mockKinesisClient;

  @Mock private DynamoDbAsyncClient mockDynamoClient;

  @Mock private CloudWatchAsyncClient mockCloudWatchClient;

  @Mock private ShardRecordProcessorFactory mockShardProcessorFactory;
