...
@RunWith(value = MockitoJUnitRunner.class) public class RetrievalConfigTest {
  ...
  @Mock private MultiStreamTracker mockMultiStreamTracker;
  ...
  @Test public void testTrackerConstruction() {
  ...
  @Test public void testUpdateInitialPositionInSingleStream() {
  ...
  @Test(expected = IllegalArgumentException.class) public void testUpdateInitialPositionInMultiStream() {
    createConfig(mockMultiStreamTracker).initialPositionInStreamExtended(InitialPositionInStreamExtended.newInitialPosition(TRIM_HORIZON));
  }
  ...
  /**
     ...
     * a valid one.
     */
  @Test public void testInvalidRetrievalSpecificConfig() {
