...
@RunWith(value = MockitoJUnitRunner.class) public class DynamoDBLeaseCoordinatorTest {
  ...
  @Test public void testInitialize_tableCreationSucceeds() throws Exception {
  ...
  @Test(expected = DependencyException.class) public void testInitialize_tableCreationFails() throws Exception {
  ...
  /**
     ...
     */
  @Test public void testStopLeaseTakerBeforeStart() {
