...
@RunWith(value = MockitoJUnitRunner.class) public class ConsumerStatesTest {
  private static final String STREAM_NAME = "TestStream";

  private static final InitialPositionInStreamExtended INITIAL_POSITION_IN_STREAM = InitialPositionInStreamExtended.newInitialPosition(InitialPositionInStream.TRIM_HORIZON);
  ...
  @Mock private InitialPositionInStreamExtended initialPositionInStream;
  ...
  @Mock private 
<<<<<<< /usr/src/app/output/awslabs/amazon-kinesis-client/36279f349fcc63549b753d5eda57eaf0540b5db2/amazon-kinesis-client/src/test/java/software/amazon/kinesis/lifecycle/ConsumerStatesTest.java/left.java
  TaskExecutionListener
=======
  HierarchicalShardSyncer
>>>>>>> /usr/src/app/output/awslabs/amazon-kinesis-client/36279f349fcc63549b753d5eda57eaf0540b5db2/amazon-kinesis-client/src/test/java/software/amazon/kinesis/lifecycle/ConsumerStatesTest.java/right.java
...
>>>>>>> /usr/src/app/output/awslabs/amazon-kinesis-client/36279f349fcc63549b753d5eda57eaf0540b5db2/amazon-kinesis-client/src/test/java/software/amazon/kinesis/lifecycle/ConsumerStatesTest.java/right.java
  ...
  @Mock private ProcessRecordsInput processRecordsInput;
  ...
  @Before public void setup() {
    ...
    consumer = spy(new ShardConsumer(recordsPublisher, executorService, shardInfo, logWarningForTaskAfterMillis, argument, taskExecutionListener));
  ...
  @Test public void blockOnParentStateTest() {
    ...
    assertThat(task, taskWith(BlockOnParentShardTask.class, LEASE_REFRESHER_CLASS, "leaseRefresher", equalTo(leaseRefresher)));
    assertThat(task, taskWith(BlockOnParentShardTask.class, Long.class, "parentShardPollIntervalMillis", equalTo(parentShardPollIntervalMillis)));
    ...
    for (ShutdownReason shutdownReason : ShutdownReason.values()) {
      assertThat(state.shutdownTransition(shutdownReason), equalTo(ShardConsumerState.SHUTDOWN_COMPLETE.consumerState()));
    }
  ...
  @Test public void initializingStateTest() {
    ...
    assertThat(task, initTask(ShardRecordProcessorCheckpointer.class, "recordProcessorCheckpointer", equalTo(recordProcessorCheckpointer)));
    ...
    assertThat(state.shutdownTransition(ShutdownReason.LEASE_LOST), equalTo(ShardConsumerState.SHUTTING_DOWN.consumerState()));
    assertThat(state.shutdownTransition(ShutdownReason.SHARD_END), equalTo(ShardConsumerState.SHUTTING_DOWN.consumerState()));
    assertThat(state.shutdownTransition(ShutdownReason.REQUESTED), equalTo(ShardConsumerState.SHUTDOWN_REQUESTED.consumerState()));
    assertThat(state.state(), equalTo(ShardConsumerState.INITIALIZING));
    assertThat(state.taskType(), equalTo(TaskType.INITIALIZE));
  }

  @Test public void processingStateTestSynchronous() {
    ...
    assertThat(task, procTask(ShardRecordProcessorCheckpointer.class, "recordProcessorCheckpointer", equalTo(recordProcessorCheckpointer)));
  ...
  @Test public void processingStateTestAsynchronous() {
    ConsumerState state = ShardConsumerState.PROCESSING.consumerState();
    ConsumerTask task = state.createTask(argument, consumer, null);
    assertThat(task, procTask(ShardInfo.class, "shardInfo", equalTo(shardInfo)));
    assertThat(task, procTask(ShardRecordProcessor.class, "shardRecordProcessor", equalTo(shardRecordProcessor)));
  ...
  @Test public void processingStateRecordsFetcher() {
    ConsumerState state = ShardConsumerState.PROCESSING.consumerState();
    ConsumerTask task = state.createTask(argument, consumer, null);
    assertThat(task, procTask(ShardInfo.class, "shardInfo", equalTo(shardInfo)));
    assertThat(task, procTask(ShardRecordProcessor.class, "shardRecordProcessor", equalTo(shardRecordProcessor)));
  ...
  @Test public void shutdownRequestState() {
    ...
    assertThat(task, shutdownReqTask(RecordProcessorCheckpointer.class, "recordProcessorCheckpointer", equalTo(recordProcessorCheckpointer)));
    ...
    assertThat(state.shutdownTransition(ShutdownReason.REQUESTED), equalTo(ConsumerStates.SHUTDOWN_REQUEST_COMPLETION_STATE));
    assertThat(state.shutdownTransition(ShutdownReason.LEASE_LOST), equalTo(ShardConsumerState.SHUTTING_DOWN.consumerState()));
    assertThat(state.shutdownTransition(ShutdownReason.SHARD_END), equalTo(ShardConsumerState.SHUTTING_DOWN.consumerState()));
  ...
  @Ignore @Test public void shuttingDownStateTest() {
    ...
    assertThat(task, shutdownTask(ShardRecordProcessorCheckpointer.class, "recordProcessorCheckpointer", equalTo(recordProcessorCheckpointer)));
    ...
    assertThat(task, shutdownTask(InitialPositionInStreamExtended.class, "initialPositionInStream", equalTo(initialPositionInStream)));
    assertThat(task, shutdownTask(Boolean.class, "cleanupLeasesOfCompletedShards", equalTo(cleanupLeasesOfCompletedShards)));
  ...
  @Test public void shutdownCompleteStateTest() {
    consumer.gracefulShutdown(shutdownNotification);
  ...
  @Test public void shutdownCompleteStateNullNotificationTest() {
    ConsumerState state = ShardConsumerState.SHUTDOWN_COMPLETE.consumerState();
  ...
  static <ValueType extends java.lang.Object> ReflectionPropertyMatcher<ShutdownTask, ValueType> shutdownTask(Class<ValueType> valueTypeClass, String propertyName, Matcher<ValueType> matcher) {
    return taskWith(ShutdownTask.class, valueTypeClass, propertyName, matcher);
  }

  static <ValueType extends java.lang.Object> ReflectionPropertyMatcher<ShutdownNotificationTask, ValueType> shutdownReqTask(Class<ValueType> valueTypeClass, String propertyName, Matcher<ValueType> matcher) {
    return taskWith(ShutdownNotificationTask.class, valueTypeClass, propertyName, matcher);
  }

  static <ValueType extends java.lang.Object> ReflectionPropertyMatcher<ProcessTask, ValueType> procTask(Class<ValueType> valueTypeClass, String propertyName, Matcher<ValueType> matcher) {
    return taskWith(ProcessTask.class, valueTypeClass, propertyName, matcher);
  }

  static <ValueType extends java.lang.Object> ReflectionPropertyMatcher<InitializeTask, ValueType> initTask(Class<ValueType> valueTypeClass, String propertyName, Matcher<ValueType> matcher) {
    return taskWith(InitializeTask.class, valueTypeClass, propertyName, matcher);
  }

  static <TaskType extends java.lang.Object, ValueType extends java.lang.Object> ReflectionPropertyMatcher<TaskType, ValueType> taskWith(Class<TaskType> taskTypeClass, Class<ValueType> valueTypeClass, String propertyName, Matcher<ValueType> matcher) {
    return new ReflectionPropertyMatcher<>(taskTypeClass, valueTypeClass, matcher, propertyName);
  }

  private static class ReflectionPropertyMatcher<TaskType extends java.lang.Object, ValueType extends java.lang.Object> extends TypeSafeDiagnosingMatcher<ConsumerTask> {
    ...
    @Override protected boolean matchesSafely(ConsumerTask item, Description mismatchDescription) {
      return Condition.matched(item, mismatchDescription).and(new Condition.Step<ConsumerTask, TaskType>() {
        @Override public Condition<TaskType> apply(ConsumerTask value, Description mismatch) {
        ...
        @Override public Condition<Object> apply(TaskType value, Description mismatch) {
        ...
        @Override public Condition<ValueType> apply(Object value, Description mismatch) {
