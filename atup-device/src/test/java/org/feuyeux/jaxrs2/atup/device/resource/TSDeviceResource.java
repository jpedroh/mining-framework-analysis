...
@ContextConfiguration(locations = { "classpath:applicationContext.xml" }) @RunWith(value = SpringJUnit4ClassRunner.class) public class TSDeviceResource {
  ...
  @Test public void testFindAll() {
    ...
    final AtupDevice device = request.rest(AtupRequest.GET, TSDeviceResource.BASE_URI + AtupApi.DEVICE_PATH + "/1", null, null, MediaType.APPLICATION_JSON_TYPE, AtupDevice.class);
    log.info(device);
  }
}