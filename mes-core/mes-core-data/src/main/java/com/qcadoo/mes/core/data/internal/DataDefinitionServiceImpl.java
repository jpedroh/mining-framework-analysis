...
@Service public final class DataDefinitionServiceImpl implements DataDefinitionService {
  ...
  private DataDefinition createProductDefinition() {
    ...
    dataDefinition.setFields(Arrays.asList(new FieldDefinition[] { fieldNumber, fieldName, fieldTypeOfMaterial, fieldEan, fieldCategory, fieldUnit }));
  ...
  private DataDefinition createSubstituteDefinition() {
    ...
    dataDefinition.setGrids(Arrays.asList(new GridDefinition[] { gridDefinition }));
    dataDefinition.setFields(Arrays.asList(new FieldDefinition[] { fieldNumber, fieldName, fieldPriority, fieldEffectiveDateFrom, fieldEffectiveDateTo, fieldProduct }));
    ColumnDefinition columnNumber = createColumnDefinition("number", fieldNumber, null);
    ColumnDefinition columnName = createColumnDefinition("name", fieldName, null);
  ...
  private DataDefinition createSubstituteComponentDefinition() {
    ...
    ColumnDefinition columnSubstituteNumber = createColumnDefinition("number", fieldProduct, "fields[\'product\'].fields[\'number\']");
    ...
    gridDefinition.setColumns(Arrays.asList(new ColumnDefinition[] { columnSubstituteNumber, columnProductName, columnQuantity }));
    return dataDefinition;
  }
