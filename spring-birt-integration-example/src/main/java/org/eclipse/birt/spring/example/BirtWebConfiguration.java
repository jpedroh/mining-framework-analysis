 ...
 * @author Josh Long
 */
@EnableWebMvc @ComponentScan(basePackageClasses = { BirtWebConfiguration.class }) @Configuration public class BirtWebConfiguration extends WebMvcConfigurerAdapter {
  static private final String HTML_BIRT = "html", PDF_BIRT = "pdf";

  @Inject BirtDataServiceConfiguration birtDataServiceConfiguration;
  ...
  @Bean(name = HTML_BIRT) public HtmlSingleFormatBirtView htmlBirt() throws Exception {
  ...
  @Bean public ViewResolver beanNameResolver() {
    return new BeanNameViewResolver();
  }

  @Bean public BirtEngineFactory engine() {
