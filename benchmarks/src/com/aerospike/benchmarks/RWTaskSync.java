...
public class RWTaskSync extends RWTask implements Runnable {
  ...
  @Override protected void put(WritePolicy writePolicy, Key key, Bin[] bins) {
  ...
  @Override protected void get(Key key) {
    Record record;
    if (counters.read.latency != null) {
      long begin = System.nanoTime();
  ...
  @Override protected void get(Key[] keys, String binName) {
    Record[] records;
    if (counters.read.latency != null) {
      long begin = System.nanoTime();
  ...
  @Override protected void get(Key[] keys) {
    Record[] records;
    if (counters.read.latency != null) {
      long begin = System.nanoTime();
