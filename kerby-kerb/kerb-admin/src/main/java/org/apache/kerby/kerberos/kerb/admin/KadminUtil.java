...
public final class KadminUtil {
  ...
  static IdentityBackend getBackend(Config backendConfig) throws KrbException {
    String backendClassName = backendConfig.getString(KdcConfigKey.KDC_IDENTITY_BACKEND);
  ...
  static void exportKeytab(File keytabFile, KrbIdentity identity) throws KrbException {
...
>>>>>>> /usr/src/app/output/apache/directory-kerby/4832ef6c97920c89220f22d3e7f1998733af07e5/kerby-kerb/kerb-admin/src/main/java/org/apache/kerby/kerberos/kerb/admin/KadminUtil.java/right.java
  }
