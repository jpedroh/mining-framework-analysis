...
public abstract class BaseCondition extends BaseNode implements Leaf {
  ...
  @Override public final void run(float delta) {
  ...
  @Override public final void addChild(BaseNode child) {
  }

  @Override public final void childTerminated(BaseNode child, State state) {
  }
