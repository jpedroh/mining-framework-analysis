...
@RequiredArgsConstructor public class QueryHandler extends SimpleChannelInboundHandler<DatagramPacket> {
  ...
  @Override protected void channelRead0(ChannelHandlerContext ctx, DatagramPacket msg) throws Exception {
    ...
    if (type == 0x00) {
      ...
      if (in.readableBytes() == 0) {
        ...
        writeString(out, "SMP");
        writeString(out, "BotFilter_by_vk.com/Leymooo_s");
        writeNumber(out, bungee.getFakeOnlineCountWithGG());
        ...
        if (in.readableBytes() == 4) {
          ...
          data.put("version", "BotFilter 1.8-1.12.1 by vk.com Leymooo_s");
          data.put("plugins", "");
          data.put("map", "BotFilter_by_vk.com/Leymooo_s");
          data.put("numplayers", Integer.toString(bungee.getFakeOnlineCountWithGG()));
  ...
  @Data private static class QuerySession {
