...
public final class GPData {
  ...
  static {
    sw.put(0x6400, "No specific diagnosis");
    sw.put(0x6700, "Wrong length (Lc)");
    sw.put(0x6D00, "Invalid INStruction");
    sw.put(0x6E00, "Invalid CLAss");
    sw.put(0x6283, "Card Life Cycle State is CARD_LOCKED");
    sw.put(0x6581, "Memory failure");
    sw.put(0x6882, "Secure messaging not supported");
    sw.put(0x6982, "Security status not satisfied");
    sw.put(0x6985, "Conditions of use not satisfied");
    sw.put(0x6A80, "Wrong data/incorrect values in data");
    sw.put(0x6A81, "Function not supported e.g. card Life Cycle State is CARD_LOCKED");
    sw.put(0x6A82, "Application/file not found");
    sw.put(0x6A84, "Not enough memory space");
    sw.put(0x6A86, "Incorrect P1/P2");
    sw.put(0x6A88, "Referenced data not found");
  }
      ...
      if (isdd != null) {
        for (BerTlv vt : isdd.getValues()) {
          if (vt.isTag(new BerTag(0x06))) {
            ...
            if (vt.isTag(new BerTag(0x60))) {
              String oid = logAndGetOidFromByteArray(vt.getTag().bytes, vt.getValues().get(0).getBytesValue());
              ...
              if (vt.isTag(new BerTag(0x63))) {
                ...
                if (vt.isTag(new BerTag(0x64))) {
                  ...
                  if (vt.isTag(new BerTag(0x65))) {
                  } else {
                    if (vt.isTag(new BerTag(0x66))) {
                      String oid = logAndGetOidFromByteArray(vt.getTag().bytes, vt.getValues().get(0).getBytesValue());
                      ...
                      if (vt.isTag(new BerTag(0x67))) {
                      } else {
                        if (vt.isTag(new BerTag(0x68))) {
                        }
                      }
                    }
                  }
