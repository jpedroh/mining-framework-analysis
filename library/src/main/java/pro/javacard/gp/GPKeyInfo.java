...
public final class GPKeyInfo {
    ...
    static final Map<Integer, String> keyVersionPurposes;
    ...
    private static Optional<String> getKeyDescription(GPKeyInfo k) {
        ...
        Optional<String> f = ((k.getVersion() == 0x0) || (k.getVersion() == 0xff)) ? Optional.of("factory key") : Optional.empty();
    ...
    static class GPKeyInfoElement {
        ...
        @Override
        public String toString() {
            return (((((("GPKeyInfoElement{" + "key=") + key) + ", keyLength=") + keyLength) + ", templateLength=") + templateLength) + '}';
        }
        ...
        public boolean equals(Object o) {
            ...
            return ((keyLength == that.keyLength) && (templateLength == that.templateLength)) && (key == that.key);
        }
    ...
    public enum GPKey {
        ...
        // Special
        PRIVATE(0x0, "Reserved for private use"),
