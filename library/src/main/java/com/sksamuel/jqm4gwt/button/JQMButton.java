...
public class JQMButton extends JQMWidget implements HasText<JQMButton>, HasRel<JQMButton>, HasTransition<JQMButton>, HasClickHandlers, HasInline<JQMButton>, HasIcon<JQMButton>, HasCorners<JQMButton>, HasIconShadow<JQMButton>, HasMini<JQMButton>, HasTapHandlers {
  ...
  private static String getCurrentTheme(Element elt) {
    ...
    for (Entry<String, String> i : currentThemeSearch.entrySet()) {
      String v = i.getValue();
      String s = v == null ? JQMCommon.getStyleStartsWith(elt, i.getKey()) : JQMCommon.getStyleStartsWith(elt, i.getKey(), v);
      if (s != null && !s.isEmpty()) {
  ...
  public static void initEltAsButton(Element elt) {
    ...
    if (tag == null || !tag.equals("BUTTON")) {
      JQMCommon.setRole(elt, "button");
    }
  ...
  /**
     ...
     * set the position to IconPos.NOTEXT
     */
  @Override public JQMButton withIconPos(IconPos pos) {
    setIconPos(pos);
    return this;
  }
  ...
  @Override public boolean isIconShadow() {
    return JQMCommon.isIconShadow(this);
  }

  /** Applies the drop shadow icon style to the select button if set to true. */
  @Override public void setIconShadow(boolean shadow) {
    JQMCommon.setIconShadow(this, shadow);
  }

  /** Applies the drop shadow icon style to the select button if set to true. */
  @Override public JQMButton withIconShadow(boolean shadow) {
  ...
  @Override public JQMButton withCorners(boolean corners) {
    setCorners(corners);
    return this;
  }
  ...
  @Override public JQMButton removeIcon() {
  ...
  /**
     * Sets the icon used by this button. See {@link DataIcon}.
     */
  @Override public JQMButton withBuiltInIcon(DataIcon icon) {
    setBuiltInIcon(icon);
    return this;
  }

  @Override public JQMButton withIconURL(String src) {
    setIconURL(src);
    return this;
  }
  ...
  /**
     ...
     * @param inline true to change to line or false to switch to full width
     */
  @Override public JQMButton withInline(boolean inline) {
    setInline(inline);
    return this;
  }
  ...
  /**
     * If set to true then renders a smaller version of the standard-sized element.
     */
  @Override public JQMButton withMini(boolean mini) {
    setMini(mini);
    return this;
  }
  ...
  @Override public void setRel(String rel) {
    JQMCommon.setAttribute(getElement(), "data-rel", rel);
  }

  @Override public JQMButton withRel(String rel) {
    setRel(rel);
    return this;
  }
  ...
  @Override public JQMButton withText(String text) {
    setText(text);
    return this;
  }
  ...
  /**
     ...
     */
  @Override public void setTransition(Transition transition) {
  ...
  /**
     * Sets the transition to be used by this button when loading the URL.
     */
  @Override public JQMButton withTransition(Transition transition) {
  ...
  public void setAlwaysActive(boolean value) {
    ...
    if (alwaysActive) {
      Scheduler.get().scheduleFinally(createAlwaysActiveCmd());
    }
  }
  ...
  private Scheduler.RepeatingCommand createAlwaysActiveCmd() {
    return new Scheduler.RepeatingCommand() {
      @Override public boolean execute() {
        if (alwaysActive) {
          JQMCommon.setBtnActive(JQMButton.this, true);
        }
        return alwaysActive;
      }
    };
  ...
  private void prepareHoverStyle() {
    ...
    String ruleIE = ".ui-btn-" + theme + ".ui-btn:hover";
    ...
    if (hoverStyle != null) {
      ...
      if (hoverStyle != null) {
        cachedCssRules.put(ruleIE, hoverStyle);
      }
    }
  }

  @Override public String getTheme() {
    return JQMCommon.getThemeEx(this, JQMCommon.STYLE_UI_BTN, JQMCommon.STYLE_UI_BTN_INLINE, JQMCommon.STYLE_UI_BTN_ICONPOS, JQMCommon.STYLE_UI_BTN_ACTIVE);
  }
  ...
  public static void setTheme(Element elt, String themeName) {
    JQMCommon.setThemeEx(elt, themeName, JQMCommon.STYLE_UI_BTN, JQMCommon.STYLE_UI_BTN_INLINE, JQMCommon.STYLE_UI_BTN_ICONPOS, JQMCommon.STYLE_UI_BTN_ACTIVE);
  }
  ...
  public PosOnBand getPosOnBand() {
    if (JQMCommon.hasStyle(this, STYLE_UI_BTN_RIGHT)) {
      return PosOnBand.RIGHT;
    } else {
      if (JQMCommon.hasStyle(this, STYLE_UI_BTN_LEFT)) {
        return PosOnBand.LEFT;
      } else {
        return null;
      }
    }
