...
public abstract class JQMToolbar extends JQMWidget implements HasText, HasFixedPosition {
  ...
  @UiChild(tagname = "widget") public void add(Widget w) {
    flow.add(w);
  }
  ...
  @Override public final boolean isFixed() {
    return "fixed".equals(getAttribute("data-position"));
  }

  @Override public final void setFixed(boolean fixed) {
    if (fixed) {
  ...
  public void setTapToggle(boolean value) {
    if (value) {
      removeAttribute("data-tap-toggle");
    } else {
      setAttribute("data-tap-toggle", "false");
    }
  }
  ...
  public void setUpdatePagePadding(boolean value) {
    if (value) {
      removeAttribute("data-update-page-padding");
    } else {
      setAttribute("data-update-page-padding", "false");
    }
  }
