...
public class JQMHeader extends JQMToolbar implements HasText<JQMHeader>, HasJqmHeader {
  ...
  /**
     ...
     *              the new back button
     */
  @UiChild(tagname = "backButton", limit = 1) public void setBackButton(JQMButton button) {
    button.setBack(true);
  ...
  /**
     ...
     */
  @UiChild(tagname = "rightButton", limit = 1) public void setRightButton(JQMButton button) {
    if (right != null) {
      remove(right);
    }
  ...
  @Override public JQMHeader withText(String text) {
    setText(text);
    return this;
  }
  ...
  @Override public JQMHeader getJqmHeader() {
    return this;
  }

  @Override public Composite getHeaderStage() {
    return this;
  }
}