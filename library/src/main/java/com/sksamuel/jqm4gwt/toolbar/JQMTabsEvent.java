...
public class JQMTabsEvent extends GwtEvent<JQMTabsEvent.Handler> {
  ...
  public static class DefaultHandler implements Handler {
    @Override public void onActivate(JQMTabsEvent event) {
    }

    @Override public void onBeforeActivate(JQMTabsEvent event) {
    }
  }
  ...
  /**
     ...
     */
  public static <S extends HasAttachHandlers> void fire(S source, TabsState tabsState, Widget newTabHeader, Widget oldTabHeader, Widget newTabContent, Widget oldTabContent) {
    if (TYPE != null) {
      JQMTabsEvent event = new JQMTabsEvent(tabsState, newTabHeader, oldTabHeader, newTabContent, oldTabContent);
  ...
  @Override public final Type<JQMTabsEvent.Handler> getAssociatedType() {
    return TYPE;
  }
  ...
  @Override protected void dispatch(JQMTabsEvent.Handler handler) {
    switch (tabsState) {
      case ACTIVATE:
