...
public class JQMControlGroup extends JQMPanel implements HasOrientation<JQMControlGroup>, HasMini<JQMControlGroup>, HasCorners<JQMControlGroup>, HasFilterable {
  ...
  @Override public boolean isHorizontal() {
    return "horizontal".equals(getAttribute("data-type"));
  }

  @Override public void setHorizontal() {
    setAttribute("data-type", "horizontal");
  }

  @Override public JQMControlGroup withHorizontal() {
    setHorizontal();
    return this;
  }
  ...
  @Override public void setVertical() {
    removeAttribute("data-type");
  }

  @Override public JQMControlGroup withVertical() {
    setVertical();
    return this;
  }
  ...
  /** If set to true then renders a smaller version of the standard-sized element. */
  @Override public JQMControlGroup withMini(boolean mini) {
    setMini(mini);
    return this;
  }
  ...
  @Override public JQMControlGroup withCorners(boolean corners) {
    setCorners(corners);
    return this;
  }
