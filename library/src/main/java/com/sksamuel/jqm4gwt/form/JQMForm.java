...
public class JQMForm extends FlowPanel {
  ...
  /**
     ...
     */
  @Deprecated public void addValidator(JQMFormWidget widget, Validator validator) {
  ...
  public void submit(String... submitMsgs) {
    ...
    if (validated) {
      ...
      @SuppressWarnings(value = { "unchecked" }) SubmissionHandler<JQMForm> h = (SubmissionHandler<JQMForm>) submissionHandler;
      h.onSubmit(this);
    } else {
      scrollToFirstError();
    }
