...
public class JQMSelect extends JQMFieldContainer implements HasNative<JQMSelect>, HasText<JQMSelect>, HasFocusHandlers, HasChangeHandlers, HasClickHandlers, HasTapHandlers, HasValue<String>, JQMFormWidget, HasIcon<JQMSelect>, HasPreventFocusZoom, HasCorners<JQMSelect>, HasMini<JQMSelect>, Focusable {
  ...
  protected class ListBoxEx extends ListBox {
    ...
    @Override public void setOptionText(OptionElement option, String text, Direction dir) {
  ...
  @UiChild public void addOption(Option option) {
    addOption(option.value, option.text, option.filterText, option.isPlaceholder(), option.isSelected(), option.isDisabled(), option.getIcon(), option.getCustomIcon());
  }
  ...
  private static void prepareOption(OptionElement opt, String value, String filterText, boolean placeholder, boolean selected, boolean disabled, DataIcon icon, String customIcon) {
    if (value == null) {
      JQMCommon.setAttribute(opt, "value", null);
    }
    if (filterText != null && !filterText.isEmpty()) {
      JQMCommon.setFilterText(opt, filterText);
    }
    if (placeholder) {
      JQMCommon.setAttribute(opt, "data-placeholder", "true");
    }
    if (selected) {
      JQMCommon.setAttribute(opt, "selected", "selected");
    }
    if (disabled) {
      JQMCommon.setAttribute(opt, "disabled", "disabled");
    }
    if (icon != null) {
      JQMCommon.setIcon(opt, icon);
    } else {
      if (customIcon != null) {
        JQMCommon.setIcon(opt, customIcon);
      }
    }
  }

  private void addOption(String value, String text, String filterText, boolean placeholder, boolean selected, boolean disabled, DataIcon icon, String customIcon) {
    if (addingOptions) {
      OptionElement opt = Document.get().createOptionElement();
      select.setOptionText(opt, text, null);
      opt.setValue(value);
      ...
      if (value == null || (filterText != null && !filterText.isEmpty()) || placeholder || selected || disabled || icon != null || customIcon != null) {
  ...
  public void beginAddOptions(int initialCapacity) {
    addingOptions = true;
    addingOptionList = initialCapacity < 0 ? new ArrayList<OptionElement>() : new ArrayList<OptionElement>(initialCapacity);
  }
  ...
  private void addOption(String value, String text, String filterText, boolean placeholder, boolean selected, boolean disabled) {
    addOption(value, text, filterText, placeholder, selected, disabled, null, null);
  }

  public void addOption(String value, String text, String filterText) {
    addOption(value, text, filterText, false, false, false);
  }
  ...
  @Override public IconPos getIconPos() {
    return JQMCommon.getIconPos(select);
  }

  /** Sets the position of the icon. */
  @Override public void setIconPos(IconPos pos) {
    JQMCommon.setIconPos(select, pos);
  }

  /** Sets the position of the icon. */
  @Override public JQMSelect withIconPos(IconPos pos) {
    setIconPos(pos);
    return this;
  }
  ...
  /** If set to true then renders a smaller version of the standard-sized element. */
  @Override public JQMSelect withMini(boolean mini) {
    setMini(mini);
    return this;
  }
  ...
  @Override public JQMSelect withCorners(boolean corners) {
    setCorners(corners);
    return this;
  }
  ...
  @Override public void setNative(boolean value) {
    JQMCommon.setAttribute(select, "data-native-menu", value ? null : "false");
  }

  @Override public JQMSelect withNative(boolean value) {
    setNative(value);
    return this;
  }
  ...
  @Override public JQMSelect removeIcon() {
  ...
  /**
     ...
     */
  @Override public void setBuiltInIcon(DataIcon icon) {
    String oldIcon = JQMCommon.getCustomIcon(select.getElement());
    oldIcon = oldIcon == null ? "" : JQMCommon.STYLE_UI_ICON + oldIcon;
  ...
  @Override public void setIconURL(String src) {
    String oldIcon = JQMCommon.getCustomIcon(select.getElement());
    oldIcon = oldIcon == null ? "" : JQMCommon.STYLE_UI_ICON + oldIcon;
  ...
  /**
     * Sets the icon used by this button. See {@link DataIcon}.
     */
  @Override public JQMSelect withBuiltInIcon(DataIcon icon) {
    setBuiltInIcon(icon);
    return this;
  }

  @Override public JQMSelect withIconURL(String src) {
    setIconURL(src);
    return this;
  }
  ...
  @Override public JQMSelect withText(String text) {
    setText(text);
    return this;
  }
  ...
  @Override protected Widget getDataFilterWidget() {
    return select;
  }
  ...
  protected void doDlgBeforeShow(Element dialog, Element prevPage) {
    ...
    if (transparent) {
      dialog.addClassName(JQMPage.JQM4GWT_DLG_TRANSPARENT);
    } else {
      dialog.removeClassName(JQMPage.JQM4GWT_DLG_TRANSPARENT);
    }
  }
