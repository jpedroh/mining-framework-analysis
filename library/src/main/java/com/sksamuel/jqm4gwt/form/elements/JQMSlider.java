...
public class JQMSlider extends JQMFieldContainer implements HasValue<Double>, HasMini<JQMSlider>, HasText<JQMSlider>, HasCorners<JQMSlider>, HasChangeHandlers, HasClickHandlers, HasTapHandlers {
  ...
  @Override public HandlerRegistration addValueChangeHandler(ValueChangeHandler<Double> handler) {
  ...
  @Override public JQMSlider withTheme(String themeName) {
    setTheme(themeName);
    return this;
  }
  ...
  /**
     * If set to true then renders a smaller version of the standard-sized element.
     */
  @Override public JQMSlider withMini(boolean mini) {
    setMini(mini);
    return this;
  }
  ...
  @Override public JQMSlider withText(String text) {
    setText(text);
    return this;
  }
  ...
  /**
     ...
     * @param value the new value of the slider, must be in the range of the slider
     */
  @Override public void setValue(Double value, boolean fireEvents) {
    Double old = getValue();
  ...
  @Override public JQMSlider withCorners(boolean corners) {
    setCorners(corners);
    return this;
  }
}