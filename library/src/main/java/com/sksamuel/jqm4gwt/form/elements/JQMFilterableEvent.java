...
public class JQMFilterableEvent extends GwtEvent<JQMFilterableEvent.Handler> {
  ...
  public static class DefaultHandler implements Handler {
    @Override public void onBeforeFilter(JQMFilterableEvent event) {
    }

    @Override public Boolean onFiltering(JQMFilterableEvent event) {
      return null;
    }
  }
  ...
  public Boolean filterStartWithIgnoreCase() {
    return filterStartWithIgnoreCase(null);
  }
  ...
  @Override public final Type<JQMFilterableEvent.Handler> getAssociatedType() {
    return TYPE;
  }
  ...
  @Override protected void dispatch(JQMFilterableEvent.Handler handler) {
