...
public class JQMPopup extends JQMContainer {
  ...
  @Override public String getRelType() {
    return "popup";
  }
  ...
  public static class PopupOptions {
    ...
    @Override public String toString() {
      return "PopupOptions [x=" + JQMContext.round(x, 2) + ", y=" + JQMContext.round(y, 2) + ", positionTo=" + positionTo + "]";
    }
  }
  ...
  protected void doBeforePosition(JavaScriptObject openOptions) {
    ...
    if (newP == null) {
      if (p != null && !p.isEmpty()) {
        JQMContext.deleteJsObjProperty(openOptions, "positionTo");
      }
    } else {
    ...
    if (newX == null) {
      if (x != null) {
        JQMContext.deleteJsObjProperty(openOptions, "x");
      }
    } else {
    ...
    if (newY == null) {
      if (y != null) {
        JQMContext.deleteJsObjProperty(openOptions, "y");
      }
    } else {
  ...
  public static class EltCoords {
    ...
    @Override public String toString() {
      return "EltCoords [left=" + JQMContext.round(left, 2) + ", top=" + JQMContext.round(top, 2) + ", width=" + JQMContext.round(width, 2) + ", height=" + JQMContext.round(height, 2) + "]";
    }
  }
