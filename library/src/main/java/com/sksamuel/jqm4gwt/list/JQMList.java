...
public class JQMList extends JQMWidget implements HasClickHandlers, HasTapHandlers, HasInset<JQMList>, HasFilter<JQMList>, HasCorners<JQMList> {
  ...
  /**
     * For UiBinder.
     */
  @UiChild(tagname = "divider") public void appendDivider(JQMListDivider divider) {
  ...
  /**
     ...
     */
  public JQMListItem addItem(String text, String url, ListItemImageKind imageKind, String imageUrl) {
    return addItem(items.size(), text, url, imageKind, imageUrl);
  }

  public JQMListItem addItem(int index, String text, String url, ListItemImageKind imageKind, String imageUrl) {
  ...
  /**
     * For UiBinder.
     */
  @UiChild(tagname = "item") public void appendItem(JQMListItem item) {
  ...
  @Override public JQMList withFilterable(boolean filterable) {
  ...
  @Override public boolean isFilterReveal() {
    return "true".equals(JQMCommon.getAttribute(this, "data-filter-reveal"));
  }

  @Override public void setFilterReveal(boolean value) {
    JQMCommon.setAttribute(this, "data-filter-reveal", value ? "true" : null);
  }

  @Override protected Element getFilterSearchElt() {
  ...
  public void setAllChecked(boolean checked) {
    for (JQMListItem li : items) {
      if (li == null || li.isChecked() == checked) {
        continue;
      }
  ...
  public ListChecked getCheckedInfo() {
    ...
    if (allChecked) {
      return ListChecked.ALL;
    } else {
      if (anyChecked) {
        return ListChecked.ANY;
      } else {
        return ListChecked.NONE;
      }
    }
  }
  ...
  @Override public boolean isInset() {
  ...
  public List<JQMListDivider> getDividers() {
    ...
    for (int k = 0; k < list.getWidgetCount(); k++) {
      ...
      if (isDivider(w)) {
        if (rslt == null) {
          rslt = new ArrayList<JQMListDivider>();
        }
  ...
  @Override public void setInset(boolean inset) {
    if (inset) {
  ...
  @Override public JQMList withInset(boolean inset) {
    setInset(inset);
    return this;
  }
  ...
  @Override public JQMList withCorners(boolean corners) {
    setCorners(corners);
    return this;
  }
