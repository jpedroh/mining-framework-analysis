...
public class JQMListItem extends CustomFlowPanel implements HasText<JQMListItem>, HasClickHandlers, HasTapHandlers, HasRel<JQMListItem>, HasTransition<JQMListItem> {
  ...
  /**
     ...
     */
  @UiConstructor public JQMListItem() {
  ...
  private void insertFirstChild(Element elem) {
    if (anchor == null) {
      getElement().insertFirst(elem);
    } else {
      if (controlGroup != null) {
        controlGroup.getElement().insertFirst(elem);
      } else {
        anchor.insertFirst(elem);
      }
    }
  }
  ...
  private void attachChild(Element elem) {
    if (anchor == null) {
      ...
      if (controlGroup != null) {
        controlGroup.getElement().appendChild(elem);
      } else {
  ...
  private void removeChild(Element elem) {
    if (anchor == null) {
      ...
      if (controlGroup != null) {
        controlGroup.getElement().removeChild(elem);
      } else {
  ...
  public void setSplitTheme(String theme) {
    splitTheme = theme;
    if (split != null) {
      JQMCommon.setTheme(split, theme);
    }
  }
  ...
  @Override public JQMListItem withText(String text) {
    setText(text);
    return this;
  }
  ...
  private void createControlGroup(boolean linkable) {
    ...
    if (anchor != null) {
      if (imageElem != null && anchor.equals(imageElem.getParentElement())) {
        moveAnchorChildrenTo(fldSet, imageElem);
      } else {
  ...
  public void setChecked(boolean value) {
    if (checkBoxInput == null || isChecked() == value) {
      return;
    }
    InputElement cb = checkBoxInput.getElement().cast();
    setChecked(cb, value);
  ...
  @Override public void setRel(String rel) {
    ...
    if (anchor != null) {
      JQMCommon.setAttribute(anchor, "data-rel", rel);
    }
  }

  @Override public JQMListItem withRel(String rel) {
    setRel(rel);
    return this;
  }
  ...
  public void setSplitRel(String rel) {
    ...
    if (split != null) {
      JQMCommon.setAttribute(split, "data-rel", rel);
    }
  }
  ...
  public void setPopupPos(String pos) {
    ...
    if (anchor != null) {
      JQMCommon.setPopupPos(anchor, pos);
    }
  }
  ...
  @Override public void setTransition(Transition transition) {
    ...
    if (anchor != null) {
      JQMCommon.setTransition(anchor, transition);
    }
  }

  @Override public JQMListItem withTransition(Transition transition) {
  ...
  public void setSplitPopupPos(String pos) {
    ...
    if (split != null) {
      JQMCommon.setPopupPos(split, pos);
    }
  }
  ...
  public void setSplitTransition(Transition transition) {
    ...
    if (split != null) {
      JQMCommon.setTransition(split, transition);
    }
  }
