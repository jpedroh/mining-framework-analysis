...
public interface HasInset<T> {
     ...
     */
    public abstract boolean isInset();

    /**
     * Sets the widget to inset mode or not.
     *
     * @param inset
     * 		if true then this widget is set to inset, if false then
     * 		inset mode is disabled
     */
    public abstract void setInset(boolean inset);
     ...
     * 		inset mode is disabled
     */
    public abstract T withInset(boolean inset);
}