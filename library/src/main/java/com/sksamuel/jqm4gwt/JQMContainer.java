...
public abstract class JQMContainer extends ComplexPanel implements HasId<JQMContainer>, HasTheme<JQMContainer>, HasTransition<JQMContainer>, HasCorners<JQMContainer>, HasJQMEventHandlers {
  ...
  public void setContainerId(String containerId) {
    ...
    if (containerId.isEmpty()) {
      ...
      if (containerId.endsWith(AUTOINC_SUFFIX)) {
  ...
  @Override public JQMContainer withId(String id) {
    setId(id);
    return this;
  }
  ...
  @Override public JQMContainer withTheme(String themeName) {
    setTheme(themeName);
    return this;
  }
  ...
  @Override public JQMContainer withTransition(Transition transition) {
  ...
  @Override public JQMContainer withCorners(boolean corners) {
    setCorners(corners);
    return this;
  }
