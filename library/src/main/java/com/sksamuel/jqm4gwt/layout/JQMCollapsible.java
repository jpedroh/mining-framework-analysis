...
public class JQMCollapsible extends JQMWidget implements HasText<JQMCollapsible>, HasIconPos<JQMCollapsible>, HasMini<JQMCollapsible>, HasInset<JQMCollapsible> {
  ...
  /**
     ...
     */
  @UiChild(tagname = "widget") public void add(Widget widget) {
    flow.add(widget);
  }
  ...
  /**
     ...
     * set the position to IconPos.NOTEXT
     */
  @Override public JQMCollapsible withIconPos(IconPos pos) {
    setIconPos(pos);
    return this;
  }
  ...
  @Override public JQMCollapsible withInset(boolean inset) {
    setInset(inset);
    return this;
  }
  ...
  /**
     * If set to true then renders a smaller version of the standard-sized element.
     */
  @Override public JQMCollapsible withMini(boolean mini) {
    setMini(mini);
    return this;
  }
  ...
  @Override public JQMCollapsible withText(String text) {
    setText(text);
    return this;
  }
