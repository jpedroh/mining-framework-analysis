...
public class JQMCollapsibleSet extends JQMWidget implements HasIconPos<JQMCollapsibleSet>, HasMini<JQMCollapsibleSet>, HasInset<JQMCollapsibleSet>, HasCorners<JQMCollapsibleSet> {
  ...
  /**
     ...
     */
  @UiChild(tagname = "collapsible") public void add(JQMCollapsible c) {
    flow.add(c);
  }
  ...
  /**
     ...
     * set the position to IconPos.NOTEXT
     */
  @Override public JQMCollapsibleSet withIconPos(IconPos pos) {
    setIconPos(pos);
    return this;
  }
  ...
  @Override public JQMCollapsibleSet withInset(boolean inset) {
    setInset(inset);
    return this;
  }
  ...
  /**
     * If set to true then renders a smaller version of the standard-sized element.
     */
  @Override public JQMCollapsibleSet withMini(boolean mini) {
    setMini(mini);
    return this;
  }
  ...
  @Override public JQMCollapsibleSet withCorners(boolean corners) {
    setCorners(corners);
    return this;
  }
