...
@ActionID(category = LocalizingService.CATEGORY_PROGRAM, id = "TranslateToZeroAction") @ActionRegistration(iconBase = TranslateToZeroAction.ICON_BASE, displayName = TranslateToZeroAction.NAME, lazy = false) @ActionReferences(value = { @ActionReference(path = LocalizingService.MENU_PROGRAM, position = 1221) }) @EditorActionRegistration(name = "translate-to-zero", toolBarPosition = 13, mimeType = GcodeLanguageConfig.MIME_TYPE, iconResource = TranslateToZeroAction.ICON_BASE) public class TranslateToZeroAction extends CookieAction implements UGSEventListener {
