 ...
 * @author wwinder
 */
public class RendererInputHandler implements WindowListener, MouseWheelListener, MouseMotionListener, MouseListener, KeyListener, PreferenceChangeListener, ControllerListener, UGSEventListener {
  ...
  @Override public void mouseDragged(java.awt.event.MouseEvent e) {
    ...
    if (SwingUtilities.isLeftMouseButton(e)) {
      int x = e.getX();
      int y = e.getY();
      int panMouseButton = InputEvent.BUTTON2_MASK;
  ...
  @Override public void mouseClicked(MouseEvent e) {
    if (SwingUtilities.isRightMouseButton(e) || e.isControlDown()) {
      ...
      Position position = new Position(coords.getX(), coords.getY(), coords.getZ(), Units.MM).getPositionIn(settings.getPreferredUnits());
  ...
  @Override public void controlStateChange(UGSEvent.ControlState state) {
  }
