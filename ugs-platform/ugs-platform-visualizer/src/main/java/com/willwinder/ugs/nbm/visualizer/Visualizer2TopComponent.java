...
public final class Visualizer2TopComponent extends TopComponent {
    ...
    public static final String VisualizerTitle = Localization.getString("platform.window.visualizer", lang);

    public static final String VisualizerTooltip = Localization.getString("platform.window.visualizer.tooltip", lang);
