...
@ActionID(category = LocalizingService.ResetZeroCategory, id = LocalizingService.ResetZeroActionId) @ActionRegistration(iconBase = ResetCoordinatesToZeroAction.ICON_BASE, displayName = "resources.MessagesBundle#" + LocalizingService.ResetZeroTitleKey, lazy = false) @ActionReferences(value = { @ActionReference(path = LocalizingService.ResetZeroWindowPath, position = 1030) }) public final class ResetCoordinatesToZeroAction extends AbstractAction implements UGSEventListener {
