...
@ActionID(category = LocalizingService.ResetYZeroCategory, id = LocalizingService.ResetYZeroActionId) @ActionRegistration(iconBase = ResetYCoordinateToZeroAction.ICON_BASE, displayName = "resources.MessagesBundle#" + LocalizingService.ResetYZeroTitleKey, lazy = false) @ActionReferences(value = { @ActionReference(path = LocalizingService.ResetYZeroWindowPath, position = 1030) }) public final class ResetYCoordinateToZeroAction extends AbstractAction implements UGSEventListener {
