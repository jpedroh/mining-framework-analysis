 ...
 * @author wwinder
 */
@ServiceProvider(service = ActionRegistrationService.class) public class ActionRegistrationService {
  ...
  /**
     ...
     */
  public void updateAction(ActionReference reference, 
...
>>>>>>> /usr/src/app/output/winder/universal-g-code-sender/886943a19d38d8b5fa4d7c05f36c81e909ced53f/ugs-platform/ugs-platform-ugslib/src/main/java/com/willwinder/ugs/nbp/lib/services/ActionRegistrationService.java/right.java
  , String shortcut, String menuPath, int menuPosition, String localMenu) throws IOException {
    registerAction(
<<<<<<< /usr/src/app/output/winder/universal-g-code-sender/886943a19d38d8b5fa4d7c05f36c81e909ced53f/ugs-platform/ugs-platform-ugslib/src/main/java/com/willwinder/ugs/nbp/lib/services/ActionRegistrationService.java/left.java
    extractId(reference.getId())
=======
    reference.getId()
>>>>>>> /usr/src/app/output/winder/universal-g-code-sender/886943a19d38d8b5fa4d7c05f36c81e909ced53f/ugs-platform/ugs-platform-ugslib/src/main/java/com/willwinder/ugs/nbp/lib/services/ActionRegistrationService.java/right.java
    , 
...
>>>>>>> /usr/src/app/output/winder/universal-g-code-sender/886943a19d38d8b5fa4d7c05f36c81e909ced53f/ugs-platform/ugs-platform-ugslib/src/main/java/com/willwinder/ugs/nbp/lib/services/ActionRegistrationService.java/right.java
    , 
<<<<<<< /usr/src/app/output/winder/universal-g-code-sender/886943a19d38d8b5fa4d7c05f36c81e909ced53f/ugs-platform/ugs-platform-ugslib/src/main/java/com/willwinder/ugs/nbp/lib/services/ActionRegistrationService.java/left.java
    extractCategory(reference.getId())
=======
    category
>>>>>>> /usr/src/app/output/winder/universal-g-code-sender/886943a19d38d8b5fa4d7c05f36c81e909ced53f/ugs-platform/ugs-platform-ugslib/src/main/java/com/willwinder/ugs/nbp/lib/services/ActionRegistrationService.java/right.java
    , shortcut, menuPath, menuPosition, localMenu, reference.getAction());
  }
  ...
  public Optional<ActionReference> lookupAction(String category, String name) {
    ...
    if (key != null) {
      if (actionCache.containsKey(key)) {
        return actionCache.get(key).stream().filter((action) -> action.getId().contains(name)).findFirst();
      }
      return Optional.empty();
    }
    return actionCache.values().stream().flatMap(Collection::stream).filter((action) -> action.getId().contains(name)).findFirst();
  }
