...
public abstract class AbstractCuttable extends AbstractEntity implements Cuttable {
  ...
  @Override public CutType getCutType() {
    return cutType;
  }

  @Override public void setCutType(CutType cutType) {
    this.cutType = cutType;
    notifyEvent(new EntityEvent(this, EventType.SETTINGS_CHANGED));
  }

  @Override public double getCutDepth() {
    return cutDepth;
  }

  @Override public void setCutDepth(double cutDepth) {
    this.cutDepth = cutDepth;
  }

  @Override public void render(Graphics2D graphics, Drawing drawing) {
...
<<<<<<< /usr/src/app/output/winder/universal-g-code-sender/656c7543917c592384e35c45348706dd7463d1ee/ugs-platform/ugs-platform-plugin-designer/src/main/java/com/willwinder/ugs/nbp/designer/entities/cuttable/AbstractCuttable.java/left.java
      strokeWidth
=======
      0.4f
>>>>>>> /usr/src/app/output/winder/universal-g-code-sender/656c7543917c592384e35c45348706dd7463d1ee/ugs-platform/ugs-platform-plugin-designer/src/main/java/com/willwinder/ugs/nbp/designer/entities/cuttable/AbstractCuttable.java/right.java
      , BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 1, new float[] { dashWidth, dashWidth }, 0));
...
>>>>>>> /usr/src/app/output/winder/universal-g-code-sender/656c7543917c592384e35c45348706dd7463d1ee/ugs-platform/ugs-platform-plugin-designer/src/main/java/com/willwinder/ugs/nbp/designer/entities/cuttable/AbstractCuttable.java/right.java
        ...
        if (getCutType() == CutType.INSIDE_PATH || getCutType() == CutType.ON_PATH || getCutType() == CutType.OUTSIDE_PATH) {
          graphics.setStroke(new BasicStroke(
<<<<<<< /usr/src/app/output/winder/universal-g-code-sender/656c7543917c592384e35c45348706dd7463d1ee/ugs-platform/ugs-platform-plugin-designer/src/main/java/com/willwinder/ugs/nbp/designer/entities/cuttable/AbstractCuttable.java/left.java
          strokeWidth
=======
