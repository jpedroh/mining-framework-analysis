...
public class CalendarServiceDataFactoryImpl implements CalendarServiceDataFactory {
  ...
  @Override public CalendarServiceData createData() {
    ...
    return updateData(_dao.getAllAgencies(), tripAgencyIdsReferencingServiceId, timeZoneMapByAgencyId);
  }

  @Override public CalendarServiceData updateData(Collection<Agency> allAgencies, Map<AgencyAndId, List<String>> tripAgencyIdsReferencingServiceId, Map<String, TimeZone> timeZoneMapByAgencyId) {
