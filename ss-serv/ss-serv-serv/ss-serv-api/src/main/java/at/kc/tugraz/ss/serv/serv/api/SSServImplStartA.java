...
public abstract class SSServImplStartA extends SSServImplA implements Runnable {
  ...
  @Override public List<SSMethU> publishClientOps(final Class clientInterfaceClass) throws Exception {
    return new ArrayList<SSMethU>();
  }

  @Override public List<SSMethU> publishServerOps(final Class serverInterfaceClass) throws Exception {
    return new ArrayList<SSMethU>();
  }
}