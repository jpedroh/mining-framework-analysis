...
public class SSServCaller {
  ...
  public static SSUri addLearnEpVersionCircle(SSUri userUri, SSUri learnEpVersionUri, SSLabelStr label, Float xLabel, Float yLabel, Float xR, Float yR, Float xC, Float yC, Boolean shouldCommit) throws Exception {
    Map<String, Object> opPars = new HashMap<String, Object>();
    SSUri result = null;
    try {
      opPars.put(SSVarU.shouldCommit, shouldCommit);
  ...
  public static SSUri addLearnEpVersionEntity(SSUri userUri, SSUri learnEpVersionUri, SSUri entityUri, Float x, Float y, Boolean shouldCommit) throws Exception {
    Map<String, Object> opPars = new HashMap<String, Object>();
    SSUri result = null;
    try {
      opPars.put(SSVarU.shouldCommit, shouldCommit);
  ...
  public static SSUri setLearnEpVersionTimelineState(SSUri userUri, SSUri learnEpVersionUri, Long startTime, Long endTime, Boolean shouldCommit) throws Exception {
    Map<String, Object> opPars = new HashMap<String, Object>();
    SSUri result = null;
    try {
      opPars.put(SSVarU.shouldCommit, shouldCommit);
  ...
  public static void entityAddAtCreationTime(final SSUri userUri, final SSUri uri, final SSLabelStr label, final Long creationTime, final SSEntityEnum type, final Boolean shouldCommit) throws Exception {
  ...
  public static void addUser(final SSUri userUri, final SSLabelStr userLabel, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
  ...
  public static void entityAdd(final SSUri userUri, final SSUri uri, final SSLabelStr label, final SSEntityEnum type, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, uri);
    opPars.put(SSVarU.label, label);
  ...
  public static List<SSUE> getUEs(SSUri userUri, SSUri forUserUri, SSUri entityUri, SSUEEnum eventType, Long startTime, Long endTime) throws Exception {
    Map<String, Object> opPars = new HashMap<String, Object>();
  ...
  public static void entityLabelSet(final SSUri entityUri, final SSLabelStr label, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.entityUri, entityUri);
    opPars.put(SSVarU.label, label);
    opPars.put(SSVarU.shouldCommit, shouldCommit);
  ...
  public static void addUEAtCreationTime(SSUri userUri, SSUri entityUri, SSUEEnum evenType, String content, Long creationTime, Boolean shouldCommit) throws Exception {
    Map<String, Object> opPars = new HashMap<String, Object>();
    try {
      opPars.put(SSVarU.shouldCommit, shouldCommit);
      opPars.put(SSVarU.user, userUri);
  ...
  public static void updateLearnEpVersionCircle(SSUri userUri, SSUri learnEpCircleUri, SSLabelStr label, Float xLabel, Float yLabel, Float xR, Float yR, Float xC, Float yC, Boolean shouldCommit) throws Exception {
    Map<String, Object> opPars = new HashMap<String, Object>();
    try {
      opPars.put(SSVarU.shouldCommit, shouldCommit);
      opPars.put(SSVarU.user, userUri);
  ...
  public static void updateLearnEpVersionEntity(SSUri userUri, SSUri learnEpEntityUri, SSUri entityUri, Float x, Float y, Boolean shouldCommit) throws Exception {
    Map<String, Object> opPars = new HashMap<String, Object>();
    try {
      opPars.put(SSVarU.shouldCommit, shouldCommit);
      opPars.put(SSVarU.user, userUri);
  ...
  public static void removeLearnEpVersionCircle(SSUri userUri, SSUri learnEpCircleUri, Boolean shouldCommit) throws Exception {
    Map<String, Object> opPars = new HashMap<String, Object>();
    try {
      opPars.put(SSVarU.shouldCommit, shouldCommit);
      opPars.put(SSVarU.user, userUri);
  ...
  public static void removeLearnEpVersionEntity(SSUri userUri, SSUri learnEpEntityUri, Boolean shouldCommit) throws Exception {
    Map<String, Object> opPars = new HashMap<String, Object>();
    try {
      opPars.put(SSVarU.shouldCommit, shouldCommit);
      opPars.put(SSVarU.user, userUri);
  ...
  public static void broadCastUpdate(SSUri userUri, SSUri enityUri, SSBroadcastEnum broadcastType, Boolean shouldCommit) throws Exception {
    Map<String, Object> opPars = new HashMap<String, Object>();
    try {
      opPars.put(SSVarU.shouldCommit, shouldCommit);
      opPars.put(SSVarU.user, userUri);
  ...
  public static SSUri collToCircleAdd(final SSUri userUri, final SSUri collCircleUri, final SSUri collUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
  ...
  public static SSUri collUserShareWithUser(final SSUri userUri, final SSUri userUriToShareWith, final SSUri collUri, final SSUri collCircleUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
  ...
  public static SSColl collUserWithEntries(final SSUri userUri, final SSUri collUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
  ...
  public static SSUri collUserSetPublic(final SSUri userUri, final SSUri collUri, final SSUri publicCircleUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.collUri, collUri);
  ...
  public static Boolean collUserEntryDelete(final SSUri userUri, final SSUri collEntryUri, final SSUri parentCollUri, final Boolean saveUE, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
  ...
  public static SSUri collUserEntryAdd(final SSUri user, final SSUri coll, final SSUri collEntry, final SSLabelStr label, final Boolean addNewColl, final Boolean saveUE, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
  ...
  public static Boolean collUserEntriesAdd(final SSUri userUri, final SSUri collUri, final List<SSUri> collEntries, final List<SSLabelStr> collEntryLabels, final Boolean saveUE, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.saveUE, saveUE);
    opPars.put(SSVarU.user, userUri);
  ...
  public static void collUserRootAdd(final SSUri userUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.user, userUri);
  ...
  public static List<SSColl> collUserHierarchyGet(final SSUri userUri, final SSUri collUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.collUri, collUri);
  ...
  public static List<SSTagFrequ> collUserCumulatedTagsGet(final SSUri userUri, final SSUri collUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.collUri, collUri);
  ...
  public static List<SSColl> collsUserEntityIsInGet(final SSUri userUri, final SSUri entityUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static Boolean collUserEntriesDelete(final SSUri userUri, final SSUri collUri, final List<SSUri> collEntries, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.coll, collUri);
  ...
  public static Boolean collsUserCouldSubscribeGet(final SSUri userUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    return (Boolean) SSServA.callServViaServer(new SSServPar(SSMethU.collsUserCouldSubscribeGet, opPars));
  }

  public static List<String> solrSearch(final SSSolrKeywordLabel keyword, final Integer maxResults) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
  ...
  public static void solrAddDoc(final SSUri userUri, final String fileID, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.user, userUri);
  ...
  public static List<SSUri> discUrisUserForTargetGet(final SSUri userUri, final SSUri entityUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static SSDisc discUserWithEntriesGet(final SSUri userUri, final SSUri discUri, final Integer maxDiscEntries) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
  ...
  public static void discUserRemove(final SSUri userUri, final SSUri entityUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static SSRatingOverall ratingOverallGet(final SSUri userUri, final SSUri entityUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.resource, entityUri);
  ...
  public static void ratingsUserRemove(final SSUri userUri, final SSUri entityUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static Integer ratingUserGet(final SSUri userUri, final SSUri entityUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.resource, entityUri);
  ...
  public static SSUri entityUserDirectlyAdjoinedEntitiesRemove(final SSUri userUri, final SSUri entityUri, final Boolean removeUserTags, final Boolean removeUserRatings, final Boolean removeFromUserColls, final Boolean removeUserLocations, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static SSUri entityAuthorGet(final SSUri userUri, final SSUri entityUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static SSEntityDescA entityDescGet(final SSUri userUri, final SSUri entityUri, final Boolean getTags, final Boolean getOverallRating, final Boolean getDiscUris) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static void entityRemove(final SSUri entityUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    try {
      opPars.put(SSVarU.entityUri, entityUri);
      opPars.put(SSVarU.shouldCommit, shouldCommit);
  ...
  public static List<SSCircle> entityUserEntityCirclesGet(final SSUri userUri, final SSUri entityUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static Boolean entityUserAllowedIs(final SSUri userUri, final SSUri entityUri, final SSEntityRightTypeE accessRight) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static Boolean entityUserCanEdit(final SSUri userUri, final SSUri entityUri) throws Exception {
    return entityUserAllowedIs(userUri, entityUri, SSEntityRightTypeE.edit);
  }

  public static Boolean entityUserCanRead(final SSUri userUri, final SSUri entityUri) throws Exception {
    return entityUserAllowedIs(userUri, entityUri, SSEntityRightTypeE.read);
  }

  public static Boolean entityUserCanAll(final SSUri userUri, final SSUri entityUri) throws Exception {
    return entityUserAllowedIs(userUri, entityUri, SSEntityRightTypeE.all);
  }

  public static SSUri entityCirclePublicAdd(final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    return (SSUri) SSServA.callServViaServer(new SSServPar(SSMethU.entityCirclePublicAdd, opPars));
  }

  public static List<SSCircle> entityUserCirclesGet(final SSUri userUri, final Boolean withSystemGeneratedCircles) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
  ...
  public static SSUri entityCircleCreate(final SSUri userUri, final SSUri toAddEntityUri, final List<SSUri> toAddUserUris, final SSEntityCircleTypeE circleType, final SSLabelStr label, final SSUri circleAuthor, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
  ...
  public static SSUri entityCircleCreate(final SSUri userUri, final SSUri toAddEntityUri, final SSUri toAddUserUri, final SSEntityCircleTypeE circleType, final SSLabelStr label, final SSUri circleAuthor, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    final List<SSUri> entityUris = new ArrayList<SSUri>();
  ...
  public static SSUri entityCircleCreate(final SSUri userUri, final List<SSUri> entityUris, final List<SSUri> userUris, final SSEntityCircleTypeE circleType, final SSLabelStr label, final SSUri circleAuthor, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUris, entityUris);
    opPars.put(SSVarU.userUris, userUris);
  ...
  public static SSUri entityEntitiesToCircleAdd(final SSUri userUri, final SSUri circleUri, final List<SSUri> entityUris, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUris, entityUris);
  ...
  public static SSUri entityEntitiesToCircleAdd(final SSUri userUri, final SSUri circleUri, final SSUri entityUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    final List<SSUri> entityUris = new ArrayList<SSUri>();
    if (entityUri != null) {
  ...
  public static SSUri entityUserEntitiesToCircleAdd(final SSUri userUri, final SSUri circleUri, final SSUri entityUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    final List<SSUri> entityUris = new ArrayList<SSUri>();
    if (entityUri != null) {
      entityUris.add(entityUri);
  ...
  public static SSUri entityUsersToCircleAdd(final SSUri userUri, final SSUri circleUri, final SSUri userUriToAdd, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    final List<SSUri> userUris = new ArrayList<SSUri>();
  ...
  public static SSUri entityUsersToCircleAdd(final SSUri userUri, final SSUri circleUri, final List<SSUri> userUrisToAdd, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
  ...
  public static SSUri entityUserUsersToCircleAdd(final SSUri userUri, final SSUri circleUri, final List<SSUri> userUris, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.userUris, userUris);
    opPars.put(SSVarU.circleUri, circleUri);
  ...
  public static List<SSEntityCircleTypeE> entityUserEntityCircleTypesGet(final SSUri userUri, final SSUri entityUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static SSEntityCircleTypeE entityMostOpenCircleTypeGet(final SSUri entityUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.entityUri, entityUri);
    return (SSEntityCircleTypeE) SSServA.callServViaServer(new SSServPar(SSMethU.entityMostOpenCircleTypeGet, opPars));
  }

  public static Boolean entityUserCircleDelete(final SSUri entityUri, final SSUri circleUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.entityUri, entityUri);
    opPars.put(SSVarU.circleUri, circleUri);
  ...
  public static SSUri entityUserPublicSet(final SSUri userUri, final SSUri entityUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
    opPars.put(SSVarU.shouldCommit, shouldCommit);
  ...
  public static void ueAdd(final SSUri userUri, final SSUri entityUri, final SSUEEnum evenType, final String content, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.resource, entityUri);
  ...
  public static Boolean userExists(final SSUri userUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    return (Boolean) SSServA.callServViaServer(new SSServPar(SSMethU.userExists, opPars));
  }

  public static List<SSUri> modelUEEntitiesForMiGet(final SSUri userUri, final SSModelUEMILabel mi) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
  ...
  public static List<String> modelUEMIsForEntityGet(final SSUri userUri, final SSUri entityUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static void dataExportUserEntityTags(final SSUri user, final Map<String, List<String>> tagsPerEntities, final String fileName, final Boolean wasLastLine) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
  ...
  public static void dataExportUserEntityTagTimestamps(final SSUri user, final Map<String, List<String>> tagsPerEntities, final Long timestampForTag, final String fileName, final Boolean wasLastLine) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.fileName, fileName);
    opPars.put(SSVarU.tagsPerEntities, tagsPerEntities);
    opPars.put(SSVarU.user, user);
  ...
  public static void dataExportUserEntityTagCategories(final SSUri user, final Map<String, List<String>> tagsPerEntities, final Map<String, List<String>> categoriesPerEntities, final String fileName, final Boolean wasLastLine) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.fileName, fileName);
    opPars.put(SSVarU.tagsPerEntities, tagsPerEntities);
  ...
  public static void dataExportUserEntityTagCategoryTimestamps(final SSUri user, final Map<String, List<String>> tagsPerEntities, final Map<String, List<String>> categoriesPerEntities, final Long timestampForTag, final String fileName, final Boolean wasLastLine) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.fileName, fileName);
    opPars.put(SSVarU.tagsPerEntities, tagsPerEntities);
    opPars.put(SSVarU.categoriesPerEntities, categoriesPerEntities);
  ...
  public static void tagsAdd(final SSUri userUri, final SSUri entityUri, final List<SSTagLabel> tagList, final SSSpaceEnum space, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    try {
      opPars.put(SSVarU.shouldCommit, shouldCommit);
      opPars.put(SSVarU.user, userUri);
  ...
  public static List<SSTag> tagsUserGet(final SSUri userUri, final SSUri entityUri, final SSTagLabel tagString, final SSSpaceEnum space) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.resource, entityUri);
  ...
  public static List<SSTagFrequ> tagUserFrequsGet(final SSUri userUri, final SSUri entityUri, final SSTagLabel tagLabel, final SSSpaceEnum space) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.resource, entityUri);
  ...
  public static List<SSUri> tagUserEntitiesForTagGet(final SSUri userUri, final SSTagLabel tagLabel, final SSSpaceEnum space) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.tagString, tagLabel);
    opPars.put(SSVarU.space, space);
  ...
  public static void tagsRemove(final SSUri forUserUri, final SSUri entityUri, final SSTagLabel tagLabel, final SSSpaceEnum space, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.forUser, forUserUri);
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static void tagsUserRemove(final SSUri userUri, final SSUri entityUri, final SSTagLabel tagString, final SSSpaceEnum space, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.resource, entityUri);
  ...
  public static void tagAdd(final SSUri userUri, final SSUri entityUri, final SSTagLabel tagString, final SSSpaceEnum space, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.resource, entityUri);
  ...
  public static void tagAddAtCreationTime(final SSUri userUri, final SSUri entityUri, final SSTagLabel tagString, final SSSpaceEnum space, final Long creationTime, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.resource, entityUri);
  ...
  public static void locationsUserRemove(final SSUri userUri, final SSUri entityUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    try {
      opPars.put(SSVarU.shouldCommit, shouldCommit);
      opPars.put(SSVarU.user, userUri);
  ...
  public static List<SSTag> recommTagsBaseLevelLearningWithContextBasedOnUserEntityTagTimestamp(final SSUri userUri, final SSUri forUser, final SSUri entityUri, final Integer maxTags) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
  ...
  public static List<SSTag> recommTagsLanguageModelBasedOnUserEntityTag(final SSUri userUri, final SSUri forUser, final SSUri entityUri, final Integer maxTags) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.forUser, forUser);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static List<SSTag> recommTagsThreeLayersBasedOnUserEntityTagCategory(final SSUri userUri, final SSUri forUser, final SSUri entityUri, final List<String> categories, final Integer maxTags) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.forUser, forUser);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static List<SSTag> recommTagsThreeLayersBasedOnUserEntityTagCategoryTimestamp(final SSUri userUri, final SSUri forUser, final SSUri entityUri, final List<String> categories, final Integer maxTags) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.forUser, forUser);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static SSFileCanWriteRet fileCanWrite(final SSUri userUri, final SSUri fileUri) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
  ...
  public static SSUri fileCreateUri(final SSUri userUri, final String fileExt) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
  ...
  public static void fileRemoveReaderOrWriter(final SSUri userUri, final SSUri fileUri, final Boolean write, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.uri, fileUri);
  ...
  public static void dataImportMediaWikiUser(final SSUri userUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.shouldCommit, shouldCommit);
  ...
  public static List<String> scaffRecommTagsBasedOnUserEntityTag(final SSUri userUri, final SSUri forUserUri, final SSUri entityUri, final Integer maxTags) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
  ...
  public static List<String> scaffRecommTagsBasedOnUserEntityTagTime(final SSUri userUri, final SSUri forUserUri, final SSUri entityUri, final Integer maxTags) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.forUserUri, forUserUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static List<String> scaffRecommTagsBasedOnUserEntityTagCategory(final SSUri userUri, final SSUri forUserUri, final SSUri entityUri, final List<String> categories, final Integer maxTags) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.forUserUri, forUserUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static List<String> scaffRecommTagsBasedOnUserEntityTagCategoryTime(final SSUri userUri, final SSUri forUserUri, final SSUri entityUri, final List<String> categories, final Integer maxTags) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.user, userUri);
    opPars.put(SSVarU.forUserUri, forUserUri);
    opPars.put(SSVarU.entityUri, entityUri);
  ...
  public static void dataImportUserResourceTagFromWikipedia(final SSUri userUri, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.shouldCommit, shouldCommit);
    opPars.put(SSVarU.user, userUri);
  ...
  public static Boolean i5CloudFileUpload(final String fileName, final String containerSpace, final String xAuthToken) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.fileName, fileName);
  ...
  public static Boolean i5CloudFileDownload(final String fileName, final String containerSpace, final String xAuthToken) throws Exception {
    final Map<String, Object> opPars = new HashMap<String, Object>();
    opPars.put(SSVarU.fileName, fileName);
    opPars.put(SSVarU.space, containerSpace);
    opPars.put(SSVarU.xAuthToken, xAuthToken);
