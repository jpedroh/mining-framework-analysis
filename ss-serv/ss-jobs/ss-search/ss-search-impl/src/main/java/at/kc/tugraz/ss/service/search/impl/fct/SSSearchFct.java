...
public class SSSearchFct {
  public static List<SSSearchResult> selectAndFillSearchResults(final SSUri userUri, final String searchOp, final Map<String, List<SSSearchResult>> searchResultsPerKeyword) throws Exception {
  ...
  private static List<SSSearchResult> selectSearchResultsWithRegardToSearchOp(final String searchOp, final Map<String, List<SSSearchResult>> searchResultsPerKeyword) {
