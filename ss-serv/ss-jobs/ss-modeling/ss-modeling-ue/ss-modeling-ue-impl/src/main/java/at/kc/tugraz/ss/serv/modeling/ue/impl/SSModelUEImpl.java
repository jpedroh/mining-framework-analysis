...
public class SSModelUEImpl extends SSServImplMiscA implements SSModelUEClientI, SSModelUEServerI {
  ...
  @Override public void modelUEResourceDetails(SSSocketCon sSCon, SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(modelUEResourceDetails(par));
  }

  @Override public void modelUERelatedPersons(SSSocketCon sSCon, SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSModelUERelatedPersonsRet.get(modelUERelatedPersons(par), par.op));
  }

  @Override public void modelUEMIsForEntityGet(final SSSocketCon sSCon, final SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSModelUEMIsForEntityGetRet.get(modelUEMIsForEntityGet(par), par.op));
  }

  /****** SSModelUEServerI ******/
  @Override public SSModelUEResourceDetailsRet modelUEResourceDetails(SSServPar parI) throws Exception {
    SSModelUEResourceDetailsPar par = new SSModelUEResourceDetailsPar(parI);
    return new SSModelUEResourceDetailsRet(par.resource, modelUERelatedPersons(new SSModelUERelatedPersonsPar(par)), modelUEMIsForEntityGet(new SSModelUEMIsForEntityGetPar(par)), modelUEEditors(new SSModelUEEditorsPar(par)), modelUEResourceRecent(new SSModelUEResourceRecentPar(par)), modelUETopicRecent(new SSModelUETopicRecentPar(par)), modelUEResourcesContributed(new SSModelUEResourcesContributedPar(par)), modelUETopicScores(new SSModelUETopicScoresPar(par)), par.op);
  }

  @Override public List<SSUri> modelUERelatedPersons(SSServPar parI) throws Exception {
  ...
  @Override public List<String> modelUEMIsForEntityGet(final SSServPar parA) throws Exception {
  ...
  @Override public void modelUEUpdate(final SSServPar par) throws Exception {
  ...
  @Override public List<SSUri> modelUEEntitiesForMiGet(final SSServPar parA) throws Exception {
    ...
    if (SSObjU.isNull(par.mi) || !SSModelUEMIEnum.contains(SSStrU.toString(par.mi))) {
      return entityUris;
    }
    for (SSModelUEResource resource : resources.values()) {
  ...
  @Override public List<String> modelUEResourcesAll(SSServPar par) throws Exception {
  ...
  @Override public List<SSUri> modelUEEditors(SSServPar parI) throws Exception {
  ...
  @Override public SSUri modelUEResourceRecent(SSServPar parI) throws Exception {
  ...
  @Override public SSTagLabel modelUETopicRecent(SSServPar parI) throws Exception {
  ...
  @Override public List<SSUri> modelUEResourcesContributed(SSServPar parI) throws Exception {
  ...
  @Override public List<SSModelUETopicScore> modelUETopicScores(SSServPar parI) throws Exception {
  ...
  @Override public List<SSModelUERelation> modelUEModelRelations(SSServPar parI) throws Exception {
  ...
  private List<SSModelUERelation> fillModelRelationLabels(List<SSModelUERelation> modelRelations) throws Exception {
    int counter = 0;
