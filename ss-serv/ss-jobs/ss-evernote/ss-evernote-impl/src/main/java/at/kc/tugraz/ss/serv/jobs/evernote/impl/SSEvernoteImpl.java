...
public class SSEvernoteImpl extends SSServImplMiscA implements SSEvernoteClientI, SSEvernoteServerI, SSEntityHandlerImplI {
  ...
  @Override public SSEvernoteInfo evernoteNoteStoreGet(SSServPar parA) throws Exception {
  ...
  @Override public List<Notebook> evernoteNotebooksGet(SSServPar parA) throws Exception {
  ...
  @Override public List<SharedNotebook> evernoteNotebooksSharedGet(SSServPar parA) throws Exception {
  ...
  @Override public List<LinkedNotebook> evernoteNotebooksLinkedGet(SSServPar parA) throws Exception {
  ...
  @Override public List<Note> evernoteNotesGet(SSServPar parA) throws Exception {
  ...
  @Override public List<Note> evernoteNotesLinkedGet(final SSServPar parA) throws Exception {
