...
public class SSSolrImpl extends SSServImplMiscA implements SSSolrClientI, SSSolrServerI {
  ...
  /** 
	 ...
	 */
  @Override public void solrAddDoc(final SSServPar parA) throws Exception {
  ...
  @Override public void solrRemoveDoc(SSServPar parI) throws Exception {
  ...
  @Override public void solrRemoveDocsAll(SSServPar parI) throws Exception {
    NamedList<Object> nl;
    UpdateResponse ur;
  ...
  @Override public List<String> solrSearch(final SSServPar parA) throws Exception {
