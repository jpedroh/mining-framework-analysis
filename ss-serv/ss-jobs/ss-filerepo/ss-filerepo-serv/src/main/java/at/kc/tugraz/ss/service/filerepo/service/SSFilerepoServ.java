...
public class SSFilerepoServ extends SSServA {
  ...
  protected SSFilerepoServ(final Class servImplClientInteraceClass, final Class servImplServerInteraceClass) {
  ...
  public void schedule() throws Exception {
    if (servConf.use) {
      SSDateU.scheduleAtFixedRate(new SSFileRepoWritingMinutesUpdateTask(), SSDateU.getDateForNextMinute(), SSDateU.minuteInMilliSeconds);
    }
  }
