...
public class SSDisc extends SSEntityA {
  ...
  public static SSDisc get(final SSUri uri, final SSLabel label, final SSUri author, final SSUri target, final SSEntityE discType, final List<SSDiscEntry> entries, final SSTextComment explanation, final Long creationTime) throws Exception {
    return new SSDisc(uri, label, author, target, discType, entries, explanation, creationTime);
  }

  private SSDisc(final SSUri uri, final SSLabel label, final SSUri author, final SSUri target, final SSEntityE discType, final List<SSDiscEntry> entries, final SSTextComment explanation, final Long creationTime) throws Exception {
    super(uri);
    this.id = uri;
    this.label = label;
    this.author = author;
