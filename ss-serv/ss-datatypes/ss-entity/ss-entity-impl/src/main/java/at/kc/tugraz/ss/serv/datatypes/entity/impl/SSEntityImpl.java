...
public class SSEntityImpl extends SSServImplWithDBA implements SSEntityClientI, SSEntityServerI {
  ...
  /****** SSEntityClientI ******/
  @Override public void entityTypeGet(SSSocketCon sSCon, SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSEntityTypeGetRet.get(entityTypeGet(par), par.op));
  }

  @Override public void entityUserShare(final SSSocketCon sSCon, final SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSEntityUserShareRet.get(entityUserShare(par), par.op));
  }

  @Override public void entityDescGet(SSSocketCon sSCon, SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSEntityDescGetRet.get(entityDescGet(par), par.op));
  }

  @Override public void entityLabelGet(SSSocketCon sSCon, SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSEntityLabelGetRet.get(entityLabelGet(par), par.op));
  }

  @Override public void entityLabelSet(SSSocketCon sSCon, SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSEntityLabelSetRet.get(entityLabelSet(par), par.op));
  }

  @Override public void entityUserDirectlyAdjoinedEntitiesRemove(final SSSocketCon sSCon, final SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
  ...
  @Override public void entityUserCircleCreate(final SSSocketCon sSCon, final SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSEntityUserCircleCreateRet.get(entityUserCircleCreate(par), par.op));
  }

  @Override public void entityUserEntitiesToCircleAdd(final SSSocketCon sSCon, final SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSEntityUserEntitiesToCircleAddRet.get(entityUserEntitiesToCircleAdd(par), par.op));
  }

  @Override public void entityUserUsersToCircleAdd(final SSSocketCon sSCon, final SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSEntityUserUsersToCircleAddRet.get(entityUserUsersToCircleAdd(par), par.op));
  }

  @Override public void entityUserCirclesGet(final SSSocketCon sSCon, final SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSEntityUserCirclesGetRet.get(entityUserCirclesGet(par), par.op));
  }

  @Override public void entityUserPublicSet(final SSSocketCon sSCon, final SSServPar par) throws Exception {
    SSServCaller.checkKey(par);
    sSCon.writeRetFullToClient(SSEntityUserPublicSetRet.get(entityUserPublicSet(par), par.op));
  }

  @Override public SSUri entityLabelSet(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public SSEntityDescA entityDescGet(final SSServPar parA) throws Exception {
    ...
    try {
      ...
      if (SSEntityEnum.equals(entity.type, SSEntityEnum.entity)) {
        result = SSEntityDesc.get(par.entityUri, entity.label, entity.creationTime, tags, overallRating, discUris, entity.author);
      } else {
        for (SSServA serv : SSServA.getServsManagingEntities()) {
          result = ((SSEntityHandlerImplI) serv.serv()).getDescForEntity(entity.type, par.user, par.entityUri, entity.label, entity.creationTime, tags, overallRating, discUris, entity.author);
  ...
  @Override public SSUri entityRemove(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public SSUri entityUserDirectlyAdjoinedEntitiesRemove(final SSServPar parA) throws Exception {
    ...
    try {
      ...
      for (SSServA serv : SSServA.getServsManagingEntities()) {
        ((SSEntityHandlerImplI) serv.serv()).removeDirectlyAdjoinedEntitiesForUser(entity.type, par);
      }
  ...
  @Override public SSUri entityAdd(final SSServPar parA) throws Exception {
    final SSEntityAddPar par = new SSEntityAddPar(parA);
    try {
      sqlFct.addEntityIfNotExists(par.entityUri, par.label, par.entityType, par.user);
      return par.entityUri;
    } catch (SSSQLDeadLockErr deadLockErr) {
      if (dbSQL.rollBack(parA)) {
  ...
  @Override public SSUri entityAddAtCreationTime(final SSServPar parA) throws Exception {
    try {
      final SSEntityAddAtCreationTimePar par = new SSEntityAddAtCreationTimePar(parA);
      sqlFct.addEntityAtCreationTimeIfNotExists(par.entityUri, par.label, par.creationTime, par.entityType, par.user);
      return par.entityUri;
    } catch (SSSQLDeadLockErr deadLockErr) {
      if (dbSQL.rollBack(parA)) {
  ...
  @Override public SSLabelStr entityLabelGet(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public SSUri entityAuthorGet(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public Long entityCreationTimeGet(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public SSEntityEnum entityTypeGet(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public SSUri entityCirclePublicAdd(final SSServPar parA) throws Exception {
    try {
      dbSQL.startTrans(parA.shouldCommit);
      publicCircleUri = sqlFct.addPublicCircle();
      SSServCaller.entityAdd(SSUri.get(SSUserGlobals.systemUserURI), publicCircleUri, SSLabelStr.get(publicCircleUri.toString()), SSEntityEnum.circle, false);
  ...
  @Override public SSUri entityCircleURIPublicGet(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public List<SSCircle> entityUserCirclesGet(final SSServPar parA) throws Exception {
    try {
      ...
      for (SSUri circleUri : sqlFct.getUserCircleURIs(par.user)) {
        if (!par.withSystemGeneratedCircles && SSEntityMiscFct.isSystemCircle(sqlFct, circleUri)) {
          continue;
        }
  ...
  @Override public SSUri entityUserCircleCreate(final SSServPar parA) throws Exception {
    try {
      ...
      dbSQL.startTrans(par.shouldCommit);
      final SSUri circleUri = SSServCaller.entityCircleCreate(par.user, par.entityUris, par.userUris, par.circleType, par.label, par.user, false);
      SSEntityMiscFct.addEntitiesToCircleByEntityHandlers(par.user, par.entityUris, circleUri);
      dbSQL.commit(par.shouldCommit);
      return circleUri;
    } catch (SSSQLDeadLockErr deadLockErr) {
      if (dbSQL.rollBack(parA)) {
  ...
  @Override public SSUri entityCircleCreate(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public SSUri entityUsersToCircleAdd(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public SSUri entityUserUsersToCircleAdd(final SSServPar parA) throws Exception {
    try {
      ...
      dbSQL.startTrans(par.shouldCommit);
      SSServCaller.entityUsersToCircleAdd(par.user, par.circleUri, par.userUris, false);
      dbSQL.commit(par.shouldCommit);
      return par.circleUri;
    } catch (SSSQLDeadLockErr deadLockErr) {
      if (dbSQL.rollBack(parA)) {
  ...
  @Override public SSEntityCircleTypeE entityMostOpenCircleTypeGet(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public List<SSEntityCircleTypeE> entityUserEntityCircleTypesGet(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public List<SSCircle> entityUserEntityCirclesGet(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public SSUri entityEntitiesToCircleAdd(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public SSUri entityUserEntitiesToCircleAdd(final SSServPar parA) throws Exception {
    try {
      final SSEntityUserEntitiesToCircleAddPar par = new SSEntityUserEntitiesToCircleAddPar(parA);
      SSEntityMiscFct.checkWhetherUserIsAllowedToEditCircle(sqlFct, par.user, par.circleUri);
      SSEntityMiscFct.checkWhetherUserCanEditEntities(par.user, par.entityUris);
      dbSQL.startTrans(par.shouldCommit);
      SSServCaller.entityEntitiesToCircleAdd(par.user, par.circleUri, par.entityUris, false);
      SSEntityMiscFct.addEntitiesToCircleByEntityHandlers(par.user, par.entityUris, par.circleUri);
      dbSQL.commit(par.shouldCommit);
      return par.circleUri;
    } catch (SSSQLDeadLockErr deadLockErr) {
      if (dbSQL.rollBack(parA)) {
  ...
  @Override public Boolean entityUserAllowedIs(final SSServPar parA) throws Exception {
    ...
    try {
      ...
      for (SSEntityCircleTypeE circleType : sqlFct.getUserEntityCircleTypes(par.user, par.entityUri)) {
        switch (circleType) {
          ...
          default:
          {
            if (SSEntityRightTypeE.equals(par.accessRight, SSEntityRightTypeE.read) || SSEntityRightTypeE.equals(par.accessRight, SSEntityRightTypeE.edit)) {
              return true;
            }
          }
        }
  ...
  @Override public SSUri entityUserPublicSet(final SSServPar parA) throws Exception {
    try {
  ...
  @Override public SSUri entityUserShare(final SSServPar parA) throws Exception {
    try {
      ...
      dbSQL.startTrans(par.shouldCommit);
      final SSUri circleUri = SSServCaller.entityCircleCreate(par.user, par.entityUri, par.userUris, SSEntityCircleTypeE.group, SSLabelStr.get(SSUri.toStr(par.user) + SSStrU.underline + SSUri.toStr(par.entityUri)), SSUri.get(SSUserGlobals.systemUserURI), false);
      SSEntityMiscFct.shareByEntityHandlers(par.user, par.userUris, par.entityUri, circleUri);
      dbSQL.commit(par.shouldCommit);
      return circleUri;
    } catch (SSSQLDeadLockErr deadLockErr) {
      if (dbSQL.rollBack(parA)) {
