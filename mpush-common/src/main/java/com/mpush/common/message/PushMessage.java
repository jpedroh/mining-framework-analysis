...
public final class PushMessage extends BaseMessage {
  ...
  @Override public void decodeJsonBody(Map<String, Object> body) {
  ...
  @Override public Map<String, Object> encodeJsonBody() {
    if (content != null) {
  ...
  @Override public String toString() {
    return "PushMessage{" + "content=\'" + content.length + '\'' + ", packet=" + packet + '}';
  }
}