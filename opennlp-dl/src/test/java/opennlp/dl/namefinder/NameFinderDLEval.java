...
public class NameFinderDLEval extends AbstactDLTest {
  @Test public void tokenNameFinder1Test() throws Exception {
  ...
  @Test public void tokenNameFinder2Test() throws Exception {
    final File model = new File(getOpennlpDataDir(), "onnx/namefinder/model.onnx");
    final File vocab = new File(getOpennlpDataDir(), "onnx/namefinder/vocab.txt");
  ...
  @Test public void tokenNameFinder3Test() throws Exception {
    final File model = new File(getOpennlpDataDir(), "onnx/namefinder/model.onnx");
    final File vocab = new File(getOpennlpDataDir(), "onnx/namefinder/vocab.txt");
  ...
  @Test public void tokenNameFinderNoInputTest() throws Exception {
    final File model = new File(getOpennlpDataDir(), "onnx/namefinder/model.onnx");
    final File vocab = new File(getOpennlpDataDir(), "onnx/namefinder/vocab.txt");
  ...
  @Test public void tokenNameFinderNoEntitiesTest() throws Exception {
    final File model = new File(getOpennlpDataDir(), "onnx/namefinder/model.onnx");
    final File vocab = new File(getOpennlpDataDir(), "onnx/namefinder/vocab.txt");
  ...
  @Test public void tokenNameFinderMultipleEntitiesTest() throws Exception {
    final File model = new File(getOpennlpDataDir(), "onnx/namefinder/model.onnx");
    final File vocab = new File(getOpennlpDataDir(), "onnx/namefinder/vocab.txt");
    ...
    Assert.assertEquals(0, spans[0].getStart());
    Assert.assertEquals(14, spans[0].getEnd());
    Assert.assertEquals(3, spans[1].getStart());
    Assert.assertEquals(5, spans[1].getEnd());
  }

  @Test(expected = OrtException.class) public void invalidModel() throws Exception {
