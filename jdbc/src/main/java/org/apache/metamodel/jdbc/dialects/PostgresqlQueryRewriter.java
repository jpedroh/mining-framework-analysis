...
public class PostgresqlQueryRewriter extends LimitOffsetQueryRewriter {
  ...
  @Override public ColumnType getColumnType(int jdbcType, String nativeType, Integer columnSize) {
    if (nativeType != null) {
      switch (nativeType) {
        case "bool":
  ...
  @Override public String rewriteColumnType(ColumnType columnType, Integer columnSize) {
  ...
  @Override public void setStatementParameter(PreparedStatement st, int valueIndex, Column column, Object value) throws SQLException {
  ...
  @Override public Object getResultSetValue(ResultSet resultSet, int columnIndex, Column column) throws SQLException {
  ...
  @Override protected String rewriteFromItem(Query query, FromItem item) {
