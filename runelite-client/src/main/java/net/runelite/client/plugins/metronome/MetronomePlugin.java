...
@PluginDescriptor(name = "Metronome", description = "Play a sound on a specified tick to aid in efficient skilling and prayer flicking", tags = { "skilling", "tick", "timers", "prayer", "flick" }, enabledByDefault = false) public class MetronomePlugin extends Plugin {
  @Inject private Client client;

  @Inject private MetronomePluginConfiguration config;

  @Inject private MetronomeOverlay ovr;
  ...
  @Provides MetronomePluginConfiguration provideConfig(ConfigManager configManager) {
