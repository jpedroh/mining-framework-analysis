...
public final class Headers implements Iterable<Header>, ToJSON {
  ...
  private static class HeaderHashMap extends LinkedHashMap<CaseInsensitiveKey, List<String>> {
    ...
    Iterator<Header> headerIterator() {
      List<Header> headers = new ArrayList<Header>();
      for (Map.Entry<
<<<<<<< /usr/src/app/output/httpcache4j/httpcache4j/ccdc581f7f9d3b683b03af7c474160d3a3d1594f/httpcache4j-api/src/main/java/org/codehaus/httpcache4j/Headers.java/left.java
      CaseInsensitiveKey
=======
      Name
>>>>>>> /usr/src/app/output/httpcache4j/httpcache4j/ccdc581f7f9d3b683b03af7c474160d3a3d1594f/httpcache4j-api/src/main/java/org/codehaus/httpcache4j/Headers.java/right.java
      , List<String>> entry : this.entrySet()) {
