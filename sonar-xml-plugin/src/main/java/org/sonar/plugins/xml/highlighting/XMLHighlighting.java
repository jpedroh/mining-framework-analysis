...
public class XMLHighlighting {
  ...
  private void highlightEndElement(XMLStreamReader xmlReader, Location prevLocation, int startOffset) {
    ...
    boolean isEmptyElement = prevLocation.getLineNumber() == xmlReader.getLocation().getLineNumber() && prevLocation.getColumnNumber() == xmlReader.getLocation().getColumnNumber();
    if (isEmptyElement) {
