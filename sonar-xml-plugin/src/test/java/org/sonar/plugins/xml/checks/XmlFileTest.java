...
public class XmlFileTest {
  ...
  @Test public void test_no_delta() throws Exception {
    assertDelta("<?xml version=\"1.0\" encoding=\"UTF-8\" ?> <tag/>", 0, 0);
  }

  @Test public void test_no_delta_if_no_prolog() throws Exception {
    assertDelta(" <tag/>", 0, 0);
    assertDelta("<tag/>", 0, 0);
  }

  @Test public void test_no_line_delta() throws Exception {
    assertDelta("abc<?xml version=\"1.0\" encoding=\"UTF-8\" ?> <tag/>", 3, 0);
    assertDelta(" <?xml version=\"1.0\" encoding=\"UTF-8\" ?> <tag/>", 1, 0);
  }

  @Test public void test_line_delta() throws Exception {
