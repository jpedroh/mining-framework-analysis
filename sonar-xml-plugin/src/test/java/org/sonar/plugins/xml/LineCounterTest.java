...
public class LineCounterTest {
  ...
  @Test public void test_simple_file() throws IOException {
    verifyMetrics("simple.xml", 18, 15, 1);
  }

  @Test public void test_complex() throws IOException {
...
>>>>>>> /usr/src/app/output/sonarcommunity/sonar-xml/0e1fee2967a660d9ad773b8279e8ffe5ab4d0908/sonar-xml-plugin/src/test/java/org/sonar/plugins/xml/LineCounterTest.java/right.java
     inputFile = createInputFile(moduleBaseDir.toPath(), filename);
  ...
  @Test public void test_file_with_char_before_prolog() throws Exception {
  ...
  private CompatibleInputFile createInputFile(Path moduleBaseDir, String name) {
    return 
<<<<<<< /usr/src/app/output/sonarcommunity/sonar-xml/0e1fee2967a660d9ad773b8279e8ffe5ab4d0908/sonar-xml-plugin/src/test/java/org/sonar/plugins/xml/LineCounterTest.java/left.java
    new DefaultInputFile(MODULE_KEY, name).setModuleBaseDir(moduleBaseDir).setType(InputFile.Type.MAIN).setLanguage(Xml.KEY).setCharset(StandardCharsets.UTF_8)
=======
    wrap(new DefaultInputFile(MODULE_KEY, name).setModuleBaseDir(moduleBaseDir).setType(InputFile.Type.MAIN).setLanguage(Xml.KEY).setCharset(StandardCharsets.UTF_8))
>>>>>>> /usr/src/app/output/sonarcommunity/sonar-xml/0e1fee2967a660d9ad773b8279e8ffe5ab4d0908/sonar-xml-plugin/src/test/java/org/sonar/plugins/xml/LineCounterTest.java/right.java
    ;
  }
}