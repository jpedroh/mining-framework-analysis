...
public class LineCountParserTest {
  ...
  @Test public void testSimpleLineCountParser() throws Exception {
  ...
  @Test public void testComplexLineCountParser() throws Exception {
  ...
  @Test(expected = SAXException.class) public void shouldNotInfiniteLoopWhenParsingInvalidXml() throws Exception {
    newLineCountData("src/test/resources/parsers/linecount/invalid.xml");
  }

  @Test public void testParseUtf16() throws Exception {
