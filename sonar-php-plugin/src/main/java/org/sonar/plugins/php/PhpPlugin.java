...
@Properties(value = { @Property(key = PhpPlugin.FILE_SUFFIXES_KEY, defaultValue = Php.DEFAULT_FILE_SUFFIXES, name = "File Suffixes", description = "Comma-separated list of suffixes of PHP files to analyze.", global = true, project = true), @Property(key = PhpPlugin.PHPUNIT_TESTS_REPORT_PATH_KEY, name = "Unit Test Report", project = true, global = true, description = "Path to the PHPUnit unit test execution report file. The path may be either absolute or relative to the project base directory."), @Property(key = PhpPlugin.PHPUNIT_COVERAGE_REPORT_PATH_KEY, name = "Coverage Report", project = true, global = true, description = "Path to the PHPUnit code coverage report file. The path may be either absolute or relative to the project base directory.") }) public class PhpPlugin extends SonarPlugin {
  ...
  @Override public List getExtensions() {
    return ImmutableList.of(Php.class, PhpSourceCodeColorizer.class, NoSonarAndCommentedOutLocSensor.class, PhpCPDMapping.class, PhpCommonRulesEngine.class, PHPSquidSensor.class, PHPRulesDefinition.class, PHPProfile.class, PSR2Profile.class, PhpUnitSensor.class, PhpUnitResultParser.class, PhpUnitCoverageResultParser.class, PhpUnitItCoverageResultParser.class, PhpUnitOverallCoverageResultParser.class);
  }
}