...
public class PhpUnitSensorTest {
  ...
  @Mock private PhpUnitResultParser parser;

  @Mock private PhpUnitCoverageResultParser coverageParser;

  @Mock private PhpUnitItCoverageResultParser itCoverageParser;

  @Mock private PhpUnitOverallCoverageResultParser overallCoverageParser;
  ...
  @Test public void shouldExecuteOnProject() {
  ...
  @Test public void shouldParserReport() {
  ...
  @Test public void should_parse_relative_path_report() {
