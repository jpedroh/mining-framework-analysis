...
public class JsonAssertTest {
  ...
  @Test public void testArrayDifferent() {
    try {
      assertJsonEquals("[{\"test\":1}, {\"test\":2}]", "[{\n\"test\": 1\n}, {\"test\": 4}]");
  ...
  @Test public void testNumberAndString() {
    try {
      setTolerance(0.001);
  ...
  @Test public void testSimpleDifferent() {
    try {
      assertJsonEquals("1", "\n2\n");
      fail("Exception expected");
    } catch (AssertionError e) {
  ...
  @Test public void testSimpleIgnore() {
  ...
  @Test public void testEqualsNodeFail() throws IOException {
    try {
  ...
  @Test public void testEqualsNodeStringFail() throws IOException {
    try {
  ...
  @Test(expected = IllegalArgumentException.class) public void testInvalidJsonActual() {
    assertJsonEquals("{\"test\":1}", "{\n\"foo\": 1\n");
  }
  ...
  @Test public void testComparisonWhenWithinTolerance() {
    setTolerance(0.01);
    assertJsonEquals("{\"test\":1}", "{\"test\":1.009}");
  }

  @Test public void testComparisonWhenWithinToleranceInlineConfig() {
    assertJsonEquals("{\"test\":1}", "{\"test\":1.009}", withTolerance(0.01));
  }

  @Test public void testComparisonWhenWithinToleranceNegative() {
    setTolerance(0.01);
    assertJsonEquals("1", "\n0.9999\n");
  }

  @Test public void testComparisonWhenOverTolerance() {
    try {
      setTolerance(0.01);
      assertJsonEquals("1", "\n1.1\n");
      fail("Exception expected");
  ...
  @Test public void testNullOk() {
    assertJsonEquals("{\"test\":null}", "{\n\"test\": null\n}");
  }

  @Test public void testNullFail() {
    try {
      assertJsonEquals("{\"test\":null}", "{\n\"test\": 1\n}");
      fail("Exception expected");
    } catch (AssertionError e) {
  ...
  @Test public void testExtraRootKey() {
    try {
      assertJsonEquals("{\"test\":1}", "{\n\"test\": 1\n, \"foo\": 2}");
      fail("Exception expected");
    } catch (AssertionError e) {
  ...
  @Test public void testIgnoreOneElement() {
    try {
  ...
  @Test public void testMissingRootKey() {
    try {
  ...
  @Test public void testDifferentNumericValue() {
    try {
      assertJsonEquals("{\"test\":1}", "{\n\"test\": 2\n}");
      fail("Exception expected");
    } catch (AssertionError e) {
  ...
  @Test public void testDifferentBooleanValue() {
    try {
  ...
  @Test public void testSameArrayValue() {
    assertJsonEquals("{\"test\":[1, 2, 3]}", "{\n\"test\": [1, 2, 3]\n}");
  }

  @Test public void testIgnoreArray() {
    assertJsonEquals("{\"test\":\"${json-unit.ignore}\"}", "{\n\"test\": [1, 2, 3]\n}");
  }

  @Test public void testDifferentArrayLength() {
    try {
      assertJsonEquals("{\"test\":[1, 2, 3]}", "{\n\"test\": [1, 2]\n}");
      fail("Exception expected");
    } catch (AssertionError e) {
  ...
  @Test public void testDifferentArrayValue() {
    try {
      assertJsonEquals("{\"test\":[1, 2, 3]}", "{\n\"test\": [1, 2, 5]\n}");
      fail("Exception expected");
    } catch (AssertionError e) {
  ...
  @Test public void testDifferentArrayType() {
    try {
      assertJsonEquals("{\"test\":[1, 2, 3]}", "{\n\"test\": [1, false, 3]\n}");
      fail("Exception expected");
    } catch (AssertionError e) {
  ...
  @Test public void testComplexOk() {
  ...
  @Test public void testComplexErrors() {
    try {
      assertJsonEquals("{\n" + "   \"test\":[\n" + "      1,\n" + "      2,\n" + "      {\n" + "         \"child\":{\n" + "            \"value1\":1,\n" + "            \"value2\":true,\n" + "            \"value3\":\"test\",\n" + "            \"value4\":{\n" + "               \"leaf\":5\n" + "            }\n" + "         }\n" + "      }\n" + "   ],\n" + "   \"root2\":false,\n" + "   \"root3\":1\n" + "}", "{\n" + "   \"test\":[\n" + "      5,\n" + "      false,\n" + "      {\n" + "         \"child\":{\n" + "            \"value1\":5,\n" + "            \"value2\":\"true\",\n" + "            \"value3\":\"test\",\n" + "            \"value4\":{\n" + "               \"leaf2\":5\n" + "            }\n" + "         },\n" + "         \"child2\":{\n" + "\n" + "         }\n" + "      }\n" + "   ],\n" + "   \"root4\":\"bar\"\n" + "}");
      fail("Exception expected");
    } catch (AssertionError e) {
  ...
  @Test public void testIgnoreObject() {
    assertJsonEquals("{\"test\":\"${json-unit.ignore}\"}", "{\n\"test\": {\"object\" : {\"another\" : 1}}}");
  }

  @Test public void testIgnoreObjectDifferentPlaceholder() {
    JsonAssert.setIgnorePlaceholder("@IGNORE");
    assertJsonEquals("{\"test\":\"@IGNORE\"}", "{\n\"test\": {\"object\" : {\"another\" : 1}}}");
    JsonAssert.setIgnorePlaceholder("${json-unit.ignore}");
  }

  @Test public void testIgnoreObjectErrorInSibling() {
    try {
  ...
  @Test public void testEmptyOk() {
    assertJsonEquals("{\"test\":{}}", "{\n\"test\": {}\n}");
  }

  @Test public void testAssertPartOk() {
    assertJsonPartEquals("1", "{\"test\":{\"value\":1}}", "test.value");
  }

  @Test public void testAssertPartOkNumber() {
    assertJsonPartEquals(1, "{\"test\":{\"value\":1}}", "test.value");
  }

  @Test public void testAssertPartOkFloat() {
    assertJsonPartEquals(1.1, "{\"test\":{\"value\":1.1}}", "test.value");
  }

  @Test public void testAssertPartOkDouble() {
    assertJsonPartEquals(1.1d, "{\"test\":{\"value\":1.1}}", "test.value");
  }

  @Test public void testAssertPartOkReaders() {
    assertJsonPartEquals(new StringReader("1"), new StringReader("{\"test\":{\"value\":1}}"), "test.value");
  }

  @Test public void testAssertPartOkString() {
    assertJsonPartEquals("a b", "{\"test\":{\"value\":\"a b\"}}", "test.value");
  }

  @Test public void testAssertPart() {
    try {
  ...
  @Test public void testAssertJsonNodeAbsent() {
    try {
  ...
  @Test public void testAssertJsonNodeAbsentOk() {
    assertJsonNodeAbsent("{\"test\":{\"value\":1}}", "test.different");
  }

  @Test public void testAssertJsonNodePresent() {
    try {
  ...
  @Test public void testAssertJsonNodePresentOk() {
    assertJsonNodePresent("{\"test\":{\"value\":1}}", "test.value");
  }

  @Test public void testAssertPartComplex() {
    try {
  ...
  @Test public void testAssertPartArrayOk() {
    assertJsonPartEquals("2", "{\"test\":[{\"value\":1},{\"value\":2}]}", "test[1].value");
  }

  @Test public void testAssertPartArray() {
    try {
  ...
  @Test public void testAssertPartStructureEquals() {
    assertJsonPartStructureEquals("{\"value\":5}", "{\"test\":[{\"value\":1},{\"value\":2}]}", "test[1]");
  }

  @Test public void testAssertPartNonexisting() {
    try {
  ...
  @Test public void testAssertStructureEquals() {
    assertJsonStructureEquals("[{\"test\":1}, {\"test\":2}]", "[{\n\"test\": 1\n}, {\"test\": 4}]");
  }

  @Test public void testComplexStructureOk() {
    assertJsonStructureEquals("{\n" + "   \"test\":[\n" + "      1,\n" + "      2,\n" + "      {\n" + "         \"child\":{\n" + "            \"value1\":1,\n" + "            \"value2\":true,\n" + "            \"value3\":\"test\",\n" + "            \"value4\":{\n" + "               \"leaf\":5\n" + "            }\n" + "         }\n" + "      }\n" + "   ],\n" + "   \"root2\":false,\n" + "   \"root3\":1\n" + "}", "{\n" + "   \"test\":[\n" + "      4,\n" + "      5,\n" + "      {\n" + "         \"child\":{\n" + "            \"value1\":6,\n" + "            \"value2\":false,\n" + "            \"value3\":\"different\",\n" + "            \"value4\":{\n" + "               \"leaf\":6\n" + "            }\n" + "         }\n" + "      }\n" + "   ],\n" + "   \"root2\":true,\n" + "   \"root3\":2\n" + "}");
  }

  @Test public void testAssertStructureDiffers() {
    try {
      assertJsonStructureEquals("[{\"test\":1}, {\"test\":2}]", "[{\n\"test\": 1\n}, {\"TEST\": 4}]");
      fail("Exception expected");
    } catch (AssertionError e) {
  ...
  @Test public void testAssertStructureArrayDiffers() {
    try {
  ...
  @Test public void testTreatNullAsAbsentTwoValues() {
    setOptions(TREATING_NULL_AS_ABSENT);
    assertJsonEquals("{\"test\":{\"a\":1}}", "{\"test\":{\"a\":1, \"b\": null, \"c\": null}}");
  }

  @Test public void testTreatNullAsNullInExpected() {
    setOptions(TREATING_NULL_AS_ABSENT);
    try {
  ...
  @Test public void testTreatNullAsNullInExpectedInline() {
    try {
  ...
  @Test public void shouldIgnoreArrayOrder() {
    setOptions(IGNORING_ARRAY_ORDER);
    assertJsonEquals("{\"test\":[1,2,3]}", "{\"test\":[3,2,1]}");
  }

  @Test public void shouldIgnoreArrayOrderOnObjectArrays() {
    setOptions(IGNORING_ARRAY_ORDER);
    assertJsonEquals("{\"test\":[{\"key\":1},{\"key\":2},{\"key\":3}]}", "{\"test\":[{\"key\":3},{\"key\":2},{\"key\":1}]}");
  }

  @Test public void shouldFailIfArrayContentIsDifferent() {
    setOptions(IGNORING_ARRAY_ORDER);
    try {
  ...
  @Test public void shouldFailIfArrayContentIsDifferentOnObjectArrays() {
    setOptions(IGNORING_ARRAY_ORDER);
    try {
  ...
  @Test public void shouldIgnoreExtraFieldsIfRequested() {
    setOptions(IGNORING_EXTRA_FIELDS);
    assertJsonEquals("{\"test\":{\"b\":2}}", "{\"test\":{\"a\":1, \"b\":2, \"c\":3}}");
  }

  @Test public void shouldIgnoreExtraFieldsInArray() {
    setOptions(IGNORING_ARRAY_ORDER, IGNORING_EXTRA_FIELDS);
    assertJsonEquals("{\"test\":[{\"key\":1},{\"key\":2},{\"key\":3}]}", "{\"test\":[{\"key\":3},{\"key\":2, \"extraField\":2},{\"key\":1}]}");
  }

  @Test public void shouldIgnoreValues() {
    setOptions(IGNORING_VALUES);
    assertJsonEquals("{\"test\":{\"a\":1,\"b\":2,\"c\":3}}", "{\"test\":{\"a\":3,\"b\":2,\"c\":1}}");
  }

  @Test public void shouldIgnoreValuesInArray() {
    setOptions(IGNORING_VALUES);
    try {
      assertJsonEquals("{\"test\":[{\"a\":1},{\"b\":2},{\"c\":3}]}", "{\"test\":[{\"a\":3},{\"b\":2},{\"c\":1}]}");
    } catch (AssertionError e) {
  ...
  @Test public void shouldFailIfIgnoringValuesButTypesAreDifferent() {
    setOptions(IGNORING_VALUES);
    try {
      assertJsonEquals("{\"test\":{\"a\":1,\"b\":2,\"c\":3}}", "{\"test\":{\"a\":3,\"b\":\"2\",\"c\":1}}");
    } catch (AssertionError e) {
  ...
  @Test public void shouldFailIfIgnoringValuesButTypesAreDifferentInArray() {
    setOptions(IGNORING_VALUES);
    try {
  ...
  @Test public void shouldIgnoreValuesWhenToleranceSet() {
    setTolerance(0.01);
    setOptions(IGNORING_VALUES);
    assertJsonEquals("5", "\n0.9999\n");
  }

  @Test public void assertPartNotEqualsShouldPass() {
    assertJsonPartNotEquals("2", "{\"test\":{\"value\":1}}", "test.value");
  }

  @Test public void assertPartNotEqualsShouldFailWithCorrectMessage() {
    try {
  ...
  @Test public void assertNotEqualsShouldPass() {
    assertJsonNotEquals("{\"test\":{\"value\":2}}", "{\"test\":{\"value\":1}}");
  }

  @Test public void assertNotEqualsShouldFailWithCorrectMessage() {
    try {
