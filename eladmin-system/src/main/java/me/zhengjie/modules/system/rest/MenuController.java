...
public class MenuController {
    ...
    public ResponseEntity<List<MenuDto>> queryAllMenu(@RequestParam
    Long pid) {
    ...
    @PreAuthorize("@el.check('menu:list')")
    public ResponseEntity<List<MenuDto>> getMenuSuperior(@RequestBody
    List<Long> ids) {
    ...
    public ResponseEntity<Object> updateMenu(@Validated(Menu.Update.class)
    @RequestBody
    Menu resources) {
    ...
    public ResponseEntity<Object> deleteMenu(@RequestBody
    Set<Long> ids) {
        Set<Menu> menuSet = new HashSet<>();
        for (Long id : ids) {
            if (id <= 126) {
