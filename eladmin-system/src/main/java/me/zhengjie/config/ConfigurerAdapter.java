 ...
 * @date 2018-11-30
 */
@Configuration @EnableWebMvc public class ConfigurerAdapter implements WebMvcConfigurer {
  @Value(value = "${file.path}") private String path;

  @Value(value = "${file.avatar}") private String avatar;
