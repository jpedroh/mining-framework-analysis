 ...
 * @author Janni Kovacs
 */
@ColorCodes(value = { "stack.tab.border", "stack.tab.border.selected", "stack.tab.border.selected.focused", "stack.tab.border.selected.focuslost", "stack.tab.border.disabled", "stack.tab.top", "stack.tab.top.selected", "stack.tab.top.selected.focused", "stack.tab.top.selected.focuslost", "stack.tab.top.disabled", "stack.tab.bottom", "stack.tab.bottom.selected", "stack.tab.bottom.selected.focused", "stack.tab.bottom.selected.focuslost", "stack.tab.bottom.disabled", "stack.tab.text", "stack.tab.text.selected", "stack.tab.text.selected.focused", "stack.tab.text.selected.focuslost", "stack.tab.text.disabled", "stack.border" }) public class ArchGradientPainter extends BaseTabComponent {
  ...
  @Override public void updateBorder() {
  ...
  @Override public void updateFocus() {
    update();
    updateBorder();
    updateFont();
  }
  ...
  @Override public void paintForeground(Graphics g) {
  ...
  private void paintSelected(Graphics g, Color top, Color bottom) {
    ...
    if (firstTab) {
      if (orientation.isHorizontal() && getX() <= 1) {
        ...
        if (orientation.isVertical() && getY() <= 1) {
          left.translate(0, -1);
        }
      }
    }
