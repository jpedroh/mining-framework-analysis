 ...
 */
@ColorCodes(value = { "paint.line", "paint.divider", "paint.insertion.area", "paint.insertion.border", "paint.removal" }) public class FlatStationPaint implements StationPaint {
