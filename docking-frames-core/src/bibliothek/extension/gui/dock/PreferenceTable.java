...
public class PreferenceTable extends JPanel {
  ...
  public PreferenceTable() {
    ...
    add(panel, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public <V extends java.lang.Object> PreferenceEditorFactory<V> getEditorFactory(Path type) {
  ...
  /**
     ...
     * @return a new editor
     */
  @SuppressWarnings(value = { "unchecked" }) protected <V extends java.lang.Object> PreferenceEditor<V> createEditor(Path type) {
  ...
  private class Row<V extends java.lang.Object> implements PreferenceEditorCallback<V> {
    private int index;
    ...
    public void setIndex(int index) {
      this.index = index;
      layout.setConstraints(label, new GridBagConstraints(0, index, 1, 1, 1.0, 1.0, GridBagConstraints.LINE_START, GridBagConstraints.NONE, new Insets(1, 1, 1, 1), 0, 0));
      if (editor != null) {
        layout.setConstraints(editor.getComponent(), new GridBagConstraints(1, index, 1, 1, 100.0, 1.0, GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
      }
      if (!initialized) {
        initialized = true;
        initialize();
      ...
      if (modelOperations != null) {
        for (Map.Entry<PreferenceOperation, Button> entry : modelOperations.entrySet()) {
          ...
          layout.setConstraints(entry.getValue(), new GridBagConstraints(location, index, 1, 1, 1.0, 1.0, GridBagConstraints.LINE_END, GridBagConstraints.NONE, new Insets(1, 0, 1, 0), 0, 0));
        }
      }
    ...
    @SuppressWarnings(value = { "unchecked" }) private void initialize() {
    ...
    private void setOperation(final PreferenceOperation operation, boolean enabled, final boolean editor) {
      ...
      if (button == null) {
        ...
        layout.setConstraints(button, new GridBagConstraints(location, index, 1, 1, 1.0, 1.0, GridBagConstraints.LINE_END, GridBagConstraints.NONE, new Insets(1, 0, 1, 0), 0, 0));
        revalidate();
      }
      button.getModel().setEnabled(enabled);
    }

    @SuppressWarnings(value = { "unchecked" }) public void changed() {
      if (editor != null) {
        editor.setValue((V) model.getValue(index));
      }
    ...
    @SuppressWarnings(value = { "unchecked" }) public V get() {
  ...
  private class Listener implements PreferenceModelListener {
    @SuppressWarnings(value = { "unchecked" }) public void preferenceAdded(PreferenceModel model, int beginIndex, int endIndex) {
