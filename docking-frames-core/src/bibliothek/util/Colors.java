...
public final class Colors {
  ...
  public static Color darker(Color c, double value) {
    ...
    value = 1 - value;
    return new Color((int) (c.getRed() * value), (int) (c.getGreen() * value), (int) (c.getBlue() * value));
  }
  ...
  public static Color brighter(Color c, double value) {
    ...
    dg = 255 - c.getGreen();
    db = 255 - c.getBlue();
    Color back = new Color(c.getRed() + (int) (dr * value), c.getGreen() + (int) (dg * value), c.getBlue() + (int) (db * value));
    return back;
  }
