...
public class Node extends VisibleSplitNode implements Divideable {
  ...
  @Override public int getChildLocation(SplitNode child) {
    if (left == child) {
      return 0;
    }
    if (right == child) {
  ...
  @Override public void setChild(SplitNode child, int location) {
    if (location == 0) {
      setLeft(child);
    } else {
      if (location == 1) {
  ...
  @Override public int getMaxChildrenCount() {
    return 2;
  }

  @Override public SplitNode getChild(int location) {
    switch (location) {
      case 0:
      return getLeft();
      case 1:
  ...
  @Override public SplitNode getVisible() {
    if (left != null && right != null) {
  ...
  @Override public boolean isOfUse() {
    return true;
  }

  @Override public void updateBounds(double x, double y, double width, double height, double factorW, double factorH, boolean components) {
      ...
      if (!leftVisible && rightVisible) {
        ...
        if (leftVisible && rightVisible) {
          ...
          if (orientation == Orientation.HORIZONTAL) {
            ...
            if (right != null) {
              right.updateBounds(x + dividerLocation + dividerWidth / 2, y, width - dividerLocation - dividerWidth / 2, height, factorW, factorH, components);
            }
          } else {
            ...
            if (right != null) {
              right.updateBounds(x, y + dividerLocation + dividerHeight / 2, width, height - dividerLocation - dividerHeight / 2, factorW, factorH, components);
            }
          }
        }
      }
  ...
  @Override public void setBounds(double x, double y, double width, double height, double factorW, double factorH, boolean updateComponentBounds) {
    ...
    if (leftVisible && rightVisible) {
      ...
      if (orientation == Orientation.HORIZONTAL) {
        double dividerWidth = factorW > 0 ? Math.max(0, dividerSize / factorW) : 0.0;
        double dividerLocation = width * divider;
        dividerBounds.setBounds((int) ((x + dividerLocation - dividerWidth / 2) * factorW), (int) (y * factorH), dividerSize, (int) (height * factorH + 0.5));
      } else {
        double dividerHeight = factorH > 0 ? Math.max(0, dividerSize / factorH) : 0.0;
        double dividerLocation = height * divider;
        dividerBounds.setBounds((int) (x * factorW), (int) ((y + dividerLocation - dividerHeight / 2) * factorH), (int) (width * factorW + 0.5), dividerSize);
      }
    }
  }
  ...
  public Rectangle getDividerBounds(double divider, Rectangle bounds) {
    ...
    if (orientation == Orientation.HORIZONTAL) {
      ...
      double dividerLocation = width * divider;
      bounds.setBounds((int) ((x + dividerLocation - dividerWidth / 2) * factorW + 0.5), (int) (y * factorH + 0.5), dividerSize, (int) (height * factorH + 0.5));
    } else {
      double dividerHeight = dividerSize / factorH;
      double dividerLocation = height * divider;
      bounds.setBounds((int) (x * factorW + 0.5), (int) ((y + dividerLocation - dividerHeight / 2) * factorH + 0.5), (int) (width * factorW + 0.5), dividerSize);
    }
    return bounds;
  }
  ...
  @Override public PutInfo getPut(int x, int y, double factorW, double factorH, Dockable drop) {
    boolean leftVisible = left == null || left.isVisible();
    boolean rightVisible = right == null || right.isVisible();
    if (leftVisible && rightVisible) {
      if (orientation == Orientation.HORIZONTAL) {
  ...
  @Override public boolean isInOverrideZone(int x, int y, double factorW, double factorH) {
    boolean leftVisible = left == null || left.isVisible();
    boolean rightVisible = right == null || right.isVisible();
    if (leftVisible && rightVisible) {
      if (orientation == Orientation.HORIZONTAL) {
  ...
  @Override public void evolve(SplitDockTree<Dockable>.Key key, boolean checkValidity, Map<Leaf, Dockable> linksToSet) {
  ...
  @Override public boolean insert(SplitDockPlaceholderProperty property, Dockable dockable) {
  ...
  @Override public boolean insert(SplitDockPathProperty property, int depth, Dockable dockable) {
    boolean leftVisible = left == null || left.isVisible();
    boolean rightVisible = right == null || right.isVisible();
    if (leftVisible && rightVisible) {
      if (depth >= property.size()) {
        ...
        boolean expand = (orientation == SplitDockStation.Orientation.HORIZONTAL && (node.getLocation() == SplitDockPathProperty.Location.TOP || node.getLocation() == SplitDockPathProperty.Location.BOTTOM)) || (orientation == SplitDockStation.Orientation.VERTICAL && (node.getLocation() == SplitDockPathProperty.Location.LEFT || node.getLocation() == SplitDockPathProperty.Location.RIGHT));
        ...
        if (expand) {
          ...
          if (node.getLocation() == SplitDockPathProperty.Location.TOP || node.getLocation() == SplitDockPathProperty.Location.BOTTOM) {
            orientation = SplitDockStation.Orientation.VERTICAL;
          } else {
            orientation = SplitDockStation.Orientation.HORIZONTAL;
          }
  ...
  @Override public <N extends java.lang.Object> N submit(SplitTreeFactory<N> factory) {
  ...
  @Override public Leaf getLeaf(Dockable dockable) {
  ...
  @Override public Node getDividerNode(int x, int y) {
    boolean leftVisible = left == null || left.isVisible();
    boolean rightVisible = right == null || right.isVisible();
  ...
  @Override public void visit(SplitNodeVisitor visitor) {
  ...
  @Override public void toString(int tabs, StringBuilder out) {
    out.append("Node[ ");
