...
public class MenuLineLayoutPossibility {
  ...
  /**
	 ...
	 */
  @Todo(compatibility = Compatibility.COMPATIBLE, target = Version.VERSION_1_1_1, priority = Priority.MINOR, description = "Make this property easy modifiable by the clients") public double getScore() {
    double result = 0;
    if (menuSize == null) {
      result += 1;
    } else {
