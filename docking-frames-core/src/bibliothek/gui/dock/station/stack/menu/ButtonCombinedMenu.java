...
public abstract class ButtonCombinedMenu<B extends Component> extends AbstractCombinedMenu {
  ...
  @Override protected void backgroundChanged(BackgroundPaint paint) {
    if (button != null) {
  ...
  @Override protected void ensureComponent() {
  ...
  @Override protected void selected(Dockable dockable) {
