...
public class StackDockStation extends AbstractDockableStation implements StackDockComponentParent {
  ...
  public static final PropertyKey<StackDockComponentFactory> COMPONENT_FACTORY = new PropertyKey<StackDockComponentFactory>("stack dock component factory");
  ...
  public static final PropertyKey<TabContentFilter> TAB_CONTENT_FILTER = new PropertyKey<TabContentFilter>("stack dock tab content filter");
...
<<<<<<< /usr/src/app/output/benoker/dockingframes/7792989b18d9aa22f844dd8a0ba8b56c8021d1e5/docking-frames-core/src/bibliothek/gui/dock/StackDockStation.java/left.java
...
>>>>>>> /usr/src/app/output/benoker/dockingframes/7792989b18d9aa22f844dd8a0ba8b56c8021d1e5/docking-frames-core/src/bibliothek/gui/dock/StackDockStation.java/right.java
  ...
  private PropertyValue<TabContentFilter> tabContentFilter = new PropertyValue<TabContentFilter>(TAB_CONTENT_FILTER) {
    @Override protected void valueChanged(TabContentFilter oldValue, TabContentFilter newValue) {
  ...
  protected void init() {
    ...
    stackComponentFactory = new PropertyValue<StackDockComponentFactory>(COMPONENT_FACTORY) {
      @Override protected void valueChanged(StackDockComponentFactory oldValue, StackDockComponentFactory newValue) {
        if (newValue == null) {
    ...
    tabPlacement = new PropertyValue<TabPlacement>(TAB_PLACEMENT) {
      @Override protected void valueChanged(TabPlacement oldValue, TabPlacement newValue) {
    ...
    addDockStationListener(new DockStationAdapter() {
      @Override public void dockableSelected(DockStation station, Dockable oldSelection, Dockable newSelection) {
  ...
  @Override public boolean isStationVisible() {
  ...
  public PlaceholderMap getPlaceholders(final Map<Dockable, Integer> children) {
    ...
    return dockables.toMap(new PlaceholderListItemAdapter<Dockable, StationChildHandle>() {
      @Override public ConvertedPlaceholderListItem convert(int index, StationChildHandle dockable) {
  ...
  public void setPlaceholders(PlaceholderMap placeholders, final Map<Integer, Dockable> children) {
    ...
    try {
      ...
      next.read(placeholders, new PlaceholderListItemAdapter<Dockable, StationChildHandle>() {
        ...
        @Override public StationChildHandle convert(ConvertedPlaceholderListItem item) {
  ...
  public void remove(int index) {
    ...
    try {
      ...
      if (dockables.dockables().size() == 1) {
        ...
        if (dockables.dockables().size() == 2 && !singleTabStackDockComponent()) {
  ...
  @Override public void configureDisplayerHints(DockableDisplayerHints hints) {
  ...
  @Override public void addMouseInputListener(MouseInputListener listener) {
  ...
  @Override public void removeMouseInputListener(MouseInputListener listener) {
      ...
      if (insert != null || (dragOperation != null && dragOperation.getDockable() != null)) {
        ...
        if (frontBounds != null) {
          if (insert != null) {
            ...
            if (dragOperation != null && dragOperation.getDockable() != null) {
