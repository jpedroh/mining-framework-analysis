...
<<<<<<< /usr/src/app/output/benoker/dockingframes/7792989b18d9aa22f844dd8a0ba8b56c8021d1e5/docking-frames-core/src/bibliothek/gui/dock/control/relocator/DefaultDockRelocator.java/left.java
  Path
=======
  StationDragOperation
>>>>>>> /usr/src/app/output/benoker/dockingframes/7792989b18d9aa22f844dd8a0ba8b56c8021d1e5/docking-frames-core/src/bibliothek/gui/dock/control/relocator/DefaultDockRelocator.java/right.java
   
<<<<<<< /usr/src/app/output/benoker/dockingframes/7792989b18d9aa22f844dd8a0ba8b56c8021d1e5/docking-frames-core/src/bibliothek/gui/dock/control/relocator/DefaultDockRelocator.java/left.java
  MERGE_EXTENSION = new Path("dock.merger")
=======
  dragOperation
>>>>>>> /usr/src/app/output/benoker/dockingframes/7792989b18d9aa22f844dd8a0ba8b56c8021d1e5/docking-frames-core/src/bibliothek/gui/dock/control/relocator/DefaultDockRelocator.java/right.java
  ;
  ...
  private Reaction selectNextTarget(Dockable dockable, DockTitle title, Point mouse) {
    ...
    RelocateOperation next = preparePut(mouse.x, mouse.y, mouse.x - pressPointLocal.x, mouse.y - pressPointLocal.y, dockable);
    boolean drop = false;
  ...
  protected Reaction dragMouseReleased(int x, int y, int modifiers, Dockable dockable) {
    checkModes(modifiers);
    int offmask = InputEvent.BUTTON1_DOWN_MASK | InputEvent.BUTTON2_DOWN_MASK | InputEvent.BUTTON3_DOWN_MASK;
