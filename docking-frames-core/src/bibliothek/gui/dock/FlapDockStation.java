...
<<<<<<< /usr/src/app/output/benoker/dockingframes/7792989b18d9aa22f844dd8a0ba8b56c8021d1e5/docking-frames-core/src/bibliothek/gui/dock/FlapDockStation.java/left.java
  /**
...
>>>>>>> /usr/src/app/output/benoker/dockingframes/7792989b18d9aa22f844dd8a0ba8b56c8021d1e5/docking-frames-core/src/bibliothek/gui/dock/FlapDockStation.java/right.java
  ...
  /**
     ...
     */
  public static final PropertyKey<ButtonContentFilter> BUTTON_CONTENT_FILTER = new PropertyKey<ButtonContentFilter>("flap dock station button content connector", new ConstantPropertyFactory<ButtonContentFilter>(new DefaultButtonContentFilter()), true);
  ...
  /**
     ...
     */
  public static final PropertyKey<FlapWindowFactory> WINDOW_FACTORY = new PropertyKey<FlapWindowFactory>("flap dock station window factory", new ConstantPropertyFactory<FlapWindowFactory>(new DefaultFlapWindowFactory()), true);
  ...
  private PropertyValue<FlapLayoutManager> layoutManager = new PropertyValue<FlapLayoutManager>(LAYOUT_MANAGER) {
    @Override protected void valueChanged(FlapLayoutManager oldValue, FlapLayoutManager newValue) {
      if (oldValue != null) {
  ...
  private PropertyValue<ButtonContent> buttonContent = new PropertyValue<ButtonContent>(BUTTON_CONTENT) {
    @Override protected void valueChanged(ButtonContent oldValue, ButtonContent newValue) {
  ...
  @Override public DockActionSource getDirectActionOffers(Dockable dockable) {
  ...
  @Override public void changed(Dockable dockable, DockTitle title, boolean active) {
  ...
  public PlaceholderMap getPlaceholders(final Map<Dockable, Integer> children) {
    ...
    return handles.toMap(new PlaceholderListItemAdapter<Dockable, DockableHandle>() {
      @Override public ConvertedPlaceholderListItem convert(int index, DockableHandle dockable) {
  ...
  public void setPlaceholders(PlaceholderMap map, final Map<Integer, Dockable> children) {
    ...
    try {
      ...
      DockablePlaceholderList<DockableHandle> next = new DockablePlaceholderList<DockableHandle>(map, new PlaceholderListItemAdapter<Dockable, DockableHandle>() {
        ...
        @Override public DockableHandle convert(ConvertedPlaceholderListItem item) {
        ...
        @Override public void added(DockableHandle dockable) {
          try {
  ...
  public StationDropOperation prepareDrop(int mouseX, int mouseY, int titleX, int titleY, Dockable dockable) {
    ...
    if (dropInfo == null) {
      if (dockable.accept(this) && accept(dockable) && acceptance.accept(this, dockable)) {
  ...
  @Override public boolean isVisible(Dockable dockable) {
  ...
  private void add(Dockable dockable, int index, int listIndex) {
    ...
    try {
      ...
      if (listIndex == -1 || handles.list().get(listIndex).getDockable() != null) {
        ...
        if (handles.list().get(listIndex).getDockable() == null) {
  ...
  private class Listener extends DockableAdapter {
    @Override public void titleExchanged(Dockable dockable, DockTitle title) {
      int index = indexOf(dockable);
      if (index < 0) {
        return;
      }
    ...
    public void setTitle(DockTitleVersion version) {
      ...
      if (version != null) {
        title = new DockTitleRequest(FlapDockStation.this, dockable, version) {
          @Override protected void answer(DockTitle previous, DockTitle title) {
            if (previous != null) {
