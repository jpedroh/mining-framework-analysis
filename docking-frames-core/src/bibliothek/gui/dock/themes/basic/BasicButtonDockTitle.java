...
@ColorCodes(value = { "title.flap.active", "title.flap.active.text", "title.flap.inactive", "title.flap.inactive.text", "title.flap.selected", "title.flap.selected.text", "title.flap.active.knob.highlight", "title.flap.active.knob.shadow", "title.flap.inactive.knob.highlight", "title.flap.inactive.knob.shadow", "title.flap.selected.knob.highlight", "title.flap.selected.knob.shadow" }) public class BasicButtonDockTitle extends AbstractDockTitle {
  ...
  public BasicButtonDockTitle(Dockable dockable, DockTitleVersion origin) {
    ...
    behavior = new ButtonContentValue(new ButtonContent(TRUE, TRUE, IF_DOCKABLE, IF_STATION, TRUE, TRUE)) {
      @Override protected void propertyChanged() {
        updateContent();
      }
    };
    ...
    addConditionalFont(DockFont.ID_FLAP_BUTTON_ACTIVE, TitleFont.KIND_FLAP_BUTTON_FONT, new Condition() {
      public boolean getState() {
        return isActive();
      }
    }, null);
    addConditionalFont(DockFont.ID_FLAP_BUTTON_SELECTED, TitleFont.KIND_FLAP_BUTTON_FONT, new Condition() {
      public boolean getState() {
        return isSelected();
      }
    }, null);
    addConditionalFont(DockFont.ID_FLAP_BUTTON_INACTIVE, TitleFont.KIND_FLAP_BUTTON_FONT, new Condition() {
      public boolean getState() {
        return !isActive();
      }
    }, null);
  ...
  @Override protected Insets getInnerInsets() {
  ...
  @Override protected DockActionSource getActionSourceFor(Dockable dockable) {
  ...
  @Override protected void updateIcon() {
  ...
  @Override protected void paintForeground(Graphics g, JComponent component) {
  ...
  @Override public Point getPopupLocation(Point click, boolean popupTrigger) {
    if (popupTrigger) {
      return click;
    }
    return null;
