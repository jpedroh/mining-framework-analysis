 ...
 */
@ColorCodes(value = { "action.button.text", "action.button.text.disabled" }) public class MiniButton<M extends BasicButtonModel> extends JComponent {
  ...
  private 
<<<<<<< /usr/src/app/output/benoker/dockingframes/4a829b05935f1ed1955f3ecefa55d0bcedfbd809/docking-frames-core/src/bibliothek/gui/dock/themes/basic/action/buttons/MiniButton.java/left.java
  String
=======
  MiniButtonContent
>>>>>>> /usr/src/app/output/benoker/dockingframes/4a829b05935f1ed1955f3ecefa55d0bcedfbd809/docking-frames-core/src/bibliothek/gui/dock/themes/basic/action/buttons/MiniButton.java/right.java
   
<<<<<<< /usr/src/app/output/benoker/dockingframes/4a829b05935f1ed1955f3ecefa55d0bcedfbd809/docking-frames-core/src/bibliothek/gui/dock/themes/basic/action/buttons/MiniButton.java/left.java
  borderKeyNormal = BORDER_KEY_NORMAL
=======
  content
>>>>>>> /usr/src/app/output/benoker/dockingframes/4a829b05935f1ed1955f3ecefa55d0bcedfbd809/docking-frames-core/src/bibliothek/gui/dock/themes/basic/action/buttons/MiniButton.java/right.java
  ;
  ...
  private BasicButtonModelAdapter listener = new BasicButtonModelAdapter() {
    @Override public void mouseInside(BasicButtonModel model, boolean mouseInside) {
      updateBorder();
    }
    ...
    @Override public void enabledStateChanged(BasicButtonModel model, boolean enabled) {
      updateBorder();
    }

    @Override public void selectedStateChanged(BasicButtonModel model, boolean selected) {
      updateBorder();
    }

    @Override public void borderChanged(BasicButtonModel model, String key, BorderModifier oldBorder, BorderModifier newBorder) {
      updateBorder();
    }
  };
  ...
  @Override public void paint(Graphics g) {
    ...
    AbstractPaintableComponent paintable = new AbstractPaintableComponent(component, this, paint) {
      ...
      @Override protected void border(Graphics g) {
        doPaintBorder(g);
      }

      @Override protected void children(Graphics g) {
      }

      @Override protected void overlay(Graphics g) {
      }
  ...
  protected void updateBorder() {
    if (model.isEnabled() && model.isMousePressed()) {
      ...
      if (model.isEnabled() && model.isMouseInside()) {
        if (model.isSelected()) {
