...
private List<ActionItem> actions = new ArrayList<ActionItem>();
     ...
     *
     * @param menu
     * 		whether a menu should be used or not
     */
     ...
     *
     * @param dockable
     * 		the Dockable for which the actions are shown, can be <code>null</code>
     * @param source
     * 		the list of actions, can be <code>null</code>
     * @param controller
     * 		the controller in whose realm this panel is used, can be <code>null</code>
     */
