...
public class ButtonPanel extends JPanel {
  ...
  private PropertyValue<DockActionImportanceOrder> actionOrder = new PropertyValue<DockActionImportanceOrder>(DockActionImportanceOrder.ORDER) {
    @Override protected void valueChanged(DockActionImportanceOrder oldValue, DockActionImportanceOrder newValue) {
      resetVisibleActions();
    }
  };
  ...
  public Dimension[] getPreferredSizes() {
    ...
    Dimension menuPreferred = menuItem == null ? new Dimension(0, 0) : menuItem.getItem().getPreferredSize();
