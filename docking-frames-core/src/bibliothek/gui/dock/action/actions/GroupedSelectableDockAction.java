 ...
 */
public abstract class GroupedSelectableDockAction<K extends java.lang.Object> extends GroupedDropDownItemAction<K, SimpleSelectableAction> implements SelectableDockAction {
  public static abstract class Check<K extends java.lang.Object> extends GroupedSelectableDockAction<K> {
    /**
    ...
    @Override protected SimpleSelectableAction createGroup(SelectableDockActionListener listener) {
  ...
  public static abstract class Radio<K extends java.lang.Object> extends GroupedSelectableDockAction<K> {
    /**
		 * Creates a new action.
		 * @param generator the generator to create new keys for unknown 
		 * Dockables
  ...
  @Override public void setGroup(K key, Dockable dockable) {
  ...
  @Override protected SimpleSelectableAction createGroup(K key) {
