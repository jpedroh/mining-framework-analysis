...
public interface DockTheme {
  ...
  /**
     ...
     */
  @FrameworkOnly public Combiner getCombiner(DockStation station);
  ...
  /**
     ...
     */
  @FrameworkOnly public StationPaint getPaint(DockStation station);
  ...
  /**
     ...
     */
  @FrameworkOnly public DisplayerFactory getDisplayFactory(DockStation station);
  ...
  /**
     ...
     * @return a factory
     */
  @FrameworkOnly public DockableMovingImageFactory getMovingImageFactory(DockController controller);
  ...
  /**
     ...
     * @return the selector
     */
  @FrameworkOnly public DockableSelection getDockableSelection(DockController controller);
}