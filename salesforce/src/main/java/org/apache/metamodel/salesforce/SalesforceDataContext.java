...
public class SalesforceDataContext extends QueryPostprocessDataContext implements UpdateableDataContext {
  ...
  @Override public DataSet executeQuery(Query query) {
        ...
        if (operand instanceof Number) {
          ...
          if (operand instanceof Date) {
            ...
            if (expectedColumnType == ColumnType.DATE) {
              ...
              if (expectedColumnType == ColumnType.TIME) {
  ...
  @Override protected DataSet materializeMainSchemaTable(Table table, List<Column> columns, int maxRows) {
    final StringBuilder sb = new StringBuilder();
    sb.append("SELECT ");
