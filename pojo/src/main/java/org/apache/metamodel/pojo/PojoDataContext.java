...
public class PojoDataContext extends QueryPostprocessDataContext implements UpdateableDataContext, Serializable {
  ...
  /**
     ...
     */
  public PojoDataContext(String schemaName, @SuppressWarnings(value = { "rawtypes" }) TableDataProvider... tableProviders) {
  ...
  @Override protected DataSet materializeMainSchemaTable(Table table, List<Column> columns, int maxRows) {
    ...
    @SuppressWarnings(value = { "rawtypes", "unchecked" }) DataSet dataSet = new PojoDataSet(pojoTable, selectItems);
    if (maxRows > 0) {
