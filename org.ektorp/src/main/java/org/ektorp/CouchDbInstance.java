...
public interface CouchDbInstance {
  ...
  /**
     ...
     * @return
     */
  <T extends java.lang.Object> T getConfiguration(final Class<T> c);
  ...
  /**
     ...
     * @return
     */
  <T extends java.lang.Object> T getConfiguration(final Class<T> c, String section);
  ...
  /**
     ...
     * @return
     */
  <T extends java.lang.Object> T getConfiguration(final Class<T> c, String section, String key);
