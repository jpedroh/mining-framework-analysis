 ...
 * @param <T>
 */
public class CouchDbRepositorySupport<T extends java.lang.Object> implements GenericRepository<T> {
  /**
  ...
  protected ViewQuery createQuery(String viewName) {
    return new ViewQuery().dbPath(db.path()).designDocId(stdDesignDocumentId).viewName(viewName);
  }
