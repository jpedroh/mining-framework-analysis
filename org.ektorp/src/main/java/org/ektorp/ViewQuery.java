...
public class ViewQuery {
  ...
  @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = { "SA_FIELD_SELF_ASSIGNMENT", "CN_IMPLEMENTS_CLONE_BUT_NOT_CLONEABLE" }) public ViewQuery clone() {
  ...
  private URI buildViewPath() {
    ...
    if (isNotEmpty(listName)) {
      ...
      if (ALL_DOCS_VIEW_NAME.equals(viewName)) {
        uri.append(viewName);
      } else {
  ...
  @Override public boolean equals(Object obj) {
    ...
    if (cachedQuery == null) {
      ...
      if (!cachedQuery.equals(other.cachedQuery)) {
        return false;
      }
    }
    if (dbPath == null) {
    ...
    if (designDocId == null) {
      ...
      if (!designDocId.equals(other.designDocId)) {
        return false;
      }
    }
    if (endDocId == null) {
      ...
      if (!endDocId.equals(other.endDocId)) {
        return false;
      }
    }
    if (endKey == null) {
    ...
    if (listName == null) {
      ...
      if (!listName.equals(other.listName)) {
        return false;
      }
    }
    if (queryParams == null) {
    ...
    if (staleOk == null) {
      ...
      if (!staleOk.equals(other.staleOk)) {
        return false;
      }
    }
    if (startDocId == null) {
      ...
      if (!startDocId.equals(other.startDocId)) {
        return false;
      }
    }
    if (startKey == null) {
  ...
  public static class Keys {
    ...
    @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "CN_IMPLEMENTS_CLONE_BUT_NOT_CLONEABLE") public Keys clone() {
      return new Keys(keys);
    }
