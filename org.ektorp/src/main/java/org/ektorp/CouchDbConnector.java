...
public interface CouchDbConnector {
  /**
	 *
	 * @param id
	 * @param the object to store in the database
  ...
  /**
	 ...
	 */
  <T extends java.lang.Object> T get(Class<T> c, String id);
  ...
  /**
	 ...
	 * @throws DocumentNotFoundException if the document was not found.
	 */
  <T extends java.lang.Object> T get(Class<T> c, String id, Options options);
  ...
  /**
	 ...
	 */
  <T extends java.lang.Object> T find(Class<T> c, String id);
  ...
  /**
	 ...
	 * @return null if the document was not found.
	 */
  <T extends java.lang.Object> T find(Class<T> c, String id, Options options);
  ...
  /**
	 ...
	 */
  @Deprecated <T extends java.lang.Object> T get(Class<T> c, String id, String rev);
  ...
  /**
	 ...
	 * @deprecated use get(Class<T> c, String id, Options options)
	 */
  @Deprecated <T extends java.lang.Object> T getWithConflicts(Class<T> c, String id);
  ...
  /**
	 ...
	 */
  <T extends java.lang.Object> List<T> queryView(ViewQuery query, Class<T> type);
  ...
  /**
	 ...
	 * @return
	 */
  <T extends java.lang.Object> Page<T> queryForPage(ViewQuery query, PageRequest pr, Class<T> type);
  ...
  <T extends java.lang.Object> T callUpdateHandler(final UpdateHandlerRequest req, final Class<T> c);
