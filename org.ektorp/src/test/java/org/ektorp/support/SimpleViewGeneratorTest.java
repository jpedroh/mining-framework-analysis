...
public class SimpleViewGeneratorTest {
  ...
  /**
         ...
         * @throws IOException 
         */
  @BeforeClass public static void createWindowsUnixLineEndings() throws IOException {
  ...
  @Test public void testGenerateFindByView() {
    DesignDocument.View v = gen.generateFindByView("name", "");
    assertEquals(expectedFindByNameMapFunction, v.getMap());
  }

  @Test public void views_should_be_generated_for_all_annotations() throws Exception {
  ...
  @Test public void views_should_be_generated_for_all_annotations_windows() throws Exception {
  ...
  @Test public void views_should_be_generated_for_all_annotations_unix() throws Exception {
  ...
  @Test public void view_generation_should_handle_interface_type() {
  ...
  @Test public void views_should_be_generated_for_persistent_type() {
  ...
  @Test public void view_should_be_generated_for_fields_with_no_orderBy_specified() {
  ...
  @Test public void views_should_not_be_generated_if_view_is_specified() {
  ...
  @Test(expected = ViewGenerationException.class) public void viewGenerationException_should_be_thrown_when_field_is_of_unsupported_type() {
    gen.generateViewsFromPersistentType(ListRefDoc.class);
  }

  @Test public void given_a_discriminator_is_declared_then_all_view_should_be_generated() {
    CouchDbConnector db = mock(CouchDbConnector.class);
  ...
  @Test public void given_a_discriminator_is_declared_on_getter_then_all_view_should_be_generated() {
    CouchDbConnector db = mock(CouchDbConnector.class);
    GenericRepository<DiscriminatorOnMethodType> repo = new CouchDbRepositorySupport<DiscriminatorOnMethodType>(DiscriminatorOnMethodType.class, db) {
      @GenerateView @Override public List<DiscriminatorOnMethodType> getAll() {
        return super.getAll();
      }
    };
    Map<String, DesignDocument.View> result = gen.generateViews(repo);
  ...
  @Test public void given_a_discriminator_is_declared_then_views_should_filter_for_specified_property() {
    CouchDbConnector db = mock(CouchDbConnector.class);
    DiscriminatingRepo repo = new DiscriminatingRepo(db);
    Map<String, DesignDocument.View> result = gen.generateViews(repo);
  ...
  @Test public void given_a_discriminator_is_declared_on_iterable_field_then_views_should_filter_for_specified_property() {
    CouchDbConnector db = mock(CouchDbConnector.class);
    DiscriminatingRepo repo = new DiscriminatingRepo(db);
    Map<String, DesignDocument.View> result = gen.generateViews(repo);
  ...
  @Test public void given_a_custom_discriminator_is_declared_then_it_should_be_used() {
    CouchDbConnector db = mock(CouchDbConnector.class);
  ...
  @Test public void given_a_discriminator_is_declared_on_child_type_then_docrefs_view_should_use_it() {
    CouchDbConnector db = mock(CouchDbConnector.class);
    DiscriminatingRepo repo = new DiscriminatingRepo(db);
    Map<String, DesignDocument.View> result = gen.generateViews(repo);
  ...
  @Views(value = { @View(name = "view_1", map = "function(doc) { ... }"), @View(name = "view_2", map = "function(doc) { ... }"), @View(name = "view_3", map = "function(doc) { ... }") }) public static class TestRepo {
    @View(name = "all", map = ALL_VIEW_FUNCTION) public List<TestDoc> findAll() {
      return null;
    }

    @GenerateView public List<TestDoc> findByName() {
      return null;
    }

    @GenerateView public List<TestDoc> findByLastName() {
      return null;
    }

    @GenerateView public TestDoc findByDomainName(String name) {
      return null;
    }

    @GenerateView(field = "accountId") public TestDoc findByAccount(String name) {
      return null;
    }

    @View(name = "by_special", map = "function(doc) { ... }") public List<String> findBySpecialView() {
      return null;
    }

    @View(name = "by_complicated", file = "complicated_view.json") public String findByComplicatedView(String input) {
      return "";
    }

    @View(name = "by_special2", map = "classpath:map.js", reduce = "classpath:reduce.js") public List<String> findBySpecialView2() {
      return null;
    }

    @View(name = "by_special3", map = "classpath:map.js") public List<String> findBySpecialView3() {
      return null;
    }
  ...
  @Views(value = { @View(name = "view_1", map = "function(doc) { ... }"), @View(name = "view_2", map = "function(doc) { ... }"), @View(name = "view_3", map = "function(doc) { ... }") }) public static class TestRepoWindows {
    @View(name = "all", map = ALL_VIEW_FUNCTION) public List<TestDoc> findAll() {
      return null;
    }
...
<<<<<<< /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/left.java
    "complicated_view.json"
=======
    "complicated_view_windows.json"
>>>>>>> /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/right.java
    ...
    @View(name = "by_special2", map = 
<<<<<<< /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/left.java
    "function(doc) {\r\n" + "  if(doc.tags.length > 0) {\r\n" + "    for(var idx in doc.tags) {\r\n" + "      emit(doc.tags[idx], null);\r\n" + "    }\r\n" + "  }\r\n" + "}"
=======
    "classpath:map_windows.js"
>>>>>>> /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/right.java
    , reduce = 
<<<<<<< /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/left.java
    "function(keys, values) {\r\n" + "  var sum = 0;\r\n" + "  for(var idx in values) {\r\n" + "    sum = sum + values[idx];\r\n" + "  }\r\n" + "  return sum;\r\n" + "}"
=======
    "classpath:reduce_windows.js"
>>>>>>> /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/right.java
    ) public List<String> findBySpecialView2() {
      return null;
    }

    @View(name = "by_special3", map = 
<<<<<<< /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/left.java
    "function(doc) {\r\n" + "  if(doc.tags.length > 0) {\r\n" + "    for(var idx in doc.tags) {\r\n" + "      emit(doc.tags[idx], null);\r\n" + "    }\r\n" + "  }\r\n" + "}"
=======
    "classpath:map_windows.js"
>>>>>>> /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/right.java
  ...
  @Views(value = { @View(name = "view_1", map = "function(doc) { ... }"), @View(name = "view_2", map = "function(doc) { ... }"), @View(name = "view_3", map = "function(doc) { ... }") }) public static class TestRepoUnix {
    @View(name = "all", map = ALL_VIEW_FUNCTION) public List<TestDoc> findAll() {
      return null;
    }
...
<<<<<<< /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/left.java
    "function(doc) {\n" + "  if(doc.tags.length > 0) {\n" + "    for(var idx in doc.tags) {\n" + "      emit(doc.tags[idx], null);\n" + "    }\n" + "  }\n" + "}"
=======
    "classpath:map_unix.js"
>>>>>>> /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/right.java
    , reduce = 
<<<<<<< /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/left.java
    "function(keys, values) {\n" + "  var sum = 0;\n" + "  for(var idx in values) {\n" + "    sum = sum + values[idx];\n" + "  }\n" + "  return sum;\n" + "}"
=======
    "classpath:reduce_unix.js"
>>>>>>> /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/right.java
    ) public List<String> findBySpecialView2() {
      return null;
    }
...
>>>>>>> /usr/src/app/output/helun/ektorp/12ee55cf7e9fb36f7a4c78d71271d0ed6030337c/org.ektorp/src/test/java/org/ektorp/support/SimpleViewGeneratorTest.java/right.java
  ...
  public static class TestRepo2<T extends TestInterface> extends CouchDbRepositorySupport<T> {
    ...
    @GenerateView public List<T> findByTags(String tag) {
  ...
  public static class DiscriminatingRepo extends CouchDbRepositorySupport<DocWithDiscriminator> {
    ...
    @GenerateView @Override public List<DocWithDiscriminator> getAll() {
      return super.getAll();
    }

    @GenerateView public List<DocWithDiscriminator> findByName(String name) {
      return queryView("by_name", name);
    }

    @GenerateView public List<DocWithDiscriminator> findByDomainName(String name) {
  ...
  public static class CustomDiscriminatingRepo extends CouchDbRepositorySupport<DocWithCustomDiscriminator> {
    ...
    @GenerateView @Override public List<DocWithCustomDiscriminator> getAll() {
      return super.getAll();
    }
  }
  ...
  @SuppressWarnings(value = { "serial" }) public static class TestDoc extends CouchDbDocument {
    ...
    @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "UWF_UNWRITTEN_FIELD") private String name;

    @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "UWF_UNWRITTEN_FIELD") private String lastName;

    @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "UWF_UNWRITTEN_FIELD") private String accountId;
  ...
  @SuppressWarnings(value = { "serial" }) public static class SetRefDoc extends CouchDbDocument {
    @DocumentReferences(backReference = "parentId", orderBy = "lastName") private Set<TestDoc> children;
  ...
  @SuppressWarnings(value = { "serial" }) public static class SetRefDocWNoOrderBy extends CouchDbDocument {
    @DocumentReferences(backReference = "parentId") private Set<TestDoc> children;
  ...
  @SuppressWarnings(value = { "serial" }) public static class ListRefDoc extends CouchDbDocument {
    @DocumentReferences(backReference = "parentId") private List<TestDoc> children;
  ...
  @SuppressWarnings(value = { "serial" }) public static class RefDocWithViewSpecified extends CouchDbDocument {
    @DocumentReferences(view = "my_view") public Set<TestDoc> children;
  }

  @SuppressWarnings(value = { "serial" }) public static class DocWithDiscriminator extends CouchDbDocument {
    @TypeDiscriminator private String mySpecialField;

    private String name;

    private Set<String> domainNames;

    @DocumentReferences(backReference = "parentId") private Set<DiscriminatingChild> children;
  ...
  public static class DiscriminatingChild implements Serializable {
    @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "UWF_UNWRITTEN_FIELD") private String parentId;

    @TypeDiscriminator private String otherField;
  ...
  public static class DiscriminatorOnMethodType {
    ...
    @TypeDiscriminator public String getMySpecialField() {
      return mySpecialField;
    }
  }

  @TypeDiscriminator(value = "doc.excoticField || doc.otherExcoticField") @SuppressWarnings(value = { "serial" }) public static class DocWithCustomDiscriminator extends CouchDbDocument {
  }
