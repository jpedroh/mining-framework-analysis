...
public class StdCouchDbConnectorTest {
  ...
  @Test public void docId_should_be_escaped_when_id_contains_slash() throws UnsupportedEncodingException {
  ...
  @Test public void testCreateFromJsonNode() throws Exception {
    doReturn(HttpResponseStub.valueOf(201, OK_RESPONSE_WITH_ID_AND_REV)).when(httpClient).put(anyString(), anyString());
  ...
  @Test public void save_document_with_utf8_charset() {
    td.setId("some_id");
    td.name = "\u00d6rjan \u00c5\u00e4\u00f6";
    setupNegativeContains(td.getId());
    doReturn(HttpResponseStub.valueOf(201, OK_RESPONSE_WITH_ID_AND_REV)).when(httpClient).put(anyString(), anyString());
  ...
  @Test public void create_should_post_if_id_is_missing() {
  ...
  @Test public void testDeleteCouchDbDocument() {
    td.setId("some_id");
  ...
  @SuppressWarnings(value = { "deprecation" }) @Test public void testGetWithConflicts() {
    setupGetDocResponse();
  ...
  private void setupGetDocResponse() {
    doReturn(HttpResponseStub.valueOf(200, "{\"name\":\"nisse\",\"age\":12,\"_id\":\"some_id\",\"_rev\":\"123D123\"}")).when(httpClient).get(anyString());
  }

  private void setupGetDocResponse(String... ids) {
    for (String id : ids) {
      doReturn(HttpResponseStub.valueOf(200, "{\"name\":\"nisse\",\"age\":12,\"_id\":\" " + id + "\",\"_rev\":\"123D123\"}")).when(httpClient).get(TEST_DB_PATH + id);
    }
  }

  @Test(expected = DocumentNotFoundException.class) public void throw_exception_when_doc_is_missing() {
  ...
  @Test(expected = UpdateConflictException.class) public void throw_exception_when_in_conflict() {
    td.setId("some_id");
    td.setRevision("123D123");
  ...
  @Test(expected = UpdateConflictException.class) public void throw_exception_when_create_attachment_in_conflict() {
    td.setId("some_id");
    td.setRevision("123D123");
  ...
  @Test public void should_create_db_if_missing() {
  ...
  @Test public void should_not_create_db_if_already_exists() {
    doReturn(HttpResponseStub.valueOf(200, "{\"test_db\":\"global\",\"doc_count\":1,\"doc_del_count\":0,\"update_seq\":3,\"purge_seq\":0,\"compact_running\":false,\"disk_size\":100,\"instance_start_time\":\"130\",\"disk_format_version\":5,\"committed_update_seq\":3}")).when(httpClient).head("/test_db/");
    dbCon.createDatabaseIfNotExists();
    verify(httpClient, VerificationModeFactory.times(0)).put(anyString());
  }

  @Test public void return_all_docIds_in_db() {
    doReturn(HttpResponseStub.valueOf(200, "{\"total_rows\": 3, \"offset\": 0, \"rows\": [" + "{\"id\": \"doc1\", \"key\": \"doc1\", \"value\": {\"rev\": \"4324BB\"}}," + "{\"id\": \"doc2\", \"key\": \"doc2\", \"value\": {\"rev\":\"2441HF\"}}," + "{\"id\": \"doc3\", \"key\": \"doc3\", \"value\": {\"rev\":\"74EC24\"}}]}")).when(httpClient).get("/test_db/_all_docs");
    List<String> all = dbCon.getAllDocIds();
    assertEquals(3, all.size());
    assertEquals("doc1", all.get(0));
    assertEquals("doc2", all.get(1));
    assertEquals("doc3", all.get(2));
    doReturn(HttpResponseStub.valueOf(200, "{\"offset\":0,\"total_rows\":2, \"rows\":[" + "{\"id\":\"07b5e058-1125-4cc9-b908-04af5e0f0a45\",\"value\":{\"_conflicts\":[],\"rev\":\"1-e18520bb-c91e-46f6-bbf8-ed13ab907b9e\"},\"key\":\"07b5e058-1125-4cc9-b908-04af5e0f0a45\"}," + "{\"id\":\"52977cfe-c809-4276-b1a4-bc1f3f6303e4\",\"value\":{\"_conflicts\":[],\"rev\":\"1-6af4da06-2554-4a74-8677-05d8b308d922\"},\"key\":\"52977cfe-c809-4276-b1a4-bc1f3f6303e4\"}]}")).when(httpClient).get("/test_db/_all_docs");
  ...
  @Test public void return_all_revisions() {
  ...
  @Test public void return_current_revision() {
    final String revision = UUID.randomUUID().toString();
    doReturn(new HttpResponseStub(200, "") {
  ...
  @Test public void return_null_revisions_when_doc_is_missing() {
  ...
  @Test public void return_attachment_with_open_data_stream() throws Exception {
  ...
  @Test public void read_document_as_stream() throws Exception {
  ...
  @Test public void should_stream_attachmed_content() {
  ...
  @Test public void load_query_result() {
    setupGetDocResponse("doc_id1", "doc_id2");
    ViewQuery query = new ViewQuery().dbPath(TEST_DB_PATH).designDocId("_design/testdoc").viewName("test_view").key("key_value");
  ...
  @Test public void queries_with_include_doc_should_read_docs_directly() {
    ViewQuery query = new ViewQuery().dbPath(TEST_DB_PATH).designDocId("_design/testdoc").viewName("test_view").includeDocs(true).key("key_value").cacheOk(true);
  ...
  @Test public void queries_with_ignore_not_found() {
    ViewQuery query = new ViewQuery().dbPath(TEST_DB_PATH).designDocId("_design/testdoc").viewName("test_view").includeDocs(true).keys(Arrays.asList("doc_id0", "doc_id1", "doc_id2", "doc_id3", "doc_id4", "doc_id5", "doc_id6"));
  ...
  @Test public void multiple_query_keys_should_be_posted() {
    List<Object> keys = new ArrayList<Object>();
    keys.add("key1");
    keys.add("key2");
    keys.add("key3");
    ViewQuery query = new ViewQuery().dbPath(TEST_DB_PATH).designDocId("_design/testdoc").viewName("test_view").keys(keys);
  ...
  @Test public void multiple_query_keys_should_be_posted_2() {
    List<Object> keys = new ArrayList<Object>();
    keys.add("key1");
    keys.add("key2");
    keys.add("key3");
  ...
  @Test public void multiple_query_keys_should_be_posted_3() throws IOException {
    List<Object> keys = new ArrayList<Object>();
    keys.add("key1");
    keys.add("key2");
    keys.add("key3");
  ...
  @Test public void given_that_doc_exists_then_contains_should_return_true() {
  ...
  @Test public void given_that_doc_does_not_exists_then_contains_should_return_false() {
    setupNegativeContains("some_id");
    assertFalse(dbCon.contains("some_id"));
  }

  @Test public void testGetDbInfo() {
  ...
  @Test public void test_replicateTo() {
  ...
  @Test public void test_replicateFrom() {
  ...
  @Test public void testGetRevsLimit() {
  ...
  @Test public void testSetRevsLimit() {
  ...
  @Test public void test_that_compact_relases_connection() {
  ...
  @Test public void test_that_compactView_relases_connection() {
    HttpResponse rsp = setupResponseOnPost();
  ...
  @Test public void test_that_cleanupViews_relases_connection() {
    HttpResponse rsp = setupResponseOnPost();
    dbCon.cleanupViews();
  ...
  @Test public void testGetDesignDocInfo() {
  ...
  @Test public void testCallUpdateHandler() {
  ...
  @Test public void testCallUpdateHanderWithObject() {
    doReturn(HttpResponseStub.valueOf(201, "{\"name\":\"nisse\",\"age\":12,\"_id\":\"some_id\",\"_rev\":\"123D123\"}")).when(httpClient).put("/test_db/_design/designDocID/_update/functionName/docID", "{\"value\":\"value\",\"param\":\"param\"}");
    UpdateHandlerRequest req = new UpdateHandlerRequest();
    req.designDocId("_design/designDocID").functionName("functionName").docId("docID").body(new TestRequest("param", "value"));
  ...
  @Test public void testEnsureFullCommit() {
  ...
  @Test public void updateMultipart_should_perform_put_operation_with_path_set_to_db_followed_by_id() {
  ...
  @Test public void updateMultipart_should_perform_put_operation_with_path_using_any_given_options() {
    String id = UUID.randomUUID().toString();
  ...
  @Test public void updateMultipart_should_perform_put_operation_with_the_given_InputStream() {
  ...
  @Test public void updateMultipart_should_perform_put_operation_with_content_type_set_to_multipart_related_with_boundary() {
  ...
  @Test(expected = IllegalArgumentException.class) public void updateMultipart_should_throw_if_boundary_is_null() {
    dbCon.updateMultipart("a", null, null, 0, null);
  }

  @Test public void updateMultipart_should_perform_put_operation_with_content_type_set_to_length() {
    long length = 1000l;
  ...
  @Test public void update_with_stream_should_perform_put_operation_with_content_type_set_to_application_json() {
  ...
  @SuppressWarnings(value = { "serial" }) static class DateDoc extends CouchDbDocument {
    private Date date;
  ...
  @SuppressWarnings(value = { "serial" }) public static class TestDoc extends CouchDbDocument {
    private String name;
  ...
  @JsonPropertyOrder(value = { "value", "param" }) static class TestRequest {
