    ...
    while ((line = reader.readLine()) != null) {
      try {
        ...
        if (opType.equals("add")) {
          ...
          if (opType.equals(ARG_UPDATE) || opType.equals("change") || opType.equals("modify")) {
...
>>>>>>> /usr/src/app/output/onebusaway/onebusaway-gtfs-modules/0dfc36d5c8bb5baea8656f9c4ea68983a8e0070d/onebusaway-gtfs-transformer/src/main/java/org/onebusaway/gtfs_transformer/factory/TransformFactory.java/right.java
                                                                                          ...
                                                                                          if (opType.equals(
<<<<<<< /usr/src/app/output/onebusaway/onebusaway-gtfs-modules/0dfc36d5c8bb5baea8656f9c4ea68983a8e0070d/onebusaway-gtfs-transformer/src/main/java/org/onebusaway/gtfs_transformer/factory/TransformFactory.java/left.java
                                                                                          "update_trips_for_sdon"
=======
                                                                                          "remove_old_calendar_statements"
>>>>>>> /usr/src/app/output/onebusaway/onebusaway-gtfs-modules/0dfc36d5c8bb5baea8656f9c4ea68983a8e0070d/onebusaway-gtfs-transformer/src/main/java/org/onebusaway/gtfs_transformer/factory/TransformFactory.java/right.java
                                                                                          )) {
                                                                                            handleTransformOperation(line, json, new 
<<<<<<< /usr/src/app/output/onebusaway/onebusaway-gtfs-modules/0dfc36d5c8bb5baea8656f9c4ea68983a8e0070d/onebusaway-gtfs-transformer/src/main/java/org/onebusaway/gtfs_transformer/factory/TransformFactory.java/left.java
...
>>>>>>> /usr/src/app/output/onebusaway/onebusaway-gtfs-modules/0dfc36d5c8bb5baea8656f9c4ea68983a8e0070d/onebusaway-gtfs-transformer/src/main/java/org/onebusaway/gtfs_transformer/factory/TransformFactory.java/right.java
                                                                                            ...
                                                                                            if (opType.equals(
<<<<<<< /usr/src/app/output/onebusaway/onebusaway-gtfs-modules/0dfc36d5c8bb5baea8656f9c4ea68983a8e0070d/onebusaway-gtfs-transformer/src/main/java/org/onebusaway/gtfs_transformer/factory/TransformFactory.java/left.java
                                                                                            "last_stop_to_headsign"
=======
                                                                                            "verify_future_route_service"
>>>>>>> /usr/src/app/output/onebusaway/onebusaway-gtfs-modules/0dfc36d5c8bb5baea8656f9c4ea68983a8e0070d/onebusaway-gtfs-transformer/src/main/java/org/onebusaway/gtfs_transformer/factory/TransformFactory.java/right.java
                                                                                            )) {
                                                                                              handleTransformOperation(line, json, new 
<<<<<<< /usr/src/app/output/onebusaway/onebusaway-gtfs-modules/0dfc36d5c8bb5baea8656f9c4ea68983a8e0070d/onebusaway-gtfs-transformer/src/main/java/org/onebusaway/gtfs_transformer/factory/TransformFactory.java/left.java
                                                                                              LastStopToHeadsignStrategy
=======
...
>>>>>>> /usr/src/app/output/onebusaway/onebusaway-gtfs-modules/0dfc36d5c8bb5baea8656f9c4ea68983a8e0070d/onebusaway-gtfs-transformer/src/main/java/org/onebusaway/gtfs_transformer/factory/TransformFactory.java/right.java
  ...
  private EntityTransformStrategy getUpdateEntityTransformStrategy(String line, TypedEntityMatch match, JSONObject update) throws JSONException, TransformSpecificationException {
    if (ServiceIdKey.class.isAssignableFrom(match.getType())) {
      ...
      Map<String, ValueSetter> propertyUpdates = getPropertyValueSettersFromJsonObject(match.getType(), update, emptySet);
  ...
  private void handleRetainOperation(String line, JSONObject json) throws JSONException, TransformSpecificationException {
  ...
  private void handleStopTimesOperation(String line, JSONObject json) throws JSONException, TransformSpecificationException {
  ...
  private TypedEntityMatch getCollectionMatch(String line, String collectionType, JSONObject match) throws TransformSpecificationException, JSONException {
    if (collectionType.equals(ARG_CALENDAR)) {
      ...
      return new TypedEntityMatch(ServiceIdKey.class, new ServiceIdKeyMatch(_transformer.getReader(), serviceId));
    } else {
      if (collectionType.equals(ARG_SHAPE)) {
  ...
  private Map<String, DeferredValueMatcher> getPropertyValueMatchersFromJsonObject(JSONObject obj, Set<String> propertiesToExclude) throws JSONException {
    Map<String, Object> map = getPropertyValuesFromJsonObject(obj, propertiesToExclude);
    Map<String, DeferredValueMatcher> matchers = new HashMap<String, DeferredValueMatcher>();
    for (Map.Entry<String, Object> entry : map.entrySet()) {
      matchers.put(entry.getKey(), new DeferredValueMatcher(_transformer.getReader(), _schemaCache, entry.getValue()));
    }
    return matchers;
  }

  private Map<String, Object> getPropertyValuesFromJsonObject(JSONObject obj, Set<String> propertiesToExclude) throws JSONException {
    Map<String, Object> map = new HashMap<String, Object>();
    for (@SuppressWarnings(value = { "unchecked" }) Iterator<String> it = obj.keys(); it.hasNext(); ) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private Map<String, Pair<String>> getEntityPropertiesAndStringReplacementsFromJsonObject(Class<?> entityType, JSONObject obj) throws JSONException {
  ...
  @SuppressWarnings(value = { "unchecked" }) private <T extends GtfsTransformStrategy> T getStrategy(Class<T> transformerType) {
