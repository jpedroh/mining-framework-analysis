                                                                                                            ...
                                                                                                            if (opType.equals("add_omny_lirr_data")) {
                                                                                                              ...
                                                                                                              if (opType.equals("add_omny_bus_data")) {
                                                                                                                ...
                                                                                                                if (opType.equals("verify_route_ids")) {
                                                                                                                  ...
                                                                                                                  if (opType.equals("remove_merged_trips")) {
                                                                                                                    handleTransformOperation(line, json, new RemoveMergedTripsStrategy());

<<<<<<< /usr/src/app/output/onebusaway/onebusaway-gtfs-modules/4430790e8806cf8918c79342ae82319d29ccd75b/onebusaway-gtfs-transformer/src/main/java/org/onebusaway/gtfs_transformer/factory/TransformFactory.java/left.java
