...
public class TestSpanRewriter {
  @Test public void testTermsQueryWithMultipleFields() throws RewriteException {
  ...
  @Test public void testBoostQuery() throws RewriteException {
  ...
  @Test public void testMultiTermQueryEquals() throws RewriteException {
  ...
  @Test public void testPhraseQuery() {
    ...
    assertThat(sq.getClauses()).contains(new SpanTermQuery(new Term("field1", "term1")), new SpanTermQuery(new Term("field1", "term2")));
