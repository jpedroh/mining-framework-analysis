...
<<<<<<< /usr/src/app/output/javaparser/javaparser/9fc1982987d5ab39a56e416e5c9ffe4e4291b65a/javaparser-core/src/main/javacc-support/com/github/javaparser/GeneratedJavaParserSupport.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  /** Add obj to list */
  static <T extends java.lang.Object> List<T> add(List<T> list, T obj) {
    if (list == null) {
      list = new LinkedList<>();
    }
    list.add(obj);
