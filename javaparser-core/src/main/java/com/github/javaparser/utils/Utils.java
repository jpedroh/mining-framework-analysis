...
public class Utils {
  ...
  /**
     ...
     */
  public static <T extends java.lang.Object> List<T> ensureNotNull(List<T> list) {
    return list == null ? new ArrayList<>() : list;
  }

  public static <E extends java.lang.Object> boolean isNullOrEmpty(Collection<E> collection) {
    return collection == null || collection.isEmpty();
  }

  public static <T extends java.lang.Object> T assertNotNull(T o) {
    if (o == null) {
  ...
  /**
     ...
     * @deprecated This is no longer in use by JavaParser, please write your own replacement.
     */
  public static <T extends java.lang.Object> List<T> arrayToList(T[] array) {
