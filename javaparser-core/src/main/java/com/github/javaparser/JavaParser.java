...
<<<<<<< /usr/src/app/output/javaparser/javaparser/4f8e32c3596a611fce001706acdac4e949403583/javaparser-core/src/main/java/com/github/javaparser/JavaParser.java/left.java
    try {
      checkSourceSet();
...
>>>>>>> /usr/src/app/output/javaparser/javaparser/4f8e32c3596a611fce001706acdac4e949403583/javaparser-core/src/main/java/com/github/javaparser/JavaParser.java/right.java
  }
  ...
  public static CompilationUnit parse(final InputStream in, final Charset encoding) throws ParseException {
  ...
  /**
     ...
     *             if the source code has parser errors
     */
  public static CompilationUnit parse(final InputStream in, Charset encoding, boolean considerComments) throws ParseException {
    try {
  ...
  public static CompilationUnit parse(final File file, final Charset encoding) throws ParseException, IOException {
  ...
  /**
     ...
     *             if the source code has parser errors
     */
  public static CompilationUnit parse(final File file, final Charset encoding, boolean considerComments) throws ParseException {
    try {
  ...
  public static CompilationUnit parse(final Reader reader) throws ParseException {
    return parse(reader, true);
  }

  public static CompilationUnit parse(final Reader reader, boolean considerComments) throws ParseException {
    try {
