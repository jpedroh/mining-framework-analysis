...
public class CompilationUnit extends Node {
  ...
  @OptionalProperty private PackageDeclaration packageDeclaration;

  private NodeList<ImportDeclaration> imports;

  private NodeList<TypeDeclaration<?>> types;

  @OptionalProperty private ModuleDeclaration module;
  ...
  @Override protected Printer getPrinter() {
  ...
  @Override protected Printer getPrinter(PrinterConfiguration config) {
