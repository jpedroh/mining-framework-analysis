...
public class Name extends Node implements NodeWithIdentifier<Name>, NodeWithAnnotations<Name> {
  ...
  @AllFieldsConstructor public Name(Name qualifier, final String identifier, NodeList<AnnotationExpr> annotations) {
    this(null, qualifier, identifier, annotations);
  }

  @Generated(value = { "com.github.javaparser.generator.core.node.MainConstructorGenerator" }) public Name(Range range, Name qualifier, String identifier, NodeList<AnnotationExpr> annotations) {
    super(range);
  ...
  @Generated(value = { "com.github.javaparser.generator.core.node.PropertyGenerator" }) public Name setIdentifier(final String identifier) {
  ...
  @Generated(value = { "com.github.javaparser.generator.core.node.PropertyGenerator" }) public Optional<Name> getQualifier() {
    return Optional.ofNullable(qualifier);
  }

  @Generated(value = { "com.github.javaparser.generator.core.node.PropertyGenerator" }) public Name setQualifier(final Name qualifier) {
  ...
  @Generated(value = { "com.github.javaparser.generator.core.node.RemoveMethodGenerator" }) public Name removeQualifier() {
  ...
  @Generated(value = { "com.github.javaparser.generator.core.node.PropertyGenerator" }) public Name setAnnotations(final NodeList<AnnotationExpr> annotations) {
  ...
  @Override @Generated(value = { "com.github.javaparser.generator.core.node.CloneGenerator" }) public Name clone() {
    return (Name) accept(new CloneVisitor(), null);
  }

  @Override @Generated(value = { "com.github.javaparser.generator.core.node.GetMetaModelGenerator" }) public NameMetaModel getMetaModel() {
