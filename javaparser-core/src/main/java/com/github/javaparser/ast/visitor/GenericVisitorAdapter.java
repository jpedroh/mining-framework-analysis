...
public abstract class GenericVisitorAdapter<R extends java.lang.Object, A extends java.lang.Object> implements GenericVisitor<R, A> {
  ...
  @Override public R visit(SimpleName n, A arg) {
    visitComment(n, arg);
    return null;
  }

  @Override public R visit(ArrayType n, A arg) {
    visitComment(n, arg);
    for (final AnnotationExpr a : n.getAnnotations()) {
      R result = a.accept(this, arg);
      if (result != null) {
  ...
  @Override public R visit(ArrayCreationLevel n, A arg) {
    visitComment(n, arg);
    for (final AnnotationExpr a : n.getAnnotations()) {
      R result = a.accept(this, arg);
      if (result != null) {
  ...
  @Override public R visit(LambdaExpr n, A arg) {
    visitComment(n, arg);
    if (n.getParameters() != null) {
  ...
  @Override public R visit(MethodReferenceExpr n, A arg) {
    visitComment(n, arg);
    {
      if (n.getTypeArguments().isPresent()) {
        for (Type type : n.getTypeArguments().get()) {
  ...
  @Override public R visit(TypeExpr n, A arg) {
    visitComment(n, arg);
    if (n.getType() != null) {
      R result = n.getType().accept(this, arg);
      if (result != null) {
  ...
  @Override public R visit(BadImportDeclaration n, A arg) {
    visitComment(n, arg);
    return null;
  }

  @Override public R visit(SingleStaticImportDeclaration n, A arg) {
    visitComment(n, arg);
    {
      R result = n.getType().accept(this, arg);
      if (result != null) {
  ...
  @Override public R visit(SingleTypeImportDeclaration n, A arg) {
    visitComment(n, arg);
    {
      R result = n.getType().accept(this, arg);
      if (result != null) {
  ...
  @Override public R visit(StaticImportOnDemandDeclaration n, A arg) {
    visitComment(n, arg);
    {
      R result = n.getType().accept(this, arg);
      if (result != null) {
  ...
  @Override public R visit(TypeImportOnDemandDeclaration n, A arg) {
    visitComment(n, arg);
    {
      R result = n.getName().accept(this, arg);
      if (result != null) {
