...
public abstract class VoidVisitorAdapter<A extends java.lang.Object> implements VoidVisitor<A> {
  ...
  @Override public void visit(SimpleName n, A arg) {
    visitComment(n.getComment(), arg);
  }

  @Override public void visit(ArrayType n, A arg) {
    visitComment(n.getComment(), arg);
    visitAnnotations(n, arg);
    n.getComponentType().accept(this, arg);
  }

  @Override public void visit(ArrayCreationLevel n, A arg) {
    visitComment(n.getComment(), arg);
    visitAnnotations(n, arg);
  ...
  @Override public void visit(LambdaExpr n, final A arg) {
    visitComment(n.getComment(), arg);
    if (n.getParameters() != null) {
  ...
  @Override public void visit(MethodReferenceExpr n, final A arg) {
    visitComment(n.getComment(), arg);
    if (n.getTypeArguments().isPresent()) {
      for (final Type t : n.getTypeArguments().get()) {
        t.accept(this, arg);
  ...
  @Override public void visit(TypeExpr n, final A arg) {
    visitComment(n.getComment(), arg);
    if (n.getType() != null) {
      n.getType().accept(this, arg);
    }
  ...
  @Override public void visit(BadImportDeclaration n, A arg) {
    visitComment(n.getComment(), arg);
  }

  @Override public void visit(SingleStaticImportDeclaration n, A arg) {
    visitComment(n.getComment(), arg);
    n.getType().accept(this, arg);
  }

  @Override public void visit(SingleTypeImportDeclaration n, A arg) {
    visitComment(n.getComment(), arg);
    n.getType().accept(this, arg);
  }

  @Override public void visit(StaticImportOnDemandDeclaration n, A arg) {
    visitComment(n.getComment(), arg);
    n.getType().accept(this, arg);
  }

  @Override public void visit(TypeImportOnDemandDeclaration n, A arg) {
    visitComment(n.getComment(), arg);
    n.getName().accept(this, arg);
  }
