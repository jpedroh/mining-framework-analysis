...
public class DumpVisitor implements VoidVisitor<Object> {
  ...
  @Override public void visit(final ArrayCreationLevel n, final Object arg) {
    printAnnotations(n.getAnnotations(), true, arg);
    printer.print("[");
  ...
  @Override public void visit(LambdaExpr n, Object arg) {
    printJavaComment(n.getComment(), arg);
  ...
  @Override public void visit(MethodReferenceExpr n, Object arg) {
    printJavaComment(n.getComment(), arg);
  ...
  @Override public void visit(TypeExpr n, Object arg) {
    printJavaComment(n.getComment(), arg);
    if (n.getType() != null) {
      n.getType().accept(this, arg);
    }
  ...
  @Override public void visit(ArrayBracketPair arrayBracketPair, Object arg) {
    printAnnotations(arrayBracketPair.getAnnotations(), true, arg);
    printer.print("[]");
  }

  @Override public void visit(NodeList n, Object arg) {
    for (Object node : n) {
      ((Node) node).accept(this, arg);
    }
  }

  @Override public void visit(EmptyImportDeclaration n, Object arg) {
    printer.printLn(";");
  }

  @Override public void visit(SingleStaticImportDeclaration n, Object arg) {
    printJavaComment(n.getComment(), arg);
  ...
  @Override public void visit(SingleTypeImportDeclaration n, Object arg) {
    printJavaComment(n.getComment(), arg);
  ...
  @Override public void visit(StaticImportOnDemandDeclaration n, Object arg) {
    printJavaComment(n.getComment(), arg);
    printer.print("import static ");
    n.getType().accept(this, arg);
    printer.printLn(".*;");
  ...
  @Override public void visit(TypeImportOnDemandDeclaration n, Object arg) {
    printJavaComment(n.getComment(), arg);
    printer.print("import ");
    n.getName().accept(this, arg);
    printer.printLn(".*;");
