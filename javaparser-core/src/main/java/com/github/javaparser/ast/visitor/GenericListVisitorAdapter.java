 ...
 * @author Enno Boland
 */
public abstract class GenericListVisitorAdapter<R extends java.lang.Object, A extends java.lang.Object> implements GenericVisitor<List<R>, A> {
  ...
  @Override public List<R> visit(NodeList n, A arg) {
  ...
  @Override public List<R> visit(final ModuleDeclaration n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getAnnotations().accept(this, arg);
  ...
  @Override public List<R> visit(final ModuleExportsDirective n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
  ...
  @Override public List<R> visit(final ModuleOpensDirective n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getModuleNames().accept(this, arg);
  ...
  @Override public List<R> visit(final ModuleProvidesDirective n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getName().accept(this, arg);
  ...
  @Override public List<R> visit(final ModuleRequiresDirective n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getModifiers().accept(this, arg);
  ...
  @Override public List<R> visit(final ModuleUsesDirective n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getName().accept(this, arg);
  ...
  @Override public List<R> visit(final UnparsableStmt n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    if (n.getComment().isPresent()) {
      tmp = n.getComment().get().accept(this, arg);
  ...
  @Override public List<R> visit(final ReceiverParameter n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getAnnotations().accept(this, arg);
  ...
  @Override public List<R> visit(final VarType n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getAnnotations().accept(this, arg);
  ...
  @Override public List<R> visit(final Modifier n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    if (n.getComment().isPresent()) {
      tmp = n.getComment().get().accept(this, arg);
  ...
  @Override public List<R> visit(final SwitchExpr n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getEntries().accept(this, arg);
  ...
  @Override public List<R> visit(final YieldStmt n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getExpression().accept(this, arg);
  ...
  @Override public List<R> visit(final TextBlockLiteralExpr n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    if (n.getComment().isPresent()) {
      tmp = n.getComment().get().accept(this, arg);
  ...
  @Override public List<R> visit(final PatternExpr n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getName().accept(this, arg);
  ...
  @Override public List<R> visit(final RecordDeclaration n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getImplementedTypes().accept(this, arg);
  ...
  public List<R> visit(final RecordDeclarationConstructor n, final A arg) {
    List<R> result = new ArrayList<>();
    List<R> tmp;
    {
      tmp = n.getBody().accept(this, arg);
