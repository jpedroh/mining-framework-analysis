...
public abstract class Node implements Cloneable, HasParentNode<Node>, Visitable, NodeWithRange<Node>, NodeWithTokenRange<Node> {
  ...
  @InternalProperty private ArrayList<Node> childNodes = new ArrayList<>(0);

  @InternalProperty private ArrayList<Comment> orphanComments = new ArrayList<>(0);

  @InternalProperty private IdentityHashMap<DataKey<?>, Object> data = null;

  @OptionalProperty private Comment comment;

  @InternalProperty private ArrayList<AstObserver> observers = new ArrayList<>(0);
  ...
  /**
     ...
     */
  @Deprecated public static final int ABSOLUTE_BEGIN_LINE = Position.ABSOLUTE_BEGIN_LINE;

  /**
     * @deprecated Use {@link Position#ABSOLUTE_END_LINE}
     */
  @Deprecated public static final int ABSOLUTE_END_LINE = Position.ABSOLUTE_END_LINE;
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> Optional<T> findFirst(TreeTraversal traversal, Function<Node, Optional<T>> consumer) {
    for (Node node : treeIterable(traversal)) {
