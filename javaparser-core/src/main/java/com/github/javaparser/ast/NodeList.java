...
public class NodeList<N extends Node> implements List<N>, Iterable<N>, HasParentNode<NodeList<N>>, Visitable, Observable {
  @InternalProperty private List<N> innerList = new ArrayList<>(0);
  ...
  @Override public boolean add(N node) {
  ...
  @Override public void sort(Comparator<? super N> comparator) {
  ...
  @Override public void add(int index, N node) {
  ...
  /**
     ...
     */
  @Override public NodeList<N> setParentNode(Node parentNode) {
  ...
  /**
     ...
     */
  @Override public void forEach(Consumer<? super N> action) {
  ...
  /**
     ...
     */
  @Override public boolean addAll(Collection<? extends N> c) {
    c.forEach(this::add);
    return !c.isEmpty();
  }
  ...
  /**
     ...
     */
  @Override public boolean addAll(int index, Collection<? extends N> c) {
    for (N e : c) {
      add(index++, e);
    }
    return !c.isEmpty();
  ...
  /**
     ...
     */
  @Override public void replaceAll(UnaryOperator<N> operator) {
  ...
  /**
     ...
     */
  @Override public boolean removeIf(Predicate<? super N> filter) {
    boolean changed = false;
  ...
  /**
     ...
     */
  @Override public ListIterator<N> listIterator() {
  ...
  /**
     ...
     */
  @Override public ListIterator<N> listIterator(int index) {
  ...
  /**
     ...
     */
  @Override public Stream<N> parallelStream() {
  ...
  /**
     ...
     */
  @Override public List<N> subList(int fromIndex, int toIndex) {
