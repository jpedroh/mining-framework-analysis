...
public final class FieldDeclaration extends BodyDeclaration<FieldDeclaration> implements NodeWithJavaDoc<FieldDeclaration>, NodeWithType<FieldDeclaration>, NodeWithModifiers<FieldDeclaration> {
  ...
  /**
     ...
     * @return modifiers
     */
  @Override public EnumSet<Modifier> getModifiers() {
    return modifiers;
  }
  ...
  @Override public FieldDeclaration setModifiers(EnumSet<Modifier> modifiers) {
    this.modifiers = modifiers;
    return this;
  }

  @Override public FieldDeclaration setType(Type type) {
    this.type = type;
  ...
  public MethodDeclaration createSetter() {
    ...
    ASTHelper.addStmt(blockStmt2, new AssignExpr(new NameExpr("this." + fieldName), new NameExpr(fieldName), Operator.assign));
    return setter;
  }
}