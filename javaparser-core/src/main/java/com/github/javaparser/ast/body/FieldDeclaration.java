...
public final class FieldDeclaration extends BodyDeclaration<FieldDeclaration> implements NodeWithJavadoc<FieldDeclaration>, NodeWithVariables<FieldDeclaration>, NodeWithAccessModifiers<FieldDeclaration>, NodeWithStaticModifier<FieldDeclaration>, NodeWithFinalModifier<FieldDeclaration> {
  ...
  @AllFieldsConstructor public FieldDeclaration(EnumSet<Modifier> modifiers, NodeList<AnnotationExpr> annotations, NodeList<VariableDeclarator> variables) {
    this(null, modifiers, annotations, variables);
  }

  @Generated(value = { "com.github.javaparser.generator.core.node.MainConstructorGenerator" }) public FieldDeclaration(Range range, EnumSet<Modifier> modifiers, NodeList<AnnotationExpr> annotations, NodeList<VariableDeclarator> variables) {
  ...
  @Generated(value = { "com.github.javaparser.generator.core.node.PropertyGenerator" }) public FieldDeclaration setModifiers(final EnumSet<Modifier> modifiers) {
