 ...
 */
public class ModifierVisitorAdapter<A extends java.lang.Object> implements GenericVisitor<Node, A> {
  ...
  @Override public Node visit(ArrayType n, A arg) {
    visitComment(n, arg);
    visitAnnotations(n, arg);
    n.setType((Type) n.getType().accept(this, arg));
    return n;
  ...
  @Override public Node visit(ArrayCreationLevel n, A arg) {
    visitComment(n, arg);
    visitAnnotations(n, arg);
  ...
  @Override public Node visit(final IntersectionType n, final A arg) {
    visitComment(n, arg);
    visitAnnotations(n, arg);
  ...
  @Override public Node visit(final UnionType n, final A arg) {
    visitComment(n, arg);
    visitAnnotations(n, arg);
    final List<ReferenceType> elements = n.getElements();
    if (elements != null) {
