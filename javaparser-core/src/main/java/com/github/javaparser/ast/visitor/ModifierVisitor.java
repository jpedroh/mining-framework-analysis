 ...
 */
public class ModifierVisitor<A extends java.lang.Object> implements GenericVisitor<Visitable, A> {
  ...
  @Override public Visitable visit(final RecordDeclaration n, final A arg) {
    NodeList<AnnotationExpr> annotations = modifyList(n.getAnnotations(), arg);
    NodeList<Modifier> modifiers = modifyList(n.getModifiers(), arg);
  ...
  @Override public Visitable visit(final RecordDeclarationConstructor n, final A arg) {
    NodeList<AnnotationExpr> annotations = modifyList(n.getAnnotations(), arg);
    NodeList<Modifier> modifiers = modifyList(n.getModifiers(), arg);
    BlockStmt body = (BlockStmt) n.getBody().accept(this, arg);
    SimpleName name = (SimpleName) n.getName().accept(this, arg);
  ...
  @Override public Visitable visit(final SimpleName n, final A arg) {
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    n.setComment(comment);
    return n;
  }

  @Override public Visitable visit(final ArrayType n, final A arg) {
    NodeList<AnnotationExpr> annotations = modifyList(n.getAnnotations(), arg);
  ...
  @Override public Visitable visit(final ArrayCreationLevel n, final A arg) {
    NodeList<AnnotationExpr> annotations = modifyList(n.getAnnotations(), arg);
  ...
  @Override public Visitable visit(final IntersectionType n, final A arg) {
    NodeList<AnnotationExpr> annotations = modifyList(n.getAnnotations(), arg);
  ...
  @Override public Visitable visit(final UnionType n, final A arg) {
    NodeList<AnnotationExpr> annotations = modifyList(n.getAnnotations(), arg);
    NodeList<ReferenceType> elements = modifyList(n.getElements(), arg);
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    if (elements.isEmpty()) {
  ...
  @Override public Visitable visit(final SwitchEntry n, final A arg) {
  ...
  @Override public Visitable visit(final LocalClassDeclarationStmt n, final A arg) {
  ...
  @Override public Visitable visit(final LambdaExpr n, final A arg) {
    Statement body = (Statement) n.getBody().accept(this, arg);
    NodeList<Parameter> parameters = modifyList(n.getParameters(), arg);
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    if (body == null) {
  ...
  @Override public Visitable visit(final MethodReferenceExpr n, final A arg) {
    Expression scope = (Expression) n.getScope().accept(this, arg);
    NodeList<Type> typeArguments = modifyList(n.getTypeArguments(), arg);
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    if (scope == null) {
  ...
  @Override public Visitable visit(final TypeExpr n, final A arg) {
    Type type = (Type) n.getType().accept(this, arg);
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    if (type == null) {
      return null;
  ...
  @Override public Visitable visit(NodeList n, A arg) {
    if (n.isEmpty()) {
      return n;
    }
  ...
  @Override public Visitable visit(final BlockComment n, final A arg) {
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    n.setComment(comment);
    return n;
  }

  @Override public Visitable visit(final LineComment n, final A arg) {
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    n.setComment(comment);
    return n;
  }
  ...
  @Override public Visitable visit(final ModuleExportsDirective n, final A arg) {
  ...
  @Override public Visitable visit(final ModuleProvidesDirective n, final A arg) {
    Name name = (Name) n.getName().accept(this, arg);
  ...
  @Override public Visitable visit(final ModuleUsesDirective n, final A arg) {
    Name name = (Name) n.getName().accept(this, arg);
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    if (name == null) {
      return null;
  ...
  @Override public Visitable visit(final ModuleOpensDirective n, final A arg) {
    NodeList<Name> moduleNames = modifyList(n.getModuleNames(), arg);
    Name name = (Name) n.getName().accept(this, arg);
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    if (name == null) {
  ...
  @Override public Visitable visit(final UnparsableStmt n, final A arg) {
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    n.setComment(comment);
    return n;
  }

  @Override public Visitable visit(final ReceiverParameter n, final A arg) {
    NodeList<AnnotationExpr> annotations = modifyList(n.getAnnotations(), arg);
    Name name = (Name) n.getName().accept(this, arg);
    Type type = (Type) n.getType().accept(this, arg);
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
  ...
  @Override public Visitable visit(final VarType n, final A arg) {
    NodeList<AnnotationExpr> annotations = modifyList(n.getAnnotations(), arg);
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    n.setAnnotations(annotations);
    n.setComment(comment);
  ...
  @Override public Visitable visit(final Modifier n, final A arg) {
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    n.setComment(comment);
    return n;
  }

  @Override public Visitable visit(final SwitchExpr n, final A arg) {
    NodeList<SwitchEntry> entries = modifyList(n.getEntries(), arg);
    Expression selector = (Expression) n.getSelector().accept(this, arg);
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    if (selector == null) {
  ...
  @Override public Visitable visit(final YieldStmt n, final A arg) {
    Expression expression = (Expression) n.getExpression().accept(this, arg);
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    if (expression == null) {
      return null;
  ...
  @Override public Visitable visit(final TextBlockLiteralExpr n, final A arg) {
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    n.setComment(comment);
    return n;
  }

  @Override public Visitable visit(final PatternExpr n, final A arg) {
    SimpleName name = (SimpleName) n.getName().accept(this, arg);
    ReferenceType type = (ReferenceType) n.getType().accept(this, arg);
    Comment comment = n.getComment().map((s) -> (Comment) s.accept(this, arg)).orElse(null);
    if (name == null || type == null) {
