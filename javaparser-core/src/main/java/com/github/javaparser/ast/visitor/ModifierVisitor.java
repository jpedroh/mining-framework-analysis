...
public class ModifierVisitor<A extends java.lang.Object> implements GenericVisitor<Visitable, A> {
  ...
  @Override public Visitable visit(SimpleName n, A arg) {
    return n;
  }

  @Override public Visitable visit(ArrayType n, A arg) {
    visitComment(n, arg);
    visitAnnotations(n, arg);
  ...
  @Override public Visitable visit(ArrayCreationLevel n, A arg) {
    visitComment(n, arg);
    visitAnnotations(n, arg);
  ...
  @Override public Visitable visit(BadImportDeclaration n, A arg) {
    visitComment(n, arg);
    return n;
  }

  @Override public Visitable visit(SingleStaticImportDeclaration n, A arg) {
    visitComment(n, arg);
    n.setType((ClassOrInterfaceType) n.getType().accept(this, arg));
    return n;
  }

  @Override public Visitable visit(SingleTypeImportDeclaration n, A arg) {
    visitComment(n, arg);
    n.setType((ClassOrInterfaceType) n.getType().accept(this, arg));
    return n;
  }

  @Override public Visitable visit(StaticImportOnDemandDeclaration n, A arg) {
    visitComment(n, arg);
    n.setType((ClassOrInterfaceType) n.getType().accept(this, arg));
    return n;
  }

  @Override public Visitable visit(TypeImportOnDemandDeclaration n, A arg) {
    visitComment(n, arg);
    n.setName((Name) n.getName().accept(this, arg));
    return n;
  }
