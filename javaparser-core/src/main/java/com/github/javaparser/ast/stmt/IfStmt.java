...
public final class IfStmt extends Statement implements NodeWithCondition<IfStmt> {
  ...
  @AllFieldsConstructor public IfStmt(final Expression condition, final Statement thenStmt, final Statement elseStmt) {
  ...
  @Generated(value = { "com.github.javaparser.generator.core.node.PropertyGenerator" }) public Optional<Statement> getElseStmt() {
  ...
  @Generated(value = { "com.github.javaparser.generator.core.node.PropertyGenerator" }) public IfStmt setCondition(final Expression condition) {
  ...
  /**
     ...
     */
  @Generated(value = { "com.github.javaparser.generator.core.node.PropertyGenerator" }) public IfStmt setElseStmt(final Statement elseStmt) {
  ...
  @Generated(value = { "com.github.javaparser.generator.core.node.PropertyGenerator" }) public IfStmt setThenStmt(final Statement thenStmt) {
  ...
  @DerivedProperty public boolean hasThenBlock() {
    return thenStmt instanceof BlockStmt;
  }

  @DerivedProperty public boolean hasElseBlock() {
    return elseStmt instanceof BlockStmt || elseStmt instanceof IfStmt;
  }

  @Override @Generated(value = { "com.github.javaparser.generator.core.node.CloneGenerator" }) public IfStmt clone() {
    return (IfStmt) accept(new CloneVisitor(), null);
  }

  @Override @Generated(value = { "com.github.javaparser.generator.core.node.GetMetaModelGenerator" }) public IfStmtMetaModel getMetaModel() {
