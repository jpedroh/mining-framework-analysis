...
public class EqualsVisitor implements GenericVisitor<Boolean, Visitable> {
  ...
  @Override public Boolean visit(ArrayType n1, Visitable arg) {
  ...
  @Override public Boolean visit(ArrayCreationLevel n1, Visitable arg) {
  ...
  @Override public Boolean visit(VoidType n1, Visitable arg) {
  ...
  @Override public Boolean visit(SimpleName n, Visitable arg) {
  ...
  @Override public Boolean visit(LambdaExpr n1, Visitable arg) {
  ...
  @Override public Boolean visit(MethodReferenceExpr n1, Visitable arg) {
  ...
  @Override public Boolean visit(TypeExpr n, Visitable arg) {
  ...
  @Override public Boolean visit(BadImportDeclaration n1, Visitable arg) {
    return true;
  }

  @Override public Boolean visit(SingleStaticImportDeclaration n1, Visitable arg) {
  ...
  @Override public Boolean visit(SingleTypeImportDeclaration n1, Visitable arg) {
  ...
  @Override public Boolean visit(StaticImportOnDemandDeclaration n1, Visitable arg) {
  ...
  @Override public Boolean visit(TypeImportOnDemandDeclaration n1, Visitable arg) {
