 ...
 * overridden.
 */
public abstract class VoidVisitorWithDefaults<A extends java.lang.Object> implements VoidVisitor<A> {
  /**
  ...
  @Override public void visit(final SimpleName n, final A arg) {
    defaultAction(n, arg);
  }
  ...
  @Override public void visit(final ArrayCreationLevel n, final A arg) {
    defaultAction(n, arg);
  }
  ...
  @Override public void visit(final SwitchEntry n, final A arg) {
    defaultAction(n, arg);
  }
  ...
  @Override public void visit(final LocalClassDeclarationStmt n, final A arg) {
    defaultAction(n, arg);
  }
  ...
  @Override public void visit(final LambdaExpr n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final MethodReferenceExpr n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final TypeExpr n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(NodeList n, A arg) {
    defaultAction(n, arg);
  }
  ...
  @Override public void visit(final ModuleExportsDirective n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final ModuleProvidesDirective n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final ModuleUsesDirective n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final ModuleOpensDirective n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final UnparsableStmt n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final ReceiverParameter n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final Modifier n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final VarType n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final SwitchExpr n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final TextBlockLiteralExpr n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final YieldStmt n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final PatternExpr n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final RecordDeclaration n, final A arg) {
    defaultAction(n, arg);
  }

  @Override public void visit(final RecordDeclarationConstructor n, final A arg) {
    defaultAction(n, arg);
  }
}