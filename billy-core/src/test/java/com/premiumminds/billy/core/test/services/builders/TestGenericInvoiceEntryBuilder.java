...
public class TestGenericInvoiceEntryBuilder extends AbstractTest {
  ...
  @Test public void doTest() {
    MockGenericInvoiceEntryEntity mock = this.createMockEntity(MockGenericInvoiceEntryEntity.class, TestGenericInvoiceEntryBuilder.GEN_INVOICE_ENTRY_YML);
    MockGenericInvoiceEntity mockInvoice = this.createMockEntity(MockGenericInvoiceEntity.class, TestGenericInvoiceEntryBuilder.GEN_INVOICE_YML);
    ...
    Mockito.when(this.getInstance(DAOProduct.class).get(Matchers.any(UID.class))).thenReturn((ProductEntity) mock.getProduct());
