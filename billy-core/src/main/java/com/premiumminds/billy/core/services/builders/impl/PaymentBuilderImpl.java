...
public class PaymentBuilderImpl<TBuilder extends PaymentBuilderImpl<TBuilder, TPayment>, TPayment extends Payment> extends AbstractBuilder<TBuilder, TPayment> implements PaymentBuilder<TBuilder, TPayment> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/portugal/i18n/FieldNames");

  @Inject public PaymentBuilderImpl(DAOPayment daoPayment) {
    super(daoPayment);
  }

  @SuppressWarnings(value = { "unchecked" }) @Override protected PaymentEntity getTypeInstance() {
