...
<<<<<<< /usr/src/app/output/premium-minds/billy/e481179c9fa61835d2db73bd8cdcb9f47123f892/billy-core/src/main/java/com/premiumminds/billy/core/services/documents/impl/DocumentIssuingServiceImpl.java/left.java
    HashMap<Class<? extends GenericInvoice>, DocumentIssuingHandler<? extends GenericInvoice, ? extends IssuingParams>>
=======
    HashMap<>
>>>>>>> /usr/src/app/output/premium-minds/billy/e481179c9fa61835d2db73bd8cdcb9f47123f892/billy-core/src/main/java/com/premiumminds/billy/core/services/documents/impl/DocumentIssuingServiceImpl.java/right.java
  ...
  @Override public <T extends GenericInvoice, P extends IssuingParams> void addHandler(Class<T> handledClass, DocumentIssuingHandler<T, P> handler) {
    this.handlers.put(handledClass, handler);
  }

  @Override public synchronized <T extends GenericInvoice> T issue(final Builder<T> documentBuilder, final IssuingParams parameters) throws DocumentIssuingException {
    try {
  ...
  @Override public synchronized <T extends GenericInvoice> T issue(final Builder<T> documentBuilder, final IssuingParams parameters, final String ticketUID) throws DocumentIssuingException {
    try {
      return new TransactionWrapper<T>(this.daoInvoice) {
        @Override public T runTransaction() throws Exception {
          ...
          DocumentIssuingServiceImpl.this.ticketManager.updateTicket(new UID(ticketUID), result.getUID(), result.getDate(), result.getCreateTimestamp());
          return result;
        }
      }.execute();
  ...
  private <T extends GenericInvoice> T issueDocument(Builder<T> documentBuilder, final IssuingParams parameters) throws DocumentIssuingException {
    final T document = documentBuilder.build();
    final Type[] types = document.getClass().getGenericInterfaces();
    for (Type type : types) {
      if (this.handlers.containsKey(type)) {
        @SuppressWarnings(value = { "unchecked" }) DocumentIssuingHandler<T, IssuingParams> handler = (DocumentIssuingHandler<T, IssuingParams>) handlers.get(type);
        return 
<<<<<<< /usr/src/app/output/premium-minds/billy/e481179c9fa61835d2db73bd8cdcb9f47123f892/billy-core/src/main/java/com/premiumminds/billy/core/services/documents/impl/DocumentIssuingServiceImpl.java/left.java
        handler.issue(document, parameters)
=======
        this.handlers.get(type).issue(document, parameters)
>>>>>>> /usr/src/app/output/premium-minds/billy/e481179c9fa61835d2db73bd8cdcb9f47123f892/billy-core/src/main/java/com/premiumminds/billy/core/services/documents/impl/DocumentIssuingServiceImpl.java/right.java
        ;
      }
    }
