...
public class DocumentIssuingServiceImpl implements DocumentIssuingService {
	...
	@Override
	public <T extends GenericInvoice, P extends IssuingParams> void addHandler(Class<T> handledClass, DocumentIssuingHandler<T, P> handler) {
		this.handlers.put(handledClass, handler);
	}

	@Override
	public synchronized <T extends GenericInvoice> T issue(final Builder<T> documentBuilder, final IssuingParams parameters) throws DocumentIssuingException {
		try {
	...
	@Override
	public synchronized <T extends GenericInvoice> T issue(final Builder<T> documentBuilder, final IssuingParams parameters, final String ticketUID) throws DocumentIssuingException {
		try {
			return new TransactionWrapper<T>(this.daoInvoice) {
				@Override
				public T runTransaction() throws Exception {
