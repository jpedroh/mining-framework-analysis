...
public class TaxBuilderImpl<TBuilder extends TaxBuilderImpl<TBuilder, TTax>, TTax extends Tax> extends AbstractBuilder<TBuilder, TTax> implements TaxBuilder<TBuilder, TTax> {
  ...
  @Inject public TaxBuilderImpl(DAOTax daoTax, DAOContext daoContext) {
    super(daoTax);
    this.daoTax = daoTax;
    this.daoContext = daoContext;
  }

  @Override public TBuilder setContextUID(UID contextUID) {
    BillyValidator.notNull(contextUID, TaxBuilderImpl.LOCALIZER.getString("field.tax_context"));
    ContextEntity c = BillyValidator.found(this.daoContext.get(contextUID), TaxBuilderImpl.LOCALIZER.getString("field.tax_context"));
    this.getTypeInstance().setContext(c);
    return this.getBuilder();
  }

  @Override public TBuilder setDesignation(String designation) {
  ...
  @Override public TBuilder setCurrency(Currency currency) {
  ...
  @Override protected void validateInstance() throws javax.validation.ValidationException {
    ...
    switch (t.getTaxRateType()) {
      case FLAT:
      BillyValidator.mandatory(t.getFlatRateAmount(), TaxBuilderImpl.LOCALIZER.getString("field.tax_rate_flat_amount"));
      break;
      case PERCENTAGE:
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override protected TaxEntity getTypeInstance() {
