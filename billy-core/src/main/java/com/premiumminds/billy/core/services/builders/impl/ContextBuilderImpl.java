...
public class ContextBuilderImpl<TBuilder extends ContextBuilderImpl<TBuilder, TContext>, TContext extends Context> extends AbstractBuilder<TBuilder, TContext> implements ContextBuilder<TBuilder, TContext> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  protected DAOContext daoContext;

  @Inject public ContextBuilderImpl(DAOContext daoContext) {
    super(daoContext);
  ...
  @Override public TBuilder setParentContextUID(UID parentUID) {
    if (parentUID == null) {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override protected ContextEntity getTypeInstance() {
