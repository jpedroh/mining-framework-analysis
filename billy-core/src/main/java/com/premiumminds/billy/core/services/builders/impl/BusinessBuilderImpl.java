...
public class BusinessBuilderImpl<TBuilder extends BusinessBuilderImpl<TBuilder, TBusiness>, TBusiness extends Business> extends AbstractBuilder<TBuilder, TBusiness> implements BusinessBuilder<TBuilder, TBusiness> {
  ...
  @Inject public BusinessBuilderImpl(DAOBusiness daoBusiness, DAOContext daoContext) {
    super(daoBusiness);
    this.daoBusiness = daoBusiness;
    this.daoContext = daoContext;
  }

  @Override public TBuilder setOperationalContextUID(UID contextUID) {
    BillyValidator.notNull(contextUID, BusinessBuilderImpl.LOCALIZER.getString("field.business_context"));
    ContextEntity c = BillyValidator.found(this.daoContext.get(contextUID), BusinessBuilderImpl.LOCALIZER.getString("field.business_context"));
    this.getTypeInstance().setOperationalContext(c);
    return this.getBuilder();
  }

  @Override @NotOnUpdate public TBuilder setFinancialID(String id, String countryCode) throws BillyUpdateException {
  ...
  @Override public TBuilder setCommercialName(String name) {
  ...
  @Override public TBuilder setWebsite(String website) {
  ...
  @Override public <T extends Address> TBuilder setAddress(Builder<T> addressBuilder) {
  ...
  @Override public <T extends Address> TBuilder setBillingAddress(Builder<T> addressBuilder) {
    BillyValidator.notNull(addressBuilder, BusinessBuilderImpl.LOCALIZER.getString("field.business_billing_address"));
  ...
  @Override public <T extends Address> TBuilder setShippingAddress(Builder<T> addressBuilder) {
    BillyValidator.notNull(addressBuilder, BusinessBuilderImpl.LOCALIZER.getString("field.business_shipping_address"));
    this.getTypeInstance().setShippingAddress((AddressEntity) addressBuilder.build());
    return this.getBuilder();
  }

  @Override public <T extends Contact> TBuilder addContact(Builder<T> contactBuilder, boolean isMainContact) {
  ...
  @Override public <T extends Application> TBuilder addApplication(Builder<T> applicationBuilder) {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override protected BusinessEntity getTypeInstance() {
