...
public class AddressBuilderImpl<TBuilder extends AddressBuilderImpl<TBuilder, TAddress>, TAddress extends Address> extends AbstractBuilder<TBuilder, TAddress> implements AddressBuilder<TBuilder, TAddress> {
  ...
  @Inject protected AddressBuilderImpl(DAOAddress daoAddress) {
    super(daoAddress);
    this.daoAddress = daoAddress;
  }

  @Override public TBuilder setStreetName(String streetName) {
  ...
  @Override public TBuilder setNumber(String number) {
  ...
  @Override public TBuilder setDetails(String details) {
  ...
  @Override public TBuilder setBuilding(String building) {
  ...
  @Override public TBuilder setRegion(String region) {
  ...
  @Override public TBuilder setISOCountry(String country) {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override protected AddressEntity getTypeInstance() {
