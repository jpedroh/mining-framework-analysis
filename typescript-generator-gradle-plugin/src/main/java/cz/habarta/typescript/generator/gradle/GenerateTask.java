...
public class GenerateTask extends DefaultTask {
  ...
  public boolean 
<<<<<<< /usr/src/app/output/vojtechhabarta/typescript-generator/1c03813f0d5593fbea4d3572a6ef028da3f034bd/typescript-generator-gradle-plugin/src/main/java/cz/habarta/typescript/generator/gradle/GenerateTask.java/left.java
  disableJackson2ModuleDiscovery
=======
  experimentalJaxrsApplicationInterface
>>>>>>> /usr/src/app/output/vojtechhabarta/typescript-generator/1c03813f0d5593fbea4d3572a6ef028da3f034bd/typescript-generator-gradle-plugin/src/main/java/cz/habarta/typescript/generator/gradle/GenerateTask.java/right.java
  ;
  ...
  @TaskAction public void generate() throws Exception {
    ...
    new TypeScriptGenerator(settings).generateTypeScript(Input.fromClassNamesAndJaxrsApplication(classes, classPatterns, classesFromJaxrsApplication, classesFromAutomaticJaxrsApplication, settings.getExcludeFilter(), classLoader), Output.to(getProject().file(outputFile)));
  }
}