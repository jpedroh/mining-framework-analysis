    ...
    if (ctx.channel().isActive()) {
      ...
      if (logExceptions) {
        if (cause instanceof ReadTimeoutException) {
          ...
          if (cause instanceof DecoderException && cause.getCause() instanceof BadPacketException) {
            ...
            if (cause instanceof DecoderException && cause.getCause() instanceof OverflowPacketException) {
