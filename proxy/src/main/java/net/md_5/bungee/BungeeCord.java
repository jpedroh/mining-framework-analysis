...
public class BungeeCord extends ProxyServer {
  ...
  public final Gson gson = new GsonBuilder().registerTypeAdapter(BaseComponent.class, new ComponentSerializer()).registerTypeAdapter(TextComponent.class, new TextComponentSerializer()).registerTypeAdapter(TranslatableComponent.class, new TranslatableComponentSerializer()).registerTypeAdapter(KeybindComponent.class, new KeybindComponentSerializer(ProtocolConstants.MINECRAFT_1_7_6)).registerTypeAdapter(ScoreComponent.class, new ScoreComponentSerializer()).registerTypeAdapter(SelectorComponent.class, new SelectorComponentSerializer()).registerTypeAdapter(ServerPing.PlayerInfo.class, new PlayerInfoSerializer(ProtocolConstants.MINECRAFT_1_7_6)).registerTypeAdapter(Favicon.class, Favicon.getFaviconTypeAdapter()).create();

  public final Gson gsonLegacy = new GsonBuilder().registerTypeAdapter(BaseComponent.class, new ComponentSerializer()).registerTypeAdapter(TextComponent.class, new TextComponentSerializer()).registerTypeAdapter(TranslatableComponent.class, new TranslatableComponentSerializer()).registerTypeAdapter(
...
<<<<<<< /usr/src/app/output/spigotmc/bungeecord/7d1e131b67dd806d686060ba35fa1fbf59868ad8/proxy/src/main/java/net/md_5/bungee/BungeeCord.java/left.java
  registerTypeAdapter(ScoreComponent.class, new ScoreComponentSerializer()).registerTypeAdapter(SelectorComponent.class, new SelectorComponentSerializer()).registerTypeAdapter(ServerPing.PlayerInfo.class, new PlayerInfoSerializer(ProtocolConstants.MINECRAFT_1_7_2)).registerTypeAdapter(Favicon.class, Favicon.getFaviconTypeAdapter()).create()
=======
...
>>>>>>> /usr/src/app/output/spigotmc/bungeecord/7d1e131b67dd806d686060ba35fa1fbf59868ad8/proxy/src/main/java/net/md_5/bungee/BungeeCord.java/right.java
  ...
  /**
     ...
     * @throws Exception
     */
  @Override @SuppressFBWarnings(value = "RV_RETURN_VALUE_IGNORED_BAD_PRACTICE") public void start() throws Exception {
  ...
  @Override public void stop(final String reason) {
    new Thread("Shutdown Thread") {
      @Override @SuppressFBWarnings(value = "DM_EXIT") @SuppressWarnings(value = { "TooBroadCatch" }) public void run() {
