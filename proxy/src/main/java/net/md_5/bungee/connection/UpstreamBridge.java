...
public class UpstreamBridge extends PacketHandler {
  ...
  @Override public void writabilityChanged(ChannelWrapper channel) throws Exception {
    if (con.getServer() != null) {
  ...
  @Override public void handle(ResourcePackRequest resourcePackRequest) throws Exception {
