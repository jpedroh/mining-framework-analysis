...
<<<<<<< /usr/src/app/output/aerospike/aerospike-client-java/35cdb2c14bcb7ed4ecbc1cc7036e1554915e58dc/proxy/src/com/aerospike/client/proxy/grpc/GrpcStream.java/left.java
    Iterator<GrpcStreamingCall> iterator = pendingCalls.iterator();
=======
    pendingCalls.drain(GrpcStream.this::execute, (idleCounter) -> idleCounter, () -> !pendingCalls.isEmpty() && requestsSent < totalRequestsToExecute && executingCalls.size() < maxConcurrentRequests);
>>>>>>> /usr/src/app/output/aerospike/aerospike-client-java/35cdb2c14bcb7ed4ecbc1cc7036e1554915e58dc/proxy/src/com/aerospike/client/proxy/grpc/GrpcStream.java/right.java
    ...
    while (iterator.hasNext()) {
      ...
      if (call.hasSendDeadlineExpired() || call.hasExpired()) {
        ...
        if (requestsSent < grpcClientPolicy.totalRequestsPerStream && executingCalls.size() < grpcClientPolicy.maxConcurrentRequestsPerStream) {
          execute(call);
          iterator.remove();
        } else {
        }
