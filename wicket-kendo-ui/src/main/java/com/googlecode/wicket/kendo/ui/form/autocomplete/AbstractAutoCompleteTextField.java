 ...
 */
public abstract class AbstractAutoCompleteTextField<T extends java.lang.Object, C extends java.lang.Object> extends TextField<T> implements IJQueryWidget, IAutoCompleteListener {
  ...
  @Override public final void onSelect(AjaxRequestTarget target, int index) {
  ...
  protected ChoiceModelBehavior<C> newChoiceModelBehavior() {
    return new ChoiceModelBehavior<C>(this.renderer, this.template) {
      ...
      @Override public List<C> getChoices() {
