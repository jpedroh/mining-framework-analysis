 ...
 */
@AutoService(value = Processor.class) public final class AutoMatterProcessor extends AbstractProcessor {
  public static final Set<String> KEYWORDS = ImmutableSet.of("abstract", "continue", "for", "new", "switch", "assert", "default", "if", "package", "synchronized", "boolean", "do", "goto", "private", "this", "break", "double", "implements", "protected", "throw", "byte", "else", "import", "public", "throws", "case", "enum", "instanceof", "return", "transient", "catch", "extends", "int", "short", "try", "char", "final", "interface", "static", "void", "class", "finally", "long", "strictfp", "volatile", "const", "float", "native", "super", "while");
  ...
  @Override public boolean process(final Set<? extends TypeElement> annotations, final RoundEnvironment env) {
  ...
  private void writeBuilder(final Element element) throws IOException, AutoMatterProcessorException {
    ...
    writer.emitImports("java.util.ArrayList", "java.util.Arrays", "java.util.Collection", "java.util.Collections", "java.util.HashMap", "java.util.HashSet", "java.util.Iterator", "java.util.List", "java.util.Map", "java.util.Set");
    writer.emitEmptyLine();
    writer.emitImports("javax.annotation.Generated");
    writer.emitEmptyLine();
    writer.emitAnnotation(Generated.class, ImmutableMap.of("value", "\"" + AutoMatterProcessor.class.getName() + "\""));
    writer.beginType(d.builderSimpleName, "class", d.isPublic ? EnumSet.of(PUBLIC, FINAL) : EnumSet.of(FINAL), null);
    emitFields(writer, d);
  ...
  private void emitConstructors(final JavaWriter writer, final Descriptor descriptor) throws IOException {
  ...
  private void emitFactoryMethods(final JavaWriter writer, final Descriptor descriptor) throws IOException {
    emitFromValueFactory(writer, descriptor);
    emitFromBuilderFactory(writer, descriptor);
  }

  private void emitFromValueFactory(final JavaWriter writer, final Descriptor descriptor) throws IOException {
    writer.emitEmptyLine();
    writer.beginMethod(descriptor.builderSimpleName, "from", EnumSet.of(STATIC, PUBLIC), descriptor.targetSimpleName, "v");
    writer.emitStatement("return new %s(v)", descriptor.builderSimpleName);
    writer.endMethod();
  }

  private void emitFromBuilderFactory(final JavaWriter writer, final Descriptor descriptor) throws IOException {
    writer.emitEmptyLine();
    writer.beginMethod(descriptor.builderSimpleName, "from", EnumSet.of(STATIC, PUBLIC), descriptor.builderSimpleName, "v");
    writer.emitStatement("return new %s(v)", descriptor.builderSimpleName);
    writer.endMethod();
  }

  private void emitDefaultConstructor(final JavaWriter writer, final Descriptor descriptor) throws IOException {
    writer.emitEmptyLine();
  ...
  private void emitCopyValueConstructor(final JavaWriter writer, final Descriptor descriptor) throws IOException {
    writer.emitEmptyLine();
  ...
  private void emitCopyValueConstructorFieldCopy(final JavaWriter writer, final ExecutableElement field) throws IOException {
  ...
  private String constructorCollectionCopy(final String original, final JavaWriter writer, final ExecutableElement field) {
    return format("(%1$s == null) ? null : new %3$s<%2$s>(%1$s)", original, fieldTypeArguments(writer, field), collection(field));
  }
  ...
  private void emitCopyBuilderConstructor(final JavaWriter writer, final Descriptor descriptor) throws IOException {
    writer.emitEmptyLine();
  ...
  private void emitCopyBuilderConstructorFieldCopy(final JavaWriter writer, final ExecutableElement field) throws IOException {
    final String name = fieldName(field);
    final String copy;
    if (isCollection(field)) {
  ...
  private boolean isCollection(final ExecutableElement field) {
    final String returnType = field.getReturnType().toString();
    return returnType.startsWith("java.util.List<") || returnType.startsWith("java.util.Set<");
  }
  ...
  private String collectionType(final ExecutableElement field) {
    ...
    if (returnType.startsWith("java.util.List<")) {
      ...
      if (returnType.startsWith("java.util.Set<")) {
        return "Set";
      } else {
        throw new AssertionError();
      }
  ...
  private void emitValue(final JavaWriter writer, final Descriptor descriptor) throws IOException, AutoMatterProcessorException {
    writer.emitEmptyLine();
    writer.beginType("Value", "class", EnumSet.of(PRIVATE, STATIC, FINAL), null, descriptor.targetSimpleName);
  ...
  private void emitValueToBuilder(final JavaWriter writer, final Descriptor descriptor) throws IOException {
    writer.emitEmptyLine();
  ...
  private void emitBuilderToBuilder(final JavaWriter writer, final Descriptor descriptor) throws IOException {
    if (descriptor.toBuilder) {
      writer.emitEmptyLine();
      writer.beginMethod(descriptor.builderFullName, "builder", EnumSet.of(PUBLIC));
      writer.emitStatement("return new %s(this)", descriptor.builderSimpleName);
  ...
  private void emitValueConstructor(final JavaWriter writer, final List<ExecutableElement> fields) throws IOException {
    writer.emitEmptyLine();
  ...
  private String valueConstructorFieldCopy(final JavaWriter writer, final ExecutableElement field) {
    if (isCollection(field)) {
      return format("(%1$s != null) ? %1$s : Collections.<%2$s>%3$s()", fieldName(field), fieldTypeArguments(writer, field), emptyCollection(field));
    } else {
      if (isMap(field)) {
        return format("(%1$s != null) ? %1$s : Collections.<%2$s>emptyMap()", fieldName(field), fieldTypeArguments(writer, field));
      } else {
  ...
  private void emitNullCheck(final JavaWriter writer, final String scope, final ExecutableElement field) throws IOException {
    if (!shouldEnforceNonNull(field)) {
      return;
    }
    final String variable = scope.isEmpty() ? fieldName(field) : scope + "." + fieldName(field);
    final String name = fieldName(field);
    emitNullCheck(writer, variable, name);
  }

  private void emitNullCheck(final JavaWriter writer, final String variable, final String name) throws IOException {
    writer.beginControlFlow("if (" + variable + " == null)");
    emitNPE(writer, name);
    writer.endControlFlow();
  }

  private void emitValueFields(final JavaWriter writer, final List<ExecutableElement> fields) throws IOException {
    writer.emitEmptyLine();
    for (ExecutableElement field : fields) {
  ...
  private void emitValueGetters(final JavaWriter writer, final List<ExecutableElement> fields) throws IOException {
    for (ExecutableElement field : fields) {
      emitValueGetter(writer, field);
    }
  }

  private void emitValueGetter(final JavaWriter writer, final ExecutableElement field) throws IOException {
    writer.emitEmptyLine();
  ...
  private void emitValueEquals(final JavaWriter writer, final Descriptor descriptor) throws IOException, AutoMatterProcessorException {
    writer.emitEmptyLine();
    writer.emitAnnotation(Override.class);
  ...
  private String fieldNotEqualCondition(final ExecutableElement field) throws AutoMatterProcessorException {
  ...
  private void emitValueHashCode(final JavaWriter writer, final List<ExecutableElement> fields) throws IOException, AutoMatterProcessorException {
    writer.emitEmptyLine();
    writer.emitAnnotation(Override.class);
    ...
    for (ExecutableElement field : fields) {
      ...
      switch (type.getKind()) {
        ...
        break;
        case FLOAT:
        writer.emitStatement("result = 31 * result + " + "(%1$s != +0.0f ? Float.floatToIntBits(%1$s) : 0)", name);
        break;
        case DOUBLE:
        ...
        break;
        case ARRAY:
        writer.emitStatement("result = 31 * result + " + "(%1$s != null ? Arrays.hashCode(%1$s) : 0)", name);
        break;
        case DECLARED:
  ...
  private void emitValueToString(final JavaWriter writer, final List<ExecutableElement> fields, final String targetName) throws IOException {
    writer.emitEmptyLine();
    writer.emitAnnotation(Override.class);
  ...
  private void emitToStringStatement(final JavaWriter writer, final List<ExecutableElement> fields, final String targetName) throws IOException {
  ...
  private void emitBuild(final JavaWriter writer, final Descriptor descriptor) throws IOException {
    writer.emitEmptyLine();
  ...
  private String buildFieldCopy(final JavaWriter writer, final ExecutableElement field) {
    if (isCollection(field)) {
      final String absent = shouldEnforceNonNull(field) ? format("Collections.<%s>%s()", fieldTypeArguments(writer, field), emptyCollection(field)) : "null";
      final String present = format("Collections.%s(new %s<%s>(%s))", unmodifiableCollection(field), collection(field), fieldTypeArguments(writer, field), fieldName(field));
      return format("(%s != null) ? %s : %s", fieldName(field), present, absent);
    } else {
      if (isMap(field)) {
        final String absent = shouldEnforceNonNull(field) ? format("Collections.<%s>emptyMap()", fieldTypeArguments(writer, field)) : "null";
        final String present = format("Collections.unmodifiableMap(new HashMap<%s>(%s))", fieldTypeArguments(writer, field), fieldName(field));
        return format("(%s != null) ? %s : %s", fieldName(field), present, absent);
      } else {
        return fieldName(field);
      }
  ...
  private void emitAccessors(final JavaWriter writer, final Descriptor descriptor) throws IOException {
  ...
  private void emitOptionalSetters(final JavaWriter writer, final String builderSimpleName, final ExecutableElement field) throws IOException {
    emitOptionalRawSetter(writer, builderSimpleName, field);
    emitOptionalOptionalSetter(writer, builderSimpleName, field);
  }

  private void emitOptionalRawSetter(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
    writer.emitEmptyLine();
    writer.beginMethod(builderName, fieldName(field), EnumSet.of(PUBLIC), fieldTypeArguments(writer, field), fieldName(field));
    writer.emitStatement("return %1$s(%2$s(%1$s))", fieldName(field), optionalMaybe(writer, field));
    writer.endMethod();
  }

  private void emitOptionalOptionalSetter(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
    writer.emitEmptyLine();
    final String argType = format("%s<? extends %s>", optionalType(field), fieldTypeArguments(writer, field));
    writer.beginMethod(builderName, fieldName(field), EnumSet.of(PUBLIC), argType, fieldName(field));
    emitNullCheck(writer, "", field);
  ...
  private boolean isOptional(final ExecutableElement field) {
    final String returnType = field.getReturnType().toString();
    return returnType.startsWith("java.util.Optional<") || returnType.startsWith("com.google.common.base.Optional<");
  }

  private void emitMapMutators(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
  ...
  private void emitMapPutAll(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
    final String name = fieldName(field);
    final String type = fieldTypeArguments(writer, field);
    final String extendedType = fieldTypeArgumentsExtended(writer, field);
    writer.emitEmptyLine();
    writer.beginMethod(builderName, name, EnumSet.of(PUBLIC), "Map<" + extendedType + ">", name);
  ...
  private void emitMapEntriesPutAll(final JavaWriter writer, final String builderName, final ExecutableElement field, final int entries) throws IOException {
    ...
    writer.emitEmptyLine();
    writer.beginMethod(builderName, name, EnumSet.of(PUBLIC), parameters, Collections.<String>emptyList());
    if (entries > 1) {
  ...
  private void emitMapEntryPut(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
    final String name = fieldName(field);
    ...
    final String valueType = valueType(writer, field);
    writer.emitEmptyLine();
    writer.beginMethod(builderName, addSingular, EnumSet.of(PUBLIC), keyType, "key", valueType, "value");
    if (shouldEnforceNonNull(field)) {
  ...
  private void emitCollectionMutators(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
  ...
  private void emitCollectionIteratorAddAll(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
    final String type = fieldTypeArguments(writer, field);
    final String extendedType = fieldTypeArgumentsExtended(writer, field);
    final String name = fieldName(field);
    final String item = variableName("item", name);
    writer.emitEmptyLine();
    writer.beginMethod(builderName, name, EnumSet.of(PUBLIC), "Iterator<" + extendedType + ">", name);
  ...
  private void emitCollectionAddAll(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
    final String extendedType = fieldTypeArgumentsExtended(writer, field);
    final String name = fieldName(field);
    writer.emitEmptyLine();
    final String fullType = collectionType(field) + "<" + extendedType + ">";
    writer.beginMethod(builderName, name, EnumSet.of(PUBLIC), fullType, name);
    writer.emitStatement("return %1$s((Collection<%2$s>) %1$s)", name, extendedType);
    writer.endMethod();
  }

  private void emitCollectionItemAdd(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
    final String name = fieldName(field);
    final String singular = singular(name);
    ...
    writer.emitEmptyLine();
    writer.beginMethod(builderName, appendMethodName, EnumSet.of(PUBLIC), fieldTypeArguments(writer, field), singular);
    if (shouldEnforceNonNull(field)) {
  ...
  private void emitCollectionIterableAddAll(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
    final String name = fieldName(field);
    final String extendedType = fieldTypeArgumentsExtended(writer, field);
  ...
  private void emitCollectionCollectionAddAll(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
    writer.emitEmptyLine();
    final String name = fieldName(field);
    final String type = fieldTypeArguments(writer, field);
    final String extendedType = fieldTypeArgumentsExtended(writer, field);
    writer.beginMethod(builderName, name, EnumSet.of(PUBLIC), "Collection<" + extendedType + ">", name);
    emitCollectionNullGuard(writer, field);
    final String item = variableName("item", name);
    if (shouldEnforceNonNull(field)) {
  ...
  private void emitCollectionNullGuard(final JavaWriter writer, final ExecutableElement field) throws IOException {
    final String name = fieldName(field);
    writer.beginControlFlow("if (" + name + " == null)");
    if (shouldEnforceNonNull(field)) {
      emitNPE(writer, name);
  ...
  private void beginFor(final JavaWriter writer, final String type, final String item, final String collection) throws IOException {
  ...
  private String fieldTypeArgumentsExtended(final JavaWriter writer, final ExecutableElement field) {
    return Joiner.on(",").join(typeArgumentsExtended(writer, field));
  }

  private List<String> typeArgumentsExtended(final JavaWriter writer, final ExecutableElement field) {
  ...
  private void emitCollectionVarArgAddAll(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
    final String type = fieldTypeArguments(writer, field);
    final String vararg = type + "...";
    writer.emitEmptyLine();
    writer.beginMethod(builderName, fieldName(field), EnumSet.of(PUBLIC), vararg, fieldName(field));
    emitCollectionNullGuard(writer, field);
    writer.emitStatement("return %1$s(Arrays.asList(%1$s))", fieldName(field));
    writer.endMethod();
  }

  private void emitRawSetter(final JavaWriter writer, final String builderName, final ExecutableElement field) throws IOException {
    writer.emitEmptyLine();
    writer.beginMethod(builderName, fieldName(field), EnumSet.of(PUBLIC), fieldType(writer, field), fieldName(field));
    emitNullCheck(writer, "", field);
  ...
  private void emitGetter(final JavaWriter writer, final ExecutableElement field) throws IOException {
    writer.emitEmptyLine();
    writer.beginMethod(fieldType(writer, field), fieldName(field), EnumSet.of(PUBLIC));
    if (isCollection(field)) {
  ...
  private void emitCollectionGetterBody(final JavaWriter writer, final ExecutableElement field) throws IOException {
    if (shouldEnforceNonNull(field)) {
      emitLazyCollectionFieldInstantiation(writer, field);
    }
    writer.emitStatement("return %s", fieldName(field));
  ...
  private void emitLazyCollectionFieldInstantiation(final JavaWriter writer, final ExecutableElement field) throws IOException {
    final String name = fieldName(field);
    writer.beginControlFlow("if (this." + name + " == null)");
    writer.emitStatement("this.%s = new %s<%s>()", name, collection(field), fieldTypeArguments(writer, field));
    writer.endControlFlow();
  }

  private void emitMapGetterBody(final JavaWriter writer, final ExecutableElement field) throws IOException {
    if (shouldEnforceNonNull(field)) {
      emitLazyMapFieldInstantiation(writer, field);
    }
    writer.emitStatement("return %s", fieldName(field));
  ...
  private void emitLazyMapFieldInstantiation(final JavaWriter writer, final ExecutableElement field) throws IOException {
    final String name = fieldName(field);
    writer.beginControlFlow("if (" + name + " == null)");
    writer.emitStatement("%s = new HashMap<%s>()", name, fieldTypeArguments(writer, field));
    writer.endControlFlow();
  ...
  private void emitDefaultGetterBody(final JavaWriter writer, final ExecutableElement field) throws IOException {
    writer.emitStatement("return %s", fieldName(field));
  }
  ...
  private AutoMatterProcessorException fail(final String msg, final Element element) throws AutoMatterProcessorException {
