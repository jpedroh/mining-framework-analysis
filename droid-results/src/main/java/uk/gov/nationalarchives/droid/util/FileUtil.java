...
public final class FileUtil {
  ...
  private static void listFiles(final Path path, final boolean recursive, final DirectoryStream.Filter<Path> filter, final List<Path> results) throws IOException {
