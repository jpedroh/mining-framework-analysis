...
public class PythonExecutionCachedEngine extends ExecutionCachedEngine<PythonExecutor> implements PythonExecutionEngine {
  ...
  @Value(value = "#{systemProperties[\'" + PythonExecutionConfigurationConsts.PYTHON_EXECUTOR_CACHE_SIZE + "\'] != null ? systemProperties[\'" + PythonExecutionConfigurationConsts.PYTHON_EXECUTOR_CACHE_SIZE + "\'] : " + PythonExecutionConfigurationConsts.PYTHON_EXECUTOR_CACHE_DEFAULT_SIZE + "}") private int cacheSize;
  ...
  @Override protected DependencyService getDependencyService() {
    return dependencyService;
  }

  @Override protected int getCacheSize() {
    return cacheSize;
  }

  @Override protected PythonExecutor createNewExecutor(Set<String> filePaths) {
