 ...
 */
@Configuration @ComponentScan(value = "io.cloudslang.runtime.impl.python") @Import(value = { DependenciesManagementConfiguration.class }) public class PythonExecutionEngineConfiguration {
  ...
  @Bean(name = "jythonExecutionEngine") PythonExecutionEngine pythonExecutionEngine() {
    ...
    return System.getProperty(PythonExecutionConfigurationConsts.PYTHON_EXECUTOR_ENGINE, cacheEngine).equals(noCacheEngine) ? new PythonExecutionNotCachedEngine() : new PythonExecutionCachedEngine();
  }
