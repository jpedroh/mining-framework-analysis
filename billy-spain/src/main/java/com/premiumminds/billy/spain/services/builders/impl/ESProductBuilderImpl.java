...
public class ESProductBuilderImpl<TBuilder extends ESProductBuilderImpl<TBuilder, TProduct>, TProduct extends ESProduct> extends ProductBuilderImpl<TBuilder, TProduct> implements ESProductBuilder<TBuilder, TProduct> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  @Inject public ESProductBuilderImpl(DAOESProduct daoESProduct, DAOESTax daoESTax) {
    super(daoESProduct, daoESTax);
  }

  @Override protected ESProductEntity getTypeInstance() {
  ...
  @Override protected void validateInstance() throws BillyValidationException {
    ...
    BillyValidator.mandatory(p.getNumberCode(), ESProductBuilderImpl.LOCALIZER.getString("field.product_number_code"));
  }
}