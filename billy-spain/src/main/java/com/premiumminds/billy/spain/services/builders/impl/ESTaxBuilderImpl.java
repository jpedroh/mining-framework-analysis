...
public class ESTaxBuilderImpl<TBuilder extends ESTaxBuilderImpl<TBuilder, TTax>, TTax extends ESTax> extends TaxBuilderImpl<TBuilder, TTax> implements ESTaxBuilder<TBuilder, TTax> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  @Inject public ESTaxBuilderImpl(DAOESTax daoESTax, DAOESRegionContext daoESContext) {
    super(daoESTax, daoESContext);
  }

  @Override protected ESTaxEntity getTypeInstance() {
  ...
  @Override protected void validateInstance() throws BillyValidationException {
    ...
    if (!((DAOESTax) this.daoTax).getTaxes((ESRegionContextEntity) e.getContext(), e.getValidFrom(), e.getValidTo()).isEmpty()) {
