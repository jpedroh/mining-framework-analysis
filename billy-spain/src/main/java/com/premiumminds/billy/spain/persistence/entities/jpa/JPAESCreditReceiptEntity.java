...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "CREDIT_RECEIPT") public class JPAESCreditReceiptEntity extends JPAESGenericInvoiceEntity implements ESCreditReceiptEntity {
