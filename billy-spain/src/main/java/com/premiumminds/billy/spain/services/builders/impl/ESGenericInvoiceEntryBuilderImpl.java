...
public class ESGenericInvoiceEntryBuilderImpl<TBuilder extends ESGenericInvoiceEntryBuilderImpl<TBuilder, TEntry, TDAOEntry, TDAOInvoice>, TEntry extends ESGenericInvoiceEntry, TDAOEntry extends AbstractDAOESGenericInvoiceEntry<?>, TDAOInvoice extends AbstractDAOESGenericInvoice<?>> extends GenericInvoiceEntryBuilderImpl<TBuilder, TEntry, TDAOEntry, TDAOInvoice> implements ESGenericInvoiceEntryBuilder<TBuilder, TEntry> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  public ESGenericInvoiceEntryBuilderImpl(TDAOEntry daoESGenericInvoiceEntry, TDAOInvoice daoESGenericInvoice, DAOESTax daoESTax, DAOESProduct daoESProduct, DAOESRegionContext daoESRegionContext) {
    super(daoESGenericInvoiceEntry, daoESGenericInvoice, daoESTax, daoESProduct, daoESRegionContext);
  }

  @Override protected ESGenericInvoiceEntryEntity getTypeInstance() {
  ...
  @Override protected void validateInstance() throws BillyValidationException {
    ...
    if (i.getTaxAmount().compareTo(BigDecimal.ZERO) == 0) {
      BillyValidator.mandatory(i.getTaxExemptionReason(), ESGenericInvoiceEntryBuilderImpl.LOCALIZER.getString("field.tax_exemption_reason"));
    }
  }
}