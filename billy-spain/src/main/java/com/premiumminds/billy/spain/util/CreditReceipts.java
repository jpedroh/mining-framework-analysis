...
public class CreditReceipts {
  ...
  public CreditReceipts(Injector injector) {
    ...
    this.exportService.addDataExtractor(ESCreditReceiptData.class, this.getInstance(ESCreditReceiptDataExtractor.class));
  ...
  public <O extends java.lang.Object> void pdfExport(UID uidDoc, BillyExportTransformer<ESCreditReceiptData, O> dataTransformer, O output) throws ExportServiceException {
