...
public class Services {
  ...
  private void setupServices() {
    ...
    this.issuingService.addHandler(ESCreditNoteEntity.class, this.injector.getInstance(ESCreditNoteIssuingHandler.class));
    ...
    this.issuingService.addHandler(ESCreditReceiptEntity.class, this.injector.getInstance(ESCreditReceiptIssuingHandler.class));
  }
  ...
  /**
     ...
     */
  public <T extends ESGenericInvoice> T issueDocument(Builder<T> builder, ESIssuingParams issuingParameters) throws DocumentIssuingException {
    return this.issuingService.issue(builder, issuingParameters);
  }

  public <T extends ESGenericInvoice> T issueDocument(Builder<T> builder, ESIssuingParams issuingParameters, String ticketUID) throws DocumentIssuingException {
