...
public class DAOESReceiptImpl extends AbstractDAOESGenericInvoiceImpl<ESReceiptEntity, JPAESReceiptEntity> implements DAOESReceipt {
  @Inject public DAOESReceiptImpl(Provider<EntityManager> emProvider) {
    super(emProvider);
  }

  @Override public ESReceiptEntity getEntityInstance() {
    return new JPAESReceiptEntity();
  }

  @Override protected Class<? extends JPAESReceiptEntity> getEntityClass() {
