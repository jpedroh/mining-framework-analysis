...
public interface ESCreditReceipt extends ESGenericInvoice {
  public static class Builder extends ESCreditReceiptBuilderImpl<Builder, ESCreditReceiptEntry, ESCreditReceipt> {
    @Inject public Builder(DAOESCreditReceipt daoESCreditReceipt, DAOESBusiness daoESBusiness, DAOESCustomer daoESCustomer, DAOESSupplier daoESSupplier) {
      super(daoESCreditReceipt, daoESBusiness, daoESCustomer, daoESSupplier);
    }
  }

  public static class ManualBuilder extends ESManualCreditReceiptBuilderImpl<ManualBuilder, ESCreditReceiptEntry, ESCreditReceipt> {
    @Inject public ManualBuilder(DAOESCreditReceipt daoESCreditReceipt, DAOESBusiness daoESBusiness, DAOESCustomer daoESCustomer, DAOESSupplier daoESSupplier) {
      super(daoESCreditReceipt, daoESBusiness, daoESCustomer, daoESSupplier);
    }
  }
}