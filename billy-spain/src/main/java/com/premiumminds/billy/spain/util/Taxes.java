...
public class Taxes {
  ...
  public class Continent {
    ...
    public ESTax normal() {
      ...
      return (ESTax) dao.get(Taxes.this.configuration.getUID(Config.Key.Context.Spain.Continental.VAT.NORMAL_UUID));
    }
    ...
    public ESTax intermediate() {
      DAOESTax dao = Taxes.this.getInstance(DAOESTax.class);
      return (ESTax) dao.get(Taxes.this.configuration.getUID(Config.Key.Context.Spain.Continental.VAT.INTERMEDIATE_UUID));
    }
    ...
    public ESTax reduced() {
      DAOESTax dao = Taxes.this.getInstance(DAOESTax.class);
      return (ESTax) dao.get(Taxes.this.configuration.getUID(Config.Key.Context.Spain.Continental.VAT.REDUCED_UUID));
    }
  }
  ...
  public class CanaryIslands {
    ...
    public ESTax normal() {
      DAOESTax dao = Taxes.this.getInstance(DAOESTax.class);
      return (ESTax) dao.get(Taxes.this.configuration.getUID(Config.Key.Context.Spain.CanaryIslands.IGIC.NORMAL_UUID));
    }
    ...
    public ESTax intermediate() {
      DAOESTax dao = Taxes.this.getInstance(DAOESTax.class);
      return (ESTax) dao.get(Taxes.this.configuration.getUID(Config.Key.Context.Spain.CanaryIslands.IGIC.INTERMEDIATE_UUID));
    }
    ...
    public ESTax reduced() {
      DAOESTax dao = Taxes.this.getInstance(DAOESTax.class);
      return (ESTax) dao.get(Taxes.this.configuration.getUID(Config.Key.Context.Spain.CanaryIslands.IGIC.REDUCED_UUID));
    }
  }
