...
public class ESCustomerPersistenceService implements PersistenceService<ESCustomer> {
  ...
  @Inject public ESCustomerPersistenceService(DAOESCustomer daoCustomer) {
    this.daoCustomer = daoCustomer;
  }

  @Override public ESCustomer create(final Builder<ESCustomer> builder) {
    try {
      return new TransactionWrapper<ESCustomer>(this.daoCustomer) {
        @Override public ESCustomer runTransaction() throws Exception {
  ...
  @Override public ESCustomer update(final Builder<ESCustomer> builder) {
    try {
      return new TransactionWrapper<ESCustomer>(this.daoCustomer) {
        @Override public ESCustomer runTransaction() throws Exception {
          ESCustomerEntity entity = (ESCustomerEntity) builder.build();
  ...
  @Override public ESCustomer get(final UID uid) {
    try {
      return new TransactionWrapper<ESCustomer>(this.daoCustomer) {
        @Override public ESCustomer runTransaction() throws Exception {
