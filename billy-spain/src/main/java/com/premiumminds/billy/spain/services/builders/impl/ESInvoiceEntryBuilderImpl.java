...
public class ESInvoiceEntryBuilderImpl<TBuilder extends ESInvoiceEntryBuilderImpl<TBuilder, TEntry>, TEntry extends ESInvoiceEntry> extends ESGenericInvoiceEntryBuilderImpl<TBuilder, TEntry, DAOESInvoiceEntry, DAOESInvoice> implements ESInvoiceEntryBuilder<TBuilder, TEntry> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  @Inject public ESInvoiceEntryBuilderImpl(DAOESInvoiceEntry daoESEntry, DAOESInvoice daoESInvoice, DAOESTax daoESTax, DAOESProduct daoESProduct, DAOESRegionContext daoESRegionContext) {
    super(daoESEntry, daoESInvoice, daoESTax, daoESProduct, daoESRegionContext);
  }

  @Override protected ESInvoiceEntryEntity getTypeInstance() {
