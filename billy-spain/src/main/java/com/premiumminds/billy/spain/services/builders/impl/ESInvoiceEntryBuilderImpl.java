...
public class ESInvoiceEntryBuilderImpl<TBuilder extends ESInvoiceEntryBuilderImpl<TBuilder, TEntry>, TEntry extends ESInvoiceEntry> extends ESGenericInvoiceEntryBuilderImpl<TBuilder, TEntry, DAOESInvoiceEntry, DAOESInvoice> implements ESInvoiceEntryBuilder<TBuilder, TEntry> {
	...
	@Inject
	public ESInvoiceEntryBuilderImpl(DAOESInvoiceEntry daoESEntry, DAOESInvoice daoESInvoice, DAOESTax daoESTax, DAOESProduct daoESProduct, DAOESRegionContext daoESRegionContext) {
