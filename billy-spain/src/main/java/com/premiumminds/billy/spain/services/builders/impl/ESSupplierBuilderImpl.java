...
public class ESSupplierBuilderImpl<TBuilder extends ESSupplierBuilderImpl<TBuilder, TSupplier>, TSupplier extends ESSupplier> extends SupplierBuilderImpl<TBuilder, TSupplier> implements ESSupplierBuilder<TBuilder, TSupplier> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  @Inject public ESSupplierBuilderImpl(DAOESSupplier daoESSupplier) {
    super(daoESSupplier);
  }

  @Override protected ESSupplierEntity getTypeInstance() {
  ...
  @Override public <T extends Address> TBuilder setBillingAddress(Builder<T> addressBuilder) {
    BillyValidator.mandatory(addressBuilder, ESSupplierBuilderImpl.LOCALIZER.getString("field.supplier_billing_address"));
  ...
  @Override public TBuilder setSelfBillingAgreement(boolean selfBilling) {
    BillyValidator.mandatory(selfBilling, ESSupplierBuilderImpl.LOCALIZER.getString("field.supplier_self_billing_agreement"));
  ...
  @Deprecated @NotImplemented public TBuilder setAccountID(String accountID) {
    return null;
  }
  ...
  @Override protected void validateInstance() throws BillyValidationException {
    ...
    BillyValidator.mandatory(s.getTaxRegistrationNumber(), ESSupplierBuilderImpl.LOCALIZER.getString("field.supplier_tax_number"));
    BillyValidator.mandatory(s.getBillingAddress(), ESSupplierBuilderImpl.LOCALIZER.getString("field.supplier_billing_address"));
    BillyValidator.mandatory(s.hasSelfBillingAgreement(), ESSupplierBuilderImpl.LOCALIZER.getString("field.supplier_self_billing_agreement"));
  }
}