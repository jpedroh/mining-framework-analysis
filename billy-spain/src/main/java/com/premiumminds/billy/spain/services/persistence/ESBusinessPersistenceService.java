...
public class ESBusinessPersistenceService implements PersistenceService<ESBusiness> {
  ...
  @Inject public ESBusinessPersistenceService(DAOESBusiness daoBusiness) {
    this.daoBusiness = daoBusiness;
  }

  @Override public ESBusiness create(final Builder<ESBusiness> builder) {
    try {
      return new TransactionWrapper<ESBusiness>(this.daoBusiness) {
        @Override public ESBusiness runTransaction() throws Exception {
  ...
  @Override public ESBusiness update(final Builder<ESBusiness> builder) {
    try {
      return new TransactionWrapper<ESBusiness>(this.daoBusiness) {
        @Override public ESBusiness runTransaction() throws Exception {
          ESBusinessEntity entity = (ESBusinessEntity) builder.build();
  ...
  @Override public ESBusiness get(final UID uid) {
    try {
      return new TransactionWrapper<ESBusiness>(this.daoBusiness) {
        @Override public ESBusiness runTransaction() throws Exception {
