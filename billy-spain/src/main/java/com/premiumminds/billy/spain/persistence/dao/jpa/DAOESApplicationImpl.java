...
public class DAOESApplicationImpl extends DAOApplicationImpl implements DAOESApplication {
  @Inject public DAOESApplicationImpl(Provider<EntityManager> emProvider) {
    super(emProvider);
  }
  ...
  @Override protected Class<JPAESApplicationEntity> getEntityClass() {
    return JPAESApplicationEntity.class;
  }

  @Override public ESApplicationEntity get(UID uid) throws NoResultException {
