...
public interface ESManualInvoiceBuilder<TBuilder extends ESManualInvoiceBuilder<TBuilder, TEntry, TDocument>, TEntry extends ESGenericInvoiceEntry, TDocument extends ESGenericInvoice> extends ESGenericInvoiceBuilder<TBuilder, TEntry, TDocument> {
