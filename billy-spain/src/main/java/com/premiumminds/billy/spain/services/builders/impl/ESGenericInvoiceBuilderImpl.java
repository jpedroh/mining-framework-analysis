...
public class ESGenericInvoiceBuilderImpl<TBuilder extends ESGenericInvoiceBuilderImpl<TBuilder, TEntry, TDocument>, TEntry extends ESGenericInvoiceEntry, TDocument extends ESGenericInvoice> extends GenericInvoiceBuilderImpl<TBuilder, TEntry, TDocument> implements ESGenericInvoiceBuilder<TBuilder, TEntry, TDocument> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  public <TDAO extends AbstractDAOESGenericInvoice<? extends TDocument>> ESGenericInvoiceBuilderImpl(TDAO daoESGenericInvoice, DAOESBusiness daoESBusiness, DAOESCustomer daoESCustomer, DAOESSupplier daoESSupplier) {
  ...
  @Override protected ESGenericInvoiceEntity getTypeInstance() {
  ...
  protected void validateESInstance(ESGenericInvoiceEntity i) {
    ...
    if (i.isSelfBilled() != null) {
      BillyValidator.mandatory(i.isSelfBilled(), ESGenericInvoiceBuilderImpl.LOCALIZER.getString("field.self_billed"));
    } else {
    ...
    BillyValidator.notEmpty(i.getPayments(), ESGenericInvoiceBuilderImpl.LOCALIZER.getString("field.payment_mechanism"));
  }
}