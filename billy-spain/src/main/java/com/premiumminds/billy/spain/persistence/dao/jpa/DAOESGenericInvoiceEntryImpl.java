...
public class DAOESGenericInvoiceEntryImpl extends AbstractDAOESGenericInvoiceEntryImpl<ESGenericInvoiceEntryEntity, JPAESGenericInvoiceEntryEntity> implements DAOESGenericInvoiceEntry {
  @Inject public DAOESGenericInvoiceEntryImpl(Provider<EntityManager> emProvider) {
    super(emProvider);
  }

  @Override public ESGenericInvoiceEntryEntity getEntityInstance() {
    return new JPAESGenericInvoiceEntryEntity();
  }

  @Override protected Class<? extends JPAESGenericInvoiceEntryEntity> getEntityClass() {
