...
public class ESCreditNoteIssuingHandler extends ESGenericInvoiceIssuingHandler<ESCreditNoteEntity, ESIssuingParams> {
  ...
  @Inject public ESCreditNoteIssuingHandler(DAOInvoiceSeries invoiceSeries, DAOESCreditNote daoCreditNote) {
    super(invoiceSeries);
    this.daoCreditNote = daoCreditNote;
  }

  @Override public ESCreditNoteEntity issue(ESCreditNoteEntity document, ESIssuingParams parameters) throws DocumentIssuingException {
...
=======
  @Override public <T extends GenericInvoice, P extends IssuingParams> T issue(final T document, P parameters) throws DocumentIssuingException {
    ...
    return this.issue(document, parametersES, this.daoCreditNote);
  }
>>>>>>> /usr/src/app/output/premium-minds/billy/e481179c9fa61835d2db73bd8cdcb9f47123f892/billy-spain/src/main/java/com/premiumminds/billy/spain/services/documents/ESCreditNoteIssuingHandler.java/right.java
}