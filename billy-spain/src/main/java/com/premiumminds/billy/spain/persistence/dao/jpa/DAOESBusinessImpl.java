...
public class DAOESBusinessImpl extends DAOBusinessImpl implements DAOESBusiness {
  @Inject public DAOESBusinessImpl(Provider<EntityManager> emProvider) {
    super(emProvider);
  }

  @Override public ESBusinessEntity getEntityInstance() {
    return new JPAESBusinessEntity();
  }

  @Override protected Class<JPAESBusinessEntity> getEntityClass() {
    return JPAESBusinessEntity.class;
  }

  @Override public ESBusinessEntity get(UID uid) throws NoResultException {
