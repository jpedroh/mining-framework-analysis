...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "SHIPPING_POINT") public class JPAESShippingPointEntity extends JPAShippingPointEntity implements ESShippingPointEntity {
  private static final long serialVersionUID = 1L;

  public JPAESShippingPointEntity() {
  }
}