...
public interface ESRegionContextBuilder<TBuilder extends ESRegionContextBuilder<TBuilder, TContext>, TContext extends ESRegionContext> extends ContextBuilder<TBuilder, TContext> {
}