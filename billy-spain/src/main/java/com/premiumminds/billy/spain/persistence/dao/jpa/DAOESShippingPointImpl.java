...
public class DAOESShippingPointImpl extends DAOShippingPointImpl implements DAOESShippingPoint {
  @Inject public DAOESShippingPointImpl(Provider<EntityManager> emProvider) {
    super(emProvider);
  }

  @Override public ESShippingPointEntity getEntityInstance() {
    return new JPAESShippingPointEntity();
  }

  @Override protected Class<JPAESShippingPointEntity> getEntityClass() {
