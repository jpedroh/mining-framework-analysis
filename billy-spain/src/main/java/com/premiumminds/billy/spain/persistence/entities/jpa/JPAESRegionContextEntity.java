...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "REGION_CONTEXT") public class JPAESRegionContextEntity extends JPAContextEntity implements ESRegionContextEntity {
  private static final long serialVersionUID = 1L;

  public JPAESRegionContextEntity() {
  }

  @Override public ESRegionContext getParentContext() {
