...
public class ESRegionContextPersistenceService implements PersistenceService<ESRegionContext> {
  ...
  @Inject public ESRegionContextPersistenceService(DAOESRegionContext daoRegionContext) {
    this.daoRegionContext = daoRegionContext;
  }

  @Override public ESRegionContext create(final Builder<ESRegionContext> builder) {
    try {
      return new TransactionWrapper<ESRegionContext>(this.daoRegionContext) {
        @Override public ESRegionContext runTransaction() throws Exception {
  ...
  @Override public ESRegionContext update(final Builder<ESRegionContext> builder) {
    try {
      return new TransactionWrapper<ESRegionContext>(this.daoRegionContext) {
        @Override public ESRegionContext runTransaction() throws Exception {
          ESRegionContextEntity entity = (ESRegionContextEntity) builder.build();
  ...
  @Override public ESRegionContext get(final UID uid) {
    try {
      return new TransactionWrapper<ESRegionContext>(this.daoRegionContext) {
        @Override public ESRegionContext runTransaction() throws Exception {
  ...
  public boolean isPartOf(final ESRegionContext parent, final Context child) {
    try {
      return new TransactionWrapper<Boolean>(this.daoRegionContext) {
        @Override public Boolean runTransaction() throws Exception {
