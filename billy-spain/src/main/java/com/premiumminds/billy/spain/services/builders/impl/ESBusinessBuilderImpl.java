...
public class ESBusinessBuilderImpl<TBuilder extends ESBusinessBuilderImpl<TBuilder, TBusiness>, TBusiness extends ESBusiness> extends BusinessBuilderImpl<TBuilder, TBusiness> implements ESBusinessBuilder<TBuilder, TBusiness> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  @Inject public ESBusinessBuilderImpl(DAOESBusiness daoBusiness, DAOESRegionContext daoContext) {
  ...
  @Override protected ESBusinessEntity getTypeInstance() {
  ...
  @Override protected void validateInstance() throws BillyValidationException {
    ...
    BillyValidator.mandatory(b.getCommercialName(), ESBusinessBuilderImpl.LOCALIZER.getString("field.commercial_name"));
