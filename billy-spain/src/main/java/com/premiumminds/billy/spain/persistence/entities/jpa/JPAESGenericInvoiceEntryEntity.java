...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "GENERIC_INVOICE_ENTRY") public class JPAESGenericInvoiceEntryEntity extends JPAGenericInvoiceEntryEntity implements ESGenericInvoiceEntryEntity {
