...
public class ESTaxPersistenceService implements PersistenceService<ESTax> {
  ...
  @Inject public ESTaxPersistenceService(DAOESTax daoTax) {
    this.daoTax = daoTax;
  }

  @Override public ESTax create(final Builder<ESTax> builder) {
    try {
      return new TransactionWrapper<ESTax>(this.daoTax) {
        @Override public ESTax runTransaction() throws Exception {
  ...
  @Override public ESTax update(final Builder<ESTax> builder) {
    try {
      return new TransactionWrapper<ESTax>(this.daoTax) {
        @Override public ESTax runTransaction() throws Exception {
          ESTaxEntity entity = (ESTaxEntity) builder.build();
  ...
  @Override public ESTax get(final UID uid) {
    try {
      return new TransactionWrapper<ESTax>(this.daoTax) {
        @Override public ESTax runTransaction() throws Exception {
