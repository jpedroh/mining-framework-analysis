...
public interface ESCreditReceiptEntry extends ESGenericInvoiceEntry {
  public static class Builder extends ESCreditReceiptEntryBuilderImpl<Builder, ESCreditReceiptEntry> {
    @Inject public Builder(DAOESCreditReceiptEntry daoESCreditReceiptEntry, DAOESReceipt daoESReceipt, DAOESTax daoESTax, DAOESProduct daoESProduct, DAOESRegionContext daoESRegionContext) {
      super(daoESCreditReceiptEntry, daoESReceipt, daoESTax, daoESProduct, daoESRegionContext);
    }
  }

  public static class ManualBuilder extends ESManualCreditReceiptEntryBuilderImpl<ManualBuilder, ESCreditReceiptEntry> {
    @Inject public ManualBuilder(DAOESCreditReceiptEntry daoESCreditReceiptEntry, DAOESReceipt daoESReceipt, DAOESTax daoESTax, DAOESProduct daoESProduct, DAOESRegionContext daoESRegionContext) {
      super(daoESCreditReceiptEntry, daoESReceipt, daoESTax, daoESProduct, daoESRegionContext);
    }
  }
