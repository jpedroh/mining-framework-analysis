...
public class ESRegionContextBuilderImpl<TBuilder extends ESRegionContextBuilderImpl<TBuilder, TContext>, TContext extends ESRegionContext> extends ContextBuilderImpl<TBuilder, TContext> implements ESRegionContextBuilder<TBuilder, TContext> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  @Inject public ESRegionContextBuilderImpl(DAOESRegionContext daoESContext) {
    super(daoESContext);
  }

  @Override protected ESRegionContextEntity getTypeInstance() {
