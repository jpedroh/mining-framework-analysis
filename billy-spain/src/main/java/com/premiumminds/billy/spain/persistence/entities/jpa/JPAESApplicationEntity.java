...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "APPLICATION") public class JPAESApplicationEntity extends JPAApplicationEntity implements ESApplicationEntity {
  /**
     *
     */
