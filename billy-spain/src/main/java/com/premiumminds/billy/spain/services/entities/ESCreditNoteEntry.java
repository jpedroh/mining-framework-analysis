...
public interface ESCreditNoteEntry extends ESGenericInvoiceEntry {
  public static class Builder extends ESCreditNoteEntryBuilderImpl<Builder, ESCreditNoteEntry> {
    @Inject public Builder(DAOESCreditNoteEntry daoESCreditNoteEntry, DAOESInvoice daoESInvoice, DAOESTax daoESTax, DAOESProduct daoESProduct, DAOESRegionContext daoESRegionContext) {
  ...
  public static class ManualBuilder extends ESManualCreditNoteEntryBuilderImpl<ManualBuilder, ESCreditNoteEntry> {
    @Inject public ManualBuilder(DAOESCreditNoteEntry daoESCreditNoteEntry, DAOESInvoice daoESInvoice, DAOESTax daoESTax, DAOESProduct daoESProduct, DAOESRegionContext daoESRegionContext) {
      super(daoESCreditNoteEntry, daoESInvoice, daoESTax, daoESProduct, daoESRegionContext);
    }
  }
