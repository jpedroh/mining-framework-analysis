...
public class ESManualCreditNoteBuilderImpl<TBuilder extends ESManualCreditNoteBuilderImpl<TBuilder, TEntry, TDocument>, TEntry extends ESCreditNoteEntry, TDocument extends ESCreditNote> extends ESManualBuilderImpl<TBuilder, TEntry, TDocument> implements ESManualCreditNoteBuilder<TBuilder, TEntry, TDocument> {
  public <TDAO extends AbstractDAOESGenericInvoice<? extends TDocument>> ESManualCreditNoteBuilderImpl(TDAO daoESCreditNote, DAOESBusiness daoESBusiness, DAOESCustomer daoESCustomer, DAOESSupplier daoESSupplier) {
    super(daoESCreditNote, daoESBusiness, daoESCustomer, daoESSupplier);

  }

  @Override protected ESCreditNoteEntity getTypeInstance() {
