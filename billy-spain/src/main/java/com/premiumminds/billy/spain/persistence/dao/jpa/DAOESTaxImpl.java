...
public class DAOESTaxImpl extends DAOTaxImpl implements DAOESTax {
  @Inject public DAOESTaxImpl(Provider<EntityManager> emProvider) {
    super(emProvider);
  }

  @Override public ESTaxEntity getEntityInstance() {
    return new JPAESTaxEntity();
  }

  @Override protected Class<JPAESTaxEntity> getEntityClass() {
    return JPAESTaxEntity.class;
  }

  @Override public List<JPAESTaxEntity> getTaxes(ESRegionContextEntity context, Date validFrom, Date validTo) {
