...
public class DAOESCustomerImpl extends DAOCustomerImpl implements DAOESCustomer {
  @Inject public DAOESCustomerImpl(Provider<EntityManager> emProvider) {
    super(emProvider);
  }

  @Override public ESCustomerEntity getEntityInstance() {
    return new JPAESCustomerEntity();
  }

  @Override protected Class<JPAESCustomerEntity> getEntityClass() {
