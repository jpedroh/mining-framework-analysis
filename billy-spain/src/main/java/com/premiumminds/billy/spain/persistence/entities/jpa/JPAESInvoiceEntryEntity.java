...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "INVOICE_ENTRY") public class JPAESInvoiceEntryEntity extends JPAESGenericInvoiceEntryEntity implements ESInvoiceEntryEntity {
  /**
     *
     */
