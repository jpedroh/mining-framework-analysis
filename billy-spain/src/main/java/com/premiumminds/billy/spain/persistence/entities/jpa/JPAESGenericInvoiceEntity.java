...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "GENERIC_INVOICE") public class JPAESGenericInvoiceEntity extends JPAGenericInvoiceEntity implements ESGenericInvoiceEntity {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public List<? extends ESGenericInvoiceEntry> getEntries() {
