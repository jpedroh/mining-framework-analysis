...
public class TestESInvoiceIssuingHandlerWithTicket extends ESDocumentAbstractTest {
  ...
  @Before public void setUpNewInvoice() {
    try {
      ...
      ESInvoice.Builder invoiceBuilder = new ESInvoiceTestUtil(ESAbstractTest.injector).getInvoiceBuilder(business);
  ...
  @Test public void testIssueWithUsedTicket() {
    ...
    try {
      entity = (ESInvoiceEntity) services.issueDocument(builder, this.parameters, this.issuedInvoiceUID.getValue());
    } catch (InvalidTicketException e) {
    } catch (DocumentIssuingException e) {
      e.printStackTrace();
    }
  ...
  @Test public void testOpenCloseConnections() {
    Services services = new Services(ESAbstractTest.injector);
    ESInvoicePersistenceService persistenceService = ESAbstractTest.injector.getInstance(ESInvoicePersistenceService.class);
    ESBusinessEntity business = new ESBusinessTestUtil(ESAbstractTest.injector).getBusinessEntity("business");
