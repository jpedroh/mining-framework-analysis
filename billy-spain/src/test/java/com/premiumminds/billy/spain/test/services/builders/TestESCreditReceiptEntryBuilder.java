...
public class TestESCreditReceiptEntryBuilder extends ESAbstractTest {
  ...
  @Test public void doTest() {
    MockESCreditReceiptEntryEntity mock = this.createMockEntity(MockESCreditReceiptEntryEntity.class, TestESCreditReceiptEntryBuilder.ES_CREDIT_RECEIPT_ENTRY_YML);
    mock.setCurrency(Currency.getInstance("EUR"));
    Mockito.when(this.getInstance(DAOESCreditReceiptEntry.class).getEntityInstance()).thenReturn(new MockESCreditReceiptEntryEntity());
    MockESReceiptEntity mockReceiptEntity = this.createMockEntity(MockESReceiptEntity.class, TestESCreditReceiptEntryBuilder.ES_RECEIPT_YML);
