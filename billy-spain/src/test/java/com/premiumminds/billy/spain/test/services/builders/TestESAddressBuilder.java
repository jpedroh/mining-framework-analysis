...
public class TestESAddressBuilder extends ESAbstractTest {
  ...
  @Test public void doTest() {
    MockESAddressEntity mockAddress = this.createMockEntity(MockESAddressEntity.class, TestESAddressBuilder.ESADDRESS_YML);
    ...
    builder.setCity(mockAddress.getCity()).setDetails(mockAddress.getDetails()).setISOCountry(mockAddress.getISOCountry()).setNumber(mockAddress.getNumber()).setPostalCode(mockAddress.getPostalCode()).setRegion(mockAddress.getRegion()).setStreetName(mockAddress.getStreetName());
