...
public class ESAddressTestUtil {
  ...
  public ESAddress.Builder getAddressBuilder(String streetName, String number, String details, String building, String city, String postalCode, String region, String isoCountry) {
  ...
  public ESAddress.Builder getAddressBuilder() {
    return this.getAddressBuilder(ESAddressTestUtil.STREET, ESAddressTestUtil.NUMBER, ESAddressTestUtil.DETAILS, ESAddressTestUtil.BUILDING, ESAddressTestUtil.CITY, ESAddressTestUtil.POSTAL_CODE, ESAddressTestUtil.REGION, ESAddressTestUtil.ISOCODE);
  }
}