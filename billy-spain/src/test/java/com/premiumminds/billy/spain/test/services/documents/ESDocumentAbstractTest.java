...
public class ESDocumentAbstractTest extends ESPersistencyAbstractTest {
  ...
  @BeforeEach public void setUpParamenters() {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected <T extends ESGenericInvoiceEntity> T newInvoice(INVOICE_TYPE type, SOURCE_BILLING source) {
    switch (type) {
      case FT:
  ...
  protected <T extends DocumentIssuingHandler<I, ESIssuingParams>, I extends ESGenericInvoiceEntity> void issueNewInvoice(T handler, I invoice, String series) throws DocumentIssuingException, SeriesUniqueCodeNotFilled, DocumentSeriesDoesNotExistException {
  ...
  protected <T extends DocumentIssuingHandler<I, ESIssuingParams>, I extends ESGenericInvoiceEntity> void issueNewInvoice(T handler, I invoice, String series, Date date) throws DocumentIssuingException, SeriesUniqueCodeNotFilled, DocumentSeriesDoesNotExistException {
