...
public class ESContactTestUtil {
  ...
  public ESContact.Builder getContactBuilder(String name, String telephone, String mobile, String fax, String email, String website) {
  ...
  public ESContact.Builder getContactBuilder() {
    return this.getContactBuilder(ESContactTestUtil.NAME, ESContactTestUtil.TELEPHONE, ESContactTestUtil.MOBILE, ESContactTestUtil.FAX, ESContactTestUtil.EMAIL, ESContactTestUtil.WEBSITE);
  }
}