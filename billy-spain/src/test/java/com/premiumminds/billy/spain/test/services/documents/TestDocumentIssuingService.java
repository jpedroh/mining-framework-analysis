...
public class TestDocumentIssuingService extends ESDocumentAbstractTest {
  ...
  @Test public void testIssuingService() throws DocumentIssuingException {
    this.service.issue(new ESInvoiceTestUtil(ESAbstractTest.injector).getInvoiceBuilder(new ESBusinessTestUtil(ESAbstractTest.injector).getBusinessEntity()), this.parameters);
  }
}