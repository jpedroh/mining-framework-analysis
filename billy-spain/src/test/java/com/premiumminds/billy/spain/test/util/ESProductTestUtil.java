...
public class ESProductTestUtil {
  ...
  public ESProduct.Builder getProductBuilder(String productCode, String unitMesure, String numberCode, String group, String description, ProductType type) {
  ...
  public ESProduct.Builder getProductBuilder() {
    return this.getProductBuilder(ESProductTestUtil.PRODUCT_CODE, ESProductTestUtil.UNIT_OF_MEASURE, ESProductTestUtil.NUMBER_CODE, ESProductTestUtil.GROUP, ESProductTestUtil.DESCRIPTION, ESProductTestUtil.TYPE);
  }

  public ESProductEntity getProductEntity(String productCode, String unitMesure, String numberCode, String group, ProductType type) {
    return (ESProductEntity) this.getProductBuilder(productCode, unitMesure, numberCode, group, ESProductTestUtil.DESCRIPTION, type).build();
  }
  ...
  public ESProductEntity getOtherRegionProductEntity() {
    ...
    productBuilder.addTaxUID(taxRegion.getUID()).setNumberCode(ESProductTestUtil.NUMBER_CODE).setUnitOfMeasure(ESProductTestUtil.UNIT_OF_MEASURE).setProductCode(ESProductTestUtil.PRODUCT_CODE).setDescription(ESProductTestUtil.DESCRIPTION).setType(ESProductTestUtil.TYPE).setProductGroup(ESProductTestUtil.GROUP);
