...
public class TestESSimpleInvoiceBuilder extends ESAbstractTest {
  ...
  @Test public void doTest() {
    MockESSimpleInvoiceEntity mock = this.createMockEntity(MockESSimpleInvoiceEntity.class, TestESSimpleInvoiceBuilder.ES_INVOICE_YML);
    MockESCustomerEntity mockCustomerEntity = this.createMockEntity(MockESCustomerEntity.class, TestESSimpleInvoiceBuilder.ESCUSTOMER_YML);
    ...
    MockESInvoiceEntryEntity entryMock = this.createMockEntity(MockESInvoiceEntryEntity.class, TestESSimpleInvoiceBuilder.ES_INVOICE_ENTRY_YML);
    ...
    MockESPaymentEntity mockPayment = this.createMockEntity(MockESPaymentEntity.class, TestESSimpleInvoiceBuilder.ES_PAYMENT_YML);
