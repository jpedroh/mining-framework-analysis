...
public class TestESInvoiceBuilder extends ESAbstractTest {
  ...
  @Test public void doTest() {
    MockESInvoiceEntity mock = this.createMockEntity(MockESInvoiceEntity.class, TestESInvoiceBuilder.ES_INVOICE_YML);
    mock.setCurrency(Currency.getInstance("EUR"));
    MockESCustomerEntity mockCustomerEntity = this.createMockEntity(MockESCustomerEntity.class, TestESInvoiceBuilder.ESCUSTOMER_YML);
    ...
    MockESInvoiceEntryEntity entryMock = this.createMockEntity(MockESInvoiceEntryEntity.class, TestESInvoiceBuilder.ES_INVOICE_ENTRY_YML);
    ...
    MockESPaymentEntity mockPayment = this.createMockEntity(MockESPaymentEntity.class, TestESInvoiceBuilder.ES_PAYMENT_YML);
