...
public class ESShippingPointTestUtil {
  ...
  public ESShippingPoint.Builder getShippingPointBuilder() {
    ...
    shippingPointBuilder.setAddress(addressBuilder).setDate(new Date()).setDeliveryId(this.deliveryId).setLocationId(this.locationId).setWarehouseId(this.warehouseId);
