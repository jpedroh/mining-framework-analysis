...
public class MockESCreditReceiptEntity extends MockGenericInvoiceEntity implements ESCreditReceiptEntity {
  ...
  public MockESCreditReceiptEntity() {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public List<ESCreditReceiptEntry> getEntries() {
    return (List<ESCreditReceiptEntry>) (List<?>) super.getEntries();
  }
