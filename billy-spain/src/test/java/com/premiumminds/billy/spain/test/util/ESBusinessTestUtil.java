...
public class ESBusinessTestUtil {
  ...
  public ESBusiness.Builder getBusinessBuilder() {
    ...
    businessBuilder.addApplication(applicationBuilder).addContact(contactBuilder, true).setAddress(addressBuilder).setBillingAddress(addressBuilder).setCommercialName(ESBusinessTestUtil.NAME).setFinancialID(ESBusinessTestUtil.FINANCIAL_ID, ESBusinessTestUtil.ES_COUNTRY_CODE).setOperationalContextUID(this.context.getUID()).setWebsite(ESBusinessTestUtil.WEBSITE).setName(ESBusinessTestUtil.NAME);
