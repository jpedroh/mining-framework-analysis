...
public class TestConcurrentIssuing extends ESDocumentAbstractTest {
  ...
  @Before public void setUp() {
    ...
    this.service.addHandler(ESInvoiceEntity.class, ESAbstractTest.injector.getInstance(ESInvoiceIssuingHandler.class));
  ...
  class TestRunner implements Callable<ESInvoice> {
    ...
    @Override public ESInvoice call() throws Exception {
      TestConcurrentIssuing.this.parameters.setInvoiceSeries(this.series);
      try {
        ESInvoice invoice = TestConcurrentIssuing.this.service.issue(new ESInvoiceTestUtil(this.injector).getInvoiceBuilder(this.business), TestConcurrentIssuing.this.parameters);
        return invoice;
