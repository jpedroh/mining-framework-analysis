...
public class ServerUtils {
  ...
  @Nullable public static SProject getProject(@NotNull final ProjectManager projectManager, @NotNull final HttpServletRequest request) {
  ...
  public static ArtifactoryManager getArtifactoryManager(ServerConfigBean serverConfigBean, String username, String password) {
