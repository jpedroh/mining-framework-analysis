...
public class GarbageCollectionTest {
  static class TestGCE implements GarbageCollectionEnvironment {
    ...
    @Override public Iterator<GcCandidate> getCandidates() throws TableNotFoundException {
    ...
    @Override public List<GcCandidate> readCandidatesThatFitInMemory(Iterator<GcCandidate> candidatesIter) {
    ...
    @Override public void deleteGcCandidates(Collection<GcCandidate> refCandidates, GcCandidateType type) {
    ...
    @Override public Map<TableId, TableState> getTableIDs() {
      HashMap<TableId, TableState> results = new HashMap<>();
      tableIds.forEach((t) -> results.put(t, TableState.ONLINE));
      return results;
    }

    @Override public void deleteConfirmedCandidates(SortedMap<String, GcCandidate> candidateMap) {
...
<<<<<<< /usr/src/app/output/apache/accumulo/c4c8c572c8be14d882899f8f9370700227e87423/server/gc/src/test/java/org/apache/accumulo/gc/GarbageCollectionTest.java/left.java
      new ReferenceFile(tid, new Path(file))
=======
      ReferenceFile.forFile(tid, file)
>>>>>>> /usr/src/app/output/apache/accumulo/c4c8c572c8be14d882899f8f9370700227e87423/server/gc/src/test/java/org/apache/accumulo/gc/GarbageCollectionTest.java/right.java
      );
      tableIds.add(tid);
    }
    ...
    private void removeLastTableIdRef(TableId tableId) {
      boolean inUse = references.keySet().stream().map((k) -> k.substring(0, k.indexOf(':'))).anyMatch((tid) -> tableId.canonical().equals(tid));
      if (!inUse) {
    ...
    @Override public Set<TableId> getCandidateTableIDs() {
      if (level == Ample.DataLevel.ROOT) {
        return Set.of(RootTable.ID);
      } else {
        if (level == Ample.DataLevel.METADATA) {
  ...
  private void assertNoCandidatesRemoved(TestGCE gce) {
    assertEquals(0, gce.deletedCandidates.size(), "Deleted Candidates not empty: " + gce.deleteInUseRefs);
  }
  ...
  @Test public void testBasic2() throws Exception {
    ...
    gce.addCandidate("hdfs://foo.com:6000/accumulo/tables/5/t0/F005.rf");
    int counter = 0;
    String[] paths = { "hdfs://foo.com:6000/accumulo/tables/5/t0/F001.rf", "hdfs://foo:6000/accumulo/tables/5/t0/F000.rf", "hdfs://foo.com:6000/accumulo/tables/6/t1/F005.rf", "hdfs://foo:6000/accumulo/tables/6/t0/F000.rf", "hdfs://foo.com:6000/accumulo/tables/6/t0/F001.rf", "hdfs://foo.com:6000/accumulo/tables/7/t0/F005.rf", "hdfs://foo:6000/accumulo/tables/7/t0/F000.rf", "hdfs://foo.com:6000/accumulo/tables/7/t0/F001.rf", "hdfs://foo.com:6000/accumulo/tables/8/t0/F005.rf", "hdfs://foo:6000/accumulo/tables/8/t0/F000.rf", "hdfs://foo.com:6000/accumulo/tables/8/t0/F001.rf", "hdfs://foo.com:6000/accumulo/tables/9/t0/F005.rf", "hdfs://foo:6000/accumulo/tables/9/t0/F000.rf", "hdfs://foo.com:6000/accumulo/tables/9/t0/F001.rf", "hdfs://foo.com:6000/accumulo/tables/10/t0/F005.rf", "hdfs://foo:6000/accumulo/tables/10/t0/F000.rf", "hdfs://foo.com:6000/accumulo/tables/10/t0/F001.rf", "hdfs://foo.com:6000/accumulo/tables/11/t0/F005.rf", "hdfs://foo:6000/accumulo/tables/11/t0/F000.rf", "hdfs://foo.com:6000/accumulo/tables/11/t0/F001.rf" };
   ...
   */
  @Test public void emptyPathsTest() throws Exception {
    TestGCE gce = new TestGCE();
    gce.addCandidate("hdfs://foo:6000/accumulo/tables/4//t0//F000.rf");
    gce.addCandidate("hdfs://foo.com:6000/accumulo/tables/4//t0//F001.rf");
    var candidate = gce.addCandidate("hdfs://foo.com:6000/accumulo/tables/5//t0//F005.rf");
  ...
  @Test public void testBlip() throws Exception {
    ...
    gca.collect(gce);
    assertFileDeleted(gce, new GcCandidate("/4/b-0", 0L), new GcCandidate("/4/b-0/F002.rf", 1L), new GcCandidate("hdfs://foo.com:6000/accumulo/tables/4/b-0/F001.rf", 2L));
    gce.blips.remove("hdfs://foo.com:6000/accumulo/tables/5/b-0");
    gca.collect(gce);
    assertFileDeleted(gce, new GcCandidate("/5/b-0", 3L), new GcCandidate("/5/b-0/F002.rf", 4L), new GcCandidate("hdfs://foo.com:6000/accumulo/tables/5/b-0/F001.rf", 5L));
    gca.collect(gce);
    assertFileDeleted(gce);
  }
  ...
  @Test public void testDirectories() throws Exception {
    ...
    gca.collect(gce);
    assertFileDeleted(gce, new GcCandidate("/6/t-0", 3L), new GcCandidate("hdfs://foo:6000/accumulo/tables/7/t-0/", 4L));
    ...
    gca.collect(gce);
    assertFileDeleted(gce, new GcCandidate("/8/t-0", 5L), new GcCandidate("hdfs://foo:6000/accumulo/tables/9/t-0", 6L), new GcCandidate("/a/t-0", 7L), new GcCandidate("hdfs://foo:6000/accumulo/tables/b/t-0", 8L), new GcCandidate("/c/t-0", 9L), new GcCandidate("hdfs://foo:6000/accumulo/tables/d/t-0", 10L));
    gca.collect(gce);
    assertFileDeleted(gce);
  }
  ...
  @Test public void testCustomDirectories() throws Exception {
    ...
    gce.removeFileReference("f", "m", "../d/t-0/F00.rf");
    gca.collect(gce);
    assertFileDeleted(gce, candidates.get(6), candidates.get(7), candidates.get(8), candidates.get(9), candidates.get(10), candidates.get(11));
    gca.collect(gce);
    assertFileDeleted(gce);
  }
  ...
  @Test public void testBadFileRef1() {
    assertThrows(IllegalArgumentException.class, () -> badRefTest("/F00.rf"));
  }

  @Test public void testBadFileRef2() {
    assertThrows(IllegalArgumentException.class, () -> badRefTest("../F00.rf"));
  }

  @Test public void testBadFileRef3() {
    assertThrows(IllegalArgumentException.class, () -> badRefTest("hdfs://foo.com:6000/accumulo/F00.rf"));
  }

  @Test public void testBadFileRef4() {
    assertThrows(IllegalArgumentException.class, () -> badRefTest("hdfs://foo.com:6000/accumulo/tbls/5/F00.rf"));
  }

  @Test public void testBadFileRef5() {
    assertThrows(RuntimeException.class, () -> badRefTest("F00.rf"));
  }

  @Test public void testBadFileRef6() {
...
=======
  @Test public void newReplicationRecordsPreventDeletion() throws Exception {
    ...
    gce.addCandidate("hdfs://foo.com:6000/accumulo/tables/1/t-00001/A000001.rf");
    var candidate = gce.addCandidate("hdfs://foo.com:6000/accumulo/tables/2/t-00002/A000002.rf");
    @SuppressWarnings(value = { "deprecation" }) Status status = org.apache.accumulo.server.replication.StatusUtil.fileCreated(System.currentTimeMillis());
    gce.filesToReplicate.put("hdfs://foo.com:6000/accumulo/tables/1/t-00001/A000001.rf", status);
    gca.collect(gce);
    assertEquals(1, gce.fileDeletions.size());
    assertEquals(candidate, gce.fileDeletions.get(0));
...
=======
  @Test public void bulkImportReplicationRecordsPreventDeletion() throws Exception {
    ...
    gca.collect(gce);
    assertEquals(1, gce.fileDeletions.size());
    assertEquals(new GcCandidate("hdfs://foo.com:6000/accumulo/tables/2/t-00002/A000002.rf", 1L), gce.fileDeletions.get(0));
  }
>>>>>>> /usr/src/app/output/apache/accumulo/c4c8c572c8be14d882899f8f9370700227e87423/server/gc/src/test/java/org/apache/accumulo/gc/GarbageCollectionTest.java/right.java


  @Test public void testMissingTableIds() throws Exception {
    GarbageCollectionAlgorithm gca = new GarbageCollectionAlgorithm();
    ...
    assertTrue((msg.contains("[b, d]") || msg.contains("[d, b]")) && msg.contains("Saw table IDs in ZK that were not in metadata table:"), msg);
  }

  @Test public void testDeletingInUseReferenceCandidates() throws Exception {
    TestGCE gce = new TestGCE();
  ...
  @Test public void testDeletingRootInUseReferenceCandidates() throws Exception {
  ...
  @Test public void testInUseDirReferenceCandidates() throws Exception {
    TestGCE gce = new TestGCE();
    GarbageCollectionAlgorithm gca = new GarbageCollectionAlgorithm();
  ...
  @Test public void testInUseScanReferenceCandidates() throws Exception {
    TestGCE gce = new TestGCE();
   ...
   */
  @Test public void testNormalGCRun() {
   ...
   */
  @Test public void testTableAddedInMiddle() {
    Set<TableId> tablesBefore = makeUnmodifiableSet("1", "2", "3");
    Set<TableId> tablesSeen = makeUnmodifiableSet("2", "1", "3");
   ...
   */
  @Test public void testTableAddedInMiddleTwo() {
    Set<TableId> tablesBefore = makeUnmodifiableSet("1", "2", "3");
   ...
   */
  @Test public void testTableDeletedInMiddle() {
   ...
   */
  @Test public void testTableDeletedInMiddleTwo() {
    Set<TableId> tablesBefore = makeUnmodifiableSet("1", "2", "3", "4");
   ...
   * this
   */
  @Test public void testMissEntireTable() {
    Set<TableId> tablesBefore = makeUnmodifiableSet("1", "2", "3", "4");
    Set<TableId> tablesSeen = makeUnmodifiableSet("1", "2", "4");
    Set<TableId> tablesAfter = makeUnmodifiableSet("1", "2", "3", "4");
    GarbageCollectionAlgorithm gca = new GarbageCollectionAlgorithm();
    String msg = assertThrows(RuntimeException.class, () -> gca.ensureAllTablesChecked(tablesBefore, tablesSeen, tablesAfter)).getMessage();
   ...
   * case let's test
   */
  @Test public void testZKHadNoTables() {
   ...
   */
  @Test public void testMissingTableAndTableAdd() {
    Set<TableId> tablesBefore = makeUnmodifiableSet("1", "2", "3");
    Set<TableId> tablesSeen = makeUnmodifiableSet("1", "2", "4");
    Set<TableId> tablesAfter = makeUnmodifiableSet("1", "2", "3", "4");
    GarbageCollectionAlgorithm gca = new GarbageCollectionAlgorithm();
   ...
   */
  @Test public void testMissingTableAndTableDeleted() {
    Set<TableId> tablesBefore = makeUnmodifiableSet("1", "2", "3", "4");
    Set<TableId> tablesSeen = makeUnmodifiableSet("1", "2", "4");
