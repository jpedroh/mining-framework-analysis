...
public class AutoNSGAIIConfigurator {
  ...
  public EvolutionaryAlgorithm<DoubleSolution> configureAndGetAlgorithm() {
    ...
    EvolutionaryAlgorithm<DoubleSolution> nsgaii = new EvolutionaryAlgorithm<>("NSGAII", evaluation, createInitialSolutions, termination, selection, variation, replacement);
    return nsgaii;
  }
  ...
  MutationOperator<DoubleSolution> getMutation() {
    switch (mutationType) {
      ...
      case uniform:
      return new UniformMutation(crossoverProbability, uniformMutationPerturbation, getRepairDoubleSolutionStrategy(mutationRepairStrategy));
      default:
