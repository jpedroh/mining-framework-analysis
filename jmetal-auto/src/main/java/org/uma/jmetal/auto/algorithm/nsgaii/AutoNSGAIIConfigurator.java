...
public class AutoNSGAIIConfigurator {
  ...
  @Option(names = { "--sbxCrossoverDistributionIndex" }, description = "SBXCrossoverDistributionIndexParameter Crossover Distribution Index (default: ${DEFAULT-VALUE})") private double sbxCrossoverDistributionIndex = 0.20;

  @Option(names = { "--blxAlphaCrossoverAlphaValue" }, description = "BLXAlphaCrossoverAlphaValueParameter-alpha Crossover Alpha value (default: ${DEFAULT-VALUE})") private double blxAlphaCrossoverAlphaValue = 0.5;
  ...
  @Option(names = { "--createInitialSolutions" }, required = true, description = "Create initial solutions: ${COMPLETION-CANDIDATES}") private CreateInitialSolutionsStrategyType createInitialSolutionsType = CreateInitialSolutionsStrategyType.random;
  ...
  @Option(names = { "--selectionTournamentSize" }, description = "Selection: number of selected solutions") private int selectionTournamentSize = 2;
  ...
  public EvolutionaryAlgorithm<DoubleSolution> configureAndGetAlgorithm() {
    ...
    class NSGAII extends EvolutionaryAlgorithm<DoubleSolution> {
      ...
      public NSGAII(String name, Evaluation<DoubleSolution> evaluation, CreateInitialSolutions<DoubleSolution> createInitialSolutionList, Termination termination, MatingPoolSelection<DoubleSolution> selection, Variation<DoubleSolution> variation, Replacement<DoubleSolution> replacement, ExternalArchiveObserver<DoubleSolution> archiveObserver) {
