 ...
 * @since 2013-11-12
 */
@Component(value = "pmsMenuBiz") public class PmsMenuBiz {
  ...
  /**
	 * 获取用于编制菜单时的树.
	 */
  @SuppressWarnings(value = { "rawtypes" }) public String getTreeMenu(String actionUrl) {
  ...
  /**
	 ...
	 * @param buffer
	 */
  @SuppressWarnings(value = { "rawtypes" }) private void recursionTreeMenu(String pId, StringBuffer buffer, List list, String url) {
    if (pId.equals("0")) {
