...
public class OperatorRealm extends AuthorizingRealm {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
    ...
    if (!"admin".equals(loginName)) {
      ...
      SimpleAuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo(operator.getLoginName(), operator.getLoginPwd(), ByteSource.Util.bytes(operator.getCredentialsSalt()), getName());
      return authenticationInfo;
    }
  }

  @Override public void clearCachedAuthorizationInfo(PrincipalCollection principals) {
    super.clearCachedAuthorizationInfo(principals);
  }

  @Override public void clearCachedAuthenticationInfo(PrincipalCollection principals) {
