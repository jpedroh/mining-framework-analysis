...
public abstract class AbstractSaturnJob extends AbstractElasticJob {
  ...
  @Override protected final void executeJob(final JobExecutionMultipleShardingContext shardingContext) {
    ...
    if (SaturnSystemReturnCode.JOB_NO_COUNT != saturnJobReturn.getReturnCode()) {
      ...
      if (errorGroup == SaturnSystemErrorGroup.SUCCESS) {
        ...
        if (errorGroup == SaturnSystemErrorGroup.TIMEOUT) {
          ...
          if (errorGroup == SaturnSystemErrorGroup.FAIL_NEED_RAISE_ALARM) {
  ...
  @Override protected boolean mayRunDownStream(JobExecutionMultipleShardingContext shardingContext) {
  ...
  protected abstract static class JobBusinessClassMethodCaller {
    public Object call(Object jobBusinessInstance, SaturnExecutorService saturnExecutorService) throws Exception {
      ...
      try {
        final Class<?> saturnJobExecutionContextClazz = jobClassLoader.loadClass(SaturnJobExecutionContext.class.getCanonicalName());
    ...
    protected abstract Object internalCall(ClassLoader jobClassLoader, Class<?> saturnJobExecutionContextClazz) throws Exception;
  }

  protected Object tryToGetSaturnBusinessInstanceFromSaturnApplication(ClassLoader jobClassLoader, Class<?> jobClass) {
    try {
      ...
      if (saturnApplication != null) {
        ...
        if (ssaClazz.isInstance(saturnApplication)) {
          Object jobBusinessInstance = saturnApplication.getClass().getMethod("getJobInstance", Class.class).invoke(saturnApplication, jobClass);
          if (jobBusinessInstance != null) {
