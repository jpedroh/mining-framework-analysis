...
public class SqlProcessResult implements Comparable<SqlProcessResult> {
  ...
  /**
     ...
     * {@inheritDoc}
     */
  @Override public int compareTo(SqlProcessResult o) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) public void validate(SqlValidator validator) throws SqlValidationException {
