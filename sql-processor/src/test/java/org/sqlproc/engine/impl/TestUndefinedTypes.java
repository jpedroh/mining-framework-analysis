...
public class TestUndefinedTypes extends TestDatabase {
  ...
  @Test public void testUndefinedTypes() throws SQLException {
    SqlQueryEngine sqlEngine = getSqlEngine("UNDEFINED_TYPES");
    String sql = sqlEngine.getSql(null, null, SqlQueryEngine.NO_ORDER);
    logger.info(sql);
    List<TypesTransport> list = sqlEngine.query(session, TypesTransport.class, null, null, SqlQueryEngine.NO_ORDER, 0, 0, 0);
  ...
  @Test public void testUndefinedTypes2() throws SQLException {
