...
public class TestStandardParameters extends TestDatabase {
...
<<<<<<< /usr/src/app/output/hudec/sql-processor/8968e32ea09be0994799e017dbaf14422ff7afe2/sql-processor/src/test/java/org/sqlproc/engine/impl/TestStandardParameters.java/left.java
          "db2"
=======
          "mssql"
>>>>>>> /usr/src/app/output/hudec/sql-processor/8968e32ea09be0994799e017dbaf14422ff7afe2/sql-processor/src/test/java/org/sqlproc/engine/impl/TestStandardParameters.java/right.java
          )) {
            return 
<<<<<<< /usr/src/app/output/hudec/sql-processor/8968e32ea09be0994799e017dbaf14422ff7afe2/sql-processor/src/test/java/org/sqlproc/engine/impl/TestStandardParameters.java/left.java
            "dbunit/TypesTest_db2.xml"
=======
            "dbunit/TypesTest_mssql.xml"
>>>>>>> /usr/src/app/output/hudec/sql-processor/8968e32ea09be0994799e017dbaf14422ff7afe2/sql-processor/src/test/java/org/sqlproc/engine/impl/TestStandardParameters.java/right.java
            ;
          } else {
  ...
  @Test public void testStandardParameters() throws SQLException, ParseException {
    SqlQueryEngine sqlEngine = getSqlEngine("STANDARD_PARAMETERS");
    ...
    if (!"oracle".equalsIgnoreCase(dbType) && !"postgresql".equalsIgnoreCase(dbType) && !"mssql".equalsIgnoreCase(dbType)) {
    ...
    List<TypesTransport> list = sqlEngine.query(session, TypesTransport.class, criteria, null, SqlQueryEngine.NO_ORDER, 0, 0, 0);
    ...
    if ("mysql".equalsIgnoreCase(dbType)) {
      ...
      if ("hsqldb".equalsIgnoreCase(dbType) || "postgresql".equalsIgnoreCase(dbType) || "db2".equalsIgnoreCase(dbType)) {
  ...
  @Test public void testFromToParameters() throws SQLException, ParseException {
    SqlQueryEngine sqlEngine = getSqlEngine("FROM_TO_PARAMETERS");
    TypesTransport criteria = new TypesTransport();
    criteria.setT_datetime(SqlUtils.getDateTime(2009, 7, 31, 15, 55, 2));
