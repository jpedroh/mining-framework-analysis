...
public class BitmapTriples implements TriplesPrivate {
  ...
  public void load(IteratorTripleID it, ProgressListener listener) {
    ...
    @SuppressWarnings(value = { "resource" }) SequenceLog64 vectorY = new SequenceLog64(BitUtil.log2(number), number);
    @SuppressWarnings(value = { "resource" }) SequenceLog64 vectorZ = new SequenceLog64(BitUtil.log2(number), number);
  ...
  @Override public void load(TempTriples triples, ProgressListener listener) {
  ...
  @Override public IteratorTripleID searchAll() {
  ...
  @Override public void load(InputStream input, ControlInfo ci, ProgressListener listener) throws IOException {
  ...
  @Override public void mapFromFile(CountInputStream input, File f, ProgressListener listener) throws IOException {
  ...
  private void createIndexObjectMemoryEfficient() {
    ...
    @SuppressWarnings(value = { "resource" }) SequenceLog64 objectCount = new SequenceLog64(BitUtil.log2(seqZ.getNumberOfElements()), numReservedObjects, true);
  ...
  @SuppressWarnings(value = { "unused" }) private void createIndexObjects() {
    class Pair {
      int valueY;
  ...
  @Override public void generateIndex(ProgressListener listener) {
    predicateIndex = new PredicateIndexArray(this);
    predicateIndex.generate(listener);
    createIndexObjectMemoryEfficient();
  }

  @Override public void populateHeader(Header header, String rootNode) {
  ...
  @Override public void saveIndex(OutputStream output, ControlInfo ci, ProgressListener listener) throws IOException {
    IntermediateListener iListener = new IntermediateListener(listener);
    ci.clear();
  ...
  @Override public void loadIndex(InputStream input, ControlInfo ci, ProgressListener listener) throws IOException {
    IntermediateListener iListener = new IntermediateListener(listener);
  ...
  @Override public void mapIndex(CountInputStream input, File f, ControlInfo ci, ProgressListener listener) throws IOException {
    IntermediateListener iListener = new IntermediateListener(listener);
    if (ci.getType() != ControlInfo.Type.INDEX) {
      throw new IllegalFormatException("Trying to read an Index Section but it was not an Index.");
    }
