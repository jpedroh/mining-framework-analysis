...
public class CRC32 implements CRC {
  ...
  @Override public int compareTo(CRC o) {
    if (o instanceof CRC32) {
      return ((CRC32) o).crc32 - this.crc32;
    }
