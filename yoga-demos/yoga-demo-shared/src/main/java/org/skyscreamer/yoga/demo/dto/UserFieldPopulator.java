 ...
 */
@Service public class UserFieldPopulator implements FieldPopulator<User> {
  @Autowired GenericDao _genericDao;

  @Override public void addExtraFields(Selector selector, User model, ResultTraverser traverser, HierarchicalModel output) {
