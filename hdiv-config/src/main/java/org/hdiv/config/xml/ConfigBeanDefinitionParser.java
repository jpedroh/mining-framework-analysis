...
public class ConfigBeanDefinitionParser implements BeanDefinitionParser {
  ...
  public BeanDefinition parse(Element element, ParserContext parserContext) {
    ...
    this.uidGeneratorRef = this.createSimpleBean(element, source, parserContext, RandomGuidUidGenerator.class, UidGenerator.class.getName());
  ...
  protected RuntimeBeanReference createDefaultEditableDataValidationProvider(Element element, Object source, ParserContext parserContext) {
          ...
          if (node.getLocalName().equalsIgnoreCase("startParameters")) {
            ...
            if (node.getLocalName().equalsIgnoreCase("paramsWithoutValidation")) {
              ...
              if (node.getLocalName().equalsIgnoreCase("sessionExpired")) {
                ...
                if (node.getLocalName().equalsIgnoreCase("longLivingPages")) {
