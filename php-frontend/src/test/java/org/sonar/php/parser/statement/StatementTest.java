...
<<<<<<< /usr/src/app/output/sonarcommunity/sonar-php/2b1240c2482c763e1523e38661bc8f5c5194763c/php-frontend/src/test/java/org/sonar/php/parser/statement/StatementTest.java/left.java
      ...
      .matches("null();")
    ;
||||||| /usr/src/app/output/sonarcommunity/sonar-php/2b1240c2482c763e1523e38661bc8f5c5194763c/php-frontend/src/test/java/org/sonar/php/parser/statement/StatementTest.java/base.java
    .matches("{}")
    .matches("label:")
    .matches("if ($a): endif;")
    .matches("while($a) {}")
