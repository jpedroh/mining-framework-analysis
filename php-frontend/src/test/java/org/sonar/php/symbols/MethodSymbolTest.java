...
public class MethodSymbolTest {
  ...
  @Test public void simple_method() {
  ...
  @Test public void method_in_anonymous_class() {
  ...
  @Test public void isOverriding_by_super_classes() {
    Map<String, ClassSymbol> classes = parseMultipleClasses("<?php", "class A { function foo() {} }", "class B extends X { function foo() {} }", "class A1 extends A { function foo() {} function bar() {} }", "class A2 extends A { }", "class A21 extends A2 { function foo() {} }", "class C { function __construct() {} }", "class C1 extends C { function __construct() {} }");
...
=======
  @Test public void isOverriding() {
    Tree ast = parse("<?php", "class A { function foo() {} }", "class B extends X { function foo() {} }", "class A1 extends A { function foo() {} function bar() {} }", "class A2 extends A { }", "class A21 extends A2 { function foo() {} }", "class C { function __construct() {} }", "class C1 extends C { function __construct() {} }");
    Map<String, ClassSymbol> classes = TreeUtils.descendants(ast, ClassDeclarationTreeImpl.class).collect(Collectors.toMap((c) -> c.name().text(), ClassDeclarationTreeImpl::symbol));
    assertThat(classes.get("A").getDeclaredMethod("foo").isOverriding()).isEqualTo(Trilean.FALSE);
    assertThat(classes.get("B").getDeclaredMethod("foo").isOverriding()).isEqualTo(Trilean.UNKNOWN);
    assertThat(classes.get("A1").getDeclaredMethod("foo").isOverriding()).isEqualTo(Trilean.TRUE);
    assertThat(classes.get("A1").getDeclaredMethod("bar").isOverriding()).isEqualTo(Trilean.FALSE);
...
>>>>>>> /usr/src/app/output/sonarcommunity/sonar-php/2ebc3248b4cc888b29b2dc46de1ee82a9e5b281c/php-frontend/src/test/java/org/sonar/php/symbols/MethodSymbolTest.java/right.java
  ...
  @Test public void catch_dead_loop_in_isDeclaredInInterface() {
    Map<String, ClassSymbol> classes = parseMultipleClasses("<?php", "interface I1 extends I2 {}", "interface I2 extends I1 {}", "class C1 implements I1 {public function method1(){}}", "class C2 extends C3 {public function method2(){}}", "class C3 extends C2 {}");
  ...
  @Test public void private_method_does_not_override() {
    Map<String, ClassSymbol> classes = parseMultipleClasses("<?php", "class C1 {public function method1(){}}", "class C2 extends C1 {private function method1(){}}");
    assertThat(classes.get("C2").getDeclaredMethod("method1").isOverriding()).isEqualTo(Trilean.FALSE);
  }

  @Test public void private_method_can_not_be_overridden() {
    Map<String, ClassSymbol> classes = parseMultipleClasses("<?php", "class C1 {private function method1(){}}", "class C2 extends C1 {public function method1(){}}");
    assertThat(classes.get("C2").getDeclaredMethod("method1").isOverriding()).isEqualTo(Trilean.FALSE);
  }

  private Map<String, ClassSymbol> parseMultipleClasses(String... lines) {
    Tree ast = parse(lines);
    return TreeUtils.descendants(ast, ClassDeclarationTreeImpl.class).collect(Collectors.toMap((c) -> c.name().text(), ClassDeclarationTreeImpl::symbol));
  }
