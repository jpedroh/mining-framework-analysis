...
public class ControlFlowGraphTest extends PHPTreeModelTest {
  @org.junit.Rule public LogTester logTester = new LogTester();
  ...
  @Test public void different_statements() {
  ...
  @Test public void not_remove_empty_with_many_successors() {
    ControlFlowGraph cfg = cfgForBlock("" + "try {" + "  tryBody( succ = [catchBody] );" + "  throw $e;" + "} catch (Type $e) {" + "  catchBody1( succ = [finallyBody] );" + "}");
  ...
  @Test public void replace_empty_start() {
    ControlFlowGraph cfg = cfgForBlock("" + "foreach($x as $y) {" + "  return $y;" + "}");
    assertThat(cfg.blocks()).contains(cfg.start());
    assertThat(cfg.start().elements()).isNotEmpty();
  }

  @Test public void infinite_for() throws Exception {
    ControlFlowGraph cfg = cfgForBlock("" + "for(;;) {" + " " + "}");
  ...
  @Test public void try_catch() {
    ControlFlowGraph actualCfg = cfgForBlock("" + "try {" + "  tryBody( succ = [catchBody, _empty] );" + "} catch(Exception $e) {" + "  catchBody( succ = [_empty] );" + "}" + "after( succ = [END]);");
    ExpectedCfgStructure expectedCfgStructure = ExpectedCfgStructure.parse(actualCfg.blocks(), (expected) -> {
      expected.createEmptyBlockExpectation().withPredecessorIds("tryBody", "catchBody").withSuccessorsIds("after", "END");
      return expected;
    });
    new Validator(expectedCfgStructure).assertCfg(actualCfg);
  }

  @Test public void try_return_finally() {
  ...
  @Test public void try_return_catch() {
    ControlFlowGraph actualCfg = cfgForBlock("" + "try {" + "    tryBody(succ = [_empty], pred = [], syntSucc = _empty);" + "    return;" + "} catch (Exception $e) {" + "    catchBody(succ=[_empty], pred = [_empty]);" + "}" + "after( succ = [END], pred = [_empty]);");
    ExpectedCfgStructure expectedCfgStructure = ExpectedCfgStructure.parse(actualCfg.blocks(), (expected) -> {
      expected.createEmptyBlockExpectation().withPredecessorIds("tryBody").withSuccessorsIds("catchBody", "_empty");
      expected.createEmptyBlockExpectation().withPredecessorIds("catchBody", "_empty").withSuccessorsIds("after", "END");
      return expected;
    });
    new Validator(expectedCfgStructure).assertCfg(actualCfg);
  }

  @Test public void try_return_catch_finally() {
    ControlFlowGraph actualCfg = cfgForBlock("" + "try {" + "    tryBody(succ = [_empty], syntSucc = _empty);" + "    return;" + "} catch (Exception $e) {" + "    catchBody1(succ=[finallyBody], pred = [_empty]);" + "} catch (Exception $e) {" + "    catchBody2(succ=[finallyBody], pred = [_empty]);" + "} finally {" + "   finallyBody(succ=[after,END], pred = [catchBody1,catchBody2,_empty]);" + "}" + "after(succ = [END], pred = [finallyBody]);");
    ExpectedCfgStructure expectedCfgStructure = ExpectedCfgStructure.parse(actualCfg.blocks(), (expected) -> {
      expected.createEmptyBlockExpectation().withPredecessorIds("tryBody").withSuccessorsIds("catchBody1", "catchBody2", "finallyBody");
      return expected;
    });
    new Validator(expectedCfgStructure).assertCfg(actualCfg);
  }

  @Test public void nested_try_return_catch_finally() {
    ControlFlowGraph actualCfg = cfgForBlock("" + "try { " + "    try {" + "        tryBody(succ = [_empty], syntSucc = _empty);" + "        return;" + "    } catch (Exception $e) {" + "        catchBody(succ=[finallyBody], pred = [_empty]);" + "    } finally {" + "        finallyBody(succ=[afterInnerTry, outerFinallyBody], pred = [catchBody,_empty]);" + "    }" + "    afterInnerTry(succ = [outerFinallyBody], pred = [finallyBody]);" + "} finally {" + "    outerFinallyBody(succ=[END], pred = [afterInnerTry, finallyBody]);" + "}");
    ExpectedCfgStructure expectedCfgStructure = ExpectedCfgStructure.parse(actualCfg.blocks(), (expected) -> {
      expected.createEmptyBlockExpectation().withPredecessorIds("tryBody").withSuccessorsIds("catchBody", "finallyBody");
      return expected;
    });
    new Validator(expectedCfgStructure).assertCfg(actualCfg);
  }

  @Test public void throw_outside_try() {
  ...
  @Test public void throw_inside_try_catch_finally() {
    ControlFlowGraph actualCfg = cfgForBlock("" + "try {" + "  tryBody( succ = [catchBody1], syntSucc = dead );" + "  throw $e;" + "  dead( succ = [catchBody1, catchBody2, finallyBody] );" + "} catch (Type1 $e) {" + "  catchBody1( succ = [END], syntSucc = finallyBody );" + "  throw $e;" + "} catch (Type2 $e) {" + "  catchBody2( succ = [finallyBody] );" + "} finally {" + "  finallyBody( succ = [END], syntSucc = _empty );" + "  throw $e;" + "}" + "after( succ = [END]);");
    ExpectedCfgStructure expectedCfgStructure = ExpectedCfgStructure.parse(actualCfg.blocks(), (expected) -> {
      expected.createEmptyBlockExpectation().withSuccessorsIds("after", "END");
      return expected;
    });
    new Validator(expectedCfgStructure).assertCfg(actualCfg);
  }

  @Test public void throw_inside_nested_try_catch_finally() {
    ControlFlowGraph actualCfg = cfgForBlock("" + "try {" + "  try {" + "    innerTryBody( succ = [catchBody1], syntSucc = dead );" + "    throw $e;" + "    dead( succ = [catchBody1, _empty]);" + "  } catch (Type $e) {" + "    catchBody1( succ = [_empty] );" + "  }" + "  outerTryBody( succ = [catchBody2, _empty] );" + "} catch (Type $e) {" + "  catchBody2( succ = [_empty] );" + "}");
    ExpectedCfgStructure expectedCfg = ExpectedCfgStructure.parse(actualCfg.blocks(), (expected) -> {
      expected.createEmptyBlockExpectation().withPredecessorIds("catchBody1", "dead").withSuccessorsIds("outerTryBody", "_empty");
      expected.createEmptyBlockExpectation().withPredecessorIds("outerTryBody", "catchBody2", "_empty").withSuccessorsIds("END");
      return expected;
    });
    new Validator(expectedCfg).assertCfg(actualCfg);
  }

  @Test public void return_stmt() {
  ...
  @Test public void break_without_argument() {
  ...
  @Test public void continue_without_argument() {
  ...
  @Test public void break_with_argument() {
    String breakInnerLoop = "" + "while (outerCond( succ = [innerCond, END] )) {" + "  while (innerCond( succ = [ifCond, outerCond] )) {" + "    if (ifCond( succ = [body, innerCond] )) {" + "      body( succ = [outerCond], syntSucc = innerCond );" + "      break %s;" + "    }" + "  }" + "}";
  ...
  @Test public void continue_with_argument() {
    String continueInnerLoop = "" + "while (outerCond( succ = [innerCond, END] )) {" + "  while (innerCond( succ = [ifCond, outerCond] )) {" + "    if (ifCond( succ = [body, innerCond] )) {" + "      body( succ = [innerCond], syntSucc = innerCond );" + "      continue %s;" + "    }" + "  }" + "}";
  ...
  @Test(expected = RecognitionException.class) public void break_unsupported_with_expression() {
    cfgForBlock("" + "while (cond) {" + "  break 2 - 1;" + "}");
  }

  @Test(expected = RecognitionException.class) public void break_outside_loop() {
    cfgForBlock("break 2;");
  }

  @Test(expected = RecognitionException.class) public void break_invalid_level() {
    cfgForBlock("" + "while (cond) {" + "  break 2;" + "}");
  }

  @Test(expected = RecognitionException.class) public void break_invalid_argument() {
    cfgForBlock("" + "while (cond) {" + "  break 2.1;" + "}");
  }

  @Test public void do_while() {
    verifyBlockCfg("" + "before( succ = [body] );" + "do {" + "  body( succ = [cond] );" + "} while (cond( succ = [body, after] ));" + "after( succ = [END] );");
  }

  @Test public void do_while_with_nested_if() {
  ...
  @Test public void while_with_nested_if() {
  ...
  @Test public void if_with_nested_while() {
  ...
  @Test public void test_start_is_first_block() {
    ControlFlowGraph cfg = cfgForBlock("" + "foo();" + "if (a) {" + "  $x = 1;" + "}");
  ...
  @Test public void test_branching_tree() {
    ControlFlowGraph cfg = cfgForBlock("" + "if (a) {" + "  qix();" + "}");
  ...
  @Test public void if_with_nested_for() {
  ...
  @Test public void if_with_nested_for_nested_do_while() {
  ...
  @Test public void simple_foreach() {
  ...
  @Test public void if_with_nested_foreach_nested_do_while() {
  ...
  @Test public void test_empty_block_removal() {
    ControlFlowGraph cfg = cfgForBlock("" + "if (a) {" + "  bar();" + "  if (b) {" + "    qix();" + "  }" + "}");
    assertThat(cfg.end().predecessors()).hasSize(3);
  }

  @Test public void test_with_script_tree() {
  ...
  @Test public void if_elseif_else() {
  ...
  @Test public void if_elseif_with_nested_while() {
  ...
  @Test public void switch_statement_with_default() {
    verifyBlockCfg("" + "before(succ = [default_]);" + "switch ($expr) {" + "    default: " + "        default_(succ = [after]);" + "}" + "after(succ = [END]);");
  }

  @Test public void switch_statement_with_default_and_case() {
  ...
  @Test public void switch_statement_with_default_first() {
  ...
  @Test public void switch_statement_case_without_body() {
  ...
  @Test public void switch_with_case_using_same_block_as_default() throws Exception {
  ...
  @Test public void multiple_gotos_to_same_label() {
  ...
  @Test public void goto_nested_one_level() {
  ...
  @Test public void goto_nested_two_levels() {
  ...
  @Test public void switch_with_break() {
  ...
  @Test public void switch_statement_with_default_first_break() {
  ...
  @Test public void switch_statement_with_loop_and_continue() {
  ...
  @Test public void switch_for_break() {
  ...
  @Test public void test_buildCFG() {
    CompilationUnitTree tree = parse("<?php " + "function foo() {" + "    $expr = function() {echo \'Hello\';};" + "}" + "echo \'Hello\';", PHPLexicalGrammar.COMPILATION_UNIT);
  ...
  @Test public void test_buildCFG_with_method() {
    CompilationUnitTree tree = parse("<?php " + "class A {" + "    function foo() {" + "        echo \'Hello\';" + "    }" + "    abstract function bar();" + "}", PHPLexicalGrammar.COMPILATION_UNIT);
  ...
  @Test public void while_try_break_finally() {
  ...
  @Test public void while_try_continue_finally() {
  ...
  @Test public void while_try_break_catch() {
    ControlFlowGraph actualCfg = cfgForBlock("" + "while (cond(succ=[tryBody, after])) {" + "   try {" + "      tryBody(succ=[_empty], syntSucc=_empty);" + "      break;" + "   } catch (Exception $e) {" + "      catchBody(succ = [_empty]);" + "  }" + "  afterTry(succ = [cond]);" + "}" + "after(succ=[END]);");
    ExpectedCfgStructure expectedCfgStructure = ExpectedCfgStructure.parse(actualCfg.blocks(), (expected) -> {
      expected.createEmptyBlockExpectation().withPredecessorIds("tryBody").withSuccessorsIds("catchBody", "_empty");
      expected.createEmptyBlockExpectation().withPredecessorIds("catchBody", "_empty").withSuccessorsIds("afterTry", "END");
      return expected;
    });
    new Validator(expectedCfgStructure).assertCfg(actualCfg);
  }

  @Test public void while_try_continue_catch() {
    ControlFlowGraph actualCfg = cfgForBlock("" + "while (cond(succ=[tryBody, after])) {" + "   try {" + "      tryBody(succ=[_empty], syntSucc=_empty);" + "      continue;" + "   } catch (Exception $e) {" + "      catchBody(succ = [_empty]);" + "  }" + "}" + "after(succ=[END]);");
    ExpectedCfgStructure expectedCfgStructure = ExpectedCfgStructure.parse(actualCfg.blocks(), (expected) -> {
      expected.createEmptyBlockExpectation().withPredecessorIds("tryBody").withSuccessorsIds("catchBody", "_empty");
      expected.createEmptyBlockExpectation().withPredecessorIds("catchBody", "_empty").withSuccessorsIds("cond", "END");
      return expected;
    });
    new Validator(expectedCfgStructure).assertCfg(actualCfg);
  }

  @Test public void while_try_break_catch_finally() {
    ControlFlowGraph actualCfg = cfgForBlock("" + "while (cond(succ=[tryBody, after])) {" + "   try {" + "      tryBody(succ=[_empty], syntSucc=_empty);" + "      break;" + "   } catch (Exception $e) {" + "      catchBody(succ = [finallyBody]);" + "  } finally {" + "      finallyBody(succ = [cond, END]);" + "  }" + "}" + "after(succ=[END]);");
    ExpectedCfgStructure expectedCfgStructure = ExpectedCfgStructure.parse(actualCfg.blocks(), (expected) -> {
      expected.createEmptyBlockExpectation().withPredecessorIds("tryBody").withSuccessorsIds("catchBody", "finallyBody");
      return expected;
    });
  ...
  @Test public void test_cfg_failure_logs() {
    CompilationUnitTree tree = parse("<?php\n" + "function foo() {\n" + "     break;\n" + "}\n", PHPLexicalGrammar.COMPILATION_UNIT);
    FunctionDeclarationTree func = (FunctionDeclarationTree) tree.script().statements().get(0);
  ...
  @Test public void test_block_tostring() {
    ControlFlowGraph cfg = cfgForBlock("" + "label: " + "    $i++;");
  ...
  @Test public void test_cfg_build_for_catch_block_only() {
    CatchBlockTree block = parse("" + "catch (Exception $e) {" + " echo $e->message();" + "}", PHPLexicalGrammar.CATCH_BLOCK);
    ControlFlowGraph cfg = ControlFlowGraph.build(block, checkContext);
    assertThat(cfg).isNotNull();
    assertThat(cfg.start().toString()).isEqualTo("echo $e->message();");
  }

  @Test public void test_cfg_build_for_foreach_block_only() {
    ForEachStatementTree block = parse("" + "foreach ($array as $item) {" + " echo $item;" + "}", PHPLexicalGrammar.FOREACH_STATEMENT);
    ControlFlowGraph cfg = ControlFlowGraph.build(block, checkContext);
    assertThat(cfg).isNotNull();
