...
public class MediaModuleParser implements ModuleParser {
  ...
  @Override public Module parse(final Element mmRoot, final Locale locale) {
        ...
        if (mc != null) {
          ...
          if (expression != null) {
            if (expression.equalsIgnoreCase("full")) {
              ...
              if (expression.equalsIgnoreCase("sample")) {
                mc.setExpression(Expression.SAMPLE);
              } else {
                if (expression.equalsIgnoreCase("nonstop")) {
      ...
      for (int i = 0; i < restrictions.size(); i++) {
        ...
        if (r.getAttributeValue("type") != null) {
          if (r.getAttributeValue("type").equalsIgnoreCase("uri")) {
            ...
            if (r.getAttributeValue("type").equalsIgnoreCase("country")) {
        ...
        if (r.getAttributeValue("relationship").equalsIgnoreCase("allow")) {
          ...
          if (r.getAttributeValue("relationship").equalsIgnoreCase("deny")) {
  ...
  private void parseRestrictions(final Element e, final Metadata md) {
    ...
    for (int i = 0; i < restrictions.size(); i++) {
      ...
      if (r.getAttributeValue("type").equalsIgnoreCase(Restriction.Type.URI.toString())) {
        ...
        if (r.getAttributeValue("type").equalsIgnoreCase(Restriction.Type.COUNTRY.toString())) {
          type = Restriction.Type.COUNTRY;
        } else {
          if (r.getAttributeValue("type").equalsIgnoreCase(Restriction.Type.SHARING.toString())) {
