...
class MethodMapper {
  ...
  public void prepare(MappingManager manager, PreparedStatement ps) {
    ...
    if (ps.getVariables().size() != method.getParameterTypes().length) {
      throw new IllegalArgumentException(String.format("The number of arguments for method %s (%d) does not match the number of bind parameters in the @Query (%d)", method.getName(), method.getParameterTypes().length, ps.getVariables().size()));
    }
  ...
  @SuppressWarnings(value = { "rawtypes" }) private void mapType(MappingManager manager, Class<?> fullReturnType, Type type) {
  ...
  public Object invoke(Object[] args) {
    ...
    if (async) {
      ...
      return mapOne ? Futures.transform(future, returnMapper.mapOneFunction) : Futures.transform(future, returnMapper.mapAllFunction);
    } else {
  ...
  static class UDTParamMapper<V extends java.lang.Object> extends ParamMapper {
    ...
    @Override void setValue(BoundStatement boundStatement, Object arg, ProtocolVersion protocolVersion) {
      @SuppressWarnings(value = { "unchecked" }) V entity = (V) arg;
      super.setValue(boundStatement, udtMapper.toUDT(entity), protocolVersion);
    }
  }

  static class UDTListParamMapper<V extends java.lang.Object> extends ParamMapper {
    ...
    @Override void setValue(BoundStatement boundStatement, Object arg, ProtocolVersion protocolVersion) {
      @SuppressWarnings(value = { "unchecked" }) List<V> entities = (List<V>) arg;
      super.setValue(boundStatement, valueMapper.toUDTValues(entities), protocolVersion);
    }
  }

  static class UDTSetParamMapper<V extends java.lang.Object> extends ParamMapper {
    private final UDTMapper<V> valueMapper;
    ...
    @Override void setValue(BoundStatement boundStatement, Object arg, ProtocolVersion protocolVersion) {
      @SuppressWarnings(value = { "unchecked" }) Set<V> entities = (Set<V>) arg;
      super.setValue(boundStatement, valueMapper.toUDTValues(entities), protocolVersion);
    }
  }

  static class UDTMapParamMapper<K extends java.lang.Object, V extends java.lang.Object> extends ParamMapper {
    ...
    @Override void setValue(BoundStatement boundStatement, Object arg, ProtocolVersion protocolVersion) {
      @SuppressWarnings(value = { "unchecked" }) Map<K, V> entities = (Map<K, V>) arg;
  ...
  static class EnumParamMapper extends ParamMapper {
    ...
    @SuppressWarnings(value = { "rawtypes" }) private Object convert(Object arg) {
      switch (enumType) {
        case STRING:
        return arg.toString();
        case ORDINAL:
