 ...
 * </p>
 */
public class UDTMapper<T extends java.lang.Object> {
  ...
  public T fromUDT(UDTValue v) {
    if (!v.getType().equals(userType)) {
      String message = String.format("UDT conversion mismatch: expected type %s, got %s", userType, v.getType());
  ...
  static <K extends java.lang.Object, V extends java.lang.Object> Map<Object, Object> toUDTValues(Map<K, V> entities, UDTMapper<K> keyMapper, UDTMapper<V> valueMapper) {
  ...
  @SuppressWarnings(value = { "unchecked" }) static <K extends java.lang.Object, V extends java.lang.Object> Map<K, V> toEntities(Map<Object, Object> udtValues, UDTMapper<K> keyMapper, UDTMapper<V> valueMapper) {
