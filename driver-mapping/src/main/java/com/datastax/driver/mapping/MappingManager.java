...
public class MappingManager {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> Mapper<T> mapper(Class<T> klass) {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> UDTMapper<T> udtMapper(Class<T> klass) {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> T createAccessor(Class<T> klass) {
    return getAccessor(klass);
  }

  @SuppressWarnings(value = { "unchecked" }) private <T extends java.lang.Object> Mapper<T> getMapper(Class<T> klass) {
  ...
  @SuppressWarnings(value = { "unchecked" }) <T extends java.lang.Object> UDTMapper<T> getUDTMapper(Class<T> klass) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private <T extends java.lang.Object> T getAccessor(Class<T> klass) {
