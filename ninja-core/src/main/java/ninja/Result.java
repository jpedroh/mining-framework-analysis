...
public class Result {
  ...
  @Deprecated public static final String APPLICATON_JSON = APPLICATION_JSON;

  public static final String APPLICATION_JSONP = "application/javascript";

  @Deprecated public static final String APPLICATON_JSONP = APPLICATION_JSONP;
  ...
  /**
     ...
     * the box.
     */
  private final static List<String> DEFAULT_SUPPORTED_CONTENT_TYPES = ImmutableList.of(TEXT_HTML, APPLICATION_JSON, APPLICATION_XML);
  ...
  /**
     ...
     */
  @Deprecated public Result renderRaw(final String string) {
