...
public class NinjaDefault implements Ninja {
  ...
  @Override public void onRouteRequest(Context.Impl context) {
  ...
  @Override public void onFrameworkStart() {
    showSplashScreenViaLogger();
    lifecycleService.start();
  }

  @Override public void onFrameworkShutdown() {
    lifecycleService.stop();
  }

  @Override public Result onException(Context context, Exception exception) {
