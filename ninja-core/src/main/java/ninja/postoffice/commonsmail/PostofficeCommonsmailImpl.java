...
public class PostofficeCommonsmailImpl implements Postoffice {
  ...
  @Inject public PostofficeCommonsmailImpl(CommonsmailHelper commonsmailHelper, NinjaProperties props) {
  ...
  @Override public void send(Mail mail) throws EmailException, AddressException {
