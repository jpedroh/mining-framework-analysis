...
public class ContextImpl implements Context {
  ...
  @Inject public ContextImpl(BodyParserEngineManager bodyParserEngineManager, FlashCookie flashCookie, SessionCookie sessionCookie, TemplateEngineManager templateEngineManager) {
