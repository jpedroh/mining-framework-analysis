...
public class ContextImpl implements Context {
  ...
  @Inject public ContextImpl(BodyParserEngineManager bodyParserEngineManager, FlashCookie flashCookie, Router router, SessionCookie sessionCookie, TemplateEngineManager templateEngineManager) {
  ...
  @Override public String getPathParameter(String key) {
    Route route = router.getRouteFor(httpServletRequest.getMethod(), httpServletRequest.getServletPath());
