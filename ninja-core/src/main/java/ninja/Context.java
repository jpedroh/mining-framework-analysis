...
public interface Context {
  ...
  /**
     ...
     * @return The value of the parameter or null if not found.
     */
  <T extends java.lang.Object> T getParameterAs(String name, Class<T> clazz);
  ...
  /**
     ...
     * @return The value of the parameter of the defaultValue if not found.
     */
  <T extends java.lang.Object> T getParameterAs(String name, Class<T> clazz, T defaultValue);
  ...
  /**
     ...
     *         error.
     */
  @Deprecated FileItemIterator getFileItemIterator();
  ...
  /**
     ...
     *         not exist
     */
  <T extends java.lang.Object> T getAttribute(String name, Class<T> clazz);
