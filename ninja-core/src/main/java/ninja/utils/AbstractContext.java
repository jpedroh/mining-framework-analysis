...
abstract public class AbstractContext implements Context.Impl {
  ...
  @Inject public AbstractContext(BodyParserEngineManager bodyParserEngineManager, FlashScope flashScope, NinjaProperties ninjaProperties, Session session, Validation validation, Injector injector) {
  ...
  @Deprecated @Override public FlashScope getFlashCookie() {
    return flashScope;
  }
  ...
  @Deprecated @Override public Session getSessionCookie() {
    return session;
  }
