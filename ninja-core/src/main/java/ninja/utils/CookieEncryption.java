 ...
 */
@Singleton public class CookieEncryption {
  ...
  @Inject public CookieEncryption(NinjaProperties properties) {
    ...
    if (properties.getBooleanWithDefault(NinjaConstant.applicationCookieEncrypted, false)) {
      ...
      try {
        ...
        secretKeySpec = Optional.of(new SecretKeySpec(secret.getBytes(), 0, maxKeyLengthBits / Byte.SIZE, ALGORITHM));
