...
@RunWith(value = MockitoJUnitRunner.class) public class RouterImplTest {
  ...
  @Test public void testGetReverseRouteWithNoContextPathWorks() {
    String contextPath = "";
  ...
  @Test public void testGetReverseRouteContextPathWorks() {
  ...
  @Test public void testGetReverseRouteWithRegexWorks() {
    String contextPath = "";
    when(ninjaProperties.getContextPath()).thenReturn(contextPath);
  ...
  @Test public void testGetReverseRouteWithRegexAndQueryParametersWorks() {
    String contextPath = "";
    when(ninjaProperties.getContextPath()).thenReturn(contextPath);
  ...
  @Test public void testGetReverseRouteWithMultipleRegexWorks() {
    String contextPath = "";
    when(ninjaProperties.getContextPath()).thenReturn(contextPath);
  ...
  @Test public void testRedirectResultNotShared() {
    String contextPath = "";
    when(ninjaProperties.getContextPath()).thenReturn(contextPath);
