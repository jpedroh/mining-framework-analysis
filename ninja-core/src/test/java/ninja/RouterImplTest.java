 ...
 */
@RunWith(value = MockitoJUnitRunner.class) public class RouterImplTest {
  Router router;
  ...
  @Mock Provider<TestController> testControllerProvider;

  @Before @SuppressWarnings(value = { "Convert2Lambda" }) public void before() {
    ...
    router.GET().route("/anonymous_class_annotations").with(new ControllerMethod1<Integer>() {
      @Override public Result apply(@Param(value = "status") Integer status) {
  ...
  @Test public void getReverseRouteWithNoContextPathWorks() {
    String contextPath = "";
  ...
  @Test public void getReverseRouteContextPathWorks() {
  ...
  @Test public void getReverseRouteWithRegexWorks() {
    String contextPath = "";
    when(ninjaProperties.getContextPath()).thenReturn(contextPath);
  ...
  @Test public void getReverseRouteWithRegexAndQueryParametersWorks() {
    String contextPath = "";
    when(ninjaProperties.getContextPath()).thenReturn(contextPath);
  ...
  @Test public void getReverseRouteWithMultipleRegexWorks() {
    String contextPath = "";
    when(ninjaProperties.getContextPath()).thenReturn(contextPath);
  ...
  @Test public void getReverseRouteWithMethodReference() {
    String contextPath = "";
    when(ninjaProperties.getContextPath()).thenReturn(contextPath);
  ...
  @Test public void routeForAnyInstanceMethodReference() {
  ...
  @Test public void routeForAnyInstanceMethodReferenceThrowsException() {
  ...
  @Test public void routeForAnyInstanceMethodReference2() {
    Route route = router.getRouteFor("GET", "/any_instance_method_ref2");
    Result result = route.getFilterChain().next(null);
    assertThat(result.getStatusCode(), is(201));
  }

  @Test public void routeForSpecificInstanceMethodReference() {
    Route route = router.getRouteFor("GET", "/specific_instance_method_ref");
    Result result = route.getFilterChain().next(null);
    assertThat(result.getRenderable(), is("Hi!"));
  }

  @Test public void routeForSpecificInstanceMethodReferenceWithAnnotations() {
  ...
  @Test public void routeForAnonymoumsMethodReference() {
    Route route = router.getRouteFor("GET", "/anonymous_method_ref");
    Result result = route.getFilterChain().next(null);
    assertThat(result.getStatusCode(), is(202));
  }

  @Test public void routeForAnonymoumsMethodReferenceWithCaptured() {
    Context context = mock(Context.class);
  ...
  @Test public void routeForAnonymoumsMethodReferenceWithContext() {
    Context context = mock(Context.class);
  ...
  @Test public void routeForAnonymoumsClassInstance() {
    Route route = router.getRouteFor("GET", "/anonymous_class");
    Result result = route.getFilterChain().next(null);
    assertThat(result.getStatusCode(), is(203));
  }

  @Test public void routeForAnonymoumsClassInstanceWithAnnotations() {
    Context context = mock(Context.class);
  ...
  public static class TestController {
    ...
    public Result status(@Param(value = "status") Integer status) {
