...
@RunWith(value = MockitoJUnitRunner.class) public class RouteBuilderImplTest {
  @Mock Injector injector;

  @Mock NinjaProperties ninjaProperties;

  @Test public void basicGETRoute() {
  ...
  @Test public void basicPlaceholersAndParameters() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
  ...
  @Test public void basicPlaceholersParametersAndRegex() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
  ...
  @Test public void basicPlaceholersParametersAndRegexInsideVariableParts() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
  ...
  @Test public void parametersDontCrossSlashes() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
  ...
  @Test public void pointsInRegexDontCrashRegexInTheMiddleOfTheRoute() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
  ...
  @Test public void pointsInRegexDontCrashRegexAtEnd() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
  ...
  @Test public void regexInRouteWorksWithEscapes() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
  ...
  @Test public void regexInRouteWorksWithoutSlashAtTheEnd() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
    routeBuilder.GET().route("/blah/{id}/.*");
    Route route = buildRoute(routeBuilder);
  ...
  @Test public void routeWithUrlEncodedSlashGetsChoppedCorrectly() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
    routeBuilder.GET().route("/blah/{id}/.*");
    Route route = buildRoute(routeBuilder);
  ...
  @Test public void routeWithResult() {
  ...
  @Test public void failedControllerRegistration() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
  ...
  @Test public void routeWithMethodReference() throws Exception {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
  ...
  @Test public void routeToAnyInstanceMethodReference() throws Exception {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
  ...
  @Test public void routeToSpecificInstanceMethodReference() throws Exception {
  ...
  @Test public void routeToStaticMethodReference() throws Exception {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
  ...
  @Test @SuppressWarnings(value = { "Convert2Lambda" }) public void routeToAnonymousClassReference() throws Exception {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
    routeBuilder.GET().route("/execute").with(new ControllerMethods.ControllerMethod0() {
      @Override public Result apply() {
  ...
  @Test public void routeToAnonymousMethodReference() throws Exception {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl(ninjaProperties);
