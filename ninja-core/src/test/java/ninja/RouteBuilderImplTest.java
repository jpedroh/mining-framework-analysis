...
@RunWith(value = MockitoJUnitRunner.class) public class RouteBuilderImplTest {
  ...
  @Test public void testBasicPlaceholersParametersAndRegexInsideVariableParts() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl();
  ...
  @Test public void testRegexInRouteWorksWithEscapes() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl();
  ...
  @Test public void testFailedControllerRegistration() {
    RouteBuilderImpl routeBuilder = new RouteBuilderImpl();
