 ...
 */
@RunWith(value = MockitoJUnitRunner.class) public class ControllerMethodInvokerTest {
  @Mock private MockController mockController;
  ...
  @Test public void headerAnnotatedArgumentShouldBePassed() throws Exception {
  ...
  @Test public void headerAnnotatedArgumentShouldHandleNull() throws Exception {
    when(context.getHeader("param1")).thenReturn(null);
    create("header").invoke(mockController, context);
    verify(mockController).header(null);
  }

  @Test public void headersAnnotatedArgumentShouldReturnNull() throws Exception {
  ...
  @Test public void headersAnnotatedArgumentShouldBePassed() throws Exception {
    when(context.getHeaders("param1")).thenReturn(Arrays.asList("a", "b", "c"));
    create("headers").invoke(mockController, context);
    verify(mockController).headers(new String[] { "a", "b", "c" });
  }

  @Test public void headersAnnotatedArgumentShouldHandleNull() throws Exception {
    when(context.getHeader("param1")).thenReturn(null);
    create("headers").invoke(mockController, context);
    verify(mockController).headers(null);
  }
  ...
  @Test public void shortParamShouldBeParsedToShort() throws Exception {
    when(context.getParameter("param1")).thenReturn("20");
    create("shortParam").invoke(mockController, context);
    verify(mockController).shortParam((short) 20);
  }

  @Test public void shortParamShouldHandleNull() throws Exception {
    create("shortParam").invoke(mockController, context);
    verify(mockController).shortParam(null);
    assertFalse(validation.hasViolations());
  }

  @Test public void shortValidationShouldWork() throws Exception {
    when(context.getParameter("param1")).thenReturn("blah");
    create("shortParam").invoke(mockController, context);
    verify(mockController).shortParam(null);
    assertTrue(validation.hasFieldViolation("param1"));
  ...
  @Test public void primShortParamShouldBeParsedToShort() throws Exception {
    when(context.getParameter("param1")).thenReturn("20");
    create("primShortParam").invoke(mockController, context);
    verify(mockController).primShortParam((short) 20);
  }

  @Test public void primShortParamShouldHandleNull() throws Exception {
    create("primShortParam").invoke(mockController, context);
    verify(mockController).primShortParam((short) 0);
    assertFalse(validation.hasViolations());
  }

  @Test public void primShortValidationShouldWork() throws Exception {
    when(context.getParameter("param1")).thenReturn("blah");
    create("primShortParam").invoke(mockController, context);
    verify(mockController).primShortParam((short) 0);
    assertTrue(validation.hasFieldViolation("param1"));
  ...
  @Test public void characterParamShouldBeParsedToCharacter() throws Exception {
  ...
  @Test public void characterParamShouldHandleNull() throws Exception {
    create("characterParam").invoke(mockController, context);
    verify(mockController).characterParam(null);
    assertFalse(validation.hasViolations());
  }

  @Test public void charParamShouldBeParsedToCharacter() throws Exception {
    when(context.getParameter("param1")).thenReturn("ABC");
    create("charParam").invoke(mockController, context);
    verify(mockController).charParam('A');
  }

  @Test public void charParamShouldHandleNull() throws Exception {
    create("charParam").invoke(mockController, context);
    verify(mockController).charParam('\u0000');
    assertFalse(validation.hasViolations());
  }

  @Test public void byteParamShouldBeParsedToByte() throws Exception {
    when(context.getParameter("param1")).thenReturn("20");
    create("byteParam").invoke(mockController, context);
    verify(mockController).byteParam((byte) 20);
  }

  @Test public void byteParamShouldHandleNull() throws Exception {
    create("byteParam").invoke(mockController, context);
    verify(mockController).byteParam(null);
    assertFalse(validation.hasViolations());
  }

  @Test public void byteValidationShouldWork() throws Exception {
    when(context.getParameter("param1")).thenReturn("blah");
    create("byteParam").invoke(mockController, context);
    verify(mockController).byteParam(null);
    assertTrue(validation.hasFieldViolation("param1"));
  ...
  @Test public void primByteParamShouldBeParsedToByte() throws Exception {
    when(context.getParameter("param1")).thenReturn("20");
    create("primByteParam").invoke(mockController, context);
    verify(mockController).primByteParam((byte) 20);
  }

  @Test public void primByteParamShouldHandleNull() throws Exception {
    create("primByteParam").invoke(mockController, context);
    verify(mockController).primByteParam((byte) 0);
    assertFalse(validation.hasViolations());
  }

  @Test public void primByteValidationShouldWork() throws Exception {
    when(context.getParameter("param1")).thenReturn("blah");
    create("primByteParam").invoke(mockController, context);
    verify(mockController).primByteParam((byte) 0);
    assertTrue(validation.hasFieldViolation("param1"));
  ...
  @Test public void enumParamShouldBeParsedToEnumCaseSensitive() throws Exception {
  ...
  @Test public void enumParamShouldBeParsedToEnumCaseInsensitive() throws Exception {
    when(context.getParameter("param1")).thenReturn("red");
    create("enumParam").invoke(mockController, context);
    verify(mockController).enumParam(Rainbow.Red);
  }

  @Test public void enumParamShouldHandleNull() throws Exception {
    create("enumParam").invoke(mockController, context);
    verify(mockController).enumParam(null);
    assertFalse(validation.hasViolations());
  }

  @Test public void enumParamValidationShouldWork() throws Exception {
    when(context.getParameter("param1")).thenReturn("blah");
    create("enumParam").invoke(mockController, context);
    verify(mockController).enumParam(null);
    assertTrue(validation.hasFieldViolation("param1"));
  ...
  @Test public void enumCsvParamSingleShouldBeParsed() throws Exception {
    when(context.getParameter("param1")).thenReturn("Red");
    create("enumCsvParam").invoke(mockController, context);
    verify(mockController).enumCsvParam(new Rainbow[] { Rainbow.Red });
  }

  @Test public void enumCsvParamMultipleShouldBeParsed() throws Exception {
  ...
  @Test public void enumCsvParamShouldReturnNull() throws Exception {
  ...
  @Test public void enumCsvParamValidationShouldWork() throws Exception {
  ...
  @Test public void enumArrayParamSingleShouldBeParsed() throws Exception {
  ...
  @Test public void enumArrayParamMultipleShouldBeParsed() throws Exception {
  ...
  @Test public void enumArrayParamShouldReturnNull() throws Exception {
  ...
  @Test public void enumArrayParamValidationShouldWork() throws Exception {
  ...
  @Test public void customDateFormatParamShouldBeParsedToDate() throws Exception {
  ...
  @Test public void customDateFormatParamWithOptionalShouldBeParsedToDate() throws Exception {
    when(context.getParameter("param1")).thenReturn("15/01/2015");
  ...
  @Test public void customDateFormatParamShouldHandleNull() throws Exception {
    create("dateParam", DateParamParser.class).invoke(mockController, context);
    verify(mockController).dateParam(null);
    assertFalse(validation.hasViolations());
  }

  @Test public void customDateFormatParamWithOptionalShouldHandleEmpty() throws Exception {
    create("dateParamWithOptional", DateParamParser.class).invoke(mockController, context);
    verify(mockController).dateParamWithOptional(Optional.empty());
    assertFalse(validation.hasViolations());
  }

  @Test public void customDateFormatValidationShouldWork() throws Exception {
    when(context.getParameter("param1")).thenReturn("blah");
    create("dateParam", DateParamParser.class).invoke(mockController, context);
    verify(mockController).dateParam(null);
    assertTrue(validation.hasFieldViolation("param1"));
  ...
  @Test(expected = RoutingException.class) public void needingInjectionParamParserNotBinded() throws Exception {
  ...
  @Test public void needingInjectionParamParser() throws Exception {
    when(context.getParameter("param1")).thenReturn("hello");
    create("needingInjectionParamParser", NeedingInjectionParamParser.class).invoke(mockController, context);
    verify(mockController).needingInjectionParamParser(new Dep("hello_hello"));
  }

  @Test public void needingInjectionParamParserArray() throws Exception {
  ...
  @Test public void customArgumentExtractorWithOptionalAndGuiceShouldBeInstantiated() {
  ...
  @Test public void optionalIntegerParamEmpty() {
    when(context.getParameter("param1")).thenReturn(null);
    create("optionalIntegerParam").invoke(mockController, context);
    verify(mockController).optionalIntegerParam(Optional.empty());
  }

  @Test(expected = BadRequestException.class) public void integerParamStrictModeWorks() {
    when(ninjaProperties.getBooleanWithDefault(NinjaConstant.NINJA_STRICT_ARGUMENT_EXTRACTORS, false)).thenReturn(true);
    when(context.getParameter("param1")).thenReturn(null);
    create("integerParam").invoke(mockController, context);
  }

  @Test public void optionalLongParam() {
    when(context.getParameter("param1")).thenReturn("1");
    create("optionalLongParam").invoke(mockController, context);
    verify(mockController).optionalLongParam(Optional.of(1L));
  }

  @Test public void optionalLongParamEmpty() {
    when(context.getParameter("param1")).thenReturn(null);
    create("optionalLongParam").invoke(mockController, context);
    verify(mockController).optionalLongParam(Optional.empty());
  }

  @Test(expected = BadRequestException.class) public void longParamEmptyStrictModeWorks() {
    when(ninjaProperties.getBooleanWithDefault(NinjaConstant.NINJA_STRICT_ARGUMENT_EXTRACTORS, false)).thenReturn(true);
    when(context.getParameter("param1")).thenReturn(null);
    create("longParam").invoke(mockController, context);
  }

  @Test public void optionalShortParam() {
    when(context.getParameter("param1")).thenReturn("1");
    create("optionalShortParam").invoke(mockController, context);
    verify(mockController).optionalShortParam(Optional.of(new Short("1")));
  }

  @Test public void optionalShortParamEmpty() {
    when(context.getParameter("param1")).thenReturn(null);
    create("optionalShortParam").invoke(mockController, context);
    verify(mockController).optionalShortParam(Optional.empty());
  }

  @Test(expected = BadRequestException.class) public void shortParamEmptyStrictModeWorks() {
    when(ninjaProperties.getBooleanWithDefault(NinjaConstant.NINJA_STRICT_ARGUMENT_EXTRACTORS, false)).thenReturn(true);
    when(context.getParameter("param1")).thenReturn(null);
    create("shortParam").invoke(mockController, context);
  }

  @Test public void optionalEnumParam() {
    when(context.getParameter("param1")).thenReturn("red");
    create("optionalEnumParam").invoke(mockController, context);
    verify(mockController).optionalEnumParam(Optional.of(Rainbow.Red));
  }

  @Test public void optionalEnumParamEmpty() {
    when(context.getParameter("param1")).thenReturn(null);
    create("optionalEnumParam").invoke(mockController, context);
    verify(mockController).optionalEnumParam(Optional.empty());
  }

  @Test(expected = BadRequestException.class) public void rainbowParamStrictModeWorks() {
    when(ninjaProperties.getBooleanWithDefault(NinjaConstant.NINJA_STRICT_ARGUMENT_EXTRACTORS, false)).thenReturn(true);
    when(context.getParameter("param1")).thenReturn(null);
    create("enumParam").invoke(mockController, context);
  }

  @Captor ArgumentCaptor<Optional<Rainbow[]>> argumentCaptor;

  @Test public void optionalEnumArrayParam() {
    when(context.getParameter("param1")).thenReturn("Red,Orange,Yellow");
  ...
  @Test public void optionalEnumArrayParamEmpty() {
    when(context.getParameter("param1")).thenReturn(null);
    create("optionalEnumArrayParam").invoke(mockController, context);
    verify(mockController).optionalEnumArrayParam(Optional.empty());
  }

  @Test(expected = BadRequestException.class) public void rainbowArrayParamEmptyStrictModeWorks() {
    when(ninjaProperties.getBooleanWithDefault(NinjaConstant.NINJA_STRICT_ARGUMENT_EXTRACTORS, false)).thenReturn(true);
    when(context.getParameter("param1")).thenReturn(null);
    create("enumArrayParam").invoke(mockController, context);
  }

  @Test public void optionalDateParam() {
    when(context.getParameter("param1")).thenReturn("15/01/2015");
  ...
  @Test public void optionalDateParamEmpty() {
    when(context.getParameter("param1")).thenReturn(null);
    create("optionalDateParam", DateParamParser.class).invoke(mockController, context);
    verify(mockController).optionalDateParam(Optional.empty());
  }

  @Test(expected = BadRequestException.class) public void dateParamStrictModeWorks() {
    when(ninjaProperties.getBooleanWithDefault(NinjaConstant.NINJA_STRICT_ARGUMENT_EXTRACTORS, false)).thenReturn(true);
    when(context.getParameter("param1")).thenReturn(null);
    create("dateParam", DateParamParser.class).invoke(mockController, context);
  }

  @Test public void optionalBody() {
  ...
  @Test public void optionalBodyEmpty() {
    when(context.parseBody(Object.class)).thenReturn(null);
    create("optionalBody").invoke(mockController, context);
    verify(mockController).optionalBody(Optional.empty());
  }

  @Test(expected = BadRequestException.class) public void bodyEmptyStrictModeWorks() {
    when(ninjaProperties.getBooleanWithDefault(NinjaConstant.NINJA_STRICT_ARGUMENT_EXTRACTORS, false)).thenReturn(true);
    when(context.parseBody(Object.class)).thenReturn(null);
  ...
  @Test public void validationWithOptionalShouldBeAppliedInCorrectOrderPreFail() {
  ...
  @Test public void validationWithOptionalShouldBeAppliedInCorrectOrderPostFail() {
    when(context.getParameter("param1")).thenReturn("5");
    create("requiredIntWithOptional").invoke(mockController, context);
  ...
  @Test public void validationWithOptionalShouldBeAppliedInCorrectOrderPass() {
    when(context.getParameter("param1")).thenReturn("20");
    create("requiredIntWithOptional").invoke(mockController, context);
  ...
  @Test(expected = RoutingException.class) public void invalidValidatorWithOptionalShouldBeFlagged() {
  ...
  @Test public void bodyWithOptionalShouldBeParsedIntoLeftOverParameter() {
    Object body = new Object();
    when(context.parseBody(Object.class)).thenReturn(body);
  ...
  @Test public void bodyWithOptionalShouldBeEmptyIfNoBodyPresent() {
    when(context.parseBody(Object.class)).thenReturn(null);
    create("bodyWithOptional").invoke(mockController, context);
  ...
  @Test public void validationWithOptionalPassed() {
  ...
  @Test public void validationWithOptionalFailedRegex() {
    validateJSR303WithOptional(buildDto("regex!!!", "length", 5));
    docheckValidationFailedRegex(context);
  }
  ...
  @Test public void validationWithOptionalFailedLength() {
  ...
  @Test public void validationWithOptionalFailedRange() {
  ...
  @Test public void validationFailedTranslationFr() {
    when(this.context.getAcceptLanguage()).thenReturn("fr");
    validateJSR303(buildDto("regex", "length - too long", 5));
    doCheckValidationFailedTranslationFr(context);
  }

  @Test public void validationWithOptionalFailedTranslationFr() {
    when(this.context.getAcceptLanguage()).thenReturn("fr");
    validateJSR303WithOptional(buildDto("regex", "length - too long", 5));
    doCheckValidationFailedTranslationFr(context);
  }
  ...
  @Test public void validationFailedTranslationEn() {
    when(this.context.getAcceptLanguage()).thenReturn("en");
    validateJSR303(buildDto("regex", "length - too long", 5));
    doCheckValidationFailedTranslationEn(context);
  }

  @Test public void validationWithOptionalFailedTranslationEn() {
    when(this.context.getAcceptLanguage()).thenReturn("en");
    validateJSR303WithOptional(buildDto("regex", "length - too long", 5));
    doCheckValidationFailedTranslationEn(context);
  }
  ...
  @Test public void validationWithOptionalFailedWithThreeFields() {
  ...
  @Test public void validationWithOptionalFailedWithTwoAnnotations() {
  ...
  public interface MockController {
    ...
    public Result param(@Param(value = "param1") String param1);

    public Result pathParam(@PathParam(value = "param1") String param1);

    public Result sessionParam(@SessionParam(value = "param1") String param1);

    public Result attribute(@Attribute(value = "param1") Dep param1);

    public Result header(@Header(value = "param1") String param1);

    public Result headers(@Headers(value = "param1") String[] param1);

    public Result integerParam(@Param(value = "param1") Integer param1);

    public Result intParam(@Param(value = "param1") int param1);

    public Result shortParam(@Param(value = "param1") Short param1);

    public Result primShortParam(@Param(value = "param1") short param1);

    public Result characterParam(@Param(value = "param1") Character param1);

    public Result charParam(@Param(value = "param1") char param1);

    public Result byteParam(@Param(value = "param1") Byte param1);

    public Result primByteParam(@Param(value = "param1") byte param1);

    public Result booleanParam(@Param(value = "param1") Boolean param1);

    public Result primBooleanParam(@Param(value = "param1") boolean param1);

    public Result longParam(@Param(value = "param1") Long param1);

    public Result primLongParam(@Param(value = "param1") long param1);

    public Result floatParam(@Param(value = "param1") Float param1);

    public Result primFloatParam(@Param(value = "param1") float param1);

    public Result doubleParam(@Param(value = "param1") Double param1);

    public Result primDoubleParam(@Param(value = "param1") double param1);

    public Result enumParam(@Param(value = "param1") Rainbow param1);

    public Result enumCsvParam(@Param(value = "param1") Rainbow[] param1);

    public Result enumArrayParam(@Params(value = "param1") Rainbow[] param1);
    ...
    public Result multiple(@Param(value = "param1") String param1, @PathParam(value = "param2") int param2, Context context, Session session);

    public Result required(@Param(value = "param1") @Required String param1);

    public Result optionalSessionParam(@SessionParam(value = "param1") Optional<String> param1);

    public Result optionalAttribute(@Attribute(value = "param1") Optional<Dep> param1);

    public Result optionalHeader(@Header(value = "param1") Optional<String> param1);

    public Result optionalHeaders(@Headers(value = "param1") Optional<String[]> param1);

    public Result optionalParam(@Param(value = "param1") Optional<String> param1);

    public Result optionalIntegerParam(@Param(value = "param1") Optional<Integer> param1);

    public Result optionalLongParam(@Param(value = "param1") Optional<Long> param1);

    public Result optionalShortParam(@Param(value = "param1") Optional<Short> param1);

    public Result optionalEnumParam(@Param(value = "param1") Optional<Rainbow> param1);

    public Result optionalEnumArrayParam(@Param(value = "param1") Optional<Rainbow[]> param1);

    public Result optionalDateParam(@Param(value = "param1") Optional<Date> param1);

    public Result optionalBody(Optional<Object> body);

    public Result requiredInt(@Param(value = "param1") @Required @NumberValue(min = 10) int param1);

    public Result requiredIntWithOptional(@Param(value = "param1") @Required @NumberValue(min = 10) Optional<Integer> param1);

    public Result badValidator(@Param(value = "param1") @NumberValue(min = 10) String param1);

    public Result badValidatorWithOptional(@Param(value = "param1") @NumberValue(min = 10) Optional<String> param1);
    ...
    public Result dateParam(@Param(value = "param1") Date param1);

    public Result dateParamWithOptional(@Param(value = "param1") Optional<Date> param1);

    public Result needingInjectionParamParser(@Param(value = "param1") Dep param1);

    public Result needingInjectionParamParserArray(@Params(value = "param1") Dep[] paramsArray);
  }

  @Retention(value = RetentionPolicy.RUNTIME) @Target(value = { ElementType.PARAMETER }) @WithArgumentExtractor(value = NoArgArgumentExtractor.class) public @interface NoArg {
  }

  @Retention(value = RetentionPolicy.RUNTIME) @Target(value = { ElementType.PARAMETER }) @WithArgumentExtractor(value = ClassArgArgumentExtractor.class) public @interface ClassArg {
  }

  @Retention(value = RetentionPolicy.RUNTIME) @Target(value = { ElementType.PARAMETER }) @WithArgumentExtractor(value = GuiceArgumentExtractor.class) public @interface GuiceAnnotation {
    String foo();
  }

  public static class NoArgArgumentExtractor implements ArgumentExtractor<String> {
    @Override public String extract(Context context) {
      return "noargs";
    }

    @Override public Class<String> getExtractedType() {
      return String.class;
    }
  ...
  public static class DateParamParser implements ParamParser<Date> {
    ...
    @Override public Date parseParameter(String field, String parameterValue, Validation validation) {
      try {
        return parameterValue == null ? null : new SimpleDateFormat(DATE_FORMAT).parse(parameterValue);
      } catch (ParseException e) {
        validation.addFieldViolation(field, ConstraintViolation.createForFieldWithDefault(KEY, field, MESSAGE, parameterValue));
        return null;
      }
    }

    @Override public Class<Date> getParsedType() {
      return Date.class;
    }
  }
  ...
  public static class NeedingInjectionParamParser implements ParamParser<Dep> {
    ...
    @Override public Dep parseParameter(String field, String parameterValue, Validation validation) {
      return new Dep(properties.get("needingInjectionParamParser.value") + "_" + parameterValue);
    }

    @Override public Class<Dep> getParsedType() {
      return Dep.class;
    }
  }
  ...
  public static class GuiceArgumentExtractor implements ArgumentExtractor<String> {
    ...
    @Inject public GuiceArgumentExtractor(Dep dep, GuiceAnnotation annot, ArgumentClassHolder holder) {
      this.dep = dep;
      this.annot = annot;
  ...
  public class Dto {
    @Size(min = 1, max = 10) @Pattern(regexp = "[a-z]*") public String regex;

    @Size(min = 5, max = 10) public String length;

    @Min(value = 3) @Max(value = 10) public int range;
  }
}