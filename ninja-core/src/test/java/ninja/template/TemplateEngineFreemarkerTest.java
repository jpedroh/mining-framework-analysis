...
@RunWith(value = MockitoJUnitRunner.class) public class TemplateEngineFreemarkerTest {
  @Mock Lang lang;

  @Mock Logger logger;

  @Mock TemplateEngineFreemarkerExceptionHandler templateEngineFreemarkerExceptionHandler;

  @Mock TemplateEngineHelper templateEngineHelper;

  @Mock TemplateEngineManager templateEngineManager;

  @Mock TemplateEngineFreemarkerReverseRouteMethod templateEngineFreemarkerReverseRouteMethod;

  @Mock TemplateEngineFreemarkerAssetsAtMethod templateEngineFreemarkerAssetsAtMethod;

  @Mock TemplateEngineFreemarkerWebJarsAtMethod templateEngineFreemarkerWebJarsAtMethod;
  ...
  @Before public void before() throws Exception {
    ...
    templateEngineFreemarker = new TemplateEngineFreemarker(messages, lang, logger, templateEngineFreemarkerExceptionHandler, templateEngineHelper, templateEngineManager, templateEngineFreemarkerReverseRouteMethod, templateEngineFreemarkerAssetsAtMethod, templateEngineFreemarkerWebJarsAtMethod, ninjaProperties);
  ...
  @Test public void testThatTemplateEngineFreemarkerHasSingletonAnnotation() {
  ...
  @Test public void testThatConfigurationCanBeRetrieved() throws Exception {
    templateEngineFreemarker.invoke(context, Results.ok());
