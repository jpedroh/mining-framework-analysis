 ...
 * @author：shenjialong
 */
@Service(value = "pmsMenuService") public class PmsMenuServiceImpl implements PmsMenuService {
  @Autowired private PmsMenuDao pmsMenuDao;
  ...
  /**
	 ...
	 * @return menuList.
	 */
  @SuppressWarnings(value = { "rawtypes" }) public List getListByParent(Long parentId) {
  ...
  /**
	 ...
	 * @return
	 */
  @SuppressWarnings(value = { "rawtypes" }) public List listByRoleIds(String roleIdsStr) {
