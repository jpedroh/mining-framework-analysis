...
public class PrimitivePropertyBuilders {
  ...
  private static class GenericColor extends AbstractPropertyBuilder {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.TRANSPARENT });
...
<<<<<<< /usr/src/app/output/flyingsaucerproject/flyingsaucer/95bfc21a868b15c0753e179040dabb40b59f6b09/flying-saucer-core/src/main/java/org/xhtmlrenderer/css/parser/property/PrimitivePropertyBuilders.java/left.java
  public static class FSDynamicAutoWidth extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.DYNAMIC, IdentValue.STATIC });
...
>>>>>>> /usr/src/app/output/flyingsaucerproject/flyingsaucer/95bfc21a868b15c0753e179040dabb40b59f6b09/flying-saucer-core/src/main/java/org/xhtmlrenderer/css/parser/property/PrimitivePropertyBuilders.java/right.java
  ...
  private static class LengthLikeWithAuto extends LengthLikeWithIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.AUTO });
  ...
  private static class LengthWithNormal extends LengthWithIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.NORMAL });
  ...
  public static class BackgroundSize extends AbstractPropertyBuilder {
    private static final BitSet ALL_ALLOWED = setFor(new IdentValue[] { IdentValue.AUTO, IdentValue.CONTAIN, IdentValue.COVER });
    ...
    public List buildDeclarations(CSSName cssName, List values, int origin, boolean important, boolean inheritAllowed) {
      ...
      checkInheritAllowed(first, inheritAllowed);
      if (values.size() == 1 && first.getCssValueType() == CSSPrimitiveValue.CSS_INHERIT) {
      ...
      if (second == null) {
        ...
        if (first.getPrimitiveType() == CSSPrimitiveValue.CSS_IDENT) {
          ...
          if (((PropertyValue) first).getFloatValue() < 0.0f) {
        ...
        if (second.getPrimitiveType() == CSSPrimitiveValue.CSS_IDENT) {
          ...
          if (((PropertyValue) second).getFloatValue() < 0.0f) {
            throw new CSSParseException(cssName + " values cannot be negative", -1);
          }
        }
  ...
  public static class BackgroundPosition extends AbstractPropertyBuilder {
    public List buildDeclarations(CSSName cssName, List values, int origin, boolean important, boolean inheritAllowed) {
      ...
      if (second == null) {
        if (isLength(first) || first.getPrimitiveType() == CSSPrimitiveValue.CSS_PERCENTAGE) {
          ...
          responseValues.add(new PropertyValue(CSSPrimitiveValue.CSS_PERCENTAGE, 50.0f, "50%"));
      ...
      if (firstIdent == null && secondIdent == null) {
        ...
        if (firstIdent != null && secondIdent != null) {
          ...
          return createTwoPercentValueResponse(getPercentForIdent(firstIdent), getPercentForIdent(secondIdent), important, origin);
        } else {
          checkIdentPosition(cssName, firstIdent, secondIdent);
          List responseValues = new ArrayList(2);
          if (firstIdent == null) {
    ...
    private float getPercentForIdent(IdentValue ident) {
      ...
      if (ident == IdentValue.CENTER) {
        ...
        if (ident == IdentValue.BOTTOM || ident == IdentValue.RIGHT) {
          percent = 100.0f;
        }
      }
      return percent;
    ...
    private PropertyValue createValueForIdent(IdentValue ident) {
      ...
      return new PropertyValue(CSSPrimitiveValue.CSS_PERCENTAGE, percent, percent + "%");
    }

    private List createTwoPercentValueResponse(float percent1, float percent2, boolean important, int origin) {
      PropertyValue value1 = new PropertyValue(CSSPrimitiveValue.CSS_PERCENTAGE, percent1, percent1 + "%");
      PropertyValue value2 = new PropertyValue(CSSPrimitiveValue.CSS_PERCENTAGE, percent2, percent2 + "%");
  ...
  public static class BorderCollapse extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.COLLAPSE, IdentValue.SEPARATE });
...
<<<<<<< /usr/src/app/output/flyingsaucerproject/flyingsaucer/95bfc21a868b15c0753e179040dabb40b59f6b09/flying-saucer-core/src/main/java/org/xhtmlrenderer/css/parser/property/PrimitivePropertyBuilders.java/left.java
  public static class FSNamedDestination extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.NONE, IdentValue.CREATE });
...
>>>>>>> /usr/src/app/output/flyingsaucerproject/flyingsaucer/95bfc21a868b15c0753e179040dabb40b59f6b09/flying-saucer-core/src/main/java/org/xhtmlrenderer/css/parser/property/PrimitivePropertyBuilders.java/right.java
  ...
  public static class CaptionSide extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.TOP, IdentValue.BOTTOM });
  ...
  public static class Clear extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.NONE, IdentValue.LEFT, IdentValue.RIGHT, IdentValue.BOTH });
  ...
  public static class EmptyCells extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.SHOW, IdentValue.HIDE });
  ...
  public static class Float extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.LEFT, IdentValue.RIGHT, IdentValue.NONE });
  ...
  public static class FontFamily extends AbstractPropertyBuilder {
    public List buildDeclarations(CSSName cssName, List values, int origin, boolean important, boolean inheritAllowed) {
      ...
      PropertyValue result = new PropertyValue(CSSPrimitiveValue.CSS_STRING, text, text);
      ...
      if (value.getCssValueType() != CSSPrimitiveValue.CSS_INHERIT) {
        ...
        if (type == CSSPrimitiveValue.CSS_IDENT) {
          ...
          if (type == CSSPrimitiveValue.CSS_NUMBER) {
            ...
            PropertyValue replacement = new PropertyValue(CSSPrimitiveValue.CSS_IDENT, weight.toString(), weight.toString());
  ...
  public static class FSPageSequence extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.START, IdentValue.AUTO });
  ...
  public static class FSPDFFontEmbed extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.AUTO, IdentValue.EMBED });
  ...
  public static class FSPDFFontEncoding extends AbstractPropertyBuilder {
    public List buildDeclarations(CSSName cssName, List values, int origin, boolean important, boolean inheritAllowed) {
      ...
      if (value.getCssValueType() != CSSPrimitiveValue.CSS_INHERIT) {
        ...
        if (value.getPrimitiveType() == CSSPrimitiveValue.CSS_IDENT) {
          return Collections.singletonList(new PropertyDeclaration(cssName, new PropertyValue(CSSPrimitiveValue.CSS_STRING, value.getStringValue(), value.getCssText()), important, origin));
        }
      }
      return Collections.singletonList(new PropertyDeclaration(cssName, value, important, origin));
    }
  ...
  public static class FSTablePaginate extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.PAGINATE, IdentValue.AUTO });
  ...
  public static class FSTextDecorationExtent extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.LINE, IdentValue.BLOCK });
  ...
  public static class FSKeepWithInline extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.AUTO, IdentValue.KEEP });
  ...
  public static class Overflow extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.VISIBLE, IdentValue.HIDDEN });
  ...
  public static class PageBreakBefore extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.AUTO, IdentValue.ALWAYS, IdentValue.AVOID, IdentValue.LEFT, IdentValue.RIGHT });
    ...
    public List buildDeclarations(CSSName cssName, List values, int origin, boolean important, boolean inheritAllowed) {
      ...
      if (value.getCssValueType() != CSSPrimitiveValue.CSS_INHERIT) {
        ...
        if (!value.getStringValue().equals("auto")) {
          value = new PropertyValue(CSSPrimitiveValue.CSS_STRING, value.getStringValue(), value.getCssText());
        }
      }
      return Collections.singletonList(new PropertyDeclaration(cssName, value, important, origin));
    }
  ...
  public static class PageBreakInside extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.AVOID, IdentValue.AUTO });
  ...
  public static class Position extends AbstractPropertyBuilder {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.STATIC, IdentValue.RELATIVE, IdentValue.ABSOLUTE, IdentValue.FIXED });
  ...
  public static class TableLayout extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.AUTO, IdentValue.FIXED });
  ...
  public static class TextAlign extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.LEFT, IdentValue.RIGHT, IdentValue.CENTER, IdentValue.JUSTIFY });
  ...
  public static class TextDecoration extends AbstractPropertyBuilder {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.UNDERLINE, IdentValue.OVERLINE, IdentValue.LINE_THROUGH });
  ...
  public static class TextTransform extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.CAPITALIZE, IdentValue.UPPERCASE, IdentValue.LOWERCASE, IdentValue.NONE });
  ...
  public static class VerticalAlign extends LengthLikeWithIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.BASELINE, IdentValue.SUB, IdentValue.SUPER, IdentValue.TOP, IdentValue.TEXT_TOP, IdentValue.MIDDLE, IdentValue.BOTTOM, IdentValue.TEXT_BOTTOM });
  ...
  public static class Visibility extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.VISIBLE, IdentValue.HIDDEN, IdentValue.COLLAPSE });
  ...
  public static class WhiteSpace extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.NORMAL, IdentValue.PRE, IdentValue.NOWRAP, IdentValue.PRE_WRAP, IdentValue.PRE_LINE });
  ...
  public static class WordWrap extends SingleIdent {
    private static final BitSet ALLOWED = setFor(new IdentValue[] { IdentValue.NORMAL, IdentValue.BREAK_WORD });
