...
public class CSSParser {
  ...
  public PropertyValue parsePropertyValue(CSSName cssName, int origin, String expr) {
    ...
    try {
      ...
      List values = expr(cssName == CSSName.FONT_FAMILY || cssName == CSSName.FONT_SHORTHAND || cssName == CSSName.FS_PDF_FONT_ENCODING);
      ...
      if (props.size() != 1) {
        throw new CSSParseException("Builder created " + props.size() + "properties, expected 1", getCurrentLine());
      }
    ...
    try {
      ...
      if (t == Token.TK_IMPORT_SYM) {
        ...
        switch (t.getType()) {
          ...
          default:
          push(t);
          throw new CSSParseException(t, new Token[] { Token.TK_STRING, Token.TK_URI }, getCurrentLine());
        }
  ...
  private Token combinator() throws IOException {
    ...
    if (t == Token.TK_PLUS || t == Token.TK_GREATER) {
      ...
      if (t != Token.TK_S) {
        push(t);
        throw new CSSParseException(t, new Token[] { Token.TK_PLUS, Token.TK_GREATER, Token.TK_S }, getCurrentLine());
      }
    }
    return t;
  }
  ...
  private int unary_operator() throws IOException {
    ...
    if (!(t == Token.TK_MINUS || t == Token.TK_PLUS)) {
      push(t);
      throw new CSSParseException(t, new Token[] { Token.TK_MINUS, Token.TK_PLUS }, getCurrentLine());
    }
    if (t == Token.TK_MINUS) {
      return -1;
    } else {
  ...
  private void ruleset(RulesetContainer container) throws IOException {
    try {
      ...
      if (t == Token.TK_LBRACE) {
        ...
        push(t);
        throw new CSSParseException(t, new Token[] { Token.TK_COMMA, Token.TK_LBRACE }, getCurrentLine());
      }
    ...
    while (true) {
      ...
      switch (t.getType()) {
        ...
        switch (t.getType()) {
          ...
          break;
          default:
          throw new CSSParseException(t, new Token[] { Token.TK_IDENT, Token.TK_ASTERISK, Token.TK_HASH, Token.TK_PERIOD, Token.TK_LBRACKET, Token.TK_COLON }, getCurrentLine());
        }
        break;
        default:
        break LOOP;
    ...
    switch (t.getType()) {
      ...
      while (true) {
        ...
        switch (t.getType()) {
          ...
          default:
          if (!found) {
            throw new CSSParseException(t, new Token[] { Token.TK_HASH, Token.TK_PERIOD, Token.TK_LBRACKET, Token.TK_COLON }, getCurrentLine());
          }
          break LOOP;
        }
      }
  ...
  private NamespacePair typed_value(boolean matchAttribute) throws IOException {
    ...
    if (t == Token.TK_ASTERISK || t == Token.TK_IDENT) {
      ...
      if (t == Token.TK_VERTICAL_BAR) {
        ...
        throw new CSSParseException(t, new Token[] { Token.TK_ASTERISK, Token.TK_IDENT, Token.TK_VERTICAL_BAR }, getCurrentLine());
      }
    }
    if (t == Token.TK_VERTICAL_BAR) {
      next();
      ...
      if (t == Token.TK_ASTERISK || t == Token.TK_IDENT) {
        ...
        throw new CSSParseException(t, new Token[] { Token.TK_ASTERISK, Token.TK_IDENT }, getCurrentLine());
      }
    }
    ...
    if (prefix != null && prefix != TreeResolver.NO_NAMESPACE) {
      ...
      if (namespaceURI == null) {
        throw new CSSParseException("There is no namespace with prefix " + prefix + " defined", getCurrentLine());
      }
    } else {
      if (prefix == null && !matchAttribute) {
      ...
      if (t == Token.TK_IDENT || t == Token.TK_ASTERISK || t == Token.TK_VERTICAL_BAR) {
        ...
        switch (t.getType()) {
          ...
          if (t == Token.TK_IDENT || t == Token.TK_STRING) {
            ...
            push(t);
            throw new CSSParseException(t, new Token[] { Token.TK_IDENT, Token.TK_STRING }, getCurrentLine());
          }
          skip_whitespace();
          t = la();
          break;
        ...
        if (t == Token.TK_RBRACKET) {
          ...
          throw new CSSParseException(t, new Token[] { Token.TK_EQUALS, Token.TK_INCLUDES, Token.TK_DASHMATCH, Token.TK_PREFIXMATCH, Token.TK_SUFFIXMATCH, Token.TK_SUBSTRINGMATCH, Token.TK_RBRACKET }, getCurrentLine());
        }
      } else {
        throw new CSSParseException(t, new Token[] { Token.TK_IDENT, Token.TK_ASTERISK }, getCurrentLine());
      }
    } else {
      push(t);
                ...
                if (value.equals("even")) {
                  ...
                  if (value.equals("odd")) {
                    ...
                    if (value.equals("last-child")) {
                      ...
                      if (CSS21_PSEUDO_ELEMENTS.contains(value)) {
  ...
  private void pseudo(Selector selector) throws IOException {
    ...
    if (t == Token.TK_COLON) {
      ...
      switch (t.getType()) {
        ...
        default:
        push(t);
        throw new CSSParseException(t, new Token[] { Token.TK_IDENT, Token.TK_FUNCTION }, getCurrentLine());
      }
    } else {
      push(t);
      throw new CSSParseException(t, Token.TK_COLON, getCurrentLine());
  ...
  private boolean checkCSSName(CSSName cssName, String propertyName) {
    if (cssName == null) {
      _errorHandler.error(_URI, propertyName + " is an unrecognized CSS property at line " + getCurrentLine() + ". Ignoring declaration.");
      return false;
    }
    if (!CSSName.isImplemented(cssName)) {
      _errorHandler.error(_URI, propertyName + " is not implemented at line " + getCurrentLine() + ". Ignoring declaration.");
      return false;
    }
    PropertyBuilder builder = CSSName.getPropertyBuilder(cssName);
    if (builder == null) {
      _errorHandler.error(_URI, "(bug) No property builder defined for " + propertyName + " at line " + getCurrentLine() + ". Ignoring declaration.");
      return false;
    }
    return true;
  }
      ...
      if (t == Token.TK_IDENT) {
        ...
        if (t == Token.TK_COLON) {
          ...
          if (!(t == Token.TK_SEMICOLON || t == Token.TK_RBRACE || t == Token.TK_EOF)) {
            throw new CSSParseException(t, new Token[] { Token.TK_SEMICOLON, Token.TK_RBRACE }, getCurrentLine());
          }
          if (valid) {
            try {
              PropertyBuilder builder = CSSName.getPropertyBuilder(cssName);
  ...
  private PropertyValue term(boolean literal) throws IOException {
    ...
    switch (t.getType()) {
      ...
      case Token.NUMBER:
      result = new PropertyValue(CSSPrimitiveValue.CSS_NUMBER, sign * Float.parseFloat(getTokenValue(t)), sign(sign) + getTokenValue(t));
      next();
      skip_whitespace();
      break;
      case Token.PERCENTAGE:
      result = new PropertyValue(CSSPrimitiveValue.CSS_PERCENTAGE, sign * Float.parseFloat(extractNumber(t)), sign(sign) + getTokenValue(t));
      next();
      skip_whitespace();
      break;
      case Token.EMS:
      result = new PropertyValue(CSSPrimitiveValue.CSS_EMS, sign * Float.parseFloat(extractNumber(t)), sign(sign) + getTokenValue(t));
      next();
      skip_whitespace();
      break;
      case Token.EXS:
      result = new PropertyValue(CSSPrimitiveValue.CSS_EXS, sign * Float.parseFloat(extractNumber(t)), sign(sign) + getTokenValue(t));
      next();
      skip_whitespace();
      break;
      case Token.PX:
      result = new PropertyValue(CSSPrimitiveValue.CSS_PX, sign * Float.parseFloat(extractNumber(t)), sign(sign) + getTokenValue(t));
      next();
      skip_whitespace();
      break;
      case Token.CM:
      result = new PropertyValue(CSSPrimitiveValue.CSS_CM, sign * Float.parseFloat(extractNumber(t)), sign(sign) + getTokenValue(t));
      next();
      skip_whitespace();
      break;
      case Token.MM:
      result = new PropertyValue(CSSPrimitiveValue.CSS_MM, sign * Float.parseFloat(extractNumber(t)), sign(sign) + getTokenValue(t));
      next();
      skip_whitespace();
      break;
      case Token.IN:
      result = new PropertyValue(CSSPrimitiveValue.CSS_IN, sign * Float.parseFloat(extractNumber(t)), sign(sign) + getTokenValue(t));
      next();
      skip_whitespace();
      break;
      case Token.PT:
      result = new PropertyValue(CSSPrimitiveValue.CSS_PT, sign * Float.parseFloat(extractNumber(t)), sign(sign) + getTokenValue(t));
      next();
      skip_whitespace();
      break;
      case Token.PC:
      result = new PropertyValue(CSSPrimitiveValue.CSS_PC, sign * Float.parseFloat(extractNumber(t)), sign(sign) + getTokenValue(t));
      next();
      skip_whitespace();
      break;
      case Token.STRING:
      String s = getTokenValue(t);
      result = new PropertyValue(CSSPrimitiveValue.CSS_STRING, s, getRawTokenValue());
      next();
      skip_whitespace();
      break;
      case Token.IDENT:
      String value = getTokenValue(t, literal);
      result = new PropertyValue(CSSPrimitiveValue.CSS_IDENT, value, value);
      next();
      skip_whitespace();
      break;
      case Token.URI:
      result = new PropertyValue(CSSPrimitiveValue.CSS_URI, getTokenValue(t), getRawTokenValue());
      next();
      skip_whitespace();
      break;
      case Token.HASH:
  ...
  private FSCMYKColor createCMYKColorFromFunction(List params) {
    ...
    for (int i = 0; i < params.size(); i++) {
      colorComponents[i] = parseCMYKColorComponent((PropertyValue) params.get(i), (i + 1));
    }
  ...
  private float parseCMYKColorComponent(PropertyValue value, int paramNo) {
    ...
    if (type == CSSPrimitiveValue.CSS_NUMBER) {
      ...
      if (type == CSSPrimitiveValue.CSS_PERCENTAGE) {
        ...
        throw new CSSParseException("Parameter " + paramNo + " to the cmyk() function is " + "not a number or a percentage", getCurrentLine());
      }
    }
    if (result < 0.0f || result > 1.0f) {
      throw new CSSParseException("Parameter " + paramNo + " to the cmyk() function must be between zero and one", getCurrentLine());
    }
    return result;
  }
  ...
  private FSRGBColor createRGBColorFromFunction(List params) {
    if (params.size() != 3 && params.size() != 4) {
      throw new CSSParseException("The rgb() function must have three or four parameters", getCurrentLine());
    }
    int red = 0;
    int green = 0;
    int blue = 0;
    ...
    for (int i = 0; i < params.size(); i++) {
      ...
      short type = value.getPrimitiveType();
      if (type != CSSPrimitiveValue.CSS_PERCENTAGE && type != CSSPrimitiveValue.CSS_NUMBER) {
        throw new CSSParseException("Parameter " + (i + 1) + " to the rgb() function is " + "not a number or percentage", getCurrentLine());
      }
      if (type != CSSPrimitiveValue.CSS_NUMBER && i == 3) {
        throw new CSSParseException("Parameter alpha to the rgba() function is " + "not a number", getCurrentLine());
      }
  ...
  private PropertyValue hexcolor() throws IOException {
    ...
    if (t == Token.TK_HASH) {
      ...
      if (s.length() == 3) {
        color = new FSRGBColor(convertToInteger(s.charAt(0), s.charAt(0)), convertToInteger(s.charAt(1), s.charAt(1)), convertToInteger(s.charAt(2), s.charAt(2)));
      } else {
        color = new FSRGBColor(convertToInteger(s.charAt(0), s.charAt(1)), convertToInteger(s.charAt(2), s.charAt(3)), convertToInteger(s.charAt(4), s.charAt(5)));
      }
