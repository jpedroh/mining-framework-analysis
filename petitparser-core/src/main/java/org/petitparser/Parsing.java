 ...
 */
@Deprecated public class Parsing {
  private Parsing() {
  }
   ...
   */
  @Deprecated public static Result parse(Parser parser, String string) {
   ...
   */
  @Deprecated public static boolean accepts(Parser parser, String string) {
   ...
   */
  @Deprecated public static <T extends java.lang.Object> List<T> matches(Parser parser, String string) {
   ...
   */
  @Deprecated public static <T extends java.lang.Object> List<T> matchesSkipping(Parser parser, String string) {
