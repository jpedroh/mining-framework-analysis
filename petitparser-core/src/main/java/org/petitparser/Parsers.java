 ...
 */
@Deprecated public class Parsers {
  private Parsers() {
  }
   ...
   */
  @Deprecated public static Parser epsilon() {
   ...
   */
  @Deprecated public static Parser failure(String message) {
   ...
   */
  @Deprecated public static Parser string(String string) {
   ...
   */
  @Deprecated public static Parser string(String string, String message) {
   ...
   */
  @Deprecated public static Parser stringIgnoreCase(String string) {
   ...
   */
  @Deprecated public static Parser stringIgnoreCase(String string, String message) {
