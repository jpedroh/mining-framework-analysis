...
@Deprecated public class Chars {
   ...
   */
  @Deprecated public static Parser any() {
   ...
   */
  @Deprecated public static Parser any(String message) {
   ...
   */
  @Deprecated public static Parser anyOf(String characters) {
   ...
   */
  @Deprecated public static Parser anyOf(String characters, String message) {
   ...
   */
  @Deprecated public static Parser character(char character) {
   ...
   */
  @Deprecated public static Parser character(char character, String message) {
   ...
   */
  @Deprecated public static Parser digit() {
   ...
   */
  @Deprecated public static Parser digit(String message) {
   ...
   */
  @Deprecated public static Parser letter() {
   ...
   */
  @Deprecated public static Parser letter(String message) {
   ...
   */
  @Deprecated public static Parser lowerCase() {
   ...
   */
  @Deprecated public static Parser lowerCase(String message) {
   ...
   */
  @Deprecated public static Parser pattern(String pattern) {
   ...
   */
  @Deprecated public static Parser pattern(String pattern, String message) {
   ...
   */
  @Deprecated public static Parser range(char start, char stop) {
   ...
   */
  @Deprecated public static Parser range(char start, char stop, String message) {
   ...
   */
  @Deprecated public static Parser upperCase() {
   ...
   */
  @Deprecated public static Parser upperCase(String message) {
   ...
   */
  @Deprecated public static Parser whitespace() {
   ...
   */
  @Deprecated public static Parser whitespace(String message) {
   ...
   */
  @Deprecated public static Parser word() {
   ...
   */
  @Deprecated public static Parser word(String message) {
