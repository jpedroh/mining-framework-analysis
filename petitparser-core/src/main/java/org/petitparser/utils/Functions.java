...
public class Functions {
   ...
   */
  public static <T extends java.lang.Object> Function<List<T>, T> firstOfList() {
   ...
   */
  public static <T extends java.lang.Object> Function<List<T>, T> lastOfList() {
   ...
   * the end of the list.
   */
  public static <T extends java.lang.Object> Function<List<T>, T> nthOfList(int index) {
   ...
   */
  public static <T extends java.lang.Object> Function<List<T>, List<T>> permutationOfList(int... indexes) {
    return (list) -> {
   ...
   */
  public static <T extends java.lang.Object> Function<List<T>, List<T>> withoutSeparators() {
    return (list) -> {
   ...
   */
  public static <T extends java.lang.Object> Function<Object, T> constant(T output) {
    return (input) -> output;
  }
}