 ...
 */
@Schema(name = "ApiResponse", description = "Describes the result of uploading an image resource") @JsonTypeName(value = "ApiResponse") @Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) public class ModelApiResponse {
