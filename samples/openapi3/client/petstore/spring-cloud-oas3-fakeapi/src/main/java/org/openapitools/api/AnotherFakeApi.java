...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "AnotherFake", description = "the AnotherFake API") public interface AnotherFakeApi {
  /**
