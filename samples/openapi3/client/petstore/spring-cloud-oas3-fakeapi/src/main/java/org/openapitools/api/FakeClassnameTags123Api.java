...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "FakeClassnameTags123", description = "the FakeClassnameTags123 API") public interface FakeClassnameTags123Api {
  /**
