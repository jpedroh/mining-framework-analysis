...
@JsonIgnoreProperties(value = "@type", allowSetters = true) @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "@type", visible = true) @JsonSubTypes(value = { @JsonSubTypes.Type(value = PizzaSpeziale.class, name = "PizzaSpeziale") }) @Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) public class Pizza extends Entity {
   ...
   * @return pizzaSize
  */
  @Valid @Schema(name = "pizzaSize", requiredMode = Schema.RequiredMode.NOT_REQUIRED) @JsonProperty(value = "pizzaSize") public BigDecimal getPizzaSize() {
    return pizzaSize;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    Pizza pizza = (Pizza) o;
    return Objects.equals(this.pizzaSize, pizza.pizzaSize) && super.equals(o);
  }
