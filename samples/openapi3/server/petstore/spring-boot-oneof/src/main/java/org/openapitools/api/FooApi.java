...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "foo", description = "the foo API") public interface FooApi {
  ...
  /**
     ...
     */
  @Operation(operationId = "getAllFoos", summary = "GET all Foos", tags = { "Foo" }, responses = { @ApiResponse(responseCode = "200", description = "Success", content = { @Content(mediaType = "application/json;charset=utf-8", schema = @Schema(implementation = FooRefOrValue.class)) }) }) @RequestMapping(method = RequestMethod.GET, value = "/foo", produces = { "application/json;charset=utf-8" }) default ResponseEntity<List<FooRefOrValue>> getAllFoos() {
    getRequest().ifPresent((request) -> {
      for (MediaType mediaType : MediaType.parseMediaTypes(request.getHeader("Accept"))) {
