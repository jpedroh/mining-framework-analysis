 ...
 */
@Schema(name = "EntityRef", description = "Entity reference schema to be use for all entityRef class.") @JsonIgnoreProperties(value = "@type", allowSetters = true) @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "@type", visible = true) @JsonSubTypes(value = { @JsonSubTypes.Type(value = BarRef.class, name = "BarRef"), @JsonSubTypes.Type(value = FooRef.class, name = "FooRef") }) @Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) public class EntityRef {
  private String name;
   ...
   * @return name
  */
  @Schema(name = "name", description = "Name of the related entity.", requiredMode = Schema.RequiredMode.NOT_REQUIRED) @JsonProperty(value = "name") public String getName() {
    return name;
  }
  ...
  */
  @Schema(name = "@referredType", description = "The actual type of the target instance when needed for disambiguation.", requiredMode = Schema.RequiredMode.NOT_REQUIRED) @JsonProperty(value = "@referredType") public String getAtReferredType() {
    return atReferredType;
  }
  ...
  */
  ...
  @Override public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, entityRef.name) && Objects.equals(this.atReferredType, entityRef.atReferredType) && Objects.equals(this.href, entityRef.href) && Objects.equals(this.id, entityRef.id) && Objects.equals(this.atSchemaLocation, entityRef.atSchemaLocation) && Objects.equals(this.atBaseType, entityRef.atBaseType) && Objects.equals(this.atType, entityRef.atType);
  }
