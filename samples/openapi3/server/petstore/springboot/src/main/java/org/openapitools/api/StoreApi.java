...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "store", description = "Access to Petstore orders") @RequestMapping(value = "${openapi.openAPIPetstore.base-path:/v2}") public interface StoreApi {
