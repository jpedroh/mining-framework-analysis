...
@Generated(value = { "org.openapitools.codegen.languages.JavaMicronautServerCodegen" }) @Controller @Tag(name = "Store", description = "The Store API") public class StoreController {
  /**
  ...
  /**
     ...
     */
  @Operation(operationId = "getInventory", summary = "Returns pet inventories by status", responses = { @ApiResponse(responseCode = "200", description = "successful operation", content = { @Content(mediaType = "application/json", schema = @Schema(implementation = Map.class)) }) }, security = { @SecurityRequirement(name = "api_key") }) @Get(uri = "/store/inventory") @Produces(value = { "application/json" }) public Mono<Map<String, Integer>> getInventory() {
    return Mono.error(new HttpStatusException(HttpStatus.NOT_IMPLEMENTED, null));
  }
