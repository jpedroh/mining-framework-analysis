...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Api(value = "fake_classname_test", description = "the fake_classname_test API") @RequestMapping(value = "${openapi.openAPIPetstore.base-path:/v2}") public interface FakeClassnameTestApi {
