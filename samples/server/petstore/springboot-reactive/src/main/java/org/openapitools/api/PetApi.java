/**
<<<<<<< /usr/src/app/output/openapitools/openapi-generator/257a97b6cdf67b1b37081594f0b080cf3b8863ec/samples/server/petstore/springboot-reactive/src/main/java/org/openapitools/api/PetApi.java/left.java
 * NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech) (3.4.0-SNAPSHOT).
||||||| /usr/src/app/output/openapitools/openapi-generator/257a97b6cdf67b1b37081594f0b080cf3b8863ec/samples/server/petstore/springboot-reactive/src/main/java/org/openapitools/api/PetApi.java/base.java
...
>>>>>>> /usr/src/app/output/openapitools/openapi-generator/257a97b6cdf67b1b37081594f0b080cf3b8863ec/samples/server/petstore/springboot-reactive/src/main/java/org/openapitools/api/PetApi.java/right.java
...
public interface PetApi {
    ...
    @RequestMapping(value = "/pet/findByTags",
        produces = { "application/xml", "application/json" }, 
        method = RequestMethod.GET)
    default Mono<ResponseEntity<Flux<Pet>>> findPetsByTags(@NotNull @ApiParam(value = "Tags to filter by", required = true, defaultValue = "new ArrayList<>()") @Valid @RequestParam(value = "tags", required = true, defaultValue="new ArrayList<>()") List<String> tags, ServerWebExchange exchange) {
