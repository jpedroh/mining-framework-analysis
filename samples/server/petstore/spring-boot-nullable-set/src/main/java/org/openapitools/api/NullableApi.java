...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "nullable", description = "the nullable API") public interface NullableApi {
