...
public interface UserApi {
    ...
    public default CompletableFuture<ResponseEntity<User>> getUserByName(@ApiParam(value = "The name that needs to be fetched. Use user1 for testing. ", required = true)
    ...
    public default CompletableFuture<ResponseEntity<String>> loginUser(@NotNull
