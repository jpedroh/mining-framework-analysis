/**
<<<<<<< /usr/src/app/output/openapitools/openapi-generator/257a97b6cdf67b1b37081594f0b080cf3b8863ec/samples/server/petstore/spring-mvc-j8-async/src/main/java/org/openapitools/api/FakeApi.java/left.java
 * NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech) (3.4.0-SNAPSHOT).
||||||| /usr/src/app/output/openapitools/openapi-generator/257a97b6cdf67b1b37081594f0b080cf3b8863ec/samples/server/petstore/spring-mvc-j8-async/src/main/java/org/openapitools/api/FakeApi.java/base.java
...
>>>>>>> /usr/src/app/output/openapitools/openapi-generator/257a97b6cdf67b1b37081594f0b080cf3b8863ec/samples/server/petstore/spring-mvc-j8-async/src/main/java/org/openapitools/api/FakeApi.java/right.java
...
public interface FakeApi {
    ...
    default CompletableFuture<ResponseEntity<Void>> testBodyWithFileSchema(@ApiParam(value = "" ,required=true )  @Valid @RequestBody FileSchemaTestClass fileSchemaTestClass) {
        return CompletableFuture.completedFuture(new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED));
    ...
    @RequestMapping(value = "/fake/{petId}/uploadImageWithRequiredFile",
        ...
        method = RequestMethod.POST)
    default CompletableFuture<ResponseEntity<ModelApiResponse>> uploadFileWithRequiredFile(@ApiParam(value = "ID of pet to update",required=true) @PathVariable("petId") Long petId,@ApiParam(value = "file detail") @Valid @RequestPart("file") MultipartFile requiredFile,@ApiParam(value = "Additional data to pass to server") @RequestParam(value="additionalMetadata", required=false)  String additionalMetadata) {
        return CompletableFuture.supplyAsync(()-> {
            getRequest().ifPresent(request -> {
                for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                    if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
