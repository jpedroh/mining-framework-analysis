...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "another-fake", description = "the another-fake API") public interface AnotherFakeApi {
  /**
