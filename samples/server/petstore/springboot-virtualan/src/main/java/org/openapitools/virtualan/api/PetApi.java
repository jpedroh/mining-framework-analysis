...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "pet", description = "Everything about your Pets") @VirtualService public interface PetApi {
