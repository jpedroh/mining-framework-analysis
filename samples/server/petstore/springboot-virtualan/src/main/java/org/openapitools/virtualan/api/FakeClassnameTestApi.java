...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "fake_classname_test", description = "the fake_classname_test API") @VirtualService @RequestMapping(value = "${openapi.openAPIPetstore.base-path:/v2}") public interface FakeClassnameTestApi {
