...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "another-fake", description = "the another-fake API") @VirtualService public interface AnotherFakeApi {
