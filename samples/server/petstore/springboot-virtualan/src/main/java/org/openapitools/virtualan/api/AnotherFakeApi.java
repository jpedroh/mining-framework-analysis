...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "another-fake", description = "the another-fake API") @VirtualService @RequestMapping(value = "${openapi.openAPIPetstore.base-path:/v2}") public interface AnotherFakeApi {
