...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "fake", description = "the fake API") @VirtualService public interface FakeApi {
