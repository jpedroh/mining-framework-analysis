...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Tag(name = "fake", description = "the fake API") @VirtualService @RequestMapping(value = "${openapi.openAPIPetstore.base-path:/v2}") public interface FakeApi {
