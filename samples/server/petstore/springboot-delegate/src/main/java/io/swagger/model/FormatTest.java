...
public class FormatTest {
   ...
   * @return integer
  **/
  @ApiModelProperty(value = "") @Min(value = 10) @Max(value = 100) public Integer getInteger() {
    return integer;
  }
   ...
   * @return int32
  **/
  @ApiModelProperty(value = "") @Min(value = 20) @Max(value = 200) public Integer getInt32() {
    return int32;
  }
  ...
  **/
   ...
   * @return number
  **/
  @ApiModelProperty(required = true, value = "") @NotNull @DecimalMin(value = "32.1") @Valid @DecimalMax(value = "543.2") public BigDecimal getNumber() {
    return number;
  }
   ...
   * @return _float
  **/
  @ApiModelProperty(value = "") @DecimalMin(value = "54.3") @DecimalMax(value = "987.6") public Float getFloat() {
    return _float;
  }
   ...
   * @return _double
  **/
  @ApiModelProperty(value = "") @DecimalMin(value = "67.8") @DecimalMax(value = "123.4") public Double getDouble() {
    return _double;
  }
   ...
   * @return string
  **/
  @ApiModelProperty(value = "") @Pattern(regexp = "/[a-z]/i") public String getString() {
    return string;
  }
   ...
   * @return _byte
  **/
  @ApiModelProperty(required = true, value = "") @NotNull public byte[] getByte() {
    return _byte;
  }
  ...
  **/
   ...
   * @return password
  **/
  @ApiModelProperty(required = true, value = "") @NotNull @Size(min = 10, max = 64) public String getPassword() {
    return password;
  }
