/**
<<<<<<< /usr/src/app/output/openapitools/openapi-generator/257a97b6cdf67b1b37081594f0b080cf3b8863ec/samples/server/petstore/springboot-beanvalidation/src/main/java/org/openapitools/api/PetApi.java/left.java
 * NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech) (3.4.0-SNAPSHOT).
||||||| /usr/src/app/output/openapitools/openapi-generator/257a97b6cdf67b1b37081594f0b080cf3b8863ec/samples/server/petstore/springboot-beanvalidation/src/main/java/org/openapitools/api/PetApi.java/base.java
...
>>>>>>> /usr/src/app/output/openapitools/openapi-generator/257a97b6cdf67b1b37081594f0b080cf3b8863ec/samples/server/petstore/springboot-beanvalidation/src/main/java/org/openapitools/api/PetApi.java/right.java
...
public interface PetApi {
    ...
    ResponseEntity<List<Pet>> findPetsByStatus(@NotNull @ApiParam(value = "Status values that need to be considered for filter", required = true, allowableValues = "available, pending, sold", defaultValue = "new ArrayList<String>()") @Valid @RequestParam(value = "status", required = true, defaultValue="new ArrayList<String>()") List<String> status);
    ...
    @RequestMapping(value = "/pet/findByTags",
        produces = { "application/xml", "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<Pet>> findPetsByTags(@NotNull @ApiParam(value = "Tags to filter by", required = true, defaultValue = "new ArrayList<String>()") @Valid @RequestParam(value = "tags", required = true, defaultValue="new ArrayList<String>()") List<String> tags);
