...
public class PetApiController implements PetApi {
    ...
    String apiKey, @RequestHeader("Accept")
    String accept) {
        // do some magic!
        return new ResponseEntity<Void>(HttpStatus.OK);
    }

    public ResponseEntity<List<Pet>> findPetsByStatus(@NotNull
    ...
    public ResponseEntity<List<Pet>> findPetsByTags(@NotNull
    ...
    public ResponseEntity<Void> updatePet(@ApiParam(value = "Pet object that needs to be added to the store", required = true)
    @Valid
    @RequestBody
    Pet body, @RequestHeader("Accept")
    String accept) {
    ...
    @PathVariable("petId")
    Long petId, @ApiParam("Updated name of the pet")
    ...
    String status, @RequestHeader("Accept")
    String accept) {
        // do some magic!
        return new ResponseEntity<Void>(HttpStatus.OK);
    }
