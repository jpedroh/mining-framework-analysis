...
>>>>>>> /usr/src/app/output/openapitools/openapi-generator/a0b429d69050b57653cad214daaa352685e8c449/samples/server/petstore/spring-mvc/src/main/java/io/swagger/model/ApiResponse.java/right.java
  ...
  /**
   **/
  @ApiModelProperty(value = "") @JsonProperty(value = "code") public Integer getCode() {
    return code;
  }
  ...
  /**
   **/
  @ApiModelProperty(value = "") @JsonProperty(value = "type") public String getType() {
    return type;
  }
  ...
  /**
   **/
  @ApiModelProperty(value = "") @JsonProperty(value = "message") public String getMessage() {
    return message;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    return Objects.equals(code, apiResponse.code) && Objects.equals(type, apiResponse.type) && Objects.equals(message, apiResponse.message);
  }
