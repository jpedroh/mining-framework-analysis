...
public interface PetApi {
    ...
    public abstract ResponseEntity<List<Pet>> findPetsByStatus(@NotNull
    ...
    public abstract ResponseEntity<List<Pet>> findPetsByTags(@NotNull
    ...
    public abstract ResponseEntity<Pet> getPetById(@ApiParam(value = "ID of pet to return", required = true)
    @PathVariable("petId")
    ...
    public abstract ResponseEntity<ModelApiResponse> uploadFile(@ApiParam(value = "ID of pet to update", required = true)
    @PathVariable("petId")
