...
@Controller public class FakeApiController implements FakeApi {
  ...
  public ResponseEntity<Client> testClientModel(@ApiParam(value = "client model", required = true) @Valid @RequestBody Client body, @RequestHeader(value = "Accept") String accept) throws IOException {
