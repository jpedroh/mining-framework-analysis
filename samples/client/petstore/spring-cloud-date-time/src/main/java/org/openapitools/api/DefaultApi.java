...
@Generated(value = { "org.openapitools.codegen.languages.SpringCodegen" }) @Validated @Api(value = "Default", description = "the Default API") public interface DefaultApi {
  /**
     * GET /thingy/{date}
     *
  ...
  /**
     ...
     */
  @ApiOperation(value = "", nickname = "updatePetWithForm", notes = "update with form data") @ApiResponses(value = { @ApiResponse(code = 405, message = "Invalid input") }) @RequestMapping(method = RequestMethod.POST, value = "/thingy/{date}", consumes = "application/x-www-form-urlencoded") ResponseEntity<Void> updatePetWithForm(@ApiParam(value = "A date path parameter", required = true, defaultValue = "1970-01-01") @PathVariable(value = "date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date, @ApiParam(value = "Updated last vist timestamp", defaultValue = "1971-12-19T03:39:57-08:00") @Valid @RequestParam(value = "visitDate", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) OffsetDateTime visitDate);
}