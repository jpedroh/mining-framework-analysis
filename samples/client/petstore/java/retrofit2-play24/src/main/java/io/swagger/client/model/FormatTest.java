...
public class FormatTest {
   ...
   * @return integer
  **/
  @Min(value = 10) @Max(value = 100) @ApiModelProperty(value = "") public Integer getInteger() {
    return integer;
  }
   ...
   * @return int32
  **/
  @Min(value = 20) @Max(value = 200) @ApiModelProperty(value = "") public Integer getInt32() {
    return int32;
  }
   ...
   * @return int64
  **/
  @ApiModelProperty(value = "") public Long getInt64() {
    return int64;
  }
   ...
   * @return number
  **/
  @NotNull @Valid @DecimalMin(value = "32.1") @DecimalMax(value = "543.2") @ApiModelProperty(required = true, value = "") public BigDecimal getNumber() {
    return number;
  }
   ...
   * @return _float
  **/
  @DecimalMin(value = "54.3") @DecimalMax(value = "987.6") @ApiModelProperty(value = "") public Float getFloat() {
    return _float;
  }
   ...
   * @return _double
  **/
  @DecimalMin(value = "67.8") @DecimalMax(value = "123.4") @ApiModelProperty(value = "") public Double getDouble() {
    return _double;
  }
   ...
   * @return string
  **/
  @Pattern(regexp = "/[a-z]/i") @ApiModelProperty(value = "") public String getString() {
    return string;
  }
   ...
   * @return _byte
  **/
  @NotNull @ApiModelProperty(required = true, value = "") public byte[] getByte() {
    return _byte;
  }
   ...
   * @return binary
  **/
  @ApiModelProperty(value = "") public byte[] getBinary() {
    return binary;
  }
   ...
   * @return date
  **/
  @NotNull @Valid @ApiModelProperty(required = true, value = "") public LocalDate getDate() {
    return date;
  }
   ...
   * @return dateTime
  **/
  @Valid @ApiModelProperty(value = "") public OffsetDateTime getDateTime() {
    return dateTime;
  }
   ...
   * @return uuid
  **/
  @Valid @ApiModelProperty(value = "") public UUID getUuid() {
    return uuid;
  }
   ...
   * @return password
  **/
  @NotNull @Size(min = 10, max = 64) @ApiModelProperty(required = true, value = "") public String getPassword() {
    return password;
  }
