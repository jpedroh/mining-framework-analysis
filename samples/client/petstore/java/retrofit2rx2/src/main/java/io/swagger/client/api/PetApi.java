...
public interface PetApi {
   ...
   * @return Call&lt;Void&gt;
   */
  @Headers(value = { "Content-Type:application/json" }) @POST(value = "pet") Completable addPet(@retrofit2.http.Body Pet body);
   ...
   * @return Call&lt;Void&gt;
   */
  @DELETE(value = "pet/{petId}") Completable deletePet(@retrofit2.http.Path(value = "petId") Long petId, @retrofit2.http.Header(value = "api_key") String apiKey);
   ...
   * @return Call&lt;Void&gt;
   */
  @Headers(value = { "Content-Type:application/json" }) @PUT(value = "pet") Completable updatePet(@retrofit2.http.Body Pet body);
   ...
   * @return Call&lt;Void&gt;
   */
  @retrofit2.http.FormUrlEncoded @POST(value = "pet/{petId}") Completable updatePetWithForm(@retrofit2.http.Path(value = "petId") Long petId, @retrofit2.http.Field(value = "name") String name, @retrofit2.http.Field(value = "status") String status);
