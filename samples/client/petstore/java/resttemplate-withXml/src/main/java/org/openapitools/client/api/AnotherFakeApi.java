...
@javax.annotation.Generated(value = { "org.openapitools.codegen.languages.JavaClientCodegen" }) @Component(value = "org.openapitools.client.api.AnotherFakeApi") public class AnotherFakeApi {
  ...
  @Autowired public AnotherFakeApi(ApiClient apiClient) {
