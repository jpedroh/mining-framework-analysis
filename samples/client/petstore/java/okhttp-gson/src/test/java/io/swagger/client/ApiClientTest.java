...
public class ApiClientTest {
  ...
  @Test public void testIsJsonMime() {
  ...
  @Test public void testSelectHeaderAccept() {
  ...
  @Test public void testSelectHeaderContentType() {
  ...
  @Test public void testSetApiKeyAndPrefix() {
  ...
  @Test public void testGetAndSetConnectTimeout() {
  ...
  @Test public void testParameterToPairsWhenNameIsInvalid() throws Exception {
  ...
  @Test public void testParameterToPairsWhenValueIsNull() throws Exception {
    List<Pair> pairs = apiClient.parameterToPairs("csv", "param-a", null);
    assertTrue(pairs.isEmpty());
  }

  @Test public void testParameterToPairsWhenValueIsEmptyStrings() throws Exception {
    ...
    assertFalse(concatStrings.get(0).getValue().isEmpty());
  }

  @Test public void testParameterToPairsWhenValueIsNotCollection() throws Exception {
    String name = "param-a";
    Integer value = 1;
  ...
  @Test public void testParameterToPairsWhenValueIsCollection() throws Exception {
    ...
    collectionFormatMap.put("", ",");
    collectionFormatMap.put("unknown", ",");
    String name = "param-a";
