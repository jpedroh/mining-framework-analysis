...
public class MixedPropertiesAndAdditionalPropertiesClass {
  @SerializedName(value = "uuid") private UUID uuid = null;

  @SerializedName(value = "dateTime") private OffsetDateTime dateTime = null;

  @SerializedName(value = "map") private Map<String, Animal> map = null;
