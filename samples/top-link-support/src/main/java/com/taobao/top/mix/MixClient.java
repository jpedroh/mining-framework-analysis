...
public class MixClient {
  ...
  private MessageHandler createHandler() {
    return new MessageHandler() {
      @Override public void onMessage(Map<String, String> message, com.taobao.top.link.endpoint.Identity messageFrom) {
      ...
      @Override public void onMessage(EndpointContext context) throws LinkException {
