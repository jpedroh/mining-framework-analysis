...
public class MysqlConnection implements ErosaConnection {
  ...
  @Override public void dump(long timestamp, MultiStageCoprocessor coprocessor) throws IOException {
    throw new NullPointerException("Not implement yet");
  }
  ...
  private void sendRegisterSlave() throws IOException {
    ...
    cmd.reportPort = authInfo.getAddress().getPort();
  ...
  @Override public long queryServerId() throws IOException {
