      ...
      if (tableMetaTSDB == null) {
        synchronized (CanalEventParser.class) {
          try {
            ...
            tableMetaTSDB = 
<<<<<<< /usr/src/app/output/alibaba/canal/68d8afae3e9cb4c21c26b3f7c291759f0c9e7426/parse/src/main/java/com/alibaba/otter/canal/parse/inbound/mysql/AbstractMysqlEventParser.java/left.java
            TableMetaTSDBBuilder.build(destination, tsdbSpringXml)
=======
            tableMetaTSDBFactory.build(destination, tsdbSpringXml)
>>>>>>> /usr/src/app/output/alibaba/canal/68d8afae3e9cb4c21c26b3f7c291759f0c9e7426/parse/src/main/java/com/alibaba/otter/canal/parse/inbound/mysql/AbstractMysqlEventParser.java/right.java
            ;
          }  finally {
  ...
  protected MultiStageCoprocessor buildMultiStageCoprocessor() {
    return new MysqlMultiStageCoprocessor(parallelBufferSize, parallelThreadSize, (LogEventConvert) binlogParser, transactionBuffer, destination);
  }
