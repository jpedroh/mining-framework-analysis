...
public class RobotiumUtils {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> ArrayList<T> filterViews(Class<T> classToFilterBy, Iterable<?> viewList) {
  ...
  static void turnOnOffWifi(Solo solo, Boolean status) {
    ...
    if (status == true && !wifiManager.isWifiEnabled()) {
      ...
      if (status == false && wifiManager.isWifiEnabled()) {
  ...
  @UiThreadTest @SuppressWarnings(value = { "deprecation" }) void unlockDevice(Solo solo, String activityName) {
...
=======
    locker
>>>>>>> /usr/src/app/output/robotiumtech/robotium/cf5465c6653b115f8a28582189859cb782f1a84a/robotium-solo/src/main/java/com/robotium/solo/RobotiumUtils.java/right.java
     = keyGuardManager.newKeyguardLock(activityName);
    ((KeyguardLock) 
<<<<<<< /usr/src/app/output/robotiumtech/robotium/cf5465c6653b115f8a28582189859cb782f1a84a/robotium-solo/src/main/java/com/robotium/solo/RobotiumUtils.java/left.java
    lock
=======
...
>>>>>>> /usr/src/app/output/robotiumtech/robotium/cf5465c6653b115f8a28582189859cb782f1a84a/robotium-solo/src/main/java/com/robotium/solo/RobotiumUtils.java/right.java
  ...
  static void checkMemory() {
    ...
    double availableMem = Double.valueOf(Runtime.getRuntime().freeMemory());
    System.out.println("Runtime Memory info: TotalMem=" + Math.round(totalMem / 1048576) + "mb. MaxMemory" + Math.round(maxMem / 1048576) + " mb. AvailableMemory=" + Math.round(availableMem / 1048576) + " mb.");
  }
}