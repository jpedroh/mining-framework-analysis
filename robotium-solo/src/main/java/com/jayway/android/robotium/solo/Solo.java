...
public class Solo {
  ...
  public void assertText(int id) {
    Assert.assertTrue("text with id " + id + " not found", waitForView(id, 1, Timeout.getLargeTimeout(), true));
  }
  ...
  public void assertView(int id) {
    Assert.assertTrue("view with id " + id + " not found", waitForView(id, 1, Timeout.getLargeTimeout(), true));
  }
  ...
  /**
	 ...
	 * 
	 */
  @SuppressWarnings(value = { "unchecked" }) public void assertCurrentActivity(String message, @SuppressWarnings(value = { "rawtypes" }) Class activityClass) {
  ...
  /**
	 ...
	 * 
	 */
  @SuppressWarnings(value = { "unchecked" }) public void assertCurrentActivity(String message, @SuppressWarnings(value = { "rawtypes" }) Class activityClass, boolean isNewInstance) {
  ...
  /**
	 ...
	 *
	 */
  @SuppressWarnings(value = { "unchecked" }) public boolean scrollDown() {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) public void scrollToBottom() {
    waiter.waitForViews(AbsListView.class, ScrollView.class, WebView.class);
  ...
  /**
	 ...
	 *
	 */
  @SuppressWarnings(value = { "unchecked" }) public boolean scrollUp() {
    waiter.waitForViews(AbsListView.class, ScrollView.class, WebView.class);
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) public void scrollToTop() {
    waiter.waitForViews(AbsListView.class, ScrollView.class, WebView.class);
  ...
  public void scrollToSide(int side, float scrollPosition) {
    switch (side) {
      case RIGHT:
      scroller.scrollToSide(Scroller.Side.RIGHT, scrollPosition);
      break;
      case LEFT:
      scroller.scrollToSide(Scroller.Side.LEFT, scrollPosition);
      break;
    }
  }
  ...
  public void scrollToSide(int side) {
    switch (side) {
      case RIGHT:
      scroller.scrollToSide(Scroller.Side.RIGHT, 0.55F);
      break;
      case LEFT:
      scroller.scrollToSide(Scroller.Side.LEFT, 0.55F);
      break;
    }
  }
  ...
  public void scrollViewToSide(View view, int side, float scrollPosition) {
    switch (side) {
      case RIGHT:
      scroller.scrollViewToSide(view, Scroller.Side.RIGHT, scrollPosition);
      break;
      case LEFT:
      scroller.scrollViewToSide(view, Scroller.Side.LEFT, scrollPosition);
      break;
    }
  }
  ...
  public void scrollViewToSide(View view, int side) {
    switch (side) {
      case RIGHT:
      scroller.scrollViewToSide(view, Scroller.Side.RIGHT, 0.55F);
      break;
      case LEFT:
      scroller.scrollViewToSide(view, Scroller.Side.LEFT, 0.55F);
      break;
    }
  }
  ...
  public void swipe(PointF startPoint1, PointF startPoint2, PointF endPoint1, PointF endPoint2) {
    ...
    swiper.generateSwipeGesture(startPoint1, startPoint2, endPoint1, endPoint2);
  }
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) public boolean isTextChecked(String text) {
  ...
  public boolean waitForActivityStackToBeEmpty(int timeout) {
    return waiter.waitForCondition(new Condition() {
  ...
  /**
	 ...
	 * 
	 */
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) private static int initializeTimeout(String property, int defaultValue) {
    try {
