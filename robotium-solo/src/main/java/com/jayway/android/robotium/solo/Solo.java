...
public class Solo {
  ...
  /**
	 ...
	 * 
	 */
  @SuppressWarnings(value = { "unchecked" }) public void assertCurrentActivity(String message, @SuppressWarnings(value = { "rawtypes" }) Class expectedClass) {
  ...
  /**
	 ...
	 * 
	 */
  @SuppressWarnings(value = { "unchecked" }) public void assertCurrentActivity(String message, @SuppressWarnings(value = { "rawtypes" }) Class expectedClass, boolean isNewInstance) {
  ...
  public void scrollViewToSide(View view, int side) {
    switch (side) {
      case RIGHT:
      scroller.scrollViewToSide(view, Scroller.Side.RIGHT);
      break;
      case LEFT:
      scroller.scrollViewToSide(view, Scroller.Side.LEFT);
      break;
    }
  }
  ...
  /**
	 ...
	 *
	 */
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) public <T extends LinearLayout> ArrayList<T> getCurrentNumberPickers() {
    try {
