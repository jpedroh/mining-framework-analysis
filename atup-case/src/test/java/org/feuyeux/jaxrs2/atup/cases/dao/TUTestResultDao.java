...
@ContextConfiguration(locations = { "classpath:applicationContext.xml" }) @RunWith(value = SpringJUnit4ClassRunner.class) public class TUTestResultDao {
  @Autowired AtupTestResultDao dao;

  @Test public void testCreateResultCase() {
  ...
  @Test public void testUpdateTestCase() {
    final AtupTestResult entity = CreateTestResult.buildTestResult();
    final AtupTestResult savedEntity = dao.save(entity);
  ...
  @Test public void testDeleteTestCase() {
    final AtupTestResult entity = CreateTestResult.buildTestResult();
    final AtupTestResult savedEntity = dao.save(entity);
  ...
  @Test public void testFindByStatus() {
  ...
  @Test public void testFindByTestCase() {
