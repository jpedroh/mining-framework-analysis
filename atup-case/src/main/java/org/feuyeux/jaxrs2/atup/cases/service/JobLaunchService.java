...
@Service public class JobLaunchService {
  ...
  @Autowired AtupDeviceDao deviceDao;

  @Autowired AtupTestResultDao resultDao;

  @Autowired AtupTestCaseDao testCaseDao;

  @Autowired AtupUserDao userDao;
        ...
        while (highIterator.hasNext()) {
          try {
            ...
            if (deviceStatus.equals(AtupParam.DEVICE_IDLE)) {
              ...
              final Integer status = request.rest(AtupRequest.POST, launchPath, null, null, MediaType.APPLICATION_JSON_TYPE, testCase, Integer.class);
