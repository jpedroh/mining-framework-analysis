...
public class JsonSelectorView extends AbstractYogaView {
  @Override public void render(Selector selector, Object value, YogaRequestContext requestContext, OutputStream outputStream) throws IOException {
  ...
  @Override public String getHrefSuffix() {
    return "json";
  }
}