...
public class CoreSelector extends MapSelector {
  ...
  @Override protected Collection<Property> getFieldCollection(Class<?> instanceType) {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected Collection<String> getAllowedCoreFields(Class<?> instanceType) {
    Object populator = _populatorRegistry == null ? null : _populatorRegistry.getFieldPopulator(instanceType);
    if (populator != null) {
  ...
  @Override public Collection<Property> getAllPossibleFields(Class<?> instanceType) {
