...
public class SampleDocumentGeneratorTest {
  @Test public void testGenerateSimplePlainDocument() throws DocumentValidatorException {
    String sampleText = "";
  ...
  @Test public void testGenerateSimpleWikiDocument() throws DocumentValidatorException {
    String sampleText = "";
  ...
  @Test public void testGenerateSimpleMarkdownDocument() throws DocumentValidatorException {
    String sampleText = "";
  ...
  @Test(expected = NullPointerException.class) public void testInputNullDocument() throws DocumentValidatorException {
