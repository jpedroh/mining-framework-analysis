...
public class SentenceLengthValidatorTest {
  @Test public void testWithLongSentence() {
    SentenceLengthValidatorForTest validator = new SentenceLengthValidatorForTest();
    validator.setLengthLimit(30);
    Sentence str = new Sentence("this is a very long long long long long long" + "long long long long long long sentence.", 0);
    List<ValidationError> error = validator.check(str);
    assertNotNull(error);
    assertEquals(1, error.size());
  }

  @Test public void testWithShortSentence() {
    SentenceLengthValidatorForTest validator = new SentenceLengthValidatorForTest();
    validator.setLengthLimit(30);
  ...
  @Test public void testWithZeroLengthSentence() {
    SentenceLengthValidatorForTest validator = new SentenceLengthValidatorForTest();
    validator.setLengthLimit(30);
