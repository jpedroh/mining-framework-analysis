...
public class ValidationError {
   ...
   */
  public ValidationError(String errorMessage, Sentence sentenceWithError) {
   ...
   */
  public ValidationError(int errorLineNumber, String errorMessage, String errorFileName) {
   ...
   * @param errorFileName file name in which the error occurs
   */
  public ValidationError(String errorMessage, Sentence sentenceWithError, String errorFileName) {
    this(sentenceWithError.position, errorMessage);
    this.sentence = sentenceWithError;
    this.fileName = errorFileName;
  }
