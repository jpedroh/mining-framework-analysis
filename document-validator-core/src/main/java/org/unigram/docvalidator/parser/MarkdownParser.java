...
public class MarkdownParser extends BasicDocumentParser {
  private PegDownProcessor pegDownProcessor = new PegDownProcessor(Extensions.HARDWRAPS + Extensions.AUTOLINKS + Extensions.FENCED_CODE_BLOCKS);

  MarkdownParser() {
    super();
  }

  @Override public FileContent generateDocument(String fileName) throws DocumentValidatorException {
  ...
  @Override public FileContent generateDocument(InputStream inputStream) throws DocumentValidatorException {
    ...
    try {
      ...
      ToFileContentSerializer serializer = new ToFileContentSerializer(fileContent, lineList, this.getSentenceExtractor());
