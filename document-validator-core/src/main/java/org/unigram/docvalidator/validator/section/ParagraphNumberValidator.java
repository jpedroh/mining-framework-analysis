...
public class ParagraphNumberValidator extends SectionValidator {
   ...
   */
  @SuppressWarnings(value = { "WeakerAccess" }) public static final int DEFAULT_MAX_PARAGRAPHS_IN_A_SECTION = 100;
  ...
  @Override protected List<ValidationError> check(Section section) {
    ...
    if (maxParagraphs < paragraphNumber) {
      validationErrors.add(new ValidationError("The number of the paragraphs exceeds the maximum " + String.valueOf(paragraphNumber), section.getHeaderContent(0)));
