...
@Controller public class CrudController {
  @Autowired private ViewDefinitionService viewDefinitionService;

  @Autowired private DataAccessService dataAccessService;

  @Autowired private TranslationService translationService;

  @RequestMapping(value = "page/{viewName}", method = RequestMethod.GET) public ModelAndView getView(@PathVariable(value = "viewName") final String viewName, @RequestParam final Map<String, String> arguments, final Locale locale) {
      ...
      if (viewElement instanceof FormDefinition) {
        ...
        for (FormFieldDefinition fieldDefEntry : form.getFields()) {
          if (fieldDefEntry.getDataField().getType() instanceof BelongsToType) {
            ...
            if (fieldDefEntry.getDataField().getType() instanceof EnumeratedFieldType) {
  ...
  @RequestMapping(value = "page/{viewName}/{elementName}/list", method = RequestMethod.GET) @ResponseBody public ListData getGridData(@PathVariable(value = "viewName") final String viewName, @PathVariable(value = "elementName") final String elementName, @RequestParam final Map<String, String> arguments) {
    ViewDefinition viewDefinition = viewDefinitionService.getViewDefinition(viewName);
  ...
  @RequestMapping(value = "page/{viewName}/{elementName}/entity", method = RequestMethod.GET) @ResponseBody public Entity getEntityData(@PathVariable(value = "viewName") final String viewName, @PathVariable(value = "elementName") final String elementName, @RequestParam final Map<String, String> arguments) {
    ViewDefinition viewDefinition = viewDefinitionService.getViewDefinition(viewName);
    ComponentDefinition element = viewDefinition.getElementByName(elementName);
  ...
  @RequestMapping(value = "page/{viewName}/{elementName}/save", method = RequestMethod.POST) @ResponseBody public ValidationResults saveEntity(@PathVariable(value = "viewName") final String viewName, @PathVariable(value = "elementName") final String elementName, @ModelAttribute final Entity entity, final Locale locale) {
    ViewDefinition viewDefinition = viewDefinitionService.getViewDefinition(viewName);
    ComponentDefinition element = viewDefinition.getElementByName(elementName);
  ...
  @RequestMapping(value = "page/{viewName}/{elementName}/delete", method = RequestMethod.POST) @ResponseBody public String deleteEntities(@PathVariable(value = "viewName") final String viewName, @PathVariable(value = "elementName") final String elementName, @RequestBody final List<Integer> selectedRows) {
    ViewDefinition viewDefinition = viewDefinitionService.getViewDefinition(viewName);
    ComponentDefinition element = viewDefinition.getElementByName(elementName);
  ...
  @RequestMapping(value = "page/{viewName}/{elementName}/move", method = RequestMethod.POST) @ResponseBody public String moveEntities(@PathVariable(value = "viewName") final String viewName, @PathVariable(value = "elementName") final String elementName, @RequestParam final Integer entityId, @RequestParam final Integer direction) {
    ViewDefinition viewDefinition = viewDefinitionService.getViewDefinition(viewName);
    ComponentDefinition element = viewDefinition.getElementByName(elementName);
