 ...
 * </ul></p>
 */
@Immutable public final class BedRecord {
  ...
  /**
     ...
     */
  private BedRecord(final Format format, final String chrom, final long start, final long end, final String name, final String score, final String strand, final long thickStart, final long thickEnd, final String itemRgb, final int blockCount, final long[] blockSizes, final long[] blockStarts) {
    checkNotNull(format);
    checkNotNull(chrom);
  ...
  /**
     ...
     * @param blockStarts block starts, must be the same length as block count
     */
  public BedRecord(final String chrom, final long start, final long end, final String name, final String score, final String strand, final long thickStart, final long thickEnd, final String itemRgb, final int blockCount, final long[] blockSizes, final long[] blockStarts) {
  ...
  @Override public boolean equals(final Object o) {
    ...
    return Objects.equals(format, bedRecord.format) && Objects.equals(chrom, bedRecord.chrom) && Objects.equals(start, bedRecord.start) && Objects.equals(end, bedRecord.end) && Objects.equals(name, bedRecord.name) && Objects.equals(score, bedRecord.score) && Objects.equals(strand, bedRecord.strand) && Objects.equals(thickStart, bedRecord.thickStart) && Objects.equals(thickEnd, bedRecord.thickEnd) && Objects.equals(itemRgb, bedRecord.itemRgb) && Objects.equals(blockCount, bedRecord.blockCount) && Objects.equals(blockSizes, bedRecord.blockSizes) && Objects.equals(blockStarts, bedRecord.blockStarts);
  }
