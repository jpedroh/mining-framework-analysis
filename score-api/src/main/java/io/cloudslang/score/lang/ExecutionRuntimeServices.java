...
public class ExecutionRuntimeServices implements Serializable {
  ...
  public private static final String LIC_SWITCH_MODE = "LIC_SWITCH_MODE";
  ...
  public void addEvent(String eventType, Serializable eventData) {
    @SuppressWarnings(value = { "unchecked" }) Queue<ScoreEvent> eventsQueue = getFromMap(SCORE_EVENTS_QUEUE);
    if (eventsQueue == null) {
  ...
  protected <T extends java.lang.Object> T getFromMap(String key) {
  ...
  public void addBranchForParallelLoop(Long startPosition, String flowUuid, Map<String, Serializable> context) {
    ...
    branches.add(new StartBranchDataContainer(startPosition, runningPlanId, context, new SystemContext(contextMapForBranch, true)));
  }
  ...
  public Double getRoiValue() {
    return (Double) contextMap.getOrDefault(ExecutionParametersConsts.EXECUTION_TOTAL_ROI, ExecutionParametersConsts.DEFAULT_ROI_VALUE);
  }
  ...
  private <T extends java.lang.Object> T removeFromMap(String key) {
