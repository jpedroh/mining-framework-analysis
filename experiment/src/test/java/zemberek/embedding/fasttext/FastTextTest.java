...
public class FastTextTest {
   ...
   */
  @Test @Ignore(value = "Not an actual Test.") public void dbpediaClassificationTest() throws Exception {
   ...
   * Runs the dbpedia classification task. run with -Xms8G or more.
   */
  @Test @Ignore(value = "Not an actual Test.") public void quantizationTest() throws Exception {
   ...
   */
  @Test @Ignore(value = "Not an actual Test.") public void skipgram() throws Exception {
