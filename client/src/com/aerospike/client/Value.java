...
public abstract class Value {
  ...
  public static final class NullValue extends Value {
    ...
    @Override public void pack(Packer packer) {
      packer.packNil();
    }

    @Override public void validateKeyType() {
    ...
    @Override public LuaValue getLuaValue(LuaInstance instance) {
      return LuaNil.NIL;
    }
  ...
  public static final class ByteSegmentValue extends Value {
    ...
    @Override public int write(byte[] buffer, int targetOffset) {
  ...
  public static final class ShortValue extends Value {
    ...
    @Override public boolean equals(Object other) {
      return (other != null && this.getClass().equals(other.getClass()) && this.value == ((ShortValue) other).value);
    }
...
=======
  public static final class BlobValue extends Value {
    ...
    @Override public int estimateSize() throws AerospikeException.Serialize {
...
>>>>>>> /usr/src/app/output/aerospike/aerospike-client-java/924fe34da0c425c1587a7edfff62947ecd8307d7/client/src/com/aerospike/client/Value.java/right.java
  ...
  public static final class GeoJSONValue extends Value {
    ...
    @Override public int write(byte[] buffer, int offset) {
      ...
      return 1 + 2 + Buffer.stringToUtf8(value, buffer, offset + 3);
    }
  ...
  public static final class HLLValue extends Value {
    ...
    @Override public boolean equals(Object other) {
      return (other != null && this.getClass().equals(other.getClass()) && Arrays.equals(this.bytes, ((HLLValue) other).bytes));
    }
  ...
  public static final class ValueArray extends Value {
    ...
    @Override public int estimateSize() throws AerospikeException {
