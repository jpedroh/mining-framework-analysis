 ...
 */
public abstract class Unpacker<T extends java.lang.Object> {
  ...
  @SuppressWarnings(value = { "unchecked" }) private T unpackTreeMap(int count) throws IOException, ClassNotFoundException {
  ...
  @SuppressWarnings(value = { "unchecked" }) private T unpackMapAsList(int count) throws IOException, ClassNotFoundException {
...
>>>>>>> /usr/src/app/output/aerospike/aerospike-client-java/924fe34da0c425c1587a7edfff62947ecd8307d7/client/src/com/aerospike/client/util/Unpacker.java/right.java
  ...
  public static final class ObjectUnpacker extends Unpacker<Object> {
    ...
    @Override protected Object getMap(Map<Object, Object> value) {
      return value;
    }

    @Override protected Object getList(List<Object> value) {
      return value;
    }

    @Override protected Object getBlob(byte[] value) {
      return value;
    }

    @Override protected Object getString(String value) {
      return value;
    }

    @Override protected Object getLong(long value) {
      return value;
    }

    @Override protected Object getDouble(double value) {
      return value;
    }

    @Override protected Object getBoolean(boolean value) {
      return value;
    }

    @Override protected Object getGeoJSON(String value) {
