...
public class ReflectionClassDeclarationTest extends AbstractSymbolResolutionTest {
  ...
  @Test public void testIsClass() {
    class Foo<E extends java.lang.Object> {
      E field;
    }
  ...
  @Test public void testGetSuperclassSimpleImplicit() {
    class Foo<E extends java.lang.Object> {
      E field;
    }
    TypeSolver typeResolver = new ReflectionTypeSolver();
  ...
  @Test public void testGetSuperclassSimple() {
    class Bar {
    }
    class Foo<E extends java.lang.Object> extends Bar {
      E field;
    }
    TypeSolver typeResolver = new ReflectionTypeSolver();
    ResolvedClassDeclaration foo = new ReflectionClassDeclaration(Foo.class, typeResolver);
  ...
  @Test public void testGetSuperclassWithGenericSimple() {
    class Foo<E extends java.lang.Object> {
      E field;
    }
    class Bar extends Foo<String> {
  ...
  @Test public void testGetSuperclassWithGenericInheritanceSameName() {
    ...
    class Bar<E extends java.lang.Object> extends Foo<E> {
    }
    TypeSolver typeResolver = new ReflectionTypeSolver();
    ResolvedClassDeclaration foo = new ReflectionClassDeclaration(Foo.class, typeResolver);
    ResolvedClassDeclaration bar = new ReflectionClassDeclaration(Bar.class, typeResolver);
  ...
  @Test public void testGetSuperclassWithGenericInheritanceDifferentName() {
    class Foo<E extends java.lang.Object> {
      E field;
    }
    class Bar extends Foo<String> {
  ...
  @Test public void testGetFieldDeclarationTypeVariableInheritance() {
    class Foo<E extends java.lang.Object> {
      E field;
    }
    class Bar extends Foo<String> {
  ...
  @Test public void testGetDeclaredMethods() {
    TypeSolver typeResolver = new ReflectionTypeSolver();
    ResolvedReferenceTypeDeclaration string = new ReflectionClassDeclaration(String.class, typeResolver);
    List<ResolvedMethodDeclaration> methods = string.getDeclaredMethods().stream().filter((m) -> m.accessSpecifier() != PRIVATE && m.accessSpecifier() != DEFAULT).sorted(
<<<<<<< /usr/src/app/output/javaparser/javaparser/cd9f929c5b0a9ae549c9845b9e2e6dcb7b182a86/javaparser-symbol-solver-testing/src/test/java/com/github/javaparser/symbolsolver/reflectionmodel/ReflectionClassDeclarationTest.java/left.java
    comparing(ResolvedDeclaration::getName)
=======
    Comparator.comparing(ResolvedDeclaration::getName)
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void testGetAllSuperclasses() {
    TypeSolver typeResolver = new ReflectionTypeSolver();
    ResolvedClassDeclaration arraylist = new ReflectionClassDeclaration(ArrayList.class, typeResolver);
  ...
  @Test public void testAllAncestors() {
    TypeSolver typeResolver = new ReflectionTypeSolver();
    ResolvedClassDeclaration arraylist = new ReflectionClassDeclaration(ArrayList.class, typeResolver);
  ...
  @Test public void testGetSuperclassWithoutTypeParameters() {
  ...
  @Test public void testGetSuperclassWithTypeParameters() {
  ...
  @Test public void testGetAllSuperclassesWithoutTypeParameters() {
  ...
  @Test public void testGetAllSuperclassesWithTypeParameters() {
  ...
  @Test public void testGetAllInterfacesWithParameters() {
    ReflectionClassDeclaration constructorDeclaration = (ReflectionClassDeclaration) typeResolver.solveType("com.github.javaparser.ast.body.ConstructorDeclaration");
  ...
  @Test public void testGetAncestorsWithTypeParameters() {
    ReflectionClassDeclaration constructorDeclaration = (ReflectionClassDeclaration) typeResolver.solveType("com.github.javaparser.ast.body.ConstructorDeclaration");
  ...
  @Test public void testGetAllAncestorsWithoutTypeParameters() {
    ReflectionClassDeclaration cu = (ReflectionClassDeclaration) typeResolver.solveType("com.github.javaparser.ast.CompilationUnit");
