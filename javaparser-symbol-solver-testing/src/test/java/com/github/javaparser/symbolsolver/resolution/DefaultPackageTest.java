...
public class DefaultPackageTest {
  ...
  @Test public void aClassInDefaultPackageCanBeAccessedFromTheDefaultPackage() {
  ...
  @Test(expected = UnsolvedSymbolException.class) public void aClassInDefaultPackageCanBeAccessedFromOutsideTheDefaultPackageWithoutImportingIt() {
