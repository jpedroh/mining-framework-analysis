...
@Configuration @ComponentScan(value = { "com.salesmanager.shop" }) @ServletComponentScan @Import(value = { CoreApplicationConfiguration.class }) @EnableWebSecurity public class ShopApplicationConfiguration implements WebMvcConfigurer {
  ...
  @Bean public FilterRegistrationBean<XssFilter> croseSiteFilter() {
