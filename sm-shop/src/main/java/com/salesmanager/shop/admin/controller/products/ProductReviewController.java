...
@Controller public class ProductReviewController {
  ...
  @PreAuthorize(value = "hasRole(\'PRODUCTS\')") @RequestMapping(value = "/admin/products/reviews.html", method = RequestMethod.GET) public String displayProductReviews(@RequestParam(value = "id") long productId, Model model, HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
  ...
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) @PreAuthorize(value = "hasRole(\'PRODUCTS\')") @RequestMapping(value = "/admin/products/reviews/paging.html", method = RequestMethod.POST) public @ResponseBody ResponseEntity<String> pageProductReviews(HttpServletRequest request, HttpServletResponse response) {
  ...
  @PreAuthorize(value = "hasRole(\'PRODUCTS\')") @RequestMapping(value = "/admin/products/reviews/remove.html", method = RequestMethod.POST) public @ResponseBody ResponseEntity<String> deleteProductReview(HttpServletRequest request, HttpServletResponse response, Locale locale) {
