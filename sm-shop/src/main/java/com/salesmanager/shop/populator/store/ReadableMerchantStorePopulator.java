...
public class ReadableMerchantStorePopulator extends AbstractDataPopulator<MerchantStore, ReadableMerchantStore> {
  ...
  @Override public ReadableMerchantStore populate(MerchantStore source, ReadableMerchantStore target, MerchantStore store, Language language) throws ConversionException {
  ...
  @Override protected ReadableMerchantStore createTarget() {
    return null;
  }
