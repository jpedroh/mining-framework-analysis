...
@SpringBootTest(classes = ShopApplication.class, webEnvironment = WebEnvironment.RANDOM_PORT) @RunWith(value = SpringRunner.class) public class CategoryManagementAPIIntegrationTest extends ServicesTestSupport {
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void getCategory() throws Exception {
    final HttpEntity<String> httpEntity = new HttpEntity<>(getHeader());
    final ResponseEntity<ReadableCategoryList> response = testRestTemplate.exchange(String.format("/api/v1/category/"), HttpMethod.GET, httpEntity, ReadableCategoryList.class);
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void postCategory() throws Exception {
  ...
  @Test public void putCategory() throws Exception {
    PersistableCategory newCategory = new PersistableCategory();
    ...
    final ResponseEntity<ReadableCategory> readableQuery = testRestTemplate.exchange(String.format("/api/v1//category/" + description.getFriendlyUrl()), HttpMethod.GET, httpEntity, ReadableCategory.class);
  ...
  @Test public void postComplexCategory() throws Exception {
  ...
  @Test public void manufacturerForItemsInCategory() throws Exception {
    ObjectWriter writer = new ObjectMapper().writer().withDefaultPrettyPrinter();
    PersistableManufacturer m1 = super.manufacturer("BRAND1");
    String json = writer.writeValueAsString(m1);
    HttpEntity<String> entity = new HttpEntity<>(json, getHeader());
    @SuppressWarnings(value = { "rawtypes" }) ResponseEntity response = testRestTemplate.postForEntity("/api/v1/private/manufacturer", entity, PersistableManufacturer.class);
    assertThat(response.getStatusCode(), is(CREATED));
    ...
    entity = new HttpEntity<>(json, getHeader());
    @SuppressWarnings(value = { "rawtypes" }) ResponseEntity categoryResponse = testRestTemplate.postForEntity("/api/v1/private/category", entity, PersistableCategory.class);
    ...
    @SuppressWarnings(value = { "rawtypes" }) ResponseEntity<List> manufacturers = testRestTemplate.exchange(String.format("/api/v1/category/" + id + "/manufacturer"), HttpMethod.GET, entity, List.class);
    assertThat(manufacturers.getStatusCode(), is(OK));
    @SuppressWarnings(value = { "unchecked" }) List<ReadableManufacturer> manufacturerList = manufacturers.getBody();
  }
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void getByCategoryFriendlyUrl() throws Exception {
    ObjectWriter writer = new ObjectMapper().writer().withDefaultPrettyPrinter();
    ...
    assertThat(response.getStatusCode(), is(CREATED));
    assertNotNull(cat.getId());
    final ResponseEntity<ReadableCategory> readResponse = testRestTemplate.exchange(String.format("/api/v1/category/" + categoryName), HttpMethod.GET, entity, ReadableCategory.class);
