...
public final class UpdateMojoTest {
  ...
  @Test public void test_skipExistingHeaders() throws Exception {
  ...
  @Test public void test_issue50() throws Exception {
  ...
  @Test public void test_issue48() throws Exception {
  ...
  @Test public void test_issue44() throws Exception {
    ...
    updater.project = new MavenProjectStub();
    updater.execute();
    assertEquals(FileUtils.read(new File(tmp, "issue44-3.rb"), System.getProperty("file.encoding")), "#" + LS + "" + "# My @Copyright license 2 with my-custom-value and 2008 and issue44-3.rb" + LS + "" + "#" + LS + "" + "" + LS + "" + "# code comment" + LS + "" + "ruby code here" + LS + "");
  ...
  @Test public void test_issue_14() throws Exception {
  ...
  @Test public void test_issue71_canSkipSeveralLines() throws Exception {
    ...
    assertThat(linesOfModifiedFile.get(0), is("|||"));
    assertThat(linesOfModifiedFile.get(8), is("|||"));
  }

  @Test public void test_UpdateWorksHasExpectedOnAOneLineCommentFile_relatesTo_issue30() throws Exception {
