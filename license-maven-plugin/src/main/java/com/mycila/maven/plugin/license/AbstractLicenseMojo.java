...
public abstract class AbstractLicenseMojo extends AbstractMojo {
  ...
  /**
     ...
     */
  @Parameter public String[] validHeaders = new String[0];
  ...
  /**
     ...
     */
  @Parameter public String[] headerDefinitions = new String[0];

  /**
     * HeadSections define special regions of a header that allow for dynamic
     * substitution and validation
     */
  @Parameter public HeaderSection[] headerSections = new HeaderSection[0];
  ...
  /**
     ...
     */
  @Parameter public Map<String, String> properties = new HashMap<String, String>();

  /**
     * Specifies files, which are included in the check. By default, all files
     * are included.
     */
  @Parameter(property = "license.includes") public String[] includes = new String[0];
  ...
  /**
     ...
     */
  @Parameter(property = "license.excludes") public String[] excludes = new String[0];
  ...
  /**
     ...
     */
  @Parameter public String[] keywords = new String[] { "copyright" };
  ...
  /**
     ...
     * and so on.
     */
  @Parameter(property = "license.useDefaultExcludes", defaultValue = "true") public boolean useDefaultExcludes = true;
  ...
  /**
     ...
     */
  @Parameter public LinkedHashMap<String, String> mapping = new LinkedHashMap<String, String>();
  ...
  @Component public MavenProject project;
  ...
  @SuppressWarnings(value = { "unchecked" }) public final void execute(final Callback callback) throws MojoExecutionException, MojoFailureException {
    if (!skip) {
      if (!hasHeader()) {
      ...
      final DocumentPropertiesLoader propertiesLoader = new DocumentPropertiesLoader() {
        @Override public Properties load(Document document) {
  ...
  private boolean hasHeader() {
    return (multi != null && ((multi.headers != null && multi.headers.length > 0) || (multi.inlineHeaders != null && multi.inlineHeaders.length > 0 && !multi.inlineHeaders[0].isEmpty()))) || (header != null || (inlineHeader != null && !this.inlineHeader.isEmpty()));
  }
