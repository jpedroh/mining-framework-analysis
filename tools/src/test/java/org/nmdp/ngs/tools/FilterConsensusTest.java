...
public final class FilterConsensusTest {
  ...
  @Test public void testEmptyReadGenomicFile() throws Exception {
    Map<Integer, Allele> exons = readGenomicFile(inputGenomicFile);
    assertTrue(exons.isEmpty());
  }

  @Test(expected = IOException.class) public void testReadGenomicFileInvalidTokens() throws Exception {
    copyResource("invalid-tokens.txt", inputGenomicFile);
    readGenomicFile(inputGenomicFile);
  }

  @Test(expected = IOException.class) public void testReadGenomicFileInvalidExon() throws Exception {
    copyResource("invalid-exon.txt", inputGenomicFile);
    readGenomicFile(inputGenomicFile);
  }

  @Test(expected = IOException.class) public void testReadGenomicFileInvalidLocus() throws Exception {
    copyResource("invalid-locus.txt", inputGenomicFile);
    readGenomicFile(inputGenomicFile);
  }

  @Test public void testReadGenomicFile() throws Exception {
  ...
  @Test public void testEmptyCigarToEditList() throws Exception {
  ...
  @Test public void testRunPloidy() throws Exception {
