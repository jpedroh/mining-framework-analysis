...
@RequestMapping(value = "/console/namespaces/{namespace:.+}/jobs") public class JobOverviewController extends AbstractGUIController {
  ...
  /**
	 ...
	 * @return 作业细节
	 */
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success/Fail", response = RequestResult.class) }) @GetMapping public SuccessResponseEntity getJobsWithCondition(final HttpServletRequest request, @PathVariable String namespace, @RequestParam Map<String, Object> condition, @RequestParam(required = false, defaultValue = "1") int page, @RequestParam(required = false, defaultValue = "25") int size) throws SaturnJobConsoleException {
  ...
  /**
     ...
     */
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success/Fail", response = RequestResult.class) }) @GetMapping(value = "/counts") public SuccessResponseEntity countJobsStatus(final HttpServletRequest request, @PathVariable String namespace) throws SaturnJobConsoleException {
  ...
  /**
	 ...
	 * @return 全域作业名字
	 */
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success/Fail", response = RequestResult.class) }) @GetMapping(value = "/names") public SuccessResponseEntity getJobNames(@PathVariable String namespace) throws SaturnJobConsoleException {
    return new SuccessResponseEntity(jobService.getJobNames(namespace));
  }

  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success/Fail", response = RequestResult.class) }) @GetMapping(value = "/sharding/status") public SuccessResponseEntity getJobsShardingStatus(@PathVariable String namespace, @RequestParam(required = false) List<String> jobNames) throws SaturnJobConsoleException {
    Map<String, String> jobShardingMap = new HashMap<>();
    if (!CollectionUtils.isEmpty(jobNames)) {
      for (String jobName : jobNames) {
        JobStatus jobStatus = jobService.getJobStatus(namespace, jobName);
        boolean isAllocated = !JobStatus.STOPPED.equals(jobStatus) && jobService.isJobShardingAllocatedExecutor(namespace, jobName);
        if (isAllocated) {
  ...
  private void preHandleCondition(Map<String, Object> condition) {
    if (condition.containsKey(QUERY_CONDITION_GROUP) && SaturnConstants.NO_GROUPS_LABEL.equals(condition.get(QUERY_CONDITION_GROUP))) {
  ...
  private JobOverviewVo countJobOverviewVo(String namespace) throws SaturnJobConsoleException {
    JobOverviewVo jobOverviewVo = new JobOverviewVo();
    jobOverviewVo.setTotalNumber(jobService.countUnSystemJobsWithCondition(namespace, Maps.<String, Object>newHashMap()));
  ...
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success/Fail", response = RequestResult.class) }) @Audit @PostMapping(value = "/{jobName}/enable") public SuccessResponseEntity enableJob(final HttpServletRequest request, @AuditParam(value = "namespace") @PathVariable String namespace, @AuditParam(value = "jobName") @PathVariable String jobName) throws SaturnJobConsoleException {
    assertIsPermitted(PermissionKeys.jobEnable, namespace);
    jobService.enableJob(namespace, jobName, getCurrentLoginUserName());
    return new SuccessResponseEntity();
  }

  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success/Fail", response = RequestResult.class) }) @Audit @PostMapping(value = "/enable") public SuccessResponseEntity batchEnableJob(final HttpServletRequest request, @AuditParam(value = "namespace") @PathVariable String namespace, @AuditParam(value = "jobNames") @RequestParam List<String> jobNames) throws SaturnJobConsoleException {
  ...
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success/Fail", response = RequestResult.class) }) @Audit @DeleteMapping(value = "/{jobName}") public SuccessResponseEntity removeJob(final HttpServletRequest request, @AuditParam(value = "namespace") @PathVariable String namespace, @AuditParam(value = "jobName") @PathVariable String jobName) throws SaturnJobConsoleException {
  ...
  /**
     * 批量设置作业的优先Executor
     */
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success/Fail", response = RequestResult.class) }) @Audit @PostMapping(value = "/preferExecutors") public SuccessResponseEntity batchSetPreferExecutors(final HttpServletRequest request, @AuditParam(value = "namespace") @PathVariable String namespace, @AuditParam(value = "jobNames") @RequestParam List<String> jobNames, @AuditParam(value = "preferList") @RequestParam String preferList) throws SaturnJobConsoleException {
  ...
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success/Fail", response = RequestResult.class) }) @Audit @PostMapping(value = "/jobs") public SuccessResponseEntity createJob(final HttpServletRequest request, @AuditParam(value = "namespace") @PathVariable String namespace, JobConfig jobConfig) throws SaturnJobConsoleException {
  ...
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success/Fail", response = RequestResult.class) }) @Audit @GetMapping(value = "/export") public void exportJobs(final HttpServletRequest request, @AuditParam(value = "namespace") @PathVariable String namespace, final HttpServletResponse response) throws SaturnJobConsoleException {
  ...
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success/Fail", response = RequestResult.class) }) @GetMapping(value = "/arrangeLayout") public SuccessResponseEntity getArrangeLayout(final HttpServletRequest request, @PathVariable String namespace) throws SaturnJobConsoleException {
