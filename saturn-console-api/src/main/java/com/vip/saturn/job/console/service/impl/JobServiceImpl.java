...
public class JobServiceImpl implements JobService {
  ...
  @Transactional(rollbackFor = Exception.class) @Override public void enableJob(String namespace, String jobName, String updatedBy) throws SaturnJobConsoleException {
  ...
  @Transactional(rollbackFor = Exception.class) @Override public void disableJob(String namespace, String jobName, String updatedBy) throws SaturnJobConsoleException {
    JobConfig4DB jobConfig = currentJobConfigService.findConfigByNamespaceAndJobName(namespace, jobName);
    if (jobConfig == null) {
  ...
  @Transactional(rollbackFor = Exception.class) @Override public void removeJob(String namespace, String jobName) throws SaturnJobConsoleException {
    ...
    if (!upStreamJobNames.isEmpty()) {
      throw new SaturnJobConsoleException(ERROR_CODE_NOT_EXISTED, "\u4e0d\u80fd\u5220\u9664\u8be5\u4f5c\u4e1a\uff08" + jobName + "\uff09\uff0c\u56e0\u4e3a\u8be5\u4f5c\u4e1a\u5b58\u5728\u4e0a\u6e38\u4f5c\u4e1a" + upStreamJobNames + "\uff0c\u8bf7\u5148\u65ad\u5f00\u4e0a\u4e0b\u6e38\u5173\u7cfb\u518d\u5220\u9664");
    }
    CuratorRepository.CuratorFrameworkOp curatorFrameworkOp = registryCenterService.getCuratorFrameworkOp(namespace);
...
>>>>>>> /usr/src/app/output/vipshop/saturn/22c8f49bc54909be8cf7fc2808fd41f4e9f389c3/saturn-console-api/src/main/java/com/vip/saturn/job/console/service/impl/JobServiceImpl.java/right.java
  ...
  @Transactional(rollbackFor = Exception.class) @Override public void setPreferList(String namespace, String jobName, String preferList, String updatedBy) throws SaturnJobConsoleException {
  ...
  private void validateDownStreamFieldOfJobConfig(String namespace, JobConfig jobConfig) throws SaturnJobConsoleException {
        ...
        for (JobConfig otherJobConfig : unSystemJobs) {
          if (childName.equals(otherJobConfig.getJobName())) {
            if (!JobType.isPassive(JobType.getJobType(otherJobConfig.getJobType()))) {
              throw new SaturnJobConsoleException(ERROR_CODE_BAD_REQUEST, "\u914d\u7f6e\u7684\u4e0b\u6e38\u4f5c\u4e1a(" + childName + ")\u4e0d\u662f\u88ab\u52a8\u4f5c\u4e1a");
            }
            found = true;
            break;
          }
  ...
  private Set<String> getAncestors(String namespace, String jobName, List<JobConfig> unSystemJobs, Stack<String> onePathRecords) {
  ...
  @Transactional(rollbackFor = Exception.class) @Override public void addJob(String namespace, JobConfig jobConfig, String createdBy) throws SaturnJobConsoleException {
    addOrCopyJob(namespace, jobConfig, null, createdBy);
  }

  @Transactional(rollbackFor = Exception.class) @Override public void copyJob(String namespace, JobConfig jobConfig, String jobNameCopied, String createdBy) throws SaturnJobConsoleException {
  ...
  private int getMaxZnodeDataLength() {
    int result = systemConfigService.getIntegerValue(SystemConfigProperties.MAX_ZNODE_DATA_LENGTH, DEFAULT_MAX_ZNODE_DATA_LENGTH);
  ...
  @Override public int countUnSystemJobsWithCondition(String namespace, Map<String, Object> condition) throws SaturnJobConsoleException {
    return currentJobConfigService.countConfigsByNamespaceWithCondition(namespace, condition);
  }

  @Override public int countEnabledUnSystemJobs(String namespace) throws SaturnJobConsoleException {
  ...
  @Override public List<String> getJobNames(String namespace) throws SaturnJobConsoleException {
  ...
  @Override public List<BatchJobResult> importJobs(String namespace, MultipartFile file, String createdBy) throws SaturnJobConsoleException {
    try {
  ...
  protected List<BatchJobResult> doCreateJobFromImportFile(String namespace, List<JobConfig> jobConfigList, String createdBy) {
  ...
  private JobConfig convertJobConfig(int sheetNumber, int rowNumber, Cell[] rowCells) throws SaturnJobConsoleException {
    ...
    if (downStream != null && !downStream.matches("[0-9a-zA-Z_,]*")) {
      throw new SaturnJobConsoleException(ERROR_CODE_BAD_REQUEST, createExceptionMessage(sheetNumber, rowNumber, 30, "\u4e0b\u6e38\u4f5c\u4e1a\u53ea\u5141\u8bb8\u5305\u542b\uff1a\u6570\u5b570-9\u3001\u5c0f\u5199\u5b57\u7b26a-z\u3001\u5927\u5199\u5b57\u7b26A-Z\u3001\u4e0b\u5212\u7ebf_\u3001\u82f1\u6587\u9017\u53f7,"));
    }
  ...
  protected void setExcelContent(String namespace, WritableSheet sheet1, List<JobConfig> unSystemJobs) throws SaturnJobConsoleException, WriteException {
    if (unSystemJobs != null && !unSystemJobs.isEmpty()) {
      ...
      for (int i = 0; i < unSystemJobs.size(); i++) {
        ...
        sheet1.addCell(new Label(29, i + 1, curatorFrameworkOp.getData(JobNodePath.getConfigNodePath(jobName, CONFIG_ITEM_DOWNSTREAM))));
      }
    }
  }
  ...
  @Override public ArrangeLayout getArrangeLayout(String namespace) throws SaturnJobConsoleException {
    ...
    Collections.sort(arrangeLayout.getPaths(), new Comparator<ArrangePath>() {
      @Override public int compare(ArrangePath o1, ArrangePath o2) {
    ...
    for (int i = 0; i <= maxLevel; i++) {
      arrangeLayout.getLevels().add(new ArrayList<String, ArrangeLevel>());
    }
    for (ArrangeNode node : nodes) {
      ...
      arrangeLayout.getLevels().get(level).add(
<<<<<<< /usr/src/app/output/vipshop/saturn/22c8f49bc54909be8cf7fc2808fd41f4e9f389c3/saturn-console-api/src/main/java/com/vip/saturn/job/console/service/impl/JobServiceImpl.java/left.java
      node.getName()
=======
      arrangeLevel
>>>>>>> /usr/src/app/output/vipshop/saturn/22c8f49bc54909be8cf7fc2808fd41f4e9f389c3/saturn-console-api/src/main/java/com/vip/saturn/job/console/service/impl/JobServiceImpl.java/right.java
    ...
    for (int i = 0; i <= maxLevel; i++) {
      Collections.sort(arrangeLayout.getLevels().get(i), new Comparator<ArrangeLevel>() {
        @Override public int compare(ArrangeLevel o1, ArrangeLevel o2) {
  ...
  private int getMaxArrangeNodeLevel(ArrangeNode currentNode, int level, Collection<ArrangeNode> nodes, Stack<String> onePathRecords) throws SaturnJobConsoleException {
  ...
  private boolean hasOtherPath(ArrangeNode currentNode, String target, Map<String, ArrangeNode> nodeMap) throws SaturnJobConsoleException {
  ...
  private boolean hasOnePath(String currentName, List<String> children, String target, Map<String, ArrangeNode> nodeMap, Stack<String> onePathRecords) throws SaturnJobConsoleException {
    onePathRecords.push(currentName);
  ...
  private List<String> getCandidateDownStream(String namespace, JobConfig jobConfig) throws SaturnJobConsoleException {
    ...
    for (JobConfig temp : unSystemJobs) {
      ...
      if (!jobConfig.getJobName().equals(jobName) && !ancestors.contains(jobName) && JobType.isPassive(JobType.getJobType(temp.getJobType()))) {
  ...
  @Transactional(rollbackFor = Exception.class) @Override public void updateJobConfig(String namespace, JobConfig jobConfig, String updatedBy) throws SaturnJobConsoleException {
  ...
  @Transactional(rollbackFor = Exception.class) @Override public void updateJobCron(String namespace, String jobName, String cron, Map<String, String> customContext, String updatedBy) throws SaturnJobConsoleException {
    String cron0 = cron;
