...
public class DashboardServiceImpl implements DashboardService {
  ...
  @Autowired private SaturnStatisticsService saturnStatisticsService;

  @Autowired private RegistryCenterService registryCenterService;

  @Autowired private JobService jobService;

  @Autowired private StatisticsRefreshService statisticsRefreshService;

  private ExecutorService updateStatisticsThreadPool;

  @Autowired private DashboardHistoryRepository dashboardHistoryRepository;
  ...
  @Override public int executorInDockerCount(String zkList) throws SaturnJobConsoleException {
    return getCountFromDB(StatisticsTableKeyConstant.EXECUTOR_IN_DOCKER_COUNT, zkList);
  }

  @Override public int executorNotInDockerCount(String zkList) throws SaturnJobConsoleException {
    return getCountFromDB(StatisticsTableKeyConstant.EXECUTOR_NOT_IN_DOCKER_COUNT, zkList);
  }

  @Override public int jobCount(String zkList) throws SaturnJobConsoleException {
  ...
  @Override public SaturnStatistics top10FailureJob(String zklist) throws SaturnJobConsoleException {
    return saturnStatisticsService.findStatisticsByNameAndZkList(StatisticsTableKeyConstant.TOP_10_FAIL_JOB, zklist);
  }

  @Override public String top10FailureJobByAllZkCluster() throws SaturnJobConsoleException {
    ...
    List<JobStatistics> top10FailJob = jobStatisticsList.subList(0, jobStatisticsList.size() > 9 ? 10 : jobStatisticsList.size());
    return JSON.toJSONString(top10FailJob);
  }

  @Override public SaturnStatistics top10FailureExecutor(String zklist) throws SaturnJobConsoleException {
    return saturnStatisticsService.findStatisticsByNameAndZkList(StatisticsTableKeyConstant.TOP_10_FAIL_EXECUTOR, zklist);
  }

  @Override public String top10FailureExecutorByAllZkCluster() throws SaturnJobConsoleException {
  ...
  @Override public SaturnStatistics top10AactiveJob(String zklist) throws SaturnJobConsoleException {
    return saturnStatisticsService.findStatisticsByNameAndZkList(StatisticsTableKeyConstant.TOP_10_ACTIVE_JOB, zklist);
  }

  @Override public String top10AactiveJobByAllZkCluster() throws SaturnJobConsoleException {
    List<JobStatistics> jobStatisticsList = new ArrayList<>();
    Collection<ZkCluster> zkClusterList = registryCenterService.getOnlineZkClusterList();
    for (ZkCluster zkCluster : zkClusterList) {
  ...
  @Override public SaturnStatistics top10LoadExecutor(String zklist) throws SaturnJobConsoleException {
    return saturnStatisticsService.findStatisticsByNameAndZkList(StatisticsTableKeyConstant.TOP_10_LOAD_EXECUTOR, zklist);
  }

  @Override public String top10LoadExecutorByAllZkCluster() throws SaturnJobConsoleException {
    List<ExecutorStatistics> executorStatisticsList = new ArrayList<>();
    Collection<ZkCluster> zkClusterList = registryCenterService.getOnlineZkClusterList();
    for (ZkCluster zkCluster : zkClusterList) {
  ...
  @Override public SaturnStatistics top10LoadJob(String zklist) throws SaturnJobConsoleException {
    return saturnStatisticsService.findStatisticsByNameAndZkList(StatisticsTableKeyConstant.TOP_10_LOAD_JOB, zklist);
  }

  @Override public String top10LoadJobByAllZkCluster() throws SaturnJobConsoleException {
    List<JobStatistics> jobStatisticsList = new ArrayList<>();
    Collection<ZkCluster> zkClusterList = registryCenterService.getOnlineZkClusterList();
    for (ZkCluster zkCluster : zkClusterList) {
  ...
  @Override public SaturnStatistics top10UnstableDomain(String zklist) throws SaturnJobConsoleException {
    return saturnStatisticsService.findStatisticsByNameAndZkList(StatisticsTableKeyConstant.TOP_10_UNSTABLE_DOMAIN, zklist);
  }

  @Override public String top10UnstableDomainByAllZkCluster() throws SaturnJobConsoleException {
  ...
  @Override public SaturnStatistics allProcessAndErrorCountOfTheDay(String zklist) throws SaturnJobConsoleException {
  ...
  @Override public String allProcessAndErrorCountOfTheDayByAllZkCluster() throws SaturnJobConsoleException {
    long count = 0;
    long error = 0;
    Collection<ZkCluster> zkClusterList = registryCenterService.getOnlineZkClusterList();
    for (ZkCluster zkCluster : zkClusterList) {
  ...
  @Override public SaturnStatistics top10FailureDomain(String zklist) throws SaturnJobConsoleException {
    return saturnStatisticsService.findStatisticsByNameAndZkList(StatisticsTableKeyConstant.TOP_10_FAIL_DOMAIN, zklist);
  }

  @Override public String top10FailureDomainByAllZkCluster() throws SaturnJobConsoleException {
    List<DomainStatistics> domainStatisticsList = new ArrayList<>();
    Collection<ZkCluster> zkClusterList = registryCenterService.getOnlineZkClusterList();
    for (ZkCluster zkCluster : zkClusterList) {
  ...
  @Override public void cleanShardingCount(String namespace) throws SaturnJobConsoleException {
  ...
  @Override public void cleanOneJobAnalyse(String namespace, String jobName) throws SaturnJobConsoleException {
    CuratorFrameworkOp curatorFrameworkOp = registryCenterService.getCuratorFrameworkOp(namespace);
  ...
  @Override public void cleanAllJobAnalyse(String namespace) throws SaturnJobConsoleException {
    CuratorFrameworkOp curatorFrameworkOp = registryCenterService.getCuratorFrameworkOp(namespace);
  ...
  @Override public void cleanAllJobExecutorCount(String namespace) throws SaturnJobConsoleException {
    CuratorFrameworkOp curatorFrameworkOp = registryCenterService.getCuratorFrameworkOp(namespace);
    List<String> jobs = jobService.getUnSystemJobNames(namespace);
    for (String job : jobs) {
  ...
  @Override public void cleanOneJobExecutorCount(String namespace, String jobName) throws SaturnJobConsoleException {
    CuratorFrameworkOp curatorFrameworkOp = registryCenterService.getCuratorFrameworkOp(namespace);
  ...
  @Override public Map<String, Integer> loadDomainRankDistribution(String zkClusterKey) throws SaturnJobConsoleException {
  ...
  @Override public Map<String, Integer> loadDomainRankDistributionByAllZkCluster() throws SaturnJobConsoleException {
    Map<String, Integer> domainMap = new HashMap<>();
    Collection<ZkCluster> zkClusterList = registryCenterService.getOnlineZkClusterList();
    for (ZkCluster zkCluster : zkClusterList) {
  ...
  @Override public Map<Integer, Integer> loadJobRankDistribution(String zklist) throws SaturnJobConsoleException {
  ...
  @Override public Map<Integer, Integer> loadJobRankDistributionByAllZkCluster() throws SaturnJobConsoleException {
  ...
  @Override public Map<String, Long> versionDomainNumber(String currentZkAddr) throws SaturnJobConsoleException {
  ...
  @Override public Map<String, Long> versionDomainNumberByAllZkCluster() throws SaturnJobConsoleException {
  ...
  @Override public Map<String, Long> versionExecutorNumber(String currentZkAddr) throws SaturnJobConsoleException {
  ...
  @Override public Map<String, Long> versionExecutorNumberByAllZkCluster() throws SaturnJobConsoleException {
  ...
  @Override public void saveDashboardHistory(String zkCluster, String type, String topic, String content) {
    dashboardHistoryRepository.createOrUpdateHistory(zkCluster, type, topic, content, new Date());
  }

  @Override public void batchSaveDashboardHistory(List<DashboardHistory> dashboardHistories) {
    dashboardHistoryRepository.batchCreateOrUpdateHistory(dashboardHistories);
  }

  @Override public List<DashboardHistory> getDashboardDomainHistory(String zkCluster, String type, String topic, Date fromDate, Date toDate) throws SaturnJobConsoleException {
    List<String> zkClusters = new ArrayList<>();
    zkClusters.add(zkCluster);
    return dashboardHistoryRepository.selectByZkClustersAndTypeAndTopicAndFromStartDateToEndDate(zkClusters, type, topic, fromDate, toDate);
  }

  @Override public Map<String, List> getDomainOperationHistory(String type, String topic, Date fromDate, Date toDate) {
    SimpleDateFormat sdf = new SimpleDateFormat("MM-dd");
    List<String> zkClusters = getAvailableZkClusterKey();
    List<DashboardHistory> dashboardHistories = dashboardHistoryRepository.selectByZkClustersAndTypeAndTopicAndFromStartDateToEndDate(zkClusters, type, topic, fromDate, toDate);
  ...
  @Override public Map<String, List> getDomainCountHistory(String zkCluster, String type, String topic, Date fromDate, Date toDate) {
    SimpleDateFormat sdf = new SimpleDateFormat("MM-dd");
    List<String> zkClusters = new ArrayList<>();
  ...
  @Override public Map<String, List> getExecutorHistory(String zkCluster, String type, String topic, Date fromDate, Date toDate) {
    SimpleDateFormat sdf = new SimpleDateFormat("MM-dd");
    List<String> zkClusters = new ArrayList<>();
    if (StringUtils.isEmpty(zkCluster)) {
      zkClusters.addAll(getAvailableZkClusterKey());
  ...
  @Override public Map<String, List> getJobCountHistory(String zkCluster, String type, String topic, Date fromDate, Date toDate) {
    SimpleDateFormat sdf = new SimpleDateFormat("MM-dd");
    List<String> zkClusters = new ArrayList<>();
    if (StringUtils.isEmpty(zkCluster)) {
      zkClusters.addAll(getAvailableZkClusterKey());
