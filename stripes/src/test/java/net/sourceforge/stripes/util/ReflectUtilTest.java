...
public class ReflectUtilTest {
  @Test(groups = "fast") public void testAccessibleMethodBaseCase() throws Exception {
    Method m = Object.class.getMethod("getClass");
    Method m2 = ReflectUtil.findAccessibleMethod(m);
    Assert.assertSame(m, m2);
  }

  @Test(groups = "fast") public void testAccessibleMethodWithMapEntry() throws Exception {
  ...
  @Test(groups = "fast") public void testCovariantProperty() {
    abstract class Base {
    ...
    class RWSub extends ROSub {
      @SuppressWarnings(value = { "unused" }) public void setId(String id) {
        this.id = id;
      }
    }
  ...
  interface A<S extends java.lang.Object, T extends java.lang.Object, U extends java.lang.Object> {
  }

  interface B<V extends Number, W extends java.lang.Object> extends A<W, String, V> {
  }

  interface C extends B<Integer, Long> {
  }

  @Test(groups = "fast") public void testResolveTypeArgsOfSuperInterface() {
  ...
  @Test(groups = "fast") public void testResolveTypeArgsOfSuperclass() {
    abstract class BaseClass1<S extends java.lang.Object, T extends java.lang.Object, U extends java.lang.Object> {
    }
    abstract class BaseClass2<V extends java.lang.Object, W extends java.lang.Object> extends BaseClass1<W, String, V> {
    }
    class Impl1<X extends java.lang.Object> extends BaseClass2<Integer, X> {
    }
