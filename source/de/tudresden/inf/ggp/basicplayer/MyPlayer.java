...
public final class MyPlayer extends Player {
  static {
    StrategyFactory.getInstance().addDescription("SMonteCarloUCT", SMonteCarloUCT.class.getCanonicalName(), "Simulates games and chooses the best path.");
  }
  ...
  public void commandStart(Message msg) {
    ...
    System.out.println("MyPlayer created the strategy " + strategy.getClass().getSimpleName() + ".");
