...
public final class ZookeeperRegistryCenterWatchTest {
  ...
  @Test(timeout = 10000L) public void assertWatchWithoutExecutor() throws InterruptedException {
...
=======
  @Test(timeout = 30000L) public void assertWatch() throws InterruptedException {
    CountDownLatch waitingForCountDownValue = new CountDownLatch(1);
    zkRegCenter.addCacheData("/test");
    CountDownLatch waitingForWatchReady = new CountDownLatch(1);
    zkRegCenter.watch("/test", (event) -> {
...
>>>>>>> /usr/src/app/output/elasticjob/elastic-job-lite/6381f6c7e98de6ac0957cc2f89400aa9dabc2edb/elasticjob-infra/elasticjob-registry-center/elasticjob-regitry-center-provider/elasticjob-registry-center-zookeeper-curator/src/test/java/org/apache/shardingsphere/elasticjob/reg/zookeeper/ZookeeperRegistryCenterWatchTest.java/right.java


  @Test(timeout = 10000L) public void assertWatchWithExecutor() throws InterruptedException {
    CountDownLatch waitingForCountDownValue = new CountDownLatch(1);
    zkRegCenter.addCacheData("/test");
    CountDownLatch waitingForWatchReady = new CountDownLatch(1);
