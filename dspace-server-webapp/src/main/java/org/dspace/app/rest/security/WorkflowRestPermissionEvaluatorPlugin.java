...
@Component public class WorkflowRestPermissionEvaluatorPlugin extends RestObjectPermissionEvaluatorPlugin {
  ...
  @Autowired private XmlWorkflowItemService workflowItemService;
  ...
  @Override public boolean hasDSpacePermission(Authentication authentication, Serializable targetId, String targetType, DSpaceRestPermission permission) {
    ...
    if (!DSpaceRestPermission.READ.equals(restPermission) || !StringUtils.equalsIgnoreCase(WorkflowItemRest.NAME, targetType)) {
      return false;
    }
