 ...
 */
public abstract class DSpaceRestRepository<T extends RestAddressableModel, ID extends Serializable> extends AbstractDSpaceRestRepository implements PagingAndSortingRepository<T, ID>, BeanNameAware {
  ...
  /**
     ...
     */
  @PreAuthorize(value = "hasAuthority(\'ADMIN\')") public abstract T findOne(Context context, ID id);

  @Override public boolean existsById(ID id) {
    return findById(id).isPresent();
  }

  @Override public final Iterable<T> findAll() {
  ...
  @Override public final Iterable<T> findAll(Sort sort) {
    throw new RuntimeException("findAll MUST be paginated");
  }
