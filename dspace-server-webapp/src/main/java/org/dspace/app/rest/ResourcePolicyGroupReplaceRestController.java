 ...
 */
@RestController @RequestMapping(value = "/api/authz/resourcepolicies" + REGEX_REQUESTMAPPING_IDENTIFIER_AS_DIGIT + "/group") public class ResourcePolicyGroupReplaceRestController {
  @Autowired private Utils utils;

  @Autowired private ResourcePolicyService resourcePolicyService;

  @PreAuthorize(value = "hasPermission(#id, \'resourcepolicy\', \'ADMIN\')") @RequestMapping(method = PUT, consumes = { "text/uri-list" }) public ResponseEntity<RepresentationModel<?>> replaceGroupOfResourcePolicy(@PathVariable Integer id, HttpServletResponse response, HttpServletRequest request) throws SQLException, AuthorizeException {
...
<<<<<<< /usr/src/app/output/dspace/dspace/79c4a4c8477aa572165e4aa686001342c734a5a4/dspace-server-webapp/src/main/java/org/dspace/app/rest/ResourcePolicyGroupReplaceRestController.java/left.java
      "ResourcePolicy doesn\'t linked to Group"
=======
      "ResourcePolicy with id:" + id + "  doesn\'t linked to Group"
