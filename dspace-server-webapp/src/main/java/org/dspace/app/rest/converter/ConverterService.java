 ...
 */
@Lazy @Service public class ConverterService {
  ...
  @Autowired private List<DSpaceConverter> converters;

  @Autowired private List<Projection> projections;

  @Autowired private WebSecurityExpressionEvaluator webSecurityExpressionEvaluator;
  ...
  /**
     ...
     */
  public <M extends java.lang.Object, R extends java.lang.Object> R toRest(M modelObject, Projection projection) {
    ...
    if (restObject instanceof BaseObjectRest) {
      ...
      if (!webSecurityExpressionEvaluator.evaluate(preAuthorizeValue, requestService.getCurrentRequest().getHttpServletRequest(), requestService.getCurrentRequest().getHttpServletResponse(), String.valueOf(baseObjectRest.getId()))) {
  ...
  private Annotation getAnnotationForRestObject(BaseObjectRest restObject) {
    ...
    DSpaceRestRepository repositoryToUse = utils.getResourceRepositoryByCategoryAndModel(baseObjectRest.getCategory(), baseObjectRest.getType());
  ...
  /**
     ...
     * @throws ClassCastException if the converter's return type is not compatible with the inferred return type.
     */
  public <M extends java.lang.Object, R extends java.lang.Object> Page<R> toRestPage(List<M> modelObjects, Pageable pageable, Projection projection) {
  ...
  /**
     ...
     * @return the page.
     */
  public <M extends java.lang.Object, R extends java.lang.Object> Page<R> toRestPage(List<M> modelObjects, Pageable pageable, long total, Projection projection) {
    List<R> transformedList = new LinkedList<>();
    for (M modelObject : modelObjects) {
      R transformedObject = toRest(modelObject, projection);
      if (transformedObject != null) {
  ...
  /**
     ...
     */
  <M extends java.lang.Object, R extends java.lang.Object> DSpaceConverter<M, R> getConverter(Class<M> sourceClass) {
  ...
  @PostConstruct private void initialize() {
    ...
    Set<BeanDefinition> beanDefinitions = provider.findCandidateComponents(HALResource.class.getPackage().getName().replaceAll("\\.", "/"));
    for (BeanDefinition beanDefinition : beanDefinitions) {
      ...
      try {
        Class<? extends RestModel> restClass = (Class<? extends RestModel>) Class.forName(restClassName);
        Class<HALResource<? extends RestModel>> resourceClass = (Class<HALResource<? extends RestModel>>) Class.forName(resourceClassName);
