 ...
 */
@Component(value = RequestItemRest.CATEGORY + '.' + RequestItemRest.NAME) public class RequestItemRepository extends DSpaceRestRepository<RequestItemRest, String> {
  ...
  @PreAuthorize(value = "permitAll()") @Override public RequestItemRest findOne(Context context, String token) {
  ...
  @Override public Page<RequestItemRest> findAll(Context context, Pageable pageable) {
    throw new RepositoryMethodNotImplementedException(RequestItemRest.NAME, "findAll");
  }

  @Override @PreAuthorize(value = "permitAll()") public RequestItemRest createAndReturn(Context ctx) throws AuthorizeException, SQLException {
  ...
  @Override public void delete(Context context, String token) throws AuthorizeException, RepositoryMethodNotImplementedException {
    throw new RepositoryMethodNotImplementedException(RequestItemRest.NAME, "delete");
  }

  @Override @PreAuthorize(value = "isAuthenticated()") public RequestItemRest put(Context context, HttpServletRequest request, String apiCategory, String model, String token, JsonNode requestBody) throws AuthorizeException {
  ...
  @Override public Class<RequestItemRest> getDomainClass() {
  ...
  private String getLinkTokenEmail(String token) throws URISyntaxException, MalformedURLException {
    ...
    URI link = new URIBuilder(base).setPathSegments("request-a-copy", token).build();
