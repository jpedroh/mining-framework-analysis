 ...
 */
@Component public class GroupRestPermissionEvaluatorPlugin extends RestObjectPermissionEvaluatorPlugin {
  ...
  @Override public boolean hasDSpacePermission(Authentication authentication, Serializable targetId, String targetType, DSpaceRestPermission permission) {
    ...
    if (!DSpaceRestPermission.READ.equals(restPermission) || Constants.getTypeID(targetType) != Constants.GROUP) {
      return false;
    }
