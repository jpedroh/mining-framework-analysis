...
public class DataLoaderCompositeTypeTest {
  ...
  @Test public void shouldCreateKeyspaceAndLoadDataWithColumnCompositeType() {
    ...
    assertThat(columnFamilyDefinitionMap.
<<<<<<< /usr/src/app/output/jsevellec/cassandra-unit/4e87b46fe206e0acf5cdbd1e8c396be97410a5e4/cassandra-unit/src/test/java/org/cassandraunit/DataLoaderCompositeTypeTest.java/left.java
    describeKeyspace("compositeKeyspace").getCfDefs().get(1).getName()
=======
    containsKey("columnFamilyWithCompositeType")
>>>>>>> /usr/src/app/output/jsevellec/cassandra-unit/4e87b46fe206e0acf5cdbd1e8c396be97410a5e4/cassandra-unit/src/test/java/org/cassandraunit/DataLoaderCompositeTypeTest.java/right.java
    ...
    assertThat(columnFamilyDefinition.getComparatorType().
<<<<<<< /usr/src/app/output/jsevellec/cassandra-unit/4e87b46fe206e0acf5cdbd1e8c396be97410a5e4/cassandra-unit/src/test/java/org/cassandraunit/DataLoaderCompositeTypeTest.java/left.java
    getCfDefs().get(1).getComparatorType().getTypeName()
=======
    getTypeName()
>>>>>>> /usr/src/app/output/jsevellec/cassandra-unit/4e87b46fe206e0acf5cdbd1e8c396be97410a5e4/cassandra-unit/src/test/java/org/cassandraunit/DataLoaderCompositeTypeTest.java/right.java
    , is(ComparatorType.getByClassName("CompositeType(org.apache.cassandra.db.marshal.LongType,org.apache.cassandra.db.marshal.UTF8Type,org.apache.cassandra.db.marshal.IntegerType)").getTypeName()));
    Keyspace keyspace = HFactory.createKeyspace("compositeKeyspace", cluster);
    SliceQuery<String, Composite, String> query = HFactory.createSliceQuery(keyspace, StringSerializer.get(), new CompositeSerializer(), StringSerializer.get());
    ...
    SliceQuery<String, Composite, String> query2 = HFactory.createSliceQuery(keyspace, StringSerializer.get(), new CompositeSerializer(), StringSerializer.get());
  ...
  @Test public void shouldCreateKeyspaceAndLoadDataWithRowKeyCompositeType() throws Exception {
    ...
    assertThat(columFamilyDefinitionAsMap.
<<<<<<< /usr/src/app/output/jsevellec/cassandra-unit/4e87b46fe206e0acf5cdbd1e8c396be97410a5e4/cassandra-unit/src/test/java/org/cassandraunit/DataLoaderCompositeTypeTest.java/left.java
    describeKeyspace("compositeKeyspace").getCfDefs().get(0).getName()
=======
    containsKey("columnFamilyWithRowKeyCompositeType")
>>>>>>> /usr/src/app/output/jsevellec/cassandra-unit/4e87b46fe206e0acf5cdbd1e8c396be97410a5e4/cassandra-unit/src/test/java/org/cassandraunit/DataLoaderCompositeTypeTest.java/right.java
    , is(true));
    assertThat(columFamilyDefinitionAsMap.get("columnFamilyWithRowKeyCompositeType").
<<<<<<< /usr/src/app/output/jsevellec/cassandra-unit/4e87b46fe206e0acf5cdbd1e8c396be97410a5e4/cassandra-unit/src/test/java/org/cassandraunit/DataLoaderCompositeTypeTest.java/left.java
    getCfDefs().get(0).getKeyValidationClass()
=======
...
>>>>>>> /usr/src/app/output/jsevellec/cassandra-unit/4e87b46fe206e0acf5cdbd1e8c396be97410a5e4/cassandra-unit/src/test/java/org/cassandraunit/DataLoaderCompositeTypeTest.java/right.java
    ...
    Keyspace keyspace = HFactory.createKeyspace("compositeKeyspace", cluster);
    SliceQuery<Composite, String, String> query = HFactory.createSliceQuery(keyspace, new CompositeSerializer(), StringSerializer.get(), StringSerializer.get());
