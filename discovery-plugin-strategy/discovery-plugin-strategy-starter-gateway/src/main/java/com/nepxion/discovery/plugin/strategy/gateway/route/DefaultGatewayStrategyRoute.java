...
public class DefaultGatewayStrategyRoute implements GatewayStrategyRoute, ApplicationEventPublisherAware {
  ...
  @Autowired(required = false) private GatewayStrategyRouteAdapter gatewayStrategyRouteAdapter;
  ...
  @Override public void update(List<GatewayStrategyRouteEntity> gatewayStrategyRouteEntityList) {
  ...
  @Override public List<String> view() {
  ...
  private void deleteRoute(RouteDefinition routeDefinition) {
    Disposable disposable = null;
    try {
      disposable = routeDefinitionWriter.delete(Mono.just(routeDefinition.getId())).onErrorResume(new Function<Throwable, Mono<? extends Void>>() {
        @Override public Mono<? extends Void> apply(Throwable throwable) {
          if (throwable instanceof NotFoundException) {
            gatewayProperties.getRoutes().removeIf(new Predicate<RouteDefinition>() {
              @Override public boolean test(RouteDefinition routeCandidate) {
