...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
  ...
  public static Timestamp toSqlTimestamp(String sDate) {
    ...
    return toSqlTimestamp(sDate, sDate.length() == DateUtils.DATE_FORMAT_DATEONLY.length() ? DateUtils.DATE_FORMAT_DATEONLY : DateUtils.DATE_FORMAT_DATETIME);
  }
  ...
  public static Timestamp toSqlTimestamp(String sDate, String sFmt) {
    ...
    if (sFmt.equals(DateUtils.DATE_FORMAT_DATETIME)) {
      ...
      if (sFmt.equals(DateUtils.DATE_FORMAT_DATEONLY)) {
        temp = sDate.replace('/', '-');
  ...
  /**
	 ...
	 * @return
	 */
  @SuppressWarnings(value = { "deprecation" }) public static int getQuarter(Date date) {
  ...
  /**
	 ...
	 * @return
	 */
  @SuppressWarnings(value = { "deprecation" }) public static Date getLastDayOfMonth(Date date) {
  ...
  public static long getDateDiff(Date date1, Date date2) {
    ...
    long diff = (date1.getTime() - date2.getTime()) / (24 * 60 * 60 * 1000) > 0 ? (date1.getTime() - date2.getTime()) / (24 * 60 * 60 * 1000) : (date2.getTime() - date1.getTime()) / (24 * 60 * 60 * 1000);
    return diff;
  }
  ...
  public static boolean isSameWeekWithToday(Date date) {
    ...
    if (subYear == 0) {
      ...
      if (subYear == 1 && dateCal.get(Calendar.MONTH) == 11 && todayCal.get(Calendar.MONTH) == 0) {
        if (todayCal.get(Calendar.WEEK_OF_YEAR) == dateCal.get(Calendar.WEEK_OF_YEAR)) {
          return true;
        }
      } else {
        if (subYear == -1 && todayCal.get(Calendar.MONTH) == 11 && dateCal.get(Calendar.MONTH) == 0) {
          if (todayCal.get(Calendar.WEEK_OF_YEAR) == dateCal.get(Calendar.WEEK_OF_YEAR)) {
            return true;
          }
        }
