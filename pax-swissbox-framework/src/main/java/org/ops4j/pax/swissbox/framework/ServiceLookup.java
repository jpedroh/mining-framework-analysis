...
public class ServiceLookup {
  ...
  public static <T extends java.lang.Object> T getService(BundleContext bc, String className) {
    return ServiceLookup.<T>getService(bc, className, DEFAULT_TIMEOUT, "");
  }

  public static <T extends java.lang.Object> T getService(BundleContext bc, Class<T> type) {
    return getService(bc, type, DEFAULT_TIMEOUT);
  }

  public static <T extends java.lang.Object> T getService(BundleContext bc, Class<T> type, Map<String, String> props) {
  ...
  /**
     ...
     */
  public static <T extends java.lang.Object> T getService(BundleContext bc, Class<T> type, long timeout, Map<String, String> props) {
    return ServiceLookup.<T>getService(bc, type.getName(), timeout, props);
  }

  public static <T extends java.lang.Object> T getService(BundleContext bc, Class<T> type, long timeout) {
    return ServiceLookup.<T>getService(bc, type.getName(), timeout, "");
  }

  public static <T extends java.lang.Object> T getService(BundleContext bc, Class<T> type, long timeout, String filter) {
    return ServiceLookup.<T>getService(bc, type.getName(), timeout, filter);
  }

  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> T getService(BundleContext bc, String className, long timeout, Map<String, String> props) {
  ...
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> T getService(BundleContext bc, String className, long timeout, String filter) {
