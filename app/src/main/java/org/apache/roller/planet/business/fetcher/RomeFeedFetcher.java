...
public class RomeFeedFetcher implements org.apache.roller.planet.business.fetcher.FeedFetcher {
  ...
  /**
     * @inheritDoc
     */
  @Override public Subscription fetchSubscription(String feedURL) throws FetcherException {
  ...
  /**
     * @inheritDoc
     */
  @Override public Subscription fetchSubscription(String feedURL, Date lastModified) throws FetcherException {
    if (feedURL == null) {
  ...
  private FeedFetcherCache getRomeFetcherCache() {
    ...
    try {
      ...
      log.error("Unable to create planet cache directory: " + ((cacheDir != null) ? cacheDir.getPath() : null), e);
      return null;
    }
