 ...
 */
public abstract class UIAction extends ActionSupport implements UIActionPreparable, UISecurityEnforced, RequestAware {
  ...
  @Override public void myPrepare() {
  }

  @Override public void setRequest(Map<String, Object> map) {
  ...
  @Override public boolean isUserRequired() {
    return true;
  }

  @Override public boolean isWeblogRequired() {
    return true;
  }

  @Override public List<String> requiredWeblogPermissionActions() {
    return Collections.singletonList(WeblogPermission.ADMIN);
  }

  @Override public List<String> requiredGlobalPermissionActions() {
  ...
  @Override public String getText(String aTextName, String defaultValue) {
    return super.getText(cleanTextKey(aTextName), cleanTextKey(defaultValue));
  }

  @Override public String getText(String aTextName, String defaultValue, String obj) {
    return super.getText(cleanTextKey(aTextName), cleanTextKey(defaultValue), cleanTextArg(obj));
  }

  @Override public String getText(String aTextName, List<?> args) {
  ...
  @Override public String getText(String aTextName, String defaultValue, List<?> args) {
    List<Object> cleanedArgs = new ArrayList<Object>(args.size());
    for (Object el : args) {
      cleanedArgs.add(el instanceof String ? cleanTextArg((String) el) : el);
    }
  ...
  @Override public String getText(String key, String defaultValue, String[] args) {
    String[] cleanedArgs = new String[args.length];
    for (int i = 0; i < args.length; ++i) {
      cleanedArgs[i] = cleanTextArg(args[i]);
    }
