...
public class ObfuscateEmailPlugin implements WeblogEntryPlugin {
  ...
  protected String description = "Automatically converts email addresses " + "to me-AT-mail-DOT-com format.  Also &quot;scrambles&quot; mailto: links.";
  ...
  @Override public void init(Weblog website) throws WebloggerException {
  }

  @Override public String render(WeblogEntry entry, String str) {
