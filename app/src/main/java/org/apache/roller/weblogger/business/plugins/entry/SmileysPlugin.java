...
public class SmileysPlugin implements WeblogEntryPlugin {
  ...
  private String description = "Change ASCII emoticons to graphics.  " + ":-) becomes <img src=\'./images/smileys/smile.gif\'>";
  ...
  @Override public synchronized void init(Weblog website) throws WebloggerException {
    if (SmileysPlugin.smileyPatterns.length < 1) {
      ...
      while (enum1.hasMoreElements()) {
        ...
        tempS[count] = "<img src=\"" + baseURL + "/images/smileys/" + smileyDefs.getProperty(smiley, "smile.gif") + "\" class=\"smiley\"" + " alt=\"" + smileyAlt + "\"" + " title=\"" + smileyAlt + "\" />";
  ...
  /**
     ...
     */
  @Override public String render(WeblogEntry entry, String text) {
