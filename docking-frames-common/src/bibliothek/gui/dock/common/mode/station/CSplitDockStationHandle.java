...
public class CSplitDockStationHandle {
  ...
  private VetoableDockRelocatorListener relocatorListener = new VetoableDockRelocatorAdapter() {
    @Override public void dropped(DockRelocatorEvent event) {
        ...
        if (property != null) {
          if (property.getSuccessor() == null) {
            ...
            if (last != null && secondLast != null) {
              if (NormalMode.IDENTIFIER.equals(secondLast.getUniqueIdentifier()) && MaximizedMode.IDENTIFIER.equals(last.getUniqueIdentifier())) {
