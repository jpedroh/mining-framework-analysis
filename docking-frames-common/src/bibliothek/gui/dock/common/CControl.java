...
<<<<<<< /usr/src/app/output/benoker/dockingframes/1aec33b4fd465a5420913fc12a4ff1d35381a07d/docking-frames-common/src/bibliothek/gui/dock/common/CControl.java/left.java
  /** 
...
>>>>>>> /usr/src/app/output/benoker/dockingframes/1aec33b4fd465a5420913fc12a4ff1d35381a07d/docking-frames-common/src/bibliothek/gui/dock/common/CControl.java/right.java
  ...
  /**
     ...
     */
  public static final PropertyKey<KeyStroke> KEY_MAXIMIZE_CHANGE = new PropertyKey<KeyStroke>("ccontrol.maximize_change");
  ...
  /**
     ...
     * maximized-state.
     */
  public static final PropertyKey<KeyStroke> KEY_GOTO_MAXIMIZED = new PropertyKey<KeyStroke>("ccontrol.goto_maximized");

  /**
     * {@link KeyStroke} used to change a {@link CDockable} into
     * normalized-state.
     */
  public static final PropertyKey<KeyStroke> KEY_GOTO_NORMALIZED = new PropertyKey<KeyStroke>("ccontrol.goto_normalized");

  /**
     * {@link KeyStroke} used to change a {@link CDockable} into
     * minimized-state.
     */
  public static final PropertyKey<KeyStroke> KEY_GOTO_MINIMIZED = new PropertyKey<KeyStroke>("ccontrol.goto_minimized");

  /**
     * {@link KeyStroke} used to change a {@link CDockable} into
     * externalized-state.
     */
  public static final PropertyKey<KeyStroke> KEY_GOTO_EXTERNALIZED = new PropertyKey<KeyStroke>("ccontrol.goto_externalized");

  /**
     * {@link KeyStroke} used to close a {@link CDockable}.
     */
  public static final PropertyKey<KeyStroke> KEY_CLOSE = new PropertyKey<KeyStroke>("ccontrol.close");
  ...
  /**
     ...
     */
  public static final PropertyKey<ConflictResolver<RequestDimension>> RESIZE_LOCK_CONFLICT_RESOLVER = new PropertyKey<ConflictResolver<RequestDimension>>("ccontrol.resize_lock_conflict_resolver", new ConstantPropertyFactory<ConflictResolver<RequestDimension>>(new DefaultConflictResolver<RequestDimension>()), true);
  ...
  protected void init(WindowProvider window, CControlFactory factory) {
    ...
    frontend.setMissingDockableStrategy(new MissingDockableStrategy() {
      ...
      public <L extends java.lang.Object> boolean shouldCreate(DockFactory<?, ?, L> factory, L data) {
    ...
    frontend.getController().getRegister().addDockRegisterListener(new DockRegisterAdapter() {
      @Override public void dockableRegistered(DockController controller, Dockable dockable) {
      ...
      @Override public void dockableUnregistered(DockController controller, Dockable dockable) {
        if (dockable instanceof CommonDockable) {
          CDockable cdock = ((CommonDockable) dockable).getDockable();
          CDockableAccess access = accesses.get(cdock);
          if (access != null) {
  ...
  protected void initExtensions(DockController controller) {
    ...
    String[] list = { "glass.eclipse.CGlassExtension", "bibliothek.gui.dock.toolbar.CToolbarExtension" };
  ...
  protected void initTransferFocusOnMinimize(DockController controller) {
    addStateListener(new CDockableAdapter() {
      @Override public void extendedModeChanged(CDockable dockable, ExtendedMode mode) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) protected void initFactories() {
    ...
    frontend.registerFactory(new StackDockStationFactory() {
      @Override public StackDockPerspective layoutPerspective(StackDockStationLayout layout, Map<Integer, PerspectiveDockable> children) {
  ...
  protected void initIcons() {
    DefaultIconScheme scheme = new DefaultIconScheme(getController(), new DefaultIconScheme.IconResource("data/bibliothek/gui/dock/core/icons.ini", null, DockController.class.getClassLoader()), new DefaultIconScheme.IconResource("data/bibliothek/gui/dock/common/icons/icons.ini", null, CControl.class.getClassLoader()));
  ...
  /**
     ...
     */
  @Deprecated @Todo(compatibility = Compatibility.BREAK_MINOR, priority = Todo.Priority.MINOR, target = Todo.Version.VERSION_1_1_2, description = "remove this method, replace by \'getStationContainers\'") public List<CContentArea> getContentAreas() {
  ...
  /**
     ...
     */
  public <A extends java.lang.Object> void putProperty(PropertyKey<A> key, A value) {
  ...
  /**
     ...
     */
  protected <A extends java.lang.Object> void putProperty(PropertyKey<A> key, A value, Priority priority) {
  ...
  /**
     ...
     */
  public <A extends java.lang.Object> A getProperty(PropertyKey<A> key) {
  ...
  /**
     ...
     */
  @Deprecated @Todo(compatibility = Compatibility.BREAK_MINOR, priority = Todo.Priority.MINOR, target = Todo.Version.VERSION_1_1_2, description = "remove this method and replace by \'removeStation\'") public void remove(CStation<?> station) {
  ...
  /**
     ...
     * a future release
     */
  @Deprecated @Todo(compatibility = Compatibility.BREAK_MAJOR, priority = Todo.Priority.ENHANCEMENT, target = Todo.Version.VERSION_1_1_2, description = "remove this method") public boolean remove(SingleCDockable dockable) {
    if (dockable == null) {
      throw new NullPointerException("dockable must not be null");
    }
  ...
  @SuppressWarnings(value = { "unchecked" }) private boolean shouldCreate(MultipleCDockableFactory<?, ?> factory, CommonMultipleDockableLayout layout) {
  ...
  /**
     ...
     * in a future release 
     */
  @Deprecated @Todo(compatibility = Compatibility.BREAK_MAJOR, priority = Todo.Priority.ENHANCEMENT, target = Todo.Version.VERSION_1_1_2, description = "remove this method") public void remove(MultipleCDockable dockable) {
    if (dockable == null) {
      throw new NullPointerException("dockable must not be null");
    }
    if (dockable.getControl() == this) {
