...
<<<<<<< /usr/src/app/output/dtrules/dtrules/d5e924b9f3bb4fcef9236053947288bbd6aa9e6d/compilerutil/src/main/java/com/dtrules/testsupport/ATestHarness.java/left.java
  PrintStream
=======
  String
>>>>>>> /usr/src/app/output/dtrules/dtrules/d5e924b9f3bb4fcef9236053947288bbd6aa9e6d/compilerutil/src/main/java/com/dtrules/testsupport/ATestHarness.java/right.java
   
<<<<<<< /usr/src/app/output/dtrules/dtrules/d5e924b9f3bb4fcef9236053947288bbd6aa9e6d/compilerutil/src/main/java/com/dtrules/testsupport/ATestHarness.java/left.java
  ostream = System.out
=======
  rulesDirectoryPath = null
>>>>>>> /usr/src/app/output/dtrules/dtrules/d5e924b9f3bb4fcef9236053947288bbd6aa9e6d/compilerutil/src/main/java/com/dtrules/testsupport/ATestHarness.java/right.java
  ;
...
>>>>>>> /usr/src/app/output/dtrules/dtrules/d5e924b9f3bb4fcef9236053947288bbd6aa9e6d/compilerutil/src/main/java/com/dtrules/testsupport/ATestHarness.java/right.java
  ...
  protected boolean pCoverage = true;
  ...
  @Override public int harnessVersion() {
    return 1;
  }
  ...
  public void setRulesDirectoryFile(String rulesDirectoryFile) {
    this.rulesDirectoryFile = rulesDirectoryFile;
  }
  ...
  /**
     ...
     * @return
     */
  @Override public String entrypoint() {
    return "default";
  }
  ...
  public void changeReportXML(OutputStream report) {
    ChangeReport cr = new ChangeReport(getRuleSetName(), getPath(), getRulesDirectoryFile(), "development", referencePath(), referenceRulesDirectoryFile(), "deployed");
    try {
      cr.compare(report);
    } catch (Exception e) {
  ...
  public String compareNodes(Node thisResult, Node oldResult) {
    ...
    if (MATCH.match == v) {
      if (thisResult.getTags() != null) {
        for (int i = 0; i < thisResult.getTags().size(); i++) {
          String r = compareNodes(thisResult.getTags().get(i), oldResult.getTags().get(i));
          if (r != null) {
            return r;
          }
        }
    ...
    String message = msg + " found on a tag: new:{" + thisResult.getName() + "} old:{" + oldResult.getName() + "} " + "with a body: new:{" + thisResult.getBody() + "} old:{" + oldResult.getBody() + "}";
    return message;
  }
  ...
  public void removeIds(Node node) {
    ...
    if (node.getName().equals("mapping_key") && node.getAttributes().get("name") != null && node.getAttributes().get("name").equals("mapping*key")) {
      node.setBody("");
    }
    if (node.getTags() != null) {
      for (Node child : node.getTags()) {
        removeIds(child);
      }
    }
  }
