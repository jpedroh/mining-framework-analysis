...
public class ListGrid {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public List<ListGridAction> getActiveToolbarActions() {
  ...
  /**
     ...
     * and are thus shown on the screen
     */
  @SuppressWarnings(value = { "unchecked" }) public List<ListGridAction> getActiveRowActions() {
  ...
  /**
     ...
     * and are thus shown on the screen
     */
  @SuppressWarnings(value = { "unchecked" }) public List<ListGridAction> getActiveToolbarActionGroups() {
    return (List<ListGridAction>) CollectionUtils.select(getToolbarActionGroups(), new TypedPredicate<ListGridActionGroup>() {
      @Override public boolean eval(ListGridActionGroup actionGroup) {
  ...
  /**
     ...
     * and are thus shown on the screen
     */
  @SuppressWarnings(value = { "unchecked" }) public List<ListGridAction> getActiveRowActionGroups() {
  ...
  /**
     ...
     * and are thus shown on the screen
     */
  @SuppressWarnings(value = { "unchecked" }) public List<ListGridAction> getActiveModalRowActions() {
