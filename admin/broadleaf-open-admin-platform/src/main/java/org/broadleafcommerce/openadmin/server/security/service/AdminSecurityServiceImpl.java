 ...
 *
 */
@Service(value = "blAdminSecurityService") public class AdminSecurityServiceImpl implements AdminSecurityService {
  ...
  @Resource(name = "blAdminRoleDao") protected AdminRoleDao adminRoleDao;

  @Resource(name = "blAdminUserDao") protected AdminUserDao adminUserDao;

  @Resource(name = "blForgotPasswordSecurityTokenDao") protected ForgotPasswordSecurityTokenDao forgotPasswordSecurityTokenDao;

  @Resource(name = "blAdminPermissionDao") protected AdminPermissionDao adminPermissionDao;
  ...
  /**
     ...
     */
  @Resource(name = "blAdminPasswordEncoder") protected PasswordEncoder passwordEncoderBean;

  @Resource(name = "blEmailService") protected EmailService emailService;

  @Resource(name = "blSendAdminResetPasswordEmail") protected EmailInfo resetPasswordEmailInfo;

  @Resource(name = "blSendAdminUsernameEmailInfo") protected EmailInfo sendUsernameEmailInfo;

  @Resource(name = "blAdminSecurityServiceExtensionManager") protected AdminSecurityServiceExtensionManager extensionManager;
  ...
  @Override @Transactional(value = "blTransactionManager") public void deleteAdminPermission(AdminPermission permission) {
    adminPermissionDao.deleteAdminPermission(permission);
    clearAdminSecurityCache();
  }

  @Override @Transactional(value = "blTransactionManager") public void deleteAdminRole(AdminRole role) {
    adminRoleDao.deleteAdminRole(role);
    clearAdminSecurityCache();
  }

  @Override @Transactional(value = "blTransactionManager") public void deleteAdminUser(AdminUser user) {
  ...
  @Override @Transactional(value = "blTransactionManager") public AdminPermission saveAdminPermission(AdminPermission permission) {
    permission = adminPermissionDao.saveAdminPermission(permission);
    clearAdminSecurityCache();
    return permission;
  }

  @Override @Transactional(value = "blTransactionManager") public AdminRole saveAdminRole(AdminRole role) {
    role = adminRoleDao.saveAdminRole(role);
    clearAdminSecurityCache();
    return role;
  }

  @Override @Transactional(value = "blTransactionManager") public AdminUser saveAdminUser(AdminUser user) {
  ...
  @Override public void clearAdminSecurityCache() {
  ...
  @Override @Transactional(value = "blTransactionManager") public AdminUser changePassword(PasswordChange passwordChange) {
  ...
  @Override public boolean isUserQualifiedForOperationOnCeilingEntity(AdminUser adminUser, PermissionType permissionType, String ceilingEntityFullyQualifiedName) {
  ...
  protected String buildCacheKey(AdminUser adminUser, PermissionType permissionType, String ceilingEntityFullyQualifiedName) {
    return CACHE_KEY_PREFIX + "user:" + adminUser.getId() + "," + "permType:" + permissionType.getFriendlyType() + "," + "ceiling:" + ceilingEntityFullyQualifiedName;
  }

  @Override public boolean doesOperationExistForCeilingEntity(PermissionType permissionType, String ceilingEntityFullyQualifiedName) {
  ...
  @Override public List<AdminUser> readAdminUsersByEmail(String email) {
  ...
  @Override @Transactional(value = "blTransactionManager") public GenericResponse sendForgotUsernameNotification(String emailAddress) {
  ...
  @Override @Transactional(value = "blTransactionManager") public GenericResponse sendResetPasswordNotification(String username) {
    GenericResponse response = new GenericResponse();
    AdminUser user = null;
    if (username != null) {
  ...
  @Override @Transactional(value = "blTransactionManager") public GenericResponse resetPasswordUsingToken(String username, String token, String password, String confirmPassword) {
    GenericResponse response = new GenericResponse();
    AdminUser user = null;
    if (username != null) {
      user = adminUserDao.readAdminUserByUserName(username);
    ...
    if (!response.getHasErrors()) {
      ...
      if (fpst == null) {
        ...
        if (fpst.isTokenUsedFlag()) {
          response.addErrorCode("tokenUsed");
        } else {
          if (isTokenExpired(fpst)) {
  ...
  protected void checkUser(AdminUser user, GenericResponse response) {
    if (user == null) {
      ...
      if (StringUtils.isBlank(user.getEmail())) {
        ...
        if (BooleanUtils.isNotTrue(user.getActiveStatusFlag())) {
          response.addErrorCode("inactiveUser");
        }
      }
    }
  ...
  @Override @Transactional(value = "blTransactionManager") public GenericResponse changePassword(String username, String oldPassword, String password, String confirmPassword) {
    GenericResponse response = new GenericResponse();
    AdminUser user = null;
    if (username != null) {
      user = adminUserDao.readAdminUserByUserName(username);
