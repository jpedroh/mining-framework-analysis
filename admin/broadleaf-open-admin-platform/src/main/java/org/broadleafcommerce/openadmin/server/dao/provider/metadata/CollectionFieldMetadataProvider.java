 ...
 * @author Jeff Fischer
 */
@Component(value = "blCollectionFieldMetadataProvider") @Scope(value = "prototype") public class CollectionFieldMetadataProvider extends AdvancedCollectionFieldMetadataProvider {
  ...
  protected FieldMetadataOverride overrideCollectionMergeMetadata(AdminPresentationMergeOverride merge) {
    ...
    for (Map.Entry<String, AdminPresentationMergeEntry> entry : overrideValues.entrySet()) {
      ...
      if (entry.getKey().equals(PropertyType.AdminPresentationCollection.ADDTYPE)) {
        ...
        if (entry.getKey().equals(PropertyType.AdminPresentationCollection.SELECTIZEVISIBLEFIELD)) {
          fieldMetadataOverride.setSelectizeVisibleField(stringValue);
        } else {
          if (entry.getKey().equals(PropertyType.AdminPresentationCollection.CURRENCYCODEFIELD)) {
            fieldMetadataOverride.setCurrencyCodeField(stringValue);
          } else {
            if (entry.getKey().equals(PropertyType.AdminPresentationCollection.CUSTOMCRITERIA)) {
              fieldMetadataOverride.setCustomCriteria(entry.getValue().stringArrayOverrideValue());
            } else {
              if (entry.getKey().equals(PropertyType.AdminPresentationCollection.EXCLUDED)) {
                ...
                if (entry.getKey().equals(PropertyType.AdminPresentationCollection.FRIENDLYNAME)) {
                  fieldMetadataOverride.setFriendlyName(stringValue);
                } else {
                  if (entry.getKey().equals(PropertyType.AdminPresentationCollection.ADDFRIENDLYNAME)) {
                    fieldMetadataOverride.setAddFriendlyName(stringValue);
                  } else {
                    if (entry.getKey().equals(PropertyType.AdminPresentationCollection.GROUP)) {
                      fieldMetadataOverride.setGroup(stringValue);
                    } else {
                      if (entry.getKey().equals(PropertyType.AdminPresentationCollection.MANYTOFIELD)) {
                        fieldMetadataOverride.setManyToField(stringValue);
                      } else {
                        if (entry.getKey().equals(PropertyType.AdminPresentationCollection.OPERATIONTYPES)) {
                          ...
                          if (entry.getKey().equals(PropertyType.AdminPresentationCollection.ORDER)) {
                            ...
                            if (entry.getKey().equals(PropertyType.AdminPresentationCollection.MANYTOFIELD)) {
                              ...
                              if (entry.getKey().equals(PropertyType.AdminPresentationCollection.READONLY)) {
                                ...
                                if (entry.getKey().equals(PropertyType.AdminPresentationCollection.SECURITYLEVEL)) {
                                  fieldMetadataOverride.setSecurityLevel(stringValue);
                                } else {
                                  if (entry.getKey().equals(PropertyType.AdminPresentationCollection.SHOWIFPROPERTY)) {
                                    ...
                                    if (entry.getKey().equals(PropertyType.AdminPresentationCollection.SHOWIFFIELDEQUALS)) {
                                      ...
                                      if (entry.getKey().equals(PropertyType.AdminPresentationCollection.SORTASCENDING)) {
                                        ...
                                        if (entry.getKey().equals(PropertyType.AdminPresentationCollection.SORTPROPERTY)) {
                                          fieldMetadataOverride.setSortProperty(stringValue);
                                        } else {
                                          if (entry.getKey().equals(PropertyType.AdminPresentationCollection.TAB)) {
                                            fieldMetadataOverride.setTab(stringValue);
                                          } else {
                                            if (entry.getKey().equals(PropertyType.AdminPresentationCollection.TABORDER)) {
                                              ...
                                              if (entry.getKey().equals(PropertyType.AdminPresentationCollection.USESERVERSIDEINSPECTIONCACHE)) {
