...
@Controller(value = "blAdminBaseProductController") @RequestMapping(value = "/" + AdminProductController.SECTION_KEY + ":" + AdminBaseProductController.SECTION_KEY) public class AdminBaseProductController extends AdminProductController {
  ...
  @Override @RequestMapping(value = { "" }, method = { RequestMethod.GET }) public String viewEntityList(HttpServletRequest request, HttpServletResponse response, Model model, @PathVariable Map<String, String> pathVars, @RequestParam MultiValueMap<String, String> requestParams) throws Exception {
