...
public class MVELToDataWrapperTranslatorTest extends TestCase {
  ...
  public void testWithinDaysDataWrapper() throws MVELTranslationException {
    ...
    Property m1 = new Property();
    m1.setName("matchRule");
    m1.setValue("(MvelHelper.convertField(\"DATE\",customer.?getCustomerAttributes()[\"invoice_date\"])" + ">MvelHelper.convertField(\"DATE\",MvelHelper.subtractFromCurrentTime(10))" + "&&MvelHelper.convertField(\"DATE\",customer.?getCustomerAttributes()[\"invoice_date\"])" + "<MvelHelper.convertField(\"DATE\",MvelHelper.currentTime()))");
    Property q1 = new Property();
    q1.setName("quantity");
    q1.setValue("1");
    Property i1 = new Property();
