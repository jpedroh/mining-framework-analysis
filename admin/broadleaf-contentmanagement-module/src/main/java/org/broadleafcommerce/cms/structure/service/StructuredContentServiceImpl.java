 ...
 * @author bpolster
 */
@Service(value = "blStructuredContentService") public class StructuredContentServiceImpl implements StructuredContentService {
  ...
  @Resource(name = "blStructuredContentDao") protected StructuredContentDao structuredContentDao;

  @Resource(name = "blStaticAssetService") protected StaticAssetService staticAssetService;

  @Resource(name = "blStaticAssetPathService") protected StaticAssetPathService staticAssetPathService;

  @Resource(name = "blLocaleService") protected LocaleService localeService;

  @Resource(name = "blContentRuleProcessors") protected List<RuleProcessor<StructuredContentDTO>> contentRuleProcessors;

  @Resource(name = "blEntityConfiguration") protected EntityConfiguration entityConfiguration;

  @Resource(name = "blStructuredContentServiceExtensionManager") protected StructuredContentServiceExtensionManager extensionManager;
  ...
  @Override public StructuredContentType findStructuredContentTypeById(Long id) {
  ...
  @Override public List<StructuredContent> findContentItems(Criteria c) {
    return c.list();
  }
  ...
  @Override public Long countContentItems(Criteria c) {
  ...
  /**
     ...
     */
  @Override public List<StructuredContentDTO> buildStructuredContentDTOList(List<StructuredContent> structuredContentList, boolean secure) {
  ...
  @Override public List<StructuredContentDTO> evaluateAndPriortizeContent(List<StructuredContentDTO> structuredContentList, int count, Map<String, Object> ruleDTOs) {
  ...
  @Override public List<StructuredContentDTO> lookupStructuredContentItemsByType(StructuredContentType contentType, Locale locale, Integer count, Map<String, Object> ruleDTOs, boolean secure) {
  ...
  @Override public List<StructuredContentDTO> lookupStructuredContentItemsByName(StructuredContentType contentType, String contentName, Locale locale, Integer count, Map<String, Object> ruleDTOs, boolean secure) {
    List<StructuredContentDTO> contentDTOList = null;
    Locale languageOnlyLocale = findLanguageOnlyLocale(locale);
    BroadleafRequestContext context = BroadleafRequestContext.getBroadleafRequestContext();
    Long site = (context.getNonPersistentSite() != null) ? context.getNonPersistentSite().getId() : null;
  ...
  @Override public List<StructuredContentDTO> convertToDtos(List<StructuredContent> scs, boolean isSecure) {
  ...
  @Override public List<StructuredContentDTO> lookupStructuredContentItemsByName(String contentName, Locale locale, Integer count, Map<String, Object> ruleDTOs, boolean secure) {
  ...
  @Override public void removeStructuredContentFromCache(SandBox sandBox, StructuredContent sc) {
  ...
  @Override public boolean removeItemFromCacheByKey(String key) {
  ...
  @Override public void removeItemFromCache(String nameKey, String typeKey) {
    removeItemFromCacheByKey(nameKey);
    removeItemFromCacheByKey(typeKey);
  }

  @Override public Locale findLanguageOnlyLocale(Locale locale) {
    if (locale != null) {
  ...
  @Override public Cache getStructuredContentCache() {
  ...
  /**
     ...
     * @return
     */
  @Override public StructuredContentDTO buildStructuredContentDTO(StructuredContent sc, boolean secure) {
  ...
  @Override public String buildTypeKey(SandBox currentSandbox, Long site, Locale locale, String contentType) {
    return buildTypeKeyWithSecure(currentSandbox, site, locale, contentType, null);
  }

  @Override public String buildTypeKeyWithSecure(SandBox currentSandbox, Long site, Locale locale, String contentType, Boolean secure) {
  ...
  @Override public void addStructuredContentListToCache(String key, List<StructuredContentDTO> scDTOList) {
  ...
  @Override public List<StructuredContentDTO> getStructuredContentListFromCache(String key) {
    Object scElement = getStructuredContentCache().get(key);
    if (scElement != null) {
      statisticsService.addCacheStat(CacheStatType.STRUCTURED_CONTENT_CACHE_HIT_RATE.toString(), true);
  ...
  @Override public List<StructuredContentDTO> getStructuredContentItemsByContentName(String contentName, Locale locale, boolean secure) {
    List<StructuredContentDTO> contentDTOList = null;
    Locale languageOnlyLocale = findLanguageOnlyLocale(locale);
    BroadleafRequestContext context = BroadleafRequestContext.getBroadleafRequestContext();
    Long site = (context.getNonPersistentSite() != null) ? context.getNonPersistentSite().getId() : null;
