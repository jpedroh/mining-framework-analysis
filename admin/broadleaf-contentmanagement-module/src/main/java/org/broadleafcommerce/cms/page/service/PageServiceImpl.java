 ...
 */
@Service(value = "blPageService") public class PageServiceImpl implements PageService {
  protected static final Log LOG = LogFactory.getLog(PageServiceImpl.class);

  protected static String AND = " && ";

  @Resource(name = "blPageDao") protected PageDao pageDao;

  @Resource(name = "blPageRuleProcessors") protected List<RuleProcessor<PageDTO>> pageRuleProcessors;
  ...
  @Resource(name = "blTemplateOverrideExtensionManager") protected TemplateOverrideExtensionManager templateOverrideManager;

  @Resource(name = "blPageServiceUtility") protected PageServiceUtility pageServiceUtility;

  @Resource(name = "blPageServiceExtensionManager") protected PageServiceExtensionManager extensionManager;

  @Resource(name = "blPageQueryExtensionManager") protected PageQueryExtensionManager queryExtensionManager;
  ...
  @Override public Page findPageById(Long pageId) {
    return pageDao.readPageById(pageId);
  }

  @Override public Map<String, PageField> findPageFieldMapByPageId(Long pageId) {
  ...
  @Override public PageTemplate findPageTemplateById(Long id) {
    return pageDao.readPageTemplateById(id);
  }

  @Override @Transactional(value = "blTransactionManager") public PageTemplate savePageTemplate(PageTemplate template) {
    return pageDao.savePageTemplate(template);
  }

  @Override public PageDTO findPageByURI(Locale locale, String uri, Map<String, Object> ruleDTOs, boolean secure) {
    PageDTO dto;
  ...
  @Override public List<PageDTO> buildPageDTOList(List<Page> pageList, boolean secure, String identifier, Locale locale) {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected List<PageDTO> buildPageDTOListUsingCache(List<Page> pageList, String identifier, Locale locale, boolean secure) {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected List<PageDTO> getPageListFromCache(String key) {
    if (key != null) {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected void addPageMapCacheEntry(String identifier, String key) {
    BroadleafRequestContext context = BroadleafRequestContext.getBroadleafRequestContext();
  ...
  @Override public String getPageMapCacheKey(String uri, Long site) {
  ...
  @Override public Cache getPageCache() {
    if (pageCache == null) {
  ...
  @Override public Cache getPageMapCache() {
  ...
  @Override public Cache getUriCachedDateCache() {
  ...
  @Override @SuppressWarnings(value = { "unchecked" }) public Boolean removePageFromCache(String mapKey) {
  ...
  @Override public Boolean removeTranslationPageFromCache(final String uri, String localeCode, boolean isSecure) {
