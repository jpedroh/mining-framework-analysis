  ...
  public static void paintRoadMapping(Graphics2D g, RoadMapping roadMapping, double lateralOffset) {
    ...
    if (roadMappingClass == RoadMappingLine.class) {
      ...
      if (roadMappingClass == RoadMappingU.class) {
        ...
        arc2D.setArcByCenter(posTheta.x - straightLength, posTheta.y + radius, radius + lateralOffset, 90.0, 180.0, Arc2D.OPEN);
        g.draw(arc2D);
        return;
      } else {
        if (roadMappingClass == RoadMappingS.class) {
        } else {
          if (roadMappingClass == RoadMappingArc.class) {
            ...
            final Arc2D.Double arc2D = new Arc2D.Double();
            arc2D.setArcByCenter(posTheta.x - dx, posTheta.y + dy, radius + lateralOffset, Math.toDegrees(angSt), Math.toDegrees(arc.arcAngle()), Arc2D.OPEN);
            g.draw(arc2D);
            return;
          } else {
            if (roadMappingClass == RoadMappingCircle.class) {
              ...
              if (roadMappingClass == RoadMappingPoly.class) {
                ...
                if (roadMappingClass == RoadMappingPolyLine.class) {
                  ...
                  if (roadMappingClass.equals(RoadMappingBezier.class)) {
                    if (lateralOffset == 0.0) {
                    ...
                    if (roadMappingClass.equals(RoadMappingPolyBezier.class)) {
                      if (lateralOffset == 0.0) {
                        ...
                        if (drawBezierPoints) {
                          g.fillOval((int) posTheta.x - radius / 2, (int) posTheta.y - radius / 2, radius, radius);
                          g.fillOval((int) bezier.controlX(lateralOffset) - radiusC / 2, (int) bezier.controlY(lateralOffset) - radiusC / 2, radiusC, radiusC);
                        }
                        while (iterator.hasNext()) {
