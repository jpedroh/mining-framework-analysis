 ...
 */
@RunWith(value = SpringRunner.class) @ContextConfiguration(initializers = BroadleafEnvironmentConfiguringApplicationListener.class) @DirtiesContext public class DeprecatedRuntimeEnvironmentTest {
  @BeforeClass public static void setRuntimeEnvironment() {
    System.setProperty(BroadleafEnvironmentConfigurer.DEPRECATED_RUNTIME_ENVIRONMENT_KEY, "production");
  }

  @AfterClass public static void clearRuntimeEnvironment() {
    System.clearProperty(BroadleafEnvironmentConfigurer.DEPRECATED_RUNTIME_ENVIRONMENT_KEY);
  }

  @Autowired protected Environment env;

  @Test public void testDeprecatedRuntimeEnvironmentKey() {
