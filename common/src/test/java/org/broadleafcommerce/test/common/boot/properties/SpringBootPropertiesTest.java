 ...
 */
@SpringBootTest @RunWith(value = SpringRunner.class) public class SpringBootPropertiesTest {
  @Configuration public static class PropertiesConfig {
  }
  ...
  @Test public void testProfileSourcesRegisteredOverridesCommon() {
  ...
  @Test public void testBootPropertiesOverrideBroadleaf() {
