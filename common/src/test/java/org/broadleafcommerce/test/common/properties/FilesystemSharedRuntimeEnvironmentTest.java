 ...
 */
@RunWith(value = SpringRunner.class) @ContextConfiguration(initializers = BroadleafEnvironmentConfiguringApplicationListener.class) @ActiveProfiles(value = "production") @DirtiesContext public class FilesystemSharedRuntimeEnvironmentTest {
