...
public class JsonUtils {
  ...
  public static <T extends java.lang.Object> T unmarshalFromByte(byte[] bytes, Class<T> targetClass) {
    return (T) JSON.parseObject(bytes, targetClass);
  }

  public static <T extends java.lang.Object> T unmarshalFromByte(byte[] bytes, TypeReference<T> type) {
  ...
  public static <T extends java.lang.Object> T unmarshalFromString(String json, Class<T> targetClass) {
    return (T) JSON.parseObject(json, targetClass);
  }

  public static <T extends java.lang.Object> T unmarshalFromString(String json, TypeReference<T> type) {
  ...
  public static class InetAddressSerializer implements ObjectSerializer {
    ...
    @Override public void write(JSONSerializer serializer, Object object, Object fieldName, Type type, int i) throws IOException {
      if (object == null) {
