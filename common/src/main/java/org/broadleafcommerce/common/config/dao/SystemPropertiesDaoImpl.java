...
@Repository(value = "blSystemPropertiesDao") public class SystemPropertiesDaoImpl extends AbstractCacheMissAware<SystemProperty> implements SystemPropertiesDao {
  ...
  @Resource(name = "blSystemPropertyDaoQueryExtensionManager") protected SystemPropertyDaoQueryExtensionManager queryExtensionManager;

  private SystemProperty nullObject;

  @Override public SystemProperty readById(Long id) {
  ...
  @Override public SystemProperty readSystemPropertyByName(final String name) {
  ...
  @Override protected Log getLogger() {
    return LOG;
  }
  ...
  @Override protected synchronized SystemProperty getNullObject(final Class<SystemProperty> responseClass) {
    if (nullObject == null) {
