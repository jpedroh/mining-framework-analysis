...
@Retention(value = RetentionPolicy.RUNTIME) @Target(value = { ElementType.FIELD }) public @interface AdminPresentation {
  ...
  @Deprecated int groupOrder() default 99999;

  @Deprecated boolean groupCollapsed() default false;
