...
@Repository(value = "blTranslationDao") public class TranslationDaoImpl implements TranslationDao {
  ...
  @Override public Class<?> getEntityImpl(TranslatedEntity entity) {
  ...
  @Override public Translation readTranslation(TranslatedEntity entity, String entityId, String fieldName, String localeCode) {
    entityId = getUpdatedEntityId(entity, entityId);
    CriteriaBuilder builder = em.getCriteriaBuilder();
    CriteriaQuery<Translation> criteria = builder.createQuery(Translation.class);
    Root<TranslationImpl> translation = criteria.from(TranslationImpl.class);
  ...
  @Override public String getEntityId(TranslatedEntity entityType, Object entity) {
  ...
  @Override public Long countTranslationEntries(TranslatedEntity entityType, ResultType stage) {
    CriteriaBuilder builder = em.getCriteriaBuilder();
  ...
  @Override public List<Translation> readAllTranslationEntries(TranslatedEntity entityType, ResultType stage) {
  ...
  @Override public List<StandardCacheItem> readConvertedTranslationEntries(TranslatedEntity entityType, ResultType stage) {
  ...
  @Override public Translation readTranslation(TranslatedEntity entityType, String entityId, String fieldName, String localeCode, String localeCountryCode, ResultType stage) {
    CriteriaBuilder builder = em.getCriteriaBuilder();
    CriteriaQuery<Translation> criteria = builder.createQuery(Translation.class);
    Root<TranslationImpl> root = criteria.from(TranslationImpl.class);
    criteria.select(root);
