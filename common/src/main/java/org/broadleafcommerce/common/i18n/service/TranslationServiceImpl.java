...
@Service(value = "blTranslationService") public class TranslationServiceImpl implements TranslationService, TranslationSupport {
  ...
  @Resource(name = "blTranslationServiceExtensionManager") protected TranslationServiceExtensionManager extensionManager;
  ...
  @Resource(name = "blTranslationExceptionProperties") protected List<String> translationExceptionProperties = new ArrayList<String>();

  @Resource(name = "blLocaleService") protected LocaleService localeService;

  @Resource protected List<TranslationOverrideStrategy> strategies;

  @Resource(name = "blCacheManager") protected CacheManager cacheManager;

  @Override @Transactional(value = "blTransactionManager") public Translation save(Translation translation) {
    return dao.save(translation);
  }

  @Override @Transactional(value = "blTransactionManager") public Translation save(String entityType, String entityId, String fieldName, String localeCode, String translatedValue) {
  ...
  @Override public Translation findTranslationById(Long id) {
    return dao.readTranslationById(id);
  }

  @Override @Transactional(value = "blTransactionManager") public Translation update(Long translationId, String localeCode, String translatedValue) {
  ...
  @Override @Transactional(value = "blTransactionManager") public void deleteTranslationById(Long translationId) {
    Translation t = dao.readTranslationById(translationId);
    dao.delete(t);
  }

  @Override public Translation getTranslation(TranslatedEntity entity, String entityId, String fieldName, String localeCode) {
    return dao.readTranslation(entity, entityId, fieldName, localeCode);
  }

  @Override public List<Translation> getTranslations(String ceilingEntityClassname, String entityId, String property) {
  ...
  @Override public Cache<String, Object> getCache() {
    if (cache == null) {
      synchronized (this) {
        if (cache == null) {
  ...
  @Override public String getTranslatedValue(Object entity, String property, Locale locale) {
  ...
  @Override public void removeTranslationFromCache(Translation translation) {
  ...
  @Override public StandardCacheItem lookupTranslationFromMap(String key, Map<String, Map<String, StandardCacheItem>> propertyTranslationMap, String entityId) {
  ...
  @Override public Translation findBestTemplateTranslation(String specificPropertyKey, String generalPropertyKey, Map<String, Map<String, Translation>> propertyTranslationMap, String entityId) {
  ...
  @Override public TranslatedEntity getAssignableEntityType(String className) {
    try {
  ...
  @Override public String getCacheKey(ResultType resultType, TranslatedEntity entityType) {
  ...
  @Override public List<String> getCacheKeyListForTemplateSite(String propertyName) {
  ...
  @Override public int getThresholdForFullCache() {
    if (BroadleafRequestContext.getBroadleafRequestContext().isProductionSandBox()) {
  ...
  @Override public void setThresholdForFullCache(int thresholdForFullCache) {
    this.thresholdForFullCache = thresholdForFullCache;
  }

  @Override public int getTemplateThresholdForFullCache() {
    if (BroadleafRequestContext.getBroadleafRequestContext().isProductionSandBox()) {
  ...
  @Override public void setTemplateThresholdForFullCache(int templateThresholdForFullCache) {
    this.templateThresholdForFullCache = templateThresholdForFullCache;
  }

  @Override public String getDefaultTranslationValue(Object entity, String property, Locale locale, String requestedDefaultValue) {
  ...
  @Override public List<Translation> findAllTranslationEntries(TranslatedEntity translatedEntity, ResultType standard, List<String> entityIds) {
