...
public abstract class AbstractGeneratedResourceHandler implements Ordered {
  ...
  @javax.annotation.Resource(name = "blStreamingTransactionCapableUtil") protected StreamingTransactionCapableUtil transUtil;

  @javax.annotation.Resource(name = "blResourceRequestExtensionManager") protected ResourceRequestExtensionManager extensionManager;

  @javax.annotation.Resource(name = "blCacheManager") protected CacheManager cacheManager;
  ...
  public Resource getResource(final String path, final List<Resource> locations) {
    ...
    if (r == null) {
      ...
      if (r instanceof GeneratedResource && isCachedResourceExpired((GeneratedResource) r, path, locations)) {
        shouldGenerate = true;
      }
    }
    if (shouldGenerate) {
