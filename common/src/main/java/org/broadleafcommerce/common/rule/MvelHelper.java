...
public class MvelHelper {
  ...
  public static Object convertField(String type, String fieldValue) {
    ...
    try {
      if (type.equals(SupportedFieldType.BOOLEAN.toString())) {
        ...
        if (type.equals(SupportedFieldType.DATE.toString())) {
          ...
          if (type.equals(SupportedFieldType.INTEGER.toString())) {
            return Integer.parseInt(fieldValue);
          } else {
            if (type.equals(SupportedFieldType.MONEY.toString()) || type.equals(SupportedFieldType.DECIMAL.toString())) {
  ...
  protected static String[] getRuleAttributeMaps() {
    return new String[] { "getProductAttributes", "getCategoryAttributesMap", "getSkuAttributes", "getOrderItemAttributes", "getCustomerAttributes", "getAdditionalAttributes", "getAdditionalFields" };
  }
