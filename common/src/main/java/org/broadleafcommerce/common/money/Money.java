...
@XmlAccessorType(value = XmlAccessType.FIELD) @JsonIgnoreProperties(value = { "zero" }) public class Money implements Serializable, Cloneable, Comparable<Money>, Externalizable {
  private static final long serialVersionUID = 1L;

  @XmlElement @XmlJavaTypeAdapter(value = BigDecimalRoundingAdapter.class) private BigDecimal amount;

  @XmlElement @XmlJavaTypeAdapter(value = CurrencyAdapter.class) private final Currency currency;
  ...
  public Money(int amount) {
    this(BigDecimal.valueOf(amount).setScale(BankersRounding.getScaleForCurrency(defaultCurrency()), RoundingMode.HALF_EVEN), defaultCurrency());
  }
