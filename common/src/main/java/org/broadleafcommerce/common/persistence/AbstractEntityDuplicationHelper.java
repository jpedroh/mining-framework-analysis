 ...
 */
public abstract class AbstractEntityDuplicationHelper<T extends java.lang.Object> implements EntityDuplicationHelper<T> {
  ...
  @Override public abstract boolean canHandle(final MultiTenantCloneable candidate);

  @Override public Map<String, String> getCopyHints() {
    return copyHints;
  }

  @Override public void addCopyHint(final String name, final String hint) {
    copyHints.put(name, hint);
  }

  @Override public abstract void modifyInitialDuplicateState(final T original, final T copy, MultiTenantCopyContext context) throws CloneNotSupportedException;
}