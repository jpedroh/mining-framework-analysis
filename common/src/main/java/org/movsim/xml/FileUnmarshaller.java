...
public class FileUnmarshaller<T extends java.lang.Object> {
  ...
  private final Unmarshaller createUnmarshaller(final Class<?> objectFactoryClass, final URL xsdFile) throws JAXBException, SAXException {
