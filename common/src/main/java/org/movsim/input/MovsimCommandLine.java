...
public class MovsimCommandLine {
  ...
  private void createOptions() {
    ...
    options.addOption("w", "write_xsd", false, "writes xsd file to output (for convenience/lookup schema definitions)");
    ...
    options.addOption("s", "simulation scanning mode", false, "invokes the simulator repeatedly in a loop (needs to be programmed by user)");
    OptionBuilder.withArgName("file");
    OptionBuilder.hasArg();
    ProjectMetaData.getInstance();
    OptionBuilder.withDescription("movsim main configuration file (ending \"" + ProjectMetaData.getMovsimConfigFileEnding() + "\" will be added automatically if not provided.");
