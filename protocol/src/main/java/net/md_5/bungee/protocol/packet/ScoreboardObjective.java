...
@Data @NoArgsConstructor @AllArgsConstructor @EqualsAndHashCode(callSuper = false) public class ScoreboardObjective extends DefinedPacket {
  private String name;
  ...
  @Deprecated public ScoreboardObjective(String name, String value, String type, byte action) {
    this.name = name;
    this.value = value;
