...
@Getter public class MinecraftDecoder extends MessageToMessageDecoder<ByteBuf> {
  ...
  @Setter private boolean[] copiedBuffers;

  @Setter private boolean[] handledPackets;
  ...
  @Override protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
    ...
    try {
      ...
      if (copiedBuffers != null && packetId >= 0 && packetId < copiedBuffers.length && copiedBuffers[packetId]) {
        buf = in.copy(markIndex, markReadable);
      } else {
...
<<<<<<< /usr/src/app/output/spigotmc/bungeecord/7838c02a6bb70dc404e03eec1526e030fce52d56/protocol/src/main/java/net/md_5/bungee/protocol/MinecraftDecoder.java/left.java
          packet.read(in, prot.getDirection(), protocolVersion);
=======
          throw new BadPacketException("Did not read all bytes from packet " + packet.getClass() + " " + packetId + " Protocol " + protocol + " Direction " + prot.getDirection());
>>>>>>> /usr/src/app/output/spigotmc/bungeecord/7838c02a6bb70dc404e03eec1526e030fce52d56/protocol/src/main/java/net/md_5/bungee/protocol/MinecraftDecoder.java/right.java
