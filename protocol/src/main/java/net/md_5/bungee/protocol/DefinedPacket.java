...
@RequiredArgsConstructor public abstract class DefinedPacket {
  ...
  public static String readString(ByteBuf buf, int maxLen) {
    ...
    if (len > maxLen * 4) {
      throw new FastOverflowPacketException(String.format(
<<<<<<< /usr/src/app/output/spigotmc/bungeecord/3d27f8f8f366d4adc020eb552970aa4ad597718c/protocol/src/main/java/net/md_5/bungee/protocol/DefinedPacket.java/left.java
      "Cannot receive string longer than Short.MAX_VALUE (got " + len + " characters)"
=======
      "Cannot receive string longer than %d (got %d bytes)"
