...
public enum Protocol {
  HANDSHAKE() {
    {
      TO_SERVER.registerPacket(Handshake.class, Handshake::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x00));
    }
  },
  GAME() {
    {
      TO_CLIENT.registerPacket(KeepAlive.class, KeepAlive::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x00), map(ProtocolConstants.MINECRAFT_1_9, 0x1F), map(ProtocolConstants.MINECRAFT_1_13, 0x21), map(ProtocolConstants.MINECRAFT_1_14, 0x20), map(ProtocolConstants.MINECRAFT_1_15, 0x21), map(ProtocolConstants.MINECRAFT_1_16, 0x20), map(ProtocolConstants.MINECRAFT_1_16_2, 0x1F), map(ProtocolConstants.MINECRAFT_1_17, 0x21));
      TO_CLIENT.registerPacket(Login.class, Login::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x01), map(ProtocolConstants.MINECRAFT_1_9, 0x23), map(ProtocolConstants.MINECRAFT_1_13, 0x25), map(ProtocolConstants.MINECRAFT_1_15, 0x26), map(ProtocolConstants.MINECRAFT_1_16, 0x25), map(ProtocolConstants.MINECRAFT_1_16_2, 0x24), map(ProtocolConstants.MINECRAFT_1_17, 0x26));
      TO_CLIENT.registerPacket(Chat.class, Chat::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x02), map(ProtocolConstants.MINECRAFT_1_9, 0x0F), map(ProtocolConstants.MINECRAFT_1_13, 0x0E), map(ProtocolConstants.MINECRAFT_1_15, 0x0F), map(ProtocolConstants.MINECRAFT_1_16, 0x0E), map(ProtocolConstants.MINECRAFT_1_17, 0x0F));
      ...
      TO_CLIENT.registerPacket(ClearTitles.class, ClearTitles::new, map(ProtocolConstants.MINECRAFT_1_17, 0x10));
      TO_CLIENT.registerPacket(Subtitle.class, Subtitle::new, map(ProtocolConstants.MINECRAFT_1_17, 0x57));
      TO_CLIENT.registerPacket(TitleTimes.class, TitleTimes::new, map(ProtocolConstants.MINECRAFT_1_17, 0x5A));
      ...
      TO_CLIENT.registerPacket(GameState.class, GameState::new, map(ProtocolConstants.MINECRAFT_1_15, 0x1F), map(ProtocolConstants.MINECRAFT_1_16, 0x1E), map(ProtocolConstants.MINECRAFT_1_16_2, 0x1D), map(ProtocolConstants.MINECRAFT_1_17, 0x1E));
      ...
      TO_SERVER.registerPacket(Chat.class, Chat::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x01), map(ProtocolConstants.MINECRAFT_1_9, 0x02), map(ProtocolConstants.MINECRAFT_1_12, 0x03), map(ProtocolConstants.MINECRAFT_1_12_1, 0x02), map(ProtocolConstants.MINECRAFT_1_14, 0x03));
      ...
      TO_SERVER.registerPacket(ClientSettings.class, ClientSettings::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x15), map(ProtocolConstants.MINECRAFT_1_9, 0x04), map(ProtocolConstants.MINECRAFT_1_12, 0x05), map(ProtocolConstants.MINECRAFT_1_12_1, 0x04), map(ProtocolConstants.MINECRAFT_1_14, 0x05));
  ...
  STATUS() {
    {
      TO_CLIENT.registerPacket(StatusResponse.class, StatusResponse::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x00));
      TO_CLIENT.registerPacket(PingPacket.class, PingPacket::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x01));
      TO_SERVER.registerPacket(StatusRequest.class, StatusRequest::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x00));
      TO_SERVER.registerPacket(PingPacket.class, PingPacket::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x01));
    }
  },
  LOGIN() {
    {
      TO_CLIENT.registerPacket(Kick.class, Kick::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x00));
      TO_CLIENT.registerPacket(EncryptionRequest.class, EncryptionRequest::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x01));
      TO_CLIENT.registerPacket(LoginSuccess.class, LoginSuccess::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x02));
      ...
      TO_SERVER.registerPacket(LoginRequest.class, LoginRequest::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x00));
      TO_SERVER.registerPacket(EncryptionResponse.class, EncryptionResponse::new, map(ProtocolConstants.MINECRAFT_1_7_2, 0x01));
  ...
  @Data private static class ProtocolData {
    ...
    @SuppressWarnings(value = { "unchecked" }) private final 
<<<<<<< /usr/src/app/output/spigotmc/bungeecord/412c148b035867136eeb9e8b7e9de3c5c89e9fee/protocol/src/main/java/net/md_5/bungee/protocol/Protocol.java/left.java
    TIntObjectMap<Constructor<? extends DefinedPacket>>
=======
...
>>>>>>> /usr/src/app/output/spigotmc/bungeecord/412c148b035867136eeb9e8b7e9de3c5c89e9fee/protocol/src/main/java/net/md_5/bungee/protocol/Protocol.java/right.java
     packetConstructors = 
<<<<<<< /usr/src/app/output/spigotmc/bungeecord/412c148b035867136eeb9e8b7e9de3c5c89e9fee/protocol/src/main/java/net/md_5/bungee/protocol/Protocol.java/left.java
    new TIntObjectHashMap<>(MAX_PACKET_ID)
=======
    new Supplier[MAX_PACKET_ID]
>>>>>>> /usr/src/app/output/spigotmc/bungeecord/412c148b035867136eeb9e8b7e9de3c5c89e9fee/protocol/src/main/java/net/md_5/bungee/protocol/Protocol.java/right.java
    ;
  }
