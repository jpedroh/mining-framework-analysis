...
@Data @NoArgsConstructor @AllArgsConstructor @EqualsAndHashCode(callSuper = false) public class Handshake extends DefinedPacket {
  ...
  @Override public void read(ByteBuf buf) {
    DefinedPacket.doLengthSanityChecks(buf, this, Direction.TO_SERVER, -1, EXPECTED_MIN_LENGTH, EXPECTED_MAX_LENGTH);
