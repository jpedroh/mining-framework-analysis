...
public class FRDocumentAbstractTest extends FRPersistencyAbstractTest {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected <T extends FRGenericInvoiceEntity> T newInvoice(INVOICE_TYPE type, SOURCE_BILLING source) {
    switch (type) {
      case FT:
  ...
  protected <T extends DocumentIssuingHandler<I, FRIssuingParams>, I extends FRGenericInvoiceEntity> void issueNewInvoice(T handler, I invoice, String series) throws DocumentIssuingException, SeriesUniqueCodeNotFilled, DocumentSeriesDoesNotExistException {
  ...
  protected <T extends DocumentIssuingHandler<I, FRIssuingParams>, I extends FRGenericInvoiceEntity> void issueNewInvoice(T handler, I invoice, String series, Date date) throws DocumentIssuingException, SeriesUniqueCodeNotFilled, DocumentSeriesDoesNotExistException {
