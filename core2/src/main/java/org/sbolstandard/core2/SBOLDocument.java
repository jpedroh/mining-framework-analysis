...
public class SBOLDocument {
  ...
  void addModuleDefinition(ModuleDefinition moduleDefinition) throws SBOLValidationException {
    addTopLevel(moduleDefinition, moduleDefinitions, "moduleDefinition", collections, componentDefinitions, experiments, experimentalData, genericTopLevels, activities, plans, agents, models, sequences, combinatorialDerivations, implementations, attachments);
  ...
  void addCollection(Collection collection) throws SBOLValidationException {
    addTopLevel(collection, collections, "collection", componentDefinitions, genericTopLevels, activities, plans, agents, models, moduleDefinitions, sequences, combinatorialDerivations, implementations, attachments);
  }
  ...
  /**
	 ...
	 *             10201, 10204, 10206.
	 */
  public Experiment createExperiment(String URIprefix, String displayId, String version) throws SBOLValidationException {
    URIprefix = URIcompliance.checkURIprefix(URIprefix);
    Experiment c = new Experiment(createCompliantURI(URIprefix, TopLevel.EXPERIMENT, displayId, version, typesInURIs));
    c.setDisplayId(displayId);
  ...
  void addExperiment(Experiment experiment) throws SBOLValidationException {
    addTopLevel(experiment, experiments, "experiment", collections, experimentalData, componentDefinitions, genericTopLevels, activities, plans, agents, models, moduleDefinitions, sequences, combinatorialDerivations, implementations, attachments);
  }
  ...
  public Experiment getExperiment(String displayId, String version) {
    try {
      return getExperiment(createCompliantURI(defaultURIprefix, TopLevel.EXPERIMENT, displayId, version, typesInURIs));
    } catch (SBOLValidationException e) {
      return null;
    }
  }
  ...
  /**
	 ...
	 *             10201, 10204, 10206.
	 */
  public ExperimentalData createExperimentalData(String URIprefix, String displayId, String version) throws SBOLValidationException {
    URIprefix = URIcompliance.checkURIprefix(URIprefix);
    ExperimentalData c = new ExperimentalData(createCompliantURI(URIprefix, TopLevel.EXPERIMENTAL_DATA, displayId, version, typesInURIs));
    c.setDisplayId(displayId);
  ...
  void addExperimentalData(ExperimentalData experimentalDatum) throws SBOLValidationException {
    addTopLevel(experimentalDatum, experimentalData, "experimentalData", collections, experiments, componentDefinitions, genericTopLevels, activities, plans, agents, models, moduleDefinitions, sequences, combinatorialDerivations, implementations, attachments);
  }
  ...
  public ExperimentalData getExperimentalData(String displayId, String version) {
    try {
      return getExperimentalData(createCompliantURI(defaultURIprefix, TopLevel.EXPERIMENTAL_DATA, displayId, version, typesInURIs));
    } catch (SBOLValidationException e) {
      return null;
    }
  }
  ...
  void addModel(Model model) throws SBOLValidationException {
    addTopLevel(model, models, "model", collections, componentDefinitions, experiments, experimentalData, genericTopLevels, activities, plans, agents, moduleDefinitions, sequences, combinatorialDerivations, implementations, attachments);
  }
  ...
  /**
	 ...
	 * 
	 */
  public Attachment createAttachment(String displayId, String version, URI source) throws SBOLValidationException {
  ...
  void addAttachment(Attachment attachment) throws SBOLValidationException {
    addTopLevel(attachment, attachments, "attachment", collections, componentDefinitions, experiments, experimentalData, genericTopLevels, activities, plans, agents, moduleDefinitions, sequences, combinatorialDerivations, implementations);
  }
  ...
  public ComponentDefinition createComponentDefinition(String URIprefix, String displayId, String version, Set<URI> types) throws SBOLValidationException {
    URIprefix = URIcompliance.checkURIprefix(URIprefix);
    ComponentDefinition cd = new ComponentDefinition(createCompliantURI(URIprefix, TopLevel.COMPONENT_DEFINITION, displayId, version, typesInURIs), types);
  ...
  void addComponentDefinition(ComponentDefinition componentDefinition) throws SBOLValidationException {
    addTopLevel(componentDefinition, componentDefinitions, "componentDefinition", collections, experiments, experimentalData, genericTopLevels, activities, plans, agents, models, moduleDefinitions, sequences, combinatorialDerivations, implementations, attachments);
  ...
  /**
	 ...
	 *             validation error
	 */
  public CombinatorialDerivation getCombinatorialDerivation(String displayId, String version) throws SBOLValidationException {
    URI uri = URIcompliance.createCompliantURI(defaultURIprefix, TopLevel.COMBINATORIAL_DERIVATION, displayId, version, typesInURIs);
  ...
  void addCombinatorialDerivation(CombinatorialDerivation combinatorialDerivation) throws SBOLValidationException {
    addTopLevel(combinatorialDerivation, combinatorialDerivations, "combinatorialDerivation", collections, experiments, experimentalData, genericTopLevels, activities, plans, agents, models, moduleDefinitions, sequences, implementations, attachments);
  ...
  /**
	 ...
	 *             {@link #createCombinatorialDerivation(String, String, URI)}.
	 */
  public CombinatorialDerivation createCombinatorialDerivation(String displayId, String version, String templateDisplayId, String templateVersion) throws SBOLValidationException {
  ...
  /**
	 ...
	 */
  public CombinatorialDerivation createCombinatorialDerivation(String displayId, URI template) throws SBOLValidationException {
  ...
  /**
	 ...
	 *             10201, 10202, 10204, 10206, 10220, 10502, 10503.
	 */
  public CombinatorialDerivation createCombinatorialDerivation(String URIprefix, String displayId, String version, URI template) throws SBOLValidationException {
    URIprefix = URIcompliance.checkURIprefix(URIprefix);
    CombinatorialDerivation cd = new CombinatorialDerivation(createCompliantURI(URIprefix, TopLevel.COMBINATORIAL_DERIVATION, displayId, version, typesInURIs), template);
    cd.setDisplayId(displayId);
    cd.setPersistentIdentity(createCompliantURI(URIprefix, TopLevel.COMBINATORIAL_DERIVATION, displayId, "", typesInURIs));
    cd.setVersion(version);
  ...
  /**
	 ...
	 *             validation error
	 */
  public Implementation getImplementation(String displayId, String version) throws SBOLValidationException {
    URI uri = URIcompliance.createCompliantURI(defaultURIprefix, TopLevel.IMPLEMENTATION, displayId, version, typesInURIs);
  ...
  void addImplementation(Implementation implementation) throws SBOLValidationException {
    addTopLevel(implementation, implementations, "implementation", collections, experiments, experimentalData, genericTopLevels, activities, plans, agents, models, moduleDefinitions, sequences, combinatorialDerivations, attachments);
  }
  ...
  /**
	 ...
	 */
  public Implementation createImplementation(String displayId) throws SBOLValidationException {
  ...
  public Implementation createImplementation(String URIprefix, String displayId, String version) throws SBOLValidationException {
    ...
    cd.setDisplayId(displayId);
    cd.setPersistentIdentity(createCompliantURI(URIprefix, TopLevel.IMPLEMENTATION, displayId, "", typesInURIs));
    cd.setVersion(version);
  ...
  public TopLevel createCopy(TopLevel topLevel, String URIprefix, String displayId, String version) throws SBOLValidationException {
    ...
    if (oldTopLevel != null) {
      if (oldTopLevel.equals(topLevel)) {
        ...
        if (oldTopLevel instanceof GenericTopLevel) {
          return oldTopLevel;
        } else {
        ...
        if (topLevel instanceof ExperimentalData) {
          ...
          if (topLevel instanceof ComponentDefinition) {
            ...
            if (topLevel instanceof CombinatorialDerivation) {
              CombinatorialDerivation newCombinatorialDerivation = this.createCombinatorialDerivation(URIprefix, displayId, version, ((CombinatorialDerivation) topLevel).getTemplateURI());
  ...
  public void createRecursiveCopy(SBOLDocument document, TopLevel topLevel) throws SBOLValidationException {
    ...
    if (topLevel instanceof GenericTopLevel || topLevel instanceof Sequence || topLevel instanceof Model || topLevel instanceof Plan || topLevel instanceof Agent || topLevel instanceof Implementation || topLevel instanceof Attachment || topLevel instanceof ExperimentalData) {
    } else {
      if (topLevel instanceof Collection) {
  ...
  private void fixDocumentURIPrefix() throws SBOLValidationException {
    ...
    for (TopLevel topLevel : getTopLevels()) {
      ...
      if (!topLevel.getIdentity().equals(URIcompliance.createCompliantURI(documentURIPrefix, URIcompliance.findDisplayId(topLevel), topLevel.getVersion()))) {
        ...
        while (getTopLevelLocalOnly(URIcompliance.createCompliantURI(documentURIPrefix, newDisplayId, newVersion)) != null) {
  ...
  private void changeURIPrefixVersion(List<Annotation> annotations, String URIPrefix, String version, String documentURIPrefix) throws SBOLValidationException {
    for (Annotation annotation : annotations) {
      if (annotation.isURIValue()) {
        ...
        if (annotation.isNestedAnnotations()) {
          ...
          if (nestedURI.toString().startsWith(URIPrefix)) {
            ...
            String displayId = nestedURI.toString().replace(documentURIPrefix, "").replace("http://", "").replace("https://", "");
  ...
  private void changeURIPrefixVersion(Identified identified, String URIPrefix, String version, String documentURIPrefix) throws SBOLValidationException {
    if (URIPrefix == null) {
  ...
  private TopLevel rename(TopLevel topLevel, String URIprefix, String displayId, String version, boolean updateRefs) throws SBOLValidationException {
    if ((URIprefix == null || URIprefix.equals(URIcompliance.extractURIprefix(topLevel.getIdentity()))) && (displayId == null || displayId.equals(topLevel.getDisplayId())) && (version == null || version.equals(topLevel.getVersion()))) {
      return topLevel;
    }
  ...
  void addSequence(Sequence sequence) throws SBOLValidationException {
    addTopLevel(sequence, sequences, "sequence", collections, componentDefinitions, experiments, experimentalData, genericTopLevels, activities, plans, agents, models, moduleDefinitions, combinatorialDerivations, implementations, attachments);
  }
  ...
  void addGenericTopLevel(GenericTopLevel genericTopLevel) throws SBOLValidationException {
    ...
    if (qNameInNamespace == null) {
      ...
      if (genericTopLevel.getRDFType().getPrefix() != qNameInNamespace.getPrefix()) {
    ...
    addTopLevel(genericTopLevel, genericTopLevels, "genericTopLevel", collections, componentDefinitions, experiments, experimentalData, models, activities, plans, agents, moduleDefinitions, sequences, combinatorialDerivations, implementations, attachments);
  }
  ...
  void addActivity(Activity activity) throws SBOLValidationException {
    addTopLevel(activity, activities, "activity", collections, componentDefinitions, experiments, experimentalData, models, genericTopLevels, plans, agents, moduleDefinitions, sequences, combinatorialDerivations, implementations, attachments);
    for (Usage usage : activity.getUsages()) {
  ...
  void addAgent(Agent agent) throws SBOLValidationException {
    addTopLevel(agent, agents, "agent", collections, componentDefinitions, experiments, experimentalData, models, genericTopLevels, plans, activities, moduleDefinitions, sequences, combinatorialDerivations, implementations, attachments);
  }
  ...
  void addPlan(Plan plan) throws SBOLValidationException {
    addTopLevel(plan, plans, "plan", collections, componentDefinitions, experiments, experimentalData, models, genericTopLevels, agents, activities, moduleDefinitions, sequences, combinatorialDerivations, implementations, attachments);
  }
  ...
  @Override public boolean equals(Object obj) {
    ...
    if (experiments == null) {
      ...
      if (!experiments.equals(other.experiments)) {
        return false;
      }
    }
    if (experimentalData == null) {
      ...
      if (!experimentalData.equals(other.experimentalData)) {
        return false;
      }
    }
    if (componentDefinitions == null) {
      ...
      if (!componentDefinitions.equals(other.componentDefinitions)) {
        return false;
      }
    }
    if (genericTopLevels == null) {
      ...
      if (!genericTopLevels.equals(other.genericTopLevels)) {
        return false;
      }
    }
    if (activities == null) {
    ...
    if (moduleDefinitions == null) {
      ...
      if (!moduleDefinitions.equals(other.moduleDefinitions)) {
        return false;
      }
    }
    if (nameSpaces == null) {
    ...
    if (combinatorialDerivations == null) {
      ...
      if (!combinatorialDerivations.equals(other.combinatorialDerivations)) {
        return false;
      }
    }
    if (attachments == null) {
    ...
    for (TL tl : instancesMap.values()) {
      if (topLevel.getPersistentIdentity().toString().equals(tl.getPersistentIdentity().toString())) {
        if (latestVersion == null) {
          ...
          if (isFirstVersionNewer(extractVersion(tl.getIdentity()), extractVersion(latestVersion))) {
            latestVersion = tl.getIdentity();
          }
        }
      }
  ...
  @Override public String toString() {
    return "SBOLDocument [activities=" + activities + ", agents=" + agents + ", plans=" + plans + ", implementations=" + implementations + ", attachments=" + attachments + ", combinatorialDerivations=" + combinatorialDerivations + ", genericTopLevels=" + genericTopLevels + ", collections=" + collections + ", experiments=" + experiments + ", experimentalData =" + experimentalData + ", componentDefinitions=" + componentDefinitions + ", models=" + models + ", moduleDefinitions=" + moduleDefinitions + ", sequences=" + sequences + ", nameSpaces=" + nameSpaces + ", defaultURIprefix=" + defaultURIprefix + ", complete=" + complete + ", compliant=" + compliant + ", typesInURIs=" + typesInURIs + ", createDefaults=" + createDefaults + "]";
  }
}