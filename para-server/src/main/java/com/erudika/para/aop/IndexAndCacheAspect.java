 ...
 */
@SuppressWarnings(value = { "unchecked" }) public class IndexAndCacheAspect implements MethodInterceptor {
  ...
  private Object invokeDAO(String appid, Method daoMethod, MethodInvocation mi) throws Throwable {
    try (MetricsUtils.Context context = MetricsUtils.time(appid, daoMethod.getDeclaringClass(), daoMethod.getName())) {
      return mi.proceed();
    }
  }
  ...
  private Object addToIndexOperation(String appid, Method daoMethod, Object[] args, MethodInvocation mi) throws Throwable {
    ...
    if (addMe != null && errors.length == 0) {
      ...
      if (addMe.getIndexed()) {
        try (MetricsUtils.Context context = MetricsUtils.time(appid, search.getClass(), "index")) {
          search.index(appid, addMe);
          logger.debug("{}: Indexed {}->{}", getClass().getSimpleName(), appid, addMe.getId());
        }
      }
    } else {
      logger.warn("{}: Invalid object {}->{} errors: [{}]. Changes weren\'t persisted.", getClass().getSimpleName(), appid, addMe, String.join("; ", errors));
    }
    return result;
  }
  ...
  private Object removeFromIndexOperation(String appid, Method daoMethod, Object[] args, MethodInvocation mi) throws Throwable {
    ...
    try (MetricsUtils.Context context = MetricsUtils.time(appid, search.getClass(), "unindex")) {
      search.unindex(appid, removeMe);
      logger.debug("{}: Unindexed {}->{}", getClass().getSimpleName(), appid, (removeMe == null) ? null : removeMe.getId());
    }
    return result;
  }
  ...
  private Object addToIndexBatchOperation(String appid, Method daoMethod, Object[] args, MethodInvocation mi) throws Throwable {
    ...
    Object result = invokeDAO(appid, daoMethod, mi);
    try (MetricsUtils.Context context = MetricsUtils.time(appid, search.getClass(), "indexAll")) {
  ...
  private Object removeFromIndexBatchOperation(String appid, Method daoMethod, Object[] args, MethodInvocation mi) throws Throwable {
    ...
    Object result = invokeDAO(appid, daoMethod, mi);
    try (MetricsUtils.Context context = MetricsUtils.time(appid, search.getClass(), "unindexAll")) {
      search.unindexAll(appid, removeUs);
    }
    logger.debug("{}: Unindexed all {}->{}", getClass().getSimpleName(), appid, (removeUs == null) ? null : removeUs.size());
    return result;
  }
  ...
  private Object readFromCacheOperation(String appid, Method daoMethod, Object[] args, MethodInvocation mi) throws Throwable {
    ...
    if (cache.contains(appid, getMeId)) {
      try (MetricsUtils.Context context = MetricsUtils.time(appid, cache.getClass(), "get")) {
      ...
      if (getMeId != null) {
        ...
        if (result != null && ((ParaObject) result).getCached()) {
          try (MetricsUtils.Context context = MetricsUtils.time(appid, cache.getClass(), "put")) {
  ...
  private void removeFromCacheOperation(String appid, Object[] args) {
    ...
    if (deleteMe != null) {
      try (MetricsUtils.Context context = MetricsUtils.time(appid, cache.getClass(), "remove")) {
  ...
  private Object readFromCacheBatchOperation(String appid, Method daoMethod, Object[] args, MethodInvocation mi) throws Throwable {
    ...
    if (getUs != null) {
      ...
      try (MetricsUtils.Context context = MetricsUtils.time(appid, cache.getClass(), "getAll")) {
  ...
  private void addToCacheBatchOperation(String appid, Object[] args) {
    ...
    if (putUs != null && !putUs.isEmpty()) {
      ...
      if (!map1.isEmpty()) {
        try (MetricsUtils.Context context = MetricsUtils.time(appid, cache.getClass(), "putAll")) {
  ...
  private void removeFromCacheBatchOperation(String appid, Object[] args) {
    ...
    if (deleteUs != null && !deleteUs.isEmpty()) {
      ...
      try (MetricsUtils.Context context = MetricsUtils.time(appid, cache.getClass(), "removeAll")) {
  ...
  private void detectNestedInvocations(Method daoMethod) {
    ...
    for (StackTraceElement stackTraceElement : stackTraceElements) {
      if (daoMethod.getDeclaringClass().getName().equals(stackTraceElement.getClassName()) && !daoMethod.getName().equals(stackTraceElement.getMethodName())) {
        String error = Utils.formatMessage("Method {0}.{1}() invoked from another method in the same " + "class - {2}.{3}(). DAO implementations should avoid this as it causes objects to be " + "indexed and cached twice per request.", daoMethod.getDeclaringClass().getSimpleName(), daoMethod.getName(), stackTraceElement.getClassName(), stackTraceElement.getMethodName());
