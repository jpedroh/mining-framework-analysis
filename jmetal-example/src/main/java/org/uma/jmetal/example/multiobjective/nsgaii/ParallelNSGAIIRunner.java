...
public class ParallelNSGAIIRunner extends AbstractAlgorithmRunner {
  ...
  public static void main(String[] args) throws JMetalException, FileNotFoundException {
    ...
    NSGAIIBuilder<DoubleSolution> builder = new NSGAIIBuilder<DoubleSolution>(problem, crossover, mutation, populationSize).setSelectionOperator(selection).setMaxEvaluations(25000).setSolutionListEvaluator(evaluator);
  ...
  public static class GNSGAIIMeasuresWithChartsRunner extends AbstractAlgorithmRunner {
    ...
    public static void main(String[] args) throws JMetalException, InterruptedException, IOException {
      ...
      algorithm = new NSGAIIBuilder<DoubleSolution>(problem, crossover, mutation, populationSize).setSelectionOperator(selection).setMaxEvaluations(maxEvaluations).setVariant(NSGAIIBuilder.NSGAIIVariant.Measures).setDominanceComparator(new GDominanceComparator<>(referencePoint)).build();
