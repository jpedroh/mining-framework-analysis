...
public class MOEADConstraintRunner extends AbstractAlgorithmRunner {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    algorithm = new MOEADBuilder(problem, Variant.ConstraintMOEAD).setCrossover(crossover).setMutation(mutation).setMaxEvaluations(150000).setPopulationSize(300).setResultPopulationSize(100).setNeighborhoodSelectionProbability(0.9).setMaximumNumberOfReplacedSolutions(2).setNeighborSize(20).setFunctionType(AbstractMOEAD.FunctionType.TCHE).setDataDirectory("resources/weightVectorFiles/moead/").build();
