  ...
  public static Input fromClassNamesAndJaxrsApplication(List<String> classNames, List<String> classNamePatterns, String jaxrsApplicationClassName, boolean automaticJaxrsApplication, Predicate<String> isClassNameExcluded, ClassLoader classLoader) {
    ...
    try {
      ...
      if (automaticJaxrsApplication) {
        types.addAll(JaxrsApplicationScanner.
<<<<<<< /usr/src/app/output/vojtechhabarta/typescript-generator/1c03813f0d5593fbea4d3572a6ef028da3f034bd/typescript-generator-core/src/main/java/cz/habarta/typescript/generator/Input.java/left.java
        scanJaxrsApplication(classpathScanner.scanClasspath(), isClassNameExcluded)
=======
        scanAutomaticJaxrsApplication(scanClasspath(), isClassNameExcluded)
>>>>>>> /usr/src/app/output/vojtechhabarta/typescript-generator/1c03813f0d5593fbea4d3572a6ef028da3f034bd/typescript-generator-core/src/main/java/cz/habarta/typescript/generator/Input.java/right.java
        );
      }
      if (types.isEmpty()) {
