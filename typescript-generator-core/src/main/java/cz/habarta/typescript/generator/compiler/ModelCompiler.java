...
<<<<<<< /usr/src/app/output/vojtechhabarta/typescript-generator/d44a704cd00045c731f3d66de3d6a2079567af88/typescript-generator-core/src/main/java/cz/habarta/typescript/generator/compiler/ModelCompiler.java/left.java
...
>>>>>>> /usr/src/app/output/vojtechhabarta/typescript-generator/d44a704cd00045c731f3d66de3d6a2079567af88/typescript-generator-core/src/main/java/cz/habarta/typescript/generator/compiler/ModelCompiler.java/right.java
  ...
  public TsType javaToTypeScript(Type type) {
    final BeanModel beanModel = new BeanModel(Object.class, Object.class, null, null, null, Collections.<Type>emptyList(), Collections.singletonList(new PropertyModel("property", type, false, null, null, null)), null);
  ...
  private <T extends java.lang.Object> TsBeanModel processBean(SymbolTable symbolTable, Model model, Map<Type, List<BeanModel>> children, BeanModel bean) {
    ...
    return new TsBeanModel(bean.getOrigin(), TsBeanCategory.Data, isClass, symbolTable.getSymbol(bean.getOrigin()), getTypeParameters(bean.getOrigin()), parentType, extendsList, implementsList, properties, null, null, bean.getComments()).withTaggedUnion(bean.getTaggedUnionClasses(), bean.getDiscriminantProperty(), bean.getDiscriminantLiteral());
  }
  ...
  private TsModel createJaxrsInterfaces(SymbolTable symbolTable, TsModel tsModel, JaxrsApplicationModel jaxrsApplication, Symbol responseSymbol, TsType.GenericVariableType optionsGenericVariable, TsType optionsType) {
  ...
  private TsModel createJaxrsClients(SymbolTable symbolTable, TsModel tsModel, JaxrsApplicationModel jaxrsApplication, Symbol responseSymbol, TsType.GenericVariableType optionsGenericVariable, TsType optionsType) {
  ...
  private TsModel transformDates(SymbolTable symbolTable, TsModel tsModel) {
    ...
    final TsModel model = transformBeanPropertyTypes(tsModel, new TsType.Transformer() {
      @Override public TsType transform(TsType.Context context, TsType type) {
        if (type == TsType.Date) {
  ...
  private TsModel inlineEnums(final TsModel tsModel, final SymbolTable symbolTable) {
    ...
    final TsModel newTsModel = transformBeanPropertyTypes(tsModel, new TsType.Transformer() {
      @Override public TsType transform(TsType.Context context, TsType tsType) {
