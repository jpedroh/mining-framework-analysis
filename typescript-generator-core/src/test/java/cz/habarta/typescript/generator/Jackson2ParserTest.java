...
public class Jackson2ParserTest {
  ...
  @Test public void testChangedNameProperty() {
    final Jackson2Parser jacksonParser = getJackson2Parser();
  ...
  @Test public void testConflictingJsonTypeInfoProperty() {
    final Jackson2Parser jacksonParser = getJackson2Parser();
  ...
  @Test public void testTaggedUnion() {
    final Jackson2Parser jacksonParser = getJackson2Parser();
  ...
  public static class DummyBeanJackson2 {
    @JsonProperty(value = "changedNameProperty") public String _changed_name_property;
  }

  @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type") public class InheritedClass {
    public String type;
  }

  @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind") @JsonSubTypes(value = { @JsonSubTypes.Type(value = SubTypeDiscriminatedByName1.class, name = "SubType1"), @JsonSubTypes.Type(value = SubTypeDiscriminatedByName2.class, name = "SubType2"), @JsonSubTypes.Type(value = SubTypeDiscriminatedByName3.class), @JsonSubTypes.Type(value = SubTypeDiscriminatedByName4.class) }) private static interface ParentWithNameDiscriminant {
  }

  @JsonTypeName(value = "explicit-name1") private static class SubTypeDiscriminatedByName1 implements ParentWithNameDiscriminant {
  }

  private static class SubTypeDiscriminatedByName2 implements ParentWithNameDiscriminant {
  }

  @JsonTypeName private static class SubTypeDiscriminatedByName3 implements ParentWithNameDiscriminant {
  }
  ...
  @Test public void testOptionalJsonProperty() {
  ...
  @Test public void testOptionalXmlElement() {
    final Settings settings = TestUtils.settings();
  ...
  public static class ClassWithOptionals {
    ...
    @JsonProperty public String jname1;

    @JsonProperty(required = false) public String jname2;

    @JsonProperty(required = true) public String jname3;

    private String jname4;

    @JsonProperty(required = true) public String getJname4() {
      return jname4;
    }

    @XmlElement public String xname1;

    @XmlElement(required = false) public String xname2;

    @XmlElement(required = true) public String xname3;

    private String xname4;

    @XmlElement(required = true) public String getXname4() {
      return xname4;
    }
  }
  ...
  @Test public void testNumberPropertyEnumValue() {
  ...
  @Test public void testJsonNumberMethodValuedEnum() {
  ...
  @Test public void testIgnoredProperty() {
    final Settings settings = TestUtils.settings();
  ...
  private static class ClassWithIgnoredProperty {
    ...
    @JsonIgnore public String name2;
  }

  @Test public void testVisibilityConfiguration() {
    {
      final Settings settings = TestUtils.settings();
