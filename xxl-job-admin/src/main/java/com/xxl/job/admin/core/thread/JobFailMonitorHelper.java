...
<<<<<<< /usr/src/app/output/xuxueli/xxl-job/c3c7ded5e057049c4b86f696ff4b0f842751827c/xxl-job-admin/src/main/java/com/xxl/job/admin/core/thread/JobFailMonitorHelper.java/left.java
                    if (IJobHandler.FAIL.getCode() == log.getTriggerCode() || IJobHandler.FAIL.getCode() == log.getHandleCode() || IJobHandler.TIMEOUT.getCode() == log.getHandleCode() || IJobHandler.FAIL_RETRY.getCode() == log.getHandleCode()) {
                      failAlarm(log);
