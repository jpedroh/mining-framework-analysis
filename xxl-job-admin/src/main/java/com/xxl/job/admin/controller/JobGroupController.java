 ...
 */
@Controller @RequestMapping(value = "/jobgroup") public class JobGroupController {
  ...
  @RequestMapping(value = "/pageList") @ResponseBody public Map<String, Object> pageList(HttpServletRequest request, @RequestParam(required = false, defaultValue = "0") int start, @RequestParam(required = false, defaultValue = "10") int length, String appname, String title) {
  ...
  @RequestMapping(value = "/save") @ResponseBody public ReturnT<String> save(XxlJobGroup xxlJobGroup) {
  ...
  @RequestMapping(value = "/update") @ResponseBody public ReturnT<String> update(XxlJobGroup xxlJobGroup) {
    if (xxlJobGroup.getAppname() == null || xxlJobGroup.getAppname().trim().length() == 0) {
      return new ReturnT<String>(500, (I18nUtil.getString("system_please_input") + "AppName"));
    }
    if (xxlJobGroup.getAppname().length() < 4 || xxlJobGroup.getAppname().length() > 64) {
  ...
  @RequestMapping(value = "/loadById") @ResponseBody public ReturnT<XxlJobGroup> loadById(int id) {
