 ...
 */
@Service public class XxlJobServiceImpl implements XxlJobService {
  ...
  @Override public Map<String, Object> pageList(int start, int length, int jobGroup, String jobDesc, String executorHandler, String filterTime) {
  ...
  @Override public ReturnT<String> add(XxlJobInfo jobInfo) {
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Override public ReturnT<String> update(XxlJobInfo jobInfo) {
    if (!CronExpression.isValidExpression(jobInfo.getJobCron())) {
      return new ReturnT<String>(ReturnT.FAIL_CODE, I18nUtil.getString("jobinfo_field_cron_unvalid"));
    }
    if (StringUtils.isBlank(jobInfo.getJobDesc())) {
    ...
    exists_jobInfo.setJobZone(jobInfo.getJobZone());
...
<<<<<<< /usr/src/app/output/xuxueli/xxl-job/7665057567d00c851ab5832f1d87794926114f0e/xxl-job-admin/src/main/java/com/xxl/job/admin/service/impl/XxlJobServiceImpl.java/left.java
      boolean ret = XxlJobDynamicScheduler.rescheduleJob(qz_group, qz_name, exists_jobInfo.getJobCron(), exists_jobInfo.getJobZone());
=======
...
>>>>>>> /usr/src/app/output/xuxueli/xxl-job/7665057567d00c851ab5832f1d87794926114f0e/xxl-job-admin/src/main/java/com/xxl/job/admin/service/impl/XxlJobServiceImpl.java/right.java
  ...
  @Override public ReturnT<String> remove(int id) {
  ...
  @Override public ReturnT<String> start(int id) {
    XxlJobInfo xxlJobInfo = xxlJobInfoDao.loadById(id);
    String group = String.valueOf(xxlJobInfo.getJobGroup());
    String name = String.valueOf(xxlJobInfo.getId());
  ...
  @Override public ReturnT<String> stop(int id) {
    XxlJobInfo xxlJobInfo = xxlJobInfoDao.loadById(id);
    String group = String.valueOf(xxlJobInfo.getJobGroup());
    String name = String.valueOf(xxlJobInfo.getId());
    try {
  ...
  @Override public ReturnT<Map<String, Object>> chartInfo(Date startDate, Date endDate) {
