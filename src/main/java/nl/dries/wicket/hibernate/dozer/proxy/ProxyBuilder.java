...
public class ProxyBuilder {
  ...
  public static Object buildProxy(AbstractPropertyDefinition property) {
    ...
    if (property instanceof SimplePropertyDefinition) {
      ...
      if (property instanceof CollectionPropertyDefinition) {
  ...
  private static class LoaderCallback implements MethodHandler, Serializable {
    ...
    /**
		 ...
		 */
    @Override public Object invoke(Object self, Method method, Method proceed, Object[] args) throws Throwable {
  ...
  private static class ProxiedHibernateInitializer implements Serializable, LazyInitializer {
    ...
    /**
		 ...
		 */
    @Override public void initialize() throws HibernateException {
    }

    /**
		 * @see org.hibernate.proxy.LazyInitializer#getIdentifier()
		 */
    @Override public Serializable getIdentifier() {
    ...
    /**
		 ...
		 */
    @Override public void setIdentifier(Serializable id) {
    }
    ...
    /**
		 ...
		 */
    @SuppressWarnings(value = { "rawtypes" }) @Override public Class getPersistentClass() {
    ...
    /**
		 ...
		 */
    @Override public boolean isUninitialized() {
      return true;
    }
    ...
    /**
		 ...
		 */
    @Override public Object getImplementation(SessionImplementor session) throws HibernateException {
    ...
    /**
		 ...
		 */
    @Override public void setImplementation(Object target) {
    }

    /**
		 * @see org.hibernate.proxy.LazyInitializer#isReadOnlySettingAvailable()
		 */
    @Override public boolean isReadOnlySettingAvailable() {
      return false;
    }
    ...
    /**
		 ...
		 */
    @Override public SessionImplementor getSession() {
      return (SessionImplementor) property.getModelCallback().getSessionFinder().getHibernateSession(getPersistentClass());
    }

    /**
		 * @see org.hibernate.proxy.LazyInitializer#setSession(org.hibernate.engine.spi.SessionImplementor)
		 */
    @Override public void setSession(SessionImplementor session) throws HibernateException {
    }

    /**
		 * @see org.hibernate.proxy.LazyInitializer#unsetSession()
		 */
    @Override public void unsetSession() {
    }

    /**
		 * @see org.hibernate.proxy.LazyInitializer#setUnwrap(boolean)
		 */
    @Override public void setUnwrap(boolean unwrap) {
    }

    /**
		 * @see org.hibernate.proxy.LazyInitializer#isUnwrap()
		 */
    @Override public boolean isUnwrap() {
      return false;
    }
  }
