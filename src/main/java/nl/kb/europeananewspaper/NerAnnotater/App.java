...
public class App {
  ...
  @SuppressWarnings(value = { "static-access" }) public static void main(final String[] args) throws ClassCastException, ClassNotFoundException, InterruptedException {
    ...
    options.addOption(OptionBuilder.withLongOpt("container").withDescription("which FORMAT are the container input files: mets (Default), didl").hasArg().withArgName("FORMAT").withType(String.class).create("c"));
