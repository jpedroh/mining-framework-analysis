 ...
 *
 */
@SuppressWarnings(value = { "serial" }) public abstract class AVector extends AbstractArray<Double> implements IVector, Comparable<AVector> {
  private static final long SPARSE_ELEMENT_THRESHOLD = 1000L;

  @Override public abstract int length();

  @Override public abstract double get(int i);

  @Override public abstract void set(int i, double value);
  ...
  @Override public final int dimensionality() {
    return 1;
  }
  ...
  @Override public AScalar slice(int position) {
    return VectorIndexScalar.wrap(this, position);
  }

  @Override public AScalar slice(int dimension, int index) {
    if (dimension != 0) {
  ...
  @Override public List<Double> getSlices() {
  ...
  @Override public AVector subArray(int[] offsets, int[] shape) {
    if (offsets.length != 1) {
  ...
  @Override public int compareTo(AVector a) {
    int len = length();
    if (len != a.length()) {
  ...
  @Override public boolean equals(AVector v) {
  ...
  @Override public boolean epsilonEquals(INDArray a, double tolerance) {
    if (a instanceof AVector) {
      return epsilonEquals((AVector) a);
    }
    if (a.dimensionality() != 1) {
      throw new IllegalArgumentException(ErrorMessages.incompatibleShapes(this, a));
    }
    ...
    for (int i = 0; i < len; i++) {
      if (!Tools.epsilonEquals(unsafeGet(i), a.get(i), tolerance)) {
        return false;
      }
    }
    return true;
  ...
  public boolean epsilonEquals(AVector v, double tolerance) {
    ...
    for (int i = 0; i < len; i++) {
      if (!Tools.epsilonEquals(unsafeGet(i), v.unsafeGet(i), tolerance)) {
        return false;
      }
    }
    return true;
  ...
  @Override public AVector squareCopy() {
    AVector r = clone();
    r.square();
    return r;
  }
  ...
  @Override public AVector getTranspose() {
    return this;
  }

  @Override public Vector getTransposeCopy() {
    return Vector.create(this);
  }

  @Override public final AVector getTransposeView() {
    return this;
  }
  ...
  public AVector innerProduct(AMatrix m) {
    ...
    int rc = m.rowCount();
    if (rc != length()) {
      throw new VectorzException("Incompatible sizes for inner product: [" + length() + "] x [" + rc + "," + cc + "]");
    }
  ...
  @Override public INDArray innerProduct(INDArray a) {
    if (a instanceof AVector) {
  ...
  @Override public AVector innerProduct(double a) {
  ...
  public double dotProduct(AVector v) {
    if (v instanceof ADenseArrayVector) {
      return dotProduct((ADenseArrayVector) v);
    }
    int len = length();
    if (v.length() != len) {
      throw new IllegalArgumentException(ErrorMessages.incompatibleShapes(this, v));
  ...
  @Override public AVector negateCopy() {
    AVector r = clone();
    r.negate();
    return r;
  }

  @Override public AVector scaleCopy(double d) {
    AVector r = clone();
    r.scale(d);
    return r;
  }
  ...
  @Override public void set(double a) {
    fill(a);
  }
  ...
  @Override public void setElements(double[] data) {
    setElements(data, 0, length());
  }

  @Override public void setElements(double[] data, int offset) {
  ...
  /**
	 ...
	 */
  @Override public AVector clone() {
    return Vector.create(this);
  }

  @Override public AVector copy() {
    if (!isMutable()) {
      return this;
    }
    return clone();
  ...
  @Override public final AVector asVector() {
    return this;
  }
  ...
  @Override public AVector reorder(int[] order) {
    return reorder(0, order);
  }

  @Override public AVector reorder(int dim, int[] order) {
    if (dim != 0) {
      throw new IndexOutOfBoundsException(ErrorMessages.invalidDimension(this, dim));
    }
  ...
  /**
	 ...
	 */
  @Override public boolean isFullyMutable() {
    return isMutable();
  }
  ...
  @Override public AVector addCopy(AVector a) {
    AVector r = this.clone();
    r.add(a);
    return r;
  }

  @Override public INDArray subCopy(INDArray a) {
    if (a instanceof AVector) {
  ...
  @Override public AVector subCopy(AVector a) {
    AVector r = this.clone();
    r.sub(a);
    return r;
  }

  @Override public INDArray multiplyCopy(INDArray a) {
    if (a instanceof AVector) {
  ...
  @Override public INDArray divideCopy(INDArray a) {
    if (a instanceof AVector) {
  ...
  @Override public AVector multiplyCopy(AVector a) {
    AVector r = this.clone();
    r.multiply(a);
    return r;
  }

  @Override public AVector divideCopy(AVector a) {
    AVector r = this.clone();
    r.divide(a);
    return r;
  }
  ...
  public void addMultiple(AVector src, double factor) {
    if (src.length() != length()) {
      throw new RuntimeException(ErrorMessages.incompatibleShapes(this, src));
    }
  ...
  public void addMultiple(int offset, AVector src, int srcOffset, int length, double factor) {
    ...
    if ((srcOffset < 0) || (srcOffset + length > src.length())) {
      throw new IndexOutOfBoundsException(ErrorMessages.invalidRange(src, srcOffset, length));
    }
    if (factor == 0.0) {
      return;
    }
  ...
  @Override public final boolean isSameShape(INDArray a) {
    if (a instanceof AVector) {
      return isSameShape((AVector) a);
    }
    if (a.dimensionality() != 1) {
      return false;
    }
  ...
  /**
	 ...
	 * @return
	 */
  @Override public AVector immutable() {
    if (!isMutable()) {
      return this;
    }
  ...
  /**
	 ...
	 * @return
	 */
  @Override public AVector mutable() {
  ...
  @Override public AVector sparse() {
  ...
  public void set(IVector vector) {
    ...
    if (len != vector.length()) {
      throw new IllegalArgumentException(ErrorMessages.mismatch(this, vector));
    }
    for (int i = 0; i < len; i++) {
  ...
  /**
	 ...
	 * @param offset
	 */
  @Override public void addToArray(double[] array, int offset) {
  ...
  @Override public void add(double constant) {
    int len = length();
    for (int i = 0; i < len; i++) {
      addAt(i, constant);
    }
  ...
  /**
	 ...
	 * @return
	 */
  @Override public boolean equalsArray(double[] data) {
  ...
  @Override public INDArray broadcast(int... targetShape) {
