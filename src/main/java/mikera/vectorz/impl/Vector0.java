...
public final class Vector0 extends APrimitiveVector implements IDense, ISparse {
  ...
  @Override public AVector join(AVector v) {
    return v;
  }

  @Override public Vector0 immutable() {
    return this;
  }
  ...
  @Override public Vector0 subVector(int start, int length) {
    if ((start == 0) && (length == 0)) {
      return this;
    }
  ...
  @Override public Vector0 exactClone() {
    return this;
  }
