 ...
 *
 */
@SuppressWarnings(value = { "serial" }) public abstract class ASparseVector extends ASizedVector implements ISparse {
  ...
  @Override public abstract Index nonSparseIndex();
  ...
  @Override public void copyTo(int offset, double[] destData, int destOffset, int length) {
  ...
  @Override public final double dotProduct(ADenseArrayVector v) {
    checkSameLength(v);
  ...
  @Override public final boolean isSparse() {
    return true;
  }
  ...
  @Override public void addMultiple(AVector src, double factor) {
  ...
  @Override public double elementProduct() {
  ...
  @Override public ASparseVector sparse() {
    return this;
  }

  @Override public AVector clone() {
    if ((length < 20) || (nonSparseElementCount() > (elementCount() * 0.25))) {
      return super.clone();
    }
  ...
  public boolean equals(ASparseVector v) {
    ...
    for (int i = 0; i < ni.length(); i++) {
      int ii = ni.get(i);
      if (unsafeGet(ii) != v.unsafeGet(ii)) {
        return false;
      }
    }
  ...
  /**
     ...
     * @return
     */
  @Override public double elementPowSum(double p) {
  ...
  /**
     ...
     * @return
     */
  @Override public double elementAbsPowSum(double p) {
