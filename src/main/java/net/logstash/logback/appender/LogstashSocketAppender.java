...
public class LogstashSocketAppender extends SyslogAppenderBase<ILoggingEvent> {
  ...
  @Override public Layout<ILoggingEvent> buildLayout() {
  ...
  @Override public int getSeverityForEvent(Object eventObject) {
    return 0;
  }
  ...
  @Override public SyslogOutputStream createOutputStream() throws UnknownHostException, SocketException {
