...
public class LogstashFormatter extends LoggingEventCompositeJsonFormatter {
  ...
  /**
     ...
     */
  @Deprecated private final JsonMessageJsonProvider jsonMessageProvider = new JsonMessageJsonProvider();
  ...
  /**
     ...
     */
  @Deprecated private ContextMapJsonProvider contextMapProvider;
  ...
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) protected void configureProviderFieldNames() {
  ...
  /**
     ...
     */
  @Deprecated public void setIncludeCallerInfo(boolean includeCallerInfo) {
    setIncludeCallerData(includeCallerInfo);
  }

  public String getCustomFieldsAsString() {
    return globalCustomFieldsProvider == null ? null : globalCustomFieldsProvider.getCustomFields();
  }
  ...
  public JsonNode getCustomFields() {
    return globalCustomFieldsProvider == null ? null : globalCustomFieldsProvider.getCustomFieldsNode();
  }
  ...
  public List<String> getIncludeMdcKeyNames() {
    return isIncludeMdc() ? mdcProvider.getIncludeMdcKeyNames() : Collections.<String>emptyList();
  }
  ...
  public List<String> getExcludeMdcKeyNames() {
    return isIncludeMdc() ? mdcProvider.getExcludeMdcKeyNames() : Collections.<String>emptyList();
  }
  ...
  @Override public LoggingEventJsonProviders getProviders() {
  ...
  @Override public void setProviders(JsonProviders<ILoggingEvent> jsonProviders) {
