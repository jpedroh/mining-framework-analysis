...
public class LogstashFormatter extends LogstashAbstractFormatter<ILoggingEvent, LogstashFieldNames> {
  /**
     ...
     */
  @Deprecated private static final String JSON_MARKER_NAME = "JSON";
  ...
  /**
     ...
     */
  @Deprecated private boolean enableContextMap;
  ...
  @Override protected void writeValueToGenerator(JsonGenerator generator, ILoggingEvent event, Context context) throws IOException {
  ...
  /**
     ...
     *             with fieldName = "json_message" and objects = an array of arguments instead.
     */
  @Deprecated private void writeJsonMessageFieldIfNecessary(JsonGenerator generator, ILoggingEvent event) throws IOException {
  ...
  /**
     ...
     * @deprecated When logging, prefer using a {@link Markers#appendEntries(Map)} marker instead.
     */
  @Deprecated private void writeContextMapFieldsIfNecessary(JsonGenerator generator, ILoggingEvent event) throws IOException {
    if (enableContextMap) {
