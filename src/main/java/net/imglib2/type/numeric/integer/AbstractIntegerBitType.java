...
public abstract class AbstractIntegerBitType<T extends AbstractIntegerBitType<T>> extends AbstractBitType<T> implements IntegerType<T> {
  public AbstractIntegerBitType(final NativeImg<?, ? extends LongAccess> bitStorage, final int nBits) {
  ...
  @Override public void sub(final T t) {
    set(get() - t.get());
  }

  @Override public void mul(final T t) {
    set(get() * t.get());
  }

  @Override public void div(final T t) {
    set(get() / t.get());
  }

  @Override public void pow(final T t) {
