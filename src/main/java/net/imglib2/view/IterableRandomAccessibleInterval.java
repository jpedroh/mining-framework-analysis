 ...
 */
public class IterableRandomAccessibleInterval<T extends java.lang.Object> extends AbstractWrappedInterval<RandomAccessibleInterval<T>> implements IterableInterval<T>, RandomAccessibleInterval<T> {
  final long size;

  public static <T extends java.lang.Object> IterableRandomAccessibleInterval<T> create(final RandomAccessibleInterval<T> interval) {
  ...
  @Override public RandomAccess<T> randomAccess(final Interval i) {
