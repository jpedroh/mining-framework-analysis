...
public class Views {
  /**
	 ...
	 * @return
	 */
  public static <T extends java.lang.Object, F extends EuclideanSpace> RealRandomAccessible<T> interpolate(final F source, final InterpolatorFactory<T, F> factory) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> RandomAccessibleOnRealRandomAccessible<T> raster(final RealRandomAccessible<T> source) {
  ...
  /**
	 ...
	 *         infinity.
	 */
  public static <T extends java.lang.Object, F extends RandomAccessibleInterval<T>> ExtendedRandomAccessibleInterval<T, F> extend(final F source, final OutOfBoundsFactory<T, ? super F> factory) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object, F extends RandomAccessibleInterval<T>> ExtendedRandomAccessibleInterval<T, F> extendMirrorSingle(final F source) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object, F extends RandomAccessibleInterval<T>> ExtendedRandomAccessibleInterval<T, F> extendMirrorDouble(final F source) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object, F extends RandomAccessibleInterval<T>> ExtendedRandomAccessibleInterval<T, F> extendPeriodic(final F source) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object, F extends RandomAccessibleInterval<T>> ExtendedRandomAccessibleInterval<T, F> extendBorder(final F source) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> IntervalView<T> interval(final RandomAccessible<T> randomAccessible, final long[] min, final long[] max) {
  ...
  /**
	 ...
	 * @return a RandomAccessibleInterval
	 */
  public static <T extends java.lang.Object> IntervalView<T> interval(final RandomAccessible<T> randomAccessible, final Interval interval) {
  ...
  /**
	 ...
	 * the XY plane.
	 */
  public static <T extends java.lang.Object> MixedTransformView<T> rotate(final RandomAccessible<T> randomAccessible, final int fromAxis, final int toAxis) {
  ...
  /**
	 ...
	 * the XY plane.
	 */
  public static <T extends java.lang.Object> IntervalView<T> rotate(final RandomAccessibleInterval<T> interval, final int fromAxis, final int toAxis) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> MixedTransformView<T> permute(final RandomAccessible<T> randomAccessible, final int fromAxis, final int toAxis) {
    final int n = randomAccessible.numDimensions();
    final int[] component = new int[n];
    for (int e = 0; e < n; ++e) {
      component[e] = e;
  ...
  /**
	 ...
	 * source, a ZYX view would be created.
	 */
  public static <T extends java.lang.Object> IntervalView<T> permute(final RandomAccessibleInterval<T> interval, final int fromAxis, final int toAxis) {
    final int n = interval.numDimensions();
    final long[] min = new long[n];
    final long[] max = new long[n];
    interval.min(min);
  ...
  /**
	 ...
	 *            resulting view.
	 */
  public static <T extends java.lang.Object> MixedTransformView<T> translate(final RandomAccessible<T> randomAccessible, final long... translation) {
    final int n = randomAccessible.numDimensions();
    final MixedTransform t = new MixedTransform(n, n);
  ...
  /**
	 ...
	 *            resulting view.
	 */
  public static <T extends java.lang.Object> IntervalView<T> translate(final RandomAccessibleInterval<T> interval, final long... translation) {
    final int n = interval.numDimensions();
    final long[] min = new long[n];
    final long[] max = new long[n];
    interval.min(min);
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> MixedTransformView<T> offset(final RandomAccessible<T> randomAccessible, final long... offset) {
    final int n = randomAccessible.numDimensions();
    final MixedTransform t = new MixedTransform(n, n);
  ...
  /**
	 ...
	 *            origin of resulting view.
	 */
  public static <T extends java.lang.Object> IntervalView<T> offset(final RandomAccessibleInterval<T> interval, final long... offset) {
    final int n = interval.numDimensions();
    final long[] min = new long[n];
    final long[] max = new long[n];
    interval.min(min);
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> IntervalView<T> zeroMin(final RandomAccessibleInterval<T> interval) {
    final int n = interval.numDimensions();
    final long[] min = new long[n];
    final long[] max = new long[n];
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> MixedTransformView<T> hyperSlice(final RandomAccessible<T> view, final int d, final long pos) {
  ...
  /**
	 ...
	 * d-component of coordinates to pos.
	 */
  public static <T extends java.lang.Object> IntervalView<T> hyperSlice(final RandomAccessibleInterval<T> view, final int d, final long pos) {
    final int m = view.numDimensions();
    final int n = m - 1;
    final long[] min = new long[n];
    final long[] max = new long[n];
  ...
  /**
	 ...
	 *            the source
	 */
  public static <T extends java.lang.Object> MixedTransformView<T> addDimension(final RandomAccessible<T> randomAccessible) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> IntervalView<T> addDimension(final RandomAccessibleInterval<T> interval, final long minOfNewDim, final long maxOfNewDim) {
  ...
  /**
	 ...
	 *            the axis to invert
	 */
  public static <T extends java.lang.Object> MixedTransformView<T> invertAxis(final RandomAccessible<T> randomAccessible, final int d) {
    final int n = randomAccessible.numDimensions();
    final boolean[] inv = new boolean[n];
    inv[d] = true;
    final MixedTransform t = new MixedTransform(n, n);
  ...
  /**
	 ...
	 *            the axis to invert
	 */
  public static <T extends java.lang.Object> IntervalView<T> invertAxis(final RandomAccessibleInterval<T> interval, final int d) {
    final int n = interval.numDimensions();
    final long[] min = new long[n];
    final long[] max = new long[n];
    interval.min(min);
  ...
  /**
	 ...
	 * @return a RandomAccessibleInterval
	 */
  public static <T extends java.lang.Object> IntervalView<T> offsetInterval(final RandomAccessible<T> randomAccessible, final long[] offset, final long[] dimension) {
    final int n = randomAccessible.numDimensions();
    final long[] min = new long[n];
    final long[] max = new long[n];
    for (int d = 0; d < n; ++d) {
  ...
  /**
	 ...
	 * @return a RandomAccessibleInterval
	 */
  public static <T extends java.lang.Object> IntervalView<T> offsetInterval(final RandomAccessible<T> randomAccessible, final Interval interval) {
    final int n = randomAccessible.numDimensions();
    final long[] offset = new long[n];
    final long[] min = new long[n];
    final long[] max = new long[n];
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> IterableInterval<T> iterable(final RandomAccessibleInterval<T> randomAccessibleInterval) {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> IterableInterval<T> flatIterable(final RandomAccessibleInterval<T> randomAccessibleInterval) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> CompositeIntervalView<T, ? extends GenericComposite<T>> collapse(final RandomAccessibleInterval<T> source) {
  ...
  /**
	 ...
	 *         {@link GenericComposite GenericComposites}
	 */
  public static <T extends java.lang.Object> CompositeView<T, ? extends GenericComposite<T>> collapse(final RandomAccessible<T> source) {
  ...
  /**
	 ...
	 *         coordinates at zero
	 */
  public static <T extends java.lang.Object> SubsampleIntervalView<T> subsample(final RandomAccessibleInterval<T> source, final long step) {
  ...
  /**
	 ...
	 *         coordinates at zero
	 */
  public static <T extends java.lang.Object> SubsampleView<T> subsample(final RandomAccessibleInterval<T> source, final long... steps) {
  ...
  /**
	 ...
	 *
	 */
  public static <T extends java.lang.Object> SubsampleView<T> subsample(final RandomAccessible<T> source, final long step) {
  ...
  /**
	 ...
	 *
	 */
  public static <T extends java.lang.Object> SubsampleView<T> subsample(final RandomAccessible<T> source, final long... steps) {
    assert steps.length >= source.numDimensions() : "Dimensions do not match.";
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> RandomAccessibleInterval<T> dropSingletonDimensions(final RandomAccessibleInterval<T> source) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> RandomAccessibleInterval<T> stack(final List<RandomAccessibleInterval<T>> hyperslices) {
  ...
  /**
	 ...
	 *         where the final dimension is the index of the hyperslice.
	 */
  public static <T extends java.lang.Object> RandomAccessibleInterval<T> stack(final RandomAccessibleInterval<T>... hyperslices) {
  ...
  /**
	 ...
	 *         where the final dimension is the index of the hyperslice.
	 */
  public static <T extends java.lang.Object> RandomAccessibleInterval<T> stack(final StackAccessMode stackAccessMode, final List<RandomAccessibleInterval<T>> hyperslices) {
  ...
  /**
	 ...
	 *         where the final dimension is the index of the hyperslice.
	 */
  public static <T extends java.lang.Object> RandomAccessibleInterval<T> stack(final StackAccessMode stackAccessMode, final RandomAccessibleInterval<T>... hyperslices) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> TransformView<T> shear(final RandomAccessible<T> source, final int shearDimension, final int referenceDimension) {
  ...
  /**
	 ...
	 * @return {@link TransformView} containing the result.
	 */
  public static <T extends java.lang.Object> TransformView<T> unshear(final RandomAccessible<T> source, final int shearDimension, final int referenceDimension) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> IntervalView<T> shear(final RandomAccessible<T> source, final Interval interval, final int shearDimension, final int referenceDimension) {
    final ShearTransform transform = new ShearTransform(source.numDimensions(), shearDimension, referenceDimension);
  ...
  /**
	 ...
	 *         {@link ShearTransform#transform} method on the input interval.
	 */
  public static <T extends java.lang.Object> IntervalView<T> unshear(final RandomAccessible<T> source, final Interval interval, final int shearDimension, final int referenceDimension) {
    final InverseShearTransform transform = new InverseShearTransform(source.numDimensions(), shearDimension, referenceDimension);
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> IntervalView<T> permuteCoordinates(final RandomAccessibleInterval<T> source, final int[] permutation) {
  ...
  /**
	 ...
	 * @return {@link IntervalView} of permuted source.
	 */
  public static <T extends java.lang.Object> IntervalView<T> permuteCoordinates(final RandomAccessibleInterval<T> source, final int[] permutation, final int d) {
    assert AbstractPermutationTransform.checkBijectivity(permutation) : "Non-bijective LUT passed for coordinate permuation.";
  ...
  /**
	 ...
	 * @return {@link IntervalView} of permuted source.
	 */
  public static <T extends java.lang.Object> IntervalView<T> permuteCoordinatesInverse(final RandomAccessibleInterval<T> source, final int[] permutation) {
    assert AbstractPermutationTransform.checkBijectivity(permutation) : "Non-bijective LUT passed for coordinate permuation.";
    assert PermutationTransform.checkInterval(source, permutation) : "Source interval boundaries do not match permutation.";
    final int nDim = source.numDimensions();
  ...
  /**
	 ...
	 * @return {@link IntervalView} of permuted source.
	 */
  public static <T extends java.lang.Object> IntervalView<T> permuteCoordinateInverse(final RandomAccessibleInterval<T> source, final int[] permutation, final int d) {
    assert AbstractPermutationTransform.checkBijectivity(permutation) : "Non-bijective LUT passed for coordinate permuation.";
    assert source.min(d) == 0 : "Source with min[d] coordinate != 0 passed to coordinate permutation.";
    assert source.dimension(d) == permutation.length : "Source with dimension[d] != LUT.length passed to coordinate permutation.";
    final int nDim = source.numDimensions();
  ...
  /**
	 ...
	 * @return
	 */
  public static <A extends java.lang.Object, B extends java.lang.Object> RandomAccessible<Pair<A, B>> pair(final RandomAccessible<A> sourceA, final RandomAccessible<B> sourceB) {
