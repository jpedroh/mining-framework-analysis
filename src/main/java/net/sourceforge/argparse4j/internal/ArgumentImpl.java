...
public final class ArgumentImpl implements Argument {
  ...
  public ArgumentImpl(ArgumentParserConfigurationImpl config, String... nameOrFlags) {
    this(config, null, nameOrFlags);
  }

  public ArgumentImpl(ArgumentParserConfigurationImpl config, ArgumentGroupImpl argumentGroup, String... nameOrFlags) {
    ...
    if (nameOrFlags.length == 1 && !config.prefixPattern_.match(nameOrFlags[0])) {
      ...
      for (String flag : flags_) {
        if (!config.prefixPattern_.match(flag)) {
          throw new IllegalArgumentException(String.format(TextHelper.LOCALE_ROOT, localize("invalidOptionStringError"), flag, config.prefixPattern_.getPrefixChars()));
        }
      }
      for (String flag : flags_) {
  ...
  @Override public String textualName() {
    if (name_ == null) {
  ...
  public Object convert(ArgumentParserImpl parser, String value) throws ArgumentParserException {
    ...
    if (choice_ != null && !choice_.contains(obj)) {
      throw new ArgumentParserException(String.format(TextHelper.LOCALE_ROOT, localize("invalidChoiceError"), value, choice_.textualFormat()), parser, this);
    }
    return obj;
  }

  @Override public ArgumentImpl nargs(int n) {
    if (n <= 0) {
  ...
  @Override public ArgumentImpl nargs(String n) {
    if (n.equals("*")) {
      minNumArg_ = 0;
  ...
  @Override public ArgumentImpl setConst(Object value) {
    const_ = value;
    return this;
  }

  @Override public <E extends java.lang.Object> ArgumentImpl setConst(E... values) {
    const_ = Arrays.asList(values);
    return this;
  }

  @Override public ArgumentImpl setDefault(Object value) {
    default_ = value;
    return this;
  }

  @Override public <E extends java.lang.Object> ArgumentImpl setDefault(E... values) {
    default_ = Arrays.asList(values);
    return this;
  }

  @Override public ArgumentImpl setDefault(FeatureControl ctrl) {
    defaultControl_ = ctrl;
    return this;
  }

  private <T extends java.lang.Object> ReflectArgumentType<T> createReflectArgumentType(Class<T> type) {
    return new ReflectArgumentType<T>(type);
  }

  @Override public <T extends java.lang.Object> ArgumentImpl type(Class<T> type) {
    if (type == null) {
  ...
  @Override public <T extends java.lang.Object> ArgumentImpl type(ArgumentType<T> type) {
    if (type == null) {
      throw new IllegalArgumentException("type cannot be null");
    }
    type_ = type;
  ...
  @Override public ArgumentImpl required(boolean required) {
    required_ = required;
    return this;
  }

  @Override public ArgumentImpl action(ArgumentAction action) {
    if (action == null) {
  ...
  @Override public ArgumentImpl choices(ArgumentChoice choice) {
    if (choice == null) {
  ...
  @Override public <E extends java.lang.Object> ArgumentImpl choices(Collection<E> values) {
    if (values == null) {
      throw new IllegalArgumentException("choice cannot be null");
    }
  ...
  @Override public <E extends java.lang.Object> ArgumentImpl choices(E... values) {
    if (values == null) {
      throw new IllegalArgumentException("choice cannot be null");
    }
    choice_ = new CollectionArgumentChoice<E>(values);
  ...
  @Override public ArgumentImpl dest(String dest) {
    if (dest == null) {
  ...
  @Override public ArgumentImpl metavar(String... metavar) {
    if (metavar.length == 0) {
  ...
  @Override public ArgumentImpl help(String help) {
    help_ = TextHelper.nonNull(help);
    return this;
  }

  @Override public ArgumentImpl help(FeatureControl ctrl) {
    helpControl_ = ctrl;
    return this;
  }
  ...
  @Override public String getDest() {
    return dest_;
  }

  @Override public Object getConst() {
    return const_;
  }
  ...
  @Override public FeatureControl getDefaultControl() {
    return defaultControl_;
  }

  @Override public FeatureControl getHelpControl() {
    return helpControl_;
  }
