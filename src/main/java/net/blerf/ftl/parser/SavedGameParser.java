...
public class SavedGameParser extends DatParser {
  ...
  public SavedGameState readSavedGame(File datFile) throws IOException {
    ...
    try {
      ...
      String playerShipName = readString(in);
      String playerShipBlueprintId = readString(in);
...
<<<<<<< /usr/src/app/output/comatoes/ftl-profile-editor/e87fe65818e726d317ec93c036d48205ed914f09/src/main/java/net/blerf/ftl/parser/SavedGameParser.java/left.java
      ShipState playerShipState = readShip(in, true);
=======
      List<Integer> mil = new ArrayList<>();
>>>>>>> /usr/src/app/output/comatoes/ftl-profile-editor/e87fe65818e726d317ec93c036d48205ed914f09/src/main/java/net/blerf/ftl/parser/SavedGameParser.java/right.java
      ...
      gameState.
<<<<<<< /usr/src/app/output/comatoes/ftl-profile-editor/e87fe65818e726d317ec93c036d48205ed914f09/src/main/java/net/blerf/ftl/parser/SavedGameParser.java/left.java
      setPlayerShipState(playerShipState)
=======
      addMysteryBytes(new MysteryBytes(in, 8))
>>>>>>> /usr/src/app/output/comatoes/ftl-profile-editor/e87fe65818e726d317ec93c036d48205ed914f09/src/main/java/net/blerf/ftl/parser/SavedGameParser.java/right.java
      ;
  ...
  private ShipState readShip(InputStream in, boolean playerControlled) throws IOException {
    ...
    String[] systemNames = new String[] { "Shields", "Engines", "Oxygen", "Weapons", "Drone Ctrl", "Medbay", "Pilot", "Sensors", "Doors", "Teleporter", "Cloaking", "Artillery" };
  ...
  private CrewState readCrewMember(InputStream in) throws IOException {
    ...
    crew.setAlpha(readInt(in));
    crew.setHealth(readInt(in));
    crew.setBeta(readInt(in));
    crew.setGamma(readInt(in));
    crew.setRoomId(readInt(in));
    crew.setRoomSquare(readInt(in));
    crew.setEpsilon(readInt(in));
    ...
    crew.setZeta(readInt(in));
    crew.setEta(readInt(in));
...
<<<<<<< /usr/src/app/output/comatoes/ftl-profile-editor/e87fe65818e726d317ec93c036d48205ed914f09/src/main/java/net/blerf/ftl/parser/SavedGameParser.java/left.java
      "\nPlayer Ship...\n"
=======
      String.format("Rebel Fleet Offset: %d\n", rebelFleetOffset)
>>>>>>> /usr/src/app/output/comatoes/ftl-profile-editor/e87fe65818e726d317ec93c036d48205ed914f09/src/main/java/net/blerf/ftl/parser/SavedGameParser.java/right.java
      );
      result.append(
<<<<<<< /usr/src/app/output/comatoes/ftl-profile-editor/e87fe65818e726d317ec93c036d48205ed914f09/src/main/java/net/blerf/ftl/parser/SavedGameParser.java/left.java
      playerShipState.toString().replaceAll("(^|\n)(.+)", "$1  $2")
=======
      String.format("Mystery Int List: %s\n", mysteryIntList)
>>>>>>> /usr/src/app/output/comatoes/ftl-profile-editor/e87fe65818e726d317ec93c036d48205ed914f09/src/main/java/net/blerf/ftl/parser/SavedGameParser.java/right.java
      );
      result.append("\n");
      result.append("\nSector Beacons...\n");
...
>>>>>>> /usr/src/app/output/comatoes/ftl-profile-editor/e87fe65818e726d317ec93c036d48205ed914f09/src/main/java/net/blerf/ftl/parser/SavedGameParser.java/right.java
  ...
  public class CrewState {
    ...
    public void setPilotSkill(int n) {
      pilotSkill = n;
    }

    public void setEngineSkill(int n) {
      engineSkill = n;
    }

    public void setShieldSkill(int n) {
      shieldSkill = n;
    }

    public void setWeaponSkill(int n) {
      weaponSkill = n;
    }

    public void setRepairSkill(int n) {
      repairSkill = n;
    }

    public void setCombatSkill(int n) {
      combatSkill = n;
    }

    public void setJumpsSurvived(int n) {
      jumpsSurvived = n;
    }
    ...
    public void setEpsilon(int n) {
      unknownEpsilon = n;
    }

    public void setDigamma(int n) {
      unknownDigamma = n;
    }

    public void setZeta(int n) {
      unknownZeta = n;
    }
    ...
    public void setTheta(int n) {
      unknownTheta = n;
    }

    public void setIota(int n) {
      unknownIota = n;
    }
  ...
  public class SystemState {
    ...
    public void setBurnProgress(int n) {
      burnProgress = n;
    }
  ...
  public class BeaconState {
    ...
    private int unknownVisitedAlpha;
    ...
    private String shipBlueprintListId;

    private int unknownEnemyPresentAlpha;

    private FleetPresence fleetPresence;

    private boolean underAttack;

    private boolean storePresent;
