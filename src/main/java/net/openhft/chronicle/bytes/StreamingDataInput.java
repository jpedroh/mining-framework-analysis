 ...
 */
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public interface StreamingDataInput<S extends StreamingDataInput<S>> extends StreamingCommon<S> {
  ...
  /**
     ...
     */
  default void readWithLength0(long length, @NotNull ThrowingConsumerNonCapturing<S, IORuntimeException, BytesOut> bytesConsumer, StringBuilder sb, BytesOut toBytes) throws BufferUnderflowException, IORuntimeException, IllegalStateException {
  ...
  /**
     * Perform a set of actions with a temporary bounds mode.
     */
  default void readWithLength(long length, @NotNull ThrowingConsumer<S, IORuntimeException> bytesConsumer) throws BufferUnderflowException, IORuntimeException, IllegalStateException {
    requireNonNull(bytesConsumer);
    if (length > readRemaining()) {
      throw new BufferUnderflowException();
    }
  ...
  /**
     ...
     */
  @Nullable default String readUtf8() throws BufferUnderflowException, IORuntimeException, IllegalStateException, ArithmeticException {
    return BytesInternal.readUtf8(this);
  }

  @Nullable default String read8bit() throws IORuntimeException, BufferUnderflowException, IllegalStateException, ArithmeticException {
  ...
  /**
     ...
     */
  default <C extends Appendable & CharSequence> boolean readUtf8(@NotNull C sb) throws IORuntimeException, BufferUnderflowException, ArithmeticException, IllegalStateException, IllegalArgumentException {
    try {
  ...
  default boolean readUtf8(@NotNull Bytes sb) throws IORuntimeException, BufferUnderflowException, ArithmeticException, IllegalStateException {
  ...
  default boolean read8bit(@NotNull Bytes b) throws BufferUnderflowException, IllegalStateException, ArithmeticException, BufferOverflowException {
    b.clear();
    if (readRemaining() <= 0) {
      return true;
    }
  ...
  @Deprecated default <C extends Appendable & CharSequence> boolean read8bit(@NotNull C sb) throws IORuntimeException, BufferUnderflowException, ArithmeticException, IllegalArgumentException, IllegalStateException {
    AppendableUtil.setLength(sb, 0);
    if (readRemaining() <= 0) {
      return true;
    }
  ...
  default int read(@NotNull byte[] bytes) throws BufferUnderflowException, IllegalStateException {
    return read(bytes, 0, bytes.length);
  }

  default int read(@NotNull byte[] bytes, int off, int len) throws BufferUnderflowException, IllegalStateException {
  ...
  default int read(@NotNull char[] bytes, int off, int len) throws IllegalStateException {
    requireNonNull(bytes);
    long remaining = readRemaining();
    if (remaining <= 0) {
      return -1;
  ...
  default void read(@NotNull ByteBuffer buffer) throws IllegalStateException {
  ...
  default void read(@NotNull Bytes bytes, int length) throws BufferUnderflowException, BufferOverflowException, IllegalStateException {
    requireNonNull(bytes);
  ...
  default void unsafeReadObject(@NotNull Object o, int length) throws BufferUnderflowException, IllegalStateException {
    unsafeReadObject(o, (o.getClass().isArray() ? 4 : 0) + Jvm.objectHeaderSize(), length);
  }

  default void unsafeReadObject(@NotNull Object o, int offset, int length) throws BufferUnderflowException, IllegalStateException {
    requireNonNull(o);
  ...
  @NotNull default <E extends Enum<E>> E readEnum(@NotNull Class<E> eClass) throws IORuntimeException, BufferUnderflowException, ArithmeticException, IllegalStateException, BufferOverflowException {
  ...
  /**
     ...
     */
  default void parseUtf8(@NotNull Appendable sb, int encodedLength) throws IllegalArgumentException, BufferUnderflowException, UTFDataFormatRuntimeException, IllegalStateException {
  ...
  /**
     ...
     */
  default void parseUtf8(@NotNull Appendable sb, boolean utf, int length) throws IllegalArgumentException, BufferUnderflowException, UTFDataFormatRuntimeException, IllegalStateException {
    AppendableUtil.setLength(sb, 0);
  ...
  void copyTo(@NotNull OutputStream out) throws IOException, IllegalStateException;

  long copyTo(@NotNull BytesStore to) throws IllegalStateException;
  ...
  default void readWithLength(@NotNull Bytes bytes) throws ArithmeticException, BufferUnderflowException, BufferOverflowException, IllegalStateException {
    bytes.clear();
