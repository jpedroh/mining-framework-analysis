 ...
 */
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public class SingleMappedBytes extends CommonMappedBytes {
  public SingleMappedBytes(@NotNull final MappedFile mappedFile) throws IllegalStateException {
    this(mappedFile, "");
  }

  protected SingleMappedBytes(@NotNull final MappedFile mappedFile, final String name) throws IllegalStateException {
  ...
  @Override public @NotNull SingleMappedBytes write(final long offsetInRDO, @NotNull final byte[] bytes, int offset, final int length) throws IllegalStateException, BufferOverflowException {
  ...
  @Override public @NotNull SingleMappedBytes write(final long writeOffset, @NotNull final RandomDataInput bytes, long readOffset, final long length) throws BufferOverflowException, BufferUnderflowException, IllegalStateException {
    requireNonNull(bytes);
    throwExceptionIfClosed();
    long wp = writeOffset;
    if (length > writeRemaining()) {
  ...
  @NotNull private BufferOverflowException newBufferOverflowException(final long offset) {
