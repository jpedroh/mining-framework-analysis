 ...
 * accessed directly.
 */@SuppressWarnings(value = { "rawtypes", "unchecked" }) public enum BytesInternal {
  ...
  /**
     ...
     */
  static boolean contentEqualInt(BytesStore a, BytesStore b) throws IllegalStateException {
  ...
  public static boolean contentEqual(@Nullable final BytesStore a, @Nullable final BytesStore b) throws IllegalStateException {
    if (a == null) {
      return b == null;
    }
    if (b == null) {
    ...
    return readRemaining <= Integer.MAX_VALUE ? contentEqualInt(a, b) : contentEqualsLong(a, b);
  }
  ...
  public static void parseUtf8(@NotNull StreamingDataInput bytes, Appendable appendable, boolean utf, int length) throws UTFDataFormatRuntimeException, BufferUnderflowException, IllegalStateException {
    throwExceptionIfReleased(bytes);
    throwExceptionIfReleased(appendable);
    if (appendable instanceof StringBuilder && bytes.isDirectMemory() && length < 1 << 20 && utf) {
  ...
  public static void parseUtf8(@NotNull RandomDataInput input, long offset, Appendable appendable, boolean utf, int length) throws UTFDataFormatRuntimeException, BufferUnderflowException, IllegalStateException {
    assert utf;
  ...
  public static boolean compareUtf8(@NotNull RandomDataInput input, long offset, @Nullable CharSequence other) throws IORuntimeException, BufferUnderflowException, IllegalStateException {
    throwExceptionIfReleased(input);
    if (other != null) {
  ...
  private static boolean compareUtf8(@NotNull RandomDataInput input, long offset, long utfLen, @NotNull CharSequence other) throws UTFDataFormatRuntimeException, BufferUnderflowException, IndexOutOfBoundsException, IllegalStateException {
    throwExceptionIfReleased(input);
    throwExceptionIfReleased(other);
  ...
  private static boolean compareUtf82(@NotNull RandomDataInput input, long offset, int charI, long utfLen, @NotNull CharSequence other) throws UTFDataFormatRuntimeException, BufferUnderflowException, IndexOutOfBoundsException, IllegalStateException {
    throwExceptionIfReleased(input);
    throwExceptionIfReleased(other);
      ...
      switch (c >> 4) {
        ...
        case 14:
        {
          ...
          if (((char2 & 0xC0) != 0x80) || ((char3 & 0xC0) != 0x80)) {
            throw new UTFDataFormatRuntimeException(MALFORMED_INPUT_AROUND_BYTE + (offset - limit + utfLen - 1) + WAS + char2 + " " + char3);
          }
          int c3 = (char) (((c & 0x0F) << 12) | ((char2 & 0x3F) << 6) | (char3 & 0x3F));
  ...
  public static void parse8bit(long offset, @NotNull RandomDataInput bytesStore, Appendable appendable, int utflen) throws BufferUnderflowException, IOException, IllegalStateException {
  ...
  public static void parseUtf81(@NotNull StreamingDataInput bytes, @NotNull Appendable appendable, boolean utf, int length) throws UTFDataFormatRuntimeException, BufferUnderflowException, IllegalStateException {
    throwExceptionIfReleased(bytes);
    throwExceptionIfReleased(appendable);
    try {
      int count = 0;
  ...
  public static void parseUtf81(@NotNull RandomDataInput input, long offset, @NotNull Appendable appendable, int utflen) throws UTFDataFormatRuntimeException, BufferUnderflowException, IllegalStateException {
    throwExceptionIfReleased(input);
    throwExceptionIfReleased(appendable);
    try {
  ...
  public static void parse8bit1(@NotNull StreamingDataInput bytes, @NotNull StringBuilder sb, int utflen) throws IllegalStateException {
    throwExceptionIfReleased(bytes);
  ...
  public static void parse8bit1(@NotNull StreamingDataInput bytes, @NotNull Appendable appendable, int utflen) throws IllegalStateException, IOException {
    throwExceptionIfReleased(bytes);
    throwExceptionIfReleased(appendable);
    assert bytes.readRemaining() >= utflen;
    for (int count = 0; count < utflen; count++) {
  ...
  public static void parse8bit1(long offset, @NotNull RandomDataInput bytes, @NotNull Appendable appendable, int utflen) throws BufferUnderflowException, IllegalStateException, IOException {
    throwExceptionIfReleased(bytes);
    throwExceptionIfReleased(appendable);
  ...
  public static void parseUtf8_SB1(@NotNull Bytes bytes, @NotNull StringBuilder sb, boolean utf, int utflen) throws UTFDataFormatRuntimeException, BufferUnderflowException {
    throwExceptionIfReleased(bytes);
    try {
      assert utf;
      int count = 0;
  ...
  public static void parseUtf8_SB1(@NotNull NativeBytesStore bytes, long offset, @NotNull StringBuilder sb, int utflen) throws UTFDataFormatRuntimeException, BufferUnderflowException, IllegalStateException {
    throwExceptionIfReleased(bytes);
    requireNonNull(sb);
    try {
  ...
  static void parseUtf82(@NotNull StreamingDataInput bytes, @NotNull Appendable appendable, boolean utf, int length, int count) throws IOException, UTFDataFormatRuntimeException, IllegalStateException {
    throwExceptionIfReleased(bytes);
    throwExceptionIfReleased(appendable);
    while (count < length) {
      int c = bytes.readUnsignedByte();
  ...
  static void parseUtf82(@NotNull RandomDataInput input, long offset, long limit, @NotNull Appendable appendable, int utflen) throws IOException, UTFDataFormatRuntimeException, BufferUnderflowException, IllegalStateException {
    throwExceptionIfReleased(input);
    throwExceptionIfReleased(appendable);
    while (offset < limit) {
      int c = input.readUnsignedByte(offset++);
  ...
  public static long writeUtf8(@NotNull RandomDataOutput out, long writeOffset, @Nullable CharSequence str) throws BufferOverflowException, IllegalStateException, ArithmeticException {
  ...
  public static long writeUtf8(@NotNull RandomDataOutput out, long offset, @Nullable CharSequence str, int maxUtf8Len) throws BufferOverflowException, IllegalStateException, ArithmeticException {
    throwExceptionIfReleased(out);
    if (str == null) {
  ...
  @NotNull public static Bytes asBytes(@NotNull RandomDataOutput bytes, long position, long limit) throws IllegalStateException, BufferOverflowException, BufferUnderflowException {
    throwExceptionIfReleased(bytes);
  ...
  public static void appendUtf8(@NotNull StreamingDataOutput bytes, @NotNull CharSequence str, int offset, int length) throws IndexOutOfBoundsException {
    throwExceptionIfReleased(bytes);
  ...
  private static void appendUtf82(@NotNull StreamingDataOutput bytes, @NotNull CharSequence str, int offset, int length, int i) throws IndexOutOfBoundsException, BufferOverflowException, IllegalStateException {
    throwExceptionIfReleased(bytes);
    throwExceptionIfReleased(str);
    for ( ; i < length; i++) {
      char c = str.charAt(offset + i);
  ...
  public static long appendUtf8(@NotNull RandomDataOutput out, long outOffset, @NotNull CharSequence str, int strOffset, int length) throws IndexOutOfBoundsException, BufferOverflowException, IllegalStateException {
    throwExceptionIfReleased(out);
    throwExceptionIfReleased(str);
    int i;
    for (i = 0; i < length; i++) {
  ...
  private static long appendUtf82(@NotNull RandomDataOutput out, long outOffset, @NotNull CharSequence str, int strOffset, int length, int i) throws IndexOutOfBoundsException, BufferOverflowException, IllegalStateException {
    throwExceptionIfReleased(out);
    throwExceptionIfReleased(str);
    for ( ; i < length; i++) {
      char c = str.charAt(strOffset + i);
  ...
  public static void append8bit(long offsetInRDO, RandomDataOutput bytes, @NotNull CharSequence str, int offset, int length) throws IllegalArgumentException, BufferOverflowException, BufferUnderflowException, IndexOutOfBoundsException, IllegalStateException, ArithmeticException {
    throwExceptionIfReleased(bytes);
    throwExceptionIfReleased(str);
  ...
  public static long appendUtf8Char(@NotNull RandomDataOutput out, long offset, int c) throws BufferOverflowException, IllegalStateException {
    if (c <= 0x007F) {
  ...
  public static long writeStopBit(@NotNull final long addr, final long n) throws BufferOverflowException, IllegalStateException {
    if ((n & ~0x7F) == 0) {
  ...
  public static long writeStopBit(@NotNull RandomDataOutput out, long offset, long n) throws BufferOverflowException, IllegalStateException {
    if ((n & ~0x7F) == 0) {
  ...
  @SuppressWarnings(value = { "ShiftOutOfRange" }) public static void writeStopBit(@NotNull StreamingDataOutput out, double d) throws BufferOverflowException, IllegalStateException {
  ...
  static long writeStopBit0(@NotNull RandomDataOutput out, long offset, long n) throws BufferOverflowException, IllegalStateException {
    boolean neg = false;
    if (n < 0) {
      neg = true;
      n = ~n;
  ...
  public static String toDebugString(@NotNull RandomDataInput bytes, long maxLength) throws IllegalStateException, ArithmeticException {
    if (bytes.refCount() < 1) {
      return "<released>";
    }
    ...
    try {
      ...
      sb.append("[").append("pos: ").append(readPosition).append(", rlim: ").append(readLimit).append(", wlim: ").append(asSize(bytes.writeLimit())).append(", cap: ").append(asSize(bytes.capacity())).append(" ] ");
      try {
  ...
  @NotNull public static String toString(@NotNull RandomDataInput bytes) {
    throwExceptionIfReleased(bytes);
    try {
  ...
  private static void toString(@NotNull RandomDataInput bytes, @NotNull Appendable sb, long start, long readPosition, long writePosition, long end) throws IllegalStateException {
    throwExceptionIfReleased(bytes);
  ...
  private static void toString(@NotNull RandomDataInput bytes, @NotNull Appendable sb, long start, long last) throws IOException, BufferUnderflowException, IllegalStateException {
    throwExceptionIfReleased(bytes);
    throwExceptionIfReleased(sb);
  ...
  /**
     ...
     * numbers
     */
  public static void append(@NotNull RandomDataOutput out, long offset, long num, int digits) throws BufferOverflowException, IllegalArgumentException, IllegalStateException {
  ...
  /**
     ...
     */
  public static void appendDecimal(@NotNull RandomDataOutput out, long num, long offset, int decimalPlaces, int width) throws IORuntimeException, IllegalArgumentException, BufferOverflowException, ArithmeticException, IllegalStateException {
    if (decimalPlaces == 0) {
  ...
  @Nullable public static String readUtf8(@NotNull StreamingDataInput in) throws BufferUnderflowException, IORuntimeException, IllegalStateException, ArithmeticException {
  ...
  @Nullable public static String readUtf8(@NotNull RandomDataInput in, long offset, int maxUtf8Len) throws BufferUnderflowException, IllegalArgumentException, IllegalStateException, IORuntimeException {
    throwExceptionIfReleased(in);
    StringBuilder sb = acquireStringBuilder();
  ...
  @Nullable public static String read8bit(@NotNull StreamingDataInput in) throws BufferUnderflowException, IORuntimeException, ArithmeticException, IllegalStateException {
    throwExceptionIfReleased(in);
    if (in.peekUnsignedByte() == 0x80 && in instanceof RandomDataInput) {
      RandomDataInput rdi = (RandomDataInput) in;
      if (rdi.peekUnsignedByte(in.readPosition() + 1) == 0) {
  ...
  @Nullable public static String parseUtf8(@NotNull StreamingDataInput bytes, @NotNull StopCharTester tester) throws IllegalStateException, ArithmeticException {
    throwExceptionIfReleased(bytes);
          ...
          if (-absValue < -MAX_VALUE_DIVIDE_10) {
            if (ch == '0') {
              ...
              if (parsingError == null) {
                parsingError = new IORuntimeException(CAN_T_PARSE_FLEXIBLE_LONG_WITHOUT_PRECISION_LOSS + (sign * absValue) + " <- " + ((char) ch));
              }
            }
          } else {
            if (absValue == MAX_VALUE_DIVIDE_10) {
      ...
      if (tens <= 0) {
        ...
        for (int i = 0; i < -tens; i++) {
          ...
          if (truncatingDigit != 0) {
            throw new IORuntimeException(CAN_T_PARSE_FLEXIBLE_LONG_WITHOUT_PRECISION_LOSS + "division of " + absValue + " by 10");
          }
          absValue /= 10;
        }
        return absValue;
  ...
  private static long parseLongHexaDecimal(@NotNull StreamingDataInput in) throws IllegalStateException, BufferUnderflowException {
    ...
    while (in.readRemaining() > 0) {
      ...
      if ((b - ('0' + Integer.MIN_VALUE)) <= 9 + Integer.MIN_VALUE) {
        ...
        if ((b - ('A' + Integer.MIN_VALUE)) < 6 + Integer.MIN_VALUE) {
          num = (num << 4) + b - ('A' - 10);
        } else {
          if ((b - ('a' + Integer.MIN_VALUE)) < 6 + Integer.MIN_VALUE) {
            num = (num << 4) + b - ('a' - 10);
  ...
  public static long parseLong(@NotNull RandomDataInput in, long offset) throws BufferUnderflowException, IllegalStateException {
    long num = 0;
    boolean negative = false;
    while (true) {
  ...
  public static float addAndGetFloat(@NotNull RandomDataInput in, long offset, float adding) throws BufferUnderflowException, IllegalStateException {
    try {
      for ( ; ; ) {
  ...
  public static double addAndGetDouble(@NotNull RandomDataInput in, long offset, double adding) throws BufferUnderflowException, IllegalStateException {
    try {
      for ( ; ; ) {
  ...
  public static int addAndGetInt(@NotNull RandomDataInput in, long offset, int adding) throws BufferUnderflowException, IllegalStateException {
    try {
      for ( ; ; ) {
        int value = in.readVolatileInt(offset);
  ...
  public static long addAndGetLong(@NotNull RandomDataInput in, long offset, long adding) throws BufferUnderflowException, IllegalStateException {
    try {
      for ( ; ; ) {
        long value = in.readVolatileLong(offset);
  ...
  /**
     ...
     */
  public static String toHexString(@NotNull final Bytes bytes, long offset, long len) throws BufferUnderflowException, IllegalStateException {
    throwExceptionIfReleased(bytes);
    if (len == 0) {
      return "";
    }
  ...
  public static boolean equalBytesAny(@NotNull BytesStore b1, @NotNull BytesStore b2, long readRemaining) throws BufferUnderflowException, IllegalStateException {
    ...
    long i = 0;
    for ( ; i < readRemaining - 7 && canReadBytesAt(bs1, b1.readPosition() + i, 8) && canReadBytesAt(bs2, b2.readPosition() + i, 8); i += 8) {
    ...
    for ( ; i < readRemaining && canReadBytesAt(bs1, b1.readPosition() + i, 1) && canReadBytesAt(bs2, b2.readPosition() + i, 1); i++) {
  ...
  @NotNull public static <E extends Enum<E>, S extends StreamingDataInput<S>> E readEnum(@NotNull StreamingDataInput input, @NotNull Class<E> eClass) throws BufferUnderflowException, IORuntimeException, BufferOverflowException, IllegalStateException, ArithmeticException {
    Bytes bytes = acquireBytes();
    input.read8bit(bytes);
    return (E) EnumInterner.ENUM_INTERNER.get(eClass).intern(bytes);
  }

  public static void writeFully(@NotNull RandomDataInput bytes, long offset, long length, @NotNull StreamingDataOutput sdo) throws BufferUnderflowException, BufferOverflowException, IllegalStateException {
    long i = 0;
    for ( ; i < length - 7; i += 8) {
  ...
  @NotNull public static byte[] toByteArray(@NotNull RandomDataInput in) throws IllegalStateException {
  ...
  public static void copy(@NotNull final RandomDataInput input, @NotNull final OutputStream output) throws IOException, IllegalStateException {
  ...
  @NotNull public static BytesStore subBytes(RandomDataInput from, long start, long length) throws BufferUnderflowException, IllegalStateException {
    try {
  ...
  @NotNull public static Bytes fromHexString(@NotNull String s) {
  ...
  private static boolean canReadBytesAt(final BytesStore bs, final long offset, final int length) {
  ...
  static class DateCache {
    ...
    @Nullable private byte[] lastDateStr = null;
