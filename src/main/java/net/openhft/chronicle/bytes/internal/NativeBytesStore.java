...
@SuppressWarnings(value = { "restriction", "rawtypes", "unchecked" }) public class NativeBytesStore<Underlying extends java.lang.Object> extends AbstractBytesStore<NativeBytesStore<Underlying>, Underlying> {
  ...
  @Nullable private SimpleCleaner cleaner;

  private boolean elastic;

  @Nullable private Underlying underlyingObject;
  ...
  @NotNull public static <T extends java.lang.Object> NativeBytesStore<T> uninitialized() {
  ...
  @NotNull private static NativeBytesStore<Void> of(long capacity, boolean zeroOut, boolean elastic) throws IllegalArgumentException {
    if (capacity <= 0) {
  ...
  @Override public void move(long from, long to, long length) throws BufferUnderflowException, IllegalStateException {
    if (from < 0 || to < 0) {
  ...
  @NotNull @Override public BytesStore<NativeBytesStore<Underlying>, Underlying> copy() throws IllegalStateException {
    try {
  ...
  @NotNull @Override public VanillaBytes<Underlying> bytesForWrite() throws IllegalStateException {
    try {
      return elastic ? NativeBytes.wrapWithNativeBytes(this, this.capacity()) : new NativeBytes<>(this);
  ...
  @NotNull @Override public NativeBytesStore<Underlying> zeroOut(long start, long end) {
    if (end <= start) {
      return this;
    }
    if (start < start()) {
  ...
  @Override public boolean compareAndSwapInt(long offset, int expected, int value) throws IllegalStateException {
    return memory.compareAndSwapInt(address + translate(offset), expected, value);
  }

  @Override public void testAndSetInt(long offset, int expected, int value) throws IllegalStateException {
    memory.testAndSetInt(address + translate(offset), offset, expected, value);
  }

  @Override public boolean compareAndSwapLong(long offset, long expected, long value) throws IllegalStateException {
    return memory.compareAndSwapLong(address + translate(offset), expected, value);
  }

  @Override public long addAndGetLong(long offset, long adding) throws BufferUnderflowException {
    return memory.addLong(address + translate(offset), adding);
  }

  @Override public int addAndGetInt(long offset, int adding) throws BufferUnderflowException {
  ...
  @Override public int readUnsignedByte(long offset) throws BufferUnderflowException {
  ...
  @Override public byte readVolatileByte(long offset) {
    return memory.readVolatileByte(address + translate(offset));
  }

  @Override public short readVolatileShort(long offset) {
    return memory.readVolatileShort(address + translate(offset));
  }

  @Override public int readVolatileInt(long offset) {
    return memory.readVolatileInt(address + translate(offset));
  }

  @Override public long readVolatileLong(long offset) {
    return memory.readVolatileLong(address + translate(offset));
  }

  @NotNull @Override public NativeBytesStore<Underlying> writeByte(long offset, byte i8) throws IllegalStateException {
    memory.writeByte(address + translate(offset), i8);
    return this;
  }

  @NotNull @Override public NativeBytesStore<Underlying> writeShort(long offset, short i16) throws IllegalStateException {
    memory.writeShort(address + translate(offset), i16);
    return this;
  }

  @NotNull @Override public NativeBytesStore<Underlying> writeInt(long offset, int i32) throws IllegalStateException {
    try {
  ...
  @NotNull @Override public NativeBytesStore<Underlying> writeOrderedInt(long offset, int i) throws IllegalStateException {
    memory.writeOrderedInt(address + translate(offset), i);
    return this;
  }

  @NotNull @Override public NativeBytesStore<Underlying> writeLong(long offset, long i64) throws IllegalStateException {
    memory.writeLong(address + translate(offset), i64);
    return this;
  }

  @NotNull @Override public NativeBytesStore<Underlying> writeOrderedLong(long offset, long i) throws IllegalStateException {
    memory.writeOrderedLong(address + translate(offset), i);
    return this;
  }

  @NotNull @Override public NativeBytesStore<Underlying> writeFloat(long offset, float f) throws IllegalStateException {
    memory.writeFloat(address + translate(offset), f);
    return this;
  }

  @NotNull @Override public NativeBytesStore<Underlying> writeDouble(long offset, double d) throws IllegalStateException {
    memory.writeDouble(address + translate(offset), d);
    return this;
  }

  @NotNull @Override public NativeBytesStore<Underlying> writeVolatileByte(long offset, byte i8) throws IllegalStateException {
    memory.writeVolatileByte(address + translate(offset), i8);
    return this;
  }

  @NotNull @Override public NativeBytesStore<Underlying> writeVolatileShort(long offset, short i16) throws IllegalStateException {
    memory.writeVolatileShort(address + translate(offset), i16);
    return this;
  }

  @NotNull @Override public NativeBytesStore<Underlying> writeVolatileInt(long offset, int i32) throws IllegalStateException {
    memory.writeVolatileInt(address + translate(offset), i32);
    return this;
  }

  @NotNull @Override public NativeBytesStore<Underlying> writeVolatileLong(long offset, long i64) throws IllegalStateException {
    memory.writeVolatileLong(address + translate(offset), i64);
    return this;
  }

  @NotNull @Override public NativeBytesStore<Underlying> write(long offsetInRDO, byte[] bytes, int offset, int length) throws IllegalStateException {
    requireNonNull(bytes);
    memory.copyMemory(bytes, offset, address + translate(offsetInRDO), length);
    return this;
  }

  @Override public void write(long offsetInRDO, @NotNull ByteBuffer bytes, int offset, int length) throws IllegalStateException {
    if (bytes.isDirect()) {
  ...
  @NotNull @Override public NativeBytesStore<Underlying> write(long writeOffset, @NotNull RandomDataInput bytes, long readOffset, long length) throws BufferOverflowException, BufferUnderflowException, IllegalStateException {
  ...
  @Override protected void backgroundPerformRelease() {
    memory = null;
  ...
  @Override public long readIncompleteLong(long offset) {
  ...
  @Override public long copyTo(@NotNull BytesStore store) throws IllegalStateException {
  ...
  @NotNull @Override public ByteBuffer toTemporaryDirectByteBuffer() {
  ...
  @Override public int byteCheckSum(long position, long limit) {
    @Nullable Memory mem = this.memory;
    assert mem != null;
    int b = 0;
    ...
    for ( ; ptr < end - 7; ptr += 8) {
      b += mem.readByte(ptr) + mem.readByte(ptr + 1) + mem.readByte(ptr + 2) + mem.readByte(ptr + 3) + mem.readByte(ptr + 4) + mem.readByte(ptr + 5) + mem.readByte(ptr + 6) + mem.readByte(ptr + 7);
    }
    for ( ; ptr < end; ptr++) {
      b += mem.readByte(ptr);
    }
  ...
  @Override public boolean sharedMemory() {
    return false;
  }

  @Override public long read(long offsetInRDI, byte[] bytes, int offset, int length) {
    requireNonNull(bytes);
  ...
  @Override public int peekUnsignedByte(long offset) {
    ...
    return translate >= limit ? -1 : mem.readByte(address2) & 0xFF;
  }

  @Override public int fastHash(long offset, int length) throws BufferUnderflowException, IllegalStateException {
    long ret;
    switch (length) {
      case 0:
      return 0;
  ...
  @Override public long safeLimit() {
    return limit;
  }

  @Override public boolean isEqual(long start, long length, String s) {
