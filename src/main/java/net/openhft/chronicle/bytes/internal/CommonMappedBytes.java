 ...
 */
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public abstract class CommonMappedBytes extends MappedBytes {
  ...
  private final AbstractCloseable closeable = new AbstractCloseable() {
    @Override protected void performClose() throws IllegalStateException {
  ...
  protected CommonMappedBytes(@NotNull final MappedFile mappedFile) throws IllegalStateException {
    this(mappedFile, "");
  }

  protected CommonMappedBytes(@NotNull final MappedFile mappedFile, final String name) throws IllegalStateException {
    super(name);
  ...
  @Override public void clearUsedByThread() {
    super.clearUsedByThread();
    closeable.clearUsedByThread();
  }

  @Override protected void bytesStore(BytesStore bytesStore) {
    super.bytesStore(bytesStore);
  }

  @Override public @NotNull CommonMappedBytes write(@NotNull final byte[] bytes, final int offset, final int length) throws IllegalStateException, BufferOverflowException {
  ...
  @NotNull @Override public CommonMappedBytes write(@NotNull final RandomDataInput bytes) throws IllegalStateException, BufferOverflowException {
    requireNonNull(bytes);
    throwExceptionIfClosed();
  ...
  @NotNull public CommonMappedBytes write(final long offsetInRDO, @NotNull final RandomDataInput bytes) throws BufferOverflowException, IllegalStateException {
    requireNonNull(bytes);
    throwExceptionIfClosed();
    try {
  ...
  @Override public BytesStore<Bytes<Void>, Void> copy() throws IllegalStateException {
  ...
  @Override public Bytes<Void> readLimitToCapacity() {
    uncheckedWritePosition(mappedFile.capacity());
    return this;
  }

  @Override public long realReadRemaining() {
  ...
  @NotNull @Override public Bytes<Void> writePosition(final long position) throws BufferOverflowException {
  ...
  @Override @NotNull public Bytes<Void> write(@NotNull final RandomDataInput bytes, final long offset, final long length) throws BufferUnderflowException, BufferOverflowException, IllegalStateException {
    requireNonNull(bytes);
    throwExceptionIfClosed();
  ...
  @NotNull @Override public Bytes<Void> append8bit(@NotNull CharSequence text, int start, int end) throws IllegalArgumentException, BufferOverflowException, BufferUnderflowException, IndexOutOfBoundsException, IllegalStateException {
    requireNonNull(text);
    throwExceptionIfClosed();
  ...
  @Override @NotNull public CommonMappedBytes write8bit(@NotNull CharSequence text, int start, int length) throws IllegalStateException, BufferUnderflowException, BufferOverflowException, ArithmeticException, IndexOutOfBoundsException {
    requireNonNull(text);
    throwExceptionIfClosed();
  ...
  @NotNull private CommonMappedBytes append8bit0(@NotNull String s, int start, int length) throws BufferOverflowException, IllegalStateException {
    requireNonNull(s);
  ...
  @NotNull @Override public Bytes<Void> appendUtf8(@NotNull CharSequence cs, int start, int length) throws BufferOverflowException, IllegalStateException, BufferUnderflowException, IndexOutOfBoundsException {
    requireNonNull(cs);
    throwExceptionIfClosed();
    long pos = writePosition();
    writeCheckOffset(pos, 0);
  ...
  @Override public void release(ReferenceOwner id) throws IllegalStateException {
    super.release(id);
  ...
  @Override public void releaseLast(ReferenceOwner id) throws IllegalStateException {
  ...
  @Override public void warnAndCloseIfNotClosed() {
    closeable.warnAndCloseIfNotClosed();
  }

  @Override public void throwExceptionIfClosed() throws IllegalStateException {
    closeable.throwExceptionIfClosed();
  }

  @NotNull @Override public Bytes<Void> writeUtf8(@Nullable CharSequence text) throws BufferOverflowException, IllegalStateException {
    throwExceptionIfClosed();
  ...
  @Override public @NotNull Bytes<Void> writeUtf8(@Nullable String text) throws BufferOverflowException, IllegalStateException {
    throwExceptionIfClosed();
    if (text == null) {
      BytesInternal.writeStopBitNeg1(this);
      return this;
  ...
  @NotNull @Override public Bytes<Void> writeStopBit(long n) throws BufferOverflowException, IllegalStateException {
    throwExceptionIfClosed();
    if ((n & ~0x7F) == 0) {
  ...
  @NotNull @Override public Bytes<Void> writeStopBit(char n) throws BufferOverflowException, IllegalStateException {
    throwExceptionIfClosed();
    if ((n & ~0x7F) == 0) {
      writeByte((byte) (n & 0x7f));
      return this;
  ...
  @Override public boolean isBackingFileReadOnly() {
  ...
  @Override public void chunkCount(long[] chunkCount) {
