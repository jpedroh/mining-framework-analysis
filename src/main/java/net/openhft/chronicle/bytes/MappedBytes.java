...
public class MappedBytes extends AbstractBytes<Void> implements Closeable {
  ...
  @Override public Bytes<Void> append8bit(@NotNull CharSequence cs, int start, int end) throws IllegalArgumentException, BufferOverflowException, BufferUnderflowException, IndexOutOfBoundsException {
    return cs instanceof String ? append8bit0((String) cs, start, end - start) : super.append8bit(cs, start, end);
  }

  @Override public Bytes<Void> writeUtf8(String s) throws BufferOverflowException {
  ...
  @NotNull private MappedBytes append8bit0(String s, int start, int length) {
  ...
  @Override public Bytes<Void> appendUtf8(CharSequence cs, int start, int length) throws BufferOverflowException, IllegalArgumentException {
    long pos = writePosition();
    writeCheckOffset(pos, 0);
