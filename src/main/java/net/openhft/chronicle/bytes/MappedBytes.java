...
public class MappedBytes extends AbstractBytes<Void> implements Closeable {
  ...
  @NotNull private final MappedFile mappedFile;
  ...
  @NotNull private static MappedFile reserve(@NotNull MappedFile mappedFile) {
    mappedFile.reserve();
    return mappedFile;
  }
  ...
  @Override public BytesStore<Bytes<Void>, Void> copy() {
  ...
  @NotNull @Override public Bytes<Void> readPositionRemaining(long position, long remaining) throws BufferUnderflowException {
    long limit = position + remaining;
    if (!bytesStore.inside(position)) {
      acquireNextByteStore(position, true);
    } else {
      if (!bytesStore.inside(limit)) {
  ...
  @NotNull @Override public Bytes<Void> readPosition(long position) throws BufferUnderflowException {
    if (bytesStore.inside(position)) {
  ...
  @Override protected void readCheckOffset(long offset, long adding, boolean given) throws BufferUnderflowException {
  ...
  @NotNull private BufferOverflowException writeBufferOverflowException(long offset) {
  ...
  @NotNull @Override public Bytes<Void> readSkip(long bytesToSkip) throws BufferUnderflowException {
  ...
  @Nullable @Override public MappedBytesStore bytesStore() {
  ...
  @NotNull @Override public Bytes<Void> writePosition(long position) throws BufferOverflowException {
    assert singleThreadedAccess();
  ...
  @NotNull @Override public Bytes<Void> clear() {
    long start = 0L;
    readPosition = start;
  ...
  @NotNull @Override public Bytes<Void> writeByte(byte i8) throws BufferOverflowException {
    assert singleThreadedAccess();
  ...
  @NotNull @Override public Bytes<Void> write(@NotNull BytesStore bytes, long offset, long length) throws BufferUnderflowException, BufferOverflowException {
    assert singleThreadedAccess();
    if (length == 8) {
      writeLong(bytes.readLong(offset));
    } else {
      if (bytes.isDirectMemory() && length >= 16) {
  ...
  @NotNull @Override public Bytes<Void> append8bit(@NotNull CharSequence cs, int start, int end) throws IllegalArgumentException, BufferOverflowException, BufferUnderflowException, IndexOutOfBoundsException {
    assert singleThreadedAccess();
  ...
  @NotNull @Override public Bytes<Void> writeUtf8(CharSequence str) throws BufferOverflowException {
...
>>>>>>> /usr/src/app/output/openhft/chronicle-bytes/2944fec37487ea4ac84a7407e1449890665af18c/src/main/java/net/openhft/chronicle/bytes/MappedBytes.java/right.java
  ...
  @Override @NotNull public MappedBytes write8bit(CharSequence s, int start, int length) {
    assert singleThreadedAccess();
    if (s == null) {
      writeStopBit(-1);
      return this;
  ...
  @NotNull private MappedBytes append8bit0(@NotNull String s, int start, int length) throws BufferOverflowException {
    assert singleThreadedAccess();
    if (Jvm.isJava9Plus()) {
  ...
  @NotNull @Override public Bytes<Void> appendUtf8(CharSequence cs, int start, int length) throws BufferOverflowException, IllegalArgumentException {
    assert singleThreadedAccess();
    long pos = writePosition();
    writeCheckOffset(pos, 0);
  ...
  @Override @NotNull public Bytes<Void> writeOrderedInt(long offset, int i) throws BufferOverflowException {
    assert singleThreadedAccess();
  ...
  @Override public int peekVolatileInt() {
  ...
  @NotNull @Override public MappedBytes write(@NotNull BytesStore bytes) throws BufferOverflowException {
    assert singleThreadedAccess();
    ...
    if (length == 8) {
      ...
      if (bytes.isDirectMemory() && length >= 16 && length <= writeRemaining()) {
        rawCopy(bytes, offset, length);
      } else {
        BytesInternal.writeFully(bytes, offset, length, this);
      }
  ...
  @Override public Bytes<Void> writeUtf8(String str) throws BufferOverflowException {
    if (str == null) {
      writeStopBit(-1);
      return this;
    }
  ...
  @NotNull @Override public Bytes<Void> appendUtf8(char[] chars, int offset, int length) throws BufferOverflowException, IllegalArgumentException {
  ...
  @NotNull @Override public Bytes<Void> writeStopBit(long n) throws BufferOverflowException {
    if ((n & ~0x7F) == 0) {
