...
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public interface Bytes<Underlying extends java.lang.Object> extends BytesStore<Bytes<Underlying>, Underlying>, BytesIn<Underlying>, BytesOut<Underlying> {
  long MAX_CAPACITY = Long.MAX_VALUE;
  ...
  /**
     ...
     * @return a string contain the text from the {@code position}  to the  {@code limit}
     */
  static String toString(@NotNull final Bytes<?> buffer, long maxLen) throws BufferUnderflowException {
  ...
  /**
     ...
     */
  static String toString(@NotNull final Bytes buffer, long position, long len) throws BufferUnderflowException {
  ...
  @NotNull default Bytes<Underlying> unchecked(boolean unchecked) throws IllegalStateException {
    if (unchecked) {
      ...
      return start() == 0 && bytesStore().isDirectMemory() ? new UncheckedNativeBytes<>(this) : new UncheckedBytes<>(this);
    }
    return this;
  }
  ...
  /**
     ...
     */
  @Override BytesStore<Bytes<Underlying>, Underlying> copy();
  ...
  /**
     ...
     */
  @Override default long copyTo(@NotNull BytesStore store) {
    return BytesStore.super.copyTo(store);
  }

  @Override default void copyTo(OutputStream out) throws IOException {
  ...
  @Deprecated default long indexOf(@NotNull Bytes source, int fromIndex) {
    return indexOf(this, source, fromIndex);
  }

  @Override @NotNull Bytes<Underlying> clear();

  @Override default boolean readWrite() {
    return bytesStore().readWrite();
  }

  default void readWithLength(long length, @NotNull BytesOut<Underlying> bytesOut) throws BufferUnderflowException, IORuntimeException {
