...
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public interface Bytes<Underlying extends java.lang.Object> extends BytesStore<Bytes<Underlying>, Underlying>, BytesIn<Underlying>, BytesOut<Underlying> {
  ...
  @Deprecated int MAX_BYTE_BUFFER_CAPACITY = MAX_HEAP_CAPACITY;
  ...
  /**
     ...
     */
  @NotNull static Bytes<ByteBuffer> elasticByteBuffer(int initialCapacity, int maxCapacity) {
  ...
  static <T extends java.lang.Object> Bytes<T> forFieldGroup(T t, String groupName) {
  ...
  /**
     ...
     */
  @NotNull static Bytes<ByteBuffer> wrapForRead(@NotNull ByteBuffer byteBuffer) {
  ...
  /**
     ...
     */
  @NotNull static Bytes<ByteBuffer> wrapForWrite(@NotNull ByteBuffer byteBuffer) {
    BytesStore<?, ByteBuffer> bs = BytesStore.wrap(byteBuffer);
    try {
      try {
  ...
  /**
     ...
     */
  @NotNull static Bytes<?> from(@NotNull CharSequence text) {
  ...
  /**
     ...
     */
  @NotNull static OnHeapBytes allocateElasticOnHeap(int initialCapacity) {
  ...
  /**
     ...
     */
  @NotNull static String toString(@NotNull final Bytes<?> buffer, long maxLen) throws BufferUnderflowException, IllegalStateException, IllegalArgumentException {
  ...
  /**
     ...
     */
  @NotNull static String toString(@NotNull final Bytes buffer, long position, long len) {
    try {
  ...
  /**
     ...
     */
  static int indexOf(@NotNull BytesStore source, @NotNull BytesStore target, int fromIndex) throws IllegalStateException {
  ...
  /**
     ...
     */
  @Override default long copyTo(@NotNull BytesStore store) throws IllegalStateException {
  ...
  /**
     ...
     */
  @Override default void copyTo(@NotNull OutputStream out) throws IOException, IllegalStateException {
  ...
  @Deprecated default long indexOf(@NotNull Bytes source, int fromIndex) throws IllegalStateException {
    return indexOf(this, source, fromIndex);
  }
  ...
  default <T extends ReadBytesMarshallable> T readMarshallableLength16(Class<T> tClass, T object) throws BufferUnderflowException, IllegalStateException {
    if (object == null) {
      object = ObjectUtils.newInstance(tClass);
    }
  ...
  default Bytes write(final InputStream inputStream) throws IOException, BufferOverflowException, IllegalStateException {
    for ( ; ; ) {
      int read;
