 ...
 * &lt;= safeLimit(); <p></p>
 */
public interface Bytes<Underlying extends java.lang.Object> extends BytesStore<Bytes<Underlying>, Underlying>, StreamingDataInput<Bytes<Underlying>>, StreamingDataOutput<Bytes<Underlying>>, ByteStringParser<Bytes<Underlying>>, ByteStringAppender<Bytes<Underlying>>, BytesPrepender<Bytes<Underlying>> {
  ...
  /**
     ...
     */
  @NotNull static Bytes<byte[]> expect(@NotNull String text) {
  ...
  /**
     ...
     * @return the expected buffer as Bytes
     */
  @NotNull static <B extends BytesStore<B, Underlying>, Underlying extends java.lang.Object> Bytes<Underlying> expect(BytesStore<B, Underlying> bytesStore) {
  ...
  /**
     ...
     */
  static String toString(@NotNull final Bytes buffer, long position, long len) throws BufferUnderflowException, IORuntimeException {
  ...
  default Bytes<Underlying> unchecked(boolean unchecked) throws IllegalStateException {
    return unchecked ? start() == 0 && bytesStore() instanceof NativeBytesStore ? new UncheckedNativeBytes<>(this) : new UncheckedBytes<>(this) : this;
  }
  ...
  /**
     ...
     */
  @NotNull default String toHexString() throws IORuntimeException {
  ...
  /**
     ...
     * @return hex representation of the buffer, from example [0D ,OA, FF]
     */
  @NotNull default String toHexString(long maxLength) throws IORuntimeException {
    if (readRemaining() < maxLength) {
      return toHexString();
    }
  ...
  /**
     ...
     * @return hex representation of the buffer, from example [0D ,OA, FF]
     */
  @NotNull default String toHexString(long offset, long maxLength) throws IORuntimeException {
  ...
  /**
     ...
     */
  default void ensureCapacity(long size) throws IllegalArgumentException, IORuntimeException {
    if (size > capacity()) {
  ...
  /**
     ...
     * @throws IllegalStateException if the underlying BytesStore has been released
     */
  @Override default Bytes<Underlying> bytesForRead() throws IllegalStateException {
