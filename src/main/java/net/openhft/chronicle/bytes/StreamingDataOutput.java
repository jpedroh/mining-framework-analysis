 ...
 */
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public interface StreamingDataOutput<S extends StreamingDataOutput<S>> extends StreamingCommon<S> {
  ...
  /**
     ...
     */
  @NotNull default S writeUtf8(@Nullable CharSequence text) throws BufferOverflowException, IllegalStateException, IllegalArgumentException, BufferUnderflowException {
    BytesInternal.writeUtf8(this, text);
    return (S) this;
  }

  @NotNull default S writeUtf8(@Nullable String text) throws BufferOverflowException, IllegalStateException, BufferUnderflowException, IllegalArgumentException {
    BytesInternal.writeUtf8(this, text);
    return (S) this;
  }

  @NotNull default S write8bit(final @Nullable CharSequence text) throws BufferOverflowException, ArithmeticException, IllegalStateException, BufferUnderflowException {
    if (text == null) {
  ...
  @NotNull default S write8bit(@NotNull CharSequence text, int start, int length) throws BufferOverflowException, IndexOutOfBoundsException, ArithmeticException, IllegalStateException, BufferUnderflowException {
    requireNonNull(text);
    if (text instanceof String) {
  ...
  @NotNull S write8bit(@NotNull String text, int start, int length);
  ...
  /**
     ...
     */
  @NotNull default S write(@NotNull CharSequence text) throws BufferOverflowException, IndexOutOfBoundsException, IllegalStateException {
    requireNonNull(text);
    if (text instanceof BytesStore) {
  ...
  /**
     ...
     */
  @NotNull default S write(@NotNull final CharSequence text, final int startText, final int length) throws BufferOverflowException, IndexOutOfBoundsException, IllegalStateException {
    requireNonNull(text);
  ...
  @NotNull default S write8bit(@Nullable String s) throws BufferOverflowException, ArithmeticException, IllegalStateException {
    try {
      if (s == null) {
        BytesInternal.writeStopBitNeg1(this);
      } else {
  ...
  /**
     ...
     */
  @NotNull default S write(@NotNull RandomDataInput bytes) throws BufferOverflowException, IllegalStateException {
  ...
  /**
     ...
     */
  default S write(@NotNull BytesStore bytes) throws BufferOverflowException, IllegalStateException {
    assert bytes != this : "you should not write to yourself !";
    requireNonNull(bytes);
    if (bytes.readRemaining() > writeRemaining()) {
      throw new BufferOverflowException();
  ...
  /**
     ...
     * Calling this method will update the cursors of this, but not the bytes we read from.
     */
  @NotNull default S writeSome(@NotNull Bytes bytes) throws IllegalStateException {
    try {
  ...
  /**
     ...
     * Calling this method will update the cursors of this, but not the bytes we read from.
     */
  @NotNull default S write(@NotNull RandomDataInput bytes, long readOffset, long length) throws BufferOverflowException, BufferUnderflowException, IllegalStateException, IllegalArgumentException {
  ...
  /**
     ...
     * Calling this method will update the cursors of this, but not the bytes we read from.
     */
  @NotNull default S write(@NotNull BytesStore bytes, long readOffset, long length) throws BufferOverflowException, BufferUnderflowException, IllegalStateException, IllegalArgumentException {
    requireNonNull(bytes);
  ...
  /**
     ...
     */
  @NotNull default S write(@NotNull byte[] byteArray) throws BufferOverflowException, IllegalStateException {
  ...
  /**
     ...
     * Calling this method will update the cursors of this.
     */
  @NotNull S writeSome(@NotNull ByteBuffer buffer) throws BufferOverflowException, IllegalStateException, BufferUnderflowException;
  ...
  @NotNull default S appendUtf8(@NotNull CharSequence cs) throws BufferOverflowException, IllegalStateException, BufferUnderflowException {
  ...
  @NotNull default S appendUtf8(@NotNull char[] chars, int offset, int length) throws BufferOverflowException, IllegalStateException, BufferUnderflowException, IllegalArgumentException {
    int i;
    ascii:
    {
      for (i = 0; i < length; i++) {
  ...
  @NotNull default S appendUtf8(@NotNull CharSequence cs, int offset, int length) throws BufferOverflowException, IndexOutOfBoundsException, IllegalStateException, BufferUnderflowException {
    BytesInternal.appendUtf8(this, cs, offset, length);
    return (S) this;
  }

  @Java9 @NotNull default S appendUtf8(@NotNull byte[] bytes, int offset, int length, byte coder) throws BufferOverflowException, IllegalStateException {
  ...
  @Java9 @NotNull default S appendUtf8(@NotNull byte[] bytes, int offset, int length) throws BufferOverflowException, IllegalStateException {
    for (int i = 0; i < length; i++) {
      int b = bytes[offset + i] & 0xFF;
      if (b >= 0xF0) {
        int b2 = bytes[offset + i + 1] & 0xFF;
        int b3 = bytes[offset + i + 2] & 0xFF;
  ...
  default void copyFrom(@NotNull InputStream input) throws IOException, BufferOverflowException, IllegalStateException {
  ...
  default void writeBigDecimal(@NotNull BigDecimal bd) throws BufferOverflowException, IllegalStateException, IllegalArgumentException {
    writeBigInteger(bd.unscaledValue());
    writeStopBit(bd.scale());
  }

  default void writeBigInteger(@NotNull BigInteger bi) throws BufferOverflowException, IllegalStateException, IllegalArgumentException {
    byte[] bytes = bi.toByteArray();
    writeStopBit(bytes.length);
    write(bytes);
  }

  default void writeWithLength(@NotNull RandomDataInput bytes) throws BufferOverflowException, IllegalStateException {
