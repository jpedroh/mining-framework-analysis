...
public interface RandomDataInput extends RandomCommon {
  ...
  /**
     ...
     * @throws IllegalStateException    if released
     */
  default <T extends Appendable & CharSequence> long readUtf8(long offset, @NotNull T sb) throws IORuntimeException, IllegalArgumentException, BufferUnderflowException, ArithmeticException, IllegalStateException {
  ...
  /**
     ...
     */
  default <T extends Appendable & CharSequence> long readUtf8Limited(long offset, final @NotNull T sb, final int maxUtf8Len) throws IORuntimeException, IllegalArgumentException, BufferUnderflowException, IllegalStateException {
    AppendableUtil.setLength(sb, 0);
    long utfLen;
    if ((utfLen = readByte(offset++)) < 0) {
      utfLen &= 0x7FL;
