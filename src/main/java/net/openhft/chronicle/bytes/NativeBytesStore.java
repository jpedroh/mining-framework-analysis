...
public class NativeBytesStore<Underlying extends java.lang.Object> implements BytesStore<NativeBytesStore<Underlying>, Underlying> {
  ...
  @Override public BytesStore<NativeBytesStore<Underlying>, Underlying> copy() {
  ...
  @Override public Bytes<Underlying> bytes() {
    return elastic ? new NativeBytes<>(this) : new VanillaBytes<>(this);
  }

  @Override public Bytes bytes(UnderflowMode underflowMode) {
    return underflowMode == UnderflowMode.BOUNDED ? new NativeBytes<>(this) : BytesStore.super.bytes(underflowMode);
  }
  ...
  @Override public Underlying underlyingObject() {
    return underlyingObject;
  }

  @Override public Access<Underlying> access() {
    return nativeAccess();
  }

  @Override public NativeBytesStore<Underlying> zeroOut(long start, long end) {
  ...
  @Override public boolean compareAndSwapInt(long offset, int expected, int value) {
    return MEMORY.compareAndSwapInt(address + translate(offset), expected, value);
  }

  @Override public boolean compareAndSwapLong(long offset, long expected, long value) {
  ...
  @Override public NativeBytesStore<Underlying> writeByte(long offset, byte i8) {
    MEMORY.writeByte(address + translate(offset), i8);
    return this;
  }

  @Override public NativeBytesStore<Underlying> writeShort(long offset, short i16) {
    MEMORY.writeShort(address + translate(offset), i16);
    return this;
  }

  @Override public NativeBytesStore<Underlying> writeInt(long offset, int i32) {
    MEMORY.writeInt(address + translate(offset), i32);
    return this;
  }

  @Override public NativeBytesStore<Underlying> writeOrderedInt(long offset, int i) {
    MEMORY.writeOrderedInt(address + translate(offset), i);
    return this;
  }

  @Override public NativeBytesStore<Underlying> writeLong(long offset, long i64) {
    MEMORY.writeLong(address + translate(offset), i64);
    return this;
  }

  @Override public NativeBytesStore<Underlying> writeOrderedLong(long offset, long i) {
    MEMORY.writeOrderedLong(address + translate(offset), i);
    return this;
  }

  @Override public NativeBytesStore<Underlying> writeFloat(long offset, float f) {
    MEMORY.writeFloat(address + translate(offset), f);
    return this;
  }

  @Override public NativeBytesStore<Underlying> writeDouble(long offset, double d) {
    MEMORY.writeDouble(address + translate(offset), d);
    return this;
  }

  @Override public NativeBytesStore<Underlying> write(long offsetInRDO, byte[] bytes, int offset, int length) {
    MEMORY.copyMemory(bytes, offset, address + translate(offsetInRDO), length);
    return this;
  }

  @Override public NativeBytesStore<Underlying> write(long offsetInRDO, ByteBuffer bytes, int offset, int length) {
    if (bytes.isDirect()) {
  ...
  @Override public NativeBytesStore<Underlying> write(long offsetInRDO, Bytes bytes, long offset, long length) {
    Access.copy(bytes.access(), bytes.accessHandle(), bytes.accessOffset(offset), access(), accessHandle(), accessOffset(offsetInRDO), length);
    return this;
  }
  ...
  @Override public Underlying accessHandle() {
    return null;
  }

  @Override public long accessOffset(long randomOffset) {
  ...
  @Override public void nativeRead(long position, long address, long size) {
