...
public class UncheckedBytes<U> extends AbstractBytes<U> {
    ...
    public UncheckedBytes(@NotNull
    Bytes underlyingBytes) throws IllegalStateException {
        super(requireNonNull(underlyingBytes.bytesStore()), underlyingBytes.writePosition(), Math.min(underlyingBytes.writeLimit(), underlyingBytes.realCapacity()));
    ...
    Bytes bytes) throws IllegalStateException {
    ...
    RandomDataInput bytes, long offset, long length) throws BufferOverflowException, IllegalArgumentException, IllegalStateException, BufferUnderflowException {
        requireNonNull(bytes);
        if (length == 8) {
    ...
    @Override
    public Bytes<U> write(@NotNull
    BytesStore bytes, long offset, long length) throws BufferOverflowException, IllegalArgumentException, IllegalStateException, BufferUnderflowException {
        requireNonNull(bytes);
        if (length == 8) {
            writeLong(bytes.readLong(offset));
    ...
    BytesStore bytes, long offset, long length) throws BufferOverflowException, IllegalStateException, BufferUnderflowException {
        requireNonNull(bytes);
    ...
    @NotNull
    @Override
    public Bytes<U> writeUtf8(@Nullable
    String text) throws BufferOverflowException, IllegalStateException {
        if (text == null) {
    ...
    void append8bit(@NotNull
    char[] chars) throws BufferOverflowException, IllegalArgumentException, IllegalStateException {
