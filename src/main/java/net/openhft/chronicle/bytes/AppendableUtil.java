...
@SuppressWarnings(value = { "rawtypes" }) public enum AppendableUtil {
  ...
  public static <C extends Appendable & CharSequence> void append(C a, CharSequence cs, long start, long len) throws ArithmeticException, BufferUnderflowException, IllegalStateException, BufferOverflowException {
  ...
  @Java9 public static long findUtf8Length(@NotNull byte[] bytes, byte coder) {
    long utflen;
    if (coder == 0) {
  ...
  @Java9 public static long findUtf8Length(@NotNull byte[] chars) {
    long utflen = 0;
