...
public abstract class AbstractBytes<U> extends AbstractReferenceCounted implements Bytes<U> {
    ...
    AbstractBytes(@NotNull
    BytesStore<Bytes<U>, U> bytesStore, long writePosition, long writeLimit) throws IllegalStateException {
        this(bytesStore, writePosition, writeLimit, "");
    }

    AbstractBytes(@NotNull
    BytesStore<Bytes<U>, U> bytesStore, long writePosition, long writeLimit, String name) throws IllegalStateException {
    ...
    public Bytes<U> compact() throws IllegalStateException {
        ...
        try {
            ...
            return this;
        } catch (BufferUnderflowException | java.lang.ArithmeticException e) {
    ...
    @NotNull
    @Override
    public Bytes<U> clearAndPad(long length) throws BufferOverflowException {
    ...
    @Override
    @NotNull
    public AbstractBytes<U> append(double d) throws BufferOverflowException, IllegalStateException {
        ...
        if (!fits) {
            fits = ((1.0E-6 <= ad) && (ad < 1.0E20)) && canWriteDirect(24);
        }
        if (fits) {
    ...
    @NotNull
    @Override
    public Bytes<U> readPosition(long position) throws BufferUnderflowException, IllegalStateException {
        if (position < start()) {
    ...
    @NotNull
    @Override
    public Bytes<U> readLimit(long limit) throws BufferUnderflowException {
        if (limit < start()) {
    ...
    @NotNull
    @Override
    public Bytes<U> writePosition(long position) throws BufferOverflowException {
    ...
    @NotNull
    @Override
    public Bytes<U> readSkip(long bytesToSkip) throws BufferUnderflowException, IllegalStateException {
        if (lenient) {
    ...
    @NotNull
    @Override
    public Bytes<U> writeSkip(long bytesToSkip) throws BufferOverflowException, IllegalStateException {
    ...
    @NotNull
    @Override
    public Bytes<U> writeLimit(long limit) throws BufferOverflowException {
        if (limit < start()) {
    ...
    public int uncheckedReadUnsignedByte() {
        try {
            ...
            readPosition++;
            return unsignedByte;
        } catch (BufferUnderflowException | java.lang.IllegalStateException e) {
            return -1;
        }
    }
    ...
    @NotNull
    @Override
    public Bytes<U> writeByte(long offset, byte i) throws BufferOverflowException, IllegalStateException {
    ...
    @NotNull
    @Override
    public Bytes<U> writeShort(long offset, short i) throws BufferOverflowException, IllegalStateException {
    ...
    @NotNull
    @Override
    public Bytes<U> writeInt(long offset, int i) throws BufferOverflowException, IllegalStateException {
        writeCheckOffset(offset, 4);
    ...
    @NotNull
    @Override
    public Bytes<U> writeOrderedInt(long offset, int i) throws BufferOverflowException, IllegalStateException {
        writeCheckOffset(offset, 4);
    ...
    @NotNull
    @Override
    public Bytes<U> writeLong(long offset, long i) throws BufferOverflowException, IllegalStateException {
        writeCheckOffset(offset, 8);
    ...
    @NotNull
    @Override
    public Bytes<U> writeOrderedLong(long offset, long i) throws BufferOverflowException, IllegalStateException {
        writeCheckOffset(offset, 8);
    ...
    @NotNull
    @Override
    public Bytes<U> writeFloat(long offset, float d) throws BufferOverflowException, IllegalStateException {
        writeCheckOffset(offset, 4);
    ...
    @NotNull
    @Override
    public Bytes<U> writeDouble(long offset, double d) throws BufferOverflowException, IllegalStateException {
        writeCheckOffset(offset, 8);
    ...
    @NotNull
    @Override
    public Bytes<U> writeVolatileByte(long offset, byte i8) throws BufferOverflowException, IllegalStateException {
        writeCheckOffset(offset, 1);
    ...
    @NotNull
    @Override
    public Bytes<U> writeVolatileShort(long offset, short i16) throws BufferOverflowException, IllegalStateException {
        writeCheckOffset(offset, 2);
    ...
    @NotNull
    @Override
    public Bytes<U> writeVolatileInt(long offset, int i32) throws BufferOverflowException, IllegalStateException {
        writeCheckOffset(offset, 4);
    ...
    @NotNull
    @Override
    public Bytes<U> writeVolatileLong(long offset, long i64) throws BufferOverflowException, IllegalStateException {
        writeCheckOffset(offset, 8);
    ...
    @Override
    @NotNull
    public Bytes<U> write(@NotNull
    final RandomDataInput bytes) throws IllegalStateException, BufferOverflowException {
        assert bytes != this : "you should not write to yourself !";
        try {
            return write(bytes, bytes.readPosition(), Math.min(writeLimit() - writePosition(), bytes.readRemaining()));
        } catch (BufferUnderflowException | java.lang.IllegalArgumentException e) {
            throw new AssertionError(e);
        }
    }
    ...
    @Override
    @NotNull
    public Bytes<U> write(long offsetInRDO, @NotNull
    byte[] bytes, int offset, int length) throws BufferOverflowException, IllegalStateException {
        requireNonNull(bytes);
        long remaining = length;
        while (remaining > 0) {
            // copy 64 KB at a time.
    ...
    @Override
    public void write(long offsetInRDO, @NotNull
    ByteBuffer bytes, int offset, int length) throws BufferOverflowException, IllegalStateException {
        requireNonNull(bytes);
    ...
    @Override
    @NotNull
    public Bytes<U> write(long writeOffset, @NotNull
    RandomDataInput bytes, long readOffset, long length) throws BufferOverflowException, BufferUnderflowException, IllegalStateException {
        requireNonNull(bytes);
        long remaining = length;
        while (remaining > 0) {
            // copy 64 KB at a time.
    ...
    @Override
    @NotNull
    public Bytes<U> write8bit(@NotNull
    String text, int start, int length) throws BufferOverflowException, IndexOutOfBoundsException, ArithmeticException, IllegalStateException, BufferUnderflowException {
    ...
    @NotNull
    public Bytes<U> write8bit(@Nullable
    BytesStore bs) throws BufferOverflowException, IllegalStateException, BufferUnderflowException {
        if (bs == null) {
    ...
    @Override
    public long write8bit(long position, @NotNull
    BytesStore bs) {
    ...
    @NotNull
    @Override
    public Bytes<U> prewrite(@NotNull
    byte[] bytes) throws BufferOverflowException, IllegalStateException {
    ...
    @Override
    public Bytes<U> prewrite(@NotNull
    BytesStore bytes) throws BufferOverflowException, IllegalStateException {
    ...
    @NotNull
    @Override
    public Bytes<U> prewriteByte(byte i8) throws BufferOverflowException, IllegalStateException {
    ...
    @NotNull
    @Override
    public Bytes<U> prewriteInt(int i) throws BufferOverflowException, IllegalStateException {
    ...
    @NotNull
    @Override
    public Bytes<U> prewriteShort(short i) throws BufferOverflowException, IllegalStateException {
    ...
    @NotNull
    @Override
    public Bytes<U> prewriteLong(long l) throws BufferOverflowException, IllegalStateException {
    ...
    @NotNull
    @Override
    public Bytes<U> writeShort(short i16) throws BufferOverflowException, IllegalStateException {
    ...
    @NotNull
    @Override
    public Bytes<U> writeIntAdv(int i, int advance) throws BufferOverflowException, IllegalStateException {
    ...
    @NotNull
    @Override
    public Bytes<U> writeLongAdv(long i64, int advance) throws BufferOverflowException, IllegalStateException {
    ...
    @NotNull
    @Override
    public Bytes<U> writeDoubleAndInt(double d, int i) throws BufferOverflowException, IllegalStateException {
    ...
    byte[] bytes, int off, int len) throws BufferUnderflowException, IllegalStateException {
        requireNonNull(bytes);
    ...
    @Override
    public Bytes<U> write(@NotNull
    byte[] bytes, int offset, int length) throws BufferOverflowException, IllegalStateException, IllegalArgumentException {
    ...
    @NotNull
    @Override
    public Bytes<U> writeSome(@NotNull
    ByteBuffer buffer) throws BufferOverflowException, IllegalStateException, BufferUnderflowException {
    ...
    @NotNull
    @Override
    public Bytes<U> writeOrderedInt(int i) throws BufferOverflowException, IllegalStateException {
        long offset = writeOffsetPositionMoved(4);
        bytesStore.writeOrderedInt(offset, i);
        return this;
    }
    ...
    @NotNull
    @Override
    public Bytes<U> writeOrderedLong(long i) throws BufferOverflowException, IllegalStateException {
        long offset = writeOffsetPositionMoved(8);
        bytesStore.writeOrderedLong(offset, i);
        return this;
    }
