...
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public class NativeBytes<Underlying extends java.lang.Object> extends VanillaBytes<Underlying> {
  ...
  @Override protected void bytesStore(@NotNull BytesStore<Bytes<Underlying>, Underlying> bytesStore) {
  ...
  @Override public void bytesStore(@NotNull BytesStore<Bytes<Underlying>, Underlying> byteStore, long offset, long length) throws IllegalStateException, IllegalArgumentException, BufferUnderflowException {
  ...
  @Deprecated public static final class NativeSubBytes extends SubBytes {
