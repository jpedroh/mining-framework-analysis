 ...
 */
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public class NativeBytes<U extends java.lang.Object> extends VanillaBytes<U> {
  ...
  @Override protected void bytesStore(@NotNull BytesStore<Bytes<U>, U> bytesStore) {
  ...
  @Override public void bytesStore(@NotNull BytesStore<Bytes<U>, U> byteStore, long offset, long length) throws IllegalStateException, IllegalArgumentException, BufferUnderflowException {
  ...
  @NotNull @Override public Bytes<U> writeByte(final byte i8) throws BufferOverflowException, IllegalStateException {
    final long offset = writeOffsetPositionMoved(1, 1);
    bytesStore.writeByte(offset, i8);
    return this;
  }

  @NotNull @Override public Bytes<U> writeLong(final long i64) throws BufferOverflowException, IllegalStateException {
