 ...
 */
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public class NativeBytes<Underlying extends java.lang.Object> extends VanillaBytes<Underlying> {
  ...
  public NativeBytes(@NotNull final BytesStore store, final long capacity) throws IllegalStateException, IllegalArgumentException {
    super(store, 0, capacity);
    this.capacity = capacity;
  }

  public NativeBytes(@NotNull final BytesStore store) throws IllegalStateException, IllegalArgumentException {
  ...
  @NotNull public static NativeBytes<Void> nativeBytes(final long initialCapacity) throws IllegalArgumentException {
  ...
  public static BytesStore<Bytes<Void>, Void> copyOf(@NotNull final Bytes bytes) throws IllegalStateException {
  ...
  @NotNull public static <T extends java.lang.Object> NativeBytes<T> wrapWithNativeBytes(@NotNull final BytesStore<?, T> bs, long capacity) throws IllegalStateException, IllegalArgumentException {
    return s_newGuarded ? new GuardedNativeBytes(bs, capacity) : new NativeBytes<>(bs, capacity);
  }

  protected static <T extends java.lang.Object> long maxCapacityFor(@NotNull BytesStore<?, T> bs) {
    return bs.underlyingObject() instanceof ByteBuffer || bs.underlyingObject() instanceof byte[] ? MAX_HEAP_CAPACITY : Bytes.MAX_CAPACITY;
  }
  ...
  @Override void prewriteCheckOffset(long offset, long subtracting) throws BufferOverflowException, IllegalStateException {
  ...
  @Override public void ensureCapacity(final long size) throws IllegalArgumentException, IllegalStateException {
    try {
      assert size >= 0;
  ...
  @NotNull private BytesStore allocateNewByteBufferBackedStore(final int size) {
    if (isDirectMemory()) {
  ...
  @NotNull @Override public Bytes<Underlying> write(@NotNull final byte[] bytes, final int offset, final int length) throws BufferOverflowException, IllegalArgumentException, IllegalStateException {
  ...
  @NotNull public Bytes<Underlying> write(@NotNull final BytesStore bytes, final long offset, final long length) throws BufferOverflowException, BufferUnderflowException, IllegalStateException, IllegalArgumentException {
    ensureCapacity(length);
    super.write(bytes, offset, length);
    return this;
  }

  @Override @NotNull public NativeBytes writeSome(@NotNull final Bytes bytes) throws IllegalStateException {
    ReportUnoptimised.reportOnce();
    try {
  ...
  @Override protected long writeOffsetPositionMoved(final long adding, final long advance) throws BufferOverflowException, IllegalStateException {
  ...
  @NotNull @Override public Bytes<Underlying> writeByte(final byte i8) throws BufferOverflowException, IllegalStateException {
    final long offset = writeOffsetPositionMoved(1, 1);
    bytesStore.writeByte(offset, i8);
    return this;
  }

  @NotNull @Override public Bytes<Underlying> writeLong(final long i64) throws BufferOverflowException, IllegalStateException {
  ...
  @Deprecated public final static class NativeSubBytes extends SubBytes {
    private final NativeBytesStore nativeBytesStore;

    public NativeSubBytes(@NotNull final BytesStore bytesStore, final long start, final long capacity) throws IllegalStateException, BufferUnderflowException, IllegalArgumentException {
      super(bytesStore, start, capacity);
      nativeBytesStore = (NativeBytesStore) this.bytesStore;
    }

    @Override public long read(final long offsetInRDI, @NotNull final byte[] bytes, final int offset, final int length) {
