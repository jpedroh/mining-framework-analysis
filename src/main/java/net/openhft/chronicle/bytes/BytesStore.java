 ...
 */
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public interface BytesStore<B extends BytesStore<B, Underlying>, Underlying extends java.lang.Object> extends RandomDataInput, RandomDataOutput<B>, ReferenceCounted, CharSequence {
  /**
     ...
     */
  static BytesStore from(@NotNull CharSequence cs) throws IllegalStateException {
  ...
  /**
     ...
     */
  static BytesStore from(@NotNull BytesStore cs) throws IllegalStateException {
    return cs.copy();
  }
  ...
  static <T extends java.lang.Object> BytesStore<?, T> forFields(Object o, String groupName, int padding) {
  ...
  /**
     ...
     * @return BytesStore
     */
  @NotNull static BytesStore<?, ByteBuffer> wrap(@NotNull ByteBuffer bb) {
  ...
  /**
     ...
     */
  @NotNull static PointerBytesStore nativePointer() {
  ...
  /**
     ...
     */
  @Override boolean isDirectMemory();
  ...
  /**
     ...
     */
  @Override @NotNull default Bytes<Underlying> bytesForRead() throws IllegalStateException {
    try {
  ...
  /**
     ...
     */
  @Override @NotNull default Bytes<Underlying> bytesForWrite() throws IllegalStateException {
    try {
  ...
  /**
     ...
     */
  default void copyTo(@NotNull OutputStream out) throws IOException, IllegalStateException {
  ...
  /**
     ...
     * @return this
     */
  @Override @NotNull default B zeroOut(long start, long end) throws IllegalStateException {
    if (end <= start) {
      return (B) this;
    }
    if (start < start()) {
  ...
  /**
     ...
     */
  @Override default char charAt(int index) throws IndexOutOfBoundsException {
    try {
  ...
  /**
     * Not supported.
     */
  @NotNull @Override default CharSequence subSequence(int start, int end) {
  ...
  /**
     ...
     */
  @NotNull default String toDebugString() throws IllegalStateException {
    try {
  ...
  /**
     ...
     * @return this BytesStore as a DebugString.
     */
  @NotNull default String toDebugString(long maxLength) throws IllegalStateException, ArithmeticException {
  ...
  /**
     ...
     */
  @Nullable default BytesStore bytesStore() {
    return this;
  }
  ...
  /**
     ...
     */
  default boolean equalBytes(@NotNull BytesStore bytesStore, long length) throws BufferUnderflowException, IllegalStateException {
  ...
  /**
     ...
     */
  default int byteCheckSum() throws IORuntimeException, BufferUnderflowException, IllegalStateException {
    try {
  ...
  /**
     ...
     * @throws IllegalStateException if this BytesStore has been released
     */
  default boolean contentEquals(@Nullable BytesStore bytesStore) throws IllegalStateException {
  ...
  /**
     ...
     * @throws IllegalStateException if this BytesStore has been released
     */
  default boolean startsWith(@Nullable BytesStore bytesStore) throws IllegalStateException {
  ...
  /**
     ...
     */
  @NotNull default String to8bitString() {
