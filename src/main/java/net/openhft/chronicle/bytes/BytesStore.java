 ...
 */
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public interface BytesStore<B extends BytesStore<B, U>, U extends java.lang.Object> extends RandomDataInput, RandomDataOutput<B>, ReferenceCounted, CharSequence {
  /**
  ...
  /**
     ...
     */
  @Override @NotNull default Bytes<U> bytesForRead() throws IllegalStateException {
    try {
  ...
  /**
     ...
     */
  @Override @NotNull default Bytes<U> bytesForWrite() throws IllegalStateException {
    try {
