...
public class VanillaEventLoop implements EventLoop, Runnable {
  ...
  @NotNull private final ExecutorService service;
  ...
  @NotNull private volatile AtomicBoolean running = new AtomicBoolean();

  @Nullable private volatile Thread thread = null;

  @Nullable private volatile Throwable closedHere = null;
  ...
  @HotMethod private boolean runAllHighHandlers() {
    boolean busy = false;
  ...
  @HotMethod private boolean runOneTenthLowHandler(int i) {
    boolean busy = false;
  ...
  @HotMethod private boolean runAllLowHandler() {
    boolean busy = false;
  ...
  @HotMethod private void runTimerHandlers() {
  ...
  @HotMethod private void runDaemonHandlers() {
  ...
  @HotMethod private boolean acceptNewHandlers() {
    boolean busy = false;
