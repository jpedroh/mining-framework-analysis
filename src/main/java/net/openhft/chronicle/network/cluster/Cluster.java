...
abstract public class Cluster<E extends HostDetails, C extends ClusterContext> implements Marshallable, Closeable {
  @NotNull public protected final Map<String, E> hostDetails;

  private final String clusterName;

  @Nullable private C clusterContext;
  ...
  @Nullable public E findHostDetails(int id) {
  ...
  @NotNull abstract protected E newHostDetails();
  ...
  @NotNull public Collection<E> hostDetails() {
