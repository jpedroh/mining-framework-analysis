...
public class AlwaysStartOnPrimaryConnectionStrategy extends SelfDescribingMarshallable implements ConnectionStrategy {
  ...
  @Override public ClientConnectionMonitor clientConnectionMonitor() {
    return clientConnectionMonitor;
  }

  @Nullable @Override public ChronicleSocketChannel connect(@NotNull String name, @NotNull SocketAddressSupplier socketAddressSupplier, boolean didLogIn, @Nullable FatalFailureMonitor fatalFailureMonitor) throws InterruptedException {
  ...
  @Override public long pauseMillisBeforeReconnect() {
