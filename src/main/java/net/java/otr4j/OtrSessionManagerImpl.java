...
public class OtrSessionManagerImpl implements OtrSessionManager {
  ...
  @Override public Session getSession(SessionID sessionID) {
  ...
  @Override public void addOtrEngineListener(OtrEngineListener l) {
  ...
  @Override public void removeOtrEngineListener(OtrEngineListener l) {
    synchronized (listeners) {
      listeners.remove(l);
    }
  }
