...
public class SessionImpl implements Session {
  ...
  private void handleQueryMessage(QueryMessage queryMessage) throws OtrException {
    logger.finest(getSessionID().getAccountID() + " received a query message from " + getSessionID().getUserID() + " through " + getSessionID().getProtocolName() + ".");
    OtrPolicy policy = getSessionPolicy();
  ...
  private void handleErrorMessage(ErrorMessage errorMessage) throws OtrException {
    logger.finest(getSessionID().getAccountID() + " received an error message from " + getSessionID().getUserID() + " through " + getSessionID().getUserID() + ".");
  ...
  private String handlePlainTextMessage(PlainTextMessage plainTextMessage) throws OtrException {
    logger.finest(getSessionID().getAccountID() + " received a plaintext message from " + getSessionID().getUserID() + " through " + getSessionID().getProtocolName() + ".");
    OtrPolicy policy = getSessionPolicy();
  ...
  public String transformSending(String msgText, List<TLV> tlvs) throws OtrException {
    ...
    switch (this.getSessionStatus()) {
      ...
      case ENCRYPTED:
      logger.finest(getSessionID().getAccountID() + " sends an encrypted message to " + getSessionID().getUserID() + " through " + getSessionID().getProtocolName() + ".");
