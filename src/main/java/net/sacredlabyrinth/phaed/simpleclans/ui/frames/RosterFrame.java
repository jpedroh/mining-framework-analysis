...
public class RosterFrame extends SCFrame {
  ...
  @SuppressWarnings(value = { "deprecation" }) @Override public void createComponents() {
    ...
    SCComponent invite = new SCComponentImpl(lang("gui.roster.invite.title"), Collections.singletonList(lang("gui.roster.invite.lore")), Material.WOOL, DyeColor.LIME.getWoolData(), 4);
