...
public class ClanListFrame extends SCFrame {
  ...
  @Override public void createComponents() {
    ...
    for (int i = paginator.getMinIndex(); paginator.isValidIndex(i); i++) {
      ...
      SCComponent c = new SCComponentImpl(lang("gui.clanlist.clan.title", clan.getColorTag(), clan.getName()), Arrays.asList(lang("gui.clanlist.clan.lore.position", i + 1), lang("gui.clanlist.clan.lore.kdr", Helper.formatKDR(clan.getTotalKDR())), lang("gui.clanlist.clan.lore.members", clan.getMembers().size())), Material.BANNER, slot);
