...
>>>>>>> /usr/src/app/output/ab0oo/javaprslib/a929486b0e7bf006bd2a192329a16f2b15ab95f1/src/main/java/net/ab0oo/aprs/parser/PositionParser.java/right.java
  ...
  public static DataExtension parseUncompressedExtension(byte[] msgBody, int cursor) throws Exception {
    ...
    if ((char) msgBody[19 + cursor] == 'P' && (char) msgBody[20 + cursor] == 'H' && (char) msgBody[21 + cursor] == 'G') {
      ...
      if ((char) msgBody[22 + cursor] == '/' && (char) msgBody[18 + cursor] != '_') {
  ...
  public static Position parseNMEA(byte[] msgBody) throws Exception {
    ...
    if ("$GPGGA".equals(nmea[0]) && nmea.length >= 15) {
      ...
      if ("$GPGLL".equals(nmea[0]) && nmea.length > 7) {
        ...
        if ("$GPRMC".equals(nmea[0]) && nmea.length > 11) {
          if (!nmea[2].equals("A")) {
            throw new UnparsablePositionException("Not valid or not autonomous NMEA sentence");
          }
          lats = nmea[3];
          ...
          if ("$GPWPL".equals(nmea[0]) && nmea.length > 5) {
            lats = nmea[1];
            lath = nmea[2];
            lngs = nmea[3];
            lngh = nmea[4];
          } else {
            if (nmea.length > 15 && "$PNTS".equals(nmea[0]) && "1".equals(nmea[1])) {
              lats = nmea[7];
              lath = nmea[8];
              lngs = nmea[9];
              lngh = nmea[10];
            } else {
              if ("$GPGSA".equals(nmea[0]) || "$GPVTG".equals(nmea[0]) || "$GPGSV".equals(nmea[0])) {
    ...
    try {
      ...
      if (lath.equals("S") || lath.equals("s")) {
        ...
        if (!(lath.equals("N") || lath.equals("n"))) {
      ...
      if (lngh.equals("W") || lngh.equals("w")) {
        ...
        if (!(lngh.equals("E") || lngh.equals("e"))) {
