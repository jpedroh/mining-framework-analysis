...
public class JiraClient {
  ...
  /**
     ...
     * @throws JiraException when something goes wrong
     */
  public Issue.FluentCreateComposed createIssues(JSONObject createmeta, String project, String issueType) throws JiraException {
  ...
  public Issue.SearchResult searchIssues(String jql, String includedFields, String expandFields, Integer maxResults, Integer startAt) throws JiraException {
    return Issue.search(restclient, jql, includedFields, expandFields, maxResults, startAt);
  }
