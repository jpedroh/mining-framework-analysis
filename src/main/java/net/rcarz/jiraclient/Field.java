...
public final class Field {
  ...
  /**
     ...
     */
  public static <TK extends Object, TV extends Object> Map<TK, TV> getMap(Class<TK> keytype, Class<TV> valtype, Object m) {
...
<<<<<<< /usr/src/app/output/rcarz/jira-client/be8dbec2182fd36a2afc51af33aefef33f7fddba/src/main/java/net/rcarz/jiraclient/Field.java/left.java
            {
...
>>>>>>> /usr/src/app/output/rcarz/jira-client/be8dbec2182fd36a2afc51af33aefef33f7fddba/src/main/java/net/rcarz/jiraclient/Field.java/right.java

          }
          SimpleDateFormat df = new SimpleDateFormat(DATETIME_FORMAT);
          return df.format(value);
        } else {
          if (m.type.equals("issuetype") || m.type.equals("priority") || m.type.equals("user") || m.type.equals("resolution")) {
