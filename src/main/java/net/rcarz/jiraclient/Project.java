 ...
 */
@Getter public class Project extends Resource {
  ...
  private void deserialise(JSONObject json) {
    ...
    issueTypes = Field.getResourceArray(IssueType.class, map.containsKey("issueTypes") ? map.get("issueTypes") : map.get("issuetypes"), restclient);
