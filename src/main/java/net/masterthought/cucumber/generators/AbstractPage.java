...
public abstract class AbstractPage {
  ...
  private void generateReport() {
    ...
    File reportFile = new File(configuration.getReportDirectory(), ReportBuilder.BASE_DIRECTORY + configuration.getDirectoryQualifier() + File.separatorChar + getWebPage());
  ...
  private void buildGeneralParameters() {
    ...
    if (StringUtils.isNotBlank(buildNumber) && configuration.containsPresentationMode(PresentationMode.RUN_WITH_JENKINS)) {
