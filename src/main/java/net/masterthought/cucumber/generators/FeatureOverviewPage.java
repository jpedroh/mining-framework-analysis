...
public class FeatureOverviewPage extends AbstractPage {
    ...
    public void generatePage() throws IOException {
        ...
        if (reportBuilder.isFlashCharts()) {
            contextMap.put("step_data", FlashChartBuilder.getStepsChart(reportInformation.getTotalStepsPassed(), reportInformation.getTotalStepsFailed(), reportInformation.getTotalStepsSkipped(), reportInformation.getTotalStepsPending(), reportInformation.getTotalStepsUndefined(), reportInformation.getTotalStepsMissing()));
            contextMap.put("scenario_data", FlashChartBuilder.pieScenariosChart(reportInformation.getTotalScenariosPassed(), reportInformation.getTotalScenariosFailed()));
        } else {
            JsChartUtil pie = new JsChartUtil();
            List<String> stepColours = pie.orderStepsByValue(reportInformation.getTotalStepsPassed(), reportInformation.getTotalStepsFailed(), reportInformation.getTotalStepsSkipped(), reportInformation.getTotalStepsPending(), reportInformation.getTotalStepsUndefined(), reportInformation.getTotalStepsMissing());
