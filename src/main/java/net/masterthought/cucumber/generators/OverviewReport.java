...
public class OverviewReport implements Reportable {
  ...
  @Override public int getPendingFeatures() {
    return featuresCounter.getValueFor(Status.PENDING);
  }

  @Override public int getUndefinedFeatures() {
    return featuresCounter.getValueFor(Status.UNDEFINED);
  }
  ...
  @Override public int getPendingScenarios() {
    return scenariosCounter.getValueFor(Status.PENDING);
  }

  @Override public int getUndefinedScenarios() {
    return scenariosCounter.getValueFor(Status.UNDEFINED);
  }
