...
>>>>>>> /usr/src/app/output/helpscout/helpscout-api-java/f606dc7048e32d8953594011ce7a80f8f325a5eb/src/main/java/net/helpscout/api/ApiClient.java/right.java
  ...
  public void updateConversation(Conversation conversation) throws ApiException {
    GsonBuilder builder = new GsonBuilder().setDateFormat("yyyy-MM-dd\'T\'HH:mm:ss\'Z\'").registerTypeAdapter(ThreadState.class, new ThreadStateAdapter()).registerTypeAdapter(Status.class, new StatusAdapter());
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  private <T extends java.lang.Object> ArrayList<T> getPageItems(JsonElement elem, Class<T> clazzType) {
