...
public final class Parser {
  ...
  public <T extends java.lang.Object> T getObject(String json, Class<T> clazzType) {
    JsonElement obj = new JsonParser().parse(json);
    return getObject(obj, clazzType);
  }

  public <T extends java.lang.Object> T getObject(JsonElement item, Class<T> clazzType) {
