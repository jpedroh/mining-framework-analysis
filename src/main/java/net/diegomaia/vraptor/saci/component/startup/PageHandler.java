...
@Component @ApplicationScoped public class PageHandler implements StereotypeHandler {
  ...
  @Override public void handle(Class<?> type) {
  ...
  @Override public Class<? extends Annotation> stereotype() {
