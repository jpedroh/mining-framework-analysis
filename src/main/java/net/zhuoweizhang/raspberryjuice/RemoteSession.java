  ...
  public void tick() {
    ...
    while ((message = inQueue.poll()) != null) {
      ...
      if (processedCount >= maxCommandsPerTick) {
        plugin.getLogger().warning("Over " + maxCommandsPerTick + " commands were queued - deferring " + inQueue.size() + " to next tick");
        break;
      }
    }
                            ...
                            if (c.equals("events.chat.posts")) {
                              ...
                              if (c.equals("player.getTile")) {
                                ...
                                if (c.equals("player.setTile")) {
                                  ...
                                  if (c.equals("player.getAbsPos")) {
                                    Player currentPlayer = getCurrentPlayer();
                                    send(currentPlayer.getLocation());
                                  } else {
                                    if (c.equals("player.setAbsPos")) {
                                      String x = args[0], y = args[1], z = args[2];
                                      Player currentPlayer = getCurrentPlayer();
                                      Location loc = currentPlayer.getLocation();
                                      ...
                                      if (c.equals("player.getPos")) {
                                        ...
                                        if (c.equals("player.setPos")) {
                                          ...
                                          if (c.equals("player.setDirection")) {
                                            ...
                                            if (c.equals("player.getDirection")) {
                                              ...
                                              if (c.equals("player.setRotation")) {
                                                          ...
                                                          if (c.equals("entity.setTile")) {
                                                            ...
                                                            if (c.equals("entity.getPos")) {
                                                              ...
                                                              if (c.equals("entity.setPos")) {
                                                                ...
                                                                if (c.equals("entity.setDirection")) {
                                                                  Entity entity = plugin.getEntity(Integer.parseInt(args[0]));
                                                                  if (entity != null) {
...
<<<<<<< /usr/src/app/output/zhuowei/raspberryjuice/76a3a9c87ac04df000a2a779e9e471f67649d902/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/left.java
                                                                    for (int i = 5; i - 5 < 4 && i < args.length; i++) {
                                                                      sign.setLine(i - 5, unescape(args[i]));
                                                                    }
=======
                                                                    loc.setDirection(new Vector(x, y, z));
>>>>>>> /usr/src/app/output/zhuowei/raspberryjuice/76a3a9c87ac04df000a2a779e9e471f67649d902/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/right.java
...
>>>>>>> /usr/src/app/output/zhuowei/raspberryjuice/76a3a9c87ac04df000a2a779e9e471f67649d902/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/right.java
                                                                    ...
                                                                    BlockState 
<<<<<<< /usr/src/app/output/zhuowei/raspberryjuice/76a3a9c87ac04df000a2a779e9e471f67649d902/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/left.java
                                                                    thisBlockState = thisBlock.getState()
=======
                                                                    entity = plugin.getEntity(Integer.parseInt(args[0]))
>>>>>>> /usr/src/app/output/zhuowei/raspberryjuice/76a3a9c87ac04df000a2a779e9e471f67649d902/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/right.java
                                                                    ;
...
>>>>>>> /usr/src/app/output/zhuowei/raspberryjuice/76a3a9c87ac04df000a2a779e9e471f67649d902/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/right.java
                                                                      .
<<<<<<< /usr/src/app/output/zhuowei/raspberryjuice/76a3a9c87ac04df000a2a779e9e471f67649d902/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/left.java
                                                                      spawnEntity(loc, EntityType.fromId(Integer.parseInt(args[3])))
=======
                                                                      getEntity(Integer.parseInt(args[0]))
>>>>>>> /usr/src/app/output/zhuowei/raspberryjuice/76a3a9c87ac04df000a2a779e9e471f67649d902/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/right.java
                                                                      ;
...
<<<<<<< /usr/src/app/output/zhuowei/raspberryjuice/76a3a9c87ac04df000a2a779e9e471f67649d902/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/left.java
                                                                        s = PythonModuleGenerator.pyEntity()
=======
                                                                        entity = plugin.getEntity(Integer.parseInt(args[0]))
>>>>>>> /usr/src/app/output/zhuowei/raspberryjuice/76a3a9c87ac04df000a2a779e9e471f67649d902/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/right.java
                                                                        ;
...
>>>>>>> /usr/src/app/output/zhuowei/raspberryjuice/76a3a9c87ac04df000a2a779e9e471f67649d902/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/right.java
  ...
  public ItemStack createBookFromJson(String json) {
    ...
    if (craftMetaBookField != null) {
      try {
        @SuppressWarnings(value = { "unchecked" }) List<Object> lo = (List<Object>) craftMetaBookField.get(meta);
        pages = lo;
