                                      ...
                                      if (c.equals("player.getPos")) {
                                        ...
                                        if (c.equals("player.setPos")) {
                                          ...
                                          if (c.equals("player.getDirection")) {
                                            ...
                                            send(
<<<<<<< /usr/src/app/output/zhuowei/raspberryjuice/8c537ab867b5f88945fb3985e05598c96efa70a8/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/left.java
                                            yaw
=======
                                            currentPlayer.getLocation().getDirection().toString()
>>>>>>> /usr/src/app/output/zhuowei/raspberryjuice/8c537ab867b5f88945fb3985e05598c96efa70a8/src/main/java/net/zhuoweizhang/raspberryjuice/RemoteSession.java/right.java
                                            );
                                          } else {
                                                    ...
                                                    if (c.equals("entity.setTile")) {
                                                      ...
                                                      if (c.equals("entity.getPos")) {
                                                        ...
                                                        if (c.equals("entity.setPos")) {
                                                          ...
                                                          if (c.equals("entity.getDirection")) {
                                                            Entity entity = plugin.getEntity(Integer.parseInt(args[0]));
                                                            if (entity != null) {
                                                            ...
                                                            if (c.equals("entity.getRotation")) {
                                                              Entity entity = plugin.getEntity(Integer.parseInt(args[0]));
                                                              if (entity != null) {
                                                              ...
                                                              if (c.equals("entity.getPitch")) {
                                                                ...
                                                                if (c.equals("world.setSign")) {
                                                                  ...
                                                                  if (c.equals("world.spawnEntity")) {
                                                                    ...
                                                                    if (c.equals("generatePythonModules")) {
