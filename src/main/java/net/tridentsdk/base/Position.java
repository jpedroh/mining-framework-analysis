 ...
 * @since 0.3-alpha-DP
 */
@ThreadSafe public final class Position extends AbstractVector<Position> implements Cloneable {
  ...
  @Override protected void writeFields(Position vector) {
  ...
  @Override public boolean equals(Object obj) {
    if (obj instanceof Position) {
      ...
      synchronized (this.lock) {
        return eq(this.x, v.x) && eq(this.y, v.y) && eq(this.z, v.z) && this.world.equals(v.world) && eq(this.pitch, v.pitch) && eq(this.yaw, v.yaw);
      }
    }
    return false;
  }
...
<<<<<<< /usr/src/app/output/projectblueshift/blueshiftapi/b53a148ca59225dcbceb1fc65321f98a0c5c13f9/src/main/java/net/tridentsdk/base/Position.java/left.java
    synchronized (this.lock) {
      return String.format("Position{%s-%f,%f,%f-pitch=%f,yaw=%f}", this.world.name(), this.x, this.y, this.z, this.pitch, this.yaw);
    }
=======
    return String.format("Position{%s-%f,%f,%f-pitch=%f,yaw=%f}", this.world.getName(), this.x, this.y, this.z, this.pitch, this.yaw);
>>>>>>> /usr/src/app/output/projectblueshift/blueshiftapi/b53a148ca59225dcbceb1fc65321f98a0c5c13f9/src/main/java/net/tridentsdk/base/Position.java/right.java
  }
