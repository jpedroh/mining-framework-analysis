 ...
 * @since 0.5-alpha
 */
@ThreadSafe @Internal(value = "public access for convenience only") public class AbstractVector<T extends AbstractVector<T>> implements Serializable {
  ...
  /**
     ...
     */
  @GuardedBy(value = "lock") protected double x;

  @GuardedBy(value = "lock") protected double y;

  @GuardedBy(value = "lock") protected double z;
  ...
  /**
     ...
     */
  @Internal @Policy(value = "GuardedBy this.lock") private void addImpl(double x, double y, double z) {
    this.x += x;
    this.y += y;
    this.z += z;
  }
  ...
  @Internal @Policy(value = "GuardedBy this.lock") private void subImpl(double x, double y, double z) {
    this.x -= x;
    this.y -= y;
    this.z -= z;
  }
  ...
  @Internal @Policy(value = "GuardedBy this.lock") private void mulImpl(double x, double y, double z) {
    this.x *= x;
    this.y *= y;
    this.z *= z;
  }
  ...
  @Internal @Policy(value = "GuardedBy this.lock") private void divImpl(double x, double y, double z) {
    this.x /= x;
    this.y /= y;
    this.z /= z;
  }
