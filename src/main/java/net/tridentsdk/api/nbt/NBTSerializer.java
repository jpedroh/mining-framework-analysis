...
public final class NBTSerializer {
  ...
  public static <T extends java.lang.Object> T deserialize(Class<T> clzz, CompoundTag tag) {
  ...
  public static <T extends java.lang.Object> T deserialize(T instance, CompoundTag tag) {
  ...
  public static CompoundTag serialize(NBTSerializable serializable, String name) {
    ...
    CompoundTagBuilder<NBTBuilder> builder = TridentFactory.createNbtBuilder(name);
