 ...
 * @since 0.5-alpha
 */
@NotThreadSafe @Accessors(chain = true) @NoArgsConstructor @AllArgsConstructor(access = AccessLevel.PRIVATE) public class ChatComponent {
  /**
  ...
  /**
     ...
     */
  @Getter @Setter private String translate;

  /**
     * The chat selector
     */
  @Getter @Setter private String selector;

  /**
     * The insertion modifier for the chat message
     */
  @Getter @Setter private String insertion;

  /**
     * The scoreboard username
     */
  @Getter @Setter private String scoreUsername;

  /**
     * The scoreboard objective
     */
  @Getter @Setter private String scoreObjective;
  ...
  /**
     ...
     */
  private final List<ChatComponent> with = Lists.
<<<<<<< /usr/src/app/output/projectblueshift/blueshiftapi/589b367cf283a6b348e415d065f59983f884b95c/src/main/java/net/tridentsdk/chat/ChatComponent.java/left.java
  newLinkedList()
=======
  newArrayList()
>>>>>>> /usr/src/app/output/projectblueshift/blueshiftapi/589b367cf283a6b348e415d065f59983f884b95c/src/main/java/net/tridentsdk/chat/ChatComponent.java/right.java
  ;

  /**
     * The list of chat components added to the 'extra' array.
     */
  private final List<ChatComponent> extra = Lists.
<<<<<<< /usr/src/app/output/projectblueshift/blueshiftapi/589b367cf283a6b348e415d065f59983f884b95c/src/main/java/net/tridentsdk/chat/ChatComponent.java/left.java
  newLinkedList()
=======
  newArrayList()
>>>>>>> /usr/src/app/output/projectblueshift/blueshiftapi/589b367cf283a6b348e415d065f59983f884b95c/src/main/java/net/tridentsdk/chat/ChatComponent.java/right.java
  ...
  @Getter @AllArgsConstructor private final class StringChatComponent extends ChatComponent {
    private String string;

    @Override public JsonElement asJson() {
