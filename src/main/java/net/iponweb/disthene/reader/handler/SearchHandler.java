 ...
 */
@SuppressWarnings(value = { "UnstableApiUsage" }) public class SearchHandler implements DistheneReaderHandler {
  ...
  @Override public FullHttpResponse handle(HttpRequest request) throws ParameterParsingException, IOException, TooMuchDataExpectedException {
    ...
    timer.
<<<<<<< /usr/src/app/output/einsamhauer/disthene-reader/8d8c28bd2a9238ebbc6ff483aa18b2632e27806b/src/main/java/net/iponweb/disthene/reader/handler/SearchHandler.java/left.java
    headers().set(HttpHeaderNames.CONTENT_TYPE, "text/plain")
=======
    stop()
>>>>>>> /usr/src/app/output/einsamhauer/disthene-reader/8d8c28bd2a9238ebbc6ff483aa18b2632e27806b/src/main/java/net/iponweb/disthene/reader/handler/SearchHandler.java/right.java
    ;
    logger.
<<<<<<< /usr/src/app/output/einsamhauer/disthene-reader/8d8c28bd2a9238ebbc6ff483aa18b2632e27806b/src/main/java/net/iponweb/disthene/reader/handler/SearchHandler.java/left.java
    headers().set(HttpHeaderNames.CONTENT_LENGTH, response.content().readableBytes())
=======
    debug("Request took " + timer.elapsed(TimeUnit.MILLISECONDS) + " milliseconds (" + parameters + ")")
>>>>>>> /usr/src/app/output/einsamhauer/disthene-reader/8d8c28bd2a9238ebbc6ff483aa18b2632e27806b/src/main/java/net/iponweb/disthene/reader/handler/SearchHandler.java/right.java
    ;
    return response;
  }
  ...
  private FullHttpResponse handleInternal(SearchParameters parameters) throws IOException {
    ...
    FullHttpResponse response = new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.OK, Unpooled.wrappedBuffer(pathsAsString.getBytes()));
  ...
  private static class SearchParameters {
    ...
    @Override public String toString() {
      return "SearchParameters{" + "tenant=\'" + tenant + '\'' + ", query=\'" + query + '\'' + '}';
    }
  }
}