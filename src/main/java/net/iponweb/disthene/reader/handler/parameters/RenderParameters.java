...
public class RenderParameters {
  ...
  @Override public String toString() {
    return "RenderParameters{" + "tenant=\'" + tenant + '\'' + ", targets=" + targets + ", from=" + from + ", until=" + until + ", format=" + format + ", tz=" + tz + ", imageParameters=" + imageParameters + '}';
  }
  ...
  private static long parseExtendedTime(String timeString, DateTimeZone tz) {
    ...
    if (matcher.matches()) {
      ...
      if ("now".equalsIgnoreCase(timeString)) {
