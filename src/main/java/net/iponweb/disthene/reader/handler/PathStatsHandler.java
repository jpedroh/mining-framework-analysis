...
public class PathStatsHandler implements DistheneReaderHandler {
  ...
  @Override public FullHttpResponse handle(HttpRequest request) throws ParameterParsingException, TooMuchDataExpectedException, IOException {
    ...
    FullHttpResponse response = new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.OK, Unpooled.wrappedBuffer(pathsAsJsonArray.getBytes()));
