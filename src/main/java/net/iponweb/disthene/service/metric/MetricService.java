 ...
 */
@Listener(references = References.Strong) public class MetricService {
  ...
  @SuppressWarnings(value = { "unused" }) @Handler public void handle(MetricReceivedEvent metricReceivedEvent) {
