...
public class UIPanel extends JPanel {
  ...
  private final JButton buttonCheckWindow = new JButton(resources.getString(ResourceKey.LABEL, StringID.UI.CHECK_WINDOW_ID));

  private JFormattedTextField textFieldAngle;

  private final JCheckBox dispMVLinesCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.SHOW_MV_ID), false);

  private JFormattedTextField textFieldGrid;

  private final JCheckBox dispAuxLinesCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.SHOW_AUX_ID));

  private final JButton buttonLength = new JButton(resources.getString(ResourceKey.LABEL, StringID.UI.MEASURE_ID));

  private final JCheckBox dispVertexCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.SHOW_VERTICES_ID));

  private final JButton buttonAngle = new JButton(resources.getString(ResourceKey.LABEL, StringID.UI.MEASURE_ID));

  private final JCheckBox doFullEstimationCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.FULL_ESTIMATION_ID));

  private final JCheckBox dispGridCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.SHOW_GRID_ID), true);
  ...
  private final JCheckBox zeroLineWidthCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.ZERO_LINE_WIDTH_ID));

  private final JPanel alterLineTypePanel = new JPanel();

  private final TypeForChange[] alterLine_comboData_from = { TypeForChange.EMPTY, TypeForChange.MOUNTAIN, TypeForChange.VALLEY, TypeForChange.AUX, TypeForChange.CUT };

  private final TypeForChange[] alterLine_comboData_to = { TypeForChange.MOUNTAIN, TypeForChange.VALLEY, TypeForChange.AUX, TypeForChange.CUT, TypeForChange.DELETE, TypeForChange.FLIP };

  private final JComboBox<TypeForChange> alterLine_combo_from = new JComboBox<>(alterLine_comboData_from);

  private final JComboBox<TypeForChange> alterLine_combo_to = new JComboBox<>(alterLine_comboData_to);

  private final JPanel angleStepComboPanel = new JPanel();

  private final JComboBox<AngleStep> angleStepCombo = new JComboBox<>(AngleStep.values());

  public UIPanel(final StateManager stateManager, final ViewScreenUpdater screenUpdater, final MouseActionHolder actionHolder, final PaintContextInterface aContext, final CutModelOutlinesHolder cutOutlinesHolder, final MainFrameSetting mainFrameSetting, final MainScreenSetting mainScreenSetting) {
    ...
    addActionListenersToComponents(stateManager, actionHolder, cutOutlinesHolder, mainScreenSetting);
    editModeInputLineButton.setSelected(true);
    angleStepCombo.setSelectedItem(AngleStep.PI_OVER_8);
    lineInputDirectVButton.doClick();
    setting.setTypeFrom((TypeForChange) alterLine_combo_from.getSelectedItem());
    setting.setTypeTo((TypeForChange) alterLine_combo_to.getSelectedItem());
  ...
  private TitledBorder createTitledBorder(final String text) {
    ...
    border.setBorder(new MatteBorder(1, 0, 0, 0, getBackground().darker().darker()));
    return border;
  }

  private void constructButtons(final StateManager stateManager, final MouseActionHolder actionHolder, final MainFrameSetting mainFrameSetting, final MainScreenSetting mainScreenSetting) {
    BinderInterface<ChangeViewSetting> viewChangeBinder = new ViewChangeBinder();
    var stateFactory = new PaintBoundStateFactory(stateManager, mainFrameSetting, setting, mainScreenSetting.getSelectionOriginHolder());
    ButtonFactory buttonFactory = new PaintActionButtonFactory(stateFactory, paintContext, actionHolder, screenUpdater);
    editModeInputLineButton = (JRadioButton) viewChangeBinder.createButton(JRadioButton.class, null, StringID.UI.INPUT_LINE_ID, screenUpdater.getKeyListener());
    editModePickLineButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.SELECT_ID, screenUpdater.getKeyListener());
    editModeDeleteLineButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.DELETE_LINE_ID, screenUpdater.getKeyListener());
    editModeLineTypeButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.CHANGE_LINE_TYPE_ID, screenUpdater.getKeyListener());
    editModeAddVertex = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.ADD_VERTEX_ID, screenUpdater.getKeyListener());
    editModeDeleteVertex = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.DELETE_VERTEX_ID, screenUpdater.getKeyListener());
    lineInputDirectVButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.DIRECT_V_ID, screenUpdater.getKeyListener());
    lineInputOnVButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.ON_V_ID, screenUpdater.getKeyListener());
    lineInputVerticalLineButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.VERTICAL_ID, screenUpdater.getKeyListener());
    lineInputAngleBisectorButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.BISECTOR_ID, screenUpdater.getKeyListener());
    lineInputTriangleSplitButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.TRIANGLE_ID, screenUpdater.getKeyListener());
    lineInputSymmetricButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.SYMMETRIC_ID, screenUpdater.getKeyListener());
    lineInputMirrorButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.MIRROR_ID, screenUpdater.getKeyListener());
    lineInputByValueButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.BY_VALUE_ID, screenUpdater.getKeyListener());
    lineInputPBisectorButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.PERPENDICULAR_BISECTOR_ID, screenUpdater.getKeyListener());
    lineInputAngleSnapButton = (JRadioButton) buttonFactory.create(this, JRadioButton.class, StringID.ANGLE_SNAP_ID, screenUpdater.getKeyListener());
  }
  ...
  private void createEditActionPanel() {
    ...
    int gridY = 0;
    int gridWidth = 1;
    mainToolPanel.add(editModeInputLineButton, createMainPanelGridBagConstraints(gridX, gridY++, gridWidth));
    mainToolPanel.add(editModePickLineButton, createMainPanelGridBagConstraints(gridX, gridY++, gridWidth));
    mainToolPanel.add(editModeDeleteLineButton, createMainPanelGridBagConstraints(gridX, gridY++, gridWidth));
    mainToolPanel.add(editModeLineTypeButton, createMainPanelGridBagConstraints(gridX, gridY++, gridWidth));
    mainToolPanel.add(editModeAddVertex, createMainPanelGridBagConstraints(gridX, gridY++, gridWidth));
    mainToolPanel.add(editModeDeleteVertex, createMainPanelGridBagConstraints(gridX, gridY++, gridWidth));
  }
  ...
  private void createLineInputPanel() {
    ...
    GridBagConstraints c = createGridBagConstraints(0, gridY++, gridWidth);
    ...
    c.weighty = 1.0;
    c.gridy++;
    lineInputPanel.add(angleStepCombo, c);
    gridY = c.gridy + 1;
    c.weighty = 0;
    lineInputPanel.add(lineInputDirectVButton, createGridBagConstraints(0, gridY, 1));
    lineInputPanel.add(lineInputOnVButton, createGridBagConstraints(1, gridY, 1));
    lineInputPanel.add(lineInputPBisectorButton, createGridBagConstraints(2, gridY, 1));
    lineInputPanel.add(lineInputAngleBisectorButton, createGridBagConstraints(3, gridY++, 1));
    lineInputPanel.add(lineInputTriangleSplitButton, createGridBagConstraints(0, gridY, 1));
    lineInputPanel.add(lineInputVerticalLineButton, createGridBagConstraints(1, gridY, 1));
    lineInputPanel.add(lineInputSymmetricButton, createGridBagConstraints(2, gridY, 1));
    lineInputPanel.add(lineInputMirrorButton, createGridBagConstraints(3, gridY++, 1));
    lineInputPanel.add(lineInputByValueButton, createGridBagConstraints(0, gridY, 1));
    lineInputPanel.add(lineInputAngleSnapButton, createGridBagConstraints(1, gridY, 1));
    setButtonIcons();
  }
  ...
  private void createAlterLineTypePanel() {
    JLabel l1 = new JLabel(resources.getString(ResourceKey.LABEL, StringID.UI.CHANGE_LINE_TYPE_FROM_ID));
    JLabel l2 = new JLabel(resources.getString(ResourceKey.LABEL, StringID.UI.CHANGE_LINE_TYPE_TO_ID));
  ...
  private void createEditByValuePanel() {
    JLabel subLabel1 = new JLabel(resources.getString(ResourceKey.LABEL, StringID.UI.LENGTH_ID));
    JLabel subLabel2 = new JLabel(resources.getString(ResourceKey.LABEL, StringID.UI.ANGLE_ID));
  ...
  private void createGridPanel() {
    JLabel gridLabel1 = new JLabel(resources.getString(ResourceKey.LABEL, StringID.UI.GRID_DIVIDE_NUM_ID));
  ...
  private GridBagConstraints createMainPanelGridBagConstraints(final int gridX, final int gridY, final int gridWidth) {
  ...
  private GridBagConstraints createGridBagConstraints(final int gridX, final int gridY, final int gridWidth) {
    var gridBagConstraints = new GridBagConstraints();
  ...
  private void setButtonIcon(final AbstractButton button, final String iconPath, final String selectedIconPath) {
  ...
  private void addActionListenersToComponents(final StateManager stateManager, final MouseActionHolder actionHolder, final CutModelOutlinesHolder cutOutlinesHolder, final MainScreenSetting mainScreenSetting) {
    ...
    PaintActionSetterFactory setterFactory = new PaintActionSetterFactory(actionHolder, screenUpdater, paintContext);
    buttonLength.addActionListener(setterFactory.create(new LengthMeasuringAction(valueSetting)));
    buttonAngle.addActionListener(setterFactory.create(new AngleMeasuringAction(valueSetting)));
    angleStepCombo.addItemListener((e) -> paintContext.setAngleStep((AngleStep) e.getItem()));
    lineTypeMountainButton.addActionListener((e) -> paintContext.setLineTypeOfNewLines(OriLine.Type.MOUNTAIN));
    lineTypeValleyButton.addActionListener((e) -> paintContext.setLineTypeOfNewLines(OriLine.Type.VALLEY));
    lineTypeAuxButton.addActionListener((e) -> paintContext.setLineTypeOfNewLines(OriLine.Type.AUX));
    editModeInputLineButton.addActionListener(new InputCommandStatePopper(stateManager));
    textFieldLength.getDocument().addDocumentListener(new LengthValueInputListener(valueSetting));
    textFieldAngle.getDocument().addDocumentListener(new AngleValueInputListener(valueSetting));
    ...
    buildButton.addActionListener((e) -> showFoldedModelWindows(cutOutlinesHolder, mainScreenSetting));
  }
  ...
  private void showCheckerWindow(final PaintContextInterface context) {
    ...
    FoldabilityCheckFrameFactory checkerFactory = new FoldabilityCheckFrameFactory(childFrameManager);
    JFrame checker = checkerFactory.createFrame(UIPanel.this, origamiModel, creasePattern, context.isZeroLineWidth());
    checker.repaint();
  ...
  private void showFoldedModelWindows(final CutModelOutlinesHolder cutOutlinesHolder, final MainScreenSetting mainScreenSetting) {
    ...
    if (origamiModel.isProbablyFoldable()) {
      final int foldableModelCount = folder.fold(origamiModel, foldedModelInfo, fullEstimation);
      if (foldableModelCount == -1) {
      } else {
        if (foldableModelCount == 0) {
          JOptionPane.showMessageDialog(this, resources.getString(ResourceKey.INFO, StringID.Information.NO_ANSWER_ID), resources.getString(ResourceKey.INFO, StringID.Information.FOLD_ALGORITHM_TITLE_ID), JOptionPane.INFORMATION_MESSAGE);
        } else {
          if (foldableModelCount > 0) {
            logger.info("foldable layer layout is found.");
            EstimationResultFrameFactory resultFrameFactory = new EstimationResultFrameFactory(childFrameManager);
    ...
    ModelViewFrameFactory modelViewFactory = new ModelViewFrameFactory(mainScreenSetting, childFrameManager);
    JFrame modelView = modelViewFactory.createFrame(this, origamiModel, cutOutlinesHolder, () -> screenUpdater.updateScreen());
    modelView.repaint();
  ...
  private OrigamiModel buildOrigamiModel(final CreasePatternInterface creasePattern) {
    ...
    return builder.build(creasePattern, () -> JOptionPane.showConfirmDialog(this, resources.getString(ResourceKey.WARNING, StringID.Warning.FOLD_FAILED_DUPLICATION_ID), resources.getString(ResourceKey.WARNING, StringID.Warning.FAILED_TITLE_ID), JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE) == JOptionPane.YES_OPTION, () -> JOptionPane.showMessageDialog(this, resources.getString(ResourceKey.INFO, StringID.Information.SIMPLIFYING_CP_ID), resources.getString(ResourceKey.INFO, StringID.Information.SIMPLIFYING_CP_TITLE_ID), JOptionPane.INFORMATION_MESSAGE), () -> JOptionPane.showMessageDialog(this, resources.getString(ResourceKey.WARNING, StringID.Warning.FOLD_FAILED_WRONG_STRUCTURE_ID), resources.getString(ResourceKey.WARNING, StringID.Warning.FAILED_TITLE_ID), JOptionPane.WARNING_MESSAGE));
  }

  private void addPropertyChangeListenersToSetting(final MainScreenSetting mainScreenSetting) {
    mainScreenSetting.addPropertyChangeListener(MainScreenSetting.ZERO_LINE_WIDTH, (e) -> {
      zeroLineWidthCheckBox.setSelected((boolean) e.getNewValue());
    });
    mainScreenSetting.addPropertyChangeListener(MainScreenSetting.GRID_VISIBLE, (e) -> {
      dispGridCheckBox.setSelected((boolean) e.getNewValue());
      repaint();
    });
    mainScreenSetting.addPropertyChangeListener(MainScreenSetting.VERTEX_VISIBLE, (e) -> {
      logger.debug("vertexVisible property change: " + e.getNewValue());
      dispVertexCheckBox.setSelected((boolean) e.getNewValue());
    });
    mainScreenSetting.addPropertyChangeListener(MainScreenSetting.MV_LINE_VISIBLE, (e) -> {
      logger.debug("mvLineVisible property change: " + e.getNewValue());
      dispMVLinesCheckBox.setSelected((boolean) e.getNewValue());
    });
    mainScreenSetting.addPropertyChangeListener(MainScreenSetting.AUX_LINE_VISIBLE, (e) -> {
      logger.debug("auxLineVisible property change: " + e.getNewValue());
      dispAuxLinesCheckBox.setSelected((boolean) e.getNewValue());
    });
    valueSetting.addPropertyChangeListener(ValueSetting.ANGLE, (e) -> textFieldAngle.setValue(e.getNewValue()));
    valueSetting.addPropertyChangeListener(ValueSetting.LENGTH, (e) -> textFieldLength.setValue(e.getNewValue()));
    setting.addPropertyChangeListener(UIPanelSetting.SELECTED_MODE, this::onChangeEditModeButtonSelection);
    setting.addPropertyChangeListener(UIPanelSetting.BY_VALUE_PANEL_VISIBLE, (e) -> {
    ...
    setting.addPropertyChangeListener(UIPanelSetting.MOUNTAIN_BUTTON_ENABLED, (e) -> lineTypeMountainButton.setEnabled((boolean) e.getNewValue()));
    setting.addPropertyChangeListener(UIPanelSetting.VALLEY_BUTTON_ENABLED, (e) -> lineTypeValleyButton.setEnabled((boolean) e.getNewValue()));
    setting.addPropertyChangeListener(UIPanelSetting.AUX_BUTTON_ENABLED, (e) -> lineTypeAuxButton.setEnabled((boolean) e.getNewValue()));
    setting.addPropertyChangeListener(UIPanelSetting.ANGLE_STEP_VISIBLE, (e) -> angleStepComboPanel.setVisible((boolean) e.getNewValue()));
  }
