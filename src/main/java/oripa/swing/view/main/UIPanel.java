...
public class UIPanel extends JPanel implements UIPanelView {
  ...
  private final JRadioButton editModeInputLineButton = new JRadioButton(resources.getString(ResourceKey.LABEL, StringID.UI.INPUT_LINE_ID));

  private final JRadioButton editModeLineSelectionButton = new JRadioButton(resources.getString(ResourceKey.LABEL, StringID.SELECT_ID));

  private final JRadioButton editModeDeleteLineButton = new JRadioButton(resources.getString(ResourceKey.LABEL, StringID.DELETE_LINE_ID));

  private final JRadioButton editModeLineTypeButton = new JRadioButton(resources.getString(ResourceKey.LABEL, StringID.CHANGE_LINE_TYPE_ID));

  private final JRadioButton editModeAddVertex = new JRadioButton(resources.getString(ResourceKey.LABEL, StringID.ADD_VERTEX_ID));

  private final JRadioButton editModeDeleteVertex = new JRadioButton(resources.getString(ResourceKey.LABEL, StringID.DELETE_VERTEX_ID));
  ...
  private final JRadioButton lineTypeAuxButton = new JRadioButton(resources.getString(ResourceKey.LABEL, StringID.UI.AUX_ID));

  private final JRadioButton lineTypeMountainButton = new JRadioButton(resources.getString(ResourceKey.LABEL, StringID.UI.MOUNTAIN_ID));

  private final JRadioButton lineTypeValleyButton = new JRadioButton(resources.getString(ResourceKey.LABEL, StringID.UI.VALLEY_ID));

  private final JPanel byValuePanel = new JPanel();

  private JFormattedTextField textFieldLength;

  private final JButton buttonLength = new JButton(resources.getString(ResourceKey.LABEL, StringID.UI.MEASURE_ID));

  private JFormattedTextField textFieldAngle;

  private final JButton buttonAngle = new JButton(resources.getString(ResourceKey.LABEL, StringID.UI.MEASURE_ID));
  ...
  private final JCheckBox dispGridCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.SHOW_GRID_ID), InitialVisibilities.GRID);
  ...
  private final JButton gridChangeButton = new JButton(resources.getString(ResourceKey.LABEL, StringID.UI.GRID_SIZE_CHANGE_ID));
  ...
  private final JCheckBox dispMVLinesCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.SHOW_MV_ID), InitialVisibilities.MV);

  private final JCheckBox dispAuxLinesCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.SHOW_AUX_ID), InitialVisibilities.AUX);

  private final JCheckBox dispVertexCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.SHOW_VERTICES_ID), InitialVisibilities.VERTEX);

  private final JCheckBox doFullEstimationCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.FULL_ESTIMATION_ID), false);

  private final JCheckBox zeroLineWidthCheckBox = new JCheckBox(resources.getString(ResourceKey.LABEL, StringID.UI.ZERO_LINE_WIDTH_ID), InitialVisibilities.ZERO_LINE_WIDTH);

  private final JPanel buttonsPanel = new JPanel();

  private final JButton buildButton = new JButton(resources.getString(ResourceKey.LABEL, StringID.UI.FOLD_ID));

  private final JButton checkWindowButton = new JButton(resources.getString(ResourceKey.LABEL, StringID.UI.CHECK_WINDOW_ID));
  ...
  public UIPanel(final MainViewSetting viewSetting) {
    ...
    editModePanel.setBorder(createTitledBorderFrame(resources.getString(ResourceKey.LABEL, StringID.UI.TOOL_PANEL_ID)));
    editModePanel.setLayout(new GridBagLayout());
    var gbBuilder = new GridBagConstraintsBuilder(1).setAnchor(GridBagConstraints.LINE_START).setInsets(0, 5, 0, 0);
    ...
    toolSettingsPanel.setBorder(createTitledBorderFrame(resources.getString(ResourceKey.LABEL, StringID.UI.TOOL_SETTINGS_PANEL_ID)));
    gbBuilder = new GridBagConstraintsBuilder(1).setAnchor(GridBagConstraints.PAGE_START).setFill(GridBagConstraints.HORIZONTAL).setWeight(1, 1);
    ...
    generalSettingsPanel.setBorder(createTitledBorderFrame(resources.getString(ResourceKey.LABEL, StringID.UI.GENERAL_SETTINGS_ID)));
    gbBuilder = new GridBagConstraintsBuilder(1).setAnchor(GridBagConstraints.PAGE_START).setFill(GridBagConstraints.HORIZONTAL).setWeight(1, 0.5);
    ...
    gbBuilder = new GridBagConstraintsBuilder(1).setAnchor(GridBagConstraints.FIRST_LINE_START).setFill(GridBagConstraints.HORIZONTAL).setWeight(1, 0.0);
    ...
    gbBuilder.setWeight(1, 0.0).setFill(GridBagConstraints.HORIZONTAL).setAnchor(GridBagConstraints.LAST_LINE_START);
  ...
  @Override public void initializeButtonSelection(final String angleStep, final String typeFrom, final String typeTo) {
  ...
  @Override public void addMouseActionPluginListener(final String name, final Runnable listener, final KeyProcessing keyProcessing) {
    var button = new JRadioButton(name);
    addButtonListener(button, listener, keyProcessing);
    pluginButtons.add(button);
  }

  @Override public void updatePluginPanel() {
    var gbBuilder = new GridBagConstraintsBuilder(1).setAnchor(GridBagConstraints.CENTER).setWeight(1, 1).setFill(GridBagConstraints.HORIZONTAL);
  ...
  private void buildLineSelectionPanel() {
    ...
    lineSelectionPanel.setBorder(createTitledBorder(resources.getString(ResourceKey.LABEL, StringID.UI.SELECT_ID)));
    var gbBuilder = new GridBagConstraintsBuilder(4).setAnchor(GridBagConstraints.CENTER).setWeight(0.5, 1);
  ...
  private void buildLineInputPanel() {
    ...
    lineInputPanel.setBorder(createTitledBorder(resources.getString(ResourceKey.LABEL, StringID.UI.LINE_INPUT_PANEL_ID)));
    var gbBuilder = new GridBagConstraintsBuilder(4).setAnchor(GridBagConstraints.CENTER).setWeight(0.5, 1.0);
  ...
  private void buildAngleStepPanel() {
    ...
    angleStepComboPanel.setBorder(createTitledBorder(resources.getString(ResourceKey.LABEL, StringID.UI.ANGLE_STEP_ID)));
    angleStepComboPanel.add(angleStepCombo, new GridBagConstraintsBuilder(1).setAnchor(GridBagConstraints.CENTER).setFill(GridBagConstraints.BOTH).getLineField());
  ...
  private void buildAlterLineTypePanel() {
    var fromLabel = new JLabel(resources.getString(ResourceKey.LABEL, StringID.UI.CHANGE_LINE_TYPE_FROM_ID));
    var toLabel = new JLabel(resources.getString(ResourceKey.LABEL, StringID.UI.CHANGE_LINE_TYPE_TO_ID));
    alterLineTypePanel.setLayout(new GridBagLayout());
    alterLineTypePanel.setBorder(createTitledBorder(resources.getString(ResourceKey.LABEL, StringID.UI.ALTER_LINE_TYPE_PANEL_ID)));
  ...
  private void buildEditByValuePanel() {
    var lengthLabel = new JLabel(resources.getString(ResourceKey.LABEL, StringID.UI.LENGTH_ID));
    var angleLabel = new JLabel(resources.getString(ResourceKey.LABEL, StringID.UI.ANGLE_ID));
    ...
    byValuePanel.setBorder(createTitledBorder(resources.getString(ResourceKey.LABEL, StringID.UI.INSERT_BY_VALUE_PANEL_ID)));
    var gbBuilder = new GridBagConstraintsBuilder(3).setAnchor(GridBagConstraints.CENTER).setFill(GridBagConstraints.NONE).setWeight(0, 1);
  ...
  private void buildGridPanel() {
    var gridDivideLabel = new JLabel(resources.getString(ResourceKey.LABEL, StringID.UI.GRID_DIVIDE_NUM_ID));
    ...
    gridPanel.setBorder(createTitledBorder(resources.getString(ResourceKey.LABEL, StringID.UI.GRID_SETTINGS_PANEL_ID)));
  ...
  private void buildViewPanel() {
    ...
    viewPanel.setBorder(createTitledBorder(resources.getString(ResourceKey.LABEL, StringID.UI.VIEW_SETTINGS_PANEL_ID)));
    var gbBuilder = new GridBagConstraintsBuilder(3);
  ...
  private void buildButtonsPanel() {
    ...
    buttonsPanel.setBorder(new MatteBorder(1, 0, 0, 0, getBackground().darker().darker()));
    var gbBuilder = new GridBagConstraintsBuilder(3);
  ...
  private void setShortcuts() {
    setShortcut(editModeInputLineButton, KeyStrokes.get(KeyEvent.VK_I), StringID.UI.INPUT_LINE_ID);
    setShortcut(editModeDeleteLineButton, KeyStrokes.get(KeyEvent.VK_D), StringID.DELETE_LINE_ID);
    setShortcut(editModeLineTypeButton, KeyStrokes.get(KeyEvent.VK_T), StringID.CHANGE_LINE_TYPE_ID);
    setShortcut(editModeAddVertex, KeyStrokes.get(KeyEvent.VK_X), StringID.ADD_VERTEX_ID);
    setShortcut(editModeDeleteVertex, KeyStrokes.get(KeyEvent.VK_Y), StringID.DELETE_VERTEX_ID);
    setLineSelectionGlobalShortcut(selectionButton, KeyStrokes.get(KeyEvent.VK_S), StringID.SELECT_LINE_ID);
    setLineSelectionGlobalShortcut(enlargementButton, KeyStrokes.getWithShiftDown(KeyEvent.VK_S), StringID.ENLARGE_ID);
    setLineInputGlobalShortcut(lineInputDirectVButton, KeyStrokes.get(KeyEvent.VK_E), StringID.DIRECT_V_ID);
    setLineInputGlobalShortcut(lineInputOnVButton, KeyStrokes.get(KeyEvent.VK_O), StringID.ON_V_ID);
    setLineInputGlobalShortcut(lineInputVerticalLineButton, KeyStrokes.get(KeyEvent.VK_V), StringID.VERTICAL_ID);
    setLineInputGlobalShortcut(lineInputAngleBisectorButton, KeyStrokes.get(KeyEvent.VK_B), StringID.BISECTOR_ID);
    setLineInputGlobalShortcut(lineInputTriangleSplitButton, KeyStrokes.get(KeyEvent.VK_R), StringID.TRIANGLE_ID);
    setLineInputGlobalShortcut(lineInputSymmetricButton, KeyStrokes.get(KeyEvent.VK_W), StringID.SYMMETRIC_ID);
    setLineInputGlobalShortcut(lineInputMirrorButton, KeyStrokes.get(KeyEvent.VK_M), StringID.MIRROR_ID);
    setLineInputGlobalShortcut(lineInputByValueButton, KeyStrokes.get(KeyEvent.VK_L), StringID.BY_VALUE_ID);
    setLineInputGlobalShortcut(lineInputPBisectorButton, KeyStrokes.get(KeyEvent.VK_P), StringID.PERPENDICULAR_BISECTOR_ID);
    setLineInputGlobalShortcut(lineInputAngleSnapButton, KeyStrokes.get(KeyEvent.VK_A), StringID.ANGLE_SNAP_ID);
    setLineInputGlobalShortcut(lineInputSuggestionButton, KeyStrokes.get(KeyEvent.VK_F), StringID.SUGGESTION_ID);
    setShortcut(lineTypeMountainButton, KeyStrokes.getWithShiftDown(KeyEvent.VK_M), StringID.UI.MOUNTAIN_ID);
    setShortcut(lineTypeValleyButton, KeyStrokes.getWithShiftDown(KeyEvent.VK_V), StringID.UI.VALLEY_ID);
    setShortcut(lineTypeAuxButton, KeyStrokes.getWithShiftDown(KeyEvent.VK_A), StringID.UI.AUX_ID);
  }
  ...
  /**
	 ...
	 */
  private void setShortcut(final AbstractButton button, final KeyStroke keyStroke, final String id) {
  ...
  private void setLineSelectionGlobalShortcut(final AbstractButton button, final KeyStroke keyStroke, final String id) {
  ...
  /**
	 ...
	 *            is an ID string to distinguish shortcut action.
	 */
  private void setLineInputGlobalShortcut(final AbstractButton button, final KeyStroke keyStroke, final String id) {
  ...
  /**
	 ...
	 *            is an ID string to distinguish shortcut action.
	 */
  private void setToolSettingGlobalShortcut(final JRadioButton toolButton, final AbstractButton settingButton, final KeyStroke keyStroke, final String id) {
    ...
    settingButton.setToolTipText(resources.getString(ResourceKey.LABEL, StringID.UI.SHORTCUT_ID) + String.join("-", keyStroke.toString().replaceFirst("pressed ", "").split(" ")));
  }

  private void setShortcut(final JComponent focusTarget, final KeyStroke keyStroke, final String id, final Action action) {
    ...
    if (inputMap.get(keyStroke) != null) {
      throw new IllegalArgumentException("Wrong key configuration: Shortcut by " + keyStroke.toString() + " is already set.");
    }
  ...
  @Override public void addItemOfAlterLineComboFrom(final String item) {
    alterLineComboFrom.addItem(item);
  }

  @Override public void addItemOfAlterLineComboTo(final String item) {
    alterLineComboTo.addItem(item);
  }

  @Override public void addItemOfAngleStepCombo(final String item) {
    angleStepCombo.addItem(item);
  }

  @Override public void addEditModeInputLineButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(editModeInputLineButton, listener, keyProcessing);
  }

  @Override public void addEditModeLineSelectionButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(editModeLineSelectionButton, listener, keyProcessing);
  }

  @Override public void addEditModeDeleteLineButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(editModeDeleteLineButton, listener, keyProcessing);
  }

  @Override public void addEditModeLineTypeButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(editModeLineTypeButton, listener, keyProcessing);
  }

  @Override public void addAlterLineComboFromSelectionListener(final Consumer<String> listener) {
    addSelectionListener(alterLineComboFrom, listener);
  }

  @Override public void addAlterLineComboToSelectionListener(final Consumer<String> listener) {
    addSelectionListener(alterLineComboTo, listener);
  }

  @SuppressWarnings(value = { "unchecked" }) private <T extends java.lang.Object> void addSelectionListener(final JComboBox<T> combo, final Consumer<T> listener) {
  ...
  @Override public void addEditModeAddVertexButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(editModeAddVertex, listener, keyProcessing);
  }

  @Override public void addEditModeDeleteVertexButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(editModeDeleteVertex, listener, keyProcessing);
  }

  @Override public void addSelectionButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(selectionButton, listener, keyProcessing);
  }

  @Override public void addEnlargementButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(enlargementButton, listener, keyProcessing);
  }

  @Override public void addLineInputDirectVButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(lineInputDirectVButton, listener, keyProcessing);
  }

  @Override public void addLineInputOnVButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(lineInputOnVButton, listener, keyProcessing);
  }

  @Override public void addLineInputVerticalLineButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(lineInputVerticalLineButton, listener, keyProcessing);
  }

  @Override public void addLineInputAngleBisectorButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(lineInputAngleBisectorButton, listener, keyProcessing);
  }

  @Override public void addLineInputTriangleSplitButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(lineInputTriangleSplitButton, listener, keyProcessing);
  }

  @Override public void addLineInputSymmetricButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(lineInputSymmetricButton, listener, keyProcessing);
  }

  @Override public void addLineInputMirrorButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(lineInputMirrorButton, listener, keyProcessing);
  }

  @Override public void addLineInputByValueButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(lineInputByValueButton, listener, keyProcessing);
  }

  @Override public void addLengthButtonListener(final Runnable listener) {
    buttonLength.addActionListener((e) -> listener.run());
  }

  @Override public void addAngleButtonListener(final Runnable listener) {
    buttonAngle.addActionListener((e) -> listener.run());
  }

  @Override public void addLengthTextFieldListener(final Consumer<Double> listener) {
    addMeasureDocumentListener(textFieldLength, listener);
  }

  @Override public void addAngleTextFieldListener(final Consumer<Double> listener) {
  ...
  @Override public void addLineInputPBisectorButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(lineInputPBisectorButton, listener, keyProcessing);
  }

  @Override public void addLineInputAngleSnapButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(lineInputAngleSnapButton, listener, keyProcessing);
  }

  @Override public void addLineInputSuggestionButtonListener(final Runnable listener, final KeyProcessing keyProcessing) {
    addButtonListener(lineInputSuggestionButton, listener, keyProcessing);
  }

  @Override public void addAngleStepComboListener(final Consumer<String> listener) {
    angleStepCombo.addItemListener((e) -> listener.accept((String) e.getItem()));
  }

  private void addButtonListener(final AbstractButton button, final Runnable listener, final KeyProcessing keyProcessing) {
  ...
  @Override public void addLineTypeMountainButtonListener(final Runnable listener) {
    lineTypeMountainButton.addActionListener((e) -> listener.run());
  }

  @Override public void addLineTypeValleyButtonListener(final Runnable listener) {
    lineTypeValleyButton.addActionListener((e) -> listener.run());
  }

  @Override public void addLineTypeAuxButtonListener(final Runnable listener) {
    lineTypeAuxButton.addActionListener((e) -> listener.run());
  }

  @Override public void addDispGridCheckBoxListener(final Consumer<Boolean> listener) {
    dispGridCheckBox.addActionListener((e) -> listener.accept(dispGridCheckBox.isSelected()));
  }

  @Override public void addGridSmallButtonListener(final Runnable listener) {
    gridSmallButton.addActionListener((e) -> listener.run());
  }

  @Override public void addGridLargeButtonListener(final Runnable listener) {
    gridLargeButton.addActionListener((e) -> listener.run());
  }

  @Override public void addGridChangeButtonListener(final Consumer<Integer> listener) {
  ...
  @Override public void addDispVertexCheckBoxListener(final Consumer<Boolean> listener) {
    dispVertexCheckBox.addActionListener((e) -> listener.accept(dispVertexCheckBox.isSelected()));
  }

  @Override public void addDispMVLinesCheckBoxListener(final Consumer<Boolean> listener) {
    dispMVLinesCheckBox.addActionListener((e) -> listener.accept(dispMVLinesCheckBox.isSelected()));
  }

  @Override public void addDispAuxLinesCheckBoxListener(final Consumer<Boolean> listener) {
    dispAuxLinesCheckBox.addActionListener((e) -> listener.accept(dispAuxLinesCheckBox.isSelected()));
  }

  @Override public void addZeroLineWidthCheckBoxListener(final Consumer<Boolean> listener) {
    zeroLineWidthCheckBox.addActionListener((e) -> listener.accept(zeroLineWidthCheckBox.isSelected()));
  }

  @Override public void setGridDivNum(final int gridDivNum) {
  ...
  @Override public void setEstimationResultColors(final Color frontColor, final Color backColor) {
  ...
  @Override public void addCheckWindowButtonListener(final Runnable listener) {
  ...
  private void addPropertyChangeListenersToSetting(final PainterScreenSetting mainScreenSetting) {
    mainScreenSetting.addPropertyChangeListener(PainterScreenSetting.ZERO_LINE_WIDTH, (e) -> zeroLineWidthCheckBox.setSelected((boolean) e.getNewValue()));
    mainScreenSetting.addPropertyChangeListener(PainterScreenSetting.GRID_VISIBLE, (e) -> {
      dispGridCheckBox.setSelected((boolean) e.getNewValue());
      repaint();
    });
    mainScreenSetting.addPropertyChangeListener(PainterScreenSetting.VERTEX_VISIBLE, (e) -> {
      logger.debug("vertexVisible property change: {}", e.getNewValue());
      dispVertexCheckBox.setSelected((boolean) e.getNewValue());
    });
    mainScreenSetting.addPropertyChangeListener(PainterScreenSetting.MV_LINE_VISIBLE, (e) -> {
      logger.debug("mvLineVisible property change: {}", e.getNewValue());
      dispMVLinesCheckBox.setSelected((boolean) e.getNewValue());
    });
    mainScreenSetting.addPropertyChangeListener(PainterScreenSetting.AUX_LINE_VISIBLE, (e) -> {
      logger.debug("auxLineVisible property change: {}", e.getNewValue());
      dispAuxLinesCheckBox.setSelected((boolean) e.getNewValue());
    });
    setting.addPropertyChangeListener(UIPanelSetting.SELECTED_MODE, this::onChangeEditModeButtonSelection);
    setting.addPropertyChangeListener(UIPanelSetting.BY_VALUE_PANEL_VISIBLE, (e) -> byValuePanel.setVisible((boolean) e.getNewValue()));
    setting.addPropertyChangeListener(UIPanelSetting.ALTER_LINE_TYPE_PANEL_VISIBLE, (e) -> alterLineTypePanel.setVisible((boolean) e.getNewValue()));
    setting.addPropertyChangeListener(UIPanelSetting.LINE_INPUT_PANEL_VISIBLE, (e) -> lineInputPanel.setVisible((boolean) e.getNewValue()));
    setting.addPropertyChangeListener(UIPanelSetting.LINE_SELECTION_PANEL_VISIBLE, (e) -> lineSelectionPanel.setVisible((boolean) e.getNewValue()));
    setting.addPropertyChangeListener(UIPanelSetting.ANGLE_STEP_PANEL_VISIBLE, (e) -> angleStepComboPanel.setVisible((boolean) e.getNewValue()));
  }
  ...
  @Override public View getTopLevelView() {
    return (View) SwingUtilities.getWindowAncestor(this);
  }

  @Override public Color getEstimationResultFrontColor() {
    return estimationResultFrontColor;
  }

  @Override public Color getEstimationResultBackColor() {
    return estimationResultBackColor;
  }

  @Override public BiConsumer<Color, Color> getEstimationResultSaveColorsListener() {
    return estimationResultSaveColorsListener;
  }

  @Override public boolean isFullEstimation() {
    return doFullEstimationCheckBox.isSelected();
  }

  @Override public PropertyChangeListener getPaperDomainOfModelChangeListener() {
    return paperDomainOfModelChangeListener;
  }

  @Override public void setBuildButtonEnabled(final boolean enabled) {
    buildButton.setEnabled(enabled);
  }

  @Override public void setByValueAngle(final double angle) {
    textFieldAngle.setValue(angle);
  }

  @Override public void setByValueLength(final double length) {
    textFieldLength.setValue(length);
  }

  @Override public void showNoAnswerMessage() {
  ...
  /**
	 ...
	 */
  @Override public boolean showCleaningUpDuplicationDialog() {
    RunnableFuture<Boolean> f = new FutureTask<>(() -> dialogService.showCleaningUpDuplicationDialog(this) == JOptionPane.YES_OPTION);
  ...
  /**
	 * Do not call this method from Event Dispatch Thread.
	 */
  @Override public void showCleaningUpMessage() {
    try {
  ...
  /**
	 * Do not call this method from Event Dispatch Thread.
	 */
  @Override public void showFoldFailureMessage() {
    try {
  ...
  @Override public void setModelComputationListener(final Runnable listener) {
    modelComputationListener = listener;
  }

  @Override public void setShowFoldedModelWindowsListener(final Runnable listener) {
  ...
  @Override public void showErrorMessage(final Exception e) {
