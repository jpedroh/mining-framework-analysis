...
public class HistQuotes2Request {
  ...
  private HistoricalQuote parseCSVLine(String line) {
    ...
    return 
<<<<<<< /usr/src/app/output/sstrickx/yahoofinance-api/a41ed401e128dc321566e584d95f2670bd9027d1/src/main/java/yahoofinance/histquotes2/HistQuotes2Request.java/left.java
    new HistoricalQuote(this.symbol, Utils.parseHistDate(data[0])).setOpen(Utils.getBigDecimal(data[1])).setLow(Utils.getBigDecimal(data[3])).setHigh(Utils.getBigDecimal(data[2])).setClose(Utils.getBigDecimal(data[4])).setAdjClose(Utils.getBigDecimal(data[6])).setVolume(Utils.getLong(data[5]))
=======
    new HistoricalQuote(this.symbol, CalendarUtil.parseHistDate(data[0]), BigDecimalUtil.getBigDecimal(data[1]), BigDecimalUtil.getBigDecimal(data[3]), BigDecimalUtil.getBigDecimal(data[2]), BigDecimalUtil.getBigDecimal(data[4]), BigDecimalUtil.getBigDecimal(data[5]), PrimitiveTypesConvertUtils.getLong(data[6]))
>>>>>>> /usr/src/app/output/sstrickx/yahoofinance-api/a41ed401e128dc321566e584d95f2670bd9027d1/src/main/java/yahoofinance/histquotes2/HistQuotes2Request.java/right.java
    ;
  }
}