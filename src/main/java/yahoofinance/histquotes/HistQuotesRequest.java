...
public class HistQuotesRequest {
  ...
  private HistoricalQuote parseCSVLine(String line) {
    ...
    return 
<<<<<<< /usr/src/app/output/sstrickx/yahoofinance-api/a41ed401e128dc321566e584d95f2670bd9027d1/src/main/java/yahoofinance/histquotes/HistQuotesRequest.java/left.java
...
=======
    new HistoricalQuote(this.symbol, CalendarUtil.parseHistDate(data[0]), BigDecimalUtil.getBigDecimal(data[1]), BigDecimalUtil.getBigDecimal(data[3]), BigDecimalUtil.getBigDecimal(data[2]), BigDecimalUtil.getBigDecimal(data[4]), BigDecimalUtil.getBigDecimal(data[6]), PrimitiveTypesConvertUtils.getLong(data[5]))
>>>>>>> /usr/src/app/output/sstrickx/yahoofinance-api/a41ed401e128dc321566e584d95f2670bd9027d1/src/main/java/yahoofinance/histquotes/HistQuotesRequest.java/right.java
    ;
  }
}