 ...
 */
@SuppressWarnings(value = { "deprecation" }) @Plugin(type = SpotAnalyzerFactory.class, priority = 
<<<<<<< /usr/src/app/output/fiji/trackmate/5e16de8e9ffcc87470a5817ae5ae92ecbf6ab30b/src/main/java/fiji/plugin/trackmate/features/spot/SpotContrastAndSNRAnalyzerFactory.java/left.java
-1d
=======
Priority.LOW
>>>>>>> /usr/src/app/output/fiji/trackmate/5e16de8e9ffcc87470a5817ae5ae92ecbf6ab30b/src/main/java/fiji/plugin/trackmate/features/spot/SpotContrastAndSNRAnalyzerFactory.java/right.java
  ...
  @Override public SpotContrastAndSNRAnalyzer<T> getAnalyzer(final Model model, final ImgPlus<T> img, final int frame, final int channel) {
  ...
  @Override public Map<String, String> getFeatureShortNames() {
    return FEATURE_SHORT_NAMES;
  }

  @Override public Map<String, String> getFeatureNames() {
    return FEATURE_NAMES;
  }

  @Override public Map<String, Dimension> getFeatureDimensions() {
  ...
  @Override public Map<String, Boolean> getIsIntFeature() {
    return IS_INT;
  }

  @Override public boolean isManualFeature() {
    return false;
  }
}