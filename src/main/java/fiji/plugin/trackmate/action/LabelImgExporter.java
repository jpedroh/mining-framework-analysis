...
@SuppressWarnings(value = { "deprecation" }) public class LabelImgExporter extends AbstractTMAction {
  ...
  @Override public void execute(final TrackMate trackmate) {
    final boolean exportSpotsAsDots;
    final boolean exportTracksOnly;
    if (gui != null) {
      final LabelImgExporterPanel panel = new LabelImgExporterPanel();
      final int userInput = JOptionPane.showConfirmDialog(gui, panel, "Export to label image", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, TrackMateWizard.TRACKMATE_ICON);
  ...
  /**
	 ...
	 */
  public static final ImagePlus createLabelImagePlus(final TrackMate trackmate, final boolean exportSpotsAsDots, final boolean exportTracksOnly) {
  ...
  /**
	 ...
	 * @return a new {@link ImagePlus}.
	 */
  public static final ImagePlus createLabelImagePlus(final TrackMate trackmate, final boolean exportSpotsAsDots, final boolean exportTracksOnly, final Logger logger) {
  ...
  /**
	 ...
	 * @return a new {@link ImagePlus}.
	 */
  public static final ImagePlus createLabelImagePlus(final Model model, final ImagePlus imp, final boolean exportSpotsAsDots, final boolean exportTracksOnly) {
  ...
  /**
	 ...
	 * @return a new {@link ImagePlus}.
	 */
  public static final ImagePlus createLabelImagePlus(final Model model, final ImagePlus imp, final boolean exportSpotsAsDots, final boolean exportTracksOnly, final Logger logger) {
  ...
  /**
	 ...
	 * @return a new {@link ImagePlus}.
	 */
  public static final ImagePlus createLabelImagePlus(final Model model, final int[] dimensions, final boolean exportSpotsAsDots, final boolean exportTracksOnly) {
  ...
  /**
	 ...
	 * @return a new {@link ImagePlus}.
	 */
  public static final ImagePlus createLabelImagePlus(final Model model, final int[] dimensions, final boolean exportSpotsAsDots, final boolean exportTracksOnly, final Logger logger) {
  ...
  /**
	 ...
	 */
  public static final Img<UnsignedShortType> createLabelImg(final Model model, final long[] dimensions, final boolean exportSpotsAsDots, final boolean exportTracksOnly) {
  ...
  /**
	 ...
	 * @return a new {@link Img}.
	 */
  public static final Img<UnsignedShortType> createLabelImg(final Model model, final long[] dimensions, final boolean exportSpotsAsDots, final boolean exportTracksOnly, final Logger logger) {
    ...
    final AxisType[] axes = new AxisType[] { Axes.X, Axes.Y, Axes.Z, Axes.TIME };
...
>>>>>>> /usr/src/app/output/fiji/trackmate/cd50720acbc96d28db16793b408e57ffb240b1cd/src/main/java/fiji/plugin/trackmate/action/LabelImgExporter.java/right.java
    ...
    for (int frame = 0; frame < dimensions[3]; frame++) {
      ...
      final SpotWriter spotWriter = exportSpotsAsDots ? new SpotAsDotWriter(imgCT) : new SpotSphereWriter(imgCT);
...
>>>>>>> /usr/src/app/output/fiji/trackmate/cd50720acbc96d28db16793b408e57ffb240b1cd/src/main/java/fiji/plugin/trackmate/action/LabelImgExporter.java/right.java
  ...
  @Plugin(type = TrackMateActionFactory.class) public static class Factory implements TrackMateActionFactory {
  ...
  private static final class SpotSphereWriter implements SpotWriter {
    ...
    @Override public void write(final Spot spot, final int id) {
  ...
  public static void main(final String[] args) {
    ...
    createLabelImagePlus(plugIn.getModel(), plugIn.getSettings().imp, true, true, plugIn.getModel().getLogger()).show();
  }
}