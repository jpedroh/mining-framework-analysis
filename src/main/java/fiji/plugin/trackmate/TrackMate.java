 ...
 */
@SuppressWarnings(value = { "deprecation" }) public class TrackMate implements Benchmark, MultiThreaded, Algorithm, Named {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) public boolean execDetection() {
    final Logger logger = model.getLogger();
  ...
  @SuppressWarnings(value = { "rawtypes" }) private boolean processGlobal(final SpotGlobalDetectorFactory factory, final ImgPlus img, final Logger logger) {
  ...
  @SuppressWarnings(value = { "rawtypes" }) private boolean processFrameByFrame(final SpotDetectorFactory factory, final ImgPlus img, final Logger logger) {
  ...
  @Override public void setNumThreads() {
    this.numThreads = Runtime.getRuntime().availableProcessors();
  }

  @Override public void setNumThreads(final int numThreads) {
