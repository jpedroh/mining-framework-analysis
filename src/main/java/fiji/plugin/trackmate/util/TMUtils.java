...
public class TMUtils {
  ...
  /**
	 ...
	 */
  public static <K extends java.lang.Object, V extends Comparable<? super V>> Map<K, V> sortByValue(final Map<K, V> map, final Comparator<V> comparator) {
  ...
  public static final String echoMap(final Map<String, Object> map, final int indent) {
    ...
    for (final String key : map.keySet()) {
      ...
      if (obj instanceof Map) {
        builder.append('\n');
        @SuppressWarnings(value = { "unchecked" }) final Map<String, Object> submap = (Map<String, Object>) obj;
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "rawtypes" }) public static final ImgPlus rawWraps(final ImagePlus imp) {
  ...
  /**
	 ...
	 */
  public static final <T extends java.lang.Object> boolean checkMapKeys(final Map<T, ?> map, Collection<T> mandatoryKeys, Collection<T> optionalKeys, final StringBuilder errorHolder) {
  ...
  /**
	 ...
	 */
  public static final <J extends java.lang.Object, K extends java.lang.Object> List<K> getArrayFromMaping(final List<J> keys, final Map<J, K> mapping) {
  ...
  public static final double[] getSpatialCalibration(final ImgPlusMetadata img) {
    ...
    for (int d = 0; d < img.numDimensions(); d++) {
      if (img.axis(d).type() == Axes.X) {
        ...
        if (img.axis(d).type() == Axes.Y) {
          calibration[1] = img.averageScale(d);
        } else {
          if (img.axis(d).type() == Axes.Z) {
  ...
  public static final Interval getIntervalWithTime(final ImgPlus<?> img, final Settings settings) {
    ...
    if (cindex >= 0) {
      Integer c = (Integer) settings.detectorSettings.get(KEY_TARGET_CHANNEL);
      if (null == c) {
        c = 1;
      }
      min[cindex] = c - 1;
