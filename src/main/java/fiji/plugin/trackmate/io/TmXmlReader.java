...
public class TmXmlReader {
  ...
  /**
	 ...
	 */
  public Collection<TrackMateModelView> getViews(final ViewProvider provider, final Model model, final Settings settings, final SelectionModel selectionModel, final DisplaySettings displaySettings) {
    final Element guiel = root.getChild(GUI_STATE_ELEMENT_KEY);
    if (null != guiel) {
  ...
  public Settings readSettings(final ImagePlus imp) {
    return readSettings(imp, new DetectorProvider(), new TrackerProvider(), new SpotAnalyzerProvider((imp == null) ? 1 : imp.getNChannels()), new EdgeAnalyzerProvider(), new TrackAnalyzerProvider(), new SpotMorphologyAnalyzerProvider((imp == null) ? 1 : imp.getNChannels()));
  }
  ...
  /**
	 ...
	 */
  public Settings readSettings(final ImagePlus imp, final DetectorProvider detectorProvider, final TrackerProvider trackerProvider, final SpotAnalyzerProvider spotAnalyzerProvider, final EdgeAnalyzerProvider edgeAnalyzerProvider, final TrackAnalyzerProvider trackAnalyzerProvider, final SpotMorphologyAnalyzerProvider spotMorphologyAnalyzerProvider) {
    final Element settingsElement = root.getChild(SETTINGS_ELEMENT_KEY);
    if (null == settingsElement) {
      return null;
    }
    ...
    readAnalyzers(settingsElement, settings, spotAnalyzerProvider, edgeAnalyzerProvider, trackAnalyzerProvider, spotMorphologyAnalyzerProvider);
    return settings;
  }
  ...
  /**
	 ...
	 *            parameters.
	 */
  protected void getDetectorSettings(final Element settingsElement, final Settings settings, final DetectorProvider provider) {
  ...
  /**
	 ...
	 *            parameters.
	 */
  protected void getTrackerSettings(final Element settingsElement, final Settings settings, final TrackerProvider provider) {
  ...
  private void readAnalyzers(final Element settingsElement, final Settings settings, final SpotAnalyzerProvider spotAnalyzerProvider, final EdgeAnalyzerProvider edgeAnalyzerProvider, final TrackAnalyzerProvider trackAnalyzerProvider, final SpotMorphologyAnalyzerProvider spotMorphologyAnalyzerProvider) {
  ...
  private void readSingleFeatureDeclaration(final Element child, final Collection<String> features, final Map<String, String> featureNames, final Map<String, String> featureShortNames, final Map<String, Dimension> featureDimensions, final Map<String, Boolean> isIntFeature) {
