...
@Extension public class ConfigurationSlicing extends ManagementLink {
  ...
  @CheckForNull @Override public Permission getRequiredPermission() {
    return Jenkins.ADMINISTER;
  }

  @SuppressWarnings(value = { "unchecked" }) public List<Slicer> getAxes() {
  ...
  public class SliceExecutor<T extends Slice, I extends java.lang.Object> {
    Slicer<T, I> slicer;
    ...
    @RequirePOST public void doSliceconfigSubmit(StaplerRequest req, StaplerResponse rsp) throws IOException, ServletException {
