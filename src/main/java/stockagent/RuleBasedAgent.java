...
public class RuleBasedAgent implements StockAgent, SensorInterface {
  ...
  @Override public void buyStock(LocalSensor sensor, Stock symbol) throws IOException {
  ...
  @Override public void sellStock() {
  }

  @Override public HashMap<Stock, Integer> getPorfolio() {
    return porfolio;
  }

  @Override public double getBuyingPower() {
    return buyingPower;
  }
  ...
  @Override public double getStockPrice(Stock stock) {
    return 0;
  }
}