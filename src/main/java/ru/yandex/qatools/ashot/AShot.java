...
public class AShot implements Serializable {
  ...
  @SuppressWarnings(value = { "UnusedDeclaration" }) public AShot imageCropper(ImageCropper cropper) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "UnusedDeclaration" }) public AShot screenTaker(ScreenTaker taker) {
    this.taker = taker;
    return this;
  }
  ...
  /**
     ...
     * @return this
     */
  @SuppressWarnings(value = { "UnusedDeclaration" }) public synchronized AShot ignoredElements(final Set<By> ignoredElements) {
  ...
  /**
     ...
     * @return aShot
     */
  @SuppressWarnings(value = { "UnusedDeclaration" }) public synchronized AShot ignoredAreas(final Set<Coords> ignoredAreas) {
  ...
  /**
     ...
     * @return aShot;
     */
  @SuppressWarnings(value = { "UnusedDeclaration" }) public synchronized AShot addIgnoredArea(Coords area) {
  ...
  public Screenshot takeScreenshot(WebDriver driver, Collection<WebElement> elements) {
    ...
    Set<Coords> ignoredAreas = compileIgnoredAreas(driver, intersectingWith(
...
>>>>>>> /usr/src/app/output/yandex-qatools/ashot/c885c16709720ca016eeaad7056c0a39a9490878/src/main/java/ru/yandex/qatools/ashot/AShot.java/right.java
  ...
  @SuppressWarnings(value = { "UnusedDeclaration" }) public synchronized Set<By> getIgnoredLocators() {
