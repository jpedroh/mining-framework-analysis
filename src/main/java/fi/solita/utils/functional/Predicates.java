...
public abstract class Predicates {
  public static final <T extends java.lang.Object> Predicate<T> not(final Apply<T, Boolean> filter) {
    return new Predicate<T>() {
      @Override public boolean accept(T candidate) {
        return !filter.apply(candidate);
      }
    };
  }

  public static <T extends java.lang.Object> Predicate<T> nulls() {
    return new Predicate<T>() {
      @Override public boolean accept(T candidate) {
  ...
  public static final Predicate<Integer> even = new Predicate<Integer>() {
    @Override public boolean accept(Integer candidate) {
      return candidate % 2 == 0;
    }
  };

  public static <E extends java.lang.Object, T extends Iterable<E>> Predicate<T> empty() {
    return new Predicate<T>() {
      @Override public boolean accept(T candidate) {
  ...
  public static final Predicate<String> empty = new Predicate<String>() {
    @Override public boolean accept(String candidate) {
      return candidate.isEmpty();
    }
  };

  public static <T extends java.lang.Object> Predicate<T> equalTo(final T element) {
    return new Predicate<T>() {
      @Override public boolean accept(T candidate) {
  ...
  public static <T extends java.lang.Object> Predicate<Class<?>> isInstance(final Class<T> clazz) {
    return new Predicate<Class<?>>() {
      @Override public boolean accept(Class<?> candidate) {
        return clazz.isAssignableFrom(candidate);
      }
    };
  }

  public static <T extends java.lang.Object> Predicate<T> instanceOf(final Class<? extends T> clazz) {
    return new Predicate<T>() {
      @Override public boolean accept(T candidate) {
  ...
  public static Predicate<Option<?>> defined() {
    return new Predicate<Option<?>>() {
      @Override public boolean accept(Option<?> candidate) {
