...
public class ELOCalculator {
	...
	public static double calculate(double winnerRating, int winnerScore, double loserRating, int loserScore) {
		...
		} else // The game was drawn, give 25% of the max score to the lowest rated team
