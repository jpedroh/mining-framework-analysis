...
@Repository @Transactional(propagation = Propagation.REQUIRED) public class DefaultScoreBoardService implements ScoreBoardService {
  private GameDao gameDao;

  private PlayerDao playerDao;

  @Autowired public DefaultScoreBoardService(GameDao gameDao, PlayerDao playerDao) {
    this.gameDao = gameDao;
    this.playerDao = playerDao;
  }

  @Override public Player createNewPlayer(String name) {
  ...
  @Transactional(readOnly = true) @Override public List<Player> getAllPlayers() {
    return playerDao.getAllPlayers();
  }

  @Override public void saveGame(Game game) {
    gameDao.saveGame(game);
  }

  @Override public List<Game> getAllGames() {
  ...
  @Override public List<Game> getPlayerGames(Player player) {
  ...
  @Override public List<PlayerResult> getPlayerResults() {
  ...
  @Override public Player getPlayer(Long playerId) {
