...
@Mojo(name = "test", defaultPhase = LifecyclePhase.TEST, threadSafe = true) public class CasperJSRunnerMojo extends AbstractMojo {
  @Parameter(property = "casperjs.executable", defaultValue = "casperjs") private String casperExec;

  @Parameter(property = "casperjs.tests.directory", defaultValue = "${basedir}/src/test/js") private File testsDir;
  ...
  @Parameter private List<String> testsPatterns;
  ...
  @Parameter(property = "casperjs.include.javascript") private boolean includeJS = true;

  @Parameter(property = "casperjs.include.coffeescript") private boolean includeCS = true;
  ...
  @Parameter(property = "casperjs.xunit") private String xUnit;

  @Parameter(property = "casperjs.logLevel") private String logLevel;

  @Parameter(property = "casperjs.direct") private boolean direct = false;

  @Parameter(property = "casperjs.failFast") private boolean failFast = false;
...
<<<<<<< /usr/src/app/output/linsolas/casperjs-runner-maven-plugin/db79e3697d8d54d644dcace723c4a1cf41f7237d/src/main/java/fr/linsolas/casperjsrunner/CasperJSRunnerMojo.java/left.java
...
>>>>>>> /usr/src/app/output/linsolas/casperjs-runner-maven-plugin/db79e3697d8d54d644dcace723c4a1cf41f7237d/src/main/java/fr/linsolas/casperjsrunner/CasperJSRunnerMojo.java/right.java
  ...
  private List<File> findFiles(String ext, File folder) {
    ...
    for (File f : folder.listFiles()) {
      if (f.isDirectory()) {
        ...
        if (StringUtils.endsWithIgnoreCase(f.getName(), ext)) {
          files.add(f);
        }
      }
    }
