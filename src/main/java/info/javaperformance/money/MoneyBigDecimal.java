...
class MoneyBigDecimal extends AbstractMoney {
  ...
  public MoneyBigDecimal(final double value) {
    m_value = new BigDecimal(value, MathContext.DECIMAL64).stripTrailingZeros();
  }
  ...
  @Override protected int compareTo(MoneyLong other) {
  ...
  public Money multiply(double multiplier) {
    return MoneyFactory.fromBigDecimal(m_value.multiply(new BigDecimal(multiplier, MathContext.DECIMAL64), MathContext.DECIMAL64));
  }
