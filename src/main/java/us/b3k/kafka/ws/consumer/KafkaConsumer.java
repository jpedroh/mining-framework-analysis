...
public class KafkaConsumer {
  ...
  static public class KafkaConsumerTask implements Runnable {
    ...
    public KafkaConsumerTask(KafkaStream stream, Async remoteEndpoint, final Transform transform, final Session session) {
      this.stream = stream;
    ...
    @Override @SuppressWarnings(value = { "unchecked" }) public void run() {
