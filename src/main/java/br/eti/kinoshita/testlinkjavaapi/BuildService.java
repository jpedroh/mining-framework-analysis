...
class BuildService extends BaseService {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected Build createBuild(Integer testPlanId, String buildName, String buildNotes) throws TestLinkAPIException {
    Build build = null;
    Integer id = 0;
  ...
  /**
     ...
     * @return
     */
  @SuppressWarnings(value = { "unchecked" }) protected Build[] getBuildsForTestPlan(Integer testPlanId) throws TestLinkAPIException {
    Build[] builds = null;
    try {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) protected Build getLatestBuildForTestPlan(Integer testPlanId) throws TestLinkAPIException {
    Build build = null;
    try {
      Map<String, Object> executionData = new HashMap<String, Object>();
      executionData.put(TestLinkParams.TEST_PLAN_ID.toString(), testPlanId);
  ...
  /**
     ...
     * @return
     */
  @SuppressWarnings(value = { "unchecked" }) protected Map<String, Object> getExecCountersByBuild(Integer testPlanId) {
