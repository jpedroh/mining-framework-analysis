...
public class PolishHolidays implements Holidays {
  private static final Set<MonthDay> FIXED_HOLIDAYS = ImmutableSet.of(MonthDay.of(JANUARY, 1), MonthDay.of(JANUARY, 6), MonthDay.of(MAY, 1), MonthDay.of(MAY, 3), MonthDay.of(AUGUST, 15), MonthDay.of(NOVEMBER, 1), MonthDay.of(NOVEMBER, 11), MonthDay.of(DECEMBER, 25), MonthDay.of(DECEMBER, 26));

  public boolean isHoliday(LocalDate date) {
    return isWeekend(date) || isFixedHoliday(date) || isEasterMonday(date) || isCorpusChristi(date);
  }
