...
public class HecJsonSerializer {
  ...
  private Gson gson = new GsonBuilder().registerTypeAdapter(HttpEventCollectorEventInfo.class, typeAdapter).disableHtmlEscaping().create();
  ...
  @SuppressWarnings(value = { "unchecked" }) private void setValue(String key, String value) {
