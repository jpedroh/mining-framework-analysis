...
<<<<<<< /usr/src/app/output/splunk/splunk-library-javalogging/50d43431cf4765430bcb7938cdabb7cca0a0f688/src/main/java/com/splunk/logging/HttpEventCollectorSender.java/left.java
  OkHttpClient
=======
  String
>>>>>>> /usr/src/app/output/splunk/splunk-library-javalogging/50d43431cf4765430bcb7938cdabb7cca0a0f688/src/main/java/com/splunk/logging/HttpEventCollectorSender.java/right.java
   
<<<<<<< /usr/src/app/output/splunk/splunk-library-javalogging/50d43431cf4765430bcb7938cdabb7cca0a0f688/src/main/java/com/splunk/logging/HttpEventCollectorSender.java/left.java
  httpSharedClient = new OkHttpClient()
=======
  PlainTextHttpContentType = "plain/text; charset=utf-8"
>>>>>>> /usr/src/app/output/splunk/splunk-library-javalogging/50d43431cf4765430bcb7938cdabb7cca0a0f688/src/main/java/com/splunk/logging/HttpEventCollectorSender.java/right.java
  ;
  ...
  /**
     ...
     */
  public static final int DefaultBatchInterval = 10 * 1000;

  public static final int DefaultBatchSize = 10 * 1024;
  ...
  public HttpEventCollectorSender(final String Url, final String token, final String channel, final String type, long delay, long maxEventsBatchCount, long maxEventsBatchSize, String sendModeStr, Map<String, String> metadata, TimeoutSettings timeoutSettings) {
    ...
    if (sendModeStr != null) {
      if (sendModeStr.equals(SendModeSequential)) {
        ...
        if (sendModeStr.equals(SendModeSParallel)) {
  ...
  /**
     ...
     */
  public synchronized void send(final String severity, final String message, final String logger_name, final String thread_name, Map<String, String> properties, final String exception_message, Serializable marker) {
  ...
  private void postEventsAsync(final List<HttpEventCollectorEventInfo> events) {
    this.middleware.postEvents(events, this, new HttpEventCollectorMiddleware.IHttpSenderCallback() {
      @Override public void completed(int statusCode, String reply) {
        if (statusCode != 200) {
