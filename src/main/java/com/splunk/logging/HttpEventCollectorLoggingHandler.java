...
public final class HttpEventCollectorLoggingHandler extends Handler {
  ...
  @Override public void publish(LogRecord record) {
    this.sender.send(record.getLevel().toString(), record.getMessage(), includeLoggerName ? record.getLoggerName() : null, includeThreadName ? String.format(Locale.US, "%d", record.getThreadID()) : null, null, (!includeException || record.getThrown() == null) ? null : record.getThrown().getMessage(), null);
  }
