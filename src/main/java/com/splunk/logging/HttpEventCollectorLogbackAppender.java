 ...
 */
public class HttpEventCollectorLogbackAppender<E extends java.lang.Object> extends AppenderBase<E> {
  ...
  private 
<<<<<<< /usr/src/app/output/splunk/splunk-library-javalogging/f80bc59f417077de739ae23c10be9b1658219bed/src/main/java/com/splunk/logging/HttpEventCollectorLogbackAppender.java/left.java
  String
=======
  HttpEventCollectorSender.TimeoutSettings
>>>>>>> /usr/src/app/output/splunk/splunk-library-javalogging/f80bc59f417077de739ae23c10be9b1658219bed/src/main/java/com/splunk/logging/HttpEventCollectorLogbackAppender.java/right.java
   
<<<<<<< /usr/src/app/output/splunk/splunk-library-javalogging/f80bc59f417077de739ae23c10be9b1658219bed/src/main/java/com/splunk/logging/HttpEventCollectorLogbackAppender.java/left.java
  _eventHeaderSerializer
=======
  timeoutSettings = new HttpEventCollectorSender.TimeoutSettings()
>>>>>>> /usr/src/app/output/splunk/splunk-library-javalogging/f80bc59f417077de739ae23c10be9b1658219bed/src/main/java/com/splunk/logging/HttpEventCollectorLogbackAppender.java/right.java
  ;
  ...
  @Override public void start() {
    ...
    this.sender = new HttpEventCollectorSender(_url, _token, _channel, _type, _batchInterval, _batchCount, _batchSize, _sendMode, metadata, timeoutSettings);
  ...
  @Override protected void append(E e) {
  ...
  private void sendEvent(ILoggingEvent event) {
    ...
    if (this.started) {
      this.sender.send(event.getLevel().toString(), _layout.doLayout((E) event), _includeLoggerName ? event.getLoggerName() : null, _includeThreadName ? event.getThreadName() : null, _includeMDC ? event.getMDCPropertyMap() : null, (!_includeException || event.getThrowableProxy() == null) ? null : event.getThrowableProxy().getMessage(), c.convert(event));
    }
  }
  ...
  private void sendEvent(E e) {
    ...
    if (message == null) {
      throw new IllegalArgumentException(String.format("The logback layout %s is probably incorrect, " + "and fails to format the message.", _layout.toString()));
    }
