...
public class RpcServer extends RemotingServer {
  ...
  private final EventLoopGroup bossGroup = NettyEventLoopUtil.newEventLoopGroup(1, new NamedThreadFactory("Rpc-netty-server-boss", true));
