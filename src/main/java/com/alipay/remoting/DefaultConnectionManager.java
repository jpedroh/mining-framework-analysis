...
public class DefaultConnectionManager implements ConnectionManager, ConnectionHeartbeatManager, Scannable {
  ...
  /**
     ...
     */
  private int minPoolSize = SystemProperties.conn_create_tp_min_size();

  /**
     * max pool size for asyncCreateConnectionExecutor
     */
  private int maxPoolSize = SystemProperties.conn_create_tp_max_size();

  /**
     * queue size for asyncCreateConnectionExecutor
     */
  private int queueSize = SystemProperties.conn_create_tp_queue_size();

  /**
     * keep alive time for asyncCreateConnectionExecutor
     */
  private long keepAliveTime = SystemProperties.conn_create_tp_keepalive();
  ...
  /**
     ...
     */
  public DefaultConnectionManager(ConnectionSelectStrategy connectionSelectStrategy, ConnectionFactory connctionFactory) {
  ...
  /**
     ...
     */
  public DefaultConnectionManager(ConnectionSelectStrategy connectionSelectStrategy, ConnectionFactory connctionFactory, ConnectionEventHandler connectionEventHandler, ConnectionEventListener connectionEventListener) {
  ...
  /**
     ...
     */
  @Override public void add(Connection connection) {
  ...
  /**
     ...
     */
  @Override public void add(Connection connection, String poolKey) {
  ...
  /**
     ...
     */
  @Override public Connection get(String poolKey) {
  ...
  /**
     ...
     */
  @Override public List<Connection> getAll(String poolKey) {
    ConnectionPool pool = this.getConnectionPool(this.connTasks.get(poolKey));
  ...
  /**
     ...
     */
  @Override public void remove(Connection connection) {
    if (null == connection) {
      return;
    }
    Set<String> poolKeys = connection.getPoolKeys();
  ...
  /**
     ...
     */
  @Override public void remove(Connection connection, String poolKey) {
  ...
  /**
     ...
     */
  @Override public Connection create(String ip, int port, int connectTimeout) throws RemotingException {
    Connection conn = null;
    try {
  ...
  /**
     ...
     */
  @Override public Connection create(String address, int connectTimeout) throws RemotingException {
  ...
  /**
     ...
     */
  @Override public void disableHeartbeat(Connection connection) {
    if (null != connection) {
  ...
  /**
     ...
     */
  @Override public void enableHeartbeat(Connection connection) {
    if (null != connection) {
  ...
  private class ConnectionPoolCall implements Callable<ConnectionPool> {
    ...
    @Override public ConnectionPool call() throws Exception {
