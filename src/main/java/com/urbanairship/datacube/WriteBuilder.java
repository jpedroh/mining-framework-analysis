...
public class WriteBuilder {
  ...
  public <O extends java.lang.Object> WriteBuilder at(Dimension<O> dimension, O coord) {
  ...
  private static SetMultimap<BucketType, byte[]> serializeCoords(Multimap<BucketType, CSerializable> inputMap) {
