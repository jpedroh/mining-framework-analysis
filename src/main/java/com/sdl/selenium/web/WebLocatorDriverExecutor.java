...
public class WebLocatorDriverExecutor implements WebLocatorExecutor {
  ...
  @Override public boolean doClick(WebLocator el) {
  ...
  @Override public boolean doClickAt(WebLocator el) {
    if (highlight) {
      doHighlight(el);
    }
    focus(el);
  ...
  @Override public boolean doubleClickAt(WebLocator el) {
    boolean clicked;
    try {
  ...
  @Override public boolean clear(WebLocator el) {
    boolean clear;
    if (isElementPresent(el)) {
      try {
  ...
  @Override public void doSendKeys(WebLocator el, java.lang.CharSequence... charSequences) {
    if (isElementPresent(el)) {
      try {
  ...
  @Override public boolean setValue(WebLocator el, String value) {
  ...
  @Override public String getCssValue(final WebLocator el, final String propertyName) {
  ...
  @Override public String getTagName(final WebLocator el) {
    String tag = null;
    if (isElementPresent(el)) {
  ...
  @Override public String getAttribute(final WebLocator el, final String attribute) {
  ...
  @Override public String getCurrentElementAttribute(final WebLocator el, final String attribute) {
    String attributeValue = null;
    try {
      if (isElementPresent(el)) {
  ...
  @Override public String getHtmlText(WebLocator el) {
    String text = null;
    if (isElementPresent(el)) {
      try {
  ...
  @Override public String getHtmlSource() {
    return driver.getPageSource();
  }

  @Override public String getHtmlSource(WebLocator el) {
    String text = null;
    if (isElementPresent(el)) {
  ...
  @Override public String getValue(WebLocator el) {
    return getAttribute(el, "value");
  }

  @Override public boolean isElementPresent(WebLocator el) {
    findElement(el);
    return el.currentElement != null;
  }

  @Override public WebElement findElement(WebLocator el) {
  ...
  @Override public WebElement waitElement(final WebLocator el, final long millis) {
  ...
  @Override public int size(WebLocator el) {
    return findElements(el).size();
  }

  @Override public Point getLocation(WebLocator el) {
    isElementPresent(el);
    return el.currentElement.getLocation();
  }

  @Override public Dimension getSize(WebLocator el) {
    isElementPresent(el);
    return el.currentElement.getSize();
  }

  @Override public void focus(WebLocator el) {
    fireEventWithJS(el, "mouseover");
  }

  @Override public void doMouseOver(WebLocator el) {
    Actions builder = new Actions(driver);
    builder.moveToElement(el.currentElement).perform();
  }

  @Override public void blur(WebLocator el) {
    fireEventWithJS(el, "blur");
  }

  @Override public boolean isTextPresent(WebLocator el, String text) {
    return driver.getPageSource().contains(text);
  }

  @Override public boolean exists(WebLocator el) {
    return size(el) > 0;
  }

  @Override public boolean isSelected(WebLocator el) {
  ...
  @Override public Object executeScript(String script, Object... objects) {
  ...
  @Override public void doHighlight(WebLocator el) {
