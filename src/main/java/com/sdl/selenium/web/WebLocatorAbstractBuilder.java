...
public abstract class WebLocatorAbstractBuilder {
  ...
  /**
     ...
     * @return class
     */
  @Deprecated public String getCls() {
    return cls;
  }
  ...
  /**
     ...
     * @return this element
     */
  @Deprecated public <T extends WebLocatorAbstractBuilder> T setCls(final String cls) {
    this.cls = cls;
    return (T) this;
  }
  ...
  public String getItemPathText() {
    ...
    if (hasText()) {
      ...
      if (searchTextType.contains(SearchType.EQUALS)) {
        ...
        if (searchTextType.contains(SearchType.STARTS_WITH)) {
  ...
  public String getLabelPath() {
    return "//" + getLabelTag() + "[text()=" + Utils.getEscapeQuotesText(getLabel()) + "]";
  }
}