...
public class ChromeConfigReader extends AbstractBrowserConfigReader {
  ...
  @Override public WebDriver createDriver() throws IOException {
    DesiredCapabilities capabilities = getDesiredCapabilities();
    return new ChromeDriver(capabilities);
  }

  @Override public WebDriver createDriver(URL remoteUrl) throws IOException {
    DesiredCapabilities capabilities = getDesiredCapabilities();
    if (isRemoteDriver()) {
  ...
  @Override public boolean isSilentDownload() {
