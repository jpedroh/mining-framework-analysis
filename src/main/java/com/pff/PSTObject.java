...
public class PSTObject {
  /**
     ...
     */
  public static final int NID_TYPE_HID = 0x00;

  /**
     * The constant NID_TYPE_INTERNAL.
     */
  public static final int NID_TYPE_INTERNAL = 0x01;

  /**
     * The constant NID_TYPE_NORMAL_FOLDER.
     */
  public static final int NID_TYPE_NORMAL_FOLDER = 0x02;

  /**
     * The constant NID_TYPE_SEARCH_FOLDER.
     */
  public static final int NID_TYPE_SEARCH_FOLDER = 0x03;

  /**
     * The constant NID_TYPE_NORMAL_MESSAGE.
     */
  public static final int NID_TYPE_NORMAL_MESSAGE = 0x04;

  /**
     * The constant NID_TYPE_ATTACHMENT.
     */
  public static final int NID_TYPE_ATTACHMENT = 0x05;

  /**
     * The constant NID_TYPE_SEARCH_UPDATE_QUEUE.
     */
  public static final int NID_TYPE_SEARCH_UPDATE_QUEUE = 0x06;

  /**
     * The constant NID_TYPE_SEARCH_CRITERIA_OBJECT.
     */
  public static final int NID_TYPE_SEARCH_CRITERIA_OBJECT = 0x07;

  /**
     * The constant NID_TYPE_ASSOC_MESSAGE.
     */
  public static final int NID_TYPE_ASSOC_MESSAGE = 0x08;

  /**
     * The constant NID_TYPE_CONTENTS_TABLE_INDEX.
     */
  public static final int NID_TYPE_CONTENTS_TABLE_INDEX = 0x0A;

  /**
     * The constant NID_TYPE_RECEIVE_FOLDER_TABLE.
     */
  public static final int NID_TYPE_RECEIVE_FOLDER_TABLE = 0X0B;

  /**
     * The constant NID_TYPE_OUTGOING_QUEUE_TABLE.
     */
  public static final int NID_TYPE_OUTGOING_QUEUE_TABLE = 0x0C;

  /**
     * The constant NID_TYPE_HIERARCHY_TABLE.
     */
  public static final int NID_TYPE_HIERARCHY_TABLE = 0x0D;

  /**
     * The constant NID_TYPE_CONTENTS_TABLE.
     */
  public static final int NID_TYPE_CONTENTS_TABLE = 0x0E;

  /**
     * The constant NID_TYPE_ASSOC_CONTENTS_TABLE.
     */
  public static final int NID_TYPE_ASSOC_CONTENTS_TABLE = 0x0F;

  /**
     * The constant NID_TYPE_SEARCH_CONTENTS_TABLE.
     */
  public static final int NID_TYPE_SEARCH_CONTENTS_TABLE = 0x10;

  /**
     * The constant NID_TYPE_ATTACHMENT_TABLE.
     */
  public static final int NID_TYPE_ATTACHMENT_TABLE = 0x11;

  /**
     * The constant NID_TYPE_RECIPIENT_TABLE.
     */
  public static final int NID_TYPE_RECIPIENT_TABLE = 0x12;

  /**
     * The constant NID_TYPE_SEARCH_TABLE_INDEX.
     */
  public static final int NID_TYPE_SEARCH_TABLE_INDEX = 0x13;

  /**
     * The constant NID_TYPE_LTP.
     */
  public static final int NID_TYPE_LTP = 0x1F;
  ...
  /**
     ...
     */
  protected PSTObject(final PSTFile theFile, final DescriptorIndexNode descriptorIndexNode) throws PSTException, IOException {
    this.pstFile = theFile;
    this.descriptorIndexNode = descriptorIndexNode;
    final PSTTableBC table = new PSTTableBC(new PSTNodeInputStream(this.pstFile, this.pstFile.getOffsetIndexNode(descriptorIndexNode.dataOffsetIndexIdentifier)));
  ...
  /**
     ...
     */
  protected PSTObject(final PSTFile theFile, final DescriptorIndexNode folderIndexNode, final PSTTableBC table, final HashMap<Integer, PSTDescriptorItem> localDescriptorItems) {
    this.pstFile = theFile;
  ...
  static String createJavaString(final byte[] data, final int stringType, String codepage) {
    try {
      ...
      if (codepage == null) {
        ...
        if (codepage.contentEquals("ISO-8859-8-I")) {
          codepage = "ISO-8859-8";
        }
        try {
  ...
  public String getStringCodepage() {
    if (codepage == null) {
      PSTTableBCItem cpItem = this.items.get(0x3FFD);
      if (cpItem == null) {
        cpItem = this.items.get(0x66C3);
        if (cpItem == null) {
          cpItem = this.items.get(0x3FDE);
        }
      }
      if (cpItem != null) {
  ...
  /**
     ...
     * @throws PSTException the pst exception
     */
  public static PSTObject detectAndLoadPSTObject(final PSTFile theFile, final long descriptorIndex) throws IOException, PSTException {
  ...
  /**
     ...
     * @throws PSTException the pst exception
     */
  static PSTObject detectAndLoadPSTObject(final PSTFile theFile, final DescriptorIndexNode folderIndexNode) throws IOException, PSTException {
    final int nidType = (folderIndexNode.descriptorIdentifier & 0x1F);
    if (nidType == 0x02 || nidType == 0x03 || nidType == 0x04) {
      final PSTTableBC table = new PSTTableBC(new PSTNodeInputStream(theFile, theFile.getOffsetIndexNode(folderIndexNode.dataOffsetIndexIdentifier)));
  ...
  /**
     ...
     */
  static PSTMessage createAppropriatePSTMessageObject(final PSTFile theFile, final DescriptorIndexNode folderIndexNode, final PSTTableBC table, final HashMap<Integer, PSTDescriptorItem> localDescriptorItems) {
  ...
  /**
     ...
     * @throws PSTException the pst exception
     */
  static String guessPSTObjectType(final PSTFile theFile, final DescriptorIndexNode folderIndexNode) throws IOException, PSTException {
    final PSTTableBC table = new PSTTableBC(new PSTNodeInputStream(theFile, theFile.getOffsetIndexNode(folderIndexNode.dataOffsetIndexIdentifier)));
    ...
    while (iterator.hasNext()) {
      ...
      if (key.intValue() >= 0x0001 && key.intValue() <= 0x0bff) {
        ...
        if (key.intValue() >= 0x1000 && key.intValue() <= 0x2fff) {
          return "Message content";
        } else {
          if (key.intValue() >= 0x3400 && key.intValue() <= 0x35ff) {
            return "Message store";
          } else {
            if (key.intValue() >= 0x3600 && key.intValue() <= 0x36ff) {
              return "Folder and address book";
            } else {
              if (key.intValue() >= 0x3700 && key.intValue() <= 0x38ff) {
                return "Attachment";
              } else {
                if (key.intValue() >= 0x3900 && key.intValue() <= 0x39ff) {
                  return "Address book";
                } else {
                  if (key.intValue() >= 0x3a00 && key.intValue() <= 0x3bff) {
                    return "Messaging user";
                  } else {
                    if (key.intValue() >= 0x3c00 && key.intValue() <= 0x3cff) {
