...
public abstract class AbstractResources {
  ...
  /**
	 ...
	 * @throws SmartsheetException the smartsheet exception
	 */
  protected <T extends java.lang.Object> T getResource(String path, Class<T> objectClass) throws SmartsheetException {
  ...
  /**
	 ...
	 * @throws SmartsheetException the smartsheet exception
	 */
  protected <T extends java.lang.Object, S extends java.lang.Object> T createResource(String path, Class<T> objectClass, S object) throws SmartsheetException {
  ...
  /**
	 ...
	 * @throws SmartsheetException the smartsheet exception
	 */
  protected <T extends java.lang.Object> T createResourceWithAttachment(String path, Class<T> objectClass, T object, String partName, InputStream inputStream, String contentType, String attachmentName) throws SmartsheetException {
  ...
  /**
	 ...
	 * @throws SmartsheetException the smartsheet exception
	 */
  protected <T extends java.lang.Object> T updateResource(String path, Class<T> objectClass, T object) throws SmartsheetException {
    Util.throwIfNull(path, object);
    Util.throwIfEmpty(path);
    HttpRequest request;
  ...
  /**
	 ...
	 */
  protected <T extends java.lang.Object> List<T> listResources(String path, Class<T> objectClass) throws SmartsheetException {
    Util.throwIfNull(path, objectClass);
    Util.throwIfEmpty(path);
    HttpRequest request;
  ...
  /**
	 ...
	 */
  protected <T extends java.lang.Object> PagedResult<T> listResourcesWithWrapper(String path, Class<T> objectClass) throws SmartsheetException {
    Util.throwIfNull(path, objectClass);
    Util.throwIfEmpty(path);
    HttpRequest request;
    request = createHttpRequest(smartsheet.getBaseURI().resolve(path), HttpMethod.GET);
  ...
  /**
	 ...
	 * @throws SmartsheetException the smartsheet exception
	 */
  protected <T extends java.lang.Object> void deleteResource(String path, Class<T> objectClass) throws SmartsheetException {
    Util.throwIfNull(path, objectClass);
    Util.throwIfEmpty(path);
    HttpRequest request;
  ...
  /**
	 ...
	 * @throws SmartsheetException the smartsheet exception
	 */
  protected <T extends java.lang.Object> List<T> deleteListResources(String path, Class<T> objectClass) throws SmartsheetException {
    Util.throwIfNull(path, objectClass);
    Util.throwIfEmpty(path);
  ...
  /**
	 ...
	 * @throws SmartsheetException the smartsheet exception
	 */
  protected <T extends java.lang.Object, S extends java.lang.Object> List<S> postAndReceiveList(String path, T objectToPost, Class<S> objectClassToReceive) throws SmartsheetException {
  ...
  /**
	 ...
	 * @throws SmartsheetException the smartsheet exception
	 */
  protected <T extends java.lang.Object, S extends java.lang.Object> List<S> putAndReceiveList(String path, T objectToPut, Class<S> objectClassToReceive) throws SmartsheetException {
  ...
  /**
	 ...
	 * @throws UnsupportedEncodingException the unsupported encoding exception
	 */
  public <T extends java.lang.Object> Attachment attachFile(String url, T t, String partName, InputStream inputstream, String contentType, String attachmentName) throws SmartsheetException {
    Util.throwIfNull(inputstream, contentType);
    Attachment attachment = null;
    final String boundary = "----" + System.currentTimeMillis();
    CloseableHttpClient httpClient = HttpClients.createDefault();
  ...
  protected void handleError(HttpResponse response) throws SmartsheetException {
    ...
    try {
      error = this.smartsheet.getJsonSerializer().deserialize(com.smartsheet.api.models.Error.class, response.getEntity().getContent());
    } catch (JsonParseException e) {
      throw new SmartsheetException(e);
    } catch (JsonMappingException e) {
      throw new SmartsheetException(e);
