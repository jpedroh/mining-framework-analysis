...
@Configuration @EnableWebMvc @ComponentScan(basePackages = { "com.jeroenreijn.examples.controller", "com.jeroenreijn.examples.factory" }) public class WebMvcConfig implements ApplicationContextAware, WebMvcConfigurer {
  ...
  @Bean public PresentationsRepository presentationsRepository() {
  ...
  @Bean public ViewResolver handlebarsViewResolver() {
  ...
  @Bean(name = "chunkTemplatesConfig") @Scope(value = "prototype") public Map<String, String> chunkTemplatesConfig() {
  ...
  @Bean public ViewResolver chunkViewResolver() {
  ...
  @Bean public ViewResolver httlViewResolver() {
  ...
  @Bean public SpringTemplateLoader jade4jTemplateLoader() {
    SpringTemplateLoader templateLoader = new SpringTemplateLoader();
    templateLoader.setEncoding("UTF-8");
    return templateLoader;
  }

  @Bean public JadeConfiguration jadeConfiguration() {
  ...
  @Bean public ViewResolver jadeViewResolver() {
  ...
  @Bean public ViewResolver htmlFlowViewResolver() {
  ...
  @Bean public ViewResolver trimouViewResolver() {
  ...
  @Bean public ViewResolver rockerViewResolver() {
  ...
  @Bean public ViewResolver ickenhamViewResolver() {
  ...
  @Bean public RythmConfigurer rythmConfigurer() {
  ...
  @Bean public ViewResolver rythmViewResolver() {
  ...
  @Bean public LiqpViewResolver liqpViewResolver() {
  ...
  @Bean public ViewResolver kotlinxHtmlViewResolver() {
  ...
  @Controller static class FaviconController {
    @RequestMapping(value = "favicon.ico") String favicon() {
