...
<<<<<<< /usr/src/app/output/spotify/netty-zmtp/8d02651ebcbfc80ea17699b5547176248b2635c7/src/main/java/com/spotify/netty/handler/codec/zmtp/ZMTPUtils.java/left.java
      if (out.order() == BIG_ENDIAN) {
        out.writeLong(size);
      } else {
        out.writeLong(ByteBufUtil.swapLong(size));
      }
=======
      writeLong(out, size);
>>>>>>> /usr/src/app/output/spotify/netty-zmtp/8d02651ebcbfc80ea17699b5547176248b2635c7/src/main/java/com/spotify/netty/handler/codec/zmtp/ZMTPUtils.java/right.java
    }
  }
   ...
   */
  public static void writeFrame(final ZMTPFrame frame, final ByteBuf buffer, final boolean more, final int version) {
    if (version == 1) {
   ...
   */
  @SuppressWarnings(value = { "ForLoopReplaceableByForEach" }) public static void writeMessage(final ZMTPMessage message, final ByteBuf buffer, final boolean enveloped, int version) {
    if (enveloped) {
   ...
   */
  @SuppressWarnings(value = { "ForLoopReplaceableByForEach" }) public static int messageSize(final ZMTPMessage message, final boolean enveloped, final int version) {
   ...
   */
  @SuppressWarnings(value = { "ForLoopReplaceableByForEach" }) public static int framesSize(final List<ZMTPFrame> frames, final int version) {
    int size = 0;
