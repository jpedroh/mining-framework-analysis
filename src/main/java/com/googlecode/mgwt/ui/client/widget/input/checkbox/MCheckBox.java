...
public class MCheckBox extends TouchWidget implements HasValue<Boolean>, IsEditor<LeafValueEditor<Boolean>> {
  ...
  @UiField public Element on;

  @UiField public Element middle;

  @UiField public Element off;
  ...
  @Override public com.google.gwt.event.shared.HandlerRegistration addValueChangeHandler(ValueChangeHandler<Boolean> handler) {
  ...
  @Override public LeafValueEditor<Boolean> asEditor() {
    if (editor == null) {
  ...
  @UiFactory public MCheckBoxAppearance getAppearance() {
    return appearance;
  }
