...
public class AgentMain {
  ...
  public static synchronized void main(final String args, final Instrumentation inst) {
    try {
      ...
      final ConsoleServer consoleServer = (ConsoleServer) agentLoader.loadClass("com.googlecode.greysanatomy.console.server.ConsoleServer").getMethod("getInstance", Configer.class, Instrumentation.class).invoke(null, configer, inst);
