 ...
 * @author vlinux
 */
@RiscCmd(named = "sm", sort = 1, desc = "Search all have been class method JVM loading.", eg = { "sm org\\.apache\\.commons\\.lang\\.StringUtils .*", "sm -d org\\.apache\\.commons\\.lang\\.StringUtils .*" }) public class SearchMethodCommand extends Command {
  ...
  @RiscNamedArg(named = "d", description = "show the detail of method") private boolean isDetail = false;

  @Override public Action getAction() {
    return new Action() {
      @Override public void action(final ConsoleServer consoleServer, Info info, Sender sender) throws Throwable {
