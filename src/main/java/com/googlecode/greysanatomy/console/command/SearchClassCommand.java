 ...
 * @author vlinux
 */
@RiscCmd(named = "sc", sort = 0, desc = "Search all have been loaded by the JVM class.", eg = { "sc org\\.apache\\.commons\\.lang\\.StringUtils", "sc -s org\\.apache\\.commons\\.lang\\.StringUtils", "sc -d org\\.apache\\.commons\\.lang\\.StringUtils", "sc -sd .*StringUtils" }) public class SearchClassCommand extends Command {
  @RiscIndexArg(index = 0, name = "class-regex", description = "regex match of classpath.classname") private String classRegex;

  @RiscNamedArg(named = "s", description = "including class\'s parents") private boolean isSuper = false;

  @RiscNamedArg(named = "d", description = "show the detail of class") private boolean isDetail = false;
