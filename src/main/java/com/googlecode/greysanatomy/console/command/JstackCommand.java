 ...
 * @author vlinux
 */
@RiscCmd(named = "jstack", sort = 7, desc = "The call stack output buried point method in each thread.", eg = { "jstack org\\.apache\\.commons\\.lang\\.StringUtils isEmpty", "jstack .*StringUtils isEmpty" }) public class JstackCommand extends Command {
