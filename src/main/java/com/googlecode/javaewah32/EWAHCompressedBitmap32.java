...
public final class EWAHCompressedBitmap32 implements Cloneable, Externalizable, Iterable<Integer>, BitmapStorage32, LogicalElement<EWAHCompressedBitmap32> {
  ...
  /**
     ...
     */
  @Deprecated public void add(final int newData) {
    addWord(newData);
  }
  ...
  /**
     ...
     * @deprecated use addWord() instead.
     */
  @Deprecated public void add(final int newData, final int bitsThatMatter) {
  ...
  /**
     ...
     * @param newData the word
     */
  @Override public void addWord(final int newData) {
  ...
  private int addEmptyWord(final boolean v) {
    ...
    if ((noliteralword) && (this.rlw.getRunningBit() == v) && (runlen < RunningLengthWord32.LARGEST_RUNNING_LENGTH_COUNT)) {
  ...
  /**
     ...
     */
  @Override public void addStreamOfLiteralWords(final int[] data, final int start, final int number) {
    int leftovernumber = number;
    while (leftovernumber > 0) {
      final int numberOfLiteralWords = this.rlw.getNumberOfLiteralWords();
      final int whatWeCanAdd = leftovernumber < RunningLengthWord32.LARGEST_LITERAL_COUNT - numberOfLiteralWords ? leftovernumber : RunningLengthWord32.LARGEST_LITERAL_COUNT - numberOfLiteralWords;
  ...
  /**
     ...
     */
  @Override public void addStreamOfEmptyWords(final boolean v, int number) {
    if (number == 0) {
      return;
    }
  ...
  /**
     ...
     * @param number the number of literal words to add
     */
  @Override public void addStreamOfNegatedLiteralWords(final int[] data, final int start, final int number) {
    int leftovernumber = number;
    while (leftovernumber > 0) {
      final int NumberOfLiteralWords = this.rlw.getNumberOfLiteralWords();
      final int whatwecanadd = leftovernumber < RunningLengthWord32.LARGEST_LITERAL_COUNT - NumberOfLiteralWords ? leftovernumber : RunningLengthWord32.LARGEST_LITERAL_COUNT - NumberOfLiteralWords;
  ...
  /**
     ...
     */
  @Override public EWAHCompressedBitmap32 and(final EWAHCompressedBitmap32 a) {
  ...
  /**
     ...
     * @return the EWAH compressed bitmap
     */
  @Override public EWAHCompressedBitmap32 andNot(final EWAHCompressedBitmap32 a) {
    int size = this.actualSizeInWords > a.actualSizeInWords ? this.actualSizeInWords : a.actualSizeInWords;
    final EWAHCompressedBitmap32 container = new EWAHCompressedBitmap32(size);
  ...
  /**
     ...
     * @param container where we store the result
     */
  public void andNotToContainer(final EWAHCompressedBitmap32 a, final BitmapStorage32 container) {
    container.clear();
      ...
      while ((rlwi.getRunningLength() > 0) || (rlwj.getRunningLength() > 0)) {
        ...
        if (((predator.getRunningBit()) && (i_is_prey)) || ((!predator.getRunningBit()) && (!i_is_prey))) {
          ...
          if (i_is_prey) {
            ...
            final int index = prey.dischargeNegated(container, predator.getRunningLength());
  ...
  @Override public EWAHCompressedBitmap32 clone() {
  ...
  private void fastaddStreamOfEmptyWords(final boolean v, int number) {
    if ((this.rlw.getRunningBit() != v) && (this.rlw.size() == 0)) {
      ...
      if ((this.rlw.getNumberOfLiteralWords() != 0) || (this.rlw.getRunningBit() != v)) {
        push_back(0);
        this.rlw.position = this.actualSizeInWords - 1;
        if (v) {
    ...
    final int runLen = this.rlw.getRunningLength();
    final int whatWeCanAdd = number < RunningLengthWord32.LARGEST_RUNNING_LENGTH_COUNT - runLen ? number : RunningLengthWord32.LARGEST_RUNNING_LENGTH_COUNT - runLen;
  ...
  /**
     ...
     */
  private void negative_push_back(final int[] data, final int start, final int number) {
    while (this.actualSizeInWords + number >= this.buffer.length) {
      ...
      if (this.actualSizeInWords + number < 32768) {
        ...
        if ((this.actualSizeInWords + number) * 3 / 2 < this.actualSizeInWords + number) {
  ...
  /**
     ...
     * @return the EWAH compressed bitmap
     */
  @Override public EWAHCompressedBitmap32 or(final EWAHCompressedBitmap32 a) {
  ...
  private void push_back(final int data) {
    if (this.actualSizeInWords == this.buffer.length) {
      ...
      if (oldBuffer.length < 32768) {
        ...
        if (oldBuffer.length * 3 / 2 < oldBuffer.length) {
          this.buffer = new int[Integer.MAX_VALUE];
        } else {
  ...
  public boolean get(final int i) {
    ...
    while (wordChecked <= wordi) {
      ...
      if (wordi < wordChecked + j.getNumberOfLiteralWords()) {
        final int w = j.getLiteralWordAt(wordi - wordChecked);
        return (w & (1 << i)) != 0;
      }
  ...
  public boolean set(final int i) {
    ...
    if (dist > 0) {
      ...
      addLiteralWord(1 << (i % WORD_IN_BITS));
      return true;
    }
    ...
    this.buffer[this.actualSizeInWords - 1] |= 1 << (i % WORD_IN_BITS);
  ...
  /**
     ...
     */
  @Override public void setSizeInBitsWithinLastWord(final int size) {
    ...
    this.buffer[this.actualSizeInWords - 1] &= ((~0) >>> (WORD_IN_BITS - usedBitsInLast));
    if (this.buffer[this.actualSizeInWords - 1] == 0) {
      this.rlw.setNumberOfLiteralWords(this.rlw.getNumberOfLiteralWords() - 1);
      this.actualSizeInWords -= 1;
      this.addEmptyWord(false);
  ...
  /**
     ...
     */
  @Override public int sizeInBits() {
  ...
  /**
     ...
     * @since 0.8.2
     */
  public static EWAHCompressedBitmap32 threshold(final int t, final EWAHCompressedBitmap32... bitmaps) {
    final EWAHCompressedBitmap32 container = new EWAHCompressedBitmap32();
  ...
  /**
     ...
     * @since 0.8.2
     */
  public static void thresholdWithContainer(final BitmapStorage32 container, final int t, final EWAHCompressedBitmap32... bitmaps) {
  ...
  /**
     ...
     * @return the EWAH compressed bitmap
     */
  @Override public EWAHCompressedBitmap32 xor(final EWAHCompressedBitmap32 a) {
    final EWAHCompressedBitmap32 container = new EWAHCompressedBitmap32();
    container.reserve(this.actualSizeInWords + a.actualSizeInWords);
  ...
  /**
     ...
     * @param container where we store the result
     */
  public void xorToContainer(final EWAHCompressedBitmap32 a, final BitmapStorage32 container) {
    container.clear();
    final EWAHIterator32 i = a.getEWAHIterator();
    final EWAHIterator32 j = getEWAHIterator();
    final IteratingBufferedRunningLengthWord32 rlwi = new IteratingBufferedRunningLengthWord32(i);
    ...
    while ((rlwi.size() > 0) && (rlwj.size() > 0)) {
      while ((rlwi.getRunningLength() > 0) || (rlwj.getRunningLength() > 0)) {
        ...
        final IteratingBufferedRunningLengthWord32 prey = i_is_prey ? rlwi : rlwj;
        final IteratingBufferedRunningLengthWord32 predator = i_is_prey ? rlwj : rlwi;
        final int index = (!predator.getRunningBit()) ? prey.discharge(container, predator.getRunningLength()) : prey.dischargeNegated(container, predator.getRunningLength());
  ...
  /**
     ...
     * @return the EWAH compressed bitmap
     */
  @Override public EWAHCompressedBitmap32 compose(EWAHCompressedBitmap32 a) {
  ...
  /**
     ...
     */
  public static void andWithContainer(final BitmapStorage32 container, final EWAHCompressedBitmap32... bitmaps) {
    if (bitmaps.length == 1) {
  ...
  /**
     ...
     */
  public static void orWithContainer(final BitmapStorage32 container, final EWAHCompressedBitmap32... bitmaps) {
    if (bitmaps.length < 2) {
  ...
  /**
     ...
     * @param bitmaps   to be aggregated
     */
  public static void xorWithContainer(final BitmapStorage32 container, final EWAHCompressedBitmap32... bitmaps) {
    if (bitmaps.length < 2) {
      throw new IllegalArgumentException("You should provide at least two bitmaps, provided " + bitmaps.length);
    }
    int size = 0;
