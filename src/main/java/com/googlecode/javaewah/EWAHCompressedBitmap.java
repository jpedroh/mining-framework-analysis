...
public final class EWAHCompressedBitmap implements Cloneable, Externalizable, Iterable<Integer>, BitmapStorage, LogicalElement<EWAHCompressedBitmap> {
  ...
  /**
     ...
     */
  @Deprecated public void add(final long newData) {
    addWord(newData);
  }
  ...
  /**
     ...
     * @deprecated use addWord() instead.
     */
  @Deprecated public void add(final long newData, final int bitsThatMatter) {
  ...
  /**
     ...
     * @param newData the word
     */
  @Override public void addWord(final long newData) {
  ...
  /**
     ...
     */
  @Override public void addStreamOfLiteralWords(final long[] data, final int start, final int number) {
  ...
  /**
     ...
     */
  @Override public void addStreamOfEmptyWords(final boolean v, long number) {
    if (number == 0) {
      return;
    }
  ...
  /**
     ...
     * @param number the number of literal words to add
     */
  @Override public void addStreamOfNegatedLiteralWords(final long[] data, final int start, final int number) {
    int leftOverNumber = number;
    while (leftOverNumber > 0) {
      final int numberOfLiteralWords = this.rlw.getNumberOfLiteralWords();
      final int whatWeCanAdd = leftOverNumber < RunningLengthWord.LARGEST_LITERAL_COUNT - numberOfLiteralWords ? leftOverNumber : RunningLengthWord.LARGEST_LITERAL_COUNT - numberOfLiteralWords;
  ...
  /**
     ...
     * @since 0.4.3
     */
  @Override public EWAHCompressedBitmap and(final EWAHCompressedBitmap a) {
  ...
  /**
     ...
     * @return the EWAH compressed bitmap
     */
  @Override public EWAHCompressedBitmap andNot(final EWAHCompressedBitmap a) {
    int size = this.actualSizeInWords > a.actualSizeInWords ? this.actualSizeInWords : a.actualSizeInWords;
    final EWAHCompressedBitmap container = new EWAHCompressedBitmap(size);
  ...
  @Override public EWAHCompressedBitmap clone() {
  ...
  /**
     ...
     * @return the EWAH compressed bitmap
     */
  @Override public EWAHCompressedBitmap or(final EWAHCompressedBitmap a) {
  ...
  /**
     ...
     * @return the EWAH compressed bitmap
     */
  @Override public EWAHCompressedBitmap xor(final EWAHCompressedBitmap a) {
    int size = this.actualSizeInWords + a.actualSizeInWords;
    final EWAHCompressedBitmap container = new EWAHCompressedBitmap(size);
  ...
  /**
     ...
     * @return the EWAH compressed bitmap
     */
  @Override public EWAHCompressedBitmap compose(EWAHCompressedBitmap a) {
