...
public class IteratorAggregation {
  ...
  public static IteratingRLW and(final IteratingRLW... al) {
    ...
    final int MAXBUFSIZE = 65536 * al.length;
    Iterator<EWAHIterator> i = new Iterator<EWAHIterator>() {
      ...
      @Override public EWAHIterator next() {
        buffer.clear();
        IteratorAggregation.andToContainer(buffer, MAXBUFSIZE, ll.get(0), ll.get(1));
        if (ll.size() > 2) {
          ...
          while (i.hasNext() && buffer.sizeInBytes() > 0) {
            IteratorAggregation.andToContainer(tmpbuffer, buffer.getIteratingRLW(), i.next());
  ...
  public static IteratingRLW xor(final IteratingRLW x1, final IteratingRLW x2) {
    ...
    Iterator<EWAHIterator> i = new Iterator<EWAHIterator>() {
      ...
      @Override public EWAHIterator next() {
        buffer.clear();
        IteratorAggregation.xorToContainer(buffer, MAXBUFSIZE, x1, x2);
        return buffer.getEWAHIterator();
      }
  ...
  private static void andToContainer(final BitmapStorage container, int desiredrlwcount, final IteratingRLW rlwi, IteratingRLW rlwj) {
  ...
  private static void andToContainer(final BitmapStorage container, final IteratingRLW rlwi, IteratingRLW rlwj) {
  ...
  private static void xorToContainer(final BitmapStorage container, int desiredrlwcount, final IteratingRLW rlwi, IteratingRLW rlwj) {
    while ((rlwi.size() > 0) && (rlwj.size() > 0) && (desiredrlwcount-- > 0)) {
      while ((rlwi.getRunningLength() > 0) || (rlwj.getRunningLength() > 0)) {
        final boolean i_is_prey = rlwi.getRunningLength() < rlwj.getRunningLength();
        final IteratingRLW prey = i_is_prey ? rlwi : rlwj;
