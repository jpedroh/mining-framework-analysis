...
public final class MergeRequestHookTriggerHandlerFactory {
  ...
  public static MergeRequestHookTriggerHandler newMergeRequestHookTriggerHandler(boolean triggerOnMergeRequest, boolean triggerOnlyWithNewCommitsPushed, boolean triggerOnAcceptedMergeRequest, boolean triggerOnClosedMergeRequest, TriggerOpenMergeRequest triggerOpenMergeRequest, boolean skipWorkInProgressMergeRequest, String labelsThatForcesBuildIfAdded, boolean triggerOnApprovedMergeRequest, boolean cancelPendingBuildsOnUpdate) {
    TriggerConfigChain chain = new TriggerConfigChain();
    chain.acceptOnlyIf(triggerOnApprovedMergeRequest, null, of(Action.approved)).acceptIf(triggerOnMergeRequest, of(State.opened, State.reopened), null).acceptIf(triggerOnAcceptedMergeRequest, null, of(Action.merge)).acceptIf(triggerOnClosedMergeRequest, null, of(Action.closed)).acceptIf(triggerOpenMergeRequest != TriggerOpenMergeRequest.never, of(State.updated), null);
  ...
  public static MergeRequestHookTriggerHandler newMergeRequestHookTriggerHandler(MergeRequestTriggerConfig config) {
    return newMergeRequestHookTriggerHandler(config.getTriggerOnMergeRequest(), config.isTriggerOnlyIfNewCommitsPushed(), config.isTriggerOnAcceptedMergeRequest(), config.isTriggerOnClosedMergeRequest(), config.getTriggerOpenMergeRequestOnPush(), config.isSkipWorkInProgressMergeRequest(), config.getLabelsThatForcesBuildIfAdded(), config.isTriggerOnApprovedMergeRequest(), config.getCancelPendingBuildsOnUpdate());
  }
...
<<<<<<< /usr/src/app/output/dabsquared/gitlab-plugin/387517997c283739cbe1f4c0de882e6be6dd8b12/src/main/java/com/dabsquared/gitlabjenkins/trigger/handler/merge/MergeRequestHookTriggerHandlerFactory.java/left.java
    private boolean triggerOnlyIfNewCommitsPushed = false;
=======
    private String labelsThatForcesBuildIfAdded;
>>>>>>> /usr/src/app/output/dabsquared/gitlab-plugin/387517997c283739cbe1f4c0de882e6be6dd8b12/src/main/java/com/dabsquared/gitlabjenkins/trigger/handler/merge/MergeRequestHookTriggerHandlerFactory.java/right.java
