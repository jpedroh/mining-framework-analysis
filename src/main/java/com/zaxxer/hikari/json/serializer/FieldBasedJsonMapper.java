...
@SuppressWarnings(value = { "restriction" }) public final class FieldBasedJsonMapper implements ObjectMapper {
  ...
  @Override @SuppressWarnings(value = { "unchecked" }) final public <T extends java.lang.Object> T readValue(final InputStream src, final Class<T> valueType) {
    source = src;
  ...
  private int parseArray(int bufferIndex, final ParseContext context) {
    ...
    do {
      ...
      switch (byteBuffer[bufferIndex]) {
        ...
        bufferIndex = parseValue(bufferIndex, context, nextContext);
        @SuppressWarnings(value = { "unchecked" }) Collection<Object> collection = ((Collection<Object>) context.target);
