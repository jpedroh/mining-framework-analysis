...
public class CronDefinition implements Serializable {
  ...
  @Override public boolean equals(Object o) {
    ...
    return matchDayOfWeekAndDayOfMonth == that.matchDayOfWeekAndDayOfMonth && fieldDefinitions.equals(that.fieldDefinitions) && cronConstraints.equals(that.cronConstraints) && cronNicknames.equals(that.cronNicknames);
  }

  @Override public int hashCode() {
    return Objects.hash(fieldDefinitions, cronConstraints, cronNicknames, matchDayOfWeekAndDayOfMonth);
  }
}