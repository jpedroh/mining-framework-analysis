...
public class ValueMappingFieldExpressionVisitor implements FieldExpressionVisitor {
  ...
  @Override public FieldExpression visit(Always always) {
    return always;
  }

  @Override public FieldExpression visit(And and) {
    And clone = new And();
