...
public class FieldParser {
  ...
  @VisibleForTesting protected FieldExpression parseBetween(String[] array) {
  ...
  @VisibleForTesting protected On parseOn(String exp) {
  ...
  @VisibleForTesting protected On parseOnWithQuestionMark(String exp) {
  ...
  @VisibleForTesting protected On parseOnWithLW(String exp) {
  ...
  @VisibleForTesting protected On parseOnWithL(String exp) {
  ...
  @VisibleForTesting protected On parseOnWithW(String exp) {
  ...
  @VisibleForTesting protected IntegerFieldValue mapToIntegerFieldValue(String string) {
    try {
  ...
  @VisibleForTesting protected FieldValue<?> map(String string) {
  ...
  /**
	 ...
	 */
  @VisibleForTesting protected int stringToInt(String exp) {
  ...
  /**
	 ...
	 */
  @VisibleForTesting protected int intToInt(Integer exp) {
