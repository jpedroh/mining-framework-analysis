...
public class CronMapper {
  ...
  private static Function<Cron, Cron> sameCron() {
    return new Function<Cron, Cron>() {
      @Override public Cron apply(Cron cron) {
        return cron;
      }
    };
  }
  ...
  /**
     ...
     */
  @VisibleForTesting static Function<CronField, CronField> returnSameExpression() {
    return new Function<CronField, CronField>() {
      @Override public CronField apply(CronField field) {
        return field;
      }
    };
  }
  ...
  /**
     ...
     * @return new Function<CronField, CronField> instance, never null
     */
  @VisibleForTesting static Function<CronField, CronField> returnAlwaysExpression(final CronFieldName name) {
    return new Function<CronField, CronField>() {
      @Override public CronField apply(CronField field) {
  ...
  @VisibleForTesting static Function<CronField, CronField> dayOfMonthMapping(final FieldDefinition sourceDef, final FieldDefinition targetDef) {
    return new Function<CronField, CronField>() {
      @Override public CronField apply(final CronField field) {
        FieldExpression expression = field.getExpression();
