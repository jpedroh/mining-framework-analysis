...
public class Args {
  ...
  @SuppressWarnings(value = { "unchecked" }) private static List<String> getEnumPossibleValues(Class<?> clazz) {
  ...
  public static final ValueCreator ENUM_CREATOR = new ValueCreator() {
    @SuppressWarnings(value = { "unchecked", "rawtypes" }) public Object createValue(Class type, String value) {
