...
public class HyperLogLog implements ICardinality, Serializable {
  ...
  /**
     ...
     */
  @Deprecated public HyperLogLog(int log2m, RegisterSet registerSet) {
    validateLog2m(log2m);
  ...
  @Override public boolean offerHashed(long hashedValue) {
  ...
  @Override public boolean offerHashed(int hashedValue) {
  ...
  public static class Builder implements IBuilder<ICardinality>, Serializable {
    ...
    /**
         ...
         */
    @Deprecated public Builder(double rsd) {
    ...
    @Override public HyperLogLog build() {
    ...
    public static Builder withAccuracy(double accuracy) {
      return new Builder(accuracyToLog2m(accuracy));
    }
  ...
  @SuppressWarnings(value = { "serial" }) protected static class HyperLogLogMergeException extends CardinalityMergeException {
