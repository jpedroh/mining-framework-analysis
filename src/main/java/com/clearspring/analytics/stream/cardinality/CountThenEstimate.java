...
public class CountThenEstimate implements ICardinality, Externalizable {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
  ...
  @Override public void writeExternal(ObjectOutput out) throws IOException {
    ...
    if (tipped) {
      if (estimator instanceof LinearCounting) {
        ...
        if (estimator instanceof AdaptiveCounting) {
          out.writeByte(AC);
        } else {
          if (estimator instanceof HyperLogLog) {
            out.writeByte(HLC);
          } else {
            if (estimator instanceof LogLog) {
              out.writeByte(LLC);
            } else {
  ...
  @SuppressWarnings(value = { "serial" }) protected static class CountThenEstimateMergeException extends CardinalityMergeException {
