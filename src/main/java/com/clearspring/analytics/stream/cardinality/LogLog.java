...
public class LogLog implements ICardinality {
  ...
  /**
     ...
     */
  @Override public ICardinality merge(ICardinality... estimators) throws LogLogMergeException {
  ...
  @SuppressWarnings(value = { "serial" }) protected static class LogLogMergeException extends CardinalityMergeException {
