...
public class LinearCounting implements ICardinality {
  ...
  /**
     ...
     */
  @Override public ICardinality merge(ICardinality... estimators) throws LinearCountingMergeException {
  ...
  @SuppressWarnings(value = { "serial" }) protected static class LinearCountingMergeException extends CardinalityMergeException {
  ...
  public static class Builder implements IBuilder<ICardinality>, Serializable {
    ...
    /**
         ...
         */
    protected final static int[] onePercentErrorLength = { 5034, 5067, 5100, 5133, 5166, 5199, 5231, 5264, 5296, 5329, 5647, 5957, 6260, 6556, 6847, 7132, 7412, 7688, 7960, 10506, 12839, 15036, 17134, 19156, 21117, 23029, 24897, 26729, 43710, 59264, 73999, 88175, 101932, 115359, 128514, 141441, 154171, 274328, 386798, 494794, 599692, 702246, 802931, 902069, 999894, 1096582 };
    ...
    @Override public LinearCounting build() {
