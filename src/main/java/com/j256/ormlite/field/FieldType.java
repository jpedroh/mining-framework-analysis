...
public class FieldType {
  ...
  public void configDaoInformation(ConnectionSource connectionSource, Class<?> parentClass) throws SQLException {
    ...
    if (fieldConfig.isForeignAutoRefresh() || foreignColumnName != null) {
      ...
      @SuppressWarnings(value = { "unchecked" }) MappedQueryForFieldEq<Object, Object> castMappedQueryForForeignField = (MappedQueryForFieldEq<Object, Object>) MappedQueryForFieldEq.build(databaseType, foreignTableInfo, foreignRefField);
      ...
      if (fieldConfig.isForeign()) {
        ...
        if (fieldConfig.isForeignCollection()) {
          ...
          if (tableConfig == null) {
            @SuppressWarnings(value = { "unchecked" }) BaseDaoImpl<Object, Object> castDao = (BaseDaoImpl<Object, Object>) DaoManager.createDao(connectionSource, collectionClazz);
            foundDao = castDao;
          } else {
            @SuppressWarnings(value = { "unchecked" }) BaseDaoImpl<Object, Object> castDao = (BaseDaoImpl<Object, Object>) DaoManager.createDao(connectionSource, tableConfig);
            foundDao = castDao;
          }
          foreignDao = foundDao;
  ...
  private Object createForeignObject(Object val, ObjectCache objectCache) throws SQLException {
    ...
    if (mappedQueryForForeignField == null) {
      @SuppressWarnings(value = { "unchecked" }) MappedQueryForFieldEq<Object, Object> castMappedQueryForId = (MappedQueryForFieldEq<Object, Object>) MappedQueryForFieldEq.build(connectionSource.getDatabaseType(), ((BaseDaoImpl<?, ?>) foreignDao).getTableInfo(), foreignIdField);
