...
public class FieldType {
  ...
  public FieldType(DatabaseType databaseType, String tableName, Field field, DatabaseFieldConfig fieldConfig, Class<?> parentClass) throws SQLException {
    ...
    if (fieldConfig.isForeign() || fieldConfig.isForeignAutoRefresh() || foreignColumnName != null) {
      ...
      if (fieldConfig.isForeignCollection()) {
        ...
        if (dataPersister == null && (!fieldConfig.isForeignCollection())) {
  ...
  /**
	 ...
	 */
  public <FT extends java.lang.Object, FID extends java.lang.Object> void configDaoInformation(ConnectionSource connectionSource, Class<?> parentClass) throws SQLException {
    Class<?> fieldClass = field.getType();
    DatabaseType databaseType = connectionSource.getDatabaseType();
    final FieldType foreignIdField;
    final FieldType foreignRefField;
    final FieldType foreignFieldType;
    final Dao<FT, FID> foreignDao;
    final MappedQueryForFieldEq<FT, FID> mappedQueryForForeignField;
    String foreignColumnName = fieldConfig.getForeignColumnName();
    if (fieldConfig.isForeignAutoRefresh() || foreignColumnName != null) {
      ...
      TableInfo<FT, FID> foreignTableInfo;
      if (tableConfig == null) {
        @SuppressWarnings(value = { "unchecked" }) Dao<FT, FID> castDao = (Dao<FT, FID>) DaoManager.createDao(connectionSource, fieldClass);
        foreignDao = castDao;
        foreignTableInfo = foreignDao.getTableInfo();
      } else {
        tableConfig.extractFieldTypes(databaseType);
        @SuppressWarnings(value = { "unchecked" }) Dao<FT, FID> castDao = (Dao<FT, FID>) DaoManager.createDao(connectionSource, tableConfig);
        foreignDao = castDao;
      ...
      MappedQueryForFieldEq<FT, FID> castMappedQueryForForeignField = MappedQueryForFieldEq.build(foreignDao, foreignTableInfo, foreignRefField);
      ...
      if (fieldConfig.isForeign()) {
        ...
        TableInfo<FT, FID> foreignTableInfo = foreignDao.getTableInfo();
        foreignIdField = foreignTableInfo.getIdField();
        if (foreignIdField == null) {
          throw new IllegalArgumentException("Foreign field " + fieldClass + " does not have id field");
        }
        ...
        if (fieldConfig.isForeignCollection()) {
          ...
          @SuppressWarnings(value = { "unchecked" }) Class<FT> collectionClazz = (Class<FT>) genericArguments[0];
          @SuppressWarnings(value = { "unchecked" }) DatabaseTableConfig<FT> tableConfig = (DatabaseTableConfig<FT>) fieldConfig.getForeignTableConfig();
          Dao<FT, FID> foundDao;
          if (tableConfig == null) {
            Dao<FT, FID> castDao = DaoManager.createDao(connectionSource, collectionClazz);
            foundDao = castDao;
          } else {
            Dao<FT, FID> castDao = DaoManager.createDao(connectionSource, tableConfig);
            foundDao = castDao;
          }
          foreignDao = foundDao;
  ...
  /**
	 ...
	 */
  public <FV extends java.lang.Object> FV extractRawJavaFieldValue(Object object) throws SQLException {
    Object val;
    ...
    @SuppressWarnings(value = { "unchecked" }) FV converted = (FV) val;
    return converted;
  }
  ...
  /**
	 ...
	 *            collection.
	 */
  public <FT extends java.lang.Object, FID extends java.lang.Object> BaseForeignCollection<FT, FID> buildForeignCollection(Object parent, FID id) throws SQLException {
    if (foreignFieldType == null) {
      return null;
    }
    @SuppressWarnings(value = { "unchecked" }) Dao<FT, FID> castDao = (Dao<FT, FID>) foreignDao;
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> T resultToJava(DatabaseResults results, Map<String, Integer> columnPositions) throws SQLException {
    ...
    @SuppressWarnings(value = { "unchecked" }) T converted = (T) fieldConverter.resultToJava(this, results, dbColumnPos);
    if (fieldConfig.isForeign()) {
      ...
      if (dataPersister.isPrimitive()) {
        ...
        if (!fieldConverter.isStreamType() && results.wasNull(dbColumnPos)) {
          return null;
        }
      }
    }
  ...
  /**
	 ...
	 */
  public <FV extends java.lang.Object> FV getFieldValueIfNotDefault(Object object) throws SQLException {
    @SuppressWarnings(value = { "unchecked" }) FV fieldValue = (FV) extractJavaFieldValue(object);
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> int createWithForeignDao(T foreignData) throws SQLException {
    @SuppressWarnings(value = { "unchecked" }) Dao<T, ?> castDao = (Dao<T, ?>) foreignDao;
  ...
  /**
	 ...
	 */
  @Deprecated public static FieldType createFieldType(ConnectionSource connectionSource, String tableName, Field field, Class<?> parentClass) throws SQLException {
  ...
  @Override public boolean equals(Object arg) {
    ...
    return field.equals(other.field) && (parentClass == null ? other.parentClass == null : parentClass.equals(other.parentClass));
  }
  ...
  private Object createForeignObject(ConnectionSource connectionSource, Object val, ObjectCache objectCache) throws SQLException {
    ...
    if (mappedQueryForForeignField == null) {
      @SuppressWarnings(value = { "unchecked" }) Dao<Object, Object> castDao = (Dao<Object, Object>) foreignDao;
      MappedQueryForFieldEq<Object, Object> castMappedQueryForId = MappedQueryForFieldEq.build(castDao, castDao.getTableInfo(), foreignIdField);
    ...
    try {
      ...
      try {
        @SuppressWarnings(value = { "unchecked" }) MappedQueryForFieldEq<Object, Object> castMappedQueryForForeignField = (MappedQueryForFieldEq<Object, Object>) mappedQueryForForeignField;
  ...
  /**
	 ...
	 */
  private <FT extends java.lang.Object, FID extends java.lang.Object> FT createForeignShell(ConnectionSource connectionSource, Object val, ObjectCache objectCache) throws SQLException {
    @SuppressWarnings(value = { "unchecked" }) Dao<FT, FID> castDao = (Dao<FT, FID>) foreignDao;
    ...
    for (FieldType fieldType : foreignDao.getTableInfo().getFieldTypes()) {
      if (fieldType.getType() == foreignClass && (foreignColumnName == null || fieldType.getField().getName().equals(foreignColumnName))) {
        if (!fieldType.fieldConfig.isForeign() && !fieldType.fieldConfig.isForeignAutoRefresh()) {
          throw new SQLException("Foreign collection object " + clazz + " for field \'" + field.getName() + "\' contains a field of class " + foreignClass + " but it\'s not foreign");
        }
        return fieldType;
      }
    }
