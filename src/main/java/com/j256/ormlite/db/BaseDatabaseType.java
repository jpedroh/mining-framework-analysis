...
public abstract class BaseDatabaseType implements DatabaseType {
  ...
  /**
	 ...
	 */
  @Deprecated protected String getDriverClassName() {
    return null;
  }
  ...
  @Override public boolean loadDriver() {
    for (String className : getDriverClassNames()) {
      ...
      try {
        ...
        logger.warn("Driver class was not found for " + getDatabaseName() + " database.  Class not found: " + className, e);
      }
    }
    return false;
  }

  @Override public void setDriver(Driver driver) {
    this.driver = driver;
  }

  @Override public void appendColumnArg(String tableName, StringBuilder sb, FieldType fieldType, List<String> additionalArgs, List<String> statementsBefore, List<String> statementsAfter, List<String> queriesAfter) throws SQLException {
  ...
  @Override public void addPrimaryKeySql(FieldType[] fieldTypes, List<String> additionalArgs, List<String> statementsBefore, List<String> statementsAfter, List<String> queriesAfter) {
  ...
  @Override public void addUniqueComboSql(FieldType[] fieldTypes, List<String> additionalArgs, List<String> statementsBefore, List<String> statementsAfter, List<String> queriesAfter) {
    StringBuilder sb = null;
    for (FieldType fieldType : fieldTypes) {
  ...
  @Override public void dropColumnArg(FieldType fieldType, List<String> statementsBefore, List<String> statementsAfter) {
  }

  @Override public void appendEscapedWord(StringBuilder sb, String word) {
    sb.append('\'').append(word).append('\'');
  }

  @Override public void appendEscapedEntityName(StringBuilder sb, String name) {
    sb.append('`');
  ...
  @Override public String generateIdSequenceName(String tableName, FieldType idFieldType) {
  ...
  @Override public String getCommentLinePrefix() {
    return "-- ";
  }

  @Override public DataPersister getDataPersister(DataPersister defaultPersister, FieldType fieldType) {
    return defaultPersister;
  }

  @Override public FieldConverter getFieldConverter(DataPersister dataPersister, FieldType fieldType) {
    return dataPersister;
  }

  @Override public boolean isIdSequenceNeeded() {
    return false;
  }
  ...
  @Override public boolean isLimitSqlSupported() {
    return true;
  }

  @Override public boolean isOffsetSqlSupported() {
    return true;
  }

  @Override public boolean isOffsetLimitArgument() {
    return false;
  }

  @Override public boolean isLimitAfterSelect() {
    return false;
  }

  @Override public void appendLimitValue(StringBuilder sb, long limit, Long offset) {
    sb.append("LIMIT ").append(limit).append(' ');
  }

  @Override public void appendOffsetValue(StringBuilder sb, long offset) {
    sb.append("OFFSET ").append(offset).append(' ');
  }

  @Override public void appendSelectNextValFromSequence(StringBuilder sb, String sequenceName) {
  }

  @Override public void appendCreateTableSuffix(StringBuilder sb) {
  }

  @Override public boolean isCreateTableReturnsZero() {
    return true;
  }

  @Override public boolean isCreateTableReturnsNegative() {
    return false;
  }
  ...
  @Override public String upCaseEntityName(String entityName) {
    return upCaseString(entityName, true);
  }

  @Override public String upCaseString(String string, boolean forceEnglish) {
    if (forceEnglish) {
  ...
  @Override public String downCaseString(String string, boolean forceEnglish) {
    if (forceEnglish) {
  ...
  @Override public boolean isNestedSavePointsSupported() {
    return true;
  }

  @Override public String getPingStatement() {
    return "SELECT 1";
  }

  @Override public boolean isBatchUseTransaction() {
    return false;
  }

  @Override public boolean isTruncateSupported() {
    return false;
  }

  @Override public boolean isCreateIfNotExistsSupported() {
    return false;
  }

  @Override public boolean isCreateIndexIfNotExistsSupported() {
    return isCreateIfNotExistsSupported();
  }

  @Override public boolean isSelectSequenceBeforeInsert() {
    return false;
  }

  @Override public boolean isAllowGeneratedIdInsertSupported() {
    return true;
  }
  ...
  /**
	 ...
	 *             for sub classes.
	 */
  @Override public <T extends java.lang.Object> DatabaseTableConfig<T> extractDatabaseTableConfig(ConnectionSource connectionSource, Class<T> clazz) throws SQLException {
    return null;
  }

  @Override public void appendInsertNoColumns(StringBuilder sb) {
    sb.append("() VALUES ()");
  }
  ...
  protected static class BooleanNumberFieldConverter extends BaseFieldConverter {
    ...
    @Override public Object javaToSqlArg(FieldType fieldType, Object obj) {
      Boolean bool = (Boolean) obj;
      return (bool ? Byte.valueOf((byte) 1) : Byte.valueOf((byte) 0));
    }

    @Override public Object resultToSqlArg(FieldType fieldType, DatabaseResults results, int columnPos) throws SQLException {
