...
public class WriterFactory {
  ...
  public static <T extends java.lang.Object> Writer<T> getJsonInstance(final OutputStream out, Map<Class, WriteHandler<?, ?>> customHandlers, boolean verboseMode) throws IOException {
    ...
    return new Writer<T>() {
      @Override public void write(T o) {
        try {
  ...
  public static <T extends java.lang.Object> Writer<T> getMsgpackInstance(final OutputStream out, Map<Class, WriteHandler<?, ?>> customHandlers) throws IOException {
