...
public class TunnelProxyServlet extends AsyncProxyServlet {
  ...
  @Override protected void onClientRequestFailure(HttpServletRequest clientRequest, Request proxyRequest, HttpServletResponse proxyResponse, Throwable failure) {
...
=======
  @Override protected void handleOnException(Throwable ex, HttpServletRequest request, HttpServletResponse response) {
...
>>>>>>> /usr/src/app/output/testingbot/testingbot-tunnel/03f9869d5ccd78ac84c044fcb9fdeeed2b7dcf7e/src/main/java/com/testingbot/tunnel/proxy/TunnelProxyServlet.java/right.java
  ...
  @Override protected Response.Listener newProxyResponseListener(HttpServletRequest request, HttpServletResponse response) {
    return new TunnelProxyResponseListener(request, response);
  }

  @Override protected void addProxyHeaders(HttpServletRequest clientRequest, Request proxyRequest) {
