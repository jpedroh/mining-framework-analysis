...
public class SimpleBuilderGenerator extends BuilderGenerator {
  ...
  @Override protected JDefinedClass generateExtendsClause(final BuilderOutline superClassBuilder) {
    return this.builderClass._extends(superClassBuilder.getDefinedBuilderClass());
  }

  @Override protected JMethod generateBuildMethod(final JMethod initMethod) {
  ...
  @Override protected JMethod generateBuilderMethod() {
