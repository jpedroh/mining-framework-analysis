...
public class FluentBuilderPlugin extends Plugin {
  ...
  @Override public int parseArgument(final Options opt, final String[] args, final int i) throws BadCommandLineException, IOException {
    ...
    if (arg.getArgsParsed() == 0) {
      arg = PluginUtil.parseBooleanArgument("fluent-builder-partial-clone", this.graphClone, opt, args, i);
  ...
  @Override public boolean run(final Outline outline, final Options opt, final ErrorHandler errorHandler) throws SAXException {
