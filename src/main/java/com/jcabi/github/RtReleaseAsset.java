 ...
 * @version $Id$
 */
@Immutable @Loggable(value = Loggable.DEBUG) @EqualsAndHashCode(of = { "request", "owner", "num" }) public final class RtReleaseAsset implements ReleaseAsset {
  /**
     * RESTful request.
     */
  ...
  @Override public Release release() {
    return this.owner;
  }
  ...
  /**
     ...
     */
  @Override public InputStream raw() throws IOException {
