 ...
 */
@Immutable @SuppressWarnings(value = { "PMD.TooManyMethods" }) public interface Gist extends JsonReadable {
  /**
     * Github we're in.
     * @return Github
     */
  ...
  /**
     ...
     */
  void write(@NotNull(message = "file name can\'t be NULL") String name, @NotNull(message = "file content can\'t be NULL") String content) throws IOException;
  ...
  /**
     ...
     * @throws IOException If there is any I/O problem
     */
  @NotNull(message = "gist is never NULL") Gist fork() throws IOException;
  ...
  /**
     ...
     */
  @NotNull(message = "comments are never NULL") GistComments comments() throws IOException;

  @Immutable @ToString @Loggable(value = Loggable.DEBUG) @EqualsAndHashCode(of = "gist") final class Smart implements Gist {
    /**
         * Encapsulated gist.
         */
    ...
    @Override public String read(final String name) throws IOException {
      return this.gist.read(name);
    }

    @Override public void write(final String name, final String content) throws IOException {
    ...
    @Override public void unstar() throws IOException {
      this.gist.unstar();
    }
