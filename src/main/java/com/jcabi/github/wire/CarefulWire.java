 ...
 * @version $Id$
 */
@Immutable @ToString @EqualsAndHashCode(of = { "origin", "threshold" }) @SuppressWarnings(value = { "PMD.AvoidDuplicateLiterals" }) public final class CarefulWire implements Wire {
  /**
     * Original wire.
     */
  ...
  /**
     ...
     */
  public CarefulWire(@NotNull(message = "wire can\'t be NULL") final Wire wire, final int thrshld) {
    this.origin = wire;
  ...
  /**
     ...
     */
  private String headerOrNull(@NotNull(message = "response can\'t be NULL") final Response resp, @NotNull(message = "header name can\'t be NULL") final String headername) {
  ...
  /**
     ...
     */
  private int remainingHeader(@NotNull(message = "response can\'t be NULL") final Response resp) {
  ...
  /**
     ...
     */
  private long resetHeader(@NotNull(message = "response can\'t be NULL") final Response resp) {
