 ...
 * @version $Id$
 */
@Immutable @Loggable(value = Loggable.DEBUG) @EqualsAndHashCode(of = { "request", "owner" }) final class RtPullComments implements PullComments {
  /**
     * API entry point.
     */
  ...
  @Override @NotNull(message = "Iterable of pull comments is never NULL") public Iterable<PullComment> iterate(@NotNull(message = "number can\'t be NULL") final int number, @NotNull(message = "params can\'t be NULL") final Map<String, String> params) {
    ...
    return new RtPagination<PullComment>(newreq.uri().queryParams(params).back(), new RtPagination.Mapping<PullComment, JsonObject>() {
      @Override public PullComment map(final JsonObject value) {
        return RtPullComments.this.get(value.getInt("id"));
      }
    });
  ...
  @Override @NotNull(message = "PullComment is never NULL") public PullComment post(@NotNull(message = "body can\'t be NULL") final String body, @NotNull(message = "commit can\'t be NULL") final String commit, @NotNull(message = "path can\'t be NULL") final String path, final int position) throws IOException {
  ...
  @Override @NotNull(message = "pull comment is never NULL") public PullComment reply(@NotNull(message = "text can\'t be NULL") final String body, @NotNull(message = "comment can\'t be NULL") final int comment) throws IOException {
