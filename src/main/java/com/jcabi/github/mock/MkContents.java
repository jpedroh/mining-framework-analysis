 ...
 * @since 0.8
 */
@Immutable @Loggable(value = Loggable.DEBUG) @ToString @EqualsAndHashCode(of = { "storage", "self", "coords" }) @SuppressWarnings(value = { "PMD.AvoidDuplicateLiterals", "PMD.TooManyMethods" }) final class MkContents implements Contents {
  /**
     * Storage.
     */
  ...
  /**
     ...
     */
  public MkContents(@NotNull(message = "stg can\'t be NULL") final MkStorage stg, @NotNull(message = "login can\'t be NULL") final String login, @NotNull(message = "rep can\'t be NULL") final Coordinates rep) throws IOException {
    this.storage = stg;
    this.self = login;
    this.coords = rep;
  ...
  @Override @NotNull(message = "the content is never NULL") public Content readme() throws IOException {
    return this.readme("master");
  }

  @Override @NotNull(message = "the content is never NULL") public Content readme(@NotNull(message = "github can\'t be  NULL") final String branch) throws IOException {
    return new MkContent(this.storage, this.self, this.coords, "README.md", branch);
  }

  @Override @NotNull(message = "created content is never NULL") public Content create(@NotNull(message = "json can\'t be NULL") final JsonObject json) throws IOException {
    this.storage.lock();
    final String branch;
    try {
  ...
  @Override @NotNull(message = "retrieved content is never NULL") public Content get(@NotNull(message = "path can\'t be NULL") final String path, @NotNull(message = "ref can\'t be NULL") final String ref) throws IOException {
    return new MkContent(this.storage, this.self, this.coords, path, ref);
  }

  @Override @NotNull(message = "retrieved content is never NULL") public Content get(@NotNull(message = "path can\'t be NULL") final String path) throws IOException {
    return new MkContent(this.storage, this.self, this.coords, path, "master");
  }

  @Override @NotNull(message = "Iterable of contents is never NULL") public Iterable<Content> iterate(@NotNull(message = "pattern can\'t be NULL") final String pattern, @NotNull(message = "ref can\'t be NULL") final String ref) throws IOException {
  ...
  @Override @NotNull(message = "commit is never NULL") public RepoCommit remove(@NotNull(message = "content should not be NULL") final JsonObject content) throws IOException {
    this.storage.lock();
  ...
  /**
     ...
     */
  @Override @NotNull(message = "updated commit is never NULL") public RepoCommit update(@NotNull(message = "path cannot be NULL") final String path, @NotNull(message = "json should not be NULL") final JsonObject json) throws IOException {
  ...
  /**
     ...
     * @throws IOException If any I/O problem occurs.
     */
  @Override @NotNull(message = "updated commit is never NULL") public RepoCommit update(@NotNull(message = "path cannot be NULL") final String path, @NotNull(message = "branch cannot be NULL") final String ref, @NotNull(message = "json should not be NULL") final JsonObject json) throws IOException {
    this.storage.lock();
    try {
      final String xpath = String.format("/github/repos/repo[@coords=\'%s\']/contents/content[path=\'%s\' and @ref=\'%s\']", this.coords, path, ref);
  ...
  /**
     ...
     */
  private MkContent mkContent(final String ref, final String path) throws IOException {
    return new MkContent(this.storage, this.self, this.coords, path, ref);
  }
  ...
  /**
     ...
     * @return The XPath
     */
  @NotNull(message = "Xpath is never NULL") private String xpath() {
  ...
  /**
     ...
     * @return Xpath
     */
  @NotNull(message = "commit xpath is never NULL") private String commitXpath() {
  ...
  /**
     ...
     */
  @NotNull(message = "MkRepoCommit is never NULL") private MkRepoCommit commit(@NotNull(message = "json can\'t be NULL") final JsonObject json) throws IOException {
  ...
  /**
     ...
     */
  @NotNull(message = "fake sha can\'t be NULL") private static String fakeSha() {
