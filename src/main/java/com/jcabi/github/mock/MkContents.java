 ...
 * @since 0.8
 */
@Immutable @Loggable(value = Loggable.DEBUG) @ToString @EqualsAndHashCode(of = { "storage", "self", "coords" }) @SuppressWarnings(value = { "PMD.AvoidDuplicateLiterals" }) public final class MkContents implements Contents {
  /**
     * Storage.
     */
  ...
  @Override @NotNull(message = "content is never NULL") public Content readme(@NotNull(message = "branch can\'t be NULL") final String branch) throws IOException {
