...
@Immutable @Loggable(value = Loggable.DEBUG) @ToString @EqualsAndHashCode(of = { "storage", "self", "coords" }) @SuppressWarnings(value = { "PMD.AvoidDuplicateLiterals", "PMD.TooManyMethods" }) final class MkContents implements Contents {
  ...
  @Override @NotNull(message = "the content is never NULL") public Content readme(final String branch) throws IOException {
  ...
  @Override @NotNull(message = "Iterable of contents is never NULL") public Iterable<Content> iterate(final String pattern, final String ref) throws IOException {
  ...
  @Override @NotNull(message = "updated commit is never NULL") public RepoCommit update(@NotNull(message = "path cannot be NULL") final String path, @NotNull(message = "json should not be NULL") final JsonObject json) throws IOException {
    this.storage.lock();
    try {
      final String xpath = String.format("/github/repos/repo[@coords=\'%s\']/contents/content[path=\'%s\']", this.coords, path);
