 ...
 * @since 0.1
 */
@Immutable @SuppressWarnings(value = { "PMD.TooManyMethods", "PMD.ExcessivePublicCount", "PMD.GodClass" }) public interface User extends JsonReadable, JsonPatchable {
  /**
     * Github we're in.
     * @return Github
     * @since 0.4
  ...
  @Immutable @ToString @Loggable(value = Loggable.DEBUG) @EqualsAndHashCode(of = { "user", "jsn" }) final class Smart implements User {
    /**
         * Encapsulated user.
         */
    ...
    /**
         ...
         * @param usr User
         */
    public Smart(@NotNull(message = "user can\'t be NULL") final User usr) {
      this.user = usr;
    ...
    /**
         ...
         * @throws IOException If it fails
         */
    @NotNull(message = "URL is never NULL") public URL avatarUrl() throws IOException {
    ...
    @Override @NotNull(message = "Keys is never NULL") public PublicKeys keys() {
      return this.user.keys();
    }

    @Override @NotNull(message = "Emails is never NULL") public UserEmails emails() {
      return this.user.emails();
    }

    @Override public List<Notification> notifications() throws IOException {
      final String pwd = "";
      final Response resp = new ApacheRequest("https://api.github.com/notifications").header(HttpHeaders.AUTHORIZATION, String.format("Basic %s", DatatypeConverter.printBase64Binary(String.format("%s:%s", this.user, pwd).getBytes(Charsets.UTF_8)))).fetch();
      final JsonResponse jsonresp = new JsonResponse(resp);
      final JsonArray jsnnotifs = jsonresp.json().readArray();
      final List<Notification> notifs = new LinkedList<Notification>();
      for (final JsonValue jsnnotif : jsnnotifs) {
        final JsonObject notifobj = (JsonObject) jsnnotif;
        final Notification notif = new RtNotification(notifobj.getInt("id"));
        notifs.add(notif);
      }
      return notifs;
    }
    ...
    /**
         ...
         */
    @NotNull(message = "Gravatar is never NULL") public String gravatar() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Html URL is never NULL") public String htmlUrl() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Followers URL is never NULL") public String follwersUrl() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Following URL is never NULL") public String followingUrl() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Gists URL is never NULL") public String gistsUrl() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Starred URL is never NULL") public String starredUrl() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Subscriptions URL is never NULL") public String subscriptionsUrl() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Organizations URL is never NULL") public String organizationsUrl() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Repos URL is never NULL") public String reposUrl() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Events URL is never NULL") public String eventsUrl() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Received enets URL is never NULL") public String receivedEventsUrl() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Hireable is never NULL") public boolean hireable() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Bio is never NULL") public String bio() throws IOException {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Created time is never NULL") public Github.Time created() throws IOException {
      try {
    ...
    /**
         ...
         * @throws IOException If any I/O error occurs.
         */
    @NotNull(message = "Updated time is never NULL") public Github.Time updated() throws IOException {
      try {
