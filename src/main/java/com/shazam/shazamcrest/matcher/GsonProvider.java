 ...
 */
@SuppressWarnings(value = { "rawtypes" }) class GsonProvider {
  /**
  ...
  private static void registerSetSerialisation(final GsonBuilder gsonBuilder) {
    gsonBuilder.registerTypeHierarchyAdapter(Set.class, new JsonSerializer<Set>() {
      @Override public JsonElement serialize(Set set, Type type, JsonSerializationContext context) {
        Gson gson = gsonBuilder.create();
  ...
  @SuppressWarnings(value = { "unchecked" }) private static Set<Object> orderSetByElementsJsonRepresentation(Set set, final Gson gson) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private static ArrayListMultimap<String, Object> mapObjectsByTheirJsonRepresentation(Map map, Gson gson) {
