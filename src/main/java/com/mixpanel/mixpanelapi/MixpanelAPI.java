...
public class MixpanelAPI {
    ...
    private static final int BUFFER_SIZE = 256; // Small, we expect small responses. private static final int CONNECT_TIMEOUT_MILLIS = 2000; // 30 seconds should be more than enough for a response. private static final int READ_TIMEOUT_MILLIS = 10000; // Two minutes should be more than enough for a response. private final String mEventsEndpoint; private final String mPeopleEndpoint; /**
