...
public abstract class AbstractCharInputReader implements CharInputReader {
  ...
  public AbstractCharInputReader(char[] lineSeparator, char normalizedLineSeparator) {
    ...
    this.lineSeparator2 = lineSeparator.length == 2 ? lineSeparator[1] : '\u0000';
  ...
  @Override public final char nextChar() {
    ...
    i++;
    if (lineSeparator1 == ch && (lineSeparator2 == '\u0000' || lineSeparator2 == buffer[i - 1])) {
      lineCount++;
      if (lineSeparator2 != '\u0000') {
  ...
  /**
	 * {@inheritDoc}
	 */
  @Override public final long lineCount() {
    return lineCount;
  }
  ...
  /**
	 * {@inheritDoc}
	 */
  @Override public final long charCount() {
    return charCount + i;
  }
}