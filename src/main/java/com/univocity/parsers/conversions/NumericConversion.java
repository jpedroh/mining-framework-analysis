...
public abstract class NumericConversion<T extends Number> extends ObjectConversion<T> implements FormattedConversion<DecimalFormat> {
  ...
  @Override public DecimalFormat[] getFormatterObjects() {
    return formatters;
  }
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) @Override protected T fromString(String input) {
  ...
  /**
	 ...
	 */
  @Override public String revert(T input) {
    if (input == null) {
