...
public class FieldMapping {
  ...
  public void write(Object instance, Object value) {
    ...
    try {
      ...
      ex.setValue(value);
      throw 
<<<<<<< /usr/src/app/output/univocity/univocity-parsers/4d075a03c743828a5c0e98e8547933f63de3167e/src/main/java/com/univocity/parsers/annotations/helpers/FieldMapping.java/left.java
      ex
=======
      new IllegalStateException("Unable to set value \'" + value + "\' for field " + field.getName() + "\' in " + this.beanClass.getName(), e)
>>>>>>> /usr/src/app/output/univocity/univocity-parsers/4d075a03c743828a5c0e98e8547933f63de3167e/src/main/java/com/univocity/parsers/annotations/helpers/FieldMapping.java/right.java
      ;
    }
  }
}