...
public class AnnotationHelper {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) public static Conversion getConversion(Field field, Annotation annotation) {
    try {
...
<<<<<<< /usr/src/app/output/univocity/univocity-parsers/4d075a03c743828a5c0e98e8547933f63de3167e/src/main/java/com/univocity/parsers/annotations/helpers/AnnotationHelper.java/left.java
...
>>>>>>> /usr/src/app/output/univocity/univocity-parsers/4d075a03c743828a5c0e98e8547933f63de3167e/src/main/java/com/univocity/parsers/annotations/helpers/AnnotationHelper.java/right.java
                  } else {
...
>>>>>>> /usr/src/app/output/univocity/univocity-parsers/4d075a03c743828a5c0e98e8547933f63de3167e/src/main/java/com/univocity/parsers/annotations/helpers/AnnotationHelper.java/right.java
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public static Conversion getDefaultConversion(Field field) {
    Parsed parsed = field.getAnnotation(Parsed.class);
    Class fieldType = field.getType();
    String nullRead = getNullReadValue(parsed);
          ...
          if (parameterType == Currency.class) {
            ...
            if (parameterType == Boolean.class) {
              ...
              if (parameterType == TimeZone.class) {
                ...
                if (parameterType == DateFormatSymbols.class) {
