...
@SuppressWarnings(value = { "serial" }) @WebServlet(urlPatterns = { "/import" }) @MultipartConfig(fileSizeThreshold = 1024 * 1024 * 10, maxFileSize = 1024 * 1024 * 50, maxRequestSize = 1024 * 1024 * 100) public class Import extends HttpServlet {
