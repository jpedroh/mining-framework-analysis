 ...
 */
@Mojo(name = "analyze") @SuppressWarnings(value = { "UnusedDeclaration", "FieldCanBeLocal" }) public class AnalyzeMojo extends AbstractMojo {
  /**
   ...
   */
  @Parameter(required = true, defaultValue = "${project.build.directory}") private File targetDirectory;

  /**
   * Maximum number of samples to keep (in main memory) before compressing.
   * defaultValue = "50000"
   */
  @Parameter(defaultValue = "50000") private int maxSamples = Environment.DEFAULT_MAXSAMPLES;

  /**
   * Width use to generate a chart. 
   * defaultValue = "800"
   */
  @Parameter(defaultValue = "800") private int chartWidth;


<<<<<<< /usr/src/app/output/afranken/jmeter-analysis-maven-plugin/b5d8d8fc2b75beaa9fa6265208204639dc084991/src/main/java/com/lazerycode/jmeter/analyzer/AnalyzeMojo.java/left.java
  /**
   * Height use to generate a chart. 
   * defaultValue = "600"
   */
  @Parameter(defaultValue = "600") private int chartHeight;
=======
  /**
   * Parametrized format of from until date format e.g. Graphite renderer does not support
   * ISO8601_FORMAT out of the box
   */
  @Parameter(required = true, defaultValue = Environment.ISO8601_FORMAT) private String remoteResourcesFromUntilDateFormat;
>>>>>>> /usr/src/app/output/afranken/jmeter-analysis-maven-plugin/b5d8d8fc2b75beaa9fa6265208204639dc084991/src/main/java/com/lazerycode/jmeter/analyzer/AnalyzeMojo.java/right.java
   ...
   */
  @Parameter(defaultValue = "false") private boolean processAllFilesFound;
   ...
   */
  @Parameter(defaultValue = "false") private boolean preserveDirectories;
   ...
   */
  @Parameter private Set<String> sampleNames = new HashSet<String>(Arrays.asList(new String[] { HTTPSAMPLE_ELEMENT_NAME, SAMPLE_ELEMENT_NAME }));
   ...
   */
  @Parameter private List<RequestGroup> requestGroups;
   ...
   */
  @Parameter private Properties remoteResources;
   ...
   */
  @Parameter private File templateDirectory;
   ...
   */
  @Parameter private List<Writer> writers;
