 ...
 * @since 2.2
 */
abstract class JSR310FormattedSerializerBase<T extends java.lang.Object> extends JSR310SerializerBase<T> implements ContextualSerializer {
  ...
  protected abstract JSR310FormattedSerializerBase<?> withFormat(Boolean useTimestamp, DateTimeFormatter dtf);
  ...
  @Override public JsonNode getSchema(SerializerProvider provider, Type typeHint) {
