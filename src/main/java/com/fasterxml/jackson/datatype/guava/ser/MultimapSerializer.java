...
public class MultimapSerializer extends ContainerSerializer<Multimap<?, ?>> implements ContextualSerializer {
  ...
  /**
     * @since 2.5
     */
  @SuppressWarnings(value = { "unchecked" }) protected MultimapSerializer(MultimapSerializer src, BeanProperty property, JsonSerializer<?> keySerializer, TypeSerializer vts, JsonSerializer<?> valueSerializer, Set<String> ignoredEntries, Object filterId, boolean sortKeys) {
    super(src);
    _type = src._type;
    _property = property;
  ...
  @Override protected ContainerSerializer<?> _withValueTypeSerializer(TypeSerializer typeSer) {
    return new MultimapSerializer(this, _property, _keySerializer, typeSer, _valueSerializer, _ignoredEntries, _filterId, _sortKeys);
  }
  ...
  @Override public JsonSerializer<?> createContextual(SerializerProvider provider, BeanProperty property) throws JsonMappingException {
    ...
    if (valueSer == null) {
      ...
      if (valueSer instanceof ContextualSerializer) {
    ...
    return withResolved(property, keySer, typeSer, valueSer, ignored, filterId, sortKeys);
  }

  @Override public JsonSerializer<?> getContentSerializer() {
  ...
  @Override public boolean hasSingleElement(Multimap<?, ?> map) {
    return map.size() == 1;
  }

  @Override public boolean isEmpty(Multimap<?, ?> map) {
    return map.isEmpty();
  }

  @Override public void serialize(Multimap<?, ?> value, JsonGenerator gen, SerializerProvider provider) throws IOException {
...
>>>>>>> /usr/src/app/output/fasterxml/jackson-datatype-guava/3ee74a3b1dfa156c398cf910fda03bd37cc40b59/src/main/java/com/fasterxml/jackson/datatype/guava/ser/MultimapSerializer.java/right.java
  ...
  @Override public void serializeWithType(Multimap<?, ?> value, JsonGenerator gen, SerializerProvider provider, TypeSerializer typeSer) throws IOException {
...
=======
      {
        provider.findKeySerializer(provider.constructType(String.class), _property).serialize(e.getKey(), gen, provider);
      }
>>>>>>> /usr/src/app/output/fasterxml/jackson-datatype-guava/3ee74a3b1dfa156c398cf910fda03bd37cc40b59/src/main/java/com/fasterxml/jackson/datatype/guava/ser/MultimapSerializer.java/right.java
...
<<<<<<< /usr/src/app/output/fasterxml/jackson-datatype-guava/3ee74a3b1dfa156c398cf910fda03bd37cc40b59/src/main/java/com/fasterxml/jackson/datatype/guava/ser/MultimapSerializer.java/left.java
        provider.findNullKeySerializer(_type.getKeyType(), _property).serialize(null, gen, provider)
=======
        gen.writeEndArray()
>>>>>>> /usr/src/app/output/fasterxml/jackson-datatype-guava/3ee74a3b1dfa156c398cf910fda03bd37cc40b59/src/main/java/com/fasterxml/jackson/datatype/guava/ser/MultimapSerializer.java/right.java
        ;
        ...
        _keySerializer.
<<<<<<< /usr/src/app/output/fasterxml/jackson-datatype-guava/3ee74a3b1dfa156c398cf910fda03bd37cc40b59/src/main/java/com/fasterxml/jackson/datatype/guava/ser/MultimapSerializer.java/left.java
        serialize(key, gen, provider)
=======
        defaultSerializeValue(Lists.newArrayList(e.getValue()), gen)
>>>>>>> /usr/src/app/output/fasterxml/jackson-datatype-guava/3ee74a3b1dfa156c398cf910fda03bd37cc40b59/src/main/java/com/fasterxml/jackson/datatype/guava/ser/MultimapSerializer.java/right.java
        ;
      }
      gen.writeStartArray();
  ...
  private final void serializeOptionalFields(Multimap<?, ?> mmap, JsonGenerator gen, SerializerProvider provider) throws IOException {
    final Set<String> ignored = _ignoredEntries;
  ...
  @Override public void acceptJsonFormatVisitor(JsonFormatVisitorWrapper visitor, JavaType typeHint) throws JsonMappingException {
    ...
    if (v2 != null) {
      ...
      if (valueSer == null) {
        valueSer = _findAndAddDynamic(_dynamicValueSerializers, vt, visitor.getProvider());
      }
