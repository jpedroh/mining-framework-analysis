...
public final class WriterBasedJsonGenerator extends JsonGeneratorImpl {
  ...
  @Override public void writeNumber(double d) throws IOException {
    if (_cfgNumbersAsStrings || (isEnabled(Feature.QUOTE_NON_NUMERIC_NUMBERS) && ((Double.isNaN(d) || Double.isInfinite(d))))) {
  ...
  @Override public void writeNumber(float f) throws IOException {
    if (_cfgNumbersAsStrings || (isEnabled(Feature.QUOTE_NON_NUMERIC_NUMBERS) && ((Float.isNaN(f) || Float.isInfinite(f))))) {
