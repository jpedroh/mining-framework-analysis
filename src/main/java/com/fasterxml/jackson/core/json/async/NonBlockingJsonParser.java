...
public class NonBlockingJsonParser extends NonBlockingJsonParserBase implements ByteArrayFeeder {
  ...
  public NonBlockingJsonParser(ObjectReadContext readCtxt, IOContext ctxt, int stdFeatures, int formatReadFeatures, ByteQuadsCanonicalizer sym) {
    super(readCtxt, ctxt, stdFeatures, formatReadFeatures, sym);
  }

  @Override public ByteArrayFeeder nonBlockingInputFeeder() {
    return this;
  }
  ...
  @Override public void feedInput(byte[] buf, int start, int end) throws JacksonException {
  ...
  @Override public void endOfInput() {
    _endOfInput = true;
  }
  ...
  protected JsonToken _finishKeywordToken(String expToken, int matched, JsonToken result) throws JacksonException {
  ...
  protected JsonToken _finishKeywordTokenWithEOF(String expToken, int matched, JsonToken result) throws JacksonException {
...
>>>>>>> /usr/src/app/output/fasterxml/jackson-core/fcef9233a200a2b9470873e4ed027cb6751b0ea5/src/main/java/com/fasterxml/jackson/core/json/async/NonBlockingJsonParser.java/right.java
  ...
  /**
     ...
     */
  private final JsonToken _parseEscapedName(int qlen, int currQuad, int currQuadBytes) throws JacksonException {
  ...
  /**
     ...
     * Unlike other 
     */
  private JsonToken _finishUnquotedName(int qlen, int currQuad, int currQuadBytes) throws JacksonException {
    int[] quads = _quadBuffer;
    final int[] codes = CharTypes.getInputCodeUtf8JsNames();
    while (true) {
      if (_inputPtr >= _inputEnd) {
  ...
  private JsonToken _finishAposName(int qlen, int currQuad, int currQuadBytes) throws JacksonException {
    int[] quads = _quadBuffer;
    final int[] codes = _icLatin1;
    while (true) {
      if (_inputPtr >= _inputEnd) {
  ...
  private final boolean _decodeSplitMultiByte(int c, int type, boolean gotNext) throws JacksonException {
    switch (type) {
      case 1:
  ...
  private final boolean _decodeSplitUTF8_3(int prev, int prevCount, int next) throws JacksonException {
    if (prevCount == 1) {
      if ((next & 0xC0) != 0x080) {
  ...
  private final boolean _decodeSplitUTF8_4(int prev, int prevCount, int next) throws JacksonException {
    if (prevCount == 1) {
      if ((next & 0xC0) != 0x080) {
        _reportInvalidOther(next & 0xFF, _inputPtr);
      }
