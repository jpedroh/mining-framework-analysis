...
public class NonBlockingJsonParser extends NonBlockingJsonParserBase implements ByteArrayFeeder {
  @SuppressWarnings(value = { "deprecation" }) private final static int FEAT_MASK_TRAILING_COMMA = Feature.ALLOW_TRAILING_COMMA.getMask();

  @SuppressWarnings(value = { "deprecation" }) private final static int FEAT_MASK_LEADING_ZEROS = Feature.ALLOW_NUMERIC_LEADING_ZEROS.getMask();

  @SuppressWarnings(value = { "deprecation" }) private final static int FEAT_MASK_ALLOW_MISSING = Feature.ALLOW_MISSING_VALUES.getMask();
  ...
  @Override public ByteArrayFeeder getNonBlockingInputFeeder() {
    return this;
  }
  ...
  @Override public void feedInput(byte[] buf, int start, int end) throws IOException {
