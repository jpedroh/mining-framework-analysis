...
public class UTF8DataInputJsonParser extends JsonParserBase {
  ...
  public UTF8DataInputJsonParser(ObjectReadContext readCtxt, IOContext ctxt, int stdFeatures, int formatFeatures, DataInput inputData, ByteQuadsCanonicalizer sym, int firstByte) {
  ...
  @Override public int releaseBuffered(OutputStream out) {
    return 0;
  }
  ...
  @Override public byte[] getBinaryValue(Base64Variant b64variant) throws JacksonException {
    ...
    if (_tokenIncomplete) {
      try {
        ...
        throw _constructReadException("Failed to decode VALUE_STRING as base64 (%s): %s", b64variant, e.getMessage());
      }
      _tokenIncomplete = false;
    } else {
...
>>>>>>> /usr/src/app/output/fasterxml/jackson-core/f54299aeaeb9e244aeffdf1df42af1eadec19d8b/src/main/java/com/fasterxml/jackson/core/json/UTF8DataInputJsonParser.java/right.java
  }
...
>>>>>>> /usr/src/app/output/fasterxml/jackson-core/f54299aeaeb9e244aeffdf1df42af1eadec19d8b/src/main/java/com/fasterxml/jackson/core/json/UTF8DataInputJsonParser.java/right.java
  ...
  protected final JsonToken _parseFloatThatStartsWithPeriod(final boolean neg, final boolean prependSign) throws IOException {
...
<<<<<<< /usr/src/app/output/fasterxml/jackson-core/f54299aeaeb9e244aeffdf1df42af1eadec19d8b/src/main/java/com/fasterxml/jackson/core/json/UTF8DataInputJsonParser.java/left.java
  /**
