...
public class ReaderBasedJsonParser extends JsonParserBase {
  ...
  @Override public int releaseBuffered(Writer w) throws JacksonException {
  ...
  @Override public Object streamReadInputSource() {
    return _reader;
  }
  ...
  /**
     ...
     */
  @Override public final String getText() throws JacksonException {
  ...
  @Override public int getText(Writer writer) throws JacksonException {
  ...
  @Override public final String getValueAsString() throws JacksonException {
    if (_currToken == JsonToken.VALUE_STRING) {
      if (_tokenIncomplete) {
        _tokenIncomplete = false;
        _finishString();
  ...
  @Override public final String getValueAsString(String defValue) throws JacksonException {
    if (_currToken == JsonToken.VALUE_STRING) {
      if (_tokenIncomplete) {
        _tokenIncomplete = false;
        _finishString();
  ...
  @Override public final char[] getTextCharacters() throws JacksonException {
    if (_currToken != null) {
  ...
  @Override public final int getTextLength() throws JacksonException {
    if (_currToken != null) {
      switch (_currToken.id()) {
        case ID_PROPERTY_NAME:
  ...
  @Override public final int getTextOffset() throws JacksonException {
    if (_currToken != null) {
      switch (_currToken.id()) {
        case ID_PROPERTY_NAME:
        return 0;
  ...
  @Override public byte[] getBinaryValue(Base64Variant b64variant) throws JacksonException {
  ...
  @Override public int readBinaryValue(Base64Variant b64variant, OutputStream out) throws JacksonException {
  ...
  /**
     ...
     */
  @Override public final JsonToken nextToken() throws JacksonException {
    if (_currToken == JsonToken.PROPERTY_NAME) {
  ...
  @Override public void finishToken() throws JacksonException {
    if (_tokenIncomplete) {
      _tokenIncomplete = false;
      _finishString();
    }
  ...
  @Override public boolean nextName(SerializableString sstr) throws JacksonException {
    _numTypesValid = NR_UNKNOWN;
    if (_currToken == JsonToken.PROPERTY_NAME) {
      _nextAfterName();
      return false;
  ...
  @Override public String nextName() throws JacksonException {
    _numTypesValid = NR_UNKNOWN;
    if (_currToken == JsonToken.PROPERTY_NAME) {
      _nextAfterName();
      return null;
...
>>>>>>> /usr/src/app/output/fasterxml/jackson-core/f54299aeaeb9e244aeffdf1df42af1eadec19d8b/src/main/java/com/fasterxml/jackson/core/json/ReaderBasedJsonParser.java/right.java
  ...
  @Override public final String nextTextValue() throws JacksonException {
    if (_currToken == JsonToken.PROPERTY_NAME) {
      _nameCopied = false;
      JsonToken t = _nextToken;
      _nextToken = null;
  ...
  @Override public final int nextIntValue(int defaultValue) throws JacksonException {
    if (_currToken == JsonToken.PROPERTY_NAME) {
      _nameCopied = false;
      JsonToken t = _nextToken;
      _nextToken = null;
  ...
  @Override public final long nextLongValue(long defaultValue) throws JacksonException {
    if (_currToken == JsonToken.PROPERTY_NAME) {
      _nameCopied = false;
      JsonToken t = _nextToken;
      _nextToken = null;
  ...
  @Override public final Boolean nextBooleanValue() throws JacksonException {
    if (_currToken == JsonToken.PROPERTY_NAME) {
      _nameCopied = false;
      JsonToken t = _nextToken;
      _nextToken = null;
...
<<<<<<< /usr/src/app/output/fasterxml/jackson-core/f54299aeaeb9e244aeffdf1df42af1eadec19d8b/src/main/java/com/fasterxml/jackson/core/json/ReaderBasedJsonParser.java/left.java
  /**
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Override protected char _decodeEscaped() throws JacksonException {
    if (_inputPtr >= _inputEnd) {
      if (!_loadMore()) {
  ...
  /**
     ...
     * @throws StreamReadException for decoding problems
     */
  @SuppressWarnings(value = { "resource" }) protected byte[] _decodeBase64(Base64Variant b64variant) throws JacksonException {
  ...
  @Override public JsonLocation currentTokenLocation() {
    if (_currToken == JsonToken.PROPERTY_NAME) {
  ...
  @Override public JsonLocation currentLocation() {
