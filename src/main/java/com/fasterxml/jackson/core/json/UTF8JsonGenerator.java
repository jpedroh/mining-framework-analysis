...
public class UTF8JsonGenerator extends JsonGeneratorBase {
  ...
  @Override public final void writeStartArray() throws JacksonException {
  ...
  @Override public final void writeStartArray(Object forValue) throws JacksonException {
    _verifyValueWrite("start an array");
  ...
  @Override public final void writeStartArray(Object forValue, int len) throws JacksonException {
    _verifyValueWrite("start an array");
    _streamWriteContext = _streamWriteContext.createChildArrayContext(forValue);
    if (_cfgPrettyPrinter != null) {
      _cfgPrettyPrinter.writeStartArray(this);
  ...
  @Override public final void writeEndArray() throws JacksonException {
  ...
  @Override public final void writeStartObject() throws JacksonException {
  ...
  @Override public final void writeEndObject() throws JacksonException {
  ...
  @Override public final void writeString(SerializableString text) throws JacksonException {
    _verifyValueWrite(WRITE_STRING);
    if (_outputTail >= _outputEnd) {
      _flushBuffer();
    }
  ...
  @Override public void writeUTF8String(byte[] text, int offset, int len) throws JacksonException {
    _verifyValueWrite(WRITE_STRING);
    if (_outputTail >= _outputEnd) {
      _flushBuffer();
    }
  ...
  @Override public void writeRaw(String text, int offset, int len) throws JacksonException {
    final char[] buf = _charBuffer;
    ...
    final int maxChunk = Math.min(cbufLen, (_outputEnd >> 2) + (_outputEnd >> 4));
  ...
  @Override public final void writeRaw(char[] cbuf, int offset, int len) throws JacksonException {
    {
  ...
  @Override public void writeRaw(char ch) throws JacksonException {
  ...
  private final void _writeUTF8Segment(byte[] utf8, final int offset, final int len) throws JacksonException {
    final int[] escCodes = _outputEscapes;
  ...
  private final void _writeUTF8Segment2(final byte[] utf8, int offset, int len) throws JacksonException {
    int outputPtr = _outputTail;
