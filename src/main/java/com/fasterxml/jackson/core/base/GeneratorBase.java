...
public abstract class GeneratorBase extends JsonGenerator {
  ...
  /**
     ...
     * @since 2.5
     */
  protected final static int DERIVED_FEATURES_MASK = Feature.WRITE_NUMBERS_AS_STRINGS.getMask() | Feature.ESCAPE_NON_ASCII.getMask() | Feature.STRICT_DUPLICATE_DETECTION.getMask();
  ...
  @Override public final boolean isEnabled(Feature f) {
  ...
  @Override public JsonGenerator enable(Feature f) {
  ...
  @Override public JsonGenerator disable(Feature f) {
    final int mask = f.getMask();
    _features &= ~mask;
    if ((mask & DERIVED_FEATURES_MASK) != 0) {
      if (f == Feature.WRITE_NUMBERS_AS_STRINGS) {
  ...
  @Override @Deprecated public JsonGenerator setFeatureMask(int newMask) {
