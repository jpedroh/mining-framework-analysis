...
<<<<<<< /usr/src/app/output/fasterxml/jackson-core/fc2a4585ca846c519c47c8628f99a7ad16a62833/src/main/java/com/fasterxml/jackson/core/base/GeneratorBase.java/left.java
    _outputContext.setCurrentValue(v);
=======
    if (_writeContext != null) {
      _writeContext.setCurrentValue(v);
    }
>>>>>>> /usr/src/app/output/fasterxml/jackson-core/fc2a4585ca846c519c47c8628f99a7ad16a62833/src/main/java/com/fasterxml/jackson/core/base/GeneratorBase.java/right.java
  }
  ...
  @Override public JsonGenerator enable(StreamWriteFeature f) {
    ...
    if ((mask & DERIVED_FEATURES_MASK) != 0) {
      if (f == StreamWriteFeature.WRITE_NUMBERS_AS_STRINGS) {
        ...
        if (f == StreamWriteFeature.STRICT_DUPLICATE_DETECTION) {
