...
public abstract class JsonParser implements Closeable, Versioned {
  ...
  public void setSchema(FormatSchema schema) {
    ...
    throw new UnsupportedOperationException("Parser of type " + getClass().getName() + " does not support schema of type " + desc);
  }
...
>>>>>>> /usr/src/app/output/fasterxml/jackson-core/1755de36114aad71607db1b42c58714631d470a6/src/main/java/com/fasterxml/jackson/core/JsonParser.java/right.java
 ...
 an integer, but its value falls
  ...
  /**
     ...
     */
  public abstract <T extends java.lang.Object> T readValueAs(Class<T> valueType) throws IOException;
  ...
  /**
     ...
     * stream is not advanced.
     */
  public abstract <T extends java.lang.Object> T readValueAs(TypeReference<T> valueTypeRef) throws IOException;

  /**
     * @since 3.0
     */
  public abstract <T extends java.lang.Object> T readValueAs(ResolvedType type) throws IOException;
  ...
  protected JsonParseException _constructError(String msg, Object arg) {
    return new JsonParseException(this, String.format(msg, arg)).withRequestPayload(_requestPayload);
  }

  protected JsonParseException _constructError(String msg, Object arg1, Object arg2) {
    return new JsonParseException(this, String.format(msg, arg1, arg2)).withRequestPayload(_requestPayload);
  }
