...
@Target(value = { ElementType.ANNOTATION_TYPE, ElementType.FIELD, ElementType.METHOD, ElementType.PARAMETER, ElementType.TYPE }) @Retention(value = RetentionPolicy.RUNTIME) @JacksonAnnotation public @interface JsonFormat {
  ...
  public static class Value implements JacksonAnnotationValue<JsonFormat>, java.io.Serializable {
    ...
    public Value(String p, Shape sh, String localeStr, String tzStr, Features f) {
      this(p, sh, (localeStr == null || localeStr.length() == 0 || DEFAULT_LOCALE.equals(localeStr)) ? null : new Locale(localeStr), (tzStr == null || tzStr.length() == 0 || DEFAULT_TIMEZONE.equals(tzStr)) ? null : tzStr, null, f);
    }
    ...
    /**
         ...
         */
    @Deprecated public Value(String p, Shape sh, Locale l, TimeZone tz) {
    ...
    /**
         * @deprecated since 2.6
         */
    @Deprecated public Value(String p, Shape sh, String localeStr, String tzStr) {
    ...
    /**
         * @deprecated since 2.6
         */
    @Deprecated public Value(String p, Shape sh, Locale l, String tzStr, TimeZone tz) {
    ...
    public Value withFeature(JsonFormat.Feature f) {
      ...
      return (newFeats == _features) ? this : new Value(_pattern, _shape, _locale, _timezoneStr, _timezone, newFeats);
    }
    ...
    @Override public String toString() {
      return String.format("[pattern=%s,shape=%s,locale=%s,timezone=%s]", _pattern, _shape, _locale, _timezoneStr);
    }
    ...
    @Override public boolean equals(Object o) {
      ...
      return _equal(_timezoneStr, other._timezoneStr) && _equal(_pattern, other._pattern) && _equal(_timezone, other._timezone) && _equal(_locale, other._locale);
    }
