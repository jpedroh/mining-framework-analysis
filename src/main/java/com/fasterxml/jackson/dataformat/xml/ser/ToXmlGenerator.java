...
public final class ToXmlGenerator extends GeneratorBase {
  ...
  public void initGenerator() throws IOException, JsonGenerationException {
    ...
    try {
      if ((_xmlFeatures & Feature.WRITE_XML_1_1.getMask()) != 0) {
        ...
        if ((_xmlFeatures & Feature.WRITE_XML_DECLARATION.getMask()) != 0) {
  ...
  @Override public final void writeFieldName(String name) throws IOException, JsonGenerationException {
  ...
  @Override public final void writeStringField(String fieldName, String value) throws IOException, JsonGenerationException {
    writeFieldName(fieldName);
    writeString(value);
  }

  @Override public final void writeStartArray() throws IOException, JsonGenerationException {
  ...
  @Override public final void writeEndArray() throws IOException, JsonGenerationException {
  ...
  @Override public final void writeStartObject() throws IOException, JsonGenerationException {
  ...
  @Override public final void writeEndObject() throws IOException, JsonGenerationException {
  ...
  @Override public void writeString(SerializableString text) throws IOException, JsonGenerationException {
  ...
  @Override protected final void _verifyValueWrite(String typeMsg) throws IOException, JsonGenerationException {
  ...
  /**
     ...
     */
  @Override public final JsonGenerator useDefaultPrettyPrinter() {
    if (_cfgPrettyPrinter != null) {
      return this;
    }
