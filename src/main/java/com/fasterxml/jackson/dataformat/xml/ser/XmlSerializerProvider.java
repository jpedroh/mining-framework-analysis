...
public class XmlSerializerProvider extends SerializationContextExt {
  ...
  public XmlSerializerProvider(TokenStreamFactory streamFactory, SerializationConfig config, GeneratorSettings genSettings, SerializerFactory f, SerializerCache cache, XmlRootNameLookup rootLookup) {
    super(streamFactory, config, genSettings, f, cache);
    _rootNameLookup = rootLookup;
  }

  @SuppressWarnings(value = { "resource" }) @Override public void serializeValue(JsonGenerator gen, Object value) throws JacksonException {
    _generator = gen;
    if (value == null) {
  ...
  @Override public void serializeValue(JsonGenerator gen, Object value, JavaType rootType) throws JacksonException {
    serializeValue(gen, value, rootType, null);
  }

  @SuppressWarnings(value = { "resource" }) @Override public void serializeValue(JsonGenerator gen, Object value, JavaType rootType, ValueSerializer<Object> ser) throws JacksonException {
    _generator = gen;
    if (value == null) {
      _serializeXmlNull(gen);
      return;
    ...
    if (xgen == null) {
      ...
      if (rootName == null) {
        rootName = 
<<<<<<< /usr/src/app/output/fasterxml/jackson-dataformat-xml/c2fe9adba4b617f21e16e64527772653749c2425/src/main/java/com/fasterxml/jackson/dataformat/xml/ser/XmlSerializerProvider.java/left.java
        _rootNameLookup.findRootName(this, rootType)
=======
        (rootType == null) ? _rootNameLookup.findRootName(value.getClass(), _config) : _rootNameLookup.findRootName(rootType, _config)
>>>>>>> /usr/src/app/output/fasterxml/jackson-dataformat-xml/c2fe9adba4b617f21e16e64527772653749c2425/src/main/java/com/fasterxml/jackson/dataformat/xml/ser/XmlSerializerProvider.java/right.java
        ;
      }
      _initWithRootName(xgen, rootName);
      asArray = (rootType == null) ? TypeUtil.isIndexedType(value.getClass()) : TypeUtil.isIndexedType(rootType);
      if (asArray) {
        _startRootArray(xgen, rootName);
      }
    }
  ...
  @SuppressWarnings(value = { "resource" }) @Override public void serializePolymorphic(JsonGenerator gen, Object value, JavaType rootType, ValueSerializer<Object> valueSer, TypeSerializer typeSer) throws JacksonException {
    _generator = gen;
    if (value == null) {
      _serializeXmlNull(gen);
      return;
...
>>>>>>> /usr/src/app/output/fasterxml/jackson-dataformat-xml/c2fe9adba4b617f21e16e64527772653749c2425/src/main/java/com/fasterxml/jackson/dataformat/xml/ser/XmlSerializerProvider.java/right.java
  ...
  protected ToXmlGenerator _asXmlGenerator(JsonGenerator gen) {
    if (!(gen instanceof ToXmlGenerator)) {
      ...
      throw DatabindException.from(gen, "XmlMapper does not work with generators of type other than `ToXmlGenerator`; got: `" + gen.getClass().getName() + "`");
    }
