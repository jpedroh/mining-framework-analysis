...
<<<<<<< /usr/src/app/output/fasterxml/jackson-dataformat-cbor/17a63ada108ac3c16efd1b17885423cda74a60d5/src/main/java/com/fasterxml/jackson/dataformat/cbor/CBORParser.java/left.java
  final protected static int NR_FLOAT = 0x008;
=======
  private final static byte[] NO_BYTES = new byte[0];
>>>>>>> /usr/src/app/output/fasterxml/jackson-dataformat-cbor/17a63ada108ac3c16efd1b17885423cda74a60d5/src/main/java/com/fasterxml/jackson/dataformat/cbor/CBORParser.java/right.java
    ...
    if ((_numTypesValid & NR_LONG) != 0) {
      ...
      if ((_numTypesValid & NR_BIGINT) != 0) {
        ...
        if ((_numTypesValid & NR_DOUBLE) != 0) {
          ...
          if ((_numTypesValid & NR_FLOAT) != 0) {
            if (_numberFloat < MIN_INT_D || 
<<<<<<< /usr/src/app/output/fasterxml/jackson-dataformat-cbor/17a63ada108ac3c16efd1b17885423cda74a60d5/src/main/java/com/fasterxml/jackson/dataformat/cbor/CBORParser.java/left.java
            _numberFloat > MAX_INT_D
=======
    ...
    if ((_numTypesValid & NR_INT) != 0) {
      ...
      if ((_numTypesValid & NR_BIGINT) != 0) {
        ...
        if ((_numTypesValid & NR_DOUBLE) != 0) {
          ...
          if ((_numTypesValid & NR_FLOAT) != 0) {
            if (_numberFloat < MIN_LONG_D || 
<<<<<<< /usr/src/app/output/fasterxml/jackson-dataformat-cbor/17a63ada108ac3c16efd1b17885423cda74a60d5/src/main/java/com/fasterxml/jackson/dataformat/cbor/CBORParser.java/left.java
            _numberFloat > MAX_LONG_D
=======
>>>>>>> Unknown file: This is a bug in JDime.
            ) {
              reportOverflowInt();
