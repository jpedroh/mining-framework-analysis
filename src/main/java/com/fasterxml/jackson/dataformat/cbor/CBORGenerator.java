...
public class CBORGenerator extends GeneratorBase {
  ...
  @Override public JsonGenerator overrideStdFeatures(int values, int mask) {
  ...
  @Override public JsonGenerator overrideFormatFeatures(int values, int mask) {
  ...
  @Override public final void writeFieldName(String name) throws IOException {
  ...
  @Override public final void writeFieldName(SerializableString name) throws IOException {
  ...
  @Override public final void writeStringField(String fieldName, String value) throws IOException {
  ...
  @Override public void writeRawUTF8String(byte[] raw, int offset, int len) throws IOException {
    _verifyValueWrite("write String value");
    if (len == 0) {
      _writeByte(BYTE_EMPTY_STRING);
      return;
  ...
  @Override public final void writeUTF8String(byte[] text, int offset, int len) throws IOException {
  ...
  @Override public int writeBinary(InputStream data, int dataLength) throws IOException {
    if (dataLength < 0) {
