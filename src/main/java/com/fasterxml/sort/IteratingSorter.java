...
public class IteratingSorter<T extends java.lang.Object> extends SorterBase<T> implements Closeable {
  ...
  private static class MergerIterator<T extends java.lang.Object> implements Iterator<T> {
