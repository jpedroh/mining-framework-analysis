...
@SuppressWarnings(value = { "serial" }) public class TypeResolver implements Serializable {
  ...
  /**
     ...
     */
  public ResolvedType resolveSubtype(ResolvedType supertype, final Class<?> subtype) throws IllegalArgumentException, UnsupportedOperationException {
    ...
    if (paramCount == 0) {
      ...
      resolvedSubtype = _fromClass(null, subtype, TypeBindings.create(subtype, resolvedParams));
    }
