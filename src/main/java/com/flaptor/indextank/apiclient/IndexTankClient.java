...
public class IndexTankClient implements ApiClient {
  ...
  static abstract class AbstractBatchResults<T extends java.lang.Object> {
  ...
  public static class Query {
    public static class Range {
      ...
      public String getValue() {
        return (floor == Double.NEGATIVE_INFINITY ? "*" : String.valueOf(floor)) + ":" + (ceil == Double.POSITIVE_INFINITY ? "*" : String.valueOf(ceil));
      }
    }
    ...
    ParameterMap toParameterMap() {
      ...
      if (categoryFilters != null) {
        params.put("category_filters", JSONObject.toJSONString(categoryFilters));
      }
      if (documentVariableFilters != null) {
        for (Range range : documentVariableFilters) {
          String key = "filter_docvar" + range.id;
          String value = (range.floor == Double.NEGATIVE_INFINITY ? "*" : String.valueOf(range.floor)) + ":" + (range.ceil == Double.POSITIVE_INFINITY ? "*" : String.valueOf(range.ceil));
  ...
  public class Index implements com.flaptor.indextank.apiclient.Index {
    ...
    @Override public SearchResults search(String query) throws IOException, InvalidSyntaxException {
      return search(Query.forString(query));
    }

    @Override public SearchResults search(Query query) throws IOException, InvalidSyntaxException {
    ...
    @Override public void deleteBySearch(String query) throws IOException, IndexDoesNotExistException, InvalidSyntaxException {
      deleteBySearch(Query.forString(query));
    }

    @Override public void deleteBySearch(Query query) throws IOException, IndexDoesNotExistException, InvalidSyntaxException {
      ParameterMap params = query.toParameterMap();
      try {
    ...
    @Override public void create() throws IOException, IndexAlreadyExistsException, MaximumIndexesExceededException {
      this.create(null);
    }

    @Override public void create(IndexConfiguration conf) throws IOException, IndexAlreadyExistsException, MaximumIndexesExceededException {
      if (this.exists()) {
    ...
    @Override public void update(IndexConfiguration conf) throws IndexDoesNotExistException, IOException {
      if (conf == null) {
    ...
    @Override public void delete() throws IOException, IndexDoesNotExistException {
      try {
    ...
    @Override public BatchResults addDocuments(Iterable<Document> documents) throws IOException, IndexDoesNotExistException {
    ...
    @Override public void addDocument(String documentId, Map<String, String> fields) throws IOException, IndexDoesNotExistException {
      addDocument(documentId, fields, null);
    }

    @Override public void addDocument(String documentId, Map<String, String> fields, Map<Integer, Float> variables) throws IOException, IndexDoesNotExistException {
      addDocument(documentId, fields, variables, null);
    }

    @Override public void addDocument(String documentId, Map<String, String> fields, Map<Integer, Float> variables, Map<String, String> categories) throws IOException, IndexDoesNotExistException {
      if (null == documentId) {
    ...
    @Override public void deleteDocument(String documentId) throws IOException, IndexDoesNotExistException {
      if (null == documentId) {
        throw new IllegalArgumentException("documentId can not be null");
      }
      ParameterMap params = new ParameterMap();
    ...
    @Override public BulkDeleteResults deleteDocuments(Iterable<String> documentIds) throws IOException, IndexDoesNotExistException {
      if (null == documentIds) {
      ...
      try {
        List<Map<String, Object>> results = (List<Map<String, Object>>) callAPI(DELETE_METHOD, indexUrl + DOCS_URL, params, privatePass);
    ...
    @Override public void updateVariables(String documentId, Map<Integer, Float> variables) throws IOException, IndexDoesNotExistException {
      if (null == documentId) {
        throw new IllegalArgumentException("documentId can not be null");
      }
      Map<String, Object> data = new HashMap<String, Object>();
    ...
    @Override public void updateCategories(String documentId, Map<String, String> variables) throws IOException, IndexDoesNotExistException {
      Map<String, Object> data = new HashMap<String, Object>();
      data.put("docid", documentId);
    ...
    @Override public void promote(String documentId, String query) throws IOException, IndexDoesNotExistException {
      if (null == documentId) {
        throw new IllegalArgumentException("documentId can not be null");
      }
      Map<String, Object> data = new HashMap<String, Object>();
    ...
    @Override public void addFunction(Integer functionIndex, String definition) throws IOException, IndexDoesNotExistException, InvalidSyntaxException {
      Map<String, Object> data = new HashMap<String, Object>();
    ...
    @Override public void deleteFunction(Integer functionIndex) throws IOException, IndexDoesNotExistException {
      try {
    ...
    @Override public Map<String, String> listFunctions() throws IndexDoesNotExistException, IOException {
      try {
    ...
    @Override public boolean hasStarted() throws IOException, IndexDoesNotExistException {
      refreshMetadata();
      return (Boolean) getMetadata().get("started");
    }

    @Override public String getCode() throws IOException, IndexDoesNotExistException {
      return (String) getMetadata().get("code");
    }

    @Override public Date getCreationTime() throws IOException, IndexDoesNotExistException {
      try {
    ...
    @Override public boolean isPublicSearchEnabled() throws IOException, IndexDoesNotExistException {
      return (Boolean) getMetadata().get("public_search");
    }

    @Override public void refreshMetadata() throws IOException, IndexDoesNotExistException {
      try {
    ...
    @Override public Map<String, Object> getMetadata() throws IOException, IndexDoesNotExistException {
      if (metadata == null) {
        this.refreshMetadata();
      }
  ...
  /**
     ...
     */
  @Deprecated public IndexTankClient(String apiUrl, String privatePass) {
    this.apiUrl = appendTrailingSlash(apiUrl);
  ...
  @Override public Index getIndex(String indexName) {
    return new Index(getIndexUrl(indexName));
  }

  @Override public Index createIndex(String indexName) throws IOException, IndexAlreadyExistsException, MaximumIndexesExceededException {
    return this.createIndex(indexName, null);
  }

  @Override public Index createIndex(String indexName, IndexConfiguration conf) throws IOException, IndexAlreadyExistsException, MaximumIndexesExceededException {
    Index index = getIndex(indexName);
    index.create(conf);
    return index;
  }

  @Override public void deleteIndex(String indexName) throws IOException, IndexDoesNotExistException {
    getIndex(indexName).delete();
  }

  @Override public List<Index> listIndexes() throws IOException {
    try {
