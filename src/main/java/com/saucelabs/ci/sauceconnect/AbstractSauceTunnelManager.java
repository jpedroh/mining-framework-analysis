...
public abstract class AbstractSauceTunnelManager implements SauceTunnelManager {
  ...
  private String activeTunnelIdentifier(String username, String identifier) {
    ...
    try {
      ...
      for (int i = 0; i < tunnelArray.length(); i++) {
        ...
        if (status.equals("running") && (tunnelIdentifier.equals("null") && identifier.equals(username)) || !tunnelIdentifier.equals("null") && tunnelIdentifier.equals(identifier)) {
          return tunnelId;
        }
      }
  ...
  /**
     ...
     */
  protected abstract String[] generateSauceConnectArgs(String[] args, String username, String apiKey, int port, String options);
