...
public abstract class TypeCompiler {
  ...
  public DataTypeDescriptor resolveArithmeticOperation(DataTypeDescriptor leftType, DataTypeDescriptor rightType, String operator) throws StandardException {
    ...
    throw new StandardException("Types not compatible for " + operator + ": " + leftTypeId.getSQLTypeName() + " and " + rightTypeId.getSQLTypeName());
  }
  ...
  protected boolean numberConvertible(TypeId otherType, boolean forDataTypeFunction) {
    ...
    boolean retval = ((otherType.isNumericTypeId()) || (otherType.userType()));
