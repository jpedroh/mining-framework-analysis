...
=======
    if (rightTypeId.isIntervalTypeId() && (operator.equals(TypeCompiler.PLUS_OP) || operator.equals(TypeCompiler.MINUS_OP)) && (getStoredFormatIdFromTypeId() == rightTypeId.getTypeFormatId())) {
    ...
    if (operator.equals(PLUS_OP) || operator.equals(MINUS_OP)) {
      ...
      if (leftTypeId.isIntervalTypeId() && rightTypeId.isIntervalTypeId()) {
        if (leftTypeId == rightTypeId) {
          ...
          if ((typeFormatId = leftTypeId.getTypeFormatId()) == rightTypeId.getTypeFormatId()) {
...
>>>>>>> /usr/src/app/output/brunoribeiro/sql-parser/4ecca111d3214fb0d1d66d34fa2559a0dd0b50b0/src/main/java/com/akiban/sql/compiler/IntervalTypeCompiler.java/right.java
      ...
      if (operator.equals(TIMES_OP) || operator.equals(DIVIDE_OP)) {
