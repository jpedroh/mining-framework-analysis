...
@SuppressWarnings(value = { "UnusedAssignment", "ThrowFromFinallyBlock" }) public class SQLAccessControlContext implements AccessControlContext, Serializable {
  ...
  private SQLAccessControlContext(Connection connection, String schemaName, SQLProfile sqlProfile, PasswordEncryptor passwordEncryptor) {
    ...
    this.authenticationProvider = new SQLPasswordAuthenticationProvider(connection, schemaName, sqlProfile.getSqlDialect(), passwordEncryptor);
  ...
  private SQLAccessControlContext(DataSource dataSource, String schemaName, SQLProfile sqlProfile, PasswordEncryptor passwordEncryptor) {
    ...
    this.authenticationProvider = new SQLPasswordAuthenticationProvider(dataSource, schemaName, sqlProfile.getSqlDialect(), passwordEncryptor);
    this.hasDefaultAuthenticationProvider = true;
  }
  ...
  private SQLAccessControlContext(String schemaName, SQLProfile sqlProfile) {
    ...
    resourceClassPersister = new ResourceClassPersister(sqlProfile, sqlStrings);
    resourceClassPermissionPersister = new ResourceClassPermissionPersister(sqlProfile, sqlStrings);
    if (sqlProfile.isRecursiveCTEEnabled()) {
      grantDomainCreatePermissionSysPersister = new RecursiveGrantDomainCreatePermissionSysPersister(sqlProfile, sqlStrings);
      grantDomainCreatePermissionPostCreateSysPersister = new RecursiveGrantDomainCreatePermissionPostCreateSysPersister(sqlProfile, sqlStrings);
      grantDomainPermissionSysPersister = new RecursiveGrantDomainPermissionSysPersister(sqlProfile, sqlStrings);
      domainPersister = new RecursiveDomainPersister(sqlProfile, sqlStrings);
      resourcePersister = new RecursiveResourcePersister(sqlProfile, sqlStrings);
      grantResourceCreatePermissionSysPersister = new RecursiveGrantResourceCreatePermissionSysPersister(sqlProfile, sqlStrings);
      grantResourceCreatePermissionPostCreateSysPersister = new RecursiveGrantResourceCreatePermissionPostCreateSysPersister(sqlProfile, sqlStrings);
      grantResourceCreatePermissionPostCreatePersister = new RecursiveGrantResourceCreatePermissionPostCreatePersister(sqlProfile, sqlStrings);
      grantResourcePermissionSysPersister = new RecursiveGrantResourcePermissionSysPersister(sqlProfile, sqlStrings);
      grantGlobalResourcePermissionSysPersister = new RecursiveGrantGlobalResourcePermissionSysPersister(sqlProfile, sqlStrings);
      grantResourcePermissionPersister = new RecursiveGrantResourcePermissionPersister(sqlProfile, sqlStrings);
      grantGlobalResourcePermissionPersister = new RecursiveGrantGlobalResourcePermissionPersister(sqlProfile, sqlStrings);
    } else {
      grantDomainCreatePermissionSysPersister = new NonRecursiveGrantDomainCreatePermissionSysPersister(sqlProfile, sqlStrings);
      grantDomainCreatePermissionPostCreateSysPersister = new NonRecursiveGrantDomainCreatePermissionPostCreateSysPersister(sqlProfile, sqlStrings);
      grantDomainPermissionSysPersister = new NonRecursiveGrantDomainPermissionSysPersister(sqlProfile, sqlStrings);
      domainPersister = new NonRecursiveDomainPersister(sqlProfile, sqlStrings);
      resourcePersister = new NonRecursiveResourcePersister(sqlProfile, sqlStrings);
      grantResourceCreatePermissionSysPersister = new NonRecursiveGrantResourceCreatePermissionSysPersister(sqlProfile, sqlStrings);
      grantResourceCreatePermissionPostCreateSysPersister = new NonRecursiveGrantResourceCreatePermissionPostCreateSysPersister(sqlProfile, sqlStrings);
      grantResourceCreatePermissionPostCreatePersister = new NonRecursiveGrantResourceCreatePermissionPostCreatePersister(sqlProfile, sqlStrings);
      grantResourcePermissionSysPersister = new NonRecursiveGrantResourcePermissionSysPersister(sqlProfile, sqlStrings);
      grantGlobalResourcePermissionSysPersister = new NonRecursiveGrantGlobalResourcePermissionSysPersister(sqlProfile, sqlStrings);
      grantResourcePermissionPersister = new NonRecursiveGrantResourcePermissionPersister(sqlProfile, sqlStrings);
      grantGlobalResourcePermissionPersister = new NonRecursiveGrantGlobalResourcePermissionPersister(sqlProfile, sqlStrings);
    }
  }
  ...
  @Override public void unauthenticate() {
  ...
  @Override public void impersonate(Resource resource) {
    SQLConnection connection = null;
  ...
  private void __assertImpersonatePermission(SQLConnection connection, Resource resource) {
    ...
    final Set<ResourcePermission> resourcePermissions = __getEffectiveResourcePermissions(connection, authenticatedResource, resource);
    ...
    if (!impersonatePermissionOK) {
      final String domainName = domainPersister.getResourceDomainNameByResourceId(connection, resource);
      final Set<ResourcePermission> globalResourcePermissions = __getEffectiveGlobalResourcePermissions(connection, authenticatedResource, resourceClassInternalInfo.getResourceClassName(), domainName);
  ...
  @Override public void unimpersonate() {
    sessionResource = authenticatedResource;
    defensiveCopyOfSessionResource = defensiveCopyOfAuthenticatedResource;
    sessionResourceDomainName = authenticatedResourceDomainName;
  }

  @Override public void setCredentials(Resource resource, Credentials newCredentials) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(resource);
    ...
    try {
      ...
      if (authenticatedResource.equals(resource)) {
        ...
        __assertResetCredentialsResourcePermission(connection, resource, resourceClassInfo.getResourceClassName(), domainName);
      }
    }  finally {
      __closeConnection(connection);
    }
    authenticationProvider.validateCredentials(resourceClassInfo.getResourceClassName(), domainName, newCredentials);
  ...
  private void __assertResetCredentialsResourcePermission(SQLConnection connection, Resource resource, String resourceClassName, String domainName) {
    ...
    if (!hasResetCredentialsPermission) {
      final Set<ResourcePermission> globalResourcePermissions = __getEffectiveGlobalResourcePermissions(connection, authenticatedResource, resourceClassName, domainName);
      if (globalResourcePermissions.contains(ResourcePermission_RESET_CREDENTIALS) || globalResourcePermissions.contains(ResourcePermission_RESET_CREDENTIALS_GRANT)) {
        hasResetCredentialsPermission = true;
      }
    }
    if (!hasResetCredentialsPermission) {
    ...
    if (!hasResetCredentialsPermission) {
      throw NotAuthorizedException.newInstanceForActionOnResource(authenticatedResource, "reset credentials", resource);
    }
  }

  @Override public void createResourceClass(String resourceClassName, boolean authenticatable, boolean unauthenticatedCreateAllowed) {
    SQLConnection connection = null;
    __assertAuthenticated();
  ...
  @Override public void createResourcePermission(String resourceClassName, String permissionName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertAuthenticatedAsSystemResource();
  ...
  @Override public void createDomain(String domainName, String parentDomainName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertDomainSpecified(domainName);
  ...
  private void __createDomain(SQLConnection connection, String domainName, String parentDomainName) {
    final Set<DomainCreatePermission> domainCreatePermissions = grantDomainCreatePermissionSysPersister.getDomainCreateSysPermissionsIncludeInherited(connection, sessionResource);
    if (domainCreatePermissions.isEmpty()) {
      throw NotAuthorizedException.newInstanceForAction(sessionResource, "create domain");
    }
    final Set<DomainPermission> newDomainPermissions = __getPostCreateDomainPermissions(grantDomainCreatePermissionPostCreateSysPersister.getDomainCreatePostCreateSysPermissionsIncludeInherited(connection, sessionResource));
    ...
    if (parentDomainName == null) {
      ...
      if (!parentDomainPermissions.contains(DomainPermission_CREATE_CHILD_DOMAIN) && !parentDomainPermissions.contains(DomainPermission_CREATE_CHILD_DOMAIN_GRANT) && !parentDomainPermissions.contains(DomainPermission_SUPER_USER) && !parentDomainPermissions.contains(DomainPermission_SUPER_USER_GRANT)) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "create child domain in domain: " + parentDomainName);
      }
      domainPersister.addResourceDomain(connection, domainName, parentDomainId);
    }
    if (newDomainPermissions.size() > 0) {
      __setDirectDomainPermissions(connection, sessionResource, domainName, newDomainPermissions, true);
    }
  }

  @Override public boolean deleteDomain(String domainName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertDomainSpecified(domainName);
    try {
  ...
  private boolean __deleteDomain(SQLConnection connection, String domainName) {
    ...
    if (!__hasDomainPermissions(connection, sessionResource, domainName, Collections.singleton(DomainPermission_DELETE))) {
      throw NotAuthorizedException.newInstanceForDomainPermissions(sessionResource, domainName, DomainPermission_DELETE);
    }
  ...
  @Override public Resource createResource(String resourceClassName, String domainName) {
    SQLConnection connection = null;
    try {
      connection = __getConnection();
  ...
  @Override public Resource createResource(String resourceClassName, String domainName, Credentials credentials) {
    SQLConnection connection = null;
    __assertCredentialsSpecified(credentials);
    try {
      connection = __getConnection();
  ...
  @Override public Resource createResource(String resourceClassName, String domainName, String externalId) {
    SQLConnection connection = null;
  ...
  @Override public Resource createResource(String resourceClassName, String domainName, String externalId, Credentials credentials) {
    SQLConnection connection = null;
    __assertExternalIdSpecified(externalId);
    __assertCredentialsSpecified(credentials);
    try {
  ...
  private Resource __createResource(SQLConnection connection, String resourceClassName, String domainName, String externalId, Credentials credentials) {
    ...
    __assertDomainSpecified(domainName);
    resourceClassName = resourceClassName.trim();
    final ResourceClassInternalInfo resourceClassInternalInfo = __getResourceClassInternalInfo(connection, resourceClassName);
    ...
    if (sessionResource == null) {
      ...
      resourceCreatePermissions = __getEffectiveResourceCreatePermissionsIgnoringSuperUserPrivileges(connection, sessionResource, resourceClassName, domainName);
      ...
      if (!createPermissionOK) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "create resource of resource class " + resourceClassName);
      }
    }
    final Resource newResource = resourcePersister.createResource(connection, Id.<ResourceClassId>from(resourceClassInternalInfo.getResourceClassId()), domainId, externalId);
    if (newResourcePermissions != null && newResourcePermissions.size() > 0) {
      if (sessionResource != null) {
        __setDirectResourcePermissions(connection, sessionResource, newResource, newResourcePermissions, sessionResource, true);
      } else {
        __setDirectResourcePermissions(connection, newResource, newResource, newResourcePermissions, newResource, true);
      }
    }
    if (credentials != null) {
  ...
  @Override public Resource setExternalId(Resource resource, String externalId) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(resource);
    __assertExternalIdSpecified(externalId);
  ...
  private Resource __setExternalId(SQLConnection connection, Resource resource, String externalId) {
    ...
    final Id<ResourceClassId> resourceClassId = Id.from(resourceClassPersister.getResourceClassInfoByResourceId(connection, resource).getResourceClassId());
    final Id<DomainId> domainId = resourcePersister.getDomainIdByResource(connection, resource);
    final Set<ResourceCreatePermission> resourceCreateSysPermissions = grantResourceCreatePermissionSysPersister.getResourceCreateSysPermissionsIncludeInherited(connection, sessionResource, resourceClassId, domainId);
    boolean createPermissionOK = false;
  ...
  @Override public boolean deleteResource(Resource obsoleteResource) {
    SQLConnection connection = null;
    __assertAuthenticated();
  ...
  private boolean __deleteResource(SQLConnection connection, Resource obsoleteResource) {
    ...
    if (!__isSuperUserOfResource(connection, sessionResource, obsoleteResource)) {
      final Set<ResourcePermission> sessionResourcePermissions = __getEffectiveResourcePermissionsIgnoringSuperUserPrivileges(connection, sessionResource, obsoleteResource);
      if (!sessionResourcePermissions.contains(ResourcePermission_DELETE) && !sessionResourcePermissions.contains(ResourcePermission_DELETE_GRANT)) {
        throw NotAuthorizedException.newInstanceForActionOnResource(sessionResource, "delete", obsoleteResource);
      }
    }
    final ResourceClassInternalInfo resourceClassInternalInfo = resourceClassPersister.getResourceClassInfoByResourceId(connection, obsoleteResource);
    if (resourceClassInternalInfo.isAuthenticatable()) {
    ...
    if (authenticatedResource.equals(obsoleteResource)) {
      ...
      if (sessionResource.equals(obsoleteResource)) {
        unimpersonate();
      }
    }
    return true;
  ...
  @Override public void setDomainPermissions(Resource accessorResource, String domainName, Set<DomainPermission> permissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
  ...
  private void __setDirectDomainPermissions(SQLConnection connection, Resource accessorResource, String domainName, Set<DomainPermission> requestedDomainPermissions, boolean newDomainMode) {
    ...
    if (!newDomainMode) {
      final Set<DomainPermission> grantorPermissions = __getEffectiveDomainPermissions(connection, sessionResource, domainName);
      if (!grantorPermissions.contains(DomainPermission_SUPER_USER) && !grantorPermissions.contains(DomainPermission_SUPER_USER_GRANT)) {
        final Set<DomainPermission> directAccessorPermissions = __getDirectDomainPermissions(connection, accessorResource, domainId);
        final Set<DomainPermission> requestedAddPermissions = __subtract(requestedDomainPermissions, directAccessorPermissions);
        if (!requestedAddPermissions.isEmpty()) {
          final Set<DomainPermission> unauthorizedAddPermissions;
          unauthorizedAddPermissions = __subtractDomainPermissionsIfGrantableFrom(requestedAddPermissions, grantorPermissions);
          if (unauthorizedAddPermissions.size() > 0) {
            throw NotAuthorizedException.newInstanceForAction(sessionResource, "add the following domain permission(s): " + unauthorizedAddPermissions);
          }
        }
        final Set<DomainPermission> requestedRemovePermissions = __subtract(directAccessorPermissions, requestedDomainPermissions);
        if (!requestedRemovePermissions.isEmpty()) {
          final Set<DomainPermission> unauthorizedRemovePermissions;
          unauthorizedRemovePermissions = __subtractDomainPermissionsIfGrantableFrom(requestedRemovePermissions, grantorPermissions);
          if (unauthorizedRemovePermissions.size() > 0) {
            throw NotAuthorizedException.newInstanceForAction(sessionResource, "remove the following domain permission(s): " + unauthorizedRemovePermissions);
          }
        }
      }
      grantDomainPermissionSysPersister.removeDomainSysPermissions(connection, accessorResource, domainId);
    }
    grantDomainPermissionSysPersister.addDomainSysPermissions(connection, accessorResource, sessionResource, domainId, requestedDomainPermissions);
  }
  ...
  @Override public void grantDomainPermissions(Resource accessorResource, String domainName, Set<DomainPermission> domainPermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertDomainSpecified(domainName);
  ...
  @Override public void grantDomainPermissions(Resource accessorResource, String domainName, DomainPermission domainPermission, DomainPermission... domainPermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertDomainSpecified(domainName);
    ...
    final Set<DomainPermission> normalizedDomainPermissions = __normalizeDomainPermissions(__getSetWithoutNullsOrDuplicates(domainPermission, domainPermissions));
    try {
      connection = __getConnection();
      accessorResource = __resolveResource(connection, accessorResource);
      __grantDirectDomainPermissions(connection, accessorResource, domainName, normalizedDomainPermissions);
  ...
  private void __grantDirectDomainPermissions(SQLConnection connection, Resource accessorResource, String domainName, Set<DomainPermission> requestedDomainPermissions) {
    ...
    final Set<DomainPermission> grantorPermissions = __getEffectiveDomainPermissions(connection, sessionResource, domainName);
    if (!grantorPermissions.contains(DomainPermission_SUPER_USER) && !grantorPermissions.contains(DomainPermission_SUPER_USER_GRANT)) {
      final Set<DomainPermission> unauthorizedPermissions = __subtractDomainPermissionsIfGrantableFrom(requestedDomainPermissions, grantorPermissions);
      if (unauthorizedPermissions.size() > 0) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "grant the following domain permission(s): " + unauthorizedPermissions);
      }
    }
    final Set<DomainPermission> directAccessorPermissions = __getDirectDomainPermissions(connection, accessorResource, domainId);
    ...
    grantDomainPermissionSysPersister.updateDomainSysPermissions(connection, accessorResource, sessionResource, domainId, updatePermissions);
    grantDomainPermissionSysPersister.addDomainSysPermissions(connection, accessorResource, sessionResource, domainId, addPermissions);
  }
  ...
  @Override public void revokeDomainPermissions(Resource accessorResource, String domainName, Set<DomainPermission> domainPermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertDomainSpecified(domainName);
  ...
  @Override public void revokeDomainPermissions(Resource accessorResource, String domainName, DomainPermission domainPermission, DomainPermission... domainPermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertDomainSpecified(domainName);
  ...
  private void __revokeDirectDomainPermissions(SQLConnection connection, Resource accessorResource, String domainName, Set<DomainPermission> requestedDomainPermissions) {
    ...
    if (!grantorPermissions.contains(DomainPermission_SUPER_USER) && !grantorPermissions.contains(DomainPermission_SUPER_USER_GRANT)) {
      final Set<DomainPermission> unauthorizedPermissions = __subtractDomainPermissionsIfGrantableFrom(requestedDomainPermissions, grantorPermissions);
      if (unauthorizedPermissions.size() > 0) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "revoke the following domain permission(s): " + unauthorizedPermissions);
      }
    }
    final Set<DomainPermission> directAccessorPermissions = __getDirectDomainPermissions(connection, accessorResource, domainId);
    ...
    grantDomainPermissionSysPersister.removeDomainSysPermissions(connection, accessorResource, domainId, removePermissions);
  }

  @Override public Set<DomainPermission> getDomainPermissions(Resource accessorResource, String domainName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertDomainSpecified(domainName);
  ...
  @Override public Map<String, Set<DomainPermission>> getDomainPermissionsMap(Resource accessorResource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    try {
      ...
      accessorResource = __resolveResource(connection, accessorResource);
      __assertQueryAuthorization(connection, accessorResource);
      return __collapseDomainPermissions(grantDomainPermissionSysPersister.getDomainSysPermissions(connection, accessorResource));
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public Set<DomainPermission> getEffectiveDomainPermissions(Resource accessorResource, String domainName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertDomainSpecified(domainName);
  ...
  private Set<DomainPermission> __getEffectiveDomainPermissions(SQLConnection connection, Resource accessorResource, Id<DomainId> domainId) {
    final Set<DomainPermission> domainSysPermissionsIncludingInherited = grantDomainPermissionSysPersister.getDomainSysPermissionsIncludeInherited(connection, accessorResource, domainId);
  ...
  @Override public Map<String, Set<DomainPermission>> getEffectiveDomainPermissionsMap(Resource accessorResource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    try {
  ...
  private Map<String, Set<DomainPermission>> __getEffectiveDomainPermissionsMap(SQLConnection connection, Resource accessorResource) {
    final Map<String, Set<DomainPermission>> domainSysPermissionsIncludingInherited = grantDomainPermissionSysPersister.getDomainSysPermissionsIncludeInherited(connection, accessorResource);
    for (Map.Entry<String, Set<DomainPermission>> domainPermissionsByDomainEntry : domainSysPermissionsIncludingInherited.entrySet()) {
      ...
      if (domainPermissions.contains(DomainPermission_SUPER_USER) || domainPermissions.contains(DomainPermission_SUPER_USER_GRANT)) {
        domainSysPermissionsIncludingInherited.put(domainPermissionsByDomainEntry.getKey(), __getApplicableDomainPermissions());
      }
    }
    return __collapseDomainPermissions(domainSysPermissionsIncludingInherited);
  }
  ...
  private Map<String, Set<DomainPermission>> __collapseDomainPermissions(Map<String, Set<DomainPermission>> domainPermissionsMap) {
    ...
    for (Map.Entry<String, Set<DomainPermission>> domainPermissionsByDomainEntry : domainPermissionsMap.entrySet()) {
      collapsedDomainPermissionsMap.put(domainPermissionsByDomainEntry.getKey(), __collapseDomainPermissions(domainPermissionsByDomainEntry.getValue()));
    }
    return collapsedDomainPermissionsMap;
  }

  @Override public void setDomainCreatePermissions(Resource accessorResource, Set<DomainCreatePermission> domainCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertPermissionsSpecified(domainCreatePermissions);
    final Set<DomainCreatePermission> normalizedDomainCreatePermissions = __normalizeDomainCreatePermissions(domainCreatePermissions);
    try {
      connection = __getConnection();
      accessorResource = __resolveResource(connection, accessorResource);
  ...
  private void __setDirectDomainCreatePermissions(SQLConnection connection, Resource accessorResource, Set<DomainCreatePermission> requestedDomainCreatePermissions) {
    ...
    final Set<DomainCreatePermission> grantorPermissions = __getEffectiveDomainCreatePermissions(connection, sessionResource);
    final Set<DomainCreatePermission> directAccessorPermissions = __getDirectDomainCreatePermissions(connection, accessorResource);
    final Set<DomainCreatePermission> requestedAddPermissions = __subtract(requestedDomainCreatePermissions, directAccessorPermissions);
    if (!requestedAddPermissions.isEmpty()) {
      final Set<DomainCreatePermission> unauthorizedAddPermissions = __subtractDomainCreatePermissionsIfGrantableFrom(requestedAddPermissions, grantorPermissions);
      if (unauthorizedAddPermissions.size() > 0) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "add the following domain create permission(s): " + unauthorizedAddPermissions);
      }
    }
    final Set<DomainCreatePermission> requestedRemovePermissions = __subtract(directAccessorPermissions, requestedDomainCreatePermissions);
    if (!requestedRemovePermissions.isEmpty()) {
      final Set<DomainCreatePermission> unauthorizedRemovePermissions = __subtractDomainCreatePermissionsIfGrantableFrom(requestedRemovePermissions, grantorPermissions);
      if (unauthorizedRemovePermissions.size() > 0) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "remove the following domain create permission(s): " + unauthorizedRemovePermissions);
      }
    }
    grantDomainCreatePermissionSysPersister.removeDomainCreateSysPermissions(connection, accessorResource);
    grantDomainCreatePermissionPostCreateSysPersister.removeDomainCreatePostCreateSysPermissions(connection, accessorResource);
    grantDomainCreatePermissionSysPersister.addDomainCreateSysPermissions(connection, accessorResource, sessionResource, requestedDomainCreatePermissions);
    grantDomainCreatePermissionPostCreateSysPersister.addDomainCreatePostCreateSysPermissions(connection, accessorResource, sessionResource, requestedDomainCreatePermissions);
  }
  ...
  private Set<DomainCreatePermission> __getDirectDomainCreatePermissions(SQLConnection connection, Resource accessorResource) {
    ...
    domainCreatePermissions.addAll(grantDomainCreatePermissionSysPersister.getDomainCreateSysPermissions(connection, accessorResource));
    domainCreatePermissions.addAll(grantDomainCreatePermissionPostCreateSysPersister.getDomainCreatePostCreateSysPermissions(connection, accessorResource));
  ...
  @Override public void grantDomainCreatePermissions(Resource accessorResource, Set<DomainCreatePermission> domainCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertPermissionsSpecified(domainCreatePermissions);
  ...
  @Override public void grantDomainCreatePermissions(Resource accessorResource, DomainCreatePermission domainCreatePermission, DomainCreatePermission... domainCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertPermissionSpecified(domainCreatePermission);
    __assertVarargPermissionsSpecified(domainCreatePermissions);
    final Set<DomainCreatePermission> normalizedDomainCreatePermissions = __normalizeDomainCreatePermissions(__getSetWithoutNullsOrDuplicates(domainCreatePermission, domainCreatePermissions));
    try {
      connection = __getConnection();
      accessorResource = __resolveResource(connection, accessorResource);
      __grantDirectDomainCreatePermissions(connection, accessorResource, normalizedDomainCreatePermissions);
  ...
  private void __grantDirectDomainCreatePermissions(SQLConnection connection, Resource accessorResource, Set<DomainCreatePermission> requestedDomainCreatePermissions) {
    __assertUniqueSystemOrPostCreateDomainPermissionNames(requestedDomainCreatePermissions);
    final Set<DomainCreatePermission> grantorPermissions = __getEffectiveDomainCreatePermissions(connection, sessionResource);
    final Set<DomainCreatePermission> unauthorizedPermissions = __subtractDomainCreatePermissionsIfGrantableFrom(requestedDomainCreatePermissions, grantorPermissions);
    if (unauthorizedPermissions.size() > 0) {
      throw NotAuthorizedException.newInstanceForAction(sessionResource, "grant the following domain create permission(s): " + unauthorizedPermissions);
    }
    final Set<DomainCreatePermission> directAccessorPermissions = __getDirectDomainCreatePermissions(connection, accessorResource);
    ...
    for (DomainCreatePermission requestedPermission : requestedDomainCreatePermissions) {
      ...
      if (requestedPermission.isSystemPermission()) {
        for (DomainCreatePermission existingDirectPermission : directAccessorPermissions) {
          if (existingDirectPermission.isSystemPermission() && requestedPermission.getSystemPermissionId() == existingDirectPermission.getSystemPermissionId()) {
            if (!requestedPermission.equals(existingDirectPermission) && !requestedPermission.isGrantableFrom(existingDirectPermission)) {
              updatePermissions.add(requestedPermission);
            }
            existingPermission = true;
        ...
        for (DomainCreatePermission existingDirectPermission : directAccessorPermissions) {
          if (!existingDirectPermission.isSystemPermission()) {
            final DomainPermission existingPostCreateDomainPermission = existingDirectPermission.getPostCreateDomainPermission();
    ...
    grantDomainCreatePermissionSysPersister.updateDomainCreateSysPermissions(connection, accessorResource, sessionResource, updatePermissions);
    grantDomainCreatePermissionPostCreateSysPersister.updateDomainCreatePostCreateSysPermissions(connection, accessorResource, sessionResource, updatePermissions);
    grantDomainCreatePermissionSysPersister.addDomainCreateSysPermissions(connection, accessorResource, sessionResource, addPermissions);
    grantDomainCreatePermissionPostCreateSysPersister.addDomainCreatePostCreateSysPermissions(connection, accessorResource, sessionResource, addPermissions);
  }
  ...
  @Override public void revokeDomainCreatePermissions(Resource accessorResource, Set<DomainCreatePermission> domainCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertPermissionsSpecified(domainCreatePermissions);
  ...
  @Override public void revokeDomainCreatePermissions(Resource accessorResource, DomainCreatePermission domainCreatePermission, DomainCreatePermission... domainCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertPermissionSpecified(domainCreatePermission);
  ...
  private void __revokeDirectDomainCreatePermissions(SQLConnection connection, Resource accessorResource, Set<DomainCreatePermission> requestedDomainCreatePermissions) {
    ...
    final Set<DomainCreatePermission> unauthorizedPermissions = __subtractDomainCreatePermissionsIfGrantableFrom(requestedDomainCreatePermissions, grantorPermissions);
    if (unauthorizedPermissions.size() > 0) {
      throw NotAuthorizedException.newInstanceForAction(sessionResource, "revoke the following domain create permission(s): " + unauthorizedPermissions);
    }
    final Set<DomainCreatePermission> directAccessorPermissions = __getDirectDomainCreatePermissions(connection, accessorResource);
    if ((directAccessorPermissions.size() > requestedDomainCreatePermissions.size()) && __setContainsDomainCreateSystemPermission(requestedDomainCreatePermissions)) {
    ...
    grantDomainCreatePermissionSysPersister.removeDomainCreateSysPermissions(connection, accessorResource, removePermissions);
    grantDomainCreatePermissionPostCreateSysPersister.removeDomainCreatePostCreateSysPermissions(connection, accessorResource, removePermissions);
  }

  @Override public Set<DomainCreatePermission> getDomainCreatePermissions(Resource accessorResource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    try {
  ...
  @Override public Set<DomainCreatePermission> getEffectiveDomainCreatePermissions(Resource accessorResource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    try {
  ...
  private Set<DomainCreatePermission> __getEffectiveDomainCreatePermissions(SQLConnection connection, Resource accessorResource) {
    final Set<DomainCreatePermission> domainCreatePermissions = new HashSet<>();
    domainCreatePermissions.addAll(grantDomainCreatePermissionSysPersister.getDomainCreateSysPermissionsIncludeInherited(connection, accessorResource));
    domainCreatePermissions.addAll(grantDomainCreatePermissionPostCreateSysPersister.getDomainCreatePostCreateSysPermissionsIncludeInherited(connection, accessorResource));
  ...
  @Override public void setResourceCreatePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourceCreatePermission> resourceCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    final Set<ResourceCreatePermission> normalizedResourceCreatePermissions = __normalizeResourceCreatePermission(resourceCreatePermissions);
    try {
      connection = __getConnection();
      accessorResource = __resolveResource(connection, accessorResource);
      __setDirectResourceCreatePermissions(connection, accessorResource, resourceClassName, domainName, normalizedResourceCreatePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }
  ...
  private void __setDirectResourceCreatePermissions(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName, Set<ResourceCreatePermission> requestedResourceCreatePermissions) {
    ...
    if (!__isSuperUserOfDomain(connection, sessionResource, domainName)) {
      final Set<ResourceCreatePermission> grantorPermissions = __getEffectiveResourceCreatePermissionsIgnoringSuperUserPrivileges(connection, sessionResource, resourceClassName, domainName);
      final Set<ResourceCreatePermission> directAccessorPermissions = __getDirectResourceCreatePermissions(connection, accessorResource, resourceClassId, domainId);
      final Set<ResourceCreatePermission> requestedAddPermissions = __subtract(requestedResourceCreatePermissions, directAccessorPermissions);
      if (!requestedAddPermissions.isEmpty()) {
        final Set<ResourceCreatePermission> unauthorizedAddPermissions = __subtractResourceCreatePermissionsIfGrantableFrom(requestedAddPermissions, grantorPermissions);
        if (unauthorizedAddPermissions.size() > 0) {
          throw NotAuthorizedException.newInstanceForAction(sessionResource, "add the following permission(s): " + unauthorizedAddPermissions);
        }
      }
      final Set<ResourceCreatePermission> requestedRemovePermissions = __subtract(directAccessorPermissions, requestedResourceCreatePermissions);
      if (!requestedRemovePermissions.isEmpty()) {
        final Set<ResourceCreatePermission> unauthorizedRemovePermissions = __subtractResourceCreatePermissionsIfGrantableFrom(requestedRemovePermissions, grantorPermissions);
        if (unauthorizedRemovePermissions.size() > 0) {
          throw NotAuthorizedException.newInstanceForAction(sessionResource, "remove the following permission(s): " + unauthorizedRemovePermissions);
        }
      }
    }
    grantResourceCreatePermissionSysPersister.removeResourceCreateSysPermissions(connection, accessorResource, resourceClassId, domainId);
    grantResourceCreatePermissionPostCreateSysPersister.removeResourceCreatePostCreateSysPermissions(connection, accessorResource, resourceClassId, domainId);
    grantResourceCreatePermissionPostCreatePersister.removeResourceCreatePostCreatePermissions(connection, accessorResource, resourceClassId, domainId);
    grantResourceCreatePermissionSysPersister.addResourceCreateSysPermissions(connection, accessorResource, resourceClassId, domainId, requestedResourceCreatePermissions, sessionResource);
    grantResourceCreatePermissionPostCreateSysPersister.addResourceCreatePostCreateSysPermissions(connection, accessorResource, resourceClassId, domainId, requestedResourceCreatePermissions, sessionResource);
    grantResourceCreatePermissionPostCreatePersister.addResourceCreatePostCreatePermissions(connection, accessorResource, resourceClassId, domainId, requestedResourceCreatePermissions, sessionResource);
  }
  ...
  private void __assertUniquePostCreatePermissionsNamesForResourceClass(SQLConnection connection, Set<ResourceCreatePermission> resourceCreatePermissions, ResourceClassInternalInfo resourceClassInternalInfo) {
    final List<String> validPermissionNames = __getApplicableResourcePermissionNames(connection, resourceClassInternalInfo);
  ...
  private <T extends java.lang.Object> Set<T> __subtract(Set<T> minuendSet, Set<T> subtrahendSet) {
  ...
  private Set<ResourceCreatePermission> __getDirectResourceCreatePermissions(SQLConnection connection, Resource accessorResource, Id<ResourceClassId> resourceClassId, Id<DomainId> domainId) {
    ...
    resourceCreatePermissions.addAll(grantResourceCreatePermissionSysPersister.getResourceCreateSysPermissions(connection, accessorResource, resourceClassId, domainId));
    resourceCreatePermissions.addAll(grantResourceCreatePermissionPostCreateSysPersister.getResourceCreatePostCreateSysPermissions(connection, accessorResource, resourceClassId, domainId));
    resourceCreatePermissions.addAll(grantResourceCreatePermissionPostCreatePersister.getResourceCreatePostCreatePermissions(connection, accessorResource, resourceClassId, domainId));
    return resourceCreatePermissions;
  }

  @Override public void grantResourceCreatePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourceCreatePermission> resourceCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      connection = __getConnection();
      accessorResource = __resolveResource(connection, accessorResource);
      __grantDirectResourceCreatePermissions(connection, accessorResource, resourceClassName, domainName, normalizedResourceCreatePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public void grantResourceCreatePermissions(Resource accessorResource, String resourceClassName, String domainName, ResourceCreatePermission resourceCreatePermission, ResourceCreatePermission... resourceCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    final Set<ResourceCreatePermission> normalizedResourceCreatePermissions = __normalizeResourceCreatePermission(__getSetWithoutNullsOrDuplicates(resourceCreatePermission, resourceCreatePermissions));
    try {
      connection = __getConnection();
      accessorResource = __resolveResource(connection, accessorResource);
      __grantDirectResourceCreatePermissions(connection, accessorResource, resourceClassName, domainName, normalizedResourceCreatePermissions);
  ...
  private void __grantDirectResourceCreatePermissions(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName, Set<ResourceCreatePermission> requestedResourceCreatePermissions) {
    ...
    if (!__isSuperUserOfDomain(connection, sessionResource, domainName)) {
      final Set<ResourceCreatePermission> grantorPermissions = __getEffectiveResourceCreatePermissionsIgnoringSuperUserPrivileges(connection, sessionResource, resourceClassName, domainName);
      final Set<ResourceCreatePermission> unauthorizedAddPermissions = __subtractResourceCreatePermissionsIfGrantableFrom(requestedResourceCreatePermissions, grantorPermissions);
      if (unauthorizedAddPermissions.size() > 0) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "grant the following permission(s): " + unauthorizedAddPermissions);
      }
    }
    final Set<ResourceCreatePermission> directAccessorPermissions = __getDirectResourceCreatePermissions(connection, accessorResource, resourceClassId, domainId);
    if (directAccessorPermissions.isEmpty()) {
    ...
    for (ResourceCreatePermission requestedPermission : requestedResourceCreatePermissions) {
      ...
      if (requestedPermission.isSystemPermission()) {
        ...
        final ResourcePermission requestedPostCreateResourcePermission = requestedPermission.getPostCreateResourcePermission();
        for (ResourceCreatePermission existingDirectPermission : directAccessorPermissions) {
          if (!existingDirectPermission.isSystemPermission()) {
            final ResourcePermission existingPostCreateResourcePermission = existingDirectPermission.getPostCreateResourcePermission();
    ...
    grantResourceCreatePermissionSysPersister.updateResourceCreateSysPermissions(connection, accessorResource, resourceClassId, domainId, updatePermissions, sessionResource);
    grantResourceCreatePermissionPostCreateSysPersister.updateResourceCreatePostCreateSysPermissions(connection, accessorResource, resourceClassId, domainId, updatePermissions, sessionResource);
    grantResourceCreatePermissionPostCreatePersister.updateResourceCreatePostCreatePermissions(connection, accessorResource, resourceClassId, domainId, updatePermissions, sessionResource);
    grantResourceCreatePermissionSysPersister.addResourceCreateSysPermissions(connection, accessorResource, resourceClassId, domainId, addPermissions, sessionResource);
    grantResourceCreatePermissionPostCreateSysPersister.addResourceCreatePostCreateSysPermissions(connection, accessorResource, resourceClassId, domainId, addPermissions, sessionResource);
    grantResourceCreatePermissionPostCreatePersister.addResourceCreatePostCreatePermissions(connection, accessorResource, resourceClassId, domainId, addPermissions, sessionResource);
  }

  @Override public void revokeResourceCreatePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourceCreatePermission> resourceCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      connection = __getConnection();
      accessorResource = __resolveResource(connection, accessorResource);
      __revokeDirectResourceCreatePermissions(connection, accessorResource, resourceClassName, domainName, normalizedResourceCreatePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public void revokeResourceCreatePermissions(Resource accessorResource, String resourceClassName, String domainName, ResourceCreatePermission resourceCreatePermission, ResourceCreatePermission... resourceCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
  ...
  private void __revokeDirectResourceCreatePermissions(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName, Set<ResourceCreatePermission> requestedResourceCreatePermissions) {
    ...
    if (!__isSuperUserOfDomain(connection, sessionResource, domainName)) {
      final Set<ResourceCreatePermission> grantorPermissions = __getEffectiveResourceCreatePermissionsIgnoringSuperUserPrivileges(connection, sessionResource, resourceClassName, domainName);
      final Set<ResourceCreatePermission> unauthorizedPermissions = __subtractResourceCreatePermissionsIfGrantableFrom(requestedResourceCreatePermissions, grantorPermissions);
      if (unauthorizedPermissions.size() > 0) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "revoke the following permission(s): " + unauthorizedPermissions);
      }
    }
    final Set<ResourceCreatePermission> directAccessorPermissions = __getDirectResourceCreatePermissions(connection, accessorResource, resourceClassId, domainId);
    if ((directAccessorPermissions.size() > requestedResourceCreatePermissions.size()) && __setContainsResourceCreateSystemPermission(requestedResourceCreatePermissions)) {
    ...
    for (ResourceCreatePermission requestedPermission : requestedResourceCreatePermissions) {
      if (requestedPermission.isSystemPermission()) {
        ...
        for (ResourceCreatePermission existingDirectPermission : directAccessorPermissions) {
          if (!existingDirectPermission.isSystemPermission()) {
            if (requestedPostCreateResourcePermission.equalsIgnoreGrantOption(existingDirectPermission.getPostCreateResourcePermission())) {
              removePermissions.add(requestedPermission);
              break;
            }
          }
    ...
    grantResourceCreatePermissionSysPersister.removeResourceCreateSysPermissions(connection, accessorResource, resourceClassId, domainId, removePermissions);
    grantResourceCreatePermissionPostCreateSysPersister.removeResourceCreatePostCreateSysPermissions(connection, accessorResource, resourceClassId, domainId, removePermissions);
    grantResourceCreatePermissionPostCreatePersister.removeResourceCreatePostCreatePermissions(connection, accessorResource, resourceClassId, domainId, removePermissions);
  }
  ...
  @Override public Set<ResourceCreatePermission> getResourceCreatePermissions(Resource accessorResource, String resourceClassName, String domainName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      resourceClassName = resourceClassName.trim();
      domainName = domainName.trim();
      return __getDirectResourceCreatePermissions(connection, accessorResource, resourceClassName, domainName);
    }  finally {
      __closeConnection(connection);
    }
  }
  ...
  private Set<ResourceCreatePermission> __getDirectResourceCreatePermissions(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName) {
    ...
    return __getDirectResourceCreatePermissions(connection, accessorResource, resourceClassId, domainId);
  }

  @Override public Map<String, Map<String, Set<ResourceCreatePermission>>> getResourceCreatePermissionsMap(Resource accessorResource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    try {
  ...
  private Map<String, Map<String, Set<ResourceCreatePermission>>> __getDirectResourceCreatePermissionsMap(SQLConnection connection, Resource accessorResource) {
    ...
    allResourceCreatePermissionsMap.putAll(grantResourceCreatePermissionSysPersister.getResourceCreateSysPermissions(connection, accessorResource));
    __mergeSourceCreatePermissionsMapIntoTargetCreatePermissionsMap(grantResourceCreatePermissionPostCreateSysPersister.getResourceCreatePostCreateSysPermissions(connection, accessorResource), allResourceCreatePermissionsMap);
    __mergeSourceCreatePermissionsMapIntoTargetCreatePermissionsMap(grantResourceCreatePermissionPostCreatePersister.getResourceCreatePostCreatePermissions(connection, accessorResource), allResourceCreatePermissionsMap);
    return __collapseResourceCreatePermissions(allResourceCreatePermissionsMap);
  }

  @Override public Set<ResourceCreatePermission> getEffectiveResourceCreatePermissions(Resource accessorResource, String resourceClassName, String domainName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      resourceClassName = resourceClassName.trim();
      domainName = domainName.trim();
      return __getEffectiveResourceCreatePermissions(connection, accessorResource, resourceClassName, domainName);
    }  finally {
      __closeConnection(connection);
    }
  }
  ...
  private Set<ResourceCreatePermission> __getEffectiveResourceCreatePermissionsIgnoringSuperUserPrivileges(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName) {
    ...
    Set<ResourceCreatePermission> resourceCreatePermissions = new HashSet<>();
    resourceCreatePermissions.addAll(grantResourceCreatePermissionSysPersister.getResourceCreateSysPermissionsIncludeInherited(connection, accessorResource, resourceClassId, domainId));
    resourceCreatePermissions.addAll(grantResourceCreatePermissionPostCreateSysPersister.getResourceCreatePostCreateSysPermissionsIncludeInherited(connection, accessorResource, resourceClassId, domainId));
    resourceCreatePermissions.addAll(grantResourceCreatePermissionPostCreatePersister.getResourceCreatePostCreatePermissionsIncludeInherited(connection, accessorResource, resourceClassId, domainId));
  ...
  @Override public Map<String, Map<String, Set<ResourceCreatePermission>>> getEffectiveResourceCreatePermissionsMap(Resource accessorResource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    try {
      ...
      accessorResource = __resolveResource(connection, accessorResource);
      __assertQueryAuthorization(connection, accessorResource);
      return __getEffectiveResourceCreatePermissionsMap(connection, accessorResource);
    }  finally {
      __closeConnection(connection);
    }
  }
  ...
  private Map<String, Map<String, Set<ResourceCreatePermission>>> __getEffectiveResourceCreatePermissionsMap(SQLConnection connection, Resource accessorResource) {
    Map<String, Map<String, Set<ResourceCreatePermission>>> allResourceCreatePermissionsMap = new HashMap<>();
    allResourceCreatePermissionsMap.putAll(grantResourceCreatePermissionSysPersister.getResourceCreateSysPermissionsIncludeInherited(connection, accessorResource));
    __mergeSourceCreatePermissionsMapIntoTargetCreatePermissionsMap(grantResourceCreatePermissionPostCreateSysPersister.getResourceCreatePostCreateSysPermissionsIncludeInherited(connection, accessorResource), allResourceCreatePermissionsMap);
    __mergeSourceCreatePermissionsMapIntoTargetCreatePermissionsMap(grantResourceCreatePermissionPostCreatePersister.getResourceCreatePostCreatePermissionsIncludeInherited(connection, accessorResource), allResourceCreatePermissionsMap);
    ...
    final Map<String, Set<DomainPermission>> effectiveDomainPermissionsMap = __getEffectiveDomainPermissionsMap(connection, accessorResource);
    for (Map.Entry<String, Set<DomainPermission>> effectiveDomainPermissionsByDomainEntry : effectiveDomainPermissionsMap.entrySet()) {
      ...
      if (effectiveDomainPermissions.contains(DomainPermission_SUPER_USER) || effectiveDomainPermissions.contains(DomainPermission_SUPER_USER_GRANT)) {
        if (superResourceCreatePermissionsMap == null) {
          ...
          for (String resourceClassName : resourceClassNames) {
            final Set<ResourceCreatePermission> applicableResourceCreatePermissions = __getApplicableResourceCreatePermissions(connection, __getResourceClassInternalInfo(connection, resourceClassName));
    ...
    __mergeSourceCreatePermissionsMapIntoTargetCreatePermissionsMap(allSuperResourceCreatePermissionsMap, allResourceCreatePermissionsMap);
    return __collapseResourceCreatePermissions(allResourceCreatePermissionsMap);
  }
  ...
  private Map<String, Map<String, Set<ResourceCreatePermission>>> __collapseResourceCreatePermissions(Map<String, Map<String, Set<ResourceCreatePermission>>> resourceCreatePermissionsMap) {
    for (Map.Entry<String, Map<String, Set<ResourceCreatePermission>>> createPermissionsByDomainEntry : resourceCreatePermissionsMap.entrySet()) {
      final Map<String, Set<ResourceCreatePermission>> createPermissionsByResourceClassMap = createPermissionsByDomainEntry.getValue();
      for (Map.Entry<String, Set<ResourceCreatePermission>> createPermissionsByResourceClassEntry : createPermissionsByResourceClassMap.entrySet()) {
        createPermissionsByResourceClassMap.put(createPermissionsByResourceClassEntry.getKey(), __collapseResourceCreatePermissions(createPermissionsByResourceClassEntry.getValue()));
      }
    }
    return resourceCreatePermissionsMap;
  }

  @Override public void setResourcePermissions(Resource accessorResource, Resource accessedResource, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    ...
    try {
      ...
      __setDirectResourcePermissions(connection, accessorResource, accessedResource, normalizedResourcePermissions, sessionResource, false);
    }  finally {
      __closeConnection(connection);
    }
  }
  ...
  private void __setDirectResourcePermissions(SQLConnection connection, Resource accessorResource, Resource accessedResource, Set<ResourcePermission> requestedResourcePermissions, Resource grantorResource, boolean newResourceMode) {
    final ResourceClassInternalInfo accessedResourceClassInternalInfo = resourceClassPersister.getResourceClassInfoByResourceId(connection, accessedResource);
    __assertUniqueResourcePermissionsNamesForResourceClass(connection, requestedResourcePermissions, accessedResourceClassInternalInfo);
    if (!newResourceMode) {
      if (!__isSuperUserOfResource(connection, grantorResource, accessedResource)) {
        final Set<ResourcePermission> grantorResourcePermissions = __getEffectiveResourcePermissionsIgnoringSuperUserPrivileges(connection, grantorResource, accessedResource);
        final Set<ResourcePermission> directAccessorResourcePermissions = __getDirectResourcePermissions(connection, accessorResource, accessedResource);
        final Set<ResourcePermission> requestedAddPermissions = __subtract(requestedResourcePermissions, directAccessorResourcePermissions);
        if (requestedAddPermissions.size() > 0) {
          final Set<ResourcePermission> unauthorizedAddPermissions = __subtractResourcePermissionsIfGrantableFrom(requestedAddPermissions, grantorResourcePermissions);
          if (unauthorizedAddPermissions.size() > 0) {
        ...
        final Set<ResourcePermission> requestedRemovePermissions = __subtract(directAccessorResourcePermissions, requestedResourcePermissions);
        if (requestedRemovePermissions.size() > 0) {
          final Set<ResourcePermission> unauthorizedRemovePermissions = __subtractResourcePermissionsIfGrantableFrom(requestedRemovePermissions, grantorResourcePermissions);
          if (unauthorizedRemovePermissions.size() > 0) {
      ...
      if (requestedResourcePermissions.contains(ResourcePermission_INHERIT) || requestedResourcePermissions.contains(ResourcePermission_INHERIT_GRANT)) {
        Set<ResourcePermission> reversePathResourcePermissions = __getEffectiveResourcePermissionsIgnoringSuperUserPrivileges(connection, accessedResource, accessorResource);
        if (reversePathResourcePermissions.contains(ResourcePermission_INHERIT) || reversePathResourcePermissions.contains(ResourcePermission_INHERIT_GRANT) || accessorResource.equals(accessedResource)) {
      ...
      grantResourcePermissionSysPersister.removeResourceSysPermissions(connection, accessorResource, accessedResource);
      grantResourcePermissionPersister.removeResourcePermissions(connection, accessorResource, accessedResource);
    }
    grantResourcePermissionSysPersister.addResourceSysPermissions(connection, accessorResource, accessedResource, Id.<ResourceClassId>from(accessedResourceClassInternalInfo.getResourceClassId()), requestedResourcePermissions, grantorResource);
    grantResourcePermissionPersister.addResourcePermissions(connection, accessorResource, accessedResource, Id.<ResourceClassId>from(accessedResourceClassInternalInfo.getResourceClassId()), requestedResourcePermissions, grantorResource);
  }
  ...
  @Override public void grantResourcePermissions(Resource accessorResource, Resource accessedResource, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceSpecified(accessedResource);
  ...
  @Override public void grantResourcePermissions(Resource accessorResource, Resource accessedResource, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceSpecified(accessedResource);
    ...
    final Set<ResourcePermission> normalizedResourcePermissions = __normalizeResourcePermission(__getSetWithoutNullsOrDuplicates(resourcePermission, resourcePermissions));
    try {
      connection = __getConnection();
      accessorResource = __resolveResource(connection, accessorResource);
      accessedResource = __resolveResource(connection, accessedResource);
  ...
  private void __grantDirectResourcePermissions(SQLConnection connection, Resource accessorResource, Resource accessedResource, Set<ResourcePermission> requestedResourcePermissions) {
    ...
    if (!__isSuperUserOfResource(connection, sessionResource, accessedResource)) {
      final Set<ResourcePermission> grantorResourcePermissions = __getEffectiveResourcePermissionsIgnoringSuperUserPrivileges(connection, sessionResource, accessedResource);
      final Set<ResourcePermission> unauthorizedPermissions = __subtractResourcePermissionsIfGrantableFrom(requestedResourcePermissions, grantorResourcePermissions);
      if (unauthorizedPermissions.size() > 0) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "grant the following permission(s): " + unauthorizedPermissions);
      }
    }
    final Set<ResourcePermission> directAccessorResourcePermissions = __getDirectResourcePermissions(connection, accessorResource, accessedResource);
    ...
    if (addPermissions.contains(ResourcePermission_INHERIT) || addPermissions.contains(ResourcePermission_INHERIT_GRANT)) {
      Set<ResourcePermission> reversePathResourcePermissions = __getEffectiveResourcePermissionsIgnoringSuperUserPrivileges(connection, accessedResource, accessorResource);
      if (reversePathResourcePermissions.contains(ResourcePermission_INHERIT) || reversePathResourcePermissions.contains(ResourcePermission_INHERIT_GRANT) || accessorResource.equals(accessedResource)) {
        throw new OaccException("Granting the requested permission(s): " + requestedResourcePermissions + " will cause a cycle between: " + accessorResource + " and: " + accessedResource);
      }
    }
    grantResourcePermissionSysPersister.updateResourceSysPermissions(connection, accessorResource, accessedResource, Id.<ResourceClassId>from(accessedResourceClassInternalInfo.getResourceClassId()), updatePermissions, sessionResource);
    grantResourcePermissionPersister.updateResourcePermissions(connection, accessorResource, accessedResource, Id.<ResourceClassId>from(accessedResourceClassInternalInfo.getResourceClassId()), updatePermissions, sessionResource);
    grantResourcePermissionSysPersister.addResourceSysPermissions(connection, accessorResource, accessedResource, Id.<ResourceClassId>from(accessedResourceClassInternalInfo.getResourceClassId()), addPermissions, sessionResource);
    grantResourcePermissionPersister.addResourcePermissions(connection, accessorResource, accessedResource, Id.<ResourceClassId>from(accessedResourceClassInternalInfo.getResourceClassId()), addPermissions, sessionResource);
  }

  @Override public void revokeResourcePermissions(Resource accessorResource, Resource accessedResource, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceSpecified(accessedResource);
  ...
  @Override public void revokeResourcePermissions(Resource accessorResource, Resource accessedResource, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceSpecified(accessedResource);
  ...
  private void __revokeDirectResourcePermissions(SQLConnection connection, Resource accessorResource, Resource accessedResource, Set<ResourcePermission> obsoleteResourcePermissions) {
    final ResourceClassInternalInfo accessedResourceClassInternalInfo = resourceClassPersister.getResourceClassInfoByResourceId(connection, accessedResource);
    __assertUniqueResourcePermissionsNamesForResourceClass(connection, obsoleteResourcePermissions, accessedResourceClassInternalInfo);
    if (!__isSuperUserOfResource(connection, sessionResource, accessedResource)) {
      final Set<ResourcePermission> grantorResourcePermissions = __getEffectiveResourcePermissionsIgnoringSuperUserPrivileges(connection, sessionResource, accessedResource);
      final Set<ResourcePermission> unauthorizedPermissions = __subtractResourcePermissionsIfGrantableFrom(obsoleteResourcePermissions, grantorResourcePermissions);
      if (unauthorizedPermissions.size() > 0) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "revoke the following permission(s): " + unauthorizedPermissions);
      }
    }
    ...
    grantResourcePermissionSysPersister.removeResourceSysPermissions(connection, accessorResource, accessedResource, Id.<ResourceClassId>from(accessedResourceClassInternalInfo.getResourceClassId()), removePermissions);
    grantResourcePermissionPersister.removeResourcePermissions(connection, accessorResource, accessedResource, Id.<ResourceClassId>from(accessedResourceClassInternalInfo.getResourceClassId()), removePermissions);
  }

  @Override public Set<ResourcePermission> getResourcePermissions(Resource accessorResource, Resource accessedResource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceSpecified(accessedResource);
  ...
  private Set<ResourcePermission> __getDirectResourcePermissions(SQLConnection connection, Resource accessorResource, Resource accessedResource) {
    ...
    resourcePermissions.addAll(grantResourcePermissionSysPersister.getResourceSysPermissions(connection, accessorResource, accessedResource));
    resourcePermissions.addAll(grantResourcePermissionPersister.getResourcePermissions(connection, accessorResource, accessedResource));
    return resourcePermissions;
  }

  @Override public Set<ResourcePermission> getEffectiveResourcePermissions(Resource accessorResource, Resource accessedResource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceSpecified(accessedResource);
  ...
  private Set<ResourcePermission> __getEffectiveResourcePermissions(SQLConnection connection, Resource accessorResource, Resource accessedResource) {
    ...
    resourcePermissions.addAll(grantResourcePermissionSysPersister.getResourceSysPermissionsIncludeInherited(connection, accessorResource, accessedResource));
    resourcePermissions.addAll(grantResourcePermissionPersister.getResourcePermissionsIncludeInherited(connection, accessorResource, accessedResource));
    final Id<ResourceClassId> accessedResourceClassId = Id.from(resourceClassInternalInfo.getResourceClassId());
    resourcePermissions.addAll(grantGlobalResourcePermissionSysPersister.getGlobalSysPermissionsIncludeInherited(connection, accessorResource, accessedResourceClassId, accessedDomainId));
    resourcePermissions.addAll(grantGlobalResourcePermissionPersister.getGlobalResourcePermissionsIncludeInherited(connection, accessorResource, accessedResourceClassId, accessedDomainId));
  ...
  private Set<ResourcePermission> __getEffectiveResourcePermissionsIgnoringSuperUserPrivileges(SQLConnection connection, Resource accessorResource, Resource accessedResource) {
    ...
    resourcePermissions.addAll(grantResourcePermissionPersister.getResourcePermissionsIncludeInherited(connection, accessorResource, accessedResource));
    final Id<DomainId> accessedDomainId = resourcePersister.getDomainIdByResource(connection, accessedResource);
    final Id<ResourceClassId> accessedResourceClassId = Id.from(resourceClassPersister.getResourceClassInfoByResourceId(connection, accessedResource).getResourceClassId());
    resourcePermissions.addAll(grantGlobalResourcePermissionSysPersister.getGlobalSysPermissionsIncludeInherited(connection, accessorResource, accessedResourceClassId, accessedDomainId));
    resourcePermissions.addAll(grantGlobalResourcePermissionPersister.getGlobalResourcePermissionsIncludeInherited(connection, accessorResource, accessedResourceClassId, accessedDomainId));
    return __collapseResourcePermissions(resourcePermissions);
  }

  @Override public void setGlobalResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      resourceClassName = resourceClassName.trim();
      domainName = domainName.trim();
      __setDirectGlobalPermissions(connection, accessorResource, resourceClassName, domainName, normalizedResourcePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }
  ...
  private void __setDirectGlobalPermissions(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> requestedResourcePermissions) {
    ...
    if (!__isSuperUserOfDomain(connection, sessionResource, domainName)) {
      final Set<ResourcePermission> grantorPermissions = __getEffectiveGlobalResourcePermissionsIgnoringSuperUserPrivileges(connection, sessionResource, resourceClassName, domainName);
      final Set<ResourcePermission> directAccessorPermissions = __getDirectGlobalResourcePermissions(connection, accessorResource, resourceClassId, domainId);
      final Set<ResourcePermission> requestedAddPermissions = __subtract(requestedResourcePermissions, directAccessorPermissions);
      if (!requestedAddPermissions.isEmpty()) {
        final Set<ResourcePermission> unauthorizedAddPermissions = __subtractResourcePermissionsIfGrantableFrom(requestedAddPermissions, grantorPermissions);
        if (unauthorizedAddPermissions.size() > 0) {
          throw NotAuthorizedException.newInstanceForAction(sessionResource, "add the following global permission(s): " + unauthorizedAddPermissions);
        }
      }
      final Set<ResourcePermission> requestedRemovePermissions = __subtract(directAccessorPermissions, requestedResourcePermissions);
      if (!requestedRemovePermissions.isEmpty()) {
        final Set<ResourcePermission> unauthorizedRemovePermissions = __subtractResourcePermissionsIfGrantableFrom(requestedRemovePermissions, grantorPermissions);
        if (unauthorizedRemovePermissions.size() > 0) {
          throw NotAuthorizedException.newInstanceForAction(sessionResource, "remove the following global permission(s): " + unauthorizedRemovePermissions);
        }
      }
    }
    grantGlobalResourcePermissionSysPersister.removeGlobalSysPermissions(connection, accessorResource, resourceClassId, domainId);
    grantGlobalResourcePermissionPersister.removeGlobalResourcePermissions(connection, accessorResource, resourceClassId, domainId);
    grantGlobalResourcePermissionSysPersister.addGlobalSysPermissions(connection, accessorResource, resourceClassId, domainId, requestedResourcePermissions, sessionResource);
    grantGlobalResourcePermissionPersister.addGlobalResourcePermissions(connection, accessorResource, resourceClassId, domainId, requestedResourcePermissions, sessionResource);
  }
  ...
  private Set<ResourcePermission> __getDirectGlobalResourcePermissions(SQLConnection connection, Resource accessorResource, Id<ResourceClassId> resourceClassId, Id<DomainId> domainId) {
    Set<ResourcePermission> resourcePermissions = new HashSet<>();
    resourcePermissions.addAll(grantGlobalResourcePermissionSysPersister.getGlobalSysPermissions(connection, accessorResource, resourceClassId, domainId));
    resourcePermissions.addAll(grantGlobalResourcePermissionPersister.getGlobalResourcePermissions(connection, accessorResource, resourceClassId, domainId));
    return resourcePermissions;
  }
  ...
  @Override public void grantGlobalResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      resourceClassName = resourceClassName.trim();
      domainName = domainName.trim();
      __grantDirectGlobalPermissions(connection, accessorResource, resourceClassName, domainName, normalizedResourcePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public void grantGlobalResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
  ...
  private void __grantDirectGlobalPermissions(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> requestedResourcePermissions) {
    ...
    if (!__isSuperUserOfDomain(connection, sessionResource, domainName)) {
      final Set<ResourcePermission> grantorPermissions = __getEffectiveGlobalResourcePermissionsIgnoringSuperUserPrivileges(connection, sessionResource, resourceClassName, domainName);
      final Set<ResourcePermission> unauthorizedPermissions = __subtractResourcePermissionsIfGrantableFrom(requestedResourcePermissions, grantorPermissions);
      if (unauthorizedPermissions.size() > 0) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "grant the following global permission(s): " + unauthorizedPermissions);
      }
    }
    final Set<ResourcePermission> directAccessorPermissions = __getDirectGlobalResourcePermissions(connection, accessorResource, resourceClassId, domainId);
    final Set<ResourcePermission> addPermissions = new HashSet<>(requestedResourcePermissions.size());
    ...
    grantGlobalResourcePermissionSysPersister.updateGlobalSysPermissions(connection, accessorResource, resourceClassId, domainId, updatePermissions, sessionResource);
    grantGlobalResourcePermissionPersister.updateGlobalResourcePermissions(connection, accessorResource, resourceClassId, domainId, updatePermissions, sessionResource);
    grantGlobalResourcePermissionSysPersister.addGlobalSysPermissions(connection, accessorResource, resourceClassId, domainId, addPermissions, sessionResource);
    grantGlobalResourcePermissionPersister.addGlobalResourcePermissions(connection, accessorResource, resourceClassId, domainId, addPermissions, sessionResource);
  }

  @Override public void revokeGlobalResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      resourceClassName = resourceClassName.trim();
      domainName = domainName.trim();
      __revokeDirectGlobalPermissions(connection, accessorResource, resourceClassName, domainName, normalizedResourcePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public void revokeGlobalResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
  ...
  private void __revokeDirectGlobalPermissions(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> requestedResourcePermissions) {
    final ResourceClassInternalInfo resourceClassInfo = __getResourceClassInternalInfo(connection, resourceClassName);
    final Id<ResourceClassId> resourceClassId = resourceClassPersister.getResourceClassId(connection, resourceClassName);
    __assertUniqueResourcePermissionsNamesForResourceClass(connection, requestedResourcePermissions, resourceClassInfo);
    final Id<DomainId> domainId = domainPersister.getResourceDomainId(connection, domainName);
    if (domainId == null) {
      throw new IllegalArgumentException("Could not find domain: " + domainName);
    }
    if (!__isSuperUserOfDomain(connection, sessionResource, domainName)) {
      ...
      final Set<ResourcePermission> unauthorizedPermissions = __subtractResourcePermissionsIfGrantableFrom(requestedResourcePermissions, grantorPermissions);
      if (unauthorizedPermissions.size() > 0) {
        throw NotAuthorizedException.newInstanceForAction(sessionResource, "revoke the following global permission(s): " + unauthorizedPermissions);
      }
    }
    final Set<ResourcePermission> directAccessorPermissions = __getDirectGlobalResourcePermissions(connection, accessorResource, resourceClassId, domainId);
    ...
    grantGlobalResourcePermissionSysPersister.removeGlobalSysPermissions(connection, accessorResource, resourceClassId, domainId, removePermissions);
    grantGlobalResourcePermissionPersister.removeGlobalResourcePermissions(connection, accessorResource, resourceClassId, domainId, removePermissions);
  }

  @Override public Set<ResourcePermission> getGlobalResourcePermissions(Resource accessorResource, String resourceClassName, String domainName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      resourceClassName = resourceClassName.trim();
      domainName = domainName.trim();
      return __getDirectGlobalResourcePermissions(connection, accessorResource, resourceClassName, domainName);
    }  finally {
      __closeConnection(connection);
    }
  }
  ...
  private Set<ResourcePermission> __getDirectGlobalResourcePermissions(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName) {
    ...
    return __getDirectGlobalResourcePermissions(connection, accessorResource, resourceClassId, domainId);
  }

  @Override public Set<ResourcePermission> getEffectiveGlobalResourcePermissions(Resource accessorResource, String resourceClassName, String domainName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      resourceClassName = resourceClassName.trim();
      domainName = domainName.trim();
      return __getEffectiveGlobalResourcePermissions(connection, accessorResource, resourceClassName, domainName);
    }  finally {
      __closeConnection(connection);
    }
  }
  ...
  private Set<ResourcePermission> __getEffectiveGlobalResourcePermissionsIgnoringSuperUserPrivileges(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName) {
    ...
    Set<ResourcePermission> resourcePermissions = new HashSet<>();
    resourcePermissions.addAll(grantGlobalResourcePermissionSysPersister.getGlobalSysPermissionsIncludeInherited(connection, accessorResource, resourceClassId, domainId));
    resourcePermissions.addAll(grantGlobalResourcePermissionPersister.getGlobalResourcePermissionsIncludeInherited(connection, accessorResource, resourceClassId, domainId));
    return __collapseResourcePermissions(resourcePermissions);
  }
  ...
  private Set<ResourcePermission> __getApplicableResourcePermissions(SQLConnection connection, ResourceClassInternalInfo resourceClassInternalInfo) {
    final List<String> resourcePermissionNames = __getApplicableResourcePermissionNames(connection, resourceClassInternalInfo);
  ...
  @Override public Map<String, Map<String, Set<ResourcePermission>>> getGlobalResourcePermissionsMap(Resource accessorResource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    try {
  ...
  private Map<String, Map<String, Set<ResourcePermission>>> __getDirectGlobalResourcePermissionsMap(SQLConnection connection, Resource accessorResource) {
    ...
    globalALLPermissionsMap.putAll(grantGlobalResourcePermissionSysPersister.getGlobalSysPermissions(connection, accessorResource));
    __mergeSourcePermissionsMapIntoTargetPermissionsMap(grantGlobalResourcePermissionPersister.getGlobalResourcePermissions(connection, accessorResource), globalALLPermissionsMap);
    return __collapseResourcePermissions(globalALLPermissionsMap);
  }

  @Override public Map<String, Map<String, Set<ResourcePermission>>> getEffectiveGlobalResourcePermissionsMap(Resource accessorResource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    try {
  ...
  private Map<String, Map<String, Set<ResourcePermission>>> __getEffectiveGlobalResourcePermissionsMap(SQLConnection connection, Resource accessorResource) {
    final Map<String, Map<String, Set<ResourcePermission>>> globalALLPermissionsMap = new HashMap<>();
    globalALLPermissionsMap.putAll(grantGlobalResourcePermissionSysPersister.getGlobalSysPermissionsIncludeInherited(connection, accessorResource));
    __mergeSourcePermissionsMapIntoTargetPermissionsMap(grantGlobalResourcePermissionPersister.getGlobalResourcePermissionsIncludeInherited(connection, accessorResource), globalALLPermissionsMap);
    ...
    for (Map.Entry<String, Set<DomainPermission>> effectiveDomainPermissionsByDomainEntry : effectiveDomainPermissionsMap.entrySet()) {
      ...
      if (effectiveDomainPermissions.contains(DomainPermission_SUPER_USER) || effectiveDomainPermissions.contains(DomainPermission_SUPER_USER_GRANT)) {
        if (superResourcePermissionsMap == null) {
          ...
          for (String resourceClassName : resourceClassNames) {
            final Set<ResourcePermission> applicableResourcePermissions = __getApplicableResourcePermissions(connection, __getResourceClassInternalInfo(connection, resourceClassName));
  ...
  private Map<String, Map<String, Set<ResourcePermission>>> __collapseResourcePermissions(Map<String, Map<String, Set<ResourcePermission>>> resourcePermissionsMap) {
    for (Map.Entry<String, Map<String, Set<ResourcePermission>>> resourcePermissionsMapByDomainEntry : resourcePermissionsMap.entrySet()) {
      final Map<String, Set<ResourcePermission>> resourcePermissionsByResourceClassMap = resourcePermissionsMapByDomainEntry.getValue();
      for (Map.Entry<String, Set<ResourcePermission>> resourcePermissionsByResourceClassEntry : resourcePermissionsByResourceClassMap.entrySet()) {
        resourcePermissionsByResourceClassMap.put(resourcePermissionsByResourceClassEntry.getKey(), __collapseResourcePermissions(resourcePermissionsByResourceClassEntry.getValue()));
      }
    }
    return resourcePermissionsMap;
  }

  @Override public String getDomainNameByResource(Resource resource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(resource);
    try {
  ...
  @Override public Set<String> getDomainDescendants(String domainName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertDomainSpecified(domainName);
    try {
  ...
  @Override public ResourceClassInfo getResourceClassInfo(String resourceClassName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceClassSpecified(resourceClassName);
    try {
      connection = __getConnection();
      final ResourceClassInternalInfo resourceClassInternalInfo = __getResourceClassInternalInfo(connection, resourceClassName);
      return new ResourceClassInfo(resourceClassInternalInfo.getResourceClassName(), resourceClassInternalInfo.isAuthenticatable(), resourceClassInternalInfo.isUnauthenticatedCreateAllowed());
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public ResourceClassInfo getResourceClassInfoByResource(Resource resource) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(resource);
    try {
  ...
  @Override public Resource getAuthenticatedResource() {
    __assertAuthenticated();
    if (defensiveCopyOfAuthenticatedResource == null || !__isEqual(defensiveCopyOfAuthenticatedResource, authenticatedResource)) {
      defensiveCopyOfAuthenticatedResource = Resources.getInstance(authenticatedResource.getId(), authenticatedResource.getExternalId());
    }
    return defensiveCopyOfAuthenticatedResource;
  }

  @Override public Resource getSessionResource() {
    __assertAuthenticated();
    if (defensiveCopyOfSessionResource == null || !__isEqual(defensiveCopyOfSessionResource, sessionResource)) {
      defensiveCopyOfSessionResource = Resources.getInstance(sessionResource.getId(), sessionResource.getExternalId());
    }
    return defensiveCopyOfSessionResource;
  }

  @Override public void assertPostCreateDomainPermissions(Resource accessorResource, Set<DomainPermission> domainPermissions) {
  ...
  @Override public void assertPostCreateDomainPermissions(Resource accessorResource, DomainPermission domainPermission, DomainPermission... domainPermissions) {
  ...
  @Override public boolean hasPostCreateDomainPermissions(Resource accessorResource, Set<DomainPermission> domainPermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertPermissionsSpecified(domainPermissions);
  ...
  @Override public boolean hasPostCreateDomainPermissions(Resource accessorResource, DomainPermission domainPermission, DomainPermission... domainPermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertPermissionSpecified(domainPermission);
  ...
  private boolean __hasPostCreateDomainPermissions(SQLConnection connection, Resource accessorResource, Set<DomainPermission> requestedDomainPermissions) {
    ...
    final Set<DomainCreatePermission> effectiveDomainCreatePermissions = __getEffectiveDomainCreatePermissions(connection, accessorResource);
    ...
    if (hasPermission) {
      final Set<DomainPermission> postCreateDomainPermissions = __getPostCreateDomainPermissions(effectiveDomainCreatePermissions);
  ...
  private boolean __isPermissible(DomainPermission queriedDomainPermission, Set<DomainPermission> domainPermissions) {
    for (DomainPermission domainPermission : domainPermissions) {
      if (queriedDomainPermission.equals(domainPermission) || queriedDomainPermission.isGrantableFrom(domainPermission)) {
        return true;
      }
    }
    return false;
  ...
  @Override public void assertDomainPermissions(Resource accessorResource, String domainName, Set<DomainPermission> domainPermissions) {
  ...
  @Override public void assertDomainPermissions(Resource accessorResource, String domainName, DomainPermission domainPermission, DomainPermission... domainPermissions) {
  ...
  @Override public boolean hasDomainPermissions(Resource accessorResource, String domainName, Set<DomainPermission> domainPermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertDomainSpecified(domainName);
  ...
  @Override public boolean hasDomainPermissions(Resource accessorResource, String domainName, DomainPermission domainPermission, DomainPermission... domainPermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertDomainSpecified(domainName);
  ...
  private boolean __hasDomainPermissions(SQLConnection connection, Resource accessorResource, String domainName, Set<DomainPermission> requestedDomainPermissions) {
    __assertQueryAuthorization(connection, accessorResource);
    final Set<DomainPermission> effectiveDomainPermissions = __getEffectiveDomainPermissions(connection, accessorResource, domainName);
  ...
  @Override public void assertDomainCreatePermissions(Resource accessorResource, Set<DomainCreatePermission> domainCreatePermissions) {
  ...
  @Override public void assertDomainCreatePermissions(Resource accessorResource, DomainCreatePermission domainCreatePermission, DomainCreatePermission... domainCreatePermissions) {
  ...
  @Override public boolean hasDomainCreatePermissions(Resource accessorResource, Set<DomainCreatePermission> domainCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertPermissionsSpecified(domainCreatePermissions);
  ...
  @Override public boolean hasDomainCreatePermissions(Resource accessorResource, DomainCreatePermission domainCreatePermission, DomainCreatePermission... domainCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertPermissionSpecified(domainCreatePermission);
  ...
  private boolean __isPermissible(DomainCreatePermission queriedDomainCreatePermission, Set<DomainCreatePermission> domainCreatePermissions) {
    for (DomainCreatePermission domainCreatePermission : domainCreatePermissions) {
      if (queriedDomainCreatePermission.equals(domainCreatePermission) || queriedDomainCreatePermission.isGrantableFrom(domainCreatePermission)) {
        return true;
      }
    }
    return false;
  ...
  @Override public void assertPostCreateResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> resourcePermissions) {
    if (!hasPostCreateResourcePermissions(accessorResource, resourceClassName, domainName, resourcePermissions)) {
  ...
  @Override public void assertPostCreateResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
  ...
  @Override public boolean hasPostCreateResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      resourceClassName = resourceClassName.trim();
      domainName = domainName.trim();
      return __hasPostCreateResourcePermissions(connection, accessorResource, resourceClassName, domainName, normalizedResourcePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public boolean hasPostCreateResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
  ...
  private boolean __hasPostCreateResourcePermissions(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> requestedResourcePermissions) {
    ...
    __assertQueryAuthorization(connection, accessorResource);
    boolean hasPermission = false;
    final Set<ResourceCreatePermission> effectiveResourceCreatePermissions = __getEffectiveResourceCreatePermissions(connection, accessorResource, resourceClassName, domainName);
    ...
    if (hasPermission) {
      final Set<ResourcePermission> postCreateResourcePermissions = __getPostCreateResourcePermissions(effectiveResourceCreatePermissions);
      final Set<ResourcePermission> nonPostCreateResourcePermissions = new HashSet<>(requestedResourcePermissions.size());
      ...
      if (!nonPostCreateResourcePermissions.isEmpty()) {
        final Set<ResourcePermission> globalResourcePermissions = __getEffectiveGlobalResourcePermissions(connection, accessorResource, resourceClassName, domainName);
  ...
  private boolean __isPermissible(ResourcePermission queriedResourcePermission, Set<ResourcePermission> resourcePermissions) {
    for (ResourcePermission resourcePermission : resourcePermissions) {
      if (queriedResourcePermission.equals(resourcePermission) || queriedResourcePermission.isGrantableFrom(resourcePermission)) {
        return true;
      }
    }
    return false;
  ...
  @Override public void assertGlobalResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> resourcePermissions) {
    if (!hasGlobalResourcePermissions(accessorResource, resourceClassName, domainName, resourcePermissions)) {
  ...
  @Override public void assertGlobalResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
    if (!hasGlobalResourcePermissions(accessorResource, resourceClassName, domainName, resourcePermission, resourcePermissions)) {
  ...
  @Override public boolean hasGlobalResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      resourceClassName = resourceClassName.trim();
      domainName = domainName.trim();
      return __hasGlobalResourcePermissions(connection, accessorResource, resourceClassName, domainName, normalizedResourcePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public boolean hasGlobalResourcePermissions(Resource accessorResource, String resourceClassName, String domainName, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
  ...
  @Override public void assertResourcePermissions(Resource accessorResource, Resource accessedResource, Set<ResourcePermission> resourcePermissions) {
  ...
  @Override public void assertResourcePermissions(Resource accessorResource, Resource accessedResource, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
  ...
  @Override public boolean hasResourcePermissions(Resource accessorResource, Resource accessedResource, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceSpecified(accessedResource);
  ...
  @Override public boolean hasResourcePermissions(Resource accessorResource, Resource accessedResource, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceSpecified(accessedResource);
  ...
  private boolean __hasResourcePermissions(SQLConnection connection, Resource accessorResource, Resource accessedResource, Set<ResourcePermission> requestedResourcePermissions) {
    __assertQueryAuthorization(connection, accessorResource);
    final ResourceClassInternalInfo resourceClassInternalInfo = resourceClassPersister.getResourceClassInfoByResourceId(connection, accessedResource);
    __assertPermissionsValid(connection, resourceClassInternalInfo.getResourceClassName(), requestedResourcePermissions);
    final Set<ResourcePermission> effectiveResourcePermissions = __getEffectiveResourcePermissions(connection, accessorResource, accessedResource);
    boolean hasPermission = true;
    for (ResourcePermission requestedResourcePermission : requestedResourcePermissions) {
    ...
    if (!hasPermission) {
      final String domainName = domainPersister.getResourceDomainNameByResourceId(connection, accessedResource);
      hasPermission = __isSuperUserOfDomain(connection, accessorResource, domainName);
    }
    return hasPermission;
  }

  @Override public void assertResourceCreatePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourceCreatePermission> resourceCreatePermissions) {
    if (!hasResourceCreatePermissions(accessorResource, resourceClassName, domainName, resourceCreatePermissions)) {
      throw NotAuthorizedException.newInstanceForResourceCreatePermissions(accessorResource, resourceCreatePermissions);
    }
  }

  @Override public void assertResourceCreatePermissions(Resource accessorResource, String resourceClassName, String domainName, ResourceCreatePermission resourceCreatePermission, ResourceCreatePermission... resourceCreatePermissions) {
    if (!hasResourceCreatePermissions(accessorResource, resourceClassName, domainName, resourceCreatePermission, resourceCreatePermissions)) {
  ...
  @Override public boolean hasResourceCreatePermissions(Resource accessorResource, String resourceClassName, String domainName, Set<ResourceCreatePermission> resourceCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      resourceClassName = resourceClassName.trim();
      domainName = domainName.trim();
      return __hasResourceCreatePermissions(connection, accessorResource, resourceClassName, domainName, normalizedResourceCreatePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public boolean hasResourceCreatePermissions(Resource accessorResource, String resourceClassName, String domainName, ResourceCreatePermission resourceCreatePermission, ResourceCreatePermission... resourceCreatePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
  ...
  private boolean __hasResourceCreatePermissions(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName, Set<ResourceCreatePermission> requestedResourceCreatePermissions) {
    __assertPermissionsValid(connection, resourceClassName, __getPostCreateResourcePermissions(requestedResourceCreatePermissions));
    __assertQueryAuthorization(connection, accessorResource);
    final Set<ResourceCreatePermission> effectiveResourceCreatePermissions = __getEffectiveResourceCreatePermissions(connection, accessorResource, resourceClassName, domainName);
    boolean hasPermission = true;
  ...
  @Override public Set<Resource> getResourcesByResourcePermissions(Resource accessorResource, String resourceClassName, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      __assertQueryAuthorization(connection, accessorResource);
      resourceClassName = resourceClassName.trim();
      return __getResourcesByPermissions(connection, accessorResource, resourceClassName, normalizedResourcePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public Set<Resource> getResourcesByResourcePermissions(Resource accessorResource, String resourceClassName, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
  ...
  private Set<Resource> __getResourcesByPermissions(SQLConnection connection, Resource accessorResource, String resourceClassName, Set<ResourcePermission> requestedResourcePermissions) {
    ...
    for (ResourcePermission resourcePermission : requestedResourcePermissions) {
      ...
      if (resourcePermission.isSystemPermission()) {
        currentResources.addAll(grantResourcePermissionSysPersister.getResourcesByResourceSysPermission(connection, accessorResource, resourceClassId, resourcePermission));
        currentResources.addAll(grantGlobalResourcePermissionSysPersister.getResourcesByGlobalSysPermission(connection, accessorResource, resourceClassId, resourcePermission));
      } else {
        ...
        currentResources.addAll(grantResourcePermissionPersister.getResourcesByResourcePermission(connection, accessorResource, resourceClassId, resourcePermission, permissionId));
        currentResources.addAll(grantGlobalResourcePermissionPersister.getResourcesByGlobalResourcePermission(connection, accessorResource, resourceClassId, resourcePermission, permissionId));
      }
  ...
  @Override public Set<Resource> getResourcesByResourcePermissionsAndDomain(Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      __assertQueryAuthorization(connection, accessorResource);
      resourceClassName = resourceClassName.trim();
      return __getResourcesByPermissionsAndDomain(connection, accessorResource, resourceClassName, domainName, normalizedResourcePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public Set<Resource> getResourcesByResourcePermissionsAndDomain(Resource accessorResource, String resourceClassName, String domainName, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessorResource);
    __assertResourceClassSpecified(resourceClassName);
  ...
  private Set<Resource> __getResourcesByPermissionsAndDomain(SQLConnection connection, Resource accessorResource, String resourceClassName, String domainName, Set<ResourcePermission> requestedResourcePermissions) {
    ...
    for (ResourcePermission resourcePermission : requestedResourcePermissions) {
      Set<Resource> currentResources = new HashSet<>();
      if (resourcePermission.isSystemPermission()) {
        currentResources.addAll(grantResourcePermissionSysPersister.getResourcesByResourceSysPermission(connection, accessorResource, resourceClassId, domainId, resourcePermission));
        currentResources.addAll(grantGlobalResourcePermissionSysPersister.getResourcesByGlobalSysPermission(connection, accessorResource, resourceClassId, domainId, resourcePermission));
      } else {
        permissionId = resourceClassPermissionPersister.getResourceClassPermissionId(connection, resourceClassId, resourcePermission.getPermissionName());
        if (permissionId == null) {
          throw new IllegalArgumentException("Permission: " + resourcePermission + " is not defined for resource class: " + resourceClassName);
        }
        currentResources.addAll(grantResourcePermissionPersister.getResourcesByResourcePermission(connection, accessorResource, resourceClassId, domainId, resourcePermission, permissionId));
        currentResources.addAll(grantGlobalResourcePermissionPersister.getResourcesByGlobalResourcePermission(connection, accessorResource, resourceClassId, domainId, resourcePermission, permissionId));
      }
      if (currentResources.isEmpty()) {
        resources = currentResources;
        break;
    ...
    resources.addAll(grantDomainPermissionSysPersister.getResourcesByDomainSuperUserPermission(connection, accessorResource, resourceClassId, domainId));
    return resources;
  }

  @Override public Set<Resource> getAccessorResourcesByResourcePermissions(Resource accessedResource, String resourceClassName, Set<ResourcePermission> resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessedResource);
    __assertResourceClassSpecified(resourceClassName);
    ...
    try {
      ...
      resourceClassName = resourceClassName.trim();
      return __getAccessorResourcesByResourcePermissions(connection, accessedResource, resourceClassName, normalizedResourcePermissions);
    }  finally {
      __closeConnection(connection);
    }
  }

  @Override public Set<Resource> getAccessorResourcesByResourcePermissions(Resource accessedResource, String resourceClassName, ResourcePermission resourcePermission, ResourcePermission... resourcePermissions) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceSpecified(accessedResource);
    __assertResourceClassSpecified(resourceClassName);
  ...
  private Set<Resource> __getAccessorResourcesByResourcePermissions(SQLConnection connection, Resource accessedResource, String resourceClassName, Set<ResourcePermission> requestedResourcePermissions) {
    ...
    for (ResourcePermission resourcePermission : requestedResourcePermissions) {
      Set<Resource> currentResources = new HashSet<>();
      if (resourcePermission.isSystemPermission()) {
        currentResources.addAll(grantResourcePermissionSysPersister.getAccessorResourcesByResourceSysPermission(connection, accessedResource, resourceClassId, resourcePermission));
      } else {
        permissionId = resourceClassPermissionPersister.getResourceClassPermissionId(connection, resourceClassId, resourcePermission.getPermissionName());
        if (permissionId == null) {
          throw new IllegalArgumentException("Permission: " + resourcePermission + " is not defined for resource class: " + resourceClassName);
        }
        currentResources.addAll(grantResourcePermissionPersister.getAccessorResourcesByResourcePermission(connection, accessedResource, resourceClassId, resourcePermission, permissionId));
      }
      if (currentResources.isEmpty()) {
        resources = currentResources;
        break;
  ...
  @Override public List<String> getResourceClassNames() {
    SQLConnection connection = null;
    __assertAuthenticated();
    try {
      connection = __getConnection();
  ...
  @Override public List<String> getResourcePermissionNames(String resourceClassName) {
    SQLConnection connection = null;
    __assertAuthenticated();
    __assertResourceClassSpecified(resourceClassName);
    try {
  ...
  private static boolean __isEqual(Resource resource1, Resource resource2) {
    ...
    return __isEqual(resource1.getId(), resource2.getId()) && __isEqual(resource1.getExternalId(), resource2.getExternalId());
  }
  ...
  private List<String> __getApplicableResourcePermissionNames(SQLConnection connection, String resourceClassName) {
    return __getApplicableResourcePermissionNames(connection, __getResourceClassInternalInfo(connection, resourceClassName));
  }
  ...
  private List<String> __getApplicableResourcePermissionNames(SQLConnection connection, ResourceClassInternalInfo resourceClassInternalInfo) {
    final List<String> permissionNames = resourceClassPermissionPersister.getPermissionNames(connection, resourceClassInternalInfo.getResourceClassName());
  ...
  private boolean __isSuperUserOfResource(SQLConnection connection, Resource accessorResource, Resource accessedResource) {
    return __isSuperUserOfDomain(connection, accessorResource, domainPersister.getResourceDomainNameByResourceId(connection, accessedResource));
  }
  ...
  private boolean __isSuperUserOfDomain(SQLConnection connection, Resource accessorResource, Id<DomainId> queriedDomainId) {
    Set<DomainPermission> domainPermissions = __getEffectiveDomainPermissions(connection, accessorResource, queriedDomainId);
    return domainPermissions.contains(DomainPermission_SUPER_USER) || domainPermissions.contains(DomainPermission_SUPER_USER_GRANT);
  }
  ...
  private void __assertAuthenticatedAsSystemResource() {
    if (sessionResource == null || !SYSTEM_RESOURCE_ID.equals(sessionResource.getId())) {
      throw NotAuthorizedException.newInstanceForAction(sessionResource, "perform operation reserved for the system resource");
    }
  }
  ...
  private void __assertQueryAuthorization(SQLConnection connection, Resource accessorResource) {
    if (!sessionResource.equals(accessorResource)) {
      final Set<ResourcePermission> effectiveResourcePermissions = __getEffectiveResourcePermissions(connection, sessionResource, accessorResource);
      if (!effectiveResourcePermissions.contains(ResourcePermission_QUERY) && !effectiveResourcePermissions.contains(ResourcePermission_QUERY_GRANT) && !effectiveResourcePermissions.contains(ResourcePermission_IMPERSONATE) && !effectiveResourcePermissions.contains(ResourcePermission_IMPERSONATE_GRANT)) {
        throw NotAuthorizedException.newInstanceForActionOnResource(sessionResource, "query", accessorResource);
      }
    }
  }

  @SafeVarargs private static <T extends java.lang.Object> Set<T> __getSetWithoutNullsOrDuplicates(T firstElement, T... elements) {
    if (elements == null) {
