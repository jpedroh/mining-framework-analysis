...
public abstract class AbstractRequest implements IRequest {
  ...
  public String getJson() throws IOException, NoContentException, BadRequestException, UnauthorizedException, ForbiddenException, NotFoundException, TooManyRequestsException, InternalServerErrorException, BadGatewayException, ServiceUnavailableException {
    Header[] headerArray = new Header[] {  };
    headers.toArray(headerArray);
    return httpManager.get(uri, headerArray);
  }

  public String postJson() throws IOException, NoContentException, BadRequestException, UnauthorizedException, ForbiddenException, NotFoundException, TooManyRequestsException, InternalServerErrorException, BadGatewayException, ServiceUnavailableException {
    Header[] headerArray = new Header[] {  };
    headers.toArray(headerArray);
    return httpManager.post(uri, headerArray, formParameters);
  }

  public String putJson() throws IOException, NoContentException, BadRequestException, UnauthorizedException, ForbiddenException, NotFoundException, TooManyRequestsException, InternalServerErrorException, BadGatewayException, ServiceUnavailableException {
    Header[] headerArray = new Header[] {  };
    headers.toArray(headerArray);
    return httpManager.put(uri, headerArray, formParameters);
  }

  public String deleteJson() throws IOException, NoContentException, BadRequestException, UnauthorizedException, ForbiddenException, NotFoundException, TooManyRequestsException, InternalServerErrorException, BadGatewayException, ServiceUnavailableException {
    Header[] headerArray = new Header[] {  };
    headers.toArray(headerArray);
    return httpManager.delete(uri, headerArray);
  }

  public <T extends java.lang.Object> SettableFuture<T> executeAsync(T value) {
  ...
  public static abstract class Builder<BuilderType extends Builder<?>> implements IRequest.Builder {
    ...
    public BuilderType setDefaults(final HttpManager httpManager, final String scheme, final String host, final Integer port) {
    ...
    public <T extends java.lang.Object> BuilderType setQueryParameter(final String name, final T value) {
      assert (name != null);
      assert (value != null);
    ...
    public <T extends java.lang.Object> BuilderType setHeader(final String name, final T value) {
      this.headers.add(new BasicHeader(name, String.valueOf(value)));
      return (BuilderType) this;
    }

    public <T extends java.lang.Object> BuilderType setFormParameter(final String name, final T value) {
      this.formParameters.add(new BasicNameValuePair(name, String.valueOf(value)));
      return (BuilderType) this;
    }

    public <T extends java.lang.Object> BuilderType setBodyParameter(final String name, final T value) {
