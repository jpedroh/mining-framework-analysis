...
public class RecommendationsSeed extends AbstractModelObject {
  ...
  public static final class Builder extends AbstractModelObject.Builder {
    ...
    @Override public RecommendationsSeed build() {
