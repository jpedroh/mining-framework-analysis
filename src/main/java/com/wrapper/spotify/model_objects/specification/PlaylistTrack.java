...
public class PlaylistTrack extends AbstractModelObject {
  ...
  public static final class Builder extends AbstractModelObject.Builder {
    ...
    @Override public PlaylistTrack build() {
  ...
  public static final class JsonUtil extends AbstractModelObject.JsonUtil<PlaylistTrack> {
    public PlaylistTrack createModelObject(JsonObject jsonObject) {
      ...
      try {
        return new Builder().setAddedAt(hasAndNotNull(jsonObject, "added_at") ? simpleDateFormat.parse(jsonObject.get("added_at").getAsString()) : null).setAddedBy(hasAndNotNull(jsonObject, "added_by") ? new User.JsonUtil().createModelObject(jsonObject.get("added_by").getAsJsonObject()) : null).setIsLocal(hasAndNotNull(jsonObject, "is_local") ? jsonObject.get("is_local").getAsBoolean() : null).setTrack(hasAndNotNull(jsonObject, "track") ? new Track.JsonUtil().createModelObject(jsonObject.getAsJsonObject("track")) : null).build();
