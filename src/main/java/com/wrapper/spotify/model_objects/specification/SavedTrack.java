...
public class SavedTrack extends AbstractModelObject {
  ...
  public static final class Builder extends AbstractModelObject.Builder {
    ...
    @Override public SavedTrack build() {
  ...
  public static final class JsonUtil extends AbstractModelObject.JsonUtil<SavedTrack> {
    public SavedTrack createModelObject(JsonObject jsonObject) {
      ...
      try {
        return new Builder().setAddedAt(hasAndNotNull(jsonObject, "added_at") ? simpleDateFormat.parse(jsonObject.get("added_at").getAsString()) : null).setTrack(hasAndNotNull(jsonObject, "track") ? new Track.JsonUtil().createModelObject(jsonObject.getAsJsonObject("track")) : null).build();
