...
public class SpotifyApi {
  ...
  public AuthorizationCodeRequest.Builder authorizationCode(String client_id, String client_secret, String code, URI redirect_uri) {
    return new AuthorizationCodeRequest.Builder(clientId, clientSecret).setDefaults(httpManager, scheme, host, port).grant_type("authorization_code").code(code).redirect_uri(redirect_uri);
  }
  ...
  public com.wrapper.spotify.requests.data.follow.legacy.FollowPlaylistRequest.Builder followPlaylist(String owner_id, String playlist_id, boolean public_) {
    return new com.wrapper.spotify.requests.data.follow.legacy.FollowPlaylistRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).owner_id(owner_id).playlist_id(playlist_id).public_(public_);
  }
  ...
  public FollowPlaylistRequest.Builder followPlaylist(String playlist_id, boolean public_) {
    return new FollowPlaylistRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).playlist_id(playlist_id).public_(public_);
  }
  ...
  public com.wrapper.spotify.requests.data.follow.legacy.UnfollowPlaylistRequest.Builder unfollowPlaylist(String owner_id, String playlist_id) {
    return new com.wrapper.spotify.requests.data.follow.legacy.UnfollowPlaylistRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).owner_id(owner_id).playlist_id(playlist_id);
  }
  ...
  public UnfollowPlaylistRequest.Builder unfollowPlaylist(String playlist_id) {
    return new UnfollowPlaylistRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).playlist_id(playlist_id);
  }
   ...
   */
  @Deprecated public AddItemsToPlaylistRequest.Builder addItemsToPlaylist(String user_id, String playlist_id, String[] uris) {
    return new AddItemsToPlaylistRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).user_id(user_id).playlist_id(playlist_id).uris(concat(uris, ','));
  }
   ...
   * (https://developer.spotify.com/community/news/2018/06/12/changes-to-playlist-uris/)
   */
  @Deprecated public AddItemsToPlaylistRequest.Builder addItemsToPlaylist(String user_id, String playlist_id, JsonArray uris) {
    return new AddItemsToPlaylistRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).user_id(user_id).playlist_id(playlist_id).uris(uris);
  }
  ...
  @Deprecated public ChangePlaylistsDetailsRequest.Builder changePlaylistsDetails(String user_id, String playlist_id) {
    return new ChangePlaylistsDetailsRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).user_id(user_id).playlist_id(playlist_id);
  }
  ...
  @Deprecated public GetPlaylistCoverImageRequest.Builder getPlaylistCoverImage(String user_id, String playlist_id) {
    return new GetPlaylistCoverImageRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).user_id(user_id).playlist_id(playlist_id);
  }
   ...
   * (https://developer.spotify.com/community/news/2018/06/12/changes-to-playlist-uris/)
   */
  @Deprecated public GetPlaylistsItemsRequest.Builder getPlaylistsItems(String user_id, String playlist_id) {
    return new GetPlaylistsItemsRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).user_id(user_id).playlist_id(playlist_id);
  }
   ...
   * (https://developer.spotify.com/community/news/2018/06/12/changes-to-playlist-uris/)
   */
  @Deprecated public RemoveItemsFromPlaylistRequest.Builder removeItemsFromPlaylist(String user_id, String playlist_id, JsonArray tracks) {
    return new RemoveItemsFromPlaylistRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).user_id(user_id).playlist_id(playlist_id).tracks(tracks);
  }
   ...
   * (https://developer.spotify.com/community/news/2018/06/12/changes-to-playlist-uris/)
   */
  @Deprecated public ReorderPlaylistsItemsRequest.Builder reorderPlaylistsItems(String user_id, String playlist_id, int range_start, int insert_before) {
    return new ReorderPlaylistsItemsRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).user_id(user_id).playlist_id(playlist_id).range_start(range_start).insert_before(insert_before);
  }
   ...
   * (https://developer.spotify.com/community/news/2018/06/12/changes-to-playlist-uris/)
   */
  @Deprecated public ReplacePlaylistsItemsRequest.Builder replacePlaylistsItems(String user_id, String playlist_id, String[] uris) {
    return new ReplacePlaylistsItemsRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).user_id(user_id).playlist_id(playlist_id).uris(concat(uris, ','));
  }
   ...
   * (https://developer.spotify.com/community/news/2018/06/12/changes-to-playlist-uris/)
   */
  @Deprecated public ReplacePlaylistsItemsRequest.Builder replacePlaylistsItems(String user_id, String playlist_id, JsonArray uris) {
    return new ReplacePlaylistsItemsRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).user_id(user_id).playlist_id(playlist_id).uris(uris);
  }
  ...
  @Deprecated public UploadCustomPlaylistCoverImageRequest.Builder uploadCustomPlaylistCoverImage(String user_id, String playlist_id) {
    return new UploadCustomPlaylistCoverImageRequest.Builder(accessToken).setDefaults(httpManager, scheme, host, port).user_id(user_id).playlist_id(playlist_id);
  }
