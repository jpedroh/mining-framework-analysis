...
public class TagList extends AbstractTag implements IAnonymousTagContainer {
  ...
  /**
	 * {@inheritDoc}
	 */
  @Override public void addTag(@Nonnull ITag tag) {
  ...
  /**
	 * {@inheritDoc}
	 */
  @Override public List<ITag> getTags() {
  ...
  /**
	 * {@inheritDoc}
	 */
  @SuppressWarnings(value = { "unchecked" }) public <T extends ITag> List<T> getTags(Class<T> tagClass) throws UnexpectedTagTypeException {
  ...
  /**
	 * {@inheritDoc}
	 */
  @Override public void removeTag(@Nonnull ITag tag) {
  ...
  /**
	 * {@inheritDoc}
	 */
  @Override public void setTag(int i, @Nonnull ITag tag) {
  ...
  /**
	 * {@inheritDoc}
	 */
  @Override public void write(NbtOutputStream outputStream, boolean anonymous) throws IOException {
