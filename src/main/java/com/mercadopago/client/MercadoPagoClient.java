...
<<<<<<< /usr/src/app/output/mercadopago/sdk-java/f86264fd19a10fd46dc8cc6370f727952d54580c/src/main/java/com/mercadopago/client/MercadoPagoClient.java/left.java
...
>>>>>>> /usr/src/app/output/mercadopago/sdk-java/f86264fd19a10fd46dc8cc6370f727952d54580c/src/main/java/com/mercadopago/client/MercadoPagoClient.java/right.java
  ...
  protected MPResponse send(String path, HttpMethod method, JsonObject payload, Map<String, Object> queryParams, MPRequestOptions requestOptions) throws MPException {
   ...
   * @throws MPException
   */
  protected MPResponse list(String path, HttpMethod method, JsonObject payload, Map<String, Object> queryParams, MPRequestOptions requestOptions) throws MPException {
  ...
  private MPRequest buildRequest(String path, HttpMethod method, JsonObject payload, Map<String, Object> queryParams, MPRequestOptions requestOptions) throws MPException {
