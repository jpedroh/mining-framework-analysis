...
||||||| /usr/src/app/output/mercadopago/sdk-java/f86264fd19a10fd46dc8cc6370f727952d54580c/src/main/java/com/mercadopago/client/MercadoPagoClient.java/base.java
    for (Map.Entry<String, String> entry : defaultHeaders.entrySet()) {
      request.addHeader(entry.getKey(), entry.getValue());
    }
    if (!request.getUri().contains("/oauth/token")) {
