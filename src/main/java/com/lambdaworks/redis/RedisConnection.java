 ...
 * @since 3.0
 */
@Deprecated public interface RedisConnection<K extends java.lang.Object, V extends java.lang.Object> extends RedisHashesConnection<K, V>, RedisKeysConnection<K, V>, RedisStringsConnection<K, V>, RedisListsConnection<K, V>, RedisSetsConnection<K, V>, RedisSortedSetsConnection<K, V>, RedisScriptingConnection<K, V>, RedisServerConnection<K, V>, RedisHLLConnection<K, V>, RedisGeoConnection<K, V>, BaseRedisConnection<K, V>, RedisClusterConnection<K, V>, RedisTransactionalCommands<K, V> {
  /**
