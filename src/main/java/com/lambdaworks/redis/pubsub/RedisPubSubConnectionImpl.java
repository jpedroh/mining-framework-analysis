 ...
 * @author Will Glozer
 */
public class RedisPubSubConnectionImpl<K extends java.lang.Object, V extends java.lang.Object> extends RedisAsyncConnectionImpl<K, V> implements RedisPubSubConnection<K, V> {
  ...
  /**
     ...
     */
  @Override public void addListener(RedisPubSubListener<K, V> listener) {
  ...
  /**
     ...
     * @param listener Listener.
     */
  @Override public void removeListener(RedisPubSubListener<K, V> listener) {
    listeners.remove(listener);
  }

  @Override public RedisFuture<Void> psubscribe(K... patterns) {
    return new VoidFuture(dispatch(PSUBSCRIBE, new PubSubOutput<K, V, K>(codec), args(patterns)));
  }

  @Override public RedisFuture<Void> punsubscribe(K... patterns) {
    return new VoidFuture(dispatch(PUNSUBSCRIBE, new PubSubOutput<K, V, K>(codec), args(patterns)));
  }

  @Override public RedisFuture<Void> subscribe(K... channels) {
    return new VoidFuture(dispatch(SUBSCRIBE, new PubSubOutput<K, V, K>(codec), args(channels)));
  }

  @Override public RedisFuture<Void> unsubscribe(K... channels) {
  ...
  @Override @SuppressWarnings(value = { "unchecked" }) public void channelRead(Object msg) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private <T extends java.lang.Object> T[] toArray(Collection<T> c) {
