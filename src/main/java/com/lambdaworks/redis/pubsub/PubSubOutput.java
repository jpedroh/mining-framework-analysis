 ...
 * @author Will Glozer
 */
public class PubSubOutput<K extends java.lang.Object, V extends java.lang.Object, T extends java.lang.Object> extends CommandOutput<K, V, T> {
  public enum Type {
    message,
    pmessage,
    psubscribe,
  ...
  @Override @SuppressWarnings(value = { "fallthrough", "unchecked" }) public void set(ByteBuffer bytes) {
    if (bytes == null) {
      return;
    }
    if (type == null) {
  ...
  @SuppressWarnings(value = { "unchecked", "fallthrough" }) private void handleOutput(ByteBuffer bytes) {
    switch (type) {
      case pmessage:
      if (pattern == null) {
