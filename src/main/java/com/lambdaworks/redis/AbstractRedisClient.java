...
public abstract class AbstractRedisClient {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected <K extends java.lang.Object, V extends java.lang.Object, T extends RedisAsyncConnectionImpl<K, V>> T connectAsyncImpl(final CommandHandler<K, V> handler, final T connection, final Supplier<SocketAddress> socketAddressSupplier, final boolean withReconnect) {
  ...
  /**
     ...
     */
  protected void connectionBuilder(CommandHandler<?, ?> handler, RedisChannelHandler<?, ?> connection, Supplier<SocketAddress> socketAddressSupplier, boolean withReconnect, ConnectionBuilder connectionBuilder, RedisURI redisURI) {
  ...
  protected static <K extends java.lang.Object, V extends java.lang.Object> Object syncHandler(RedisChannelHandler<K, V> connection, Class<?>... interfaceClasses) {
