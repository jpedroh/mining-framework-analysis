...
public abstract class AbstractRedisClient {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected <K extends java.lang.Object, V extends java.lang.Object, T extends RedisAsyncConnectionImpl<K, V>> T connectAsyncImpl(final CommandHandler<K, V> handler, final T connection, final Supplier<SocketAddress> socketAddressSupplier) {
  ...
  private synchronized EventLoopGroup getEventLoopGroup(ConnectionPoint connectionPoint) {
    ...
    if (connectionPoint != null && connectionPoint.getSocket() != null && !eventLoopGroups.containsKey(EpollEventLoopGroup.class)) {
