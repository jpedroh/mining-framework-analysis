...
public class RedisClusterClient extends AbstractRedisClient {
  ...
  /**
     ...
     */
  @Deprecated public RedisClusterClient(List<RedisURI> redisURIs) {
    this(null, redisURIs);
  }
  ...
  /**
     ...
     * @return A new stateful Redis Cluster connection
     */
  @SuppressWarnings(value = { "unchecked" }) public <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisClusterConnection<K, V> connect(RedisCodec<K, V> codec) {
  ...
  /**
     ...
     */
  @Deprecated public RedisAdvancedClusterCommands<String, String> connectCluster() {
  ...
  /**
     ...
     * @return A new connection.
     */
  @SuppressWarnings(value = { "unchecked" }) @Deprecated public <K extends java.lang.Object, V extends java.lang.Object> RedisAdvancedClusterCommands<K, V> connectCluster(RedisCodec<K, V> codec) {
    assertNotNull(codec);
  ...
  /**
     ...
     * @return A new connection.
     */
  @Deprecated public RedisAdvancedClusterAsyncCommands<String, String> connectClusterAsync() {
  ...
  /**
     ...
     * @return A new connection.
     */
  @Deprecated public <K extends java.lang.Object, V extends java.lang.Object> RedisAdvancedClusterAsyncCommands<K, V> connectClusterAsync(RedisCodec<K, V> codec) {
    assertNotNull(codec);
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  /**
     ...
     * @return a new connection
     */
  <K extends java.lang.Object, V extends java.lang.Object> RedisAsyncConnectionImpl<K, V> connectNode(RedisCodec<K, V> codec, String nodeId, RedisChannelWriter<K, V> clusterWriter, final Supplier<SocketAddress> socketAddressSupplier) {
    logger.debug("connectNode(" + nodeId + ")");
    Queue<RedisCommand<K, V, ?>> queue = new ArrayDeque<RedisCommand<K, V, ?>>();
    ClusterNodeCommandHandler<K, V> handler = new ClusterNodeCommandHandler<K, V>(clientOptions, clientResources, queue, clusterWriter);
  ...
  /**
     ...
     * @return A new connection
     */
  <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisConnection<K, V> connectToNode(RedisCodec<K, V> codec, String nodeId, RedisChannelWriter<K, V> clusterWriter, final Supplier<SocketAddress> socketAddressSupplier) {
    assertNotNull(codec);
    ...
    ClusterNodeCommandHandler<K, V> handler = new ClusterNodeCommandHandler<K, V>(clientOptions, getResources(), queue, clusterWriter);
  ...
  /**
     ...
     * @return a new connection
     */
  <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisClusterConnectionImpl<K, V> connectClusterImpl(RedisCodec<K, V> codec) {
    if (partitions == null) {
...
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/cluster/RedisClusterClient.java/left.java
  /**
     ...
     * @return a new connection
     */
  <K extends java.lang.Object, V extends java.lang.Object> RedisAdvancedClusterAsyncConnectionImpl<K, V> connectClusterAsyncImpl(RedisCodec<K, V> codec, final Supplier<SocketAddress> socketAddressSupplier) {
    if (partitions == null) {
      initializePartitions();
    }
    activateTopologyRefreshIfNeeded();
    ...
    PooledClusterConnectionProvider<K, V> pooledClusterConnectionProvider = new PooledClusterConnectionProvider<K, V>(this, clusterWriter, codec);
    clusterWriter.setClusterConnectionProvider(pooledClusterConnectionProvider);
    RedisAdvancedClusterAsyncConnectionImpl<K, V> connection = newRedisAdvancedClusterAsyncConnectionImpl(clusterWriter, codec, timeout, unit);
    connection.setReadFrom(ReadFrom.MASTER);
    connection.setPartitions(partitions);
    connectAsyncImpl(handler, connection, socketAddressSupplier);
    connection.registerCloseables(closeableResources, connection, clusterWriter, pooledClusterConnectionProvider);
...
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/cluster/RedisClusterClient.java/left.java
    new Predicate<RedisAdvancedClusterAsyncConnectionImpl<?, ?>>() {
      @Override public boolean apply(RedisAdvancedClusterAsyncConnectionImpl<?, ?> input) {
      ...
      if (options.isRefreshClusterView()) {
        synchronized (clusterTopologyRefreshActivated) {
          if (!clusterTopologyRefreshActivated.get()) {
            ...
            genericWorkerPool.scheduleAtFixedRate(r, options.getRefreshPeriod(), options.getRefreshPeriod(), options.getRefreshPeriodUnit());
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  /**
     ...
     */
  protected <K extends java.lang.Object, V extends java.lang.Object> RedisAdvancedClusterAsyncConnectionImpl<K, V> newRedisAdvancedClusterAsyncConnectionImpl(RedisChannelWriter<K, V> channelWriter, RedisCodec<K, V> codec, long timeout, TimeUnit unit) {
...
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/cluster/RedisClusterClient.java/right.java
  ...
  private List<RedisClusterNode> getOrderedPartitions(Iterable<RedisClusterNode> clusterNodes) {
    ...
    Collections.sort(ordered, new Comparator<RedisClusterNode>() {
      @Override public int compare(RedisClusterNode o1, RedisClusterNode o2) {
  ...
  protected void forEachClusterConnection(
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/cluster/RedisClusterClient.java/left.java
  Predicate
=======
  Consumer
...
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/cluster/RedisClusterClient.java/right.java
  <?, ?>> function) {
    forEachCloseable(
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/cluster/RedisClusterClient.java/left.java
    new Predicate<Closeable>() {
      @Override public boolean apply(Closeable input) {
        return input instanceof RedisAdvancedClusterAsyncConnectionImpl;
      }
    }
=======
    (input) -> input instanceof StatefulRedisClusterConnectionImpl
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/cluster/RedisClusterClient.java/right.java
    , function);
  }

  @SuppressWarnings(value = { "unchecked" }) protected <T extends Closeable> void forEachCloseable(Predicate<? super Closeable> selector, 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/cluster/RedisClusterClient.java/left.java
  Predicate
=======
  Consumer
