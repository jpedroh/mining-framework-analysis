...
public class RedisClusterClient extends AbstractRedisClient {
  ...
  /**
     ...
     * @return A new connection.
     */
  @SuppressWarnings(value = { "unchecked" }) public <K extends java.lang.Object, V extends java.lang.Object> RedisClusterConnection<K, V> connectCluster(RedisCodec<K, V> codec) {
  ...
  /**
     ...
     * @return A new connection.
     */
  public <K extends java.lang.Object, V extends java.lang.Object> RedisClusterAsyncConnection<K, V> connectClusterAsync(RedisCodec<K, V> codec) {
    return connectClusterAsyncImpl(codec, getSocketAddressSupplier());
  }
  ...
  /**
     ...
     */
  <K extends java.lang.Object, V extends java.lang.Object> RedisAsyncConnectionImpl<K, V> connectAsyncImpl(RedisCodec<K, V> codec, final SocketAddress socketAddress) {
  ...
  <K extends java.lang.Object, V extends java.lang.Object> RedisAsyncConnectionImpl<K, V> connectClusterAsyncImpl(RedisCodec<K, V> codec) {
    return connectClusterAsyncImpl(codec, getSocketAddressSupplier());
  }
  ...
  /**
     ...
     * @return
     */
  <K extends java.lang.Object, V extends java.lang.Object> RedisAsyncConnectionImpl<K, V> connectClusterAsyncImpl(RedisCodec<K, V> codec, final Supplier<SocketAddress> socketAddressSupplier) {
    if (partitions == null) {
