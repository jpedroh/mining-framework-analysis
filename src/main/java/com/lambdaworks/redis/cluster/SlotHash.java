...
public class SlotHash {
  ...
  /**
     ...
     * 
     */
  static <K extends java.lang.Object, V extends java.lang.Object> Map<Integer, List<K>> partition(RedisCodec<K, V> codec, Iterable<K> keys) {
  ...
  /**
     ...
     * @param <K>
     */
  static <K extends java.lang.Object> Map<K, Integer> getSlots(Map<Integer, ? extends Iterable<K>> partitioned) {
