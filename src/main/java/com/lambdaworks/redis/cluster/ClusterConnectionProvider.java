...
interface ClusterConnectionProvider extends Closeable {
  /**
     ...
     */
  <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisConnection<K, V> getConnection(Intent intent, int slot);
  ...
  /**
     ...
     */
  <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisConnection<K, V> getConnection(Intent intent, String host, int port);
