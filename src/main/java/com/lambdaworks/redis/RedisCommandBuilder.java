 ...
 */
class RedisCommandBuilder<K extends java.lang.Object, V extends java.lang.Object> extends BaseRedisCommandBuilder<K, V> {
  ...
  public <T extends java.lang.Object> Command<K, V, T> eval(String script, ScriptOutputType type, K... keys) {
  ...
  public <T extends java.lang.Object> Command<K, V, T> eval(String script, ScriptOutputType type, K[] keys, V... values) {
    assertNotEmpty(script, "script " + MUST_NOT_BE_EMPTY);
    CommandArgs<K, V> args = new CommandArgs<K, V>(codec);
  ...
  public <T extends java.lang.Object> Command<K, V, T> evalsha(String digest, ScriptOutputType type, K... keys) {
  ...
  public <T extends java.lang.Object> Command<K, V, T> evalsha(String digest, ScriptOutputType type, K[] keys, V... values) {
    assertNotEmpty(digest, "digest " + MUST_NOT_BE_EMPTY);
    CommandArgs<K, V> args = new CommandArgs<K, V>(codec);
  ...
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public Command<K, V, Map<K, Long>> pubsubNumsub(K... pattern) {
  ...
  @Deprecated public Command<K, V, String> shutdown() {
  ...
  @SuppressWarnings(value = { "unchecked" }) public Command<K, V, Long> zadd(K key, ZAddArgs zAddArgs, Object... scoresAndValues) {
    ...
    if (allElementsInstanceOf(scoresAndValues, ScoredValue.class)) {
      ...
      assertTrue(scoresAndValues.length % 2 == 0, "scoresAndValues.length must be a multiple of 2 and contain a " + "sequence of score1, value1, score2, value2, scoreN,valueN");
  ...
  @SuppressWarnings(value = { "unchecked" }) public Command<K, V, String> pfmerge(K destkey, K sourcekey, K... moreSourceKeys) {
  ...
  @SuppressWarnings(value = { "unchecked" }) public Command<K, V, String> pfmerge(K destkey, K... sourcekeys) {
    assertNotNull(destkey, "destkey " + MUST_NOT_BE_NULL);
  ...
  public Command<K, V, Long> geoadd(K key, Object[] lngLatMember) {
    ...
    assertTrue(lngLatMember.length % 3 == 0, "lngLatMember.length must be a multiple of 3 and contain a " + "sequence of longitude1, latitude1, member1, longitude2, latitude2, member2, ... longitudeN, latitudeN, memberN");
    CommandArgs<K, V> args = new CommandArgs<K, V>(codec).addKey(key);
  ...
  public Command<K, V, List<GeoWithin<V>>> georadius(K key, double longitude, double latitude, double distance, String unit, GeoArgs geoArgs) {
    ...
    CommandArgs<K, V> args = new CommandArgs<K, V>(codec).addKey(key).add(longitude).add(latitude).add(distance).add(unit);
    geoArgs.build(args);
    return createCommand(GEORADIUS, new GeoWithinListOutput<K, V>(codec, geoArgs.isWithDistance(), geoArgs.isWithHash(), geoArgs.isWithCoordinates()), args);
  }

  public Command<K, V, Long> georadius(K key, double longitude, double latitude, double distance, String unit, GeoRadiusStoreArgs<K> geoRadiusStoreArgs) {
    assertNotNull(geoRadiusStoreArgs, "geoRadiusStoreArgs must not be null");
    assertTrue(geoRadiusStoreArgs.getStoreKey() != null || geoRadiusStoreArgs.getStoreDistKey() != null, "At least STORE key or STORDIST key is required");
    CommandArgs<K, V> args = new CommandArgs<K, V>(codec).addKey(key).add(longitude).add(latitude).add(distance).add(unit);
  ...
  public Command<K, V, List<GeoWithin<V>>> georadiusbymember(K key, V member, double distance, String unit, GeoArgs geoArgs) {
    ...
    CommandArgs<K, V> args = new CommandArgs<K, V>(codec).addKey(key).addValue(member).add(distance).add(unit);
    geoArgs.build(args);
    return createCommand(GEORADIUSBYMEMBER, new GeoWithinListOutput<K, V>(codec, geoArgs.isWithDistance(), geoArgs.isWithHash(), geoArgs.isWithCoordinates()), args);
  }

  public Command<K, V, Long> georadiusbymember(K key, V member, double distance, String unit, GeoRadiusStoreArgs<K> geoRadiusStoreArgs) {
    assertNotNull(geoRadiusStoreArgs, "geoRadiusStoreArgs must not be null");
    assertTrue(geoRadiusStoreArgs.getStoreKey() != null || geoRadiusStoreArgs.getStoreDistKey() != null, "At least STORE key or STORDIST key is required");
    CommandArgs<K, V> args = new CommandArgs<K, V>(codec).addKey(key).addValue(member).add(distance).add(unit);
    geoRadiusStoreArgs.build(args);
  ...
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public Command<K, V, List<GeoCoordinates>> geopos(K key, V[] members) {
