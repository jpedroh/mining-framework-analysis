 ...
 * @author Will Glozer
 */
@ChannelHandler.Sharable public class CommandHandler<K extends java.lang.Object, V extends java.lang.Object> extends ChannelDuplexHandler implements RedisChannelWriter<K, V> {
  ...
  private void recordLatency(RedisCommand<K, V, ?> command, SentReceived sentReceived) {
    if (sentReceived != null && channel != null && remote() != null && clientResources.commandLatencyCollector().isEnabled()) {
      long firstResponseLatency = nanoTime() - sentReceived.firstResponse;
      long completionLatency = nanoTime() - sentReceived.sent;
      clientResources.commandLatencyCollector().recordCommandLatency(local(), remote(), command.getType(), firstResponseLatency, completionLatency);
    }
  }
  ...
  @Override public <T extends java.lang.Object, C extends RedisCommand<K, V, T>> C write(C command) {
    ...
    if (commandBuffer.size() + queue.size() >= clientOptions.getRequestQueueSize()) {
      throw new RedisException("Request queue size exceeded: " + clientOptions.getRequestQueueSize() + ". Commands are not accepted until the queue size drops.");
    }
    if (
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/protocol/CommandHandler.java/left.java
    (channel == null || !isConnected()) && !clientOptions.isAutoReconnect()
=======
    (channel == null || !isConnected()) && isRejectCommand()
...
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/protocol/CommandHandler.java/left.java
            complete()
=======
            completeExceptionally(connectionError)
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/protocol/CommandHandler.java/right.java
            ;
            return command;
          }
  ...
  private <T extends java.lang.Object> void bufferCommand(RedisCommand<K, V, T> command) {
    if (debugEnabled) {
  ...
  private boolean isConnected() {
    synchronized (lifecycleState) {
      return lifecycleState.ordinal() >= LifecycleState.CONNECTED.ordinal() && lifecycleState.ordinal() <= LifecycleState.DISCONNECTED.ordinal();
    }
  }

  @Override @SuppressWarnings(value = { "rawtypes", "unchecked" }) public void flushCommands() {
    if (channel != null && isConnected()) {
      ...
      if (reliability == Reliability.AT_MOST_ONCE) {
        channel.writeAndFlush(queuedCommands).addListener(new AtMostOnceWriteListener(queuedCommands, this.queue, sentTimes));
      }
      if (reliability == Reliability.AT_LEAST_ONCE) {
  ...
  /**
     ...
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
...
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/protocol/CommandHandler.java/right.java
  ...
  @Override public void setRedisChannelHandler(RedisChannelHandler<K, V> redisChannelHandler) {
  ...
  private static class AtMostOnceWriteListener<K extends java.lang.Object, V extends java.lang.Object, T extends java.lang.Object> implements ChannelFutureListener {
    ...
    @SuppressWarnings(value = { "unchecked", "rawtypes" }) public AtMostOnceWriteListener(RedisCommand<K, V, T> sentCommand, Queue<?> queue, Map<RedisCommand<K, V, T>, SentReceived> sentTimes) {
