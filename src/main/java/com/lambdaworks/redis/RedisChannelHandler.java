...
public abstract class RedisChannelHandler<K extends java.lang.Object, V extends java.lang.Object> extends ChannelInboundHandlerAdapter implements Closeable {
  ...
  protected <T extends java.lang.Object, C extends RedisCommand<K, V, T>> C dispatch(C cmd) {
  ...
  protected <T extends java.lang.Object> T syncHandler(Object asyncApi, Class<?>... interfaces) {
