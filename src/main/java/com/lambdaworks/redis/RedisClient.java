...
public class RedisClient extends AbstractRedisClient {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public <K extends java.lang.Object, V extends java.lang.Object> RedisConnectionPool<RedisConnection<K, V>> pool(final RedisCodec<K, V> codec, int maxIdle, int maxActive) {
    checkForRedisURI();
    ...
    RedisConnectionPool<RedisConnection<K, V>> pool = new RedisConnectionPool<RedisConnection<K, V>>(new RedisConnectionProvider<RedisConnection<K, V>>() {
      @Override public RedisConnection<K, V> createConnection() {
        return connect(codec, false, redisURI);
      }

      @Override @SuppressWarnings(value = { "rawtypes" }) public Class<? extends RedisConnection<K, V>> getComponentType() {
  ...
  /**
     ...
     */
  public <K extends java.lang.Object, V extends java.lang.Object> RedisConnectionPool<RedisAsyncConnection<K, V>> asyncPool(final RedisCodec<K, V> codec, int maxIdle, int maxActive) {
    checkForRedisURI();
    long maxWait = makeTimeout();
    RedisConnectionPool<RedisAsyncConnection<K, V>> pool = new RedisConnectionPool<RedisAsyncConnection<K, V>>(new RedisConnectionProvider<RedisAsyncConnection<K, V>>() {
      @Override public RedisAsyncConnection<K, V> createConnection() {
        return connectAsync(codec, false, redisURI);
      }

      @Override @SuppressWarnings(value = { "rawtypes", "unchecked" }) public Class<? extends RedisAsyncConnection<K, V>> getComponentType() {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public RedisConnection<String, String> connect() {
  ...
  /**
     ...
     * @return A new connection.
     */
  @SuppressWarnings(value = { "unchecked" }) public <K extends java.lang.Object, V extends java.lang.Object> RedisConnection<K, V> connect(RedisCodec<K, V> codec) {
    checkForRedisURI();
  ...
  /**
     ...
     * @return A new connection.
     */
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public RedisConnection<String, String> connect(RedisURI redisURI) {
  ...
  private void checkValidRedisURI(RedisURI redisURI) {
    checkArgument(redisURI != null && LettuceStrings.isNotEmpty(redisURI.getHost()), "A valid RedisURI with a host is needed");
  }

  @SuppressWarnings(value = { "rawtypes" }) private <K extends java.lang.Object, V extends java.lang.Object> RedisConnection connect(RedisCodec<K, V> codec, boolean withReconnect, RedisURI redisURI) {
    return (RedisConnection) syncHandler(connectAsync(codec, withReconnect, redisURI), RedisConnection.class, RedisClusterConnection.class);
  }
  ...
  /**
     ...
     * @return A new connection.
     */
  public <K extends java.lang.Object, V extends java.lang.Object> RedisAsyncConnection<K, V> connectAsync(RedisCodec<K, V> codec) {
    checkForRedisURI();
    checkArgument(codec != null, "RedisCodec must not be null");
  ...
  private <K extends java.lang.Object, V extends java.lang.Object> RedisAsyncConnectionImpl<K, V> connectAsync(RedisCodec<K, V> codec, boolean withReconnect, RedisURI redisURI) {
  ...
  private <K extends java.lang.Object, V extends java.lang.Object> void connectAsync(CommandHandler<K, V> handler, RedisAsyncConnectionImpl<K, V> connection, boolean withReconnect, RedisURI redisURI) {
  ...
  /**
     ...
     */
  public <K extends java.lang.Object, V extends java.lang.Object> RedisPubSubConnection<K, V> connectPubSub(RedisCodec<K, V> codec) {
    checkForRedisURI();
    return connectPubSub(codec, redisURI);
  }

  protected <K extends java.lang.Object, V extends java.lang.Object> RedisPubSubConnection<K, V> connectPubSub(RedisCodec<K, V> codec, RedisURI redisURI) {
    checkArgument(codec != null, "RedisCodec must not be null");
    BlockingQueue<RedisCommand<K, V, ?>> queue = new LinkedBlockingQueue<RedisCommand<K, V, ?>>();
  ...
  /**
     ...
     * @return a new connection.
     */
  public <K extends java.lang.Object, V extends java.lang.Object> RedisSentinelAsyncConnection<K, V> connectSentinelAsync(RedisCodec<K, V> codec) {
    checkForRedisURI();
    checkArgument(codec != null, "RedisCodec must not be null");
  ...
  /**
     ...
     * @return A new connection.
     */
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public RedisSentinelAsyncConnection<String, String> connectSentinelAsync(RedisURI redisURI) {
  ...
  /**
     ...
     */
  protected <K extends java.lang.Object, V extends java.lang.Object> RedisAsyncConnectionImpl<K, V> newRedisAsyncConnectionImpl(RedisChannelWriter<K, V> channelWriter, RedisCodec<K, V> codec, long timeout, TimeUnit unit) {
  ...
  /**
     ...
     */
  protected <K extends java.lang.Object, V extends java.lang.Object> RedisSentinelAsyncConnectionImpl<K, V> newRedisSentinelAsyncConnectionImpl(RedisChannelWriter<K, V> channelWriter, RedisCodec<K, V> codec, long timeout, TimeUnit unit) {
  ...
  /**
     ...
     */
  protected <K extends java.lang.Object, V extends java.lang.Object> RedisPubSubConnectionImpl<K, V> newRedisPubSubConnectionImpl(RedisChannelWriter<K, V> channelWriter, RedisCodec<K, V> codec, long timeout, TimeUnit unit) {
