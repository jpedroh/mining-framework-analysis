...
public class RedisClient extends AbstractRedisClient {
  ...
  @SuppressWarnings(value = { "unchecked" }) public <K extends java.lang.Object, V extends java.lang.Object> RedisConnectionPool<RedisCommands<K, V>> pool(final RedisCodec<K, V> codec, int maxIdle, int maxActive) {
    ...
    pool.addListener((resource) -> closeableResources.remove(resource));
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public RedisCommands<String, String> connect() {
  ...
  /**
     ...
     * @return A new connection.
     */
  @SuppressWarnings(value = { "unchecked" }) public <K extends java.lang.Object, V extends java.lang.Object> RedisCommands<K, V> connect(RedisCodec<K, V> codec) {
    checkForRedisURI();
  ...
  /**
     ...
     * @return A new connection.
     */
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public RedisCommands<String, String> connect(RedisURI redisURI) {
    checkValidRedisURI(redisURI);
    return 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/b378ab2fb0448418754c692b66d23b99e0801ac8/src/main/java/com/lambdaworks/redis/RedisClient.java/left.java
    (RedisConnection<String, String>) connect(newStringStringCodec(), redisURI)
=======
    connect(newStringStringCodec(), redisURI)
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/b378ab2fb0448418754c692b66d23b99e0801ac8/src/main/java/com/lambdaworks/redis/RedisClient.java/right.java
    ;
  }
  ...
  @SuppressWarnings(value = { "rawtypes" }) private <K extends java.lang.Object, V extends java.lang.Object> RedisCommands<K, V> connect(RedisCodec<K, V> codec, RedisURI redisURI) {
  ...
  /**
     ...
     * @return A new connection.
     */
  public <K extends java.lang.Object, V extends java.lang.Object> RedisAsyncCommands<K, V> connectAsync(RedisCodec<K, V> codec) {
    checkForRedisURI();
    checkArgument(codec != null, "RedisCodec must not be null");
    return connectStateful(codec, redisURI).async();
  }
  ...
  public RedisAsyncCommands<String, String> connectAsync(RedisURI redisURI) {
    ...
    return 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/b378ab2fb0448418754c692b66d23b99e0801ac8/src/main/java/com/lambdaworks/redis/RedisClient.java/left.java
    connectAsync(newStringStringCodec(), redisURI)
=======
    connectStateful(newStringStringCodec(), redisURI).async()
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/b378ab2fb0448418754c692b66d23b99e0801ac8/src/main/java/com/lambdaworks/redis/RedisClient.java/right.java
    ;
  }

  private <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisConnection<K, V> connectStateful(RedisCodec<K, V> codec, RedisURI redisURI) {
  ...
  private <K extends java.lang.Object, V extends java.lang.Object> void connectImpl(CommandHandler<K, V> handler, RedisChannelHandler<K, V> connection, RedisURI redisURI) {
  ...
  /**
     ...
     * @return A new connection.
     */
  public RedisPubSubAsyncCommands<String, String> connectPubSub() {
  ...
  /**
     ...
     * @return A new connection.
     */
  public RedisPubSubAsyncCommands<String, String> connectPubSub(RedisURI redisURI) {
    checkValidRedisURI(redisURI);
  ...
  /**
     ...
     */
  public <K extends java.lang.Object, V extends java.lang.Object> RedisPubSubAsyncCommands<K, V> connectPubSub(RedisCodec<K, V> codec) {
    checkForRedisURI();
    return connectPubSub(codec, redisURI);
  }

  protected <K extends java.lang.Object, V extends java.lang.Object> RedisPubSubAsyncCommands<K, V> connectPubSub(RedisCodec<K, V> codec, RedisURI redisURI) {
    checkArgument(codec != null, "RedisCodec must not be null");
  ...
  /**
     ...
     * @return a new connection.
     */
  public <K extends java.lang.Object, V extends java.lang.Object> RedisSentinelAsyncCommands<K, V> connectSentinelAsync(RedisCodec<K, V> codec) {
    checkForRedisURI();
    checkArgument(codec != null, "RedisCodec must not be null");
  ...
  public RedisSentinelAsyncCommands<String, String> connectSentinelAsync(RedisURI redisURI) {
    return 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/b378ab2fb0448418754c692b66d23b99e0801ac8/src/main/java/com/lambdaworks/redis/RedisClient.java/left.java
    connectSentinelAsyncImpl(newStringStringCodec(), redisURI)
=======
    connectSentinelImpl(newStringStringCodec(), redisURI).async()
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/b378ab2fb0448418754c692b66d23b99e0801ac8/src/main/java/com/lambdaworks/redis/RedisClient.java/right.java
    ;
  }
  ...
  protected <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisPubSubConnectionImpl<K, V> newStatefulRedisPubSubConnection(PubSubCommandHandler<K, V> handler, RedisCodec<K, V> codec) {
  ...
  protected <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisConnectionImpl<K, V> newStatefulRedisConnection(CommandHandler<K, V> handler, RedisCodec<K, V> codec) {
  ...
  private SocketAddress lookupRedis(String sentinelMasterId) throws InterruptedException, TimeoutException, ExecutionException {
    RedisSentinelAsyncCommands<String, String> connection = connectSentinelAsync();
    try {
