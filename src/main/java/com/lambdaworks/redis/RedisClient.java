...
public class RedisClient extends AbstractRedisClient {
  ...
  /**
     ...
     */
  @Deprecated public RedisClient(String host, int port) {
  ...
  /**
     ...
     * @deprecated Use the factory method {@link #create(RedisURI)}
     */
  @Deprecated public RedisClient(RedisURI redisURI) {
    super();
    this.redisURI = redisURI;
  ...
  /**
     ...
     * @return a new {@link RedisConnectionPool} instance
     */
  @SuppressWarnings(value = { "unchecked" }) public <K extends java.lang.Object, V extends java.lang.Object> RedisConnectionPool<RedisCommands<K, V>> pool(final RedisCodec<K, V> codec, int maxIdle, int maxActive) {
    checkForRedisURI();
    checkArgument(codec != null, "RedisCodec must not be null");
    long maxWait = makeTimeout();
    RedisConnectionPool<RedisCommands<K, V>> pool = new RedisConnectionPool<>(new RedisConnectionPool.RedisConnectionProvider<RedisCommands<K, V>>() {
      @Override public RedisCommands<K, V> createConnection() {
        return connect(codec, redisURI).sync();
      }

      @Override @SuppressWarnings(value = { "rawtypes" }) public Class<? extends RedisCommands<K, V>> getComponentType() {
  ...
  private void checkForRedisURI() {
    checkState(this.redisURI != null, "RedisURI is not available. Use RedisClient(Host), RedisClient(Host, Port) or RedisClient(RedisURI) to construct your client.");
  }
  ...
  /**
     ...
     * @return a new {@link RedisConnectionPool} instance
     */
  public <K extends java.lang.Object, V extends java.lang.Object> RedisConnectionPool<RedisAsyncCommands<K, V>> asyncPool(final RedisCodec<K, V> codec, int maxIdle, int maxActive) {
    checkForRedisURI();
    checkArgument(codec != null, "RedisCodec must not be null");
    long maxWait = makeTimeout();
    RedisConnectionPool<RedisAsyncCommands<K, V>> pool = new RedisConnectionPool<>(new RedisConnectionPool.RedisConnectionProvider<RedisAsyncCommands<K, V>>() {
      @Override public RedisAsyncCommands<K, V> createConnection() {
        return connectStandalone(codec, redisURI).async();
      }

      @Override @SuppressWarnings(value = { "rawtypes", "unchecked" }) public Class<? extends RedisAsyncCommands<K, V>> getComponentType() {
  ...
  /**
     ...
     * @return A new connection
     */
  public <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisConnection<K, V> connect(RedisCodec<K, V> codec) {
    checkForRedisURI();
...
=======
>>>>>>> Unknown file: This is a bug in JDime.
   public <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisConnection<K, V> connect(RedisCodec<K, V> codec, RedisURI redisURI) {
    return 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/RedisClient.java/left.java
    (RedisConnection<K, V>) syncHandler((RedisChannelHandler<K, V>) connectAsync(codec, redisURI), RedisConnection.class, RedisClusterConnection.class)
=======
    connectStandalone(codec, redisURI)
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/RedisClient.java/right.java
  ...
  /**
     ...
     * @return A new connection
     */
  @Deprecated public RedisAsyncCommands<String, String> connectAsync() {
  ...
  /**
     ...
     * @return A new connection
     */
  @Deprecated public <K extends java.lang.Object, V extends java.lang.Object> RedisAsyncCommands<K, V> connectAsync(RedisCodec<K, V> codec) {
    checkForRedisURI();
  ...
  /**
     ...
     * @return A new connection
     */
  @Deprecated public RedisAsyncCommands<String, String> connectAsync(RedisURI redisURI) {
    checkValidRedisURI(redisURI);
  ...
  /**
     ...
     * @return A new connection
     */
  @Deprecated public <K extends java.lang.Object, V extends java.lang.Object> 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/RedisClient.java/left.java
  RedisAsyncConnection
=======
  RedisAsyncCommands
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/RedisClient.java/right.java
  <K, V> connectAsync(RedisCodec<K, V> codec, RedisURI redisURI) {
    checkArgument(codec != null, "RedisCodec must not be null");
    assertNotNull(redisURI);
...
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/RedisClient.java/left.java
  private <K extends java.lang.Object, V extends java.lang.Object> void connectAsync(CommandHandler<K, V> handler, RedisAsyncConnectionImpl<K, V> connection, RedisURI redisURI) {
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  private <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisConnection<K, V> connectStandalone(RedisCodec<K, V> codec, RedisURI redisURI) {
    assertNotNull(codec);
    assertNotNull(redisURI);
  ...
  private <K extends java.lang.Object, V extends java.lang.Object> void connectStateful(CommandHandler<K, V> handler, StatefulRedisConnectionImpl<K, V> connection, RedisURI redisURI) {
    ConnectionBuilder connectionBuilder;
    if (redisURI.isSsl()) {
      SslConnectionBuilder sslConnectionBuilder = SslConnectionBuilder.sslConnectionBuilder();
      sslConnectionBuilder.ssl(redisURI);
  ...
  /**
     ...
     * @return A new pub/sub connection
     */
  public <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisPubSubConnection<K, V> connectPubSub(RedisCodec<K, V> codec) {
    checkForRedisURI();
  ...
  /**
     ...
     * @return A new connection
     */
  public <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisPubSubConnection<K, V> connectPubSub(RedisCodec<K, V> codec, RedisURI redisURI) {
    assertNotNull(codec);
    assertNotNull(redisURI);
    Queue<RedisCommand<K, V, ?>> queue = new 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/RedisClient.java/left.java
    ArrayDeque<RedisCommand<K, V, ?>>
=======
    ArrayDeque<>
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/RedisClient.java/right.java
    ();
  ...
  /**
     ...
     * @return A new stateful Redis Sentinel connection
     */
  public <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisSentinelConnection<K, V> connectSentinel(RedisCodec<K, V> codec) {
    checkForRedisURI();
  ...
  /**
     ...
     * @return A new connection
     */
  public <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisSentinelConnection<K, V> connectSentinel(RedisCodec<K, V> codec, RedisURI redisURI) {
    return connectSentinelImpl(codec, redisURI);
  }
  ...
  /**
     ...
     * @return a new connection
     */
  @Deprecated public RedisSentinelAsyncCommands<String, String> connectSentinelAsync() {
  ...
  /**
     ...
     * @return a new connection
     */
  @Deprecated public <K extends java.lang.Object, V extends java.lang.Object> RedisSentinelAsyncCommands<K, V> connectSentinelAsync(RedisCodec<K, V> codec) {
    checkForRedisURI();
  ...
  /**
     ...
     * @return A new connection
     */
  @Deprecated public RedisSentinelAsyncCommands<String, String> connectSentinelAsync(RedisURI redisURI) {
...
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/RedisClient.java/right.java
  <K, V> connectSentinelAsync(RedisCodec<K, V> codec, RedisURI redisURI) {
    return 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/RedisClient.java/left.java
    connectSentinelAsyncImpl(codec, redisURI)
=======
    connectSentinelImpl(codec, redisURI).async()
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/RedisClient.java/right.java
    ;
  }
...
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/RedisClient.java/left.java
  private <K extends java.lang.Object, V extends java.lang.Object> RedisSentinelAsyncConnection<K, V> connectSentinelAsyncImpl(RedisCodec<K, V> codec, RedisURI redisURI) {
    assertNotNull(codec);
    assertNotNull(redisURI);
    Queue<RedisCommand<K, V, ?>> queue = new ArrayDeque<RedisCommand<K, V, ?>>();
    ...
    final RedisSentinelAsyncConnectionImpl<K, V> connection = newRedisSentinelAsyncConnectionImpl(commandHandler, codec, timeout, unit);
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  private <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisSentinelConnection<K, V> connectSentinelImpl(RedisCodec<K, V> codec, RedisURI redisURI) {
    assertNotNull(codec);
    assertNotNull(redisURI);
    Queue<RedisCommand<K, V, ?>> queue = new ArrayDeque<>();
    ConnectionBuilder connectionBuilder = ConnectionBuilder.connectionBuilder();
  ...
  /**
     ...
     */
  protected <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisPubSubConnectionImpl<K, V> newStatefulRedisPubSubConnection(PubSubCommandHandler<K, V> commandHandler, RedisCodec<K, V> codec) {
  ...
  /**
     ...
     */
  protected <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisSentinelConnectionImpl<K, V> newStatefulRedisSentinelConnection(CommandHandler<K, V> commandHandler, RedisCodec<K, V> codec) {
  ...
  /**
     ...
     */
  protected <K extends java.lang.Object, V extends java.lang.Object> StatefulRedisConnectionImpl<K, V> newStatefulRedisConnection(CommandHandler<K, V> commandHandler, RedisCodec<K, V> codec) {
  ...
  private static <K extends java.lang.Object, V extends java.lang.Object> void assertNotNull(RedisCodec<K, V> codec) {
    checkArgument(codec != null, "RedisCodec must not be null");
  }
  ...
  /**
     ...
     */
  @Override public void setOptions(ClientOptions clientOptions) {
