 ...
 * @since 3.0
 */
public interface RedisChannelWriter<K extends java.lang.Object, V extends java.lang.Object> extends Closeable {
  /**
     ...
     */
  <T extends java.lang.Object, C extends RedisCommand<K, V, T>> C write(C command);
