...
class PlainChannelInitializer extends io.netty.channel.ChannelInitializer<Channel> implements RedisChannelInitializer {
  final static RedisCommandBuilder<String, String> INITIALIZING_CMD_BUILDER = 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/PlainChannelInitializer.java/left.java
  new RedisCommandBuilder<String, String>(new Utf8StringCodec())
=======
  new RedisCommandBuilder<>(new Utf8StringCodec())
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/PlainChannelInitializer.java/right.java
  ...
  public PlainChannelInitializer(boolean pingBeforeActivateConnection, char[] password, List<ChannelHandler> handlers, EventBus eventBus) {
  ...
  @Override protected void initChannel(Channel channel) throws Exception {
    if (channel.pipeline().get("channelActivator") == null) {
      channel.pipeline().addLast("channelActivator", new RedisChannelInitializerImpl() {
        ...
        @Override public Future<Boolean> channelInitialized() {
...
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/main/java/com/lambdaworks/redis/PlainChannelInitializer.java/right.java
  ...
  static void pingBeforeActivate(final AsyncCommand<?, ?, ?> cmd, final SettableFuture<Boolean> initializedFuture, final ChannelHandlerContext ctx, final List<ChannelHandler> handlers) throws Exception {
