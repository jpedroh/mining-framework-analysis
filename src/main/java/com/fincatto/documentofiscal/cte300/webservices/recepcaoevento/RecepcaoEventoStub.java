...
@SuppressWarnings(value = { "rawtypes", "unchecked", "deprecation", "unused" }) public class RecepcaoEventoStub extends org.apache.axis2.client.Stub {
  ...
  /**
     ...
     * @param cteCabecMsg1
     */
  public com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult cteRecepcaoEvento(final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg cteDadosMsg0, final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
  ...
  /**
     ...
     * @param cteCabecMsg1
     */
  public void startcteRecepcaoEvento(final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg cteDadosMsg0, final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteCabecMsgE cteCabecMsg1, final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoCallbackHandler callback) throws java.rmi.RemoteException {
    final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
    _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento/cteRecepcaoEvento");
    _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
    this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
  ...
  private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult param, final boolean optimizeContent) {
  ...
  private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteCabecMsgE param, final boolean optimizeContent) {
  ...
  private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
