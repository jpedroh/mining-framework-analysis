...
public class MDFeRecepcaoStub extends org.apache.axis2.client.Stub {
  ...
  /**
     ...
     */
  public MDFeRecepcaoStub(final org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
  ...
  /**
     ...
     */
  public MDFeRecepcaoStub(final org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint, final boolean useSeparateListener) throws org.apache.axis2.AxisFault {
  ...
  /**
     * Default Constructor
     */
  public MDFeRecepcaoStub(final org.apache.axis2.context.ConfigurationContext configurationContext) throws org.apache.axis2.AxisFault {
    this(configurationContext, "https://mdfe.sefaz.rs.gov.br/ws/MDFerecepcao/MDFeRecepcao.asmx");
  }
  ...
  public MDFeRecepcaoStub() throws org.apache.axis2.AxisFault {
    this("https://mdfe.sefaz.rs.gov.br/ws/MDFerecepcao/MDFeRecepcao.asmx");
  }

  /**
     * Constructor taking the target endpoint
     */
  public MDFeRecepcaoStub(final java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
  ...
  /**
     ...
     * @param mdfeCabecMsg1
     */
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) public com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoStub.MdfeRecepcaoLoteResult mdfeRecepcaoLote(final com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoStub.MdfeDadosMsg mdfeDadosMsg0, final com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
  ...
  @SuppressWarnings(value = { "serial" }) public static class MdfeCabecMsg implements org.apache.axis2.databinding.ADBBean {
    ...
    @SuppressWarnings(value = { "rawtypes", "unchecked" }) @Override public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
      ...
      if (this.localCUFTracker) {
        elementList.add(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao", "cUF"));
        if (this.localCUF != null) {
      ...
      if (this.localVersaoDadosTracker) {
        elementList.add(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao", "versaoDados"));
        if (this.localVersaoDados != null) {
  ...
  @SuppressWarnings(value = { "serial" }) public static class MdfeRecepcaoLoteResult implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
      /**
             * static method to create the object Precondition: If this object is an element, the current or next start element starts this object and any intervening reader events are ignorable If this object is not an element, it is a complex type and the reader is at the event just after the outer start element Postcondition: If this object is an element, the reader is positioned at its end element If this object is a complex type, the reader is positioned at the end element of its outer element
             */
      @SuppressWarnings(value = { "unused", "rawtypes" }) public static MdfeRecepcaoLoteResult parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
