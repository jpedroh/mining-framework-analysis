...
public class MDFeConsNaoEncStub extends org.apache.axis2.client.Stub {
  ...
  private static synchronized java.lang.String getUniqueSuffix() {
    if (MDFeConsNaoEncStub.counter > 99999) {
  ...
  private void populateAxisService() {
    this._service = new org.apache.axis2.description.AxisService("MDFeConsNaoEnc" + MDFeConsNaoEncStub.getUniqueSuffix());
  ...
  /**
     ...
     */
  public MDFeConsNaoEncStub(final org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
  ...
  /**
     ...
     */
  public MDFeConsNaoEncStub(final org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint, final boolean useSeparateListener) throws org.apache.axis2.AxisFault {
  ...
  /**
     * Default Constructor
     */
  public MDFeConsNaoEncStub(final org.apache.axis2.context.ConfigurationContext configurationContext) throws org.apache.axis2.AxisFault {
  ...
  /**
     ...
     */
  public MDFeConsNaoEncStub(final java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
  ...
  /**
     ...
     * @param mdfeCabecMsg1
     */
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) public com.fincatto.documentofiscal.mdfe3.webservices.consultanaoencerrado.MDFeConsNaoEncStub.MdfeConsNaoEncResult mdfeConsNaoEnc(final com.fincatto.documentofiscal.mdfe3.webservices.consultanaoencerrado.MDFeConsNaoEncStub.MdfeDadosMsg mdfeDadosMsg0, final com.fincatto.documentofiscal.mdfe3.webservices.consultanaoencerrado.MDFeConsNaoEncStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
    ...
    try {
      ...
      env = this.toEnvelope(Stub.getFactory(_operationClient.getOptions().getSoapVersionURI()), mdfeDadosMsg0, this.optimizeContent(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc", "mdfeConsNaoEnc")), new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc", "mdfeConsNaoEnc"));
      env.build();
      if (mdfeCabecMsg1 != null) {
        final org.apache.axiom.om.OMElement omElementmdfeCabecMsg1 = this.toOM(mdfeCabecMsg1, this.optimizeContent(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc", "mdfeConsNaoEnc")));
      ...
      if (faultElt != null) {
        if (this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeConsNaoEnc"))) {
          try {
            final java.lang.String exceptionClassName = (java.lang.String) this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeConsNaoEnc"));
  ...
  /**
     ...
     * @param mdfeCabecMsg1
     */
  public void startmdfeConsNaoEnc(final com.fincatto.documentofiscal.mdfe3.webservices.consultanaoencerrado.MDFeConsNaoEncStub.MdfeDadosMsg mdfeDadosMsg0, final com.fincatto.documentofiscal.mdfe3.webservices.consultanaoencerrado.MDFeConsNaoEncStub.MdfeCabecMsgE mdfeCabecMsg1, final com.fincatto.documentofiscal.mdfe3.webservices.consultanaoencerrado.MDFeConsNaoEncCallbackHandler callback) throws java.rmi.RemoteException {
    final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
    _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc/mdfeConsNaoEnc");
    _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
    this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
    ...
    _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
      ...
      @SuppressWarnings(value = { "rawtypes", "unchecked" }) @Override public void onError(final java.lang.Exception error) {
        if (error instanceof org.apache.axis2.AxisFault) {
          ...
          final org.apache.axiom.om.OMElement faultElt = f.getDetail();
          if (faultElt != null) {
            if (MDFeConsNaoEncStub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeConsNaoEnc"))) {
              try {
                final java.lang.String exceptionClassName = (java.lang.String) MDFeConsNaoEncStub.this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeConsNaoEnc"));
                final java.lang.Class exceptionClass = java.lang.Class.forName(exceptionClassName);
                final java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(String.class);
                final java.lang.Exception ex = (java.lang.Exception) constructor.newInstance(f.getMessage());
  ...
  @SuppressWarnings(value = { "serial" }) public static class MdfeCabecMsg implements org.apache.axis2.databinding.ADBBean {
    ...
    @SuppressWarnings(value = { "deprecation" }) @Override public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
      ...
      if (serializeType) {
        final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, "http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc");
    ...
    @SuppressWarnings(value = { "rawtypes", "unchecked" }) @Override public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
      ...
      if (this.localCUFTracker) {
        elementList.add(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc", "cUF"));
        if (this.localCUF != null) {
      ...
      if (this.localVersaoDadosTracker) {
        elementList.add(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc", "versaoDados"));
        if (this.localVersaoDados != null) {
    ...
    public static class Factory {
      /**
             ...
             */
      @SuppressWarnings(value = { "rawtypes", "unused" }) public static MdfeCabecMsg parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
  ...
  public static class ExtensionMapper {
    public static java.lang.Object getTypeObject(final java.lang.String namespaceURI, final java.lang.String typeName, final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      if ("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc".equals(namespaceURI) && "mdfeCabecMsg".equals(typeName)) {
  ...
  @SuppressWarnings(value = { "serial" }) public static class MdfeConsNaoEncResult implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc", "mdfeConsNaoEncResult", "ns6");
    ...
    /**
         ...
         */
    @Override public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory) {
      final org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MdfeConsNaoEncResult.MY_QNAME);
      return factory.createOMElement(dataSource, MdfeConsNaoEncResult.MY_QNAME);
    }
    ...
    @Override public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
      ...
      if (serializeType) {
        final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, "http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc");
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
          this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":mdfeConsNaoEncResult", xmlWriter);
        } else {
          this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "mdfeConsNaoEncResult", xmlWriter);
        }
      }
    ...
    private void writeStartElement(java.lang.String prefix, final java.lang.String namespace, final java.lang.String localPart, final javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
      ...
      if (writerPrefix != null) {
        ...
        if (namespace.length() == 0) {
          ...
          if (prefix == null) {
            prefix = MdfeConsNaoEncResult.generatePrefix(namespace);
          }
        }
        xmlWriter.writeStartElement(prefix, localPart, namespace);
        xmlWriter.writeNamespace(prefix, namespace);
    ...
    @SuppressWarnings(value = { "unused" }) private void writeQName(final javax.xml.namespace.QName qname, final javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
      ...
      if (namespaceURI != null) {
        java.lang.String prefix = xmlWriter.getPrefix(namespaceURI);
        if (prefix == null) {
          prefix = MdfeConsNaoEncResult.generatePrefix(namespaceURI);
          xmlWriter.writeNamespace(prefix, namespaceURI);
          xmlWriter.setPrefix(prefix, namespaceURI);
        }
        if (prefix.trim().length() > 0) {
    ...
    public static class Factory {
      /**
             * static method to create the object Precondition: If this object is an element, the current or next start element starts this object and any intervening reader events are ignorable If this object is not an element, it is a complex type and the reader is at the event just after the outer start element Postcondition: If this object is an element, the reader is positioned at its end element If this object is a complex type, the reader is positioned at the end element of its outer element
             */
      @SuppressWarnings(value = { "unused", "rawtypes" }) public static MdfeConsNaoEncResult parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
        final MdfeConsNaoEncResult object = new MdfeConsNaoEncResult();
        final int event;
          ...
          if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
            ...
            if (fullTypeName != null) {
              ...
              if (!"mdfeConsNaoEncResult".equals(type)) {
                final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                return (MdfeConsNaoEncResult) ExtensionMapper.getTypeObject(nsUri, type, reader);
              }
            }
          }
          final java.util.Vector handledAttributes = new java.util.Vector();
  ...
  @SuppressWarnings(value = { "serial" }) public static class MdfeCabecMsgE implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc", "mdfeCabecMsg", "ns6");
    ...
    public static class Factory {
      /**
             * static method to create the object Precondition: If this object is an element, the current or next start element starts this object and any intervening reader events are ignorable If this object is not an element, it is a complex type and the reader is at the event just after the outer start element Postcondition: If this object is an element, the reader is positioned at its end element If this object is a complex type, the reader is positioned at the end element of its outer element
             */
      @SuppressWarnings(value = { "rawtypes", "unused" }) public static MdfeCabecMsgE parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
  ...
  @SuppressWarnings(value = { "serial" }) public static class MdfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc", "mdfeDadosMsg", "ns6");
    ...
    /**
         * databinding method to get an XML representation of this object
         */
    @SuppressWarnings(value = { "unchecked", "rawtypes" }) @Override public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
      final java.util.ArrayList elementList = new java.util.ArrayList();
      final java.util.ArrayList attribList = new java.util.ArrayList();
      if (this.localExtraElement != null) {
        elementList.add(org.apache.axis2.databinding.utils.Constants.OM_ELEMENT_KEY);
