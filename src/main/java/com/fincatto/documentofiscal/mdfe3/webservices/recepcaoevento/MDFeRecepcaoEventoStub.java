...
public class MDFeRecepcaoEventoStub extends org.apache.axis2.client.Stub {
  ...
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) public com.fincatto.documentofiscal.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult mdfeRecepcaoEvento(final com.fincatto.documentofiscal.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeDadosMsg mdfeDadosMsg0, final com.fincatto.documentofiscal.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
    ...
    try {
      ...
      if (mdfeCabecMsg1 != null) {
        final org.apache.axiom.om.OMElement omElementmdfeCabecMsg1 = this.toOM(mdfeCabecMsg1, this.optimizeContent(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoEvento", "mdfeRecepcaoEvento")));
      ...
      final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), com.fincatto.documentofiscal.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult.class, this.getEnvelopeNamespaces(_returnEnv));
      ...
      if (faultElt != null) {
        if (this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcaoEvento"))) {
          try {
            final java.lang.String exceptionClassName = (java.lang.String) this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcaoEvento"));
            ...
            final java.lang.String messageClassName = (java.lang.String) this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcaoEvento"));
    ...
    _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
      @Override public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
        try {
          ...
          final java.lang.Object object = MDFeRecepcaoEventoStub.this.fromOM(resultEnv.getBody().getFirstElement(), com.fincatto.documentofiscal.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult.class, MDFeRecepcaoEventoStub.this.getEnvelopeNamespaces(resultEnv));
        ...
        if (error instanceof org.apache.axis2.AxisFault) {
          ...
          if (faultElt != null) {
            if (MDFeRecepcaoEventoStub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcaoEvento"))) {
              try {
                final java.lang.String exceptionClassName = (java.lang.String) MDFeRecepcaoEventoStub.this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcaoEvento"));
                final java.lang.Class exceptionClass = java.lang.Class.forName(exceptionClassName);
                final java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(String.class);
                final java.lang.Exception ex = (java.lang.Exception) constructor.newInstance(f.getMessage());
                final java.lang.String messageClassName = (java.lang.String) MDFeRecepcaoEventoStub.this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcaoEvento"));
                final java.lang.Class messageClass = java.lang.Class.forName(messageClassName);
                final java.lang.Object messageObject = MDFeRecepcaoEventoStub.this.fromOM(faultElt, messageClass, null);
                final java.lang.reflect.Method m = exceptionClass.getMethod("setFaultMessage", messageClass);
                m.invoke(ex, messageObject);
  ...
  public static class ExtensionMapper {
    public static java.lang.Object getTypeObject(final java.lang.String namespaceURI, final java.lang.String typeName, final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      if ("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoEvento".equals(namespaceURI) && "mdfeCabecMsg".equals(typeName)) {
  ...
  @SuppressWarnings(value = { "serial" }) public static class MdfeCabecMsgE implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoEvento", "mdfeCabecMsg", "ns3");
  ...
  @SuppressWarnings(value = { "serial" }) public static class MdfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
    ...
    @Override public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
      ...
      if (serializeType) {
        final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, "http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoEvento");
  ...
  @SuppressWarnings(value = { "serial" }) public static class MdfeRecepcaoEventoResult implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
      /**
             * static method to create the object Precondition: If this object is an element, the current or next start element starts this object and any intervening reader events are ignorable If this object is not an element, it is a complex type and the reader is at the event just after the outer start element Postcondition: If this object is an element, the reader is positioned at its end element If this object is a complex type, the reader is positioned at the end element of its outer element
             */
      @SuppressWarnings(value = { "unused", "rawtypes" }) public static MdfeRecepcaoEventoResult parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
  ...
  @SuppressWarnings(value = { "unused" }) private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeDadosMsg param, final boolean optimizeContent) {
  ...
  @SuppressWarnings(value = { "unused" }) private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult param, final boolean optimizeContent) {
  ...
  private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeCabecMsgE param, final boolean optimizeContent) {
  ...
  private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final com.fincatto.documentofiscal.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
