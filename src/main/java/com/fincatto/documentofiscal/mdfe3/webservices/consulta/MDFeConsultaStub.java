...
public class MDFeConsultaStub extends org.apache.axis2.client.Stub {
  ...
  private static synchronized java.lang.String getUniqueSuffix() {
    if (MDFeConsultaStub.counter > 99999) {
  ...
  /**
     ...
     */
  public MDFeConsultaStub(final org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
  ...
  /**
     ...
     */
  public MDFeConsultaStub(final org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint, final boolean useSeparateListener) throws org.apache.axis2.AxisFault {
  ...
  /**
     * Default Constructor
     */
  public MDFeConsultaStub(final org.apache.axis2.context.ConfigurationContext configurationContext) throws org.apache.axis2.AxisFault {
    this(configurationContext, "https://mdfe.sefaz.rs.gov.br/ws/MDFeConsulta/MDFeConsulta.asmx");
  }
  ...
  public MDFeConsultaStub() throws org.apache.axis2.AxisFault {
    this("https://mdfe.sefaz.rs.gov.br/ws/MDFeConsulta/MDFeConsulta.asmx");
  }

  /**
     * Constructor taking the target endpoint
     */
  public MDFeConsultaStub(final java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
  ...
  /**
     ...
     * @param mdfeCabecMsg1
     */
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) public com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeConsultaMDFResult mdfeConsultaMDF(final com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeDadosMsg mdfeDadosMsg0, final com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
    ...
    try {
      ...
      final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeConsultaMDFResult.class, this.getEnvelopeNamespaces(_returnEnv));
      return (com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeConsultaMDFResult) object;
    ...
    _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
      @Override public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
        try {
          ...
          final java.lang.Object object = MDFeConsultaStub.this.fromOM(resultEnv.getBody().getFirstElement(), com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeConsultaMDFResult.class, MDFeConsultaStub.this.getEnvelopeNamespaces(resultEnv));
          callback.receiveResultmdfeConsultaMDF((com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeConsultaMDFResult) object);
          ...
          if (faultElt != null) {
            if (MDFeConsultaStub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeConsultaMDF"))) {
              try {
                ...
                final java.lang.Class messageClass = java.lang.Class.forName(messageClassName);
                final java.lang.Object messageObject = MDFeConsultaStub.this.fromOM(faultElt, messageClass, null);
                final java.lang.reflect.Method m = exceptionClass.getMethod("setFaultMessage", messageClass);
                m.invoke(ex, messageObject);
  ...
  @SuppressWarnings(value = { "serial" }) public static class MdfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsulta", "mdfeDadosMsg", "ns1");
  ...
  @SuppressWarnings(value = { "serial" }) public static class MdfeConsultaMDFResult implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsulta", "mdfeConsultaMDFResult", "ns1");
    ...
    /**
         ...
         */
    @Override public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory) {
      final org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MdfeConsultaMDFResult.MY_QNAME);
      return factory.createOMElement(dataSource, MdfeConsultaMDFResult.MY_QNAME);
    }
    ...
    @Override public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
      ...
      if (serializeType) {
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
          ...
          this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "mdfeConsultaMDFResult", xmlWriter);
        }
      }
      if (this.localExtraElement != null) {
        this.localExtraElement.serialize(xmlWriter);
    ...
    private void writeStartElement(java.lang.String prefix, final java.lang.String namespace, final java.lang.String localPart, final javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
      ...
      if (writerPrefix != null) {
        ...
        if (namespace.length() == 0) {
          ...
          if (prefix == null) {
            prefix = MdfeConsultaMDFResult.generatePrefix(namespace);
          }
        }
        xmlWriter.writeStartElement(prefix, localPart, namespace);
        xmlWriter.writeNamespace(prefix, namespace);
    ...
    @SuppressWarnings(value = { "unused" }) private void writeQName(final javax.xml.namespace.QName qname, final javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
      ...
      if (namespaceURI != null) {
        java.lang.String prefix = xmlWriter.getPrefix(namespaceURI);
        if (prefix == null) {
          prefix = MdfeConsultaMDFResult.generatePrefix(namespaceURI);
          xmlWriter.writeNamespace(prefix, namespaceURI);
          xmlWriter.setPrefix(prefix, namespaceURI);
        }
        if (prefix.trim().length() > 0) {
    ...
    public static class Factory {
      /**
             * static method to create the object Precondition: If this object is an element, the current or next start element starts this object and any intervening reader events are ignorable If this object is not an element, it is a complex type and the reader is at the event just after the outer start element Postcondition: If this object is an element, the reader is positioned at its end element If this object is a complex type, the reader is positioned at the end element of its outer element
             */
      @SuppressWarnings(value = { "unused", "rawtypes" }) public static MdfeConsultaMDFResult parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
        final MdfeConsultaMDFResult object = new MdfeConsultaMDFResult();
        try {
          while (!reader.isStartElement() && !reader.isEndElement()) {
            reader.next();
          }
          if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
            ...
            if (fullTypeName != null) {
              ...
              if (!"mdfeConsultaMDFResult".equals(type)) {
                final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                return (MdfeConsultaMDFResult) ExtensionMapper.getTypeObject(nsUri, type, reader);
              }
            }
          }
          final java.util.Vector handledAttributes = new java.util.Vector();
  ...
  private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeCabecMsgE param, final boolean optimizeContent) {
    return param.getOMElement(com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
  }

  private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
    final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
    emptyEnvelope.getBody().addChild(param.getOMElement(com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeDadosMsg.MY_QNAME, factory));
  ...
  @SuppressWarnings(value = { "rawtypes" }) private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
    try {
      if (com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeDadosMsg.class.equals(type)) {
        return com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
      }
      if (com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeConsultaMDFResult.class.equals(type)) {
        return com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeConsultaMDFResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
      }
      if (com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeCabecMsgE.class.equals(type)) {
        return com.fincatto.documentofiscal.mdfe3.webservices.consulta.MDFeConsultaStub.MdfeCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
      }
