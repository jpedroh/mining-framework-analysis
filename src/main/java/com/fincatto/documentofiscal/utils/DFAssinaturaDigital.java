...
<<<<<<< /usr/src/app/output/fincatto/nfe/a4be269d5dc77dafeedaa7986ce331f1dac5bfae/src/main/java/com/fincatto/documentofiscal/utils/DFAssinaturaDigital.java/left.java
    try {
      ...
      String commonName = ldapDN.getRdns().stream().filter((rdn) -> StringUtils.equalsIgnoreCase(rdn.getType(), "CN")).map((val) -> val.getValue() + "").findFirst().orElse("");
...
>>>>>>> /usr/src/app/output/fincatto/nfe/a4be269d5dc77dafeedaa7986ce331f1dac5bfae/src/main/java/com/fincatto/documentofiscal/utils/DFAssinaturaDigital.java/right.java

    this.getLogger().debug("DN: {}", dn);
    final String cn = new LdapName(dn).getRdns().stream().filter((rdn) -> StringUtils.equalsIgnoreCase(rdn.getType(), "CN")).map((val) -> String.valueOf(val.getValue())).findFirst().orElse("");
  ...
  private KeyStore.PrivateKeyEntry getPrivateKeyEntry() throws KeyStoreException, NoSuchAlgorithmException, UnrecoverableEntryException {
    ...
    if (StringUtils.
<<<<<<< /usr/src/app/output/fincatto/nfe/a4be269d5dc77dafeedaa7986ce331f1dac5bfae/src/main/java/com/fincatto/documentofiscal/utils/DFAssinaturaDigital.java/left.java
    isNotEmpty(config.getCertificadoAlias())
=======
    isNotBlank(config.getCertificadoAlias())
>>>>>>> /usr/src/app/output/fincatto/nfe/a4be269d5dc77dafeedaa7986ce331f1dac5bfae/src/main/java/com/fincatto/documentofiscal/utils/DFAssinaturaDigital.java/right.java
    ) {
...
>>>>>>> /usr/src/app/output/fincatto/nfe/a4be269d5dc77dafeedaa7986ce331f1dac5bfae/src/main/java/com/fincatto/documentofiscal/utils/DFAssinaturaDigital.java/right.java
      ...
      return (KeyStore.PrivateKeyEntry) config.getCertificadoKeyStore().getEntry(
<<<<<<< /usr/src/app/output/fincatto/nfe/a4be269d5dc77dafeedaa7986ce331f1dac5bfae/src/main/java/com/fincatto/documentofiscal/utils/DFAssinaturaDigital.java/left.java
      certificateAlias
=======
      config.getCertificadoAlias()
>>>>>>> /usr/src/app/output/fincatto/nfe/a4be269d5dc77dafeedaa7986ce331f1dac5bfae/src/main/java/com/fincatto/documentofiscal/utils/DFAssinaturaDigital.java/right.java
      , passwordProtection);
    } else {
...
>>>>>>> /usr/src/app/output/fincatto/nfe/a4be269d5dc77dafeedaa7986ce331f1dac5bfae/src/main/java/com/fincatto/documentofiscal/utils/DFAssinaturaDigital.java/right.java
  ...
  static class DFKeySelector extends KeySelector {
    @Override public KeySelectorResult select(final KeyInfo keyInfo, final KeySelector.Purpose purpose, final AlgorithmMethod method, final XMLCryptoContext context) throws KeySelectorException {
