...
public class NFNotaInfoItemImpostoICMS61 extends DFBase {
  ...
  @Element(name = "qBCMonoRet", required = false) private String quantidadeBaseCalculo;

  @Element(name = "adRemICMSRet") private String percentualAliquota;

  @Element(name = "vICMSMonoRet") private String valorTributo;
