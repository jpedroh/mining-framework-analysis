...
public class NfeStatusServico4Stub extends org.apache.axis2.client.Stub {
  ...
  private static synchronized java.lang.String getUniqueSuffix() {
    if (NfeStatusServico4Stub.counter > 99999) {
  ...
  private void populateAxisService() {
    this._service = new org.apache.axis2.description.AxisService("NfeStatusServico4" + NfeStatusServico4Stub.getUniqueSuffix());
  ...
  /**
     ...
     * @param nfeDadosMsg0
     */
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) public com.fincatto.documentofiscal.nfe400.webservices.statusservico.consulta.NfeStatusServico4Stub.NfeResultMsg nfeStatusServicoNF(final com.fincatto.documentofiscal.nfe400.webservices.statusservico.consulta.NfeStatusServico4Stub.NfeDadosMsg nfeDadosMsg0) throws java.rmi.RemoteException {
    ...
    try {
      ...
      final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), com.fincatto.documentofiscal.nfe400.webservices.statusservico.consulta.NfeStatusServico4Stub.NfeResultMsg.class);
      return (com.fincatto.documentofiscal.nfe400.webservices.statusservico.consulta.NfeStatusServico4Stub.NfeResultMsg) object;
    } catch (final org.apache.axis2.AxisFault f) {
      final org.apache.axiom.om.OMElement faultElt = f.getDetail();
      if (faultElt != null) {
        if (this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeStatusServicoNF"))) {
          try {
  ...
  private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final com.fincatto.documentofiscal.nfe400.webservices.statusservico.consulta.NfeStatusServico4Stub.NfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName elementQName) {
  ...
  @SuppressWarnings(value = { "rawtypes" }) private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type) throws org.apache.axis2.AxisFault {
    try {
      if (com.fincatto.documentofiscal.nfe400.webservices.statusservico.consulta.NfeStatusServico4Stub.NfeDadosMsg.class.equals(type)) {
        return com.fincatto.documentofiscal.nfe400.webservices.statusservico.consulta.NfeStatusServico4Stub.NfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
      }
      if (com.fincatto.documentofiscal.nfe400.webservices.statusservico.consulta.NfeStatusServico4Stub.NfeResultMsg.class.equals(type)) {
        return com.fincatto.documentofiscal.nfe400.webservices.statusservico.consulta.NfeStatusServico4Stub.NfeResultMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
      }
  ...
  @SuppressWarnings(value = { "serial" }) public static class NfeResultMsg implements org.apache.axis2.databinding.ADBBean {
    ...
    @Override public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
      ...
      if (serializeType) {
        final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, "http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4");
    ...
    public static class Factory {
      @SuppressWarnings(value = { "unused" }) private static org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(Factory.class);

      /**
             * static method to create the object Precondition: If this object is an element, the current or next start element starts this object and any intervening reader events are ignorable If this object is not an element, it is a complex type and the reader is at the event just after the outer start element Postcondition: If this object is an element, the reader is positioned at its end element If this object is a complex type, the reader is positioned at the end element of its outer element
             */
      @SuppressWarnings(value = { "unused", "rawtypes" }) public static NfeResultMsg parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
    ...
    @Override public XMLStreamReader getPullParser(final QName arg0) {
      return null;
    }
  }

  @SuppressWarnings(value = { "serial" }) public static class NfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
      ...
      /**
             * static method to create the object Precondition: If this object is an element, the current or next start element starts this object and any intervening reader events are ignorable If this object is not an element, it is a complex type and the reader is at the event just after the outer start element Postcondition: If this object is an element, the reader is positioned at its end element If this object is a complex type, the reader is positioned at the end element of its outer element
             */
      @SuppressWarnings(value = { "unused", "rawtypes" }) public static NfeDadosMsg parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
