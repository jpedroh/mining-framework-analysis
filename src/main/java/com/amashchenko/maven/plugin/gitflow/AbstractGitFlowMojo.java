...
public abstract class AbstractGitFlowMojo extends AbstractMojo {
  ...
  @Parameter(property = "additionalMergeOptions") protected String additionalMergeOptions;
  ...
  protected String getCurrentProjectVersion() throws MojoFailureException {
    try {
      ...
      final FileReader fileReader = new FileReader(mavenSession.getCurrentProject().getFile().getAbsoluteFile());
      try {
  ...
  protected boolean validBranchName(final String branchName) throws MojoFailureException, CommandLineException {
    CommandResult r = executeGitCommandExitCode("check-ref-format", "--allow-onelevel", branchName);
  ...
  protected String gitFindBranches(final String branchName, final boolean firstMatch) throws MojoFailureException, CommandLineException {
    ...
    String branches;
    if (firstMatch) {
      branches = executeGitCommandReturn("for-each-ref", "--count=1", "--format=\"%(refname:short)\"", "refs/heads/" + branchName + wildcard);
    } else {
      branches = executeGitCommandReturn("for-each-ref", "--format=\"%(refname:short)\"", "refs/heads/" + branchName + wildcard);
    }
  ...
  protected String gitFindLastTag() throws MojoFailureException, CommandLineException {
    String tag = executeGitCommandReturn("for-each-ref", "--sort=-*authordate", "--count=1", "--format=\"%(refname:short)\"", "refs/tags/");
  ...
  /**
     ...
     * @throws CommandLineException
     */
  protected void gitMerge(final String branchName, boolean rebase, boolean noff, boolean ffonly, String message) throws MojoFailureException, CommandLineException {
  ...
  /**
     ...
     * @throws CommandLineException
     */
  protected void gitMerge(final String branchName, boolean rebase, boolean noff, boolean ffonly, final String message, 
<<<<<<< /usr/src/app/output/aleksandr-m/gitflow-maven-plugin/0af75155f88504861517809c437b9e30fe9ea8ab/src/main/java/com/amashchenko/maven/plugin/gitflow/AbstractGitFlowMojo.java/left.java
  final String additionalMergeOptions
=======
  Map<String, String> messageProperties
>>>>>>> /usr/src/app/output/aleksandr-m/gitflow-maven-plugin/0af75155f88504861517809c437b9e30fe9ea8ab/src/main/java/com/amashchenko/maven/plugin/gitflow/AbstractGitFlowMojo.java/right.java
  ...
  protected void gitPush(final String branchName, boolean pushTags) throws MojoFailureException, CommandLineException {
    ...
    if (pushTags) {
      executeGitCommand("push", "--quiet", "-u", "--follow-tags", gitFlowConfig.getOrigin(), branchName);
    } else {
  ...
  protected void mvnSetVersions(final String version) throws MojoFailureException, CommandLineException {
    ...
    if (tychoBuild) {
      ...
      executeMvnCommand(VERSIONS_MAVEN_PLUGIN_SET_GOAL, g, a, "-DnewVersion=" + version, "-DgenerateBackupPoms=false");
    }
  }
