...
public class LibratoReporter extends AbstractPollingReporter implements MetricProcessor<MetricsLibratoBatch> {
  ...
  /**
     ...
     */
  private LibratoReporter(String authHeader, String apiUrl, String name, final APIUtil.Sanitizer customSanitizer, String source, long timeout, TimeUnit timeoutUnit, MetricsRegistry registry, MetricPredicate predicate, Clock clock, VirtualMachineMetrics vm, boolean reportVmMetrics, MetricExpansionConfig expansionConfig) {
    super(registry, name);
  ...
  @Override public void run() {
    MetricsLibratoBatch batch = new MetricsLibratoBatch(LibratoBatch.DEFAULT_BATCH_SIZE, sanitizer, timeout, timeoutUnit, expansionConfig);
    if (reportVmMetrics) {
  ...
  public static class Builder {
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setApiUrl(String apiUrl) {
      this.apiUrl = apiUrl;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setSanitizer(APIUtil.Sanitizer sanitizer) {
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setRegistry(MetricsRegistry registry) {
      this.registry = registry;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setPredicate(MetricPredicate predicate) {
      this.predicate = predicate;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setVm(VirtualMachineMetrics vm) {
      this.vm = vm;
      return this;
    }
    ...
    public LibratoReporter build() {
      ...
      return new LibratoReporter(auth, apiUrl, name, sanitizer, source, timeout, timeoutUnit, registry, predicate, clock, vm, reportVmMetrics, expansionConfig);
    }
  }
