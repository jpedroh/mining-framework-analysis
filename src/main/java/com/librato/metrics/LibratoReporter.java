...
public class LibratoReporter extends ScheduledReporter implements MetricsLibratoBatch.RateConverter, MetricsLibratoBatch.DurationConverter {
  ...
  /**
     ...
     */
  private LibratoReporter(MetricRegistry registry, String name, MetricFilter filter, TimeUnit rateUnit, TimeUnit durationUnit, Sanitizer customSanitizer, String source, long timeout, TimeUnit timeoutUnit, Clock clock, MetricExpansionConfig expansionConfig, HttpPoster httpPoster, String prefix, String prefixDelimiter, Pattern sourceRegex, boolean deleteIdleStats) {
  ...
  @Override public void report(SortedMap<String, Gauge> gauges, SortedMap<String, Counter> counters, SortedMap<String, Histogram> histograms, SortedMap<String, Meter> meters, SortedMap<String, Timer> timers) {
    final long epoch = TimeUnit.MILLISECONDS.toSeconds(clock.getTime());
    final MetricsLibratoBatch batch = new MetricsLibratoBatch(LibratoBatch.DEFAULT_BATCH_SIZE, sanitizer, timeout, timeoutUnit, expansionConfig, httpPoster, prefix, prefixDelimiter, deltaTracker, this, this, sourceRegex);
  ...
  public static class Builder {
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "UnusedDeclaration" }) public Builder setDeleteIdleStats(boolean deleteIdleStats) {
      this.deleteIdleStats = deleteIdleStats;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setSourceRegex(Pattern sourceRegex) {
      this.sourceRegex = sourceRegex;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setTimeout(long timeout) {
      this.timeout = timeout;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setTimeoutUnit(TimeUnit timeoutUnit) {
      this.timeoutUnit = timeoutUnit;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setPrefixDelimiter(String prefixDelimiter) {
      this.prefixDelimiter = prefixDelimiter;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setPrefix(String prefix) {
      this.prefix = prefix;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setHttpPoster(HttpPoster poster) {
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setRateUnit(TimeUnit rateUnit) {
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setDurationUnit(TimeUnit durationUnit) {
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setTimeout(long timeout, TimeUnit timeoutUnit) {
      this.timeout = timeout;
      this.timeoutUnit = timeoutUnit;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setName(String name) {
      this.name = name;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setSanitizer(Sanitizer sanitizer) {
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setFilter(MetricFilter filter) {
      this.filter = filter;
      return this;
    }
    ...
    /**
         ...
         * @return itself
         */
    @SuppressWarnings(value = { "unused" }) public Builder setClock(Clock clock) {
      this.clock = clock;
      return this;
    }
    ...
    /**
         ...
         */
    @SuppressWarnings(value = { "unused" }) public Builder setExpansionConfig(MetricExpansionConfig expansionConfig) {
      this.expansionConfig = expansionConfig;
      return this;
    }
    ...
    /**
         ...
         * @return itself.
         */
    @SuppressWarnings(value = { "unused" }) public Builder setHttpClientConfig(AsyncHttpClientConfig httpClientConfig) {
    ...
    public LibratoReporter build() {
      constructHttpPoster();
      return new LibratoReporter(registry, name, filter, rateUnit, durationUnit, sanitizer, source, timeout, timeoutUnit, clock, expansionConfig, httpPoster, prefix, prefixDelimiter, sourceRegex, deleteIdleStats);
    }
