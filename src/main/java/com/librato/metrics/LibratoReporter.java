...
public class LibratoReporter extends AbstractPollingReporter implements MetricProcessor<MetricsLibratoBatch> {
  ...
  /**
     ...
     */
  private LibratoReporter(String authHeader, String apiUrl, String name, final APIUtil.Sanitizer customSanitizer, String source, long timeout, TimeUnit timeoutUnit, MetricsRegistry registry, MetricPredicate predicate, Clock clock, VirtualMachineMetrics vm, boolean reportVmMetrics) {
    super(registry, name);
  ...
  public static class Builder {
    ...
    public LibratoReporter build() {
      ...
      return new LibratoReporter(auth, apiUrl, name, sanitizer, source, timeout, timeoutUnit, registry, predicate, clock, vm, reportVmMetrics);
    }
  }
