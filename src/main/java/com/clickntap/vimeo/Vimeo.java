...
public class Vimeo {
  ...
  private VimeoResponse apiRequest(String endpoint, String methodName, Map<String, String> params, InputStream inputStream) throws IOException {
      ...
      if (methodName.equals(HttpPost.METHOD_NAME)) {
        ...
        if (methodName.equals(HttpPut.METHOD_NAME)) {
          ...
          if (methodName.equals(HttpDelete.METHOD_NAME)) {
            ...
            if (methodName.equals(HttpPatch.METHOD_NAME)) {
