...
public class SuperMojo extends AbstractMojo {
  ...
  @Parameter(property = "projectId") protected String projectId;

  @Parameter(property = "apiKey") protected String apiKey;

  @Parameter(property = "propertiesPath") protected String propertiesPath = null;
  ...
  protected Properties fetchHomeProperties() throws Exception {
    ...
    if (!file.exists()) {
      throw new MojoExecutionException(propertiesPath + " is missing! Read the instructions at " + "https://github.com/versioneye/versioneye_maven_plugin");
    }
    PropertiesUtils propertiesUtils = new PropertiesUtils();
