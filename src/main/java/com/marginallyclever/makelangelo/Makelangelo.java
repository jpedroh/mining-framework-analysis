...
public final class Makelangelo {
  ...
  @SuppressWarnings(value = { "unused" }) private void checkSharingPermission() {
  ...
  private JMenu createSettingsMenu() {
    ...
    bOpenPlotterSettings.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, SHORTCUT_CTRL));
  ...
  private JMenuItem createRenderStyleMenu() {
    ...
    Arrays.stream(TurtleRenderFactory.values()).forEach((iter) -> {
      ...
      if (myTurtleRenderer.getRenderer() == renderer) {
  ...
  private JMenu createToolsMenu() {
    ...
    a6.setSource(this);
    a6.addModifierListener(this::setTurtle);
    menu.add(a6);
    a7.setSource(this);
    a7.addModifierListener(this::setTurtle);
    menu.add(a7);
    ...
    a4.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_H, SHORTCUT_CTRL));
    TurtleModifierAction a5 = new FlipTurtleAction(-1, 1, Translator.get("FlipV"));
    a5.putValue(Action.SMALL_ICON, new UnicodeIcon("\u2194"));
    a5.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F, SHORTCUT_CTRL));
    a4.setSource(this);
    a4.addModifierListener(this::setTurtle);
    menu.add(a4);
    a5.setSource(this);
    a5.addModifierListener(this::setTurtle);
    menu.add(a5);
    menu.addSeparator();
    TurtleModifierAction a1 = new SimplifyTurtleAction();
    a1.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Y, SHORTCUT_CTRL));
    TurtleModifierAction a2 = new ReorderTurtleAction();
    a2.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, SHORTCUT_CTRL));
    TurtleModifierAction a3 = new InfillTurtleAction();
    a3.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_I, SHORTCUT_CTRL));
    a1.setSource(this);
    a1.addModifierListener(this::setTurtle);
    menu.add(a1);
    a2.setSource(this);
    a2.addModifierListener(this::setTurtle);
    menu.add(a2);
    a3.setSource(this);
    a3.addModifierListener(this::setTurtle);
    menu.add(a3);
    return menu;
  }
  ...
  private JMenu createFileMenu() {
    ...
    buttonNewFile.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N, SHORTCUT_CTRL));
    ...
    buttonOpenFile.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O, SHORTCUT_CTRL));
    ...
    buttonSaveFile.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, SHORTCUT_CTRL));
    ...
    if (isMacOS) {
      buttonAdjustPreferences.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_COMMA, SHORTCUT_CTRL));
    } else {
      buttonAdjustPreferences.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, SHORTCUT_ALT));
    }
    ...
    if (!isMacOS) {
      ...
      buttonExit.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q, SHORTCUT_CTRL));
  ...
  private JMenu createViewMenu() {
    ...
    checkboxShowPenUpMoves.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, SHORTCUT_CTRL));
  ...
  private JMenu createHelpMenu() {
    ...
    buttonViewLog.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, SHORTCUT_CTRL));
  ...
  private boolean onClosing() {
    int result = JOptionPane.showConfirmDialog(mainFrame, Translator.get("ConfirmQuitQuestion"), Translator.get("ConfirmQuitTitle"), JOptionPane.YES_NO_OPTION);
