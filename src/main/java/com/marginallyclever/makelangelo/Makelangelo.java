...
public final class Makelangelo {
  ...
  @SuppressWarnings(value = { "unused" }) private DropTarget dropTarget;
  ...
  private JMenuItem createRobotStyleMenu() {
    ...
    ButtonGroup group = new ButtonGroup();
    Arrays.stream(Machines.values()).forEach((iter) -> {
  ...
  private JMenu createToolsMenu() {
    ...
    a6.setSource(this);
    a6.addModifierListener((e) -> setTurtle(e));
    menu.add(a6);
    a7.setSource(this);
    a7.addModifierListener((e) -> setTurtle(e));
    menu.add(a7);
    ...
    a4.setSource(this);
    a4.addModifierListener((e) -> setTurtle(e));
    menu.add(a4);
    a5.setSource(this);
    a5.addModifierListener((e) -> setTurtle(e));
    menu.add(a5);
    menu.addSeparator();
    ...
    a1.setSource(this);
    a1.addModifierListener((e) -> setTurtle(e));
    menu.add(a1);
    a2.setSource(this);
    a2.addModifierListener((e) -> setTurtle(e));
    menu.add(a2);
    a3.setSource(this);
    a3.addModifierListener((e) -> setTurtle(e));
    menu.add(a3);
    return menu;
  }
