...
public class Plotter implements PreviewListener, Cloneable {
  ...
  private void firePlotterEvent(PlotterEvent e) {
    for (PlotterEventListener listener : listeners) {
      listener.makelangeloRobotEvent(e);
    }
  }
  ...
  public void setSettings(PlotterSettings s) throws InvalidParameterException {
    if (s == null) {
      throw new InvalidParameterException(PlotterSettings.class.getSimpleName() + " cannot be null.");
    }
    settings = s;
  }
  ...
  /**
	 ...
	 */
  @Override public void render(GL2 gl2) {
