...
public class PlotterSettings implements Serializable {
  ...
  private double penUpAngle = 90;

  private double penDownAngle = 25;
  ...
  public PlotterSettings() {
    ...
    penDownColor = penDownColorDefault = new ColorRGB(0, 0, 0);
    penUpColor = new ColorRGB(0, 255, 0);
  ...
  public void loadConfig(long uid) {
    ...
    maxAcceleration = Float.valueOf(uniqueMachinePreferencesNode.get("acceleration", Double.toString(maxAcceleration)));
