...
class Results {
  static class Errors {
    ...
    void duplicateTable(String table, int line) {
      sb.append("Duplicate table definition: [").append(table).append("]\n");
    }
    ...
    void invalidTable(String table, int line) {
      sb.append("Invalid table definition on line ").append(line).append(": ");
      if (!table.startsWith("[")) {
        sb.append('[');
      }
      sb.append(table);
    ...
    void duplicateKey(String key, int line) {
      sb.append("Duplicate key: ").append(key).append('\n');
    }
    ...
    void invalidIdentifier(Identifier identifier, int line) {
      if (identifier.isKey()) {
        ...
        if (identifier.isTable()) {
          invalidTable(identifier.getName(), line);
        } else {
          if (identifier.isTableArray()) {
    ...
    void invalidTextAfterIdentifier(Identifier identifier, char text, int line) {
      if (identifier.isKey() && text == '\n') {
        ...
        sb.append("Invalid text after key ").append(identifier.getName()).append(" on line ").append(line).append(". Make sure to terminate the value or add a comment (#).").append('\n');
      }
    }
    ...
    void invalidTableArray(String tableArray, int line) {
      sb.append("Invalid table array definition on line ").append(line).append(": ").append(tableArray).append('\n');
    }

    void invalidValue(String key, String value, int line) {
      sb.append("Invalid value on line ").append(line).append(": ").append(key).append(" = ").append(value).append('\n');
    }

    void unterminated(String key, 
...
>>>>>>> /usr/src/app/output/mwanji/toml4j/c4027ed2d5a685734a83306fdd1a4ed41f473f60/src/main/java/com/moandjiezana/toml/Results.java/right.java
    , int line) {
      sb.append(
<<<<<<< /usr/src/app/output/mwanji/toml4j/c4027ed2d5a685734a83306fdd1a4ed41f473f60/src/main/java/com/moandjiezana/toml/Results.java/left.java
      "Unterminated multiline value on line "
=======
      "Unterminated value on line "
>>>>>>> /usr/src/app/output/mwanji/toml4j/c4027ed2d5a685734a83306fdd1a4ed41f473f60/src/main/java/com/moandjiezana/toml/Results.java/right.java
      ).append(line).append(": ").append(key).append(" = ").append(
<<<<<<< /usr/src/app/output/mwanji/toml4j/c4027ed2d5a685734a83306fdd1a4ed41f473f60/src/main/java/com/moandjiezana/toml/Results.java/left.java
      multiline
=======
      value
>>>>>>> /usr/src/app/output/mwanji/toml4j/c4027ed2d5a685734a83306fdd1a4ed41f473f60/src/main/java/com/moandjiezana/toml/Results.java/right.java
  ...
  void addValue(String key, Object value) {
    ...
    if (value instanceof Map) {
      startTable(key);
      @SuppressWarnings(value = { "unchecked" }) Map<String, Object> valueMap = (Map<String, Object>) value;
