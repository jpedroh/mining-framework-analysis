...
class WSTrustRequest {
  ...
  private final static Logger piiLog = LoggerFactory.getLogger(LogHelper.PII_LOGGER_PREFIX + WSTrustRequest.class);
  ...
  static WSTrustResponse execute(String username, String password, String cloudAudienceUrn, BindingPolicy policy, Proxy proxy, SSLSocketFactory sslSocketFactory) throws Exception {
  ...
  static WSTrustResponse execute(String url, String username, String password, String cloudAudienceUrn, Proxy proxy, SSLSocketFactory sslSocketFactory) throws Exception {
  ...
  static WSTrustResponse execute(String mexURL, String cloudAudienceUrn, Proxy proxy, SSLSocketFactory sslSocketFactory) throws Exception {
