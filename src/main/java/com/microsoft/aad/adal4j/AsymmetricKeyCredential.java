...
public final class AsymmetricKeyCredential {
  ...
  /**
     ...
     */
  private AsymmetricKeyCredential(final String clientId, final PrivateKey key, final X509Certificate publicCertificate) {
    ...
    if (key instanceof RSAPrivateKey) {
      ...
      if ("sun.security.mscapi.RSAPrivateKey".equals(key.getClass().getName())) {
  ...
  /**
     ...
     */
  public static AsymmetricKeyCredential create(final String clientId, final InputStream pkcs12Certificate, final String password) throws KeyStoreException, NoSuchProviderException, NoSuchAlgorithmException, CertificateException, IOException, UnrecoverableKeyException {
