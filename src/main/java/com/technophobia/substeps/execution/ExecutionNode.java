  ...
  public String getDebugStringForThisNode() {
    ...
    if (this.parent != null) {
      ...
      if (this.feature != null) {
        buf.append(this.feature.getName()).append(" in ").append(this.feature.getFilename()).append("\n");
      } else {
      ...
      if (this.line != null) {
        buf.
<<<<<<< /usr/src/app/output/technophobia/substeps-core/07b94728d642a789e11b45c284432544e6a013a9/src/main/java/com/technophobia/substeps/execution/ExecutionNode.java/left.java
        append(this.line)
=======
        append(line).append("\n")
>>>>>>> /usr/src/app/output/technophobia/substeps-core/07b94728d642a789e11b45c284432544e6a013a9/src/main/java/com/technophobia/substeps/execution/ExecutionNode.java/right.java
        ;
      }
  ...
  public String toDebugString() {
    final StringBuilder buf = new StringBuilder();
    if (this.parent != null) {
      buf.append(this.id).append(Strings.repeat("\t", this.depth)).append("file: ").append(getFilename()).append(" ").append(this.parent.getId()).append(" ");
      if (this.feature != null) {
  ...
  public void appendMethodInfo(final String prefix, final StringBuilder buf) {
    if (this.targetClass != null && this.targetMethod != null) {
      ...
      buf.append(this.targetClass.getSimpleName()).append(".").append(this.targetMethod.getName()).append("(");
  ...
  public boolean isStep() {
    return this.depth == 3 && !isOutlineScenario() || this.depth == 4 && this.parent.isOutlineScenario();
  }
    ...
    if (this.line != null) {
      ...
      if (isFeature()) {
        ...
        if (isScenario()) {
          ...
          if (this.parent != null && this.parent.isOutlineScenario()) {
  ...
  public List<ExecutionNode> getFailedChildNodes() {
    final List<ExecutionNode> failed = filterNodes(this.children, new Predicate<ExecutionNode>() {
  ...
  private List<ExecutionNode> filterNodes(final List<ExecutionNode> sourceList, final Predicate<ExecutionNode> predicate) {
  ...
  private boolean hasFailed() {
    return this.result.getResult() == ExecutionResult.FAILED || getFailedChildNodes() != null;
  }
