...
public class Plan extends Resource<Plan> {
  ...
  @Deprecated public enum ChargeModel {
    FLAT_FEE,
    PER_UNIT,
    TIERED,
    VOLUME,
  ...
  @Deprecated public ChargeModel chargeModel() {
  ...
  public static class CreateRequest extends Request<CreateRequest> {
    ...
    @Deprecated public CreateRequest chargeModel(ChargeModel chargeModel) {
    ...
    @Deprecated public CreateRequest downgradePenalty(Double downgradePenalty) {
  ...
  public static class UpdateRequest extends Request<UpdateRequest> {
    ...
    @Deprecated public UpdateRequest chargeModel(ChargeModel chargeModel) {
      params.addOpt("charge_model", chargeModel);
      return this;
    }
    ...
    @Deprecated public UpdateRequest downgradePenalty(Double downgradePenalty) {
      params.addOpt("downgrade_penalty", downgradePenalty);
      return this;
    }
  ...
  public static class PlanListRequest extends ListRequest<PlanListRequest> {
    ...
    @Deprecated public EnumFilter<ChargeModel, PlanListRequest> chargeModel() {
