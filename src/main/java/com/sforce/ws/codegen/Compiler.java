...
class Compiler {
  ...
  @SuppressWarnings(value = { "unchecked" }) private void findCompiler(ClassLoader loader) throws ClassNotFoundException, InstantiationException, IllegalAccessException, NoSuchMethodException {
  ...
  public void compile(String[] files, File dir) throws ToolsException {
    ...
    String[] args = { "-g", "-d", dir.getAbsolutePath(), "-sourcepath", dir.getAbsolutePath(), "-target", target, "-source", target };
