...
public class Element implements Constants, Named {
  ...
  @Override public String toString() {
    return "Element{" + "name=\'" + name + '\'' + ", type=\'" + type + '\'' + ", ref=\'" + ref + '\'' + ", nillable=\'" + nillable + '\'' + ", minOccurs=\'" + minOccurs + '\'' + ", maxOccurs=\'" + maxOccurs + '\'' + '}';
  }
  ...
  public void read(WsdlParser parser) throws WsdlParseException {
    ...
    if (ref != null) {
      ...
      parser.addPostParseProcessor(new WsdlParser.PostParseProcessor() {
        @Override public void postParse() throws ConnectionException {
          Element referencedElement = schema.getTypes().getElement(getRef());
          if (referencedElement != null) {
            ...
            throw new ConnectionException("attribute ref \'" + ref + "\' could not be resolved at: " + positionDescription);
          }
        }
      });
    }
    ...
    while (true) {
      if (eventType == XmlInputStream.START_TAG) {
        ...
        if (COMPLEX_TYPE.equals(n) && SCHEMA_NS.equals(ns)) {
          ...
          if (SIMPLE_TYPE.equals(n) && SCHEMA_NS.equals(ns)) {
