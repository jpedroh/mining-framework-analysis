...
public class Definitions extends WsdlNode {
  ...
  public Binding getBinding() throws ConnectionException {
    ...
    if (binding.getName().equals(name.getLocalPart()) && targetNamespace.equals(name.getNamespaceURI())) {
      ...
      throw new ConnectionException("Unable to find binding " + name + ". Found " + binding.getName() + " instead.");
    }
  }
      ...
      if (eventType == XmlInputStream.START_DOCUMENT) {
        ...
        if (eventType == XmlInputStream.START_TAG) {
          ...
          if (eventType == XmlInputStream.END_TAG) {
            ...
            if (eventType == XmlInputStream.TEXT) {
            }
          }
        }
      }
  ...
  @Override public String toString() {
    return "Definitions{" + "types=" + types + ", messages=" + messages + ", targetNamespace=\'" + targetNamespace + '\'' + ", portType=" + portType + ", service=" + service + '}';
  }
}