...
public class PushManager<T extends ApnsPushNotification> implements ApnsConnectionListener<T> {
  ...
  /**
	 ...
	 */
  protected PushManager(final ApnsEnvironment environment, final SSLContext sslContext, final int concurrentConnectionCount, final NioEventLoopGroup workerGroup, final ExecutorService listenerExecutorService, final BlockingQueue<T> queue) {
