...
public class SystemAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
  ...
  String infoAWS = "You\'re about to manually set up an EC2 connection." + "" + "You rather use the EC2 settings. " + "By a manual setup Keybox is going to change the default key." + "You can\'t access the server with the default AWS key then. " + "Press okay to go ahead, or cancel the setup.";

  @Action(value = "/admin/viewSystems", results = { @Result(name = "success", location = "/admin/view_systems.jsp") }) public String viewAdminSystems() {
  ...
  @Action(value = "/manage/viewSystems", results = { @Result(name = "success", location = "/manage/view_systems.jsp") }) public String viewManageSystems() {
  ...
  @Action(value = "/manage/saveSystem", results = { @Result(name = "input", location = "/manage/view_systems.jsp"), @Result(name = "success", location = "/manage/viewSystems.action?sortedSet.orderByDirection=${sortedSet.orderByDirection}&sortedSet.orderByField=${sortedSet.orderByField}", type = "redirect") }) public String saveSystem() {
  ...
  @Action(value = "/manage/genNewKeyOnSystem", results = { @Result(name = "success", location = "/manage/viewSystems.action?sortedSet.orderByDirection=${sortedSet.orderByDirection}&sortedSet.orderByField=${sortedSet.orderByField}", type = "redirect") }) public String genNewKeyOnSystem() {
    String retVal = SUCCESS;
    initAppList = PrivateKeyDB.getInitialApplicationKey();
  ...
  @Action(value = "/manage/deleteSystem", results = { @Result(name = "success", location = "/manage/viewSystems.action?sortedSet.orderByDirection=${sortedSet.orderByDirection}&sortedSet.orderByField=${sortedSet.orderByField}", type = "redirect") }) public String deleteSystem() {
    if (hostSystem.getId() != null) {
  ...
  /**
     ...
     */
  @Action(value = "/manage/disableSystem", results = { @Result(name = "success", location = "/manage/viewSystems.action?sortedSet.orderByDirection=${sortedSet.orderByDirection}&sortedSet.orderByField=${sortedSet.orderByField}", type = "redirect") }) public String disableSystem() {
    if (hostSystem.getId() != null) {
  ...
  /**
     ...
     * @author Robert Vorkoeper
     */
  @Action(value = "/manage/enableSystem", results = { @Result(name = "success", location = "/manage/viewSystems.action?sortedSet.orderByDirection=${sortedSet.orderByDirection}&sortedSet.orderByField=${sortedSet.orderByField}", type = "redirect") }) public String enableSystem() {
    if (hostSystem.getId() != null) {
  ...
  @Action(value = "/manage/downloadSystemKey", results = { @Result(name = "input", location = "/manage/view_systems.jsp"), @Result(name = "success", location = "/manage/viewSystems.action?sortedSet.orderByDirection=${sortedSet.orderByDirection}&sortedSet.orderByField=${sortedSet.orderByField}", type = "redirect") }) public String downloadSystemKey() {
    sortedSet.getFilterMap().put("region", "---");
    sortedSet = SystemDB.getSystemSet(sortedSet);
    initAppList = PrivateKeyDB.getInitialApplicationKey();
    return SUCCESS;
  ...
  /**
     ...
     * @return null
     */
  @Action(value = "/manage/downloadPvtKey") public String downloadPvtKey() {
  ...
  public void validateSaveSystem() {
    if (hostSystem == null || hostSystem.getDisplayNm() == null || hostSystem.getDisplayNm().trim().equals("")) {
      addFieldError("hostSystem.displayNm", "Required");
    }
    if (hostSystem == null || hostSystem.getUser() == null || hostSystem.getUser().trim().equals("")) {
      addFieldError("hostSystem.user", "Required");
    }
    if (hostSystem == null || hostSystem.getHost() == null || hostSystem.getHost().trim().equals("")) {
      addFieldError("hostSystem.host", "Required");
    }
    if (hostSystem == null || hostSystem.getPort() == null) {
      addFieldError("hostSystem.port", "Required");
    } else {
      if (!(hostSystem.getPort() > 0)) {
        addFieldError("hostSystem.port", "Invalid");
      }
    }
    if (hostSystem == null || hostSystem.getAuthorizedKeys() == null || hostSystem.getAuthorizedKeys().trim().equals("") || hostSystem.getAuthorizedKeys().trim().equals("~")) {
