...
public abstract class AbstractID3v2Tag implements ID3v2 {
  ...
  @Override public void setGenreDescription(String text) throws IllegalArgumentException {
  ...
  @Override public void setChapterTOC(ArrayList<ID3v2ChapterTOCFrameData> toc) {
    if (toc != null) {
      invalidateDataLength();
      boolean first = true;
  ...
  @Override public void setWmpRating(final int rating) {
  ...
  @Override public String getCustomText(String description) {
    ID3v2TXXXFrameData frameData = ID3v2TXXXFrameData.extract(frameSets, unsynchronisation, description);
    if (frameData != null) {
  ...
  @Override public void setCustomText(String description, String value) {
    ID3v2TXXXFrameData.createOrAddField(frameSets, unsynchronisation, description, value, true);
  }
  ...
  @Override public boolean equals(Object obj) {
    ...
    if (frameSets == null) {
      ...
      if (other.frameSets == null) {
        ...
        if (!frameSets.equals(other.frameSets)) {
          return false;
        }
      }
    }
