...
public class EncodedText {
  ...
  private static byte textEncodingForBytesFromBOM(byte[] value) {
    if (value.length >= 2 && value[0] == (byte) 0xff && value[1] == (byte) 0xfe) {
      ...
      if (value.length >= 2 && value[0] == (byte) 0xfe && value[1] == (byte) 0xff) {
        ...
        if (value.length >= 3 && (value[0] == (byte) 0xef && value[1] == (byte) 0xbb && value[2] == (byte) 0xbf)) {
  ...
  protected private static String bytesToString(byte[] bytes, String characterSet) throws CharacterCodingException {
  ...
  protected private static byte[] stringToBytes(String s, String characterSet) {
    try {
