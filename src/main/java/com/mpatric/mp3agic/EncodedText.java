...
public class EncodedText {
	...
	private static final String[] characterSets = new java.lang.String[]{ CHARSET_ISO_8859_1, CHARSET_UTF_16, CHARSET_UTF_16BE, CHARSET_UTF_8 };

	private static final byte[] textEncodingFallback = new byte[]{ 0, 2, 1, 3 };

	private static final byte[][] boms = new byte[][]{ new byte[]{  }, new byte[]{ ((byte) (0xff)), ((byte) (0xfe)) }, new byte[]{ ((byte) (0xfe)), ((byte) (0xff)) }, new byte[]{  } };

	private static final byte[][] terminators = new byte[][]{ new byte[]{ 0 }, new byte[]{ 0, 0 }, new byte[]{ 0, 0 }, new byte[]{ 0 } };
...
private
>>>>>>> RIGHT
	 static String bytesToString(byte[] bytes, String characterSet) throws CharacterCodingException {
...
private
>>>>>>> RIGHT
	 static byte[] stringToBytes(String s, String characterSet) {
		try {
