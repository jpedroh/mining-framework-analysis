...
public abstract class Entity implements Serializable {
  ...
  public boolean isUnderWater() {
    int var1;
    return (var1 = level.getTile((int) x, (int) (y + 0.12F), (int) z)) != 0 ? Block.blocks[var1].getLiquidType().equals(LiquidType.water) : false;
  }
  ...
  public void move(float var1, float var2, float var3) {
    ...
    if (makeStepSound && onGround && !noPhysics) {
      if (this instanceof Player && !((Player) this).noPhysics) {
        distanceWalkedModified = (float) (distanceWalkedModified + Math.sqrt(var1 * var1 + var3 * var3) * 0.6D);
        distanceWalkedOnStepModified = (float) (distanceWalkedOnStepModified + Math.sqrt(var1 * var1 + var2 * var2 + var3 * var3) * 0.6D);
