    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                try {
                    Thread.sleep(1000L);
                } catch (java.lang.InterruptedException var56) {
                }
                Display.create();
            }
            Keyboard.create();
            ...
            try {
                Controllers.create();
            } catch (java.lang.Exception var55) {
            ...
            if ((this.server != null) && (this.session != null)) {
                ...
                } catch (java.lang.Exception var54) {
            ...
            try {
                ...
                try {
                    ...
                    var72.start();
                } catch (java.lang.Exception var51) {
                    var51.printStackTrace();
                    var4.running = false;
                }
            } catch (java.lang.Exception var52) {
            }
        ...
        } catch (java.lang.Exception var62) {
                ...
                if (this.waiting) {
                    ...
                    try {
                        ...
                        if (var18 > 1000L) {
                            ...
                            var63.adjustment += (var24 - var63.adjustment) * 0.20000000298023224;
                        ...
                        double var95;
                        var24 = ((var95 = var20 / 1000.0) - var63.lastHR) * var63.adjustment;
                        var63.lastHR = var95;
                        if (var24 < 0.0) {
                            var24 = 0.0;
                        }
                        ...
                        if (!this.online) {
                            ...
                            if (!renderer.minecraft.online) {
                                ...
                                if (renderer.minecraft.level != null) {
                                    float var80 = var65;
                                    Renderer var82 = renderer;
                                    Renderer var27 = renderer;
                                    Player var28;
                        ...
                        ++var15;
                    } catch (java.lang.Exception var58) {
        ...
        } catch (java.lang.Exception var60) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen == null) {
                        ...
                        if (Keyboard.getEventKey() == Keyboard.KEY_X) {
                            if ((HackState == HackState.HacksTagEnabled) || ((HackState == HackState.OpHacks) && (this.player.userType >= 100))) {
                                this.player.noPhysics = !this.player.noPhysics;
                                this.player.hovered = !this.player.hovered;
                            }
                        }
                        if (Keyboard.getEventKey() == Keyboard.KEY_Z) {
                            if (((HackState == HackState.HacksTagEnabled) || (HackState == HackState.NoHacksTagShown)) || ((HackState == HackState.OpHacks) && (this.player.userType >= 100))) {
