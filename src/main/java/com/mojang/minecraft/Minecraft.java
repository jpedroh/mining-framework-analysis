...
public final class Minecraft implements Runnable {
  ...
  public byte[] flipPixels(byte[] originalBuffer, int width, int height) {
    ...
    if (originalBuffer != null) {
      ...
      for (int y = 0; y < height; y++) {
        System.arraycopy(originalBuffer, y * width, flippedBuffer, (height - y - 1) * width, width * 3);
      }
    }
      ...
      if (!isOnline) {
        ...
        if (!renderer.minecraft.isOnline) {
          ...
          if (renderer.minecraft.level != null && player != null) {
            ...
            List<Entity> var37 = renderer.minecraft.level.blockMap.getEntities(player, player.bb.expand(var34 * reachDistance, var33 * reachDistance, var87 * reachDistance));
            float var35 = 0.0F;
            for (var81 = 0; var81 < var37.size(); ++var81) {
              Entity var88 = var37.get(var81);
              if (var88.isPickable()) {
                var74 = 0.1F;
                MovingObjectPosition var78 = var88.bb.grow(var74, var74, var74).clip(var31, vec3D);
                if (var78 != null) {
            ...
            Block var73;
            if ((var73 = Block.blocks[var26.getTile((int) player.x, (int) (player.y + 0.12F), (int) player.z)]) != null && var73.getLiquidType() != LiquidType.notLiquid) {
              LiquidType var79;
            ...
            renderer.applyBobbing(var80, renderer.minecraft.settings.viewBobbing);
            ...
            if (settings.thirdPersonMode == 2) {
              ...
              GL11.glRotatef((var116.yRotO + (var116.yRot - var116.yRotO) * var80) + 180, 0.0F, 1.0F, 0.0F);
            } else {
              GL11.glRotatef(var116.xRotO + (var116.xRot - var116.xRotO) * var80, 1.0F, 0.0F, 0.0F);
            ...
            Collections.sort(renderer.minecraft.levelRenderer.chunks, new ChunkDirtyDistanceComparator(var126));
                  ...
                  for (int var38 = var110 - 1; var38 <= var110 + 1; ++var38) {
                    ...
                    if ((var104 = var89.level.getTile(var122, var125, var38)) != 0 && Block.blocks[var104].isSolid()) {
                      ...
                      for (var114 = 0; var114 < 6; ++var114) {
                        Block.blocks[var104].renderInside(shapeRenderer, var99, var98, var105, var114);
                      }
                      shapeRenderer.end();
            ...
            for (var83 = 0; var83 < 2; ++var83) {
              if (!var96.particles[var83].isEmpty()) {
                ...
                for (var120 = 0; var120 < var96.particles[var83].size(); ++var120) {
                  ((Particle) var96.particles[var83].get(var120)).render(shapeRenderer, var107, var29, var69, var30, var117, var32);
                }
                shapeRenderer.end();
              }
            }
            ...
            if (settings.showClouds) {
              ...
              for (var86 = -2048; var86 < var101.level.width + 2048; var86 += 512) {
                for (var125 = -2048; var125 < var101.level.length + 2048; var125 += 512) {
                  shapeRenderer.vertexUV(var86, var74, var125 + 512, var86 * var33 + var34, (var125 + 512) * var33);
                  shapeRenderer.vertexUV(var86 + 512, var74, var125 + 512, (var86 + 512) * var33 + var34, (var125 + 512) * var33);
                  shapeRenderer.vertexUV(var86 + 512, var74, var125, (var86 + 512) * var33 + var34, var125 * var33);
                  shapeRenderer.vertexUV(var86, var74, var125, var86 * var33 + var34, var125 * var33);
                  shapeRenderer.vertexUV(var86, var74, var125, var86 * var33 + var34, var125 * var33);
                  shapeRenderer.vertexUV(var86 + 512, var74, var125, (var86 + 512) * var33 + var34, var125 * var33);
                  shapeRenderer.vertexUV(var86 + 512, var74, var125 + 512, (var86 + 512) * var33 + var34, (var125 + 512) * var33);
                  shapeRenderer.vertexUV(var86, var74, var125 + 512, var86 * var33 + var34, (var125 + 512) * var33);
            ...
            if (renderer.minecraft.selected != null) {
              ...
              if (var89.cracks > 0.0F) {
                ...
                for (var86 = 0; var86 < 6; ++var86) {
                  var73.renderSide(shapeRenderer, var102.x, var102.y, var102.z, var86, 240 + (int) (var101.cracks * 10.0F));
                }
                shapeRenderer.end();
            ...
            GL11.glEnable(GL11.GL_TEXTURE_2D);
            GL11.glEnable(GL11.GL_BLEND);
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, var89.textureManager.load("/water.png"));
            ...
            if (var120 > 0) {
              GL11.glBindTexture(GL11.GL_TEXTURE_2D, var89.textureManager.load("/terrain.png"));
              GL11.glCallLists(var89.buffer);
            }
            GL11.glDepthMask(true);
            GL11.glDisable(GL11.GL_BLEND);
            GL11.glDisable(GL11.GL_FOG);
            Collections.sort(selectionBoxes, new SelectionBoxDistanceComparator(player));
            ...
            if (renderer.minecraft.isRaining || renderer.minecraft.isSnowing) {
              ...
              for (var110 = var104 - 5; var110 <= var104 + 5; ++var110) {
                for (var122 = var114 - 5; var122 <= var114 + 5; ++var122) {
                  ...
                  if (var86 != var125) {
                    var74 = ((renderer.levelTicks + var110 * 3121 + var122 * 418711) % 32 + var97) / 32.0F * speed;
                    ...
                    shapeRenderer.begin();
                    shapeRenderer.vertexUV(var110, var86, var122, 0.0F, var86 * 2.0F / 8.0F + var74 * 2.0F);
                    shapeRenderer.vertexUV(var110 + 1, var86, var122 + 1, 2.0F, var86 * 2.0F / 8.0F + var74 * 2.0F);
                    shapeRenderer.vertexUV(var110 + 1, var125, var122 + 1, 2.0F, var125 * 2.0F / 8.0F + var74 * 2.0F);
                    shapeRenderer.vertexUV(var110, var125, var122, 0.0F, var125 * 2.0F / 8.0F + var74 * 2.0F);
                    shapeRenderer.vertexUV(var110, var86, var122 + 1, 0.0F, var86 * 2.0F / 8.0F + var74 * 2.0F);
                    shapeRenderer.vertexUV(var110 + 1, var86, var122, 2.0F, var86 * 2.0F / 8.0F + var74 * 2.0F);
                    shapeRenderer.vertexUV(var110 + 1, var125, var122, 2.0F, var125 * 2.0F / 8.0F + var74 * 2.0F);
                    shapeRenderer.vertexUV(var110, var125, var122 + 1, 0.0F, var125 * 2.0F / 8.0F + var74 * 2.0F);
                    shapeRenderer.end();
                  }
                }
              }
            ...
            if (!isSinglePlayer && networkManager != null && networkManager.players != null && networkManager.players.size() > 0) {
              if (settings.ShowNames == 1 && player.userType >= 100) {
                for (int n = 0; n < networkManager.players.values().size(); n++) {
                  ...
                  if (np != null) {
                    np.renderHover(renderer.minecraft.textureManager, var80);
                  }
                }
              } else {
                if (renderer.entity != null) {
                  renderer.entity.renderHover(renderer.minecraft.textureManager, var80);
                }
              }
            }
            ...
            var117 = renderer.heldBlock.lastPos + (heldBlock.pos - heldBlock.lastPos) * var80;
            ...
            var69 = 0.8F;
            if (heldBlock.moving) {
              var33 = MathHelper.sin((var74 = (heldBlock.offset + var80) / 7.0F) * 3.1415927F);
            ...
            if (heldBlock.moving) {
              var33 = MathHelper.sin((var74 = (heldBlock.offset + var80) / 7.0F) * var74 * 3.1415927F);
            ...
            ColorCache color = heldBlock.minecraft.level.getBrightnessColor((int) var116.x, (int) var116.y, (int) var116.z);
            ...
            if (currentScreen != null || canRenderGUI) {
              renderer.minecraft.hud.render(timer.delta, renderer.minecraft.currentScreen != null, var94, var70);
            }
          } else {
            GL11.glViewport(0, 0, renderer.minecraft.width, renderer.minecraft.height);
  ...
  public void takeAndSaveScreenshot(int width, int height) {
    try {
      ...
      int[] a = { 8, 8, 8 };
      int[] b = { 0, 1, 2 };
      ComponentColorModel colorComp = new ComponentColorModel(colorSpace, a, false, false, 3, 0);
      WritableRaster raster = Raster.createInterleavedRaster(new DataBufferByte(pixels, pixels.length), width, height, i * 3, 3, b, null);
              ...
              while (networkHandler.in.position() > 0 && var4++ != 100) {
                ...
                if (networkHandler.netManager.successful) {
                  if (packetType == PacketType.EXT_INFO) {
                    ...
                    System.out.println("Connecting to AppName " + AppName + " with extension count " + ExtensionCount);
...
<<<<<<< /usr/src/app/output/andrewphorn/classicube-client/13382c090c30a301818952d910b8cddbff481f15/src/main/java/com/mojang/minecraft/Minecraft.java/left.java
                      Constants.SERVER_SUPPORTED_EXTENSIONS
=======
                      com.oyasunadev.mcraft.client.util.Constants.SERVER_SUPPORTED_EXTENSIONS
>>>>>>> /usr/src/app/output/andrewphorn/classicube-client/13382c090c30a301818952d910b8cddbff481f15/src/main/java/com/mojang/minecraft/Minecraft.java/right.java
...
>>>>>>> /usr/src/app/output/andrewphorn/classicube-client/13382c090c30a301818952d910b8cddbff481f15/src/main/java/com/mojang/minecraft/Minecraft.java/right.java
                      .size()) {
                        ...
                        Object[] toSendParams = new Object[] { Constants.CLIENT_NAME, (short) temp.size() };
                        ...
                        for (int k = 0; k < temp.size(); k++) {
                          ...
                          toSendParams = new Object[] { temp.get(k).Name, temp.get(k).Version };
                      ...
                      if (packetType == PacketType.SELECTION_CUBOID) {
                        ...
                        SelectionBoxData data = new SelectionBoxData(ID, Name, new ColorCache(r / 255.0F, g / 255.0F, b / 255.0F, a / 255.0F), new CustomAABB(X1, Y1, Z1, X2, Y2, Z2));
                                      ...
                                      if (packetType == PacketType.EXT_ADD_ENTITY) {
                                        ...
                                        if (packetType == PacketType.EXT_REMOVE_PLAYER_NAME) {
                                          ...
                                          if (packetType == PacketType.CUSTOM_BLOCK_SUPPORT_LEVEL) {
                                            System.out.println("Custom blocks packet received");
                                                        ...
                                                        if (packetType == PacketType.LEVEL_FINALIZE) {
                                                          ...
                                                          if (packetType == PacketType.BLOCK_CHANGE) {
                                                            if (networkManager.minecraft.level != null) {
                                                              networkManager.minecraft.level.netSetTile(((Short) packetParams[0]).shortValue(), ((Short) packetParams[1]).shortValue(), ((Short) packetParams[2]).shortValue(), ((Byte) packetParams[3]).byteValue());
                                                            }
                                                          } else {
                                                            byte var9;
                                                            String var34;
                                                            ...
                                                            if (packetType == PacketType.SPAWN_PLAYER) {
                                                              ...
                                                              if (var5 >= 0) {
                                                                ...
                                                                var33 = new NetworkPlayer(networkManager.minecraft, var34, var36, var47, var10, var9 * 360 / 256.0F, var58 * 360 / 256.0F);
                                                                networkManager.players.put(Byte.valueOf(var5), var33);
                                                                networkManager.minecraft.level.addEntity(var33);
                                                              } else {
                                                                networkManager.minecraft.level.setSpawnPos(var36 / 32, var47 / 32, var10 / 32, var9 * 320 / 256);
                                                                networkManager.minecraft.player.moveTo(var36 / 32.0F, var47 / 32.0F, var10 / 32.0F, var9 * 360 / 256.0F, var58 * 360 / 256.0F);
                                                              }
                                                            } else {
                                                              byte var53;
                                                              ...
                                                              if (packetType == PacketType.POSITION_ROTATION) {
                                                                ...
                                                                if (var5 < 0) {
                                                                  ...
                                                                  if ((networkPlayer = networkManager.players.get(Byte.valueOf(var5))) != null) {
                                                                    networkPlayer.teleport(var38, var36, var47, var53 * 360 / 256.0F, var9 * 360 / 256.0F);
                                                                  }
                                                                }
                                                              } else {
                                                                byte var37;
                                                                ...
                                                                if (packetType == PacketType.POSITION_ROTATION_UPDATE) {
                                                                  ...
                                                                  if (packetType == PacketType.ROTATION_UPDATE) {
                                                                    ...
                                                                    if (packetType == PacketType.POSITION_UPDATE) {
                                                                      ...
                                                                      byte var5 = var10001;
                                                                      NetworkPlayer var59;
                                                                      if (var5 >= 0 && (var59 = networkManager.players.get(Byte.valueOf(var5))) != null) {
                                                                        var59.queue(var37, var44, var49);
                                                                      }
                                                                    } else {
                                                                      if (packetType == PacketType.DESPAWN_PLAYER) {
                                                                        byte var5 = ((Byte) packetParams[0]).byteValue();
                                                                        if (var5 >= 0 && (var33 = networkManager.players.remove(Byte.valueOf(var5))) != null) {
                                                                          var33.clear();
...
<<<<<<< /usr/src/app/output/andrewphorn/classicube-client/13382c090c30a301818952d910b8cddbff481f15/src/main/java/com/mojang/minecraft/Minecraft.java/left.java
                                                                          messageType < 0
=======
                                                                          messageType < 0 || !serverSupportsMessages
>>>>>>> /usr/src/app/output/andrewphorn/classicube-client/13382c090c30a301818952d910b8cddbff481f15/src/main/java/com/mojang/minecraft/Minecraft.java/right.java
                                                                          ) {
                                                                            messageType = -1;
                                                                          } else {
...
>>>>>>> Unknown file: This is a bug in JDime.
        ...
        if (networkManager.levelLoaded) {
          ...
          var20.netHandler.send(PacketType.POSITION_ROTATION, new Object[] { canSendHeldBlock ? player.inventory.getSelected() : Integer.valueOf(-1), Integer.valueOf(var24), Integer.valueOf(var4), Integer.valueOf(var40), Integer.valueOf(var46), Integer.valueOf(var45) });
        }
      }
    }
    if (isLoadingMap) {
  ...
  private void handleInput() {
    if (currentScreen instanceof BlockSelectScreen) {
      ...
      if (currentScreen == null) {
        ...
        if (currentScreen == null) {
          if (Mouse.isButtonDown(MB_LEFT) && ticks - lastClick >= timer.tps / 4.0F && hasMouse) {
            onMouseClick(MB_LEFT);
            lastClick = ticks;
          }
          if (Mouse.isButtonDown(MB_RIGHT) && ticks - lastClick >= timer.tps / 4.0F && hasMouse) {
            onMouseClick(MB_RIGHT);
            lastClick = ticks;
          }
        }
