    ...
    private void onFrame() {
        ...
        try {
            ...
            if (clockTimeSinceLastFrame > 1000L) {
                ...
                timer.adjustment += (clockAdjustmentRatio - timer.adjustment) * 0.20000000298023224;
            ...
            double actualNowSeconds = actualNow / 1000.0;
            ...
            if (!isOnline) {
                ...
                if (!renderer.minecraft.isOnline) {
                    ...
                    if ((renderer.minecraft.level != null) && (player != null)) {
                        ...
                        var29 = 1.0F - ((float) (Math.pow(var29, 0.25)));
                            ...
                            while ((networkHandler.in.position() > 0) && ((var4++) != 100)) {
                                ...
                                if (networkHandler.netManager.successful) {
                                    if (packetType == PacketType.EXT_INFO) {
                                        ...
                                        int dec = (((r & 0xff) << 16) | ((g & 0xff) << 8)) | (b & 0xff);
                                        switch (Variable) {
                                            case 0 :
                                                // sky
                                                level.skyColor = dec;
                                        ...
                                        } else if (disallowedPlacementBlocks.contains(block)) {
                                        ...
                                        } else if (DisallowedBreakingBlocks.contains(block)) {
