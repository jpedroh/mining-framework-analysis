...
public final class Minecraft implements Runnable {
        ...
        if (var5 != null) {
          if (var5.level != null) {
            if (var5.level.creativeMode) {
              LevelIO.save(var5.level, (new FileOutputStream(new File(mcDir, "levelc.dat"))));
            } else {
              LevelIO.save(var5.level, (new FileOutputStream(new File(mcDir, "levels.dat"))));
            }
          }
        }
  ...
  @Override public final void run() {
    ...
    try {
      ...
      if (!isApplet) {
        String s = System.getProperty("os.name").toLowerCase();
        System.setProperty("org.lwjgl.librarypath", mcDir + "/native/" + getOSfolderName(s));
        System.setProperty("net.java.games.input.librarypath", mcDir + "/native/" + getOSfolderName(s));
      }
      if (this.canvas != null) {
            ...
            if (!this.online) {
              ...
              if (!renderer.minecraft.online) {
                ...
                if (renderer.minecraft.level != null) {
                  ...
                  Player var28;
                  float var29 = (var28 = renderer.minecraft.player).xRotO + (var28.xRot - var28.xRotO) * var65;
                  ...
                  List<Entity> var37 = renderer.minecraft.level.blockMap.getEntities(var28, var28.bb.expand(var34 * reachDistance, var33 * reachDistance, var87 * reachDistance));
                  float var35 = 0.0F;
                  ...
                  while (true) {
                    ...
                    ColorCache color = var112.minecraft.level.getBrightnessColor((int) var116.x, (int) var116.y, (int) var116.z);
                ...
                if (renderer.minecraft.notifyScreen != null) {
                  renderer.minecraft.notifyScreen.render(var94, var70);
                }
              ...
              if (var1 == 0) {
                ...
                if ((block == null || block == Block.WATER || block == Block.STATIONARY_WATER || block == Block.LAVA || block == Block.STATIONARY_LAVA) && (aabb == null || (this.player.bb.intersects(aabb) ? false : this.level.isFree(aabb)))) {
                  ...
                  if (!file.exists()) {
                    ...
                    this.notifyScreen = new GuiNotificationScreen("Achievement Get: This is where it all begins!", "Congratulations, you have figured out how to place a block! Good for you :)", 6000);
                    int var21 = this.width * 240 / this.height;
                    int var3 = this.height * 240 / this.height;
                    ((GuiScreen) this.notifyScreen).open(this, var21, var3);
                  }
                  ...
                  if (packetType == PacketType.EXT_INFO) {
                    ...
                    if (packetType == PacketType.EXT_ENTRY) {
                      ...
                      if (recievedExtensionLength == com.oyasunadev.mcraft.client.util.Constants.ServerSupportedExtensions.size()) {
                        ...
                        Object[] toSendParams = new Object[] { AppName, temp.size() };
                      ...
                      if (packetType == PacketType.SELECTION_CUBOID) {
                        ...
                        byte r = ((Byte) packetParams[8]).byteValue();
                        byte g = ((Byte) packetParams[9]).byteValue();
                        byte b = ((Byte) packetParams[10]).byteValue();
                        byte a = ((Byte) packetParams[11]).byteValue();
                        ...
                        if (packetType == PacketType.REMOVE_SELECTION_CUBOID) {
                          ...
                          if (packetType == PacketType.ENV_SET_COLOR) {
                            ...
                            byte r = ((Byte) packetParams[1]).byteValue();
                            byte g = ((Byte) packetParams[2]).byteValue();
                            byte b = ((Byte) packetParams[3]).byteValue();
                                                  ...
                                                  if (packetType == PacketType.BLOCK_CHANGE) {
                                                    ...
                                                    if (packetType == PacketType.SPAWN_PLAYER) {
                                                      ...
                                                      if (var5 >= 0) {
                                                        ...
                                                        var33 = new NetworkPlayer(networkManager.minecraft, var5, var34, var36, var47, var10, var9 * 360 / 256.0F, var58 * 360 / 256.0F);
                                                      ...
                                                      if (packetType == PacketType.POSITION_ROTATION) {
                                                        ...
                                                        if (var5 < 0) {
                                                          ...
                                                          if ((var61 = networkManager.players.get(Byte.valueOf(var5))) != null) {
        ...
        if (Keyboard.getEventKeyState()) {
            ...
            for (int j = 0; j < this.hotKeys.size(); j++) {
              ...
              if (Keyboard.getEventKey() == keyCode) {
                ...
                if (action.endsWith("\n")) {
                  ...
                  this.networkManager.netHandler.send(PacketType.CHAT_MESSAGE, new Object[] { Integer.valueOf(-1), action });
                } else {
          ...
          if (this.currentScreen == null) {
            ...
            if (Keyboard.getEventKey() == Keyboard.KEY_X) {
              if (HackState == com.mojang.minecraft.HackState.HacksTagEnabled || HackState == com.mojang.minecraft.HackState.OpHacks && this.player.userType >= 100) {
                this.player.noPhysics = !this.player.noPhysics;
                this.player.hovered = !this.player.hovered;
              }
            }
            if (Keyboard.getEventKey() == Keyboard.KEY_Z) {
              if (HackState == com.mojang.minecraft.HackState.HacksTagEnabled || HackState == com.mojang.minecraft.HackState.NoHacksTagShown || HackState == com.mojang.minecraft.HackState.OpHacks && this.player.userType >= 100) {
