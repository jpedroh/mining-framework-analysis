...
public final class Minecraft implements Runnable {
  ...
  public static boolean doesUrlExistAndIsImage(String URLName) {
    try {
      ...
      return (con.getResponseCode() == HttpURLConnection.HTTP_OK && con.getContentType().contains("image"));
    } catch (Exception e) {
      e.printStackTrace();
      return false;
    }
  ...
  private void onMouseClick(int var1) {
    if (var1 != 0 || this.blockHitTime <= 0) {
      ...
      int x;
      if (var1 == 1 && (x = this.player.inventory.getSelected()) > 0 && this.gamemode.useItem(this.player, x)) {
        var2 = this.renderer.heldBlock;
          ...
          if (this.selected.entityPos == 1) {
            ...
            if (this.selected.entityPos == 0) {
              ...
              if (var1 == 0) {
                ...
                if (blockID <= 0 || this.disallowedPlacementBlocks.contains(Block.blocks[blockID])) {
                  return;
                }
                AABB aabb = Block.blocks[blockID].getCollisionBox(x, y, z);
                if ((block == null || block == Block.WATER || block == Block.STATIONARY_WATER || block == Block.LAVA || block == Block.STATIONARY_LAVA) && (aabb == null || (this.player.bb.intersects(aabb) ? false : this.level.isFree(aabb)))) {
  ...
  public final void run() {
    ...
    try {
      ...
      if (settings.lastUsedTexturePack != null) {
        File file = new File(getMinecraftDirectory().getAbsolutePath() + "/texturepacks/" + settings.lastUsedTexturePack);
        if (file.exists()) {
          ...
          if (var1.levelName != null) {
            ...
            if (!var1.levelLoaded) {
              ...
              if (gamemode instanceof CreativeGameMode) {
                if ((var11 = var1.levelIo.load((new FileInputStream(new File(mcDir, "levelc.dat"))))) != null) {
                  var1.setLevel(var11);
                }
              } else {
                if (gamemode instanceof SurvivalGameMode) {
                  if ((var11 = var1.levelIo.load((new FileInputStream(new File(mcDir, "levels.dat"))))) != null) {
                    var1.setLevel(var11);
                  }
                }
              }
      ...
      JOptionPane.showMessageDialog((Component) null, var62.toString(), "Failed to start ClassiCube", 0);
      return;
    }
            ...
            if (!this.online) {
              ...
              if (renderer.minecraft.hasMouse) {
                ...
                if (renderer.minecraft.levelLoaded) {
                  if (renderer.minecraft.canvas != null) {
                    Point var90;
                    var70 = (var90 = renderer.minecraft.canvas.getLocationOnScreen()).x + renderer.minecraft.width / 2;
              ...
              if (!renderer.minecraft.online) {
                ...
                if (renderer.minecraft.level != null && player != null) {
                  float var80 = var65;
                  float var29 = player.xRotO + (player.xRot - player.xRotO) * var65;
                  float var30 = player.yRotO + (player.yRot - player.yRotO) * var65;
                  ...
                  if (renderer.minecraft.selected != null) {
                    var74 = renderer.minecraft.selected.vec.distance(renderer.getPlayerVector(var65));
                  }
                  ...
                  for (var81 = 0; var81 < var37.size(); ++var81) {
                    ...
                    if ((var88 = (Entity) var37.get(var81)).isPickable()) {
                      ...
                      if ((var78 = var88.bb.grow(var74, var74, var74).clip(var31, vec3D)) != null && ((var74 = var31.distance(var78.vec)) < var35 || var35 == 0.0F)) {
                        renderer.entity = var88;
                        var35 = var74;
                      }
                    }
                  }
                  if (renderer.entity != null && !(renderer.minecraft.gamemode instanceof CreativeGameMode)) {
                  ...
                  while (true) {
                    ...
                    Block var73;
                    if ((var73 = Block.blocks[var26.getTile((int) player.x, (int) (player.y + 0.12F), (int) player.z)]) != null && var73.getLiquidType() != LiquidType.NOT_LIQUID) {
                      LiquidType var79;
                    ...
                    if (renderer.minecraft.raining || renderer.minecraft.snowing) {
                      ...
                      if (renderer.minecraft.raining) {
                        GL11.glBindTexture(3553, renderer.minecraft.textureManager.load("/rain.png"));
                      } else {
                        if (renderer.minecraft.snowing) {
                          GL11.glBindTexture(3553, renderer.minecraft.textureManager.load("/snow.png"));
                          speed = 0.2F;
                        }
                      }
                    ...
                    if (!isSinglePlayer && this.networkManager != null && this.networkManager.players != null && this.networkManager.players.size() > 0) {
                      if (this.settings.ShowNames == 1 && this.player.userType >= 100) {
                        for (int n = 0; n < this.networkManager.players.values().size(); n++) {
                          NetworkPlayer np = (NetworkPlayer) this.networkManager.players.values().toArray()[n];
                          if (np != null) {
                    ...
                    if (heldBlock.block != null) {
                      ...
                      if (!this.settings.thirdPersonMode && canRenderGUI) {
                        GL11.glBindTexture(3553, heldBlock.minecraft.textureManager.load("/terrain.png"));
                  ...
                  if (this.currentScreen != null || canRenderGUI) {
                    renderer.minecraft.hud.render(var65, renderer.minecraft.currentScreen != null, var94, var70);
                  }
                } else {
                  GL11.glViewport(0, 0, renderer.minecraft.width, renderer.minecraft.height);
  ...
  private void tick() {
    ...
    for (var16 = 0; var16 < texManager.animations.size(); ++var16) {
      ...
      GL11.glTexSubImage2D(3553, 0, texFX.textureId % 16 << 4, texFX.textureId / 16 << 4, 16, 16, 6408, 5121, texManager.textureBuffer);
    }
    int var4;
    int i;
    int var40;
    ...
    if (this.networkManager != null && !(this.currentScreen instanceof ErrorScreen)) {
      if (!this.networkManager.isConnected()) {
                ...
                if (networkHandler.netManager.successful) {
                  if (packetType == PacketType.EXT_INFO) {
                    ...
                    if (packetType == PacketType.EXT_ENTRY) {
                      ...
                      com.oyasunadev.mcraft.client.util.Constants.ServerSupportedExtensions.add(new ExtData(ExtName, Version));
                      if (ExtName.toLowerCase().contains("heldblock")) {
                        this.canSendHeldBlock = true;
                      }
                      if (recievedExtensionLength == com.oyasunadev.mcraft.client.util.Constants.ServerSupportedExtensions.size()) {
                        ...
                        if (packetType == PacketType.REMOVE_SELECTION_CUBOID) {
                          ...
                          if (packetType == PacketType.ENV_SET_COLOR) {
                            ...
                            switch (Variable) {
                              ...
                              break;
                              case 3:
                              this.level.customShadowColour = new ColorCache(r / 255.0F, g / 255.0F, b / 255.0F);
                              break;
                              case 4:
                              this.level.customLightColour = new ColorCache(r / 255.0F, g / 255.0F, b / 255.0F);
                              break;
                            }
                            ...
                            if (packetType == PacketType.ENV_SET_MAP_APPEARANCE) {
                              ...
                              if (sideBlock == -1) {
                                ...
                                if (sideBlock < Block.blocks.length) {
                                  ...
                                  this.textureManager.customSideBlock = textureManager.textureAtlas.get(ID);
                                }
                              }
                              if (edgeBlock == -1) {
                                ...
                                if (edgeBlock < Block.blocks.length) {
                                  ...
                                  this.textureManager.customEdgeBlock = textureManager.textureAtlas.get(ID);
                                }
                              }
                              ...
                              if (packetType == PacketType.CLICK_DISTANCE) {
                                ...
                                if (packetType == PacketType.HOLDTHIS) {
                                  ...
                                  this.player.inventory.replaceSlot(Block.blocks[BlockToHold]);
                                      ...
                                      if (packetType == PacketType.EXT_ADD_ENTITY) {
                                        ...
                                        if (packetType == PacketType.EXT_REMOVE_PLAYER_NAME) {
                                          ...
                                          if (packetType == PacketType.CUSTOM_BLOCK_SUPPORT_LEVEL) {
                                            ...
                                            networkManager.netHandler.send(PacketType.CUSTOM_BLOCK_SUPPORT_LEVEL, com.oyasunadev.mcraft.client.util.Constants.SupportLevel);
                                                    ...
                                                    if (packetType == PacketType.LEVEL_INIT) {
                                                      ...
                                                      if (packetType == PacketType.LEVEL_DATA) {
                                                        ...
                                                        if (packetType == PacketType.LEVEL_FINALIZE) {
                                                          ...
                                                          byte[] decompressedStream = LevelIO.decompress(new ByteArrayInputStream(networkManager.levelData.toByteArray()));
                                                                      ...
                                                                      if (packetType == PacketType.DESPAWN_PLAYER) {
                                                                        ...
                                                                        if (packetType == PacketType.CHAT_MESSAGE) {
                                                                          ...
                                                                          if (var5 < 0) {
                                                                            ...
                                                                            networkManager.players.get(Byte.valueOf(var5));
        ...
        if (this.networkManager.levelLoaded) {
          ...
          var20.netHandler.send(PacketType.POSITION_ROTATION, new Object[] { this.canSendHeldBlock ? player.inventory.selected : Integer.valueOf(-1), Integer.valueOf(var24), Integer.valueOf(var4), Integer.valueOf(var40), Integer.valueOf(var46), Integer.valueOf(var45) });
        }
      }
    }
        ...
        while (Keyboard.next()) {
          ...
          if (Keyboard.getEventKeyState()) {
            ...
            if (this.currentScreen == null) {
              ...
              if (Keyboard.getEventKey() == 53 && this.networkManager != null && this.networkManager.isConnected()) {
                this.player.releaseAllKeys();
              ...
              if (this.settings.HacksEnabled) {
                if (this.settings.HackType == 0) {
                  if (Keyboard.getEventKey() == Keyboard.KEY_X) {
                    if (HackState.Noclip || (HackState.Noclip && this.player.userType >= 100)) {
