            ...
            if (!isSinglePlayer && networkManager != null && networkManager.players != null && networkManager.players.size() > 0) {
              if (settings.ShowNames == 1 && this.player.userType >= 100) {
                ...
                if (renderer.entity != null) {
                  renderer.entity.renderHover(renderer.minecraft.textureManager, delta);
                }
              }
            }
                    ...
                    if (packetType == PacketType.EXT_ENTRY) {
                      ...
                      if (recievedExtensionLength == Constants.SERVER_SUPPORTED_EXTENSIONS.size()) {
                        ...
                        for (int j = 0; j < PacketType.packets.length - 1; j++) {
                          if (PacketType.packets[j] != null && PacketType.packets[j].extName != "") {
                                                          ...
                                                          if (packetType == PacketType.BLOCK_CHANGE) {
                                                            ...
                                                            if (packetType == PacketType.SPAWN_PLAYER) {
                                                              ...
                                                              if (var5 >= 0) {
                                                                ...
                                                                var33 = new NetworkPlayer(networkManager.minecraft, var34, var36, var47, var10, var9 * 360 / 256F, var58 * 360 / 256F);
                                                                ...
                                                                networkManager.minecraft.player.moveTo(var36 / 32F, var47 / 32F, var10 / 32F, var9 * 360 / 256F, var58 * 360 / 256F);
                                                              }
                                                            } else {
                                                              byte var53;
                                                              ...
                                                              if (packetType == PacketType.POSITION_ROTATION) {
                                                                ...
                                                                byte var5 = var10001;
                                                                if (var5 < 0) {
                                                                  networkManager.minecraft.player.moveTo(var38 / 32F, var36 / 32F, var47 / 32F, var53 * 360 / 256F, var9 * 360 / 256F);
                                                                } else {
                                                                  var53 = (byte) (var53 + 128);
                                                                  var36 = (short) (var36 - 22);
                                                                  if ((networkPlayer = networkManager.players.get(Byte.valueOf(var5))) != null) {
                                                                    networkPlayer.teleport(var38, var36, var47, var53 * 360 / 256F, var9 * 360 / 256F);
                                                                  }
                                                                }
                                                              } else {
                                                                byte var37;
                                                                ...
                                                                if (packetType == PacketType.POSITION_ROTATION_UPDATE) {
                                                                  ...
                                                                  if (playerID >= 0) {
                                                                    ...
                                                                    if ((networkPlayer = networkManager.players.get(Byte.valueOf(playerID))) != null) {
                                                                      networkPlayer.queue(var37, var44, var49, var53 * 360 / 256F, var9 * 360 / 256F);
                                                                    }
                                                                  }
                                                                } else {
                                                                  if (packetType == PacketType.ROTATION_UPDATE) {
                                                                    ...
                                                                    if (var5 >= 0) {
                                                                      ...
                                                                      if ((var54 = networkManager.players.get(Byte.valueOf(var5))) != null) {
                                                                        var54.queue(var37 * 360 / 256F, var44 * 360 / 256F);
                                                                      }
                                                                    }
                                                                  } else {
