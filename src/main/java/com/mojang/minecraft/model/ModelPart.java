...
public final class ModelPart {
    ...
    public final void render(float var1) {
        if (render) {
            ...
            if (((pitch == 0.0F) && (yaw == 0.0F)) && (roll == 0.0F)) {
                ...
                GL11.glTranslatef(x * var1, y * var1, z * var1);
                if (roll != 0.0F) {
                    GL11.glRotatef(roll * ((float) (180.0 / Math.PI)), 0.0F, 0.0F, 1.0F);
                }
                if (yaw != 0.0F) {
                    GL11.glRotatef(yaw * ((float) (180.0 / Math.PI)), 0.0F, 1.0F, 0.0F);
                }
                if (pitch != 0.0F) {
                    GL11.glRotatef(pitch * ((float) (180.0 / Math.PI)), 1.0F, 0.0F, 0.0F);
                }
                GL11.glCallList(list);
                GL11.glPopMatrix();
            }
    ...
    public final void setBounds(float var1, float var2, float var3, int var4, int var5, int var6, float var7) {
        ...
        vertices[6] = var21;
        vertices[7] = var14;
        quads[0] = new TexturedQuad(new Vertex[]{ var15, var11, var12, var21 }, (u + var6) + var4, v + var6, ((u + var6) + var4) + var6, (v + var6) + var5);
        quads[1] = new TexturedQuad(new Vertex[]{ var20, var13, var14, var18 }, u, v + var6, u + var6, (v + var6) + var5);
        quads[2] = new TexturedQuad(new Vertex[]{ var15, var13, var20, var11 }, u + var6, v, (u + var6) + var4, v + var6);
        quads[3] = new TexturedQuad(new Vertex[]{ var12, var18, var14, var21 }, (u + var6) + var4, v, ((u + var6) + var4) + var4, v + var6);
        quads[4] = new TexturedQuad(new Vertex[]{ var11, var20, var18, var12 }, u + var6, v + var6, (u + var6) + var4, (v + var6) + var5);
        quads[5] = new TexturedQuad(new Vertex[]{ var13, var15, var21, var14 }, ((u + var6) + var4) + var6, v + var6, (((u + var6) + var4) + var6) + var4, (v + var6) + var5);
        if (mirror) {
