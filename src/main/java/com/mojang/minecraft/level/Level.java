...
public class Level implements Serializable {
      ...
      for (int var6 = var2; var6 < var2 + var4; ++var6) {
        ...
        if (var7 != var8) {
          ...
          for (var8 = 0; var8 < listeners.size(); ++var8) {
            listeners.get(var8).queueChunks(var5 - 1, var9 - 1, var6 - 1, var5 + 1, var7 + 1, var6 + 1);
          }
        }
      }
    }
    ...
    for (int var10 = var2; var10 < var3; ++var10) {
      for (var2 = var4; var2 < var5; ++var2) {
        for (int var8 = var6; var8 < var7; ++var8) {
          Block var9;
          if ((var9 = Block.blocks[getTile(var10, var2, var8)]) != null && var9.getLiquidType() != LiquidType.notLiquid) {
            return true;
          }
        }
      }
  ...
  public boolean containsLiquid(AABB var1, LiquidType var2) {
    ...
    for (int var11 = var3; var11 < var4; ++var11) {
      for (var3 = var5; var3 < var6; ++var3) {
        for (int var9 = var7; var9 < var8; ++var9) {
          Block var10;
          if ((var10 = Block.blocks[getTile(var11, var3, var9)]) != null && var10.getLiquidType() == var2) {
            return true;
          }
        }
      }
    ...
    for (int var12 = var6; var12 < var7; ++var12) {
      for (var13 = var9 - 1; var13 >= var8; --var13) {
        for (int var14 = var10; var14 < var11; ++var14) {
          ...
          int var19;
          if (var12 >= 0 && var13 >= 0 && var14 >= 0 && var12 < width && var13 < height && var14 < length && var15 * var15 + var16 * var16 + var17 * var17 < var5 * var5 && (var19 = getTile(var12, var13, var14)) > 0 && Block.blocks[var19].canExplode()) {
    ...
    for (int var9 = var5 - 6; var9 <= var5 + 6; ++var9) {
      for (int var10 = var6 - 6; var10 <= var6 + 6; ++var10) {
        if (isInBounds(var9, var14, var10) && !isSolidTile(var9, var14, var10)) {
          ...
          float var12;
          float var13;
          for (var13 = (float) (Math.atan2(var12 = var10 + 0.5F - var3, var11) - var4 * (float) Math.PI / 180.0F + 1.5707963705062866D); var13 < -(float) Math.PI; var13 += 6.2831855F) {
            ;
          }
    ...
    for ( ; var3 < var4; ++var3) {
      for (int var9 = var5; var9 < var6; ++var9) {
        for (int var10 = var7; var10 < var8; ++var10) {
          AABB var11;
          if (var3 >= 0 && var9 >= 0 && var10 >= 0 && var3 < width && var9 < height && var10 < length) {
            Block var12;
            if ((var12 = Block.blocks[getTile(var3, var9, var10)]) != null && (var11 = var12.getCollisionBox(var3, var9, var10)) != null && var1.intersectsInner(var11)) {
              var2.add(var11);
            }
          } else {
            if ((var3 < 0 || var9 < 0 || var10 < 0 || var3 >= width || var10 >= length) && (var11 = Block.BEDROCK.getCollisionBox(var3, var9, var10)) != null && var1.intersectsInner(var11)) {
              var2.add(var11);
            }
          }
        }
  ...
  public int getHighestTile(int var1, int var2) {
    int var3;
    for (var3 = height; (getTile(var1, var3 - 1, var2) == 0 || Block.blocks[getTile(var1, var3 - 1, var2)].getLiquidType() != LiquidType.notLiquid) && var3 > 0; --var3) {
      ;
    }
    return var3;
  }
  ...
  public LiquidType getLiquid(int var1, int var2, int var3) {
    int var4;
    return (var4 = getTile(var1, var2, var3)) == 0 ? LiquidType.notLiquid : Block.blocks[var4].getLiquidType();
  }
  ...
  public boolean isLit(int var1, int var2, int var3) {
    return var1 >= 0 && var2 >= 0 && var3 >= 0 && var1 < width && var2 < height && var3 < length ? var2 >= blockers[var1 + var3 * width] : true;
  }

  private boolean isSolid(float var1, float var2, float var3) {
    int var4;
    return (var4 = getTile((int) var1, (int) var2, (int) var3)) > 0 && Block.blocks[var4].isSolid();
  }
  ...
  public boolean isWater(int var1, int var2, int var3) {
    int var4;
    return (var4 = getTile(var1, var2, var3)) > 0 && Block.blocks[var4].getLiquidType() == LiquidType.water;
  }
  ...
  public boolean maybeGrowTree(int var1, int var2, int var3) {
    ...
    for (var6 = var2; var6 <= var2 + 1 + var4; ++var6) {
      ...
      for (var8 = var1 - var7; var8 <= var1 + var7 && var5; ++var8) {
        for (var9 = var3 - var7; var9 <= var3 + var7 && var5; ++var9) {
          if (var8 >= 0 && var6 >= 0 && var9 >= 0 && var8 < width && var6 < height && var9 < length) {
    ...
    if (!var5) {
      ...
      if ((blocks[((var2 - 1) * length + var3) * width + var1] & 255) == Block.GRASS.id && var2 < height - var4 - 1) {
  ...
  public boolean netSetTileNoNeighborChange(int var1, int var2, int var3, int var4) {
    if (var1 >= 0 && var2 >= 0 && var3 >= 0 && var1 < width && var2 < height && var3 < length) {
      if (var4 == blocks[(var2 * length + var3) * width + var1]) {
        ...
        if (var4 == 0 && (var1 == 0 || var3 == 0 || var1 == width - 1 || var3 == length - 1) && var2 >= getGroundLevel() && var2 < getWaterLevel() && !networkMode) {
          var4 = Block.WATER.id;
        }
        ...
        for (var4 = 0; var4 < listeners.size(); ++var4) {
          listeners.get(var4).queueChunks(var1 - 1, var2 - 1, var3 - 1, var1 + 1, var2 + 1, var3 + 1);
        }
        return true;
      }
    } else {
  ...
  public boolean setTile(int var1, int var2, int var3, int var4) {
    if (networkMode) {
      ...
      if (setTileNoNeighborChange(var1, var2, var3, var4)) {
        updateNeighborsAt(var1, var2, var3, var4);
        return true;
      } else {
        return false;
    ...
    if (tickCount % 5 == 0) {
      ...
      for (var7 = 0; var7 < var6; ++var7) {
        ...
        if ((var8 = tickList.remove(0)).ticks > 0) {
          ...
          byte var9;
          if (isInBounds(var8.x, var8.y, var8.z) && (var9 = blocks[(var8.y * length + var8.z) * width + var8.x]) == var8.block && var9 > 0) {
