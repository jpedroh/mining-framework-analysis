...
public final class NetworkHandler {
  ...
  @SuppressWarnings(value = { "rawtypes" }) public Object readObject(Class obj) {
    if (!connected) {
      return null;
    } else {
      try {
  ...
  @SuppressWarnings(value = { "rawtypes" }) public final void send(PacketType packetType, Object... obj) {
    if (connected) {
