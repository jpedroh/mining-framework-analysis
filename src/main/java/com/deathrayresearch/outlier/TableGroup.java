...
public class TableGroup {
  ...
  public Table apply(ToDoubleFunction<FloatColumn> fun, String calcColumn, String resultColumnName) {
  ...
  public Table apply(ToIntFunction<IntColumn> fun, String calcColumn, String resultColumnName) {
