...
public class KinesisClientLibConfiguration {
  ...
  private void checkIsCloudWatchMetricsFactoryNameValid(String cloudWatchMetricsFactoryName) {
    if ("CWMetricsFactory".equals(cloudWatchMetricsFactoryName) || "NullMetricsFactory".equals(cloudWatchMetricsFactoryName) || "LogMetricsFactory".equals(cloudWatchMetricsFactoryName)) {
      return;
    }
