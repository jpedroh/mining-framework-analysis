...
public class Utils {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public static Map<String, ?> toSoyCompatibleMap(Object obj) {
  ...
  private static Object toSoyCompatibleObjects(Object obj) {
    ...
    if (obj instanceof Map) {
      @SuppressWarnings(value = { "unchecked" }) Map<String, Object> map = (Map<String, Object>) obj;
    ...
    {
      @SuppressWarnings(value = { "unchecked" }) Map<String, Object> pojoMap = (Map<String, Object>) pojoToMap(obj);
  ...
  public static Map<String, ?> pojoToMap(Object pojo) {
    ...
    for (Method method : pojo.getClass().getDeclaredMethods()) {
      if (Modifier.isPublic(method.getModifiers()) && method.getParameterTypes().length == 0 && method.getReturnType() != void.class && method.getName().matches("^(get|is).+")) {
