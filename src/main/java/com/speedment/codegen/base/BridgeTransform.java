 ...
 */
public class BridgeTransform<A extends java.lang.Object, B extends java.lang.Object> implements Transform<A, B> {
  ...
  /**
     ...
     *              returned empty
     */
  @Override public Optional<B> transform(Generator gen, A model) {
    Object o = model;
    for (final Transform<?, ?> step : steps) {
      if (o == null) {
        return Optional.empty();
      } else {
        @SuppressWarnings(value = { "unchecked" }) final Transform<Object, ?> step2 = (Transform<Object, ?>) step;
        o = gen.transform(step2, o, factory).map((m) -> m.getResult()).orElse(null);
      }
    }
    if (o == null) {
      return Optional.empty();
      ...
      if (to.isAssignableFrom(o.getClass())) {
        @SuppressWarnings(value = { "unchecked" }) final B result = (B) o;
        return Optional.of(result);
      } else {
        throw new IllegalStateException("The bridge between \'" + from.getSimpleName() + "\' to \'" + to.getSimpleName() + "\' is not complete.");
      }
    }
  }

  private <A2 extends java.lang.Object, B2 extends java.lang.Object> boolean addStep(Class<A2> from, Class<B2> to, Transform<A2, B2> step) {
  ...
  /**
     ...
     */
  public static <A extends java.lang.Object, B extends java.lang.Object, T extends Transform<A, B>> Stream<T> create(TransformFactory factory, Class<A> from, Class<B> to) {
  ...
  /**
     ...
     * @return        a <code>Stream</code> of all unique paths between A and B
     */
  private static <A extends java.lang.Object, B extends java.lang.Object, T extends Transform<A, B>> Stream<T> create(TransformFactory factory, BridgeTransform<A, B> bridge) {
    if (bridge.end.equals(bridge.to)) {
      @SuppressWarnings(value = { "unchecked" }) final T result = (T) bridge;
      ...
      factory.allFrom(bridge.end).stream().forEachOrdered((e) -> {
        ...
        @SuppressWarnings(value = { "unchecked" }) Class<Object> a = (Class<Object>) bridge.end;
        @SuppressWarnings(value = { "unchecked" }) Class<Object> b = (Class<Object>) e.getKey();
        @SuppressWarnings(value = { "unchecked" }) Transform<Object, Object> transform = (Transform<Object, Object>) e.getValue();
  ...
  /**
     ...
     */
  @Override public boolean is(Class<? extends Transform<?, ?>> transformer) {
