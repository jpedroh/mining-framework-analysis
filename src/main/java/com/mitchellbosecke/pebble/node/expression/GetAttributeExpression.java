...
public class GetAttributeExpression implements Expression<Object> {
    ...
    private Object getObjectFromMap(Map<?, ?> object, Object attributeNameValue) {
        ...
        if ((attributeNameValue != null) && java.lang.Number.class.isAssignableFrom(attributeNameValue.getClass())) {
    ...
    private Object cast(Number number, Class<?> desiredType) {
        if (desiredType == java.lang.Long.class) {
            return number.longValue();
        } else if (desiredType == java.lang.Integer.class) {
            return number.intValue();
        } else if (desiredType == java.lang.Double.class) {
            return number.doubleValue();
        } else if (desiredType == java.lang.Float.class) {
            return number.floatValue();
        } else if (desiredType == java.lang.Short.class) {
            return number.shortValue();
        } else if (desiredType == java.lang.Byte.class) {
