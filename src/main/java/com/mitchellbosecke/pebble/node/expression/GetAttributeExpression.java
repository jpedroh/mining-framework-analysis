...
public class GetAttributeExpression implements Expression<Object> {
  ...
  @Override public Object evaluate(PebbleTemplateImpl self, EvaluationContext context) throws PebbleException {
      ...
      if (args == null) {
        ...
        try {
          ...
          if (object instanceof List) {
            Integer key = Integer.valueOf(attributeName);
            @SuppressWarnings(value = { "unchecked" }) List<Object> list = (List<Object>) object;
            return list.get(key);
          }
    ...
    if (object != null && member != null) {
      ...
      if (context.isStrictVariables()) {
        if (object == null) {
          ...
          throw new RootAttributeNotFoundException(null, String.format("Root attribute [%s] does not exist or can not be accessed and strict variables is set to true.", rootPropertyName), rootPropertyName);
        } else {
          throw new AttributeNotFoundException(null, String.format("Attribute [%s] of [%s] does not exist or can not be accessed and strict variables is set to true.", attributeName, object.getClass().getName()), attributeName);
        }
      }
    }
    return result;
