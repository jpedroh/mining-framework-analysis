...
public class ContainsExpression extends BinaryExpression<Boolean> {
  @SuppressWarnings(value = { "rawtypes", "unchecked" }) @Override public Boolean evaluate(PebbleTemplateImpl self, EvaluationContextImpl context) {
      ...
      if (leftValue instanceof Map) {
        ...
        if (leftValue.getClass().isArray()) {
          ...
          if (leftValue instanceof String) {
            ...
            throw new PebbleException(null, "Contains operator can only be used on Collections, Maps and arrays. Actual type was: " + leftValue.getClass().getName(), this.getLineNumber(), self.getName());
          }
        }
      }
    }
