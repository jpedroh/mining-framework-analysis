...
public class BlockNode extends AbstractRenderableNode {
  ...
  @Override public void render(final PebbleTemplateImpl self, Writer writer, EvaluationContextImpl context) throws IOException {
  ...
  public Block getBlock() {
    return new Block() {
      ...
      @Override public void evaluate(PebbleTemplateImpl self, Writer writer, EvaluationContextImpl context) throws IOException {
