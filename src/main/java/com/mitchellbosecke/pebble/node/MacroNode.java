...
public class MacroNode extends AbstractRenderableNode {
  ...
  @Override public void render(PebbleTemplateImpl self, Writer writer, EvaluationContextImpl context) {
  }
  ...
  public Macro getMacro() {
    return new Macro() {
      ...
      @Override public String call(PebbleTemplateImpl self, EvaluationContextImpl context, Map<String, Object> macroArgs) {
