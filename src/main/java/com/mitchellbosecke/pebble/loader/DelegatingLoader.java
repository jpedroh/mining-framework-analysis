...
public class DelegatingLoader implements Loader<DelegatingLoaderCacheKey> {
  ...
  @Override public Reader getReader(String templateName) {
    Reader reader = null;
  ...
  private <T extends java.lang.Object> Reader getReaderInner(Loader<T> delegatingLoader, String templateName) {
  ...
  @Override public String resolveRelativePath(String relativePath, String anchorPath) {
  ...
  @Override public DelegatingLoaderCacheKey createCacheKey(String templateName) {
