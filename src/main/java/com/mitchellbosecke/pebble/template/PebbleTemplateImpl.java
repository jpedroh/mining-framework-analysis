...
public class PebbleTemplateImpl implements PebbleTemplate {
  ...
  private EvaluationContextImpl initContext(Locale locale) {
    ...
    EvaluationContextImpl context = new EvaluationContextImpl(this, engine.isStrictVariables(), locale, engine.getExtensionRegistry(), engine.getTagCache(), engine.getExecutorService(), new ArrayList<PebbleTemplateImpl>(), scopeChain, null);
    return context;
  }
  ...
  /**
     ...
     */
  public void includeTemplate(Writer writer, EvaluationContextImpl context, String name, Map<?, ?> additionalVariables) throws PebbleException, IOException {
  ...
  /**
     ...
     * @throws IOException     Thrown from the writer object
     */
  public void block(Writer writer, EvaluationContextImpl context, String blockName, boolean ignoreOverriden) throws PebbleException, IOException {
  ...
  /**
     ...
     */
  public SafeString macro(EvaluationContextImpl context, String macroName, ArgumentsNode args, boolean ignoreOverriden) throws PebbleException {
  ...
  public void setParent(EvaluationContextImpl context, String parentName) throws PebbleException {
    context.getHierarchy().pushAncestor((PebbleTemplateImpl) engine.getTemplate(this.resolveRelativePath(parentName)));
  }
