...
public class PebbleTemplateImpl implements PebbleTemplate {
    ...
    private EvaluationContextImpl initContext(Locale locale) {
        ...
        EvaluationContextImpl context = new EvaluationContextImpl(this, this.engine.isStrictVariables(), locale, this.engine.getExtensionRegistry(), this.engine.getTagCache(), this.engine.getExecutorService(), new ArrayList<PebbleTemplateImpl>(), scopeChain, null);
        return context;
    }
     ...
     */
    public SafeString macro(EvaluationContextImpl context, String macroName, ArgumentsNode args, boolean ignoreOverriden, int lineNumber) throws PebbleException {
