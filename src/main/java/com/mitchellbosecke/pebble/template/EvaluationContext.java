...
<<<<<<< /usr/src/app/output/mbosecke/pebble/edcb7368e0c64c3268f102f7be46f122f067a45c/src/main/java/com/mitchellbosecke/pebble/template/EvaluationContext.java/left.java
/**
...
public class EvaluationContext {
  ...
  /**
     ...
     */
  public EvaluationContext(PebbleTemplateImpl self, boolean strictVariables, Locale locale, ExtensionRegistry extensionRegistry, Cache<CacheKey, Object> tagCache, ExecutorService executorService, List<PebbleTemplateImpl> importedTemplates, ScopeChain scopeChain, Hierarchy hierarchy) {
    if (hierarchy == null) {
  ...
  public EvaluationContext shallowCopyWithoutInheritanceChain(PebbleTemplateImpl self) {
    EvaluationContext result = new EvaluationContext(self, strictVariables, locale, extensionRegistry, tagCache, executorService, importedTemplates, scopeChain, null);
    return result;
  }
  ...
  public EvaluationContext threadSafeCopy(PebbleTemplateImpl self) {
    EvaluationContext result = new EvaluationContext(self, strictVariables, locale, extensionRegistry, tagCache, executorService, new ArrayList<>(importedTemplates), scopeChain.deepCopy(), hierarchy);
    return result;
  }
...
>>>>>>> /usr/src/app/output/mbosecke/pebble/edcb7368e0c64c3268f102f7be46f122f067a45c/src/main/java/com/mitchellbosecke/pebble/template/EvaluationContext.java/right.java
