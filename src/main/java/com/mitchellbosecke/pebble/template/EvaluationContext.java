...
public class EvaluationContext {
  ...
  /**
     ...
     */
  public EvaluationContext(PebbleTemplateImpl self, boolean strictVariables, Locale locale, ExtensionRegistry extensionRegistry, Cache<BaseTagCacheKey, Object> tagCache, ExecutorService executorService, List<PebbleTemplateImpl> importedTemplates, ScopeChain scopeChain, Hierarchy hierarchy) {
    if (hierarchy == null) {
  ...
  public EvaluationContext shallowCopyWithNewScopeChain(PebbleTemplateImpl self) {
    EvaluationContext result = new EvaluationContext(self, strictVariables, locale, extensionRegistry, tagCache, executorService, importedTemplates, scopeChain.deepCopy(), hierarchy);
    return result;
  }
