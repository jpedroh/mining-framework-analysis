...
public class OperatorUtils {
  ...
  public static boolean equals(Object op1, Object op2) {
    if (op1 != null && op1 instanceof Number && op2 != null && op2 instanceof Number) {
      ...
      if (op1 != null && op1 instanceof Enum<?> && op2 != null && op2 instanceof String) {
        return compareEnum((Enum<?>) op1, (String) op2);
      } else {
        if (op2 != null && op2 instanceof Enum<?> && op1 != null && op1 instanceof String) {
  ...
  /**
     ...
     * @return
     */
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) private static Object addToList(List<?> op1, Object op2) {
  ...
  /**
     ...
     * @return
     */
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) private static Object subtractFromList(List<?> op1, Object op2) {
    if (op2 instanceof Collection) {
  ...
  private static Object wideningConversionBinaryOperation(Object op1, Object op2, Operation operation) {
    ...
    if (num1 instanceof BigDecimal || num2 instanceof BigDecimal) {
      return bigDecimalOperation(BigDecimal.valueOf(num1.doubleValue()), BigDecimal.valueOf(num2.doubleValue()), operation);
    }
  ...
  private static Object evaluateAsNumber(Object op) {
    ...
    if (op != null && op instanceof String) {
      try {
        ...
        throw new IllegalArgumentException(String.format("invalid operands for mathematical comparison [%s]", op));
      }
    }
    return result;
  }
