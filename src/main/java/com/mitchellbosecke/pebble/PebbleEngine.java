...
public class PebbleEngine {
  ...
  private PebbleTemplate getPebbleTemplate(final PebbleEngine self, final String templateName, final Object cacheKey) {
    ...
    Parser parser = new ParserImpl(this.extensionRegistry.getUnaryOperators(), this.extensionRegistry.getBinaryOperators(), this.extensionRegistry.getTokenParsers(), this.parserOptions);
  ...
  public static class Builder {
    ...
    public PebbleEngine build() {
      ...
      return new PebbleEngine(this.loader, this.syntax, this.strictVariables, this.defaultLocale, this.tagCache, this.templateCache, this.executorService, extensions, parserOptions, evaluationOptions);
    }
  }
