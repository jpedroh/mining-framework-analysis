...
public class SyndFeedImpl implements Serializable, SyndFeed {
  ...
  /**
     ...
     */
  @Override public List<String> getSupportedFeedTypes() {
  ...
  /**
     ...
     * 
     */
  @Override public WireFeed createWireFeed() {
  ...
  /**
     ...
     * 
     */
  @Override public WireFeed createWireFeed(final String feedType) {
    if (feedType == null) {
  ...
  /**
     ...
     * 
     */
  @Override public WireFeed originalWireFeed() {
    return wireFeed;
  }
  ...
  /**
     ...
     * 
     */
  @Override public String getFeedType() {
    return feedType;
  }
  ...
  /**
     ...
     * 
     */
  @Override public void setFeedType(final String feedType) {
  ...
  /**
     ...
     * 
     */
  @Override public SyndContent getDescriptionEx() {
    return description;
  }
  ...
  /**
     ...
     * 
     */
  @Override public void setDescriptionEx(final SyndContent description) {
  ...
  /**
     ...
     * 
     */
  @Override public void setCopyright(final String copyright) {
  ...
  /**
     ...
     * 
     */
  @Override public SyndImage getImage() {
    return image;
  }
  ...
  /**
     ...
     * 
     */
  @Override public void setImage(final SyndImage image) {
    this.image = image;
  }
  ...
  /**
     ...
     * 
     */
  @Override public void setEntries(final List<SyndEntry> entries) {
  ...
  @Override public Class<SyndFeed> getInterface() {
    return SyndFeed.class;
  }

  @Override public void copyFrom(final CopyFrom<SyndFeed> obj) {
  ...
  @Override public boolean isPreservingWireFeed() {
