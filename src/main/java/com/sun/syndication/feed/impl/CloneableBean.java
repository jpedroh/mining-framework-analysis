...
>>>>>>> /usr/src/app/output/rometools/rome/648a1f04cf5a4c55a13bfff801389cfe93c6976e/src/main/java/com/sun/syndication/feed/impl/CloneableBean.java/right.java
    ...
    try {
      ...
      if (pds != null) {
        for (int i = 0; i < pds.length; i++) {
          ...
          if (pReadMethod != null && pWriteMethod != null && !ignoreProperties.contains(pds[i].getName()) && pReadMethod.getDeclaringClass() != Object.class && pReadMethod.getParameterTypes().length == 0) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private <T extends Object> T doClone(T value) throws Exception {
    if (value != null) {
  ...
  private <T extends java.lang.Object> T[] cloneArray(final T[] array) throws Exception {
    final Class<?> elementClass = array.getClass().getComponentType();
    final int length = Array.getLength(array);
    @SuppressWarnings(value = { "unchecked" }) final T[] newArray = (T[]) Array.newInstance(elementClass, length);
  ...
  private <T extends java.lang.Object> Collection<T> cloneCollection(final Collection<T> collection) throws Exception {
    @SuppressWarnings(value = { "unchecked" }) final Class<Collection<T>> mClass = (Class<Collection<T>>) collection.getClass();
  ...
  private <S extends java.lang.Object, T extends java.lang.Object> Map<S, T> cloneMap(final Map<S, T> map) throws Exception {
    @SuppressWarnings(value = { "unchecked" }) final Class<Map<S, T>> mClass = (Class<Map<S, T>>) map.getClass();
