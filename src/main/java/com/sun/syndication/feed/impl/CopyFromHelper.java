...
public class CopyFromHelper {
    ...
    try {
      ...
      if (pds != null) {
        for (final PropertyDescriptor pd : pds) {
          ...
          if (pReadMethod != null && pWriteMethod != null && pReadMethod.getDeclaringClass() != Object.class && pReadMethod.getParameterTypes().length == 0 && baseInterfaceMap.containsKey(propertyName)) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private <T extends java.lang.Object> T doCopy(T value, final Class<?> baseInterface) throws Exception {
    if (value != null) {
...
>>>>>>> /usr/src/app/output/rometools/rome/648a1f04cf5a4c55a13bfff801389cfe93c6976e/src/main/java/com/sun/syndication/feed/impl/CopyFromHelper.java/right.java
  ...
  private <T extends java.lang.Object> T[] doCopyArray(final T[] array, final Class<?> baseInterface) throws Exception {
  ...
  private <T extends java.lang.Object> Collection<T> doCopyCollection(final Collection<T> collection, final Class<?> baseInterface) throws Exception {
...
>>>>>>> /usr/src/app/output/rometools/rome/648a1f04cf5a4c55a13bfff801389cfe93c6976e/src/main/java/com/sun/syndication/feed/impl/CopyFromHelper.java/right.java
  ...
  private <S extends java.lang.Object, T extends java.lang.Object> Map<S, T> doCopyMap(final Map<S, T> map, final Class<?> baseInterface) throws Exception {
