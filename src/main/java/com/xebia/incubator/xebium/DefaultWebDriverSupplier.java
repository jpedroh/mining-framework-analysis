        ...
        if ("chrome".equalsIgnoreCase(browser)) {
          ...
          if ("safari".equalsIgnoreCase(browser)) {
            ...
            if ("htmlUnit".equalsIgnoreCase(browser)) {
              ...
              if ("htmlUnit+js".equalsIgnoreCase(browser)) {
                driver = new HtmlUnitDriver(true);
              } else {
                if ("opera".equalsIgnoreCase(browser)) {
                  driver = new OperaDriver();
                } else {
                  if ("opera-mobile-tablet".equalsIgnoreCase(browser)) {
                    ...
                    if ("opera-mobile-phone".equalsIgnoreCase(browser)) {
                      DesiredCapabilities capabilities = DesiredCapabilities.opera();
                      capabilities.setCapability("opera.product", OperaProduct.MOBILE);
                      ...
                      if ("phantomjs".equalsIgnoreCase(browser)) {
                        ...
                        try {
                          ...
                          throw new RuntimeException("Unknown browser type. Should be one of \'firefox\', \'iexplore\', \'chrome\', " + "\'opera\', \'opera-mobile-tablet\', \'opera-mobile-phone\', \'htmlUnit\' or \'htmlUnit+js\'", e);
                        }
                      }
                    }
                  }
