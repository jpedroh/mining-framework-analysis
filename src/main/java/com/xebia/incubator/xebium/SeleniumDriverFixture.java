...
public class SeleniumDriverFixture {
  ...
  private AddMissingSeleneseCommands addcommands = new AddMissingSeleneseCommands();
...
<<<<<<< /usr/src/app/output/xebia/xebium/cbfab438393258e91f8f54b6020f3fd8c8c4cc9f/src/main/java/com/xebia/incubator/xebium/SeleniumDriverFixture.java/left.java
  private void addMissingSeleneseCommands(WebDriverCommandProcessor driver) {
    ...
    if (driver.getWrappedDriver().toString().toLowerCase().contains("chrome")) {
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  public WebDriver getWebDriver() {
    return commandProcessor instanceof WebDriverCommandProcessor ? ((WebDriverCommandProcessor) commandProcessor).getWrappedDriver() : null;
  }
