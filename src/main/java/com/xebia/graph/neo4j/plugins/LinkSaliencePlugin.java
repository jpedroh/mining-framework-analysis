...
public class LinkSaliencePlugin extends ServerPlugin {
	...
	public void computeLinkSalience(@Source
	GraphDatabaseService graphDb, @Description("Name of the relationship property representing edge weight.")
	@Parameter(name = "weightProperty")
	String weightProperty, @Description("Indicates whether the graph should be treated as a directed graph. " + "False means edge direction is ignored in computing shortest paths.")
	@Parameter(name = "directed")
	Boolean treatGraphAsDirected) {
