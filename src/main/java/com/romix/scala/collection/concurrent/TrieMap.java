 ...
 * @param <V>
 */
@SuppressWarnings(value = { "unchecked", "rawtypes", "unused" }) public class TrieMap<K extends java.lang.Object, V extends java.lang.Object> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
  ...
  private static class Equiv<K extends java.lang.Object> {
  ...
  private static interface Hashing<K extends java.lang.Object> {
    public int hash(K k);
  }
