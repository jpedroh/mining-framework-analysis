 ...
 * @param <V>
 */
@SuppressWarnings(value = { "unchecked", "rawtypes", "unused" }) public class TrieMap<K extends java.lang.Object, V extends java.lang.Object> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
  ...
  public static <K extends java.lang.Object, V extends java.lang.Object> TrieMap<K, V> empty() {
    return new TrieMap<K, V>();
  }

  static class INode<K extends java.lang.Object, V extends java.lang.Object> extends INodeBase<K, V> {
    static final Object KEY_PRESENT = new Object();

    static final Object KEY_ABSENT = new Object();

    static <K extends java.lang.Object, V extends java.lang.Object> INode<K, V> newRootNode() {
      Gen gen = new Gen();
      ...
      while (true) {
        ...
        if (m instanceof CNode) {
          ...
          if ((bmp & flag) != 0) {
            ...
            if (cond == null || cond == INode.KEY_ABSENT) {
              CNode<K, V> rn = (cn.gen == gen) ? cn : cn.renewed(gen, ct);
  ...
  private static final class FailedNode<K extends java.lang.Object, V extends java.lang.Object> extends MainNode<K, V> {
    MainNode<K, V> p;
  ...
  private interface KVNode<K extends java.lang.Object, V extends java.lang.Object> {
    Map.Entry<K, V> kvPair();
  }

  private static final class SNode<K extends java.lang.Object, V extends java.lang.Object> extends BasicNode implements KVNode<K, V> {
    final K k;
  ...
  private static final class TNode<K extends java.lang.Object, V extends java.lang.Object> extends MainNode<K, V> implements KVNode<K, V> {
    final K k;
  ...
  private final static class LNode<K extends java.lang.Object, V extends java.lang.Object> extends MainNode<K, V> {
  ...
  private static final class CNode<K extends java.lang.Object, V extends java.lang.Object> extends CNodeBase<K, V> {
    final int bitmap;
    ...
    static <K extends java.lang.Object, V extends java.lang.Object> MainNode<K, V> dual(final SNode<K, V> x, int xhc, final SNode<K, V> y, int yhc, int lev, Gen gen) {
      if (lev < 35) {
  ...
  private static class RDCSS_Descriptor<K extends java.lang.Object, V extends java.lang.Object> {
    INode<K, V> old;
  ...
  private static class Equiv<K extends java.lang.Object> implements Serializable {
    private static final long serialVersionUID = 1L;
  ...
  private static interface Hashing<K extends java.lang.Object> extends Serializable {
    public int hash(K k);
  }

  static class Default<K extends java.lang.Object> implements Hashing<K> {
    private static final long serialVersionUID = 1L;
  ...
  @Override final public V put(Object key, Object value) {
    ensureReadWrite();
    int hc = computeHash((K) key);
  ...
  @Override final public V remove(Object k) {
    ensureReadWrite();
  ...
  @Override final public V putIfAbsent(Object k, Object v) {
    ensureReadWrite();
    int hc = computeHash((K) k);
  ...
  @Override public boolean replace(K k, V oldvalue, V newvalue) {
    ensureReadWrite();
    int hc = computeHash(k);
  ...
  @Override public V replace(Object k, Object v) {
    ensureReadWrite();
    int hc = computeHash((K) k);
  ...
  private static class TrieMapReadOnlyIterator<K extends java.lang.Object, V extends java.lang.Object> extends TrieMapIterator<K, V> {
  ...
  private static class TrieMapIterator<K extends java.lang.Object, V extends java.lang.Object> implements java.util.Iterator<Map.Entry<K, V>> {
    private int level;
