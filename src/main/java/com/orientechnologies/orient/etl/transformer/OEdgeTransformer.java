...
>>>>>>> /usr/src/app/output/orientechnologies/orientdb-etl/889e65b57d07559f507bcef0e966f6f0612ae9dd/src/main/java/com/orientechnologies/orient/etl/transformer/OEdgeTransformer.java/right.java
     + "{unresolvedVertexAction:{optional:true,description:\'action when a unresolved vertices is found\',values:" + stringArray2Json(ACTION.values()) + "}}]," + "input:[\'ODocument\',\'OrientVertex\'],output:\'OrientVertex\'}");
  }

  @Override public void configure(OETLProcessor iProcessor, final ODocument iConfiguration, final OCommandContext iContext) {
