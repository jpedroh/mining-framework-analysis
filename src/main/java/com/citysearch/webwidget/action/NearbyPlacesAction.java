...
public class NearbyPlacesAction extends AbstractCitySearchAction implements ModelDriven<NearbyPlacesRequest> {
    ...
    public String execute() throws CitysearchException {
        ...
        try {
            ...
            if ((nearbyPlacesResponse.getNearbyPlaces() != null) && (!nearbyPlacesResponse.getNearbyPlaces().isEmpty())) {
                ...
                for (NearbyPlace alb : nearbyPlacesResponse.getNearbyPlaces()) {
                    ...
                    if ((callBackUrl != null) && (callBackUrl.trim().length() > 0)) {
                        ...
                        listingUrl = getTrackingUrl(callBackUrl, "http://ad.doubleclick.net/clk;225291110;48835962;h?", alb.getListingId(), nearbyPlacesRequest.getPublisher(), nearbyPlacesRequest.getAdUnitName(), nearbyPlacesRequest.getAdUnitSize());
                    } else {
                        listingUrl = getTrackingUrl(alb.getAdDisplayURL(), "http://ad.doubleclick.net/clk;225291110;48835962;h?", alb.getListingId(), nearbyPlacesRequest.getPublisher(), nearbyPlacesRequest.getAdUnitName(), nearbyPlacesRequest.getAdUnitSize());
                    }
    ...
    private String getTrackingUrl(String adDisplayURL, String dartTrackingUrl, String listingId, String publisher, String adUnitName, String adUnitSize) throws CitysearchException {
        try {
