...
public class Config extends AutoUpdateConfigLoader {
  ...
  @Override protected boolean validateKeys() {
  ...
  @Override protected void loadKeys() {
  }
  ...
  public boolean getHardcoreStatLossEnabled(SkillType skillType) {
    return config.getBoolean("Hardcore.Death_Stat_Loss.Enabled." + StringUtils.getCapitalized(skillType.toString()), false);
  }

  public void setHardcoreStatLossEnabled(SkillType skillType, boolean enabled) {
    config.set("Hardcore.Death_Stat_Loss.Enabled." + StringUtils.getCapitalized(skillType.toString()), enabled);
  }
  ...
  public boolean getHardcoreVampirismEnabled(SkillType skillType) {
    return config.getBoolean("Hardcore.Vampirism.Enabled." + StringUtils.getCapitalized(skillType.toString()), false);
  }

  public void setHardcoreVampirismEnabled(SkillType skillType, boolean enabled) {
    config.set("Hardcore.Vampirism.Enabled." + StringUtils.getCapitalized(skillType.toString()), enabled);
  }
  ...
  public boolean getFluxPickaxeEnabled() {
    return config.getBoolean("Items.Flux_Pickaxe.Enabled", true);
  }
...
<<<<<<< /usr/src/app/output/mcmmo-dev/mcmmo/d4bd886522cc786603bfbfeca927401c27335458/src/main/java/com/gmail/nossr50/config/Config.java/left.java
  BlockData
=======
  Material
>>>>>>> /usr/src/app/output/mcmmo-dev/mcmmo/d4bd886522cc786603bfbfeca927401c27335458/src/main/java/com/gmail/nossr50/config/Config.java/right.java
   material) {
    return config.getBoolean("Double_Drops.Woodcutting." + StringUtils.
<<<<<<< /usr/src/app/output/mcmmo-dev/mcmmo/d4bd886522cc786603bfbfeca927401c27335458/src/main/java/com/gmail/nossr50/config/Config.java/left.java
    getFriendlyConfigBlockDataString(material)
=======
    getPrettyItemString(material).replace(" ", "_")
>>>>>>> /usr/src/app/output/mcmmo-dev/mcmmo/d4bd886522cc786603bfbfeca927401c27335458/src/main/java/com/gmail/nossr50/config/Config.java/right.java
    );
  }
