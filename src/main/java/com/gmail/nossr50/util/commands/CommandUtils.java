...
<<<<<<< /usr/src/app/output/mcmmo-dev/mcmmo/31e80149c2f2f340732d081b7209b49424b13b02/src/main/java/com/gmail/nossr50/util/commands/CommandUtils.java/left.java
        "[McMMO] Player data file with UIID " + offlinePlayer.getUniqueId() + " is missing a player name. This may be a legacy file from before bukkit.lastKnownName. This should be okay to ignore."
=======
        "[McMMO] Bad player data file with UIID " + offlinePlayer.getUniqueId()
