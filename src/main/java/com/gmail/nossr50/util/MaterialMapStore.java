...
public class MaterialMapStore {
  ...
  private void fillIntendedTools() {
    ...
    intendedToolPickAxe.add("element_constructor");
    intendedToolPickAxe.add("compound_creator");
    intendedToolPickAxe.add("material_reducer");
    ...
    intendedToolPickAxe.add("heat_block");
    ...
    intendedToolPickAxe.add("glowing_obsidian");
  ...
  private void fillAbilityBlackList() {
    ...
    abilityBlackList.add("wall_sign");
    abilityBlackList.add("sign");
  ...
  public int getTier(@NotNull String id) {
    return tierValue.getOrDefault(id, 1);
  }
