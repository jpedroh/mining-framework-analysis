 ...
 */
@SuppressWarnings(value = { "unchecked", "rawtypes" }) public abstract class Controller {
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> T getAttr(String name) {
    return (T) request.getAttribute(name);
  }

  public <T extends java.lang.Object> T getAttr(String name, T defaultValue) {
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> T getSessionAttr(String key) {
    HttpSession session = request.getSession(false);
    return session != null ? (T) session.getAttribute(key) : null;
  }

  public <T extends java.lang.Object> T getSessionAttr(String key, T defaultValue) {
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> T getModel(Class<T> modelClass) {
    return (T) Injector.injectModel(modelClass, request, false);
  }

  public <T extends java.lang.Object> T getModel(Class<T> modelClass, boolean skipConvertError) {
  ...
  /**
	 * Get model from http request.
	 */
  public <T extends java.lang.Object> T getModel(Class<T> modelClass, String modelName) {
    return (T) Injector.injectModel(modelClass, modelName, request, false);
  }

  public <T extends java.lang.Object> T getModel(Class<T> modelClass, String modelName, boolean skipConvertError) {
    return (T) Injector.injectModel(modelClass, modelName, request, skipConvertError);
  }

  public <T extends java.lang.Object> T getBean(Class<T> beanClass) {
    return (T) Injector.injectBean(beanClass, request, false);
  }

  public <T extends java.lang.Object> T getBean(Class<T> beanClass, boolean skipConvertError) {
    return (T) Injector.injectBean(beanClass, request, skipConvertError);
  }

  public <T extends java.lang.Object> T getBean(Class<T> beanClass, String beanName) {
    return (T) Injector.injectBean(beanClass, beanName, request, false);
  }

  public <T extends java.lang.Object> T getBean(Class<T> beanClass, String beanName, boolean skipConvertError) {
