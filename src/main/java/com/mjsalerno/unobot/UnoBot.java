...
public class UnoBot extends ListenerAdapter {
  ...
  @Override public void onMessage(MessageEvent event) throws Exception {
    ...
    if (!message.startsWith(this.token)) {
      return;
    }
    ...
    if (tokens[0].equalsIgnoreCase(this.token + "info")) {
      ...
      if (tokens[0].equalsIgnoreCase(this.token + "unohelp")) {
        ...
        if (tokens[0].equalsIgnoreCase(this.token + "fullhelp")) {
          bot.sendIRC().notice(sender, this.token + "uno ------ Starts an new UNO game.");
          ...
          if (tokens[0].equalsIgnoreCase(this.token + "joinc") && botOps.isOper(sender)) {
            bot.sendIRC().joinChannel(tokens[1]);
          } else {
            if (tokens[0].equalsIgnoreCase(this.token + "update") && botOps.isOper(sender) && this.updateScript != null) {
              try {
              ...
              if (tokens[0].equalsIgnoreCase(this.token + "part") && botOps.isOper(sender)) {
                Channel chan = bot.getUserChannelDao().getChannel(tokens[1]);
                chan.send().part();
              } else {
                if (tokens[0].equalsIgnoreCase(this.token + "quit") && botOps.isOper(sender)) {
                  bot.sendIRC().quitServer();
                  System.exit(0);
                } else {
                  if (tokens[0].equalsIgnoreCase(this.token + "resetsb") && botOps.isOper(sender)) {
                    try {
                      resetScoreBoard();
    ...
    if (tokens[0].equalsIgnoreCase(this.token + "messages") && messagesEnabled) {
      ...
      if (tokens[0].equalsIgnoreCase(this.token + "tell") && messagesEnabled) {
        ...
        if (tokens[0].equalsIgnoreCase(this.token + "score")) {
          ...
          if (tokens[0].equalsIgnoreCase(this.token + "ai")) {
            startAI();
          } else {
    ...
    if (tokens[0].equalsIgnoreCase(this.token + "join") || tokens[0].equalsIgnoreCase(this.token + "jo") && gameUp) {
      ...
      if (tokens[0].equalsIgnoreCase(this.token + "endgame") && gameUp) {
        ...
        if (tokens[0].equalsIgnoreCase(this.token + "leave") || tokens[0].equalsIgnoreCase(this.token + "quit")) {
          ...
          if (tokens[0].equalsIgnoreCase(this.token + "unocount") && delt) {
            ...
            if (tokens[0].equalsIgnoreCase(this.token + "players") && gameUp) {
              ...
              if ((tokens[0].equalsIgnoreCase(this.token + "deal") || tokens[0].equalsIgnoreCase(this.token + "de")) && !delt && gameUp) {
                  ...
                  if ((tokens[0].equalsIgnoreCase(this.token + "wait")) && delt && (sender.equals(players.at().getName()))) {
                    ...
                    if ((tokens[0].equalsIgnoreCase(this.token + "draw")) && delt && (sender.equals(players.at().getName()))) {
                      if (!drew) {
                        ...
                        bot.sendIRC().message(channel, "Sorry " + sender + " but you already " + "drew a card. If you still have no cards that you can play then " + "pass by typing !pass");
                      }
                    } else {
                      if ((tokens[0].equalsIgnoreCase(this.token + "pass")) && delt && (sender.equals(players.at().getName()))) {
                        ...
                        if ((tokens[0].equalsIgnoreCase(this.token + "showcards") || tokens[0].equalsIgnoreCase(this.token + "hand") || tokens[0].equalsIgnoreCase(this.token + "ca")) && delt) {
                          bot.sendIRC().notice(sender, getCards(players.get(sender)));
                        } else {
                          if (tokens[0].equalsIgnoreCase(this.token + "rank")) {
                            ...
                            if ((tokens[0].equalsIgnoreCase(this.token + "play") || tokens[0].equalsIgnoreCase(this.token + "p") || tokens[0].equalsIgnoreCase(this.token + "pl")) && delt && gameUp && (sender.equals(players.at().getName()))) {
                              Card card = null;
                              if (tokens.length >= 2) {
                                if (tokens.length >= 3) {
                                  card = Card.parse(tokens[1] + " " + tokens[2]);
                                } else {
                                  card = Card.parse(tokens[1]);
                                }
                              }
                              if (card == null) {
