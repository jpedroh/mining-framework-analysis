...
public class DefaultElasticSearchService implements ElasticSearchService {
  ...
  @Inject public DefaultElasticSearchService(TransportClientFactory clientFactory, ElasticSearchConfigurator configurator) {
    this.clientFactory = clientFactory;
    this.configurator = configurator;
  }

  @Override public void start() {
    Settings settings = ImmutableSettings.settingsBuilder().put("cluster.name", configurator.getClusterName()).put("client.transport.sniff", configurator.getClientTransportSniff()).build();
  ...
  @Override public void index(String index, String type, JsonObject source, IndexOptions options, Handler<AsyncResult<JsonObject>> resultHandler) {
    IndexRequestBuilder builder = client.prepareIndex(index, type).setSource(source.encode());
    if (options != null) {
    ...
    builder.execute(new ActionListener<IndexResponse>() {
      @Override public void onResponse(IndexResponse indexResponse) {
        JsonObject result = new JsonObject().put(CONST_INDEX, indexResponse.getIndex()).put(CONST_TYPE, indexResponse.getType()).put(CONST_ID, indexResponse.getId()).put(CONST_VERSION, indexResponse.getVersion()).put(CONST_CREATED, indexResponse.isCreated());
  ...
  @Override public void update(String index, String type, String id, UpdateOptions options, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    if (options != null) {
      ...
      if (options.getScriptLang() != null) {
        builder.setScriptLang(options.getScriptLang());
      }
      if (options.getScriptParams() != null) {
        builder.setScriptParams(options.getScriptParams().getMap());
      }
    ...
    builder.execute(new ActionListener<UpdateResponse>() {
      @Override public void onResponse(UpdateResponse updateResponse) {
        JsonObject result = new JsonObject().put(CONST_INDEX, updateResponse.getIndex()).put(CONST_TYPE, updateResponse.getType()).put(CONST_ID, updateResponse.getId()).put(CONST_VERSION, updateResponse.getVersion()).put(CONST_CREATED, updateResponse.isCreated());
        resultHandler.handle(Future.succeededFuture(result));
      }
  ...
  @Override public void get(String index, String type, String id, GetOptions options, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    builder.execute(new ActionListener<GetResponse>() {
      @Override public void onResponse(GetResponse getResponse) {
        ...
        JsonObject reply = new JsonObject().put(CONST_INDEX, getResponse.getIndex()).put(CONST_TYPE, getResponse.getType()).put(CONST_ID, getResponse.getId()).put(CONST_VERSION, getResponse.getVersion()).put(CONST_SOURCE, source);
  ...
  @Override public void search(List<String> indices, SearchOptions options, Handler<AsyncResult<JsonObject>> resultHandler) {
  ...
  @Override public void searchScroll(String scrollId, SearchScrollOptions options, Handler<AsyncResult<JsonObject>> resultHandler) {
  ...
  @Override public void delete(String index, String type, String id, DeleteOptions options, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    builder.execute(new ActionListener<DeleteResponse>() {
      @Override public void onResponse(DeleteResponse deleteResponse) {
        JsonObject json = new JsonObject().put(CONST_INDEX, deleteResponse.getIndex()).put(CONST_TYPE, deleteResponse.getType()).put(CONST_ID, deleteResponse.getId()).put(CONST_VERSION, deleteResponse.getVersion());
        resultHandler.handle(Future.succeededFuture(json));
      }
  ...
  @Override public void putIndexedScript(PutIndexedScriptOptions options, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    if (options != null) {
      ...
      if (options.getSource() != null) {
        builder.setSource(options.getSource().encode().getBytes(CHARSET_UTF8));
      }
    }
    builder.execute(new ActionListener<PutIndexedScriptResponse>() {
      @Override public void onResponse(PutIndexedScriptResponse putIndexedScriptResponse) {
        JsonObject json = new JsonObject().put(CONST_INDEX, putIndexedScriptResponse.getIndex()).put(CONST_SCRIPT_LANG, putIndexedScriptResponse.getScriptLang()).put(CONST_ID, putIndexedScriptResponse.getId()).put(CONST_IS_CREATED, putIndexedScriptResponse.isCreated()).put(CONST_VERSION, putIndexedScriptResponse.getVersion());
        resultHandler.handle(Future.succeededFuture(json));
      }
