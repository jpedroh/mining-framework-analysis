...
public class DefaultElasticSearchService implements InternalElasticSearchService {
  ...
  @Override public void start() {
    ...
    Settings settings = Settings.builder().put("cluster.name", configurator.getClusterName()).put("client.transport.sniff", configurator.getClientTransportSniff()).build();
  ...
  @Override public void suggest(String index, SuggestOptions options, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    builder.execute(new ActionListener<SuggestResponse>() {
      @Override public void onResponse(SuggestResponse suggestResponse) {
  ...
  @Override public void deleteByQuery(List<String> indices, DeleteByQueryOptions options, Handler<AsyncResult<JsonObject>> resultHandler) {
    final DeleteByQueryRequestBuilder deleteByQueryRequestBuilder = new DeleteByQueryRequestBuilder(client, DeleteByQueryAction.INSTANCE).setIndices(indices.toArray(new String[indices.size()]));
    if (options != null) {
      if (!options.getTypes().isEmpty()) {
        deleteByQueryRequestBuilder.setTypes(options.getTypes().toArray(new String[options.getTypes().size()]));
      }
      if (options.getTimeout() != null) {
        deleteByQueryRequestBuilder.setTimeout(options.getTimeout());
      }
      if (options.getRouting() != null) {
        deleteByQueryRequestBuilder.setRouting(options.getRouting());
      }
      if (options.getQuery() != null) {
        deleteByQueryRequestBuilder.setSource("{\"query\": " + options.getQuery().encode() + "}");
      }
    }
  ...
  @Override public TransportClient getClient() {
    return client;
  }
