...
public class WiresShape extends WiresContainer {
  ...
  @Override public WiresShape setDraggable(final boolean draggable) {
  ...
  public void addWiresShapeHandler(final HandlerRegistrationManager registrationManager, final WiresShapeHandler handler) {
