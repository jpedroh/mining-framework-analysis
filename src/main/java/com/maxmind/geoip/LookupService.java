...
public class LookupService {
  ...
  public synchronized Location getLocationV6(InetAddress addr) {
    ...
    try {
      ...
      record_buf_offset++;
      while (record_buf[record_buf_offset + str_length] != '\u0000') {
        str_length++;
      }
      if (str_length > 0) {
