 ...
 * created Nov 10, 2013
 */
@Getter public abstract class AbstractSheetWriter<T extends java.lang.Object> implements SheetWriter<T> {
  ...
  /**
     ...
     */
  @Deprecated AbstractSheetWriter(XceliteSheet sheet, boolean writeHeader) {
    this(sheet);
  ...
  void writeToCell(Cell cell, Object fieldValueObj, Class<?> dataType) {
    ...
    if (type.equals(Date.class)) {
      ...
      if ((type.equals(Boolean.class)) || (type.equals(boolean.class))) {
        ...
        if ((Number.class.isAssignableFrom(type)) || (fieldValueObj instanceof Number)) {
          cell.setCellType(CellType.NUMERIC);
  ...
  /**
     ...
     */
  @Deprecated @Override public void write(final Collection<T> data) {
  ...
  @Override public void generateHeaderRow(boolean generateHeaderRow) {
  ...
  /**
     * @deprecated since 1.2. Use {@link #setGenerateHeaderRow(boolean) instead}
     */
  @Deprecated @Override public void setGenerateHeaderRow(boolean generateHeaderRow) {
    options.setGenerateHeaderRow(generateHeaderRow);
  }
