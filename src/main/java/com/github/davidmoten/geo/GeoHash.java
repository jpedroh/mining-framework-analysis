...
public final class GeoHash {
  ...
  @VisibleForTesting static void instantiate() {
    new GeoHash();
  }
  ...
  private static void checkHash(String hash) {
    Preconditions.checkArgument(hash != null && hash.length() > 0, "hash must be non-null of length>1");
  }
  ...
  public static String encodeHash(double latitude, double longitude, int length) {
    ...
    Preconditions.checkArgument(latitude >= -90 && latitude <= 90, "latitude must be between -90 and 90 inclusive");
  ...
  /**
	 ...
	 * @return
	 */
  public static int hashLengthToEncloseBoundingBox(double topLeftLat, double topLeftLon, double bottomRightLat, double bottomRightLon) {
  ...
  public static boolean hashContains(String hash, double lat, double lon) {
    ...
    return Math.abs(centre.getLat() - lat) <= heightDegrees(hash.length()) / 2 && Math.abs(centre.getLon() - lon) <= widthDegrees(hash.length()) / 2;
  }
  ...
  /**
	 ...
	 * @return
	 */
  public static Coverage coverBoundingBox(double topLeftLat, final double topLeftLon, final double bottomRightLat, final double bottomRightLon) {
    int length = hashLengthToEncloseBoundingBox(topLeftLat, topLeftLon, bottomRightLat, bottomRightLon) + 1;
    return coverBoundingBox(topLeftLat, topLeftLon, bottomRightLat, bottomRightLon, length);
  }
  ...
  /**
	 ...
	 * @return
	 */
  public static Coverage coverBoundingBox(double topLeftLat, final double topLeftLon, final double bottomRightLat, final double bottomRightLon, final int length) {
    Preconditions.checkArgument(length > 0, "length must be greater than zero");
    ...
    double coverageAreaDegrees = hashes.size() * widthDegrees(length) * heightDegrees(length);
  ...
  /**
	 ...
	 * @return
	 */
  @VisibleForTesting static double longitudeDiff(double a, double b) {
    a = to180(a);
    b = to180(b);
    if (a < b) {
      return a - b + 360;
  ...
  /**
	 ...
	 * @return
	 */
  public static String gridToString(String hash, int size, Set<String> highlightThese) {
  ...
  /**
	 ...
	 * @return
	 */
  public static String gridToString(String hash, int fromRight, int fromBottom, int toRight, int toBottom) {
    return gridToString(hash, fromRight, fromBottom, toRight, toBottom, Collections.<String>emptySet());
  }
  ...
  /**
	 ...
	 * @return
	 */
  public static String gridToString(String hash, int fromRight, int fromBottom, int toRight, int toBottom, Set<String> highlightThese) {
