...
public final class Util {
  ...
  static Func1<Integer, List<Parameter>> TO_EMPTY_PARAMETER_LIST = new Func1<Integer, List<Parameter>>() {
    @Override public List<Parameter> call(Integer n) {
  ...
  /**
	 ...
	 * @return
	 */
  static <R extends java.lang.Object, S extends java.lang.Object> Func1<R, S> constant(final S s) {
    return new Func1<R, S>() {
      @Override public S call(R t1) {
        return s;
      }
    };
  }
  ...
  /**
	 ...
	 * @return
	 */
  static <T extends java.lang.Object> Func1<ResultSet, T> autoMap(final Class<T> cls) {
    return new Func1<ResultSet, T>() {
      @Override public T call(ResultSet rs) {
  ...
  /**
	 ...
	 */
  static <T extends java.lang.Object> T autoMap(ResultSet rs, Class<T> cls) {
    try {
  ...
  /**
	 ...
	 */
  private static <T extends java.lang.Object> T autoMap(ResultSet rs, Class<T> cls, Constructor<?> c) {
  ...
  /**
	 ...
	 * @return
	 */
  @SuppressWarnings(value = { "unchecked" }) private static <T extends java.lang.Object> T newInstance(Constructor<?> c, List<Object> parameters) {
    try {
  ...
  public static <T extends java.lang.Object> Object getObject(final ResultSet rs, Class<T> cls, int i) {
    try {
      ...
      if (type == Types.DATE) {
        ...
        if (type == Types.TIME) {
          ...
          if (type == Types.TIMESTAMP) {
            ...
            if (type == Types.CLOB && cls.equals(String.class)) {
              return toString(rs.getClob(i));
            } else {
              if (type == Types.CLOB && Reader.class.isAssignableFrom(cls)) {
                Clob c = rs.getClob(i);
                Reader r = c.getCharacterStream();
                return createFreeOnCloseReader(c, r);
              } else {
                if (type == Types.BLOB && cls.equals(byte[].class)) {
                  return toBytes(rs.getBlob(i));
                } else {
                  if (type == Types.BLOB && InputStream.class.isAssignableFrom(cls)) {
  ...
  public static final Func1<Reader, String> READER_TO_STRING = new Func1<Reader, String>() {
    @Override public String call(Reader r) {
      try {
  ...
  @SuppressWarnings(value = { "unchecked" }) static <T extends java.lang.Object> Observable<T> concatButIgnoreFirstSequence(Observable<?> o1, Observable<T> o2) {
