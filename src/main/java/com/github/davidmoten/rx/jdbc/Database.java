...
final public class Database {
  ...
  private static final Func0<Scheduler> CURRENT_THREAD_SCHEDULER_FACTORY = new Func0<Scheduler>() {
    @Override public Scheduler call() {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> Operator<Boolean, T> commitOperator() {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> Operator<Boolean, T> rollbackOperator() {
    return commitOrRollbackOperator(false);
  }

  private <T extends java.lang.Object> Operator<Boolean, T> commitOrRollbackOperator(final boolean commit) {
    ...
    return RxUtil.toOperator(new Func1<Observable<T>, Observable<Boolean>>() {
      @Override public Observable<Boolean> call(Observable<T> source) {
  ...
  /**
     ...
     * @return
     */
  private <T extends java.lang.Object> Operator<Boolean, T> commitOrRollbackOnCompleteOperator(final boolean isCommit) {
    return RxUtil.toOperator(new Func1<Observable<T>, Observable<Boolean>>() {
      @Override public Observable<Boolean> call(Observable<T> source) {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> Operator<Boolean, T> commitOnCompleteOperator() {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> Operator<Boolean, T> rollbackOnCompleteOperator() {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> Operator<T, T> beginTransactionOnNextOperator() {
  ...
  /**
     ...
     * @return
     */
  public <T extends java.lang.Object> Operator<Boolean, T> commitOnNextOperator() {
    return commitOrRollbackOnNextOperator(true);
  }

  public <T extends java.lang.Object> Operator<Boolean, Observable<T>> commitOnNextListOperator() {
    return commitOrRollbackOnNextListOperator(true);
  }

  public <T extends java.lang.Object> Operator<Boolean, Observable<T>> rollbackOnNextListOperator() {
    return commitOrRollbackOnNextListOperator(false);
  }

  private <T extends java.lang.Object> Operator<Boolean, Observable<T>> commitOrRollbackOnNextListOperator(final boolean isCommit) {
    return RxUtil.toOperator(new Func1<Observable<Observable<T>>, Observable<Boolean>>() {
      @Override public Observable<Boolean> call(Observable<Observable<T>> source) {
  ...
  private <T extends java.lang.Object> Operator<Boolean, T> commitOrRollbackOnNextOperator(final boolean isCommit) {
    return RxUtil.toOperator(new Func1<Observable<T>, Observable<Boolean>>() {
      @Override public Observable<Boolean> call(Observable<T> source) {
  ...
  private static <T extends java.lang.Object> Observable<Boolean> commitOrRollbackOnCompleteOperatorIfAtLeastOneValue(final boolean isCommit, final Database db, Observable<T> source) {
    CountingAction<T> counter = RxUtil.counter();
    Observable<Boolean> commit = counter.count().filter(greaterThanZero()).lift(db.commitOrRollbackOperator(isCommit));
  ...
  /**
     ...
     * @return
     */
  private static <T extends java.lang.Object> Observable<Boolean> commitOrRollbackOnNext(final boolean isCommit, final Database db, Observable<T> source) {
    return source.concatMap(new Func1<T, Observable<Boolean>>() {
      @Override public Observable<Boolean> call(T t) {
        if (isCommit) {
          return db.commit();
        } else {
          return db.rollback();
  ...
  private static <T extends java.lang.Object> Observable<T> beginTransactionOnNext(final Database db, Observable<T> source) {
  ...
  public Observable<Integer> run(Observable<String> commands) {
    return commands.reduce(Observable.<Integer>empty(), new Func2<Observable<Integer>, String, Observable<Integer>>() {
      @Override public Observable<Integer> call(Observable<Integer> dep, String command) {
  ...
  public Operator<Integer, String> run() {
    return RxUtil.toOperator(new Func1<Observable<String>, Observable<Integer>>() {
      @Override public Observable<Integer> call(Observable<String> commands) {
        return run(commands);
      }
    });
  }
  ...
  public Observable<Integer> run(InputStream is, Charset charset, String delimiter) {
    return StringObservable.split(StringObservable.from(new InputStreamReader(is, charset)), ";").lift(run());
  }
