            ...
            if ("eps:txt".equalsIgnoreCase(format)) {
              ...
              if ("svg".equalsIgnoreCase(format)) {
                ...
                if ("txt".equalsIgnoreCase(format)) {
                  ...
                  if ("utxt".equalsIgnoreCase(format)) {
    ...
    try {
      ...
      if (baseDir != null) {
        ...
        for (final File f : files) {
          ...
          final SourceFileReader sourceFileReader = new SourceFileReader(new Defines(), f, this.option.getOutputDir(), this.option.getConfig(), this.option.getCharset(), this.option.getFileFormatOption());
