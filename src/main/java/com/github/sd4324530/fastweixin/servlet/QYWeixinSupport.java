  ...
  public String processRequest(HttpServletRequest request) {
    ...
    if (msgType.equals(QYReqType.EVENT)) {
      ...
      if (QYEventType.SUBSCRIBE.equalsIgnoreCase(eventType)) {
        ...
        if (QYEventType.UNSUBSCRIBE.equalsIgnoreCase(eventType)) {
          QYBaseEvent event = new QYBaseEvent();
          buildBasicEvent(reqMap, event);
          ...
          if (QYEventType.CLICK.equalsIgnoreCase(eventType)) {
            ...
            if (QYEventType.VIEW.equalsIgnoreCase(eventType)) {
              String eventKey = (String) reqMap.get("EventKey");
              LOG.debug("eventKey:{}", eventKey);
              QYMenuEvent event = new QYMenuEvent(eventKey);
              buildBasicEvent(reqMap, event);
              ...
              if (QYEventType.LOCATION.equalsIgnoreCase(eventType)) {
                ...
                if (QYEventType.SCANCODEPUSH.equalsIgnoreCase(eventType) || QYEventType.SCANCODEWAITMSG.equalsIgnoreCase(eventType)) {
                  String eventKey = (String) reqMap.get("EventKey");
                  ...
                  if (QYEventType.PICPHOTOORALBUM.equalsIgnoreCase(eventType) || QYEventType.PICSYSPHOTO.equalsIgnoreCase(eventType) || QYEventType.PICWEIXIN.equalsIgnoreCase(eventType)) {
                    String eventKey = (String) reqMap.get("EventKey");
                    ...
                    if (QYEventType.ENTERAGENT.equalsIgnoreCase(eventType)) {
                      ...
                      if (QYEventType.BATCHJOBRESULT.equalsIgnoreCase(eventType)) {
      ...
      if (QYReqType.TEXT.equalsIgnoreCase(msgType)) {
        ...
        if (QYReqType.IMAGE.equalsIgnoreCase(msgType)) {
          ...
          if (QYReqType.VOICE.equalsIgnoreCase(msgType)) {
            ...
            if (QYReqType.VIDEO.equalsIgnoreCase(msgType)) {
              ...
              if (QYReqType.SHORT_VIDEO.equalsIgnoreCase(msgType)) {
                String thumbMediaId = (String) reqMap.get("ThumbMediaId");
                String mediaId = (String) reqMap.get("MediaId");
                QYVideoReqMsg videoReqMsg = new QYVideoReqMsg(mediaId, thumbMediaId);
                buildBasicReqMsg(reqMap, videoReqMsg);
                ...
                if (QYReqType.LOCATION.equalsIgnoreCase(msgType)) {
