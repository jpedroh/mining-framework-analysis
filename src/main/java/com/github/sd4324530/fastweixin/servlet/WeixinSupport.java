  ...
  public String processRequest(HttpServletRequest request) {
    ...
    if (msgType.equals(ReqType.EVENT)) {
          ...
          if (eventType.equals(EventType.CLICK)) {
            ...
            if (eventType.equals(EventType.VIEW)) {
              ...
              if (eventType.equals(EventType.LOCATION)) {
                ...
                if (EventType.SCANCODEPUSH.equals(eventType) || EventType.SCANCODEWAITMSG.equals(eventType)) {
                  String eventKey = (String) reqMap.get("EventKey");
                  ...
                  if (EventType.PICPHOTOORALBUM.equals(eventType) || EventType.PICSYSPHOTO.equals(eventType) || EventType.PICWEIXIN.equals(eventType)) {
                    String eventKey = (String) reqMap.get("EventKey");
                    ...
                    if (EventType.TEMPLATESENDJOBFINISH.equals(eventType)) {
                      ...
                      if (EventType.MASSSENDJOBFINISH.equals(eventType)) {
                        String msgId = (String) reqMap.get("MsgID");
                        String status = (String) reqMap.get("Status");
      ...
      if (msgType.equals(ReqType.TEXT)) {
        ...
        if (msgType.equals(ReqType.IMAGE)) {
          ...
          if (msgType.equals(ReqType.VOICE)) {
            ...
            if (msgType.equals(ReqType.VIDEO)) {
              ...
              if (msgType.equals(ReqType.SHORT_VIDEO)) {
                String thumbMediaId = (String) reqMap.get("ThumbMediaId");
                String mediaId = (String) reqMap.get("MediaId");
                VideoReqMsg videoReqMsg = new VideoReqMsg(mediaId, thumbMediaId);
                buildBasicReqMsg(reqMap, videoReqMsg);
                ...
                if (msgType.equals(ReqType.LOCATION)) {
                  ...
                  if (msgType.equals(ReqType.LINK)) {
