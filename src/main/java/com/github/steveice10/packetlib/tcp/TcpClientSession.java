...
>>>>>>> /usr/src/app/output/steveice10/packetlib/6fe86c063737c0d01d8ee7a1df92a887d4aab3fb/src/main/java/com/github/steveice10/packetlib/tcp/TcpClientSession.java/right.java
  ...
  private static Class<? extends DatagramChannel> 
<<<<<<< /usr/src/app/output/steveice10/packetlib/6fe86c063737c0d01d8ee7a1df92a887d4aab3fb/src/main/java/com/github/steveice10/packetlib/tcp/TcpClientSession.java/left.java
  datagramChannel
=======
...
>>>>>>> /usr/src/app/output/steveice10/packetlib/6fe86c063737c0d01d8ee7a1df92a887d4aab3fb/src/main/java/com/github/steveice10/packetlib/tcp/TcpClientSession.java/right.java
  ...
  public void connectInternal(SocketAddress socketAddress, String clientIp) {
    ...
    try {
      ...
      bootstrap.handler(new ChannelInitializer<LocalChannelWithRemoteAddress>() {
        @Override public void initChannel(LocalChannelWithRemoteAddress channel) {
  ...
  private InetSocketAddress resolveAddress() {
    ...
    if (getFlag(BuiltinFlags.ATTEMPT_SRV_RESOLVE, true) && (!this.host.matches(IP_REGEX) && !this.host.equalsIgnoreCase("localhost"))) {
      ...
      try {
        resolver = new DnsNameResolverBuilder(EVENT_LOOP_GROUP.next()).channelType(
<<<<<<< /usr/src/app/output/steveice10/packetlib/6fe86c063737c0d01d8ee7a1df92a887d4aab3fb/src/main/java/com/github/steveice10/packetlib/tcp/TcpClientSession.java/left.java
