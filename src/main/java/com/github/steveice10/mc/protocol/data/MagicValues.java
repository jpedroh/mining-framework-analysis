...
<<<<<<< /usr/src/app/output/steveice10/mcprotocollib/36e5eafd286fc1d6a554487a0a2e2f18032ece1a/src/main/java/com/github/steveice10/mc/protocol/data/MagicValues.java/left.java
||||||| /usr/src/app/output/steveice10/mcprotocollib/36e5eafd286fc1d6a554487a0a2e2f18032ece1a/src/main/java/com/github/steveice10/mc/protocol/data/MagicValues.java/base.java
        register(MobType.ARMOR_STAND, 1);
=======
        register(MobType.AREA_EFFECT_CLOUD, 0);
        register(MobType.ARMOR_STAND, 1);
        register(MobType.ARROW, 2);
>>>>>>> /usr/src/app/output/steveice10/mcprotocollib/36e5eafd286fc1d6a554487a0a2e2f18032ece1a/src/main/java/com/github/steveice10/mc/protocol/data/MagicValues.java/right.java
        register(MobType.BAT, 3);
        register(MobType.BLAZE, 4);
<<<<<<< /usr/src/app/output/steveice10/mcprotocollib/36e5eafd286fc1d6a554487a0a2e2f18032ece1a/src/main/java/com/github/steveice10/mc/protocol/data/MagicValues.java/left.java
        register(MobType.CAT, 6);
        register(MobType.CAVE_SPIDER, 7);
        register(MobType.CHICKEN, 8);
        register(MobType.COD, 9);
        register(MobType.COW, 10);
        register(MobType.CREEPER, 11);
        register(MobType.DONKEY, 12);
        register(MobType.DOLPHIN, 13);
        register(MobType.DROWNED, 15);
        register(MobType.ELDER_GUARDIAN, 16);
        register(MobType.ENDER_DRAGON, 18);
        register(MobType.ENDERMAN, 19);
        register(MobType.ENDERMITE, 20);
        register(MobType.EVOKER, 22);
        register(MobType.FOX, 27);
        register(MobType.GHAST, 28);
        register(MobType.GIANT, 29);
        register(MobType.GUARDIAN, 30);
        register(MobType.HORSE, 31);
        register(MobType.HUSK, 32);
        register(MobType.ILLUSIONER, 33);
        register(MobType.LLAMA, 38);
        register(MobType.MAGMA_CUBE, 40);
        ...
        register(MobType.PUFFERFISH, 55);
        register(MobType.ZOMBIE_PIGMAN, 56);
        ...
        register(MobType.ZOMBIE_HORSE, 95);
        register(MobType.ZOMBIE_VILLAGER, 96);
        register(MobType.PHANTOM, 97);
        register(MobType.RAVAGER, 98);
        register(MobType.PLAYER, 100);
||||||| /usr/src/app/output/steveice10/mcprotocollib/36e5eafd286fc1d6a554487a0a2e2f18032ece1a/src/main/java/com/github/steveice10/mc/protocol/data/MagicValues.java/base.java
...
>>>>>>> /usr/src/app/output/steveice10/mcprotocollib/36e5eafd286fc1d6a554487a0a2e2f18032ece1a/src/main/java/com/github/steveice10/mc/protocol/data/MagicValues.java/right.java
        ...
        register(ObjectType.BOAT, 5);
        register(ObjectType.DRAGON_FIREBALL, 14);
        register(ObjectType.END_CRYSTAL, 17);
        register(ObjectType.EVOKER_FANGS, 21);
        register(ObjectType.EXPERIENCE_ORB, 23);
        register(ObjectType.EYE_OF_ENDER, 24);
        register(ObjectType.FALLING_BLOCK, 25);
        register(ObjectType.FIREWORK_ROCKET, 26);
        register(ObjectType.ITEM, 34);
        register(ObjectType.ITEM_FRAME, 35);
        register(ObjectType.FIREBALL, 36);
        register(ObjectType.LEASH_KNOT, 37);
        register(ObjectType.LLAMA_SPIT, 39);
        register(ObjectType.MINECART, 41);
        register(ObjectType.CHEST_MINECART, 42);
        register(ObjectType.COMMAND_BLOCK_MINECART, 43);
        register(ObjectType.FURNACE_MINECART, 44);
        register(ObjectType.HOPPER_MINECART, 45);
        register(ObjectType.SPAWNER_MINECART, 46);
        register(ObjectType.TNT_MINECART, 47);
        ...
        register(ObjectType.FISHING_BOBBER, 101);
