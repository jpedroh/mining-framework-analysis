...
public class MagicValues {
  ...
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> T key(Class<T> keyType, Object value) {
        ...
        for (Object val : values.get(key)) {
          if (val == value || val.equals(value)) {
            ...
            if (Number.class.isAssignableFrom(val.getClass()) && Number.class.isAssignableFrom(value.getClass())) {
              ...
              if (String.class.isAssignableFrom(val.getClass()) && String.class.isAssignableFrom(value.getClass())) {
  ...
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> T value(Class<T> valueType, Object key) {
    if (values.containsKey(key)) {
      for (Object val : values.get(key)) {
