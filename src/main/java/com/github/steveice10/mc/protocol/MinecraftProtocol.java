 ...
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE) public class MinecraftProtocol extends PacketProtocol {
  ...
  /**
     ...
     */
  @Getter private GameProfile profile = null;
  ...
  /**
     ...
     */
  @Getter @Setter private boolean useDefaultListeners = true;
  ...
  /**
     ...
     */
  @Deprecated public MinecraftProtocol(String username, String password) throws RequestException {
  ...
  /**
     ...
     * @throws RequestException If the log in request fails.
     */
  @Deprecated public MinecraftProtocol(String username, String clientToken, String accessToken) throws RequestException {
  ...
  /**
     ...
     */
  @Deprecated public MinecraftProtocol(GameProfile profile, String clientToken, String accessToken) {
    this(SubProtocol.LOGIN);
  ...
  @Override public String getSRVRecordPrefix() {
    return "_minecraft";
  }
  ...
  @Override public PacketEncryption getEncryption() {
    return this.encryption;
  }

  @Override public void newClientSession(Client client, Session session) {
  ...
  @Override public void newServerSession(Server server, Session session) {
