...
public class MinecraftCodec {
  ...
  public static final PacketCodec CODEC = PacketCodec.builder().protocolVersion(761).helper(() -> new MinecraftCodecHelper(LEVEL_EVENTS, SOUND_NAMES)).minecraftVersion(
