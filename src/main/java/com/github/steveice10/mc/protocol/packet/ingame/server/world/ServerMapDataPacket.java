...
@Data @With @Setter(value = AccessLevel.NONE) @NoArgsConstructor(access = AccessLevel.PRIVATE) @AllArgsConstructor public class ServerMapDataPacket implements Packet {
  private int mapId;
