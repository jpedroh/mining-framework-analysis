 ...
 * 
 */
@Mojo(name = "nar-vcproj", defaultPhase = LifecyclePhase.GENERATE_SOURCES, requiresDependencyResolution = ResolutionScope.COMPILE) public class NarVcprojMojo extends AbstractCompileMojo {
  ...
  public void narExecute() throws MojoExecutionException, MojoFailureException {
    ...
    for (Iterator i = profiles.iterator(); i.hasNext(); ) {
      org.apache.maven.model.Profile profile = (org.apache.maven.model.Profile) i.next();
