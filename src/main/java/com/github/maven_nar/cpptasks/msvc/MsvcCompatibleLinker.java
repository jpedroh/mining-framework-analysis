...
public abstract class MsvcCompatibleLinker extends CommandLineLinker {
  ...
  @Override protected void addFixed(final CCTask task, final Boolean fixed, final Vector<String> args) {
    if (fixed != null) {
   ...
   *          bidded fileset
   */
  @Override public void addVersionFiles(final VersionInfo versionInfo, final LinkType linkType, final File outputFile, final boolean isDebug, final File objDir, final TargetMatcher matcher) throws IOException {
