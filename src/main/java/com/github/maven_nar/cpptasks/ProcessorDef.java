...
<<<<<<< /usr/src/app/output/maven-nar/nar-maven-plugin/cb61e829410f4f86501ba652f1a211fc264121df/src/main/java/com/github/maven_nar/cpptasks/ProcessorDef.java/left.java
 *
 * http://www.apache.org/licenses/LICENSE-2.0
 *
||||||| /usr/src/app/output/maven-nar/nar-maven-plugin/cb61e829410f4f86501ba652f1a211fc264121df/src/main/java/com/github/maven_nar/cpptasks/ProcessorDef.java/base.java
 * 
 *      http://www.apache.org/licenses/LICENSE-2.0
 * 
=======
 ...
 * http://www.apache.org/licenses/LICENSE-2.0
 * 
>>>>>>> /usr/src/app/output/maven-nar/nar-maven-plugin/cb61e829410f4f86501ba652f1a211fc264121df/src/main/java/com/github/maven_nar/cpptasks/ProcessorDef.java/right.java
   ...
   */
    public CommandLineArgument[] getActiveProcessorArgs() {
      ...
      for (int i = 0; i < this.processorArgs.size(); i++) {
        final CommandLineArgument arg = (CommandLineArgument) this.processorArgs
                    .elementAt(i);
        if (arg.isActive(p)) {
   ...
   */
    public ProcessorParam[] getActiveProcessorParams() {
      ...
      for (int i = 0; i < this.processorParams.size(); i++) {
        final ProcessorParam param = (ProcessorParam) this.processorParams
                    .elementAt(i);
        if (param.isActive(p)) {
