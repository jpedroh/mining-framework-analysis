 ...
 */
@Mojo(name = "nar-integration-test", requiresDependencyResolution = ResolutionScope.TEST, defaultPhase = LifecyclePhase.INTEGRATION_TEST) public class NarIntegrationTestMojo extends AbstractDependencyMojo {
  ...
  /**
     ...
     */
  @Parameter(property = "skipNar") private boolean skipNar;
  ...
  /**
     ...
     * @since 2.4
     */
  @Parameter(property = "skipNarTests") private boolean skipNarTests;
  ...
  /**
     ...
     * @since 2.3
     */
  @Parameter(property = "nar.test.skip.exec") private boolean skipNarExec;
  ...
  /**
     ...
     */
  @Parameter(property = "nar.test.failure.ignore") private boolean testFailureIgnore;
  ...
  /**
     ...
     * @required
     */
  @Parameter(property = "basedir", required = true) private File basedir;
  ...
  /**
     ...
     * @required
     */
  @Parameter(property = "project.build.testOutputDirectory", required = true) private File testClassesDirectory;
  ...
  /**
     ...
     * @required
     */
  @Parameter(property = "project.build.outputDirectory", required = true) private File classesDirectory;
  ...
  /**
     ...
     * @readonly
     */
  @Parameter(property = "project.testClasspathElements", required = true, readonly = true) private List classpathElements;
  ...
  /**
     ...
     * @since 2.4
     */
  @Parameter private List additionalClasspathElements;
  ...
  /**
     ...
     * @since 2.2
     */
  @Parameter(property = "project.build.testSourceDirectory", required = true) private File testSourceDirectory;
  ...
  /**
     ...
     * @parameter
     */
  @Parameter private List includes;
  ...
  /**
     ...
     * @parameter
     */
  @Parameter private List excludes;
  ...
  /**
     ...
     * @readonly
     */
  @Parameter(property = "plugin.artifactMap", required = true, readonly = true) private Map pluginArtifactMap;
  ...
  /**
     ...
     * @readonly
     */
  @Parameter(property = "project.artifactMap", readonly = true, required = true) private Map projectArtifactMap;
  ...
  /**
     ...
     */
  @Parameter(property = "surefire.printSummary", defaultValue = "true") private boolean printSummary = true;
  ...
  /**
     ...
     * @since 2.3
     */
  @Parameter(property = "nar.test.redirectTestOutputToFile") private boolean redirectTestOutputToFile;
  ...
  /**
     ...
     * @since 2.1.3
     */
  @Parameter private Map environmentVariables = new HashMap();
  ...
  /**
     ...
     * @since 2.1
     */
  @Parameter(property = "childDelegation") private boolean childDelegation;
  ...
  /**
     ...
     * @since 2.2
     */
  @Parameter private File[] suiteXmlFiles;
  ...
  /**
     ...
     * @since 2.2
     */
  @Parameter(property = "trimStackTrace", defaultValue = "true") private boolean trimStackTrace = true;
  ...
  /**
     ...
     * @since 2.2
     */
  @Parameter(property = "disableXmlReport") private boolean disableXmlReport;
  ...
  /**
     ...
     * @since 2.3
     */
  @Parameter(property = "surefire.useSystemClassLoader") private Boolean useSystemClassLoader;
  ...
  /**
     ...
     * @since 2.4.3
     */
  @Parameter(property = "surefire.useManifestOnlyJar", defaultValue = "true") private boolean useManifestOnlyJar = true;
  ...
  private SurefireBooter constructSurefireBooter() throws MojoExecutionException, MojoFailureException {
    ...
    if (suiteXmlFiles != null && suiteXmlFiles.length > 0 && test == null) {
      ...
      surefireBooter.addTestSuite("org.apache.maven.surefire.testng.TestNGXmlTestSuite", new Object[] { suiteXmlFiles, testSourceDirectory.getAbsolutePath(), testNgArtifact.getBaseVersion(), testNgArtifact.getClassifier(), properties, reportsDirectory });
    } else {
      List includeList;
      List excludeList;
      if (test != null) {
        ...
        if (includeList == null || includeList.size() == 0) {
          includeList = new ArrayList(Arrays.asList(new String[] { "**/Test*.java", "**/*Test.java", "**/*TestCase.java" }));
        }
      ...
      if (testNgArtifact != null) {
        surefireBooter.addTestSuite("org.apache.maven.surefire.testng.TestNGDirectoryTestSuite", new Object[] { testClassesDirectory, includeList, excludeList, testSourceDirectory.getAbsolutePath(), testNgArtifact.getBaseVersion(), testNgArtifact.getClassifier(), properties, reportsDirectory });
      } else {
        ...
        surefireBooter.addTestSuite(junitDirectoryTestSuite, new Object[] { testClassesDirectory, includeList, excludeList });
      }
    }
    ...
    if (fork.isForking()) {
      ...
      if (testJNIModule()) {
        File jniLibraryPathEntry = getLayout().getLibDirectory(getTargetDirectory(), getMavenProject().getArtifactId(), getMavenProject().getVersion(), getAOL().toString(), Library.JNI);
        ...
        File sharedLibraryPathEntry = getLayout().getLibDirectory(getTargetDirectory(), getMavenProject().getArtifactId(), getMavenProject().getVersion(), getAOL().toString(), Library.SHARED);
      ...
      List dependencies = getNarArtifacts();
      for (Iterator i = dependencies.iterator(); i.hasNext(); ) {
        ...
        for (int j = 0; j < bindings.length; j++) {
          ...
          if (!binding.equals(Library.STATIC)) {
            File depLibPathEntry = getLayout().getLibDirectory(getUnpackDirectory(), dependency.getArtifactId(), dependency.getVersion(), getAOL().toString(), binding);
  ...
  private ArtifactResolutionResult resolveArtifact(Artifact filteredArtifact, Artifact providerArtifact) throws ArtifactResolutionException, ArtifactNotFoundException {
    ...
    return artifactResolver.resolveTransitively(Collections.singleton(providerArtifact), originatingArtifact, getLocalRepository(), getRemoteRepositories(), metadataSource, filter);
  }
  ...
  private void addReporters(SurefireBooter surefireBooter, boolean forking) {
    ...
    if (useFile) {
      ...
      if (BRIEF_REPORT_FORMAT.equals(reportFormat)) {
        ...
        if (PLAIN_REPORT_FORMAT.equals(reportFormat)) {
