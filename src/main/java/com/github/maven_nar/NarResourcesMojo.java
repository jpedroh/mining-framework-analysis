 ...
 */
@Mojo(name = "nar-resources", defaultPhase = LifecyclePhase.PROCESS_RESOURCES, requiresProject = true) public class NarResourcesMojo extends AbstractResourcesMojo {
  /**
     ...
     * @required
     */
  @Parameter(property = "nar.resources.copy.aol", defaultValue = "true", required = true) private boolean resourcesCopyAOL;
  ...
  /**
     ...
     * @required
     */
  @Parameter(defaultValue = "${basedir}/src/nar/resources", required = true) private File resourceDirectory;
