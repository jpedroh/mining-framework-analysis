 ...
 */
@Mojo(name = "nar-assembly", defaultPhase = LifecyclePhase.PROCESS_RESOURCES, requiresProject = true, requiresDependencyResolution = ResolutionScope.COMPILE) public class NarAssemblyMojo extends AbstractDependencyMojo {
  ...
  public final void narExecute() throws MojoExecutionException, MojoFailureException {
    ...
    for (Iterator d = dependencies.iterator(); d.hasNext(); ) {
      ...
      File srcDir = getLayout().getNarUnpackDirectory(getUnpackDirectory(), getNarManager().getNarFile(dependency));
      ...
      try {
        ...
        throw new MojoExecutionException("Failed to copy directory for dependency " + dependency + " from " + srcDir + " to " + dstDir, ioe);
      }
    }
  }
}