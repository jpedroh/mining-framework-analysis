...
public class Linker {
   ...
   */
  @Parameter(required = true) private final boolean incremental = false;

  /**
   * Enables or disables the production of a map file.
   */
  @Parameter(required = true) private final boolean map = false;

  /**
   * Options for the linker Defaults to Architecture-OS-Linker specific values.
   * FIXME table missing
   */
  @Parameter private List options;
   ...
   *
   */
  @Parameter private List testOptions;
   ...
   */
  @Parameter private String libSet;

  /**
   * Adds system libraries to the linker.
   */
  @Parameter private List sysLibs;
   ...
   */
  @Parameter private String sysLibSet;
  ...
  private void addLibraries(final String libraryList, final LinkerDef linker, final Project antProject, final boolean isSystem) {
    if (libraryList == null) {
      return;
    }
  ...
  public final LinkerDef getLinker(final AbstractCompileMojo mojo, final Project antProject, final String os, final String prefix, final String type) throws MojoFailureException, MojoExecutionException {
    if (this.name == null) {
  ...
  public final String getName(final NarProperties properties, final String prefix) throws MojoFailureException, MojoExecutionException {
   ...
   *         argument list.
   */
  public final LinkerDef getTestLinker(final AbstractCompileMojo mojo, final Project antProject, final String os, final String prefix, final String type) throws MojoFailureException, MojoExecutionException {
  ...
  public final String getVersion(final AbstractNarMojo mojo) throws MojoFailureException, MojoExecutionException {
    ...
    if (this.name.equals("g++") || this.name.equals("gcc")) {
      ...
      if (this.name.equals("msvc")) {

<<<<<<< /usr/src/app/output/maven-nar/nar-maven-plugin/cb61e829410f4f86501ba652f1a211fc264121df/src/main/java/com/github/maven_nar/Linker.java/left.java
        version = mojo.getMsvc().getVersion()
=======
        NarUtil.runCommand("link", new String[] { "/?" }, null, null, out, err, dbg, this.log, true)
>>>>>>> /usr/src/app/output/maven-nar/nar-maven-plugin/cb61e829410f4f86501ba652f1a211fc264121df/src/main/java/com/github/maven_nar/Linker.java/right.java
        ;
...
>>>>>>> /usr/src/app/output/maven-nar/nar-maven-plugin/cb61e829410f4f86501ba652f1a211fc264121df/src/main/java/com/github/maven_nar/Linker.java/right.java
        ...
        if (this.name.equals("icc") || this.name.equals("icpc")) {
