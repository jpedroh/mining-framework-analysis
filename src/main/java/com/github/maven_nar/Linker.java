...
public class Linker {
  ...
  /**
     ...
     * @required
     */
  @Parameter(required = true) private boolean incremental = false;
  ...
  /**
     ...
     * @required
     */
  @Parameter(required = true) private boolean map = false;
  ...
  public final String getVersion() throws MojoFailureException, MojoExecutionException {
    ...
    if (name.equals("g++") || name.equals("gcc")) {
      ...
      if (name.equals("msvc")) {
        ...
        if (name.equals("icc") || name.equals("icpc")) {
  ...
  /**
     ...
     */
  public final LinkerDef getTestLinker(AbstractCompileMojo mojo, Project antProject, String os, String prefix, String type) throws MojoFailureException, MojoExecutionException {
