 ...
 */
@Mojo(name = "nar-gnu-configure", requiresProject = true, defaultPhase = LifecyclePhase.PROCESS_SOURCES) public class NarGnuConfigureMojo extends AbstractGnuMojo {
  /**
	 ...
	 */
  @Parameter(property = "nar.gnu.configure.in-place") private boolean gnuConfigureInPlace;
  ...
  /**
	 ...
	 */
  @Parameter(property = "nar.gnu.autogen.skip") private boolean gnuAutogenSkip;
  ...
  /**
	 ...
	 */
  @Parameter(property = "nar.gnu.configure.skip") private boolean gnuConfigureSkip;
  ...
  /**
	 ...
	 */
  @Parameter(property = "nar.gnu.configure.args", defaultValue = "") private String gnuConfigureArgs;
  ...
  /**
	 ...
	 */
  @Parameter(property = "nar.gnu.buildconf.args", defaultValue = "") private String gnuBuildconfArgs;
  ...
  public final void narExecute() throws MojoExecutionException, MojoFailureException {
    ...
    if (sourceDir.exists()) {
      ...
      if (!gnuConfigureSkip && configure.exists()) {
        ...
        int result = NarUtil.runCommand("sh", args, buildDir, null, getLog());
        if (result != 0) {
  ...
  private void runAutogen(final File autogen, final File targetDir, final String[] args) throws MojoExecutionException, MojoFailureException {
