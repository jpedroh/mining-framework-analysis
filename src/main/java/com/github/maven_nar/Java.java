...
public class Java {
  /**
     ...
     * @required
     */
  @Parameter(required = true) private boolean include = false;
  ...
  /**
     ...
     */
  @Parameter private List includePaths;
  ...
  /**
     ...
     * @required
     */
  @Parameter(required = true) private boolean link = false;
  ...
  /**
     ...
     * @parameter default-value=""
     */
  @Parameter private String runtimeDirectory;
  ...
  /**
     ...
     */
  @Parameter(defaultValue = "jvm") private String runtime = "jvm";
