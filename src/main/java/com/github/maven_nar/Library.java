...
public class Library implements Executable {
  ...
  /**
     ...
     */
  @Parameter private String type = SHARED;
  ...
  /**
     ...
     * @parameter default-value=""
     */
  @Parameter private String subSystem = "console";
  ...
  /**
     ...
     * @parameter default-value=""
     */
  @Parameter(defaultValue = "true") private boolean linkCPP = true;
  ...
  /**
     ...
     * @parameter default-value=""
     */
  @Parameter private boolean linkFortran = false;
  ...
  /**
     ...
     * @parameter default-value=""
     */
  @Parameter private boolean linkFortranMain = false;
  ...
  /**
     ...
     * @parameter default-value=""
     */
  @Parameter private String narSystemPackage = null;
  ...
  /**
     ...
     * @required
     */
  @Parameter(defaultValue = "NarSystem", required = true) private String narSystemName = "NarSystem";
  ...
  /**
     ...
     * @required
     */
  @Parameter(defaultValue = "${project.build.dir}/nar/nar-generated", required = true) private String narSystemDirectory = "nar-generated";
  ...
  /**
     ...
     * @parameter default-value=""
     */
  @Parameter private boolean run = false;
