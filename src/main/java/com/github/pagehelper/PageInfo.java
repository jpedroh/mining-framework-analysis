 ...
 */
@SuppressWarnings(value = { "rawtypes", "unchecked" }) public class PageInfo<T extends java.lang.Object> extends PageSerializable<T> {
  ...
  public static <T extends java.lang.Object> PageInfo<T> of(List<? extends T> list) {
    return new PageInfo<T>(list);
  }

  public static <T extends java.lang.Object> PageInfo<T> of(List<? extends T> list, int navigatePages) {
  ...
  /**
     ...
     * @return
     */
  public static <T extends java.lang.Object> PageInfo<T> emptyPageInfo() {
  ...
  /**
     ...
     * @return 转换了对象类型的包装结果
     */
  public <E extends java.lang.Object> PageInfo<E> convert(Page.Function<T, E> function) {
