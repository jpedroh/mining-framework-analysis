...
<<<<<<< /usr/src/app/output/kongchen/swagger-maven-plugin/d2e1b0994d1d9cfdfc412842519319406128f268/src/main/java/com/github/kongchen/swagger/docgen/mavenplugin/MavenDocumentSource.java/left.java
  @Override public void loadDocuments() throws GenerateException {
    ...
    if (FilterFactory.getFilter() != null) {
      swagger = new SpecFilter().filter(swagger, FilterFactory.getFilter(), new HashMap<String, List<String>>(), new HashMap<String, String>(), new HashMap<String, List<String>>());
    }
  }
=======
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  protected Sets.SetView<Class<?>> getValidClasses() {
    return Sets.union(apiSource.getValidClasses(Api.class), apiSource.getValidClasses(Path.class));
  }
