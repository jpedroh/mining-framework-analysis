...
public class MustacheDocument implements Comparable<MustacheDocument> {
  ...
  @JsonIgnore private final Map<String, Model> models = new HashMap<String, Model>();
  ...
  @JsonIgnore private Set<String> requestTypes = new LinkedHashSet<String>();

  @JsonIgnore private Set<String> responseTypes = new LinkedHashSet<String>();

  @JsonIgnore private int apiIndex = 1;

  @JsonIgnore private static final Map<String, Integer> hashValueMap = new HashMap<String, Integer>();
  ...
  public List<MustacheParameterSet> analyzeParameters(List<Parameter> parameters) {
    ...
    Collections.sort(parameterList, new Comparator<MustacheParameterSet>() {
      @Override public int compare(MustacheParameterSet o1, MustacheParameterSet o2) {
  ...
  public List<MustacheItem> analyzeDataTypes(String responseClass) {
    ...
    Collections.sort(mustacheItemList, new Comparator<MustacheItem>() {
      @Override public int compare(MustacheItem o1, MustacheItem o2) {
        if (o1 != null && o2 != null) {
  ...
  @Override public int compareTo(MustacheDocument o) {
    if (o == null) {
      return 1;
    }
