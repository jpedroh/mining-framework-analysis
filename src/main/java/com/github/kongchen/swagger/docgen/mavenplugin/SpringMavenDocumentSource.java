...
public class SpringMavenDocumentSource extends AbstractDocumentSource {
  ...
  @Override protected Set<Class<?>> getValidClasses() {
    return Sets.union(super.getValidClasses(), apiSource.getValidClasses(RestController.class));
  }

  @Override protected ClassSwaggerReader resolveApiReader() throws GenerateException {
