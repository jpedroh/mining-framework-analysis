...
<<<<<<< /usr/src/app/output/kongchen/swagger-maven-plugin/6a1618ba07a66309f2b5287e4c812dc10d1970b0/src/main/java/com/github/kongchen/swagger/docgen/reader/AbstractReader.java/left.java
...
>>>>>>> /usr/src/app/output/kongchen/swagger-maven-plugin/6a1618ba07a66309f2b5287e4c812dc10d1970b0/src/main/java/com/github/kongchen/swagger/docgen/reader/AbstractReader.java/right.java
  ...
  private Response createResponse(ResponseMessageOverride responseMessage) {
    Response response = new Response().description(responseMessage.getMessage());
    if (responseMessage.getExample() != null) {
      response.example(responseMessage.getExample().getMediaType(), responseMessage.getExample().getValue());
    }
    return response;
  }
      ...
      if (!cls.equals(Void.class) && !cls.equals(void.class)) {
        ...
        if (property != null) {
          ...
          if (header.responseContainer().equalsIgnoreCase("list")) {
            ...
            if (header.responseContainer().equalsIgnoreCase("map")) {
  ...
  protected void readImplicitParameters(Method method, Operation operation) {
    ...
    for (ApiImplicitParam param : implicitParams.value()) {
      Class<?> cls;
      try {
        cls = param.dataTypeClass() == Void.class ? Class.forName(param.dataType()) : param.dataTypeClass();
  ...
  protected Parameter readImplicitParam(ApiImplicitParam param, Class<?> apiClass) {
    ...
    if (param.paramType().equalsIgnoreCase("path")) {
      ...
      if (param.paramType().equalsIgnoreCase("query")) {
        parameter = new QueryParameter();
      } else {
        if (param.paramType().equalsIgnoreCase("form") || param.paramType().equalsIgnoreCase("formData")) {
          parameter = new FormParameter();
        } else {
          if (param.paramType().equalsIgnoreCase("body")) {
            parameter = new BodyParameter();
          } else {
            if (param.paramType().equalsIgnoreCase("header")) {
