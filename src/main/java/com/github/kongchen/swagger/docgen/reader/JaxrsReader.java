...
public class JaxrsReader extends AbstractReader implements ClassSwaggerReader {
    ...
    public Operation parseMethod(String httpMethod, Method method) {
        ...
        if (apiOperation != null) {
            ...
            if ((!apiOperation.response().equals(java.lang.Void.class)) && (!apiOperation.response().equals(void.class))) {
        ...
        if ((((((responseClassType != null) && (!responseClassType.equals(java.lang.Void.class))) && (!responseClassType.equals(void.class))) && (!responseClassType.equals(javax.ws.rs.core.Response.class))) && (!hasApiAnnotation)) && (!isSubResource(httpMethod, method))) {
            ...
            } else if ((!responseClassType.equals(java.lang.Void.class)) && (!responseClassType.equals(void.class))) {
        ...
        if (AnnotationUtils.findAnnotation(method, java.lang.Deprecated.class) != null) {
