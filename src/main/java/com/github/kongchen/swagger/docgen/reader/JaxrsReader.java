...
public class JaxrsReader extends AbstractReader implements ClassSwaggerReader {
  ...
  @Override protected void updateExtensionChain() {
  ...
  @Override public Swagger read(Set<Class<?>> classes) {
  ...
  public Operation parseMethod(String httpMethod, Method method) {
    ...
    if ((responseClassType != null) && !responseClassType.equals(Void.class) && !responseClassType.equals(void.class) && !responseClassType.equals(javax.ws.rs.core.Response.class) && !hasApiAnnotation && !isSubResource(httpMethod, method)) {
      if (isPrimitive(responseClassType)) {
        ...
        if (!responseClassType.equals(Void.class) && !responseClassType.equals(void.class)) {
          ...
          if (models.isEmpty()) {
            ...
            operation.response(responseCode, new Response().description("successful operation").schema(p).headers(defaultResponseHeaders));
          }
...
<<<<<<< /usr/src/app/output/kongchen/swagger-maven-plugin/34fb37258e823222f6743558724ef66ce56738c4/src/main/java/com/github/kongchen/swagger/docgen/reader/JaxrsReader.java/left.java
...
>>>>>>> /usr/src/app/output/kongchen/swagger-maven-plugin/34fb37258e823222f6743558724ef66ce56738c4/src/main/java/com/github/kongchen/swagger/docgen/reader/JaxrsReader.java/right.java
      }
    }
            ...
            if (AnnotationUtils.findAnnotation(method, DELETE.class) != null) {
              ...
              if (AnnotationUtils.findAnnotation(method, OPTIONS.class) != null) {
                ...
                if (AnnotationUtils.findAnnotation(method, HEAD.class) != null) {
                  ...
                  if (AnnotationUtils.findAnnotation(method, io.swagger.jaxrs.PATCH.class) != null) {
                    return "patch";
                  } else {
