...
public class ApiSource {
  /**
     ...
     */
  @Parameter(required = true) private List<String> locations;

  @Parameter private Info info;

  /**
     * The basePath of your APIs.
     */
  @Parameter private String basePath;
  ...
  @Parameter(defaultValue = "false") private boolean 
<<<<<<< /usr/src/app/output/kongchen/swagger-maven-plugin/abb6c10117c59ea83b2d7849e8eb5fb70911becf/src/main/java/com/github/kongchen/swagger/docgen/mavenplugin/ApiSource.java/left.java
  skipInheritingClasses = false
=======
  removeBasePathFromEndpoints
>>>>>>> /usr/src/app/output/kongchen/swagger-maven-plugin/abb6c10117c59ea83b2d7849e8eb5fb70911becf/src/main/java/com/github/kongchen/swagger/docgen/mavenplugin/ApiSource.java/right.java
  ;
  ...
  @Parameter private String outputPath;

  @Parameter(defaultValue = "json") private String outputFormats;

  @Parameter private String swaggerDirectory;

  @Parameter private String swaggerFileName;
  ...
  /**
     ...
     */
  @Parameter private boolean attachSwaggerArtifact;

  @Parameter private String swaggerUIDocBasePath;

  @Parameter private String modelSubstitute;

  @Parameter private String apiSortComparator;

  /**
     * Information about swagger filter that will be used for prefiltering
     */
  @Parameter private String swaggerInternalFilter;

  @Parameter private String swaggerApiReader;

  /**
     * List of full qualified class names of SwaggerExtension implementations to be
     * considered for the generation
     */
  @Parameter private List<String> swaggerExtensions;

  @Parameter private boolean springmvc;

  @Parameter private boolean useJAXBAnnotationProcessor;

  @Parameter private boolean useJAXBAnnotationProcessorAsPrimary = true;

  @Parameter private String swaggerSchemaConverter;

  @Parameter private List<SecurityDefinition> securityDefinitions;

  @Parameter private List<String> typesToSkip = new ArrayList<String>();

  @Parameter private List<String> apiModelPropertyAccessExclusions = new ArrayList<String>();

  @Parameter private boolean jsonExampleValues = false;

  @Parameter private File descriptionFile;

  @Parameter private List<String> modelConverters;

  @Parameter private String operationIdFormat;
  ...
  private Contact from(io.swagger.annotations.Contact contactAnnotation) {
    Contact contact = new Contact().name(emptyToNull(contactAnnotation.name())).email(emptyToNull(contactAnnotation.email())).url(emptyToNull(contactAnnotation.url()));
  ...
  private License from(io.swagger.annotations.License licenseAnnotation) {
    License license = new License().name(emptyToNull(licenseAnnotation.name())).url(emptyToNull(licenseAnnotation.url()));
