...
public class ApiSource {
  /**
     ...
     */
  @Parameter(required = true) private String locations;

  @Parameter(name = "info", required = true) private Info info;

  /**
     * The basePath of your APIs.
     */
  @Parameter(required = true) private String basePath;
  ...
  /**
     ...
     */
  @Parameter(required = false) private String templatePath;
...
<<<<<<< /usr/src/app/output/kongchen/swagger-maven-plugin/e3165edb0fccc6aeec927b53d8c3366538d49bf9/src/main/java/com/github/kongchen/swagger/docgen/mavenplugin/ApiSource.java/left.java
  useJAXBAnnotationProcessor
=======
  attachSwaggerArtifact
>>>>>>> /usr/src/app/output/kongchen/swagger-maven-plugin/e3165edb0fccc6aeec927b53d8c3366538d49bf9/src/main/java/com/github/kongchen/swagger/docgen/mavenplugin/ApiSource.java/right.java
  ;
  ...
  @Parameter(required = false) private boolean jsonExampleValues = false;
