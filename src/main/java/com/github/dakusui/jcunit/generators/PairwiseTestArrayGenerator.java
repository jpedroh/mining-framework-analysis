 ...
 */
public class PairwiseTestArrayGenerator<T extends java.lang.Object, U extends java.lang.Object> extends BaseTestArrayGenerator<T, U> {
  /**
	 * A set of test runs.
	 */
  ...
  @Override public void init(GeneratorParameters.Value[] params, LinkedHashMap<T, U[]> domains) {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public int getIndex(T key, long cur) {
