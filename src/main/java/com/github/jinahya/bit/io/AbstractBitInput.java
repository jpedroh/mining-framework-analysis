...
public abstract class AbstractBitInput implements BitInput {
  ...
  @Override public byte readByte(final boolean unsigned, final int size) throws IOException {
    return (byte) readInt(unsigned, requireValidSizeByte(unsigned, size));
  }

  @Override public short readShort(final boolean unsigned, final int size) throws IOException {
    return (short) readInt(unsigned, requireValidSizeShort(unsigned, size));
  }

  @Override public int readInt(final boolean unsigned, final int size) throws IOException {
  ...
  @Override public long readLong(final boolean unsigned, final int size) throws IOException {
  ...
  @Override public char readChar(final int size) throws IOException {
