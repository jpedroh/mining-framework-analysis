...
public final class SearchServlet extends HttpServlet {
  ...
  @Override protected void doGet(final HttpServletRequest req, final HttpServletResponse resp) throws ServletException, IOException {
    ...
    final SearcherCallback callback = new SearcherCallback() {
      ...
      private JSONObject performQuery(final boolean debug, final boolean rewrite_query, final IndexSearcher searcher, final String version, final Query q) throws IOException, CorruptIndexException {
