...
public class StateRepresentation<S extends java.lang.Object, T extends java.lang.Object> {
  ...
  public void addEntryAction(final T trigger, final Action2<Transition<S, T>, Object[]> action) {
    ...
    entryActions.add(new Action2<Transition<S, T>, Object[]>() {
      @Override public void doIt(Transition<S, T> t, Object[] args) {
  ...
  @SuppressWarnings(value = { "unchecked" }) public List<T> getPermittedTriggers() {
