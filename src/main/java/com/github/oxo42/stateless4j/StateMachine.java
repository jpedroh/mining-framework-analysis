 ...
 */
public class StateMachine<S extends java.lang.Object, T extends java.lang.Object> {
  ...
  protected Action2<S, T> unhandledTriggerAction = new Action2<S, T>() {
    @Override public void doIt(S state, T trigger) {
  ...
  public StateConfiguration<S, T> configure(S state) {
    return new StateConfiguration<>(getRepresentation(state), new Func2<S, StateRepresentation<S, T>>() {
      @Override public StateRepresentation<S, T> call(S arg0) {
  ...
  /**
     ...
     * @The current state does not allow the trigger to be fired
     */
  public <TArg0 extends java.lang.Object> void fire(TriggerWithParameters1<TArg0, S, T> trigger, TArg0 arg0) {
  ...
  /**
     ...
     * @The current state does not allow the trigger to be fired
     */
  public <TArg0 extends java.lang.Object, TArg1 extends java.lang.Object> void fire(TriggerWithParameters2<TArg0, TArg1, S, T> trigger, TArg0 arg0, TArg1 arg1) {
    assert trigger != null : "trigger is null";
  ...
  /**
     ...
     * @The current state does not allow the trigger to be fired
     */
  public <TArg0 extends java.lang.Object, TArg1 extends java.lang.Object, TArg2 extends java.lang.Object> void fire(TriggerWithParameters3<TArg0, TArg1, TArg2, S, T> trigger, TArg0 arg0, TArg1 arg1, TArg2 arg2) {
    assert trigger != null : "trigger is null";
  ...
  /**
     ...
     */
  public <TArg0 extends java.lang.Object> TriggerWithParameters1<TArg0, S, T> setTriggerParameters(T trigger, Class<TArg0> classe0) {
  ...
  /**
     ...
     * @return An object that can be passed to the fire() method in order to fire the parameterised trigger
     */
  public <TArg0 extends java.lang.Object, TArg1 extends java.lang.Object> TriggerWithParameters2<TArg0, TArg1, S, T> setTriggerParameters(T trigger, Class<TArg0> classe0, Class<TArg1> classe1) {
  ...
  /**
     ...
     * @return An object that can be passed to the fire() method in order to fire the parameterised trigger
     */
  public <TArg0 extends java.lang.Object, TArg1 extends java.lang.Object, TArg2 extends java.lang.Object> TriggerWithParameters3<TArg0, TArg1, TArg2, S, T> setTriggerParameters(T trigger, Class<TArg0> classe0, Class<TArg1> classe1, Class<TArg2> classe2) {
