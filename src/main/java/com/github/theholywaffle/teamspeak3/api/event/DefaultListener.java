...
public class DefaultListener implements TS3Listener {
  ...
  public void onClientLeave(ClientLeaveEvent e) {
    System.out.println("[Player Left] id: " + e.getClientId() + "from:" + e.getClientFromId() + " to:" + e.getClientTargetId() + " name:" + e.getInvokerName());
  }
  ...
  public void onClientMoved(ClientMovedEvent e) {
    System.out.println("[Client Moved] id: " + e.getClientId() + "target-id:" + e.getClientTargetId());
  }
