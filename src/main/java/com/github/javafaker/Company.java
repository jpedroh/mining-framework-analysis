...
public class Company {
  ...
  public String buzzword() {
    @SuppressWarnings(value = { "unchecked" }) List<List<String>> buzzwordLists = (List<List<String>>) faker.fakeValuesService().fetchObject("company.buzzwords");
  ...
  public String catchPhrase() {
    @SuppressWarnings(value = { "unchecked" }) List<List<String>> catchPhraseLists = (List<List<String>>) faker.fakeValuesService().fetchObject("company.buzzwords");
  ...
  /**
     ...
     */
  public String bs() {
    @SuppressWarnings(value = { "unchecked" }) List<List<String>> buzzwordLists = (List<List<String>>) faker.fakeValuesService().fetchObject("company.bs");
