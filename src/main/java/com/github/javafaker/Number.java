...
public class Number {
  ...
  public int numberBetween(int min, int max) {
    ...
    return 
<<<<<<< /usr/src/app/output/dius/java-faker/d3370c84a39f8d0ad2818f6faa6f173e4889a962/src/main/java/com/github/javafaker/Number.java/left.java
    decimalBetween(min, max).setScale(0, RoundingMode.HALF_DOWN).intValue()
=======
    value == max ? value - 1 : value
>>>>>>> /usr/src/app/output/dius/java-faker/d3370c84a39f8d0ad2818f6faa6f173e4889a962/src/main/java/com/github/javafaker/Number.java/right.java
    ;
  }
