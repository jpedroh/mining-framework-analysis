 ...
 *
 */
@SuppressWarnings(value = { "unchecked", "rawtypes" }) public class Faker {
  ...
  public String emailAddress() {
    return join(new Object[] { firstName().toLowerCase(), ".", lastName().toLowerCase(), "@", fetchString("internet.free_email") });
  }
