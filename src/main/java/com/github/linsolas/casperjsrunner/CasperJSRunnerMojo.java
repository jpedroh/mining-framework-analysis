 ...
 * @since 09/04/13
 */
@Mojo(name = "test", defaultPhase = LifecyclePhase.TEST, threadSafe = true) public class CasperJSRunnerMojo extends AbstractMojo {
  /**
     ...
     */
  @Parameter(property = "casperjs.executable") private String casperExecPath;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.tests.directory", defaultValue = "${basedir}/src/test/casperjs") private File testsDir;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.test") private String test;
...
&lt;/testsIncludes&gt;</code>
     */
  @Parameter private List<String> testsIncludes;

  /**
     * A list of <code>&lt;testsExclude&gt;</code> elements specifying the tests (by pattern) that should be excluded in testing.
     */
  @Parameter private List<String> testsExcludes;

  /**
     * Do we ignore the tests failures. If yes, the plugin will not fail at the end if there was tests failures.
     */
  @Parameter(property = "casperjs.ignoreTestFailures", defaultValue = "${maven.test.failure.ignore}") private boolean ignoreTestFailures = false;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.verbose", defaultValue = "${maven.verbose}") private boolean verbose = false;

  /**
     * A flag to indicate if the *.js found in <code>tests.directory</code> should be executed.
     */
  @Parameter(property = "casperjs.include.javascript", defaultValue = "true") private boolean includeJS;

  /**
     * A flag to indicate if the *.coffee found in <code>tests.directory</code> should be executed.
     */
  @Parameter(property = "casperjs.include.coffeescript", defaultValue = "true") private boolean includeCS;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.skip", defaultValue = "${maven.test.skip}") private boolean skip = false;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.pre") private String pre;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.post") private String post;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.includes") private String includes;
...
&lt;/includesPatterns&gt;</code>
     */
  @Parameter private List<String> includesPatterns;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.enableXmlReports", defaultValue = "false") private boolean enableXmlReports;


<<<<<<< /usr/src/app/output/linsolas/casperjs-runner-maven-plugin/98fccc0f940917225388733e66237404f374cdfc/src/main/java/com/github/linsolas/casperjsrunner/CasperJSRunnerMojo.java/left.java
  /**
     * Directory where the xUnit reports will be stored.
     */
  @Parameter(property = "casperjs.reports.directory", defaultValue = "${project.build.directory}/casperjs-reports") private File reportsDir;
=======
  /**
     ...
     */
  @Parameter(property = "casperjs.casperjsVerbose", defaultValue = "false") private boolean casperjsVerbose;
>>>>>>> /usr/src/app/output/linsolas/casperjs-runner-maven-plugin/98fccc0f940917225388733e66237404f374cdfc/src/main/java/com/github/linsolas/casperjsrunner/CasperJSRunnerMojo.java/right.java
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.logLevel") private String logLevel;

  /**
     * Set the value for the CasperJS option --direct: will output log messages directly to the console.
     */
  @Deprecated @Parameter(property = "casperjs.direct", defaultValue = "false") private boolean direct;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.failFast", defaultValue = "false") private boolean failFast;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.engine") private String engine;
  ...
  /**
     ...
     */
  @Parameter(defaultValue = "${project.build.directory}/casperjs") private File targetDir;
  ...
  private int executeScript(File f) {
    ...
    if (StringUtils.isNotBlank(pre)) {
      ...
      if (new File(testsDir, "pre.js").exists()) {
    ...
    if (StringUtils.isNotBlank(post)) {
      ...
      if (new File(testsDir, "post.js").exists()) {
