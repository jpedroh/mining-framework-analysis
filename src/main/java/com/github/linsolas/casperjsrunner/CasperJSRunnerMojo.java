...
&lt;/includesPatterns&gt;</code>
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.enableXmlReport", defaultValue = "false") private boolean enableXmlReport;

  @Parameter(property = "casperjs.generateLogs", defaultValue = "false") private boolean generateLogs;

  @Parameter(property = "casperjs.generateCookies", defaultValue = "false") private boolean generateCookies;

  @Parameter(property = "casperjs.cookies") private String cookies;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.casper.verbose", defaultValue = "false") private boolean casperVerbose;
  ...
  /**
     ...
     */
  @Parameter(property = "casperjs.ignoreSslErrors", defaultValue = "false") private boolean ignoreSslErrors;

  @Parameter(property = "casperjs.proxyAuth") private String proxyAuth;
