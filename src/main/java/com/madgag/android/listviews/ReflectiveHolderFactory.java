 ...
 */
public class ReflectiveHolderFactory<T extends java.lang.Object> implements ViewHolderFactory<T> {
  private final Class<? extends ViewHolder<T>> holderClass;

  public static <T extends java.lang.Object> ReflectiveHolderFactory<T> reflectiveFactoryFor(Class<? extends ViewHolder<T>> holderClass, Object... args) {
    return new ReflectiveHolderFactory<T>(holderClass, args);
  }

  private static Constructor<?> findMatch(final Class<?> clazz, final Class<?>[] types) {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) private ReflectiveHolderFactory(final Class<? extends ViewHolder<T>> holderClass, Object... args) {
    ...
    constructor = (Constructor<? extends ViewHolder<T>>) findMatch(holderClass, types);
    if (constructor == null) {
