...
public final class StreamUtils {
  ...
  /**
     ...
     * @return A stream of zipped values.
     */
  public static <T extends java.lang.Object, O extends java.lang.Object> Stream<O> zip(List<Stream<T>> streams, Function<List<T>, O> combiner) {
  ...
  /**
     ...
     * @return A stream of lists representing the windows
     */
  public static <T extends java.lang.Object> Stream<List<T>> windowed(Stream<T> source, int windowSize, int skip, boolean allowLesserSize) {
  ...
  /**
     ...
     */
  public static <T extends java.lang.Object> Stream<T> streamNullable(T nullable) {
  ...
  /**
     ...
     * @return A stream of zero or one values.
     */
  public static <T extends java.lang.Object> Stream<T> ofSingleNullable(T nullable) {
  ...
  /**
     ...
     */
  public static <T extends java.lang.Object> Stream<T> stream(Iterable<T> iterable) {
  ...
  /**
     ...
     */
  public static <T extends java.lang.Object> Stream<T> ofNullable(Iterable<T> iterable) {
  ...
  /**
     ...
     * @return A stream of zero or more values.
     */
  public static <T extends java.lang.Object> Stream<T> ofNullable(T[] nullable) {
    return null == nullable ? Stream.empty() : Stream.of(nullable);
  }
}