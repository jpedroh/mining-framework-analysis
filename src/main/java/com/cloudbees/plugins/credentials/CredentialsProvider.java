...
public abstract class CredentialsProvider extends Descriptor<CredentialsProvider> implements ExtensionPoint, Describable<CredentialsProvider>, IconSpec {
  ...
  public static final CredentialsProvider NONE = new CredentialsProvider() {
    /**
         * {@inheritDoc}
         */
    @NonNull @Override public <C extends Credentials> List<C> getCredentials(@NonNull Class<C> type, @Nullable ItemGroup itemGroup, @Nullable Authentication authentication) {
  ...
  /**
     ...
     */
  @SuppressFBWarnings(value = "MS_SHOULD_BE_FINAL", justification = "Accessible via System Groovy Scripts") @Restricted(value = NoExternalUse.class) static boolean FINGERPRINT_ENABLED = Boolean.parseBoolean(System.getProperty(FINGERPRINT_ENABLED_NAME, "true"));

  /**
     * Default constructor.
     */
  @SuppressWarnings(value = { "unchecked" }) public CredentialsProvider() {
  ...
  /**
     ...
     */
  @Deprecated @NonNull @SuppressWarnings(value = { "unused" }) public static <C extends Credentials> List<C> lookupCredentials(@NonNull Class<C> type) {
  ...
  /**
     ...
     * or {@link #lookupCredentials(Class, ItemGroup, Authentication, DomainRequirement...)}
     */
  @Deprecated @NonNull @SuppressWarnings(value = { "unused" }) public static <C extends Credentials> List<C> lookupCredentials(@NonNull Class<C> type, @Nullable Authentication authentication) {
  ...
  /**
     ...
     */
  @Deprecated @NonNull @SuppressWarnings(value = { "unused" }) public static <C extends Credentials> List<C> lookupCredentials(@NonNull Class<C> type, @Nullable Item item) {
    return item == null ? lookupCredentials(type, Jenkins.get(), ACL.SYSTEM) : lookupCredentials(type, item, ACL.SYSTEM);
  }
  ...
  /**
     ...
     * or {@link #lookupCredentials(Class, ItemGroup, Authentication, DomainRequirement...)}
     */
  @Deprecated @NonNull @SuppressWarnings(value = { "unused" }) public static <C extends Credentials> List<C> lookupCredentials(@NonNull Class<C> type, @Nullable ItemGroup itemGroup) {
  ...
  /**
     ...
     * or {@link #lookupCredentials(Class, ItemGroup, Authentication, DomainRequirement...)}
     */
  @Deprecated @NonNull @SuppressWarnings(value = { "unchecked", "unused" }) public static <C extends Credentials> List<C> lookupCredentials(@NonNull Class<C> type, @Nullable ItemGroup itemGroup, @Nullable Authentication authentication) {
  ...
  /**
     ...
     * or {@link #lookupCredentials(Class, Item, Authentication, DomainRequirement...)}
     */
  @Deprecated @NonNull @SuppressWarnings(value = { "unused" }) public static <C extends Credentials> List<C> lookupCredentials(@NonNull Class<C> type, @Nullable Item item, @Nullable Authentication authentication) {
  ...
  /**
     ...
     * @since 1.5
     */
  @NonNull @SuppressWarnings(value = { "unchecked", "unused" }) public static <C extends Credentials> List<C> lookupCredentials(@NonNull Class<C> type, @Nullable ItemGroup itemGroup, @Nullable Authentication authentication, @Nullable DomainRequirement... domainRequirements) {
  ...
  /**
     ...
     * @since 1.5
     */
  @NonNull @SuppressWarnings(value = { "unchecked", "unused" }) public static <C extends Credentials> List<C> lookupCredentials(@NonNull Class<C> type, @Nullable ItemGroup itemGroup, @Nullable Authentication authentication, @Nullable List<DomainRequirement> domainRequirements) {
    ...
    if (resolver != null) {
      ...
      final List<Credentials> originals = lookupCredentials(resolver.getFromClass(), itemGroup, authentication, domainRequirements);
  ...
  public static <C extends IdCredentials> ListBoxModel listCredentials(@NonNull Class<C> type, @Nullable ItemGroup itemGroup, @Nullable Authentication authentication, @Nullable List<DomainRequirement> domainRequirements, @Nullable CredentialsMatcher matcher) {
    ...
    for (CredentialsProvider provider : all()) {
      if (provider.isEnabled(itemGroup) && provider.isApplicable(type)) {
        try {
          for (ListBoxModel.Option option : provider.getCredentialIds(type, itemGroup, authentication, domainRequirements, matcher)) {
  ...
  /**
     ...
     * @since 1.5
     */
  @NonNull @SuppressWarnings(value = { "unused" }) public static <C extends Credentials> List<C> lookupCredentials(@NonNull Class<C> type, @Nullable Item item, @Nullable Authentication authentication, DomainRequirement... domainRequirements) {
  ...
  /**
     ...
     * @since 1.5
     */
  @NonNull @SuppressWarnings(value = { "unused" }) public static <C extends Credentials> List<C> lookupCredentials(@NonNull Class<C> type, @Nullable Item item, @Nullable Authentication authentication, @Nullable List<DomainRequirement> domainRequirements) {
    Objects.requireNonNull(type);
    if (item == null) {
    ...
    if (resolver != null) {
      LOGGER.log(Level.FINE, "Resolving legacy credentials of type {0} with resolver {1}", new Object[] { type, resolver });
      final List<Credentials> originals = lookupCredentials(resolver.getFromClass(), item, authentication, domainRequirements);
      LOGGER.log(Level.FINE, "Original credentials for resolving: {0}", originals);
      return resolver.resolve(originals);
    }
    List<C> result = new ArrayList<>();
  ...
  @NonNull public static <C extends IdCredentials> ListBoxModel listCredentials(@NonNull Class<C> type, @Nullable Item item, @Nullable Authentication authentication, @Nullable List<DomainRequirement> domainRequirements, @Nullable CredentialsMatcher matcher) {
    ...
    if (resolver != null && IdCredentials.class.isAssignableFrom(resolver.getFromClass())) {
      LOGGER.log(Level.FINE, "Listing legacy credentials of type {0} identified by resolver {1}", new Object[] { type, resolver });
      return listCredentials((Class) resolver.getFromClass(), item, authentication, domainRequirements, matcher);
    }
    ListBoxModel result = new ListBoxModel();
    Set<String> ids = new HashSet<>();
    for (CredentialsProvider provider : all()) {
      if (provider.isEnabled(item) && provider.isApplicable(type)) {
        try {
          for (ListBoxModel.Option option : provider.getCredentialIds(type, item, authentication, domainRequirements, matcher)) {
            if (ids.add(option.value)) {
              result.add(option);
            }
          }
  ...
  /**
     ...
     * @since 1.14
     */
  @SuppressWarnings(value = { "unchecked" }) public static <C extends Credentials> C snapshot(C credential) {
  ...
  /**
     ...
     * @since 1.14
     */
  @SuppressWarnings(value = { "unchecked" }) public static <C extends Credentials> C snapshot(Class<C> clazz, C credential) {
    Class bestType = null;
  ...
  /**
     ...
     */
  @NonNull static Authentication getDefaultAuthenticationOf(Item item) {
  ...
  @CheckForNull public static <C extends IdCredentials> C findCredentialById(@NonNull String id, @NonNull Class<C> type, @NonNull Run<?, ?> run, @Nullable List<DomainRequirement> domainRequirements) {
    ...
    if (!isParameter || isDefaultValue) {
      ...
      List<C> candidates = new ArrayList<>(CredentialsProvider.lookupCredentials(type, run.getParent(), runAuth, domainRequirements));
      if (runAuth != ACL.SYSTEM && run.hasPermission(runAuth, CredentialsProvider.USE_ITEM)) {
        candidates.addAll(CredentialsProvider.lookupCredentials(type, run.getParent(), ACL.SYSTEM, domainRequirements));
      }
    ...
    if (run.hasPermission(a, CredentialsProvider.USE_ITEM)) {
      Authentication runAuth = CredentialsProvider.getDefaultAuthenticationOf(run.getParent());
      candidates.addAll(CredentialsProvider.lookupCredentials(type, run.getParent(), runAuth, domainRequirements));
      if (runAuth != ACL.SYSTEM && run.hasPermission(runAuth, CredentialsProvider.USE_ITEM)) {
        candidates.addAll(CredentialsProvider.lookupCredentials(type, run.getParent(), ACL.SYSTEM, domainRequirements));
      }
    }
  ...
  @CheckForNull private static <C extends Credentials> C contextualize(@NonNull Class<C> type, @CheckForNull C credentials, @NonNull Run<?, ?> run) {
    if (credentials != null) {
  ...
  /**
     ...
     */
  @CheckForNull private static Map.Entry<User, Run<?, ?>> triggeredBy(Run<?, ?> run) {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public Descriptor<CredentialsProvider> getDescriptor() {
    return this;
  }
  ...
  @NonNull public <C extends IdCredentials> ListBoxModel getCredentialIds(@NonNull Class<C> type, @Nullable ItemGroup itemGroup, @Nullable Authentication authentication, @NonNull List<DomainRequirement> domainRequirements, @NonNull CredentialsMatcher matcher) {
    return getCredentials(type, itemGroup, authentication, domainRequirements).stream().filter(matcher::matches).sorted(new CredentialsNameComparator()).map((c) -> new ListBoxModel.Option(CredentialsNameProvider.name(c), c.getId())).collect(Collectors.toCollection(ListBoxModel::new));
  }
  ...
  @NonNull public <C extends Credentials> List<C> getCredentials(@NonNull Class<C> type, @NonNull Item item, @Nullable Authentication authentication, @NonNull List<DomainRequirement> domainRequirements) {
    return getCredentials(type, item instanceof ItemGroup ? (ItemGroup) item : item.getParent(), authentication, domainRequirements);
  }
  ...
  @NonNull public <C extends IdCredentials> ListBoxModel getCredentialIds(@NonNull Class<C> type, @NonNull Item item, @Nullable Authentication authentication, @NonNull List<DomainRequirement> domainRequirements, @NonNull CredentialsMatcher matcher) {
    ...
    return getCredentials(type, item, authentication, domainRequirements).stream().filter(matcher::matches).sorted(new CredentialsNameComparator()).map((c) -> new ListBoxModel.Option(CredentialsNameProvider.name(c), c.getId())).collect(Collectors.toCollection(ListBoxModel::new));
  }
  ...
  public final List<CredentialsDescriptor> getCredentialsDescriptors() {
    return DescriptorVisibilityFilter.apply(this, ExtensionList.lookup(CredentialsDescriptor.class)).stream().filter(this::_isApplicable).collect(Collectors.toList());
  }
              ...
              for (Iterator<FingerprintFacet> iterator = facets.iterator(); iterator.hasNext(); ) {
                ...
                if (f instanceof NodeCredentialsFingerprintFacet) {
                  if (StringUtils.equals(nodeName, ((NodeCredentialsFingerprintFacet) f).getNodeName())) {
                    ...
                    if (!jenkinsNodeNames.contains(((NodeCredentialsFingerprintFacet) f).getNodeName())) {
                      iterator.remove();
                    }
                  }
                }
        ...
        if (c != null) {
          try {
            ...
            try {
              ...
              for (Iterator<FingerprintFacet> iterator = facets.iterator(); iterator.hasNext(); ) {
                FingerprintFacet f = iterator.next();
                if (f instanceof ItemCredentialsFingerprintFacet && StringUtils.equals(fullName, ((ItemCredentialsFingerprintFacet) f).getItemFullName())) {
                  start = Math.min(start, f.getTimestamp());
                  iterator.remove();
                }
              }
  ...
  /**
     ...
     *
     */
  @Restricted(value = DoNotUse.class) public static void saveAll() {
      ...
      Timer.get().execute(() -> {
        try (ACLContext ctx = ACL.as(ACL.SYSTEM)) {
          ...
          for (User user : User.getAll()) {
            ...
            ACL.impersonate(new UsernamePasswordAuthenticationToken(user.getId(), "", new GrantedAuthority[] { SecurityRealm.AUTHENTICATED_AUTHORITY }));
  ...
  private static class ListBoxModelOptionComparator implements Comparator<ListBoxModel.Option> {
    ...
    /**
         * {@inheritDoc}
         */
    @Override public int compare(ListBoxModel.Option o1, ListBoxModel.Option o2) {
