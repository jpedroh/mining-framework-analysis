...
public class CertificateCredentialsImpl extends BaseStandardCredentials implements StandardCertificateCredentials {
  ...
  /**
     * The keystore.
     */
  @GuardedBy(value = "this") @CheckForNull private transient KeyStore keyStore;

  /**
     * Timestamp of the last time the keystore was modified so that we can track if need to refresh {@link #keyStore}.
     */
  @GuardedBy(value = "this") private transient long keyStoreLastModified;
  ...
  /**
     ...
     */
  @DataBoundConstructor public CertificateCredentialsImpl(@CheckForNull CredentialsScope scope, @CheckForNull String id, @CheckForNull String description, @CheckForNull String password, @NonNull KeyStoreSource keyStoreSource) {
  ...
  /**
     ...
     */
  @CheckForNull private static char[] toCharArray(@NonNull Secret password) {
  ...
  private Object writeReplace() {
    if (Channel.current() == null || keyStoreSource.isSnapshotSource()) {
      return this;
    }
  ...
  /**
     ...
     */
  @NonNull public synchronized KeyStore getKeyStore() {
  ...
  @Extension(ordinal = -1) @Symbol(value = "certificate") public static class DescriptorImpl extends BaseStandardCredentialsDescriptor {
    /**
         * {@inheritDoc}
         */
          ...
          if (keyStore.isCertificateEntry(alias)) {
            ...
            if (keyStore.isKeyEntry(alias)) {
              ...
              try {
                ...
                return FormValidation.warning(e, Messages.CertificateCredentialsImpl_LoadKeyFailed(alias));
              }
            }
          }
        }
        return FormValidation.ok(StringUtils.defaultIfEmpty(StandardCertificateCredentials.NameProvider.getSubjectDN(keyStore), buf.toString()));
  ...
  @Deprecated public static class FileOnMasterKeyStoreSource extends KeyStoreSource {
    /**
         * Our logger.
         */
    ...
    /**
         * {@inheritDoc}
         */
    @NonNull @Override public byte[] getKeyStoreBytes() {
      try {
    ...
    /**
         * {@inheritDoc}
         */
    @Override public long getKeyStoreLastModified() {
  ...
  public static class UploadedKeyStoreSource extends KeyStoreSource implements Serializable {
    ...
    /**
         ...
         */
    @CheckForNull @Deprecated private Secret uploadedKeystore;
    ...
    /**
         ...
         * @since 2.1.5
         */
    @CheckForNull private SecretBytes uploadedKeystoreBytes;
    ...
    /**
         ...
         * @deprecated
         */
    @SuppressWarnings(value = { "unused" }) @Deprecated public UploadedKeyStoreSource(String uploadedKeystore) {
    ...
    /**
         ...
         * @deprecated
         */
    @SuppressWarnings(value = { "unused" }) @Deprecated public UploadedKeyStoreSource(@CheckForNull SecretBytes uploadedKeystore) {
    ...
    /**
         ...
         * @deprecated
         */
    @SuppressWarnings(value = { "unused" }) @Deprecated public UploadedKeyStoreSource(@CheckForNull Secret uploadedKeystore) {
    ...
    /**
         ...
         */
    @SuppressWarnings(value = { "unused" }) @DataBoundConstructor public UploadedKeyStoreSource(FileItem uploadedCertFile, @CheckForNull SecretBytes uploadedKeystore) {
    ...
    public SecretBytes getUploadedKeystore() {
      if (uploadedKeystore != null && uploadedKeystoreBytes == null) {
        String msg = "[INFOLOG] UploadedKeyStoreSource instance using Secret:" + " in Channel: " + (Channel.current() == null ? "false" : "true") + " on controller: " + (JenkinsJVM.isJenkinsJVM() ? "true" : "false");
        LOGGER.log(Level.SEVERE, msg);
        LOGGER.log(Level.INFO, msg);
        System.out.println(msg);
        System.err.println(msg);
        if (Channel.current() != null && !(JenkinsJVM.isJenkinsJVM())) {
          useSecretBytes();
        } else {
    ...
    /**
         * {@inheritDoc}
         */
    @Override public boolean isSnapshotSource() {
    ...
    @Extension public static class DescriptorImpl extends KeyStoreSourceDescriptor {
      ...
      @Deprecated @CheckForNull public static Secret toSecret(@Nullable byte[] contents) {
        return contents == null || contents.length == 0 ? null : Secret.fromString(Base64.getEncoder().encodeToString(contents));
      }
      ...
      /**
             ...
             */
      @SuppressWarnings(value = { "unused" }) @Restricted(value = NoExternalUse.class) @RequirePOST public FormValidation doCheckUploadedKeystore(@QueryParameter String value, @QueryParameter String uploadedCertFile, @QueryParameter String password) {
      ...
      /**
             ...
             */
      @SuppressWarnings(value = { "unused" }) @Restricted(value = NoExternalUse.class) public Upload getUpload(String divId) {
        return new Upload(divId, null);
      }
    }

    @Deprecated public static class Upload {
      /**
             * The id of the {@literal <input>} element on the {@code window.opener} of the pop-up to inject the
             * uploaded content into.
             */
      @NonNull private final String divId;

      /**
             * The uploaded content.
             */
      @CheckForNull private final SecretBytes uploadedKeystore;
      ...
      /**
             ...
             * uploaded content into.
             */
      @NonNull public String getDivId() {
        return divId;
      }
      ...
      /**
             ...
             * @return the content.
             */
      @CheckForNull @SuppressWarnings(value = { "unused" }) public SecretBytes getUploadedKeystore() {
      ...
      /**
             ...
             * @return the response.
             */
      @NonNull public HttpResponse doUpload(@NonNull StaplerRequest req) {
