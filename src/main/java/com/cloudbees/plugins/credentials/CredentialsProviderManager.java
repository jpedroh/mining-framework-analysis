...
@Extension public class CredentialsProviderManager extends DescriptorVisibilityFilter implements Serializable, Saveable {
  ...
  @Override public boolean filter(Object context, @NonNull Descriptor descriptor) {
    ...
    if (restrictions != null && descriptor instanceof CredentialsDescriptor) {
      ...
      if (context instanceof CredentialsProvider) {
        ...
        if (context instanceof CredentialsStore) {
    ...
    if (Jenkins.get().hasPermission(Jenkins.ADMINISTER)) {
      if (restrictions != null) {
        restrictions.sort(new Comparator<CredentialsProviderTypeRestriction>() {
          ...
          /** {@inheritDoc} */
          @Override public int compare(CredentialsProviderTypeRestriction o1, CredentialsProviderTypeRestriction o2) {
  ...
  /**
     ...
     */
  @CheckForNull private Map<CredentialsProviderTypeRestrictionDescriptor, List<CredentialsProviderTypeRestriction>> restrictions() {
    if (restrictionGroups == null && restrictions != null) {
      Map<CredentialsProviderTypeRestrictionDescriptor, List<CredentialsProviderTypeRestriction>> restrictionGroups = new HashMap<>();
  ...
  @Extension public static class Configuration extends GlobalConfiguration {
    /**
         * A Jelly EL short-cut for {@link CredentialsProviderManager#getProviderFilter()}.
         *
         * @return the {@link CredentialsProviderFilter}.
         */
    @SuppressWarnings(value = { "unused" }) public CredentialsProviderFilter getProviderFilter() {
      CredentialsProviderManager manager = getInstance();
    ...
    /**
         ...
         */
    @SuppressWarnings(value = { "unused" }) public void setProviderFilter(CredentialsProviderFilter providerFilter) {
      CredentialsProviderManager manager = getInstance();
      if (manager != null) {
    ...
    /**
         ...
         */
    @SuppressWarnings(value = { "unused" }) public CredentialsTypeFilter getTypeFilter() {
      CredentialsProviderManager manager = getInstance();
    ...
    /**
         ...
         */
    @SuppressWarnings(value = { "unused" }) public void setTypeFilter(CredentialsTypeFilter typeFilter) {
      CredentialsProviderManager manager = getInstance();
      if (manager != null) {
    ...
    /**
         ...
         */
    @SuppressWarnings(value = { "unused" }) public List<CredentialsProviderTypeRestriction> getRestrictions() {
      CredentialsProviderManager manager = getInstance();
    ...
    /**
         ...
         */
    @SuppressWarnings(value = { "unused" }) public void setRestrictions(List<CredentialsProviderTypeRestriction> restrictions) {
      CredentialsProviderManager manager = getInstance();
      if (manager != null) {
