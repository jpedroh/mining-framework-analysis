...
@Extension public class UserCredentialsProvider extends CredentialsProvider {
  ...
  /**
     ...
     */
  @GuardedBy(value = "self") private static final WeakHashMap<User, UserCredentialsProperty> emptyProperties = new WeakHashMap<>();
    ...
    if (!ACL.SYSTEM.equals(authentication)) {
      ...
      if (user != null) {
        ...
        if (property != null) {
          ...
          Supplier<List<C>> credentials = () -> DomainCredentials.getCredentials(property.getDomainCredentialsMap(), type, domainRequirements, always());
  ...
  public static class UserCredentialsProperty extends UserProperty {
    /**
         ...
         * @deprecated
         */
    @Deprecated private transient List<Credentials> credentials;
    ...
    /**
         ...
         * @since 1.5
         */
    @SuppressFBWarnings(value = "IS2_INCONSISTENT_SYNC") private Map<Domain, List<Credentials>> domainCredentialsMap;
    ...
    /**
         ...
         * @since 1.5
         */
    @SuppressWarnings(value = { "deprecation" }) private Object readResolve() {
    ...
    public <C extends Credentials> List<C> getCredentials(Class<C> type) {
      ...
      return getCredentials().stream().filter(type::isInstance).map(type::cast).collect(Collectors.toList());
    }
    ...
    /**
         ...
         * @since 1.5
         */
    @SuppressWarnings(value = { "deprecation" }) @NonNull public synchronized Map<Domain, List<Credentials>> getDomainCredentialsMap() {
      checkPermission(CredentialsProvider.VIEW);
      ...
      if (user.equals(User.current())) {
        ...
        if (property == null) {
          ...
          if (domainCredentialsMap == null || domainCredentialsMap.isEmpty()) {
            ...
            if (domainCredentialsMap.size() == 1) {
    ...
    /**
         * {@inheritDoc}
         */
    @Override public UserProperty reconfigure(StaplerRequest req, JSONObject form) {
      return this;
    }
    ...
    @Extension @SuppressWarnings(value = { "unused" }) public static class DescriptorImpl extends UserPropertyDescriptor {
      /**
             * {@inheritDoc}
             */
      ...
      /**
             ...
             * @since 1.5
             */
      @SuppressWarnings(value = { "unused" }) public DescriptorExtensionList<Credentials, CredentialsDescriptor> getCredentialDescriptors() {
  ...
  @ExportedBean public static class UserFacingAction extends CredentialsStoreAction {
    ...
    /**
         * {@inheritDoc}
         */
    @NonNull @Exported public CredentialsStore getStore() {
      return store;
    }
    ...
    @Override public String getIconFileName() {
      return isVisible() ? "/plugin/credentials/images/user-store.svg" : null;
    }
    ...
    /**
         ...
         */
    @Override public String getIconClassName() {
      return isVisible() ? "icon-credentials-user-store" : null;
    }
  ...
  public static class StoreImpl extends CredentialsStore {
    ...
    /**
         * {@inheritDoc}
         */
    @Override public String getRelativeLinkToContext() {
