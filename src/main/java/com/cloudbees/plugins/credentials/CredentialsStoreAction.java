 ...
 */
@ExportedBean public abstract class CredentialsStoreAction implements Action, IconSpec, AccessControlled, ModelObjectWithContextMenu, ModelObjectWithChildren {
  /**
      ...
      public void marshal(Object source, HierarchicalStreamWriter writer, MarshallingContext context) {
        ...
        try {
          ...
          if (source instanceof Secret) {
            ...
            if (source instanceof SecretBytes) {
  ...
  /**
     ...
     * @since 2.0
     */
  @CheckForNull @SuppressWarnings(value = { "unused" }) public Object getDynamic(String token) {
  ...
  /**
     ...
     * @since 2.0
     */
  @CheckForNull public ContextMenu getContextMenu(String prefix) {
    ContextMenu menu = new ContextMenu();
    if (getStore().isDomainsModifiable() && getStore().hasPermission(MANAGE_DOMAINS)) {
      menu.add(ContextMenuIconUtils.buildUrl(prefix, "newDomain"), getMenuItemIconUrlByClassSpec("icon-credentials-new-domain icon-md"), Messages.CredentialsStoreAction_AddDomainAction());
    }
  ...
  /**
     ...
     * @since 2.0
     */
  @CheckForNull public ContextMenu getChildrenContextMenu(String prefix) {
    ContextMenu menu = new ContextMenu();
    for (Domain d : getStore().getDomains()) {
      MenuItem item = new MenuItem(d.getUrl(), getMenuItemIconUrlByClassSpec("icon-credentials-domain icon-md"), d.isGlobal() ? Messages.CredentialsStoreAction_GlobalDomainDisplayName() : d.getName());
  ...
  /**
     ...
     */
  @Exported @NonNull public Map<String, DomainWrapper> getDomains() {
  ...
  /**
     ...
     */
  @CheckForNull public DomainWrapper getDomain(String name) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public DescriptorExtensionList<DomainSpecification, Descriptor<DomainSpecification>> getSpecificationDescriptors() {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) @Restricted(value = NoExternalUse.class) @RequirePOST public HttpResponse doCreateDomain(StaplerRequest req) throws ServletException, IOException {
    ...
    if (requestContentType.startsWith("application/xml") || requestContentType.startsWith("text/xml")) {
      ...
      Domain domain = (Domain) Items.XSTREAM.unmarshal(new XppDriver().createReader(new StringReader(out.toString())));
  ...
  /**
     * {@inheritDoc}
     */
  @Override public void checkPermission(@NonNull Permission permission) throws AccessDeniedException {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public boolean hasPermission(@NonNull Permission permission) {
    return getACL().hasPermission(permission);
  }

  @ExportedBean public static class DomainWrapper extends AbstractDescribableImpl<DomainWrapper> implements ModelObjectWithContextMenu, ModelObjectWithChildren, AccessControlled {
    /**
    ...
    /**
         ...
         * @return the URL name.
         */
    @Exported @SuppressFBWarnings(value = "NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE", justification = "isGlobal() check implies that domain.getName() is null") public String getUrlName() {
    ...
    /**
         ...
         */
    @NonNull public Map<String, CredentialsWrapper> getCredentials() {
    ...
    /**
         ...
         * @since 2.1.0
         */
    @NonNull @Exported(name = "credentials", visibility = 1) public List<CredentialsWrapper> getCredentialsList() {
    ...
    /**
         ...
         */
    @CheckForNull public CredentialsWrapper getCredential(String id) {
    ...
    /**
         ...
         * @throws IOException      if something goes wrong.
         */
    @RequirePOST @Restricted(value = NoExternalUse.class) @SuppressWarnings(value = { "unused" }) public HttpResponse doCreateCredentials(StaplerRequest req) throws ServletException, IOException {
      ...
      if (requestContentType.startsWith("application/xml") || requestContentType.startsWith("text/xml")) {
        ...
        Credentials credentials = (Credentials) Items.XSTREAM.unmarshal(new XppDriver().createReader(new StringReader(out.toString())));
    ...
    /**
         ...
         * @throws IOException      if something goes wrong.
         */
    @RequirePOST @Restricted(value = NoExternalUse.class) @SuppressWarnings(value = { "unused" }) public HttpResponse doConfigSubmit(StaplerRequest req) throws ServletException, IOException {
      if (!getStore().isDomainsModifiable()) {
    ...
    /**
         ...
         * @throws IOException if something goes wrong.
         */
    @RequirePOST @Restricted(value = NoExternalUse.class) @SuppressWarnings(value = { "unused" }) public HttpResponse doDoDelete(StaplerRequest req) throws IOException {
      if (!getStore().isDomainsModifiable()) {
        return HttpResponses.status(400);
      }
      getStore().checkPermission(MANAGE_DOMAINS);
    ...
    @CheckForNull public ContextMenu getContextMenu(String prefix) {
      if (getStore().hasPermission(CREATE) || (getStore().hasPermission(MANAGE_DOMAINS) && !domain.isGlobal())) {
        ...
        if (getStore().hasPermission(CREATE)) {
          result.add(new MenuItem(ContextMenuIconUtils.buildUrl(prefix, "newCredentials"), getMenuItemIconUrlByClassSpec("icon-credentials-new-credential icon-md"), Messages.CredentialsStoreAction_AddCredentialsAction()));
        }
        if (getStore().hasPermission(MANAGE_DOMAINS) && !domain.isGlobal()) {
          result.add(new MenuItem(ContextMenuIconUtils.buildUrl(prefix, "configure"), getMenuItemIconUrlByClassSpec("icon-setting icon-md"), Messages.CredentialsStoreAction_ConfigureDomainAction()));
          result.add(new MenuItem(ContextMenuIconUtils.buildUrl(prefix, "delete"), getMenuItemIconUrlByClassSpec("icon-edit-delete icon-md"), Messages.CredentialsStoreAction_DeleteDomainAction()));
        }
    ...
    @CheckForNull public ContextMenu getChildrenContextMenu(String prefix) {
      ...
      for (Map.Entry<String, CredentialsWrapper> entry : getCredentials().entrySet()) {
        ...
        MenuItem item = new MenuItem(p, getMenuItemIconUrlByClassSpec(entry.getValue().getIconClassName() + " icon-md"), entry.getValue().getDisplayName());
    ...
    /**
         ...
         * @since 2.1.1
         */
    @WebMethod(name = "config.xml") @Restricted(value = NoExternalUse.class) @SuppressWarnings(value = { "unused" }) public void doConfigDotXml(StaplerRequest req, StaplerResponse rsp) throws IOException {
      getStore().checkPermission(CredentialsProvider.MANAGE_DOMAINS);
      if (req.getMethod().equals("GET")) {
        rsp.setContentType("application/xml");
        Items.XSTREAM2.toXML(domain, new OutputStreamWriter(rsp.getOutputStream(), rsp.getCharacterEncoding()));
        return;
      }
    ...
    /**
         ...
         * @since 2.1.1
         */
    @Restricted(value = NoExternalUse.class) public void updateByXml(Source source) throws IOException {
      getStore().checkPermission(CredentialsProvider.MANAGE_DOMAINS);
      final StringWriter out = new StringWriter();
      try {
    ...
    @Extension public static class DescriptorImpl extends Descriptor<DomainWrapper> {
      /**
             * Default constructor.
             */
      ...
      /**
             ...
             */
      @SuppressWarnings(value = { "unused" }) @Restricted(value = NoExternalUse.class) public FormValidation doCheckName(@AncestorInPath DomainWrapper wrapper, @AncestorInPath CredentialsStoreAction action, @QueryParameter String value) {
  ...
  @ExportedBean public static class CredentialsWrapper extends AbstractDescribableImpl<CredentialsWrapper> implements IconSpec, ModelObjectWithContextMenu, AccessControlled {
    /**
    ...
    /**
         ...
         */
    @Exported public String getDescription() {
      return credentials instanceof StandardCredentials ? ((StandardCredentials) credentials).getDescription() : null;
    }
    ...
    /**
         ...
         * @since 2.1.1
         */
    @Restricted(value = NoExternalUse.class) @Exported(visibility = 1) public Fingerprint getFingerprint() throws IOException {
      if (fingerprint == null) {
    ...
    @SuppressWarnings(value = { "unused" }) @Restricted(value = NoExternalUse.class) public boolean isFingerprintEnabled() {
    ...
    /**
         ...
         * @throws IOException if something goes wrong.
         */
    @RequirePOST @Restricted(value = NoExternalUse.class) @SuppressWarnings(value = { "unused" }) public HttpResponse doDoMove(StaplerRequest req, @QueryParameter String destination) throws IOException {
      ...
      if ("".equals(contextName)) {
        ...
        while (context == null && split > 0) {
          context = contextName.startsWith("user:") ? User.get(contextName.substring("user:".length(), split - 1), false, Collections.emptyMap()) : jenkins.getItemByFullName(contextName);
          if (context == null) {
    ...
    /**
         ...
         * @throws IOException      if something goes wrong.
         */
    @RequirePOST @Restricted(value = NoExternalUse.class) @SuppressWarnings(value = { "unused" }) public HttpResponse doUpdateSubmit(StaplerRequest req) throws ServletException, IOException {
    ...
    /**
         ...
         * @since 2.0
         */
    @CheckForNull @Restricted(value = NoExternalUse.class) public ContextMenu getContextMenu(String prefix) {
      if (getStore().hasPermission(UPDATE) || getStore().hasPermission(DELETE)) {
        ContextMenu result = new ContextMenu();
        if (getStore().hasPermission(UPDATE)) {
          result.add(new MenuItem(ContextMenuIconUtils.buildUrl(prefix, "update"), getMenuItemIconUrlByClassSpec("icon-setting icon-md"), Messages.CredentialsStoreAction_UpdateCredentialAction()));
        }
        if (getStore().hasPermission(DELETE)) {
          result.add(new MenuItem(ContextMenuIconUtils.buildUrl(prefix, "delete"), getMenuItemIconUrlByClassSpec("icon-edit-delete icon-md"), Messages.CredentialsStoreAction_DeleteCredentialAction()));
          result.add(new MenuItem(ContextMenuIconUtils.buildUrl(prefix, "move"), getMenuItemIconUrlByClassSpec("icon-credentials-move icon-md"), Messages.CredentialsStoreAction_MoveCredentialAction()));
        }
        return result.items.isEmpty() ? null : result;
      }
      return null;
    ...
    @WebMethod(name = "config.xml") @Restricted(value = NoExternalUse.class) @SuppressWarnings(value = { "unused" }) public void doConfigDotXml(StaplerRequest req, StaplerResponse rsp) throws IOException {
      if (req.getMethod().equals("GET")) {
        ...
        rsp.setContentType("application/xml");
        SECRETS_REDACTED.toXML(credentials, new OutputStreamWriter(rsp.getOutputStream(), rsp.getCharacterEncoding()));
        return;
      }
    ...
    @Extension public static class DescriptorImpl extends Descriptor<CredentialsWrapper> {
      /**
             ...
             */
      @Restricted(value = NoExternalUse.class) public DescriptorExtensionList<Credentials, CredentialsDescriptor> getCredentialDescriptors() {
