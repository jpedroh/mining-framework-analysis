...
@JsonIgnoreProperties(ignoreUnknown = true) public class RecurlyUnitCurrency {
  @XmlElement(name = "USD") private Integer unitAmountUSD;

  @XmlElement(name = "AUD") private Integer unitAmountAUD;

  @XmlElement(name = "JPY") private Integer unitAmountJPY;

  @XmlElement(name = "CAD") private Integer unitAmountCAD;

  @XmlElement(name = "EUR") private Integer unitAmountEUR;

  @XmlElement(name = "GBP") private Integer unitAmountGBP;

  @XmlElement(name = "CZK") private Integer unitAmountCZK;

  @XmlElement(name = "DKK") private Integer unitAmountDKK;

  @XmlElement(name = "HUF") private Integer unitAmountHUF;

  @XmlElement(name = "NOK") private Integer unitAmountNOK;

  @XmlElement(name = "NZD") private Integer unitAmountNZD;

  @XmlElement(name = "PLN") private Integer unitAmountPLN;

  @XmlElement(name = "SGD") private Integer unitAmountSGD;

  @XmlElement(name = "SEK") private Integer unitAmountSEK;

  @XmlElement(name = "CHF") private Integer unitAmountCHF;

  @XmlElement(name = "ZAR") private Integer unitAmountZAR;
  ...
  @Override public int hashCode() {
    return Objects.hashCode(unitAmountUSD, unitAmountCAD, unitAmountAUD, unitAmountEUR, unitAmountGBP, unitAmountCZK, unitAmountDKK, unitAmountHUF, unitAmountNOK, unitAmountNZD, unitAmountPLN, unitAmountSGD, unitAmountSEK, unitAmountCHF, unitAmountZAR, unitAmountJPY);
  }
}