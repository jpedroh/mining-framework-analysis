...
@XmlRootElement(name = "coupon") public class Coupon extends RecurlyObject {
  ...
  @XmlTransient public static final String GENERATE_RESOURCE = "/generate";

  @XmlTransient public static final String UNIQUE_CODES_RESOURCE = "/unique_coupon_codes";
  ...
  /**
     ...
     */
  @XmlElement(name = "invoice_description") private String invoiceDescription;
  ...
  @XmlElement(name = "discount_type") private DiscountType discountType;

  @XmlElement(name = "free_trial_unit") private FreeTrialUnit freeTrialUnit;

  @XmlElement(name = "free_trial_amount") private Integer freeTrialAmount;
  ...
  @XmlElement(name = "discount_in_cents") private RecurlyUnitCurrency discountInCents;
  ...
  @XmlElement(name = "plan_code") @XmlElementWrapper(name = "plan_codes") private PlanCodes planCodes;
  ...
  /**
     ...
     * attributes.
     */
  @XmlElement(name = "duration") private Duration duration;
  ...
  /**
     ...
     */
  @XmlElement(name = "temporal_unit") private TemporalUnit temporalUnit;
  ...
  /**
     ...
     * be applied to invoices for.
     */
  @XmlElement(name = "temporal_amount") private Integer temporalAmount;

  /**
     * The coupon is valid for one-time, non-plan charges if true, defaults to
     * false.
     */
  @XmlElement(name = "applies_to_non_plan_charges") private Boolean appliesToNonPlanCharges;
  ...
  /**
     ...
     */
  @XmlElement(name = "redemption_resource") private RedemptionResource redemptionResource;

  /**
     * The number of times the coupon can be redeemed on a specific account
     */
  @XmlElement(name = "max_redemptions_per_account") private Integer maxRedemptionsPerAccount;
  ...
  /**
     ...
     * endpoint.
     */
  @XmlElement(name = "coupon_type") private Type type;
  ...
  /**
     ...
     */
  @XmlElement(name = "unique_code_template") private String uniqueCodeTemplate;
  ...
  /**
     ...
     */
  @XmlElement(name = "number_of_unique_codes") private Integer numberOfUniqueCodes;
  ...
  @Override public int hashCode() {
    return Objects.hashCode(appliesForMonths, appliesToAllPlans, appliesToNonPlanCharges, name, couponCode, planCodes, description, discountType, discountPercent, discountInCents, duration, id, invoiceDescription, redeemByDate, singleUse, maxRedemptions, freeTrialUnit, freeTrialAmount, createdAt, redemptionResource, temporalAmount, temporalUnit, type, uniqueCodeTemplate, updatedAt);
  }
}