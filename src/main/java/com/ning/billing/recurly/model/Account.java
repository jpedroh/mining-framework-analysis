...
@XmlRootElement(name = "account") public class Account extends RecurlyObject {
  @XmlTransient public static final String ACCOUNT_RESOURCE = "/accounts";

  @XmlTransient public static final Pattern ACCOUNT_CODE_PATTERN = Pattern.compile(ACCOUNT_RESOURCE + "/(.+)$");

  @XmlTransient private String href;

  @XmlElementWrapper(name = "adjustments") @XmlElement(name = "adjustment") private List<Adjustment> adjustments;

  @XmlElementWrapper(name = "invoices") @XmlElement(name = "invoice") private List<Invoice> invoices;

  @XmlElementWrapper(name = "subscriptions") @XmlElement(name = "subscription") private List<Subscription> subscriptions;

  @XmlElementWrapper(name = "transactions") @XmlElement(name = "transaction") private List<Transaction> transactions;

  @XmlElement(name = "account_code") private String accountCode;
  ...
  @XmlElement(name = "company_name") private String companyName;

  @XmlElement(name = "accept_language") private String acceptLanguage;

  @XmlElement(name = "hosted_login_token") private String hostedLoginToken;

  @XmlElement(name = "created_at") private DateTime createdAt;

  @XmlElement(name = "billing_info") private BillingInfo billingInfo;
