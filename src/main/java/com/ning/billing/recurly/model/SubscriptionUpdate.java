...
public class SubscriptionUpdate extends AbstractSubscription {
  ...
  @XmlElement(name = "imported_trial") private Boolean importedTrial;

  @XmlElement(name = "renewal_billing_cycles") private Integer renewalBillingCycles;

  @XmlElement(name = "auto_renew") private Boolean autoRenew;
  ...
  @Override public int hashCode() {
    return Objects.hashCode(timeframe, couponCode, collectionMethod, shippingAddress, shippingAddressId, customFields, netTerms, poNumber, revenueScheduleType, remainingBillingCycles, importedTrial, renewalBillingCycles, autoRenew);
  }
}