...
@XmlRootElement(name = "invoice") public class Invoice extends RecurlyObject {
  @XmlElement(name = "account") private Account account;

  @XmlElement(name = "original_invoice") private Invoice originalInvoice;

  @XmlElement(name = 
<<<<<<< /usr/src/app/output/killbilling/recurly-java-library/14e6f7bdf9c361a948bb4ce46166c4d05db1daed/src/main/java/com/ning/billing/recurly/model/Invoice.java/left.java
  "original_invoices"
=======
  "gateway_code"
>>>>>>> /usr/src/app/output/killbilling/recurly-java-library/14e6f7bdf9c361a948bb4ce46166c4d05db1daed/src/main/java/com/ning/billing/recurly/model/Invoice.java/right.java
  ) private 
<<<<<<< /usr/src/app/output/killbilling/recurly-java-library/14e6f7bdf9c361a948bb4ce46166c4d05db1daed/src/main/java/com/ning/billing/recurly/model/Invoice.java/left.java
  Invoice
=======
...
>>>>>>> /usr/src/app/output/killbilling/recurly-java-library/14e6f7bdf9c361a948bb4ce46166c4d05db1daed/src/main/java/com/ning/billing/recurly/model/Invoice.java/right.java
  ...
  @XmlElement(name = "invoice_number") private Integer invoiceNumber;

  @XmlElement(name = "invoice_number_prefix") private String invoiceNumberPrefix;

  @XmlElement(name = "po_number") private String poNumber;

  @XmlElement(name = "vat_number") private String vatNumber;

  @XmlElement(name = "subtotal_in_cents") private Integer subtotalInCents;

  @XmlElement(name = "tax_in_cents") private Integer taxInCents;

  @XmlElement(name = "total_in_cents") private Integer totalInCents;
  ...
  @XmlElement(name = "created_at") private DateTime createdAt;

  @XmlElement(name = "updated_at") private DateTime updatedAt;

  @XmlElement(name = "closed_at") private DateTime closedAt;

  @XmlElement(name = "collection_method") private String collectionMethod;

  @XmlElement(name = "net_terms") private Integer netTerms;

  @XmlElement(name = "attempt_next_collection_at") private DateTime attemptNextCollectionAt;

  @XmlElement(name = "recovery_reason") private String recoveryReason;

  @XmlElementWrapper(name = "line_items") @XmlElement(name = "adjustment") private Adjustments lineItems;

  @XmlElementWrapper(name = "transactions") @XmlElement(name = "transaction") private Transactions transactions;
  ...
  @XmlElement(name = "vat_reverse_charge_notes") private String vatReverseChargeNotes;

  @XmlElement(name = "subtotal_before_discount_in_cents") private Integer subtotalBeforeDiscountInCents;

  @XmlElement(name = "discount_in_cents") private Integer discountInCents;

  @XmlElement(name = "balance_in_cents") private Integer balanceInCents;

  @XmlElement(name = "refundable_total_in_cents") private Integer refundableTotalInCents;

  @XmlElement(name = "due_on") private DateTime dueOn;

  @XmlElement(name = "type") private String type;

  @XmlElement(name = "origin") private String origin;
