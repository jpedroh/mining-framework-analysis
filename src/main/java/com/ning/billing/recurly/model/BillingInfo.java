...
@XmlRootElement(name = "billing_info") public class BillingInfo extends RecurlyObject {
  @XmlTransient public static final String BILLING_INFO_RESOURCE = "/billing_info";

  @XmlElement(name = "type") private String type;

  @XmlAttribute(name = "type") private String attributeType;

  @XmlElement(name = "account") private Account account;

  @XmlElement(name = "name_on_account") private String nameOnAccount;

  @XmlElement(name = "first_name") private String firstName;

  @XmlElement(name = "last_name") private String lastName;

  @XmlElement(name = "mandate_reference") private String mandateReference;

  @XmlElement(name = "company") private String company;

  @XmlElement(name = "address1") private String address1;

  @XmlElement(name = "address2") private String address2;
  ...
  @XmlElement(name = "vat_number") private String vatNumber;

  @XmlElement(name = "ip_address") private String ipAddress;

  @XmlElement(name = "ip_address_country") private String ipAddressCountry;

  @XmlElement(name = "account_type") private String accountType;

  @XmlElement(name = "card_type") private String cardType;

  @XmlElement(name = "year") private Integer year;

  @XmlElement(name = "month") private Integer month;

  @XmlElement(name = "first_six") private String firstSix;

  @XmlElement(name = "last_four") private String lastFour;

  @XmlElement(name = "number") private String number;

  @XmlElement(name = "routing_number") private String routingNumber;

  @XmlElement(name = "account_number") private String accountNumber;

  @XmlElement(name = "verification_value") private String verificationValue;

  @XmlElement(name = "token_id") private String tokenId;

  @XmlElement(name = "currency") private String currency;

  @XmlElement(name = "geo_code") private String geoCode;

  @XmlElement(name = "updated_at") private DateTime updatedAt;

  @XmlElement(name = "external_hpp_type") private String externalHppType;

  @XmlElement(name = "gateway_token") private String gatewayToken;

  @XmlElement(name = "gateway_code") private String gatewayCode;

  @XmlElement(name = "amazon_billing_agreement_id") private String amazonBillingAgreementId;

  @XmlElement(name = "amazon_region") private String amazonRegion;

  @XmlElement(name = "three_d_secure_action_result_token_id") private String threeDSecureActionResultTokenId;

  @XmlElement(name = "transaction_type") private String transactionType;

  @XmlElement(name = "iban") private String iban;

  @XmlElement(name = "sort_code") private String sortCode;

  @XmlElement(name = "bsb_code") private String bsbCode;
  ...
  /**
     ...
     * @param account
     */
  @Deprecated public void setAccount(final Account account) {
  ...
  @Override public String toString() {
    ...
    if (account != null && account.getBillingInfo() != null && this.getHref() != null && this.getHref().equals(account.getBillingInfo().getHref())) {
  ...
  @Override public int hashCode() {
    return Objects.hashCode(account, nameOnAccount, firstName, lastName, mandateReference, company, address1, address2, city, state, zip, country, phone, vatNumber, ipAddress, ipAddressCountry, accountType, cardType, year, month, firstSix, lastFour, number, routingNumber, accountNumber, updatedAt, geoCode, type, externalHppType, gatewayToken, gatewayCode, amazonBillingAgreementId, amazonRegion, threeDSecureActionResultTokenId, transactionType, iban, sortCode, bsbCode);
  }
}