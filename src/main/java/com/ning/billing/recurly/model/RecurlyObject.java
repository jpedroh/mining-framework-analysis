...
@JsonIgnoreProperties(ignoreUnknown = true) public abstract class RecurlyObject {
  @XmlTransient private RecurlyClient recurlyClient;

  @XmlTransient protected String href;
  ...
  @JsonProperty public void setHref(final Object href) {
  ...
  @SuppressWarnings(value = { "unchecked" }) public static <E extends Enum<E>> E enumOrNull(Class<E> enumClass, @Nullable final Object object, final Boolean upCase) {
    if (isNull(object)) {
      return null;
    } else {
  ...
  @SuppressWarnings(value = { "unchecked" }) public static <E extends Enum<E>> E enumOrNull(Class<E> enumClass, @Nullable final Object object) {
