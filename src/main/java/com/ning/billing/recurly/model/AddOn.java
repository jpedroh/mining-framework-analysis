...
@XmlRootElement(name = "add_on") public class AddOn extends AbstractAddOn {
  @XmlTransient public static final String ADDONS_RESOURCE = "/add_ons";

  @XmlElement(name = "name") private String name;

  @XmlElement(name = 
<<<<<<< /usr/src/app/output/killbilling/recurly-java-library/cc90a56d89d2acd4c4e4b8e00a60c8523ce96292/src/main/java/com/ning/billing/recurly/model/AddOn.java/left.java
  "item_code"
=======
  "tier_type"
>>>>>>> /usr/src/app/output/killbilling/recurly-java-library/cc90a56d89d2acd4c4e4b8e00a60c8523ce96292/src/main/java/com/ning/billing/recurly/model/AddOn.java/right.java
  ) private String 
<<<<<<< /usr/src/app/output/killbilling/recurly-java-library/cc90a56d89d2acd4c4e4b8e00a60c8523ce96292/src/main/java/com/ning/billing/recurly/model/AddOn.java/left.java
  itemCode
=======
...
>>>>>>> /usr/src/app/output/killbilling/recurly-java-library/cc90a56d89d2acd4c4e4b8e00a60c8523ce96292/src/main/java/com/ning/billing/recurly/model/AddOn.java/right.java
  ...
  @XmlElement(name = "display_quantity_on_hosted_page") private Boolean displayQuantityOnHostedPage;

  @XmlElement(name = "default_quantity") private Integer defaultQuantity;

  @XmlElement(name = "unit_amount_in_cents") private RecurlyUnitCurrency unitAmountInCents;

  @XmlElement(name = "created_at") private DateTime createdAt;

  @XmlElement(name = "updated_at") private DateTime updatedAt;

  @XmlElement(name = "measured_unit") private MeasuredUnit measuredUnit;

  @XmlElement(name = "add_on_type") private String addOnType;

  @XmlElement(name = "tax_code") private String taxCode;

  @XmlElement(name = "accounting_code") private String accountingCode;

  @XmlElement(name = "optional") private Boolean optional;

  @XmlElementWrapper(name = "tiers") @XmlElement(name = "tier") protected Tiers tiers;
...
>>>>>>> /usr/src/app/output/killbilling/recurly-java-library/cc90a56d89d2acd4c4e4b8e00a60c8523ce96292/src/main/java/com/ning/billing/recurly/model/AddOn.java/right.java
  ...
  @Override public int hashCode() {
    return Objects.hashCode(name, itemCode, measuredUnit, addOnType, displayQuantityOnHostedPage, defaultQuantity, unitAmountInCents, createdAt, updatedAt, taxCode, accountingCode, optional, tierType, tiers);
  }
}