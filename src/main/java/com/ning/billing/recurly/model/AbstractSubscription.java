...
@XmlRootElement(name = "subscription") public class AbstractSubscription extends RecurlyObject {
  public static final String SUBSCRIPTION_RESOURCE = "/subscriptions";

  @XmlElement(name = "unit_amount_in_cents") protected Integer unitAmountInCents;

  @XmlElement(name = "quantity") protected Integer quantity;

  @XmlElementWrapper(name = "subscription_add_ons") @XmlElement(name = "subscription_add_on") protected List<AddOn> addOns;
