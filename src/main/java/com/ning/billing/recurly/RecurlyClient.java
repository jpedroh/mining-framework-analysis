...
public class RecurlyClient {
  ...
  @VisibleForTesting static final String GIT_COMMIT_ID_DESCRIBE_SHORT = "git.commit.id.describe-short";
  ...
  public Account reopenAccount(final String accountCode) {
    return doPUT(Account.ACCOUNT_RESOURCE + "/" + urlEncode(accountCode) + "/reopen", null, Account.class);
  }
  ...
  public Adjustment createAccountAdjustment(final String accountCode, final Adjustment adjustment) {
    return doPOST(Account.ACCOUNT_RESOURCE + "/" + urlEncode(accountCode) + Adjustments.ADJUSTMENTS_RESOURCE, adjustment, Adjustment.class);
  }
  ...
  public Subscription getSubscription(final String uuid) {
    ...
    return doGET(Subscriptions.SUBSCRIPTIONS_RESOURCE + "/" + urlEncode(uuid), Subscription.class);
  }
  ...
  public Subscription cancelSubscription(final Subscription subscription) {
    return doPUT(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscription.getUuid()) + "/cancel", subscription, Subscription.class);
  }
  ...
  public Subscription cancelSubscription(final String subscriptionUuid, final SubscriptionUpdate.Timeframe timeframe) {
    ...
    if (timeframe != null) {
      qp.put("timeframe", timeframe.toString());
    }
    return doPUT(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscriptionUuid) + "/cancel", null, Subscription.class, qp);
  }
  ...
  public Subscription pauseSubscription(final String subscriptionUuid, final int remainingPauseCycles) {
    ...
    return doPUT(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscriptionUuid) + "/pause", request, Subscription.class);
  }
  ...
  public Subscription convertTrialMoto(final String subscriptionUuid) {
    ...
    return doPUT(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscriptionUuid) + "/convert_trial", request, Subscription.class);
  }
  ...
  public Subscription resumeSubscription(final String subscriptionUuid) {
    return doPUT(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscriptionUuid) + "/resume", null, Subscription.class);
  }
  ...
  public Subscription postponeSubscription(final Subscription subscription, final DateTime nextBillDate) {
    ...
    return doPUT(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscription.getUuid()) + "/postpone", subscription, Subscription.class, params);
  }
  ...
  public void terminateSubscription(final Subscription subscription, final RefundOption refund) {
    ...
    doPUT(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscription.getUuid()) + "/terminate", subscription, Subscription.class, params);
  }
  ...
  public Subscription reactivateSubscription(final Subscription subscription) {
    return doPUT(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscription.getUuid()) + "/reactivate", subscription, Subscription.class);
  }
  ...
  public Subscription updateSubscription(final String uuid, final SubscriptionUpdate subscriptionUpdate) {
    return doPUT(Subscriptions.SUBSCRIPTIONS_RESOURCE + "/" + urlEncode(uuid), subscriptionUpdate, Subscription.class);
  }
  ...
  public Subscription updateSubscriptionPreview(final String uuid, final SubscriptionUpdate subscriptionUpdate) {
    return doPOST(Subscriptions.SUBSCRIPTIONS_RESOURCE + "/" + urlEncode(uuid) + "/preview", subscriptionUpdate, Subscription.class);
  }
  ...
  public Subscription updateSubscriptionNotes(final String uuid, final SubscriptionNotes subscriptionNotes) {
    return doPUT(SubscriptionNotes.SUBSCRIPTION_RESOURCE + "/" + urlEncode(uuid) + "/notes", subscriptionNotes, Subscription.class);
  }
  ...
  public Subscriptions getAccountSubscriptions(final String accountCode) {
    return doGET(Account.ACCOUNT_RESOURCE + "/" + urlEncode(accountCode) + Subscriptions.SUBSCRIPTIONS_RESOURCE, Subscriptions.class, new QueryParams());
  }
  ...
  public Subscriptions getSubscriptions() {
    return doGET(Subscriptions.SUBSCRIPTIONS_RESOURCE, Subscriptions.class, new QueryParams());
  }
  ...
  public Subscriptions getSubscriptions(final SubscriptionState state, final QueryParams params) {
    ...
    return doGET(Subscriptions.SUBSCRIPTIONS_RESOURCE, Subscriptions.class, params);
  }
  ...
  public Subscriptions getAccountSubscriptions(final String accountCode, final SubscriptionState state, final QueryParams params) {
    ...
    return doGET(Account.ACCOUNT_RESOURCE + "/" + urlEncode(accountCode) + Subscriptions.SUBSCRIPTIONS_RESOURCE, Subscriptions.class, params);
  }
  ...
  public Subscriptions getInvoiceSubscriptions(final String invoiceId, final QueryParams params) {
    return doGET(Invoices.INVOICES_RESOURCE + "/" + urlEncode(invoiceId) + Subscriptions.SUBSCRIPTIONS_RESOURCE, Subscriptions.class, params);
  }
  ...
  public Usage postSubscriptionUsage(final String subscriptionCode, final String addOnCode, final Usage usage) {
    return doPOST(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscriptionCode) + AddOn.ADDONS_RESOURCE + "/" + urlEncode(addOnCode) + Usage.USAGE_RESOURCE, usage, Usage.class);
  }
  ...
  public Usages getSubscriptionUsages(final String subscriptionCode, final String addOnCode, final QueryParams params) {
    return doGET(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscriptionCode) + AddOn.ADDONS_RESOURCE + "/" + urlEncode(addOnCode) + Usage.USAGE_RESOURCE, Usages.class, params);
  }
  ...
  /**
     ...
     * @return Subscriptions on the account
     */
  @Deprecated public Subscriptions getAccountSubscriptions(final String accountCode, final String status) {
    final QueryParams params = new QueryParams();
    if (status != null) {
  ...
  public void bulkUpdate(final String id, final DunningCampaignBulkUpdate dunningCampaignBulkUpdate) {
    doPUT(DunningCampaign.DUNNING_CAMPAIGNS_RESOURCE + "/" + urlEncode(id) + "/bulk_update", dunningCampaignBulkUpdate, DunningCampaignBulkUpdate.class);
  }
  ...
  public Accounts getInvoiceTemplateAccounts(final String invoiceTemplateUuid, final QueryParams params) {
    return doGET(InvoiceTemplate.INVOICE_TEMPLATES_RESOURCE + "/" + urlEncode(invoiceTemplateUuid) + Accounts.ACCOUNTS_RESOURCE, Accounts.class, params);
  }
  ...
  public BillingInfo createOrUpdateBillingInfo(final String accountCode, final BillingInfo billingInfo) {
    return doPUT(Account.ACCOUNT_RESOURCE + "/" + urlEncode(accountCode) + BillingInfo.BILLING_INFO_RESOURCE, billingInfo, BillingInfo.class);
  }

  public BillingInfo createBillingInfo(final String accountCode, final BillingInfo billingInfo) {
    return doPOST(Account.ACCOUNT_RESOURCE + "/" + urlEncode(accountCode) + BillingInfos.BILLING_INFOS_RESOURCE, billingInfo, BillingInfo.class);
  }

  public BillingInfo updateBillingInfo(final String accountCode, final String uuid, final BillingInfo billingInfo) {
    return doPUT(Account.ACCOUNT_RESOURCE + "/" + urlEncode(accountCode) + BillingInfos.BILLING_INFOS_RESOURCE + "/" + urlEncode(uuid), billingInfo, BillingInfo.class);
  }

  public BillingInfo getBillingInfoByUuid(final String accountCode, final String uuid) {
    return doGET(Account.ACCOUNT_RESOURCE + "/" + urlEncode(accountCode) + BillingInfos.BILLING_INFOS_RESOURCE + "/" + urlEncode(uuid), BillingInfo.class);
  }

  public BillingInfos getBillingInfos(final String accountCode) {
    return doGET(Account.ACCOUNT_RESOURCE + "/" + urlEncode(accountCode) + BillingInfos.BILLING_INFOS_RESOURCE, BillingInfos.class);
  }
  ...
  /**
     ...
     * @return the newly created or update billing info object on success, null otherwise
     */
  @Deprecated public BillingInfo createOrUpdateBillingInfo(final BillingInfo billingInfo) {
  ...
  public BillingInfo getBillingInfo(final String accountCode) {
    return doGET(Account.ACCOUNT_RESOURCE + "/" + urlEncode(accountCode) + BillingInfo.BILLING_INFO_RESOURCE, BillingInfo.class);
  }
  ...
  public AccountNotes getAccountNotes(final String accountCode) {
    return doGET(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + AccountNotes.ACCOUNT_NOTES_RESOURCE, AccountNotes.class, new QueryParams());
  }
  ...
  public Entitlements getEntitlements(final String accountCode) {
    return doGET(Account.ACCOUNT_RESOURCE + "/" + urlEncode(accountCode) + Entitlements.ENTITLEMENTS_RESOURCE, Entitlements.class);
  }
  ...
  public Transactions getAccountTransactions(final String accountCode) {
    return doGET(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + Transactions.TRANSACTIONS_RESOURCE, Transactions.class, new QueryParams());
  }
  ...
  public Transactions getAccountTransactions(final String accountCode, final TransactionState state, final TransactionType type, final QueryParams params) {
    ...
    return doGET(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + Transactions.TRANSACTIONS_RESOURCE, Transactions.class, params);
  }
  ...
  public Transaction getTransaction(final String transactionId) {
    ...
    return doGET(Transactions.TRANSACTIONS_RESOURCE + "/" + urlEncode(transactionId), Transaction.class);
  }
  ...
  public Subscriptions getTransactionSubscriptions(final String transactionId) {
    return doGET(Transactions.TRANSACTIONS_RESOURCE + "/" + urlEncode(transactionId) + Subscriptions.SUBSCRIPTIONS_RESOURCE, Subscriptions.class, new QueryParams());
  }
  ...
  /**
     ...
     * @return the invoice
     */
  @Deprecated public Invoice getInvoice(final Integer invoiceId) {
  ...
  /**
     ...
     */
  @Deprecated public InputStream getInvoicePdf(final Integer invoiceId) {
  ...
  public Transactions getInvoiceTransactions(final String invoiceId) {
    return doGET(Invoices.INVOICES_RESOURCE + "/" + urlEncode(invoiceId) + Transactions.TRANSACTIONS_RESOURCE, Transactions.class, new QueryParams());
  }
  ...
  public Invoices getAccountInvoices(final String accountCode) {
    return doGET(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + Invoices.INVOICES_RESOURCE, Invoices.class, new QueryParams());
  }
  ...
  public Invoices getOriginalInvoices(final String invoiceId) {
    return doGET(Invoices.INVOICES_RESOURCE + "/" + urlEncode(invoiceId) + "/original_invoices", Invoices.class, new QueryParams());
  }
  ...
  /**
     ...
     * @return the refunded invoice
     */
  @Deprecated public Invoice refundInvoice(final String invoiceId, List<AdjustmentRefund> lineItems, final RefundMethod method) {
    final InvoiceRefund invoiceRefund = new InvoiceRefund();
    invoiceRefund.setRefundMethod(method);
  ...
  public ShippingAddresses getAccountShippingAddresses(final String accountCode) {
    return doGET(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + ShippingAddresses.SHIPPING_ADDRESSES_RESOURCE, ShippingAddresses.class, new QueryParams());
  }
  ...
  public ShippingAddress getShippingAddress(final String accountCode, final long shippingAddressId) {
    return doGET(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + ShippingAddresses.SHIPPING_ADDRESSES_RESOURCE + "/" + shippingAddressId, ShippingAddress.class);
  }
  ...
  public ShippingAddress createShippingAddress(final String accountCode, final ShippingAddress shippingAddress) {
    return doPOST(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + ShippingAddresses.SHIPPING_ADDRESSES_RESOURCE, shippingAddress, ShippingAddress.class);
  }
  ...
  public ShippingAddress updateShippingAddress(final String accountCode, final long shippingAddressId, ShippingAddress shippingAddress) {
    return doPUT(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + ShippingAddresses.SHIPPING_ADDRESSES_RESOURCE + "/" + shippingAddressId, shippingAddress, ShippingAddress.class);
  }
  ...
  public Invoices getAccountInvoices(final String accountCode, final InvoiceState state, final QueryParams params) {
    ...
    return doGET(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + Invoices.INVOICES_RESOURCE, Invoices.class, params);
  }
  ...
  /**
     ...
     * @param invoiceId Recurly Invoice ID
     */
  @Deprecated public Invoice markInvoiceSuccessful(final Integer invoiceId) {
  ...
  /**
     ...
     * @param invoiceId Recurly Invoice ID
     */
  @Deprecated public InvoiceCollection markInvoiceFailed(final Integer invoiceId) {
  ...
  /**
     ...
     */
  @Deprecated public Transaction enterOfflinePayment(final Integer invoiceId, final Transaction payment) {
  ...
  public void deleteItem(final String itemCode) {
    doDELETE(Item.ITEMS_RESOURCE + "/" + urlEncode(itemCode));
  }
  ...
  public void deletePlan(final String planCode) {
    doDELETE(Plan.PLANS_RESOURCE + "/" + urlEncode(planCode));
  }
  ...
  public AddOn createPlanAddOn(final String planCode, final AddOn addOn) {
    return doPOST(Plan.PLANS_RESOURCE + "/" + urlEncode(planCode) + AddOn.ADDONS_RESOURCE, addOn, AddOn.class);
  }
  ...
  public AddOn getAddOn(final String planCode, final String addOnCode) {
    ...
    return doGET(Plan.PLANS_RESOURCE + "/" + urlEncode(planCode) + AddOn.ADDONS_RESOURCE + "/" + addOnCode, AddOn.class);
  }
  ...
  public AddOns getAddOns(final String planCode) {
    return doGET(Plan.PLANS_RESOURCE + "/" + urlEncode(planCode) + AddOn.ADDONS_RESOURCE, AddOns.class, new QueryParams());
  }
  ...
  public AddOns getAddOns(final String planCode, final QueryParams params) {
    return doGET(Plan.PLANS_RESOURCE + "/" + urlEncode(planCode) + AddOn.ADDONS_RESOURCE, AddOns.class, params);
  }
  ...
  public AddOn updateAddOn(final String planCode, final String addOnCode, final AddOn addOn) {
    return doPUT(Plan.PLANS_RESOURCE + "/" + urlEncode(planCode) + AddOn.ADDONS_RESOURCE + "/" + urlEncode(addOnCode), addOn, AddOn.class);
  }
  ...
  public Coupon restoreCoupon(final String couponCode, final Coupon coupon) {
    return doPUT(Coupon.COUPON_RESOURCE + "/" + urlEncode(couponCode) + Coupon.RESTORE_RESOURCE, coupon, Coupon.class);
  }
  ...
  public Redemption getCouponRedemptionByAccount(final String accountCode) {
    return doGET(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + Redemption.REDEMPTION_RESOURCE, Redemption.class);
  }
  ...
  public Redemptions getCouponRedemptionsByAccount(final String accountCode) {
    return doGET(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + Redemption.REDEMPTIONS_RESOURCE, Redemptions.class, new QueryParams());
  }
  ...
  public Redemptions getCouponRedemptionsByAccount(final String accountCode, final QueryParams params) {
    return doGET(Accounts.ACCOUNTS_RESOURCE + "/" + urlEncode(accountCode) + Redemption.REDEMPTIONS_RESOURCE, Redemptions.class, params);
  }
  ...
  /**
     ...
     */
  @Deprecated public Redemption getCouponRedemptionByInvoice(final Integer invoiceNumber) {
  ...
  public Redemption getCouponRedemptionByInvoice(final String invoiceId) {
    return doGET(Invoices.INVOICES_RESOURCE + "/" + urlEncode(invoiceId) + Redemption.REDEMPTION_RESOURCE, Redemption.class);
  }
  ...
  /**
     ...
     * @return the coupon redemptions for this invoice on success, null otherwise
     */
  @Deprecated public Redemptions getCouponRedemptionsByInvoice(final Integer invoiceNumber, final QueryParams params) {
  ...
  public Redemptions getCouponRedemptionsByInvoice(final String invoiceId, final QueryParams params) {
    return doGET(Invoices.INVOICES_RESOURCE + "/" + urlEncode(invoiceId) + Redemption.REDEMPTIONS_RESOURCE, Redemptions.class, params);
  }
  ...
  public Redemptions getCouponRedemptionsBySubscription(final String subscriptionUuid, final QueryParams params) {
    return doGET(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscriptionUuid) + Redemptions.REDEMPTIONS_RESOURCE, Redemptions.class, params);
  }
  ...
  public Coupons getUniqueCouponCodes(final String couponCode, final QueryParams params) {
    return doGET(Coupon.COUPON_RESOURCE + "/" + urlEncode(couponCode) + Coupon.UNIQUE_CODES_RESOURCE, Coupons.class, params);
  }
  ...
  private <T extends java.lang.Object> T doGET(final String resource, final Class<T> clazz, QueryParams params) {
  ...
  public <T extends java.lang.Object> T doGETWithFullURL(final Class<T> clazz, final String url) {
    if (debug()) {
  ...
  private <T extends java.lang.Object> T doPOST(final String resource, final RecurlyObject payload, final Class<T> clazz) {
    ...
    if (xmlPayload != null) {
      builder.setEntity(new StringEntity(xmlPayload, ContentType.APPLICATION_XML.withCharset(Charsets.UTF_8)));
    }
  ...
  private <T extends java.lang.Object> T doPUT(final String resource, final RecurlyObject payload, final Class<T> clazz, final QueryParams params) {
    final String xmlPayload;
    try {
      if (payload != null) {
        xmlPayload = RecurlyObject.sharedXmlMapper().writeValueAsString(payload);
  ...
  private <T extends java.lang.Object> T callRecurlySafeXmlContent(final HttpRequestBase builder, @Nullable final Class<T> clazz) {
    try {
  ...
  private <T extends java.lang.Object> T callRecurlyXmlContent(final HttpRequestBase builder, @Nullable final Class<T> clazz) throws IOException {
    clientRequestBuilderCommon(builder);
    builder.setHeader(HttpHeaders.ACCEPT, "application/xml");
    builder.setHeader(HttpHeaders.CONTENT_TYPE, "application/xml; charset=utf-8");
    CloseableHttpResponse response = null;
    try {
      ...
      if (obj instanceof RecurlyObject) {
        ...
        if (obj instanceof RecurlyObjects) {
  ...
  protected CloseableHttpClient createHttpClient() throws KeyManagementException, NoSuchAlgorithmException {
    final HttpClientBuilder httpClientBuilder = HttpClients.custom().disableCookieManagement().setMaxConnPerRoute(256).setMaxConnTotal(512).setDefaultRequestConfig(RequestConfig.custom().setConnectTimeout(5000).setSocketTimeout(60000).build()).setSSLContext(SslUtils.getInstance().getSSLContext());
  ...
  @VisibleForTesting String getUserAgent() {
    return userAgent;
  }
  ...
  private static String buildUserAgent() {
    ...
    try {
      ...
      final URL resourceURL = MoreObjects.firstNonNull(Thread.currentThread().getContextClassLoader(), RecurlyClient.class.getClassLoader()).getResource(GIT_PROPERTIES_FILE);
      Reader reader = null;
      try {
  ...
  @VisibleForTesting static String getVersionFromGitRepositoryState(final Properties gitRepositoryState) {
  ...
  private static String urlEncode(String s) {
    return new String(URLCodec.encodeUrl(RFC_3986_SAFE_CHARS, s.getBytes(Charsets.UTF_8)), Charsets.UTF_8);
  }
