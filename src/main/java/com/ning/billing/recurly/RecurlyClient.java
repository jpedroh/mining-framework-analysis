...
public class RecurlyClient {
  ...
  public Subscription postponeSubscription(final Subscription subscription, final DateTime renewaldate) {
    return doPUT(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscription.getUuid()) + "/postpone?next_renewal_date=" + renewaldate, subscription, Subscription.class);
  }
  ...
  public void terminateSubscription(final Subscription subscription, final RefundOption refund) {
    doPUT(Subscription.SUBSCRIPTION_RESOURCE + "/" + urlEncode(subscription.getUuid()) + "/terminate?refund=" + refund, subscription, Subscription.class);
  }
  ...
  private InputStream callRecurlySafeGetPdf(String url) {
    ...
    try {
      response = clientRequestBuilderCommon(client.prepareGet(url)).addHeader("Accept", "application/pdf").addHeader("Content-Type", "application/pdf").execute().get();
...
>>>>>>> /usr/src/app/output/killbilling/recurly-java-library/12a461e91eecef158fb2c17ae39cf7cd240bab92/src/main/java/com/ning/billing/recurly/RecurlyClient.java/right.java
  ...
  private FluentCaseInsensitiveStringsMap callRecurlyNoContent(final AsyncHttpClient.BoundRequestBuilder builder) {
    try {
      final Response response = clientRequestBuilderCommon(builder).addHeader("Accept", "application/xml").addHeader("Content-Type", "application/xml; charset=utf-8").execute().get();
  ...
  private <T extends java.lang.Object> T callRecurlySafeXmlContent(final AsyncHttpClient.BoundRequestBuilder builder, @Nullable final Class<T> clazz) {
    try {
      ...
      if (e.getCause() instanceof ConnectException) {
        ...
        if (e.getCause() != null && e.getCause().getCause() != null && e.getCause().getCause() instanceof TransactionErrorException) {
          throw (TransactionErrorException) e.getCause().getCause();
        } else {
          if (e.getCause() != null && e.getCause() instanceof TransactionErrorException) {
  ...
  private <T extends java.lang.Object> T callRecurlyXmlContent(final AsyncHttpClient.BoundRequestBuilder builder, @Nullable final Class<T> clazz) throws IOException, ExecutionException, InterruptedException {
    final Response response = clientRequestBuilderCommon(builder).addHeader("Accept", "application/xml").addHeader("Content-Type", "application/xml; charset=utf-8").execute().get();
...
<<<<<<< /usr/src/app/output/killbilling/recurly-java-library/12a461e91eecef158fb2c17ae39cf7cd240bab92/src/main/java/com/ning/billing/recurly/RecurlyClient.java/left.java
          errors.getTransactionError() == null && errors.getRecurlyErrors() == null
=======
          errors.getRecurlyErrors() == null && errors.getTransaction() == null && errors.getTransactionError() == null
>>>>>>> /usr/src/app/output/killbilling/recurly-java-library/12a461e91eecef158fb2c17ae39cf7cd240bab92/src/main/java/com/ning/billing/recurly/RecurlyClient.java/right.java
          )) {
...
>>>>>>> /usr/src/app/output/killbilling/recurly-java-library/12a461e91eecef158fb2c17ae39cf7cd240bab92/src/main/java/com/ning/billing/recurly/RecurlyClient.java/right.java
  ...
  @VisibleForTesting String getVersionFromGitRepositoryState(final Properties gitRepositoryState) {
  ...
  private static String urlEncode(String s) {
    try {
      return URLEncoder.encode(s, Charsets.UTF_8.name()).replace("+", "%20").replace("*", "%2A");
