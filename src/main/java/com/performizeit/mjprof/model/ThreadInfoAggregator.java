...
public class ThreadInfoAggregator {
  ...
  public void mergeNonKeyProps(ThreadInfo target, ThreadInfo threadInfo) {
    ...
    for (String prop1 : keys) {
      if (prop1.equals(STACK) || prop1.equals(COUNT) || prop1.equals(CPUNS) || prop1.equals(WALL) || prop1.equals(CPU_PREC) || propsMap.contains(prop1)) {
        continue;
      }
      if (propsMap.contains(prop1)) {
        continue;
      }
