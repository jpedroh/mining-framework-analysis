  ...
  public static void main(String[] args) throws IOException {
    ...
    for (MJStep mjstep : steps) {
      ...
      if (mjstep.getStepName().equals("group")) {
        ...
        if (mjstep.getStepName().equals("list")) {
          gbp = new ListProps();
        } else {
          if (mjstep.getStepName().equals("count")) {
