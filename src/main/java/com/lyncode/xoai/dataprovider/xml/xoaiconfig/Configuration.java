 ...
 * 
 */
@XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "contexts", "formats", "transformers", "filters", "sets" }) @XmlRootElement(name = "Configuration") public class Configuration {
  @XmlElement(name = "Contexts", required = true) protected Configuration.Contexts contexts;

  @XmlElement(name = "Formats", required = true) protected Configuration.Formats formats;

  @XmlElement(name = "Transformers") protected Configuration.Transformers transformers;

  @XmlElement(name = "Filters") protected Configuration.Filters filters;

  @XmlElement(name = "Sets") protected Configuration.Sets sets;

  @XmlAttribute(name = "maxListRecordsSize") protected Integer maxListRecordsSize;

  @XmlAttribute(name = "maxListSetsSize") protected Integer maxListSetsSize;

  @XmlAttribute(name = "maxListIdentifiersSize") protected Integer maxListIdentifiersSize;

  @XmlAttribute(name = "indentation") protected Boolean indentation;

  @XmlAttribute(name = "stylesheet") protected String stylesheet;

  @XmlAttribute(name = "descriptionFile") protected String descriptionFile;
  ...
  @XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "context" }) public static class Contexts {
    @XmlElement(name = "Context", required = true) protected List<Configuration.Contexts.Context> context;
    ...
    @XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "transformer", "filter", "set", "format" }) public static class Context {
      @XmlElement(name = "Transformer") protected BundleReference transformer;

      @XmlElement(name = "Filter") protected List<BundleReference> filter;

      @XmlElement(name = "Set") protected List<BundleReference> set;

      @XmlElement(name = "Format", required = true) protected List<BundleReference> format;

      @XmlAttribute(name = "baseurl") protected String baseurl;
  ...
  @XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "customFilter", "filter" }) public static class Filters {
    @XmlElement(name = "CustomFilter") protected List<Configuration.Filters.CustomFilter> customFilter;

    @XmlElement(name = "Filter") protected List<Configuration.Filters.Filter> filter;
    ...
    @XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "clazz", "parameter" }) public static class CustomFilter {
      @XmlElement(name = "Class", required = true) protected String clazz;

      @XmlElement(name = "Parameter") protected List<Parameter> parameter;
    ...
    @XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "definition" }) public static class Filter implements Referable {
  ...
  @XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "format" }) public static class Formats {
    @XmlElement(name = "Format", required = true) protected List<Configuration.Formats.Format> format;
    ...
    @XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "prefix", "xslt", "namespace", "schemaLocation", "filter" }) public static class Format implements Referable {
      @XmlElement(name = "Prefix", required = true) protected String prefix;

      @XmlElement(name = "XSLT", required = true) protected String xslt;

      @XmlElement(name = "Namespace", required = true) protected String namespace;

      @XmlElement(name = "SchemaLocation", required = true) protected String schemaLocation;

      @XmlElement(name = "ScopedFilter") protected List<BundleReference> filter;
  ...
  @XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "set" }) public static class Sets {
    @XmlElement(name = "Set", required = true) protected List<Configuration.Sets.Set> set;
    ...
    @XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "pattern", "name", "filter", "parameter" }) public static class Set {
      @XmlElement(name = "Pattern", required = true) protected String pattern;
  ...
  @XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "transformer" }) public static class Transformers {
    @XmlElement(name = "Transformer", required = true) protected List<Configuration.Transformers.Transformer> transformer;
    ...
    @XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "xslt" }) public static class Transformer implements Referable {
      @XmlElement(name = "XSLT", required = true) protected String xslt;
