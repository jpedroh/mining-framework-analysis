...
public class BigDataViewer {
  ...
  protected final 
<<<<<<< /usr/src/app/output/tpietzsch/bigdataviewer-core/3173a1be985d9d2c0fac011dc0df6b11891d4933/src/main/java/bdv/BigDataViewer.java/left.java
  ProduceMovieDialog
=======
  PreferencesDialog
>>>>>>> /usr/src/app/output/tpietzsch/bigdataviewer-core/3173a1be985d9d2c0fac011dc0df6b11891d4933/src/main/java/bdv/BigDataViewer.java/right.java
...
>>>>>>> /usr/src/app/output/tpietzsch/bigdataviewer-core/3173a1be985d9d2c0fac011dc0df6b11891d4933/src/main/java/bdv/BigDataViewer.java/right.java
  ...
  /**
	 ...
	 * </ul>
	 */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends NumericType<T>> Converter<T, ARGBType> createConverterToARGB(final T type) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object, V extends Volatile<T>> SourceAndConverter<T> wrapWithTransformedSource(final SourceAndConverter<T> soc) {
    if (soc.asVolatile() == null) {
      return new SourceAndConverter<>(new TransformedSource<>(soc.getSpimSource()), soc.getConverter());
    }
    @SuppressWarnings(value = { "unchecked" }) final SourceAndConverter<V> vsoc = (SourceAndConverter<V>) soc.asVolatile();
  ...
  private static <T extends NumericType<T>, V extends Volatile<T> & NumericType<V>> void initSetupNumericType(final AbstractSpimData<?> spimData, final BasicViewSetup setup, final List<ConverterSetup> converterSetups, final List<SourceAndConverter<?>> sources) {
    final int setupId = setup.getId();
    final ViewerImgLoader imgLoader = (ViewerImgLoader) spimData.getSequenceDescription().getImgLoader();
    @SuppressWarnings(value = { "unchecked" }) final ViewerSetupImgLoader<T, V> setupImgLoader = (ViewerSetupImgLoader<T, V>) imgLoader.getSetupImgLoader(setupId);
  ...
  /**
	 ...
	 * @return
	 */
  @Deprecated public static InputTriggerConfig getInputTriggerConfig(final ViewerOptions options) {
