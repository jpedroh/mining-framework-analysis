...
public abstract class Service<R extends Resource> {
  ...
  /**
     ...
     */
  protected <T extends java.lang.Object> T getResourceProxy(final Class<T> clazz, final String serverUri) {
  ...
  /**
     ...
     */
  private final <T extends java.lang.Object> T getClientService(final Class<T> clazz, final String serverUri) {
  ...
  /**
     ...
     */
  protected <T extends java.lang.Object, E extends AlfrescoServiceException> T parseEntityFromResponse(final ClientResponse<T> clientResponse, final Class<E> exceptionClazz) throws E {
    T entity = null;
    try {
  ...
  /**
     ...
     * @throws EX the eX
     */
  protected <E extends AlfrescoServiceException> void validateResponseSuccess(final ClientResponse<?> clientResponse, final Class<E> exceptionClazz) throws E {
    ...
    if (statusFamily != Family.SUCCESSFUL) {
      ...
      E exception = null;
      final String genericErrorMsg = "Error occurred while creating new instance of exception class of type " + exceptionClazz.getCanonicalName() + " to throw the following error:\n" + errorResponse;
      try {
        if (cause != null) {
          exception = exceptionClazz.getConstructor(String.class, Throwable.class).newInstance("An error occurred while fetching entity from HTTP response:\n" + errorResponse, cause);
        } else {
          exception = exceptionClazz.getConstructor(String.class).newInstance("Request processing failed.\n HTTP Status: " + clientResponse.getResponseStatus() + "\n HTTP Status Code:" + clientResponse.getStatus() + " \n Error:" + errorResponse);
        }
