...
public class ISO8601DateDeserializer extends JsonDeserializer<Date> {
  @Override public Date deserialize(final JsonParser jsonparser, final DeserializationContext deserializationcontext) throws IOException {
    ...
    try {
      ...
      throw new IOException("Error occurred while parsing date \'" + dateString + "\'", parseException);
    }
  }
}