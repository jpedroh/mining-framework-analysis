...
public class TestMDCAdapter implements MDCAdapter {
  private final ThreadLocal<Map<String, String>> value = new ThreadLocal<Map<String, String>>(Suppliers.<String, String>makeEmptyMutableMap());
  ...
  @SuppressWarnings(value = { "unchecked" }) public void setContextMap(final Map contextMap) {
