 ...
 */
@SuppressWarnings(value = { "PMD.ExcessivePublicCount", "PMD.TooManyMethods" }) public class TestLogger implements Logger {
  private final String name;

  private final TestLoggerFactory testLoggerFactory;

  private final ThreadLocal<List<LoggingEvent>> loggingEvents = new ThreadLocal<List<LoggingEvent>>(Suppliers.<LoggingEvent>makeEmptyMutableList());
  ...
  @Override public void trace(final String msg, final Throwable throwable) {
  ...
  @Override public void trace(final Marker marker, final String format, final Object... args) {
    log(TRACE, marker, format, args);
  }

  @Override public void trace(final Marker marker, final String msg, final Throwable throwable) {
  ...
  @Override public void debug(final String msg, final Throwable throwable) {
  ...
  @Override public void debug(final Marker marker, final String format, final Object... args) {
    log(DEBUG, marker, format, args);
  }

  @Override public void debug(final Marker marker, final String msg, final Throwable throwable) {
  ...
  @Override public void info(final String msg, final Throwable throwable) {
  ...
  @Override public void info(final Marker marker, final String format, final Object... args) {
    log(INFO, marker, format, args);
  }

  @Override public void info(final Marker marker, final String msg, final Throwable throwable) {
  ...
  @Override public void warn(final String msg, final Throwable throwable) {
  ...
  @Override public void warn(final Marker marker, final String format, final Object... args) {
    log(WARN, marker, format, args);
  }

  @Override public void warn(final Marker marker, final String msg, final Throwable throwable) {
  ...
  @Override public void error(final String msg, final Throwable throwable) {
  ...
  @Override public void error(final Marker marker, final String format, final Object... args) {
    log(ERROR, marker, format, args);
  }

  @Override public void error(final Marker marker, final String msg, final Throwable throwable) {
  ...
  private void addLoggingEvent(final Level level, final Optional<Marker> marker, final Optional<Throwable> throwable, final String format, final Object... args) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private Map<String, String> mdc() {
