...
public class Mailer extends Notifier implements SimpleBuildStep {
  ...
  @Override @SuppressFBWarnings(value = "NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE", justification = "build cannnot be null and the workspace is not used in case it was null") public boolean perform(AbstractBuild<?, ?> build, Launcher launcher, BuildListener listener) throws InterruptedException, IOException {
    perform(build, build.getWorkspace(), launcher, listener);
    return true;
  }

  @Override public void perform(Run<?, ?> build, FilePath workspace, Launcher launcher, TaskListener listener) throws IOException, InterruptedException {
    if (debug) {
    ...
    new MailSender(recip, dontNotifyEveryUnstableBuild, sendToIndividuals, descriptor().getCharset()) {
      ...
      @Override public boolean artifactMatches(String path, AbstractBuild<?, ?> build) {
  ...
  /**
     ...
     */
  @Deprecated @Restricted(value = DoNotUse.class) @RestrictedSince(value = "1.16") @SuppressFBWarnings(value = "NM_METHOD_NAMING_CONVENTION", justification = "It\'s deprecated and required for API compatibility") public static InternetAddress StringToAddress(String strAddress, String charset) throws AddressException, UnsupportedEncodingException {
  ...
  /**
     ...
     */
  @Restricted(value = NoExternalUse.class) @RestrictedSince(value = "1.355") @SuppressFBWarnings(value = "MS_PKGPROTECT", justification = "Deprecated API field") public static DescriptorImpl DESCRIPTOR;
  ...
  @Extension public static final class DescriptorImpl extends BuildStepDescriptor<Publisher> {
    ...
    @Deprecated private transient String smtpAuthUsername;

    @Deprecated private transient Secret smtpAuthPassword;
    ...
    @SuppressFBWarnings(value = "ST_WRITE_TO_STATIC_FROM_INSTANCE_METHOD", justification = "Writing to a deprecated field") public DescriptorImpl() {
      load();
      DESCRIPTOR = this;
    }
    ...
    /**
         ...
         */
    @SuppressFBWarnings(value = "NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE", justification = "False positive. See https://sourceforge.net/p/findbugs/bugs/1411/") private JenkinsLocationConfiguration getJenkinsLocationConfiguration() {
    ...
    @Override public Publisher newInstance(StaplerRequest req, JSONObject formData) throws FormException {
    ...
    @RequirePOST public FormValidation doCheckSmtpHost(@QueryParameter String value) {
  ...
  public static class UserProperty extends hudson.model.UserProperty {
    ...
    @Extension @Symbol(value = "mailer") public static final class DescriptorImpl extends UserPropertyDescriptor {
      public String getDisplayName() {
      ...
      @Override public UserProperty newInstance(@CheckForNull StaplerRequest req, JSONObject formData) throws FormException {
  ...
  /**
     ...
     */
  @SuppressFBWarnings(value = "MS_SHOULD_BE_FINAL", justification = "It may used for debugging purposes. We have to keep it for the sake of the binary copatibility") @Deprecated public static boolean debug = false;
}