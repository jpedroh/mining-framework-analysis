 ...
 */
@SuppressFBWarnings(value = "UG_SYNC_SET_UNSYNC_GET", justification = "False positive") public class TestResultAction extends AbstractTestResultAction<TestResultAction> implements StaplerProxy, SimpleBuildStep.LastBuildAction {
  ...
  @Deprecated public TestResultAction(AbstractBuild owner, TestResult result, BuildListener listener) {
  ...
  @Deprecated public TestResultAction(TestResult result, BuildListener listener) {
    this((Run) null, result, listener);
  }

  @SuppressWarnings(value = { "deprecation" }) @Override public Collection<? extends Action> getProjectActions() {
    Job<?, ?> job = run.getParent();
    if (!Util.filter(job.getActions(), TestResultProjectAction.class).isEmpty()) {
  ...
  @Deprecated public void setResult(TestResult result, BuildListener listener) {
  ...
  @Override public synchronized int getFailCount() {
    if (totalCount == null) {
      getResult();
    }
    return failCount;
  ...
  @Override public synchronized int getSkipCount() {
    if (totalCount == null) {
      getResult();
    }
    return skipCount;
  ...
  @Override public synchronized int getTotalCount() {
    if (totalCount == null) {
      getResult();
    }
    return totalCount;
  ...
  @Override public double getHealthScaleFactor() {
