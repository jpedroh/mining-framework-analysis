...
public class TestResultSummary implements Serializable {
  ...
  @Deprecated @Restricted(value = DoNotUse.class) public TestResultSummary() {
  }
  ...
  @Whitelisted public int getFailCount() {
    return failCount;
  }

  @Whitelisted public int getSkipCount() {
    return skipCount;
  }

  @Whitelisted public int getPassCount() {
    return passCount;
  }

  @Whitelisted public int getTotalCount() {
    return totalCount;
  }
}