...
public class CaseResult extends TestResult implements Comparable<CaseResult> {
  ...
  @SuppressFBWarnings(value = "SE_TRANSIENT_FIELD_NOT_RESTORED", justification = "Specific method to restore it") private transient SuiteResult parent;

  @SuppressFBWarnings(value = "IS2_INCONSISTENT_SYNC", justification = "Not guarded, though read in synchronized blocks") private transient ClassResult classResult;
  ...
  CaseResult(SuiteResult parent, Element testCase, String testClassName, boolean keepLongStdio) {
    ...
    @SuppressWarnings(value = { "LeakingThisInConstructor" }) Collection<CaseResult> _this = Collections.singleton(this);
  ...
  /**
     ...
     */
  @SuppressFBWarnings(value = "DM_DEFAULT_ENCODING", justification = "Expected behavior") static String possiblyTrimStdio(Collection<CaseResult> results, boolean keepLongStdio, File stdio) throws IOException {
  ...
  /**
     ...
     */
  @Exported(visibility = 999) public @Override String getName() {
    return testName;
  }
  ...
  @Override public CaseResult getPreviousResult() {
    if (parent == null) {
      return null;
    }
  ...
  /**
     ...
     * @return null
     */
  @Override public TestResult findCorrespondingResult(String id) {
  ...
  /**
     ...
     */
  @Override public Collection<? extends TestResult> getFailedTests() {
  ...
  /**
     ...
     * @return the children of this test result, if any, or an empty collection
     */
  @Override public Collection<? extends TestResult> getPassedTests() {
  ...
  /**
     ...
     */
  @Override public Collection<? extends TestResult> getSkippedTests() {
  ...
  @Exported(name = "status", visibility = 9) public Status getStatus() {
    if (skipped) {
