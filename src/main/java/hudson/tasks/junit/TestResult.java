...
public final class TestResult extends MetaTabulatedResult {
  ...
  @Deprecated public TestResult(long buildTime, DirectoryScanner results) throws IOException {
    this(buildTime, results, false);
  }

  @Deprecated public TestResult(long buildTime, DirectoryScanner results, boolean keepLongStdio) throws IOException {
    this(buildTime, results, keepLongStdio, null, null, null);
  }
  ...
  @Override public void setParent(TestObject parent) {
    this.parent = parent;
  }
  ...
  @Deprecated public void parse(long buildTime, DirectoryScanner results) throws IOException {
    parse(buildTime, results, null, null, null);
  }
  ...
  @Deprecated public void parse(long buildTime, File baseDir, String[] reportFiles) throws IOException {
    parse(buildTime, baseDir, null, null, null, reportFiles);
  }
  ...
  @Deprecated public void parse(long buildTime, Iterable<File> reportFiles) throws IOException {
    parse(buildTime, reportFiles, null, null, null);
  }
  ...
  @Deprecated public void parse(File reportFile) throws IOException {
    parse(reportFile, null, null, null);
  }
  ...
  @Override public Run<?, ?> getRun() {
    return parentAction == null ? null : parentAction.run;
  }

  @Override public hudson.tasks.test.TestResult findCorrespondingResult(String id) {
  ...
  @Override public String getChildTitle() {
    return Messages.TestResult_getChildTitle();
  }

  @Exported(visibility = 999) @Override public float getDuration() {
    return duration;
  }

  @Exported(visibility = 999) @Override public int getPassCount() {
    return totalTests - getFailCount() - getSkipCount();
  }

  @Exported(visibility = 999) @Override public int getFailCount() {
    if (failedTests == null) {
      return 0;
    } else {
  ...
  @Exported(visibility = 999) @Override public int getSkipCount() {
  ...
  /**
     ...
     */
  @Override public synchronized List<CaseResult> getPassedTests() {
    if (passedTests == null) {
  ...
  /**
     ...
     */
  @Override public synchronized List<CaseResult> getSkippedTests() {
  ...
  /**
     ...
     */
  @Override public int getFailedSince() {
  ...
  /**
     ...
     * when this test started failing.
     */
  @Override public Run<?, ?> getFailedSinceRun() {
    throw new UnsupportedOperationException();
  }
  ...
  /**
     ...
     */
  @Override public String getErrorStackTrace() {
  ...
  /**
     ...
     */
  @Override public String getErrorDetails() {
  ...
  /**
     ...
     */
  @Override public boolean isPassed() {
    return getFailCount() == 0;
  }

  @Override public Collection<PackageResult> getChildren() {
  ...
  @Override public Object getDynamic(String token, StaplerRequest req, StaplerResponse rsp) {
  ...
  @Nonnull public TestResult getResultByRunAndNode(@Nonnull String runId, @Nonnull String nodeId) {
    return getResultByRunAndNodes(runId, Collections.singletonList(nodeId));
  }

  @Nonnull public TestResult getResultByRunAndNodes(@Nonnull String runId, @Nonnull List<String> nodeIds) {
  ...
  @Override public void setParentAction(AbstractTestResultAction action) {
    this.parentAction = action;
    tally();
  }

  @Override public AbstractTestResultAction getParentAction() {
  ...
  private void addSuiteByRunAndNode(SuiteResult s) {
    String runId = s.getRunId();
    String nodeId = s.getNodeId();
    if (runId != null && nodeId != null) {
      if (suitesByRunAndNode.get(runId) == null) {
        suitesByRunAndNode.put(runId, new HashMap<String, List<SuiteResult>>());
      }
      if (suitesByRunAndNode.get(runId).get(nodeId) == null) {
        suitesByRunAndNode.get(runId).put(nodeId, new ArrayList<SuiteResult>());
      }
      suitesByRunAndNode.get(runId).get(nodeId).add(s);
  ...
  @CheckForNull public BlocksWithChildren getBlockWithChildren(@Nonnull String runId, @Nonnull String blockId) {
  ...
  private void populateBlocks(@Nonnull String runId, @Nonnull List<String> innermostFirst, @Nonnull String nodeId, @CheckForNull BlocksWithChildren nested) {
  ...
  public static class BlocksWithChildren implements Serializable {
    ...
    @Nonnull public Map<String, BlocksWithChildren> getChildBlocks() {
      return childBlocks;
    }

    @Nonnull public Set<String> getLeafNodes() {
      return leafNodes;
    }
    ...
    @Nonnull public Set<String> nodesWithTests() {
    ...
    /**
         ...
         */
    @Nonnull public TestResult toTestResult(@Nonnull String runId, @Nonnull TestResult fullResult) {
      TestResult result = new TestResult();
      for (BlocksWithChildren child : childBlocks.values()) {
