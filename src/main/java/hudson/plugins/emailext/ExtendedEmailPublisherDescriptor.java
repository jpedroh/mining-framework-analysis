 ...
 */
@Extension @Symbol(value = "email-ext") public final class ExtendedEmailPublisherDescriptor extends BuildStepDescriptor<Publisher> {
  ...
  @Initializer(after = InitMilestone.EXTENSIONS_AUGMENTED, before = InitMilestone.JOB_LOADED) public static void autoConfigure() {
  ...
  public Session createSession(String from) throws MessagingException {
    ...
    if (StringUtils.isNotBlank(from)) {
      ...
      for (MailAccount ma : addAccounts) {
        if (ma == null || !ma.isValid() || !ma.getAddress().equalsIgnoreCase(fromAddress.getAddress())) {
          continue;
        }
        acc = ma;
        break;
  ...
  @SuppressWarnings(value = { "unused" }) @Deprecated public void setSmtpUsername(String username) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setSmtpPassword(String password) {
    mailAccount.setSmtpPassword(password);
  }

  @SuppressWarnings(value = { "unused" }) public void setSmtpAuth(String userName, String password) {
  ...
  @SuppressWarnings(value = { "unused" }) @Deprecated public void setUseSsl(boolean useSsl) {
    mailAccount.setUseSsl(useSsl);
  }
  ...
  @SuppressWarnings(value = { "unused" }) @Deprecated public void setSmtpPort(String port) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setCharset(String charset) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setDefaultContentType(String contentType) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setDefaultSubject(String subject) {
    if (subject == null) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setDefaultBody(String body) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setMaxAttachmentSizeMb(long mb) {
    if (mb < 0) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setDefaultRecipients(String recipients) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setAllowedDomains(String allowed) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setExcludedCommitters(String excluded) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setListId(String id) {
    this.listId = id;
  }
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setPrecedenceBulk(boolean bulk) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setDefaultReplyTo(String to) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setAdminRequiredForTemplateTesting(boolean requireAdmin) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setWatchingEnabled(boolean enabled) {
    this.enableWatching = enabled;
  }

  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setAllowUnregisteredEnabled(boolean enabled) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setDefaultPresendScript(String script) {
  ...
  @SuppressWarnings(value = { "unused" }) @DataBoundSetter public void setDefaultPostsendScript(String script) {
    script = StringUtils.trim(script);
  ...
  @DataBoundSetter public void setDefaultClasspath(List<GroovyScriptPath> defaultClasspath) throws FormException {
  ...
  @SuppressWarnings(value = { "unused" }) public ListBoxModel doFillDefaultContentTypeItems() {
