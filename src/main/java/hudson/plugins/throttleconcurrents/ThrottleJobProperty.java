...
public class ThrottleJobProperty extends JobProperty<Job<?, ?>> {
  ...
  public boolean isThrottleMatrixBuilds() {
    return matrixOptions != null ? matrixOptions.isThrottleMatrixBuilds() : ThrottleMatrixProjectOptions.DEFAULT.isThrottleMatrixBuilds();
  }
  ...
  public boolean isThrottleMatrixConfigurations() {
    return matrixOptions != null ? matrixOptions.isThrottleMatrixConfigurations() : ThrottleMatrixProjectOptions.DEFAULT.isThrottleMatrixConfigurations();
  }
  ...
  /**
     ...
     */
  @Nonnull static Map<String, List<String>> getCategoriesForRunByFlowNode(@Nonnull Run<?, ?> run) {
    ...
    for (ThrottleJobProperty t : properties) {
      if (t.getThrottleEnabled()) {
        if (t.getCategories() != null && t.getCategories().contains(category)) {
          Job<?, ?> p = t.owner;
          if (p instanceof Queue.Task && getItem(p.getParent(), p.getName()) == p && p.getProperty(ThrottleJobProperty.class) == t) {
  ...
  /**
     ...
     */
  @Nonnull static Map<String, List<FlowNode>> getThrottledPipelineRunsForCategory(@Nonnull String category) {
  ...
  @Extension @Symbol(value = "throttleJobProperty") public static final class DescriptorImpl extends JobPropertyDescriptor {
    ...
    @Override @SuppressWarnings(value = { "rawtypes" }) public boolean isApplicable(Class<? extends Job> jobType) {
    ...
    @Nonnull public synchronized Map<String, List<String>> getThrottledPipelinesForCategory(@Nonnull String category) {
      return internalGetThrottledPipelinesForCategory(category);
    }

    @Nonnull private Map<String, List<String>> internalGetThrottledPipelinesForCategory(@Nonnull String category) {
  ...
  public static final class ThrottleCategory extends AbstractDescribableImpl<ThrottleCategory> {
    ...
    @DataBoundConstructor public ThrottleCategory(String categoryName, Integer maxConcurrentPerNode, Integer maxConcurrentTotal, List<NodeLabeledPair> nodeLabeledPairs) {
      this.maxConcurrentPerNode = maxConcurrentPerNode;
      this.maxConcurrentTotal = maxConcurrentTotal;
      this.categoryName = categoryName;
      this.nodeLabeledPairs = nodeLabeledPairs == null ? new ArrayList<NodeLabeledPair>() : nodeLabeledPairs;
    }
  ...
  public static final class NodeLabeledPair extends AbstractDescribableImpl<NodeLabeledPair> {
    ...
    @Extension public static class DescriptorImpl extends Descriptor<NodeLabeledPair> {
      @Override public String getDisplayName() {
        return "";
      }
    }
