...
public abstract class CargoContainerAdapter extends ContainerAdapter implements Serializable {
  ...
  @Override public boolean redeploy(FilePath war, final String contextPath, final Run<?, ?> build, final Launcher launcher, final TaskListener listener) throws IOException, InterruptedException {
