...
public class DeployPublisher extends Notifier implements SimpleBuildStep, Serializable {
  ...
  @DataBoundConstructor public DeployPublisher(List<ContainerAdapter> adapters, String war) {
    this.adapters = adapters;
    this.war = war;
  }

  @Deprecated public DeployPublisher(List<ContainerAdapter> adapters, String war, String contextPath, boolean onFailure) {
    this.adapters = adapters;
    this.war = war;
  }
  ...
  @DataBoundSetter public void setContextPath(String contextPath) {
  ...
  @Symbol(value = "deploy") @Extension public static final class DescriptorImpl extends BuildStepDescriptor<Publisher> {
  ...
  @Restricted(value = NoExternalUse.class) @Extension public static final class Migrator extends ItemListener {
    @SuppressWarnings(value = { "deprecation" }) @Override public void onLoaded() {
