...
public class ActiveDirectorySecurityRealm extends AbstractPasswordBasedSecurityRealm {
  ...
  @DataBoundConstructor public ActiveDirectorySecurityRealm(String domain, List<ActiveDirectoryDomain> domains, String site, String bindName, String bindPassword, String server, GroupLookupStrategy groupLookupStrategy, boolean removeIrrelevantGroups, Boolean customDomain, CacheConfiguration cache, Boolean startTls, TlsConfiguration tlsConfiguration, ActiveDirectoryInternalUsersDatabase internalUsersDatabase) {
  ...
  @DataBoundSetter public void setEnvironmentProperties(List<EnvironmentProperty> environmentProperties) {
    this.environmentProperties = environmentProperties;
  }

  @Restricted(value = NoExternalUse.class) public CacheConfiguration getCache() {
  ...
  @Restricted(value = NoExternalUse.class) public String getJenkinsInternalUser() {
    return internalUsersDatabase == null ? null : internalUsersDatabase.getJenkinsInternalUser();
  }

  @Restricted(value = NoExternalUse.class) public ActiveDirectoryInternalUsersDatabase getInternalUsersDatabase() {
  ...
  @Restricted(value = NoExternalUse.class) public Boolean isStartTls() {
    return startTls;
  }
  ...
  @Restricted(value = NoExternalUse.class) public List<EnvironmentProperty> getEnvironmentProperties() {
    return environmentProperties;
  }

  @Restricted(value = NoExternalUse.class) public boolean getCustomDomain() {
    return domains != null;
  }
  ...
  @Restricted(value = NoExternalUse.class) public TlsConfiguration getTlsConfiguration() {
  ...
  @Restricted(value = NoExternalUse.class) public List<ActiveDirectoryDomain> getDomains() {
    return domains;
  }
  ...
  @Restricted(value = DoNotUse.class) public void shutDownthreadPoolExecutors() {
  ...
  @Extension public static final class DescriptorImpl extends Descriptor<SecurityRealm> {
    ...
    /**
         ...
         * otherwise broken, so try all the servers.
         */
    @Deprecated public DirContext bind(String principalName, String password, List<SocketInfo> ldapServers) throws NamingException {
    ...
    @IgnoreJRERequirement @Deprecated private LdapContext bind(String principalName, String password, SocketInfo server, Hashtable<String, String> props) throws NamingException {
      return bind(principalName, password, server, props, null);
    }

    @IgnoreJRERequirement private LdapContext bind(String principalName, String password, SocketInfo server, Hashtable<String, String> props, TlsConfiguration tlsConfiguration) throws NamingException {
    ...
    @Deprecated public List<SocketInfo> obtainLDAPServer(String domainName, String site, String preferredServer) throws NamingException {
    ...
    public List<SocketInfo> obtainLDAPServer(DirContext ictx, String domainName, String site, String preferredServers) throws NamingException {
      ...
      if (a != null) {
        class PrioritizedSocketInfo implements Comparable<PrioritizedSocketInfo> {
          ...
          @SuppressFBWarnings(value = "EQ_COMPARETO_USE_OBJECT_EQUALS", justification = "Weird and unpredictable behaviour intentional for load balancing.") public int compareTo(PrioritizedSocketInfo that) {
  ...
  /**
     ...
     *      Use the UI field.
     */
  @SuppressFBWarnings(value = "MS_SHOULD_BE_FINAL", justification = "Diagnostic fields are left mutable so that groovy console can be used to dynamically turn/off probes.") public static String DOMAIN_CONTROLLERS = System.getProperty(ActiveDirectorySecurityRealm.class.getName() + ".domainControllers");
  ...
  /**
     ...
     */
  @SuppressFBWarnings(value = "MS_SHOULD_BE_FINAL", justification = "Diagnostic fields are left mutable so that groovy console can be used to dynamically turn/off probes.") public static boolean FORCE_LDAPS = Boolean.getBoolean(ActiveDirectorySecurityRealm.class.getName() + ".forceLdaps");
  ...
  @Extension public final static TlsConfigurationAdministrativeMonitor NOTICE = new TlsConfigurationAdministrativeMonitor();
    ...
    public boolean isActivated() {
      ...
      if (securityRealm instanceof ActiveDirectorySecurityRealm) {
        ...
        if (activeDirectorySecurityRealm.tlsConfiguration == null && activeDirectorySecurityRealm.getDescriptor().canDoNativeAuth() && activeDirectorySecurityRealm.domains != null) {
          ...
          if (activeDirectorySecurityRealm.tlsConfiguration == null && !activeDirectorySecurityRealm.getDescriptor().canDoNativeAuth()) {
            return true;
          }
        }
      }
