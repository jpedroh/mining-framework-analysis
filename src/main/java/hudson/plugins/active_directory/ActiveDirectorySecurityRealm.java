...
public class ActiveDirectorySecurityRealm extends AbstractPasswordBasedSecurityRealm {
  ...
  @DataBoundConstructor public ActiveDirectorySecurityRealm(String domain, List<ActiveDirectoryDomain> domains, String site, String bindName, String bindPassword, String server, GroupLookupStrategy groupLookupStrategy, boolean removeIrrelevantGroups, Boolean customDomain, CacheConfiguration cache, Boolean startTls) {
  ...
  @Restricted(value = DoNotUse.class) @Terminator public void shutDownthreadPoolExecutors() {
  ...
  @Extension public static final class DescriptorImpl extends Descriptor<SecurityRealm> {
    ...
    @IgnoreJRERequirement private LdapContext bind(String principalName, String password, SocketInfo server, Hashtable<String, String> props) throws NamingException {
