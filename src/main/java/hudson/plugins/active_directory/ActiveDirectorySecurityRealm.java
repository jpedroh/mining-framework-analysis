...
public class ActiveDirectorySecurityRealm extends AbstractPasswordBasedSecurityRealm {
  ...
  @DataBoundConstructor public ActiveDirectorySecurityRealm(String domain, List<ActiveDirectoryDomain> domains, String site, String bindName, String bindPassword, String server, GroupLookupStrategy groupLookupStrategy, boolean removeIrrelevantGroups, Boolean customDomain, CacheConfiguration cache) {
