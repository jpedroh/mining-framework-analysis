...
public class NestedView extends View implements ViewGroup, StaplerProxy, ModelObjectWithContextMenu {
  ...
  @Override public synchronized void onJobRenamed(Item item, String oldName, String newName) {
    for (View v : views) {
  ...
  @Override @WebMethod(name = "config.xml") public HttpResponse doConfigDotXml(StaplerRequest req) throws IOException {
  ...
  /**
     ...
     */
  @Override public void updateByXml(Source source) throws IOException {
  ...
  @Extension public static final class DescriptorImpl extends ViewDescriptor {
