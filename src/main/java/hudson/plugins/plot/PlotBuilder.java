...
public class PlotBuilder extends Builder implements SimpleBuildStep {
  ...
  @CheckForNull private String title;

  @CheckForNull private String description;

  @CheckForNull private String numBuilds;

  @CheckForNull private String yaxis;

  @CheckForNull private String yaxisMinimum;

  @CheckForNull private String yaxisMaximum;
  ...
  /**
     * List of data series.
     */
  @SuppressWarnings(value = { "visibilitymodifier" }) public List<CSVSeries> csvSeries;

  @SuppressWarnings(value = { "visibilitymodifier" }) public List<PropertiesSeries> propertiesSeries;

  @SuppressWarnings(value = { "visibilitymodifier" }) public List<XMLSeries> xmlSeries;

  @DataBoundConstructor public PlotBuilder(String group, String style, String csvFileName) {
    this.group = group;
    this.style = style;
  ...
  @DataBoundSetter public void setCsvSeries(List<CSVSeries> csvSeries) {
  ...
  @DataBoundSetter public void setXmlSeries(List<XMLSeries> xmlSeries) {
  ...
  @DataBoundSetter public void setWidth(String width) {
    this.width = width;
  }
  ...
  @DataBoundSetter public void setHeight(String height) {
    this.height = height;
  }

  @Override public void perform(@NonNull Run<?, ?> build, @NonNull FilePath workspace, @NonNull Launcher launcher, @NonNull TaskListener listener) {
    List<Plot> plots = new ArrayList<>();
    Plot plot = new Plot(title, yaxis, group, numBuilds, csvFileName, style, useDescr, keepRecords, exclZero, logarithmic, yaxisMinimum, yaxisMaximum, description);
    if (width != null) {
      plot.setWidth(width);
    }
    if (height != null) {
  ...
  @Extension @Symbol(value = "plot") public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
    /**
