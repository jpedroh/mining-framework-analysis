...
public abstract class GSResourceEncoder<T extends GSDimensionInfoEncoder> extends PropertyXMLEncoder {
  ...
  public void setLatLonBoundingBox(double minx, double maxy, double maxx, double miny, final String crs) {
  ...
  public void setNativeBoundingBox(double minx, double maxy, double maxx, double miny, final String crs) {
