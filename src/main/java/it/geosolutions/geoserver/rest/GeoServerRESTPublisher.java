...
public class GeoServerRESTPublisher {
  ...
  public boolean publishShp(String workspace, String storename, String layername, File zipFile, String srs) throws FileNotFoundException {
    ...
    if (shpSent) {
      ...
      StringBuilder postUrl = new StringBuilder(restURL).append("/rest/workspaces/").append(workspace).append("/datastores/").append(storename).append("/featuretypes/").append(layername);
...
>>>>>>> /usr/src/app/output/geosolutions-it/geoserver-manager/352e241e0bf2b9c4a7d640dd5ca7795e1b5d303a/src/main/java/it/geosolutions/geoserver/rest/GeoServerRESTPublisher.java/right.java
  ...
  public boolean publishGeoTIFF(String workspace, String storeName, File geotiff) throws FileNotFoundException {
    ...
    String sendResult = HTTPUtils.put(sUrl, geotiff, "text", gsuser, gspass);
...
<<<<<<< /usr/src/app/output/geosolutions-it/geoserver-manager/352e241e0bf2b9c4a7d640dd5ca7795e1b5d303a/src/main/java/it/geosolutions/geoserver/rest/GeoServerRESTPublisher.java/left.java
        setProjectionPolicy(ProjectionPolicy.REPROJECT_TO_DECLARED)
=======
