...
public class MetricsUtil {
  ...
  public double[][] readFront(String path) {
    try {
      ...
      Configuration.logger_.log(Level.SEVERE, "readFront() crashed reading for file: " + path, e);
    }
  ...
  public SolutionSet readSolutionSet(String path) {
    try {
      ...
      Configuration.logger_.log(Level.SEVERE, "jmetal.qualityIndicator.util.readNonDominatedSolutionSet: " + path, e);
    }
    return null;
  }
