...
public class PgSchema {
  /**
     ...
     */
  @SuppressWarnings(value = { "CollectionWithoutInitialCapacity" }) private final List<PgFunction> functions = new ArrayList<PgFunction>();

  /**
     * List of procedures defined in the schema.
     */
  @SuppressWarnings(value = { "CollectionWithoutInitialCapacity" }) private final List<PgProcedure> procedures = new ArrayList<PgProcedure>();

  /**
     * List of sequences defined in the schema.
     */
  @SuppressWarnings(value = { "CollectionWithoutInitialCapacity" }) private final List<PgSequence> sequences = new ArrayList<PgSequence>();

  /**
     * List of rels defined in the schema.
     */
  @SuppressWarnings(value = { "CollectionWithoutInitialCapacity" }) private final List<PgRelation> rels = new ArrayList<PgRelation>();

  /**
     * List of types defined in the schema.
     */
  @SuppressWarnings(value = { "CollectionWithoutInitialCapacity" }) private final List<PgType> types = new ArrayList<PgType>();

  /**
     * List of indexes defined in the schema.
     */
  @SuppressWarnings(value = { "CollectionWithoutInitialCapacity" }) private final List<PgIndex> indexes = new ArrayList<PgIndex>();

  /**
     * List of primary keys defined in the schema.
     */
  @SuppressWarnings(value = { "CollectionWithoutInitialCapacity" }) private final List<PgConstraint> primaryKeys = new ArrayList<PgConstraint>();

  /**
     * List of rules defined in the schema.
     */
  @SuppressWarnings(value = { "CollectionWithoutInitialCapacity" }) private final List<PgRule> rules = new ArrayList<PgRule>();
  ...
  public List<PgTable> getTables() {
    @SuppressWarnings(value = { "CollectionWithoutInitialCapacity" }) final List<PgTable> list = new ArrayList<PgTable>();
    for (PgRelation rel : rels) {
  ...
  public List<PgView> getViews() {
    @SuppressWarnings(value = { "CollectionWithoutInitialCapacity" }) final List<PgView> list = new ArrayList<PgView>();
    for (PgRelation rel : rels) {
  ...
  public List<PgRule> getRules() {
    @SuppressWarnings(value = { "CollectionWithoutInitialCapacity" }) final List<PgRule> list = new ArrayList<PgRule>();
    for (PgRelation rel : rels) {
