...
public class CSSParserVisitorImpl implements CSSParserVisitor<Object>, CSSParserExtractor {
  ...
  /**
     ...
     */
  @Override public RuleList visitInlinestyle(CSSParser.InlinestyleContext ctx) {
  ...
  /**
     ...
     */
  @Override public RuleList visitStylesheet(CSSParser.StylesheetContext ctx) {
  ...
  @Override public RuleBlock<?> visitStatement(CSSParser.StatementContext ctx) {
  ...
  @Override public RuleBlock<?> visitAtstatement(CSSParser.AtstatementContext ctx) {
  ...
  @Override public String visitImport_uri(CSSParser.Import_uriContext ctx) {
    if (ctx != null) {
  ...
  @Override public RuleBlock<?> visitPage(CSSParser.PageContext ctx) {
    boolean invalid = false;
    String name = null;
    if (ctx.IDENT() != null) {
  ...
  @Override public RuleMargin visitMargin_rule(CSSParser.Margin_ruleContext ctx) {
  ...
  @Override public cz.vutbr.web.css.RuleBlock<?> visitInlineset(CSSParser.InlinesetContext ctx) {
    logEnter("inlineset");
  ...
  @Override public List<cz.vutbr.web.css.MediaQuery> visitMedia(CSSParser.MediaContext ctx) {
    logEnter("media: ", ctx);
  ...
  @Override public MediaQuery visitMedia_query(CSSParser.Media_queryContext ctx) {
  ...
  @Override public Object visitMedia_term(CSSParser.Media_termContext ctx) {
    if (ctx.IDENT() != null) {
      ...
      if (m.equalsIgnoreCase("ONLY") && state == MediaQueryState.START) {
        ...
        if (m.equalsIgnoreCase("NOT") && state == MediaQueryState.START) {
          mq.q.setNegative(true);
          mq.state = MediaQueryState.TYPEOREXPR;
        } else {
          if (m.equalsIgnoreCase("AND") && state == MediaQueryState.AND) {
            mq.state = MediaQueryState.EXPR;
          } else {
            if (state == MediaQueryState.START || state == MediaQueryState.TYPE || state == MediaQueryState.TYPEOREXPR) {
              mq.q.setType(m);
  ...
  @Override public MediaExpression visitMedia_expression(CSSParser.Media_expressionContext ctx) {
  ...
  @Override public RuleBlock<?> visitMedia_rule(CSSParser.Media_ruleContext ctx) {
  ...
  @Override public Object visitUnknown_atrule(CSSParser.Unknown_atruleContext ctx) {
    return null;
  }

  @Override public RuleBlock<?> visitRuleset(CSSParser.RulesetContext ctx) {
    logEnter("ruleset");
  ...
  @Override public List<Declaration> visitDeclarations(CSSParser.DeclarationsContext ctx) {
  ...
  @Override public Declaration visitDeclaration(CSSParser.DeclarationContext ctx) {
  ...
  @Override public Object visitImportant(CSSParser.ImportantContext ctx) {
    if (ctxHasErrorNode(ctx)) {
      declaration_stack.peek().invalid = true;
    } else {
  ...
  @Override public Object visitProperty(CSSParser.PropertyContext ctx) {
    logEnter("property");
    String property = extractTextUnescaped(ctx.IDENT().getText());
    if (ctx.MINUS() != null) {
  ...
  @Override public List<Term<?>> visitTerms(CSSParser.TermsContext ctx) {
  ...
  /**
     ...
     * ;
     */
  @Override public Object visitTermValuePart(CSSParser.TermValuePartContext ctx) {
    logEnter("term");
    visitValuepart(ctx.valuepart());
    return null;
  }

  @Override public Object visitTermInvalid(CSSParser.TermInvalidContext ctx) {
    logEnter("term");
    declaration_stack.peek().invalid = true;
    return null;
  }

  @Override public Object visitFunct(CSSParser.FunctContext ctx) {
  ...
  @Override public Object visitValuepart(CSSParser.ValuepartContext ctx) {
                  ...
                  if (ctx.NUMBER() != null) {
                    ...
                    if (ctx.UNIRANGE() != null) {
                      ...
                      if (ctx.URI() != null) {
                        ...
                        if (ctx.UNCLOSED_URI() != null && ((CSSToken) ctx.UNCLOSED_URI().getSymbol()).isValid()) {
  ...
  @Override public List<Term<?>> visitFunct_args(CSSParser.Funct_argsContext ctx) {
  ...
  @Override public Object visitFunct_argument(CSSParser.Funct_argumentContext ctx) {
  ...
  @Override public CombinedSelector visitCombined_selector(CSSParser.Combined_selectorContext ctx) {
  ...
  @Override public Selector.Combinator visitCombinator(CSSParser.CombinatorContext ctx) {
    logEnter("combinator");
    if (ctx.GREATER() != null) {
  ...
  /**
     ...
     */
  @Override public Object visitSelpart(CSSParser.SelpartContext ctx) {
    logEnter("selpart");
    String ident;
    if (ctx.HASH() != null) {
  ...
  @Override public Selector.ElementAttribute visitAttribute(CSSParser.AttributeContext ctx) {
  ...
  @Override public Selector.SelectorPart visitPseudo(CSSParser.PseudoContext ctx) {
    logEnter("pseudo: ", ctx);
    ...
    if (ctx.FUNCTION() == null) {
      ...
      if (isPseudoElem) {
        ...
        if (ctx.parent instanceof CSSParser.PageContext) {
    ...
    if ((pseudo instanceof Selector.PseudoPage && ((Selector.PseudoPage) pseudo).getType() == null) || (pseudo instanceof Selector.PseudoClass && ((Selector.PseudoClass) pseudo).getType() == null) || (pseudo instanceof Selector.PseudoElement && ((Selector.PseudoElement) pseudo).getType() == null)) {
  ...
  @Override public String visitString(CSSParser.StringContext ctx) {
  ...
  @Override public Object visitAny(CSSParser.AnyContext ctx) {
    return null;
  }

  @Override public Object visitNostatement(CSSParser.NostatementContext ctx) {
    return null;
  }

  @Override public Object visitNoprop(CSSParser.NopropContext ctx) {
    return null;
  }

  @Override public Object visitNorule(CSSParser.NoruleContext ctx) {
    return null;
  }

  @Override public Object visitNomediaquery(CSSParser.NomediaqueryContext ctx) {
    return null;
  }
