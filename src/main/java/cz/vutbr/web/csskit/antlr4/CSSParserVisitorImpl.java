...
public class CSSParserVisitorImpl implements CSSParserVisitor<Object>, CSSParserExtractor {
  ...
  @Override public String visitPage_pseudo(CSSParser.Page_pseudoContext ctx) {
    return extractTextUnescaped(ctx.getText());
  }
  ...
  @Override public Selector.PseudoPage visitPseudo(CSSParser.PseudoContext ctx) {
    logEnter("pseudo: ", ctx);
    ...
    if (ctx.FUNCTION() == null) {
      ...
      if (pseudoPage == null || pseudoPage.getDeclaration() == null) {
        ...
        if (isPseudoElem && !pseudoPage.getDeclaration().isPseudoElement()) {
  ...
  @Override public Object visitPseudocolon(CSSParser.PseudocolonContext ctx) {
    return null;
  }
