...
public class SocketIOServer {
  ...
  public synchronized void start() {
    ...
    bootstrap = new ServerBootstrap().group(new NioEventLoopGroup(), new NioEventLoopGroup()).channel(NioServerSocketChannel.class).childHandler(channelInitializer).childOption(ChannelOption.TCP_NODELAY, true).childOption(ChannelOption.ALLOCATOR, PooledByteBufAllocator.DEFAULT);
  ...
  /**
	 ...
	 */
  @Deprecated public void setHeartbeatThreadpoolSize(int heartbeatThreadpoolSize) {
  ...
  /**
     ...
     * server constructor which accept configuration {@link SocketIOServer#SocketIOServer(ServerConfiguration)}
     */
  @Deprecated public void setHeartbeatTimeout(int heartbeatTimeout) {
  ...
  /**
     ...
     * server constructor which accept configuration {@link SocketIOServer#SocketIOServer(ServerConfiguration)}
     */
  @Deprecated public void setCloseTimeout(int closeTimeout) {
  ...
  /**
     ...
     * server constructor which accept configuration {@link SocketIOServer#SocketIOServer(ServerConfiguration)}
     */
  @Deprecated public void setTransports(String transports) {
  ...
  /**
     ...
     * server constructor which accept configuration {@link SocketIOServer#SocketIOServer(ServerConfiguration)}
     */
  @Deprecated public void setHeartbeatInterval(int heartbeatInterval) {
  ...
  /**
     ...
     * server constructor which accept configuration {@link SocketIOServer#SocketIOServer(ServerConfiguration)}
     */
  @Deprecated public void setAlwaysSecureWebSocketLocation(boolean alwaysSecureWebSocketLocation) {
  ...
  /**
     ...
     * server constructor which accept configuration {@link SocketIOServer#SocketIOServer(ServerConfiguration)}
     */
  @Deprecated public void setHeaderClientIpAddressName(String headerClientIpAddressName) {
