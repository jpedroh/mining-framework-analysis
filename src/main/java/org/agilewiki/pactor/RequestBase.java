 ...
 * </p>
 */
public abstract class RequestBase<RESPONSE_TYPE extends java.lang.Object> implements Request<RESPONSE_TYPE> {
  /**
  ...
  @Override public Mailbox getMailbox() {
    return mailbox;
  }
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public void send(final Mailbox source) throws Exception {
    mailbox.send(this, source);
  }

  @Override public void reply(final Mailbox source, final ResponseProcessor<RESPONSE_TYPE> responseProcessor) throws Exception {
    mailbox.reply(this, source, responseProcessor);
  }

  @Override public RESPONSE_TYPE pend() throws Exception {
