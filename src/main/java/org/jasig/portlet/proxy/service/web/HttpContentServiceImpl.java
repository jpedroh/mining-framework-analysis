 ...
 */
@Service(value = "httpContentService") public class HttpContentServiceImpl implements IContentService<HttpContentRequestImpl, GenericContentResponseImpl> {
  ...
  @Required @Resource(name = "replayedRequestHeaders") public void setReplayedRequestHeaders(List<String> replayedRequestHeaders) {
    this.replayedRequestHeaders = replayedRequestHeaders;
  }

  @Autowired(required = true) private IExpressionProcessor expressionParser;

  @Override public HttpContentRequestImpl getRequest(PortletRequest request) {
  ...
  @Override public void beforeGetContent(HttpContentRequestImpl proxyRequest, PortletRequest request) {
  ...
  @Override public GenericContentResponseImpl getContent(HttpContentRequestImpl proxyRequest, PortletRequest request) {
  ...
  @Override public void afterGetContent(HttpContentRequestImpl proxyRequest, PortletRequest request, GenericContentResponseImpl proxyResponse) {
  }
