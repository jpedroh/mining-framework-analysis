...
<<<<<<< /usr/src/app/output/jodaorg/joda-beans/dec9b88627fa8e7ff0b7804a22cb5cf594dbe7df/src/main/java/org/joda/beans/gen/BeanGenConfig.java/left.java
  /**
...
>>>>>>> /usr/src/app/output/jodaorg/joda-beans/dec9b88627fa8e7ff0b7804a22cb5cf594dbe7df/src/main/java/org/joda/beans/gen/BeanGenConfig.java/right.java
  ...
  public static BeanGenConfig parse(String resourceLocator) {
    ...
    if (resourceLocator.contains("/") || resourceLocator.endsWith(".ini")) {
      ...
      if (resourceLocator.equals("jdk6")) {
  ...
  private static BeanGenConfig parse(List<String> lines) {
    ...
    for (ListIterator<String> iterator = lines.listIterator(); iterator.hasNext(); ) {
      ...
      if (line.equals("[immutable.builder.to.immutable]")) {
        ...
        if (line.equals("[immutable.builder.to.mutable]")) {
          while (iterator.hasNext()) {
            line = iterator.next().trim();
            if (line.startsWith("[")) {
              iterator.previous();
          ...
          if (line.equals("[immutable.invalid.type]")) {
            while (iterator.hasNext()) {
              line = iterator.next().trim();
              int pos = line.indexOf('=');
              if (pos <= 0) {
            ...
            if (line.equals("[immutable.get.clone]")) {
              while (iterator.hasNext()) {
                line = iterator.next().trim();
                if (line.startsWith("[")) {
                  iterator.previous();
              ...
              if (line.equals("[immutable.builder.varargs]")) {
                while (iterator.hasNext()) {
                  line = iterator.next().trim();
                  if (line.startsWith("[")) {
                    iterator.previous();
                ...
                if (line.equals("[immutable.builder.type]")) {
                  while (iterator.hasNext()) {
                    line = iterator.next().trim();
                    if (line.startsWith("[")) {
                      iterator.previous();
                  ...
                  if (line.equals("[immutable.builder.init]")) {
                    while (iterator.hasNext()) {
                      line = iterator.next().trim();
                      if (line.startsWith("[")) {
                        iterator.previous();
                    ...
                    if (line.equals("[immutable.builder.add]")) {
                      while (iterator.hasNext()) {
                        line = iterator.next().trim();
                        if (line.startsWith("[")) {
                          iterator.previous();
  ...
  /**
     ...
     */
  private BeanGenConfig(Map<String, CopyGen> copyGenerators, Map<String, BuilderGen> builderGenerators, Map<String, CollectionGen> collectionGenerators, Map<String, String> builderTypes, Set<String> invalidImmutableTypes, Map<String, String> immutableVarArgs, Map<String, String> immutableGetClones) {
