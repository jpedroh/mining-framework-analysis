...
class GeneratableProperty {
      ...
      if (style.equals("is")) {
        ...
        if (style.equals("smart")) {
          ...
          if (style.equals("")) {
            ...
            if (style.equals("clone")) {
              getterGen = GetterGen.CloneGetterGen.PUBLIC;
            } else {
              if (style.equals("cloneCast")) {
                getterGen = GetterGen.CloneCastGetterGen.PUBLIC;
              } else {
                if (style.equals("manual")) {
                  getterGen = GetterGen.ManualGetterGen.INSTANCE;
                } else {
                  throw new RuntimeException("Unable to locate setter generator \'" + style + "\'" + " in " + getBean().getTypeRaw() + "." + getPropertyName());
                }
              }
            }
          }
  ...
  public void resolveSetterGen() {
    ...
    if (style.equals("set")) {
      ...
      if (style.equals("setClearAddAll")) {
        setterGen = new SetterGen.PatternSetterGen("$field.clear();\n$field.addAll($value);");
      } else {
        if (style.equals("setClearPutAll")) {
          setterGen = new SetterGen.PatternSetterGen("$field.clear();\n$field.putAll($value);");
        } else {
          if (style.equals("smart")) {
            if (isDerived()) {
            ...
            if (style.equals("")) {
              ...
              if (style.equals("manual")) {
                ...
                if (style.contains("$field") || style.contains("$value")) {
