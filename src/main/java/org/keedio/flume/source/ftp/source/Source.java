...
public class Source extends AbstractSource implements Configurable, PollableSource {
  ...
  private static final short ATTEMPTS_MAX = 3;
   ...
   */
  @Override public PollableSource.Status process() throws EventDeliveryException {
    try {
   ...
   * @throws IOException
   */
  private <T extends java.lang.Object> void discoverElements(KeedioSource keedioSource, String parentDir, String currentDir, int level, boolean recursive) throws IOException {
    long position;
    ...
    if (!(list.isEmpty())) {
      for (T element : list) {
        ...
        if (keedioSource.isDirectory(element)) {
          ...
          if (keedioSource.isFile(element)) {
            ...
            if (!(keedioSource.getFileList().containsKey(dirToList + "/" + elementName))) {
              sourceCounter.incrementFilesCount();
              position = 0L;
              ...
              if (dif > 0) {
                ...
                if (dif < 0) {
                  keedioSource.getExistFileList().remove(dirToList + "/" + elementName);
                  keedioSource.saveMap();
                  continue;
                } else {
                  continue;
            ...
            try {
              ...
              boolean success = inputStream != null && keedioSource.particularCommand();
              if (success) {
            ...
            if (keedioSource.isLink(element)) {
   ...
   */
  public <T extends java.lang.Object> boolean isBeingWritten(long lastModifiedTime, Integer timeout) {
...
<<<<<<< /usr/src/app/output/lazaromedina/flume-ftp-source/2911f84fb00a054b772a0c296274bd9efe2d9b59/src/main/java/org/keedio/flume/source/ftp/source/Source.java/left.java
...
>>>>>>> /usr/src/app/output/lazaromedina/flume-ftp-source/2911f84fb00a054b772a0c296274bd9efe2d9b59/src/main/java/org/keedio/flume/source/ftp/source/Source.java/right.java
