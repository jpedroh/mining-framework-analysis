...
public class SFTPSource extends KeedioSource<ChannelSftp.LsEntry> {
  ...
  @Override public void changeToDirectory(String directory) throws IOException {
    try {
  ...
  @Override public List<ChannelSftp.LsEntry> listElements(String directory) throws IOException {
  ...
  @Override public InputStream getInputStream(ChannelSftp.LsEntry file) throws IOException {
  ...
  @Override public String getObjectName(ChannelSftp.LsEntry file) {
    return file.getFilename();
  }

  @Override public boolean isDirectory(ChannelSftp.LsEntry file) {
    return file.getAttrs().isDir();
  }

  @Override public long getModifiedTime(ChannelSftp.LsEntry file) {
    return file.getAttrs().getMTime() * 1000L;
  }

  @Override public boolean isFile(ChannelSftp.LsEntry file) {
    boolean isfile;
  ...
  @Override public boolean particularCommand() {
    return true;
  }

  @Override public long getObjectSize(ChannelSftp.LsEntry file) {
    long filesize = 0L;
    try {
  ...
  @Override public boolean isLink(ChannelSftp.LsEntry file) {
    return file.getAttrs().isLink();
  }

  @Override public String getLink(ChannelSftp.LsEntry file) {
    String link = "";
    try {
  ...
  @Override public String getDirectoryserver() throws IOException {
  ...
  /**
     ...
     */
  @Override public Object getClientSource() {
    return sftpClient;
  }

  @Override public void setFileType(int fileType) throws IOException {
  }

  @Override public List<ChannelSftp.LsEntry> listElements(String dirToList, KeedioFileFilter filter) throws IOException {
    List<ChannelSftp.LsEntry> list = new ArrayList<>();
