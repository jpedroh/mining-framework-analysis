...
public final class Code extends Attribute {
  ...
  /**
     ...
     */
  Code(final int name_index, final int length, final DataInput file, final ConstantPool constant_pool, final boolean isOak) throws IOException {
    this(name_index, length, isOak ? file.readUnsignedByte() : file.readUnsignedShort(), isOak ? file.readUnsignedByte() : file.readUnsignedShort(), (byte[]) null, (CodeException[]) null, (Attribute[]) null, constant_pool);
    this.isOak = isOak;
  ...
  /**
     ...
     */
  public Code(final int name_index, final int length, final int maxStack, final int maxLocals, final byte[] code, final CodeException[] exceptionTable, final Attribute[] attributes, final ConstantPool constant_pool, final boolean isOak) {
  ...
  private int getInternalLength() {
    ...
    return maxStack + maxLocals + codeLength + code.length + 2 + 8 * (exceptionTable == null ? 0 : exceptionTable.length) + 2;
  }
