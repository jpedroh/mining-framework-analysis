...
public final class ConstantUtf8 extends Constant {
  ...
  private static final int MAX_CACHED_SIZE = Integer.getInteger(CONSTANT_UTF8_MAX_CACHED_SIZE_KEY, 200).intValue();
  ...
  private static class CACHE_HOLDER {
    ...
    private static final HashMap<String, ConstantUtf8> CACHE = new LinkedHashMap<String, ConstantUtf8>(INITIAL_CACHE_CAPACITY, 0.75f, true) {
