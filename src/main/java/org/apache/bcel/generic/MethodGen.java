...
public class MethodGen extends FieldGenOrMethodGen {
  ...
  public MethodGen(final Method m, final String class_name, final ConstantPoolGen cp) {
    this(m.getAccessFlags(), Type.getReturnType(m.getSignature()), Type.getArgumentTypes(m.getSignature()), null, m.getName(), class_name, ((m.getAccessFlags() & (Const.ACC_ABSTRACT | Const.ACC_NATIVE)) == 0) ? new InstructionList(m.getCode().getCode()) : null, cp);
      ...
      if (a instanceof Code) {
        ...
        if (ces != null) {
          for (final CodeException ce : ces) {
            ...
            if (type > 0) {
              final String cen = m.getConstantPool().getConstantString(type, Const.CONSTANT_Class);
...
>>>>>>> /usr/src/app/output/apache/commons-bcel/6917052a54643f63b5abebf79dae59eab5aebc4c/src/main/java/org/apache/bcel/generic/MethodGen.java/right.java

              updateLocalVariableTable(
<<<<<<< /usr/src/app/output/apache/commons-bcel/6917052a54643f63b5abebf79dae59eab5aebc4c/src/main/java/org/apache/bcel/generic/MethodGen.java/left.java
  ...
  public LocalVariableGen[] getLocalVariables() {
    ...
    if (size > 1) {
      Arrays.sort(lg, new Comparator<LocalVariableGen>() {
        @Override public int compare(final LocalVariableGen o1, final LocalVariableGen o2) {
...
>>>>>>> /usr/src/app/output/apache/commons-bcel/6917052a54643f63b5abebf79dae59eab5aebc4c/src/main/java/org/apache/bcel/generic/MethodGen.java/right.java
    ...
    if ((il != null) && !isAbstract() && !isNative()) {
      ...
      code = new Code(_cp.addUtf8("Code"), 8 + byte_code.length + 2 + exc_len + 2 + attrs_len, max_stack, max_locals, byte_code, c_exc, code_attrs, _cp.getConstantPool());
      addAttribute(code);
    }
  ...
  private void ensureExistingParameterAnnotationsUnpacked() {
    ...
    for (final Attribute attribute : attrs) {
      if (attribute instanceof ParameterAnnotations) {
        if (!hasParameterAnnotations) {
          @SuppressWarnings(value = { "unchecked" }) final List<AnnotationEntryGen>[] parmList = new List[arg_types.length];
