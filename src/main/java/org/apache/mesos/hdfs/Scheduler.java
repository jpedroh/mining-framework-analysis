...
public class Scheduler implements Scheduler , Runnable {
  ...
  public void run() {
    ...
    } catch (java.lang.InterruptedException | ExecutionException | InvalidProtocolBufferException e) {
  ...
  private void correctCurrentPhase() {
    ...
    } else if ((!liveState.isNameNode1Initialized()) || (!liveState.isNameNode2Initialized())) {
