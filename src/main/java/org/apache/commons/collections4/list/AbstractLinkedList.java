 ...
 * @since 3.0
 */
public abstract class AbstractLinkedList<E extends java.lang.Object> implements List<E> {
  /**
  ...
  @Override public ListIterator<E> listIterator(final int fromIndex) {
    return new LinkedListIterator<>(this, fromIndex);
  }

  @Override public int indexOf(final Object value) {
    int i = 0;
  ...
  @Override public int lastIndexOf(final Object value) {
    int i = size - 1;
  ...
  @Override @SuppressWarnings(value = { "unchecked" }) public <T extends java.lang.Object> T[] toArray(T[] array) {
  ...
  /**
     ...
     */
  @Override public List<E> subList(final int fromIndexInclusive, final int toIndexExclusive) {
    return new LinkedSubList<>(this, fromIndexInclusive, toIndexExclusive);
  }

  @Override public boolean add(final E value) {
    addLast(value);
    return true;
  }

  @Override public void add(final int index, final E value) {
  ...
  @Override public boolean addAll(final int index, final Collection<? extends E> coll) {
    final Node<E> node = getNode(index, true);
    for (final E e : coll) {
  ...
  @Override public E set(final int index, final E value) {
    final Node<E> node = getNode(index, false);
    final E oldValue = node.getValue();
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) protected void doReadObject(final ObjectInputStream inputStream) throws IOException, ClassNotFoundException {
    init();
  ...
  protected static class Node<E extends java.lang.Object> {
  ...
  protected static class LinkedListIterator<E extends java.lang.Object> implements ListIterator<E>, OrderedIterator<E> {
    /** The parent list */
    ...
    @Override public void add(final E obj) {
      checkModCount();
  ...
  protected static class LinkedSubListIterator<E extends java.lang.Object> extends LinkedListIterator<E> {
    /** The sub list */
  ...
  protected static class LinkedSubList<E extends java.lang.Object> extends AbstractList<E> {
    /** The main list */
    ...
    @Override public void add(final int index, final E obj) {
    ...
    @Override public E set(final int index, final E obj) {
      rangeCheck(index, size);
      checkModCount();
