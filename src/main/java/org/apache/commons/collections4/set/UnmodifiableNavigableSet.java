 ...
 * @since 4.1
 */
public final class UnmodifiableNavigableSet<E extends java.lang.Object> extends AbstractNavigableSetDecorator<E> implements Unmodifiable {
  ...
  /**
     ...
     */
  public static <E extends java.lang.Object> NavigableSet<E> unmodifiableNavigableSet(final NavigableSet<E> set) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) private void readObject(final ObjectInputStream in) throws IOException, ClassNotFoundException {
