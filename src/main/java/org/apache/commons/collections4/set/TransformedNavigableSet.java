 ...
 * @since 4.1
 */
public class TransformedNavigableSet<E extends java.lang.Object> extends TransformedSortedSet<E> implements NavigableSet<E> {
  ...
  /**
     ...
     */
  public static <E extends java.lang.Object> TransformedNavigableSet<E> transformingNavigableSet(final NavigableSet<E> set, final Transformer<? super E, ? extends E> transformer) {
  ...
  /**
     ...
     * @throws NullPointerException if set or transformer is null
     */
  public static <E extends java.lang.Object> TransformedNavigableSet<E> transformedNavigableSet(final NavigableSet<E> set, final Transformer<? super E, ? extends E> transformer) {
    final TransformedNavigableSet<E> decorated = new TransformedNavigableSet<>(set, transformer);
    if (set.size() > 0) {
      @SuppressWarnings(value = { "unchecked" }) final E[] values = (E[]) set.toArray();
      set.clear();
