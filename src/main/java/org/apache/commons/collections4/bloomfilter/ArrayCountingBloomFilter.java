...
public final class ArrayCountingBloomFilter implements CountingBloomFilter {
  ...
  @Override public ArrayCountingBloomFilter copy() {
  ...
  @Override public boolean add(final BitCountProducer other) {
    Objects.requireNonNull(other, "other");
    other.forEachCount(this::add);
    return isValid();
  }

  @Override public boolean subtract(final BitCountProducer other) {
    Objects.requireNonNull(other, "other");
  ...
  @Override public boolean forEachCount(final BitCountProducer.BitCountConsumer consumer) {
  ...
  @Override public int[] asIndexArray() {
