 ...
 * @since 4.0
 */
public abstract class AbstractPatriciaTrie<K extends java.lang.Object, V extends java.lang.Object> extends AbstractBitwiseTrie<K, V> {
  ...
  private static final class Reference<E extends java.lang.Object> {
    private E item;
  ...
  protected static class TrieEntry<K extends java.lang.Object, V extends java.lang.Object> extends BasicEntry<K, V> {
  ...
  private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
    ...
    private class EntryIterator extends AbstractTrieIterator<Map.Entry<K, V>> {
  ...
  private class KeySet extends AbstractSet<K> {
    ...
    private class KeyIterator extends AbstractTrieIterator<K> {
  ...
  private class Values extends AbstractCollection<V> {
    ...
    private class ValueIterator extends AbstractTrieIterator<V> {
  ...
  abstract class AbstractTrieIterator<E extends java.lang.Object> implements Iterator<E> {
    /** For fast-fail. */
  ...
  private class TrieMapIterator extends AbstractTrieIterator<K> implements OrderedMapIterator<K, V> {
    ...
    @Override protected TrieEntry<K, V> nextEntry() {
  ...
  private class RangeEntryMap extends AbstractRangeMap {
    ...
    @Override public K getFromKey() {
      return fromKey;
    }

    @Override public K getToKey() {
      return toKey;
    }

    @Override public boolean isFromInclusive() {
      return fromInclusive;
    }

    @Override public boolean isToInclusive() {
      return toInclusive;
    }

    @Override protected SortedMap<K, V> createRangeMap(final K fromKey, final boolean fromInclusive, final K toKey, final boolean toInclusive) {
  ...
  private class RangeEntrySet extends AbstractSet<Map.Entry<K, V>> {
    ...
    @SuppressWarnings(value = { "unchecked" }) @Override public boolean contains(final Object o) {
      if (!(o instanceof Map.Entry)) {
        return false;
      }
    ...
    @SuppressWarnings(value = { "unchecked" }) @Override public boolean remove(final Object o) {
      if (!(o instanceof Map.Entry)) {
        return false;
      }
      final Map.Entry<K, V> entry = (Map.Entry<K, V>) o;
  ...
  private class PrefixRangeMap extends AbstractRangeMap {
    ...
    /**
         ...
         */
    @Override protected boolean inRange(final K key) {
    ...
    /**
         ...
         */
    @Override protected boolean inRange2(final K key) {
      return inRange(key);
    }
    ...
    /**
         ...
         */
    @Override protected boolean inFromRange(final K key, final boolean forceInclusive) {
      return getKeyAnalyzer().isPrefix(prefix, offsetInBits, lengthInBits, key);
    }
    ...
    /**
         ...
         */
    @Override protected boolean inToRange(final K key, final boolean forceInclusive) {
      return getKeyAnalyzer().isPrefix(prefix, offsetInBits, lengthInBits, key);
    }
  ...
  private final class PrefixRangeEntrySet extends RangeEntrySet {
    ...
    private final class EntryIterator extends AbstractTrieIterator<Map.Entry<K, V>> {
      ...
      @Override protected TrieEntry<K, V> findNext(final TrieEntry<K, V> prior) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) private void readObject(final ObjectInputStream stream) throws IOException, ClassNotFoundException {
