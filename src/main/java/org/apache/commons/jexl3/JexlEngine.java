...
public abstract class JexlEngine {
  ...
  /**
     ...
     */
  protected static final java.lang.ThreadLocal<JexlEngine> ENGINE = new java.lang.ThreadLocal<JexlEngine>();
  ...
  public static final class EmptyNamespaceResolver implements JexlContext.NamespaceResolver {
    ...
    @Override public Object resolveNamespace(String name) {
      return null;
    }
  }
  ...
  /**
     ...
     */
  public abstract <T extends java.lang.Object> T newInstance(Class<? extends T> clazz, Object... args);
  ...
  protected String readSource(final File file) {
    ...
    try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(file), getCharset()))) {
