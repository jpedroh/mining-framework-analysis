...
public class JexlArithmetic {
  ...
  public JexlArithmetic options(final JexlOptions options) {
    if (options != null) {
      ...
      if (ostrict != isStrict() || bigdScale != getMathScale() || bigdContext != getMathContext()) {
  ...
  /**
     ...
     * @deprecated 3.2
     */
  @Deprecated public JexlArithmetic options(final JexlEngine.Options options) {
    if (options != null) {
  ...
  public Number narrowNumber(final Number original, final Class<?> narrow) {
    ...
    if (original instanceof Double || original instanceof Float) {
      ...
      if (narrowAccept(narrow, Byte.class) && value <= Byte.MAX_VALUE && value >= Byte.MIN_VALUE) {
        ...
        if (narrowAccept(narrow, Short.class) && value <= Short.MAX_VALUE && value >= Short.MIN_VALUE) {
          result = (short) value;
        } else {
          if (narrowAccept(narrow, Integer.class) && value <= Integer.MAX_VALUE && value >= Integer.MIN_VALUE) {
            result = (int) value;
          }
        }
      }
  ...
  public Object add(final Object left, final Object right) {
    ...
    final boolean strconcat = strict ? left instanceof String || right instanceof String : left instanceof String && right instanceof String;
    if (!strconcat) {
      try {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "MagicNumber" }) protected static boolean isMultiplyExact(final long x, final long y, final long r) {
    final long ax = Math.abs(x);
    final long ay = Math.abs(y);
    return !(((ax | ay) >>> (Integer.SIZE - 1) != 0) && (((y != 0) && (r / y != x)) || (x == Long.MIN_VALUE && y == -1)));
  }
...
<<<<<<< /usr/src/app/output/apache/commons-jexl/247bbdd4815bad2deffcf37089bf90c128dc1f20/src/main/java/org/apache/commons/jexl3/JexlArithmetic.java/left.java
        try {
...
>>>>>>> /usr/src/app/output/apache/commons-jexl/247bbdd4815bad2deffcf37089bf90c128dc1f20/src/main/java/org/apache/commons/jexl3/JexlArithmetic.java/right.java
...
>>>>>>> /usr/src/app/output/apache/commons-jexl/247bbdd4815bad2deffcf37089bf90c128dc1f20/src/main/java/org/apache/commons/jexl3/JexlArithmetic.java/right.java
      ...
      if (left instanceof Comparable<?>) {
        @SuppressWarnings(value = { "unchecked" }) final Comparable<Object> comparable = (Comparable<Object>) left;
  ...
  /**
     ...
     * @deprecated 3.0
     */
  @Deprecated public final Object bitwiseAnd(final Object lhs, final Object rhs) {
    return and(lhs, rhs);
  }
  ...
  /**
     ...
     * @deprecated 3.0
     */
  @Deprecated public final Object bitwiseOr(final Object lhs, final Object rhs) {
    return or(lhs, rhs);
  }
  ...
  /**
     ...
     * @deprecated 3.0
     */
  @Deprecated public final Object bitwiseXor(final Object lhs, final Object rhs) {
    return xor(lhs, rhs);
  }
  ...
  /**
     ...
     * @deprecated 3.0
     */
  @Deprecated public final Object logicalNot(final Object arg) {
    return not(arg);
  }
  ...
  /**
     ...
     * @deprecated 3.0
     */
  @Deprecated public final Object matches(final Object lhs, final Object rhs) {
    return contains(rhs, lhs);
  }
}