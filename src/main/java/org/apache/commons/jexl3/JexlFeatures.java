...
public final class JexlFeatures {
  ...
  private static final String[] F_NAMES = { "register", "reserved variable", "local variable", "assign/modify", "global assign/modify", "array reference", "create instance", "loop", "function", "method call", "set/map/array literal", "pragma", "annotation", "script", "lexical", "lexicalShade", "thin-arrow", "fat-arrow", 
...
>>>>>>> /usr/src/app/output/apache/commons-jexl/e1f233ff4da530bd493455793d0afb3b1444c954/src/main/java/org/apache/commons/jexl3/JexlFeatures.java/right.java
  ...
  /**
     ...
     */
  private static final long DEFAULT_FEATURES = (1L << LOCAL_VAR) | (1L << SIDE_EFFECT) | (1L << SIDE_EFFECT_GLOBAL) | (1L << ARRAY_REF_EXPR) | (1L << NEW_INSTANCE) | (1L << LOOP) | (1L << LAMBDA) | (1L << METHOD_CALL) | (1L << STRUCTURED_LITERAL) | (1L << PRAGMA) | (1L << ANNOTATION) | (1L << SCRIPT) | (1L << THIN_ARROW) | (1L << NS_PRAGMA) | (1L << IMPORT_PRAGMA);
  ...
  public JexlFeatures() {
    flags = 
<<<<<<< /usr/src/app/output/apache/commons-jexl/e1f233ff4da530bd493455793d0afb3b1444c954/src/main/java/org/apache/commons/jexl3/JexlFeatures.java/left.java
    (1L << LOCAL_VAR) | (1L << SIDE_EFFECT) | (1L << SIDE_EFFECT_GLOBAL) | (1L << ARRAY_REF_EXPR) | (1L << NEW_INSTANCE) | (1L << LOOP) | (1L << LAMBDA) | (1L << METHOD_CALL) | (1L << STRUCTURED_LITERAL) | (1L << PRAGMA) | (1L << ANNOTATION) | (1L << SCRIPT) | (1L << THIN_ARROW) | (1L << EXT_REL_OPER)
=======
    DEFAULT_FEATURES
>>>>>>> /usr/src/app/output/apache/commons-jexl/e1f233ff4da530bd493455793d0afb3b1444c954/src/main/java/org/apache/commons/jexl3/JexlFeatures.java/right.java
    ;
