...
public class Threader {
  ...
  private void gatherSubjects(final ThreadContainer root) {
    ...
    for (prev = null, c = root.child, rest = c.next; c != null; prev = c, c = rest, rest = (rest == null ? null : rest.next)) {
      ...
      if (old.threadable == null && c.threadable == null) {
        ...
        if (old.threadable == null || (c.threadable != null && c.threadable.subjectIsReply() && !old.threadable.subjectIsReply())) {
          c.parent = old;
          c.next = old.child;
          old.child = c;
        } else {
  ...
  private void pruneEmptyContainers(final ThreadContainer parent) {
    ...
    for (prev = null, container = parent.child, next = container.next; container != null; prev = container, container = next, next = (container == null ? null : container.next)) {
      if (container.threadable == null && container.child == null) {
        ...
        if (container.threadable == null && (container.parent != null || container.child.next == null)) {
          ThreadContainer tail;
  ...
  /**
     ...
     */
  @Deprecated public Threadable thread(final Threadable[] messages) {
    if (messages == null) {
      return null;
    }
