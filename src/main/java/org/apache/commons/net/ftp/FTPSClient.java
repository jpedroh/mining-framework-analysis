...
public class FTPSClient extends FTPClient {
  ...
  protected void execAUTH() throws SSLException, IOException {
    ...
    if (FTPReply.SECURITY_MECHANISM_IS_OK == replyCode) {
      ...
      if (FTPReply.SECURITY_DATA_EXCHANGE_COMPLETE != replyCode) {
  ...
  /**
     ...
     */
  @Override @Deprecated protected Socket _openDataConnection_(int command, String arg) throws IOException {
