...
public class ValidatorResources implements Serializable {
  ...
  /**
     ...
     */
  @Deprecated protected FastHashMap hFormSets = new FastHashMap();
  ...
  /**
     ...
     */
  @Deprecated protected FastHashMap hConstants = new FastHashMap();
  ...
  /**
     ...
     */
  @Deprecated protected FastHashMap hActions = new FastHashMap();
  ...
  private void addOldArgRules(final Digester digester) {
    final Rule rule = new Rule() {
      @Override public void begin(final String namespace, final String name, final Attributes attributes) throws Exception {
  ...
  private FormSet getParent(final FormSet fs) {
    ...
    if (fs.getType() == FormSet.LANGUAGE_FORMSET) {
      ...
      if (fs.getType() == FormSet.COUNTRY_FORMSET) {
        parent = getFormSets().get(buildLocale(fs.getLanguage(), null, null));
        if (parent == null) {
          parent = defaultFormSet;
        }
      } else {
        if (fs.getType() == FormSet.VARIANT_FORMSET) {
  ...
  /**
     ...
     * @since 1.2.0
     */
  @SuppressWarnings(value = { "unchecked" }) protected Map<String, FormSet> getFormSets() {
    return hFormSets;
  }
  ...
  /**
     ...
     * @since 1.2.0
     */
  @SuppressWarnings(value = { "unchecked" }) protected Map<String, String> getConstants() {
    return hConstants;
  }
  ...
  /**
     ...
     * @since 1.2.0
     */
  @SuppressWarnings(value = { "unchecked" }) protected Map<String, ValidatorAction> getActions() {
    return hActions;
  }
