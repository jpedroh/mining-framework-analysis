...
public final class CSVFormat implements Serializable {
  ...
  /**
     ...
     */
  public static final CSVFormat DEFAULT = new CSVFormat(COMMA, DOUBLE_QUOTE_CHAR, null, null, null, false, true, CRLF, null, null, null, false, false, false, false, false, false, true);
  ...
  /**
     ...
     *      -data.html</a>
     */
  public static final CSVFormat MYSQL = DEFAULT.builder().setDelimiter(TAB).setEscape(BACKSLASH).setIgnoreEmptyLines(false).setQuote(null).setRecordSeparator(LF).setNullString("\\N").setQuoteMode(QuoteMode.ALL_NON_NULL).build();
  ...
  /**
     ...
     * @since 1.6
     */
  public static final CSVFormat ORACLE = DEFAULT.builder().setDelimiter(COMMA).setEscape(BACKSLASH).setIgnoreEmptyLines(false).setQuote(DOUBLE_QUOTE_CHAR).setNullString("\\N").setTrim(true).setRecordSeparator(System.lineSeparator()).setQuoteMode(QuoteMode.MINIMAL).build();
  ...
  /**
     ...
     * @since 1.5
     */
  public static final CSVFormat POSTGRESQL_CSV = DEFAULT.builder().setDelimiter(COMMA).setEscape(DOUBLE_QUOTE_CHAR).setIgnoreEmptyLines(false).setQuote(DOUBLE_QUOTE_CHAR).setRecordSeparator(LF).setNullString(EMPTY).setQuoteMode(QuoteMode.ALL_NON_NULL).build();
  ...
  /**
     ...
     * @since 1.5
     */
  public static final CSVFormat POSTGRESQL_TEXT = DEFAULT.builder().setDelimiter(TAB).setEscape(BACKSLASH).setIgnoreEmptyLines(false).setQuote(DOUBLE_QUOTE_CHAR).setRecordSeparator(LF).setNullString("\\N").setQuoteMode(QuoteMode.ALL_NON_NULL).build();
  ...
  /**
     ...
     */
  @SafeVarargs static <T extends java.lang.Object> T[] clone(final T... values) {
  ...
  @Override public int hashCode() {
    ...
    return prime * result + Objects.hash(allowDuplicateHeaderNames, allowMissingColumnNames, autoFlush, commentMarker, delimiter, escapeCharacter, ignoreEmptyLines, ignoreHeaderCase, ignoreSurroundingSpaces, nullString, quoteCharacter, quoteMode, quotedNullString, recordSeparator, skipHeaderRecord, trailingDelimiter, trim);
  }
  ...
  /**
     ...
     * @since 1.5
     */
  @SuppressWarnings(value = { "resource" }) public CSVPrinter print(final File out, final Charset charset) throws IOException {
  ...
  /**
     ...
     * @since 1.5
     */
  @SuppressWarnings(value = { "resource" }) public CSVPrinter print(final Path out, final Charset charset) throws IOException {
  ...
  private void printWithEscapes(final Reader reader, final Appendable appendable) throws IOException {
    int start = 0;
    int pos = 0;
    @SuppressWarnings(value = { "resource" }) final ExtendedBufferedReader bufferedReader = new ExtendedBufferedReader(reader);
    final char[] delim = getDelimiterString().toCharArray();
    final int delimLength = delim.length;
    final char escape = getEscapeCharacter().charValue();
    ...
    while (-1 != (c = bufferedReader.read())) {
      ...
      final boolean isDelimiterStart = isDelimiter((char) c, builder.toString() + new String(bufferedReader.lookAhead(delimLength - 1)), pos, delim, delimLength);
      if (c == CR || c == LF || c == escape || isDelimiterStart) {
        if (pos > start) {
...
<<<<<<< /usr/src/app/output/apache/commons-csv/cf1fea845b1f0a451aba0612f3a836ff7de7e71c/src/main/java/org/apache/commons/csv/CSVFormat.java/left.java
          appendable.append(quote);
=======
          append(builder.substring(0, pos), appendable);
>>>>>>> /usr/src/app/output/apache/commons-csv/cf1fea845b1f0a451aba0612f3a836ff7de7e71c/src/main/java/org/apache/commons/csv/CSVFormat.java/right.java
...
>>>>>>> /usr/src/app/output/apache/commons-csv/cf1fea845b1f0a451aba0612f3a836ff7de7e71c/src/main/java/org/apache/commons/csv/CSVFormat.java/right.java
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withAllowDuplicateHeaderNames(final boolean allowDuplicateHeaderNames) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withAllowMissingColumnNames(final boolean allowMissingColumnNames) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withAutoFlush(final boolean autoFlush) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withCommentMarker(final char commentMarker) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withCommentMarker(final Character commentMarker) {
    return builder().setCommentMarker(commentMarker).build();
  }
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withDelimiter(final char delimiter) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withEscape(final char escape) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withEscape(final Character escape) {
    return builder().setEscape(escape).build();
  }
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withHeader(final Class<? extends Enum<?>> headerEnum) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withHeader(final ResultSet resultSet) throws SQLException {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withHeader(final ResultSetMetaData resultSetMetaData) throws SQLException {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withHeader(final String... header) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withHeaderComments(final Object... headerComments) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withIgnoreEmptyLines(final boolean ignoreEmptyLines) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withIgnoreHeaderCase(final boolean ignoreHeaderCase) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withIgnoreSurroundingSpaces(final boolean ignoreSurroundingSpaces) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withNullString(final String nullString) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withQuote(final char quoteChar) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withQuote(final Character quoteChar) {
    return builder().setQuote(quoteChar).build();
  }
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withQuoteMode(final QuoteMode quoteMode) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withRecordSeparator(final char recordSeparator) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withRecordSeparator(final String recordSeparator) {
    return builder().setRecordSeparator(recordSeparator).build();
  }
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withSkipHeaderRecord(final boolean skipHeaderRecord) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withTrailingDelimiter(final boolean trailingDelimiter) {
  ...
  /**
     ...
     */
  @Deprecated public CSVFormat withTrim(final boolean trim) {
