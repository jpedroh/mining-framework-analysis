...
public final class MurmurHash3 {
  ...
  /**
     ...
     */
  @Deprecated public static long hash64(final long data) {
  ...
  /**
     ...
     */
  @Deprecated public static long hash64(final int data) {
  ...
  /**
     ...
     */
  @Deprecated public static long hash64(final short data) {
    long hash = DEFAULT_SEED;
    long k1 = 0;
    k1 ^= ((long) data & 0xff) << 8;
  ...
  /**
     ...
     */
  @Deprecated public static long hash64(final byte[] data) {
  ...
  /**
     ...
     */
  @Deprecated public static long hash64(final byte[] data, final int offset, final int length) {
  ...
  /**
     ...
     * Use half of the hash bytes from {@link #hash128x64(byte[], int, int, int)}.
     */
  @Deprecated public static long hash64(final byte[] data, final int offset, final int length, final int seed) {
    long hash = seed;
  ...
  @Deprecated public static class IncrementalHash32 extends IncrementalHash32x86 {
    /**
         * {@inheritDoc}
         *
         * <p>This implementation contains a sign-extension bug in the finalisation step of
         ...
         */
    @Override @Deprecated int finalise(final int hash, final int unprocessedLength, final byte[] unprocessed, final int totalLen) {
      int result = hash;
      int k1 = 0;
      switch (unprocessedLength) {
        case 3:
