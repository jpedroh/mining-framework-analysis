...
public final class MurmurHash3 {
  ...
  /**
     ...
     */
  @Deprecated public static int hash32(final long l0, final long l1) {
  ...
  /**
     ...
     * @deprecated use hash32_x86
     */
  @Deprecated public static int hash32(final long l0) {
  ...
  /**
     ...
     * @deprecated use hash32_x86
     */
  @Deprecated public static int hash32(final long l0, final int seed) {
    int hash = seed;
  ...
  /**
     ...
     * @deprecated use hash32_x86
     */
  @Deprecated public static int hash32(final long l0, final long l1, final int seed) {
    int hash = seed;
    final long r0 = Long.reverseBytes(l0);
  ...
  /**
     ...
     * @deprecated use hash32_x86
     */
  @Deprecated public static int hash32(final byte[] data) {
  ...
  /**
     ...
     * @deprecated use hash32_x86
     */
  @Deprecated public static int hash32(final String data) {
  ...
  /**
     ...
     * @deprecated use hash32_x86
     */
  @Deprecated public static int hash32(final byte[] data, final int length) {
  ...
  /**
     ...
     * @deprecated use hash32_x86
     */
  @Deprecated public static int hash32(final byte[] data, final int length, final int seed) {
  ...
  /**
     ...
     * @deprecated use hash32_x86
     */
  @Deprecated public static int hash32(final byte[] data, final int offset, final int length, final int seed) {
    int hash = seed;
    final int nblocks = length >> 2;
    for (int i = 0; i < nblocks; i++) {
      final int i_4 = i << 2;
      final int k = (data[offset + i_4] & 0xff) | ((data[offset + i_4 + 1] & 0xff) << 8) | ((data[offset + i_4 + 2] & 0xff) << 16) | ((data[offset + i_4 + 3] & 0xff) << 24);
      hash = mix32(k, hash);
    }
  ...
  public static long hash64(final byte[] data, final int offset, final int length, final int seed) {
    ...
    for (int i = 0; i < nblocks; i++) {
      final int i8 = i << 3;
      long k = ((long) data[offset + i8] & UBYTE_MASK) | (((long) data[offset + i8 + 1] & UBYTE_MASK) << 8) | (((long) data[offset + i8 + 2] & UBYTE_MASK) << 16) | (((long) data[offset + i8 + 3] & UBYTE_MASK) << 24) | (((long) data[offset + i8 + 4] & UBYTE_MASK) << 32) | (((long) data[offset + i8 + 5] & UBYTE_MASK) << 40) | (((long) data[offset + i8 + 6] & UBYTE_MASK) << 48) | (((long) data[offset + i8 + 7] & UBYTE_MASK) << 56);
      k *= C1;
      k = Long.rotateLeft(k, R1);
      k *= C2;
      hash ^= k;
  ...
  /**
     ...
     */
  @Deprecated public static long[] hash128(final byte[] data) {
  ...
  /**
     ...
     * @deprecated use hash128_x64
     */
  @Deprecated public static long[] hash128(final String data) {
    final byte[] origin = data.getBytes();
  ...
  /**
     ...
     * @deprecated use hash128_x64
     */
  @Deprecated public static long[] hash128(final byte[] data, final int offset, final int length, final int seed) {
    long h1 = seed & UINT_MASK;
    long h2 = seed & UINT_MASK;
    final int nblocks = length >> 4;
    for (int i = 0; i < nblocks; i++) {
      final int i16 = i << 4;
      long k1 = ((long) data[offset + i16] & UBYTE_MASK) | (((long) data[offset + i16 + 1] & UBYTE_MASK) << 8) | (((long) data[offset + i16 + 2] & UBYTE_MASK) << 16) | (((long) data[offset + i16 + 3] & UBYTE_MASK) << 24) | (((long) data[offset + i16 + 4] & UBYTE_MASK) << 32) | (((long) data[offset + i16 + 5] & UBYTE_MASK) << 40) | (((long) data[offset + i16 + 6] & UBYTE_MASK) << 48) | (((long) data[offset + i16 + 7] & UBYTE_MASK) << 56);
      long k2 = ((long) data[offset + i16 + 8] & UBYTE_MASK) | (((long) data[offset + i16 + 9] & UBYTE_MASK) << 8) | (((long) data[offset + i16 + 10] & UBYTE_MASK) << 16) | (((long) data[offset + i16 + 11] & UBYTE_MASK) << 24) | (((long) data[offset + i16 + 12] & UBYTE_MASK) << 32) | (((long) data[offset + i16 + 13] & UBYTE_MASK) << 40) | (((long) data[offset + i16 + 14] & UBYTE_MASK) << 48) | (((long) data[offset + i16 + 15] & UBYTE_MASK) << 56);
      k1 *= C1;
      k1 = Long.rotateLeft(k1, R1);
      k1 *= C2;
      h1 ^= k1;
    ...
    while (pos < end) {
      ...
      if (code < 0x80) {
        ...
        if (code < 0x800) {
          ...
          if (code < 0xd800 || code > 0xdfff || pos >= end) {
            k2 = (0xe0 | (code >> 12)) | ((0x80 | ((code >> 6) & 0x3f)) << 8) | ((0x80 | (code & 0x3f)) << 16);
            bits = 24;
          } else {
            int utf32 = data.charAt(pos++);
            utf32 = ((code - 0xd7c0) << 10) + (utf32 & 0x3ff);
            k2 = (UBYTE_MASK & (0xF0 | (utf32 >> 18))) | ((0x80 | ((utf32 >> 12) & 0x3f))) << 8 | ((0x80 | ((utf32 >> 6) & 0x3f))) << 16 | (0x80 | (utf32 & 0x3f)) << 24;
            bits = 32;
          }
        }
      }
  ...
  public static final long getLongLittleEndian(byte[] buf, int offset) {
    return ((long) buf[offset + 7] << 56) | ((buf[offset + 6] & UBYTE_LONG_MASK) << 48) | ((buf[offset + 5] & UBYTE_LONG_MASK) << 40) | ((buf[offset + 4] & UBYTE_LONG_MASK) << 32) | ((buf[offset + 3] & UBYTE_LONG_MASK) << 24) | ((buf[offset + 2] & UBYTE_LONG_MASK) << 16) | ((buf[offset + 1] & UBYTE_LONG_MASK) << 8) | ((buf[offset] & UBYTE_LONG_MASK));
  }
  ...
  public static long[] hash128_x64(byte[] key, int offset, int len, int seed) {
    ...
    switch (len & 15) {
      case 15:
      k2 = (key[roundedEnd + 14] & UBYTE_LONG_MASK) << 48;
      case 14:
      k2 |= (key[roundedEnd + 13] & UBYTE_LONG_MASK) << 40;
      case 13:
      k2 |= (key[roundedEnd + 12] & UBYTE_LONG_MASK) << 32;
      case 12:
      k2 |= (key[roundedEnd + 11] & UBYTE_LONG_MASK) << 24;
      case 11:
      k2 |= (key[roundedEnd + 10] & UBYTE_LONG_MASK) << 16;
      case 10:
      k2 |= (key[roundedEnd + 9] & UBYTE_LONG_MASK) << 8;
      case 9:
      k2 |= (key[roundedEnd + 8] & UBYTE_LONG_MASK);
      k2 *= c2;
      k2 = Long.rotateLeft(k2, 33);
      k2 *= c1;
      h2 ^= k2;
      ...
      case 7:
      k1 |= (key[roundedEnd + 6] & UBYTE_LONG_MASK) << 48;
      case 6:
      k1 |= (key[roundedEnd + 5] & UBYTE_LONG_MASK) << 40;
      case 5:
      k1 |= (key[roundedEnd + 4] & UBYTE_LONG_MASK) << 32;
      case 4:
      k1 |= (key[roundedEnd + 3] & UBYTE_LONG_MASK) << 24;
      case 3:
      k1 |= (key[roundedEnd + 2] & UBYTE_LONG_MASK) << 16;
      case 2:
      k1 |= (key[roundedEnd + 1] & UBYTE_LONG_MASK) << 8;
      case 1:
      k1 |= (key[roundedEnd] & UBYTE_LONG_MASK);
      k1 *= c1;
      k1 = Long.rotateLeft(k1, 31);
      k1 *= c2;
      h1 ^= k1;
