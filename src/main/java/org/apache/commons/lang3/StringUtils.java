...
public class StringUtils {
  ...
  /**
     ...
     */
  @Deprecated public static String chomp(final String str, final String separator) {
  ...
  /**
     ...
     * @see StringUtils#defaultString(String, String)
     */
  public static <T extends CharSequence> T getIfBlank(final T str, final Supplier<T> defaultStrSupplier) {
  ...
  /**
     ...
     * @see StringUtils#defaultString(String, String)
     */
  public static <T extends CharSequence> T getIfEmpty(final T str, final Supplier<T> defaultStrSupplier) {
  ...
  /**
     ...
     * <pre>
     * {@code
     * StringUtils.getIfNullString(null, () -> "NULL")    = "NULL"
     * StringUtils.getIfNullString("", () -> "NULL")      = ""
     * StringUtils.getIfNullString("bat", () -> "NULL")   = "bat"
     * StringUtils.getIfNullString(null, () -> null)      = null
     * StringUtils.getIfNullString(null, null)            = null
     * }
     * </pre>
     ...
     */
  public static String getIfNullString(final String str, final Supplier<String> defaultStrSupplier) {
  ...
  /**
     ...
     * @since 3.8
     */
  @SafeVarargs public static <T extends CharSequence> T firstNonBlank(final T... values) {
    if (values != null) {
  ...
  /**
     ...
     * @since 3.8
     */
  @SafeVarargs public static <T extends CharSequence> T firstNonEmpty(final T... values) {
    if (values != null) {
      for (final T val : values) {
        if (isNotEmpty(val)) {
          return val;
  ...
  /**
     ...
     */
  @Deprecated public static int getFuzzyDistance(final CharSequence term, final CharSequence query, final Locale locale) {
  ...
  /**
     ...
     */
  @Deprecated public static double getJaroWinklerDistance(final CharSequence first, final CharSequence second) {
  ...
  /**
     ...
     */
  @Deprecated public static int getLevenshteinDistance(CharSequence s, CharSequence t) {
    if (s == null || t == null) {
      throw new IllegalArgumentException("Strings must not be null");
    }
    int n = s.length();
  ...
  /**
     ...
     * LevenshteinDistance</a> instead
     */
  @Deprecated public static int getLevenshteinDistance(CharSequence s, CharSequence t, final int threshold) {
    if (s == null || t == null) {
      throw new IllegalArgumentException("Strings must not be null");
    }
    if (threshold < 0) {
  ...
  /**
     ...
     */
  @SafeVarargs public static <T extends java.lang.Object> String join(final T... elements) {
  ...
  /**
     ...
     */
  @Deprecated public static String removeAll(final String text, final String regex) {
  ...
  /**
     ...
     * @deprecated Moved to RegExUtils.
     */
  @Deprecated public static String removeFirst(final String text, final String regex) {
  ...
  /**
     ...
     * @deprecated Moved to RegExUtils.
     */
  @Deprecated public static String removePattern(final String source, final String regex) {
  ...
  /**
     ...
     * @deprecated Moved to RegExUtils.
     */
  @Deprecated public static String replaceAll(final String text, final String regex, final String replacement) {
  ...
  /**
     ...
     * @deprecated Moved to RegExUtils.
     */
  @Deprecated public static String replaceFirst(final String text, final String regex, final String replacement) {
  ...
  /**
     ...
     * @deprecated Moved to RegExUtils.
     */
  @Deprecated public static String replacePattern(final String source, final String regex, final String replacement) {
  ...
  /**
     ...
     * @since 3.1
     */
  @Deprecated public static String toString(final byte[] bytes, final String charsetName) throws UnsupportedEncodingException {
