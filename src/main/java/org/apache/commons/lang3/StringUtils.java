...
public class StringUtils {
  ...
  /**
     ...
     */
  @Deprecated public static String defaultString(final String str, final String nullDefault) {
  ...
  private static StringJoiner newStringJoiner(final String delimiter) {
