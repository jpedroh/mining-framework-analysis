...
public class JmxTransExporterConfiguration {
  ...
  @Override public String toString() {
    return "JmxTransExporterConfiguration{" + "queries=" + queries + ", invocations=" + invocations + ", outputWriter=" + outputWriter + ", collectInterval=" + collectInterval + " " + collectIntervalTimeUnit + '}';
  }
