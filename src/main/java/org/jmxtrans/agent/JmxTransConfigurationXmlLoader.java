...
public class JmxTransConfigurationXmlLoader implements JmxTransConfigurationLoader {
  ...
  @Nonnull private final Resource configurationResource;
  ...
  @Override public JmxTransExporterConfiguration loadConfiguration() {
  ...
  protected JmxTransExporterConfiguration build(Document document) {
    ...
    Integer reloadConfigInterval = getIntegerElementValueOrNullIfNotSet(rootElement, "reloadConfigurationCheckIntervalInSeconds", resolver);
  ...
  @Nonnull private Map<String, String> loadPropertiesOrEmptyOnException() {
    try {
  ...
  @Override public String toString() {
    return "JmxTransConfigurationXmlLoader{" + "configurationResource=\'" + configurationResource + '\'' + '}';
  }
}