...
/**
 ...
 @param <T>
 */
public interface View<T extends java.lang.Object> extends Transformable<T> {
  public static final View<?> EMPTY_VIEW = Option::none;

  @SuppressWarnings(value = { "unchecked" }) public static <U extends java.lang.Object> View<U> emptyView() {
    return (View<U>) EMPTY_VIEW;
  }

  public static <T extends java.lang.Object> View<T> of(Iterator<T> i) {
    return ViewFromIterator.of(i);
  }

  public static <T extends java.lang.Object> View<T> of(Iterable<T> i) {
    return ViewFromIterator.of(i);
  }

  @SafeVarargs public static <T extends java.lang.Object> View<T> ofArray(T... i) {
  ...
  @Override default <U extends java.lang.Object> View<U> map(Function<T, U> func) {
    return ViewMapped.of(this, func);
  }

  @Override default View<T> filter(Predicate<T> pred) {
    return ViewFiltered.of(this, pred);
  }

  @Override default void forEach(Consumer<T> se) {
    Option<T> item = next();
    while (item.isSome()) {
      se.accept(item.get());
      item = next();
  ...
  /**
     ...
     */
  @Override @Deprecated default T firstMatching(Predicate<T> pred) {
    Option<T> item = next();
    while (item.isSome()) {
      T t = item.get();
      if (pred.test(t)) {
  ...
  @Override default <U extends java.lang.Object> U foldLeft(U u, BiFunction<U, T, U> fun) {
    Option<T> item = next();
    while (item.isSome()) {
  ...
  /**
     ...
     */
  default <U extends java.lang.Object> View<U> flatMap(Function<T, View<U>> func) {
