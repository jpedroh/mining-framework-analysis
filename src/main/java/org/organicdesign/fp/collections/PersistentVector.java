 ...
 */
public class PersistentVector<E extends java.lang.Object> extends UnmodList.AbstractUnmodList<E> implements ImList<E>, Serializable {
  ...
  public final static PersistentVector<?> EMPTY = new PersistentVector<>(0, NODE_LENGTH_POW_2, EMPTY_NODE, new Object[] {  });

  /** Returns the empty ImList (there only needs to be one) */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> PersistentVector<T> empty() {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> MutVector<T> emptyMutable() {
  ...
  /**
     ...
     */
  static public <T extends java.lang.Object> PersistentVector<T> ofIter(Iterable<T> items) {
  ...
  @Override public MutVector<E> mutable() {
  ...
  @SuppressWarnings(value = { "unchecked" }) private E[] leafNodeArrayFor(int i) {
    if (i >= 0 && i < size) {
      if (i >= tailoff()) {
        return tail;
      }
  ...
  /** {@inheritDoc} */
  @SuppressWarnings(value = { "unchecked" }) @Override public PersistentVector<E> replace(int i, E val) {
    if (i >= 0 && i < size) {
      if (i >= tailoff()) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) @Override public PersistentVector<E> append(E val) {
  ...
  private Node pushTail(int level, Node parent, Node tailnode) {
    ...
    if (level == NODE_LENGTH_POW_2) {
      ...
      nodeToInsert = (child == null) ? newPath(root.edit, level - NODE_LENGTH_POW_2, tailnode) : pushTail(level - NODE_LENGTH_POW_2, child, tailnode);
    }
  ...
  @SuppressWarnings(value = { "WeakerAccess" }) public static final class MutVector<F extends java.lang.Object> extends UnmodList.AbstractUnmodList<F> implements MutList<F> {
    private int size;
    ...
    @SuppressWarnings(value = { "unchecked" }) @Override public PersistentVector<F> immutable() {
      ensureEditable();
      root.edit.set(null);
    ...
    @SuppressWarnings(value = { "unchecked" }) @Override public MutList<F> append(F val) {
      ensureEditable();
      int i = size;
    ...
    @SuppressWarnings(value = { "unchecked" }) private Node pushTail(int level, Node parent, Node tailnode) {
      ...
      if (level == NODE_LENGTH_POW_2) {
        ...
        Node child = (Node) parent.array[subidx];
        nodeToInsert = (child != null) ? pushTail(level - NODE_LENGTH_POW_2, child, tailnode) : newPath(root.edit, level - NODE_LENGTH_POW_2, tailnode);
      }
      ret.array[subidx] = nodeToInsert;
      return ret;
    }
    ...
    @SuppressWarnings(value = { "unchecked" }) private F[] editableArrayFor(int i) {
      if (i >= 0 && i < size) {
        if (i >= tailoff()) {
          return tail;
        }
    ...
    @SuppressWarnings(value = { "unchecked" }) private static <T extends java.lang.Object> T[] editableTail(T[] tl) {
