 ...
 */
public interface Transformable<T extends java.lang.Object> {
  /**
  ...
  default Option<T> head() {
    return foldUntil(Option.none(), (accum, item) -> Option.someOrNullNoneOf(item), Fn2.first()).match((g) -> Option.none(), (b) -> b);
  }
  ...
  /**
     ...
     */
  <U extends java.lang.Object> Transformable<U> flatMap(Fn1<? super T, Iterable<U>> f);
  ...
  /**
     ...
     */
  <U extends java.lang.Object> U fold(U accum, Fn2<? super U, ? super T, U> reducer);
  ...
  /**
     ...
     */
  <G extends java.lang.Object, B extends java.lang.Object> Or<G, B> foldUntil(G accum, Fn2<? super G, ? super T, B> terminator, Fn2<? super G, ? super T, G> reducer);
  ...
  /**
     ...
     */
  <U extends java.lang.Object> Transformable<U> map(Fn1<? super T, ? extends U> func);
  ...
  /**
     ...
     */
  default <K extends java.lang.Object, V extends java.lang.Object> ImMap<K, V> toImMap(Fn1<? super T, Entry<K, V>> f1) {
  ...
  /**
     ...
     */
  default <K extends java.lang.Object, V extends java.lang.Object> ImSortedMap<K, V> toImSortedMap(Comparator<? super K> comp, Fn1<? super T, Entry<K, V>> f1) {
    return fold((ImSortedMap<K, V>) PersistentTreeMap.<K, V>empty(comp), (ts, t) -> ts.assoc(f1.apply(t)));
  }
  ...
  /**
     ...
     */
  default <K extends java.lang.Object, V extends java.lang.Object> MutMap<K, V> toMutMap(final Fn1<? super T, Entry<K, V>> f1) {
  ...
  default MutableRrbt<T> toMutableRrbt() {
    return fold(RrbTree.emptyMutable(), MutableRrbt<T>::append);
  }
  ...
  /**
     ...
     @return A map with the keys from the given set, mapped to values using the given function.
     */
  default <K extends java.lang.Object, V extends java.lang.Object> SortedMap<K, V> toMutSortedMap(Comparator<? super K> comp, final Fn1<? super T, Entry<K, V>> f1) {
