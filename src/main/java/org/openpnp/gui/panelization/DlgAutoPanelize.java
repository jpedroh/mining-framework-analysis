...
public class DlgAutoPanelize extends JDialog {
  ...
  public DlgAutoPanelize(Frame parent, JobPanel jobPanel) {
    ...
    jPanel.setBorder(new TitledBorder(null, "Panelize Parameters ", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    ...
    if (jobPanel.getJob().getPanels() == null || jobPanel.getJob().getPanels().isEmpty()) {
      jobPanel.getJob().addPanel(new Panel("Panel1", 3, 3, new Length(0, LengthUnit.Millimeters), new Length(0, LengthUnit.Millimeters), "", false, new Placement("PanelFid1"), new Placement("PanelFid2")));
    }
  ...
  private class SwingAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
      UiUtils.messageBoxOnException(() -> {
        ...
        p1.setPart(part);
        Panel pcbPanel = new Panel("Panel1", cols, rows, gapX, gapY, partId, checkFidsCheckBox.isSelected(), p0, p1);
