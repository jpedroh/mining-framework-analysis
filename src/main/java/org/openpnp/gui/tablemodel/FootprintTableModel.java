...
public class FootprintTableModel extends AbstractTableModel {
  private String[] columnNames = new String[] { Translations.getString("FootPrintTableModel.ColumnName.Name"), "X", "Y", Translations.getString("FootPrintTableModel.ColumnName.Width"), Translations.getString("FootPrintTableModel.ColumnName.Length"), Translations.getString("FootPrintTableModel.ColumnName.Rotate"), Translations.getString("FootPrintTableModel.ColumnName.Round") };

  private Class[] columnTypes = new Class[] { String.class, LengthCellValue.class, LengthCellValue.class, LengthCellValue.class, LengthCellValue.class, String.class, String.class };
