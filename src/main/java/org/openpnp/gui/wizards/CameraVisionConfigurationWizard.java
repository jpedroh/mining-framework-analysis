...
@SuppressWarnings(value = { "serial" }) public class CameraVisionConfigurationWizard extends AbstractConfigurationWizard {
  ...
  public CameraVisionConfigurationWizard(AbstractSettlingCamera camera) {
    ...
    panelVision.setBorder(new TitledBorder(null, Translations.getString("CameraVisionConfigurationWizard.VisionPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelVision);
    panelVision.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(50dlu;min)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("min:grow"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.MIN_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.MIN_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("max(70dlu;default):grow") }));
    lblSettleMethod = new JLabel(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.SettleMethodLabel.text"));
    ...
    lblSettleTimeMs = new JLabel(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.SettleTimeLabel.text"));
    ...
    lblSettleTimeoutMs = new JLabel(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.SettleTimeOutLabel.text"));
    ...
    lblSettleThreshold = new JLabel(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.SettleThresholdLabel.text"));
    ...
    lblSettleDebounce = new JLabel(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.DebounceFramesLabel.text"));
    ...
    lblSettleFullColor = new JLabel(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.ColorSensitiveLabel.text"));
    lblSettleFullColor.setToolTipText(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.ColorSensitiveLabel.toolTipText"));
    ...
    panelSettleTest.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.MIN_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.MIN_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.MIN_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    ...
    lblSettleGradient = new JLabel(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.EdgeSensitiveLabel.text"));
    lblSettleGradient.setToolTipText(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.EdgeSensitiveLabel.toolTipText"));
    panelVision.add(lblSettleGradient, "8, 8, right, default");
    settleGradients = new JCheckBox("");
    panelVision.add(settleGradients, "10, 8");
    lblContrastEnhance = new JLabel(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.EnhanceContrastLabel.text"));
    lblContrastEnhance.setToolTipText(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.EnhanceContrastLabel.toolTipText"));
    ...
    lblSettleGaussianBlur = new JLabel(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.DenoisePixelLabel.text"));
    lblSettleGaussianBlur.setToolTipText(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.DenoisePixelLabel.toolTipText"));
    ...
    lblSettleMaskCircle = new JLabel(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.CenterMaskLabel.text"));
    lblSettleMaskCircle.setToolTipText(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.CenterMaskLabel.toolTipText"));
    ...
    lblSettleDiagnostics = new JLabel(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.DiagnosticsLabel.text"));
    lblSettleDiagnostics.setToolTipText(Translations.getString("CameraVisionConfigurationWizard.VisionPanel.DiagnosticsLabel.toolTipText"));
  ...
  protected void settleTestPlanar(ActionEvent e, int x, int y, int c) throws HeadlessException {
    UiUtils.messageBoxOnException(() -> {
      ...
      if ((x != 0 || y != 0) && !initialJogWarningDisplayed) {
        int result = JOptionPane.showConfirmDialog(getTopLevelAncestor(), "<html>This will move " + jogTool.getName() + " for one jog increment and back. <br/>" + ((jogTool instanceof Camera) ? "" : "<span style=\"color:red\">WARNING: No move to Safe Z!</span><br/>") + "Are you sure?</html>", null, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
  ...
  private Action settleTestLeftAction = new AbstractAction("", Icons.arrowRight) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Makes a move to the left and back, then settles the Camera. Uses the Jog increment distance.");
    }
  ...
  private Action settleTestRightAction = new AbstractAction("", Icons.arrowLeft) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Makes a move to the right and back, then settles the Camera. Uses the Jog increment distance.");
    }
  ...
  private Action settleTestRearAction = new AbstractAction("", Icons.arrowDown) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Makes a move to the rear and back, then settles the Camera. Uses the Jog increment distance.");
    }
  ...
  private Action settleTestFrontAction = new AbstractAction("", Icons.arrowUp) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Makes a move to the front and back, then settles the Camera. Uses the Jog increment distance.");
    }
  ...
  private Action settleTestRotateAction = new AbstractAction("", Icons.rotateCounterclockwise) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Makes a rotation and back, then settles the Camera. Uses the Jog increment.");
    }
  ...
  private Action settleTestUpAction = new AbstractAction("", Icons.centerTool) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Moves the nozzle to the camera at Safe Z (or just to Safe Z and back), then settles the camera.");
    }
    ...
    @Override public void actionPerformed(ActionEvent e) {
      UiUtils.messageBoxOnException(() -> {
        applyAction.actionPerformed(e);
        HeadMountable jogTool = getJogTool();
        if (camera.getHead() == null && jogTool.getLocation().convertToUnits(LengthUnit.Millimeters).getXyzDistanceTo(camera.getLocation()) > 5.0) {
          UiUtils.submitUiMachineTask(() -> {
  ...
  private Action settleTestAction = new AbstractAction("", Icons.captureCamera) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Test-Settle the Camera with no motion.");
    }
