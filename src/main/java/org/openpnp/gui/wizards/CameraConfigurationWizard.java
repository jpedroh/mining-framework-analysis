...
@SuppressWarnings(value = { "serial" }) public class CameraConfigurationWizard extends AbstractConfigurationWizard {
  private final AbstractBroadcastingCamera camera;

  private final static String uppFormat = "%.8f";

  private final static String basicCalibrationInstructions = Translations.getString("CameraConfigurationWizard.basicCalibrationInstructions");

  private final static String downLookingCalibrationInstructions = Translations.getString("CameraConfigurationWizard.downLookingCalibrationInstructions");

  private final static String upLookingCalibrationInstructions = Translations.getString("CameraConfigurationWizard.upLookingCalibrationInstructions");
  ...
  public CameraConfigurationWizard(AbstractBroadcastingCamera camera) {
    ...
    this.camera = camera;
    panel = new JPanel();
    panel.setBorder(new TitledBorder(null, Translations.getString("CameraConfigurationWizard.PropertiesPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panel);
    panel.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    ...
    lblPreviewFps = new JLabel(Translations.getString("CameraConfigurationWizard.PropertiesPanel.PreviewFPSLabel.text"));
    ...
    lblSuspendDuringTasks = new JLabel(Translations.getString("CameraConfigurationWizard.PropertiesPanel.SuspendDuringTasksLabel.text"));
    lblSuspendDuringTasks.setToolTipText(Translations.getString("CameraConfigurationWizard.PropertiesPanel.SuspendDuringTasksLabel.toolTipText"));
    panel.add(lblSuspendDuringTasks, "6, 6, right, default");
    suspendPreviewInTasks = new JCheckBox("");
    panel.add(suspendPreviewInTasks, "8, 6");
    lblAutoVisible = new JLabel(Translations.getString("CameraConfigurationWizard.PropertiesPanel.AutoCameraViewLabel.text"));
    lblAutoVisible.setToolTipText(Translations.getString("CameraConfigurationWizard.PropertiesPanel.AutoCameraViewLabel.toolTipText"));
    panel.add(lblAutoVisible, "2, 8, right, default");
    autoVisible = new JCheckBox("");
    panel.add(autoVisible, "4, 8");
    lblShowMultiview = new JLabel(Translations.getString("CameraConfigurationWizard.PropertiesPanel.ShowInMultiCameraViewLabel.text"));
    lblShowMultiview.setToolTipText(Translations.getString("CameraConfigurationWizard.PropertiesPanel.ShowInMultiCameraViewLabel.toolTipText"));
    panel.add(lblShowMultiview, "6, 8, right, default");
    shownInMultiCameraView = new JCheckBox("");
    panel.add(shownInMultiCameraView, "8, 8");
    lblFocusSensing = new JLabel(Translations.getString("CameraConfigurationWizard.PropertiesPanel.FocusSensingLabel.text"));
    ...
    panelLight.setBorder(new TitledBorder(null, Translations.getString("CameraConfigurationWizard.LightPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelLight);
    panelLight.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblLightingActuator = new JLabel(Translations.getString("CameraConfigurationWizard.LightPanel.LightActuatorLabel.text"));
    ...
    lblAllowMachineActuators = new JLabel(Translations.getString("CameraConfigurationWizard.LightPanel.AllowMachineActuatorsLabel.text"));
    panelLight.add(lblAllowMachineActuators, "6, 2, right, default");
    lblAllowMachineActuators.setToolTipText(Translations.getString("CameraConfigurationWizard.LightPanel.AllowMachineActuatorsLabel.toolTipText"));
    allowMachineActuators = new JCheckBox("");
    panelLight.add(allowMachineActuators, "8, 2");
    allowMachineActuators.setToolTipText(Translations.getString("CameraConfigurationWizard.LightPanel.AllowMachineActuatorsChkBox.toolTipText"));
    ...
    lblBeforeCapture = new JLabel(Translations.getString("CameraConfigurationWizard.LightPanel.BeforeCaptureLabel.text"));
    lblBeforeCapture.setToolTipText(Translations.getString("CameraConfigurationWizard.LightPanel.BeforeCaptureLabel.toolTipText"));
    ...
    lblAfterCapture = new JLabel(Translations.getString("CameraConfigurationWizard.LightPanel.AfterCaptureLabel.text"));
    lblAfterCapture.setToolTipText(Translations.getString("CameraConfigurationWizard.LightPanel.AfterCaptureLabel.toolTipText"));
    ...
    lblUserActionLight = new JLabel(Translations.getString("CameraConfigurationWizard.LightPanel.UserCameraActionLabel.text"));
    panelLight.add(lblUserActionLight, "2, 10, right, default");
    lblUserActionLight.setToolTipText(Translations.getString("CameraConfigurationWizard.LightPanel.UserCameraActionLabel.toolTipText"));
    userActionLightOn = new JCheckBox("");
    panelLight.add(userActionLightOn, "4, 10");
    lblAntiglare = new JLabel(Translations.getString("CameraConfigurationWizard.LightPanel.AntiGlareLabel.text"));
    lblAntiglare.setToolTipText(Translations.getString("CameraConfigurationWizard.LightPanel.AntiGlareLabel.toolTipText"));
    ...
    panelUpp.setBorder(new TitledBorder(null, Translations.getString("CameraConfigurationWizard.UnitsPerPixelPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null));
    panelUpp.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.UNRELATED_GAP_ROWSPEC, RowSpec.decode("default:grow"), FormSpecs.RELATED_GAP_ROWSPEC }));
    lbldCalibration = new JLabel(Translations.getString("CameraConfigurationWizard.UnitsPerPixelPanel.3DCalibrationLabel.text"));
    ...
    advancedCalWarning = new JLabel(Translations.getString("CameraConfigurationWizard.UnitsPerPixelPanel.AdvancedCalibrationActiveLabel.text"));
    ...
    lblCameraZ = new JLabel(Translations.getString("CameraConfigurationWizard.UnitsPerPixelPanel.CameraZLabel.text"));
    panelUpp.add(lblCameraZ, "10, 4, center, default");
    lblCalibrationObject = new JLabel(Translations.getString("CameraConfigurationWizard.UnitsPerPixelPanel.ObjectDimensionsLabel.text"));
    lblCalibrationObject.setToolTipText(Translations.getString("CameraConfigurationWizard.UnitsPerPixelPanel.ObjectDimensionsLabel.toolTipText"));
    ...
    lblPrimaryUpp = new JLabel(Translations.getString("CameraConfigurationWizard.UnitsPerPixelPanel.UnitsPerPixelLabel.text"));
    ...
    lblSecondaryUpp = new JLabel(Translations.getString("CameraConfigurationWizard.UnitsPerPixelPanel.SecondaryUnitsPerPixelLabel.text"));
    ...
    lblDefaultWorkingPlane = new JLabel(Translations.getString("CameraConfigurationWizard.UnitsPerPixelPanel.DefaultWorkingPlaneLabel.text"));
    ...
    textFieldDefaultZ.setToolTipText(Translations.getString("CameraConfigurationWizard.UnitsPerPixelPanel.DefaultZTextField.toolTipText"));
    ...
    panelCal.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), Translations.getString("CameraConfigurationWizard.CalibrateInstructionsPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null));
    panelUpp.add(panelCal, "2, 14, 13, 1, fill, fill");
    panelCal.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("default:grow"), FormSpecs.RELATED_GAP_ROWSPEC }));
    cancelMeasure1Action.setEnabled(false);
  ...
  protected void setActuatorModel(AbstractMachine machine, AbstractCamera camera) {
    if (camera.getHead() == null) {
      ...
      if (allowMachineActuators.isSelected()) {
  ...
  private void adaptDialog() {
    ...
    lblUppInstructions.setText(enable3D ? (lookingDown ? downLookingCalibrationInstructions : upLookingCalibrationInstructions) : basicCalibrationInstructions);
    ...
    boolean cameraZ = enable3D && lookingDown && !(camera.getAxisZ() == null || camera.getAxisZ() instanceof ReferenceVirtualAxis);
  ...
  @Override public void createBindings() {
    if (camera instanceof ReferenceCamera) {
      addWrappedBinding(((ReferenceCamera) camera).getAdvancedCalibration(), "overridingOldTransformsAndDistortionCorrectionSettings", this, "overriddenClassicTransforms");
    }
    AbstractMachine machine = (AbstractMachine) Configuration.get().getMachine();
    LengthConverter uppLengthConverter = new LengthConverter(uppFormat);
    LengthConverter lengthConverter = new LengthConverter();
    DoubleConverter doubleConverter = new DoubleConverter(Configuration.get().getLengthDisplayFormat());
    NamedConverter<Actuator> actuatorConverter = (camera.getHead() != null ? new NamedConverter<>(machine.getActuators(), camera.getHead().getActuators()) : new NamedConverter<>(machine.getActuators()));
    ...
    addWrappedBinding(defaultUnitsPerPixel, "lengthZ", textFieldPrimaryUppZ, "text", lengthConverter);
    ...
    addWrappedBinding(secondaryUnitsPerPixel, "lengthZ", textFieldSecondaryUppZ, "text", lengthConverter);
  ...
  private Action captureToolZAction = new AbstractAction("", Icons.captureTool) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Capture the Z height that the selected tool is at.");
    }
  ...
  private Action measure1Action = new AbstractAction(Translations.getString("CameraConfigurationWizard.Action.Measure1")) {
    @Override public void actionPerformed(ActionEvent arg0) {
  ...
  private Action confirmMeasure1Action = new AbstractAction(Translations.getString("CameraConfigurationWizard.Action.ConfirmMeasure1")) {
    @Override public void actionPerformed(ActionEvent arg0) {
  ...
  private Action cancelMeasure1Action = new AbstractAction(Translations.getString("CameraConfigurationWizard.Action.CancelMeasure1")) {
    @Override public void actionPerformed(ActionEvent arg0) {
      btnMeasure1.setAction(measure1Action);
      cancelMeasure1Action.setEnabled(false);
      measure2Action.setEnabled(true);
  ...
  private Action measure2Action = new AbstractAction(Translations.getString("CameraConfigurationWizard.Action.Measure2")) {
    @Override public void actionPerformed(ActionEvent arg0) {
  ...
  private Action confirmMeasure2Action = new AbstractAction(Translations.getString("CameraConfigurationWizard.Action.ConfirmMeasure2")) {
    @Override public void actionPerformed(ActionEvent arg0) {
  ...
  private Action cancelMeasure2Action = new AbstractAction(Translations.getString("CameraConfigurationWizard.Action.CancelMeasure2")) {
    @Override public void actionPerformed(ActionEvent arg0) {
      btnMeasure2.setAction(measure2Action);
      cancelMeasure2Action.setEnabled(false);
      measure1Action.setEnabled(true);
  ...
  @Override protected void saveToModel() {
    super.saveToModel();
    if (reloadWizard) {
  ...
  protected void measure(int measurement) throws Exception {
    ...
    if (!enableUnitsPerPixel3D.isSelected()) {
      ...
      if (lookingCb.getSelectedItem() == Camera.Looking.Up) {
        ...
        if (measurement == 1) {
          desiredNozzleLocation = cameraLocation.add(new Location(units, 0, 0, thickness, 0));
        } else {
          desiredNozzleLocation = cameraLocation.derive(null, null, nozzleLocation.getZ(), nozzleLocation.getRotation());
        }
        measurementLocation = desiredNozzleLocation.subtract(new Location(units, 0, 0, thickness, 0)).convertToUnits(units);
        if (measurement == 2 && Math.abs(measurementLocation.getZ() - Double.parseDouble(textFieldPrimaryUppZ.getText())) < new Length(1, LengthUnit.Millimeters).convertToUnits(units).getValue()) {
        ...
        if (!nozzleLocation.equals(desiredNozzleLocation)) {
          int result = JOptionPane.showConfirmDialog(getTopLevelAncestor(), "<html>This will position the nozzle " + nozzle.getName() + " over the camera " + camera.getName() + ". <br/><br/>" + "<span style=\"color:red;\">CAUTION:</span> Nozzle head offset, nozzle Safe Z, camera <br/>" + "location, basic motion etc. must already be set up.<br/><br/>" + "Are you sure?</html>", null, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        ...
        int result = JOptionPane.showConfirmDialog(getTopLevelAncestor(), "<html>This will move camera " + camera.getName() + " over to the position of the nozzle " + nozzle.getName() + ". <br/><br/>" + "<span style=\"color:red;\">CAUTION:</span> Nozzle head offset, nozzle Safe Z, basic <br/>" + "motion etc. must already be set up.<br/><br/>" + "Are you sure?</html>", null, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        if (result == JOptionPane.NO_OPTION) {
          throw new Exception("Measurement aborted.");
        }
        UiUtils.submitUiMachineTask(() -> {
  ...
  protected void confirmMeasure(int measurement) throws NumberFormatException {
    ...
    if (measurement == 1) {
      textFieldPrimaryUppX.setText(uppLengthConverter.convertForward(new Length(width / Math.abs(selection.width), units)));
      textFieldPrimaryUppY.setText(uppLengthConverter.convertForward(new Length(height / Math.abs(selection.height), units)));
      if (measurementLocation != null) {
        textFieldPrimaryUppZ.setText(lengthConverter.convertForward(measurementLocation.getLengthZ()));
        cameraPrimaryZ.setText(lengthConverter.convertForward(cameraLocation.getLengthZ()));
        if (lookingCb.getSelectedItem() == Camera.Looking.Up) {
          textFieldDefaultZ.setText(lengthConverter.convertForward(measurementLocation.getLengthZ()));
        }
      }
    } else {
      textFieldSecondaryUppX.setText(uppLengthConverter.convertForward(new Length(width / Math.abs(selection.width), units)));
      textFieldSecondaryUppY.setText(uppLengthConverter.convertForward(new Length(height / Math.abs(selection.height), units)));
      if (measurementLocation != null) {
        textFieldSecondaryUppZ.setText(lengthConverter.convertForward(measurementLocation.getLengthZ()));
