...
public class JobPlacementsPanel extends JPanel {
  ...
  private void createUi() {
    setBorder(new TitledBorder(null, Translations.getString("JobPlacementsPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    Configuration configuration = Configuration.get();
    boardLocationSelectionActionGroup = new ActionGroup(newAction);
    boardLocationSelectionActionGroup.setEnabled(false);
    singleSelectionActionGroup = new ActionGroup(removeAction, editPlacementFeederAction, setTypeAction, setSideAction, setPlacedAction, setErrorHandlingAction, setEnabledAction);
    singleSelectionActionGroup.setEnabled(false);
    multiSelectionActionGroup = new ActionGroup(removeAction, setTypeAction, setSideAction, setPlacedAction, setErrorHandlingAction, setEnabledAction);
    multiSelectionActionGroup.setEnabled(false);
    captureAndPositionActionGroup = new ActionGroup(captureCameraPlacementLocation, captureToolPlacementLocation, moveCameraToPlacementLocation, moveCameraToPlacementLocationNext, moveToolToPlacementLocation);
    ...
    table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
      @Override public void valueChanged(ListSelectionEvent e) {
        ...
        if (getSelections().size() > 1) {
          ...
          if (getSelection() != null && mainFrame.getTabs().getSelectedComponent() == mainFrame.getJobTab() && Configuration.get().getTablesLinked() == TablesLinked.Linked) {
  ...
  public void updateActivePlacements() {
    ...
    MainFrame.get().setPlacementCompletionStatus(totalActivePlacements - activePlacements, totalActivePlacements, blTotalActivePlacements - blActivePlacements, blTotalActivePlacements);
  }
  ...
  public final Action newAction = new AbstractAction() {
    {
      ...
      putValue(SHORT_DESCRIPTION, Translations.getString("JobPlacementsPanel.NewPlacement.ShortDescription"));
    }

    @Override public void actionPerformed(ActionEvent arg0) {
      if (Configuration.get().getParts().size() == 0) {
        MessageBoxes.errorBox(getTopLevelAncestor(), Translations.getString("JobPlacementsPanel.NewPlacement.ErrorMessageBox.title"), Translations.getString("JobPlacementsPanel.NewPlacement.ErrorMessageBox.NoPartsMessage"));
        return;
      }
      String id = JOptionPane.showInputDialog(getTopLevelAncestor(), Translations.getString("JobPlacementsPanel.NewPlacement.InputDialog.enterIdMessage"));
      if (id == null) {
        return;
      }
      for (Placement compareplacement : boardLocation.getBoard().getPlacements()) {
        if (compareplacement.getId().equals(id)) {
          MessageBoxes.errorBox(getTopLevelAncestor(), Translations.getString("JobPlacementsPanel.NewPlacement.ErrorMessageBox.title"), Translations.getString("JobPlacementsPanel.NewPlacement.ErrorMessageBox.IdAlreadyExistsMessage"));
          return;
        }
      }
  ...
  public final Action moveCameraToPlacementLocation = new AbstractAction() {
    {
      ...
      putValue(SHORT_DESCRIPTION, Translations.getString("JobPlacementsPanel.PositionCameraAtPlacement.ShortDescription"));
    }

    @Override public void actionPerformed(ActionEvent arg0) {
      UiUtils.submitUiMachineTask(() -> {
        Location location = Utils2D.calculateBoardPlacementLocation(boardLocation, getSelection().getLocation());
  ...
  public final Action moveCameraToPlacementLocationNext = new AbstractAction() {
    {
      ...
      putValue(SHORT_DESCRIPTION, Translations.getString("JobPlacementsPanel.PositionCameraAtNextPlacement.ShortDescription"));
    }
  ...
  public final Action moveToolToPlacementLocation = new AbstractAction() {
    {
      ...
      putValue(SHORT_DESCRIPTION, Translations.getString("JobPlacementsPanel.PositionToolAtPlacement.ShortDescription"));
    }
  ...
  public final Action captureCameraPlacementLocation = new AbstractAction() {
    {
      ...
      putValue(NAME, Translations.getString("JobPlacementsPanel.CaptureCameraPlacementLocation.Name"));
      putValue(SHORT_DESCRIPTION, Translations.getString("JobPlacementsPanel.CaptureCameraPlacementLocation.ShortDescription"));
    }
    ...
    @Override public void actionPerformed(ActionEvent arg0) {
      UiUtils.messageBoxOnException(() -> {
        ...
        Location placementLocation = Utils2D.calculateBoardPlacementLocationInverse(boardLocation, camera.getLocation());
  ...
  public final Action captureToolPlacementLocation = new AbstractAction() {
    {
      ...
      putValue(SHORT_DESCRIPTION, Translations.getString("JobPlacementsPanel.CaptureToolPlacementLocation.ShortDescription"));
    }

    @Override public void actionPerformed(ActionEvent arg0) {
      UiUtils.messageBoxOnException(() -> {
        Nozzle nozzle = MainFrame.get().getMachineControls().getSelectedNozzle();
        Location placementLocation = Utils2D.calculateBoardPlacementLocationInverse(boardLocation, nozzle.getLocation());
        getSelection().setLocation(placementLocation);
        table.repaint();
      });
    }
  ...
  public final Action editPlacementFeederAction = new AbstractAction() {
    {
      ...
      putValue(SHORT_DESCRIPTION, Translations.getString("JobPlacementsPanel.EditPlacementFeeder.ShortDescription"));
    }
  ...
  public final Action setTypeAction = new AbstractAction() {
    {
      ...
      putValue(SHORT_DESCRIPTION, Translations.getString("JobPlacementsPanel.SetType.ShortDescription"));
    }
    ...
    public void setValue(Object value) {
      ...
      if (status == Status.Ready) {
        ...
        if (status == Status.MissingFeeder) {
          ...
          if (status == Status.ZeroPartHeight) {
            setBorder(new LineBorder(getBackground()));
            setForeground(Color.black);
