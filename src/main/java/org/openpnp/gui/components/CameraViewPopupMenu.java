...
@SuppressWarnings(value = { "serial" }) public class CameraViewPopupMenu extends JPopupMenu {
  ...
  public CameraViewPopupMenu(CameraView cameraView) {
    ...
    if (cameraView.getDefaultReticle() != null) {
      if (cameraView.getDefaultReticle() instanceof RulerReticle) {
        ...
        if (cameraView.getDefaultReticle() instanceof GridReticle) {
...
<<<<<<< /usr/src/app/output/openpnp/openpnp/0c32f6facf7588586ad6d566dad3066bcd7c08cc/src/main/java/org/openpnp/gui/components/CameraViewPopupMenu.java/left.java
          createGridReticleOptionsMenu((GridReticle) cameraView.getDefaultReticle())
=======
          createRulerReticleOptionsMenu((GridReticle) cameraView.getDefaultReticle())
>>>>>>> /usr/src/app/output/openpnp/openpnp/0c32f6facf7588586ad6d566dad3066bcd7c08cc/src/main/java/org/openpnp/gui/components/CameraViewPopupMenu.java/right.java
  ...
  private JMenu createFiducialReticleOptionsMenu(final FiducialReticle reticle) {
    ...
    inputMenuItem.addActionListener(new ActionListener() {
      @Override public void actionPerformed(ActionEvent e) {
        String result = JOptionPane.showInputDialog(cameraView, String.format("Enter the size in %s", reticle.getUnits().toString().toLowerCase()), reticle.getSize() + "");
        if (result != null) {
  ...
  private Action gridReticleAction = new AbstractAction("Grid") {
    @Override public void actionPerformed(ActionEvent arg0) {
      ...
      JMenu optionsMenu = 
<<<<<<< /usr/src/app/output/openpnp/openpnp/0c32f6facf7588586ad6d566dad3066bcd7c08cc/src/main/java/org/openpnp/gui/components/CameraViewPopupMenu.java/left.java
      createGridReticleOptionsMenu(reticle)
=======
      createRulerReticleOptionsMenu(reticle)
>>>>>>> /usr/src/app/output/openpnp/openpnp/0c32f6facf7588586ad6d566dad3066bcd7c08cc/src/main/java/org/openpnp/gui/components/CameraViewPopupMenu.java/right.java
      ;
      setReticleOptionsMenu(optionsMenu);
      cameraView.setDefaultReticle(reticle);
