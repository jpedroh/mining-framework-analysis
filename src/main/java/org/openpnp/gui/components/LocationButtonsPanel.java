 ...
 * place of the tool.
 */
@SuppressWarnings(value = { "serial" }) public class LocationButtonsPanel extends JPanel {
  private JTextField textFieldX, textFieldY, textFieldZ, textFieldC;

  private String actuatorName;

  private 
<<<<<<< /usr/src/app/output/openpnp/openpnp/1c43c4f3860aa482eb95a7e1c5e79e50ae2ae74c/src/main/java/org/openpnp/gui/components/LocationButtonsPanel.java/left.java
  JButton
=======
  Action
>>>>>>> /usr/src/app/output/openpnp/openpnp/1c43c4f3860aa482eb95a7e1c5e79e50ae2ae74c/src/main/java/org/openpnp/gui/components/LocationButtonsPanel.java/right.java
   
<<<<<<< /usr/src/app/output/openpnp/openpnp/1c43c4f3860aa482eb95a7e1c5e79e50ae2ae74c/src/main/java/org/openpnp/gui/components/LocationButtonsPanel.java/left.java
  buttonCenterCamera
=======
  positionActuatorNoSafeZAction = new AbstractAction("Position Actuator (Without Safe Z)", Icons.centerPinNoSafeZ) {
    {
...
>>>>>>> /usr/src/app/output/openpnp/openpnp/1c43c4f3860aa482eb95a7e1c5e79e50ae2ae74c/src/main/java/org/openpnp/gui/components/LocationButtonsPanel.java/right.java
  ...
  public Actuator getActuator() throws Exception {
    ...
    if (actuator == null) {
      throw new Exception(String.format("No Actuator with name %s on Head %s", actuatorName, head.getName()));
    }
    return actuator;
  }
