...
@SuppressWarnings(value = { "serial" }) public class MainFrame extends JFrame {
  ...
  private 
<<<<<<< /usr/src/app/output/openpnp/openpnp/93126880a6228d8a226afcd56b949b514cd72dcf/src/main/java/org/openpnp/gui/MainFrame.java/left.java
  Component
=======
  Action
>>>>>>> /usr/src/app/output/openpnp/openpnp/93126880a6228d8a226afcd56b949b514cd72dcf/src/main/java/org/openpnp/gui/MainFrame.java/right.java
   
<<<<<<< /usr/src/app/output/openpnp/openpnp/93126880a6228d8a226afcd56b949b514cd72dcf/src/main/java/org/openpnp/gui/MainFrame.java/left.java
  navigationPanel
=======
  changeLogAction = new AbstractAction(Translations.getString("Menu.Help.ChangeLog")) {
...
>>>>>>> /usr/src/app/output/openpnp/openpnp/93126880a6228d8a226afcd56b949b514cd72dcf/src/main/java/org/openpnp/gui/MainFrame.java/right.java
  ...
  public MainFrame(Configuration configuration) {
    ...
    toolbar.add(getJobTab().startPauseResumeJobAction);
    toolbar.add(getJobTab().stepJobAction);
    toolbar.add(getJobTab().stopJobAction);
