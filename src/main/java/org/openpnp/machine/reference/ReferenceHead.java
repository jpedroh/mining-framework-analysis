...
public class ReferenceHead extends AbstractHead {
  ...
  @Override public boolean isInsideSoftLimits(HeadMountable hm, Location location) throws Exception {
  ...
  @Override public void moveTo(HeadMountable hm, Location location, double speed, MotionOption... options) throws Exception {
    ReferenceMachine machine = getMachine();
  ...
  @Attribute(required = false) private NozzleSolution nozzleSolution;

  @Attribute(required = false) int nozzleSolutionsMultiplier = 1;
