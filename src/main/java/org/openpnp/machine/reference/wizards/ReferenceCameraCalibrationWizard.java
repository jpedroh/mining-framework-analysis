...
@SuppressWarnings(value = { "serial" }) public class ReferenceCameraCalibrationWizard extends AbstractConfigurationWizard {
  ...
  public ReferenceCameraCalibrationWizard(ReferenceCamera referenceCamera) {
    ...
    if (isMovable) {
      ...
      try {
        primaryDiameter = referenceHead.getCalibrationPrimaryFiducialDiameter().divide(referenceCamera.getUnitsPerPixel(primaryLocation.getLengthZ()).getLengthX());
        secondaryDiameter = referenceHead.getCalibrationSecondaryFiducialDiameter().divide(referenceCamera.getUnitsPerPixel(secondaryLocation.getLengthZ()).getLengthX());
      } catch (Exception e) {
      }
    ...
    panelCameraCalibration.setBorder(new TitledBorder(null, Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelCameraCalibration);
    panelCameraCalibration.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(87dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(87dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(87dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(87dlu;default):grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(39dlu;default):grow") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.UNRELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.UNRELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.UNRELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.UNRELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.UNRELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.UNRELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, RowSpec.decode("10dlu"), FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("max(114dlu;default)"), FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, RowSpec.decode("10dlu"), FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("max(178dlu;default)"), FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, RowSpec.decode("10dlu"), FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("max(151dlu;default)"), FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("default:grow") }));
    chckbxAdvancedCalOverride = new JCheckBox(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.AdvancedCalOverrideChkbox.text"));
    chckbxAdvancedCalOverride.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.AdvancedCalOverrideChkbox.toolTipText"));
    chckbxAdvancedCalOverride.addActionListener(overrideAction);
    panelCameraCalibration.add(chckbxAdvancedCalOverride, "2, 2, 11, 1");
    lblDescription = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.DescriptionLabel.text"));
    panelCameraCalibration.add(lblDescription, "4, 4, 7, 1");
    separator_2 = new JSeparator();
    panelCameraCalibration.add(separator_2, "2, 6, 13, 1");
    lblNewLabel_31 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.GeneralSettingsLabel.text"));
    ...
    checkboxDeinterlace = new JCheckBox(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.DeInterlaceLabel.text"));
    checkboxDeinterlace.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.DeInterlaceLabel.toolTipText"));
    panelCameraCalibration.add(checkboxDeinterlace, "4, 10");
    lblNewLabel_20 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.CroppedWidthLabel.text"));
    ...
    lblNewLabel_22 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.SetZeroForNoCropped1Label.text"));
    panelCameraCalibration.add(lblNewLabel_22, "6, 12");
    lblNewLabel_21 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.CroppedHeightLabel.text"));
    ...
    lblNewLabel_23 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.SetZeroForNoCropped2Label.text"));
    panelCameraCalibration.add(lblNewLabel_23, "6, 14");
    lblNewLabel_1 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.DefaultWorkingPlaneZLabel.text"));
    ...
    lblNewLabel_32 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.CalibrationSetupLabel.text"));
    ...
    if (isMovable) {
      textFieldDefaultZ.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.MovableDefaultZTextFiled.toolTipText"));
    } else {
      textFieldDefaultZ.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.NotMovableDefaultZTextFiled.toolTipText"));
    }
    lblNewLabel_35 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.PrimaryCalibrationZLabel.text"));
    ...
    if (isMovable) {
      textFieldPrimaryCalZ.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.MovablePrimCalZTextField.toolTipText"));
    } else {
      textFieldPrimaryCalZ.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.NotMovablePrimCalZTextField.toolTipText"));
    }
    ...
    if (!isMovable) {
      lblNewLabel_37 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.CautionLabel.text"));
      panelCameraCalibration.add(lblNewLabel_37, "6, 22, 5, 3");
    }
    lblNewLabel_36 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.SecondaryCalibrationZLabel.text"));
    ...
    if (isMovable) {
      textFieldSecondaryCalZ.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.MovableSecondaryCalZTextField.toolTipText"));
    } else {
      textFieldSecondaryCalZ.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.NotMovableSecondaryCalZTextField.toolTipText"));
    }
    panelCameraCalibration.add(textFieldSecondaryCalZ, "4, 24, fill, default");
    textFieldSecondaryCalZ.setColumns(10);
    lblNewLabel_28 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.RadialLinesPerCalZLabel.text"));
    ...
    textFieldDesiredNumberOfRadialLines.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.NumberOfRadialLinesTextField.toolTipText"));
    ...
    startCameraCalibrationBtn.setText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.StartCameraCalibrationButton.text"));
    panelCameraCalibration.add(startCameraCalibrationBtn, "4, 30");
    chckbxUseSavedData = new JCheckBox(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.UseSavedDateChkBox.text"));
    chckbxUseSavedData.setEnabled(advCal.isValid());
    chckbxUseSavedData.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.UseSavedDateChkBox.toolTipText"));
    panelCameraCalibration.add(chckbxUseSavedData, "6, 30, 5, 1");
    lblNewLabel_34 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.DetectionDiameterLabel.text"));
    ...
    spinnerDiameter.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.DiameterSpinner.toolTipText"));
    spinnerDiameter.setEnabled(false);
    panelCameraCalibration.add(spinnerDiameter, "4, 32");
    chckbxEnable = new JCheckBox(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ApplyCalibrationChkBox.text"));
    chckbxEnable.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ApplyCalibrationChkBox.toolTipText"));
    ...
    lblNewLabel = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.CropInvalidPixelsLabel.text"));
    lblNewLabel.setHorizontalAlignment(SwingConstants.TRAILING);
    panelCameraCalibration.add(lblNewLabel, "2, 36");
    sliderAlpha.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.AlfaSlider.toolTipText"));
    panelCameraCalibration.add(sliderAlpha, "4, 36, 5, 1");
    lblNewLabel_3 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ShowValidPixelsLabel.text"));
    panelCameraCalibration.add(lblNewLabel_3, "10, 36");
    separator_1 = new JSeparator();
    panelCameraCalibration.add(separator_1, "2, 38, 13, 1");
    lblNewLabel_33 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.CalibrationResults.text"));
    ...
    if (isMovable) {
      offsetOrPositionLabel = Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.CalibratedHeadOffsets.text");
    } else {
      offsetOrPositionLabel = Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.CameraLocation.text");
    }
    ...
    lblNewLabel_24 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.UnitsPerPixelLabel.text"));
    ...
    textFieldUnitsPerPixel.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.UnitsPerPixelTextField.toolTipText"));
    ...
    lblNewLabel_30 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.AtDefaultWorkingPlaneZLabel.text"));
    panelCameraCalibration.add(lblNewLabel_30, "6, 46");
    lblNewLabel_4 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.EstimatedLocatingAccuracyLabel.text"));
    lblNewLabel_4.setHorizontalAlignment(SwingConstants.TRAILING);
    panelCameraCalibration.add(lblNewLabel_4, "2, 48, right, default");
    textFieldRmsError = new JTextField();
    textFieldRmsError.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.RmsErrorTextField.toolTipText"));
    ...
    lblNewLabel_29 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.AtDefaultWorkingPlaneZLabel.text"));
    panelCameraCalibration.add(lblNewLabel_29, "6, 48");
    lblNewLabel_40 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.WidthLabel.text"));
    panelCameraCalibration.add(lblNewLabel_40, "4, 50, default, top");
    lblNewLabel_41 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.HeightLabel.text"));
    panelCameraCalibration.add(lblNewLabel_41, "6, 50");
    lblNewLabel_39 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.PhysicalFieldOfViewLabel.text"));
    ...
    lblNewLabel_42 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.EffectiveFieldOfViewLabel.text"));
    ...
    lblNewLabel_5 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.XAxisLabel.text"));
    panelCameraCalibration.add(lblNewLabel_5, "4, 56");
    lblNewLabel_6 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.YAxisLabel.text"));
    panelCameraCalibration.add(lblNewLabel_6, "6, 56");
    lblNewLabel_7 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ZAxisLabel.text"));
    panelCameraCalibration.add(lblNewLabel_7, "8, 56");
    lblNewLabel_2 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.CameraMountingErrorLabel.text"));
    panelCameraCalibration.add(lblNewLabel_2, "2, 58, right, default");
    textFieldXRotationError = new JTextField();
    textFieldXRotationError.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.XRotationErrorTextField.toolTipText"));
    ...
    textFieldYRotationError.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.YRotationErrorTextField.toolTipText"));
    ...
    textFieldZRotationError.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ZRotationErrorTextField.toolTipText"));
    ...
    lblNewLabel_8 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.SelectedCalZForPlottingLabel.text"));
    ...
    spinnerIndex.setToolTipText(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.IndexSpinner.toolTipText"));
    ...
    chckbxShowOutliers = new JCheckBox(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ShowOutliersChkBox.text"));
    chckbxShowOutliers.addActionListener(showOutliersActionListener);
    panelCameraCalibration.add(chckbxShowOutliers, "6, 60");
    lblNewLabel_14 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ResidualErrorsInCollectionOrderLabel.text"));
    lblNewLabel_14.setFont(new Font("Tahoma", Font.BOLD, 13));
    lblNewLabel_14.setHorizontalAlignment(SwingConstants.CENTER);
    panelCameraCalibration.add(lblNewLabel_14, "4, 62, 3, 1");
    lblNewLabel_9 = new VerticalLabel(String.format(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ResidualError.text") + " [%s]", smallDisplayUnits.getShortName()));
    ...
    String legend = Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.Legend.text");
    lblNewLabel_17 = new JLabel(String.format(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ResidualErrorsLegendDescriptionLabel.text"), legend));
    panelCameraCalibration.add(lblNewLabel_17, "8, 64, 3, 1, left, default");
    lblNewLabel_10 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.CollectionSequenceNumberLabel.text"));
    lblNewLabel_10.setHorizontalAlignment(SwingConstants.CENTER);
    panelCameraCalibration.add(lblNewLabel_10, "4, 66, 3, 1");
    lblNewLabel_15 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ResidualErrorXYScatterPlotLabel.text"));
    lblNewLabel_15.setFont(new Font("Tahoma", Font.BOLD, 13));
    lblNewLabel_15.setHorizontalAlignment(SwingConstants.CENTER);
    panelCameraCalibration.add(lblNewLabel_15, "4, 68, 3, 1");
    lblNewLabel_11 = new VerticalLabel(String.format("Y %s [%s]", Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ResidualError.text"), smallDisplayUnits.getShortName()));
    ...
    lblNewLabel_18 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ResidualErrorsXYDescriptionLabel.text"));
    panelCameraCalibration.add(lblNewLabel_18, "8, 70, 3, 1, left, default");
    lblNewLabel_12 = new JLabel(String.format("X %s [%s]", Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ResidualError.text"), smallDisplayUnits.getShortName()));
    lblNewLabel_12.setHorizontalAlignment(SwingConstants.CENTER);
    panelCameraCalibration.add(lblNewLabel_12, "4, 72, 3, 1");
    lblNewLabel_16 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ResidualErrorMapLabel.text"));
    lblNewLabel_16.setFont(new Font("Tahoma", Font.BOLD, 13));
    lblNewLabel_16.setHorizontalAlignment(SwingConstants.CENTER);
    panelCameraCalibration.add(lblNewLabel_16, "4, 74, 3, 1");
    lblNewLabel_13 = new VerticalLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ImageYLocationLabel.text"));
    ...
    lblNewLabel_19 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ResidualErrorMapDescriptionLabel.text"));
    panelCameraCalibration.add(lblNewLabel_19, "8, 76, 5, 1, left, default");
    lblNewLabel_12 = new JLabel(Translations.getString("ReferenceCameraCalibrationWizard.CameraCalibrationPanel.ImageXLocationLabel.text"));
    lblNewLabel_12.setHorizontalAlignment(SwingConstants.CENTER);
  ...
  @Override public void createBindings() {
    ...
    if (isMovable) {
      if (referenceCamera instanceof ImageCamera) {
        bind(UpdateStrategy.READ, (ImageCamera) referenceCamera, "primaryFiducial", advCal, "primaryLocation");
        bind(UpdateStrategy.READ, (ImageCamera) referenceCamera, "secondaryFiducial", advCal, "secondaryLocation");
      } else {
        bind(UpdateStrategy.READ, referenceHead, "calibrationPrimaryFiducialLocation", advCal, "primaryLocation");
        bind(UpdateStrategy.READ, referenceHead, "calibrationSecondaryFiducialLocation", advCal, "secondaryLocation");
      }
    } else {
      bind(UpdateStrategy.READ, referenceCamera, "headOffsets", advCal, "primaryLocation");
      bind(UpdateStrategy.READ_WRITE, this, "secondaryLocation", advCal, "secondaryLocation");
    }
    ...
    bind(UpdateStrategy.READ_WRITE, advCal, "overridingOldTransformsAndDistortionCorrectionSettings", chckbxAdvancedCalOverride, "selected");
    bind(UpdateStrategy.READ, advCal, "valid", chckbxEnable, "enabled");
    bind(UpdateStrategy.READ_WRITE, advCal, "enabled", chckbxEnable, "selected");
    bind(UpdateStrategy.READ, advCal, "valid", spinnerIndex, "enabled");
    bind(UpdateStrategy.READ_WRITE, advCal, "alphaPercent", sliderAlpha, "value");
    bind(UpdateStrategy.READ_WRITE, advCal, "fiducialDiameter", spinnerDiameter, "value");
    bind(UpdateStrategy.READ_WRITE, referenceCamera, "defaultZ", textFieldDefaultZ, "text", lengthConverter);
    bind(UpdateStrategy.READ_WRITE, referenceCamera, "cropWidth", textFieldCropWidth, "text", intConverter);
    bind(UpdateStrategy.READ_WRITE, referenceCamera, "cropHeight", textFieldCropHeight, "text", intConverter);
    bind(UpdateStrategy.READ_WRITE, referenceCamera, "deinterlace", checkboxDeinterlace, "selected");
    bind(UpdateStrategy.READ_WRITE, advCal, "desiredRadialLinesPerTestPattern", textFieldDesiredNumberOfRadialLines, "text", intConverter);
    bind(UpdateStrategy.READ, advCal, "widthFov", textFieldWidthFov, "text", doubleConverter);
    bind(UpdateStrategy.READ, advCal, "heightFov", textFieldHeightFov, "text", doubleConverter);
    bind(UpdateStrategy.READ, advCal, "virtualWidthFov", textFieldVirtualWidthFov, "text", doubleConverter);
    bind(UpdateStrategy.READ, advCal, "virtualHeightFov", textFieldVirtualHeightFov, "text", doubleConverter);
    bind(UpdateStrategy.READ, advCal, "rotationErrorZ", textFieldZRotationError, "text", doubleConverter);
    bind(UpdateStrategy.READ, advCal, "rotationErrorY", textFieldYRotationError, "text", doubleConverter);
    bind(UpdateStrategy.READ, advCal, "rotationErrorX", textFieldXRotationError, "text", doubleConverter);
  ...
  private Action startCalibration = new AbstractAction("Start Calibration Data Collection") {
    @Override public void actionPerformed(ActionEvent e) {
      ...
      try {
        ...
        referenceCamera.captureTransformed();
        if (!chckbxUseSavedData.isSelected()) {
          ...
          UiUtils.messageBoxOnException(() -> {
            new CalibrateCameraProcess(MainFrame.get(), cameraView, calibrationLocations, detectionDiameters, 0) {
              @Override public void processRawCalibrationData(double[][][] testPattern3dPointsList, double[][][] testPatternImagePointsList, Size size, double mirrored, double apparentMotionDirection) throws Exception {
                advCal.setDataAvailable(true);
                advCal.setValid(false);
                chckbxUseSavedData.setEnabled(true);
                try {
                  advCal.processRawCalibrationData(testPattern3dPointsList, testPatternImagePointsList, size, mirrored, apparentMotionDirection);
              ...
              @Override protected void processCanceled() {
          ...
          try {
            referenceCamera.getAdvancedCalibration().processRawCalibrationData(new Size(referenceCamera.getWidth(), referenceCamera.getHeight()));
            postCalibrationProcessing();
          } catch (Exception ex) {
  ...
  private void postCalibrationProcessing() throws Exception {
    ...
    int numberOfCalibrationHeights = advCal.getSavedTestPattern3dPointsList().length;
    for (int i = 0; i < numberOfCalibrationHeights; i++) {
      calibrationHeightSelections.add(new LengthCellValue(new Length(advCal.getSavedTestPattern3dPointsList()[i][0][2], LengthUnit.Millimeters)));
    }
    ...
    if (isMovable && referenceCamera.getHead().getDefaultCamera() == referenceCamera) {
      int ans = JOptionPane.showConfirmDialog(MainFrame.get(), "Calibration of the head\'s default camera is complete and the machine should " + "be re-homed before any new locations are captured/examined. Home the machine now?", "Calibration Complete", JOptionPane.YES_NO_OPTION);
  ...
  private void updateDiagnosticsDisplay() {
    if (advCal.isValid()) {
      ...
      Location uppAtDefaultZ = referenceCamera.getUnitsPerPixel(referenceCamera.getDefaultZ()).convertToUnits(smallDisplayUnits);
      textFieldUnitsPerPixel.setText((new LengthCellValue(uppAtDefaultZ.getLengthX(), true)).toString());
      textFieldRmsError.setText((new LengthCellValue(uppAtDefaultZ.getLengthX().multiply(advCal.getRmsError()), true)).toString());
      Location uppAtHeight = referenceCamera.getUnitsPerPixel(calibrationHeightSelections.get(heightIndex).getLength()).convertToUnits(smallDisplayUnits);
      double smallUnitsPerPixel = uppAtHeight.getLengthX().getValue();
      List<double[]> residuals = null;
      try {
        if (chckbxShowOutliers.isSelected()) {
          residuals = CameraCalibrationUtils.computeResidualErrors(advCal.getSavedTestPatternImagePointsList(), advCal.getModeledImagePointsList(), heightIndex);
        } else {
          residuals = CameraCalibrationUtils.computeResidualErrors(advCal.getSavedTestPatternImagePointsList(), advCal.getModeledImagePointsList(), heightIndex, advCal.getOutlierPointList());
        }
        ...
        iPoint = 0;
        for (double[] residual : residuals) {
          dataRowXY.recordDataPoint(smallUnitsPerPixel * residual[0], smallUnitsPerPixel * residual[1]);
          iPoint++;
        }
        ...
        double radius = smallUnitsPerPixel * advCal.getRmsError() * CameraCalibrationUtils.sigmaThresholdForRejectingOutliers;
        for (int i = 0; i <= 45; i++) {
        ...
        if (chckbxShowOutliers.isSelected()) {
          errorImage = CameraCalibrationUtils.generateErrorImage(new Size(width, height), heightIndex, advCal.getSavedTestPatternImagePointsList(), advCal.getModeledImagePointsList(), null);
        } else {
          errorImage = CameraCalibrationUtils.generateErrorImage(new Size(width, height), heightIndex, advCal.getSavedTestPatternImagePointsList(), advCal.getModeledImagePointsList(), advCal.getOutlierPointList());
        }
