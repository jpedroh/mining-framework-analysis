...
@SuppressWarnings(value = { "serial" }) public class ReferenceCameraTransformsConfigurationWizard extends AbstractConfigurationWizard {
  ...
  public ReferenceCameraTransformsConfigurationWizard(ReferenceCamera referenceCamera) {
    ...
    panelTransforms.setBorder(new TitledBorder(null, Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null));
    contentPanel.add(panelTransforms);
    panelTransforms.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.LABEL_COMPONENT_GAP_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblRotation = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.RotationLabel.text"));
    ...
    advancedCalWarning = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.AdvancedCalibrationActiveLabel.text"));
    advancedCalWarning.setForeground(Color.RED);
    panelTransforms.add(advancedCalWarning, "7, 2, right, default");
    lblOffsetX = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.OffsetXLabel.text"));
    ...
    lblOffsetY = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.OffsetYLabel.text"));
    ...
    lblFlipX = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.FlipVerticalLabel.text"));
    panelTransforms.add(lblFlipX, "2, 8, right, default");
    chckbxFlipX = new JCheckBox("");
    panelTransforms.add(chckbxFlipX, "4, 8");
    lblFlipY = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.FlipHorizontalLabel.text"));
    panelTransforms.add(lblFlipY, "2, 10, right, default");
    checkBoxFlipY = new JCheckBox("");
    panelTransforms.add(checkBoxFlipY, "4, 10");
    lblCropX = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.CropWidthLabel.text"));
    ...
    lblNewLabel = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.Use0ForNoCropping1Label.text"));
    panelTransforms.add(lblNewLabel, "7, 12");
    lblCropHeight = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.CropHeightLabel.text"));
    ...
    lblNewLabel_1 = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.Use0ForNoCropping2Label.text"));
    panelTransforms.add(lblNewLabel_1, "7, 14");
    lblScaleWidth = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.ScaleWidthLabel.text"));
    ...
    lbluseFor = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.Use0ForNoScaling1Label.text"));
    panelTransforms.add(lbluseFor, "7, 16");
    lblScaleHeight = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.ScaleHeightLabel.text"));
    ...
    label = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.Use0ForNoScaling2Label.text"));
    panelTransforms.add(label, "7, 18");
    lblDeinterlace = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.DeInterlaceLabel.text"));
    panelTransforms.add(lblDeinterlace, "2, 20, right, default");
    deinterlaceChk = new JCheckBox("");
    panelTransforms.add(deinterlaceChk, "4, 20");
    lblremovesInterlacingFrom = new JLabel(Translations.getString("ReferenceCameraTransformsConfigurationWizard.TransformsPanel.RemoveInterlacingLabel.text"));
  ...
  @Override public void createBindings() {
    addWrappedBinding(referenceCamera.getAdvancedCalibration(), "overridingOldTransformsAndDistortionCorrectionSettings", this, "overriddenClassicTransforms");
