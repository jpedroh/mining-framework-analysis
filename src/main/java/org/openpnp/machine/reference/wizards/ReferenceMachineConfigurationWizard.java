...
public class ReferenceMachineConfigurationWizard extends AbstractConfigurationWizard {
  ...
  public ReferenceMachineConfigurationWizard(ReferenceMachine machine) {
    ...
    panelGeneral.setBorder(new TitledBorder(null, Translations.getString("ReferenceMachineConfigurationWizard.PanelGeneral.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    panelGeneral.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    JLabel lblHomeAfterEnabled = new JLabel(Translations.getString("ReferenceMachineConfigurationWizard.PanelGeneral.HomeAfterEnabledLabel.text"));
    ...
    JLabel lblParkAfterHomed = new JLabel(Translations.getString("ReferenceMachineConfigurationWizard.PanelGeneral.ParkAfterHomedLabel.text"));
    panelGeneral.add(lblParkAfterHomed, "2, 4, right, default");
    parkAfterHomed = new JCheckBox("");
    panelGeneral.add(parkAfterHomed, "4, 4");
    JLabel lblParkAllAtSafeZ = new JLabel(Translations.getString("ReferenceMachineConfigurationWizard.PanelGeneral.ParkAllAtSafeZLabel.text"));
    lblParkAllAtSafeZ.setToolTipText(Translations.getString("ReferenceMachineConfigurationWizard.PanelGeneral.ParkAllAtSafeZLabel.toolTipText"));
    panelGeneral.add(lblParkAllAtSafeZ, "2, 6, right, default");
    safeZPark = new JCheckBox("");
    panelGeneral.add(safeZPark, "4, 6");
    JLabel lblAutoToolSelect = new JLabel(Translations.getString("ReferenceMachineConfigurationWizard.PanelGeneral.AutoToolSelectLabel.text"));
    panelGeneral.add(lblAutoToolSelect, "2, 10, right, default");
    autoToolSelect = new JCheckBox("");
    panelGeneral.add(autoToolSelect, "4, 10");
    JLabel lblNewLabel = new JLabel(Translations.getString("ReferenceMachineConfigurationWizard.PanelGeneral.UnsafeZRoamingLabel.text"));
    ...
    JLabel lblMotionPlanning = new JLabel(Translations.getString("ReferenceMachineConfigurationWizard.PanelGeneral.MotionPlanningLabel.text"));
    panelGeneral.add(lblMotionPlanning, "2, 16, right, default");
    Object[] classNames = machine.getCompatibleMotionPlannerClasses().stream().map((c) -> c.getSimpleName()).toArray();
    ...
    panelLocations.setBorder(new TitledBorder(null, Translations.getString("ReferenceMachineConfigurationWizard.PanelLocations.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelLocations);
    panelLocations.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    ...
    JLabel lblRotation = new JLabel(Translations.getString("ReferenceMachineConfigurationWizard.PanelLocations.RotationLabel.text"));
    panelLocations.add(lblRotation, "10, 2");
    lblRotation.setHorizontalAlignment(SwingConstants.CENTER);
    JLabel lblDiscardPoint = new JLabel(Translations.getString("ReferenceMachineConfigurationWizard.PanelLocations.DiscardLocationLabel.text"));
    ...
    LocationButtonsPanel locationButtonsPanel = new LocationButtonsPanel(discardXTf, discardYTf, discardZTf, discardCTf);
