...
@SuppressWarnings(value = { "serial" }) public class ReferenceNozzleVacuumWizard extends AbstractConfigurationWizard {
  ...
  private void createUi() {
    ...
    panel.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(50dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    label = new JLabel(Translations.getString("ReferenceNozzleVacuumWizard.ContentPanel.VacuumActuatorLabel.text"));
    ...
    label = new JLabel(Translations.getString("ReferenceNozzleVacuumWizard.ContentPanel.BlowOffActuatorLabel.text"));
    ...
    lblSensingActuator = new JLabel(Translations.getString("ReferenceNozzleVacuumWizard.ContentPanel.SensingActuatorLabel.text"));
