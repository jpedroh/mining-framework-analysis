...
@SuppressWarnings(value = { "serial" }) public class ReferenceNozzleConfigurationWizard extends AbstractConfigurationWizard {
  ...
  public ReferenceNozzleConfigurationWizard(AbstractMachine machine, ReferenceNozzle nozzle) {
    ...
    panelProperties.setBorder(new TitledBorder(null, Translations.getString("ReferenceNozzleConfigurationWizard.PropertiesPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelProperties);
    panelProperties.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblName = new JLabel(Translations.getString("ReferenceNozzleConfigurationWizard.PropertiesPanel.NameLabel.text"));
    panelProperties.add(lblName, "2, 2, right, default");
    nameTf = new JTextField();
    panelProperties.add(nameTf, "4, 2");
    nameTf.setColumns(20);
    panelOffsets = new JPanel();
    panelOffsets.setBorder(new TitledBorder(null, Translations.getString("ReferenceNozzleConfigurationWizard.OffsetsPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null));
    panelOffsets.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    ...
    lblRotation = new JLabel(Translations.getString("ReferenceNozzleConfigurationWizard.OffsetsPanel.RotationLabel.text"));
    panelOffsets.add(lblRotation, "10, 2");
    lblAxis = new JLabel(Translations.getString("ReferenceNozzleConfigurationWizard.OffsetsPanel.AxisLabel.text"));
    ...
    lblOffset = new JLabel(Translations.getString("ReferenceNozzleConfigurationWizard.OffsetsPanel.OffsetLabel.text"));
    ...
    lblRotationMode = new JLabel(Translations.getString("ReferenceNozzleConfigurationWizard.OffsetsPanel.RotationModeLabel.text"));
    ...
    panelSafeZ.setBorder(new TitledBorder(null, Translations.getString("ReferenceNozzleConfigurationWizard.SafeZPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelSafeZ);
    panelSafeZ.setLayout(new FormLayout(new ColumnSpec[] { ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("114px"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { RowSpec.decode("24px"), RowSpec.decode("19px") }));
    JLabel lblSafeZ = new JLabel(Translations.getString("ReferenceNozzleConfigurationWizard.SafeZPanel.SafeZLabel.text"));
    ...
    lblDynamicSafeZ = new JLabel(Translations.getString("ReferenceNozzleConfigurationWizard.SafeZPanel.DynamicSafeZLabel.text"));
    ...
    chckbxDynamicsafez.setToolTipText(Translations.getString("ReferenceNozzleConfigurationWizard.SafeZPanel.DynamicSafeZChkbox.toolTipText"));
    panelSafeZ.add(chckbxDynamicsafez, "3, 2");
    panelChanger = new JPanel();
    panelChanger.setBorder(new TitledBorder(null, Translations.getString("ReferenceNozzleConfigurationWizard.ChangerPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null));
    contentPanel.add(panelChanger);
    panelChanger.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblPickDwellTime = new JLabel(Translations.getString("ReferenceNozzleConfigurationWizard.ChangerPanel.PickDwellTimeLabel.text"));
    ...
    lblPlaceDwellTime = new JLabel(Translations.getString("ReferenceNozzleConfigurationWizard.ChangerPanel.PlaceDwellTimeLabel.text"));
    ...
    lblDwellTime = new JLabel(Translations.getString("ReferenceNozzleConfigurationWizard.ChangerPanel.DwellTimeLabel.text"));
