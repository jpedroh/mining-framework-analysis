...
public class ReferenceNozzleTipConfigurationWizard extends AbstractConfigurationWizard {
  ...
  public ReferenceNozzleTipConfigurationWizard(ReferenceNozzleTip nozzleTip) {
    ...
    panel = new JPanel();
    panel.setBorder(new TitledBorder(null, Translations.getString("ReferenceNozzleTipConfigurationWizard.PropertiesPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panel);
    panel.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblName = new JLabel(Translations.getString("ReferenceNozzleTipConfigurationWizard.PropertiesPanel.NameLabel.text"));
    panel.add(lblName, "2, 2, right, default");
    nameTf = new JTextField();
    panel.add(nameTf, "4, 2, fill, default");
    nameTf.setColumns(10);
    panelPickAndPlace = new JPanel();
    panelPickAndPlace.setBorder(new TitledBorder(
<<<<<<< /usr/src/app/output/openpnp/openpnp/f9a8fe8740a0c227349eb465f22314b826ed7d2f/src/main/java/org/openpnp/machine/reference/wizards/ReferenceNozzleTipConfigurationWizard.java/left.java
    UIManager.getBorder("TitledBorder.border")
=======
    Translations.getString("ReferenceNozzleTipConfigurationWizard.DwellTimesPanel.Border.title")
>>>>>>> /usr/src/app/output/openpnp/openpnp/f9a8fe8740a0c227349eb465f22314b826ed7d2f/src/main/java/org/openpnp/machine/reference/wizards/ReferenceNozzleTipConfigurationWizard.java/right.java
    , "Pick & Place", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
    contentPanel.add(panelPickAndPlace);
    panelPickAndPlace.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("min(100dlu;pref):grow") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblPickDwellTime = new JLabel(Translations.getString("ReferenceNozzleTipConfigurationWizard.DwellTimesPanel.PickDwellTimeLabel.text"));
    ...
    lblPlaceDwellTime = new JLabel(Translations.getString("ReferenceNozzleTipConfigurationWizard.DwellTimesPanel.PlaceDwellTimeLabel.text"));
    ...
    lblPlaceBlowoffLevel = new JLabel(
<<<<<<< /usr/src/app/output/openpnp/openpnp/f9a8fe8740a0c227349eb465f22314b826ed7d2f/src/main/java/org/openpnp/machine/reference/wizards/ReferenceNozzleTipConfigurationWizard.java/left.java
    "Place Blow-Off Level"
=======
    Translations.getString("ReferenceNozzleTipConfigurationWizard.DwellTimesPanel.DwellTimeLabel.text")
>>>>>>> /usr/src/app/output/openpnp/openpnp/f9a8fe8740a0c227349eb465f22314b826ed7d2f/src/main/java/org/openpnp/machine/reference/wizards/ReferenceNozzleTipConfigurationWizard.java/right.java
    );
    ...
    panelPushAndDrag.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), Translations.getString("ReferenceNozzleTipConfigurationWizard.PushAndDragPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null));
    contentPanel.add(panelPushAndDrag);
    panelPushAndDrag.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblLowDiameter = new JLabel(Translations.getString("ReferenceNozzleTipConfigurationWizard.PushAndDragPanel.OutsideDiameterLabel.text"));
    lblLowDiameter.setToolTipText(Translations.getString("ReferenceNozzleTipConfigurationWizard.PushAndDragPanel.OutsideDiameterLabel.toolTipText"));
    ...
    lblPushAndDragAllowed = new JLabel(Translations.getString("ReferenceNozzleTipConfigurationWizard.PushAndDragPanel.PushAndDragAllowedLabel.text"));
    lblPushAndDragAllowed.setToolTipText(Translations.getString("ReferenceNozzleTipConfigurationWizard.PushAndDragPanel.PushAndDragAllowedLabel.toolTipText"));
    ...
    panelPartDimensions.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), Translations.getString("ReferenceNozzleTipConfigurationWizard.PartDimensionsPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null));
    contentPanel.add(panelPartDimensions);
    panelPartDimensions.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblMinPartDiameter = new JLabel(Translations.getString("ReferenceNozzleTipConfigurationWizard.PartDimensionsPanel.MinPartDiameterLabel.text"));
    lblMinPartDiameter.setToolTipText(Translations.getString("ReferenceNozzleTipConfigurationWizard.PartDimensionsPanel.MinPartDiameterLabel.toolTipText"));
    ...
    lblMaxPartDiameter = new JLabel(Translations.getString("ReferenceNozzleTipConfigurationWizard.PartDimensionsPanel.MaxPartDiameterLabel.text"));
...
=======
    Translations.getString("ReferenceNozzleTipConfigurationWizard.PartDimensionsPanel.MaxPartDiameterLabel.toolTipText")
>>>>>>> /usr/src/app/output/openpnp/openpnp/f9a8fe8740a0c227349eb465f22314b826ed7d2f/src/main/java/org/openpnp/machine/reference/wizards/ReferenceNozzleTipConfigurationWizard.java/right.java
    );
    ...
    lblMaxPartHeight = new JLabel(Translations.getString("ReferenceNozzleTipConfigurationWizard.PartDimensionsPanel.MaxPartHeightLabel.text"));
    lblMaxPartHeight.setToolTipText(Translations.getString("ReferenceNozzleTipConfigurationWizard.PartDimensionsPanel.MaxPartHeightLabel.toolTipText"));
    ...
    lblMaxPickTolerance = new JLabel(Translations.getString("ReferenceNozzleTipConfigurationWizard.PartDimensionsPanel.MaxPickToleranceLabel.text"));
    lblMaxPickTolerance.setToolTipText(Translations.getString("ReferenceNozzleTipConfigurationWizard.PartDimensionsPanel.MaxPickToleranceLabel.toolTipText"));
