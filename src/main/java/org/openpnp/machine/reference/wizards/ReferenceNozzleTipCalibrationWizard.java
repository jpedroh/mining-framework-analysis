...
public class ReferenceNozzleTipCalibrationWizard extends AbstractConfigurationWizard {
  ...
  public ReferenceNozzleTipCalibrationWizard(ReferenceNozzleTip nozzleTip) {
    ...
    panelCalibration.setBorder(new TitledBorder(null, "Calibration (EXPERIMENTAL!)", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelCalibration);
    panelCalibration.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(72dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.UNRELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.UNRELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    ...
    compensationAlgorithmCb = new JComboBox(ReferenceNozzleTipCalibration.RunoutCompensationAlgorithm.values());
  ...
  @SuppressWarnings(value = { "serial" }) private Action positionToolAction = new AbstractAction("Position Tool", Icons.centerTool) {
    ...
    @Override public void actionPerformed(ActionEvent arg0) {
      UiUtils.submitUiMachineTask(() -> {
        ...
        Location location = camera.getLocation(nozzle).add(new Location(nozzleTip.getCalibration().getCalibrationZOffset().getUnits(), 0, 0, nozzleTip.getCalibration().getCalibrationZOffset().getValue(), 0));
  ...
  private void calibrateCamera() {
    UiUtils.submitUiMachineTask(() -> {
      nozzleTip.getCalibration().calibrateCamera(nozzleTip);
    });
  }
  ...
  @Override public void createBindings() {
    ...
    bind(UpdateStrategy.READ, nozzleTip.getCalibration(), "runoutCompensationInformation", lblCalibrationResults, "text");
