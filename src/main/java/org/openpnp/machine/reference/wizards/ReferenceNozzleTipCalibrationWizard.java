...
public class ReferenceNozzleTipCalibrationWizard extends AbstractConfigurationWizard {
  ...
  public ReferenceNozzleTipCalibrationWizard(ReferenceNozzleTip nozzleTip) {
    ...
    panelTop = new JPanel();
    panelTop.setBorder(new TitledBorder(null, Translations.getString("ReferenceNozzleTipCalibrationWizard.TopPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelTop);
    panelTop.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(96dlu;default)"), FormSpecs.UNRELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    calibrationEnabledCheckbox = new JCheckBox(Translations.getString("ReferenceNozzleTipCalibrationWizard.TopPanel.CalibrationEnabledChkBox.text"));
    ...
    lblCalibrate = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.TopPanel.CalibrationLabel.text"));
    panelTop.add(lblCalibrate, "2, 4, right, default");
    btnCalibrate = new JButton(Translations.getString("ReferenceNozzleTipCalibrationWizard.TopPanel.CalibrateButton.text"));
    panelTop.add(btnCalibrate, "4, 4");
    btnReset = new JButton(Translations.getString("ReferenceNozzleTipCalibrationWizard.TopPanel.ResetButton.text"));
    panelTop.add(btnReset, "6, 4");
    btnCalibrateCamera = new JButton(Translations.getString("ReferenceNozzleTipCalibrationWizard.TopPanel.CalibrateCameraButton.text"));
    panelTop.add(btnCalibrateCamera, "8, 4");
    btnCalibrateCamera.setToolTipText(Translations.getString("ReferenceNozzleTipCalibrationWizard.TopPanel.CalibrateCameraButton.toolTipText"));
    lblRecalibration = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.TopPanel.RecalibrationLabel.text"));
    panelTop.add(lblRecalibration, "2, 6, right, default");
    lblRecalibration.setToolTipText(Translations.getString("ReferenceNozzleTipCalibrationWizard.TopPanel.RecalibrationLabel.toolTipText"));
    ...
    lblFailHoming = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.TopPanel.FailHomingLabel.text"));
    panelTop.add(lblFailHoming, "2, 8, right, default");
    lblFailHoming.setToolTipText(Translations.getString("ReferenceNozzleTipCalibrationWizard.TopPanel.FailHomingLabel.toolTipText"));
    ...
    btnReset.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        nozzleTip.getCalibration().resetAll();
      }
    });
    ...
    panelCalibration.setBorder(new TitledBorder(null, Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelCalibration);
    panelCalibration.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.UNRELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblCalibrationInfo = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.StatusLabel.text"));
    ...
    lblAngleIncrements = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.AngleIncrementsLabel.text"));
    ...
    lblAllowMisdectects = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.AllowMisDetectsLabel.text"));
    lblAllowMisdectects.setToolTipText(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.AllowMisDetectsLabel.toolTipText"));
    ...
    lblOffsetThreshold = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.OffsetThresholdLabel.text"));
    ...
    lblCalibrationZOffset = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.CalibrationZOffsetLabel.text"));
    lblCalibrationZOffset.setToolTipText(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.CalibrationZOffsetLabel.toolTipText"));
    ...
    lblNozzleTipDiameter = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.VisionDiameterLabel.text"));
    lblNozzleTipDiameter.setToolTipText(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.VisionDiameterLabel.toolTipText"));
    ...
    lblNewLabel = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.PipelineLabel.text"));
    panelCalibration.add(lblNewLabel, "2, 12, right, default");
    btnEditPipeline = new JButton(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.EditPipelineButton.text"));
    panelCalibration.add(btnEditPipeline, "4, 12");
    btnResetPipeline = new JButton(Translations.getString("ReferenceNozzleTipCalibrationWizard.CalibrationPanel.ResetPipelineButton.text"));
    ...
    panelBackground.setBorder(new TitledBorder(null, Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelBackground);
    panelBackground.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("max(50dlu;default)"), FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblMethod = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.MethodLabel.title"));
    ...
    lblDetailSize = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.MinDetailSizeLabel.title"));
    lblDetailSize.setToolTipText(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.MinDetailSizeLabel.toolTipText"));
    ...
    lblMinimum = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.MinimumLabel.text"));
    panelBackground.add(lblMinimum, "4, 8, center, default");
    lblMaximum = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.MaximumLabel.text"));
    panelBackground.add(lblMaximum, "6, 8, center, default");
    lblTolerance = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.ToleranceLabel.text"));
    panelBackground.add(lblTolerance, "8, 8, center, default");
    lblHue = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.HueLabel.text"));
    ...
    lblSaturation = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.SaturationLabel.text"));
    lblSaturation.setToolTipText(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.SaturationLabel.toolTipText"));
    ...
    lblBrightness = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.ValueLabel.text"));
    lblBrightness.setToolTipText(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.ValueLabel.toolTipText"));
    ...
    backgroundDiagnostics = new JLabel(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.BackgroundDiagnosticsLabel.text"));
    panelBackground.add(backgroundDiagnostics, "8, 16, 3, 1");
    btnShowProblems = new JButton(Translations.getString("ReferenceNozzleTipCalibrationWizard.BackgroundCalibrationPanel.ShowProblemsButton.text"));
  ...
  protected void adaptDialog() {
    ...
    boolean calibratesOnHoming = (recalibration == ReferenceNozzleTipCalibration.RecalibrationTrigger.MachineHome || recalibration == ReferenceNozzleTipCalibration.RecalibrationTrigger.NozzleTipChange);
    ...
    for (Component comp : panelBackground.getComponents()) {
      if (comp == backgroundCalibrationMethod || comp == lblMethod) {
        comp.setEnabled(enabled);
      } else {
        if (comp == backgroundMinValue || comp == backgroundMaxValue || comp == backgroundTolValue || comp == minimumDetailSize || comp == lblMaximum || comp == lblMinimum || comp == lblTolerance || comp == lblBrightness || comp == lblDetailSize || comp == hsvIndicator || comp == backgroundDiagnostics || comp == btnShowProblems) {
  ...
  @SuppressWarnings(value = { "serial" }) private Action positionToolAction = new AbstractAction(Translations.getString("ReferenceNozzleTipCalibrationWizard.Action.PositionTool"), Icons.centerTool) {
    {
      putValue(Action.SHORT_DESCRIPTION, Translations.getString("ReferenceNozzleTipCalibrationWizard.Action.PositionTool.Description"));
    }
  ...
  private void editCalibrationPipeline() throws Exception {
    ...
    if (Math.abs(distance.getLengthX().divide(camera.getUnitsPerPixelAtZ().getLengthX())) >= camera.getWidth() / 2 || Math.abs(distance.getLengthY().divide(camera.getUnitsPerPixelAtZ().getLengthY())) >= camera.getHeight() / 2 || Math.abs(distance.getLengthZ().convertToUnits(LengthUnit.Millimeters).getValue()) >= 0.1) {
      location = calibration.getCalibrationLocation(camera, nozzle);
    }
    final Location moveToLocation = location;
    UiUtils.confirmMoveToLocationAndAct(getTopLevelAncestor(), "move nozzle " + nozzle.getName() + " to the camera center location before editing the pipeline", nozzle, moveToLocation, true, () -> {
      CvPipeline pipeline = calibration.getPipeline(camera, nozzle, moveToLocation);
  ...
  private void calibrate() {
    ...
    UiUtils.submitUiMachineTask(() -> {
      nozzleTip.getCalibration().calibrate(getUiCalibrationNozzle(nozzleTip));
    });
  }
  ...
  private void calibrateCamera() {
    applyAction.actionPerformed(null);
    UiUtils.submitUiMachineTask(() -> {
      nozzleTip.getCalibration().calibrateCamera(getUiCalibrationNozzle(nozzleTip));
    });
  }
  ...
  @Override public void createBindings() {
    ...
    addWrappedBinding(nozzleTip.getCalibration(), "failHoming", failHoming, "selected");
    addWrappedBinding(nozzleTip.getCalibration(), "angleSubdivisions", angleIncrementsTf, "text", intConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "allowMisdetections", allowMisdetectsTf, "text", intConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "offsetThresholdLength", offsetThresholdTf, "text", lengthConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "calibrationZOffset", calibrationZOffsetTf, "text", lengthConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "calibrationTipDiameter", calibrationTipDiameter, "text", lengthConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "recalibrationTrigger", recalibrationCb, "selectedItem");
    bind(UpdateStrategy.READ, this, "calibrationStatus", calibrationStatus, "text");
    addWrappedBinding(nozzleTip.getCalibration(), "backgroundCalibrationMethod", backgroundCalibrationMethod, "selectedItem");
    addWrappedBinding(nozzleTip.getCalibration(), "minimumDetailSize", minimumDetailSize, "text", lengthConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "backgroundMinValue", backgroundMinValue, "text", intConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "backgroundMaxValue", backgroundMaxValue, "text", intConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "backgroundTolValue", backgroundTolValue, "text", intConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "backgroundMinSaturation", backgroundMinSaturation, "text", intConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "backgroundMaxSaturation", backgroundMaxSaturation, "text", intConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "backgroundTolSaturation", backgroundTolSaturation, "text", intConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "backgroundMinHue", backgroundMinHue, "text", intConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "backgroundMaxHue", backgroundMaxHue, "text", intConverter);
    addWrappedBinding(nozzleTip.getCalibration(), "backgroundTolHue", backgroundTolHue, "text", intConverter);
  ...
  public static void showBackgroundProblems(ReferenceNozzleTip nozzleTip, boolean noProblems) {
    UiUtils.messageBoxOnException(() -> {
      ...
      cameraView.showFilteredImages(backgroundCalibrationImages, texts, 1000);
    });
  }
}