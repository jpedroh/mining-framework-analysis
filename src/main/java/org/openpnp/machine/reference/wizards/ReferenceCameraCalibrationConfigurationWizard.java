...
@SuppressWarnings(value = { "serial" }) public class ReferenceCameraCalibrationConfigurationWizard extends AbstractConfigurationWizard {
  ...
  public ReferenceCameraCalibrationConfigurationWizard(ReferenceCamera referenceCamera) {
    ...
    panelLensCalibration.setBorder(new TitledBorder(null, Translations.getString("ReferenceCameraCalibrationConfigurationWizard.LensCalibrationPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelLensCalibration);
    panelLensCalibration.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    startLensCalibrationBtn = new JButton(startCalibration);
    panelLensCalibration.add(startLensCalibrationBtn, "2, 2, 3, 1");
    advancedCalWarning = new JLabel(Translations.getString("ReferenceCameraCalibrationConfigurationWizard.LensCalibrationPanel.AdvancedCalibrationActiveLabel.text"));
    advancedCalWarning.setForeground(Color.RED);
    panelLensCalibration.add(advancedCalWarning, "8, 2, left, default");
    lblApplyCalibration = new JLabel(Translations.getString("ReferenceCameraCalibrationConfigurationWizard.LensCalibrationPanel.ApplyCalibrationLabel.text"));
  ...
  private Action startCalibration = new AbstractAction(Translations.getString("ReferenceCameraCalibrationConfigurationWizard.Action.StartCalibration")) {
  ...
  private Action cancelCalibration = new AbstractAction(Translations.getString("ReferenceCameraCalibrationConfigurationWizard.Action.CancelCalibration")) {
    @Override public void actionPerformed(ActionEvent e) {
      startLensCalibrationBtn.setAction(startCalibration);
