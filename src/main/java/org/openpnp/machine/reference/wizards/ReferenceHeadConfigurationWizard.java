...
@SuppressWarnings(value = { "serial" }) public class ReferenceHeadConfigurationWizard extends AbstractConfigurationWizard {
  ...
  private void createUi() {
    ...
    panel.setBorder(new TitledBorder(null, Translations.getString("ReferenceHeadConfigurationWizard.LocationsPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panel);
    panel.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(80dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(50dlu;default)") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    JLabel lblX = new JLabel("X");
    panel.add(lblX, "4, 2, center, default");
    JLabel lblY = new JLabel("Y");
    panel.add(lblY, "6, 2, center, default");
    JLabel lblHomingFiducial = new JLabel(Translations.getString("ReferenceHeadConfigurationWizard.LocationsPanel.HomingFiducialLabel.text"));
    ...
    JLabel lblHomingMethod = new JLabel(Translations.getString("ReferenceHeadConfigurationWizard.LocationsPanel.HomingMethodLabel.text"));
    ...
    panel_1.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(50dlu;default)") }, new RowSpec[] { FormSpecs.DEFAULT_ROWSPEC }));
    btnHomingTest = new JButton(Translations.getString("ReferenceHeadConfigurationWizard.LocationsPanel.VisualTestButton.text"));
    panel_1.add(btnHomingTest, "1, 1, fill, default");
    btnHomingTest.setToolTipText(Translations.getString("ReferenceHeadConfigurationWizard.LocationsPanel.VisualTestButton.toolTipText"));
    btnVisualHome = new JButton(Translations.getString("ReferenceHeadConfigurationWizard.LocationsPanel.VisualHomeButton.text"));
    panel_1.add(btnVisualHome, "3, 1");
    btnVisualHome.setToolTipText(Translations.getString("ReferenceHeadConfigurationWizard.LocationsPanel.VisualHomeButton.toolTipText"));
    ...
    JLabel lblWarningChangingThese = new JLabel(Translations.getString("ReferenceHeadConfigurationWizard.LocationsPanel.WarningChangingLabel.text"));
    lblWarningChangingThese.setForeground(Color.BLACK);
    panel.add(lblWarningChangingThese, "4, 8, 7, 1");
    JLabel lblParkLocation = new JLabel(Translations.getString("ReferenceHeadConfigurationWizard.LocationsPanel.ParkLocationLabel.text"));
    ...
    panelCalibration.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), Translations.getString("ReferenceHeadConfigurationWizard.CalibrationRigPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
    contentPanel.add(panelCalibration);
    panelCalibration.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(80dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(50dlu;default)") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblX_1 = new JLabel("X");
    ...
    lblDiameter = new JLabel(Translations.getString("ReferenceHeadConfigurationWizard.CalibrationRigPanel.DiameterLabel.text"));
    lblDiameter.setToolTipText(Translations.getString("ReferenceHeadConfigurationWizard.CalibrationRigPanel.DiameterLabel.toolTipText"));
    panelCalibration.add(lblDiameter, "10, 2, center, default");
    lblCalibrationPrimary = new JLabel(Translations.getString("ReferenceHeadConfigurationWizard.CalibrationRigPanel.PrimaryFiducialLabel.text"));
    lblCalibrationPrimary.setToolTipText(Translations.getString("ReferenceHeadConfigurationWizard.CalibrationRigPanel.PrimaryFiducialLabel.toolTipText"));
    ...
    lblCalibrationSecondary = new JLabel(Translations.getString("ReferenceHeadConfigurationWizard.CalibrationRigPanel.SecondaryFiducialLabel.text"));
    lblCalibrationSecondary.setToolTipText(Translations.getString("ReferenceHeadConfigurationWizard.CalibrationRigPanel.SecondaryFiducialLabel.toolTipText"));
    ...
    lblTestObject = new JLabel(Translations.getString("ReferenceHeadConfigurationWizard.CalibrationRigPanel.TestObjectLabel.text"));
    ...
    panel_2.setBorder(new TitledBorder(null, Translations.getString("ReferenceHeadConfigurationWizard.ZProbePanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panel_2);
    panel_2.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(80dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(50dlu;default)") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    JLabel lblNewLabel_4 = new JLabel(Translations.getString("ReferenceHeadConfigurationWizard.ZProbePanel.ZProbeActuatorLabel.text"));
    ...
    panel_3.setBorder(new TitledBorder(null, Translations.getString("ReferenceHeadConfigurationWizard.PumpPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panel_3);
    panel_3.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(80dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(50dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    JLabel lblVacuumPumpActuator = new JLabel(Translations.getString("ReferenceHeadConfigurationWizard.PumpPanel.VacuumPumpActuatorLabel.text"));
