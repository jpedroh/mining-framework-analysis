...
@SuppressWarnings(value = { "serial" }) public class ReferenceCameraPositionConfigurationWizard extends AbstractConfigurationWizard {
  ...
  public ReferenceCameraPositionConfigurationWizard(AbstractMachine machine, ReferenceCamera referenceCamera) {
    ...
    panelOffsets.setBorder(new TitledBorder(null, Translations.getString("ReferenceCameraPositionConfigurationWizard.OffsetsPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null));
    ...
    lblRotation = new JLabel(Translations.getString("ReferenceCameraPositionConfigurationWizard.OffsetsPanel.RotationLabel.text"));
    panelOffsets.add(lblRotation, "10, 2");
    lblAxis = new JLabel(Translations.getString("ReferenceCameraPositionConfigurationWizard.OffsetsPanel.AxisLabel.text"));
    ...
    lblOffset = new JLabel(Translations.getString("ReferenceCameraPositionConfigurationWizard.OffsetsPanel.OffsetLabel.text"));
...
=======
    panelSafeZ.setBorder(new TitledBorder(null, Translations.getString("ReferenceCameraPositionConfigurationWizard.SafeZPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
>>>>>>> /usr/src/app/output/openpnp/openpnp/f9a8fe8740a0c227349eb465f22314b826ed7d2f/src/main/java/org/openpnp/machine/reference/wizards/ReferenceCameraPositionConfigurationWizard.java/right.java

    JLabel lblSafeZ = new JLabel(Translations.getString("ReferenceCameraPositionConfigurationWizard.SafeZPanel.SafeZLabel.text"));
    ...
    panelLocation.setBorder(new TitledBorder(null, Translations.getString("ReferenceCameraPositionConfigurationWizard.LocationPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelLocation);
    panelLocation.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("left:default") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblX = new JLabel("X");
    ...
    lblRotation_1 = new JLabel(Translations.getString("ReferenceCameraPositionConfigurationWizard.LocationPanel.RotationLabel.text"));
