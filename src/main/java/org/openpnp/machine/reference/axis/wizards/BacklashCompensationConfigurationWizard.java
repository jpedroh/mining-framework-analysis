...
@SuppressWarnings(value = { "serial" }) public class BacklashCompensationConfigurationWizard extends AbstractConfigurationWizard {
  ...
  private Action backlashCalibrateAction = new AbstractAction(Translations.getString("BacklashCompensationConfigurationWizard.Action.Calibrate"), Icons.axisCartesian) {
    {
      putValue(Action.SHORT_DESCRIPTION, Translations.getString("BacklashCompensationConfigurationWizard.Action.Calibrate.Description"));
    }
        ...
        if (hm instanceof ReferenceCamera) {
          ...
          if (camera.getHead() != null && camera.getLooking() == Looking.Down) {
            if (Configuration.get().getMachine() instanceof ReferenceMachine) {
              ...
              refMachine.getCalibrationSolutions().calibrateAxisBacklash((ReferenceHead) (camera.getHead()), camera, camera, (ReferenceControllerAxis) axis);
  ...
  public BacklashCompensationConfigurationWizard(ReferenceControllerAxis axis) {
    ...
    panelBacklashDiagnostics.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), Translations.getString("BacklashCompensationConfigurationWizard.BacklashDiagnosticsPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
    contentPanel.add(panelBacklashDiagnostics);
    panelBacklashDiagnostics.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("default:grow"), FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("default:grow"), FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("default:grow") }));
    lblBacklashCompensation = new JLabel(Translations.getString("BacklashCompensationConfigurationWizard.BacklashDiagnosticsPanel.CompensationMethodLabel.text"));
    panelBacklashDiagnostics.add(lblBacklashCompensation, "2, 2, right, default");
    lblBacklashCompensation.setToolTipText(Translations.getString("BacklashCompensationConfigurationWizard.BacklashDiagnosticsPanel.CompensationMethodLabel.toolTipText"));
    ...
    lblAcceptableTolerance = new JLabel(Translations.getString("BacklashCompensationConfigurationWizard.BacklashDiagnosticsPanel.ToleranceLabel.text"));
    lblAcceptableTolerance.setToolTipText(Translations.getString("BacklashCompensationConfigurationWizard.BacklashDiagnosticsPanel.ToleranceLabel.toolTipText"));
    ...
    lblSneakupDistance = new JLabel(Translations.getString("BacklashCompensationConfigurationWizard.BacklashDiagnosticsPanel.SneakUpDistanceLabel.text"));
    ...
    lblBacklashSpeedFactor = new JLabel(Translations.getString("BacklashCompensationConfigurationWizard.BacklashDiagnosticsPanel.SpeedFactorLabel.text"));
    ...
    lblStepTest = new JLabel(Translations.getString("BacklashCompensationConfigurationWizard.BacklashDiagnosticsPanel.StepTestLabel.text"));
    ...
    lblBacklashDistanceTest = new JLabel(Translations.getString("BacklashCompensationConfigurationWizard.BacklashDiagnosticsPanel.DistanceTestLabel.text"));
    ...
    lblBacklashSpeedTest = new JLabel(Translations.getString("BacklashCompensationConfigurationWizard.BacklashDiagnosticsPanel.SpeedTestLabel.text"));
