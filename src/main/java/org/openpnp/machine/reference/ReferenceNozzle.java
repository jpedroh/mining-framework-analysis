...
public class ReferenceNozzle extends AbstractNozzle implements ReferenceHeadMountable {
  ...
  @Override public void pick(Feeder feeder) throws Exception {
  ...
  @Override public void place(Location location) throws Exception {
  ...
  @Override public boolean isPartOnEnabled() {
    return isVaccumActuatorEnabled() && (getNozzleTip().getVacuumLevelPartOnLow() < getNozzleTip().getVacuumLevelPartOnHigh());
  }

  @Override public boolean isPartOffEnabled() {
    return isVaccumActuatorEnabled() && (getNozzleTip().getVacuumLevelPartOffLow() < getNozzleTip().getVacuumLevelPartOffHigh());
  }
