...
public class GcodeDriverSettings extends AbstractConfigurationWizard {
  ...
  public GcodeDriverSettings(GcodeDriver driver) {
    ...
    settingsPanel.setBorder(new TitledBorder(null, Translations.getString("GcodeDriverSettings.SettingsPanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(settingsPanel);
    settingsPanel.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("max(50dlu;default)") }));
    JLabel lblMotionControlType = new JLabel(Translations.getString("GcodeDriverSettings.SettingsPanel.MotionControlTypeLabel.text"));
    lblMotionControlType.setToolTipText(Translations.getString("GcodeDriverSettings.SettingsPanel.MotionControlTypeLabel.toolTipText"));
    ...
    JLabel lblMaxFeedRate = new JLabel(Translations.getString("GcodeDriverSettings.SettingsPanel.MaxFeedRate.text"));
    lblMaxFeedRate.setToolTipText(Translations.getString("GcodeDriverSettings.SettingsPanel.MaxFeedRate.toolTipText"));
    ...
    JLabel lblCommandTimeoutms = new JLabel(Translations.getString("GcodeDriverSettings.SettingsPanel.CommandTimeout.text"));
    ...
    JLabel lblConnectWaitTime = new JLabel(Translations.getString("GcodeDriverSettings.SettingsPanel.ConnectWaitTimeoutLabel.text"));
    ...
    JLabel lblLetterVariables = new JLabel(Translations.getString("GcodeDriverSettings.SettingsPanel.LetterVariablesLabel.text"));
    lblLetterVariables.setToolTipText(Translations.getString("GcodeDriverSettings.SettingsPanel.LetterVariablesLabel.toolTipText"));
    ...
    JLabel lblAllowPremoveCommands = new JLabel(Translations.getString("GcodeDriverSettings.SettingsPanel.AllowPreMoveCommandsLabel.text"));
    ...
    JLabel lblRemoveComments = new JLabel(Translations.getString("GcodeDriverSettings.SettingsPanel.RemoveCommentsLabel.text"));
    lblRemoveComments.setToolTipText(Translations.getString("GcodeDriverSettings.SettingsPanel.RemoveCommentsLabel.toolTipText"));
    ...
    JLabel lblCompressGcode = new JLabel(Translations.getString("GcodeDriverSettings.SettingsPanel.CompressGCodeLabel.text"));
    lblCompressGcode.setToolTipText(Translations.getString("GcodeDriverSettings.SettingsPanel.CompressGCodeLabel.toolTipText"));
    settingsPanel.add(lblCompressGcode, "6, 12, right, default");
    compressGcode = new JCheckBox("");
    settingsPanel.add(compressGcode, "8, 12");
    JLabel lblBackslashEscapedCharacters = new JLabel(Translations.getString("GcodeDriverSettings.SettingsPanel.BackslashEscapedCharactersLabel.text"));
    lblBackslashEscapedCharacters.setToolTipText(Translations.getString("GcodeDriverSettings.SettingsPanel.BackslashEscapedCharactersLabel.toolTipText"));
    settingsPanel.add(lblBackslashEscapedCharacters, "2, 14, right, default");
    backslashEscapedCharacters = new JCheckBox("");
    backslashEscapedCharacters.setToolTipText(Translations.getString("GcodeDriverSettings.SettingsPanel.BackslashEscapedCharactersLabel.toolTipText"));
    settingsPanel.add(backslashEscapedCharacters, "4, 14");
    JLabel lblLogGcode = new JLabel(Translations.getString("GcodeDriverSettings.SettingsPanel.LogGCodeLabel.text"));
    lblLogGcode.setToolTipText(Translations.getString("GcodeDriverSettings.SettingsPanel.LogGCodeLabel.toolTipText"));
    settingsPanel.add(lblLogGcode, "6, 14, right, default");
    loggingGcode = new JCheckBox("");
    settingsPanel.add(loggingGcode, "8, 14");
    JButton btnDetectFirmware = new JButton(Translations.getString("GcodeDriverSettings.SettingsPanel.DetectFirmwareButton.text"));
    btnDetectFirmware.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        firmwareConfiguration.setText(Translations.getString("GcodeDriverSettings.SettingsPanel.FirmwareConfigurationTextArea.Detecting.text"));
  ...
  public final Action exportProfileAction = new AbstractAction() {
    {
      ...
      putValue(NAME, Translations.getString("GcodeDriverSettings.Action.ExportProfile"));
      putValue(SHORT_DESCRIPTION, Translations.getString("GcodeDriverSettings.Action.ExportProfile.Description"));
    }

    @Override public void actionPerformed(ActionEvent arg0) {
      try {
        FileDialog fileDialog = new FileDialog(MainFrame.get(), Translations.getString("GcodeDriverSettings.SaveFileDialog.title"), FileDialog.SAVE);
  ...
  public final Action importProfileAction = new AbstractAction() {
    {
      ...
      putValue(SHORT_DESCRIPTION, Translations.getString("GcodeDriverSettings.Action.ImportProfile.Description"));
    }

    @Override public void actionPerformed(ActionEvent arg0) {
      try {
        FileDialog fileDialog = new FileDialog(MainFrame.get(), Translations.getString("GcodeDriverSettings.OpenFileDialog.title"), FileDialog.LOAD);
        fileDialog.setFilenameFilter(new FilenameFilter() {
          @Override public boolean accept(File dir, String name) {
            return name.toLowerCase().endsWith(".xml");
          }
  ...
  public final Action copyProfileToClipboardAction = new AbstractAction() {
    {
      ...
      putValue(SHORT_DESCRIPTION, Translations.getString("GcodeDriverSettings.Action.CopyProfile.Description"));
    }
    ...
    @Override public void actionPerformed(ActionEvent arg0) {
      try {
        ...
        MessageBoxes.infoBox(Translations.getString("CommonPhrases.copiedGcode"), Translations.getString("CommonPhrases.copiedGcodeToClipboard"));
      } catch (Exception e) {
  ...
  public final Action pasteProfileFromClipboardAction = new AbstractAction() {
    {
      ...
      putValue(SHORT_DESCRIPTION, Translations.getString("GcodeDriverSettings.Action.PasteProfile.Description"));
    }
    ...
    @Override public void actionPerformed(ActionEvent arg0) {
      try {
        ...
        MessageBoxes.infoBox(Translations.getString("CommonPhrases.pastedGcode"), Translations.getString("CommonPhrases.pastedGcodeFromClipboard"));
      } catch (Exception e) {
