...
@Root public class GcodeDriver extends AbstractReferenceDriver implements Named {
  ...
  @Override public void home(ReferenceMachine machine) throws Exception {
  ...
  @Override public void setGlobalOffsets(ReferenceMachine machine, AxesLocation axesLocation) throws Exception {
  ...
  @Override public void moveTo(ReferenceHeadMountable hm, MoveToCommand move) throws Exception {
  ...
  @Override public void waitForCompletion(ReferenceHeadMountable hm, CompletionType completionType) throws Exception {
  ...
  @Override public void actuate(ReferenceActuator actuator, boolean on) throws Exception {
  ...
  @Override public void actuate(ReferenceActuator actuator, double value) throws Exception {
  ...
  @Override public void actuate(ReferenceActuator actuator, String value) throws Exception {
  ...
  @Override public String actuatorRead(ReferenceActuator actuator, Object parameter) throws Exception {
  ...
  @Override public String actuatorRead(ReferenceActuator actuator) throws Exception {
  ...
  @Override public void findIssues(List<Solutions.Issue> issues) {
