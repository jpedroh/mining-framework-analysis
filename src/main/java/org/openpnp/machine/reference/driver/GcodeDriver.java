...
@Root public class GcodeDriver extends AbstractCommunications implements Named, Runnable {
  ...
  public List<String> sendCommand(String command, long timeout) throws Exception {
    ...
    responseQueue.drainTo(responses);
    Logger.debug("sendCommand({} {}, {}) => {}", new Object[] { comms.getConnectionName(), command, timeout == Long.MAX_VALUE ? -1 : timeout, responses });
    return responses;
  }
