...
public class ReferenceNozzleTip extends AbstractNozzleTip {
  ...
  @Deprecated @Element(required = false) private Double vacuumLevelPartOn;

  @Deprecated @Element(required = false) private Double vacuumLevelPartOff;
  ...
  public boolean isUnloadedNozzleTipStandin() {
    return getName().equals("unloaded") || getName().equals("unmounted");
  }
...
<<<<<<< /usr/src/app/output/openpnp/openpnp/b8e09be2a49e1aafa13895c40f7407facc178839/src/main/java/org/openpnp/machine/reference/ReferenceNozzleTip.java/left.java
