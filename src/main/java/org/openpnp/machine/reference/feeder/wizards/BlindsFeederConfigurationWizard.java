...
@SuppressWarnings(value = { "serial" }) public class BlindsFeederConfigurationWizard extends AbstractConfigurationWizard {
  private final BlindsFeeder feeder;

  public BlindsFeederConfigurationWizard(BlindsFeeder feeder) {
    this.feeder = feeder;
    panelPart = new JPanel();
    panelPart.setBorder(new TitledBorder(null, "General Settings", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
    contentPanel.add(panelPart);
    panelPart.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("right:default:grow"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    ...
    panelTapeSettings.setBorder(new TitledBorder(null, "Tape Settings", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
    panelTapeSettings.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    ...
    panelCover.setBorder(new TitledBorder(null, "Cover Settings", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    contentPanel.add(panelCover);
    panelCover.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
  ...
  private Action performOcrAction = new AbstractAction("OCR Detect") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Try to detect and set the part by OCR.");
    }
  ...
  private Action captureToolCoordinatesAction = new AbstractAction("Get Tool Z", Icons.captureTool) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Capture the Z height that the tool is at.");
    }
  ...
  private Action showFeaturesAction = new AbstractAction("Show Features") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Show the features recognized by vision, taking the camera center and/or already set feeder properties into consideration.");
    }
  ...
  private Action calibrateEdgesAction = new AbstractAction("Calibrate Cover Edges") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Calibrate the cover edges against the nozzle tip to get precise open/close positioning.");
    }
  ...
  private Action resetFeedCountAction = new AbstractAction("Reset") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Reset the Feed Count to 0 (for a newly loaded tape).");
    }
  ...
  private Action autoSetup = new AbstractAction("Auto Setup", Icons.captureCamera) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Capture the blinds pitch, size and centerline from the current camera position.");
    }
  ...
  private Action openCover = new AbstractAction("Open Cover", Icons.lockOpenOutline) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Open this cover using the nozzle tip.");
    }
  ...
  private Action closeCover = new AbstractAction("Close Cover", Icons.lockOutline) {
    {
      putValue(Action.SHORT_DESCRIPTION, "Close this cover using the nozzle tip.");
    }
  ...
  private Action openAllCovers = new AbstractAction("Open All Covers") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Open the covers of all the enabled feeders of the machine.");
    }
  ...
  private Action closeAllCovers = new AbstractAction("Close All Covers") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Close the opened covers of all the feeders of the machine.");
    }
