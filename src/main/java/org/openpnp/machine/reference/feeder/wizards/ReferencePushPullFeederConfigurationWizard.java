...
@SuppressWarnings(value = { "serial" }) public class ReferencePushPullFeederConfigurationWizard extends AbstractReferenceFeederConfigurationWizard {
  ...
  public ReferencePushPullFeederConfigurationWizard(ReferencePushPullFeeder feeder) {
    ...
    panelLocations.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(26dlu;default):grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("right:max(180dlu;min)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    ...
    panelLocations = new JPanel();
    panelLocations.setBorder(new TitledBorder(null, "Tape Settings", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    ...
    panelTape.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(26dlu;default):grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow") }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    ...
    panelVisionEnabled.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.LABEL_COMPONENT_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow") }, new RowSpec[] { FormSpecs.LINE_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
  ...
  @Override public void createBindings() {
    ...
    addWrappedBinding(firstPickLocation, "lengthX", textFieldPickLocationX, "text", lengthConverter);
    addWrappedBinding(firstPickLocation, "lengthY", textFieldPickLocationY, "text", lengthConverter);
    addWrappedBinding(firstPickLocation, "lengthZ", textFieldPickLocationZ, "text", lengthConverter);
  ...
  private Action editPipelineAction = new AbstractAction("Edit Pipeline") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Edit the Pipeline to be used for all vision operations of this feeder.");
    }

    @Override public void actionPerformed(ActionEvent e) {
      UiUtils.messageBoxOnException(() -> {
        UiUtils.confirmMoveToLocationAndAct(getTopLevelAncestor(), "move the camera to the proper feeder vision location before editing the pipeline", feeder.getCamera(), feeder.getNominalVisionLocation(), true, () -> {
          editPipeline();
        });
      });
    }
  ...
  private Action resetPipelineAction = new AbstractAction("Reset Pipeline") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Reset the Pipeline for this feeder to the OpenPNP standard.");
    }
  ...
  private Action resetStatisticsAction = new AbstractAction("Reset Statistics") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Reset the average obtained precision statistics.");
    }
  ...
  private Action resetFeedCountAction = new AbstractAction("Reset Feed Count") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Reset the feed count e.g. when a tape has been changed.");
    }

    @Override public void actionPerformed(ActionEvent e) {
      int result = JOptionPane.showConfirmDialog(getTopLevelAncestor(), "This will reset the recorded feed count of this feeder. Are you sure?", null, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
  ...
  private Action discardPartsAction = new AbstractAction("Discard Parts") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Discard parts that have been produced by the last tape transport.");
    }
  ...
  private Action showVisionFeaturesAction = new AbstractAction("Preview Vision Features") {
    {
      putValue(Action.SHORT_DESCRIPTION, "Preview the features recognized by Computer Vision.");
    }
  ...
  private Action autoSetupAction = new AbstractAction("Auto-Setup with Camera at Pick Location", Icons.captureCamera) {
    {
      putValue(Action.SHORT_DESCRIPTION, "<html>Center the camera on the pick location and press this button to Auto-Setup <br/>" + "If there are multiple picks per feed cycle, choose the one closest to the tape reel.</html>");
    }
    ...
    @Override public void actionPerformed(ActionEvent e) {
      UiUtils.messageBoxOnException(() -> {
        ...
        if (!feeder.getLocation().isInitialized()) {
          ...
          result = JOptionPane.showConfirmDialog(getTopLevelAncestor(), "This may overwrite all your current settings. Are you sure?", null, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        }
        if (result == JOptionPane.YES_OPTION) {
          applyAction.actionPerformed(e);
          UiUtils.submitUiMachineTask(() -> {
  ...
  private Action allFeederOcrAction = new AbstractAction("All Feeder OCR") {
    {
      putValue(Action.SHORT_DESCRIPTION, "<html>Go to all the feeders with OCR and rediscover the parts loaded in them. </html>");
    }
  ...
  private Action setupOcrRegionAction = new AbstractAction("Setup OCR Region") {
    {
      putValue(Action.SHORT_DESCRIPTION, "<html>Moves the camera to the vision location and lets you select the OCR region of interest.</html>");
    }
        ...
        SwingUtilities.invokeAndWait(() -> {
          UiUtils.messageBoxOnException(() -> {
            new RegionOfInterestProcess(MainFrame.get(), feeder.getCamera(), "Setup OCR Region") {
              @Override public void setResult(RegionOfInterest roi) {
  ...
  private Action performOcrAction = new AbstractAction("Part by OCR") {
    {
      putValue(Action.SHORT_DESCRIPTION, "<html>Perform OCR and assign the recognized part.</html>");
    }
  ...
  private Action feederCloneFromTemplate = new AbstractAction("Clone from Template", Icons.importt) {
    {
      putValue(Action.SHORT_DESCRIPTION, "<html>Clone the settings from the selected template feeder, <br/>transforming any coordinates to the pick location and orientation.</html>");
    }
    ...
    @Override public void actionPerformed(ActionEvent e) {
      UiUtils.messageBoxOnException(() -> {
        ...
        if (!(checkBoxCloneTapeSettings.isSelected() || checkBoxClonePushPullSettings.isSelected() || checkBoxCloneVisionSettings.isSelected())) {
        ...
        int result = JOptionPane.showConfirmDialog(getTopLevelAncestor(), "<html><p>This will overwrite the selected settings with those from the template:<br/><br/>" + feeder.getCloneTemplateStatus() + "<br/><br/>" + "Are you sure?", null, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
          feeder.smartClone(null, checkBoxCloneLocationSettings.isSelected(), checkBoxCloneTapeSettings.isSelected(), checkBoxClonePushPullSettings.isSelected(), checkBoxCloneVisionSettings.isSelected());
        }
      });
    }
  };

  private Action feederCloneToAllAction = new AbstractAction("Clone to Feeders", Icons.export) {
    {
      putValue(Action.SHORT_DESCRIPTION, "<html>Clone the settings from this feeder to all compatible feeders.</html>");
    }
    ...
    @Override public void actionPerformed(ActionEvent e) {
      UiUtils.messageBoxOnException(() -> {
        ...
        int result = JOptionPane.showConfirmDialog(getTopLevelAncestor(), "<html>This will overwrite the selected settings in all the target feeders:<br/><br/>" + feeder.getCloneTemplateStatus() + "<br/><br/>   " + "Are you sure?</html>", null, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
          for (ReferencePushPullFeeder targetFeeder : feeder.getCompatibleFeeders()) {
            targetFeeder.cloneFeederSettings(checkBoxCloneLocationSettings.isSelected(), checkBoxCloneTapeSettings.isSelected(), checkBoxClonePushPullSettings.isSelected(), checkBoxCloneVisionSettings.isSelected(), feeder);
          }
        }
      });
    }
  ...
  private Action plusOneAction = new AbstractAction("", Icons.add) {
    {
      putValue(Action.SHORT_DESCRIPTION, "<html>Add one more feeder like this one, advancing in a row.</html>");
    }
