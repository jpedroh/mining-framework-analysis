...
>>>>>>> /usr/src/app/output/openpnp/openpnp/3bce6e43e27344d6140fe166b5322cfa77844280/src/main/java/org/openpnp/machine/reference/feeder/ReferenceLoosePartFeeder.java/right.java
    ...
    location = location.derive(null, null, this.location.convertToUnits(location.getUnits()).getZ() + part.getHeight().convertToUnits(location.getUnits()).getValue(), null);
  ...
  public static CvPipeline createDefaultPipeline() {
    try {
      String xml = IOUtils.toString(ReferenceLoosePartFeeder.class.getResource("ReferenceLoosePartFeeder-DefaultPipeline.xml"));
