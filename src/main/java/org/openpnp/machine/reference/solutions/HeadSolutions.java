...
<<<<<<< /usr/src/app/output/openpnp/openpnp/f9a8fe8740a0c227349eb465f22314b826ed7d2f/src/main/java/org/openpnp/machine/reference/solutions/HeadSolutions.java/left.java
                            if (solutions.confirm("<html>"
                                    ...
                                    + "</ol>"
                                    + "<br/>"
                                    +"Are you sure?</html>", true)) { //$NON-NLS-1$
||||||| /usr/src/app/output/openpnp/openpnp/f9a8fe8740a0c227349eb465f22314b826ed7d2f/src/main/java/org/openpnp/machine/reference/solutions/HeadSolutions.java/base.java
                            if (solutions.confirm("<html>"
                                    + "<p>Accepting this solution may change your machine configuration fundamentally.<br/>"
                                    + "The following will happen:<p/>"
                                    + "<ol>"
