...
public class ReferenceMachine extends AbstractMachine {
  @Element(required = false) private ReferenceDriver driver = new NullDriver();

  @Element(required = false) protected PnpJobProcessor pnpJobProcessor = new ReferencePnpJobProcessor();

  @Element(required = false) protected PasteDispenseJobProcessor pasteDispenseJobProcessor;

  @Deprecated @Element(required = false) protected PartAlignment partAlignment = null;
  ...
  @Override public PasteDispenseJobProcessor getPasteDispenseJobProcessor() {
