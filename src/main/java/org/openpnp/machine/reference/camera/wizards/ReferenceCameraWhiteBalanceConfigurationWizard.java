...
@SuppressWarnings(value = { "serial" }) public class ReferenceCameraWhiteBalanceConfigurationWizard extends AbstractConfigurationWizard {
  ...
  public ReferenceCameraWhiteBalanceConfigurationWizard(ReferenceCamera referenceCamera) {
    ...
    panelColorBalance.setBorder(new TitledBorder(null, Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.ColorBalancePanel.Border.title"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
    contentPanel.add(panelColorBalance);
    panelColorBalance.setLayout(new FormLayout(new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(70dlu;default)"), FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC, FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC }, new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("max(100dlu;default)"), FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC }));
    lblRedBalance = new JLabel(Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.ColorBalancePanel.RedBalanceLabel.text"));
    ...
    lblGreenBalance = new JLabel(Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.ColorBalancePanel.GreenBalanceLabel.text"));
    ...
    lblBlueBalance = new JLabel(Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.ColorBalancePanel.BlueBalanceLabel.text"));
    ...
    lblRedGamma = new JLabel(Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.ColorBalancePanel.RedGammaLabel.text"));
    ...
    lblGreenGamma = new JLabel(Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.ColorBalancePanel.GreenGammaLabel.text"));
    ...
    lblBlueGamma = new JLabel(Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.ColorBalancePanel.BlueGammaLabel.text"));
    ...
    lblOutput = new JLabel(Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.ColorBalancePanel.OutputLevelLabel.text"));
    panelColorBalance.add(lblOutput, "2, 18, 1, 15, right, default");
    lblAutoWhitebalance = new JLabel(Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.ColorBalancePanel.AutoWhiteBalanceLabel.text"));
    ...
    lblInputLevel = new JLabel(Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.ColorBalancePanel.InputLevelLabel.text"));
  ...
  private final Action autoWhiteBalanceAction = new AbstractAction() {
    {
      putValue(NAME, Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.Action.AutoWhiteBalance"));
      putValue(SHORT_DESCRIPTION, Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.Action.AutoWhiteBalance.Description"));
    }
  ...
  private final Action autoWhiteBalanceBrightAction = new AbstractAction() {
    {
      putValue(NAME, Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.Action.Brightest"));
      putValue(SHORT_DESCRIPTION, Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.Action.Brightest.Description"));
    }
  ...
  private final Action autoWhiteBalanceRoughMapAction = new AbstractAction() {
    {
      putValue(NAME, Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.Action.MappedRoughly"));
      putValue(SHORT_DESCRIPTION, Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.Action.MappedRoughly.Description"));
    }
  ...
  private final Action autoWhiteBalanceFineMapAction = new AbstractAction() {
    {
      putValue(NAME, Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.Action.MappedFinely"));
      putValue(SHORT_DESCRIPTION, Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.Action.MappedFinely.Description"));
    }
  ...
  private final Action resetAction = new AbstractAction() {
    {
      putValue(NAME, Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.Action.Reset"));
      putValue(SHORT_DESCRIPTION, Translations.getString("ReferenceCameraWhiteBalanceConfigurationWizard.Action.Reset.Description"));
    }
