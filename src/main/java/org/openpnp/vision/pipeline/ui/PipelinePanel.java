...
public class PipelinePanel extends JPanel {
  ...
  private 
<<<<<<< /usr/src/app/output/openpnp/openpnp/fe97d5eb0739be99b7879275d1b49422b0652be7/src/main/java/org/openpnp/vision/pipeline/ui/PipelinePanel.java/left.java
  LengthPropertySheetConverter
=======
  PipelinePropertySheetTable
>>>>>>> /usr/src/app/output/openpnp/openpnp/fe97d5eb0739be99b7879275d1b49422b0652be7/src/main/java/org/openpnp/vision/pipeline/ui/PipelinePanel.java/right.java
   
<<<<<<< /usr/src/app/output/openpnp/openpnp/fe97d5eb0739be99b7879275d1b49422b0652be7/src/main/java/org/openpnp/vision/pipeline/ui/PipelinePanel.java/left.java
  lengthPropertySheetConverter = new LengthPropertySheetConverter()
=======
  pipelinePropertySheetTable
>>>>>>> /usr/src/app/output/openpnp/openpnp/fe97d5eb0739be99b7879275d1b49422b0652be7/src/main/java/org/openpnp/vision/pipeline/ui/PipelinePanel.java/right.java
  ;
...
>>>>>>> /usr/src/app/output/openpnp/openpnp/fe97d5eb0739be99b7879275d1b49422b0652be7/src/main/java/org/openpnp/vision/pipeline/ui/PipelinePanel.java/right.java
  ...
  public Action newStageAction = new AbstractAction() {
    ...
    @Override public void actionPerformed(ActionEvent arg0) {
      ...
      stageClasses.sort(new Comparator<Class<? extends CvStage>>() {
        @Override public int compare(Class<? extends CvStage> o1, Class<? extends CvStage> o2) {
          return o1.getSimpleName().toLowerCase().compareTo(o2.getSimpleName().toLowerCase());
        }
      });
      ClassSelectionDialog<CvStage> dialog = new ClassSelectionDialog<>(JOptionPane.getFrameForComponent(PipelinePanel.this), "New Stage", "Please select a stage implemention from the list below.", stageClasses);
      ...
      try {
        ...
        MessageBoxes.errorBox(JOptionPane.getFrameForComponent(PipelinePanel.this), "Error", e);
      }
    }
  };
  ...
  public final Action copyAction = new AbstractAction() {
    ...
    @Override public void actionPerformed(ActionEvent arg0) {
      try {
        StringSelection stringSelection = new StringSelection(editor.getPipeline().toXmlString());
