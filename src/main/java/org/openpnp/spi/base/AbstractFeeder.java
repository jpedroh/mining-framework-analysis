...
public abstract class AbstractFeeder extends AbstractModelObject implements Feeder {
  ...
  @Attribute(required = false) protected String parentId;

  @Attribute(required = false) protected String name;

  @Attribute protected boolean enabled;

  @Attribute protected String partId;
  ...
  /**
     ...
     */
  @Attribute(required = false) protected int retryCount = 3;

  @Attribute(required = false) protected int pickRetryCount = 3;
  ...
  @Override public void addChild(String childId) {
  }

  @Override public void removeChild(String childId) {
  }

  @Override public void removeAllChildren() {
  }

  @Override public boolean isPotentialParentOf(Feeder feeder) {
    return false;
  }

  @Override public void preDeleteCleanUp() {
    if (!parentId.equals(ROOT_FEEDER_ID)) {
