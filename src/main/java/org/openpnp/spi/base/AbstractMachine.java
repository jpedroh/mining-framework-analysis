...
public abstract class AbstractMachine extends AbstractModelObject implements Machine {
  ...
  @ElementList(required = false) protected IdentifiableList<Axis> axes = new IdentifiableList<>();

  @ElementList protected IdentifiableList<Head> heads = new IdentifiableList<>();

  @ElementList(required = false) protected IdentifiableList<Signaler> signalers = new IdentifiableList<>();

  @ElementList(required = false) protected IdentifiableList<Feeder> feeders = new IdentifiableList<>();

  @ElementList(required = false) protected IdentifiableList<Camera> cameras = new IdentifiableList<>();

  @ElementList(required = false) protected IdentifiableList<Actuator> actuators = new IdentifiableList<>();

  @ElementList(required = false) protected IdentifiableList<PartAlignment> partAlignments = new IdentifiableList<>();

  @ElementList(required = false) protected IdentifiableList<Driver> drivers = new IdentifiableList<>();

  @Element(required = false) protected Location discardLocation = new Location(LengthUnit.Millimeters);

  @Attribute(required = false) protected double speed = 1.0D;

  @ElementMap(required = false) protected HashMap<String, Object> properties = new HashMap<>();

  @ElementList(required = false) protected IdentifiableList<NozzleTip> nozzleTips = new IdentifiableList<>();
  ...
  @SuppressWarnings(value = { "unused" }) @Commit protected void commit() {
    for (Head head : heads) {
  ...
  @Override public List<Axis> getAxes() {
    return Collections.unmodifiableList(axes);
  }

  @Override public Axis getAxis(String id) {
    return axes.get(id);
  }
  ...
  public AbstractAxis getDefaultAxis(Axis.Type type) {
    ...
    if (defaultAxis != null) {
      if (type != Axis.Type.Z) {
        for (Axis axis : getAxes()) {
          if (axis instanceof AbstractSingleTransformedAxis && ((AbstractSingleTransformedAxis) axis).getInputAxis() == defaultAxis) {
            defaultAxis = (AbstractAxis) axis;
            break;
          }
        }
      ...
      for (Axis axis : getAxes()) {
        if (axis instanceof ReferenceLinearTransformAxis && ((ReferenceLinearTransformAxis) axis).getPrimaryInputAxis() == defaultAxis) {
          defaultAxis = (AbstractAxis) axis;
          break;
        }
      }
  ...
  @Override public List<Head> getHeads() {
    return Collections.unmodifiableList(heads);
  }

  @Override public Head getHead(String id) {
    return heads.get(id);
  }

  @Override public Head getHeadByName(String name) {
    for (Head head : heads) {
  ...
  @Override public List<Signaler> getSignalers() {
    return Collections.unmodifiableList(signalers);
  }

  @Override public Signaler getSignaler(String id) {
    return signalers.get(id);
  }

  @Override public Signaler getSignalerByName(String name) {
  ...
  @Override public Feeder getFeeder(String id) {
  ...
  @Override public Camera getCamera(String id) {
  ...
  @Override public List<PartAlignment> getPartAlignments() {
    return Collections.unmodifiableList(partAlignments);
  }

  @Override public List<Actuator> getActuators() {
    return Collections.unmodifiableList(actuators);
  }

  @Override public Actuator getActuator(String id) {
    return actuators.get(id);
  }

  @Override public Actuator getActuatorByName(String name) {
  ...
  @Override public Feeder getFeederByName(String name) {
  ...
  @Override public void addListener(MachineListener listener) {
    if (!listeners.contains(listener)) {
      listeners.add(listener);
    }
  }

  @Override public void removeListener(MachineListener listener) {
    listeners.remove(listener);
  }

  @Override public void addAxis(Axis axis) throws Exception {
    axes.add(axis);
    fireIndexedPropertyChange("axes", axes.size() - 1, null, axis);
  }

  @Override public void removeAxis(Axis axis) {
  ...
  @Override public void permutateAxis(Axis axis, int direction) {
  ...
  @Override public void addFeeder(Feeder feeder) throws Exception {
    feeders.add(feeder);
    fireIndexedPropertyChange("feeders", feeders.size() - 1, null, feeder);
  }

  @Override public void removeFeeder(Feeder feeder) {
  ...
  @Override public void addCamera(Camera camera) throws Exception {
    camera.setHead(null);
    cameras.add(camera);
    fireIndexedPropertyChange("cameras", cameras.size() - 1, null, camera);
  }

  @Override public void removeCamera(Camera camera) {
  ...
  @Override public void permutateCamera(Camera camera, int direction) {
  ...
  @Override public void addActuator(Actuator actuator) throws Exception {
    actuator.setHead(null);
    actuators.add(actuator);
    fireIndexedPropertyChange("actuators", actuators.size() - 1, null, actuator);
  }

  @Override public void removeActuator(Actuator actuator) {
  ...
  @Override public void addDriver(Driver driver) throws Exception {
    drivers.add(driver);
    fireIndexedPropertyChange("drivers", drivers.size() - 1, null, drivers);
  }

  @Override public void removeDriver(Driver driver) {
  ...
  @Override public void permutateDriver(Driver driver, int direction) {
  ...
  @Override public void addSignaler(Signaler signaler) throws Exception {
    signalers.add(signaler);
    fireIndexedPropertyChange("signalers", signalers.size() - 1, null, signalers);
  }

  @Override public void removeSignaler(Signaler signaler) {
  ...
  @Override public Future<Object> submit(Runnable runnable) {
    return submit(Executors.callable(runnable));
  }

  @Override public <T extends java.lang.Object> Future<T> submit(Callable<T> callable) {
    return submit(callable, null);
  }

  @Override public <T extends java.lang.Object> Future<T> submit(final Callable<T> callable, final FutureCallback<T> callback) {
    return submit(callable, callback, false);
  }

  @Override public <T extends java.lang.Object> Future<T> submit(final Callable<T> callable, final FutureCallback<T> callback, final boolean ignoreEnabled) {
    synchronized (this) {
  ...
  @Override public <T extends java.lang.Object> T execute(final Callable<T> callable, final boolean onlyIfEnabled, final long timeout) throws Exception {
  ...
  @Override public boolean isTask(Thread thread) {
  ...
  @Override public Head getDefaultHead() throws Exception {
  ...
  @Override public List<NozzleTip> getNozzleTips() {
    return Collections.unmodifiableList(nozzleTips);
  }

  @Override public void addNozzleTip(NozzleTip nozzleTip) throws Exception {
    nozzleTips.add(nozzleTip);
    fireIndexedPropertyChange("nozzleTips", nozzleTips.size() - 1, null, nozzleTip);
  }

  @Override public void removeNozzleTip(NozzleTip nozzleTip) {
  ...
  @Override public NozzleTip getNozzleTip(String id) {
    return nozzleTips.get(id);
  }

  @Override public NozzleTip getNozzleTipByName(String name) {
