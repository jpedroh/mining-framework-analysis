...
public abstract class AbstractNozzle extends AbstractModelObject implements Nozzle {
  ...
  @ElementList(required = false) protected List<String> compatibleNozzleTipIds = new ArrayList<>();
  ...
  @Override public Head getHead() {
    return head;
  }

  @Override public void setHead(Head head) {
    this.head = head;
  }
  ...
  @Override public Set<NozzleTip> getCompatibleNozzleTips() {
  ...
  @Override public void addCompatibleNozzleTip(NozzleTip nt) {
  ...
  @Override public void removeCompatibleNozzleTip(NozzleTip nt) {
    getCompatibleNozzleTips();
