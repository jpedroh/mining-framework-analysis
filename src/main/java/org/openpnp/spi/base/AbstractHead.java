...
public abstract class AbstractHead extends AbstractModelObject implements Head {
  @Attribute protected String id;

  @Attribute(required = false) protected String name;

  @ElementList(required = false) protected IdentifiableList<Nozzle> nozzles = new IdentifiableList<>();
  ...
  @Element(required = false) protected Location parkLocation = new Location(LengthUnit.Millimeters);

  @Deprecated @Element(required = false) protected boolean softLimitsEnabled = false;

  @Deprecated @Element(required = false) protected Location minLocation = null;

  @Deprecated @Element(required = false) protected Location maxLocation = null;

  @Element(required = false) protected String zProbeActuatorName;

  @Element(required = false) protected String pumpActuatorName;
  ...
  @Attribute(required = false) private VisualHomingMethod visualHomingMethod = VisualHomingMethod.None;
  ...
  @SuppressWarnings(value = { "unused" }) @Commit private void commit() {
  ...
  @Override public List<Nozzle> getNozzles() {
    return Collections.unmodifiableList(nozzles);
  }

  @Override public Nozzle getNozzle(String id) {
    return nozzles.get(id);
  }

  @Override public Nozzle getNozzleByName(String name) {
  ...
  @Override public void addNozzle(Nozzle nozzle) throws Exception {
    nozzle.setHead(this);
    nozzles.add(nozzle);
    fireIndexedPropertyChange("nozzles", nozzles.size() - 1, null, nozzle);
  }

  @Override public void removeNozzle(Nozzle nozzle) {
  ...
  @Override public void permutateNozzle(Nozzle nozzle, int direction) {
  ...
  @Override public List<HeadMountable> getHeadMountables() {
  ...
  @Override public void moveToSafeZ(double speed) throws Exception {
    for (HeadMountable hm : getHeadMountables()) {
  ...
  @Override public Camera getDefaultCamera() throws Exception {
  ...
  @Override public Nozzle getDefaultNozzle() throws Exception {
  ...
  @Override public HeadMountable getDefaultHeadMountable() throws Exception {
    List<Camera> cameras = getCameras();
    if (cameras != null && !cameras.isEmpty()) {
      return cameras.get(0);
    }
  ...
  @Override public Machine getMachine() {
    return machine;
  }

  @Override public void setMachine(Machine machine) {
    this.machine = machine;
  }

  @Override public void moveToSafeZ() throws Exception {
  ...
  @Deprecated public Location getMinLocation() {
    return minLocation;
  }

  @Deprecated public void setMinLocation(Location minLocation) {
    this.minLocation = minLocation;
  }

  @Deprecated public Location getMaxLocation() {
    return maxLocation;
  }

  @Deprecated public void setMaxLocation(Location maxLocation) {
    this.maxLocation = maxLocation;
  }

  @Deprecated public boolean isSoftLimitsEnabled() {
    return softLimitsEnabled;
  }

  @Override public Actuator getZProbe() {
  ...
  @Override public Actuator getPump() {
