...
public abstract class AbstractHead extends AbstractModelObject implements Head {
  ...
  @Element(required = false) protected boolean softLimitsEnabled = false;

  @Element(required = false) protected Location minLocation = new Location(LengthUnit.Millimeters);

  @Element(required = false) protected Location maxLocation = new Location(LengthUnit.Millimeters);
