...
<<<<<<< /usr/src/app/output/spoutcraft/legacylauncher/384475a5de173cb5adb28b972e4501380e9dd3fe/src/main/java/org/spoutcraft/launcher/GUI/LoginForm.java/left.java
...
public class LoginForm extends JFrame implements ActionListener, DownloadListener, KeyListener {
  ...
  public void drawCharacter(String url, int x, int y) {
    ...
    try {
      ...
      drawCropped(originalImage, type, 40, 8, 48, 16, x - 4, y - 5, 8);
      drawCropped(originalImage, type, 8, 8, 16, 16, x, y, 7);
      drawCropped(originalImage, type, 20, 20, 28, 32, x, y + 56, 7);
      drawCropped(originalImage, type, 44, 20, 48, 32, x - 28, y + 56, 7);
      drawCropped(originalImage, type, 44, 20, 48, 32, x + 56, y + 56, 7, true);
      drawCropped(originalImage, type, 4, 20, 8, 32, x, y + 140, 7);
...
>>>>>>> /usr/src/app/output/spoutcraft/legacylauncher/384475a5de173cb5adb28b972e4501380e9dd3fe/src/main/java/org/spoutcraft/launcher/GUI/LoginForm.java/right.java
