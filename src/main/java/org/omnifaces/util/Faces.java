...
public final class Faces {
  ...
  /**
	 ...
	 * @since 1.8
	 */
  @Deprecated public static String getForwardRequestURI() {
  ...
  /**
	 ...
	 * @since 1.8
	 */
  @Deprecated public static String getForwardRequestQueryString() {
  ...
  /**
	 ...
	 * @since 1.8
	 */
  @Deprecated public static String getForwardRequestURIWithQueryString() {
  ...
  /**
	 ...
	 * @since 1.8
	 */
  public static void addResponseCookie(String name, String value, String domain, String path, int maxAge, boolean isHttpOnly) {
