...
public final class Components {
  ...
  /**
	 ...
	 * @since 2.4
	 */
  @SuppressWarnings(value = { "unchecked" }) public static List<String> getActionExpressionsAndListeners(UIComponent component) {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) private static <C extends java.lang.Object, F extends java.lang.Object> F getField(Class<? extends C> classType, Class<F> fieldType, C instance) {
