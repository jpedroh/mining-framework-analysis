...
public final class FacesLocal {
  ...
  /**
	 ...
	 */
  @Deprecated public static String getForwardRequestURI(FacesContext context) {
  ...
  /**
	 ...
	 */
  @Deprecated public static String getForwardRequestQueryString(FacesContext context) {
  ...
  /**
	 ...
	 */
  @Deprecated public static String getForwardRequestURIWithQueryString(FacesContext context) {
  ...
  /**
	 ...
	 */
  public static void addResponseCookie(FacesContext context, String name, String value, String path, int maxAge, boolean isHttpOnly) {
  ...
  /**
	 ...
	 */
  public static void addResponseCookie(FacesContext context, String name, String value, String domain, String path, int maxAge, boolean isHttpOnly) {
    ExternalContext externalContext = context.getExternalContext();
  ...
  /**
	 ...
	 */
  public static void sendFile(FacesContext context, String filename, boolean attachment, Callback.Output outputCallback) throws IOException {
    ExternalContext externalContext = context.getExternalContext();
    ...
    externalContext.setResponseHeader("Content-Disposition", String.format(SENDFILE_HEADER, (attachment ? "attachment" : "inline"), encodeURI(filename)));
  ...
  /**
	 ...
	 */
  private static void sendFile(final FacesContext context, final InputStream input, String filename, final long contentLength, boolean attachment) throws IOException {
