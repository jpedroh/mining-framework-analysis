...
public final class FacesLocal {
  ...
  public static Map<String, List<String>> getViewParameterMap(FacesContext context) {
    ...
    Map<String, List<String>> parameterMap = new 
<<<<<<< /usr/src/app/output/omnifaces/omnifaces/c60f2912ea124a5c47fc0e0e83a1c81ff6751d2f/src/main/java/org/omnifaces/util/FacesLocal.java/left.java
    HashMap<String, List<String>>
=======
    LinkedHashMap<>
>>>>>>> /usr/src/app/output/omnifaces/omnifaces/c60f2912ea124a5c47fc0e0e83a1c81ff6751d2f/src/main/java/org/omnifaces/util/FacesLocal.java/right.java
    (viewParameters.size());
