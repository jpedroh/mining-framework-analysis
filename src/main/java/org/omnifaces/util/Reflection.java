 ...
 *
 */
@Typed public final class Reflection {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> Class<T> toClass(String className) {
    try {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> T instance(String className) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> T instance(Class<T> clazz) {
    try {
  ...
  /**
	 ...
	 * @since 2.5
	 */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> T accessField(Object instance, String fieldName) {
    try {
  ...
  /**
	 ...
	 * @since 2.5
	 */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> T invokeMethod(Object instance, String methodName, Object... parameters) {
    try {
      Method method = findMethod(instance, methodName, parameters);
      method.setAccessible(true);
      return (T) method.invoke(instance, parameters);
    } catch (Exception e) {
      throw new IllegalStateException(String.format(ERROR_INVOKE_METHOD, methodName, instance.getClass(), Arrays.toString(parameters)), e);
    }
  }
}