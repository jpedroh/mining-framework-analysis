...
public class NoAutoGeneratedIdViewHandler extends ViewHandlerWrapper {
  ...
  @Override public void renderView(final FacesContext context, UIViewRoot viewToRender) throws IOException, FacesException {
    super.renderView(new FacesContextWrapper() {
      @Override public void setResponseWriter(ResponseWriter responseWriter) {
    ...
    @Override public void writeAttribute(String name, Object value, String property) throws IOException {
      if (value != null && "id".equals(name)) {
        ...
        if (id.startsWith(UNIQUE_ID_PREFIX) || id.contains(INTERMEDIATE_ID_PREFIX)) {
          ...
          throw new IllegalStateException(String.format(ERROR_AUTO_GENERATED_ID_ENCOUNTERED, id, (component == null) ? "<null>" : component.getClass().getName()));
        }
      }
