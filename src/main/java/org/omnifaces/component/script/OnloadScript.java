 ...
 */
@FacesComponent(value = OnloadScript.COMPONENT_TYPE) @ListenersFor(value = { @ListenerFor(systemEventClass = PostAddToViewEvent.class), @ListenerFor(systemEventClass = PostRestoreStateEvent.class) }) public class OnloadScript extends ScriptFamily implements SystemEventListener {
  ...
  @Override public void processEvent(SystemEvent event) throws AbortProcessingException {
    ...
    context.setResponseWriter(new ResponseWriterWrapper() {
      @Override public void writeText(Object text, String property) throws IOException {
