 ...
 * @see SortedTreeModel
 */
@FacesComponent(value = Tree.COMPONENT_TYPE) @SuppressWarnings(value = { "rawtypes" }) public class Tree extends TreeFamily implements NamingContainer {
  ...
  /**
	 ...
	 */
  @Override public String getContainerClientId(FacesContext context) {
    ...
    if (currentModelNodeIndex != null) {
      containerClientId = new StringBuilder(containerClientId).append(UINamingContainer.getSeparatorChar(context)).append(currentModelNodeIndex).toString();
    }
  ...
  /**
	 ...
	 */
  @Override public void setValueExpression(String name, ValueExpression binding) {
  ...
  /**
	 ...
	 */
  @Override public void queueEvent(FacesEvent event) {
  ...
  /**
	 ...
	 */
  @Override protected void process(final FacesContext context, final PhaseId phaseId) {
    if (!isRendered()) {
      return;
    }
  ...
  /**
	 ...
	 */
  @Override public boolean visitTree(final VisitContext context, final VisitCallback callback) {
  ...
  /**
	 ...
	 */
  @Override public void broadcast(FacesEvent event) throws AbortProcessingException {
  ...
  protected void processTreeNode(final FacesContext context, final PhaseId phaseId) {
    processTreeNode(phaseId, new Callback.ReturningWithArgument<Void, TreeNode>() {
      @Override public Void invoke(TreeNode treeNode) {
        if (treeNode != null) {
  ...
  protected boolean visitTreeNode(final VisitContext context, final VisitCallback callback) {
    return processTreeNode(PhaseId.ANY_PHASE, new Callback.ReturningWithArgument<Boolean, TreeNode>() {
      @Override public Boolean invoke(TreeNode treeNode) {
        if (treeNode != null) {
  ...
  /**
	 ...
	 */
  private <R extends java.lang.Object> R process(FacesContext context, TreeModel node, Callback.Returning<R> callback) {
  ...
  /**
	 ...
	 * @return The callback result.
	 */
  private <R extends java.lang.Object> R processTreeNode(PhaseId phaseId, Callback.ReturningWithArgument<R, TreeNode> callback) {
