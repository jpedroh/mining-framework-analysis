 ...
 */
@FacesComponent(value = Form.COMPONENT_TYPE) public class Form extends UIForm {
          ...
          return new ViewHandlerWrapper() {
            ...
            @Override public String getActionURL(FacesContext context, String viewId) {
              if (type == useRequestURI) {
                ...
                if (type == includeRequestParams) {
                  return context.getExternalContext().encodeBookmarkableURL(super.getActionURL(context, viewId), getRequestQueryStringMap(context));
                } else {
                  if (type == includeViewParams) {
                    return context.getExternalContext().encodeBookmarkableURL(super.getActionURL(context, viewId), getViewParameterMap(context));
                  } else {
