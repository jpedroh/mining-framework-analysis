 ...
 * @since 1.3
 */
@FacesConverter(value = "omnifaces.SelectItemsIndexConverter") public class SelectItemsIndexConverter implements Converter {
  private static final String ATTRIBUTE_SELECT_ITEMS = "SelectItemsIndexConverter.%s";

  private static final String ERROR_SELECT_ITEMS_LIST_EMPTY = "Could not determine select items list for component {0}";
  ...
  @Override public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
    ...
    try {
      ...
      throw new ConverterException(createError(ERROR_SELECT_ITEMS_LIST_INDEX, submittedValue, component.getClientId(context)), e);
    } catch (Exception e) {
      throw new ConverterException(createError(ERROR_GET_AS_OBJECT, submittedValue, component.getClientId(context)), e);
    }
  }
  ...
  private static List<Object> getSelectItemValues(FacesContext context, UIComponent component) {
    ...
    if (selectItemValues.isEmpty()) {
      throw new ConverterException(createError(
<<<<<<< /usr/src/app/output/omnifaces/omnifaces/54a7f76c73dc469f57484ebdcdf2203dc9f3a193/src/main/java/org/omnifaces/converter/SelectItemsIndexConverter.java/left.java
      ERROR_SELECT_ITEMS_LIST_NULL
=======
      ERROR_SELECT_ITEMS_LIST_EMPTY
