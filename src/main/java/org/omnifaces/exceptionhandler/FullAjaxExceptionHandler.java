...
public class FullAjaxExceptionHandler extends ExceptionHandlerWrapper {
  ...
  private static final String ERROR_INVALID_UNWRAP_PARAM_CLASS = "Context parameter \'" + PARAM_NAME_EXCEPTION_TYPES_TO_UNWRAP + "\'" + " references a class which cannot be found in runtime classpath: \'%s\'";
