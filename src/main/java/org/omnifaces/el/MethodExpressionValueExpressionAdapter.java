...
public class MethodExpressionValueExpressionAdapter extends MethodExpression {
  ...
  private static final Set<Class<? extends Throwable>> EXCEPTIONS_TO_UNWRAP = unmodifiableSet(MethodNotFoundException.class, ConverterException.class, ValidatorException.class);
  ...
  @Override public Object invoke(ELContext context, Object[] params) {
    try {
  ...
  @Override public MethodInfo getMethodInfo(ELContext context) {
