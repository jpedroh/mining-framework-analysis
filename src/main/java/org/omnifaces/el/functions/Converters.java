...
public final class Converters {
  ...
  /**
	 ...
	 */
  public static <E extends java.lang.Object> List<E> setToList(Set<E> set) {
    if (set == null) {
      return null;
    }
  ...
  /**
	 ...
	 * @return The converted list.
	 */
  public static <K extends java.lang.Object, V extends java.lang.Object> List<Map.Entry<K, V>> mapToList(Map<K, V> map) {
    if (map == null) {
      return null;
    }
  ...
  /**
	 ...
	 * @since 1.5
	 */
  public static <E extends java.lang.Object> DataModel<E> iterableToModel(Iterable<E> iterable) {
    if (iterable == null) {
      return null;
    }
  ...
  /**
	 ...
	 * @since 1.3
	 */
  public static <E extends java.lang.Object> String joinCollection(Collection<E> collection, String separator) {
    if (collection == null) {
      return null;
    }
    StringBuilder builder = new StringBuilder();
  ...
  /**
	 ...
	 * @since 1.3
	 */
  public static <K extends java.lang.Object, V extends java.lang.Object> String joinMap(Map<K, V> map, String pairSeparator, String entrySeparator) {
    if (map == null) {
      return null;
    }
    StringBuilder builder = new StringBuilder();
  ...
  /**
	 ...
	 * @since 1.6
	 */
  public static <E extends java.lang.Object> List<List<E>> splitList(List<E> list, int fragmentSize) {
    if (isEmpty(list)) {
...
>>>>>>> /usr/src/app/output/omnifaces/omnifaces/54a7f76c73dc469f57484ebdcdf2203dc9f3a193/src/main/java/org/omnifaces/el/functions/Converters.java/right.java
    ((sourceSize + fragmentSize - 1) / fragmentSize);
