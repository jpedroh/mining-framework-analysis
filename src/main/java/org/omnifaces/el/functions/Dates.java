...
public final class Dates {
  private static final Map<Locale, Map<String, Integer>> MONTHS_CACHE = new 
<<<<<<< /usr/src/app/output/omnifaces/omnifaces/54a7f76c73dc469f57484ebdcdf2203dc9f3a193/src/main/java/org/omnifaces/el/functions/Dates.java/left.java
  ConcurrentHashMap<Locale, Map<String, Integer>>
=======
  ConcurrentHashMap<>
>>>>>>> /usr/src/app/output/omnifaces/omnifaces/54a7f76c73dc469f57484ebdcdf2203dc9f3a193/src/main/java/org/omnifaces/el/functions/Dates.java/right.java
  ...
  private static final Map<Locale, Map<String, Integer>> SHORT_MONTHS_CACHE = new 
<<<<<<< /usr/src/app/output/omnifaces/omnifaces/54a7f76c73dc469f57484ebdcdf2203dc9f3a193/src/main/java/org/omnifaces/el/functions/Dates.java/left.java
  ConcurrentHashMap<Locale, Map<String, Integer>>
=======
  ConcurrentHashMap<>
>>>>>>> /usr/src/app/output/omnifaces/omnifaces/54a7f76c73dc469f57484ebdcdf2203dc9f3a193/src/main/java/org/omnifaces/el/functions/Dates.java/right.java
  ...
  private static final Map<Locale, Map<String, Integer>> DAYS_OF_WEEK_CACHE = new 
<<<<<<< /usr/src/app/output/omnifaces/omnifaces/54a7f76c73dc469f57484ebdcdf2203dc9f3a193/src/main/java/org/omnifaces/el/functions/Dates.java/left.java
  ConcurrentHashMap<Locale, Map<String, Integer>>
=======
  ConcurrentHashMap<>
>>>>>>> /usr/src/app/output/omnifaces/omnifaces/54a7f76c73dc469f57484ebdcdf2203dc9f3a193/src/main/java/org/omnifaces/el/functions/Dates.java/right.java
  ...
  private static final Map<Locale, Map<String, Integer>> SHORT_DAYS_OF_WEEK_CACHE = new 
<<<<<<< /usr/src/app/output/omnifaces/omnifaces/54a7f76c73dc469f57484ebdcdf2203dc9f3a193/src/main/java/org/omnifaces/el/functions/Dates.java/left.java
  ConcurrentHashMap<Locale, Map<String, Integer>>
=======
  ConcurrentHashMap<>
>>>>>>> /usr/src/app/output/omnifaces/omnifaces/54a7f76c73dc469f57484ebdcdf2203dc9f3a193/src/main/java/org/omnifaces/el/functions/Dates.java/right.java
  ...
  public static String formatDateWithTimezone(Date date, String pattern, Object timezone) {
    return formatDate(date, pattern, (timezone instanceof TimeZone) ? ((TimeZone) timezone) : TimeZone.getTimeZone(String.valueOf(timezone)));
  }
  ...
  /**
	 ...
	 */
  private static <K extends java.lang.Object, V extends java.lang.Object> K getKey(Map<K, V> map, V value) {
    if (value == null) {
      return null;
    }
