...
public final class Strings {
  ...
  public static String capitalize(String string) {
    ...
    return new StringBuilder().append(Character.toTitleCase(string.charAt(0))).append(string.substring(1)).toString();
  }
  ...
  public static String prettyURL(String string) {
    ...
    return Normalizer.normalize(string.toLowerCase(), Form.NFD).replaceAll("\\p{InCombiningDiacriticalMarks}+", "").replaceAll("[^\\p{Alnum}]+", "-");
  }
