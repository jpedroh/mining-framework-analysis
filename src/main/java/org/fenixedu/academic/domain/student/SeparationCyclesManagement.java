...
@Deprecated public class SeparationCyclesManagement {
  ...
  protected Registration createNewSecondCycle(final StudentCurricularPlan oldStudentCurricularPlan) {
    ...
    final StudentCurricularPlan newStudentCurricularPlan = createStudentCurricularPlan(newRegistration, degreeCurricularPlan, oldSecondCycle.getCycleType());
  ...
  private void moveExtraAttends(final StudentCurricularPlan oldStudentCurricularPlan, final StudentCurricularPlan newStudentCurricularPlan) {
    ...
    for (final Attends attend : oldStudentCurricularPlan.getRegistration().getAssociatedAttendsSet()) {
      if (!belongsTo(oldStudentCurricularPlan, attend) && isToMoveAttendsFrom(oldStudentCurricularPlan, newStudentCurricularPlan, attend)) {
        attends.add(attend);
      }
    }
  ...
  private boolean isToMoveAttendsFrom(final StudentCurricularPlan oldStudentCurricularPlan, final StudentCurricularPlan newStudentCurricularPlan, final Attends attend) {
  ...
  private YearMonthDay getBeginDate(final StudentCurricularPlan sourceStudentCurricularPlan, final ExecutionSemester executionSemester) {
    ...
    return executionSemester.getBeginDateYearMonthDay().isBefore(stateDate) ? stateDate : executionSemester.getBeginDateYearMonthDay();
  }
  ...
  private StudentCurricularPlan createStudentCurricularPlan(final Registration registration, final DegreeCurricularPlan degreeCurricularPlan, CycleType cycleType) {
  ...
  private void copyCycleCurriculumGroupsInformation(final CycleCurriculumGroup oldSecondCycle, final CycleCurriculumGroup newSecondCycle) {
  ...
  private void createSubstitutionForEnrolment(final Enrolment enrolment, final CurriculumGroup parent) {
    ...
    if (enrolment.isOptional()) {
      ...
      createNewOptionalDismissal(substitution, parent, enrolment, optional.getOptionalCurricularCourse(), optional.getEctsCredits());
    } else {
  ...
  private OptionalDismissal createNewOptionalDismissal(final Credits credits, final CurriculumGroup parent, final CurriculumLine curriculumLine, final OptionalCurricularCourse curricularCourse, final Double ectsCredits) {
  ...
  private void createDismissal(final Dismissal dismissal, final CurriculumGroup parent) {
    ...
    if (dismissal.hasCurricularCourse()) {
      if (dismissal instanceof OptionalDismissal) {
        ...
        createNewOptionalDismissal(newCredits, parent, dismissal, optionalDismissal.getCurricularCourse(), optionalDismissal.getEctsCredits());
      } else {
  ...
  private void moveExtraCurriculumGroupInformation(final StudentCurricularPlan oldStudentCurricularPlan, final StudentCurricularPlan newStudentCurricularPlan) {
  ...
  private void markOldRegistrationWithConcludedState(final StudentCurricularPlan oldStudentCurricularPlan) {
    ...
    final RegistrationState state = RegistrationState.createRegistrationState(oldStudentCurricularPlan.getRegistration(), null, stateDate.toDateTimeAtStartOfDay(), RegistrationStateType.CONCLUDED);
    state.setResponsiblePerson(null);
  }

  private void moveGratuityEventsInformation(final StudentCurricularPlan oldStudentCurricularPlan, final StudentCurricularPlan newStudentCurricularPlan) {
    if (!oldStudentCurricularPlan.hasGratuityEvent(getExecutionYear(), GratuityEventWithPaymentPlan.class) || oldStudentCurricularPlan.
<<<<<<< /usr/src/app/output/fenixedu/fenixedu-academic/5b7496ed218ab8234f16d55853dd5af5f4dc86f9/src/main/java/org/fenixedu/academic/domain/student/SeparationCyclesManagement.java/left.java
    getGratuityEvent(getExecutionYear(), GratuityEventWithPaymentPlan.class).anyMatch(Event::isCancelled)
=======
    getGratuityEvent(getExecutionYear(), GratuityEventWithPaymentPlan.class).map(Event::isCancelled).orElse(false)
>>>>>>> /usr/src/app/output/fenixedu/fenixedu-academic/5b7496ed218ab8234f16d55853dd5af5f4dc86f9/src/main/java/org/fenixedu/academic/domain/student/SeparationCyclesManagement.java/right.java
    ...
    final GratuityEvent firstEvent = oldStudentCurricularPlan.
<<<<<<< /usr/src/app/output/fenixedu/fenixedu-academic/5b7496ed218ab8234f16d55853dd5af5f4dc86f9/src/main/java/org/fenixedu/academic/domain/student/SeparationCyclesManagement.java/left.java
    getGratuityEvent(getExecutionYear(), GratuityEventWithPaymentPlan.class).findAny().orElseThrow(UnsupportedOperationException::new)
=======
    getGratuityEvent(getExecutionYear(), GratuityEventWithPaymentPlan.class).orElseThrow(UnsupportedOperationException::new)
>>>>>>> /usr/src/app/output/fenixedu/fenixedu-academic/5b7496ed218ab8234f16d55853dd5af5f4dc86f9/src/main/java/org/fenixedu/academic/domain/student/SeparationCyclesManagement.java/right.java
    ;
    final GratuityEvent secondEvent = newStudentCurricularPlan.
<<<<<<< /usr/src/app/output/fenixedu/fenixedu-academic/5b7496ed218ab8234f16d55853dd5af5f4dc86f9/src/main/java/org/fenixedu/academic/domain/student/SeparationCyclesManagement.java/left.java
    getGratuityEvent(getExecutionYear(), GratuityEventWithPaymentPlan.class).findAny().orElseThrow(UnsupportedOperationException::new)
=======
    getGratuityEvent(getExecutionYear(), GratuityEventWithPaymentPlan.class).orElseThrow(UnsupportedOperationException::new)
>>>>>>> /usr/src/app/output/fenixedu/fenixedu-academic/5b7496ed218ab8234f16d55853dd5af5f4dc86f9/src/main/java/org/fenixedu/academic/domain/student/SeparationCyclesManagement.java/right.java
  ...
  private void createGratuityEvent(final StudentCurricularPlan newStudentCurricularPlan) {
    final InvocationResult result = new AccountingEventsManager().createGratuityEvent(newStudentCurricularPlan, getExecutionYear(), false);
    if (!result.isSuccess()) {
  ...
  private void correctRegistrationRegime(final StudentCurricularPlan oldStudentCurricularPlan, final StudentCurricularPlan newStudentCurricularPlan) {
    if (oldStudentCurricularPlan.getRegistration().isPartialRegime(getExecutionYear()) && !newStudentCurricularPlan.getRegistration().isPartialRegime(getExecutionYear())) {
      new RegistrationRegime(newStudentCurricularPlan.getRegistration(), getExecutionYear(), RegistrationRegimeType.PARTIAL_TIME);
    }
  }
  ...
  private void createAdministrativeOfficeFeeAndInsurance(final StudentCurricularPlan newStudentCurricularPlan) {
    if (!newStudentCurricularPlan.getPerson().hasAdministrativeOfficeFeeInsuranceEventFor(getExecutionYear()) && newStudentCurricularPlan.hasEnrolments(getExecutionYear())) {
      new AccountingEventsManager().createAdministrativeOfficeFeeAndInsuranceEvent(newStudentCurricularPlan, getExecutionYear(), false);
    }
  }
