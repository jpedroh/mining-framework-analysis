...
public class InitializePassword {
  ...
  private static final Map<String, String> ERRORS = new HashMap<String, String>() {
    {
      ...
      put("CIISTADMIN_KERBEROS_PASSWORD_NOT_ENOUGH_CHARACTER_CLASSES", "internationalRegistration.error.not.enough.character.classes");
  ...
  public static void run(User user, String password) throws PasswordInitializationException {
    ...
    final Response post = HTTP_CLIENT.target(FenixEduAcademicConfiguration.getConfiguration().getWebServicesInternationalRegistrationUrl()).request(MediaType.APPLICATION_JSON).header("Authorization", getServiceAuth()).post(Entity.form(form));
...
>>>>>>> /usr/src/app/output/fenixedu/fenixedu-academic/0ebb833b3f09a28a19b06f2f137a2cbbd6080b78/src/main/java/org/fenixedu/academic/service/services/person/InitializePassword.java/right.java
