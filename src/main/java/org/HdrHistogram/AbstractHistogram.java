...
public abstract class AbstractHistogram extends AbstractHistogramColdFields implements Serializable {
  ...
  int getBucketIndex(long value) {
    int pow2ceiling = 64 - Long.numberOfLeadingZeros(value | subBucketMask);
  ...
  public void add(final AbstractHistogram other) {
    if ((highestTrackableValue != other.highestTrackableValue) || (numberOfSignificantValueDigits != other.numberOfSignificantValueDigits) || (bucketCount != other.bucketCount) || (subBucketCount != other.subBucketCount)) {
  ...
  public boolean equals(Object other) {
    ...
    if ((highestTrackableValue != that.highestTrackableValue) || (numberOfSignificantValueDigits != that.numberOfSignificantValueDigits)) {
      return false;
    }
  ...
  public long sizeOfEquivalentValueRange(long value) {
    int bucketIndex = getBucketIndex(value);
    int subBucketIndex = getSubBucketIndex(value, bucketIndex);
    long distanceToNextValue = (1 << ((subBucketIndex >= subBucketCount) ? (bucketIndex + 1) : bucketIndex));
