...
public class MethodDescriptor {
  ...
  @Nullable public String getGlobalTable() {
  ...
  @Nullable public Sharding getShardingAnno() {
  ...
  public boolean isReturnGeneratedId() {
    return isAnnotationPresent(ReturnGeneratedId.class) || (name != null && name.contains("ReturnGeneratedId"));
  }
}