...
final class RemoteConnectionChannel extends AbstractHandleableCloseable<Channel> implements Channel {
  ...
  public <T extends java.lang.Object> T getOption(final Option<T> option) {
  ...
  public <T extends java.lang.Object> T setOption(final Option<T> option, final T value) throws IllegalArgumentException {
    return null;
  }
  ...
  @Override protected void closeAction() throws IOException {
    closeReadsAndWrites();
    closeMessages();
  }
  ...
  void dumpState(final StringBuilder b) {
    ...
    if (Bits.allAreSet(state, READ_CLOSED)) {
      b.append("read-closed ");
    }
    if (Bits.allAreSet(state, WRITE_CLOSED)) {
