            ...
            switch (protoId) {
              ...
              case Protocol.CHANNEL_OPEN_REQUEST:
              {
                ...
                try {
                  ...
                  if (!ok1) {
                    handler.handleInboundChannelClosed();
                  }
                }
              }
              ...
              case Protocol.APP_AUTH_REQUEST:
              {
                ...
                final int length = (buffer.get() - 1 & 0xff) + 1;
