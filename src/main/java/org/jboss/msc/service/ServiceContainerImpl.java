...
final class ServiceContainerImpl extends ServiceTargetImpl implements ServiceContainer {
  ...
  private final ServiceContainerMXBean containerMXBean = new ServiceContainerMXBean() {
    ...
    @Override public void dumpServicesByStatus(String status) {
    ...
    @Override public String dumpServicesToStringByStatus(String status) {
      Collection<ServiceStatus> services = this.queryServicesByStatus(status);
      ByteArrayOutputStream baos = new ByteArrayOutputStream();
      PrintStream ps = null;
      try {
  ...
  @Override public void addTerminateListener(final TerminateListener listener) {
  ...
  @Override public void awaitTermination(long timeout, TimeUnit unit) throws InterruptedException {
    final LatchListener listener = new LatchListener(1);
    addTerminateListener(listener);
    listener.await(timeout, unit);
  }

  @Override public void awaitStability() throws InterruptedException {
    awaitStability(null, null);
  }

  @Override public boolean awaitStability(final long timeout, final TimeUnit unit) throws InterruptedException {
    return awaitStability(timeout, unit, null, null);
  }

  @Override public void awaitStability(Set<? super ServiceController<?>> failed, Set<? super ServiceController<?>> problem) throws InterruptedException {
    synchronized (lock) {
  ...
  @Override public boolean awaitStability(final long timeout, final TimeUnit unit, Set<? super ServiceController<?>> failed, Set<? super ServiceController<?>> problem) throws InterruptedException {
  ...
  @Override public ServiceController<?> getRequiredService(final ServiceName serviceName) throws ServiceNotFoundException {
  ...
  @Override public ServiceController<?> getService(final ServiceName serviceName) {
  ...
  @Override <T extends java.lang.Object> ServiceController<T> install(final AbstractServiceBuilder<T> serviceBuilder) throws DuplicateServiceException {
  ...
  /**
     ...
     */
  private <T extends java.lang.Object> void detectCircularity(ServiceControllerImpl<T> instance) throws CircularDependencyException {
  ...
  final class ContainerExecutor implements ExecutorService {
    ...
    public <T extends java.lang.Object> Future<T> submit(final Callable<T> task) {
      return delegate.submit(task);
    }

    public <T extends java.lang.Object> Future<T> submit(final Runnable task, final T result) {
    ...
    public <T extends java.lang.Object> List<Future<T>> invokeAll(final Collection<? extends Callable<T>> tasks) throws InterruptedException {
      return delegate.invokeAll(tasks);
    }

    public <T extends java.lang.Object> List<Future<T>> invokeAll(final Collection<? extends Callable<T>> tasks, final long timeout, final TimeUnit unit) throws InterruptedException {
      return delegate.invokeAll(tasks, timeout, unit);
    }

    public <T extends java.lang.Object> T invokeAny(final Collection<? extends Callable<T>> tasks) throws InterruptedException, ExecutionException {
      return delegate.invokeAny(tasks);
    }

    public <T extends java.lang.Object> T invokeAny(final Collection<? extends Callable<T>> tasks, final long timeout, final TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException {
