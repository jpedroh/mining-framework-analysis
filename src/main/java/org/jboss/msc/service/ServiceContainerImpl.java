...
final class ServiceContainerImpl implements ServiceContainer {
  ...
  public <T extends java.lang.Object> ServiceBuilderImpl<T> buildService(final Value<? extends Service<? extends T>> service) {
    return buildService(null, service);
  }

  public <T extends java.lang.Object> ServiceBuilderImpl<T> buildService(final ServiceName serviceName, final Value<? extends Service<? extends T>> service) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private <T extends java.lang.Object> void doResolve(BatchServiceBuilderImpl<T> entry, final Map<ServiceName, BatchServiceBuilderImpl<?>> services) throws ServiceRegistryException {
    outer:
    while (entry != null) {
      ...
      while (entry.i < deps.length) {
        ...
        if (dependencyController == null) {
          ...
          if (dependencyEntry != null) {
            ...
            if (entry.isOptionalDependency(dependencyName)) {
