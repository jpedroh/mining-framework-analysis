 ...
 */
@SuppressWarnings(value = { "SameParameterValue" }) public class ModelNode implements Externalizable, Cloneable {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "DeprecatedIsStillUsed" }) @Deprecated public ModelNode setExpression(final String newValue) {
    if (newValue == null) {
  ...
  /**
     ...
     */
  @Deprecated public ModelNode setExpression(final String propertyName, final String propertyValue) {
    checkProtect();
    final ModelNode node = new ModelNode();
  ...
  /**
     ...
     */
  @Deprecated public ModelNode addExpression(final String newValue) {
  ...
  /**
     ...
     * @return the clone
     */
  @SuppressWarnings(value = { "MethodDoesntCallSuperMethod" }) @Override public ModelNode clone() {
  ...
  /**
     ...
     * @throws IOException if an I/O error occurs
     */
  @SuppressWarnings(value = { "unused" }) public void readExternal(final DataInputStream in) throws IOException {
    readExternal((DataInput) in);
  }
  ...
  /**
     ...
     * @throws IOException if an I/O error occurs
     */
  @SuppressWarnings(value = { "WeakerAccess" }) public void readExternal(final DataInput in) throws IOException {
    checkProtect();
    try {
