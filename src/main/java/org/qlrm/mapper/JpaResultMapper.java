...
public class JpaResultMapper extends ResultMapper {
  ...
  @SuppressWarnings(value = { "unchecked" }) public <T extends java.lang.Object> List<T> list(final Query q, final Class<T> clazz) throws IllegalArgumentException {
  ...
  public <T extends java.lang.Object> T uniqueResult(final Query q, final Class<T> clazz) {
