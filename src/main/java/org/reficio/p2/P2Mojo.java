...
@Mojo(name = "site", defaultPhase = LifecyclePhase.COMPILE, requiresDependencyResolution = ResolutionScope.RUNTIME, requiresDependencyCollection = ResolutionScope.RUNTIME) public class P2Mojo extends AbstractMojo implements Contextualizable {
  ...
  /**
     ...
     */
  @Parameter(defaultValue = "false") private boolean skipInvalidArtifacts;
...
<<<<<<< /usr/src/app/output/reficio/p2-maven-plugin/0593405310b31463850e71621111950b149d14f5/src/main/java/org/reficio/p2/P2Mojo.java/left.java
  /**
     * A list of definitions of eclipse features
     *
     */
  @Parameter(readonly = true) private List<P2FeatureDefinition> featureDefinitions;
=======
  /**
     ...
     */
  @Parameter(defaultValue = "false") private boolean skipNotExistingArtifacts;
>>>>>>> /usr/src/app/output/reficio/p2-maven-plugin/0593405310b31463850e71621111950b149d14f5/src/main/java/org/reficio/p2/P2Mojo.java/right.java
  ...
  /**
     ...
     */
  @Parameter(defaultValue = "true") private boolean reuseSnapshotVersionFromArtifact;
  ...
  /**
     ...
     */
  @Parameter(readonly = true) private List<P2Artifact> features;

  /**
     * A list of Eclipse artifacts that should be downloaded from P2 repositories
     */
  @Parameter(readonly = true) private List<EclipseArtifact> p2;
