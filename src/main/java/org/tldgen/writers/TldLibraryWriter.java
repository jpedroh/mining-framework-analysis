...
public class TldLibraryWriter extends AbstractWriter {
  ...
  /**
	 ...
	 */
  private void writeFunctions(Set<Function> functions) throws XMLStreamException {
  ...
  /**
	 ...
	 */
  private void writeListeners(Set<Listener> listeners) throws XMLStreamException {
