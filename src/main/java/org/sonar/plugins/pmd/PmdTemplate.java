...
public class PmdTemplate {
  ...
  private static final Map<String, String> JAVA_VERSIONS = 
<<<<<<< /usr/src/app/output/sonarcommunity/sonar-pmd/933775819973c32cc8a831ea756e9a6c7a10f113/src/main/java/org/sonar/plugins/pmd/PmdTemplate.java/left.java
  ImmutableMap.<String, String>builder().put("1.1", "1.3").put("1.2", "1.3").put("5", "1.5").put("6", "1.6").put("7", "1.7").put("8", "1.8").put("9", "9").put("10", "10").put("11", "11").build()
=======
  prepareVersions()
