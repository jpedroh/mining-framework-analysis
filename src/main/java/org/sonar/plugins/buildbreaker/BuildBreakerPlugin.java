...
false
>>>>>>>
 ) } ) public class BuildBreakerPlugin  extends SonarPlugin  {   public static final String  SKIP_KEY = "sonar.buildbreaker.skip" ;   public static final String  QUERY_MAX_ATTEMPTS_KEY = "sonar.buildbreaker.queryMaxAttempts" ;   public static final String  QUERY_INTERVAL_KEY = "sonar.buildbreaker.queryInterval" ;   public static final String  TOTAL_WAIT_TIME_DESCRIPTION =     "Total wait time is <code>" +  BuildBreakerPlugin . QUERY_MAX_ATTEMPTS_KEY + " * " +  BuildBreakerPlugin . QUERY_INTERVAL_KEY + "</code>." ;   public static final String  BUILD_BREAKER_LOG_STAMP = "[BUILD BREAKER] " ;   public static final String  FORBIDDEN_CONF_KEY = "sonar.buildbreaker.forbiddenConf" ;   public static final String  FAIL_FOR_ISSUES_WITH_SEVERITY_KEY = "sonar.buildbreaker.preview.failForIssuesWithSeverity" ;   public static final String  FAIL_FOR_ISSUES_DISABLED = "DISABLED" ;    @ Override public List getExtensions  ( )  {  return  Arrays . asList  (  ForbiddenConfigurationBreaker . class ,  QualityGateBreaker . class ,  BasicIssuesBuildBreaker . class ) ; }   public static final String  ALTERNATIVE_SERVER_URL_KEY = "sonar.buildbreaker.alternativeServerUrl" ; }