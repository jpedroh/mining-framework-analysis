...
public class URLTrigger extends AbstractTrigger {
  ...
  @DataBoundConstructor public URLTrigger(String cronTabSpec, String triggerLabel) throws ANTLRException {
  ...
  @SuppressWarnings(value = { "unused" }) public List<URLTriggerEntry> getEntries() {
    return entries;
  }
  ...
  @SuppressWarnings(value = { "unused" }) public boolean isLabelRestriction() {
  ...
  public final class InternalURLTriggerAction extends URLTriggerAction {
    ...
    @SuppressWarnings(value = { "unused" }) public BuildableItem getOwner() {
      return job;
    }

    @SuppressWarnings(value = { "unused" }) public String getLabel() {
      return label;
    }
    ...
    @SuppressWarnings(value = { "unused" }) public String getLog() throws IOException {
      return Util.loadFile(getLogFile());
    }

    @SuppressWarnings(value = { "unused" }) public Map<String, String> getSubActionTitle() {
      return subActionTitle;
    }

    @SuppressWarnings(value = { "unused" }) @SuppressFBWarnings(value = "RV_RETURN_VALUE_IGNORED") public void writeLogTo(XMLOutput out) throws IOException {
  ...
  @Override protected boolean checkIfModified(Node pollingNode, XTriggerLog log) throws XTriggerException {
  ...
  private boolean isServiceUnavailableAndNotExpected(Response clientResponse, URLTriggerEntry entry) {
    return HttpServletResponse.SC_SERVICE_UNAVAILABLE == clientResponse.getStatus() && entry.getStatusCode() != HttpServletResponse.SC_SERVICE_UNAVAILABLE;
  }

  private boolean isURLNotFoundAndNotExpected(Response clientResponse, URLTriggerEntry entry) {
    return HttpServletResponse.SC_NOT_FOUND == clientResponse.getStatus() && entry.getStatusCode() != HttpServletResponse.SC_NOT_FOUND;
  }
  ...
  @Override protected XTriggerCause getBuildCause() {
  ...
  private HostnameVerifier getHostnameVerifier() {
    return new HostnameVerifier() {
      @Override public boolean verify(String hostname, javax.net.ssl.SSLSession sslSession) {
        return true;
      }
    };
  }
  ...
  private SSLContext getSSLContext() throws XTriggerException {
    javax.net.ssl.TrustManager x509 = new javax.net.ssl.X509TrustManager() {
      @Override public void checkClientTrusted(java.security.cert.X509Certificate[] arg0, String arg1) throws java.security.cert.CertificateException {
      }

      @Override public void checkServerTrusted(java.security.cert.X509Certificate[] arg0, String arg1) throws java.security.cert.CertificateException {
      }
  ...
  @Override protected Action[] getScheduledActions(Node node, XTriggerLog log) {
    return new Action[0];
  }

  @Override protected boolean requiresWorkspaceForPolling() {
    return false;
  }

  @Override public URLTriggerDescriptor getDescriptor() {
  ...
  @Symbol(value = "URLTrigger") @Extension public static class URLTriggerDescriptor extends XTriggerDescriptor {
    ...
    @Override public URLTrigger newInstance(StaplerRequest req, JSONObject formData) throws FormException {
    ...
    private URLTriggerEntry fillAndGetEntry(StaplerRequest req, JSONObject entryObject) {
      ...
      urlTriggerEntry.setTimeout(5 * 60);
