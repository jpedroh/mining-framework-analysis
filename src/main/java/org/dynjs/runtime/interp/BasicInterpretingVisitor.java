...
public class BasicInterpretingVisitor implements InterpretingVisitor {
  ...
  @Override public void visit(ExecutionContext context, AdditiveExpression expr, boolean strict) {
...
<<<<<<< /usr/src/app/output/dynjs/dynjs/a98c081265982db02dec1543679620aae7783b47/src/main/java/org/dynjs/runtime/interp/BasicInterpretingVisitor.java/left.java
  FloatingNumberExpression
=======
  OfOperatorExpression
>>>>>>> /usr/src/app/output/dynjs/dynjs/a98c081265982db02dec1543679620aae7783b47/src/main/java/org/dynjs/runtime/interp/BasicInterpretingVisitor.java/right.java
   expr, boolean strict) {
    expr.getLhs().accept(context, this, strict);
    Object lhs = getValue(context, pop());
    expr.getRhs().accept(context, this, strict);
...
<<<<<<< /usr/src/app/output/dynjs/dynjs/a98c081265982db02dec1543679620aae7783b47/src/main/java/org/dynjs/runtime/interp/BasicInterpretingVisitor.java/left.java
    expr.getValue()
=======
    ((JSObject) rhs).hasProperty(context, Types.toString(context, lhs))
>>>>>>> /usr/src/app/output/dynjs/dynjs/a98c081265982db02dec1543679620aae7783b47/src/main/java/org/dynjs/runtime/interp/BasicInterpretingVisitor.java/right.java
    );
  }
  ...
  @Override public void visit(ExecutionContext context, 
<<<<<<< /usr/src/app/output/dynjs/dynjs/a98c081265982db02dec1543679620aae7783b47/src/main/java/org/dynjs/runtime/interp/BasicInterpretingVisitor.java/left.java
  IntegerNumberExpression expr
=======
  ForExprOfStatement statement
>>>>>>> /usr/src/app/output/dynjs/dynjs/a98c081265982db02dec1543679620aae7783b47/src/main/java/org/dynjs/runtime/interp/BasicInterpretingVisitor.java/right.java
  , boolean strict) {
    statement.getRhs().accept(context, this, strict);
    Object exprRef = pop();
...
>>>>>>> /usr/src/app/output/dynjs/dynjs/a98c081265982db02dec1543679620aae7783b47/src/main/java/org/dynjs/runtime/interp/BasicInterpretingVisitor.java/right.java
  ...
  @Override public void visit(ExecutionContext context, ForVarDeclOfStatement statement, boolean strict) {
    statement.getDeclaration().accept(context, this, strict);
    String varName = (String) pop();
    statement.getRhs().accept(context, this, strict);
    Object exprRef = pop();
  ...
  @Override public void visit(ExecutionContext context, PropertyGet propertyGet, boolean strict) {
    JSFunction compiledFn = context.getCompiler().compileFunction(context, null, new String[] {  }, propertyGet.getBlock(), strict);
    push(compiledFn);
  }
