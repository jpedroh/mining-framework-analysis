 ...
 * Time: 10:59
 */
@Repository public class ClientRepositoryImpl implements ClientRepository {
  @Override public void saveOrUpdateClient(Client client) {
  ...
  @Override public List<Client> getClientsByName(String clientName) {
    Session session = null;
  ...
  @Override public void deleteClientsWithoutOrders(int minutes) {
    Session session = null;
    Date date = new Date();
  ...
  @Override public void deleteClient(Client client) {
