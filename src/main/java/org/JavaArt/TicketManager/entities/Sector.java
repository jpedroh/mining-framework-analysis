...
@Entity @Table(name = "sector") public class Sector implements Comparable, Serializable {
  ...
  @JoinColumn(name = "operator_id") @ManyToOne Operator operator;

  @Column(name = "MaxRows") private int maxRows;

  @Column(name = "MaxSeats") private int maxSeats;
  ...
  @Override @NotNull public int compareTo(Object o) {
    Sector sector = (Sector) o;
    return id - sector.id;
  }
}