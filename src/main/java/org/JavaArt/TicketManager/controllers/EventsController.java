...
@Controller @SessionAttributes(value = { "pageName", "events", "event", "sector", "sectors" }) public class EventsController {
  ...
  @RequestMapping(value = "NewEvent/NewEvent.do", method = RequestMethod.GET) public String newEventGet(Model model) {
    model.addAttribute("pageName", 7);
    return "NewEvent";
  }

  @RequestMapping(value = "Events/setDelete.do", method = RequestMethod.POST) public String eventsSetDelete(@RequestParam(value = "evnt", required = true) int evnt, Model model, SessionStatus status) {
  ...
  @RequestMapping(value = "Events/Redirect.do", method = RequestMethod.POST) public String eventsRedirect(Model model, SessionStatus status) {
    return "redirect:/NewEvent/NewEvent.do";
  }

  @RequestMapping(value = "NewEvent/addEvent.do", method = RequestMethod.POST) public String bookingAddEvent(@RequestParam(value = "dateEvent", required = true) String dateEvent, String inputTime, String description, String timeRemoveBooking, SessionStatus status, HttpServletRequest request) throws SQLException, ParseException {
    if (description == null) {
      return "redirect:/NewEvent/NewEvent.do";
    }
  ...
  @RequestMapping(value = "Events/Edit.do", method = RequestMethod.POST) public String eventsEdit(@RequestParam(value = "evnt") int evnt, Model model, SessionStatus status, HttpServletRequest request) {
    this.editEvent = eventService.getEventById(evnt);
    return "redirect:/EditEvent/EditEvent.do";
  }

  @RequestMapping(value = "EditEvent/EditEvent.do", method = RequestMethod.GET) public String editEventGet(Model model, SessionStatus statusEvent) throws 
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @RequestMapping(value = "EditEvent/editEventNow.do", method = RequestMethod.POST) public String editEvent(@RequestParam(value = "dateEvent", required = true) String dateEvent, String inputTime, int eventEditHidden, String description, String timeRemoveBooking, SessionStatus status, HttpServletRequest request) throws SQLException, ParseException {
    if (description == null) {
      return "redirect:/EditEvent/EditEvent.do";
    }
