...
public class ManagerConnectionImpl implements ManagerConnection, Dispatcher {
    ...
    while (attempts++ < MAX_VERSION_ATTEMPTS) {
      ...
      if (showVersionFilesResult != null && showVersionFilesResult.size() > 0) {
        ...
        if (line1.startsWith("File")) {
          ...
          if (line1 != null && line1.contains("No such command")) {
  ...
  private void setProtocolIdentifier(final String identifier) {
    ...
    if (!"Asterisk Call Manager/1.0".equals(identifier) && !"Asterisk Call Manager/1.1".equals(identifier) && !"Asterisk Call Manager/1.2".equals(identifier) && !"Asterisk Call Manager/1.3".equals(identifier) && !"OpenPBX Call Manager/1.0".equals(identifier) && !"CallWeaver Call Manager/1.0".equals(identifier) && !(identifier != null && identifier.startsWith("Asterisk Call Manager Proxy/"))) {
