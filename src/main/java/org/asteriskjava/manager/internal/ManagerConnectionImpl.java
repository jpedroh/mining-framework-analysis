...
<<<<<<< /usr/src/app/output/srt/asterisk-java/d78b6f9d5d466bf8d509b4ff2eaf96d33eaf4fdc/src/main/java/org/asteriskjava/manager/internal/ManagerConnectionImpl.java/left.java
...
||||||| /usr/src/app/output/srt/asterisk-java/d78b6f9d5d466bf8d509b4ff2eaf96d33eaf4fdc/src/main/java/org/asteriskjava/manager/internal/ManagerConnectionImpl.java/base.java
            // increase timeout as output is quite large
            showVersionFilesResponse = sendAction(new CommandAction("show version files pbx.c"), defaultResponseTimeout * 2);
            if (!(showVersionFilesResponse instanceof CommandResponse))
            {
...
>>>>>>> /usr/src/app/output/srt/asterisk-java/d78b6f9d5d466bf8d509b4ff2eaf96d33eaf4fdc/src/main/java/org/asteriskjava/manager/internal/ManagerConnectionImpl.java/right.java
...
=======
    				if (coreShowVersionResponse != null && coreShowVersionResponse instanceof CommandResponse)
    				{
    					final List<String> coreShowVersionResult = ((CommandResponse) coreShowVersionResponse)
    							.getResult();
...
=======
    	{
    		...
    		// Note: The response handler should has already been removed
    		// when the response was received, however we remove it here
    		// just in case it was never received.
    		synchronized (this.responseListeners)
    		{
...
>>>>>>> /usr/src/app/output/srt/asterisk-java/d78b6f9d5d466bf8d509b4ff2eaf96d33eaf4fdc/src/main/java/org/asteriskjava/manager/internal/ManagerConnectionImpl.java/right.java
	 ...
	 *             if username or password are incorrect and the login action
	 *             returns an error or if the MD5 hash cannot be computed. The
	 *             connection is closed in this case.
	 * @throws TimeoutException
	 *             if a timeout occurs while waiting for the protocol
	 *             identifier. The connection is closed in this case.
	 */
	/**
	 * Creates a new unique internal action id based on the hash code of this
	 * connection and a sequence.
