    ...
    while (attempts++ < MAX_VERSION_ATTEMPTS) {
      ...
      if (showVersionFilesResult != null && showVersionFilesResult.size() > 0) {
        ...
        if (line1.startsWith("File")) {
          ...
          if (line1.contains("No such command")) {
...
=======
                    if (coreLine != null && coreLine.startsWith("Asterisk 11")) {
                      return AsteriskVersion.ASTERISK_11;
                    }
>>>>>>> /usr/src/app/output/srt/asterisk-java/2131fda1860f47da7d05dd3d494922e7d90b2ab3/src/main/java/org/asteriskjava/manager/internal/ManagerConnectionImpl.java/right.java
  ...
  public void sendAction(ManagerAction action, SendActionCallback callback) throws IOException, IllegalArgumentException, IllegalStateException {
    ...
    if ((state == CONNECTING || state == RECONNECTING) && (action instanceof ChallengeAction || action instanceof LoginAction || isShowVersionCommandAction(action))) {
    } else {
      if (state == DISCONNECTING && action instanceof LogoffAction) {
      } else {
        if (state != CONNECTED) {
  ...
  private void setProtocolIdentifier(final String identifier) {
    ...
    if (!"Asterisk Call Manager/1.0".equals(identifier) && !"Asterisk Call Manager/1.1".equals(identifier) && !"Asterisk Call Manager/1.2".equals(identifier) && !"Asterisk Call Manager/1.3".equals(identifier) && !"Asterisk Call Manager/2.6.0".equals(identifier) && !"OpenPBX Call Manager/1.0".equals(identifier) && !"CallWeaver Call Manager/1.0".equals(identifier) && !(identifier != null && identifier.startsWith("Asterisk Call Manager Proxy/"))) {
