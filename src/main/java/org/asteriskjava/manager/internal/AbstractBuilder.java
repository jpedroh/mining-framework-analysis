...
abstract class AbstractBuilder {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected void setAttributes(Object target, Map<String, Object> attributes, Set<String> ignoredAttributes) {
    ...
    for (Map.Entry<String, Object> entry : attributes.entrySet()) {
      ...
      if (dataType == Boolean.class) {
        ...
        if (dataType.isAssignableFrom(String.class)) {
          ...
          if (dataType.isAssignableFrom(Map.class)) {
