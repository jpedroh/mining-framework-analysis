 ...
 */
@SuppressWarnings(value = { "WeakerAccess", "UnusedReturnValue", "unused" }) public class DelegateExecutionFake extends DelegateFake<DelegateExecutionFake> implements DelegateExecution {
  ...
  @Override public String getProcessBusinessKey() {
    return processBusinessKey;
  }

  @Override public void setProcessBusinessKey(String processBusinessKey) {
  ...
  @Override public String getCurrentActivityId() {
  ...
  @Override public String getCurrentActivityName() {
  ...
  @Override public String getActivityInstanceId() {
  ...
  @Override public String getParentActivityInstanceId() {
  ...
  @Override public String getCurrentTransitionId() {
  ...
  @Override public DelegateExecution getProcessInstance() {
  ...
  @Override public DelegateExecution getSuperExecution() {
  ...
  @Override public void setVariable(final String variableName, final Object value, final String activityId) {
    setVariable(variableName, value);
  }

  @Override public Incident createIncident(final String incidentType, final String configuration) {
    return createIncident(incidentType, configuration, null);
  }

  @Override public Incident createIncident(final String incidentType, final String configuration, final String message) {
  ...
  @Override public void resolveIncident(final String incidentId) {
  ...
  @Override public String getBusinessKey() {
    return businessKey;
  }
  ...
  @Override public BpmnModelInstance getBpmnModelInstance() {
    throw new UnsupportedOperationException("not implemented");
  }

  @Override public FlowElement getBpmnModelElementInstance() {
    throw new UnsupportedOperationException("not implemented");
  }
