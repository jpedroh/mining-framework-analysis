...
public class ElementDecorator implements FieldDecorator {
  ...
  @Override public Object decorate(ClassLoader loader, Field field) {
  ...
  /**
     ...
     */
  protected <T extends java.lang.Object> T proxyForLocator(ClassLoader loader, Class<T> interfaceType, ElementLocator locator) {
    InvocationHandler handler = new ElementHandler(interfaceType, locator);
    T proxy;
    proxy = interfaceType.cast(Proxy.newProxyInstance(loader, new Class[] { interfaceType, WebElement.class, WrapsElement.class, Locatable.class }, handler));
    return proxy;
  }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) protected <T extends java.lang.Object> List<T> proxyForListLocator(ClassLoader loader, Class<T> interfaceType, ElementLocator locator) {
