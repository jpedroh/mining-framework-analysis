...
public abstract class AbstractWxApi2 implements WxApi2 {
  ...
  @Override public WxAccessTokenStore getAccessTokenStore() {
    return accessTokenStore;
  }

  @Override public void setAccessTokenStore(WxAccessTokenStore ats) {
    this.accessTokenStore = ats;
  }

  @Override public WxJsapiTicketStore getJsapiTicketStore() {
    return jsapiTicketStore;
  }

  @Override public void setJsapiTicketStore(WxJsapiTicketStore jsapiTicketStore) {
  ...
  @Override public WxInMsg parse(HttpServletRequest req) {
    InputStream in;
    try {
    ...
    try {
      ...
      String str = pc.decryptMsg(msg_signature, timestamp, nonce, new String(Streams.readBytesAndClose(in), Encoding.CHARSET_UTF8));
  ...
  @Override public void handle(HttpServletRequest req, HttpServletResponse resp, WxHandler handler) {
    try {
  ...
  @Override public NutMap genJsSDKConfig(String url, String... jsApiList) {
