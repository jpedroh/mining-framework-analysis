...
public class HectorPersistenceFactory extends AbstractPersistenceFactory {
  ...
  /**
     ...
     */
  @Override public void deleteColumns(String colFamily, String key, String... columns) {
  ...
  /**
     ...
     * @return the entity
     */
  public <T extends java.lang.Object> T get(Class<T> entityClass, String key) {
    if (log.isDebugEnabled()) {
      log.debug(String.format("get (start): %s, %s", entityClass, key));
    }
    ...
    if (log.isDebugEnabled()) {
      log.debug(String.format("get (end): %s", result));
    }
    return result;
  }
  ...
  /**
     ...
     */
  @Override public Map<String, ByteBuffer> getColumns(String columnFamily, String key, boolean reversed, String... columns) {
    return getColumns(Query.get(select(reversed ? reversed() : null, columns(columns), from(columnFamily), where(key(key)))).getQuery());
  }
  ...
  /**
     ...
     * @return a map of columns and their values
     */
  @Override public Map<String, ByteBuffer> getColumns(String columnFamily, String key, int limit, boolean reversed, String fromColumn, String toColumn) {
    return getColumns(Query.get(select(reversed ? reversed() : null, first(limit), columnRange(fromColumn, toColumn), from(columnFamily), where(key(key)))).getQuery());
  }
  ...
  /**
     ...
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public <T extends java.lang.Object> List<T> getResultList(Class<T> type, Query query) {
    if (log.isDebugEnabled()) {
      log.debug(String.format("getResultList (start): %s", query.getQuery()));
    }
    ...
    if (log.isDebugEnabled()) {
      log.debug(String.format("getResultList (end): %s", result.size()));
    }
    return result;
  }
  ...
  /**
     ...
     */
  @Override public <T extends java.lang.Object> T getSingleResult(Class<T> type, Query query) {
  ...
  /**
     ...
     */
  @Override public void insertColumns(String colFamily, String key, Map<String, Object> keyValuePairs) {
    Keyspace keyspace = HFactory.createKeyspace(getDefaultKeySpace(), cluster);
  ...
  /**
     ...
     * @return the result
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public <T extends java.lang.Object> T executeQuery(Class<T> expectedResult, Query query) {
  ...
  /**
     ...
     * @return the CqlQuery
     */
  protected <T extends java.lang.Object, V extends java.lang.Object> CqlExecuteQuery<V> getCQLExecuteQuery(String query) {
  ...
  /**
     ...
     * @return a CqlQuery
     */
  protected <T extends java.lang.Object, V extends java.lang.Object> CqlQuery<String, String, V> getCQLQuery(Class<T> type, String query) {
  ...
  /**
     ...
     */
  @Override protected <T extends java.lang.Object> void loadLazyPropertyIfNecessary(ClassMetadata<T> metadata, Object self, Method proceed, Method m, Object[] args) throws Exception {
    ...
    if (key != null) {
      ...
      if (mappedColumnValue != null && isEmptyContainerValue(value)) {
  ...
  /**
     ...
     */
  private <V extends java.lang.Object> SliceQuery<String, String, V> getSliceQuery(ClassMetadata<?> classMetadata) {
  ...
  private void update(Mutator<String> mutator, String key, Object entity, String property, Object value) throws InvocationTargetException, NoSuchMethodException, IllegalAccessException, IOException {
    ...
    if (!metadata.getKeyProperty().equals(property)) {
  ...
  protected void updateSimpleColumn(Mutator<String> mutator, String key, ClassMetadata metadata, String property, Object value, Object entity) throws InvocationTargetException, NoSuchMethodException, IllegalAccessException, IOException {
    ...
    if (!metadata.isAssociationContainer(property)) {
      if (value == null) {
        if (!metadata.isContainer(property)) {
          fireColumnEvent(Event.Column.PRE_COLUMN_DELETION, entity, property, key, colFamily, null);
          mutator.addDeletion(key, colFamily, property, StringSerializer.get());
          log.debug(String.format("\tD: %s", property));
          fireColumnEvent(Event.Column.POST_COLUMN_DELETION, entity, property, key, colFamily, null);
        ...
        if (metadata.isCounterIncreaseProperty(property)) {
          ...
          if (!metadata.isCounterProperty(property)) {
            HColumn<String, Object> column = createColumn(property, value, StringSerializer.get(), new TypeConverterSerializer<Object>(value));
  ...
  /**
     ...
     */
  private <T extends java.lang.Object> T serializeColumns(String key, ClassMetadata<?> metadata, Class<T> entityClass, List<HColumn<String, Object>> columns, T instance, boolean ignoreLazyFlags) throws Exception {
  ...
  protected void serializeColumn(ClassMetadata<?> metadata, Object instance, String name, HColumn<String, Object> column, boolean ignoreLazyFlags) throws Exception {
    if (!name.equals(CLASS_PROPERTY) && metadata.getSelectionProperties().contains(name)) {
  ...
  public final class TypeConverterSerializer<Type extends java.lang.Object> extends AbstractSerializer<Type> {
    /**
         * The target class
         */
    ...
    /**
         ...
         */
    @Override @SuppressWarnings(value = { "unchecked" }) public Type fromByteBuffer(ByteBuffer byteBuffer) {
      try {
