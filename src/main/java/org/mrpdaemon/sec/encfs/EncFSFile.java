...
public class EncFSFile {
  ...
  /**
	 ...
	 */
  public EncFSFile(EncFSVolume volume, String volumePath, File file) throws EncFSCorruptDataException, EncFSChecksumException {
    this.file = file;
    this.volume = volume;
    this.volumePath = volumePath;
    if (file.getName().equals(EncFSVolume.ENCFS_VOLUME_CONFIG_FILE_NAME) || file.getName().equals(".") || file.getName().equals("..") || volume.getRootDir() == null) {
  ...
  /**
	 ...
	 *             Checksum error during name decoding
	 */
  public EncFSFile(EncFSVolume volume, String volumePath, String filePath) throws EncFSCorruptDataException, EncFSChecksumException {
  ...
  public EncFSFile[] listFiles() throws EncFSCorruptDataException, EncFSChecksumException {
    ...
    File[] files = file.listFiles(new FileFilter() {
      public boolean accept(File entry) {
        boolean result;
        if (volumePath.equals(EncFSVolume.ENCFS_VOLUME_ROOT_PATH) && entry.getName().equals(volume.getConfigFileName())) {
          result = false;
        } else {
          try {
