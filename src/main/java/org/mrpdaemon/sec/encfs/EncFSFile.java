...
public class EncFSFile {
	...
	private static final long HEADER_SIZE = 8; // 64 bit initialization vector.. // Volume path of this file private final String volumePath; // Volume hosting this file private final EncFSVolume volume; // Underlying File object ('this' doesn't extend File) private final File file; // Cached plaintext name of the represented file private String plaintextName; /**
