...
>>>>>>> /usr/src/app/output/esapi/esapi-java-legacy/12a5696c9cff9dd655b5d89e1635417dd6985f09/src/main/java/org/owasp/esapi/waf/configuration/AppGuardianConfiguration.java/right.java
...
>>>>>>> /usr/src/app/output/esapi/esapi-java-legacy/12a5696c9cff9dd655b5d89e1635417dd6985f09/src/main/java/org/owasp/esapi/waf/configuration/AppGuardianConfiguration.java/right.java
  ...
  public String toString() {
    ...
    for (Rule rule : beforeBodyRules) {
      sb.append("  " + rule.toString() + "\n");
    }
    sb.append("After body rules:\n");
    for (Rule rule : afterBodyRules) {
      sb.append("  " + rule.toString() + "\n");
    }
    sb.append("Before response rules:\n");
    for (Rule rule : beforeResponseRules) {
      sb.append("  " + rule.toString() + "\n");
    }
    sb.append("Cookie rules:\n");
    for (Rule rule : cookieRules) {
      sb.append("  " + rule.toString() + "\n");
    }
    return sb.toString();
  }
