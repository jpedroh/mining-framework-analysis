...
public abstract class AbstractVector implements Vector {
  ...
  @Override public Vector add(Vector that) {
    return add(that, factory);
  }

  @Override public Vector add(Vector that, Factory factory) {
    ensureFactoryIsNotNull(factory);
  ...
  @Override public void addInPlace(Vector that) {
    ensureArgumentIsNotNull(that, "vector");
    ensureVectorIsSimilar(that);
  ...
  @Override public Vector hadamardProduct(Vector that) {
    return hadamardProduct(that, factory);
  }

  @Override public Vector hadamardProduct(Vector that, Factory factory) {
    ensureFactoryIsNotNull(factory);
    ensureArgumentIsNotNull(that, "vector");
    ensureVectorIsSimilar(that);
  ...
  @Override public void hadamardProductInPlace(Vector that) {
    ensureArgumentIsNotNull(that, "vector");
    ensureVectorIsSimilar(that);
  ...
  @Override public Vector subtract(Vector that) {
    return subtract(that, factory);
  }

  @Override public Vector subtract(Vector that, Factory factory) {
    ensureFactoryIsNotNull(factory);
    ensureArgumentIsNotNull(that, "vector");
    ensureVectorIsSimilar(that);
  ...
  @Override public void subtractInPlace(Vector that) {
    ensureArgumentIsNotNull(that, "vector");
    ensureVectorIsSimilar(that);
  ...
  @Override public double innerProduct(Vector that) {
    ensureArgumentIsNotNull(that, "vector");
    ensureVectorIsSimilar(that);
    return pipeTo(VectorOperations.ooPlaceInnerProduct(), that);
  }

  @Override public Matrix outerProduct(Vector that) {
    return outerProduct(that, factory);
  }

  @Override public Matrix outerProduct(Vector that, Factory factory) {
    ensureFactoryIsNotNull(factory);
    ensureArgumentIsNotNull(that, "vector");
  ...
  @Override public Vector normalize(VectorAccumulator acc) {
  ...
  @Override public boolean equals(Vector vector, double precision) {
