...
public abstract class SparseVector extends AbstractVector {
  ...
  @Override public VectorIterator burningIterator() {
  ...
  @Override public <T extends java.lang.Object> T pipeTo(VectorOperation<T> operation) {
    return operation.apply(this);
  }

  @Override public <T extends java.lang.Object> T pipeTo(VectorVectorOperation<T> operation, Vector that) {
