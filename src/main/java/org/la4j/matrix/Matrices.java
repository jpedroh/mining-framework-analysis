...
public final class Matrices {
  ...
  private static class DiagonalMatrixPredicate implements MatrixPredicate {
    @Override public boolean test(int i, int j, double value) {
  ...
  private static class SymmetricMatrixPredicate implements AdvancedMatrixPredicate {
    ...
    @Override public boolean test(int rows, int columns) {
      if (rows != columns) {
        return false;
      } else {
        size = rows;
    ...
    @Override public boolean test(int i, int j, double value) {
      ...
      if (Double.isNaN(values[offset])) {
        ...
        return (value == values[offset]) ? true : diff < EPS ? true : diff / Math.max(Math.abs(value), Math.abs(values[offset])) < EPS;
      }
    }
  }

  private static class IncMatrixFunction implements MatrixFunction {
    @Override public double evaluate(int i, int j, double value) {
      return value + 1.0;
    }
  }
  ...
  private static class SumMatrixAccumulator implements MatrixAccumulator {
    ...
    @Override public void update(int i, int j, double value) {
      result = result.add(new BigDecimal(value));
    }

    @Override public double accumulate() {
  ...
  /**
     ...
     * matrix</a>.
     */
  public final static MatrixPredicate DIAGONAL_MATRIX = new DiagonalMatrixPredicate();
  ...
  /**
     ...
     * matrix</a>.
     */
  public final static MatrixPredicate IDENTITY_MATRIX = new IdentityMatrixPredicate();
  ...
  /**
     ...
     * matrix</a>.
     */
  public final static MatrixPredicate ZERO_MATRIX = new ZeroMatrixPredicate();
  ...
  /**
     ...
     * matrix</a>.
     */
  public final static MatrixPredicate TRIDIAGONAL_MATRIX = new TridiagonalMatrixPredicate();
  ...
  /**
     ...
     * matrix</a>.
     */
  public final static MatrixPredicate POSITIVE_MATRIX = new PositiveMatrixPredicate();
  ...
  /**
     ...
     * matrix</a>.
     */
  public final static MatrixPredicate NEGATIVE_MATRIX = new NegativeMatrixPredicate();

  /**
     * Checks whether the matrix is a lower bidiagonal matrix</a>.
     */
  public final static MatrixPredicate LOWER_BIDIAGONAL_MATRIX = new LowerBidiagonalMatrixPredicate();

  /**
     * Checks whether the matrix is an upper bidiagonal matrix. 
     */
  public final static MatrixPredicate UPPER_BIDIAGONAL_MATRIX = new UpperBidiagonalMatrixPredicate();
  ...
  /**
     ...
     * triangular matrix</a>.
     */
  public final static MatrixPredicate LOWER_TRIANGULAR_MARTIX = new LowerTriangularMatrixPredicate();
  ...
  /**
     ...
     * triangular matrix</a>.
     */
  public final static MatrixPredicate UPPER_TRIANGULAR_MATRIX = new UpperTriangularMatrixPredicate();
  ...
  /**
     ...
     * matrix</a>. 
     */
  public final static MatrixPredicate SYMMETRIC_MATRIX = new SymmetricMatrixPredicate();

  /**
     * Increases each element of matrix by <code>1</code>.
     */
  public final static MatrixFunction INC_FUNCTION = new IncMatrixFunction();

  /**
     * Decreases each element of matrix by <code>1</code>.
     */
  public final static MatrixFunction DEC_FUNCTION = new DecMatrixFunction();

  /**
     * Inverts each element of matrix.  
     */
  public final static MatrixFunction INV_FUNCTION = new InvMatrixFunction();
  ...
  /**
     ...
     * </p>
     */
  public final static Factory SAFE_BASIC1D_FACTORY = new SafeFactory(BASIC1D_FACTORY);
  ...
  /**
     ...
     * </p>
     */
  public final static Factory SAFE_BASIC2D_FACTORY = new SafeFactory(BASIC2D_FACTORY);
  ...
  /**
     ...
     * </p>
     */
  public final static Factory SAFE_CRS_FACTORY = new SafeFactory(CRS_FACTORY);
  ...
  /**
     ...
     * </p>
     */
  public final static Factory SAFE_CCS_FACTORY = new SafeFactory(CCS_FACTORY);
  ...
  /**
     ...
     */
  public final static MatrixDecompositor CHOLESKY_DECOMPOSITOR = new CholeskyDecompositor();

  /**
     * The {@link EigenDecompositor} singleton instance.
     */
  public final static MatrixDecompositor EIGEN_DECOMPOSITOR = new EigenDecompositor();

  /**
     * The {@link LUDecompositor} singleton instance.
     */
  public final static MatrixDecompositor LU_DECOMPOSITOR = new LUDecompositor();

  /**
     * The {@link QRDecompositor} singleton instance.
     */
  public final static MatrixDecompositor QR_DECOMPOSITOR = new QRDecompositor();

  /**
     * The {@link SingularValueDecompositor} singleton instance.
     */
  public final static MatrixDecompositor SINGULAR_VALUE_DECOMPOSITOR = new SingularValueDecompositor();

  /**
     * The {@link CroutDecompositor} singleton instance.
     */
  public final static MatrixDecompositor CROUT_DECOMPOSITOR = new CroutDecompositor();

  /**
     * The {@link GaussianInvertor} singleton instance.
     */
  public final static MatrixInvertor GAUSSIAN_INVERTOR = new GaussianInvertor();
  ...
  /**
     ...
     */
  public final static LinearSystemSolver GAUSSIAN_SOLVER = new GaussianSolver();

  /**
     * The {@link JacobiSolver} singleton instance.
     */
  public final static LinearSystemSolver JACOBI_SOLVER = new JacobiSolver();

  /**
     * The {@link SeidelSolver} singleton instance.
     */
  public final static LinearSystemSolver SEIDEL_SOLVER = new SeidelSolver();

  /**
     * The {@link SquareRootSolver} singleton instance.
     */
  public final static LinearSystemSolver SQUARE_ROOT_SOLVER = new SquareRootSolver();

  /**
     * The {@link SweepSolver} singleton instance.
     */
  public final static LinearSystemSolver SWEEP_SOLVER = new SweepSolver();
