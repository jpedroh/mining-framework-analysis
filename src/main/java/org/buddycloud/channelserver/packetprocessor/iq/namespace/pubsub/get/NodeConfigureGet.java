...
public class NodeConfigureGet extends PubSubElementProcessorAbstract {
  ...
  private void getNodeConfiguration() throws Exception {
    ...
    for (String key : nodeConf.keySet()) {
      ...
      if ((key.equals(AccessModel.FIELD_NAME)) && (value.equals(AccessModel.local.toString())) && (
<<<<<<< /usr/src/app/output/buddycloud/buddycloud-server-java/e746268967301a644cf186725205f1d823a45a83/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/get/NodeConfigureGet.java/left.java
      !channelManager.isLocalJID(actor)
=======
      false == Configuration.getInstance().isLocalJID(actor)
>>>>>>> /usr/src/app/output/buddycloud/buddycloud-server-java/e746268967301a644cf186725205f1d823a45a83/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/get/NodeConfigureGet.java/right.java
      )) {
