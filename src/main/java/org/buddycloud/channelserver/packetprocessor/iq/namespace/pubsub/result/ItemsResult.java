...
public class ItemsResult extends PubSubElementProcessorAbstract {
  ...
  public void process(Element elm, JID actorJID, IQ reqIQ, Element rsm) throws Exception {
    ...
    @SuppressWarnings(value = { "unchecked" }) List<Element> items = request.getElement().element("pubsub").element("items").elements("item");
  ...
  @SuppressWarnings(value = { "unchecked" }) private void processSubscriptionItem(Element item) throws NodeStoreException {
  ...
  private void addSubscription(Element item, JID user) throws NodeStoreException {
    ...
    if ((true == Configuration.getInstance().isLocalNode(node)) && (true == Configuration.getInstance().isLocalJID(user))) {
      return;
    }
