...
public class SubscriptionEvent extends PubSubElementProcessorAbstract {
  ...
  public void process(Element elm, JID actorJID, IQ reqIQ, Element rsm) throws Exception {
    ...
    if (
<<<<<<< /usr/src/app/output/buddycloud/buddycloud-server-java/e746268967301a644cf186725205f1d823a45a83/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/set/SubscriptionEvent.java/left.java
    !channelManager.isLocalNode(node)
=======
    false == Configuration.getInstance().isLocalNode(node)
>>>>>>> /usr/src/app/output/buddycloud/buddycloud-server-java/e746268967301a644cf186725205f1d823a45a83/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/set/SubscriptionEvent.java/right.java
    ) {
      makeRemoteRequest();
      return;
    }
...
>>>>>>> /usr/src/app/output/buddycloud/buddycloud-server-java/e746268967301a644cf186725205f1d823a45a83/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/set/SubscriptionEvent.java/right.java
       || (!checkNodeExists()) || (!actorHasPermissionToAuthorize()) || (actorIsModifyingTheirSubscription()) || (!userIsSubscribable())) {
        outQueue.put(response);
        return;
      }
  ...
  private void saveUpdatedSubscription() throws NodeStoreException {
    ...
    NodeSubscription newSubscription = new NodeSubscriptionImpl(node, jid, currentMembership.getListener(), Subscriptions.valueOf(subscriptionElement.attributeValue("subscription")), invitedBy);
  ...
  private boolean validRequestStanza() {
    subscriptionElement = request.getElement().element(XMLConstants.PUBSUB_ELEM).element(XMLConstants.SUBSCRIPTIONS_ELEM).element(XMLConstants.SUBSCRIPTION_ELEM);
