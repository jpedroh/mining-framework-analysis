...
public class AffiliationEvent extends PubSubElementProcessorAbstract {
    ...
    public void process(Element elm, JID actorJID, IQ reqIQ, Element rsm) throws Exception {
        ...
        try {
            if ((false == validRequestStanza())
            		|| (false == checkNodeExists()) || (false == actorHasPermissionToAuthorize()) || (false == subscriberHasCurrentAffiliation())
                    || (true == userIsModifyingTheirAffiliation()) || (false == attemptToChangeAffiliationOfNodeOwner())) {
            	outQueue.put(response);
            	return;
            }
    ...
    private boolean validRequestStanza() {
        try {
            ...
            if ((null == requestedAffiliationElement) || (null == requestedAffiliationElement.attribute("jid"))
