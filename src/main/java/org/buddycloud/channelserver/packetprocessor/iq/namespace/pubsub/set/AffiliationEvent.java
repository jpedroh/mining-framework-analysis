...
public class AffiliationEvent extends PubSubElementProcessorAbstract {
  ...
  public void process(Element elm, JID actorJID, IQ reqIQ, Element rsm) throws Exception {
    ...
    if (
<<<<<<< /usr/src/app/output/buddycloud/buddycloud-server-java/e746268967301a644cf186725205f1d823a45a83/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/set/AffiliationEvent.java/left.java
    !channelManager.isLocalNode(node)
=======
    false == Configuration.getInstance().isLocalNode(node)
>>>>>>> /usr/src/app/output/buddycloud/buddycloud-server-java/e746268967301a644cf186725205f1d823a45a83/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/set/AffiliationEvent.java/right.java
    ) {
      makeRemoteRequest();
      return;
    }
    try {
      if (
<<<<<<< /usr/src/app/output/buddycloud/buddycloud-server-java/e746268967301a644cf186725205f1d823a45a83/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/set/AffiliationEvent.java/left.java
      (!nodeProvided()) || (!validRequestStanza())
=======
      (false == validRequestStanza())
>>>>>>> /usr/src/app/output/buddycloud/buddycloud-server-java/e746268967301a644cf186725205f1d823a45a83/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/set/AffiliationEvent.java/right.java
       || (!checkNodeExists()) || (!actorHasPermissionToAuthorize()) || (!subscriberHasCurrentAffiliation()) || (userIsModifyingTheirAffiliation()) || (!attemptToChangeAffiliationOfNodeOwner())) {
        outQueue.put(response);
        return;
      }
  ...
  private boolean validRequestStanza() {
    try {
      requestedAffiliationElement = request.getElement().element(XMLConstants.PUBSUB_ELEM).element(XMLConstants.AFFILIATIONS_ELEM).element(XMLConstants.AFFILIATION_ELEM);
      if ((null == requestedAffiliationElement) || (null == requestedAffiliationElement.attribute(XMLConstants.JID_ATTR)) || (null == requestedAffiliationElement.attribute(XMLConstants.AFFILIATION_ELEM))) {
