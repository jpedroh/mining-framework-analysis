...
<<<<<<< /usr/src/app/output/buddycloud/buddycloud-server-java/bc01763824f2ab363ee2be9718c77db9cb5e3755/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/get/ThreadGet.java/left.java
        if (null != channelManager.getNodeItem(node, parentId)) {
    		return true;
    	}
||||||| /usr/src/app/output/buddycloud/buddycloud-server-java/bc01763824f2ab363ee2be9718c77db9cb5e3755/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/get/ThreadGet.java/base.java
        if (null != (parentItem = channelManager.getNodeItem(node, parentId))) return true;
=======
        if (null != (channelManager.getNodeItem(node, parentId))) {
    	    return true;
    	}
>>>>>>> /usr/src/app/output/buddycloud/buddycloud-server-java/bc01763824f2ab363ee2be9718c77db9cb5e3755/src/main/java/org/buddycloud/channelserver/packetprocessor/iq/namespace/pubsub/get/ThreadGet.java/right.java
    ...
    private boolean userCanViewNode() throws NodeStoreException {
        if (getNodeViewAcl().canViewNode(node, channelManager.getNodeMembership(node, actor), getNodeAccessModel(), Configuration.getInstance().isLocalJID(actor))) {
        	return true;
        }
