...
import org.xmpp.resultsetmanagement.ResultSet;
 ...
 public abstract abstract class AbstractMessageProcessor implements PacketProcessor<Message> {
...
<<<<<<< /usr/src/app/output/buddycloud/buddycloud-server-java/bc01763824f2ab363ee2be9718c77db9cb5e3755/src/main/java/org/buddycloud/channelserver/packetprocessor/message/event/AbstractMessageProcessor.java/left.java
            if (false == Configuration.getInstance().isLocalJID(member.getUser())) {
				continue;
			}
||||||| /usr/src/app/output/buddycloud/buddycloud-server-java/bc01763824f2ab363ee2be9718c77db9cb5e3755/src/main/java/org/buddycloud/channelserver/packetprocessor/message/event/AbstractMessageProcessor.java/base.java
            if (false == Configuration.getInstance().isLocalJID(member.getUser())) continue;
=======
            if (false == Configuration.getInstance().isLocalJID(member.getUser())) {
                continue;
            }
>>>>>>> /usr/src/app/output/buddycloud/buddycloud-server-java/bc01763824f2ab363ee2be9718c77db9cb5e3755/src/main/java/org/buddycloud/channelserver/packetprocessor/message/event/AbstractMessageProcessor.java/right.java
