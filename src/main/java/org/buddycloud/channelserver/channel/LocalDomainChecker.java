...
public class LocalDomainChecker {
  ...
  public static boolean isLocal(String domain, Properties configuration, Set<String> localDomains) {
    ...
    String command = configuration.getProperty(Configuration.CONFIGURATION_LOCAL_DOMAIN_CHECKER);
    if (command == null) {
      String serverDomain = configuration.getProperty(Configuration.CONFIGURATION_SERVER_DOMAIN);
      ...
      return (domain.equals(serverDomain) || domain.equals(topicDomain) || domain.equals(channelDomain));
    }
