...
public class Sql92NodeStoreDialect implements NodeStoreSQLDialect {
	...
	private static final String SELECT_USER_PUBLISHED_ITEMS = "SELECT \"node\", \"id\", \"updated\", \"xml\", \"in_reply_to\", \"created\"" + (" FROM \"items\" WHERE (CAST(xpath(\'//atom:author/atom:name/text()\', xmlparse(document \"xml\")," + " ARRAY[ARRAY['atom', 'http://www.w3.org/2005/Atom']]) AS TEXT[]))[1] = ?");
