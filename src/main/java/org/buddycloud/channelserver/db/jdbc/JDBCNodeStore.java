...
public class JDBCNodeStore implements NodeStore {
  ...
  @Override public int countNodeAffiliations(String nodeId) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
  ...
  @Override public ResultSet<NodeAffiliation> getNodeAffiliations(String nodeId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public ResultSet<NodeAffiliation> getNodeAffiliations(String nodeId, String afterItemId, int maxItemsToReturn) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public ResultSet<NodeSubscription> getNodeSubscriptions(String nodeId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  public ResultSet<NodeSubscription> getNodeSubscriptions(String nodeId, JID afterItemId, int maxItemsToReturn) throws NodeStoreException {
    PreparedStatement stmt = null;
    String maxItems;
  ...
  @Override public int countNodeSubscriptions(String nodeId) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
