...
public class JDBCNodeStore implements NodeStore {
  ...
  @Override public void createNode(JID owner, String nodeId, Map<String, String> nodeConf) throws NodeStoreException {
    if (owner == null) {
  ...
  @Override public void deleteNode(String nodeId) throws NodeStoreException {
  ...
  @Override public void addRemoteNode(String nodeId) throws NodeStoreException {
    if (null == nodeId) {
      throw new NullPointerException("nodeId must not be null");
    }
    PreparedStatement addStatement = null;
  ...
  @Override public void setNodeConfValue(String nodeId, String key, String value) throws NodeStoreException {
    if (nodeId == null) {
      throw new NullPointerException("nodeId must not be null");
    }
    if (key == null) {
  ...
  @Override public void setNodeConf(String nodeId, Map<String, String> conf) throws NodeStoreException {
    Transaction t = null;
    try {
      t = beginTransaction();
  ...
  @Override public boolean nodeExists(String nodeId) throws NodeStoreException {
    ...
    try {
      ...
      close(existsStatement);
    }
  }

  @Override public void setUserAffiliation(String nodeId, JID user, Affiliations affiliation) throws NodeStoreException {
    PreparedStatement deleteStatement = null;
    PreparedStatement updateStatement = null;
    PreparedStatement addStatement = null;
    Transaction t = null;
  ...
  @Override public String getNodeConfValue(String nodeId, String key) throws NodeStoreException {
  ...
  @Override public void deleteNodeConfiguration(String nodeId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public Map<String, String> getNodeConf(String nodeId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public void addUserSubscription(final NodeSubscription subscription) throws NodeStoreException {
    PreparedStatement deleteStatement = null;
    PreparedStatement updateStatement = null;
    PreparedStatement addStatement = null;
    Transaction t = null;
  ...
  @Override public NodeAffiliation getUserAffiliation(String nodeId, JID user) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
      NodeAffiliationImpl affiliation;
      selectStatement = conn.prepareStatement(dialect.selectAffiliation());
      ...
      if (rs.next()) {
        affiliation = new NodeAffiliationImpl(nodeId, user, Affiliations.valueOf(rs.getString(1)), rs.getTimestamp(2));
      } else {
        affiliation = new NodeAffiliationImpl(nodeId, user, Affiliations.none, new Date());
      }
      return affiliation;
    } catch (SQLException e) {
      throw new NodeStoreException(e);
  ...
  @Override public ResultSet<NodeAffiliation> getAffiliationChanges(JID user, Date startDate, Date endDate) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      ...
      while (rs.next()) {
        NodeAffiliationImpl nodeSub = new NodeAffiliationImpl(rs.getString(1), new JID(rs.getString(2)), Affiliations.valueOf(rs.getString(3)), rs.getTimestamp(4));
        result.add(nodeSub);
      }
  ...
  @Override public ResultSet<NodeAffiliation> getUserAffiliations(JID user) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      ...
      ArrayList<NodeAffiliation> result = new ArrayList<NodeAffiliation>();
      while (rs.next()) {
        NodeAffiliationImpl nodeSub = new NodeAffiliationImpl(rs.getString(1), user, Affiliations.valueOf(rs.getString(3)), rs.getTimestamp(4));
        result.add(nodeSub);
      }
      return new ResultSetImpl<NodeAffiliation>(result);
    } catch (SQLException e) {
  ...
  @Override public ResultSet<NodeAffiliation> getUserAffiliations(JID user, String afterItemId, int maxItemsToReturn) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public int countNodeAffiliations(String nodeId, boolean isOwnerModerator) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
      if (true == isOwnerModerator) {
        selectStatement = conn.prepareStatement(dialect.countNodeAffiliationsForOwner());
      } else {
        selectStatement = conn.prepareStatement(dialect.countNodeAffiliations());
      }
      selectStatement.setString(1, nodeId);
      java.sql.ResultSet rs = selectStatement.executeQuery();
      if (rs.next()) {
  ...
  @Override public ResultSet<NodeAffiliation> getNodeAffiliations(String nodeId, boolean isOwnerModerator) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      if (true == isOwnerModerator) {
  ...
  @Override public ResultSet<NodeAffiliation> getNodeAffiliations(String nodeId, boolean isOwnerModerator, String afterItemId, int maxItemsToReturn) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      if (true == isOwnerModerator) {
        stmt = conn.prepareStatement(dialect.selectAffiliationsToNodeForOwnerAfterJid());
      } else {
  ...
  @Override public ArrayList<JID> getNodeOwners(String node) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public int countUserAffiliations(JID actorJid) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
      selectStatement = conn.prepareStatement(dialect.countUserAffiliations());
  ...
  @Override public NodeSubscription getUserSubscription(String nodeId, JID user) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
      NodeSubscriptionImpl subscription;
      selectStatement = conn.prepareStatement(dialect.selectSubscription());
      selectStatement.setString(1, nodeId);
      selectStatement.setString(2, user.toBareJID());
      ...
      java.sql.ResultSet rs = selectStatement.executeQuery();
      if (rs.next()) {
        subscription = new NodeSubscriptionImpl(nodeId, new JID(rs.getString(2)), new JID(rs.getString(3)), Subscriptions.valueOf(rs.getString(4)), rs.getTimestamp(5));
      } else {
        subscription = new NodeSubscriptionImpl(nodeId, user, user, Subscriptions.none);
      }
      return subscription;
    } catch (SQLException e) {
      throw new NodeStoreException(e);
  ...
  @Override public ResultSet<NodeSubscription> getUserSubscriptions(final JID user) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      ...
      while (rs.next()) {
        NodeSubscriptionImpl nodeSub = new NodeSubscriptionImpl(rs.getString(1), new JID(rs.getString(2)), new JID(rs.getString(3)), Subscriptions.valueOf(rs.getString(4)), rs.getTimestamp(5));
        result.add(nodeSub);
      }
  ...
  @Override public ResultSet<NodeSubscription> getUserSubscriptions(JID user, String afterNodeId, int maxItemsToReturn) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public ResultSet<NodeSubscription> getSubscriptionChanges(JID user, Date startDate, Date endDate) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public ResultSet<NodeSubscription> getNodeSubscriptions(String nodeId, boolean isOwnerModerator) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      if (true == isOwnerModerator) {
  ...
  @Override public ResultSet<NodeSubscription> getNodeSubscriptions(String nodeId, boolean isOwnerModerator, JID afterItemId, int maxItemsToReturn) throws NodeStoreException {
    PreparedStatement stmt = null;
    String maxItems;
  ...
  @Override public int countUserSubscriptions(JID user) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
  ...
  @Override public ResultSet<NodeSubscription> getNodeSubscriptionListeners(String nodeId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      ...
      ArrayList<NodeSubscription> result = new ArrayList<NodeSubscription>();
      while (rs.next()) {
        NodeSubscriptionImpl nodeSub = new NodeSubscriptionImpl(rs.getString(2), new JID(rs.getString(1)), Subscriptions.valueOf(rs.getString(3)), rs.getTimestamp(4));
        result.add(nodeSub);
      }
      return new ResultSetImpl<NodeSubscription>(result);
    } catch (SQLException e) {
  ...
  @Override public ResultSet<NodeSubscription> getNodeSubscriptionListeners() throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public CloseableIterator<NodeItem> getNodeItems(String nodeId, String afterItemId, int count) throws NodeStoreException {
    ...
    try {
      if (afterItem == null) {
        ...
        return new ResultSetIterator<NodeItem>(rs, new ResultSetIterator.RowConverter<NodeItem>() {
          @Override public NodeItem convertRow(java.sql.ResultSet rs) throws SQLException {
  ...
  @Override public CloseableIterator<NodeItem> getFirehose(int limit, String afterItemId, boolean isAdmin) throws NodeStoreException {
    PreparedStatement stmt = null;
    ...
    try {
      ...
      stmt.setString(4, "%@" + Configuration.getInstance().getProperty(Configuration.CONFIGURATION_SERVER_DOMAIN) + "%");
      stmt.setString(5, "%@" + Configuration.getInstance().getProperty(Configuration.CONFIGURATION_SERVER_TOPICS_DOMAIN) + "%");
      stmt.setInt(6, limit);
      java.sql.ResultSet rs = stmt.executeQuery();
      LinkedList<NodeItem> results = new LinkedList<NodeItem>();
      while (rs.next()) {
        results.push(new NodeItemImpl(rs.getString(1), rs.getString(2), rs.getTimestamp(3), rs.getString(4), rs.getString(5)));
      }
  ...
  @Override public int getFirehoseItemCount(boolean isAdmin) throws NodeStoreException {
    PreparedStatement stmt = null;
    String accessModel = "open";
    if (true == isAdmin) {
      accessModel = "%";
    ...
    try {
      ...
      stmt.setString(3, "%@" + Configuration.getInstance().getProperty(Configuration.CONFIGURATION_SERVER_DOMAIN) + "%");
      stmt.setString(4, "%@" + Configuration.getInstance().getProperty(Configuration.CONFIGURATION_SERVER_TOPICS_DOMAIN) + "%");
      java.sql.ResultSet rs = stmt.executeQuery();
      if (rs.next()) {
        return rs.getInt(1);
      } else {
  ...
  @Override public int getCountRecentItems(JID user, Date since, int maxPerNode, String node) throws NodeStoreException {
    if (null == node) {
      node = "/posts";
    }
    if (-1 == maxPerNode) {
  ...
  @Override public CloseableIterator<NodeItem> getRecentItems(JID user, Date since, int maxPerNode, int limit, GlobalItemID afterItemId, String node) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      if (null == node) {
        node = "/posts";
      ...
      for (NodeSubscription subscription : subscriptions) {
        ...
        queryParts.add(dialect.selectRecentItemParts().replace("%counter%", String.valueOf(counter)));
        parameters.add(subscription.getNodeId());
        parameters.add(new java.sql.Timestamp(since.getTime()));
        parameters.add(maxPerNode);
        ++counter;
      ...
      while (rs.next()) {
        results.add(new NodeItemImpl(rs.getString(2), rs.getString(1), rs.getTimestamp(4), rs.getString(3), rs.getString(5)));
      }
      return new ClosableIteratorImpl<NodeItem>(results.iterator());
    } catch (SQLException e) {
      e.printStackTrace();
  ...
  @Override public CloseableIterator<NodeItem> getNodeItems(String nodeId) throws NodeStoreException {
    return getNodeItems(nodeId, null, -1);
  }

  @Override public ClosableIteratorImpl<NodeItem> getNodeItemReplies(String nodeId, String itemId, String afterItemId, int limit) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      ...
      LinkedList<NodeItem> results = new LinkedList<NodeItem>();
      while (rs.next()) {
        results.push(new NodeItemImpl(rs.getString(2), rs.getString(1), rs.getTimestamp(4), rs.getString(3), rs.getString(5)));
      }
      return new ClosableIteratorImpl<NodeItem>(results.iterator());
    } catch (SQLException e) {
      throw new NodeStoreException(e);
  ...
  @Override public int getCountNodeItemReplies(String nodeId, String itemId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public ClosableIteratorImpl<NodeItem> getNodeItemThread(String nodeId, String itemId, String afterItemId, int limit) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      Date since = new Date(0);
      if (null != afterItemId) {
  ...
  @Override public int getCountNodeThread(String nodeId, String itemId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public CloseableIterator<NodeItem> getNewNodeItemsForUser(JID user, Date startDate, Date endDate) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public int countNodeItems(String nodeId) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
  ...
  @Override public NodeItem getNodeItem(String nodeId, String nodeItemId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public void addNodeItem(NodeItem item) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public void updateNodeItem(NodeItem item) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public void deleteNodeItemById(String nodeId, String nodeItemId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public void purgeNodeItems(String nodeId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public CloseableIterator<NodeItem> performSearch(JID searcher, List content, JID author, int page, int rpp) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      String sql = "SELECT * FROM \"items\"  " + "LEFT JOIN \"subscriptions\" ON \"items\".\"node\" = \"subscriptions\".\"node\" " + "WHERE " + "\"subscriptions\".\"user\" = ?  " + "AND \"subscriptions\".\"subscription\" = \'subscribed\' " + "AND RIGHT(\"items\".\"node\", 6) = \'/posts\' " + " $searchParameters " + "ORDER BY \"items\".\"updated\" DESC " + "LIMIT ? OFFSET ?;";
  ...
  @Override public ArrayList<String> getNodeList() throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public boolean isCachedNode(String nodeId) throws NodeStoreException {
    return (this.countNodeItems(nodeId) > 0);
  }

  @Override public boolean isCachedNodeConfig(String nodeId) throws NodeStoreException {
    return (this.getNodeConf(nodeId).size() > 0);
  }

  @Override public boolean isCachedJID(JID jid) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
      selectStatement = conn.prepareStatement(dialect.countSubscriptionsForJid());
  ...
  @Override public boolean userHasRatedPost(String node, JID user, GlobalItemID id) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
  ...
  @Override public int countNodeSubscriptions(String nodeId, boolean isOwnerModerator) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
      if (true == isOwnerModerator) {
        selectStatement = conn.prepareStatement(dialect.countSubscriptionsToNodeForOwner());
      } else {
        selectStatement = conn.prepareStatement(dialect.countSubscriptionsForNode());
      }
      selectStatement.setString(1, nodeId);
      java.sql.ResultSet rs = selectStatement.executeQuery();
      if (rs.next()) {
  ...
  @Override public boolean nodeHasSubscriptions(String nodeId) throws NodeStoreException {
    return (this.countNodeSubscriptions(nodeId, false) > 0);
  }

  @Override public ResultSet<NodeItem> getUserItems(JID userJid) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      ...
      while (rs.next()) {
        NodeItem nodeItem = new NodeItemImpl(rs.getString(1), rs.getString(2), rs.getTimestamp(3), rs.getString(4), rs.getString(5));
        result.add(nodeItem);
      }
  ...
  @Override public void deleteUserItems(JID userJid) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public void deleteUserAffiliations(JID userJid) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public void deleteUserSubscriptions(JID userJid) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public ResultSet<NodeThread> getNodeThreads(String node, String afterId, int limit) throws NodeStoreException {
    Date after = new Date();
    if (afterId != null) {
  ...
  @Override public int countNodeThreads(String node) throws NodeStoreException {
    PreparedStatement selectStatement = null;
    try {
  ...
  @Override public Transaction beginTransaction() throws NodeStoreException {
  ...
  public class JDBCTransaction implements Transaction {
    ...
    @Override public void commit() throws NodeStoreException {
      if (closed) {
    ...
    @Override public void close() throws NodeStoreException {
      if (closed) {
        return;
      }
      if (!isLatestTransaction()) {
