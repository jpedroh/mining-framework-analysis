...
public class JDBCNodeStore implements NodeStore {
  ...
  @Override public ResultSet<NodeMembership> getUserMemberships(JID jid) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      ...
      while (rs.next()) {
        ...
        NodeMembershipImpl membership = new NodeMembershipImpl(rs.getString(1), new JID(rs.getString(2)), new JID(rs.getString(3)), Subscriptions.valueOf(rs.getString(4)), Affiliations.valueOf(rs.getString(5)), inviter, rs.getTimestamp(7));
  ...
  @Override public NodeMembership getNodeMembership(String nodeId, JID user) throws NodeStoreException {
    ...
    try {
      ...
      if (rs.next()) {
        ...
        membership = new NodeMembershipImpl(nodeId, new JID(rs.getString(2)), new JID(rs.getString(3)), Subscriptions.valueOf(rs.getString(4)), Affiliations.valueOf(rs.getString(5)), inviter, rs.getTimestamp(7));
      } else {
  ...
  @Override public ResultSet<NodeMembership> getNodeMemberships(String nodeId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public ResultSet<NodeSubscription> getSubscriptionChanges(JID user, Date startDate, Date endDate) throws NodeStoreException {
    ...
    try {
      ...
      while (rs.next()) {
        ...
        NodeSubscriptionImpl nodeSub = new NodeSubscriptionImpl(rs.getString(1), new JID(rs.getString(2)), new JID(rs.getString(3)), Subscriptions.valueOf(rs.getString(4)), invitedBy, rs.getTimestamp(6));
        result.add(nodeSub);
      }
  ...
  @Override public ResultSet<NodeSubscription> getNodeSubscriptionListeners(String nodeId) throws NodeStoreException {
    ...
    try {
      ...
      ArrayList<NodeSubscription> result = new ArrayList<NodeSubscription>();
      while (rs.next()) {
        NodeSubscriptionImpl nodeSub = new NodeSubscriptionImpl(rs.getString(2), new JID(rs.getString(1)), Subscriptions.valueOf(rs.getString(3)), null, rs.getTimestamp(4));
        result.add(nodeSub);
      }
      return new ResultSetImpl<NodeSubscription>(result);
    } catch (SQLException e) {
  ...
  @Override public CloseableIterator<NodeItem> getUserFeedItems(JID user, Date since, int limit, GlobalItemID afterItemId, boolean parentOnly) throws NodeStoreException {
    PreparedStatement stmt = null;
    String limitSQL = "";
    String afterSQL = "";
    String parentSQL = "";
    ...
    try {
      stmt = conn.prepareStatement(dialect.selectUserFeedItems().replace("%limit%", limitSQL).replace("%after%", afterSQL).replace("%parent%", parentSQL));
  ...
  @Override public int getCountUserFeedItems(JID user, Date since, boolean parentOnly) throws NodeStoreException {
    PreparedStatement stmt = null;
    String parentSQL = "";
    NodeItem afterItem = null;
    if (true == parentOnly) {
  ...
  @Override public int getCountRecentItems(JID user, Date since, int maxPerNode, String node, boolean parentOnly) throws NodeStoreException {
    if (null == node) {
      node = "/posts";
    }
    if (-1 == maxPerNode) {
  ...
  @Override public CloseableIterator<NodeItem> getRecentItems(JID user, Date since, int maxPerNode, int limit, GlobalItemID afterItemId, String node, boolean parentOnly) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
      if (null == node) {
        node = "/posts";
  ...
  @Override public NodeItem getNodeItem(GlobalItemID itemId) throws NodeStoreException {
  ...
  @Override public void updateThreadParent(String node, String itemId) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public ResultSet<NodeItem> getUserPublishedItems(JID userJid) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
...
=======
  @Override public ResultSet<NodeItem> getUserItems(JID userJid) throws NodeStoreException {
    ...
    try {
      ...
      ArrayList<NodeItem> result = new ArrayList<NodeItem>();
      while (rs.next()) {
        NodeItem nodeItem = new NodeItemImpl(rs.getString(1), rs.getString(2), rs.getTimestamp(3), rs.getString(4), rs.getString(5), rs.getTimestamp(6));
        result.add(nodeItem);
      }
      return new ResultSetImpl<NodeItem>(result);
    } catch (SQLException e) {
...
>>>>>>> /usr/src/app/output/buddycloud/buddycloud-server-java/ee3043efe741251853534591998abbc2a3823b3a/src/main/java/org/buddycloud/channelserver/db/jdbc/JDBCNodeStore.java/right.java
  ...
  @Override public ResultSet<NodeThread> getNodeThreads(String node, String afterId, int limit) throws NodeStoreException {
    ...
    try {
      ...
      while (rs.next()) {
        NodeItem nodeItem = new NodeItemImpl(rs.getString(1), rs.getString(2), rs.getTimestamp(3), rs.getString(4), rs.getString(5), rs.getTimestamp(8));
