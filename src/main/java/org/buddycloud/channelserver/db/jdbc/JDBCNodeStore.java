...
public class JDBCNodeStore implements NodeStore {
  ...
  @Override public CloseableIterator<NodeItem> getFirehose(int limit, String afterItemId, boolean isAdmin, String actorDomain) throws NodeStoreException {
    PreparedStatement stmt = null;
...
>>>>>>> /usr/src/app/output/buddycloud/buddycloud-server-java/bc01763824f2ab363ee2be9718c77db9cb5e3755/src/main/java/org/buddycloud/channelserver/db/jdbc/JDBCNodeStore.java/right.java
  ...
  @Override public int getFirehoseItemCount(boolean isAdmin, String actorDomain) throws NodeStoreException {
    PreparedStatement stmt = null;
...
>>>>>>> /usr/src/app/output/buddycloud/buddycloud-server-java/bc01763824f2ab363ee2be9718c77db9cb5e3755/src/main/java/org/buddycloud/channelserver/db/jdbc/JDBCNodeStore.java/right.java
  ...
  @Override public void jidOnline(JID jid) throws NodeStoreException {
    PreparedStatement addStatement = null;
    try {
      jidOffline(jid);
  ...
  @Override public void jidOffline(JID jid) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public ArrayList<JID> onlineJids(JID jid) throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public List<String> getLocalNodesList() throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
  ...
  @Override public List<String> getRemoteNodesList() throws NodeStoreException {
    PreparedStatement stmt = null;
    try {
