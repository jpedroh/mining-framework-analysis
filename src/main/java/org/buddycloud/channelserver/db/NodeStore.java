...
public interface NodeStore {
  ...
  /**
	 ...
	 * @return
	 */
  NodeAffiliation getUserAffiliation(String nodeId, JID user) throws NodeStoreException;
  ...
  /**
	 ...
	 * @return
	 */
  ResultSet<NodeAffiliation> getUserAffiliations(JID user) throws NodeStoreException;
  ...
  /**
     ...
     * @return
     */
  ResultSet<NodeAffiliation> getUserAffiliations(JID actorJid, String afterItemId, int maxItemsToReturn) throws NodeStoreException;
  ...
  /**
	 ...
	 * @return
	 */
  ResultSet<NodeAffiliation> getNodeAffiliations(String nodeId) throws NodeStoreException;
  ...
  /**
     ...
     * @return
     */
  ResultSet<NodeAffiliation> getNodeAffiliations(String node, String afterItemId, int maxItemsToReturn) throws NodeStoreException;
  ...
  /**
	 ...
	 * @return
	 */
  ResultSet<NodeSubscription> getUserSubscriptions(JID user, String afterNodeId, int maxItemsToReturn) throws NodeStoreException;
  ...
  /**
	 ...
	 * @return
	 */
  ResultSet<NodeSubscription> getUserSubscriptions(JID user) throws NodeStoreException;
  ...
  /**
	 ...
	 * @return
	 */
  ResultSet<NodeSubscription> getNodeSubscriptions(String nodeId) throws NodeStoreException;
  ...
  /**
	 ...
	 * @return
	 */
  ResultSet<NodeSubscription> getNodeSubscriptions(String nodeId, JID afterItemId, int maxItemsToReturn) throws NodeStoreException;
  ...
  /**
	 ...
	 * @return
	 */
  NodeSubscription getUserSubscription(String nodeId, JID user) throws NodeStoreException;
  ...
  /**
     ...
     * @throws NodeStoreException
     */
  CloseableIterator<NodeItem> getRecentItems(JID user, Date since, int maxPerNode, int limit, GlobalItemID afterItemId, String node) throws NodeStoreException;
