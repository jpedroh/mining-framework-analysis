...
public interface NodeStore {
  ...
  /**
	 ...
	 * @throws NodeStoreException
	 */
  CloseableIterator<NodeItem> getRecentItems(JID user, Date since, int maxPerNode, int limit, GlobalItemID afterItemId, String node, boolean parentOnly) throws NodeStoreException;
  ...
  /**
	 ...
	 * @throws NodeStoreException
	 */
  @SuppressWarnings(value = { "rawtypes" }) CloseableIterator<NodeItem> performSearch(JID searcher, List content, JID author, int page, int rpp) throws NodeStoreException;
  ...
  /**
	 ...
	 * @throws NodeStoreException
	 */
  CloseableIterator<NodeItem> getFirehose(int limit, String afterItemId, boolean isAdmin, String actorDomain) throws NodeStoreException;
