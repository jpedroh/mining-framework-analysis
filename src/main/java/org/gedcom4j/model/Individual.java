 ...
 * @author frizbog1
 */
@SuppressWarnings(value = { "PMD.ExcessiveClassLength", "PMD.ExcessivePublicCount", "PMD.GodClass" }) public class Individual extends AbstractAddressableElement implements HasCitations, HasXref {
  /**
     * Serial Version UID
     */
    ...
    if (other.citations != null) {
      ...
      for (AbstractCitation ac : other.citations) {
        if (ac instanceof CitationWithoutSource) {
          ...
          if (ac instanceof CitationWithSource) {
  ...
  /**
     * {@inheritDoc}
     */
  @Override @SuppressWarnings(value = { "PMD.NcssMethodCount", "PMD.ExcessiveMethodLength", "checkstyle:methodlength" }) public boolean equals(Object obj) {
    if (this == obj) {
      return true;
    }
    if (!super.equals(obj)) {
    ...
    if (ancestorInterest == null) {
      ...
      if (!ancestorInterest.equals(other.ancestorInterest)) {
        return false;
      }
    }
    if (ancestralFileNumber == null) {
      ...
      if (!ancestralFileNumber.equals(other.ancestralFileNumber)) {
        return false;
      }
    }
    if (associations == null) {
      ...
      if (!associations.equals(other.associations)) {
        return false;
      }
    }
    if (attributes == null) {
    ...
    if (changeDate == null) {
      ...
      if (!changeDate.equals(other.changeDate)) {
        return false;
      }
    }
    if (citations == null) {
      ...
      if (!citations.equals(other.citations)) {
        return false;
      }
    }
    if (descendantInterest == null) {
      ...
      if (!descendantInterest.equals(other.descendantInterest)) {
        return false;
      }
    }
    if (events == null) {
    ...
    if (familiesWhereChild == null) {
      ...
      if (!familiesWhereChild.equals(other.familiesWhereChild)) {
        return false;
      }
    }
    if (familiesWhereSpouse == null) {
      ...
      if (!familiesWhereSpouse.equals(other.familiesWhereSpouse)) {
        return false;
      }
    }
    if (ldsIndividualOrdinances == null) {
      ...
      if (!ldsIndividualOrdinances.equals(other.ldsIndividualOrdinances)) {
        return false;
      }
    }
    if (multimedia == null) {
    ...
    if (permanentRecFileNumber == null) {
      ...
      if (!permanentRecFileNumber.equals(other.permanentRecFileNumber)) {
        return false;
      }
    }
    if (recIdNumber == null) {
      ...
      if (!recIdNumber.equals(other.recIdNumber)) {
        return false;
      }
    }
    if (restrictionNotice == null) {
      ...
      if (!restrictionNotice.equals(other.restrictionNotice)) {
        return false;
      }
    }
    if (sex == null) {
    ...
    if (userReferences == null) {
      ...
      if (!userReferences.equals(other.userReferences)) {
        return false;
      }
    }
    if (xref == null) {
  ...
  /**
     ...
     */
  @Override public List<AbstractCitation> getCitations() {
    return citations;
  }
  ...
  /**
     ...
     * @return the citations
     */
  @Override public List<AbstractCitation> getCitations(boolean initializeIfNeeded) {
  ...
  /**
     ...
     * @return the xref
     */
  @Override public String getXref() {
    return xref;
  }
