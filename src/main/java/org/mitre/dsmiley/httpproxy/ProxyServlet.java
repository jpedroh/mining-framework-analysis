 ...
 */
@SuppressWarnings(value = { "deprecation", "serial" }) public class ProxyServlet extends HttpServlet {
  ...
  protected RequestConfig buildRequestConfig() {
    RequestConfig.Builder builder = RequestConfig.custom().setRedirectsEnabled(doHandleRedirects).setCookieSpec(CookieSpecs.IGNORE_COOKIES).setConnectTimeout(connectTimeout).setSocketTimeout(readTimeout);
  ...
  protected void copyRequestHeaders(HttpServletRequest servletRequest, HttpRequest proxyRequest) {
    @SuppressWarnings(value = { "unchecked" }) Enumeration<String> enumerationOfHeaderNames = servletRequest.getHeaderNames();
  ...
  protected void copyRequestHeader(HttpServletRequest servletRequest, HttpRequest proxyRequest, String headerName) {
    ...
    @SuppressWarnings(value = { "unchecked" }) Enumeration<String> headers = servletRequest.getHeaders(headerName);
    while (headers.hasMoreElements()) {
      ...
      if (!doPreserveHost && headerName.equalsIgnoreCase(HttpHeaders.HOST)) {
        ...
        if (!doPreserveCookies && headerName.equalsIgnoreCase(org.apache.http.cookie.SM.COOKIE)) {
