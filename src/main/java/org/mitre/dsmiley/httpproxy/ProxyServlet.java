...
@SuppressWarnings(value = { "deprecation", "serial" }) public class ProxyServlet extends HttpServlet {
  ...
  protected RequestConfig buildRequestConfig() {
    return RequestConfig.custom().setRedirectsEnabled(doHandleRedirects).setCookieSpec(CookieSpecs.IGNORE_COOKIES).setConnectTimeout(connectTimeout).setSocketTimeout(readTimeout).build();
  }
