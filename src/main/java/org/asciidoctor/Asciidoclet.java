...
public class Asciidoclet extends Doclet {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "UnusedDeclaration" }) public static LanguageVersion languageVersion() {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "UnusedDeclaration" }) public static int optionLength(String option) {
  ...
  /**
     ...
     * @return success
     */
  @SuppressWarnings(value = { "UnusedDeclaration" }) public static boolean start(RootDoc rootDoc) {
  ...
  /**
     ...
     * @return success
     */
  @SuppressWarnings(value = { "UnusedDeclaration" }) public static boolean validOptions(String[][] options, DocErrorReporter errorReporter) {
  ...
  private boolean postProcess() {
    if (docletOptions.stylesheetFile().isPresent()) {
      return true;
    }
