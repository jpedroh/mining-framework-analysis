...
public class ZMQ {
  ...
  /**
     ...
     */
  @Deprecated public static final int UPSTREAM = PULL;

  /**
     * @see org.zeromq.ZMQ#PUSH
     */
  @Deprecated public static final int DOWNSTREAM = PUSH;
  ...
  /**
     ...
     */
  @Deprecated public static final int EVENT_DELAYED = EVENT_CONNECT_DELAYED;
  ...
  /**
     ...
     */
  @Deprecated public static final int EVENT_RETRIED = EVENT_CONNECT_RETRIED;
  ...
  public static class Socket implements Closeable {
    ...
    /**
         ...
         */
    @Deprecated public final long getSwap() {
      return -1L;
    }
    ...
    /**
         ...
         */
    @Deprecated public final boolean hasMulticastLoop() {
      return false;
    }
    ...
    /**
         ...
         * @param multicastLoop
         */
    @Deprecated public final void setMulticastLoop(boolean multicastLoop) {
      throw new UnsupportedOperationException();
    }
  ...
  @Deprecated public static boolean device(int type, Socket frontend, Socket backend) {
  ...
  public static int getFullVersion() {
    return zmq.ZMQ.ZMQ_MAKE_VERSION(zmq.ZMQ.ZMQ_VERSION_MAJOR, zmq.ZMQ.ZMQ_VERSION_MINOR, zmq.ZMQ.ZMQ_VERSION_PATCH);
  }
