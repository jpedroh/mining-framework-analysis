...
/**
 * Reusable assertions for two-dimensional arrays of {@code double}s.
 * 
 * @author Maciej Wajcht
 */
public class Double2DArrays {
   ...
   */
  public void assertHasDimensions(AssertionInfo info, double[][] actual, int expectedFirstDimension, int expectedSecondDimension) {
