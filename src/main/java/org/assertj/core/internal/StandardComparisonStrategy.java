...
public class StandardComparisonStrategy extends AbstractComparisonStrategy {
  ...
  @Override protected Set<Object> newSetUsingComparisonStrategy() {
   ...
   */
  @Override public boolean areEqual(Object actual, Object other) {
   ...
   *         false otherwise.
   */
  @Override public boolean iterableContains(Iterable<?> iterable, Object value) {
    if (iterable == null) {
      return false;
    }
   ...
   * {@inheritDoc}
   */
  @Override public void iterableRemoves(Iterable<?> iterable, Object value) {
    if (iterable == null) {
      return;
    }
   ...
   * {@inheritDoc}
   */
  @Override public void iterablesRemoveFirst(Iterable<?> iterable, Object value) {
    if (iterable == null) {
      return;
    }
    Iterator<?> iterator = iterable.iterator();
   ...
   */
  @Override public Iterable<?> duplicatesFrom(Iterable<?> iterable) {
    return super.duplicatesFrom(iterable);
  }

  @Override public boolean stringStartsWith(String string, String prefix) {
    return string.startsWith(prefix);
  }

  @Override public boolean stringEndsWith(String string, String suffix) {
    return string.endsWith(suffix);
  }

  @Override public boolean stringContains(String string, String sequence) {
    return string.contains(sequence);
  }

  @SuppressWarnings(value = { "unchecked" }) @Override public boolean isGreaterThan(Object actual, Object other) {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public boolean isLessThan(Object actual, Object other) {
    if (!(actual instanceof Comparable)) {
      throw new IllegalArgumentException(format("argument \'%s\' should be Comparable but is not", actual));
    }
    return Comparable.class.cast(actual).compareTo(other) < 0;
