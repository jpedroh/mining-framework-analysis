...
/**
 * Reusable assertions for two-dimensional arrays of {@code long}s.
 * 
...
public class Long2DArrays {
   ...
   */
  public static Long2DArrays instance() {
    return INSTANCE;
  }
   ...
   */
  public void assertHasDimensions(AssertionInfo info, long[][] actual, int expectedFirstDimension, int expectedSecondDimension) {
   ...
   */
  public void assertHasSameDimensionsAs(AssertionInfo info, long[][] actual, Object other) {
