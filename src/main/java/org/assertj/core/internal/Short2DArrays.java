...
public class Short2DArrays {
  ...
  @VisibleForTesting public void setArrays(Arrays2D arrays) {
    this.arrays = arrays;
  }
   ...
   */
  public void assertHasDimensions(AssertionInfo info, short[][] actual, int expectedFirstDimensionSize, int expectedSecondDimensionSize) {
    arrays.assertHasDimensions(info, failures, actual, expectedFirstDimensionSize, expectedSecondDimensionSize);
  }
   ...
   */
  public void assertHasSameDimensionsAs(AssertionInfo info, short[][] actual, Object other) {
