 ...
 */
public class Object2DArrays<ELEMENT extends java.lang.Object> {
  /**
   ...
   */
  public static <ELEMENT extends java.lang.Object> Object2DArrays<ELEMENT> instance() {
    return new Object2DArrays<>();
  }

  private Arrays2D arrays = Arrays2D.instance();

  @VisibleForTesting void setArrays(Arrays2D arrays) {
    this.arrays = arrays;
  }
   ...
   */
  public void assertHasDimensions(AssertionInfo info, ELEMENT[][] actual, int expectedFirstDimension, int expectedSecondDimension) {
