...
@CheckReturnValue public class Assertions {
   ...
   * @since 2.7.0 / 3.7.0
   */
  @CheckReturnValue public static <RESULT extends java.lang.Object> AbstractFutureAssert<?, ? extends Future<? extends RESULT>, RESULT> assertThat(Future<RESULT> actual) {
   ...
   * @return the created assertion object.
   */
  @CheckReturnValue public static <ELEMENT extends java.lang.Object, STREAM extends BaseStream<ELEMENT, STREAM>> AbstractListAssert<?, List<? extends ELEMENT>, ELEMENT, ObjectAssert<ELEMENT>> assertThat(BaseStream<? extends ELEMENT, STREAM> actual) {
    return AssertionsForInterfaceTypes.assertThat(actual);
  }
