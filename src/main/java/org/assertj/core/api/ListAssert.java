 ...
 */
public class ListAssert<ELEMENT extends java.lang.Object> extends FactoryBasedNavigableListAssert<ListAssert<ELEMENT>, List<? extends ELEMENT>, ELEMENT, ObjectAssert<ELEMENT>> {
  ...
  @Override public ListAssert<ELEMENT> isEqualTo(Object expected) {
  ...
  @Override public ListAssert<ELEMENT> isInstanceOf(Class<?> type) {
  ...
  @Override public ListAssert<ELEMENT> isInstanceOfAny(Class<?>... types) {
    if (actual instanceof ListFromStream) {
  ...
  @Override public ListAssert<ELEMENT> isOfAnyClassIn(Class<?>... types) {
    if (actual instanceof ListFromStream) {
  ...
  @Override public ListAssert<ELEMENT> isExactlyInstanceOf(Class<?> type) {
    if (actual instanceof ListFromStream) {
  ...
  @Override public ListAssert<ELEMENT> isNotInstanceOf(Class<?> type) {
    if (actual instanceof ListFromStream) {
  ...
  @Override public ListAssert<ELEMENT> isNotInstanceOfAny(Class<?>... types) {
    if (actual instanceof ListFromStream) {
  ...
  @Override public ListAssert<ELEMENT> isNotOfAnyClassIn(Class<?>... types) {
    if (actual instanceof ListFromStream) {
  ...
  @Override public ListAssert<ELEMENT> isNotExactlyInstanceOf(Class<?> type) {
    if (actual instanceof ListFromStream) {
  ...
  @Override public ListAssert<ELEMENT> isSameAs(Object expected) {
    if (actual instanceof ListFromStream) {
  ...
  @Override public ListAssert<ELEMENT> isNotSameAs(Object expected) {
    if (actual instanceof ListFromStream) {
  ...
  @Override @SafeVarargs public final ListAssert<ELEMENT> startsWith(ELEMENT... sequence) {
    if (!(actual instanceof ListFromStream)) {
      return super.startsWith(sequence);
    }
    objects.assertNotNull(info, actual);
    checkIsNotNull(sequence);
    @SuppressWarnings(value = { "unchecked" }) Iterator<? extends ELEMENT> iterator = asListFromStream().stream().iterator();
  ...
  @Override @SafeVarargs public final ListAssert<ELEMENT> contains(ELEMENT... values) {
  ...
  @Override @SafeVarargs public final ListAssert<ELEMENT> containsOnly(ELEMENT... values) {
    return super.containsOnly(values);
  }

  @SuppressWarnings(value = { "rawtypes" }) private ListFromStream asListFromStream() {
    return (ListFromStream) actual;
  }

  @VisibleForTesting static class ListFromStream<ELEMENT extends java.lang.Object> extends AbstractList<ELEMENT> {
  ...
  @Override @SafeVarargs public final ListAssert<ELEMENT> containsOnlyOnce(ELEMENT... values) {
    return super.containsOnlyOnce(values);
  }

  @Override @SafeVarargs public final ListAssert<ELEMENT> containsExactly(ELEMENT... values) {
    return super.containsExactly(values);
  }

  @Override @SafeVarargs public final ListAssert<ELEMENT> containsExactlyInAnyOrder(ELEMENT... values) {
    return super.containsExactlyInAnyOrder(values);
  }

  @Override @SafeVarargs public final ListAssert<ELEMENT> isSubsetOf(ELEMENT... values) {
    return super.isSubsetOf(values);
  }

  @Override @SafeVarargs public final ListAssert<ELEMENT> containsSequence(ELEMENT... sequence) {
    return super.containsSequence(sequence);
  }

  @Override @SafeVarargs public final ListAssert<ELEMENT> containsSubsequence(ELEMENT... sequence) {
    return super.containsSubsequence(sequence);
  }

  @Override @SafeVarargs public final ListAssert<ELEMENT> doesNotContain(ELEMENT... values) {
    return super.doesNotContain(values);
  }

  @Override @SafeVarargs public final ListAssert<ELEMENT> endsWith(ELEMENT... sequence) {
