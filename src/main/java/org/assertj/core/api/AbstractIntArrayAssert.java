...
public abstract class AbstractIntArrayAssert<S extends AbstractIntArrayAssert<S>> extends AbstractArrayAssert<S, int[], Integer> {
  @VisibleForTesting protected IntArrays arrays = IntArrays.instance();
  ...
  /** {@inheritDoc} */
  @Override public S isSortedAccordingTo(Comparator<? super Integer> comparator) {
    arrays.assertIsSortedAccordingToComparator(info, actual, comparator);
    return myself;
  }

  /** {@inheritDoc} */
  @Override public S usingElementComparator(Comparator<? super Integer> customComparator) {
