...
public class Java6Assertions {
   ...
   * @return the created assertion object.
   */
  @CheckReturnValue public static <T extends java.lang.Object> AbstractIterableAssert<?, Iterable<? extends T>, T, ObjectAssert<T>> assertThat(Iterable<? extends T> actual) {
   ...
   * @return the created assertion object.
   */
  @CheckReturnValue public static <T extends java.lang.Object> AbstractIterableAssert<?, Iterable<? extends T>, T, ObjectAssert<T>> assertThat(Iterator<? extends T> actual) {
    return new IterableAssert<>(actual);
  }
   ...
   * @return the created assertion object.
   */
  @CheckReturnValue public static <T extends java.lang.Object> AbstractListAssert<?, List<? extends T>, T, ObjectAssert<T>> assertThat(List<? extends T> actual) {
