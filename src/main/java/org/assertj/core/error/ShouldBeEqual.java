...
public class ShouldBeEqual implements AssertionErrorFactory {
  ...
  @VisibleForTesting final MessageFormatter messageFormatter = MessageFormatter.instance();
  ...
  @VisibleForTesting ShouldBeEqual(Object actual, Object expected, ComparisonStrategy comparisonStrategy, Representation representation) {
    this.actual = actual;
   ...
   */
  @Override public AssertionError newAssertionError(Description description, Representation representation) {
  ...
  private String smartErrorMessage(Description description, Representation representation) {
    ...
    return comparisonStrategy.isStandard() ? messageFormatter.format(description, representation, EXPECTED_BUT_WAS_MESSAGE, actual, expected) : messageFormatter.format(description, representation, EXPECTED_BUT_WAS_MESSAGE_USING_COMPARATOR, actual, expected, comparisonStrategy);
  }
  ...
  private String defaultDetailedErrorMessage(Description description, Representation representation) {
    if (comparisonStrategy instanceof ComparatorBasedComparisonStrategy) {
      return messageFormatter.format(description, representation, EXPECTED_BUT_WAS_MESSAGE_USING_COMPARATOR, detailedActual(), detailedExpected(), comparisonStrategy);
    }
  ...
  private AssertionError assertionFailedError(String message) {
    try {
      Object o = constructorInvoker.newInstance("org.opentest4j.AssertionFailedError", MSG_ARG_TYPES_FOR_ASSERTION_FAILED_ERROR, message, expected, actual);
