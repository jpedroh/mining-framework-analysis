...
public final class Lists {
   ...
   */
  @SafeVarargs public static <T extends java.lang.Object> ArrayList<T> newArrayList(T... elements) {
    if (elements == null) {
      return null;
    }
   ...
   */
  public static <T extends java.lang.Object> ArrayList<T> newArrayList(Iterable<? extends T> elements) {
    if (elements == null) {
      return null;
    }
    ArrayList<T> list = newArrayList();
   ...
   */
  public static <T extends java.lang.Object> ArrayList<T> newArrayList(Iterator<? extends T> elements) {
    if (elements == null) {
      return null;
    }
    ArrayList<T> list = newArrayList();
   ...
   * @return the created {@code ArrayList}, of {@code null} if the given array of elements is {@code null}.
   */
  public static <T extends java.lang.Object> ArrayList<T> newArrayList() {
