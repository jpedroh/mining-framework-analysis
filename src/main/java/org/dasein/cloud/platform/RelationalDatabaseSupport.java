...
public interface RelationalDatabaseSupport extends AccessControlledService {
  ...
  /**
     ...
     *
     */
  @Deprecated public Iterable<DatabaseProduct> getDatabaseProducts(DatabaseEngine forEngine) throws CloudException, InternalException;
  ...
  @Deprecated public String getProviderTermForDatabase(Locale locale);

  @Deprecated public String getProviderTermForSnapshot(Locale locale);

  public DatabaseSnapshot getSnapshot(String providerDbSnapshotId) throws CloudException, InternalException;

  public boolean isSubscribed() throws CloudException, InternalException;

  @Deprecated public boolean isSupportsFirewallRules();

  @Deprecated public boolean isSupportsHighAvailability() throws CloudException, InternalException;

  @Deprecated public boolean isSupportsLowAvailability() throws CloudException, InternalException;

  @Deprecated public boolean isSupportsMaintenanceWindows();

  @Deprecated public boolean isSupportsSnapshots();
