...
public interface LoadBalancerSupport extends AccessControlledService {
  ...
  public @Nonnull @Deprecated Iterable<LoadBalancerServer> getLoadBalancerServerHealth(@Nonnull String loadBalancerId) throws CloudException, InternalException;

  public @Nonnull @Deprecated Iterable<LoadBalancerServer> getLoadBalancerServerHealth(@Nonnull String loadBalancerId, @Nonnull String... serverIdsToCheck) throws CloudException, InternalException;
  ...
  public @Nonnull @Deprecated String create(@Nonnull String name, @Nonnull String description, @Nullable String addressId, @Nullable String[] dataCenterIds, @Nullable LbListener[] listeners, @Nullable String[] serverIds, @Nullable String[] subnetIds, @Nullable LbType type) throws CloudException, InternalException;

  public @Deprecated void remove(@Nonnull String loadBalancerId) throws CloudException, InternalException;

  public @Deprecated boolean requiresListenerOnCreate() throws CloudException, InternalException;

  public @Deprecated boolean requiresServerOnCreate() throws CloudException, InternalException;
