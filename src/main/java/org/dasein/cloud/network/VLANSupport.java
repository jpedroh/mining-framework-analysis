...
public interface VLANSupport extends AccessControlledService {
     ...
     * 		an error occurred with the cloud provider while performing the operation
     * @throws InternalException
     * 		an error occurred locally independent of any events in the cloud
     * @throws UnsupportedOperationException
     * 		this cloud doesn't support vlan creation using the specified options
     */
    @Nonnull
    public abstract VLAN createVlan(@Nonnull
    VlanCreateOptions options) throws InternalException, CloudException;
