...
public interface VLANSupport extends AccessControlledService {
  ...
  /**
     ...
     */
  @Deprecated public boolean allowsNewNetworkInterfaceCreation() throws CloudException, InternalException;

  @Deprecated public boolean allowsNewVlanCreation() throws CloudException, InternalException;

  @Deprecated public boolean allowsNewRoutingTableCreation() throws CloudException, InternalException;

  @Deprecated public boolean allowsNewSubnetCreation() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public boolean allowsMultipleTrafficTypesOverSubnet() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public boolean allowsMultipleTrafficTypesOverVlan() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public int getMaxNetworkInterfaceCount() throws CloudException, InternalException;

  @Deprecated public int getMaxVlanCount() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull String getProviderTermForNetworkInterface(@Nonnull Locale locale);

  @Deprecated public @Nonnull String getProviderTermForSubnet(@Nonnull Locale locale);

  @Deprecated public @Nonnull String getProviderTermForVlan(@Nonnull Locale locale);
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Requirement getRoutingTableSupport() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Requirement getSubnetSupport() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Requirement identifySubnetDCRequirement() throws CloudException, InternalException;
  ...
  @Deprecated public boolean isSubnetDataCenterConstrained() throws CloudException, InternalException;

  @Deprecated public boolean isVlanDataCenterConstrained() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Iterable<RoutingTable> listRoutingTables(@Nonnull String vlanId) throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public boolean supportsInternetGatewayCreation() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public boolean supportsRawAddressRouting() throws CloudException, InternalException;
  ...
  /**
     ...
     * @throws InternalException an error occurred within the Dasein Cloud API implementation
     */
  public abstract void updateRoutingTableTags(@Nonnull String routingTableId, boolean asynchronous, @Nonnull Tag... tags) throws CloudException, InternalException;
  ...
  /**
     ...
     * @throws InternalException an error occurred within the Dasein Cloud API implementation
     */
  public abstract void updateRoutingTableTags(@Nonnull String[] routingTableIds, boolean asynchronous, @Nonnull Tag... tags) throws CloudException, InternalException;
  ...
  /**
     ...
     * @throws InternalException an error occurred within the Dasein Cloud API implementation
     */
  public abstract void updateInternetGatewayTags(@Nonnull String internetGatewayId, boolean asynchronous, @Nonnull Tag... tags) throws CloudException, InternalException;
