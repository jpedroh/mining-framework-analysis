...
public class Firewall implements Networkable, Taggable {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public @Nullable String getName() {
    return name;
  }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public @Nullable String getProviderFirewallId() {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public @Nullable String getRegionId() {
    return regionId;
  }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public boolean isActive() {
    return active;
  }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public boolean isAvailable() {
    return available;
  }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public void setActive(boolean active) {
    this.active = active;
  }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public void setAvailable(boolean available) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public void setName(@Nonnull String name) {
    this.name = name;
  }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public void setProviderFirewallId(@Nonnull String providerFirewallId) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public void setRegionId(@Nonnull String regionId) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public @Nullable String getDescription() {
    return description;
  }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public void setDescription(@Nonnull String description) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public void setProviderVlanId(@Nullable String providerVlanId) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public @Nullable String getProviderVlanId() {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public @Nonnull Collection<FirewallRule> getRules() {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) public @Nonnull void setRules(Collection<FirewallRule> ruleList) {
    rules = ruleList;
  }
