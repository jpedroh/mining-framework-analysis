...
@SuppressWarnings(value = { "UnusedDeclaration" }) public interface SnapshotSupport extends AccessControlledService {
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull String getProviderTermForSnapshot(@Nonnull Locale locale);
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Requirement identifyAttachmentRequirement() throws InternalException, CloudException;
  ...
  /**
     ...
     */
  @Deprecated public boolean supportsSnapshotCopying() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public boolean supportsSnapshotCreation() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public boolean supportsSnapshotSharing() throws InternalException, CloudException;
  ...
  /**
     ...
     */
  @Deprecated public boolean supportsSnapshotSharingWithPublic() throws InternalException, CloudException;
