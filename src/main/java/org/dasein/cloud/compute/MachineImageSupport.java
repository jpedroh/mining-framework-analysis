 ...
 * @since unknown
 */
@SuppressWarnings(value = { "UnusedDeclaration" }) public interface MachineImageSupport extends AccessControlledService {
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull String getProviderTermForImage(@Nonnull Locale locale);
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull String getProviderTermForImage(@Nonnull Locale locale, @Nonnull ImageClass cls);
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull String getProviderTermForCustomImage(@Nonnull Locale locale, @Nonnull ImageClass cls);
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Requirement identifyLocalBundlingRequirement() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Iterable<MachineImageFormat> listSupportedFormats() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Iterable<MachineImageFormat> listSupportedFormatsForBundling() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Iterable<ImageClass> listSupportedImageClasses() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Iterable<MachineImageType> listSupportedImageTypes() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public boolean supportsDirectImageUpload() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public boolean supportsImageCapture(@Nonnull MachineImageType type) throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public boolean supportsImageSharingWithPublic() throws CloudException, InternalException;
  ...
  /**
     ...
     */
  @Deprecated public boolean supportsPublicLibrary(@Nonnull ImageClass cls) throws CloudException, InternalException;
