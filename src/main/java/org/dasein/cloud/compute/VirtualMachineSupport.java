...
@SuppressWarnings(value = { "UnusedDeclaration" }) public interface VirtualMachineSupport extends AccessControlledService {
  ...
  /**
     ...
     */
  @Deprecated public VirtualMachine alterVirtualMachine(@Nonnull String vmId, @Nonnull VMScalingOptions options) throws InternalException, CloudException;
  ...
  /**
     ...
     * @throws CloudException    an error occurred in the cloud processing the request
     */
  @Deprecated public abstract VirtualMachine modifyInstance(@Nonnull String vmId, @Nonnull String[] firewalls) throws InternalException, CloudException;
