 ...
 */
@SuppressWarnings(value = { "UnusedDeclaration" }) public interface VolumeSupport extends AccessControlledService {
  ...
  /**
     ...
     */
  @Deprecated public int getMaximumVolumeCount() throws InternalException, CloudException;
  ...
  /**
     ...
     */
  @Deprecated public @Nullable Storage<Gigabyte> getMaximumVolumeSize() throws InternalException, CloudException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Storage<Gigabyte> getMinimumVolumeSize() throws InternalException, CloudException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull String getProviderTermForVolume(@Nonnull Locale locale);
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Requirement getVolumeProductRequirement() throws InternalException, CloudException;
  ...
  /**
     ...
     */
  @Deprecated public boolean isVolumeSizeDeterminedByProduct() throws InternalException, CloudException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Iterable<String> listPossibleDeviceIds(@Nonnull Platform platform) throws InternalException, CloudException;
  ...
  /**
     ...
     */
  @Deprecated public @Nonnull Iterable<VolumeFormat> listSupportedFormats() throws InternalException, CloudException;
