...
public abstract class AbstractVMSupport<T extends CloudProvider> implements VirtualMachineSupport {
  ...
  @Override public Iterable<VirtualMachineProduct> listProducts(VirtualMachineProductFilterOptions options) throws InternalException, CloudException {
    throw new OperationNotSupportedException("Product size filtering not implemented for " + getProvider().getCloudName());
  }

  @Override public Iterable<VirtualMachineProduct> listProducts(VirtualMachineProductFilterOptions options, Architecture architecture) throws InternalException, CloudException {
    throw new OperationNotSupportedException("Product size filtering not implemented for " + getProvider().getCloudName());
  }
