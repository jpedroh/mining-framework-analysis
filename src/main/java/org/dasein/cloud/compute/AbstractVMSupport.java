...
public abstract class AbstractVMSupport<T extends CloudProvider> implements VirtualMachineSupport {
  ...
  @Override public void cancelSpotInstanceRequest(String providerSpotInstanceRequestID) throws CloudException, InternalException {
    throw new OperationNotSupportedException("Spot Instances are not supported for " + getProvider().getCloudName());
  }
  ...
  @Override public @Nonnull SpotInstanceRequest createSpotInstanceRequest(SIRequestCreateOptions options) throws CloudException, InternalException {
    throw new OperationNotSupportedException("Spot Instances are not supported for " + getProvider().getCloudName());
  }
  ...
  @Override public void enableSpotDataFeedSubscription(String s3BucketName) throws CloudException, InternalException {
    throw new OperationNotSupportedException("Spot Instances are not supported for " + getProvider().getCloudName());
  }
  ...
  @Override public @Nonnull Iterable<VirtualMachineProduct> listProducts(@Nonnull Architecture architecture) throws InternalException, CloudException {
    return listProducts(architecture, null);
  }

  @Override public @Nonnull Iterable<VirtualMachineProduct> listProducts(@Nonnull Architecture architecture, String preferedDataCenterId) throws InternalException, CloudException {
  ...
  @Override public Iterable<SpotPriceHistory> listSpotPriceHistories(SPHistoryFilterOptions options) throws CloudException, InternalException {
    throw new OperationNotSupportedException("Spot Instances are not supported for " + getProvider().getCloudName());
  }
  ...
  @Override public void updateTags(@Nonnull String vmId, boolean asynchronous, @Nonnull Tag... tags) throws CloudException, InternalException {
  }

  @Override public void updateTags(@Nonnull String[] vmIds, boolean asynchronous, @Nonnull Tag... tags) throws CloudException, InternalException {
    for (String id : vmIds) {
