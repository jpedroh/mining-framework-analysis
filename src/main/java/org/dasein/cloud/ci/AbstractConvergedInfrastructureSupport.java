...
public abstract class AbstractConvergedInfrastructureSupport<T extends CloudProvider> extends AbstractProviderService<T> implements ConvergedInfrastructureSupport {
  ...
  @Override public @Nullable ConvergedInfrastructure getConvergedInfrastructure(@Nonnull String ciId) throws CloudException, InternalException {
  ...
  @Override public @Nonnull Iterable<ResourceStatus> listConvergedInfrastructureStatus() throws CloudException, InternalException {
  ...
  @Override public void updateTags(@Nonnull String ciId, @Nonnull Tag... tags) throws CloudException, InternalException {
  }

  @Override public void updateTags(@Nonnull String[] ciIds, @Nonnull Tag... tags) throws CloudException, InternalException {
    for (String id : ciIds) {
      updateTags(id, tags);
    }
  }

  @Override public void removeTags(@Nonnull String ciId, @Nonnull Tag... tags) throws CloudException, InternalException {
  }

  @Override public void removeTags(@Nonnull String[] ciIds, @Nonnull Tag... tags) throws CloudException, InternalException {
    for (String id : ciIds) {
      removeTags(id, tags);
    }
  }
