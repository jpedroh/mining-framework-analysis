...
public abstract class CloudProvider {
  @SuppressWarnings(value = { "UnusedDeclaration" }) static private @Nonnull String getLastItem(@Nonnull String name) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "deprecation" }) @Deprecated public final void connect(@Nonnull ProviderContext context) {
  ...
  /**
     ...
     */
  @Deprecated public final void connect(@Nonnull ProviderContext context, @Nullable CloudProvider computeProvider) {
    try {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "deprecation" }) protected void connect(@Nonnull ProviderContext context, @Nullable CloudProvider computeProvider, @Nullable Cloud myCloud) throws CloudException, InternalException {
    close();
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "deprecation" }) public synchronized @Nullable StorageServices getStorageServices() {
