...
public class FilterBenchmark {
  ...
  public static void chainingSchedule() {
    ...
    int arEx[][] = { { 2, 2, 2 }, { 2, 3, 2 }, { 4, 4, 2 }, { 1, 1, 3 }, { 1, 2, 3 }, { 2, 2, 3 }, { 2, 3, 3 }, { 2, 4, 3 }, { 3, 4, 3 }, { 2, 2, 4 }, { 2, 3, 4 }, { 3, 4, 4 } };
    for (int i = 0; i < arEx.length; i++) {
    ...
    int dctEx[][] = { { 2, 1, 2 }, { 2, 2, 2 }, { 3, 2, 2 }, { 4, 2, 2 }, { 4, 3, 2 }, { 5, 4, 2 }, { 1, 1, 3 }, { 2, 1, 3 }, { 3, 2, 3 }, { 4, 2, 3 }, { 5, 3, 3 } };
    for (int i = 0; i < dctEx.length; i++) {
  ...
  public static int experiment1(Store store, Filter filter, int addNum, int mulNum) {
    ...
    SelectChoicePoint<IntVar> select = new SimpleMatrixSelect<IntVar>(vars, new SmallestMin<IntVar>(), new MostConstrainedStatic<IntVar>(), new IndomainMin<IntVar>(), 0);
  ...
  public static int experiment1PM(Store store, Filter filter, int addNum, int mulNum) {
    ...
    SelectChoicePoint<IntVar> select = new SimpleMatrixSelect<IntVar>(vars, new SmallestMax<IntVar>(), new MostConstrainedStatic<IntVar>(), new IndomainMin<IntVar>(), 0);
    System.out.println("\nVariable store size: " + store.size() + "\nNumber of constraints: " + store.numberConstraints());
    result = store.consistency();
  ...
  public static int experiment2PM(Store store, Filter filter, int addNum, int mulNum) {
    ...
    SelectChoicePoint<IntVar> selectMC = new SimpleSelect<IntVar>(varsTs, new MostConstrainedStatic<IntVar>(), new SmallestDomain<IntVar>(), new IndomainMin<IntVar>());
  ...
  public static int experiment2P(Store store, Filter filter, int addNum, int mulNum) {
    ...
    SelectChoicePoint<IntVar> selectMC = new SimpleSelect<IntVar>(varsTs, new SmallestMin<IntVar>(), new MostConstrainedStatic<IntVar>(), new IndomainMin<IntVar>());
    SelectChoicePoint<IntVar> selectIO = new SimpleSelect<IntVar>(varsRs, null, null, new IndomainMin<IntVar>());
  ...
  public static List<List<IntVar>> makeConstraintsPipeMultiplier(Store store, Filter filter, int addNum, int mulNum) {
    ...
    int[] lastOp = filter.lastOp();
    IntVar addDelay = new IntVar(store, filter.addDel(), filter.addDel());
    IntVar mulDelay = new IntVar(store, 1, 1);
    IntVar one = new IntVar(store, 1, 1);
    IntVar T[] = new IntVar[delays.length];
    IntVar R[] = new IntVar[delays.length];
    int D[] = new int[delays.length];
