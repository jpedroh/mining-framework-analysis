 ...
 */
@SuppressWarnings(value = { "unused" }) @Mojo(name = "jdeb", defaultPhase = LifecyclePhase.PACKAGE) public class DebMojo extends AbstractPluginMojo {
  ...
  /**
     ...
     */
  @Parameter(defaultValue = "false") private boolean timestamped;
