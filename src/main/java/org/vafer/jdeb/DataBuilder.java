  ...
  BigInteger buildData(Collection<DataProducer> producers, File output, final StringBuilder checksums, TarOptions options) throws NoSuchAlgorithmException, IOException, CompressorException {
    ...
    final DataConsumer receiver = new DataConsumer() {
      ...
      public void onEachFile(InputStream input, TarArchiveEntry fileEntry) throws IOException {
        ...
        console.debug("file:" + fileEntry.getName() + " size:" + fileEntry.getSize() + " mode:" + fileEntry.getMode() + " linkname:" + fileEntry.getLinkName() + " username:" + fileEntry.getUserName() + " userid:" + fileEntry.getLongUserId() + " groupname:" + fileEntry.getGroupName() + " groupid:" + fileEntry.getLongGroupId() + " modtime:" + fileEntry.getModTime() + " md5: " + md5);
      ...
      public void onEachLink(TarArchiveEntry entry) throws IOException {
        ...
        tarOutputStream.closeArchiveEntry();
        console.debug("link:" + entry.getName() + " mode:" + entry.getMode() + " linkname:" + entry.getLinkName() + " username:" + entry.getUserName() + " userid:" + entry.getLongUserId() + " groupname:" + entry.getGroupName() + " groupid:" + entry.getLongGroupId());
      }
