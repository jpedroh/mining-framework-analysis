...
public class LdapProviderConfiguration implements UserGroupProviderConfiguration {
  ...
  @Override public String getProviderClass() {
  ...
  @Override public boolean isCreateSupported() {
    return true;
  }

  @Override public String getCreateJSP() {
    return "/modules/ldap/userGroupProviderEdit.jsp";
  }

  @Override public String create(Map<String, Object> parameters, Map<String, Object> flashScope) throws Exception {
  ...
  @Override public boolean isEditSupported() {
    return true;
  }

  @Override public String getEditJSP() {
    return "/modules/ldap/userGroupProviderEdit.jsp";
  }

  @Override public void edit(String providerKey, Map<String, Object> parameters, Map<String, Object> flashScope) throws Exception {
    Properties properties = getProperties(parameters);
    flashScope.put("ldapProperties", properties);
    if (!testConnection(properties)) {
      throw new Exception("Connection to the LDAP server impossible");
    ...
    if (providerKey.equals("ldap")) {
      ...
      if (providerKey.startsWith("ldap.")) {
  ...
  @Override public boolean isDeleteSupported() {
    return true;
  }

  @Override public void delete(String providerKey, Map<String, Object> flashScope) throws Exception {
    String configName;
    if (providerKey.equals("ldap")) {
      configName = jahiaLDAPConfigFactory.getName() + "-config.cfg";
    } else {
  ...
  private boolean testConnection(Properties p) throws Exception {
    return testConnection(getValue(p, "url", "user.url", "group.url"), getValue(p, "public.bind.dn", "user.public.bind.dn", "group.public.bind.dn"), getValue(p, "public.bind.password", "user.public.bind.password", "group.public.bind.password"));
  }
