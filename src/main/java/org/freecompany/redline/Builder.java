...
<<<<<<< /usr/src/app/output/craigwblake/redline/a38b7a65a974b98a0763d1ff45b63caab7dd2913/src/main/java/org/freecompany/redline/Builder.java/left.java
  private static final char[] ILLEGAL_CHARS_VARIABLE = new char[] { '-', '~', '/' };
=======
  protected File privateKeyRingFile;
>>>>>>> /usr/src/app/output/craigwblake/redline/a38b7a65a974b98a0763d1ff45b63caab7dd2913/src/main/java/org/freecompany/redline/Builder.java/right.java
...
>>>>>>> /usr/src/app/output/craigwblake/redline/a38b7a65a974b98a0763d1ff45b63caab7dd2913/src/main/java/org/freecompany/redline/Builder.java/right.java
  ...
  @SuppressWarnings(value = { "unchecked" }) protected final Entry<byte[]> signature = (Entry<byte[]>) format.getSignature().addEntry(SIGNATURES, 16);

  @SuppressWarnings(value = { "unchecked" }) protected final Entry<byte[]> immutable = (Entry<byte[]>) format.getHeader().addEntry(HEADERIMMUTABLE, 16);
  ...
  public void setDistribution(final CharSequence distribution) {
    if (distribution != null) {
      format.getHeader().createEntry(DISTRIBUTION, distribution);
    }
  }
  ...
  public void setSourceRpm(final String rpm) {
    if (rpm != null) {
      format.getHeader().createEntry(SOURCERPM, rpm);
    }
  }
  ...
  public void setPrefixes(final String... prefixes) {
    if (prefixes != null) {
      format.getHeader().createEntry(PREFIXES, prefixes);
    }
  }
  ...
  public void setPreTransScript(final String script) {
    ...
    if (script != null) {
      format.getHeader().createEntry(PRETRANSSCRIPT, script);
    }
  }
  ...
  public void setPreInstallScript(final String script) {
    ...
    if (script != null) {
      format.getHeader().createEntry(PREINSCRIPT, script);
    }
  }
  ...
  public void setPostInstallScript(final String script) {
    ...
    if (script != null) {
      format.getHeader().createEntry(POSTINSCRIPT, script);
    }
  }
  ...
  public void setPreUninstallScript(final String script) {
    ...
    if (script != null) {
      format.getHeader().createEntry(PREUNSCRIPT, script);
    }
  }
  ...
  public void setPostUninstallScript(final String script) {
    ...
    if (script != null) {
      format.getHeader().createEntry(POSTUNSCRIPT, script);
    }
  }
  ...
  public void setPostTransScript(final String script) {
    ...
    if (script != null) {
      format.getHeader().createEntry(POSTTRANSSCRIPT, script);
    }
  }
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) public void build(final FileChannel original) throws NoSuchAlgorithmException, IOException {
