...
public class LaneChangingInputDataImpl implements LaneChangingInputData {
  ...
  private double critSpeedEuroRules;
  ...
  @Override public boolean isInitializedMobilData() {
    return isInitializedMobilData;
  }

  @Override public boolean isWithEuropeanRules() {
    return isWithEuropeanRules;
  }

  @Override public double getCritSpeedEuroRules() {
    return critSpeedEuroRules;
  }

  @Override public LaneChangingMobilData getLcMobilData() {
    return lcMobilData;
  }
}