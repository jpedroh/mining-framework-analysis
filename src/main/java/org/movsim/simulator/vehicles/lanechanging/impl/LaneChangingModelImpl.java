...
public class LaneChangingModelImpl implements LaneChangingModel {
  ...
  public static double LANECHANGE_TDELAY_S = 3.0;

  public static double LANECHANGE_TDELAY_FRONT_S = 3.0;
  ...
  @Override public boolean isMandatoryLaneChangeSafe(double dt, final VehicleContainer vehContainerTargetLane) {
    final Vehicle frontMain = vehContainerTargetLane.getLeader(me);
    final Vehicle backMain = vehContainerTargetLane.getFollower(me);
    final boolean changeSafe = mandatoryWeavingChange(frontMain, backMain);
    return changeSafe;
  }
