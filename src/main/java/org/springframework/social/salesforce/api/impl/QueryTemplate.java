...
public class QueryTemplate extends AbstractSalesForceOperations<Salesforce> implements QueryOperations {
  ...
  @Override public QueryResult query(String query, boolean includeDeletedItems) {
  ...
  @Override public QueryResult nextPage(String pathOrToken) {
    requireAuthorization();
  ...
  /**
     ...
     */
  @Override public QueryResult queryAll(String query) {
