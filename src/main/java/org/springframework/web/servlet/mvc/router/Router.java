...
>>>>>>> /usr/src/app/output/resthub/springmvc-router/43b5984109507a1956226b3ce4bb4641cf1f4dbf/src/main/java/org/springframework/web/servlet/mvc/router/Router.java/right.java
  ...
  static void parse(
<<<<<<< /usr/src/app/output/resthub/springmvc-router/43b5984109507a1956226b3ce4bb4641cf1f4dbf/src/main/java/org/springframework/web/servlet/mvc/router/Router.java/left.java
  InputStream routeFile
=======
  String content
>>>>>>> /usr/src/app/output/resthub/springmvc-router/43b5984109507a1956226b3ce4bb4641cf1f4dbf/src/main/java/org/springframework/web/servlet/mvc/router/Router.java/right.java
  , String prefix, String fileAbsolutePath) throws IOException {
    int lineNumber = 0;
          ...
          for (Route.Arg arg : route.args) {
            ...
            if (value == null) {
              ...
              if (value instanceof List<?>) {
                @SuppressWarnings(value = { "unchecked" }) List<Object> l = (List<Object>) value;
                value = l.get(0);
              }
            ...
            for (Map.Entry<String, Object> entry : args.entrySet()) {
              ...
              if (inPathArgs.contains(key) && value != null) {
                if (List.class.isAssignableFrom(value.getClass())) {
                  @SuppressWarnings(value = { "unchecked" }) List<Object> vals = (List<Object>) value;
                  try {
                ...
                if (route.staticArgs.containsKey(key)) {
                } else {
                  if (value != null) {
                    if (List.class.isAssignableFrom(value.getClass())) {
                      @SuppressWarnings(value = { "unchecked" }) List<Object> vals = (List<Object>) value;
