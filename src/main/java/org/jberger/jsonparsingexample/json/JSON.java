...
public class JSON {
  ...
  private static void saveToFiles(ArrayList<String> bookTitles) throws IOException {
    JSONArray 
<<<<<<< /usr/src/app/output/jacquesberger/jsonparsingexample/ac521954c2d20f93d597a8dfbeae1e3f008befda/src/main/java/org/jberger/jsonparsingexample/json/JSON.java/left.java
    outputList = initializeBookList(bookTitles)
=======
    bookTitleList = new JSONArray()
>>>>>>> /usr/src/app/output/jacquesberger/jsonparsingexample/ac521954c2d20f93d597a8dfbeae1e3f008befda/src/main/java/org/jberger/jsonparsingexample/json/JSON.java/right.java
    ;
