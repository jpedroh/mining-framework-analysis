...
public final class Benchmark {
  ...
  private static void generateCmdFile(final String classPath, final File commandFile, final String engineName, final String config, final Properties properties, final String defaultJavaHome) throws Exception {
