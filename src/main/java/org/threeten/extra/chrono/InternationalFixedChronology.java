...
>>>>>>> /usr/src/app/output/threeten/threeten-extra/e5a3e5ebfa32bb843cf0b90c76354f8eeead3ebe/src/main/java/org/threeten/extra/chrono/InternationalFixedChronology.java/right.java
  ...
  /**
     ...
     */
  @Override public InternationalFixedEra eraOf(final int eraValue) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) private Object readResolve() {
    return INSTANCE;
  }
  ...
  /**
     ...
     */
  @Override public boolean isLeapYear(final long year) {
  ...
  /**
     ...
     */
  @Override public InternationalFixedDate date(final Era era, final int yearOfEra, final int month, final int dayOfMonth) {
  ...
  /**
     ...
     */
  @Override public int prolepticYear(final Era era, final int yearOfEra) {
...
>>>>>>> /usr/src/app/output/threeten/threeten-extra/e5a3e5ebfa32bb843cf0b90c76354f8eeead3ebe/src/main/java/org/threeten/extra/chrono/InternationalFixedChronology.java/right.java
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public InternationalFixedDate date(final int prolepticYear, final int month, final int dayOfMonth) {
  ...
  /**
     ...
     */
  @Override public ValueRange range(final ChronoField field) {
    switch (field) {
  ...
  /**
     ...
     * @throws ClassCastException if the {@code era} is not a {@code InternationalFixedEra}
     */
  @Override public InternationalFixedDate dateYearDay(final Era era, final int yearOfEra, final int dayOfYear) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public InternationalFixedDate dateYearDay(final int prolepticYear, final int dayOfYear) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public InternationalFixedDate dateEpochDay(final long epochDay) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public InternationalFixedDate dateNow() {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public InternationalFixedDate dateNow(final ZoneId zone) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public InternationalFixedDate dateNow(final Clock clock) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public InternationalFixedDate date(final TemporalAccessor temporal) {
