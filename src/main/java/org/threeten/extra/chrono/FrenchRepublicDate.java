 ...
 */
public final class FrenchRepublicDate extends AbstractNileDate implements ChronoLocalDate, Serializable {
  /**
  ...
  /**
     ...
     */
  private static final int EPOCH_DAY_DIFFERENCE = 64748;
...
<<<<<<< /usr/src/app/output/threeten/threeten-extra/7fe13bdfa7d8a9cf5f5a40f5070ebb17d22c5e4c/src/main/java/org/threeten/extra/chrono/FrenchRepublicDate.java/left.java
    DAY_OF_WEEK.equals(field)
=======
    WeekFields.ISO.dayOfWeek().equals(field)
...
>>>>>>> /usr/src/app/output/threeten/threeten-extra/7fe13bdfa7d8a9cf5f5a40f5070ebb17d22c5e4c/src/main/java/org/threeten/extra/chrono/FrenchRepublicDate.java/right.java
  ...
  @Override int getEpochDayDifference() {
  ...
  @Override FrenchRepublicDate resolvePrevious(int newYear, int newMonth, int dayOfMonth) {
  ...
  /**
     ...
     */
  @Override public FrenchRepublicChronology getChronology() {
  ...
  /**
     ...
     */
  @Override public FrenchRepublicEra getEra() {
    return (prolepticYear >= 1 ? FrenchRepublicEra.REPUBLICAN : FrenchRepublicEra.BEFORE_REPUBLICAN);
  }

  @Override public FrenchRepublicDate with(TemporalAdjuster adjuster) {
    return (FrenchRepublicDate) adjuster.adjustInto(this);
  }

  @Override public FrenchRepublicDate with(TemporalField field, long newValue) {
    return (FrenchRepublicDate) super.with(field, newValue);
  }

  @Override public FrenchRepublicDate plus(TemporalAmount amount) {
    return (FrenchRepublicDate) amount.addTo(this);
  }

  @Override public FrenchRepublicDate plus(long amountToAdd, TemporalUnit unit) {
    return (FrenchRepublicDate) super.plus(amountToAdd, unit);
  }

  @Override public FrenchRepublicDate minus(TemporalAmount amount) {
    return (FrenchRepublicDate) amount.subtractFrom(this);
  }

  @Override public FrenchRepublicDate minus(long amountToSubtract, TemporalUnit unit) {
    return (amountToSubtract == Long.MIN_VALUE ? plus(Long.MAX_VALUE, unit).plus(1, unit) : plus(-amountToSubtract, unit));
  }

  @Override @SuppressWarnings(value = { "unchecked" }) public ChronoLocalDateTime<FrenchRepublicDate> atTime(LocalTime localTime) {
