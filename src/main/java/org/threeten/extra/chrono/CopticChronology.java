...
public final class CopticChronology extends AbstractNileChronology implements Serializable {
  ...
  /**
     ...
     */
  @Override public CopticDate date(Era era, int yearOfEra, int month, int dayOfMonth) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public CopticDate date(int prolepticYear, int month, int dayOfMonth) {
  ...
  /**
     ...
     * @throws ClassCastException if the {@code era} is not a {@code CopticEra}
     */
  @Override public CopticDate dateYearDay(Era era, int yearOfEra, int dayOfYear) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public CopticDate dateYearDay(int prolepticYear, int dayOfYear) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public CopticDate dateEpochDay(long epochDay) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public CopticDate dateNow() {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public CopticDate dateNow(ZoneId zone) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public CopticDate dateNow(Clock clock) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public CopticDate date(TemporalAccessor temporal) {
  ...
  /**
     ...
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public ChronoLocalDateTime<CopticDate> localDateTime(TemporalAccessor temporal) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date-time
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public ChronoZonedDateTime<CopticDate> zonedDateTime(TemporalAccessor temporal) {
  ...
  /**
     ...
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public ChronoZonedDateTime<CopticDate> zonedDateTime(Instant instant, ZoneId zone) {
  ...
  @Override public CopticEra eraOf(int eraValue) {
  ...
  @Override public CopticDate resolveDate(Map<TemporalField, Long> fieldValues, ResolverStyle resolverStyle) {
