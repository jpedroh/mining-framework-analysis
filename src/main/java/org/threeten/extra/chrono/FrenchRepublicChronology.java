 ...
 */
public final class FrenchRepublicChronology extends AbstractNileChronology implements Serializable {
  /**
  ...
  /**
     ...
     */
  @Deprecated public FrenchRepublicChronology() {
  }
  ...
  /**
     ...
     */
  @Override public FrenchRepublicDate date(Era era, int yearOfEra, int month, int dayOfMonth) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public FrenchRepublicDate date(int prolepticYear, int month, int dayOfMonth) {
  ...
  /**
     ...
     * @throws ClassCastException if the {@code era} is not a {@code FrenchRepublicEra}
     */
  @Override public FrenchRepublicDate dateYearDay(Era era, int yearOfEra, int dayOfYear) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public FrenchRepublicDate dateYearDay(int prolepticYear, int dayOfYear) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public FrenchRepublicDate dateEpochDay(long epochDay) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public FrenchRepublicDate dateNow() {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public FrenchRepublicDate dateNow(ZoneId zone) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public FrenchRepublicDate dateNow(Clock clock) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date
     */
  @Override public FrenchRepublicDate date(TemporalAccessor temporal) {
  ...
  /**
     ...
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public ChronoLocalDateTime<FrenchRepublicDate> localDateTime(TemporalAccessor temporal) {
  ...
  /**
     ...
     * @throws DateTimeException if unable to create the date-time
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public ChronoZonedDateTime<FrenchRepublicDate> zonedDateTime(TemporalAccessor temporal) {
  ...
  /**
     ...
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public ChronoZonedDateTime<FrenchRepublicDate> zonedDateTime(Instant instant, ZoneId zone) {
...
>>>>>>> /usr/src/app/output/threeten/threeten-extra/7fe13bdfa7d8a9cf5f5a40f5070ebb17d22c5e4c/src/main/java/org/threeten/extra/chrono/FrenchRepublicChronology.java/right.java
  ...
  @Override public FrenchRepublicEra eraOf(int eraValue) {
  ...
  @Override public FrenchRepublicDate resolveDate(Map<TemporalField, Long> fieldValues, ResolverStyle resolverStyle) {
