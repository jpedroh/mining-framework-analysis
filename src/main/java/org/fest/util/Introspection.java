...
||||||| /usr/src/app/output/alexruiz/fest-util/ec150f8c4420dbd9d177e880e96f09dca7f35f30/src/main/java/org/fest/util/Introspection.java/base.java
...
>>>>>>> /usr/src/app/output/alexruiz/fest-util/ec150f8c4420dbd9d177e880e96f09dca7f35f30/src/main/java/org/fest/util/Introspection.java/right.java
  ...
  private static IntrospectionError buildIntrospectionErrorForMissingProperty(String propertyName, Object target) {
    ...
    // generic message
    return new IntrospectionError(concat("Unable to find property %s in %s", quote(propertyName), " in ", target.getClass().getName()));
  }
