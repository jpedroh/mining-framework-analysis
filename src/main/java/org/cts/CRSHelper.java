...
public class CRSHelper {
  ...
  public static CoordinateReferenceSystem createCoordinateReferenceSystem(Identifier identifier, Map<String, String> parameters) throws CRSException {
    if ((parameters.get(PrjKeyParameters.PROJCS) != null || parameters.get(PrjKeyParameters.GEOGCS) != null) && parameters.get(PrjKeyParameters.VERTCS) != null) {
    ...
    if (sproj.equalsIgnoreCase(ProjValueParameters.GEOCENT)) {
      ...
      if (sproj.equalsIgnoreCase(ProjValueParameters.LONGLAT)) {
  ...
  private static PrimeMeridian getPrimeMeridian(Map<String, String> param) {
    ...
    if (authCode != null) {
      ...
      id = pmName != null ? new Identifier(authNameWithKey[0], authNameWithKey[1], pmName) : new Identifier(authNameWithKey[0], authNameWithKey[1], Identifiable.UNKNOWN);
    } else {
  ...
  private static GeodeticDatum getDatum(Map<String, String> param) {
    ...
    if (gd == null && authCode != null) {
      String[] authNameWithKey = authCode.split(":");
      Identifier id = datumName != null ? new Identifier(authNameWithKey[0], authNameWithKey[1], datumName) : new Identifier(authNameWithKey[0], authNameWithKey[1], Identifiable.UNKNOWN);
      gd = (GeodeticDatum) IdentifiableComponent.getComponent(id);
    }
    if (param.get(ProjKeyParameters.nadgrids) != null && param.get(ProjKeyParameters.nadgrids).toLowerCase().contains("ntf_r93.gsb")) {
      if (PrimeMeridian.PARIS.equals(getPrimeMeridian(param))) {
        gd = GeodeticDatum.NTF_PARIS;
      } else {
        if (PrimeMeridian.GREENWICH.equals(getPrimeMeridian(param))) {
  ...
  private static VerticalDatum getVerticalDatum(Map<String, String> param) {
    ...
    if (vd == null && authCode != null) {
      String[] authNameWithKey = authCode.split(":");
      id = datumName != null ? new Identifier(authNameWithKey[0], authNameWithKey[1], datumName) : new Identifier(authNameWithKey[0], authNameWithKey[1], Identifiable.UNKNOWN);
              ...
              if (grid.equalsIgnoreCase("ntf_r93.gsb")) {
                ...
                if (aco instanceof FrenchGeocentricNTF2RGF) {
                  ...
                  if (gridNTF instanceof NTv2GridShiftTransformation) {
                    ...
                    crs.getDatum().addGeographicTransformation(GeodeticDatum.WGS84, new CoordinateOperationSequence(ntf_r93.getIdentifier(), LongitudeRotation.getLongitudeRotationFrom(crs.getDatum().getPrimeMeridian()), ntf_r93));
                    crs.getDatum().addGeographicTransformation(GeodeticDatum.RGF93, new CoordinateOperationSequence(ntf_r93.getIdentifier(), LongitudeRotation.getLongitudeRotationFrom(crs.getDatum().getPrimeMeridian()), ntf_r93));
  ...
  private static Ellipsoid getEllipsoid(Map<String, String> param) {
    ...
    if (ellps == null && authorityCode != null) {
      ...
      Identifier id = ellipsoidName != null ? new Identifier(authNameWithKey[0], authNameWithKey[1], ellipsoidName) : new Identifier(authNameWithKey[0], authNameWithKey[1], Identifiable.UNKNOWN);
  ...
  public static class CRSGridCache<K extends java.lang.Object, V extends java.lang.Object> extends LinkedHashMap<K, V> {
