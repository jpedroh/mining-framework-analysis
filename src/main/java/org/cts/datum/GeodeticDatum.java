...
public class GeodeticDatum extends AbstractDatum {
  ...
  /**
     ...
     */
  public final static GeodeticDatum WGS84 = new GeodeticDatum(new Identifier("EPSG", "6326", "World Geodetic System 1984", "WGS 84"), PrimeMeridian.GREENWICH, Ellipsoid.WGS84, GeographicExtent.WORLD, null, null);

  /**
     * Nouvelle Triangulation Française (Paris).
     */
  public final static GeodeticDatum NTF_PARIS = new GeodeticDatum(new Identifier("EPSG", "6807", "Nouvelle Triangulation Fran\u00e7aise (Paris)", "NTF (Paris)"), PrimeMeridian.PARIS, Ellipsoid.CLARKE1880IGN, GeographicExtent.WORLD, "Fundamental point: Pantheon. Latitude: 48 deg 50 min 46.52 sec N; Longitude: 2 deg 20 min 48.67 sec E (of Greenwich).", "1895");
  ...
  /**
     ...
     */
  public final static GeodeticDatum RGF93 = new GeodeticDatum(new Identifier("EPSG", "6171", "R\u00e9seau g\u00e9od\u00e9sique fran\u00e7ais 1993", "RGF93"), PrimeMeridian.GREENWICH, Ellipsoid.GRS80, GeographicExtent.WORLD, "Coincident with ETRS89 at epoch 1993.0", "1993");

  /**
     * European Datum 1950.
     */
  public final static GeodeticDatum ED50 = new GeodeticDatum(new Identifier("EPSG", "6230", "European Datum 1950", "ED50"), PrimeMeridian.GREENWICH, Ellipsoid.INTERNATIONAL1924, GeographicExtent.WORLD, "Fundamental point: Potsdam (Helmert Tower). Latitude: 52 deg 22 min 51.4456 sec N; Longitude: 13 deg  3 min 58.9283 sec E (of Greenwich).", "1950");
  ...
  /**
     ...
     */
  public GeodeticDatum(final PrimeMeridian primeMeridian, final Ellipsoid ellipsoid) {
    this(new Identifier(GeodeticDatum.class, Identifiable.UNKNOWN), primeMeridian, ellipsoid, GeographicExtent.WORLD, null, null);
  }
  ...
  /**
     ...
     * @param ellipsoid the ellipsoid to use with this datum
     */
  public GeodeticDatum(final PrimeMeridian primeMeridian, final Ellipsoid ellipsoid, final CoordinateOperation toWGS84) {
    this(new Identifier(GeodeticDatum.class, Identifiable.UNKNOWN), primeMeridian, ellipsoid, GeographicExtent.WORLD, null, null);
  ...
  /**
     ...
     */
  public GeodeticDatum(final Identifier identifier, final PrimeMeridian primeMeridian, final Ellipsoid ellipsoid, final GeographicExtent extent, final String origin, final String epoch) {
  ...
  public final void setToOtherDatumOperation(CoordinateOperation toOtherDatum, GeodeticDatum targetDatum) {
    if (toOtherDatum != null && toOtherDatum != Identity.IDENTITY) {
      this.addCoordinateOperation(targetDatum, new CoordinateOperationSequence(new Identifier(CoordinateOperation.class, getName() + " to " + targetDatum.getName()), new LongitudeRotation(primeMeridian.getLongitudeFromGreenwichInRadians()), new Geographic2Geocentric(getEllipsoid()), toOtherDatum, new Geocentric2Geographic(targetDatum.getEllipsoid()), new LongitudeRotation(-targetDatum.getPrimeMeridian().getLongitudeFromGreenwichInRadians())));
      try {
      ...
      if (toOtherDatum == Identity.IDENTITY && !primeMeridian.equals(targetDatum.getPrimeMeridian()) && !ellipsoid.equals(targetDatum.getEllipsoid())) {
        ...
        if (toOtherDatum == Identity.IDENTITY && !primeMeridian.equals(targetDatum.getPrimeMeridian())) {
          ...
          if (toOtherDatum == Identity.IDENTITY && !ellipsoid.equals(targetDatum.getEllipsoid())) {
            this.addCoordinateOperation(targetDatum, new CoordinateOperationSequence(new Identifier(CoordinateOperation.class, getName() + " to " + targetDatum.getName()), new Geographic2Geocentric(getEllipsoid()), new Geocentric2Geographic(targetDatum.getEllipsoid())));
            targetDatum.addCoordinateOperation(this, new CoordinateOperationSequence(new Identifier(CoordinateOperation.class, getName() + " to " + targetDatum.getName()), new Geographic2Geocentric(targetDatum.getEllipsoid()), new Geocentric2Geographic(getEllipsoid())));
          } else {
  ...
  /**
     ...
     */
  @Override public CoordinateOperation getToWGS84() {
    return toWGS84;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    if (o instanceof GeodeticDatum) {
      ...
      return ellipsoid.equals(gd.getEllipsoid()) && primeMeridian.equals(gd.getPrimeMeridian()) && toWGS84rs;
    } else {
      return false;
    }
  }
