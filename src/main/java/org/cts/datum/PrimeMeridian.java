...
public class PrimeMeridian extends IdentifiableComponent {
  public static final PrimeMeridian GREENWICH = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8901", "Greenwich", "Greenwich"), 0.0);

  public static final PrimeMeridian LISBON = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8902", "Lisbon", "Lisbon"), -9.0754862);

  public static final PrimeMeridian PARIS = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8903", "Paris", "Paris", "Value adopted by IGN (Paris) in 1936. Equivalent to 2\u00b020\'14.025\". Preferred by EPSG to earlier value of 2\u00b020\'13.95\" (2.596898 grads) used by RGS London", null), 2.337229167);

  public static final PrimeMeridian BOGOTA = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8904", "Bogota", "Bogota"), -74.04513);

  public static final PrimeMeridian MADRID = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8905", "Madrid", "Madrid"), -3.411658);

  public static final PrimeMeridian ROME = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8906", "Rome", "Rome"), 12.27084);

  public static final PrimeMeridian BERN = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8907", "Bern", "Bern", "1895 value. Newer value of 7\u00b026\'22.335\" determined in 1938.", null), 7.26225);

  public static final PrimeMeridian JAKARTA = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8908", "Jakarta", "Jakarta"), 106.482779);

  public static final PrimeMeridian FERRO = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8909", "Ferro", "Ferro", "Used in Austria and former Czechoslovakia.", null), -17.4);

  public static final PrimeMeridian BRUSSELS = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8910", "Brussels", "Brussels"), 4.220471);

  public static final PrimeMeridian STOCKHOLM = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8911", "Stockholm"), 18.03298);

  public static final PrimeMeridian ATHENS = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8912", "Athens", "Athens", "Used in Greece for older mapping based on Hatt projection.", null), 23.4258815);

  public static final PrimeMeridian OSLO = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8913", "Oslo", "Oslo", " Formerly known as Kristiania or Christiania.", null), 10.43225);

  public static final PrimeMeridian PARIS_RGS = createPrimeMeridianFromDDLongitude(new Identifier("EPSG", "8914", "Paris (RGS)", "Paris (RGS)", "Value replaced by IGN (France) in 1936 - see code 8903. Equivalent to 2.596898 grads.", null), 2.201395);
  ...
  private PrimeMeridian checkExistingPrimeMeridian() {
    if (this.equals(PrimeMeridian.GREENWICH)) {
      ...
      if (this.equals(PrimeMeridian.ATHENS)) {
        return PrimeMeridian.ATHENS;
      } else {
        if (this.equals(PrimeMeridian.BERN)) {
          return PrimeMeridian.BERN;
        } else {
          if (this.equals(PrimeMeridian.BOGOTA)) {
            return PrimeMeridian.BOGOTA;
          } else {
            if (this.equals(PrimeMeridian.BRUSSELS)) {
              return PrimeMeridian.BRUSSELS;
            } else {
              if (this.equals(PrimeMeridian.FERRO)) {
                return PrimeMeridian.FERRO;
              } else {
                if (this.equals(PrimeMeridian.JAKARTA)) {
                  return PrimeMeridian.JAKARTA;
                } else {
                  if (this.equals(PrimeMeridian.LISBON)) {
                    return PrimeMeridian.LISBON;
                  } else {
                    if (this.equals(PrimeMeridian.MADRID)) {
                      return PrimeMeridian.MADRID;
                    } else {
                      if (this.equals(PrimeMeridian.OSLO)) {
                        return PrimeMeridian.OSLO;
                      } else {
                        if (this.equals(PrimeMeridian.PARIS)) {
                          return PrimeMeridian.PARIS;
                        } else {
                          if (this.equals(PrimeMeridian.PARIS_RGS)) {
                            return PrimeMeridian.PARIS_RGS;
                          } else {
                            if (this.equals(PrimeMeridian.ROME)) {
                              return PrimeMeridian.ROME;
                            } else {
                              if (this.equals(PrimeMeridian.STOCKHOLM)) {
  ...
  @Override public boolean equals(Object other) {
    ...
    if (other instanceof PrimeMeridian) {
      ...
      if (getAuthorityKey().equals(pm.getAuthorityKey()) || getName().equalsIgnoreCase(pm.getName())) {
        return true;
      }
