...
public class Ellipsoid extends IdentifiableComponent {
  ...
  /**
     * Perfect SPHERE.
     */
  public static final Ellipsoid SPHERE = createEllipsoidFromSemiMinorAxis(new Identifier("EPSG", "7035", "SPHERE"), 6371000.0, 6371000.0);

  /**
     * GRS 1980 ellipsoid, used in most recent spatial geodetic system (1990 and
     * after).
     */
  public static final Ellipsoid GRS80 = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7019", "GRS 1980", "GRS80"), 6378137.0, 298.257222101);

  /**
     * WGS84 ellipsoid, used with the WGS84 spatial geodetic datum. This
     * ellipsoid (and datum) is coherent with GRS80 and the ITRS.
     */
  public static final Ellipsoid WGS84 = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7030", "WGS 84", "WGS84"), 6378137.0, 298.257223563);

  /**
     * International 1924.
     */
  public static final Ellipsoid INTERNATIONAL1924 = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7022", "Intenational 1924", "Int_1924"), 6378388.0, 297.0);

  /**
     * Bessel 1841.
     */
  public static final Ellipsoid BESSEL1841 = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7004", "Bessel 1841", "Bessel_1841"), 6377397.155, 299.1528128);

  /**
     * Clarke 1866.
     */
  public static final Ellipsoid CLARKE1866 = createEllipsoidFromSemiMinorAxis(new Identifier("EPSG", "7008", "Clarke 1866", "Clarke_1866"), 6378206.4, 6356583.8);

  /**
     * Clarke 1880 (IGN).
     */
  public static final Ellipsoid CLARKE1880IGN = createEllipsoidFromSemiMinorAxis(new Identifier("EPSG", "7011", "Clarke 1880 (IGN)", "Clarke_1880_IGN"), 6378249.2, 6356515.0);

  /**
     * Clarke 1880 (RGS) or Clarke 1880 modified.
     */
  public static final Ellipsoid CLARKE1880RGS = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7012", "Clarke 1880 (RGS)", "Clarke_1880_mod"), 6378249.2, 293.465);
  ...
  /**
     ...
     */
  public static final Ellipsoid CLARKE1880ARC = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7013", "Clarke 1880 (Arc)", "Clarke_1880_Arc"), 6378249.145, 293.4663077);

  /**
     * Krassowski 1940.
     */
  public static final Ellipsoid KRASSOWSKI = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7024", "Krassowski 1940", "Krassowski_1940"), 6378245.0, 298.3);

  /**
     * Everest 1830 (1967 definition).
     */
  public static final Ellipsoid EVERESTSS = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7016", "Everest 1830 (1967 Definition)", "evrstSS"), 6377298.556, 300.8017);

  /**
     * GRS 1967 ellipsoid, used in Australian Geodetic Datum and in South
     * American Datum 1969.
     */
  public static final Ellipsoid GRS67 = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7036", "GRS 1967", "GRS67"), 6378160, 298.247167427);

  /**
     * GRS 1967 (SAD 1969) ellipsoid, used in Australian Geodetic Datum and in
     * South American Datum 1969.
     */
  public static final Ellipsoid AustSA = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7050", "GRS 1967 (SAD 1969)", "aust_SA"), 6378160, 298.25);

  /**
     * Airy 1830.
     */
  public static final Ellipsoid AIRY = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7001", "AIRY 1830", "airy"), 6377563.396, 299.3249646);

  /**
     * Bessel Namibia (GLM).
     */
  public static final Ellipsoid BESSNAM = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7046", "Bessel Namibia (GLM)", "bess_nam"), 6377483.865280419, 299.1528128);

  /**
     * Helmert 1906.
     */
  public static final Ellipsoid HELMERT = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7020", "Helmert 1906", "helmert"), 6378200, 298.3);

  /**
     * Airy Modified 1849.
     */
  public static final Ellipsoid AIRYMOD = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7002", "Airy Modified 1849", "mod_airy"), 6377340.189, 299.3249646);

  /**
     * WGS 66.
     */
  public static final Ellipsoid WGS66 = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7025", "WGS 66", "WGS66"), 6378145, 298.25);

  /**
     * WGS 72.
     */
  public static final Ellipsoid WGS72 = createEllipsoidFromInverseFlattening(new Identifier("EPSG", "7043", "WGS 72", "WGS72"), 6378135, 298.26);
  ...
  private Ellipsoid checkExistingEllipsoid() {
    if (this.equals(Ellipsoid.GRS80)) {
      ...
      if (this.equals(Ellipsoid.WGS84)) {
        return Ellipsoid.WGS84;
      } else {
        if (this.equals(Ellipsoid.INTERNATIONAL1924)) {
          return Ellipsoid.INTERNATIONAL1924;
        } else {
          if (this.equals(Ellipsoid.CLARKE1866)) {
            return Ellipsoid.CLARKE1866;
          } else {
            if (this.equals(Ellipsoid.CLARKE1880ARC)) {
              return Ellipsoid.CLARKE1880ARC;
            } else {
              if (this.equals(Ellipsoid.CLARKE1880IGN)) {
                return Ellipsoid.CLARKE1880IGN;
              } else {
                if (this.equals(Ellipsoid.CLARKE1880RGS)) {
                  return Ellipsoid.CLARKE1880RGS;
                } else {
                  if (this.equals(Ellipsoid.SPHERE)) {
                    return Ellipsoid.SPHERE;
                  } else {
                    if (this.equals(Ellipsoid.BESSEL1841)) {
                      return Ellipsoid.BESSEL1841;
                    } else {
                      if (this.equals(Ellipsoid.KRASSOWSKI)) {
                        return Ellipsoid.KRASSOWSKI;
                      } else {
                        if (this.equals(Ellipsoid.GRS67)) {
                          return Ellipsoid.GRS67;
                        } else {
                          if (this.equals(Ellipsoid.AustSA)) {
                            return Ellipsoid.AustSA;
                          } else {
                            if (this.equals(Ellipsoid.AIRY)) {
                              return Ellipsoid.AIRY;
                            } else {
                              if (this.equals(Ellipsoid.AIRYMOD)) {
                                return Ellipsoid.AIRYMOD;
                              } else {
                                if (this.equals(Ellipsoid.BESSNAM)) {
                                  return Ellipsoid.BESSNAM;
                                } else {
                                  if (this.equals(Ellipsoid.HELMERT)) {
                                    return Ellipsoid.HELMERT;
                                  } else {
                                    if (this.equals(Ellipsoid.WGS66)) {
                                      return Ellipsoid.WGS66;
                                    } else {
                                      if (this.equals(Ellipsoid.WGS72)) {
  ...
  public final double latitude(double isoLatitude, double epsilon) {
    ...
    while (abs(latj - lati) >= epsilon) {
      ...
      latj = 2 * atan(pow((1 + esinlat) / (1 - esinlat), e / 2) * exp_isolatitude) - PI_2;
    }
    return latj;
  }
  ...
  public double curvilinearAbscissa(double latitude) {
    ...
    return arc_coeff[0] * latitude + arc_coeff[1] * sin(2 * latitude) + arc_coeff[2] * sin(4 * latitude) + arc_coeff[3] * sin(6 * latitude) + arc_coeff[4] * sin(8 * latitude);
  }
