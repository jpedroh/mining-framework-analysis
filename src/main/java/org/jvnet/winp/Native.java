...
class Native {
  ...
  /**
     ...
     */
  @CheckReturnValue public static boolean sendCtrlC(int pid) throws WinpException {
  ...
  /**
     ...
     */
  @SuppressFBWarnings(value = "DM_GC", justification = "Fallback in the case of linkage errors, see details in the code") private static void loadDll(File dllFile) {
    try {
