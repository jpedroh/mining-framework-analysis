...
public class PostCollectionHandler extends PutCollectionHandler {
  ...
  @Override public void handleRequest(HttpServerExchange exchange, RequestContext context) throws Exception {
    ...
    int httpCode = this.
<<<<<<< /usr/src/app/output/softinstigate/restheart/0747dae87d95db10cd2f8c43757649542e6c6d62/src/main/java/org/restheart/handlers/collection/PostCollectionHandler.java/left.java
    upsertDocumentPost(exchange, context.getDBName(), context.getCollectionName(), docId, content, etag)
=======
    documentDAO.upsertDocumentPost(exchange, context.getDBName(), context.getCollectionName(), content, etag)
>>>>>>> /usr/src/app/output/softinstigate/restheart/0747dae87d95db10cd2f8c43757649542e6c6d62/src/main/java/org/restheart/handlers/collection/PostCollectionHandler.java/right.java
    ;
