...
public class LocalCachesSingleton {
  ...
  private void setup() {
    ...
    if (enabled) {
      this.dbPropsCache = CacheFactory.
<<<<<<< /usr/src/app/output/softinstigate/restheart/c05198d3ef50cb4e96bfede52da7166a48afa0c7/src/main/java/org/restheart/handlers/injectors/LocalCachesSingleton.java/left.java
      createLocalLoadingCache(maxCacheSize, Cache.EXPIRE_POLICY.AFTER_WRITE, ttl, DBDAO::getDbProps)
=======
      build(new CacheLoader<String, Optional<DBObject>>() {
...
>>>>>>> /usr/src/app/output/softinstigate/restheart/c05198d3ef50cb4e96bfede52da7166a48afa0c7/src/main/java/org/restheart/handlers/injectors/LocalCachesSingleton.java/right.java
      ;
      this.collectionPropsCache = CacheFactory.
<<<<<<< /usr/src/app/output/softinstigate/restheart/c05198d3ef50cb4e96bfede52da7166a48afa0c7/src/main/java/org/restheart/handlers/injectors/LocalCachesSingleton.java/left.java
      createLocalLoadingCache(maxCacheSize, Cache.EXPIRE_POLICY.AFTER_WRITE, ttl, (String key) -> {
