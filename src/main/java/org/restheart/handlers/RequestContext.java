...
<<<<<<< /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/left.java
  CLIENT_SESSION_KEY = "cs"
=======
  _FEEDS = "_feeds"
>>>>>>> /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/right.java
  ;
    ...
    if (pathTokens.length > 0 && pathTokens[pathTokens.length - 1].equalsIgnoreCase(_SIZE)) {
      if (pathTokens.length == 2) {
        ...
        if (pathTokens.length == 3) {
          ...
          if (pathTokens.length == 4 && pathTokens[2].endsWith(FS_FILES_SUFFIX)) {
            type = TYPE.FILES_BUCKET_SIZE;
          } else {
            if (pathTokens.length == 4 && pathTokens[2].endsWith(_SCHEMAS)) {
      ...
      if (pathTokens.length > 2 && pathTokens[pathTokens.length - 1].equalsIgnoreCase(_META)) {
        if (pathTokens.length == 3) {
          type = TYPE.DB_META;
        } else {
          if (pathTokens.length == 4 && pathTokens[2].endsWith(FS_FILES_SUFFIX)) {
        ...
        if (pathTokens.length < 2) {
          ...
          if (pathTokens.length == 2 && pathTokens[pathTokens.length - 1].equalsIgnoreCase(_TRANSACTIONS)) {
            type = TYPE.TRANSACTIONS;
          } else {
            if (pathTokens.length == 3 && pathTokens[pathTokens.length - 2].equalsIgnoreCase(_TRANSACTIONS)) {
              type = TYPE.TRANSACTION;
            } else {
              if (pathTokens.length < 3 && pathTokens[1].equalsIgnoreCase(_METRICS)) {
                type = TYPE.METRICS;
              } else {
                if (pathTokens.length < 3) {
                  type = TYPE.DB;
                  ...
                  if (pathTokens.length >= 3 && pathTokens[2].endsWith(FS_FILES_SUFFIX)) {
                    if (pathTokens.length == 3) {
                      ...
                      if (pathTokens.length == 4 && pathTokens[3].equalsIgnoreCase(_INDEXES)) {
                        ...
                        if (pathTokens.length == 4 && !pathTokens[3].equalsIgnoreCase(_INDEXES) && !pathTokens[3].equals(RESOURCES_WILDCARD_KEY)) {
                          type = TYPE.FILE;
                        } else {
                          if (pathTokens.length > 4 && pathTokens[3].equalsIgnoreCase(_INDEXES)) {
                            type = TYPE.INDEX;
                          } else {
                            if (pathTokens.length > 4 && !pathTokens[3].equalsIgnoreCase(_INDEXES) && !pathTokens[4].equalsIgnoreCase(BINARY_CONTENT)) {
                              type = TYPE.FILE;
                            } else {
                    ...
                    if (pathTokens.length >= 3 && pathTokens[2].endsWith(_SCHEMAS)) {
                      if (pathTokens.length == 3) {
                      ...
                      if (pathTokens.length >= 3 && pathTokens[2].equalsIgnoreCase(_METRICS)) {
                        type = TYPE.METRICS;
                      } else {
                        if (pathTokens.length < 4) {
                          type = TYPE.COLLECTION;
                        } else {
                          if (pathTokens.length == 4 && pathTokens[3].equalsIgnoreCase(_METRICS)) {
                            type = TYPE.METRICS;
                          } else {
                            if (pathTokens.length == 4 && pathTokens[3].equalsIgnoreCase(_INDEXES)) {
                              type = TYPE.COLLECTION_INDEXES;
                            } else {
                              if (pathTokens.length == 4 && pathTokens[3].equals(RESOURCES_WILDCARD_KEY)) {
                                type = TYPE.BULK_DOCUMENTS;
                              } else {
                                if (
<<<<<<< /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/left.java
                                pathTokens.length > 4 && pathTokens[3].equalsIgnoreCase(_INDEXES)
=======
                                pathTokens.length == 4 && pathTokens[3].equalsIgnoreCase(_FEEDS)
>>>>>>> /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/right.java
                                ) {
                                  type = TYPE.
<<<<<<< /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/left.java
...
>>>>>>> /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/right.java
                                  ...
                                  if (
<<<<<<< /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/left.java
                                  pathTokens.length == 4 && pathTokens[3].equalsIgnoreCase(_AGGREGATIONS)
=======
                                  pathTokens.length > 4 && pathTokens[3].equalsIgnoreCase(_FEEDS)
>>>>>>> /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/right.java
                                  ) {
...
<<<<<<< /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/left.java
                                    if (pathTokens.length > 4 && pathTokens[3].equalsIgnoreCase(_AGGREGATIONS)) {
...
>>>>>>> /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/right.java
  ...
  public static boolean isReservedResourceDb(String dbName) {
    return !dbName.equalsIgnoreCase(_METRICS) && !dbName.equalsIgnoreCase(_SIZE) && !dbName.equalsIgnoreCase(_TRANSACTIONS) && (dbName.equals(ADMIN) || dbName.equals(LOCAL) || dbName.startsWith(SYSTEM) || dbName.startsWith(UNDERSCORE) || dbName.equals(RESOURCES_WILDCARD_KEY));
  }
  ...
  public static boolean isReservedResourceCollection(String collectionName) {
    return collectionName != null && !collectionName.equalsIgnoreCase(_SCHEMAS) && !collectionName.equalsIgnoreCase(_METRICS) && !collectionName.equalsIgnoreCase(_META) && !collectionName.equalsIgnoreCase(_SIZE) && (collectionName.startsWith(SYSTEM) || collectionName.startsWith(UNDERSCORE) || collectionName.endsWith(FS_CHUNKS_SUFFIX) || collectionName.equals(RESOURCES_WILDCARD_KEY));
  }
  ...
  public static boolean isReservedResourceDocument(TYPE type, String documentIdRaw) {
    ...
    return 
<<<<<<< /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/left.java
    (documentIdRaw.startsWith(UNDERSCORE) || (type != TYPE.AGGREGATION && _AGGREGATIONS.equalsIgnoreCase(documentIdRaw))) && !documentIdRaw.equalsIgnoreCase(_METRICS) && !documentIdRaw.equalsIgnoreCase(_SIZE)
=======
    (documentIdRaw.startsWith(UNDERSCORE) || (type != TYPE.AGGREGATION && _AGGREGATIONS.equalsIgnoreCase(documentIdRaw))) && (documentIdRaw.startsWith(UNDERSCORE) || (type != TYPE.FEED && _FEEDS.equalsIgnoreCase(documentIdRaw)))
>>>>>>> /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/right.java
     && !documentIdRaw.equalsIgnoreCase(
<<<<<<< /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/left.java
    _INDEXES
=======
    _METRICS
...
<<<<<<< /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/left.java
    startsWith(COLL_META_DOCID_PREFIX)
=======
    equalsIgnoreCase(MIN_KEY_ID)
>>>>>>> /usr/src/app/output/softinstigate/restheart/d8673744dc1e6e0322b5082d02a49108e8fc6019/src/main/java/org/restheart/handlers/RequestContext.java/right.java
     && !documentIdRaw.equalsIgnoreCase(MAX_KEY_ID) && !documentIdRaw.equalsIgnoreCase(NULL_KEY_ID) && !documentIdRaw.equalsIgnoreCase(TRUE_KEY_ID) && !documentIdRaw.equalsIgnoreCase(FALSE_KEY_ID) && !(type == TYPE.AGGREGATION) && !(type == TYPE.FEED) || (documentIdRaw.equals(RESOURCES_WILDCARD_KEY) && !(type == TYPE.BULK_DOCUMENTS));
  }
  ...
  public RequestContext(HttpServerExchange exchange, String whereUri, String whatUri) {
    this.whereUri = URLUtils.removeTrailingSlashes(whereUri == null ? null : whereUri.startsWith("/") ? whereUri : "/" + whereUri);
    this.whatUri = URLUtils.removeTrailingSlashes(whatUri == null ? null : whatUri.startsWith("/") || "*".equals(whatUri) ? whatUri : "/" + whatUri);
    ...
    HeaderValues etagHvs = exchange.getRequestHeaders() == null ? null : exchange.getRequestHeaders().get(Headers.IF_MATCH);
  ...
  private String replaceParamsWithActualValues() {
    ...
    this.pathTemplateMatch.getParameters().keySet().stream().filter((key) -> !key.equals("*")).collect(Collectors.toMap((key) -> key, (key) -> this.pathTemplateMatch.getParameters().get(key)));
    for (String key : this.pathTemplateMatch.getParameters().keySet()) {
  ...
  public boolean isParentAccessible() {
    return type == TYPE.DB ? mappedUri.split(SLASH).length > 1 : mappedUri.split(SLASH).length > 2;
  }
  ...
  public boolean isReservedResource() {
    ...
    return isReservedResourceDb(getDBName()) || isReservedResourceCollection(getCollectionName()) || isReservedResourceDocument(type, getDocumentIdRaw());
  }
  ...
  public boolean isCount() {
    return count || this.type == TYPE.ROOT_SIZE || this.type == TYPE.COLLECTION_SIZE || this.type == TYPE.FILES_BUCKET_SIZE || this.type == TYPE.SCHEMA_STORE_SIZE;
  }
  ...
  public BsonDocument getProjectionDocument() throws JsonParseException {
    ...
    if (keys == null || keys.isEmpty()) {
      ...
      keys.stream().forEach((String f) -> {
        projection.putAll(BsonDocument.parse(f));
      });
    }
    return projection;
  }
  ...
  public void setContent(BsonValue content) {
    if (content != null && !(content.isDocument() || content.isArray())) {
      throw new IllegalArgumentException("content must be " + "either an object or an array");
    }
  ...
  public void setResponseContent(BsonValue responseContent) {
    if (responseContent != null && !(responseContent.isDocument() || responseContent.isArray())) {
      throw new IllegalArgumentException("response content must be " + "either an object or an array");
    }
  ...
  public boolean isDbNameInvalid(String dbName) {
    return (dbName == null || dbName.contains(NUL) || dbName.contains(" ") || dbName.contains("/") || dbName.contains("\\") || dbName.contains(".") || dbName.contains("\"") || dbName.contains("$") || dbName.length() > 64 || dbName.length() == 0);
  }
  ...
  public boolean isDbNameInvalidOnWindows(String dbName) {
    return (isDbNameInvalid() || dbName.contains("*") || dbName.contains("<") || dbName.contains(">") || dbName.contains(":") || dbName.contains(".") || dbName.contains("|") || dbName.contains("?"));
  }
  ...
  public boolean isCollectionNameInvalid(String collectionName) {
    return (collectionName == null || collectionName.contains(NUL) || collectionName.contains("$") || collectionName.length() == 64);
  }
  ...
  public boolean isETagCheckRequired() {
    ...
    if (type == TYPE.DOCUMENT || type == TYPE.FILE) {
      BsonValue _policy = collectionProps != null ? collectionProps.get(ETAG_DOC_POLICY_METADATA_KEY) : null;
      LOGGER.trace("collection etag policy (from coll properties) {}", _policy);
      if (_policy == null) {
        _policy = dbProps != null ? dbProps.get(ETAG_DOC_POLICY_METADATA_KEY) : null;
      ...
      if (_policy != null && _policy.isString()) {
        try {
          policy = ETAG_CHECK_POLICY.valueOf(_policy.asString().getValue().toUpperCase());
    ...
    if (type == TYPE.COLLECTION && collectionProps != null) {
      ...
      if (_policy == null) {
        _policy = dbProps != null ? dbProps.get(ETAG_POLICY_METADATA_KEY) : null;
