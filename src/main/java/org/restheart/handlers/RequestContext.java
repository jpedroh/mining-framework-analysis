...
<<<<<<< /usr/src/app/output/softinstigate/restheart/0747dae87d95db10cd2f8c43757649542e6c6d62/src/main/java/org/restheart/handlers/RequestContext.java/left.java
  DOC_ID_TYPE_KEY = "doc_id_type"
=======
  _FILESYSTEM = "_filesystem"
>>>>>>> /usr/src/app/output/softinstigate/restheart/0747dae87d95db10cd2f8c43757649542e6c6d62/src/main/java/org/restheart/handlers/RequestContext.java/right.java
  ;
        ...
        if (pathTokens.length < 4) {
          ...
          if (pathTokens.length == 4 && pathTokens[3].equals(_INDEXES)) {
            ...
            if (pathTokens.length > 4 && pathTokens[3].equals(_INDEXES)) {
              ...
              if (pathTokens.length >= 2 && pathTokens[2].equals(_FILESYSTEM)) {
  ...
  public boolean isReservedResource() {
    ...
    return isReservedResourceDb(getDBName()) || isReservedResourceCollection(getCollectionName()) || isReservedResourceDocument(getDocumentIdRaw());
  }
