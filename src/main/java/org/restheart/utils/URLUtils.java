...
>>>>>>> /usr/src/app/output/softinstigate/restheart/920927de1918cd741aecdf03bc018149be020f46/src/main/java/org/restheart/utils/URLUtils.java/right.java
  ...
  /**
     ...
     */
  static public String getUriWithDocId(RequestContext context, String dbName, String collName, BsonValue id) throws UnsupportedDocumentIdException {
    DOC_ID_TYPE docIdType = URLUtils.checkId(id);
    StringBuilder sb = new StringBuilder();
    sb.append("/").append(dbName).append("/").append(collName).append("/").append(getIdAsStringNoBrachets(id));
    if (docIdType == DOC_ID_TYPE.STRING && ObjectId.isValid(id.asString().getValue())) {
      sb.append("?id_type=STRING");
    } else {
      if (docIdType != DOC_ID_TYPE.STRING && docIdType != DOC_ID_TYPE.OID) {
  ...
  /**
     ...
     * @throws org.restheart.representation.UnsupportedDocumentIdException
     */
  static public String getUriWithFilterMany(RequestContext context, String dbName, String collName, BsonValue[] ids) throws UnsupportedDocumentIdException {
    StringBuilder sb = new StringBuilder();
    sb.append("/").append(dbName).append("/").append(collName).append("?").append("filter={").append("\'").append("_id").append("\'").append(":").append("{\'$in\'").append(":").append(getIdsString(ids)).append("}}");
    return context.mapUri(sb.toString());
  }
  ...
  /**
     ...
     * @throws org.restheart.representation.UnsupportedDocumentIdException
     */
  static public String getUriWithFilterOne(RequestContext context, String dbName, String collName, String referenceField, BsonValue id) throws UnsupportedDocumentIdException {
    StringBuilder sb = new StringBuilder();
    sb.append("/").append(dbName).append("/").append(collName).append("?").append("filter={").append("\'").append(referenceField).append("\'").append(":").append(getIdString(id)).append("}");
    return context.mapUri(sb.toString());
  }
  ...
  /**
     ...
     * @throws org.restheart.representation.UnsupportedDocumentIdException
     */
  static public String getUriWithFilterManyInverse(RequestContext context, String dbName, String collName, String referenceField, BsonValue id) throws UnsupportedDocumentIdException {
    StringBuilder sb = new StringBuilder();
    sb.append("/").append(dbName).append("/").append(collName).append("?").append("filter={\'").append(referenceField).append("\':{").append("\'$elemMatch\':{\'$eq\':").append(getIdString(id)).append("}}}");
  ...
  public static String getIdString(BsonValue id) throws UnsupportedDocumentIdException {
    if (id == null) {
      ...
      if (id.isString()) {
        ...
        return JsonUtils.minify(JsonUtils.toJson(id).replace("\"", "\'"));
      }
    }
  }
