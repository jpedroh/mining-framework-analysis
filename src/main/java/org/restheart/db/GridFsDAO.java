...
public class GridFsDAO implements GridFsRepository {
  ...
  @Override public OperationResult createFile(final Database db, final String dbName, final String bucketName, final BsonDocument metadata, final Path filePath) throws IOException, DuplicateKeyException {
  ...
  @Override public OperationResult upsertFile(final Database db, final String dbName, final String bucketName, final BsonDocument metadata, final Path filePath, final BsonValue fileId, final String requestEtag, final boolean checkEtag) throws IOException {
  ...
  @Override public OperationResult deleteFile(final Database db, final String dbName, final String bucketName, final BsonValue fileId, final String requestEtag, final boolean checkEtag) {
    final String bucket = extractBucketName(bucketName);
    GridFSBucket gridFSBucket = GridFSBuckets.create(db.getDatabase(dbName), bucket);

<<<<<<< /usr/src/app/output/softinstigate/restheart/496796f99387a9891fa744e2a4822b583ca1dc49/src/main/java/org/restheart/db/GridFsDAO.java/left.java
      ...
      if (checkEtag) {
        ...
        if (oldEtag != null) {
          if (requestEtag == null) {
            ...
            if (!Objects.equals(oldEtag.toString(), requestEtag)) {
...
>>>>>>> /usr/src/app/output/softinstigate/restheart/496796f99387a9891fa744e2a4822b583ca1dc49/src/main/java/org/restheart/db/GridFsDAO.java/right.java
  }
  ...
  @Override public void deleteChunksCollection(final Database db, final String dbName, final String bucketName) {
