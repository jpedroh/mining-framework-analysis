...
public class PropsFixer {
  ...
  public boolean addCollectionProps(String dbName, String collName) throws MongoException {
    ...
    DBCollection 
<<<<<<< /usr/src/app/output/softinstigate/restheart/0747dae87d95db10cd2f8c43757649542e6c6d62/src/main/java/org/restheart/db/PropsFixer.java/left.java
    propsColl = collectionDAO.getCollection(dbName, "_properties")
=======
    coll = dbsDAO.getCollection(dbName, collName)
>>>>>>> /usr/src/app/output/softinstigate/restheart/0747dae87d95db10cd2f8c43757649542e6c6d62/src/main/java/org/restheart/db/PropsFixer.java/right.java
    ;
