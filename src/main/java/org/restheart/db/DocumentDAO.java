...
public class DocumentDAO implements Repository {
  ...
  /**
     ...
     */
  @Override public int upsertDocument(String dbName, String collName, String documentId, DBObject content, ObjectId requestEtag, boolean patching) {
  ...
  /**
     ...
     * @return the HttpStatus code to retrun
     */
  @Override public int upsertDocumentPost(HttpServerExchange exchange, String dbName, String collName, DBObject content, ObjectId requestEtag) {
    final DbsDAO dbsDAO = new DbsDAO();
    DB db = dbsDAO.getDB(dbName);
    DBCollection coll = db.getCollection(collName);
    ObjectId timestamp = new ObjectId();
  ...
  /**
     ...
     * @return
     */
  @Override public int deleteDocument(String dbName, String collName, String documentId, ObjectId requestEtag) {
    final DbsDAO dbsDAO = new DbsDAO();
    DB db = dbsDAO.getDB(dbName);
    DBCollection coll = db.getCollection(collName);
    BasicDBObject idQuery = new BasicDBObject("_id", getId(documentId));
