...
public final class SimpleAccessManager extends AbstractSecurityManager implements AccessManager {
  ...
  @Override Consumer<? super Map<String, Object>> consumeConfiguration() {
    return (u) -> {
  ...
  /**
     ...
     * @return
     */
  @Override public boolean isAllowed(HttpServerExchange exchange, RequestContext context) {
    if (noAclDefined()) {
      return false;
    }
  ...
  /**
     * @return the acl
     */
  @Override public HashMap<String, Set<Predicate>> getAcl() {
    return acl;
  }
