...
public class Instagram {
  ...
  public MediaFeed getUserLikedMediaFeed() throws InstagramException {
    MediaFeed userLikedMedia = createInstagramObject(Verbs.GET, MediaFeed.class, Methods.USERS_SELF_LIKED_MEDIA, null);
  ...
  public MediaFeed getUserLikedMediaFeed(long maxLikeId, int count) throws InstagramException {
    ...
    MediaFeed userLikedMedia = createInstagramObject(Verbs.GET, MediaFeed.class, Methods.USERS_SELF_LIKED_MEDIA, params);
    return userLikedMedia;
  }
  ...
  public LocationSearchFeed searchLocation(double latitude, double longitude) throws InstagramException {
    ...
    params.put(QueryParam.LATITUDE, Double.toString(latitude));
    params.put(QueryParam.LONGITUDE, Double.toString(longitude));
    LocationSearchFeed feed = createInstagramObject(Verbs.GET, LocationSearchFeed.class, Methods.LOCATIONS_SEARCH, params);
    return feed;
  }
  ...
  /**
	 ...
	 * @throws InstagramException
	 */
  private <T extends InstagramObject> T createInstagramObject(Verbs verbs, Class<T> clazz, String methodName, Map<String, String> params) throws InstagramException {
    Response response;
    try {
  ...
  /**
	 ...
	 * @throws InstagramException if any error occurs.
	 */
  protected <T extends java.lang.Object> T createObjectFromResponse(Class<T> clazz, final String response) throws InstagramException {
    Gson gson = new Gson();
    T object;
    try {
