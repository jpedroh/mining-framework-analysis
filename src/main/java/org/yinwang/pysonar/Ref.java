...
public class Ref implements Comparable<Object> {
  ...
  private static final int STRING = 0x8;
  ...
  public Ref(@NotNull Node node) {
    ...
    if ((parent instanceof Attribute) && node == ((Attribute) parent).attr) {
      markAsAttribute();
    }
  }
  ...
  @Override public boolean equals(Object obj) {
    if (!(obj instanceof Ref)) {
      ...
      Ref ref = (Ref) obj;
      return (start == ref.start && (file == null && ref.file == null) || (file != null && ref.file != null && file.equals(ref.file)));
    }
  }
