...
public final class Money implements MonetaryAmount, Comparable<MonetaryAmount>, Serializable {
  ...
  @Override public Money divide(long divisor) {
    if (divisor == 1L) {
      return this;
    }
  ...
  @Override public Money divide(double divisor) {
  ...
  @Override public Money[] divideAndRemainder(long divisor) {
    if (divisor == 1L) {
  ...
  @Override public Money[] divideAndRemainder(double divisor) {
    if (NumberVerifier.isInfinityAndNotNaN(divisor)) {
  ...
  @Override public Money multiply(long multiplicand) {
    if (multiplicand == 1L) {
      return this;
    }
  ...
  @Override public Money multiply(double multiplicand) {
  ...
  @Override public Money remainder(long divisor) {
    if (divisor == 1L) {
      return this;
    }
  ...
  @Override public Money remainder(double divisor) {
    if (NumberVerifier.isInfinityAndNotNaN(divisor)) {
      return Money.of(0, getCurrency());
    }
  ...
  @Override public <R extends java.lang.Object> R query(MonetaryQuery<R> query) {
  ...
  @Override public Money with(MonetaryOperator operator) {
  ...
  @Override public Money add(MonetaryAmount amount) {
  ...
  @Override public Money divide(Number divisor) {
    if (NumberVerifier.isInfinityAndNotNaN(divisor)) {
      return Money.of(0, getCurrency());
    }
    ...
    BigDecimal dec = this.number.divide(divisorBD, MoneyUtils.getMathContext(getContext(), RoundingMode.HALF_EVEN));
    return new Money(dec, getCurrency());
  }

  @Override public Money[] divideAndRemainder(Number divisor) {
    if (NumberVerifier.isInfinityAndNotNaN(divisor)) {
      Money zero = Money.of(0, getCurrency());
      return new Money[] { zero, zero };
    }
  ...
  @Override public Money divideToIntegralValue(long divisor) {
    return divideToIntegralValue(MoneyUtils.getBigDecimal(divisor));
  }

  @Override public Money divideToIntegralValue(double divisor) {
    if (NumberVerifier.isInfinityAndNotNaN(divisor)) {
      return Money.of(0, getCurrency());
    }
    return divideToIntegralValue(MoneyUtils.getBigDecimal(divisor));
  ...
  @Override public Money divideToIntegralValue(Number divisor) {
    if (NumberVerifier.isInfinityAndNotNaN(divisor)) {
      return Money.of(0, getCurrency());
    }
    BigDecimal divisorBD = MoneyUtils.getBigDecimal(divisor);
  ...
  @Override public Money multiply(Number multiplicand) {
    NumberVerifier.checkNoInfinityOrNaN(multiplicand);
  ...
  @Override public Money negate() {
    return new Money(this.number.negate(), getCurrency());
  }

  @Override public Money plus() {
    return this;
  }

  @Override public Money subtract(MonetaryAmount amount) {
    MoneyUtils.checkAmountParameter(amount, this.currency);
    if (amount.isZero()) {
      return this;
    }
  ...
  @Override public Money stripTrailingZeros() {
    if (isZero()) {
  ...
  @Override public Money remainder(Number divisor) {
    if (NumberVerifier.isInfinityAndNotNaN(divisor)) {
      return new Money(BigDecimal.ZERO, getCurrency());
    }
  ...
  @Override public Money scaleByPowerOfTen(int power) {
  ...
  @Override public MonetaryAmountFactory<Money> getFactory() {
  ...
  @Override public boolean equals(Object obj) {
    ...
    if (obj instanceof Money) {
      ...
      return Objects.equals(getCurrency(), other.getCurrency()) && Objects.equals(getNumberStripped(), other.getNumberStripped());
    }
    return false;
  }
  ...
  public static Money of(Number number, String currencyCode, MonetaryContext monetaryContext) {
    return new Money(MoneyUtils.getBigDecimal(number), Monetary.getCurrency(currencyCode), monetaryContext);
  }
  ...
  private static final ToStringMonetaryAmountFormat DEFAULT_FORMATTER = ToStringMonetaryAmountFormat.of(ToStringMonetaryAmountFormatStyle.MONEY);
}