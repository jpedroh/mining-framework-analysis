...
public class BenchmarkProbeSet {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "BusyWait" }) public void start() throws Exception {
        ...
        try {
          ...
          for (Map.Entry<BenchmarkProbe, BenchmarkProbePointWriter> entry : writers.entrySet()) {
            ...
            try {
              ...
              errorHelp(cfg, "Failed to gracefully close probe writer " + "[probe=" + entry.getKey() + ", writer=" + entry.getValue() + ", err=" + e.getMessage() + ']', e);
            }
          }
        }
      }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "ForLoopReplaceableByForEach" }) public void onBeforeExecute(int threadIdx) {
  ...
  /**
     ...
     * @param threadIdx Executor thread index.
     */
  @SuppressWarnings(value = { "ForLoopReplaceableByForEach" }) public void onAfterExecute(int threadIdx) {
    for (int i = 0; i < execProbes.size(); i++) {
