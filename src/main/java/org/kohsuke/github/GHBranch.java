 ...
 */
@SuppressFBWarnings(value = { "UWF_UNWRITTEN_PUBLIC_OR_PROTECTED_FIELD", "UWF_UNWRITTEN_FIELD", "NP_UNWRITTEN_FIELD", "URF_UNREAD_FIELD" }, justification = "JSON API") public class GHBranch {
  private GitHub root;
  ...
  @JsonProperty(value = "protected") private boolean protection;

  private String protection_url;

  @JsonCreator GHBranch(@JsonProperty(value = "name") String name) throws Exception {
    if (name != null) {
      this.name = name;
    } else {
  ...
  public static class Commit {
    ...
    @SuppressFBWarnings(value = "UUF_UNUSED_FIELD", justification = "We don\'t provide it in API now") String url;
  }
