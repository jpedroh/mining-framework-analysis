...
public class GitHub {
  ...
  public PagedIterable<GHOrganization> listOrganizations(final String since) {
    return retrieve().with("since", since).asPagedIterable("/organizations", GHOrganization[].class, (item) -> item.wrapUp(GitHub.this));
  }
  ...
  public PagedIterable<GHRepository> listAllPublicRepositories(final String since) {
    return retrieve().with("since", since).asPagedIterable("/repositories", GHRepository[].class, (item) -> item.wrap(GitHub.this));
  }
