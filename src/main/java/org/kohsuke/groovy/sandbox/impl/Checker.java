...
public class Checker {
  ...
  public static Object checkedSetProperty(Object _receiver, Object _property, boolean safe, boolean spread, int op, Object _value) throws Throwable {
    if (op != Types.ASSIGN) {
      ...
      return checkedSetProperty(_receiver, _property, safe, spread, Types.ASSIGN, checkedBinaryOp(v, Ops.compoundAssignmentToBinaryOperator(op), _value));
    }
    if (safe && _receiver == null) {
      return _value;
    }
  ...
  public static Object checkedSetAttribute(Object _receiver, Object _property, boolean safe, boolean spread, int op, Object _value) throws Throwable {
    if (op != Types.ASSIGN) {
      ...
      return checkedSetAttribute(_receiver, _property, safe, spread, Types.ASSIGN, checkedBinaryOp(v, Ops.compoundAssignmentToBinaryOperator(op), _value));
    }
    if (safe && _receiver == null) {
      return _value;
    }
  ...
  public static Object checkedSetArray(Object _receiver, Object _index, int op, Object _value) throws Throwable {
    if (op != Types.ASSIGN) {
      ...
      return checkedSetArray(_receiver, _index, Types.ASSIGN, checkedBinaryOp(v, Ops.compoundAssignmentToBinaryOperator(op), _value));
    } else {
  ...
  public static Object checkedComparison(Object lhs, final int op, Object rhs) throws Throwable {
    if (lhs == null) {
      return InvokerHelper.invokeStaticMethod(ScriptBytecodeAdapter.class, Ops.binaryOperatorMethods(op), new Object[] { null, rhs });
    }
    return new SingleArgInvokerChain(lhs) {
      public Object call(Object lhs, String method, Object rhs) throws Throwable {
        if (chain.hasNext()) {
          return chain.next().onMethodCall(this, lhs, lhs instanceof Comparable ? "compareTo" : "equals", rhs);
        } else {
          return InvokerHelper.invokeStaticMethod(ScriptBytecodeAdapter.class, Ops.binaryOperatorMethods(op), new Object[] { lhs, rhs });
        }
      }
    }.call(lhs, null, rhs);
  }
  ...
  @FunctionalInterface public interface Thunk {
          ...
          if (!clazz.isArray() && clazz != Object.class && !Modifier.isAbstract(clazz.getModifiers()) && (exp instanceof Collection || exp.getClass().isArray() || exp instanceof Map)) {
            ...
            if (exp instanceof Collection) {
              if (isCollectionSafeToCast((Collection) exp)) {
                ...
                throw new UnsupportedOperationException("Casting non-standard Collections to a type via constructor is not supported. " + "Consider converting " + exp.getClass() + " to a Collection defined in the java.util package and then casting to " + clazz + ".");
              }
            } else {
            ...
            if (clazz == File.class && exp instanceof CharSequence) {
              ...
              if (exp instanceof File && (clazz.isArray() || Collection.class.isAssignableFrom(clazz))) {
                new VarArgInvokerChain(clazz) {
                  public Object call(Object receiver, String method, Object... args) throws Throwable {
                ...
                if (exp instanceof Class && ((Class) exp).isEnum() && (clazz.isArray() || Collection.class.isAssignableFrom(clazz))) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private static <T extends java.lang.Object> T getDefaultValue(Class<T> clazz) {
