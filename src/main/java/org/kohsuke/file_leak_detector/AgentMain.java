...
@SuppressWarnings(value = { "Since15" }) public class AgentMain {
  ...
  private static ClassTransformSpec newFdSpec(String binName, String methodName, String constructorDesc, String listenermethod) {
    return new ClassTransformSpec(binName, new GenericInterceptor(methodName, constructorDesc, listenermethod));
  }
