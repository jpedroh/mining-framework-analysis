 ...
 */
@Versioned public class RythmEngine implements IEventDispatcher {
  ...
  private void _initConf(Map<String, ?> conf, File confFile) {
    ...
    if (null != conf) {
      rawConf.putAll((Map) _processConf(conf));
    }
    _initLogger(rawConf);
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> T getProperty(String key) {
  ...
  private void init(Map<String, ?> conf, File file) {
    ...
    _templates.put("chain", new JavaTagBase() {
      @Override protected void call(__ParameterList params, __Body body) {
  ...
  @Deprecated private void handleCCE(ClassCastException ce) {
  }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public ITemplate getTemplate(String template, Object... args) {
  ...
  /**
     ...
     * @return template instance
     */
  @SuppressWarnings(value = { "unchecked" }) public ITemplate getTemplate(File file, Object... args) {
    boolean typeInferenceEnabled = conf().typeInferenceEnabled();
    if (typeInferenceEnabled) {
      ParamTypeInferencer.registerParams(this, args);
    }
  ...
  /**
     ...
     * @return render result
     */
  @SuppressWarnings(value = { "unchecked" }) public String renderString(String key, String template, Object... args) {
    boolean typeInferenceEnabled = conf().typeInferenceEnabled();
    if (typeInferenceEnabled) {
      ParamTypeInferencer.registerParams(this, args);
    }
  ...
  public String renderIfTemplateExists(String template, Object... args) {
    ...
    if (nonExistsTemplates.contains(template)) {
      return "";
    }
    String key = template;
    if (typeInferenceEnabled) {
  ...
  public TemplateTestResult testTemplate(String name, TemplateClass callerClass, ICodeType codeType) {
    ...
    if (mode().isProd() && _nonTmpls.contains(name)) {
      return null;
    }
  ...
  public void invokeTemplate(int line, String name, ITemplate caller, ITag.__ParameterList params, ITag.__Body body, ITag.__Body context, boolean ignoreNonExistsTag) {
    if (_nonExistsTags.contains(name)) {
      return;
    }
    ...
    try {
      ...
      if (null == t) {
        ...
        if (null == t) {
          ...
          if (null != tc) {
            t = _templates.get(tc.getTagName());
          }
          if (null == t) {
  ...
  /**
     ...
     */
  @Override public Object accept(IEvent event, Object param) {
  ...
  public static enum OutputMode {
    ...
    writer,
    str() {
      @Override public boolean writeOutput() {
        return false;
      }
    }
    ;
  ...
  private final static InheritableThreadLocal<OutputMode> outputMode = new InheritableThreadLocal<OutputMode>() {
    @Override protected OutputMode initialValue() {
  ...
  public void shutdown() {
    ...
    if (null != _nonExistsTags) {
      _nonExistsTags.clear();
    }
    if (null != nonExistsTemplates) {
      nonExistsTemplates.clear();
    }
    if (null != _nonTmpls) {
      _nonTmpls.clear();
    }
