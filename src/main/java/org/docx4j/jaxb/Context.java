...
public class Context {
  ...
  static {
    ...
    try {
      ...
      tempContext = JAXBContext.newInstance("org.docx4j.wml:org.docx4j.w14:org.docx4j.w15:" + "org.docx4j.com.microsoft.schemas.office.word.x2006.wordml:" + 
<<<<<<< /usr/src/app/output/plutext/docx4j/aa42a5b3f77c350916c1b790b26cb2633e9aa31c/src/main/java/org/docx4j/jaxb/Context.java/left.java
...
>>>>>>> /usr/src/app/output/plutext/docx4j/aa42a5b3f77c350916c1b790b26cb2633e9aa31c/src/main/java/org/docx4j/jaxb/Context.java/right.java
      ...
      if (tempContext.getClass().getName().equals("org.eclipse.persistence.jaxb.JAXBContext")) {
        ...
        if (tempContext.getClass().getName().startsWith("com.ibm.xml.xlxp2.jaxb")) {
          ...
          if (jaxbImplementation == JAXBImplementation.ORACLE_JRE) {
            ...
            if (jaxbImplementation == JAXBImplementation.REFERENCE) {
      ...
      while (resEnum.hasMoreElements()) {
        ...
        try {
          ...
          if (is != null) {
            ...
            if (impTitle != null && (impTitle.contains("JAXB Reference Implementation") || impTitle.contains("org.eclipse.persistence"))) {
              log.info("\n" + url);
