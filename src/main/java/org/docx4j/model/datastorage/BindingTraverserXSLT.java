...
public class BindingTraverserXSLT extends BindingTraverserCommonImpl {
  ...
  static {
    try {
      Source xsltSource = new StreamSource(ResourceUtils.getResourceViaProperty("docx4j.model.datastorage.BindingTraverserXSLT.xslt", "org/docx4j/model/datastorage/bind.xslt"));
  ...
  /**
	 ...
	 */
  public Object traverseToBind(JaxbXmlPart part, org.docx4j.openpackaging.packages.OpcPackage pkg, Map<String, org.opendope.xpaths.Xpaths.Xpath> xpathsMap) throws Docx4JException {
    ...
    try {
      ...
      if (ENABLE_XPATH_CACHE) {
        if (domToXPathMap == null) {
          CustomXmlDataStoragePart cdsp = CustomXmlDataStoragePartSelector.getCustomXmlDataStoragePart((WordprocessingMLPackage) pkg);
          if (cdsp == null) {
...
>>>>>>> /usr/src/app/output/plutext/docx4j/aa42a5b3f77c350916c1b790b26cb2633e9aa31c/src/main/java/org/docx4j/model/datastorage/BindingTraverserXSLT.java/right.java
      ...
      {
        return unmarshal(((org.w3c.dom.Document) result.getNode()), Docx4jProperties.getProperty("docx4j.model.datastorage.BindingTraverserXSLT.ValidationEventContinue", false));
      }
  ...
  /**
	 ...
	 */
  public static DocumentFragment convertXHTML(BindingTraverserState bindingTraverserState, WordprocessingMLPackage pkg, JaxbXmlPart sourcePart, Map<String, CustomXmlPart> customXmlDataStorageParts, Map<String, org.opendope.xpaths.Xpaths.Xpath> xpathsMap, String sdtParent, String contentChild, NodeIterator rPrNodeIt, String tag, Map<String, Integer> sequenceCounters, BookmarkCounter bookmarkCounter) {
    ...
    for (int j = 0; j < methods.length; j++) {
      if (methods[j].getName().equals("setBookmarkIdNext") && methods[j].getParameterTypes().length == 1) {
        method = methods[j];
        break;
      }
    }
    ...
    if (r == null) {
      ...
      if (log.isDebugEnabled() && r.trim().length() == 0) {
        r = BindingHandler.xpathGetString(pkg, customXmlDataStorageParts, storeItemId, xpathExp, prefixMappings);
        if (r.trim().length() > 0) {
  ...
  /**
	 ...
	 * @return
	 */
  private static DocumentFragment xhtmlError(String sdtParent, org.w3c.dom.Document docContainer, DocumentFragment docfrag, String errMsg) {
  ...
  /**
	 ...
	 */
  public static DocumentFragment xpathGenerateRuns(BindingTraverserState bindingTraverserState, WordprocessingMLPackage pkg, JaxbXmlPart sourcePart, Map<String, CustomXmlPart> customXmlDataStorageParts, Map<String, org.opendope.xpaths.Xpaths.Xpath> xpathsMap, NodeIterator sdtPrNodeIt, String sdtParent, String contentChild, boolean multiLine) {
    SdtPr sdtPr = null;
    ...
    String xpathExp = xpath.getDataBinding().getXpath();
    String prefixMappings = xpath.getDataBinding().getPrefixMappings();
    return xpathGenerateRuns(bindingTraverserState.getPathMap(), pkg, sourcePart, customXmlDataStorageParts, storeItemId, xpathExp, prefixMappings, sdtPr, sdtParent, contentChild, multiLine);
  }
  ...
  public static DocumentFragment xpathGenerateRuns(BindingTraverserState bindingTraverserState, WordprocessingMLPackage pkg, JaxbXmlPart sourcePart, Map<String, CustomXmlPart> customXmlDataStorageParts, String storeItemId, String xpath, String prefixMappings, NodeIterator sdtPrNodeIt, String sdtParent, String contentChild, boolean multiLine) {
    ...
    return xpathGenerateRuns(bindingTraverserState.getPathMap(), pkg, sourcePart, customXmlDataStorageParts, storeItemId, xpath, prefixMappings, sdtPr, sdtParent, contentChild, multiLine);
  }
  ...
  public static DocumentFragment xpathGenerateRuns(Map<String, String> pathMap, WordprocessingMLPackage pkg, JaxbXmlPart sourcePart, Map<String, CustomXmlPart> customXmlDataStorageParts, String storeItemId, String xpath, String prefixMappings, SdtPr sdtPr, String sdtParent, String contentChild, boolean multiLine) {
    String r = null;
    if (pathMap != null) {
      ...
      if (sdtParent.equals("body") || sdtParent.equals("tc")) {
        ...
        if (sdtParent.equals("tr")) {
          ...
          if (sdtParent.equals("p")) {
            ...
            if (sdtParent.equals("sdtContent")) {
  ...
  /**
	 ...
	 * @since 3.0.1
	 */
  public static String xpathInjectImageRelId(WordprocessingMLPackage wmlPackage, JaxbXmlPart sourcePart, Map<String, CustomXmlDataStoragePart> customXmlDataStorageParts, Map<String, org.opendope.xpaths.Xpaths.Xpath> xpathsMap, String tag) {
    QueryString qs = new QueryString();
    HashMap<String, String> map = qs.parseQueryString(tag, true);
    String xpathId = map.get(OpenDoPEHandler.BINDING_ROLE_XPATH);
    log.info("Looking for xpath by id: " + xpathId);
    ...
    String xpathExp = xpath.getDataBinding().getXpath();
    String prefixMappings = xpath.getDataBinding().getPrefixMappings();
    return xpathInjectImageRelId(wmlPackage, sourcePart, customXmlDataStorageParts, storeItemId, xpathExp, prefixMappings);
  }
  ...
  public static String getRepeatPositionCondition(Map<String, org.opendope.xpaths.Xpaths.Xpath> xpathsMap, String odTag) {
    QueryString qs = new QueryString();
    HashMap<String, String> map = qs.parseQueryString(odTag, true);
  ...
  /**
	 ...
	 * @since 3.0.1
	 */
  public static DocumentFragment convertFlatOPC(WordprocessingMLPackage pkg, JaxbXmlPart sourcePart, Map<String, CustomXmlPart> customXmlDataStorageParts, Map<String, org.opendope.xpaths.Xpaths.Xpath> xpathsMap, String sdtParent, String contentChild, NodeIterator rPrNodeIt, String tag) {
    try {
    ...
    try {
      ...
      if (r.equals("true") || r.equals("1")) {
        if (log.isWarnEnabled() && sdtCheckbox.getCheckedState() != null) {
          ...
          if (sdtCheckboxSymbol.getVal() != null && !sdtCheckboxSymbol.getVal().equals("2612")) {
        ...
        if (log.isWarnEnabled() && sdtCheckbox.getUncheckedState() != null) {
          ...
          if (sdtCheckboxSymbol.getVal() != null && !sdtCheckboxSymbol.getVal().equals("2610")) {
