...
public class ResourceBuilder {
  ...
  public Map<Object, Object> buildPedegreeData(String IRI, ConfigurationBean conf, OntologyBean ontoBean, Locale locale) throws Exception {
    ...
    browseRelatives(IRI, "spouse", s, resultMap, found, controlList, false, se, conf, localMode, locale, ontoBean);
    browseRelatives(IRI, 
<<<<<<< /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/left.java
    "sons"
=======
    "bro"
>>>>>>> /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/right.java
    , s, resultMap, found, controlList, true, se, conf, localMode, locale, ontoBean);
    browseRelatives(IRI, 
<<<<<<< /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/left.java
    "parents"
=======
...
>>>>>>> /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/right.java
      ...
      for (PropertyBean lit : lits.keySet()) {
        ...
        for (TripleBean trip : l) {
          if (trip.getProperty().getProperty().equals("http://dbpedia.org/ontology/birthDate")) {
            ...
            if (trip.getProperty().getProperty().equals("http://dbpedia.org/ontology/deathDate")) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private void browseRelatives(String IRI, String key, Map<String, Object> s, Map<Object, Object> resultMap, Set<String> found, Set<String> controlList, boolean deep, SPARQLEndPoint se, ConfigurationBean conf, boolean localMode, Locale locale, OntologyBean ontoBean) throws Exception {
...
>>>>>>> /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/right.java
    ...
    System.out.println(
<<<<<<< /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/left.java
    ("http://lodview.it/p/" + key + " " + IRI)
=======
    "looking for " + key + " of " + IRI
>>>>>>> /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/right.java
    );
  ...
  private ResultBean triplesToResult(String IRI, List<TripleBean> triples, Locale locale, ConfigurationBean conf, OntologyBean ontoBean) {
    ...
    for (TripleBean tripleBean : triples) {
      ...
      if (conf.getTitleProperties().contains(tripleBean.getProperty().getNsProperty()) || conf.getTitleProperties().contains(tripleBean.getProperty().getProperty())) {
        ...
        if (conf.getDescriptionProperties().contains(tripleBean.getProperty().getNsProperty()) || conf.getDescriptionProperties().contains(tripleBean.getProperty().getProperty())) {
          ...
          if (conf.getLatitudeProperties().contains(tripleBean.getProperty().getNsProperty()) || conf.getLatitudeProperties().contains(tripleBean.getProperty().getProperty())) {
            result.setLatitude(tripleBean.getValue());
          } else {
            if (conf.getLongitudeProperties().contains(tripleBean.getProperty().getNsProperty()) || conf.getLongitudeProperties().contains(tripleBean.getProperty().getProperty())) {
              result.setLongitude(tripleBean.getValue());
            } else {
              if (conf.getImageProperties().contains(tripleBean.getProperty().getNsProperty()) || conf.getImageProperties().contains(tripleBean.getProperty().getProperty())) {
...
>>>>>>> /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/right.java
                .contains(tripleBean.getProperty().getNsProperty()) || conf.
<<<<<<< /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/left.java
                getAudioProperties()
=======
                getLinkingProperties()
>>>>>>> /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/right.java
                .contains(tripleBean.getProperty().getProperty())) {
...
<<<<<<< /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/left.java
                    add(tripleBean.getValue())
=======
                    setTypeProperty(tripleBean.getProperty())
>>>>>>> /usr/src/app/output/dvcama/lodview/ddb60742654745a31c1f43814762216d118d4fd2/src/main/java/org/dvcama/lodview/builder/ResourceBuilder.java/right.java
                    ;
                  } else {
                    if (conf.getLinkingProperties().contains(tripleBean.getProperty().getNsProperty()) || conf.getLinkingProperties().contains(tripleBean.getProperty().getProperty())) {
                      linking.add(tripleBean.getValue());
                    } else {
                      if (conf.getTypeProperties().contains(tripleBean.getProperty().getNsProperty()) || conf.getTypeProperties().contains(tripleBean.getProperty().getProperty())) {
      ...
      if (tripleBean.getType().equals("iri")) {
        ...
        if (tripleBean.getType().equals("literal")) {
          ...
          if (tripleBean.getType().equals("bnode")) {
