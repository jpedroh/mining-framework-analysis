...
public class BlockJUnit4ClassRunner extends ParentRunner<FrameworkMethod> {
  ...
  /**
     ...
     */
  @Deprecated protected Statement withPotentialTimeout(FrameworkMethod method, Statement next) {
...
<<<<<<< /usr/src/app/output/junit-team/junit4/0546b36b9a793a959d45c64fc04bc1615f308de7/src/main/java/org/junit/runners/BlockJUnit4ClassRunner.java/left.java
    timeout > 0 ? new FailOnTimeout(next, timeout, method.getClass() + method.getName()) : next
=======
    FailOnTimeout.builder().withTimeout(timeout, TimeUnit.MILLISECONDS).build(next)
