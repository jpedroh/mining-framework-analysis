...
public abstract class JDBC3ResultSet extends CoreResultSet {
  ...
  public int getColumnType(int col) throws SQLException {
    ...
    if (valueType == SQLITE_INTEGER || valueType == SQLITE_NULL) {
      ...
      if (valueType == SQLITE_INTEGER || "INT".equals(typeName) || "INTEGER".equals(typeName) || "MEDIUMINT".equals(typeName)) {
    ...
    if (valueType == SQLITE_TEXT || valueType == SQLITE_NULL) {
      ...
      if (valueType == SQLITE_TEXT || "VARCHAR".equals(typeName) || "VARYING CHARACTER".equals(typeName) || "NVARCHAR".equals(typeName) || "TEXT".equals(typeName)) {
