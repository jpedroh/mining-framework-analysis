 ...
 * @author michael.rice
 */
@Mojo(name = "os-check") public class OpenSourceLicenseCheckMojo extends AbstractMojo {
  ...
  @Component final MavenProject project = null;
   ...
   */
  @Parameter(defaultValue = "${project.remotePluginRepositories}") List<RemoteRepository> remoteRepos;

  /**
   * This is the maximum number of parents to search through (in case there's a malformed pom).
   */
  @Parameter(property = "os-check.recursion-limit", defaultValue = "12") int maxSearchDepth;
   ...
   */
  @Parameter(property = "os-check.excludes") String[] excludes;
   ...
   */
  @Parameter(property = "os-check.excludesRegex") String[] excludesRegex;

  @Parameter(property = "os-check.excludesNoLicense") boolean excludeNoLicense;
   ...
   */
  @Parameter(property = "os-check.blacklist") String[] blacklist;
   ...
   * &lt;param&gt;gpl-3.0&lt;/param&gt; &lt;/blacklist&gt; &lt;/configuration&gt;
   */
  @Parameter(property = "os-check.whitelist") String[] whitelist;
   ...
   */
  @Parameter(property = "os-check.excludedScopes") String[] excludedScopes;
   ...
   * @return
   */
  boolean artifactIsOnExcludeList(final Set<String> excludeSet, final List<Pattern> patternList, final Set<String> excludedScopes, final Artifact artifact) {
    return isExcludedTemplate(excludeSet, patternList, toCoordinates(artifact)) || excludedScopes.contains(artifact.getScope());
  }

  boolean isExcludedTemplate(final Set<String> excludeSet, final List<Pattern> patternList, final String template) {
