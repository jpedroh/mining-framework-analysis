...
public final class DataFactory {
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> T getItem(List<T> items) {
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> T getItem(List<T> items, int probability) {
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> T getItem(List<T> items, int probability, T defaultItem) {
    if (items == null) {
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> T getItem(T[] items) {
    return getItem(items, 100, null);
  }
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> T getItem(T[] items, int probability) {
    return getItem(items, probability, null);
  }
  ...
  /**
	 ...
	 * @return Item from the array or the default value
	 */
  public <T extends java.lang.Object> T getItem(T[] items, int probability, T defaultItem) {
    if (items == null) {
  ...
  private int avg(int first, int second) {
    ...
    return firstInt.add(secondInt).divide(BigInteger.valueOf(2)).intValue();
  }
