...
public class FeedbackServiceManager {
   ...
   */
  @Deprecated private FeedbackServiceManager(final DeviceFactory deviceFactory) {
   ...
   */
  @SuppressWarnings(value = { "deprecation" }) public FeedbackServiceManager() {
   ...
   * @deprecated The DeviceFactory-based architecture is deprecated.
   */
  @Deprecated private void setDeviceFactory(final DeviceFactory deviceFactory) {
