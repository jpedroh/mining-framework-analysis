...
@Controller public class GoodsController {
  ...
  @GetMapping(value = { "/search", "/search.html" }) public String searchPage(@RequestParam Map<String, Object> params, HttpServletRequest request) {
  ...
  @GetMapping(value = "/goods/detail/{goodsId}") public String detailPage(@PathVariable(value = "goodsId") Long goodsId, HttpServletRequest request) {
    if (goodsId < 1) {
    ...
    goodsReview.put("reviewMore", 0);
    goodsReview.put("reviewType", 1);
  ...
  @RequestMapping(value = "/goods/qaList", method = RequestMethod.POST) @ResponseBody public Result goodsQa(@RequestBody Map<String, Object> params) {
  ...
  @RequestMapping(value = "/goods/helpNum", method = RequestMethod.POST) @ResponseBody public Result qaHelpNum(@RequestBody Map<String, Object> params, HttpSession httpSession) {
  ...
  @RequestMapping(value = "/goods/goodsReview", method = RequestMethod.POST) @ResponseBody public Result goodsReview(@RequestBody Map<String, Object> params) {
  ...
  @RequestMapping(value = "/goods/likeNum", method = RequestMethod.POST) @ResponseBody public Result reviewLikeNum(@RequestBody Map<String, Object> params, HttpSession httpSession) {
    NewBeeMallUserVO user = (NewBeeMallUserVO) httpSession.getAttribute(Constants.MALL_USER_SESSION_KEY);
    Long goodsId = Long.parseLong(params.get("goodsId").toString());
  ...
  @RequestMapping(value = "/goods/insertGoodsQa", method = RequestMethod.POST) @ResponseBody public Result insertGoodsQa(@RequestBody GoodsQa goodsQa, HttpSession httpSession) {
    NewBeeMallUserVO user = (NewBeeMallUserVO) httpSession.getAttribute(Constants.MALL_USER_SESSION_KEY);
    String userId = user.getUserId().toString();
  ...
  @RequestMapping(value = "/goods/insertGoodsReview", method = RequestMethod.POST) @ResponseBody public Result insertGoodsReview(@RequestBody GoodsReview goodsReview, HttpSession httpSession) {
    NewBeeMallUserVO user = (NewBeeMallUserVO) httpSession.getAttribute(Constants.MALL_USER_SESSION_KEY);
    String userId = user.getUserId().toString();
  ...
  @RequestMapping(value = "/upload/reviewImage", method = RequestMethod.POST) @ResponseBody public Result upload(HttpServletRequest httpServletRequest, @RequestParam(value = "file") MultipartFile file) throws URISyntaxException {
