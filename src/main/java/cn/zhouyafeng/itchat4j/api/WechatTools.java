...
public class WechatTools {
  ...
  /**
	 ...
	 * @return
	 */
  public static JSONObject getMemberListByGroupId(String groupId) {
    ...
    String url = "https://wx2.qq.com/cgi-bin/mmwebwx-bin/webwxbatchgetcontact?type=ex&pass_ticket=" + StorageLoginInfoEnum.pass_ticket.getType() + "&" + "r=" + String.valueOf(new Date().getTime());
    JSONObject postData = new JSONObject();
    JSONObject baseRequest_JSON = new JSONObject();
    for (BaseParaEnum baseRequest : BaseParaEnum.values()) {
      baseRequest_JSON.put(baseRequest.para().toLowerCase(), core.getLoginInfo().get(baseRequest.value()).toString());
    }
