...
<<<<<<< /usr/src/app/output/yaphone/itchat4j/2bc3e1ad9d4b8db1554dce5b5fe7eeb8f153d283/src/main/java/cn/zhouyafeng/itchat4j/core/MsgCenter.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
                ...
                if (msg.getType().equals(MsgTypeEnum.PIC.getType())) {
                  ...
                  if (msg.getType().equals(MsgTypeEnum.VOICE.getType())) {
                    String result = msgHandler.voiceMsgHandle(msg);
                    MessageTools.sendMsgById(result, core.getMsgList().get(0).getFromUserName());
                  } else {
                    if (msg.getType().equals(MsgTypeEnum.VIEDO.getType())) {
                      String result = msgHandler.viedoMsgHandle(msg);
                      MessageTools.sendMsgById(result, core.getMsgList().get(0).getFromUserName());
                    } else {
                      if (msg.getType().equals(MsgTypeEnum.NAMECARD.getType())) {
                        String result = msgHandler.nameCardMsgHandle(msg);
                        MessageTools.sendMsgById(result, core.getMsgList().get(0).getFromUserName());
                      } else {
                        if (msg.getType().equals(MsgTypeEnum.SYS.getType())) {
