  package     gov . nysenate . openleg . model . spotcheck ;   import     com . google . common . collect . HashMultimap ;  import     com . google . common . collect . SetMultimap ;  import     gov . nysenate . openleg . util . OutputUtils ;  import    java . util . stream . Collectors ;  import static      gov . nysenate . openleg . model . spotcheck . SpotCheckRefType .  * ;  import  java . util .  * ;   public enum SpotCheckMismatchType  {  All  ( "All" ,  SpotCheckRefType . values  ( ) ) ,  REFERENCE_DATA_MISSING  ( "Ref. Missing" ,  SpotCheckRefType . values  ( ) ) ,  OBSERVE_DATA_MISSING  ( "Source Missing" ,  SpotCheckRefType . values  ( ) ) ,  BILL_ACTION  ( "Action" , LBDC_DAYBREAK , SENATE_SITE_BILLS ) ,  BILL_ACTIVE_AMENDMENT  ( "Active Amendment" , LBDC_DAYBREAK , LBDC_SCRAPED_BILL , SENATE_SITE_BILLS , OPENLEG_BILL ) ,  BILL_AMENDMENT_PUBLISH  ( "Published Status" , LBDC_DAYBREAK , SENATE_SITE_BILLS ) ,  BILL_COSPONSOR  ( "Co Sponsor" , LBDC_DAYBREAK , SENATE_SITE_BILLS ) ,  BILL_FULLTEXT_PAGE_COUNT  ( "Page Count" , LBDC_DAYBREAK ) ,  BILL_TEXT_LINE_OFFSET  ( "Text Line Offset" , LBDC_SCRAPED_BILL , SENATE_SITE_BILLS ) ,  BILL_TEXT_CONTENT  ( "Text Content" , LBDC_SCRAPED_BILL , SENATE_SITE_BILLS ) ,  BILL_LAW_CODE_SUMMARY  ( "Law/Summary" , LBDC_DAYBREAK ) ,  BILL_LAW_SECTION  ( "Law Section" , LBDC_DAYBREAK ) ,  BILL_MEMO  ( "Memo" , LBDC_SCRAPED_BILL , SENATE_SITE_BILLS ) ,  BILL_MULTISPONSOR  ( "Multi Sponsor" , LBDC_DAYBREAK , SENATE_SITE_BILLS ) ,  BILL_SESSION_YEAR  ( "Session Year" , LBDC_DAYBREAK , OPENLEG_BILL ) ,  BILL_SPONSOR  ( "Sponsor" , LBDC_DAYBREAK , SENATE_SITE_BILLS , OPENLEG_BILL ) ,  BILL_TITLE  ( "Title" , LBDC_DAYBREAK , SENATE_SITE_BILLS , OPENLEG_BILL ) ,  BILL_BASE_PRINT_NO  ( "Base Print No" , SENATE_SITE_BILLS ) ,  BILL_CHAMBER  ( "Chamber" , SENATE_SITE_BILLS ) ,  BILL_SAME_AS  ( "Same As" , SENATE_SITE_BILLS ) ,  BILL_PREVIOUS_VERSIONS  ( "Prev. Versions" , SENATE_SITE_BILLS ) ,  BILL_IS_AMENDED  ( "Is Amended" , SENATE_SITE_BILLS ) ,  BILL_HAS_SAME_AS  ( "Has Same As" , SENATE_SITE_BILLS ) ,  BILL_PUBLISH_DATE  ( "Publish Date" , SENATE_SITE_BILLS ) ,  BILL_MILESTONES  ( "Milestones" , SENATE_SITE_BILLS ) ,  BILL_LAST_STATUS  ( "Last Status" , SENATE_SITE_BILLS , OPENLEG_BILL ) ,  BILL_LAST_STATUS_COMM  ( "Last Status Committee" , SENATE_SITE_BILLS ) ,  BILL_LAST_STATUS_DATE  ( "Last Status Date" , SENATE_SITE_BILLS ) ,  BILL_SUMMARY  ( "Summary" , SENATE_SITE_BILLS , OPENLEG_BILL ) ,  BILL_LAW_CODE  ( "Law Code" , SENATE_SITE_BILLS ) ,  BILL_TEXT  ( "Full Text" , SENATE_SITE_BILLS ) ,  BILL_ADDITIONAL_SPONSOR_OPENLEG  ( "Bill Additional Sponsor" , OPENLEG_BILL ) ,  BILL_ACTIVE_AMENDMENT_OPENLEG  ( "Bill Active Amendment" , OPENLEG_BILL ) ,  BILL_APPROVE_MESSAGE_OPENLEG  ( "Bill Approve Message" , OPENLEG_BILL ) ,  BILL_VOTES_OPENLEG  ( "Bill Votes" , OPENLEG_BILL ) ,  CALENDAR_OPENLEG  ( "Calendar" , OPENLEG_BILL ) ,  BILL_COMMITTEE_AGENDAS_OPENLEG  ( "Bill Committee Agendas" , OPENLEG_BILL ) ,  BILL_PAST_COMMITTEE_OPENLEG  ( "Bill Past commmittee" , OPENLEG_BILL ) ,  AGENDA_ID  ( "Agenda Id" , SENATE_SITE_AGENDA ) ,  AGENDA_BILL_LISTING  ( "Bill List" , LBDC_AGENDA_ALERT , 
<<<<<<<
OPENLEG_AGENDA
=======
SENATE_SITE_AGENDA
>>>>>>>
 ) ,  AGENDA_CHAIR  ( "Chair" , LBDC_AGENDA_ALERT , OPENLEG_AGENDA ) ,  AGENDA_MEETING_TIME  ( "Meeting Time" , LBDC_AGENDA_ALERT , 
<<<<<<<
OPENLEG_AGENDA
=======
SENATE_SITE_AGENDA
...
SENATE_SITE_AGENDA
>>>>>>>
 ) ,  AGENDA_MODIFIED_DATE_TIME  ( "Modified Date Time" , OPENLEG_AGENDA ) ,  AGENDA_HAS_VOTES  ( "Has Votes" , OPENLEG_AGENDA ) ,  
<<<<<<<
AGENDA_ATTENDANCE_LIST
=======
AGENDA_BILLS
>>>>>>>
  ( 
