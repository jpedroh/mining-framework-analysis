...
<<<<<<< /usr/src/app/output/nysenate/openlegislation/0dcc6a0996c0d14e9e3c49b973e1e37ede8a3b97/src/main/java/gov/nysenate/openleg/model/spotcheck/SpotCheckMismatchType.java/left.java
  OPENLEG_AGENDA
=======
  SENATE_SITE_AGENDA
>>>>>>> /usr/src/app/output/nysenate/openlegislation/0dcc6a0996c0d14e9e3c49b973e1e37ede8a3b97/src/main/java/gov/nysenate/openleg/model/spotcheck/SpotCheckMismatchType.java/right.java
  ),
...
>>>>>>> /usr/src/app/output/nysenate/openlegislation/0dcc6a0996c0d14e9e3c49b973e1e37ede8a3b97/src/main/java/gov/nysenate/openleg/model/spotcheck/SpotCheckMismatchType.java/right.java
  ...
  public boolean possibleForContentType(SpotCheckContentType contentType) {
    ...
    return this.getRefTypes().stream().map(SpotCheckRefType::getContentType).anyMatch(contentType::equals);
  }
  ...
  public static String getJsonMap() {
    return OutputUtils.toJson(EnumSet.allOf(SpotCheckMismatchType.class).stream().collect(Collectors.toMap(SpotCheckMismatchType::name, SpotCheckMismatchType::getDisplayName)));
  }
