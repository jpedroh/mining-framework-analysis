...
public class Bill extends BaseLegislativeContent implements Serializable, Comparable<Bill>, Cloneable {
  ...
  protected 
<<<<<<< /usr/src/app/output/nysenate/openlegislation/0dcc6a0996c0d14e9e3c49b973e1e37ede8a3b97/src/main/java/gov/nysenate/openleg/model/bill/Bill.java/left.java
  String
=======
  BillId
>>>>>>> /usr/src/app/output/nysenate/openlegislation/0dcc6a0996c0d14e9e3c49b973e1e37ede8a3b97/src/main/java/gov/nysenate/openleg/model/bill/Bill.java/right.java
   
<<<<<<< /usr/src/app/output/nysenate/openlegislation/0dcc6a0996c0d14e9e3c49b973e1e37ede8a3b97/src/main/java/gov/nysenate/openleg/model/bill/Bill.java/left.java
  ldblurb = ""
=======
  directPreviousVersion
>>>>>>> /usr/src/app/output/nysenate/openlegislation/0dcc6a0996c0d14e9e3c49b973e1e37ede8a3b97/src/main/java/gov/nysenate/openleg/model/bill/Bill.java/right.java
  ;
  ...
  /** --- Overrides --- */
  @Override public int compareTo(Bill other) {
  ...
  /**
     ...
     */
  @Override public void setPublishedDateTime(LocalDateTime publishDateTime) {
  ...
  public SortedSet<BillId> getAmendmentIds() {
    return Collections.synchronizedSortedSet(this.amendmentMap.values().stream().map(BillAmendment::getBillId).collect(Collectors.toCollection(TreeSet::new)));
  }
  ...
  public boolean isBaseVersionPublished() {
    return (this.amendPublishStatusMap.containsKey(Version.DEFAULT) && this.amendPublishStatusMap.get(Version.DEFAULT).isPublished());
  }
  ...
  public boolean hasAmendment(Version version) {
    return this.amendmentMap.containsKey(version) && this.amendmentMap.get(version) != null;
  }
  ...
  public void setLDBlurb(String blurb) {
    this.ldblurb = blurb;
  }
  ...
  public void setReprintOf(BaseBillId reprintOf) {
    this.reprintOf = reprintOf;
  }

  public BaseBillId getReprintOf() {
    return reprintOf;
  }
}