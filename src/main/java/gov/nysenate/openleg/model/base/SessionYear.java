...
public class SessionYear implements Serializable, Comparable<SessionYear> {
  ...
  private void setYear(int year) {
    if (year < 0) {
      throw new IllegalArgumentException("Session year cannot be negative! " + year);
    }
  ...
  /**
     ...
     */
  @JsonIgnore public int getSessionStartYear() {
    return this.year;
  }
  ...
  /**
     ...
     */
  @JsonIgnore public int getSessionEndYear() {
    return this.year + 1;
  }

  /** Returns a date range encompassing this session */
  @JsonIgnore public Range<LocalDate> asDateRange() {
  ...
  @JsonIgnore public Range<LocalDateTime> asDateTimeRange() {
    return Range.closed(LocalDateTime.of(getSessionStartYear(), 1, 1, 0, 0, 0), LocalDateTime.of(getSessionEndYear(), 12, 31, 23, 59, 59));
  }

  /** Returns a sorted list containing the years of the session */
  @JsonIgnore public List<Integer> asYearList() {
  ...
  /**
     ...
     */
  @JsonIgnore public LocalDateTime getStartDateTime() {
  ...
  /**
     ...
     */
  @JsonIgnore public LocalDateTime getEndDateTime() {
    return this.asDateTimeRange().upperEndpoint();
  }

  /** --- Overrides --- */
  @Override public int compareTo(SessionYear o) {
