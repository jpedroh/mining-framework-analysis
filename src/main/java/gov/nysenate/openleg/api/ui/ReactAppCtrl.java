...
@Controller public class ReactAppCtrl {
  ...
  @RequestMapping(value = { "/", "/data/**", "/bills/**", "/calendars/**", "/agendas/**", "/transcripts/**", "/members/**", "/laws/**", "/sources/**", "/reports/**", "/manage/**", "/admin/**", "/register/**", "/subscriptions/**" }) public String home(HttpServletRequest request) {
