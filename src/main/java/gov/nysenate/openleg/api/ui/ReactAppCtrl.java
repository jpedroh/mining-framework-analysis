 ...
 */
@Controller public class ReactAppCtrl {
  ...
  @Value(value = "${ga.tracking.id}") private String gaTrackingId;

  @Value(value = "${api.auth.ip.whitelist}") private String ipWhitelist;

  @RequestMapping(value = { "/", "/data/**", "/bills/**", "/calendars/**", "/agendas/**", "/transcripts/**", "/members/**", "/laws/**", "/sources/**", "/reports/**", "/manage/**", "/admin/**", "/register/**", "/subscriptions/**", "/public" }) public String home(HttpServletRequest request) {
    setRequestAttributes(request);
    return "index";
  }

  @ResponseBody @RequestMapping(value = "/loginapikey", method = RequestMethod.POST) public BaseResponse login(@RequestBody Map<String, String> body, HttpServletRequest request) {
  ...
  @ResponseBody @RequestMapping(value = "/admin/login", method = RequestMethod.POST) public BaseResponse loginAdmin(@RequestBody Map<String, String> body, HttpServletRequest request) {
  ...
  @ResponseBody @RequestMapping(value = "/globals") public BaseResponse globals(HttpServletRequest request) {
    ...
    GlobalsView gv = new GlobalsView(ipWhitelist, ipAddr, environment.getSenSiteUrl(), environment.getOpenlegRefUrl());
