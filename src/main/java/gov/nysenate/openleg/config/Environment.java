...
@Component public class Environment {
  ...
  @Value(value = 
<<<<<<< /usr/src/app/output/nysenate/openlegislation/0dcc6a0996c0d14e9e3c49b973e1e37ede8a3b97/src/main/java/gov/nysenate/openleg/config/Environment.java/left.java
  "${sobi.process.enabled}"
=======
  "${spotcheck.checkmail.enabled:true}"
>>>>>>> /usr/src/app/output/nysenate/openlegislation/0dcc6a0996c0d14e9e3c49b973e1e37ede8a3b97/src/main/java/gov/nysenate/openleg/config/Environment.java/right.java
  ) private boolean 
<<<<<<< /usr/src/app/output/nysenate/openlegislation/0dcc6a0996c0d14e9e3c49b973e1e37ede8a3b97/src/main/java/gov/nysenate/openleg/config/Environment.java/left.java
  sobiProcessEnabled
=======
...
>>>>>>> /usr/src/app/output/nysenate/openlegislation/0dcc6a0996c0d14e9e3c49b973e1e37ede8a3b97/src/main/java/gov/nysenate/openleg/config/Environment.java/right.java
  ...
  /** ---- Openleg Reference ---*/
  @Value(value = "${ref.api.key}") private String refApiKey;

  @Value(value = "${ref.url}") private String refUrl;
