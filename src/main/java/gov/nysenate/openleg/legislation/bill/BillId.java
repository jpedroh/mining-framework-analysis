...
public class BillId implements Serializable, Comparable<BillId> {
  @Serial private static final long serialVersionUID = 6494036869654732240L;
  ...
  /**
     ...
     */
  @JsonIgnore public static BaseBillId getBaseId(BillId billId) {
  ...
  /**
     ...
     */
  @JsonIgnore public BillType getBillType() {
  ...
  /**
     ...
     */
  @JsonIgnore public Chamber getChamber() {
  ...
  /**
     ...
     */
  @JsonIgnore public int getNumber() {
  ...
  /**
     ...
     */
  @JsonIgnore public String getPaddedBillIdString() {
  ...
  /**
     ...
     */
  @JsonIgnore public String getPaddedPrintNumber() {
    Matcher billIdMatcher = PRINT_NUMBER_PATTERN.matcher(this.getPrintNo());
    if (billIdMatcher.find()) {
      return String.format("%s%05d%s", billIdMatcher.group(1), Integer.parseInt(billIdMatcher.group(2)), billIdMatcher.group(3));
    }
    return "";
  }
  ...
  public boolean equalsBase(Object o) {
    ...
    BillId oBillId = (BillId) o;
    return Objects.equals(this.session, oBillId.session) && Objects.equals(this.basePrintNo, oBillId.basePrintNo);
  }
  ...
  @Override public int compareTo(BillId o) {
    return ComparisonChain.start().compare(this.session, o.session).compare(this.basePrintNo, o.basePrintNo).compare(this.version, o.version).result();
  }
  ...
  private String normalizePrintNo(String printNo) {
    ...
    if (!PRINT_NUMBER_PATTERN.matcher(printNo).matches()) {
      throw new IllegalArgumentException("PrintNo (" + printNo + ") " + "does not match print no pattern " + "(" + PRINT_NUMBER_PATTERN.pattern() + ")");
    }
    try {
