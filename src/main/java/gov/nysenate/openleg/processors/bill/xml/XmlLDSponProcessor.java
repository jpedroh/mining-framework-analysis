 ...
 */
@Service public class XmlLDSponProcessor extends AbstractBillProcessor {
  private static final Logger logger = LoggerFactory.getLogger(XmlLDSponProcessor.class);

  @Override public LegDataFragmentType getSupportedType() {
  ...
  /**
     ...
     */
  @Override public void process(LegDataFragment legDataFragment) {
    ...
    try {
      ...
      Bill baseBill = getOrCreateBaseBill(new BillId(sponsorhse + sponsorno, sessyr), legDataFragment);
