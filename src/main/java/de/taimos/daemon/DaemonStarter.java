 ...
 * 
 */
@SuppressWarnings(value = { "restriction" }) public class DaemonStarter {
  ...
  private static void configureLogging() {
    try {
      ...
      if (!DaemonStarter.isDevelopmentMode()) {
        ...
        DaemonStarter.darofi.setFile("log/" + 
<<<<<<< /usr/src/app/output/taimos/daemon-framework/f1696c8958a9311d29297b106064211abec721dd/src/main/java/de/taimos/daemon/DaemonStarter.java/left.java
        DaemonStarter.daemonName.get()
=======
        DaemonStarter.getDaemonName()
>>>>>>> /usr/src/app/output/taimos/daemon-framework/f1696c8958a9311d29297b106064211abec721dd/src/main/java/de/taimos/daemon/DaemonStarter.java/right.java
        ...
        DaemonStarter.syslog.setLayout(new PatternLayout(
<<<<<<< /usr/src/app/output/taimos/daemon-framework/f1696c8958a9311d29297b106064211abec721dd/src/main/java/de/taimos/daemon/DaemonStarter.java/left.java
        DaemonStarter.daemonName.get()
=======
        DaemonStarter.getDaemonName()
  ...
  private final static void handleSignals() {
    if (!System.getProperty("os.name").contains("Win") && !DaemonStarter.isDevelopmentMode()) {
      Signal.handle(new Signal("HUP"), new SignalHandler() {
        @Override public void handle(final Signal arg0) {
        }
      });
