 ...
 * 
 */
@XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "LinkType", propOrder = { "refreshMode", "refreshInterval", "viewRefreshMode", "viewRefreshTime", "viewBoundScale", "viewFormat", "httpQuery", "linkSimpleExtension", "linkObjectExtension" }) @XmlRootElement(name = "Link", namespace = "http://www.opengis.net/kml/2.2") public class Link extends BasicLink implements Cloneable {
  /**
     * RefreshMode
     * <p>
     ...
     * 
     */
  @XmlElement(defaultValue = "onChange") protected RefreshMode refreshMode;
  ...
  /**
     ...
     * 
     */
  @XmlElement(defaultValue = "4.0") protected Double refreshInterval;
  ...
  /**
     ...
     * 
     */
  @XmlElement(defaultValue = "never") protected ViewRefreshMode viewRefreshMode;
  ...
  @XmlElement(name = "LinkSimpleExtensionGroup") @XmlSchemaType(name = "anySimpleType") protected List<Object> linkSimpleExtension;
  ...
  /**
     ...
     * 
     */
  @XmlElement(name = "LinkObjectExtensionGroup") protected List<AbstractObject> linkObjectExtension;
  ...
  @Obvious @Override public Link addToObjectSimpleExtension(final Object objectSimpleExtension) {
  ...
  @Obvious @Override public Link addToBasicLinkSimpleExtension(final Object basicLinkSimpleExtension) {
  ...
  @Obvious @Override public Link addToBasicLinkObjectExtension(final AbstractObject basicLinkObjectExtension) {
  ...
  @Obvious @Override public Link withObjectSimpleExtension(final List<Object> objectSimpleExtension) {
    super.withObjectSimpleExtension(objectSimpleExtension);
    return this;
  }

  @Obvious @Override public Link withId(final String id) {
    super.withId(id);
    return this;
  }

  @Obvious @Override public Link withTargetId(final String targetId) {
    super.withTargetId(targetId);
    return this;
  }

  @Obvious @Override public Link withHref(final String href) {
    super.withHref(href);
    return this;
  }

  @Obvious @Override public Link withBasicLinkSimpleExtension(final List<Object> basicLinkSimpleExtension) {
    super.withBasicLinkSimpleExtension(basicLinkSimpleExtension);
    return this;
  }

  @Obvious @Override public Link withBasicLinkObjectExtension(final List<AbstractObject> basicLinkObjectExtension) {
