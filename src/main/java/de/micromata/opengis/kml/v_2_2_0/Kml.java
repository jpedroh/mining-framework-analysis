...
public class Kml implements Cloneable {
     ...
     * {@code NetworkLinkControl networkLinkControl = new NetworkLinkControl();
     ...
     *
     * This method is a short version for:
     * {@code ScreenOverlay screenOverlay = new ScreenOverlay();
     ...
     *
     * This method is a short version for:
     * {@code PhotoOverlay photoOverlay = new PhotoOverlay();
     ...
     *
     * This method is a short version for:
     * {@code GroundOverlay groundOverlay = new GroundOverlay();
     ...
     *
     * This method is a short version for:
     * {@code NetworkLink networkLink = new NetworkLink();
     ...
     *
     * This method is a short version for:
     * {@code Placemark placemark = new Placemark();
    ...
    public boolean marshalAsKmz(@NotNull
    String name, Kml... additionalFiles) throws IOException {
     ...
     * 
     */
    public static Kml[] unmarshalFromKmz(@NotNull
    ...
    public Kml clone() {
        ...
        } catch (java.lang.CloneNotSupportedException _x) {
