...
public final class ReflectionUtil {
  ...
  public static List<Field> getAllFieldsWithAnnotation(final Class<?> clazz, final Class<? extends Annotation> annotation) {
    ...
    new DerivedClassIterator(clazz) {
      @Override protected boolean handleClass(final Class<?> clazz) {
  ...
  public static List<Method> getAllMethodsWithAnnotation(final Class<?> clazz, final Class<? extends Annotation> annotation) {
  ...
  public static <T extends java.lang.Object> T createInstance(final Class<T> clazz, final Object... parameter) throws Exception {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> Class<T> lookupClass(final Class<T> type, final String className) throws ClassNotFoundException {
