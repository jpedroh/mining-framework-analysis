...
public class PostgresArtifactStore implements IMutableArtifactStore {
  ...
  @Override public void removeFileSet(Distribution distribution, IExtractedFileSet all) {
  ...
  @Override public boolean checkDistribution(Distribution distribution) throws IOException {
  ...
  @Override public void setDownloadConfig(IDownloadConfig downloadConfig) {
    this.downloadConfig = downloadConfig;
  }
