...
public class TemplatesImpl extends AWebPage implements ITemplate {
  ...
  @Autowired private IPackageDAO dPkg;

  @Autowired private IServiceDefaultStateDAO dSvcDefState;

  @Autowired private IServiceStateDAO dSvcState;

  @Autowired private IPackageServerDAO dPackageServer;

  @Autowired private IServiceDAO dSvc;

  @Autowired private IPackageVersionDAO dPkgVersion;

  @Override protected String getTemplateFolder() {
    return "templates";
  }
  ...
  @Override protected String getNavElementName() {
    return "Templates";
  }

  @Override @Transactional public RenderedView view() {
  ...
  @Override @Transactional public AjaxAnswer updatePackages(String tname, List<String> updatePackages) {
  ...
  @Override @Transactional public AjaxAnswer changeTemplateState(String tname, List<String> deletePackages) {
    RESTAssert.assertNotEmpty(tname);
    ETemplate template = this.dTemplate.findByName(tname);
  ...
  @Override @Transactional public RenderedView editTemplateView(String tname) {
    RESTAssert.assertNotEmpty(tname);
    ETemplate template = this.dTemplate.findByName(tname);
  ...
  @Override @Transactional public AjaxAnswer editTemplate(String tname, String templatename, Long packageManagerId, String description, String autoupdate, String smoothupdate) throws FormErrorException {
    RESTAssert.assertNotEmpty(tname);
  ...
  @Override @Transactional public RenderedView addPackageView(String tname) {
    RESTAssert.assertNotEmpty(tname);
    ETemplate template = this.dTemplate.findByName(tname);
  ...
  @Override @Transactional public AjaxAnswer addPackage(String tname, String[] pkgs) throws FormErrorException {
    RESTAssert.assertNotEmpty(tname);
  ...
  @Override @Transactional public RenderedView deleteTemplateView(String tname) {
    RESTAssert.assertNotEmpty(tname);
    ETemplate template = this.dTemplate.findByName(tname);
    RESTAssert.assertNotNull(template);
  ...
  @Override @Transactional public AjaxAnswer deleteTemplate(String tname) throws FormErrorException {
    RESTAssert.assertNotEmpty(tname);
    ETemplate template = this.dTemplate.findByName(tname);
  ...
  @Override @Transactional public RenderedView defaultServiceStatesView(String tname) {
    ETemplate template = this.dTemplate.findByName(tname);
  ...
  @Override @Transactional public AjaxAnswer changeDefaultServiceStates(String tname, List<String> startService, List<String> stopService) {
    RESTAssert.assertNotEmpty(tname);
  ...
  @Override @Transactional public RenderedView addTemplateView() {
    CSViewModel modal = this.createModal("mAddTemplate");
    modal.addModel("availablePM", this.dPackageServer.findList());
    return modal.render();
  }

  @Override @Transactional public AjaxAnswer addTemplate(String templatename, Long packageManagerId, String description, String autoupdate, String smoothupdate) throws FormErrorException {
    this.templateOptionErrorHandling(templatename, packageManagerId, description, autoupdate, smoothupdate);
