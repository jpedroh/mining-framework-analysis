...
public class Query {
  ...
  public Query(String server, String user, String password, boolean shorten, String charset) throws SQLException {
    ...
    this.conn = DriverManager.getConnection(String.format("jdbc:virtuoso://%s/UID=%s/PWD=%s/charset=%s/", server, user, password, charset));
  }
  ...
  /**
     ...
     * @throws IOException
     */
  public ResultSet queryRaw(String query) throws SQLException, IOException {
