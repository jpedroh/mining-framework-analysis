 ...
 * @author christoph
 */
@Getter @Setter @Slf4j public class PhotonDoc {
  ...
  public static PhotonDoc create(long placeId, String osmType, long osmId, Map<String, String> nameMap) {
    return new PhotonDoc(placeId, osmType, osmId, "", "", nameMap, "", null, null, null, 0, 0, null, null, 0, 0);
  }
  ...
  public final String getObjectType() {
    ...
    if (rankAddress >= 13 && rankAddress <= 16) {
      return "city";
    }
    if (rankAddress >= 5 && rankAddress <= 12) {
      return "region";
    }
    if (rankAddress == 4) {
      return "country";
