 ...
 *
 */
@XmlRootElement @XmlAccessorType(value = XmlAccessType.FIELD) public class Times {
  @XmlElement(name = "LastModificationTime") private Calendar lastModificationTime;

  @XmlElement(name = "CreationTime") private Calendar creationTime;

  @XmlElement(name = "LastAccessTime") private Calendar lastAccessTime;

  @XmlElement(name = "ExpiryTime") private Calendar expiryTime;

  @XmlElement(name = "Expires") @XmlJavaTypeAdapter(value = BooleanXmlAdapter.class) private Boolean expires;

  @XmlElement(name = "UsageCount") private int usageCount;

  @XmlElement(name = "LocationChanged") private Calendar locationChanged;
  ...
  @Override public final boolean equals(Object obj) {
    ...
    if (expires == null) {
      ...
      if (!expires.equals(other.expires)) {
        return false;
      }
    }
    if (expiryTime == null) {
      ...
      if (!expiryTime.equals(other.expiryTime)) {
        return false;
      }
    }
    ...
    if (locationChanged == null) {
      ...
      if (!locationChanged.equals(other.locationChanged)) {
        return false;
      }
    }
