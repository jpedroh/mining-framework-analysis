 ...
 *
 */
@XmlRootElement @XmlAccessorType(value = XmlAccessType.FIELD) public class CustomIcons {
  @XmlElement(name = "Icon") private List<CustomIcon> customIconList = new ArrayList<CustomIcon>();
  ...
  @Override public final boolean equals(Object obj) {
    ...
    if (customIconList == null) {
      ...
      if (!customIconList.equals(other.customIconList)) {
        return false;
      }
    }
    return true;
