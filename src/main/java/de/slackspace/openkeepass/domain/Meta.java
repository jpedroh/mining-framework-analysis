 ...
 *
 */
@XmlRootElement @XmlAccessorType(value = XmlAccessType.FIELD) public class Meta {
  @XmlElement(name = "Generator") private String generator;

  @XmlElement(name = "DatabaseName") private String databaseName;

  @XmlElement(name = "DatabaseDescription") private String databaseDescription;

  @XmlElement(name = "DatabaseNameChanged") private Calendar databaseNameChanged;

  @XmlElement(name = "DatabaseDescriptionChanged") private Calendar databaseDescriptionChanged;

  @XmlElement(name = "MaintenanceHistoryDays") private int maintenanceHistoryDays;

  @XmlElement(name = "RecycleBinUUID") @XmlJavaTypeAdapter(value = UUIDXmlAdapter.class) private UUID recycleBinUuid;

  @XmlElement(name = "RecycleBinChanged") private Calendar recycleBinChanged;

  @XmlElement(name = "RecycleBinEnabled") @XmlJavaTypeAdapter(value = BooleanXmlAdapter.class) private Boolean recycleBinEnabled;

  @XmlElement(name = "HistoryMaxItems") private long historyMaxItems;

  @XmlElement(name = "HistoryMaxSize") private long historyMaxSize;

  @XmlElement(name = "CustomIcons") private CustomIcons customIcons;
  ...
  @Override public final boolean equals(Object obj) {
    ...
    if (databaseDescription == null) {
      ...
      if (!databaseDescription.equals(other.databaseDescription)) {
        return false;
      }
    }
    if (databaseDescriptionChanged == null) {
      ...
      if (!databaseDescriptionChanged.equals(other.databaseDescriptionChanged)) {
        return false;
      }
    }
    ...
    if (databaseNameChanged == null) {
      ...
      if (!databaseNameChanged.equals(other.databaseNameChanged)) {
        return false;
      }
    }
    if (generator == null) {
    ...
    if (recycleBinChanged == null) {
      ...
      if (!recycleBinChanged.equals(other.recycleBinChanged)) {
        return false;
      }
    }
    if (recycleBinEnabled == null) {
      ...
      if (!recycleBinEnabled.equals(other.recycleBinEnabled)) {
        return false;
      }
    }
    if (recycleBinUuid == null) {
      ...
      if (!recycleBinUuid.equals(other.recycleBinUuid)) {
        return false;
      }
    }
    return true;
