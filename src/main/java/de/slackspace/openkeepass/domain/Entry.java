 ...
 *
 */
@XmlRootElement @XmlAccessorType(value = XmlAccessType.FIELD) public class Entry implements KeePassFileElement {
  ...
  @XmlElement(name = "IconID") private int iconId = 0;
  ...
  @XmlElement(name = "String") private List<Property> properties = new ArrayList<Property>();

  @XmlElement(name = "History") private History history;
