...
public class TimesBuilder implements TimesContract {
  ...
  @Override public Calendar getLastModificationTime() {
    return lastModificationTime;
  }

  @Override public Calendar getCreationTime() {
    return creationTime;
  }

  @Override public Calendar getLastAccessTime() {
    return lastAccessTime;
  }

  @Override public Calendar getExpiryTime() {
    return expiryTime;
  }

  @Override public boolean getExpires() {
    return expires;
  }

  @Override public int getUsageCount() {
    return usageCount;
  }

  @Override public Calendar getLocationChanged() {
