 ...
 *
 */
@XmlRootElement @XmlAccessorType(value = XmlAccessType.FIELD) public class PropertyValue {
  @XmlAttribute(name = "Protected") @XmlJavaTypeAdapter(value = BooleanXmlAdapter.class) private Boolean isProtected;
  ...
  @Override public boolean equals(Object obj) {
    ...
    if (isProtected == null) {
      ...
      if (!isProtected.equals(other.isProtected)) {
        return false;
      }
    }
    if (value == null) {
