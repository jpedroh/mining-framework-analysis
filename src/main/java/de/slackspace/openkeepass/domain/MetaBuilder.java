...
public class MetaBuilder implements MetaContract {
  ...
  @Override public String getDatabaseDescription() {
    return databaseDescription;
  }

  @Override public Calendar getDatabaseNameChanged() {
    return databaseNameChanged;
  }

  @Override public Calendar getDatabaseDescriptionChanged() {
    return databaseDescriptionChanged;
  }

  @Override public int getMaintenanceHistoryDays() {
    return maintenanceHistoryDays;
  }

  @Override public UUID getRecycleBinUuid() {
    return recycleBinUuid;
  }

  @Override public Calendar getRecycleBinChanged() {
    return recycleBinChanged;
  }

  @Override public boolean getRecycleBinEnabled() {
    return recycleBinEnabled;
  }

  @Override public long getHistoryMaxItems() {
    return historyMaxItems;
  }

  @Override public long getHistoryMaxSize() {
    return historyMaxSize;
  }

  @Override public CustomIcons getCustomIcons() {
    return customIcons;
  }
}