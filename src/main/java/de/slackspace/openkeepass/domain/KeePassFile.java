 ...
 */
@XmlRootElement(name = "KeePassFile") @XmlAccessorType(value = XmlAccessType.FIELD) public class KeePassFile implements KeePassFileElement {
  @XmlElement(name = "Meta") private Meta meta;

  @XmlElement(name = "Root") private Group root;
  ...
  public List<Entry> getEntriesByTitle(final String title, final boolean matchExactly) {
    ...
    return ListFilter.filter(allEntries, new Filter<Entry>() {
      @Override public boolean matches(Entry item) {
        if (matchExactly) {
  ...
  public List<Group> getGroupsByName(final String name, final boolean matchExactly) {
    ...
    return ListFilter.filter(allGroups, new Filter<Group>() {
      @Override public boolean matches(Group item) {
        if (matchExactly) {
  ...
  /**
     ...
     */
  @Deprecated public Entry getEntryByUUID(final UUID UUID) {
  ...
  /**
     ...
     */
  @Deprecated public Group getGroupByUUID(final UUID UUID) {
