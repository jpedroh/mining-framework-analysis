...
public abstract class CoapMessage implements Cloneable {
  ...
  public boolean equals(Object obj) {
    ...
    return this.getHeader().equals(msg.getHeader()) && optionList.equals(msg.getOptionList()) && payload.equals(msg.getPayload());
  }

  @Override public String toString() {
    return this.getClass().getName() + ":" + " MsgID " + getMessageID() + ", MygType " + getMessageType() + ", Code " + getCode() + ", Token " + new ByteArrayWrapper(getToken()).toHexString() + ", Block_2 " + getMaxBlocksizeForResponse();
  }
}