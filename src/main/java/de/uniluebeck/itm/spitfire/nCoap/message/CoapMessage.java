...
public abstract class CoapMessage {
  ...
  public byte[] getToken() {
    try {
      ...
      return 
<<<<<<< /usr/src/app/output/okleine/ncoap/805f73110b467c848fed1ff26471fff425614f01/src/main/java/de/uniluebeck/itm/spitfire/nCoap/message/CoapMessage.java/left.java
      result.getValue()
=======
      optionList.getOption(OptionRegistry.OptionName.TOKEN).get(0).getValue()
>>>>>>> /usr/src/app/output/okleine/ncoap/805f73110b467c848fed1ff26471fff425614f01/src/main/java/de/uniluebeck/itm/spitfire/nCoap/message/CoapMessage.java/right.java
      ;
  ...
  @Override public boolean equals(Object obj) {
    ...
    return rcptAddress.equals(coapMessage.rcptAddress) && header.equals(coapMessage.header) && optionList.equals(coapMessage.optionList) && payload.equals(coapMessage.payload);
  }
}