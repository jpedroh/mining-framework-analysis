...
public abstract class CoapMessage {
  ...
  public byte[] getToken() {
    try {
      return optionList.getOption(OptionRegistry.OptionName.TOKEN).get(0).getValue();
  ...
  public List<Option> getOption(OptionRegistry.OptionName optionName) {
    try {
      ...
      switch (optionName) {
        ...
        if (IPAddressUtil.isIPv6LiteralAddress(
...
>>>>>>> /usr/src/app/output/okleine/ncoap/a823abff038fd7f1526fd6c6ad13c8a7edfab6ca/src/main/java/de/uniluebeck/itm/spitfire/nCoap/message/CoapMessage.java/right.java
  ...
  @Override public boolean equals(Object obj) {
    ...
    return (rcptAddress == null ? coapMessage.rcptAddress == null : rcptAddress.equals(coapMessage.rcptAddress)) && (payload == null ? coapMessage.payload == null : payload.equals(coapMessage.payload)) && header.equals(coapMessage.header) && optionList.equals(coapMessage.optionList);
  }
}