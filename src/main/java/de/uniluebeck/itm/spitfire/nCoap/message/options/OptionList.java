...
public class OptionList {
  ...
  /**
     ...
     * options per message
     */
  public void addOption(Code code, OptionName optionName, Option option) throws InvalidOptionException, ToManyOptionsException {
    ...
    if (allowed_occurence == OptionRegistry.OptionOccurence.NONE) {
      String msg = "[OptionList] " + optionName + " option has no meaning with" + " a message with code " + code + ".";
      throw new InvalidOptionException(option.getOptionNumber(), msg);
    } else {
      if (allowed_occurence == OptionRegistry.OptionOccurence.ONCE) {
        if (options.containsKey(optionName)) {
          String msg = "[OptionList] " + optionName + " option may not occur multiple times" + " in a message with code " + code + ".";
    ...
    log.debug("" + optionName + " option with value " + Option.getHexString(option.getValue()) + " succesfully added to option list.");
  }
