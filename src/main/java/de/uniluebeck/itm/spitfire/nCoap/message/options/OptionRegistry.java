...
public class OptionRegistry {
  ...
  public static enum OptionOccurence {
    NONE,
    ONCE,
    MULTIPLE
  }
  ...
  private static final HashMap<OptionName, OptionSyntaxConstraints> syntaxConstraints = new HashMap<OptionName, OptionSyntaxConstraints>();
  ...
  private static final HashMap<Code, HashMap<OptionName, OptionOccurence>> allowedOptions = new HashMap<Code, HashMap<OptionName, OptionOccurence>>();
  ...
  public static OptionOccurence getAllowedOccurence(Code code, OptionName opt_name) {
    try {
      ...
      if (log.isDebugEnabled()) {
        log.debug("[OptionRegistry] Occurence constraint for option " + opt_name + " with code " + code + " is: " + result.toString());
      }
