 ...
 * @since 1.6
 */
@SuppressWarnings(value = { "PMD.TooManyStaticImports" }) public class TypeErasureAnalyzer extends JavaFileAnalyzer {
  @Nonnull private static ClassOrInterfaceType getFirstQualifier(@Nonnull ClassOrInterfaceType classOrInterfaceType) {
    ClassOrInterfaceType scope = classOrInterfaceType.getScope();
    return scope == null ? classOrInterfaceType : getFirstQualifier(scope);
  }

  @Nonnull private static String getFullQualifier(@Nonnull ClassOrInterfaceType classOrInterfaceType) {
  ...
  @Nonnull private static ClassOrInterfaceType getLastQualifier(@Nonnull ClassOrInterfaceType classOrInterfaceType) {
  ...
  @Nullable private static ClassOrInterfaceType getParentQualifier(@Nonnull ClassOrInterfaceType classOrInterfaceType) {
...
=======
  @Override @SuppressFBWarnings(value = "DM_DEFAULT_ENCODING", justification = "The MavenProject does not provide the proper encoding") public void doAnalysis(@Nonnull AnalysisContext analysisContext, @Nonnull File file) {
    ...
    Reader reader = null;
    try {
      reader = analysisContext.getModule().getEncoding() != null ? new InputStreamReader(new FileInputStream(file), analysisContext.getModule().getEncoding()) : new FileReader(file);
...
>>>>>>> /usr/src/app/output/immobilienscout24/deadcode4j/4a894fe5616a8290f6f5e1458b3e077c0d5e2106/src/main/java/de/is24/deadcode4j/analyzer/TypeErasureAnalyzer.java/right.java
  ...
  @Override protected void analyzeCompilationUnit(@Nonnull final AnalysisContext analysisContext, @Nonnull final CompilationUnit compilationUnit) {
    compilationUnit.accept(new TypeParameterRecordingVisitor<Void>() {
      ...
      @Nullable private ClassOrInterfaceType getReferencedType(@Nonnull Type type) {
      ...
      private void resolveTypeReference(ClassOrInterfaceType referencedType) {
        @SuppressWarnings(value = { "unchecked" }) Optional<String> resolvedClass = or(resolveFullyQualifiedClass(), resolveInnerType(), resolveInheritedType(), resolveImport(), resolvePackageType(), resolveAsteriskImports(), resolveJavaLangType()).apply(referencedType);
      ...
      @Nonnull private Function<ClassOrInterfaceType, Optional<String>> resolveFullyQualifiedClass() {
        return new Function<ClassOrInterfaceType, Optional<String>>() {
          @Nonnull @Override public Optional<String> apply(@SuppressWarnings(value = { "NullableProblems" }) @Nonnull ClassOrInterfaceType typeReference) {
      ...
      @Nonnull private Function<ClassOrInterfaceType, Optional<String>> resolveInnerType() {
        return new Function<ClassOrInterfaceType, Optional<String>>() {
          @Nonnull @Override public Optional<String> apply(@SuppressWarnings(value = { "NullableProblems" }) @Nonnull ClassOrInterfaceType typeReference) {
      ...
      @Nonnull private Optional<String> resolveInnerReference(@Nonnull ClassOrInterfaceType firstQualifier, @Nullable Iterable<? extends BodyDeclaration> bodyDeclarations) {
      ...
      @Nonnull private String resolveReferencedType(@Nonnull ClassOrInterfaceType qualifier, @Nonnull TypeDeclaration type) {
      ...
      @Nonnull private Function<ClassOrInterfaceType, Optional<String>> resolveInheritedType() {
        return new Function<ClassOrInterfaceType, Optional<String>>() {
          @Nonnull @Override public Optional<String> apply(@SuppressWarnings(value = { "NullableProblems" }) @Nonnull ClassOrInterfaceType typeReference) {
      ...
      @Nonnull private Optional<String> resolveInheritedType(@Nonnull CtClass clazz, @Nonnull ClassOrInterfaceType firstQualifier) {
      ...
      @Nonnull private Optional<String> checkNestedClasses(@Nullable CtClass clazz, @Nonnull ClassOrInterfaceType firstQualifier) {
        ...
        for (CtClass nestedClass : getNestedClassesOf(clazz)) {
          ...
          if (firstQualifier.getName().equals(simpleName)) {
            return of(nestedClass.getName().substring(0, nestedClass.getName().length() - simpleName.length()) + getFullQualifier(getLastQualifier(firstQualifier)));
          }
        }
        return resolveInheritedType(clazz, firstQualifier);
      }

      @Nonnull private Function<ClassOrInterfaceType, Optional<String>> resolveImport() {
        return new Function<ClassOrInterfaceType, Optional<String>>() {
          @Nonnull @Override public Optional<String> apply(@SuppressWarnings(value = { "NullableProblems" }) @Nonnull ClassOrInterfaceType typeReference) {
            for (ImportDeclaration importDeclaration : emptyIfNull(compilationUnit.getImports()).filter(not(isAsterisk()))) {
              String importedClass = importDeclaration.getName().getName();
              String typeReferenceQualifier = getFullQualifier(typeReference);
              if (typeReferenceQualifier.equals(importedClass) || typeReferenceQualifier.startsWith(importedClass + ".")) {
      ...
      @Nonnull private Function<ClassOrInterfaceType, Optional<String>> resolvePackageType() {
        return new Function<ClassOrInterfaceType, Optional<String>>() {
          @Nonnull @Override public Optional<String> apply(@SuppressWarnings(value = { "NullableProblems" }) @Nonnull ClassOrInterfaceType typeReference) {
      ...
      @Nonnull private Function<ClassOrInterfaceType, Optional<String>> resolveAsteriskImports() {
        return new Function<ClassOrInterfaceType, Optional<String>>() {
          @Nonnull @Override public Optional<String> apply(@SuppressWarnings(value = { "NullableProblems" }) @Nonnull ClassOrInterfaceType typeReference) {
            for (ImportDeclaration importDeclaration : emptyIfNull(compilationUnit.getImports()).filter(and(isAsterisk(), not(isStatic())))) {
              StringBuilder buffy = new StringBuilder(getFullQualifier(typeReference));
      ...
      @Nonnull private Function<ClassOrInterfaceType, Optional<String>> resolveJavaLangType() {
        return new Function<ClassOrInterfaceType, Optional<String>>() {
          @Nonnull @Override public Optional<String> apply(@SuppressWarnings(value = { "NullableProblems" }) @Nonnull ClassOrInterfaceType typeReference) {
      ...
      @Nonnull private StringBuilder prependPackageName(@Nonnull StringBuilder buffy) {
        return compilationUnit.getPackage() == null ? buffy : prepend(compilationUnit.getPackage().getName(), buffy);
      }
    }, null);
  }

  private static class TypeParameterRecordingVisitor<A extends java.lang.Object> extends FixedVoidVisitorAdapter<A> {
    ...
    @Nonnull private Set<String> getTypeParameterNames(@Nullable List<TypeParameter> typeParameters) {
