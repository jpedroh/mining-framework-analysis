...
public final class Utils {
  ...
  /**
     ...
     * @since 1.6
     */
  @Nonnull public static String getKeyFor(@Nonnull Artifact artifact) {
  ...
  /**
     ...
     * @since 1.6
     */
  @Nonnull public static String getVersionedKeyFor(@Nonnull Artifact artifact) {
  ...
  /**
     ...
     * @since 1.2.0
     */
  @Nonnull public static String getKeyFor(@Nonnull MavenProject project) {
  ...
  /**
     ...
     * @since 1.4
     */
  @Nonnull public static Function<MavenProject, String> toKey() {
    return new Function<MavenProject, String>() {
      @Override public String apply(@Nullable MavenProject input) {
  ...
  /**
     ...
     * @since 1.2.0
     */
  public static <E extends java.lang.Object> boolean addIfNonNull(@Nonnull Collection<E> collection, @Nullable E element) {
  ...
  /**
     ...
     * @since 1.2.0
     */
  public static <K extends java.lang.Object, V extends java.lang.Object> V getValueOrDefault(Map<K, V> map, K key, V defaultValue) {
    V value = map.get(key);
  ...
  /**
     ...
     * @since 1.4
     */
  public static <K extends java.lang.Object, V extends java.lang.Object> Set<V> getOrAddMappedSet(Map<K, Set<V>> map, K key) {
  ...
  /**
     ...
     * @since 1.6
     */
  @Nonnull public static <E extends java.lang.Object> Iterable<E> emptyIfNull(@Nullable Iterable<E> iterable) {
  ...
  /**
     ...
     * @since 1.6
     */
  @Nonnull public static <F extends java.lang.Object, T extends java.lang.Object> Function<F, Optional<T>> or(@Nonnull final Function<F, Optional<T>>... functions) {
    return new Function<F, Optional<T>>() {
      @Nonnull @Override @SuppressWarnings(value = { "ConstantConditions" }) public Optional<T> apply(@Nullable F input) {
        int i = 0;
        for ( ; ; ) {
