 ...
 * @since 1.5
 */
@Mojo(name = "find-only", aggregator = true, requiresProject = true, requiresDependencyCollection = COMPILE, threadSafe = true) @SuppressWarnings(value = { "PMD.TooManyStaticImports" }) public class FindDeadCodeOnlyMojo extends AbstractSlf4jMojo {

<<<<<<< /usr/src/app/output/immobilienscout24/deadcode4j/54dc6a0b2c2a7d81578f9ba336d014b017a4b946/src/main/java/de/is24/deadcode4j/plugin/FindDeadCodeOnlyMojo.java/left.java
  private final Callable<Log> logAccessor = new Callable<Log>() {
    @Override public Log call() {
      return getLog();
    }
  };
=======
  @Component private RepositorySystem repositorySystem;
>>>>>>> /usr/src/app/output/immobilienscout24/deadcode4j/54dc6a0b2c2a7d81578f9ba336d014b017a4b946/src/main/java/de/is24/deadcode4j/plugin/FindDeadCodeOnlyMojo.java/right.java
  ...
  /**
     ...
     * @since 1.3
     */
  @Parameter private Set<String> annotationsMarkingLiveCode = emptySet();
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  /**
     ...
     * @since 1.0.1
     */
  @Parameter private Set<String> classesToIgnore = emptySet();
  ...
  /**
     ...
     * @since 1.3
     */
  @Parameter private List<CustomXml> customXmls = emptyList();
  ...
  /**
     ...
     * @since 1.4
     */
  @Parameter private Set<String> interfacesMarkingLiveCode = emptySet();
  ...
  /**
     ...
     * @since 1.4
     */
  @Parameter private List<String> modulesToSkip = emptyList();

  @Component private MojoExecution mojoExecution;

  @Parameter(property = "reactorProjects", readonly = true) @SuppressWarnings(value = { "MismatchedQueryAndUpdateOfCollection" }) private List<MavenProject> reactorProjects;
  ...
  /**
     ...
     * @since 1.4
     */
  @Parameter private Set<String> superClassesMarkingLiveCode = emptySet();
  ...
  /**
     ...
     */
  @Deprecated @Parameter(defaultValue = "fooBar") @SuppressWarnings(value = { "unused" }) private String workAroundForHelpMojo;
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  public void doExecute() throws MojoExecutionException {
    try {
      ...
      getLog().error("An unexpected exception occurred." + "Please consider reporting an issue at https://github.com/ImmobilienScout24/deadcode4j/issues", rE);
      throw rE;
    }
  }
  ...
  private DeadCode analyzeCode() throws MojoExecutionException {
    Set<Analyzer> analyzers = Sets.<Analyzer>newHashSet(new AopXmlAnalyzer(), new ApacheTilesAnalyzer(), new CastorClassesAnalyzer(), new ClassDependencyAnalyzer(), new FacesConfigXmlAnalyzer(), new HibernateAnnotationsAnalyzer(), new JeeAnnotationsAnalyzer(), new ServletContainerInitializerAnalyzer(), new SpringAnnotationsAnalyzer(), new SpringNamespaceHandlerAnalyzer(), new SpringWebApplicationInitializerAnalyzer(), new SpringWebFlowAnalyzer(), new SpringWebXmlAnalyzer(), new SpringXmlAnalyzer(), new TldAnalyzer(), new WebXmlAnalyzer(), new WsddAnalyzer());
...
<<<<<<< /usr/src/app/output/immobilienscout24/deadcode4j/54dc6a0b2c2a7d81578f9ba336d014b017a4b946/src/main/java/de/is24/deadcode4j/plugin/FindDeadCodeOnlyMojo.java/left.java
  @Nonnull private Collection<CodeRepository> getCodeRepositoryFor(@Nonnull MavenProject project) throws MojoExecutionException {
    de.is24.deadcode4j.plugin.packaginghandler.PackagingHandler packagingHandler = getValueOrDefault(this.packagingHandlers, project.getPackaging(), this.defaultPackagingHandler);
