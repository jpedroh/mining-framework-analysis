...
<<<<<<< /usr/src/app/output/immobilienscout24/deadcode4j/69518ebbfef40f661ff6ab30ea9ab758a81509c7/src/main/java/de/is24/deadcode4j/plugin/packaginghandler/WarPackagingHandler.java/left.java
  @Override @Nonnull public Collection<CodeRepository> getCodeRepositoriesFor(@Nonnull MavenProject project) throws MojoExecutionException {
    ...
    if (!webappDirectory.exists()) {
      throw new MojoExecutionException("The webapp directory of " + getKeyFor(project) + " does not exist - please make sure the project is packaged!");
    }
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Override @Nonnull public Collection<Repository> getRepositoriesFor(@Nonnull MavenProject project) throws MojoExecutionException {
    if (getLog().isDebugEnabled()) {
      getLog().debug("Project " + getKeyFor(project) + " has war packaging, looking for webapp directory...");
    }
    Plugin plugin = project.getPlugin("org.apache.maven.plugins:maven-war-plugin");
