...
@Mojo(name = "create-graph") public class JMeterPluginsMojo extends AbstractMojo {
  ...
  public static class Graph {
    ...
    @Override public String toString() {
      return "Graph{" + "pluginType=\'" + pluginType + '\'' + ", width=" + width + ", height=" + height + ", relativeTimes=" + relativeTimes + ", includeLabels=" + includeLabels + ", excludeLabels=" + excludeLabels + ", outputFile=" + outputFile + ", outputFilePattern=" + outputFilePattern + ", graphPerRow=" + graphPerRow + ", granulation=" + granulation + ", preventOutliers= " + preventOutliers + '}';
    }
  }
