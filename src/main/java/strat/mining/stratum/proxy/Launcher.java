...
<<<<<<< /usr/src/app/output/stratehm/stratum-proxy/185a97668a9fa06017dd079fcebb91ce44fa2ef6/src/main/java/strat/mining/stratum/proxy/Launcher.java/left.java
    hookThread
=======
    new Thread() {
      public void run() {
...
>>>>>>> /usr/src/app/output/stratehm/stratum-proxy/185a97668a9fa06017dd079fcebb91ce44fa2ef6/src/main/java/strat/mining/stratum/proxy/Launcher.java/right.java
    );
  }
  ...
  private static void initHttpServices(ConfigurationManager configurationManager) throws IOException {
    URI baseUri = UriBuilder.fromUri("http://" + configurationManager.getRestBindAddress()).port(configurationManager.getRestListenPort()).path("/proxy").build();
    ...
    apiHttpServer.getListener("grizzly").getCompressionConfig().setCompressableMimeTypes("text/javascript", "application/json", "text/html", "text/css");
