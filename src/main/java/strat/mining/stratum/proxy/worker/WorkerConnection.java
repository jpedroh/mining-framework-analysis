...
<<<<<<< /usr/src/app/output/stratehm/stratum-proxy/45364d27bd41bec671a6fe0c50bf75f3864fb11e/src/main/java/strat/mining/stratum/proxy/worker/WorkerConnection.java/left.java
public class WorkerConnection extends StratumConnection {
  ...
  public void onPoolSubmitResponse(MiningSubmitRequest workerRequest, MiningSubmitResponse poolResponse) {
    if (poolResponse.getIsAccepted() != null && poolResponse.getIsAccepted()) {
      LOGGER.info("Accepted share (diff: {}) from {}@{} on {}. Yeah !!!!", pool != null ? pool.getDifficulty() : "Unknown", workerRequest.getWorkerName(), getConnectionName(), pool.getName());
    } else {
      LOGGER.info("REJECTED share (diff: {}) from {}@{} on {}. Booo !!!!. Error: {}", pool != null ? pool.getDifficulty() : "Unknown", workerRequest.getWorkerName(), getConnectionName(), pool.getName(), poolResponse.getJsonError());
    }
...
>>>>>>> /usr/src/app/output/stratehm/stratum-proxy/45364d27bd41bec671a6fe0c50bf75f3864fb11e/src/main/java/strat/mining/stratum/proxy/worker/WorkerConnection.java/right.java
