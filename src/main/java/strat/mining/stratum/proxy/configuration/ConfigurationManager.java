...
<<<<<<< /usr/src/app/output/stratehm/stratum-proxy/3d9c994eece6a6a6ccf078915a9d6910c45b2f03/src/main/java/strat/mining/stratum/proxy/configuration/ConfigurationManager.java/left.java
  private Level apiLogLevel = null;
=======
  private boolean validateSha26GetworkShares = false;
>>>>>>> /usr/src/app/output/stratehm/stratum-proxy/3d9c994eece6a6a6ccf078915a9d6910c45b2f03/src/main/java/strat/mining/stratum/proxy/configuration/ConfigurationManager.java/right.java
  ...
  public void loadConfiguration(String[] cliArguments) throws Exception {
    ...
    if (cliParser.isHelpRequested()) {
      ...
      if (cliParser.isVersionRequested()) {
        ...
        if (cliParser.getConfigurationFile() != null) {
          ...
          if (configurationFile.isFile() && configurationFile.canRead()) {
            ...
            throw new FileNotFoundException("Configuration file " + configurationFile.getAbsolutePath() + " does not exist or is not readable.");
          }
        } else {
  ...
  private void useConfigurationFile() throws JsonParseException, JsonMappingException, IOException, BadParameterException {
    ...
    logDirectory = configuration.getLogDirectory() != null && !configuration.getLogDirectory().trim().isEmpty() ? new File(configuration.getLogDirectory()) : logDirectory;
    initLogging();
    ...
    isRejectReconnect = configuration.getRejectReconnectOnDifferentHost() != null ? configuration.getRejectReconnectOnDifferentHost() : isRejectReconnect;
    poolHashrateSamplingPeriod = configuration.getPoolHashrateSamplingPeriod() != null ? configuration.getPoolHashrateSamplingPeriod() : poolHashrateSamplingPeriod;
    userHashrateSamplingPeriod = configuration.getUserHashrateSamplingPeriod() != null ? configuration.getUserHashrateSamplingPeriod() : userHashrateSamplingPeriod;
    connectionHashrateSamplingPeriod = configuration.getConnectionHashrateSamplingPeriod() != null ? configuration.getConnectionHashrateSamplingPeriod() : connectionHashrateSamplingPeriod;
    isScrypt = configuration.getIsScrypt() != null ? configuration.getIsScrypt() : isScrypt;
    databaseDirectory = configuration.getDatabaseDirectory() != null && !configuration.getDatabaseDirectory().trim().isEmpty() ? new File(configuration.getDatabaseDirectory()) : databaseDirectory;
    hashrateDatabaseSamplingPeriod = configuration.getHashrateDatabaseSamplingPeriod() != null ? configuration.getHashrateDatabaseSamplingPeriod() : hashrateDatabaseSamplingPeriod;
    hashrateDatabaseHistoryDepth = configuration.getHashrateDatabaseHistoryDepth() != null ? configuration.getHashrateDatabaseHistoryDepth() : hashrateDatabaseHistoryDepth;
    noMidsate = configuration.getNoMidstate() != null ? configuration.getNoMidstate() : noMidsate;
    validateSha26GetworkShares = configuration.getValidateSha26GetworkShares() != null ? configuration.getValidateSha26GetworkShares() : validateSha26GetworkShares;
  ...
  private void useCommandLine(CommandLineOptions cliParser) throws Exception {
    ...
    poolHashrateSamplingPeriod = cliParser.getPoolHashrateSamplingPeriod() != null ? cliParser.getPoolHashrateSamplingPeriod() : poolHashrateSamplingPeriod;
    userHashrateSamplingPeriod = cliParser.getUserHashrateSamplingPeriod() != null ? cliParser.getUserHashrateSamplingPeriod() : userHashrateSamplingPeriod;
    connectionHashrateSamplingPeriod = cliParser.getConnectionHashrateSamplingPeriod() != null ? cliParser.getConnectionHashrateSamplingPeriod() : connectionHashrateSamplingPeriod;
    ...
    hashrateDatabaseSamplingPeriod = cliParser.getHashrateDatabaseSamplingPeriod() != null ? cliParser.getHashrateDatabaseSamplingPeriod() : hashrateDatabaseSamplingPeriod;
    hashrateDatabaseHistoryDepth = cliParser.getHashrateDatabaseHistoryDepth() != null ? cliParser.getHashrateDatabaseHistoryDepth() : hashrateDatabaseHistoryDepth;
    noMidsate = cliParser.isNoMidstate() != null ? cliParser.isNoMidstate() : noMidsate;
    validateSha26GetworkShares = cliParser.isValidateSha26GetworkShares() != null ? cliParser.isValidateSha26GetworkShares() : validateSha26GetworkShares;
  ...
  private void buildPoolsFromCommandLine(CommandLineOptions cliParser) throws Exception {
    ...
    if (cliParser.getPoolHosts() != null) {
      int index = 0;
      if (cliParser.getPoolHosts().size() > 0 && cliParser.getPoolUsers() != null && cliParser.getPoolUsers().size() > 0 && cliParser.getPoolPasswords() != null && cliParser.getPoolPasswords().size() > 0) {
