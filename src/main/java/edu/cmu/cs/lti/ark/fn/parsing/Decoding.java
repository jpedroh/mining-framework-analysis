  ...
  public static class RoleAssignments implements Comparable<RoleAssignments> {
    private final static Function<Map.Entry<String, Range0Based>, String> JOIN_ENTRY = new Function<Map.Entry<String, Range0Based>, String>() {
      @Override public String apply(Map.Entry<String, Range0Based> input) {
        return TAB_JOINER.join(input.getKey(), 
...
>>>>>>> /usr/src/app/output/sammthomson/semafor/1b62f9ce9b3c32ea3e1c737df5c9acf3c23d27e1/src/main/java/edu/cmu/cs/lti/ark/fn/parsing/Decoding.java/right.java
    ...
    private final PMap<String, Range0Based, Span> nonNullAssignments;

    private final PMap<String, Range0Based, Span> nullAssignments;

    public RoleAssignments(PMap<String, Range0Based, Span> nonNullAssignments, PMap<String, Range0Based, Span> nullAssignments) {
      this.nonNullAssignments = nonNullAssignments;
      this.nullAssignments = nullAssignments;
    }

    public RoleAssignments() {
      this(HashTreePMap.<String, Range0Based, Span>empty(), HashTreePMap.<String, Range0Based, Span>empty());
    }

    public RoleAssignments plus(String key, 
<<<<<<< /usr/src/app/output/sammthomson/semafor/1b62f9ce9b3c32ea3e1c737df5c9acf3c23d27e1/src/main/java/edu/cmu/cs/lti/ark/fn/parsing/Decoding.java/left.java
    Range0Based
=======
    Span
>>>>>>> /usr/src/app/output/sammthomson/semafor/1b62f9ce9b3c32ea3e1c737df5c9acf3c23d27e1/src/main/java/edu/cmu/cs/lti/ark/fn/parsing/Decoding.java/right.java
    ...
    private Map<String, Range0Based, Span> getNonNullAssignments() {
  ...
  private Map<String, CandidatesForRole> scoreCandidatesForRoles(List<String> roleNames, List<SpanAndFeatures[]> featuresList) {
    ...
    for (int i = 0; i < featuresList.size(); i++) {
      ...
      for (SpanAndFeatures spanAndFeatures : featuresList.get(i)) {
        ...
        final double logScore = getWeightSum(
<<<<<<< /usr/src/app/output/sammthomson/semafor/1b62f9ce9b3c32ea3e1c737df5c9acf3c23d27e1/src/main/java/edu/cmu/cs/lti/ark/fn/parsing/Decoding.java/left.java
        spanAndFeatures.features()
=======
        spanAndFeatures.features
>>>>>>> /usr/src/app/output/sammthomson/semafor/1b62f9ce9b3c32ea3e1c737df5c9acf3c23d27e1/src/main/java/edu/cmu/cs/lti/ark/fn/parsing/Decoding.java/right.java
        , modelWeights);
