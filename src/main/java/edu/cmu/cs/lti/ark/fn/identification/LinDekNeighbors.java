...
public class LinDekNeighbors {
  ...
  public static void main(String[] args) throws IOException {
    Pair<TObjectIntHashMap<String>, TObjectIntHashMap<String>> p = readAdjectivesAndAdverbs();
  ...
  public static void createNeighborsForVerbs() throws IOException {
  ...
  public static void createNeighborsForNouns() throws IOException {
    String stopfile = "lrdata/stopwords.txt";
    String wnConfigFile = "file_properties.xml";
    WordNetRelations wnr = new WordNetRelations(stopfile, wnConfigFile);
    String lindekdirectory = "/home/dipanjan/work/fall2010/SSL/FNData";
  ...
  public static void createNeighborsForAdverbsAndAdjectives(Pair<TObjectIntHashMap<String>, TObjectIntHashMap<String>> p) throws IOException {
    String lindekdirectory = "/home/dipanjan/work/fall2010/SSL/FNData";
    String outFile = "/home/dipanjan/work/fall2010/SSL/FNData/lindekneighbors.dat";
    ...
    while (line != null) {
      ...
      for (int i = 1; i < lines.size(); i++) {
        ...
        if (unit.startsWith("\"")) {
          ...
          String lc = unit.toLowerCase();
          int wpos = findWordPOS(dAdjectives, dAdverbs, lc);
          if (wpos == 1) {
            isAdjective = true;
          } else {
            if (wpos == 2) {
  ...
  public static boolean isMultiWordAdjective(THashSet<String> mAdjectives, String word) {
    return mAdjectives.contains(word);
  }

  public static boolean isMultiWordAdverb(THashSet<String> mAdverbs, String word) {
    return mAdverbs.contains(word);
  }

  public static int findWordPOS(TObjectIntHashMap<String> dAdjectives, TObjectIntHashMap<String> dAdverbs, String word) {
  ...
  public static Pair<TObjectIntHashMap<String>, TObjectIntHashMap<String>> readAdjectivesAndAdverbs() throws IOException {
    String adjFile = "/home/dipanjan/work/fall2010/SSL/FNData/gw.a";
    String advFile = "/home/dipanjan/work/fall2010/SSL/FNData/gw.adv";
    List<String> adjectives = ParsePreparation.readLines(adjFile);
    List<String> adverbs = ParsePreparation.readLines(advFile);
    TObjectIntHashMap<String> adjMap = new TObjectIntHashMap<String>();
    TObjectIntHashMap<String> advMap = new TObjectIntHashMap<String>();
  ...
  public static Pair<TObjectIntHashMap<String>, TObjectIntHashMap<String>> scanAdjectivesAndAdverbs() {
    String largeFile = "/home/dipanjan/work/fall2010/SSL/FNData/AP_1m.all.lemma.tags";
