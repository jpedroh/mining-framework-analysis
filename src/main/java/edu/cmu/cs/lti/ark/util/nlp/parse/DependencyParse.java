...
public class DependencyParse extends ParseNode<DependencyParse> {
  ...
  private final Supplier<DependencyParse[]> indexSortedNodesSupplier = Suppliers.memoize(new Supplier<DependencyParse[]>() {
...
>>>>>>> /usr/src/app/output/sammthomson/semafor/1b62f9ce9b3c32ea3e1c737df5c9acf3c23d27e1/src/main/java/edu/cmu/cs/lti/ark/util/nlp/parse/DependencyParse.java/right.java
...
>>>>>>> /usr/src/app/output/sammthomson/semafor/1b62f9ce9b3c32ea3e1c737df5c9acf3c23d27e1/src/main/java/edu/cmu/cs/lti/ark/util/nlp/parse/DependencyParse.java/right.java
  ...
  public static DependencyParse[] process(String[][][] parseData, double logProb) {
    ...
    checkArgument(parseData[0][2].length == parseData[0][3].length, "Parse information inconsistent: %s dependency types but %s parent indices.", parseData[0][2].length, parseData[0][3].length);
