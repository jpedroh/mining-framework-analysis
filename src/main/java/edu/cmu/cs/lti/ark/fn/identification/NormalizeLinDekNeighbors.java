...
public class NormalizeLinDekNeighbors {
  public static void main(String[] args) throws IOException {
    ...
    int size = lines.size();
    ArrayList<TObjectDoubleHashMap<String>> rnList = new ArrayList<TObjectDoubleHashMap<String>>();
    ...
    THashMap<String, TObjectDoubleHashMap<String>> finalMap = new THashMap<String, TObjectDoubleHashMap<String>>();
    for (int i = 0; i < size; i++) {
      String line = lines.get(i).trim();
      String[] toks = line.split("\t");
      String unit = toks[0];
  ...
  public static TObjectDoubleHashMap<String> add(TObjectDoubleHashMap<String> vector, TObjectDoubleHashMap<String> oldVector, int count) {
