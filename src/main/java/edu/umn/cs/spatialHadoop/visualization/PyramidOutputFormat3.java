...
<<<<<<< /usr/src/app/output/aseldawy/spatialhadoop2/83340231db8f7e94b9972fb90e6dbd379e7937fa/src/main/java/edu/umn/cs/spatialHadoop/visualization/PyramidOutputFormat3.java/left.java
  AdaptiveMultilevelPlot
=======
  PyramidOutputFormat3
>>>>>>> /usr/src/app/output/aseldawy/spatialhadoop2/83340231db8f7e94b9972fb90e6dbd379e7937fa/src/main/java/edu/umn/cs/spatialHadoop/visualization/PyramidOutputFormat3.java/right.java
  ...
  static class ImageRecordWriter extends RecordWriter<LongWritable, Writable> {
    ...
    ImageRecordWriter(FileSystem outFs, Path taskOutPath, TaskAttemptContext task) {
      ...
      imgExt = extensionStart == -1 ? ".png" : outFName.substring(extensionStart);
      tempLine = new Text2();
    ...
    @Override public void write(LongWritable encodedTileID, Writable w) throws IOException {
  ...
  @Override public RecordWriter<LongWritable, Writable> getRecordWriter(TaskAttemptContext task) throws IOException, InterruptedException {
  ...
  public static class MultiLevelOutputCommitter extends FileOutputCommitter {
    ...
    public MultiLevelOutputCommitter(Path outputPath, TaskAttemptContext context) throws IOException {
    ...
    @Override public void commitJob(JobContext context) throws IOException {
      ...
      htmlOut.close();
      PrintStream confOut = new PrintStream(outFs.create(new Path(outPath, "Configuration.txt")));
