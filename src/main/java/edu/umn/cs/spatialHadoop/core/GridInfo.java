...
public class GridInfo extends Rectangle {
  ...
  @Override public String toString() {
    return "grid: " + x1 + "," + y1 + "," + x2 + "," + y2 + ", " + "cell: " + getAverageCellWidth() + "," + getAverageCellHeight() + "(" + columns + "x" + rows + ")";
  }
  ...
  @Override public boolean equals(Object obj) {
    ...
    return super.equals(obj) && this.columns == gi.columns && this.rows == gi.rows;
  }
  ...
  @Override public Text toText(Text text) {
    ...
    TextSerializerHelper.serializeLong(rows, text, '\u0000');
    return text;
  }
