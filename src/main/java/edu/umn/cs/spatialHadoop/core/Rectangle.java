...
public class Rectangle implements Shape, WritableComparable<Rectangle> {
  ...
  @Override public double distanceTo(double px, double py) {
  ...
  @Override public Rectangle getMBR() {
    return new Rectangle(this);
  }
  ...
  @Override public Text toText(Text text) {
  ...
  @Override public void fromText(Text text) {
   ...
   */
  @Override public int compareTo(Rectangle r2) {
    if (this.x1 < r2.x1) {
      return -1;
    }
    if (this.x1 > r2.x1) {
  ...
  @Override public void draw(Graphics g, Rectangle fileMBR, int imageWidth, int imageHeight, double scale) {
  ...
  @Override public void draw(Graphics g, double xscale, double yscale) {
  ...
  public String toWKT() {
    return String.format("POLYGON((%g %g, %g %g, %g %g, %g %g, %g %g))", x1, y1, x1, y2, x2, y2, x2, y1, x1, y1);
  }
}