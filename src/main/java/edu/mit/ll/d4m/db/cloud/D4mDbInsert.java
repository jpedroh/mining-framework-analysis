...
public class D4mDbInsert extends D4mParent {
  ...
  private static boolean IntEncodeValueAndDropEmpty = false;

  @SuppressWarnings(value = { "unused" }) public static void setIntEncodeValueAndDropEmpty(boolean intEncodeValueAndDropEmpty) {
    IntEncodeValueAndDropEmpty = intEncodeValueAndDropEmpty;
  }

  @SuppressWarnings(value = { "unused" }) public static boolean isIntEncodeValueAndDropEmpty() {
    return IntEncodeValueAndDropEmpty;
  }

  private static boolean IntEncodeKeyAndPrependLastByteRev = false;

  @SuppressWarnings(value = { "unused" }) public static void setIntEncodeKeyAndPrependLastByteRev(boolean intEncodeKeyAndPrependLastByteRev) {
    IntEncodeKeyAndPrependLastByteRev = intEncodeKeyAndPrependLastByteRev;
  }

  @SuppressWarnings(value = { "unused" }) public static boolean isIntEncodeKeyAndPrependLastByteRev() {
