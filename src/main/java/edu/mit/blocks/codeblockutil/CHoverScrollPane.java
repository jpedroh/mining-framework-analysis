...
public class CHoverScrollPane extends CScrollPane implements KeyListener {
  ...
  /**
     ...
     */
  public CHoverScrollPane(JComponent view, ScrollPolicy verticalPolicy, ScrollPolicy horizontalPolicy, int thumbWidth, Color thumbColor, Color trackColor) {
    super();
    this.setLayout(null);
    ...
    verticalbar = new HoverVerticalBar(thumbWidth, thumbColor, trackColor, scrollviewport.getVerticalScrollBar().getModel(), verticalPolicy);
    horizontalbar = new HoverHorizontalBar(thumbWidth, thumbColor, trackColor, scrollviewport.getHorizontalScrollBar().getModel());
