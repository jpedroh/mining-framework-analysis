...
public class CTracklessScrollPane extends CScrollPane implements KeyListener {
  ...
  /**
     ...
     */
  public CTracklessScrollPane(JComponent view, ScrollPolicy verticalPolicy, ScrollPolicy horizontalPolicy, int thumbWidth, Color thumbColor, Color trackColor) {
    super();
    ...
    verticalbar = new VerticalBar(thumbWidth, thumbColor, scrollviewport.getVerticalScrollBar().getModel());
    verticalbar.setBackground(trackColor);
    horizontalbar = new HorizontalBar(thumbWidth, thumbColor, scrollviewport.getHorizontalScrollBar().getModel());
