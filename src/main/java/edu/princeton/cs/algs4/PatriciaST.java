 ...
 */
public class PatriciaST<Value extends java.lang.Object> {
  private Node head;
  ...
  public void put(String key, Value val) {
    if (key == null) {
      throw new NullPointerException("called put(null)");
    }
    if (key.length() == 0) {
  ...
  public Value get(String key) {
    if (key == null) {
      throw new NullPointerException("called get(null)");
    }
    if (key.length() == 0) {
      throw new IllegalArgumentException("invalid key");
    }
  ...
  public void delete(String key) {
    if (key == null) {
      throw new NullPointerException("called delete(null)");
    }
    if (key.length() == 0) {
      throw new IllegalArgumentException("invalid key");
    }
