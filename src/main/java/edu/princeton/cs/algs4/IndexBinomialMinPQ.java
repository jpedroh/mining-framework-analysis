 ...
 */
public class IndexBinomialMinPQ<Key extends java.lang.Object> implements Iterable<Integer> {
  ...
  private class Node<Key extends java.lang.Object> {
    Key key;
  ...
  private class MyComparator implements Comparator<Key> {
    @Override public int compare(Key key1, Key key2) {
