...
class HttpTemplate {
  ...
  public HttpTemplate() {
    ...
    defaultHttpHeaders.put("User-Agent", "ResCU JDK/6 AppleWebKit/535.7 Chrome/16.0.912.36 Safari/535.7");
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> T executeRequest(String urlString, Class<T> returnType, String requestBody, Map<String, String> httpHeaders, HttpMethod method, String contentType, Class<? extends RuntimeException> exceptionType) throws IOException {
