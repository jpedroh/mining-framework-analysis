 ...
 */public enum Browser {
  ...
  IE10(Manufacturer.MICROSOFT, Browser.IE, 92, "Internet Explorer 10", new String[] { "MSIE 10" }, new String[] { "Xbox", "Xbox One" }, BrowserType.WEB_BROWSER, RenderingEngine.TRIDENT, null),
  IE9(Manufacturer.MICROSOFT, Browser.IE, 90, "Internet Explorer 9", new String[] { "MSIE 9" }, new String[] { "Xbox", "Xbox One" }, BrowserType.WEB_BROWSER, RenderingEngine.TRIDENT, null),
  ...
  XBOX(Manufacturer.MICROSOFT, null, 360, "Xbox", new String[] { "Xbox", "Xbox One" }, new String[] {  }, BrowserType.APP, RenderingEngine.TRIDENT, null),
