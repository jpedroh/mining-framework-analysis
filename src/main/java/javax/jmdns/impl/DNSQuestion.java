...
public class DNSQuestion extends DNSEntry {
  ...
  private static class DNS4Address extends DNSQuestion {
    ...
    @Override public void addAnswers(JmDNSImpl jmDNSImpl, Set<DNSRecord> answers) {
    ...
    @Override public boolean iAmTheOnlyOne(JmDNSImpl jmDNSImpl) {
  ...
  private static class AllRecords extends DNSQuestion {
    ...
    @Override public boolean isSameType(DNSEntry entry) {
      return (entry != null);
    }
...
<<<<<<< /usr/src/app/output/openhab/jmdns/437ad89e74909605df7580af282a585b90e71e49/src/main/java/javax/jmdns/impl/DNSQuestion.java/left.java
        servicePtr
=======
        new DNSRecord.Pointer(constructedName, DNSRecordClass.CLASS_IN, DNSRecordClass.UNIQUE, DNSConstants.DNS_TTL, info.getName() + "." + constructedType)
>>>>>>> /usr/src/app/output/openhab/jmdns/437ad89e74909605df7580af282a585b90e71e49/src/main/java/javax/jmdns/impl/DNSQuestion.java/right.java
  ...
  @Override public void toString(StringBuilder aLog) {
  }
}