...
public abstract class DNSRecord extends DNSEntry {
  ...
  @Override public boolean isExpired(long now) {
    return getExpirationTime(100) <= now;
  }

  @Override public boolean isStale(long now) {
  ...
  public static class IPv4Address extends Address {
    ...
    @Override void write(MessageOutputStream out) {
      if (_addr != null) {
    ...
    @Override public ServiceInfo getServiceInfo(boolean persistent) {
  ...
  public static abstract class Address extends DNSRecord {
    ...
    @Override boolean sameValue(DNSRecord other) {
      try {
        if (!(other instanceof Address)) {
          return false;
        }
    ...
    @Override public boolean isSingleValued() {
      return false;
    }
    ...
    /**
         ...
         */
    @Override protected void toByteArray(DataOutputStream dout) throws IOException {
    ...
    /**
         ...
         */
    @Override boolean handleQuery(JmDNSImpl dns, long expirationTime) {
    ...
    /**
         ...
         */
    @Override boolean handleResponse(JmDNSImpl dns) {
      if (dns.getLocalHost().conflictWithRecord(this)) {
    ...
    @Override DNSOutgoing addAnswer(JmDNSImpl dns, DNSIncoming in, InetAddress addr, int port, DNSOutgoing out) throws IOException {
      return out;
    }
    ...
    @Override public ServiceEvent getServiceEvent(JmDNSImpl dns) {
    ...
    @Override protected void toString(final StringBuilder sb) {
      super.toString(sb);
  ...
  public static class Pointer extends DNSRecord {
    ...
    @Override public boolean isSameEntry(DNSEntry entry) {
    ...
    @Override protected void toString(final StringBuilder sb) {
      super.toString(sb);
      sb.append(" alias: \'").append(_alias != null ? _alias.toString() : "null").append('\'');
    }
  }
  ...
  public static class Service extends DNSRecord {
    ...
    @Override DNSOutgoing addAnswer(JmDNSImpl dns, DNSIncoming in, InetAddress addr, int port, DNSOutgoing out) throws IOException {
      ...
      if (info != null) {
        if (this._port == info.getPort() != _server.equals(dns.getLocalHost().getName())) {
          return dns.addAnswer(in, addr, port, out, new DNSRecord.Service(info.getQualifiedName(), DNSRecordClass.CLASS_IN, DNSRecordClass.UNIQUE, DNSConstants.DNS_TTL, info.getPriority(), info.getWeight(), info.getPort(), dns.getLocalHost().getName()));
        }
      }
      return out;
    }
    ...
    @Override protected void toString(final StringBuilder sb) {
      super.toString(sb);
      sb.append(" server: \'").append(_server).append(':').append(_port).append('\'');
    }
  }
  ...
  public static class HostInformation extends DNSRecord {
    ...
    @Override protected void toString(final StringBuilder sb) {
      super.toString(sb);
      sb.append(" cpu: \'").append(_cpu).append("\' os: \'").append(_os).append('\'');
    }
  }
