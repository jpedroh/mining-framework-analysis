 ...
 */
@SuppressWarnings(value = { "UnusedDeclaration" }) public class RubyPlugin extends PluginImpl {
  /**
  ...
  public void rack(IRubyObject servletHandler) {
    ...
    dra.call(env).respond(new ServletRackResponseEnvironment(Stapler.getCurrentResponse()));
  }
}