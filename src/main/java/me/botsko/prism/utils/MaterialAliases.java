...
public class MaterialAliases {
    ...
    if (items != null) {
      ...
      if (itemAliases != null) {
        for (Map.Entry<String, Object> entry : itemAliases.entrySet()) {
          @SuppressWarnings(value = { "unchecked" }) Iterable<String> aliases = (List<String>) entry.getValue();
  ...
  /**
     ...
     * @return IntPair
     */
  @Deprecated public IntPair materialToIdsWildcard(Material material, String state) {
  ...
  /**
     ...
     * @return HashMap
     */
  @Deprecated public HashMap<String, String> getItemAliases() {
    return itemAliases;
  }
