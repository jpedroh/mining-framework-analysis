...
public abstract class ScalaCompilerSupport extends ScalaSourceMojoSupport {
  ...
  /**
     ...
     *
     */
  @Parameter(property = "recompileMode", defaultValue = "incremental") protected String recompileMode;
  ...
  /**
     ...
     *
     */
  @Parameter(property = "compileOrder", defaultValue = "Mixed") private CompileOrder compileOrder;
  ...
  @SuppressWarnings(value = { "unchecked" }) protected int incrementalCompile(List<String> classpathElements, List<File> sourceRootDirs, File outputDir, File cacheFile, boolean compileInLoop) throws Exception {
