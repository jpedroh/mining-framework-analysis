...
class Sample {
  ...
  public static Sample createFromWav(File file, boolean dither, boolean halfSpeed, int volumeDb, int trim, int pitch) throws IOException, UnsupportedAudioFileException {
