...
public class BlockListeners implements Listener {
  ...
  @EventHandler(ignoreCancelled = true) public void onItemDrop(PlayerDropItemEvent event) {
  ...
  @EventHandler public void onInventoryMove(InventoryMoveItemEvent event) {
    if (!cratesPlus.getConfigHandler().isDisableKeySwapping()) {
      return;
    }
    String title;
  ...
  @EventHandler public void onInventoryPickup(InventoryPickupItemEvent event) {
    if (!cratesPlus.getConfigHandler().isDisableKeySwapping()) {
      return;
    }
  ...
  @EventHandler(ignoreCancelled = true, priority = EventPriority.HIGHEST) public void onBlockPlace(BlockPlaceEvent event) {
    String title;
