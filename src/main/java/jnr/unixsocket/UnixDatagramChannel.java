...
public class UnixDatagramChannel extends AbstractNativeDatagramChannel {
  ...
  @Override public UnixDatagramChannel bind(SocketAddress local) throws IOException {
  ...
  @Override public UnixSocketAddress receive(ByteBuffer src) throws IOException {
  ...
  @Override public int send(ByteBuffer src, SocketAddress target) throws IOException {
  ...
  @Override public DatagramChannel connect(SocketAddress remote) throws IOException {
  ...
  @Override public UnixDatagramSocket socket() {
    try {
  ...
  @Override public <T extends java.lang.Object> T getOption(SocketOption<T> name) throws IOException {
  ...
  @Override public <T extends java.lang.Object> DatagramChannel setOption(SocketOption<T> name, T value) throws IOException {
    if (name == null) {
  ...
  @Override public MembershipKey join(InetAddress group, NetworkInterface interf) {
    throw new UnsupportedOperationException("join is not supported");
  }

  @Override public MembershipKey join(InetAddress group, NetworkInterface interf, InetAddress source) {
    throw new UnsupportedOperationException("join is not supported");
  }
}