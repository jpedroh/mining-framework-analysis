...
public class MySQLServerHelper extends NullHelper {
  ...
  @Override public String outputType(String type, Integer size) {
  ...
  @Override public String outputName(String name) {
    if (name.contains(" ")) {
      name = name.replace(' ', '_');
    }
    if (name.contains(".")) {
  ...
  @Override public String normalizedType(String type) {
  ...
  @Override public void fixSequences(DBConnection con, String table, String typeName, String column) throws Exception {
  ...
  @Override public String normalizeValue(String value) {
    if (value != null) {
  ...
  @Override public void setDefaultValue(DBConnection con, String table, String typeName, String column, String value) throws Exception {
  ...
  @Override public int translateType(int type) {
    int pType = type;
    switch (type) {
      case Types.NCHAR:
      pType = Types.CHAR;
  ...
  @Override public String normalizeDefault(String str) {
  ...
  @Override public String getParametersHelp() {
    return MYSQL_NORMALIZE_BIT_BOOLEAN + " - convert BIT columns into BOOLEAN";
  }

  @Override public void setupStatement(Statement stm) throws SQLException {
