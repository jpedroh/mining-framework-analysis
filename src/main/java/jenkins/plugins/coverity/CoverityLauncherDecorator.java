 ...
 */
@Extension public class CoverityLauncherDecorator extends LauncherDecorator {
  /**
...
<<<<<<< /usr/src/app/output/jenkinsci/coverity-plugin/ab382ea7f87d69826dd1c5281156f1f250c49b44/src/main/java/jenkins/plugins/coverity/CoverityLauncherDecorator.java/left.java
  public class DecoratedLauncher extends Launcher {
    ...
    @Override public Proc launch(ProcStarter starter) throws IOException {
      ...
      if (!isCoverityBuildStepEnabled || (isCoverityBuildStepEnabled && CoverityBuildStep.get())) {
        ...
        if (invocationAssistance != null && invocationAssistance.getSaOverride() != null) {
          home = new CoverityInstallation(CoverityUtils.evaluateEnvVars(invocationAssistance.getSaOverride(), envVars, invocationAssistance.getUseAdvancedParser())).forEnvironment(envVars).getHome();
        }
