...
public abstract class CoverityToolHandler {
  ...
  public boolean importMsvsca(AbstractBuild<?, ?> build, Launcher launcher, BuildListener listener, String home, CoverityTempDir temp, boolean csharpMsvsca) throws IOException, InterruptedException {
