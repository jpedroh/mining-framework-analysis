      ...
      if (json != null && !json.isNullObject()) {
        ...
        if (cimStreamDescriptor != null) {
          if (StringUtils.isEmpty(cimStream.getInstance())) {
            ...
            if (StringUtils.isEmpty(cimStream.getStream()) || StringUtils.isEmpty(cimStream.getProject())) {
              DefectFilters defectFilters = cimStream.getDefectFilters();
              if (defectFilters != null) {
                Set<String> allCheckers = new HashSet<>(getInstance(cimStream.getInstance()).getCimInstanceCheckers());
                try {
                  cimStream.getDefectFilters().invertCheckers(allCheckers, toStrings(cimStreamDescriptor.doFillClassificationDefectFilterItems(cimStream.getInstance())), toStrings(cimStreamDescriptor.doFillActionDefectFilterItems(cimStream.getInstance())), toStrings(cimStreamDescriptor.doFillSeveritiesDefectFilterItems(cimStream.getInstance())), toStrings(cimStreamDescriptor.doFillComponentDefectFilterItems(cimStream.getInstance(), cimStream.getStream())));
