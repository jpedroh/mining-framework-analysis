...
public class CoverityPublisher extends Recorder {
  ...
  @DataBoundConstructor public CoverityPublisher(CIMStream cimStream) {
  ...
  @DataBoundSetter public void setInvocationAssistance(InvocationAssistance invocationAssistance) {
  ...
  @DataBoundSetter public void setKeepIntDir(boolean keepIntDir) {
  ...
  @DataBoundSetter public void setSkipFetchingDefects(boolean skipFetchingDefects) {
  ...
  @DataBoundSetter public void setHideChart(boolean hideChart) {
  ...
  @DataBoundSetter public void setTaOptionBlock(TaOptionBlock taOptionBlock) {
  ...
  @DataBoundSetter public void setScmOptionBlock(ScmOptionBlock scmOptionBlock) {
  ...
  @Extension public static class DescriptorImpl extends BuildStepDescriptor<Publisher> {
    ...
    /**
         ...
         */
    public FormValidation doCheckInstance(@QueryParameter String host, @QueryParameter int port, @QueryParameter boolean useSSL, @QueryParameter String credentialId) {
