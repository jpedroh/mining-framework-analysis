...
public class CoverityProjectAction implements Action {
  ...
  private class GraphImpl extends Graph {
    ...
    protected JFreeChart createGraph() {
      ...
      final JFreeChart chart = ChartFactory.createStackedAreaChart(null, null, "Defect Count", dataset, PlotOrientation.VERTICAL, true, true, false);
      ...
      StackedAreaRenderer ar = new StackedAreaRenderer2() {
        ...
        @Override public String generateURL(CategoryDataset dataset, int row, int column) {
          ChartLabel label = (ChartLabel) dataset.getColumnKey(column);
          return label.getUrl() + CoverityBuildAction.BUILD_ACTION_IDENTIFIER;
        }

        @Override public String generateToolTip(CategoryDataset dataset, int row, int column) {
          ChartLabel label = (ChartLabel) dataset.getColumnKey(column);
          int defects = 0;
