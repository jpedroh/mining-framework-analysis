...
public class CIMStream extends AbstractDescribableImpl<CIMStream> {
  ...
  @DataBoundConstructor public CIMStream(String instance, String project, String stream, DefectFilters defectFilters, String id, String language, InvocationAssistance invocationAssistanceOverride) {
  ...
  @Override public String toString() {
    return "CIMStream{" + "instance=\'" + instance + '\'' + ", project=\'" + project + '\'' + ", stream=\'" + stream + '\'' + ", id=\'" + id + '\'' + ", language=\'" + language + '\'' + ", defectFilters=" + defectFilters + ", invocationAssistanceOverride=" + invocationAssistanceOverride + '}';
  }
  ...
  @Extension public static class DescriptorImpl extends Descriptor<CIMStream> {
