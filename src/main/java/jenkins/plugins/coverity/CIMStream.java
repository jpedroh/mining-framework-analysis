...
public class CIMStream extends AbstractDescribableImpl<CIMStream> {
  ...
  @DataBoundConstructor public CIMStream(String instance, String project, String stream) {
  ...
  @DataBoundSetter public void setDefectFilters(DefectFilters defectFilters) {
  ...
  @Deprecated public InvocationAssistance getInvocationAssistanceOverride() {
  ...
  @Override public String toString() {
    return "CIMStream{" + "instance=\'" + instance + '\'' + ", project=\'" + project + '\'' + ", stream=\'" + stream + '\'' + ", defectFilters=" + defectFilters + '}';
  }
