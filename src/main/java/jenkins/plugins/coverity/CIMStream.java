...
public class CIMStream extends AbstractDescribableImpl<CIMStream> {
  ...
  @DataBoundConstructor public CIMStream(String instance, String project, String stream, DefectFilters defectFilters, String id) {
  ...
  @Override public String toString() {
    return "CIMStream{" + "instance=\'" + instance + '\'' + ", project=\'" + project + '\'' + ", stream=\'" + stream + '\'' + ", id=\'" + id + '\'' + ", defectFilters=" + defectFilters + '}';
  }
