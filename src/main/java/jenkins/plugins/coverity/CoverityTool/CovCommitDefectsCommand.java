...
public class CovCommitDefectsCommand extends CoverityCommand {
  ...
  public CovCommitDefectsCommand(AbstractBuild<?, ?> build, Launcher launcher, TaskListener listener, CoverityPublisher publisher, String home, EnvVars envVars, CIMStream cimStream, CIMInstance cimInstance, CoverityVersion version) {
  ...
  @Override protected void prepareCommand() {
    addHost();
