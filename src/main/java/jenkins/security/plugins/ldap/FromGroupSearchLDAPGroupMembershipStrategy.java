...
public class FromGroupSearchLDAPGroupMembershipStrategy extends LDAPGroupMembershipStrategy {
  ...
  @Override public void setAuthoritiesPopulator(LdapAuthoritiesPopulator authoritiesPopulator) {
  ...
  @Override public Set<String> getGroupMembers(String groupDn, LDAPConfiguration conf) {
  ...
  @Extension public static class DescriptorImpl extends LDAPGroupMembershipStrategyDescriptor {
  ...
  private static class GroupMembersMapper implements LdapEntryMapper<Set<String>> {
    @Override public Set<String> mapAttributes(String dn, Attributes attributes) throws NamingException {
      NamingEnumeration<?> enumeration;
      boolean expectingUidInsteadOfDn = false;
      if (attributes.get("member") != null) {
        enumeration = attributes.get("member").getAll();
      } else {
        if (attributes.get("uniqueMember") != null) {
