...
public class KeyMap {
      ...
      for (int i = 0; i < keySeq.length(); i++) {
        ...
        if (i < keySeq.length() - 1) {
          ...
          if (map.mapping[c] instanceof KeyMap) {
            ...
            if (onlyIfNotBound == false || op == null || op == Operation.DO_LOWERCASE_VERSION || op == Operation.VI_MOVEMENT_MODE) {
            }
  ...
  public static final char CTRL_OB = (char) 27;

  public static final char CTRL_CB = (char) 29;
