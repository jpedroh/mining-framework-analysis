...
final class PropertiesInjectorImpl implements PropertiesInjector {
  ...
  @Override public void injectProperties(final Object object) throws PropertyInjectionException {
  ...
  private <A extends Annotation> void injectProperty(Field field, Object object, A annotation, AnnotationProcessor<A> annotationProcessor) throws PropertyInjectionException {
    try {
      ...
      throw new PropertyInjectionException(format("Unable to inject value from annotation \'%s\' in field \'%s\' of object \'%s\'", annotation, field.getName(), object), e);
    }
  }
