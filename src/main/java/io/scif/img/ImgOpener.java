...
public class ImgOpener extends AbstractImgIOComponent {
  ...
  @Parameter private PlaneConverterService pcService;

  @Parameter private InitializeService initializeService;
  ...
  /**
	 ...
	 * @throws ImgIOException if there is a problem reading the image data.
	 */
  public <T extends RealType<T> & NativeType<T>> List<SCIFIOImgPlus<T>> openImgs(final String source, final T type) throws ImgIOException {
  ...
  /**
	 ...
	 * @throws ImgIOException if there is a problem reading the image data.
	 */
  public List<SCIFIOImgPlus<?>> openImgs(final String source, SCIFIOConfig config) throws ImgIOException {
    if (config == null) {
  ...
  /**
	 ...
	 * @throws ImgIOException if there is a problem reading the image data.
	 */
  public <T extends RealType<T> & NativeType<T>> List<SCIFIOImgPlus<T>> openImgs(final String source, final T type, SCIFIOConfig config) throws ImgIOException {
    if (config == null) {
      config = new SCIFIOConfig().imgOpenerSetComputeMinMax(true);
    }
    final Reader r = createReader(source, config);
  ...
  /**
	 ...
	 * @throws ImgIOException if there is a problem reading the image data.
	 */
  public List<SCIFIOImgPlus<?>> openImgs(final Reader reader) throws ImgIOException {
  ...
  /**
	 ...
	 * @throws ImgIOException if there is a problem reading the image data.
	 */
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public List<SCIFIOImgPlus<?>> openImgs(final Reader reader, SCIFIOConfig config) throws ImgIOException {
    ...
    try {
      if (t instanceof NativeType) {
        imgFactory = heuristic.createFactory(reader.getMetadata(), config.imgOpenerGetImgModes(), (NativeType) t);
      } else {
        return null;
      }
  ...
  @SuppressWarnings(value = { "rawtypes" }) private RealType getType(final Reader r) {
  ...
  /**
	 ...
	 * @see #openImgs(String)
	 */
  @Deprecated public SCIFIOImgPlus<?> openImg(final String source) throws ImgIOException {
  ...
  /**
	 ...
	 */
  @Deprecated public <T extends RealType<T> & NativeType<T>> SCIFIOImgPlus<T> openImg(final String source, final T type) throws ImgIOException {
  ...
  /**
	 ...
	 */
  private Reader createReader(final String source, final SCIFIOConfig config) throws ImgIOException {
  ...
  /**
	 ...
	 */
  @Deprecated public SCIFIOImgPlus<?> openImg(final String source, final SCIFIOConfig config) throws ImgIOException {
  ...
  /**
	 ...
	 */
  @Deprecated public <T extends RealType<T> & NativeType<T>> SCIFIOImgPlus<T> openImg(final String source, final T type, final SCIFIOConfig config) throws ImgIOException {
  ...
  /**
	 ...
	 */
  @Deprecated public <T extends RealType<T> & NativeType<T>> SCIFIOImgPlus<T> openImg(final String source, final ImgFactory<T> imgFactory, final T type) throws ImgIOException {
  ...
  /**
	 ...
	 * @see #openImgs(Reader, SCIFIOConfig)
	 */
  @Deprecated public SCIFIOImgPlus<?> openImg(final Reader reader, final SCIFIOConfig config) throws ImgIOException {
  ...
  /**
	 ...
	 */
  private <T extends RealType<T>> SCIFIOImgPlus<T> makeImgPlus(final Img<T> img, final Reader r, final int imageIndex) {
    ...
    final int rgbChannelCount = base.getMetadata().get(0).isMultichannel() ? (int) base.getMetadata().get(0).getAxisLength(Axes.CHANNEL) : 1;
    final int validBits = meta.get(0).getBitsPerPixel();
    final SCIFIOImgPlus<T> imgPlus = new SCIFIOImgPlus<>(img, name, dimTypes, cal);
  ...
  /**
	 ...
	 * @see #openImgs(Reader, RealType, SCIFIOConfig)
	 */
  @Deprecated public <T extends RealType<T> & NativeType<T>> SCIFIOImgPlus<T> openImg(final Reader reader, final T type, final SCIFIOConfig config) throws ImgIOException {
  ...
  /**
	 ...
	 */
  private <T extends RealType<T>> void setCalibrationUnits(final SCIFIOImgPlus<T> imgPlus, final Metadata m, final int imageIndex) {
  ...
  /**
	 ...
	 */
  @Deprecated public <T extends RealType<T>> SCIFIOImgPlus<T> openImg(final Reader reader, final T type, final ImgFactory<T> imgFactory, final SCIFIOConfig config) throws ImgIOException {
  ...
  private <T extends RealType<T>> void readPlanes(final Reader r, final int imageIndex, final ImgPlus<T> imgPlus, final SCIFIOConfig config) throws FormatException, IOException {
    ...
    @SuppressWarnings(value = { "rawtypes" }) final RealType inputType = utils().makeType(r.getMetadata().get(0).getPixelType());
  ...
  @SuppressWarnings(value = { "rawtypes" }) private void read(final int imageIndex, final ImgPlus imgPlus, final Reader r, final SCIFIOConfig config, final PlaneConverter converter, final long[] planarMin, final long[] planarLength, final Range[] npRanges, final long[] npIndices) throws FormatException, IOException {
    read(imageIndex, imgPlus, r, config, converter, null, planarMin, planarLength, npRanges, npIndices, 0, new int[] { 0 });
  }

  @SuppressWarnings(value = { "unchecked", "rawtypes" }) private Plane read(final int imageIndex, final ImgPlus imgPlus, final Reader r, final SCIFIOConfig config, final PlaneConverter converter, Plane tmpPlane, final long[] planarMin, final long[] planarLength, final Range[] npRanges, final long[] npIndices, final int depth, final int[] planeCount) throws FormatException, IOException {
    if (depth < npRanges.length) {
      ...
      for (int i = 0; i < npRanges[npPosition].size(); i++) {
        ...
        tmpPlane = read(imageIndex, imgPlus, r, config, converter, tmpPlane, planarMin, planarLength, npRanges, npIndices, depth + 1, planeCount);
      }
    } else {
      final int planeIndex = (int) FormatTools.positionToRaster(0, r, npIndices);
      if (config.imgOpenerIsComputeMinMax()) {
        populateMinMax(r, imgPlus, imageIndex);
      }
      if (tmpPlane == null) {
        ...
        tmpPlane = r.openPlane(imageIndex, planeIndex, tmpPlane, planarMin, planarLength, config);
      }
  ...
  private void populateMinMax(final Reader r, final ImgPlus<?> imgPlus, final int imageIndex) {
    final int sizeC = (int) r.getMetadata().get(imageIndex).getAxisLength(Axes.CHANNEL);
    final ReaderFilter rf = (ReaderFilter) r;
  ...
  /**
	 ...
	 */
  @Deprecated public <T extends RealType<T> & NativeType<T>> List<SCIFIOImgPlus<T>> openImgs(final String source, final ImgFactory<T> imgFactory, final T type) throws ImgIOException {
  ...
  /**
	 ...
	 */
  @Deprecated public <T extends RealType<T>> List<SCIFIOImgPlus<T>> openImgs(Reader reader, final T type, final ImgFactory<T> imgFactory, final SCIFIOConfig config) throws ImgIOException {
  ...
  /**
	 ...
	 * @see #openImgs(String, ImgFactory)
	 */
  @Deprecated public <T extends RealType<T> & NativeType<T>> SCIFIOImgPlus<T> openImg(final String source, final ImgFactory<T> imgFactory) throws ImgIOException {
  ...
  /**
	 ...
	 */
  @Deprecated public <T extends RealType<T> & NativeType<T>> SCIFIOImgPlus<T> openImg(final String source, final ImgFactory<T> imgFactory, final SCIFIOConfig config) throws ImgIOException {
