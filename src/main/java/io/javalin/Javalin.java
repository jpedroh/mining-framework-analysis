...
public class Javalin {
  ...
  public Javalin start() {
    if (!started) {
      ...
      try {
        embeddedServer = embeddedServerFactory.create(new JavalinServlet(contextPath, pathMatcher, exceptionMapper, errorMapper, pathWsHandlers, logLevel, dynamicGzipEnabled, defaultContentType, defaultCharacterEncoding, maxRequestCacheBodySize), staticFileConfig);
