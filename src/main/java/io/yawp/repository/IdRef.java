...
public class IdRef<T extends java.lang.Object> implements Comparable<IdRef<T>> {
  ...
  public <TT extends java.lang.Object> TT fetch(Class<TT> childClazz) {
    return r.query(childClazz).fetch(this);
  }

  public <TT extends java.lang.Object> TT child(Class<TT> childClazz) {
  ...
  @SuppressWarnings(value = { "unchecked" }) public <TT extends java.lang.Object> IdRef<TT> getParentId() {
    return (IdRef<TT>) parentId;
  }

  @SuppressWarnings(value = { "unchecked" }) public <TT extends java.lang.Object> IdRef<TT> getAncestorId(int ancestor) {
  ...
  public <TT extends java.lang.Object> IdRef<TT> createChildId(Class<TT> clazz, Long id) {
    IdRef<TT> idRef = new IdRef<TT>(r, clazz, id);
    idRef.setParentId(this);
    return idRef;
  }

  public <TT extends java.lang.Object> IdRef<TT> createChildId(Class<TT> clazz, String name) {
    IdRef<TT> idRef = new IdRef<TT>(r, clazz, name);
    idRef.setParentId(this);
    return idRef;
  }

  public static <TT extends java.lang.Object> IdRef<TT> create(Repository r, Class<TT> clazz, Long id) {
    return new IdRef<TT>(r, clazz, id);
  }

  public static <TT extends java.lang.Object> IdRef<TT> create(Repository r, Class<TT> clazz, String name) {
    return new IdRef<TT>(r, clazz, name);
  }

  public static <TT extends java.lang.Object> List<IdRef<TT>> create(Repository r, Class<TT> clazz, Long... ids) {
  ...
  @SuppressWarnings(value = { "unchecked" }) public static <TT extends java.lang.Object> IdRef<TT> parse(Repository r, HttpVerb verb, String path) {
  ...
  public static <T extends java.lang.Object> IdRef<T> parse(Class<T> clazz, Repository r, String idString) {
    return parse(r, HttpVerb.GET, idString);
  }

  public static <T extends java.lang.Object> List<IdRef<T>> parse(Class<T> clazz, Repository r, List<String> idsString) {
  ...
  @Override public int compareTo(IdRef<T> o) {
