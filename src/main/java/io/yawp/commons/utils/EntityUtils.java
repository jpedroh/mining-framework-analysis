...
public class EntityUtils {
  ...
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> Class<T> getHookObject(Class<? extends Hook<T>> hook) {
    return (Class<T>) ReflectionUtils.getGenericParameter(hook);
  }

  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> Class<T> getShieldObject(Class<? extends Shield<T>> hook) {
    return (Class<T>) ReflectionUtils.getGenericParameter(hook);
  }
  ...
  public static <T extends java.lang.Object> T toObject(Repository r, Entity entity, Class<T> clazz) {
    try {
  ...
  public static <T extends java.lang.Object> void setKey(Repository r, T object, Key key) {
    try {
  ...
  public static <T extends java.lang.Object> String getActualFieldName(String fieldName, Class<T> clazz) {
  ...
  public static <T extends java.lang.Object> Object getActualFieldValue(String fieldName, Class<T> clazz, Object value) {
    Field field = ReflectionUtils.getFieldRecursively(clazz, fieldName);
  ...
  private static <T extends java.lang.Object> Object getActualListFieldValue(String fieldName, Class<T> clazz, Collection<?> value) {
  ...
  private static <T extends java.lang.Object> Key getActualKeyFieldValue(Class<T> clazz, Object value) {
  ...
  private static <T extends java.lang.Object> void setObjectProperty(Repository r, T object, Entity entity, Field field) throws IllegalAccessException {
  ...
  private static <T extends java.lang.Object> void setIdRefProperty(Repository r, T object, Field field, Object value) throws IllegalAccessException {
    field.set(object, IdRef.parse(r, HttpVerb.GET, (String) value));
  }

  private static <T extends java.lang.Object> void setIntProperty(T object, Field field, Object value) throws IllegalAccessException {
    field.set(object, ((Long) value).intValue());
  }

  private static <T extends java.lang.Object> void setTextProperty(T object, Field field, Object value) throws IllegalAccessException {
    field.set(object, ((Text) value).getValue());
  }

  private static <T extends java.lang.Object> void setJsonProperty(Repository r, T object, Field field, Object value) throws IllegalAccessException {
    String json = ((Text) value).getValue();
    field.set(object, JsonUtils.from(r, json, field.getGenericType()));
  }

  @SuppressWarnings(value = { "unchecked", "rawtypes" }) private static <T extends java.lang.Object> void setEnumProperty(T object, Field field, Object value) throws IllegalAccessException {
  ...
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public static Class<?> getActionEndpoint(Method action) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private static <T extends java.lang.Object, V extends Action<T>> Class<T> getActionEndpoint(Class<V> clazz) {
