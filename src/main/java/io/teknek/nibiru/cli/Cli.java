  ...
  public static void main(String[] args) throws IOException {
    ...
    while ((line = br.readLine()) != null) {
      ...
      if ("connect".equalsIgnoreCase(parts[0])) {
        ...
        client = new ColumnFamilyClient(new Client(parts[1], Integer.parseInt(parts[2]), 10000, 10000));
      } else {
        if ("showcluster".equalsIgnoreCase(parts[0])) {
          try {
          ...
          if ("use".equalsIgnoreCase(parts[0])) {
            ...
            if ("set".equalsIgnoreCase(parts[0])) {
              ...
              if ("get".equalsIgnoreCase(parts[0])) {
                ...
                if ("createkeyspace".equalsIgnoreCase(parts[0])) {
                  try {
                  ...
                  if ("createcolumnfamily".equalsIgnoreCase(parts[0])) {
                    try {
                    ...
                    if ("showkeyspaces".equalsIgnoreCase(parts[0])) {
                      try {
                      ...
                      if ("describekeyspace".equalsIgnoreCase(parts[0])) {
                        try {
