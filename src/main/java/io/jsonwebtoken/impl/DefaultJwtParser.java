...
@SuppressWarnings(value = { "unchecked" }) public class DefaultJwtParser implements JwtParser {
  ...
  @Override public JwtParser setAllowedClockSkewInSeconds(int seconds) {
    ...
    if (claims != null) {
      ...
      if (exp != null) {
        ...
        if (nowWithAllowedClockSkew.equals(exp) || nowWithAllowedClockSkew.after(exp)) {
          ...
          String msg = "JWT expired at " + expVal + ". Current time: " + nowVal + ". Allowed clock skew: " + allowedClockSkewInSeconds + " second(s).";
      ...
      if (nbf != null) {
        ...
        if (nowWithAllowedClockSkew.before(nbf)) {
          ...
          String nowVal = sdf.format(now);
          String msg = "JWT must not be accepted before " + nbfVal + ". Current time: " + nowVal + ". Allowed clock skew: " + allowedClockSkewInSeconds + " second(s).";
