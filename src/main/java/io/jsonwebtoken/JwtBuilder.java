...
public interface JwtBuilder extends ClaimsMutator<JwtBuilder> {
  ...
  /**
     ...
     * @since 0.2
     */
  @Override JwtBuilder setIssuer(String iss);
  ...
  /**
     ...
     * @since 0.2
     */
  @Override JwtBuilder setSubject(String sub);
  ...
  /**
     ...
     * @since 0.2
     */
  @Override JwtBuilder setAudience(String aud);
  ...
  /**
     ...
     * @since 0.2
     */
  @Override JwtBuilder setExpiration(Date exp);
  ...
  /**
     ...
     * @since 0.2
     */
  @Override JwtBuilder setNotBefore(Date nbf);
  ...
  /**
     ...
     * @since 0.2
     */
  @Override JwtBuilder setIssuedAt(Date iat);
  ...
  /**
     ...
     * @since 0.2
     */
  @Override JwtBuilder setId(String jti);
