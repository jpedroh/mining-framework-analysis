...
public class Repository {
  @SuppressWarnings(value = { "unused" }) private static Logger logger = Logger.getLogger(Repository.class.getSimpleName());
  ...
  public <T extends java.lang.Object> DatastoreQuery<T> queryWithHooks(Class<T> clazz) throws HttpException {
    DatastoreQuery<T> q = DatastoreQuery.q(clazz, this);
    RepositoryHooks.beforeQuery(this, q, clazz);
    return q;
  }

  public <T extends java.lang.Object> DatastoreQuery<T> query(Class<T> clazz) {
