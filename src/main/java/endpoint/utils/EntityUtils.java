...
public class EntityUtils {
  ...
  @SuppressWarnings(value = { "unchecked" }) public static Class<? extends DatastoreObject> getListClass(Field field) {
  ...
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) private static <T extends DatastoreObject> void setEnumProperty(T object, Field field, Object value) throws IllegalAccessException {
    if (value == null) {
      return;
    }
