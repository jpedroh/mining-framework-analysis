...
public class EntityUtils {
  ...
  public static <T extends java.lang.Object> Field[] getFields(Class<T> clazz) {
...
=======
  public static <T extends java.lang.Object> Object getIndexFieldValue(String fieldName, Class<T> clazz, Object value) {
    Field field = getFieldFromAnyParent(clazz, fieldName);
    if (isKey(field)) {
      if (value instanceof Key) {
        return value;
...
>>>>>>> /usr/src/app/output/feroult/yawp/8518960a9a916ec76f31751c722d21c61edf422f/src/main/java/endpoint/utils/EntityUtils.java/right.java
