...
public class CommandLineApp {
  ...
  public static Options buildOptions() {
    ...
    o.addOption(Option.builder("x").longOpt("regex").desc("Find areas to extract using regex. Example: --regex regexbefore,incl/excl,regexafter,incl/excl").hasArg().argName("REGEX").build());
