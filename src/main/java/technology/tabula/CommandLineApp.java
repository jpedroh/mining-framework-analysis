...
public class CommandLineApp {
  ...
  private static ExtractionMethod whichExtractionMethod(CommandLine line) {
    ...
    if (line.hasOption('c') || line.hasOption('g') || line.hasOption('t')) {
  ...
  public static Options buildOptions() {
    ...
    o.addOption(Option.builder("a").longOpt("area").desc("Portion of the page to analyze (top,left,bottom,right). Example: --area 269.875,12.75,790.5,561. Default is entire page").hasArg().argName("AREA").build());
    o.addOption(Option.builder("p").longOpt("pages").desc("Comma separated list of ranges, or all. Examples: --pages 1-3,5-7, --pages 3 or --pages all. Default is --pages 1").hasArg().argName("PAGES").build());
    o.addOption(Option.builder("r").longOpt("regex").desc("Find areas to extract using regex. Example: --regex regexbefore,incl/excl,regexafter,incl/excl").hasArg().argName("REGEX").build());
    o.addOption(Option.builder("m").longOpt("margins").desc("Define the header and footer margins for the document").hasArg().argName("MARGINS").build());
    return o;
  }
