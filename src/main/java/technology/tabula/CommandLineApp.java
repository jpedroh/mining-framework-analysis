...
public class CommandLineApp {
  ...
  public static Options buildOptions() {
    ...
    o.addOption(Option.builder("c").longOpt("columns").desc("X coordinates of column boundaries. Example --columns 10.1,20.2,30.3. " + "If all values are between 0-100 (inclusive) and preceded by \'%\', input will be taken as % of actual width of the page. " + "Example: --columns %25,50,80.6").hasArg().argName("COLUMNS").build());
