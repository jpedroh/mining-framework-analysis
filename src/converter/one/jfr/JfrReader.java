...
public class JfrReader implements Closeable {
  ...
  private final 
<<<<<<< /usr/src/app/output/jvm-profiling-tools/async-profiler/f3857d8dcf97af86770d36267c7ce7d02bc6eae7/src/converter/one/jfr/JfrReader.java/left.java
  int
=======
  boolean
>>>>>>> /usr/src/app/output/jvm-profiling-tools/async-profiler/f3857d8dcf97af86770d36267c7ce7d02bc6eae7/src/converter/one/jfr/JfrReader.java/right.java
...
>>>>>>> /usr/src/app/output/jvm-profiling-tools/async-profiler/f3857d8dcf97af86770d36267c7ce7d02bc6eae7/src/converter/one/jfr/JfrReader.java/right.java
     = 
<<<<<<< /usr/src/app/output/jvm-profiling-tools/async-profiler/f3857d8dcf97af86770d36267c7ce7d02bc6eae7/src/converter/one/jfr/JfrReader.java/left.java
    getTypeId("profiler.Malloc")
=======
    hasField("jdk.JavaMonitorEnter", "previousOwner")
>>>>>>> /usr/src/app/output/jvm-profiling-tools/async-profiler/f3857d8dcf97af86770d36267c7ce7d02bc6eae7/src/converter/one/jfr/JfrReader.java/right.java
    ;
    this.
<<<<<<< /usr/src/app/output/jvm-profiling-tools/async-profiler/f3857d8dcf97af86770d36267c7ce7d02bc6eae7/src/converter/one/jfr/JfrReader.java/left.java
...
>>>>>>> /usr/src/app/output/jvm-profiling-tools/async-profiler/f3857d8dcf97af86770d36267c7ce7d02bc6eae7/src/converter/one/jfr/JfrReader.java/right.java
     = 
<<<<<<< /usr/src/app/output/jvm-profiling-tools/async-profiler/f3857d8dcf97af86770d36267c7ce7d02bc6eae7/src/converter/one/jfr/JfrReader.java/left.java
    getTypeId("profiler.Free")
=======
    hasField("jdk.ThreadPark", "until")
>>>>>>> /usr/src/app/output/jvm-profiling-tools/async-profiler/f3857d8dcf97af86770d36267c7ce7d02bc6eae7/src/converter/one/jfr/JfrReader.java/right.java
    ;
  ...
  @SuppressWarnings(value = { "unchecked" }) public <E extends Event> E readEvent(Class<E> cls) throws IOException {
    while (ensureBytes(CHUNK_HEADER_SIZE)) {
      ...
      if (type == executionSample || type == nativeMethodSample) {
        ...
        if (type == allocationInNewTLAB) {
          if (cls == null || cls == AllocationSample.class) {
            return (E) readAllocationSample(true);
          }
        } else {
          if (type == allocationOutsideTLAB) {
            if (cls == null || cls == AllocationSample.class) {
              return (E) readAllocationSample(false);
            }
          } else {
            if (type == monitorEnter) {
              if (cls == null || cls == ContendedLock.class) {
                return (E) readContendedLock(false, hasPreviousOwner);
              }
            } else {
              if (type == threadPark) {
                if (cls == null || cls == ContendedLock.class) {
                  return (E) readContendedLock(true, hasParkUntil);
                }
              } else {
                if (type == malloc) {
                  if (cls == null || cls == MallocEvent.class) {
                    return (E) readMallocEvent(true);
                  }
                } else {
                  if (type == free) {
                    if (cls == null || cls == MallocEvent.class) {
                      return (E) readMallocEvent(false);
                    }
                  }
                }
              }
