...
public class jfr2flame {
  ...
  public void convert(final FlameGraph fg, final boolean threads, final boolean total, final boolean lines, final boolean bci, final Class<? extends Event> eventClass) throws IOException {
    ...
    agg.forEach(new EventAggregator.Visitor() {
      @Override public void visit(Event event, long value) {
        ...
        if (stackTrace != null) {
          ...
          for (int i = 0; i < methods.length; i++) {
            ...
            if (lines && (location = locations[i] >>> 16) != 0) {
              ...
              if (bci && (location = locations[i] & 0xffff) != 0) {
                methodName += "@" + location;
              }
            }
          ...
          fg.addSample(trace, 
<<<<<<< /usr/src/app/output/jvm-profiling-tools/async-profiler/aebeed5d99ee31497e59c84bfc3d312487391c19/src/converter/jfr2flame.java/left.java
          isOnCPU
=======
          scale ? (long) (value * ticksToNanos) : value
>>>>>>> /usr/src/app/output/jvm-profiling-tools/async-profiler/aebeed5d99ee31497e59c84bfc3d312487391c19/src/converter/jfr2flame.java/right.java
          );
        }
      }
    });
