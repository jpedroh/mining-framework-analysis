...
<<<<<<< /usr/src/app/output/zextras/openzal/6fc129fd6cd4bba8445378f721719f6f5a977772/src/java/org/openzal/zal/ProvisioningImp.java/left.java
...
>>>>>>> /usr/src/app/output/zextras/openzal/6fc129fd6cd4bba8445378f721719f6f5a977772/src/java/org/openzal/zal/ProvisioningImp.java/right.java


  @Nonnull public final com.zimbra.cs.account.Provisioning mProvisioning;
  ...
  @Nonnull private final NamedEntryWrapper<Account> mNamedEntryAccountWrapper;

  @Nonnull private final NamedEntryWrapper<Domain> mNamedEntryDomainWrapper;

  private final static String[] mAccountAttrs = { com.zimbra.cs.account.Provisioning.A_c, com.zimbra.cs.account.Provisioning.A_cn, com.zimbra.cs.account.Provisioning.A_co };
  ...
  public ProvisioningImp(Object provisioning) {
    ...
    mNamedEntryAccountWrapper = new NamedEntryWrapper<Account>() {
      @Nonnull @Override public Account wrap(NamedEntry entry) {
        return new Account((com.zimbra.cs.account.Account) entry);
      }
    };
    mNamedEntryDomainWrapper = new NamedEntryWrapper<Domain>() {
      @Nonnull @Override public Domain wrap(NamedEntry entry) {
        return new Domain((com.zimbra.cs.account.Domain) entry);
      }
    };
  }

  @Override public boolean isValidUid(@Nonnull String uid) {
    return uid.length() == 36 && (uid.charAt(8) == '-' && uid.charAt(13) == '-' && uid.charAt(18) == '-' && uid.charAt(23) == '-');
  }

  @Override @Nonnull public Account getZimbraUser() throws ZimbraException {
    return assertAccountById(ZIMBRA_USER_ID);
  }

  @Override public OperationContext createZContext() {
    return new OperationContext(new com.zimbra.cs.mailbox.OperationContext(getZimbraUser().toZimbra(com.zimbra.cs.account.Account.class), true));
  }

  @Override @Nullable public DistributionList getDistributionListById(String id) throws ZimbraException {
    try {
  ...
  @Override @Nullable public DistributionList getDistributionListByName(String name) throws ZimbraException {
    try {
  ...
  @Override public void visitAllAccounts(@Nonnull SimpleVisitor<Account> visitor) throws ZimbraException {
  ...
  @Override public void visitAllLocalAccountsNoDefaults(@Nonnull SimpleVisitor<Account> visitor) throws ZimbraException {
    NamedEntry.Visitor namedEntryVisitor = new ZimbraVisitorWrapper<Account>(visitor, mNamedEntryAccountWrapper);
    try {
  ...
  @Override public void visitAllLocalAccounts(@Nonnull SimpleVisitor<Account> visitor) throws ZimbraException {
    NamedEntry.Visitor namedEntryVisitor = new ZimbraVisitorWrapper<Account>(visitor, mNamedEntryAccountWrapper);
    try {
      com.zimbra.cs.account.Server server = mProvisioning.getLocalServer();
      com.zimbra.cs.account.SearchAccountsOptions searchOptions = new com.zimbra.cs.account.SearchAccountsOptions();
  ...
  @Override public void visitAllAccounts(@Nonnull SimpleVisitor<Account> visitor, @Nonnull Filter<Account> filterAccounts) throws ZimbraException {
    ProvisioningVisitor<Account> accountProvisioningVisitor = new ProvisioningVisitor<Account>(visitor, filterAccounts);
    visitAllAccounts(accountProvisioningVisitor);
  }

  @Override public void visitAllLocalAccountsSlow(@Nonnull SimpleVisitor<Account> visitor, @Nonnull Filter<Account> filterAccounts) throws ZimbraException {
    final List<Account> allAccounts = new ArrayList<Account>();
    SimpleVisitor<Account> accountListBuilder = new SimpleVisitor<Account>() {
      @Override public void visit(Account entry) {
        allAccounts.add(entry);
      }
    };
    ProvisioningVisitor<Account> accountListBuilderVisitor = new ProvisioningVisitor<Account>(accountListBuilder, filterAccounts);
  ...
  @Override public void visitAccountByIdNoDefaults(SimpleVisitor<Account> visitor, ZimbraId accountId) {
    try {
      ...
      searchOptions.setTypes(SearchDirectoryOptions.ObjectType.accounts, SearchDirectoryOptions.ObjectType.resources);
  ...
  @Override public void visitAllDomains(@Nonnull SimpleVisitor<Domain> visitor) throws ZimbraException {
  ...
  @Override public void visitDomain(@Nonnull SimpleVisitor<Account> visitor, @Nonnull Domain domain) throws ZimbraException {
    NamedEntry.Visitor namedEntryVisitor = new ZimbraVisitorWrapper<Account>(visitor, mNamedEntryAccountWrapper);
    try {
      mProvisioning.getAllAccounts(domain.toZimbra(com.zimbra.cs.account.Domain.class), namedEntryVisitor);
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  public void visitDomainsWithAttributes(@Nonnull SimpleVisitor<Domain> visitor, Map<String, Object> attributes) throws ZimbraException {
    ...
    try {
      for (String id : attributes.keySet()) {
        filter = zLdapFilterFactory.fromFilterString(ZLdapFilterFactory.FilterId.ALL_DOMAINS, zLdapFilterFactory.equalityFilter(id, attributes.get(id).toString(), true));
        if (lastFilter != null) {
  ...
  @Override public Collection<String> getGroupMembers(String list) throws UnableToFindDistributionListException {
    try {
      com.zimbra.cs.account.Group distributionList = mProvisioning.getGroup(ProvisioningKey.ByDistributionList.name.toZimbra(), list);
      if (distributionList == null) {
  ...
  @Override public void authAccount(@Nonnull Account account, String password, @Nonnull Protocol protocol, Map<String, Object> context) throws ZimbraException {
    try {
      mProvisioning.authAccount(account.toZimbra(com.zimbra.cs.account.Account.class), password, protocol.toZimbra(), context);
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override public void authAccountWithLdap(@Nonnull Account account, String password, Map<String, Object> context) throws ZimbraException {
    try {
      if (LdapProvisioning.class.isAssignableFrom(mProvisioning.getClass())) {
        ((LdapProvisioning) mProvisioning).zimbraLdapAuthenticate(account.toZimbra(com.zimbra.cs.account.Account.class), password, context);
      } else {
        mProvisioning.authAccount(account.toZimbra(com.zimbra.cs.account.Account.class), password, context.get("proto") instanceof AuthContext.Protocol ? (AuthContext.Protocol) context.get("proto") : AuthContext.Protocol.valueOf(context.get("proto").toString()));
      }
  ...
  public void authAccountSkippingCustom(@Nonnull Account account, String password, @Nonnull Map<String, Object> context, @Nullable String customName) throws ZimbraException {
    try {
      ...
      if (LdapProvisioning.class.isAssignableFrom(mProvisioning.getClass())) {
        ...
        if (Objects.nonNull(customName) && authMechanism.getMechanism() == AuthMechanism.AuthMech.custom) {
          customName = customName.startsWith(AuthMechanism.AuthMech.custom.name() + ":") ? customName : String.format("%s:%s", AuthMechanism.AuthMech.custom.name(), customName);
  ...
  private void doAuth(AuthMechanism mechanism, Account account, String password, Map<String, Object> context) throws ServiceException {
    mechanism.doAuth((LdapProvisioning) mProvisioning, requiredDomain(account).toZimbra(com.zimbra.cs.account.Domain.class), account.toZimbra(com.zimbra.cs.account.Account.class), password, context);
  }

  @Override public Account getAccountByAccountIdOrItemId(String id) {
  ...
  @Override @Nullable public Account getAccountById(String accountId) throws ZimbraException {
    try {
  ...
  @Override @Nonnull public Server getLocalServer() throws ZimbraException {
    try {
      com.zimbra.cs.account.Server server = mProvisioning.getLocalServer();
      if (server == null) {
  ...
  @Override @Nullable public Domain getDomainByName(String domainName) throws ZimbraException {
    try {
  ...
  @Override @Nullable public Domain getDomainById(String domainId) throws ZimbraException {
    try {
  ...
  @Nonnull @Override public Domain assertDomainById(String domainId) {
  ...
  @Nonnull @Override public Domain assertDomainByName(String domainName) {
  ...
  @Override public Zimlet assertZimlet(String zimletName) {
  ...
  @Override public List<Domain> getAllDomains() throws ZimbraException {
    try {
  ...
  @Nullable @Override public Domain getDomainByVirtualHostname(String host) throws ZimbraException {
    try {
  ...
  @Override @Nonnull public Zimlet getZimlet(String zimletName) throws ZimbraException {
    try {
  ...
  @Override public void modifyAttrs(@Nonnull Entry entry, Map<String, Object> attrs) throws ZimbraException {
    try {
  ...
  @Override public List<DistributionList> getAllDistributionLists(@Nonnull Domain domain) throws ZimbraException {
    try {
      return ZimbraListWrapper.wrapDistributionLists(mProvisioning.getAllDistributionLists(domain.toZimbra(com.zimbra.cs.account.Domain.class)));
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override public List<Group> getAllGroups(Domain domain) throws ZimbraException {
    try {
      return ZimbraListWrapper.wrapGroups(mProvisioning.getAllGroups(domain.toZimbra(com.zimbra.cs.account.Domain.class)));
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override @Nullable public Cos getCosById(String cosId) throws ZimbraException {
    try {
  ...
  @Override public List<Cos> getAllCos() throws ZimbraException {
    try {
  ...
  @Override @Nullable public Cos getCosByName(String cosStr) throws ZimbraException {
    try {
  ...
  @Override @Nullable public DistributionList get(@Nonnull ProvisioningKey.ByDistributionList id, String dlStr) throws ZimbraException {
    try {
  ...
  @Override @Nullable public Account get(@Nonnull ProvisioningKey.ByAccount by, String target) throws ZimbraException {
    try {
  ...
  @Override @Nonnull public Account assertAccountByName(String accountStr) throws NoSuchAccountException {
  ...
  @Override @Nonnull public Account assertAccountById(String accountStr) throws NoSuchAccountException {
  ...
  @Override @Nullable public Account getAccountByName(String accountStr) throws NoSuchAccountException {
    try {
  ...
  @Override public List<Account> getAllAdminAccounts() throws ZimbraException {
    try {
  ...
  @Override public Locale getLocale(Entry entry) throws ZimbraException {
    try {
  ...
  @Override public List<Account> getAllAccounts(@Nonnull Domain domain) throws ZimbraException {
    try {
      return ZimbraListWrapper.wrapAccounts(mProvisioning.getAllAccounts(domain.toZimbra(com.zimbra.cs.account.Domain.class)));
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }
  ...
  @Override public List<Server> getAllServers() throws ZimbraException {
    try {
      List<com.zimbra.cs.account.Server> allServers = mProvisioning.getAllServers().stream().filter(ProvisioningImp::isReachable).collect(Collectors.toList());
  ...
  @Override public List<Server> getAllServers(String service) throws ZimbraException {
    try {
      List<com.zimbra.cs.account.Server> allServers = mProvisioning.getAllServers(service).stream().filter(ProvisioningImp::isReachable).collect(Collectors.toList());
      return ZimbraListWrapper.wrapServers(allServers);
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  ...
  @Override public List<CalendarResource> getAllCalendarResources(@Nonnull Domain domain) throws ZimbraException {
    try {
      return ZimbraListWrapper.wrapCalendarResources(mProvisioning.getAllCalendarResources(domain.toZimbra(com.zimbra.cs.account.Domain.class)));
    } catch (ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override public List<Zimlet> listAllZimlets() throws ZimbraException {
    try {
  ...
  @Override public List<XMPPComponent> getAllXMPPComponents() throws ZimbraException {
    try {
  ...
  @Override @Nullable public GlobalGrant getGlobalGrant() throws ZimbraException {
    try {
  ...
  @Override @Nonnull public Config getConfig() throws ZimbraException {
    try {
  ...
  @Override public List<UCService> getAllUCServices() throws ZimbraException {
    try {
  ...
  @Override @Nullable public CalendarResource getCalendarResourceByName(String resourceName) throws ZimbraException {
    try {
  ...
  @Override @Nullable public CalendarResource getCalendarResourceById(String resourceId) throws ZimbraException {
    try {
  ...
  @Override @Nullable public Domain createDomain(String currentDomainName, Map<String, Object> stringObjectMap) throws ZimbraException {
    try {
      com.zimbra.cs.account.Domain domain = mProvisioning.createDomain(currentDomainName, stringObjectMap);
      if (domain == null) {
        return null;
      } else {
        return new Domain(domain);
  ...
  @Override @Nullable public Cos createCos(String cosname, Map<String, Object> stringObjectMap) throws ZimbraException {
    try {
      com.zimbra.cs.account.Cos cos = mProvisioning.createCos(cosname, stringObjectMap);
      if (cos == null) {
        return null;
      } else {
        return new Cos(cos);
  ...
  @Override @Nullable public DistributionList createDistributionList(String dlistName) throws ZimbraException {
    return createDistributionList(dlistName, new HashMap<String, Object>());
  }

  @Override @Nullable public DistributionList createDistributionList(String dlistName, Map<String, Object> stringObjectMap) throws ZimbraException {
    try {
      com.zimbra.cs.account.DistributionList distributionList = mProvisioning.createDistributionList(dlistName, stringObjectMap);
      if (distributionList == null) {
        return null;
      } else {
        return new DistributionList(distributionList);
  ...
  @Override @Nullable public Group createDynamicGroup(String groupName) throws ZimbraException {
    return createDynamicGroup(groupName, Collections.<String, Object>emptyMap());
  }

  @Override @Nullable public Group createDynamicGroup(String groupName, Map<String, Object> stringObjectMap) throws ZimbraException {
    try {
      com.zimbra.cs.account.Group group = mProvisioning.createDynamicGroup(groupName, stringObjectMap);
      if (group == null) {
        return null;
      } else {
  ...
  @Override @Nullable public Account createCalendarResource(String dstAccount, String newPassword, Map<String, Object> attrs) throws ZimbraException {
    try {
  ...
  @Override @Nullable public Account createAccount(String dstAccount, String newPassword, Map<String, Object> attrs) throws ZimbraException {
    try {
  ...
  @Override public Account createGalAccount(String dstAccount, String newPassword, Map<String, Object> attrs) throws ZimbraException {
    ...
    try {
      ...
      try {
        contactFolder = zimbraMBox.getFolderByPath(null, folder);
      } catch (MailServiceException.NoSuchItemException e) {
        contactFolder = zimbraMBox.createFolder(null, folder, new Folder.FolderOptions().setDefaultView(MailItem.Type.CONTACT));
      }
      ...
      zimbraMBox.grantAccess(null, folderId, domain.getId(), ACL.GRANTEE_DOMAIN, ACL.stringToRights("r"), null);
      ...
      mProvisioning.createDataSource(account.toZimbra(com.zimbra.cs.account.Account.class), com.zimbra.soap.admin.type.DataSourceType.gal, "zimbra", dataSourceAttrs);
    } catch (ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
    return account;
  ...
  @Override public Account createFakeAccount(Map<String, Object> attrs) throws ZimbraException {
    return new Account("dummy_account", "", attrs, new HashMap(), this);
  }

  @Override public void restoreAccount(String emailAddress, Map<String, Object> attrs) {
    ...
    try {
      ...
      dn = provisioning.getDIT().accountDNCreate(null, entry.getAttributes(), localPart, domain);
      entry.setDN(dn);
  ...
  @Override public DataSource restoreDataSource(Account account, DataSourceType dsType, String dsName, Map<String, Object> dataSourceAttrs) {
    try {
      return new DataSource(mProvisioning.restoreDataSource(account.toZimbra(com.zimbra.cs.account.Account.class), com.zimbra.soap.admin.type.DataSourceType.fromString(dsType.name()), dsName, dataSourceAttrs));
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override public Identity restoreIdentity(Account account, String identityName, Map<String, Object> identityAttrs) {
    try {
      return new Identity(mProvisioning.restoreIdentity(account.toZimbra(com.zimbra.cs.account.Account.class), identityName, identityAttrs));
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override public Signature restoreSignature(Account account, String signatureName, Map<String, Object> signatureAttrs) {
    try {
      return new Signature(mProvisioning.restoreSignature(account.toZimbra(com.zimbra.cs.account.Account.class), signatureName, signatureAttrs));
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override public void restoreCos(Map<String, Object> attributes) {
    ZLdapContext zlc = null;
    ZMutableEntry entry = null;
    String dn = null;
    try {
  ...
  static {
    try {
      sCreateParentDomains = com.zimbra.cs.account.ldap.LdapProvisioning.class.getDeclaredMethod("createParentDomains", ZLdapContext.class, String[].class, String[].class);
  ...
  @Override public void restoreDomain(Map<String, Object> attributes) {
    ZLdapContext zlc = null;
    String dn = null;
    ZMutableEntry entry = null;
    try {
      ...
      for (String part : parts) {
        stringBuffer.append("dc=").append(LdapUtil.escapeRDNValue(part)).append(",");
      }
  ...
  @Override public void restoreDistributionList(String address, Map<String, Object> attributes) {
    ZLdapContext zlc = null;
    ZMutableEntry entry = null;
    String dn = null;
    try {
  ...
  @Override @Nullable public Server createServer(String name, Map<String, Object> attrs) throws ZimbraException {
    try {
  ...
  @Override public void modifyIdentity(@Nonnull Account newAccount, String identityName, Map<String, Object> newAttrs) throws ZimbraException {
    try {
      mProvisioning.modifyIdentity(newAccount.toZimbra(com.zimbra.cs.account.Account.class), identityName, newAttrs);
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override public void grantRight(String targetType, @Nonnull Targetby targetBy, String target, String granteeType, @Nonnull GrantedBy granteeBy, String grantee, String right) throws ZimbraException {
    grantRight(targetType, targetBy, target, granteeType, granteeBy, grantee, right, null);
  }

  @Override public void grantRight(String targetType, @Nonnull Targetby targetBy, String target, String granteeType, @Nonnull GrantedBy granteeBy, String grantee, String right, RightModifier rightModifier) throws ZimbraException {
    try {
      mProvisioning.grantRight(targetType, targetBy.toZimbra(TargetBy.class), target, granteeType, granteeBy.toZimbra(GranteeBy.class), grantee, null, right, (rightModifier == null) ? null : rightModifier.toZimbra());
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override public void revokeRight(String targetType, Targetby targetBy, String target, String granteeType, @Nonnull GrantedBy granteeBy, String grantee, String right) throws NoSuchGrantException {
    try {
      mProvisioning.revokeRight(targetType, targetBy.toZimbra(com.zimbra.soap.type.TargetBy.class), target, granteeType, granteeBy.toZimbra(GranteeBy.class), grantee, right, null);
    } catch (ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override public void revokeRight(String targetType, Targetby targetBy, String target, String granteeType, @Nonnull GrantedBy granteeBy, String grantee, String right, RightModifier rightModifier) throws NoSuchGrantException {
    try {
      mProvisioning.revokeRight(targetType, targetBy != null ? targetBy.toZimbra(TargetBy.class) : null, target != null ? target : null, granteeType, granteeBy.toZimbra(GranteeBy.class), grantee, right, rightModifier != null ? rightModifier.toZimbra() : null);
    } catch (ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override public boolean checkRight(String targetType, Targetby targetBy, String target, GrantedBy granteeBy, String granteeVal, String right) {
    try {
      return mProvisioning.checkRight(targetType, targetBy.toZimbra(TargetBy.class), target, granteeBy.toZimbra(GranteeBy.class), granteeVal, right, null, null);
    } catch (ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override @Nullable public Grants getGrants(String targetType, Targetby targetBy, String target, String granteeType, GrantedBy granteeBy, String grantee, boolean granteeIncludeGroupsGranteeBelongs) {
    try {
      ...
      RightCommand.Grants grants = mProvisioning.getGrants(targetType, targetBy1, target, granteeType, granteeBy1, grantee, granteeIncludeGroupsGranteeBelongs);
      if (grants == null) {
        return null;
      } else {
  ...
  @Override public <T extends java.lang.Object> T toZimbra(@Nonnull Class<T> cls) {
    return cls.cast(mProvisioning);
  }

  @Override @Nullable public Domain getDomain(@Nonnull Account account) throws ZimbraException {
    try {
  ...
  @Override public void flushCache(@Nonnull CacheEntryType cacheEntryType, @Nullable Collection<CacheEntry> cacheEntries) throws ZimbraException {
  ...
  @Override public CountAccountResult countAccount(@Nonnull Domain domain) throws ZimbraException {
    try {
      return new CountAccountResult(mProvisioning.countAccount(domain.toZimbra(com.zimbra.cs.account.Domain.class)));
    } catch (com.zimbra.common.service.ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }

  @Override public long getAccountsOnCos(@Nonnull Domain domain, @Nonnull Cos cos) {
  ...
  @Override public long getMaxAccountsOnCos(@Nonnull Domain domain, @Nonnull Cos cos) {
  ...
  @Override @Nullable public Server getServer(@Nonnull Account acct) throws ZimbraException {
    try {
  ...
  @Nullable @Override public Server getServerById(String id) throws ZimbraException {
    try {
  ...
  @Nullable @Override public Server getServerByName(String name) throws ZimbraException {
    try {
  ...
  @Override public boolean onLocalServer(@Nonnull Account userAccount) throws ZimbraException {
    try {
  ...
  @Override @Nullable public Zimlet createZimlet(String name, Map<String, Object> attrs) throws org.openzal.zal.exceptions.ZimbraException {
    try {
  ...
  @Override public long getEffectiveQuota(@Nonnull Account account) {
  ...
  @Override public List<Account> getAllDelegatedAdminAccounts() throws ZimbraException {
    List<NamedEntry> entryList;
    SearchDirectoryOptions opts = new SearchDirectoryOptions();
    ZLdapFilterFactory zLdapFilterFactory = ZLdapFilterFactory.getInstance();
    try {
      ZLdapFilter filter = ZLdapFilterFactory.getInstance().fromFilterString(ZLdapFilterFactory.FilterId.ALL_ACCOUNTS_ONLY, zLdapFilterFactory.equalityFilter(A_zimbraIsDelegatedAdminAccount, "TRUE", true));
  ...
  public void visitAllDelegatedAdminAccounts(SimpleVisitor<Account> visitor) throws ZimbraException {
    ...
    ZLdapFilterFactory zLdapFilterFactory = ZLdapFilterFactory.getInstance();
    try {
      ZLdapFilter filter = zLdapFilterFactory.andWith(ZLdapFilterFactory.getInstance().fromFilterString(ZLdapFilterFactory.FilterId.ALL_ACCOUNTS_ONLY, zLdapFilterFactory.equalityFilter(A_zimbraIsDelegatedAdminAccount, "TRUE", true)), ZLdapFilterFactory.getInstance().fromFilterString(ZLdapFilterFactory.FilterId.ALL_ACCOUNTS_ONLY, zLdapFilterFactory.equalityFilter(A_zimbraAccountStatus, "active", true)));
      opts.setFilter(filter);
      opts.setTypes(SearchDirectoryOptions.ObjectType.accounts);
  ...
  @Override @Nullable public Group getGroupById(String dlStr) throws ZimbraException {
    try {
  ...
  @Override @Nullable public Group getGroupByName(String dlStr) throws NoSuchGroupException {
    try {
  ...
  @Override public void removeGranteeId(String target, String grantee_id, String granteeType, String right) throws ZimbraException {
    try {
      com.zimbra.cs.account.Entry targetEntry = null;
      try {
        targetEntry = com.zimbra.cs.account.accesscontrol.TargetType.lookupTarget(mProvisioning, TargetType.account, com.zimbra.soap.type.TargetBy.name, target);
      } catch (Exception ignore) {
      }
      if (targetEntry == null) {
        targetEntry = com.zimbra.cs.account.accesscontrol.TargetType.lookupTarget(mProvisioning, TargetType.dl, com.zimbra.soap.type.TargetBy.name, target);
      }
      Right r = RightManager.getInstance().getRight(right);
      Set<ZimbraACE> aces = new HashSet<ZimbraACE>();
      ZimbraACE ace = new ZimbraACE(grantee_id, GranteeType.fromCode(granteeType).toZimbra(com.zimbra.cs.account.accesscontrol.GranteeType.class), r, null, null);
      aces.add(ace);
      List<ZimbraACE> revoked = ACLUtil.revokeRight(mProvisioning, targetEntry, aces);
      if (revoked.isEmpty()) {
  ...
  @Override @Nullable public Grants getGrants(@Nonnull org.openzal.zal.provisioning.TargetType targetType, Targetby name, String targetName, boolean granteeIncludeGroupsGranteeBelongs) {
    try {
      RightCommand.Grants grants = mProvisioning.getGrants(targetType.getCode(), name != null ? name.toZimbra(TargetBy.class) : null, targetName, null, null, null, granteeIncludeGroupsGranteeBelongs);
      if (grants == null) {
        return null;
      } else {
        return new Grants(grants);
  ...
  @Override public String getGranteeName(String grantee_id, @Nonnull String grantee_type) throws ZimbraException {
    if (grantee_type.equals(GranteeType.GT_GROUP.getCode())) {
      ...
      if (grantee_type.equals(GranteeType.GT_USER.getCode())) {
        ...
        if (grantee_type.equals(GranteeType.GT_AUTHUSER.getCode())) {
          return "00000000-0000-0000-0000-000000000000";
        } else {
          if (grantee_type.equals(GranteeType.GT_PUBLIC.getCode())) {
  ...
  @Override @Nonnull public GalSearchResult galSearch(@Nonnull Account account, String query, int skip, int limit) {
  ...
  @Nonnull public GalSearchResult galSearch(@Nonnull Account account, Domain domain, String query, int skip, int limit) {
  ...
  @Nonnull public DistributionList assertDistributionListById(String targetId) {
  ...
  @Override public void deleteAccountByName(String name) {
    try {
  ...
  @Override public void deleteAccountById(String id) {
    try {
  ...
  @Override public void deleteDomainById(String id) {
    try {
  ...
  @Override public void deleteCosById(String id) {
    try {
  ...
  public static class GalSearchCallback extends GalSearchResultCallback {
    ...
    @Nullable public Element handleContact(@Nonnull Contact contact) throws ZimbraException {
      if (mCounter >= mSkip) {
    ...
    try {
      ...
      try {
        ...
        for (com.zimbra.cs.account.Server memcachedServer : memcachedServers) {
          addresses[i++] = memcachedServer.getAttr(ProvisioningImp.A_zimbraServiceHostname, "localhost") + ":" + memcachedServer.getAttr("zimbraMemcachedBindPort", "11211");
        }
  ...
  @Override public long getLastLogonTimestampFrequency() {
    try {
  ...
  @Override @Nonnull public Group assertGroupById(String groupId) throws NoSuchGroupException {
  ...
  @Override @Nonnull public Group assertGroupByName(String groupName) throws NoSuchGroupException {
  ...
  @Override public void rawQuery(String base, final String query, LdapVisitor visitor) {
    rawQuery(base, query, visitor, null);
  }

  @Override public void rawQuery(String base, final String query, LdapVisitor visitor, String[] fields) {
    ...
    try {
      ...
      {
        SearchRequest searchRequest = new SearchRequest(base, SearchScope.SUBORDINATE_SUBTREE, query);
        searchRequest.setAttributes(fields);
        HashMap<String, String> map = new HashMap<>(fields == null ? 100 : fields.length, 1.0f);
        ASN1OctetString resumeCookie = null;
        while (true) {
          searchRequest.setControls(new SimplePagedResultsControl(1000 * 25, resumeCookie));
  ...
  @Override public int rawCountQuery(String base, final String query) {
    ZLdapContext zlc = null;
    try {
      ZSearchControls searchControls = ZSearchControls.createSearchControls(ZSearchScope.SEARCH_SCOPE_SUBTREE, 0, (String[]) null);
      zlc = LdapClient.getContext(LdapServerType.REPLICA, LdapUsage.GENERIC);
      return (int) zlc.countEntries(base, DirectQueryFilterBuilder.create(query), searchControls);
    } catch (ServiceException ex) {
      throw ExceptionWrapper.wrap(ex);
    } catch (LDAPException ex) {
      throw ExceptionWrapper.wrap(ex);
  ...
  @Override public void registerChangePasswordListener(ChangePasswordListener listener) {
  ...
  @Override public void registerTwoFactorChangeListener(String name, TwoFactorAuthChangeListener listener) {
    TwoFactorAuthChangeListenerWrapper.wrap(listener).register(name);
  }

  public boolean doExternalLdapAuth(Domain domain, String account, String password, Map<String, Object> context) {
    try {
  ...
  public Account autoProvisioningAndAuthenticate(Domain domain, String account, String password) {
    try {
      return Account.wrap(mProvisioning.autoProvAccountLazy(domain.toZimbra(com.zimbra.cs.account.Domain.class), account, password, AutoProvAuthMech.LDAP));
    } catch (ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }
