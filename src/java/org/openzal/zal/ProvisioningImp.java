...
public class ProvisioningImp implements Provisioning {
  ...
  public static String A_zimbraNetworkAdminEnabled = "zimbraNetworkAdminEnabled";

  public static String A_zimbraNetworkAdminNGEnabled = "zimbraNetworkAdminNGEnabled";
  ...
  @Override public void setZimletPriority(String zimletName, int priority) {
    Zimlet zimlet = getZimlet(zimletName);
