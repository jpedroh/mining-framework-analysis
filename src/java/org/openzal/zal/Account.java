...
public class Account extends Entry {
  ...
  public Account(String accountName, String accountId, Map<String, Object> accountAttrs, Map emptyMap, @Nonnull Provisioning provisioning) {
    this(new com.zimbra.cs.account.Account(accountName, accountId, accountAttrs, emptyMap, provisioning.toZimbra(com.zimbra.cs.account.Provisioning.class)));
  }
  ...
  public List<DataSource> getAllDataSources() throws NoSuchAccountException {
    try {
  ...
  public void setPrefAllowAddressForDelegatedSender(@Nonnull Collection<String> addresses) throws ZimbraException {
    try {
  ...
  @Nonnull public Collection<String> getMultiAttr(String name) {
    return Arrays.asList(mAccount.getMultiAttr(name));
  }

  @Nonnull public Collection<String> getPrefAllowAddressForDelegatedSender() {
  ...
  @Nonnull public Collection<String> getChildAccount() {
  ...
  public void modifyDataSource(String dataSourceId, Map<String, Object> attrs) throws NoSuchAccountException {
    try {
  ...
  @Nullable public Identity getIdentityByName(String name) throws NoSuchAccountException {
 ...
 */
  @Nonnull public List<DistributionList> getDistributionLists(boolean directOnly, Map<String, String> via) {
    try {
  ...
  @Nonnull public Collection<String> getAliases() {
   ...
   */
  @Nonnull public Collection<String> getAllAddressesIncludeDomainAliases(Provisioning provisioning) {
    Set<String> addresses = new HashSet<String>();
    Map<String, Collection<Domain>> domainCache = new HashMap<>();
    for (String address : getAllAddresses()) {
      addresses.add(address);
      addresses.addAll(((ProvisioningImp) provisioning).getWithDomainAliasesExpansion(address, domainCache));
    }
    return addresses;
  }

  @Nonnull public Collection<String> getAllAddressesAllowedInFrom(Provisioning provisioning) {
    Set<String> addresses = new HashSet<String>();
    ...
    try {
      rights = new ACLAccessManager().discoverUserRights(mAccount, new HashSet<Right>() {
        {
          add(UserRights.R_sendAs);
          add(UserRights.R_sendAsDistList);
        }
      }, false);
    } catch (Exception e) {
      return addresses;
   ...
   * of account.getName().
   */
  @Nonnull public List<String> getAllAddresses() {
  ...
  @Nonnull public PrefExternalSendersType getPrefExternalSendersType() {
    return new PrefExternalSendersType(mAccount.getPrefExternalSendersType());
  }

  @Nullable public Cos getCOS() throws NoSuchDomainException {
  ...
  @Nonnull public List<Signature> getAllSignatures() throws NoSuchAccountException {
    try {
  ...
  @Override public boolean equals(@Nullable Object o) {
    ...
    return getId().equals(((Account) o).getId());
  }
  ...
  @Nullable public AccountStatus getAccountStatus() {
  ...
  @Nonnull public Collection<String> getMailAlias() {
    return Arrays.asList(mAccount.getMailAlias());
  }

  @Nonnull public Collection<String> getPrefChildVisibleAccount() {
    return Arrays.asList(mAccount.getPrefChildVisibleAccount());
  }

  @Nonnull public Signature createSignature(String signatureName, Map<String, Object> attrs) throws NoSuchAccountException {
    try {
  ...
  @Nonnull public Collection<String> getChildVisibleAccount() {
    return Arrays.asList(mAccount.getChildVisibleAccount());
  }

  public void setPrefOutOfOfficeExternalReply(String zimbraPrefOutOfOfficeExternalReply) throws ServiceException {
  ...
  public void setPrefOutOfOfficeExternalUnknownReply(String zimbraPrefOutOfOfficeExternalReply) throws ServiceException {
    mAccount.setPrefOutOfOfficeExternalReply(zimbraPrefOutOfOfficeExternalReply);
    mAccount.setPrefExternalSendersType(ZAttrProvisioning.PrefExternalSendersType.ALLNOTINAB);
  }

  @Nonnull public Collection<String> getAllowFromAddress() {
  ...
  @Nonnull public Set<String> getDistributionLists() {
  ...
  @Nonnull public Collection<String> getMailDeliveryAddress() {
  ...
  public void setPrefExternalSendersType(@Nonnull PrefExternalSendersType zimbraPrefExternalSendersType) {
    try {
      mAccount.setPrefExternalSendersType(zimbraPrefExternalSendersType.toZimbra(ZAttrProvisioning.PrefExternalSendersType.class));
    } catch (ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }
  ...
  public String getAccountStatus(@Nonnull Provisioning prov) {
    return mAccount.getAccountStatus(prov.toZimbra(com.zimbra.cs.account.Provisioning.class));
  }

  @Nullable public Signature getSignatureByName(String key) {
  ...
  public void modifySignature(String signatureId, Map<String, Object> attrs) throws NoSuchAccountException, NoSuchSignatureException {
    try {
  ...
  @Nonnull public Map<String, Object> getAttrs() {
  ...
  @Nonnull public Collection<String> getMobilePolicyUnapprovedInROMApplication() {
  ...
  @Nonnull public Map<String, Object> getAttrs(boolean applyDefaults) {
    return new HashMap<String, Object>(mAccount.getAttrs(applyDefaults));
  }

  @Nullable public DataSource getDataSourceByName(String name) throws NoSuchAccountException {
  ...
  @Nonnull public Collection<String> getMobilePolicyApprovedApplicationList() {
    return Arrays.asList(mAccount.getMobilePolicyApprovedApplicationList());
  }

  @Nonnull public DataSource createDataSource(@Nonnull DataSourceType sourceType, String sourceName, Map<String, Object> attrs, boolean passwdAlreadyEncrypted) throws NoSuchAccountException, TooManyDataSourcesException, DataSourceExistsException {
    try {
      return new DataSource(mAccount.createDataSource(sourceType.toZimbra(com.zimbra.soap.admin.type.DataSourceType.class), sourceName, attrs, passwdAlreadyEncrypted));
    } catch (ServiceException e) {
      throw ExceptionWrapper.wrap(e);
    }
  }
  ...
  public void unsetPrefOutOfOfficeDate() throws ServiceException {
  ...
  public void removeAlias(String alias) throws NoSuchDomainException, NoSuchAliasException {
    try {
  ...
  @Nonnull public Identity createIdentity(String identityName, Map<String, Object> attrs) throws NoSuchAccountException, TooManyIdentitiesException, IdentityExistsException {
    try {
  ...
  public <T extends java.lang.Object> T toZimbra(@Nonnull Class<T> cls) {
  ...
  @Deprecated public String getServerHostname() {
  ...
  @Nonnull public ICalendarTimezone getAccountTimeZone() {
    ICalTimeZone accountTimeZone = Util.getAccountTimeZone(toZimbra(com.zimbra.cs.account.Account.class));
  ...
  public List<String> getAuthTokenEncoded() {
    ...
    if (encodedTokens == null) {
      ...
      if (encodedTokens instanceof String) {
