...
public class ReWriteVisitor implements NodeVisitor {
  ...
  private boolean needsParentheses(Node n) {
    return (n != null && (n.childNodes().size() > 1 || inCall() || firstChild(n) instanceof HashNode) || firstChild(n) instanceof NewlineNode || firstChild(n) instanceof IfNode);
  }
  ...
  private void printCallArguments(Node argsNode, Node iterNode, boolean hasParens) {
    ...
    if (argsNode != null && argsNode.childNodes().size() == 1 && firstChild(argsNode) instanceof HashNode && iterNode == null) {
    ...
    boolean paranthesesPrinted = hasParens || needsParentheses(argsNode) || (argsNode == null && iterNode != null && iterNode instanceof BlockPassNode) || (argsNode != null && argsNode.childNodes().size() > 0 && iterNode != null);
  ...
  @Override public Object visitAliasNode(AliasNode iVisited) {
    print("alias ");
  ...
  private boolean sourceRangeContains(SourcePosition pos, String searched) {
    return pos.getStartOffset() < config.getSource().length() && pos.getEndOffset() < config.getSource().length() + 1 && config.getSource().substring(pos.getStartOffset(), pos.getEndOffset()).indexOf(searched) > -1;
  }

  @Override public Object visitAndNode(AndNode iVisited) {
    enterCall();
  ...
  @Override public Object visitArgsNode(ArgsNode iVisited) {
  ...
  @Override public Object visitArgsCatNode(ArgsCatNode iVisited) {
    print("[");
  ...
  @Override public Object visitArgumentNode(ArgumentNode iVisited) {
    return null;
  }

  @Override public Object visitArrayNode(ArrayNode iVisited) {
    print('[');
    enterCall();
  ...
  @Override public Object visitBackRefNode(BackRefNode iVisited) {
    print('$');
    print(iVisited.getType());
    return null;
  }

  @Override public Object visitBeginNode(BeginNode iVisited) {
    print("begin");
  ...
  @Override public Object visitBignumNode(BignumNode iVisited) {
    print(iVisited.getValue());
    return null;
  }

  @Override public Object visitBlockArgNode(BlockArgNode iVisited) {
    print(iVisited.getLexicalName());
    return null;
  }

  @Override public Object visitBlockArg18Node(BlockArg18Node iVisited) {
    print('&');
    visitNode(iVisited.getBlockArg());
    return null;
  }

  @Override public Object visitBlockNode(BlockNode iVisited) {
  ...
  @Override public Object visitBlockPassNode(BlockPassNode iVisited) {
    visitNode(iVisited.getBody());
    return null;
  }

  @Override public Object visitBreakNode(BreakNode iVisited) {
    print("break");
    return null;
  }

  @Override public Object visitConstDeclNode(ConstDeclNode iVisited) {
    printAsgnNode(iVisited);
    return null;
  }

  @Override public Object visitClassVarAsgnNode(ClassVarAsgnNode iVisited) {
    printAsgnNode(iVisited);
    return null;
  }

  @Override public Object visitClassVarDeclNode(ClassVarDeclNode iVisited) {
    printAsgnNode(iVisited);
    return null;
  }

  @Override public Object visitClassVarNode(ClassVarNode iVisited) {
    print(iVisited.getLexicalName());
    return null;
  }

  @Override public Object visitComplexNode(ComplexNode iVisited) {
  ...
  private void printCallReceiverNode(CallNode iVisited) {
    if (iVisited.getReceiver() instanceof HashNode) {
      print('(');
    }
  ...
  @Override public Object visitCallNode(CallNode iVisited) {
    ...
    if (isNameAnOperator(iVisited.getName())) {
      if (firstChild(iVisited.getArgs()) instanceof NewlineNode) {
        print(' ');
      }
    ...
    if (!(iVisited.getIter() instanceof BlockPassNode)) {
      visitNode(iVisited.getIter());
    }
    return null;
  }

  @Override public Object visitCaseNode(CaseNode iVisited) {
    print("case ");
  ...
  @Override public Object visitClassNode(ClassNode iVisited) {
    print("class ");
  ...
  @Override public Object visitColon2Node(Colon2Node iVisited) {
  ...
  @Override public Object visitColon3Node(Colon3Node iVisited) {
    print(iVisited.getLexicalName());
    return null;
  }

  @Override public Object visitCommentNode(CommentNode iVisited) {
    print(iVisited.getContent());
    return null;
  }

  @Override public Object visitConstNode(ConstNode iVisited) {
    print(iVisited.getName());
    return null;
  }

  @Override public Object visitDAsgnNode(DAsgnNode iVisited) {
    printAsgnNode(iVisited);
    return null;
  }

  @Override public Object visitDRegxNode(DRegexpNode iVisited) {
  ...
  @Override public Object visitDStrNode(DStrNode iVisited) {
  ...
  @Override public Object visitDSymbolNode(DSymbolNode iVisited) {
    print(':');
    if (config.getPrintQuotesInString().isTrue()) {
      print(getSeparatorForSym(iVisited));
    }
    config.getPrintQuotesInString().set(false);
    leaveCall();
    for (Node child : iVisited.childNodes()) {
  ...
  @Override public Object visitDVarNode(DVarNode iVisited) {
    print(iVisited.getLexicalName());
    return null;
  }

  @Override public Object visitDXStrNode(DXStrNode iVisited) {
    config.getPrintQuotesInString().set(false);
    print("%x{");
    visitIter(iVisited.childNodes().iterator());
    print('}');
  ...
  @Override public Object visitDefinedNode(DefinedNode iVisited) {
    print("defined? ");
    enterCall();
  ...
  private boolean hasArguments(Node n) {
    if (n instanceof ArgsNode) {
      ...
      if (n instanceof ArrayNode && n.childNodes().isEmpty()) {
        return false;
      }
    }
    return true;
  ...
  @Override public Object visitDefnNode(DefnNode iVisited) {
  ...
  @Override public Object visitDefsNode(DefsNode iVisited) {
    config.getIndentor().indent();
    print("def ");
    visitNode(iVisited.getReceiver());
    print('.');
  ...
  @Override public Object visitDotNode(DotNode iVisited) {
    enterCall();
  ...
  @Override public Object visitEnsureNode(EnsureNode iVisited) {
    visitNode(iVisited.getBody());
    config.getIndentor().outdent();
    printNewlineAndIndentation();
    print("ensure");
  ...
  @Override public Object visitEvStrNode(EvStrNode iVisited) {
    print('#');
  ...
  @Override public Object visitFCallNode(FCallNode iVisited) {
    print(iVisited.getName());
    if (iVisited.getIter() != null) {
      config.getCallDepth().enterCall();
    }
    printCallArguments(iVisited.getArgs(), iVisited.getIter(), iVisited.hasParens());
    if (iVisited.getIter() != null) {
  ...
  @Override public Object visitFalseNode(FalseNode iVisited) {
    print("false");
    return null;
  }

  @Override public Object visitFixnumNode(FixnumNode iVisited) {
    print(iVisited.getValue());
    return null;
  }

  @Override public Object visitFlipNode(FlipNode iVisited) {
    enterCall();
    visitNode(iVisited.getBegin());
    print(" ..");
    if (iVisited.isExclusive()) {
  ...
  @Override public Object visitFloatNode(FloatNode iVisited) {
    print(iVisited.getValue());
    return null;
  }

  @Override public Object visitForNode(ForNode iVisited) {
    print("for ");
  ...
  @Override public Object visitGlobalAsgnNode(GlobalAsgnNode iVisited) {
    printAsgnNode(iVisited);
    return null;
  }

  @Override public Object visitGlobalVarNode(GlobalVarNode iVisited) {
    print(iVisited.getLexicalName());
    return null;
  }
  ...
  @Override public Object visitHashNode(HashNode iVisited) {
    print('{');
  ...
  @Override public Object visitInstAsgnNode(InstAsgnNode iVisited) {
    printAsgnNode(iVisited);
    return null;
  }

  @Override public Object visitInstVarNode(InstVarNode iVisited) {
    print(iVisited.getLexicalName());
    return null;
  }
  ...
  private boolean sourceSubStringEquals(int offset, int length, String str) {
    return config.getSource().length() >= offset + length && config.getSource().substring(offset, offset + length).equals(str);
  }

  private boolean isShortIfStatement(IfNode iVisited) {
    return (isOnSingleLine(iVisited.getCondition(), iVisited.getElseBody()) && !(iVisited.getElseBody() instanceof IfNode) && !sourceSubStringEquals(getStartOffset(iVisited), 2, "if"));
  }

  @Override public Object visitIfNode(IfNode iVisited) {
  ...
  @Override public Object visitImplicitNilNode(ImplicitNilNode visited) {
    return null;
  }

  @Override public Object visitIterNode(IterNode iVisited) {
  ...
  @Override public Object visitLambdaNode(LambdaNode visited) {
    print("->(");
  ...
  @Override public Object visitListNode(ListNode iVisited) {
    return null;
  }

  @Override public Object visitLocalAsgnNode(LocalAsgnNode iVisited) {
    config.getLocalVariables().addLocalVariable(iVisited.getIndex(), iVisited.getLexicalName());
    printAsgnNode(iVisited);
    return null;
  }

  @Override public Object visitLocalVarNode(LocalVarNode iVisited) {
    print(iVisited.getLexicalName());
    return null;
  }

  @Override public Object visitMethodNameNode(MethodNameNode iVisited) {
    return null;
  }

  @Override public Object visitMultipleAsgnNode(MultipleAsgnNode iVisited) {
    if (iVisited.getPre() != null) {
  ...
  @Override public Object visitMatch2Node(Match2Node iVisited) {
    visitNode(iVisited.getReceiver());
  ...
  @Override public Object visitMatch3Node(Match3Node iVisited) {
    visitNode(iVisited.getValue());
    print(config.getFormatHelper().matchOperator());
    visitNode(iVisited.getReceiver());
    return null;
  ...
  @Override public Object visitMatchNode(MatchNode iVisited) {
    visitNode(iVisited.getRegexp());
    return null;
  }

  @Override public Object visitModuleNode(ModuleNode iVisited) {
    print("module ");
    config.getIndentor().indent();
    visitNode(iVisited.getCPath());
    visitNode(iVisited.getBody());
  ...
  @Override public Object visitNewlineNode(NewlineNode iVisited) {
  ...
  @Override public Object visitNextNode(NextNode iVisited) {
    print("next");
    return null;
  }

  @Override public Object visitNilNode(NilNode iVisited) {
    print("nil");
    return null;
  }

  @Override public Object visitNotNode(NotNode iVisited) {
    if (iVisited.getCondition() instanceof CallNode) {
      enterCall();
    }
  ...
  @Override public Object visitNthRefNode(NthRefNode iVisited) {
    print('$');
  ...
  private boolean isSimpleNode(Node n) {
    return (n instanceof LocalVarNode || n instanceof AssignableNode || n instanceof InstVarNode || n instanceof ClassVarNode || n instanceof GlobalVarNode || n instanceof ConstDeclNode || n instanceof VCallNode || isNumericNode(n));
  }

  @Override public Object visitOpElementAsgnNode(OpElementAsgnNode iVisited) {
  ...
  @Override public Object visitOpAsgnNode(OpAsgnNode op) {
  ...
  @Override public Object visitOpAsgnAndNode(OpAsgnAndNode iVisited) {
    printOpAsgnNode(iVisited.getSecond(), "&&=");
    return null;
  }

  @Override public Object visitOpAsgnOrNode(OpAsgnOrNode iVisited) {
    printOpAsgnNode(iVisited.getSecond(), "||=");
    return null;
  }

  @Override public Object visitOptArgNode(OptArgNode iVisited) {
    return null;
  }

  @Override public Object visitOrNode(OrNode iVisited) {
    enterCall();
    visitNode(iVisited.getFirst());
    leaveCall();
  ...
  @Override public Object visitPostExeNode(PostExeNode iVisited) {
    return null;
  }

  @Override public Object visitPreExeNode(PreExeNode iVisited) {
    return null;
  }

  @Override public Object visitRationalNode(RationalNode iVisited) {
  ...
  @Override public Object visitRedoNode(RedoNode iVisited) {
    print("redo");
    return null;
  }
  ...
  private boolean isSpecialRegexNotation(Node n) {
    return getStartOffset(n) >= 2 && !(config.getSource().length() < getStartOffset(n)) && config.getSource().charAt(getStartOffset(n) - 3) == '%';
  }
  ...
  @Override public Object visitRegexpNode(RegexpNode re) {
  ...
  @Override public Object visitRequiredKeywordArgumentValueNode(
<<<<<<< /usr/src/app/output/jruby/jruby-parser/e6dae92cd4c87841431cbdfeffa34a4e05f3a2d9/src/org/jrubyparser/rewriter/ReWriteVisitor.java/left.java
  RequiredKeywordArgumentValueNode argumentValueNode
=======
  RequiredKeywordArgumentValueNode iVisted
>>>>>>> /usr/src/app/output/jruby/jruby-parser/e6dae92cd4c87841431cbdfeffa34a4e05f3a2d9/src/org/jrubyparser/rewriter/ReWriteVisitor.java/right.java
  ...
  @Override public Object visitRescueBodyNode(RescueBodyNode iVisited) {
  ...
  private void printExceptionNode(RescueBodyNode n) {
    ...
    if (n.getBody() instanceof BlockNode) {
      firstBodyNode = firstChild(n.getBody());
    }
    if (firstBodyNode instanceof AssignableNode) {
      ...
      if (firstBodyNode instanceof LocalAsgnNode) {
        config.getLocalVariables().addLocalVariable(((LocalAsgnNode) firstBodyNode).getIndex(), ((LocalAsgnNode) firstBodyNode).getName());
      }
      config.getIndentor().indent();
  ...
  @Override public Object visitRescueNode(RescueNode iVisited) {
    visitNode(iVisited.getBody());
    config.getIndentor().outdent();
    Node body = iVisited.getRescue().getBody();
    if (body != null && getStartLine(iVisited) != getEndLine(body)) {
      printNewlineAndIndentation();
    }
    if (body == null) {
      printNewlineAndIndentation();
  ...
  @Override public Object visitKeywordArgNode(KeywordArgNode iVisited) {
    throw new UnsupportedOperationException("Not supported yet.");
  }

  @Override public Object visitKeywordRestArgNode(KeywordRestArgNode iVisited) {
    throw new UnsupportedOperationException("Not supported yet.");
  }

  @Override public Object visitRetryNode(RetryNode iVisited) {
    print("retry");
    return null;
  }
  ...
  @Override public Object visitReturnNode(ReturnNode iVisited) {
    print("return");
    enterCall();
    if (iVisited.getValue() != null) {
      print(' ');
  ...
  @Override public Object visitSClassNode(SClassNode iVisited) {
    print("class << ");
    config.getIndentor().indent();
    visitNode(iVisited.getReceiver());
    visitNode(iVisited.getBody());
  ...
  @Override public Object visitSelfNode(SelfNode iVisited) {
    print("self");
    return null;
  }

  @Override public Object visitSplatNode(SplatNode iVisited) {
    print("*");
    visitNode(iVisited.getValue());
    return null;
  }
  ...
  protected char getSeparatorForSym(Node n) {
    if (config.getSource().length() >= (getStartOffset(n) + 1) && config.getSource().charAt(getStartOffset(n) + 1) == '\'') {
      return '\'';
    }
    return '\"';
  }
  ...
  @Override public Object visitStrNode(StrNode iVisited) {
  ...
  private boolean needsSuperNodeParentheses(SuperNode n) {
    return n.getArgs().childNodes().isEmpty() && config.getSource().charAt(getEndOffset(n)) == '(';
  }

  @Override public Object visitSuperNode(SuperNode iVisited) {
    print("super");
    printCallArguments(iVisited.getArgs(), iVisited.getIter(), iVisited.hasParens());
    return null;
  }

  @Override public Object visitSValueNode(SValueNode iVisited) {
    visitNode(iVisited.getValue());
    return null;
  }

  @Override public Object visitSymbolNode(SymbolNode symbol) {
    print(symbol.getLexicalName());
    return null;
  }

  @Override public Object visitSyntaxNode(SyntaxNode iVisited) {
    print(iVisited.getContent());
    return null;
  }

  @Override public Object visitToAryNode(ToAryNode iVisited) {
    visitNode(iVisited.getValue());
    return null;
  }

  @Override public Object visitTrueNode(TrueNode iVisited) {
    print("true");
    return null;
  }

  @Override public Object visitUnaryCallNode(UnaryCallNode iVisited) {
    print(iVisited.getLexicalName());
    visitNode(iVisited.getReceiver());
    return null;
  }

  @Override public Object visitUndefNode(UndefNode iVisited) {
    print("undef ");
    visitNode(iVisited.getName());
    return null;
  }

  @Override public Object visitUntilNode(UntilNode iVisited) {
    print("until ");
  ...
  @Override public Object visitVAliasNode(VAliasNode iVisited) {
    print("alias ").print(iVisited.getNewName()).print(' ').print(iVisited.getOldName());
    return null;
  }

  @Override public Object visitVCallNode(VCallNode iVisited) {
    print(iVisited.getName());
    return null;
  }
  ...
  @Override public Object visitWhenNode(WhenNode iVisited) {
    printNewlineAndIndentation();
    print("when ");
    enterCall();
  ...
  @Override public Object visitWhileNode(WhileNode iVisited) {
  ...
  @Override public Object visitXStrNode(XStrNode iVisited) {
    print('`');
    print(iVisited.getValue());
    print('`');
    return null;
  ...
  @Override public Object visitYieldNode(YieldNode iVisited) {
    print("yield");
    printCallArguments(iVisited.getArgs(), null, iVisited.hasParens());
    return null;
  }

  @Override public Object visitZArrayNode(ZArrayNode iVisited) {
    print("[]");
    return null;
  }

  @Override public Object visitZSuperNode(ZSuperNode iVisited) {
    print("super");
    return null;
  }
  ...
  @Override public Object visitArgsPushNode(ArgsPushNode node) {
    assert false : "Unhandled node";
    return null;
  }

  @Override public Object visitAttrAssignNode(AttrAssignNode iVisited) {
    if (iVisited.getName().equals("[]=")) {
  ...
  @Override public Object visitRootNode(RootNode root) {
  ...
  @Override public Object visitRestArgNode(RestArgNode iVisited) {
    print(iVisited.getLexicalName());
    return null;
  }

  @Override public Object visitEncodingNode(EncodingNode iVisited) {
    print("__ENCODING__");
    return null;
  }

  @Override public Object visitLiteralNode(LiteralNode iVisited) {
    print(iVisited.getName());
    return null;
  }
}