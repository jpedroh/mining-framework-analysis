...
public class SimpleGenerator implements ChunkGenerator {
  @Override public BlockId[][] generateExtBlockSections(EnderWorld world, Random random, int i, int o) {
  ...
  @Override public List<MultiChunkBlockPopulator> getDefaultPopulators(EnderWorld world) {
