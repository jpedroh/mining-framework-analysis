...
public class EnderPlayer extends EnderEntity implements CommandSender, Player {
  ...
  @Override public boolean equals(Object obj) {
    ...
    if (textureSignature == null) {
      ...
      if (!textureSignature.equals(other.textureSignature)) {
        return false;
      }
    }
    if (textureValue == null) {
      ...
      if (!textureValue.equals(other.textureValue)) {
        return false;
      }
    }
    if (uuid == null) {
  ...
  @Override public Packet[] getSpawnPackets() {
    ...
    if (this.getInventoryHandler().getItemInHand() != null) {
      toSend.add(new PacketOutEntityEquipment(this.getEntityId(), (short) 0, this.getInventoryHandler().getItemInHand()));
    }
  ...
  @Override public void serverTick() {
    ...
    if (!this.isDead() && latestFood++ % (30 * 20) == 0) {
      didFoodUpdate = true;
