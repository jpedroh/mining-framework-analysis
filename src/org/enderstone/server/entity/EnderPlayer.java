...
<<<<<<< /usr/src/app/output/sander2798/enderstone/27f9c43869468a75a469b9d40b3e3e946da5c687/src/org/enderstone/server/entity/EnderPlayer.java/left.java
	public void onPlayerChat(String message) {
		Utill.broadcastMessage("<" + this.getPlayerName() + "> " + message);
||||||| /usr/src/app/output/sander2798/enderstone/27f9c43869468a75a469b9d40b3e3e946da5c687/src/org/enderstone/server/entity/EnderPlayer.java/base.java
...
=======
	public void onPlayerChat(String message) throws Exception {
		if (message.startsWith("/")) {
			...
			Utill.broadcastMessage("<" + this.getPlayerName() + "> " + message);
>>>>>>> /usr/src/app/output/sander2798/enderstone/27f9c43869468a75a469b9d40b3e3e946da5c687/src/org/enderstone/server/entity/EnderPlayer.java/right.java
	}
