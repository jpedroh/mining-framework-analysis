...
public abstract class Packet {
            ...
            if (watch.getValue() instanceof Float) {
              ...
              if (watch.getValue() instanceof String) {
                ...
                if (watch.getValue() instanceof ItemStack) {
                  ...
                  if (watch.getValue() instanceof Vector) {
  ...
  public static int getItemStackSize(ItemStack stack) {
    ...
    if (stack.getCompoundTag() == null) {
      total++;
      return 
<<<<<<< /usr/src/app/output/sandergielisse/enderstone/febdb02eb304ada845e62272290b13d31e533cf2/src/org/enderstone/server/packet/Packet.java/left.java
      total
=======
      ++total
>>>>>>> /usr/src/app/output/sandergielisse/enderstone/febdb02eb304ada845e62272290b13d31e533cf2/src/org/enderstone/server/packet/Packet.java/right.java
      ;
    }
