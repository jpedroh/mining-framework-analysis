...
public abstract class GraphBaseImpl implements Graph, InternalGraph {
  ...
  @Override public void removeGraphStructureChangedListener(GraphStructureChangedListener listener) {
    ...
    if (listener instanceof GraphStructureChangedListenerWithAutoRemove) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = graphStructureChangedListenersWithAutoRemoval.iterator();
      ...
      Iterator<GraphStructureChangedListener> iterator = graphStructureChangedListeners.iterator();
  ...
  private ArrayList<GraphStructureChangedListener> getListenerListForAutoRemove() {
    ...
    ArrayList<GraphStructureChangedListener> listeners = new ArrayList<GraphStructureChangedListener>(graphStructureChangedListenersWithAutoRemoval.size());
    Iterator<WeakReference<GraphStructureChangedListener>> it = graphStructureChangedListenersWithAutoRemoval.iterator();
    while (it.hasNext()) {
