...
public abstract class GraphBaseImpl implements Graph, InternalGraph {
  ...
  /**
	 ...
	 */
  @Override public final void ecaAttributeChanging(String name, Object oldValue, Object newValue) {
    if (!isLoading()) {
  ...
  /**
	 ...
	 */
  @Override public final void ecaAttributeChanged(String name, Object oldValue, Object newValue) {
    if (!isLoading()) {
  ...
  private final void internalDeleteEdge(Edge edge) {
    ...
    edgeListModified();
    if (hasECARuleManager()) {
      getECARuleManager().fireAfterDeleteEdgeEvents(e.getAttributedElementClass(), alpha, omega);
    }
  }
  ...
  private final void internalDeleteVertex() {
    while (!getDeleteVertexList().isEmpty()) {
      ...
      vertexListModified();
      if (hasECARuleManager()) {
        getECARuleManager().fireAfterDeleteVertexEvents(v.getAttributedElementClass());
      }
    }
  }
  ...
  @Override public final ECARuleManagerInterface getECARuleManager() {
  ...
  @Override public final boolean hasECARuleManager() {
