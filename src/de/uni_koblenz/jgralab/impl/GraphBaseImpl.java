...
public abstract class GraphBaseImpl implements Graph, InternalGraph {
  ...
  @Override public final void addEdge(Edge newEdge, Vertex alpha, Vertex omega) {
    assert newEdge != null;
  ...
  @Override public final void appendEdgeToESeq(InternalEdge e) {
  ...
  @Override public final void appendVertexToVSeq(InternalVertex v) {
  ...
  /**
	 ...
	 */
  @Override public final void expandEdgeArray(int newSize) {
    if (newSize <= eMax) {
  ...
  /**
	 ...
	 */
  @Override public final void expandVertexArray(int newSize) {
    if (newSize <= vMax) {
  ...
  @Override public final Edge getEdge(int eId) {
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/b6ce189e6c29da1ddaee21ca7a4c5e0dba98957d/src/de/uni_koblenz/jgralab/impl/GraphBaseImpl.java/right.java
  ...
  @Override public final void removeVertexFromVSeq(InternalVertex v) {
    assert v != null;
  ...
  @Override public final void removeEdgeFromESeq(InternalEdge e) {
    assert e != null;
  ...
  @Override public final void internalLoadingCompleted(int[] firstIncidence, int[] nextIncidence) {
  ...
  @Override public final void setLoading(boolean isLoading) {
    loading = isLoading;
  }
  ...
  @Override public final void defragment() {
  ...
  @Override public void setECARuleManager(ECARuleManagerInterface manager) {
  ...
  @Override public void fireAfterDeleteVertex(VertexClass vc) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
