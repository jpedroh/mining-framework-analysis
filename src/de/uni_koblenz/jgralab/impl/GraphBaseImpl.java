...
public abstract class GraphBaseImpl implements Graph, InternalGraph {
  ...
  @Override public Class<? extends AttributedElement> getSchemaClass() {
    return null;
  }
  ...
  @Override public <T extends java.lang.Object> T getAttribute(String name) throws NoSuchAttributeException {
    return null;
  }
  ...
  @Override public void addEdge(Edge newEdge, Vertex alpha, Vertex omega) {
    ...
    if (!a.isValidAlpha(e)) {
      throw new GraphException("Edges of class " + e.getAttributedElementClass().getQualifiedName() + " may not start at vertices of class " + a.getAttributedElementClass().getQualifiedName());
    }
    InternalVertex o = (InternalVertex) omega;
    if (!o.isValidOmega(e)) {
      throw new GraphException("Edges of class " + e.getAttributedElementClass().getQualifiedName() + " may not end at vertices of class " + o.getAttributedElementClass().getQualifiedName());
    }
    int eId = e.getId();
    if (isLoading()) {
      if (eId > 0) {
  ...
  @Override public int getExpandedVertexCount() {
  ...
  @Override public int getExpandedEdgeCount() {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) @Override public <T extends Edge> T createEdge(Class<T> cls, Vertex alpha, Vertex omega) {
    try {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) public <T extends Edge> T createEdge(EdgeClass ec, Vertex alpha, Vertex omega) {
  ...
  /**
	 ...
	 * <code>cls</code> has to be the "Impl" class.
	 */
  @SuppressWarnings(value = { "unchecked" }) @Override public <T extends Vertex> T createVertex(Class<T> cls) {
    try {
  ...
  @Override public Edge getFirstEdge() {
    TraversalContext tc = getTraversalContext();
  ...
  @Override public Edge getLastEdge() {
    TraversalContext tc = getTraversalContext();
  ...
  @Override public Edge getFirstEdge(Class<? extends Edge> edgeClass) {
  ...
  @Override public Edge getFirstEdge(EdgeClass edgeClass) {
    assert edgeClass != null;
    return getFirstEdge(edgeClass.getSchemaClass());
  }

  @Override public Vertex getFirstVertex() {
    TraversalContext tc = getTraversalContext();
  ...
  @Override public Vertex getLastVertex() {
    TraversalContext tc = getTraversalContext();
  ...
  @Override public Vertex getFirstVertex(Class<? extends Vertex> vertexClass) {
  ...
  @Override public Vertex getFirstVertex(VertexClass vertexClass) {
    assert vertexClass != null;
  ...
  /**
	 ...
	 */
  @Override public void ecaAttributeChanging(String name, Object oldValue, Object newValue) {
    if (!isLoading()) {
      getECARuleManager().fireBeforeChangeAttributeEvents(this, name, oldValue, newValue);
    }
  }
  ...
  /**
	 ...
	 */
  @Override public void ecaAttributeChanged(String name, Object oldValue, Object newValue) {
    if (!isLoading()) {
      getECARuleManager().fireAfterChangeAttributeEvents(this, name, oldValue, newValue);
    }
  }
  ...
  private void internalDeleteEdge(Edge edge) {
    ...
    edgeListModified();
    if (getECARuleManagerIfThere() != null) {
      getECARuleManagerIfThere().fireAfterDeleteEdgeEvents(e.getSchemaClass());
    }
  ...
  private void internalDeleteVertex() {
    while (!getDeleteVertexList().isEmpty()) {
      ...
      vertexListModified();
      if (getECARuleManagerIfThere() != null) {
        getECARuleManagerIfThere().fireAfterDeleteVertexEvents(v.getSchemaClass());
      }
  ...
  @Override public boolean isEdgeListModified(long edgeListVersion) {
    return getEdgeListVersion() != edgeListVersion;
  }

  @Override public boolean isGraphModified(long previousVersion) {
  ...
  @Override public boolean isVertexListModified(long previousVersion) {
  ...
  @Override public void setFreeVertexList(FreeIndexList freeVertexList) {
    this.freeVertexList = freeVertexList;
  }

  @Override public void setFreeEdgeList(FreeIndexList freeEdgeList) {
    this.freeEdgeList = freeEdgeList;
  }

  @Override public void sortVertices(Comparator<Vertex> comp) {
    if (getFirstVertexInVSeq() == null) {
      return;
    }
    class VertexList {
  ...
  @Override public void sortEdges(Comparator<Edge> comp) {
    if (getFirstEdgeInESeq() == null) {
      return;
    }
    class EdgeList {
  ...
  @Override public ECARuleManagerInterface getECARuleManager() {
    if (ecaRuleManager == null) {
      Constructor<?> ruleManagerConstructor;
      try {
        ruleManagerConstructor = Class.forName("de.uni_koblenz.jgralab.eca.ECARuleManager").getConstructor(Graph.class);
        ecaRuleManager = (ECARuleManagerInterface) ruleManagerConstructor.newInstance(this);
      } catch (Exception e) {
        e.printStackTrace();
      }
  ...
  @Override public ECARuleManagerInterface getECARuleManagerIfThere() {
    return ecaRuleManager;
  }
  ...
  @Override public int getGraphStructureChangedListenerCount() {
  ...
  @Override public void notifyVertexDeleted(Vertex v) {
    assert (v != null) && v.isValid() && vSeqContainsVertex(v);
    if (graphStructureChangedListenersWithAutoRemoval != null) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = getListenerListIteratorForAutoRemove();
  ...
  @Override public void notifyVertexAdded(Vertex v) {
    assert (v != null) && v.isValid() && vSeqContainsVertex(v);
    if (graphStructureChangedListenersWithAutoRemoval != null) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = getListenerListIteratorForAutoRemove();
      while (iterator.hasNext()) {
  ...
  @Override public void notifyEdgeDeleted(Edge e) {
  ...
  @Override public void notifyEdgeAdded(Edge e) {
    assert (e != null) && e.isValid() && e.isNormal() && eSeqContainsEdge(e);
    if (graphStructureChangedListenersWithAutoRemoval != null) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = getListenerListIteratorForAutoRemove();
      while (iterator.hasNext()) {
  ...
  @Override public void notifyMaxVertexCountIncreased(int newValue) {
    if (graphStructureChangedListenersWithAutoRemoval != null) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = getListenerListIteratorForAutoRemove();
      while (iterator.hasNext()) {
        GraphStructureChangedListener currentListener = iterator.next().get();
  ...
  @Override public void notifyMaxEdgeCountIncreased(int newValue) {
    if (graphStructureChangedListenersWithAutoRemoval != null) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = getListenerListIteratorForAutoRemove();
      while (iterator.hasNext()) {
        GraphStructureChangedListener currentListener = iterator.next().get();
  ...
  @Override public void save(String filename, ProgressFunction pf) throws GraphIOException {
  ...
  @Override public void save(DataOutputStream out, ProgressFunction pf) throws GraphIOException {
