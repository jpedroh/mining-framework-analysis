...
public abstract class GraphBaseImpl implements Graph, InternalGraph {
  ...
  @Override public void addEdge(Edge newEdge, Vertex alpha, Vertex omega) {
    assert newEdge != null;
    ...
    assert (alpha.getSchema() == omega.getSchema()) && (alpha.getSchema() == schema) && (newEdge.getSchema() == schema) : "The schemas of alpha, omega, newEdge and this graph don\'t match!";
  ...
  @Override public final void internalEdgeAdded(InternalEdge e) {
    notifyEdgeAdded(e);
  }

  @Override public final void addVertex(Vertex newVertex) {
  ...
  @Override public void internalVertexAdded(InternalVertex v) {
    notifyVertexAdded(v);
  }

  @Override public void appendEdgeToESeq(InternalEdge e) {
  ...
  @Override public void appendVertexToVSeq(InternalVertex v) {
  ...
  @Override public final int getExpandedVertexCount() {
  ...
  @Override public final int getExpandedEdgeCount() {
    return computeNewSize(eMax);
  }

  @Override public final int compareTo(AttributedElement<GraphClass, Graph> a) {
    if (a == this) {
      return 0;
    }
  ...
  @Override public final boolean containsEdge(Edge e) {
    return getTraversalContext() == null ? eSeqContainsEdge(e) : eSeqContainsEdge(e) && getTraversalContext().containsEdge(e);
  }

  @Override public final boolean eSeqContainsEdge(Edge e) {
    return (e != null) && (e.getGraph() == this) && containsEdgeId(((EdgeBaseImpl) e.getNormalEdge()).id) && (getEdge(((EdgeBaseImpl) e.getNormalEdge()).id) == e.getNormalEdge());
  }
  ...
  private final boolean containsEdgeId(int eId) {
    ...
    return (eId > 0) && (eId <= eMax) && (getEdge(eId) != null) && (getRevEdge()[eId] != null);
  }

  @Override public final boolean containsVertex(Vertex v) {
    return getTraversalContext() == null ? vSeqContainsVertex(v) : vSeqContainsVertex(v) && getTraversalContext().containsVertex(v);
  }

  @Override public final boolean vSeqContainsVertex(Vertex v) {
    return (v != null) && (v.getGraph() == this) && containsVertexId(((VertexBaseImpl) v).id) && (getVertex(((VertexBaseImpl) v).id) == v);
  }
  ...
  /**
	 ...
	 */
  @Override @SuppressWarnings(value = { "unchecked" }) public <T extends Edge> T createEdge(EdgeClass ec, Vertex alpha, Vertex omega) {
    try {
  ...
  /**
	 ...
	 * graph.
	 */
  @SuppressWarnings(value = { "unchecked" }) @Override public <T extends Vertex> T createVertex(VertexClass vc) {
    try {
  ...
  /**
	 ...
	 */
  @Override public void expandEdgeArray(int newSize) {
    if (newSize <= eMax) {
  ...
  /**
	 ...
	 */
  @Override public void expandVertexArray(int newSize) {
    if (newSize <= vMax) {
    ...
    if (getVertex() != null) {
      System.arraycopy(getVertex(), 0, expandedArray, 0, getVertex().length);
    }
  ...
  @Override public final int getECount() {
  ...
  @Override public Edge getEdge(int eId) {
  ...
  @Override public final Edge getFirstEdge() {
    TraversalContext tc = getTraversalContext();
  ...
  @Override public final Edge getLastEdge() {
    TraversalContext tc = getTraversalContext();
  ...
  @Override public final Edge getFirstEdge(EdgeClass edgeClass) {
  ...
  @Override public final Vertex getFirstVertex() {
    TraversalContext tc = getTraversalContext();
  ...
  @Override public final Vertex getLastVertex() {
    TraversalContext tc = getTraversalContext();
  ...
  @Override public final Vertex getFirstVertex(VertexClass vertexClass) {
  ...
  @Override public final GraphClass getGraphClass() {
    return getAttributedElementClass();
  }

  @Override public long getGraphVersion() {
    return graphVersion;
  }
  ...
  @Override public int getMaxECount() {
    return eMax;
  }

  @Override public int getMaxVCount() {
    return vMax;
  }
  ...
  @Override public Vertex getVertex(int vId) {
  ...
  @Override public final void internalEdgeDeleted(InternalEdge e) {
    assert e != null;
    notifyEdgeDeleted(e);
  }
    ...
    while (!getDeleteVertexList().isEmpty()) {
      ...
      while (e != null) {
        ...
        if (e.getThatAggregationKind() == AggregationKind.COMPOSITE) {
          ...
          if ((other != v) && vSeqContainsVertex(other) && !getDeleteVertexList().contains(other)) {
      ...
      vertexListModified();
      fireAfterDeleteVertex(v.getAttributedElementClass(), getDeleteVertexList().isEmpty());
    }
  }

  @Override public final void internalVertexDeleted(InternalVertex v) {
    assert v != null;
    notifyVertexDeleted(v);
  }

  @Override public void removeVertexFromVSeq(InternalVertex v) {
    assert v != null;
  ...
  @Override public void removeEdgeFromESeq(InternalEdge e) {
    assert e != null;
  ...
  @Override public final boolean isEdgeListModified(long edgeListVersion) {
    return getEdgeListVersion() != edgeListVersion;
  }

  @Override public final boolean isGraphModified(long previousVersion) {
  ...
  @Override public final boolean isVertexListModified(long previousVersion) {
    return getVertexListVersion() != previousVersion;
  }

  @Override public void internalLoadingCompleted(int[] firstIncidence, int[] nextIncidence) {
    ...
    for (int vId = 1; vId < getVertex().length; ++vId) {
      ...
      if (v != null) {
        ...
        while (eId != 0) {
          v.appendIncidenceToISeq(eId < 0 ? getRevEdge()[-eId] : getEdge()[eId]);
  ...
  @Override public final void putEdgeAfterInGraph(InternalEdge targetEdge, InternalEdge movedEdge) {
    assert (targetEdge != null) && targetEdge.isValid() && eSeqContainsEdge(targetEdge);
    assert (movedEdge != null) && movedEdge.isValid() && eSeqContainsEdge(movedEdge);
    ...
    if (movedEdge == getFirstEdgeInESeq()) {
      ...
      if (movedEdge == getLastEdgeInESeq()) {
  ...
  @Override public final void putVertexAfter(InternalVertex targetVertex, InternalVertex movedVertex) {
    assert (targetVertex != null) && targetVertex.isValid() && vSeqContainsVertex(targetVertex);
    assert (movedVertex != null) && movedVertex.isValid() && vSeqContainsVertex(movedVertex);
    ...
    if (movedVertex == getFirstVertexInVSeq()) {
      ...
      if (movedVertex == getLastVertexInVSeq()) {
  ...
  /**
	 ...
	 */
  @Override public final void putEdgeBeforeInGraph(InternalEdge targetEdge, InternalEdge movedEdge) {
    assert (targetEdge != null) && targetEdge.isValid() && eSeqContainsEdge(targetEdge);
    assert (movedEdge != null) && movedEdge.isValid() && eSeqContainsEdge(movedEdge);
    assert targetEdge != movedEdge;
  ...
  @Override public final void putVertexBefore(InternalVertex targetVertex, InternalVertex movedVertex) {
    assert (targetVertex != null) && targetVertex.isValid() && vSeqContainsVertex(targetVertex);
    assert (movedVertex != null) && movedVertex.isValid() && vSeqContainsVertex(movedVertex);
    assert targetVertex != movedVertex;
  ...
  @Override public final void setGraphVersion(long graphVersion) {
  ...
  @Override public final boolean setLoading(boolean isLoading) {
    boolean result = loading;
    loading = isLoading;
    return result;
  }

  @Override public final void vertexListModified() {
    setVertexListVersion(getVertexListVersion() + 1);
    setGraphVersion(getGraphVersion() + 1);
  }

  @Override public final Iterable<Vertex> vertices() {
    return new VertexIterable<Vertex>(this, null, null);
  }

  @Override public final Iterable<Vertex> vertices(VertexFilter<Vertex> filter) {
    return new VertexIterable<Vertex>(this, null, filter);
  }

  @Override public final Iterable<Vertex> vertices(VertexClass vertexClass) {
    return new VertexIterable<Vertex>(this, vertexClass, null);
  }

  @Override public final Iterable<Vertex> vertices(VertexClass vertexClass, VertexFilter<Vertex> filter) {
  ...
  @Override public final void sortVertices(Comparator<Vertex> comp) {
    if (getFirstVertexInVSeq() == null) {
      return;
    }
  ...
  @Override public Object getEnumConstant(EnumDomain enumDomain, String constantName) {
  ...
  @Override public Record createRecord(RecordDomain recordDomain, Map<String, Object> values) {
  ...
  @Override public final void sortEdges(Comparator<Edge> comp) {
    if (getFirstEdgeInESeq() == null) {
      return;
    }
  ...
  @Override public void addGraphChangeListener(GraphChangeListener l) {
    if (l == null) {
  ...
  @Override public void removeGraphChangeListener(GraphChangeListener l) {
    if (l == null) {
      throw new IllegalArgumentException("Listener must not be null");
    }
  ...
  @Override public void addGraphStructureChangedListener(GraphStructureChangedListener newListener) {
    ...
    if (newListener instanceof GraphStructureChangedListenerWithAutoRemove) {
      ...
      graphStructureChangedListenersWithAutoRemoval.add(new WeakReference<GraphStructureChangedListener>(newListener));
    } else {
      graphStructureChangedListeners.add(newListener);
    }
  }

  @Override public final void removeGraphStructureChangedListener(GraphStructureChangedListener listener) {
    ...
    if (listener instanceof GraphStructureChangedListenerWithAutoRemove) {
      ...
      while ((iterator != null) && iterator.hasNext()) {
        GraphStructureChangedListener currentListener = iterator.next().get();
  ...
  @Override public final void removeAllGraphStructureChangedListeners() {
    graphStructureChangedListenersWithAutoRemoval = null;
    graphStructureChangedListeners.clear();
  }

  @Override public final int getGraphStructureChangedListenerCount() {
    return graphStructureChangedListenersWithAutoRemoval == null ? graphStructureChangedListeners.size() : graphStructureChangedListenersWithAutoRemoval.size() + graphStructureChangedListeners.size();
  }

  private final Iterator<WeakReference<GraphStructureChangedListener>> getListenerListIteratorForAutoRemove() {
    return graphStructureChangedListenersWithAutoRemoval != null ? graphStructureChangedListenersWithAutoRemoval.iterator() : null;
  }

  private final Iterator<GraphStructureChangedListener> getListenerListIterator() {
    return graphStructureChangedListeners != null ? graphStructureChangedListeners.iterator() : null;
  }

  @Override public final void notifyVertexDeleted(Vertex v) {
    assert (v != null) && v.isValid() && vSeqContainsVertex(v);
    if (graphStructureChangedListenersWithAutoRemoval != null) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = getListenerListIteratorForAutoRemove();
  ...
  @Override public final void notifyVertexAdded(Vertex v) {
    assert (v != null) && v.isValid() && vSeqContainsVertex(v);
    if (graphStructureChangedListenersWithAutoRemoval != null) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = getListenerListIteratorForAutoRemove();
      while (iterator.hasNext()) {
  ...
  @Override public final void notifyEdgeDeleted(Edge e) {
    assert (e != null) && e.isValid() && e.isNormal() && eSeqContainsEdge(e);
    if (graphStructureChangedListenersWithAutoRemoval != null) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = getListenerListIteratorForAutoRemove();
      while (iterator.hasNext()) {
        GraphStructureChangedListener currentListener = iterator.next().get();
  ...
  @Override public final void notifyEdgeAdded(Edge e) {
    assert (e != null) && e.isValid() && e.isNormal() && eSeqContainsEdge(e);
    if (graphStructureChangedListenersWithAutoRemoval != null) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = getListenerListIteratorForAutoRemove();
      while (iterator.hasNext()) {
  ...
  @Override public final void notifyMaxVertexCountIncreased(int newValue) {
    if (graphStructureChangedListenersWithAutoRemoval != null) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = getListenerListIteratorForAutoRemove();
      while (iterator.hasNext()) {
        GraphStructureChangedListener currentListener = iterator.next().get();
    ...
    int n = graphStructureChangedListeners.size();
    for (int i = 0; i < n; i++) {
      graphStructureChangedListeners.get(i).maxVertexCountIncreased(newValue);
    }
  }

  @Override public final void notifyMaxEdgeCountIncreased(int newValue) {
    if (graphStructureChangedListenersWithAutoRemoval != null) {
      Iterator<WeakReference<GraphStructureChangedListener>> iterator = getListenerListIteratorForAutoRemove();
      while (iterator.hasNext()) {
        GraphStructureChangedListener currentListener = iterator.next().get();
  ...
  @Override public final void save(String filename) throws GraphIOException {
    save(filename, null);
  }

  @Override public final void save(String filename, ProgressFunction pf) throws GraphIOException {
    GraphIO.saveGraphToFile(this, filename, pf);
  }

  @Override public final void save(DataOutputStream out) throws GraphIOException {
    save(out, null);
  }

  @Override public final void save(DataOutputStream out, ProgressFunction pf) throws GraphIOException {
    GraphIO.saveGraphToStream(this, out, pf);
  }

  @Override public final GraphFactory getGraphFactory() {
    return graphFactory;
  }

  @Override public final void setGraphFactory(GraphFactory graphFactory) {
    this.graphFactory = graphFactory;
  }

  @Override public boolean isInstanceOf(GraphClass cls) {
    return cls.getSchemaClass().isInstance(this);
  }

  @Override public final TraversalContext getTraversalContext() {
    return tc.get();
  }

  @Override public final TraversalContext setTraversalContext(TraversalContext tc) {
    TraversalContext oldTc = this.tc.get();
    this.tc.set(tc);
    return oldTc;
  }

  @Override public void loadingCompleted() {
  }

  @Override public void fireBeforeCreateVertex(VertexClass vc) {
  ...
  @Override public void fireAfterCreateVertex(Vertex v) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
  ...
  @Override public void fireBeforeDeleteVertex(Vertex v) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
  ...
  @Override public void fireAfterDeleteVertex(VertexClass vc, boolean finalDelete) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
  ...
  @Override public void fireBeforeCreateEdge(EdgeClass ec, Vertex alpha, Vertex omega) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
  ...
  @Override public void fireAfterCreateEdge(Edge e) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
  ...
  @Override public void fireBeforeDeleteEdge(Edge e) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
  ...
  @Override public void fireAfterDeleteEdge(EdgeClass ec, Vertex alpha, Vertex omega) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
  ...
  @Override public void fireBeforeChangeAttribute(AttributedElement<?, ?> element, String attributeName, Object oldValue, Object newValue) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
    for (int i = 0; i < n; ++i) {
      graphChangeListeners.get(i).beforeChangeAttribute(element, attributeName, oldValue, newValue);
    }
  }

  @Override public void fireAfterChangeAttribute(AttributedElement<?, ?> element, String attributeName, Object oldValue, Object newValue) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
    for (int i = 0; i < n; ++i) {
      graphChangeListeners.get(i).afterChangeAttribute(element, attributeName, oldValue, newValue);
    }
  }

  @Override public void fireBeforeChangeAlpha(Edge edge, Vertex oldVertex, Vertex newVertex) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
    for (int i = 0; i < n; ++i) {
      graphChangeListeners.get(i).beforeChangeAlpha(edge, oldVertex, newVertex);
    }
  }

  @Override public void fireAfterChangeAlpha(Edge edge, Vertex oldVertex, Vertex newVertex) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
    for (int i = 0; i < n; ++i) {
      graphChangeListeners.get(i).afterChangeAlpha(edge, oldVertex, newVertex);
    }
  }

  @Override public void fireBeforeChangeOmega(Edge edge, Vertex oldVertex, Vertex newVertex) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
    for (int i = 0; i < n; ++i) {
      graphChangeListeners.get(i).beforeChangeOmega(edge, oldVertex, newVertex);
    }
  }

  @Override public void fireAfterChangeOmega(Edge edge, Vertex oldVertex, Vertex newVertex) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
    for (int i = 0; i < n; ++i) {
      graphChangeListeners.get(i).afterChangeOmega(edge, oldVertex, newVertex);
    }
  }

  @Override public void fireBeforePutIncidenceBefore(Edge inc, Edge other) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
  ...
  @Override public void fireAfterPutIncidenceBefore(Edge inc, Edge other) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
  ...
  @Override public void fireBeforePutIncidenceAfter(Edge inc, Edge other) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
  ...
  @Override public void fireAfterPutIncidenceAfter(Edge inc, Edge other) {
    if (graphChangeListeners == null || loading) {
      return;
    }
    int n = graphChangeListeners.size();
