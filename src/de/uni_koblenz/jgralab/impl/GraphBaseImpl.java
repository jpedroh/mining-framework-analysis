...
=======
  @Override public GraphClass getAttributedElementClass() {
    return null;
  }
>>>>>>> /usr/src/app/output/jgralab/jgralab/7a018e9d43bc940e7e850dfd4c259a57166af59c/src/de/uni_koblenz/jgralab/impl/GraphBaseImpl.java/right.java



<<<<<<< Unknown file: This is a bug in JDime.
=======
  @Override public Class<? extends Graph> getSchemaClass() {
    return null;
  }
>>>>>>> /usr/src/app/output/jgralab/jgralab/7a018e9d43bc940e7e850dfd4c259a57166af59c/src/de/uni_koblenz/jgralab/impl/GraphBaseImpl.java/right.java
  ...
  @Override public int compareTo(AttributedElement<GraphClass, Graph> a) {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) @Override public <T extends Edge> T createEdge(EdgeClass ec, Vertex alpha, Vertex omega) {
    try {
  ...
  private void internalDeleteEdge(Edge edge) {
    ...
    edgeListModified();
    if (getECARuleManagerIfThere() != null) {
      getECARuleManagerIfThere().fireAfterDeleteEdgeEvents(e.getAttributedElementClass());
    }
  ...
  private void internalDeleteVertex() {
    while (!getDeleteVertexList().isEmpty()) {
      ...
      vertexListModified();
      if (getECARuleManagerIfThere() != null) {
        getECARuleManagerIfThere().fireAfterDeleteVertexEvents(v.getAttributedElementClass());
      }
