...
public abstract class GraphBaseImpl implements Graph, InternalGraph {
  ...
  @Override public GraphFactory getGraphFactory() {
    return graphFactory;
  }

  @Override public void setGraphFactory(GraphFactory graphFactory) {
    this.graphFactory = graphFactory;
  }

  @Override public boolean isInstanceOf(AttributedElementClass cls) {
