...
public abstract class GraphBaseImpl implements Graph, InternalGraph {
  ...
  @Override public Iterable<Vertex> vertices(VertexFilter<Vertex> filter) {
  ...
  @Override public Iterable<Vertex> vertices(VertexClass vertexClass, VertexFilter<Vertex> filter) {
