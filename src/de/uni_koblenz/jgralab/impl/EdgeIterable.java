...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/impl/EdgeIterable.java/right.java
    ...
    @SuppressWarnings(value = { "unchecked" }) EdgeIterator(InternalGraph g, Class<? extends Edge> ec) {
      graph = g;
      this.ec = ec;
    ...
    @SuppressWarnings(value = { "unchecked" }) EdgeIterator(InternalGraph g, EdgeClass ec) {
      graph = g;
      schemaEc = ec;
      edgeListVersion = g.getEdgeListVersion();
      current = (E) (ec == null ? graph.getFirstEdge() : graph.getFirstEdge(ec));
    ...
    @SuppressWarnings(value = { "unchecked" }) public E next() {
      ...
      E result = current;
      current = (E) (
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/impl/EdgeIterable.java/left.java
      ec == null ? current.getNextEdge() : current.getNextEdge(ec)
=======
      ec == null && schemaEc == null ? current.getNextEdge() : schemaEc == null ? current.getNextEdge(ec) : current.getNextEdge(schemaEc)
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/impl/EdgeIterable.java/right.java
      );
      return result;
    }
