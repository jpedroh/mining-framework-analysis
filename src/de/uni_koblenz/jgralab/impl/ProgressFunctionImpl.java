...
public final class ProgressFunctionImpl extends ConsoleProgressFunction {
	...
	@Deprecated
	/** replace by ConsoleProgressFunction() */
	public ProgressFunctionImpl() {
		super();
	}

	@Deprecated
	/** replace by ConsoleProgressFunction(int) */
	public ProgressFunctionImpl(int length) {
		super(length);
	}

	@Deprecated
	/** replace by ConsoleProgressFunction(PrintStream) */
	public ProgressFunctionImpl(PrintStream printStream) {
		super(printStream);
	}

	@Deprecated
	/** replace by ConsoleProgressFunction(PrintStream, int) */
