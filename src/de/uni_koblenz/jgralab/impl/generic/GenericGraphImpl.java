...
public class GenericGraphImpl extends GraphImpl {
  ...
  @SuppressWarnings(value = { "unchecked" }) public <T extends Vertex> T createVertex(VertexClass vc, int id) {
  ...
  @SuppressWarnings(value = { "unchecked" }) public <T extends Edge> T createEdge(EdgeClass ec, int id, Vertex alpha, Vertex omega) {
    try {
  ...
  @Override public void readAttributeValueFromString(String attributeName, String value) throws GraphIOException, NoSuchAttributeException {
    if ((attributes != null) && attributes.containsKey(attributeName)) {
      attributes.put(attributeName, aec.getAttribute(attributeName).getDomain().parseGenericAttribute(GraphIO.createStringReader(value, getSchema())));
      return;
    }
  ...
  @Override public String writeAttributeValueToString(String attributeName) throws IOException, GraphIOException, NoSuchAttributeException {
    ...
    aec.getAttribute(attributeName).getDomain().serializeGenericAttribute(io, getAttribute(attributeName));
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public <T extends java.lang.Object> T getAttribute(String name) throws NoSuchAttributeException {
    if ((attributes == null) || !attributes.containsKey(name)) {
      throw new NoSuchAttributeException(aec.getSimpleName() + " doesn\'t contain an attribute " + name);
    } else {
  ...
  @Override public <T extends Vertex> POrderedSet<T> reachableVertices(Vertex startVertex, String pathDescription, Class<T> vertexType) {
    throw new UnsupportedOperationException("This method is not supported by the generic implementation");
  }
