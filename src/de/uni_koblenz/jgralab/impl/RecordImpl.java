...
public class RecordImpl implements de.uni_koblenz.jgralab.Record {
  ...
  @Override public Object getComponent(String name) {
  ...
  @Override public void writeComponentValues(GraphIO io) throws IOException, GraphIOException {
  ...
  @Override public List<String> getComponentNames() {
  ...
  @Override public PMap<String, Object> toPMap() {
    return entries;
  }
}