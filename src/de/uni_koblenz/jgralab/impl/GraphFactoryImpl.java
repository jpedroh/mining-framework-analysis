...
||||||| /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/impl/GraphFactoryImpl.java/base.java
	protected HashMap<Class<? extends Edge>, Constructor<? extends Edge>> edgeMap;
=======
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/impl/GraphFactoryImpl.java/right.java
	...
	public Graph createGraph(Class<? extends Graph> graphClass, String id,
			int vMax, int eMax) {
		try {
			Graph g = graphConstructor.newInstance(id, vMax, eMax);
			return g;
		} catch (Exception ex) {
