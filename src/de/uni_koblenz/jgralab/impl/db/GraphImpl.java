 ...
 */
public abstract class GraphImpl extends GraphBaseImpl implements DatabasePersistableGraph {
  /**
  ...
  /**
	 ...
	 */
  protected GraphImpl(String id, GraphClass graphClass, GraphDatabase graphDatabase) {
  ...
  /**
	 ...
	 *            Database in which graph is persistent.
	 */
  protected GraphImpl(String id, int vMax, int eMax, GraphClass graphClass, GraphDatabase graphDatabase) {
    this(id, graphClass, vMax, eMax);
    if (graphDatabase != null) {
      containingDatabase = graphDatabase;
    } else {
      throw new GraphException("Cannot create a graph with database support with no database given.");
    }
  }
  ...
  @Override public void setGId(int gId) {
    this.gId = gId;
  }

  @Override public void setGraphVersion(long graphVersion) {
  ...
  @Override public void addVertex(int vId, long sequenceNumber) {
    vSeq.add(sequenceNumber, vId);
  }

  @Override public void addVertex(Vertex newVertex) {
  ...
  @Override public void addEdge(int eId, long sequenceNumber) {
  ...
  @Override public void addEdge(Edge newEdge, Vertex alpha, Vertex omega) {
    ...
    testEdgeSuitingVertices((InternalEdge) newEdge, (InternalVertex) alpha, (InternalVertex) omega);
    proceedWithAdditionOf(newEdge, alpha, omega);
  }

  private void assertPreConditionOfAddEdge(Edge newEdge, Vertex alpha, Vertex omega) {
    assert newEdge != null;
  ...
  private boolean isVertexValid(Vertex vertex) {
    return (vertex != null) && vertex.isValid() && vSeqContainsVertex(vertex);
  }

  private boolean isSameSchemaAsGraph(Edge edge, Vertex alpha, Vertex omega) {
    return (alpha.getSchema() == omega.getSchema()) && (alpha.getSchema() == getSchema()) && (edge.getSchema() == getSchema());
  }

  private boolean isGraphMatching(Edge edge, Vertex alpha, Vertex omega) {
    return (alpha.getGraph() == omega.getGraph()) && (alpha.getGraph() == this) && (edge.getGraph() == this);
  }

  private void testEdgeSuitingVertices(InternalEdge edge, InternalVertex alpha, InternalVertex omega) {
    if (!((VertexClass) alpha.getAttributedElementClass()).isValidFromFor((EdgeClass) edge.getAttributedElementClass())) {
      throw new GraphException("Edges of class " + edge.getAttributedElementClass().getQualifiedName() + " may not start at vertices of class " + alpha.getAttributedElementClass().getQualifiedName());
    }
    if (!((VertexClass) omega.getAttributedElementClass()).isValidToFor((EdgeClass) edge.getAttributedElementClass())) {
      throw new GraphException("Edges of class " + edge.getAttributedElementClass().getQualifiedName() + " may not end at vertices of class " + omega.getAttributedElementClass().getQualifiedName());
    }
  }
  ...
  private void testValidityOfLoadedEdge(Edge edge) {
    ...
    if (eId <= 0) {
      ...
      if (eId > eMax) {
        throw new GraphException("Edge\'s id " + eId + " is bigger than maximum capacity of edges allowed.");
      }
    }
  }
  ...
  private void addEdgeToIncidenceLists(EdgeImpl edge, VertexImpl alpha, VertexImpl omega) {
  ...
  @Override public void appendEdgeToESeq(InternalEdge edge) {
  ...
  @Override public <T extends Edge> T createEdge(EdgeClass ec, Vertex alpha, Vertex omega) {
  ...
  @Override public <T extends Vertex> T createVertex(VertexClass vc) {
  ...
  private void insertEdgeIntoDatabase(DatabasePersistableEdge edge, DatabasePersistableVertex alpha, DatabasePersistableVertex omega) {
    try {
  ...
  private void writeBackGraphAttribute(String attributeName) {
    try {
      ...
      exception.printStackTrace();
      throw new GraphException("Cannot write back graph attribute value.", exception);
    }
  }

  @Override public long getVertexListVersion() {
    return vSeq.getVersion();
  }

  @Override public long getEdgeListVersion() {
    return eSeq.getVersion();
  }

  @Override public void setVertexListVersion(long vertexListVersion) {
    vSeq.setVersion(vertexListVersion);
  }

  @Override public void setEdgeListVersion(long edgeListVersion) {
    eSeq.setVersion(edgeListVersion);
  }

  @Override public int getVCountInVSeq() {
    return vSeq.size();
  }

  @Override public int getECountInESeq() {
    return eSeq.size();
  }

  @Override public void setVCount(int count) {
    if (count > super.vMax) {
      expandVertexArray(count);
    }
  }

  @Override public void setECount(int count) {
    if (count > super.eMax) {
      expandEdgeArray(count);
    }
  }

  @Override public InternalVertex getFirstVertexInVSeq() {
    return vSeq.getFirst();
  }

  @Override public InternalEdge getFirstEdgeInESeq() {
    return eSeq.getFirst();
  }

  @Override public InternalVertex getLastVertexInVSeq() {
    return vSeq.getLast();
  }

  @Override public InternalEdge getLastEdgeInESeq() {
    return eSeq.getLast();
  }
  ...
  private DatabasePersistableVertex getVertexFromDatabase(int vId) {
    try {
      setLoading(true);
      DatabasePersistableVertex vertex = containingDatabase.getVertex(vId, this);
      setLoading(false);
      return vertex;
  ...
  @Override public void setFirstVertex(InternalVertex vertex) {
    if (vertex != null) {
  ...
  @Override public void setFirstEdgeInGraph(InternalEdge edge) {
    if (edge != null) {
  ...
  @Override public void setLastVertex(InternalVertex vertex) {
    if (vertex != null) {
      DatabasePersistableVertex persistentVertex = (DatabasePersistableVertex) vertex;
  ...
  @Override public void setLastEdgeInGraph(InternalEdge edge) {
    if (edge != null) {
      DatabasePersistableEdge persistentEdge = (DatabasePersistableEdge) edge;
  ...
  private void writeBackGraphId() {
    try {
      ...
      exception.printStackTrace();
      throw new GraphException("Cannot write back id of graph.", exception);
    }
  }
  ...
  private DatabasePersistableEdge getEdgeFromDatabase(int eId) {
    try {
      setLoading(true);
      DatabasePersistableEdge edge = containingDatabase.getEdge(eId, this);
      setLoading(false);
      return edge;
    } catch (Exception exception) {
      exception.printStackTrace();
  ...
  @Override public void deleteVertex(Vertex v) {
  ...
  /**
	 ...
	 */
  @Override public void vertexAfterDeleted(Vertex vertexToBeDeleted) {
  ...
  private void deleteVertexAndIncidentEdgesFromDatabase(DatabasePersistableVertex vertex) {
    try {
  ...
  @Override public void deleteEdge(Edge e) {
    super.deleteEdge(e);
  }

  @Override public void edgeAfterDeleted(Edge e, Vertex oldAlpha, Vertex oldOmega) {
    assert e != null;
  ...
  private void deleteEdgeFromDatabase(DatabasePersistableEdge edge) {
    try {
      ...
      exception.printStackTrace();
      throw new GraphException("Cannot delete edge " + edge.getId() + " in graph " + getId(), exception);
    }
  }

  @Override public void vertexListModified() {
    if (!isLoading()) {
      vSeq.modified();
      graphModified();
    }
  ...
  @Override public void edgeListModified() {
    if (!isLoading()) {
      eSeq.modified();
      graphModified();
    }
  ...
  @Override public void putVertexAfter(InternalVertex targetVertex, InternalVertex movedVertex) {
  ...
  @Override public void putEdgeAfterInGraph(InternalEdge targetEdge, InternalEdge movedEdge) {
  ...
  @Override public void putVertexBefore(InternalVertex targetVertex, InternalVertex movedVertex) {
    DatabasePersistableVertex targetVertexImpl = (DatabasePersistableVertex) targetVertex;
    DatabasePersistableVertex movedVertexImpl = (DatabasePersistableVertex) movedVertex;
    vSeq.putBefore(targetVertexImpl, movedVertexImpl);
  }

  @Override public void putEdgeBeforeInGraph(InternalEdge targetEdge, InternalEdge movedEdge) {
    assertEdges(movedEdge, targetEdge);
    DatabasePersistableEdge dbTargetEdge = (DatabasePersistableEdge) targetEdge;
    DatabasePersistableEdge dbMovedEdge = (DatabasePersistableEdge) movedEdge;
  ...
  @Override public boolean vSeqContainsVertex(Vertex v) {
    return (v != null) && (v.getGraph() == this) && vSeq.contains((DatabasePersistableVertex) v);
  }

  @Override public boolean eSeqContainsEdge(Edge e) {
    return (e != null) && (e.getGraph() == this) && eSeq.contains((DatabasePersistableEdge) e);
  }
  ...
  protected void writeIncidentVIdBack(DatabasePersistableIncidence incidence) {
    try {
      ...
      exception.printStackTrace();
      throw new GraphException("Cannot write id of incident vertex back.", exception);
    }
  }
  ...
  protected void writeSequenceNumberInESeqBack(DatabasePersistableEdge edge) {
    try {
      ...
      exception.printStackTrace();
      throw new GraphException("Cannot write number mapping edge\'s sequence in ESeq back.", exception);
    }
  }
  ...
  protected void writeSequenceNumberInLambdaSeqBack(DatabasePersistableIncidence incidence) {
    try {
      ...
      exception.printStackTrace();
      throw new GraphException("Cannot write incidence\'s number mapping it\'s sequence in LambdaSeq back.", exception);
    }
  }
  ...
  public void reorganizeVertexListInGraphDatabase() {
    try {
      ...
      exception.printStackTrace();
      throw new GraphException("VSeq of graph " + getId() + " could not be reorganized in database.", exception);
    }
  }
  ...
  public void reorganizeEdgeListInGraphDatabase() {
    try {
      ...
      exception.printStackTrace();
      throw new GraphException("ESeq of graph " + getId() + " could not be reorganized in database.", exception);
    }
  }
  ...
  public void reorganizeIncidenceListInDatabaseOf(DatabasePersistableVertex vertex) {
    try {
      ...
      long start = ((DatabasePersistableIncidence) firstIncidence).getSequenceNumberInLambdaSeq();
      containingDatabase.reorganizeIncidenceList(vertex, start);
    } catch (GraphDatabaseException exception) {
      exception.printStackTrace();
      throw new GraphException("Incidence list of vertex " + vertex.getId() + " in graph " + vertex.getGraph().getId() + " could not be reorganized in database.", exception);
    }
  }
  ...
  @Override public void delete() {
    try {
      ...
      throw new GraphException("Graph could not be deleted from database.", exception);
    }
  }
  ...
  @Override public FreeIndexList getFreeEdgeList() {
    return super.freeEdgeList;
  }

  @Override public FreeIndexList getFreeVertexList() {
    return super.freeVertexList;
  }

  @Override public void freeEdgeIndex(int index) {
    super.freeEdgeList.freeIndex(index);
  }

  @Override public void freeVertexIndex(int index) {
    super.freeVertexList.freeIndex(index);
  }

  @Override public int allocateEdgeIndex(int currentId) {
  ...
  @Override public int allocateVertexIndex(int currentId) {
  ...
  @Override public List<InternalVertex> getDeleteVertexList() {
    return deleteVertexList;
  }

  @Override public void setDeleteVertexList(List<InternalVertex> deleteVertexList) {
    this.deleteVertexList = deleteVertexList;
  }

  @Override public final boolean hasTransactionSupport() {
    return false;
  }
  ...
  @Override public boolean isInConflict() {
    throw new UnsupportedOperationException("Transactions are not supported for this graph.");
  }

  @Override public Transaction newReadOnlyTransaction() {
    throw new UnsupportedOperationException("Creation of read-only-transactions is not supported for this graph.");
  }

  @Override public Transaction newTransaction() {
    throw new UnsupportedOperationException("Creation of read-write-transactions is not supported for this graph.");
  }

  @Override public void restoreSavepoint(Savepoint savepoint) throws InvalidSavepointException {
    throw new UnsupportedOperationException("Definition of save-points is not supported for this graph.");
  }

  @Override public void setCurrentTransaction(Transaction transaction) {
    throw new UnsupportedOperationException("Transactions are not supported for this graph.");
  }

  @Override public Savepoint defineSavepoint() {
    throw new UnsupportedOperationException("Definition of save-points is not supported for this graph.");
  }
  ...
  @Override public InternalVertex[] getVertex() {
    throw new UnsupportedOperationException("Operation not supported by this graph.");
  }

  @Override public InternalEdge[] getEdge() {
    throw new UnsupportedOperationException("Operation not supported by this graph.");
  }

  @Override public ReversedEdgeBaseImpl[] getRevEdge() {
    throw new UnsupportedOperationException("Operation not supported by this graph.");
  }

  @Override public void setVertex(InternalVertex[] vertex) {
    throw new UnsupportedOperationException("Operation not supported by this graph.");
  }

  @Override public void setEdge(InternalEdge[] edge) {
    throw new UnsupportedOperationException("Operation not supported by this graph.");
  }

  @Override public void setRevEdge(InternalEdge[] revEdge) {
    throw new UnsupportedOperationException("Operation not supported by this graph.");
  }

  @Override public void abort() {
    throw new UnsupportedOperationException("Abort is not supported for this graph.");
  }

  @Override public void commit() throws CommitFailedException {
    throw new UnsupportedOperationException("Commit is not supported for this graph.");
  }

  @Override public void defragment() {
    throw new UnsupportedOperationException("Defragment is not supported by this graph.");
  }

  @Override public void internalLoadingCompleted(int[] firstIncidence, int[] nextIncidence) {
    throw new UnsupportedOperationException("Operation is not supported by this graph.");
  }

  @Override public TraversalContext getTraversalContext() {
    return tc;
  }

  @Override public TraversalContext setTraversalContext(TraversalContext tc) {
