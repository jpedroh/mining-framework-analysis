...
public abstract class EdgeBaseImpl extends IncidenceImpl implements Edge, InternalEdge {
  ...
  @Override public void setAlpha(Vertex alpha) {
    ...
    if (!graph.isLoading() && graph.getECARuleManagerIfThere() != null) {
      graph.getECARuleManager().fireBeforeChangeAlphaOfEdgeEvents(this, oldAlpha, alphaBase);
    }
  ...
  @Override public void setOmega(Vertex omega) {
    ...
    if (!graph.isLoading() && graph.getECARuleManagerIfThere() != null) {
      graph.getECARuleManager().fireBeforeChangeOmegaOfEdgeEvents(this, oldOmgea, omegaBase);
    }
  ...
  @Override public String toString() {
    assert isValid();
    return "+e" + getId() + ": " + getAttributedElementClass().getQualifiedName();
  }
