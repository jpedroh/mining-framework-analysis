...
public abstract class EdgeBaseImpl extends IncidenceImpl implements Edge, EdgeBase {
  ...
  @Override public String getThisRole() {
    assert isValid();
    return ((EdgeClass) getAttributedElementClass()).getFrom().getRolename();
  }
  ...
  @Override public void setAlpha(Vertex alpha) {
    ...
    if (
<<<<<<< /usr/src/app/output/jgralab/jgralab/a8bafd4f90fa457bf483902bb3e12777124b605c/src/de/uni_koblenz/jgralab/impl/EdgeBaseImpl.java/left.java
    !this.graph.isLoading() && this.graph.getECARuleManagerIfThere() != null
=======
    !graph.isLoading()
>>>>>>> /usr/src/app/output/jgralab/jgralab/a8bafd4f90fa457bf483902bb3e12777124b605c/src/de/uni_koblenz/jgralab/impl/EdgeBaseImpl.java/right.java
    ) {
      graph.getECARuleManager().
<<<<<<< /usr/src/app/output/jgralab/jgralab/a8bafd4f90fa457bf483902bb3e12777124b605c/src/de/uni_koblenz/jgralab/impl/EdgeBaseImpl.java/left.java
      getECARuleManagerIfThere().fireBeforeChangeAlphaOfEdgeEvents(this, oldAlpha, alpha)
=======
      fireBeforeChangeAlphaOfEdgeEvents(this, oldAlpha, alphaBase)
>>>>>>> /usr/src/app/output/jgralab/jgralab/a8bafd4f90fa457bf483902bb3e12777124b605c/src/de/uni_koblenz/jgralab/impl/EdgeBaseImpl.java/right.java
      ;
    }
    ...
    if (!alphaBase.isValidAlpha(this)) {
      throw new GraphException("Edges of class " + getAttributedElementClass().getUniqueName() + " may not start at vertices of class " + alphaBase.getAttributedElementClass().getUniqueName());
    }
    ...
    if (!graph.isLoading()) {
      graph.getECARuleManager().fireAfterChangeAlphaOfEdgeEvents(this, oldAlpha, alphaBase);
    }
  }
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/a8bafd4f90fa457bf483902bb3e12777124b605c/src/de/uni_koblenz/jgralab/impl/EdgeBaseImpl.java/right.java
      ...
      graph.getECARuleManager().
<<<<<<< /usr/src/app/output/jgralab/jgralab/a8bafd4f90fa457bf483902bb3e12777124b605c/src/de/uni_koblenz/jgralab/impl/EdgeBaseImpl.java/left.java
      getECARuleManagerIfThere().fireBeforeChangeOmegaOfEdgeEvents(this, oldOmgea, omega)
=======
      fireBeforeChangeOmegaOfEdgeEvents(this, oldOmgea, omegaBase)
>>>>>>> /usr/src/app/output/jgralab/jgralab/a8bafd4f90fa457bf483902bb3e12777124b605c/src/de/uni_koblenz/jgralab/impl/EdgeBaseImpl.java/right.java
      ;
    }
    ...
    if (!omegaBase.isValidOmega(this)) {
      throw new GraphException("Edges of class " + getAttributedElementClass().getUniqueName() + " may not end at at vertices of class " + omegaBase.getAttributedElementClass().getUniqueName());
    }
    ...
    if (!graph.isLoading()) {
      graph.getECARuleManager().fireAfterChangeOmegaOfEdgeEvents(this, oldOmgea, omegaBase);
    }
  }
