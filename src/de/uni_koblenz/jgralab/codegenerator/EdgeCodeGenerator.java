...
public class EdgeCodeGenerator extends AttributedElementCodeGenerator<EdgeClass, Edge> {
  ...
  @Override protected CodeBlock createSpecialConstructorCode() {
  ...
  private CodeBlock createGetAlphaOmegaOverrides() {
    ...
    EdgeClass ec = 
<<<<<<< /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/EdgeCodeGenerator.java/left.java
    (EdgeClass) aec
=======
    aec
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/EdgeCodeGenerator.java/right.java
    ;
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/EdgeCodeGenerator.java/right.java
  ...
  private CodeBlock createNextEdgeMethod(EdgeClass ec) {
    ...
    code.setVariable("ecQualifiedName", schemaRootPackageName + "." + ec.getQualifiedName());
    ...
    if (currentCycle.isStdOrDbImplOrTransImpl()) {
      code.add("public #ecQualifiedName# getNext#ecCamelName#InGraph(#formalParams#) {", "\treturn (#ecQualifiedName#)getNextEdge(#ecQualifiedName#.class#actualParams#);", "}");
    }
    return code;
  }
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/EdgeCodeGenerator.java/right.java
  ...
  private CodeBlock createNextIncidenceMethod(EdgeClass ec, boolean withOrientation) {
    ...
    if (currentCycle.isStdOrDbImplOrTransImpl()) {
      code.add("public #ecQualifiedName# getNext#ecCamelName#Incidence(#formalParams#) {", "\treturn (#ecQualifiedName#)getNextIncidence(#ecQualifiedName#.class#actualParams#);", "}");
    }
    return code;
  }
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/EdgeCodeGenerator.java/right.java
    ...
    if ((ec.getTo().getAggregationKind() == AggregationKind.COMPOSITE) || (ec.getFrom().getAggregationKind() == AggregationKind.COMPOSITE)) {
      ...
      if ((ec.getTo().getAggregationKind() == AggregationKind.SHARED) || (ec.getFrom().getAggregationKind() == AggregationKind.SHARED)) {
        val = "SHARED";
      }
    }
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/EdgeCodeGenerator.java/right.java
  ...
  @Override protected CodeBlock createAttributedElementClassConstant() {
    return new CodeSnippet(true, "public static final #jgSchemaPackage#.#schemaElementClass# EC" + " = #schemaPackageName#.#schemaName#.instance().#schemaVariableName#;");
  }
