...
public class ReversedEdgeCodeGenerator extends AttributedElementCodeGenerator {
  ...
  @Override protected CodeBlock createGenericGetter(Set<Attribute> attrSet) {
    return null;
  }

  @Override protected CodeBlock createGenericSetter(Set<Attribute> attrSet) {
    return null;
  }
  ...
  private CodeBlock createNextEdgeMethods() {
    ...
    TreeSet<
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/codegenerator/ReversedEdgeCodeGenerator.java/left.java
    AttributedElementClass
=======
    AttributedElementClass<?, ?>
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/codegenerator/ReversedEdgeCodeGenerator.java/right.java
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/codegenerator/ReversedEdgeCodeGenerator.java/right.java
  ...
  private CodeBlock createNextIncidenceMethod(EdgeClass ec, boolean withOrientation) {
    CodeSnippet code = new CodeSnippet(true, "public #ecName# getNext#ecCamelName#Incidence(#formalParams#) {", "\treturn (#ecName#)getNextIncidence(#ecName#.class#actualParams#);", "}");
    code.setVariable("ecName", schemaRootPackageName + "." + ec.getQualifiedName());
    code.setVariable("ecCamelName", camelCase(ec.getUniqueName()));
  ...
  @Override protected CodeBlock createFields(Set<Attribute> attrSet) {
    return null;
  }
  ...
  @Override protected CodeBlock createReadAttributesFromStringMethod(Set<Attribute> attrSet) {
    CodeList code = new CodeList();
  ...
  @Override protected CodeBlock createWriteAttributeToStringMethod(Set<Attribute> attrSet) {
    CodeList code = new CodeList();
    addImports("#jgPackage#.GraphIO", "#jgPackage#.GraphIOException");
  ...
  @Override protected CodeBlock createReadAttributesMethod(SortedSet<Attribute> attrSet) {
    CodeList code = new CodeList();
    addImports("#jgPackage#.GraphIO", "#jgPackage#.GraphIOException");
  ...
  @Override protected CodeBlock createWriteAttributesMethod(Set<Attribute> attrSet) {
    CodeList code = new CodeList();
  ...
  @Override protected CodeBlock createGetVersionedAttributesMethod(SortedSet<Attribute> attributeList) {
    if (currentCycle.isTransImpl()) {
