...
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/SchemaCodeGenerator.java/right.java
    , " */", "static WeakReference<#simpleClassName#> theInstance = new WeakReference<#simpleClassName#>(null);", "", "/**", " * @return the singleton instance of #simpleClassName#", " */", "public static synchronized #simpleClassName# instance() {", "\t#simpleClassName# s = theInstance.get();", "\tif (s != null) {", "\t\treturn s;", "\t}", 
<<<<<<< /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/SchemaCodeGenerator.java/left.java
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/SchemaCodeGenerator.java/right.java
    , "\t\tif (s != null) {", "\t\t\treturn s;", "\t\t}", "\t\ts = new #simpleClassName#();", "\t\ttheInstance = new WeakReference<#simpleClassName#>(s);", "\treturn s;", "}", "", "/**", " * Creates a #simpleClassName# and builds its schema classes.", " * This constructor is private. Use the <code>instance()</code> method", " * to access the schema.", " */", "private #simpleClassName#() {", "\tsuper(\"#simpleClassName#\", \"#schemaPackage#\");"));
...
=======
    code.setVariable("vcVariable", gc.getDefaultVertexClass().getVariableName());
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/SchemaCodeGenerator.java/right.java


<<<<<<< Unknown file: This is a bug in JDime.
=======
    code.setVariable("ecVariable", gc.getDefaultEdgeClass().getVariableName());
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/SchemaCodeGenerator.java/right.java
    ...
    code.addNoIndent(new CodeSnippet(true, "{", "\tGraphClass #gcVariable# = #schemaVariable# = createGraphClass(\"#gcName#\");", "\t#vcVariable# = #gcVariable#.getDefaultVertexClass();", "\t#ecVariable# = #gcVariable#.getDefaultEdgeClass();"));
