...
public abstract class CodeGenerator {
  ...
  public CodeGenerator(String schemaRootPackageName, String packageName, CodeGeneratorConfiguration config) {
    ...
    if ((packageName != null) && !packageName.equals("")) {
      ...
      rootBlock.setVariable("schemaImplDbPackage", schemaRootPackageName + ".impl.db." + packageName);
    } else {
      ...
      rootBlock.setVariable("schemaImplDbPackage", schemaRootPackageName + ".impl.db");
    }
    ...
    while (currentCycle != null) {
      ...
      if (currentCycle.isStdOrDbImplOrTransImpl()) {
        ...
        if (currentCycle.isDbImpl()) {
          schemaImplPackage = rootBlock.getVariable("schemaImplDbPackage");
