...
public class AttributedElementCodeGenerator extends CodeGenerator {
  ...
  protected CodeBlock createAttributedElementClassConstant() {
    return new CodeSnippet(true, "static final #jgSchemaPackage#.AttributedElementClass ATTRIBUTED_ELEMENT_CLASS" + " = #schemaPackageName#.#schemaName#.instance().#schemaVariableName#;");
  }
  ...
  protected CodeBlock createGetAttributedElementClassMethod() {
    return new CodeSnippet(true, "public final #jgSchemaPackage#.#schemaElementClass# getAttributedElementClass() {", "\treturn #javaClassName#.ATTRIBUTED_ELEMENT_CLASS;", "}");
  }

  protected CodeBlock createGetSchemaClassMethod() {
    return new CodeSnippet(true, "public final java.lang.Class<? extends #jgPackage#.#graphElementClass#> getSchemaClass() {", "\treturn #javaClassName#.class;", "}");
  }
