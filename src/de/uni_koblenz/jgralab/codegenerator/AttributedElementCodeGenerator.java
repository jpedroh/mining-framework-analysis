...
<<<<<<< /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/AttributedElementCodeGenerator.java/left.java
/**
 * TODO add comment
 *
...
public abstract class AttributedElementCodeGenerator<SC extends AttributedElementClass<SC, IC>, IC extends AttributedElement<SC, IC>> extends CodeGenerator {
  ...
  /**
	 ...
	 * @return
	 */
  protected CodeBlock createGetVersionedAttributesMethod(List<Attribute> attributes) {
    CodeList code = new CodeList();
    if (currentCycle.isTransImpl()) {
      CodeSnippet codeSnippet = new CodeSnippet();
      codeSnippet.add("public java.util.Set<#jgTransPackage#.VersionedDataObject<?>> attributes() {");
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/codegenerator/AttributedElementCodeGenerator.java/right.java
