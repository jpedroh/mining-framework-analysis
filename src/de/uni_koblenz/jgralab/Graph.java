...
public interface Graph extends AttributedElement<GraphClass, Graph> {
  ...
  /**
	 ...
	 */
  public <T extends Vertex> POrderedSet<T> reachableVertices(Vertex startVertex, String pathDescription, Class<T> vertexType);
  ...
  /**
	 ...
	 */
  public void restoreSavepoint(Savepoint savepoint) throws InvalidSavepointException;
  ...
  public void save(String filename, ProgressFunction pf) throws GraphIOException;

  public void save(DataOutputStream out) throws GraphIOException;

  public void save(DataOutputStream out, ProgressFunction pf) throws GraphIOException;
