...
public class ECARuleManager implements ECARuleManagerInterface {
  ...
  @Override public void fireBeforeCreateVertexEvents(VertexClass vc) {
    if (beforeCreateVertexEvents == null) {
      return;
    }
  ...
  @Override public void fireAfterCreateVertexEvents(Vertex element) {
    if (afterCreateVertexEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
  ...
  @Override public void fireBeforeDeleteVertexEvents(Vertex element) {
    if (beforeDeleteVertexEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
  ...
  @Override public void fireAfterDeleteVertexEvents(VertexClass vc) {
    if (afterDeleteVertexEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
  ...
  @Override public void fireBeforeCreateEdgeEvents(EdgeClass elementClass) {
    if (beforeCreateEdgeEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
  ...
  @Override public void fireAfterCreateEdgeEvents(Edge element) {
    if (afterCreateEdgeEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
  ...
  @Override public void fireBeforeDeleteEdgeEvents(Edge element) {
    if (beforeDeleteEdgeEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
  ...
  @Override public void fireAfterDeleteEdgeEvents(EdgeClass ec, Vertex oldAlpha, Vertex oldOmega) {
    if (afterDeleteEdgeEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
  ...
  @Override public void fireBeforeChangeAlphaOfEdgeEvents(Edge element, Vertex oldVertex, Vertex newVertex) {
    if (beforeChangeAlphaOfEdgeEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
    ...
    for (int i = 0; i < max; i++) {
      beforeChangeAlphaOfEdgeEvents.get(i).fire(element, oldVertex, newVertex, EdgeEnd.ALPHA);
    }
    nestedTriggerCalls--;
  }

  @Override public void fireAfterChangeAlphaOfEdgeEvents(Edge element, Vertex oldVertex, Vertex newVertex) {
    if (afterChangeAlphaOfEdgeEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
    ...
    for (int i = 0; i < max; i++) {
      afterChangeAlphaOfEdgeEvents.get(i).fire(element, oldVertex, newVertex, EdgeEnd.ALPHA);
    }
    nestedTriggerCalls--;
  }

  @Override public void fireBeforeChangeOmegaOfEdgeEvents(Edge element, Vertex oldVertex, Vertex newVertex) {
    if (beforeChangeOmegaOfEdgeEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
    ...
    for (int i = 0; i < max; i++) {
      beforeChangeOmegaOfEdgeEvents.get(i).fire(element, oldVertex, newVertex, EdgeEnd.OMEGA);
    }
    nestedTriggerCalls--;
  }

  @Override public void fireAfterChangeOmegaOfEdgeEvents(Edge element, Vertex oldVertex, Vertex newVertex) {
    if (afterChangeOmegaOfEdgeEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
    ...
    for (int i = 0; i < max; i++) {
      afterChangeOmegaOfEdgeEvents.get(i).fire(element, oldVertex, newVertex, EdgeEnd.OMEGA);
    }
    nestedTriggerCalls--;
  }

  @Override public <AEC extends AttributedElementClass<AEC, ?>> void fireBeforeChangeAttributeEvents(AttributedElement<AEC, ?> element, String attributeName, Object oldValue, Object newValue) {
    if (beforeChangeAttributeEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
    ...
    for (int i = 0; i < max; i++) {
      @SuppressWarnings(value = { "unchecked" }) ChangeAttributeEventDescription<AEC> ed = (ChangeAttributeEventDescription<AEC>) beforeChangeAttributeEvents.get(i);
      ed.fire(element, attributeName, oldValue, newValue);
    }
    nestedTriggerCalls--;
  }

  @Override public <AEC extends AttributedElementClass<AEC, ?>> void fireAfterChangeAttributeEvents(AttributedElement<AEC, ?> element, String attributeName, Object oldValue, Object newValue) {
    if (afterChangeAttributeEvents == null) {
      return;
    }
    if (increaseAndTestOnMaximumNestedCalls()) {
    ...
    for (int i = 0; i < max; i++) {
      @SuppressWarnings(value = { "unchecked" }) ChangeAttributeEventDescription<AEC> ed = (ChangeAttributeEventDescription<AEC>) afterChangeAttributeEvents.get(i);
      ed.fire(element, attributeName, oldValue, newValue);
    }
    nestedTriggerCalls--;
  }
  ...
  @Override public int getMaxNestedTriggerCalls() {
    return maxNestedTriggerCalls;
  }

  @Override public void setMaxNestedTriggerCalls(int maxNestedTriggerCalls) {
    this.maxNestedTriggerCalls = maxNestedTriggerCalls;
  }

  @Override public int getNestedTriggerCalls() {
  ...
  private void addEventToList(ChangeEdgeEventDescription e) {
    if (e.getTime().equals(EventDescription.EventTime.BEFORE)) {
      if (e.getEdgeEnd().equals(EdgeEnd.ALPHA)) {
        ...
        if (e.getEdgeEnd().equals(EdgeEnd.OMEGA)) {
