...
<<<<<<< /usr/src/app/output/jgralab/jgralab/5cec4db29f49dc758f85bd1421d9a714457c9a7e/src/de/uni_koblenz/jgralab/eca/Condition.java/left.java
...
public class Condition {
  ...
  public boolean evaluate(Event event) {
    ...
    GreqlEvaluator greqlEvaluator = this.rule.getECARuleManager().getGreqlEvaluator();
    ...
    if (result instanceof Boolean) {
      ...
      throw new ECAException("Invalid Condition: \"" + this.conditionExpression + "\" evaluates to type " + Types.getGreqlTypeName(result) + " but the result has to be a Boolean.");
    }
  }
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/5cec4db29f49dc758f85bd1421d9a714457c9a7e/src/de/uni_koblenz/jgralab/eca/Condition.java/right.java
