...
public class ECAIO {
    ...
    if (ev instanceof CreateVertexEventDescription) {
      ...
      if (ev instanceof DeleteVertexEventDescription) {
        ...
        if (ev instanceof ChangeAttributeEventDescription) {
          return "updatedAttributeValue(" + getEventElementTypeString(ev) + ", " + ((ChangeAttributeEventDescription) ev).getConcernedAttribute() + ")";
        } else {
          if (ev instanceof ChangeEdgeEventDescription) {
            if (((ChangeEdgeEventDescription) ev).getEdgeEnd().equals(EdgeEnd.ALPHA)) {
              return "updatedStartVertex(" + getEventElementTypeString(ev) + ") ";
            } else {
              if (((ChangeEdgeEventDescription) ev).getEdgeEnd().equals(EdgeEnd.OMEGA)) {
                return "updatedEndVertex(" + getEventElementTypeString(ev) + ") ";
              } else {
                return "updatedStartOrEndVertex(" + getEventElementTypeString(ev) + ") ";
              }
            }
          } else {
  ...
  private String getEventElementTypeString(EventDescription ev) {
    ...
    if (ev.getContext().equals(EventDescription.Context.TYPE)) {
      nameOfGraphElementClass += ev.getType().getName().replace(schema.getPackagePrefix() + ".", "");
    }
  ...
  private void saveActionToStream(Action act) throws ECAIOException {
    ...
    if (act instanceof PrintAction) {
      ...
      if (act instanceof GretlTransformAction) {
      ...
      if (eventdestype.equals("createdVertex")) {
        ...
        if (eventdestype.equals("createdEdge")) {
          ...
          if (eventdestype.equals("updatedStartVertex")) {
            return finishChangeEdgeEventDescription(context, et, type, EdgeEnd.ALPHA);
          } else {
            if (eventdestype.equals("updatedEndVertex")) {
              return finishChangeEdgeEventDescription(context, et, type, EdgeEnd.OMEGA);
            } else {
              if (eventdestype.equals("updatedStartOrEndVertex")) {
                return finishChangeEdgeEventDescription(context, et, type, EdgeEnd.ANY);
              } else {
  ...
  /**
	 ...
	 * @throws ECAIOException
	 */
  private EventTime getEventTime(String eventTimeString) throws ECAIOException {
    EventTime eventTime;
    if (eventTimeString.equals("after")) {
      eventTime = EventTime.AFTER;
    } else {
      if (eventTimeString.equals("before")) {
  ...
  /**
	 ...
	 * @throws ECAIOException
	 */
  private EventDescription finishDeleteEdgeEventDescription(String context, EventTime eventTime, String qualNameOfGraphElementToMonitor) throws ECAIOException {
    if (context != null && qualNameOfGraphElementToMonitor == null) {
      return new DeleteEdgeEventDescription(eventTime, context);
    } else {
      if (context == null && qualNameOfGraphElementToMonitor != null) {
        return new DeleteEdgeEventDescription(eventTime, getAttributedElement(qualNameOfGraphElementToMonitor));
      } else {
  ...
  /**
	 ...
	 * @throws ECAIOException
	 */
  private EventDescription finishDeleteVertexEventDescription(String context, EventTime eventTime, String qualNameOfGraphElementToMonitor) throws ECAIOException {
    if (context != null && qualNameOfGraphElementToMonitor == null) {
      return new DeleteVertexEventDescription(eventTime, context);
    } else {
      if (context == null && qualNameOfGraphElementToMonitor != null) {
        return new DeleteVertexEventDescription(eventTime, getAttributedElement(qualNameOfGraphElementToMonitor));
      } else {
  ...
  /**
	 ...
	 * @throws ECAIOException
	 */
  private EventDescription finishChangeEdgeEventDescription(String context, EventTime eventTime, String qualNameOfGraphElementToMonitor, EdgeEnd edgeEnd) throws ECAIOException {
    if (context != null && qualNameOfGraphElementToMonitor == null) {
      return new ChangeEdgeEventDescription(eventTime, context);
    } else {
      if (context == null && qualNameOfGraphElementToMonitor != null) {
        return new ChangeEdgeEventDescription(eventTime, getAttributedElement(qualNameOfGraphElementToMonitor), edgeEnd);
      } else {
        throw new ECAIOException("It\'s necessary to give a context OR a type. Its an XOR. Found: context: \"" + context + "\" and type: \"" + qualNameOfGraphElementToMonitor + "\"");
      }
    }
  ...
  /**
	 ...
	 * @throws ECAIOException
	 */
  private EventDescription finishChangeAttributeEventDescription(String context, EventTime eventTime, String qualNameOfGraphElementToMonitor) throws ECAIOException {
    ...
    if (context != null && qualNameOfGraphElementToMonitor == null) {
      ...
      if (context == null && qualNameOfGraphElementToMonitor != null) {
        return new ChangeAttributeEventDescription(eventTime, getAttributedElement(qualNameOfGraphElementToMonitor), name);
      } else {
        throw new ECAIOException("It\'s necessary to give a context OR a type. Its an XOR. Found: context: \"" + context + "\" and type: \"" + qualNameOfGraphElementToMonitor + "\"");
      }
    }
  ...
  /**
	 ...
	 * @throws ECAIOException
	 */
  private EventDescription finishCreateEdgeEventDescription(String context, EventTime eventTime, String qualNameOfGraphElementToMonitor) throws ECAIOException {
    if (context != null && qualNameOfGraphElementToMonitor == null) {
      return new CreateEdgeEventDescription(eventTime, context);
    } else {
      if (context == null && qualNameOfGraphElementToMonitor != null) {
        return new CreateEdgeEventDescription(eventTime, getAttributedElement(qualNameOfGraphElementToMonitor));
      } else {
        throw new ECAIOException("It\'s necessary to give a context OR a type. Its an XOR. Found: context: \"" + context + "\" and type: \"" + qualNameOfGraphElementToMonitor + "\"");
      }
    }
  ...
  /**
	 ...
	 * @throws ECAIOException
	 */
  private EventDescription finishCreateVertexEvent(String context, EventTime eventTime, String qualNameOfGraphElementToMonitor) throws ECAIOException {
    if (context != null && qualNameOfGraphElementToMonitor == null) {
      return new CreateVertexEventDescription(eventTime, context);
    } else {
      if (context == null && qualNameOfGraphElementToMonitor != null) {
        return new CreateVertexEventDescription(eventTime, getAttributedElement(qualNameOfGraphElementToMonitor));
      } else {
        throw new ECAIOException("It\'s necessary to give a context OR a type. Its an XOR. Found: context: \"" + context + "\" and type: \"" + qualNameOfGraphElementToMonitor + "\"");
      }
    }
  ...
  private Condition parseCondition() throws ECAIOException {
    ...
    if (isMatching(currentToken, "do")) {
      ...
      if (isMatching(currentToken, "with")) {
  ...
  /**
	 ...
	 * @throws ECAIOException
	 */
  @SuppressWarnings(value = { "unchecked" }) private Action parseAction() throws ECAIOException {
    String currentToken = nextToken();
    if (isMatching("print", currentToken)) {
      ...
      try {
        ...
        if (actionclass.getSuperclass().equals(Transformation.class)) {
          return new GretlTransformAction((Class<? extends Transformation<Graph>>) actionclass);
        } else {
