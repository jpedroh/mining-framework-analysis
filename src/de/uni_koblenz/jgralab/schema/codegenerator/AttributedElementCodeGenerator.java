...
public abstract class AttributedElementCodeGenerator<SC extends AttributedElementClass<SC, IC>, IC extends AttributedElement<SC, IC>> extends CodeGenerator {
  ...
  protected AttributedElementCodeGenerator(SC attributedElementClass, String schemaRootPackageName, CodeGeneratorConfiguration config) {
    ...
    rootBlock.setVariable("qualifiedImplClassName", schemaRootPackageName + ".impl.std" + aec.getQualifiedName() + "Impl");
  ...
  @Override protected CodeBlock createHeader() {
    ...
    code.setVariable("classOrInterface", currentCycle.isStdOrDiskv2Impl() ? " class" : " interface");
    code.setVariable("abstract", currentCycle.isStdOrDiskv2Impl() && aec.isAbstract() ? " abstract" : "");
    code.setVariable("impl", currentCycle.isStdOrDiskv2Impl() && !aec.isAbstract() ? "Impl" : "");
    code.add("public#abstract##classOrInterface# #simpleClassName##impl##extends##implements# {");
    code.setVariable("extends", currentCycle.isStdOrDiskv2Impl() ? " extends #baseClassName#" : "");
    StringBuilder buf = new StringBuilder();
    if (interfaces.size() > 0) {
      String delim = currentCycle.isStdOrDiskv2Impl() ? " implements " : " extends ";
      for (String interfaceName : interfaces) {
        if (currentCycle.isStdOrDiskv2Impl() || !interfaceName.equals(aec.getQualifiedName())) {
  ...
  protected CodeBlock createSetter(Attribute attr) {
    ...
    code.setVariable("graphRef", aec.getClass() == GraphClassImpl.class ? "" : "graph.");
    switch (currentCycle) {
      case ABSTRACT:
      code.add("public void set_#name#(#type# _#name#);");
      break;
      case STDIMPL:
      code.add("public void set_#name#(#type# _#name#) {", "\t#graphRef#fireBeforeChangeAttribute(this, \"#name#\", this._#name#, _#name#);", "\tObject oldValue = this._#name#;", "\tthis._#name# = _#name#;", "\tgraphModified();", "\t#graphRef#fireAfterChangeAttribute(this, \"#name#\", oldValue, _#name#);", "}");
      break;
      case DISKV2IMPL:
      code.add("public void set_#name#(#type# _#name#) {", 
<<<<<<< /usr/src/app/output/jgralab/jgralab/fbd9a0ffd885f02b80fbd72715848d2f0d5c0bc9/src/de/uni_koblenz/jgralab/schema/codegenerator/AttributedElementCodeGenerator.java/left.java
      "\t#graphRef#fireBeforeChangeAttribute(this, \"#name#\", this._#name#, _#name#);"
=======
      "\tecaAttributeChanging(\"#name#\", this._#name#, _#name#);"
>>>>>>> /usr/src/app/output/jgralab/jgralab/fbd9a0ffd885f02b80fbd72715848d2f0d5c0bc9/src/de/uni_koblenz/jgralab/schema/codegenerator/AttributedElementCodeGenerator.java/right.java
      , "\tObject oldValue = this._#name#;", "\tthis._#name# = _#name#;", "\tgraphModified();", 
<<<<<<< /usr/src/app/output/jgralab/jgralab/fbd9a0ffd885f02b80fbd72715848d2f0d5c0bc9/src/de/uni_koblenz/jgralab/schema/codegenerator/AttributedElementCodeGenerator.java/left.java
