...
<<<<<<< /usr/src/app/output/jgralab/jgralab/00f790a8e86ecd1765a5ea9bbd0426397803b9e8/src/de/uni_koblenz/jgralab/schema/codegenerator/AttributedElementCodeGenerator.java/left.java
      code.add("public void set_#name#(#type# _#name#) {", "\tecaAttributeChanging(\"#name#\", this._#name#, _#name#);", "\tObject oldValue = this._#name#;", "\tthis._#name# = _#name#;", "\tgraphModified();", "\tecaAttributeChanged(\"#name#\", oldValue, _#name#);", "\tattributeChanged();", "}");
=======
