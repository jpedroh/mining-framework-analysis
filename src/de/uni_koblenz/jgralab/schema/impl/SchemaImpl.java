...
public class SchemaImpl implements Schema {
  ...
  static final Class<?>[] GRAPHCLASS_CREATE_SIGNATURE = { String.class, int.class, int.class };
  ...
  @Override public Method getGraphCreateMethod(ImplementationType implementationType) {
    if (implementationType != ImplementationType.GENERIC) {
      ...
      return getCreateMethod(graphClass.getSimpleName(), graphClass.getSimpleName(), new Class[] { GraphClass.class, String.class, int.class, int.class }, implementationType);
    }
  }
  ...
  @Override public Graph createGraph(ImplementationType implementationType, int vCount, int eCount) {
    return createGraph(implementationType, null, vCount, eCount);
  }

  @Override public Graph createGraph(ImplementationType implementationType, String id, int vCount, int eCount) {
    if (implementationType != ImplementationType.GENERIC) {
      try {
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/141d83b74b0c4798cfca554834a0b1645b4dd1b5/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
      if (implementationType != ImplementationType.GENERIC) {
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/141d83b74b0c4798cfca554834a0b1645b4dd1b5/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
    } catch (Exception e) {
