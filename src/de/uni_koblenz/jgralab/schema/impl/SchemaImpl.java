...
=======
  DirectedAcyclicGraph<Domain>
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
   domainsDag = new DirectedAcyclicGraph<Domain>();
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
  ...
  /**
	 ...
	 */
  private Map<String, 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
  AttributedElementClass
=======
  AttributedElementClass<?, ?>
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
  > duplicateSimpleNames = new HashMap<String, 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
  AttributedElementClass
=======
  AttributedElementClass<?, ?>
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
  ...
  void addDomain(Domain dom) {
    assert !domains.containsKey(dom.getQualifiedName()) : "There already is a Domain with the qualified name: " + dom.getQualifiedName() + " in the Schema!";
    domains.put(dom.getQualifiedName(), dom);
  }

  void addPackage(PackageImpl pkg) {
    assert !packages.containsKey(pkg.getQualifiedName()) : "There already is a Package with the qualified name \'" + pkg.getQualifiedName() + "\' in the Schema!";
    packages.put(pkg.getQualifiedName(), pkg);
  }

  void addNamedElement(NamedElement namedElement) {
    assert !namedElements.containsKey(namedElement.getQualifiedName()) : "You are trying to add the NamedElement \'" + namedElement.getQualifiedName() + "\' to this Schema, but that does already exist!";
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
      AttributedElementClass other = duplicateSimpleNames.get(aec.getSimpleName());
=======
      AttributedElementClass<?, ?> other = duplicateSimpleNames.get(aec.getSimpleName());
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
  ...
  private void compileClasses(File schemaDir) throws IOException {
    ...
    Iterable<? extends JavaFileObject> compilationUnits = fileManager.getJavaFileObjectsFromFiles(getJavaFiles(schemaDir));
  ...
  @Override public Vector<InMemoryJavaSourceFile> commit(CodeGeneratorConfiguration config) {
    ...
    Vector<InMemoryJavaSourceFile> javaSources = new Vector<InMemoryJavaSourceFile>();
    CodeGenerator schemaCodeGenerator = new SchemaCodeGenerator(this, packagePrefix, config);
    javaSources.addAll(schemaCodeGenerator.createJavaSources());
    CodeGenerator factoryCodeGenerator = new GraphFactoryGenerator(this, packagePrefix, config);
  ...
  @Override public void compile(CodeGeneratorConfiguration config) {
    ...
    if (compiler == null) {
      throw new SchemaException("Cannot compile schema " + qualifiedName + ". Most probably you use a JRE instead of a JDK. " + "The JRE does not provide a compiler.");
    }
  ...
  @Override public Attribute createAttribute(String name, Domain dom, 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
    ...
    return 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
    new EnumDomainImpl(simpleName, parent, enumComponents)
=======
    ed
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
    ;
  ...
  Package createPackageWithParents(String qn) {
    ...
    assert (currentParent.getQualifiedName().isEmpty() ? currentParent == defaultPackage : true) : "The parent package of package \'" + pkgSimpleName + "\' is empty, but not the default package.";
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
    ...
    return 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
    new RecordDomainImpl(simpleName, parent, recordComponents)
=======
    rd
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
    ;
  ...
  @Override public boolean equals(Object other) {
    if (
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
    other == null || !(other instanceof Schema)
=======
    (other == null) || !(other instanceof Schema)
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
    ) {
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
  @Override public AttributedElementClass getAttributedElementClass(String qualifiedName) {
    if (graphClass == null) {
      return null;
    } else {
      if (graphClass.getQualifiedName().equals(qualifiedName)) {
        return graphClass;
      } else {
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
  @Override public List<CompositeDomain> getCompositeDomainsInTopologicalOrder() {
    ...
    while (!compositeDomainSet.isEmpty()) {
      for (Iterator<CompositeDomain> cdit = compositeDomainSet.iterator(); cdit.hasNext(); ) {
        cd = cdit.next();
        if (topologicalOrderList.containsAll(cd.getAllComponentCompositeDomains())) {
...
=======
        if (implementationType != ImplementationType.GENERIC) {
          return getClass().getMethod("create" + graphClassName, signature);
        } else {
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
  @Override public List<EdgeClass> getEdgeClassesInTopologicalOrder() {
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
    try {
      schemaClass = (Class<? extends Graph>) Class.forName(implClassName, true, SchemaClassManager.instance(qualifiedName));
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
  @Override public Method getGraphCreateMethod(ImplementationType implementationType) {
    return getCreateMethod(graphClass.getSimpleName(), graphClass.getSimpleName(), GRAPHCLASS_CREATE_SIGNATURE, implementationType);
  }
=======
>>>>>>> Unknown file: This is a bug in JDime.
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
  @Override public List<VertexClass> getVertexClassesInTopologicalOrder() {
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
    return getCreateMethod(vertexClassName, graphClass.getSimpleName(), VERTEX_CLASS_CREATE_SIGNATURE, implementationType);
=======
    if (implementationType != ImplementationType.GENERIC) {
      return getCreateMethod(vertexClassName, graphClass.getSimpleName(), VERTEX_CLASS_CREATE_SIGNATURE, implementationType);
    } else {
      return getCreateMethod(vertexClassName, graphClass.getSimpleName(), new Class[] { VertexClass.class, int.class }, implementationType);
    }
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
  }
  ...
  void setGraphClass(GraphClass gc) {
    if (graphClass != null) {
      throw new SchemaException("There already is a GraphClass named: " + graphClass.getQualifiedName() + "in the Schema!");
    }
    graphClass = gc;
  }
  ...
  @Override public GraphFactory createDefaultGraphFactory(ImplementationType implementationType) {
    if (implementationType != ImplementationType.GENERIC) {
      throw new IllegalArgumentException("Base implementation can\'t create a GraphFactory for implementation type " + implementationType + ". Only GENERIC is supported.");
    }
  ...
  , int eMax) {
    try {
      ...
      switch (implementationType) {
        ...
        break;
        default:
        throw new RuntimeException("FIXME: Unexpected implementation type " + implementationType);
      }
    }
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
    graphCreateMethod = getGraphCreateMethod(ImplementationType.STANDARD)
=======
    factory = createDefaultGraphFactory(implementationType)
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
    ;
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
    try {
      ...
      throw new SchemaException("Something failed when creating the  graph!", e);
    }
=======
