...
<<<<<<< /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Override public EnumDomain createEnumDomain(String qualifiedName, String... enumComponents) {
  ...
  protected PackageImpl createPackage(String sn, PackageImpl parentPkg) {
    this.assertNotFinished();
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
    this.domains
=======
    ArrayPSet.<Domain>empty().plusAll(domains.values())
>>>>>>> /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/right.java
    ;
  }
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
  @Override public List<EdgeClass> getEdgeClasses() {
    return this.graphClass.getEdgeClasses();
  }
=======
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @SuppressWarnings(value = { "unchecked" }) private Class<? extends Graph> getGraphClassImpl(ImplementationType implementationType) {
    ...
    if (implementationType != ImplementationType.GENERIC) {
      ...
      try {
        schemaClass = (Class<? extends Graph>) Class.forName(implClassName, true, SchemaClassManager.instance(this.qualifiedName));
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/schema/impl/SchemaImpl.java/left.java
  @Override public List<VertexClass> getVertexClasses() {
    return this.graphClass.getVertexClasses();
  }
=======
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Override public Method getVertexCreateMethod(String vertexClassName, ImplementationType implementationType) {
    if (implementationType != ImplementationType.GENERIC) {
      ...
      return this.getCreateMethod(vertexClassName, this.graphClass.getSimpleName(), new Class[] { VertexClass.class, int.class }, implementationType);
    }
  }
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  /**
	 ...
	 * finish
	 */
  @Override public boolean reopen() {
    if (!finished) {
      return false;
    }
    domainsDag.reopen();
