...
public class SchemaImpl implements Schema {
  ...
  @Override public Graph createGraph(ImplementationType implementationType, String id, int vCount, int eCount) {
    ...
    Method graphCreateMethod = implementationType != ImplementationType.GENERIC ? getGraphCreateMethod(implementationType) : getGraphCreateMethod(ImplementationType.GENERIC);
    try {
      if (implementationType != ImplementationType.GENERIC) {
        return (Graph) graphCreateMethod.invoke(implementationType, null, id, vCount, eCount);
      } else {
        return (Graph) graphCreateMethod.invoke(null, getGraphClass(), id, vCount, eCount);
      }
    } catch (Exception e) {
  ...
  @Override public Graph createGraph(GraphFactory factory) {
    return createGraph(factory, null, 100, 100);
  }

  @Override public Graph createGraph(GraphFactory factory, String id, int vCount, int eCount) {
    return null;
  }
