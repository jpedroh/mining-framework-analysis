...
=======
>>>>>>> Unknown file: This is a bug in JDime.
   PackageImpl(String simpleName, 
<<<<<<< /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/schema/impl/PackageImpl.java/left.java
  Package
=======
  PackageImpl
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/schema/impl/PackageImpl.java/right.java
   parentPackage, SchemaImpl schema) {
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/schema/impl/PackageImpl.java/right.java
  ...
  void addGraphClass(GraphClass gc) {
    if (!isDefaultPackage()) {
      throw new SchemaException("The GraphClass must be situated in the DefaultPackage.");
    }
    assert !graphClasses.containsKey(gc.getSimpleName()) && !graphClasses.containsValue(gc) : "This package (" + getQualifiedName() + ") already contains a graph class called " + gc.getSimpleName();
  ...
  @Override public boolean containsNamedElement(String sn) {
    return 
<<<<<<< /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/schema/impl/PackageImpl.java/left.java
    domains.containsKey(sn) || edgeClasses.containsKey(sn) || (isDefaultPackage() && (schema.getDefaultGraphClass() != null))
=======
    domains.containsKey(sn) || edgeClasses.containsKey(sn)
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/schema/impl/PackageImpl.java/right.java
  ...
  @Override public Map<String, EdgeClass> getEdgeClasses() {
    return edgeClasses;
  }

  @Override public Map<String, GraphClass> getGraphClasses() {
    return graphClasses;
  }
  ...
  @Override public Map<String, Package> getSubPackages() {
    return subPackages;
  }

  @Override public Map<String, VertexClass> getVertexClasses() {
