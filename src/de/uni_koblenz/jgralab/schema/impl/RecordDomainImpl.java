...
public class RecordDomainImpl extends CompositeDomainImpl implements RecordDomain {
  ...
  /**
	 ...
	 */
  protected RecordDomainImpl(String sn, PackageImpl pkg, Collection<RecordComponent> components) {
    super(sn, pkg);
    if (components != null) {
  ...
  @Override public void delete() {
    ...
    if (!attributes.isEmpty()) {
      throw new SchemaException("Cannot delete record domain that is still used by attributes: " + attributes);
    }
