...
public class EdgeClassImpl extends GraphElementClassImpl<EdgeClass, Edge> implements EdgeClass {
  ...
  /**
	 ...
	 *            unique way
	 */
  protected EdgeClassImpl(String simpleName, Package pkg, GraphClass aGraphClass, VertexClass from, int fromMin, int fromMax, String fromRoleName, AggregationKind aggrFrom, VertexClass to, int toMin, int toMax, String toRoleName, AggregationKind aggrTo) {
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/EdgeClassImpl.java/left.java
    from.addOutIncidenceClass(fromInc)
=======
    ((VertexClassImpl) from).addOutIncidenceClass(fromInc)
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/EdgeClassImpl.java/right.java
    ;
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/EdgeClassImpl.java/right.java
  ...
  @Override public IncidenceClass getFrom() {
    return from;
  }

  @Override public IncidenceClass getTo() {
    return to;
  }
  ...
  /**
	 ...
	 */
  public static void checkIncidenceClassSpecialization(IncidenceClass special, IncidenceClass general) {
  ...
  @Override @SuppressWarnings(value = { "unchecked" }) public Class<? extends Edge> getSchemaClass() {
