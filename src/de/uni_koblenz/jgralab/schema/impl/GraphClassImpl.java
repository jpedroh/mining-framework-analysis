...
public final class GraphClassImpl extends AttributedElementClassImpl<GraphClass, Graph> implements GraphClass {
  ...
  private Map<String, GraphElementClass<?, ?>> graphElementClasses = new HashMap<String, 
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/GraphClassImpl.java/right.java
  ...
  public String getDescriptionString() {
    ...
    Iterator<AttributedElementClass, GraphClass> it = getAllSubClasses().iterator();
    while (it.hasNext()) {
      output.append("\'" + ((GraphClassImpl) it.next()).getQualifiedName() + "\' ");
    }
    output.append("\nsuperClasses of \'" + getQualifiedName() + "\': ");
    Iterator<AttributedElementClass, GraphClass> it2 = getAllSuperClasses().iterator();
    while (it2.hasNext()) {
...
=======
    GraphElementClass<?, ?>
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/schema/impl/GraphClassImpl.java/right.java
    > it3 = graphElementClasses.values().iterator();
    while (it3.hasNext()) {
