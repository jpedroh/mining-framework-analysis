...
public class VertexClassImpl extends GraphElementClassImpl implements VertexClass {
  ...
  @Override public Set<IncidenceClass> getAllInIncidenceClasses() {
    ...
    for (AttributedElementClass vc : getDirectSuperClasses()) {
      incidenceClasses.addAll(((VertexClass) vc).getAllInIncidenceClasses());
    }
  ...
  @Override public Set<IncidenceClass> getAllOutIncidenceClasses() {
    ...
    for (AttributedElementClass vc : getDirectSuperClasses()) {
      incidenceClasses.addAll(((VertexClass) vc).getAllOutIncidenceClasses());
    }
    return incidenceClasses;
  }
  ...
  @Override protected void finish() {
    ...
    for (AttributedElementClass vc : getDirectSuperClasses()) {
      this.allInIncidenceClasses.addAll(((VertexClass) vc).getAllInIncidenceClasses());
      this.allOutIncidenceClasses.addAll(((VertexClass) vc).getAllOutIncidenceClasses());
    }
