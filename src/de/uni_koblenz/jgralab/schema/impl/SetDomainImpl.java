...
public final class SetDomainImpl extends CollectionDomainImpl implements SetDomain {
  SetDomainImpl(Schema schema, Domain aBaseDomain) {
    super(SETDOMAIN_NAME + "<" + aBaseDomain.getTGTypeName(schema.getDefaultPackage()) + ">", schema.getDefaultPackage(), aBaseDomain);
  }
  ...
  @Override public String getJavaAttributeImplementationTypeName(String schemaRootPackagePrefix) {
    return SETDOMAIN_TYPE + "<" + baseDomain.getJavaClassName(schemaRootPackagePrefix) + ">";
  }
  ...
  private void internalGetReadMethod(CodeList code, String schemaRootPackagePrefix, String variableName, String graphIoVariableName) {
    ...
    code.setVariable("basetype", getBaseDomain().getJavaAttributeImplementationTypeName(schemaRootPackagePrefix));
    ...
    code.add(new CodeSnippet(SETDOMAIN_TYPE + "<#basedom#> $#name# = #empty#;"));
    ...
    code.add(getBaseDomain().getReadMethod(schemaRootPackagePrefix, "$" + variableName + "Element", graphIoVariableName), 1);
  ...
  private void internalGetWriteMethod(CodeList code, String schemaRootPackagePrefix, String variableName, String graphIoVariableName) {
    ...
    code.add(getBaseDomain().getWriteMethod(schemaRootPackagePrefix, code.getVariable("element"), graphIoVariableName), 1);
  ...
  @Override public String getTransactionJavaAttributeImplementationTypeName(String schemaRootPackagePrefix) {
    return SETDOMAIN_TYPE + "<" + baseDomain.getTransactionJavaClassName(schemaRootPackagePrefix) + ">";
  }
