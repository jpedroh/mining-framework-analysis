...
>>>>>>> Unknown file: This is a bug in JDime.
   SetDomainImpl(Schema schema, Domain aBaseDomain) {
    super(SETDOMAIN_NAME + "<" + aBaseDomain.getTGTypeName(schema.getDefaultPackage()) + ">", 
<<<<<<< /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/schema/impl/SetDomainImpl.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Override public String getJavaAttributeImplementationTypeName(String schemaRootPackagePrefix) {
    return SETDOMAIN_TYPE + "<" + this.baseDomain.getJavaClassName(schemaRootPackagePrefix) + ">";
  }
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/schema/impl/SetDomainImpl.java/right.java
    ...
    code.add(
<<<<<<< /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/schema/impl/SetDomainImpl.java/left.java
    this.getBaseDomain().getReadMethod(schemaRootPackagePrefix, "$" + variableName + "Element", graphIoVariableName)
=======
    getBaseDomain().getReadMethod(schemaRootPackagePrefix, "$" + variableName + "Element", graphIoVariableName)
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/schema/impl/SetDomainImpl.java/right.java
    , 1);
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/schema/impl/SetDomainImpl.java/left.java
    this.baseDomain.getTransactionJavaClassName(schemaRootPackagePrefix)
=======
    baseDomain.getTransactionJavaClassName(schemaRootPackagePrefix)
>>>>>>> /usr/src/app/output/jgralab/jgralab/8cef5d06ba740f3eaeac87876172c02a85a5819f/src/de/uni_koblenz/jgralab/schema/impl/SetDomainImpl.java/right.java
     + ">";
  }
