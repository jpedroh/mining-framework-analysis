...
public abstract class AttributedElementClassImpl extends NamedElementImpl implements AttributedElementClass {
  /**
  ...
  /**
	 ...
	 */
  protected AttributedElementClassImpl(String simpleName, Package pkg, Schema schema) {
  ...
  @Override public void addAttribute(Attribute anAttribute) {
    if (containsAttribute(anAttribute.getName())) {
      throw new DuplicateAttributeException(anAttribute.getName(), getQualifiedName());
    }
  ...
  @Override public Set<AttributedElementClass> getAllSubClasses() {
  ...
  @Override public Set<AttributedElementClass> getAllSuperClasses() {
  ...
  @Override public SortedSet<Attribute> getAttributeList() {
  ...
  @Override public Set<AttributedElementClass> getDirectSubClasses() {
    return directSubClasses;
  }

  @Override public Set<AttributedElementClass> getDirectSuperClasses() {
    return new HashSet<AttributedElementClass>(directSuperClasses);
  }

  @SuppressWarnings(value = { "unchecked" }) @Override public Class<? extends AttributedElement> getSchemaClass() {
    if (schemaClass == null) {
      String schemaClassName = getSchema().getPackagePrefix() + "." + getQualifiedName();
      try {
        schemaClass = (Class<? extends AttributedElement>) Class.forName(schemaClassName, true, SchemaClassManager.instance(getSchema().getQualifiedName()));
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public Class<? extends AttributedElement> getSchemaImplementationClass() {
    if (isAbstract()) {
    ...
    if (schemaImplementationClass == null) {
      try {
        ...
        schemaImplementationClass = (Class<? extends AttributedElement>) f.get(schemaClass);
  ...
  @Override public boolean isDirectSubClassOf(AttributedElementClass anAttributedElementClass) {
    return directSuperClasses.contains(anAttributedElementClass);
  }

  @Override public boolean isDirectSuperClassOf(AttributedElementClass anAttributedElementClass) {
    return (((AttributedElementClassImpl) anAttributedElementClass).directSuperClasses.contains(this));
  }

  @Override public boolean isInternal() {
    Schema s = getSchema();
    return ((this == s.getDefaultEdgeClass()) || (this == s.getDefaultGraphClass()) || (this == s.getDefaultVertexClass()));
  }

  @Override public boolean isSubClassOf(AttributedElementClass anAttributedElementClass) {
    return getAllSuperClasses().contains(anAttributedElementClass);
  }

  @Override public boolean isSuperClassOf(AttributedElementClass anAttributedElementClass) {
    return anAttributedElementClass.getAllSuperClasses().contains(this);
  }

  @Override public boolean isSuperClassOfOrEquals(AttributedElementClass anAttributedElementClass) {
...
public abstract class AttributedElementClassImpl<SC extends AttributedElementClass<SC, IC>, IC extends AttributedElement<SC, IC>> extends NamedElementImpl implements AttributedElementClass<SC, IC> {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public Class<IC> getSchemaClass() {
    if (schemaClass == null) {
      String schemaClassName = getSchema().getPackagePrefix() + "." + getQualifiedName();
      try {
        schemaClass = (Class<IC>) Class.forName(schemaClassName, true, SchemaClassManager.instance(getSchema().getQualifiedName()));
      } catch (ClassNotFoundException e) {
        throw new SchemaClassAccessException("Can\'t load (generated) schema class for AttributedElementClass \'" + getQualifiedName() + "\'", e);
      }
    }
