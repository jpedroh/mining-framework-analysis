...
public class MapDomainImpl extends CompositeDomainImpl implements MapDomain {
  ...
  protected MapDomainImpl(Schema schema, Domain aKeyDomain, Domain aValueDomain) {
    super(MAPDOMAIN_NAME + "<" + aKeyDomain.getTGTypeName(schema.getDefaultPackage()) + ", " + aValueDomain.getTGTypeName(schema.getDefaultPackage()) + ">", (PackageImpl) schema.getDefaultPackage());
  ...
  @Override public String getJavaAttributeImplementationTypeName(String schemaRootPackagePrefix) {
    return MAPDOMAIN_TYPE + "<" + this.keyDomain.getJavaClassName(schemaRootPackagePrefix) + ", " + this.valueDomain.getJavaClassName(schemaRootPackagePrefix) + ">";
  }
  ...
  @Override public String getTGTypeName(Package pkg) {
    return MAPDOMAIN_NAME + "<" + this.keyDomain.getTGTypeName(pkg) + ", " + this.valueDomain.getTGTypeName(pkg) + ">";
  }
  ...
  @Override public String toString() {
    return "domain " + MAPDOMAIN_NAME + "<" + this.keyDomain.toString() + ", " + this.valueDomain.toString() + ">";
  }
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public void serializeGenericAttribute(GraphIO io, Object data) throws IOException {
    if (data != null) {
      ...
      for (Object key : ((PMap<Object, Object>) data).keySet()) {
        ...
        io.write(" -");
        this.getValueDomain().serializeGenericAttribute(io, ((PMap<Object, Object>) data).get(key));
      }
      io.write("}");
      io.space();
    } else {
  ...
  @Override public boolean isConformGenericValue(Object value) {
    ...
    while (iterator.hasNext() && result) {
      ...
      result &= getKeyDomain().isConformGenericValue(key) && getValueDomain().isConformGenericValue(((PMap<?, ?>) value).get(key));
    }
    return result;
  }

  @Override protected void registerAttribute(Attribute a) {
