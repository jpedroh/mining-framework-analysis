  ...
  private void createAndUpdateEdges() {
    for (CreateEdge ce : replaceGraph.getCreateEdgeEdges()) {
      ...
      if ((ce.get_typeName() == null) && (arch != null) && (arch instanceof Edge)) {
        InternalEdge e = 
<<<<<<< /usr/src/app/output/jgralab/jgralab/07337134fba547de8a5275744759c83da0e62431/src/de/uni_koblenz/jgralab/gretl/MatchReplace.java/left.java
        (InternalEdge) arch.toEdge().getNormalEdge()
=======
        ((Edge) arch).getNormalEdge()
>>>>>>> /usr/src/app/output/jgralab/jgralab/07337134fba547de8a5275744759c83da0e62431/src/de/uni_koblenz/jgralab/gretl/MatchReplace.java/right.java
        ;
        preservables.add(e);
