...
public class GraphIO {
  ...
  private final 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/left.java
  Map<String, Method>
=======
  GraphFactory
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/right.java
   graphFactory;
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/left.java
      "Exception while loading schema"
=======
      "Exception while loading schema."
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/right.java
      , e);
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/right.java
  ...
  private void writeHierarchy(Package pkg, AttributedElementClass<?, ?> aec) throws IOException {
    String delim = ":";
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/left.java
  /**
	 ...
	 *             not be loaded
	 */
  public static Graph loadSchemaAndGraphFromFile(String filename, CodeGeneratorConfiguration config, ProgressFunction pf) throws GraphIOException {
    try {
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  /**
	 ...
	 *             not be loaded
	 */
  public static Graph loadGraphFromFileWithStandardSupport(String filename, ProgressFunction pf) throws GraphIOException {
    return loadGraphFromFile(filename, null, pf, ImplementationType.STANDARD);
  }
  ...
  /**
	 ...
	 *             not be loaded
	 */
  public static Graph loadGraphFromFileWithStandardSupport(String filename, Schema schema, ProgressFunction pf) throws GraphIOException {
    return loadGraphFromFile(filename, schema, pf, ImplementationType.STANDARD);
  }
  ...
  /**
	 ...
	 *             not be loaded
	 */
  public static Graph loadGraphFromFileWithTransactionSupport(String filename, ProgressFunction pf) throws GraphIOException {
    return loadGraphFromFile(filename, null, pf, ImplementationType.TRANSACTION);
  }
  ...
  /**
	 ...
	 *             not be loaded
	 */
  public static Graph loadGraphFromFileWithTransactionSupport(String filename, Schema schema, ProgressFunction pf) throws GraphIOException {
    return loadGraphFromFile(filename, schema, pf, ImplementationType.TRANSACTION);
  }

  /**
	 * Use {@link #loadGraphFromFileWithStandardSupport} instead.
	 */
  @Deprecated public static Graph loadGraphFromFile(String filename, ProgressFunction pf) throws GraphIOException {
    return 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/left.java
    loadGraphFromFileWithStandardSupport(filename, pf)
=======
    loadGraphFromFile(filename, ImplementationType.STANDARD, pf)
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/right.java
    ;
  }
  ...
  /**
	 * Use {@link #loadGraphFromFileWithStandardSupport} instead.
	 */
  @Deprecated public static Graph loadGraphFromFile(String filename, Schema schema, ProgressFunction pf) throws GraphIOException {
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/right.java
  , ProgressFunction pf, ImplementationType implementationType) throws GraphIOException {

<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/left.java
    InputStream inputStream = null;
=======
    if (implementationType == null || implementationType == ImplementationType.DATABASE) {
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/left.java
      return loadGraphFromStream(inputStream, schema, pf, implementationType);
=======
      try {
        if (filename.toLowerCase().endsWith(".gz")) {
          inputStream = new GZIPInputStream(fileStream, BUFFER_SIZE);
...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/left.java
  /**
	 ...
	 *             not be loaded
	 */
  public static Graph loadGraphFromStream(InputStream in, Schema schema, ProgressFunction pf, ImplementationType implementationType) throws GraphIOException {
    try {
      GraphIO io = new GraphIO();
      io.schema = schema;
      io.TGIn = in;
      ...
      Class<?> schemaClass = Class.forName(schemaQName, true, SchemaClassManager.instance(schemaQName));
      ...
      loadedGraph.internalLoadingCompleted(io.firstIncidence, io.nextIncidence);
      io.firstIncidence = null;
      io.nextIncidence = null;
      loadedGraph.loadingCompleted();
      return loadedGraph;
    } catch (ClassNotFoundException e) {
      throw new GraphIOException("Unable to load a graph which belongs to the schema because the Java-classes for this schema have not yet been created." + " Use Schema.commit(..) to create them!", e);
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  private void tgfile() throws GraphIOException, SchemaException, IOException {
    ...
    throw new GraphIOException("Symbol \'" + lookAhead + "\' not recognized in line " + line, null);
  }
  ...
  private void schema() throws GraphIOException, SchemaException {
    ...
    if (qn[0].equals("")) {
      throw new GraphIOException("Invalid schema name \'" + lookAhead + "\', package prefix must not be empty in line " + line);
    }
    match(";");
    if (schema != null) {
      if (schema.getQualifiedName().equals(qn[0] + "." + qn[1])) {
        String prev = "";
        while ((lookAhead.length() > 0) && !(prev.equals(";") && lookAhead.equals("Graph"))) {
          prev = lookAhead;
          match();
        }
        return;
      } else {
        throw new GraphIOException("Trying to load a graph with wrong schema. Expected: " + schema.getQualifiedName() + ", but found " + qn[0] + "." + qn[1]);
      }
    }
  ...
  private void processComments() throws GraphIOException {
    for (Entry<String, List<String>> e : commentData.entrySet()) {
      if (!schema.knows(e.getKey())) {
        throw new GraphIOException("Annotated element \'" + e.getKey() + "\' not found in schema " + schema.getQualifiedName());
      }
  ...
  private void parseEnumDomain() throws GraphIOException {
    match("EnumDomain");
    String[] qn = matchQualifiedName(true);
    enumDomainBuffer.add(new EnumDomainData(qn[0], qn[1], parseEnumConstants()));
    match(";");
  }
  ...
  private void enumDomains() {
    ...
    for (EnumDomainData enumDomainData : enumDomainBuffer) {
      String qName = toQNameString(enumDomainData.packageName, enumDomainData.simpleName);
      domain = schema.createEnumDomain(qName, enumDomainData.enumConstants);
  ...
  private void parseRecordDomain() throws GraphIOException {
    match("RecordDomain");
    String[] qn = matchQualifiedName(true);
    recordDomainBuffer.add(new RecordDomainData(qn[0], qn[1], parseRecordComponents()));
    match(";");
  }
  ...
  private void recordDomains() throws GraphIOException, SchemaException {
    ...
    for (RecordDomainData recordDomainData : recordDomainBuffer) {
      String qName = toQNameString(recordDomainData.packageName, recordDomainData.simpleName);
      domain = schema.createRecordDomain(qName, getComponents(recordDomainData.components));
      domains.put(qName, domain);
    }
  }
  ...
  private List<RecordComponent> getComponents(List<ComponentData> componentsData) throws GraphIOException {
    ...
    for (ComponentData ad : componentsData) {
      RecordComponent c = new RecordComponent(ad.name, attrDomain(ad.domainDescription));
      result.add(c);
    }
    return result;
  }
  ...
  private void parseSchema() throws GraphIOException, SchemaException {
    ...
    while (lookAhead.equals("Package") || lookAhead.equals("RecordDomain") || lookAhead.equals("EnumDomain") || lookAhead.equals("abstract") || lookAhead.equals("VertexClass") || lookAhead.equals("EdgeClass") || lookAhead.equals("Comment")) {
      if (lookAhead.equals("Package")) {
        ...
        if (lookAhead.equals("RecordDomain")) {
          ...
          if (lookAhead.equals("EnumDomain")) {
            parseEnumDomain();
          } else {
            if (lookAhead.equals("Comment")) {
              parseComment();
            } else {
  ...
  private void parsePackage() throws GraphIOException {
    ...
    if (lookAhead.equals(";")) {
      ...
      if (!isValidPackageName(qn[1])) {
        throw new GraphIOException("Invalid package name \'" + qualifiedName + "\' in line " + line);
      }
  ...
  private void completeGraphClass() throws GraphIOException, SchemaException {
    ...
    for (GraphElementClassData currentGraphElementClassData : vertexClassBuffer.get(graphClass.name)) {
      createVertexClass(currentGraphElementClassData, currentGraphClass);
    }
    for (GraphElementClassData currentGraphElementClassData : edgeClassBuffer.get(graphClass.name)) {
  ...
  private String parseGraphClass() throws GraphIOException, SchemaException {
    ...
    match(";");
    vertexClassBuffer.put(graphClass.name, new ArrayList<GraphElementClassData>());
    edgeClassBuffer.put(graphClass.name, new ArrayList<GraphElementClassData>());
  ...
  private List<AttributeData> parseAttributes() throws GraphIOException {
    ...
    while (lookAhead.equals(",")) {
      ...
      if (names.contains(ad.name)) {
        throw new GraphIOException("Duplicate attribute name \'" + ad.name + "\' in line " + line);
      }
      attributesData.add(ad);
      names.add(ad.name);
    }
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/right.java
    ...
    for (AttributeData ad : attributesData) {
      aec.addAttribute(ad.name, attrDomain(ad.domainDescription), ad.defaultValue);
    }
  }
  ...
  private Domain attrDomain(List<String> domainNames) throws GraphIOException {
    ...
    while (it.hasNext()) {
      ...
      if (domainName.equals("List<")) {
        try {
          ...
          throw new GraphIOException("Can\'t create list domain in line " + line, e);
        }
      } else {
        if (domainName.equals("Set<")) {
          try {
            ...
            throw new GraphIOException("Can\'t create set domain in line " + line, e);
          }
        } else {
          if (domainName.equals("Map<")) {
            try {
              ...
              if (keyDomain == null) {
                throw new GraphIOException("Can\'t create map domain, because no key domain was given in line " + line);
              }
              MapDomain result = schema.createMapDomain(keyDomain, valueDomain);
              return result;
            } catch (SchemaException e) {
              throw new GraphIOException("Can\'t create map domain in line " + line, e);
            }
          } else {
            Domain result = schema.getDomain(domainName);
            if (result == null) {
              throw new GraphIOException("Undefined domain \'" + domainName + "\' in line " + line);
            }
            return result;
          }
        }
    ...
    throw new GraphIOException("Couldn\'t create domain for \'" + domainNames + "\' in line " + line);
  }

  public final String matchEnumConstant() throws GraphIOException {
    if (schema.isValidEnumConstant(lookAhead) || lookAhead.equals(NULL_LITERAL)) {
      return matchAndNext();
    }
    throw new GraphIOException("Invalid enumeration constant \'" + lookAhead + "\' in line " + line);
  }
  ...
  private void parseGraphElementClass(String gcName) throws GraphIOException, SchemaException {
    ...
    if (lookAhead.equals("VertexClass")) {
      ...
      if (lookAhead.equals("EdgeClass")) {
        ...
        throw new SchemaException("Undefined keyword: " + lookAhead + " at position ");
      }
    }
    if (lookAhead.equals("{")) {
  ...
  private int[] parseMultiplicity() throws GraphIOException {
    ...
    if (min < 0) {
      throw new GraphIOException("Minimum multiplicity \'" + min + "\' must be >=0 in line " + line);
    }
    match(",");
    int max;
    if (lookAhead.equals("*")) {
      ...
      max = matchInteger();
      if (max < min) {
        throw new GraphIOException("Maximum multiplicity \'" + max + "\' must be * or >=" + min + " in line " + line);
      }
    }
    match(")");
    multis[0] = min;
  ...
  private AggregationKind parseAggregation() throws GraphIOException {
    ...
    if (lookAhead.equals("none")) {
      ...
      if (lookAhead.equals("shared")) {
        match();
        return AggregationKind.SHARED;
      } else {
        if (lookAhead.equals("composite")) {
          match();
          return AggregationKind.COMPOSITE;
        } else {
          throw new GraphIOException("Invalid aggregation: expected \'none\', \'shared\', or \'composite\', but found \'" + lookAhead + "\' in line " + line);
        }
      }
    }
  }
  ...
  private List<ComponentData> parseRecordComponents() throws GraphIOException {
    ...
    while (lookAhead.equals(",")) {
      ...
      if (names.contains(cd.name)) {
        throw new GraphIOException("Duplicate record component name \'" + cd.name + "\' in line " + line);
      }
      componentsData.add(cd);
      names.add(cd.name);
    }
  ...
  private List<String> parseEnumConstants() throws GraphIOException {
    ...
    while (lookAhead.equals(",")) {
      ...
      if (enums.contains(s)) {
        throw new GraphIOException("Duplicate enumeration constant name \'" + lookAhead + "\' in line " + line);
      }
      enums.add(s);
    }
    match(")");
  ...
  private void buildVertexClassHierarchy() throws GraphIOException, SchemaException {
    ...
    for (Entry<String, List<GraphElementClassData>> gcElements : vertexClassBuffer.entrySet()) {
      for (GraphElementClassData vData : gcElements.getValue()) {
        aec = schema.getAttributedElementClass(vData.getQualifiedName());
        if (aec == null) {
        ...
        if (aec instanceof VertexClass) {
          for (String superClassName : vData.directSuperClasses) {
            superClass = (VertexClass) GECsearch.get(aec).getGraphElementClass(superClassName);
            if (superClass == null) {
  ...
  private void buildEdgeClassHierarchy() throws GraphIOException, SchemaException {
    ...
    for (Entry<String, List<GraphElementClassData>> gcElements : edgeClassBuffer.entrySet()) {
      for (GraphElementClassData eData : gcElements.getValue()) {
        aec = schema.getAttributedElementClass(eData.getQualifiedName());
        if (aec == null) {
        ...
        for (String superClassName : eData.directSuperClasses) {
          superClass = (EdgeClass) GECsearch.get(aec).getGraphElementClass(superClassName);
          if (superClass == null) {
  ...
  private final int read() throws GraphIOException {
    try {
      ...
      throw new GraphIOException("Error on reading bytes from file, line " + line + ", last char read was " + (la >= 0 ? "\'" + (char) la + "\'" : "end of file"), e);
    }
  }
  ...
  private final void readUtfString(StringBuilder out) throws GraphIOException {
    ...
    while ((la != -1) && (la != '\"')) {
      if ((la < 32) || (la > 127)) {
        throw new GraphIOException("Invalid character \'" + (char) la + "\' in string in line " + line);
      }
      if (la == '\\') {
        la = read();
        if (la == -1) {
    ...
    if (la == -1) {
      throw new GraphIOException("Unterminated string starting in line " + startLine + ".  lookAhead = \'" + lookAhead + "\'");
    }
    la = read();
  }
  ...
  public final void match(String s) throws GraphIOException {
    if (lookAhead.equals(s)) {
      ...
      throw new GraphIOException("Expected \'" + s + "\' but found " + (lookAhead.equals("") ? "end of file" : "\'" + lookAhead + "\'") + " in line " + line, null);
    }
  }
  ...
  public final int matchInteger() throws GraphIOException {
    try {
      ...
      throw new GraphIOException("Expected int number but found " + (lookAhead.equals("") ? "end of file" : "\'" + lookAhead + "\'") + " in line " + line, e);
    }
  }
  ...
  public final long matchLong() throws GraphIOException {
    try {
      ...
      throw new GraphIOException("Expected long number but found " + (lookAhead.equals("") ? "end of file" : "\'" + lookAhead + "\'") + " in line " + line, e);
    }
  }
  ...
  public final String matchSimpleName(boolean isUpperCase) throws GraphIOException {
    ...
    if (!ok) {
      throw new GraphIOException("Invalid simple name \'" + lookAhead + "\' in line " + line);
    }
    match();
    return s;
  }
  ...
  public final String[] matchQualifiedName(boolean isUpperCase) throws GraphIOException {
    String c = lookAhead.indexOf('.') >= 0 ? lookAhead : toQNameString(currentPackageName, lookAhead);
    ...
    if (!ok) {
      throw new GraphIOException("Invalid qualified name \'" + lookAhead + "\' in line " + line);
    }
    match();
    return result;
  }
  ...
  public final String matchUtfString() throws GraphIOException {
    ...
    throw new GraphIOException("Expected a string constant but found " + (lookAhead.equals("") ? "end of file" : "\'" + lookAhead + "\'") + " in line " + line);
  }

  public final boolean matchBoolean() throws GraphIOException {
    if (!lookAhead.equals("t") && !lookAhead.equals("f")) {
      throw new GraphIOException("Expected a boolean constant (\'f\' or \'t\') but found " + (lookAhead.equals("") ? "end of file" : "\'" + lookAhead + "\'") + " in line " + line);
    }
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/GraphIO.java/right.java
    ...
    GraphBaseImpl graph = graphFactory.createGraph(schema.getGraphClass(), graphId, maxV, maxE);
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  public final double matchDouble() throws GraphIOException {
    try {
      ...
      throw new GraphIOException("expected a double value but found \'" + lookAhead + "\' in line " + line, e);
    }
  }
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  private void edgeDesc(Graph graph, ImplementationType implementationType) throws GraphIOException {
    ...
    Edge edge = graphFactory.createEdge(ec, eId, graph, edgeOut[eId], edgeIn[eId]);
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  private void sortRecordDomains() throws GraphIOException {
    ...
    while (!recordDomainBuffer.isEmpty()) {
      for (Iterator<RecordDomainData> rdit = recordDomainBuffer.iterator(); rdit.hasNext(); ) {
        rd = rdit.next();
        ...
        for (ComponentData comp : rd.components) {
          for (String componentDomain : comp.domainDescription) {
            ...
            for (RecordDomainData orderedRd : orderedRdList) {
              String qName = toQNameString(orderedRd.packageName, orderedRd.simpleName);
            ...
            for (EnumDomainData ed : enumDomainBuffer) {
              String qName = toQNameString(ed.packageName, ed.simpleName);
              if (componentDomain.equals(qName)) {
                componentDomsInOrderedList = true;
                break;
              }
            ...
            if (!componentDomsInOrderedList) {
              ...
              for (RecordDomainData rd2 : recordDomainBuffer) {
                String qName = toQNameString(rd2.packageName, rd2.simpleName);
  ...
  private void checkFromToVertexClasses() throws GraphIOException {
    ...
    for (Entry<String, List<GraphElementClassData>> graphClassEdge : edgeClassBuffer.entrySet()) {
      for (GraphElementClassData ec : graphClassEdge.getValue()) {
        existingFromVertexClass = false;
        existingToVertexClass = false;
        for (Entry<String, List<GraphElementClassData>> graphClassVertex : vertexClassBuffer.entrySet()) {
  ...
  public static Graph loadGraphFromDatabase(String id, GraphDatabase graphDatabase) throws GraphDatabaseException {
    if (graphDatabase != null) {
      return graphDatabase.getGraph(id);
    } else {
      throw new GraphDatabaseException("No graph database given.");
