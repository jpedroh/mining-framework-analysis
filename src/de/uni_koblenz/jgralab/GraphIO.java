...
>>>>>>> /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/GraphIO.java/right.java
  ...
  protected void addAttributes(List<AttributeData> attributesData, AttributedElementClass<?, ?> aec) throws GraphIOException {
    for (AttributeData ad : attributesData) {
      aec.
<<<<<<< /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/GraphIO.java/left.java
      addAttribute(this.schema.createAttribute(ad.name, this.attrDomain(ad.domainDescription), aec, ad.defaultValue))
=======
      createAttribute(ad.name, attrDomain(ad.domainDescription), ad.defaultValue)
>>>>>>> /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/GraphIO.java/right.java
      ;
    }
  }
      ...
      for (GraphElementClassData vData : gcElements.getValue()) {
        ...
        if (aec instanceof VertexClass) {
          for (String superClassName : vData.directSuperClasses) {
            superClass = 
<<<<<<< /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/GraphIO.java/left.java
            (VertexClass) this.GECsearch.get(aec).getGraphElementClass(superClassName)
=======
            GECsearch.get(aec).getVertexClass(superClassName)
>>>>>>> /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/GraphIO.java/right.java
            ;
            if (superClass == null) {
    ...
    for (Entry<String, List<GraphElementClassData>> gcElements : this.edgeClassBuffer.entrySet()) {
      for (GraphElementClassData eData : gcElements.getValue()) {
        ...
        for (String superClassName : eData.directSuperClasses) {
          superClass = 
<<<<<<< /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/GraphIO.java/left.java
          (EdgeClass) this.GECsearch.get(aec).getGraphElementClass(superClassName)
=======
          GECsearch.get(aec).getEdgeClass(superClassName)
>>>>>>> /usr/src/app/output/jgralab/jgralab/6bbf63215fad598bdf53cca678c43d433b56e95e/src/de/uni_koblenz/jgralab/GraphIO.java/right.java
          ;
          if (superClass == null) {
  ...
  private GraphBaseImpl graph(ProgressFunction pf) throws GraphIOException {
    ...
    GraphBaseImpl graph = this.graphFactory.createGraph(this.schema.getGraphClass(), graphId, maxV, maxE);
  ...
  private void edgeDesc(Graph graph) throws GraphIOException {
    ...
    Edge edge = this.graphFactory.createEdge(ec, eId, graph, this.edgeOut[eId], this.edgeIn[eId]);
