...
public interface Vertex extends GraphElement<VertexClass, Vertex> {
  ...
  /**
	 ...
	 *         class anEdgeClass
	 */
  public Edge getFirstIncidence(Class<? extends Edge> anEdgeClass, EdgeDirection orientation);
  ...
  /**
	 ...
	 */
  public <T extends Vertex> POrderedSet<T> reachableVertices(String pathDescription, Class<T> vertexType);
  ...
  /**
	 ...
	 *         pathElements
	 */
  public <T extends Vertex> POrderedSet<T> reachableVertices(Class<T> returnType, PathElement... pathElements);
