...
@NeedsEvaluatorArgument public class IsReachable extends Function {
  public static boolean PRINT_STOP_VERTICES = false;

  public IsReachable() {
    super("Returns true, iff there is a path from vertex given as first argument to vertex " + "given as second argument that matches the path description given as second argument. " + "Usually invoked like so: myVertex (--> | <>--)+ myOtherVertex.", 50, 1, 0.01, Category.GRAPH, Category.PATHS_AND_PATHSYSTEMS_AND_SLICES);
  }
