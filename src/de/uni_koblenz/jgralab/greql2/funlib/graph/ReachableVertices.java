...
@NeedsEvaluatorArgument public class ReachableVertices extends Function {
  public ReachableVertices() {
    super("Returns all vertices that are reachable from the given vertex by a path matching the the given path description.", 100, 10, 1.0, Category.GRAPH, Category.PATHS_AND_PATHSYSTEMS_AND_SLICES);
  }
