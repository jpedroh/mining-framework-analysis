...
@NeedsEvaluatorArgument public class Slice extends Function {
  public Slice() {
    super("Returns a slice, starting at the given root vertex or vertices and " + " being structured according to the given path description.", 1000, 1, 1.0, Category.GRAPH, Category.PATHS_AND_PATHSYSTEMS_AND_SLICES);
  }
