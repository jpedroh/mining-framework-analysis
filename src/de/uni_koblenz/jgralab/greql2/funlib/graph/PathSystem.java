...
@NeedsEvaluatorArgument public class PathSystem extends Function {
  public PathSystem() {
    super("Returns a path system with the given root vertex, which is structured according to the given path description.", 1000, 1, 1.0, Category.PATHS_AND_PATHSYSTEMS_AND_SLICES);
  }
