...
public class HasType extends Function {
  public HasType() {
    super("Returns true, iff the given attributed element or attributed element class has an attribute with the given name.", Category.SCHEMA_ACCESS);
  }

  public Boolean evaluate(AttributedElement el, String qn) {
    AttributedElementClass aec = el.getSchema().getAttributedElementClass(qn);
    if (aec == null) {
