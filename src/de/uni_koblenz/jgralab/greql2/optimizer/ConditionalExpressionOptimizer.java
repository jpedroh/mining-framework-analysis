...
public class ConditionalExpressionOptimizer extends Optimizer {
  private static Logger logger = JGraLab.getLogger(ConditionalExpressionOptimizer.class.getPackage().getName());

  private static class VertexEdgeClassTuple {
    public VertexEdgeClassTuple(Greql2Vertex v, 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/optimizer/ConditionalExpressionOptimizer.java/left.java
    Class<? extends Edge> ec
=======
    EdgeClass ec
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/optimizer/ConditionalExpressionOptimizer.java/right.java
    ) {
      this.v = v;
      this.ec = ec;
    }
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/optimizer/ConditionalExpressionOptimizer.java/right.java
  ...
  @Override protected boolean optimize(Greql2Graph syntaxgraph, CostModel costModel) {
    ...
    FunctionApplication top = findAndOrNotFunApp(syntaxgraph.getFirstGreql2Expression());
    while (top != null) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private LinkedList<VertexEdgeClassTuple> rememberConnections(FunctionApplication top) {
  ...
  private FunctionApplication findAndOrNotFunApp(Greql2Expression g) {
    ...
    while (!queue.isEmpty()) {
      ...
      if (v instanceof FunctionApplication) {
        ...
        if (OptimizerUtility.isAnd(f) || OptimizerUtility.isOr(f) || OptimizerUtility.isNot(f)) {
          return f;
        }
      }
