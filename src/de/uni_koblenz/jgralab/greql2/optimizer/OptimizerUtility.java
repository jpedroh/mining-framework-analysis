...
public class OptimizerUtility {
  ...
  public static boolean isAnd(FunctionApplication funApp) {
    return ((FunctionId) funApp.getFirstIsFunctionIdOfIncidence().getAlpha()).get_name().equals("and");
  }
  ...
  public static boolean isOr(FunctionApplication funApp) {
    return ((FunctionId) funApp.getFirstIsFunctionIdOfIncidence().getAlpha()).get_name().equals("or");
  }
  ...
  public static boolean isXor(FunctionApplication funApp) {
    return ((FunctionId) funApp.getFirstIsFunctionIdOfIncidence().getAlpha()).get_name().equals("xor");
  }
  ...
  public static boolean isNot(FunctionApplication funApp) {
    return ((FunctionId) funApp.getFirstIsFunctionIdOfIncidence().getAlpha()).get_name().equals("not");
  }
  ...
  /**
	 ...
	 */
  public static void mergeSourcePositions(Greql2Aggregation from, Greql2Aggregation to) {
