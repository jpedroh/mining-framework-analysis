 ...
 * 
 */
public class PathExistenceToDirectedPathExpressionOptimizer extends Optimizer {
  ...
  private boolean tryOptimizePathExistence(PathExistence pe) {
    ...
    if ((ibvoStart != null) && (ibvoTarget != null)) {
      ...
      if ((ibvoStart != null) && (ibvoTarget == null)) {
        ...
        if ((ibvoStart == null) && (ibvoTarget != null)) {
          anchorVar = target;
          sdsVar = start;
          SimpleDeclaration startSD = start.getFirstIsDeclaredVarOfIncidence().getOmega();
    ...
    if (!isConstraintAndTopLevelConjunction(pe, sd.getFirstIsSimpleDeclOfIncidence().getOmega())) {
