...
public class DefaultOptimizer extends Optimizer {
  ...
  @Override public boolean optimize(Greql2Graph syntaxgraph) throws OptimizerException {
    ...
    int noOfRuns = 1;
    while (cso.optimize(syntaxgraph) | txfao.optimize(syntaxgraph) | cso.optimize(syntaxgraph) | mco.optimize(syntaxgraph) | pe2dpeo.optimize(syntaxgraph) | eso.optimize(syntaxgraph) | cso.optimize(syntaxgraph) | vdoo.optimize(syntaxgraph) | cso.optimize(syntaxgraph) | peo.optimize(syntaxgraph) | ceo.optimize(syntaxgraph) | cso.optimize(syntaxgraph) | msdo.optimize(syntaxgraph)) {
