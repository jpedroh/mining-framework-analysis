...
public class EarlySelectionOptimizer extends Optimizer {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) private Vertex copySubgraph(Vertex origVertex, Greql2Graph graph, Set<Variable> variablesToBeCopied, HashMap<Variable, Variable> copiedVarMap) {
    ...
    Class<? extends Vertex> vertexClass = (Class<? extends Vertex>) origVertex.getAttributedElementClass().getSchemaClass();
    ...
    while (origEdge != null) {
      ...
      Class<? extends Edge> edgeClass = (Class<? extends Edge>) origEdge.getAttributedElementClass().getSchemaClass();
