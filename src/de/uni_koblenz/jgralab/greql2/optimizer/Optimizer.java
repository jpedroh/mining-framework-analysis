...
public abstract class Optimizer {
  /**
	 ...
	 *         anything.
	 */
  protected abstract boolean optimize(Greql2Graph syntaxgraph, CostModel costModel);
  ...
  /**
	 ...
	 */
  protected abstract boolean isEquivalent(Optimizer optimizer);
  ...
  protected boolean isDeclaredBefore(Variable var1, Variable var2) {
    ...
    SimpleDeclaration sd2 = var2.getFirstIsDeclaredVarOfIncidence(EdgeDirection.OUT).getOmega();
    Declaration decl2 = sd2.getFirstIsSimpleDeclOfIncidence(EdgeDirection.OUT).getOmega();
    if (decl1 == decl2) {
      if (sd1 == sd2) {
