...
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/optimizer/condexp/And.java/left.java
    Greql2Graph
=======
    Greql2
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/optimizer/condexp/And.java/right.java
  ...
  @Override protected Formula calculateReplacementFormula(Expression exp, Literal literal) {
    return new And(greqlEvaluator, leftHandSide.calculateReplacementFormula(exp, literal), rightHandSide.calculateReplacementFormula(exp, literal));
  }

  @Override public Formula simplify() {
    Formula lhs = leftHandSide.simplify();
    Formula rhs = rightHandSide.simplify();
    if (lhs.equals(new Not(greqlEvaluator, rhs)) || new Not(greqlEvaluator, lhs).equals(rhs)) {
  ...
  @Override public double getSelectivity() {
    double selectivity = leftHandSide.getSelectivity() * rightHandSide.getSelectivity();
  ...
  @Override public boolean equals(Object o) {
    if (o instanceof And) {
      And and = (And) o;
      return leftHandSide.equals(and.leftHandSide) && rightHandSide.equals(and.rightHandSide);
    }
    return false;
  }
