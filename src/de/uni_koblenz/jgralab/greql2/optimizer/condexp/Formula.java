...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/optimizer/condexp/Formula.java/right.java
  ...
  public static Formula createFormulaFromExpression(Expression exp, GreqlEvaluator eval) {
  ...
  private static Formula createFormulaFromExpressionInternal(GreqlEvaluator eval, Expression exp) {
    ...
    if (exp instanceof FunctionApplication) {
      ...
      if (OptimizerUtility.isAnd(funApp)) {
        ...
        Expression rightArg = 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/optimizer/condexp/Formula.java/left.java
        inc.getNextIsArgumentOfIncidence(EdgeDirection.IN).getAlpha()
=======
        (Expression) inc.getNextIsArgumentOfIncidence(EdgeDirection.IN).getAlpha()
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/optimizer/condexp/Formula.java/right.java
        ;
        return new And(eval, createFormulaFromExpressionInternal(eval, leftArg), createFormulaFromExpressionInternal(eval, rightArg));
      }
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/optimizer/condexp/Formula.java/right.java
        ;
        return new Or(eval, createFormulaFromExpressionInternal(eval, leftArg), createFormulaFromExpressionInternal(eval, rightArg));
      }
      if (OptimizerUtility.isNot(funApp)) {
        IsArgumentOf inc = funApp.getFirstIsArgumentOfIncidence(EdgeDirection.IN);
        Expression arg = inc.getAlpha();
        return new Not(eval, createFormulaFromExpressionInternal(eval, arg));
      }
    }
