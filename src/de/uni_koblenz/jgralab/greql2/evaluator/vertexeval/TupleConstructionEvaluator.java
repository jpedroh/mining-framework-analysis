...
public class TupleConstructionEvaluator extends ValueConstructionEvaluator {
  public TupleConstructionEvaluator(TupleConstruction vertex, GreqlEvaluator eval) {
    super(vertex, eval);
  }
  ...
  @Override public VertexCosts calculateSubtreeEvaluationCosts(GraphSize graphSize) {
    return this.greqlEvaluator.getCostModel().calculateCostsTupleConstruction(this, graphSize);
  }

  @Override public long calculateEstimatedCardinality(GraphSize graphSize) {
    return greqlEvaluator.getCostModel().calculateCardinalityTupleConstruction(this, graphSize);
  }
}