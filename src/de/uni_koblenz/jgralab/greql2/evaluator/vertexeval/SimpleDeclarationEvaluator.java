...
public class SimpleDeclarationEvaluator extends VertexEvaluator {
  ...
  /**
	 ...
	 */
  public SimpleDeclarationEvaluator(SimpleDeclaration vertex, GreqlEvaluator eval) {
    super(eval);
    this.vertex = vertex;
  }
  ...
  /**
	 ...
	 */
  @Override public PVector<VariableDeclaration> evaluate() {
    ...
    while (varInc != null) {
      VariableDeclaration varDecl = new VariableDeclaration((Variable) varInc.getAlpha(), exprEval, vertex, greqlEvaluator);
  ...
  @Override public VertexCosts calculateSubtreeEvaluationCosts(GraphSize graphSize) {
    return this.greqlEvaluator.getCostModel().calculateCostsSimpleDeclaration(this, graphSize);
  }
  ...
  @Override public long calculateEstimatedCardinality(GraphSize graphSize) {
    return greqlEvaluator.getCostModel().calculateCardinalitySimpleDeclaration(this, graphSize);
  }
}