...
<<<<<<< /usr/src/app/output/jgralab/jgralab/693df1d429d23b9f14b883047743fb3c1d785f91/src/de/uni_koblenz/jgralab/greql2/evaluator/vertexeval/VariableEvaluator.java/left.java
/**
...
public class VariableEvaluator<V extends Variable> extends VertexEvaluator<V> {
  ...
  @Override public Set<Variable> getNeededVariables() {
  ...
  @Override public Set<Variable> getDefinedVariables() {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected List<VertexEvaluator<? extends Expression>> calculateDependingExpressions() {
...
public class VariableEvaluator extends VertexEvaluator {
  ...
  @Override public VertexCosts calculateSubtreeEvaluationCosts(GraphSize graphSize) {
    return this.greqlEvaluator.getCostModel().calculateCostsVariable(this, graphSize);
  }
  ...
  /**
	 ...
	 */
  @Override public long getVariableCombinations(GraphSize graphSize) {
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/693df1d429d23b9f14b883047743fb3c1d785f91/src/de/uni_koblenz/jgralab/greql2/evaluator/vertexeval/VariableEvaluator.java/right.java
