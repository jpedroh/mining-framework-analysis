...
public class FunctionApplicationEvaluator extends VertexEvaluator<FunctionApplication> {
  ...
  public String getFunctionName() {
    if (functionName == null) {
      FunctionId id = vertex.getFirstIsFunctionIdOfIncidence(EdgeDirection.IN).getAlpha();
  ...
  protected ArrayList<VertexEvaluator<? extends Expression>> createVertexEvaluatorList() {
    ...
    while (inc != null) {
      ...
      VertexEvaluator<? extends Expression> paramEval = query.getVertexEvaluator(currentParameterExpr);
  ...
  private TypeCollection createTypeArgument(InternalGreqlEvaluator evaluator) {
    ...
    if (typeEdge != null) {
      ...
      while (typeEdge != null) {
        ...
        TypeIdEvaluator typeEval = (TypeIdEvaluator) query.getVertexEvaluator(typeId);
