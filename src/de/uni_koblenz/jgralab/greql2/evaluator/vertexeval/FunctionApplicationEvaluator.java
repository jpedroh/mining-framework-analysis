...
public class FunctionApplicationEvaluator extends VertexEvaluator {
  ...
  public String getFunctionName() {
    if (functionName == null) {
      FunctionId id = (FunctionId) vertex.getFirstIsFunctionIdOfIncidence(EdgeDirection.IN).getAlpha();
  ...
  /**
	 ...
	 */
  public FunctionApplicationEvaluator(FunctionApplication vertex, GreqlEvaluator eval) {
    super(eval);
    this.vertex = vertex;
  }
  ...
  @Override public VertexCosts calculateSubtreeEvaluationCosts(GraphSize graphSize) {
    return this.greqlEvaluator.getCostModel().calculateCostsFunctionApplication(this, graphSize);
  }

  @Override public double calculateEstimatedSelectivity(GraphSize graphSize) {
    return this.greqlEvaluator.getCostModel().calculateSelectivityFunctionApplication(this, graphSize);
  }

  @Override public long calculateEstimatedCardinality(GraphSize graphSize) {
    return greqlEvaluator.getCostModel().calculateCardinalityFunctionApplication(this, graphSize);
  }
}