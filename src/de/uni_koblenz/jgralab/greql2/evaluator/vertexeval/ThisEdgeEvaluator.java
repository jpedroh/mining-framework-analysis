...
public class ThisEdgeEvaluator extends VariableEvaluator<ThisEdge> {
  /**
	 ...
	 */
  public ThisEdgeEvaluator(ThisEdge vertex, QueryImpl query) {
    super(vertex, query);
  }

  @SuppressWarnings(value = { "unchecked" }) @Override public List<VertexEvaluator<? extends Expression>> calculateDependingExpressions() {
