...
public class QuantifiedExpressionEvaluator extends VertexEvaluator {
  ...
  /**
	 ...
	 */
  public QuantifiedExpressionEvaluator(QuantifiedExpression vertex, GreqlEvaluator eval) {
    super(eval);
    this.vertex = vertex;
  }

  private void initialize() {
    Declaration d = (Declaration) vertex.getFirstIsQuantifiedDeclOfIncidence(EdgeDirection.IN).getAlpha();
    ...
    Quantifier quantifier = (Quantifier) vertex.getFirstIsQuantifierOfIncidence(EdgeDirection.IN).getAlpha();
    quantificationType = quantifier.get_type();
    Expression b = (Expression) vertex.getFirstIsBoundExprOfIncidence(EdgeDirection.IN).getAlpha();
