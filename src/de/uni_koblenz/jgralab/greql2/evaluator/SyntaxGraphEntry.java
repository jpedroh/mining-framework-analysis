...
public class SyntaxGraphEntry {
  ...
  /**
	 ...
	 */
  public SyntaxGraphEntry(String queryText, Greql2 graph, Optimizer optimizer, CostModel costModel, boolean locked) {
  ...
  @Override public boolean equals(Object o) {
    if (o instanceof SyntaxGraphEntry) {
      ...
      return queryText.equals(e.queryText) && optimizer.getClass().equals(e.optimizer.getClass()) && costModel.getClass().equals(e.costModel.getClass());
    }
    return false;
  }

  @Override public int hashCode() {
    return queryText.hashCode() + optimizer.getClass().hashCode() + costModel.getClass().hashCode();
  }
  ...
  @Override public String toString() {
    return "{SyntaxGraphEntry@" + syntaxGraph.hashCode() + ":" + costModel.getClass().getSimpleName() + ":" + optimizer.getClass().getSimpleName() + "}";
  }
}