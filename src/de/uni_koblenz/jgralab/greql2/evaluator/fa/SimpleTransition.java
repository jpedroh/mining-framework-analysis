...
public class SimpleTransition extends Transition {
  ...
  /**
	 ...
	 *            accepted
	 */
  public SimpleTransition(State start, State end, AllowedEdgeDirection dir, TypeCollection typeCollection, Set<String> roles, VertexEvaluator<? extends Expression> predicateEvaluator, QueryImpl query) {
    super(start, end);
    validDirection = dir;
