...
public class SimpleTransition extends Transition {
  ...
  /**
	 ...
	 *            accepted
	 */
  public SimpleTransition(State start, State end, AllowedEdgeDirection dir, TypeCollection typeCollection, Set<String> roles, VertexEvaluator predicateEvaluator, GraphMarker<VertexEvaluator> graphMarker) {
    super(start, end);
    validDirection = dir;
