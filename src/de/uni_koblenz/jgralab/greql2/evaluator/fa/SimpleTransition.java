...
public class SimpleTransition extends Transition {
  ...
  public SimpleTransition(State start, State end, GReQLDirection dir, TypeCollection typeCollection, Set<String> roles, VertexEvaluator<? extends Expression> predicateEvaluator, QueryImpl query) {
    ...
    ThisEdge v = 
<<<<<<< /usr/src/app/output/jgralab/jgralab/f475191b1bb19e089d61d4d35056c1306db833a9/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/SimpleTransition.java/left.java
    graphMarker.getGraph().getFirstVertex(ThisEdge.VC)
=======
    (ThisEdge) query.getQueryGraph().getFirstVertex(ThisEdge.class)
>>>>>>> /usr/src/app/output/jgralab/jgralab/f475191b1bb19e089d61d4d35056c1306db833a9/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/SimpleTransition.java/right.java
    ;
    if (v != null) {
