...
public class BoolExpressionTransition extends Transition {
  ...
  public BoolExpressionTransition(State start, State end, VertexEvaluator<? extends Expression> boolEval, QueryImpl query) {
    ...
    ThisVertex v = 
<<<<<<< /usr/src/app/output/jgralab/jgralab/f475191b1bb19e089d61d4d35056c1306db833a9/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/BoolExpressionTransition.java/left.java
    graphMarker.getGraph().getFirstVertex(ThisVertex.VC)
=======
    (ThisVertex) query.getQueryGraph().getFirstVertex(ThisVertex.class)
>>>>>>> /usr/src/app/output/jgralab/jgralab/f475191b1bb19e089d61d4d35056c1306db833a9/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/BoolExpressionTransition.java/right.java
    ;
    if (v != null) {
