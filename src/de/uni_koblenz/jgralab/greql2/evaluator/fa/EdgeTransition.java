...
public class EdgeTransition extends SimpleTransition {
  ...
  /**
	 ...
	 *            be accepted
	 */
  public EdgeTransition(State start, State end, AllowedEdgeDirection dir, TypeCollection typeCollection, Set<String> roles, VertexEvaluator edgeEval, VertexEvaluator predicateEval, GraphMarker<VertexEvaluator> graphMarker) {
  ...
  @Override public boolean accepts(Vertex v, Edge e) {
    ...
    if (allowedEdgeEvaluator != null) {
      Edge allowedEdge = ((Edge) allowedEdgeEvaluator.getResult()).getNormalEdge();
