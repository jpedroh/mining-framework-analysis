...
public class NFA extends FiniteAutomaton {
  ...
  /**
	 ...
	 */
  public static NFA createEdgePathDescriptionNFA(Transition.AllowedEdgeDirection dir, TypeCollection typeCollection, Set<String> roles, VertexEvaluator<?> edgeEval, 
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/NFA.java/right.java
    ...
    SimpleTransition t = new EdgeTransition(nfa.initialState, nfa.finalStates.get(0), dir, typeCollection, roles, edgeEval, predicateEvaluator, 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/NFA.java/left.java
    query
=======
    marker
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/NFA.java/right.java
  ...
  /**
	 ...
	 * EdgeRestrictions (RoleId, TypeId) are modeled in the Transition.
	 */
  public static NFA createSimplePathDescriptionNFA(Transition.AllowedEdgeDirection dir, TypeCollection typeCollection, Set<String> roles, 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/NFA.java/left.java
  VertexEvaluator<? extends Expression> predicateEvaluator
=======
  VertexEvaluator predicateEvaluator
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/NFA.java/right.java
    ...
    nfa.initialState.outTransitions.clear();
    nfa.finalStates.get(0).inTransitions.clear();
    SimpleTransition t = new SimpleTransition(nfa.initialState, nfa.finalStates.get(0), dir, typeCollection, roles, predicateEvaluator, 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/NFA.java/left.java
    query
=======
    marker
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/NFA.java/right.java
  ...
  /**
	 ...
	 * EdgeRestrictions (RoleId, TypeId) are modeled in the Transition.
	 */
  public static NFA createAggregationPathDescriptionNFA(boolean aggregateFrom, TypeCollection typeCollection, Set<String> roles, 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/NFA.java/left.java
  VertexEvaluator<? extends Expression> predicateEvaluator
=======
  VertexEvaluator predicateEvaluator
...
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/NFA.java/right.java
    ...
    nfa.initialState.outTransitions.clear();
    nfa.finalStates.get(0).inTransitions.clear();
    AggregationTransition t = new AggregationTransition(nfa.initialState, nfa.finalStates.get(0), aggregateFrom, typeCollection, roles, predicateEvaluator, 
<<<<<<< /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/NFA.java/left.java
    query
=======
    marker
>>>>>>> /usr/src/app/output/jgralab/jgralab/1502a3525248376410ba747530bf6ef93a0656f2/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/NFA.java/right.java
  ...
  /**
	 ...
	 */
  public static void addGoalBooleanRestriction(NFA nfa, VertexEvaluator<? extends Expression> boolEval, Query query) {
    State newEndState;
    if (nfa.finalStates.size() == 1) {
      newEndState = nfa.finalStates.get(0);
      newEndState.isFinal = false;
  ...
  /**
	 ...
	 *            the VertexEvaluator, which restricts this nfa
	 */
  public static void addStartBooleanRestriction(NFA nfa, VertexEvaluator<? extends Expression> boolEval, Query query) {
