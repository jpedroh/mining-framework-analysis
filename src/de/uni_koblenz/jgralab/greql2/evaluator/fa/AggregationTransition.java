...
public class AggregationTransition extends Transition {
  ...
  /**
	 ...
	 *            accepted
	 */
  public AggregationTransition(State start, State end, boolean aggregateFrom, TypeCollection typeCollection, Set<String> roles, VertexEvaluator<? extends Expression> predicateEvaluator, QueryImpl query) {
    super(start, end);
    ...
    ThisEdge v = 
<<<<<<< /usr/src/app/output/jgralab/jgralab/f475191b1bb19e089d61d4d35056c1306db833a9/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/AggregationTransition.java/left.java
    graphMarker.getGraph().getFirstVertex(ThisEdge.VC)
=======
    (ThisEdge) query.getQueryGraph().getFirstVertex(ThisEdge.class)
>>>>>>> /usr/src/app/output/jgralab/jgralab/f475191b1bb19e089d61d4d35056c1306db833a9/src/de/uni_koblenz/jgralab/greql2/evaluator/fa/AggregationTransition.java/right.java
    ;
    if (v != null) {
