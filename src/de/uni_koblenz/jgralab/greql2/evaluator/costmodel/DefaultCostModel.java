...
public class DefaultCostModel extends CostModelBase implements CostModel {
  ...
  @Override public long calculateCardinalityBackwardVertexSet(BackwardVertexSetEvaluator e) {
    return 5;
  }
  ...
  @Override public long calculateCardinalityConditionalExpression(ConditionalExpressionEvaluator e) {
  ...
  @Override public long calculateCardinalityDeclaration(DeclarationEvaluator e) {
  ...
  @Override public long calculateCardinalityEdgeSetExpression(EdgeSetExpressionEvaluator e) {
  ...
  @Override public long calculateCardinalityForwardVertexSet(ForwardVertexSetEvaluator e) {
    return 5;
  }

  @Override public long calculateCardinalityFunctionApplication(FunctionApplicationEvaluator e) {
  ...
  @Override public long calculateCardinalityListConstruction(ListConstructionEvaluator e) {
  ...
  @Override public long calculateCardinalityListRangeConstruction(ListRangeConstructionEvaluator e) {
    ...
    if (startExpEval instanceof IntLiteralEvaluator) {
      if (targetExpEval instanceof IntLiteralEvaluator) {
        try {
          range = (((Number) targetExpEval.getResult(null)).longValue() - ((Number) startExpEval.getResult(null)).longValue()) + 1;
        } catch (Exception ex) {
        }
      }
    }
  ...
  @Override public long calculateCardinalityRecordConstruction(RecordConstructionEvaluator e) {
  ...
  @Override public long calculateCardinalitySetComprehension(SetComprehensionEvaluator e) {
  ...
  @Override public long calculateCardinalitySetConstruction(SetConstructionEvaluator e) {
  ...
  @Override public long calculateCardinalitySimpleDeclaration(SimpleDeclarationEvaluator e) {
  ...
  @Override public long calculateCardinalityTableComprehension(TableComprehensionEvaluator e) {
  ...
  @Override public long calculateCardinalityTupleConstruction(TupleConstructionEvaluator e) {
  ...
  @Override public long calculateCardinalityVertexSetExpression(VertexSetExpressionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsAlternativePathDescription(AlternativePathDescriptionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsBackwardVertexSet(BackwardVertexSetEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsConditionalExpression(ConditionalExpressionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsDeclaration(DeclarationEvaluator e) {
    Declaration decl = (Declaration) e.getVertex();
    ...
    long iterationCosts = e.getDefinedVariableCombinations() * declarationCostsFactor;
  ...
  @Override public VertexCosts calculateCostsEdgePathDescription(EdgePathDescriptionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsEdgeRestriction(EdgeRestrictionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsEdgeSetExpression(EdgeSetExpressionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsExponentiatedPathDescription(ExponentiatedPathDescriptionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsForwardVertexSet(ForwardVertexSetEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsFunctionApplication(FunctionApplicationEvaluator e) {
    FunctionApplication funApp = (FunctionApplication) e.getVertex();
    IsArgumentOf inc = funApp.getFirstIsArgumentOfIncidence(EdgeDirection.IN);
    long argCosts = 0;
  ...
  @Override public VertexCosts calculateCostsGreql2Expression(Greql2ExpressionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsIntermediateVertexPathDescription(IntermediateVertexPathDescriptionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsIteratedPathDescription(IteratedPathDescriptionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsListConstruction(ListConstructionEvaluator e) {
    ListConstruction listCons = (ListConstruction) e.getVertex();
    IsPartOf inc = listCons.getFirstIsPartOfIncidence();
    long parts = 0;
    long partCosts = 0;
  ...
  @Override public VertexCosts calculateCostsListRangeConstruction(ListRangeConstructionEvaluator e) {
    ListRangeConstruction exp = (ListRangeConstruction) e.getVertex();
  ...
  @Override public VertexCosts calculateCostsOptionalPathDescription(OptionalPathDescriptionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsPathExistence(PathExistenceEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsQuantifiedExpression(QuantifiedExpressionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsRecordConstruction(RecordConstructionEvaluator e) {
    RecordConstruction recCons = (RecordConstruction) e.getVertex();
  ...
  @Override public VertexCosts calculateCostsRecordElement(RecordElementEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsSequentialPathDescription(SequentialPathDescriptionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsSetComprehension(SetComprehensionEvaluator e) {
    SetComprehension setComp = e.getVertex();
    Declaration decl = setComp.getFirstIsCompDeclOfIncidence().getAlpha();
    DeclarationEvaluator declEval = (DeclarationEvaluator) e.getVertexEvalMarker().getMark(decl);
    long declCosts = declEval.getCurrentSubtreeEvaluationCosts();
  ...
  @Override public VertexCosts calculateCostsSetConstruction(SetConstructionEvaluator e) {
    SetConstruction setCons = (SetConstruction) e.getVertex();
  ...
  @Override public VertexCosts calculateCostsSimpleDeclaration(SimpleDeclarationEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsSimplePathDescription(SimplePathDescriptionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsTableComprehension(TableComprehensionEvaluator e) {
    TableComprehension tableComp = (TableComprehension) e.getVertex();
    Declaration decl = tableComp.getFirstIsCompDeclOfIncidence().getAlpha();
    DeclarationEvaluator declEval = (DeclarationEvaluator) e.getVertexEvalMarker().getMark(decl);
    long declCosts = declEval.getCurrentSubtreeEvaluationCosts();
    ...
    VertexEvaluator resultDefEval = e.getVertexEvalMarker().getMark(resultDef);
    long resultCosts = resultDefEval.getCurrentSubtreeEvaluationCosts();
    long ownCosts = resultDefEval.getEstimatedCardinality() * addToListCosts;
    long iteratedCosts = ownCosts * e.getVariableCombinations();
    long subtreeCosts = iteratedCosts + resultCosts + declCosts;
    return new VertexCosts(ownCosts, iteratedCosts, subtreeCosts);
  }

  @Override public VertexCosts calculateCostsTransposedPathDescription(TransposedPathDescriptionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsTupleConstruction(TupleConstructionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsTypeId(TypeIdEvaluator e) {
    long costs = graphSize.getKnownEdgeTypes() + graphSize.getKnownVertexTypes();
    return new VertexCosts(costs, costs, costs);
  }

  @Override public VertexCosts calculateCostsVariable(VariableEvaluator e) {
    return new VertexCosts(1, 1, 1);
  }

  @Override public VertexCosts calculateCostsVertexSetExpression(VertexSetExpressionEvaluator e) {
  ...
  @Override public double calculateSelectivityFunctionApplication(FunctionApplicationEvaluator e) {
    Function func = e.getFunction();
    if (func != null) {
  ...
  @Override public double calculateSelectivityPathExistence(PathExistenceEvaluator e) {
    return 0.1;
  }

  @Override public double calculateSelectivityTypeId(TypeIdEvaluator e) {
  ...
  @Override public long calculateVariableAssignments(VariableEvaluator e) {
