...
public class DefaultCostModel extends CostModelBase implements CostModel {
  ...
  @Override public long calculateCardinalityListComprehension(ComprehensionEvaluator e) {
  ...
  @Override public VertexCosts calculateCostsBackwardVertexSet(BackwardVertexSetEvaluator e) {
    ...
    Expression targetExpression = (Expression) bwvertex.getFirstIsTargetExprOfIncidence().getAlpha();
  ...
  @Override public VertexCosts calculateCostsListComprehension(ComprehensionEvaluator e) {
    ListComprehension listComp = (ListComprehension) e.getVertex();
    Declaration decl = (Declaration) listComp.getFirstIsCompDeclOfIncidence().getAlpha();
    DeclarationEvaluator declEval = (DeclarationEvaluator) e.getVertexEvalMarker().getMark(decl);
  ...
  @Override public VertexCosts calculateCostsConditionalExpression(ConditionalExpressionEvaluator e) {
    ...
    Expression condition = (Expression) vertex.getFirstIsConditionOfIncidence().getAlpha();
    ...
    expressionToEvaluate = (Expression) vertex.getFirstIsTrueExprOfIncidence().getAlpha();
    ...
    expressionToEvaluate = (Expression) vertex.getFirstIsFalseExprOfIncidence().getAlpha();
  ...
  @Override public VertexCosts calculateCostsForwardVertexSet(ForwardVertexSetEvaluator e) {
    ...
    Expression targetExpression = (Expression) bwvertex.getFirstIsStartExprOfIncidence().getAlpha();
    VertexEvaluator vertexEval = e.getVertexEvalMarker().getMark(targetExpression);
    long targetCosts = vertexEval.getCurrentSubtreeEvaluationCosts();
    PathDescription p = (PathDescription) bwvertex.getFirstIsPathOfIncidence().getAlpha();
    PathDescriptionEvaluator pathDescEval = (PathDescriptionEvaluator) e.getVertexEvalMarker().getMark(p);
  ...
  @Override public VertexCosts calculateCostsPathExistence(PathExistenceEvaluator e) {
    ...
    Expression startExpression = (Expression) existence.getFirstIsStartExprOfIncidence().getAlpha();
    ...
    Expression targetExpression = (Expression) existence.getFirstIsTargetExprOfIncidence().getAlpha();
  ...
  @Override public VertexCosts calculateCostsQuantifiedExpression(QuantifiedExpressionEvaluator e) {
    ...
    long declCosts = declEval.getCurrentSubtreeEvaluationCosts();
    VertexEvaluator boundExprEval = e.getVertexEvalMarker().getMark(quantifiedExpr.getFirstIsBoundExprOfQuantifiedExpressionIncidence().getAlpha());
  ...
  @Override public VertexCosts calculateCostsAggregationPathDescription(AggregationPathDescriptionEvaluator e) {
    return new VertexCosts(transitionCosts, transitionCosts, transitionCosts);
  }
  ...
  @Override public VertexCosts calculateCostsMapConstruction(MapConstructionEvaluator e) {
  ...
  @Override public long calculateCardinalityMapConstruction(MapConstructionEvaluator e) {
    long mappings = 0;
    MapConstruction mapCons = (MapConstruction) e.getVertex();
  ...
  @Override public VertexCosts calculateCostsMapComprehension(MapComprehensionEvaluator e) {
    ...
    long ownCosts = keyEval.getEstimatedCardinality() + (valEval.getEstimatedCardinality() * addToSetCosts);
    long iteratedCosts = ownCosts * e.getVariableCombinations();
    long subtreeCosts = iteratedCosts + resultCosts + declCosts;
    return new VertexCosts(ownCosts, iteratedCosts, subtreeCosts);
  }

  @Override public long calculateCardinalityMapComprehension(MapComprehensionEvaluator e) {
