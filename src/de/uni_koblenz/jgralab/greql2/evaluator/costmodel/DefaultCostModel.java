...
public class DefaultCostModel extends CostModelBase implements CostModel {
	...
	@Override
	public VertexCosts calculateCostsAggregationPathDescription(AggregationPathDescriptionEvaluator e) {
		return new VertexCosts(transitionCosts, transitionCosts, transitionCosts);
	}
	...
	@Override
	public VertexCosts calculateCostsMapComprehension(MapComprehensionEvaluator e) {
