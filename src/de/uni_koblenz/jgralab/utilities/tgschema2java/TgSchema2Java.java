  ...
  private boolean isExistingSchema(Schema schema) {
    ...
    for (VertexClass vc : schema.getGraphClass().getVertexClasses()) {
      ...
      if (!vc.isAbstract()) {
        ...
        requiredFilePaths.add(commitPath + File.separator + schemaPath + File.separator + "impl" + File.separator + pathName + vc.getSimpleName() + "Impl.java");
      }
    }
    for (EdgeClass ec : schema.getGraphClass().getEdgeClasses()) {
      ...
      if (!ec.isAbstract()) {
        ...
        requiredFilePaths.add(commitPath + File.separator + schemaPath + File.separator + "impl" + File.separator + pathName + "Reversed" + ec.getSimpleName() + "Impl.java");
      }
    }
