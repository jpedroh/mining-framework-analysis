...
public class GreqlEvaluatorFacade {
  ...
  /**
	 ...
	 */
  public void setStaticVariablesOfGreqlEvaluator(AttributedElementClass<?, ?> typeClass) {
    if (typeClass instanceof EdgeClass) {
      setStaticVariablesOfGreqlEvaluator((EdgeClass) typeClass);
    } else {
      if (typeClass instanceof VertexClass) {
        setStaticVariablesOfGreqlEvaluator((VertexClass) typeClass);
      } else {
        throw new RuntimeException("The class " + typeClass.getClass().getSimpleName() + " hasn\' been expected");
      }
    }
  }
  ...
  /**
	 ...
	 *            AttributedElement.
	 */
  protected void setTypeSpecificVariablesOfGreqlEvaluator(AttributedElement<?, ?> attributedElement, int graphSequenceIndex) {
  ...
  /**
	 ...
	 *            AttributedElement.
	 */
  public void setVariablesOfGreqlEvaluator(AttributedElement<?, ?> attributedElement, int graphSequenceIndex) {
