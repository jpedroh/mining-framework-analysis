...
public class IndexBuilder {
  ...
  public static void main(String[] args) throws IOException {
    ...
    ib.buildIndex(outputDirectory + "normalized.txt", outputDirectory + "index.txt");
  }
  ...
  public void buildIndex(String inputPath, String indexPath) {
    ...
    int fileCount = 0;
    Iterator<Map.Entry<String, Long>> wordMapIterator = this.wordMap.entrySet().iterator();
    try {
  ...
  public String[] deserializeIndex(String indexPath) {
    ...
    int lineCount = 0;
    try {
      BufferedReader br = IOHelper.openReadFile(indexPath, 1024 * 1024 * 8);
