...
public class NGramNormalizer {
  ...
  public static void main(String[] args) throws NumberFormatException, IOException {
    ...
    IOHelper.strongLog("normalizing ngrams from " + Config.get().nGramsInput + " and storing updated ngrams at " + Config.get().normalizedNGrams);
    double time = ngn.normalize(Config.get().nGramsInput, Config.get().normalizedNGrams);
    IOHelper.strongLog("time for normalizing ngrams from " + Config.get().nGramsInput + " : " + time);
  }
