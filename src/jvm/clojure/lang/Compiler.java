...
public class Compiler implements Opcodes {
  ...
  final static Method createTupleMethods[] = { Method.getMethod("clojure.lang.IPersistentVector create()"), Method.getMethod("clojure.lang.IPersistentVector create(Object)"), Method.getMethod("clojure.lang.IPersistentVector create(Object,Object)"), Method.getMethod("clojure.lang.IPersistentVector create(Object,Object,Object)"), Method.getMethod("clojure.lang.IPersistentVector create(Object,Object,Object,Object)"), Method.getMethod("clojure.lang.IPersistentVector create(Object,Object,Object,Object,Object)"), Method.getMethod("clojure.lang.IPersistentVector create(Object,Object,Object,Object,Object,Object)") };
  ...
  static final public Var SOURCE = Var.intern(Namespace.findOrCreate(Symbol.intern("clojure.core")), Symbol.intern("*source-path*"), "NO_SOURCE_FILE").setDynamic();

  static final public Var SOURCE_PATH = Var.intern(Namespace.findOrCreate(Symbol.intern("clojure.core")), Symbol.intern("*file*"), "NO_SOURCE_PATH").setDynamic();

  static final public Var COMPILE_PATH = Var.intern(Namespace.findOrCreate(Symbol.intern("clojure.core")), Symbol.intern("*compile-path*"), null).setDynamic();

  static final public Var COMPILE_FILES = Var.intern(Namespace.findOrCreate(Symbol.intern("clojure.core")), Symbol.intern("*compile-files*"), Boolean.FALSE).setDynamic();

  static final public Var INSTANCE = Var.intern(Namespace.findOrCreate(Symbol.intern("clojure.core")), Symbol.intern("instance?"));

  static final public Var ADD_ANNOTATIONS = Var.intern(Namespace.findOrCreate(Symbol.intern("clojure.core")), Symbol.intern("add-annotations"));
  ...
  static class DefExpr implements Expr {
    ...
    static class Parser implements IParser {
      public Expr parse(C context, Object form) {
        ...
        return new DefExpr((String) SOURCE.deref(), lineDeref(), columnDeref(), v, analyze(context == C.EVAL ? context : C.EXPRESSION, RT.third(form), v.sym.name), meta, RT.count(form) == 3, isDynamic);
      }
    }
  }
  ...
  static public abstract class HostExpr implements Expr, MaybePrimitiveExpr {
    ...
    static class Parser implements IParser {
      public Expr parse(C context, Object frm) {
        ...
        if (maybeField) {
          Symbol sym = (((Symbol) RT.third(form)).name.charAt(0) == '-') ? Symbol.intern(((Symbol) RT.third(form)).name.substring(1)) : (Symbol) RT.third(form);
      ...
      if (c != null) {
        ...
        if (sym.name.equals("objects")) {
          ...
          if (sym.name.equals("ints")) {
            ...
            if (sym.name.equals("longs")) {
              c = long[].class;
            } else {
              if (sym.name.equals("floats")) {
                c = float[].class;
              } else {
                if (sym.name.equals("doubles")) {
                  c = double[].class;
                } else {
                  if (sym.name.equals("chars")) {
                    c = char[].class;
                  } else {
                    if (sym.name.equals("shorts")) {
                      c = short[].class;
                    } else {
                      if (sym.name.equals("bytes")) {
                        c = byte[].class;
                      } else {
                        if (sym.name.equals("booleans")) {
                          c = boolean[].class;
                        }
                      }
                    }
      ...
      try {
        ...
        for (java.lang.reflect.Method m : c.getMethods()) {
          if (fieldName.equals(m.getName()) && (Modifier.isStatic(m.getModifiers()))) {
            throw new IllegalArgumentException("No matching method " + fieldName + " found taking 0 args for " + c);
          }
        }
  ...
  static abstract class MethodExpr extends HostExpr {
    ...
    private static java.lang.reflect.Method getAdaptableSAMMethod(Class target) {
      if (target.isInterface() && target.isAnnotationPresent(FunctionalInterface.class) && target != Runnable.class && target != Callable.class && target != Comparator.class) {
      ...
      for (int i = 0; i < parameterTypes.length; i++) {
        ...
        try {
          ...
          if (primc == parameterTypes[i]) {
            ...
            if (primc == int.class && parameterTypes[i] == long.class) {
              final MaybePrimitiveExpr pe = (MaybePrimitiveExpr) e;
              pe.emitUnboxed(C.EXPRESSION, objx, gen);
              gen.visitInsn(I2L);
            } else {
              if (primc == long.class && parameterTypes[i] == int.class) {
                final MaybePrimitiveExpr pe = (MaybePrimitiveExpr) e;
                pe.emitUnboxed(C.EXPRESSION, objx, gen);
                if (RT.booleanCast(RT.UNCHECKED_MATH.deref())) {
                ...
                if (primc == float.class && parameterTypes[i] == double.class) {
                  final MaybePrimitiveExpr pe = (MaybePrimitiveExpr) e;
                  pe.emitUnboxed(C.EXPRESSION, objx, gen);
                  gen.visitInsn(F2D);
                } else {
                  if (primc == double.class && parameterTypes[i] == float.class) {
                    final MaybePrimitiveExpr pe = (MaybePrimitiveExpr) e;
                    pe.emitUnboxed(C.EXPRESSION, objx, gen);
                    gen.visitInsn(D2F);
                  } else {
                    ...
                    if (sam != null && !(e.hasJavaClass() && maybeSamClass.isAssignableFrom(e.getJavaClass()))) {
                      gen.dup();
                      ...
                      gen.visitInvokeDynamicInsn(samMethodName, adapterSig.toMethodDescriptorString(), new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[] { Type.getType(samDescriptor), new Handle(Opcodes.H_INVOKESTATIC, currentClassName, lambdaMethodName, lambdaDescriptor, false), Type.getType(samDescriptor) });
  ...
  static class StaticMethodExpr extends MethodExpr {
    ...
    public StaticMethodExpr(String source, int line, int column, Symbol tag, Class c, String methodName, IPersistentVector args, boolean tailPosition) {
      ...
      if (methods.isEmpty()) {
        throw new IllegalArgumentException("No matching method " + methodName + " found taking " + args.count() + " args for " + c);
      }
      int methodidx = 0;
      if (methods.size() > 1) {
        ArrayList<Class[]> params = new ArrayList();
  ...
  static class ConstantExpr extends LiteralExpr {
    ...
    public Class getJavaClass() {
      if (v instanceof APersistentMap) {
        ...
        if (v instanceof APersistentSet) {
      ...
      public Expr parse(C context, Object form) {
        ...
        if (v instanceof Number) {
          ...
          if (v instanceof String) {
            ...
            if (v instanceof IPersistentCollection && (((IPersistentCollection) v).count() == 0) && (!(v instanceof IObj) || ((IObj) v).meta() == null)) {
          ...
          if (!Util.equals(op, CATCH) && !Util.equals(op, FINALLY)) {
            ...
            if (Util.equals(op, CATCH)) {
              ...
              try {
                ...
                LocalBinding lb = registerLocal(sym, (Symbol) (RT.second(f) instanceof Symbol ? RT.second(f) : null), null, false);
          ...
          if (matchIdx == -1) {
            ...
            if (subsumes(paramlists.get(i), paramlists.get(matchIdx))) {
              ...
              if (Arrays.equals(paramlists.get(matchIdx), paramlists.get(i))) {
                ...
                if (!(subsumes(paramlists.get(matchIdx), paramlists.get(i)))) {
                  tied = true;
                }
              }
            }
  ...
  public static class IfExpr implements Expr, MaybePrimitiveExpr {
    ...
    public boolean hasJavaClass() {
      return thenExpr.hasJavaClass() && elseExpr.hasJavaClass() && (thenExpr.getJavaClass() == elseExpr.getJavaClass() || thenExpr.getJavaClass() == RECUR_CLASS || elseExpr.getJavaClass() == RECUR_CLASS || (thenExpr.getJavaClass() == null && !elseExpr.getJavaClass().isPrimitive()) || (elseExpr.getJavaClass() == null && !thenExpr.getJavaClass().isPrimitive()));
    }

    public boolean canEmitPrimitive() {
      try {
        return thenExpr instanceof MaybePrimitiveExpr && elseExpr instanceof MaybePrimitiveExpr && (thenExpr.getJavaClass() == elseExpr.getJavaClass() || thenExpr.getJavaClass() == RECUR_CLASS || elseExpr.getJavaClass() == RECUR_CLASS) && ((MaybePrimitiveExpr) thenExpr).canEmitPrimitive() && ((MaybePrimitiveExpr) elseExpr).canEmitPrimitive();
      } catch (Exception e) {
        return false;
      }
    }
  ...
  static final public IPersistentMap CHAR_MAP = PersistentHashMap.create('-', "_", ':', "_COLON_", '+', "_PLUS_", '>', "_GT_", '<', "_LT_", '=', "_EQ_", '~', "_TILDE_", '!', "_BANG_", '@', "_CIRCA_", '#', "_SHARP_", '\'', "_SINGLEQUOTE_", '\"', "_DOUBLEQUOTE_", '%', "_PERCENT_", '^', "_CARET_", '&', "_AMPERSAND_", '*', "_STAR_", '|', "_BAR_", '{', "_LBRACE_", '}', "_RBRACE_", '[', "_LBRACK_", ']', "_RBRACK_", '/', "_SLASH_", '\\', "_BSLASH_", '?', "_QMARK_");
  ...
  public static class MapExpr implements Expr {
    ...
    static public Expr parse(C context, IPersistentMap form) {
      ...
      if (form instanceof IObj && ((IObj) form).meta() != null) {
        return new MetaExpr(ret, MapExpr.parse(context == C.EVAL ? context : C.EXPRESSION, ((IObj) form).meta()));
      } else {
        if (keysConstant) {
  ...
  static class KeywordInvokeExpr implements Expr {
    ...
    public void emit(C context, ObjExpr objx, GeneratorAdapter gen) {
      ...
      gen.swap();
      gen.invokeInterface(ObjExpr.ILOOKUP_SITE_TYPE, Method.getMethod("clojure.lang.ILookupThunk fault(Object)"));
      gen.dup();
      gen.putStatic(objx.objtype, objx.thunkNameStatic(siteIndex), ObjExpr.ILOOKUP_THUNK_TYPE);
      gen.swap();
      gen.invokeInterface(ObjExpr.ILOOKUP_THUNK_TYPE, Method.getMethod("Object get(Object)"));
      gen.mark(endLabel);
      if (context == C.STATEMENT) {
      ...
      for (java.lang.reflect.Method m : allmethods) {
        if (Modifier.isStatic(m.getModifiers()) && m.getName().equals("invokeStatic")) {
          ...
          if (argcount == params.length) {
            ...
            if (argcount > params.length && params.length > 0 && params[params.length - 1] == ISeq.class) {
              method = m;
              variadic = true;
              break;
            }
  ...
  static class InvokeExpr implements Expr {
    ...
    public void emitProto(C context, ObjExpr objx, GeneratorAdapter gen) {
      ...
      e.emit(C.EXPRESSION, objx, gen);
      gen.dup();
      gen.invokeStatic(UTIL_TYPE, Method.getMethod("Class classOf(Object)"));
      gen.getStatic(objx.objtype, objx.cachedClassName(siteIndex), CLASS_TYPE);
      gen.visitJumpInsn(IF_ACMPEQ, callLabel);
      if (protocolOn != null) {
        gen.dup();
      ...
      gen.dup();
      gen.invokeStatic(UTIL_TYPE, Method.getMethod("Class classOf(Object)"));
      gen.putStatic(objx.objtype, objx.cachedClassName(siteIndex), CLASS_TYPE);
      gen.mark(callLabel);
      objx.emitVar(gen, v);
      gen.invokeVirtual(VAR_TYPE, Method.getMethod("Object getRawRoot()"));
      gen.swap();
    ...
    static public Expr parse(C context, ISeq form) {
      ...
      if (RT.booleanCast(getCompilerOption(directLinkingKey)) && fexpr instanceof VarExpr && context != C.EVAL) {
        ...
        if (!v.isDynamic() && !RT.booleanCast(RT.get(v.meta(), redefKey, false))) {
          ...
          Expr ret = StaticInvokeExpr.parse(v, RT.next(form), formtag != null ? formtag : sigtag != null ? sigtag : vtag, tailPosition);
          if (ret != null) {
            return ret;
          }
        }
      ...
      if (fexpr instanceof VarExpr && context != C.EVAL) {
        ...
        for (ISeq s = RT.seq(arglists); s != null; s = s.next()) {
          ...
          if (args.count() == arity) {
            ...
            if (primc != null) {
              return analyze(context, ((IObj) RT.listStar(Symbol.intern(".invokePrim"), ((Symbol) form.first()).withMeta(RT.map(RT.TAG_KEY, Symbol.intern(primc))), form.next())).withMeta((IPersistentMap) RT.conj(RT.meta(v), RT.meta(form))));
            }
            break;
          }
        }
  ...
  static public class FnExpr extends ObjExpr {
    ...
    static Expr parse(C context, ISeq form, String name) {
      ...
      String basename = (enclosingMethod != null ? enclosingMethod.objx.name : (munge(currentNS().name.name))) + "$";
      Symbol nm = null;
      if (RT.second(form) instanceof Symbol) {
      ...
      try {
        Var.pushThreadBindings(RT.mapUniqueKeys(CONSTANTS, PersistentVector.EMPTY, CONSTANT_IDS, new IdentityHashMap(), KEYWORDS, PersistentHashMap.EMPTY, VARS, PersistentHashMap.EMPTY, KEYWORD_CALLSITES, PersistentVector.EMPTY, PROTOCOL_CALLSITES, PersistentVector.EMPTY, VAR_CALLSITES, emptyVarCallSites(), NO_RECUR, null));
        if (nm != null) {
          fn.thisName = nm.name;
        ...
        for (ISeq s = RT.next(form); s != null; s = RT.next(s)) {
          ...
          if (f.isVariadic()) {
            ...
            if (methodArray[f.reqParms.count()] == null) {
  ...
  static public class ObjExpr implements Expr {
    ...
    void compile(String superName, String[] interfaceNames, boolean oneTimeUse) throws IOException {
      ...
      if (altCtorDrops > 0) {
        ...
        ctorgen.visitInsn(Opcodes.ACONST_NULL);
        ctorgen.visitInsn(Opcodes.ICONST_0);
        ctorgen.visitInsn(Opcodes.ICONST_0);
    ...
    static final Keyword LAMBDA_NAME = Keyword.intern(null, "lambda-name");

    static final Keyword SAM_SIGNATURE = Keyword.intern(null, "sam-sig");
    ...
    protected String addLambdaAdapter(MethodType samSig) {
      ...
      IPersistentMap lambda = RT.map(LAMBDA_NAME, lambdaName, SAM_SIGNATURE, samSig);
    ...
    private void emitLambdaAdapters(ClassVisitor cv) {
      for (ISeq s = RT.seq(lambdaAdapters); s != null; s = s.next()) {
        ...
        String lambdaName = (String) lambda.valAt(LAMBDA_NAME);
        MethodType samSig = (MethodType) lambda.valAt(SAM_SIGNATURE);
        MethodType lambdaSig = samSig.insertParameterTypes(0, IFn.class);
                              ...
                              if (value instanceof IRecord) {
                                ...
                                if (value instanceof IPersistentMap) {
                                  ...
                                  if (value instanceof IPersistentVector) {
                                    ...
                                    if (value instanceof PersistentHashSet) {
                                      ...
                                      if (value instanceof ISeq || value instanceof IPersistentList) {
                                        emitListAsObjectArray(value, gen);
    ...
    public Class getJavaClass() {
      if (jc == null) {
        jc = (compiledClass != null) ? compiledClass : (tag != null) ? HostExpr.tagToClass(tag) : IFn.class;
      }
      return jc;
    }
  ...
  public static class FnMethod extends ObjMethod {
    ...
    static FnMethod parse(ObjExpr objx, ISeq form, Object rettag) {
      ...
      try {
        ...
        Var.pushThreadBindings(RT.mapUniqueKeys(METHOD, method, LOCAL_ENV, LOCAL_ENV.deref(), LOOP_LOCALS, null, NEXT_LOCAL_NUM, 0, CLEAR_PATH, pnode, CLEAR_ROOT, pnode, CLEAR_SITES, PersistentHashMap.EMPTY, METHOD_RETURN_CONTEXT, RT.T));
        ...
        for (int i = 0; i < parms.count(); i++) {
          ...
          if (p.equals(_AMP_)) {
            ...
            argclasses.add(pc);
            LocalBinding lb = pc.isPrimitive() ? registerLocal(p, null, new MethodParamExpr(pc), true) : registerLocal(p, state == PSTATE.REST ? ISEQ : tagOf(p), null, true);
    ...
    public void doEmitStatic(ObjExpr fn, ClassVisitor cv) {
      ...
      GeneratorAdapter gen = new GeneratorAdapter(ACC_PUBLIC + ACC_STATIC, ms, null, EXCEPTION_TYPES, cv);
      gen.visitCode();
      ...
      gen = new GeneratorAdapter(ACC_PUBLIC, m, null, EXCEPTION_TYPES, cv);
      gen.visitCode();
      ...
      if (prim != null) {
        ...
        gen = new GeneratorAdapter(ACC_PUBLIC + ACC_FINAL, pm, null, EXCEPTION_TYPES, cv);
        gen.visitCode();
        for (int i = 0; i < argtypes.length; i++) {
          gen.loadArg(i);
          if (!argclasses[i].isPrimitive()) {
    ...
    public void doEmitPrim(ObjExpr fn, ClassVisitor cv) {
      ...
      GeneratorAdapter gen = new GeneratorAdapter(ACC_PUBLIC + ACC_FINAL, ms, null, EXCEPTION_TYPES, cv);
      gen.visitCode();
      Label loopLabel = gen.mark();
      gen.visitLineNumber(line, loopLabel);
      try {
    ...
    public void doEmit(ObjExpr fn, ClassVisitor cv) {
      ...
      GeneratorAdapter gen = new GeneratorAdapter(ACC_PUBLIC, m, null, EXCEPTION_TYPES, cv);
      gen.visitCode();
      Label loopLabel = gen.mark();
      gen.visitLineNumber(line, loopLabel);
      try {
    ...
    static void emitBody(ObjExpr objx, GeneratorAdapter gen, Class retClass, Expr body) {
      ...
      if (Util.isPrimitive(retClass) && be.canEmitPrimitive()) {
        ...
        if (bc == retClass) {
          ...
          if (retClass == long.class && bc == int.class) {
            be.emitUnboxed(C.RETURN, objx, gen);
            gen.visitInsn(I2L);
          } else {
            if (retClass == double.class && bc == float.class) {
              be.emitUnboxed(C.RETURN, objx, gen);
              gen.visitInsn(F2D);
            } else {
              if (retClass == int.class && bc == long.class) {
                be.emitUnboxed(C.RETURN, objx, gen);
                gen.invokeStatic(RT_TYPE, Method.getMethod("int intCast(long)"));
              } else {
                if (retClass == float.class && bc == double.class) {
                  be.emitUnboxed(C.RETURN, objx, gen);
                  gen.visitInsn(D2F);
                } else {
    ...
    static class Parser implements IParser {
      public Expr parse(C context, Object frms) {
        ...
        for ( ; forms != null; forms = forms.next()) {
          Expr e = (context != C.EVAL && (context == C.STATEMENT || forms.next() != null)) ? analyze(C.STATEMENT, forms.first()) : analyze(context, forms.first());
          exprs = exprs.cons(e);
        }
        if (exprs.count() == 0) {
          ...
          try {
              ...
              if (isLoop) {
                if (recurMismatches != null && RT.booleanCast(recurMismatches.nth(i / 2))) {
                  ...
                  if (maybePrimitiveType(init) == int.class) {
                    ...
                    if (maybePrimitiveType(init) == float.class) {
            ...
            try {
              if (isLoop) {
                ...
                Var.pushThreadBindings(RT.map(CLEAR_PATH, clearpath, CLEAR_ROOT, clearroot, NO_RECUR, null, METHOD_RETURN_CONTEXT, methodReturnContext));
              }
      ...
      for (int i = 0; i < loopLocals.count(); i++) {
        ...
        if (lb.getPrimitiveType() != null) {
          ...
          if (pc == primc) {
            ...
            if (primc == long.class && pc == int.class) {
              ((MaybePrimitiveExpr) arg).emitUnboxed(C.EXPRESSION, objx, gen);
              gen.visitInsn(I2L);
            } else {
              if (primc == double.class && pc == float.class) {
                ((MaybePrimitiveExpr) arg).emitUnboxed(C.EXPRESSION, objx, gen);
                gen.visitInsn(F2D);
              } else {
                if (primc == int.class && pc == long.class) {
                  ((MaybePrimitiveExpr) arg).emitUnboxed(C.EXPRESSION, objx, gen);
                  gen.invokeStatic(RT_TYPE, Method.getMethod("int intCast(long)"));
                } else {
                  if (primc == float.class && pc == double.class) {
                    ((MaybePrimitiveExpr) arg).emitUnboxed(C.EXPRESSION, objx, gen);
                    gen.visitInsn(D2F);
                  } else {
        ...
        for (int i = 0; i < loopLocals.count(); i++) {
          ...
          if (primc != null) {
            ...
            if (mismatch) {
              ...
              if (RT.booleanCast(RT.WARN_ON_REFLECTION.deref())) {
                RT.errPrintWriter().println(source + ":" + line + " recur arg for primitive local: " + lb.name + " is not matching primitive, had: " + (pc != null ? pc.getName() : "Object") + ", needed: " + primc.getName());
              }
            }
          }
        }
  ...
  static public class CompilerException extends RuntimeException implements IExceptionInfo {
    ...
    private static String verb(Keyword phase) {
      if (PHASE_READ.equals(phase)) {
        ...
        if (PHASE_COMPILE_SYNTAX_CHECK.equals(phase) || PHASE_COMPILATION.equals(phase)) {
          return "compiling";
        } else {
    ...
    public static String makeMsg(String source, int line, int column, Symbol sym, Keyword phase, Throwable cause) {
      return (PHASE_MACROEXPANSION.equals(phase) ? "Unexpected error " : "Syntax error ") + verb(phase) + " " + (sym != null ? sym + " " : "") + "at (" + (source != null && !source.equals("NO_SOURCE_PATH") ? (source + ":") : "") + line + ":" + column + ").";
    }
    ...
    try {
      ...
      try {
        ...
        if (form instanceof ISeq && Util.equals(RT.first(form), DO)) {
          ...
          if ((form instanceof IType) || (form instanceof IPersistentCollection && !(RT.first(form) instanceof Symbol && ((Symbol) RT.first(form)).name.startsWith("def")))) {
  ...
  static public class NewInstanceExpr extends ObjExpr {
    ...
    static Class compileStub(String superName, NewInstanceExpr ret, String[] interfaceNames, Object frm) {
      ClassWriter cw = classWriter();
      ClassVisitor cv = cw;
      cv.visit(V1_8, ACC_PUBLIC + ACC_SUPER, COMPILE_STUB_PREFIX + "/" + ret.internalName, null, superName, interfaceNames);
    ...
    protected void emitMethods(ClassVisitor cv) {
      ...
      for (Map.Entry<IPersistentVector, Set<Class>> e : covariants.entrySet()) {
        ...
        for (Class retType : e.getValue()) {
          ...
          GeneratorAdapter gen = new GeneratorAdapter(ACC_PUBLIC + ACC_BRIDGE, meth, null, EXCEPTION_TYPES, cv);
          gen.visitCode();
          gen.loadThis();
          gen.loadArgs();
  ...
  static Class primClass(Symbol sym) {
    ...
    if (sym.name.equals("int")) {
      ...
      if (sym.name.equals("long")) {
        c = long.class;
      } else {
        if (sym.name.equals("float")) {
          c = float.class;
        } else {
          if (sym.name.equals("double")) {
            c = double.class;
          } else {
            if (sym.name.equals("char")) {
              c = char.class;
            } else {
              if (sym.name.equals("short")) {
                c = short.class;
              } else {
                if (sym.name.equals("byte")) {
                  c = byte.class;
                } else {
                  if (sym.name.equals("boolean")) {
                    c = boolean.class;
                  } else {
                    if (sym.name.equals("void")) {
                      c = void.class;
                    }
                  }
                }
    ...
    public void doEmit(C context, ObjExpr objx, GeneratorAdapter gen, boolean emitUnboxed) {
      ...
      for (Integer i : labels.keySet()) {
        ...
        if (testType == intKey) {
          ...
          if (RT.contains(skipCheck, i) == RT.T) {
