...
public class CommandHandler {
    ...
    if (!c.perms.hasPermisssion(command, username)) {
      ...
      if (command.equalsIgnoreCase("help")) {
        ...
        if (command.equalsIgnoreCase("move")) {
          ...
          if (command.equalsIgnoreCase("whereareyou")) {
            ...
            if (command.equalsIgnoreCase("whatis")) {
              ...
              if (command.equalsIgnoreCase("holding")) {
                if (args.length > 1) {
                              ...
                              if (command.equalsIgnoreCase("respawn")) {
                                ...
                                if (command.equalsIgnoreCase("friends")) {
                                  ...
                                  if (command.equalsIgnoreCase("respawn")) {
                                    ...
                                    if (command.equalsIgnoreCase("setuserperms")) {
                                      c.perms.setUserPerms(args[1], args[2]);
                                    } else {
                                      if (command.equalsIgnoreCase("removeuserperms")) {
                                        c.perms.removeUserPerms(args[1]);
                                      } else {
                                        if (command.equalsIgnoreCase("swapSlots")) {
  ...
  public void pluginH(String[] messages, String append, List<String> helpl) {
    ...
    new DelayedMessageSender(c).delayedMessageSender(helpl, 1000, 1000);
  }
}