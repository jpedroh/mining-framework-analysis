...
@Category(value = IntegrationTest.class) public class MemberSearchCtrlIT extends ApiTest {
  @Autowired private MemberSearchCtrl testCtrl;

  /**
     * Tests that a Member is retrieved correctly.
     */
  @Test public void aSimpleTest() throws SearchException {
    PersonName expectedName = new PersonName("Aurelia Greene", "Assembly Member", "Aurelia", "", "Greene", "");
    ...
    SessionMember actualSessionMember = ((SessionMemberView) listResponse.getResult().getItems().get(0)).toSessionMember();
  ...
  /**
     ...
     */
  @Test public void searchBySessionMemberId() throws SearchException {
    Person testP = 
<<<<<<< /usr/src/app/output/nysenate/openlegislation/55f02d1256aabf0841995fe75f1beb820ed4c6bc/src/test/java/gov/nysenate/openleg/api/legislation/member/MemberSearchCtrlIT.java/left.java
    TestData.PERSON_DATA.get(499)
=======
    new Person(499, "Edward Hennessey", null, "Assembly Member", "no_image.jpg")
