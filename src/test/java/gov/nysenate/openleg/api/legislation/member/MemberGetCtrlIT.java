...
@Category(value = IntegrationTest.class) public class MemberGetCtrlIT extends ApiTest {
  @Autowired private MemberGetCtrl testCtrl;

  /**
     * Tests that all members of a certain year are correctly retrieved.
     */
  @Test public void getMembersByYearTest() throws SearchException, MemberNotFoundEx {
    ...
    long numAlternates = listResponse.getResult().getItems().stream().filter((sm) -> sm instanceof SessionMemberView && ((SessionMemberView) sm).isAlternate()).count();
    assertEquals(0, numAlternates);
    listResponse = (ListViewResponse<?>) testCtrl.getMembersByYear(2013, "shortName:asc", true, testRequest);
    ;
    FullMemberView testFmv = (FullMemberView) listResponse.getResult().getItems().stream().filter((fm) -> fm instanceof FullMemberView && ((FullMemberView) fm).getMemberId() == 591).toList().get(0);
  ...
  /**
     ...
     */
  @Test public void getMembersByYearAndIdTest() {
    String name = "HASSELL-THOMPSO";
    PersonName pName = new PersonName("Ruth Hassell-Thompson", "Senator", "Ruth", null, "Hassell-Thompson", null);
    Person 
<<<<<<< /usr/src/app/output/nysenate/openlegislation/55f02d1256aabf0841995fe75f1beb820ed4c6bc/src/test/java/gov/nysenate/openleg/api/legislation/member/MemberGetCtrlIT.java/left.java
    testPerson = new Person(199, pName, "hassellt@senate.state.ny.us", "380_ruth_hassell-thompson.jpg")
=======
    testP = new Person(199, "Ruth Hassell-Thompson", "hassellt@senate.state.ny.us", "Senator", "380_ruth_hassell-thompson.jpg")
>>>>>>> /usr/src/app/output/nysenate/openlegislation/55f02d1256aabf0841995fe75f1beb820ed4c6bc/src/test/java/gov/nysenate/openleg/api/legislation/member/MemberGetCtrlIT.java/right.java
    ...
    SessionMember nonAlt2011 = new SessionMember(74, testMember, name + "N", new SessionYear(2011), 36, false);
    ...
    FullMemberView testFmv = new FullMemberView(new FullMember(Arrays.asList(alt2009, nonAlt2009, alt2011, nonAlt2011, alt2013, nonAlt2013, only2015)));
  ...
  /**
     ...
     */
  @Test public void getMembersByYearAndChamberTest() throws SearchException, MemberNotFoundEx {
  ...
  /**
     ...
     */
  @Test public void handleMemberNotFoundExTest() {
