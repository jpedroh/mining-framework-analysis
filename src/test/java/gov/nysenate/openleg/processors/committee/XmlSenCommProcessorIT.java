 ...
 */
@Category(value = IntegrationTest.class) public class XmlSenCommProcessorIT extends BaseXmlProcessorTest {
  @Autowired private CommitteeDataService committeeDataService;

  @Test public void processCommittee() throws ParseError {
    CommitteeVersionId committeeId = new CommitteeVersionId(SENATE, "AgricultureTEST", SessionYear.of(2017), LocalDateTime.parse("2017-01-31T04:51:43"));
  ...
  /**
     ...
     * overwritten version.
     */
  @Test public void fixCommitteeTest() {
    final CommitteeSessionId testCommSeshId = new CommitteeSessionId(SENATE, "Nonsense", SessionYear.of(2017));
    final CommitteeVersionId testCommVerId = new CommitteeVersionId(testCommSeshId, LocalDate.parse("2017-01-01").atStartOfDay());
