...
public class SupplementalCalendarTest extends BaseTests {
  ...
  @Autowired private CalendarAlertProcessor process;

  @Autowired private CalendarCheckService calendarCheckService;

  @Test public void supplementalCalendarTest() throws FileNotFoundException {
