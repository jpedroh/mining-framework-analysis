...
public class LDAPSecurityRealmTest {
  ...
  @Test public void attributesCache() {
    LDAPSecurityRealm.LDAPUserDetailsService s = new LDAPSecurityRealm.LDAPUserDetailsService((username) -> {
  ...
  @LocalData @Test public void compatAndConfig() throws Exception {
    check();
    r.configRoundtrip();
    check();
  }
  ...
  @Issue(value = "JENKINS-8152") @WithoutJenkins @Test public void providerUrl() throws Exception {
  ...
  @Issue(value = "JENKINS-30588") @Test public void groupMembershipAttribute() throws Exception {
    final String previousValue = "previousValue";
    final String testValue = "testValue";
    final LDAPSecurityRealm realm = new LDAPSecurityRealm("localhost", null, null, null, null, null, new FromUserRecordLDAPGroupMembershipStrategy("previousValue"), null, null, false, false, null, null, null, null, (IdStrategy) null, (IdStrategy) null);
  ...
  @Test public void configRoundTrip() throws Exception {
    ...
    final LDAPSecurityRealm realm = new LDAPSecurityRealm(server, rootDN, userSearchBase, null, null, null, new FromUserRecordLDAPGroupMembershipStrategy("previousValue"), managerDN, Secret.fromString(managerSecret), false, false, null, null, null, null, IdStrategy.CASE_INSENSITIVE, IdStrategy.CASE_INSENSITIVE);
    r.jenkins.setSecurityRealm(realm);
  ...
  @Test public void configRoundTripTwo() throws Exception {
    ...
    final LDAPSecurityRealm realm = new LDAPSecurityRealm(ldapConfigurations, true, null, IdStrategy.CASE_INSENSITIVE, IdStrategy.CASE_INSENSITIVE);
    r.jenkins.setSecurityRealm(realm);
    final JenkinsRule.WebClient client = r.createWebClient();
    r.submit(client.goTo("configureSecurity").getFormByName("config"));
    LDAPSecurityRealm newRealm = (LDAPSecurityRealm) r.jenkins.getSecurityRealm();
  ...
  @Test public void configRoundTwoThreeSameId() throws Exception {
    TestConf[] confs = new TestConf[2];
    confs[0] = new TestConf("ldap.example.com", "ou=example,dc=ou.com", "cn=users,ou=example,ou.com", "cn=admin,ou=example,ou.com", "secret1");
    ...
    try {
      ...
      try {
        ...
        LDAPSecurityRealm realm = new LDAPSecurityRealm(ldapConfigurations, true, null, IdStrategy.CASE_INSENSITIVE, IdStrategy.CASE_INSENSITIVE);
        r.jenkins.setSecurityRealm(realm);
      }  finally {
  ...
  @Test public void configRoundTripThreeSameId() throws Exception {
  ...
  @Test public void configRoundTripEnvironmentProperties() throws Exception {
    final String server = "localhost";
    final String rootDN = "ou=umich,dc=ou.edu";
    final String userSearchBase = "cn=users,ou=umich,ou.edu";
    final String managerDN = "cn=admin,ou=umich,ou.edu";
    ...
    LDAPSecurityRealm realm = new LDAPSecurityRealm(configurations, false, null, IdStrategy.CASE_INSENSITIVE, IdStrategy.CASE_INSENSITIVE);
    r.jenkins.setSecurityRealm(realm);
    final JenkinsRule.WebClient client = r.createWebClient();
    r.submit(client.goTo("configureSecurity").getFormByName("config"));
    LDAPSecurityRealm newRealm = (LDAPSecurityRealm) r.jenkins.getSecurityRealm();
