 ...
 */
@SuppressWarnings(value = { "rawtypes" }) public class MailSenderTest {
  /**
     ...
     * list.
     */
  @SuppressWarnings(value = { "unchecked" }) @Test public void testIncludeUpstreamCulprits() throws Exception {
    final Jenkins jenkins = mock(Jenkins.class);

<<<<<<< /usr/src/app/output/jenkinsci/mailer-plugin/021f80f4d6d5f008f0b673df1465e4ad849ac52a/src/test/java/hudson/tasks/MailSenderTest.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
    ...
    try (MockedStatic<Jenkins> mockedJenkins = mockStatic(Jenkins.class)) {
      ...
      createPreviousNextRelationShip(previousBuildUpstreamBuild, upstreamBuildBetweenPreviousAndCurrent, upstreamBuild);
  ...
  @Issue(value = "SECURITY-372") @Test public void forbiddenMail() throws Exception {
    final Jenkins jenkins = mock(Jenkins.class);
