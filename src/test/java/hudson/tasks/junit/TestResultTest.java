...
public class TestResultTest {
  ...
  /**
     ...
     */
  @Test public void testSkippedMessageIsAddedWhenTheMessageAttributeIsNull() throws IOException, URISyntaxException {
    TestResult testResult = new TestResult();
  ...
  @Issue(value = "JENKINS-37598") @Test public void testMergeWithTime() throws Exception {
    TestResult testResult = new TestResult();
  ...
  @Issue(value = "JENKINS-37598") @Test public void testMergeWithoutTime() throws Exception {
    TestResult testResult = new TestResult();
  ...
  @Issue(value = "JENKINS-42438") @Test public void testSuiteWithMultipleClasses() throws IOException, URISyntaxException {
    TestResult testResult = new TestResult();
