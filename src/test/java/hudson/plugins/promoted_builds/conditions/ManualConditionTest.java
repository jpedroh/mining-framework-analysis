...
public class ManualConditionTest {
  ...
  @Test public void testManualPromotionProcess() throws Exception {
  ...
  @Issue(value = "SECURITY-170") @Test public void testManualPromotionProcessWithInvalidParam() throws Exception {
    FreeStyleProject p = j.createFreeStyleProject();
    ExtensionList<Descriptor> list = j.jenkins.getExtensionList(Descriptor.class);
    list.add(new JobPropertyImpl.DescriptorImpl(JobPropertyImpl.class));
    JobPropertyImpl base = new JobPropertyImpl(p);
  ...
  @Test public void testManualPromotionProcessViaWebClient() throws Exception {
    FreeStyleProject p = j.createFreeStyleProject();
    ExtensionList<Descriptor> list = j.jenkins.getExtensionList(Descriptor.class);
    list.add(new JobPropertyImpl.DescriptorImpl(JobPropertyImpl.class));
    JobPropertyImpl base = new JobPropertyImpl(p);
  ...
  @Test @Issue(value = "SECURITY-190") public void testManualPromotionPermissions() throws Exception {
    enableSecurity(j);
    FreeStyleProject p = j.createFreeStyleProject();
  ...
  @Test public void testManualPromotionPermissionsViaWebClient() throws Exception {
    enableSecurity(j);
    FreeStyleProject p = j.createFreeStyleProject();
    PromotionProcess pp = addPromotionProcess(p, "foo");
