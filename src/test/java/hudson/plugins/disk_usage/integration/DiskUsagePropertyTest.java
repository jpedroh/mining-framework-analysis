...
public class DiskUsagePropertyTest {
  ...
  @Test public void testCheckWorkspaces() throws Exception {
  ...
  @Test public void getWorkspaceSizeTest() throws Exception {
    RunListener listener = RunListener.all().get(DiskUsageBuildListener.class);
    j.jenkins.getExtensionList(RunListener.class).remove(listener);
  ...
  @Test public void testchcekWorkspacesIfSlaveIsDeleted() throws Exception {
    FreeStyleProject project = j.jenkins.createProject(FreeStyleProject.class, "project");
  ...
  @Test public void testchcekWorkspacesIfDoesNotExistsIsDeleted() throws Exception {
    FreeStyleProject project = j.jenkins.createProject(FreeStyleProject.class, "project");
    DiskUsageProperty property = new DiskUsageProperty();
    project.addProperty(property);
    Slave slave1 = j.createOnlineSlave();
  ...
  @Test public void testGetAllNonSlaveOrCustomWorkspaceSizeWithOnlySlaves() throws Exception {
    FreeStyleProject project = j.jenkins.createProject(FreeStyleProject.class, "project");
  ...
  @Test public void testGetAllNonSlaveOrCustomWorkspaceSizeWithMaster() throws Exception {
    FreeStyleProject project = j.jenkins.createProject(FreeStyleProject.class, "project");
    if (Functions.isWindows()) {
      project.getBuildersList().add(new BatchFile("echo hello > log"));
    } else {
  ...
  @Test @LocalData public void testBackwadrCompatibility1() throws IOException {
  ...
  @Test @ReplaceHudsonHomeWithCurrentPath(value = "jobs/project1/config.xml") @LocalData public void testBackwadrCompatibility2() throws IOException {
    j.jenkins.getPlugin(DiskUsagePlugin.class).getConfiguration().disableBuildsDiskUsageCalculation();
    j.jenkins.getPlugin(DiskUsagePlugin.class).getConfiguration().disableJobsDiskUsageCalculation();
    j.jenkins.getPlugin(DiskUsagePlugin.class).getConfiguration().disableWorkspacesDiskUsageCalculation();
    AbstractProject project = (AbstractProject) j.jenkins.getItem("project1");
  ...
  @Test @LocalData public void testGetDiskUsageOfBuilds() {
    AbstractProject project = (AbstractProject) j.jenkins.getItem("project1");
  ...
  @Test @LocalData public void testGetDiskUsageOfBuild() {
    AbstractProject project = (AbstractProject) j.jenkins.getItem("project1");
    int loadedBuildsSize = project._getRuns().getLoadedBuilds().size();
    DiskUsageProperty property = (DiskUsageProperty) project.getProperty(DiskUsageProperty.class);
  ...
  @Test @LocalData public void testGetDiskUsageBuildInformation() {
    AbstractProject project = (AbstractProject) j.jenkins.getItem("project1");
    int loadedBuildsSize = project._getRuns().getLoadedBuilds().size();
    DiskUsageProperty property = (DiskUsageProperty) project.getProperty(DiskUsageProperty.class);
  ...
  @Test @LocalData public void testGetDiskUsageOfBuildByNumber() {
    AbstractProject project = (AbstractProject) j.jenkins.getItem("project1");
    int loadedBuildsSize = project._getRuns().getLoadedBuilds().size();
    DiskUsageProperty property = (DiskUsageProperty) project.getProperty(DiskUsageProperty.class);
    assertEquals("Build with id 1 should have size 3000", 3000, property.getDiskUsageOfBuild(1), 0);
  ...
  @Test @ReplaceHudsonHomeWithCurrentPath(value = "jobs/project1/disk-usage.xml") @LocalData public void testCheckWorkspacesBuildsWithoutLoadingBuilds() throws IOException, InterruptedException {
    AbstractProject project = (AbstractProject) j.jenkins.getItem("project1");
    int loadedBuildsSize = project._getRuns().getLoadedBuilds().size();
    DiskUsageProperty property = (DiskUsageProperty) project.getProperty(DiskUsageProperty.class);
  ...
  @Test @ReplaceHudsonHomeWithCurrentPath(value = "jobs/project1/config.xml, jobs/project1/builds/1/build.xml, jobs/project1/builds/3/build.xml") @LocalData public void testCheckWorkspacesWithLoadingBuilds() throws IOException {
  ...
  @Test public void testGetAllDiskUsageOfBuild() throws IOException, Exception {
    FreeStyleProject project = j.jenkins.createProject(FreeStyleProject.class, "project1");
    MatrixProject matrixProject = j.jenkins.createProject(MatrixProject.class, "project2");
    TextAxis axis1 = new TextAxis("axis", "axisA", "axisB", "axisC");
    TextAxis axis2 = new TextAxis("axis2", "Aaxis", "Baxis", "Caxis");
  ...
  @Test @LocalData public void testDoNotBreakLazyLoading() {
    AbstractProject project = (AbstractProject) j.jenkins.getItem("project1");
  ...
  @Test public void testRemoveBuild() throws Exception {
  ...
  @Test public void testRemoveDeletedBuildNotLoadedByJenkins() throws Exception {
    FreeStyleProject project = j.createFreeStyleProject();
    j.buildAndAssertSuccess(project);
    j.buildAndAssertSuccess(project);
    AbstractBuild build = project.getLastBuild();
      ...
      public void run() {
        try {
          ...
          while (count < 1000) {
            ...
            diskUsage.addBuildInformation(new DiskUsageBuildInformation(Integer.toString(count), calendar.getTimeInMillis(), count, 0l), null);
          }
        } catch (ConcurrentModificationException ex) {
          exception = ex;
        } catch (Exception ex) {
  ...
  @Test public void testThreadSaveOperationUnderSetOfDiskUsageBuildInformation() throws Exception {
  ...
  @Target(value = { METHOD }) @Retention(value = RUNTIME) @JenkinsRecipe(value = ReplaceHudsonHomeWithCurrentPath.CurrentWorkspacePath.class) public @interface ReplaceHudsonHomeWithCurrentPath {
    ...
    class CurrentWorkspacePath extends JenkinsRecipe.Runner<ReplaceHudsonHomeWithCurrentPath> {
      ...
      @Override public void setup(JenkinsRule jenkinsRule, ReplaceHudsonHomeWithCurrentPath recipe) throws Exception {
        paths = recipe.value();
      }
    }
  }
