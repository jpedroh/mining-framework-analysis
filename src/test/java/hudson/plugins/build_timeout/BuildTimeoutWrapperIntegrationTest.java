 ...
 */
    ...
    public void migrationFrom_1_12_2() throws Exception {
        ...
        // Abort
        {
            ...
            // assert it works.
            ExecutionCheckBuilder checkBuilder = project.getBuildersList().get(BuildTimeoutWrapperIntegrationTest.ExecutionCheckBuilder.class);
            ExecutionCheckPublisher checkPublisher = project.getPublishersList().get(BuildTimeoutWrapperIntegrationTest.ExecutionCheckPublisher.class);
