...
public class BuildTimeoutWrapperIntegrationTest {
  ...
  @Test public void buildTimeoutEnvValid() throws Exception {
    EnvVars expectedEnvVars = getEnvVars();
    FreeStyleProject project = j.createFreeStyleProject();
    project.getBuildWrappersList().add(new BuildTimeoutWrapper(new QuickBuildTimeOutStrategy(12345), Arrays.<BuildTimeOutOperation>asList(), "BUILD_TIMEOUT"));
    CaptureEnvironmentBuilder captureEnvBuilder = new CaptureEnvironmentBuilder();
    project.getBuildersList().add(captureEnvBuilder);
    project.scheduleBuild2(0).get();
  ...
  @Test public void buildTimeoutEnvNull() throws Exception {
    EnvVars expectedEnvVars = getEnvVars();
    FreeStyleProject project = j.createFreeStyleProject();
    project.getBuildWrappersList().add(new BuildTimeoutWrapper(new QuickBuildTimeOutStrategy(12345), Arrays.<BuildTimeOutOperation>asList(), null));
    CaptureEnvironmentBuilder captureEnvBuilder = new CaptureEnvironmentBuilder();
    project.getBuildersList().add(captureEnvBuilder);
    project.scheduleBuild2(0).get();
    EnvVars envVars = captureEnvBuilder.getEnvVars();
  ...
  @Test public void buildTimeoutEnvEmpty() throws Exception {
    EnvVars expectedEnvVars = getEnvVars();
    FreeStyleProject project = j.createFreeStyleProject();
    project.getBuildWrappersList().add(new BuildTimeoutWrapper(new QuickBuildTimeOutStrategy(12345), Arrays.<BuildTimeOutOperation>asList(), "   "));
    CaptureEnvironmentBuilder captureEnvBuilder = new CaptureEnvironmentBuilder();
    project.getBuildersList().add(captureEnvBuilder);
    project.scheduleBuild2(0).get();
    EnvVars envVars = captureEnvBuilder.getEnvVars();
  ...
  @Issue(value = "JENKINS-9203") @Test public void issue9203() throws Exception {
    BuildTimeoutWrapper.MINIMUM_TIMEOUT_MILLISECONDS = 0;
    FreeStyleProject project = j.createFreeStyleProject();
  ...
  public static class ExecutionCheckBuilder extends Builder {
    ...
    @TestExtension public static class DescriptorImpl extends BuildStepDescriptor<Builder> {
      @Override public boolean isApplicable(@SuppressWarnings(value = { "rawtypes" }) Class<? extends AbstractProject> arg0) {
        return true;
      }
  ...
  public static class ExecutionCheckPublisher extends Recorder {
    ...
    @SuppressWarnings(value = { "rawtypes", "unchecked" }) @Override public BuildStepDescriptor getDescriptor() {
      return super.getDescriptor();
    }

    @TestExtension public static class DescriptorImpl extends BuildStepDescriptor<Publisher> {
      @Override public boolean isApplicable(@SuppressWarnings(value = { "rawtypes" }) Class<? extends AbstractProject> arg0) {
        return true;
      }
...
<<<<<<< /usr/src/app/output/jenkinsci/build-timeout-plugin/daeab4a1ee26e434bcc2358529b78b852819068b/src/test/java/hudson/plugins/build_timeout/BuildTimeoutWrapperIntegrationTest.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void abort() throws Exception {
    BuildTimeoutWrapper.MINIMUM_TIMEOUT_MILLISECONDS = 0;
    {
      FreeStyleProject project = j.createFreeStyleProject();
      project.getBuildWrappersList().add(new BuildTimeoutWrapper(new QuickBuildTimeOutStrategy(), false, false));
...
<<<<<<< /usr/src/app/output/jenkinsci/build-timeout-plugin/daeab4a1ee26e434bcc2358529b78b852819068b/src/test/java/hudson/plugins/build_timeout/BuildTimeoutWrapperIntegrationTest.java/left.java
  @LocalData public void testMigrationFrom_1_12_2() throws Exception {
    BuildTimeoutWrapper.MINIMUM_TIMEOUT_MILLISECONDS = 0;
    {
      ...
      assertEquals(Arrays.asList(AbortOperation.class), Lists.transform(buildTimeout.getOperationList(), new Function<BuildTimeOutOperation, Class<? extends BuildTimeOutOperation>>() {
    ...
    }
    {
      ...
      assertNotNull(buildTimeout);
      assertEquals(QuickBuildTimeOutStrategy.class, buildTimeout.getStrategy().getClass());
      assertEquals(Arrays.asList(WriteDescriptionOperation.class, AbortOperation.class), Lists.transform(buildTimeout.getOperationList(), new Function<BuildTimeOutOperation, Class<? extends BuildTimeOutOperation>>() {
        public Class<? extends BuildTimeOutOperation> apply(BuildTimeOutOperation input) {
          return input.getClass();
        }
      }));
    ...
    }
    {
      ...
      assertNotNull(buildTimeout);
      assertEquals(QuickBuildTimeOutStrategy.class, buildTimeout.getStrategy().getClass());
      assertEquals(Arrays.asList(FailOperation.class), Lists.transform(buildTimeout.getOperationList(), new Function<BuildTimeOutOperation, Class<? extends BuildTimeOutOperation>>() {
        public Class<? extends BuildTimeOutOperation> apply(BuildTimeOutOperation input) {
          return input.getClass();
        }
      }));
    ...
    }
    {
      ...
      assertNotNull(buildTimeout);
      assertEquals(QuickBuildTimeOutStrategy.class, buildTimeout.getStrategy().getClass());
      assertEquals(Arrays.asList(WriteDescriptionOperation.class, FailOperation.class), Lists.transform(buildTimeout.getOperationList(), new Function<BuildTimeOutOperation, Class<? extends BuildTimeOutOperation>>() {
        public Class<? extends BuildTimeOutOperation> apply(BuildTimeOutOperation input) {
          return input.getClass();
        }
      }));
      ...
      BuildTimeOutAction action = build.getAction(BuildTimeOutAction.class);
      assertNotNull(action);
      assertEquals(WriteDescriptionOperation.class.getSimpleName(), action.getReason());
    }
  }
=======
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @LocalData public void migrationFrom_1_12_2() throws Exception {
    BuildTimeoutWrapper.MINIMUM_TIMEOUT_MILLISECONDS = 0;
    {
  ...
  private static class TestBuildTimeOutOperation extends BuildTimeOutOperation {
    ...
    @Override public boolean perform(AbstractBuild<?, ?> build, BuildListener listener, long effectiveTimeout) {
      executed = true;
      return result;
    }
  }

  @Test public void multipleOperations() throws Exception {
    BuildTimeoutWrapper.MINIMUM_TIMEOUT_MILLISECONDS = 0;
    FreeStyleProject project = j.createFreeStyleProject();
    ...
    project.getBuildWrappersList().add(new BuildTimeoutWrapper(new QuickBuildTimeOutStrategy(1000), Arrays.<BuildTimeOutOperation>asList(op1, op2, op3)));
  ...
  @Test public void failingOperations() throws Exception {
    BuildTimeoutWrapper.MINIMUM_TIMEOUT_MILLISECONDS = 0;
    FreeStyleProject project = j.createFreeStyleProject();
    TestBuildTimeOutOperation op1 = new TestBuildTimeOutOperation();
    TestBuildTimeOutOperation op2 = new TestBuildTimeOutOperation(false);
    TestBuildTimeOutOperation op3 = new TestBuildTimeOutOperation();
    project.getBuildWrappersList().add(new BuildTimeoutWrapper(new QuickBuildTimeOutStrategy(1000), Arrays.<BuildTimeOutOperation>asList(op1, op2, op3)));
    project.getBuildersList().add(new SleepBuilder(5000));
    ExecutionCheckBuilder checkBuilder = new ExecutionCheckBuilder();
  ...
  @Test public void configurationNoOperation() throws Exception {
    FreeStyleProject p = j.createFreeStyleProject();
    p.getBuildWrappersList().add(new BuildTimeoutWrapper(new AbsoluteTimeOutStrategy(3), Collections.<BuildTimeOutOperation>emptyList(), "TESTVAR"));
    p.save();
    ...
    assertEquals(AbsoluteTimeOutStrategy.class, p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getStrategy().getClass());
    assertEquals("3", ((AbsoluteTimeOutStrategy) p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getStrategy()).getTimeoutMinutes());
    assertEquals(Collections.emptyList(), p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getOperationList());
    assertEquals("TESTVAR", p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getTimeoutEnvVar());
  }

  @Test public void configurationSingleOperation() throws Exception {
    FreeStyleProject p = j.createFreeStyleProject();
    p.getBuildWrappersList().add(new BuildTimeoutWrapper(new AbsoluteTimeOutStrategy(3), Arrays.<BuildTimeOutOperation>asList(new WriteDescriptionOperation("test")), "TESTVAR"));
    p.save();
    String fullname = p.getFullName();
    WebClient wc = j.createWebClient();
    HtmlPage page = wc.getPage(p, "configure");
    ...
    assertEquals(AbsoluteTimeOutStrategy.class, p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getStrategy().getClass());
    assertEquals("3", ((AbsoluteTimeOutStrategy) p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getStrategy()).getTimeoutMinutes());
    assertEquals(Arrays.asList(WriteDescriptionOperation.class), Lists.transform(p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getOperationList(), new Function<BuildTimeOutOperation, Class<? extends BuildTimeOutOperation>>() {
      public Class<? extends BuildTimeOutOperation> apply(BuildTimeOutOperation input) {
        return input.getClass();
      }
    }));
    assertEquals("test", ((WriteDescriptionOperation) p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getOperationList().get(0)).getDescription());
    assertEquals("TESTVAR", p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getTimeoutEnvVar());
  }

  @Test public void configurationMultipleOperation() throws Exception {
    FreeStyleProject p = j.createFreeStyleProject();
    p.getBuildWrappersList().add(new BuildTimeoutWrapper(new AbsoluteTimeOutStrategy(3), Arrays.asList(new WriteDescriptionOperation("test"), new AbortOperation()), "TESTVAR"));
    p.save();
    String fullname = p.getFullName();
    WebClient wc = j.createWebClient();
    HtmlPage page = wc.getPage(p, "configure");
    ...
    assertEquals(AbsoluteTimeOutStrategy.class, p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getStrategy().getClass());
    assertEquals("3", ((AbsoluteTimeOutStrategy) p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getStrategy()).getTimeoutMinutes());
    assertEquals(Arrays.asList(WriteDescriptionOperation.class, AbortOperation.class), Lists.transform(p.getBuildWrappersList().get(BuildTimeoutWrapper.class).getOperationList(), new Function<BuildTimeOutOperation, Class<? extends BuildTimeOutOperation>>() {
      public Class<? extends BuildTimeOutOperation> apply(BuildTimeOutOperation input) {
        return input.getClass();
      }
    }));
  ...
  @LocalData @Test public void migrationFrom_1_13() throws Exception {
    Thread.sleep(60000);
