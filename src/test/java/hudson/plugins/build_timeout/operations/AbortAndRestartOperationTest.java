...
<<<<<<< /usr/src/app/output/jenkinsci/build-timeout-plugin/daeab4a1ee26e434bcc2358529b78b852819068b/src/test/java/hudson/plugins/build_timeout/operations/AbortAndRestartOperationTest.java/left.java
  @Test public void testAbortAndRestartOnce() throws Exception {
    ...
    AbortAndRestartOperation operation = new AbortAndRestartOperation("1");
    ...
    testproject.getBuildersList().add(new SleepBuilder(5 * 60 * 1000));
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void abortAndRestartOnce() throws Exception {
    FreeStyleProject testproject = j.createFreeStyleProject();
    QuickBuildTimeOutStrategy strategy = new QuickBuildTimeOutStrategy(5000);
    AbortAndRestartOperation operation = new AbortAndRestartOperation("1");
    LinkedList<BuildTimeOutOperation> list = new LinkedList<>();
...
<<<<<<< /usr/src/app/output/jenkinsci/build-timeout-plugin/daeab4a1ee26e434bcc2358529b78b852819068b/src/test/java/hudson/plugins/build_timeout/operations/AbortAndRestartOperationTest.java/left.java
  @Test public void testAbortAndRestartTwice() throws Exception {
    FreeStyleProject testproject = j.createFreeStyleProject();
    QuickBuildTimeOutStrategy strategy = new QuickBuildTimeOutStrategy(5000);
    AbortAndRestartOperation operation = new AbortAndRestartOperation("2");
    LinkedList<BuildTimeOutOperation> list = new LinkedList<>();
    list.add(operation);
    BuildTimeoutWrapper wrapper = new BuildTimeoutWrapper(strategy, list, "");
    testproject.getBuildWrappersList().add(wrapper);
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void abortAndRestartTwice() throws Exception {
    FreeStyleProject testproject = j.createFreeStyleProject();
    QuickBuildTimeOutStrategy strategy = new QuickBuildTimeOutStrategy(5000);
    AbortAndRestartOperation operation = new AbortAndRestartOperation("2");
    LinkedList<BuildTimeOutOperation> list = new LinkedList<>();
...
<<<<<<< /usr/src/app/output/jenkinsci/build-timeout-plugin/daeab4a1ee26e434bcc2358529b78b852819068b/src/test/java/hudson/plugins/build_timeout/operations/AbortAndRestartOperationTest.java/left.java
  @Test public void testUsingVariable() throws Exception {
    FreeStyleProject p = j.createFreeStyleProject();
    p.addProperty(new ParametersDefinitionProperty(new StringParameterDefinition("RESTART", null)));
    p.getBuildWrappersList().add(new BuildTimeoutWrapper(new QuickBuildTimeOutStrategy(1000), Arrays.<BuildTimeOutOperation>asList(new AbortAndRestartOperation("${RESTART}")), ""));
    p.getBuildersList().add(new SleepBuilder(5 * 60 * 1000));
    j.assertBuildStatus(Result.ABORTED, p.scheduleBuild2(0, new Cause.UserIdCause(), new ParametersAction(new StringParameterValue("RESTART", "1"))).get());
    j.waitUntilNoActivityUpTo(25000);
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void usingVariable() throws Exception {
    FreeStyleProject p = j.createFreeStyleProject();
    p.addProperty(new ParametersDefinitionProperty(new StringParameterDefinition("RESTART", null)));
    p.getBuildWrappersList().add(new BuildTimeoutWrapper(new QuickBuildTimeOutStrategy(1000), Arrays.<BuildTimeOutOperation>asList(new AbortAndRestartOperation("${RESTART}")), ""));
    p.getBuildersList().add(new SleepBuilder(5 * 60 * 1000));
...
<<<<<<< /usr/src/app/output/jenkinsci/build-timeout-plugin/daeab4a1ee26e434bcc2358529b78b852819068b/src/test/java/hudson/plugins/build_timeout/operations/AbortAndRestartOperationTest.java/left.java
  @Test public void testUsingBadRestart() throws Exception {
    FreeStyleProject p = j.createFreeStyleProject();
    p.getBuildWrappersList().add(new BuildTimeoutWrapper(new QuickBuildTimeOutStrategy(1000), Arrays.<BuildTimeOutOperation>asList(new AbortAndRestartOperation("${RESTART}")), ""));
    p.getBuildersList().add(new SleepBuilder(5 * 60 * 1000));
    j.assertBuildStatus(Result.ABORTED, p.scheduleBuild2(0, new Cause.UserIdCause(), new ParametersAction(new StringParameterValue("RESTART", "xxx"))).get());
    j.waitUntilNoActivityUpTo(25000);
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void usingBadRestart() throws Exception {
    FreeStyleProject p = j.createFreeStyleProject();
    p.getBuildWrappersList().add(new BuildTimeoutWrapper(new QuickBuildTimeOutStrategy(1000), Arrays.<BuildTimeOutOperation>asList(new AbortAndRestartOperation("${RESTART}")), ""));
    p.getBuildersList().add(new SleepBuilder(5 * 60 * 1000));
    j.assertBuildStatus(Result.ABORTED, p.scheduleBuild2(0, new Cause.UserIdCause(), new ParametersAction(new StringParameterValue("RESTART", "xxx"))).get());
