...
public class MoneyTest extends TestCase {
  ...
  public void testDoubleMultiply() {
    ...
    final Money res5 = lng4.multiply(1.0 / 7.0);
    assertTrue(res5 instanceof MoneyBigDecimal);
    String val1 = "0.000000000000000000000005";
  ...
  public void testDivisionRounding() {
    ...
    for (long i = 0; i < 10000; i += 2) {
      ...
      final Money res = src.divide(2.0, 1);
  ...
  public void testMultiplicationIssue14() {
    ...
    double currentAllocationD = moneyValue.multiply(100).divide(totalValue.toDouble(), 4).toDouble();
    Money currentAllocation = moneyValue.multiply(100).divide(totalValue.toDouble(), 4);
