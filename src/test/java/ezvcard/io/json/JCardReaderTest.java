...
public class JCardReaderTest {
  ...
  @Test public void read_single() throws Throwable {
    ...
    assertSimpleProperty(vcard.getFormattedNames()).value("John Doe").noMore();
    assertWarnings(0, reader);
    assertNoMoreVCards(reader);
  }

  @Test public void read_multiple() throws Throwable {
    ...
    assertVersion(V4_0, vcard);
    assertPropertyCount(1, vcard);
    assertSimpleProperty(vcard.getFormattedNames()).value("Jane Doe").noMore();
    assertWarnings(0, reader);
    assertNoMoreVCards(reader);
  }

  @Test public void no_version() throws Exception {
    String json = "[\"vcard\"," + "[" + "[\"fn\", {}, \"text\", \"John Doe\"]" + "]" + "]";
    JCardReader reader = new JCardReader(json);
    VCard vcard = reader.readNext();
    assertVersion(V4_0, vcard);
    assertPropertyCount(1, vcard);
  ...
  @Test public void invalid_version() throws Exception {
    String json = "[\"vcard\"," + "[" + "[\"version\", {}, \"text\", \"3.0\"]," + "[\"fn\", {}, \"text\", \"John Doe\"]" + "]" + "]";
    JCardReader reader = new JCardReader(json);
    VCard vcard = reader.readNext();
    assertVersion(V4_0, vcard);
    assertPropertyCount(1, vcard);
  ...
  @Test public void no_properties() throws Throwable {
    String json = "[\"vcard\"," + "[" + "]" + "]";
    JCardReader reader = new JCardReader(json);
    VCard vcard = reader.readNext();
    assertVersion(V4_0, vcard);
  ...
  @Test public void no_properties_multiple() throws Throwable {
    String json = "[" + "[\"vcard\"," + "[" + "]" + "]," + "[\"vcard\"," + "[" + "]" + "]" + "]";
    JCardReader reader = new JCardReader(json);
    VCard vcard = reader.readNext();
    assertVersion(V4_0, vcard);
    assertPropertyCount(0, vcard);
  ...
  @Test public void extendedType() throws Throwable {
    String json = "[\"vcard\"," + "[" + "[\"version\", {}, \"text\", \"4.0\"]," + "[\"x-type\", {}, \"text\", \"value\"]" + "]" + "]";
    JCardReader reader = new JCardReader(json);
    VCard vcard = reader.readNext();
    assertVersion(V4_0, vcard);
    assertPropertyCount(1, vcard);
    assertRawProperty("x-type", vcard).value("value").noMore();
    assertWarnings(0, reader);
  }

  @Test public void registerExtendedType() throws Throwable {
    String json = "[\"vcard\"," + "[" + "[\"version\", {}, \"text\", \"4.0\"]," + "[\"x-type\", {}, \"text\", \"value\"]" + "]" + "]";
    JCardReader reader = new JCardReader(json);
  ...
  @Test public void readExtendedType_override_standard_type_classes() throws Throwable {
    String json = "[\"vcard\"," + "[" + "[\"version\", {}, \"text\", \"4.0\"]," + "[\"fn\", {}, \"text\", \"John Doe\"]" + "]" + "]";
    JCardReader reader = new JCardReader(json);
  ...
  @Test public void cannotParseException() throws Throwable {
    ...
    assertRawProperty("x-foo", vcard).value("value").noMore();
    assertRawProperty("cannotparse", vcard).value("value").noMore();
    assertWarnings(1, reader);
  }
  ...
  @Test public void utf8() throws Throwable {
    ...
    VCard vcard = reader.readNext();
    assertPropertyCount(1, vcard);
    assertSimpleProperty(vcard.getNotes()).value("\u019dote").noMore();
    assertWarnings(0, reader);
    assertNoMoreVCards(reader);
  }
  ...
  private static class TypeForTesting extends VCardProperty {
    ...
    @Override public TypeForTesting copy() {
  ...
  private static class TypeForTestingScribe extends VCardPropertyScribe<TypeForTesting> {
    ...
    @Override protected String _writeText(TypeForTesting property, VCardVersion version) {
      return "";
    }

    @Override protected TypeForTesting _parseText(String value, VCardDataType dataType, VCardVersion version, VCardParameters parameters, List<String> warnings) {
      return new TypeForTesting(null);
    }

    @Override protected TypeForTesting _parseJson(JCardValue value, VCardDataType dataType, VCardParameters parameters, List<String> warnings) {
...
<<<<<<< /usr/src/app/output/mangstadt/ez-vcard/63ab6b841a7aa31372315a902b98fc5b2cc3b661/src/test/java/ezvcard/io/json/JCardReaderTest.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  public static void validateExampleJCard(VCard vcard) {
    ...
    assertTelephone(vcard).uri(new TelUri.Builder("+1-418-656-9254").extension("102").build()).types(TelephoneType.WORK, TelephoneType.VOICE).param("PREF", "1").next().uri(new TelUri.Builder("+1-418-262-6501").build()).types(TelephoneType.WORK, TelephoneType.VOICE, TelephoneType.CELL, TelephoneType.VIDEO, TelephoneType.TEXT).noMore();
