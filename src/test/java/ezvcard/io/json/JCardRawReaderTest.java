...
public class JCardRawReaderTest {
  @Test public void basic() throws Throwable {
  ...
  @Test public void ignore_other_json() throws Throwable {
  ...
  @Test public void bad_snytax() throws Throwable {
  ...
  @Test public void empty_properties_array() throws Throwable {
    String json = "[\"vcard\"," + "[" + "]" + "]";
    JCardRawReader reader = createReader(json);
    JCardDataStreamListener listener = mock(JCardDataStreamListener.class);
    reader.readNext(listener);
  ...
  @Test public void structured_value() throws Throwable {
  ...
  @Test public void multi_value() throws Throwable {
  ...
  @Test public void different_data_types() throws Throwable {
  ...
  @Test public void complex_value() throws Throwable {
  ...
  @Test public void data_type_unknown() throws Throwable {
  ...
  @Test public void data_type_unrecognized() throws Throwable {
  ...
  @Test public void empty() throws Throwable {
    String json = "";
    JCardRawReader reader = createReader(json);
    JCardDataStreamListener listener = mock(JCardDataStreamListener.class);
    reader.readNext(listener);
  ...
  @Test public void no_vcard() throws Throwable {
    String json = "{" + "\"foo\": \"bar\"" + "}";
    JCardRawReader reader = createReader(json);
    JCardDataStreamListener listener = mock(JCardDataStreamListener.class);
    reader.readNext(listener);
  ...
  @Test public void parameters() throws Throwable {
  ...
  @Test public void group() throws Throwable {
