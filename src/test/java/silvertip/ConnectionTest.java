...
public class ConnectionTest {
  ...
  @Test public void garbledMessage() throws Exception {
  ...
  @Test public void partialMessage() throws Exception {
  ...
  @Test public void multipleMessages() throws Exception {
  ...
  @Test public void idle() throws Exception {
    Callback callback = new Callback() {
  ...
  @Test public void denied() throws Exception {
    final String message = "The quick brown fox jumps over the lazy dog";
    final AtomicBoolean connectionClosed = new AtomicBoolean(false);
    Callback callback = new Callback() {
      @Override public void closed(Connection<Message> connection) {
  ...
  private void sendMessage(String message, Connection.Callback<Message> callback, MessageParser<Message> parser) throws InterruptedException, IOException {
    sendMessage(message, callback, parser, 0);
  }

  private void sendMessage(String message, Connection.Callback<Message> callback, MessageParser<Message> parser, int options) throws InterruptedException, IOException {
