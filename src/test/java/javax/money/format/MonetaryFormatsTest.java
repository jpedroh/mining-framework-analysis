...
public class MonetaryFormatsTest {
  @Test public void testGetAmountFormatLocale() {
  ...
  @Test(expectedExceptions = MonetaryException.class) public void testGetAmountFormatLocale_Invalid() {
    MonetaryFormats.getAmountFormat(new Locale("foo", "bar"));
  }

  @Test public void testGetAvailableLocales() {
  ...
  @Test public void testIsAvailable_Locale_Providers() {
  ...
  @Test public void testIsAvailable_Query() {
  ...
  @Test public void testGetAmountFormats_Query() {
  ...
  @Test public void testGeAmountFormat_Name_Providers() {
  ...
  @Test public void testGetProviderNames() {
  ...
  @Test public void testGetDefaultProviderChain() {
