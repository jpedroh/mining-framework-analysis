...
public class MonetaryCurrenciesSingletonSpiTest {
  private MonetaryCurrenciesSingletonSpi testSpi = new MonetaryCurrenciesSingletonSpi() {
    ...
    @Override public Set<String> getProviderNames() {
      return new HashSet(Arrays.asList(new String[] { "a", "b" }));
    }

    @Override public Set<CurrencyUnit> getCurrencies(CurrencyQuery query) {
  ...
  @Test public void testGetCurrency_String() {
  ...
  @Test public void testGetCurrency_Locale() {
    CurrencyUnit cu = testSpi.getCurrency(Locale.GERMANY, "a");
    assertNotNull(cu);
  }

  @Test public void testGetCurrencies_Locale() {
    Set<CurrencyUnit> curs = testSpi.getCurrencies(Locale.FRANCE, "a");
    assertNotNull(curs);
  }

  @Test public void testIsCurrencyAvailable_String() {
  ...
  @Test public void testIsCurrencyAvailable_Locale() {
  ...
  @Test public void testGetCurrencies_String() {
  ...
  @Test public void testGetCurrency_Query() {
