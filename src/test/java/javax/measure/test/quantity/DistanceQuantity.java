...
public class DistanceQuantity extends TestQuantity<Length> {
  ...
  public Measurement<Length> subtract(Measurement<Length> that) {
    return null;
  }

  @Override public Quantity<?> divide(Quantity<?> that) {
    return null;
  }

  @Override public Quantity<Length> to(Unit<Length> unit) {
    return null;
  }
  ...
  @Override public Quantity<Length> subtract(Quantity<Length> that) {
    return null;
  }

  @Override public Quantity<Length> add(Quantity<Length> that) {
    return null;
  }

  @Override public Quantity<Length> divide(Number that) {
    return null;
  }

  @Override public Quantity<Length> inverse() {
    return null;
  }

  @Override public Quantity<?> multiply(Quantity<?> that) {
  ...
  @Override public Quantity<Length> multiply(Number that) {
    return null;
  }
}