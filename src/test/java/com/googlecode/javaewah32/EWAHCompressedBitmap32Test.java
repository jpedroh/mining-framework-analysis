 ...
 */
@SuppressWarnings(value = { "javadoc" }) public class EWAHCompressedBitmap32Test {
  ...
  /**
     ...
     */
  @Test public void habermaasTest() {
  ...
  /**
     ...
     */
  @Test public void testExternalization() throws IOException {
