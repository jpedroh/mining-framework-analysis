...
public class FunctionTest {
  @Test public void testArithmeticExpression() {
    ...
    assertEquals(6 - (4 / 2 - (4 + 5)) * 2 + 100 / (2 + 1) * 20 - 5 * 5 * 5 + (6 + 1) / (2 - 3 / (1 + 1)), AviatorEvaluator.execute("6-(4/2-(4+5))*2+100/(2+1)*20-5*5*5+(6+1)/(2-3/(1+1))"));
    ...
    assertEquals(100 % 3 * 4.2 + (37 + 95) / (6 * 3 - 18.0), (Double) AviatorEvaluator.execute("100%3*4.2+(37+95)/(6*3-18.0)"), 0.0001);
  }
  ...
  @Test public void testArithmeticExpressionWithVariable() {
    ...
    assertEquals(i * pi + (d * b - 199) / (1 - d * pi) - (2 + 100 - i / pi) % 99, AviatorEvaluator.execute("i * pi + (d * b - 199) / (1 - d * pi) - (2 + 100 - i / pi) % 99", env));
  }

  @Test public void testOperatorPrecedence() {
    assertEquals(false, AviatorEvaluator.execute("6.7-100>39.6 ? 5==5? 4+5:6-1 : !false ? 5-6>0&& false: 100%3<=5 || 67*40>=100"));
  }

  @Test public void testLogicExpression() {
  ...
  @Test public void testLogicExpressionWithVariable() {
    Map<String, Object> env = new HashMap<String, Object>();
    int i = 100;
    float pi = 3.14f;
    double d = -3.9;
    ...
    assertEquals(true, AviatorEvaluator.execute("i * pi + (d * b - 199) / (1 - d * pi) - (2 + 100 - i / pi) % 99 ==i * pi + (d * b - 199) / (1 - d * pi) - (2 + 100 - i / pi) % 99", env));
  }

  @Test public void testSystemFunction() {
  ...
  @Test public void testSeqFunction() {
    Map<String, Object> env = new HashMap<String, Object>();
  ...
  @Test public void testBitOperations() {
    ...
    assertEquals(4 / 2 * 3 - 4 + (5 ^ 5 - 2 & 3) == 4000 ? !false && true ? 1 & 4 : 0 : 6L >> 2L * 2L / 4L ^ ~699L + 100L << 4L >> 5L >> 1000L, AviatorEvaluator.execute("4 / 2 * 3 - 4 + (5 ^ 5 - 2 & 3) == 4000 ? (!false && true ? 1 & 4 : 0) : 6 >> 2 * 2 / 4^ ~699 + 100 << 4 >> 5 >> 1000"));
    assertEquals((99 & 7) == (99 & 7) && false, AviatorEvaluator.execute("(99&7)==(99&7)&&false "));
    assertEquals((99 | 7) != (99 | 7) || false, AviatorEvaluator.execute("(99|7)!=(99|7)||false "));
  }

  @Test public void testBitOperationsWithVariable() {
    Map<String, Object> env = new HashMap<String, Object>();
    long i = 100;
    long j = -99;
    long k = 7;
    ...
    assertEquals(i ^ j ^ k & i & j & k | i | j | k & 3 & 4 | 5 & ~i, AviatorEvaluator.execute("i^j^k&i&j&k|i|j|k&3&4|5&~i", env));
    assertEquals(4 / 2 * 3 - 4 + (5 ^ 5 - 2 & 3) == 4000 ? !false && true ? 1 & 4 : 0 : i >> j * k / i ^ ~j + k << i >> j >> 1000L, AviatorEvaluator.execute("4 / 2 * 3 - 4 + (5 ^ 5 - 2 & 3) == 4000 ? (!false && true ? 1 & 4 : 0) :i >> j * k / i ^ ~j + k << i >> j >> 1000", env));
  ...
  @Test public void testHexNumber() {
    Map<String, Object> env = new HashMap<String, Object>();
    long i = 100;
    float j = -99;
    int k = 7;
    ...
    assertEquals(0x45 > i ? 0x11 - 0344 * 5 / 7 : k / 0xFF - j * 0x45, AviatorEvaluator.execute("0x45>i?0x11-0344*5/7:k/0xFF-j*0x45 ", env));
  }

  @Test public void testBitOp_BitMap() {
    Map<String, Object> env = new HashMap<String, Object>();
    int flag = 0;
    env.put("flag", flag);
  ...
  @Test public void testMathFunction() {
  ...
  @Test public void testParseScientificNotations() {
  ...
  @Test public void testParseBigNumbers() {
    assertEquals(new BigInteger("99999999999999999999999999999999"), AviatorEvaluator.exec("99999999999999999999999999999999"));
    assertEquals(new BigInteger("99999999999999999999999999999999"), AviatorEvaluator.exec("99999999999999999999999999999999N"));
    assertEquals(new BigInteger("199999999999999999999999999999998"), AviatorEvaluator.exec("99999999999999999999999999999999+99999999999999999999999999999999"));
    Env env = new Env(null);
    env.setInstance(AviatorEvaluator.getInstance());
    assertEquals(new BigDecimal("99999999999999999999999999999999.99999999", RuntimeUtils.getMathContext(env)), AviatorEvaluator.exec("99999999999999999999999999999999.99999999M"));
  }

  @Test public void testGetVariableNames() {
  ...
  @Test public void testArrayAccess() {
    ...
    assertEquals(a[1] + b[0][2] * c[1][1][1] / (a[2] * a[1] + 100 - c[0][1][1] * b[0][1]), AviatorEvaluator.execute("a[1]+b[0][2]*c[1][1][1]/(a[2]*a[1]+100-c[0][1][1]*b[0][1])", env));
  ...
  @Test public void testBigNumberNegative() {
    assertEquals(new BigInteger("-1000000000000000000000000000000000"), AviatorEvaluator.exec("-a", new BigInteger("1000000000000000000000000000000000")));
    assertEquals(new BigDecimal("9999999999999999999999999999999999999.99999999999"), AviatorEvaluator.exec("-a", new BigDecimal("-9999999999999999999999999999999999999.99999999999")));
    assertEquals(new BigDecimal("9999999999999999999.999999999999"), AviatorEvaluator.exec("-(-9999999999999999999.999999999999M)"));
    assertEquals(new BigInteger("9999999999999999999"), AviatorEvaluator.exec("-(-9999999999999999999N)"));
  }

  @Test public void testBigNumberBitOperations() {
    assertEquals(new BigInteger("1000000000000000000000000000000000").xor(new BigInteger("9999999999999999999999")), AviatorEvaluator.exec("a^b", new BigInteger("1000000000000000000000000000000000"), new BigInteger("9999999999999999999999")));
    assertEquals(new BigInteger("1000000000000000000000000000000000").and(new BigInteger("9999999999999999999999")), AviatorEvaluator.exec("a&b", new BigInteger("1000000000000000000000000000000000"), new BigInteger("9999999999999999999999")));
    assertEquals(new BigInteger("1000000000000000000000000000000000").or(new BigInteger("9999999999999999999999")), AviatorEvaluator.exec("a|b", new BigInteger("1000000000000000000000000000000000"), new BigInteger("9999999999999999999999")));
    assertEquals(new BigInteger("1000000000000000000000000000000000").shiftLeft(2), AviatorEvaluator.exec("a<<2", new BigInteger("1000000000000000000000000000000000")));
    assertEquals(new BigInteger("1000000000000000000000000000000000").shiftRight(2), AviatorEvaluator.exec("a>>2", new BigInteger("1000000000000000000000000000000000")));
    assertEquals(new BigInteger("1000000000000000000000000000000000").shiftRight(2), AviatorEvaluator.exec("a>>>2", new BigInteger("1000000000000000000000000000000000")));
  }

  @Test(expected = ExpressionRuntimeException.class) public void testDecimalBitAnd() {
    AviatorEvaluator.exec("3M< & 2M");
  }

  @Test public void testAlwaysUseDoubleAsDecimal() {
  ...
  @Test public void testOtherFunction() {
    assertTrue((Boolean) AviatorEvaluator.execute("\'A\' == \'A\' || \'B\' == \'B\' && \'ABCD\' == t &&  \'A\' == \'A\'"));
  }

  @Test public void testDisablePropertySyntaxSugar() {
  ...
  @Test public void testPropertyNilNotFound() {
    Map<String, Object> env = createUsersEnv();
    try {
  ...
  @Test public void testSeqFilterListWithProperty() {
    Map<String, Object> env = createUsersEnv();
    Object result = AviatorEvaluator.execute("filter(data,seq.and(seq.gt(25,\'age\'),seq.eq(\'\u674e\u56db\',\'name\')))", env);
  ...
  @Test public void testSeqFilterMapWithProperty() {
    ...
    Object result = AviatorEvaluator.execute("filter(data,seq.and(seq.gt(25,\'value.age\'),seq.eq(\'\u674e\u56db\',\'value.name\')))", env);
    Map map = (Map) result;
  ...
  @Test public void testTuple() {
    assertArrayEquals(new Object[] { 1, "hello", 3.2 }, (Object[]) AviatorEvaluator.execute("tuple(1,\'hello\',3.2)"));
    ...
    assertArrayEquals(new Object[] { 2, 3, 4 }, (Object[]) AviatorEvaluator.execute("map(tuple(1,2,3), lambda(x) -> x +1 end)"));
  ...
  @Test public void testSeqMinMaxFunction() {
  ...
  @Test public void testSeqNewList() {
    ...
    assertEquals(newList(1L, "hello"), AviatorEvaluator.execute("seq.add(seq.add(seq.list(), 1), \'hello\')"));
    assertEquals(newList("hello"), AviatorEvaluator.execute("seq.remove(seq.add(seq.add(seq.list(), 1), \'hello\'), 1)"));
  ...
  @Test public void testSeqNewMap() {
    ...
    map.remove(3L);
    assertEquals(map, AviatorEvaluator.execute("seq.remove(seq.add(seq.map(1,2,3,4), \'a\',\'b\'), 3)"));
    map.remove("a");
    assertEquals(map, AviatorEvaluator.execute("seq.remove(seq.remove(seq.add(seq.map(1,2,3,4), \'a\',\'b\'), 3), \'a\')"));
  ...
  @Test public void testSeqNewSet() {
    ...
    assertEquals(newSet(1L, "hello"), AviatorEvaluator.execute("seq.add(seq.add(seq.set(), 1), \'hello\')"));
    assertEquals(newSet("hello"), AviatorEvaluator.execute("seq.remove(seq.add(seq.add(seq.set(), 1), \'hello\'), 1)"));
  ...
  @Test public void testSystemMinMaxFunction() {
