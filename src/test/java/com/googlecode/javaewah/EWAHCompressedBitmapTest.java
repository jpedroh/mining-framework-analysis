 ...
 */
@SuppressWarnings(value = { "javadoc" }) public class EWAHCompressedBitmapTest {
  @Test public void reverseIntIterator() {
  ...
  @Test public void reverseIntIteratorOverBitmapsOfOnes() {
    EWAHCompressedBitmap bitmap = EWAHCompressedBitmap.bitmapOf();
  ...
  @Test public void reverseIntIteratorOverBitmapsOfZeros() {
    EWAHCompressedBitmap bitmap = EWAHCompressedBitmap.bitmapOf();
  ...
  @Test public void reverseIntIteratorOverBitmapsOfOnesAndZeros() {
    EWAHCompressedBitmap bitmap = EWAHCompressedBitmap.bitmapOf();
  ...
  @Test public void chunkIterator() {
  ...
  @Test public void chunkIteratorOverBitmapOfZeros() {
    EWAHCompressedBitmap bitmap = EWAHCompressedBitmap.bitmapOf();
    bitmap.setSizeInBits(WORD_IN_BITS, false);
    ChunkIterator iterator = bitmap.chunkIterator();
    Assert.assertTrue(iterator.hasNext());
  ...
  @Test public void chunkIteratorOverBitmapOfZerosAndOnes() {
    EWAHCompressedBitmap bitmap = EWAHCompressedBitmap.bitmapOf();
  ...
  @Test public void chunkIteratorOverBitmapOfOnesAndZeros() {
    EWAHCompressedBitmap bitmap = EWAHCompressedBitmap.bitmapOf();
    bitmap.setSizeInBits(WORD_IN_BITS - 10, true);
  ...
  @Test public void simpleCompose() {
  ...
  @Test public void composeBitmapOfOnesWithItself() {
    EWAHCompressedBitmap bitmap = EWAHCompressedBitmap.bitmapOf();
    bitmap.setSizeInBits(WORD_IN_BITS, true);
  ...
  @Test public void composeBitmapOfZerosAndOnesWithBitmapOfOnes() {
  ...
  @Test public void composeBitmapOfOnesWithBitmapOfZerosAndOnes() {
    EWAHCompressedBitmap bitmap1 = EWAHCompressedBitmap.bitmapOf();
    bitmap1.setSizeInBits(2 * WORD_IN_BITS, true);
    EWAHCompressedBitmap bitmap2 = EWAHCompressedBitmap.bitmapOf();
  ...
  @Test public void composeBitmapWithBitmapOfZeros() {
  ...
  @Test public void testAstesana2() {
    for (int k = 1; k < 256; ++k) {
      EWAHCompressedBitmap bm = new EWAHCompressedBitmap();
      bm.set(0);
      bm.setSizeInBits(k, false);
  ...
  @Test public void testClearIntIterator() {
  ...
  @Test public void clearIntIteratorOverBitmapOfZeros() {
  ...
  @SuppressWarnings(value = { "deprecation", "boxing" }) @Test public void OKaserBugReportJuly2013() {
  ...
  @Test public void testSizeInBitsWithAnd() {
  ...
  @Test public void testSizeInBitsWithAndNot() {
  ...
  @Test public void testSizeInBitsWithOr() {
  ...
  @Test public void testSizeInBitsWithXor() {
  ...
  @Test public void testDebugSetSizeInBitsTest() {
  ...
  /**
     ...
     */
  @Test public void EwahIteratorProblem() {
  ...
  /**
     ...
     */
  @Test public void SsiYanKaiTest() {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "ForLoopReplaceableByForEach" }) @Test public void habermaasTest() {
  ...
  @Test public void testAndResultAppend() {
  ...
  /**
     ...
     */
  @Test public void testEWAHCompressedBitmap() {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "ForLoopReplaceableByForEach" }) @Test public void testExternalization() throws IOException {
  ...
  @Test public void testExtremeRange() {
  ...
  /**
     ...
     */
  @Test public void testIntersectsMethod() {
  ...
  /**
     ...
     * bound exception.
     */
  @Test public void testLargeEWAHCompressedBitmap() {
  ...
  /**
     * Test massive and.
     */
  @Test public void testMassiveAnd() {
    ...
    Assert.assertTrue(EWAHCompressedBitmap.and(ewah).toList().size() == 0);
  }

  /**
     * Test massive and not.
     */
  @Test public void testMassiveAndNot() {
  ...
  @Test public void testsetSizeInBits() {
  ...
  @Test public void testOrCardinality() {
    ...
    for (int N = 0; N < 1024; ++N) {
      ...
      Assert.assertEquals(N + 2, bitmap.orCardinality(new EWAHCompressedBitmap()));
    }
  }
  ...
  /**
     * Test sets and gets.
     */
  @SuppressWarnings(value = { "ForLoopReplaceableByForEach" }) @Test public void testSetGet() {
  ...
  /**
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
  @Test public void testWithParameters() throws IOException {
  ...
  /**
     ...
     * deterministic.)
     */
  @Test public void vanSchaikTest() {
  ...
  @Test public void TestCloneEwahCompressedBitArray() {
  ...
  @Test public void testSizeInBits1() {
    EWAHCompressedBitmap bitmap = new EWAHCompressedBitmap();
  ...
  @Test public void testHasNextSafe() {
    EWAHCompressedBitmap bitmap = new EWAHCompressedBitmap();
    bitmap.set(0);
  ...
  @Test public void testHasNextSafe2() {
    EWAHCompressedBitmap bitmap = new EWAHCompressedBitmap();
    bitmap.set(0);
    IntIterator it = bitmap.intIterator();
    Assert.assertEquals(0, it.next());
  ...
  @Test public void testSizeInBits2() {
    EWAHCompressedBitmap bitmap = new EWAHCompressedBitmap();
