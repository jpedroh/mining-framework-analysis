 ...
 * minutes.
 */
@RunWith(value = Theories.class) public class ZMTPMessageParserTest {
  public static final int CPUS = Runtime.getRuntime().availableProcessors();

  public static final ExecutorService EXECUTOR = MoreExecutors.getExitingExecutorService((ThreadPoolExecutor) Executors.newFixedThreadPool(CPUS), 0, SECONDS);

  @DataPoints public static Parameters[] PARAMETERS = { test(input("1"), enveloped()), test(input("2", ""), enveloped()), test(input("3", "aa"), enveloped()), test(input("4", "", "a"), enveloped()), test(input("5", "", "a", "bb"), enveloped()), test(input("6", "aa", "", "b", "cc"), enveloped()), test(input("7", "", "a"), nonEnveloped()), test(input("8", "", "b", "cc"), nonEnveloped()), test(input("9", "aa", "", "b", "cc"), nonEnveloped()), test(input("a", "bb", "", "c", "dd", "", "eee"), nonEnveloped(limit(1), truncated(9, "a")), nonEnveloped(limit(2), truncated(9, "a")), nonEnveloped(limit(3), truncated(9, "a", "bb", "")), nonEnveloped(limit(4), truncated(9, "a", "bb", "", "c")), nonEnveloped(limit(5), truncated(9, "a", "bb", "", "c")), nonEnveloped(limit(6), truncated(9, "a", "bb", "", "c", "dd", "")), nonEnveloped(limit(7), truncated(9, "a", "bb", "", "c", "dd", "")), nonEnveloped(limit(8), truncated(9, "a", "bb", "", "c", "dd", "")), nonEnveloped(limit(9), whole(9, "a", "bb", "", "c", "dd", "", "eee")), enveloped(limit(1), truncated(9, "a")), enveloped(limit(2), truncated(9, "a")), enveloped(limit(3), truncated(9, "a", "bb", "")), enveloped(limit(4), truncated(9, "a", "bb", "", "c")), enveloped(limit(5), truncated(9, "a", "bb", "", "c")), enveloped(limit(6), truncated(9, "a", "bb", "", "c", "dd", "")), enveloped(limit(7), truncated(9, "a", "bb", "", "c", "dd", "")), enveloped(limit(8), truncated(9, "a", "bb", "", "c", "dd", "")), enveloped(limit(9), whole(9, "a", "bb", "", "c", "dd", "", "eee"))) };

  @Theory public void testParse(final Parameters parameters) throws Exception {
  ...
  private void testParse(final boolean enveloped, final Limit limit, final List<String> input, final ZMTPParsedMessage expected, int version) throws Exception {
    ...
    new Fragmenter(serialized.readableBytes()).fragment(new Fragmenter.Consumer() {
      @Override public void fragments(final int[] limits, final int count) throws Exception {
        serialized.setIndex(0, serializedLength);
  ...
  static class Parameters {
    ...
    Parameters(final List<String> inputFrames, final List<Verification> verifications) {
    ...
    private static Verification verification(final List<String> input, final Expectation e) {
    ...
    public static Expectation nonEnveloped(final Limit sizeLimit, final ZMTPParsedMessage expected) {
    ...
    public static Output output(final boolean truncated, final long byteSize, final String... frames) {
    ...
    public static Expectation expectation(final boolean enveloped, final Limit sizeLimit, final ZMTPParsedMessage expected) {
  ...
  static class Verification {
    ...
    public Verification(final boolean enveloped, final Limit sizeLimit, final List<String> inputFrames, final ZMTPParsedMessage expectedMessage) {
