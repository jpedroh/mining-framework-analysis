...
public class ZMTPUtilsTests {
  @Test public void frameSizeTest() {
  ...
  @Test public void messageSizeTest() {
    ...
    @SuppressWarnings(value = { "unchecked" }) final List<List<ZMTPFrame>> frameSets = asList(EMPTY, asList(ZMTPFrame.create("foo")), asList(ZMTPFrame.create("foo"), ZMTPFrame.create("bar")), manyFrameSizes);
