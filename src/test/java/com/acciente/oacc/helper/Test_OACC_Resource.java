...
public class Test_OACC_Resource {
  @Test public void meta_checkPasswords() {
  ...
  @Test public void meta_equalityOfResourcesWithEncryptedPasswords() {
    PasswordEncryptor passwordEncryptor = JasyptPasswordEncryptor.getPasswordEncryptor();
    final char[] plaintext = "abc".toCharArray();
    final String digest_01 = passwordEncryptor.encryptPassword(PasswordUtils.computeBoundPassword(Resources.getInstance(0), plaintext));
    final String digest_02 = passwordEncryptor.encryptPassword(PasswordUtils.computeBoundPassword(Resources.getInstance(0), plaintext));
