...
public class SQLAccessControlSystemResetUtil {
  public static void resetOACC(Connection connection, String dbSchema, char[] oaccRootPwd, PasswordEncryptor passwordEncryptor) throws SQLException {
  ...
  public static void resetOACC(DataSource dataSource, String dbSchema, char[] oaccRootPwd, PasswordEncryptor passwordEncryptor) throws SQLException {
  ...
  public static void deleteAllOACCData(Connection connection, String dbSchema) throws SQLException {
  ...
  protected static void deleteDomainsIndividually(Connection connection, String schemaNameAndTablePrefix) throws SQLException {
    try (PreparedStatement selectStatement = connection.prepareStatement("SELECT DomainID FROM " + schemaNameAndTablePrefix + "Domain WHERE DomainID NOT IN (" + "SELECT ParentDomainID FROM " + schemaNameAndTablePrefix + "Domain WHERE ParentDomainID IS NOT NULL)"); PreparedStatement deleteStatement = connection.prepareStatement("DELETE FROM " + schemaNameAndTablePrefix + "Domain WHERE DomainID = ?")) {
