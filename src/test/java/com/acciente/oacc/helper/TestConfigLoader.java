...
public class TestConfigLoader {
  ...
  static {
    try {
      ...
      if (sqlTypeName == null) {
        throw new RuntimeException("no " + PROP_SQL_PROFILE + " property specified in database configuration property file");
      }
      sqlProfile = SQLProfile.valueOf(sqlTypeName);
      for (String propertyName : properties.stringPropertyNames()) {
        if (!(PROP_DATA_SOURCE_CLASS.equals(propertyName) || PROP_SQL_PROFILE.equals(propertyName) || PROP_DB_SCHEMA.equals(propertyName) || PROP_PWD_ENCRYPTOR.equals(propertyName) || PROP_OACC_ROOT_PWD.equals(propertyName))) {
      ...
      if (pwdEncryptor == null) {
        throw new RuntimeException("no " + PROP_PWD_ENCRYPTOR + " property specified in database configuration property file");
      }
  ...
  private static void setDataSourceProperty(DataSource vendorSpecificDataSource, String propertyName, String valueAsString) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
    ...
    if (valueAsInteger == null && valueAsString != null) {
      ...
      if (trimmedAndLowerCasedValue.equals("true")) {
        ...
        if (trimmedAndLowerCasedValue.equals("false")) {
    ...
    final Method setMethod = vendorSpecificDataSource.getClass().getMethod(methodName, valueAsInteger != null ? int.class : valueAsBoolean != null ? boolean.class : String.class);
    setMethod.invoke(vendorSpecificDataSource, valueAsInteger != null ? valueAsInteger : valueAsBoolean != null ? valueAsBoolean : valueAsString);
  }
