...
public class NotifierTest {
  ...
  private static final String HTTP_CLONE_URL = "http://some.stash.com/scm/foo/bar.git";

  private static final String SSH_CLONE_URL = "ssh://git@some.stash.com:12345/foo/bar.git";

  private static final String CUSTOM_CLONE_URL = "http://custom.host/custom.git";
    ...
    try {
      ...
      when(escalatedSecurityContext.call(any(Operation.class))).thenAnswer(new Answer<Object>() {
        @Override public Object answer(InvocationOnMock invocation) throws Throwable {
          ...
          Operation<Object, Throwable> op = (Operation<Object, Throwable>) args[0];
          return op.perform();
        }
      });
    } catch (Throwable t) {
   ...
   * @throws Exception
   */
  @Test public void shouldReturnEarlyWhenHookIsNull() throws Exception {
   ...
   * @throws Exception
   */
  @Test public void shouldReturnEarlyWhenHookIsNotEnabled() throws Exception {
   ...
   * @throws Exception
   */
  @Test public void shouldReturnEarlyWhenSettingsAreNull() throws Exception {
   ...
   * @throws Exception
   */
  @Test public void shouldCallTheCorrectUrlWithHttpCloneType() throws Exception {
    when(settings.getString(Notifier.CLONE_TYPE)).thenReturn("http");
    notifier.notify(repo, "refs/heads/master", "sha1");
    ...
    assertEquals("http://localhost.jenkins/git/notifyCommit?" + "url=http%3A%2F%2Fsome.stash.com%2Fscm%2Ffoo%2Fbar.git" + "&branches=refs%2Fheads%2Fmaster" + "&sha1=sha1", captor.getValue().getURI().toString());
  }
   ...
   * @throws Exception
   */
  @Test public void shouldCallTheCorrectUrlWithSshCloneType() throws Exception {
    ...
    verify(httpClient, times(1)).execute(captor.capture());
    verify(connectionManager, times(1)).shutdown();
    assertEquals("http://localhost.jenkins/git/notifyCommit?" + "url=ssh%3A%2F%2Fgit%40some.stash.com%3A12345%2Ffoo%2Fbar.git" + "&branches=refs%2Fheads%2Fmaster" + "&sha1=sha1", captor.getValue().getURI().toString());
  }
   ...
   * @throws Exception
   */
  @Test public void shouldCallTheCorrectUrlWithCustomCloneType() throws Exception {
    ...
    verify(httpClient, times(1)).execute(captor.capture());
    verify(connectionManager, times(1)).shutdown();
    assertEquals("http://localhost.jenkins/git/notifyCommit?" + "url=http%3A%2F%2Fcustom.host%2Fcustom.git" + "&branches=refs%2Fheads%2Fmaster" + "&sha1=sha1", captor.getValue().getURI().toString());
  }
   ...
   * @throws Exception
   */
  @Test public void shouldCallTheCorrectUrlWithNullCloneType() throws Exception {
   ...
   * @throws Exception
   */
  @Test public void shouldFailWithInvalidCloneType() throws Exception {
   ...
   * @throws Exception
   */
  @Test public void shouldCallTheCorrectUrlWithoutSsl() throws Exception {
    notifier.notify(repo, "refs/heads/master", "sha1");
    ArgumentCaptor<HttpGet> captor = ArgumentCaptor.forClass(HttpGet.class);
    verify(httpClientFactory, times(1)).getHttpClient(false, false);
    verify(httpClient, times(1)).execute(captor.capture());
   ...
   * @throws Exception
   */
  @Test public void shouldCallTheCorrectUrlWithSsl() throws Exception {
    ...
    verify(httpClient, times(1)).execute(captor.capture());
    verify(connectionManager, times(1)).shutdown();
    assertEquals("https://localhost.jenkins/git/notifyCommit?" + "url=http%3A%2F%2Fsome.stash.com%2Fscm%2Ffoo%2Fbar.git" + "&branches=refs%2Fheads%2Fmaster" + "&sha1=sha1", captor.getValue().getURI().toString());
  }
   ...
   * @throws Exception
   */
  @Test public void shouldCallTheCorrectUrlWithSslAndIgnoreCerts() throws Exception {
    when(settings.getString(Notifier.JENKINS_BASE)).thenReturn(JENKINS_BASE_URL.replace("http", "https"));
   ...
   * @throws Exception
   */
  @Test public void shouldCallTheCorrectUrlWithTrailingSlashOnJenkinsBaseUrl() throws Exception {
   ...
   * @throws Exception
   */
  @Test public void shouldCallTheCorrectURLWithOmitBranchNameOn() throws Exception {
    ...
    verify(httpClient, times(1)).execute(captor.capture());
    verify(connectionManager, times(1)).shutdown();
    assertEquals("http://localhost.jenkins/git/notifyCommit?" + "url=http%3A%2F%2Fsome.stash.com%2Fscm%2Ffoo%2Fbar.git" + "&sha1=sha1", captor.getValue().getURI().toString());
  }
   ...
   * @throws Exception
   */
  @Test public void shouldCallTheCorrectURLWithOmitBranchNameOff() throws Exception {
