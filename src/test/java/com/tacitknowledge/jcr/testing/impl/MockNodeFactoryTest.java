...
public class MockNodeFactoryTest {
  ...
  @Test public void shouldCreateProperty() throws RepositoryException {
  ...
  @Test public void shouldAddValueToAlreadyCreatedProperty() throws RepositoryException {
  ...
  @Test public void shouldDoNothingIfPropertyIsAlreadySetup() throws RepositoryException {
    when(parent.getProperty(name)).thenReturn(property);
  ...
  @Test public void shouldCreateNodeWithNullNodeType() throws RepositoryException {
  ...
  @Test public void shouldCreateNodeWithNodeType() throws RepositoryException {
  ...
  @Test public void shouldCreateNodeIfParentIsNull() throws RepositoryException {
  ...
  @Test public void shouldNotCreateChildNodeIfAlreadyExist() throws RepositoryException {
  ...
  @Test public void shouldCreatePropertyFromDefinitionWithNullDefaultValues() throws RepositoryException {
  ...
  @Test public void shouldCreatePropertyFromDefinitionWithDefaultValues() throws RepositoryException {
    Value value = mock(Value.class);
  ...
  @Test public void shouldCreatePropertyFromDefinitionWithDefaultValuesEmpty() throws RepositoryException {
    Value[] defaultValues = {  };
    when(propertyDefinition.getDefaultValues()).thenReturn(defaultValues);
    nodeFactory.createPropertyFromDefinition(parent, propertyDefinition);
    Property actualProperty = parent.getProperty(PROPERTY_NAME);
  ...
  @Test public void shouldCreatePropertyFromDefinitionWithDefaultValuesMultipleProperties() throws RepositoryException {
    Value[] defaultValues = {  };
    when(propertyDefinition.getDefaultValues()).thenReturn(defaultValues);
  ...
  @Test public void shouldCreateIterator() throws RepositoryException {
  ...
  @Test public void shouldCreateNewIteratorOnEachCallToGetNodes() throws RepositoryException {
    List<Node> childNodes = new ArrayList<Node>();
    nodeFactory.createIteratorFor(parent, childNodes);
  ...
  @Test public void shouldThrowParseExceptionWhenDateIsInvalidFormat() throws RepositoryException {
    try {
  ...
  @Test public void shouldCreateStringValue() throws RepositoryException {
    nodeFactory.createValueFor(property, "stringValue", 20);
    assertEquals("stringValue", property.getString());
  }

  @Test public void shouldThrowIllegalArgumentExceptionIfBinaryDoesNotExist() throws RepositoryException {
    try {
  ...
  @Test public void shouldCreateNodeFromNodeType() throws RepositoryException {
    NodeType nodeType = mock(NodeType.class);
  ...
  @Test public void callToGetPathShouldReturnAbsolutePath() throws RepositoryException {
  ...
  @Test public void shouldRetrievePropertyFromAllAscendantNodes() throws RepositoryException {
