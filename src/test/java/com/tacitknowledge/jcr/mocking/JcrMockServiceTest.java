...
public class JcrMockServiceTest {
  ...
  public static final String JSON_NODE_DEFINITION_WITH_NODE_TYPES = "{" + "    ac2d111: {" + "        trustEntity: \'type:String\'," + "        view: \'type:String\'," + "        binary: {" + "            nodeType: \'nt:file\'," + "            \'jcr:content\': {" + "                \'jcr:data\': \'type:Binary, value:/files/air_jordan.jpg\'" + "            }" + "        }" + "    }" + "}";

  public static final String JSON_NODE_DEFINITION_WITH_TWO_NODES = "{" + "    ac2d111: {" + "        trustEntity: \'type:String\'," + "        view: \'type:String\'," + "        binary: {" + "            nodeType: \'nt:file\'" + "        }," + "        anotherNode: {" + "            attri: \'valueyes\'" + "        }" + "    }" + "} ";

  @BeforeClass public static void setup() throws RepositoryException, IOException {
    NodeFactory mockFactory = new MockNodeFactory();
    mockService = new JsonMockService(mockFactory);
  }

  @Test public void testJcrNodeServiceWithParentNode() throws RepositoryException {
    String jsonNodeDefinition = "{" + "    content: {" + "        dpils: {" + "            testProperty: \'myvalue\'" + "        }" + "    }" + "}";
    Node parentNode = mock(Node.class);
    mockService.fromString(parentNode, jsonNodeDefinition);
    assertNodeContents(parentNode);
  }

  @Test public void shouldAddItemTypeInformationToNodeStructure() throws RepositoryException {
    Node parentNode = mock(Node.class);
  ...
  @Test public void shouldCreateFullJsonStructureFromFile() throws IOException, RepositoryException {
  ...
  @Test public void testDeepHierarchies() throws RepositoryException {
    Node parentNode = mock(Node.class);
    mockService.fromString(parentNode, JSON_NODE_DEFINITION_WITH_NODE_TYPES);
  ...
  @Test(expected = NoSuchElementException.class) public void shouldReturnWorkingNodeIterator() throws RepositoryException {
    Node parentNode = mock(Node.class);
  ...
  @Test(expected = NoSuchElementException.class) public void iteratorShouldWorkWithNodesWithoutChildren() throws RepositoryException {
    Node parentNode = mock(Node.class);
    mockService.fromString(parentNode, JSON_NODE_DEFINITION_WITH_TWO_NODES);
    Node ac2d111Node = parentNode.getNode("ac2d111");
  ...
  @Test public void shouldSetBinaryValue() throws RepositoryException {
    String jsonNodeDefinitionWithNodeTypes = "{" + "    ac2d111: {" + "        trustEntity: \'type:String\'," + "        view: \'type:String\'," + "        binary: {" + "            nodeType: \'nt:file\'," + "            \'jcr:content\': {" + "                \'jcr:data\': \'type:Binary, value:/files/air_jordan.jpg\'" + "            }" + "        }," + "        anotherNode: {" + "            attri: \'valueyes\'" + "        }" + "    }" + "} ";
    Node parentNode = mock(Node.class);
  ...
  @Test public void shouldCreateNodeStructureWithoutPassingAParentNode() throws RepositoryException {
    String jsonNodeStructure = "{" + "    products: {" + "        productA: {" + "            name: \'Air Jordan\'," + "            confidentiality: \'Bronze\'," + "            digitalAssets: {" + "                asset1: {" + "                    mimeType: \'jpg\'," + "                    contentType: \'photography\'," + "                    binary: \'type:Binary, value:/files/air_jordan.jpg\'" + "                }" + "            }" + "        }" + "    }" + "}";
  ...
  @Test public void shouldHandleReferences() throws IOException, RepositoryException {
  ...
  @Test public void shouldBeAbleToIterateOnNodesMultipleTimes() throws RepositoryException {
    String jsonNodeStructure = "{" + "    products: {" + "        productA: {" + "            name: \'Air Jordan\'," + "            confidentiality: \'Bronze\'," + "            someNode: {}," + "            digitalAssets: {" + "                asset1: {" + "                    mimeType: \'jpg\'," + "                    contentType: \'photography\'," + "                    binary: \'type:Binary, value:/files/air_jordan.jpg\'" + "                }" + "            }" + "        }" + "    }" + "}";
    Node rootNode = mockService.fromString(jsonNodeStructure);
    assertNotNull(rootNode);
  ...
  @Test public void getPathShouldWorkForBothNodesAndProperties() throws RepositoryException {
    String jsonNodeStructure = "{" + "    products: {" + "        productA: {" + "            name: \'Air Jordan\'," + "            confidentiality: \'Bronze\'," + "            someNode: {}," + "            digitalAssets: {" + "                asset1: {" + "                    mimeType: \'jpg\'," + "                    contentType: \'photography\'," + "                    binary: \'type:Binary, value:/files/air_jordan.jpg\'" + "                }" + "            }" + "        }" + "    }" + "}";
    Node rootNode = mockService.fromString(jsonNodeStructure);
  ...
  @Test public void shouldBeAbleToRetrieveNestedPropertyFromAncestors() throws RepositoryException {
    String jsonNodeStructure = "{" + "    products: {" + "        productA: {" + "            name: \'Air Jordan\'," + "            confidentiality: \'Bronze\'," + "            someNode: {}," + "            digitalAssets: {" + "                asset1: {" + "                    mimeType: \'jpg\'," + "                    contentType: \'photography\'," + "                    binary: \'type:Binary, value:/files/air_jordan.jpg\'" + "                }" + "            }" + "        }" + "    }" + "}";
    Node rootNode = mockService.fromString(jsonNodeStructure);
    assertNotNull(rootNode);
  ...
  @Test public void shouldReturnCorrectPrimaryTypePropertyValueAsString() throws RepositoryException {
    String jsonNodeStructureWithPrimaryType = "{" + "    ac2d111: {" + "        trustEntity: \'type:String\'," + "        view: \'type:String\'," + "        binary: {" + "            \'jcr:primaryType\': \'nt:file\'" + "        }," + "        anotherNode: {" + "            attri: \'valueyes\'" + "        }" + "    }" + "} ";
