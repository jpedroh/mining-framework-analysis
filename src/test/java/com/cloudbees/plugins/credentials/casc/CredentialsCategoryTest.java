...
public class CredentialsCategoryTest {
  @ClassRule @ConfiguredWithCode(value = "credentials-category.yaml") public static JenkinsConfiguredWithCodeRule r = new JenkinsConfiguredWithCodeRule();

  @Test public void importConfig() {
  ...
  @TestExtension @Symbol(value = "test") public static class TestGlobalConfiguration extends GlobalConfiguration {
  ...
  @Test public void exportUsernamePasswordCredentialsImplConfiguration() throws Exception {
    UsernamePasswordCredentialsImpl usernamePasswordCredentials = new UsernamePasswordCredentialsImpl(CredentialsScope.GLOBAL, "username-pass", "Username / Password credential for testing", "my-user", "wonderfulPassword");
  ...
  @Test public void exportCertificateCredentialsImplConfiguration() throws Exception {
    CertificateCredentialsImpl certificateCredentials = new CertificateCredentialsImpl(CredentialsScope.GLOBAL, "credential-certificate", "Credential with certificate", "password", new CertificateCredentialsImpl.UploadedKeyStoreSource(null, SecretBytes.fromBytes("Testing not real certificate".getBytes())));
