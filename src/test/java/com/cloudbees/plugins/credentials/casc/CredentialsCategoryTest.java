...
public class CredentialsCategoryTest {
  ...
  @Test public void exportCertificateCredentialsImplConfiguration() throws Exception {
    CertificateCredentialsImpl certificateCredentials = new CertificateCredentialsImpl(CredentialsScope.GLOBAL, "credential-certificate", "Credential with certificate", "password", new CertificateCredentialsImpl.UploadedKeyStoreSource(SecretBytes.fromBytes("Testing not real certificate".getBytes())));
