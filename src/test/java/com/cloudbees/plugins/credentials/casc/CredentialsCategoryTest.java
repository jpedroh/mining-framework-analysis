...
public class CredentialsCategoryTest {
  ...
  @Test @ConfiguredWithCode(value = "credentials-category.yaml") public void globalCredentialsConfigurationCategory() throws Exception {
  ...
  @TestExtension @Symbol(value = "testGlobalConfiguration") public static class TestGlobalConfiguration extends GlobalConfiguration {
