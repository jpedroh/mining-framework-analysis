...
public class TestSubscriptionUpdate extends TestModelBase {
  @Test(groups = "fast") public void testDeserialization() throws Exception {
  ...
  @Test(groups = "fast") public void testSerializationWithoutAddOns() throws Exception {
  ...
  @Test(groups = "fast") public void testSerializationWithEmptyAddOns() throws Exception {
    final SubscriptionUpdate subscription = new SubscriptionUpdate();
    subscription.setPlanCode("gold");
    subscription.setTimeframe(SubscriptionUpdate.Timeframe.now);
    subscription.setUnitAmountInCents(800);
    ...
    final String xml = xmlMapper.writeValueAsString(subscription);
    Assert.assertEquals(xml, "<subscription>" + "<timeframe>now</timeframe>" + "<unit_amount_in_cents>800</unit_amount_in_cents>" + "<quantity>1</quantity>" + "<subscription_add_ons></subscription_add_ons>" + "<plan_code>gold</plan_code>" + "</subscription>");
  }

  @Test(groups = "fast") public void testSerializationWithAddOns() throws Exception {
    final SubscriptionUpdate subscription = new SubscriptionUpdate();
    subscription.setPlanCode("gold");
    subscription.setTimeframe(SubscriptionUpdate.Timeframe.now);
    subscription.setUnitAmountInCents(800);
  ...
  @Test(groups = "fast") public void testSerializationWithCustomFields() throws Exception {
    final SubscriptionUpdate subscription = new SubscriptionUpdate();
    subscription.setPlanCode("gold");
    subscription.setTimeframe(SubscriptionUpdate.Timeframe.now);
    subscription.setUnitAmountInCents(800);
    ...
    final String xml = xmlMapper.writeValueAsString(subscription);
    Assert.assertEquals(xml, "<subscription>" + "<timeframe>now</timeframe>" + "<unit_amount_in_cents>800</unit_amount_in_cents>" + "<quantity>1</quantity>" + "<custom_fields>" + "<custom_field>" + "<name>name1</name>" + "<value>value1</value>" + "</custom_field>" + "</custom_fields>" + "<plan_code>gold</plan_code>" + "</subscription>");
  }

  @Test(groups = "fast") public void testSerializationWithCoupons() throws Exception {
    final SubscriptionUpdate subscription = new SubscriptionUpdate();
    subscription.setPlanCode("gold");
    subscription.setTimeframe(SubscriptionUpdate.Timeframe.now);
    subscription.setUnitAmountInCents(800);
