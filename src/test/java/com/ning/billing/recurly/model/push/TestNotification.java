...
public class TestNotification extends TestModelBase {
  ...
  private <T extends Notification> void deserialize(final Class<T> clazz) {
    ...
    final StringBuilder notificationDataBuilder = new StringBuilder().append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n").append("<").append(xmlElement).append(">\n");
  ...
  @Test(groups = "fast") public void testNewAccountNotification() {
    deserialize(NewAccountNotification.class);
  }

  @Test(groups = "fast") public void testCanceledAccountNotification() {
    deserialize(CanceledAccountNotification.class);
  }

  @Test(groups = "fast") public void testBillingInfoUpdatedNotification() {
    deserialize(BillingInfoUpdatedNotification.class);
  }

  @Test(groups = "fast") public void testNewSubscriptionNotification() {
    deserialize(NewSubscriptionNotification.class);
  }

  @Test(groups = "fast") public void testUpdatedSubscriptionNotification() {
    deserialize(UpdatedSubscriptionNotification.class);
  }

  @Test(groups = "fast") public void testCanceledSubscriptionNotification() {
    deserialize(CanceledSubscriptionNotification.class);
  }

  @Test(groups = "fast") public void testRenewedSubscriptionNotification() {
    deserialize(RenewedSubscriptionNotification.class);
  }

  @Test(groups = "fast") public void testReactivatedAccountNotification() {
    deserialize(ReactivatedAccountNotification.class);
  }

  @Test(groups = "fast") public void testExpiredSubscriptionNotification() {
    deserialize(ExpiredSubscriptionNotification.class);
  }

  @Test(groups = "fast") public void testSuccessfulPaymentNotification() {
    deserialize(SuccessfulPaymentNotification.class);
  }

  @Test(groups = "fast") public void testFailedPaymentNotification() {
    deserialize(FailedPaymentNotification.class);
  }

  @Test(groups = "fast") public void testVoidPaymentNotification() {
    deserialize(VoidPaymentNotification.class);
  }

  @Test(groups = "fast") public void testSuccessfulRefundNotification() {
    deserialize(SuccessfulRefundNotification.class);
  }

  @Test(groups = "fast") public void testClosedInvoiceNotification() {
    deserialize(ClosedInvoiceNotification.class);
  }

  @Test(groups = "fast") public void testNewInvoiceNotification() {
    deserialize(NewInvoiceNotification.class);
  }

  @Test(groups = "fast") public void testPastDueInvoiceNotification() {
    deserialize(PastDueInvoiceNotification.class);
  }

  @Test(groups = "fast") public void testProcessingInvoiceNotification() {
