...
public class TestRecurlyClient {
  ...
  @BeforeMethod(groups = { "integration", "enterprise" }) public void setUp() throws Exception {
  ...
  @AfterMethod(groups = { "integration", "enterprise" }) public void tearDown() throws Exception {
    recurlyClient.close();
  }

  @Test(groups = "integration") public void testUnauthorizedException() throws Exception {
  ...
  @Test(groups = "integration", description = "See https://github.com/killbilling/recurly-java-library/issues/21") public void testGetEmptySubscriptions() throws Exception {
  ...
  @Test(groups = "integration") public void testReopenAccount() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    try {
  ...
  @Test(groups = "integration") public void testInvalidTokenError() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
  ...
  @Test(groups = "integration") public void testGetBillingInfo() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
  ...
  @Test(groups = "integration", description = "See https://github.com/killbilling/recurly-java-library/issues/23") public void testRemoveSubscriptionAddons() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
  ...
  @Test(groups = "integration") public void testGetSiteSubscriptions() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
  ...
  @Test(groups = "integration") public void testGetAndDeleteAdjustment() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    final Plan planData = TestUtils.createRandomPlan();
    try {
  ...
  @Test(groups = "integration") public void testGetAdjustments() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    final Plan planData = TestUtils.createRandomPlan();
    try {
  ...
  @Test(groups = "integration") public void testPagination() throws Exception {
  ...
  @Test(groups = "integration") public void testCreateAccountWithBadBillingInfo() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
  ...
  @Test(groups = "integration") public void testCreateUpdateAccount() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
  ...
  @Test(groups = "integration") public void testGetAccountBalance() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    try {
      final Account account = recurlyClient.createAccount(accountData);
  ...
  @Test(groups = "integration") public void testCreateItem() throws Exception {
  ...
  @Test(groups = "integration") public void testUpdateItem() throws Exception {
    final Item itemData = TestUtils.createRandomItem();
    try {
      final Item item = recurlyClient.createItem(itemData);
      final Item itemChanges = new Item();
      Assert.assertNotNull(item);
  ...
  @Test(groups = "integration") public void testReactivateItem() throws Exception {
    final Item itemData = TestUtils.createRandomItem();
    try {
      final Item item = recurlyClient.createItem(itemData);
      Assert.assertNotNull(item);
  ...
  @Test(groups = "integration") public void testUpdatePlan() throws Exception {
    final Plan planData = TestUtils.createRandomPlan();
    try {
      final DateTime creationDateTime = new DateTime(DateTimeZone.UTC);
      final Plan plan = recurlyClient.createPlan(planData);
  ...
  @Test(groups = "integration") public void testCreateSubscriptionWithCustomFields() throws Exception {
    final List<AddOn> addons = new ArrayList<AddOn>();
    final Plan planData = TestUtils.createRandomPlan();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
  ...
  @Test(groups = "integration") public void testCreateBulkSubscriptions() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    try {
      final Account account = recurlyClient.createAccount(accountData);
  ...
  @Test(groups = "integration") public void testCreateAndCloseInvoices() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    try {
      final Account account = recurlyClient.createAccount(accountData);
  ...
  @Test(groups = "integration") public void testCreateInvoiceAndRetrieveInvoicePdf() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
  ...
  @Test(groups = "enterprise") public void testCreateAndCloseManualInvoices() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    try {
      final Account account = recurlyClient.createAccount(accountData);
      final Adjustment a = new Adjustment();
  ...
  @Test(groups = "integration") public void testBulkCoupons() throws Exception {
    final Coupon couponData = TestUtils.createRandomCoupon();
  ...
  @Test(groups = "integration") public void testRedeemCoupon() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    final Plan planData = TestUtils.createRandomPlan(CURRENCY);
    final Coupon couponData = TestUtils.createRandomCoupon();
  ...
  @Test(groups = "integration") public void testCreateTrialExtensionCoupon() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    final Plan planData = TestUtils.createRandomPlan(CURRENCY);
    final Coupon couponData = TestUtils.createRandomCoupon();
  ...
  @Test(groups = "integration") public void testRedeemGiftCardOnSubscription() throws Exception {
  ...
  @Test(groups = "integration") public void testRedeemGiftCardOnAccount() throws Exception {
    final GiftCard giftCardData = TestUtils.createRandomGiftCard();
    final GiftCard giftCard = recurlyClient.purchaseGiftCard(giftCardData);
    Assert.assertEquals(giftCard.getProductCode(), giftCardData.getProductCode());
    Assert.assertNull(giftCard.getRedeemedAt());
  ...
  @Test(groups = "integration") public void testPreviewGiftCardPurchase() throws Exception {
    final GiftCard giftCardData = TestUtils.createRandomGiftCard();
  ...
  @Test(groups = "integration") public void testShippingAddressesOnAccount() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
  ...
  @Test(groups = "integration") public void testShippingAddressesOnSubscription() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final Plan planData = TestUtils.createRandomPlan(CURRENCY);
  ...
  @Test(groups = "integration") public void testInvoices() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final Plan planData = TestUtils.createRandomPlan(CURRENCY);
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    billingInfoData.setAccount(null);
  ...
  @Test(groups = "integration") public void testLineItemInvoiceRefund() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final Plan planData = TestUtils.createRandomPlan(CURRENCY);
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    billingInfoData.setAccount(null);
  ...
  @Test(groups = "integration") public void testCounts() throws Exception {
  ...
  @Test(groups = "integration") public void testPurchase() throws Exception {
    final Plan planData = TestUtils.createRandomPlan(CURRENCY);
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    ...
    adjustmentData.setCurrency(null);
  ...
  @Test(groups = "integration") public void testAuthorizePurchase() throws Exception {
    final Plan planData = TestUtils.createRandomPlan(CURRENCY);
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    final Adjustments adjustmentsData = new Adjustments();
    ...
    billingInfoData.setAccount(null);
    accountData.setBillingInfo(billingInfoData);
    billingInfoData.setExternalHppType("adyen");
  ...
  @Test(groups = "integration") public void testAccountAcquisition() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    try {
      final Account account = recurlyClient.createAccount(accountData);
  ...
  @Test(groups = "integration") public void testPauseSubscription() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final BillingInfo billingInfoData = TestUtils.createRandomBillingInfo();
    final Plan planData = TestUtils.createRandomPlan();
    billingInfoData.setAccount(null);
  ...
  @Test(groups = "integration") public void testInvoicesCount() throws Exception {
    int invoiceCount = recurlyClient.getInvoicesCount(new QueryParams());
    Assert.assertTrue(invoiceCount > 0);
  }

  @Test(groups = "integration") public void testShippingAddresses() throws Exception {
    final Account accountData = TestUtils.createRandomAccount();
    final ShippingAddress shippingAddressData = TestUtils.createRandomShippingAddress();
    try {
      final Account account = recurlyClient.createAccount(accountData);
      ...
      final ShippingAddress updatedShippingAddress = recurlyClient.updateShippingAddress(account.getAccountCode(), shadId, updatedRequest);
