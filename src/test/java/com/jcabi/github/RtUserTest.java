 ...
 */
@SuppressWarnings(value = { "PMD.AvoidDuplicateLiterals", "PMD.TooManyMethods" }) public final class RtUserTest {
  /**
     * RtUser can understand who am I.
     * @throws Exception If some problem inside
     */
  @Test public void checksWhoAmI() throws Exception {
    final String login = "monalia";
    final RtUser user = new RtUser(Mockito.mock(Github.class), new FakeRequest().withBody(Json.createObjectBuilder().add("login", login).build().toString()));
    MatcherAssert.assertThat(user.login(), Matchers.equalTo(login));
  }
  ...
  /**
     ...
     * @throws Exception If some problem inside
     */
  @Test public void checksIfHeHasAName() throws Exception {
    final User.Smart smart = new User.Smart(new RtUser(Mockito.mock(Github.class), new FakeRequest().withBody(Json.createObjectBuilder().add("name", "octoc").build().toString()), "octoc"));
    MatcherAssert.assertThat(smart.hasName(), Matchers.equalTo(true));
  }
  ...
  /**
     ...
     * @throws Exception If some problem inside
     */
  @Test public void checksIfHeHasNoName() throws Exception {
  ...
  @Test public void describeAsJson() throws Exception {
    final RtUser user = new RtUser(Mockito.mock(Github.class), new FakeRequest().withBody(Json.createObjectBuilder().add("name", "monalisa").add("email", "octocat@github.com").build().toString()), "octoc");
    MatcherAssert.assertThat(user.json().toString(), Matchers.equalTo("{\"name\":\"monalisa\",\"email\":\"octocat@github.com\"}"));
  }
  ...
  /**
     ...
     */
  @Test public void fetchesEmails() {
  ...
  /**
     ...
     */
  @Test public void fetchesOrganizations() {
    final Github github = Mockito.mock(Github.class);
    Mockito.when(github.entry()).thenReturn(new FakeRequest());
    final User user = new RtUser(github, new FakeRequest());
  ...
  /**
     ...
     */
  @Test public void hasGravatar() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasHtmlUrl() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasFollwersUrl() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasFollowingUrl() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasGistsUrl() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasStarredUrl() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasSubscriptionsUrl() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasOrganizationsUrl() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasReposUrl() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasEventsUrl() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasReceivedEventsUrl() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasType() throws Exception {
    final String value = "http://github.example.com/organizations";
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasSiteAdmin() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasBlog() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasHireable() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasBio() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasPublicRepos() throws Exception {
    final int value = Tv.THREE;
    final User.Smart smart = this.userWith("public_repos", String.valueOf(value));
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasPublicGists() throws Exception {
    final int value = Tv.FOUR;
    final User.Smart smart = this.userWith("public_gists", String.valueOf(value));
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasFollowersCount() throws Exception {
    final int value = Tv.FIVE;
    final User.Smart smart = this.userWith("followers", String.valueOf(value));
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasFollowingCount() throws Exception {
    final int value = Tv.SIX;
    final User.Smart smart = this.userWith("following", String.valueOf(value));
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasCreated() throws Exception {
  ...
  /**
     ...
     * @throws Exception if any problem occurs.
     */
  @Test public void hasUpdated() throws Exception {
    final Github.Time value = new Github.Time("2014-07-04T15:29:43Z");
  ...
  private User.Smart userWith(final String property, final String value) {
    return new User.Smart(new RtUser(Mockito.mock(Github.class), new FakeRequest().withBody(Json.createObjectBuilder().add(property, value).build().toString()), "octoc"));
  }
}