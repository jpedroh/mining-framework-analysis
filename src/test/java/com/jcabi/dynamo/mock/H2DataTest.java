...
public final class H2DataTest {
  /**
     ...
     */
  @Rule public final transient TemporaryFolder temp = new TemporaryFolder();

  /**
     * H2Data can store and fetch.
     * @throws Exception If some problem inside
     */
  @Test public void storesAndReadsAttributes() throws Exception {
  ...
  /**
     ...
     */
  @Test @Ignore public void storesToFile() throws Exception {
  ...
  /**
     ...
     * @throws Exception If some problem inside
     */
  @Test public void createsManyTables() throws Exception {
    new H2Data().with("firsttable", new String[] { "firstid" }, new String[0]).with("secondtable", new String[] { "secondid" }, new String[0]);
  }
  ...
  /**
     ...
     */
  @Test public void createsTablesWithLongNames() throws Exception {
    new H2Data().with(Joiner.on("").join(Collections.nCopies(255, "a")), new String[] { "key" }, new String[0]);
  }
  ...
  /**
     ...
     * @throws Exception In case test fails
     */
  @Test public void supportsTableNamesWithIllegalCharacters() throws Exception {
  ...
  /**
     ...
     */
  @Test @Ignore public void supportsColumnNamesWithIllegalCharacters() throws Exception {
    final String key = "0-.col.-0";
    final String table = "test";
    new H2Data().with(table, new String[] { key }, new String[0]).put(table, new Attributes().with(key, "value"));
  }
  ...
  /**
     ...
     * @throws Exception In case test fails
     */
  @Test public void deletesRecords() throws Exception {
    final String table = "customers";
    final String field = "name";
    final String man = "Kevin";
    final String woman = "Helen";
    final H2Data data = new H2Data().with(table, new String[] { field }, new String[0]);
    data.put(table, new Attributes().with(field, man));
    data.put(table, new Attributes().with(field, woman));
    data.delete(table, new Attributes().with(field, man));
    final List<Attributes> rest = Lists.newArrayList(data.iterate(table, new Conditions()));
    MatcherAssert.assertThat(rest.size(), Matchers.equalTo(1));
    MatcherAssert.assertThat(rest.get(0).get(field).getS(), Matchers.equalTo(woman));
  }
  ...
  /**
     ...
     * @throws Exception In case test fails
     */
  @Test public void updatesTableAttributes() throws Exception {
