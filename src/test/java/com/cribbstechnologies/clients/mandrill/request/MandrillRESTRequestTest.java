...
public class MandrillRESTRequestTest {
  ...
  @Mock ClientConnectionManager manager;
  ...
  @Test public void testGetPostDataJsonGenerationException() throws Exception {
  ...
  @Test public void testGetPostDataJsonMappingException() throws Exception {
    this.initRequestWithMockedMapper();
  ...
  @Test public void testGetPostDataBaseMandrillRequest() throws Exception {
  ...
  @Test public void testGetPostDataMandrillRequestWithEmail() throws Exception {
    this.initRequestWithActualMapper();
  ...
  @Test public void testGetPostDataMandrillRequestWithQuery() throws Exception {
    this.initRequestWithActualMapper();
  ...
  @Test public void testGetPostDataMandrillRequestWithTag() throws Exception {
    this.initRequestWithActualMapper();
  ...
  @Test public void testGetPostDataMandrillRequestWithUrl() throws Exception {
    this.initRequestWithActualMapper();
  ...
  @Test public void testGetPostDataMandrillMessageRequest() throws Exception {
    this.initRequestWithActualMapper();
  ...
  @Test public void testGetPostDataMandrillMessageRequestWithBCC() throws Exception {
  ...
  @Test public void testPostRequest() throws ClientProtocolException, IOException {
    this.request = new MandrillRESTRequest();
  ...
  @Test public void testPostRequestMapperExceptions() throws ClientProtocolException, IOException {
    this.request = new MandrillRESTRequest();
    this.request.setHttpClient(this.client);
    this.request.setConfig(this.config);
    this.request.setObjectMapper(this.mapper);
  ...
  @Test public void testPostRequestNon200Response() {
    try {
      this.request = new MandrillRESTRequest();
      this.request.setHttpClient(this.client);
      this.request.setConfig(this.config);
  ...
  @Test public void testUsersInfoResponseConversion() throws JsonParseException, JsonMappingException, IOException {
    this.initRequestWithActualMapper();
  ...
  @Test public void testSendersResponseConversion() throws IOException {
    this.initRequestWithActualMapper();
    StringWriter sw = new StringWriter();
  ...
  @Test public void testDisableResponseConversion() throws IOException {
    this.initRequestWithActualMapper();
    StringWriter sw = new StringWriter();
  ...
  @Test public void testVerifySenderResponseConversion() throws IOException {
    this.initRequestWithActualMapper();
    StringWriter sw = new StringWriter();
  ...
  @Test public void testSendMessageResponseConversion() throws IOException {
    this.initRequestWithActualMapper();
    StringWriter sw = new StringWriter();
  ...
  @Test public void testListTagsResponseConversion() throws IOException {
    this.initRequestWithActualMapper();
    StringWriter sw = new StringWriter();
  ...
  @Test public void testTimeTagsResponseConversion() throws IOException {
    this.initRequestWithActualMapper();
    StringWriter sw = new StringWriter();
  ...
  @Test public void testUrlListResponseConversion() throws IOException {
    this.initRequestWithActualMapper();
    StringWriter sw = new StringWriter();
  ...
  @Test public void testUrlTimeResponseConversion() throws IOException {
    this.initRequestWithActualMapper();
    StringWriter sw = new StringWriter();
  ...
  @Test public void testTemplateResponseConversion() throws IOException {
    this.initRequestWithActualMapper();
    StringWriter sw = new StringWriter();
  ...
  @Test public void testTemplateListResponseConversion() throws IOException {
    this.initRequestWithActualMapper();
    StringWriter sw = new StringWriter();
