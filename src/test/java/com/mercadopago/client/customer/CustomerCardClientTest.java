...
public class CustomerCardClientTest extends BaseClientTest {
  ...
  @BeforeEach public void init() {
    customerCardCreateRequest = CustomerCardCreateRequest.builder().token("abc").issuer(CustomerCardIssuer.builder().id("123").name("visa").build()).build();
  ...
  @Test public void getCardSuccess() throws IOException, MPException, ParseException {
    HttpResponse httpResponse = MockHelper.generateHttpResponseFromFile(responseFileSingleCard, HttpStatus.OK);
  ...
  @Test public void getCardWithRequestOptionsSuccess() throws IOException, MPException, ParseException {
  ...
  @Test public void createCardSuccess() throws IOException, MPException, ParseException {
    HttpResponse httpResponse = MockHelper.generateHttpResponseFromFile(responseFileSingleCard, HttpStatus.OK);
    httpResponse.setHeader(HttpHeaders.CONTENT_TYPE, APPLICATION_JSON);
    doReturn(httpResponse).when(httpClient).execute(any(HttpRequestBase.class), any(HttpContext.class));
  ...
  @Test public void createCardWithRequestOptionsSuccess() throws ParseException, IOException, MPException {
    MPRequestOptions requestOptions = MPRequestOptions.builder().accessToken("abc").connectionTimeout(DEFAULT_TIMEOUT).connectionRequestTimeout(DEFAULT_TIMEOUT).socketTimeout(DEFAULT_TIMEOUT).build();
    HttpResponse httpResponse = MockHelper.generateHttpResponseFromFile(responseFileSingleCard, HttpStatus.OK);
    httpResponse.setHeader(HttpHeaders.CONTENT_TYPE, APPLICATION_JSON);
    doReturn(httpResponse).when(httpClient).execute(any(HttpRequestBase.class), any(HttpContext.class));
  ...
  @Test public void deleteCardSuccess() throws ParseException, MPException, IOException {
    HttpResponse httpResponse = MockHelper.generateHttpResponseFromFile(responseFileSingleCard, HttpStatus.OK);
    httpResponse.setHeader(HttpHeaders.CONTENT_TYPE, APPLICATION_JSON);
    doReturn(httpResponse).when(httpClient).execute(any(HttpRequestBase.class), any(HttpContext.class));
  ...
  @Test public void deleteCardWithRequestOptionsSuccess() throws MPException, IOException, ParseException {
    MPRequestOptions requestOptions = MPRequestOptions.builder().accessToken("abc").connectionTimeout(DEFAULT_TIMEOUT).connectionRequestTimeout(DEFAULT_TIMEOUT).socketTimeout(DEFAULT_TIMEOUT).build();
    HttpResponse httpResponse = MockHelper.generateHttpResponseFromFile(responseFileSingleCard, HttpStatus.OK);
    httpResponse.setHeader(HttpHeaders.CONTENT_TYPE, APPLICATION_JSON);
    doReturn(httpResponse).when(httpClient).execute(any(HttpRequestBase.class), any(HttpContext.class));
  ...
  @Test public void listAllCardsSuccess() throws IOException, MPException, ParseException {
    HttpResponse httpResponse = MockHelper.generateHttpResponseFromFile(responseFileAllCards, HttpStatus.OK);
    httpResponse.setHeader(HttpHeaders.CONTENT_TYPE, APPLICATION_JSON);
    doReturn(httpResponse).when(httpClient).execute(any(HttpRequestBase.class), any(HttpContext.class));
  ...
  @Test public void listAllCardsWithRequestOptionsSuccess() throws IOException, MPException, ParseException {
    MPRequestOptions requestOptions = MPRequestOptions.builder().accessToken("abc").connectionTimeout(DEFAULT_TIMEOUT).connectionRequestTimeout(DEFAULT_TIMEOUT).socketTimeout(DEFAULT_TIMEOUT).build();
    HttpResponse httpResponse = MockHelper.generateHttpResponseFromFile(responseFileAllCards, HttpStatus.OK);
    httpResponse.setHeader(HttpHeaders.CONTENT_TYPE, APPLICATION_JSON);
    doReturn(httpResponse).when(httpClient).execute(any(HttpRequestBase.class), any(HttpContext.class));
  ...
  private void assertCustomerCardFields(CustomerCard card) throws ParseException {
    ...
    assertEquals("http://img.mlstatic.com/org-img/MP3/API/logos/visa.gif", card.getPaymentMethod().getThumbnail());
    assertEquals("https://www.mercadopago.com/org-img/MP3/API/logos/visa.gif", card.getPaymentMethod().getSecureThumbnail());
    ...
    assertEquals(OffsetDateTime.of(2019, 7, 3, 21, 15, 35, 0, ZoneOffset.UTC), card.getDateCreated());
    assertEquals(OffsetDateTime.of(2019, 7, 3, 21, 19, 18, 0, ZoneOffset.UTC), card.getDateLastUpdated());
