...
class TurtleTest {
  ...
  @Test public void penDownLinePenUp() {
    Turtle turtle = new Turtle();
    turtle.penDown();
    turtle.moveTo(20, 30);
    turtle.moveTo(10, 12);
  ...
  @Test public void splitByToolChange() {
    Turtle turtle = new Turtle();
    turtle.penDown();
    turtle.moveTo(20, 30);
    turtle.moveTo(10, 15);
  ...
  @Test public void equalsTwoTurtles() {
    Turtle turtle = new Turtle();
    turtle.penDown();
    turtle.moveTo(20, 30);
    turtle.moveTo(10, 15);
  ...
  @Test public void notEqualsTwoTurtles() {
    Turtle turtle = new Turtle();
    turtle.penDown();
    turtle.moveTo(20, 30);
    turtle.moveTo(10, 15);
