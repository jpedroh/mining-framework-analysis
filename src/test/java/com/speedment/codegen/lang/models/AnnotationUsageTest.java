...
public class AnnotationUsageTest {
  private final static Number[] TEST_VALUES = new Number[] { Integer.MAX_VALUE, Integer.MIN_VALUE, Double.MAX_VALUE, Double.MIN_VALUE, Long.MAX_VALUE, Long.MIN_VALUE, 0, 1, -12345, -0.123456789, 0.123456789, 0xabce, 0b01100011100 };

  private final static String[] TEST_LABELS = new String[] { "", " ", "ad87dfjdjLKSFfdsfdfsdfsdfsdfSFjerjkJHJKFHDj45kj645j6kllFHDJFHJas8f7dsd7a8f", "^_1#4\\87328(}?+/$", "0", "\u00c0\u04d7\u0467\u046c\u0278\u2665\u1e01\ufeba", "qqqqqqqqqqqqq", "000000", "false", "true", "fAlse", "tr*e", "" };
  ...
  /**
	 ...
	 */
  @Test public void testSetValue_Value() {
  ...
  /**
	 * Test of setValue method, of class AnnotationUsage.
	 */
  @Test public void testSetValue_String_Value() {
