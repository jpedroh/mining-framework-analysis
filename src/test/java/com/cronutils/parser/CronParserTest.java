...
public class CronParserTest {
  ...
  @Mock private CronDefinition definition;
  ...
  @Test(expected = IllegalArgumentException.class) public void testParseEmptyExpression() throws Exception {
  ...
  @Test(expected = IllegalArgumentException.class) public void testParseNoMatchingExpression() throws Exception {
    Set<FieldDefinition> set = Sets.newHashSet();
  ...
  /**
     ...
     */
  @Test public void testMultipleSpacesDoNotHurtParsingExpression() throws Exception {
  ...
  /**
     ...
     */
  @Test public void testParseEveryXyears() {
  ...
  @Test(expected = IllegalArgumentException.class) public void testRejectionOfZeroPeriod() {
    CronDefinition quartzDefinition = CronDefinitionBuilder.instanceDefinitionFor(CronType.QUARTZ);
    parser = new CronParser(quartzDefinition);
    parser.parse("0/0 0 0 1 1 ? 2017/3");
  }

  @Test(expected = IllegalArgumentException.class) public void testRejectionOfPeriodUpperLimitExceedance() {
    CronDefinition quartzDefinition = CronDefinitionBuilder.instanceDefinitionFor(CronType.QUARTZ);
    parser = new CronParser(quartzDefinition);
    parser.parse("0/60 0 0 1 1 ? 2017/3");
  }

  @Test public void testParseExtendedQuartzCron() {
