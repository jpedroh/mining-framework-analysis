...
public class CronParserQuartzIntegrationTest {
  ...
  /**
     ...
     */
  @Test(expected = IllegalArgumentException.class) public void testInvalidCharsDetected() throws Exception {
    parser.parse("* * * * $ ?");
  }

  @Test(expected = IllegalArgumentException.class) public void testInvalidCharsDetectedWithSingleSpecialChar() throws Exception {
    parser.parse("* * * * $W ?");
  }

  @Test(expected = IllegalArgumentException.class) public void testInvalidCharsDetectedWithHashExpression1() throws Exception {
    parser.parse("* * * * $#3 ?");
  }

  @Test(expected = IllegalArgumentException.class) public void testInvalidCharsDetectedWithHashExpression2() throws Exception {
    parser.parse("* * * * 3#$ ?");
  }
  ...
  /**
     ...
     */
  @Test public void testLSupportedInDoMRange() throws Exception {
    parser.parse("* * * L-3 * ?");
  }
  ...
  /**
     ...
     */
  @Test(expected = IllegalArgumentException.class) public void testLSupportedInRange() throws Exception {
    parser.parse("* * * W-3 * ?");
  }

  @Test public void testNLSupported() throws Exception {
    parser.parse("* * * 3L * ?");
  }
  ...
  /**
     ...
     */
  @Test public void testLSupportedInDoM() throws Exception {
  ...
  /**
     ...
     */
  @Test public void testMonthRangeStringMapping() {
  ...
  /**
     ...
     */
  @Test public void testSingleMonthStringMapping() {
  ...
  /**
     ...
     */
  @Test public void testDoWRangeStringMapping() {
  ...
  /**
     ...
     */
  @Test public void testSingleDoWStringMapping() {
  ...
  /**
     ...
     */
  @Test public void testJulyMonthAsStringConsideredSpecialChar() {
  ...
  /**
     ...
     */
  @Test public void testParseExpressionWithQuestionMarkAndWeekdays() {
  ...
  /**
     * Issue #39: reported issue about exception being raised on parse.
     */
  @Test public void testDescribeExpressionWithQuestionMarkAndWeekdays() {
  ...
  /**
     ...
     */
  @Test public void testDescribeExpression() {
  ...
  /**
     ...
     */
  @Test(expected = IllegalArgumentException.class) public void testDoMAndDoWParametersInvalidForQuartz() {
  ...
  /**
     * Issue #78: ExecutionTime.forCron fails on intervals
     */
  @Test public void testIntervalMinutes() {
  ...
  /**
     ...
     */
  @Test public void testRegressionDifferentMessageForException() {
  ...
  /**
     ...
     */
  @Test public void testReportedErrorContainsSameExpressionAsProvided() {
    thrown.expect(IllegalArgumentException.class);
    thrown.expectMessage("Invalid cron expression: 0/1 * * * * *. Both, a day-of-week AND a day-of-month parameter, are not supported.");
  ...
  /**
     ...
     */
  @Test public void testMissingExpressionAndInvalidCharsInErrorMessage() {
    thrown.expect(IllegalArgumentException.class);
  ...
  @Test public void testRejectIllegalMonthArgument() {
    thrown.expect(IllegalArgumentException.class);
  ...
  /**
     ...
     * Duplicate of #148
     */
  @Test public void supportQuartzCronExpressionIncrementsOnYears() {
    final String[] sampleCronExpressions = { "0 0 0 1 * ? 2017/2", "0 0 0 1 * ? 2017/3", "0 0 0 1 * ? 2017/10", "0 0 0 1 * ? 2017-2047/2" };
  ...
  @Test public void testErrorAbout2Parts() {
    thrown.expect(IllegalArgumentException.class);
    thrown.expectMessage("Cron expression contains 2 parts but we expect one of [6, 7]");
    assertNotNull(ExecutionTime.forCron(parser.parse("* *")));
  }

  @Test public void testErrorAboutMissingSteps() {
    thrown.expect(IllegalArgumentException.class);
    thrown.expectMessage("Missing steps for expression: */");
    assertNotNull(ExecutionTime.forCron(parser.parse("*/ * * * * ?")));
  }

  @Test(expected = IllegalArgumentException.class) public void rejectHashInDoM() {
    parser.parse("* * * 6#3 * ?");
  }

  @Test(expected = IllegalArgumentException.class) public void rejectWInDoW() {
    parser.parse("* * * ? * W");
  }
}