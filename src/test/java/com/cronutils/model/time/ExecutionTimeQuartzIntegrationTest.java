...
public class ExecutionTimeQuartzIntegrationTest {
  ...
  @Test public void testForCron() throws Exception {
    assertEquals(ExecutionTime.class, ExecutionTime.forCron(parser.parse(EVERY_SECOND)).getClass());
  }

  @Test public void testNextExecutionEverySecond() throws Exception {
  ...
  @Test public void testLastExecution() throws Exception {
    ZonedDateTime now = truncateToSeconds(ZonedDateTime.now());
  ...
  @Test public void testTimeFromLastExecution() throws Exception {
    ZonedDateTime now = truncateToSeconds(ZonedDateTime.now());
    ZonedDateTime expected = truncateToSeconds(now.minusSeconds(1));
    ExecutionTime executionTime = ExecutionTime.forCron(parser.parse(EVERY_SECOND));
  ...
  /**
     ...
     */
  @Test public void testDoesNotIgnoreMonthOrDayOfWeek() {
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void testHourlyIntervalTimeFromLastExecution() throws Exception {
  ...
  /**
     ...
     */
  @Test public void testShiftTo24thHour() {
    String expression = "0/1 * * 1/1 * ? *";
  ...
  /**
     ...
     */
  @Test public void testShiftTo32ndDay() {
    String expression = "0/1 * * 1/1 * ? *";
    ExecutionTime executionTime = ExecutionTime.forCron(parser.parse(expression));
  ...
  /**
     ...
     */
  @Test public void testTimeShiftingProperlyDone() throws Exception {
  ...
  /**
     ...
     */
  @Test public void testSaturdayExecutionTime() {
    ZonedDateTime now = ZonedDateTime.now();
  ...
  /**
     ...
     */
  @Test public void testWeekdayExecutionTime() {
    ZonedDateTime now = ZonedDateTime.now();
  ...
  /**
     ...
     */
  @Test public void testExecutionTimeForRanges() {
  ...
  /**
     ...
     */
  @Test public void testLastExecutionTimeForFixedMonth() {
  ...
  /**
     ...
     */
  @Test public void testNextExecutionRightDoWForFixedMonth() {
  ...
  /**
     * Issue #66: Incorrect Day Of Week processing for Quartz when Month or Year isn't '*'.
     */
  @Test public void testNextExecutionRightDoWForFixedYear() {
  ...
  /**
     ...
     */
  @Test(expected = IllegalArgumentException.class) public void testIllegalQuestionMarkValue() {
    ExecutionTime.forCron(parser.parse("0 0 12 1W ? *"));
  }
  ...
  /**
     ...
     */
  @Test public void testNextExecutionProducingInvalidPrintln() {
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void testMultipleMinuteIntervalTimeFromLastExecution() {
    String expression = "* 8-10,23-25,38-40,53-55 * * * ? *";
    ExecutionTime executionTime = ExecutionTime.forCron(parser.parse(expression));
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void testMultipleMinuteIntervalMatch() {
  ...
  @Test public void testDayLightSavingsSwitch() {
    ...
    DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy MM dd HH:mm:ss").withZone(ZoneId.of("America/Denver"));
  ...
  @Test public void bigNumbersOnDayOfMonthField() {
  ...
  @Test public void noSpecificDayOfMonthEvaluatedOnLastDay() {
  ...
  /**
     ...
     */
  @Test public void testCronWithFirstWorkDayOfWeek() {
    ...
    assertEquals("incorrect Day", nextRun.getDayOfMonth(), 1);
  }
  ...
  @Test public void testDayOfWeekMapping() {
    ...
    assertEquals("same generated dates", numberExec.nextExecution(fridayMorning), nameExec.nextExecution(fridayMorning));
  }

  /**
     * Issue #91: Calculating the minimum interval for a cron expression.
     */
  @Test public void testMinimumInterval() {
  ...
  /**
     ...
     */
  @Test public void noDateTimeExceptionIsThrownGeneratingNextExecutionWithDayOfWeekFilters() {
    ...
    String[] cronExpressionsExcludingWednesdayAndIncludingThursday = { "0 0/1 * ? * 5", "0 0/1 * ? * 2,5", "0 0/1 * ? * THU", "0 0/1 * ? * THU,SAT", "0 0/1 * ? * 5-6", "0 0/1 * ? * THU-FRI" };
    ...
    assertExpectedNextExecution("0 0/1 * ? * 5-6", endOfFridayNov4, startOfThursdayNov10);
    assertExpectedNextExecution("0 0/1 * ? * THU-FRI", endOfFridayNov4, startOfThursdayNov10);
  }

  /**
     * Issue #114: Describe day of week is incorrect
     */
  @Test public void descriptionForExpressionTellsWrongDoW() {
  }

  /**
     * Issue #117: Last Day of month Skipped on Quartz Expression: 0 * * ? * *
     */
  @Test public void noSpecificDayOfMonth() {
    Cron cron = parser.parse("0 * * ? * *");
    ExecutionTime executionTime = ExecutionTime.forCron(cron);
  ...
  /**
     ...
     */
  @Test public void testNextExecutionTimeProperlySet() {
  ...
  /**
     ...
     */
  @Test public void testNextExecutionTimeProperlySet2() {
    CronParser quartzCronParser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(QUARTZ));
  ...
  /**
     ...
     */
  @Test public void validate31IsSupportedForDoM() {
  ...
  /**
     ...
     */
  @Test public void validateIsMatchForRangeOfDates() {
  ...
  /**
     ...
     */
  @Test public void nextExecutionNotFail() {
  ...
  /**
     ...
     */
  @Test public void lastDayOfTheWeek() throws Exception {
    ...
    ZonedDateTime expected = date.plusDays(2);
    ZonedDateTime cronUtilsNextTime = ExecutionTime.forCron(cron).nextExecution(date).get();
    ...
    Date quartzNextTime = cronExpression.getNextValidTimeAfter(DateTimeUtils.toDate(date.toInstant()));
    assertEquals(expected.toInstant(), DateTimeUtils.toInstant(quartzNextTime));
    assertEquals(expected.toInstant(), cronUtilsNextTime.toInstant());
  }
  ...
  /**
     ...
     */
  @Test public void lastExecutionDec31NotFail() {
  ...
  public void testPeriodicIncrementalHoursIgnorePeriodBounds() {
    ...
    ZonedDateTime[] expected = new ZonedDateTime[] { ZonedDateTime.of(2016, 12, 27, 16, 0, 0, 0, ZoneId.of("UTC")), ZonedDateTime.of(2016, 12, 27, 18, 0, 0, 0, ZoneId.of("UTC")), ZonedDateTime.of(2016, 12, 28, 16, 0, 0, 0, ZoneId.of("UTC")), ZonedDateTime.of(2016, 12, 28, 18, 0, 0, 0, ZoneId.of("UTC")), ZonedDateTime.of(2016, 12, 29, 16, 0, 0, 0, ZoneId.of("UTC")) };
  ...
  /**
     ...
     */
  @Test public void mustJumpToNextMonthIfCurrentMonthDoesNotHaveDesiredDay() {
    CronParser parser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(QUARTZ));
    ExecutionTime executionTime = ExecutionTime.forCron(parser.parse("0 0 8 31 * ?"));
  ...
  /**
     ...
     * Reported case: executionTime.nextExecution fails to find when current month does not have desired day
     */
  @Test public void mustJumpToEndOfMonthIfCurrentMonthHasDesiredDay() {
    CronParser parser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(QUARTZ));
    ExecutionTime executionTime = ExecutionTime.forCron(parser.parse("0 0 8 31 * ?"));
  ...
  public void mustMatchLowerBoundDateMatchingCronExpressionRequirements() {
    ...
    ExecutionTime executionTime = ExecutionTime.forCron(parser.parse("0 0 0 1 * ?"));
    ExecutionTime constraintExecutionTime = ExecutionTime.forCron(parser.parse("0 0 0 1 * ? 2017"));
  ...
  private void assertExpectedNextExecution(String cronExpression, ZonedDateTime lastRun, ZonedDateTime expectedNextRun) {
