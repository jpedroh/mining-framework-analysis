...
public class ExecutionTimeQuartzIntegrationTest {
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void testMultipleMinuteIntervalTimeFromLastExecution() throws Exception {
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void testMultipleMinuteIntervalMatch() throws Exception {
  ...
  @Test(expected = IllegalArgumentException.class) public void testIllegalQuestionMarkValue() {
    final CronParser quartzParser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(CronType.QUARTZ));
    ExecutionTime.forCron(quartzParser.parse("0 0 12 1W ? *"));
  }
