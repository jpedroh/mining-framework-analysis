...
public class ExecutionTimeUnixIntegrationTest {
  @Test public void testIsMatchForUnix01() {
  ...
  @Test public void testIsMatchForUnix02() {
    CronParser parser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(CronType.UNIX));
    String crontab = "0 * * * 1-5";
    Cron cron = parser.parse(crontab);
    ExecutionTime executionTime = ExecutionTime.forCron(cron);
  ...
  /**
     ...
     */
  @Test public void testEveryTenMinutesNextExecution() {
    CronParser parser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(CronType.UNIX));
  ...
  /**
     ...
     */
  @Test public void testEveryTuesdayAtThirdHourOfDayNextExecution() {
    CronDefinition cronDefinition = CronDefinitionBuilder.instanceDefinitionFor(CronType.UNIX);
  ...
  /**
     * Issue #41: for everything other than a dayOfWeek value == 1, nextExecution and lastExecution do not return correct results
     */
  @Test public void testEveryTuesdayAtThirdHourOfDayLastExecution() {
    CronDefinition cronDefinition = CronDefinitionBuilder.instanceDefinitionFor(CronType.UNIX);
    CronParser parser = new CronParser(cronDefinition);
    Cron myCron = parser.parse("0 3 * * 3");
    ZonedDateTime time = ZonedDateTime.parse("2015-09-17T00:00:00.000-07:00");
  ...
  /**
     ...
     */
  @Test public void testMondayWeekdayNextExecution() {
    String crontab = "* * * * 1";
    CronDefinition cronDefinition = CronDefinitionBuilder.instanceDefinitionFor(CronType.UNIX);
    CronParser parser = new CronParser(cronDefinition);
    Cron cron = parser.parse(crontab);
  ...
  /**
     ...
     */
  @Test public void testNextExecutionDaylightSaving() {
    CronParser parser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(CronType.UNIX));
  ...
  /**
     ...
     */
  @Test public void testLastExecutionDaylightSaving() {
    CronParser parser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(CronType.UNIX));
    ExecutionTime executionTime = ExecutionTime.forCron(parser.parse("0 17 * * *"));
  ...
  /**
     ...
     */
  @Test public void testNextExecution2014() {
  ...
  /**
     ...
     */
  @Test public void testNextExecution2016() {
    CronParser parser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(CronType.UNIX));
  ...
  /**
     ...
     */
  @Test public void testNextExecutionProducesStackTraces() throws Exception {
    CronParser parser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(CronType.UNIX));
  ...
  /**
     ...
     */
  @Test public void exact_hit_returns_full_interval_duration() {
    CronParser parser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(CronType.UNIX));
  ...
  /**
     ...
     * https://github.com/jmrozanec/cron-utils/issues/130
     */
  @Test public void fuzzy_hit_returns_very_small_interval_duration() {
    CronParser parser = new CronParser(CronDefinitionBuilder.instanceDefinitionFor(CronType.UNIX));
    Cron cron = parser.parse("0 12 * * *");
