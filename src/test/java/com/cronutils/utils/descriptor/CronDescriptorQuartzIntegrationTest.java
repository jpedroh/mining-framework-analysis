...
public class CronDescriptorQuartzIntegrationTest {
  ...
  @Test public void testCronWithAndHours() {
    assertExpression("* * 1,2,3,4 * * ? *", "at 1, 2, 3 and 4 hours");
  }

  @Test public void testCronAndWithRangeHours() {
    assertExpression("* * 1,2,3,4,6-9 * * ? *", "at 1, 2, 3 and 4 hours and every hour between 6 and 9");
  }

  @Test public void testCronAndWithRangesAndEveryExpressions() {
  ...
  @Test public void testEverySecond() {
    assertExpression("* * * * * ?", "every second");
  }

  @Test public void testEvery45Seconds() {
    assertExpression("*/45 * * * * ?", "every 45 seconds");
  }

  @Test public void testEveryHour() {
    assertExpression("0 0 * * * ?", "every hour");
    assertExpression("0 0 0/1 * * ?", "every hour");
  }

  @Test public void testEveryDayFireAtNoon() {
    assertExpression("0 0 12 * * ?", "at 12:00");
  }

  @Test public void testEveryDayFireAtTenFifteen() {
  ...
  @Test public void testEveryDayFireAtTenFifteenYear2005() {
    assertExpression("0 15 10 * * ? 2005", "at 10:15 at 2005 year");
  }

  @Test public void testEveryMinuteBetween14and15EveryDay() {
    assertExpression("0 * 14 * * ?", "at 14 hour");
  }

  @Test public void testEveryFiveMinutesBetween14and15EveryDay() {
    assertExpression("0 0/5 14 * * ?", "every 5 minutes at 14 hour");
  }

  @Test public void testEveryFiveMinutesBetween14and15AndBetween18And19EveryDay() {
  ...
  /**
     ...
     */
  @Test public void testEveryDayEveryFourHoursFromHour2() {
    assertExpression("0 0 2/4 * * ?", "every 4 hours at minute 0");
  }

  @Test public void testDescriptionDayOfWeek() {
