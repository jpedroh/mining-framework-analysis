...
public class TestAzureTableInputFormat {
  ...
  @Test public void testGetSplits() throws Exception {
    ...
    AzureTableConfiguration.configureInputTable(conf, t.getName(), getAccountUri(), getAccountKey());
  ...
  @Test public void testRecordReader() throws Exception {
    ...
    RecordReader<Text, WritableEntity> reader = inputFormat.createRecordReader(split, taskContext);
