...
public class TestGraphUtil {
  ...
  public static List<Relationship> createTestEdgesMakingSquareGraphWithUnbalancedWeight(Node n1, Node n2, Node n3, Node n4, GraphDatabaseService graphDb) {
    Transaction tx = graphDb.beginTx();
    List<Relationship> testEdges = Lists.newArrayList();
    try {
      Relationship e1 = n1.createRelationshipTo(n2, RelTypes.X);
  ...
  public static List<Relationship> createTestEdgesMakingBrancheGraphWithUnbalancedWeight(Node n1, Node n2, Node n3, Node n4, Node n5, GraphDatabaseService graphDb) {
    Transaction tx = graphDb.beginTx();
    List<Relationship> testEdges = Lists.newArrayList();
    try {
      Relationship e1 = n1.createRelationshipTo(n2, RelTypes.X);
  ...
  public static List<Relationship> createTestEdgesCypherGraph(Node n1, Node n2, Node n3, Node n4, Node n5, Node n6, Node n7, Node n8, Node n9, Node n10, GraphDatabaseService graphDb) {
    Transaction tx = graphDb.beginTx();
    List<Relationship> testEdges = Lists.newArrayList();
    try {
      Relationship e1 = n1.createRelationshipTo(n2, RelTypes.X);
