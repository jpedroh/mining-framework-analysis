 ...
 *
 */
@RunWith(value = MockitoJUnitRunner.class) @CommonsLog public class PrefetchGetRecordsCacheIntegrationTest {
  ...
  @Before public void setup() {
    ...
    getRecordsCache = new PrefetchGetRecordsCache(MAX_SIZE, MAX_BYTE_SIZE, MAX_RECORDS_COUNT, MAX_RECORDS_PER_CALL, getRecordsRetrievalStrategy, executorService, 
...
>>>>>>> /usr/src/app/output/awslabs/amazon-kinesis-client/2fc4267b832ae2088fe8f2f84187b9e3ec73677d/src/test/java/com/amazonaws/services/kinesis/clientlibrary/lib/worker/PrefetchGetRecordsCacheIntegrationTest.java/right.java
  ...
  @Test public void testRollingCache() {
  ...
  @Test public void testFullCache() {
    getRecordsCache.start();
  ...
  @Test public void testDifferentShardCaches() {
    ...
    GetRecordsCache getRecordsCache2 = new PrefetchGetRecordsCache(MAX_SIZE, MAX_BYTE_SIZE, MAX_RECORDS_COUNT, MAX_RECORDS_PER_CALL, getRecordsRetrievalStrategy2, executorService2, 
<<<<<<< /usr/src/app/output/awslabs/amazon-kinesis-client/2fc4267b832ae2088fe8f2f84187b9e3ec73677d/src/test/java/com/amazonaws/services/kinesis/clientlibrary/lib/worker/PrefetchGetRecordsCacheIntegrationTest.java/left.java
    new NullMetricsFactory()
=======
    IDLE_MILLIS_BETWEEN_CALLS
>>>>>>> /usr/src/app/output/awslabs/amazon-kinesis-client/2fc4267b832ae2088fe8f2f84187b9e3ec73677d/src/test/java/com/amazonaws/services/kinesis/clientlibrary/lib/worker/PrefetchGetRecordsCacheIntegrationTest.java/right.java
  ...
  private class KinesisDataFetcherForTest extends KinesisDataFetcher {
    public KinesisDataFetcherForTest(final IKinesisProxy kinesisProxy, final ShardInfo shardInfo) {
      super(kinesisProxy, shardInfo);
    }

    @Override public DataFetcherResult getRecords(final int maxRecords) {
