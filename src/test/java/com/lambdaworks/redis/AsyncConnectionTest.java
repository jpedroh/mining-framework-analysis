...
public class AsyncConnectionTest extends AbstractRedisClientTest {
  ...
  @Before public void openAsyncConnection() throws Exception {
    async = client.connectAsync();
  }

  @After public void closeAsyncConnection() throws Exception {
    async.close();
  }

  @Test(timeout = 10000) public void multi() throws Exception {
  ...
  @Test(timeout = 10000) public void watch() throws Exception {
  ...
  @Test(timeout = 10000) public void futureListener() throws Exception {
  ...
  @Test(timeout = 1000) public void futureListenerCompleted() throws Exception {
    final List<Object> run = new ArrayList<Object>();
    Runnable listener = new Runnable() {
      @Override public void run() {
        run.add(new Object());
  ...
  @Test(timeout = 500) public void discardCompletesFutures() throws Exception {
    async.multi();
    Future<String> set = async.set(key, value);
    async.discard();
    assertThat(set.get()).isNull();
  ...
  @Test(timeout = 10000) public void awaitAll() throws Exception {
  ...
  @Test(timeout = 500) public void awaitAllTimeout() throws Exception {
