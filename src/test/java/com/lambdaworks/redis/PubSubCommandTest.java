...
public class PubSubCommandTest extends AbstractCommandTest implements RedisPubSubListener<String, String> {
  ...
  @Before public void openPubSubConnection() throws Exception {
  ...
  @After public void closePubSubConnection() throws Exception {
    pubsub.close();
  }

  @Test public void auth() throws Exception {
    new WithPasswordRequired() {
      @Override protected void run(RedisClient client) throws Exception {
  ...
  @Test public void authWithReconnect() throws Exception {
    new WithPasswordRequired() {
      @Override protected void run(RedisClient client) throws Exception {
        RedisPubSubConnection<String, String> connection = client.connectPubSub();
        connection.addListener(PubSubCommandTest.this);
  ...
  @Test(timeout = 200) public void message() throws Exception {
  ...
  @Test(timeout = 200) public void pmessage() throws Exception {
  ...
  @Test(timeout = 200) public void psubscribe() throws Exception {
  ...
  @Test(timeout = 200) public void psubscribeWithListener() throws Exception {
    RedisFuture<Void> psubscribe = pubsub.psubscribe(pattern);
  ...
  @Test public void pubsubEmptyChannels() throws Exception {
  ...
  @Test public void pubsubChannels() throws Exception {
  ...
  @Test public void pubsubMultipleChannels() throws Exception {
  ...
  @Test public void pubsubNumpat() throws Exception {
    pubsub.psubscribe(pattern).get();
    Long result = redis.pubsubNumpat();
    assertThat(result.longValue()).isEqualTo(1L);
  }

  @Test public void punsubscribe() throws Exception {
    pubsub.punsubscribe(pattern).get();
    assertThat(patterns.take()).isEqualTo(pattern);
    assertThat((long) counts.take()).isEqualTo(0);
  }

  @Test(timeout = 200) public void subscribe() throws Exception {
    pubsub.subscribe(channel);
    assertThat(channels.take()).isEqualTo(channel);
    assertThat((long) counts.take()).isEqualTo(1);
  }

  @Test(timeout = 200) public void unsubscribe() throws Exception {
  ...
  @Test public void pubsubCloseOnClientShutdown() throws Exception {
  ...
  @Test(timeout = 200) public void utf8Channel() throws Exception {
  ...
  @Test(timeout = 2000) public void resubscribeChannelsOnReconnect() throws Exception {
    pubsub.subscribe(channel);
    assertThat(channels.take()).isEqualTo(channel);
    assertThat((long) counts.take()).isEqualTo(1);
    pubsub.quit();
  ...
  @Test(timeout = 2000) public void resubscribePatternsOnReconnect() throws Exception {
  ...
  @Test(timeout = 200) public void adapter() throws Exception {
  ...
  @Test(timeout = 2000) public void removeListener() throws Exception {
    pubsub.subscribe(channel);
    assertThat(channels.take()).isEqualTo(channel);
    redis.publish(channel, message);
    assertThat(channels.take()).isEqualTo(channel);
