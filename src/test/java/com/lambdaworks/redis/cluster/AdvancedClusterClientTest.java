 ...
 */
@SuppressWarnings(value = { "rawtypes" }) public class AdvancedClusterClientTest extends AbstractClusterTest {
  ...
  @Test public void nodeConnections() throws Exception {
  ...
  @Test public void differentConnections() throws Exception {
    for (RedisClusterNode redisClusterNode : clusterClient.getPartitions()) {
      RedisClusterAsyncConnection<String, String> nodeId = 
...
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/test/java/com/lambdaworks/redis/cluster/AdvancedClusterClientTest.java/right.java
      ...
      RedisClusterAsyncConnection<String, String> hostAndPort = 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/test/java/com/lambdaworks/redis/cluster/AdvancedClusterClientTest.java/left.java
      connection
=======
      commands
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/test/java/com/lambdaworks/redis/cluster/AdvancedClusterClientTest.java/right.java
    ...
    for (RedisClusterNode redisClusterNode : clusterClient.getPartitions()) {
      ...
      StatefulRedisConnection<String, String> hostAndPort = statefulConnection.getConnection(redisClusterNode.getUri().getHost(), redisClusterNode.getUri().getPort());
      assertThat(nodeId).isNotSameAs(hostAndPort);
    }
    ...
    for (RedisClusterNode redisClusterNode : clusterClient.getPartitions()) {
      ...
      RedisClusterCommands<String, String> hostAndPort = sync.getConnection(redisClusterNode.getUri().getHost(), redisClusterNode.getUri().getPort());
      assertThat(nodeId).isNotSameAs(hostAndPort);
    }
    ...
    for (RedisClusterNode redisClusterNode : clusterClient.getPartitions()) {
      ...
      RedisClusterReactiveCommands<String, String> hostAndPort = rx.getConnection(redisClusterNode.getUri().getHost(), redisClusterNode.getUri().getPort());
      assertThat(nodeId).isNotSameAs(hostAndPort);
    }
  }

  @Test(expected = RedisException.class) public void unknownNodeId() throws Exception {
    commands.getConnection("unknown");
  }

  @Test(expected = RedisException.class) public void invalidHost() throws Exception {
  ...
  @Test public void doWeirdThingsWithClusterconnections() throws Exception {
    assertThat(clusterClient.getPartitions()).hasSize(4);
    for (RedisClusterNode redisClusterNode : clusterClient.getPartitions()) {
      RedisClusterAsyncConnection<String, String> nodeConnection = commands.getConnection(redisClusterNode.getNodeId());
  ...
  @Test public void msetRegular() throws Exception {
  ...
  @Test public void noAddr() throws Exception {
  ...
  @Test public void msetCrossSlot() throws Exception {
  ...
  @Test public void forbiddenHostOnRedirect() throws Exception {
    RedisAdvancedClusterConnection<String, String> sync = clusterClient.connectCluster();
    try {
      Partitions partitions = clusterClient.getPartitions();
      for (RedisClusterNode partition : partitions) {
  ...
  @Test public void msetnxCrossSlot() throws Exception {
    Map<String, String> mset = prepareMset();
  ...
  @Test public void mgetRegular() throws Exception {
    msetRegular();
    List<String> result = syncCommands.mget(key);
    assertThat(result).hasSize(1);
  }

  @Test public void mgetCrossSlot() throws Exception {
    msetCrossSlot();
  ...
  @Test public void delRegular() throws Exception {
    msetRegular();
  ...
  @Test public void delCrossSlot() throws Exception {
  ...
  @Test public void unlinkRegular() throws Exception {
    msetRegular();
    Long result = syncCommands.unlink(key);
    assertThat(result).isEqualTo(1);
  ...
  @Test public void unlinkCrossSlot() throws Exception {
    List<String> keys = prepareKeys();
  ...
  @Test public void clientSetname() throws Exception {
    ...
    for (RedisClusterNode redisClusterNode : clusterClient.getPartitions()) {
      RedisClusterCommands<String, String> nodeConnection = commands.getStatefulConnection().sync().getConnection(redisClusterNode.getNodeId());
      assertThat(nodeConnection.clientList()).contains(name);
    }
  }

  @Test(expected = RedisCommandExecutionException.class) public void clientSetnameRunOnError() throws Exception {
  ...
  @Test public void keysStreaming() throws Exception {
    writeKeysToTwoNodes();
  ...
  @Test public void scriptFlush() throws Exception {
    assertThat(syncCommands.scriptFlush()).isEqualTo("OK");
  }

  @Test public void scriptKill() throws Exception {
    assertThat(syncCommands.scriptKill()).isEqualTo("OK");
  }

  @Test @Ignore(value = "Run me manually, I will shutdown all your cluster nodes so you need to restart the Redis Cluster after this test") public void shutdown() throws Exception {
  ...
  @Test public void routeCommandTonoAddrPartition() throws Exception {
  ...
  @Test public void routeCommandToForbiddenHostOnRedirect() throws Exception {
    RedisClusterCommands<String, String> sync = clusterClient.connect().sync();
    try {
      Partitions partitions = clusterClient.getPartitions();
      for (RedisClusterNode partition : partitions) {
  ...
  @Test public void getConnectionToNotAClusterMemberForbidden() throws Exception {
    RedisAdvancedClusterConnection<String, String> sync = clusterClient.connectCluster();
    try {
  ...
  @Test public void getConnectionToNotAClusterMemberAllowed() throws Exception {
...
=======
    connection
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/test/java/com/lambdaworks/redis/cluster/AdvancedClusterClientTest.java/right.java
    .getConnection(TestSettings.host(), TestSettings.port());
...
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/test/java/com/lambdaworks/redis/cluster/AdvancedClusterClientTest.java/right.java
  ...
  @Test public void pipelining() throws Exception {
...
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/test/java/com/lambdaworks/redis/cluster/AdvancedClusterClientTest.java/right.java
    <String, String> verificationConnection = 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/dea8f66f846bf37494c18d1ca6036edd4a2f7898/src/test/java/com/lambdaworks/redis/cluster/AdvancedClusterClientTest.java/left.java
