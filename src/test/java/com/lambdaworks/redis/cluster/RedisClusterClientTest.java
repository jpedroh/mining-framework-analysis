...
@FixMethodOrder(value = MethodSorters.NAME_ASCENDING) @SuppressWarnings(value = { "unchecked" }) public class RedisClusterClientTest extends AbstractClusterTest {

<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/89d0af927de4c4f0621247f7fede9cac81b25f15/src/test/java/com/lambdaworks/redis/cluster/RedisClusterClientTest.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void statefulConnectionFromSync() throws Exception {
  ...
  @Test public void testClusterNodes() throws Exception {
  ...
  @Test public void testClusterNodesSync() throws Exception {
  ...
  @Test public void testClusterSlaves() throws Exception {
  ...
  private void setNode4SlaveOfNode1() throws InterruptedException, TimeoutException {
    ...
    final RedisClusterNode node1 = Iterables.find(partitions, new Predicate<RedisClusterNode>() {
      @Override public boolean apply(RedisClusterNode input) {
  ...
  @Test public void testAsking() throws Exception {
    clusterClient.reloadPartitions();
    assertThat(redissync1.asking()).isEqualTo("OK");
  }

  @Test public void testClusteredOperations() throws Exception {
    SlotHash.getSlot("b".getBytes());
    SlotHash.getSlot("a".getBytes());
  ...
  @Test public void testReset() throws Exception {
    clusterClient.reloadPartitions();
    RedisAdvancedClusterAsyncConnectionImpl<String, String> connection = 
<<<<<<< /usr/src/app/output/lettuce-io/lettuce-core/89d0af927de4c4f0621247f7fede9cac81b25f15/src/test/java/com/lambdaworks/redis/cluster/RedisClusterClientTest.java/left.java
    (RedisAdvancedClusterAsyncConnectionImpl) clusterClient.connectClusterAsync()
=======
    clusterClient.connectClusterAsync()
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/89d0af927de4c4f0621247f7fede9cac81b25f15/src/test/java/com/lambdaworks/redis/cluster/RedisClusterClientTest.java/right.java
    ;
    RedisFuture<String> setA = connection.set("a", "myValue1");
    setA.get();
    connection.reset();
  ...
  @Test public void testClusterSlots() throws Exception {
  ...
  @Test @SuppressWarnings(value = { "rawtypes" }) public void testClusterCommandRedirection() throws Exception {
    RedisClusterAsyncConnection<String, String> connection = clusterClient.connectClusterAsync();
  ...
  @Test @SuppressWarnings(value = { "rawtypes" }) public void testClusterRedirection() throws Exception {
    RedisClusterAsyncConnection<String, String> connection = clusterClient.connectClusterAsync();
  ...
  @Test public void readOnly() throws Exception {
    String key = "b";
...
<<<<<<< Unknown file: This is a bug in JDime.
=======
  @Test public void testClusterConnectionStability() throws Exception {
    RedisAsyncConnectionImpl<String, String> connection = (RedisAsyncConnectionImpl<String, String>) clusterClient.connectClusterAsync();
    connection.set("a", "b");
    ClusterDistributionChannelWriter<String, String> writer = (ClusterDistributionChannelWriter<String, String>) connection.getChannelWriter();
    final RedisAsyncConnectionImpl<Object, Object> backendConnection = writer.getClusterConnectionProvider().getConnection(ClusterConnectionProvider.Intent.WRITE, 3300);
    ...
    connection.set("a", "b");
    RedisAsyncConnectionImpl<Object, Object> backendConnection2 = writer.getClusterConnectionProvider().getConnection(ClusterConnectionProvider.Intent.WRITE, 3300);
...
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/89d0af927de4c4f0621247f7fede9cac81b25f15/src/test/java/com/lambdaworks/redis/cluster/RedisClusterClientTest.java/right.java
  ...
  @Test public void readOnlyWithReconnect() throws Exception {
    String key = "b";
    prepareReadonlyTest(key);
    RedisConnection<String, String> connect4 = client.connect(RedisURI.Builder.redis(host, port4).build());
    assertThat(connect4.readOnly()).isEqualTo("OK");
...
<<<<<<< Unknown file: This is a bug in JDime.
=======
  @Test(timeout = 20000) public void distributedClusteredAccessAsync() throws Exception {
    RedisClusterAsyncConnection<String, String> connection = clusterClient.connectClusterAsync();
...
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/89d0af927de4c4f0621247f7fede9cac81b25f15/src/test/java/com/lambdaworks/redis/cluster/RedisClusterClientTest.java/right.java
  ...
  protected void waitUntilValueIsVisible(String key, RedisConnection<String, String> connection) throws InterruptedException, TimeoutException {
...
<<<<<<< Unknown file: This is a bug in JDime.
=======
  @Test(timeout = 20000) public void distributedClusteredAccessSync() throws Exception {
    RedisClusterConnection<String, String> connection = clusterClient.connectCluster();
    for (int i = 0; i < 100; i++) {
...
>>>>>>> /usr/src/app/output/lettuce-io/lettuce-core/89d0af927de4c4f0621247f7fede9cac81b25f15/src/test/java/com/lambdaworks/redis/cluster/RedisClusterClientTest.java/right.java
  ...
  protected void prepareReadonlyTest(String key) throws InterruptedException, TimeoutException, java.util.concurrent.ExecutionException {
    setNode4SlaveOfNode1();
  ...
  @Test public void readOnlyReadWrite() throws Exception {
    String key = "b";
    prepareReadonlyTest(key);
  ...
  @Test public void readOnlyOnCluster() throws Exception {
    syncConnection.readOnly();
    syncConnection.set("b", "b");
  }

  @Test(expected = RedisException.class) public void closeConnection() throws Exception {
  ...
  @Test public void clusterAuth() throws Exception {
    RedisClusterClient clusterClient = new RedisClusterClient(RedisURI.Builder.redis(TestSettings.host(), port7).withPassword("foobared").build());
    try (RedisAdvancedClusterConnection<String, String> connection = clusterClient.connectCluster()) {
      List<String> time = connection.time();
      assertThat(time).hasSize(2);
  ...
  @Test(expected = RedisException.class) public void clusterNeedsAuthButNotSupplied() throws Exception {
  ...
  @Test public void noClusterNodeAvailable() throws Exception {
  ...
  @Test public void getClusterNodeConnection() throws Exception {
  ...
  @Test public void operateOnNodeConnection() throws Exception {
    RedisClusterNode redis1Node = getOwnPartition(redissync2);
    syncConnection.set("a", "b");
    syncConnection.set("b", "c");
    StatefulRedisConnection<String, String> statefulRedisConnection = syncConnection.getStatefulConnection().getConnection(TestSettings.host(), port3);
  ...
  @Test public void testStatefulConnection() throws Exception {
