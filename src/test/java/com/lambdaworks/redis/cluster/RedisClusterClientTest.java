...
@FixMethodOrder(value = MethodSorters.NAME_ASCENDING) @SuppressWarnings(value = { "unchecked" }) public class RedisClusterClientTest {
  ...
  @Test public void testClusterFailover() throws Exception {
  ...
  @Test public void testNoClusterNodeAvailable() throws Exception {
