...
public class RedisURIBuilderTest {
  @Test public void sentinel() throws Exception {
  ...
  @Test public void sentinelWithPort() throws Exception {
  ...
  @Test public void redisWithPort() throws Exception {
  ...
  @Test public void redisFromUrl() throws Exception {
  ...
  @Test public void redisFromUrlNoPassword() throws Exception {
  ...
  @Test public void redisFromUrlPassword() throws Exception {
  ...
  @Test public void redisWithSSL() throws Exception {
  ...
  @Test public void redisSslFromUrl() throws Exception {
  ...
  @Test public void redisSentinelFromUrl() throws Exception {
  ...
  @Test(expected = IllegalStateException.class) public void redisSentinelWithSSLNotPossible() throws Exception {
    RedisURI.Builder.sentinel("a", 1, "master").withSsl(true);
  }

  @Test(expected = IllegalStateException.class) public void redisSentinelWithTLSNotPossible() throws Exception {
    RedisURI.Builder.sentinel("a", 1, "master").withStartTls(true);
  }

  @Test(expected = IllegalArgumentException.class) public void invalidScheme() throws Exception {
    RedisURI.create("http://www.web.de");
  }

  @Test public void redisSocket() throws Exception {
  ...
  @Test public void redisSocketWithPassword() throws Exception {
    File file = new File("work/socket-6479").getCanonicalFile();
