...
public class UnixDomainSocketTest {
  ...
  @Rule public SentinelRule sentinelRule = new SentinelRule(sentinelClient, false, 26379, 26380);
  ...
  @Test public void standalone_Linux_x86_64_socket() throws Exception {
    linuxOnly();
  ...
  @Test public void sentinel_Linux_x86_64_socket() throws Exception {
    linuxOnly();
  ...
  @Test public void sentinel_Linux_x86_64_socket_and_inet() throws Exception {
    ...
    RedisClient redisClient = new RedisClient(uri);
    RedisSentinelAsyncConnection<String, String> sentinelConnection = redisClient.connectSentinelAsync(getSentinelSocketRedisUri());
