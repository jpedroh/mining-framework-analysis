...
public class GerritRestClientTest {
  ...
  @Test public void testHttpClientBuilderExtension() throws Exception {
    ...
    HttpClientBuilderExtension httpClientBuilderExtension = new HttpClientBuilderExtension() {
      ...
      @Override public CredentialsProvider extendCredentialProvider(HttpClientBuilder httpClientBuilder, CredentialsProvider credentialsProvider, GerritAuthData authData) {
