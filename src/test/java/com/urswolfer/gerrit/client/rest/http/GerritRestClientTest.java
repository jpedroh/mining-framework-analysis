...
public class GerritRestClientTest {
  ...
  @BeforeClass public void startJetty() throws Exception {
    ...
    handlers.setHandlers(new Handler[] { servletContextHandler, resourceHandler, basicAuthContextHandler });
  ...
  @Test(expectedExceptions = RestApiException.class) public void testInvalidHost() throws Exception {
  ...
  @Test public void testGetChanges() throws Exception {
  ...
  @Test public void testGetSelfAccount() throws Exception {
    GerritApi gerritClient = getGerritApiWithJettyHost();
    AccountInfo accountInfo = gerritClient.accounts().self().get();
    Truth.assertThat(accountInfo.name).isEqualTo("John Doe");
  }

  @Test(expectedExceptions = HttpStatusException.class) public void testGetInvalidAccount() throws Exception {
    GerritApi gerritClient = getGerritApiWithJettyHost();
  ...
  @Test public void testGetCommitMsgHook() throws Exception {
  ...
  @Test(expectedExceptions = HttpStatusException.class) public void testStarNotLoggedIn() throws Exception {
    GerritApi gerritClient = getGerritApiWithJettyHost();
    gerritClient.accounts().self().starChange("1");
  }

  @Test(expectedExceptions = HttpStatusException.class) public void testUnstarNotLoggedIn() throws Exception {
    GerritApi gerritClient = getGerritApiWithJettyHost();
    gerritClient.accounts().self().unstarChange("1");
  }

  @Test(expectedExceptions = HttpStatusException.class) public void testAbandonNotLoggedIn() throws Exception {
    GerritApi gerritClient = getGerritApiWithJettyHost();
    gerritClient.changes().id(1).abandon();
  }

  @Test(expectedExceptions = RestApiException.class) public void testInvalidJson() throws Exception {
    GerritApi gerritClient = getGerritApiWithJettyHost();
    gerritClient.accounts().id("invalid_json").get();
  }

  @Test(expectedExceptions = RestApiException.class) public void testNullJson() throws Exception {
    GerritApi gerritClient = getGerritApiWithJettyHost();
    gerritClient.accounts().id("null_json").get();
  }

  @Test(expectedExceptions = IllegalStateException.class) public void testUnsupportedHttpMethod() throws Exception {
    GerritRestClient gerritRestClient = new GerritRestClient(new GerritAuthData.Basic(jettyUrl), new HttpRequestExecutor());
  ...
  /**
     ...
     */
  @Test(enabled = false) public void testUserAuth() throws Exception {
    GerritRestApiFactory gerritRestApiFactory = new GerritRestApiFactory();
  ...
  /**
     ...
     */
  @Test(enabled = false) public void testInvalidUserAuth() throws Exception {
    GerritRestApiFactory gerritRestApiFactory = new GerritRestApiFactory();
  ...
  /**
     ...
     */
  @Test public void testHttpClientBuilderExtension() throws Exception {
    ...
    HttpClientBuilderExtension httpClientBuilderExtension = new HttpClientBuilderExtension() {
      @Override public HttpClientBuilder extend(HttpClientBuilder httpClientBuilder, GerritAuthData authData) {
        extendCalled[0] = true;
        return super.extend(httpClientBuilder, authData);
      }

      @Override public BasicCredentialsProviderHC4 extendCredentialProvider(HttpClientBuilder httpClientBuilder, BasicCredentialsProviderHC4 credentialsProvider, GerritAuthData authData) {
  ...
  /**
     ...
     */
  @Test public void testGerritAuthExtractionAndCache() throws Exception {
    GerritRestClient gerritRestClient = new GerritRestClient(new GerritAuthData.Basic(jettyUrl), new HttpRequestExecutor());
  ...
  /**
     ...
     */
  @Test(enabled = false) public void testGerritAuthNotAvailable() throws Exception {
    GerritRestClient gerritRestClient = new GerritRestClient(new GerritAuthData.Basic(jettyUrl, "foo", "bar"), new HttpRequestExecutor());
    Field loginCacheField = gerritRestClient.getClass().getDeclaredField("loginCache");
    loginCacheField.setAccessible(true);
    LoginCache loginCache = (LoginCache) loginCacheField.get(gerritRestClient);
    Truth.assertThat(loginCache.getGerritAuthOptional().isPresent()).isFalse();
  ...
  @Test(enabled = false) public void testBasicRestCallToLocalhost() throws Exception {
    GerritRestApiFactory gerritRestApiFactory = new GerritRestApiFactory();
  ...
  @Test(enabled = false) public void testBasicRestCallToLocalhostProjects() throws Exception {
    GerritRestApiFactory gerritRestApiFactory = new GerritRestApiFactory();
    GerritApi gerritClient = gerritRestApiFactory.create(new GerritAuthData.Basic("http://localhost:8080"));
    List<ProjectInfo> projects = gerritClient.projects().list().get();
  ...
  @Test(enabled = false) public void testBasicRestCallToLocalhostProjectsQuery() throws Exception {
    GerritRestApiFactory gerritRestApiFactory = new GerritRestApiFactory();
    GerritApi gerritClient = gerritRestApiFactory.create(new GerritAuthData.Basic("http://localhost:8080"));
