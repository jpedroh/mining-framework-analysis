...
public class ID3v2TagTest {
  ...
  @Test public void shouldInitialiseFromHeaderBlockWithValidHeaders() throws NoSuchTagException, UnsupportedTagException, InvalidDataException {
  ...
  @Test public void shouldCalculateCorrectDataLengthsFromHeaderBlock() throws NoSuchTagException, UnsupportedTagException, InvalidDataException {
    byte[] header = BufferTools.copyBuffer(ID3V2_HEADER, 0, ID3V2_HEADER.length);
  ...
  @Test public void shouldThrowExceptionForNonSupportedVersionInId3v2HeaderBlock() throws NoSuchTagException, InvalidDataException {
    byte[] header = BufferTools.copyBuffer(ID3V2_HEADER, 0, ID3V2_HEADER.length);
    header[3] = 5;
    header[4] = 0;
    try {
  ...
  @Test public void shouldSortId3TagsAlphabetically() throws Exception {
  ...
  @Test public void shouldReadFramesFromMp3With32Tag() throws IOException, NoSuchTagException, UnsupportedTagException, InvalidDataException {
    byte[] buffer = TestHelper.loadFile("src/test/resources/v1andv23tags.mp3");
    ID3v2 id3v2tag = ID3v2TagFactory.createTag(buffer);
    assertEquals("3.0", id3v2tag.getVersion());
  ...
  @Test public void shouldReadId3v2WithFooter() throws IOException, NoSuchTagException, UnsupportedTagException, InvalidDataException {
  ...
  @Test public void shouldReadTagFieldsFromMp3With24tag() throws Exception {
  ...
  @Test public void shouldReadTagFieldsFromMp3With32tag() throws Exception {
  ...
  @Test public void shouldConvert23TagToBytesAndBackToEquivalentTag() throws Exception {
  ...
  @Test public void shouldConvert24TagWithFooterToBytesAndBackToEquivalentTag() throws Exception {
  ...
  @Test public void shouldConvert24TagWithPaddingToBytesAndBackToEquivalentTag() throws Exception {
    ID3v2 id3tag = new ID3v24Tag();
    setTagFields(id3tag);
  ...
  @Test public void shouldNotUsePaddingOnA24TagIfItHasAFooter() throws Exception {
    ID3v2 id3tag = new ID3v24Tag();
    setTagFields(id3tag);
    id3tag.setFooter(true);
    id3tag.setPadding(true);
  ...
  @Test public void shouldExtractGenreNumberFromCombinedGenreStringsCorrectly() throws Exception {
  ...
  @Test public void shouldExtractGenreDescriptionFromCombinedGenreStringsCorrectly() throws Exception {
    ID3v23TagForTesting id3tag = new ID3v23TagForTesting();
  ...
  @Test public void shouldSetCombinedGenreOnTag() throws Exception {
    ID3v2 id3tag = new ID3v23Tag();
    setTagFields(id3tag);
  ...
  @Test public void testSetGenreDescriptionOn23Tag() throws Exception {
    ID3v2 id3tag = new ID3v23Tag();
    setTagFields(id3tag);
  ...
  @Test public void testSetGenreDescriptionOn23TagWithUnknownGenre() throws Exception {
    ID3v2 id3tag = new ID3v23Tag();
    setTagFields(id3tag);
    try {
  ...
  @Test public void testSetGenreDescriptionOn24Tag() throws Exception {
    ID3v2 id3tag = new ID3v24Tag();
    setTagFields(id3tag);
    id3tag.setGenreDescription("Jazz");
    assertEquals("Jazz", id3tag.getGenreDescription());
  ...
  @Test public void testSetGenreDescriptionOn24TagWithUnknownGenre() throws Exception {
    ID3v2 id3tag = new ID3v24Tag();
    setTagFields(id3tag);
    id3tag.setGenreDescription("Bebop");
  ...
  @Test public void shouldReadCombinedGenreInTag() throws Exception {
    ID3v2 id3tag = new ID3v23Tag();
    setTagFields(id3tag);
  ...
  @Test public void shouldGetCommentAndItunesComment() throws Exception {
  ...
  @Test public void shouldReadFramesFromMp3WithObselete32Tag() throws Exception {
  ...
  @Test public void shouldReadTagFieldsFromMp3WithObselete32tag() throws Exception {
    byte[] buffer = TestHelper.loadFile("src/test/resources/obsolete.mp3");
    ID3v2 id3tag = ID3v2TagFactory.createTag(buffer);
  ...
  @Test public void shouldReadTagFieldsWithUnicodeDataFromMp3() throws Exception {
    byte[] buffer = TestHelper.loadFile("src/test/resources/v23unicodetags.mp3");
    ID3v2 id3tag = ID3v2TagFactory.createTag(buffer);
    assertEquals("\u03b3\u03b5\u03b9\u03ac \u03c3\u03bf\u03c5", id3tag.getArtist());
    assertEquals("\u4e2d\u6587", id3tag.getTitle());
    assertEquals("\u3053\u3093\u306b\u3061\u306f", id3tag.getAlbum());
    assertEquals("\u0ab9\u0ac7\u0ab2\u0acd\u0ab2\u0acb", id3tag.getComposer());
  }

  @Test public void shouldSetTagFieldsWithUnicodeDataAndSpecifiedEncodingCorrectly() throws Exception {
    ID3v2 id3tag = new ID3v23Tag();
  ...
  @Test public void shouldExtractChapterTOCFramesFromMp3() throws Exception {
  ...
  @Test public void shouldExtractChapterTOCAndChapterFramesFromMp3() throws Exception {
    byte[] buffer = TestHelper.loadFile("src/test/resources/v23tagwithchapters.mp3");
    ID3v2 id3tag = ID3v2TagFactory.createTag(buffer);
  ...
  @Test public void shouldReadTagFieldsFromMp3With32tagResavedByMp3tagWithUTF16Encoding() throws Exception {
  ...
  @Test public void shouldRemoveAlbumImageFrame() throws Exception {
    byte[] buffer = TestHelper.loadFile("src/test/resources/v1andv23tagswithalbumimage.mp3");
    ID3v2 id3tag = ID3v2TagFactory.createTag(buffer);
    assertEquals(1885, id3tag.getAlbumImage().length);
  ...
  @Test public void shouldIgnoreInvalidWmpRatingOnWrite() throws Exception {
    ID3v2 id3tag = new ID3v23Tag();
    setTagFields(id3tag);
  ...
  class ID3v22TagForTesting extends ID3v22Tag {
    ...
    @Override protected int unpackFrames(byte[] buffer, int offset, int framesLength) {
      return offset;
    }
  }
