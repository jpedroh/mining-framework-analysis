...
public class FeedbackServiceClientTest extends BasePushyTest {
  ...
  @Test public void testGetExpiredTokens() throws Exception {
    final FeedbackServiceClient feedbackClient = new FeedbackServiceClient(TEST_ENVIRONMENT, SSLTestUtil.createSSLContextForTestClient(), this.getEventLoopGroup());
  ...
  @Test public void testGetExpiredTokensCloseWhenDone() throws Exception {
