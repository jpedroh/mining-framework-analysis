...
public class ArrayElementTest {
  ...
  @Test public void testAccept() {
    ...
    mockVisitor.visitArray("foo", Collections.singletonList((Element) subElement));
    expectLastCall();
    replay(mockVisitor);
  ...
  @Test public void testCompareTo() {
    final ArrayElement a1 = new ArrayElement("a", new StringElement("a", "1"));
    final ArrayElement a11 = new ArrayElement("a", new StringElement("a", "1"), new StringElement("a", "1"));
    final ArrayElement a2 = new ArrayElement("a", new StringElement("a", "2"));
    final ArrayElement b1 = new ArrayElement("b", new StringElement("a", "1"));
  ...
  /**
     ...
     */
  @Test public void testConstructManuallyWithArray() {
    final ArrayElement ae = new ArrayElement("listObj", new StringElement("", "fabse"), new StringElement("", "fabse2"));
    assertThat((StringElement) ae.getEntries().get(0), is(new StringElement("0", "fabse")));
    assertThat((StringElement) ae.getEntries().get(1), is(new StringElement("1", "fabse2")));
  }

  /**
     * Test method for {@link ArrayElement#ArrayElement(String, Element...)}.
     */
  @Test public void testConstructManuallyWithList() {
    final ArrayElement ae = new ArrayElement("listObj", Arrays.asList((Element) new StringElement("", "fabse"), new StringElement("", "fabse2")));
    assertThat((StringElement) ae.getEntries().get(0), is(new StringElement("0", "fabse")));
    assertThat((StringElement) ae.getEntries().get(1), is(new StringElement("1", "fabse2")));
  }
  ...
  @Test public void testConstructors() {
    ...
    assertEquals("foo", element.getName());
    assertEquals(ElementType.ARRAY, element.getType());
    assertEquals(Collections.singletonList(subElement), element.getEntries());
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "deprecation" }) @Test public void testEqualsHashCode() {
    ...
    for (final String name : Arrays.asList("1", "2", "foo", "bar", "baz", "2")) {
      ...
      for (int i = 0; i < count; ++i) {
        ...
        switch (type) {
          ...
          builder.addJavaScript("function bar() {}", BuilderFactory.start().build());
          break;
          case LONG:
  ...
  /**
     ...
     */
  @Test public void testFindFirstWithBadPatternPathMatchingSubelement() {
    final BooleanElement subElement = new BooleanElement("0", false);
    final ArrayElement element = new ArrayElement("foo", subElement);
  ...
  /**
     * Test method for {@link ArrayElement#findFirst}.
     */
  @Test public void testFindFirstWithBadPatternPathNotMatchingSubelement() {
    final BooleanElement subElement = new BooleanElement("0", false);
    final ArrayElement element = new ArrayElement("foo", subElement);
    final Element found = element.findFirst(Element.class, "(");
    assertNull(found);
  ...
  /**
     * Test method for {@link ArrayElement#findFirst}.
     */
  @Test public void testFindFirstWithEmptyPathMatchingType() {
    final ArrayElement element = new ArrayElement("foo", new BooleanElement("1", false));
    final Element found = element.findFirst(Element.class);
    assertNotNull(found);
  ...
  /**
     * Test method for {@link ArrayElement#findFirst}.
     */
  @Test public void testFindFirstWithEmptyPathNonMatchingType() {
    final ArrayElement element = new ArrayElement("foo", new BooleanElement("1", false));
  ...
  /**
     * Test method for {@link ArrayElement#findFirst}.
     */
  @Test public void testFindFirstWithPathMatchingNonFirstSubelement() {
    final BooleanElement subElement = new BooleanElement("1", false);
    final ArrayElement element = new ArrayElement("f", new BooleanElement("0", false), subElement);
  ...
  /**
     * Test method for {@link ArrayElement#findFirst}.
     */
  @Test public void testFindFirstWithPathMatchingNonLastSubelement() {
    final BooleanElement subElement = new BooleanElement("0", false);
    final ArrayElement element = new ArrayElement("f", subElement, new BooleanElement("1", false));
  ...
  /**
     * Test method for {@link ArrayElement#findFirst}.
     */
  @Test public void testFindFirstWithPathMatchingNonLastSubelementBadRegex() {
    final BooleanElement subElement = new BooleanElement("0", false);
    final ArrayElement element = new ArrayElement("f", subElement, new BooleanElement("1", false));
  ...
  /**
     * Test method for {@link ArrayElement#findFirst}.
     */
  @Test public void testFindFirstWithPathMatchingSubelement() {
    final BooleanElement subElement = new BooleanElement("0", false);
    final ArrayElement element = new ArrayElement("foo", subElement);
    Element found = element.findFirst(Element.class, "0");
    assertNotNull(found);
  ...
  /**
     * Test method for {@link ArrayElement#findFirst}.
     */
  @Test public void testFindFirstWithPathNotMatchingSubelement() {
    final BooleanElement subElement = new BooleanElement("1", false);
    final ArrayElement element = new ArrayElement("foo", subElement);
  ...
  /**
     ...
     */
  @Test public void testFindWithBadPatternPathMatchingSubelement() {
    final BooleanElement subElement = new BooleanElement("0", false);
    final ArrayElement element = new ArrayElement("foo", subElement);
  ...
  /**
     * Test method for {@link ArrayElement#find}.
     */
  @Test public void testFindWithBadPatternPathNotMatchingSubelement() {
    final BooleanElement subElement = new BooleanElement("0", false);
    final ArrayElement element = new ArrayElement("foo", subElement);
    final List<Element> elements = element.find(Element.class, "(");
    assertEquals(0, elements.size());
  ...
  /**
     * Test method for {@link ArrayElement#find}.
     */
  @Test public void testFindWithEmptyPathMatchingType() {
    final ArrayElement element = new ArrayElement("foo", new BooleanElement("0", false));
    final List<Element> elements = element.find(Element.class);
    assertEquals(1, elements.size());
    assertSame(element, elements.get(0));
    final List<ArrayElement> arrayElements = element.find(ArrayElement.class);
  ...
  /**
     * Test method for {@link ArrayElement#find}.
     */
  @Test public void testFindWithEmptyPathNonMatchingType() {
    final ArrayElement element = new ArrayElement("foo", new BooleanElement("1", false));
    final List<BooleanElement> elements = element.find(BooleanElement.class);
    assertEquals(0, elements.size());
  }
  ...
  /**
     * Test method for {@link ArrayElement#find}.
     */
  @Test public void testFindWithPathMatchingSubelement() {
    final BooleanElement subElement = new BooleanElement("0", false);
    final ArrayElement element = new ArrayElement("foo", subElement);
  ...
  /**
     * Test method for {@link ArrayElement#find}.
     */
  @Test public void testFindWithPathNotMatchingSubelement() {
    final BooleanElement subElement = new BooleanElement("1", false);
    final ArrayElement element = new ArrayElement("foo", subElement);
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unused" }) @Test(expected = IllegalArgumentException.class) public void testThrowsOnNullName() {
  ...
  /**
     ...
     */
  @Test public void testValueAsObject() {
    final BooleanElement subElement = new BooleanElement("0", false);
    ArrayElement element = new ArrayElement("foo", subElement, subElement);
    assertArrayEquals(new Element[] { subElement, subElement.withName("1") }, element.getValueAsObject());
    element = new ArrayElement("foo", subElement);
    assertArrayEquals(new Element[] { subElement }, element.getValueAsObject());
    element = new ArrayElement("foo", new ArrayElement("0"));
    assertArrayEquals(new Element[] { new ArrayElement("0") }, element.getValueAsObject());
    element = new ArrayElement("foo", new DocumentElement("0"));
    assertArrayEquals(new Element[] { new DocumentElement("0") }, element.getValueAsObject());
  }

  /**
     * Test method for {@link ArrayElement#getValueAsString()}.
     */
  @Test public void testValueAsString() {
    final BooleanElement subElement = new BooleanElement("0", false);
    ArrayElement element = new ArrayElement("foo", subElement, subElement);
  ...
  /**
     * Test method for {@link ArrayElement#withName(String)}.
     */
  @Test public void testWithNameWhenSameName() {
    final List<Element> list = Collections.emptyList();
