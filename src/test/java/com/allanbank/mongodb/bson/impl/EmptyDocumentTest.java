 ...
 */
@SuppressWarnings(value = { "boxing" }) public class EmptyDocumentTest {
  /**
     * Test method for
  ...
  /**
     ...
     */
  @Test public void testAsDocument() {
    final Document doc = new EmptyDocument();
  ...
  /**
     ...
     */
  @Test public void testEqualsRootDocument() {
  ...
  /**
     ...
     */
  @Test public void testFindClassOfEStringArray() {
    assertThat(new EmptyDocument().find(Element.class, "a"), is(EmptyDocument.EMPTY_ELEMENTS));
  }

  /**
     * Test method for {@link EmptyDocument#findFirst(Class, String[])} .
     */
  @Test public void testFindFirstClassOfEStringArray() {
  ...
  /**
     ...
     */
  @Test public void testFindFirstStringArray() {
  ...
  /**
     ...
     */
  @Test public void testFindStringArray() {
    assertThat(new EmptyDocument().find("a"), is(EmptyDocument.EMPTY_ELEMENTS));
  }

  /**
     * Test method for {@link EmptyDocument#get(Class, String)} .
     */
  @Test public void testGetClassOfEString() {
  ...
  @Test public void testGetElements() {
    assertThat(new EmptyDocument().getElements(), is(EmptyDocument.EMPTY_ELEMENTS));
  }
