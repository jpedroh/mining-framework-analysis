...
public class GoogleAuthTest {
  @SuppressWarnings(value = { "SpellCheckingInspection" }) private static final String SECRET_KEY = "KR52HV2U5Z4DWGLJ";

  private static final int VALIDATION_CODE = 598775;

  @BeforeClass public static void setupMockCredentialRepository() {
    System.setProperty(CredentialRepositoryMock.MOCK_SECRET_KEY_NAME, SECRET_KEY);
  }

  @Test public void createCredentials() {
    GoogleAuthenticatorConfig.GoogleAuthenticatorConfigBuilder gacb = new GoogleAuthenticatorConfig.GoogleAuthenticatorConfigBuilder().setKeyRepresentation(KeyRepresentation.BASE64);
  ...
  @Test public void createCredentialsForUser() {
  ...
  @Test public void getCurrentCode() {
  ...
  @Test public void authorise() {
    GoogleAuthenticatorConfig.GoogleAuthenticatorConfigBuilder gacb = new GoogleAuthenticatorConfig.GoogleAuthenticatorConfigBuilder().setTimeStepSizeInMillis(TimeUnit.SECONDS.toMillis(30)).setWindowSize(5);
