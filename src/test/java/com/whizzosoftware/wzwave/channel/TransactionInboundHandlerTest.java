...
public class TransactionInboundHandlerTest {
  @Test public void testRequestNodeInfoApplicationUpdate() throws Exception {
  ...
  @Test public void testRequestNodeInfoApplicationUpdateWithNoNodeId() throws Exception {
    MockChannelHandlerContext ctx = new MockChannelHandlerContext();
    TransactionInboundHandler h = new TransactionInboundHandler();
    RequestNodeInfo requestFrame = new RequestNodeInfo((byte) 0x02);
    h.userEventTriggered(ctx, new DataFrameSentEvent(requestFrame, true));
  ...
  @Test public void testRequestNodeInfoFailure() throws Exception {
    MockChannelHandlerContext ctx = new MockChannelHandlerContext();
    TransactionInboundHandler h = new TransactionInboundHandler();
  ...
  @Test public void testAddNodeToNetworkTransaction() {
    MockChannelHandlerContext ctx = new MockChannelHandlerContext();
    TransactionInboundHandler h = new TransactionInboundHandler();
  ...
  @Test public void testSendDataTransactionTimeout() throws Exception {
    MockChannelHandlerContext ctx = new MockChannelHandlerContext();
    TransactionInboundHandler h = new TransactionInboundHandler();
    assertFalse(h.hasCurrentTransaction());
  ...
  @Test public void testSendDataSleepingNodeTransactionNoACKFailure() throws Exception {
    MockChannelHandlerContext ctx = new MockChannelHandlerContext();
    TransactionInboundHandler h = new TransactionInboundHandler();
  ...
  @Test public void testSendDataSleepingNodeTransactionNetworkCongestionFailure() throws Exception {
    MockChannelHandlerContext ctx = new MockChannelHandlerContext();
    TransactionInboundHandler h = new TransactionInboundHandler();
    h.userEventTriggered(ctx, new DataFrameSentEvent(new SendData(Unpooled.wrappedBuffer(new byte[] { 0x01, 0x09, 0x00, 0x13, 0x06, 0x02, 0x00, 0x00, 0x25, 0x0a, (byte) 0xce })), false));
    assertEquals(1, ctx.getUserEvents().size());
  ...
  @Test public void testSendDataSuccessfulTransaction() throws Exception {
    MockChannelHandlerContext ctx = new MockChannelHandlerContext();
    TransactionInboundHandler h = new TransactionInboundHandler();
    h.userEventTriggered(ctx, new DataFrameSentEvent(new SendData(Unpooled.wrappedBuffer(new byte[] { 0x01, 0x09, 0x00, 0x13, 0x06, 0x02, 0x00, 0x00, 0x25, 0x0a, (byte) 0xce })), false));
    assertEquals(1, ctx.getUserEvents().size());
  ...
  @Test public void testTransactionTimeoutExtension() throws Exception {
    MockChannelHandlerContext ctx = new MockChannelHandlerContext();
    TransactionInboundHandler h = new TransactionInboundHandler();
    h.handlerAdded(ctx);
    assertFalse(h.hasCurrentTransaction());
...
<<<<<<< /usr/src/app/output/whizzosoftware/wzwave/957ba2027da2ce9a5bf458ec36101136224e2711/src/test/java/com/whizzosoftware/wzwave/channel/TransactionInboundHandlerTest.java/left.java
    processEvent(ctx, new IncompleteDataFrameEvent(), now)
=======
    userEventTriggered(ctx, new IncompleteDataFrameEvent())
