...
public class TestHyperLogLogPlus {
  ...
  @Test public void consistentBytes() throws Throwable {
  ...
  @Test public void testComputeCount() {
  ...
  @Test public void testSmallCardinalityRepeatedInsert() {
    HyperLogLogPlus hyperLogLogPlus = new HyperLogLogPlus(14, 25);
    int count = 15000;
    int maxAttempts = 200;
    Random r = new Random();
  ...
  @Test public void testSerialization_Normal() throws IOException {
  ...
  @Test public void testSerialization_Sparse() throws IOException {
  ...
  @Test public void testMergeSelf_forceNormal() throws CardinalityMergeException, IOException {
  ...
  @Test public void testMergeSelf() throws CardinalityMergeException, IOException {
  ...
  @Test public void testSparseSpace() throws IOException {
  ...
  @Test public void testMerge_Normal() throws CardinalityMergeException {
    int numToMerge = 4;
    int bits = 18;
  ...
  @Test public void testLegacyCodec_normal() throws IOException {
    int bits = 18;
  ...
  @Test public void testLegacyCodec_sparse() throws IOException {
    int bits = 18;
    int cardinality = 5000;
    HyperLogLogPlus baseline = new HyperLogLogPlus(bits, 25);
    for (int j = 0; j < cardinality; j++) {
  ...
  @Test public void testMerge_SparseIntersection() throws CardinalityMergeException {
