...
public class OPFCheckerTest {
  ...
  public void testValidateDocument(String fileName, EPUBVersion version, EPUBProfile profile, boolean verbose) {
    ValidationReport testReport = new ValidationReport(fileName, String.format(messages.get("single_file"), "opf", version.toString(), profile == null ? EPUBProfile.DEFAULT : profile));
    ...
    OPFChecker opfChecker = OPFCheckerFactory.getInstance().newInstance(new ValidationContextBuilder().path("test_single_opf").resourceProvider(resourceProvider).report(testReport).version(version).profile(profile).build());
  ...
  @Test public void testBindingsIsDeprecated() {
  ...
  @Test public void testValidateDocumentMediaOverlay001() {
  ...
  @Test public void testValidateDocumentMediaOverlay002() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/media-overlay-002.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testValidateDocumentMediaOverlayMeta001() {
    Collections.addAll(expectedErrors, MessageId.RSC_005, MessageId.RSC_005);
    testValidateDocument("invalid/media-overlay-meta-001.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testValidateDocumentMinlegth() {
  ...
  @Test public void testValidateDocumentUid001() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/uid-001.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testValidateDocumentUid002() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/uid-002.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testValidateDocumentItemProperties() {
  ...
  @Test public void testInvalidIdentifierUUIDAttrIssue853_EPUB2() {
    Collections.addAll(expectedWarnings, MessageId.OPF_085);
    testValidateDocument("invalid/issue853_invalid-uuid-002.opf", EPUBVersion.VERSION_2);
  }

  @Test public void testInvalidIdentifierUUIDIssue853_EPUB3() {
    Collections.addAll(expectedWarnings, MessageId.OPF_085);
    testValidateDocument("invalid/issue853_invalid-uuid.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testFilenameInManifestContainsSpacesIssue239_EPUB2() {
  ...
  @Test public void testMetaPropertyUndefined() {
  ...
  @Test public void testMetaPropertyUndefinedPrefix() {
  ...
  @Test public void testPrefixDeclarationInvalidRedeclares() {
  ...
  @Test public void testRenditionSpreadPortraitIsDeprecated() {
    Collections.addAll(expectedWarnings, MessageId.RSC_017);
    testValidateDocument("invalid/rendition-spread-portrait-deprecated.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testRenditionSpreadPortraitIsDeprecatedOnItemref() {
    Collections.addAll(expectedWarnings, MessageId.RSC_017);
    testValidateDocument("invalid/rendition-spread-portrait-deprecated-onitemref.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testRenditionViewportIsDeprecated() {
  ...
  @Test public void testRenditionViewportDuplicates() {
  ...
  @Test public void testCollection_DO() {
    testValidateDocument("valid/collection-do.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testCollection_DOInvalid() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/collection-invalid-do-sch-001.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testCollection_ManifestInvalid_TopLevel() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/collection-manifest-toplevel.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testMetaSchemaOrg() {
    testValidateDocument("valid/meta-schemaorg.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testEdupub() {
    testValidateDocument("valid/edupub-minimal.opf", EPUBVersion.VERSION_3, EPUBProfile.EDUPUB);
  }

  @Test public void testEdupub_Teacher() {
    testValidateDocument("valid/edupub-teacher-edition.opf", EPUBVersion.VERSION_3, EPUBProfile.EDUPUB);
  }

  @Test public void testEdupub_InvalidDCType() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/edupub-missing-dc-type.opf", EPUBVersion.VERSION_3, EPUBProfile.EDUPUB);
  }

  @Test public void testEdupub_InvalidNoAccessFeature() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/edupub-no-accessFeature.opf", EPUBVersion.VERSION_3, EPUBProfile.EDUPUB);
  }

  @Test public void testEdupub_InvalidAccessFeatureNone() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/edupub-accessFeature-none.opf", EPUBVersion.VERSION_3, EPUBProfile.EDUPUB);
  }

  @Test public void testEdupub_InvalidTeacherNoDCType() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/edupub-teacher-edition-no-dc-type.opf", EPUBVersion.VERSION_3, EPUBProfile.EDUPUB);
  }

  @Test public void testEdupub_InvalidTeacherNoSource() {
    Collections.addAll(expectedWarnings, MessageId.RSC_017);
    testValidateDocument("invalid/edupub-teacher-edition-nosource.opf", EPUBVersion.VERSION_3, EPUBProfile.EDUPUB);
  }

  @Test public void testSC_Embedded() {
    testValidateDocument("valid/sc-embedded.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testIDX_Collection() {
    testValidateDocument("valid/idx-collection.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testIDX_CollectionWithSubGroup() {
    testValidateDocument("valid/idx-collection-indexgroup.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testIDX_CollectionInvalid_ChildNoIndexGroup() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/idx-collection-invalidchild.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testIDX_CollectionInvalid_TopLevelIndexGroup() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/idx-collection-toplevel-indexgroup.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testIDX_CollectionInvalid_IndexGroupWithChild() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/idx-collection-indexgroup-withchild.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testIDX_CollectionInvalid_ResourceNotContentDoc() {
  ...
  @Test public void testGuideReferenceUnique_EPUB2() {
    Collections.addAll(expectedWarnings, MessageId.RSC_017, MessageId.RSC_017);
    testValidateDocument("invalid/guide-duplicates.opf", EPUBVersion.VERSION_2);
  }

  @Test public void testGuideReferenceUnique_EPUB3() {
    Collections.addAll(expectedWarnings, MessageId.RSC_017, MessageId.RSC_017);
    testValidateDocument("invalid/guide-duplicates.opf", EPUBVersion.VERSION_3);
  }

  @Test public void testDict_Single() {
    testValidateDocument("valid/dict-single.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Single_NoSKM() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-single-noskm.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Single_NoSKM_2() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-single-noskm-2.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Multiple() {
    testValidateDocument("valid/dict-multiple.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Multiple_NoSKM() {
    Collections.addAll(expectedErrors, MessageId.OPF_083);
    testValidateDocument("invalid/dict-multiple-noskm.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Multiple_CollectionWithMultipleSKMs() {
    Collections.addAll(expectedErrors, MessageId.OPF_082);
    testValidateDocument("invalid/dict-multiple-morethanoneskm.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Multiple_CollectionSharingSKM() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-multiple-sharedskm.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Multiple_CollectionContainingMissingResource() {
    Collections.addAll(expectedErrors, MessageId.OPF_081);
    testValidateDocument("invalid/dict-multiple-missingresource.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Multiple_CollectionContainingNonXHTML() {
    Collections.addAll(expectedErrors, MessageId.OPF_084);
    testValidateDocument("invalid/dict-multiple-nonxhtml.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Multiple_CollectionWithSubCollection() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-multiple-subcollection.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_NoDCType() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-nodctype.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_SKM_BadMediaType() {
    Collections.addAll(expectedErrors, MessageId.OPF_012);
    testValidateDocument("invalid/dict-skm-badmediatype.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Lang_InCollection() {
    testValidateDocument("valid/dict-multiple-dedicatedlang.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Lang_InvalidInCollection() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-lang-invalidcollection.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Lang_InvalidInTopLevel() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-lang-invalidtoplevel.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Lang_MissingInCollection() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-lang-missingcollection.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Lang_MissingTopLevel() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-lang-missingtoplevel.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Lang_UndeclaredInCollection() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-lang-undeclaredcollection.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Lang_UndeclaredTopLevel() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-lang-undeclaredtoplevel.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Type() {
    testValidateDocument("valid/dict-single-typed.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testDict_Type_Unknown() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/dict-type-unknown.opf", EPUBVersion.VERSION_3, EPUBProfile.DICT);
  }

  @Test public void testManifest_DuplicateResource() {
