...
public class NavCheckerTest {
  ...
  public void testValidateDocument(String fileName, boolean verbose) {
    ValidationReport testReport = new ValidationReport(fileName, String.format(messages.get("single_file"), "nav", EPUBVersion.VERSION_3, EPUBProfile.DEFAULT));
    ...
    NavChecker navChecker = new NavChecker(new ValidationContextBuilder().path(basepath + fileName).resourceProvider(resourceProvider).report(testReport).mimetype("application/xhtml+xml").version(EPUBVersion.VERSION_3).profile(EPUBProfile.DEFAULT).build());
    navChecker.validate();
    if (verbose) {
  ...
  @Test public void testValidateDocumentValidMinimalNav() {
    testValidateDocument("valid/minimal.xhtml");
  }

  @Test public void testValidateDocumentNavWithoutType() {
    Collections.addAll(expectedWarnings, MessageId.RSC_017);
    testValidateDocument("invalid/nav-no-type.xhtml");
  }

  @Test public void testValidateDocumentValidNav001() {
    testValidateDocument("valid/nav001.xhtml");
  }

  @Test public void testValidateDocumentNoTocNav() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    Collections.addAll(expectedWarnings, MessageId.RSC_017);
    testValidateDocument("invalid/noTocNav.xhtml");
  }

  @Test public void testValidateDocumentHText() {
  ...
  @Test public void testValidateDocumenNavLabels001() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/nav-labels-001.xhtml");
  }

  @Test public void testValidateDocumentNavLabels002() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/nav-labels-001.xhtml");
  }

  @Test public void testValidateDocumentNavLandmarks001() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/nav-landmarks-001.xhtml");
  }

  @Test public void testValidateDocumentNavLandmarks002() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/nav-landmarks-002.xhtml");
  }

  @Test public void testValidateDocumentNavLandmarksDuplicates() {
  ...
  @Test public void testValidateDocumentNavLandmarksNoDuplicates() {
    testValidateDocument("valid/nav-landmarks-noduplicates.xhtml");
  }

  @Test public void testValidateDocumentNavNoPagelist001() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/nav-pagelist-001.xhtml");
  }

  @Test public void testValidateDocumentNavNoToc() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/nav-no-toc.xhtml");
  }

  @Test public void testValidateDocumentNavEmptyList() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/nav-empty-list.xhtml");
  }

  @Test public void testValidateDocumentNavReqHeading() {
    Collections.addAll(expectedErrors, MessageId.RSC_005);
    testValidateDocument("invalid/req-heading.xhtml");
  }

  @Test public void testValid_issuet538() {
