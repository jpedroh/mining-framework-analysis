...
public class Epub30CheckExpandedTest extends AbstractEpubCheckTest {
  ...
  @Test public void testValidateEPUBPLoremBasic() {
  ...
  @Test public void testValidateEPUBPLoremMultipleRenditionsUnmanifested() {
  ...
  @Test public void testValidateEPUB30_CSSURLS_3() {
  ...
  @Test public void testValidateEPUB30_CSSFontFace_valid() {
    testValidateDocument("valid/wasteland-otf/", "valid/wasteland-otf.txt");
  }

  @Test public void testValidateEPUB30_CSSFontFace_invalid() {
  ...
  @Test public void testRemoteAudioSourcesUndeclaredInOPF() {
    Collections.addAll(expectedErrors, MessageId.RSC_008);
    testValidateDocument("invalid/remote-audio-sources-undeclared/");
  }

  @Test public void testValidateEPUB30_circularFallback() {
  ...
  @Test public void testEdupubPagination_InvalidNoPageSource() {
  ...
  @Test public void testIdx_WholePub() {
    testValidateDocument("valid/idx-whole-pub/");
  }

  @Test public void testIdx_WholePub_InvalidIndexContent() {
    expectedErrors.add(MessageId.RSC_005);
    testValidateDocument("invalid/idx-whole-pub-badidxcontent/");
  }

  @Test public void testIdx_WholePub_InvalidNoIndex() {
    expectedErrors.add(MessageId.RSC_005);
  ...
  @Test public void testDataNav_RegionBased_ComicsTypes() {
  ...
  @Test public void testDict_NoDCTypeButDictContent() {
    expectedWarnings.add(MessageId.OPF_079);
  ...
  @Test public void testSwitchMissingProperty() {
    Collections.addAll(expectedWarnings, MessageId.RSC_017);
    Collections.addAll(expectedErrors, MessageId.OPF_014);
    testValidateDocument("invalid/switch-missing-property");
  }

  @Test public void testEntities() {
