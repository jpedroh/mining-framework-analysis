...
public class CollectionPropertyTranslationTest {
  @Test public void testTranslateCopiesMap() {
  ...
  /**
	 ...
	 */
  @Test public void testTranslateCopiesCollections() {
  ...
  /**
	 ...
	 */
  @Test public void testCopiesNullsInsideCollections() {
    List<String> before = Arrays.asList("a", "b", null, "c");
    TestDto dto = new Moo().translate(new StringsDomain(before), TestDto.class);
    Assert.assertEquals(before, dto.getStrings());
  }

  @Test public void testTranslatesCollectionsOfTranslations() {
  ...
  @Test public void testNaturallySortsTranslationsOfNaturallySortedCollections() {
    OrdinalSet ordinals = new OrdinalSet(new Ordinal(2, "second"), new Ordinal(1, "first"), new Ordinal(3, "third"));
    int index = 1;
    for (Ordinal item : ordinals.getOrdinals()) {
      assertEquals(item.getRank(), index++);
    }
    OrdinalSetDto ordinalsDto = new Moo().translate(ordinals, OrdinalSetDto.class);
    Assert.assertNotNull(ordinalsDto.getOrdinals());
    Assert.assertEquals(ordinals.getOrdinals().size(), ordinalsDto.getOrdinals().size());
    index = 1;
...
<<<<<<< /usr/src/app/output/geoffreywiseman/moo/c87b8cb339acf2e0e5d38ed55775bd9b6a3c3d1f/src/test/java/com/codiform/moo/CollectionPropertyTranslationTest.java/left.java
...
>>>>>>> /usr/src/app/output/geoffreywiseman/moo/c87b8cb339acf2e0e5d38ed55775bd9b6a3c3d1f/src/test/java/com/codiform/moo/CollectionPropertyTranslationTest.java/right.java
  ...
  public static class OrdinalListDto {
    @TranslateCollection(value = OrdinalDto.class) private List<OrdinalDto> ordinals;
...
<<<<<<< /usr/src/app/output/geoffreywiseman/moo/c87b8cb339acf2e0e5d38ed55775bd9b6a3c3d1f/src/test/java/com/codiform/moo/CollectionPropertyTranslationTest.java/left.java
  public static class OrdinalSetDto {
    @TranslateCollection(value = OrdinalDto.class) private SortedSet<OrdinalDto> ordinals;
