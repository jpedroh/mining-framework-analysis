...
public class TsLintSensorTest {
    ...
    public void setUp() throws Exception {
        ...
        doReturn(this.issuable).when(this.perspectives).as(eq(Issuable.class), any(File.class));
        ...
        this.sonarFile = mock(File.class);
    ...
    public void analyse_addsIssues() {
        ...
        when(parser.parse(any(java.lang.String.class))).thenReturn(issues);
    ...
    public void analyse_callsExecutorWithSuppliedTimeout() throws IOException {
        this.sensor.analyse(mock(Project.class), mock(SensorContext.class));
        verify(this.executor, times(1)).execute(any(java.lang.String.class), any(java.lang.String.class), any(java.lang.String.class), any(List.class), eq(45000));
    }
    ...
    public void analyze_callsExecutorWithAtLeast5000msTimeout() throws IOException {
        ...
        this.sensor.analyse(mock(Project.class), mock(SensorContext.class));
        verify(this.executor, times(1)).execute(any(java.lang.String.class), any(java.lang.String.class), any(java.lang.String.class), any(List.class), eq(5000));
    }
}