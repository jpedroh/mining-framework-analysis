...
public class TsLintSensorTest {
  ...
  @Before public void setUp() throws Exception {
    ...
    this.files = new ArrayList<File>(Arrays.asList(new File[] { this.file }));
    this.fileSystem = mock(FileSystem.class);
  ...
  @Test public void shouldExecuteOnProject_ReturnsTrue_WhenAnyTsFiles() {
    assertTrue(this.sensor.shouldExecuteOnProject(null));
  }

  @Test public void shouldExecuteOnProject_ReturnsFalse_WhenNoTsFiles() {
    when(fileSystem.files(this.predicate)).thenReturn(new ArrayList<File>());
    assertFalse(this.sensor.shouldExecuteOnProject(null));
  }

  @Test public void analyse_addsIssues() {
    ...
    TsLintIssue[][] issues = new TsLintIssue[][] { new TsLintIssue[] { issue } };
  ...
  @Test public void analyse_doesNothingWhenNotConfigured() throws IOException {
  ...
  @Test public void analyse_doesNothingWhenNoConfigPathset() throws IOException {
  ...
  @Test public void analyse_callsExecutorWithSuppliedTimeout() throws IOException {
    this.sensor.analyse(mock(Project.class), mock(SensorContext.class));
    verify(this.executor, times(1)).execute(any(String.class), any(String.class), any(String.class), any(List.class), eq(45000));
  }

  @Test public void analyze_callsExecutorWithAtLeast5000msTimeout() throws IOException {
