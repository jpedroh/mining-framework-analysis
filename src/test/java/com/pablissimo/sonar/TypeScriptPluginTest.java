...
public class TypeScriptPluginTest {
  ...
  @Test public void advertisesAppropriateExtensions() {
  ...
  @Test public void definesExpectedProperties() {
    ...
    assertNotNull(findPropertyByName(properties, TypeScriptPlugin.SETTING_TS_LINT_ENABLED));
    ...
    assertNotNull(findPropertyByName(properties, TypeScriptPlugin.SETTING_TS_LINT_TIMEOUT));
    assertNotNull(findPropertyByName(properties, TypeScriptPlugin.SETTING_TS_LINT_RULES_DIR));
    assertNotNull(findPropertyByName(properties, TypeScriptPlugin.SETTING_TS_RULE_CONFIGS));
  }

  @Test public void tsLintPathSetting_definedAppropriately() {
  ...
  @Test public void excludeTypeDefinitionFilesSetting_definedAppropriately() {
  ...
  @Test public void lcovReportPathSetting_definedAppropriately() {
  ...
  @Test public void forceZeroCoverageSetting_definedAppropriately() {
  ...
  @Test public void tsLintTimeoutSettings_definedAppropriately() {
  ...
  @Test public void rulesDirSetting_definedAppropriately() {
  ...
  @Test public void ruleConfigsSetting_definedAppropriately() {
