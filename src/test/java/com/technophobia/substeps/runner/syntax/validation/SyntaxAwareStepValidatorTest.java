...
public class SyntaxAwareStepValidatorTest {
  ...
  @Test public void validatorReportsMissingStepsInScenario() {
    final FeatureFile featureFile = this.featureFileParser.loadFeatureFile(createFeatureFile("error.feature"));
    createStepValidatorWithSubsteps("simple.substeps").validateFeatureFile(featureFile, this.syntaxErrorReporter);
    final List<SyntaxErrorData> errors = 
<<<<<<< /usr/src/app/output/technophobia/substeps-core/f51e19b36c2a13d3d11fe9744381a0c910d61c6f/src/test/java/com/technophobia/substeps/runner/syntax/validation/SyntaxAwareStepValidatorTest.java/left.java
    this.syntaxErrorReporter.errors()
=======
    syntaxErrorReporter.syntaxErrors()
>>>>>>> /usr/src/app/output/technophobia/substeps-core/f51e19b36c2a13d3d11fe9744381a0c910d61c6f/src/test/java/com/technophobia/substeps/runner/syntax/validation/SyntaxAwareStepValidatorTest.java/right.java
    ;
  ...
  @Test public void validatorReportsNoErrorsForFeatureWithValidSteps() {
    final FeatureFile featureFile = this.featureFileParser.loadFeatureFile(createFeatureFile("error.feature"));
    createStepValidatorWithSubsteps("error.substeps").validateFeatureFile(featureFile, this.syntaxErrorReporter);
    final List<SyntaxErrorData> errors = 
<<<<<<< /usr/src/app/output/technophobia/substeps-core/f51e19b36c2a13d3d11fe9744381a0c910d61c6f/src/test/java/com/technophobia/substeps/runner/syntax/validation/SyntaxAwareStepValidatorTest.java/left.java
    this.syntaxErrorReporter.errors()
=======
...
>>>>>>> /usr/src/app/output/technophobia/substeps-core/f51e19b36c2a13d3d11fe9744381a0c910d61c6f/src/test/java/com/technophobia/substeps/runner/syntax/validation/SyntaxAwareStepValidatorTest.java/right.java
  ...
  @Test public void validatorReportsMissingSubstepsInDefinition() {
    final PatternMap<ParentStep> substeps = this.substepsFileParser.loadSubSteps(createSubstepsFile("error.substeps"));
...
>>>>>>> /usr/src/app/output/technophobia/substeps-core/f51e19b36c2a13d3d11fe9744381a0c910d61c6f/src/test/java/com/technophobia/substeps/runner/syntax/validation/SyntaxAwareStepValidatorTest.java/right.java
  ...
  @Test public void validatorReportsNoErrorsForSubstepsWithValidSteps() {
    final PatternMap<ParentStep> substeps = this.substepsFileParser.loadSubSteps(createSubstepsFile("allFeatures.substeps"));
    final StepValidator stepValidator = createStepValidatorWithSubsteps("simple.substeps", MockStepImplementations.class);
    for (final ParentStep substep : substeps.values()) {
      stepValidator.validateSubstep(substep, this.syntaxErrorReporter);
    }
    final List<SyntaxErrorData> errors = 
...
>>>>>>> /usr/src/app/output/technophobia/substeps-core/f51e19b36c2a13d3d11fe9744381a0c910d61c6f/src/test/java/com/technophobia/substeps/runner/syntax/validation/SyntaxAwareStepValidatorTest.java/right.java
  ...
  private StepValidator createStepValidatorWithSubsteps(final String substepsFilename, final Class<?>... stepImplClasses) {
    final Syntax syntax = SyntaxBuilder.buildSyntax(Arrays.asList(stepImplClasses), createSubstepsFile(substepsFilename), true, new String[0], new ClassAnalyser(), true, this.syntaxErrorReporter);
