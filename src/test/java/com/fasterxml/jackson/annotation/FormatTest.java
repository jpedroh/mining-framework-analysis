...
public class FormatTest extends TestBase {
  ...
  @JsonFormat(shape = JsonFormat.Shape.BOOLEAN, pattern = "xyz", timezone = "bogus") private final static class Bogus {
  }
  ...
  public void testToString() {
    assertEquals("JsonFormat.Value(pattern=null,shape=STRING,lenient=null,locale=null,timezone=null,features=EMPTY)", JsonFormat.Value.forShape(JsonFormat.Shape.STRING).toString());
    assertEquals("JsonFormat.Value(pattern=[.],shape=ANY,lenient=null,locale=null,timezone=null,features=EMPTY)", JsonFormat.Value.forPattern("[.]").toString());
  }
  ...
  public void testFeatures() {
    ...
    JsonFormat.Features f4 = JsonFormat.Features.construct(new Feature[] { Feature.WRITE_DATE_TIMESTAMPS_AS_NANOSECONDS }, new Feature[] { Feature.ACCEPT_SINGLE_VALUE_AS_ARRAY });
