...
public class TestNextXxx extends com.fasterxml.jackson.core.BaseTest {
  ...
  private void _testIsNextTokenName1(boolean useStream) throws Exception {
    ...
    JsonParser jp = useStream ? jf.createParser(new ByteArrayInputStream(DOC.getBytes("UTF-8"))) : jf.createParser(new StringReader(DOC));
    ...
    jp.close();
    jp = useStream ? jf.createParser(DOC.getBytes("UTF-8")) : jf.createParser(DOC);
  ...
  private void _testIsNextTokenName2(boolean useStream) throws Exception {
    final String DOC = "{\"name\":123,\"name2\":14,\"x\":\"name\"}";
    JsonParser jp = useStream ? JSON_F.createParser(new ByteArrayInputStream(DOC.getBytes("UTF-8"))) : JSON_F.createParser(new StringReader(DOC));
  ...
  private void _testIsNextTokenName3(boolean useStream) throws Exception {
    final String DOC = "{\"name\":123,\"name2\":14,\"x\":\"name\"}";
    JsonParser p = useStream ? JSON_F.createParser(new ByteArrayInputStream(DOC.getBytes("UTF-8"))) : JSON_F.createParser(new StringReader(DOC));
...
>>>>>>> /usr/src/app/output/fasterxml/jackson-core/f554808f2285ab7fa68a7b830e33417712ce4a26/src/test/java/com/fasterxml/jackson/core/json/TestNextXxx.java/right.java
    .createParser(new ByteArrayInputStream(DOC.getBytes("UTF-8"))) : 
<<<<<<< /usr/src/app/output/fasterxml/jackson-core/f554808f2285ab7fa68a7b830e33417712ce4a26/src/test/java/com/fasterxml/jackson/core/json/TestNextXxx.java/left.java
    JSON_F
=======
    f
>>>>>>> /usr/src/app/output/fasterxml/jackson-core/f554808f2285ab7fa68a7b830e33417712ce4a26/src/test/java/com/fasterxml/jackson/core/json/TestNextXxx.java/right.java
    .createParser(new StringReader(DOC));
  ...
  private void _testIssue34(boolean useStream) throws Exception {
    ...
    JsonFactory jf = new JsonFactory();
    JsonParser parser = useStream ? jf.createParser(new ByteArrayInputStream(DOC.getBytes("UTF-8"))) : jf.createParser(new StringReader(DOC));
  ...
  private void _testNextNameWithLong(boolean useStream) throws Exception {
    ...
    sb.append("}");
    final String DOC = sb.toString();
    JsonParser parser = useStream ? JSON_F.createParser(new ByteArrayInputStream(DOC.getBytes("UTF-8"))) : JSON_F.createParser(new StringReader(DOC));
