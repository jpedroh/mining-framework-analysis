...
@SuppressWarnings(value = { "resource" }) public class BasicParserFilteringTest extends BaseTest {
  static class NameMatchFilter extends TokenFilter {
    ...
    @Override public TokenFilter includeElement(int index) {
      return this;
    }
    ...
    @Override protected boolean _includeScalar() {
      return false;
    }
  }
  ...
  static class NoObjectsFilter extends TokenFilter {
    @Override public TokenFilter filterStartObject() {
      return null;
    }
  }
  ...
  static final TokenFilter INCLUDE_EMPTY_IF_NOT_FILTERED = new TokenFilter() {
    ...
    @Override public boolean _includeScalar() {
      return false;
    }
  };
  ...
  private final String SIMPLE = a2q("{\'a\':123,\'array\':[1,2],\'ob\':{\'value0\':2,\'value\':3,\'value2\':0.25},\'b\':true}");
  ...
  public void testSingleMatchFilteringWithoutPath() throws Exception {
    ...
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new NameMatchFilter("value"), Inclusion.ONLY_INCLUDE_ALL, false);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testSingleMatchFilteringWithPath1() throws Exception {
    ...
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new NameMatchFilter("a"), Inclusion.INCLUDE_ALL_AND_PATH, false);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testSingleMatchFilteringWithPath2() throws Exception {
    String jsonString = a2q("{\'a\':123,\'array\':[1,2],\'ob\':{\'value0\':2,\'value\':3,\'value2\':4},\'b\':true}");
    JsonParser p0 = JSON_F.createParser(jsonString);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new NameMatchFilter("value"), Inclusion.INCLUDE_ALL_AND_PATH, false);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testSingleMatchFilteringWithPath3() throws Exception {
    ...
    JsonParser p0 = JSON_F.createParser(jsonString);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new NameMatchFilter("ob"), Inclusion.INCLUDE_ALL_AND_PATH, false);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testNotAllowMultipleMatchesWithoutPath2() throws Exception {
    ...
    JsonParser p0 = JSON_F.createParser(jsonString);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new IndexMatchFilter(1), Inclusion.ONLY_INCLUDE_ALL, false);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testNotAllowMultipleMatchesWithPath1() throws Exception {
    ...
    JsonParser p0 = JSON_F.createParser(jsonString);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new IndexMatchFilter(1), Inclusion.INCLUDE_ALL_AND_PATH, false);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testAllowMultipleMatchesWithoutPath() throws Exception {
    ...
    JsonParser p0 = JSON_F.createParser(jsonString);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new NameMatchFilter("value"), Inclusion.ONLY_INCLUDE_ALL, true);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testAllowMultipleMatchesWithPath1() throws Exception {
    String jsonString = a2q("{\'a\':123,\'array\':[1,2],\'ob\':{\'value0\':2,\'value\':3,\'value2\':4,\'value\':{\'value0\':2}},\'value\':\"val\",\'b\':true}");
    JsonParser p0 = JSON_F.createParser(jsonString);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new NameMatchFilter("value"), Inclusion.INCLUDE_ALL_AND_PATH, true);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testAllowMultipleMatchesWithPath2() throws Exception {
    ...
    JsonParser p0 = JSON_F.createParser(jsonString);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new IndexMatchFilter(1), Inclusion.INCLUDE_ALL_AND_PATH, true);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testMultipleMatchFilteringWithPath1() throws Exception {
    JsonParser p0 = JSON_F.createParser(SIMPLE);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new NameMatchFilter("value0", "value2"), Inclusion.INCLUDE_ALL_AND_PATH, true);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testMultipleMatchFilteringWithPath2() throws Exception {
    ...
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new NameMatchFilter("b", "value"), Inclusion.INCLUDE_ALL_AND_PATH, true);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testNoMatchFiltering1() throws Exception {
    String jsonString = a2q("{\'a\':123,\'array\':[1,2],\'ob\':{\'value0\':2,\'value\':3,\'value2\':4},\'b\':true}");
    JsonParser p0 = JSON_F.createParser(jsonString);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new NameMatchFilter("invalid"), Inclusion.INCLUDE_NON_NULL, true);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testNoMatchFiltering4() throws Exception {
    String jsonString = a2q("{\'a\':123,\'array\':[1,2],\'ob\':{\'value0\':2,\'value\':3,\'value2\':4},\'b\':true}");
    JsonParser p0 = JSON_F.createParser(jsonString);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new StrictNameMatchFilter("invalid"), Inclusion.INCLUDE_NON_NULL, true);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testValueOmitsFieldName1() throws Exception {
    ...
    JsonParser p0 = JSON_F.createParser(jsonString);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new NoArraysFilter(), Inclusion.INCLUDE_NON_NULL, true);
    String result = readAndWrite(JSON_F, p);
  ...
  public void testValueOmitsFieldName2() throws Exception {
    ...
    JsonParser p0 = JSON_F.createParser(jsonString);
    FilteringParserDelegate p = new FilteringParserDelegate(p0, new NoObjectsFilter(), Inclusion.INCLUDE_NON_NULL, true);
    String result = readAndWrite(JSON_F, p);
    assertEquals(a2q("[\'a\',123]"), result);
    assertEquals(2, p.getMatchCount());
  }
  ...
  public void testIndexMatchWithPath1() throws Exception {
    FilteringParserDelegate p = new FilteringParserDelegate(JSON_F.createParser(SIMPLE), new IndexMatchFilter(1), Inclusion.INCLUDE_ALL_AND_PATH, true);
    String result = readAndWrite(JSON_F, p);
    assertEquals(a2q("{\'array\':[2]}"), result);
    assertEquals(1, p.getMatchCount());
    p = new FilteringParserDelegate(JSON_F.createParser(SIMPLE), new IndexMatchFilter(0), Inclusion.INCLUDE_ALL_AND_PATH, true);
  ...
  public void testIndexMatchWithPath2() throws Exception {
    FilteringParserDelegate p = new FilteringParserDelegate(JSON_F.createParser(SIMPLE), new IndexMatchFilter(0, 1), Inclusion.INCLUDE_ALL_AND_PATH, true);
    assertEquals(a2q("{\'array\':[1,2]}"), readAndWrite(JSON_F, p));
    assertEquals(2, p.getMatchCount());
    String JSON = a2q("{\'a\':123,\'array\':[1,2,3,4,5],\'b\':[1,2,3]}");
    p = new FilteringParserDelegate(JSON_F.createParser(JSON), new IndexMatchFilter(1, 3), Inclusion.INCLUDE_ALL_AND_PATH, true);
  ...
  public void testBasicSingleMatchFilteringWithPath() throws Exception {
    JsonParser p0 = JSON_F.createParser(SIMPLE);
    JsonParser p = new FilteringParserDelegate(p0, new NameMatchFilter("value"), Inclusion.INCLUDE_ALL_AND_PATH, false);
    String result = readAndWrite(JSON_F, p);
    assertEquals(a2q("{\'ob\':{\'value\':3}}"), result);
  }
  ...
  public void testIncludeEmptyArrayIfNotFiltered() throws Exception {
    JsonParser p0 = JSON_F.createParser(a2q("{\'empty_array\':[],\'filtered_array\':[5]}"));
    JsonParser p = new FilteringParserDelegate(p0, INCLUDE_EMPTY_IF_NOT_FILTERED, Inclusion.INCLUDE_ALL_AND_PATH, false);
    assertEquals(a2q("{\'empty_array\':[]}"), readAndWrite(JSON_F, p));
  }

  public void testIncludeEmptyArray() throws Exception {
    JsonParser p0 = JSON_F.createParser(a2q("{\'empty_array\':[],\'filtered_array\':[5]}"));
    JsonParser p = new FilteringParserDelegate(p0, INCLUDE_EMPTY, Inclusion.INCLUDE_ALL_AND_PATH, false);
  ...
  public void testIncludeEmptyObjectIfNotFiltered() throws Exception {
    JsonParser p0 = JSON_F.createParser(a2q("{\'empty_object\':{},\'filtered_object\':{\'foo\':5}}"));
    JsonParser p = new FilteringParserDelegate(p0, INCLUDE_EMPTY_IF_NOT_FILTERED, Inclusion.INCLUDE_ALL_AND_PATH, false);
  ...
  public void testIncludeEmptyArrayInObjectIfNotFiltered() throws Exception {
    JsonParser p0 = JSON_F.createParser(a2q("{\'object_with_empty_array\':{\'foo\':[]},\'object_with_filtered_array\':{\'foo\':[5]}}"));
    JsonParser p = new FilteringParserDelegate(p0, INCLUDE_EMPTY_IF_NOT_FILTERED, Inclusion.INCLUDE_ALL_AND_PATH, false);
  ...
  public void testIncludeEmptyArrayInObject() throws Exception {
    JsonParser p0 = JSON_F.createParser(a2q("{\'object_with_empty_array\':{\'foo\':[]},\'object_with_filtered_array\':{\'foo\':[5]}}"));
    JsonParser p = new FilteringParserDelegate(p0, INCLUDE_EMPTY, Inclusion.INCLUDE_ALL_AND_PATH, false);
    assertEquals(a2q("{\'object_with_empty_array\':{\'foo\':[]},\'object_with_filtered_array\':{\'foo\':[]}}"), readAndWrite(JSON_F, p));
  }

  public void testIncludeEmptyObjectInArrayIfNotFiltered() throws Exception {
    JsonParser p0 = JSON_F.createParser(a2q("{\'array_with_empty_object\':[{}],\'array_with_filtered_object\':[{\'foo\':5}]}"));
    JsonParser p = new FilteringParserDelegate(p0, INCLUDE_EMPTY_IF_NOT_FILTERED, Inclusion.INCLUDE_ALL_AND_PATH, false);
  ...
  public void testIncludeEmptyObjectInArray() throws Exception {
    JsonParser p0 = JSON_F.createParser(a2q("{\'array_with_empty_object\':[{}],\'array_with_filtered_object\':[{\'foo\':5}]}"));
    JsonParser p = new FilteringParserDelegate(p0, INCLUDE_EMPTY, Inclusion.INCLUDE_ALL_AND_PATH, false);
    assertEquals(a2q("{\'array_with_empty_object\':[{}],\'array_with_filtered_object\':[{}]}"), readAndWrite(JSON_F, p));
  }

  public void testIncludeEmptyArrayIfNotFilteredAfterFiltered() throws Exception {
    JsonParser p0 = JSON_F.createParser(a2q("[5, {\'empty_array\':[],\'filtered_array\':[5]}]"));
    JsonParser p = new FilteringParserDelegate(p0, INCLUDE_EMPTY_IF_NOT_FILTERED, Inclusion.INCLUDE_ALL_AND_PATH, false);
    assertEquals(a2q("[{\'empty_array\':[]}]"), readAndWrite(JSON_F, p));
  }
}