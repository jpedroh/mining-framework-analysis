...
public class ParserDupHandlingTest extends com.fasterxml.jackson.core.BaseTest {
  ...
  private void _testSimpleDupsOk(final String doc, JsonFactory f, int mode) throws Exception {
