...
@FixMethodOrder(value = MethodSorters.NAME_ASCENDING) public class NonStandardNumberParsingTest extends com.fasterxml.jackson.core.BaseTest {
  private final JsonFactory JSON_F = JsonFactory.builder().enable(JsonReadFeature.ALLOW_LEADING_PLUS_SIGN_FOR_NUMBERS).enable(JsonReadFeature.ALLOW_LEADING_DECIMAL_POINT_FOR_NUMBERS).enable(JsonReadFeature.ALLOW_TRAILING_DECIMAL_POINT_FOR_NUMBERS).build();
...
<<<<<<< /usr/src/app/output/fasterxml/jackson-core/ecc5f645448e3e12a9dfbd976cbca5f196d0abd3/src/test/java/com/fasterxml/jackson/core/read/NonStandardNumberParsingTest.java/left.java
      try {
        p.nextToken();
        fail("Should not pass");
