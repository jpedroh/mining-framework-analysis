...
public class TestMultimaps extends ModuleTestBase {
  ...
  @JsonInclude(value = JsonInclude.Include.NON_EMPTY) static class MultiMapWrapper {
    @JsonProperty Multimap<String, String> map = ArrayListMultimap.create();
  }

  static class MultiMapWithIgnores {
    @JsonIgnoreProperties(value = { "x", "y" }) public Multimap<String, String> map = ArrayListMultimap.create();
  ...
  private static final String StringStringMultimap = "{\"first\":[\"abc\",\"abc\",\"foo\"]," + "\"second\":[\"bar\"]}";

  private final ObjectMapper MAPPER = mapperWithModule();

  public void testMultimap() throws Exception {
    _testMultimap(TreeMultimap.create(), true, "{\"false\":[false],\"maybe\":[false,true],\"true\":[true]}");
    _testMultimap(LinkedListMultimap.create(), false, "{\"true\":[true],\"false\":[false],\"maybe\":[true,false]}");
  ...
  private void _testMultimap(Multimap<?, ?> map0, boolean fullyOrdered, String EXPECTED) throws Exception {
    @SuppressWarnings(value = { "unchecked" }) Multimap<String, Boolean> map = (Multimap<String, Boolean>) map0;
  ...
  public void testHashMultimap() throws IOException {
    SetMultimap<String, String> map = setBasedHelper(new TypeReference<HashMultimap<String, String>>() { });
    assertTrue(map instanceof HashMultimap);
  }

  public void testLinkedHashMultimap() throws IOException {
    SetMultimap<String, String> map = setBasedHelper(new TypeReference<LinkedHashMultimap<String, String>>() { });
  ...
  public void testArrayListMultimap() throws IOException {
    ListMultimap<String, String> map = listBasedHelper(new TypeReference<ArrayListMultimap<String, String>>() { });
    assertTrue(map instanceof ArrayListMultimap);
  }

  public void testLinkedListMultimap() throws IOException {
    ListMultimap<String, String> map = listBasedHelper(new TypeReference<LinkedListMultimap<String, String>>() { });
    assertTrue(map instanceof LinkedListMultimap);
  }

  public void testMultimapWithIgnores() throws IOException {
    assertEquals("{\"map\":{\"a\":[\"foo\"]}}", MAPPER.writeValueAsString(new MultiMapWithIgnores()));
  }
