...
public class FortunaTest {
  @Test public void shouldCreateInstanceAndWaitForInitialization() {
  ...
  @Test public void shouldProduceEvenDistribution() {
    int numbers = 1000;
...
>>>>>>> /usr/src/app/output/grunka/fortuna/7475060adde9b911d104d64d02aceaee05fd9e4b/src/test/java/com/grunka/random/fortuna/FortunaTest.java/right.java
  ...
  @Test public void shouldNotShutdownPassedInScheduledExecutorService() throws InterruptedException {
  ...
  private static class MockScheduledExecutorService implements ScheduledExecutorService {
    ...
    @Override public <V extends java.lang.Object> ScheduledFuture<V> schedule(Callable<V> callable, long delay, TimeUnit unit) {
      throw new UnsupportedOperationException();
    }
    ...
    @Override public <T extends java.lang.Object> Future<T> submit(Callable<T> task) {
      throw new UnsupportedOperationException();
    }

    @Override public <T extends java.lang.Object> Future<T> submit(Runnable task, T result) {
      throw new UnsupportedOperationException();
    }
    ...
    @Override public <T extends java.lang.Object> List<Future<T>> invokeAll(Collection<? extends Callable<T>> tasks) {
      throw new UnsupportedOperationException();
    }

    @Override public <T extends java.lang.Object> List<Future<T>> invokeAll(Collection<? extends Callable<T>> tasks, long timeout, TimeUnit unit) {
      throw new UnsupportedOperationException();
    }

    @Override public <T extends java.lang.Object> T invokeAny(Collection<? extends Callable<T>> tasks) {
      throw new UnsupportedOperationException();
    }

    @Override public <T extends java.lang.Object> T invokeAny(Collection<? extends Callable<T>> tasks, long timeout, TimeUnit unit) {
      throw new UnsupportedOperationException();
    }
