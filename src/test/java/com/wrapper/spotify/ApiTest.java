...
public class ApiTest {
  ...
  @Test public void shouldCreateAGetAlbumUrl() {
...
<<<<<<< /usr/src/app/output/thelinmichael/spotify-web-api-java/9899e12d3f8290f0096702389efd8d4d92a53401/src/test/java/com/wrapper/spotify/ApiTest.java/left.java
  @Test public void shouldCreateGetAudioFeaturesUrl() {
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void shouldCreateAGetAudioFeaturesUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateAGetTracksForAlbumUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
    Request request = api.getTracksForAlbum("5oEljuMoe9MXH6tBIPbd5e").build();
    String test = request.toString();
    assertEquals("https://api.spotify.com:443/v1/albums/5oEljuMoe9MXH6tBIPbd5e/tracks", request.getUri().toString());
  }

  @Test public void shouldReplacePlaylistsTracks() {
    final Api api = Api.builder().accessToken(accessToken).build();
    Request request = api.replacePlaylistsTracks("userId", "5oEljuMoe9MXH6tBIPbd5e", new String[] { "spotify:track:4iV5W9uYEdYUVa79Axb7Rh" }).build();
    assertEquals("https://api.spotify.com:443/v1/users/userId/playlists/5oEljuMoe9MXH6tBIPbd5e/tracks?uris=spotify%3Atrack%3A4iV5W9uYEdYUVa79Axb7Rh", request.getUri().toString());
  }

  @Test public void shouldUnfollowPlaylist() {
    final Api api = Api.builder().accessToken(accessToken).build();
    Request request = api.unfollowPlaylist("userId", "5oEljuMoe9MXH6tBIPbd5e").build();
    assertEquals("https://api.spotify.com:443/v1/users/userId/playlists/5oEljuMoe9MXH6tBIPbd5e/followers", request.getUri().toString());
  }

  @Test public void shouldCreateAGetRecentlyPlayedTracksUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateAGetArtistUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateAGetTrackUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateAGetAlbumsUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateAGetAlbumsUrlFromAList() {
    final Api api = Api.builder().accessToken(accessToken).build();
    IRequest request = api.getAlbums("6hDH3YWFdcUNQjubYztIsG", "2IA4WEsWAYpV9eKkwR2UYv").build();
    assertEquals("https://api.spotify.com:443/v1/albums?ids=6hDH3YWFdcUNQjubYztIsG%2C2IA4WEsWAYpV9eKkwR2UYv", request.getUri().toString());
    assertHasQueryParameter(request, "ids", "6hDH3YWFdcUNQjubYztIsG,2IA4WEsWAYpV9eKkwR2UYv");
  ...
  @Test public void shouldCreateAGetTracksUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateAGetTracksUrlFromList() {
    final Api api = Api.builder().accessToken(accessToken).build();
    IRequest request = api.getTracks("6hDH3YWFdcUNQjubYztIsG", "2IA4WEsWAYpV9eKkwR2UYv").build();
    assertEquals("https://api.spotify.com:443/v1/tracks?ids=6hDH3YWFdcUNQjubYztIsG%2C2IA4WEsWAYpV9eKkwR2UYv", request.getUri().toString());
    assertHasQueryParameter(request, "ids", "6hDH3YWFdcUNQjubYztIsG,2IA4WEsWAYpV9eKkwR2UYv");
  ...
  @Test public void shouldCreateAGetRecommendationsUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateAGetRecommendationsUrlFromList() {
    final Api api = Api.builder().accessToken(accessToken).build();
    Request request = api.getRecommendations().build();
    assertEquals("https://api.spotify.com:443/v1/recommendations", request.getUri().toString());
  }

  @Test public void shouldCreateAUrlForArtistsAlbum() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldHaveMultipleAlbumTypeParametersInArtistsAlbumUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
    IRequest request = api.getAlbumsForArtist("4AK6F7OLvEQ5QYCBNiQWHq").album_type(AlbumType.ALBUM.getType() + "," + AlbumType.SINGLE.getType()).market(CountryCode.SE).build();
  ...
  @Test public void shouldHaveSingleAlbumTypeParametersInArtistsAlbumUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
    IRequest request = api.getAlbumsForArtist("4AK6F7OLvEQ5QYCBNiQWHq").album_type(AlbumType.SINGLE.getType()).build();
  ...
  @Test public void shouldFailIfAlbumTypeParametersIsInArtistsAlbumUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
    IRequest request = api.getAlbumsForArtist("4AK6F7OLvEQ5QYCBNiQWHq").album_type(AlbumType.SINGLE.getType()).build();
    assertEquals("https://api.spotify.com:443/v1/artists/4AK6F7OLvEQ5QYCBNiQWHq/albums?album_type=single", request.getUri().toString());
    assertHasQueryParameter(request, "album_type", "single");
  ...
  @Test public void shouldHaveLimitParameterInArtistsAlbumUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldHaveOffsetParameterInArtistsAlbumUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldHaveSeveralQueryParametersAtTheSameTimeInArtistsAlbumUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
    IRequest request = api.getAlbumsForArtist("4AK6F7OLvEQ5QYCBNiQWHq").album_type(AlbumType.SINGLE.getType()).limit(2).offset(5).build();
  ...
  @Test public void shouldCreateAGetArtistsUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateSearchUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateSearchUrlForAlbum() {
    final Api api = Api.builder().accessToken(accessToken).build();
    IRequest request = api.searchAlbums("meeep").market(CountryCode.GB).build();
  ...
  @Test public void shouldCreateSearchUrlForArtist() {
    final Api api = Api.builder().accessToken(accessToken).build();
    IRequest request = api.searchArtists("meeep").market(CountryCode.GB).build();
  ...
  @Test public void shouldCreateSearchUrlWithLimitParameter() {
    final Api api = Api.builder().accessToken(accessToken).build();
    IRequest request = api.searchTracks("moulat swalf").limit(2).market(CountryCode.SE).build();
  ...
  @Test public void shouldCreateSearchUrlWithOffsetParameter() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldModifySchemeInUrl() {
  ...
  @Test public void shouldModifyPortInUrl() {
  ...
  @Test public void shouldModifyHostInUrl() {
  ...
  @Test public void shouldCreateTopTracksUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
    IRequest request = api.getTopTracksForArtist("0LcJLqbBmaGUft1e9Mm8HV", CountryCode.GB).build();
  ...
  @Test public void shouldCreateUserProfileUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateUrlForListingAUsersPlaylists() throws Exception {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateRequestForTokensUrl() {
...
<<<<<<< Unknown file: This is a bug in JDime.
=======
  @Test public void shouldCreateRefreshAccessTokenUrl() {
    final String clientId = "myClientId";
    final String clientSecret = "myClientSecret";
    final String refreshToken = "myRefreshToken";
    final Api api = Api.builder().clientId(clientId).clientSecret(clientSecret).refreshToken(refreshToken).build();
...
>>>>>>> /usr/src/app/output/thelinmichael/spotify-web-api-java/9899e12d3f8290f0096702389efd8d4d92a53401/src/test/java/com/wrapper/spotify/ApiTest.java/right.java
  ...
  @Test public void shouldCreatePlaylistLookupUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateCurrentUserLookupUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateRemoveTrackFromPlaylistUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
    final String myUsername = "thelinmichael";
    final String myPlaylistId = "5ieJqeLJjjI8iJWaxeBLuK";
    ...
    final String expectedJsonBodyTracks = String.format("[{\"uri\":\"%s\"},{\"uri\":\"%s\",\"positions\":[%s]}]", track1Uri, track2Uri, String.valueOf(track2Position));
    final Request request = api.removeTrackFromPlaylist(myUsername, myPlaylistId, tracksToRemove).snapshotId(snapshotId).tracks(tracks).build();
  ...
  @Test public void shouldCreateReorderTracksInPlaylistUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
    final String myUsername = "thelinmichael";
    final String myPlaylistId = "5ieJqeLJjjI8iJWaxeBLuK";
    final String snapshotId = "JbtmHBDBAYu3/bt8BOXKjzKx3i0b6LCa/wVjyl6qQ2Yf6nFXkbmzuEa+ZI/U1yF+";
    ...
    final String expectedJsonBody = String.format("{\"range_start\":%s,\"insert_before\":%s,\"range_length\":%s,\"snapshot_id\":\"%s\"}", String.valueOf(rangeStart), String.valueOf(insertBefore), String.valueOf(rangeLength), snapshotId);
    final Request request = api.reorderTracksInPlaylist(myUsername, myPlaylistId, rangeStart, insertBefore).range_length(rangeLength).snapshot_id(snapshotId).build();
    assertEquals("https://api.spotify.com:443/v1/users/thelinmichael/playlists/" + myPlaylistId + "/tracks", request.getUri().toString());
    assertHasHeader(request, "Authorization", "Bearer " + accessToken);
  ...
  @Test public void shouldCreateChangePlaylistDetailsUrl() {
    final Api api = Api.builder().accessToken(accessToken).build();
    final String myUsername = "thelinmichael";
    final String myPlaylistId = "5ieJqeLJjjI8iJWaxeBLuK";
    final boolean isPublic = false;
    final String name = "Testing name change";
    final IRequest request = api.changePlaylistDetails(myUsername, myPlaylistId).public_(isPublic).name(name).build();
    assertEquals("https://api.spotify.com:443/v1/users/thelinmichael/playlists/" + myPlaylistId, request.getUri().toString());
    assertHasHeader(request, "Authorization", "Bearer " + accessToken);
  ...
  @Test public void shouldCreateClientCredentialsGrantUrl() {
    final String clientId = "myClientId";
    final String clientSecret = "myClientSecret";
  ...
  @Test public void shouldCreateAGetPlaylistTracksURL() {
    final String accessToken = "myAccessToken";
    final String userId = "thelinmichael";
    final String playlistId = "5ieJqeLJjjI8iJWaxeBLuK";
    final Api api = Api.builder().accessToken(accessToken).build();
    final IRequest request = api.getPlaylistTracks(userId, playlistId).fields("items").limit(20).offset(1).build();
  ...
  @Test public void shouldCreateRelatedArtistsURL() {
    final Api api = Api.builder().accessToken(accessToken).build();
  ...
  @Test public void shouldCreateAuthorizeUrlWithOptionalParameters() {
    ...
    final String[] scopes = { "user-read-private", "user-read-email" };
    final String state = "someExpectedStateString";
    String authorizeUrlString = api.createAuthorizeUri(scopes).toString();
  ...
  @Test public void shouldCreateAuthorizeUrlWithShowDialog() {
    final String redirectURI = "http://www.michaelthelin.se/test-callback";
    final String clientId = "fcecfc79122e4cd299473677a17cbd4d";
    final Api api = Api.builder().clientId(clientId).redirectURI(redirectURI).build();
    final String[] scopes = { "user-read-private", "user-read-email" };
    final String state = "someExpectedStateString";
    String authorizeURLString = api.createAuthorizeUri(scopes, state, true).toString();
  ...
  @Test public void shouldCreateGetMyTracksURL() {
    final String accessToken = "myAccessToken";
    final Api api = Api.builder().accessToken(accessToken).build();
    final IRequest request = api.getMySavedTracks().limit(5).offset(1).build();
  ...
  @Test public void shouldCreatePutTracksURL() {
    final String accessToken = "myAccessToken";
    final Api api = Api.builder().accessToken(accessToken).build();
    final IRequest request = api.addToMySavedTracks("test", "test2").build();
    assertEquals("https://api.spotify.com:443/v1/me/tracks?ids=test%2Ctest2", request.getUri().toString());
    assertHasHeader(request, "Authorization", "Bearer " + accessToken);
  }

  @Test public void shouldCreateRemoveTracksURL() {
    final String accessToken = "myAccessToken";
    final Api api = Api.builder().accessToken(accessToken).build();
    final IRequest request = api.removeFromMySavedTracks("test", "test2").build();
    assertEquals("https://api.spotify.com:443/v1/me/tracks?ids=test%2Ctest2", request.getUri().toString());
  }

  @Test public void shouldCreateGetNewReleasesRequest() {
    final String accessToken = "myAccessToken";
    final Api api = Api.builder().accessToken(accessToken).build();
    final IRequest request = api.getNewReleases().limit(4).offset(1).country(CountryCode.SE).build();
  ...
  @Test public void shouldCreateFeaturedPlaylistsRequest() {
    final String accessToken = "myAccessToken";
    final Api api = Api.builder().accessToken(accessToken).build();
    Calendar calendar = Calendar.getInstance();
    calendar.set(2014, Calendar.DECEMBER, 22, 13, 59, 30);
    Date timestamp = calendar.getTime();
    final IRequest request = api.getFeaturedPlaylists().country(CountryCode.SE).locale(LanguageCode.es + "_" + CountryCode.MX).limit(5).offset(1).timestamp(timestamp).build();
