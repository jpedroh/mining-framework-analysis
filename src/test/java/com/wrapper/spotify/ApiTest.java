...
public class ApiTest {
  ...
  @Test public void shouldCreateAGetTracksForAlbumUrl() {
    ...
    assertEquals("https://api.spotify.com:443/v1/albums/5oEljuMoe9MXH6tBIPbd5e/tracks", request.toString());
  }

  @Test public void shouldReplacePlaylistsTracks() {
    Api api = Api.DEFAULT_API;
    Request request = api.replacePlaylistsTracks("userId", "5oEljuMoe9MXH6tBIPbd5e", Collections.<String>emptyList()).build();
    assertEquals("https://api.spotify.com:443/v1/users/userId/playlists/5oEljuMoe9MXH6tBIPbd5e/tracks", request.toString());
  }

  @Test public void shouldUnfollowPlaylist() {
    Api api = Api.DEFAULT_API;
    Request request = api.unfollowPlaylist("userId", "5oEljuMoe9MXH6tBIPbd5e").build();
    assertEquals("https://api.spotify.com:443/v1/users/userId/playlists/5oEljuMoe9MXH6tBIPbd5e/followers", request.toString());
  }
  ...
  @Test public void shouldCreateAuthorizeUrlWithOptionalParameters() {
    ...
    final String[] scopes = { "user-read-private", "user-read-email" };
    final String state = "someExpectedStateString";
    String authorizeUrlString = api.createAuthorizeURL(scopes).state(state).showDialog(false).build().toString();
