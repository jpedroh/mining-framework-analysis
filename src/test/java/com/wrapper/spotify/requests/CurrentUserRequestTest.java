...
public class CurrentUserRequestTest {
  @Test public void shouldGetCurrentUser_async() throws Exception {
    ...
    final CurrentUserRequest request = api.getMe().accessToken("myLongAccessToken").setHttpManager(TestUtil.MockedHttpManager.returningJson("current-user.json")).build();
