...
@RunWith(value = MockitoJUnitRunner.class) public class ArtistsRequestTest {
  @Test public void shouldGetArtistsResult_async() throws Exception {
    final Api api = Api.DEFAULT_API;
    final ArtistsRequest request = api.getArtists("0oSGxfWSnnOXhD2fKuz2Gy", "3dBVyJ7JuOMt4GE9607Qin").setHttpManager(TestUtil.MockedHttpManager.returningJson("artists.json")).build();
    ...
    Futures.addCallback(artistsFuture, new FutureCallback<Artist[]>() {
      @Override public void onSuccess(Artist[] artists) {
