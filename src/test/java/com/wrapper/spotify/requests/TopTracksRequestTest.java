...
@RunWith(value = MockitoJUnitRunner.class) public class TopTracksRequestTest {
  @Test public void shouldGetTracksResult_async() throws Exception {
    final Api api = Api.DEFAULT_API;
    final TopTracksRequest request = api.getTopTracksForArtist("43ZHCT0cAZBISjO8DG9PnE", "GB").setHttpManager(TestUtil.MockedHttpManager.returningJson("tracks-for-artist.json")).build();
    ...
    Futures.addCallback(tracksFuture, new FutureCallback<Track[]>() {
      @Override public void onSuccess(Track[] tracks) {
