...
public class RelatedArtistsRequestTest {
  @Test public void shouldGetRelatedArtists_async() throws Exception {
    final Api api = Api.DEFAULT_API;
    final RelatedArtistsRequest request = api.getArtistRelatedArtists("0qeei9KQnptjwb8MgkqEoy").setHttpManager(TestUtil.MockedHttpManager.returningJson("related-artists.json")).build();
  ...
  @Test public void shouldGetRelatedArtists_sync() throws Exception {
    final Api api = Api.DEFAULT_API;
    final RelatedArtistsRequest request = api.getArtistRelatedArtists("0qeei9KQnptjwb8MgkqEoy").setHttpManager(TestUtil.MockedHttpManager.returningJson("related-artists.json")).build();
