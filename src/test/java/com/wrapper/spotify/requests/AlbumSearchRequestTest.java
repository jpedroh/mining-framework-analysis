...
@RunWith(value = MockitoJUnitRunner.class) public class AlbumSearchRequestTest {
  @Test public void shouldGetAlbumsResult_async() throws Exception {
    final Api api = Api.DEFAULT_API;
    final AlbumSearchRequest request = api.searchAlbums("tania bowra").setHttpManager(TestUtil.MockedHttpManager.returningJson("search-album.json")).build();
  ...
  @Test public void shouldGetAlbumsResult_sync() throws Exception {
    final Api api = Api.DEFAULT_API;
    final AlbumSearchRequest request = api.searchAlbums("tania bowra").setHttpManager(TestUtil.MockedHttpManager.returningJson("search-album.json")).build();
