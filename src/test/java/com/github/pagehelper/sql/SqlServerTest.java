...
public class SqlServerTest {
  ...
  @Test @Ignore(value = "\u6682\u65f6\u4e0d\u652f\u6301") public void testSqlTestWithlock() throws JSQLParserException {
  ...
  @Test public void testSelectParameter() throws JSQLParserException {
    String originalSql = "Select id as id,? name,? from country o where id > 10 order by id desc , countryname asc";
    System.out.println(sqlServer.convertToPageSql(originalSql, 1, 10));
  }

  @Test public void testSqlWith() throws JSQLParserException {
    String originalSql = "with cr as " + " (select id " + "    from country " + "   where id > 100 " + "     and id < 120) " + "select id, countryname, countrycode " + "  from country " + " where id in (select * from cr) order by id";
    System.out.println(sqlServer.convertToPageSql(originalSql, 1, 10));
  }

  @Test public void testSqlLeftJoin() throws JSQLParserException {
  ...
  @Test public void testSqlUnion() throws JSQLParserException {
    String originalSql = "select countryname,countrycode code from country where id >170 " + "union all " + "select countryname,countrycode code from country where id < 10 order by code";
    System.out.println(sqlServer.convertToPageSql(originalSql, 1, 10));
  }

  @Test public void testSqlUnion2() throws JSQLParserException {
    String originalSql = "select countryname,code from ( " + "\tselect countryname,countrycode code from country where id >170 " + "\tunion all " + "\tselect countryname,countrycode code from country where id < 10 " + ") as temp " + "order by code";
    System.out.println(sqlServer.convertToPageSql(originalSql, 1, 10));
  }

  @Test public void testSqlOrderByFunctionAlias() throws JSQLParserException {
    String originalSql = "select countrycode code, func() func_alias from country order by func()";
    System.out.println(sqlServer.convertToPageSql(originalSql, 1, 10));
  }

  @Test public void testSqlOrderByUnknown() throws JSQLParserException {
    String originalSql = "select countryname from country order by countrycode";
    System.out.println(sqlServer.convertToPageSql(originalSql, 1, 10));
  }

  @Test public void testSqlOrderByTable() throws JSQLParserException {
    String originalSql = "select t.countrycode, t.countryname from country t order by t.countrycode";
    System.out.println(sqlServer.convertToPageSql(originalSql, 1, 10));
  }

  @Test public void testSqlStar() throws JSQLParserException {
