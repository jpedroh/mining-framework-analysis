...
public class SpringMvcTest extends AbstractMojoTestCase {
  ...
  @Test public void testGeneratedSwaggerSpecYaml() throws Exception {
    ...
    String expectYaml = io.swagger.util.Yaml.pretty().writeValueAsString(new Yaml().load(this.getClass().getResourceAsStream("/expectedOutput/swagger-spring.yaml")));
    ObjectMapper mapper = new ObjectMapper();
  ...
  @DataProvider private Iterator<String[]> pathProvider() throws Exception {
