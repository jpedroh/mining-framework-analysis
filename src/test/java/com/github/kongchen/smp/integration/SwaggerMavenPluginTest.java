...
public class SwaggerMavenPluginTest extends AbstractMojoTestCase {
  ...
  @Test public void testGeneratedSwaggerSpecJson() throws Exception {
    executeAndAssertGeneratedSwaggerSpecJson("This is a sample.", "/expectedOutput/swagger.json");
  }

  @Test public void testGeneratedSwaggerSpecYaml() throws Exception {
    assertGeneratedSwaggerSpecYaml("This is a sample.", "/expectedOutput/swagger.yaml");
  }

  @Test public void testSwaggerCustomReaderJson() throws Exception {
  ...
  @Test public void testSwaggerCustomReaderYaml() throws Exception {
    setCustomReader(mojo, "com.wordnik.jaxrs.CustomJaxrsReader");
    assertGeneratedSwaggerSpecYaml("Processed with CustomJaxrsReader", "/expectedOutput/swagger.yaml");
  }

  @Test public void testInvalidCustomReaderJson() throws Exception {
  ...
  @Test public void testInvalidCustomReaderYaml() throws Exception {
    String className = "com.wordnik.nonexisting.Class";
    setCustomReader(mojo, className);
    try {
      testGeneratedSwaggerSpecJson();
  ...
  @Test public void testGeneratedDoc() throws Exception {
    mojo.execute();
  ...
  @Test public void testGeneratedDocWithJsonExampleValues() throws Exception {
  ...
  @Test public void testNullSwaggerOutput() throws Exception {
    List<ApiSource> apisources = (List<ApiSource>) getVariableValueFromObject(mojo, "apiSources");
  ...
  @Test public void testNullMustacheOutput() throws Exception {
    List<ApiSource> apisources = (List<ApiSource>) getVariableValueFromObject(mojo, "apiSources");
  ...
  @DataProvider private Iterator<Object[]> pathProvider() throws Exception {
  ...
  @Test(enabled = false, dataProvider = "pathProvider") public void testExecuteDirectoryCreated(String path) throws Exception {
  ...
  @Test public void testCustomModelConverterYaml() throws MojoFailureException, MojoExecutionException, IOException {
  ...
  @Test public void testCustomModelConverterJson() throws MojoFailureException, MojoExecutionException, IOException {
    mojo.getApiSources().get(0).setModelConverters(ImmutableList.of(PetIdToStringModelConverter.class.getName()));
    executeAndAssertGeneratedSwaggerSpecJson("This is a sample.", "/expectedOutput/swagger-with-converter.json");
  }

  @Test public void testMultipleApiSourcesWithDifferentArtifactName() throws Exception {
  ...
  @Test public void testFeatureIsAccepted() throws Exception {
  ...
  @Test public void testFeatureIsNotFoundFail() throws Exception {
  ...
  @Test public void testExternalDocsAdded() throws Exception {
    File testPom = new File(getBasedir(), "src/test/resources/plugin-config-externalDocs.xml");
    mojo = (ApiDocumentMojo) lookupMojo("generate", testPom);
    mojo.execute();
    assertGeneratedSwaggerSpecJson("This is a sample.", "/expectedOutput/swagger-externalDocs.json", "swagger.json");
  }
}