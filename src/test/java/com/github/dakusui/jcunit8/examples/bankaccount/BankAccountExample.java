...
@RunWith(value = JCUnit8.class) @ConfigureWith(value = ConfigFactory.Default.class) public class BankAccountExample {
  private BankAccount myAccount;

  private BankAccount anotherAccount = BankAccount.open();

  @ParameterSource public Regex.Factory<String> scenario() {
    return Regex.Factory.of("open deposit(deposit|withdraw|transfer){0,2}getBalance");
  }

  @ParameterSource public Simple.Factory<Integer> depositAmount() {
    return Simple.Factory.of(asList(100, 200, 300, 400, 500, 600, -1));
  }

  @ParameterSource public Simple.Factory<Integer> withdrawAmount() {
    return Simple.Factory.of(asList(100, 200, 300, 400, 500, 600, -1));
  }

  @ParameterSource public Simple.Factory<Integer> transferAmount() {
    return Simple.Factory.of(asList(100, 200, 300, 400, 500, 600, -1));
  }
