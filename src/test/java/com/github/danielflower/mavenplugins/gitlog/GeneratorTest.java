...
public class GeneratorTest {
  ...
  @Test public void writeLogToStandardOutput() throws Exception {
    Log log = new SystemStreamLog();
    ChangeLogRenderer renderer = new MavenLoggerRenderer(log);
    generateReport(log, renderer);
  }

  @Test public void writeLogToStandardOutputWithRegexpFilter() throws Exception {
    Log log = new SystemStreamLog();
    ChangeLogRenderer renderer = new MavenLoggerRenderer(log);
  ...
  @Test public void writePlainTextLogToFile() throws Exception {
    Log log = new SystemStreamLog();
    ChangeLogRenderer renderer = new PlainTextRenderer(log, new File(TARGET_DIR), "changelog.txt", false);
    generateReport(log, renderer);
  }

  @Test public void writePlainTextFullLogToFile() throws Exception {
    Log log = new SystemStreamLog();
    ChangeLogRenderer renderer = new PlainTextRenderer(log, new File(TARGET_DIR), "changelogFull.txt", true);
    generateReport(log, renderer);
  }

  @Ignore public void writePlainTextFullLogToFileCustomDir() throws Exception {
    Log log = new SystemStreamLog();
  ...
  @Test public void writeSimpleHtmlLogToFile() throws Exception {
    Log log = new SystemStreamLog();
  ...
  @Test public void writeSimpleHtmlFullLogToFile() throws Exception {
    Log log = new SystemStreamLog();
    GitHubIssueLinkConverter messageConverter = new GitHubIssueLinkConverter(log, THIS_PLUGIN_ISSUES);
  ...
  @Test public void writeHtmlTableOnlyLogToFile() throws Exception {
    Log log = new SystemStreamLog();
    GitHubIssueLinkConverter messageConverter = new GitHubIssueLinkConverter(log, THIS_PLUGIN_ISSUES);
  ...
  @Test public void writeMarkdownLogToFile() throws Exception {
    Log log = new SystemStreamLog();
    GitHubIssueLinkConverter messageConverter = new GitHubIssueLinkConverter(log, THIS_PLUGIN_ISSUES);
  ...
  @Test public void writeAsciidocLogToFile() throws Exception {
    Log log = new SystemStreamLog();
    GitHubIssueLinkConverter messageConverter = new GitHubIssueLinkConverter(log, THIS_PLUGIN_ISSUES);
  ...
  @Test public void writeAsciidocLogToFileJiraAsTableView() throws Exception {
    Log log = new SystemStreamLog();
  ...
  @Test public void writeJsonLogToFile() throws Exception {
    Log log = new SystemStreamLog();
