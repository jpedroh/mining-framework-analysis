...
public class MemoryFileSystemTest {
  ...
  @Rule public final FileSystemRule rule = new FileSystemRule();

  @Test public void tryLockNoArguments() throws IOException {
  ...
  @Test public void overLappingLocking() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("file.txt");
    Files.createFile(path);
    this.setContents(path, "0123456789");
  ...
  @Test public void writeByteArrayAppending() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("file.txt");
    Files.createFile(path);
  ...
  @Test public void writeByteArrayNonAppending() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("file.txt");
    byte[] data = new byte[] { 'a', 'b', 'c', 'd' };
  ...
  @Test public void readIntoBuffer() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("file.txt");
    Files.createFile(path);
  ...
  @Test public void scatteringRead() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("file.txt");
    Files.createFile(path);
    this.setContents(path, "abcd");
  ...
  @Test public void scatteringReadBufferTooSmall() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("file.txt");
    Files.createFile(path);
  ...
  @Test public void scatteringWrite() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("file.txt");
  ...
  @Test public void scatteringWriteAppend() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("file.txt");
    Files.createFile(path);
    this.setContents(path, "z");
  ...
  @Test public void writeAsyncChannelTruncate() throws IOException, InterruptedException, ExecutionException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void writeSyncChannelTruncate() throws IOException, InterruptedException, ExecutionException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("async.txt");
    Files.createFile(path);
    this.setContents(path, "abc");
  ...
  @Test public void writeAsyncChannelBasicMethods() throws IOException, InterruptedException, ExecutionException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("async.txt");
    Files.createFile(path);
    this.setContents(path, "z");
  ...
  @Test public void writeAsyncChannelWriteCompletionHandler() throws IOException, InterruptedException, ExecutionException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("async.txt");
    Files.createFile(path);
    this.setContents(path, "z");
  ...
  @Test public void writeAsyncChannelReadCompletionHandler() throws IOException, InterruptedException, ExecutionException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("async.txt");
    Files.createFile(path);
    this.setContents(path, "abcd");
  ...
  @Test public void writeAsyncChannelWriteIoException() throws IOException, InterruptedException, ExecutionException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("async.txt");
    Files.createFile(path);
    this.setContents(path, "z");
  ...
  @Test public void writeAsyncChannelWriteCompletionFuture() throws IOException, InterruptedException, ExecutionException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("async.txt");
    Files.createFile(path);
    this.setContents(path, "z");
  ...
  @Test public void writeAsyncChannelReadCompletionFuture() throws IOException, InterruptedException, ExecutionException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("async.txt");
    Files.createFile(path);
    this.setContents(path, "abcd");
  ...
  @Test public void writeAsyncChannelWriteCompletionFutureFailed() throws IOException, InterruptedException, ExecutionException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("async.txt");
    Files.createFile(path);
    this.setContents(path, "z");
  ...
  @Test public void lockAsyncChannel() throws IOException, InterruptedException, ExecutionException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void deleteOnCloseInputStream() throws IOException {
  ...
  @Test public void deleteOnCloseOutputStream() throws IOException {
    Path path = this.rule.getFileSystem().getPath("/sample.txt");
    Files.createFile(path);
    assertThat(path, exists());
  ...
  @Test public void deleteOnCloseByteChannelStream() throws IOException {
    Path path = this.rule.getFileSystem().getPath("/sample.txt");
    Files.createFile(path);
    assertThat(path, exists());
  ...
  @Test public void probeContent() throws IOException {
    Path path = this.rule.getFileSystem().getPath("/sample.txt");
    Files.createFile(path);
    Files.probeContentType(path);
  }

  @Test public void trasferFrom() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    ...
    try (FileChannel fromChannel = FileChannel.open(from, READ); FileChannel toChannel = FileChannel.open(to, WRITE, CREATE_NEW)) {
  ...
  @Test public void trasferTo() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path from = fileSystem.getPath("from.txt");
    Path to = fileSystem.getPath("to.txt");
    this.writeBigContents(from);
  ...
  @Test public void directoryStream() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    ...
    try (DirectoryStream<Path> directoryStream = Files.newDirectoryStream(fileSystem.getPath("/"))) {
      ...
      List<Path> expected = Arrays.asList(fileSystem.getPath("/a.java"), fileSystem.getPath("/a.cpp"), fileSystem.getPath("/a.hpp"), fileSystem.getPath("/a.c"), fileSystem.getPath("/a.h"), fileSystem.getPath("/d1"), fileSystem.getPath("/d2"));
    ...
    try (DirectoryStream<Path> directoryStream = Files.newDirectoryStream(fileSystem.getPath("/"), "*.{java,cpp}")) {
      List<Path> actual = asList(directoryStream.iterator());
      List<Path> expected = Arrays.asList(fileSystem.getPath("/a.java"), fileSystem.getPath("/a.cpp"));
      assertEquals(expected.size(), actual.size());
      Set<Path> actualSet = new HashSet<>(actual);
      assertEquals(actualSet.size(), actual.size());
      Set<Path> expectedSet = new HashSet<>(expected);
  ...
  static <T extends java.lang.Object> List<T> asList(Iterator<T> iterator) {
  ...
  static <T extends java.lang.Object> List<T> asList(Iterable<T> iterable) {
    return asList(iterable.iterator());
  }

  @Test(expected = IllegalArgumentException.class) public void setDirectory() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("/");
    Files.setAttribute(path, "isDirectory", false);
  }

  @Test(expected = FileSystemLoopException.class) public void symbolicLinkLoop() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void readSymlink() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path a = fileSystem.getPath("/a");
    Path b = fileSystem.getPath("/b");
    Files.createFile(b);
  ...
  @Test public void readSymlinkInDirectory() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test(expected = FileSystemException.class) public void dontDeleteOpenFile() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void truncateExisting() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("test");
    try (SeekableByteChannel channel = Files.newByteChannel(path, CREATE_NEW, WRITE)) {
      channel.write(ByteBuffer.wrap(new byte[] { 1, 2, 3 }));
  ...
  @Test public void position() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void setPosition() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = Files.createTempFile(fileSystem.getPath("/"), "sample", ".txt");
    try (SeekableByteChannel channel = Files.newByteChannel(path, WRITE)) {
      ByteBuffer src = ByteBuffer.wrap(new byte[] { 1, 2, 3, 4, 5 });
  ...
  @Test public void isRegularFile() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("/");
  ...
  @Test(expected = UnsupportedOperationException.class) public void getPathMatcherUnknown() {
    FileSystem fileSystem = this.rule.getFileSystem();
    fileSystem.getPathMatcher("syntax:patten");
  }

  @Test(expected = IllegalArgumentException.class) public void getPathMatcherInvalid1() {
    FileSystem fileSystem = this.rule.getFileSystem();
    fileSystem.getPathMatcher("invalid");
  }

  @Test(expected = IllegalArgumentException.class) public void getPathMatcherInvalid2() {
    FileSystem fileSystem = this.rule.getFileSystem();
    fileSystem.getPathMatcher("invalid:");
  }

  @Test public void getPathMatcherGlob() {
    FileSystem fileSystem = this.rule.getFileSystem();
    PathMatcher matcher = fileSystem.getPathMatcher("glob:*.java");
    assertTrue(matcher instanceof GlobPathMatcher);
  }

  @Test public void getPathMatcherRegex() {
    FileSystem fileSystem = this.rule.getFileSystem();
    PathMatcher matcher = fileSystem.getPathMatcher("regex:.*\\.java");
    assertTrue(matcher instanceof RegexPathMatcher);
  }

  @Test(expected = PatternSyntaxException.class) public void getPathMatcherRegexInvalid() {
    FileSystem fileSystem = this.rule.getFileSystem();
    PathMatcher matcher = fileSystem.getPathMatcher("regex:*\\.java");
    assertTrue(matcher instanceof RegexPathMatcher);
  }

  @Test(expected = IllegalArgumentException.class) public void emptySubPath() {
    FileSystem fileSystem = this.rule.getFileSystem();
    assertEquals(fileSystem.getPath(""), fileSystem.getPath("").subpath(0, 0));
  }

  @Test public void subPath() {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void normalizeRoot() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path root = fileSystem.getPath("/");
    assertEquals(root, root.normalize());
  }

  @Test public void normalizeAbsolute() {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void normalizeRelative() {
    FileSystem fileSystem = this.rule.getFileSystem();
    assertEquals(fileSystem.getPath("a"), fileSystem.getPath("a").normalize());
    assertEquals(fileSystem.getPath("a"), fileSystem.getPath("a/.").normalize());
    assertEquals(fileSystem.getPath(""), fileSystem.getPath("a/..").normalize());
  ...
  @Test public void resolveAbsoluteOtherRelative() {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void resolveAbsoluteOtherAbsoluteString() {
    FileSystem fileSystem = this.rule.getFileSystem();
    String absolute = "/a/b";
  ...
  @Test public void resolveAbsoluteOtherRelativeString() {
    FileSystem fileSystem = this.rule.getFileSystem();
    String realtive = "a/b";
    assertEquals(fileSystem.getPath("a/b"), fileSystem.getPath("").resolve(realtive));
    assertEquals(fileSystem.getPath("/a/b"), fileSystem.getPath("/").resolve(realtive));
  ...
  @Test public void resolveSibling() {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void resolveSiblingAgainstRoot() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path root = fileSystem.getPath("/");
  ...
  @Test public void resolveSiblingAgainstRootString() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path root = fileSystem.getPath("/");
  ...
  @Test public void relativizeAbsolute() {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test(expected = IllegalArgumentException.class) public void relativizeAbsoluteUnsupported1() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path first = fileSystem.getPath("/a/b");
  ...
  @Test(expected = IllegalArgumentException.class) public void relativizeAbsoluteUnsupported2() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path first = fileSystem.getPath("/a/b");
    Path second = fileSystem.getPath("c");
  ...
  @Test public void relativizeRelative() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path first = fileSystem.getPath("a/b");
    Path second = fileSystem.getPath("a/b/c");
    assertEquals(fileSystem.getPath("c"), first.relativize(second));
  ...
  @Test public void relativizeRelativeRoot() {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void absoluteIterator() {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void relativeIterator() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path usrBin = fileSystem.getPath("usr/bin");
    Iterable<String> expected = Arrays.asList("usr", "bin");
    this.assertIterator(fileSystem, usrBin, expected);
  ...
  @Test public void absoluteGetParent() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path usrBin = fileSystem.getPath("/usr/bin");
  ...
  @Test public void relativeGetParent() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path usrBin = fileSystem.getPath("usr/bin");
    Path usr = fileSystem.getPath("usr");
    assertEquals(usr, usrBin.getParent());
  ...
  @Test(expected = IllegalArgumentException.class) public void absoluteGetName0() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path usrBin = fileSystem.getPath("/usr/bin");
    usrBin.getName(-1);
  }

  @Test(expected = IllegalArgumentException.class) public void absoluteGetNameToLong() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path usrBin = fileSystem.getPath("/usr/bin");
    usrBin.getName(2);
  }

  @Test(expected = IllegalArgumentException.class) public void emptyGetName() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path empty = fileSystem.getPath("");
    empty.getName(0);
  }

  @Test public void absoluteGetName() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path usrBin = fileSystem.getPath("/usr/bin");
    Path usr = fileSystem.getPath("usr");
  ...
  @Test public void relativeGetName() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path usrBin = fileSystem.getPath("usr/bin");
    Path usr = fileSystem.getPath("usr");
    assertEquals(usr, usrBin.getName(0));
  ...
  @Test(expected = IllegalArgumentException.class) public void relativeGetName0() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path usrBin = fileSystem.getPath("usr/bin");
    usrBin.getName(-1);
  }

  @Test(expected = IllegalArgumentException.class) public void relativeGetNameToLong() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path usrBin = fileSystem.getPath("usr/bin");
    usrBin.getName(2);
  }
  ...
  @Test public void absolutePaths() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("/");
  ...
  @Test public void supportedFileAttributeViews() {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void defaultSeparator() {
    FileSystem fileSystem = this.rule.getFileSystem();
    assertEquals("/", fileSystem.getSeparator());
  }

  @Test(expected = IllegalArgumentException.class) public void slash() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path path = fileSystem.getPath("/");
    path.subpath(0, 1);
  }

  @Test(expected = IOException.class) public void createDirectoryNoParent() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void xattrs() throws IOException {
  ...
  @Test public void pathOrderingDifferentFileSystem() throws IOException {
  ...
  @Test(expected = ClassCastException.class) public void pathOrderingIncompatible() {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path a = fileSystem.getPath("a");
  ...
  @Test public void createDirectories() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path homePmarscha = fileSystem.getPath("/home/pmarscha");
    assertThat(homePmarscha, not(exists()));
  ...
  @Test public void createDirectory() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test(expected = FileAlreadyExistsException.class) public void createDirectoryAlreadyExists() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path home = fileSystem.getPath("/home");
    assertThat(home, not(exists()));
    Files.createDirectory(home);
  ...
  @Test public void getRootDirectories() {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void copySameFile() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path a = fileSystem.getPath("a");
  ...
  @Test public void moveSameFile() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path a = fileSystem.getPath("a");
    Path b = fileSystem.getPath("./b/../a");
    this.createAndSetContents(a, "aaa");
  ...
  @Test public void readAttributes() throws IOException, ParseException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void copyAlreadyExists() throws IOException, ParseException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void moveAlreadyExistsNotEmpty() throws IOException, ParseException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path source = fileSystem.getPath("source");
    Path target = fileSystem.getPath("target");
  ...
  @Test public void copyAlreadyExistsNotEmpty() throws IOException, ParseException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path source = fileSystem.getPath("source");
    Path target = fileSystem.getPath("target");
    Path child = fileSystem.getPath("target/child.txt");
  ...
  @Test public void moveAlreadyExists() throws IOException, ParseException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path source = fileSystem.getPath("source");
    Path target = fileSystem.getPath("target");
    Files.createDirectory(source);
  ...
  @Test public void copyOverwriteExists() throws IOException, ParseException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path source = fileSystem.getPath("source");
    Path target = fileSystem.getPath("target");
    Files.createDirectory(source);
  ...
  @Test public void moveOverwriteExists() throws IOException, ParseException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path source = fileSystem.getPath("source");
    Path target = fileSystem.getPath("target");
    Files.createDirectory(source);
  ...
  @Test public void setTimesNull() throws IOException, ParseException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void copyAttributes() throws IOException, ParseException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path source = fileSystem.getPath("/source.txt");
  ...
  @Test public void copyNoExisitingNoAttributes() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
  ...
  @Test public void copyAcrossFileSystems() throws IOException {
  ...
  @Test public void copyReplaceExisitingNoAttributes() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path a = fileSystem.getPath("/1/a");
    Path b = fileSystem.getPath("/2/b");
    this.createAndSetContents(a, "aaa");
  ...
  @Test public void moveNoExisitingNoAttributes() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path a = fileSystem.getPath("/1/a");
    Path b = fileSystem.getPath("/2/b");
    Files.createDirectories(b.toAbsolutePath().getParent());
  ...
  @Test public void moveDifferentFileSystem() throws IOException {
    FileSystem source = this.rule.getFileSystem();
    try (FileSystem target = MemoryFileSystemBuilder.newEmpty().build("target")) {
      Path a = source.getPath("a");
      Path b = target.getPath("b");
  ...
  @Test public void moveReplaceExisitingNoAttributes() throws IOException {
    FileSystem fileSystem = this.rule.getFileSystem();
    Path a = fileSystem.getPath("/1/a");
    Path b = fileSystem.getPath("/2/b");
    this.createAndSetContents(a, "aaa");
  ...
  static final class CompletionHandlerStub<V extends java.lang.Object, A extends java.lang.Object> implements CompletionHandler<V, A> {
    ...
    @Override public void failed(Throwable exception, A attachment) {
