 ...
 */
@ExtendWith(value = { WeldJunit5Extension.class }) public abstract class BitInputTest<T extends BitInput> {
  ...
  @BeforeEach void selectBitInput() {
    bitInput = bitInputInstance.select(bitInputClass).get();
  }

  @AfterEach void dotAlign() throws IOException {
    final long bits = bitInput.align(current().nextInt(1, 16));
    assertTrue(bits >= 0L);
  }

  @RepeatedTest(value = 8) public void testReadBoolean() throws IOException {
  ...
  /**
     ...
     * less than {@code 1}.
     */
  @Test public void assertReadByteThrowsIllegalArgumentExceptionWhenSizeIsLessThanOne() {
    assertThrows(IllegalArgumentException.class, () -> bitInput.readByte(current().nextBoolean(), 0));
    assertThrows(IllegalArgumentException.class, () -> bitInput.readByte(current().nextBoolean(), current().nextInt() | Integer.MIN_VALUE));
  }

  @RepeatedTest(value = 128) public void testReadByte() {
  ...
  @RepeatedTest(value = 128) public void testReadShort() {
  ...
  /**
     ...
     */
  @RepeatedTest(value = 128) public void testReadInt() {
  ...
  @RepeatedTest(value = 128) public void testReadLong() {
  ...
  @Test public void testReadCharAssertThrowsIllegalArgumentExceptionWhenSizeIsLessThanOne() {
  ...
  @RepeatedTest(value = 8) public void testReadChar() throws IOException {
  ...
  /**
     ...
     * {@code 1}.
     */
  @Test public void assertIllegalArgumentExceptionThrownWhenBytesIsLessThanOne() {
  ...
  /**
     ...
     */
  @Test public void testAlign() throws IOException {
  ...
  @Inject private Instance<BitInput> bitInputInstance;
