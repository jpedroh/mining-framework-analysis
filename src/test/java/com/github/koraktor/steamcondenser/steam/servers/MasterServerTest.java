...
public class MasterServerTest {
  ...
  @Test public void testGetServers() throws Exception {
    ...
    verify(this.server.socket).send(argThat(new BaseMatcher<A2M_GET_SERVERS_BATCH2_Paket>() {
      public boolean matches(Object o) {
        ...
        return Arrays.equals(packet.getBytes(), "1\u00030.0.0.0:0\u0000filter\u0000".getBytes());
      }
    ...
    verify(this.server.socket).send(argThat(new BaseMatcher<A2M_GET_SERVERS_BATCH2_Paket>() {
      public boolean matches(Object o) {
        ...
        A2M_GET_SERVERS_BATCH2_Paket packet = (A2M_GET_SERVERS_BATCH2_Paket) o;
        return Arrays.equals(packet.getBytes(), "1\u0003127.0.0.3:27015\u0000filter\u0000".getBytes());
      }
  ...
  @Test public void testGetServersForced() throws Exception {
  ...
  @Test public void testGetServersSwapIp() throws Exception {
    M2A_SERVER_BATCH_Paket packet1 = mock(M2A_SERVER_BATCH_Paket.class);
    Vector<String> servers1 = new Vector<String>();
    servers1.add("127.0.0.1:27015");
    servers1.add("127.0.0.2:27015");
    ...
    servers2.add("0.0.0.0:0");
    when(packet2.getServers()).thenReturn(servers2);
    when(this.server.socket.getReply()).thenReturn(packet1).thenThrow(new TimeoutException()).thenThrow(new TimeoutException()).thenThrow(new TimeoutException()).thenReturn(packet2);
  ...
  @Test public void testGetServersTimeout() throws Exception {
