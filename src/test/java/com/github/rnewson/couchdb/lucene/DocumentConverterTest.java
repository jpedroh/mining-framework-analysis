...
public class DocumentConverterTest {
  ...
  @Test public void testSingleDocumentReturn() throws Exception {
  ...
  @Test public void testMultipleDocumentReturn() throws Exception {
    final DocumentConverter converter = new DocumentConverter(context, view("function(doc) {var ret = new Array(); ret.push(new Document()); ret.push(new Document()); return ret;}"));
    final Document[] result = converter.convert(doc("{_id:\"hello\"}"), settings(), null);
  ...
  @Test public void testAdd() throws Exception {
    final DocumentConverter converter = new DocumentConverter(context, view("function(doc) {var ret=new Document(); ret.add(doc.key); return ret;}"));
  ...
  @Test public void testForLoopOverObject() throws Exception {
    final DocumentConverter converter = new DocumentConverter(context, view("function(doc) {var ret=new Document(); for (var key in doc) { ret.add(doc[key]); } return ret; }"));
    final Document[] result = converter.convert(doc("{_id:\"hello\", key:\"value\"}"), settings(), null);
    assertThat(result.length, is(1));
    assertThat(result[0].get("_id"), is("hello"));
  ...
  @Test public void testForLoopOverArray() throws Exception {
    final DocumentConverter converter = new DocumentConverter(context, view("function(doc) {var ret=new Document(); for (var key in doc.arr) {ret.add(doc.arr[key]); } return ret; }"));
  ...
  @Test public void testForEverything() throws Exception {
    final DocumentConverter converter = new DocumentConverter(context, view("function(doc) {var ret=new Document(); " + "function idx(obj) {for (var key in obj) " + "{switch (typeof obj[key]) {case \'object\':idx(obj[key]); break; " + "case \'function\': break; default: ret.add(obj[key]); break;} } }; idx(doc); return ret; }"));
  ...
  @Test public void testNullReturn() throws Exception {
    final DocumentConverter converter = new DocumentConverter(context, view("function(doc) {return null;}"));
    final Document[] result = converter.convert(doc("{_id:\"hello\"}"), settings(), null);
    assertThat(result.length, is(0));
  }

  @Test public void testUndefinedReturn() throws Exception {
  ...
  @Test public void testNullAddsAreIgnored() throws Exception {
    final DocumentConverter converter = new DocumentConverter(context, view("function(doc) {var ret=new Document(); ret.add(doc.nope); return ret;}"));
    final Document[] result = converter.convert(doc("{_id:\"hello\"}"), settings(), null);
    assertThat(result.length, is(1));
  }

  @Test public void testQuoteRemoval() throws Exception {
    final DocumentConverter converter = new DocumentConverter(context, view("\"function(doc) {return new Document();}\""));
    final Document[] result = converter.convert(doc("{_id:\"hello\"}"), settings(), null);
    assertThat(result.length, is(1));
    assertThat(result[0].get("_id"), is("hello"));
  ...
  @Test public void testNoReturnValue() throws Exception {
  ...
  @Test public void testDefaultValue() throws Exception {
    ...
    final DocumentConverter converter = new DocumentConverter(context, view(fun));
    final Document[] result = converter.convert(doc("{_id:\"hi\", arr:[\"1\",\"2\"]}"), settings(), null);
    assertThat(result.length, is(1));
  ...
  @Test public void testNullValue() throws Exception {
    ...
    final DocumentConverter converter = new DocumentConverter(context, view(fun));
    final Document[] result = converter.convert(doc("{_id:\"hi\", foo:null}"), settings(), null);
    assertThat(result.length, is(1));
    assertThat(result[0].get("foo"), is(nullValue()));
  }

  @Test public void testLongValue() throws Exception {
  ...
  @Test public void testDateString() throws Exception {
  ...
  @Test public void testDateObject() throws Exception {
  ...
  @Test public void testParseInt() throws Exception {
  ...
  @Test public void testConditionalOnNulls() throws Exception {
    final String fun = "function(doc) { if (doc.foo && doc.bar) { return new Document(); }; return null; }";
    final DocumentConverter converter = new DocumentConverter(context, view(fun));
    final Document[] result = converter.convert(doc("{_id:\"hi\", foo: null, bar: null}"), settings(), null);
    assertThat(result.length, is(0));
  }
