...
public class AddressTest extends AbstractFakerTest {
  ...
  @Test public void testStreetAddressIncludeSecondary() {
    assertThat(faker.address().streetAddress(true), not(emptyString()));
  }

  @Test public void testCityWithLocaleFranceAndSeed() {
    long seed = 1L;
