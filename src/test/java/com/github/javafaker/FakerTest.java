...
@RunWith(value = Parameterized.class) public class FakerTest {
  ...
  @Parameters(name = "testing locale {0}") public static Collection<Object[]> data() {
