...
@RunWith(value = Parameterized.class) public class FakerIT {
  ...
  @Parameterized.Parameters(name = "testing locale {0} and random {1}") public static Collection<Object[]> data() {
    Object[][] data = new Object[][] { { Locale.ENGLISH, null }, { Locale.FRENCH, null }, { Locale.CANADA_FRENCH, null }, { Locale.TRADITIONAL_CHINESE, null }, { new Locale("pt"), null }, { FINNISH_LOCALE, null }, { Locale.ENGLISH, new Random() }, { null, new Random() }, { null, null } };
  ...
  @Test public void testExceptionsNotCoveredInAboveTest() throws Exception {
