 ...
 */
@RunWith(value = Parameterized.class) public class FakerIT {
  ...
  @Parameterized.Parameters(name = "testing locale {0} and random {1}") public static Collection<Object[]> data() {
    Object[][] data = new Object[][] { { Locale.ENGLISH, new Random() }, { new Locale("pt-BR"), null }, { new Locale("pt-br"), null }, { new Locale("Pt_br"), null }, { new Locale("pT_Br"), null }, { new Locale("pt", "Br", "x2"), null }, { null, new Random() }, { null, null } };
  ...
  @Test public void testAllFakerMethodsThatReturnStrings() throws Exception {
    ...
    testAllMethodsThatReturnStringsActuallyReturnStrings(faker.
<<<<<<< /usr/src/app/output/dius/java-faker/9f4a220590b2d5231b6e7b32f5d46e1e8c45ca8f/src/test/java/com/github/javafaker/integration/FakerIT.java/left.java
    military()
=======
    aquaTeenHungerForce()
>>>>>>> /usr/src/app/output/dius/java-faker/9f4a220590b2d5231b6e7b32f5d46e1e8c45ca8f/src/test/java/com/github/javafaker/integration/FakerIT.java/right.java
    );
  }

  private void testAllMethodsThatReturnStringsActuallyReturnStrings(Object object) throws Exception {
    @SuppressWarnings(value = { "unchecked" }) Set<Method> methodsThatReturnStrings = getAllMethods(object.getClass(), withModifier(Modifier.PUBLIC), withReturnType(String.class), withParametersCount(0));
  ...
  @Test public void testExceptionsNotCoveredInAboveTest() {
