...
public class NameTest extends AbstractFakerTest {
  ...
  @Test public void testNameWithMiddle() {
    assertThat(faker.name().nameWithMiddle(), matchesRegularExpression("([\\w\']+\\.?( )?){3,4}"));
  }

  @Test @Repeat(times = 10) public void testNameWithMiddleDoesNotHaveRepeatedName() {
  ...
  @Test public void testUsernameWithSpaces() {
  ...
  @Test public void testBloodGroup() {
