...
public class RebuildValidatorTest {
  ...
  /**
     ...
     *             ExecutionException
     */
  @Test public void testNoRebuildValidatorExtension() throws IOException, InterruptedException, ExecutionException {
  ...
  /**
     ...
     *             ExecutionException
     */
  @Test public void testRebuildValidatorExtensionIsApplicableTrue() throws IOException, InterruptedException, ExecutionException {
    j.getInstance().getExtensionList(RebuildValidator.class).add(0, new ValidatorAlwaysApplicable());
  ...
  /**
     ...
     *             ExecutionException
     */
  @Test public void testRebuildValidatorExtensionIsApplicableFalse() throws IOException, InterruptedException, ExecutionException {
    j.getInstance().getExtensionList(RebuildValidator.class).add(0, new ValidatorNeverApplicable());
  ...
  /**
     ...
     *             ExecutionException
     */
  @Test public void testRebuildValidatorExtensionIsApplicableTrueFalse() throws IOException, InterruptedException, ExecutionException {
    j.getInstance().getExtensionList(RebuildValidator.class).add(0, new ValidatorAlwaysApplicable());
    j.getInstance().getExtensionList(RebuildValidator.class).add(0, new ValidatorNeverApplicable());
    Project projectA = j.createFreeStyleProject("testFreeStyleC");
    Build buildA = (Build) projectA.scheduleBuild2(0, new Cause.UserIdCause(), new ParametersAction(new StringParameterValue("party", "megaparty"))).get();
  ...
  /**
     ...
     *             Exception
     */
  @Test public void testWhenProjectWithoutParamsThenRebuildProjectAvailable() throws Exception {
  ...
  /**
     ...
     *             Exception
     */
  @Test public void testWhenProjectWithNoParamsDefinedThenRebuildofBuildWithParamsShouldShowParams() throws Exception {
    System.setProperty("hudson.model.ParametersAction.keepUndefinedParameters", "true");
    FreeStyleProject project = j.createFreeStyleProject();
    project.scheduleBuild2(0, new Cause.UserIdCause(), new ParametersAction(new StringParameterValue("name", "ABC"))).get();
    HtmlPage rebuildConfigPage = j.createWebClient().getPage(project, "1/rebuild");
  ...
  /**
     ...
     *             Exception
     */
  @Test public void testAutoRebuildAsRequestParameter() throws Exception {
    FreeStyleProject project = j.createFreeStyleProject();
    project.addProperty(new ParametersDefinitionProperty(new StringParameterDefinition("name", "defaultValue")));
    project.scheduleBuild2(0, new Cause.UserIdCause(), new ParametersAction(new StringParameterValue("name", "ABC"))).get();
    HtmlPage rebuildConfigPage = j.createWebClient().getPage(project, "1/rebuild?autorebuild");
  ...
  /**
     ...
     *             Exception
     */
  @Test public void testWhenProjectWithParamsThenRebuildProjectExecutesRebuildOfLastBuild() throws Exception {
    FreeStyleProject project = j.createFreeStyleProject();
    project.addProperty(new ParametersDefinitionProperty(new StringParameterDefinition("name", "defaultValue")));
    project.scheduleBuild2(0, new Cause.UserIdCause(), new ParametersAction(new StringParameterValue("name", "test"))).get();
    HtmlPage rebuildConfigPage = j.createWebClient().getPage(project, "1/rebuild");
    ...
    assertEquals("Rebuild Last should point to the second build", "/jenkins/" + project.getUrl() + "lastCompletedBuild/rebuild", rebuildHref.getHrefAttribute());
  }
  ...
  /**
     ...
     *             Exception
     */
  @Test public void testWhenProjectWithCauseThenCauseIsCopiedAndUserIdCauseAdded() throws Exception {
    FreeStyleProject project = j.createFreeStyleProject();
    project.addProperty(new ParametersDefinitionProperty(new StringParameterDefinition("name", "defaultValue")));
    project.scheduleBuild2(0, new Cause.RemoteCause("host", "note"), new ParametersAction(new StringParameterValue("name", "test"))).get();
    HtmlPage rebuildConfigPage = j.createWebClient().getPage(project, "1/rebuild");
    j.submit(rebuildConfigPage.getFormByName("config"));
    j.createWebClient().getPage(project).getAnchorByText("Rebuild Last").click();
  ...
  /**
     ...
     *             Exception
     */
  @Test public void testWhenProjectWithChainedRebuildsThenSingleUserIdCauseAndReplayCause() throws Exception {
    FreeStyleProject project = j.createFreeStyleProject();
    project.addProperty(new ParametersDefinitionProperty(new StringParameterDefinition("name", "defaultValue")));
    project.scheduleBuild2(0, new Cause.RemoteCause("host", "note"), new ParametersAction(new StringParameterValue("name", "test"))).get();
    ...
    assertEquals("Multiple chained rebuilds should contain a single UserIdCause", 1, userIdCauseCount);
    assertEquals("Multiple chained rebuilds should contain a single RebuildCause", 1, rebuildCauseCount);
  }
  ...
  /**
     ...
     *             Exception
     */
  @Test public void testWhenProjectWithoutParamsThenRebuildProjectEnabled() throws Exception {
    FreeStyleProject project = j.createFreeStyleProject();
  ...
  /**
     ...
     *             Exception
     */
  @Test public void testWhenProjectWithoutParamsThenRebuildProjectIsDisabled() throws Exception {
    FreeStyleProject project = j.createFreeStyleProject();
    project.scheduleBuild2(0);
  ...
  public static class ValidatorNeverApplicable extends RebuildValidator {
    @Override public boolean isApplicable(AbstractBuild build) {
      return false;
    }
  }
  ...
  /**
     ...
     *             Exception
     */
  @Test public void testRebuildUnsupportedUnknownParameterValue() throws Exception {
    WebClient wc = j.createWebClient();
    FreeStyleProject project = j.createFreeStyleProject();
    project.addProperty(new ParametersDefinitionProperty(new UnsupportedUnknownParameterDefinition("param1", "defaultValue")));
    j.assertBuildStatusSuccess(project.scheduleBuild2(0, new Cause.RemoteCause("host", "note"), new ParametersAction(new UnsupportedUnknownParameterValue("param1", "value1"))));
    FreeStyleBuild build = project.getLastBuild();
    HtmlPage page = wc.getPage(build, "rebuild");
    assertTrue(page.asNormalizedText().contains("Configuration page for UnsupportedUnknownParameterValue"));
  }
  ...
  /**
     ...
     *             Exception
     */
  @Test public void testRebuildSupportedUnknownParameterValue() throws Exception {
    WebClient wc = j.createWebClient();
    FreeStyleProject project = j.createFreeStyleProject();
    project.addProperty(new ParametersDefinitionProperty(new SupportedUnknownParameterDefinition("param1", "defaultValue")));
    j.assertBuildStatusSuccess(project.scheduleBuild2(0, new Cause.RemoteCause("host", "note"), new ParametersAction(new SupportedUnknownParameterValue("param1", "value1"))));
    FreeStyleBuild build = project.getLastBuild();
    HtmlPage page = wc.getPage(build, "rebuild");
    assertTrue(page.asNormalizedText(), page.asNormalizedText().contains("This is a mark for test"));
  }

  @Test public void testRebuildDispatcherExtensionActionIsCopied() throws Exception {
    FreeStyleProject project = j.createFreeStyleProject();
    project.addProperty(new ParametersDefinitionProperty(new StringParameterDefinition("name", "defaultValue")));
    project.scheduleBuild2(0, new Cause.RemoteCause("host", "note"), new ParametersAction(new StringParameterValue("name", "test")), new RebuildDispatcherTestAction(true)).get();
    HtmlPage rebuildConfigPage = j.createWebClient().getPage(project, "1/rebuild");
    j.submit(rebuildConfigPage.getFormByName("config"));
    j.createWebClient().getPage(project).getAnchorByText("Rebuild Last").click();
    while (project.isBuilding()) {
  ...
  @Test public void testRebuildDispatcherExtensionActionIsNotCopied() throws Exception {
    FreeStyleProject project = j.createFreeStyleProject();
    project.addProperty(new ParametersDefinitionProperty(new StringParameterDefinition("name", "defaultValue")));
    project.scheduleBuild2(0, new Cause.RemoteCause("host", "note"), new ParametersAction(new StringParameterValue("name", "test")), new RebuildDispatcherTestAction(false)).get();
    HtmlPage rebuildConfigPage = j.createWebClient().getPage(project, "1/rebuild");
    j.submit(rebuildConfigPage.getFormByName("config"));
    j.createWebClient().getPage(project).getAnchorByText("Rebuild Last").click();
    while (project.isBuilding()) {
  ...
  public static class UnsupportedUnknownParameterDefinition extends StringParameterDefinition {
    ...
    @DataBoundConstructor public UnsupportedUnknownParameterDefinition(String name, String defaultValue) {
    ...
    @Override public StringParameterValue getDefaultParameterValue() {
  ...
  public static class SupportedUnknownParameterDefinition extends StringParameterDefinition {
    ...
    @DataBoundConstructor public SupportedUnknownParameterDefinition(String name, String defaultValue) {
      super(name, defaultValue);
    }
  ...
  @TestExtension public static class TestRebuildParameterProvider extends RebuildParameterProvider {
    @Override public RebuildParameterPage getRebuildPage(ParameterValue value) {
  ...
  @Extension public static class RebuildActionDispatcherTestImpl extends RebuildActionDispatcher {
    @Override public Set<Action> getPropagatingActions(Run r) {
