...
class AnyColumnTest {
  ...
  private static Object[][] testData = { { "Crystal", "Maiden", "01/02/1990", 2.0, "Female" }, { "Witch", "Doctor", "01/01/1990", 1.0, "Male" } };

  private static String[] employeeProjects1 = { null, "Testing", "Website Relaunch", null, null };

  private static String[][] employeeProjects2 = { { "Website Relaunch", "Testing", null }, { null, "Migration", "Testing" }, { "Testing", null, "Website Relaunch" }, { null, null, null }, { null, "Website Relaunch", null } };

  @Test @DisplayName(value = "Must correctly parse header row with @AnyColumn annotated column headers") void mustReadColumnHeadersOK() {
  ...
  @Test @DisplayName(value = "Must correctly parse data with @AnyColumn annotated column headers") @SuppressWarnings(value = { "unchecked" }) void mustReadDataOK() {
    Xcelite xcelite = new Xcelite(new File("src/test/resources/UPPERCASE.xlsx"));
    XceliteSheet sheet = xcelite.getSheet(0);
    SheetReader<AnyColumnBean> beanReader = sheet.getBeanReader(AnyColumnBean.class);
    Collection<AnyColumnBean> datasets = beanReader.read();
  ...
  @Test @DisplayName(value = "Must throw an exception because of multiple @AnyColumn annotations") @SuppressWarnings(value = { "unchecked" }) void mustThrowOnInvalidBean() {
  ...
  /**
     ...
     * @since 1.3
     */
  @Test @DisplayName(value = "Must correctly overwrite fields with @AnyColumn and repeated column headers") @SuppressWarnings(value = { "unchecked" }) void mustReadAnyColumnDataOkNoCollections() {
  ...
  @Test @DisplayName(value = "Must throw an exception because of @AnyColumn annotation on wrong type") @SuppressWarnings(value = { "unchecked" }) public void mustThrowOnInvalidBean2() {
    Executable testClosure = () -> {
      Xcelite xcelite = new Xcelite(new File("src/test/resources/UPPERCASE.xlsx"));
      XceliteSheet sheet = xcelite.getSheet(0);
    ...
    assertThrows(XceliteException.class, testClosure, "Should have thrown an exception" + " because of @AnyColumn annotation on `Set` member");
  }
  ...
  /**
     ...
     * @since 1.3
     */
  @Test @DisplayName(value = "Must correctly create collections for fields with @AnyColumn and repeated column headers") @SuppressWarnings(value = { "unchecked" }) void mustReadAnyColumnDataOkWithCollections() {
    XceliteOptions options = new XceliteOptions();
