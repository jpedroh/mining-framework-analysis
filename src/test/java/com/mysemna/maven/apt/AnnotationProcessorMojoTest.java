...
public class AnnotationProcessorMojoTest {
  ...
  @Before public void setUp() throws DependencyResolutionRequiredException {
  ...
  @Test public void Execute() throws MojoExecutionException {
    mojo.execute();
    EasyMock.verify(project);
    assertTrue(new File(outputDir, "com/example/QEntity.java").exists());
  }

  @Test public void Processors() throws MojoExecutionException {
  ...
  @Test public void Includes() throws MojoExecutionException {
  ...
  @Test public void Options() throws MojoExecutionException {
  ...
  @Test public void NoSources() throws MojoExecutionException {
    mojo.setIncludes(Sets.newHashSet("xxx"));
    mojo.execute();
    assertTrue(outputDir.list() == null || outputDir.list().length == 0);
  }

  @Test public void LogOnlyOnError() throws MojoExecutionException {
  ...
  @Test public void Artifacts() throws MojoExecutionException {
