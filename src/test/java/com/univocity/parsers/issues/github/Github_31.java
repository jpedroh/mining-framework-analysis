...
public class Github_31 {
  ...
  public static class AB {
    @Parsed(index = 0) private Gender a;

    @Parsed(index = 1) private Gender b;

    @EnumOptions(customElement = "code") @Parsed(index = 2, defaultNullRead = "UNSPECIFIED", defaultNullWrite = "U") private Gender c;

    @EnumOptions(customElement = "getCode") @Parsed(index = 3) private Gender d;

    public AB() {
    }
  }

  @Test public void testConversionToEnumAndBack() {
