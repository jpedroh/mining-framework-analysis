...
public class GitFlowVersionInfoTest {
  @Test public void testCreating() throws Exception {
  ...
  @Test(expected = VersionParseException.class) public void testVersionParseException() throws Exception {
    new GitFlowVersionInfo("", null);
  }

  @Test public void testIsValidVersion() throws Exception {
    Assert.assertTrue(GitFlowVersionInfo.isValidVersion("0.9"));
    Assert.assertTrue(GitFlowVersionInfo.isValidVersion("some-SNAPSHOT"));
    Assert.assertTrue(GitFlowVersionInfo.isValidVersion("0.9-RC3-feature-SNAPSHOT"));
  ...
  @Test public void testDigitsVersionInfo2() throws Exception {
  ...
  @Test public void testWithoutVersionPolicy() throws Exception {
  ...
  @Test public void testWithVersionPolicy() throws Exception {
