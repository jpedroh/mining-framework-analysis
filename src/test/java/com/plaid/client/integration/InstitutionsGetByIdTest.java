...
public class InstitutionsGetByIdTest extends AbstractIntegrationTest {
  ...
  @Test public void testSuccessWithIncludeStatusTrue() throws Exception {
    InstitutionsGetByIdRequestOptions options = new InstitutionsGetByIdRequestOptions();
  ...
  @Test public void testSuccessWithIncludeStatusFalse() throws Exception {
    InstitutionsGetByIdRequestOptions options = new InstitutionsGetByIdRequestOptions();
  ...
  @Test public void testSuccessWithIncludePaymentInitiationMetadataTrue() throws Exception {
    Response<InstitutionsGetByIdResponse> response = client().service().institutionsGetById(new InstitutionsGetByIdRequest(ROYAL_BANK_OF_PLAID_INSTITUTION_ID, Arrays.asList("GB")).withIncludePaymentInitiationMetadata(true)).execute();
    assertSuccessResponse(response);
    Institution institution = response.body().getInstitution();
  ...
  @Test public void testSuccessWithIncludePaymentInitiationMetadataFalse() throws Exception {
    Response<InstitutionsGetByIdResponse> response = client().service().institutionsGetById(new InstitutionsGetByIdRequest(ROYAL_BANK_OF_PLAID_INSTITUTION_ID, Arrays.asList("GB")).withIncludePaymentInitiationMetadata(false)).execute();
    assertSuccessResponse(response);
    Institution institution = response.body().getInstitution();
    assertIsRoyalBankOfPlaid(institution);
  ...
  private void assertIsRoyalBankOfPlaid(Institution institution) {
    ...
    assertEquals(Arrays.asList(Product.ASSETS, Product.AUTH, Product.BALANCE, Product.TRANSACTIONS, Product.IDENTITY, Product.PAYMENT_INITIATION), institution.getProducts());
  ...
  @Test public void testInvalidInstitution() throws Exception {
    ...
    Response<InstitutionsGetByIdResponse> response = client().institutionsGetById(request).execute();
    assertErrorResponse(response, Error.ErrorTypeEnum.INVALID_INPUT, "INVALID_INSTITUTION");
  }
}