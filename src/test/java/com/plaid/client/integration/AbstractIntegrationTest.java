...
public abstract class AbstractIntegrationTest {
  ...
  @Before public void setUpClient() throws Exception {
  ...
  void assertErrorResponse(Response response, Error.ErrorTypeEnum expectedErrorType, String expectedErrorCode) throws Exception {
