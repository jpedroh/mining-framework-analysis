...
public class CoreFiltersTest extends AbstractTest {
  ...
  @Test(expected = IllegalArgumentException.class) public void testSliceWithInvalidSecondArg() throws PebbleException, IOException {
    Loader<?> loader = new StringLoader();
    PebbleEngine pebble = new PebbleEngine(loader);
  ...
  @Test(expected = IllegalArgumentException.class) public void testSliceWithInvalidSecondArg2() throws PebbleException, IOException {
    Loader<?> loader = new StringLoader();
    PebbleEngine pebble = new PebbleEngine(loader);
  ...
  @Test(expected = IllegalArgumentException.class) public void testSliceWithInvalidInputType() throws PebbleException, IOException {
    Loader<?> loader = new StringLoader();
    PebbleEngine pebble = new PebbleEngine(loader);
    PebbleTemplate template = pebble.getTemplate("{{ names | slice(2,5) }}");
    Map<String, Object> context = new HashMap<>();
