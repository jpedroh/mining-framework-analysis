...
public class CoreTagsTest extends AbstractTest {
  ...
  @Test public void testBlock() throws PebbleException, IOException {
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void skipGenerationBlock() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testBlockWithStringLiteralName() throws PebbleException, IOException {
  ...
  @Test public void testIf() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test(expected = PebbleException.class) public void testExceptionWithIfStatement() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testIfThenElse() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testIfWithDirectProperty() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testIfTestAgainstNullVar() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testIfTestAgainstNullVarWithStrictVariables() throws PebbleException, IOException {
  ...
  @Test public void testFlush() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testFor() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testForWithMap() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testForSequenceNumber() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test(expected = IllegalArgumentException.class) public void testForSequenceNumberException() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testFilterTag() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testChainedFilterTag() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testForIteratingOverProperty() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testForWithNullIterable() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testForWithArray() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testForWithArrayOfPrimitives() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  /**
     ...
     * @throws PebbleException
     */
  @Test public void multipleForLoops() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testForElse() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testMacro() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void skipGenerationMacro() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  @Test(expected = RuntimeException.class) public void testMacrosWithSameName() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    PebbleTemplate template = pebble.getTemplate("{{ test() }}{% macro test(one) %}ONE{% endmacro %}{% macro test(one,two) %}TWO{% endmacro %}");
    Writer writer = new StringWriter();
    template.evaluate(writer);
    assertEquals("\t<input name=\"company\" value=\"google\" type=\"text\" />" + LINE_SEPARATOR, writer.toString());
  }

  @Test public void testMacroWithDefaultArgument() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    PebbleTemplate template = pebble.getTemplate("{{ input(name=\'country\') }}{% macro input(type=\'text\', name) %}{{ type }} {{ name }}{% endmacro %}");
    Writer writer = new StringWriter();
    template.evaluate(writer);
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testMacroInvokedTwice() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  @Test public void testFunctionInMacroInvokedTwice() throws PebbleException, IOException {
    TestingExtension extension = new TestingExtension();
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).extension(extension).build();
  ...
  @Test public void testMacroInvocationWithoutAllArguments() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    PebbleTemplate template = pebble.getTemplate("{{ test(\'1\') }}{% macro test(one,two) %}{{ one }}{{ two }}{% endmacro %}");
    Writer writer = new StringWriter();
    template.evaluate(writer);
  ...
  /**
     ...
     * @throws PebbleException
     */
  @Test public void testMacroBeingFiltered() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  @Test public void testCache() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testDisabledCache() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).cacheActive(false).build();
    String source = "{% cache \'test\' %}{% if foobar %}true{% else %}false{% endif %}{% endcache %}";
    PebbleTemplate template = pebble.getTemplate(source);
    Map<String, Object> context = new HashMap<>();
    context.put("foobar", true);
  ...
  @Test public void testCacheWithVariable() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test(expected = PebbleException.class) public void testCacheWithNoName() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testMemberCacheWithNullObject() throws PebbleException, IOException {
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testMemberCacheWithDifferingObjectTypes() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    PebbleTemplate template = pebble.getTemplate("{{ object.value }}");
  ...
  @Test public void testImportWithinBlock() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  @Test public void testImportFile() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  @Test public void testImportInChildTemplateOutsideOfBlock() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  @Test public void testDynamicImport() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  @Test public void testDynamicInclude() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  @Test(expected = PebbleException.class) public void testNonExistingMacroOrFunction() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testInclude() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testIncludeInheritance() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  @Test public void testIncludeWithinBlock() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testIncludePropagatesContext() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testIncludeOverridesBlocks() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  @Test public void testSet() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testSetInChildTemplateOutsideOfBlock() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(false).build();
  ...
  @Test public void testReSetInForLoop() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testVerbatim() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test(timeout = 300) public void testParallel() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).executorService(Executors.newCachedThreadPool()).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testParallelTagWhileEvaluationContextIsChanging() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).executorService(Executors.newCachedThreadPool()).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test(timeout = 500) public void testNestedParallel() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).executorService(Executors.newCachedThreadPool()).build();
    String source = "{% parallel %}" + "{% parallel %}{{ slowObject.fourth() }}{% endparallel %} {% parallel %}{{ slowObject.first() }}{% endparallel %} " + "{% parallel %}{{ slowObject.fourth() }}{% endparallel %} {% parallel %}{{ slowObject.first() }}{% endparallel %}" + "{% endparallel %}";
    PebbleTemplate template = pebble.getTemplate(source);
    Writer writer = new StringWriter();
    Map<String, Object> context = new HashMap<>();
    context.put("slowObject", new SlowObject());
  ...
  @Test(timeout = 300) public void testIncludeWithinParallelTag() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().strictVariables(true).executorService(Executors.newCachedThreadPool()).build();
  ...
  @Test public void testParallelWithoutExecutorService() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  /**
     ...
     * @throws IOException
     */
  @Test public void testParallelWithImport() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().executorService(Executors.newCachedThreadPool()).build();
