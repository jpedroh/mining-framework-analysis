...
public class MapSyntaxTest extends AbstractTest {
  ...
  @Test public void testMapSyntax() throws PebbleException, IOException {
  ...
  @Test public void testSimpleMap() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void test2ElementMap() throws PebbleException, IOException {
  ...
  @Test public void test2ElementMap2() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).extension(new TestingExtension()).strictVariables(false).build();
    String source = "{{ {\'key1\' :  \'value1\'   ,    \'key2\'      :       \'value2\' } | mapToString }}";
    PebbleTemplate template = pebble.getTemplate(source);
    Writer writer = new StringWriter();
  ...
  @Test public void testNElementMap() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).extension(new TestingExtension()).strictVariables(false).build();
  ...
  @Test public void testIncompleteMapSyntax() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{{ {,} }}";
  ...
  @Test public void testIncompleteMapSyntax2() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{{ {\'key\'} }}";
    thrown.expect(RuntimePebbleException.class);
    thrown.expectCause(instanceOf(ParserException.class));
  ...
  @Test public void testIncompleteMapSyntax3() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{{ {\'key\':} }}";
    thrown.expect(RuntimePebbleException.class);
    thrown.expectCause(instanceOf(ParserException.class));
  ...
  @Test public void testIncompleteMapSyntax4() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{{ {:\'value\'} }}";
    thrown.expect(RuntimePebbleException.class);
    thrown.expectCause(instanceOf(ParserException.class));
  ...
  @Test public void testIncompleteMapSyntax5() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{{ {\'key\':\'value\',} }}";
    thrown.expect(RuntimePebbleException.class);
    thrown.expectCause(instanceOf(ParserException.class));
  ...
  @SuppressWarnings(value = { "serial" }) @Test public void testMapWithExpressions() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).extension(new TestingExtension()).strictVariables(false).build();
  ...
  @SuppressWarnings(value = { "serial", "unused" }) @Test public void testMapWithComplexExpressions() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).extension(new TestingExtension()).strictVariables(false).build();
  ...
  @Test(expected = PebbleException.class) public void testAdditionOverloading() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test(expected = PebbleException.class) public void testSubtractionOverloading() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{% set map = {\'Bob\':\'Marley\'} - 1 %}{{ map }}";
    PebbleTemplate template = pebble.getTemplate(source);
    Writer writer = new StringWriter();
  ...
  @Test public void testNestedMaps() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testNestedArrayInMap() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{{ {\'array\':[]} }}";
    PebbleTemplate template = pebble.getTemplate(source);
    Writer writer = new StringWriter();
  ...
  @Test public void testBraceSyntax() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
