...
public class GetAttributeTest extends AbstractTest {
  ...
  @Test public void testMethodAttributeWhenAccessingClassWithStrictVariableOff() throws PebbleException, IOException {
  ...
  @Test(expected = ClassAccessException.class) public void testMethodAttributeWhenAccessingClassWithStrictVariableOn() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(true).build();
    PebbleTemplate template = pebble.getTemplate("hello {{ object.class }}");
    Map<String, Object> context = new HashMap<>();
    context.put("object", "some string");
  ...
  public class DynamicAttributeProviderObject implements DynamicAttributeProvider {
    ...
    @Override public boolean canProvideDynamicAttribute(Object attributeName) {
      return "name".equals(attributeName);
    }

    @Override public Object getDynamicAttribute(Object attributeName, Object[] argumentValues) {
  ...
  @Test public void testAttributeProviderSimple() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testAttributeProviderEmptyArguments() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(true).build();
    PebbleTemplate template = pebble.getTemplate("hello {{ object.name() }}");
    Map<String, Object> context = new HashMap<>();
    context.put("object", new DynamicAttributeProviderObject());
  ...
  @Test public void testAttributeProviderWithArguments() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(true).build();
