...
public class GetAttributeTest extends AbstractTest {
  ...
  @Test public void testMethodAttributeWhenAccessingClassWithStrictVariableOffAndAllowGetClass() throws PebbleException, IOException {
  ...
  @Test(expected = ClassAccessException.class) public void testMethodAttributeWhenAccessingClassWithStrictVariableOnAndAllowGetClass() throws PebbleException, IOException {
  ...
  @Test(expected = ClassAccessException.class) public void testMethodAttributeWhenAccessingGetClassWithStrictVariableOnAndAllowGetClass() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(true).allowGetClass(true).build();
  ...
  @Test(expected = ClassAccessException.class) public void testMethodAttributeWhenAccessingClassWithStrictVariableOffAndDontAllowGetClass() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).allowGetClass(false).build();
    PebbleTemplate template = pebble.getTemplate("hello {{ object.class }}");
    Map<String, Object> context = new HashMap<>();
    context.put("object", "some string");
    Writer writer = new StringWriter();
  ...
  @Test(expected = ClassAccessException.class) public void testMethodAttributeWhenAccessingGetClassWithStrictVariableOffAndDontAllowGetClass() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).allowGetClass(false).build();
    PebbleTemplate template = pebble.getTemplate("hello {{ object.getClass }}");
    Map<String, Object> context = new HashMap<>();
    context.put("object", "some string");
