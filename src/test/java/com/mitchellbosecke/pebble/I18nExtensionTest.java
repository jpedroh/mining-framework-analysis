...
public class I18nExtensionTest extends AbstractTest {
  @Test public void testSimpleLookup() throws PebbleException, IOException {
  ...
  @Test public void testMessageWithNamedArguments() throws PebbleException, IOException {
    Loader<?> loader = new StringLoader();
    PebbleEngine pebble = new PebbleEngine(loader);
    pebble.addExtension(new I18nExtension());
  ...
  @Test public void testLookupWithLocale() throws PebbleException, IOException {
    Loader<?> loader = new StringLoader();
    PebbleEngine pebble = new PebbleEngine(loader);
    pebble.addExtension(new I18nExtension());
    PebbleTemplate template = pebble.getTemplate("{{ i18n(\'testMessages\',\'greeting\') }}");
  ...
  @Test public void testLookupSpecialChar() throws PebbleException, IOException {
    Loader loader = new StringLoader();
    PebbleEngine pebble = new PebbleEngine(loader);
    pebble.addExtension(new I18nExtension());
  ...
  @Test public void testMessageWithParams() throws PebbleException, IOException {
    Loader<?> loader = new StringLoader();
    PebbleEngine pebble = new PebbleEngine(loader);
    pebble.addExtension(new I18nExtension());
