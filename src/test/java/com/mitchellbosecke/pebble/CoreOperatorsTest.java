...
public class CoreOperatorsTest extends AbstractTest {
    ...
    public void testEqualsOperatorWithNumberObjects() throws PebbleException, IOException {
        ...
        tests.add(new Pair(1.0F, "num1"));
        tests.add(new Pair(999999.0F, "num999999"));
        tests.add(new Pair(1.0, "num1"));
        tests.add(new Pair(999999.0, "num999999"));
    ...
    public void testContainsWithArrays() throws PebbleException, IOException {
        ...
        // double
        writer = new StringWriter();
        context.put("values", new double[]{ 1.0, 2.0 });
        context.put("value", new Double(1.0));
        template.evaluate(writer, context);
        assertEquals("yes", writer.toString());
        // float
        writer = new StringWriter();
