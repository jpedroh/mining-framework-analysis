...
public class CoreOperatorsTest extends AbstractTest {
  @Test public void testUnaryOperators() throws PebbleException, IOException {
  ...
  @Test public void testNotUnaryOperator() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testNotUnaryOperatorWithStrictVariables() throws PebbleException, IOException {
  ...
  @Test public void testBinaryOperators() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  /**
     ...
     */
  @Test public void testBinaryOperatorOnAttribute() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{{ 1 + item.changeInt }} " + "{{ 1 - item.changeInt }} " + "{{ 2 * item.changeInt }} " + "{{ 11 / item.changeInt }} " + "{{ 4 % item.changeInt }}";
    PebbleTemplate template = pebble.getTemplate(source);
    Map<String, Object> context = new HashMap<>();
  ...
  @Test public void testBinaryOperatorsBigDecimal() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testBinaryOperatorsBigDecimalWithDouble() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{{ number1 + number2 * number1 / number2 }}-{{number1 % number2}}";
    PebbleTemplate template = pebble.getTemplate(source);
    Writer writer = new StringWriter();
  ...
  @Test public void testBinaryOperatorsBigInteger() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{{ number1 + number2 * number1 / number2 }}-{{number1 % number2}}";
    PebbleTemplate template = pebble.getTemplate(source);
    Writer writer = new StringWriter();
  ...
  @Test public void testBinaryOperatorsBigIntegerWithLong() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{{ number1 + number2 * number1 / number2 }}-{{number1 % number2}}";
    PebbleTemplate template = pebble.getTemplate(source);
    Writer writer = new StringWriter();
  ...
  @Test public void testBinaryOperatorsShort() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{{ number1 + number2 * number1 / number2 }}-{{number1 % number2}}";
    PebbleTemplate template = pebble.getTemplate(source);
    Writer writer = new StringWriter();
  ...
  /**
     ...
     * @throws PebbleException
     */
  @Test public void testUnaryOperatorOnAttribute() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testNotUnaryOperatorOnAttribute() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testLogicOperatorOnAttributes() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{% if item.truthy and item.falsy %}yes{% else %}no{% endif %}" + "{% if item.truthy or item.falsy %}yes{% else %}no{% endif %}";
    PebbleTemplate template = pebble.getTemplate(source);
    Map<String, Object> context = new HashMap<>();
    context.put("item", new Item());
    Writer writer = new StringWriter();
  ...
  @Test public void testLogicOperatorsWithNullValues() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testLogicOperatorsWithNullValuesWithStrictVariables() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(true).build();
  ...
  @Test public void testTernary() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testComparisons() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{% if 3 > 2 %}yes{% endif %}" + "{% if 2 > 3 %}no{% endif %}" + "{% if 2 > 2 %}no{% endif %}" + "{% if 2 < 3 %}yes{% endif %}" + "{% if 3 < 2 %}no{% endif %}" + "{% if 2 < 2 %}no{% endif %}" + "{% if 3 >= 3 %}yes{% endif %}" + "{% if 3 >= 2 %}yes{% endif %}" + "{% if 2 >= 3 %}no{% endif %}" + "{% if 3 <= 3 %}yes{% endif %}" + "{% if 3 <= 2 %}no{% endif %}" + "{% if 2 <= 3 %}yes{% endif %}" + "{% if 100 <= 100 %}yes{% endif %}" + "{% if 2 == 2 %}yes{% endif %}" + "{% if 2 == 3 %}no{% endif %}";
    PebbleTemplate template = pebble.getTemplate(source);
    Writer writer = new StringWriter();
    template.evaluate(writer);
  ...
  @Test public void testComparisonsOnDifferingOperands() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testEqualsOperator() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testEqualsOperatorWithNulls() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testNotEqualsOperator() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testEqualsOperatorWithPrimitives() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) @Test public void testEqualsOperatorWithNumberObjects() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  /**
     ...
     * @throws PebbleException
     */
  @Test public void testComparisonWithAttributeOperand() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{% if item.change < 2.0 %}yes{% else %}no{% endif %}" + "{% if item.change <= 2.0 %}yes{% else %}no{% endif %}" + "{% if item.change > 2.0 %}yes{% else %}no{% endif %}" + "{% if item.change >= 2.0 %}yes{% else %}no{% endif %}";
    PebbleTemplate template = pebble.getTemplate(source);
    Map<String, Object> context = new HashMap<>();
    context.put("item", new Item());
    Writer writer = new StringWriter();
  ...
  @Test public void testComparisonWithNull() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testComparisonWithNull2() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{% if number1 > number2 %}yes{% else %}no{% endif %}";
    PebbleTemplate template = pebble.getTemplate(source);
    Map<String, Object> context = new HashMap<>();
  ...
  @Test public void testComparisonBigDecimalWithDouble() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{% if number1 > number2 %}yes{% endif %}" + "{% if number2 > number1 %}no{% endif %}" + "{% if number2 > number2 %}no{% endif %}" + "{% if number2 < number1 %}yes{% endif %}" + "{% if number1 < number2 %}no{% endif %}" + "{% if number2 < number2 %}no{% endif %}" + "{% if number1 >= number1 %}yes{% endif %}" + "{% if number1 >= number2 %}yes{% endif %}" + "{% if number2 >= number1 %}no{% endif %}" + "{% if number1 <= number1 %}yes{% endif %}" + "{% if number1 <= number2 %}no{% endif %}" + "{% if number2 <= number1 %}yes{% endif %}" + "{% if number2 <= number2 %}yes{% endif %}" + "{% if number2 == number2 %}yes{% endif %}" + "{% if number2 == number1 %}no{% endif %}";
    PebbleTemplate template = pebble.getTemplate(source);
    Map<String, Object> context = new HashMap<>();
  ...
  @Test public void testIsOperatorPrecedence() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testIsOperatorPrecedenceWithAnd() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testContainsOperator() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testContainsOperatorWithNull() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @SuppressWarnings(value = { "serial" }) @Test public void testContainsOperator2() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testContainsOperator4() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testContainsOperator5() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
    String source = "{% if names contains \'Cobra\' %}yes{% else %}no{% endif %}";
    PebbleTemplate template = pebble.getTemplate(source);
    Map<String, Object> context = new HashMap<>();
  ...
  @Test public void testContainsOperatorWithAnd() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testContainsOperatorWithOr() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testContainsOperatorWithNot() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  @Test public void testContainsWithArrays() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  /**
     ...
     */
  @Test public void testStringConcatenation() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
  ...
  /**
     ...
     */
  @Test public void testMacroSafeStringConcatenation() throws PebbleException, IOException {
    PebbleEngine pebble = new PebbleEngine.Builder().loader(new StringLoader()).strictVariables(false).build();
