...
public class StateMachineTestCase {
  @Rule public Mockery _mockery = new JUnitRuleMockery();
  ...
  @Test public void testEntryAction() {
    final Action<String, String> stateOneEntry = _mockery.mock(Action.class, "stateOneEntryAction");
    final Action<String, String> stateTwoEntry = _mockery.mock(Action.class, "stateTwoEntryAction");
    final Sequence transitions = _mockery.sequence("State transition order");
  ...
  @Test public void testLeaveAction() {
    final Action<String, String> stateOneLeave = _mockery.mock(Action.class, "stateOneLeaveAction");
    final Action<String, String> stateTwoLeave = _mockery.mock(Action.class, "stateTwoLeaveAction");
    final Sequence transitions = _mockery.sequence("State transition order");
    StateMachinePlan<String, String> builder = new StateMachinePlan<String, String>();
