...
public class ManualSmallTokenRead extends ManualPerfTestBase {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final String jsonStr = a2q("{\'data\':[true,false,null,false,null,true],\'last\':true}");
    new ManualSmallTokenRead(f, jsonStr).test("char[]", "byte[]", jsonStr.length());
  }

  @Override protected void testRead1(int reps) throws Exception {
    while (--reps >= 0) {
  ...
  @Override protected void testRead2(int reps) throws Exception {
    while (--reps >= 0) {
