...
@RunWith(value = SpringJUnit4ClassRunner.class) @ContextConfiguration(value = "/context.xml") public class ServerMainTest {
  ...
  @Before public void before() throws SmppChannelException {
    smscConfiguration = context.getBean(SmscGlobalConfiguration.class);
    SmppServerConfiguration serverConfig = context.getBean(SmppServerConfiguration.class);
  ...
  /**
     ...
     **/
  @Test public void testSubmitsAndDeliveryReceipts() throws Exception {
  ...
  /**
     ...
     **/
  @Test public void testSubmitsAndDeliveryReceipts2() throws Exception {
  ...
  /**
     * Success rate is 0
     */
  @Test public void testAlwaysFailedDelivery() throws Exception {
    SmppClient client = new SmppClient("localhost", PORT, SYSTEM_ID);
  ...
  /**
     ...
     **/
  @Test public void testFailDelivery() throws Exception {
    SmppClient client = new SmppClient("localhost", PORT, SYSTEM_ID);
  ...
  /**
     ...
     */
  @Test public void testChancedBaseSucessButDidNotFollowFormat() throws Exception {
    SmppClient client = new SmppClient("localhost", PORT, SYSTEM_ID);
    BlockingAndTallyingDeliveryReceiptSessionHandler handler = new BlockingAndTallyingDeliveryReceiptSessionHandler(smscServer.getSessionManager().getNextServerSession(), smscConfiguration);
    SmppSession session = client.connect(handler);
    int totalMessagesToSendSMSC = 20;
  ...
  /**
     ...
     */
  @Test public void testChancedDelivery() throws Exception {
    SmppClient client = new SmppClient("localhost", PORT, SYSTEM_ID);
...
<<<<<<< /usr/src/app/output/mavocz/smscsim/8bfb11d2761aacc461674c06d3df511961252c0b/src/test/java/net/voldrich/smscsim/ServerMainTest.java/left.java
  public static class BlockingAndTallyingDeliveryReceiptSessionHandler extends SmscSmppSessionHandler {
    ...
    @Override public PduResponse firePduRequestReceived(PduRequest pduRequest) {
...
>>>>>>> /usr/src/app/output/mavocz/smscsim/8bfb11d2761aacc461674c06d3df511961252c0b/src/test/java/net/voldrich/smscsim/ServerMainTest.java/right.java
  ...
  public static class BlockingSmppSessionHandler extends DefaultSmppSessionHandler {
    ...
    @Override public void firePduRequestExpired(PduRequest pduRequest) {
