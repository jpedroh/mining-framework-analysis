...
public class TrendsTest {
  @Test public void addBuild_AddsNewResultAtTheLastPosition() {
  ...
  @Test public void limitItems_ReducesNumberOfItems() {
    final int limit = 1;
  ...
  @Test public void copyLastElements_OnBigLimit_ReturnsPassedIntArray() {
  ...
  @Test public void copyLastElements_OnBigLimit_ReturnsPassedLongArray() {
  ...
  @Test public void copyLastElements_OnBigLimit_ReturnsPassedStringArray() {
