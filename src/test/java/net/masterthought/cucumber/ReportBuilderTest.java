...
public class ReportBuilderTest extends ReportGenerator {
  ...
  @Test public void generatePages_CallsPreparePageContextOverPassedPages() {
    ...
    AbstractPage page = new AbstractPage("testpage.vm") {
      ...
      @Override public void preparePageContext(VelocityContext context, Configuration configuration, ReportResult reportResult) {
        counter.increment();
      }
    };
