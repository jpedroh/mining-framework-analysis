...
public class ReportableBuilder implements Reportable {
  ...
  public ReportableBuilder(int passedFeatures, int failedFeatures, int totalFeatures, int passedScenarios, int failedScenarios, int totalScenarios, int passedSteps, int failedSteps, int skippedSteps, int pendingSteps, int undefinedSteps, int totalSteps, long duration) {
