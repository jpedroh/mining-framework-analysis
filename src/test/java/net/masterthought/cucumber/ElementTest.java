...
public class ElementTest {
  ...
  @Before public void setUpJsonReports() throws IOException {
  ...
  @Test public void shouldReturnSteps() {
    assertThat(passingElement.getSteps()[0], isA(Step.class));
  }

  @Test public void shouldReturnStatus() {
  ...
  @Test public void shouldReturnNameWhenConfigSkippedTurnedOn() {
  ...
  @Test public void shouldReturnNameWhenConfiUndefinedTurnedOn() {
    ConfigurationOptions configuration = ConfigurationOptions.instance();
  ...
  @Test public void shouldReturnKeyword() {
    assertThat(passingElement.getKeyword(), is("Background"));
  }

  @Test public void shouldReturnType() {
    assertThat(passingElement.getType(), is("background"));
  }

  @Test public void shouldReturnTagList() {
  ...
  @Test public void shouldKnowIfHasTags() {
    assertThat(taggedElement.hasTags(), is(true));
  }

  @Test public void shouldReturnTagsAsHtml() {
