...
public class FeatureReportPageIntegrationTest extends PageTest {
  ...
  @Test public void generatePage_addsCustomJsFiles() {
    setUpWithJson(SAMPLE_JSON);
    final Feature feature = features.get(0);
  ...
  @Test public void generatePage_addsCustomCssFiles() {
    setUpWithJson(SAMPLE_JSON);
    final Feature feature = features.get(0);
  ...
  @Test public void generatePage_generatesFeatureDetails() {
    setUpWithJson(SAMPLE_JSON);
    final Feature feature = features.get(0);
    page = new FeatureReportPage(reportResult, configuration, feature);
    page.generatePage();
  ...
  @Test public void generatePage_generatesScenarioDetails() {
    setUpWithJson(SAMPLE_JSON);
    final Feature feature = features.get(0);
    page = new FeatureReportPage(reportResult, configuration, feature);
    page.generatePage();
  ...
  @Test public void generatePage_generatesHooks() {
    setUpWithJson(SAMPLE_JSON);
  ...
  @Test public void generatePage_OnBiDimentionalArray_generatesOutput() {
    setUpWithJson(SAMPLE_JSON);
    final Feature feature = features.get(1);
    page = new FeatureReportPage(reportResult, configuration, feature);
    page.generatePage();
  ...
  @Test public void generatePage_OnSingleArray_generatesOutput() {
    setUpWithJson(SAMPLE_JSON);
    final Feature feature = features.get(1);
    page = new FeatureReportPage(reportResult, configuration, feature);
    page.generatePage();
  ...
  @Test public void generatePage_generatesArguments() {
    setUpWithJson(SAMPLE_JSON);
    final Feature feature = features.get(0);
    page = new FeatureReportPage(reportResult, configuration, feature);
    page.generatePage();
  ...
  @Test public void generatePage_generatesDocString() {
    setUpWithJson(SAMPLE_JSON);
    final Feature feature = features.get(0);
    page = new FeatureReportPage(reportResult, configuration, feature);
    page.generatePage();
  ...
  @Test public void generatePage_ForAfterElementHook_generatesOutputs() {
    setUpWithJson(SAMPLE_JSON);
    final Feature feature = features.get(1);
    page = new FeatureReportPage(reportResult, configuration, feature);
    page.generatePage();
