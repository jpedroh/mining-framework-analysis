...
public class TagsOverviewPageIntegrationTest extends PageTest {
  ...
  @Test public void generatePage_generatesStatsTableHeader() {
    ...
    secondRow.hasExactValues("Tag", "Passed", "Failed", "Skipped", "Pending", "Undefined", "Total", "Passed", "Failed", "Total", "Duration", "Status");
  }
  ...
  @Test public void generatePage_generatesStatsTableFooter() {
    ...
    footerRows[0].hasExactValues("", "22", "1", "2", "1", "2", "28", "3", "1", "4", "509ms", "3");
