...
public class TagsOverviewPageIntegrationTest extends PageTest {
  @Test public void generatePage_generatesTitle() {
    ...
    final String titleValue = String.format("Cucumber-JVM Html Reports  - Tags Overview", configuration.getBuildNumber());
    page.generatePage();
  ...
  @Test public void generatePage_generatesStatsTableHeader() {
    ...
    secondRow.hasExactValues("Tag", "Total", "Passed", "Failed", "Total", "Passed", "Failed", "Skipped", "Pending", "Undefined", "Missing", "Duration", "Status");
  }
