...
public class FeaturesOverviewPageIntegrationTest extends PageTest {
  @Test public void generatePage_generatesTitle() {
    ...
    final String titleValue = String.format("Cucumber-JVM Html Reports (no %s) - Features Overview", configuration.getBuildNumber());
    page.generatePage();
  ...
  @Test public void generatePage_generatesStatsTableHeader() {
    ...
    secondRow.hasExactValues("Feature", "Total", "Passed", "Failed", "Total", "Passed", "Failed", "Skipped", "Pending", "Undefined", "Missing", "Duration", "Status");
  }
  ...
  @Test public void generatePage_generatesStatsTableBody() {
    ...
    firstRow.hasExactValues("1st feature", "1", "1", "0", "10", "7", "0", "0", "2", "1", "0", "1m 39s 343 ms", "Passed");
  ...
  @Test public void generatePage_onEmptyJsons_generatesProperMessage() {
