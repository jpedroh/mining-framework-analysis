...
public class FeaturesOverviewPageIntegrationTest extends PageTest {
  @Test public void generatePage_generatesTitle() {
    ...
    final String titleValue = String.format("Cucumber Reports (no %s) - Features Overview", configuration.getBuildNumber());
    page.generatePage();
  ...
  @Test public void generatePage_generatesClassifications() {
  ...
  @Test public void generatePage_generatesStatsTableHeader() {
    setUpWithJson(SAMPLE_JSON);
    page = new FeaturesOverviewPage(reportResult, configuration);
    page.generatePage();
    DocumentAssertion document = documentFrom(page.getWebPage());
    ...
    secondRow.hasExactValues("Feature", "Passed", "Failed", "Skipped", "Pending", "Undefined", "Total", "Passed", "Failed", "Pending", "Undefined", "Total", "Duration", "Status");
  }
  ...
  @Test public void generatePage_generatesStatsTableBody() {
    ...
    firstRow.hasExactValues("1st feature", "10", "0", "0", "0", "0", "10", "1", "0", "0", "0", "1", "1:39.263", "Passed");
    ...
    secondRow.hasExactValues("Second feature", "5", "1", "2", "1", "3", "12", "1", "1", "0", "1", "3", "0.092", "Failed");
    secondRow.hasExactCSSClasses("tagname", "passed", "failed", "skipped", "pending", "undefined", "total", "passed", "failed", "", "undefined", "total", "duration", "failed");
  ...
  @Test public void generatePage_generatesStatsTableFooter() {
    setUpWithJson(SAMPLE_JSON);
    page = new FeaturesOverviewPage(reportResult, configuration);
    page.generatePage();
    DocumentAssertion document = documentFrom(page.getWebPage());
    ...
    footerRows[0].hasExactValues("", "15", "1", "2", "1", "3", "22", "2", "1", "0", "1", "4", "1:39.355", "2");
    footerRows[1].hasExactValues("", "68.18%", "4.55%", "9.09%", "4.55%", "13.64%", "", "50.00%", "25.00%", "0.00%", "25.00%", "", "", "50.00%");
  }
}