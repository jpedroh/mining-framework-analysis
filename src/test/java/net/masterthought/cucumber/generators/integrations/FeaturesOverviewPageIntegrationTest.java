...
public class FeaturesOverviewPageIntegrationTest extends PageTest {
  ...
  @Test public void generatePage_generatesStatsTableBody() {
    ...
    secondRow.hasExactValues("Second feature", "5", "1", "2", "1", "3", "12", "1", "0", "0", "2", "3", "0.092", "Failed");
  ...
  @Test public void generatePage_generatesStatsTableFooter() {
    ...
    footerRows[0].hasExactValues("", "15", "1", "2", "1", "3", "22", "2", "2", "4", 
...
>>>>>>> /usr/src/app/output/masterthought/cucumber-reporting/c502aa0ba26acc0f5ba914f6a8c9eb3b9de6a189/src/test/java/net/masterthought/cucumber/generators/integrations/FeaturesOverviewPageIntegrationTest.java/right.java
    ...
    footerRows[1].hasExactValues("", "68.18%", "4.55%", "9.09%", "4.55%", "13.64%", "", "50.00%", "50.00%", "0.00%", "0.00%", "", "", "50.00%");
  }
}