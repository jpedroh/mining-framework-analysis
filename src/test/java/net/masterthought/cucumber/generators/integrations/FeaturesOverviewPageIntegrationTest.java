...
public class FeaturesOverviewPageIntegrationTest extends PageTest {
    ...
    public void generatePage_generatesClassifications() {
        // given
        final String[] names = new java.lang.String[]{ "Platform", "Browser", "Branch", "Repository" };
        final String[] values = new java.lang.String[]{ "Win", "Opera", "master", "<a href=\"example.com\" rel=\"nofollow noopener noreferrer\">Example Repository</a>" };
        setUpWithJson(SAMPLE_JSON);
    ...
    public void generatePage_generatesStatsTableBody() {
        ...
        secondRow.hasExactValues("Second feature", "5", "1", "2", "1", "3", "12", "1", "2", "0", "0", "3", "0.092", "Failed");
    ...
    public void generatePage_generatesStatsTableFooter() {
        ...
        footerRows[0].hasExactValues("", "15", "1", "2", "1", "3", "22", "2", "2", "0", "0", "4", "1:39.355", "2");
