...
public class ElementTest extends PageTest {
  ...
  @Test public void getSteps_ReturnsSteps() {
  ...
  @Test public void getBefore_ReturnsHooks() {
  ...
  @Test public void getAfter_ReturnsHooks() {
    Element element = features.get(1).getElements()[0];
  ...
  @Test public void getBeforeStatus_ReturnsStatus() {
    Element element = features.get(1).getElements()[0];
    Status status = element.getBeforeStatus();
    assertThat(status).isEqualTo(Status.FAILED);
  }

  @Test public void getBeforeStatus_OnNoExistingBefore_ReturnsStatus() {
  ...
  @Test public void getAfterStatus_ReturnsStatus() {
    Element element = features.get(1).getElements()[0];
    Status status = element.getAfterStatus();
    assertThat(status).isEqualTo(Status.UNDEFINED);
  }

  @Test public void getAfterStatus_OnNoExistingBefore_ReturnsStatus() {
    Element element = features.get(0).getElements()[0];
    Status status = element.getAfterStatus();
  ...
  @Test public void getStepsStatus_ReturnsStatus() {
    Element element = features.get(1).getElements()[0];
  ...
  @Test public void getKeyword_ReturnsName() {
    Element element = features.get(0).getElements()[0];
    String keyword = element.getKeyword();
    assertThat(keyword).isEqualTo("Background");
  }

  @Test public void getType_ReturnsName() {
    Element element = features.get(1).getElements()[0];
  ...
  @Test public void getDescription_OnMissingDescription_ReturnsEmptyString() {
    Element element = features.get(1).getElements()[1];
    String description = element.getDescription();
    assertThat(description).isEmpty();
  }

  @Test public void isScenario_ReturnsTrueForScenarios() {
    Feature feature = features.get(0);
    boolean[] results = { feature.getElements()[0].isScenario(), feature.getElements()[1].isScenario() };
    assertThat(results).containsOnly(false, true);
  }

  @Test public void getFeature_ReturnsFeature() {
    Element element = features.get(0).getElements()[0];
