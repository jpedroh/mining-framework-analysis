...
public class SimpleServerAndClientTest {
  ...
  @Test public void test() throws IOException, TimeoutException, InterruptedException {
    for ( ; ; ) {
      ...
      try (EventLoop eg = new EventGroup(true)) {
        ...
        try (TcpChannelHub tcpChannelHub = createClient(eg, desc)) {
          ...
          tcpChannelHub.lock2(() -> tcpChannelHub.writeSocket(wire, true), true, TryLock.TRY_LOCK_WARN);
          try {
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @NotNull private TcpChannelHub createClient(EventLoop eg, String desc) {
  ...
  @NotNull private Function<NetworkContext, TcpEventHandler> handlerFactory() {
