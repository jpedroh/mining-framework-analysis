...
@SuppressWarnings(value = { "rawtypes" }) @RunWith(value = Parameterized.class) public class BytesTest extends BytesTestCommon {
  ...
  @Parameterized.Parameters(name = "{0}") public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][] { { "Native", NATIVE }, { "Heap", HEAP }, { "Heap ByteBuffer", BYTE_BUFFER }, { "Native Unchecked", NATIVE_UNCHECKED }, { "Heap Unchecked", HEAP_UNCHECKED }, { "Heap Embedded", HEAP_EMBEDDED } });
  }

  @Test public void throwExceptionIfReleased() {
  ...
  @Test public void testName() throws IORuntimeException {
  ...
  @Test public void readUnsignedByte() {
    Bytes<?> bytes = alloc1.fixedBytes(30);
    try {
  ...
  @Test public void writeHistogram() {
  ...
  @Test public void internRegressionTest() throws IORuntimeException {
  ...
  @Test public void testEqualBytesWithSecondStoreBeingLonger() throws IORuntimeException {
  ...
  @Test public void testStopBitDouble() throws IORuntimeException {
  ...
  @Test public void testParseUtf8() {
  ...
  @Test(expected = BufferOverflowException.class) public void testPartialWriteArray() {
  ...
  @Test public void testPartialWriteBB() {
  ...
  @Test public void testReadIncompleteLong() throws IllegalStateException, BufferOverflowException, BufferUnderflowException {
    assumeFalse(NativeBytes.areNewGuarded());
    Bytes bytes = alloc1.elasticBytes(16);
    ...
    try {
      ...
      for (int i = 0; i <= 7; i++) {
        assertEquals("i: " + i, Long.toHexString(0x0B0A090807060504L >>> (i * 8)), Long.toHexString(bytes.readPositionRemaining(4 + i, 8 - i).readIncompleteLong()));
      }
  ...
  @Test public void testUnwrite() throws IllegalArgumentException, BufferOverflowException, IllegalStateException, BufferUnderflowException {
    assumeFalse(NativeBytes.areNewGuarded());
    Bytes bytes = alloc1.elasticBytes(1);
    try {
      for (int i = 0; i < 26; i++) {
  ...
  @Test(expected = BufferOverflowException.class) public void testExpectNegativeOffsetAbsoluteWriteOnElasticBytesThrowsBufferOverflowException() throws BufferOverflowException, IllegalStateException {
  ...
  @Test(expected = BufferOverflowException.class) public void testExpectNegativeOffsetAbsoluteWriteOnElasticBytesOfInsufficientCapacityThrowsBufferOverflowException() throws IllegalStateException, BufferOverflowException {
    Bytes<?> bytes = alloc1.elasticBytes(1);
    try {
      if (bytes.unchecked()) {
        throw new BufferOverflowException();
  ...
  @Test(expected = BufferOverflowException.class) public void testExpectNegativeOffsetAbsoluteWriteOnFixedBytesThrowsBufferOverflowException() {
  ...
  @Test(expected = BufferOverflowException.class) public void testExpectNegativeOffsetAbsoluteWriteOnFixedBytesOfInsufficientCapacityThrowsBufferOverflowException() {
  ...
  @Test public void testWriter() throws IllegalStateException {
    assumeFalse(NativeBytes.areNewGuarded());
    Bytes bytes = alloc1.elasticBytes(1);
    ...
    try (Scanner scan = new Scanner(bytes.reader())) {
  ...
  @Test public void testParseUtf8High() throws BufferUnderflowException, BufferOverflowException, IllegalStateException {
    assumeFalse(NativeBytes.areNewGuarded());
    assumeFalse(alloc1 == HEAP_EMBEDDED);
  ...
  @Test public void testBigDecimalBinary() throws BufferUnderflowException, ArithmeticException {
  ...
  @Test public void testBigDecimalText() {
    assumeFalse(alloc1 == HEAP_EMBEDDED);
    for (double d : new double[] { 1.0, 1000.0, 0.1 }) {
  ...
  @Test public void testAppendBase() {
    @NotNull Bytes b = alloc1.elasticBytes(16);
  ...
  @Test public void testAppendBase16() {
    @NotNull Bytes b = alloc1.elasticBytes(16);
    for (long value : new long[] { Long.MIN_VALUE, Integer.MIN_VALUE, -1, 0, 1, Integer.MAX_VALUE, Long.MAX_VALUE }) {
  ...
  @Test(expected = IllegalStateException.class) public void testMove2() {
    @NotNull Bytes b = alloc1.elasticBytes(16);
    b.append("0123456789");
    b.move(3, 1, 3);
  ...
  @Test public void testMoveBackward() {
    @NotNull Bytes b = alloc1.elasticBytes(16);
    b.append("0123456789abcdefg");
    b.move(3, 1, 10);
  ...
  @Test(expected = IllegalStateException.class) public void testMove2B() {
    @NotNull Bytes b = alloc1.elasticBytes(16);
    b.append("Hello World");
  ...
  @Test public void testReadPosition() {
    @NotNull Bytes b = alloc1.elasticBytes(16);
    try {
      b.readPosition(17);
  ...
  @Test public void testReadPositionTooSmall() {
    @NotNull Bytes b = alloc1.elasticBytes(16);
    try {
      b.readPosition(-1);
      assertTrue(b.unchecked());
  ...
  @Test public void testReadLimit() {
    @NotNull Bytes b = alloc1.elasticBytes(16);
    try {
  ...
  @Test public void testReadLimitTooSmall() {
    @NotNull Bytes b = alloc1.elasticBytes(16);
    try {
  ...
  @Test public void uncheckedSkip() {
    assumeFalse(NativeBytes.areNewGuarded());
    @NotNull Bytes b = alloc1.elasticBytes(16);
    try {
  ...
  @Test public void testDateTimeMillis() {
    @NotNull Bytes b = alloc1.elasticBytes(16);
    try {
  ...
  @Test public void testWriteOffset() {
    int length = 127;
  ...
  @Test public void testToStringDoesNotChange() {
  ...
  @Test public void testParseDoubleReadLimit() {
  ...
  @Test public void write8BitString() {
    assumeFalse(alloc1 == HEAP_EMBEDDED);
  ...
  @Test public void write8BitNativeBytes() {
    assumeFalse(alloc1 == HEAP_EMBEDDED);
    @NotNull Bytes bytes = alloc1.elasticBytes(703);
  ...
  @Test public void write8BitHeapBytes() {
    assumeFalse(alloc1 == HEAP_EMBEDDED);
    @NotNull Bytes bytes = alloc1.elasticBytes(703);
  ...
  @Test public void write8BitCharSequence() {
    assumeFalse(alloc1 == HEAP_EMBEDDED);
    @NotNull Bytes bytes = alloc1.elasticBytes(703);
    StringBuilder sb = new StringBuilder();
  ...
  @Ignore(value = "https://github.com/OpenHFT/Chronicle-Bytes/issues/185") @Test public void capacityVsWriteLimitInvariant() {
    final Bytes<?> bytes = alloc1.elasticBytes(20);
    assertEquals(bytes.capacity(), bytes.writeLimit());
  }

  @Test public void stopBitChar() {
  ...
  @Ignore(value = "https://github.com/OpenHFT/Chronicle-Bytes/issues/185") @Test public void isClear() {
    final Bytes<?> bytes = alloc1.elasticBytes(20);
    assertTrue(bytes.isClear());
  }

  @Test public void stopBitLong() {
    final Bytes bytes = alloc1.fixedBytes(64);
    for (int i = 0; i <= 63; i++) {
      long l = 1L << i;
