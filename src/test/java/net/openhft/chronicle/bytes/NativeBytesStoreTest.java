...
public class NativeBytesStoreTest extends BytesTestCommon {
  ...
  @Test public void issue176StopBits() {
    final int stepLength = 23;
  ...
  @Test public void testCipherPerf() throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
  ...
  @Test public void testCipher() throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
  ...
  @Test public void testElasticByteBuffer() throws IORuntimeException, BufferOverflowException {
  ...
  @Test public void testAppendUtf8() {
  ...
  @Test public void testToTempByteBuf() {
    final String hi = "Hello World";
    final char[] chars = hi.toCharArray();
  ...
  @Test public void perfCheckSum() throws IORuntimeException {
    final NativeBytesStore<?>[] nbs = { NativeBytesStore.nativeStoreWithFixedCapacity(140), NativeBytesStore.nativeStoreWithFixedCapacity(149), NativeBytesStore.nativeStoreWithFixedCapacity(159), NativeBytesStore.nativeStoreWithFixedCapacity(194) };
    try {
      ...
      Stream.of(nbs).forEach(NativeBytesStore::releaseLast);
    }
  }
...
<<<<<<< /usr/src/app/output/openhft/chronicle-bytes/0fb20d3a4773a4519123121ef3a61befde10ea33/src/test/java/net/openhft/chronicle/bytes/NativeBytesStoreTest.java/left.java
      assertEquals(src.toString(), dst.toString())
=======
      assertTrue(BytesInternal.contentEqual(src, dst))
>>>>>>> /usr/src/app/output/openhft/chronicle-bytes/0fb20d3a4773a4519123121ef3a61befde10ea33/src/test/java/net/openhft/chronicle/bytes/NativeBytesStoreTest.java/right.java
      ;
    }  finally {
      src.releaseLast();
      dst.releaseLast();
  ...
  @SuppressWarnings(value = { "rawtypes" }) @Test public void testEquals() {
