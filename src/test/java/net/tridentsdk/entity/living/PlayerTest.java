...
public class PlayerTest {
  @Test public void testSendMessageDefault() {
  ...
  @Data private final class SentMessage {
    private final ChatComponent message;

    private final ChatType type;
  }

  @AllArgsConstructor private final class DummyPlayer implements Player {
    ...
    @Override public void sendMessage(ChatComponent message, ChatType type) {
      this.sentMessages.add(new SentMessage(message, type));
    }

    @Override public void kick(ChatComponent reason) {
    }
    ...
    @Override public TabList getTabList() {
      return null;
    }
    ...
    @Override public PlayerMeta getMetadata() {
      return null;
    }

    @Override public Collection<BossBar> getBossBars() {
      return null;
    }

    @Override public void addBossBar(BossBar bar) {
    }

    @Override public void removeBossBar(BossBar bar) {
    }

    @Override public void updateBossBars() {
    }
  }
}