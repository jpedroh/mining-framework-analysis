...
<<<<<<< /usr/src/app/output/projectblueshift/blueshiftapi/b53a148ca59225dcbceb1fc65321f98a0c5c13f9/src/test/java/net/tridentsdk/base/PositionTest.java/left.java
        ...
        assertEquals(p0.intX() / 16, p0.getChunkX());
        assertEquals(p0.intZ() / 16, p0.getChunkZ());
||||||| /usr/src/app/output/projectblueshift/blueshiftapi/b53a148ca59225dcbceb1fc65321f98a0c5c13f9/src/test/java/net/tridentsdk/base/PositionTest.java/base.java
        assertEquals(p0.intX() / 16, p0.getChunkX());
        assertEquals(p0.intZ() / 16, p0.getChunkZ());
=======
        assertEquals(p0.getIntX() / 16, p0.getChunkX());
        assertEquals(p0.getIntZ() / 16, p0.getChunkZ());
>>>>>>> /usr/src/app/output/projectblueshift/blueshiftapi/b53a148ca59225dcbceb1fc65321f98a0c5c13f9/src/test/java/net/tridentsdk/base/PositionTest.java/right.java
    }
    ...
    public void testToWorldVec() {
        Position p = new Position(this.world);
