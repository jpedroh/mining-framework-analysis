...
@DisplayName(value = "APRS Packet Tests") public class APRSPacketTests {
  @Nested @DisplayName(value = "Given an empty APRS packet") public class GivenEmptyAPRSPacket {
    ...
    @Nested @DisplayName(value = "When questioned") public class WhenQuestioned {
      @Test @DisplayName(value = "Then it should have no fault") public void thenHasNoFault() {
        System.out.println("Success!");
        assertFalse(packet.hasFault());
      }

      @Test @DisplayName(value = "Then it should have one TCPIP digipeater") public void thenHasOneDigipeater() {
        List<Digipeater> digipeaters = packet.getDigipeaters();
        assertEquals(1, digipeaters.size());
      }

      @Test @DisplayName(value = "Then it should have a correct lattitude and longitude") public void thenHasPosition() {
