...
@RunWith(value = PowerMockRunner.class) @PrepareForTest(value = Logback11Support.class) public class LogstashEncoderTest {
  ...
  @Test public void replaceCharsDecorator() throws Exception {
  ...
  @Test public void replaceCharsDecoratorConfigurationOptions() throws Exception {
  ...
  @Test public void customDecorators() throws Exception {
    ...
    encoder.setJsonFactoryDecorator(new JsonFactoryDecorator() {
      @Override public MappingJsonFactory decorate(MappingJsonFactory factory) {
