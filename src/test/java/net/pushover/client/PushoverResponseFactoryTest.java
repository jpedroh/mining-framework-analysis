...
public class PushoverResponseFactoryTest {
  ...
  @Test(expected = IOException.class) public void testNullStausResponse() throws Exception {
    assertNull(PushoverResponseFactory.createStatus(null));
  }

  @Test(expected = IOException.class) public void testNullEntityStatusResponse() throws Exception {
    assertNull(PushoverResponseFactory.createStatus(response));
  }

  @Test(expected = IOException.class) public void testMalformedStatusResponse() throws IOException {
    when(response.getEntity()).thenReturn(new StringEntity("{"));
    PushoverResponseFactory.createStatus(response);
  }

  @Test public void testEmptyStatus() throws IOException {
    when(response.getEntity()).thenReturn(new StringEntity("{}"));
    Status status = PushoverResponseFactory.createStatus(response);
    assertNotNull(status);
  }

  @Test public void testOKStatus() throws IOException {
  ...
  @Test public void testOKVerification() throws IOException {
    final String expectedRequestId = "1234";
  ...
  @Test public void testOKResponse() throws IOException {
    final String expectedRequestId = "1234";
    final int expectedRemaining = 4321;
    when(response.getEntity()).thenReturn(new StringEntity("{\"status\":1, \"request\":\"" + expectedRequestId + "\"}"));
    when(response.getFirstHeader(PushoverResponseFactory.REQUEST_REMAINING_HEADER)).thenReturn(new BasicHeader(PushoverResponseFactory.REQUEST_REMAINING_HEADER, String.valueOf(expectedRemaining)));
  ...
  @Test public void testFailedVerification() throws IOException {
    final String expectedRequestId = "1234";
    final List<String> expectedDevices = new ArrayList<String>() {
      {
        add("requesteddevice");
  ...
  @Test public void testOKEmergencyResponse() throws IOException {
    final String expectedRequestId = "1234";
  ...
  @Test public void testCreateSoundResponse() throws IOException {
  ...
  @Test(expected = IOException.class) public void testMalformedCreateSoundResponse() throws IOException {
    when(response.getEntity()).thenReturn(new StringEntity("{"));
    PushoverResponseFactory.createSoundSet(response);
  }

  @Test public void testEmptyCreateSoundResponse() throws IOException {
    when(response.getEntity()).thenReturn(new StringEntity("{}"));
    final Set<PushOverSound> sounds = PushoverResponseFactory.createSoundSet(response);
    assertNotNull(sounds);
  ...
  @Test(expected = IOException.class) public void testNullCreateSoundResponse() throws Exception {
    assertNull(PushoverResponseFactory.createSoundSet(null));
  }

  @Test(expected = IOException.class) public void testNullEntityCreateSoundResponse() throws Exception {
