...
public class ComponentTest {
  ...
  @Before public void setup() throws RestException, IOException, URISyntaxException {
  ...
  @Test public void getLead() throws Exception {
    assertEquals("fred", component.getLead().getName());
  }

  @Test public void updateComponent() throws Exception {
    ...
    component.update().name("New Component 1").description("New Description").leadUserName("marcello").assigneeType("COMPONENT_LEAD").execute();
