...
public class BasicFunctionalityUnitTests {
  ...
  @Test public void testAnythingBut() {
    VerbalExpression testRegex = new VerbalExpression.Builder().startOfLine().anythingButNot("w").build();
  ...
  @Test public void testSearchOneLine() {
    VerbalExpression testRegex = new VerbalExpression.Builder().startOfLine().then("a").br().then("b").endOfLine().build();
  ...
  @Test public void testGetText() {
    ...
    VerbalExpression testRegex = new VerbalExpression().add("http").maybe("s").then("://").then("www.").anythingBut(" ").add("com");
