...
@RunWith(value = PowerMockRunner.class) @PrepareForTest(value = { Secret.class, CredentialsMatchers.class, CredentialsProvider.class }) public class WebServiceFactoryTest {
  private CIMInstance cimInstance = new CIMInstanceBuilder().withName("test").withHost("cim-host").withPort(8080).withUseSSL(false).withDefaultCredentialId().build();
  ...
  @Test public void getDefectService_returns_DefectService_instance() throws IOException {
  ...
  @Test public void getDefectService_returns_same_instance() throws IOException {
    WebServiceFactory factory = new TestWebServiceFactory();
    DefectService result = factory.getDefectService(cimInstance);
    Assert.assertNotNull(result);
  ...
  @Test public void getDefectService_returns_new_instance() throws IOException {
    WebServiceFactory factory = new TestWebServiceFactory();
    DefectService result = factory.getDefectService(cimInstance);
    Assert.assertNotNull(result);
    CredentialUtil.setCredentialManager("test-user", "password");
    cimInstance = new CIMInstanceBuilder().withName("test instance 2").withHost("other-cim-host").withPort(8443).withUseSSL(true).withDefaultCredentialId().build();
    DefectService result2 = factory.getDefectService(cimInstance);
  ...
  @Test public void getConfigurationService_returns_ConfigurationService_instance() throws IOException {
    WebServiceFactory factory = new TestWebServiceFactory();
  ...
  @Test public void getConfigurationService_returns_same_instance() throws IOException {
    WebServiceFactory factory = new TestWebServiceFactory();
    ConfigurationService result = factory.getConfigurationService(cimInstance);
    Assert.assertNotNull(result);
  ...
  @Test public void getConfigurationService_returns_new_instance() throws IOException {
    WebServiceFactory factory = new TestWebServiceFactory();
    ConfigurationService result = factory.getConfigurationService(cimInstance);
    Assert.assertNotNull(result);
    CredentialUtil.setCredentialManager("test-user", "password");
