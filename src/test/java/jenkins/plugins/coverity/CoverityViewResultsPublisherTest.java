...
@RunWith(value = PowerMockRunner.class) @PrepareForTest(value = { Jenkins.class, WebServiceFactory.class, Client.class }) public class CoverityViewResultsPublisherTest {
  ...
  @Test public void perform_unknownInstance_logsError() throws IOException, InterruptedException {
  ...
  @Test public void perform_emptyProject_logsError() throws IOException, InterruptedException {
  ...
  @Test public void perform_nullView_logsError() throws IOException, InterruptedException {
    final String instance = cimInstance.getName();
    final String projectId = "my projectId";
  ...
  @Test public void perform_unstablePipeline_withIssues() throws IOException, InterruptedException {
    ...
    publisher.perform(run, workspace, launcher, listener);
    consoleLogger.verifyMessages(getInformationMessage(instance, projectId, view), getRetrievingMessage(projectId, view), getIssueCountMessage(20, projectId, view), expectedUrlMessage, expectedFinishedMessage);
    verify(run).setResult(Result.UNSTABLE);
  }

  @Test public void perform_handlesError_failsPipeline() throws IOException, InterruptedException {
    final String instance = cimInstance.getName();
    final String projectId = "projectId";
    final String view = "view";
  ...
  @Test public void perform_handles400Error_logsMessage_failsPipeline() throws IOException, InterruptedException {
    final String instance = cimInstance.getName();
    final String projectId = "projectId";
