...
public class CovImportMsvscaCommandTest extends CommandTestBase {
  @Test public void addMsvscaOutputFilesTest() throws IOException, InterruptedException {
...
=======
  @Test public void CovImportMsvscaCommand_AddMsvscaOutputFilesTest() {
    mocker.replay();
    File analysisLog1 = new File("CodeAnalysisLog1.xml");
    File analysisLog2 = new File("CodeAnalysisLog2.xml");
    File[] outputFiles = new File[] { analysisLog1, analysisLog2 };
...
>>>>>>> /usr/src/app/output/jenkinsci/coverity-plugin/5846a9f06a151725dff014e3a580a9349a20e8ec/src/test/java/jenkins/plugins/coverity/CoverityTool/CovImportMsvscaCommandTest.java/right.java
