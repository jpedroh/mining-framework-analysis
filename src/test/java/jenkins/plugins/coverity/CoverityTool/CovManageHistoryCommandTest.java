...
=======
  @Test public void CovManageHistoryCommand_PrepareCommandTest() throws IOException {
    mocker.replay();
    CIMStream cimStream = new CIMStream("TestInstance", "TestProject", "TestStream", null, "TestId", null);
    List<CIMStream> cimStreamList = new ArrayList<>();
    cimStreamList.add(cimStream);
...
>>>>>>> /usr/src/app/output/jenkinsci/coverity-plugin/5846a9f06a151725dff014e3a580a9349a20e8ec/src/test/java/jenkins/plugins/coverity/CoverityTool/CovManageHistoryCommandTest.java/right.java


  @Test public void prepareCommandTest_WithSslConfiguration_ForIndio() throws IOException, InterruptedException {
    CIMStream cimStream = new CIMStream("TestInstance", "TestProject", "TestStream", null, "TestId", null);
    List<CIMStream> cimStreamList = new ArrayList<>();
    cimStreamList.add(cimStream);
...
<<<<<<< Unknown file: This is a bug in JDime.
=======
  @Test public void CovManageHistoryCommand_PrepareCommandTest_WithSslConfiguration_ForIndio() throws IOException {
    mocker.replay();
    CIMStream cimStream = new CIMStream("TestInstance", "TestProject", "TestStream", null, "TestId", null);
    List<CIMStream> cimStreamList = new ArrayList<>();
    cimStreamList.add(cimStream);
...
>>>>>>> /usr/src/app/output/jenkinsci/coverity-plugin/5846a9f06a151725dff014e3a580a9349a20e8ec/src/test/java/jenkins/plugins/coverity/CoverityTool/CovManageHistoryCommandTest.java/right.java
  ...
  @Test public void prepareCommandTest_WithSslConfiguration_ForJasperOrHigher() throws IOException, InterruptedException {
    CIMStream cimStream = new CIMStream("TestInstance", "TestProject", "TestStream", null, "TestId", null);
    List<CIMStream> cimStreamList = new ArrayList<>();
    cimStreamList.add(cimStream);
    CIMInstance cimInstance = new CIMInstance("TestInstance", "Localhost", 8080, "TestUser", "TestPassword", true, 0);
