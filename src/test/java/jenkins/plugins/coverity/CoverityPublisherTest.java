...
@RunWith(value = PowerMockRunner.class) @PrepareForTest(value = { Jenkins.class, Executor.class, ToolLocationNodeProperty.class, SaveableListener.class }) public class CoverityPublisherTest {
  @Mock private Jenkins jenkins;

  @Rule public private TemporaryFolder 
<<<<<<< /usr/src/app/output/jenkinsci/coverity-plugin/aa34ba78eb1e1bd9c61cc8311cf3552995c43fa2/src/test/java/jenkins/plugins/coverity/CoverityPublisherTest.java/left.java
  idir = new TemporaryFolder()
=======
  tempJenkinsRoot = new TemporaryFolder()
