...
@RunWith(value = PowerMockRunner.class) @PrepareForTest(value = { Jenkins.class, WebServiceFactory.class, Secret.class, CredentialsMatchers.class, CredentialsProvider.class }) public class CoverityBuildActionTest {
  ...
  @Before public void setup() throws IOException {
    ...
    cimInstance = new CIMInstanceBuilder().withName("test-cim-instance").withHost("test-cim-instance").withPort(8443).withUseSSL(true).withDefaultCredentialId().build();
  ...
  @Test public void getUrl_returnsFormattedUrlForDefect() throws IOException, CovRemoteServiceException_Exception {
    ...
    String expectedUrl = String.format("https://%s:%d/sourcebrowser.htm?projectId=%s&mergedDefectId=%d", cimInstance.getHost(), cimInstance.getPort(), 0, defects.get(0).getCid());
    assertEquals(expectedUrl, url);
  }

  @Test public void getDefects_forPre190Build_returnsDefectIds() {
  ...
  @Test public void getProjectActions_includesCoverityProjectAction() {
  ...
  @Test public void getProjectActions_withNullBuild() {
  ...
  @Test public void getProjectActions_withJobMissingPublisher() {
  ...
  @Test public void getProjectActions_withJobPublisher() {
  ...
  @Test public void getProjectActions_withPublisherHidesChart() {
    final CoverityPublisherBuilder publisherBuilder = new CoverityPublisherBuilder();
