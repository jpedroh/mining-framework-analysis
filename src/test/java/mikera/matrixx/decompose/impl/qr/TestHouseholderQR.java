...
public class TestHouseholderQR extends GenericQrCheck {
  ...
  @Override protected QRDecomposition createQRDecomposition(boolean compact) {
  ...
  @Test public void testZeroDecompose() {
  ...
  @Test public void testZeroDecomposeSquare() {
