...
public class TestMatrices {
  ...
  @Test public void g_PermutedMatrix() {
    ...
    randomise(mmn);
    PermutedMatrix pmm = new PermutedMatrix(mmn, Indexz.createRandomPermutation(mmn.rowCount()), Indexz.createRandomPermutation(mmn.columnCount()));
    doGenericTests(pmm);
  ...
  @Test public void g_QuadtreeMatrix() {
    doGenericTests(QuadtreeMatrix.create(new Matrix22(1, 0, 0, 2), ZeroMatrix.create(2, 1), ZeroMatrix.create(1, 2), Matrixx.createScaleMatrix(1, 3)));
  }
