...
public class TestSparseRowMatrix {
  ...
  @Test public void testColumnMultiply() {
    SparseRowMatrix m = SparseRowMatrix.create(Matrix.create(Vector.of(1, 2), Vector.of(3, 4)));
    SparseColumnMatrix c = SparseColumnMatrix.create(Matrix.create(Vector.of(1, 3), Vector.of(2, 4)));
