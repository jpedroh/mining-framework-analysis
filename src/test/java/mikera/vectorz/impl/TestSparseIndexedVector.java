...
public class TestSparseIndexedVector {
  ...
  @Test(expected = java.lang.Throwable.class) public void testFaultyConstruction() {
  ...
  @Test public void testRoundToZero() {
    SparseIndexedVector sv = SparseIndexedVector.create(10, Index.of(1, 3, 6), Vector.of(0.001, 0.01, 0.1));
