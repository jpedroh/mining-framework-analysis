...
public class GeoHashTest {
  ...
  @Test public void testAddingOnes() {
    hash.addOnBitToEnd();
  ...
  @Test public void testAddingZeroes() {
    hash.addOnBitToEnd();
    assertEquals(0x1l, hash.bits);
    hash.addOffBitToEnd();
    hash.addOffBitToEnd();
  ...
  @Test(expected = IllegalStateException.class) public void toBase32ShouldThrowWhenPrecisionIsNotAMultipleOf5() {
  ...
  @Test public void testToAndFromBinaryString() {
    for (GeoHash gh : RandomGeohashes.fullRange()) {
  ...
  @Test public void itShouldCreateAHashWithMaximumPrecisionOf64Bits() {
    GeoHash.withBitPrecision(10.0, 10.0, 64);
  }

  @Test(expected = IllegalArgumentException.class) public void itShouldThrowWhenTheBitPrecisionIsMoreThan64Bits() {
    GeoHash.withBitPrecision(46.0, 8.0, 70);
  }

  @Test(expected = IllegalArgumentException.class) public void itShouldThrowWhenTheCharacterPrecisionIsTooBig() {
    GeoHash.withCharacterPrecision(10.0, 120.0, 14);
  }

  @Test public void testNotWithin() {
    hash.bits = 0x6ff0414000000000l;
    hash.significantBits = 25;
    assertEquals("ezs42", hash.toBase32());
    GeoHash bbox = new GeoHash();
  ...
  @Test public void testConstructorWithBitPrecision() {
  ...
  @Test public void testLatLonBoundingBoxes() {
    hash = GeoHash.withBitPrecision(40, 120, 10);
    System.out.println(hash.toBase32());
    printBoundingBox(hash);
  }

  @Test public void testByCharacterPrecision() {
  ...
  @Test public void testGetLatitudeBits() {
  ...
  @Test public void testGetLongitudeBits() {
    hash = GeoHash.withBitPrecision(30, 30, 16);
  ...
  @Test public void testMovingAroundWorldOnHashStrips() throws Exception {
  ...
  @Test public void testKnownNeighbouringHashes() {
  ...
  @Test public void testKnownAdjacentNeighbours() {
    String center = "dqcjqc";
    String[] adjacent = new String[] { "dqcjqf", "dqcjqb", "dqcjr1", "dqcjq9", "dqcjqd", "dqcjr4", "dqcjr0", "dqcjq8" };
    assertAdjacentHashesAre(center, adjacent);
    center = "u1x0dfg";
    adjacent = new String[] { "u1x0dg4", "u1x0dg5", "u1x0dgh", "u1x0dfu", "u1x0dfs", "u1x0dfe", "u1x0dfd", "u1x0dff" };
    assertAdjacentHashesAre(center, adjacent);
    center = "sp2j";
  ...
  @Test public void testNeibouringHashesNearMeridian() {
  ...
  @Test public void testSimpleWithin() {
  ...
  @Test public void testToLongAndBack() {
    double lat = 40.390943;
    double lon = -75.9375;
  ...
  @Test(expected = IllegalStateException.class) public void testGetCharacterPrecisionThrows() throws Exception {
    GeoHash hash = GeoHash.withBitPrecision(37.7, -122.52, 32);
    hash.getCharacterPrecision();
  }

  @Test public void testGetCharacterPrecisionWorksWhenPrecisionIsMultipleOfFive() throws Exception {
    GeoHash hash = GeoHash.withBitPrecision(37.7, -122.52, 60);
    int precision = hash.getCharacterPrecision();
    assertEquals(precision, 12);
  }

  @Test public void testStepsBetween() {
    ...
    while (idx.compareTo(ur) < 0) {
      ...
      if (idx.getPoint().getLatitude() > iterBbox.getMaxLat()) {
        ...
        if (idx.getPoint().getLatitude() < iterBbox.getMinLat()) {
          latIsLess = true;
          latLess++;
        }
      }
      if (idx.getPoint().getLongitude() > iterBbox.getMaxLon()) {
        ...
        if (idx.getPoint().getLongitude() < iterBbox.getMinLon()) {
          lonLess++;
          if (latIsLess) {
            bothLess++;
          }
  ...
  @Test public void testOrdIsPositive() {
    double lat = 40.390943;
    double lon = 75.9375;
    GeoHash hash = GeoHash.withCharacterPrecision(lat, lon, 12);
  ...
  @Test public void testSecondCaseWhereOrdMustBePositive() {
