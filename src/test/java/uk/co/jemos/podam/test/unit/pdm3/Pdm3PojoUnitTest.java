...
public class Pdm3PojoUnitTest {
  ...
  @Test public void testPdm3PojoConstructor() {
    Pdm3PojoConstructor<?> pojo = factory.manufacturePojo(Pdm3PojoConstructor.class, String.class);
    assertNotNull(pojo);
    assertNotNull(pojo.getName());
  }

  @Test public void testPdm3ListOfPojos() {
    List<?> pojos = factory.manufacturePojo(ArrayList.class, Pdm3PojoConstructor.class, String.class);
    assertCollection(pojos, Pdm3PojoConstructor.class);
  }

  @Test public void testPdm3MapOfPojos() {
    Map<?, ?> pojos = factory.manufacturePojo(HashMap.class, Integer.class, Pdm3PojoConstructor.class, String.class);
    assertMap(pojos, Integer.class, Pdm3PojoConstructor.class);
  }

  @Test public void testPdm3ExtendingListOfPojos() {
    Collection<?> pojos = factory.manufacturePojo(CollectionExtendingGenericsPojo.class);
    assertCollection(pojos, String.class);
  }

  @Test public void testPdm3ExtendingMapOfPojos() {
    Map<?, ?> pojos = factory.manufacturePojo(MapExtendingGenericsPojo.class);
    assertMap(pojos, Integer.class, String.class);
  }

  @Test public void testPdm3PojoGenericsConstructor() {
  ...
  @Test public void testPdm3ListOfGenericPojos() {
    List<?> pojos = factory.manufacturePojo(ArrayList.class, Pdm3PojoGenericsConstructor.class);
    assertCollection(pojos, Pdm3PojoGenericsConstructor.class);
  }

  @Test public void testPdm3MapOfGenericPojos() {
    Map<?, ?> pojos = factory.manufacturePojo(HashMap.class, String.class, Pdm3PojoGenericsConstructor.class);
