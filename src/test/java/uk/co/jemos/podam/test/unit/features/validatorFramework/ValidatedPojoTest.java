 ...
 * @author daivanov
 */
@RunWith(value = SerenityRunner.class) public class ValidatedPojoTest extends AbstractPodamSteps {
  ...
  @Test @Title(value = "Podam should be able to fulfill most of the javax Validation framework") public void podamShouldFulfillMostOfTheJavaxValidationFramework() throws Exception {
  ...
  @Test @Title(value = "Podam should allow validation annotations customization") public void podamShouldAllowValidationAnnotationsCustomization() throws Exception {
  ...
  @Test @Title(value = "When the @Size annotation doesn\'t have a max length specified, Podam should assign a sensible value") public void whenMaxLengthIsNotSpecifiedInSizeAnnotationPodamShouldAssignASensibleDefault() throws Exception {
  ...
  @Test @Title(value = "When the @Digits and @DecimalMin and @DecimalMax applied to the same field, Podam should use minimum requirements") public void whenDigitsAndDecimalMinOrDecimalMaxAreAttachedToTheSameFieldPodamShouldUseMinimumRequirement() throws Exception {
