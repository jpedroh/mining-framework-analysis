...
@RunWith(value = JUnitParamsRunner.class) public class LoggingEventTests {
  ...
  @Test public void constructorMessageArgs() {
  ...
  @Test public void constructorThrowableMessageArgs() {
  ...
  @Test public void constructorMarkerMessageArgs() {
  ...
  @Test public void constructorMarkerThrowableMessageArgs() {
  ...
  @Test public void constructorMdcMessageArgs() {
  ...
  @Test public void constructorMdcThrowableMessageArgs() {
  ...
  @Test public void constructorMdcMarkerMessageArgs() {
  ...
  @Test public void constructorMdcMarkerThrowableMessageArgs() {
  ...
  @Test public void traceMessageArgs() {
  ...
  @Test public void traceThrowableMessageArgs() {
  ...
  @Test public void traceMdcMarkerMessageArgs() {
  ...
  @Test public void traceMdcMarkerThrowableMessageArgs() {
  ...
  @Test public void debugMdcMarkerMessageArgs() {
  ...
  @Test public void debugMdcMarkerThrowableMessageArgs() {
  ...
  @Test public void infoMdcMarkerMessageArgs() {
  ...
  @Test public void infoMdcMarkerThrowableMessageArgs() {
  ...
  @Test public void warnMdcMarkerMessageArgs() {
  ...
  @Test public void warnMdcMarkerThrowableMessageArgs() {
  ...
  @Test public void errorMdcMarkerMessageArgs() {
  ...
  @Test public void errorMdcMarkerThrowableMessageArgs() {
  ...
  @Test public void mdcIsSnapshotInTime() {
    Map<String, String> mdc = new HashMap<String, String>();
    mdc.put("key", "value1");
  ...
  @Test(expected = UnsupportedOperationException.class) public void mdcNotModifiable() throws Throwable {
    Map<String, String> mdc = new HashMap<String, String>();
    mdc.put("key", "value1");
  ...
  @Test public void argsIsSnapshotInTime() {
  ...
  @Test(expected = UnsupportedOperationException.class) public void argsNotModifiable() throws Throwable {
  ...
  @Test(expected = IllegalStateException.class) public void creatingLoggerNotPresent() {
    info("message").getCreatingLogger();
  }

  @Test public void creatingLoggerPresent() {
  ...
  @Test public void printToStandardOutNoThrowable() {
    LoggingEvent event = new LoggingEvent(INFO, "message with {}", "argument");
    event.print();
    assertThat(systemOutputRule.getSystemOut(), is("1970-01-01T00:00:00.000Z [" + Thread.currentThread().getName() + "] INFO - message with argument" + lineSeparator()));
  }

  @Test public void printToStandardOutWithThrowable() {
    LoggingEvent event = new LoggingEvent(INFO, new Exception(), "message");
    event.print();
    assertThat(systemOutputRule.getSystemOut(), startsWith("1970-01-01T00:00:00.000Z [" + Thread.currentThread().getName() + "] INFO - message" + lineSeparator() + "java.lang.Exception" + lineSeparator() + "\tat"));
  }

  @Test @Parameters(value = { "TRACE", "DEBUG", "INFO" }) public void printInfoAndBelow(Level level) {
  ...
  @Test @Parameters(value = { "WARN", "ERROR" }) public void printWarnAndAbove(Level level) {
    LoggingEvent event = new LoggingEvent(level, "message with {}", "argument");
    event.print();
  ...
  @SuppressWarnings(value = { "unchecked" }) private Matcher<Optional<?>> isAbsent() {
