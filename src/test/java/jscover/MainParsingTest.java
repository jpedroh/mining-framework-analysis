...
public class MainParsingTest {
  ...
  @Test public void shouldHaveDefaults() {
  ...
  @Test public void shouldDetectMissingJARs() throws IOException {
    main.parse(new String[] {  });
  ...
  @Test public void shouldParseVersion() {
  ...
  @Test public void shouldParseFileSystem() {
  ...
  @Test public void shouldDetectInvalidOptions1() {
    verifyInvalid(new String[] { "-ws", "-fs" });
  }

  @Test public void shouldDetectInvalidOptions2() {
    verifyInvalid(new String[] { "-ws", "-io" });
  }

  @Test public void shouldDetectInvalidOptions3() {
  ...
  @Test public void shouldDetectInvalidOptionsNoArgs() {
    assertThat(main.parse(new String[] {  }).showHelp(), equalTo(true));
    assertThat(main.getExitStatus(), equalTo(1));
  }

  @Test public void shouldRetrieveHelpText() {
