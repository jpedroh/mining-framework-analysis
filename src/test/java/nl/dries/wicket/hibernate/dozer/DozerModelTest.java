...
public class DozerModelTest extends AbstractWicketHibernateTest {
  /**
	 * Model ceate and get
	 */
  @Test public void testCreateAndGet() {
  ...
  /**
	 * Detach with proxies
	 */
  @Test public void testLoadedDetach() {
    Person person = new Person();
    person.setId(1L);
    person.setName("test");
    ...
    getSession().flush();
    getSession().clear();
    adres.setPerson((Person) getSession().load(Person.class, 1L));
  ...
  /**
	 ...
	 */
  @Test public void testLoadedListDetach() {
    Person person = new Person();
    person.setId(1L);
    person.setName("test");
    Adres adres = new Adres();
    ...
    getSession().flush();
    getSession().clear();
    person.setAdresses(Arrays.asList((Adres) getSession().load(Adres.class, 1L)));
    DozerModel<Person> model = new DozerModel<>(person);
    model.detach();
    model = serialize(model);
    closeSession();
  ...
  /**
	 ...
	 */
  @Test public void testWithTreeUsingChild() {
    buildTree();
  ...
  /**
	 ...
	 */
  @Test public void testTreeWithSameBranches() {
    DozerModel<AbstractTreeObject> model = new DozerModel<>(buildTree());
    model.detach();
    model = serialize(model);
    getSession().flush();
  ...
  /**
	 ...
	 */
  @Test public void testWithAbstractProperty() {
    Person person = new Person();
    person.setId(1L);
    person.setName("name");
  ...
  /**
	 ...
	 */
  @Test public void testCollectionWithFlush() {
    Person person = new Person();
    person.setId(1L);
  ...
  /**
	 * Multiple load
	 */
  @Test public void testMultipleLoad() {
    Person person = new Person();
    person.setId(1L);
    person.setName("person");
    getSession().saveOrUpdate(person);
  ...
  @Test public void testEvictUnique() {
    Person person = new Person();
    person.setId(1L);
    person.setName("person");
    getSession().saveOrUpdate(person);
  ...
  /**
	 ...
	 */
  @Test public void testInitializedMap() {
    MapObject map = new MapObject();
    map.setId(1L);
    map.getMap().put("1", "one");
    map.getMap().put("2", "two");
  ...
  /**
	 ...
	 */
  @Test public void testMultipleInitialize() {
    Person person = new Person();
    person.setId(1L);
    person.setName("test");
    Adres adres = new Adres();
  ...
  /**
	 ...
	 */
  @Test public void testSetInitialized() {
    Company company = new Company();
    company.setId(1L);
    Person person = new Person();
    person.setId(1L);
  ...
  /**
	 ...
	 * correctly.
	 */
  @Test public void testNonHibernateObjectAsRoot() {
    Person person = new Person();
    person.setId(1L);
    person.setName("test");
    Adres adres = new Adres();
  ...
  /**
	 ...
	 */
  @Test public void testNonHibernateObjectAsRootInitialized() {
    Person person = new Person();
    person.setId(1L);
    person.setName("test");
    Adres adres = new Adres();
  ...
  /**
	 * Set other object
	 */
  @Test public void testSetOtherObject() {
    Person person = new Person();
    person.setId(1L);
    person.setName("test");
    getSession().saveOrUpdate(person);
  ...
  /**
	 ...
	 */
  @Override protected List<Class<? extends Serializable>> getEntities() {
    return Arrays.asList(Adres.class, Person.class, AbstractTreeObject.class, DescTreeObject.class, RootTreeObject.class, AbstractOrganization.class, Company.class, MapObject.class);
  }
  ...
  /**
	 ...
	 * @return object
	 */
  @SuppressWarnings(value = { "unchecked" }) private <T extends Serializable> T serialize(T in) {
    T out = null;
    try {
