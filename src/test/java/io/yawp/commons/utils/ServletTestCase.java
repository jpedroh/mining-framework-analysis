...
public class ServletTestCase extends EndpointTestCase {
  ...
  @Before public void createServlet() {
  ...
  protected <T extends java.lang.Object> T from(String json, Class<T> clazz) {
    return JsonUtils.from(yawp, json, clazz);
  }

  protected <T extends java.lang.Object> List<T> fromList(String json, Class<T> clazz) {
