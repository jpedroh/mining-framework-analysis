...
public class TreeMapTest extends AbstractSortedMapTest {
  ...
  @Override protected <T1 extends java.lang.Object, T2 extends java.lang.Object> java.util.Map<T1, T2> javaEmptyMap() {
    return new java.util.TreeMap<>();
  }

  @Override protected <T1 extends Comparable<? super T1>, T2 extends java.lang.Object> TreeMap<T1, T2> emptyMap() {
    return TreeMap.empty();
  }

  @Override protected <K extends Comparable<? super K>, V extends java.lang.Object, T extends V> Collector<T, ArrayList<T>, ? extends Map<K, V>> collectorWithMapper(Function<? super T, ? extends K> keyMapper) {
    return TreeMap.collector(keyMapper);
  }

  @Override protected <K extends Comparable<? super K>, V extends java.lang.Object, T extends java.lang.Object> Collector<T, ArrayList<T>, ? extends Map<K, V>> collectorWithMappers(Function<? super T, ? extends K> keyMapper, Function<? super T, ? extends V> valueMapper) {
    return TreeMap.collector(keyMapper, valueMapper);
  }

  @Override protected boolean emptyMapShouldBeSingleton() {
    return false;
  }
  ...
  @Override protected <T extends java.lang.Object> Collector<Tuple2<Integer, T>, ArrayList<Tuple2<Integer, T>>, ? extends Map<Integer, T>> mapCollector() {
    return TreeMap.collector();
  }

  @SuppressWarnings(value = { "varargs" }) @SafeVarargs @Override protected final <K extends Comparable<? super K>, V extends java.lang.Object> TreeMap<K, V> mapOfTuples(Tuple2<? extends K, ? extends V>... entries) {
    return TreeMap.ofEntries(entries);
  }

  @Override protected <K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapOfTuples(Iterable<? extends Tuple2<? extends K, ? extends V>> entries) {
    return TreeMap.ofEntries(entries);
  }

  @SuppressWarnings(value = { "varargs" }) @SafeVarargs @Override protected final <K extends Comparable<? super K>, V extends java.lang.Object> TreeMap<K, V> mapOfEntries(java.util.Map.Entry<? extends K, ? extends V>... entries) {
    return TreeMap.ofEntries(entries);
  }

  @Override protected <K extends Comparable<? super K>, V extends java.lang.Object> TreeMap<K, V> mapOf(K k1, V v1) {
    return TreeMap.of(k1, v1);
  }

  @Override protected <K extends Comparable<? super K>, V extends java.lang.Object> TreeMap<K, V> mapOf(K k1, V v1, K k2, V v2) {
    return TreeMap.of(k1, v1, k2, v2);
  }

  @Override protected <K extends Comparable<? super K>, V extends java.lang.Object> TreeMap<K, V> mapOf(K k1, V v1, K k2, V v2, K k3, V v3) {
    return TreeMap.of(k1, v1, k2, v2, k3, v3);
  }

  @Override protected <K extends Comparable<? super K>, V extends java.lang.Object> TreeMap<K, V> mapOfNullKey(K k1, V v1, K k2, V v2) {
    return TreeMap.of(nullsFirst(Comparators.naturalComparator()), k1, v1, k2, v2);
  }

  @Override protected <K extends Comparable<? super K>, V extends java.lang.Object> TreeMap<K, V> mapOfNullKey(K k1, V v1, K k2, V v2, K k3, V v3) {
    return TreeMap.of(nullsFirst(Comparators.naturalComparator()), k1, v1, k2, v2, k3, v3);
  }

  @Override protected <T extends java.lang.Object, K extends Comparable<? super K>, V extends java.lang.Object> TreeMap<K, V> mapOf(Stream<? extends T> stream, Function<? super T, ? extends K> keyMapper, Function<? super T, ? extends V> valueMapper) {
    return TreeMap.ofAll(stream, keyMapper, valueMapper);
  }

  @Override protected <T extends java.lang.Object, K extends Comparable<? super K>, V extends java.lang.Object> TreeMap<K, V> mapOf(Stream<? extends T> stream, Function<? super T, Tuple2<? extends K, ? extends V>> f) {
    return TreeMap.ofAll(stream, f);
  }

  @Override protected <K extends Comparable<? super K>, V extends java.lang.Object> TreeMap<K, V> mapTabulate(int n, Function<? super Integer, ? extends Tuple2<? extends K, ? extends V>> f) {
    return TreeMap.tabulate(n, f);
  }

  @Override protected <K extends Comparable<? super K>, V extends java.lang.Object> TreeMap<K, V> mapFill(int n, Supplier<? extends Tuple2<? extends K, ? extends V>> s) {
  ...
  @Test public void shouldCollectFromJavaStream() {
  ...
  @Test @SuppressWarnings(value = { "unchecked", "rawtypes" }) public void shouldConstructFromJavaStreamWithKeyMapperAndValueMapper() {
  ...
  @Test public void shouldConstructFromJavaStreamWithEntryMapper() {
  ...
  @Test public void shouldReturnSingletonFromTupleUsingComparator() {
  ...
  @Test public void shouldConstructFrom1EntryWithComparator() {
    final Map<Integer, String> actual = TreeMap.of(Comparators.naturalComparator(), 1, "1");
    final java.util.Map<Integer, String> expected = asJavaMap(asJavaEntry(1, "1"));
    assertThat(actual.toJavaMap()).isEqualTo(expected);
  }

  @Test public void shouldConstructFrom2EntriesWithComparator() {
  ...
  @Test public void shouldConstructFrom3EntriesWithComparator() {
  ...
  @Test public void shouldConstructFrom4EntriesWithComparator() {
  ...
  @Test public void shouldConstructFrom5EntriesWithComparator() {
  ...
  @Test public void shouldConstructFrom6EntriesWithComparator() {
  ...
  @Test public void shouldConstructFrom7EntriesWithComparator() {
  ...
  @Test public void shouldConstructFrom8EntriesWithComparator() {
  ...
  @Test public void shouldConstructFrom9EntriesWithComparator() {
  ...
  @Test public void shouldConstructFrom10EntriesWithComparator() {
  ...
  @Test public void shouldCreateOfEntriesUsingNoComparator() {
  ...
  @Test public void shouldScanLeft() {
    final TreeMap<String, Integer> tm = TreeMap.ofEntries(Tuple.of("one", 1), Tuple.of("two", 2));
  ...
  @Test public void shouldScanRight() {
    final TreeMap<String, Integer> tm = TreeMap.ofEntries(Tuple.of("one", 1), Tuple.of("two", 2));
  ...
  @Test public void shouldWrapMap() {
  ...
  @Test public void shouldCreateKeyComparatorForJavaUtilMap() {
  ...
  @Test public void shouldFillWithComparator() {
  ...
  @Test public void shouldReturnATreeMapWithCorrectComparatorWhenFlatMappingToEmpty() {
  ...
  @Test public void shouldReturnModifiedKeysMapWithNonUniqueMapperAndPredictableOrder() {
  ...
  @Test public void shouldTabulateWithComparator() {
