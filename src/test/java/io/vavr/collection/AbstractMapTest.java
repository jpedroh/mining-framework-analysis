...
public abstract class AbstractMapTest extends AbstractTraversableTest {
  @Override protected <T extends java.lang.Object> IterableAssert<T> assertThat(Iterable<T> actual) {
    return new IterableAssert<T>(actual) {
      @Override public IterableAssert<T> isEqualTo(Object obj) {
        @SuppressWarnings(value = { "unchecked" }) final Iterable<T> expected = (Iterable<T>) obj;
  ...
  @Override protected <T extends java.lang.Object> Collector<T, ArrayList<T>, IntMap<T>> collector() {
    ...
    return new Collector<T, ArrayList<T>, IntMap<T>>() {
      @Override public Supplier<ArrayList<T>> supplier() {
        return ArrayList::new;
      }

      @Override public BiConsumer<ArrayList<T>, T> accumulator() {
        return ArrayList::add;
      }

      @Override public BinaryOperator<ArrayList<T>> combiner() {
        return (left, right) -> fromTuples(mapCollector.combiner().apply(toTuples(left), toTuples(right)));
      }

      @Override public Function<ArrayList<T>, IntMap<T>> finisher() {
      ...
      private ArrayList<Tuple2<Integer, T>> toTuples(java.util.List<T> list) {
        ...
        Stream.ofAll(list).zipWithIndex().map((tu) -> Tuple.of(tu._2, tu._1)).forEach(result::add);
        return result;
      }

      private ArrayList<T> fromTuples(java.util.List<Tuple2<Integer, T>> list) {
        final ArrayList<T> result = new ArrayList<>();
        Stream.ofAll(list).map((tu) -> tu._2).forEach(result::add);
        return result;
      }
    };
  }

  @Override protected <T extends java.lang.Object> IntMap<T> empty() {
    return IntMap.of(emptyMap());
  }

  @Override protected boolean emptyShouldBeSingleton() {
    return false;
  }

  private <T extends java.lang.Object> Map<Integer, T> emptyInt() {
    return emptyMap();
  }
  ...
  protected abstract <T1 extends java.lang.Object, T2 extends java.lang.Object> java.util.Map<T1, T2> javaEmptyMap();

  protected abstract <T1 extends Comparable<? super T1>, T2 extends java.lang.Object> Map<T1, T2> emptyMap();

  protected abstract <K extends Comparable<? super K>, V extends java.lang.Object, T extends V> Collector<T, ArrayList<T>, ? extends Map<K, V>> collectorWithMapper(Function<? super T, ? extends K> keyMapper);

  protected abstract <K extends Comparable<? super K>, V extends java.lang.Object, T extends java.lang.Object> Collector<T, ArrayList<T>, ? extends Map<K, V>> collectorWithMappers(Function<? super T, ? extends K> keyMapper, Function<? super T, ? extends V> valueMapper);

  protected boolean emptyMapShouldBeSingleton() {
    return true;
  }

  protected abstract <T extends java.lang.Object> Collector<Tuple2<Integer, T>, ArrayList<Tuple2<Integer, T>>, ? extends Map<Integer, T>> mapCollector();

  @SuppressWarnings(value = { "unchecked" }) protected abstract <K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapOfTuples(Tuple2<? extends K, ? extends V>... entries);

  protected abstract <K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapOfTuples(Iterable<? extends Tuple2<? extends K, ? extends V>> entries);

  @SuppressWarnings(value = { "unchecked" }) protected abstract <K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapOfEntries(java.util.Map.Entry<? extends K, ? extends V>... entries);

  protected abstract <K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapOf(K k1, V v1);

  protected abstract <K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapOf(K k1, V v1, K k2, V v2);

  protected abstract <K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapOf(K k1, V v1, K k2, V v2, K k3, V v3);

  protected abstract <T extends java.lang.Object, K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapOf(java.util.stream.Stream<? extends T> stream, Function<? super T, ? extends K> keyMapper, Function<? super T, ? extends V> valueMapper);

  protected abstract <T extends java.lang.Object, K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapOf(java.util.stream.Stream<? extends T> stream, Function<? super T, Tuple2<? extends K, ? extends V>> f);

  protected abstract <K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapOfNullKey(K k1, V v1, K k2, V v2);

  protected abstract <K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapOfNullKey(K k1, V v1, K k2, V v2, K k3, V v3);

  protected abstract <K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapTabulate(int n, Function<? super Integer, ? extends Tuple2<? extends K, ? extends V>> f);

  protected abstract <K extends Comparable<? super K>, V extends java.lang.Object> Map<K, V> mapFill(int n, Supplier<? extends Tuple2<? extends K, ? extends V>> s);

  @Override protected boolean useIsEqualToInsteadOfIsSameAs() {
    return true;
  }

  @Override protected int getPeekNonNilPerformingAnAction() {
    return 1;
  }

  @Override protected <T extends java.lang.Object> IntMap<T> of(T element) {
    Map<Integer, T> map = emptyMap();
    map = map.put(0, element);
    return IntMap.of(map);
  }

  @SuppressWarnings(value = { "unchecked" }) @Override protected <T extends java.lang.Object> IntMap<T> of(T... elements) {
    Map<Integer, T> map = emptyMap();
  ...
  @Override protected <T extends java.lang.Object> IntMap<T> ofAll(Iterable<? extends T> elements) {
    Map<Integer, T> map = emptyMap();
    for (T element : elements) {
      map = map.put(map.size(), element);
    }
  ...
  @Override protected <T extends Comparable<? super T>> IntMap<T> ofJavaStream(java.util.stream.Stream<? extends T> javaStream) {
    return ofAll(io.vavr.collection.Iterator.ofAll(javaStream.iterator()));
  }

  @Override protected IntMap<Boolean> ofAll(boolean... elements) {
    return ofAll(io.vavr.collection.Iterator.ofAll(elements));
  }

  @Override protected IntMap<Byte> ofAll(byte... elements) {
    return ofAll(io.vavr.collection.Iterator.ofAll(elements));
  }

  @Override protected IntMap<Character> ofAll(char... elements) {
    return ofAll(io.vavr.collection.Iterator.ofAll(elements));
  }

  @Override protected IntMap<Double> ofAll(double... elements) {
    return ofAll(io.vavr.collection.Iterator.ofAll(elements));
  }

  @Override protected IntMap<Float> ofAll(float... elements) {
    return ofAll(io.vavr.collection.Iterator.ofAll(elements));
  }

  @Override protected IntMap<Integer> ofAll(int... elements) {
    return ofAll(io.vavr.collection.Iterator.ofAll(elements));
  }

  @Override protected IntMap<Long> ofAll(long... elements) {
    return ofAll(io.vavr.collection.Iterator.ofAll(elements));
  }

  @Override protected IntMap<Short> ofAll(short... elements) {
    return ofAll(io.vavr.collection.Iterator.ofAll(elements));
  }

  @Override protected <T extends java.lang.Object> IntMap<T> tabulate(int n, Function<? super Integer, ? extends T> f) {
    Map<Integer, T> map = emptyMap();
    for (int i = 0; i < n; i++) {
  ...
  @Override protected <T extends java.lang.Object> IntMap<T> fill(int n, Supplier<? extends T> s) {
    return tabulate(n, (anything) -> s.get());
  }

  @Test public void shouldNarrowMap() {
  ...
  @Test public void shouldCollectWithKeyMapper() {
  ...
  @SafeVarargs protected final <K extends java.lang.Object, V extends java.lang.Object> java.util.Map<K, V> asJavaMap(java.util.Map.Entry<K, V>... entries) {
  ...
  @Test public void shouldConstructFromJavaStream() {
  ...
  @Test public void shouldConstructFromJavaStreamWithDuplicatedKeys() {
  ...
  @Test public void shouldConstructFromJavaStreamEntries() {
    final java.util.stream.Stream<Integer> javaStream = java.util.stream.Stream.of(1, 2, 3);
    final Map<String, Integer> map = mapOf(javaStream, (i) -> Tuple.of(String.valueOf(i), i));
    assertThat(map).isEqualTo(this.<String, Integer>emptyMap().put("1", 1).put("2", 2).put("3", 3));
  }

  @Test public void shouldConstructFromJavaStreamEntriesWithDuplicatedKeys() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void shouldConstructFromUtilEntries() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void shouldConstructFromUtilEntriesWithDuplicatedKeys() {
    assertThat(mapOfEntries(asJavaEntry(1, "1"), asJavaEntry(1, "2"), asJavaEntry(2, "3"), asJavaEntry(2, "4"))).hasSize(2).isEqualTo(mapOf(1, "2", 2, "4"));
  }

  @Test @SuppressWarnings(value = { "unchecked" }) public void shouldConstructFromEntriesVararg() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void shouldConstructFromEntriesVarargWithDuplicatedKeys() {
    assertThat(mapOfTuples(Map.entry(1, "1"), Map.entry(1, "2"), Map.entry(2, "3"), Map.entry(2, "4"))).hasSize(2).isEqualTo(mapOf(1, "2", 2, "4"));
  }

  @Test public void shouldConstructFromEntriesIterable() {
    final Map<String, Integer> actual = mapOfTuples(asList(Map.entry("1", 1), Map.entry("2", 2), Map.entry("3", 3)));
    final Map<String, Integer> expected = this.<String, Integer>emptyMap().put("1", 1).put("2", 2).put("3", 3);
    assertThat(actual).isEqualTo(expected);
  }

  @Test public void shouldConstructFromEntriesIterableWithDuplicatedKeys() {
    assertThat(mapOfTuples(asList(Map.entry(1, "1"), Map.entry(1, "2"), Map.entry(2, "3"), Map.entry(2, "4")))).hasSize(2).isEqualTo(mapOf(1, "2", 2, "4"));
  }

  @Test public void shouldConstructFromPairs() {
    final Map<String, Integer> actual = mapOf("1", 1, "2", 2, "3", 3);
    final Map<String, Integer> expected = this.<String, Integer>emptyMap().put("1", 1).put("2", 2).put("3", 3);
    assertThat(actual).isEqualTo(expected);
  }

  @Test public void shouldConstructFromPairsWithDuplicatedKeys() {
  ...
  @Test public void shouldConstructWithTabulate() {
  ...
  @Test public void shouldConstructWithFillWithDuplicatedKeys() {
    AtomicInteger i = new AtomicInteger();
  ...
  @Test public void shouldImplementPartialFunction() {
  ...
  @Test public void shouldApplyExistingKey() {
    assertThat(emptyInt().put(1, 2).asPartialFunction().apply(1)).isEqualTo(2);
  }

  @Test(expected = NoSuchElementException.class) public void shouldApplyNonExistingKey() {
    emptyInt().put(1, 2).asPartialFunction().apply(3);
  }

  @Test public void shouldObeyEqualityConstraints() {
  ...
  @Test(expected = NoSuchElementException.class) public void shouldThrowWhenHeadEmpty() {
    emptyMap().head();
  }

  @Test(expected = UnsupportedOperationException.class) public void shouldThrowWhenInitEmpty() {
    emptyMap().init();
  }

  @Test(expected = UnsupportedOperationException.class) public void shouldThrowWhenTailEmpty() {
    emptyMap().tail();
  }

  @Test public void shouldMakeString() {
    assertThat(emptyMap().toString()).isEqualTo(className() + "()");
    assertThat(emptyInt().put(1, 2).toString()).isEqualTo(className() + "(" + Tuple.of(1, 2) + ")");
  }

  @Test public void shouldConvertToJavaMap() {
  ...
  @Test public void shouldFindKey() {
  ...
  @Test public void shouldRecognizeNotContainedKeyValuePair() {
  ...
  @Test public void shouldRecognizeContainedKeyValuePair() {
    final io.vavr.collection.TreeMap<String, Integer> testee = io.vavr.collection.TreeMap.of(Tuple.of("one", 1));
    assertThat(testee.contains(Tuple.of("one", 1))).isTrue();
  }

  @SuppressWarnings(value = { "unchecked" }) @Test public void shouldFlatMapUsingBiFunction() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void shouldReturnKeySet() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void shouldReturnKeysIterator() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void shouldReturnValuesSeq() {
  ...
  @Test public void shouldReturnModifiedKeysMapWithNonUniqueMapper() {
    final Map<Integer, String> actual = emptyIntString().put(1, "1").put(2, "2").put(3, "3").mapKeys((k) -> k * 118).mapKeys(Integer::toHexString).mapKeys(AbstractMapTest::md5).mapKeys(String::length);
  ...
  @Test public void shouldReturnModifiedKeysMapWithNonUniqueMapperAndMergedValues() {
    final Map<Integer, String> actual = emptyIntString().put(1, "1").put(2, "2").put(3, "3").mapKeys((k) -> k * 118).mapKeys(Integer::toHexString).mapKeys(AbstractMapTest::md5).mapKeys(String::length, (v1, v2) -> io.vavr.collection.List.of(v1.split("#")).append(v2).sorted().mkString("#"));
    final Map<Integer, String> expected = emptyIntString().put(32, "1#2#3");
    assertThat(actual).isEqualTo(expected);
  }

  @Test public void shouldReturnModifiedValuesMap() {
    assertThat(emptyIntString().put(1, "1").put(2, "2").mapValues(Integer::parseInt)).isEqualTo(emptyInt().put(1, 1).put(2, 2));
  }

  @Test public void shouldReturnListWithMappedValues() {
  ...
  @Test public void shouldReturnSameMapWhenMergeNonEmptyWithEmpty() {
    final Map<Integer, String> map = mapOf(1, "a", 2, "b", 3, "c");
    assertThat(map.merge(emptyMap())).isSameAs(map);
  }

  @Test public void shouldReturnSameMapWhenMergeEmptyWithNonEmpty() {
    final Map<Integer, String> map = mapOf(1, "a", 2, "b", 3, "c");
    if (map.isOrdered()) {
  ...
  @Test public void shouldMergeCollisions() {
    final Map<Integer, Integer> m1 = emptyIntInt().put(1, 1).put(2, 2);
  ...
  @Test public void shouldReturnSameMapWhenMergeNonEmptyWithEmptyUsingCollisionResolution() {
    final Map<Integer, Integer> map = mapOf(1, 1, 2, 2, 3, 3);
    assertThat(map.merge(emptyMap(), Math::max)).isSameAs(map);
  }

  @Test public void shouldReturnSameMapWhenMergeEmptyWithNonEmptyUsingCollisionResolution() {
    final Map<Integer, Integer> map = mapOf(1, 1, 2, 2, 3, 3);
    if (map.isOrdered()) {
  ...
  @Test public void shouldPutExistingKeyAndEqualValue() {
    final Map<IntMod2, String> map = mapOf(new IntMod2(1), "a");
  ...
  @Test public void shouldZipNils() {
  ...
  @Test public void shouldZipNonNilsIfThatIsSmaller() {
  ...
  @Test public void shouldZipNonNilsOfSameSize() {
  ...
  @Test(expected = NullPointerException.class) public void shouldThrowIfZipWithThatIsNull() {
    emptyMap().zip(null);
  }

  @Test public void shouldZipNilWithIndex() {
    assertThat(emptyMap().zipWithIndex()).isEqualTo(Stream.empty());
  }

  @Test public void shouldZipNonNilWithIndex() {
  ...
  @Test public void shouldZipAllNonEmptyAndNil() {
  ...
  @Test public void shouldZipAllNonNilsIfThisIsSmaller() {
  ...
  @Test public void shouldZipAllNonNilsIfThisIsMoreSmaller() {
  ...
  @Test public void shouldZipAllNonNilsIfThatIsSmaller() {
  ...
  @Test public void shouldZipAllNonNilsIfThatIsMoreSmaller() {
  ...
  @Test public void shouldZipAllNonNilsOfSameSize() {
  ...
  @Test(expected = NullPointerException.class) public void shouldThrowIfZipAllWithThatIsNull() {
    emptyMap().zipAll(null, null, null);
  }

  @Override public void shouldComputeDistinctOfNonEmptyTraversable() {
    final Map<Integer, Object> testee = emptyInt().put(1, 1).put(2, 2).put(3, 3);
    assertThat(testee.distinct()).isEqualTo(testee);
  }

  @Override public void shouldReturnSomeTailWhenCallingTailOptionOnNonNil() {
    assertThat(of(1, 2, 3).tailOption().get()).isEqualTo(Option.some(of(2, 3)).get());
  }

  @Override public void shouldPreserveSingletonInstanceOnDeserialization() {
    final Map<?, ?> obj = deserialize(serialize(emptyMap()));
    final boolean actual = obj == emptyMap();
    assertThat(actual).isTrue();
  }

  @Test public void shouldSerializeDeserializeNonEmptyMap() {
    final Object expected = of('a', 'b', 'c');
    final Object actual = deserialize(serialize(expected));
    assertThat(actual).isEqualTo(expected);
  }

  @Override public void shouldFoldRightNonNil() {
  ...
  @Test public void forEachByKeyValue() {
  ...
  @Test public void forEachByTuple() {
    final Map<Integer, Integer> map = mapOf(1, 2).put(3, 4);
    final int[] result = { 0 };
    map.forEach((t) -> {
      result[0] += t._1 + t._2;
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void shouldTabulateTheSeqCallingTheFunctionInTheRightOrder() {
  ...
  @Test public void shouldTabulateTheSeqWith0Elements() {
    assertThat(mapTabulate(0, (i) -> new Tuple2<>(i, i))).isEqualTo(empty());
  }

  @Test public void shouldTabulateTheSeqWith0ElementsWhenNIsNegative() {
    assertThat(mapTabulate(-1, (i) -> new Tuple2<>(i, i))).isEqualTo(empty());
  }

  @SuppressWarnings(value = { "unchecked" }) @Test public void shouldFillTheSeqCallingTheSupplierInTheRightOrder() {
    final LinkedList<Integer> ints = new LinkedList<>(asList(0, 0, 1, 1, 2, 2));
  ...
  @Test public void shouldFillTheSeqWith0Elements() {
    assertThat(mapFill(0, () -> new Tuple2<>(1, 1))).isEqualTo(empty());
  }

  @Test public void shouldReturnSingleMapAfterFillWithConstantKeys() {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void mapOfTuplesShouldReturnTheSingletonEmpty() {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void mapOfEntriesShouldReturnTheSingletonEmpty() {
    if (!emptyMapShouldBeSingleton()) {
      return;
    }
  ...
  @Test public void shouldBiFilterWork() throws Exception {
  ...
  @Test public void shouldKeyFilterWork() throws Exception {
    final Map<Integer, String> src = mapTabulate(20, (n) -> Tuple.of(n, Integer.toHexString(n)));
  ...
  @Test public void shouldValueFilterWork() throws Exception {
  ...
  @Test public void biFilterNotShouldWork() {
    final Map<Integer, String> src = mapTabulate(20, (n) -> Tuple.of(n, Integer.toHexString(n)));
    final Pattern isDigits = Pattern.compile("^\\d+$");
  ...
  @Test public void keyFilterNotShouldWork() {
    final Map<Integer, String> src = mapTabulate(20, (n) -> Tuple.of(n, Integer.toHexString(n)));
  ...
  @Test public void valueFilterNotShouldWork() {
  ...
  @Test public void shouldComputeIfAbsent() {
  ...
  @Test public void shouldComputeIfPresent() {
    final Map<Integer, String> map = emptyIntString().put(1, "v");
  ...
  @Test public void shouldReturnOptionOfNullWhenAccessingKeysSetToNull() {
    final Map<String, String> map = mapOf("1", null);
    assertThat(map.get("1")).isEqualTo(Option.some(null));
  }

  @Test public void shouldReturnOptionOfKeyWhenAccessingPresentKeysInAMapWithNulls() {
    final Map<String, String> map = mapOf("1", "a").put("2", null);
    assertThat(map.get("1")).isEqualTo(Option.of("a"));
  }

  @Test public void shouldReturnNoneWhenAccessingAbsentKeysInAMapWithNulls() {
    final Map<String, String> map = mapOf("1", "a").put("2", null);
    assertThat(map.get("3")).isEqualTo(Option.none());
  }

  @Test public void shouldReturnSameInstanceIfReplacingCurrentValueWithNonExistingKey() {
  ...
  @Test public void shouldReplaceCurrentValueForExistingKey() {
    final Map<Integer, String> map = mapOf(1, "a", 2, "b");
  ...
  @Test public void shouldReplaceCurrentValueForExistingKeyAndEqualOldValue() {
    final Map<Integer, String> map = mapOf(1, "a", 2, "b");
  ...
  @Test public void shouldReturnSameInstanceForExistingKeyAndNonEqualOldValue() {
    final Map<Integer, String> map = mapOf(1, "a", 2, "b");
    final Map<Integer, String> actual = map.replace(2, "d", "c");
    assertThat(actual).isSameAs(map);
  }

  @Test public void shouldReturnSameInstanceIfReplacingCurrentValueWithOldValueWithNonExistingKey() {
    final Map<Integer, String> map = mapOf(1, "a", 2, "b");
    final Map<Integer, String> actual = map.replace(3, "?", "!");
    assertThat(actual).isSameAs(map);
  }

  @Test public void shouldReplaceAllValuesWithFunctionResult() {
    final Map<Integer, String> map = mapOf(1, "a", 2, "b");
  ...
  @Test public void shouldHaveSizedSpliterator() {
    assertThat(of(1, 2, 3).spliterator().hasCharacteristics(Spliterator.SIZED | Spliterator.SUBSIZED)).isTrue();
  }

  @Test public void shouldHaveDistinctSpliterator() {
    assertThat(of(1, 2, 3).spliterator().hasCharacteristics(Spliterator.DISTINCT)).isTrue();
  }

  @Test public void shouldReturnSizeWhenSpliterator() {
    assertThat(of(1, 2, 3).spliterator().getExactSizeIfKnown()).isEqualTo(3);
  }

  @Override @Test @SuppressWarnings(value = { "unchecked" }) public void shouldPartitionIntsInOddAndEvenHavingOddAndEvenNumbers() {
  ...
  @Override @Test @SuppressWarnings(value = { "unchecked" }) public void shouldSpanNonNil() {
  ...
  @Override @Test @SuppressWarnings(value = { "unchecked" }) public void shouldSpanAndNotTruncate() {
  ...
  @Override @Test public void shouldNonNilGroupByIdentity() {
