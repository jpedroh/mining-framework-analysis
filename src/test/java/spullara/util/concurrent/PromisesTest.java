...
public class PromisesTest {
  ...
  @Test public void testPromises() throws Exception {
    ...
    try {
      promise5.map(new Mapper<String, Object>() {
        @Override public Object map(String s) {
          return null;
        }
      }).get();
    ...
    Promise<Object> map1 = promise.join(promise2).map(new Mapper<Pair<String, String>, Object>() {
      @Override public Object map(Pair<String, String> stringStringTuple2) {
    ...
    assertEquals("Flatmapped: Constant", promise2.flatMap(new Mapper<String, Promise<String>>() {
      @Override public Promise<String> map(String s) {
        return promise3;
      }
...
<<<<<<< /usr/src/app/output/spullara/java-future-jdk8/0e8ce31ebd03ba223dda4339601f61b8ffd53ace/src/test/java/spullara/util/concurrent/PromisesTest.java/left.java
    result11 = new Promise<>()
=======
    promise11 = new Promise<String>()
>>>>>>> /usr/src/app/output/spullara/java-future-jdk8/0e8ce31ebd03ba223dda4339601f61b8ffd53ace/src/test/java/spullara/util/concurrent/PromisesTest.java/right.java
    ;
    try {
    ...
    assertEquals(Arrays.asList("Done.", "Done2.", "Constant"), Promises.collect(Arrays.asList(promise, promise2, promise3)).map(new Mapper<List<String>, List<String>>() {
      @Override public List<String> map(List<String> list) {
        return list;
      }
    }).get());
    assertEquals(Arrays.asList(), Promises.collect(Collections.<Promise<String>>emptyList()).map(new Mapper<List<String>, List<String>>() {
      @Override public List<String> map(List<String> list) {
        return list;
      }
    }).get());
