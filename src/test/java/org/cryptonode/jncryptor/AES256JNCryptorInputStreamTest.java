...
public class AES256JNCryptorInputStreamTest {
   ...
   * @throws Exception
   */
  @Test public void testUsingRead() throws Exception {
   ...
   * @throws Exception
   */
  @Test public void testUsingReadByteArrayWithOffset() throws Exception {
   ...
   * @throws Exception
   */
  @Test public void testUsingReadByteArray() throws Exception {
    byte[] plaintext = getRandomBytes(256);
    final String password = "Testing1234";
    JNCryptor cryptor = new AES256JNCryptor();
    byte[] data = cryptor.encryptData(plaintext, password.toCharArray());
   ...
   * @throws Exception
   */
  @Test public void testUsingReadByteArrayLargeBufferIssue6() throws Exception {
   ...
   * @throws Exception
   */
  @Test(expected = IOException.class) public void testUsingMismatchedKeys() throws Exception {
    byte[] plaintext = getRandomBytes(256);
   ...
   * @throws Exception
   */
  @Test public void testUsingKeys() throws Exception {
    byte[] plaintext = getRandomBytes(256);
    byte[] encryptionSalt = getRandomBytes(8);
    byte[] hmacSalt = getRandomBytes(8);
    final String password = "Testing1234";
   ...
   * @throws Exception
   */
  @Test(expected = StreamIntegrityException.class) public void testBadHMAC() throws Exception {
    byte[] plaintext = getRandomBytes(256);
    final String password = "Testing1234";
    JNCryptor cryptor = new AES256JNCryptor();
    byte[] data = cryptor.encryptData(plaintext, password.toCharArray());
   ...
   * @throws Exception
   */
  @Test(expected = StreamIntegrityException.class) public void testBadHMACExactLength() throws Exception {
    byte[] plaintext = getRandomBytes(256);
    final String password = "Testing1234";
    JNCryptor cryptor = new AES256JNCryptor();
    byte[] data = cryptor.encryptData(plaintext, password.toCharArray());
   ...
   * @throws Exception
   */
  @Test(expected = StreamIntegrityException.class) public void testBadHMACExactLengthByByte() throws Exception {
    byte[] plaintext = getRandomBytes(256);
    final String password = "Testing1234";
    JNCryptor cryptor = new AES256JNCryptor();
    byte[] data = cryptor.encryptData(plaintext, password.toCharArray());
