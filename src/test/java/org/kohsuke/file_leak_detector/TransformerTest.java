 ...
 */
@RunWith(value = Parameterized.class) public class TransformerTest {
  ...
  @Test public void testInstrumentations() throws Exception {
  ...
  @Parameters public static List<Object[]> specs() throws Exception {
