...
public class SandboxTransformerTest {
  ...
  @Issue(value = "SECURITY-1754") @Test public void blocksDirectCallsToSyntheticConstructors() throws Exception {
  ...
  @Test public void forLoopDummyParameterIsNotDeclared() {
    sandboxedEval("for (int i = 0; i < 1; i++) {\n" + "  println(forLoopDummyParameter)\n" + "}\n", ShouldFail.class, (e) -> ec.checkThat(e.getMessage(), containsString("No such property: forLoopDummyParameter")));
  }
