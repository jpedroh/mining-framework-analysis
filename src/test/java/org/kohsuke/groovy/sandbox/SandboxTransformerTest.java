...
public class SandboxTransformerTest {
  ...
  private void assertFailsWithSameException(String expression) {
    ...
    ec.checkThat("Sandboxed and unsandboxed exception should have the same type", unsandboxedException.get().getClass(), equalTo(sandboxedException.get().getClass()));
    ec.checkThat("Sandboxed and unsandboxed exception should have the same message", unsandboxedException.get().getMessage(), equalTo(sandboxedException.get().getMessage()));
  }

  @Issue(value = "SECURITY-1465") @Test public void sandboxTransformsMethodPointerLhs() throws Exception {
  ...
  @Issue(value = "SECURITY-1465") @Test public void sandboxTransformsMethodPointerRhs() throws Exception {
    try {
  ...
  @Issue(value = "SECURITY-1465") @Test public void sandboxWillNotCastNonStandardCollections() throws Exception {
    sandboxedEval("def i = 0\n" + "(({-> if(i) {\n" + "    return [\'secret.txt\'] as Object[]\n" + "  } else {\n" + "    i = 1\n" + "    return null\n" + "  }\n" + "} as Collection) as File) as Object[]", ShouldFail.class, (e) -> {
      assertThat(e, instanceOf(UnsupportedOperationException.class));
      assertThat(e.getMessage(), containsString("Casting non-standard Collections to a type via constructor is not supported."));
    });
  }

  @Issue(value = "SECURITY-1465") @Test public void sandboxWillNotCastNonStandardCollectionsEvenIfHarmless() throws Exception {
  ...
  @Issue(value = "SECURITY-1465") @Test public void sandboxWillCastStandardCollections() throws Exception {
  ...
  @Issue(value = "SECURITY-1465") @Test public void sandboxInterceptsEnumClassToArrayCasts() throws Exception {
  ...
  @Issue(value = "SECURITY-1538") @Test public void sandboxTransformsMethodNameInMethodCalls() throws Exception {
    assertIntercept("1.({ System.getProperties(); \'toString\' }())()", "1", "Script1$_run_closure1.call()", "System:getProperties()", "Integer.toString()");
  }

  @Issue(value = "SECURITY-1538") @Test public void sandboxTransformsPropertyNameInLhsOfAssignmentOps() throws Exception {
    assertIntercept("class Test {\n" + "  def x\n" + "}\n" + "def t = new Test()\n" + "t.({\n" + "  System.getProperties()\n" + "  \'x\'\n" + "}()) = 1\n" + "t.x", 1, "new Test()", "Script1$_run_closure1.call()", "System:getProperties()", "Test.x=Integer", "Test.x");
  }

  @Issue(value = "SECURITY-1538") @Test public void sandboxTransformsPropertyNameInPrefixPostfixOps() throws Exception {
    assertIntercept("class Test {\n" + "  def x = 0\n" + "}\n" + "def t = new Test()\n" + "(t.({\n" + "  System.getProperties()\n" + "  \'x\'\n" + "}()))++\n" + "t.x", 1, "new Test()", "Script1$_run_closure1.call()", "System:getProperties()", "Test.x", "Integer.next()", "Test.x=Integer", "Test.x");
  }

  @Issue(value = "SECURITY-1538") @Test public void sandboxTransformsComplexExpressionsInPrefixOps() throws Exception {
    assertIntercept("++({ System.getProperties(); 1 }())", 2, "Script1$_run_closure1.call()", "System:getProperties()", "Integer.next()");
  }

  @Issue(value = "SECURITY-1538") @Test public void sandboxTransformsComplexExpressionsInPostfixOps() throws Exception {
  ...
  @Issue(value = "SECURITY-1658") @Test public void sandboxTransformsInitialExpressionsForClosureParameters() throws Exception {
    assertIntercept("({ p = System.getProperties() -> true })()", true, "Script1$_run_closure1.call()", "System:getProperties()");
  }

  @Issue(value = "SECURITY-1754") @Test public void interceptThisConstructorCalls() throws Exception {
    assertIntercept("class Superclass { }\n" + "class Subclass extends Superclass {\n" + "  Subclass() { this(1) }\n" + "  Subclass(int x) {  }\n" + "}\n" + "new Subclass()\n" + "null", null, "new Subclass()", "new Subclass(Integer)", "new Superclass()");
  }

  @Issue(value = { "SECURITY-1754", "SECURITY-2824" }) @Test public void blocksDirectCallsToSyntheticConstructors() throws Exception {
    sandboxedEval("class Superclass { }\n" + "class Subclass extends Superclass {\n" + "  Subclass() { }\n" + "}\n" + "new Subclass(null)\n", ShouldFail.class, (e) -> assertThat(e.getMessage(), equalTo("Rejecting illegal call to synthetic constructor: private Subclass(org.kohsuke.groovy.sandbox.impl.Checker$SuperConstructorWrapper). " + "Perhaps you meant to use one of these constructors instead: public Subclass()")));
  ...
  @Issue(value = "SECURITY-1754") @Test public void blocksCallsToSyntheticConstructorsViaOtherConstructors() throws Exception {
    sandboxedEval("class Superclass { }\n" + "class Subclass extends Superclass {\n" + "  Subclass() { }\n" + "  Subclass(int x, int y) { this(null) }\n" + "}\n" + "new Subclass(1, 2)\n", ShouldFail.class, (e) -> assertThat(e.getMessage(), equalTo("Rejecting illegal call to synthetic constructor: private Subclass(org.kohsuke.groovy.sandbox.impl.Checker$SuperConstructorWrapper). " + "Perhaps you meant to use one of these constructors instead: public Subclass(), public Subclass(int,int)")));
  }

  @Issue(value = "SECURITY-1754") @Test public void blocksUnintendedCallsToNonSyntheticConstructors() throws Exception {
    sandboxedEval("class B { }\n" + "class F extends B { }\n" + "class S extends B {\n" + "  Object scw\n" + "  S(Object o) { }\n" + "  S(Object o, F f) { scw = o }\n" + "}\n" + "new S(new F()).scw", ShouldFail.class, (e) -> assertThat(e.getMessage(), equalTo("Rejecting unexpected invocation of constructor: public S(java.lang.Object,F). " + "Expected to invoke synthetic constructor: private S(org.kohsuke.groovy.sandbox.impl.Checker$SuperConstructorWrapper,java.lang.Object)")));
  }

  @Issue(value = "SECURITY-1754") @Test public void localVarsInIfStatementsAreNotInScopeInElseStatements() throws Exception {
    sandboxedEval("class Super { }\n" + "class Sub extends Super {\n" + "  def var\n" + "  Sub() {\n" + "    if (false)\n" + "      def $cw\n" + "    else {\n" + "      this.var = $cw\n" + "    }\n" + "  }\n" + "}\n" + "new Sub().var\n", ShouldFail.class, (e) -> assertThat(e.getMessage(), containsString("No such property: $cw for class: Sub")));
  }

  @Issue(value = "SECURITY-1754") @Test public void statementsInSyntheticConstructorsAreScopedCorrectly() throws Exception {
    assertIntercept("class Super { }\n" + "class Sub extends Super {\n" + "  Sub() {\n" + "    def x = 1\n" + "    x += 1\n" + "  }\n" + "}\n" + "new Sub()\n" + "null\n", null, "new Sub()", "new Super()");
  }

  @Issue(value = "SECURITY-2020") @Test public void sandboxedCodeRejectedWhenExecutedOutsideOfSandbox() throws Exception {
    cr.reset();
    cr.register();
    Object returnValue;
    try {
      returnValue = sandboxedSh.evaluate("class Test {\n" + "  @Override public String toString() {\n" + "    System.getProperties()\n" + "    \'test\'\n" + "  }\n" + "}\n" + "new Test()");
    }  finally {
      cr.unregister();
    }
    try {
  ...
  @Test public void sandboxInterceptsUnaryOperatorExpressions() {
    assertIntercept("def auditLog = []\n" + "def o = new SandboxTransformerTest.OperatorOverloader(auditLog, 2)\n" + "[-o, +o, ~o, *auditLog]", Arrays.asList(-2, 2, ~2, "negative", "positive", "bitwiseNegate"), "new SandboxTransformerTest$OperatorOverloader(ArrayList,Integer)", "SandboxTransformerTest$OperatorOverloader.negative()", "SandboxTransformerTest$OperatorOverloader.positive()", "SandboxTransformerTest$OperatorOverloader.bitwiseNegate()");
  }
  ...
  @Test public void rangeExpressionsSmoke() {
  ...
  private static class OperatorOverloader implements Comparable<OperatorOverloader> {
    ...
    @Override public int compareTo(OperatorOverloader other) {
  ...
  @Issue(value = "SECURITY-2824") @Test public void sandboxInterceptsImplicitCastsMethodReturnValues() {
  ...
  @Issue(value = "SECURITY-2824") @Test public void sandboxInterceptsImplicitCastsVariableAssignment() {
    assertIntercept("File file\n" + "file = [\'secret.key\']\n " + "file", new File("secret.key"), "new File(String)");
  }

  @Ignore(value = "These casts cannot be intercepted by groovy-sandbox itself without extensive modifications") @Issue(value = "SECURITY-2824") @Test public void sandboxInterceptsImplicitCastsPropertyAndAttributeAssignment() {
  ...
  @Issue(value = "SECURITY-2824") @Test public void sandboxInterceptsImplicitCastsPropertyAssignmentThisField() {
  ...
  @Issue(value = "SECURITY-2824") @Test public void sandboxInterceptsImplicitCastsArrayAssignment() {
    sandboxedEval("File[] files = [null]\n" + "files[0] = [\'secret.key\']\n" + "files[0]", ShouldFail.class, (e) -> ec.checkThat(e.toString(), equalTo("java.lang.ArrayStoreException: java.util.ArrayList")));
  }

  @Issue(value = "SECURITY-2824") @Test public void sandboxInterceptsImplicitCastsInitialParameterExpressions() {
    ...
    assertIntercept("class Test {\n" + "  def x\n" + "  Test(File file = [\'secret.key\']) {\n" + "   x = file\n" + "  }\n" + "}\n" + "new Test().x", new File("secret.key"), "new Test()", "new File(String)", "Test.x");
  }

  @Issue(value = "SECURITY-2824") @Test public void sandboxInterceptsImplicitCastsFields() {
  ...
  @Issue(value = "SECURITY-2824") @Test public void sandboxInterceptsElementCastsInArrayCasts() {
  ...
  @Issue(value = "SECURITY-2824") @Test public void sandboxUsesCastToTypeForImplicitCasts() {
  ...
  @Test public void sandboxInterceptsAttributeExpressionsInPrefixPostfixOps() {
    assertIntercept("class Test { int x }\n" + "def t = new Test()\n" + "t.@x++\n" + "t.@x\n", 1, "new Test()", "Test.@x", "Integer.next()", "Test.@x=Integer", "Test.@x");
  }

  @Test public void sandboxInterceptsEnums() {
  ...
  @Test public void sandboxInterceptsBooleanCasts() {
  ...
  @Test public void sandboxInterceptsCastsToAbstractClasses() throws Throwable {
    ...
    assertIntercept("def proxy = { -> \'overridden\' } as org.kohsuke.groovy.sandbox.SandboxTransformerTest.AbstractClass\n" + "[proxy.get(), proxy.get2()]", Arrays.asList("overridden", "overridden"), "new SandboxTransformerTest$AbstractClass()", "SandboxTransformerTest$AbstractClass" + counter + "_groovyProxy.get()", "SandboxTransformerTest$AbstractClass" + counter + "_groovyProxy.get2()");
    counter = pxyCounter.get() + 1;
    assertIntercept("def proxy = [\'get\': { -> \'overridden\' }] as org.kohsuke.groovy.sandbox.SandboxTransformerTest.AbstractClass\n" + "[proxy.get(), proxy.get2()]", Arrays.asList("overridden", "default"), "new SandboxTransformerTest$AbstractClass()", "SandboxTransformerTest$AbstractClass" + counter + "_groovyProxy.get()", "SandboxTransformerTest$AbstractClass" + counter + "_groovyProxy.get2()");
  }
  ...
  @Test public void sandboxDoesNotMutateReturnStatementConstant() {
    sandboxedEval("", null, null);
    sandboxedEval("", null, null);
    unsandboxedEval("", null, ec::addError);
  }

  @Issue(value = "JENKINS-69899") @Test public void sandboxDoesNotCastEmptyExpression() {
    assertIntercept("@groovy.transform.Field String x", null);
    assertIntercept("@groovy.transform.Field String x; x = null", null);
  }

  @Test public void sandboxSupportsConstructorsWithVarArgs() throws Exception {
  ...
  @Test public void sandboxSupportsReturnStatementsInClosures() throws Exception {
  ...
  @Test public void sandboxSupportsFinalFields() {
  ...
  @Test public void sandboxDoesNotRecurseInfinitelyInSetters() {
  ...
  @Test public void sandboxDoesNotPerformImplicitCastsForOverloadedOperators() {
    assertFailsWithSameException("class OverridePlus {\n" + "  def file\n" + "  OverridePlus plus(File file) {\n" + "    this.file = file\n" + "    this\n" + "  }\n" + "}\n" + "new OverridePlus() + [\'secret.key\']\n");
  }

  @Issue(value = "JENKINS-70080") @Test public void sandboxSupportsCompoundAssignmentsToFields() throws Throwable {
