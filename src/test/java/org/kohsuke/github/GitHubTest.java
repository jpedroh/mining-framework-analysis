...
public class GitHubTest extends AbstractGitHubWireMockTest {
  @Test public void listUsers() throws IOException {
    for (GHUser u : Iterables.limit(gitHub.listUsers(), 10)) {
      assert u.getName() != null;
    }
  }

  @Test public void getOrgs() throws IOException {
    int iterations = 10;
  ...
  @Test public void searchUsers() throws Exception {
  ...
  @Test public void testListAllRepositories() throws Exception {
  ...
  @Test public void searchContent() throws Exception {
  ...
  @Test public void testListMyAuthorizations() throws IOException {
  ...
  @Test public void getMeta() throws IOException {
