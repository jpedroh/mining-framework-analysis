...
public class JSONAssertTest {
  @Test public void testString() throws JSONException {
  ...
  @Test public void testNumber() throws JSONException {
    ...
    testFail("310.1e-1", "31.01", STRICT);
  }

  @Test public void testSimple() throws JSONException {
  ...
  @Test public void testSimpleStrict() throws JSONException {
  ...
  @Test public void testReversed() throws JSONException {
  ...
  @Test public void testArray() throws JSONException {
  ...
  @Test public void testNested() throws JSONException {
    testPass("{id:1,address:{addr1:\"123 Main\", addr2:null, city:\"Houston\", state:\"TX\"}}", "{id:1,address:{addr1:\"123 Main\", addr2:null, city:\"Houston\", state:\"TX\"}}", STRICT);
    testFail("{id:1,address:{addr1:\"123 Main\", addr2:null, city:\"Houston\", state:\"TX\"}}", "{id:1,address:{addr1:\"123 Main\", addr2:null, city:\"Austin\", state:\"TX\"}}", STRICT);
  }

  @Test public void testVeryNested() throws JSONException {
    testPass("{a:{b:{c:{d:{e:{f:{g:{h:{i:{j:{k:{l:{m:{n:{o:{p:\"blah\"}}}}}}}}}}}}}}}}", "{a:{b:{c:{d:{e:{f:{g:{h:{i:{j:{k:{l:{m:{n:{o:{p:\"blah\"}}}}}}}}}}}}}}}}", STRICT);
    testFail("{a:{b:{c:{d:{e:{f:{g:{h:{i:{j:{k:{l:{m:{n:{o:{p:\"blah\"}}}}}}}}}}}}}}}}", "{a:{b:{c:{d:{e:{f:{g:{h:{i:{j:{k:{l:{m:{n:{o:{z:\"blah\"}}}}}}}}}}}}}}}}", STRICT);
  }

  @Test public void testSimpleArray() throws JSONException {
    testPass("{id:1,pets:[\"dog\",\"cat\",\"fish\"]}", "{id:1,pets:[\"dog\",\"cat\",\"fish\"]}", STRICT);
    testFail("{id:1,pets:[\"dog\",\"cat\",\"fish\"]}", "{id:1,pets:[\"dog\",\"fish\",\"cat\"]}", STRICT);
    testPass("{id:1,pets:[\"dog\",\"cat\",\"fish\"]}", "{id:1,pets:[\"dog\",\"fish\",\"cat\"]}", LENIENT);
    testPass("{id:1,pets:[\"dog\",\"cat\",\"fish\"]}", "{id:1,pets:[\"dog\",\"fish\",\"cat\"]}", NON_EXTENSIBLE);
    testFail("{id:1,pets:[\"dog\",\"cat\",\"fish\"]}", "{id:1,pets:[\"dog\",\"fish\",\"cat\"]}", STRICT_ORDER);
    testFail("{id:1,pets:[\"dog\",\"cat\",\"fish\"]}", "{id:1,pets:[\"dog\",\"cat\",\"bird\"]}", STRICT);
    testFail("{id:1,pets:[\"dog\",\"cat\",\"fish\"]}", "{id:1,pets:[\"dog\",\"cat\",\"bird\"]}", LENIENT);
    testFail("{id:1,pets:[\"dog\",\"cat\",\"fish\"]}", "{id:1,pets:[\"dog\",\"cat\",\"bird\"]}", STRICT_ORDER);
    testFail("{id:1,pets:[\"dog\",\"cat\",\"fish\"]}", "{id:1,pets:[\"dog\",\"cat\",\"bird\"]}", NON_EXTENSIBLE);
  }

  @Test public void testSimpleMixedArray() throws JSONException {
    testPass("{stuff:[321, \"abc\"]}", "{stuff:[\"abc\", 321]}", LENIENT);
    testFail("{stuff:[321, \"abc\"]}", "{stuff:[\"abc\", 789]}", LENIENT);
  }

  @Test public void testComplexMixedStrictArray() throws JSONException {
    testPass("{stuff:[{pet:\"cat\"},{car:\"Ford\"}]}", "{stuff:[{pet:\"cat\"},{car:\"Ford\"}]}", STRICT);
  }

  @Test public void testComplexMixedArray() throws JSONException {
    testPass("{stuff:[{pet:\"cat\"},{car:\"Ford\"}]}", "{stuff:[{pet:\"cat\"},{car:\"Ford\"}]}", LENIENT);
  }

  @Test public void testComplexArrayNoUniqueID() throws JSONException {
    testPass("{stuff:[{address:{addr1:\"123 Main\"}}, {address:{addr1:\"234 Broad\"}}]}", "{stuff:[{address:{addr1:\"123 Main\"}}, {address:{addr1:\"234 Broad\"}}]}", LENIENT);
  }

  @Test public void testSimpleAndComplexStrictArray() throws JSONException {
    testPass("{stuff:[123,{a:\"b\"}]}", "{stuff:[123,{a:\"b\"}]}", STRICT);
  }

  @Test public void testSimpleAndComplexArray() throws JSONException {
    testPass("{stuff:[123,{a:\"b\"}]}", "{stuff:[123,{a:\"b\"}]}", LENIENT);
  }

  @Test public void testComplexArray() throws JSONException {
    testPass("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", STRICT);
    testFail("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:3,name:\"Sue\",pets:[\"fish\",\"bird\"]},{id:2,name:\"Pat\",pets:[\"dog\"]}],pets:[]}", STRICT);
    testFail("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:3,name:\"Sue\",pets:[\"fish\",\"bird\"]},{id:2,name:\"Pat\",pets:[\"dog\"]}],pets:[]}", STRICT_ORDER);
    testPass("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:3,name:\"Sue\",pets:[\"fish\",\"bird\"]},{id:2,name:\"Pat\",pets:[\"dog\"]}],pets:[]}", LENIENT);
    testPass("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:3,name:\"Sue\",pets:[\"fish\",\"bird\"]},{id:2,name:\"Pat\",pets:[\"dog\"]}],pets:[]}", NON_EXTENSIBLE);
    testFail("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"cat\",\"fish\"]}],pets:[]}", STRICT);
    testFail("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"cat\",\"fish\"]}],pets:[]}", LENIENT);
    testFail("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"cat\",\"fish\"]}],pets:[]}", STRICT_ORDER);
    testFail("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"cat\",\"fish\"]}],pets:[]}", NON_EXTENSIBLE);
  }

  @Test public void testArrayOfArraysStrict() throws JSONException {
  ...
  @Test public void testArrayOfArrays() throws JSONException {
    testPass("{id:1,stuff:[[4,3],[3,2],[],[1,2]]}", "{id:1,stuff:[[1,2],[2,3],[],[3,4]]}", LENIENT);
  }

  @Test public void testLenientArrayRecursion() throws JSONException {
    testPass("[{\"arr\":[5, 2, 1]}]", "[{\"b\":3, \"arr\":[1, 5, 2]}]", LENIENT);
  }

  @Test public void testFieldMismatch() throws JSONException {
  ...
  @Test public void testBooleanArray() throws JSONException {
  ...
  @Test public void testNullProperty() throws JSONException {
    testFail("{id:1,name:\"Joe\"}", "{id:1,name:null}", STRICT);
    testFail("{id:1,name:null}", "{id:1,name:\"Joe\"}", STRICT);
  }

  @Test public void testIncorrectTypes() throws JSONException {
    testFail("{id:1,name:\"Joe\"}", "{id:1,name:[]}", STRICT);
    testFail("{id:1,name:[]}", "{id:1,name:\"Joe\"}", STRICT);
  }

  @Test public void testNullEquality() throws JSONException {
    testPass("{id:1,name:null}", "{id:1,name:null}", STRICT);
  }

  @Test public void testExpectedArrayButActualObject() throws JSONException {
    testFail("[1]", "{id:1}", LENIENT);
  }

  @Test public void testExpectedObjectButActualArray() throws JSONException {
    testFail("{id:1}", "[1]", LENIENT);
  }

  @Test public void testEquivalentIntAndLong() throws JSONException {
  ...
  @Test public void testEquivalentIntAndDouble() throws JSONException {
    JSONObject expected = new JSONObject();
    JSONObject actual = new JSONObject();
    expected.put("id", Integer.valueOf(12345));
  ...
  @Test(expected = AssertionError.class) public void testAssertNotEqualsWhenEqualStrict() throws JSONException {
    JSONObject expected = new JSONObject();
    JSONObject actual = new JSONObject();
    expected.put("id", Integer.valueOf(12345));
  ...
  @Test(expected = AssertionError.class) public void testAssertNotEqualsWhenEqualLenient() throws JSONException {
    JSONObject expected = new JSONObject();
    JSONObject actual = new JSONObject();
    expected.put("id", Integer.valueOf(12345));
    actual.put("id", Double.valueOf(12345));
  ...
  @Test public void testAssertNotEqualsWhenEqualDiffObjectsStrict() throws JSONException {
    JSONObject expected = new JSONObject();
    JSONObject actual = new JSONObject();
    expected.put("id", Integer.valueOf(12345));
  ...
  @Test(expected = AssertionError.class) public void testAssertNotEqualsWhenEqualDiffObjectsLenient() throws JSONException {
    JSONObject expected = new JSONObject();
    JSONObject actual = new JSONObject();
    expected.put("id", Integer.valueOf(12345));
    expected.put("name", "Joe");
  ...
  @Test public void testAssertNotEqualsWhenDifferentStrict() throws JSONException {
    JSONObject expected = new JSONObject();
    JSONObject actual = new JSONObject();
    expected.put("id", Integer.valueOf(12345));
  ...
  @Test public void testAssertNotEqualsWhenDifferentLenient() throws JSONException {
    JSONObject expected = new JSONObject();
    JSONObject actual = new JSONObject();
    expected.put("id", Integer.valueOf(12345));
    actual.put("id", Double.valueOf(12346));
  ...
  @Test public void testAssertNotEqualsString() throws JSONException {
  ...
  @Test public void testAssertEqualsString() throws JSONException {
  ...
  @Test public void testAssertNotEqualsStringAndJSONObject() throws JSONException {
    JSONObject actual = new JSONObject();
    actual.put("id", Double.valueOf(12345));
  ...
  @Test public void testAssertNotEqualsJSONArray() throws JSONException {
  ...
  @Test public void testWildCard() throws JSONException {
    testPass("{id:**,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", STRICT, "**");
    testPass("{id:\"**\",name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", STRICT, "**");
    testFail("{id:1,name:**,friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:3,name:\"Sue\",pets:[\"fish\",\"bird\"]},{id:2,name:\"Pat\",pets:[\"dog\"]}],pets:[]}", STRICT, "**");
    testFail("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:**},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:3,name:\"Sue\",pets:[\"fish\",\"bird\"]},{id:2,name:\"Pat\",pets:[\"dog\"]}],pets:[]}", STRICT_ORDER, "**");
    testPass("{id:1,name:\"Joe\",friends:**,pets:[]}", "{id:1,name:\"Joe\",friends:[{id:3,name:\"Sue\",pets:[\"fish\",\"bird\"]},{id:2,name:\"Pat\",pets:[\"dog\"]}],pets:[]}", LENIENT, "**");
    testPass("{id:1,name:\"Joe\",friends:\"**\",pets:[]}", "{id:1,name:\"Joe\",friends:[{id:3,name:\"Sue\",pets:[\"fish\",\"bird\"]},{id:2,name:\"Pat\",pets:[\"dog\"]}],pets:[]}", LENIENT, "**");
    testPass("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:**}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:3,name:\"Sue\",pets:[\"fish\",\"bird\"]},{id:2,name:\"Pat\",pets:[\"dog\"]}],pets:[]}", NON_EXTENSIBLE, "**");
    testFail("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"bird\",\"fish\"]}],pets:++}", "{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"cat\",\"fish\"]}],pets:[]}", STRICT, "++");
    testPass("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:++}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"cat\",\"fish\"]}],pets:[]}", STRICT, "++");
    testPass("{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:\"++\"}],pets:[]}", "{id:1,name:\"Joe\",friends:[{id:2,name:\"Pat\",pets:[\"dog\"]},{id:3,name:\"Sue\",pets:[\"cat\",\"fish\"]}],pets:[]}", STRICT, "++");
  }

  @Test public void testAssertEqualsStringJSONArrayBooleanWithMessage() throws JSONException {
    JSONArray actual = new JSONArray(Arrays.asList(1, 2, 3));
  ...
  @Test public void testAssertEqualsStringJSONArrayCompareModeWithMessage() throws JSONException {
    JSONArray actual = new JSONArray(Arrays.asList(1, 2, 3));
  ...
  @Test public void testAssertEqualsJSONArray2BooleanWithMessage() throws JSONException {
    JSONArray actual = new JSONArray(Arrays.asList(1, 2, 3));
  ...
  @Test public void testAssertEqualsJSONArray2JSONCompareWithMessage() throws JSONException {
    JSONArray actual = new JSONArray(Arrays.asList(1, 2, 3));
  ...
  @Test public void testAssertEqualsString2Boolean() throws JSONException {
  ...
  @Test public void testAssertEqualsString2JSONCompare() throws JSONException {
  ...
  @Test public void testAssertEqualsStringJSONObjectBoolean() throws JSONException {
    JSONObject actual = new JSONObject();
    actual.put("id", Double.valueOf(12345));
  ...
  @Test public void testAssertEqualsStringJSONObjectJSONCompare() throws JSONException {
    JSONObject actual = new JSONObject();
    actual.put("id", Double.valueOf(12345));
  ...
  @Test public void testAssertEqualsJSONObject2JSONCompare() throws JSONException {
    JSONObject expected = new JSONObject();
    JSONObject actual = new JSONObject();
    expected.put("id", Integer.valueOf(12345));
    actual.put("name", "Joe");
  ...
  @Test public void testAssertEqualsJSONObject2Boolean() throws JSONException {
    JSONObject expected = new JSONObject();
    JSONObject actual = new JSONObject();
    expected.put("id", Integer.valueOf(12345));
    actual.put("name", "Joe");
  ...
  @Test public void testAssertEqualsString2JsonComparator() throws IllegalArgumentException, JSONException {
    JSONAssert.assertEquals("Message", "{\"entry\":{\"id\":x}}", "{\"entry\":{\"id\":1, \"id\":2}}", new CustomComparator(JSONCompareMode.STRICT, new Customization("entry.id", new RegularExpressionValueMatcher<Object>("\\d"))));
    performAssertEqualsTestForMessageVerification("{\"entry\":{\"id\":x}}", "{\"entry\":{\"id\":1, \"id\":as}}", new CustomComparator(JSONCompareMode.STRICT, new Customization("entry.id", new RegularExpressionValueMatcher<Object>("\\d"))));
  }

  @Test public void testAssertNotEqualsStringJSONArrayBooleanWithMessage() throws JSONException {
    JSONArray actual = new JSONArray(Arrays.asList(1, 2, 3));
  ...
  @Test public void testAssertNotEqualsStringJSONArrayCompareModeWithMessage() throws JSONException {
    JSONArray actual = new JSONArray(Arrays.asList(1, 2, 3));
  ...
  @Test public void testAssertNotEqualsJSONArray2BooleanWithMessage() throws JSONException {
    JSONArray actual = new JSONArray(Arrays.asList(1, 2, 3));
  ...
  @Test public void testAssertNotEqualsJSONArray2JSONCompareWithMessage() throws JSONException {
    JSONArray actual = new JSONArray(Arrays.asList(1, 2, 3));
  ...
  @Test public void testAssertNotEqualsString2Boolean() throws JSONException {
  ...
  @Test public void testAssertNotEqualsString2JSONCompare() throws JSONException {
  ...
  @Test public void testAssertNotEqualsStringJSONObjectBoolean() throws JSONException {
    JSONObject actual = new JSONObject();
    actual.put("id", Double.valueOf(12345));
  ...
  @Test public void testAssertNotEqualsStringJSONObjectJSONCompare() throws JSONException {
    JSONObject actual = new JSONObject();
    actual.put("id", Double.valueOf(12345));
  ...
  @Test public void testAssertNtEqualsJSONObject2JSONCompare() throws JSONException {
    JSONObject expected = new JSONObject();
    JSONObject actual = new JSONObject();
    expected.put("id", Integer.valueOf(12345));
    actual.put("name", "Joe");
  ...
  @Test public void testAssertNotEqualsJSONObject2Boolean() throws JSONException {
    JSONObject expected = new JSONObject();
    JSONObject actual = new JSONObject();
    expected.put("id", Integer.valueOf(12345));
    actual.put("name", "Joe");
  ...
  @Test public void testAssertNotEqualsString2JsonComparator() throws IllegalArgumentException, JSONException {
    JSONAssert.assertNotEquals("Message", "{\"entry\":{\"id\":x}}", "{\"entry\":{\"id\":1, \"id\":hh}}", new CustomComparator(JSONCompareMode.STRICT, new Customization("entry.id", new RegularExpressionValueMatcher<Object>("\\d"))));
    performAssertNotEqualsTestForMessageVerification("{\"entry\":{\"id\":x}}", "{\"entry\":{\"id\":1, \"id\":2}}", new CustomComparator(JSONCompareMode.STRICT, new Customization("entry.id", new RegularExpressionValueMatcher<Object>("\\d"))));
  }
  ...
  private void testPass(String expected, String actual, JSONCompareMode compareMode, String wildcard) throws JSONException {
    String message = expected + " == " + actual + " (" + compareMode + ")";
    JSONCompareResult result = JSONCompare.compareJSON(expected, actual, compareMode, wildcard);
    Assert.assertTrue(message + "\n  " + result.getMessage(), result.passed());
  }

  private void performAssertEqualsTestForMessageVerification(Object expected, Object actual, Object strictMode) throws JSONException {
    ...
    if (expected instanceof String && actual instanceof String && strictMode instanceof JSONComparator) {
      try {
        ...
        fail(testShouldFailMessage);
      } catch (AssertionError ae) {
        handleAssertionError(message, assertEqualsFailed, ae);
      }
    } else {
      if (expected instanceof String && actual instanceof JSONArray) {
        try {
          if (strictMode instanceof JSONCompareMode) {
            ...
            if (strictMode instanceof Boolean) {
        ...
        if (expected instanceof JSONArray && actual instanceof JSONArray) {
          ...
          if (expected instanceof String && actual instanceof String) {
            ...
            if (expected instanceof String && actual instanceof JSONObject) {
              try {
                if (strictMode instanceof JSONCompareMode) {
  ...
  private void testFail(String expected, String actual, JSONCompareMode compareMode, String wildcard) throws JSONException {
    String message = expected + " != " + actual + " (" + compareMode + ")";
    JSONCompareResult result = JSONCompare.compareJSON(expected, actual, compareMode, wildcard);
    Assert.assertTrue(message, result.failed());
  }

  private void performAssertNotEqualsTestForMessageVerification(Object expected, Object actual, Object strictMode) throws JSONException {
    String message = "Message";
    String testShouldFailMessage = "The test should fail so that the message in AssertionError could be verified.";
    String strictModeMessage = "strictMode must be an instance of JSONCompareMode or Boolean";
    boolean assertEqualsFailed = true;
