...
public class BsonQueryFactoryTest {
  ...
  @Test(expected = IllegalArgumentException.class) public void shouldFailWithInvalidParameter() throws Exception {
    factory.createQuery("{id:#}", new ErrorObject());
  }

  @Test(expected = IllegalArgumentException.class) public void shouldFailWhenNotEnoughParameters() throws Exception {
    factory.createQuery("{id:#,id2:#}", "123");
  }

  @Test(expected = IllegalArgumentException.class) public void shouldFailWhenTooManyParameters() throws Exception {
    factory.createQuery("{id:#}", 123, 456);
  }

  @Test public void shouldAllowToCreateNullQuery() throws Exception {
    Query query = factory.createQuery(null);
    assertThat(query.toDBObject()).isEqualTo(null);
  }

  @Test public void shouldBindOneParameter() throws Exception {
    Query query = factory.createQuery("{id:#}", 123);
    assertThat(query.toDBObject()).isEqualTo(new BasicDBObject("id", 123));
  }

  @Test public void shouldBindManyParameters() throws Exception {
  ...
  @Test public void shouldBindManyNames() throws Exception {
    Query query = factory.createQuery("{#:123, #:456}", "id", "test");
    assertThat(query.toDBObject()).isEqualTo(QueryBuilder.start("id").is(123).and("test").is(456).get());
  }

  @Test public void shouldBindNullParameter() throws Exception {
    Query query = factory.createQuery("{id:#}", null);
    assertThat(query.toDBObject()).isEqualTo(new BasicDBObject("id", null));
  }

  @Test public void shouldBindParameterWithCustomToken() throws Exception {
  ...
  @Test public void shouldBindHashSign() throws Exception {
  ...
  @Test public void shouldBindQuotationMark() throws Exception {
  ...
  @Test public void shouldBindNestedQuery() throws Exception {
  ...
  @Test public void shouldBindNestedParameter() throws Exception {
  ...
  @Test public void canSaveAndUpdateBytes() throws Exception {
  ...
  @Test public void canHandleAObjectSerializedAsAPrimitive() throws Exception {
  ...
  private static class PrimitiveJsonSerializer extends JsonSerializer<Friend> {
    @Override public void serialize(Friend friend, JsonGenerator jgen, SerializerProvider provider) throws IOException {
