...
public class QuestionsSpikeTest extends JongoTestBase {
  ...
  @Test public void complexQueryWithDriverAndJongo() throws Exception {
  ...
  @Test public void pushANonBSONObject() throws Exception {
  ...
  @Test public void canHandleElemMatchOperator() throws Exception {
  ...
  @Test public void canSelectOnlyAField() throws Exception {
  ...
  @Test public void canUpdateIntoAnArray() throws Exception {
  ...
  @Test public void canUseElemMatchWithDateParams() throws Exception {
    Date now = new Date();
  ...
  @Test public void canSetAFieldToNullDuringAnUpdate() throws Exception {
