...
public class InsertTest extends JongoTestCase {
  ...
  @Test public void canInsert() throws Exception {
    collection.insert("{name : \'Abby\'}");
    assertThat(collection.count("{name : \'Abby\'}")).isEqualTo(1);
  }

  @Test public void canInsertPojo() throws Exception {
  ...
  @Test public void canInsertPojos() throws Exception {
    Friend friend = new Friend("John");
  ...
  @Test public void canInsertWithParameters() throws Exception {
    collection.insert("{name : #}", "Abby");
    assertThat(collection.count("{name : \'Abby\'}")).isEqualTo(1);
  }

  @Test public void canInsertAnObjectWithoutId() throws Exception {
  ...
  @Test public void canInsertAPojoWithNewObjectId() throws Exception {
  ...
  @Test public void canInsertAPojoWithACustomId() throws Exception {
  ...
  @Test public void canOnlyInsertOnceAPojoWithObjectId() throws Exception {
    ObjectId id = ObjectId.get();
    collection.withWriteConcern(WriteConcern.SAFE).insert(new Friend(id, "John"));
    try {
      collection.withWriteConcern(WriteConcern.SAFE).insert(new Friend(id, "John"));
  ...
  @Test public void canOnlyInsertOnceAPojoWithACustomId() throws Exception {
    collection.withWriteConcern(WriteConcern.SAFE).insert(new ExternalFriend("122", "value"));
    try {
  ...
  @Test public void canInsertAListOfDocuments() throws Exception {
