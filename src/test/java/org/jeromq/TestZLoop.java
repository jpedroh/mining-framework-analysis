...
public class TestZLoop {
  @Test public void testZLoop() {
    ...
    ZLoop.IZLoopHandler s_timer_event = new ZLoop.IZLoopHandler() {
      @Override public int handle(ZLoop loop, PollItem item, Object arg) {
  ...
  @Test(timeout = 1000) public void testZLoopEndReactorFromTimer() {
  ...
  @Test public void testZLoopAddTimerFromTimer() {
