...
public class FallbackNarrowphaseDetectorTest {
  ...
  private static final Convex[] TYPES = new Convex[] { Geometry.createCapsule(1.0, 0.5), Geometry.createCircle(0.5), Geometry.createEllipse(1.0, 0.5), Geometry.createHalfEllipse(1.0, 0.25), Geometry.createHorizontalSegment(1.0), Geometry.createRectangle(1.0, 2.0), Geometry.createSlice(0.5, Math.toRadians(50)), Geometry.createUnitCirclePolygon(5, 0.5), Geometry.createEquilateralTriangle(1.0) };
  ...
  /**
	 ...
	 */
  @Test(expected = NullPointerException.class) public void createNullPrimary() {
  ...
  /**
	 ...
	 */
  @Test(expected = NullPointerException.class) public void createNullSecondary() {
  ...
  /**
	 ...
	 */
  @Test public void addRemoveCondition() {
    FallbackNarrowphaseDetector detector = new FallbackNarrowphaseDetector(new Sat(), new Gjk());
  ...
  /**
	 ...
	 */
  @Test public void singleTypedCondition() {
    FallbackNarrowphaseDetector detector = new FallbackNarrowphaseDetector(new Sat(), new Gjk());
  ...
  /**
	 ...
	 */
  @Test public void singleTypedConditionStrict() {
    FallbackNarrowphaseDetector detector = new FallbackNarrowphaseDetector(new Sat(), new Gjk());
  ...
  /**
	 ...
	 */
  @Test public void singleTypedConditionOrder() {
    FallbackNarrowphaseDetector detector = new FallbackNarrowphaseDetector(new Sat(), new Gjk());
    ...
    for (int i = 0; i < TYPES.length; i++) {
      for (int j = i; j < TYPES.length; j++) {
        boolean fallback = detector.isFallbackRequired(TYPES[i], TYPES[j]);
        if (TYPES[i].getClass() == Polygon.class || TYPES[j].getClass() == Polygon.class || TYPES[i].getClass() == Rectangle.class || TYPES[j].getClass() == Rectangle.class) {
          TestCase.assertTrue(fallback);
        } else {
          TestCase.assertFalse(fallback);
        }
  ...
  /**
	 ...
	 */
  @Test public void pairwiseTypedCondition() {
    FallbackNarrowphaseDetector detector = new FallbackNarrowphaseDetector(new Sat(), new Gjk());
  ...
  /**
	 * Test that fallback occurs for a type pair.
	 */
  @Test public void pairwiseTypedConditionStrict() {
    FallbackNarrowphaseDetector detector = new FallbackNarrowphaseDetector(new Sat(), new Gjk());
    detector.addCondition(new PairwiseTypedFallbackCondition(Polygon.class, Ellipse.class, true));
    for (int i = 0; i < TYPES.length; i++) {
      for (int j = i; j < TYPES.length; j++) {
        boolean fallback = detector.isFallbackRequired(TYPES[i], TYPES[j]);
        if ((TYPES[i].getClass() == Polygon.class && TYPES[j] instanceof Ellipse) || (TYPES[i] instanceof Ellipse && TYPES[j].getClass() == Polygon.class)) {
          TestCase.assertTrue(fallback);
        } else {
          TestCase.assertFalse(fallback);
        }
  ...
  /**
	 ...
	 */
  @Test public void pairwiseTypedConditionStrictOne() {
    FallbackNarrowphaseDetector detector = new FallbackNarrowphaseDetector(new Sat(), new Gjk());
    detector.addCondition(new PairwiseTypedFallbackCondition(Polygon.class, true, Polygon.class, false));
    for (int i = 0; i < TYPES.length; i++) {
      for (int j = i; j < TYPES.length; j++) {
        boolean fallback = detector.isFallbackRequired(TYPES[i], TYPES[j]);
        if ((TYPES[i].getClass() == Polygon.class && TYPES[j] instanceof Polygon) || (TYPES[i] instanceof Polygon && TYPES[j].getClass() == Polygon.class)) {
          TestCase.assertTrue(fallback);
        } else {
          TestCase.assertFalse(fallback);
        }
