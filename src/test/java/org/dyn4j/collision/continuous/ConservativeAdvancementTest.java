...
public class ConservativeAdvancementTest {
  ...
  /**
	 ...
	 */
  @Test public void afterMidPoint() {
  ...
  /**
	 ...
	 */
  @Test public void beforeMidPoint() {
    Transform t1 = new Transform();
  ...
  /**
	 ...
	 * with the slower.
	 */
  @Test public void sameDirection() {
    Transform t1 = new Transform();
    t1.translate(0.0, 1.5);
  ...
  /**
	 ...
	 */
  @Test public void orthogonalDirection() {
    Transform t1 = new Transform();
    t1.translate(0.0, 1.5);
    Vector2 dp1 = new Vector2(120.0 * TIME_STEP, 0.0);
    Convex c2 = Geometry.createSquare(0.2);
  ...
  /**
	 ...
	 */
  @Test public void sameDirectionNoCollision() {
    Transform t1 = new Transform();
    t1.translate(0.0, 1.0);
    Vector2 dp1 = new Vector2(120.0 * TIME_STEP, 0.0);
    Convex c2 = Geometry.createSquare(0.5);
  ...
  /**
	 ...
	 * but the bodies do not collide.
	 */
  @Test public void sameDirectionNoCollision2() {
    Transform t1 = new Transform();
    t1.translate(0.0, 1.0);
    Vector2 dp1 = new Vector2(120.0 * TIME_STEP, 0.0);
    Convex c2 = Geometry.createSquare(0.5);
  ...
  /**
	 ...
	 * but do not collide.
	 */
  @Test public void orthogonalDirectionNoCollision() {
    Transform t1 = new Transform();
    t1.translate(0.0, 1.0);
    Vector2 dp1 = new Vector2(120.0 * TIME_STEP, 0.0);
  ...
  /**
	 ...
	 */
  @Test public void setDistanceDetector() {
  ...
  /**
	 ...
	 * null value.
	 */
  @Test(expected = NullPointerException.class) public void setNullDistanceDetector() {
  ...
  /**
	 ...
	 */
  @Test(expected = NullPointerException.class) public void createWithNullDistanceDetector() {
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void setZeroTolerance() {
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void setNegativeTolerance() {
  ...
  /**
	 ...
	 */
  @Test public void setMaxIterations() {
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void setZeroMaxIterations() {
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void setNegativeMaxIterations() {
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void setLessThanTenMaxIterations() {
  ...
  /**
	 ...
	 */
  @Test public void fastRotationAgainstStatic() {
  ...
  /**
	 ...
	 */
  @Test public void fastRotationAgainstFastRotation() {
    Convex c1 = Geometry.createRectangle(2.0, 0.2);
    Transform t1 = new Transform();
    t1.translate(0.5, 0.0);
    t1.rotate(Math.toRadians(-40.0), t1.getTranslationX(), t1.getTranslationY());
  ...
  /**
	 ...
	 * occurs.
	 */
  @Test public void fastRotationAgainstFastRotationNoCollision() {
    Convex c1 = Geometry.createRectangle(2.0, 0.2);
    Transform t1 = new Transform();
    t1.translate(0.5, 0.0);
    t1.rotate(Math.toRadians(-40.0), t1.getTranslationX(), t1.getTranslationY());
  ...
  /**
	 ...
	 */
  @Test public void equidistantSameVelocityTest() {
  ...
  /**
	 ...
	 */
  @Test public void separationTooSmall() {
    Convex c1 = Geometry.createSquare(1.0);
    Transform t1 = new Transform();
    Vector2 dp1 = new Vector2(1.0, 0.0);
    double da1 = 0.0;
