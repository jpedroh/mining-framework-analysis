...
public class AbstractPhysicsWorldTest {
  private class TestWorld extends AbstractPhysicsWorld<Body, WorldCollisionData<Body>> {
    ...
    @Override protected WorldCollisionData<Body> createCollisionData(CollisionPair<CollisionItem<Body, BodyFixture>> pair) {
  ...
  private class StepListenerCounter implements StepListener<Body> {
    ...
    @Override public void end(TimeStep step, PhysicsWorld<Body, ?> world) {
      this.steps++;
    }
  }
  ...
  private class DestructionListenerCounter implements DestructionListener<Body> {
    ...
    @Override public void destroyed(Joint<Body> joint) {
      this.called++;
    }

    @Override public void destroyed(ContactConstraint<Body> contactConstraint) {
      this.called++;
    }

    @Override public void destroyed(Body body) {
      this.called++;
    }
  }
  ...
  private class ContactListenerCounter implements ContactListener<Body> {
    ...
    @Override public void preSolve(ContactCollisionData<Body> collision, Contact contact) {
    }

    @Override public void begin(ContactCollisionData<Body> collision, Contact contact) {
    }

    @Override public void end(ContactCollisionData<Body> collision, Contact contact) {
      this.end++;
    }

    @Override public void destroyed(ContactCollisionData<Body> collision, Contact contact) {
      this.destroyed++;
    }

    @Override public void collision(ContactCollisionData<Body> collision, ContactConstraint<Body> contactConstraint) {
    }

    @Override public void persist(ContactCollisionData<Body> collision, Contact oldContact, Contact newContact) {
    }

    @Override public void postSolve(ContactCollisionData<Body> collision, SolvedContact contact) {
    }
  }
  ...
  /**
	 ...
	 */
  @Test public void addJoint() {
    TestWorld w = new TestWorld();
    Body b1 = new Body();
    b1.addFixture(Geometry.createCapsule(1.0, 0.5));
    Body b2 = new Body();
    b2.addFixture(Geometry.createCapsule(1.0, 0.5));
  ...
  /**
	 ...
	 */
  @Test(expected = NullPointerException.class) public void addNullJoint() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void addJointFromOtherWorld() {
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void addSameJointToSameWorld() {
    TestWorld w = new TestWorld();
    Body b1 = new Body();
    Body b2 = new Body();
    Joint<Body> j = new AngleJoint<Body>(b1, b2);
  ...
  /**
	 * Tests adding a joint that's already on this world.
	 */
  @Test(expected = IllegalArgumentException.class) public void addJointWithoutBodies() {
    TestWorld w = new TestWorld();
    Body b1 = new Body();
    Body b2 = new Body();
    Joint<Body> j = new AngleJoint<Body>(b1, b2);
  ...
  /**
	 ...
	 */
  @Test(expected = UnsupportedOperationException.class) public void getJointsAndAdd() {
    TestWorld w = new TestWorld();
  ...
  /**
	 * Makes sure the returned list is unmodifiable.
	 */
  @Test(expected = UnsupportedOperationException.class) public void getJointsAndRemove() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test public void getJointAtIndex() {
    TestWorld w = new TestWorld();
    Body b1 = new Body();
    Body b2 = new Body();
    Joint<Body> j = new AngleJoint<Body>(b1, b2);
  ...
  /**
	 ...
	 */
  @Test(expected = IndexOutOfBoundsException.class) public void getJointAtNegativeIndex() {
    TestWorld w = new TestWorld();
    w.getJoint(-1);
  }
  ...
  /**
	 ...
	 */
  @Test(expected = IndexOutOfBoundsException.class) public void getJointAtBadIndex() {
    TestWorld w = new TestWorld();
    w.getJoint(1);
  }
  ...
  /**
	 * Tests the getJoint(int) method w/ a value out of range.
	 */
  @Test public void getJointCount() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test public void getJointIterator() {
    TestWorld w = new TestWorld();
  ...
  /**
	 * Tests the getJointIterator method.
	 */
  @Test public void getJointIteratorFailure() {
    TestWorld w = new TestWorld();
    Body b1 = new Body();
    Body b2 = new Body();
    w.addBody(b1);
  ...
  /**
	 ...
	 */
  @Test public void containsJoint() {
    TestWorld w = new TestWorld();
    Body b1 = new Body();
    Body b2 = new Body();
    w.addBody(b1);
  ...
  /**
	 ...
	 */
  @Test(expected = IndexOutOfBoundsException.class) public void removeJointNegativeIndex() {
    TestWorld w = new TestWorld();
    w.removeJoint(-1);
  }
  ...
  /**
	 ...
	 */
  @Test(expected = IndexOutOfBoundsException.class) public void removeJointBadIndex() {
    TestWorld w = new TestWorld();
    w.removeJoint(2);
  }
  ...
  /**
	 ...
	 */
  @Test public void removeAllJoints() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test public void fixtureModification() {
    TestWorld w = new TestWorld();
    Convex c1 = Geometry.createCircle(1.0);
    Convex c2 = Geometry.createEquilateralTriangle(0.5);
    Body b1 = new Body();
  ...
  /**
	 ...
	 */
  @Test public void getSetAccumulatedTime() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test public void getSetCoefficientMixer() {
    TestWorld w = new TestWorld();
    TestCase.assertEquals(CoefficientMixer.DEFAULT_MIXER, w.getCoefficientMixer());
    CoefficientMixer cm = new CoefficientMixer() {
      @Override public double mixRestitution(double restitution1, double restitution2) {
        return (restitution1 + restitution2) * 0.5;
      }

      @Override public double mixFriction(double friction1, double friction2) {
  ...
  /**
	 ...
	 */
  @Test(expected = NullPointerException.class) public void setNullCoefficientMixer() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test public void getSetContactConstraintSolver() {
    TestWorld w = new TestWorld();
    ContactConstraintSolver<Body> ccs = new ContactConstraintSolver<Body>() {
      @Override public void solveVelocityContraints(List<ContactConstraint<Body>> contactConstraints, TimeStep step, Settings settings) {
      }

      @Override public boolean solvePositionContraints(List<ContactConstraint<Body>> contactConstraints, TimeStep step, Settings settings) {
        return false;
      }

      @Override public void initialize(List<ContactConstraint<Body>> contactConstraints, TimeStep step, Settings settings) {
      }
    };
  ...
  /**
	 ...
	 */
  @Test(expected = NullPointerException.class) public void setNullContactConstraintSolver() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test public void getSetGravity() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test public void setNullGravity() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test(expected = NullPointerException.class) public void setNullCCDBroadphaseDetector() {
    TestWorld w = new TestWorld();
  ...
  /**
	 * Tests the set CCD broadphase detector method.
	 */
  @Test public void getAndSetCCDBroadphaseDetector() {
    TestWorld w = new TestWorld();
    Body b = new Body();
  ...
  /**
	 ...
	 * @since 2.2.2
	 */
  @Test public void isJointCollisionAllowed() {
    TestWorld w = new TestWorld();
    Body b1 = new Body();
    Body b2 = new Body();
    w.addBody(b1);
  ...
  /**
	 ...
	 */
  @Test public void getJoinedBodies() {
    TestWorld w = new TestWorld();
    Body b1 = new Body();
    Body b2 = new Body();
    w.addBody(b1);
  ...
  /**
	 ...
	 */
  @Test public void getJointsForBody() {
    TestWorld w = new TestWorld();
    Body b1 = new Body();
    Body b2 = new Body();
    w.addBody(b1);
  ...
  /**
	 ...
	 */
  @Test public void getInContactBodies() {
    TestWorld w = new TestWorld();
    Convex c1 = Geometry.createCircle(1.0);
    Convex c2 = Geometry.createEquilateralTriangle(0.5);
    Body b1 = new Body();
  ...
  /**
	 ...
	 * body.
	 */
  @Test public void getJoinedBodiesMulti() {
    TestWorld w = new TestWorld();
    Body b1 = new Body();
    Body b2 = new Body();
    w.addBody(b1);
  ...
  /**
	 ...
	 * body.
	 */
  @Test public void getInContactBodiesMulti() {
    TestWorld w = new TestWorld();
    Body b1 = new Body();
    Body b2 = new Body();
  ...
  /**
	 ...
	 */
  @Test public void setNullSettings() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test public void getSetTimeOfImpactSolver() {
    TestWorld w = new TestWorld();
  ...
  /**
	 * Tests the set contact constraint solver method passing a null value.
	 */
  @Test(expected = NullPointerException.class) public void setNullTimeOfImpactSolver() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test public void getSetUpdateRequired() {
    TestWorld w = new TestWorld();
  ...
  /**
	 ...
	 */
  @Test public void stepIntElapsed() {
    TestWorld w = new TestWorld();
    StepListenerCounter sl = new StepListenerCounter();
    w.addStepListener(sl);
    w.step(3, 1.0 / 50.0);
  ...
  /**
	 * Tests the remove body method.
	 */
  @Test public void removeBodyAtIndex() {
    TestWorld w = new TestWorld();
    DestructionListenerCounter dl = new DestructionListenerCounter();
    w.addDestructionListener(dl);
    Convex c1 = Geometry.createCircle(1.0);
  ...
  /**
	 ...
	 */
  @Test public void removeBodyMemoryLeak() {
    TestWorld w = new TestWorld();
    DestructionListenerCounter dl = new DestructionListenerCounter();
    w.addDestructionListener(dl);
    boolean success = w.removeBody((Body) null);
  ...
  /**
	 ...
	 * @since 3.0.2
	 */
  @Test public void removeAllBodies() {
    TestWorld w = new TestWorld();
    ContactListenerCounter cl = new ContactListenerCounter();
    DestructionListenerCounter dl = new DestructionListenerCounter();
    w.addContactListener(cl);
  ...
  /**
	 ...
	 * the solve stage.
	 */
  @Test public void disabledAndSensor() {
    ...
    world.addContactListener(new ContactListenerAdapter<Body>() {
      @Override public void begin(ContactCollisionData<Body> collision, Contact contact) {
        if ((collision.getBody1() == b1 && collision.getBody2() == b2) || (collision.getBody1() == b2 && collision.getBody2() == b1)) {
