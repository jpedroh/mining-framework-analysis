...
public class PrismaticJointTest extends AbstractJointTest {
  ...
  /**
	 ...
	 */
  @Test public void setMaximumMotorForce() {
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void setNegativeMaximumMotorForce() {
    PrismaticJoint<Body> pj = new PrismaticJoint<Body>(b1, b2, new Vector2(), new Vector2(0.0, 1.0));
  ...
  /**
	 ...
	 */
  @Test public void setMaximumMotorForceSleep() {
    PrismaticJoint<Body> pj = new PrismaticJoint<Body>(b1, b2, new Vector2(), new Vector2(0.0, 1.0));
