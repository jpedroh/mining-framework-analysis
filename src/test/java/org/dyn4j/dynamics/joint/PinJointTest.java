...
public class PinJointTest extends AbstractJointTest {
  ...
  /**
	 ...
	 */
  @Test(expected = NullPointerException.class) public void createWithNullBody() {
  ...
  /**
	 ...
	 */
  @Test(expected = NullPointerException.class) public void createWithNullTarget() {
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void createWithZeroFrequency() {
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void createWithNegativeFrequency() {
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void createWithGreaterThan1DampingRatio() {
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void createWithNegativeDampingRatio() {
    new PinJoint<Body>(b1, new Vector2(), 4.0, -0.4, 10.0);
  }
  ...
  /**
	 * Tests the create method passing a negative damping ratio.
	 */
  @Test(expected = IllegalArgumentException.class) public void createWithNegativeMaximumForce() {
    new PinJoint<Body>(b1, new Vector2(), 4.0, 0.4, -10.0);
  }
  ...
  /**
	 ...
	 */
  @Test(expected = NullPointerException.class) public void setNullTarget() {
    PinJoint<Body> pj = new PinJoint<Body>(b1, new Vector2(), 4.0, 0.4, 10.0);
    pj.setTarget(null);
  }
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void setNegativeDampingRatio() {
    PinJoint<Body> pj = new PinJoint<Body>(b1, new Vector2(), 4.0, 0.4, 10.0);
    pj.setDampingRatio(-1.0);
  }
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void setNegativeFrequency() {
    PinJoint<Body> pj = new PinJoint<Body>(b1, new Vector2(), 4.0, 0.4, 10.0);
    pj.setFrequency(-0.3);
  }
  ...
  /**
	 ...
	 */
  @Test(expected = IllegalArgumentException.class) public void setZeroFrequency() {
    PinJoint<Body> pj = new PinJoint<Body>(b1, new Vector2(), 4.0, 0.4, 10.0);
    pj.setFrequency(0.0);
  }
  ...
  /**
	 ...
	 */
  @Test public void setTargetSleep() {
    PinJoint<Body> pj = new PinJoint<Body>(b1, new Vector2(), 4.0, 0.4, 10.0);
