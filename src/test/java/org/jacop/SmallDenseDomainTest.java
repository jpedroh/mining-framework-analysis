 ...
 */
@RunWith(value = Parameterized.class) public class SmallDenseDomainTest {
  ...
  @Test public void testinterval25() throws InvocationTargetException, IllegalAccessException {
  ...
  @Test public void testinterval81() throws InvocationTargetException, IllegalAccessException {
    IntDomain intDomain = (IntDomain) prepareMethod.invoke(this, new Object[] { new int[] { 1, 2 } });
    intDomain.inShift(100, var, intDomain, 1);
    verify(var).domainHasChanged(IntDomain.GROUND);
  }

  @Test public void testinterval82() throws InvocationTargetException, IllegalAccessException {
    IntDomain intDomain = (IntDomain) prepareMethod.invoke(this, new Object[] { new int[] { 1, 3, 5, 7, 12, 18 } });
    intDomain.inShift(100, var, intDomain, 1);
    verify(var).domainHasChanged(IntDomain.BOUND);
  }

  @Test public void testinterval83() throws InvocationTargetException, IllegalAccessException {
    IntDomain intDomain = (IntDomain) prepareMethod.invoke(this, new Object[] { new int[] { 1, 3, 5, 7, 12, 18 } });
    intDomain.inShift(100, var, intDomain, 1);
    verify(var).domainHasChanged(IntDomain.BOUND);
  }

  @Test public void testinterval84() throws InvocationTargetException, IllegalAccessException {
    IntDomain intDomain = (IntDomain) prepareMethod.invoke(this, new Object[] { new int[] { 1, 3, 5, 7, 12, 18 } });
  ...
  @Test public void testinterval86() throws InvocationTargetException, IllegalAccessException {
    IntDomain intDomain = (IntDomain) prepareMethod.invoke(this, new Object[] { new int[] { 1, 3, 5, 7, 12, 18 } });
    IntDomain intDomain1 = mock(IntDomain.class, Mockito.CALLS_REAL_METHODS);
  ...
  @Test public void testinterval87() throws InvocationTargetException, IllegalAccessException {
  ...
  @Test public void testinterval88() throws InvocationTargetException, IllegalAccessException {
    IntDomain intDomain = (IntDomain) prepareMethod.invoke(this, new Object[] { new int[] { 5, 5 } });
    IntDomain intDomain1 = mock(IntDomain.class, Mockito.CALLS_REAL_METHODS);
  ...
  @Test public void testinterval89() throws InvocationTargetException, IllegalAccessException {
    IntDomain intDomain = (IntDomain) prepareMethod.invoke(this, new Object[] { new int[] { 5, 5 } });
    IntDomain intDomain1 = mock(IntDomain.class, Mockito.CALLS_REAL_METHODS);
  ...
  @Test public void testinterval188() throws InvocationTargetException, IllegalAccessException {
    IntDomain intDomain = (IntDomain) prepareMethod.invoke(this, new Object[] { new int[] { 1, 3, 5, 7, 12, 18 } });
    IntDomain intDomain1 = mock(IntDomain.class, Mockito.CALLS_REAL_METHODS);
  ...
  public IntDomain prepareSmallDenseDomain(int[] intervalList) {
    ...
    if (intervalList.length % 2 != 0) {
      throw new IllegalArgumentException("List must have an even number of elements" + " since the domain is a list of intervals and each interval is denoted by two elements");
    }
    if (intervalList.length < 2) {
      throw new IllegalArgumentException("List must have at least two elements since the domain" + " must have at least one interval and each interval is denoted by two integers.");
    }
