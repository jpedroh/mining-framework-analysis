...
public class WebJarAssetLocatorTest {
  @Test public void get_paths_of_asset_in_nested_folder() {
  ...
  @Test public void get_full_path_of_asset_in_root_folder() {
  ...
  @Test public void lookup_asset_multiple_times() {
    WebJarAssetLocator locator = new WebJarAssetLocator();
  ...
  @Test public void get_a_file_when_another_file_exists_that_starts_with_the_same_string() {
  ...
  @Test public void get_full_path_from_partial_path_with_folders() {
    WebJarAssetLocator locator = new WebJarAssetLocator();
  ...
  @Test public void should_throw_exception_when_asset_not_found() {
    try {
  ...
  @Test public void should_distinguish_between_multiple_versions() {
    WebJarAssetLocator locator = new WebJarAssetLocator();
  ...
  @Test public void should_throw_exceptions_when_several_matches_found() {
    try {
  ...
  @Test public void should_list_assets_in_folder() {
