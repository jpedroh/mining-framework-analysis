 ...
 */
@BeanDefinition public class ValidateBean extends DirectBean {
  /**
     * The non-null value.
     */
  @PropertyDefinition(validate = "notNull") private String first;

  /**
     * The non-empty value.
     */
  @PropertyDefinition(validate = "notEmpty") private String second;

  /**
     * The static checked value.
     */
  @PropertyDefinition(validate = "TestValidateBean.checkInTest") private String third;

  /**
     * The locally checked value.
     */
  @PropertyDefinition(validate = "checkInBean") private String fourth;
  ...
  @Override public ValidateBean.Meta metaBean() {
    return ValidateBean.Meta.INSTANCE;
  }
  ...
  @Override public ValidateBean clone() {
  ...
  @Override public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(getFirst(), other.getFirst()) && JodaBeanUtils.equal(getSecond(), other.getSecond()) && JodaBeanUtils.equal(getThird(), other.getThird()) && JodaBeanUtils.equal(getFourth(), other.getFourth());
    }
    return false;
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    /**
         ...
         */
    private final MetaProperty<String> first = DirectMetaProperty.ofReadWrite(this, "first", ValidateBean.class, String.class);

    /**
         * The meta-property for the {@code second} property.
         */
    private final MetaProperty<String> second = DirectMetaProperty.ofReadWrite(this, "second", ValidateBean.class, String.class);

    /**
         * The meta-property for the {@code third} property.
         */
    private final MetaProperty<String> third = DirectMetaProperty.ofReadWrite(this, "third", ValidateBean.class, String.class);

    /**
         * The meta-property for the {@code fourth} property.
         */
    private final MetaProperty<String> fourth = DirectMetaProperty.ofReadWrite(this, "fourth", ValidateBean.class, String.class);

    /**
         * The meta-properties.
         */
    private final Map<String, MetaProperty<?>> metaPropertyMap$ = new DirectMetaPropertyMap(this, null, "first", "second", "third", "fourth");
    ...
    @Override public BeanBuilder<? extends ValidateBean> builder() {
      return new DirectBeanBuilder<ValidateBean>(new ValidateBean());
    }

    @Override public Class<? extends ValidateBean> beanType() {
    ...
    @Override protected void validate(Bean bean) {
