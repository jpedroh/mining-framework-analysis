...
public class GelfMessageTest {
  @Test public void testAdditionalFieldsIds() throws Exception {
  ...
  @Test public void testSendLongMessage() throws Exception {
  ...
  @Test public void testAdditionalFields() throws Exception {
  ...
  @Test public void generateBallastMessage() {
    Date date = new Date();
  }
}