...
class FunctionsTest {
  ...
  public static class Testable<T extends java.lang.Object, P extends java.lang.Object> {
  ...
  @Test void testAcceptDoubleConsumer() {
    final IllegalStateException ise = new IllegalStateException();
  ...
  @Test void testAcceptLongConsumer() {
    final IllegalStateException ise = new IllegalStateException();
  ...
  @Test void testAcceptObjDoubleConsumer() {
    final IllegalStateException ise = new IllegalStateException();
  ...
  @Test void testAcceptObjIntConsumer() {
    final IllegalStateException ise = new IllegalStateException();
  ...
  @Test public void testAsFunction() {
    final IllegalStateException ise = new IllegalStateException();
    final Testable<?, ?> testable = new Testable<>(ise);
