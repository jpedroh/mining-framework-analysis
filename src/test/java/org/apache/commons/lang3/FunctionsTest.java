...
class FunctionsTest {
  private static final String ODD_INVOCATION_1 = "Odd Invocation: 1";

  private static final String UNKNOWN_IO_ERROR = "Unknown I/O error";

  public static class SomeException extends Exception {
    private static final long serialVersionUID = -4965704778119283411L;

    @SuppressWarnings(value = { "java:S1165" }) private Throwable t;
    ...
    @SuppressWarnings(value = { "java:S112" }) public void test() throws Throwable {
      if (t != null) {
        throw t;
      }
    }
  ...
  @SuppressWarnings(value = { "java:S112" }) public static class Testable {
    private Throwable t;
  ...
  public static class CloseableObject {
    ...
    @SuppressWarnings(value = { "java:S112" }) public void run(final Throwable pTh) throws Throwable {
      if (pTh != null) {
        throw pTh;
      }
    }
  ...
  @SuppressWarnings(value = { "java:S2696" }) @BeforeEach void beforeEach() {
  ...
  @Test void testRunnable() {
    ...
    assertEquals(ODD_INVOCATION_1, cause.getMessage());
...
>>>>>>> /usr/src/app/output/apache/commons-lang/dd17065cb283c129ac34fd862a2f095191aa5c1d/src/test/java/org/apache/commons/lang3/FunctionsTest.java/right.java
  ...
  @Test void testAcceptConsumer() {
    ...
    assertSame(error, e);
    final IOException ioe = new IOException(UNKNOWN_IO_ERROR);
  ...
  @Test void testAsBiConsumer() {
    final IllegalStateException ise = new IllegalStateException();
    final Testable testable = new Testable(null);
    final Functions.FailableBiConsumer<Testable, Throwable, Throwable> failableBiConsumer = (t, th) -> {
      t.setThrowable(th);
      t.test();
    };
  ...
  @SuppressWarnings(value = { "java:S4276" }) @Test public void testAsFunction() {
    final IllegalStateException ise = new IllegalStateException();
    final Testable testable = new Testable(ise);
    final Functions.FailableFunction<Throwable, Integer, Throwable> failableFunction = (th) -> {
  ...
  @Test public void testAsBiFunction() {
    final IllegalStateException ise = new IllegalStateException();
    final Testable testable = new Testable(ise);
    final Functions.FailableBiFunction<Testable, Throwable, Integer, Throwable> failableBiFunction = (t, th) -> {
      t.setThrowable(th);
      return t.testInt();
    };
  ...
  @SuppressWarnings(value = { "java:S4144" }) @Test public void testGetFromSupplier() {
    final UndeclaredThrowableException e = assertThrows(UndeclaredThrowableException.class, () -> Functions.run(FailureOnOddInvocations::new));
    final Throwable cause = e.getCause();
    assertNotNull(cause);
    assertTrue(cause instanceof SomeException);
  ...
  @Test public void testAsToIntFunction() {
    final IllegalStateException ise = new IllegalStateException();
    final Testable testable = new Testable(ise);
  ...
  @Test public void testAsToLongFunction() {
    final IllegalStateException ise = new IllegalStateException();
    final Testable testable = new Testable(ise);
  ...
  @Test public void testAsToDoubleFunction() {
    final IllegalStateException ise = new IllegalStateException();
    final Testable testable = new Testable(ise);
