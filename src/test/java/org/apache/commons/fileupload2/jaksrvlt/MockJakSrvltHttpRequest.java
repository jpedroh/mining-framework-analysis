...
public class MockJakSrvltHttpRequest implements HttpServletRequest {
  ...
  /**
     ...
     * and content type.
     */
  public MockJakSrvltHttpRequest(final byte[] requestData, final String strContentType) {
  ...
  /**
     ...
     * and content type.
     */
  public MockJakSrvltHttpRequest(final InputStream requestData, final long requestLength, final String strContentType) {
  ...
  /**
     ...
     */
  @Override public long getDateHeader(final String arg0) {
    return 0;
  }
  ...
  /**
     ...
     */
  @Override public String getHeader(final String headerName) {
  ...
  /**
     ...
     */
  @Override public Enumeration<String> getHeaders(final String arg0) {
    return null;
  }
  ...
  /**
     ...
     */
  @Override public int getIntHeader(final String arg0) {
    return 0;
  }
  ...
  /**
     ...
     */
  @Override public boolean isUserInRole(final String arg0) {
    return false;
  }
  ...
  /**
     ...
     */
  @Override public HttpSession getSession(final boolean arg0) {
    return null;
  }
  ...
  /**
     ...
     */
  @Override public Object getAttribute(final String arg0) {
    return null;
  }
  ...
  /**
     ...
     */
  @Override public void setCharacterEncoding(final String arg0) throws UnsupportedEncodingException {
  }
  ...
  /**
     ...
     */
  @Override public String getParameter(final String arg0) {
    return null;
  }
  ...
  /**
     ...
     */
  @Override public String[] getParameterValues(final String arg0) {
    return null;
  }
  ...
  /**
     ...
     */
  @Override @SuppressWarnings(value = { "javadoc" }) public String getLocalName() {
    return null;
  }
  ...
  /**
     ...
     */
  @Override @SuppressWarnings(value = { "javadoc" }) public int getLocalPort() {
    return 0;
  }
  ...
  /**
     ...
     */
  @Override @SuppressWarnings(value = { "javadoc" }) public int getRemotePort() {
    return 0;
  }
  ...
  /**
     ...
     */
  @Override @SuppressWarnings(value = { "javadoc" }) public String getLocalAddr() {
    return null;
  }
  ...
  /**
     ...
     */
  @Override public void setAttribute(final String arg0, final Object arg1) {
  }

  /**
     * @see javax.servlet.ServletRequest#removeAttribute(String)
     */
  @Override public void removeAttribute(final String arg0) {
  }
  ...
  /**
     ...
     */
  @Override public RequestDispatcher getRequestDispatcher(final String arg0) {
    return null;
  }
  ...
  @Override public AsyncContext startAsync(final ServletRequest servletRequest, final ServletResponse servletResponse) throws IllegalStateException {
    throw new IllegalStateException("Not implemented");
  }
  ...
  @Override public boolean authenticate(final HttpServletResponse response) throws IOException, ServletException {
    return false;
  }

  @Override public void login(final String username, final String password) throws ServletException {
    throw new IllegalStateException("Not implemented");
  }
  ...
  @Override public Part getPart(final String name) throws IOException, ServletException {
    return null;
  }

  @Override public <T extends HttpUpgradeHandler> T upgrade(final Class<T> handlerClass) throws IOException, ServletException {
    throw new IllegalStateException("Not implemented");
  }
