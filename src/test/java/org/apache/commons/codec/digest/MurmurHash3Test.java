 ...
 */
@SuppressWarnings(value = { "deprecation" }) public class MurmurHash3Test {
  ...
  /**
     ...
     */
  @Test public void testHash32LongLong() {
    final int offset = 0;
  ...
  /**
     ...
     */
  @Test public void testHash32LongLongSeed() {
    final int offset = 0;
    final int seed = 104729;
    final int length = MurmurHash3.LONG_BYTES * 2;
    final ByteBuffer buffer = ByteBuffer.allocate(length);
  ...
  /**
     ...
     */
  @Test public void testHash32Long() {
    final int offset = 0;
    final int seed = 104729;
  ...
  /**
     ...
     */
  @Test public void testHash32LongSeed() {
    final int offset = 0;
    final int seed = 104729;
    final int length = MurmurHash3.LONG_BYTES;
    final ByteBuffer buffer = ByteBuffer.allocate(length);
  ...
  /**
     ...
     * @see <a href="https://pypi.org/project/mmh3/">mmh3</a>
     */
  @Test public void testHash32WithLength() {
  ...
  /**
     ...
     * @see <a href="https://pypi.org/project/mmh3/">mmh3</a>
     */
  @Test public void testHash32WithLengthAndSeed() {
    final int seed = -42;
  ...
  /**
     ...
     * @see <a href="https://pypi.org/project/mmh3/">mmh3</a>
     */
  @Test public void testHash32WithOffsetLengthAndSeed() {
    final int seed = -42;
    final int offset = 13;
  ...
  /**
     ...
     */
  @Test public void testHash32String() {
    final int seed = 104729;
    final int minSize = 1;
  ...
  /**
     ...
     */
  @Test public void testHash32WithTrailingNegativeSignedBytesIsInvalid() {
  ...
  /**
     ...
     * @see <a href="https://pypi.org/project/mmh3/">mmh3</a>
     */
  @Test public void testhash32x86() {
  ...
  /**
     ...
     * @see <a href="https://pypi.org/project/mmh3/">mmh3</a>
     */
  @Test public void testHash32x86WithOffsetLengthAndSeed() {
    final int seed = -42;
    final int offset = 13;
    final int[] answers = { 192929823, -27171978, -1282326280, -816314453, -1176217753, -1904531247, 1962794233, -1302316624, -1151850323, -1464386748, -369299427, 972232488, 1747314487, 2137398916, 690986564, -1985866226, -678669121, -2123325690, -253319081, 46181235, 656058278, 1401175653, 1750113912, -1567219725, 2032742772, -2024269989, -305340794, 1161737942, -661265418, 172838872, -650122718, -1934812417 };
    for (int i = 0; i < answers.length; i++) {
  ...
  /**
     ...
     * if the final 1, 2, or 3 bytes are negative.
     */
  @Test public void testHash32x86WithTrailingNegativeSignedBytes() {
  ...
  /**
     ...
     * Unknown origin of test data. It may be from the Apache Hive project.
     */
  @Test public void testHash64WithOffsetAndLength() {
    final byte[] origin = StringUtils.getBytesUtf8(TEST_HASH64);
  ...
  /**
     ...
     */
  @Test public void testHash64WithPrimitives() {
    final int offset = 0;
    final int seed = 104729;
  ...
  /**
     ...
     */
  @Test public void testHash64InNotEqualToHash128() {
    for (int i = 0; i < 32; i++) {
      final byte[] bytes = Arrays.copyOf(RANDOM_BYTES, i);
  ...
  /**
     ...
     * @see <a href="https://pypi.org/project/mmh3/">mmh3</a>
     */
  @Test public void testHash128WithOffsetLengthAndSeed() {
    final int seed = 42;
    final int offset = 13;
  ...
  /**
     ...
     * <p>The test uses random strings created with random unicode code points.</p>
     */
  @Test public void testHash128String() {
    final int seed = 104729;
    final int minSize = 1;
    final int maxSize = 11;
    final int codePoints = 112956;
  ...
  /**
     ...
     * @see <a href="https://pypi.org/project/mmh3/">mmh3</a>
     */
  @Test public void testHash128x64WithOffsetLengthAndSeed() {
    final int seed = 42;
    final int offset = 13;
    final long[][] answers = { { -1140915396076141277L, -3386313222241793095L }, { 2745805417334040752L, -3045882272665292331L }, { 6807939080212835946L, -1975749467247671127L }, { -7924884987449335214L, -4468571497642087939L }, { 3005389733967167773L, -5809440073240597398L }, { 8032745196600164727L, 4545709434702374224L }, { 2095398623732573832L, 1778447136435513908L }, { 4492723708121417255L, -7411125500882394867L }, { 8467397417110552178L, -1503802302645548949L }, { 4189760269121918355L, -8004336343217265057L }, { 4939298084211301953L, -8419135013628844658L }, { 5497136916151148085L, -394028342910298191L }, { 3405983294878231737L, -3216533807498089078L }, { 5833223403351466775L, -1792451370239813325L }, { 7730583391236194819L, 5356157313842354092L }, { 3111977482488580945L, -3119414725698132191L }, { 3314524606404365027L, -1923219843083192742L }, { 7299569240140613949L, 4176392429810027494L }, { 6398084683727166117L, 7703960505857395788L }, { -8594572031068184774L, 4394224719145783692L }, { -7589785442804461713L, 4110439243215224554L }, { -5343610105946840628L, -4423992782020122809L }, { -522490326525787270L, 289136460641968781L }, { -5320637070354802556L, -7845553044730489027L }, { 1344456408744313334L, 3803048032054968586L }, { 1131205296221907191L, -6256656049039287019L }, { 8583339267101027117L, 8934225022848628726L }, { -6379552869905441749L, 8973517768420051734L }, { 5076646564516328801L, 8561479196844000567L }, { -4610341636137642517L, -6694266039505142069L }, { -758896383254029789L, 4050360662271552727L }, { -6123628195475753507L, 4283875822581966645L } };
    for (int i = 0; i < answers.length; i++) {
  ...
  /**
     ...
     * @see <a href="https://pypi.org/project/mmh3/">mmh3</a>
     */
  @Test public void testHash128x64WithOffsetLengthAndNegativeSeed() {
    final int seed = -42;
    final int offset = 13;
  ...
  /**
     ...
     */
  @Test public void testIncrementalHash32() {
  ...
  /**
     ...
     */
  @Test public void testIncrementalHash32x86() {
    final byte[] bytes = new byte[1023];
    ThreadLocalRandom.current().nextBytes(bytes);
    for (final int seed : new int[] { -567, 0, 6787990 }) {
  ...
  /**
     ...
     */
  @Test public void testIncrementalHashWithUnprocessedBytesAndHugeLengthArray() {
