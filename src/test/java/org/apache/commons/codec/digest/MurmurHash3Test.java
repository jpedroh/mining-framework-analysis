...
public class MurmurHash3Test {
  ...
  @Test public void test32_String() {
  ...
  @Test public void test128_Short() {
  ...
  @Test public void test128_Double() {
  ...
  @Test public void test128_String() {
    final String origin = TEST;
  ...
  @Test public void testTwoLongOrdered() {
  ...
  @Test public void testTwoLongRandom() {
    final ByteBuffer buffer = ByteBuffer.allocate(MurmurHash3.LONG_BYTES * 2);
  ...
  @Test public void testSingleLongOrdered() {
    final ByteBuffer buffer = ByteBuffer.allocate(MurmurHash3.LONG_BYTES);
    for (long i = 0; i < 1000; i++) {
      buffer.putLong(0, i);
  ...
  @Test public void testSingleLongRandom() {
    final ByteBuffer buffer = ByteBuffer.allocate(MurmurHash3.LONG_BYTES);
    final Random random = new Random();
    for (long i = 0; i < 1000; i++) {
      final long x = random.nextLong();
  ...
  @Test public void test32_x86_String() {
    final String origin = TEST;
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testHash128SignExtension() throws Exception {
  ...
  @Test public void test128_x64_Short() {
    final ByteBuffer BUFFER = ByteBuffer.allocate(MurmurHash3.SHORT_BYTES);
    BUFFER.putShort(0, (short) 2);
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testHash32SignExtension() throws Exception {
  ...
  @Test public void test128_x64_Int() {
    final ByteBuffer BUFFER = ByteBuffer.allocate(MurmurHash3.INTEGER_BYTES);
    BUFFER.putInt(0, 3);
    final long[] result = MurmurHash3.hash128_x64(BUFFER.array());
    assertEquals(result.length, 2);
  ...
  @Test public void test128_x64_Long() {
    final ByteBuffer BUFFER = ByteBuffer.allocate(MurmurHash3.LONG_BYTES);
    BUFFER.putLong(0, 8675309L);
    final long[] result = MurmurHash3.hash128_x64(BUFFER.array());
    assertEquals(result.length, 2);
  ...
  @Test public void test128_x64_Double() {
    final ByteBuffer BUFFER = ByteBuffer.allocate(Double.SIZE / Byte.SIZE);
    BUFFER.putDouble(0, 456.987);
    final long[] result = MurmurHash3.hash128_x64(BUFFER.array());
    assertEquals(result.length, 2);
  ...
  @Test public void test128_x64_String() {
    final String origin = TEST;
  ...
  @Test public void testTwoLongOrdered_32x86() {
    final ByteBuffer buffer = ByteBuffer.allocate(MurmurHash3.LONG_BYTES * 2);
    for (long i = 0; i < 1000; i++) {
      for (long j = 0; j < 1000; j++) {
        buffer.putLong(0, i);
  ...
  @Test public void testTwoLongRandom_32x86() {
    final ByteBuffer buffer = ByteBuffer.allocate(MurmurHash3.LONG_BYTES * 2);
    final Random random = new Random();
    for (long i = 0; i < 1000; i++) {
      for (long j = 0; j < 1000; j++) {
  ...
  @Test public void testSingleLongOrdered_32x86() {
    final ByteBuffer buffer = ByteBuffer.allocate(MurmurHash3.LONG_BYTES);
    for (long i = 0; i < 1000; i++) {
      buffer.putLong(0, i);
  ...
  @Test public void testSingleLongRandom_32x86() {
    final ByteBuffer buffer = ByteBuffer.allocate(MurmurHash3.LONG_BYTES);
    final Random random = new Random();
    for (long i = 0; i < 1000; i++) {
      final long x = random.nextLong();
