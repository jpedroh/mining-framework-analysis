...
1.0
>>>>>>>
 ) ) ;  if  (  !  msg . equals  ( "" ) )  {  throw  new RuntimeException  ( msg ) ; } }    @ Test public void testRealToComplex  ( )  {   setArrays  ( ) ;   TestUtils . assertEquals  ( msg , ansArrayc1r ,  ComplexUtils . real2Complex  ( d , 3 , 7 ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
