...
1.0
>>>>>>>
 ) ) ;  for (   int  i = 0 ;  i < 10 ;  i ++ )  {   TestUtils . assertEquals  ( msg ,  cr2d [ i ] ,  ComplexUtils . real2Complex  (  d2d [ i ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0
>>>>>>>
 ) ) ; }  for (   int  i = 0 ;  i < 10 ;  i ++ )  {  for (   int  j = 0 ;  j < 10 ;  j ++ )  {   TestUtils . assertEquals  ( msg ,   cr3d [ i ] [ j ] ,  ComplexUtils . real2Complex  (   d3d [ i ] [ j ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0
>>>>>>>
 ) ) ; } }  if  (  !  msg . equals  ( "" ) )  {  throw  new RuntimeException  ( msg ) ; } }    @ Test public void testComplexToReal  ( )  {   setArrays  ( ) ;   TestUtils . assertEquals  ( msg , ansArrayd1r ,  ComplexUtils . complex2Real  ( c , 3 , 7 ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0f
>>>>>>>
 ) ) ;  for (   int  i = 0 ;  i < 10 ;  i ++ )  {   TestUtils . assertEquals  ( msg ,  sr2d [ i ] ,  ComplexUtils . complex2Real  (  c2d [ i ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0f
>>>>>>>
 ) ) ; }  for (   int  i = 0 ;  i < 10 ;  i ++ )  {  for (   int  j = 0 ;  j < 10 ;  j ++ )  {   TestUtils . assertEquals  ( msg ,   sr3d [ i ] [ j ] ,  ComplexUtils . complex2Real  (   c3d [ i ] [ j ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0f
>>>>>>>
 ) ) ; } }  if  (  !  msg . equals  ( "" ) )  {  throw  new RuntimeException  ( msg ) ; } }    @ Test public void testImaginaryToComplex  ( )  {   setArrays  ( ) ;   TestUtils . assertEquals  ( msg , ansArrayc1i ,  ComplexUtils . imaginary2Complex  ( d , 3 , 7 ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0
>>>>>>>
 ) ) ;  for (   int  i = 0 ;  i < 10 ;  i ++ )  {   TestUtils . assertEquals  ( msg ,  ci2d [ i ] ,  ComplexUtils . imaginary2Complex  (  d2d [ i ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0
>>>>>>>
 ) ) ; }  for (   int  i = 0 ;  i < 10 ;  i ++ )  {  for (   int  j = 0 ;  j < 10 ;  j ++ )  {   TestUtils . assertEquals  ( msg ,   ci3d [ i ] [ j ] ,  ComplexUtils . imaginary2Complex  (   d3d [ i ] [ j ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0
>>>>>>>
 ) ) ; } }  if  (  !  msg . equals  ( "" ) )  {  throw  new RuntimeException  ( msg ) ; } }    @ Test public void testComplexToImaginary  ( )  {   setArrays  ( ) ;   TestUtils . assertEquals  ( msg , ansArrayd1i ,  ComplexUtils . complex2Imaginary  ( c , 3 , 7 ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0f
...
1.0f
>>>>>>>
 ) ) ;  for (   int  i = 0 ;  i < 10 ;  i ++ )  {   TestUtils . assertEquals  ( msg ,  si2d [ i ] ,  ComplexUtils . complex2Imaginary  (  c2d [ i ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0f
>>>>>>>
 ) ) ; }  for (   int  i = 0 ;  i < 10 ;  i ++ )  {  for (   int  j = 0 ;  j < 10 ;  j ++ )  {   TestUtils . assertEquals  ( msg ,   si3d [ i ] [ j ] ,  ComplexUtils . complex2Imaginary  (   c3d [ i ] [ j ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0f
>>>>>>>
 ) ) ; } }  if  (  !  msg . equals  ( "" ) )  {  throw  new RuntimeException  ( msg ) ; } }    @ Test public void testInterleavedToComplex  ( )  {   setArrays  ( ) ;   TestUtils . assertEquals  ( msg , ansArrayc3 ,  ComplexUtils . interleaved2Complex  ( di , 3 , 7 ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0
>>>>>>>
 ) ) ;  for (   int  i = 0 ;  i < 10 ;  i ++ )  {   TestUtils . assertEquals  ( msg ,  c2d [ i ] ,  ComplexUtils . interleaved2Complex  (  di2d [ i ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0
>>>>>>>
 ) ) ; }  for (   int  i = 0 ;  i < 10 ;  i ++ )  {  for (   int  j = 0 ;  j < 10 ;  j ++ )  {   TestUtils . assertEquals  ( msg ,   c3d [ i ] [ j ] ,  ComplexUtils . interleaved2Complex  (   di3d [ i ] [ j ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0
>>>>>>>
 ) ) ; } }  if  (  !  msg . equals  ( "" ) )  {  throw  new RuntimeException  ( msg ) ; } }    @ Test public void testComplexToInterleaved  ( )  {   setArrays  ( ) ;   TestUtils . assertEquals  ( msg , ansArraydi1 ,  ComplexUtils . complex2Interleaved  ( c , 3 , 7 ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0f
>>>>>>>
 ) ) ;  for (   int  i = 0 ;  i < 10 ;  i ++ )  {   TestUtils . assertEquals  ( msg ,  di2d [ i ] ,  ComplexUtils . complex2Interleaved  (  c2d [ i ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0f
>>>>>>>
 ) ) ; }  for (   int  i = 0 ;  i < 10 ;  i ++ )  {  for (   int  j = 0 ;  j < 10 ;  j ++ )  {   TestUtils . assertEquals  ( msg ,   di3d [ i ] [ j ] ,  ComplexUtils . complex2Interleaved  (   c3d [ i ] [ j ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
...
1.0f
>>>>>>>
 ) ) ; } }  if  (  !  msg . equals  ( "" ) )  {  throw  new RuntimeException  ( msg ) ; } }    @ Test public void testSplit2Complex  ( )  {   setArrays  ( ) ;   TestUtils . assertEquals  ( msg , c ,  ComplexUtils . split2Complex  ( sr , si ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
>>>>>>>
 ) ) ;  for (   int  i = 0 ;  i < 10 ;  i ++ )  {   TestUtils . assertEquals  ( msg ,  c2d [ i ] ,  ComplexUtils . split2Complex  (  sr2d [ i ] ,  si2d [ i ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
>>>>>>>
 ) ) ; }  for (   int  i = 0 ;  i < 10 ;  i ++ )  {  for (   int  j = 0 ;  j < 10 ;  j ++ )  {   TestUtils . assertEquals  ( msg ,   c3d [ i ] [ j ] ,  ComplexUtils . split2Complex  (   sr3d [ i ] [ j ] ,   si3d [ i ] [ j ] ) ,  Math . ulp  ( 
<<<<<<<
1
=======
1.0
>>>>>>>
 ) ) ; } }  if  (  !  msg . equals  ( "" ) )  {  throw  new RuntimeException  ( msg ) ; } }    @ Test public void testInitialize  ( )  {   Complex  [ ]  c =  new Complex  [ 10 ] ;   ComplexUtils . initialize  ( c ) ;  for ( Complex cc : c )  {   TestUtils . assertEquals  (  new Complex  ( 0 , 0 ) , cc ,  Math . ulp  ( 0 ) ) ; } } }