...
public class HasherCollectionTest extends AbstractHasherTest {
  @Override protected HasherCollection createHasher() {
    return new HasherCollection(new IncrementingHasher(1, 1), new IncrementingHasher(2, 2));
  }

  @Override protected HasherCollection createEmptyHasher() {
    return new HasherCollection();
  }

  @Override protected int getHasherSize(Hasher hasher) {
  ...
  @Override public void testUniqueIndex() {
  ...
  @Test void testHasherCollection() {
