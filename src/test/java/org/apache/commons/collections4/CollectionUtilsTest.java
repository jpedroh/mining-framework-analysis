 ...
 *
 */
@SuppressWarnings(value = { "boxing" }) public class CollectionUtilsTest extends MockTestCase {
  /**
  ...
  @Test public void getCardinalityMap() {
  ...
  @Test(expected = NullPointerException.class) public void testGetCardinalityMapNull() {
  ...
  @Test(expected = NullPointerException.class) public void testContainsAnyNullColl1() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
    CollectionUtils.containsAny(null, list);
  }

  @Test(expected = NullPointerException.class) public void testContainsAnyNullColl2() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
  ...
  @Test(expected = NullPointerException.class) public void testContainsAnyNullColl3() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
  ...
  @Test(expected = NullPointerException.class) public void testContainsAnyInArrayNullColl1() {
    final String[] oneArr = { "1" };
    CollectionUtils.containsAny(null, oneArr);
  }

  @Test(expected = NullPointerException.class) public void testContainsAnyInArrayNullColl2() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
    final Collection<String> list2 = null;
    CollectionUtils.containsAny(list, list2);
  ...
  @Test(expected = NullPointerException.class) public void testContainsAnyInArrayNullArray() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
    final String[] array = null;
    CollectionUtils.containsAny(list, array);
  ...
  @Test(expected = NullPointerException.class) public void testUnionNullColl1() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
  ...
  @Test(expected = NullPointerException.class) public void testIntersectionNullColl1() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
    CollectionUtils.intersection(null, list);
  }

  @Test(expected = NullPointerException.class) public void testIntersectionNullColl2() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
  ...
  @Test(expected = NullPointerException.class) public void testDisjunctionNullColl1() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
    CollectionUtils.disjunction(null, list);
  }

  @Test(expected = NullPointerException.class) public void testDisjunctionNullColl2() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
    CollectionUtils.disjunction(list, null);
  }

  @Test public void testDisjunctionAsUnionMinusIntersection() {
  ...
  @Test(expected = NullPointerException.class) public void testSubtractNullColl1() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
  ...
  @Test public void testSubtractWithPredicate() {
  ...
  @Test public void testIsSubCollectionOfSelf() {
  ...
  @Test public void testIsSubCollection() {
  ...
  @Test(expected = NullPointerException.class) public void testIsSubCollectionNullColl1() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
    CollectionUtils.isSubCollection(null, list);
  }

  @Test(expected = NullPointerException.class) public void testIsSubCollectionNullColl2() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
    CollectionUtils.isSubCollection(list, null);
  }

  @Test public void testIsEqualCollectionToSelf() {
  ...
  @Test public void testIsEqualCollection() {
  ...
  @Test public void testIsEqualCollection2() {
  ...
  @Test(expected = NullPointerException.class) public void testIsEqualCollectionNullEquator() {
  ...
  @Test public void testHashCodeNullCollection() {
    final Equator<Integer> e = new Equator<Integer>() {
      @Override public boolean equate(final Integer o1, final Integer o2) {
        if (o1 % 2 == 0 ^ o2 % 2 == 0) {
          return false;
  ...
  @Test(expected = NullPointerException.class) public void testHashCodeNullEquator() {
    CollectionUtils.hashCode(collectionB, null);
  }

  @Test(expected = NullPointerException.class) public void testIsEqualCollectionNullColl1() {
  ...
  @Test(expected = NullPointerException.class) public void testIsEqualCollectionNullColl2() {
    final Collection<Integer> list = new ArrayList<>(1);
    list.add(1);
    final Equator<Integer> e = new Equator<Integer>() {
      @Override public boolean equate(final Integer o1, final Integer o2) {
  ...
  @Test public void testIsProperSubCollection() {
    final Collection<String> a = new ArrayList<>();
    final Collection<String> b = new ArrayList<>();
  ...
  @Test(expected = NullPointerException.class) public void testIsProperSubCollectionNullColl1() {
    final Collection<String> list = new ArrayList<>(1);
    list.add("1");
  ...
  @Test @Deprecated public void find() {
  ...
  @Test(expected = FunctorException.class) @Deprecated public void forAllDoFailure() {
  ...
  @Test @Deprecated public void forAllButLastDoIterator() {
    final Closure<List<? extends Number>> testClosure = ClosureUtils.invokerClosure("clear");
    final Collection<List<? extends Number>> col = new ArrayList<>();
    col.add(collectionA);
    col.add(collectionB);
  ...
  /**
     ...
     * {@link List#get(int)}.
     */
  @Test(expected = IndexOutOfBoundsException.class) public void getFromList() throws Exception {
  ...
  @Test @Deprecated public void getFromIterator() throws Exception {
  ...
  @Test @Deprecated public void getFromEnumeration() throws Exception {
  ...
  @Test(expected = IndexOutOfBoundsException.class) @Deprecated public void getFromIterable() throws Exception {
    final Bag<String> bag = new HashBag<>();
    bag.add("element", 1);
  ...
  @Test(expected = IndexOutOfBoundsException.class) public void getFromObjectArray() throws Exception {
  ...
  @Test(expected = IndexOutOfBoundsException.class) public void getFromPrimitiveArray() throws Exception {
  ...
  @Test(expected = IllegalArgumentException.class) public void getFromObject() throws Exception {
  ...
  @Test public void testSize_Array() {
  ...
  @Test public void testSize_PrimitiveArray() {
  ...
  @Test public void testSize_Enumeration() {
  ...
  @Test public void testSize_Iterator() {
    final List<String> list = new ArrayList<>();
  ...
  @Test(expected = IllegalArgumentException.class) public void testSize_Other() {
  ...
  @Test public void testSizeIsEmpty_List() {
    final List<String> list = new ArrayList<>();
  ...
  @Test public void testSizeIsEmpty_Map() {
    final Map<String, String> map = new HashMap<>();
  ...
  @Test public void testSizeIsEmpty_Array() {
    final Object[] objectArray = new Object[0];
  ...
  @Test public void testSizeIsEmpty_PrimitiveArray() {
    final int[] intArray = new int[0];
  ...
  @Test public void testSizeIsEmpty_Enumeration() {
    final Vector<String> list = new Vector<>();
  ...
  @Test public void testSizeIsEmpty_Iterator() {
    final List<String> list = new ArrayList<>();
  ...
  @Test public void testSizeIsEmpty_Other() {
    try {
  ...
  @Test public void testIsEmptyWithNonEmptyCollection() {
  ...
  @Test public void testIsNotEmptyWithEmptyCollection() {
    assertFalse(CollectionUtils.isNotEmpty(new ArrayList<>()));
  }

  @Test public void testIsNotEmptyWithNonEmptyCollection() {
    assertTrue(CollectionUtils.isNotEmpty(Collections.singletonList("item")));
  }

  @Test public void testIsNotEmptyWithNull() {
  ...
  @Test public void filterNullParameters() throws Exception {
  ...
  @Test public void filterInverse() {
    final List<Integer> ints = new ArrayList<>();
    ints.add(1);
    ints.add(2);
    ints.add(3);
  ...
  @Test public void filterInverseNullParameters() throws Exception {
    final List<Long> longs = Collections.nCopies(4, 10L);
  ...
  @Test @Deprecated public void countMatches() {
  ...
  @Test public void selectWithOutputCollections() {
  ...
  @Test public void selectRejected() {
  ...
  @Test public void addIgnoreNull() {
    final Set<String> set = new HashSet<>();
    set.add("1");
    set.add("2");
    set.add("3");
  ...
  @Test(expected = NullPointerException.class) public void testAddIgnoreNullNullColl() {
    CollectionUtils.addIgnoreNull(null, "1");
  }

  @Test public void predicatedCollection() {
  ...
  @Test(expected = NullPointerException.class) public void testPredicatedCollectionNullColl() {
    final Predicate<Object> predicate = PredicateUtils.instanceofPredicate(Integer.class);
    CollectionUtils.predicatedCollection(null, predicate);
  }

  @Test(expected = NullPointerException.class) public void testPredicatedCollectionNullPredicate() {
  ...
  @Test(expected = NullPointerException.class) public void testIsFullNullColl() {
  ...
  @Test(expected = NullPointerException.class) public void testMaxSizeNullColl() {
    CollectionUtils.maxSize(null);
  }

  @Test public void intersectionUsesMethodEquals() {
  ...
  @Test(expected = NullPointerException.class) public void testRetainAllNullBaseColl() {
    final List<Object> sub = new ArrayList<>();
    sub.add("A");
    CollectionUtils.retainAll(null, sub);
  }

  @Test(expected = NullPointerException.class) public void testRetainAllNullSubColl() {
    final List<String> base = new ArrayList<>();
    base.add("A");
  ...
  @Test(expected = NullPointerException.class) public void testRemoveRangeNull() {
    final Collection<Integer> list = null;
    CollectionUtils.removeRange(list, 0, 0);
  }

  @Test(expected = IndexOutOfBoundsException.class) public void testRemoveRangeStartIndexNegative() {
    final Collection<Integer> list = new ArrayList<>();
    list.add(1);
    CollectionUtils.removeRange(list, -1, 1);
  }

  @Test(expected = IllegalArgumentException.class) public void testRemoveRangeEndIndexNegative() {
    final Collection<Integer> list = new ArrayList<>();
    list.add(1);
    CollectionUtils.removeRange(list, 0, -1);
  }

  @Test(expected = IllegalArgumentException.class) public void testRemoveRangeEndLowStart() {
    final Collection<Integer> list = new ArrayList<>();
    list.add(1);
    list.add(2);
  ...
  @Test(expected = IndexOutOfBoundsException.class) public void testRemoveRangeWrongEndIndex() {
    final Collection<Integer> list = new ArrayList<>();
    list.add(1);
  ...
  @Test(expected = NullPointerException.class) public void testRemoveCountWithNull() {
    final Collection<Integer> list = null;
    CollectionUtils.removeCount(list, 0, 1);
  }

  @Test(expected = IndexOutOfBoundsException.class) public void testRemoveCountStartNegative() {
    final Collection<Integer> list = new ArrayList<>();
    CollectionUtils.removeCount(list, -1, 1);
  }

  @Test(expected = IndexOutOfBoundsException.class) public void testRemoveCountNegative() {
    final Collection<Integer> list = new ArrayList<>();
    CollectionUtils.removeCount(list, 0, -1);
  }

  @Test(expected = IndexOutOfBoundsException.class) public void testRemoveCountWrongCount() {
    final Collection<Integer> list = new ArrayList<>();
    list.add(1);
  ...
  @Test(expected = NullPointerException.class) public void testRemoveAllNullBaseColl() {
    final List<String> sub = new ArrayList<>();
    sub.add("A");
    CollectionUtils.removeAll(null, sub);
  }

  @Test(expected = NullPointerException.class) public void testRemoveAllNullSubColl() {
    final List<String> base = new ArrayList<>();
    base.add("A");
    CollectionUtils.removeAll(base, null);
  }

  @Test public void testTransformedCollection() {
  ...
  @Test(expected = NullPointerException.class) public void testTransformingCollectionNullColl() {
    final Transformer<Object, Object> transformer = TransformerUtils.nopTransformer();
    CollectionUtils.transformingCollection(null, transformer);
  }

  @Test(expected = NullPointerException.class) public void testTransformingCollectionNullTransformer() {
    final List<String> list = new ArrayList<>();
    CollectionUtils.transformingCollection(list, null);
  }

  @Test public void testTransformedCollection_2() {
  ...
  @Test @Deprecated public void testUnmodifiableCollection() {
  ...
  @Test public void addAllForElements() {
    CollectionUtils.addAll(collectionA, 5);
    assertTrue(collectionA.contains(5));
  }

  @Test(expected = NullPointerException.class) public void testaddAllNullColl1() {
    final List<Integer> list = new ArrayList<>();
    CollectionUtils.addAll(null, list);
  }

  @Test(expected = NullPointerException.class) public void testAddAllNullColl2() {
    final List<Integer> list = new ArrayList<>();
    final Iterable<Integer> list2 = null;
    CollectionUtils.addAll(list, list2);
  }

  @Test(expected = NullPointerException.class) public void testAddAllNullColl3() {
    final List<Integer> list = new ArrayList<>();
    final Iterator<Integer> list2 = null;
    CollectionUtils.addAll(list, list2);
  }

  @Test(expected = NullPointerException.class) public void testAddAllNullColl4() {
    final List<Integer> list = new ArrayList<>();
    final Enumeration<Integer> enumArray = null;
    CollectionUtils.addAll(list, enumArray);
  }

  @Test(expected = NullPointerException.class) public void testAddAllNullColl5() {
    final List<Integer> list = new ArrayList<>();
    final Integer[] array = null;
    CollectionUtils.addAll(list, array);
  }

  @Test(expected = IndexOutOfBoundsException.class) public void getNegative() {
    CollectionUtils.get((Object) collectionA, -3);
  }

  @Test(expected = IndexOutOfBoundsException.class) public void getPositiveOutOfBounds() {
    CollectionUtils.get((Object) collectionA.iterator(), 30);
  }

  @Test(expected = IllegalArgumentException.class) public void get1() {
  ...
  @Test public void getEnumeration() {
  ...
  @Test(expected = NullPointerException.class) public void testReverseArrayNull() {
  ...
  /**
     ...
     */
  private <T extends java.lang.Object> void next(final Iterator<T> iterator, final T t) {
    expect(iterator.hasNext()).andReturn(true);
    expect(iterator.next()).andReturn(t);
  }

  @Test(expected = NullPointerException.class) public void collateException0() {
    CollectionUtils.collate(null, collectionC);
  }

  @Test(expected = NullPointerException.class) public void collateException1() {
    CollectionUtils.collate(collectionA, null);
  }

  @Test(expected = NullPointerException.class) public void collateException2() {
  ...
  @Test public void testCollateIgnoreDuplicates() {
  ...
  @Test(expected = NullPointerException.class) public void testPermutationsWithNullCollection() {
  ...
  @Test @Deprecated public void testMatchesAll() {
  ...
  @Test public void testRetainAllWithEquator() {
    final List<String> base = new ArrayList<>();
    base.add("AC");
    base.add("BB");
    base.add("CA");
