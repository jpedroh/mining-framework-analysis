...
public class CaseInsensitiveMapTest<K extends java.lang.Object, V extends java.lang.Object> extends AbstractIterableMapTest<K, V> {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void testPutConvertKeyOnlyOnce() {
...
<<<<<<< /usr/src/app/output/apache/commons-collections/219336301fd7957feebed1203ccebe9e2858412f/src/test/java/org/apache/commons/collections4/map/CaseInsensitiveMapTest.java/left.java
    addMockedMethod("convertKey").createMock()
=======
    withConstructor(Map.class).withArgs(new HashMap<>()).addMockedMethod("convertKey").createMock()
