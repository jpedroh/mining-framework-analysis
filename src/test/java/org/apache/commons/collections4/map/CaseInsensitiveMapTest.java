 ...
 *
 */
public class CaseInsensitiveMapTest<K extends java.lang.Object, V extends java.lang.Object> extends AbstractIterableMapTest<K, V> {
  ...
  @Override public CaseInsensitiveMap<K, V> makeObject() {
    return new CaseInsensitiveMap<>();
  }

  @Test @SuppressWarnings(value = { "unchecked" }) public void testCaseInsensitive() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void testClone() {
  ...
  /**
     ...
     */
  @Test public void testInitialCapacityZero() {
    final CaseInsensitiveMap<String, String> map = new CaseInsensitiveMap<>(0);
    assertEquals(1, map.data.length);
  }

  @Test public void testLocaleIndependence() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void testNullHandling() {
    final Map<K, V> map = makeObject();
    map.put((K) "One", (V) "One");
    map.put((K) "Two", (V) "Two");
  ...
  @Test public void testPutAll() {
    ...
    assertTrue(!caseInsensitiveMap.containsValue("One") || !caseInsensitiveMap.containsValue("Three"));
    assertEquals("Four", caseInsensitiveMap.get(null));
  }

  @SuppressWarnings(value = { "unchecked" }) public void testPutConvertKeyOnlyOnce() {
    CaseInsensitiveMap mock = EasyMock.partialMockBuilder(CaseInsensitiveMap.class).withConstructor(Map.class).withArgs(new HashMap<>()).addMockedMethod("convertKey").createMock();
