...
public class ClosureUtilsTest {
  ...
  static class MockClosure<T extends java.lang.Object> implements Closure<T> {
    int count = 0;

    @Override public void execute(final T object) {
      count++;
    }
  ...
  static class MockTransformer<T extends java.lang.Object> implements Transformer<T, T> {
    int count = 0;

    @Override public T transform(final T object) {
      count++;
      return object;
    }
  }
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void testChainedClosure() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void testSwitchClosure() {
  ...
  @Test public void testSingletonPatternInSerialization() {
    final Object[] singletons = new Object[] { ExceptionClosure.INSTANCE, NOPClosure.INSTANCE };
