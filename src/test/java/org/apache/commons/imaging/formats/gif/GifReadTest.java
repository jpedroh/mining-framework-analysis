...
public class GifReadTest extends GifBaseTest {
  ...
  @ParameterizedTest @MethodSource(value = "animatedImageData") public void testBufferedImagesForAnimatedImageGif(final File imageFile) throws Exception {
    final List<BufferedImage> images = Imaging.getAllBufferedImages(imageFile);
    assertTrue(images.size() > 1);
  }

  @ParameterizedTest @MethodSource(value = "singleImageData") public void testBufferedImagesForSingleImageGif(final File imageFile) throws Exception {
    final List<BufferedImage> images = Imaging.getAllBufferedImages(imageFile);
    assertEquals(1, images.size());
  }

  @Test public void testConvertInvalidDisposalMethodValues() {
    assertThrows(ImagingException.class, () -> GifImageParser.createDisposalMethodFromIntValue(8));
  }

  @Test public void testConvertValidDisposalMethodValues() throws ImagingException {
  ...
  @Test public void testCreateMetadataWithDisposalMethods() {
  ...
  @ParameterizedTest @MethodSource(value = "data") public void testImageDimensions(final File imageFile) throws Exception {
  ...
  @Disabled(value = "RoundtripTest has to be fixed before implementation can throw UnsupportedOperationException") @ParameterizedTest @MethodSource(value = "data") public void testMetadata(final File imageFile) {
  ...
  /**
     ...
     */
  @Test public void testUncaughtExceptionOssFuzz33464() throws IOException {
  ...
  /**
     ...
     * @throws IOException if it fails to read the test image
     */
  @Test public void testUncaughtExceptionOssFuzz33501() throws IOException {
  ...
  /**
     ...
     * @throws IOException if it fails to read the test image
     */
  @Test public void testUncaughtExceptionOssFuzz34185() throws IOException {
