...
public class BmpReadTest extends BmpBaseTest {
  ...
  /**
     ...
     */
  @Test public void testGetMaskShiftZeroMask() throws ImagingException, IOException {
  ...
  @ParameterizedTest @MethodSource(value = "data") public void testImageInfo(final File imageFile) throws ImagingException, IOException {
  ...
  @Test public void testNegativePaletteLength() {
