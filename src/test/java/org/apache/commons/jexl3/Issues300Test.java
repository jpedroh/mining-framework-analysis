...
public class Issues300Test {
  @Test public void testIssue301a() {
  ...
  @Test public void testIssues301b() {
    final JexlEngine jexl = new JexlBuilder().safe(false).arithmetic(new JexlArithmetic(false)).create();
  ...
  @Test public void testIssue306b() {
    final JexlEngine jexl = new JexlBuilder().create();
    final JexlScript e = jexl.createScript("x?.y ?: 2", "x");
  ...
  @Test public void testIssue306c() {
  ...
  @Test public void testIssue306d() {
    final JexlEngine jexl = new JexlBuilder().safe(true).create();
  ...
  @Test public void testIssue309a() {
  ...
  @Test public void testIssue309b() {
    final String src = "<html lang=\"en\">\n" + "  <body>\n" + "    <h1>Hello World!</h1>\n" + "$$ var i = a b c;\n" + "  </body>\n" + "</html>";
    final JexlEngine jexl = new JexlBuilder().safe(true).create();
    final JxltEngine jxlt = jexl.createJxltEngine();
    final JexlInfo info = new JexlInfo("template", 1, 1);
  ...
  @Test public void testIssue309c() {
    final String src = "<html lang=\"en\">\n" + "  <body>\n" + "    <h1>Hello World!</h1>\n" + "$$ var i =12;\n" + "  </body>\n" + "</html>";
    final JexlEngine jexl = new JexlBuilder().safe(true).create();
    final JxltEngine jxlt = jexl.createJxltEngine();
    final JexlInfo info = new JexlInfo("template", 1, 1);
