...
public class Issues300Test {
  @Test public void test301a() {
    final JexlEngine jexl = new JexlBuilder().safe(false).arithmetic(new JexlArithmetic(false)).create();
    final String[] srcs = new String[] { "var x = null; x.0", "var x = null; x[0]", "var x = [null,1]; x[0][0]" };
  ...
  @Test public void tests301b() {
    final JexlEngine jexl = new JexlBuilder().safe(false).arithmetic(new JexlArithmetic(false)).create();
    final Object[] xs = new Object[] { null, null, new Object[] { null, 1 } };
    final String[] srcs = new String[] { "x.0", "x[0]", "x[0][0]" };
  ...
  @Test public void test302() {
    ...
    final String[] strs = new String[] { "{if (0) 1 else 2; var x = 4;}", "if (0) 1; else 2; ", "{ if (0) 1; else 2; }", "{ if (0) { if (false) 1 else -3 } else 2; }" };
  ...
  @Test public void test304() {
    ...
    final String[] keywords = new String[] { "if", "else", "do", "while", "for", "break", "continue", "function", "return", "new", "size", "empty", "var", "let", "const", "null", "true", "false", "not", "div", "mod", "and", "or", "eq", "ne", "lt", "gt", "ge", "le" };
  ...
  @Test public void test322a() {
    final JexlEngine jexl = new JexlBuilder().strict(true).create();
    final JxltEngine jxlt = jexl.createJxltEngine();
    final JexlContext context = new MapContext();
    final String[] ins = new String[] { "${\'{\'}", "${\"{\"}", "${\"{}\"}", "${\'{42}\'}", "${\"{\\\"\\\"}\"}" };
    final String[] ctls = new String[] { "{", "{", "{}", "{42}", "{\"\"}" };
    StringWriter strw;
  ...
  @Test public void test330() {
    final JexlEngine jexl = new JexlBuilder().create();
    final String longExpression = "" + "\'THIS IS A VERY VERY VERY VERY VERY VERY VERY " + "VERY VERY LONG STRING CONCATENATION \' + VARIABLE \' <--- " + "error: missing + between VARIABLE and literal\'";
    try {
  ...
  @Test public void testSO20220930() {
  ...
  @Test public void test384b() {
    JexlEngine jexl = new JexlBuilder().arithmetic(new Arithmetic384(true)).safe(false).strict(true).create();
    for (String src0 : Arrays.asList("\'ABC\' + null", "null + \'ABC\'")) {
      JexlContext ctxt = new MapContext();
      JexlScript s0 = jexl.createScript(src0);
  ...
  @Test public void test390() throws Exception {
  ...
  public static class Arithmetic384c extends JexlArithmetic {
    ...
    @Override protected int compare(Object l, Object r, String op) {
      cmp.incrementAndGet();
  ...
  @Test public void test384c() {
    Arithmetic384c ja = new Arithmetic384c(true);
    JexlEngine jexl = new JexlBuilder().safe(false).strict(true).arithmetic(ja).create();
  ...
  <T extends java.lang.Object> T createProxy(final JexlEngine jexl, final Object o, final Class[] clazzz) {
