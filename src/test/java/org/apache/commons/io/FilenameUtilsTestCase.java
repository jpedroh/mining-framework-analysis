...
public class FilenameUtilsTestCase extends FileBasedTestCase {
  ...
  @Before public void setUp() throws Exception {
    ...
    try (BufferedOutputStream output3 = new BufferedOutputStream(new FileOutputStream(testFile1))) {
    ...
    try (BufferedOutputStream output2 = new BufferedOutputStream(new FileOutputStream(testFile2))) {
    ...
    try (BufferedOutputStream output1 = new BufferedOutputStream(new FileOutputStream(testFile1))) {
      TestUtils.generateTestData(output1, (long) testFile1Size);
    }
    if (!testFile2.getParentFile().exists()) {
      throw new IOException("Cannot create file " + testFile2 + " as the parent directory does not exist");
    }
    try (BufferedOutputStream output = new BufferedOutputStream(new FileOutputStream(testFile2))) {
  ...
  @Test public void testNormalize_with_nullbytes() throws Exception {
    try {
      assertEquals("a" + SEP + "b" + SEP + "c.txt", FilenameUtils.normalize("a\\b/c\u0000.txt"));
  ...
  @Test public void testNormalizeUnixWin() throws Exception {
  ...
  @Test public void testNormalizeNoEndSeparatorUnixWin() throws Exception {
  ...
  @Test public void testSeparatorsToUnix() {
  ...
  @Test public void testSeparatorsToWindows() {
  ...
  @Test public void testGetPrefixLength() {
  ...
  @Test public void testIndexOfLastSeparator() {
  ...
  @Test public void testIndexOfExtension() {
  ...
  @Test public void testGetPrefix_with_nullbyte() {
    try {
  ...
  @Test(expected = IllegalArgumentException.class) public void testGetPath_with_nullbyte() {
    assertEquals("a/b/", FilenameUtils.getPath("~user/a/\u0000b/c.txt"));
  }

  @Test public void testGetPathNoEndSeparator() {
    assertEquals(null, FilenameUtils.getPath(null));
    assertEquals("", FilenameUtils.getPath("noseperator.inthispath"));
  ...
  @Test public void testGetPathNoEndSeparator_with_null_byte() {
    try {
      assertEquals("a/b", FilenameUtils.getPathNoEndSeparator("~user/a\u0000/b/c.txt"));
    } catch (IllegalArgumentException ignore) {
    }
  ...
  @Test public void testGetFullPathNoEndSeparator() {
  ...
  /**
     ...
     */
  @Test public void testGetFullPathNoEndSeparator_IO_248() {
    assertEquals("/", FilenameUtils.getFullPathNoEndSeparator("/"));
    assertEquals("\\", FilenameUtils.getFullPathNoEndSeparator("\\"));
  ...
  @Test public void testInjectionFailure() {
    try {
      assertEquals("c", FilenameUtils.getName("a\\b\\\u0000c"));
    } catch (IllegalArgumentException ignore) {
    }
  ...
  @Test public void testGetBaseName_with_nullByte() {
    try {
  ...
  @Test public void testRemoveExtension() {
  ...
  @Test public void testEqualsOnSystem() {
  ...
  @Test public void testEqualsNormalized() {
  ...
  @Test public void testEqualsNormalizedOnSystem() {
  ...
  /**
     ...
     */
  @Test public void testEqualsNormalizedError_IO_128() {
    try {
  ...
  @Test public void testEquals_fullControl() {
  ...
  @Test public void testIsExtension() {
  ...
  @Test public void testIsExtension_injection() {
    try {
  ...
  @Test public void testIsExtensionArray() {
    assertFalse(FilenameUtils.isExtension(null, (String[]) null));
    assertFalse(FilenameUtils.isExtension("file.txt", (String[]) null));
    assertTrue(FilenameUtils.isExtension("file", (String[]) null));
  ...
  @Test public void testIsExtensionCollection() {
