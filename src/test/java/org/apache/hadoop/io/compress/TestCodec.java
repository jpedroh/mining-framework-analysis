...
public class TestCodec {
  ...
  @Test public void testDecryptWithSmallerBuffer() throws IOException, ClassNotFoundException {
    codecBufferSizeTest(1024, 496);
  }

  @Test public void testDecryptFileWithLargerBuffer() throws IOException, ClassNotFoundException {
  ...
  @Test public void testCryptoCodec() throws IOException {
    conf.set(CryptoCodec.CRYPTO_SECRET_KEY, "Una clave cualquiera");
  ...
  @Test public void testSequenceFileCryptoCodec() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException {
    conf.set(CryptoCodec.CRYPTO_SECRET_KEY, "Una clave cualquiera");
