...
import org.zalando.sprocwrapper.example.Example1DomainObject1;
import org.zalando.sprocwrapper.example.Example1DomainObject2;
import org.zalando.sprocwrapper.example.Example2DomainObject1;
import org.zalando.sprocwrapper.example.Example2DomainObject2;
import org.zalando.sprocwrapper.example.ExampleDomainObject;
import org.zalando.sprocwrapper.example.ExampleDomainObjectWithDate;
import org.zalando.sprocwrapper.example.ExampleDomainObjectWithEmbed;
import org.zalando.sprocwrapper.example.ExampleDomainObjectWithEnum;
import org.zalando.sprocwrapper.example.ExampleDomainObjectWithGlobalTransformer;
import org.zalando.sprocwrapper.example.ExampleDomainObjectWithInnerObject;
import org.zalando.sprocwrapper.example.ExampleDomainObjectWithMap;
import org.zalando.sprocwrapper.example.ExampleDomainObjectWithRandomFields;
import org.zalando.sprocwrapper.example.ExampleDomainObjectWithRandomFieldsInner;
import org.zalando.sprocwrapper.example.ExampleDomainObjectWithRandomFieldsOverride;
...
import org.zalando.sprocwrapper.example.LookupType;
import org.zalando.sprocwrapper.example.LookupTypeSchema;
import org.zalando.sprocwrapper.example.OptionalLookupType;
import org.zalando.sprocwrapper.example.Order;
import org.zalando.sprocwrapper.example.OrderMonetaryAmountImpl;
import org.zalando.sprocwrapper.example.OrderPosition;
import org.zalando.sprocwrapper.example.TestInheritanceChild;
import org.zalando.sprocwrapper.example.WrapperLookupSchema;
import org.zalando.sprocwrapper.example.WrapperOptionalLookupType;
import org.zalando.typemapper.parser.DateTimeUtil;

@RunWith(value = SpringJUnit4ClassRunner.class) @ContextConfiguration(locations = { "classpath:backendContextTest.xml" }) public class SimpleIT {
  @Autowired private ExampleSProcService exampleSProcService;

  @Autowired private ExampleValidationSProcService exampleValidationSProcService;

  @Autowired private ExampleNamespacedSProcService exampleNamespacedSProcService;

  @Autowired @Qualifier(value = "testDataSource1") private DataSource dataSource1;

  @Test public void testSample() throws SQLException {
  ...
  @Test public void testSimpleTransformer() throws SQLException {
    final ExampleDomainObjectWithSimpleTransformer transformed = exampleSProcService.testSimpleTransformer(new ExampleDomainObjectWithSimpleTransformer("123", "hallo"));
    assertEquals("123", transformed.getA());
    assertEquals("hallo", transformed.getB());
  }

  @Test public void testMicroSecondTimestamp() throws SQLException {
    java.sql.Timestamp t = exampleSProcService.getMicorsecondTimestamp();
    assertEquals(t.getNanos(), 123456000);
  }

  @Test public void testGlobalTransformer() throws SQLException {
    final ExampleDomainObjectWithGlobalTransformer transformed = exampleSProcService.testGlobalTransformer(new ExampleDomainObjectWithGlobalTransformer("123", new GlobalTransformedObject("hallo"), Lists.newArrayList(new GlobalTransformedObject("list element 1"), new GlobalTransformedObject("list element 2")), Sets.newHashSet(new GlobalTransformedObject("set element 1"), new GlobalTransformedObject("set element 2"))));
    assertEquals("123", transformed.getA());
  ...
  @Test public void testGlobalTransformer2() throws SQLException {
    final GlobalTransformedObject transformed = exampleSProcService.testGlobalTransformer2(new GlobalTransformedObject("global transformed value"));
    assertEquals("global transformed value", transformed.getValue());
  }

  @Test public void testGlobalTransformer3() throws SQLException {
    final GlobalTransformedObject transformed = exampleSProcService.testGlobalTransformer3(new GlobalTransformedObject("global transformed value"), new ExampleDomainObject("EDO a", "EDO b"));
    assertEquals("global transformed value:b:EDO aEDO b", transformed.getValue());
  }

  @Test public void testGlobalTransformer4() throws SQLException {
    final List<GlobalTransformedObject> transformed = exampleSProcService.testGlobalTransformer4(Lists.newArrayList(new GlobalTransformedObject("global transformed value 1"), new GlobalTransformedObject("global transformed value 2")), new ExampleDomainObject("EDO a", "EDO b"));
  ...
  @Test public void testGlobalTransformer5() throws SQLException {
    final GlobalTransformedObject transformed = exampleSProcService.testGlobalTransformer2(null);
    assertNull(transformed);
  }

  @Test public void testGlobalTransformer6() throws SQLException {
    final GlobalTransformedObject transformed = exampleSProcService.testGlobalTransformer2(new GlobalTransformedObject(null));
    assertNull(transformed);
  }

  @Test public void testGlobalTransformer7() throws SQLException {
    final List<GlobalTransformedObject> transformed = exampleSProcService.testGlobalTransformer5(Sets.newHashSet(new GlobalTransformedObject(null)), null);
    assertNotNull(transformed);
    assertEquals(1, transformed.size());
    assertNull(transformed.get(0).getValue());
  }

  @Test public void testGlobalTransformer8() throws SQLException {
  ...
  @Test public void testGlobalTransformer9() throws SQLException {
  ...
  @Test public void testGlobalTransformer10() throws SQLException {
  ...
  @Test public void testGlobalTransformer11() throws SQLException {
  ...
  @Test public void testGlobalTransformer12() throws SQLException {
  ...
  @Test public void testSimpleListParam() throws SQLException {
  ...
  @Test public void testMultiRowTypeMappedResult() {
  ...
  @Test public void testParameterOverloading() {
    assertEquals(3, (int) exampleSProcService.getSimpleInt());
    assertEquals(1234, exampleSProcService.getSimpleInt(1234));
  }

  @Test public void testObjectParam() {
  ...
  @Test public void testListParam() {
  ...
  @Test public void testListParamWithMap() {
  ...
  @Test public void textComplexParam() {
    String result = exampleSProcService.createOrUpdateMultipleObjectsWithInnerObject(null);
    assertNull(result);
    result = exampleSProcService.createOrUpdateMultipleObjectsWithInnerObject(new ArrayList<ExampleDomainObjectWithInnerObject>());
    assertNull(result);
  ...
  @Test public void testReturnDomainObjectWithEnum() {
  ...
  @Test public void testIntegerListParam() {
  ...
  @Test public void testGetAddressSql() {
    final AddressPojo a = getNewTestAddress();
    final AddressPojo b = exampleSProcService.createAddress(a);
    final AddressPojo c = new AddressPojo();
    c.id = b.getId();
  ...
  @Test public void testSensitiveParameter() {
    exampleSProcService.login("henning.jacobs", "mySecR3tPassW0rd");
  }

  @Test public void testNamespacedService() {
    assertEquals("TESTRESULT", exampleNamespacedSProcService.test());
  }

  @Test public void testPrimitiveListResults() {
  ...
  /**
     ...
     */
  @Test public void textComplexParamNameMapping() {
    ...
    result = exampleSProcService.createOrUpdateMultipleObjectsWithRandomFields(Lists.newArrayList(new ExampleDomainObjectWithRandomFields("X", "Y", 1)));
  ...
  /**
     * test correct mapping of complex types with inner type and random field ordering (i.e. not alphabetically sorted)
     */
  @Test public void textComplexParamNameMappingNoAnnotation() {
    String result;
    result = exampleSProcService.createOrUpdateMultipleObjectsWithRandomFieldsNoAnnotation(Lists.newArrayList(new ExampleDomainObjectWithRandomFields("X", "Y", 1)));
    assertEquals("XY1", result);
  }
  ...
  /**
     ...
     */
  @Test public void textComplexParamNameMappingNoAnnotationOverride() {
    String result;
    result = exampleSProcService.createOrUpdateMultipleObjectsWithRandomFieldsNoAnnotationOverride(Lists.newArrayList(new ExampleDomainObjectWithRandomFieldsOverride("X", "Y", 1)));
    assertEquals("XY1", result);
  }

  @Test @Ignore(value = "performance test only") public void testRuntime() {
    assertEquals(1, 1);
  ...
  @Test public void testValidValidation1() {
  ...
  @Test public void testValidValidation2() {
  ...
  @Test public void testValidValidation3() {
  ...
  @Test(expected = ConstraintViolationException.class) public void testValidValidation4() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation("test", 1);
    exampleSProcService.testSprocCallWithValidation(obj);
  }

  @Test(expected = ConstraintViolationException.class) public void testValidValidation5() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation("test", 1);
    exampleValidationSProcService.testSprocCallWithValidation1(obj);
  }

  @Test(expected = ConstraintViolationException.class) public void testValidValidation6() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation("test", 1);
    exampleValidationSProcService.testSprocCallWithValidation2(obj);
  }

  @Test(expected = ConstraintViolationException.class) public void testValidValidation7() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation("test", 1);
    exampleValidationSProcService.testSprocCallWithValidation3(obj);
  }

  @Test(expected = ConstraintViolationException.class) public void testValidValidation8() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation(null, null);
    exampleSProcService.testSprocCallWithValidation(obj);
  }

  @Test(expected = ConstraintViolationException.class) public void testValidValidation9() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation(null, null);
    exampleValidationSProcService.testSprocCallWithValidation1(obj);
  }

  @Test(expected = ConstraintViolationException.class) public void testValidValidation10() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation(null, null);
    exampleValidationSProcService.testSprocCallWithValidation2(obj);
  }

  @Test(expected = ConstraintViolationException.class) public void testValidValidation11() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation(null, null);
    exampleValidationSProcService.testSprocCallWithValidation3(obj);
  }

  @Test public void testValidValidationReturnValue1() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation("test", 4);
    exampleSProcService.testSprocCallWithValidationInvalidRet1(obj);
  }

  @Test(expected = ConstraintViolationException.class) public void testValidValidationReturnValue2() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation("test", 4);
    exampleSProcService.testSprocCallWithValidationInvalidRet2(obj);
  }

  @Test public void testValidationErrorWithNullParameters() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation("test", 4);
    try {
  ...
  @Test public void testValidationWithNullParameter() {
    final ExampleDomainObjectWithValidation obj = new ExampleDomainObjectWithValidation("test", 4);
    exampleValidationSProcService.testSprocCallWithMultipleParametersValidation(obj, "parameter0", "parameter1", null);
  }

  @Test public void testReturnDomainObjectWithEmbed() {
  ...
  @Test public void testReturnDomainObjectWithEmbedEmptyString() {
  ...
  @Test public void testReturnDomainObjectWithEmbedNullFields() {
  ...
  @Test public void testResourcesWithNumbers1() {
  ...
  @Test public void testResourcesWithNumbers2() {
  ...
  @Test public void testReturnDomainObjectWithNullInnerObject() {
  ...
  @Test public void testListComplexObjects() {
  ...
  @Test public void testTypeLookupBugWithList() {
  ...
  @Test public void testTypeLookupBugWithSchema() throws Exception {
  ...
  @Test public void testInheritanceInParameter() throws Exception {
  ...
  @Test public void testMonetaryValue() {
  ...
  @Test public void testMonetaryValueInsideOrder() {
    ...
    o.positions = Arrays.asList(new OrderPosition(new OrderMonetaryAmountImpl(c, "EUR"), new OrderMonetaryAmountImpl(d, "EUR"), addr));
  ...
  @Test public void testOptionalValueWithoutMapping() {
  ...
  @Test public void testEmptyOptionalValues() {
    BigDecimal b = new BigDecimal("12.34");
    BigDecimal c = new BigDecimal("45.67");
  ...
  @Test public void testDatabaseTypeWithoutName() {
  ...
  @Test public void testSQLUpdate() {
  ...
  @Test public void testNullComplexParam() throws Exception {
    exampleSProcService.createOrder(null);
  }

  @Test public void testNullEnumParam() {
    exampleSProcService.useEnumParam(null);
  }

  @Test public void testEnumListNoEntry() {
  ...
  @Test public void testEnumListTwoEntries() {
