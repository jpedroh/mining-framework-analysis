...
@SuppressWarnings(value = { "unchecked" }) public class ChangesSinceLastBuildMacroTest {
  ...
  @Test public void testShouldGetChangesForLatestBuild() throws Exception {
  ...
  @Test public void testShouldGetChangesForLatestBuildEvenWhenPreviousBuildsExist() throws Exception {
  ...
  @Test public void testShouldPrintDate() throws Exception {
  ...
  @Test public void testShouldPrintRevision() throws Exception {
  ...
  @Test public void testShouldPrintPath() throws Exception {
  ...
  @Test public void testWhenShowPathsIsTrueShouldPrintPath() throws Exception {
  ...
  @Test public void testDateFormatString() throws Exception {
    changesSinceLastBuildMacro.format = "%d";
  ...
  @Test public void testTypeFormatStringWithNoGetAffectedFiles() throws Exception {
    changesSinceLastBuildMacro.showPaths = true;
  ...
  @Test public void testTypeFormatStringWithAffectedFiles() throws Exception {
    changesSinceLastBuildMacro.showPaths = true;
  ...
  @Test public void testRegexReplace() throws Exception {
  ...
  @Test public void testShouldPrintDefaultMessageWhenNoChanges() throws Exception {
  ...
  @Test public void testShouldPrintMessageWhenNoChanges() throws Exception {
  ...
  @Test public void testShouldDefaultToNotEscapeHtml() throws Exception {
    AbstractBuild currentBuild = createBuild(Result.SUCCESS, 42, "<b>bold</b>");
    String content = changesSinceLastBuildMacro.evaluate(currentBuild, listener, ChangesSinceLastBuildMacro.MACRO_NAME);
    assertEquals("[Ash Lux] <b>bold</b>\n\n", content);
  }

  @Test public void testShouldEscapeHtmlWhenArgumentEscapeHtmlSetToTrue() throws Exception {
    AbstractBuild currentBuild = createBuild(Result.SUCCESS, 42, "<b>bold</b>");
  ...
  public static class ChangeLogEntryWithAffectedFiles extends ChangeLogEntry {
    ...
    @Override public Collection<AffectedFile> getAffectedFiles() {
