 ...
 * Test Temporals.
 */
@RunWith(value = DataProviderRunner.class) public class TestTemporals {
  ...
  @Test public void test_nextWorkingDayOrSame_serialization() throws IOException, ClassNotFoundException {
  ...
  @Test public void test_nextWorkingDayOrSame() {
    for (Month month : Month.values()) {
      for (int i = 1; i <= month.length(false); i++) {
        LocalDate date = LocalDate.of(2007, month, i);
  ...
  @Test public void test_nextWorkingDayOrSame_yearChange() {
  ...
  @Test public void test_previousWorkingDayOrSame_serialization() throws IOException, ClassNotFoundException {
  ...
  @Test public void test_previousWorkingDayOrSame() {
    for (Month month : Month.values()) {
      for (int i = 1; i <= month.length(false); i++) {
        LocalDate date = LocalDate.of(2007, month, i);
  ...
  @Test public void test_previousWorkingDayOrSame_yearChange() {
    LocalDate sunday = LocalDate.of(2011, JANUARY, 2);
  ...
  @DataProvider public static Object[][] data_parseFirstMatching() {
    return new Object[][] { { "2016-09-06", DateTimeFormatter.ISO_LOCAL_DATE, DateTimeFormatter.BASIC_ISO_DATE }, { "20160906", DateTimeFormatter.ISO_LOCAL_DATE, DateTimeFormatter.BASIC_ISO_DATE } };
  }

  @Test @UseDataProvider(value = "data_parseFirstMatching") public void test_parseFirstMatching(String text, DateTimeFormatter fmt1, DateTimeFormatter fmt2) {
    assertEquals(LocalDate.of(2016, 9, 6), Temporals.parseFirstMatching(text, LocalDate::from, fmt1, fmt2));
  }

  @Test(expected = DateTimeParseException.class) public void test_parseFirstMatching_zero() {
    Temporals.parseFirstMatching("2016-09-06", LocalDate::from);
  }

  @Test public void test_parseFirstMatching_one() {
  ...
  @Test @UseDataProvider(value = "data_convertAmount") public void test_convertAmount_negative(long fromAmount, TemporalUnit fromUnit, TemporalUnit resultUnit, long resultWhole, long resultRemainder) {
    long[] result = Temporals.convertAmount(-fromAmount, fromUnit, resultUnit);
    assertEquals(-resultWhole, result[0]);
    assertEquals(-resultRemainder, result[1]);
  }

  @Test public void test_convertAmountSameUnit_zero() {
  ...
  @Test public void test_convertAmountSameUnit_nonZero() {
    for (ChronoUnit unit : ChronoUnit.values()) {
      if (unit != ERAS && unit != FOREVER) {
  ...
  @DataProvider public static Object[][] data_convertAmountInvalid() {
    return new Object[][] { { SECONDS, MONTHS }, { SECONDS, QUARTER_YEARS }, { SECONDS, YEARS }, { SECONDS, DECADES }, { SECONDS, CENTURIES }, { SECONDS, MILLENNIA }, { MONTHS, SECONDS }, { QUARTER_YEARS, SECONDS }, { YEARS, SECONDS }, { DECADES, SECONDS }, { CENTURIES, SECONDS }, { MILLENNIA, SECONDS } };
  }

  @Test(expected = DateTimeException.class) @UseDataProvider(value = "data_convertAmountInvalid") public void test_convertAmountInvalid(TemporalUnit fromUnit, TemporalUnit resultUnit) {
    Temporals.convertAmount(1, fromUnit, resultUnit);
  }

  @DataProvider public static Object[][] data_convertAmountInvalidUnsupported() {
    return new Object[][] { { SECONDS, ERAS }, { ERAS, SECONDS }, { YEARS, ERAS }, { ERAS, YEARS }, { SECONDS, FOREVER }, { FOREVER, SECONDS }, { YEARS, FOREVER }, { FOREVER, YEARS }, { FOREVER, ERAS }, { ERAS, FOREVER } };
  }

  @Test(expected = UnsupportedTemporalTypeException.class) @UseDataProvider(value = "data_convertAmountInvalidUnsupported") public void test_convertAmountInvalidUnsupported(TemporalUnit fromUnit, TemporalUnit resultUnit) {
    Temporals.convertAmount(1, fromUnit, resultUnit);
  }
}