 ...
 * Test.
 */
@Test @SuppressWarnings(value = { "static-method", "javadoc" }) public class TestSymmetry010Chronology {
  ...
  @DataProvider(name = "samples") Object[][] data_samples() {
    return new Object[][] { { Symmetry010Date.of(1, 1, 1), LocalDate.of(1, 1, 1) }, { Symmetry010Date.of(272, 2, 28), LocalDate.of(272, 2, 27) }, { Symmetry010Date.of(272, 2, 27), LocalDate.of(272, 2, 26) }, { Symmetry010Date.of(742, 3, 27), LocalDate.of(742, 4, 2) }, { Symmetry010Date.of(742, 4, 2), LocalDate.of(742, 4, 7) }, { Symmetry010Date.of(1066, 10, 14), LocalDate.of(1066, 10, 14) }, { Symmetry010Date.of(1304, 7, 21), LocalDate.of(1304, 7, 20) }, { Symmetry010Date.of(1304, 7, 20), LocalDate.of(1304, 7, 19) }, { Symmetry010Date.of(1433, 11, 12), LocalDate.of(1433, 11, 10) }, { Symmetry010Date.of(1433, 11, 10), LocalDate.of(1433, 11, 8) }, { Symmetry010Date.of(1452, 4, 11), LocalDate.of(1452, 4, 15) }, { Symmetry010Date.of(1452, 4, 15), LocalDate.of(1452, 4, 19) }, { Symmetry010Date.of(1492, 10, 10), LocalDate.of(1492, 10, 12) }, { Symmetry010Date.of(1492, 10, 12), LocalDate.of(1492, 10, 14) }, { Symmetry010Date.of(1564, 2, 18), LocalDate.of(1564, 2, 15) }, { Symmetry010Date.of(1564, 2, 15), LocalDate.of(1564, 2, 12) }, { Symmetry010Date.of(1564, 4, 28), LocalDate.of(1564, 4, 26) }, { Symmetry010Date.of(1564, 4, 26), LocalDate.of(1564, 4, 24) }, { Symmetry010Date.of(1643, 1, 7), LocalDate.of(1643, 1, 4) }, { Symmetry010Date.of(1643, 1, 4), LocalDate.of(1643, 1, 1) }, { Symmetry010Date.of(1707, 4, 12), LocalDate.of(1707, 4, 15) }, { Symmetry010Date.of(1707, 4, 15), LocalDate.of(1707, 4, 18) }, { Symmetry010Date.of(1789, 7, 16), LocalDate.of(1789, 7, 14) }, { Symmetry010Date.of(1789, 7, 14), LocalDate.of(1789, 7, 12) }, { Symmetry010Date.of(1879, 3, 14), LocalDate.of(1879, 3, 14) }, { Symmetry010Date.of(1941, 9, 11), LocalDate.of(1941, 9, 9) }, { Symmetry010Date.of(1941, 9, 9), LocalDate.of(1941, 9, 7) }, { Symmetry010Date.of(1970, 1, 4), LocalDate.of(1970, 1, 1) }, { Symmetry010Date.of(1970, 1, 1), LocalDate.of(1969, 12, 29) }, { Symmetry010Date.of(1999, 12, 29), LocalDate.of(2000, 1, 1) }, { Symmetry010Date.of(2000, 1, 1), LocalDate.of(2000, 1, 3) } };
  }

  @Test(dataProvider = "samples") public void test_LocalDate_from_Symmetry010Date(Symmetry010Date sym010, LocalDate iso) {
    assertEquals(LocalDate.from(sym010), iso);
  }

  @Test(dataProvider = "samples") public void test_Symmetry010Date_from_LocalDate(Symmetry010Date sym010, LocalDate iso) {
    assertEquals(Symmetry010Date.from(iso), sym010);
  }

  @Test(dataProvider = "samples") public void test_Symmetry010Date_chronology_dateEpochDay(Symmetry010Date sym010, LocalDate iso) {
    assertEquals(Symmetry010Chronology.INSTANCE.dateEpochDay(iso.toEpochDay()), sym010);
  }

  @Test(dataProvider = "samples") public void test_Symmetry010Date_toEpochDay(Symmetry010Date sym010, LocalDate iso) {
    assertEquals(sym010.toEpochDay(), iso.toEpochDay());
  }

  @Test(dataProvider = "samples") public void test_Symmetry010Date_until_Symmetry010Date(Symmetry010Date sym010, LocalDate iso) {
    assertEquals(sym010.until(sym010), Symmetry010Chronology.INSTANCE.period(0, 0, 0));
  }

  @Test(dataProvider = "samples") public void test_Symmetry010Date_until_LocalDate(Symmetry010Date sym010, LocalDate iso) {
    assertEquals(sym010.until(iso), Symmetry010Chronology.INSTANCE.period(0, 0, 0));
  }

  @Test(dataProvider = "samples") public void test_Chronology_date_Temporal(Symmetry010Date sym010, LocalDate iso) {
    assertEquals(Symmetry010Chronology.INSTANCE.date(iso), sym010);
  }

  @Test(dataProvider = "samples") public void test_LocalDate_until_Symmetry010Date(Symmetry010Date sym010, LocalDate iso) {
    assertEquals(iso.until(sym010), Period.ZERO);
  }

  @Test(dataProvider = "samples") public void test_plusDays(Symmetry010Date sym010, LocalDate iso) {
  ...
  @Test(dataProvider = "samples") public void test_minusDays(Symmetry010Date sym010, LocalDate iso) {
  ...
  @Test(dataProvider = "samples") public void test_until_DAYS(Symmetry010Date sym010, LocalDate iso) {
  ...
  @Test(dataProvider = "badLeapDates", expectedExceptions = DateTimeException.class) public void badLeapDayDates(int year) {
  ...
  @Test(dataProvider = "lengthOfMonth") public void test_lengthOfMonth(int year, int month, int day, int length) {
    assertEquals(Symmetry010Date.of(year, month, day).lengthOfMonth(), length);
  }

  @Test(dataProvider = "lengthOfMonth") public void test_lengthOfMonthFirst(int year, int month, int day, int length) {
  ...
  @DataProvider(name = "prolepticYearBadEra") Object[][] data_prolepticYear_badEra() {
  ...
  @Test(dataProvider = "prolepticYearBadEra", expectedExceptions = ClassCastException.class) public void test_prolepticYear_badEra(Era era) {
  ...
  @DataProvider(name = "getLong") Object[][] data_getLong() {
    return new Object[][] { { 2014, 5, 26, DAY_OF_WEEK, 7 }, { 2014, 5, 26, DAY_OF_MONTH, 26 }, { 2014, 5, 26, DAY_OF_YEAR, 30 + 31 + 30 + 30 + 26 }, { 2014, 5, 26, ALIGNED_DAY_OF_WEEK_IN_MONTH, 7 }, { 2014, 5, 26, ALIGNED_WEEK_OF_MONTH, 4 }, { 2014, 5, 26, ALIGNED_DAY_OF_WEEK_IN_YEAR, 7 }, { 2014, 5, 26, ALIGNED_WEEK_OF_YEAR, 4 + 5 + 4 + 4 + 4 }, { 2014, 5, 26, MONTH_OF_YEAR, 5 }, { 2014, 5, 26, PROLEPTIC_MONTH, 2014 * 12 + 5 - 1 }, { 2014, 5, 26, YEAR, 2014 }, { 2014, 5, 26, ERA, 1 }, { 1, 5, 8, ERA, 1 }, { 2012, 9, 26, DAY_OF_WEEK, 3 }, { 2012, 9, 26, DAY_OF_YEAR, 3 * (4 + 5 + 4) * 7 - 4 }, { 2012, 9, 26, ALIGNED_DAY_OF_WEEK_IN_MONTH, 3 }, { 2012, 9, 26, ALIGNED_WEEK_OF_MONTH, 4 }, { 2012, 9, 26, ALIGNED_DAY_OF_WEEK_IN_YEAR, 3 }, { 2012, 9, 26, ALIGNED_WEEK_OF_YEAR, 3 * (4 + 5 + 4) }, { 2015, 12, 37, DAY_OF_WEEK, 7 }, { 2015, 12, 37, DAY_OF_MONTH, 37 }, { 2015, 12, 37, DAY_OF_YEAR, 4 * (4 + 5 + 4) * 7 + 7 }, { 2015, 12, 37, ALIGNED_DAY_OF_WEEK_IN_MONTH, 7 }, { 2015, 12, 37, ALIGNED_WEEK_OF_MONTH, 6 }, { 2015, 12, 37, ALIGNED_DAY_OF_WEEK_IN_YEAR, 7 }, { 2015, 12, 37, ALIGNED_WEEK_OF_YEAR, 53 }, { 2015, 12, 37, MONTH_OF_YEAR, 12 }, { 2015, 12, 37, PROLEPTIC_MONTH, 2016 * 12 - 1 } };
  }
  ...
  @DataProvider(name = "with") Object[][] data_with() {
    return new Object[][] { { 2014, 5, 26, DAY_OF_WEEK, 1, 2014, 5, 20 }, { 2014, 5, 26, DAY_OF_WEEK, 5, 2014, 5, 24 }, { 2014, 5, 26, DAY_OF_MONTH, 28, 2014, 5, 28 }, { 2014, 5, 26, DAY_OF_MONTH, 26, 2014, 5, 26 }, { 2014, 5, 26, DAY_OF_YEAR, 364, 2014, 12, 30 }, { 2014, 5, 26, DAY_OF_YEAR, 138, 2014, 5, 17 }, { 2014, 5, 26, ALIGNED_DAY_OF_WEEK_IN_MONTH, 3, 2014, 5, 22 }, { 2014, 5, 26, ALIGNED_DAY_OF_WEEK_IN_MONTH, 5, 2014, 5, 24 }, { 2014, 5, 26, ALIGNED_WEEK_OF_MONTH, 1, 2014, 5, 5 }, { 2014, 5, 26, ALIGNED_WEEK_OF_MONTH, 4, 2014, 5, 26 }, { 2014, 5, 26, ALIGNED_DAY_OF_WEEK_IN_YEAR, 2, 2014, 5, 21 }, { 2014, 5, 26, ALIGNED_DAY_OF_WEEK_IN_YEAR, 5, 2014, 5, 24 }, { 2014, 5, 26, ALIGNED_WEEK_OF_YEAR, 23, 2014, 6, 9 }, { 2014, 5, 26, ALIGNED_WEEK_OF_YEAR, 20, 2014, 5, 19 }, { 2014, 5, 26, MONTH_OF_YEAR, 4, 2014, 4, 26 }, { 2014, 5, 26, MONTH_OF_YEAR, 5, 2014, 5, 26 }, { 2014, 5, 26, PROLEPTIC_MONTH, 2013 * 12 + 3 - 1, 2013, 3, 26 }, { 2014, 5, 26, PROLEPTIC_MONTH, 2014 * 12 + 5 - 1, 2014, 5, 26 }, { 2014, 5, 26, YEAR, 2012, 2012, 5, 26 }, { 2014, 5, 26, YEAR, 2014, 2014, 5, 26 }, { 2014, 5, 26, YEAR_OF_ERA, 2012, 2012, 5, 26 }, { 2014, 5, 26, YEAR_OF_ERA, 2014, 2014, 5, 26 }, { 2014, 5, 26, ERA, 1, 2014, 5, 26 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_MONTH, 1, 2015, 12, 17 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_MONTH, 2, 2015, 12, 18 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_MONTH, 3, 2015, 12, 19 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_MONTH, 4, 2015, 12, 20 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_MONTH, 5, 2015, 12, 21 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_MONTH, 6, 2015, 12, 22 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_MONTH, 7, 2015, 12, 23 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_YEAR, 1, 2015, 12, 17 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_YEAR, 2, 2015, 12, 18 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_YEAR, 3, 2015, 12, 19 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_YEAR, 4, 2015, 12, 20 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_YEAR, 5, 2015, 12, 21 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_YEAR, 6, 2015, 12, 22 }, { 2015, 12, 22, ALIGNED_DAY_OF_WEEK_IN_YEAR, 7, 2015, 12, 23 }, { 2015, 12, 29, ALIGNED_WEEK_OF_MONTH, 0, 2015, 12, 29 }, { 2015, 12, 29, ALIGNED_WEEK_OF_MONTH, 3, 2015, 12, 15 }, { 2015, 12, 29, ALIGNED_WEEK_OF_YEAR, 0, 2015, 12, 29 }, { 2015, 12, 29, ALIGNED_WEEK_OF_YEAR, 3, 2015, 1, 20 }, { 2015, 12, 29, DAY_OF_WEEK, 0, 2015, 12, 29 }, { 2015, 12, 28, DAY_OF_WEEK, 1, 2015, 12, 24 }, { 2015, 12, 28, DAY_OF_WEEK, 2, 2015, 12, 25 }, { 2015, 12, 28, DAY_OF_WEEK, 3, 2015, 12, 26 }, { 2015, 12, 28, DAY_OF_WEEK, 4, 2015, 12, 27 }, { 2015, 12, 28, DAY_OF_WEEK, 5, 2015, 12, 28 }, { 2015, 12, 28, DAY_OF_WEEK, 6, 2015, 12, 29 }, { 2015, 12, 28, DAY_OF_WEEK, 7, 2015, 12, 30 }, { 2015, 12, 29, DAY_OF_MONTH, 1, 2015, 12, 1 }, { 2015, 12, 29, DAY_OF_MONTH, 3, 2015, 12, 3 }, { 2015, 12, 29, MONTH_OF_YEAR, 1, 2015, 1, 29 }, { 2015, 12, 29, MONTH_OF_YEAR, 12, 2015, 12, 29 }, { 2015, 12, 29, MONTH_OF_YEAR, 2, 2015, 2, 29 }, { 2015, 12, 37, YEAR, 2004, 2004, 12, 37 }, { 2015, 12, 37, YEAR, 2013, 2013, 12, 30 }, { 2014, 3, 28, DAY_OF_MONTH, 1, 2014, 3, 1 }, { 2014, 1, 28, DAY_OF_MONTH, 1, 2014, 1, 1 }, { 2014, 3, 28, MONTH_OF_YEAR, 1, 2014, 1, 28 }, { 2015, 3, 28, DAY_OF_YEAR, 371, 2015, 12, 37 }, { 2012, 3, 28, DAY_OF_YEAR, 364, 2012, 12, 30 } };
  }
  ...
  @DataProvider(name = "temporalAdjusters_lastDayOfMonth") Object[][] data_temporalAdjusters_lastDayOfMonth() {
  ...
  @Test(dataProvider = "temporalAdjusters_lastDayOfMonth") public void test_temporalAdjusters_LastDayOfMonth(int year, int month, int day, int expectedYear, int expectedMonth, int expectedDay) {
  ...
  @Test public void test_LocalDate_adjustToSymmetry010Date() {
  ...
  @Test public void test_LocalDateTime_adjustToSymmetry010Date() {
    Symmetry010Date sym010 = Symmetry010Date.of(2012, 7, 19);
  ...
  @DataProvider(name = "plus_leapWeek") Object[][] data_plus_leapWeek() {
  ...
  @Test(dataProvider = "plus_leapWeek") public void test_plus_leapWeek_TemporalUnit(int year, int month, int dom, long amount, TemporalUnit unit, int expectedYear, int expectedMonth, int expectedDom) {
    assertEquals(Symmetry010Date.of(year, month, dom).plus(amount, unit), Symmetry010Date.of(expectedYear, expectedMonth, expectedDom));
  }
  ...
  @Test(dataProvider = "plus_leapWeek") public void test_minus_leapWeek_TemporalUnit(int expectedYear, int expectedMonth, int expectedDom, long amount, TemporalUnit unit, int year, int month, int dom) {
    assertEquals(Symmetry010Date.of(year, month, dom).minus(amount, unit), Symmetry010Date.of(expectedYear, expectedMonth, expectedDom));
  }
  ...
  @DataProvider(name = "until") Object[][] data_until() {
    return new Object[][] { { 2014, 5, 26, 2014, 5, 26, DAYS, 0 }, { 2014, 5, 26, 2014, 6, 4, DAYS, 9 }, { 2014, 5, 26, 2014, 5, 20, DAYS, -6 }, { 2014, 5, 26, 2014, 5, 26, WEEKS, 0 }, { 2014, 5, 26, 2014, 6, 1, WEEKS, 0 }, { 2014, 5, 26, 2014, 6, 5, WEEKS, 1 }, { 2014, 5, 26, 2014, 5, 26, MONTHS, 0 }, { 2014, 5, 26, 2014, 6, 25, MONTHS, 0 }, { 2014, 5, 26, 2014, 6, 26, MONTHS, 1 }, { 2014, 5, 26, 2014, 5, 26, YEARS, 0 }, { 2014, 5, 26, 2015, 5, 25, YEARS, 0 }, { 2014, 5, 26, 2015, 5, 26, YEARS, 1 }, { 2014, 5, 26, 2014, 5, 26, DECADES, 0 }, { 2014, 5, 26, 2024, 5, 25, DECADES, 0 }, { 2014, 5, 26, 2024, 5, 26, DECADES, 1 }, { 2014, 5, 26, 2014, 5, 26, CENTURIES, 0 }, { 2014, 5, 26, 2114, 5, 25, CENTURIES, 0 }, { 2014, 5, 26, 2114, 5, 26, CENTURIES, 1 }, { 2014, 5, 26, 2014, 5, 26, MILLENNIA, 0 }, { 2014, 5, 26, 3014, 5, 25, MILLENNIA, 0 }, { 2014, 5, 26, 3014, 5, 26, MILLENNIA, 1 }, { 2014, 5, 26, 3014, 5, 26, ERAS, 0 } };
  }

  @DataProvider(name = "until_period") Object[][] data_until_period() {
  ...
  @Test(dataProvider = "until_period") public void test_until_end(int year1, int month1, int dom1, int year2, int month2, int dom2, int yearPeriod, int monthPeriod, int dayPeriod) {
    Symmetry010Date start = Symmetry010Date.of(year1, month1, dom1);
    Symmetry010Date end = Symmetry010Date.of(year2, month2, dom2);
  ...
  @Test public void test_plus_Period() {
    assertEquals(Symmetry010Date.of(2014, 5, 21).plus(Symmetry010Chronology.INSTANCE.period(0, 2, 8)), Symmetry010Date.of(2014, 7, 29));
  }

  @Test(expectedExceptions = DateTimeException.class) public void test_plus_Period_ISO() {
    assertEquals(Symmetry010Date.of(2014, 5, 26).plus(Period.ofMonths(2)), Symmetry010Date.of(2014, 7, 26));
  }

  @Test public void test_minus_Period() {
    assertEquals(Symmetry010Date.of(2014, 5, 26).minus(Symmetry010Chronology.INSTANCE.period(0, 2, 3)), Symmetry010Date.of(2014, 3, 23));
  }
  ...
  @DataProvider(name = "equals") Object[][] data_equals() {
    return new Object[][] { { Symmetry010Date.of(2000, 1, 3), Symmetry010Date.of(2000, 1, 4), Symmetry010Date.of(2000, 2, 3), Symmetry010Date.of(2001, 1, 3) }, { Symmetry010Date.of(2000, 12, 28), Symmetry010Date.of(2000, 12, 25), Symmetry010Date.of(2001, 1, 1), Symmetry010Date.of(2001, 12, 28) }, { Symmetry010Date.of(2000, 6, 28), Symmetry010Date.of(2000, 6, 23), Symmetry010Date.of(2000, 7, 1), Symmetry010Date.of(2004, 6, 28) } };
  }

  @Test(dataProvider = "equals") void test_equals(Symmetry010Date a1, Symmetry010Date b, Symmetry010Date c, Symmetry010Date d) {
  ...
  @Test(dataProvider = "toString") public void test_toString(Symmetry010Date date, String expected) {
