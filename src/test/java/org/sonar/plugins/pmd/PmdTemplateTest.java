...
class PmdTemplateTest {
  ...
  void should_fail_on_invalid_java_version() {
    final Throwable thrown = catchThrowable(() -> PmdTemplate.create("12.2", mock(.class), StandardCharsets.UTF_8));
    assertThat(thrown).isInstanceOf(java.lang.IllegalArgumentException.class);
  }

  @Test
  void shouldnt_fail_on_valid_java_version() {
    PmdTemplate.create("6", mock(java.lang.ClassLoader.class), StandardCharsets.UTF_8);
  }
  ...
  void should_set_classloader() {
    ClassLoader classloader = mock(java.lang.ClassLoader.class);
  ...
  void should_set_encoding() {
    PmdTemplate pmdTemplate = PmdTemplate.create("6", mock(java.lang.ClassLoader.class), StandardCharsets.UTF_16BE);
