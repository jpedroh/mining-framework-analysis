...
public class BlameVersionSelectorTest {
  @Rule public TemporaryFile temporaryFile = new TemporaryFile();
  ...
  @Test public void should_save_blame_when_file_changed() throws IOException {
  ...
  @Test public void should_save_blame_when_file_is_the_same_but_no_previous_measures_present() throws IOException {
    File file = file("source.java", "foo");
    DefaultInputFile inputFile = new DefaultInputFile("source.java").setFile(file);
  ...
  @Test public void should_copy_previous_measures_when_file_is_the_same_and_previous_measures_present() throws IOException {
    File file = file("source.java", "foo");
    DefaultInputFile inputFile = new DefaultInputFile("source.java").setFile(file);
    inputFile.setStatus(InputFile.Status.SAME);
  ...
  @Test public void should_save_blame_when_reloadEnabled() throws IOException {
    File file = file("source.java", "foo");
