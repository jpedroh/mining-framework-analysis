...
public class ScmFacadeTest {
  ...
  @Test public void should_set_credentials() throws ScmException {
  ...
  @Test public void should_not_set_credentials_for_blank_user() throws ScmException {
  ...
  @Test public void should_set_credentials_for_blank_password() throws ScmException {
    when(conf.getUrl()).thenReturn("/url");
  ...
  @Test public void shouldInitSvn() throws ScmException {
    when(conf.getUrl()).thenReturn("/url");
  ...
  @Test(expected = SonarException.class) public void should_report_repository_failure() throws ScmException {
    when(manager.makeScmRepository(anyString())).thenThrow(new ScmRepositoryException("BUG"));
    scmFacade.getScmRepository();
  }

  @Test(expected = SonarException.class) public void should_report_failure() throws ScmException {
    when(manager.makeScmRepository(anyString())).thenThrow(new NoSuchScmProviderException("BUG"));
    scmFacade.getScmRepository();
  }

  @Test public void should_blame_file() throws ScmException {
  ...
  @Test public void should_set_clientspec_property_for_erforce() throws ScmException {
    when(conf.getUrl()).thenReturn("/url");
  ...
  @Test public void should_set_svn_options_property() throws ScmException {
    when(conf.getUrl()).thenReturn("/url");
    when(conf.getScmProvider()).thenReturn("svn");
