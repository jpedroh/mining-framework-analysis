...
class FindbugsConfigurationTest {
  ...
  @Test void should_warn_of_missing_precompiled_jsp() throws IOException {
  ...
  @Test void should_analyze_precompiled_jsp() throws IOException {
  ...
  @Test void scala_project() throws IOException {
