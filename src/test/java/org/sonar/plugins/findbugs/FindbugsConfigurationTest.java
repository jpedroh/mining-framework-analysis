...
class FindbugsConfigurationTest {
  ...
  @Test public void should_get_only_analyze_filter() {
  ...
  @ParameterizedTest @ValueSource(booleans = { true, false }) void should_warn_of_missing_precompiled_jsp(boolean withSq98Api) throws IOException {
  ...
  @ParameterizedTest @ValueSource(booleans = { true, false }) void should_analyze_precompiled_jsp(boolean withSq98Api) throws IOException {
  ...
  @ParameterizedTest @ValueSource(booleans = { true, false }) void scala_project(boolean withSq98Api) throws IOException {
