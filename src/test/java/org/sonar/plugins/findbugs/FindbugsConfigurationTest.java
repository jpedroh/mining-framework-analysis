...
class FindbugsConfigurationTest {
  ...
  @RegisterExtension public LogTester logTester = new JupiterLogTester();
  ...
  @Test void should_return_effort() {
  ...
  @Test void should_return_timeout() {
  ...
  @Test void should_return_excludes_filters() {
  ...
  @Test void should_return_confidence_level() {
  ...
  @Test void should_set_class_files() throws IOException {
  ...
  @Test void should_set_class_path() throws IOException {
  ...
  @Test void should_get_only_analyze_filter() {
    ...
    assertTrue(expected.matches("any/random/src/main/java/com/exam" + "ple/Test.class"));
    configuration.setProperty(FindbugsConstants.ONLY_ANALYZE_PROPERTY, "com.example.*");
    expected = conf.getOnlyAnalyzeFilter();
    assertNotNull(expected);
    assertTrue(expected.matches("any/random/src/main/java/com/exam" + "ple/Test.class"));
    assertTrue(expected.matches("any/random/src/main/java/com/exam" + "ple/Test2.class"));
    configuration.setProperty(FindbugsConstants.ONLY_ANALYZE_PROPERTY, "com.example.-");
    expected = conf.getOnlyAnalyzeFilter();
    assertNotNull(expected);
    assertTrue(expected.matches("any/random/src/main/java/com/exam" + "ple/Test1.class"));
    assertTrue(expected.matches("any/random/src/main/java/com/exam" + "ple/innerPackage/Test2.class"));
    configuration.setProperty(FindbugsConstants.ONLY_ANALYZE_PROPERTY, "");
  }

  @Test void scanEmptyFolderForAdditionalClasses() throws IOException {
    List<File> classes = FindbugsConfiguration.scanForAdditionalClasses(temp, (f) -> true);
    assertThat(classes).isEmpty();
  }

  @ParameterizedTest @CsvSource(value = { "true,true", "true,false", "false,true", "false,false" }) void should_warn_of_missing_precompiled_jsp(boolean withSq98Api, boolean analyzeTests) throws IOException {
  ...
  @ParameterizedTest @CsvSource(value = { "true,true", "true,false", "false,true", "false,false" }) void should_analyze_precompiled_jsp(boolean withSq98Api, boolean analyzeTests) throws IOException {
  ...
  @ParameterizedTest @CsvSource(value = { "true,true", "true,false", "false,true", "false,false" }) void scala_project(boolean withSq98Api, boolean analyzeTests) throws IOException {
  ...
  private void setupSampleProject(boolean withPrecompiledJsp, boolean withJspFiles, boolean withScalaFiles, boolean withSq98Api, boolean analyzeTests) throws IOException {
  ...
  @Test void buildMissingCompiledCodeException() {
