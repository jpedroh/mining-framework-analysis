...
class FindbugsSensorTest extends FindbugsTests {
  ...
  @Test void should_execute_findbugs() throws Exception {
  ...
  @Test void should_not_add_issue_if_resource_not_found() throws Exception {
  ...
  @Test void should_execute_findbugs_even_if_only_fbcontrib() throws Exception {
  ...
  @Test void should_execute_findbugs_even_if_only_findsecbug() throws Exception {
  ...
  @Test void should_execute_findbugs_but_not_find_violation() throws Exception {
  ...
  @Test void should_not_execute_findbugs_if_no_active() throws Exception {
    when(javaResourceLocator.classFilesToAnalyze()).thenReturn(Collections.singletonList(new File("file")));
   ...
   */
  @Test void should_not_execute_findbugs_if_only_jsp_rules_and_no_jsp_file() throws Exception {
   ...
   */
  @Test void should_execute_findbugs_if_only_jsp_rules_and_some_jsp_files() throws Exception {
  ...
  @Test void should_execute_findbugs_with_missing_smap_and_source() throws Exception {
    BugInstance bugInstance = getBugInstance("AM_CREATES_EMPTY_ZIP_FILE_ENTRY", 6, true);
    Collection<ReportedBug> collection = Arrays.asList(new ReportedBug(bugInstance));
  ...
  @Test void should_execute_findbugs_with_smap() throws Exception {
    BugInstance bugInstance = getBugInstance("AM_CREATES_EMPTY_ZIP_FILE_ENTRY", 6, true);
    Collection<ReportedBug> collection = Arrays.asList(new ReportedBug(bugInstance));
    when(executor.execute(false, false)).thenReturn(collection);
    JavaResourceLocator javaResourceLocator = mockJavaResourceLocator();
  ...
  @Test void shouldIgnoreNotActiveViolations() throws Exception {
