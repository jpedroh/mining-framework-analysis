...
@RunWith(Suite.class)
@SuiteClasses({ AllAssertionTests.class, AllDeprecatedTests.class, AllDescriptionTests.class, AllExperimentalTests.class, AllInternalTests.class, AllJUnit3CompatibilityTests.class, AllListeningTests.class, AllManipulationTests.class, AllRulesTests.class, AllRunnersTests.class, AllRunnerTests.class, AllRunningTests.class, AllSamplesTests.class, AllValidationTests.class, AllValidatorTests.class, AssumptionViolatedExceptionTest.class, ObjectContractTest.class })
