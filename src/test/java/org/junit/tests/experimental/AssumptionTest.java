...
public class AssumptionTest {
  ...
  @Test public void failedAssumptionsMeanPassing() {
  ...
  @Test public void passingAssumptionsScootThrough() {
  ...
  @Test public void assumeThatWorks() {
    try {
      assumeThat(1, is(2));
  ...
  @Test public void assumeThatPasses() {
    assumeThat(1, is(1));
    assertCompletesNormally();
  }

  @Test public void assumeThatPassesOnStrings() {
    assumeThat("x", is("x"));
    assertCompletesNormally();
  }

  @Test public void assumeNotNullThrowsException() {
  ...
  @Test public void assumeNotNullThrowsExceptionForNullArray() {
    try {
  ...
  @Test public void assumeNotNullPasses() {
    Object[] objects = { 1, 2 };
    assumeNotNull(objects);
    assertCompletesNormally();
  }

  @Test public void assumeNotNullIncludesParameterList() {
    try {
      Object[] objects = { 1, 2, null };
      assumeNotNull(objects);
    } catch (AssumptionViolatedException e) {
  ...
  @Test public void assumeNoExceptionThrows() {
  ...
  @Test public void assumeTrueWorks() {
    try {
  ...
  public static class TestClassWithAssumptionFailure {
    @Test(expected = IllegalArgumentException.class) public void assumeWithExpectedException() {
      assumeTrue(false);
    }
  }

  @Test public void assumeWithExpectedExceptionShouldThrowAssumptionViolatedException() {
  ...
  @Test public void assumptionsWithMessageAndCause() {
  ...
  @Test public void failedAssumptionsWithMessage() {
