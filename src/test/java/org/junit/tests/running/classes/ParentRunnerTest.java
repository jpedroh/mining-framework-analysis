...
public class ParentRunnerTest {
  ...
  @Test public void testMultipleFilters() throws Exception {
  ...
  private Matcher<List<?>> isEmpty() {
    return new TypeSafeMatcher<List<?>>() {
      ...
      @Override public boolean matchesSafely(List<?> item) {
        return item.size() == 0;
      }
    };
  }
  ...
  @Test public void failWithHelpfulMessageForProtectedClassRule() {
  ...
  @Test public void cannotBeCreatedWithNonPublicTestClass() {
  ...
  @Test public void assertionErrorAtParentLevelTest() throws InitializationError {
  ...
  public static class AssumptionViolatedAtParentLevelTest {
    @SuppressWarnings(value = { "deprecation" }) @BeforeClass public static void beforeClass() {
  ...
  @Test public void assumptionViolatedAtParentLevel() throws InitializationError {
  ...
  public static class TestTest {
    ...
    @SuppressWarnings(value = { "deprecation" }) @Test public void assumptionFail() {
      throw new AssumptionViolatedException("Thrown from @Test");
    }
  }

  @Test public void parentRunnerTestMethods() throws InitializationError {
