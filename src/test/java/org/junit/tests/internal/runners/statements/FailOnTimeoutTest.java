...
<<<<<<< /usr/src/app/output/junit-team/junit4/0546b36b9a793a959d45c64fc04bc1615f308de7/src/test/java/org/junit/tests/internal/runners/statements/FailOnTimeoutTest.java/left.java
  new FailOnTimeout(statement, TIMEOUT, "Test Name")
=======
  builder().withTimeout(TIMEOUT, MILLISECONDS).build(statement)
>>>>>>> /usr/src/app/output/junit-team/junit4/0546b36b9a793a959d45c64fc04bc1615f308de7/src/test/java/org/junit/tests/internal/runners/statements/FailOnTimeoutTest.java/right.java
  ...
  @Test public void throwsTestTimedOutException() throws Throwable {
    thrown.expect(TestTimedOutException.class);
    evaluateWithWaitDuration(DURATION_THAT_EXCEEDS_TIMEOUT);
  }

  @Test public void throwExceptionWithNiceMessageOnTimeout() throws Throwable {
    thrown.expectMessage("test timed out after 100 milliseconds");
    evaluateWithWaitDuration(DURATION_THAT_EXCEEDS_TIMEOUT);
  }

  @Test public void sendUpExceptionThrownByStatement() throws Throwable {
  ...
  @Test public void throwTimeoutExceptionOnSecondCallAlthoughFirstCallThrowsException() throws Throwable {
    thrown.expectMessage("test timed out after 100 milliseconds");
    try {
  ...
  @Test public void throwsExceptionWithTimeoutValueAndTimeUnitSet() throws Throwable {
    try {
      evaluateWithWaitDuration(DURATION_THAT_EXCEEDS_TIMEOUT);
...
<<<<<<< /usr/src/app/output/junit-team/junit4/0546b36b9a793a959d45c64fc04bc1615f308de7/src/test/java/org/junit/tests/internal/runners/statements/FailOnTimeoutTest.java/left.java
    new FailOnTimeout(infiniteLoop, TIMEOUT, "TestName")
=======
    builder().withTimeout(TIMEOUT, MILLISECONDS).build(infiniteLoop)
>>>>>>> /usr/src/app/output/junit-team/junit4/0546b36b9a793a959d45c64fc04bc1615f308de7/src/test/java/org/junit/tests/internal/runners/statements/FailOnTimeoutTest.java/right.java
    ;
    try {
...
<<<<<<< /usr/src/app/output/junit-team/junit4/0546b36b9a793a959d45c64fc04bc1615f308de7/src/test/java/org/junit/tests/internal/runners/statements/FailOnTimeoutTest.java/left.java
    new FailOnTimeout(stuck, TIMEOUT, "TestName")
=======
    builder().withTimeout(TIMEOUT, MILLISECONDS).build(stuck)
>>>>>>> /usr/src/app/output/junit-team/junit4/0546b36b9a793a959d45c64fc04bc1615f308de7/src/test/java/org/junit/tests/internal/runners/statements/FailOnTimeoutTest.java/right.java
    ;
    try {
  ...
  @Test public void timeoutThreadNameTest() throws Throwable {
