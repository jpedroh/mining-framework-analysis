...
public abstract class HttpClientAbstactIT extends AbstactIT {
  ...
  private static void createURIs() throws URISyntaxException {
    rootUri = buildURI("/", new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    rootUriRemapped = buildURI(REMAPPEDALL, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    dbUri = buildURI("/" + dbName, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    dbUriPaging = buildURI("/" + dbName, new NameValuePair[] { new BasicNameValuePair("pagesize", "1"), new BasicNameValuePair("hal", "f") });
    dbUriRemappedAll = buildURI(REMAPPEDALL + "/" + dbName, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    dbUriRemappedDb = buildURI(REMAPPEDDB, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    dbTmpUri = buildURI("/" + dbTmpName);
    dbTmpUri2 = buildURI("/" + dbTmpName2, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    dbTmpUri3 = buildURI("/" + dbTmpName3, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    collection1Uri = buildURI("/" + dbName + "/" + collection1Name, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    collection1UriRemappedAll = buildURI(REMAPPEDALL + "/" + dbName + "/" + collection1Name, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    collection1UriRemappedDb = buildURI(REMAPPEDDB + "/" + collection1Name, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    collection1UriRemappedCollection = buildURI(REMAPPEDREFCOLL1, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    collection2Uri = buildURI("/" + dbName + "/" + collection2Name, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    collection2UriRemappedAll = buildURI(REMAPPEDALL + "/" + dbName + "/" + collection2Name, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    collection2UriRemappedDb = buildURI(REMAPPEDDB + "/" + collection2Name, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    collection2UriRemappedCollection = buildURI(REMAPPEDREFCOLL2, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    collectionTmpUri = buildURI("/" + dbTmpName + "/" + collectionTmpName, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    collectionTmpUserUri2 = buildURI("/" + dbTmpName2 + "/" + collectionTmpUserName2, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    collectionTmpUserUri3 = buildURI("/" + dbTmpName3 + "/" + collectionTmpUserName2, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    docsCollectionUri = buildURI("/" + dbName + "/" + docsCollectionName, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    docsCollectionUriPaging = buildURI("/" + dbName + "/" + docsCollectionName, new NameValuePair[] { new BasicNameValuePair("pagesize", "2"), new BasicNameValuePair("hal", "f") });
    docsCollectionUriCountAndPaging = buildURI("/" + dbName + "/" + docsCollectionName, new NameValuePair[] { new BasicNameValuePair("count", null), new BasicNameValuePair("page", "2"), new BasicNameValuePair("pagesize", "2"), new BasicNameValuePair("hal", "f") });
    docsCollectionUriSort = buildURI("/" + dbName + "/" + docsCollectionName, new NameValuePair[] { new BasicNameValuePair("sort_by", "surname"), new BasicNameValuePair("hal", "f") });
    docsCollectionUriFilter = buildURI("/" + dbName + "/" + docsCollectionName, new NameValuePair[] { new BasicNameValuePair("filter", "{\'name\':{\'$regex\':\'.*k$\'}}"), new BasicNameValuePair("sort_by", "name"), new BasicNameValuePair("count", null), new BasicNameValuePair("hal", "f") });
    indexesUri = buildURI("/" + dbName + "/" + docsCollectionName + _INDEXES, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    indexesUriRemappedAll = buildURI(REMAPPEDALL + "/" + dbName + "/" + docsCollectionName + _INDEXES, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    indexesUriRemappedDb = buildURI(REMAPPEDDB + "/" + docsCollectionName + _INDEXES, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    indexesTmpUri = buildURI("/" + dbTmpName + "/" + collectionTmpName + _INDEXES, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    indexTmpUri = buildURI("/" + dbTmpName + "/" + collectionTmpName + _INDEXES + "/new-index", new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    documentTmpUri = buildURI("/" + dbTmpName + "/" + collectionTmpName + "/" + documentTmpId, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    document1Uri = buildURI("/" + dbName + "/" + collection1Name + "/" + document1Id, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    document1UriRemappedAll = buildURI(REMAPPEDALL + "/" + dbName + "/" + collection1Name + "/" + document1Id, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    document1UriRemappedDb = buildURI(REMAPPEDDB + "/" + collection1Name + "/" + document1Id, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    document1UriRemappedCollection = buildURI(REMAPPEDREFCOLL1 + "/" + document1Id, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    document1UriRemappedDocument = buildURI(REMAPPEDDOC1, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    document2Uri = buildURI("/" + dbName + "/" + collection2Name + "/" + document2Id, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    document2UriRemappedAll = buildURI(REMAPPEDALL + "/" + dbName + "/" + collection1Name + "/" + document2Id, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    document2UriRemappedDb = buildURI(REMAPPEDDB + "/" + collection2Name + "/" + document2Id, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    document2UriRemappedCollection = buildURI(REMAPPEDREFCOLL2 + "/" + document2Id, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
    document2UriRemappedDocument = buildURI(REMAPPEDDOC2, new NameValuePair[] { new BasicNameValuePair("hal", "f") });
  ...
  protected static URI buildURI(String path, NameValuePair[] parameters) throws URISyntaxException {
    return createURIBuilder(path).addParameters(Arrays.asList(parameters)).build();
  }
  ...
  private static URIBuilder createURIBuilder(String path) {
    return new URIBuilder().setScheme(HTTP).setHost(HTTP_HOST.getHostName()).setPort(HTTP_HOST.getPort()).setPath(path);
  }

  protected static URI addCheckEtag(URI uri) throws URISyntaxException {
    return createURIBuilder(uri.getPath()).addParameter("checkEtag", null).addParameter("hal", "f").build();
  }
