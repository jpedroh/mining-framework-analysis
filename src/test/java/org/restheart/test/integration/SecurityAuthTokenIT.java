 ...
 */
@Ignore public class SecurityAuthTokenIT extends HttpClientAbstactIT {
  ...
  @Test public void testAuthToken() throws Exception {
  ...
  @Test public void testAuthTokenResourceLocation() throws Exception {
    Response resp = adminExecutor.execute(Request.Get(rootUri));
    HttpResponse httpResp = resp.returnResponse();
    assertNotNull(httpResp);
    StatusLine statusLine = httpResp.getStatusLine();
    ...
    assertTrue("check content type", entity.getContentType().getValue().equals(Resource.HAL_JSON_MEDIA_TYPE) || entity.getContentType().getValue().equals(Resource.JSON_MEDIA_TYPE));
  ...
  @Test public void testAuthTokenInvalidation() throws Exception {
    Response resp = adminExecutor.execute(Request.Get(rootUri));
    HttpResponse httpResp = resp.returnResponse();
    assertNotNull(httpResp);
    StatusLine statusLine = httpResp.getStatusLine();
