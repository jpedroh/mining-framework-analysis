...
public abstract class AbstactIT {
  ...
  private static void createURIs() throws URISyntaxException {
    rootUri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/").build();
    rootUriRemapped = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDALL).build();
    dbUri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName).build();
    dbUriPaging = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName).addParameter("pagesize", "1").build();
    dbUriRemappedAll = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDALL + "/" + dbName).build();
    dbUriRemappedDb = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDDB).build();
    dbTmpUri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbTmpName).build();
    collection1Uri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName + "/" + collection1Name).build();
    collection1UriRemappedAll = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDALL + "/" + dbName + "/" + collection1Name).build();
    collection1UriRemappedDb = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDDB + "/" + collection1Name).build();
    collection1UriRemappedCollection = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDREFCOLL1).build();
    collection2Uri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName + "/" + collection2Name).build();
    collection2UriRemappedAll = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDALL + "/" + dbName + "/" + collection2Name).build();
    collection2UriRemappedDb = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDDB + "/" + collection2Name).build();
    collection2UriRemappedCollection = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDREFCOLL2).build();
    collectionTmpUri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbTmpName + "/" + collectionTmpName).build();
    docsCollectionUri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName + "/" + docsCollectionName).build();
    docsCollectionUriPaging = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName + "/" + docsCollectionName).addParameter("pagesize", "2").build();
    docsCollectionUriCountAndPaging = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName + "/" + docsCollectionName).addParameter("count", null).addParameter("page", "2").addParameter("pagesize", "2").build();
    docsCollectionUriSort = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName + "/" + docsCollectionName).addParameter("sort_by", "surname").build();
    docsCollectionUriFilter = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName + "/" + docsCollectionName).addParameter("filter", "{\'name\':{\'$regex\' : \'.*k$\'}}").addParameter("sort_by", "name").addParameter("count", null).build();
    indexesUri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName + "/" + docsCollectionName + _INDEXES).build();
    indexesUriRemappedAll = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDALL + "/" + dbName + "/" + docsCollectionName + _INDEXES).build();
    indexesUriRemappedDb = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDDB + "/" + docsCollectionName + _INDEXES).build();
    documentTmpUri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbTmpName + "/" + collectionTmpName + "/" + documentTmpId).build();
    indexesTmpUri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbTmpName + "/" + collectionTmpName + _INDEXES).build();
    indexTmpUri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbTmpName + "/" + collectionTmpName + _INDEXES + "/new-index").build();
    document1Uri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName + "/" + collection1Name + "/" + document1Id).build();
    document1UriRemappedAll = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDALL + "/" + dbName + "/" + collection1Name + "/" + document1Id).build();
    document1UriRemappedDb = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDDB + "/" + collection1Name + "/" + document1Id).build();
    document1UriRemappedCollection = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDREFCOLL1 + "/" + document1Id).build();
    document1UriRemappedDocument = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDDOC1).build();
    document2Uri = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath("/" + dbName + "/" + collection2Name + "/" + document2Id).build();
    document2UriRemappedAll = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDALL + "/" + dbName + "/" + collection1Name + "/" + document2Id).build();
    document2UriRemappedDb = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDDB + "/" + collection2Name + "/" + document2Id).build();
    document2UriRemappedCollection = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDREFCOLL2 + "/" + document2Id).build();
    document2UriRemappedDocument = new URIBuilder().setScheme(HTTP).setHost(HOST).setPort(conf.getHttpPort()).setPath(REMAPPEDDOC2).build();
  }
