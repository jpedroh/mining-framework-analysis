...
public class GetIndexesIT extends HttpClientAbstactIT {
  ...
  @Test public void testGetIndexes() throws Exception {
    testGetIndexes(indexesUri);
  }

  @Test public void testGetIndexesRemappedAll() throws Exception {
    testGetIndexes(indexesUriRemappedAll);
  }

  @Test public void testGetIndexesRemappedDb() throws Exception {
  ...
  @Before public void createTestData() throws Exception {
    com.mashape.unirest.http.HttpResponse resp = Unirest.put(url(DB)).basicAuth(ADMIN_ID, ADMIN_PWD).asString();
    ...
    resp = Unirest.put(url(DB, COLL, "_indexes", TEST_DB_PREFIX + "_idx_pos")).basicAuth(ADMIN_ID, ADMIN_PWD).header("content-type", "application/json").body("{\'keys\': {\'a\':1}}").asString();
    ...
    resp = Unirest.put(url(DB, COLL, "_indexes", TEST_DB_PREFIX + "_idx_neg")).basicAuth(ADMIN_ID, ADMIN_PWD).header("content-type", "application/json").body("{\'keys\':{\'a\':-1}}").asString();
    ...
    resp = Unirest.put(url(DB, COLL, "one")).basicAuth(ADMIN_ID, ADMIN_PWD).header("content-type", "application/json").body("{\'a\':1}").asString();
    Assert.assertEquals("create doc one", org.apache.http.HttpStatus.SC_CREATED, resp.getStatus());
    resp = Unirest.put(url(DB, COLL, "two")).basicAuth(ADMIN_ID, ADMIN_PWD).header("content-type", "application/json").body("{\'a\':2}").asString();
    Assert.assertEquals("create doc two", org.apache.http.HttpStatus.SC_CREATED, resp.getStatus());
  }

  @Test public void testGetHintStringFormat() throws Exception {
    com.mashape.unirest.http.HttpResponse resp = Unirest.get(url(DB, COLL)).queryString("hint", "a").queryString("sort", "{}").basicAuth(ADMIN_ID, ADMIN_PWD).asString();
    ...
    resp = Unirest.get(url(DB, COLL)).queryString("hint", "-a").queryString("sort", "{}").basicAuth(ADMIN_ID, ADMIN_PWD).asString();
    Assert.assertEquals("test get collection", org.apache.http.HttpStatus.SC_OK, resp.getStatus());
  ...
  @Test public void testGetHintObjectFormat() throws Exception {
    com.mashape.unirest.http.HttpResponse resp = Unirest.get(url(DB, COLL)).queryString("hint", "{\'a\':1}").queryString("sort", "{}").basicAuth(ADMIN_ID, ADMIN_PWD).asString();
    Assert.assertEquals("test get collection", org.apache.http.HttpStatus.SC_OK, resp.getStatus());
    JsonValue _rbody = Json.parse(resp.getBody().toString());
    Assert.assertTrue("response body is a document", _rbody != null && _rbody.isObject());
    JsonObject rbody = _rbody.asObject();
    ...
    Assert.assertTrue("doc prop a is a number", a.isNumber());
    Assert.assertTrue("doc prop a equals 1", a.asInt() == 1);
    resp = Unirest.get(url(DB, COLL)).queryString("hint", "{\'a\':-1}").queryString("sort", "{}").basicAuth(ADMIN_ID, ADMIN_PWD).asString();
    Assert.assertEquals("test get collection", org.apache.http.HttpStatus.SC_OK, resp.getStatus());
    _rbody = Json.parse(resp.getBody().toString());
    Assert.assertTrue("response body is a document", _rbody != null && _rbody.isObject());
    rbody = _rbody.asObject();
