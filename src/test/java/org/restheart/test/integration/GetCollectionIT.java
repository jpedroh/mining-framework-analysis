...
public class GetCollectionIT extends HttpClientAbstactIT {
  ...
  @Test public void testGetCollectionRemappedAll() throws Exception {
    testGetCollection(collection1UriRemappedAll);
  }

  @Test public void testGetCollectionRemappedDb() throws Exception {
    testGetCollection(collection1UriRemappedDb);
  }

  @Test public void testGetCollectionRemappedCollection() throws Exception {
  ...
  @Test public void testBinaryProperty() throws Exception {
    ...
    MongoCollection<Document> coll = MongoDBClientSingleton.getInstance().getClient().getDatabase(dbName).getCollection(collection1Name);
    ...
    com.mashape.unirest.http.HttpResponse<String> resp = Unirest.get(url).basicAuth(ADMIN_ID, ADMIN_PWD).asString();
