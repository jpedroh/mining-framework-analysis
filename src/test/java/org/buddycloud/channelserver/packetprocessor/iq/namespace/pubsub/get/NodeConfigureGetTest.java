...
public class NodeConfigureGetTest extends IQTestHandler {
  ...
  @Test public void testInexistentNodeAttributeReturnsErrorStanza() throws Exception {
  ...
  @Test public void testLocalNodeNoError() throws Exception {
    IQ request = readStanzaAsIq("/iq/pubsub/configure/request-with-node.stanza");
    Element configure = request.getChildElement().element("configure");
  ...
  @Test public void testLocalAccessModelGetsReportedAsAuthorizeToRemoveUsers() throws Exception {
  ...
  @SuppressWarnings(value = { "unchecked" }) private static String fieldValue(Element x, String var) {
