...
public class NodeDeleteTest extends IQTestHandler {
  ...
  @Test public void testPassingDeleteAsElementName() {
    Assert.assertTrue(nodeDelete.accept(element));
  }

  @Test public void testPassingNotDeleteAsElementName() {
    Element element = new BaseElement("not-delete");
    Assert.assertFalse(nodeDelete.accept(element));
  }

  @Test public void testStanzaWithNoNode() throws Exception {
  ...
  @Test public void testStanzaWithEmptyNode() throws Exception {
  ...
  @Test public void testNonLocalNode() throws Exception {
  ...
  @Test public void testNotRegisteredActor() throws Exception {
    IQ request = readStanzaAsIq("/iq/pubsub/delete/request-with-node.stanza");
    Element deleteEl = request.getChildElement().element("delete");
    String node = deleteEl.attributeValue("node");
  ...
  @Test public void testNotAffiliatedActor() throws Exception {
    IQ request = readStanzaAsIq("/iq/pubsub/delete/request-with-node.stanza");
    Element deleteEl = request.getChildElement().element("delete");
    String node = deleteEl.attributeValue("node");
    Mockito.when(channelManager.nodeExists(node)).thenReturn(true);
  ...
  @Test public void testActorIsNotOwner() throws Exception {
    IQ request = readStanzaAsIq("/iq/pubsub/delete/request-with-node.stanza");
    Element deleteEl = request.getChildElement().element("delete");
    String node = deleteEl.attributeValue("node");
    Mockito.when(channelManager.nodeExists(node)).thenReturn(true);
    Mockito.when(channelManager.getNodeMembership(node, jid)).thenReturn(new NodeMembershipImpl(node, jid, Subscriptions.subscribed, Affiliations.moderator, null));
    nodeDelete.process(deleteEl, jid, request, null);
    Packet response = queue.poll();
    PacketError error = response.getError();
    Assert.assertNotNull(error);
  ...
  @Test public void testBadFormattedNode() throws Exception {
  ...
  @Test public void testNodeFromUnknownDomain() throws Exception {
  ...
  @Test public void testSuccessfulDeleteNoSubscribers() throws Exception {
    IQ request = readStanzaAsIq("/iq/pubsub/delete/request-with-node.stanza");
    Element deleteEl = request.getChildElement().element("delete");
    String node = deleteEl.attributeValue("node");
    Mockito.when(channelManager.nodeExists(node)).thenReturn(true);
    Mockito.when(channelManager.getNodeMembership(node, jid)).thenReturn(new NodeMembershipImpl(node, jid, Subscriptions.subscribed, Affiliations.owner, null));
    nodeDelete.process(deleteEl, jid, request, null);
  ...
  @Test public void testSuccessfulDeleteWithSubscribers() throws Exception {
    IQ request = readStanzaAsIq("/iq/pubsub/delete/request-with-node.stanza");
    Element deleteEl = request.getChildElement().element("delete");
    String node = deleteEl.attributeValue("node");
    Mockito.when(channelManager.nodeExists(node)).thenReturn(true);
