...
public class SubscriptionEventTest extends IQTestHandler {
    ...
    @Test
    public void testNotProvidingSubscriptionChildNodeReturnsErrorStanza() throws Exception {

        IQ request =
                toIq(readStanzaAsString("/iq/pubsub/subscribe/authorizationPendingGrantReply.stanza").replaceFirst(
    ...
    public void testNotProvidingJidAttributeReturnsErrorStanza() throws Exception {
        IQ request =
                toIq(readStanzaAsString("/iq/pubsub/subscribe/authorizationPendingGrantReply.stanza").replaceFirst("jid='francisco@denmark.lit'", ""));
        event.process(element, jid, request, null);
        Packet response = queue.poll();
    ...
    public void userWithoutSubscriptionReturnsErrorStanza() throws Exception {
        ...
        when(dataStore.getNodeMembership(anyString(), any(JID.class))).thenReturn(
    ...
    @Test
    public void userWhoIsntOwnerOrModeratorCantUpdateSubscription() throws Exception {
        when(dataStore.getNodeMembership(anyString(), any(JID.class))).thenReturn(
    ...
    @Test
    public void subscribingUserMustHaveExistingSubscriptionToUpdate() throws Exception {
    ...
    @Test
    public void passingInvalidSubscriptionTypeSetsSubscriptionToNone() throws Exception {

        IQ request =
                toIq(readStanzaAsString("/iq/pubsub/subscribe/authorizationPendingGrantReply.stanza").replaceFirst("subscription='subscribed'",
    ...
    @Test
    public void passingValidSubscriptionSendsOutExpectedNotifications() throws Exception {
