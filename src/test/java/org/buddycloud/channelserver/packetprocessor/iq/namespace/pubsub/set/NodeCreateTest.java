...
public class NodeCreateTest extends IQTestHandler {
  ...
  @Test public void testPassingCreateAsElementNameReturnsTrue() {
    Element element = new BaseElement("create");
    Assert.assertTrue(nodeCreate.accept(element));
  }

  @Test public void testPassingNotCreateAsElementNameReturnsFalse() {
  ...
  @Test public void testRequestingAlreadyExistingNodeReturnsErrorStanza() throws Exception {
  ...
  @Test public void testUnauthenticatedUserCanNotCreateNode() throws Exception {
  ...
  @Test public void testInvalidlyFormattedNodeReturnsError() throws Exception {
  ...
  @Test public void testNewNodeMustBeOnADomainSupportedByCurrentServer() throws Exception {
  ...
  @Test public void testchannelManagerFailureReturnsInternalServerErrorResponse() throws Exception {
    Mockito.doThrow(new NodeStoreException()).when(channelManager).createNode(Mockito.any(JID.class), Mockito.anyString(), Mockito.anyMapOf(String.class, String.class));
    nodeCreate.setChannelManager(channelManager);
  ...
  @Test public void testValidCreateNodeRequestReturnsConfirmationStanza() throws Exception {
    Helper helper = Mockito.mock(Helper.class);
    Mockito.doReturn(true).when(helper).isValid();
    nodeCreate.setConfigurationHelper(helper);
    nodeCreate.process(element, jid, request, null);
  ...
  @Test public void testCreateNodeWithConfigurationResultsInExpectedConfig() throws Exception {
  ...
  @Test public void testFailingNodeConfigurationReturnsErrorStanza() throws Exception {
    String channelTitle = "test-channel-name";
    HashMap<String, String> configurationProperties = new HashMap<String, String>();
    configurationProperties.put(NodeTitle.FIELD_NAME, channelTitle);
    Helper helper = Mockito.mock(Helper.class);
