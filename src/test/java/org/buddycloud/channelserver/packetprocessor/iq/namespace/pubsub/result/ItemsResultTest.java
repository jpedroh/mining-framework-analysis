...
public class ItemsResultTest extends IQTestHandler {
    ...
    public void testNoItemsResultsInNoAdditionsToDatabase() throws Exception {
        ...
        result =
                toIq("<iq type=\"result\" id=\"items1\" " + "from=\"channels.shakespeare.lit\" " + "to=\"francisco@denmark.lit/barracks\">"
                        + "<pubsub xmlns=\"http://jabber.org/protocol/pubsub\">" + "<items node=\"/user/francisco@denmark.lit/posts\">"
                        + "</items></pubsub></iq>");
    ...
    public void testItemWithInvalidDateIsNotAddedToDatabase() throws Exception {
        ...
        result =
                toIq("<iq type=\"result\" id=\"items1\" " + "from=\"channels.shakespeare.lit\" " + "to=\"francisco@denmark.lit/barracks\">"
                        + "<pubsub xmlns=\"http://jabber.org/protocol/pubsub\">" + "<items node=\"/user/francisco@denmark.lit/posts\">"
                        + "<item id=\"3\">" + "<entry xmlns=\"" + Atom.NS + "\" xmlns:activity=\"http://activitystrea.ms/spec/1.0/\">"
                        + "<id>tag:channels.buddycloud.com,/user/koski@buddycloud.com/posts,3</id>" + "<updated>November 5, 1955</updated>" + "<author>"
                        + "<name>koski@buddycloud.com</name>" + "</author>" + "</entry>" + "</item>" + "</items></pubsub></iq>");
    ...
    @Test
    public void testSubscriptionsNodeAttemptsToPlaceCorrectDataIntoDatabase() throws Exception {
    ...
    @Test
    public void testWhenSubscribedNodeIsntInDatastoreItIsAdded() throws Exception {
        Mockito.when(channelManager.nodeExists(Mockito.anyString())).thenReturn(false);
