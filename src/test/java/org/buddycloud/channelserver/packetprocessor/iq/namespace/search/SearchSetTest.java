...
public class SearchSetTest extends IQTestHandler {
  ...
  @Test public void testOnlyAcceptsPacketsFromLocalUsers() throws Exception {
  ...
  @Test public void testReturnsErrorIfDataFormAbsent() throws Exception {
    search.process(request);
    Packet response = queue.poll();
    PacketError error = response.getError();
    Assert.assertNotNull(error);
  ...
  @Test public void testReturnsErrorIfNamespaceIncorrect() throws Exception {
  ...
  @Test public void testReturnsErrorIfTypeIncorrect() throws Exception {
    Element query = request.getElement().element("query");
    Element x = query.addElement("x");
  ...
  @Test public void testReturnsErrorIfFieldFormTypeIsIncorrect() throws Exception {
    Element query = request.getElement().element("query");
    Element x = query.addElement("x");
    x.addAttribute("xmlns", DataForm.NAMESPACE);
  ...
  @Test public void testReturnsErrorIfFieldFormTypeValueIsIncorrect() throws Exception {
    Element query = request.getElement().element("query");
    Element x = query.addElement("x");
    x.addAttribute("xmlns", DataForm.NAMESPACE);
    x.addAttribute("type", "submit");
  ...
  @Test public void testReturnsErrorIfTooFewFields() throws Exception {
    Element query = request.getElement().element("query");
    Element x = query.addElement("x");
    x.addAttribute("xmlns", DataForm.NAMESPACE);
    x.addAttribute("type", "submit");
  ...
  @Test public void testReturnsErrorIfContentValueIncorrect() throws Exception {
    Element query = request.getElement().element("query");
    Element x = query.addElement("x");
    x.addAttribute("xmlns", DataForm.NAMESPACE);
    x.addAttribute("type", "submit");
  ...
  @Test public void testReturnsErrorIfAuthorValueIncorrect() throws Exception {
    Element query = request.getElement().element("query");
    Element x = query.addElement("x");
    x.addAttribute("xmlns", DataForm.NAMESPACE);
    x.addAttribute("type", "submit");
  ...
  @Test public void testReturnsErrorIfAuthorValueInvalid() throws Exception {
    Element query = request.getElement().element("query");
    Element x = query.addElement("x");
    x.addAttribute("xmlns", DataForm.NAMESPACE);
    x.addAttribute("type", "submit");
  ...
  @Test public void testReturnsErrorIfPageValueIncorrect() throws Exception {
    Element query = request.getElement().element("query");
    Element x = query.addElement("x");
    x.addAttribute("xmlns", DataForm.NAMESPACE);
    x.addAttribute("type", "submit");
  ...
  @Test public void testReturnsErrorIfRppValueIncorrect() throws Exception {
    Element query = request.getElement().element("query");
    Element x = query.addElement("x");
    x.addAttribute("xmlns", DataForm.NAMESPACE);
    x.addAttribute("type", "submit");
  ...
  @Test public void testReturnsErrorOnChannelManagerException() throws Exception {
    Mockito.when(channelManager.performSearch(Mockito.any(JID.class), Mockito.any(List.class), Mockito.any(JID.class), Mockito.anyInt(), Mockito.anyInt())).thenThrow(new NodeStoreException());
  ...
  @Test public void testNoResultsReturnsExpectedStanza() throws Exception {
    ...
    Mockito.doReturn(itemList).when(channelManager).performSearch(Mockito.any(JID.class), Mockito.any(List.class), Mockito.any(JID.class), Mockito.anyInt(), Mockito.anyInt());
    search.process(setStanza);
    Packet response = queue.poll();
  ...
  @Test public void testReturnsDataInExpectedFormat() throws Exception {
  ...
  @Test public void testBadlyFormedSourceDataIsIgnored() throws Exception {
