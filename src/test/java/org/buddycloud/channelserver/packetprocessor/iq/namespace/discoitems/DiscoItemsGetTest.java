...
public class DiscoItemsGetTest extends IQTestHandler {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void testReturnsListOfNodes() throws Exception {
  ...
  @Test public void testOnlyReturnsLocalNodes() throws Exception {
  ...
  @Test public void testReturnsErrorIfDataStoreException() throws Exception {
  ...
  @Test public void testReturnsErrorIfNodeProvided() throws Exception {
