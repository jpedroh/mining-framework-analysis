...
public class MessageArchiveManagementTest extends IQTestHandler {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(channelManager.getAffiliationChanges(Mockito.any(JID.class), Mockito.any(Date.class), Mockito.any(Date.class))).thenReturn(
                noAffiliations);
        Mockito.when(channelManager.getSubscriptionChanges(Mockito.any(JID.class), Mockito.any(Date.class), Mockito.any(Date.class))).thenReturn(
                noSubscriptions);
    ...
    @Test
    public void testInvalidStartTimestampResultsInBadRequestStanza() throws Exception {
    ...
    @Test
    public void testInvalidEndTimestampResultsInBadRequestStanza() throws Exception {
    ...
    @Test
    public void testOutcastChangeReportedAsExpectedToOwnerModerator() throws Exception {
    ...
    public void testTwoNewItemsReportAsExpected() throws Exception {
        ...
        Mockito.when(channelManager.getNewNodeItemsForUser(Mockito.any(JID.class), Mockito.any(Date.class), Mockito.any(Date.class))).thenReturn(
