...
public class SubscriptionProcessorTest extends IQTestHandler {
  ...
  @Before public void setUp() throws Exception {
    ...
    members.add(new NodeMembershipImpl("/user/romeo@shakespeare.lit/posts", jid, Subscriptions.subscribed, Affiliations.member, null));
  ...
  @Test(expected = IllegalArgumentException.class) public void testInvalidSubscriptionValueThrowsException() throws Exception {
  ...
  @Test public void testMissingSubscriptionElementDoesNotCauseError() throws Exception {
  ...
  @Test public void setsInvitedByIfProvided() throws Exception {
