...
public class RetractItemProcessorTest extends IQTestHandler {
  ...
  @Before public void setUp() throws Exception {
    ...
    subscribers.add(new NodeMembershipImpl("/user/romeo@shakespeare.lit/posts", jid, Subscriptions.subscribed, Affiliations.member, null));
  ...
  @Test public void testWhenRetractElementPassedItemIsDeleted() throws Exception {
    retractItemProcessor.process(message);
