...
public class ConfigurationProcessorTest extends IQTestHandler {
  ...
  @Before public void setUp() throws Exception {
    ...
    configurationElement.addAttribute("node", "/user/juliet@denmark.lit/posts");
  ...
  @Test public void testRemoteNodeIsCreatedIfNotInDataStore() throws Exception {
  ...
  @Test public void testExpectedDetailsAreSavedToTheDataStore() throws Exception {
