...
@SuppressWarnings(value = { "serial" }) public abstract class JDBCNodeStoreAbstract {
  ...
  protected static final String TEST_SERVER1_NODE1_ITEM4_GLOBAL_ID = new GlobalItemIDImpl(new JID("server1"), TEST_SERVER1_NODE1_ID, TEST_SERVER1_NODE1_ITEM4_ID).toString();
