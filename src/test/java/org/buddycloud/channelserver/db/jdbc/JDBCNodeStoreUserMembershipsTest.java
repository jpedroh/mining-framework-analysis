...
public class JDBCNodeStoreUserMembershipsTest extends JDBCNodeStoreAbstract {
  ...
  @Test public void getUserMemberships() throws Exception {
    ...
    HashSet<NodeMembership> expected = new HashSet<NodeMembership>() {
      {
        ...
        add(new NodeMembershipImpl(TEST_SERVER1_NODE2_ID, TEST_SERVER1_USER1_JID, Subscriptions.subscribed, Affiliations.publisher, null, new Date()));
      }
    };
  ...
  @Test public void getUserMembershipsUsesBareJID() throws Exception {
    dbTester.loadData("node_1");
    dbTester.loadData("node_2");
  ...
  @Test public void canGetUserMembershipWhereTheresOnlySubscription() throws Exception {
    dbTester.loadData("node_1");
...
=======
  @Test public void canGetUserMembershipWhereTheresOnlyAffiliation() throws Exception {
    dbTester.loadData("node_1");
    store.deleteUserSubscriptions(TEST_SERVER1_USER1_JID);
    ResultSet<NodeMembership> result = store.getUserMemberships(TEST_SERVER1_USER1_JID);
    NodeMembership expected = new NodeMembershipImpl(TEST_SERVER1_NODE1_ID, TEST_SERVER1_USER1_JID, Subscriptions.none, Affiliations.owner, null);
    assertEquals("An unexpected user membership was returned", expected, result.get(0));
  }
>>>>>>> /usr/src/app/output/buddycloud/buddycloud-server-java/c0daab08a4d3af4ab7be092cd53a9fba7d51eaf5/src/test/java/org/buddycloud/channelserver/db/jdbc/JDBCNodeStoreUserMembershipsTest.java/right.java
