...
/**
 * TODO(work) Additional work required:
 * 
...
public class AtomEntryTest extends TestHandler {
    ...
    public void globalInReplyToIdIsMadeALocalId() throws Exception {
        ...
        Assert.assertEquals("tag:channels.shakespeare.lit,/users/romeo@shakespeare.lit/posts,fc362eb42085f017ed9ccd9c4004b095", replyEntry
                .element("entry").element("in-reply-to").attributeValue("ref"));
    ...
    public void canNotRateARating() throws Exception {
        ...
        String testPayload =
                "<entry xmlns=\"http://www.w3.org/2005/Atom\" " + "xmlns:review=\"http://activitystrea.ms/schema/1.0/review\">"
