...
public class JmxTransConfigurationXmlLoaderTest {
  @Test public void testParseConfiguration() throws Exception {
  ...
  @Test public void testParseConfiguration2() throws Exception {
  ...
  @Test public void testParseConfigurationMultipleAttributes() throws Exception {
  ...
  @Test public void testNoAttributesSpecifiedGeneratesWildcardQuery() throws Exception {
  ...
  @Test(expected = IllegalArgumentException.class) public void testParseConfigurationAttributeAndAttributesMutuallyExclusive() throws Exception {
    new JmxTransConfigurationXmlLoader("classpath:jmxtrans-attribute-attributes-exclusive-test.xml").loadConfiguration();
  }

  @Test public void testParseConfigReload() throws Exception {
  ...
  @Test public void testExternalPropertiesSourceIsUsed() throws Exception {
    PropertiesLoader propertiesLoader = new PropertiesLoader() {
      @Override public Map<String, String> loadProperties() {
  ...
  @Test public void testErrorOnLoadingExternalPropertiesDoesNotPropagate() throws Exception {
    PropertiesLoader propertiesLoader = new PropertiesLoader() {
      @Override public Map<String, String> loadProperties() {
  ...
  @Test public void collectIntervalOverrideTest() throws Exception {
