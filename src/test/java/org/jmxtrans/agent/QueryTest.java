...
public class QueryTest {
  ...
  @Test public void basic_attribute_return_simple_result() throws Exception {
  ...
  @Test public void basic_attribute_null_result_alias_returns_simple_result() throws Exception {
  ...
  @Test public void expression_language_substitutes_object_name_key() throws Exception {
  ...
  @Test public void expression_language_substitutes_function() throws Exception {
  ...
  @Test public void indexed_list_attribute_return_simple_result() throws Exception {
  ...
  @Test public void non_indexed_list_attribute_return_simple_result() throws Exception {
  ...
  @Test public void indexed_int_array_attribute_return_simple_result() throws Exception {
  ...
  @Test public void indexed_integer_array_attribute_return_simple_result() throws Exception {
  ...
  @Test public void query_wildcard_objectname_domain_returns_objetname_and_attribute() throws Exception {
  ...
  @Test public void query_wildcard_objectname_property_returns_objetname_and_attribute() throws Exception {
  ...
  @Test public void query_wildcard_objectname_domain_returns_meabn_with_resultalias() throws Exception {
  ...
  @Test public void query_wildcard_objectname_property_returns_mbean_with_resultalias() throws Exception {
  ...
  @Test public void query_objectname_with_null_attribute_returns_all_attributes() throws Exception {
  ...
  @Test public void attribute_list_returns_specified_attributes() throws Exception {
    Query query = new Query("test:type=Mock,name=mock", Arrays.asList("CollectionUsageThreshold", "Name"), null, null, null, "altTest.#attribute#", resultNameStrategy, null);
    query.collectAndExport(mbeanServer, mockOutputWriter);
  ...
  @Test public void attribute_list_attribute_does_not_return_not_specified_attribute() throws Exception {
    Query query = new Query("test:type=Mock,name=mock", Arrays.asList("CollectionUsageThreshold", "Name"), null, null, null, "altTest.#attribute#", resultNameStrategy, null);
    query.collectAndExport(mbeanServer, mockOutputWriter);
  ...
  public static class MockOutputWriter extends AbstractOutputWriter {
    ...
    @Override public void writeQueryResult(@Nonnull String name, @Nullable String type, @Nullable Object value) throws IOException {
    ...
    @Override public void writeInvocationResult(@Nonnull String invocationName, @Nullable Object value) throws IOException {
