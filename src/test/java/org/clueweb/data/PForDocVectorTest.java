...
public class PForDocVectorTest {
  ...
  @Test public void testPFor1() throws Exception {
    int len = 256;
  ...
  @Test public void testPFor2() throws Exception {
    int len = 23;
    FastPFOR p4 = new FastPFOR();
    int[] doc = new int[len];
    for (int i = 0; i < len; i++) {
  ...
  @Test public void testPFor3() throws Exception {
    int len = 129;
    FastPFOR p4 = new FastPFOR();
    int[] doc = new int[len];
    for (int i = 0; i < len; i++) {
  ...
  @Test public void testPFor4() throws Exception {
    int len = 128 * 4 + 1;
    FastPFOR p4 = new FastPFOR();
    int[] doc = new int[len];
    for (int i = 0; i < len; i++) {
  ...
  @Test public void testSerializeRandom() throws Exception {
  ...
  @Test public void testSerializeRandomArrayTooLong() throws Exception {
  ...
  @Test public void testSerializeEmpty1() throws Exception {
    IntArrayWritable ints = new IntArrayWritable();
  ...
  @Test public void testSerializeEmpty2() throws Exception {
    IntArrayWritable ints = new IntArrayWritable();
