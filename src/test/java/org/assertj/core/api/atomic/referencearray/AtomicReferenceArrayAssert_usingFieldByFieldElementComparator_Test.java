...
public class AtomicReferenceArrayAssert_usingFieldByFieldElementComparator_Test extends AtomicReferenceArrayAssertBaseTest {
  ...
  @Test public void successful_containsExactlyInAnyOrderElementsOf_assertion_using_field_by_field_element_comparator_with_heterogeneous_array() {
    Snake snake = new Snake(15);
    AtomicReferenceArray<Animal> array1 = new AtomicReferenceArray<>(array(new Bird("White"), snake, snake));
    assertThat(array1).usingFieldByFieldElementComparator().containsExactlyInAnyOrderElementsOf(newArrayList(new Snake(15), new Bird("White"), new Snake(15)));
  }
  ...
  @Test public void should_be_able_to_use_a_comparator_for_element_fields_with_specified_type_when_using_field_by_field_element_comparator() {
    ...
    assertThat(atomicArrayOf(actual)).usingComparatorForElementFieldsWithType(ALWAY_EQUALS_STRING, String.class).usingFieldByFieldElementComparator().contains(other);
  }
