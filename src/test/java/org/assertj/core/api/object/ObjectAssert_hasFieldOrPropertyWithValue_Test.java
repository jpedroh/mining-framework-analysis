...
public class ObjectAssert_hasFieldOrPropertyWithValue_Test extends ObjectAssertBaseTest {
  ...
  @Test public void shoud_pass_if_both_are_null() {
    Jedi jedi = new Jedi(null, "Blue");
    assertThat(jedi).hasFieldOrPropertyWithValue(FIELD_NAME, null);
  }

  @Test public void shoud_fail_if_given_field_or_property_does_not_exist() {
  ...
  @Test public void shoud_fail_if_field_or_property_value_is_not_equal_to_the_expected_value() {
  ...
  @Test public void shoud_fail_if_field_or_property_value_is_not_null_when_expected_value_is() {
  ...
  @Test public void shoud_fail_when_property_or_field_value_is_null_and_expected_value_is_not() {
