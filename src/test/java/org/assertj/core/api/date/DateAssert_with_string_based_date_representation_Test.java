...
public class DateAssert_with_string_based_date_representation_Test extends DateAssertBaseTest {
  ...
  @Test public void should_fail_if_given_date_string_representation_cant_be_parsed_with_default_date_formats() {
    ...
    thrown.expectAssertionError("Failed to parse 2003/04/26 with any of these date formats:%n" + "   [yyyy-MM-dd\'T\'HH:mm:ss.SSS,%n" + "    yyyy-MM-dd HH:mm:ss.SSS,%n" + "    yyyy-MM-dd\'T\'HH:mm:ss,%n" + "    yyyy-MM-dd]");
  ...
  @Test public void should_fail_if_given_date_string_representation_cant_be_parsed_with_any_custom_date_formats() {
    thrown.expectAssertionError("Failed to parse 2003 04 26 with any of these date formats:%n" + "   [yyyy/MM/dd\'T\'HH:mm:ss,%n" + "    yyyy/MM/dd,%n" + "    yyyy-MM-dd\'T\'HH:mm:ss.SSS,%n" + "    yyyy-MM-dd HH:mm:ss.SSS,%n" + "    yyyy-MM-dd\'T\'HH:mm:ss,%n" + "    yyyy-MM-dd]");
    final Date date = DateUtil.parse("2003-04-26");
  ...
  @Test public void use_custom_date_formats_set_from_Assertions_entry_point() {
    ...
    try {
      ...
      assertThat(e).hasMessage(format("Failed to parse 2003/04/26 with any of these date formats:%n" + "   [yyyy/MM/dd\'T\'HH:mm:ss,%n" + "    yyyy-MM-dd\'T\'HH:mm:ss.SSS,%n" + "    yyyy-MM-dd HH:mm:ss.SSS,%n" + "    yyyy-MM-dd\'T\'HH:mm:ss,%n" + "    yyyy-MM-dd]"));
    }
  ...
  @Test public void use_custom_date_formats_first_then_defaults_to_parse_a_date() {
    ...
    try {
      ...
      assertThat(e).hasMessage(format("Failed to parse 2003/04/26 with any of these date formats:%n" + "   [yyyy-MM-dd\'T\'HH:mm:ss.SSS,%n" + "    yyyy-MM-dd HH:mm:ss.SSS,%n" + "    yyyy-MM-dd\'T\'HH:mm:ss,%n" + "    yyyy-MM-dd]"));
    }
    registerCustomDateFormat("yyyy/MM/dd");
    assertThat(date).isEqualTo("2003/04/26");
    assertThat(date).isEqualTo("2003-04-26");
    ...
    try {
      ...
      assertThat(e).hasMessage(format("Failed to parse 2003 04 26 with any of these date formats:%n" + "   [yyyy/MM/dd,%n" + "    yyyy-MM-dd\'T\'HH:mm:ss.SSS,%n" + "    yyyy-MM-dd HH:mm:ss.SSS,%n" + "    yyyy-MM-dd\'T\'HH:mm:ss,%n" + "    yyyy-MM-dd]"));
    }
    registerCustomDateFormat("yyyy MM dd");
    assertThat(date).isEqualTo("2003 04 26");
  }
