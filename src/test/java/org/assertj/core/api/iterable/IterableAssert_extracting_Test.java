...
public class IterableAssert_extracting_Test {
  ...
  @Test public void should_allow_assertions_on_null_property_values_extracted_from_given_iterable() {
  ...
  @Test public void should_allow_extracting_single_values_using_extractor() {
    assertThat(employees).extracting(firstName).containsOnly("Yoda", "Luke");
    assertThat(employees).extracting(age).containsOnly(26, 800);
  }

  @Test public void should_allow_extracting_multiple_values_using_extractor() throws Exception {
...
=======
  @Test public void sohuld_allow_extracting_multiple_values_using_extractor() {
    assertThat(employees).extracting(new Extractor<Employee, Tuple>() {
      @Override public Tuple extract(Employee input) {
        return new Tuple(input.getName().getFirst(), input.getAge(), input.id);
      }
...
>>>>>>> /usr/src/app/output/joel-costigliola/assertj-core/327f0860049931d7af945af02e57dab608ae0aed/src/test/java/org/assertj/core/api/iterable/IterableAssert_extracting_Test.java/right.java


  @Test public void should_allow_extracting_by_toString_method() {
    assertThat(employees).extracting(Extractors.toStringMethod()).containsOnly("Employee[id=1, name=Name[first=\'Yoda\', last=\'null\'], age=800]", "Employee[id=2, name=Name[first=\'Luke\', last=\'Skywalker\'], age=26]");
  }

  @Test public void should_allow_assertions_by_using_function_extracted_from_given_iterable() throws Exception {
  ...
  @Test public void should_throw_error_if_function_fails() throws Exception {
