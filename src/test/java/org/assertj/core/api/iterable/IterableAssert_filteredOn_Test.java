...
public class IterableAssert_filteredOn_Test extends IterableAssert_filtered_baseTest {
  ...
  @Test public void should_fail_if_given_expected_value_is_null() {
    thrown.expectWithMessageContaining(IllegalArgumentException.class, "The expected value should not be null.%n" + "If you were trying to filter on a null value, please use filteredOnNull(String propertyOrFieldName) instead");
