...
public class AutoCloseableSoftAssertionsTest {
  ...
  @Test public void should_be_able_to_catch_exceptions_thrown_by_all_proxied_methods() {
    try (AutoCloseableSoftAssertions softly = new AutoCloseableSoftAssertions()) {
      ...
      softly.assertThat(new ByteArrayInputStream(new byte[] { (byte) 65 })).hasContentEqualTo(new ByteArrayInputStream(new byte[] { (byte) 66 }));
      ...
      softly.assertThat(ZonedDateTime.of(2015, 1, 1, 23, 59, 59, 0, UTC)).isEqualTo(ZonedDateTime.of(2015, 1, 1, 23, 59, 0, 0, UTC));
      softly.assertThat(
<<<<<<< /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableSoftAssertionsTest.java/left.java
      OptionalInt
=======
      LocalTime
>>>>>>> /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableSoftAssertionsTest.java/right.java
      .of(12, 0)).isEqualTo(
<<<<<<< /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableSoftAssertionsTest.java/left.java
      1
=======
...
=======
      12
>>>>>>> /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableSoftAssertionsTest.java/right.java
      , 0, 0, 0, ZoneOffset.UTC)).isEqualTo(
<<<<<<< /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableSoftAssertionsTest.java/left.java
      1L
=======
...
>>>>>>> /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableSoftAssertionsTest.java/right.java
      ...
      assertThat(errors.get(20)).isEqualTo("\nInputStreams do not have equal content:" + System.getProperty("line.separator") + "line:<1>, expected:<B> but was:<A>");
      ...
      assertThat(errors.get(43)).isEqualTo(
<<<<<<< /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableSoftAssertionsTest.java/left.java
      "expected:<[1]> but was:<[OptionalInt[0]]>"
=======
      "expected:<1[3]:00> but was:<1[2]:00>"
>>>>>>> /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableSoftAssertionsTest.java/right.java
      );
      assertThat(errors.get(44)).isEqualTo(
<<<<<<< /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableSoftAssertionsTest.java/left.java
      "expected:<[1.0]> but was:<[OptionalDouble[0.0]]>"
=======
      "expected:<1[3]:00Z> but was:<1[2]:00Z>"
>>>>>>> /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableSoftAssertionsTest.java/right.java
      );
