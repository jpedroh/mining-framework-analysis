...
public class AutoCloseableBDDSoftAssertionsTest {
  ...
  @Test public void should_be_able_to_catch_exceptions_thrown_by_all_proxied_methods() {
    try (AutoCloseableBDDSoftAssertions softly = new AutoCloseableBDDSoftAssertions()) {
      ...
      softly.then(new ByteArrayInputStream(new byte[] { (byte) 65 })).hasContentEqualTo(new ByteArrayInputStream(new byte[] { (byte) 66 }));
      ...
      softly.then(
<<<<<<< /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableBDDSoftAssertionsTest.java/left.java
      Optional
=======
      LocalTime
>>>>>>> /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableBDDSoftAssertionsTest.java/right.java
      .of(
<<<<<<< /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableBDDSoftAssertionsTest.java/left.java
      "not empty"
=======
...
=======
      OffsetTime
>>>>>>> /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableBDDSoftAssertionsTest.java/right.java
      .of(12, 0, 0, 0, ZoneOffset.UTC)).isEqualTo(
<<<<<<< /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableBDDSoftAssertionsTest.java/left.java
      1
=======
...
<<<<<<< /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableBDDSoftAssertionsTest.java/left.java
      "expected:<[\"empty\"]> but was:<[Optional[not empty]]>"
=======
