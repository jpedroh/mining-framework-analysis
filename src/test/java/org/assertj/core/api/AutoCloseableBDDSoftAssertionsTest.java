...
||||||| /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableBDDSoftAssertionsTest.java/base.java
=======
...
||||||| /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableBDDSoftAssertionsTest.java/base.java
=======
    assertThat(errors.get(38)).isEqualTo("expected:<1[3]:00> but was:<1[2]:00>");
    assertThat(errors.get(39)).isEqualTo("expected:<1[3]:00Z> but was:<1[2]:00Z>");
>>>>>>> /usr/src/app/output/joel-costigliola/assertj-core/df54907840a677e22be2141132df77fa1f64dc18/src/test/java/org/assertj/core/api/AutoCloseableBDDSoftAssertionsTest.java/right.java
	  return;
  }
