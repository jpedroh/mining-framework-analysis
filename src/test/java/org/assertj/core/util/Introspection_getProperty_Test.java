...
public class Introspection_getProperty_Test {
  ...
  @Test public void should_raise_an_error_because_of_missing_getter() {
    assertThatExceptionThrownBy(() -> getProperty("salary", judy)).isInstanceOf(IntrospectionError.class).hasMessage("No getter for property \'salary\' in org.assertj.core.util.Employee");
  }

  @Test public void should_raise_an_error_because_of_non_public_getter() {
    assertThatExceptionThrownBy(() -> getProperty("firstJob", judy)).isInstanceOf(IntrospectionError.class).hasMessage("No public getter for property \'firstJob\' in org.assertj.core.util.Employee");
    assertThatExceptionThrownBy(() -> getProperty("company", judy)).isInstanceOf(IntrospectionError.class).hasMessage("No public getter for property \'company\' in org.assertj.core.util.Employee");
  }
}