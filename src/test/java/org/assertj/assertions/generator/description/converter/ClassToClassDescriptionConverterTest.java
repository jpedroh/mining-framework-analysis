...
@RunWith(value = Theories.class) public class ClassToClassDescriptionConverterTest implements NestedClassesTest, BeanWithExceptionsTest {
  ...
  @Test public void should_build_player_class_description() throws Exception {
  ...
  @Test public void should_build_movie_class_description() throws Exception {
  ...
  @Theory public void should_build_nestedclass_description(NestedClass nestedClass) throws Exception {
  ...
  @Theory public void should_build_getter_with_exception_description(GetterWithException getter) throws Exception {
  ...
  @Test public void should_build_class_description_for_iterable_of_primitive_type_array() throws Exception {
    class Type {
      List<int[]> scores;

      @SuppressWarnings(value = { "unused" }) public List<int[]> getScores() {
        return scores;
      }
    }
  ...
  @Test public void should_build_class_description_for_array_of_primitive_type_array() throws Exception {
    class Type {
      int[][] scores;

      @SuppressWarnings(value = { "unused" }) public int[][] getScores() {
        return scores;
      }
    }
    ClassDescription classDescription = converter.convertToClassDescription(Type.class);
  ...
  @Test public void should_build_class_description_for_enum_type() throws Exception {
  ...
  @Test public void should_build_class_description_for_iterable_of_Object_type() throws Exception {
    class Type {
      List<Player[]> players;

      @SuppressWarnings(value = { "unused" }) public List<Player[]> getPlayers() {
        return players;
      }
    }
    ClassDescription classDescription = converter.convertToClassDescription(Type.class);
  ...
  @Test public void should_build_fellowshipOfTheRing_class_description() throws Exception {
  ...
  @Test public void should_handle_toString() {
    ClassDescription classDescription = converter.convertToClassDescription(FellowshipOfTheRing.class);
    assertThat(classDescription.toString()).contains(FellowshipOfTheRing.class.getSimpleName(), "java.util.Map", "java.util.List");
  }

  @Test public void should_build_class_description_for_class_with_public_fields() throws Exception {
    ...
    assertThat(classDescription.getFieldsDescriptions()).extracting("name").containsOnly("name", "oldNames", "westCoast", "rank", "players", "points", "victoryRatio");
