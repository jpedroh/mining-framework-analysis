...
@RunWith(value = Theories.class) public class AssertionGeneratorTest implements NestedClassesTest, BeanWithExceptionsTest {
  ...
  @Test public void should_generate_assertion_for_player_class() throws Exception {
    assertionGenerator.generateCustomAssertionFor(converter.convertToClassDescription(Player.class));
    assertThat(fileGeneratedFor(Player.class)).hasContentEqualTo(new File("src/test/resources/PlayerAssert.expected.txt").getAbsoluteFile());
  }

  @Test public void should_generate_assertion_for_class_with_public_fields() throws Exception {
  ...
  @Test public void should_generate_flat_assertion_for_movie_class() throws Exception {
    ...
    assertThat(fileGeneratedFor(Movie.class)).hasContentEqualTo(new File("src/test/resources/MovieAssert.flat.expected" + ".txt").getAbsoluteFile());
    assertThat(abstractFileGeneratedFor(Movie.class)).doesNotExist();
  }

  @Test public void should_generate_hierarchical_assertion_for_movie_class() throws Exception {
    assertionGenerator.generateHierarchicalCustomAssertionFor(converter.convertToClassDescription(Movie.class), allClasses);
    assertThat(fileGeneratedFor(Movie.class)).hasContentEqualTo(new File("src/test/resources/MovieAssert.expected" + ".txt").getAbsoluteFile());
    assertThat(abstractFileGeneratedFor(Movie.class)).hasContentEqualTo(new File("src/test/resources/AbstractMovieAssert.expected" + ".txt").getAbsoluteFile());
  }

  @Test public void should_generate_hierarchical_assertion_for_artwork_class() throws Exception {
    assertionGenerator.generateHierarchicalCustomAssertionFor(converter.convertToClassDescription(ArtWork.class), allClasses);
    assertThat(fileGeneratedFor(ArtWork.class)).hasContentEqualTo(new File("src/test/resources/ArtWorkAssert.expected" + ".txt").getAbsoluteFile());
    assertThat(abstractFileGeneratedFor(ArtWork.class)).hasContentEqualTo(new File("src/test/resources/AbstractArtWorkAssert.expected" + ".txt").getAbsoluteFile());
  }

  @Theory public void should_generate_assertion_for_nested_class(NestedClass nestedClass) throws Exception {
  ...
  @Theory public void should_generate_assertion_for_property_with_exception(Class<?> beanClass) throws Exception {
  ...
  @Test public void should_generate_assertion_for_classes_in_package() throws Exception {
  ...
  @Test public void should_generate_assertion_for_classes_in_package_using_provided_class_loader() throws Exception {
  ...
  @Test public void should_check_template_type() throws Exception {
    BaseAssertionGenerator assertionGenerator = new BaseAssertionGenerator();
