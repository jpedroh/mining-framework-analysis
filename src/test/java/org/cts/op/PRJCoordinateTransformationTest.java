...
public class PRJCoordinateTransformationTest extends BaseCoordinateTransformTest {
  @Test public void testLAMBEtoLAMB93PRJ() throws Exception {
    double[] srcPoint = new double[] { 282331, 2273699.7, 0 };
    double[] expectedPoint = new double[] { 332602.961893497, 6709788.26447893, 0 };
    String srcprj = "PROJCS[\"NTF_Lambert_II_\u00e9tendu\",\tGEOGCS[\"GCS_NTF\", DATUM[\"D_NTF\"," + "SPHEROID[\"Clarke_1866_IGN\",6378249.2,293.46602]], PRIMEM[\"Greenwich\",0.0]," + "UNIT[\"Degree\",0.0174532925199433]], PROJECTION[\"Lambert_Conformal_Conic\"]," + "PARAMETER[\"False_Easting\",600000.0], PARAMETER[\"False_Northing\",2200000.0]," + "PARAMETER[\"Central_Meridian\",2.3372291667], PARAMETER[\"Standard_Parallel_1\",45.8989188889]," + "PARAMETER[\"Standard_Parallel_2\",47.6960144444], PARAMETER[\"Scale_Factor\",1.0]," + "PARAMETER[\"Latitude_Of_Origin\",46.8], UNIT[\"Meter\",1.0]]";
    CoordinateReferenceSystem srcCRS = cRSFactory.createFromPrj(srcprj);
    String outprj = "PROJCS[\"RGF93_Lambert_93\", GEOGCS[\"GCS_RGF_1993\", DATUM[\"D_RGF_1993\", " + "SPHEROID[\"GRS_1980\",6378137.0,298.257222101]], PRIMEM[\"Greenwich\",0.0]," + "UNIT[\"Degree\",0.0174532925199433]], PROJECTION[\"Lambert_Conformal_Conic\"]," + "PARAMETER[\"False_Easting\",700000.0]," + "PARAMETER[\"False_Northing\",6600000.0]," + "PARAMETER[\"Central_Meridian\",3.0]," + "PARAMETER[\"Standard_Parallel_1\",44.0]," + "PARAMETER[\"Standard_Parallel_2\",49.0]," + "PARAMETER[\"Latitude_Of_Origin\",46.5]," + "UNIT[\"Meter\",1.0]]";
  ...
  @Test public void testWGS84toLAMB93PRJ() throws Exception {
    double[] srcPoint = new double[] { 2.114551393, 50.345609791, 0 };
    double[] expectedPoint = new double[] { 636890.74032145, 7027895.26344997, 0 };
    String srcprj = "GEOGCS[\"WGS 84\",DATUM[\"WGS_1984\"," + "SPHEROID[\"WGS 84\",6378137,298.257223563,AUTHORITY[\"EPSG\",\"7030\"]]," + "AUTHORITY[\"EPSG\",\"6326\"]]," + "PRIMEM[\"Greenwich\",0,AUTHORITY[\"EPSG\",\"8901\"]]," + "UNIT[\"degree\",0.01745329251994328,AUTHORITY[\"EPSG\",\"9122\"]]," + "AUTHORITY[\"EPSG\",\"4326\"]]";
    CoordinateReferenceSystem srcCRS = cRSFactory.createFromPrj(srcprj);
    String outprj = "PROJCS[\"RGF93_Lambert_93\", GEOGCS[\"GCS_RGF_1993\", DATUM[\"D_RGF_1993\", " + "SPHEROID[\"GRS_1980\",6378137.0,298.257222101]], PRIMEM[\"Greenwich\",0.0]," + "UNIT[\"Degree\",0.0174532925199433]], PROJECTION[\"Lambert_Conformal_Conic\"]," + "PARAMETER[\"False_Easting\",700000.0]," + "PARAMETER[\"False_Northing\",6600000.0]," + "PARAMETER[\"Central_Meridian\",3.0]," + "PARAMETER[\"Standard_Parallel_1\",44.0]," + "PARAMETER[\"Standard_Parallel_2\",49.0]," + "PARAMETER[\"Latitude_Of_Origin\",46.5]," + "UNIT[\"Meter\",1.0]]";
    CoordinateReferenceSystem outCRS = cRSFactory.createFromPrj(outprj);
    double[] result = transform((GeodeticCRS) srcCRS, (GeodeticCRS) outCRS, srcPoint);
  ...
  @Test public void testUnitsInPRJ() throws Exception {
  ...
  @Test public void testCH1903toLV95PRJ() throws Exception {
