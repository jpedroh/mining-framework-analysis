...
public class EPSGTransform extends BaseCoordinateTransformTest {
  @Test public void testFrenchEPSGCodeFrom4326To27582() throws Exception {
    String csNameSrc = "EPSG:4326";
    double[] pointSource = new double[] { 2.114551393, 50.345609791, 0 };
    String csNameDest = "EPSG:27582";
  ...
  @Test public void testFrenchEPSGCodeFrom27582To4326() throws Exception {
    String csNameSrc = "EPSG:27582";
    double[] pointSource = new double[] { 584173.736, 2594514.828, 0 };
    String csNameDest = "EPSG:4326";
