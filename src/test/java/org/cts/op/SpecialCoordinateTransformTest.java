...
public class SpecialCoordinateTransformTest extends BaseCoordinateTransformTest {
  @Test public void testPolyconic() throws Exception {
    ...
    CoordinateReferenceSystem outputCRS = new ProjectedCRS(new Identifier(ProjectedCRS.class, "SIRGAS 2000 / Brazil Polyconic"), (GeodeticDatum) inputCRS.getDatum(), CRSHelper.getProjection("poly", Ellipsoid.GRS80, crsParameters));
  ...
  @Test public void testCylindricalEqualArea() throws Exception {
  ...
  @Test public void testMillerCylindrical() throws Exception {
    Map<String, Measure> map = new HashMap<String, Measure>();
