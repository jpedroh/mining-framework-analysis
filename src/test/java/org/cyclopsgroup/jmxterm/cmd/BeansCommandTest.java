...
public class BeansCommandTest {
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void testExecuteWithAllBeans() throws Exception {
    context.checking(new Expectations() {
      {
        oneOf(conn).getDomains();
        will(returnValue(new String[] { "a", "b" }));
        atLeast(1).of(conn).queryNames(new ObjectName("a:*"), null);
        will(returnValue(new HashSet<ObjectName>(Arrays.asList(new ObjectName("a:type=1"), new ObjectName("a:type=2")))));
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void testExecuteWithDomainInSession() throws Exception {
    context.checking(new Expectations() {
      {
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void testExecuteWithDomainOption() throws Exception {
    command.setDomain("b");
    context.checking(new Expectations() {
      {
        allowing(conn).getDomains();
  ...
  /**
     ...
     * @throws Exception
     */
  @Test public void testExecuteWithNullDomain() throws Exception {
    command.setDomain("*");
    context.checking(new Expectations() {
      {
        oneOf(conn).getDomains();
