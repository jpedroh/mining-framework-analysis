...
public class InfoCommandTest {
   ...
   * @throws Exception
   */
  @Test public void testExecuteWithShowingAttributes() throws Exception {
   ...
   * @throws Exception
   */
  @Test public void testExecuteWithShowingOperations() throws Exception {
    command.setBean("a:type=x");
    command.setType("o");
    final MBeanServerConnection con = context.mock(MBeanServerConnection.class);
    final MBeanInfo beanInfo = context.mock(MBeanInfo.class);
    ...
    command.execute();
    context.assertIsSatisfied();
    assertEquals("# operations" + System.lineSeparator() + "  %0   - int x(java.lang.String a)", output.toString().trim());
  }
   ...
   * @throws Exception
   */
  @Test public void testExecuteWithShowingSpecificOperation() throws Exception {
    command.setBean("a:type=x");
   ...
   * @throws Exception
   */
  @Test public void testExecuteWithShowingNonExistingOperation() throws Exception {
    command.setBean("a:type=x");
   ...
   * @throws Exception
   */
  @Test public void testExecuteWithShowingMultipleMatchingOperations() throws Exception {
    command.setBean("a:type=x");
    command.setOperation("x");
    final MBeanServerConnection con = context.mock(MBeanServerConnection.class);
    final MBeanInfo beanInfo = context.mock(MBeanInfo.class);
    ...
    result.append("             parameters:").append(System.lineSeparator());
    result.append("                 + a                    : My param description").append(System.lineSeparator()).append(System.lineSeparator());
