...
public class HTTPUtilitiesTest extends TestCase {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "deprecation" }) public void testDeprecatedSetRememberToken() throws AuthenticationException {
  ...
  public void testSetRememberToken() throws Exception {
    ...
    @SuppressWarnings(value = { "unchecked" }) List<Cookie> cookies = (List<Cookie>) field.get(response);
    Cookie cookie = null;
  ...
  public void testGetSessionAttribute() throws Exception {
    ...
    try {
      @SuppressWarnings(value = { "unused" }) Integer test1 = ESAPI.httpUtilities().getSessionAttribute(session, "testAttribute");
      fail();
  ...
  public void testGetRequestAttribute() throws Exception {
    ...
    try {
      @SuppressWarnings(value = { "unused" }) Integer test1 = ESAPI.httpUtilities().getRequestAttribute(request, "testAttribute");
      fail();
    } catch (ClassCastException cce) {
    }
