...
public class BuilderTest extends TestBase {
  @Test public void testLongNameTruncation() throws Exception {
  ...
  @Test public void testFiles() throws Exception {
    ...
    builder.setPlatform(NOARCH, LINUX);
    builder.setType(BINARY);
    builder.addFile("/etc", new File("src/test/resources/prein.sh"), 0755, 0755, new Directive(Directive.RPMFILE_CONFIG | Directive.RPMFILE_DOC | Directive.RPMFILE_NOREPLACE), "jabberwocky", "vorpal");
    builder.build(new File(getTargetDir()));
    ...
    assertArrayEquals(new int[] { Directive.RPMFILE_CONFIG | Directive.RPMFILE_DOC | Directive.RPMFILE_NOREPLACE }, (int[]) format.getHeader().getEntry(Header.HeaderTag.FILEFLAGS).getValues());
  }

  @Test public void testBuildWithoutSignature() throws Exception {
    Builder builder = new Builder();
  ...
  @Test public void testBuildWithSignature() throws Exception {
    Builder builder = new Builder();
  ...
  @Test public void testBuildWithEpoch() throws Exception {
    Builder builder = new Builder();
  ...
  @Test public void testBuildMetapackage() throws Exception {
    Builder builder = new Builder();
