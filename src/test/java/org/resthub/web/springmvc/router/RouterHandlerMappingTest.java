...
@RunWith(value = SpringJUnit4ClassRunner.class) @ContextConfiguration(locations = { "classpath*:routerTestContext.xml" }) public class RouterHandlerMappingTest {
  private String LOCATION = "/routerTestContext.xml";

  private XmlWebApplicationContext wac;

  @Inject @Named(value = "myTestController") private MyTestController testController;
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void additionalRouteFile() throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void wildcardRouteFiles() throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testHeadMethod() throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testDefaultParamAction() throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testParamAction() throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testGETHTTPAction() throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testPUTHTTPAction() throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testPOSTHTTPAction() throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testDELETEHTTPAction() throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testOverrideHeaderHTTPAction() throws Exception {
    MockHttpServletRequest request = new MockHttpServletRequest("GET", "/http");
    request.addHeader("host", sampleHost);
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testOverrideQueryStringHTTPAction() throws Exception {
    MockHttpServletRequest request = new MockHttpServletRequest("GET", "/http");
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testregexNumberAction() throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testregexStringAction() throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void testhostAction() throws Exception {
