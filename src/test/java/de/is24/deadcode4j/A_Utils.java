...
public final class A_Utils {
  @Test public void returnsDefaultValue() {
  ...
  @Test public void returnsMappedValue() {
  ...
  @Test public void addsSetToMapIfNoMappedSetExists() {
  ...
  @Test public void preservesExistingSetIfMappedSetExists() {
    final String key = "foo";
    Map<String, Set<Integer>> map = newHashMap();
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void callsEachFunction() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void stopsAfterResultIsPresent() {
    Object expectedReturnValue = new Object();
    Function<Object, Optional<Object>> first = mock(Function.class, "firstFunction");
