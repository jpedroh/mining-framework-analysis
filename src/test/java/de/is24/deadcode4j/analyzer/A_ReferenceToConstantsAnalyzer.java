...
public final class A_ReferenceToConstantsAnalyzer extends AnAnalyzer {
  ...
  @Before public void setUp() throws Exception {
    ...
    codeContext.addAnalyzedClass(FQ_CONSTANTS);
    codeContext.addAnalyzedClass(FQ_CONSTANTS + ".More");
    dependers.clear();
    dependees.clear();
  }

  @After public void assertNoOtherDependenciesExist() {
  ...
  @Test public void recognizesDependencyToConstantInExpression() {
  ...
  @Test public void recognizesDependencyToConstantInField() {
  ...
  @Test public void recognizesDependencyToConstantInMethod() {
  ...
  @Test public void recognizesDependencyToFullyQualifiedConstantInExpression() {
  ...
  @Test public void recognizesDependencyToFullyQualifiedConstantInField() {
  ...
  @Test public void recognizesDependencyToFullyQualifiedConstantInMethod() {
  ...
  @Test public void recognizesDependencyToConstantViaStaticImportInExpression() {
  ...
  @Test public void recognizesDependencyToConstantViaStaticImportInField() {
  ...
  @Test public void recognizesDependencyToConstantViaStaticImportInMethod() {
  ...
  @Test public void recognizesDependencyToConstantViaStaticImportInSwitch() {
  ...
  @Test public void recognizesDependencyToConstantViaAsteriskStaticImportInField() {
    analyzeFile("../../src/test/java/de/is24/deadcode4j/analyzer/constants/ClassUsingConstantViaAsteriskStaticImportInField.java");
    triggerFinishAnalysisEvent();
  }

  @Test public void recognizesReferenceToConstantOfOtherPackageViaStaticImportIsOverwrittenByLocalVariable() {
  ...
  @Test public void recognizesReferenceToConstantOfOtherPackageViaStaticImportIsOverwrittenByLocalVariableInSuperiorBlock() {
  ...
  @Test public void recognizesReferenceToConstantOfOtherPackageViaStaticImportIsOverwrittenByLocalVariableInStaticInitializer() {
  ...
  @Test public void recognizesReferenceToConstantOfOtherPackageViaStaticImportExistsAlthoughInnerClassDefinesInstanceFieldWithSameName() {
  ...
  @Test public void recognizesReferenceToConstantOfOtherPackageViaStaticImportIsOverwrittenByInstanceFieldBeingDeclaredAfterItIsReferenced() {
  ...
  @Test public void recognizesReferenceToConstantOfOtherPackageViaStaticImportIsOverwrittenByStaticField() {
  ...
  @Test public void recognizesReferenceToConstantOfOtherPackageIsOverwrittenByLocalVariable() {
  ...
  @Test public void recognizesReferenceToConstantOfOtherPackageIsOverwrittenByInstanceField() {
  ...
  @Test public void recognizesReferenceToConstantOfOtherPackageIsOverwrittenByStaticVariable() {
  ...
  @Test public void recognizesDependencyToInnerClassInsteadOfPackageClass() {
    ...
    triggerFinishAnalysisEvent();
    assertDependencyExists("de.is24.deadcode4j.analyzer.constants.ClassWithInnerClassNamedLikePotentialTarget", "de.is24.deadcode4j.analyzer.constants.ClassWithInnerClassNamedLikePotentialTarget$Constants");
    ...
    assertDependencyExists("de.is24.deadcode4j.analyzer.constants.ClassWithInnerClassNamedLikePotentialTarget$InnerClass", "de.is24.deadcode4j.analyzer.constants.ClassWithInnerClassNamedLikePotentialTarget$Constants");
  }

  @Test public void recognizesDependencyToConstantOfOtherPackageInExpression() {
  ...
  @Test public void recognizesDependencyToConstantOfOtherPackageInField() {
  ...
  @Test public void recognizesDependencyToConstantOfOtherPackageInMethod() {
  ...
  @Test public void recognizesDependencyToFullyQualifiedConstantOfOtherPackageInExpression() {
  ...
  @Test public void recognizesDependencyToFullyQualifiedConstantOfOtherPackageInField() {
  ...
  @Test public void recognizesDependencyToFullyQualifiedConstantOfOtherPackageInMethod() {
  ...
  @Test public void recognizesDependencyToConstantOfOtherPackageViaAsteriskImportInExpression() {
  ...
  @Test public void recognizesDependencyToConstantOfOtherPackageViaAsteriskImportInField() {
  ...
  @Test public void recognizesDependencyToConstantOfOtherPackageViaAsteriskImportInMethod() {
  ...
  @Test public void recognizesDependencyToConstantOfOtherPackageViaStaticImportInExpression() {
  ...
  @Test public void recognizesDependencyToConstantOfOtherPackageViaStaticImportInField() {
  ...
  @Test public void recognizesDependencyToConstantOfOtherPackageViaStaticImportInMethod() {
  ...
  @Test public void recognizesDependencyToConstantOfOtherPackageViaAsteriskStaticImportInField() {
  ...
  @Test public void recognizesEnumsDependencyToConstantInField() {
  ...
  @Test public void recognizesDependencyToConstantForInnerClassesInField() {
    analyzeFile("../../src/test/java/de/is24/deadcode4j/analyzer/constants/ClassUsingInnerClassOfConstantInField.java");
    triggerFinishAnalysisEvent();
    assertDependencyExists("de.is24.deadcode4j.analyzer.constants.ClassUsingInnerClassOfConstantInField", FQ_CONSTANTS + ".More");
  }

  @Test public void recognizesDependencyToConstantForInnerClassViaStaticImportInField() {
    ...
    triggerFinishAnalysisEvent();
    assertDependencyExists("de.is24.deadcode4j.analyzer.constants.ClassUsingInnerClassOfConstantViaStaticImportInField", FQ_CONSTANTS + ".More");
  }

  @Test public void recognizesDependencyToConstantForInnerClassViaAsteriskStaticImportInField() {
  }

  @Test public void recognizesDependencyToConstantOfOtherPackageForInnerClassesInField() {
    ...
    triggerFinishAnalysisEvent();
    assertDependencyExists("de.is24.deadcode4j.analyzer.constants.subpackage.ClassUsingInnerClassOfConstantOfOtherPackageInField", FQ_CONSTANTS + ".More");
  }

  @Ignore(value = "not sure if Constants.A_STRING.intern() is actually inlined by the compiler") @Test public void recognizesDependencyToConstantOfOtherPackageForInnerClassesInMethodCall() {
  ...
  @Test public void recognizesAnnotationsDependencyToConstantAsDefault() {
    ...
    assertDependencyExists("de.is24.deadcode4j.analyzer.constants.AnnotationUsingConstantAsDefault", "java.lang.annotation.ElementType");
  }

  @Test public void ignoresReferencesToStaticMethods() {
