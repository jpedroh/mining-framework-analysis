...
public class ExpressionBuilderTest {
  @Test public void testCustomFunction1() throws Exception {
    CustomFunction custom = new CustomFunction("timespi") {
      @Override public double applyFunction(double... values) {
  ...
  @Test public void testCustomFunction2() throws Exception {
  ...
  @Test public void testCustomFunction3() throws Exception {
  ...
  @Test public void testCustomFunction4() throws Exception {
    CustomFunction custom1 = new CustomFunction("foo") {
      @Override public double applyFunction(double... values) {
        return values[0] * Math.E;
      }
  ...
  @Test public void testCustomFunction5() throws Exception {
    CustomFunction custom1 = new CustomFunction("foo") {
      @Override public double applyFunction(double... values) {
        return values[0] * Math.E;
      }
  ...
  @Test public void testCustomFunction6() throws Exception {
    CustomFunction custom1 = new CustomFunction("foo") {
      @Override public double applyFunction(double... values) {
        return values[0] * Math.E;
      }
  ...
  @Test public void testCustomFunction7() throws Exception {
  ...
  @Test public void testCustomFunction10() throws Exception {
  ...
  @Test public void testCustomFunction11() throws Exception {
  ...
  @Test public void testCustomFunction12() throws Exception {
  ...
  @Test public void testCustomFunction13() throws Exception {
  ...
  @Test public void testCustomFunction14() throws Exception {
  ...
  @Test public void testCustomFunction15() throws Exception {
  ...
  @Test public void testCustomFunction16() throws Exception {
  ...
  @Test public void testCustomFunction17() throws Exception {
    CustomFunction custom1 = new CustomFunction("timesPi") {
      @Override public double applyFunction(double... values) {
        return values[0] * Math.PI;
      }
  ...
  @Test public void testCustomFunction18() throws Exception {
  ...
  @Test public void testCustomFunction19() throws Exception {
  ...
  @Test public void testCustomFunction20() throws Exception {
  ...
  @Test public void testCustomOperators1() throws Exception {
    CustomOperator factorial = new CustomOperator("!", true, 6, 1) {
      @Override protected double applyOperation(double[] values) {
        double tmp = 1d;
        int steps = 1;
  ...
  @Test public void testCustomOperators2() throws Exception {
    CustomOperator factorial = new CustomOperator("!", true, 6, 1) {
      @Override protected double applyOperation(double[] values) {
        double tmp = 1d;
        int steps = 1;
  ...
  @Test public void testCustomOperators3() throws Exception {
  ...
  @Test public void testCustomOperators4() throws Exception {
  ...
  @Test(expected = UnparsableExpressionException.class) public void testInvalidOperator1() throws Exception {
  ...
  @Test(expected = InvalidCustomFunctionException.class) public void testInvalidCustomFunction1() throws Exception {
    CustomFunction func = new CustomFunction("1gd") {
      @Override public double applyFunction(double... args) {
        return 0;
      }
    };
  }

  @Test(expected = InvalidCustomFunctionException.class) public void testInvalidCustomFunction2() throws Exception {
    CustomFunction func = new CustomFunction("+1gd") {
      @Override public double applyFunction(double... args) {
        return 0;
      }
  ...
  @Test(expected = UnparsableExpressionException.class) public void testSameName() throws Exception {
  ...
  @Test(expected = UnparsableExpressionException.class) public void testInvalidFunction() throws Exception {
    double varY = 4.22d;
    Calculable calc = new ExpressionBuilder("3*invalid_function(y)").withVariable("y", varY).build();
    calc.calculate();
  }

  @Test(expected = UnparsableExpressionException.class) public void testMissingVar() throws Exception {
    double varY = 4.22d;
    Calculable calc = new ExpressionBuilder("3*y*z").withVariable("y", varY).build();
    calc.calculate();
  }

  @Test @SuppressWarnings(value = { "unchecked" }) public void testOperatorPrecedence() throws Exception {
  ...
  @Test(expected = UnparsableExpressionException.class) public void testVarname1() throws Exception {
    String expr = "12.23 * foo.bar";
    Calculable calc = new ExpressionBuilder(expr).withVariable("foo.bar", 1d).build();
    assertTrue(12.23 == calc.calculate());
  }

  public void testVarname2() throws Exception {
    String expr = "12.23 * foo.bar";
    Calculable calc = new ExpressionBuilder(expr).withVariable("_foo", 1d).build();
    assertTrue(12.23 == calc.calculate());
  }
  ...
  @Test public void testExpression35() throws Exception {
    String expr = "-3^2";
  ...
  @Test public void testExpression36() throws Exception {
    String expr = "-3^-2";
    double expected = -Math.pow(3, -2);
    System.setProperty(ExpressionBuilder.PROPERTY_UNARY_HIGH_PRECEDENCE, "false");
    Calculable calc = new ExpressionBuilder(expr).build();
  ...
  @Test public void testExpression37() throws Exception {
    String expr = "-3^-2^-4";
  ...
  @Test public void testExpression38() throws Exception {
    String expr = "-3^(-2*3)";
  ...
  @Test public void testExpression39() throws Exception {
    String expr = "3^(2*-3)";
    double expected = Math.pow(3, -6);
    System.setProperty(ExpressionBuilder.PROPERTY_UNARY_HIGH_PRECEDENCE, "false");
    Calculable calc = new ExpressionBuilder(expr).build();
  ...
  @Test(expected = UnparsableExpressionException.class) public void testExpression45() throws Exception {
    String expr = "6.02214E2E3";
    new ExpressionBuilder(expr).build();
  }

  @Test(expected = UnparsableExpressionException.class) public void testExpression46() throws Exception {
    String expr = "6.02214e2E3";
    new ExpressionBuilder(expr).build();
  }

  @Test(expected = UnparsableExpressionException.class) public void testExpression47() throws Exception {
  ...
  @Test public void testCharacterPositionInException1() throws Exception {
    String expr;
    expr = "2 + sn(4)";
    try {
      Calculable calc = new ExpressionBuilder(expr).build();
  ...
  @Test(expected = UnparsableExpressionException.class) public void testFailUnknownFunction1() throws Exception {
    String expr;
    expr = "lig(1)";
    Calculable calc = new ExpressionBuilder(expr).build();
    calc.calculate();
  ...
  @Test(expected = UnparsableExpressionException.class) public void testFailUnknownFunction2() throws Exception {
    String expr;
    expr = "galength(1)";
    new ExpressionBuilder(expr).build().calculate();
  }

  @Test(expected = UnparsableExpressionException.class) public void testFailUnknownFunction3() throws Exception {
    String expr;
    expr = "f(cos) = cos(cos)";
    new ExpressionBuilder(expr).build().calculate();
  }
  ...
  @Test public void testGetExpression() throws Exception {
    String expr;
    expr = "2 + 4 - cbrt(2^3)";
  ...
  @Test(expected = UnparsableExpressionException.class) public void testPostfixInvalidVariableName() throws Exception {
    String expr;
    double expected;
    double x = 4.5334332d;
    double log = Math.PI;
  ...
  @Test public void testBench1() throws Exception {
    ...
    Calculable calc = new ExpressionBuilder(expr).withVariableNames("x", "y").build();
    @SuppressWarnings(value = { "unused" }) double val;
