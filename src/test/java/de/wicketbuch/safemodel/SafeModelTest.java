...
public class SafeModelTest {
  ...
  @Test public void simplePropertyModel() throws Exception {
  ...
  @Test public void multiStepPropertyModel() throws Exception {
  ...
  @Test public void customBeanPropertyModel() throws Exception {
    final Top top = new Top();
    top.setMid(new Middle());
  ...
  @Test public void nullLeafModel() throws Exception {
    final Top top = new Top();
  ...
  @Test public void nullInTreeModel() throws Exception {
    final Top top = new Top();
    final IModel<Bottom> model = model(from(top).getMid().getBot());
    assertNull(model.getObject());
  }

  @Test public void listAsLeaf() throws Exception {
    final Top top = new Top();
    final Middle mid = new Middle();
    top.getMids().add(mid);
  ...
  @Test public void listInPath() throws Exception {
    final Top top = new Top();
    final Middle mid = new Middle();
    top.getMids().add(mid);
  ...
  @Test public void mapAsLeaf() throws Exception {
    final Top top = new Top();
    ...
    assertEquals(bot2, top.getBottomMap().get("bot1"));
  }

  @Test public void mapInPath() throws Exception {
    final Top top = new Top();
    final Bottom bot1 = new Bottom();
    top.getBottomMap().put("bot1", bot1);
    bot1.setValue(42);
  ...
  @Test public void loadFromService() throws Exception {
  ...
  @Test public void modelAsTarget() throws Exception {
    final Top top = new Top();
    final Middle mid = new Middle();
    top.setMid(mid);
    final IModel<Top> rootModel = new AbstractReadOnlyModel<SafeModelTest.Top>() {
      @Override public Top getObject() {
        return top;
      }
    };
  ...
  @Test public void listModelAsTarget() throws Exception {
    final Top top = new Top();
    final Middle mid = new Middle();
    top.setMid(mid);
    ...
    final IModel<List<Top>> rootModel = new AbstractReadOnlyModel<List<Top>>() {
      @Override public List<Top> getObject() {
        return list;
      }
    };
  ...
  @Test public void nestedServiceModel() throws Exception {
    final MidService service = new MidServiceImpl();
    final IModel<Integer> model = model(from(model(fromService(service).loadMid(42))).getBot().getValue());
    assertEquals(Integer.valueOf(42), model.getObject());
  }

  @Test public void cgProxiedService() throws Exception {
  ...
  @Test public void javaProxiedService() throws Exception {
    final Middle expected = new Middle();
    MidService mockedService = (MidService) Proxy.newProxyInstance(MidService.class.getClassLoader(), new Class<?>[] { Serializable.class, MidService.class }, new InvocationHandler() {
  ...
  @Test public void nonreflectableModel() throws Exception {
