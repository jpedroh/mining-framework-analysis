<<<<<<< /usr/src/app/output/okleine/ncoap/0fe28d174e89355a76eb698dd4f13327180400a3/src/test/java/de/uniluebeck/itm/spitfire/nCoap/communication/ObserveOptionCancellationTest.java/left.java
 ...
 */
public class ObserveOptionCancellationTest {
    ...
    public static void init() throws Exception {
        ...
        observableDummyWebService.addPreparedResponses(6, notification);
...
//        testServer.addResponse(6, notification);
        ...
        */
        //first registration
  /*1*/ testReceiver.writeMessage(reg1Request, new InetSocketAddress("localhost", COAP_SERVER_PORT));
        //wait for first response
  /*2*/ Thread.sleep(150);
        //send GET for same resource without Observe Option
  /*3*/ testReceiver.writeMessage(cancelGETrequest, new InetSocketAddress("localhost", COAP_SERVER_PORT));
...
//        testServer.notifyCoapObservers();
        ...
        //second registration
  /*5*/ testReceiver.writeMessage(reg2Request, new InetSocketAddress("localhost", COAP_SERVER_PORT));
        //wait for first response
  /*6*/ Thread.sleep(150);
...
//        testServer.notifyCoapObservers();
  ...
  /*8*/ testReceiver.writeMessage(cancelRSTmsg, new InetSocketAddress("localhost", COAP_SERVER_PORT));
        Thread.sleep(150);
        //if cancellation was successful, nothing should happen here
        observableDummyWebService.setResourceStatus(true);
//        testServer.notifyCoapObservers();
...
||||||| /usr/src/app/output/okleine/ncoap/0fe28d174e89355a76eb698dd4f13327180400a3/src/test/java/de/uniluebeck/itm/spitfire/nCoap/communication/ObserveOptionCancellationTest.java/base.java
package de.uniluebeck.itm.spitfire.nCoap.communication;
...
//        //create registration requests
//        String requestPath = "/testpath";
//        URI targetUri = new URI("coap://localhost:" + CoapServerApplication.DEFAULT_COAP_SERVER_PORT + requestPath);
//        reg1Request = new CoapRequest(MsgType.CON, Code.GET, targetUri);
//        reg1Request.getHeader().setMsgID(1111);
//        reg1Request.setToken(new byte[]{0x12, 0x23, 0x34});
//        reg1Request.setObserveOptionRequest();
...
//        */
//        //first registration
//  /*1*/ testReceiver.writeMessage(reg1Request, new InetSocketAddress("localhost", DEFAULT_COAP_SERVER_PORT));
//        //wait for first response
//  /*2*/ Thread.sleep(150);
//        //send GET for same resource without Observe Option
//  /*3*/ testReceiver.writeMessage(cancelGETrequest, new InetSocketAddress("localhost", DEFAULT_COAP_SERVER_PORT));
//        //wait for Simple ACK response (without Observe Option)
//  /*4*/ Thread.sleep(150);
//        //if cancellation was successful, nothing should happen here
//
...
//
//        //second registration
//  /*5*/ testReceiver.writeMessage(reg2Request, new InetSocketAddress("localhost", DEFAULT_COAP_SERVER_PORT));
//        //wait for first response
//  /*6*/ Thread.sleep(150);
//        //get second CON response
//        observableDummyWebService.setResourceStatus(true);
...
//        CoapMessage lastReceivedMessage = receivedMessages.get(receivedMessages.lastKey());
//        cancelRSTmsg.setMessageID(lastReceivedMessage.getMessageID());
//  /*8*/ testReceiver.writeMessage(cancelRSTmsg, new InetSocketAddress("localhost", DEFAULT_COAP_SERVER_PORT));
//        Thread.sleep(150);
//        //if cancellation was successful, nothing should happen here
//        observableDummyWebService.setResourceStatus(true);
////        testServer.notifyCoapObservers();
...
//
//}
>>>>>>> /usr/src/app/output/okleine/ncoap/0fe28d174e89355a76eb698dd4f13327180400a3/src/test/java/de/uniluebeck/itm/spitfire/nCoap/communication/ObserveOptionCancellationTest.java/right.java
