...
<<<<<<< /usr/src/app/output/okleine/ncoap/0fe28d174e89355a76eb698dd4f13327180400a3/src/test/java/de/uniluebeck/itm/spitfire/nCoap/communication/ObserveOptionNotificationTest.java/left.java
...
public class ObserveOptionNotificationTest {
  ...
  @Test public void testReceiverReceivedNotification2() {
    SortedMap<Long, CoapMessage> receivedMessages = testReceiver.getReceivedMessages();
  ...
  @Test public void testReceiverReceivedNotification3() {
    SortedMap<Long, CoapMessage> receivedMessages = testReceiver.getReceivedMessages();
    Iterator<Long> timeKeys = receivedMessages.keySet().iterator();
    timeKeys.next();
    timeKeys.next();
  ...
  @Test public void testObserveOptionIsSetProperly() {
    SortedMap<Long, CoapMessage> receivedMessages = testReceiver.getReceivedMessages();
    Iterator<Long> timeKeys = receivedMessages.keySet().iterator();
  ...
  @Test public void testObserveOptionExists() {
    SortedMap<Long, CoapMessage> receivedMessages = testReceiver.getReceivedMessages();
    Iterator<Long> timeKeys = receivedMessages.keySet().iterator();
    CoapMessage receivedMessage1 = receivedMessages.get(timeKeys.next());
    CoapMessage receivedMessage2 = receivedMessages.get(timeKeys.next());
  ...
  @Test public void testAllNotificationsHaveTheSameToken() {
    SortedMap<Long, CoapMessage> receivedMessages = testReceiver.getReceivedMessages();
    Iterator<Long> timeKeys = receivedMessages.keySet().iterator();
    CoapMessage receivedMessage1 = receivedMessages.get(timeKeys.next());
    CoapMessage receivedMessage2 = receivedMessages.get(timeKeys.next());
...
>>>>>>> /usr/src/app/output/okleine/ncoap/0fe28d174e89355a76eb698dd4f13327180400a3/src/test/java/de/uniluebeck/itm/spitfire/nCoap/communication/ObserveOptionNotificationTest.java/right.java
