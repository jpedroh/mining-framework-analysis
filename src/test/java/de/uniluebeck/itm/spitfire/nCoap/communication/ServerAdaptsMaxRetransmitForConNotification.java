...
||||||| /usr/src/app/output/okleine/ncoap/0fe28d174e89355a76eb698dd4f13327180400a3/src/test/java/de/uniluebeck/itm/spitfire/nCoap/communication/ServerAdaptsMaxRetransmitForConNotification.java/base.java
package de.uniluebeck.itm.spitfire.nCoap.communication;
...
//        testServicePath = "/testpath";
//        testResourceContent = "testpayload";
//        testReceiver.reset();
//
//        testReceiver.setReceiveEnabled(true);
//
...
////        emptyACK.getHeader().setMsgType(MsgType.ACK);
////        testReceiver.writeMessage(emptyACK, new InetSocketAddress("localhost",
////                CoapServerDatagramChannelFactory.DEFAULT_COAP_SERVER_PORT));
////
