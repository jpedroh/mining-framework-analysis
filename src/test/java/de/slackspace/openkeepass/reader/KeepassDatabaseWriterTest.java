...
public class KeepassDatabaseWriterTest {
  ...
  @Test public void whenWritingDatabaseFileShouldBeAbleToReadItAlso() throws FileNotFoundException {
  ...
  @Test public void shouldCreateNewDatabaseFile() throws FileNotFoundException {
  ...
  @Test public void shouldBuildKeePassFileWithTreeStructure() throws FileNotFoundException {
    Group root = new GroupBuilder().addEntry(new EntryBuilder("First entry").build()).addGroup(new GroupBuilder("Banking").build()).addGroup(new GroupBuilder("Internet").addGroup(new GroupBuilder("Shopping").addEntry(new EntryBuilder("Second entry").build()).build()).build()).build();
  ...
  @Test public void shouldModifiyGroupInKeePassFile() throws FileNotFoundException {
  ...
  @Test public void shouldModifyMetadataAndRenameGeneralNodeThenWriteAndReadDatabase() throws FileNotFoundException {
  ...
  @Test public void shouldWriteDatabaseWithCustomIcon() throws FileNotFoundException {
