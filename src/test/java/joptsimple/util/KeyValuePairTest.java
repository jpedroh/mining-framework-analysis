...
public class KeyValuePairTest {
  @Test(expected = NullPointerException.class) public void nullArg() {
  ...
  @Test public void multipleEqualsSignsDoNotMatter() {
