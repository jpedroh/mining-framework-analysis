...
public class RepositoryTest extends EndpointTestCase {
  @Test public void testSave() throws HttpException {
  ...
  @Test public void testJsonProperty() throws HttpException {
  ...
  @Test public void testJsonArrayProperty() throws HttpException {
    SimpleObject object = new SimpleObject();
    object.setAString("xpto");
  ...
  @Test public void testJsonMapWithLongKeyAndObjectValue() throws HttpException {
    SimpleObject object = new SimpleObject();
  ...
  @Test(expected = NoResultException.class) public void testDelete() throws HttpException {
