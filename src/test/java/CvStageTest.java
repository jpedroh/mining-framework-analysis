...
public class CvStageTest {
  ...
  /**
     ...
     * </pre>
	 */
  @Test public void testPipelinePropertyOverrides() throws Exception {
    ...
    String propName = "propName";
    {
      ...
      overriddenParameter = stage.getPossiblePipelinePropertyOverride(originalParameter, pipeline, propName);
    ...
    }
    {
      ...
      overriddenParameter = stage.getPossiblePipelinePropertyOverride(originalParameter, pipeline, propName, Double.class, Integer.class, Long.class, Area.class, Length.class);
      assertEquals(originalParameter, overriddenParameter);
      pipeline.setProperty(propName, overridingParameter);
      overriddenParameter = stage.getPossiblePipelinePropertyOverride(originalParameter, pipeline, propName, Double.class, Integer.class, Long.class, Area.class, Length.class);
      assertEquals(overridingParameter, overriddenParameter);
    ...
    }
    {
      ...
      overriddenParameter = stage.getPossiblePipelinePropertyOverride(originalParameter, pipeline, propName, org.opencv.core.Point.class, org.openpnp.model.Point.class, Location.class);
      assertEquals(originalParameter, overriddenParameter);
      pipeline.setProperty(propName, overridingParameter);
      overriddenParameter = stage.getPossiblePipelinePropertyOverride(originalParameter, pipeline, propName, org.opencv.core.Point.class, org.openpnp.model.Point.class, Location.class);
      assertEquals(overridingParameter, overriddenParameter);
    ...
    }
    {
      ...
      pipeline.setProperty(propName, overridingParameter);
      overriddenParameter = stage.getPossiblePipelinePropertyOverride(originalParameter, pipeline, propName, org.opencv.core.Point.class, org.openpnp.model.Point.class, Location.class);
      assertEquals(new org.opencv.core.Point(camera.getWidth() / 2 + overridingParameter.getX(), camera.getHeight() / 2 - overridingParameter.getY()), overriddenParameter);
    }
    {
      CvPipeline pipeline = new CvPipeline();
      CvStage stage = new TestStage();
    ...
    }
    {
      ...
      pipeline.setProperty(propName, overridingParameter);
      overriddenParameter = stage.getPossiblePipelinePropertyOverride(originalParameter, pipeline, propName, org.opencv.core.Point.class, org.openpnp.model.Point.class, Location.class);
      assertEquals(new org.openpnp.model.Point(camera.getWidth() / 2 + overridingParameter.getX(), camera.getHeight() / 2 - overridingParameter.getY()), overriddenParameter);
    }
    {
      CvPipeline pipeline = new CvPipeline();
      CvStage stage = new TestStage();
