 ...
 * @author Matija Mazi
 */
@SuppressWarnings(value = { "Duplicates" }) public class RestInvocationHandlerTest {
  private static final Logger log = LoggerFactory.getLogger(RestInvocationHandlerTest.class);

  @Test public void testInvocationData() throws Exception {
  ...
  @Test public void testEmptyServicePath() throws Exception {
  ...
  @Test public void testHttpBasicAuthWithConfig() throws Exception {
  ...
  @Test public void testJsonBody() throws Exception {
  ...
  @Test public void testRootPathService() throws Exception {
  ...
  @Test public void testCheckedException() throws Exception {
    ...
    ExampleService proxy = RestProxyFactory.createProxy(ExampleService.class, testHandler);
    assertThat(catchThrowable(proxy::io)).isInstanceOf(IOException.class).hasMessage("A simulated I/O problem.");
  }

  @Test public void testJsonResponse() throws IOException {
    ClientConfig clientConfig = new ClientConfig();
    TestRestInvocationHandler testHandler = new TestRestInvocationHandler(ExampleService.class, clientConfig, ResourceUtils.getResourceAsString("/example-ticker.json"), 200);
    ExampleService proxy = RestProxyFactory.createProxy(ExampleService.class, testHandler);
  ...
  @Test public void testGenericJsonResponse() throws IOException {
    ClientConfig clientConfig = new ClientConfig();
    TestRestInvocationHandler testHandler = new TestRestInvocationHandler(ExampleService.class, clientConfig, ResourceUtils.getResourceAsString("/example-generic.json"), 200);
    ExampleService proxy = RestProxyFactory.createProxy(ExampleService.class, testHandler);
  ...
  @Test public void testGetTextPlain() throws Exception {
    ClientConfig clientConfig = new ClientConfig();
    ...
    @SuppressWarnings(value = { "deprecation" }) final Map<String, String> httpHeaders = testHandler.getInvocation().getAllHttpHeaders();
    assertThat(httpHeaders.get("Content-Type")).isEqualTo(null);
    assertThat(httpHeaders.get("Accept")).isEqualTo(MediaType.TEXT_PLAIN);
  }

  @Test public void testGetTextPlainError() throws Exception {
    ...
    ExampleService proxy = RestProxyFactory.createProxy(ExampleService.class, testHandler);
    assertThat(catchThrowable(proxy::getString)).isInstanceOf(MessageException.class).hasMessage("Error message.");
  }

  @Test public void testPutTextPlain() throws Exception {
  ...
  @Test public void testPatchTextPlain() throws Exception {
    TestRestInvocationHandler testHandler = new TestRestInvocationHandler(ExampleService.class, new ClientConfig(), "OK", 200);
    ExampleService proxy = RestProxyFactory.createProxy(ExampleService.class, testHandler);
  ...
  @Test public void testValueGenerator() {
    TestRestInvocationHandler testHandler = new TestRestInvocationHandler(ExampleService.class, new ClientConfig(), "OK", 200);
    ExampleService proxy = RestProxyFactory.createProxy(ExampleService.class, testHandler);
    proxy.getNonce(new ConstantValueFactory<>(1L));
  }

  @Test public void testSciNotUrl() throws Exception {
    TestRestInvocationHandler testHandler = new TestRestInvocationHandler(ExampleService.class, new ClientConfig(), "OK", 200);
    ExampleService proxy = RestProxyFactory.createProxy(ExampleService.class, testHandler);
  ...
  @Test public void testSciNotJson() throws Exception {
    TestRestInvocationHandler testHandler = new TestRestInvocationHandler(ExampleService.class, new ClientConfig(), "OK", 200);
    ExampleService proxy = RestProxyFactory.createProxy(ExampleService.class, testHandler);
    final String numberString = "0.00000043";
    final BigDecimal smallNumber = new BigDecimal(numberString);
  ...
  @Test public void testParseAsExceptionWhenReturnTypeParseFails() throws Exception {
  ...
  @Test public void testParseAsExceptionWhenHttpErrorAndNoExceptionDeclared() throws Exception {
    TestRestInvocationHandler testHandler = new TestRestInvocationHandler(ExampleService.class, new ClientConfig(), null, 500);
    ExampleService proxy = RestProxyFactory.createProxy(ExampleService.class, testHandler);
    assertThat(catchThrowable(() -> proxy.testIOExceptionDeclared(null))).isInstanceOf(HttpStatusIOException.class).hasMessage("HTTP status code was not OK: 500");
  }

  @Test public void testParseAsExceptionWhenReturnTypeParseFailsAndNoExceptionDeclared() throws Exception {
    ...
    ExampleService proxy = RestProxyFactory.createProxy(ExampleService.class, testHandler);
    assertThat(catchThrowable(proxy::testIOExceptionDeclared)).isInstanceOf(HttpStatusIOException.class).hasMessage(String.format("Response body could not be parsed as method return type %s: last and volume required", DummyTicker.class.toString()));
  }

  @Test public void testExceptionOnArrayMethod() throws Exception {
  ...
  @Test public void testGetMethodWithBodyFail() throws Exception {
  ...
  @Test public void testInterceptor() throws Exception {
    ...
    assertThat(catchThrowable(proxy::test500)).isInstanceOf(Http500Exception.class);
  }
  ...
  @Test public void testInvocationAwareException() throws Exception {
  ...
  @Test public void responseHeadersAwareException() throws Exception {
    ...
    assertThat(actualHeaders).isNotNull().containsEntry("X-my-header", Collections.singletonList("My value"));
  }

  @Test public void responseHeadersAwareException500() throws Exception {
    final Map<String, List<String>> mockHeaders = new HashMap<>();
    mockHeaders.put("X-my-header", Collections.singletonList("My value"));
    TestRestInvocationHandler testHandler = new TestRestInvocationHandler(ExampleService.class, new ClientConfig(), "{}", 500) {
      @Override protected HttpURLConnection invokeHttp(RestInvocation invocation) {
  ...
  @Test public void shouldUrlEncodePathParams() throws Exception {
  ...
  @Test public void shouldDigestUrlEncodedFormParams() throws Exception {
    TestRestInvocationHandler testHandler = new TestRestInvocationHandler(ExampleService.class, new ClientConfig(), "{}", 200);
    ExampleService proxy = RestProxyFactory.createProxy(ExampleService.class, testHandler);
  ...
  @Test public void shouldReceiveSequentialNonces() throws Exception {
    ...
    final SynchronizedValueFactory vf = new SynchronizedValueFactory() {
      ...
      @Override public Object createValue() {
        return seq++;
      }
    };
