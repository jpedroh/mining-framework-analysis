...
@RunWith(value = JUnitParamsRunner.class) public class ObjectStringificationTest {
  @Test public void stringifyString() throws Exception {
    assertThat(stringify("exampleName", 0)).isEqualTo("[0] exampleName");
  }

  @Test public void stringifyClassWithToStringAndOneParam() throws Exception {
    ClassWithToString obj = new ClassWithToString("exampleName");
    assertThat(stringify(obj, 0)).isEqualTo("[0] exampleName");
  }

  @Test public void stringifyClassWithToStringAndManyParams() throws Exception {
  ...
  @Test public void stringifyClassWithToStringInSuperclass() throws Exception {
    ClassWithToString obj = new ClassWithToString("exampleName");
  ...
  @Test public void stringifyArray() {
    Double[] nullArray = null;
    int[] primitiveArray = { 1, 2, 3 };
    String[] array = { "one", "two", null };
    Object[] mixed = $($(nullArray, "stringOne", primitiveArray, "stringTwo", array));
    assertThat(Utils.stringify(mixed)).isEqualTo("null, stringOne, [1, 2, 3], stringTwo, [one, two, null]");
  }

  @Test @Parameters public void shouldCreateParameterObjectsOnce(Object object) {
