...
@RunWith(value = MockitoJUnitRunner.class) public class IgnoreUntilRuleTest {
  ...
  @InjectMocks IgnoreUntilRule rule = new IgnoreUntilRule();

  @Test public void shouldReturnOriginalStatementIfAnnotationNotPresent() {
  ...
  @Test(expected = IllegalArgumentException.class) public void shouldThrowExceptionIfDateTimeFormatInvalid() {
  ...
  @Test public void shouldReturnOriginalStatementIfIgnoreUntilDateTimeIsInThePast() {
  ...
  @Test public void shouldReturnAlwaysPassesStatementIfIgnoreUntilDateTimeIsInTheFuture() {
  ...
  @Test public void shouldReturnOriginalStatementIfIgnoreUntilDateIsInThePast() {
  ...
  @Test public void shouldReturnOriginalStatementIfIgnoreUntilDateSameAsCurrentDate() {
  ...
  @Test public void shouldReturnAlwaysPassesStatementIfIgnoreUntilDateIsInTheFuture() {
  ...
  @Test public void shouldReturnOriginalStatementIfMethodAnnotationWithNonDefaultValueExists() throws NoSuchMethodException {
  ...
  @IgnoreUntil(value = "2099-01-01") static class MethodOverrideClassAnnotationTest {
    @IgnoreUntil(value = "2018-01-01") @Test public void shouldNowExecute() {
    }
  }

  @Test public void shouldReturnAlwaysPassesIfMethodAnnotationInheritsFromClassAnnotation() throws NoSuchMethodException {
  ...
  @IgnoreUntil(value = "2099-01-01") static class MethodInheritFromClassAnnotationTest {
    @IgnoreUntil @Test public void shouldNowExecute() {
    }
  }

  @Test public void shouldReturnAlwaysPassesIfOnlyMethodAnnotationExists() throws NoSuchMethodException {
  ...
  static class MethodAnnotationOnly {
    @IgnoreUntil(value = "2099-01-01") @Test public void shouldNowExecute() {
    }
  }
}