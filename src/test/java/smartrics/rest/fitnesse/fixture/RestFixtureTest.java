...
public class RestFixtureTest {
  ...
  @SuppressWarnings(value = { "rawtypes" }) private CellFormatter mockCellFormatter;
  ...
  @Test public void mustSetConfigNameToDefaultWhenNotSpecifiedAsSecondOptionalParameter_SLIM() {
    fixture = new RestFixture(BASE_URL, "configName");
    assertEquals("configName", fixture.getConfig().getName());
  }

  @Test public void mustSetConfigNameToSpecifiedValueIfOptionalSecondParameterIsSpecified_SLIM() {
    fixture = new RestFixture(BASE_URL, "configName");
    assertEquals("configName", fixture.getConfig().getName());
  }

  @Test public void mustUseDefaultHeadersIfDefinedOnNamedConfig() {
  ...
  @Test public void mustAllowMultilineHeadersWhenSettingHeaders() {
  ...
  @Test public void mustExpandSymbolsWhenSettingMultilineHeaders() {
  ...
  @Test public void mustAllowSettingHeaders() {
  ...
  @Test public void mustExpandSymbolSetWithLetWhenSettingHeaders() {
  ...
  @Test public void mustExpandSymbolWhenSettingHeaders() {
  ...
  @Test public void mustRenderSymbolValueWhenSettingHeaders() {
...
>>>>>>> /usr/src/app/output/smartrics/restfixture/d8c6704346b6c678edcfb02a11c914f6db985b21/src/test/java/smartrics/rest/fitnesse/fixture/RestFixtureTest.java/right.java
  ...
  @Test(expected = RuntimeException.class) public void mustNotifyClientIfHTTPVerbInFirstCellIsNotSupported() {
    RowWrapper<?> row = helper.createTestRow("IDONTEXIST", "/uri", "", "", "");
    fixture.processRow(row);
  }

  @Test @SuppressWarnings(value = { "unchecked" }) public void mustNotifyClientIfExpectedBodyCellHasNotBeenSpecified() {
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
    RowWrapper<?> row = helper.createTestRow("GET", "/uri", "", "");
    fixture.processRow(row);
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustNotifyClientIfExpectedHeadersCellHasNotBeenSpecified() {
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
    RowWrapper<?> row = helper.createTestRow("GET", "/uri", "");
    fixture.processRow(row);
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustNotifyClientIfExpectedStatusCodeCellHasNotBeenSpecified() {
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
    RowWrapper<?> row = helper.createTestRow("GET", "/uri");
    fixture.processRow(row);
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustExecuteVerbByOverridingBaseUriIfRowResourceIsAbsoluteUri() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustExecuteVerbOnAUriWithNoExcpectationsOnRestResponseParts() {
    when(mockBodyTypeAdapter.toString()).thenReturn("returned <body />");
    when(mockLastRequest.getQuery()).thenReturn("a=b");
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
    lastResponse.setResource("/uri");
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustExecutePOSTWithFileUploadWhenFileParamNameIsDefault() throws Exception {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustExecuteVerbOnAUriWithExcpectationsSetOnEachResponsePart_ExpectationsMatched() throws Exception {
    when(mockBodyTypeAdapter.toString()).thenReturn("returned <body />");
    when(mockLastRequest.getQuery()).thenReturn("a=b");
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
    when(mockBodyTypeAdapter.parse("//body")).thenReturn("//body");
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustExecuteVerbOnAUriWithExcpectationsSetOnEachResponsePart_ExpectationsNotMatched() throws Exception {
    when(mockLastRequest.getQuery()).thenReturn("a=b");
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void mustMatchRequestsWithNoBodyExpressedAsNoBodyString() throws Exception {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) @Test public void mustExecuteVerbOnAUriWithExcpectationsSetOnHeaders() {
    when(mockLastRequest.getQuery()).thenReturn("");
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
    lastResponse.setResource("/uri");
  ...
  @Test public void mustExpectOnlySupportedVerbOnFirstCell() {
    RowWrapper<?> row = helper.createTestRow("GET", "/uri", "", "", "");
    fixture.processRow(row);
    verify(mockLastRequest).setMethod(Method.Get);
  ...
  /**
     ...
     */
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustExecuteVerbOnAUriWithExcpectationsSetOnBody_XML() throws Exception {
    when(mockBodyTypeAdapter.parse("//body")).thenReturn("//body");
    when(mockBodyTypeAdapter.equals("//body", "<body />")).thenReturn(true);
    when(mockLastRequest.getQuery()).thenReturn("");
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
  ...
  /**
     ...
     */
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustExecuteVerbOnAUriWithExcpectationsSetOnBody_TEXT() throws Exception {
  ...
  /**
     ...
     * correctly handled
     */
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustExecuteVerbOnAUriWithExcpectationsSetOnBody_TEXTWithHtml() throws Exception {
  ...
  /**
     ...
     */
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustExecuteVerbOnAUriWithExcpectationsSetOnBody_JSON() throws Exception {
    String json = "{\"test\":\"me\"}";
  ...
  @Test public void mustUseValueOnSymbolMapEvenIfNotSetViaVariables() {
    when(mockLastRequest.getQuery()).thenReturn("");
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
  ...
  @Test public void mustSetValueOnSymbolMapIfVariableNameStartsWith$() {
    when(mockLastRequest.getQuery()).thenReturn("");
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
  ...
  @Test public void mustReplaceVariablesInExpectedContentOfLetCell() {
    when(mockLastRequest.getQuery()).thenReturn("");
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
    lastResponse.setBody("<body>text</body>");
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustSetValueOnSymbolMapAsXmlStringIfSourceIsBodyAsXml() throws Exception {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustSetValiueOnSymbolMapAsJsonStringIfSourceIsJs() throws Exception {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustReportToTheUserIfLetCantFindTheHandlerToHandleTheDesiredExpression() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustCaptureErrorsOnExpectationsAndDisplayThemInTheSameCell() {
    when(mockLastRequest.getQuery()).thenReturn("");
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
  ...
  /**
     ...
     */
  @Test public void mustAllowGlobalStorageOfValuesExtractedViaXPathFromBody() {
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
    lastResponse.setBody("<body>text</body>");
    RowWrapper<?> row = helper.createTestRow("GET", "/uri", "", "", "");
    fixture.processRow(row);
  ...
  /**
     ...
     */
  @Test public void mustAllowStorageOfValuesExtractedViaXPathsReturningStringValues() {
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
    lastResponse.setBody("<body>text</body>");
    RowWrapper<?> row = helper.createTestRow("GET", "/uri", "", "", "");
    fixture.processRow(row);
  ...
  /**
     ...
     */
  @Test public void mustAllowGlobalStorageOfValuesExtractedViaRegexFromHeader() {
    when(mockRestClient.getBaseUrl()).thenReturn(BASE_URL);
    lastResponse.setBody("<body>text</body>");
  ...
  @Test public void mustAllowSetOfFileNameForFileUpload() {
    RowWrapper<?> row = helper.createTestRow("setFileName", "/tmp/filename");
    fixture.processRow(row);
    assertEquals("/tmp/filename", fixture.getFileName());
  }

  @Test @SuppressWarnings(value = { "unchecked" }) public void mustReportAsExceptionWhenSettingMissingFileName() {
  ...
  @Test public void mustAllowSetOfMultipartFileNameForFileUpload() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustReportAsExceptionWhenAttemptingToSetMissingMultipartFileName() {
  ...
  @Test public void mustAllowSetOfMultipartFileParameterNameForFileUpload() {
  ...
  @Test public void mustExecuteVariableSubstitutionOnBodyForNextRequest() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustEvalJavascriptStringsWithEval() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustNotifyExceptionsWhenEvalJavascriptStrings() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustReportAsRTEWhenSettingMissingMultipartFileParameterName() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustReportAsRTEWhenSettingAMissingBody() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void mustReportAsRTEWhenSettingAMissingHeader() {
  ...
  /**
     ...
     */
  @Test public void constructingWithOneArgShoudlBeTheSUTUri() {
    String uri = "http://localhost:9090";
    RestFixture f = new RestFixture(uri);
    assertEquals(uri, f.getBaseUrl());
  }

  @Test public void constructingWithOneArgShoudlStripAnyTagAndSetTheSUTUri() {
    String uri = "http://localhost:9090";
  ...
  @Test public void constructingWithOneFailsIfArgIsNotAnUri() {
    String uri = "rubbish";
    try {
      new RestFixture(uri);
