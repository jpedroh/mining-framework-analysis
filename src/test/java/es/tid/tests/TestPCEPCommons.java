            ...
            if (c.isPrimitive()) {
              ...
              if (c.isArray()) {
                ...
                if (c.getName().equals("String")) {
                  ...
                  if (c.getName().equals("java.net.Inet4Address")) {
                    o = Inet4Address.getByName("1.1.1.1");
                  } else {
                    if (c.getName().equals("java.net.Inet6Address")) {
                      o = Inet6Address.getByName("1080:0:0:0:8:800:200C:417A");
                    } else {
                      if (c.getName().equals("es.tid.pce.pcep.objects.EndPoints")) {
                        o = new EndPointsIPv4();
                        createAllFields(o);
                      } else {
                        if (c.getName().equals("es.tid.pce.pcep.objects.Bandwidth")) {
                          o = new BandwidthRequested();
                          createAllFields(o);
                        } else {
                          if (c.getName().equals("es.tid.pce.pcep.constructs.GeneralizedBandwidth")) {
                            o = new GeneralizedBandwidthSSON();
                            createAllFields(o);
                          } else {
                            if (c.getName().equals("es.tid.pce.pcep.objects.LabelSet")) {
                              o = new BitmapLabelSet();
                              createAllFields(o);
                            } else {
                              if (c.getName().equals("es.tid.pce.pcep.objects.PceId")) {
                                o = new PceIdIPv4();
                                createAllFields(o);
                              } else {
                                if (c.getName().equals("es.tid.of.DataPathID")) {
                                  o = new DataPathID();
                                  ((DataPathID) o).setDataPathID("11:22:00:AA:33:BB:11:11");
                                } else {
                                  if (c.getName().equals("es.tid.bgp.bgp4.update.tlv.node_link_prefix_descriptor_subTLVs.IGPRouterIDNodeDescriptorSubTLV")) {
              ...
              if (rt instanceof Class) {
                ...
                if (ca.getName().equals("java.util.LinkedList")) {
                  ...
                  if (((Class) at).getName().equals("es.tid.rsvp.objects.subobjects.EROSubobject")) {
                    ...
                    if (((Class) at).getName().equals("es.tid.rsvp.objects.subobjects.RROSubobject")) {
                      System.out.println("FIXME: es.tid.rsvp.objects.subobjects.RROSubobject");
                    } else {
                      if (((Class) at).getName().equals("es.tid.pce.pcep.objects.subobjects.XROSubobject")) {
                        System.out.println("FIXME: es.tid.pce.pcep.objects.subobjects.XROSubobject");
                      } else {
                        if (((Class) at).getName().equals("es.tid.pce.pcep.tlvs.PCEPTLV")) {
                          System.out.println("FIXME: es.tid.pce.pcep.tlvs.PCEPTLV");
                        } else {
                          if (((Class) at).getName().equals("es.tid.pce.pcep.objects.Metric")) {
                            ...
                            if (((Class) at).getName().equals("es.tid.pce.pcep.objects.ObjectiveFunction")) {
                              ...
                              if (((Class) at).getName().equals("es.tid.pce.pcep.constructs.SwitchEncodingType")) {
                                ...
                                if (((Class) at).getName().equals("es.tid.pce.pcep.constructs.Path")) {
                                  ...
                                  if (((Class) at).getName().equals("es.tid.pce.pcep.constructs.NCF")) {
                                    ...
                                    if (((Class) at).getName().equals("es.tid.pce.pcep.constructs.MetricPCE")) {
                                      ...
                                      if (((Class) at).getName().equals("es.tid.bgp.bgp4.open.BGP4OptionalParameter")) {
...
<<<<<<< /usr/src/app/output/telefonicaid/netphony-network-protocols/07041eaa5a5fe329a0efbcecbe079f3323b65462/src/test/java/es/tid/tests/TestPCEPCommons.java/left.java
                                      {
                                        if (((Class) at).getName().equals("java.lang.Integer")) {
                                          ...
                                          if (((Class) at).getName().equals("java.lang.Long")) {
                                            Long in = new Long(5);
                                            methods[0].invoke(res, in);
                                          } else {
                                            if (((Class) at).getName().equals("java.net.Inet4Address")) {
                                              LinkedList<Inet4Address> ll = new LinkedList<Inet4Address>();
                                              Inet4Address in = (Inet4Address) Inet4Address.getByName("1.1.1.1");
                                              ll.add(in);
                                              method2.invoke(object, ll);
                                            } else {
                                              if (((Class) at).getName().equals("es.tid.pce.pcep.objects.tlvs.OperatorAssociation")) {
...
=======
                                      if (((Class) at).getName().equals("es.tid.bgp.bgp4.open.BGP4Capability")) {
...
>>>>>>> /usr/src/app/output/telefonicaid/netphony-network-protocols/07041eaa5a5fe329a0efbcecbe079f3323b65462/src/test/java/es/tid/tests/TestPCEPCommons.java/right.java
