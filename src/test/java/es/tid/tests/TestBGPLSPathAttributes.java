...
@RunWith(value = org.junit.runners.Parameterized.class) public class TestBGPLSPathAttributes {
  String object;

  @Parameters(name = "{0}") public static Collection<Object[]> configs() {
    Object[][] objects = { { "es.tid.bgp.bgp4.update.fields.NodeNLRI" }, { "es.tid.bgp.bgp4.update.fields.LinkNLRI" } };
  ...
  @Test public void testMP_Unreach_Attriute() {
