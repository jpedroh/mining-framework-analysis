...
public class MPRestClientTest {
  ...
  @Test public void getMethodTest() throws MPRestException {
    MPRestClient client = new MPRestClient();
    MPBaseResponse response = client.executeRequest(HttpMethod.GET, HTTPBIN_TEST_URL + "get", PayloadType.NONE, null, null, 1, 1, 1);
    ...
    response = client.executeRequest(HttpMethod.GET, HTTPBIN_TEST_URL + "get/invalid", PayloadType.NONE, null, null);
    ...
    response = client.executeRequest(HttpMethod.GET, HTTPBIN_TEST_URL + "post", PayloadType.NONE, null, null);
    ...
    try {
      client.executeRequest(HttpMethod.GET, HTTPBIN_TEST_URL + "get", PayloadType.JSON, new JsonObject(), null);
  ...
  @Test public void deleteMethodTest() throws MPRestException {
    MPRestClient client = new MPRestClient();
    MPBaseResponse response = client.executeRequest(HttpMethod.DELETE, HTTPBIN_TEST_URL + "delete", PayloadType.NONE, null, null);
    assertEquals("Response must have a 200 status.", 200, response.getStatusCode());
    assertEquals("Response must have a \"OK\" reason phrase.", "OK", response.getReasonPhrase());
    response = client.executeRequest(HttpMethod.DELETE, HTTPBIN_TEST_URL + "delete/invalid", PayloadType.NONE, null, null);
    assertEquals("Response must have a 404 status.", 404, response.getStatusCode());
    assertEquals("Response must have a \"NOT FOUND\" reason phrase.", "NOT FOUND", response.getReasonPhrase());
    response = client.executeRequest(HttpMethod.DELETE, HTTPBIN_TEST_URL + "get", PayloadType.NONE, null, null);
    assertEquals("Response must have a 405 status.", 405, response.getStatusCode());
    assertEquals("Response must have a \"METHOD NOT ALLOWED\" reason phrase.", "METHOD NOT ALLOWED", response.getReasonPhrase());
    Exception exception = null;
    try {
      client.executeRequest(HttpMethod.DELETE, HTTPBIN_TEST_URL + "delete", PayloadType.JSON, new JsonObject(), null);
    } catch (MPException mpException) {
      assertEquals("Exception must have \"Payload not supported for this method.\" message", mpException.getMessage(), "Payload not supported for this method.");
      exception = mpException;
    }
  ...
  @Test public void postMethodTest() throws MPRestException {
    MPRestClient client = new MPRestClient();
    ...
    response = client.executeRequest(HttpMethod.POST, HTTPBIN_TEST_URL + "post", PayloadType.X_WWW_FORM_URLENCODED, jsonObject, null);
    assertEquals("Response must have a 200 status.", 200, response.getStatusCode());
    assertEquals("Response must have a \"OK\" reason phrase.", "OK", response.getReasonPhrase());
    ...
    response = client.executeRequest(HttpMethod.POST, HTTPBIN_TEST_URL + "post/invalid", PayloadType.JSON, jsonObject, null);
    assertEquals("Response must have a 404 status.", 404, response.getStatusCode());
    assertEquals("Response must have a \"NOT FOUND\" reason phrase.", "NOT FOUND", response.getReasonPhrase());
    response = client.executeRequest(HttpMethod.POST, HTTPBIN_TEST_URL + "get", PayloadType.JSON, jsonObject, null);
    assertEquals("Response must have a 405 status.", 405, response.getStatusCode());
    assertEquals("Response must have a \"METHOD NOT ALLOWED\" reason phrase.", "METHOD NOT ALLOWED", response.getReasonPhrase());
    Exception exception = null;
    try {
      client.executeRequest(HttpMethod.POST, HTTPBIN_TEST_URL + "post", PayloadType.NONE, null, null);
    } catch (MPException mpException) {
  ...
  @Test public void putMethodTest() throws MPRestException {
    MPRestClient client = new MPRestClient();
    JsonObject jsonObject = new JsonObject();
    jsonObject.addProperty("property", "value");
    ...
    assertEquals("Response must have a 404 status.", 404, response.getStatusCode());
    assertEquals("Response must have a \"NOT FOUND\" reason phrase.", "NOT FOUND", response.getReasonPhrase());
    response = client.executeRequest(HttpMethod.PUT, HTTPBIN_TEST_URL + "get", PayloadType.JSON, jsonObject, null);
    assertEquals("Response must have a 405 status.", 405, response.getStatusCode());
    assertEquals("Response must have a \"METHOD NOT ALLOWED\" reason phrase.", "METHOD NOT ALLOWED", response.getReasonPhrase());
    Exception exception = null;
    try {
      client.executeRequest(HttpMethod.PUT, HTTPBIN_TEST_URL + "put", PayloadType.NONE, null, null);
    } catch (MPException mpException) {
  ...
  @Test public void invalidTest() throws MPRestException {
    MPRestClient client = new MPRestClient();
    Exception exception = null;
    try {
    ...
    exception = null;
    try {
      client.executeRequest(HttpMethod.GET, null, PayloadType.NONE, null, null);
    } catch (MPException mpException) {
