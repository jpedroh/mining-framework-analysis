 ...
 */
@Idempotent public class MPBaseTest extends MPBase {
  ...
  @GET(path = "/getpath/slug/:id") public MPBaseResponse load(String id) throws MPException {
    return super.processMethod("load", id);
  }

  @GET(path = "/getpath/slug/") @PUT(path = "/putpath/slug/") public MPBaseResponse loadAll() throws MPException {
  ...
  @POST(path = "/postpath/slug") public MPBaseResponse create() throws MPException {
    return super.processMethod("create");
  }

  @PUT(path = "/putpath/slug/:id") public MPBaseResponse update(String id) throws MPException {
  ...
  /**
     ...
     */
  @Test public void nonAllowedMethodTest() throws Exception {
  ...
  /**
     ...
     * It should return an MPException
     */
  @Test public void notExistentMethodTest() throws Exception {
    Exception auxException = null;
    try {
  ...
  /**
     ...
     * It should return an MPException.
     */
  @Test public void notAnnotatedMethodTest() throws Exception {
    Exception auxException = null;
    try {
      save();
    } catch (MPException mpException) {
  ...
  /**
     ...
     * It should return an MPException
     */
  @Test public void multipleAnnotationMethodTest() throws Exception {
    Exception auxException = null;
    try {
      loadAll();
    } catch (MPException mpException) {
  ...
  /**
     ...
     * It should return an MPException
     */
  @Test public void methodWithNoArgumentTest() throws Exception {
    Exception auxException = null;
    try {
      load(null);
    } catch (MPException mpException) {
  ...
  /**
     ...
     */
  @Test public void methodPathTest() throws Exception {
  ...
  @Test public void idempotenceTest() throws MPException {
    MPBaseTest resource = new MPBaseTest();
