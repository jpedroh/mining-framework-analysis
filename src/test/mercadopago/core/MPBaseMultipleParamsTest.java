...
public class MPBaseMultipleParamsTest extends MPBase {
  @BeforeClass public static void beforeTest() throws MPException {
    MPConf.cleanConfiguration();
    MPConf.setConfiguration("test/mercadopago/data/credentials.properties");
  }

  @GET(path = "/loadpath/slug") public MPBaseResponse load() throws MPException {
    return super.processMethod("load");
  }

  @POST(path = "/savepath/slug/:param1") public MPBaseResponse save(String param1) throws MPException {
    return super.processMethod("save", param1);
  }

  @GET(path = "/getpath/slug/:param1/otherslug/:param2") public MPBaseResponse update(String param1, String param2) throws MPException {
    return super.processMethod("update", param1, param2);
  }

  @DELETE(path = "/delete/slug/:card_id/otherslug/:param2/:param3") public MPBaseResponse delete(String card_id, String param2, String param3) throws MPException {
  ...
  /**
     ...
     */
  @Test public void noParamsMethdTest() throws Exception {
    MPBaseResponse expected = "{\"method\":\"GET\",\"path\":\"https://api.mercadopago.com/loadpath/slug";
  ...
  /**
     ...
     */
  @Test public void singleParamsMethdTest() throws Exception {
    MPBaseResponse expected = "{\"method\":\"POST\",\"path\":\"https://api.mercadopago.com/savepath/slug/test1";
    expected += "?access_token=" + MPConf.getAccessToken();
    expected += "\",\"payload\":{}}";
  ...
  /**
     ...
     */
  @Test public void twoParamsMethdTest() throws Exception {
    MPBaseResponse expected = "{\"method\":\"GET\",\"path\":\"https://api.mercadopago.com/getpath/slug/test1/otherslug/test2";
    expected += "?access_token=" + MPConf.getAccessToken();
    expected += "\"}";
  ...
  /**
     ...
     */
  @Test public void threeParamsMethdTest() throws Exception {
    MPBaseResponse expected = "{\"method\":\"DELETE\",\"path\":\"https://api.mercadopago.com/delete/slug/test1/otherslug/test2/test3";
    expected += "?access_token=" + MPConf.getAccessToken();
    expected += "\"}";
    assertEquals(expected, delete("test1", "test2", "test3"));
  }

  @Test public void idempotenceKeyTest() throws MPException {
