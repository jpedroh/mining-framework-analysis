...
public class MPBaseMultipleParamsTest extends MPBase {
  ...
  @GET(path = "/loadpath/slug") public String load() throws MPException {
    return super.processMethod("load");
  }

  @POST(path = "/savepath/slug/:param1") public String save(String param1) throws MPException {
    return super.processMethod("save", param1);
  }

  @GET(path = "/getpath/slug/:param1/otherslug/:param2") public String update(String param1, String param2) throws MPException {
    return super.processMethod("update", param1, param2);
  }

  @DELETE(path = "/delete/slug/:card_id/otherslug/:param2/:param3") public String delete(String card_id, String param2, String param3) throws MPException {
