...
public class DeployTesty extends TestBase {
  ...
  @BeforeClass public void startTests() {
    driver.get(JENKINS_JOB_URL);
  }

  @Test public void loginJenkins() {
    loginEl.click();
    loginForm.ready(10);
  ...
  @Test(dependsOnMethods = "loginJenkins") public void deployOnJenkins() {
    buildNow.click();
  ...
  @Test(dependsOnMethods = "deployOnJenkins") public void loginAsAdminSDLNexus() {
  ...
  @Test(dependsOnMethods = "loginAsAdminSDLNexus") public void removeFormSDLNexus() {
