...
public class APIData {
  ...
  public static final String TYPE_REQUEST_APPROVAL = "PENDING_APPROVAL";
  ...
  public static final String START_MATURITY = "START_MATURITY";

  public static final String TYPE_WRITE_OFF = "WRITE_OFF";

  public static final String TYPE_DEPOSIT_ADJUSTMENT = "DEPOSIT_ADJUSTMENT";

  public static final String DISBURSEMENT_DETAILS = "disbursementDetails";
  ...
  public static final String UNDO_REJECT = "UNDO_REJECT";

  public static final String UNDO_WITHDRAWN = "UNDO_WITHDRAWN";

  public static final String UNDO_CLOSE = "UNDO_CLOSE";
  ...
  public static final String SETTLEMENT_ACCOUNTS = "settlementAccounts";
  ...
  public static String CUSTOM_INFORMATION_FIELD = "customInformation";
  ...
  public static final String PRINCIPAL_PAYMENT_SETTINGS = "principalPaymentSettings";
  ...
  public static final String FIXED_DAYS_OF_MONTH = "fixedDaysOfMonth";

  public static final String ARREARS_TOLERANCE_PERIOD = "arrearsTolerancePeriod";

  public static final String INTEREST_SETTINGS = "interestSettings";

  public static final String OVERDRAFT_INTEREST_SETTINGS = "overdraftInterestSettings";
  ...
  public static String LINES_OF_CREDIT = "linesofcredit";
  ...
  public static String yyyyMmddFormat = DateUtils.DATE_FORMAT;
