  ...
  private class Tokenizer implements Iterator<Token> {
    ...
    @Override public Token next() {
      ...
      if (Character.isDigit(ch)) {
        ...
        if (ch == minusSign && Character.isDigit(peekNextChar()) && (previousToken == null || previousToken.type == TokenType.OPEN_PAREN || previousToken.type == TokenType.COMMA || previousToken.type == TokenType.OPERATOR)) {
  ...
  private List<Token> shuntingYard(String expression) {
    ...
    while (tokenizer.hasNext()) {
      ...
      switch (token.type) {
        ...
        while (token2 != null && operators.containsKey(token2) && ((o1.isLeftAssoc() && o1.getPrecedence() <= operators.get(token2).getPrecedence()) || (o1.getPrecedence() < operators.get(token2).getPrecedence()))) {
          outputQueue.add(stack.pop());
...
<<<<<<< /usr/src/app/output/uklimaschewski/evalex/b712e336e13c0bc27119d445050721515f71f6d4/src/com/udojava/evalex/Expression.java/left.java
            null
=======
            new BigDecimal(new BigInteger(token.surface.substring(2), 16), mc)
>>>>>>> /usr/src/app/output/uklimaschewski/evalex/b712e336e13c0bc27119d445050721515f71f6d4/src/com/udojava/evalex/Expression.java/right.java
            ;
          }
