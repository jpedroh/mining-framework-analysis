...
public class MPCredentials {
    ...
    public static String getAccessToken() throws MPException {
        if (StringUtils.isEmpty(MPConf.getClientId()) || StringUtils.isEmpty(MPConf.getClientSecret())) {
        ...
        MPBaseResponse response = new MPRestClient().executeRequest(MPRestClient.HttpMethod.POST, MPConf.getBaseUrl() + "/oauth/token", PayloadType.X_WWW_FORM_URLENCODED, jsonPayload, null);
