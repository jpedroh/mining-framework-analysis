...
public abstract class MPBase {
  ...
  private HashMap<String, Object> getRestInformation(AnnotatedElement element) throws MPException {
    ...
    for (Annotation annotation : element.getAnnotations()) {
      if (annotation instanceof DELETE) {
        ...
        hashAnnotation = fillHashAnnotations(hashAnnotation, HttpMethod.DELETE, delete.path(), null, delete.connectionTimeout(), delete.soTimeout());
      } else {
        if (annotation instanceof GET) {
          ...
          hashAnnotation = fillHashAnnotations(hashAnnotation, HttpMethod.GET, get.path(), null, get.connectionTimeout(), get.soTimeout());
        } else {
          if (annotation instanceof POST) {
            ...
            hashAnnotation = fillHashAnnotations(hashAnnotation, HttpMethod.POST, post.path(), post.payloadType(), post.connectionTimeout(), post.soTimeout());
          } else {
            if (annotation instanceof PUT) {
              ...
              hashAnnotation = fillHashAnnotations(hashAnnotation, HttpMethod.PUT, put.path(), put.payloadType(), put.connectionTimeout(), put.soTimeout());
            }
          }
        }
      }
  ...
  /**
     ...
     * @throws MPException
     */
  private HashMap<String, Object> fillHashAnnotations(HashMap<String, Object> hashAnnotation, HttpMethod method, String path, PayloadType payloadType, int connectionTimeout, int soTimeout) throws MPException {
