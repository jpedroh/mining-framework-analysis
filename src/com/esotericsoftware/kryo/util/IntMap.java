...
public class IntMap<V extends java.lang.Object> implements Iterable<IntMap.Entry<V>> {
  public int size;
  ...
  @Null public V put(int key, @Null V value) {
    if (key == 0) {
  ...
  public static class Entry<V extends java.lang.Object> {
    public int key;
  ...
  private static class MapIterator<V extends java.lang.Object> {
  ...
  public static class Entries<V extends java.lang.Object> extends MapIterator<V> implements Iterable<Entry<V>>, Iterator<Entry<V>> {
  ...
  public static class Values<V extends java.lang.Object> extends MapIterator<V> implements Iterable<V>, Iterator<V> {
