...
public class MapReferenceResolver implements ReferenceResolver {
  ...
  @Override public void setKryo(Kryo kryo) {
    this.kryo = kryo;
  }

  @Override public int addWrittenObject(Object object) {
    int id = writtenObjects.size;
    writtenObjects.put(object, id);
    return id;
  }

  @Override public int getWrittenId(Object object) {
    return writtenObjects.get(object, -1);
  }

  @Override public int nextReadId(Class type) {
    int id = readObjects.size();
    readObjects.add(null);
    return id;
  }

  @Override public void setReadObject(int id, Object object) {
    readObjects.set(id, object);
  }

  @Override public Object getReadObject(Class type, int id) {
