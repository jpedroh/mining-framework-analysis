...
public final class DefaultGenerics extends BaseGenerics {
  ...
  @Override public int pushTypeVariables(GenericsHierarchy hierarchy, GenericType[] args) {
  ...
  @Override public void popTypeVariables(int count) {
