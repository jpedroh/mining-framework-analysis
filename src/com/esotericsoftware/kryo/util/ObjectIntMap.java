...
public class ObjectIntMap<K extends java.lang.Object> implements Iterable<ObjectIntMap.Entry<K>> {
  public int size;
  ...
  public static class Entry<K extends java.lang.Object> {
    public K key;
  ...
  private static class MapIterator<K extends java.lang.Object> {
  ...
  public static class Entries<K extends java.lang.Object> extends MapIterator<K> implements Iterable<Entry<K>>, Iterator<Entry<K>> {
  ...
  public static class Keys<K extends java.lang.Object> extends MapIterator<K> implements Iterable<K>, Iterator<K> {
