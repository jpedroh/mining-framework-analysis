...
public class DefaultClassResolver implements ClassResolver {
  ...
  @Override public Registration register(Registration registration) {
    memoizedClassId = -1;
    memoizedClass = null;
  ...
  @Override public Registration unregister(int classID) {
  ...
  @Override public Registration getRegistration(int classID) {
  ...
  @Override public Registration readClass(Input input) {
