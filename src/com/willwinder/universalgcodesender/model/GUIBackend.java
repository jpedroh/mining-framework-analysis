...
<<<<<<< /usr/src/app/output/winder/universal-g-code-sender/8f1015bceb298de27146fa3b9aa0274fbd49e807/src/com/willwinder/universalgcodesender/model/GUIBackend.java/left.java
    disconnectInternal()
=======
    this.sendControlStateEvent(new UGSEvent(ControlState.COMM_DISCONNECTED))
>>>>>>> /usr/src/app/output/winder/universal-g-code-sender/8f1015bceb298de27146fa3b9aa0274fbd49e807/src/com/willwinder/universalgcodesender/model/GUIBackend.java/right.java
    ;
  }
  ...
  @Override public void autoconnect() {
    if (disableAutoconnect) {
      return;
    }
    long now = System.currentTimeMillis();
    if (now - lastResponse > AUTO_DISCONNECT_THRESHOLD && now - lastConnectAttempt > AUTO_DISCONNECT_THRESHOLD) {
  ...
  @Override public void updateSystemState(SystemStateBean systemStateBean) {
  ...
  /**
     ...
     */
  @Override public void adjustManualLocation(int dirX, int dirY, int dirZ, double stepSize, Units units) throws Exception {
  ...
  @Override public void setTempDir(File file) throws IOException {
    if (file.isDirectory()) {
      this.tempDir = file;
    } else {
  ...
  @Override public void setGcodeFile(File file) throws Exception {
    ...
    this.sendControlStateEvent(new UGSEvent(FileState.FILE_LOADING, file.getAbsolutePath()));
    initializeProcessedLines(true);
    this.sendControlStateEvent(new UGSEvent(FileState.FILE_LOADED, processedGcodeFile.getAbsolutePath()));
  }
  ...
  @Override public boolean isSending() {
  ...
  @Override public void resetCoordinateToZero(char coordinate) throws Exception {
  ...
  @Override public void messageForConsole(String msg, Boolean verbose) {
  }
