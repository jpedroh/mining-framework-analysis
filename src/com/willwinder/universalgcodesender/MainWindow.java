...
public class MainWindow extends JFrame implements ControllerListener, ControlStateListener {
  ...
  private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    if (returnVal == JFileChooser.APPROVE_OPTION) {
      try {
        ...
        displayErrorDialog(Localization.getString("mainWindow.error.openingFile") + ": " + ex.getMessage());
      } catch (IOException e) {
        displayErrorDialog(Localization.getString("mainWindow.error.processingFile") + ": " + e.getMessage());
      } catch (Exception e) {
        logger.log(Level.INFO, "Exception in saveButtonActionPerformed.", e);
        displayErrorDialog(Localization.getString("mainWindow.error.duringSave") + ": " + e.getMessage());
      }
    }
  }
  ...
  @Override public void statusStringListener(String state, Position machineCoord, Position workCoord) {
