  ...
  public static void configCheck(ConfigType type) {
    ...
    if (type == ConfigType.PRESETS) {
      ...
      if (type == ConfigType.LANGUAGE) {
        ...
        config.addDefault("Abilities.Water.PhaseChange.Description", 
