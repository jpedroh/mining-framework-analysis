        ...
        try {
          ...
          try (BufferedReader reader = new BufferedReader(new InputStreamReader(urlc.getInputStream()))) {
            ...
            while ((line = reader.readLine()) != null) {
              if (
<<<<<<< /usr/src/app/output/projectkorra/projectkorra/dd6d1252c9301ab42113fcc18f215eaf8fc6eb96/src/com/projectkorra/projectkorra/util/Updater.java/left.java
              line.contains("<h3>Version ")
=======
              line.toLowerCase().matches(".*<span class=\"u-muted\">[0-9\\. formcr+]{1,23}<\\/span>.*")
>>>>>>> /usr/src/app/output/projectkorra/projectkorra/dd6d1252c9301ab42113fcc18f215eaf8fc6eb96/src/com/projectkorra/projectkorra/util/Updater.java/right.java
              ) {
                line = line.trim();
                updateVersion = line.
<<<<<<< /usr/src/app/output/projectkorra/projectkorra/dd6d1252c9301ab42113fcc18f215eaf8fc6eb96/src/com/projectkorra/projectkorra/util/Updater.java/left.java
                split("<h3>Version ")[1]
=======
                split("<span class=\"u-muted\">")[1].split("<\\/span>")[0]
>>>>>>> /usr/src/app/output/projectkorra/projectkorra/dd6d1252c9301ab42113fcc18f215eaf8fc6eb96/src/com/projectkorra/projectkorra/util/Updater.java/right.java
                ;
...
>>>>>>> /usr/src/app/output/projectkorra/projectkorra/dd6d1252c9301ab42113fcc18f215eaf8fc6eb96/src/com/projectkorra/projectkorra/util/Updater.java/right.java
  ...
  public boolean updateAvailable() {
    ...
    String numericUpdateVersion = updateVersion.split(" ")[0];
    String numericCurrentVersion = currentVersion.split(" ")[0];
    int currentNumber = Integer.parseInt(numericCurrentVersion.replaceAll("[^\\d]", ""));
    int updateNumber = Integer.parseInt(numericUpdateVersion.replaceAll("[^\\d]", ""));
    return 
<<<<<<< /usr/src/app/output/projectkorra/projectkorra/dd6d1252c9301ab42113fcc18f215eaf8fc6eb96/src/com/projectkorra/projectkorra/util/Updater.java/left.java
    currentNumber < updateNumber
=======
    currentNumber < updateNumber || currentVersion.hashCode() != updateVersion.hashCode()
>>>>>>> /usr/src/app/output/projectkorra/projectkorra/dd6d1252c9301ab42113fcc18f215eaf8fc6eb96/src/com/projectkorra/projectkorra/util/Updater.java/right.java
    ;
  }
