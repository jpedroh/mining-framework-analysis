...
public class EarthBlast extends EarthAbility {
      ...
      if (blast.player.equals(player)) {
        ...
        if (!blast.location.getWorld().equals(player.getWorld())) {
          ...
          if (!blast.isProgressing) {
            ...
            if (GeneralMethods.isRegionProtectedFromBuild(this, blast.location)) {
              continue;
            }
          }
        }
  ...
  @SuppressWarnings(value = { "deprecation" }) private void focusBlock() {
  ...
  public boolean prepare() {
    ...
    for (EarthBlast blast : getAbilities(player, EarthBlast.class)) {
      if (!blast.isProgressing) {
        ...
        if (blast.isProgressing && block.equals(blast.sourceBlock)) {
  ...
  @SuppressWarnings(value = { "deprecation" }) @Override public void progress() {
    ...
    if (System.currentTimeMillis() - time >= interval) {
      ...
      if (isAtDestination) {
        ...
        if (!isEarthbendable(sourceBlock) && sourceBlock.getType() != Material.COBBLESTONE) {
          remove();
          return;
        }
      }
  ...
  @SuppressWarnings(value = { "deprecation" }) @Override public void remove() {
    super.remove();
  ...
  @SuppressWarnings(value = { "deprecation" }) public void throwEarth() {
  ...
  /**
	 ...
	 */
  @Deprecated public static boolean annihilateBlasts(Location location, double radius, Player source) {
    boolean broke = false;
    for (EarthBlast blast : getAbilities(EarthBlast.class)) {
    ...
    for (EarthBlast blast : getAbilities(EarthBlast.class)) {
      if (!blast.isProgressing || ignore.contains(blast)) {
        ...
        if (!blast.location.getWorld().equals(player.getWorld())) {
          ...
          if (GeneralMethods.isRegionProtectedFromBuild(blast, blast.location)) {
            continue;
          } else {
            if (blast.player.equals(player)) {
