  ...
  public void formArmor() {
    if (this.metalClipsCount >= 4) {
      ...
      if (this.metalClipsCount == 3 && !this.canUse4Clips) {
        ...
        if (this.targetEntity != null && GeneralMethods.isRegionProtectedFromBuild(this, this.targetEntity.getLocation())) {
          return;
        }
      }
    }
      ...
      for (final Entity entity : GeneralMethods.getEntitiesAroundPoint(this.player.getLocation(), this.magnetRange)) {
        ...
        if (entity instanceof Item) {
          ...
          if (Arrays.asList(METAL_ITEMS).contains(iron.getItemStack().getType())) {
            iron.setVelocity(vector.normalize().multiply(
...
>>>>>>> /usr/src/app/output/projectkorra/projectkorra/67f85ed9148cd291557f0736d82cf4a4dde511ee/src/com/projectkorra/projectkorra/earthbending/metal/MetalClips.java/right.java
  ...
  public void dropIngots(final Location loc, final int amount) {
    final Item i = this.player.
<<<<<<< /usr/src/app/output/projectkorra/projectkorra/67f85ed9148cd291557f0736d82cf4a4dde511ee/src/com/projectkorra/projectkorra/earthbending/metal/MetalClips.java/left.java
    getWorld().dropItem(loc, new ItemStack(Material.IRON_INGOT, amount))
=======
    dropItem(loc, new ItemStack(Material.IRON_INGOT, amount))
>>>>>>> /usr/src/app/output/projectkorra/projectkorra/67f85ed9148cd291557f0736d82cf4a4dde511ee/src/com/projectkorra/projectkorra/earthbending/metal/MetalClips.java/right.java
    ;
    i.setPickupDelay(61);
  }
