...
<<<<<<< /usr/src/app/output/projectkorra/projectkorra/d0b17cacf5a4067954c3a63ffaf45ca733cf2bdb/src/com/projectkorra/projectkorra/ability/WaterAbility.java/left.java
        !isBendableWaterTempBlock(block)
=======
...
>>>>>>> /usr/src/app/output/projectkorra/projectkorra/d0b17cacf5a4067954c3a63ffaf45ca733cf2bdb/src/com/projectkorra/projectkorra/ability/WaterAbility.java/right.java
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "deprecation" }) public static Block getWaterSourceBlock(Player player, double range, boolean plantbending) {
    Location location = player.getEyeLocation();
    Vector vector = location.getDirection().clone().normalize();
...
>>>>>>> /usr/src/app/output/projectkorra/projectkorra/d0b17cacf5a4067954c3a63ffaf45ca733cf2bdb/src/com/projectkorra/projectkorra/ability/WaterAbility.java/right.java
  ...
  @SuppressWarnings(value = { "deprecation" }) public static boolean isWaterbendable(Player player, String abilityName, Block block) {
    byte full = 0x0;
    BendingPlayer bPlayer = BendingPlayer.getBendingPlayer(player);
...
>>>>>>> /usr/src/app/output/projectkorra/projectkorra/d0b17cacf5a4067954c3a63ffaf45ca733cf2bdb/src/com/projectkorra/projectkorra/ability/WaterAbility.java/right.java
      ...
      if (isWater(block) && block.getData() == full) {
        ...
        if (isIce(block) && !bPlayer.canIcebend()) {
          return false;
        } else {
          if (isPlant(block) && !bPlayer.canPlantbend()) {
            return false;
          }
        }
      }
  ...
  /**
	 ...
	 */
  @Deprecated public static void removeWaterSpouts(Location loc, double radius, Player source) {
  ...
  /**
	 ...
	 * @param source The player causing the removal
	 */
  @Deprecated public static void removeWaterSpouts(Location loc, Player source) {
