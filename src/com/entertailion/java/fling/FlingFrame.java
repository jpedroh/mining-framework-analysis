...
public class FlingFrame extends JFrame implements ActionListener, BroadcastDiscoveryHandler, ChangeListener {
  ...
  private static final String TRANSCODING_PARAMETERS = 
<<<<<<< /usr/src/app/output/entertailion/fling/e008cc1cee6c339a24627ec7e00cc5be46f916ee/src/com/entertailion/java/fling/FlingFrame.java/left.java
  "vcodec=VP80,vb=1000,vfilter=canvas{width=640,height=360},acodec=vorb,ab=128,channels=2,samplerate=44100,threads=2"
=======
  "vcodec=VP80,vb=1000,vfilter=canvas{width=640,height=360},acodec=vorb,ab=128,channels=2,samplerate=44100"
