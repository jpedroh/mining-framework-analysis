...
public class PackageManager {
  ...
  @SuppressWarnings(value = { "squid:S00100" }) public static InstallOption WITH_INSTALLER_PACKAGE_NAME(String name) {
    return new InstallOption("-t", name);
  }

  @SuppressWarnings(value = { "squid:S00100" }) public static InstallOption ON_SHARED_MASS_STORAGE(String name) {
    return new InstallOption("-s", name);
  }

  @SuppressWarnings(value = { "squid:S00100" }) public static InstallOption ON_INTERNAL_SYSTEM_MEMORY(String name) {
