...
public abstract class Policy {
  ...
  /**
	 ...
	 */
  @Deprecated public static double getProbOfActionGivenDistribution(State s, AbstractGroundedAction ga, List<ActionProb> distribution) {
  ...
  public static class GroundedAnnotatedAction extends GroundedAction {
    ...
    @Override public void initParamsWithStringRep(String[] params) {
      delegate.initParamsWithStringRep(params);
    }

    @Override public String[] getParametersAsString() {
    ...
    @Override public boolean applicableInState(State s) {
      return delegate.applicableInState(s);
    }

    @Override public GroundedAction copy() {
      GroundedAction selCopy = (GroundedAction) this.delegate.copy();
      return new GroundedAnnotatedAction(this.annotation, selCopy);
    }

    @Override public EnvironmentOutcome executeIn(Environment env) {
      return delegate.executeIn(env);
    }

    @Override public State executeIn(State s) {
      return delegate.executeIn(s);
    }

    @Override public List<TransitionProbability> getTransitions(State s) {
      return delegate.getTransitions(s);
    }

    @Override public GroundedAction translateParameters(State source, State target) {
