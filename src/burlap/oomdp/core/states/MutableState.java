...
public class MutableState extends OOMDPState implements State {
  ...
  /**
	 ...
	 */
  @Override public MutableState copy() {
  ...
  @Override public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + ((objectIndexByClass == null) ? 0 : objectIndexByClass.hashCode());
    result = prime * result + ((objectInstances == null) ? 0 : objectInstances.hashCode());
  ...
  private void getPossibleRenameBindingsHelper(List<List<String>> res, List<List<String>> currentBindingSets, int bindIndex, List<ObjectInstance> remainingObjects, List<String> uniqueOrderGroups, String[] paramClasses, String[] paramOrderGroups) {
