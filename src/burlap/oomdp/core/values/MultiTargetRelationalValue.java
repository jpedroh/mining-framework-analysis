...
public class MultiTargetRelationalValue extends OOMDPValue implements Value {
  ...
  @Override public boolean valueHasBeenSet() {
    return true;
  }

  @Override public Value setValue(String v) {
    if (v.indexOf(';') != -1) {
  ...
  @Override public Value addRelationalTarget(String t) {
    TreeSet<String> targets = new TreeSet<String>(this.targetObjects);
    targets.add(t);
    return new MultiTargetRelationalValue(this.attribute, targets);
  }

  @Override public Value addAllRelationalTargets(Collection<String> targets) {
  ...
  @Override public Value clearRelationTargets() {
    return new MultiTargetRelationalValue(this.attribute);
  }

  @Override public Value removeRelationalTarget(String target) {
    TreeSet<String> targets = new TreeSet<String>(this.targetObjects);
    targets.remove(target);
    return new MultiTargetRelationalValue(this.attribute, targets);
  }

  @Override public Set<String> getAllRelationalTargets() {
    return this.targetObjects;
  }

  @Override public StringBuilder buildStringVal(StringBuilder builder) {
  ...
  @Override public double getNumericRepresentation() {
    return 0;
  }
  ...
  @Override public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + ((targetObjects == null) ? 0 : targetObjects.hashCode());
    return result;
  }
