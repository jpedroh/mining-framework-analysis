...
public class EL implements ICompiler {
  ...
  /**
     ...
     **/
  @Override public String compileContext(String context) throws Exception {
  ...
  /**
     ...
     **/
  @Override public String compileAction(String action) throws Exception {
  ...
  /**
     ...
     * mean others have to.
     **/
  @Override public String compileInitialAction(String action) throws Exception {
    return compile("action " + action);
  }
  ...
  /**
     ...
     **/
  @Override public String compileCondition(String condition) throws Exception {
  ...
  /**
     ...
     */
  @Override public String compilePolicyStatement(String policyStatement) throws Exception {
