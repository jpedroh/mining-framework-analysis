 ...
 */
public class BarYehudaEvenTwoApproxVCImpl<V extends java.lang.Object, E extends java.lang.Object> implements MinimumWeightedVertexCoverAlgorithm<V, E>, VertexCoverAlgorithm<V> {
  ...
  @Override public VertexCoverAlgorithm.VertexCover getVertexCover() {
  ...
  /**
     ...
     */
  @Override @Deprecated public MinimumVertexCoverAlgorithm.VertexCover<V> getVertexCover(Graph<V, E> graph, Map<V, Double> vertexWeightMap) {
