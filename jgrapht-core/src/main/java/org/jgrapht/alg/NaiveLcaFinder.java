 ...
 */
@Deprecated public class NaiveLcaFinder<V extends java.lang.Object, E extends java.lang.Object> {
  ...
  public V findLca(V a, V b) {
    return findLca(Collections.singleton(a), Collections.singleton(b), new LinkedHashSet<>(), new LinkedHashSet<>());
  }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public Set<V> findLcas(V a, V b) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) private void doubleBfs(V a, V b, Set<V>[] visitedSets) {
