 ...
 */
@Deprecated public class CliqueMinimalSeparatorDecomposition<V extends java.lang.Object, E extends java.lang.Object> {
  /**
  ...
  /**
     ...
     */
  private static <V extends java.lang.Object, E extends java.lang.Object> boolean isClique(Graph<V, E> graph, Set<V> vertices) {
    for (V v1 : vertices) {
      for (V v2 : vertices) {
  ...
  /**
     ...
     */
  private static <V extends java.lang.Object, E extends java.lang.Object> Graph<V, E> copyAsSimpleGraph(Graph<V, E> graph) {
