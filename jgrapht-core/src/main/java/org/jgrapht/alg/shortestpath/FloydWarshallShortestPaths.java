 ...
 */
public class FloydWarshallShortestPaths<V extends java.lang.Object, E extends java.lang.Object> extends BaseShortestPathAlgorithm<V, E> {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public GraphPath<V, E> getPath(V a, V b) {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public double getPathWeight(V source, V sink) {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public SingleSourcePaths<V, E> getPaths(V source) {
  ...
  class FloydWarshallSingleSourcePaths implements SingleSourcePaths<V, E> {
    ...
    @Override public double getWeight(V sink) {
      return FloydWarshallShortestPaths.this.getPathWeight(source, sink);
    }

    @Override public GraphPath<V, E> getPath(V sink) {
