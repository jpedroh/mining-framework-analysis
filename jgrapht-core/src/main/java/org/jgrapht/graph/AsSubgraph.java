 ...
 * @since Jul 18, 2003
 */
public class AsSubgraph<V extends java.lang.Object, E extends java.lang.Object> extends AbstractGraph<V, E> implements Serializable {
  ...
  /**
     ...
     */
  @Override @Deprecated public EdgeFactory<V, E> getEdgeFactory() {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public Supplier<V> getVertexSupplier() {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public Supplier<E> getEdgeSupplier() {
