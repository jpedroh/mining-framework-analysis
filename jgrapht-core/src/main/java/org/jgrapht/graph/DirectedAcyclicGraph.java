 ...
 * @author Peter Giles
 */
public class DirectedAcyclicGraph<V, E> extends SimpleDirectedGraph<V, E> implements Iterable<V> {
     ...
     */
    @Deprecated
    protected DirectedAcyclicGraph(EdgeFactory<V, E> ef, VisitedStrategyFactory visitedStrategyFactory, TopoOrderMap<V> topoOrderMap, boolean weighted) {
        super(ef, weighted);
     ...
     */
    @Deprecated
    public static <V, E> GraphBuilder<V, E, ? extends DirectedAcyclicGraph<V, E>> createBuilder(EdgeFactory<V, E> ef) {
    ...
    protected interface TopoOrderMap<V> extends Serializable {
         ...
         * 		the vertex
         */
        public abstract void putVertex(Integer index, V vertex);
         ...
         */
        public abstract V getVertex(Integer index);
        ...
        ordering
         */
        public abstract Integer getTopologicalIndex(V vertex);
        ...
        ordering
         */
        public abstract Integer removeVertex(V vertex);
    ...
    protected interface VisitedStrategy {
         ...
         * 		the topological index
         */
        public abstract void setVisited(int index);
         ...
         */
        public abstract boolean getVisited(int index);
         ...
         */
        public abstract void clearVisited(int index) throws UnsupportedOperationException;
    }
    ...
    protected interface VisitedStrategyFactory extends Serializable {
         ...
         */
        public abstract VisitedStrategy getVisitedStrategy(Region affectedRegion);
    }
