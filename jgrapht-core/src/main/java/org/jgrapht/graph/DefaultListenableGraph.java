 ...
 * @since Jul 20, 2003
 */
public class DefaultListenableGraph<V extends java.lang.Object, E extends java.lang.Object> extends GraphDelegator<V, E> implements ListenableGraph<V, E>, Cloneable {
  ...
  protected void fireEdgeAdded(E edge, V source, V target, double weight) {
    GraphEdgeChangeEvent<V, E> e = createGraphEdgeChangeEvent(GraphEdgeChangeEvent.EDGE_ADDED, edge, source, target, weight);
  ...
  protected void fireEdgeRemoved(E edge, V source, V target, double weight) {
    GraphEdgeChangeEvent<V, E> e = createGraphEdgeChangeEvent(GraphEdgeChangeEvent.EDGE_REMOVED, edge, source, target, weight);
    for (GraphListener<V, E> l : graphListeners) {
      l.edgeRemoved(e);
    }
  }
  ...
  protected void fireEdgeWeightUpdated(E edge, V source, V target, double weight) {
    GraphEdgeChangeEvent<V, E> e = createGraphEdgeChangeEvent(GraphEdgeChangeEvent.EDGE_WEIGHT_UPDATED, edge, source, target, weight);
    for (GraphListener<V, E> l : graphListeners) {
  ...
  private static class FlyweightEdgeEvent<VV extends java.lang.Object, EE extends java.lang.Object> extends GraphEdgeChangeEvent<VV, EE> {
  ...
  private static class FlyweightVertexEvent<VV extends java.lang.Object> extends GraphVertexChangeEvent<VV> {
