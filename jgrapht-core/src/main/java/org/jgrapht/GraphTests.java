...
public abstract class GraphTests {
    ...
    while (!unknown.isEmpty()) {
      ...
      for (E e : graph.edgesOf(v)) {
        ...
        if (unknown.contains(n)) {
          ...
          if (odd.contains(v) == odd.contains(n)) {
            return false;
          }
        }
      }
  ...
  /**
     ...
     * @param <E> the graph edge type
     */
  public static <V extends java.lang.Object, E extends java.lang.Object> boolean isBipartitePartition(Graph<V, E> graph, Set<? extends V> firstPartition, Set<? extends V> secondPartition) {
    Objects.requireNonNull(graph, GRAPH_CANNOT_BE_NULL);
