 ...
 */
public class GnmRandomGraphGenerator<V extends java.lang.Object, E extends java.lang.Object> implements GraphGenerator<V, E, V> {
...
>>>>>>> /usr/src/app/output/jgrapht/jgrapht/62628bcbc4bd44eed87539b6e804a189db3e299c/jgrapht-core/src/main/java/org/jgrapht/generate/GnmRandomGraphGenerator.java/right.java
     && !target.getType().isAllowingSelfLoops()) {
...
=======
    multipleEdges
>>>>>>> /usr/src/app/output/jgrapht/jgrapht/62628bcbc4bd44eed87539b6e804a189db3e299c/jgrapht-core/src/main/java/org/jgrapht/generate/GnmRandomGraphGenerator.java/right.java
     && !target.getType().isAllowingMultipleEdges()) {
      throw new IllegalArgumentException("Provided graph does not support multiple edges between the same vertices");
    }
    if (m > computeMaximumAllowedEdges(n, target.getType().isDirected(), loops, multipleEdges)) {
      throw new IllegalArgumentException("number of edges is not valid for the graph type " + "\n-> invalid number of edges=" + m + " for:" + " graph type=" + target.getType() + ", number of vertices=" + n);
    }
  ...
  /**
     ...
     */
  static <V extends java.lang.Object, E extends java.lang.Object> int computeMaximumAllowedEdges(int n, boolean isDirected, boolean createLoops, boolean createMultipleEdges) {
    if (n == 0) {
      return 0;
    }
    int maxAllowedEdges;
