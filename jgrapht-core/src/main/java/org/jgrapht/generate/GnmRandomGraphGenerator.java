...
public class GnmRandomGraphGenerator<V extends java.lang.Object, E extends java.lang.Object> implements GraphGenerator<V, E, V> {
  ...
  @Override public void generateGraph(Graph<V, E> target, Map<String, V> resultMap) {
    ...
    if (m > computeMaximumAllowedEdges(n, target.getType().isDirected(), createLoops, createMultipleEdges)) {
      throw new IllegalArgumentException("number of edges is not valid for the graph type " + "\n-> invalid number of edges=" + m + " for:" + " graph type=" + target.getClass() + ", number of vertices=" + n);
    }
