...
public class WattsStrogatzGraphGenerator<V, E> implements GraphGenerator<V, E, V> {
     ...
     * 		the number of nodes
     * @param k
     * 		connect each node to its k nearest neighbors in a ring
     * @param p
     * 		the probability of re-wiring each edge
     ...
     * @param p
     * 		the probability of re-wiring each edge
     * @param addInsteadOfRewire
     * 		whether to add shortcut edges instead of re-wiring
     * @param rng
