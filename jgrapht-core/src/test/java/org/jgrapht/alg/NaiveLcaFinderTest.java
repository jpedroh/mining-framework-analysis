...
public class NaiveLcaFinderTest {
  private static <V extends java.lang.Object, E extends java.lang.Object> void checkLcas(NaiveLcaFinder<V, E> finder, V a, V b, Collection<V> expectedSet) {
  ...
  @Test public void testNormalCases() {
    ...
    Assert.assertEquals("a", finder.findLca("a", "e"));
  ...
  @Test public void testArrivalOrder() {
    Graph<String, DefaultEdge> g = new DefaultDirectedGraph<>(DefaultEdge.class);
    g.addVertex("a");
    g.addVertex("b");
    g.addVertex("c");
