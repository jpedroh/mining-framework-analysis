...
public class BergeGraphInspectorTest {
  ...
  private void reset() {
    stimulus = new SimpleGraph<>(SupplierUtil.createIntegerSupplier(), SupplierUtil.createIntegerSupplier(), false);
  }
  ...
  private boolean verifyCertificate(GraphPath<Integer, Integer> certificate) {
    ...
    return subg.vertexSet().size() == subg.edgeSet().size() && subg.edgeSet().size() == subg.vertexSet().size() && subg.vertexSet().size() % 2 == 1 && subg.vertexSet().stream().allMatch((t) -> subg.edgesOf(t).size() == 2);
  }
  ...
  @Test public void checkIsYXComplete() {
    reset();
    stimulus.addVertex(1);
    stimulus.addVertex(2);
    stimulus.addVertex(3);
  ...
  @Test public void checkConfigurationType2() {
    reset();
    stimulus.addVertex(1);
    stimulus.addVertex(2);
    stimulus.addVertex(3);
  ...
  @Test public void checkConfigurationType3() {
    reset();
    stimulus.addVertex(1);
    stimulus.addVertex(2);
    stimulus.addVertex(3);
  ...
  @Test public void checkCleanOddHole() {
    reset();
    stimulus.addVertex(1);
    stimulus.addVertex(2);
    stimulus.addVertex(3);
  ...
  @Test public void checkContainsShortestOddHole() {
    reset();
    stimulus.addVertex(1);
    stimulus.addVertex(2);
    stimulus.addVertex(3);
  ...
  @Test public void checkRoutine3() {
    reset();
    stimulus.addVertex(1);
    stimulus.addVertex(2);
    stimulus.addVertex(3);
  ...
  @Test public void checkPetersenGraph() {
    reset();
  ...
  @Test public void checkDodecahedronGraph() {
    reset();
...
<<<<<<< /usr/src/app/output/jgrapht/jgrapht/2d71b99ba5e1de41856a1d1a4f6bbbf3409a907d/jgrapht-core/src/test/java/org/jgrapht/alg/cycle/BergeGraphInspectorTest.java/left.java
  @Test @Category(value = OptionalTests.class) public void checkMöbiusKantorGraph() {
    reset();
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void checkBullGraph() {
    reset();
  ...
  @Test public void checkButterflyGraph() {
    reset();
  ...
  @Test public void checkClawGraph() {
    reset();
  ...
  @Test public void checkGrötzschGraph() {
    reset();
  ...
  @Test public void checkDiamondGraph() {
    reset();
  ...
  @Test @Category(value = SlowTests.class) public void checkFranklinGraph() {
    reset();
  ...
  @Test public void checkFruchtGraph() {
    reset();
  ...
  @Test @Category(value = SlowTests.class) public void checkGoldnerHararyGraph() {
    reset();
  ...
  @Test @Category(value = SlowTests.class) public void checkHeawoodGraph() {
    reset();
  ...
  @Test @Category(value = SlowTests.class) public void checkHerschelGraph() {
    reset();
  ...
  @Test @Category(value = SlowTests.class) public void checkKrackhardtKiteGraph() {
    reset();
  ...
  @Test public void checkMoserSpindleGraph() {
    reset();
...
<<<<<<< /usr/src/app/output/jgrapht/jgrapht/2d71b99ba5e1de41856a1d1a4f6bbbf3409a907d/jgrapht-core/src/test/java/org/jgrapht/alg/cycle/BergeGraphInspectorTest.java/left.java
  @Test @Category(value = OptionalTests.class) public void checkPappusGraph() {
    reset();
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void checkTietzeGraph() {
    reset();
  ...
  @Test public void checkThomsenGraph() {
    reset();
  ...
  @Test public void checkTutteGraph() {
    reset();
  ...
  @Test public void checkEmptyGraph() {
    reset();
...
<<<<<<< /usr/src/app/output/jgrapht/jgrapht/2d71b99ba5e1de41856a1d1a4f6bbbf3409a907d/jgrapht-core/src/test/java/org/jgrapht/alg/cycle/BergeGraphInspectorTest.java/left.java
  @Test @Category(value = OptionalTests.class) public void checkBipartiteGraphs() {
    int repititions = repititionsPerTestCase;
    reset();
    while (repititions-- > 0) {
      int n1 = new Random().nextInt(maximalNumberOfVertices - minimalNumberOfVertices) / 2 + minimalNumberOfVertices / 2, n2 = maximalNumberOfVertices - n1;
...
<<<<<<< /usr/src/app/output/jgrapht/jgrapht/2d71b99ba5e1de41856a1d1a4f6bbbf3409a907d/jgrapht-core/src/test/java/org/jgrapht/alg/cycle/BergeGraphInspectorTest.java/left.java
  @Test @Category(value = OptionalTests.class) public void checkWheelGraphs() {
    int repititions = repititionsPerTestCase;
    while (repititions-- > 0) {
      int numberOfVertices = new Random().nextInt(maximalNumberOfVertices - minimalNumberOfVertices) + minimalNumberOfVertices;
...
<<<<<<< /usr/src/app/output/jgrapht/jgrapht/2d71b99ba5e1de41856a1d1a4f6bbbf3409a907d/jgrapht-core/src/test/java/org/jgrapht/alg/cycle/BergeGraphInspectorTest.java/left.java
  @Test @Category(value = OptionalTests.class) public void checkWindmillGraphs() {
    int repititions = repititionsPerTestCase;
    while (repititions-- > 0) {
      int m = 2;
      int numberOfVertices = new Random().nextInt(maximalNumberOfVertices - 3) + 3;
      reset();
      new WindmillGraphsGenerator<Integer, Integer>(WindmillGraphsGenerator.Mode.WINDMILL, m, numberOfVertices).generateGraph(stimulus);
      assertTrue(dut.isBerge(stimulus));
    }
  }
=======
