...
public class ConnectivityInspectorTest extends TestCase {
  ...
  public void testDirectedGraph() {
    ListenableDirectedGraph<String, DefaultEdge> g = new ListenableDirectedGraph<String, DefaultEdge>(DefaultEdge.class);
    g.addVertex(V1);
    g.addVertex(V2);
    g.addVertex(V3);
    g.addEdge(V1, V2);
  ...
  public void testStronglyConnected1() {
    ...
    g.addEdge(V2, V1);
    g.addEdge(V3, V4);
    StrongConnectivityInspector<String, DefaultEdge> inspector = new StrongConnectivityInspector<String, DefaultEdge>(g);
    ...
    for (DirectedSubgraph<String, DefaultEdge> sg : subgraphs) {
      ...
      StrongConnectivityInspector<String, DefaultEdge> ci = new StrongConnectivityInspector<String, DefaultEdge>(sg);
  ...
  public void testStronglyConnected4() {
    DefaultDirectedGraph<Integer, String> graph = new DefaultDirectedGraph<Integer, String>(new EdgeFactory<Integer, String>() {
    ...
    StrongConnectivityInspector<Integer, String> sc = new StrongConnectivityInspector<Integer, String>(graph);
