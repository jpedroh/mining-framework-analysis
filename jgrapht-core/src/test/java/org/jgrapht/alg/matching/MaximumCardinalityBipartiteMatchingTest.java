...
public abstract class MaximumCardinalityBipartiteMatchingTest {
  public abstract MatchingAlgorithm<Integer, DefaultEdge> getMatchingAlgorithm(Graph<Integer, DefaultEdge> graph, Set<Integer> partition1, Set<Integer> partition2);

  /**
     * Random test graph 1
     */
  @Test public void testBipartiteMatching1() {
    ...
    MatchingAlgorithm<Integer, DefaultEdge> bm = getMatchingAlgorithm(graph, new HashSet<>(partition1), new HashSet<>(partition2));
  ...
  /**
     * Random test graph 2
     */
  @Test public void testBipartiteMatching2() {
    Graph<Integer, DefaultEdge> graph = new SimpleGraph<>(DefaultEdge.class);
  ...
  /**
     ...
     */
  @Test public void testEmptyMatching() {
    Graph<Integer, DefaultEdge> graph = new SimpleGraph<>(DefaultEdge.class);
  ...
  /**
     * Issue 233 instance
     */
  @Test public void testBipartiteMatchingIssue233() {
    ...
    g.addEdge(0, 3);
    g.addEdge(1, 2);
    MatchingAlgorithm.Matching<Integer, DefaultEdge> m = getMatchingAlgorithm(g, left, right).getMatching();
    assertTrue(m.getEdges().contains(g.getEdge(1, 2)));
    assertTrue(m.getEdges().contains(g.getEdge(0, 3)));
    assertEquals(2, m.getEdges().size());
  }

  @Test public void testPseudoGraph() {
  ...
  @Test public void testRandomBipartiteGraphs() {
  ...
  private <V extends java.lang.Object, E extends java.lang.Object> void verifyMatching(Graph<V, E> g, MatchingAlgorithm.Matching<V, E> m, int cardinality) {
    ...
    assertEquals(m.getEdges().size() * 2, matched.size());
