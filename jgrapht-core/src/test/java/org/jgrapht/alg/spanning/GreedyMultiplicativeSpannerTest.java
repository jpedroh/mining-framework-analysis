...
public class GreedyMultiplicativeSpannerTest {
  ...
  private <V extends java.lang.Object, E extends java.lang.Object> void runTest(Graph<V, E> g, int k, Set<E> correct) {
  ...
  @Test public void testGraph1WithMultipleEdges() {
    Graph<String, DefaultEdge> g = new Pseudograph<>(DefaultEdge.class);
    createGraph1(g);
    g.addEdge(V0, V1);
    g.addEdge(V1, V2);
  ...
  @Test public void testGraph3() {
    WeightedPseudograph<String, DefaultWeightedEdge> g = new WeightedPseudograph<>(DefaultWeightedEdge.class);
    createGraph3(g);
  ...
  @Test public void testNegativeWeightsGraph() {
    WeightedPseudograph<String, DefaultWeightedEdge> g = new WeightedPseudograph<>(DefaultWeightedEdge.class);
    g.addVertex(V0);
    g.addVertex(V1);
    g.addVertex(V2);
