...
public class BhandariKDisjointShortestPathsTest extends KDisjointShortestPathsTestCase {
  /**
     ...
     * 
     */
  @Test public void testTwoDisjointPathsNegative() {
    ...
    GraphPath<Integer, DefaultWeightedEdge> expectedP1 = new GraphWalk<>(graph, Arrays.asList(1, 2, 6, 4), -20);
    ...
    GraphPath<Integer, DefaultWeightedEdge> expectedP2 = new GraphWalk<>(graph, Arrays.asList(1, 5, 3, 4), -10);
  ...
  @Override protected <V extends java.lang.Object, E extends java.lang.Object> KShortestPathAlgorithm<V, E> getKShortestPathAlgorithm(Graph<V, E> graph) {
