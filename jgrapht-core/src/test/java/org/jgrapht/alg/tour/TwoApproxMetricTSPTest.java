...
public class TwoApproxMetricTSPTest {
  @Test public void testWikiExampleSymmetric4Cities() {
    ...
    GraphPath<String, DefaultWeightedEdge> tour = new TwoApproxMetricTSP<String, DefaultWeightedEdge>().getTour(g);
  ...
  @Test public void testComplete() {
    ...
    for (int i = 1; i < maxSize; i++) {
      ...
      GraphPath<Object, DefaultEdge> tour = new TwoApproxMetricTSP<Object, DefaultEdge>().getTour(g);
      assertHamiltonian(g, tour);
  ...
  static <V extends java.lang.Object, E extends java.lang.Object> void assertHamiltonian(Graph<V, E> g, GraphPath<V, E> path) {
