 ...
 */
@Category(value = SlowTests.class) public class TwoOptHeuristicTSPTest {
  @Test public void testWikiExampleSymmetric4Cities() {
    ...
    GraphPath<String, DefaultWeightedEdge> tour = new TwoOptHeuristicTSP<String, DefaultWeightedEdge>().getTour(g);
  ...
  @Test public void testComplete() {
    ...
    for (int i = 1; i < maxSize; i++) {
      ...
      GraphPath<Object, DefaultEdge> tour = new TwoOptHeuristicTSP<Object, DefaultEdge>().getTour(g);
      assertHamiltonian(g, tour);
    }
  }
  ...
  @Test(expected = IllegalArgumentException.class) public void testInvalidInstanceDirected() {
    new TwoOptHeuristicTSP<String, DefaultEdge>().getTour(new SimpleDirectedGraph<>(DefaultEdge.class));
  }

  @Test(expected = IllegalArgumentException.class) public void testInvalidInstanceNotComplete() {
    SimpleWeightedGraph<String, DefaultWeightedEdge> g = new SimpleWeightedGraph<>(DefaultWeightedEdge.class);
    g.addVertex("A");
    g.addVertex("B");
    g.addVertex("C");
