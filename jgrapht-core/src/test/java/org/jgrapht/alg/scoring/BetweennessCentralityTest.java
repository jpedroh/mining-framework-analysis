...
public class BetweennessCentralityTest {
  @Test(expected = NullPointerException.class) public void testNullGraph() {
  ...
  @Test public void testEmptyGraphNormalized() {
    Graph<Integer, DefaultEdge> g = new SimpleGraph<>(DefaultEdge.class);
  ...
  @Test public void testSingletonGraph() {
    Graph<Integer, DefaultEdge> g = new SimpleGraph<>(DefaultEdge.class);
    g.addVertex(0);
    VertexScoringAlgorithm<Integer, Double> bc = new BetweennessCentrality<>(g);
    Map<Integer, Double> scores = bc.getScores();
  ...
  @Test public void testSingletonGraphNormalized() {
    Graph<Integer, DefaultEdge> g = new SimpleGraph<>(DefaultEdge.class);
    g.addVertex(0);
    VertexScoringAlgorithm<Integer, Double> bc = new BetweennessCentrality<>(g, true);
    Map<Integer, Double> scores = bc.getScores();
  ...
  @Test public void testK2GraphNormalized() {
    Graph<Integer, DefaultEdge> g = new SimpleGraph<>(DefaultEdge.class);
    g.addVertex(0);
    g.addVertex(1);
    g.addEdge(0, 1);
  ...
  @Test public void testUnweighted1() {
  ...
  @Test public void testAsWeighted1() {
  ...
  @Test public void testUnweighted2() {
  ...
  @Test public void testUnweighted3() {
  ...
  @Test public void testWeighted5() {
  ...
  @Test public void testWeighted6() {
  ...
  @Test(expected = ArithmeticException.class) public void testOverflow() {
    ...
    VertexScoringAlgorithm<Integer, Double> bc = new BetweennessCentrality<>(g, false, OverflowStrategy.THROW_EXCEPTION_ON_OVERFLOW);
    bc.getScores();
  }

  @Test @Category(value = SlowTests.class) public void testIgnoreOverflow() {
    final Graph<Integer, DefaultEdge> g = new SimpleDirectedGraph<>(DefaultEdge.class);
    for (int i = 0; i < 3300; i++) {
      g.addVertex(i);
    }
    ...
    VertexScoringAlgorithm<Integer, Double> bc = new BetweennessCentrality<>(g, false, OverflowStrategy.IGNORE_OVERFLOW);
    Map<Integer, Double> scores = bc.getScores();
