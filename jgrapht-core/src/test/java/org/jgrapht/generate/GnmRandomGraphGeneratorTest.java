 ...
 * @since Aug 6, 2005
 */
public class GnmRandomGraphGeneratorTest extends TestCase {
  ...
  public void testDirectedGraphGnp1() {
    GraphGenerator<Integer, DefaultEdge, Integer> gen = new GnmRandomGraphGenerator<>(6, 18, SEED);
    Graph<Integer, DefaultEdge> g = new DirectedPseudograph<>(DefaultEdge.class);
    gen.generateGraph(g, new IntegerVertexFactory(1), null);
    int[][] edges = { { 6, 5 }, { 1, 6 }, { 5, 6 }, { 3, 4 }, { 6, 4 }, { 2, 1 }, { 3, 5 }, { 1, 2 }, { 1, 3 }, { 2, 5 }, { 4, 3 }, { 2, 3 }, { 5, 4 }, { 1, 4 }, { 2, 6 }, { 6, 1 }, { 4, 6 }, { 3, 1 } };
  ...
  public void testDirectedGraphGnp1WithLoops() {
    GraphGenerator<Integer, DefaultEdge, Integer> gen = new GnmRandomGraphGenerator<>(6, 18, SEED, true, false);
    Graph<Integer, DefaultEdge> g = new DirectedPseudograph<>(DefaultEdge.class);
    gen.generateGraph(g, new IntegerVertexFactory(1), null);
    int[][] edges = { { 6, 5 }, { 3, 3 }, { 1, 6 }, { 5, 6 }, { 3, 4 }, { 6, 4 }, { 2, 1 }, { 3, 5 }, { 1, 2 }, { 1, 3 }, { 2, 5 }, { 4, 3 }, { 2, 3 }, { 2, 2 }, { 5, 4 }, { 2, 2 }, { 1, 4 }, { 5, 5 } };
    assertEquals(6, g.vertexSet().size());
    for (int[] e : edges) {
      assertTrue(g.containsEdge(e[0], e[1]));
    }
  ...
  public void testDirectedGraphGnp1WithMultipleEdges() {
    GraphGenerator<Integer, DefaultEdge, Integer> gen = new GnmRandomGraphGenerator<>(6, 18, SEED, false, true);
    Graph<Integer, DefaultEdge> g = new DirectedPseudograph<>(DefaultEdge.class);
    gen.generateGraph(g, new IntegerVertexFactory(1), null);
    int[][] edges = { { 6, 5 }, { 1, 6 }, { 5, 6 }, { 3, 4 }, { 6, 4 }, { 2, 1 }, { 3, 5 }, { 1, 2 }, { 6, 4 }, { 1, 6 }, { 1, 3 }, { 2, 5 }, { 3, 4 }, { 4, 3 }, { 2, 3 }, { 2, 3 }, { 5, 4 }, { 1, 6 } };
    assertEquals(6, g.vertexSet().size());
    for (int[] e : edges) {
      assertTrue(g.containsEdge(e[0], e[1]));
    }
  ...
  public void testDirectedGraphGnp1WithLoopsAndMultipleEdges() {
    GraphGenerator<Integer, DefaultEdge, Integer> gen = new GnmRandomGraphGenerator<>(6, 18, SEED, true, true);
    Graph<Integer, DefaultEdge> g = new DirectedPseudograph<>(DefaultEdge.class);
    gen.generateGraph(g, new IntegerVertexFactory(1), null);
    int[][] edges = { { 6, 5 }, { 3, 3 }, { 1, 6 }, { 5, 6 }, { 3, 4 }, { 6, 4 }, { 2, 1 }, { 3, 5 }, { 1, 2 }, { 6, 4 }, { 1, 6 }, { 1, 3 }, { 2, 5 }, { 3, 4 }, { 4, 3 }, { 2, 3 }, { 2, 2 }, { 2, 3 } };
    assertEquals(6, g.vertexSet().size());
    for (int[] e : edges) {
      assertTrue(g.containsEdge(e[0], e[1]));
    }
  ...
  public void testUndirectedGraphGnp1() {
    GraphGenerator<Integer, DefaultEdge, Integer> gen = new GnmRandomGraphGenerator<>(6, 15, SEED);
    Graph<Integer, DefaultEdge> g = new Pseudograph<>(DefaultEdge.class);
    gen.generateGraph(g, new IntegerVertexFactory(1), null);
    int[][] edges = { { 6, 5 }, { 1, 6 }, { 3, 4 }, { 6, 4 }, { 2, 1 }, { 3, 5 }, { 1, 3 }, { 2, 5 }, { 2, 3 }, { 5, 4 }, { 1, 4 }, { 2, 6 }, { 5, 1 }, { 4, 2 }, { 6, 3 } };
    assertEquals(6, g.vertexSet().size());
    for (int[] e : edges) {
      assertTrue(g.containsEdge(e[0], e[1]));
    }
  ...
  public void testUndirectedGraphGnp1WithLoops() {
    GraphGenerator<Integer, DefaultEdge, Integer> gen = new GnmRandomGraphGenerator<>(6, 15, SEED, true, false);
    Graph<Integer, DefaultEdge> g = new Pseudograph<>(DefaultEdge.class);
    gen.generateGraph(g, new IntegerVertexFactory(1), null);
    int[][] edges = { { 6, 5 }, { 3, 3 }, { 1, 6 }, { 3, 4 }, { 6, 4 }, { 2, 1 }, { 3, 5 }, { 1, 3 }, { 2, 5 }, { 2, 3 }, { 2, 2 }, { 5, 4 }, { 2, 2 }, { 1, 4 }, { 5, 5 } };
    assertEquals(6, g.vertexSet().size());
    for (int[] e : edges) {
      assertTrue(g.containsEdge(e[0], e[1]));
    }
  ...
  public void testEdgeLimitsDirected() {
    try {
      GraphGenerator<Integer, DefaultEdge, Integer> gen1 = new GnmRandomGraphGenerator<>(5, 21, SEED, false, false);
    ...
    GraphGenerator<Integer, DefaultEdge, Integer> gen2 = new GnmRandomGraphGenerator<>(5, 20, SEED, false, false);
    ...
    GraphGenerator<Integer, DefaultEdge, Integer> gen3 = new GnmRandomGraphGenerator<>(5, 25, SEED, true, false);
    ...
    GraphGenerator<Integer, DefaultEdge, Integer> gen4 = new GnmRandomGraphGenerator<>(5, 25, SEED, false, true);
  ...
  public void testEdgeLimitsUndirected() {
    try {
      GraphGenerator<Integer, DefaultEdge, Integer> gen1 = new GnmRandomGraphGenerator<>(5, 11, SEED, false, false);
      Graph<Integer, DefaultEdge> g1 = new SimpleGraph<>(DefaultEdge.class);
      gen1.generateGraph(g1, new IntegerVertexFactory(), null);
      fail("Exception expected");
    } catch (IllegalArgumentException e) {
    }
    GraphGenerator<Integer, DefaultEdge, Integer> gen2 = new GnmRandomGraphGenerator<>(5, 10, SEED, false, false);
    Graph<Integer, DefaultEdge> g2 = new SimpleGraph<>(DefaultEdge.class);
    gen2.generateGraph(g2, new IntegerVertexFactory(), null);
    GraphGenerator<Integer, DefaultEdge, Integer> gen3 = new GnmRandomGraphGenerator<>(5, 15, SEED, true, false);
    Graph<Integer, DefaultEdge> g3 = new Pseudograph<>(DefaultEdge.class);
    gen3.generateGraph(g3, new IntegerVertexFactory(), null);
    GraphGenerator<Integer, DefaultEdge, Integer> gen4 = new GnmRandomGraphGenerator<>(5, 15, SEED, false, true);
  ...
  public void testCannotGuessGraphType() {
    try {
      GraphGenerator<Integer, DefaultEdge, Integer> gen1 = new GnmRandomGraphGenerator<>(5, 11, SEED, false, false);
      GraphDelegator<Integer, DefaultEdge> g1 = new GraphDelegator<>(new SimpleGraph<>(DefaultEdge.class));
      gen1.generateGraph(g1, new IntegerVertexFactory(), null);
      fail("Exception expected");
    } catch (IllegalArgumentException e) {
    }
    GraphGenerator<Integer, DefaultEdge, Integer> gen2 = new GnmRandomGraphGenerator<>(5, 10, SEED, false, false);
    GraphDelegator<Integer, DefaultEdge> g2 = new GraphDelegator<>(new SimpleGraph<>(DefaultEdge.class));
    gen2.generateGraph(g2, new IntegerVertexFactory(), null);
    try {
      GraphGenerator<Integer, DefaultEdge, Integer> gen3 = new GnmRandomGraphGenerator<>(5, 11, SEED, true, false);
      GraphDelegator<Integer, DefaultEdge> g3 = new GraphDelegator<>(new Pseudograph<>(DefaultEdge.class));
      gen3.generateGraph(g3, new IntegerVertexFactory(), null);
      fail("Exception expected");
    } catch (IllegalArgumentException e) {
    }
    try {
      GraphGenerator<Integer, DefaultEdge, Integer> gen4 = new GnmRandomGraphGenerator<>(5, 11, SEED, false, true);
      GraphDelegator<Integer, DefaultEdge> g4 = new GraphDelegator<>(new Pseudograph<>(DefaultEdge.class));
      gen4.generateGraph(g4, new IntegerVertexFactory(), null);
      fail("Exception expected");
    } catch (IllegalArgumentException e) {
    }
  ...
  public void testGenerateDirectedGraph() {
    ...
    assertTrue(new EdgeTopologyCompare<Integer, DefaultEdge>().compare(graphArray.get(0), graphArray.get(2)));
    assertTrue(new EdgeTopologyCompare<Integer, DefaultEdge>().compare(graphArray.get(1), graphArray.get(3)));
  }
  ...
  public void testBadVertexFactory() {
    GraphGenerator<String, DefaultEdge, String> randomGen = new GnmRandomGraphGenerator<>(10, 3);
  ...
  /**
     ...
     */
  private static void generateGraphs(List<Graph<Integer, DefaultEdge>> graphs, int numOfVertex, int numOfEdges) {
    final int seed = 17;
    GraphGenerator<Integer, DefaultEdge, Integer> randomGen = new GnmRandomGraphGenerator<>(numOfVertex, numOfEdges, seed);
    ...
    GraphGenerator<Integer, DefaultEdge, Integer> newRandomGen = new GnmRandomGraphGenerator<>(numOfVertex, numOfEdges, seed);
  ...
  static class EdgeTopologyCompare<V extends java.lang.Object, E extends java.lang.Object> {
    /**
  ...
  static class VertexOrdering<V extends java.lang.Object, E extends java.lang.Object> {
    /**
    ...
    private static class LabelsEdge {
      ...
      @Override public boolean equals(Object obj) {
        if (this == obj) {
          ...
          if (!(obj instanceof VertexOrdering.LabelsEdge)) {
            return false;
          }
        }
