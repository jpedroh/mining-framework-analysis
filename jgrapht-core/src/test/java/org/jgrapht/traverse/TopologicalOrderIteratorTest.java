...
public class TopologicalOrderIteratorTest {
  ...
  @Test public void testGraphWithPartialOrder() {
    DirectedGraph<String, DefaultEdge> graph = new DefaultDirectedGraph<>(DefaultEdge.class);
    Graphs.addAllVertices(graph, Arrays.asList("v0", "v1", "v2", "v3", "v4", "v5"));
    graph.addEdge("v0", "v1");
    graph.addEdge("v0", "v2");
  ...
  @Test public void testGraphWithParallelEdges() {
    DirectedGraph<String, DefaultEdge> graph = new DirectedPseudograph<>(DefaultEdge.class);
    Graphs.addAllVertices(graph, Arrays.asList("v0", "v1", "v2", "v3", "v4", "v5"));
    graph.addEdge("v0", "v1");
    graph.addEdge("v0", "v1");
    graph.addEdge("v0", "v2");
  ...
  @Test(expected = IllegalArgumentException.class) public void testWithSelfLoops() {
    DirectedGraph<String, DefaultEdge> graph = new DefaultDirectedGraph<>(DefaultEdge.class);
  ...
  @Test(expected = IllegalArgumentException.class) public void testGraphWithCycle() {
    DirectedGraph<String, DefaultEdge> graph = new DirectedPseudograph<>(DefaultEdge.class);
    Graphs.addAllVertices(graph, Arrays.asList("v0", "v1", "v2", "v3", "v4", "v5"));
    graph.addEdge("v0", "v1");
    graph.addEdge("v0", "v1");
  ...
  @Test public void testDisconnected() {
    DirectedGraph<Integer, DefaultEdge> graph = new DirectedPseudograph<>(DefaultEdge.class);
  ...
  @Test(expected = IllegalArgumentException.class) public void testTryToDisableCrossComponent() {
    DirectedGraph<Integer, DefaultEdge> graph = new DirectedPseudograph<>(DefaultEdge.class);
