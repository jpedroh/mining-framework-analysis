...
public class LexBreadthFirstIteratorTest {
  ...
  /**
     ...
     */
  @Test(expected = NoSuchElementException.class) public void testLexicographicalBfsIterator1() {
    Graph<Integer, DefaultEdge> graph = new DefaultUndirectedGraph<>(DefaultEdge.class);
    LexBreadthFirstIterator<Integer, DefaultEdge> iterator = new LexBreadthFirstIterator<>(graph);
  ...
  /**
     ...
     */
  @Test public void testLexicographicalBfsIterator2() {
    Graph<Integer, DefaultEdge> graph = new DefaultUndirectedGraph<>(DefaultEdge.class);
    graph.addVertex(1);
    graph.addVertex(2);
    graph.addVertex(3);
  ...
  /**
     ...
     */
  @Test public void testLexicographicalBfsIterator3() {
  ...
  /**
     ...
     */
  @Test public void testLexicographicalBfsIterator4() {
  ...
  static class MyTraversalListener<V extends java.lang.Object, E extends java.lang.Object> extends TraversalListenerAdapter<V, E> {
