...
public class MaximumCardinalityIteratorTest {
  ...
  @Test public void testEvents() {
    ...
    LexBreadthFirstIteratorTest.MyTraversalListener<String, DefaultEdge> listener = new LexBreadthFirstIteratorTest.MyTraversalListener<>(graph);
  ...
  /**
     ...
     */
  @Test(expected = NoSuchElementException.class) public void testMaximumCardinalityIterator1() {
  ...
  /**
     ...
     */
  @Test public void testMaximumCardinalityIterator2() {
    Graph<String, DefaultEdge> graph = new DefaultUndirectedGraph<>(DefaultEdge.class);
    Graphs.addEdgeWithVertices(graph, "a", "b");
    Graphs.addEdgeWithVertices(graph, "b", "c");
    Graphs.addEdgeWithVertices(graph, "b", "d");
  ...
  /**
     ...
     */
  @Test public void testMaximumCardinalityIterator3() {
    Graph<Integer, DefaultEdge> graph = new DefaultUndirectedGraph<>(DefaultEdge.class);
    graph.addVertex(1);
    graph.addVertex(2);
    graph.addVertex(3);
  ...
  /**
     ...
     */
  @Test public void testMaximumCardinalityIterator4() {
    Graph<String, DefaultEdge> graph = new DefaultUndirectedGraph<>(DefaultEdge.class);
