...
@ApplicationScoped class MetricResolver {
  @Inject private MetricsExtension extension;
  ...
  private static final class DoesHaveMetric<T extends Annotation> implements Of<T> {
    ...
    @Override public T metricAnnotation() {
      return annotation;
    }
  }

  @Vetoed private static final class DoesNotHaveMetric<T extends Annotation> implements Of<T> {
