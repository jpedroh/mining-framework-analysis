...
<<<<<<< /usr/src/app/output/jwtk/jjwt/1e9b969946df0584a8942a189059cee80558a184/impl/src/main/java/io/jsonwebtoken/impl/DefaultJwtParser.java/left.java
                String msg = "The parsed JWT indicates it was signed with the " + algId + " signature " +
                        "algorithm, but the specified verification key of type " + " key may " +
||||||| /usr/src/app/output/jwtk/jjwt/1e9b969946df0584a8942a189059cee80558a184/impl/src/main/java/io/jsonwebtoken/impl/DefaultJwtParser.java/base.java
                String msg = "The parsed JWT indicates it was signed with the " + algName + " signature " +
                    "algorithm, but the specified signing key of type " + " key may " +
=======
                String msg = "The parsed JWT indicates it was signed with the '" + algName + "' signature " +
...
>>>>>>> /usr/src/app/output/jwtk/jjwt/1e9b969946df0584a8942a189059cee80558a184/impl/src/main/java/io/jsonwebtoken/impl/DefaultJwtParser.java/right.java
                        "not be used to verify " + algId + " signatures.  Because the verification " +
