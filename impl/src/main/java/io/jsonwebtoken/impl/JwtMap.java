...
public class JwtMap implements Map<String, Object> {
  ...
  protected final Map<String, Object> redactedValues;
  ...
  @SuppressWarnings(value = { "unchecked" }) protected <T extends java.lang.Object> T idiomaticGet(Field<T> field) {
  ...
  protected <T extends java.lang.Object> Object apply(Field<T> field, Object rawValue) {
  ...
  private String getName() {
    if (this instanceof JweHeader) {
      ...
      if (this instanceof JwsHeader) {
        return "JWS header";
      } else {
        if (this instanceof Header) {
          return "JWT header";
        } else {
          if (this instanceof Jwk || this instanceof JwkContext) {
  ...
  @SuppressWarnings(value = { "EqualsWhichDoesntCheckParameterClass" }) @Override public boolean equals(Object obj) {
