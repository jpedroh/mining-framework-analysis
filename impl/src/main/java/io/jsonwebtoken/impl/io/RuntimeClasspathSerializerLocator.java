...
public class RuntimeClasspathSerializerLocator implements InstanceLocator<Serializer> {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public Serializer<Object> getInstance() {
  ...
  @SuppressWarnings(value = { "WeakerAccess" }) protected Serializer<Object> locate() {
  ...
  @SuppressWarnings(value = { "WeakerAccess" }) protected boolean compareAndSet(Serializer<Object> s) {
