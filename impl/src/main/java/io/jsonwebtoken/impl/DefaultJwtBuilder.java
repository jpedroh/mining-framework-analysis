...
@SuppressWarnings(value = { "unchecked" }) public class DefaultJwtBuilder<T extends JwtBuilder<T>> implements JwtBuilder<T> {
  ...
  @Override public T setProvider(Provider provider) {
    this.provider = provider;
    return (T) this;
  }

  @Override public T setSecureRandom(SecureRandom secureRandom) {
    this.secureRandom = secureRandom;
    return (T) this;
  }

  @SuppressWarnings(value = { "rawtypes" }) protected Function<Map<String, ?>, byte[]> wrap(final Serializer<Map<String, ?>> serializer, String which) {
    Class clazz = "header".equals(which) ? IllegalStateException.class : IllegalArgumentException.class;
    return new PropagatingExceptionFunction<>(clazz, "Unable to serialize " + which + " to JSON.", new Function<Map<String, ?>, byte[]>() {
      @Override public byte[] apply(Map<String, ?> map) {
        return serializer.serialize(map);
      }
    });
  }

  @Override public T serializeToJsonWith(final Serializer<Map<String, ?>> serializer) {
  ...
  @Override public T base64UrlEncodeWith(Encoder<byte[], String> base64UrlEncoder) {
    Assert.notNull(base64UrlEncoder, "base64UrlEncoder cannot be null.");
    this.base64UrlEncoder = base64UrlEncoder;
    return (T) this;
  }

  @Override public T setHeader(Header<?> header) {
    this.header = header;
    return (T) this;
  }

  @Override public T setHeader(Map<String, ?> header) {
    this.header = new DefaultHeader<>(header);
    return (T) this;
  }

  @Override public T setHeaderParams(Map<String, ?> params) {
  ...
  @Override public T setHeaderParam(String name, Object value) {
    ensureHeader().put(name, value);
    return (T) this;
  }

  @Override public T signWith(Key key) throws InvalidKeyException {
    Assert.notNull(key, "Key argument cannot be null.");
    SignatureAlgorithm<Key, ?> alg = (SignatureAlgorithm<Key, ?>) SignatureAlgorithms.forSigningKey(key);
    return signWith(key, alg);
  }

  @Override public <K extends Key> T signWith(K key, final SignatureAlgorithm<K, ?> alg) throws InvalidKeyException {
    Assert.notNull(key, "Key argument cannot be null.");
    Assert.notNull(alg, "SignatureAlgorithm cannot be null.");
    this.key = key;
    this.algorithm = (SignatureAlgorithm<Key, ?>) alg;
    this.signFunction = new PropagatingExceptionFunction<>(SignatureException.class, "Unable to compute " + alg.getId() + " signature.", new Function<SignatureRequest<Key>, byte[]>() {
      @Override public byte[] apply(SignatureRequest<Key> request) {
  ...
  @SuppressWarnings(value = { "deprecation" }) @Override public T signWith(Key key, io.jsonwebtoken.SignatureAlgorithm alg) throws InvalidKeyException {
    Assert.notNull(alg, "SignatureAlgorithm cannot be null.");
    return signWith(key, (SignatureAlgorithm<Key, ?>) SignatureAlgorithmsBridge.forId(alg.getValue()));
  }

  @SuppressWarnings(value = { "deprecation" }) @Override public T signWith(io.jsonwebtoken.SignatureAlgorithm alg, byte[] secretKeyBytes) throws InvalidKeyException {
    Assert.notNull(alg, "SignatureAlgorithm cannot be null.");
  ...
  @SuppressWarnings(value = { "deprecation" }) @Override public T signWith(io.jsonwebtoken.SignatureAlgorithm alg, String base64EncodedSecretKey) throws InvalidKeyException {
  ...
  @SuppressWarnings(value = { "deprecation" }) @Override public T signWith(io.jsonwebtoken.SignatureAlgorithm alg, Key key) {
    return signWith(key, alg);
  }

  @Override public T compressWith(CompressionCodec compressionCodec) {
    Assert.notNull(compressionCodec, "compressionCodec cannot be null");
    this.compressionCodec = compressionCodec;
    return (T) this;
  }

  @Override public T setPayload(String payload) {
  ...
  @Override public T setClaims(Claims claims) {
    this.claims = claims;
    return (T) this;
  }

  @Override public T setClaims(Map<String, ?> claims) {
    this.claims = new DefaultClaims(claims);
    return (T) this;
  }

  @Override public T addClaims(Map<String, ?> claims) {
    ensureClaims().putAll(claims);
    return (T) this;
  }

  @Override public T setIssuer(String iss) {
  ...
  @Override public T setSubject(String sub) {
  ...
  @Override public T setAudience(String aud) {
  ...
  @Override public T setExpiration(Date exp) {
    if (exp != null) {
  ...
  @Override public T setNotBefore(Date nbf) {
    if (nbf != null) {
  ...
  @Override public T setIssuedAt(Date iat) {
    if (iat != null) {
  ...
  @Override public T setId(String jti) {
  ...
  @Override public T claim(String name, Object value) {
  ...
  @Override public String compact() {
    ...
    Assert.state(algorithm != null, "algorithm instance should never be null.");
...
public class DefaultJwtBuilder implements JwtBuilder {
  ...
  @Override public JwtBuilder serializeToJsonWith(Serializer<Map<String, ?>> serializer) {
    Assert.notNull(serializer, "Serializer cannot be null.");
    this.serializer = serializer;
    return this;
  }

  @Override public JwtBuilder base64UrlEncodeWith(Encoder<byte[], String> base64UrlEncoder) {
    Assert.notNull(base64UrlEncoder, "base64UrlEncoder cannot be null.");
    this.base64UrlEncoder = base64UrlEncoder;
    return this;
  }

  @Override public JwtBuilder setHeader(Header header) {
    this.header = header;
    return this;
  }

  @Override public JwtBuilder setHeader(Map<String, Object> header) {
    this.header = new DefaultHeader(header);
    return this;
  }

  @Override public JwtBuilder setHeaderParams(Map<String, Object> params) {
    if (!Collections.isEmpty(params)) {
      Header header = ensureHeader();
  ...
  @Override public JwtBuilder setHeaderParam(String name, Object value) {
    ensureHeader().put(name, value);
    return this;
  }

  @Override public JwtBuilder signWith(Key key) throws InvalidKeyException {
    Assert.notNull(key, "Key argument cannot be null.");
    SignatureAlgorithm alg = SignatureAlgorithm.forSigningKey(key);
    return signWith(key, alg);
  }

  @Override public JwtBuilder signWith(Key key, SignatureAlgorithm alg) throws InvalidKeyException {
    Assert.notNull(key, "Key argument cannot be null.");
    Assert.notNull(alg, "SignatureAlgorithm cannot be null.");
    alg.assertValidSigningKey(key);
    createSigner(alg, key);
    this.algorithm = alg;
    this.key = key;
    return this;
  }

  @Override public JwtBuilder signWith(SignatureAlgorithm alg, byte[] secretKeyBytes) throws InvalidKeyException {
    Assert.notNull(alg, "SignatureAlgorithm cannot be null.");
    Assert.notEmpty(secretKeyBytes, "secret key byte array cannot be null or empty.");
    Assert.isTrue(alg.isHmac(), "Key bytes may only be specified for HMAC signatures.  If using RSA or Elliptic Curve, use the signWith(SignatureAlgorithm, Key) method instead.");
    SecretKey key = new SecretKeySpec(secretKeyBytes, alg.getJcaName());
  ...
  @Override public JwtBuilder signWith(SignatureAlgorithm alg, String base64EncodedSecretKey) throws InvalidKeyException {
    Assert.hasText(base64EncodedSecretKey, "base64-encoded secret key cannot be null or empty.");
    Assert.isTrue(alg.isHmac(), "Base64-encoded key bytes may only be specified for HMAC signatures.  If using RSA or Elliptic Curve, use the signWith(SignatureAlgorithm, Key) method instead.");
    byte[] bytes = Decoders.BASE64.decode(base64EncodedSecretKey);
    return signWith(alg, bytes);
  ...
  @Override public JwtBuilder signWith(SignatureAlgorithm alg, Key key) {
    return signWith(key, alg);
  }

  @Override public JwtBuilder compressWith(CompressionCodec compressionCodec) {
    Assert.notNull(compressionCodec, "compressionCodec cannot be null");
    this.compressionCodec = compressionCodec;
    return this;
  }

  @Override public JwtBuilder setPayload(String payload) {
    this.payload = payload;
    return this;
  }
  ...
  @Override public JwtBuilder setClaims(Claims claims) {
    this.claims = claims;
    return this;
  }

  @Override public JwtBuilder setClaims(Map<String, ?> claims) {
    this.claims = new DefaultClaims(claims);
    return this;
  }

  @Override public JwtBuilder addClaims(Map<String, Object> claims) {
    ensureClaims().putAll(claims);
    return this;
  }

  @Override public JwtBuilder setIssuer(String iss) {
    if (Strings.hasText(iss)) {
      ensureClaims().setIssuer(iss);
    } else {
      if (this.claims != null) {
  ...
  @Override public JwtBuilder setSubject(String sub) {
    if (Strings.hasText(sub)) {
      ensureClaims().setSubject(sub);
    } else {
      if (this.claims != null) {
  ...
  @Override public JwtBuilder setAudience(String aud) {
    if (Strings.hasText(aud)) {
      ensureClaims().setAudience(aud);
    } else {
      if (this.claims != null) {
  ...
  @Override public JwtBuilder setExpiration(Date exp) {
    if (exp != null) {
      ensureClaims().setExpiration(exp);
    } else {
      if (this.claims != null) {
  ...
  @Override public JwtBuilder setNotBefore(Date nbf) {
    if (nbf != null) {
      ensureClaims().setNotBefore(nbf);
    } else {
      if (this.claims != null) {
  ...
  @Override public JwtBuilder setIssuedAt(Date iat) {
    if (iat != null) {
      ensureClaims().setIssuedAt(iat);
    } else {
      if (this.claims != null) {
  ...
  @Override public JwtBuilder setId(String jti) {
    if (Strings.hasText(jti)) {
      ensureClaims().setId(jti);
    } else {
      if (this.claims != null) {
  ...
  @Override public JwtBuilder claim(String name, Object value) {
    Assert.hasText(name, "Claim property name cannot be null or empty.");
    if (this.claims == null) {
      if (value != null) {
        ensureClaims().put(name, value);
  ...
  @SuppressWarnings(value = { "unchecked" }) @Deprecated protected byte[] toJson(Object object) throws SerializationException {
