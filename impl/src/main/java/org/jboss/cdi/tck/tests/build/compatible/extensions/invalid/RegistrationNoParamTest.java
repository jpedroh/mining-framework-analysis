...
@SpecVersion(spec = "cdi", version = "4.0") public class RegistrationNoParamTest extends AbstractInvalidExtensionParamTest {
  ...
  @Test @SpecAssertion(section = Sections.REGISTRATION_PHASE, id = "aa", note = "Fail due to no parameter ext method") public void shouldFail() {
  }
}