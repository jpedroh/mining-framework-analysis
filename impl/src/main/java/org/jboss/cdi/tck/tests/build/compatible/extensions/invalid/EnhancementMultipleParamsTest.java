...
@SpecVersion(spec = "cdi", version = "4.0") public class EnhancementMultipleParamsTest extends AbstractInvalidExtensionParamTest {
  ...
  @Test @SpecAssertion(section = Sections.ENHANCEMENT_PHASE, id = "ab", note = "Fail due to more than one parameter ext method") public void shouldFail() {
  }
}