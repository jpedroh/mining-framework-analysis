...
@SpecVersion(spec = "cdi", version = "4.0") public class RegistrationOnlyMessagesTest extends AbstractInvalidExtensionParamTest {
  ...
  @Test @SpecAssertion(section = Sections.REGISTRATION_PHASE, id = "aa", note = "Fail due to no required parameter ext method") public void shouldFail() {
  }
}