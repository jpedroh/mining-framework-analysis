...
@SpecVersion(spec = "cdi", version = "4.0") public class EnhancementNoParamTest extends AbstractInvalidExtensionParamTest {
  ...
  @Test @SpecAssertion(section = Sections.ENHANCEMENT_PHASE, id = "aa", note = "Fail due to no parameter ext method") public void shouldFail() {
  }
}