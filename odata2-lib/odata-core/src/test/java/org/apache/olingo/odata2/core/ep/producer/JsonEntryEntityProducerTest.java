...
public class JsonEntryEntityProducerTest extends BaseTest {
  ...
  protected static final EntityProviderWriteProperties DEFAULT_PROPERTIES = EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).build();

  @Test public void entry() throws Exception {
    ...
    assertEquals("{\"d\":{\"__metadata\":{\"id\":\"" + BASE_URI + "Teams(\'1\')\"," + "\"uri\":\"" + BASE_URI + "Teams(\'1\')\",\"type\":\"RefScenario.Team\"}," + "\"Id\":\"1\",\"Name\":null,\"isScrumTeam\":true," + "\"nt_Employees\":{\"__deferred\":{\"uri\":\"" + BASE_URI + "Teams(\'1\')/nt_Employees\"}}}}", json);
  }

  @SuppressWarnings(value = { "unchecked" }) @Test public void omitETagTestPropertyPresent() throws Exception {
    final EntityProviderWriteProperties properties = EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).omitETag(true).omitJsonWrapper(true).build();
    ...
    final ODataResponse response = new JsonEntityProvider().writeEntry(MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Rooms"), localRoomData, properties);
    Map<String, Object> room = (Map<String, Object>) new Gson().fromJson(new InputStreamReader((InputStream) response.getEntity()), Map.class);
    room = (Map<String, Object>) room.get("__metadata");
    assertFalse(room.containsKey("etag"));
  }

  @SuppressWarnings(value = { "unchecked" }) @Test public void omitETagTestPropertyNOTPresentMustNotResultInException() throws Exception {
    final EntityProviderWriteProperties properties = EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).omitETag(true).omitJsonWrapper(true).build();
    Map<String, Object> localRoomData = new HashMap<String, Object>();
    localRoomData.put("Id", "1");
    localRoomData.put("Name", "Neu Schwanstein");
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void omitETagTestNonNullablePropertyNOTPresentMustNotResultInException() throws Exception {
    ...
    ExpandSelectTreeNode selectNode = ExpandSelectTreeNode.entitySet(entitySet).selectedProperties(selectedPropertyNames).build();
    final EntityProviderWriteProperties properties = EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).omitETag(true).omitJsonWrapper(true).expandSelectTree(selectNode).build();
    Map<String, Object> localRoomData = new HashMap<String, Object>();
    localRoomData.put("Id", "1");
    localRoomData.put("Name", "Neu Schwanstein");
    localRoomData.put("Seats", new Integer(20));
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void contentOnly() throws Exception {
    ...
    EntityProviderWriteProperties properties = EntityProviderWriteProperties.fromProperties(DEFAULT_PROPERTIES).omitJsonWrapper(true).contentOnly(true).build();
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, employeeData, properties);
    Map<String, Object> employee = (Map<String, Object>) new Gson().fromJson(new InputStreamReader((InputStream) response.getEntity()), Map.class);
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void contentOnlyWithoutKey() throws Exception {
    HashMap<String, Object> employeeData = new HashMap<String, Object>();
    employeeData.put("ManagerId", "1");
    employeeData.put("Age", new Integer(52));
    employeeData.put("RoomId", "1");
    ...
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Employees");
    ExpandSelectTreeNode expandSelectTreeNode = ExpandSelectTreeNode.entitySet(entitySet).selectedProperties(selectedProperties).build();
    EntityProviderWriteProperties properties = EntityProviderWriteProperties.fromProperties(DEFAULT_PROPERTIES).omitJsonWrapper(true).contentOnly(true).expandSelectTree(expandSelectTreeNode).build();
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, employeeData, properties);
    Map<String, Object> employee = (Map<String, Object>) new Gson().fromJson(new InputStreamReader((InputStream) response.getEntity()), Map.class);
    assertNull(employee.get("__metadata"));
    assertNull(employee.get("ne_Manager"));
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void contentOnlySelectedOrExpandedLinksMustBeIgnored() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Employees");
    HashMap<String, Object> employeeData = new HashMap<String, Object>();
    employeeData.put("ManagerId", "1");
    List<String> selectedProperties = new ArrayList<String>();
    ...
    ExpandSelectTreeNode expandSelectTreeNode = ExpandSelectTreeNode.entitySet(entitySet).selectedProperties(selectedProperties).expandedLinks(expandedLinks).build();
    EntityProviderWriteProperties properties = EntityProviderWriteProperties.fromProperties(DEFAULT_PROPERTIES).omitJsonWrapper(true).contentOnly(true).expandSelectTree(expandSelectTreeNode).build();
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, employeeData, properties);
    Map<String, Object> employee = (Map<String, Object>) new Gson().fromJson(new InputStreamReader((InputStream) response.getEntity()), Map.class);
    assertNull(employee.get("__metadata"));
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void contentOnlyWithAdditinalLink() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Employees");
    HashMap<String, Object> employeeData = new HashMap<String, Object>();
    employeeData.put("ManagerId", "1");
    List<String> selectedProperties = new ArrayList<String>();
    ...
    EntityProviderWriteProperties properties = EntityProviderWriteProperties.fromProperties(DEFAULT_PROPERTIES).omitJsonWrapper(true).contentOnly(true).expandSelectTree(expandSelectTreeNode).additionalLinks(additinalLinks).build();
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, employeeData, properties);
    Map<String, Object> employee = (Map<String, Object>) new Gson().fromJson(new InputStreamReader((InputStream) response.getEntity()), Map.class);
    assertNull(employee.get("__metadata"));
    assertNull(employee.get("ne_Team"));
  ...
  @Test public void omitJsonWrapper() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Teams");
    Map<String, Object> teamData = new HashMap<String, Object>();
    teamData.put("Id", "1");
    teamData.put("isScrumTeam", true);
    EntityProviderWriteProperties properties = EntityProviderWriteProperties.fromProperties(DEFAULT_PROPERTIES).omitJsonWrapper(true).build();
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, teamData, properties);
    final String json = verifyResponse(response);
    assertEquals("{\"__metadata\":{\"id\":\"" + BASE_URI + "Teams(\'1\')\"," + "\"uri\":\"" + BASE_URI + "Teams(\'1\')\",\"type\":\"RefScenario.Team\"}," + "\"Id\":\"1\",\"Name\":null,\"isScrumTeam\":true," + "\"nt_Employees\":{\"__deferred\":{\"uri\":\"" + BASE_URI + "Teams(\'1\')/nt_Employees\"}}}", json);
  }

  @Test(expected = EdmSimpleTypeException.class) public void serializeWithFacetsValidation() throws Throwable {
    ...
    EntityProviderWriteProperties properties = EntityProviderWriteProperties.fromProperties(DEFAULT_PROPERTIES).validatingFacets(true).build();
    try {
  ...
  @Test public void serializeWithoutFacetsValidation() throws Exception {
    Edm edm = MockFacade.getMockEdm();
    EdmTyped roomNameProperty = edm.getEntityType("RefScenario", "Room").getProperty("Name");
    EdmFacets facets = mock(EdmFacets.class);
    when(facets.getMaxLength()).thenReturn(3);
    ...
    roomData.put("Id", "4711");
    roomData.put("Name", name);
    EntityProviderWriteProperties properties = EntityProviderWriteProperties.fromProperties(DEFAULT_PROPERTIES).validatingFacets(false).build();
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, roomData, properties);
    final String json = verifyResponse(response);
    assertNotNull(response);
    assertEquals("{\"d\":{\"__metadata\":{\"id\":\"http://host:80/service/Rooms(\'4711\')\"," + "\"uri\":\"http://host:80/service/Rooms(\'4711\')\",\"type\":\"RefScenario.Room\"}," + "\"Id\":\"4711\",\"Name\":\"1234567890\",\"Seats\":null,\"Version\":null," + "\"nr_Employees\":{\"__deferred\":{\"uri\":\"http://host:80/service/Rooms(\'4711\')/nr_Employees\"}}," + "\"nr_Building\":{\"__deferred\":{\"uri\":\"http://host:80/service/Rooms(\'4711\')/nr_Building\"}}}}", json);
  }

  @Test(expected = EntityProviderException.class) public void entryWithNullData() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Teams");
    new JsonEntityProvider().writeEntry(entitySet, null, DEFAULT_PROPERTIES);
  }

  @Test(expected = EntityProviderException.class) public void entryWithEmptyData() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Teams");
    new JsonEntityProvider().writeEntry(entitySet, new HashMap<String, Object>(), DEFAULT_PROPERTIES);
  }

  @Test public void entryWithSelect() throws Exception {
    ...
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, buildingData, EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).expandSelectTree(node).build());
    final String json = verifyResponse(response);
    assertEquals("{\"d\":{\"__metadata\":{\"id\":\"" + BASE_URI + "Buildings(\'1\')\"," + "\"uri\":\"" + BASE_URI + "Buildings(\'1\')\",\"type\":\"RefScenario.Building\"}," + "\"nb_Rooms\":{\"__deferred\":{\"uri\":\"" + BASE_URI + "Buildings(\'1\')/nb_Rooms\"}}}}", json);
  }

  @Test public void mediaLinkEntry() throws Exception {
    ...
    final String json = verifyResponse(response);
    assertEquals("{\"d\":{\"__metadata\":{" + "\"id\":\"" + BASE_URI + "Container2.Photos(Id=1,Type=\'image%2Fpng\')\"," + "\"uri\":\"" + BASE_URI + "Container2.Photos(Id=1,Type=\'image%2Fpng\')\"," + "\"type\":\"RefScenario2.Photo\",\"etag\":\"W/\\\"1\\\"\",\"content_type\":\"image/png\"," + "\"media_src\":\"" + BASE_URI + "Container2.Photos(Id=1,Type=\'image%2Fpng\')/$value\"," + "\"edit_media\":\"" + BASE_URI + "Container2.Photos(Id=1,Type=\'image%2Fpng\')/$value\"}," + "\"Id\":1,\"Name\":null,\"Type\":\"image/png\",\"Image\":null," + "\"BinaryData\":\"/wABAg==\",\"\u0421\u043e\u0434\u0435\u0440\u0436\u0430\u043d\u0438\u0435\":null,\"CustomProperty\":null}}", json);
  }

  @Test public void mediaLinkEntryWithSelect() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Employees");
    ...
    EntityProviderWriteProperties writeProperties = EntityProviderWriteProperties.fromProperties(DEFAULT_PROPERTIES).serviceRoot(URI.create(BASE_URI)).expandSelectTree(node).build();
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, employeeData, writeProperties);
    final String json = verifyResponse(response);
    assertEquals("{\"d\":{\"__metadata\":{" + "\"id\":\"" + BASE_URI + "Employees(\'1\')\"," + "\"uri\":\"" + BASE_URI + "Employees(\'1\')\"," + "\"type\":\"RefScenario.Employee\",\"content_type\":\"image/jpeg\"," + "\"media_src\":\"" + BASE_URI + "Employees(\'1\')/$value\"," + "\"edit_media\":\"" + BASE_URI + "Employees(\'1\')/$value\"}," + "\"EntryDate\":\"\\/Date(0)\\/\"}}", json);
  }

  @SuppressWarnings(value = { "unchecked" }) @Test public void entryWithExpandedEntryButNullData() throws Exception {
    ...
    class EntryCallback implements OnWriteEntryContent {
      @Override public WriteEntryCallbackResult retrieveEntryResult(final WriteEntryCallbackContext context) throws ODataApplicationException {
    ...
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, roomData, EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).expandSelectTree(node1).callbacks(callbacks).build());
    assertNotNull(response);
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void entryWithExpandedEntryButEmptyData() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Rooms");
    Map<String, Object> roomData = new HashMap<String, Object>();
    roomData.put("Id", "1");
    roomData.put("Version", 1);
    ...
    Map<String, ODataCallback> callbacks = new HashMap<String, ODataCallback>();
    callbacks.put("nr_Building", callback);
    ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, roomData, EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).expandSelectTree(node1).callbacks(callbacks).build());
    assertNotNull(response);
    assertNotNull(response.getEntity());
    assertNull("EntitypProvider must not set content header", response.getContentHeader());
    Map<String, Object> roomEntry = new Gson().fromJson(new InputStreamReader((InputStream) response.getEntity()), Map.class);
  ...
  @Test public void entryWithExpandedEntry() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Rooms");
    Map<String, Object> roomData = new HashMap<String, Object>();
    roomData.put("Id", "1");
    roomData.put("Version", 1);
  ...
  @Test(expected = EntityProviderException.class) public void entryWithExpandedEntryWithFacets() throws Exception {
    Edm edm = MockFacade.getMockEdm();
  ...
  @Test public void entryWithExpandedEntryIgnoreFacets() throws Exception {
    Edm edm = MockFacade.getMockEdm();
    EdmTyped imageUrlProperty = edm.getEntityType("RefScenario", "Employee").getProperty("ImageUrl");
    EdmFacets facets = mock(EdmFacets.class);
    when(facets.getMaxLength()).thenReturn(1);
    ...
    class EntryCallback implements OnWriteFeedContent {
      @Override public WriteFeedCallbackResult retrieveFeedResult(final WriteFeedCallbackContext context) throws ODataApplicationException {
        ...
        result.setFeedData(Collections.singletonList(data));
        result.setInlineProperties(DEFAULT_PROPERTIES);
        EntityProviderWriteProperties properties = EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).validatingFacets(context.getCurrentWriteProperties().isValidatingFacets()).build();
  ...
  @Test public void entryWithExpandedEntryButNoRegisteredCallback() throws Exception {
    ...
    ExpandSelectTreeNode node1 = Mockito.mock(ExpandSelectTreeNode.class);
    Mockito.when(node1.getLinks()).thenReturn(links);
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, roomData, EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).expandSelectTree(node1).build());
    final String json = verifyResponse(response);
    assertEquals("{\"d\":{\"__metadata\":{\"id\":\"" + BASE_URI + "Rooms(\'1\')\"," + "\"uri\":\"" + BASE_URI + "Rooms(\'1\')\",\"type\":\"RefScenario.Room\",\"etag\":\"W/\\\"1\\\"\"}," + "\"nr_Building\":{\"__deferred\":{\"uri\":\"" + BASE_URI + "Rooms(\'1\')/nr_Building\"}}}}", json);
  }

  @Test(expected = EntityProviderException.class) public void entryWithExpandedEntryWithRegisteredNullCallback() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Rooms");
    Map<String, Object> roomData = new HashMap<String, Object>();
    roomData.put("Id", "1");
    roomData.put("Version", 1);
    ...
    new JsonEntityProvider().writeEntry(entitySet, roomData, EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).expandSelectTree(node1).callbacks(callbacks).build());
  }

  @Test public void entryWithExpandedFeed() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Buildings");
    Map<String, Object> buildingData = new HashMap<String, Object>();
    buildingData.put("Id", "1");
    ExpandSelectTreeNode node2 = Mockito.mock(ExpandSelectTreeNode.class);
    ...
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, buildingData, EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).expandSelectTree(node1).callbacks(callbacks).build());
    final String json = verifyResponse(response);
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void entryWithExpandedFeedButNullData() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Buildings");
    Map<String, Object> buildingData = new HashMap<String, Object>();
    buildingData.put("Id", "1");
    ExpandSelectTreeNode node2 = Mockito.mock(ExpandSelectTreeNode.class);
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void entryWithExpandedFeedButEmptyData() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Buildings");
    Map<String, Object> buildingData = new HashMap<String, Object>();
    buildingData.put("Id", "1");
    ExpandSelectTreeNode node2 = Mockito.mock(ExpandSelectTreeNode.class);
  ...
  @Test public void entryWithExpandedFeedButNoRegisteredCallback() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Buildings");
    Map<String, Object> buildingData = new HashMap<String, Object>();
    buildingData.put("Id", "1");
    ExpandSelectTreeNode node2 = Mockito.mock(ExpandSelectTreeNode.class);
    ...
    ExpandSelectTreeNode node1 = Mockito.mock(ExpandSelectTreeNode.class);
    Mockito.when(node1.getLinks()).thenReturn(links);
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, buildingData, EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).expandSelectTree(node1).build());
    final String json = verifyResponse(response);
    assertEquals("{\"d\":{\"__metadata\":{\"id\":\"" + BASE_URI + "Buildings(\'1\')\"," + "\"uri\":\"" + BASE_URI + "Buildings(\'1\')\",\"type\":\"RefScenario.Building\"}," + "\"nb_Rooms\":{\"__deferred\":{\"uri\":\"" + BASE_URI + "Buildings(\'1\')/nb_Rooms\"}}}}", json);
  }

  @Test(expected = EntityProviderException.class) public void entryWithExpandedFeedWithRegisteredNullCallback() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Buildings");
    Map<String, Object> buildingData = new HashMap<String, Object>();
    buildingData.put("Id", "1");
    ExpandSelectTreeNode node2 = Mockito.mock(ExpandSelectTreeNode.class);
    ...
    new JsonEntityProvider().writeEntry(entitySet, buildingData, EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).expandSelectTree(node1).callbacks(callbacks).build());
  }

  @SuppressWarnings(value = { "unchecked" }) @Test public void serializeWithCustomSrcAttributeOnEmployee() throws Exception {
    Map<String, Object> employeeData = new HashMap<String, Object>();
    Calendar date = Calendar.getInstance(TimeZone.getTimeZone("GMT"));
    date.clear();
    date.set(1999, 0, 1);
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void serializeWithCustomSrcAndTypeAttributeOnEmployee() throws Exception {
    Map<String, Object> employeeData = new HashMap<String, Object>();
    Calendar date = Calendar.getInstance(TimeZone.getTimeZone("GMT"));
    date.clear();
    date.set(1999, 0, 1);
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void serializeWithCustomSrcAttributeOnRoom() throws Exception {
    Map<String, Object> roomData = new HashMap<String, Object>();
    roomData.put("Id", "1");
    roomData.put("Name", "Neu Schwanstein");
    roomData.put("Seats", new Integer(20));
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void serializeWithCustomSrcAndTypeAttributeOnRoom() throws Exception {
    Map<String, Object> roomData = new HashMap<String, Object>();
    roomData.put("Id", "1");
    roomData.put("Name", "Neu Schwanstein");
    roomData.put("Seats", new Integer(20));
  ...
  @Test public void additionalLink() throws Exception {
    final EdmEntitySet entitySet = MockFacade.getMockEdm().getDefaultEntityContainer().getEntitySet("Rooms");
    Map<String, Object> data = new HashMap<String, Object>();
    data.put("Id", "1");
    ...
    final EntityProviderWriteProperties properties = EntityProviderWriteProperties.serviceRoot(URI.create(BASE_URI)).additionalLinks(links).build();
    final ODataResponse response = new JsonEntityProvider().writeEntry(entitySet, data, properties);
    final String json = verifyResponse(response);
    assertEquals("{\"d\":{\"__metadata\":{\"id\":\"" + BASE_URI + "Rooms(\'1\')\"," + "\"uri\":\"" + BASE_URI + "Rooms(\'1\')\",\"type\":\"RefScenario.Room\"}," + "\"Id\":\"1\",\"Name\":null,\"Seats\":null,\"Version\":null," + "\"nr_Employees\":{\"__deferred\":{\"uri\":\"" + BASE_URI + "Rooms(\'1\')/nr_Employees\"}}," + "\"nr_Building\":{\"__deferred\":{\"uri\":\"" + BASE_URI + "Buildings(\'3\')\"}}}}", json);
  }
