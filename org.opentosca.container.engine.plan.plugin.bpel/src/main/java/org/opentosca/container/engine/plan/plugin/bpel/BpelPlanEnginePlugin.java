...
@NonNullByDefault @Service public class BpelPlanEnginePlugin implements IPlanEnginePlanRefPluginService {
  ...
  public boolean deployPlanFile(final Path planLocation, final CsarId csarId, final QName planId, Map<String, String> endpointMetadata) {
    ...
    if (processId != null && endpointUri != null && portType != null && this.endpointService != null) {
      ...
      final Endpoint endpoint = new Endpoint(endpointUri, localContainer, localContainer, csarId, null, endpointMetadata, portType, null, null, planId);
      ...
      if (Objects.nonNull(callbackEndpoint)) {
        ...
        this.endpointService.storeEndpoint(new Endpoint(callbackEndpoint, localContainer, localContainer, csarId, null, endpointMetadata, callbackPortType, null, null, planId));
      }
    } else {
