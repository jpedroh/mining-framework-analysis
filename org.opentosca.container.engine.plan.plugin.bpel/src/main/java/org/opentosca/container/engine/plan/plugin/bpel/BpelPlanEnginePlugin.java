 ...
 */
@NonNullByDefault @Service public class BpelPlanEnginePlugin implements IPlanEnginePlanRefPluginService {
  ...
  @Inject public BpelPlanEnginePlugin(ICoreEndpointService endpointService, CsarStorageService storage) {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public String getLanguageUsed() {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public List<String> getCapabilties() {
  ...
  public boolean deployPlanFile(final Path planLocation, final CsarId csarId, final QName planId, Map<String, String> endpointMetadata) {
    ...
    try {
      ...
      planContents = FileSystem.unzip(planLocation, tempDir).parallelStream().map(Path::toFile).collect(Collectors.toList());
    } catch (IOException e) {
    ...
    try {
      ...
      if (!odeUpdater.changeEndpoints(planContents, csarId)) {
        LOG.error("Not all endpoints used by the plan {} have been changed", planLocation);
      }
...
<<<<<<< /usr/src/app/output/opentosca/container/6b594e8970fa00400d0566a726502e3a846316e5/org.opentosca.container.engine.plan.plugin.bpel/src/main/java/org/opentosca/container/engine/plan/plugin/bpel/BpelPlanEnginePlugin.java/left.java
      endpoint = new Endpoint(endpointUri, localContainer, localContainer, csarId, null, endpointMetadata, portType, null, null, planId)
=======
      wsdlEndpoint = new WSDLEndpoint(endpoint, portType, localContainer, localContainer, csarId, null, planId, null, null, invokeEndpointMetaData)
...
<<<<<<< /usr/src/app/output/opentosca/container/6b594e8970fa00400d0566a726502e3a846316e5/org.opentosca.container.engine.plan.plugin.bpel/src/main/java/org/opentosca/container/engine/plan/plugin/bpel/BpelPlanEnginePlugin.java/left.java
        storeEndpoint(new Endpoint(callbackEndpoint, localContainer, localContainer, csarId, null, endpointMetadata, callbackPortType, null, null, planId))
=======
        storeWSDLEndpoint(new WSDLEndpoint(callbackEndpoint, callbackPortType, localContainer, localContainer, csarId, null, planId, null, null, callbackEndpointMetaData))
>>>>>>> /usr/src/app/output/opentosca/container/6b594e8970fa00400d0566a726502e3a846316e5/org.opentosca.container.engine.plan.plugin.bpel/src/main/java/org/opentosca/container/engine/plan/plugin/bpel/BpelPlanEnginePlugin.java/right.java
        ;
      }
    } else {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public boolean deployPlanReference(final QName planId, final PlanModelReference planRef, final CsarId csarId) {
    if (storage == null) {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public boolean undeployPlanReference(final QName planId, final PlanModelReference planRef, final CsarId csarId) {
    Path planLocation = planLocationOnDisk(csarId, planId, planRef);
    if (planLocation == null) {
      return false;
    }
    ...
    if (this.endpointService != null) {
      ...
      if (endpoints.isEmpty()) {
        LOG.warn("Couldn\'t remove endpoint for plan {}, because endpoint service didn\'t find any endpoint associated with the plan to remove", planRef.getReference());
      } else {
        for (Endpoint endpoint : endpoints) {
          this.endpointService.removeEndpoint(endpoint);
          LOG.debug("Removed endpoint {} for plan {}", endpoint.toString(), planRef.getReference());
        }
      }
    } else {
      LOG.warn("Couldn\'t remove endpoint for plan {}, cause endpoint service is not available", planRef.getReference());
    }
    if (wasUndeployed) {
  ...
  @Nullable private Path planLocationOnDisk(CsarId csarId, QName planId, PlanModelReference planRef) {
