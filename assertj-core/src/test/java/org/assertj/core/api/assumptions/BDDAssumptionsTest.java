...
class BDDAssumptionsTest {
  @Nested class BDDAssumptions_given_boolean_primitive_Test {
  ...
  @Nested class BDDAssumptions_given_Boolean_Test {
    private final Boolean actual = true;
  ...
  @Nested class BDDAssumptions_given_boolean_array_Test {
  ...
  @Nested class BDDAssumptions_given_byte_primitive_Test {
  ...
  @Nested class BDDAssumptions_given_Byte_Test {
    private final Byte actual = (byte) 1;
  ...
  @Nested class BDDAssumptions_given_byte_array_Test {
  ...
  @Nested class BDDAssumptions_given_short_primitive_Test {
  ...
  @Nested class BDDAssumptions_given_Short_Test {
    private final Short actual = (short) 1;
  ...
  @Nested class BDDAssumptions_given_short_array_Test {
  ...
  @Nested class BDDAssumptions_given_int_Test {
  ...
  @Nested class BDDAssumptions_given_Integer_Test {
  ...
  @Nested class BDDAssumptions_given_int_array_Test {
  ...
  @Nested class BDDAssumptions_given_BigInteger_Test {
  ...
  @Nested class BDDAssumptions_given_long_primitive_Test {
  ...
  @Nested class BDDAssumptions_given_Long_Test {
    private final Long actual = 1L;
  ...
  @Nested class BDDAssumptions_given_long_array_Test {
  ...
  @Nested class BDDAssumptions_given_float_primitive_Test {
  ...
  @Nested class BDDAssumptions_given_Float_Test {
    private final Float actual = 1.0f;
  ...
  @Nested class BDDAssumptions_given_float_array_Test {
  ...
  @Nested class BDDAssumptions_given_double_primitive_Test {
  ...
  @Nested class BDDAssumptions_given_Double_Test {
    private final Double actual = 1.0;
  ...
  @Nested class BDDAssumptions_given_double_array_Test {
  ...
  @Nested class BDDAssumptions_given_BigDecimal_Test {
  ...
  @Nested class BDDAssumptions_given_char_Test {
  ...
  @Nested class BDDAssumptions_given_Character_Test {
  ...
  @Nested class BDDAssumptions_given_char_array_Test {
  ...
  @Nested class BDDAssumptions_given_CharSequence_Test {
  ...
  @Nested class BDDAssumptions_given_String_Test {
  ...
  @Nested class BDDAssumptions_given_StringBuilder_Test {
  ...
  @Nested class BDDAssumptions_given_StringBuffer_Test {
  ...
  @Nested class BDDAssumptions_given_Class_Test {
  ...
  @Nested class BDDAssumptions_given_ClassLoader_Test {
  ...
  @Nested class BDDAssumptions_given_generics_Test {
    private class Yoda {
      private int field = 1;

      @SuppressWarnings(value = { "unused" }) public int getField() {
        return field;
      }
    }

    @Nested class BDDAssumptions_given_T_Test {
    ...
    @Nested class BDDAssumptions_given_array_T_Test {
    ...
    @Nested class BDDAssumptions_givenObject_Test {
      private final Yoda actual = new Yoda();
  ...
  @Nested class BDDAssumptions_given_Comparable_Test {
    private class Yoda implements Comparable<Yoda> {
      @Override public int compareTo(Yoda to) {
        return 0;
      }
    }
  ...
  @Nested class BDDAssumptions_given_Throwable_Test {
  ...
  @Nested class BDDAssumptions_given_SQLException_Test {
  ...
  @Nested class BDDAssumptions_givenCode_Test {
    @Nested class BDDAssumptions_givenCode_no_exception_required_Test {
      @Test void should_run_test_when_assumption_passes() {
        thenCode(() -> givenCode(() -> {
      ...
      @Test void should_ignore_test_when_assumption_fails() {
        ...
        }).hasMessage("Yoda time"));
      }
    }

    @Nested class BDDAssumptions_givenCode_exception_required_Test {
      @Test void should_run_test_when_assumption_passes() {
        thenCode(() -> givenCode(() -> {
  ...
  @Nested class BDDAssumptions_given_Iterable_Test {
  ...
  @Nested class BDDAssumptions_given_Iterator_Test {
  ...
  @Nested class BDDAssumptions_given_List_Test {
  ...
  @Nested class BDDAssumptions_given_Map_Test {
  ...
  @Nested class BDDAssumptions_given_Predicate_Test {
  ...
  @Nested class BDDAssumptions_given_IntPredicate_Test {
  ...
  @Nested class BDDAssumptions_given_LongPredicate_Test {
  ...
  @Nested class BDDAssumptions_given_DoublePredicate_Test {
  ...
  @Nested class BDDAssumptions_given_Optional_Test {
  ...
  @Nested class BDDAssumptions_given_OptionalInt_Test {
  ...
  @Nested class BDDAssumptions_given_OptionalLong_Test {
  ...
  @Nested class BDDAssumptions_given_OptionalDouble_Test {
  ...
  @Nested class BDDAssumptions_given_Stream_Test {
  ...
  @Nested class BDDAssumptions_given_IntStream_Test {
  ...
  @Nested class BDDAssumptions_given_LongStream_Test {
  ...
  @Nested class BDDAssumptions_given_DoubleStream_Test {
  ...
  @Nested class BDDAssumptions_given_Spliterator_Test {
  ...
  @Nested class BDDAssumptions_given_Future_Test {
  ...
  @Nested class BDDAssumptions_given_CompletableFuture_Test {
  ...
  @Nested class BDDAssumptions_given_CompletableStage_Test {
  ...
  @Nested class BDDAssumptions_given_AtomicBoolean_Test {
  ...
  @Nested class BDDAssumptions_given_AtomicInteger_Test {
  ...
  @Nested class BDDAssumptions_given_AtomicIntegerArray_Test {
  ...
  @Nested class BDDAssumptions_given_AtomicIntegerFieldUpdater_Test {
    private class Yoda {
      @SuppressWarnings(value = { "unused" }) public volatile int field = 0;
    }
  ...
  @Nested class BDDAssumptions_given_AtomicLong_Test {
  ...
  @Nested class BDDAssumptions_given_AtomicLongArray_Test {
  ...
  @Nested class BDDAssumptions_given_AtomicLongFieldUpdater_Test {
    private class Yoda {
      @SuppressWarnings(value = { "unused" }) public volatile long field = 0L;
    }
  ...
  @Nested class BDDAssumptions_given_AtomicReference_Test {
  ...
  @Nested class BDDAssumptions_given_AtomicReferenceArray_Test {
  ...
  @Nested class BDDAssumptions_given_AtomicReferenceFieldUpdater_Test {
    private class Yoda {
      @SuppressWarnings(value = { "unused" }) public volatile String field = "";
    }

    private final AtomicReferenceFieldUpdater<Yoda, String> actual = AtomicReferenceFieldUpdater.newUpdater(Yoda.class, String.class, "field");
  ...
  @Nested class BDDAssumptions_given_AtomicMarkableReference_Test {
  ...
  @Nested class BDDAssumptions_given_AtomicStampedReference_Test {
  ...
  @Nested class BDDAssumptions_given_Date_Test {
  ...
  @Nested class BDDAssumptions_given_LocalDate_Test {
  ...
  @Nested class BDDAssumptions_given_LocalTime_Test {
  ...
  @Nested class BDDAssumptions_given_OffsetTime_Test {
  ...
  @Nested class BDDAssumptions_given_LocalDateTime_Test {
  ...
  @Nested class BDDAssumptions_given_Instant_Test {
  ...
  @Nested class BDDAssumptions_given_OffsetDateTime_Test {
  ...
  @Nested class BDDAssumptions_given_ZonedDateTime_Test {
  ...
  @Nested class BDDAssumptions_given_InputStream_Test {
  ...
  @Nested class BDDAssumptions_given_File_Test {
  ...
  @Nested class BDDAssumptions_given_Path_Test {
  ...
  @Nested class BDDAssumptions_given_URI_Test {
    @Test void should_run_test_when_assumption_passes() {
  ...
  @Nested class BDDAssumptions_given_URL_Test {
    @Test void should_run_test_when_assumption_passes() {
  ...
  @Nested class BDDAssumptions_given_Duration_Test {
    @Test void should_run_test_when_assumption_passes() {
