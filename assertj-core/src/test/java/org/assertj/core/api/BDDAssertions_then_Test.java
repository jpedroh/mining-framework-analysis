...
class BDDAssertions_then_Test {
  ...
  @Test void then_double_array() {
    then(new double[] { 1d, 2d }).contains(2d);
  }

  @Test void then_float() {
  ...
  @Test void then_Integer() {
    then(Integer.valueOf(4)).isEqualTo(4);
  }

  @Test void then_BigInteger() {
    then(BigInteger.valueOf(4)).isEqualTo(4);
  }

  @Test void then_int_array() {
  ...
  @Test void should_build_ThrowableAssert_with_throwable_thrown() {
    thenThrownBy(() -> {
      throw new Throwable("something was wrong");
    }).isInstanceOf(Throwable.class).hasMessage("something was wrong");
  }

  @Test void should_build_ThrowableAssert_with_throwable_thrown_with_format_string() {
    thenThrownBy(() -> {
      throw new Throwable("something was wrong");
    }).isInstanceOf(Throwable.class).hasMessage("something was %s", "wrong");
  }

  @Test void then_explicit_Object() {
  ...
  @Test void then_with_multiple_requirements() {
    thenWith("foo", (string) -> assertThat(string).startsWith("f"), (string) -> assertThat(string).endsWith("o"));
  }
  ...
  @Test void should_build_ThrowableTypeAssert_with_IllegalArgumentException_thrown() {
  ...
  @Test void should_build_ThrowableTypeAssert_with_IllegalStateException_thrown() {
  ...
  @Test void should_build_ThrowableTypeAssert_with_IOException_thrown() {
