 ...
 */
@Test(groups = { "buckets" }) public class MantaClientIT {
  ...
  @BeforeClass @Parameters(value = { "encryptionCipher", "testType" }) public void beforeClass(final @Optional String encryptionCipher, final @Optional String testType) throws IOException {
  ...
  @Test public final void testManyOperationsWithDirectories() throws IOException {
    ...
    MantaAssert.assertResponseFailureCode(404, (MantaFunction<Object>) () -> mantaClient.get(dir));
  }

  @Test public final void createMantaObjectStreamCloseInOneThreadAndAbortInAnother() throws Exception {
    final String name = UUID.randomUUID().toString();
    final String path = testPathPrefix + name;
