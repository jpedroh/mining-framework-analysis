...
public class ThymeleafHdivRequestDataValueProcessor extends HdivRequestDataValueProcessor {
  @Override public String processAction(final HttpServletRequest request, final String action, final String method) {
  ...
  @Override public Map<String, String> getExtraHiddenFields(final HttpServletRequest request) {
    IDataComposer dataComposer = HDIVUtil.getDataComposer(request);
