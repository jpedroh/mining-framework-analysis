 ...
 */
public class ReflectionInterfaceDeclaration extends AbstractTypeDeclaration implements ResolvedInterfaceDeclaration, MethodResolutionCapability, MethodUsageResolutionCapability {
  private Class<?> clazz;
  ...
  @Override @Deprecated public SymbolReference<ResolvedMethodDeclaration> solveMethod(String name, List<ResolvedType> parameterTypes, boolean staticOnly) {
  ...
  @Override public boolean canBeAssignedTo(ResolvedReferenceTypeDeclaration other) {
    ...
    if (this.clazz.getSuperclass() != null && new ReflectionInterfaceDeclaration(clazz.getSuperclass(), typeSolver).canBeAssignedTo(other)) {
      return true;
    }
  ...
  @Override public List<ResolvedReferenceType> getInterfacesExtended() {
  ...
  @Override public ResolvedInterfaceDeclaration asInterface() {
    return this;
  }
  ...
  @Override public Optional<ClassOrInterfaceDeclaration> toAst() {
    return Optional.empty();
  }
}