...
public class JavaParserEnumDeclaration extends AbstractTypeDeclaration implements ResolvedEnumDeclaration, MethodResolutionCapability, MethodUsageResolutionCapability, SymbolResolutionCapability {
  ...
  @Override public boolean canBeAssignedTo(ResolvedReferenceTypeDeclaration other) {
  ...
  @Override public boolean equals(Object o) {
    ...
    if (!wrappedNode.equals(that.wrappedNode)) {
      return false;
    }
    return true;
  }
  ...
  @Override public Optional<MethodUsage> solveMethodAsUsage(String name, List<ResolvedType> argumentTypes, Context invokationContext, List<ResolvedType> typeParameters) {
  ...
  @Override public SymbolReference<? extends ResolvedValueDeclaration> solveSymbol(String name, TypeSolver typeSolver) {
  ...
  public static class ValuesMethod implements ResolvedMethodDeclaration, TypeVariableResolutionCapability {
    ...
    @Override public ResolvedReferenceTypeDeclaration declaringType() {
      return enumDeclaration;
    }

    @Override public ResolvedType getReturnType() {
    ...
    @Override public ResolvedParameterDeclaration getParam(int i) {
    ...
    @Override public boolean isDefaultMethod() {
      return false;
    }
    ...
    @Override public int getNumberOfSpecifiedExceptions() {
      return 0;
    }

    @Override public ResolvedType getSpecifiedException(int index) {
    ...
    @Override public String toDescriptor() {
      return String.format("()[", getReturnType().toDescriptor());
    }
  }
  ...
  public static class ValueOfMethod implements ResolvedMethodDeclaration, TypeVariableResolutionCapability {
    ...
    @Override public MethodUsage resolveTypeVariables(Context context, List<ResolvedType> parameterTypes) {
      return new MethodUsage(this);
    }
    ...
    @Override public String toDescriptor() {
      return String.format("(Ljava/lang/String;)", getReturnType().toDescriptor());
    }
  }
