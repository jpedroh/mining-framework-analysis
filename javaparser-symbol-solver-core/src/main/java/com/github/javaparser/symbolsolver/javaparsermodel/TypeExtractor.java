...
public class TypeExtractor extends DefaultVisitorAdapter {
  ...
  @Override public ResolvedType visit(VariableDeclarator node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(Parameter node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(ArrayAccessExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(ArrayCreationExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(ArrayInitializerExpr node, Boolean solveLambdas) {
    throw new UnsupportedOperationException(node.getClass().getCanonicalName());
  }

  @Override public ResolvedType visit(AssignExpr node, Boolean solveLambdas) {
    return node.getTarget().accept(this, solveLambdas);
  }

  @Override public ResolvedType visit(BinaryExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(CastExpr node, Boolean solveLambdas) {
    return facade.convertToUsage(node.getType(), JavaParserFactory.getContext(node, typeSolver));
  }

  @Override public ResolvedType visit(ClassExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(ConditionalExpr node, Boolean solveLambdas) {
    return node.getThenExpr().accept(this, solveLambdas);
  }

  @Override public ResolvedType visit(EnclosedExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(FieldAccessExpr node, Boolean solveLambdas) {
    if (node.getScope() instanceof NameExpr || node.getScope() instanceof FieldAccessExpr) {
      ...
      if (node.getScope() instanceof ThisExpr) {
        ...
        if (node.getScope().toString().indexOf('.') > 0) {
  ...
  @Override public ResolvedType visit(InstanceOfExpr node, Boolean solveLambdas) {
    return ResolvedPrimitiveType.BOOLEAN;
  }

  @Override public ResolvedType visit(StringLiteralExpr node, Boolean solveLambdas) {
    return new ReferenceTypeImpl(new ReflectionTypeSolver().solveType(String.class.getCanonicalName()), typeSolver);
  }

  @Override public ResolvedType visit(IntegerLiteralExpr node, Boolean solveLambdas) {
    return ResolvedPrimitiveType.INT;
  }

  @Override public ResolvedType visit(LongLiteralExpr node, Boolean solveLambdas) {
    return ResolvedPrimitiveType.LONG;
  }

  @Override public ResolvedType visit(CharLiteralExpr node, Boolean solveLambdas) {
    return ResolvedPrimitiveType.CHAR;
  }

  @Override public ResolvedType visit(DoubleLiteralExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(BooleanLiteralExpr node, Boolean solveLambdas) {
    return ResolvedPrimitiveType.BOOLEAN;
  }

  @Override public ResolvedType visit(NullLiteralExpr node, Boolean solveLambdas) {
    return NullType.INSTANCE;
  }

  @Override public ResolvedType visit(MethodCallExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(NameExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(TypeExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(ObjectCreationExpr node, Boolean solveLambdas) {
    return facade.convertToUsage(node.getType(), node);
  }

  @Override public ResolvedType visit(ThisExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(SuperExpr node, Boolean solveLambdas) {
    if (node.getTypeName().isPresent()) {
      String className = node.getTypeName().get().asString();
  ...
  @Override public ResolvedType visit(UnaryExpr node, Boolean solveLambdas) {
    switch (node.getOperator()) {
      case MINUS:
      case PLUS:
  ...
  @Override public ResolvedType visit(VariableDeclarationExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(LambdaExpr node, Boolean solveLambdas) {
  ...
  @Override public ResolvedType visit(MethodReferenceExpr node, Boolean solveLambdas) {
    if (demandParentNode(node) instanceof MethodCallExpr) {
      MethodCallExpr callExpr = (MethodCallExpr) demandParentNode(node);
      int pos = JavaParserSymbolDeclaration.getParamPos(node);
  ...
  @Override public ResolvedType visit(FieldDeclaration node, Boolean solveLambdas) {
    if (node.getVariables().size() == 1) {
