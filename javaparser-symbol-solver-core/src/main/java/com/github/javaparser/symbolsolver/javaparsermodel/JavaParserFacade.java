...
public class JavaParserFacade {
  ...
  protected ResolvedType getBinaryTypeConcrete(Node left, Node right, boolean solveLambdas, BinaryExpr.Operator operator) {
    ...
    if (operator == BinaryExpr.Operator.PLUS) {
      ...
      boolean isRightString = rightType.isReferenceType() && rightType.asReferenceType().getQualifiedName().equals(String.class.getCanonicalName());
    ...
    if (isLeftNumeric && isRightNumeric) {
      ...
      if (leftType.asPrimitive().equals(ResolvedPrimitiveType.LONG) || rightType.asPrimitive().equals(ResolvedPrimitiveType.LONG)) {
