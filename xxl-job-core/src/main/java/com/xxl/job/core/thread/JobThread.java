...
<<<<<<< /usr/src/app/output/xuxueli/xxl-job/f61f973d7c1665d9189e977b93be1208681f64ce/xxl-job-core/src/main/java/com/xxl/job/core/thread/JobThread.java/left.java
  private static int triggerQueueSize = 1000;
=======
  private ThreadPoolExecutor futureTaskExecutor;
>>>>>>> /usr/src/app/output/xuxueli/xxl-job/f61f973d7c1665d9189e977b93be1208681f64ce/xxl-job-core/src/main/java/com/xxl/job/core/thread/JobThread.java/right.java
  ...
  private void runFutureTask(FutureTask<?> task) {
    if (futureTaskExecutor == null) {
      futureTaskExecutor = new ThreadPoolExecutor(0, 3, 60L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), (r) -> new Thread(r, "xxl-job, JobFutureExecutor-" + jobId));
    }
