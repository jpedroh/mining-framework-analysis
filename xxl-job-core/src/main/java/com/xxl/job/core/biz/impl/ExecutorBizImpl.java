...
public class ExecutorBizImpl implements ExecutorBiz {
  ...
  @Override public ReturnT<LogResult> log(long logDateTim, int logId, int fromLineNum) {
    ...
    if (jobThread != null) {
      ...
      if (ExecutorBlockStrategyEnum.DISCARD_LATER == blockStrategy) {
        if (jobThread.isRunningOrHasQueue()) {
          return new ReturnT<String>(ReturnT.IGNORE_CODE, "block strategy effect\uff1a" + ExecutorBlockStrategyEnum.DISCARD_LATER.getTitle());
        }
      } else {
