...
public class ChosenImpl {
  ...
  private void choiceBuild(OptionItem option) {
    ...
    choices++;
    searchContainer.before(ChozenTemplate.templates.choice(choiceId, css.searchChoice(), option.getHtml(), css.searchChoiceClose(), "" + option.getArrayIndex()).asString());
  ...
  private void setup() {
    ...
    SafeStyles horizontalOffset = isRTL ? SafeStylesUtils.forRight(HORIZONTAL_OFFSET, Style.Unit.PX) : SafeStylesUtils.forLeft(HORIZONTAL_OFFSET, Style.Unit.PX);
    if (isMultiple) {
      containerTemp.html(ChozenTemplate.templates.contentMultiple(css.chznChoices(), css.searchField(), defaultText, css.defaultClass(), css.chznDrop(), css.chznResults(), horizontalOffset).asString());
    } else {
      containerTemp.html(ChozenTemplate.templates.contentSingle(css.chznSingle(), css.chznDefault(), defaultText, css.chznDrop(), css.chznSearch(), css.chznResults(), horizontalOffset).asString());
    }
        ...
        if (!(isMultiple && option.isSelected())) {
          ...
          if (found) {
            if (options.isHighlightSearchTerm()) {
              ...
              result.
<<<<<<< /usr/src/app/output/arcbees/gwtchosen/34d5c72a1ab388a2585c40554e785d0700fced3c/plugin/src/main/java/com/watopi/chosen/client/ChosenImpl.java/left.java
              addClass(css.foundResult())
=======
              html(text)
>>>>>>> /usr/src/app/output/arcbees/gwtchosen/34d5c72a1ab388a2585c40554e785d0700fced3c/plugin/src/main/java/com/watopi/chosen/client/ChosenImpl.java/right.java
              ;
            } else 
<<<<<<< /usr/src/app/output/arcbees/gwtchosen/34d5c72a1ab388a2585c40554e785d0700fced3c/plugin/src/main/java/com/watopi/chosen/client/ChosenImpl.java/left.java
            {
