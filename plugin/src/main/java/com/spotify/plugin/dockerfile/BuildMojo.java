...
@Mojo(name = "build", defaultPhase = LifecyclePhase.PACKAGE, requiresProject = true, threadSafe = true) public class BuildMojo extends AbstractDockerMojo {
  ...
  @Parameter(property = "dockerfile.tagSnapshotAsLatest", defaultValue = "false") private boolean tagSnapshotAsLatest;
  ...
  @Override public void execute(DockerClient dockerClient) throws MojoExecutionException, MojoFailureException {
    ...
    final String imageId = buildImage(dockerClient, log, verbose, contextDirectory, repository, tag, pullNewerImage, noCache, buildArgs);
    if (imageId == null) {
  ...
  @Nullable static String buildImage(@Nonnull DockerClient dockerClient, @Nonnull Log log, boolean verbose, @Nonnull File contextDirectory, @Nullable String repository, @Nonnull String tag, boolean pullNewerImage, boolean noCache, @Nullable Map<String, String> buildArgs) throws MojoExecutionException, MojoFailureException {
