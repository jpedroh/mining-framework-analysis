...
public abstract class BaseChosenValueListBox<T extends java.lang.Object> extends Composite implements Focusable, HasEnabled, ChosenChangeHandler {
  ...
  @Override public void onChange(ChosenChangeEvent event) {
