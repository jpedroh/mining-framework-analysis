...
, 
<<<<<<< /usr/src/app/output/apache/maven-plugin-tools/5fe527d2614d39b64e81881e52ff4fb88a0c6111/maven-script/maven-plugin-tools-ant/src/main/java/org/apache/maven/tools/plugin/extractor/ant/AntMojoDescriptorExtractor.java/left.java
hint = AntMojoDescriptorExtractor.NAME
=======
>>>>>>> Unknown file: This is a bug in JDime.
) @Named(value = "ant") @Singleton public class AntMojoDescriptorExtractor extends AbstractScriptedMojoDescriptorExtractor {
  ...
  /** {@inheritDoc} */
  @Override protected List<MojoDescriptor> extractMojoDescriptorsFromMetadata(Map<String, Set<File>> metadataFilesKeyedByBasedir, PluginToolsRequest request) throws ExtractionException, InvalidPluginDescriptorException {
      ...
      for (File metadataFile : metadataFiles) {
        ...
        try {
          ...
          for (MojoDescriptor descriptor : mojoDescriptors) {
            @SuppressWarnings(value = { "unchecked" }) Map<String, ?> paramMap = descriptor.getParameterMap();
            ...
            @SuppressWarnings(value = { "unchecked" }) List<ComponentRequirement> requirements = descriptor.getRequirements();
  ...
  /** {@inheritDoc} */
  @Override protected String getScriptFileExtension(PluginToolsRequest request) {
    return SCRIPT_FILE_EXTENSION;
  }

  /** {@inheritDoc} */
  @Override protected String getMetadataFileExtension(PluginToolsRequest request) {
