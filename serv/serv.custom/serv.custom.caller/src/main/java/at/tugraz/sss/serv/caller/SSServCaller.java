...
public class SSServCaller {
  public static void evalLog(final SSUri user, final SSToolContextE toolContext, final SSUri forUser, final SSEvalLogE type, final SSUri entity, final String content, final List<SSUri> entities, final List<SSUri> users) throws Exception {
  ...
  public static SSLikes likesUserGet(final SSUri user, final SSUri forUser, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.forUser, forUser);
  ...
  public static SSUri likeUserSet(final SSUri user, final SSUri entity, final Integer value) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<? extends SSEntity> friendsUserGet(final SSUri user) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    return (List<? extends SSEntity>) SSServReg.inst.callServViaServer(new SSServPar(SSServOpE.friendsUserGet, opPars));
  }

  public static SSUri appStackLayoutCreate(final SSUri user, final String uuid, final SSUri app, final SSLabel label, final SSTextComment description) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static List<? extends SSEntity> appStackLayoutsGet(final SSUri user) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    return (List<? extends SSEntity>) SSServReg.inst.callServViaServer(new SSServPar(SSServOpE.appStackLayoutsGet, opPars));
  }

  public static SSUri appAdd(final SSUri user, final SSLabel label, final SSTextComment descriptionShort, final SSTextComment descriptionFunctional, final SSTextComment descriptionTechnical, final SSTextComment descriptionInstall, final SSUri downloadIOS, final SSUri downloadAndroid, final SSUri fork, final List<SSUri> downloads, final List<SSUri> images, final List<SSUri> videos) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.label, label);
  ...
  public static List<? extends SSEntity> appsGet(final SSUri user) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    return (List<? extends SSEntity>) SSServReg.inst.callServViaServer(new SSServPar(SSServOpE.appsGet, opPars));
  }

  public static List<SSUri> commentEntitiesCommentedGet(final SSUri user, final SSUri forUser) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.forUser, forUser);
  ...
  public static List<SSTextComment> commentsGet(final SSUri user, final SSUri forUser, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.forUser, forUser);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSTextComment> commentsUserGet(final SSUri user, final SSUri forUser, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.forUser, forUser);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSFlag> flagsGet(final SSUri user, final List<SSUri> entities, final List<String> types, final Long startTime, final Long endTime) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entities, entities);
  ...
  public static Boolean flagsUserSet(final SSUri user, final List<SSUri> entities, final List<String> types, final Long endTime, final Integer value) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entities, entities);
    opPars.put(SSVarNames.types, SSFlagE.get(types));
  ...
  public static List<SSFlag> flagsUserGet(final SSUri user, final List<SSUri> entities, final List<String> types, final Long startTime, final Long endTime) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entities, entities);
    opPars.put(SSVarNames.types, SSFlagE.get(types));
  ...
  public static SSLearnEpLockHoldRet learnEpLockHold(final SSUri user, final SSUri learnEp, final Boolean withUserRestriction) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static Boolean learnEpLockRemove(final SSUri user, final SSUri forUser, final SSUri learnEp, final Boolean withUserRestriction, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.forUser, forUser);
    opPars.put(SSVarNames.learnEp, learnEp);
  ...
  public static Boolean learnEpLockSet(final SSUri user, final SSUri forUser, final SSUri learnEp, final Boolean withUserRestriction, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.forUser, forUser);
    opPars.put(SSVarNames.learnEp, learnEp);
  ...
  public static SSUri learnEpUserCopyForUser(final SSUri user, final SSUri forUser, final SSUri entity, final List<SSUri> entitiesToExclude, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.forUser, forUser);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static SSUri learnEpCreate(final SSUri user, final SSLabel label, final SSTextComment description, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.label, label);
  ...
  public static SSUri learnEpVersionAddCircle(final SSUri user, final SSUri learnEpVersion, final SSLabel label, final Float xLabel, final Float yLabel, final Float xR, final Float yR, final Float xC, final Float yC, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
  ...
  public static SSUri learnEpVersionAddEntity(final SSUri user, final SSUri learnEpVersion, final SSUri entity, final Float x, final Float y, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.learnEpVersion, learnEpVersion);
  ...
  public static void learnEpVersionCurrentSet(final SSUri user, final SSUri learnEpVersion, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.learnEpVersion, learnEpVersion);
  ...
  public static SSUri learnEpVersionSetTimelineState(final SSUri user, final SSUri learnEpVersion, final Long startTime, final Long endTime, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.learnEpVersion, learnEpVersion);
  ...
  public static SSLearnEpTimelineState learnEpVersionGetTimelineState(final SSUri user, final SSUri learnEpVersion) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.learnEpVersion, learnEpVersion);
  ...
  public static SSUri learnEpVersionCreate(final SSUri user, final SSUri learnEp, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.learnEp, learnEp);
  ...
  public static Integer uECountGet(final SSUri user, final SSUri forUser, final SSUri entity, final SSUEE type, final Long startTime, final Long endTime) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.forUser, forUser);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSUE> uEsGet(final SSUri user, final SSUri forUser, final SSUri entity, final List<SSUEE> types, final Long startTime, final Long endTime) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.forUser, forUser);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static Resource evernoteResourceByHashGet(final SSUri user, final NoteStoreClient noteStore, final String noteGUID, final String resourceHash) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static Boolean evernoteResourceAdd(final SSUri user, final SSUri note, final SSUri resource, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static Boolean evernoteUSNSet(final SSUri user, final String authToken, final Integer usn, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static Boolean evernoteNoteAdd(final SSUri user, final SSUri notebook, final SSUri note, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static String evernoteUsersAuthTokenGet(final SSUri user) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    return (String) SSServReg.inst.callServViaServer(new SSServPar(SSServOpE.evernoteUsersAuthTokenGet, opPars));
  }

  public static Boolean evernoteUserAdd(final SSUri user, final String authToken, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.authToken, authToken);
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
  ...
  public static Resource evernoteResourceGet(final NoteStoreClient noteStore, final String resourceGUID, final Boolean includeContent) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.noteStore, noteStore);
  ...
  public static List<SharedNotebook> evernoteNotebooksSharedGet(final NoteStoreClient noteStore) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.noteStore, noteStore);
    return (List<SharedNotebook>) SSServReg.inst.callServViaServer(new SSServPar(SSServOpE.evernoteNotebooksSharedGet, opPars));
  }

  public static Notebook evernoteNotebookGet(final NoteStoreClient noteStore, final String notebookGUID) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.noteStore, noteStore);
  ...
  public static Note evernoteNoteGet(final NoteStoreClient noteStore, final String noteGUID, final Boolean includeContent) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.noteStore, noteStore);
    opPars.put(SSVarNames.noteGUID, noteGUID);
    opPars.put(SSVarNames.includeContent, includeContent);
  ...
  public static SSEvernoteInfo evernoteNoteStoreGet(final SSUri user, final String authToken) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.authToken, authToken);
  ...
  public static List<String> evernoteNoteTagNamesGet(final NoteStoreClient noteStore, final String noteGUID) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.noteStore, noteStore);
    opPars.put(SSVarNames.noteGUID, noteGUID);
  ...
  public static void uEAddAtCreationTime(final SSUri user, final SSUri entity, final SSUEE type, final String content, final Long creationTime, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static SSLearnEpVersion learnEpVersionGet(final SSUri user, final SSUri learnEpVersion) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.learnEpVersion, learnEpVersion);
  ...
  public static void learnEpVersionUpdateCircle(final SSUri user, final SSUri learnEpCircle, final SSLabel label, final Float xLabel, final Float yLabel, final Float xR, final Float yR, final Float xC, final Float yC, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
  ...
  public static void learnEpVersionUpdateEntity(final SSUri user, final SSUri learnEpEntity, final SSUri entity, final Float x, final Float y, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
  ...
  public static void learnEpVersionRemoveCircle(final SSUri user, final SSUri learnEpCircle, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.learnEpCircle, learnEpCircle);
  ...
  public static void learnEpVersionRemoveEntity(final SSUri user, final SSUri learnEpEntity, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.learnEpEntity, learnEpEntity);
  ...
  public static List<SSLearnEp> learnEpsGet(final SSUri user) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    return (List<SSLearnEp>) SSServReg.inst.callServViaServer(new SSServPar(SSServOpE.learnEpsGet, opPars));
  }

  public static List<SSLearnEpVersion> learnEpVersionsGet(final SSUri user, final SSUri learnEp) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.learnEp, learnEp);
  ...
  public static Boolean broadcastAdd(final SSUri user, final SSUri entity, final SSBroadcastEnum type, final Object content) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.type, type);
  ...
  public static List<SSBroadcast> broadcastsGet(final SSUri user) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static SSColl collUserWithEntries(final SSUri user, final SSUri coll) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static Boolean collUserEntryDelete(final SSUri user, final SSUri entry, final SSUri parentColl, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
  ...
  public static SSUri collUserEntryAdd(final SSUri user, final SSUri coll, final SSUri entry, final SSLabel label, final Boolean addNewColl, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.coll, coll);
  ...
  public static Boolean collUserEntriesAdd(final SSUri user, final SSUri coll, final List<SSUri> entries, final List<SSLabel> labels, final Boolean saveUE, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
  ...
  public static void collUserRootAdd(final SSUri user, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
  ...
  public static List<SSColl> collUserHierarchyGet(final SSUri user, final SSUri coll) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.coll, coll);
  ...
  public static List<SSTagFrequ> collUserCumulatedTagsGet(final SSUri user, final SSUri coll) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.coll, coll);
  ...
  public static List<SSColl> collsUserEntityIsInGet(final SSUri user, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static Boolean collUserEntriesDelete(final SSUri user, final SSUri coll, final List<SSUri> entries, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.coll, coll);
  ...
  public static Boolean collsUserCouldSubscribeGet(final SSUri user) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static SSSearchRet search(final SSUri user, final Boolean includeTextualContent, final List<String> wordsToSearchFor, final Boolean includeTags, final List<String> tagsToSearchFor, final Boolean includeAuthors, final List<SSUri> authorsToSearchFor, final Boolean includeLabel, final List<String> labelsToSearchFor, final Boolean includeDescription, final List<String> descriptionsToSearchFor, final List<SSEntityE> typesToSearchOnlyFor, final Boolean includeOnlySubEntities, final List<SSUri> entitiesToSearchWithin, final Boolean extendToParents, final Boolean includeRecommendedResults, final Boolean provideEntries, final String pagesID, final Integer pageNumber, final Integer minRating, final Integer maxRating, final SSSearchOpE localSearchOp, final SSSearchOpE globalSearchOp) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static List<String> solrSearch(final String keyword, final Integer maxResults) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
  ...
  public static void solrAddDoc(final SSUri user, final String fileID, final SSMimeTypeE mimeType, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
  ...
  public static SSUri entityAdd(final SSUri user, final SSUri entity, final SSEntityE type, final SSLabel label, final SSTextComment description, final Long creationTime, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.type, type);
  ...
  public static SSEntity entityUserGet(final SSUri user, final SSUri entity, final SSUri forUser, final Boolean logErr) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.forUser, forUser);
  ...
  public static void entityUpdate(final SSUri user, final SSUri entity, final SSLabel label, final SSTextComment description, final List<SSTextComment> comments, final List<SSUri> downloads, final List<SSUri> screenShots, final List<SSUri> images, final List<SSUri> videos, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.label, label);
  ...
  public static void entityLocationsAdd(final SSUri user, final SSUri entity, final Double latitude, final Double longitude, final Float accuracy, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    final List<SSLocation> locations = new ArrayList<>();
    locations.add(SSLocation.get(vocURICreate(), latitude, longitude, accuracy));
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSLocation> entityLocationsGet(final SSUri user, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static Boolean entityReadGet(final SSUri user, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSEntity> entityEntitiesAttachedGet(final SSUri user, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSUri> entityUserEntitiesAttach(final SSUri user, final SSUri entity, final List<SSUri> entities, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.entities, entities);
  ...
  public static List<SSUri> entityFilesGet(final SSUri user, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSUri> entityDownloadURIsGet(final SSUri user, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<? extends SSEntity> entityScreenShotsGet(final SSUri user, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static void entityFileAdd(final SSUri user, final SSUri entity, final SSUri file, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSUri> entityThumbsGet(final SSUri user, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static void entityThumbAdd(final SSUri user, final SSUri entity, final SSUri thumb, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSEntity> entitiesForLabelsAndDescriptionsGet(final List<String> requireds, final List<String> absents, final List<String> eithers) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
  ...
  public static List<SSEntity> entitiesForLabelsGet(final List<String> requireds, final List<String> absents, final List<String> eithers) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.requireds, requireds);
    opPars.put(SSVarNames.absents, absents);
    opPars.put(SSVarNames.eithers, eithers);
  ...
  public static List<SSEntity> entitiesForDescriptionsGet(final List<String> requireds, final List<String> absents, final List<String> eithers) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.requireds, requireds);
    opPars.put(SSVarNames.absents, absents);
    opPars.put(SSVarNames.eithers, eithers);
  ...
  public static Boolean entityExists(final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.entity, entity);
  ...
  public static Boolean entityExists(final SSEntityE type, final SSLabel label) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
  ...
  public static SSEntity entityGet(final SSEntityE type, final SSLabel label) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.entity, null);
    opPars.put(SSVarNames.type, type);
    opPars.put(SSVarNames.label, label);
  ...
  public static SSEntity entityGet(final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.type, null);
    opPars.put(SSVarNames.label, null);
  ...
  public static List<SSUri> entityUserParentEntitiesGet(final SSUri user, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSUri> entityUserSubEntitiesGet(final SSUri user, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static SSUri entityUserDirectlyAdjoinedEntitiesRemove(final SSUri user, final SSUri entity, final Boolean removeUserTags, final Boolean removeUserRatings, final Boolean removeFromUserColls, final Boolean removeUserLocations, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSEntity> entityDescsGet(final SSUri user, final List<SSUri> entities, final List<SSEntityE> types, final Boolean getTags, final Boolean getOverallRating, final Boolean getDiscs, final Boolean getUEs, final Boolean getThumb, final Boolean getFlags) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entities, entities);
    opPars.put(SSVarNames.types, types);
  ...
  public static SSEntity entityDescGet(final SSUri user, final SSUri entity, final Boolean getTags, final Boolean getOverallRating, final Boolean getDiscs, final Boolean getUEs, final Boolean getThumb, final Boolean getFlags, final Boolean getCircles) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.getTags, getTags);
  ...
  public static void entityRemove(final SSUri entity, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
  ...
  public static Boolean entityUserCopy(final SSUri user, final SSUri entity, final List<SSUri> users, final List<SSUri> entitiesToExclude, final SSTextComment comment, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.users, users);
  ...
  public static List<SSUri> circleEntitiesRemove(final SSUri user, final SSUri circle, final List<SSUri> entities, final Boolean withUserRestriction, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static SSEntity circleUserCan(final SSUri user, final SSUri entity, final SSCircleRightE accessRight) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static SSEntity circleUserCan(final SSUri user, final SSUri entity, final SSCircleRightE accessRight, final Boolean logErr) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.accessRight, accessRight);
  ...
  public static SSUri circleEntityShare(final SSUri user, final SSUri entity, final List<SSUri> users, final List<SSUri> circles, final SSTextComment comment, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.users, users);
  ...
  public static SSUri circlePrivURIGet(final SSUri user) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    return (SSUri) SSServReg.inst.callServViaServer(new SSServPar(SSServOpE.circlePrivURIGet, opPars));
  }

  public static SSUri circlePubURIGet(final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    return (SSUri) SSServReg.inst.callServViaServer(new SSServPar(SSServOpE.circlePubURIGet, opPars));
  }

  public static SSUri circleEntityPublicSet(final SSUri user, final SSUri entity, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
  ...
  public static void ueAdd(final SSUri user, final SSUri entity, final SSUEE type, final String content, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static Boolean uEsRemove(final SSUri user, final SSUri entity, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static List<SSUri> modelUEEntitiesForMiGet(final SSUri user, final String mi) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static List<String> modelUEMIsForEntityGet(final SSUri user, final SSUri entity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static void dataExportUserRelations(final SSUri user) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    SSServReg.inst.callServViaServer(new SSServPar(SSServOpE.dataExportUserRelations, opPars));
  }

  public static void dataExportUserEntityTagCategoryTimestamps(final SSUri user, final Boolean exportTags, final Boolean usePrivateTagsToo, final Boolean exportCategories, final String fileName) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
  ...
  public static void dataExportAddTagsCategoriesTimestampsForUserEntity(final SSUri user, final SSUri forUser, final SSUri entity, final List<String> tags, final List<String> categories, final String fileName) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.forUser, forUser);
    opPars.put(SSVarNames.entity, entity);
  ...
  public static Map<String, Double> recommTags(final SSUri user, final String realm, final SSUri forUser, final SSUri entity, final List<String> categories, final Integer maxTags, final Boolean includeOwn) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static void recommUpdateBulk(final SSUri user, final String realm) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.realm, realm);
  ...
  public static Map<SSEntity, Double> recommResources(final SSUri user, final String realm, final SSUri forUser, final SSUri entity, final List<String> categories, final Integer maxResources, final List<SSEntityE> typesToRecommOnly, final Boolean setCircleTypes, final Boolean includeOwn) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.realm, realm);
    opPars.put(SSVarNames.forUser, forUser);
  ...
  public static String fileThumbBase64Get(final SSUri user, final SSUri file) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.file, file);
  ...
  public static SSFileCanWriteRet fileCanWrite(final SSUri user, final SSUri file) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.file, file);
  ...
  public static String fileIDFromURI(final SSUri user, final SSUri file) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.file, file);
  ...
  public static void fileRemoveReaderOrWriter(final SSUri user, final SSUri file, final Boolean write, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.file, file);
  ...
  public static void dataImportAchso(final SSUri user, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
  ...
  public static void dataImportUserResourceTagFromWikipedia(final SSUri user, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
  ...
  public static Map<String, String> dataImportSSSUsersFromCSVFile(final String fileName) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.fileName, fileName);
    return (Map<String, String>) SSServReg.inst.callServViaServer(new SSServPar(SSServOpE.dataImportSSSUsersFromCSVFile, opPars));
  }

  public static void dataImportEvernote(final SSUri user, final String authToken, final String authEmail, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.authToken, authToken);
  ...
  public static void dataImportMediaWikiUser(final SSUri user, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
  ...
  public static SSUri authRegisterUser(final SSUri user, final SSLabel label, final String email, final String password, final Boolean isSystemUser, final Boolean updatePassword, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.label, label);
  ...
  public static void authUsersFromCSVFileAdd(final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
  ...
  public static SSAuthCheckCredRet authCheckCred(final SSUri user, final String key) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static List<String> i5CloudAchsoSemanticAnnotationsSetGet(final List<String> ids) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
  ...
  public static Boolean i5CloudFileUpload(final String fileName, final String containerSpace, final String authToken) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.fileName, fileName);
  ...
  public static Boolean i5CloudFileDownload(final String fileName, final String containerSpace, final String authToken) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.fileName, fileName);
    opPars.put(SSVarNames.space, containerSpace);
    opPars.put(SSVarNames.authToken, authToken);
  ...
  public static SSActivity activityGet(final SSUri user, final SSUri activity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static SSUri activityContentsAdd(final SSUri user, final SSUri activity, final SSActivityContentE contentType, final List<SSActivityContent> contents, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.activity, activity);
  ...
  public static SSUri activityContentAdd(final SSUri user, final SSUri activity, final SSActivityContentE contentType, final SSActivityContent content, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.activity, activity);
    opPars.put(SSVarNames.contentType, contentType);
  ...
  public static SSUri activityAdd(final SSUri user, final SSActivityE type, final SSUri entity, final List<SSUri> users, final List<SSUri> entities, final List<SSTextComment> comments, final Long creationTime, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.entity, entity);
    opPars.put(SSVarNames.type, type);
  ...
  public static List<SSActivity> activitiesUserGet(final SSUri user, final List<SSActivityE> types, final List<SSUri> users, final List<SSUri> entities, final List<SSUri> circles, final Long startTime, final Long endTime, final Boolean includeOnlyLastActivities) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.types, types);
    opPars.put(SSVarNames.users, users);
  ...
  public static List<? extends SSEntity> videosUserGet(final SSUri user, final SSUri forUser, final SSUri forEntity) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
    opPars.put(SSVarNames.forUser, forUser);
  ...
  public static SSEntity videoUserGet(final SSUri user, final SSUri video) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  public static SSUri videoUserAdd(final SSUri user, final SSUri link, final SSUri forEntity, final String uuid, final Boolean shouldCommit) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.shouldCommit, shouldCommit);
    opPars.put(SSVarNames.user, user);
  ...
  public static void recommLoadUserRealms(final SSUri user) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.user, user);
  ...
  /**
     * *** OCD ****
     */
  public static String ocdCreateGraph(final String graphName, final String graphCreationType, final SSOCDGraphInputE graphInputFormat, final boolean doMakeUndirected, final String content) throws Exception {
    final Map<String, Object> opPars = new HashMap<>();
    opPars.put(SSVarNames.graphName, graphName);
    opPars.put(SSVarNames.graphCreationType, graphCreationType);
    opPars.put(SSVarNames.graphInputFormat, graphInputFormat);
    opPars.put(SSVarNames.doMakeUndirected, doMakeUndirected);
    opPars.put(SSVarNames.content, content);
    return (String) SSServReg.inst.callServViaServer(new SSServPar(SSServOpE.ocdCreateGraph, opPars));
  }
}