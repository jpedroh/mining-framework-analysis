 ...
 */
@EqualsAndHashCode(callSuper = false) @Getter @Setter @ToString @RequiredArgsConstructor @NoArgsConstructor @AllArgsConstructor @Builder public class SendVideo extends SendMediaBotMethod<Message> {
  ...
  @NonNull private InputFile video;
  ...
  public static class SendVideoBuilder {
    @Tolerate public SendVideoBuilder chatId(@NonNull Long chatId) {
      this.chatId = chatId.toString();
      return this;
    }
  }
