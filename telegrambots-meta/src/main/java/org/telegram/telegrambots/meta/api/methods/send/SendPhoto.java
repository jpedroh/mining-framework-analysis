 ...
 */
@EqualsAndHashCode(callSuper = false) @Getter @Setter @ToString @RequiredArgsConstructor @NoArgsConstructor @AllArgsConstructor @Builder public class SendPhoto extends SendMediaBotMethod<Message> {
  ...
  @NonNull private InputFile photo;
  ...
  public static class SendPhotoBuilder {
    @Tolerate public SendPhotoBuilder chatId(@NonNull Long chatId) {
      this.chatId = chatId.toString();
      return this;
    }
  }
