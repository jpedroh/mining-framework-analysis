 ...
 */
@EqualsAndHashCode(callSuper = false) @Getter @Setter @ToString @RequiredArgsConstructor @NoArgsConstructor @AllArgsConstructor @Builder public class SendAnimation extends SendMediaBotMethod<Message> {
  ...
  @NonNull private InputFile animation;
  ...
  @Singular private List<MessageEntity> captionEntities;
  ...
  @Tolerate public void setChatId(@NonNull Long chatId) {
  ...
  @Override public InputFile getFile() {
    return animation;
  }

  @Override public String getFileField() {
    return ANIMATION_FIELD;
  }

  public static class SendAnimationBuilder {
    @Tolerate public SendAnimationBuilder chatId(@NonNull Long chatId) {
      this.chatId = chatId.toString();
      return this;
    }
  }
