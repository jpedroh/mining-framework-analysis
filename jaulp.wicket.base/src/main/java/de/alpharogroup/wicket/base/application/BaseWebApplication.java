...
public abstract class BaseWebApplication extends WebApplication {
  ...
  /**
	 ...
	 */
  @Getter private DateTime startupDate;

  /** The configuration properties. */
  @Getter private final Properties properties;

  /** The configuration properties resolver. */
  @Getter private final ConfigurationPropertiesResolver configurationPropertiesResolver;
  ...
  /**
	 ...
	 */
  public <T extends Page> void mountPage(final String path, final Class<T> pageClass, final IPageParametersEncoder pageParametersEncoder) {
