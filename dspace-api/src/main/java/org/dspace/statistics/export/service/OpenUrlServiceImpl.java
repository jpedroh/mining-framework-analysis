...
public class OpenUrlServiceImpl implements OpenUrlService {
  ...
  /**
     ...
     * @throws SQLException
     */
  @Override public void processUrl(Context c, String urlStr) throws SQLException {
...
=======
    getHttpClient(getHttpClientRequestConfig())
>>>>>>> /usr/src/app/output/dspace/dspace/c65314db9d4f1df5539b4785a5b234ee3ab8a2a5/dspace-api/src/main/java/org/dspace/statistics/export/service/OpenUrlServiceImpl.java/right.java
  ...
  /**
     ...
     * @throws SQLException
     */
  @Override public void reprocessFailedQueue(Context context) throws SQLException {
  ...
  /**
     ...
     * @throws SQLException
     */
  @Override public void logfailed(Context context, String url) throws SQLException {
    Date now = new Date();
