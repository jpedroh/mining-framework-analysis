...
public class BitstreamStorageServiceImpl implements BitstreamStorageService, InitializingBean {
  ...
  @Override public UUID store(Context context, Bitstream bitstream, InputStream is) throws SQLException, IOException {
  ...
  /**
     ...
     */
  @Override public UUID register(Context context, Bitstream bitstream, int assetstore, String bitstreamPath) throws SQLException, IOException, AuthorizeException {
  ...
  @Override public Map<String, Object> computeChecksum(Context context, Bitstream bitstream) throws IOException {
    return this.getStore(bitstream.getStoreNumber()).about(bitstream, List.of("checksum", "checksum_algorithm"));
  }

  @Override public boolean isRegisteredBitstream(String internalId) {
    return internalId.startsWith(REGISTERED_FLAG);
  }

  @Override public InputStream retrieve(Context context, Bitstream bitstream) throws SQLException, IOException {
    Integer storeNumber = bitstream.getStoreNumber();
    return this.getStore(storeNumber).get(bitstream);
  }

  @Override public void cleanup(boolean deleteDbRecords, boolean verbose) throws SQLException, IOException, AuthorizeException {
  ...
  /**
     ...
     */
  @Override public Bitstream clone(Context context, Bitstream bitstream) throws SQLException, IOException, AuthorizeException {
  ...
  /**
     ...
     *                            to perform a particular action.
     */
  @Override public void migrate(Context context, Integer assetstoreSource, Integer assetstoreDestination, boolean deleteOld, Integer batchCommitSize) throws IOException, SQLException, AuthorizeException {
  ...
  @Override public void printStores(Context context) {
    try {
