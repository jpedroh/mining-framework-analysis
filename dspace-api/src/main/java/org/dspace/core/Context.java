...
public class Context implements AutoCloseable {
  ...
  public void restoreAuthSystemState() {
    ...
    try {
      ...
      log.warn(LogHelper.getHeader(this, "restore_auth_sys_state", "not previous state info available:  {}"), ex::getLocalizedMessage);
    ...
    if (log.isDebugEnabled()) {
      ...
      try {
        ...
        previousCaller = "none";
        log.warn(LogHelper.getHeader(this, "restore_auth_sys_state", "no previous caller info available:  {}"), ex::getLocalizedMessage);
      }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public <E extends ReloadableEntity> E reloadEntity(E entity) throws SQLException {
  ...
  /**
     ...
     * @throws SQLException When reloading the entity from the database fails.
     */
  @SuppressWarnings(value = { "unchecked" }) public <E extends ReloadableEntity> void uncacheEntity(E entity) throws SQLException {
