...
public class I18nUtil {
  ...
  public static String getInputFormsFileName(Locale locale) {
    ...
    String defsFilename = DSpaceServicesFactory.getInstance().getConfigurationService().getProperty("dspace.dir") + File.separator + "config" + File.separator + FORM_DEF_FILE;
  ...
  public static String getDefaultLicense(Context context) {
    ...
    String defsFilename = DSpaceServicesFactory.getInstance().getConfigurationService().getProperty("dspace.dir") + File.separator + "config" + File.separator + DEF_LIC_FILE;
    String fileName = getFilename(locale, defsFilename, FILE_TYPE);
    return fileName;
  }
