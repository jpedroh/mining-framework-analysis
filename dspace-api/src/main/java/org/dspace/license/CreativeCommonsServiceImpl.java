...
public class CreativeCommonsServiceImpl implements CreativeCommonsService, InitializingBean {
  ...
  /**
     ...
     */
  @Deprecated protected static final String BSN_LICENSE_URL = "license_url";
  ...
  /**
     ...
     */
  @Deprecated protected static final String BSN_LICENSE_TEXT = "license_text";
  ...
  @Override public void afterPropertiesSet() throws Exception {
    ...
    try {
      templates = TransformerFactory.newInstance().newTemplates(new StreamSource(CreativeCommonsServiceImpl.class.getResourceAsStream("CreativeCommons.xsl")));
  ...
  @Override public void setLicenseRDF(Context context, Item item, String licenseRdf) throws SQLException, IOException, AuthorizeException {
  ...
  @Override public void setLicense(Context context, Item item, InputStream licenseStm, String mimeType) throws SQLException, IOException, AuthorizeException {
    Bundle bundle = getCcBundle(context, item);
    BitstreamFormat bs_format;
    if (mimeType.equalsIgnoreCase("text/xml")) {
      bs_format = bitstreamFormatService.findByShortDescription(context, "CC License");
    } else {
      if (mimeType.equalsIgnoreCase("text/rdf")) {
  ...
  /**
     ...
     */
  @Override public void removeLicenseFile(Context context, Item item) throws SQLException, IOException, AuthorizeException {
    List<Bundle> bundles = itemService.getBundles(item, CC_BUNDLE_NAME);
    if ((bundles.size() > 0) && (bundles.get(0) != null)) {
      itemService.removeBundle(context, item, bundles.get(0));
    }
  ...
  @Override public Bitstream getLicenseRdfBitstream(Item item) throws SQLException, IOException, AuthorizeException {
    return getBitstream(item, BSN_LICENSE_RDF);
  }

  @Deprecated @Override public Bitstream getLicenseTextBitstream(Item item) throws SQLException, IOException, AuthorizeException {
    return getBitstream(item, BSN_LICENSE_TEXT);
  }

  @Override public String getLicenseURL(Context context, Item item) throws SQLException, IOException, AuthorizeException {
  ...
  /**
     ...
     */
  @Override public String getLicenseURI(Item item) {
  ...
  /**
     ...
     */
  @Override public String getLicenseName(Item item) {
  ...
  @Override public String fetchLicenseRDF(Document license) {
    StringWriter result = new StringWriter();
    try {
      templates.newTransformer().transform(new JDOMSource(license), new StreamResult(result));
  ...
  /**
     ...
     */
  @Override public String getCCField(String fieldId) {
  ...
  /**
     ...
     * @throws SQLException       An exception that provides information on a database access error or other errors.
     */
  @Override public void removeLicense(Context context, Item item) throws AuthorizeException, IOException, SQLException {
  ...
  private void addLicenseField(Context context, Item item, String field, String language, String value) throws SQLException {
    String[] params = splitField(field);
  ...
  /**
     ...
     */
  @Override public List<CCLicense> findAllCCLicenses() {
  ...
  /**
     ...
     */
  @Override public List<CCLicense> findAllCCLicenses(String language) {
  ...
  /**
     ...
     */
  @Override public CCLicense findOne(String id) {
  ...
  /**
     ...
     * @return the corresponding license if found or null when not found
     */
  @Override public CCLicense findOne(String id, String language) {
    if (!ccLicenses.containsKey(language)) {
      initLicenses(language);
    }
  ...
  /**
     ...
     */
  @Override public String retrieveLicenseUri(String licenseId, Map<String, String> answerMap) {
  ...
  /**
     ...
     * @return the corresponding license URI
     */
  @Override public String retrieveLicenseUri(String licenseId, String language, Map<String, String> answerMap) {
  ...
  /**
     ...
     */
  @Override public boolean verifyLicenseInformation(String licenseId, Map<String, String> fullAnswerMap) {
  ...
  /**
     ...
     * @return whether the information is valid
     */
  @Override public boolean verifyLicenseInformation(String licenseId, String language, Map<String, String> fullAnswerMap) {
  ...
  /**
     ...
     */
  @Override public Map<String, String> retrieveFullAnswerMap(String licenseId, Map<String, String> answerMap) {
  ...
  /**
     ...
     */
  @Override public Map<String, String> retrieveFullAnswerMap(String licenseId, String language, Map<String, String> answerMap) {
    CCLicense ccLicense = findOne(licenseId, language);
    if (ccLicense == null) {
      return null;
    }
  ...
  /**
     ...
     * @throws SQLException
     */
  @Override public boolean updateLicense(final Context context, final String licenseUri, final Item item) throws AuthorizeException, SQLException {
    try {
  ...
  /**
     ...
     * @throws AuthorizeException
     */
  @Override public void addLicense(Context context, Item item, String licenseUri, String licenseName, Document doc) throws SQLException, IOException, AuthorizeException {
    String uriField = getCCField("uri");
    String nameField = getCCField("name");
