...
public class MetadataImporter {
  ...
  /**
     ...
     **/
  public static void main(String[] args) throws ParseException, SQLException, IOException, TransformerException, ParserConfigurationException, AuthorizeException, SAXException, NonUniqueMetadataException, RegistryImportException, XPathExpressionException {
  ...
  public static void loadRegistry(String file, boolean forceUpdate) throws SQLException, IOException, TransformerException, ParserConfigurationException, AuthorizeException, SAXException, NonUniqueMetadataException, RegistryImportException, XPathExpressionException {
    ...
    try {
      ...
      NodeList schemaNodes = (NodeList) xPath.compile("/dspace-dc-types/dc-schema").evaluate(document, XPathConstants.NODESET);
      for (int i = 0; i < schemaNodes.getLength(); i++) {
        Node n = schemaNodes.item(i);
        loadSchema(context, n, forceUpdate);
      }
      NodeList typeNodes = (NodeList) xPath.compile("/dspace-dc-types/dc-type").evaluate(document, XPathConstants.NODESET);
  ...
  /**
     ...
     * @throws RegistryImportException    if import fails
     */
  private static void loadSchema(Context context, Node node, boolean updateExisting) throws SQLException, AuthorizeException, NonUniqueMetadataException, RegistryImportException, XPathExpressionException {
