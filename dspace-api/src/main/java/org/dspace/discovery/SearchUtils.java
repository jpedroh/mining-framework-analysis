...
public class SearchUtils {
  ...
  public static DiscoveryConfiguration getDiscoveryConfiguration(final Context context, DSpaceObject dso) {
  ...
  /**
     ...
     */
  public static DiscoveryConfiguration getDiscoveryConfiguration(final Context context, String prefix, DSpaceObject dso) {
    if (prefix != null) {
  ...
  /**
     ...
     */
  public static List<DiscoveryConfiguration> getAllDiscoveryConfigurations(Item item, Context context) throws SQLException {
  ...
  /**
     ...
     * @throws SQLException
     */
  public static List<DiscoveryConfiguration> getAllDiscoveryConfigurations(final Context context, WorkspaceItem witem) throws SQLException {
  ...
  /**
     ...
     * @throws SQLException
     */
  public static List<DiscoveryConfiguration> getAllDiscoveryConfigurations(final Context context, WorkflowItem witem) throws SQLException {
    List<Collection> collections = new ArrayList<Collection>();
    collections.add(witem.getCollection());
    return getAllDiscoveryConfigurations(context, "workflow", collections, witem.getItem());
  }

  private static List<DiscoveryConfiguration> getAllDiscoveryConfigurations(final Context context, String prefix, List<Collection> collections, Item item) throws SQLException {
  ...
  public static DiscoverQueryBuilder getQueryBuilder() {
    ServiceManager manager = DSpaceServicesFactory.getInstance().getServiceManager();
    return manager.getServiceByName(DiscoverQueryBuilder.class.getName(), DiscoverQueryBuilder.class);
  }
}