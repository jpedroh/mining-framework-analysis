...
public class OAIHarvester {
  ...
  /**
     ...
     */
  protected void processRecord(Element record, String OREPrefix, final long currentRecord, long totalListSize) throws SQLException, AuthorizeException, IOException, CrosswalkException, HarvestingException, ParserConfigurationException, SAXException, XPathExpressionException {
  ...
  /**
     ...
     * @throws XPathExpressionException     if XPath error
     */
  private String oaiGetDateGranularity(String oaiSource) throws IOException, ParserConfigurationException, SAXException, XPathExpressionException {
  ...
  /**
     ...
     * @throws HarvestingException          if harvesting error
     */
  protected List<Element> getMDrecord(String oaiSource, String itemOaiId, String metadataPrefix) throws IOException, ParserConfigurationException, SAXException, XPathExpressionException, HarvestingException {
