...
public class AuthoritySolrServiceImpl implements AuthorityIndexingService, AuthoritySearchService {
  ...
  @Inject @Named(value = "solrHttpConnectionPoolService") private HttpConnectionPoolService httpConnectionPoolService;
  ...
  public SolrClient getSolr() throws MalformedURLException, SolrServerException, IOException {
    if (solr == null) {
      ...
      HttpSolrClient solrServer = new HttpSolrClient.Builder(solrService).withHttpClient(httpConnectionPoolService.getClient()).build();
  ...
  @Override public void indexContent(AuthorityValue value) {
  ...
  @Override public void cleanIndex() throws Exception {
    try {
  ...
  @Override public boolean isConfiguredProperly() {
  ...
  @Override public QueryResponse search(SolrQuery query) throws SolrServerException, MalformedURLException, IOException {
  ...
  /**
     ...
     */
  @Override public List<String> getAllIndexedMetadataFields() throws Exception {
