...
public class QDCCrosswalkTest extends AbstractDSpaceTest {
  ...
  private static final String NAMESPACE_PROPERTY = "crosswalk.qdc.namespace." + PLUGIN_NAME + "." + NAMESPACE_PREFIX;
  ...
  @BeforeClass public static void setUpClass() {
    ...
    pluginService = dsf.getServiceManager().getServiceByName(null, PluginService.class);
    ConfigurationService cfg = dsf.getConfigurationService();
    cfg.setProperty("crosswalk.selfnamed." + IngestionCrosswalk.class.getName(), QDCCrosswalk.class.getName());
  ...
  /**
     ...
     */
  @Test public void testGetPluginNames() {
  ...
  /**
     ...
     */
  @Ignore @Test public void testDisseminateList() throws Exception {
  }
  ...
  /**
     ...
     * @throws java.lang.Exception passed through.
     */
  @Ignore @Test public void testDisseminateElement() throws Exception {
  }

  /**
     * Test of canDisseminate method, of class QDCCrosswalk.
     */
  @Ignore @Test public void testCanDisseminate() {
  }
  ...
  /**
     ...
     * @throws java.lang.Exception passed through.
     */
  @Ignore @Test public void testIngest_4args_1() throws Exception {
  }
  ...
  /**
     ...
     * @throws java.lang.Exception passed through.
     */
  @Ignore @Test public void testIngest_4args_2() throws Exception {
  }

  /**
     * Test of preferList method, of class QDCCrosswalk.
     */
  @Test public void testPreferList() {
    QDCCrosswalk instance = (QDCCrosswalk) pluginService.getNamedPlugin(IngestionCrosswalk.class, PLUGIN_NAME);
