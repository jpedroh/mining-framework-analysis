...
public class MockCCLicenseConnectorServiceImpl extends CCLicenseConnectorServiceImpl {
  /**
     ...
     */
  @Override public Map<String, CCLicense> retrieveLicenses(String language) {
  ...
  private List<CCLicenseField> createMockLicenseFields(int count, int[] amountOfFieldsAndEnums) {
    ...
    for (int index = 0; index < amountOfFieldsAndEnums.length; index++) {
      ...
      List<CCLicenseFieldEnum> mockLicenseFields = createMockLicenseFields(count, index, amountOfFieldsAndEnums[index]);
  ...
  /**
     ...
     */
  @Override public String retrieveRightsByQuestion(final String licenseId, final String language, final Map<String, String> answerMap) {
  ...
  /**
     ...
     * @throws IOException
     */
  @Override public Document retrieveLicenseRDFDoc(String licenseURI) throws IOException {
