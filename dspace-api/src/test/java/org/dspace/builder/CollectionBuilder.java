...
public class CollectionBuilder extends AbstractDSpaceObjectBuilder<Collection> {
  ...
  /**
     ...
     * @return this.
     */
  public static CollectionBuilder createCollection(final Context context, final Community parent, final String handle) {
    CollectionBuilder builder = new CollectionBuilder(context);
  ...
  public CollectionBuilder withProvenance(final String provenance) {
    return addMetadataValue(collection, MetadataSchemaEnum.DC.getName(), "description", "provenance", provenance);
  }
  ...
  /**
     ...
     * @deprecated 7.0
     */
  @Deprecated public CollectionBuilder withWorkflowGroup(int step, EPerson... members) throws SQLException, AuthorizeException {
  ...
  /**
     ...
     * @throws AuthorizeException passed through.
     */
  public CollectionBuilder withWorkflowGroup(String roleName, EPerson... members) throws SQLException, AuthorizeException, IOException, WorkflowConfigurationException {
  ...
  @Override public Collection build() {
    try {
  ...
  /**
     ...
     * @deprecated 7.0
     */
  @Deprecated public void deleteWorkflowGroups(Context c, Collection collection) throws Exception {
    for (int i = 1; i <= 3; i++) {
  ...
  @Override protected DSpaceObjectService<Collection> getService() {
