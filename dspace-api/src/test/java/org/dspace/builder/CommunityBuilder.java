...
public class CommunityBuilder extends AbstractDSpaceObjectBuilder<Community> {
  ...
  public static CommunityBuilder createSubCommunity(final Context context, final Community parent, final String handle) {
    CommunityBuilder builder = new CommunityBuilder(context);
  ...
  public CommunityBuilder addParentCommunity(final Context context, final Community parent) throws SQLException, AuthorizeException {
    communityService.addSubcommunity(context, parent, community);
    return this;
  }

  @Override public Community build() {
    try {
  ...
  @Override protected DSpaceObjectService<Community> getService() {
