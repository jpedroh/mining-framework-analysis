...
public class RelationshipTypeBuilder extends AbstractBuilder<RelationshipType, RelationshipTypeService> {
  ...
  @Override protected RelationshipTypeService getService() {
  ...
  @Override public void delete(Context c, RelationshipType dso) throws Exception {
    if (dso != null) {
      getService().delete(c, dso);
    }
  }

  @Override public RelationshipType build() {
    try {
