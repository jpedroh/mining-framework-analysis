      ...
      if (doc.get(type).isDocument()) {
        ...
        for (String field : typeDoc.keySet()) {
          ...
          switch (fieldMapping.getBsonType()) {
            ...
            case DOCUMENT:
            {
              ...
              if (fieldMappingDoc.containsKey("limit")) {
                if (fieldMappingDoc.get("limit").isDocument()) {
                  ...
                  if (fieldMappingDoc.get("limit").isNumber()) {
              ...
              if (fieldMappingDoc.containsKey("skip")) {
                if (fieldMappingDoc.get("skip").isDocument()) {
                  ...
                  if (fieldMappingDoc.get("skip").isNumber()) {
            ...
            default:
            throw new GraphQLIllegalAppDefinitionException("Error with mappings of type: \'" + type + "\'. A field mapping must be of type \'STRING\' but was " + fieldMapping.getBsonType());
          }
        }
