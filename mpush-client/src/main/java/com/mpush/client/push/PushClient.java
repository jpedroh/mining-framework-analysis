...
final class PushClient extends BaseService implements PushSender {
  ...
  @Override public FutureTask<PushResult> send(PushContext ctx) {
    if (ctx.isBroadcast()) {
  ...
  @Override protected void doStart(Listener listener) throws Throwable {
  ...
  @Override protected void doStop(Listener listener) throws Throwable {
    ServiceDiscoveryFactory.create().syncStart();
