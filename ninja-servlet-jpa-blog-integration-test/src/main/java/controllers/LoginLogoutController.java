...
@Singleton @FilterWith(value = RememberMeFilter.class) public class LoginLogoutController {
  ...
  public Result loginPost(@Param(value = "username") String username, @Param(value = "password") String password, @Param(value = "rememberMe") Boolean rememberMe, Context context) {
