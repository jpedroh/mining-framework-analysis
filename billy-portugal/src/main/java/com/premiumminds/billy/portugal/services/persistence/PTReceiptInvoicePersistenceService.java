...
public class PTReceiptInvoicePersistenceService implements PersistenceService<PTReceiptInvoice> {
  ...
  @Inject public PTReceiptInvoicePersistenceService(DAOPTReceiptInvoice daoReceiptInvoice, DAOTicket daoTicket) {
    this.daoReceiptInvoice = daoReceiptInvoice;
    this.daoTicket = daoTicket;
  }

  @Override @NotImplemented public PTReceiptInvoice create(final Builder<PTReceiptInvoice> builder) {
    return null;
  }

  @NotImplemented @Override public PTReceiptInvoice update(final Builder<PTReceiptInvoice> builder) {
    try {
      return new TransactionWrapper<PTReceiptInvoice>(this.daoReceiptInvoice) {
        @Override public PTReceiptInvoice runTransaction() throws Exception {
  ...
  @Override public PTReceiptInvoice get(final UID uid) {
    try {
      return new TransactionWrapper<PTReceiptInvoice>(this.daoReceiptInvoice) {
        @Override public PTReceiptInvoice runTransaction() throws Exception {
  ...
  public PTReceiptInvoice getWithTicket(final UID ticketUID) {
    try {
      return new TransactionWrapper<PTReceiptInvoice>(this.daoReceiptInvoice) {
        @Override public PTReceiptInvoice runTransaction() throws NoResultException, BillyRuntimeException {
          UID objectUID = PTReceiptInvoicePersistenceService.this.daoTicket.getObjectEntityUID(ticketUID.getValue());
