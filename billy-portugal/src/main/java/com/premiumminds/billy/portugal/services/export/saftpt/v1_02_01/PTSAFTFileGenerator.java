...
import com.premiumminds.billy.portugal.services.export.saftpt.v1_02_01.schema.Payment;
import com.premiumminds.billy.portugal.services.export.saftpt.v1_02_01.schema.Product;
import com.premiumminds.billy.portugal.services.export.saftpt.v1_02_01.schema.References;
...
public class PTSAFTFileGenerator {
  ...
  @Inject public PTSAFTFileGenerator(DAOPTCustomer daoCustomer, DAOPTSupplier daoSupplier, DAOPTProduct daoProduct, DAOPTTax daoPTTax, DAOPTRegionContext daoPTRegionContext, DAOPTInvoice daoPTInvoice, DAOPTSimpleInvoice daoPTSimpleInvoice, DAOPTReceiptInvoice daoPTReceiptInvoice, DAOPTCreditNote daoPTCreditNote) {
    ...
    try {
      this.jaxbContext = JAXBContext.newInstance("com.premiumminds.billy.portugal.services.export.saftpt.v1_02_01.schema");
  ...
  /**
	 ...
	 */
  @Deprecated public void generateSAFTFile(final OutputStream targetStream, final PTBusinessEntity businessEntity, final PTApplicationEntity application, final String certificateNumber, final Date fromDate, final Date toDate) throws SAFTPTExportException {
  ...
  /**
     ...
     * @throws SAFTPTExportException
     */
  public void generateSAFTFile(final OutputStream targetStream, final PTBusinessEntity businessEntity, final PTApplicationEntity application, final Date fromDate, final Date toDate) throws SAFTPTExportException {
    try {
  ...
  private Invoice generateSAFTInvoice(PTGenericInvoiceEntity document) throws DatatypeConfigurationException, RequiredFieldNotFoundException, InvalidDocumentTypeException, InvalidDocumentStateException, InvalidInvoiceTypeException {
    ...
    if (document.isSelfBilled() != null) {
      saftInv.setSelfBillingIndicator(this.validateInteger("SelfBillingIndicator", document.isSelfBilled() ? "1" : "0", this.MAX_LENGTH_1, true));
    } else {
  ...
  @SuppressWarnings(value = { "unchecked" }) private List<Payment> getPaymentsList(PTGenericInvoiceEntity document) throws RequiredFieldNotFoundException, InvalidPaymentMechanismException, DatatypeConfigurationException {
