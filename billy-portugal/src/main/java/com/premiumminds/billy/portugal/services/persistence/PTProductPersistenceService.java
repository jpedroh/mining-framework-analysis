...
public class PTProductPersistenceService implements PersistenceService<PTProduct> {
  ...
  @Inject public PTProductPersistenceService(DAOPTProduct daoProduct) {
    this.daoProduct = daoProduct;
  }

  @Override public PTProduct create(final Builder<PTProduct> builder) {
    try {
      return new TransactionWrapper<PTProduct>(this.daoProduct) {
        @Override public PTProduct runTransaction() throws Exception {
  ...
  @Override public PTProduct update(final Builder<PTProduct> builder) {
    try {
      return new TransactionWrapper<PTProduct>(this.daoProduct) {
        @Override public PTProduct runTransaction() throws Exception {
          PTProductEntity entity = (PTProductEntity) builder.build();
  ...
  @Override public PTProduct get(final UID uid) {
    try {
      return new TransactionWrapper<PTProduct>(this.daoProduct) {
        @Override public PTProduct runTransaction() throws Exception {
