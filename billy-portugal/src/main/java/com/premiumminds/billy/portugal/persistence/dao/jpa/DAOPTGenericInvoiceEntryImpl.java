...
public class DAOPTGenericInvoiceEntryImpl extends AbstractDAOGenericInvoiceEntryImpl<PTGenericInvoiceEntryEntity, JPAPTGenericInvoiceEntryEntity> implements DAOPTGenericInvoiceEntry {
  @Inject public DAOPTGenericInvoiceEntryImpl(Provider<EntityManager> emProvider) {
    super(emProvider);
  }

  @Override public PTGenericInvoiceEntryEntity getEntityInstance() {
    return new JPAPTGenericInvoiceEntryEntity();
  }

  @Override protected Class<? extends JPAPTGenericInvoiceEntryEntity> getEntityClass() {
