...
public class PTContactBuilderImpl<TBuilder extends PTContactBuilderImpl<TBuilder, TContact>, TContact extends PTContact> extends ContactBuilderImpl<TBuilder, TContact> implements PTContactBuilder<TBuilder, TContact> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  @Inject public PTContactBuilderImpl(DAOPTContact daoPTContact) {
    super(daoPTContact);
  }

  @Override protected PTContactEntity getTypeInstance() {
