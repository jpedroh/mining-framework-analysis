...
public class DAOPTProductImpl extends DAOProductImpl implements DAOPTProduct {
  @Inject public DAOPTProductImpl(Provider<EntityManager> emProvider) {
    super(emProvider);
  }

  @Override public PTProductEntity getEntityInstance() {
    return new JPAPTProductEntity();
  }

  @Override protected Class<JPAPTProductEntity> getEntityClass() {
