...
public class PTProductBuilderImpl<TBuilder extends PTProductBuilderImpl<TBuilder, TProduct>, TProduct extends PTProduct> extends ProductBuilderImpl<TBuilder, TProduct> implements PTProductBuilder<TBuilder, TProduct> {
  ...
  @Inject public PTProductBuilderImpl(DAOPTProduct daoPTProduct, DAOPTTax daoPTTax) {
    super(daoPTProduct, daoPTTax);
  }

  @Override protected PTProductEntity getTypeInstance() {
  ...
  @Override protected void validateInstance() throws BillyValidationException {
    ...
    BillyValidator.mandatory(p.getNumberCode(), PTProductBuilderImpl.LOCALIZER.getString("field.product_number_code"));
  }
}