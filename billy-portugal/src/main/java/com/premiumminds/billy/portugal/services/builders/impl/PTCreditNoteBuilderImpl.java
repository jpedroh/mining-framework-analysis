...
public class PTCreditNoteBuilderImpl<TBuilder extends PTCreditNoteBuilderImpl<TBuilder, TEntry, TDocument>, TEntry extends PTCreditNoteEntry, TDocument extends PTCreditNote> extends PTGenericInvoiceBuilderImpl<TBuilder, TEntry, TDocument> implements PTCreditNoteBuilder<TBuilder, TEntry, TDocument> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  public <TDAO extends AbstractDAOPTGenericInvoice<? extends TDocument>> PTCreditNoteBuilderImpl(TDAO daoPTCreditNote, DAOPTBusiness daoPTBusiness, DAOPTCustomer daoPTCustomer, DAOPTSupplier daoPTSupplier) {
