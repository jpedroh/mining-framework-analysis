...
public class PTCreditNoteIssuingHandler extends PTGenericInvoiceIssuingHandler<PTCreditNoteEntity, PTIssuingParams> {
  ...
  @Inject public PTCreditNoteIssuingHandler(DAOInvoiceSeries invoiceSeries, DAOPTCreditNote daoCreditNote) {
    super(invoiceSeries);
    this.daoCreditNote = daoCreditNote;
  }

  @Override public PTCreditNoteEntity issue(PTCreditNoteEntity document, PTIssuingParams parameters) throws DocumentIssuingException {
...
=======
  @Override public <T extends GenericInvoice, P extends IssuingParams> T issue(final T document, P parameters) throws DocumentIssuingException {
    ...
    return this.issue(document, parametersPT, this.daoCreditNote, PTCreditNoteIssuingHandler.INVOICE_TYPE);
  }
>>>>>>> /usr/src/app/output/premium-minds/billy/e481179c9fa61835d2db73bd8cdcb9f47123f892/billy-portugal/src/main/java/com/premiumminds/billy/portugal/services/documents/PTCreditNoteIssuingHandler.java/right.java
}