...
@SuppressWarnings(value = { "deprecation" }) public class SchemaExport {
  public static void main(String[] args) {
    SchemaExport.exportSchema(args[0], args[1], Boolean.parseBoolean(args[2]), Boolean.parseBoolean(args[3]), args[4]);
  }

  private static void exportSchema(String persistenceUnit, String outputDir, Boolean drop, Boolean create, String delemiter) {
