...
public class PTCreditNoteTemplateBundle extends AbstractTemplateBundle implements PTTemplateBundle {
  ...
  public PTCreditNoteTemplateBundle(String logoImagePath, InputStream xsltFileStream, String softwareCertificationId) {
