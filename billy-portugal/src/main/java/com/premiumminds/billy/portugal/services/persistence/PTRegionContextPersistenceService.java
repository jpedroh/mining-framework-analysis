...
public class PTRegionContextPersistenceService implements PersistenceService<PTRegionContext> {
  ...
  @Inject public PTRegionContextPersistenceService(DAOPTRegionContext daoRegionContext) {
    this.daoRegionContext = daoRegionContext;
  }

  @Override public PTRegionContext create(final Builder<PTRegionContext> builder) {
    try {
      return new TransactionWrapper<PTRegionContext>(this.daoRegionContext) {
        @Override public PTRegionContext runTransaction() throws Exception {
  ...
  @Override public PTRegionContext update(final Builder<PTRegionContext> builder) {
    try {
      return new TransactionWrapper<PTRegionContext>(this.daoRegionContext) {
        @Override public PTRegionContext runTransaction() throws Exception {
          PTRegionContextEntity entity = (PTRegionContextEntity) builder.build();
  ...
  @Override public PTRegionContext get(final UID uid) {
    try {
      return new TransactionWrapper<PTRegionContext>(this.daoRegionContext) {
        @Override public PTRegionContext runTransaction() throws Exception {
