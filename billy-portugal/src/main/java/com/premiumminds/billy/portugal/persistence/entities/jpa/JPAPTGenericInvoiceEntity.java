...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "GENERIC_INVOICE") public class JPAPTGenericInvoiceEntity extends JPAGenericInvoiceEntity implements PTGenericInvoiceEntity {
  private static final long serialVersionUID = 1L;

  @Column(name = "CANCELLED") protected boolean cancelled;

  @Column(name = "EAC_CODE") protected String eacCode;

  @Column(name = "BILLED") protected boolean billed;

  @Column(name = "CHANGE_REASON") protected String reason;

  @Column(name = "HASH") protected String hash;

  @Column(name = "SOURCE_HASH") protected String sourceHash;

  @Column(name = "HASH_CONTROL") protected String hashControl;

  @Column(name = "SOURCE_BILLING") protected SourceBilling sourceBilling;

  @Column(name = "INVOICE_TYPE") protected TYPE type;
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public List<? extends PTGenericInvoiceEntry> getEntries() {
    return (List<PTGenericInvoiceEntry>) super.getEntries();
  }

  @Override public void setSourceBilling(SourceBilling sourceBilling) {
