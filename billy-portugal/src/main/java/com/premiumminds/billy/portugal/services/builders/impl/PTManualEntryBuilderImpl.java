...
public abstract class PTManualEntryBuilderImpl<TBuilder extends PTManualEntryBuilderImpl<TBuilder, TEntry, TDAOEntry, TDAOInvoice>, TEntry extends PTGenericInvoiceEntry, TDAOEntry extends AbstractDAOGenericInvoiceEntry<?>, TDAOInvoice extends AbstractDAOGenericInvoice<?>> extends PTGenericInvoiceEntryBuilderImpl<TBuilder, TEntry, TDAOEntry, TDAOInvoice> implements PTManualInvoiceEntryBuilder<TBuilder, TEntry> {
  public PTManualEntryBuilderImpl(TDAOEntry daoPTEntry, TDAOInvoice daoPTInvoice, DAOPTTax daoPTTax, DAOPTProduct daoPTProduct, DAOPTRegionContext daoPTRegionContext) {
  ...
  @Override protected void validateInstance() throws BillyValidationException {
    ...
    BillyValidator.mandatory(i.getQuantity(), PTGenericInvoiceEntryBuilderImpl.LOCALIZER.getString("field.quantity"));
    BillyValidator.mandatory(i.getUnitOfMeasure(), PTGenericInvoiceEntryBuilderImpl.LOCALIZER.getString("field.unit"));
    ...
    BillyValidator.mandatory(i.getTaxPointDate(), PTGenericInvoiceEntryBuilderImpl.LOCALIZER.getString("field.tax_point_date"));
  }
