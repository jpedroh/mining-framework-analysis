...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "SHIPPING_POINT") public class JPAPTShippingPointEntity extends JPAShippingPointEntity implements PTShippingPointEntity {
