...
public class PTApplicationBuilderImpl<TBuilder extends PTApplicationBuilderImpl<TBuilder, TApplication>, TApplication extends PTApplication> extends ApplicationBuilderImpl<TBuilder, TApplication> implements PTApplicationBuilder<TBuilder, TApplication> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  @Inject public PTApplicationBuilderImpl(DAOPTApplication daoPTApplication) {
    super(daoPTApplication);
  }

  @Override protected PTApplicationEntity getTypeInstance() {
    return (PTApplicationEntity) super.getTypeInstance();
  }

  @Override public TBuilder setSoftwareCertificationNumber(Integer number) {
  ...
  @Override public TBuilder setApplicationKeysPath(URL path) {
  ...
  @Override protected void validateInstance() throws ValidationException {
    ...
    BillyValidator.mandatory(c.getSoftwareCertificationNumber(), PTApplicationBuilderImpl.LOCALIZER.getString("field.certificate_number"));
  }
}