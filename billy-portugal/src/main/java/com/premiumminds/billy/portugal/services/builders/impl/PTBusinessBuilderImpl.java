...
public class PTBusinessBuilderImpl<TBuilder extends PTBusinessBuilderImpl<TBuilder, TBusiness>, TBusiness extends PTBusiness> extends BusinessBuilderImpl<TBuilder, TBusiness> implements PTBusinessBuilder<TBuilder, TBusiness> {
  protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

  @Inject public PTBusinessBuilderImpl(DAOPTBusiness daoBusiness, DAOPTRegionContext daoContext) {
    super(daoBusiness, daoContext);
  }

  @Override @NotOnUpdate public TBuilder setFinancialID(String id, String countryCode) throws InvalidTaxIdentificationNumberException {
  ...
  @Override protected PTBusinessEntity getTypeInstance() {
  ...
  @Override protected void validateInstance() throws BillyValidationException {
    ...
    BillyValidator.mandatory(b.getCommercialName(), PTBusinessBuilderImpl.LOCALIZER.getString("field.commercial_name"));
