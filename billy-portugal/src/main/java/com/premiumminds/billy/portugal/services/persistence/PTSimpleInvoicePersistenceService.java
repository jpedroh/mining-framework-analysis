...
public class PTSimpleInvoicePersistenceService {
  ...
  @Inject public PTSimpleInvoicePersistenceService(DAOPTSimpleInvoice daoInvoice, DAOTicket daoTicket) {
  ...
  public PTSimpleInvoice update(final Builder<PTSimpleInvoice> builder) {
    try {
      return new TransactionWrapper<PTSimpleInvoice>(this.daoInvoice) {
        @Override public PTSimpleInvoice runTransaction() throws Exception {
  ...
  public PTSimpleInvoice getWithTicket(final UID ticketUID) {
    try {
      return new TransactionWrapper<PTSimpleInvoice>(this.daoInvoice) {
        @Override public PTSimpleInvoice runTransaction() throws NoResultException, BillyRuntimeException {
          UID objectUID = PTSimpleInvoicePersistenceService.this.daoTicket.getObjectEntityUID(ticketUID.getValue());
