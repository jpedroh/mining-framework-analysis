...
public class TestInvoiceGenerationAndExport extends PTPersistenceServiceAbstractTest {
  ...
  @Before public void setUp() throws DocumentIssuingException, MalformedURLException {
  }

  @Test public void testExportInvoice() throws SAFTPTExportException, IOException {
  }
}