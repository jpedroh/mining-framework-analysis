...
public class TestConcurrentIssuing extends PTDocumentAbstractTest {
  ...
  class TestRunner implements Callable<PTInvoice> {
    ...
    @Override public PTInvoice call() throws Exception {
      TestConcurrentIssuing.this.parameters.setInvoiceSeries(this.series);
      try {
        PTInvoice invoice = TestConcurrentIssuing.this.service.issue(new PTInvoiceTestUtil(this.injector).getInvoiceBuilder(this.business, SourceBilling.P), TestConcurrentIssuing.this.parameters);
        return invoice;
  ...
  @Test public void testConcurrentIssuing() throws InterruptedException, ExecutionException {
  ...
  @Test public void testConcurrentIssuing2() throws InterruptedException, ExecutionException {
    String B1 = "Business 1";
    PTBusinessEntity businessEntity1 = new PTBusinessTestUtil(PTAbstractTest.injector).getBusinessEntity(B1);
    ConcurrentTestUtil test = new ConcurrentTestUtil(10);
    List<Future<?>> results1 = test.runThreads(new TestRunner(PTAbstractTest.injector, "A", businessEntity1));
    ...
    PTInvoiceEntity entity1 = this.getLatestInvoice(invoices1);
    PTInvoiceEntity entity2 = this.getLatestInvoice(invoices2);
    Integer latestInvoiceNumber = (entity1.getSeriesNumber() < entity2.getSeriesNumber()) ? entity2.getSeriesNumber() : entity1.getSeriesNumber();
  ...
  @Test public void testDifferenteBusinessAndSeries() throws InterruptedException, ExecutionException {
  ...
  @Test public void testMultipleSeriesIssuing() throws InterruptedException, ExecutionException {
    String B1 = "Business 1";
    PTBusinessEntity businessEntity1 = new PTBusinessTestUtil(PTAbstractTest.injector).getBusinessEntity(B1);
  ...
  private <T extends java.lang.Object> List<T> filterNotNull(List<T> in) {
