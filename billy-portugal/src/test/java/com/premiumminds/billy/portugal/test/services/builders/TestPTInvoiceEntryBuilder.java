...
public class TestPTInvoiceEntryBuilder extends PTAbstractTest {
  ...
  @Test public void doTest() {
    MockPTInvoiceEntryEntity mock = this.createMockEntity(MockPTInvoiceEntryEntity.class, TestPTInvoiceEntryBuilder.PT_INVOICE_ENTRY_YML);
    mock.currency = Currency.getInstance("EUR");
    Mockito.when(this.getInstance(DAOPTInvoiceEntry.class).getEntityInstance()).thenReturn(new MockPTInvoiceEntryEntity());
    MockPTInvoiceEntity mockInvoice = this.createMockEntity(MockPTInvoiceEntity.class, TestPTInvoiceEntryBuilder.PT_INVOICE_YML);
    ...
    Mockito.when(this.getInstance(DAOPTRegionContext.class).isSameOrSubContext(Mockito.any(), Mockito.any(Context.class))).thenReturn(true);
