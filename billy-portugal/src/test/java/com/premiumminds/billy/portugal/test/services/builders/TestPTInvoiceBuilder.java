...
public class TestPTInvoiceBuilder extends PTAbstractTest {
  ...
  @Test public void doTest() {
    MockPTInvoiceEntity mock = this.createMockEntity(MockPTInvoiceEntity.class, TestPTInvoiceBuilder.PT_INVOICE_YML);
    mock.setCurrency(Currency.getInstance("EUR"));
    MockPTCustomerEntity mockCustomerEntity = this.createMockEntity(MockPTCustomerEntity.class, TestPTInvoiceBuilder.PTCUSTOMER_YML);
    ...
    MockPTInvoiceEntryEntity entryMock = this.createMockEntity(MockPTInvoiceEntryEntity.class, TestPTInvoiceBuilder.PT_INVOICE_ENTRY_YML);
    ...
    MockPTPaymentEntity mockPayment = this.createMockEntity(MockPTPaymentEntity.class, TestPTInvoiceBuilder.PT_PAYMENT_YML);
