...
public class TestPTGenericInvoiceBuilder extends PTAbstractTest {
  ...
  @Test public void doTest() {
    MockPTGenericInvoiceEntity mock = this.createMockEntity(MockPTGenericInvoiceEntity.class, TestPTGenericInvoiceBuilder.PT_GENERIC_INVOICE_YML);
    MockPTCustomerEntity mockCustomerEntity = this.createMockEntity(MockPTCustomerEntity.class, TestPTGenericInvoiceBuilder.PTCUSTOMER_YML);
    ...
    MockPTGenericInvoiceEntryEntity entryMock = this.createMockEntity(MockPTGenericInvoiceEntryEntity.class, TestPTGenericInvoiceBuilder.PT_GENERIC_INVOICE_ENTRY_YML);
    ...
    MockPTPaymentEntity mockPayment = this.createMockEntity(MockPTPaymentEntity.class, TestPTGenericInvoiceBuilder.PT_PAYMENT_YML);
