...
>>>>>>> /usr/src/app/output/premium-minds/billy/9420e73394b22e375a57d57822bad925e7f9572a/billy-portugal/src/test/java/com/premiumminds/billy/portugal/test/services/documents/handler/TestPTSimpleInvoiceIssuingHandlerWithTicket.java/right.java
      ...
      PTBusinessEntity business = new PTBusinessTestUtil(PTAbstractTest.injector).getBusinessEntity(
<<<<<<< /usr/src/app/output/premium-minds/billy/9420e73394b22e375a57d57822bad925e7f9572a/billy-portugal/src/test/java/com/premiumminds/billy/portugal/test/services/documents/handler/TestPTSimpleInvoiceIssuingHandlerWithTicket.java/left.java
      uid
=======
      business1
>>>>>>> /usr/src/app/output/premium-minds/billy/9420e73394b22e375a57d57822bad925e7f9572a/billy-portugal/src/test/java/com/premiumminds/billy/portugal/test/services/documents/handler/TestPTSimpleInvoiceIssuingHandlerWithTicket.java/right.java
      ...
      PTSimpleInvoice.Builder simpleInvoiceBuilder = new PTSimpleInvoiceTestUtil(PTAbstractTest.injector).getSimpleInvoiceBuilder(business, TestPTSimpleInvoiceIssuingHandlerWithTicket.SOURCE_BILLING, CLIENTTYPE.CUSTOMER);
  ...
  @Test public void testIssuedInvoiceSimpleWithTicket() throws DocumentIssuingException {
    PTSimpleInvoice issuedInvoice = this.getInstance(DAOPTSimpleInvoice.class).get(this.issuedInvoiceUID);
    PTSimpleInvoicePersistenceService service = PTAbstractTest.injector.getInstance(PTSimpleInvoicePersistenceService.class);
    ...
    String formatedNumber = TestPTSimpleInvoiceIssuingHandlerWithTicket.DEFAULT_TYPE + " " + PTPersistencyAbstractTest.DEFAULT_SERIES + "/1";
    Assertions.assertEquals(formatedNumber, issuedInvoice.getNumber());
    Assertions.assertEquals(TestPTSimpleInvoiceIssuingHandlerWithTicket.SOURCE_BILLING, issuedInvoice.getSourceBilling());
  ...
  @Test public void testTicketAssociateEntity() throws DocumentIssuingException {
    PTSimpleInvoicePersistenceService service = PTAbstractTest.injector.getInstance(PTSimpleInvoicePersistenceService.class);
  ...
  @Test public void testIssueWithUsedTicket() {
    Services services = new Services(PTAbstractTest.injector);
    ...
    PTSimpleInvoice.Builder builder = new PTSimpleInvoiceTestUtil(PTAbstractTest.injector).getSimpleInvoiceBuilder(business, TestPTSimpleInvoiceIssuingHandlerWithTicket.SOURCE_BILLING, CLIENTTYPE.CUSTOMER);
    try {
      entity = (PTSimpleInvoiceEntity) services.issueDocument(builder, this.parameters, this.issuedInvoiceUID.getValue());
    } catch (InvalidTicketException e) {
    } catch (DocumentIssuingException e) {
      e.printStackTrace();
    }
  ...
  @Test public void testOpenCloseConnections() {
    Services services = new Services(PTAbstractTest.injector);
    PTSimpleInvoicePersistenceService persistenceService = PTAbstractTest.injector.getInstance(PTSimpleInvoicePersistenceService.class);
    PTBusinessEntity business = new PTBusinessTestUtil(PTAbstractTest.injector).getBusinessEntity("business");
    PTSimpleInvoice.Builder testinvoice = new PTSimpleInvoiceTestUtil(PTAbstractTest.injector).getSimpleInvoiceBuilder(business, TestPTSimpleInvoiceIssuingHandlerWithTicket.SOURCE_BILLING, CLIENTTYPE.CUSTOMER);
