...
public class TestPTSimpleInvoiceIssuingHandler extends PTDocumentAbstractTest {
  ...
  @Test public void testIssuedInvoiceSimple() throws DocumentIssuingException {
    PTSimpleInvoice issuedInvoice = (PTSimpleInvoice) this.getInstance(DAOPTSimpleInvoice.class).get(this.issuedInvoiceUID);
  ...
  @Test(expected = BillySimpleInvoiceException.class) public void testBusinessSimpleInvoice() {

<<<<<<< /usr/src/app/output/premium-minds/billy/e481179c9fa61835d2db73bd8cdcb9f47123f892/billy-portugal/src/test/java/com/premiumminds/billy/portugal/test/services/documents/handler/TestPTSimpleInvoiceIssuingHandler.java/left.java
...
>>>>>>> /usr/src/app/output/premium-minds/billy/e481179c9fa61835d2db73bd8cdcb9f47123f892/billy-portugal/src/test/java/com/premiumminds/billy/portugal/test/services/documents/handler/TestPTSimpleInvoiceIssuingHandler.java/right.java
  }
}