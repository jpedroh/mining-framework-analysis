...
public class PTBusinessTestUtil {
  ...
  public PTBusiness.Builder getBusinessBuilder() {
    ...
    businessBuilder.addApplication(applicationBuilder).addContact(contactBuilder, true).setAddress(addressBuilder).setBillingAddress(addressBuilder).setCommercialName(PTBusinessTestUtil.NAME).setFinancialID(PTBusinessTestUtil.FINANCIAL_ID, PTBusinessTestUtil.PT_COUNTRY_CODE).setOperationalContextUID(this.context.getUID()).setWebsite(PTBusinessTestUtil.WEBSITE).setName(PTBusinessTestUtil.NAME);
