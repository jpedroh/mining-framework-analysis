...
public class TestPTApplicationBuilder extends PTAbstractTest {
  ...
  @Test public void doTest() throws MalformedURLException {
    MockPTApplicationEntity mockApplication = this.createMockEntity(MockPTApplicationEntity.class, TestPTApplicationBuilder.PTAPPLICATION_YML);
    Mockito.when(this.getInstance(DAOPTApplication.class).getEntityInstance()).thenReturn(new MockPTApplicationEntity());
    ...
    Assert.assertEquals(mockApplication.getDeveloperCompanyTaxIdentifier(), application.getDeveloperCompanyTaxIdentifier());
    Assert.assertEquals(mockApplication.getWebsiteAddress(), application.getWebsiteAddress());
    Assert.assertEquals(mockApplication.getSoftwareCertificationNumber(), application.getSoftwareCertificationNumber());
    Assert.assertEquals(mockApplication.getApplicationKeysPath(), application.getApplicationKeysPath());
