...
public class TestPTSimpleInvoiceBuilder extends PTAbstractTest {
  ...
  @Test public void doTest() {
    MockPTSimpleInvoiceEntity mock = this.createMockEntity(MockPTSimpleInvoiceEntity.class, TestPTSimpleInvoiceBuilder.PT_INVOICE_YML);
    MockPTCustomerEntity mockCustomerEntity = this.createMockEntity(MockPTCustomerEntity.class, TestPTSimpleInvoiceBuilder.PTCUSTOMER_YML);
    ...
    MockPTInvoiceEntryEntity entryMock = this.createMockEntity(MockPTInvoiceEntryEntity.class, TestPTSimpleInvoiceBuilder.PT_INVOICE_ENTRY_YML);
    ...
    MockPTPaymentEntity mockPayment = this.createMockEntity(MockPTPaymentEntity.class, TestPTSimpleInvoiceBuilder.PT_PAYMENT_YML);
