...
public class TestPTManualInvoiceIssuingHandler extends PTDocumentAbstractTest {
  ...
  @Before public void setUpNewManualInvoice() {
    ...
    try {
      PTInvoiceEntity invoice = this.newInvoice(TestPTManualInvoiceIssuingHandler.DEFAULT_TYPE, TestPTManualInvoiceIssuingHandler.SOURCE_BILLING);
  ...
  @Test public void testIssuedManualInvoiceSimple() throws DocumentIssuingException {
    ...
    String formatedNumber = TestPTManualInvoiceIssuingHandler.DEFAULT_TYPE + " " + PTPersistencyAbstractTest.DEFAULT_SERIES + "/1";
  ...
  /**
     ...
     */
  @Test(expected = InvalidSourceBillingException.class) public void testDifferentBilling() throws DocumentIssuingException {
    PTInvoiceEntity issuedInvoice = this.getInstance(DAOPTInvoice.class).get(this.issuedInvoiceUID);
    PTInvoiceEntity normalInvoice = this.newInvoice(TestPTManualInvoiceIssuingHandler.DEFAULT_TYPE, SourceBilling.P);
