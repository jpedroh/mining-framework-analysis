...
public class PTPersistencyAbstractTest extends PTAbstractTest {
  ...
  protected void createSeries(String businessUID) {
    this.createSeries(new PTReceiptInvoiceTestUtil(PTAbstractTest.injector).getReceiptInvoiceBuilder(new PTBusinessTestUtil(PTAbstractTest.injector).getBusinessEntity(businessUID), SourceBilling.P).build(), PTPersistencyAbstractTest.DEFAULT_SERIES, Optional.of("CCCC2345"));
  }

  protected void createSeries(String businessUID, String series) {
    this.createSeries(new PTReceiptInvoiceTestUtil(PTAbstractTest.injector).getReceiptInvoiceBuilder(new PTBusinessTestUtil(PTAbstractTest.injector).getBusinessEntity(businessUID), SourceBilling.P).build(), series, Optional.of("CCCC2345"));
  }
