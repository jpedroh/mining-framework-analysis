...
public class TestPTInvoiceIssuingHandler extends PTDocumentAbstractTest {
  ...
  @BeforeEach public void setUpNewInvoice() {
    ...
    try {
      PTInvoiceEntity invoice = this.newInvoice(TestPTInvoiceIssuingHandler.DEFAULT_TYPE, TestPTInvoiceIssuingHandler.SOURCE_BILLING);
  ...
  @Test public void testIssuedInvoiceSimple() throws DocumentIssuingException {
    ...
    String formatedNumber = TestPTInvoiceIssuingHandler.DEFAULT_TYPE + " " + PTPersistencyAbstractTest.DEFAULT_SERIES + "/1";
  ...
  @Test public void testIssuedInvoiceSameSeries() throws DocumentIssuingException, SeriesUniqueCodeNotFilled, DocumentSeriesDoesNotExistException {
    ...
    PTGenericInvoiceEntity newInvoice = this.newInvoice(TestPTInvoiceIssuingHandler.DEFAULT_TYPE, TestPTInvoiceIssuingHandler.SOURCE_BILLING);
    ...
    String formatedNumber = TestPTInvoiceIssuingHandler.DEFAULT_TYPE + " " + PTPersistencyAbstractTest.DEFAULT_SERIES + "/" + nextNumber;
  ...
  /**
     ...
     */
  @Test public void testIssuedInvoiceFailure() throws DocumentIssuingException, SeriesUniqueCodeNotFilled, DocumentSeriesDoesNotExistException {
    String series = "NEWSERIES";
    PTGenericInvoiceEntity invoice = this.newInvoice(TestPTInvoiceIssuingHandler.DEFAULT_TYPE, TestPTInvoiceIssuingHandler.SOURCE_BILLING);
    ...
    PTGenericInvoiceEntity diffentTypeInvoice = this.newInvoice(TYPE.FS, TestPTInvoiceIssuingHandler.SOURCE_BILLING);
  ...
  @Test public void testIssuedInvoiceFailureWithInvalidSeriesAndInvoiceNumber() {
  ...
  @Test public void testIssuedInvoiceFailWhenSeriesHasNoUniqueCode() {
    PTGenericInvoiceEntity newInvoice = this.newInvoice(TestPTInvoiceIssuingHandler.DEFAULT_TYPE, TestPTInvoiceIssuingHandler.SOURCE_BILLING);
    this.createSeries(newInvoice, PTPersistencyAbstractTest.DEFAULT_SERIES, Optional.empty());
    Assertions.assertThrows(SeriesUniqueCodeNotFilled.class, () -> this.issueNewInvoice(this.handler, newInvoice, PTPersistencyAbstractTest.DEFAULT_SERIES));
  }

  @Test public void testSeriesDoesNotExist() {
    final PTInvoiceEntity invoiceEntity = this.newInvoice(TestPTInvoiceIssuingHandler.DEFAULT_TYPE, TestPTInvoiceIssuingHandler.SOURCE_BILLING);
    Assertions.assertThrows(DocumentSeriesDoesNotExistException.class, () -> this.issueNewInvoice(this.handler, invoiceEntity, "ARANDOMSERIES"));
  }

  @Test public void testIssuedInvoiceFailWhenSeriesUniqueCodeIsInvalid() {
    PTGenericInvoiceEntity newInvoice = this.newInvoice(TestPTInvoiceIssuingHandler.DEFAULT_TYPE, TestPTInvoiceIssuingHandler.SOURCE_BILLING);
    this.createSeries(newInvoice, PTPersistencyAbstractTest.DEFAULT_SERIES, Optional.of("12345"));
    Assertions.assertThrows(DocumentIssuingException.class, () -> this.issueNewInvoice(this.handler, newInvoice, PTPersistencyAbstractTest.DEFAULT_SERIES));
  }
}