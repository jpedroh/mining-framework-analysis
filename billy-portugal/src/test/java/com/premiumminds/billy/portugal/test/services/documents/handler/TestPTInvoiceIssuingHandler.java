...
public class TestPTInvoiceIssuingHandler extends PTDocumentAbstractTest {
  ...
  @Test public void testIssuedInvoiceSameSeries() throws DocumentIssuingException {
    PTInvoice issuedInvoice = this.getInstance(DAOPTInvoice.class).get(this.issuedInvoiceUID);
  ...
  @Test public void testIssuedInvoiceDifferentSeries() throws DocumentIssuingException {
  ...
  /**
     ...
     */
  @Test(expected = InvalidInvoiceTypeException.class) public void testIssuedInvoiceFailure() throws DocumentIssuingException {
  ...
  @Test public void testIssuedInvoiceSameSourceBilling() throws DocumentIssuingException {
    PTGenericInvoiceEntity newInvoice = this.newInvoice(TestPTInvoiceIssuingHandler.DEFAULT_TYPE, TestPTInvoiceIssuingHandler.SOURCE_BILLING);
    UID newInvoiceUID = newInvoice.getUID();
    this.issueNewInvoice(this.handler, newInvoice, PTPersistencyAbstractTest.DEFAULT_SERIES);
    PTInvoice issuedInvoice = this.getInstance(DAOPTInvoice.class).get(newInvoiceUID);
