...
public class SAFTExportTest extends PTPersistencyAbstractTest {
  ...
  @Before public void setUp() {
    ...
    this.service.addHandler(PTInvoiceEntity.class, PTAbstractTest.injector.getInstance(PTInvoiceIssuingHandler.class));
    this.service.addHandler(PTSimpleInvoiceEntity.class, PTAbstractTest.injector.getInstance(PTSimpleInvoiceIssuingHandler.class));
    this.service.addHandler(PTReceiptInvoiceEntity.class, PTAbstractTest.injector.getInstance(PTReceiptInvoiceIssuingHandler.class));
    this.service.addHandler(PTCreditNoteEntity.class, PTAbstractTest.injector.getInstance(PTCreditNoteIssuingHandler.class));
  ...
  @Test public void doTest() throws Exception {
    ...
    PTAddress.Builder addressBuilder2 = address.getAddressBuilder("Av. Liberdade", "N\u00ba 4 - 5\u00ba Dir.", "Av. Liberdade, N\u00ba 4 - 5\u00ba Dir.", "nr building", "Lisboa", "1500-123", "Lisboa", "PT");
    PTAddress.Builder addressBuilder3 = address.getAddressBuilder("Campo Grande", "Condom\u00ednio X", "Lote 20, Andar 3", "Building nr K", "Lisboa", "1000-253", "Lisboa", "PT");
    PTContact.Builder contactBuilder = contact.getContactBuilder("My Business", "299999999", "999999999", "299999998", "mybusiness@email.me", "http://www.mybusiness.web");
    PTContact.Builder contactBuilder2 = contact.getContactBuilder("Z\u00e9", "299999991", "999999991", "299999992", "maildoze@email.me", "http://www.zenaweb.web");
    PTContact.Builder contactBuilder3 = contact.getContactBuilder("YourSupplier", "299999993", "999999993", "299999994", "maildoyourbusiness@email.me", "http://www.yourbusinessnaweb.web");
    PTApplication.Builder applicationBuilder = application.getApplicationBuilder("APP", "1.0", "My Business", "500001758", "hhtp://www.app.mybusiness.web", 1, "http://here", contactBuilder);
    ...
    PTCustomer.Builder customerBuilder = customer.getCustomerBuilder("Z\u00e9", "213512351", false, addressBuilder2, contactBuilder2);
    ...
    PTSupplier.Builder supplierBuilder = supplier.getSupplierBuilder("YourSupplier", "500001758", false, addressBuilder3, contactBuilder3);
    ...
    PTInvoiceEntity invoiceEntity = (PTInvoiceEntity) this.service.issue(invoice.getInvoiceBuilder(businessEntity, SourceBilling.P), this.parameters);
    ...
    this.service.issue(simpleInvoice.getSimpleInvoiceBuilder(businessEntity, SourceBilling.P, CLIENTTYPE.CUSTOMER), this.parameters);
    ...
    this.exportSAFT(daoPTRegionContext, applicationEntity, businessEntity, daoPTCustomer, daoPTSupplier, daoPTTax, daoPTProduct, daoPTInvoice, daoPTSimpleInvoice, daoPTReceiptInvoice, daoPTCreditNote);
  }

  private void exportSAFT(DAOPTRegionContext daoPTRegionContext, PTApplicationEntity applicationEntity, PTBusinessEntity businessEntity, DAOPTCustomer daoPTCustomer, DAOPTSupplier daoPTSupplier, DAOPTTax daoPTTax, DAOPTProduct daoPTProduct, DAOPTInvoice daoPTInvoice, DAOPTSimpleInvoice daoPTSimpleInvoice, DAOPTReceiptInvoice daoPTReceiptInvoice, DAOPTCreditNote daoPTCreditNote) throws FileNotFoundException, SAFTPTExportException {
    ...
    generator.generateSAFTFile(stream, businessEntity, applicationEntity, "1234", calendar.getTime(), new Date(), SAFTVersion.V10201);
    stream = new PrintStream(SAFTExportTest.SAFT_OUTPUT + "SAFT_10301.xml");
    generator.generateSAFTFile(stream, businessEntity, applicationEntity, "1234", calendar.getTime(), new Date(), SAFTVersion.V10301);
  }
}