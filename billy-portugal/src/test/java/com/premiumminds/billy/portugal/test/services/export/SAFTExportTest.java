...
public class SAFTExportTest extends PTPersistencyAbstractTest {
  ...
  private void exportSAFT(PTApplicationEntity applicationEntity, PTBusinessEntity businessEntity) throws FileNotFoundException, SAFTPTExportException {
    ...
    generator.generateSAFTFile(stream, businessEntity, applicationEntity, calendar.getTime(), new Date(), SAFTVersion.V10201, true);
    stream = new PrintStream(SAFTExportTest.SAFT_OUTPUT + "SAFT_10301.xml");
    generator.generateSAFTFile(stream, businessEntity, applicationEntity, calendar.getTime(), new Date(), SAFTVersion.V10301, true);
    stream = new PrintStream(SAFTExportTest.SAFT_OUTPUT + "SAFT_10401.xml");
    generator.generateSAFTFile(stream, businessEntity, applicationEntity, calendar.getTime(), new Date(), SAFTVersion.V10401, true);
    stream = new PrintStream(SAFTExportTest.SAFT_OUTPUT + "SAFT_current.xml");
    generator.generateSAFTFile(stream, businessEntity, applicationEntity, calendar.getTime(), new Date(), SAFTVersion.CURRENT, true);
  }
}