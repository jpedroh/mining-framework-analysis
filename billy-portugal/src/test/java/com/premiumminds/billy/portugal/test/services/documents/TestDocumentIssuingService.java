...
public class TestDocumentIssuingService extends PTDocumentAbstractTest {
  ...
  @Test public void testIssuingService() throws DocumentIssuingException {
    this.service.issue(new PTInvoiceTestUtil(PTAbstractTest.injector).getInvoiceBuilder(new PTBusinessTestUtil(PTAbstractTest.injector).getBusinessEntity(), SourceBilling.P), this.parameters);
  }
}