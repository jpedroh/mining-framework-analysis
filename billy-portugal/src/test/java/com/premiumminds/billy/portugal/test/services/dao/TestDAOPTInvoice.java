...
public class TestDAOPTInvoice extends PTPersistencyAbstractTest {
  ...
  @Test public void testInvoiceFromBusiness() {
    ...
    Assertions.assertNull(this.getInstance(DAOPTInvoice.class).findByNumber(com.premiumminds.billy.core.services.UID.fromString("INEXISTENT_BUSINESS"), inv1.getNumber()));
  }
