...
public class RepositoryServiceImpl implements RepositoryService, DavConstants {
  ...
  public RepositoryServiceImpl(String uri, IdFactory idFactory, NameFactory nameFactory, PathFactory pathFactory, QValueFactory qValueFactory, int itemInfoCacheSize, boolean allowInsecureHttps) throws RepositoryException {
  ...
  /**
     ...
     * @throws RepositoryException If an error occurs.
     */
  public RepositoryServiceImpl(String uri, IdFactory idFactory, NameFactory nameFactory, PathFactory pathFactory, QValueFactory qValueFactory, int itemInfoCacheSize, int maximumHttpConnections, boolean allowInsecureHttps) throws RepositoryException {
  ...
  private static String generateLinkHeaderFieldValue(SessionInfo sessionInfo, boolean isReadAccess) {
    ...
    linkHeaderField.append("<").append(sessionIdentifier).append(">; rel=\"").append(JcrRemotingConstants.RELATION_REMOTE_SESSION_ID).append("\"");
    String userdata = ((SessionInfoImpl) sessionInfo).getUserData();
    if (userdata != null && !isReadAccess) {
      String escaped = Text.escape(userdata);
      linkHeaderField.append(", <data:,").append(escaped).append(">; rel=\"").append(JcrRemotingConstants.RELATION_USER_DATA).append("\"");
    }
  ...
  @Override public IdFactory getIdFactory() {
    return idFactory;
  }

  @Override public NameFactory getNameFactory() {
    return nameFactory;
  }

  @Override public PathFactory getPathFactory() {
    return pathFactory;
  }

  @Override public QValueFactory getQValueFactory() {
    return qValueFactory;
  }

  @Override public ItemInfoCache getItemInfoCache(SessionInfo sessionInfo) throws RepositoryException {
    return new ItemInfoCacheImpl(itemInfoCacheSize);
  }

  @Override public Map<String, QValue[]> getRepositoryDescriptors() throws RepositoryException {
  ...
  @Override public SessionInfo obtain(Credentials credentials, String workspaceName) throws RepositoryException {
    CredentialsWrapper dc = new CredentialsWrapper(credentials);
    return obtain(dc, workspaceName);
  }

  @Override public SessionInfo obtain(SessionInfo sessionInfo, String workspaceName) throws RepositoryException {
    checkSessionInfo(sessionInfo);
    return obtain(((SessionInfoImpl) sessionInfo).getCredentials(), workspaceName);
  }

  @Override public SessionInfo impersonate(SessionInfo sessionInfo, Credentials credentials) throws RepositoryException {
  ...
  @Override public void dispose(SessionInfo sessionInfo) throws RepositoryException {
    checkSessionInfo(sessionInfo);
    removeClient(sessionInfo);
  }

  @Override public String[] getWorkspaceNames(SessionInfo sessionInfo) throws RepositoryException {
    DavPropertyNameSet nameSet = new DavPropertyNameSet();
    nameSet.add(DeltaVConstants.WORKSPACE);
    HttpPropfind request = null;
    try {
  ...
  @Override public boolean isGranted(SessionInfo sessionInfo, ItemId itemId, String[] actions) throws RepositoryException {
    HttpReport request = null;
    try {
  ...
  @Override public PrivilegeDefinition[] getPrivilegeDefinitions(SessionInfo sessionInfo) throws RepositoryException {
    return internalGetPrivilegeDefinitions(sessionInfo, uriResolver.getRepositoryUri());
  }

  @Override public PrivilegeDefinition[] getSupportedPrivileges(SessionInfo sessionInfo, NodeId nodeId) throws RepositoryException {
  ...
  @Override public Name[] getPrivilegeNames(SessionInfo sessionInfo, NodeId nodeId) throws RepositoryException {
    String uri = (nodeId == null) ? uriResolver.getWorkspaceUri(sessionInfo.getWorkspaceName()) : getItemUri(nodeId, sessionInfo);
    DavPropertyNameSet nameSet = new DavPropertyNameSet();
  ...
  @Override public QNodeDefinition getNodeDefinition(SessionInfo sessionInfo, NodeId nodeId) throws RepositoryException {
    return (QNodeDefinition) getItemDefinition(sessionInfo, nodeId);
  }

  @Override public QPropertyDefinition getPropertyDefinition(SessionInfo sessionInfo, PropertyId propertyId) throws RepositoryException {
  ...
  @Override public NodeInfo getNodeInfo(SessionInfo sessionInfo, NodeId nodeId) throws RepositoryException {
    DavPropertyNameSet nameSet = new DavPropertyNameSet();
  ...
  @Override public Iterator<? extends ItemInfo> getItemInfos(SessionInfo sessionInfo, ItemId itemId) throws RepositoryException {
    if (itemId.denotesNode()) {
  ...
  @Override public Iterator<ChildInfo> getChildInfos(SessionInfo sessionInfo, NodeId parentId) throws RepositoryException {
    DavPropertyNameSet nameSet = new DavPropertyNameSet();
    nameSet.add(JcrRemotingConstants.JCR_NAME_LN, ItemResourceConstants.NAMESPACE);
    nameSet.add(JcrRemotingConstants.JCR_INDEX_LN, ItemResourceConstants.NAMESPACE);
    nameSet.add(JcrRemotingConstants.JCR_PARENT_LN, ItemResourceConstants.NAMESPACE);
  ...
  @Override public Iterator<PropertyId> getReferences(SessionInfo sessionInfo, NodeId nodeId, Name propertyName, boolean weakReferences) throws RepositoryException {
    DavPropertyNameSet nameSet = new DavPropertyNameSet();
  ...
  @Override public PropertyInfo getPropertyInfo(SessionInfo sessionInfo, PropertyId propertyId) throws RepositoryException {
    ...
    try {
      ...
      if (ct != null && ct.getMimeType().startsWith("jcr-value")) {
        ...
        if (ct != null && ct.getMimeType().equals("text/xml")) {
  ...
  @Override public Batch createBatch(SessionInfo sessionInfo, ItemId itemId) throws RepositoryException {
    checkSessionInfo(sessionInfo);
    return new BatchImpl(itemId, sessionInfo);
  }

  @Override public void submit(Batch batch) throws RepositoryException {
  ...
  @Override public Tree createTree(SessionInfo sessionInfo, Batch batch, Name nodeName, Name primaryTypeName, String uniqueId) throws RepositoryException {
    return new DocumentTree(nodeName, primaryTypeName, uniqueId, getNamePathResolver(sessionInfo));
  }

  @Override public void importXml(SessionInfo sessionInfo, NodeId parentId, InputStream xmlStream, int uuidBehaviour) throws RepositoryException {
  ...
  @Override public void move(SessionInfo sessionInfo, NodeId srcNodeId, NodeId destParentNodeId, Name destName) throws RepositoryException {
  ...
  @Override public void copy(SessionInfo sessionInfo, String srcWorkspaceName, NodeId srcNodeId, NodeId destParentNodeId, Name destName) throws RepositoryException {
  ...
  @Override public void update(SessionInfo sessionInfo, NodeId nodeId, String srcWorkspaceName) throws RepositoryException {
    String uri = getItemUri(nodeId, sessionInfo);
  ...
  @Override public void clone(SessionInfo sessionInfo, String srcWorkspaceName, NodeId srcNodeId, NodeId destParentNodeId, Name destName, boolean removeExisting) throws RepositoryException {
    throw new UnsupportedOperationException("Missing implementation");
  }

  @Override public LockInfo getLockInfo(SessionInfo sessionInfo, NodeId nodeId) throws RepositoryException {
    DavPropertyNameSet nameSet = new DavPropertyNameSet();
  ...
  @Override public LockInfo lock(SessionInfo sessionInfo, NodeId nodeId, boolean deep, boolean sessionScoped) throws RepositoryException {
    return lock(sessionInfo, nodeId, deep, sessionScoped, Long.MAX_VALUE, null);
  }

  @Override public LockInfo lock(SessionInfo sessionInfo, NodeId nodeId, boolean deep, boolean sessionScoped, long timeoutHint, String ownerHint) throws RepositoryException {
  ...
  @Override public void refreshLock(SessionInfo sessionInfo, NodeId nodeId) throws RepositoryException {
    checkSessionInfo(sessionInfo);
    String uri = getItemUri(nodeId, sessionInfo);
    Set<String> allLockTokens = ((SessionInfoImpl) sessionInfo).getAllLockTokens();
    String[] locktokens = allLockTokens.toArray(new String[allLockTokens.size()]);
  ...
  @Override public void unlock(SessionInfo sessionInfo, NodeId nodeId) throws RepositoryException {
    checkSessionInfo(sessionInfo);
    String uri = getItemUri(nodeId, sessionInfo);
  ...
  @Override public NodeId checkin(SessionInfo sessionInfo, NodeId nodeId) throws RepositoryException {
    String uri = getItemUri(nodeId, sessionInfo);
  ...
  @Override public void checkout(SessionInfo sessionInfo, NodeId nodeId) throws RepositoryException {
    String uri = getItemUri(nodeId, sessionInfo);
  ...
  @Override public void checkout(SessionInfo sessionInfo, NodeId nodeId, NodeId activityId) throws RepositoryException {
    if (activityId == null) {
  ...
  @Override public NodeId checkpoint(SessionInfo sessionInfo, NodeId nodeId) throws RepositoryException {
    NodeId vID = checkin(sessionInfo, nodeId);
    checkout(sessionInfo, nodeId);
    return vID;
  }

  @Override public NodeId checkpoint(SessionInfo sessionInfo, NodeId nodeId, NodeId activityId) throws RepositoryException {
    if (activityId == null) {
  ...
  @Override public void removeVersion(SessionInfo sessionInfo, NodeId versionHistoryId, NodeId versionId) throws RepositoryException {
  ...
  @Override public void restore(SessionInfo sessionInfo, NodeId nodeId, NodeId versionId, boolean removeExisting) throws RepositoryException {
    String uri = getItemUri(nodeId, sessionInfo);
  ...
  @Override public void restore(SessionInfo sessionInfo, NodeId[] versionIds, boolean removeExisting) throws RepositoryException {
  ...
  @Override public Iterator<NodeId> merge(SessionInfo sessionInfo, NodeId nodeId, String srcWorkspaceName, boolean bestEffort) throws RepositoryException {
    return merge(sessionInfo, nodeId, srcWorkspaceName, bestEffort, false);
  }

  @Override public Iterator<NodeId> merge(SessionInfo sessionInfo, NodeId nodeId, String srcWorkspaceName, boolean bestEffort, boolean isShallow) throws RepositoryException {
  ...
  @Override public void resolveMergeConflict(SessionInfo sessionInfo, NodeId nodeId, NodeId[] mergeFailedIds, NodeId[] predecessorIds) throws RepositoryException {
  ...
  @Override public void addVersionLabel(SessionInfo sessionInfo, NodeId versionHistoryId, NodeId versionId, Name label, boolean moveLabel) throws RepositoryException {
  ...
  @Override public void removeVersionLabel(SessionInfo sessionInfo, NodeId versionHistoryId, NodeId versionId, Name label) throws RepositoryException {
    HttpLabel request = null;
    try {
      String uri = getItemUri(versionId, sessionInfo);
      String strLabel = getNamePathResolver(sessionInfo).getJCRName(label);
  ...
  @Override public NodeId createActivity(SessionInfo sessionInfo, String title) throws RepositoryException {
    throw new UnsupportedOperationException("JCR-2104: JSR 283 Versioning. Implementation missing");
  }

  @Override public void removeActivity(SessionInfo sessionInfo, NodeId activityId) throws RepositoryException {
    throw new UnsupportedOperationException("JCR-2104: JSR 283 Versioning. Implementation missing");
  }

  @Override public Iterator<NodeId> mergeActivity(SessionInfo sessionInfo, NodeId activityId) throws RepositoryException {
    throw new UnsupportedOperationException("JCR-2104: JSR 283 Versioning. Implementation missing");
  }

  @Override public NodeId createConfiguration(SessionInfo sessionInfo, NodeId nodeId) throws RepositoryException {
    throw new UnsupportedOperationException("JCR-2104: JSR 283 Versioning. Implementation missing");
  }

  @Override public String[] getSupportedQueryLanguages(SessionInfo sessionInfo) throws RepositoryException {
  ...
  @Override public String[] checkQueryStatement(SessionInfo sessionInfo, String statement, String language, Map<String, String> namespaces) throws RepositoryException {
    return new String[0];
  }

  @Override public QueryInfo executeQuery(SessionInfo sessionInfo, String statement, String language, Map<String, String> namespaces, long limit, long offset, Map<String, QValue> values) throws RepositoryException {
  ...
  @Override public EventFilter createEventFilter(SessionInfo sessionInfo, int eventTypes, Path absPath, boolean isDeep, String[] uuids, Name[] nodeTypeNames, boolean noLocal) throws RepositoryException {
  ...
  @Override public EventBundle[] getEvents(Subscription subscription, long timeout) throws RepositoryException {
  ...
  @Override public EventBundle getEvents(SessionInfo sessionInfo, EventFilter filter, long after) throws RepositoryException {
    HttpGet request = null;
  ...
  @Override public Subscription createSubscription(SessionInfo sessionInfo, EventFilter[] filters) throws RepositoryException {
    checkSessionInfo(sessionInfo);
  ...
  @Override public void updateEventFilters(Subscription subscription, EventFilter[] filters) throws RepositoryException {
    checkEventFilterSupport(filters);
  }
  ...
  @Override public void dispose(Subscription subscription) throws RepositoryException {
    checkSubscription(subscription);
    EventSubscriptionImpl subscr = (EventSubscriptionImpl) subscription;
    String rootUri = uriResolver.getRootItemUri(subscr.getSessionInfo().getWorkspaceName());
  ...
  @Override public Map<String, String> getRegisteredNamespaces(SessionInfo sessionInfo) throws RepositoryException {
  ...
  @Override public String getNamespaceURI(SessionInfo sessionInfo, String prefix) throws RepositoryException {
    try {
  ...
  @Override public String getNamespacePrefix(SessionInfo sessionInfo, String uri) throws RepositoryException {
    try {
  ...
  @Override public void registerNamespace(SessionInfo sessionInfo, String prefix, String uri) throws RepositoryException {
    getRegisteredNamespaces(sessionInfo);
  ...
  @Override public void unregisterNamespace(SessionInfo sessionInfo, String uri) throws RepositoryException {
    getRegisteredNamespaces(sessionInfo);
  ...
  @Override public Iterator<QNodeTypeDefinition> getQNodeTypeDefinitions(SessionInfo sessionInfo) throws RepositoryException {
    HttpReport request = null;
    try {
  ...
  @Override public Iterator<QNodeTypeDefinition> getQNodeTypeDefinitions(SessionInfo sessionInfo, Name[] nodetypeNames) throws RepositoryException {
    return getQNodeTypeDefinitions(sessionInfo);
  }

  @Override public void registerNodeTypes(SessionInfo sessionInfo, QNodeTypeDefinition[] nodeTypeDefinitions, boolean allowUpdate) throws RepositoryException {
    HttpProppatch request = null;
    try {
      DavPropertySet setProperties = new DavPropertySet();
  ...
  @Override public void unregisterNodeTypes(SessionInfo sessionInfo, Name[] nodeTypeNames) throws RepositoryException {
    HttpProppatch request = null;
    try {
      DavPropertySet setProperties = new DavPropertySet();
  ...
  @Override public void createWorkspace(SessionInfo sessionInfo, String name, String srcWorkspaceName) throws RepositoryException {
  ...
  @Override public void deleteWorkspace(SessionInfo sessionInfo, String name) throws RepositoryException {
  ...
  private class BatchImpl implements Batch {
    ...
    @Override public void addNode(NodeId parentId, Name nodeName, Name nodetypeName, String uuid) throws RepositoryException {
      checkConsumed();
      try {
    ...
    @Override public void addProperty(NodeId parentId, Name propertyName, QValue value) throws RepositoryException {
      checkConsumed();
    ...
    @Override public void addProperty(NodeId parentId, Name propertyName, QValue[] values) throws RepositoryException {
      checkConsumed();
      try {
        String uri = getItemUri(parentId, propertyName, sessionInfo);
    ...
    @Override public void setValue(PropertyId propertyId, QValue value) throws RepositoryException {
      checkConsumed();
      if (value == null) {
        remove(propertyId);
      } else {
    ...
    @Override public void setValue(PropertyId propertyId, QValue[] values) throws RepositoryException {
      checkConsumed();
      if (values == null) {
        remove(propertyId);
      } else {
    ...
    @Override public void remove(ItemId itemId) throws RepositoryException {
      checkConsumed();
      String uri = getItemUri(itemId, sessionInfo);
      HttpDelete request = new HttpDelete(uri);
      requests.add(request);
    ...
    @Override public void reorderNodes(NodeId parentId, NodeId srcNodeId, NodeId beforeNodeId) throws RepositoryException {
      checkConsumed();
      try {
        String uri = getItemUri(parentId, sessionInfo);
    ...
    @Override public void setMixins(NodeId nodeId, Name[] mixinNodeTypeIds) throws RepositoryException {
      checkConsumed();
      try {
    ...
    @Override public void setPrimaryType(NodeId nodeId, Name primaryNodeTypeName) throws RepositoryException {
      checkConsumed();
      try {
        DavPropertySet setProperties = new DavPropertySet();
    ...
    @Override public void move(NodeId srcNodeId, NodeId destParentNodeId, Name destName) throws RepositoryException {
      checkConsumed();
      String uri = getItemUri(srcNodeId, sessionInfo);
      String destUri = getItemUri(destParentNodeId, destName, sessionInfo);
      if (isDavClass3(sessionInfo)) {
    ...
    @Override public void setTree(NodeId parentId, Tree tree) throws RepositoryException {
      checkConsumed();
  ...
  private class NamespaceResolverImpl implements NamespaceResolver {
    ...
    @Override public String getURI(String prefix) throws NamespaceException {
      try {
    ...
    @Override public String getPrefix(String uri) throws NamespaceException {
      try {
  ...
  private class IdentifierResolverImpl implements IdentifierResolver {
    ...
    @Override public Path getPath(String identifier) throws MalformedPathException {
      try {
    ...
    @Override public void checkFormat(String identifier) throws MalformedPathException {
    }
  }
  ...
  private class NamePathResolverImpl implements NamePathResolver {
    ...
    @Override public Name getQName(String jcrName) throws IllegalNameException, NamespaceException {
      return nResolver.getQName(jcrName);
    }

    @Override public String getJCRName(Name qName) throws NamespaceException {
      return nResolver.getJCRName(qName);
    }

    @Override public Path getQPath(String path) throws MalformedPathException, IllegalNameException, NamespaceException {
      return pResolver.getQPath(path);
    }

    @Override public Path getQPath(String path, boolean normalizeIdentifier) throws MalformedPathException, IllegalNameException, NamespaceException {
      return pResolver.getQPath(path, normalizeIdentifier);
    }

    @Override public String getJCRPath(Path path) throws NamespaceException {
