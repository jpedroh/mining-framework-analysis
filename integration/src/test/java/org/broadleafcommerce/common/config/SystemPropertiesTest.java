...
@ContextHierarchy(value = @ContextConfiguration(name = "siteRoot")) public class SystemPropertiesTest extends TestNGSiteIntegrationSetup {
  public static class SystemPropertiesTestConfig implements FrameworkCommonClasspathPropertySource {
    @Override public String getClasspathFolder() {
  ...
  @Autowired protected SystemPropertiesDao propsDao;

  @Test @Transactional public void testEnvironmentResolvedFromDatabase() {
  ...
  @Test @Transactional public void testOverridesPropertyFiles() {
