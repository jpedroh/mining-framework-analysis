...
public class OfferAuditTest extends CommonSetupBaseTest {
  ...
  @Resource private OfferAuditDao offerAuditDao;
  ...
  @Test(groups = { "offerCreateSku1" }, dataProvider = "basicSku", dataProviderClass = SkuDaoDataProvider.class) @Rollback(value = false) public void createSku(Sku sku) {
  ...
  @Test(groups = { "testPercentageOffOffer" }, dependsOnGroups = { "offerCreateSku1" }) @Transactional public void testMinimumDaysPerUsageAudit() throws Exception {
    Offer offer = offerUtil.createOffer("10 Percent Off All Item Offer", OfferType.ORDER_ITEM, OfferDiscountType.PERCENT_OFF, 10, null, false, true, 10, null);
