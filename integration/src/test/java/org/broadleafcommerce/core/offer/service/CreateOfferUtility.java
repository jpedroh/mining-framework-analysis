...
@SuppressWarnings(value = { "deprecation" }) public class CreateOfferUtility {
  ...
  public OfferCode createOfferCode(String offerName, OfferType offerType, OfferDiscountType discountType, double value, String orderRule, boolean stackable, boolean combinable, int priority) {
  ...
  public OfferCode createOfferCode(String offerCodeName, String offerName, OfferType offerType, OfferDiscountType discountType, double value, String orderRule, boolean stackable, boolean combinable, int priority, String qualifierRule, OfferAdjustmentType adjustmentType) {
    Offer offer = createOffer(offerName, offerType, discountType, value, orderRule, stackable, combinable, priority, qualifierRule, adjustmentType);
  ...
  public Offer createOffer(String offerName, OfferType offerType, OfferDiscountType discountType, double value, String orderRule, boolean stackable, boolean combinable, int priority, String qualifierRule) {
    return createOffer(offerName, offerType, discountType, value, orderRule, stackable, combinable, priority, qualifierRule, OfferAdjustmentType.ORDER_DISCOUNT);
  }

  public Offer createOffer(String offerName, OfferType offerType, OfferDiscountType discountType, double value, String orderRule, boolean stackable, boolean combinable, int priority, String qualifierRule, OfferAdjustmentType adjustmentType) {
