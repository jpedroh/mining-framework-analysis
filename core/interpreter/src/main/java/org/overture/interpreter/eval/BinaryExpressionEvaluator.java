...
public class BinaryExpressionEvaluator extends UnaryExpressionEvaluator {
  @Override public Value caseAAndBooleanBinaryExp(AAndBooleanBinaryExp node, Context ctxt) throws AnalysisException {
  ...
  @Override public Value caseAEquivalentBooleanBinaryExp(AEquivalentBooleanBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
      Value rv = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
  ...
  @Override public Value caseAImpliesBooleanBinaryExp(AImpliesBooleanBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
      if (lv.isUndefined()) {
  ...
  @Override public Value caseAOrBooleanBinaryExp(AOrBooleanBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
      if (lv.isUndefined()) {
  ...
  @Override public Value caseACompBinaryExp(ACompBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
  ...
  @Override public Value caseADomainResByBinaryExp(ADomainResByBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
  ...
  @Override public Value caseADomainResToBinaryExp(ADomainResToBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      ValueSet set = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt).setValue(ctxt);
      ValueMap map = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt).mapValue(ctxt);
  ...
  @Override public Value caseAEqualsBinaryExp(AEqualsBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    if (lv.isUndefined()) {
      return lv;
  ...
  @Override public Value caseAInSetBinaryExp(AInSetBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
  ...
  @Override public Value caseAMapUnionBinaryExp(AMapUnionBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    ValueMap lm = null;
    ValueMap rm = null;
    try {
  ...
  @Override public Value caseANotEqualBinaryExp(ANotEqualBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    Value rv = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    return new BooleanValue(!lv.equals(rv));
  ...
  @Override public Value caseANotInSetBinaryExp(ANotInSetBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    Value elem = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    Value set = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    try {
  ...
  @Override public Value caseADivNumericBinaryExp(ADivNumericBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
  ...
  @Override public Value caseADivideNumericBinaryExp(ADivideNumericBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
  ...
  @Override public Value caseAGreaterEqualNumericBinaryExp(AGreaterEqualNumericBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    Value rv = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    try {
  ...
  @Override public Value caseAGreaterNumericBinaryExp(AGreaterNumericBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    Value rv = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    try {
  ...
  @Override public Value caseALessEqualNumericBinaryExp(ALessEqualNumericBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    Value rv = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    try {
  ...
  @Override public Value caseALessNumericBinaryExp(ALessNumericBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    Value rv = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
    try {
  ...
  @Override public Value caseAModNumericBinaryExp(AModNumericBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      double lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt).intValue(ctxt);
      double rv = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt).intValue(ctxt);
  ...
  @Override public Value caseAPlusNumericBinaryExp(APlusNumericBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
  ...
  @Override public Value caseARemNumericBinaryExp(ARemNumericBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      double lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt).intValue(ctxt);
      double rv = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt).intValue(ctxt);
  ...
  @Override public Value caseASubtractNumericBinaryExp(ASubtractNumericBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      Value l = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
      Value r = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
  ...
  @Override public Value caseATimesNumericBinaryExp(ATimesNumericBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      Value l = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
      Value r = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
  ...
  @Override public Value caseAPlusPlusBinaryExp(APlusPlusBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt).deref();
      Value rv = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
  ...
  @Override public Value caseAProperSubsetBinaryExp(AProperSubsetBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      ...
      return new BooleanValue(set1.size() < set2.size() && set2.containsAll(set1));
    } catch (ValueException e) {
      return VdmRuntimeError.abort(node.getLocation(), e);
    }
  }

  @Override public Value caseARangeResByBinaryExp(ARangeResByBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    ValueSet set = null;
    ValueMap map = null;
    try {
  ...
  @Override public Value caseARangeResToBinaryExp(ARangeResToBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    ValueSet set = null;
    ValueMap map = null;
    try {
  ...
  @Override public Value caseASeqConcatBinaryExp(ASeqConcatBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
      Value rv = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
  ...
  @Override public Value caseASetDifferenceBinaryExp(ASetDifferenceBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
  ...
  @Override public Value caseASetIntersectBinaryExp(ASetIntersectBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      ValueSet result = new ValueSet();
      result.addAll(node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt).setValue(ctxt));
  ...
  @Override public Value caseASetUnionBinaryExp(ASetUnionBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      ValueSet result = new ValueSet();
      result.addAll(node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt).setValue(ctxt));
  ...
  @Override public Value caseAStarStarBinaryExp(AStarStarBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      Value lv = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt).deref();
      Value rv = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt);
      if (lv instanceof MapValue) {
        ...
        if (lv instanceof FunctionValue) {
  ...
  @Override public Value caseASubsetBinaryExp(ASubsetBinaryExp node, Context ctxt) throws AnalysisException {
    node.getLocation().hit();
    try {
      ValueSet set1 = node.getLeft().apply(VdmRuntime.getExpressionEvaluator(), ctxt).setValue(ctxt);
      ValueSet set2 = node.getRight().apply(VdmRuntime.getExpressionEvaluator(), ctxt).setValue(ctxt);
