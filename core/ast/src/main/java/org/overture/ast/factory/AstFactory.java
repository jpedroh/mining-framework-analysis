...
@SuppressWarnings(value = { "deprecation" }) public class AstFactory {
  ...
  private static void initStateDesignator(PStateDesignator result, ILexLocation location) {
    result.setLocation(location);
  }

  private static void initDefinition(PDefinition result, Pass values, ILexLocation location, ILexNameToken name, NameScope scope) {
  ...
  private static void initExpressionUnary(SUnaryExp result, ILexLocation location, PExp exp) {
  ...
  public static ADefPatternBind newADefPatternBind(ILexLocation location, Object patternOrBind) {
    ...
    if (patternOrBind instanceof PPattern) {
      ...
      if (patternOrBind instanceof PBind) {
        result.setPattern(null);
        result.setBind((PBind) patternOrBind);
      } else {
        throw new InternalException(3, "PatternBind passed " + patternOrBind.getClass().getName());
      }
    }
    return result;
  }
  ...
  public static ATypeMultipleBind newATypeMultipleBind(List<PPattern> plist, PType readType) {
  ...
  public static AClassClassDefinition newAClassClassDefinition(ILexNameToken className, List<? extends ILexNameToken> superclasses, List<PDefinition> members) {
    AClassClassDefinition result = new AClassClassDefinition();
    initClassDefinition(result, className, superclasses, members);
    return result;
  }

  protected static void initClassDefinition(SClassDefinition result, ILexNameToken className, List<? extends ILexNameToken> superclasses, List<PDefinition> members) {
  ...
  public static ASystemClassDefinition newASystemClassDefinition(ILexNameToken className, List<PDefinition> members) {
    ASystemClassDefinition result = new ASystemClassDefinition();
    initClassDefinition(result, className, new LexNameList(), members);
    return result;
  }

  public static ANamedInvariantType newANamedInvariantType(ILexNameToken typeName, PType type) {
  ...
  public static ARecordInvariantType newARecordInvariantType(ILexNameToken name, List<AFieldField> fields) {
  ...
  public static ATypeDefinition newATypeDefinition(ILexNameToken name, SInvariantType type, PPattern invPattern, PExp invExpression) {
    return newATypeDefinition(name, type, invPattern, invExpression, null, null);
  }

  public static ATypeDefinition newATypeDefinition(ILexNameToken name, SInvariantType type, PPattern invPattern, PExp invExpression, AEqRelation eqRelation, AOrdRelation ordRelation) {
  ...
  public static AExplicitFunctionDefinition newAExplicitFunctionDefinition(ILexNameToken name, NameScope scope, List<ILexNameToken> typeParams, AFunctionType type, List<List<PPattern>> parameters, PExp body, PExp precondition, PExp postcondition, boolean typeInvariant, PExp measure) {
  ...
  public static AImplicitFunctionDefinition newAImplicitFunctionDefinition(ILexNameToken name, NameScope scope, List<ILexNameToken> typeParams, List<APatternListTypePair> parameterPatterns, APatternTypePair resultPattern, PExp body, PExp precondition, PExp postcondition, PExp measure) {
  ...
  public static AFunctionType newAFunctionType(ILexLocation location, boolean partial, List<PType> parameters, PType resultType) {
  ...
  public static PDefinition newAUntypedDefinition(ILexLocation location, ILexNameToken name, NameScope scope) {
    AUntypedDefinition result = new AUntypedDefinition();
    initDefinition(result, Pass.DEFS, location, name, scope);
    return result;
  }

  public static AStateDefinition newAStateDefinition(ILexNameToken name, List<AFieldField> fields, PPattern invPattern, PExp invExpression, PPattern initPattern, PExp initExpression) {
  ...
  public static ALocalDefinition newALocalDefinition(ILexLocation location, ILexNameToken name, NameScope scope, PType type) {
  ...
  public static AExplicitOperationDefinition newAExplicitOperationDefinition(ILexNameToken name, AOperationType type, List<PPattern> parameters, PExp precondition, PExp postcondition, PStm body) {
  ...
  public static AImplicitOperationDefinition newAImplicitOperationDefinition(ILexNameToken name, List<APatternListTypePair> parameterPatterns, APatternTypePair resultPattern, PStm body, ASpecificationStm spec) {
    ...
    AOperationType operationType = AstFactory.newAOperationType(result.getLocation(), ptypes, result.getResult() == null ? AstFactory.newAVoidType(name.getLocation()) : result.getResult().getType());
    result.setType(operationType);
    return result;
  }

  public static AOperationType newAOperationType(ILexLocation location, List<PType> parameters, PType resultType) {
  ...
  public static ASpecificationStm newASpecificationStm(ILexLocation location, List<AExternalClause> externals, PExp precondition, PExp postcondition, List<AErrorCase> errors) {
  ...
  public static AExternalClause newAExternalClause(ILexToken mode, List<? extends ILexNameToken> names, PType type) {
  ...
  public static AEqualsDefinition newAEqualsDefinition(ILexLocation location, PPattern pattern, PExp test) {
  ...
  public static AEqualsDefinition newAEqualsDefinition(ILexLocation location, ATypeBind typebind, PExp test) {
    AEqualsDefinition result = AstFactory.newAEqualsDefinition(location);
    result.setPattern(null);
  ...
  public static AEqualsDefinition newAEqualsDefinition(ILexLocation location, PBind bind, PExp test) {
    AEqualsDefinition result = AstFactory.newAEqualsDefinition(location);
    result.setPattern(null);
    result.setTypebind(null);
  ...
  public static AClassInvariantDefinition newAClassInvariantDefinition(ILexNameToken name, PExp expression) {
  ...
  public static AInstanceVariableDefinition newAInstanceVariableDefinition(ILexNameToken name, PType type, PExp expression) {
  ...
  public static AThreadDefinition newPeriodicAThreadDefinition(ILexNameToken opname, List<PExp> args) {
    return newAThreadDefinition(AstFactory.newAPeriodicStm(opname, args));
  }

  public static AThreadDefinition newSporadicAThreadDefinition(ILexNameToken opname, List<PExp> args) {
  ...
  private static APeriodicStm newAPeriodicStm(ILexNameToken opname, List<PExp> args) {
  ...
  public static APerSyncDefinition newAPerSyncDefinition(ILexLocation location, ILexNameToken opname, PExp guard) {
  ...
  public static AMutexSyncDefinition newAMutexSyncDefinition(ILexLocation location, LexNameList operations) {
  ...
  public static ANamedTraceDefinition newANamedTraceDefinition(ILexLocation location, List<String> pathname, List<ATraceDefinitionTerm> terms) {
  ...
  public static ARepeatTraceDefinition newARepeatTraceDefinition(ILexLocation location, PTraceCoreDefinition core, long from, long to) {
    return new ARepeatTraceDefinition(location, core, from, to);
  }

  public static ALetDefBindingTraceDefinition newALetDefBindingTraceDefinition(ILexLocation location, List<AValueDefinition> localDefs, PTraceDefinition body) {
    return new ALetDefBindingTraceDefinition(location, localDefs, body);
  }

  public static ALetBeStBindingTraceDefinition newALetBeStBindingTraceDefinition(ILexLocation location, PMultipleBind bind, PExp stexp, PTraceDefinition body) {
    return new ALetBeStBindingTraceDefinition(location, bind, stexp, body, null);
  }

  public static AConcurrentExpressionTraceCoreDefinition newAConcurrentExpressionTraceCoreDefinition(ILexLocation location, List<PTraceDefinition> defs) {
    return new AConcurrentExpressionTraceCoreDefinition(location, defs);
  }

  public static AAccessSpecifierAccessSpecifier newAAccessSpecifierAccessSpecifier(PAccess access, boolean isStatic, boolean isAsync) {
    return newAAccessSpecifierAccessSpecifier(access, isStatic, isAsync, false);
  }

  public static AAccessSpecifierAccessSpecifier newAAccessSpecifierAccessSpecifier(PAccess access, boolean isStatic, boolean isAsync, boolean isPure) {
  ...
  public static APatternListTypePair newAPatternListTypePair(List<PPattern> patterns, PType type) {
  ...
  public static ATuplePattern newATuplePattern(ILexLocation location, List<PPattern> list) {
  ...
  public static AProductType newAProductType(ILexLocation location, List<PType> types) {
  ...
  public static APatternTypePair newAPatternTypePair(PPattern pattern, PType type) {
  ...
  public static AErrorCase newAErrorCase(LexIdentifierToken name, PExp left, PExp right) {
    return new AErrorCase(name, left, right);
  }

  public static AApplyExpressionTraceCoreDefinition newAApplyExpressionTraceCoreDefinition(PStm stmt, String currentModule) {
    return new AApplyExpressionTraceCoreDefinition(stmt.getLocation(), stmt, currentModule);
  }

  public static ABracketedExpressionTraceCoreDefinition newABracketedExpressionTraceCoreDefinition(ILexLocation location, List<ATraceDefinitionTerm> list) {
    return new ABracketedExpressionTraceCoreDefinition(location, list);
  }

  public static AEquivalentBooleanBinaryExp newAEquivalentBooleanBinaryExp(PExp left, LexToken op, PExp right) {
    AEquivalentBooleanBinaryExp result = new AEquivalentBooleanBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static AImpliesBooleanBinaryExp newAImpliesBooleanBinaryExp(PExp left, LexToken op, PExp right) {
    AImpliesBooleanBinaryExp result = new AImpliesBooleanBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static AOrBooleanBinaryExp newAOrBooleanBinaryExp(PExp left, LexToken op, PExp right) {
    AOrBooleanBinaryExp result = new AOrBooleanBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static AAndBooleanBinaryExp newAAndBooleanBinaryExp(PExp left, LexToken op, PExp right) {
  ...
  public static ANotUnaryExp newANotUnaryExp(ILexLocation location, PExp readNotExpression) {
    ANotUnaryExp result = new ANotUnaryExp();
    initExpressionUnary(result, location, readNotExpression);
    return result;
  }

  public static AEqualsBinaryExp newAEqualsBinaryExp(PExp left, LexToken op, PExp right) {
    AEqualsBinaryExp result = new AEqualsBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ALessNumericBinaryExp newALessNumericBinaryExp(PExp left, LexToken op, PExp right) {
    ALessNumericBinaryExp result = new ALessNumericBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ALessEqualNumericBinaryExp newALessEqualNumericBinaryExp(PExp left, LexToken op, PExp right) {
    ALessEqualNumericBinaryExp result = new ALessEqualNumericBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static AGreaterNumericBinaryExp newAGreaterNumericBinaryExp(PExp left, LexToken op, PExp right) {
    AGreaterNumericBinaryExp result = new AGreaterNumericBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static AGreaterEqualNumericBinaryExp newAGreaterEqualNumericBinaryExp(PExp left, LexToken op, PExp right) {
    AGreaterEqualNumericBinaryExp result = new AGreaterEqualNumericBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ANotEqualBinaryExp newANotEqualBinaryExp(PExp left, LexToken op, PExp right) {
    ANotEqualBinaryExp result = new ANotEqualBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ASubsetBinaryExp newASubsetBinaryExp(PExp left, LexToken op, PExp right) {
    ASubsetBinaryExp result = new ASubsetBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static AProperSubsetBinaryExp newAProperSubsetBinaryExp(PExp left, LexToken op, PExp right) {
    AProperSubsetBinaryExp result = new AProperSubsetBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static AInSetBinaryExp newAInSetBinaryExp(PExp left, LexToken op, PExp right) {
    AInSetBinaryExp result = new AInSetBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ANotInSetBinaryExp newANotInSetBinaryExp(PExp left, LexToken op, PExp right) {
    ANotInSetBinaryExp result = new ANotInSetBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static APlusNumericBinaryExp newAPlusNumericBinaryExp(PExp left, LexToken op, PExp right) {
    APlusNumericBinaryExp result = new APlusNumericBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ASubtractNumericBinaryExp newASubstractNumericBinaryExp(PExp left, LexToken op, PExp right) {
    ASubtractNumericBinaryExp result = new ASubtractNumericBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ASetUnionBinaryExp newASetUnionBinaryExp(PExp left, LexToken op, PExp right) {
    ASetUnionBinaryExp result = new ASetUnionBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ASetDifferenceBinaryExp newASetDifferenceBinaryExp(PExp left, LexToken op, PExp right) {
    ASetDifferenceBinaryExp result = new ASetDifferenceBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static AMapUnionBinaryExp newAMapUnionBinaryExp(PExp left, LexToken op, PExp right) {
    AMapUnionBinaryExp result = new AMapUnionBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static APlusPlusBinaryExp newAPlusPlusBinaryExp(PExp left, LexToken op, PExp right) {
    APlusPlusBinaryExp result = new APlusPlusBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ASeqConcatBinaryExp newASeqConcatBinaryExp(PExp left, LexToken op, PExp right) {
    ASeqConcatBinaryExp result = new ASeqConcatBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ATimesNumericBinaryExp newATimesNumericBinaryExp(PExp left, LexToken op, PExp right) {
    ATimesNumericBinaryExp result = new ATimesNumericBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ADivideNumericBinaryExp newADivideNumericBinaryExp(PExp left, LexToken op, PExp right) {
    ADivideNumericBinaryExp result = new ADivideNumericBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ARemNumericBinaryExp newARemNumericBinaryExp(PExp left, LexToken op, PExp right) {
    ARemNumericBinaryExp result = new ARemNumericBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static AModNumericBinaryExp newAModNumericBinaryExp(PExp left, LexToken op, PExp right) {
    AModNumericBinaryExp result = new AModNumericBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ADivNumericBinaryExp newADivNumericBinaryExp(PExp left, LexToken op, PExp right) {
    ADivNumericBinaryExp result = new ADivNumericBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ASetIntersectBinaryExp newASetIntersectBinaryExp(PExp left, LexToken op, PExp right) {
    ASetIntersectBinaryExp result = new ASetIntersectBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static AMapInverseUnaryExp newAMapInverseUnaryExp(ILexLocation location, PExp exp) {
    AMapInverseUnaryExp result = new AMapInverseUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static ADomainResToBinaryExp newADomainResToBinaryExp(PExp left, LexToken op, PExp right) {
    ADomainResToBinaryExp result = new ADomainResToBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ADomainResByBinaryExp newADomainResByBinaryExp(PExp left, LexToken op, PExp right) {
    ADomainResByBinaryExp result = new ADomainResByBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ARangeResToBinaryExp newARangeResToBinaryExp(PExp left, LexToken op, PExp right) {
    ARangeResToBinaryExp result = new ARangeResToBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static ARangeResByBinaryExp newARangeResByBinaryExp(PExp left, LexToken op, PExp right) {
  ...
  public static ACompBinaryExp newACompBinaryExp(PExp left, LexToken op, PExp right) {
    ACompBinaryExp result = new ACompBinaryExp();
    initExpressionBinary(result, left, op, right);
    return result;
  }

  public static AStarStarBinaryExp newAStarStarBinaryExp(PExp left, LexToken op, PExp right) {
  ...
  public static AMuExp newAMuExp(ILexLocation location, PExp record, List<ARecordModifier> args) {
  ...
  public static ARecordModifier newARecordModifier(LexIdentifierToken tag, PExp value) {
  ...
  public static AIsExp newAIsExp(ILexLocation location, ILexNameToken name, PExp test) {
  ...
  public static APreExp newAPreExp(ILexLocation location, PExp function, List<PExp> args) {
  ...
  public static ASetCompSetExp newASetCompSetExp(ILexLocation start, PExp first, List<PMultipleBind> bindings, PExp predicate) {
  ...
  public static ASetRangeSetExp newASetRangeSetExp(ILexLocation start, PExp first, PExp last) {
  ...
  public static AMapCompMapExp newAMapCompMapExp(ILexLocation start, AMapletExp first, List<PMultipleBind> bindings, PExp predicate) {
    AMapCompMapExp result = new AMapCompMapExp();
    initExpression(result, start);
    result.setFirst(first);
    result.setBindings(bindings);
    result.setPredicate(predicate);
  ...
  public static AMapEnumMapExp newAMapEnumMapExp(ILexLocation start, List<AMapletExp> members) {
    AMapEnumMapExp result = new AMapEnumMapExp();
  ...
  public static ASeqCompSeqExp newASeqCompSeqExp(ILexLocation start, PExp first, PBind bind, PExp predicate) {
  ...
  public static ASeqEnumSeqExp newASeqEnumSeqExp(ILexLocation start, List<PExp> members) {
    ASeqEnumSeqExp result = new ASeqEnumSeqExp();
    initExpression(result, start);
    result.setMembers(members);
    return result;
  ...
  public static AIfExp newAIfExp(ILexLocation start, PExp test, PExp thenExp, List<AElseIfExp> elseList, PExp elseExp) {
  ...
  public static AElseIfExp newAElseIfExp(ILexLocation start, PExp elseIfExp, PExp thenExp) {
  ...
  public static ACasesExp newACasesExp(ILexLocation start, PExp exp, List<ACaseAlternative> cases, PExp others) {
  ...
  public static ACaseAlternative newACaseAlternative(PExp cexp, PPattern pattern, PExp resultExp) {
  ...
  public static ALetDefExp newALetDefExp(ILexLocation start, List<PDefinition> localDefs, PExp readConnectiveExpression) {
  ...
  public static ALetBeStExp newALetBeStExp(ILexLocation start, PMultipleBind bind, PExp suchThat, PExp value) {
  ...
  public static AForAllExp newAForAllExp(ILexLocation start, List<PMultipleBind> bindList, PExp predicate) {
  ...
  public static AExistsExp newAExistsExp(ILexLocation start, List<PMultipleBind> bindList, PExp predicate) {
  ...
  public static AExists1Exp newAExists1Exp(ILexLocation start, PBind bind, PExp predicate) {
  ...
  public static AIotaExp newAIotaExp(ILexLocation start, PBind bind, PExp predicate) {
  ...
  public static ALambdaExp newALambdaExp(ILexLocation start, List<ATypeBind> bindList, PExp expression) {
  ...
  public static ADefExp newADefExp(ILexLocation start, List<PDefinition> equalsDefs, PExp expression) {
  ...
  public static ANewExp newANewExp(ILexLocation start, ILexIdentifierToken classname, List<PExp> args) {
  ...
  public static AIsOfBaseClassExp newAIsOfBaseClassExp(ILexLocation start, ILexNameToken classname, PExp pExp) {
  ...
  public static AIsOfClassExp newAIsOfClassExp(ILexLocation start, ILexNameToken classname, PExp pExp) {
  ...
  public static ASameBaseClassExp newASameBaseClassExp(ILexLocation start, List<PExp> args) {
  ...
  public static ASameClassExp newASameClassExp(ILexLocation start, List<PExp> args) {
  ...
  public static AHistoryExp newAHistoryExp(ILexLocation location, LexToken op, LexNameList opnames) {
  ...
  public static AFromModuleImports newAFromModuleImports(ILexIdentifierToken name, List<List<PImport>> signatures) {
    return new AFromModuleImports(name, signatures);
  }

  public static AModuleModules newAModuleModules(File file, List<PDefinition> definitions) {
    ...
    result.setTypeChecked(false);
    result.setIsDLModule(false);
    List<ClonableFile> files = new Vector<ClonableFile>();
    if (file != null) {
      files.add(new ClonableFile(file));
    }
    result.setFiles(files);
    result.setExportdefs(new Vector<PDefinition>());
    result.setImportdefs(new Vector<PDefinition>());
  ...
  public static AModuleModules newAModuleModules(LexIdentifierToken name, AModuleImports imports, AModuleExports exports, List<PDefinition> defs) {
    AModuleModules result = new AModuleModules();
    result.setName(name);
  ...
  public static AValueExport newAValueExport(ILexLocation location, List<ILexNameToken> nameList, PType type) {
  ...
  public static AFunctionExport newAFunctionExport(ILexLocation location, List<ILexNameToken> nameList, PType type, List<ILexNameToken> typeParams) {
  ...
  public static AOperationExport newAOperationExport(ILexLocation location, List<ILexNameToken> nameList, PType type) {
  ...
  public static AModuleImports newAModuleImports(ILexIdentifierToken name, List<AFromModuleImports> imports) {
    return new AModuleImports(name, imports);
  }

  public static ATypeImport newATypeImport(ATypeDefinition def, ILexNameToken renamed) {
  ...
  public static ATypeImport newATypeImport(ILexNameToken defname, ILexNameToken renamed) {
    ATypeImport result = new ATypeImport();
  ...
  public static AValueValueImport newAValueValueImport(LexNameToken defname, PType type, LexNameToken renamed) {
  ...
  public static AFunctionValueImport newAFunctionValueImport(ILexNameToken defname, PType type, LexNameList typeParams, ILexNameToken renamed) {
  ...
  public static AOperationValueImport newAOperationValueImport(ILexNameToken defname, PType type, ILexNameToken renamed) {
  ...
  public static AUnionPattern newAUnionPattern(PPattern left, ILexLocation location, PPattern right) {
  ...
  public static AConcatenationPattern newAConcatenationPattern(PPattern left, ILexLocation location, PPattern right) {
  ...
  public static ASetPattern newASetPattern(ILexLocation location, List<PPattern> list) {
  ...
  public static ASeqPattern newASeqPattern(ILexLocation location, List<PPattern> list) {
  ...
  public static ARecordPattern newARecordPattern(ILexNameToken typename, List<PPattern> list) {
  ...
  public static AObjectPattern newAObjectPattern(ILexNameToken classname, List<ANamePatternPair> list) {
  ...
  public static ATixeStm newATixeStm(ILexLocation token, List<ATixeStmtAlternative> traps, PStm body) {
  ...
  public static ATrapStm newATrapStm(ILexLocation token, ADefPatternBind patternBind, PStm with, PStm body) {
  ...
  public static AAnnotatedStm newAAnnotatedStm(ILexLocation location, PAnnotation annotation, PStm body) {
  ...
  public static ANonDeterministicSimpleBlockStm newANonDeterministicSimpleBlockStm(ILexLocation token) {
  ...
  public static AAtomicStm newAAtomicStm(ILexLocation token, List<AAssignmentStm> assignments) {
  ...
  public static ACallObjectStm newACallObjectStm(PObjectDesignator designator, ILexNameToken classname, List<PExp> args) {
  ...
  public static ACallObjectStm newACallObjectStm(PObjectDesignator designator, ILexIdentifierToken fieldname, List<PExp> args) {
    ACallObjectStm result = new ACallObjectStm();
    initStatement(result, designator.getLocation());
    result.setDesignator(designator);
  ...
  public static AFieldObjectDesignator newAFieldObjectDesignator(PObjectDesignator object, ILexIdentifierToken fieldname) {
  ...
  public static PObjectDesignator newAFieldObjectDesignator(PObjectDesignator object, ILexNameToken classname) {
    AFieldObjectDesignator result = new AFieldObjectDesignator();
    result.setLocation(object.getLocation());
    result.setObject(object);
    result.setClassName(classname);
  ...
  public static AApplyObjectDesignator newAApplyObjectDesignator(PObjectDesignator object, List<PExp> args) {
  ...
  public static ASelfObjectDesignator newASelfObjectDesignator(ILexLocation location) {
  ...
  public static AIdentifierObjectDesignator newAIdentifierObjectDesignator(ILexNameToken name) {
  ...
  public static ANewObjectDesignator newANewObjectDesignator(LexIdentifierToken classname, List<PExp> args) {
  ...
  public static AForAllStm newAForAllStm(ILexLocation token, PPattern pattern, PExp set, PStm stmt) {
  ...
  public static AForPatternBindStm newAForPatternBindStm(ILexLocation token, ADefPatternBind pb, boolean reverse, PExp exp, PStm body) {
  ...
  public static AForIndexStm newAForIndexStm(ILexLocation token, ILexNameToken var, PExp from, PExp to, PExp by, PStm body) {
  ...
  public static AIfStm newAIfStm(ILexLocation token, PExp ifExp, PStm thenStmt, List<AElseIfStm> elseIfList, PStm elseStmt) {
  ...
  public static AElseIfStm newAElseIfStm(ILexLocation token, PExp elseIfExp, PStm thenStmt) {
  ...
  public static AAssignmentStm newAAssignmentStm(ILexLocation token, PStateDesignator target, PExp exp) {
  ...
  public static AFieldStateDesignator newAFieldStateDesignator(PStateDesignator object, ILexIdentifierToken field) {
  ...
  public static AMapSeqStateDesignator newAMapSeqStateDesignator(PStateDesignator mapseq, PExp exp) {
  ...
  public static ABlockSimpleBlockStm newABlockSimpleBlockStm(ILexLocation token, List<AAssignmentDefinition> assignmentDefs) {
  ...
  public static AAssignmentDefinition newAAssignmentDefinition(ILexNameToken name, PType type, PExp exp) {
  ...
  public static ALetStm newALetStm(ILexLocation token, List<PDefinition> localDefs, PStm readStatement) {
  ...
  public static ALetBeStStm newALetBeStStm(ILexLocation token, PMultipleBind bind, PExp stexp, PStm statement) {
  ...
  public static ACasesStm newACasesStm(ILexLocation token, PExp exp, List<ACaseAlternativeStm> cases, PStm others) {
  ...
  public static ACaseAlternativeStm newACaseAlternativeStm(PPattern pattern, PStm stmt) {
  ...
  public static ADurationStm newADurationStm(ILexLocation location, PExp duration, PStm stmt) {
  ...
  public static ACyclesStm newACyclesStm(ILexLocation location, PExp duration, PStm stmt) {
  ...
  public static AUnionType newAUnionType(ILexLocation location, PType a, PType b) {
  ...
  public static AFieldField newAFieldField(ILexNameToken tagname, String tag, PType type, boolean equalityAbstraction) {
  ...
  public static AMapMapType newAMapMapType(ILexLocation location, PType from, PType to) {
  ...
  public static AInMapMapType newAInMapMapType(ILexLocation location, PType from, PType to) {
  ...
  public static AClassInvariantStm newAClassInvariantStm(ILexNameToken name, List<PDefinition> invdefs) {
  ...
  public static AInheritedDefinition newAInheritedDefinition(ILexNameToken localname, PDefinition d) {
  ...
  public static AImportedDefinition newAImportedDefinition(ILexLocation location, PDefinition d) {
  ...
  public static ARenamedDefinition newARenamedDefinition(ILexNameToken name, PDefinition def) {
  ...
  public static AClassType newAClassType(ILexLocation location, SClassDefinition classdef) {
  ...
  public static ARecordInvariantType newARecordInvariantType(ILexLocation location, List<AFieldField> fields) {
    ARecordInvariantType result = new ARecordInvariantType();
    initType(result, location);
  ...
  public static AExternalDefinition newAExternalDefinition(PDefinition state, ILexToken mode) {
  ...
  public static AMultiBindListDefinition newAMultiBindListDefinition(ILexLocation location, List<PMultipleBind> bindings) {
  ...
  public static AUnaryPlusUnaryExp newAUnaryPlusUnaryExp(ILexLocation location, PExp exp) {
    AUnaryPlusUnaryExp result = new AUnaryPlusUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static AUnaryMinusUnaryExp newAUnaryMinusUnaryExp(ILexLocation location, PExp exp) {
    AUnaryMinusUnaryExp result = new AUnaryMinusUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static ACardinalityUnaryExp newACardinalityUnaryExp(ILexLocation location, PExp exp) {
    ACardinalityUnaryExp result = new ACardinalityUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static AMapDomainUnaryExp newAMapDomainUnaryExp(ILexLocation location, PExp exp) {
  ...
  public static APowerSetUnaryExp newAPowerSetUnaryExp(ILexLocation location, PExp exp) {
    APowerSetUnaryExp result = new APowerSetUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static AMapRangeUnaryExp newAMapRangeUnaryExp(ILexLocation location, PExp exp) {
    AMapRangeUnaryExp result = new AMapRangeUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static AElementsUnaryExp newAElementsUnaryExp(ILexLocation location, PExp exp) {
    AElementsUnaryExp result = new AElementsUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static AAbsoluteUnaryExp newAAbsoluteUnaryExp(ILexLocation location, PExp exp) {
    AAbsoluteUnaryExp result = new AAbsoluteUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static AAnnotatedUnaryExp newAAnnotatedUnaryExp(ILexLocation location, PAnnotation annotation, PExp exp) {
  ...
  public static ADistIntersectUnaryExp newADistIntersectUnaryExp(ILexLocation location, PExp exp) {
    ADistIntersectUnaryExp result = new ADistIntersectUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static ADistMergeUnaryExp newADistMergeUnaryExp(ILexLocation location, PExp exp) {
  ...
  public static AReverseUnaryExp newAReverseUnaryExp(ILexLocation location, PExp exp) {
    AReverseUnaryExp result = new AReverseUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static AFloorUnaryExp newAFloorUnaryExp(ILexLocation location, PExp exp) {
    AFloorUnaryExp result = new AFloorUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static ADistUnionUnaryExp newADistUnionUnaryExp(ILexLocation location, PExp exp) {
    ADistUnionUnaryExp result = new ADistUnionUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static ADistConcatUnaryExp newADistConcatUnaryExp(ILexLocation location, PExp exp) {
    ADistConcatUnaryExp result = new ADistConcatUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static AIndicesUnaryExp newAIndicesUnaryExp(ILexLocation location, PExp exp) {
    AIndicesUnaryExp result = new AIndicesUnaryExp();
    initExpressionUnary(result, location, exp);
    return result;
  }

  public static ASetEnumSetExp newASetEnumSetExp(ILexLocation start, List<PExp> members) {
    ASetEnumSetExp result = new ASetEnumSetExp();
    initExpression(result, start);
    result.setMembers(members);
    return result;
  ...
  public static AIdentifierStateDesignator newAIdentifierStateDesignator(ILexNameToken name) {
  ...
  public static ATixeStmtAlternative newATixeStmtAlternative(ADefPatternBind patternBind, PStm resultStm) {
  ...
  public static APostOpExp newAPostOpExp(ILexNameToken opname, PExp preexpression, PExp postexpression, List<AErrorCase> errors, AStateDefinition state) {
  ...
  public static APreOpExp newAPreOpExp(ILexNameToken opname, PExp expression, List<AErrorCase> errors, AStateDefinition state) {
  ...
  public static ATraceDefinitionTerm newATraceDefinitionTerm(List<PTraceDefinition> term) {
