...
@Service(value = "blCustomerService") public class CustomerServiceImpl implements CustomerService {
  ...
  @Resource(name = "blCustomerDao") protected CustomerDao customerDao;

  @Resource(name = "blIdGenerationService") protected IdGenerationService idGenerationService;

  @Resource(name = "blCustomerForgotPasswordSecurityTokenDao") protected CustomerForgotPasswordSecurityTokenDao customerForgotPasswordSecurityTokenDao;
  ...
  /**
     ...
     */
  @Resource(name = "blPasswordEncoder") protected PasswordEncoder passwordEncoderBean;

  @Resource(name = "blRoleDao") protected RoleDao roleDao;
  ...
  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public Customer saveCustomer(Customer customer) {
    return saveCustomer(customer, customer.isRegistered());
  }

  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public Customer saveCustomer(Customer customer, boolean register) {
  ...
  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public Customer registerCustomer(Customer customer, String password, String passwordConfirm) {
    customer.setRegistered(true);
  ...
  @Override public void createRegisteredCustomerRoles(Customer customer) {
  ...
  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public Customer changePassword(PasswordChange passwordChange) {
  ...
  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public Customer resetPassword(PasswordReset passwordReset) {
  ...
  @Override public void detachCustomer(Customer customer) {
  ...
  @Override public Customer readCustomerByUsername(String username, Boolean cacheable) {
  ...
  @Override public Customer readCustomerByExternalId(String userExternalId) {
  ...
  @Override public boolean isPasswordValid(String rawPassword, String encodedPassword) {
    return passwordEncoderBean.matches(rawPassword, encodedPassword);
  }

  @Override public boolean customerPassesCustomerRule(Customer customer, CustomerRuleHolder customerRuleHolder) {
  ...
  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public GenericResponse sendForgotUsernameNotification(String emailAddress) {
  ...
  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public GenericResponse sendForgotPasswordNotification(String username, String resetPasswordUrl) {
    GenericResponse response = new GenericResponse();
  ...
  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public GenericResponse sendForcedPasswordChangeNotification(String username, String resetPasswordUrl) {
    return sendForgotPasswordNotification(username, resetPasswordUrl);
  }

  @Override public GenericResponse checkPasswordResetToken(String token, Customer customer) {
    GenericResponse response = new GenericResponse();
  ...
  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public GenericResponse resetPasswordUsingToken(String username, String token, String password, String confirmPassword) {
    GenericResponse response = new GenericResponse();
    Customer customer = null;
    if (username != null) {
      customer = customerDao.readCustomerByUsername(username);
  ...
  @Override public List<Customer> readBatchCustomers(int start, int pageSize) {
    return customerDao.readBatchCustomers(start, pageSize);
  }

  @Override public Long readNumberOfCustomers() {
