...
@Service(value = "blCustomerAddressService") public class CustomerAddressServiceImpl implements CustomerAddressService {
  @Resource(name = "blCustomerAddressDao") protected CustomerAddressDao customerAddressDao;

  @Resource(name = "blCustomerDao") protected CustomerDao customerDao;

  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public CustomerAddress saveCustomerAddress(CustomerAddress customerAddress) {
  ...
  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public void makeCustomerAddressDefault(Long customerAddressId, Long customerId) {
    customerAddressDao.makeCustomerAddressDefault(customerAddressId, customerId);
  }

  @Override @Transactional(value = TransactionUtils.DEFAULT_TRANSACTION_MANAGER) public void deleteCustomerAddressById(Long customerAddressId) {
  ...
  @Override public List<CustomerAddress> readBatchAddresses(int start, int pageSize) {
    return customerAddressDao.readBatchCustomerAddresses(start, pageSize);
  }

  @Override public Long readNumberOfAddresses() {
