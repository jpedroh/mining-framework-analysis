...
public interface Address extends Serializable, MultiTenantCloneable<Address> {
  ...
  /**
     ...
     * @see {@link Phone}
     */
  @Deprecated public String getPrimaryPhone();

  /**
     * @deprecated Should use {@link #setPhonePrimary(Phone)} instead
     * @see {@link Phone}
     */
  @Deprecated public void setPrimaryPhone(String primaryPhone);

  /**
     * @deprecated Should use {@link #getPhoneSecondary()} instead
     * @see {@link Phone}
     */
  @Deprecated public String getSecondaryPhone();

  /**
     * @deprecated Should use {@link #setPhoneSecondary(Phone)} instead
     * @see {@link Phone}
     */
  @Deprecated public void setSecondaryPhone(String secondaryPhone);
