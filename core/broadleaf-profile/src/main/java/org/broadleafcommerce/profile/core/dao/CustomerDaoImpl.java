...
@Repository(value = "blCustomerDao") public class CustomerDaoImpl implements CustomerDao {
  ...
  @Override public Customer readCustomerByExternalId(String externalId) {
  ...
  @Override public List<Customer> readCustomersByIds(List<Long> ids) {
  ...
  @Override public List<Customer> readCustomersByUsername(String username) {
    return readCustomersByUsername(username, true);
  }

  @Override public List<Customer> readCustomersByUsername(String username, Boolean cacheable) {
  ...
  @Override public List<Customer> readCustomersByEmail(String emailAddress) {
  ...
  @Override public void detach(Customer customer) {
    em.detach(customer);
  }
  ...
  @Override public List<Customer> readBatchCustomersFromLastID(Long lastID, int pageSize) {
    CriteriaBuilder builder = em.getCriteriaBuilder();
    CriteriaQuery<Customer> criteria = builder.createQuery(Customer.class);
    Root<CustomerImpl> customer = criteria.from(CustomerImpl.class);
    criteria.select(customer);
  ...
  @Override @Transactional public void refreshCustomer(Customer customer) {
    em.refresh(customer);
  }
}