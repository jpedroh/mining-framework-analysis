...
public abstract class AbstractGraphTest extends TestCase {
  ...
  public void testExceptions() throws Exception {
    ...
    try {
      root.createContextNode(XDI3SubSegment.create("=markus"));
      fail();
    ...
    try {
      markus.createRelation(XDI3Segment.create("+friend"), les);
      fail();
    } catch (Xdi2GraphException ex) {
    }
    graph17.close();
  ...
  private static void testGraph(Graph graph) throws Exception {
    ...
    ContextNode contextNodesArray[] = new ContextNode[] { graph.findContextNode(XDI3Segment.create("()"), false), graph.findContextNode(XDI3Segment.create("=abc"), false), graph.findContextNode(XDI3Segment.create("=abc+passport"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!1"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!2"), false), graph.findContextNode(XDI3Segment.create("=abc+passport$v"), false), graph.findContextNode(XDI3Segment.create("=abc+passport($)"), false), graph.findContextNode(XDI3Segment.create("=abc+passport$v!1"), false), graph.findContextNode(XDI3Segment.create("=abc+passport$v!2"), false), graph.findContextNode(XDI3Segment.create("=abc+passport($)!1"), false), graph.findContextNode(XDI3Segment.create("=abc+passport($)!2"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!1+number<<$string>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!1+country<<$string>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!1<<$d>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!2+number<<$string>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!2+country<<$string>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!2<<$d>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport($)!1<<$d>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport($)!2<<$d>>"), false) };
    XDI3SubSegment[][] contextNodeArcXrisArray = new XDI3SubSegment[][] { new XDI3SubSegment[] { XDI3SubSegment.create("=abc") }, new XDI3SubSegment[] { XDI3SubSegment.create("+passport") }, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("!2"), XDI3SubSegment.create("$v"), XDI3SubSegment.create("($)") }, new XDI3SubSegment[] { XDI3SubSegment.create("+number"), XDI3SubSegment.create("+country"), XDI3SubSegment.create("<<$d>>") }, new XDI3SubSegment[] { XDI3SubSegment.create("+number"), XDI3SubSegment.create("+country"), XDI3SubSegment.create("<<$d>>") }, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("!2") }, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("!2") }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] { XDI3SubSegment.create("<<$d>>") }, new XDI3SubSegment[] { XDI3SubSegment.create("<<$d>>") }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  } };
    ...
    for (ContextNode contextNode : contextNodesArray) {
      if (contextNode != null) {
        assertTrue(contextNode.getGraph().containsContextNode(contextNode.getXri()));
      }
    }
    for (int i = 0; i < contextNodesArray.length; i++) {
      if (contextNodesArray[i] == null) {
        assertNull(contextNodeArcXrisArray[i]);
        continue;
      } else {
        assertNotNull(contextNodeArcXrisArray[i]);
      }
    ...
    for (int i = 0; i < contextNodesArray.length; i++) {
      ...
      for (Iterator<XDI3Segment> it = arcXris.iterator(); it.hasNext(); ) {
        assertTrue(contextNodesArray[i].getGraph().containsRelations(contextNodesArray[i].getXri(), it.next()));
      }
  ...
  private static void testManipulatedGraph(Graph graph) throws Exception {
    ...
    assertTrue(abcPassportCContextNode.containsContextNode(XDI3SubSegment.create("!2")));
    assertTrue(abcPassportC1ContextNode.containsContextNode(XDI3SubSegment.create("<<$d>>")));
    assertFalse(abcPassportC2ContextNode.containsContextNode(XDI3SubSegment.create("<<$d>>")));
    ...
    ContextNode contextNodesArray[] = new ContextNode[] { graph.findContextNode(XDI3Segment.create("()"), false), graph.findContextNode(XDI3Segment.create("=abc"), false), graph.findContextNode(XDI3Segment.create("=abc+passport"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!1"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!2"), false), graph.findContextNode(XDI3Segment.create("=abc+passport$v"), false), graph.findContextNode(XDI3Segment.create("=abc+passport($)"), false), graph.findContextNode(XDI3Segment.create("=abc+passport$v!1"), false), graph.findContextNode(XDI3Segment.create("=abc+passport$v!2"), false), graph.findContextNode(XDI3Segment.create("=abc+passport($)!1"), false), graph.findContextNode(XDI3Segment.create("=abc+passport($)!2"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!1+number<<$string>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!1+country<<$string>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!1<<$d>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!2+number<<$string>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!2+country<<$string>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport!2<<$d>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport($)!1<<$d>>"), false), graph.findContextNode(XDI3Segment.create("=abc+passport($)!2<<$d>>"), false) };
    XDI3SubSegment[][] contextNodeArcXrisArray = new XDI3SubSegment[][] { new XDI3SubSegment[] { XDI3SubSegment.create("=abc") }, new XDI3SubSegment[] { XDI3SubSegment.create("+passport") }, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("$v"), XDI3SubSegment.create("($)") }, new XDI3SubSegment[] { XDI3SubSegment.create("+number"), XDI3SubSegment.create("+country"), XDI3SubSegment.create("<<$d>>") }, null, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("!2") }, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("!2") }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] { XDI3SubSegment.create("<<$d>>") }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, null, null, null, new XDI3SubSegment[] {  }, null };
    ...
    assertNull(abcRelation2);
    assertEquals(rootContextNode.getAllContextNodeCount(), 15);
