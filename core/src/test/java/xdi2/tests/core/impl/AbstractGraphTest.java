...
public abstract class AbstractGraphTest extends TestCase {
  ...
  public void testEmptyContextNode() throws Exception {
    ...
    try {
      markus.getAllContextNodes().next();
      fail();
    } catch (NoSuchElementException ex) {
    }
    assertFalse(markus.getAllLeafContextNodes().hasNext());
    try {
      markus.getAllLeafContextNodes().next();
      fail();
    } catch (NoSuchElementException ex) {
    }
    ...
    try {
      markus.getRelations(XDI3Segment.create("+not")).next();
      fail();
    } catch (NoSuchElementException ex) {
    }
    assertFalse(markus.getRelations().hasNext());
    try {
      markus.getRelations().next();
      fail();
    } catch (NoSuchElementException ex) {
    }
    try {
      markus.getIncomingRelations().next();
      fail();
    } catch (NoSuchElementException ex) {
    }
    assertFalse(markus.getAllRelations().hasNext());
    try {
      markus.getAllRelations().next();
      fail();
    } catch (NoSuchElementException ex) {
    }
  ...
  public void testIllegalArcXris() throws Exception {
    ...
    try {
      markus.setContextNode(XDI3SubSegment.create("<#email>"));
      fail();
    } catch (Xdi2GraphException ex) {
    }
    try {
  ...
  @SuppressWarnings(value = { "unused" }) private static void makeGraph(Graph graph) throws Exception {
  ...
  private static void testGraph(Graph graph) throws Exception {
    ...
    ContextNode contextNodesArray[] = new ContextNode[] { graph.getDeepContextNode(XDI3Segment.create("")), graph.getDeepContextNode(XDI3Segment.create("=abc")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!1")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!2")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$v]")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$o]")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$v]!1")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$v]!2")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$o]!1")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$o]!2")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!1<#number>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!1<#country>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!1<$t>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!2<#number>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!2<#country>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!2<$t>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$o]!1<$t>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$o]!2<$t>&")) };
    XDI3SubSegment[][] contextNodeXriArray = new XDI3SubSegment[][] { new XDI3SubSegment[] { XDI3SubSegment.create("=abc") }, new XDI3SubSegment[] { XDI3SubSegment.create("[#passport]") }, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("!2"), XDI3SubSegment.create("[$v]"), XDI3SubSegment.create("[$o]") }, new XDI3SubSegment[] { XDI3SubSegment.create("<#number>"), XDI3SubSegment.create("<#country>"), XDI3SubSegment.create("<$t>") }, new XDI3SubSegment[] { XDI3SubSegment.create("<#number>"), XDI3SubSegment.create("<#country>"), XDI3SubSegment.create("<$t>") }, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("!2") }, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("!2") }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] { XDI3SubSegment.create("<$t>") }, new XDI3SubSegment[] { XDI3SubSegment.create("<$t>") }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  } };
    XDI3Segment[][] relationArcXrisArray = new XDI3Segment[][] { new XDI3Segment[] {  }, new XDI3Segment[] { XDI3Segment.create("+rel"), XDI3Segment.create("+rel") }, new XDI3Segment[] { XDI3Segment.create("[$v]"), XDI3Segment.create("*1"), XDI3Segment.create("*2") }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] { XDI3Segment.create("$") }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  } };
    Boolean[] literalsArray = new Boolean[] { Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, Boolean.TRUE };
    ...
    for (ContextNode contextNode : contextNodesArray) {
      if (contextNode != null) {
        assertTrue(contextNode.getGraph().getDeepContextNode(contextNode.getXri()) != null);
      }
    }
    for (int i = 0; i < contextNodesArray.length; i++) {
      if (contextNodesArray[i] == null) {
        assertNull(contextNodeXriArray[i]);
        continue;
      } else {
        assertNotNull(contextNodeXriArray[i]);
      }
      ...
      for (Iterator<ContextNode> it = contextNodesArray[i].getContextNodes(); it.hasNext(); ) {
        assertTrue(arcXris.remove(it.next().getArcXri()));
      }
      assertTrue(arcXris.isEmpty());
    }
    for (int i = 0; i < contextNodesArray.length; i++) {
      if (contextNodesArray[i] == null) {
        assertNull(relationArcXrisArray[i]);
        continue;
      } else {
        assertNotNull(relationArcXrisArray[i]);
      }
      List<XDI3Segment> arcXris = new ArrayList<XDI3Segment>(Arrays.asList(relationArcXrisArray[i]));
      for (Iterator<XDI3Segment> it = arcXris.iterator(); it.hasNext(); ) {
        assertTrue(contextNodesArray[i].getGraph().getDeepRelations(contextNodesArray[i].getXri(), it.next()) != null);
      }
      ...
      for (Iterator<Relation> it = contextNodesArray[i].getRelations(); it.hasNext(); ) {
        assertTrue(arcXris.remove(it.next().getArcXri()));
      }
      assertTrue(arcXris.isEmpty());
    }
    for (int i = 0; i < contextNodesArray.length; i++) {
      if (contextNodesArray[i] == null) {
        assertNull(literalsArray[i]);
        continue;
      } else {
        assertNotNull(literalsArray[i]);
      }
  ...
  @SuppressWarnings(value = { "unused" }) private static void manipulateGraph(Graph graph) throws Exception {
    ContextNode rootContextNode = graph.getRootContextNode();
    ContextNode abcContextNode = rootContextNode.getContextNode(XDI3SubSegment.create("=abc"));
    ContextNode abcPassportContextNode = abcContextNode.getContextNode(XDI3SubSegment.create("[#passport]"));
    ContextNode abcPassport1ContextNode = abcPassportContextNode.getContextNode(XDI3SubSegment.create("!1"));
  ...
  private static void testManipulatedGraph(Graph graph) throws Exception {
    ...
    assertTrue(abcContextNode.containsContextNode(XDI3SubSegment.create("[#passport]")));
    assertTrue(abcPassportContextNode.containsContextNode(XDI3SubSegment.create("!1")));
    assertFalse(abcPassportContextNode.containsContextNode(XDI3SubSegment.create("!2")));
    assertTrue(abcPassportContextNode.containsContextNode(XDI3SubSegment.create("[$v]")));
    assertTrue(abcPassportContextNode.containsContextNode(XDI3SubSegment.create("[$o]")));
    assertTrue(abcPassportVContextNode.containsContextNode(XDI3SubSegment.create("!1")));
    assertTrue(abcPassportVContextNode.containsContextNode(XDI3SubSegment.create("!2")));
    ...
    assertTrue(abcPassport1ContextNode.containsContextNode(XDI3SubSegment.create("<#country>")));
    assertTrue(abcPassport1ContextNode.containsContextNode(XDI3SubSegment.create("<$t>")));
    assertNull(abcPassport2ContextNode);
    assertNull(abcPassport2ContextNode);
    assertNull(abcPassport2ContextNode);
    assertTrue(abcPassport1ContextNode.getDeepContextNode(XDI3Segment.create("<#number>&")).containsLiteral());
    assertTrue(abcPassport1ContextNode.getDeepContextNode(XDI3Segment.create("<#country>&")).containsLiteral());
    ...
    assertTrue(abcPassportCContextNode.containsContextNode(XDI3SubSegment.create("!2")));
    assertTrue(abcPassportC1ContextNode.containsContextNode(XDI3SubSegment.create("<$t>")));
    assertFalse(abcPassportC2ContextNode.containsContextNode(XDI3SubSegment.create("<$t>")));
    assertTrue(abcPassportC1ContextNode.getDeepContextNode(XDI3Segment.create("<$t>&")).containsLiteral());
    assertNull(abcPassportC2LiteralD);
    assertTrue(abcPassportContextNode.containsRelation(XDI3Segment.create("[$v]"), XDI3Segment.create("=abc[#passport][$v]!2")));
    assertTrue(abcPassportContextNode.containsRelation(XDI3Segment.create("*1"), XDI3Segment.create("=abc[#passport]!1")));
    assertFalse(abcPassportContextNode.containsRelation(XDI3Segment.create("*2"), XDI3Segment.create("=abc[#passport]!2")));
    assertTrue(abcContextNode.containsRelation(XDI3Segment.create("+rel"), XDI3Segment.create("=abc[#passport]!1")));
    assertFalse(abcContextNode.containsRelation(XDI3Segment.create("+rel"), XDI3Segment.create("=abc[#passport]!2")));
    ContextNode contextNodesArray[] = new ContextNode[] { graph.getDeepContextNode(XDI3Segment.create("")), graph.getDeepContextNode(XDI3Segment.create("=abc")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!1")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!2")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$v]")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$o]")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$v]!1")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$v]!2")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$o]!1")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$o]!2")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!1<#number>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!1<#country>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!1<$t>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!2<#number>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!2<#country>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport]!2<$t>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$o]!1<$t>&")), graph.getDeepContextNode(XDI3Segment.create("=abc[#passport][$o]!2<$t>&")) };
    XDI3SubSegment[][] contextNodeXriArray = new XDI3SubSegment[][] { new XDI3SubSegment[] { XDI3SubSegment.create("=abc") }, new XDI3SubSegment[] { XDI3SubSegment.create("[#passport]") }, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("[$v]"), XDI3SubSegment.create("[$o]") }, new XDI3SubSegment[] { XDI3SubSegment.create("<#number>"), XDI3SubSegment.create("<#country>"), XDI3SubSegment.create("<$t>") }, null, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("!2") }, new XDI3SubSegment[] { XDI3SubSegment.create("!1"), XDI3SubSegment.create("!2") }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] { XDI3SubSegment.create("<$t>") }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, new XDI3SubSegment[] {  }, null, null, null, new XDI3SubSegment[] {  }, null };
    XDI3Segment[][] relationArcXrisArray = new XDI3Segment[][] { new XDI3Segment[] {  }, new XDI3Segment[] { XDI3Segment.create("+rel") }, new XDI3Segment[] { XDI3Segment.create("[$v]"), XDI3Segment.create("*1") }, new XDI3Segment[] {  }, null, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] { XDI3Segment.create("$") }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, new XDI3Segment[] {  }, null, null, null, new XDI3Segment[] {  }, null };
    Boolean[] literalsArray = new Boolean[] { Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, null, null, null, Boolean.TRUE, null };
    assertEquals(contextNodesArray.length, contextNodeXriArray.length);
    assertEquals(contextNodesArray.length, relationArcXrisArray.length);
    assertEquals(contextNodesArray.length, literalsArray.length);
    for (ContextNode contextNode : contextNodesArray) {
    ...
    assertNull(abcPassport2LiteralNumber);
    assertNull(abcPassport2LiteralNumber);
    assertNull(abcPassport2LiteralCountry);
    assertNull(abcPassport2LiteralCountry);
    assertNull(abcPassport2LiteralD);
    assertNull(abcPassport2LiteralD);
    assertEquals(XDI3SubSegment.create("!1"), abcPassportC1ContextNode.getArcXri());
    assertEquals(XDI3Segment.create("=abc[#passport][$o]!1"), abcPassportC1ContextNode.getXri());
    assertEquals(XDI3SubSegment.create("!2"), abcPassportC2ContextNode.getArcXri());
    ...
    assertEquals("2010-03-03T03:03:03Z", abcPassportC1LiteralD.getLiteralData());
    assertNull(abcPassportC2LiteralD);
    assertNull(abcPassportC2LiteralD);
    assertEquals(XDI3SubSegment.create("[$v]"), abcPassportRelationV.getArcXri());
    assertEquals(XDI3Segment.create("=abc[#passport][$v]!2"), abcPassportRelationV.getTargetContextNodeXri());
    assertEquals(XDI3SubSegment.create("*1"), abcPassportRelation1.getArcXri());
    assertEquals(XDI3Segment.create("=abc[#passport]!1"), abcPassportRelation1.getTargetContextNodeXri());
    assertNull(abcPassportRelation2);
    assertNull(abcPassportRelation2);
    assertEquals(XDI3SubSegment.create("+rel"), abcRelation1.getArcXri());
    assertEquals(XDI3Segment.create("=abc[#passport]!1"), abcRelation1.getTargetContextNodeXri());
    assertNull(abcRelation2);
    assertNull(abcRelation2);
    assertEquals(rootContextNode.getAllContextNodeCount(), 17);
    assertEquals(rootContextNode.getAllRelationCount(), 4);
    assertEquals(rootContextNode.getAllLiteralCount(), 4);
  }
