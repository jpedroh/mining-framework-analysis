...
public class Code128WriterTestCase extends Assert {
  ...
  @Test public void testEncodeWithFncsAndNumberInCodesetA() throws Exception {
    String toEncode = "\n" + "\u00f1" + "\u00f4" + "1" + "\n";
  ...
  @Test public void testEncodeSwitchBetweenCodesetsAAndB() throws Exception {
    testEncode("\u0000ABab\u0010", QUIET_SPACE + START_CODE_A + "10100001100" + "10100011000" + "10001011000" + SWITCH_CODE_B + "10010110000" + "10010000110" + SWITCH_CODE_A + "10100111100" + "11001110100" + STOP + QUIET_SPACE);
    testEncode("ab\u0000ab", QUIET_SPACE + START_CODE_B + "10010110000" + "10010000110" + SWITCH_CODE_A + "10100001100" + SWITCH_CODE_B + "10010110000" + "10010000110" + "11010001110" + STOP + QUIET_SPACE);
  }
  ...
  @Test(expected = IllegalArgumentException.class) public void testEncodeWithForcedCodeSetFailureCodeSetABadCharacter() throws Exception {
  ...
  @Test(expected = IllegalArgumentException.class) public void testEncodeWithForcedCodeSetFailureCodeSetBBadCharacter() throws Exception {
    String toEncode = "ASdf\u000123";
    Map<EncodeHintType, Object> hints = new EnumMap<>(EncodeHintType.class);
    hints.put(EncodeHintType.FORCE_CODE_SET, "B");
    BitMatrix result = writer.encode(toEncode, BarcodeFormat.CODE_128, 0, 0, hints);
  }

  @Test(expected = IllegalArgumentException.class) public void testEncodeWithForcedCodeSetFailureCodeSetCBadCharactersNonNum() throws Exception {
  ...
  @Test(expected = IllegalArgumentException.class) public void testEncodeWithForcedCodeSetFailureCodeSetCBadCharactersFncCode() throws Exception {
  ...
  @Test(expected = IllegalArgumentException.class) public void testEncodeWithForcedCodeSetFailureCodeSetCWrongAmountOfDigits() throws Exception {
  ...
  @Test public void testEncodeWithForcedCodeSetFailureCodeSetA() throws Exception {
  ...
  @Test public void testEncodeWithForcedCodeSetFailureCodeSetB() throws Exception {
