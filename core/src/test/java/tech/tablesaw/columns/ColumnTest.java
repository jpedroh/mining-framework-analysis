...
public class ColumnTest {
  ...
  @Test public void testCountAtLeast() {
  ...
  private <T extends java.lang.Object> void check(Column<T> column, @SuppressWarnings(value = { "unchecked" }) T... ts) {
