...
public class AggregateFunctionsTest {
  ...
  @Test public void testGroupMean() {
  ...
  @Test public void testBooleanAggregateFunctions() {
  ...
  @Test public void testGroupMeanByStep() {
  ...
  @Test public void testSummaryWithACalculatedColumn() {
  ...
  @Test public void test2ColumnGroupMean() {
  ...
  @Test public void testComplexSummarizing() {
    table.addColumns(table.numberColumn("approval").cube());
    table.column(3).setName("cubed");
    StringColumn byColumn1 = table.stringColumn("who");
  ...
  @Test public void testMultipleColumnTypes() {
  ...
  @Test public void testMultipleColumnTypesWithApply() {
    boolean[] args = { true, false, true, false };
    BooleanColumn booleanColumn = BooleanColumn.create("b", args);
    double[] numbers = { 1, 2, 3, 4 };
    NumberColumn numberColumn = NumberColumn.create("n", numbers);
  ...
  @Test public void testBooleanFunctions() {
  ...
  @Test public void testPercentileFunctions() {
