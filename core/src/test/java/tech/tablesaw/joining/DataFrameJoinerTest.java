...
public class DataFrameJoinerTest {
  ...
  private static Table createHOUSE() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("Style,Bedrooms,BuildDate,Owner", "Colonial,3,1976-06-02,Smith", "Gambrel,4,1982-11-18,Jones", "Contemporary,5,1980-03-24,White", "Split,2,1970-09-30,Brown"), "House");
  }

  private static Table createBOAT() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("Type,Bedrooms,SoldDate,Owner", "Yacht,2,1970-02-03,Jones", "Dinghy,0,1988-12-12,Trump", "HouseBoat,3,1981-04-21,Smith", "Contemporary,5,1980-05-17,White", "Cruise,200,1989-01-23,Brown"), "Boat");
  }

  private static Table createHOUSE10() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("Style,Bedrooms,BuildDate,Owner", "Colonial,3,1976-06-02,Smith", "Gambrel,4,1982-11-18,Jones", "Contemporary,5,1980-03-24,White", "Ranch,4,1982-11-18,Black", "Victorian,5,1980-03-24,Red", "Split,2,1970-09-30,Brown"), "House10");
  }

  private static Table createBOAT10() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("Type,Bedrooms,SoldDate,Owner", "Yacht,2,1970-02-03,Jones", "Dinghy,0,1988-12-12,White", "HouseBoat,3,1981-04-21,Smith", "Contemporary,5,1980-05-17,White", "Paddleboat,3,1981-04-21,Smith", "Rowboat,5,1980-05-17,White", "Sailboat,4,1980-05-17,Black", "Cruise,200,1989-01-23,Brown"), "Boat10");
  }

  private static Table createBEDANDBREAKFAST() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("Design,Bedrooms,SoldDate,Owner", "Colonial,5,1980-05-17,Smith", "Gambrel,4,1982-11-18,Jones", "Contemporary,5,1980-03-24,White", "Split,2,1970-09-30,Brown"), "BedAndBreakfast");
  }

  private static Table createSTUDENT() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("ID,FirstName,LastName,City,State,Age,USID,GradYear", "1,Bob,Barney,Burke,VA,20,11122,2019", "2,Chris,Cabello,Canyonville,OR,20,22224,2019", "3,Dan,Dirble,Denver,CO,21,33335,2020", "4,Edward,Earhardt,Easterly,WA,21,44339,2021", "5,Frank,Farnsworth,Fredriksburg,VA,22,55338,2019", "6,George,Gabral,Garrisburg,MD,22,66337,2020", "7,Michael,Marbury,Milton,NH,23,77330,2020", "8,Robert,Riley,Roseburg,OR,23,88836,2020", "9,Bob,Earhardt,Milton,NH,24,93333,2019", "10,Dan,Gabral,Easterly,WA,24,13333,2020"), "Student");
  }

  private static Table createINSTRUCTOR() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("ID,First,Last,Title,City,State,Age,USID,GradYear", "1,Bob,Cabello,Prof,Burke,VA,20,11333,2019", "2,Chris,Barney,TA,Canyonville,OR,20,22334,2019", "3,Dan,Earhardt,Instructor,Denver,CO,19,33335,2020", "4,Edward,Dirble,Prof,Easterly,WA,22,43339,2020", "5,Farnsworth,Frank,Prof,Fredriksburg,VA,18,55338,2019", "6,Gabral,George,TA,Garrisburg,MD,20,66337,2019", "7,Robert,Marbury,TA,Msilton,NH,22,73330,2020", "8,Michael,Riley,TA,Roseburg,OR,22,88336,2020", "9,Bob,Riley,Prof,Milton,NH,19,99933,2020", "10,Earhardt,Gabral,Prof,Easterly,WA,21,13333,2019"), "Instructor");
  }

  private static Table createDEPTHEAD() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("ID,First,Last,Dept,City,State,Age", "1,John,Cabello,ComputerScience,Burke,VA,20", "2,Samantha,Barney,Writing,Canyonville,OR,21", "3,Mark,Earhardt,Mathematics,Denver,CO,22", "4,Christie,Dirble,Architecture,Easterly,WA,23", "5,Bhawesh,Frank,Psychology,Fredriksburg,VA,24", "6,Robert,George,Sociology,Garrisburg,MD,25", "7,George,Marbury,Physics,Msilton,NH,26", "8,Zhongyu,Riley,Chemistry,Roseburg,OR,27", "9,Laura,Riley,Economics,Milton,NH,28", "10,Sally,Gabral,Marketing,Easterly,WA,29"), "DepartmentHead");
  }

  private static Table createCLASS() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("ID,ClassType,Name,Level,Description,StartDate,EndDate,Completed,Age", "1001,Math,Calculus,101,Newton math,2018-09-20,2018-12-17,false,16", "1002,Math,Calculus,102,Newton math,2019-01-06,2019-03-06,false,17", "1003,Math,Calculus,103,Newton math,2019-03-10,2019-06-17,false,18", "1004,Writing,Composition,101,Writing papers,2018-09-20,2018-12-17,false,19", "1005,Writing,Composition,102,Writing papers,2019-01-06,2019-03-07,false,20", "1006,Software,Programming,101,Programming basics,2018-09-22,2018-12-15,false,21", "1007,Software,Programming,102,Programming basics,2019-01-05,2019-03-07,false,22", "1008,Economics,Microeconomics,101,Basic micro economics,2018-09-20,2018-12-17,false,23", "1009,Economics,Microeconomics,102,Basic micro economics,2018-01-05,2019-03-07,false,24", "1010,Literature,Shakespeare,101,Understanding Shakespeare,2018-09-20,2018-12-17,false,25"), "Class");
  }

  private static Table createANIMALHOMES() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("Animal,Name,Home,Age,MoveInDate", "Pig,Bob,Sty,5,5/5/2018", "Horse,James,Field,5,6/6/2018", "Goat,Samantha,Tree,10,7/7/2018", "Tigon,Rudhrani,Jungle,2,2/2/2018", "Chicken,Chuck,Pen,2,1/1/2018", "Squirrel,Sidney,Tree,10,3/3/2018", "Fox,Frankie,Forest,10,9/19/2018", "Rabbit,Taylor,Forest,10,4/4/2018"), "Animal Homes");
  }

  private static Table createTREE() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("Name,Home,Age", "Cherry,Frontyard,2", "Walnut,Field,3", "Birch,Forest,4", "Tallgreen,Jungle,5", "Apple,Orchard,6", "Orange,Orchard,9", "Hemlock,Forest,10"), "Tree");
  }

  private static Table createFLOWER() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("Name,Home,Age,Color", "Lily,Backyard,2,White", "VenusFlyTrap,Swamp,2,White", "Rose,Frontyard,4,Red", "Pansie,Meadow,5,Blue", "Daisy,Meadow,6,Yellow", "Dandelion,Field,7,Yellow", "Violet,Forest,10,Blue"), "Flower");
  }

  private static Table createDOUBLEINDEXEDPEOPLENicknameDwellingYearsMoveInDate() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("ID,Nickname,Dwelling,Years,MoveInDate", "1.1,Bob,Jungle,5,2/2/2018", "2.1,James,Field,5,6/6/2018", "3.0,David,Jungle,5,6/6/2018", "4.0,Marty,Forest,10,2/2/2018", "5.0,Tarzan,Jungle,10,7/7/2018", "6.0,Samantha,Tree,10,5/5/2018"), "People - Nickname Dwelling Years MoveInDate");
  }

  private static Table createDOUBLEINDEXEDPEOPLENameDwellingYearsMoveInDate() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("ID,Name,Dwelling,Years,MoveInDate", "1.1,Bob,Jungle,5,2/2/2018", "2.1,James,Field,5,6/6/2018", "3.0,David,Jungle,5,6/6/2018", "4.0,Marty,Jungle,10,2/2/2018", "5.0,Tarzan,Jungle,10,7/7/2018", "6.0,Samantha,Tree,10,5/5/2018"), "People - Name Dwelling Years MoveInDate");
  }

  private static Table createDOUBLEINDEXEDPEOPLENameHomeAgeMoveInDate() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("ID,Name,HOME,Age,MoveInDate", "1.1,Bob,Jungle,5,2/2/2018", "2.1,James,Field,5,6/6/2018", "3.0,David,Jungle,5,6/6/2018", "4.0,Marty,Jungle,10,2/2/2018", "5.0,Tarzan,Jungle,10,7/7/2018", "6.0,Samantha,Forest,10,5/5/2018"), "People - Name Home Age MoveInDate");
  }

  private static Table createFOOTBALLSCHEDULE() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("TeamName,PlayDate,PlayTime,Location,HomeGame", "Lancers,2018-09-10,15:30,Springfield,true", "Tigers,2018-09-12,15:00,Detroit,false", "Patriots,2018-09-14,14:30,Boston,true", "Ravens,2018-09-10,12:30,Baltimore,true"), "FootballSchedule");
  }

  private static Table createSOCCERSCHEDULE() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("Mascot,PlayDate,PlayTime,Place", "Steelers,2018-09-10,15:30,Pittsburgh", "Dolphins,2018-09-12,15:00,Miami", "Patriots,2018-09-13,14:30,Boston", "Yankees,2018-09-10,12:00,NewYorkCity"), "SoccerSchedule");
  }

  private static Table createFOOTBALLSCHEDULEDateTime() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("TeamName,PlayDateTime,Location,HomeGame,SeasonRevenue,AllTimeRevenue", "Lancers,2018-09-10T15:30,Springfield,true,2000000000,8500000000000", "Tigers,2018-09-12T15:00,Detroit,false,1500000000,9000000000000", "Patriots,2018-09-14T14:30,Boston,true,1400000000,8200000000000", "Ravens,2018-09-10T12:30,Baltimore,true,2000000000,7000000000000"), "FootballSchedule2");
  }

  private static Table createBASEBALLSCHEDULEDateTime() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("TeamName,PlayDateTime,Location,HomeGame,SeasonRevenue,AllTimeRevenue", "RedSox,2018-09-10T15:30,Springfield,false,2000000000,7000000000000", "Marlins,2018-09-12T15:00,Detroit,true,1500000000,8500000000000", "Mariners,2018-09-14T14:30,Boston,true,1400000000,9000000000000", "Ravens,2018-09-10T12:30,Baltimore,false,2000000000,7000000000000"), "FootballSchedule2");
  }

  private static Table createSOCCERSCHEDULEDateTime() {
    return Table.read().csv(Joiner.on(System.lineSeparator()).join("Mascot,PlayDateTime,Place,SeasonRevenue,AllTimeRevenue", "Steelers,2018-09-10T15:30,Pittsburgh,2000000000,7500000000000", "Dolphins,2018-09-12T15:00,Miami,1500000000,8200000000000", "Patriots,2018-09-13T14:30,Boston,1500000000,9000000000000", "Yankees,2018-09-10T12:00,NewYorkCity,1300000000,7000000000000"), "SoccerSchedule2");
  }

  @Test public void innerJoinWithDoubleBirdsCatsFishDouble() {
    Table joined = DOUBLE_INDEXED_BIRDS.joinOn("ID").inner(DOUBLE_INDEXED_CATS, DOUBLE_INDEXED_FISH);
    assertEquals(4, joined.columnCount());
    assertEquals(1, joined.rowCount());
  }

  @Test public void innerJoinWithDoubleDogsCatsBirdsDouble() {
    Table joined = DOUBLE_INDEXED_FISH.joinOn("ID").inner(DOUBLE_INDEXED_CATS, DOUBLE_INDEXED_BIRDS);
    assertEquals(4, joined.columnCount());
    assertEquals(1, joined.rowCount());
  }
  ...
  @Test public void rightOuterJoinWithDoubles3() {
    Table joined = DOUBLE_INDEXED_PEOPLE.joinOn("ID").rightOuter(DOUBLE_INDEXED_DOGS, DOUBLE_INDEXED_CATS);
    assertEquals(3, joined.columnCount());
    assertEquals(4, joined.rowCount());
  }
  ...
  @Test public void leftOuterJoinWithDoubles4() {
    Table joined = DOUBLE_INDEXED_DOGS.joinOn("ID").leftOuter(DOUBLE_INDEXED_PEOPLE, DOUBLE_INDEXED_CATS);
    assertEquals(3, joined.columnCount());
    assertEquals(4, joined.rowCount());
    assertEquals(4, joined.column("ID").size());
  }
  ...
  @Test public void innerJoinSingleColumn() {
    Table joined = SP500.select("Date").joinOn("Date").inner(ONE_YEAR.select("Date"));
    assertEquals(5, joined.rowCount());
    assertEquals(1, joined.columnCount());
  }

  @Test public void innerJoinSingleColumnOnRight() {
    Table joined = SP500.joinOn("Date").inner(ONE_YEAR.select("Date"));
    assertEquals(5, joined.rowCount());
    assertEquals(2, joined.columnCount());
  }

  @Test public void innerJoinMultipleColumnsAllColumnsInJoinKey() {
    Table table1 = Table.create(SP500.dateColumn("Date"), SP500.dateColumn("Date").copy().setName("Date2"));
    Table table2 = Table.create(ONE_YEAR.dateColumn("Date"), ONE_YEAR.dateColumn("Date").copy().setName("Date2"));
    Table joined = table1.joinOn("Date", "Date2").inner(table2);
    assertEquals(5, joined.rowCount());
    assertEquals(2, joined.columnCount());
  }

  @Test public void innerJoinWithBoolean() {
    Table joined = DUPLICATE_COL_NAME_DOGS.joinOn("Good").inner(true, DUPLICATE_COL_NAME_DOGS.copy());
    assertEquals(5, joined.columnCount());
  ...
  @Test public void innerJoinDuplicateKeysSecondTableWithTextColumn() {
  ...
  @Test public void fullOuterJoinColTwoOnlyJoinKeys() {
  ...
  @Test void joiningShouldNotMutateColNamesOnOriginalTable() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
  ...
  @Test public void innerJoinHouseBoatOnBedroomsOwner() {
    ...
    Table joined = table1.joinOn("Bedrooms", "Owner").inner(table2, new String[] { "Bedrooms", "Owner" });
  ...
  @Test public void innerJoinHouseBoatOnStyleTypeBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.joinOn("Style", "Bedrooms", "Owner").inner(table2, new String[] { "Type", "Bedrooms", "Owner" });
    assertEquals(5, joined.columnCount());
    assertEquals(1, joined.rowCount());
  }
  ...
  @Test public void leftJoinHouseBoatOnBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.joinOn("Bedrooms", "Owner").leftOuter(table2, new String[] { "Bedrooms", "Owner" });
    assertEquals(6, joined.columnCount());
    assertEquals(4, joined.rowCount());
  }
  ...
  @Test public void leftJoinHouseBoatBnBOnStyleTypeBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.joinOn("Style", "Bedrooms", "Owner").leftOuter(table2, new String[] { "Type", "Bedrooms", "Owner" });
    assertEquals(5, joined.columnCount());
    assertEquals(4, joined.rowCount());
  }
  ...
  @Test public void rightJoinHouseBoatOnBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.joinOn("Bedrooms", "Owner").rightOuter(table2, new String[] { "Bedrooms", "Owner" });
    assertEquals(6, joined.columnCount());
    assertEquals(5, joined.rowCount());
  }
  ...
  @Test public void rightJoinHouseBoatOnStyleTypeBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.joinOn("Style", "Bedrooms", "Owner").rightOuter(table2, new String[] { "Type", "Bedrooms", "Owner" });
    assertEquals(5, joined.columnCount());
    assertEquals(5, joined.rowCount());
  }
  ...
  @Test public void innerJoinOnAllMismatchedColNames() {
    ...
    Table joined = table1.joinOn("Name", "Home", "Age").inner(table2, true, "Nickname", "Dwelling", "Years");
    assertEquals(7, joined.columnCount());
    assertEquals(2, joined.rowCount());
  }
  ...
  @Test public void innerJoinOnPartiallyMismatchedColNames() {
    ...
    Table joined = table1.joinOn("Name", "Home", "Age").inner(table2, true, "Name", "Dwelling", "Years");
  ...
  @Test public void leftOuterJoinOnPartiallyMismatchedColNames() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameDwellingYearsMoveInDate();
    Table joined = table1.joinOn("Name", "Home", "Age").leftOuter(table2, true, "Name", "Dwelling", "Years");
    assert (joined.columnNames().containsAll(Arrays.asList("Name", "Home", "Age")));
    assertEquals(7, joined.columnCount());
    assertEquals(8, joined.rowCount());
  }
  ...
  @Test public void rightOuterJoinOnPartiallyMismatchedColNames() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameDwellingYearsMoveInDate();
    Table joined = table1.joinOn("Name", "Home", "Age").rightOuter(table2, true, "Name", "Dwelling", "Years");
  ...
  @Test public void fullOuterJoinFootballBaseballBoolean() {
    Table table1 = createFOOTBALLSCHEDULE();
