...
public class DataFrameJoinerTest {
  ...
  private static final Table DOUBLE_INDEXED_PEOPLE = Table.read().csv(Joiner.on(System.lineSeparator()).join("ID,Name", "1.0,Bob", "2.0,James", "3.0,David", "4.0,Samantha"), "People");

  private static final Table DOUBLE_INDEXED_DOGS = Table.read().csv(Joiner.on(System.lineSeparator()).join("ID,Dog Name", "1.0,Spot", "3.0,Fido", "4.0,Sasha", "5.0,King"), "Dogs");

  private static final Table DOUBLE_INDEXED_CATS = Table.read().csv("ID,Cat Name\n" + "1.0,Spot2\n" + "2.0,Fido\n" + "6.0,Sasha\n" + "8.0,King2\n", "Cats");

  private static final Table DOUBLE_INDEXED_FISH = Table.read().csv("ID,Fish Name\n" + "11.0,Spot3\n" + "2.0,Fido\n" + "4.0,Sasha\n" + "6.0,King2\n", "Fish");

  private static final Table DOUBLE_INDEXED_MICE = Table.read().csv("ID,Mice_Name\n" + "2.0,Jerry\n" + "3.0,Fido\n" + "6.0,Sasha\n" + "9.0,Market\n", "Mice");

  private static final Table DUPLICATE_COL_NAME_DOGS = Table.read().csv(Joiner.on(System.lineSeparator()).join("ID,Dog Name, Good", "1.0,Spot,true", "3.0,Fido,true", "4.0,Sasha,true", "5.0,King,true", "1.0,Spot,false", "3.0,Fido,false", "4.0,Sasha,false", "5.0,King,false"), "Dogs");

  private static Table createHOUSE() {
    return Table.read().csv("Style,Bedrooms,BuildDate,Owner\n" + "Colonial,3,1976-06-02,Smith\n" + "Gambrel,4,1982-11-18,Jones\n" + "Contemporary,5,1980-03-24,White\n" + "Split,2,1970-09-30,Brown\n", "House");
  }

  private static Table createBOAT() {
    return Table.read().csv("Type,Bedrooms,SoldDate,Owner\n" + "Yacht,2,1970-02-03,Jones\n" + "Dinghy,0,1988-12-12,Trump\n" + "HouseBoat,3,1981-04-21,Smith\n" + "Contemporary,5,1980-05-17,White\n" + "Cruise,200,1989-01-23,Brown\n", "Boat");
  }
  ...
  private static Table createBEDANDBREAKFAST() {
    return Table.read().csv("Design,Bedrooms,SoldDate,Owner\n" + "Colonial,5,1980-05-17,Smith\n" + "Gambrel,4,1982-11-18,Jones\n" + "Contemporary,5,1980-03-24,White\n" + "Split,2,1970-09-30,Brown\n", "BedAndBreakfast");
  }

  private static Table createSTUDENT() {
    return Table.read().csv(
<<<<<<< /usr/src/app/output/jtablesaw/tablesaw/9a52d00511a6f7b1aae615e9f8bbea3e8a68b05c/core/src/test/java/tech/tablesaw/joining/DataFrameJoinerTest.java/left.java
...
=======
    Joiner.on(System.lineSeparator()).join("ID,FirstName,LastName,City,State,Age,USID,GradYear", "1,Bob,Barney,Burke,VA,17,11122,2019", "2,Chris,Cabello,Canyonville,OR,17,22224,2019", "3,Dan,Dirble,Denver,CO,17,33335,2020", "4,Edward,Earhardt,Easterly,WA,18,44339,2021", "5,Frank,Farnsworth,Fredriksburg,VA,18,55338,2019", "6,George,Gabral,Garrisburg,MD,19,66337,2020", "7,Michael,Marbury,Milton,NH,19,77330,2020", "8,Robert,Riley,Roseburg,OR,19,88836,2020", "9,Bob,Earhardt,Milton,NH,50,93333,2019", "10,Dan,Gabral,Easterly,WA,20,13333,2020")
>>>>>>> /usr/src/app/output/jtablesaw/tablesaw/9a52d00511a6f7b1aae615e9f8bbea3e8a68b05c/core/src/test/java/tech/tablesaw/joining/DataFrameJoinerTest.java/right.java
    , "Student");
  }
...
=======
    Joiner.on(System.lineSeparator()).join("ID,First,Last,Title,City,State,Age,USID,GradYear", "1,Bob,Cabello,Prof,Burke,VA,20,11333,2019", "2,Chris,Barney,TA,Canyonville,OR,20,22334,2019", "3,Dan,Earhardt,Instructor,Denver,CO,22,33335,2020", "4,Edward,Dirble,Prof,Easterly,WA,22,43339,2020", "5,Farnsworth,Frank,Prof,Fredriksburg,VA,22,55338,2019", "6,Gabral,George,TA,Garrisburg,MD,18,66337,2019", "7,Robert,Marbury,TA,Msilton,NH,23,73330,2020", "8,Michael,Riley,TA,Roseburg,OR,23,88336,2020", "9,Bob,Riley,Prof,Milton,NH,50,99933,2020", "10,Earhardt,Gabral,Prof,Easterly,WA,24,13333,2019")
>>>>>>> /usr/src/app/output/jtablesaw/tablesaw/9a52d00511a6f7b1aae615e9f8bbea3e8a68b05c/core/src/test/java/tech/tablesaw/joining/DataFrameJoinerTest.java/right.java
    , "Instructor");
  }
...
=======
    Joiner.on(System.lineSeparator()).join("ID,First,Last,Dept,City,State,Age", "1,John,Cabello,ComputerScience,Burke,VA,20", "2,Samantha,Barney,Writing,Canyonville,OR,18", "3,Mark,Earhardt,Mathematics,Denver,CO,35", "4,Christie,Dirble,Architecture,Easterly,WA,36", "5,Bhawesh,Frank,Psychology,Fredriksburg,VA,37", "6,Robert,George,Sociology,Garrisburg,MD,38", "7,George,Marbury,Physics,Msilton,NH,39", "8,Zhongyu,Riley,Chemistry,Roseburg,OR,40", "9,Laura,Riley,Economics,Milton,NH,50", "10,Sally,Gabral,Marketing,Easterly,WA,42")
>>>>>>> /usr/src/app/output/jtablesaw/tablesaw/9a52d00511a6f7b1aae615e9f8bbea3e8a68b05c/core/src/test/java/tech/tablesaw/joining/DataFrameJoinerTest.java/right.java
    , "DepartmentHead");
  }
...
>>>>>>> /usr/src/app/output/jtablesaw/tablesaw/9a52d00511a6f7b1aae615e9f8bbea3e8a68b05c/core/src/test/java/tech/tablesaw/joining/DataFrameJoinerTest.java/right.java
  ...
  @Test public void innerJoinWithDoubleDogsCatsFishVarargs() {
    Table joined = DOUBLE_INDEXED_MICE.join("ID").inner(DOUBLE_INDEXED_CATS, DOUBLE_INDEXED_FISH);
    assertEquals(4, joined.columnCount());
    assertEquals(2, joined.rowCount());
  }

  @Test public void innerJoinWithDoublesSimple() {
  ...
  @Test public void innerJoinWithDoubles() {
    Table joined = DOUBLE_INDEXED_PEOPLE.join("ID").inner(DOUBLE_INDEXED_DOGS, "ID");
    assertEquals(3, joined.columnCount());
    assertEquals(3, joined.rowCount());
  }

  @Test public void innerJoinWithDuplicateColumnNames() {
  ...
  @Test public void rightOuterJoinWithDuplicateColumnNames() {
    Table table1 = DUPLICATE_COL_NAME_DOGS.where(DUPLICATE_COL_NAME_DOGS.booleanColumn("Good").isTrue());
    Table table2 = DUPLICATE_COL_NAME_DOGS.where(DUPLICATE_COL_NAME_DOGS.booleanColumn("Good").isFalse());
    Table joined = table1.join("ID").rightOuter(table2, true);
    assertEquals(5, joined.columnCount());
    assertEquals(4, joined.rowCount());
  }

  @Test public void leftOuterJoinWithDuplicateColumnNames() {
    Table table1 = DUPLICATE_COL_NAME_DOGS.where(DUPLICATE_COL_NAME_DOGS.booleanColumn("Good").isTrue());
    Table table2 = DUPLICATE_COL_NAME_DOGS.where(DUPLICATE_COL_NAME_DOGS.booleanColumn("Good").isFalse());
    Table joined = table1.join("ID").leftOuter(table2, true);
    assertEquals(5, joined.columnCount());
    assertEquals(4, joined.rowCount());
    assertEquals(4, joined.column("ID").size());
  }

  @Test public void leftOuterJoinWithDoubles() {
  ...
  @Test public void rightOuterJoinWithDoubles() {
  ...
  @Test public void rightOuterJoinWithDoubles2() {
  ...
  @Test public void leftOuterJoinWithDoubles3() {
  ...
  @Test public void leftOuterJoinWithDoubles4() {
  ...
  @Test public void innerJoinDuplicateKeysFirstTable() {
    Table joined = ANIMAL_NAMES.join("Animal").inner(ANIMAL_FEED, "Animal");
    assertEquals(3, joined.columnCount());
    assertEquals(4, joined.rowCount());
  }

  @Test public void leftOuterJoinDuplicateKeysFirstTable() {
  ...
  @Test public void innerJoinDuplicateKeysSecondTable() {
    Table joined = ANIMAL_FEED.join("Animal").inner(ANIMAL_NAMES, "Animal");
    assertEquals(3, joined.columnCount());
    assertEquals(4, joined.rowCount());
  }

  @Test public void leftOuterJoinDuplicateKeysSecondTable() {
  ...
  @Test public void fullOuterJoinJustTable() {
  ...
  @Test public void fullOuterJoin() {
  ...
  @Test public void fullOuterJoinNew() {
  ...
  @Test public void innerJoinStudentInstructorOnAge() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
    Table joined = table1.join("Age").inner(true, table2);
    assert (joined.columnNames().containsAll(Arrays.asList(new String[] { "T2.ID", "T2.City", "T2.State", "T2.USID", "T2.GradYear" })));
    assertEquals(16, joined.columnCount());
    assertEquals(14, joined.rowCount());
  }

  @Test public void innerJoinInstructorStudentOnAge() {
  ...
  @Test public void innerJoinStudentInstructorClassOnAge() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
    Table table3 = createCLASS();
    Table joined = table1.join("Age").inner(true, table2, table3);
    assert (joined.columnNames().containsAll(Arrays.asList(new String[] { "T2.ID", "T2.City", "T2.State", "T2.USID", "T2.GradYear", "T3.ID" })));
    assertEquals(24, joined.columnCount());
    assertEquals(14, joined.rowCount());
  }

  @Test public void innerJoinStudentInstructorClassDeptHeadOnAge() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
    Table table3 = createCLASS();
    Table table4 = createDEPTHEAD();
    Table joined = table1.join("Age").inner(true, table2, table3, table4);
    assert (joined.columnNames().containsAll(Arrays.asList(new String[] { "T2.ID", "T2.City", "T2.State", "T2.USID", "T2.GradYear", "T3.ID", "T4.ID", "T4.First", "T4.Last", "T4.City", "T4.State" })));
    assertEquals(30, joined.columnCount());
    assertEquals(14, joined.rowCount());
  }

  @Test public void innerJoinStudentInstructorDeptHeadOnStateAge() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
    Table table3 = createDEPTHEAD();
    Table joined = table1.join(new String[] { "State", "Age" }).inner(true, table2, table3);
    assert (joined.columnNames().containsAll(Arrays.asList(new String[] { "T2.ID", "T2.City", "T2.USID", "T2.GradYear", "T3.ID", "T3.First", "T3.Last", "T3.City" })));
    assertEquals(20, joined.columnCount());
    assertEquals(1, joined.rowCount());
  }

  @Test public void innerJoinStudentInstructorOnStateAge() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
  ...
  @Test public void innerJoinStudentInstructorOnStateAgeGradYear() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
    Table joined = table1.join(new String[] { "State", "Age", "GradYear" }).inner(true, table2);
    assertEquals(14, joined.columnCount());
    assertEquals(2, joined.rowCount());
  }

  @Test public void leftJoinStudentInstructorOnStateAge() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
    Table joined = table1.join(new String[] { "State", "Age" }).leftOuter(true, table2);
    assertEquals(15, joined.columnCount());
  ...
  @Test public void innerJoinHouseBoatOnBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.join(new String[] { "Bedrooms", "Owner" }).inner(table2, new String[] { "Bedrooms", "Owner" });
    assertEquals(6, joined.columnCount());
    assertEquals(2, joined.rowCount());
    assertEquals(2, joined.column("Bedrooms").size());
  }

  @Test public void innerJoinHouseBoatOnStyleTypeBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.join(new String[] { "Style", "Bedrooms", "Owner" }).inner(table2, new String[] { "Type", "Bedrooms", "Owner" });
    assertEquals(5, joined.columnCount());
    assertEquals(1, joined.rowCount());
  }

  @Test public void fullJoinHouseBoatOnBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.join(new String[] { "Bedrooms", "Owner" }).fullOuter(true, table2);
    assertEquals(6, joined.columnCount());
  ...
  @Test public void fullJoinHouse10Boat10OnBedroomsOwner() {
  ...
  @Test public void fullJoinBnBBoat10OnBedroomsOwner() {
    Table table1 = createBEDANDBREAKFAST();
    Table table2 = createBOAT10();
    Table joined = table1.join(new String[] { "Bedrooms", "SoldDate" }).fullOuter(true, table2);
    assertEquals(6, joined.columnCount());
    assertEquals(11, joined.rowCount());
  ...
  @Test public void leftJoinHouseBoatOnBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.join(new String[] { "Bedrooms", "Owner" }).leftOuter(table2, new String[] { "Bedrooms", "Owner" });
    assertEquals(6, joined.columnCount());
    assertEquals(4, joined.rowCount());
  }

  @Test public void leftJoinHouseBoatOnStyleTypeBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.join(new String[] { "Style", "Bedrooms", "Owner" }).leftOuter(table2, new String[] { "Type", "Bedrooms", "Owner" });
    assertEquals(5, joined.columnCount());
    assertEquals(4, joined.rowCount());
  }

  @Test public void leftJoinHouseBoatBnBOnStyleTypeBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.join(new String[] { "Style", "Bedrooms", "Owner" }).leftOuter(table2, new String[] { "Type", "Bedrooms", "Owner" });
    assertEquals(5, joined.columnCount());
  ...
  @Test public void rightJoinHouseBoatOnBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.join(new String[] { "Bedrooms", "Owner" }).rightOuter(table2, new String[] { "Bedrooms", "Owner" });
    assertEquals(6, joined.columnCount());
    assertEquals(5, joined.rowCount());
  }

  @Test public void rightJoinHouseBoatOnStyleTypeBedroomsOwner() {
    Table table1 = createHOUSE();
    Table table2 = createBOAT();
    Table joined = table1.join(new String[] { "Style", "Bedrooms", "Owner" }).rightOuter(table2, new String[] { "Type", "Bedrooms", "Owner" });
    assertEquals(5, joined.columnCount());
    assertEquals(5, joined.rowCount());
  }

  @Test public void rightJoinStudentInstructorOnStateAge() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
    Table joined = table1.join(new String[] { "State", "Age" }).rightOuter(true, table2);
    assertEquals(15, joined.columnCount());
    assertEquals(10, joined.rowCount());
  }

  @Test public void innerJoinStudentInstructorOnStateName() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
    Table joined = table1.join(new String[] { "State", "FirstName" }).inner(table2, true, new String[] { "State", "First" });
    assertEquals(15, joined.columnCount());
    assertEquals(5, joined.rowCount());
  }

  @Test public void leftJoinStudentInstructorOnStateName() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
    Table joined = table1.join(new String[] { "State", "FirstName" }).leftOuter(table2, true, new String[] { "State", "First" });
    assertEquals(15, joined.columnCount());
    assertEquals(10, joined.rowCount());
  }

  @Test public void rightJoinStudentInstructorOnStateName() {
    Table table1 = createSTUDENT();
    Table table2 = createINSTRUCTOR();
    Table joined = table1.join(new String[] { "State", "FirstName" }).rightOuter(table2, true, new String[] { "State", "First" });
    assertEquals(15, joined.columnCount());
    assertEquals(10, joined.rowCount());
  }

  @Test public void innerJoinOnAge() {
  ...
  @Test public void innerJoinAnimalPeopleOnAge() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameHomeAgeMoveInDate();
    Table joined = table1.join("Age").inner(true, table2);
    assertEquals(9, joined.columnCount());
  ...
  @Test public void innerJoinAnimalTreeOnAge() {
    Table table1 = createANIMALHOMES();
  ...
  @Test public void innerJoinAnimalPeopleTreeOnAge() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameHomeAgeMoveInDate();
    Table table3 = createTREE();
    Table table4 = createFLOWER();
    Table joined = table1.join("Age").inner(true, table2, table3, table4);
    assert (joined.columnNames().containsAll(Arrays.asList(new String[] { "T2.Name", "T2.HOME", "T2.MoveInDate", "T3.Name", "T3.Home", "T4.Name", "T4.Home", "Color" })));
    assertEquals(14, joined.columnCount());
    assertEquals(18, joined.rowCount());
  }

  @Test public void innerJoinAnimalPeopleTreeOnAgeHome() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameHomeAgeMoveInDate();
    Table table3 = createTREE();
    Table table4 = createFLOWER();
    Table joined = table1.join(new String[] { "Age", "Home" }).inner(true, table2, table3, table4);
    assert (joined.columnNames().containsAll(Arrays.asList(new String[] { "Animal", "Name", "Home", "Age", "MoveInDate", "ID", "T2.Name", "T2.MoveInDate", "T3.Name", "T4.Name", "Color" })));
    assertEquals(11, joined.columnCount());
    assertEquals(2, joined.rowCount());
  }

  @Test public void innerJoinOnNameHomeAge() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameHomeAgeMoveInDate();
    Table joined = table1.join(new String[] { "Name", "Home", "Age" }).inner(true, table2);
    assertEquals(7, joined.columnCount());
    assertEquals(1, joined.rowCount());
  }

  @Test public void innerJoinOnAllMismatchedColNames() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENicknameDwellingYearsMoveInDate();
    Table joined = table1.join(new String[] { "Name", "Home", "Age" }).inner(table2, true, new String[] { "Nickname", "Dwelling", "Years" });
    assertEquals(7, joined.columnCount());
    assertEquals(2, joined.rowCount());
  }

  @Test public void innerJoinOnPartiallyMismatchedColNames() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameDwellingYearsMoveInDate();
    Table joined = table1.join(new String[] { "Name", "Home", "Age" }).inner(table2, true, new String[] { "Name", "Dwelling", "Years" });
    assert (joined.columnNames().containsAll(Arrays.asList(new String[] { "Name", "Home", "Age" })));
    assertEquals(7, joined.columnCount());
    assertEquals(2, joined.rowCount());
  }

  @Test public void leftOuterJoinOnPartiallyMismatchedColNames() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameDwellingYearsMoveInDate();
    Table joined = table1.join(new String[] { "Name", "Home", "Age" }).leftOuter(table2, true, new String[] { "Name", "Dwelling", "Years" });
    assert (joined.columnNames().containsAll(Arrays.asList(new String[] { "Name", "Home", "Age" })));
    assertEquals(7, joined.columnCount());
    assertEquals(8, joined.rowCount());
  }

  @Test public void rightOuterJoinOnPartiallyMismatchedColNames() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameDwellingYearsMoveInDate();
    Table joined = table1.join(new String[] { "Name", "Home", "Age" }).rightOuter(table2, true, "Name", "Dwelling", "Years");
    assert (joined.columnNames().containsAll(Arrays.asList(new String[] { "Name", "Dwelling", "Years" })));
    assertEquals(7, joined.columnCount());
    assertEquals(6, joined.rowCount());
  }

  @Test public void innerJoinOnAgeMoveInDate() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameHomeAgeMoveInDate();
    Table joined = table1.join(new String[] { "Age", "MoveInDate" }).inner(true, table2);
    assertEquals(8, joined.columnCount());
    assertEquals(3, joined.rowCount());
  }

  @Test public void leftOuterJoinOnAgeMoveInDate() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameHomeAgeMoveInDate();
    Table joined = table1.join(new String[] { "Age", "MoveInDate" }).leftOuter(true, table2);
    assertEquals(8, joined.columnCount());
    assertEquals(9, joined.rowCount());
  }

  @Test public void rightOuterJoinOnAgeMoveInDate() {
    Table table1 = createANIMALHOMES();
    Table table2 = createDOUBLEINDEXEDPEOPLENameHomeAgeMoveInDate();
  ...
  @Test public void innerJoinFootballSoccerOnPlayDate() {
    Table table1 = createFOOTBALLSCHEDULE();
    Table table2 = createSOCCERSCHEDULE();
    Table joined = table1.join(new String[] { "PlayDate" }).inner(true, table2);
    assertEquals(8, joined.columnCount());
    assertEquals(5, joined.rowCount());
  }

  @Test public void innerJoinFootballSoccerOnPlayTime() {
    Table table1 = createFOOTBALLSCHEDULE();
    Table table2 = createSOCCERSCHEDULE();
    Table joined = table1.join(new String[] { "PlayTime" }).inner(true, table2);
    assertEquals(8, joined.columnCount());
    assertEquals(3, joined.rowCount());
  }

  @Test public void innerJoinFootballSoccerOnPlayDatePlayTime() {
    Table table1 = createFOOTBALLSCHEDULE();
    Table table2 = createSOCCERSCHEDULE();
    Table joined = table1.join(new String[] { "PlayDate", "PlayTime" }).inner(true, table2);
    assertEquals(7, joined.columnCount());
    assertEquals(2, joined.rowCount());
  }

  @Test public void fullOuterJoinFootballSoccerOnPlayTime() {
    Table table1 = createFOOTBALLSCHEDULE();
    Table table2 = createSOCCERSCHEDULE();
  ...
  @Test public void innerJoinFootballSoccerOnPlayDatePlayDateTime() {
  ...
  @Test public void innerJoinFootballSoccerOnSeasonRevenue() {
    Table table1 = createFOOTBALLSCHEDULEDateTime();
    Table table2 = createSOCCERSCHEDULEDateTime();
    Table joined = table1.join(new String[] { "SeasonRevenue", "AllTimeRevenue" }).inner(true, table2);
    assertEquals(9, joined.columnCount());
    assertEquals(1, joined.rowCount());
  }

  @Test public void innerJoinFootballSoccerOnHomeGame() {
    Table table1 = createFOOTBALLSCHEDULEDateTime();
    Table table2 = createSOCCERSCHEDULEDateTime();
    try {
      Table joined = table1.join(new String[] { "HomeGame" }).inner(true, table2);
      assertEquals(9, joined.columnCount());
      assertEquals(1, joined.rowCount());
  ...
  @Test public void fullOuterJoinFootballSoccerOnPlayDateTimeSeasonRevenue() {
    Table table1 = createFOOTBALLSCHEDULEDateTime();
    Table table2 = createSOCCERSCHEDULEDateTime();
    Table joined = table1.join(new String[] { "PlayDateTime", "SeasonRevenue" }).fullOuter(true, table2);
    assertEquals(9, joined.columnCount());
    assertEquals(6, joined.rowCount());
  ...
  @Test public void fullOuterJoinFootballSoccerOnPlayDateTimeAllTimeRevenue() {
    Table table1 = createFOOTBALLSCHEDULEDateTime();
    Table table2 = createSOCCERSCHEDULEDateTime();
    Table joined = table1.join(new String[] { "AllTimeRevenue" }).fullOuter(true, table2);
    assertEquals(10, joined.columnCount());
    assertEquals(5, joined.rowCount());
  ...
  @Test public void fullOuterJoinFootballBaseballException() {
    Table table1 = createFOOTBALLSCHEDULE();
    Table table2 = createBASEBALLSCHEDULEDateTime();
    try {
      table1.join(new String[] { "HomeGame" }).fullOuter(true, table2);
    } catch (IllegalArgumentException e) {
      assertTrue(e.getMessage().contains("Joining is supported on integral, string, and date-like columns."));
    }
  }
