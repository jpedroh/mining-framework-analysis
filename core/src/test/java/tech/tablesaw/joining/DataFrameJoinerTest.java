...
<<<<<<< /usr/src/app/output/jtablesaw/tablesaw/9a52d00511a6f7b1aae615e9f8bbea3e8a68b05c/core/src/test/java/tech/tablesaw/joining/DataFrameJoinerTest.java/left.java
    ...
    private static final Table DUPLICATE_COL_NAME_DOGS = Table.read().csv(
            "ID,Dog Name, Good\n"
                    ...
                    + "4.0,Sasha,false\n"
                    + "5.0,King,false\n",
||||||| /usr/src/app/output/jtablesaw/tablesaw/9a52d00511a6f7b1aae615e9f8bbea3e8a68b05c/core/src/test/java/tech/tablesaw/joining/DataFrameJoinerTest.java/base.java
    private static final Table DUPLICATE_COL_NAME_DOGS = Table.read().csv(
            "ID,Dog Name, Good\n"
                    + "1.0,Spot,true\n"
                    + "3.0,Fido,true\n"
