...
public abstract class XdiAbstractClass<U extends XdiInstanceUnordered, O extends XdiInstanceOrdered, I extends XdiInstance> extends XdiAbstractSubGraph implements XdiClass<U, O, I> {
  ...
  public static boolean isValid(ContextNode contextNode) {
    return XdiEntityClass.isValid(contextNode) || XdiAttributeClass.isValid(contextNode);
  }
  ...
  public static XdiAbstractClass<? extends XdiInstanceUnordered, ? extends XdiInstanceOrdered, ? extends XdiInstance> fromContextNode(ContextNode contextNode) {
    ...
    if ((xdiClass = XdiEntityClass.fromContextNode(contextNode)) != null) {
      return xdiClass;
    }
    if ((xdiClass = XdiAttributeClass.fromContextNode(contextNode)) != null) {
      return xdiClass;
    }
    return null;
  }
  ...
  public static boolean isValidArcXri(XDI3SubSegment arcXri) {
    return XdiEntityClass.isValidArcXri(arcXri) || XdiAttributeClass.isValidArcXri(arcXri);
  }
  ...
  /**
	 ...
	 */
  @Override public U setXdiInstanceUnordered(XDI3SubSegment arcXri) {
  ...
  /**
	 ...
	 * @return The XDI instance.
	 */
  @Override public U getXdiInstanceUnordered(XDI3SubSegment arcXri) {
    ContextNode instanceContextNode = this.getContextNode().getContextNode(arcXri);
    if (instanceContextNode == null) {
      return null;
    }
  ...
  /**
	 ...
	 */
  @Override public ReadOnlyIterator<U> getXdiInstancesUnordered() {
  ...
  /**
	 ...
	 */
  @Override public long getXdiInstancesUnorderedCount() {
  ...
  /**
	 ...
	 */
  @Override public O setXdiInstanceOrdered(long index) {
    boolean attribute = this.attribute();
    if (index < 0) {
  ...
  /**
	 ...
	 * @return The XDI element.
	 */
  @Override public O getXdiInstanceOrdered(long index) {
    boolean attribute = this.attribute();
    XDI3SubSegment arcXri = XdiAbstractInstanceOrdered.createArcXri(Long.toString(index), attribute);
    ContextNode contextNode = this.getContextNode().getContextNode(arcXri);
    if (contextNode == null) {
  ...
  /**
	 ...
	 */
  @Override public ReadOnlyIterator<O> getXdiInstancesOrdered() {
  ...
  /**
	 ...
	 */
  @Override public long getXdiInstancesOrderedCount() {
  ...
  /**
	 ...
	 */
  @Override public ReadOnlyIterator<I> getXdiInstances(boolean deref) {
  ...
  private boolean attribute() {
    ...
    if (this instanceof XdiAttributeClass) {
      ...
      if (this instanceof XdiEntityClass) {
        attribute = false;
      } else {
  ...
  public static class MappingContextNodeXdiClassIterator extends NotNullIterator<XdiClass<? extends XdiInstanceUnordered, ? extends XdiInstanceOrdered, ? extends XdiInstance>> {
    public MappingContextNodeXdiClassIterator(Iterator<ContextNode> contextNodes) {
      super(new MappingIterator<ContextNode, XdiClass<? extends XdiInstanceUnordered, ? extends XdiInstanceOrdered, ? extends XdiInstance>>(contextNodes) {
        @Override public XdiClass<? extends XdiInstanceUnordered, ? extends XdiInstanceOrdered, ? extends XdiInstance> map(ContextNode contextNode) {
