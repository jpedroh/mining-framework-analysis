...
public class XdiPeerRoot extends XdiAbstractRoot {
  ...
  public static boolean isValid(ContextNode contextNode) {
    ...
    if (contextNode.getContextNode() != null && !XdiAbstractRoot.isValid(contextNode.getContextNode())) {
      return false;
    }
    return true;
  }
  ...
  public static XdiPeerRoot fromContextNode(ContextNode contextNode) {
    ...
    if (contextNode.getXDIArc().isDefinition() && contextNode.getXDIArc().isVariable()) {
      return new Definition.Variable(contextNode);
    }
    if (contextNode.getXDIArc().isDefinition() && !contextNode.getXDIArc().isVariable()) {
  ...
  public boolean isSelfPeerRoot() {
    ...
    if (refPeerRoot != null && refPeerRoot.equals(selfPeerRoot)) {
      return true;
    }
    ...
    if (repPeerRoot != null && repPeerRoot.equals(selfPeerRoot)) {
      return true;
    }
    return false;
  }
  ...
  public static XDIAddress getXDIAddressOfPeerRootXDIArc(XDIArc XDIarc) {
    ...
    if (!XDIConstants.XS_ROOT.equals(xref.getXs())) {
      return null;
    }
    if (!xref.hasXDIArc()) {
      return null;
  ...
  public static boolean isValidXDIArc(XDIArc XDIarc) {
    ...
    if (getXDIAddressOfPeerRootXDIArc(XDIarc) != null) {
      return true;
    }
    if (getIriOfPeerRootXDIArc(XDIarc) != null) {
      return true;
    }
    if (getLiteralOfPeerRootXDIArc(XDIarc) != null) {
      return true;
    }
    return false;
  }
  ...
  public static class MappingContextNodePeerRootIterator extends NotNullIterator<XdiPeerRoot> {
    public MappingContextNodePeerRootIterator(Iterator<ContextNode> contextNodes) {
      super(new MappingIterator<ContextNode, XdiPeerRoot>(contextNodes) {
        @Override public XdiPeerRoot map(ContextNode contextNode) {
  ...
  public static class MappingXDIAddressPeerRootXDIArcIterator extends MappingIterator<XDIAddress, XDIArc> {
    ...
    @Override public XDIArc map(XDIAddress XDIaddress) {
  ...
  public static class MappingPeerRootXDIArcXDIAddressIterator extends MappingIterator<XDIArc, XDIAddress> {
    ...
    @Override public XDIAddress map(XDIArc XDIarc) {
  ...
  public static class MappingPeerRootXDIArcIriIterator extends MappingIterator<XDIArc, String> {
    ...
    @Override public String map(XDIArc XDIarc) {
