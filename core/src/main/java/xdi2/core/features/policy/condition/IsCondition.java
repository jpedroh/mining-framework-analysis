...
public class IsCondition extends Condition {
  ...
  public static boolean isValid(XDIStatement XDIstatement) {
    ...
    if (!XDIPolicyConstants.XDI_ADD_IS.equals(XDIstatement.getRelationXDIAddress())) {
      return false;
    }
    return true;
  }
  ...
  @Override public boolean evaluateInternal(PolicyEvaluationContext policyEvaluationContext) {
