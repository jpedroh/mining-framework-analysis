...
public class AutoReader extends AbstractXDIReader {
  ...
  private static String readerClassNames[] = { XDIJSONReader.class.getName(), XDIJSONQuadReader.class.getName(), XDIDisplayReader.class.getName(), XDIJSONXDReader.class.getName() };
  ...
  static {
    ...
    for (String readerClassName : readerClassNames) {
      try {
        ...
        if (readerClass.equals(AutoReader.class)) {
          continue;
        }
  ...
  @SuppressWarnings(value = { "unchecked" }) private static Class<XDIReader> forName(String readerClassName) throws ClassNotFoundException {
  ...
  @Override public synchronized Reader read(Graph graph, Reader reader) throws IOException, Xdi2ParseException {
  ...
  @Override public synchronized InputStream read(Graph graph, InputStream stream) throws IOException, Xdi2ParseException {
