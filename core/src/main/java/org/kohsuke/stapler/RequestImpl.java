...
public class RequestImpl extends HttpServletRequestWrapper implements StaplerRequest {
  ...
  /**
     ...
     */
  private static int FILEUPLOAD_MAX_FILES = Integer.getInteger(RequestImpl.class.getName() + ".FILEUPLOAD_MAX_FILES", 1000);
  ...
  /**
     ...
     * Set to {@code -1} to disable limits.
     */
  private static long FILEUPLOAD_MAX_FILE_SIZE = Long.getLong(RequestImpl.class.getName() + ".FILEUPLOAD_MAX_FILE_SIZE", -1);
  ...
  /**
     ...
     * Set to {@code -1} to disable limits.
     */
  private static long FILEUPLOAD_MAX_SIZE = Long.getLong(RequestImpl.class.getName() + ".FILEUPLOAD_MAX_SIZE", -1);
  ...
  @Override public boolean isJavaScriptProxyCall() {
    String ct = getContentType();
    return ct != null && ct.startsWith("application/x-stapler-method-invocation");
  }

  @Override public BoundObjectTable getBoundObjectTable() {
    return stapler.getWebApp().boundObjectTable;
  }

  @Override public String createJavaScriptProxy(Object toBeExported) {
    return getBoundObjectTable().bind(toBeExported).getProxyScript();
  }

  @Override public RenderOnDemandParameters createJavaScriptProxyParameters(Object toBeExported) {
  ...
  @Override public Stapler getStapler() {
    return stapler;
  }
  ...
  @Override public String getRestOfPath() {
    return tokens.assembleRestOfPath();
  }

  @Override public String getOriginalRestOfPath() {
  ...
  @Override public String getRequestURIWithQueryString() {
  ...
  @Override public StringBuffer getRequestURLWithQueryString() {
  ...
  @Override public RequestDispatcher getView(Object it, String viewName) throws IOException {
    return getView(Klass.java(it.getClass()), it, viewName);
  }

  @Override public RequestDispatcher getView(Class clazz, String viewName) throws IOException {
    return getView(Klass.java(clazz), null, viewName);
  }

  @Override public RequestDispatcher getView(Klass<?> clazz, String viewName) throws IOException {
  ...
  @Override public List<Ancestor> getAncestors() {
    return ancestorsView;
  }

  @Override public Ancestor findAncestor(Class type) {
  ...
  @Override public <T extends java.lang.Object> T findAncestorObject(Class<T> type) {
  ...
  @Override public Ancestor findAncestor(Object anc) {
    for (int i = ancestors.size() - 1; i >= 0; i--) {
      AncestorImpl a = ancestors.get(i);
      Object o = a.getObject();
      if (o == anc) {
  ...
  @Override public boolean hasParameter(String name) {
    return getParameter(name) != null;
  }

  @Override public String getOriginalRequestURI() {
    return originalRequestURI;
  }

  @Override public boolean checkIfModified(long lastModified, StaplerResponse rsp) {
    return checkIfModified(lastModified, rsp, 0);
  }

  @Override public boolean checkIfModified(long lastModified, StaplerResponse rsp, long expiration) {
    if (lastModified <= 0) {
      return false;
    }
  ...
  @Override public boolean checkIfModified(Date timestampOfResource, StaplerResponse rsp) {
    return checkIfModified(timestampOfResource.getTime(), rsp);
  }

  @Override public boolean checkIfModified(Calendar timestampOfResource, StaplerResponse rsp) {
    return checkIfModified(timestampOfResource.getTimeInMillis(), rsp);
  }

  @Override public BindInterceptor getBindInterceptor() {
    return bindInterceptor;
  }

  @Override public BindInterceptor setBindListener(BindInterceptor bindListener) {
    return setBindInterceptor(bindListener);
  }

  @Override public BindInterceptor setBindInterceptpr(BindInterceptor bindListener) {
    return setBindInterceptor(bindListener);
  }

  @Override public BindInterceptor setBindInterceptor(BindInterceptor bindListener) {
    BindInterceptor o = this.bindInterceptor;
    this.bindInterceptor = bindListener;
    return o;
  }

  @Override public void bindParameters(Object bean) {
    bindParameters(bean, "");
  }

  @Override public void bindParameters(Object bean, String prefix) {
  ...
  @Override public <T extends java.lang.Object> List<T> bindParametersToList(Class<T> type, String prefix) {
  ...
  @Override public <T extends java.lang.Object> T bindParameters(Class<T> type, String prefix) {
    return bindParameters(type, prefix, 0);
  }

  @Override public <T extends java.lang.Object> T bindParameters(Class<T> type, String prefix, int index) {
  ...
  @Override public <T extends java.lang.Object> T bindJSON(Class<T> type, JSONObject src) {
    return type.cast(bindJSON(type, type, src));
  }

  @Override public Object bindJSON(Type type, Class erasure, Object json) {
    return new TypePair(type, erasure).convertJSON(json);
  }

  @Override public void bindJSON(Object bean, JSONObject src) {
    try {
  ...
  @Override public <T extends java.lang.Object> List<T> bindJSONToList(Class<T> type, Object src) {
  ...
  private <T extends java.lang.Object> T invokeConstructor(Constructor<T> c, Object[] args) {
    try {
  ...
  private <T extends java.lang.Object> Constructor<T> findConstructor(Class<T> type, int length) {
      ...
      if (o instanceof JSONObject) {
        ...
        if (l == null) {
          ...
          if (j.has("stapler-class-bag")) {
            ...
            if (Enum.class.isAssignableFrom(l.itemType)) {
              for (Map.Entry<String, Object> e : (Set<Map.Entry<String, Object>>) j.entrySet()) {
                Object v = e.getValue();
  ...
  /**
     ...
     */
  private <T extends java.lang.Object> T injectSetters(T r, JSONObject j, Collection<String> exclusions) {
    OUTER:
  ...
  @Override public JSONObject getSubmittedForm() throws ServletException {
  ...
  @Override public FileItem getFileItem(String name) throws ServletException, IOException {
    parseMultipartFormData();
    if (parsedFormData == null) {
      return null;
    }
