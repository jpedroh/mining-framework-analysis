...
public class PluginsRegistryImpl implements PluginsRegistry {
  ...
  /**
     ...
     */
  @Override public Set<PluginRecord<AuthMechanism>> getAuthMechanisms() {
  ...
  /**
     ...
     */
  @Override public Set<PluginRecord<Authenticator>> getAuthenticators() {
  ...
  /**
     ...
     */
  @Override public PluginRecord<Authenticator> getAuthenticator(String name) throws ConfigurationException {
  ...
  /**
     * @return the authenticators
     */
  @Override public PluginRecord<TokenManager> getTokenManager() {
  ...
  /**
     * @return the authenticators
     */
  @Override public Set<PluginRecord<Authorizer>> getAuthorizers() {
  ...
  /**
     ...
     */
  @Override public Set<PluginRecord<Initializer>> getInitializers() {
  ...
  @Override public Set<PluginRecord<Interceptor>> getInterceptors() {
  ...
  /**
     * @return the services
     */
  @Override public Set<PluginRecord<Service>> getServices() {
  ...
  /**
     ...
     */
  @Override public Set<Predicate> getGlobalSecurityPredicates() {
    return globalSecurityPredicates;
  }

  @Override public PathHandler getRootPathHandler() {
    return ROOT_PATH_HANDLER;
  }

  @Override public void plugPipeline(String path, PipelinedHandler handler, PipelineInfo info) {
  ...
  @Override public PipelineInfo getPipelineInfo(String path) {
