...
<<<<<<< /usr/src/app/output/movsim/movsim/51e5bb8b29c0520339d82143530d50c59145fb3f/core/src/main/java/org/movsim/simulator/vehicles/Vehicle.java/left.java
    "Vehicle [id=" + id + ", label=" + label + ", length=" + getLength()
=======
    "Vehicle [id=" + id + ", label=" + label + ", length=" + df.format(length) + ", frontPosition=" + df.format(frontPosition)
>>>>>>> /usr/src/app/output/movsim/movsim/51e5bb8b29c0520339d82143530d50c59145fb3f/core/src/main/java/org/movsim/simulator/vehicles/Vehicle.java/right.java
     + ", frontPositionOld=" + df.format(frontPositionOld) + ", speed=" + df.format(speed) + ", accModel=" + df.format(accModel) + ", acc=" + df.format(acc) + ", accOld=" + df.format(accOld) + ", vehNumber=" + vehNumber + ", lane=" + lane + ", brakeLightOn=" + brakeLightOn + "]";
  }
