...
public class Vehicle {
  ...
  private void considerRouteAlternatives(RoadSegment roadSegment) {
    ...
    if (serviceProvider.doDiverge(uncertainty, roadSegment.userId(), randomAlternative)) {
      ...
      if (roadSegment.laneType(roadSegment.laneCount()) != Lanes.Type.EXIT) {
        throw new IllegalArgumentException("cannot do diverge on roadSegment " + roadSegment.userId() + " without exit lane!");
      }
    }
  }
  ...
  @Override public String toString() {
    return "Vehicle [id=" + id + ", label=" + label + ", length=" + getLength() + ", frontPosition=" + frontPosition + ", frontPositionOld=" + frontPositionOld + ", speed=" + speed + ", accModel=" + accModel + ", acc=" + acc + ", accOld=" + accOld + ", vehNumber=" + vehNumber + ", lane=" + lane + "]";
  }
