...
public class Vehicle {
  ...
  public void updateAcceleration(double dt, RoadSegment roadSegment, LaneSegment laneSegment, LaneSegment leftLaneSegment, double alphaT, double alphaV0) {
    accOld = acc;
    double accError = 0;
    if (noise != null) {
      noise.update(dt);
  ...
  protected double accelerationConsideringTrafficLight(double acc, RoadSegment roadSegment) {
    double moderatedAcc = acc;
    TrafficLightLocationWithDistance location = roadSegment.getNextDownstreamTrafficLight(getFrontPosition(), lane(), TrafficLightApproaching.MAX_LOOK_AHEAD_DISTANCE);
    if (location != null) {
  ...
  @Override public String toString() {
    return "Vehicle [label=" + label + ", length=" + length + ", frontPosition=" + frontPosition + ", frontPositionOld=" + frontPositionOld + ", speed=" + speed + ", accModel=" + accModel + ", acc=" + acc + ", accOld=" + accOld + ", id=" + id + ", vehNumber=" + vehNumber + ", lane=" + lane + "]";
  }
