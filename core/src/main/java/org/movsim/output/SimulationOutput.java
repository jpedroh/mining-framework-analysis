...
public class SimulationOutput implements SimulationTimeStep {
  ...
  public SimulationOutput(double simulationTimestep, boolean writeOutput, OutputConfiguration outputConfiguration, RoadNetwork roadNetwork, Routing routing, VehicleFactory vehicleFactory, @Nullable ServiceProviders serviceProviders) {
  ...
  private void initConsumption(boolean writeOutput, double simulationTimestep, final OutputConfiguration outputConfiguration) {
  ...
  private void initTravelTimes(boolean writeOutput, double simulationTimestep, final OutputConfiguration outputConfiguration) {
  ...
  private void initSpatioTemporalOutput(boolean writeOutput, final OutputConfiguration outputConfiguration) {
    for (final SpatioTemporalConfiguration spatioTemporalInput : outputConfiguration.getSpatioTemporalConfiguration()) {
      final Route route = getCheckedRoute(spatioTemporalInput.getRoute());
      final SpatioTemporal spatioTemporal = new SpatioTemporal(spatioTemporalInput.getDx(), spatioTemporalInput.getDt(), roadNetwork, route, writeOutput);
