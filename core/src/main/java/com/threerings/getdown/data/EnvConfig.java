...
public final class EnvConfig {
  ...
  public static EnvConfig create(String[] argv, List<Note> notes) {
    ...
    List<String> appArgs = argv.length > 2 ? Arrays.asList(argv).subList(2, argv.length) : Collections.<String>emptyList();
  ...
  public EnvConfig(File appDir) {
    this(appDir, null, null, Collections.<Certificate>emptyList(), Collections.<String>emptyList());
  }
