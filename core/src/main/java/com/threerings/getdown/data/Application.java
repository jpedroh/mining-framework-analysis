...
public class Application {
  ...
  public Resource getJavaVMResource() {
    ...
    try {
      ...
      return new Resource(vmfile, remote, getLocalPath(vmfile), EnumSet.of(Resource.Attr.UNPACK));
    } catch (Exception e) {
  ...
  public URL getTrackingURL(String event) {
    try {
      ...
      return _trackingURL == null ? null : HostWhitelist.INSTANCE.verify(new URL(_trackingURL + encodePath(event + suffix + ga)));
