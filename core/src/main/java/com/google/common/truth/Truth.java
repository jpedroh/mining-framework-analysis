...
public class Truth {
  ...
  @CheckReturnValue public static <T extends java.lang.Object, C extends Iterable<T>> IterableSubject<? extends IterableSubject<?, T, C>, T, C> assertThat(Iterable<T> target) {
    return IterableSubject.create(getFailureStrategy(), target);
  }

  @CheckReturnValue public static <T extends java.lang.Object, C extends Collection<T>> CollectionSubject<? extends CollectionSubject<?, T, C>, T, C> assertThat(Collection<T> target) {
    return CollectionSubject.create(getFailureStrategy(), target);
  }

  @CheckReturnValue public static <T extends java.lang.Object, C extends List<T>> ListSubject<? extends ListSubject<?, T, C>, T, C> assertThat(List<T> target) {
    return ListSubject.create(getFailureStrategy(), target);
  }

  @CheckReturnValue public static <T extends java.lang.Object> ObjectArraySubject<T> assertThat(T[] target) {
  ...
  @CheckReturnValue public static <T extends java.lang.Object> OptionalSubject<T> assertThat(Optional<T> target) {
    return new OptionalSubject<T>(getFailureStrategy(), target);
  }

  @CheckReturnValue public static <K extends java.lang.Object, V extends java.lang.Object, M extends Map<K, V>> MapSubject<? extends MapSubject<?, K, V, M>, K, V, M> assertThat(Map<K, V> target) {
