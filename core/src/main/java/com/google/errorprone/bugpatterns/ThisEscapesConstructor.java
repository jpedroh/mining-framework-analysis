 ...
 */
@BugPattern(name = "ThisEscapesConstructor", summary = "Do not let \'this\' escape the constructor.", severity = SUGGESTION) public class ThisEscapesConstructor extends BugChecker implements MethodTreeMatcher {
  private static final Matcher<MethodTree> IS_CONSTRUCTOR = methodIsConstructor();

  @Override public Description matchMethod(MethodTree constructor, VisitorState state) {
