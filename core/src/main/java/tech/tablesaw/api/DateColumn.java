...
<<<<<<< /usr/src/app/output/lwhite1/tablesaw/107b41139ec9db652d16c15a42367f74ce58b82e/core/src/main/java/tech/tablesaw/api/DateColumn.java/left.java
        if (obj == null) {
            return appendMissing();
        }
        if (!(obj instanceof LocalDate)) {
            throw new IllegalArgumentException("Cannot append " + obj.getClass().getName() + " to DateColumn");
||||||| /usr/src/app/output/lwhite1/tablesaw/107b41139ec9db652d16c15a42367f74ce58b82e/core/src/main/java/tech/tablesaw/api/DateColumn.java/base.java
        if (!(obj instanceof LocalDate)) {
...
=======
        if (obj == null) {
            ...
            throw new IllegalArgumentException();
>>>>>>> /usr/src/app/output/lwhite1/tablesaw/107b41139ec9db652d16c15a42367f74ce58b82e/core/src/main/java/tech/tablesaw/api/DateColumn.java/right.java
        }
