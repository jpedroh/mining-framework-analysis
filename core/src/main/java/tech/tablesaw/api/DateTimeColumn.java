...
public class DateTimeColumn extends AbstractColumn<LocalDateTime> implements DateTimeMapFunctions, DateTimeFilters, DateTimeFillers<DateTimeColumn>, CategoricalColumn<LocalDateTime> {
  ...
  @Override public Column<LocalDateTime> setMissing(int i) {
  ...
  @Override public DateTimeColumn appendCell(String stringValue, AbstractParser<?> parser) {
  ...
  @Override public DateTimeColumn setName(String name) {
    return (DateTimeColumn) super.setName(name);
  }

  @Override public DateTimeColumn filter(Predicate<? super LocalDateTime> test) {
    return (DateTimeColumn) super.filter(test);
  }

  @Override public DateTimeColumn sorted(Comparator<? super LocalDateTime> comp) {
    return (DateTimeColumn) super.sorted(comp);
  }

  @Override public DateTimeColumn map(Function<? super LocalDateTime, ? extends LocalDateTime> fun) {
    return (DateTimeColumn) super.map(fun);
  }

  @Override public DateTimeColumn min(Column<LocalDateTime> other) {
    return (DateTimeColumn) super.min(other);
  }

  @Override public DateTimeColumn max(Column<LocalDateTime> other) {
    return (DateTimeColumn) super.max(other);
  }

  @Override public DateTimeColumn set(Selection condition, Column<LocalDateTime> other) {
    return (DateTimeColumn) super.set(condition, other);
  }

  @Override public DateTimeColumn first(int numRows) {
    return (DateTimeColumn) super.first(numRows);
  }

  @Override public DateTimeColumn last(int numRows) {
    return (DateTimeColumn) super.last(numRows);
  }

  @Override public DateTimeColumn inRange(int start, int end) {
    return (DateTimeColumn) super.inRange(start, end);
  }

  @Override public DateTimeColumn sampleN(int n) {
    return (DateTimeColumn) super.sampleN(n);
  }

  @Override public DateTimeColumn sampleX(double proportion) {
