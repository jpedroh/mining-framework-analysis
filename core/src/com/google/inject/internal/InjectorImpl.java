...
final class InjectorImpl implements Injector, Lookups {
  ...
  static class InjectorOptions {
    ...
    @Override public String toString() {
      return MoreObjects.toStringHelper(getClass()).add("stage", stage).add("jitDisabled", jitDisabled).add("disableCircularProxies", disableCircularProxies).add("atInjectRequired", atInjectRequired).add("exactBindingAnnotationsRequired", exactBindingAnnotationsRequired).toString();
    }
  }
  ...
  @Override public <T extends java.lang.Object> List<Binding<T>> findBindingsByType(TypeLiteral<T> type) {
    @SuppressWarnings(value = { "unchecked" }) List<Binding<T>> list = (List<Binding<T>>) (List) bindingData.getIndexedExplicitBindings().get(checkNotNull(type, "type"));
    return Collections.unmodifiableList(list);
  }

  /** Returns the binding for {@code key} */
  @Override public <T extends java.lang.Object> BindingImpl<T> getBinding(Key<T> key) {
  ...
  @Override public <T extends java.lang.Object> BindingImpl<T> getExistingBinding(Key<T> key) {
    ...
    synchronized (jitBindingData.lock()) {
      for (InjectorImpl injector = this; injector != null; injector = injector.parent) {
        @SuppressWarnings(value = { "unchecked" }) BindingImpl<T> jitBinding = (BindingImpl<T>) injector.jitBindingData.getJitBinding(key);
        if (jitBinding != null) {
          return jitBinding;
        }
      }
    ...
    if (isProvider(key)) {
      try {
        @SuppressWarnings(value = { "unchecked", "cast" }) Key<?> providedKey = (Key<?>) getProvidedKey((Key) key, new Errors());
   ...
   * binding.
   */
  <T extends java.lang.Object> BindingImpl<T> getBindingOrThrow(Key<T> key, Errors errors, JitLimitation jitType) throws ErrorsException {
  ...
  @Override public <T extends java.lang.Object> Binding<T> getBinding(Class<T> type) {
  ...
  @Override public Injector createChildInjector(Iterable<? extends Module> modules) {
    return new InternalInjectorCreator().parentInjector(this).addModules(modules).build();
  }

  @Override public Injector createChildInjector(Module... modules) {
   ...
   */
  private <T extends java.lang.Object> BindingImpl<T> getJustInTimeBinding(Key<T> key, Errors errors, JitLimitation jitType) throws ErrorsException {
    boolean jitOverride = isProvider(key) || isTypeLiteral(key) || isMembersInjector(key);
    synchronized (jitBindingData.lock()) {
      for (InjectorImpl injector = this; injector != null; injector = injector.parent) {
        @SuppressWarnings(value = { "unchecked" }) BindingImpl<T> binding = (BindingImpl<T>) injector.jitBindingData.getJitBindings().get(key);
        if (binding != null) {
  ...
  private static <T extends java.lang.Object> Key<T> getProvidedKey(Key<Provider<T>> key, Errors errors) throws ErrorsException {
    Type providerType = key.getTypeLiteral().getType();
    if (!(providerType instanceof ParameterizedType)) {
      throw errors.cannotInjectRawProvider().toException();
    }
    Type entryType = ((ParameterizedType) providerType).getActualTypeArguments()[0];
    @SuppressWarnings(value = { "unchecked" }) Key<T> providedKey = (Key<T>) key.ofType(entryType);
    return providedKey;
  }
  ...
  private <T extends java.lang.Object> BindingImpl<MembersInjector<T>> createMembersInjectorBinding(Key<MembersInjector<T>> key, Errors errors) throws ErrorsException {
    Type membersInjectorType = key.getTypeLiteral().getType();
    if (!(membersInjectorType instanceof ParameterizedType)) {
      throw errors.cannotInjectRawMembersInjector().toException();
    }
    @SuppressWarnings(value = { "unchecked" }) TypeLiteral<T> instanceType = (TypeLiteral<T>) TypeLiteral.get(((ParameterizedType) membersInjectorType).getActualTypeArguments()[0]);
   ...
   */
  private <T extends java.lang.Object> BindingImpl<Provider<T>> createSyntheticProviderBinding(Key<Provider<T>> key, Errors errors) throws ErrorsException {
  ...
  private static class SyntheticProviderBindingImpl<T extends java.lang.Object> extends BindingImpl<Provider<T>> implements ProviderBinding<Provider<T>>, HasDependencies {
    ...
    static <T extends java.lang.Object> InternalFactory<Provider<T>> createInternalFactory(Binding<T> providedBinding) {
      final Provider<T> provider = providedBinding.getProvider();
      return new InternalFactory<Provider<T>>() {
        @Override public Provider<T> get(InternalContext context, Dependency<?> dependency, boolean linked) {
          return provider;
        }
      };
    }

    @Override public Key<? extends T> getProvidedKey() {
      return providedBinding.getKey();
    }

    @Override public <V extends java.lang.Object> V acceptTargetVisitor(BindingTargetVisitor<? super Provider<T>, V> visitor) {
   ...
   */
  private <T extends java.lang.Object> BindingImpl<T> convertConstantStringBinding(Key<T> key, Errors errors) throws ErrorsException {
    ...
    TypeConverterBinding typeConverterBinding = bindingData.getConverter(stringValue, type, errors, source);
    if (typeConverterBinding == null) {
      return null;
    }
    try {
      @SuppressWarnings(value = { "unchecked" }) T converted = (T) typeConverterBinding.getTypeConverter().convert(stringValue, type);
      if (converted == null) {
  ...
  private static class ConvertedConstantBindingImpl<T extends java.lang.Object> extends BindingImpl<T> implements ConvertedConstantBinding<T> {
    final T value;
    ...
    @Override public <V extends java.lang.Object> V acceptTargetVisitor(BindingTargetVisitor<? super T, V> visitor) {
      return visitor.visit(this);
    }
    ...
    @Override public TypeConverterBinding getTypeConverterBinding() {
      return typeConverterBinding;
    }

    @Override public Key<String> getSourceKey() {
    ...
    @Override public String toString() {
      return MoreObjects.toStringHelper(ConvertedConstantBinding.class).add("key", getKey()).add("sourceKey", getSourceKey()).add("value", value).toString();
    }
  ...
  <T extends java.lang.Object> void initializeBinding(BindingImpl<T> binding, Errors errors) throws ErrorsException {
    if (binding instanceof DelayedInitialize) {
      ((DelayedInitialize) binding).initialize(this, errors);
    }
  }

  <T extends java.lang.Object> void initializeJitBinding(BindingImpl<T> binding, Errors errors) throws ErrorsException {
    if (binding instanceof DelayedInitialize) {
    ...
    for (Dependency<?> dep : deps) {
      ...
      if (encountered.add(depKey)) {
        ...
        if (depBinding != null) {
          ...
          if (bindingData.getExplicitBinding(depKey) == null) {
            bindingFailed = true;
          }
        }
      }
   ...
   * none is specified.
   */
  <T extends java.lang.Object> BindingImpl<T> createUninitializedBinding(Key<T> key, Scoping scoping, Object source, Errors errors, boolean jitBinding) throws ErrorsException {
    ...
    if (rawType == TypeLiteral.class) {
      @SuppressWarnings(value = { "unchecked" }) BindingImpl<T> binding = (BindingImpl<T>) createTypeLiteralBinding((Key<TypeLiteral<Object>>) key, errors);
      return binding;
    }
   ...
   */
  private <T extends java.lang.Object> BindingImpl<TypeLiteral<T>> createTypeLiteralBinding(Key<TypeLiteral<T>> key, Errors errors) throws ErrorsException {
    ...
    @SuppressWarnings(value = { "unchecked" }) TypeLiteral<T> value = (TypeLiteral<T>) TypeLiteral.get(innerType);
  ...
  <T extends java.lang.Object> BindingImpl<T> createProvidedByBinding(Key<T> key, Scoping scoping, ProvidedBy providedBy, Errors errors) throws ErrorsException {
    Class<?> rawType = key.getTypeLiteral().getRawType();
    Class<? extends javax.inject.Provider<?>> providerType = providedBy.value();
    if (providerType == rawType) {
      throw errors.recursiveProviderType().toException();
    }
    @SuppressWarnings(value = { "unchecked" }) Key<? extends Provider<T>> providerKey = (Key<? extends Provider<T>>) Key.get(providerType);
  ...
  private <T extends java.lang.Object> BindingImpl<T> createImplementedByBinding(Key<T> key, Scoping scoping, ImplementedBy implementedBy, Errors errors) throws ErrorsException {
    Class<?> rawType = key.getTypeLiteral().getRawType();
    ...
    @SuppressWarnings(value = { "unchecked" }) Class<? extends T> subclass = (Class<? extends T>) implementationType;
   ...
   */
  private <T extends java.lang.Object> BindingImpl<T> createJustInTimeBindingRecursive(Key<T> key, Errors errors, boolean jitDisabled, JitLimitation jitType) throws ErrorsException {
   ...
   */
  private <T extends java.lang.Object> BindingImpl<T> createJustInTimeBinding(Key<T> key, Errors errors, boolean jitDisabled, JitLimitation jitType) throws ErrorsException {
    ...
    if (isProvider(key)) {
      @SuppressWarnings(value = { "unchecked", "cast" }) BindingImpl<T> binding = (BindingImpl<T>) createSyntheticProviderBinding((Key) key, errors);
      return binding;
    }
    if (isMembersInjector(key)) {
      @SuppressWarnings(value = { "unchecked", "cast" }) BindingImpl<T> binding = (BindingImpl<T>) createMembersInjectorBinding((Key) key, errors);
      return binding;
    }
  ...
  <T extends java.lang.Object> InternalFactory<? extends T> getInternalFactory(Key<T> key, Errors errors, JitLimitation jitType) throws ErrorsException {
    return getBindingOrThrow(key, errors, jitType).getInternalFactory();
  }

  @Override public Map<Key<?>, Binding<?>> getBindings() {
    return bindingData.getExplicitBindingsThisLevel();
  }

  @Override public Map<Key<?>, Binding<?>> getAllBindings() {
    synchronized (jitBindingData.lock()) {
      return new ImmutableMap.Builder<Key<?>, Binding<?>>().putAll(bindingData.getExplicitBindingsThisLevel()).putAll(jitBindingData.getJitBindings()).build();
    }
  }

  @Override public Map<Class<? extends Annotation>, Scope> getScopeBindings() {
    return ImmutableMap.copyOf(bindingData.getScopes());
  }

  @Override public Set<TypeConverterBinding> getTypeConverterBindings() {
  ...
  @Override public Map<TypeLiteral<?>, List<InjectionPoint>> getAllMembersInjectorInjectionPoints() {
    @SuppressWarnings(value = { "unchecked" }) Map<TypeLiteral<?>, List<InjectionPoint>> res = (Map<TypeLiteral<?>, List<InjectionPoint>>) (Map<TypeLiteral<?>, ?>) ImmutableListMultimap.copyOf(Multimaps.filterKeys(membersInjectorStore.getAllInjectionPoints(), userRequestedMembersInjectorTypes::contains)).asMap();
    return res;
  }
  ...
  <T extends java.lang.Object> SingleParameterInjector<T> createParameterInjector(final Dependency<T> dependency, final Errors errors) throws ErrorsException {
  ...
  @Override @SuppressWarnings(value = { "unchecked", "rawtypes" }) public void injectMembers(Object instance) {
    MembersInjector membersInjector = getMembersInjector(instance.getClass());
    membersInjector.injectMembers(instance);
  }

  @Override public <T extends java.lang.Object> MembersInjector<T> getMembersInjector(TypeLiteral<T> typeLiteral) {
  ...
  @Override public <T extends java.lang.Object> MembersInjector<T> getMembersInjector(Class<T> type) {
    return getMembersInjector(TypeLiteral.get(type));
  }

  @Override public <T extends java.lang.Object> Provider<T> getProvider(Class<T> type) {
    return getProvider(Key.get(checkNotNull(type, "type")));
  }

  <T extends java.lang.Object> Provider<T> getProviderOrThrow(final Dependency<T> dependency, Errors errors) throws ErrorsException {
  ...
  @Override public <T extends java.lang.Object> Provider<T> getProvider(final Key<T> key) {
  ...
  @Override public <T extends java.lang.Object> T getInstance(Key<T> key) {
    return getProvider(key).get();
  }

  @Override public <T extends java.lang.Object> T getInstance(Class<T> type) {
  ...
  @Override public String toString() {
    return MoreObjects.toStringHelper(Injector.class).add("bindings", bindingData.getExplicitBindingsThisLevel().values()).toString();
  }
}