 ...
 */
@Deprecated @Component(value = "blSessionFixationProtectionFilter") public class SessionFixationProtectionFilter extends GenericFilterBean {
  ...
  @Autowired @Qualifier(value = "blSessionFixationEncryptionModule") protected EncryptionModule encryptionModule;

  @Autowired @Qualifier(value = "blCookieUtils") protected CookieUtils cookieUtils;

  @Value(value = "${filter.sessionFixationProtection.legacy.enabled:true}") protected Boolean enabled;

  @Override public void doFilter(ServletRequest sRequest, ServletResponse sResponse, FilterChain chain) throws IOException, ServletException {
