...
public class BinderTest extends TestCase {
  ...
  public void testMissingBindings() {
    try {
      ...
      if (isIncludeStackTraceOff()) {
        assertContains(e.getMessage(), segment1, atSegment, sourceFileName, segment2, atSegment, sourceFileName, segment3, atSegment, sourceFileName, segment4, atSegment, sourceFileName);
      } else {
        assertContains(e.getMessage(), segment3, atSegment, sourceFileName, segment1, atSegment, sourceFileName, segment4, atSegment, sourceFileName, segment2, atSegment, sourceFileName);
      }
    }
  }
  ...
  public void testMissingDependency() {
    try {
      ...
      assertContains(e.getMessage(), "No implementation for java.lang.Runnable was bound.", "for field at " + NeedsRunnable.class.getName(), ".runnable(BinderTest.java:", "at " + getClass().getName(), getDeclaringSourcePart(getClass()));
    }
  }
    ...
    try {
      Guice.createInjector(new AbstractModule() {
        @Override public void configure() {
          ...
          assertEquals("Provider<java.util.List<java.lang.String>>", getProvider(Key.get(new TypeLiteral<List<String>>() { })).toString());
  ...
  @ProvidedBy(value = HasProvidedBy1Provider.class) interface HasProvidedBy1 {
  }
  ...
  @ImplementedBy(value = ImplementsHasImplementedBy1.class) interface HasImplementedBy1 {
  }

  static class ImplementsHasImplementedBy1 implements HasImplementedBy1 {
  }

  @ProvidedBy(value = HasProvidedBy2Provider.class) static class HasProvidedBy2 {
  }
  ...
  @ImplementedBy(value = ExtendsHasImplementedBy2.class) static class HasImplementedBy2 {
  }
  ...
  @ImplementedBy(value = ImplementsHasImplementedByThatNeedsAnotherImplementedBy.class) static interface HasImplementedByThatNeedsAnotherImplementedBy {
  }
  ...
  static class ImplementsHasImplementedByThatNeedsAnotherImplementedBy implements HasImplementedByThatNeedsAnotherImplementedBy {
    @Inject ImplementsHasImplementedByThatNeedsAnotherImplementedBy(HasImplementedBy1 h1n1) {
    }
  }

  @ImplementedBy(value = ImplementsHasImplementedByThatWantsExplicit.class) static interface HasImplementedByThatWantsExplicit {
  }
