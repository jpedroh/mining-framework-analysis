 ...
 */
@Deprecated @Component(value = "blGoogleUniversalAnalyticsProcessor") @ConditionalOnTemplating public class GoogleUniversalAnalyticsProcessor extends AbstractBroadleafTagReplacementProcessor {
  ...
  /**
     ...
     */
  @Value(value = "${googleAnalytics.masterWebPropertyId}") protected String masterWebPropertyId;
  ...
  /**
     ...
     * a request to Google
     */
  @Value(value = "${googleAnalytics.testLocal}") protected boolean testLocal = false;
  ...
  @Override public BroadleafTemplateModel getReplacementModel(String tagName, Map<String, String> tagAttributes, BroadleafTemplateContext context) {
