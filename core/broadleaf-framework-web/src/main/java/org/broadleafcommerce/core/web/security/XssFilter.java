...
@ConditionalOnNotAdmin @Component(value = "blXssFilter") public class XssFilter extends AbstractIgnorableOncePerRequestFilter {
  ...
  @Override protected void doFilterInternalUnlessIgnored(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws IOException, ServletException {
