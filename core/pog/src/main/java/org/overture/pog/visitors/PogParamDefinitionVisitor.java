...
public class PogParamDefinitionVisitor<Q extends IPOContextStack, A extends IProofObligationList> extends AbstractPogParamVisitor {
  ...
  /**
	 ...
	 */
  public PogParamDefinitionVisitor(QuestionAnswerAdaptor<IPOContextStack, ? extends IProofObligationList> parentVisitor, QuestionAnswerAdaptor<IPOContextStack, ? extends IProofObligationList> mainVisitor, IPogAssistantFactory assistantFactory) {
  ...
  /**
	 ...
	 * @param parentVisitor
	 */
  public PogParamDefinitionVisitor(QuestionAnswerAdaptor<IPOContextStack, ? extends IProofObligationList> parentVisitor) {
    this.rootVisitor = parentVisitor;
    this.mainVisitor = this;
    this.assistantFactory = new PogAssistantFactory();
  }

  @Override public IProofObligationList caseAExplicitFunctionDefinition(AExplicitFunctionDefinition node, IPOContextStack question) throws AnalysisException {
    try {
      ...
      if (node.getIsUndefined() || !assistantFactory.getTypeComparator().isSubType(node.getActualResult(), node.getExpectedResult())) {
  ...
  @Override public IProofObligationList defaultSClassDefinition(SClassDefinition node, IPOContextStack question) throws AnalysisException {
    try {
  ...
  @Override public IProofObligationList caseAClassInvariantDefinition(AClassInvariantDefinition node, IPOContextStack question) throws AnalysisException {
    try {
  ...
  @Override public IProofObligationList caseAEqualsDefinition(AEqualsDefinition node, IPOContextStack question) throws AnalysisException {
    try {
      IProofObligationList list = new ProofObligationList();
      PPattern pattern = node.getPattern();
      if (pattern != null) {
        if (!(pattern instanceof AIdentifierPattern) && !(pattern instanceof AIgnorePattern) && node.getExpType() instanceof AUnionType) {
  ...
  @Override public IProofObligationList caseAImplicitFunctionDefinition(AImplicitFunctionDefinition node, IPOContextStack question) throws AnalysisException {
    try {
      ...
      if (node.getBody() == null) {
        ...
        if (node.getIsUndefined() || !assistantFactory.getTypeComparator().isSubType(node.getActualResult(), ((AFunctionType) node.getType()).getResult())) {
  ...
  @Override public IProofObligationList caseAExplicitOperationDefinition(AExplicitOperationDefinition node, IPOContextStack question) throws AnalysisException {
    try {
      ...
      if (!node.getIsConstructor() && !assistantFactory.getTypeComparator().isSubType(node.getActualResult(), ((AOperationType) node.getType()).getResult())) {
  ...
  protected List<AInstanceVariableDefinition> collectState(AExplicitOperationDefinition node) throws AnalysisException {
  ...
  /**
	 ...
	 */
  protected void collectOpCtxt(AExplicitOperationDefinition node, IPOContextStack question, Boolean precond) throws AnalysisException {
    question.push(new POOperationDefinitionContext(node, precond, node.getState()));
  }

  @Override public IProofObligationList caseAImplicitOperationDefinition(AImplicitOperationDefinition node, IPOContextStack question) throws AnalysisException {
    try {
      IProofObligationList obligations = beforeAnnotations(node.getAnnotations(), node, question);
      LexNameList pids = new LexNameList();
      AOperationType otype = (AOperationType) node.getType();
  ...
  @Override public IProofObligationList caseAAssignmentDefinition(AAssignmentDefinition node, IPOContextStack question) throws AnalysisException {
    try {
      IProofObligationList obligations = new ProofObligationList();
  ...
  @Override public IProofObligationList defaultPDefinition(PDefinition node, IPOContextStack question) {
    return new ProofObligationList();
  }

  public IProofObligationList caseAInstanceVariableDefinition(AInstanceVariableDefinition node, IPOContextStack question) throws AnalysisException {
    try {
      IProofObligationList obligations = beforeAnnotations(node.getAnnotations(), node, question);
      PExp expression = node.getExpression();
      PType type = node.getType();
  ...
  @Override public IProofObligationList caseAPerSyncDefinition(APerSyncDefinition node, IPOContextStack question) throws AnalysisException {
    try {
  ...
  @Override public IProofObligationList caseAStateDefinition(AStateDefinition node, IPOContextStack question) throws AnalysisException {
    try {
      IProofObligationList list = beforeAnnotations(node.getAnnotations(), node, question);
  ...
  @Override public IProofObligationList caseATypeDefinition(ATypeDefinition node, IPOContextStack question) throws AnalysisException {
    try {
      IProofObligationList list = beforeAnnotations(node.getAnnotations(), node, question);
  ...
  @Override public IProofObligationList caseAValueDefinition(AValueDefinition node, IPOContextStack question) throws AnalysisException {
    try {
      IProofObligationList obligations = beforeAnnotations(node.getAnnotations(), node, question);
      ...
      PPattern pattern = node.getPattern();
      PType type = node.getType();
      if (!(pattern instanceof AIdentifierPattern) && !(pattern instanceof AIgnorePattern) && assistantFactory.createPTypeAssistant().isUnion(type, null)) {
        PType patternType = assistantFactory.createPPatternAssistant(null).getPossibleType(pattern);
  ...
  @Override public IProofObligationList defaultPTraceDefinition(PTraceDefinition node, IPOContextStack question) {
    return new ProofObligationList();
  }

  @Override public IProofObligationList defaultPTraceCoreDefinition(PTraceCoreDefinition node, IPOContextStack question) {
    return new ProofObligationList();
  }

  @Override public IProofObligationList caseAClassClassDefinition(AClassClassDefinition node, IPOContextStack question) throws AnalysisException {
    try {
