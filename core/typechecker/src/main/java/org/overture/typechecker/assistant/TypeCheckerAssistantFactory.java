...
public class TypeCheckerAssistantFactory extends AstAssistantFactory implements ITypeCheckerAssistantFactory {
  ...
  @Override public AnswerAdaptor<Boolean> getClassBasisChecker(Environment env) {
  ...
  @Override public IAnswer<Boolean> getTypeDefinitionChecker() {
  ...
  @Override public IQuestionAnswer<FreeVarInfo, LexNameSet> getFreeVariablesChecker() {
