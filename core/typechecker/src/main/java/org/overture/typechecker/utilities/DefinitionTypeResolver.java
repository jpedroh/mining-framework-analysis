...
public class DefinitionTypeResolver extends QuestionAdaptor<DefinitionTypeResolver.NewQuestion> {
  ...
  @Override public void defaultSClassDefinition(SClassDefinition node, NewQuestion question) throws AnalysisException {
  ...
  @Override public void caseAExplicitFunctionDefinition(AExplicitFunctionDefinition node, NewQuestion question) throws AnalysisException {
    ...
    if (node.getBody() instanceof ASubclassResponsibilityExp || node.getBody() instanceof ANotYetSpecifiedExp) {
  ...
  @Override public void caseAExplicitOperationDefinition(AExplicitOperationDefinition node, NewQuestion question) throws AnalysisException {
    node.setType(af.createPTypeAssistant().typeResolve(node.getType(), null, question.rootVisitor, question.question));
    if (question.question.env.isVDMPP()) {
  ...
  @Override public void caseAImplicitFunctionDefinition(AImplicitFunctionDefinition node, NewQuestion question) throws AnalysisException {
    if (node.getTypeParams().size() > 0) {
  ...
  @Override public void caseAImplicitOperationDefinition(AImplicitOperationDefinition node, NewQuestion question) throws AnalysisException {
    node.setType(af.createPTypeAssistant().typeResolve(node.getType(), null, question.rootVisitor, question.question));
    if (node.getResult() != null) {
      af.createAPatternTypePairAssistant().typeResolve(node.getResult(), question.rootVisitor, question.question);
    }
  ...
  @Override public void caseAInstanceVariableDefinition(AInstanceVariableDefinition node, NewQuestion question) throws AnalysisException {
    try {
      node.setType(af.createPTypeAssistant().typeResolve(node.getType(), null, question.rootVisitor, question.question));
  ...
  @Override public void caseALocalDefinition(ALocalDefinition node, NewQuestion question) throws AnalysisException {
  ...
  @Override public void caseARenamedDefinition(ARenamedDefinition node, NewQuestion question) throws AnalysisException {
    node.getDef().apply(this, question);
  }

  @Override public void caseAStateDefinition(AStateDefinition node, NewQuestion question) throws AnalysisException {
  ...
  @Override public void caseATypeDefinition(ATypeDefinition node, NewQuestion question) throws AnalysisException {
    try {
  ...
  @Override public void caseAValueDefinition(AValueDefinition node, NewQuestion question) throws AnalysisException {
    if (node.getType() != null) {
      node.setType(af.createPTypeAssistant().typeResolve(node.getType(), null, question.rootVisitor, question.question));
  ...
  @Override public void caseAPatternListTypePair(APatternListTypePair pltp, NewQuestion question) throws AnalysisException {
  ...
  @Override public void defaultPDefinition(PDefinition node, NewQuestion question) throws AnalysisException {
    return;
  }
}