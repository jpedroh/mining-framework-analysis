...
public class TypeCheckerExpVisitor extends AbstractTypeCheckVisitor {
  public TypeCheckerExpVisitor(IQuestionAnswer<TypeCheckInfo, PType> typeCheckVisitor) {
    super(typeCheckVisitor);
  }

  @Override public PType caseAApplyExp(AApplyExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    if (inFunction) {
      ...
      if (called != null) {
        if (func instanceof AExplicitFunctionDefinition) {
          ...
          if (func instanceof AImplicitFunctionDefinition) {
    ...
    boolean isSimple = !question.assistantFactory.createPTypeAssistant().isUnion(node.getType(), question.fromModule);
    PTypeSet results = new PTypeSet(question.assistantFactory);
    if (question.assistantFactory.createPTypeAssistant().isFunction(node.getType(), question.fromModule)) {
    ...
    if (question.assistantFactory.createPTypeAssistant().isOperation(node.getType(), question.fromModule)) {
      ...
      AOperationType ot = question.assistantFactory.createPTypeAssistant().getOperation(node.getType(), question.fromModule);
      ...
      if (inFunction && Settings.release == Release.VDM_10 && !ot.getPure()) {
        TypeCheckerErrors.report(3300, "Impure operation \'" + node.getRoot() + "\' cannot be called from here", node.getLocation(), node);
        results.add(AstFactory.newAUnknownType(node.getLocation()));
      } else {
        if (inOperation && Settings.release == Release.VDM_10 && func != null && func.getAccess().getPure() && !ot.getPure()) {
          TypeCheckerErrors.report(3339, "Cannot call impure operation \'" + node.getRoot() + "\' from a pure operation", node.getLocation(), node);
          results.add(AstFactory.newAUnknownType(node.getLocation()));
        } else {
    ...
    if (question.assistantFactory.createPTypeAssistant().isSeq(node.getType(), question.fromModule)) {
      SSeqType seq = question.assistantFactory.createPTypeAssistant().getSeq(node.getType(), question.fromModule);
      results.add(sequenceApply(node, isSimple, seq, question));
    }
    if (question.assistantFactory.createPTypeAssistant().isMap(node.getType(), question.fromModule)) {
      SMapType map = question.assistantFactory.createPTypeAssistant().getMap(node.getType(), question.fromModule);
  ...
  @Override public PType defaultSBooleanBinaryExp(SBooleanBinaryExp node, TypeCheckInfo question) throws AnalysisException {
  ...
  @Override public PType caseAAndBooleanBinaryExp(AAndBooleanBinaryExp node, TypeCheckInfo question) throws AnalysisException {
  ...
  @Override public PType caseACompBinaryExp(ACompBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    noConstraint.qualifiers = null;
    node.getLeft().apply(THIS, noConstraint);
    node.getRight().apply(THIS, noConstraint);
    PTypeSet results = new PTypeSet(question.assistantFactory);
    if (question.assistantFactory.createPTypeAssistant().isMap(node.getLeft().getType(), question.fromModule)) {
      if (!question.assistantFactory.createPTypeAssistant().isMap(node.getRight().getType(), question.fromModule)) {
      ...
      SMapType lm = question.assistantFactory.createPTypeAssistant().getMap(node.getLeft().getType(), question.fromModule);
      SMapType rm = question.assistantFactory.createPTypeAssistant().getMap(node.getRight().getType(), question.fromModule);
    ...
    if (question.assistantFactory.createPTypeAssistant().isFunction(node.getLeft().getType(), question.fromModule)) {
      if (!question.assistantFactory.createPTypeAssistant().isFunction(node.getRight().getType(), question.fromModule)) {
        ...
        if (lf.getParameters().size() != 1) {
          ...
          if (rf.getParameters().size() != 1) {
            ...
            if (!question.assistantFactory.getTypeComparator().compatible(lf.getParameters().get(0), rf.getResult())) {
  ...
  @Override public PType caseADomainResByBinaryExp(ADomainResByBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo domConstraint = question;
    if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isMap(question.constraint, question.fromModule)) {
    ...
    if (!question.assistantFactory.createPTypeAssistant().isSet(node.getLeft().getType(), question.fromModule)) {
      ...
      if (!question.assistantFactory.createPTypeAssistant().isMap(node.getRight().getType(), question.fromModule)) {
        ...
        SSetType set = question.assistantFactory.createPTypeAssistant().getSet(node.getLeft().getType(), question.fromModule);
        SMapType map = question.assistantFactory.createPTypeAssistant().getMap(node.getRight().getType(), question.fromModule);
  ...
  @Override public PType caseADomainResToBinaryExp(ADomainResToBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo domConstraint = question;
    if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isMap(question.constraint, question.fromModule)) {
      PType stype = question.assistantFactory.createPTypeAssistant().getMap(question.constraint, question.fromModule).getFrom();
      domConstraint = question.newConstraint(AstFactory.newASetSetType(node.getLocation(), stype));
  ...
  @Override public PType caseAEqualsBinaryExp(AEqualsBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    node.getLeft().apply(THIS, noConstraint);
    node.getRight().apply(THIS, noConstraint);
    if (question.assistantFactory.createPTypeAssistant().isUnion(node.getLeft().getType(), question.fromModule)) {
    ...
    if (question.assistantFactory.createPTypeAssistant().isUnion(node.getRight().getType(), question.fromModule)) {
      IQuestion<TypeCheckInfo> mEqC = question.assistantFactory.getMultipleEqualityChecker();
      node.getRight().getType().apply(mEqC, question);
    }
    if (!question.assistantFactory.getTypeComparator().compatible(node.getLeft().getType(), node.getRight().getType()) || !question.assistantFactory.getTypeComparator().compatible(node.getRight().getType(), node.getLeft().getType())) {
  ...
  @Override public PType caseAInSetBinaryExp(AInSetBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    PType ltype = node.getLeft().apply(THIS, noConstraint);
    PType rtype = node.getRight().apply(THIS, noConstraint);
    if (!question.assistantFactory.createPTypeAssistant().isSet(node.getRight().getType(), question.fromModule)) {
      TypeCheckerErrors.report(3110, "Argument of \'in set\' is not a set", node.getLocation(), node);
      TypeCheckerErrors.detail("Actual", rtype);
    } else {
      SSetType stype = question.assistantFactory.createPTypeAssistant().getSet(rtype, question.fromModule);
  ...
  @Override public PType caseAMapUnionBinaryExp(AMapUnionBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    if (!question.assistantFactory.createPTypeAssistant().isMap(node.getLeft().getType(), question.fromModule)) {
      ...
      if (!question.assistantFactory.createPTypeAssistant().isMap(node.getRight().getType(), question.fromModule)) {
        ...
        SMapType ml = question.assistantFactory.createPTypeAssistant().getMap(node.getLeft().getType(), question.fromModule);
        SMapType mr = question.assistantFactory.createPTypeAssistant().getMap(node.getRight().getType(), question.fromModule);
  ...
  @Override public PType caseANotEqualBinaryExp(ANotEqualBinaryExp node, TypeCheckInfo question) throws AnalysisException {
  ...
  @Override public PType caseANotInSetBinaryExp(ANotInSetBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    PType ltype = node.getLeft().apply(THIS, noConstraint);
    PType rtype = node.getRight().apply(THIS, noConstraint);
    if (!question.assistantFactory.createPTypeAssistant().isSet(node.getRight().getType(), question.fromModule)) {
  ...
  @Override public PType caseADivNumericBinaryExp(ADivNumericBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    checkNumeric(node, THIS, question.newConstraint(null));
    node.setType(AstFactory.newAIntNumericBasicType(node.getLocation()));
    return node.getType();
  }

  @Override public PType caseADivideNumericBinaryExp(ADivideNumericBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    checkNumeric(node, THIS, question.newConstraint(null));
    node.setType(AstFactory.newARealNumericBasicType(node.getLocation()));
    return node.getType();
  }

  @Override public PType caseAGreaterEqualNumericBinaryExp(AGreaterEqualNumericBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    checkOrdered(node, THIS, question.newConstraint(null));
    node.setType(AstFactory.newABooleanBasicType(node.getLocation()));
    return question.assistantFactory.createPTypeAssistant().checkConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseAGreaterNumericBinaryExp(AGreaterNumericBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    checkOrdered(node, THIS, question.newConstraint(null));
    node.setType(AstFactory.newABooleanBasicType(node.getLocation()));
    return question.assistantFactory.createPTypeAssistant().checkConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseAModNumericBinaryExp(AModNumericBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    checkNumeric(node, THIS, question.newConstraint(null));
    node.setType(AstFactory.newAIntNumericBasicType(node.getLocation()));
    return node.getType();
  }

  @Override public PType caseAPlusNumericBinaryExp(APlusNumericBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    checkNumeric(node, THIS, question.newConstraint(null));
    SNumericBasicType ln = question.assistantFactory.createPTypeAssistant().getNumeric(node.getLeft().getType(), question.fromModule);
    SNumericBasicType rn = question.assistantFactory.createPTypeAssistant().getNumeric(node.getRight().getType(), question.fromModule);
    if (ln instanceof ARealNumericBasicType) {
      node.setType(ln);
      return ln;
    } else {
      if (rn instanceof ARealNumericBasicType) {
        node.setType(rn);
        return rn;
      } else {
        if (ln instanceof AIntNumericBasicType) {
          node.setType(ln);
          return ln;
        } else {
          if (rn instanceof AIntNumericBasicType) {
            node.setType(rn);
            return rn;
          } else {
            if (ln instanceof ANatNumericBasicType && rn instanceof ANatNumericBasicType) {
              node.setType(ln);
              return ln;
            } else {
  ...
  @Override public PType caseARemNumericBinaryExp(ARemNumericBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    checkNumeric(node, THIS, question.newConstraint(null));
    node.setType(AstFactory.newAIntNumericBasicType(node.getLocation()));
    return node.getType();
  }

  @Override public PType caseASubtractNumericBinaryExp(ASubtractNumericBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    checkNumeric(node, THIS, question.newConstraint(null));
    if (question.assistantFactory.createPTypeAssistant().isType(node.getLeft().getType(), ARealNumericBasicType.class) || question.assistantFactory.createPTypeAssistant().isType(node.getRight().getType(), ARealNumericBasicType.class)) {
      node.setType(AstFactory.newARealNumericBasicType(node.getLocation()));
      return node.getType();
    } else {
      if (question.assistantFactory.createPTypeAssistant().isType(node.getLeft().getType(), ARationalNumericBasicType.class) || question.assistantFactory.createPTypeAssistant().isType(node.getRight().getType(), ARationalNumericBasicType.class)) {
  ...
  @Override public PType caseATimesNumericBinaryExp(ATimesNumericBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    checkNumeric(node, THIS, question.newConstraint(null));
    SNumericBasicType ln = question.assistantFactory.createPTypeAssistant().getNumeric(node.getLeft().getType(), question.fromModule);
    SNumericBasicType rn = question.assistantFactory.createPTypeAssistant().getNumeric(node.getRight().getType(), question.fromModule);
    if (ln instanceof ARealNumericBasicType) {
      ...
      if (rn instanceof ARealNumericBasicType) {
        ...
        if (ln instanceof AIntNumericBasicType) {
          ...
          if (rn instanceof AIntNumericBasicType) {
            ...
            if (ln instanceof ANatNumericBasicType) {
              node.setType(ln);
              return ln;
            } else {
              if (rn instanceof ANatNumericBasicType) {
                node.setType(rn);
                return rn;
              } else {
                node.setType(AstFactory.newANatOneNumericBasicType(ln.getLocation()));
  ...
  @Override public PType caseAPlusPlusBinaryExp(APlusPlusBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo leftcons = question.newConstraint(null);
    TypeCheckInfo mapcons = question.newConstraint(null);
    if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isSeq(question.constraint, question.fromModule)) {
      SSeqType st = question.assistantFactory.createPTypeAssistant().getSeq(question.constraint, question.fromModule);
      mapcons = question.newConstraint(AstFactory.newAMapMapType(node.getLocation(), AstFactory.newANatOneNumericBasicType(node.getLocation()), st.getSeqof()));
      leftcons = question.newConstraint(AstFactory.newASeqSeqType(node.getLocation()));
    } else {
      if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isMap(question.constraint, question.fromModule)) {
        SMapType mt = question.assistantFactory.createPTypeAssistant().getMap(question.constraint, question.fromModule);
        mapcons = question.newConstraint(mt);
        leftcons = question.newConstraint(AstFactory.newAMapMapType(node.getLocation(), mt.getFrom(), AstFactory.newAUnknownType(node.getLocation())));
      }
    }
    node.getLeft().apply(THIS, leftcons);
    node.getRight().apply(THIS, mapcons);
    PTypeSet result = new PTypeSet(question.assistantFactory);
    boolean unique = !question.assistantFactory.createPTypeAssistant().isUnion(node.getLeft().getType(), question.fromModule) && !question.assistantFactory.createPTypeAssistant().isUnion(node.getRight().getType(), question.fromModule);
    if (question.assistantFactory.createPTypeAssistant().isMap(node.getLeft().getType(), question.fromModule)) {
      if (!question.assistantFactory.createPTypeAssistant().isMap(node.getRight().getType(), question.fromModule)) {
    ...
    if (question.assistantFactory.createPTypeAssistant().isSeq(node.getLeft().getType(), question.fromModule)) {
      SSeqType st = question.assistantFactory.createPTypeAssistant().getSeq(node.getLeft().getType(), question.fromModule);
      if (!question.assistantFactory.createPTypeAssistant().isMap(node.getRight().getType(), question.fromModule)) {
  ...
  @Override public PType caseAProperSubsetBinaryExp(AProperSubsetBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    node.getLeft().apply(THIS, noConstraint);
    node.getRight().apply(THIS, noConstraint);
    PType ltype = node.getLeft().getType();
    PType rtype = node.getRight().getType();
    if (question.assistantFactory.createPTypeAssistant().isSet(ltype, question.fromModule) && question.assistantFactory.createPTypeAssistant().isSet(rtype, question.fromModule) && !question.assistantFactory.getTypeComparator().compatible(ltype, rtype)) {
    ...
    if (!question.assistantFactory.createPTypeAssistant().isSet(ltype, question.fromModule)) {
      TypeCheckerErrors.report(3146, "Left hand of " + node.getOp() + " is not a set", node.getLocation(), node);
    }
    if (!question.assistantFactory.createPTypeAssistant().isSet(rtype, question.fromModule)) {
  ...
  @Override public PType caseARangeResByBinaryExp(ARangeResByBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    PType ltype = node.getLeft().getType();
    PType rtype = node.getRight().getType();
    if (!question.assistantFactory.createPTypeAssistant().isMap(ltype, question.fromModule)) {
      ...
      if (!question.assistantFactory.createPTypeAssistant().isSet(rtype, question.fromModule)) {
        ...
        SMapType map = question.assistantFactory.createPTypeAssistant().getMap(ltype, question.fromModule);
        SSetType set = question.assistantFactory.createPTypeAssistant().getSet(rtype, question.fromModule);
  ...
  @Override public PType caseARangeResToBinaryExp(ARangeResToBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo rngConstraint = question;
    if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isMap(question.constraint, question.fromModule)) {
      PType stype = question.assistantFactory.createPTypeAssistant().getMap(question.constraint, question.fromModule).getTo();
      rngConstraint = question.newConstraint(AstFactory.newASetSetType(node.getLocation(), stype));
  ...
  @Override public PType caseASeqConcatBinaryExp(ASeqConcatBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo lrconstraint = question;
    if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isSeq(question.constraint, question.fromModule)) {
      SSeqType stype = question.assistantFactory.createPTypeAssistant().getSeq(question.constraint, question.fromModule);
    ...
    PType ltype = node.getLeft().getType();
    PType rtype = node.getRight().getType();
    if (!question.assistantFactory.createPTypeAssistant().isSeq(ltype, question.fromModule)) {
    ...
    PType lof = question.assistantFactory.createPTypeAssistant().getSeq(ltype, question.fromModule);
    PType rof = question.assistantFactory.createPTypeAssistant().getSeq(rtype, question.fromModule);
    ...
    ts.add(lof);
    ts.add(rof);
    node.setType(seq1 ? AstFactory.newASeq1SeqType(node.getLocation(), ts.getType(node.getLocation())) : AstFactory.newASeqSeqType(node.getLocation(), ts.getType(node.getLocation())));
    return node.getType();
  }

  @Override public PType caseASetDifferenceBinaryExp(ASetDifferenceBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    node.getLeft().apply(THIS, noConstraint);
    node.getRight().apply(THIS, noConstraint);
    PType ltype = node.getLeft().getType();
  ...
  @Override public PType caseASetIntersectBinaryExp(ASetIntersectBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    node.getLeft().apply(THIS, noConstraint);
    node.getRight().apply(THIS, noConstraint);
    PType ltype = node.getLeft().getType();
    ...
    if (!assistant.isSet(ltype, question.fromModule)) {
      TypeCheckerErrors.report(3163, "Left hand of " + node.getLocation() + " is not a set", node.getLocation(), node);
    } else {
      lset = assistant.getSet(ltype, question.fromModule).getSetof();
    }
    if (!assistant.isSet(rtype, question.fromModule)) {
      TypeCheckerErrors.report(3164, "Right hand of " + node.getLocation() + " is not a set", node.getLocation(), node);
    } else {
      rset = assistant.getSet(rtype, question.fromModule).getSetof();
    }
    PType result = ltype;
  ...
  @Override public PType caseASetUnionBinaryExp(ASetUnionBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    node.getLeft().apply(THIS, question);
    node.getRight().apply(THIS, question);
    PType ltype = node.getLeft().getType();
    PType rtype = node.getRight().getType();
    ...
    PType lof = question.assistantFactory.createPTypeAssistant().getSet(ltype, question.fromModule).getSetof();
    PType rof = question.assistantFactory.createPTypeAssistant().getSet(rtype, question.fromModule).getSetof();
    boolean set1 = lof instanceof ASet1SetType || rof instanceof ASet1SetType;
    PTypeSet result = new PTypeSet(question.assistantFactory);
    result.add(lof);
    result.add(rof);
    node.setType(set1 ? AstFactory.newASet1SetType(node.getLocation(), result.getType(node.getLocation())) : AstFactory.newASetSetType(node.getLocation(), result.getType(node.getLocation())));
    return node.getType();
  }

  @Override public PType caseAStarStarBinaryExp(AStarStarBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    node.getLeft().apply(THIS, noConstraint);
    node.getRight().apply(THIS, noConstraint);
    PType ltype = node.getLeft().getType();
    ...
    if (question.assistantFactory.createPTypeAssistant().isMap(ltype, question.fromModule)) {
      ...
      if (!question.assistantFactory.createPTypeAssistant().isNumeric(rtype, question.fromModule)) {
        TypeCheckerErrors.report(3170, "Map iterator expects nat as right hand arg", node.getRight().getLocation(), rtype);
      }
    } else {
      if (question.assistantFactory.createPTypeAssistant().isFunction(ltype, question.fromModule)) {
        question.assistantFactory.createPTypeAssistant();
        if (!question.assistantFactory.createPTypeAssistant().isNumeric(rtype, question.fromModule)) {
        ...
        question.assistantFactory.createPTypeAssistant();
        if (question.assistantFactory.createPTypeAssistant().isNumeric(ltype, question.fromModule)) {
          question.assistantFactory.createPTypeAssistant();
          if (!question.assistantFactory.createPTypeAssistant().isNumeric(rtype, question.fromModule)) {
  ...
  @Override public PType caseASubsetBinaryExp(ASubsetBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    node.getLeft().apply(THIS, noConstraint);
    node.getRight().apply(THIS, noConstraint);
    PType ltype = node.getLeft().getType();
  ...
  @Override public PType caseABooleanConstExp(ABooleanConstExp node, TypeCheckInfo question) {
    node.setType(AstFactory.newABooleanBasicType(node.getLocation()));
    return question.assistantFactory.createPTypeAssistant().checkConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseACasesExp(ACasesExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    question.qualifiers = null;
  ...
  @Override public PType caseACharLiteralExp(ACharLiteralExp node, TypeCheckInfo question) {
    node.setType(AstFactory.newACharBasicType(node.getLocation()));
    return question.assistantFactory.createPTypeAssistant().checkConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseAElseIfExp(AElseIfExp node, TypeCheckInfo question) throws AnalysisException {
    node.setType(typeCheckAElseIf(node, node.getLocation(), node.getElseIf(), node.getThen(), question));
    return node.getType();
  }

  @Override public PType caseAExists1Exp(AExists1Exp node, TypeCheckInfo question) throws AnalysisException {
    ...
    question.qualifiers = null;
    if (!question.assistantFactory.createPTypeAssistant().isType(node.getPredicate().apply(THIS, new TypeCheckInfo(question.assistantFactory, local, question.scope, null, AstFactory.newABooleanBasicType(node.getLocation()), null, question.fromModule)), ABooleanBasicType.class)) {
  ...
  @Override public PType caseAExistsExp(AExistsExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    question = new TypeCheckInfo(question.assistantFactory, local, question.scope, null, AstFactory.newABooleanBasicType(node.getLocation()), null, question.fromModule);
  ...
  @Override public PType caseAFieldExp(AFieldExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    boolean unique = !question.assistantFactory.createPTypeAssistant().isUnion(root, question.fromModule);
    if (question.assistantFactory.createPTypeAssistant().isRecord(root, question.fromModule)) {
      ARecordInvariantType rec = question.assistantFactory.createPTypeAssistant().getRecord(root, question.fromModule);
      ...
      if (state != null && state.getRecordType().equals(rec)) {
        ...
        question.assistantFactory.createPDefinitionAssistant().findName(state, sname, NameScope.STATE);
      }
      if (cf != null) {
        results.add(cf.getType());
      } else {
        TypeCheckerErrors.concern(unique, 3090, "Unknown field " + node.getField().getName() + " in record " + rec.getName(), node.getField().getLocation(), node.getField());
      }
      recOrClass = true;
    }
    if (question.env.isVDMPP() && question.assistantFactory.createPTypeAssistant().isClass(root, question.env, question.fromModule)) {
      AClassType cls = question.assistantFactory.createPTypeAssistant().getClassType(root, question.env, question.fromModule);
      ...
      if (encl != null && question.assistantFactory.createPDefinitionAssistant().isFunction(encl)) {
        findScope = NameScope.VARSANDNAMES;
      }
      ...
      if (fdef == null) {
        ...
        memberName.setTypeQualifier(oldq);
      }
      ...
      if (fdef == null) {
        TypeCheckerErrors.concern(unique, 3091, "Unknown member " + memberName + " of class " + cls.getName().getName(), node.getField().getLocation(), node.getField());
        if (unique) {
          question.env.listAlternatives(memberName);
        }
      } else {
        if (question.assistantFactory.createSClassDefinitionAssistant().isAccessible(question.env, fdef, false)) {
          ...
          TypeCheckerErrors.concern(unique, 3092, "Inaccessible member " + memberName + " of class " + cls.getName().getName(), node.getField().getLocation(), node.getField());
        }
      }
      recOrClass = true;
    }
    if (results.isEmpty()) {
      if (!recOrClass) {
        if (root instanceof ARecordInvariantType && ((ARecordInvariantType) root).getOpaque()) {
          TypeCheckerErrors.report(3093, "Field \'" + node.getField().getName() + "\' applied to non-struct export", node.getObject().getLocation(), node.getObject());
        } else {
          TypeCheckerErrors.report(3093, "Field \'" + node.getField().getName() + "\' applied to non-aggregate type", node.getObject().getLocation(), node.getObject());
        }
      }
      node.setType(AstFactory.newAUnknownType(node.getLocation()));
      return node.getType();
  ...
  @Override public PType caseAFieldNumberExp(AFieldNumberExp node, TypeCheckInfo question) throws AnalysisException {
    PExp tuple = node.getTuple();
    question.qualifiers = null;
    PType type = tuple.apply(THIS, question.newConstraint(null));
    node.setType(type);
    if (!question.assistantFactory.createPTypeAssistant().isProduct(type, question.fromModule)) {
      TypeCheckerErrors.report(3094, "Field \'#" + node.getField() + "\' applied to non-tuple type", tuple.getLocation(), tuple);
      node.setType(AstFactory.newAUnknownType(node.getLocation()));
      return node.getType();
    }
    AProductType product = question.assistantFactory.createPTypeAssistant().getProduct(type, question.fromModule);
  ...
  @Override public PType caseAForAllExp(AForAllExp node, TypeCheckInfo question) throws AnalysisException {
    PDefinition def = AstFactory.newAMultiBindListDefinition(node.getLocation(), node.getBindList());
    def.apply(THIS, question.newConstraint(null));
    Environment local = new FlatCheckedEnvironment(question.assistantFactory, def, question.env, question.scope);
    if (!question.assistantFactory.createPTypeAssistant().isType(node.getPredicate().apply(THIS, new TypeCheckInfo(question.assistantFactory, local, question.scope, null, AstFactory.newABooleanBasicType(node.getLocation()), null, question.fromModule)), ABooleanBasicType.class)) {
  ...
  @Override public PType caseAFuncInstatiationExp(AFuncInstatiationExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    if (question.assistantFactory.createPTypeAssistant().isFunction(ftype, question.fromModule)) {
      ...
      if (t.getDefinitions().size() == 0) {
        ...
        for (PDefinition def : t.getDefinitions()) {
          ...
          node.setType(node.getExpdef() == null ? question.assistantFactory.createAImplicitFunctionDefinitionAssistant().getType(node.getImpdef(), node.getActualTypes()) : question.assistantFactory.createAExplicitFunctionDefinitionAssistant().getType(node.getExpdef(), node.getActualTypes()));
  ...
  @Override public PType caseAHistoryExp(AHistoryExp node, TypeCheckInfo question) {
      ...
      for (PDefinition def : allDefs) {
        if (def.getName() != null && def.getName().matches(opname)) {
          ...
          if (!question.assistantFactory.createPDefinitionAssistant().isCallableOperation(def)) {
            TypeCheckerErrors.report(3105, opname + " is not an explicit operation", opname.getLocation(), opname);
          }
          ...
          if (def.getAccess().getStatic() == null && question.env.isStatic()) {
            TypeCheckerErrors.report(3349, "Cannot see non-static operation from static context", opname.getLocation(), opname);
          }
        }
      }
      if (found == 0) {
  ...
  @Override public PType caseAIfExp(AIfExp node, TypeCheckInfo question) throws AnalysisException {
    node.setType(typeCheckIf(node.getLocation(), node.getTest(), node.getThen(), node.getElseList(), node.getElse(), question));
    return node.getType();
  }

  @Override public PType caseAIntLiteralExp(AIntLiteralExp node, TypeCheckInfo question) {
  ...
  @Override public PType caseAIotaExp(AIotaExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    if (bind instanceof ASetBind) {
      ...
      if (question.assistantFactory.createPTypeAssistant().isSet(rt, question.fromModule)) {
        rt = question.assistantFactory.createPTypeAssistant().getSet(rt, question.fromModule).getSetof();
      } else {
        TypeCheckerErrors.report(3112, "Iota set bind is not a set", node.getLocation(), node);
      }
    } else {
      if (bind instanceof ASeqBind) {
        ASeqBind sb = (ASeqBind) bind;
        question.qualifiers = null;
        rt = sb.getSeq().apply(THIS, question.newConstraint(null));
        if (question.assistantFactory.createPTypeAssistant().isSeq(rt, question.fromModule)) {
          rt = question.assistantFactory.createPTypeAssistant().getSeq(rt, question.fromModule).getSeqof();
        } else {
  ...
  @Override public PType caseAIsExp(AIsExp node, TypeCheckInfo question) throws AnalysisException {
    question.qualifiers = null;
  ...
  @Override public PType caseAIsOfBaseClassExp(AIsOfBaseClassExp node, TypeCheckInfo question) throws AnalysisException {
    if (question.env.findType(node.getBaseClass(), null) == null) {
      TypeCheckerErrors.report(3114, "Undefined base class type: " + node.getBaseClass().getName(), node.getLocation(), node);
    }
    question.qualifiers = null;
    PType rt = node.getExp().apply(THIS, question.newConstraint(null));
    if (!question.assistantFactory.createPTypeAssistant().isClass(rt, question.env, question.fromModule)) {
  ...
  @Override public PType caseAIsOfClassExp(AIsOfClassExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    if (cls == null || !(cls instanceof SClassDefinition)) {
      TypeCheckerErrors.report(3115, "Undefined class type: " + classname.getName(), node.getLocation(), node);
    } else {
  ...
  @Override public PType caseALambdaExp(ALambdaExp node, TypeCheckInfo question) throws AnalysisException {
    question = question.newScope(NameScope.NAMES);
    ...
    for (ATypeBind tb : node.getBindList()) {
      ...
      paramDefinitions.addAll(question.assistantFactory.createPPatternAssistant(question.fromModule).getDefinitions(tb.getPattern(), tb.getType(), NameScope.LOCAL));
    ...
    local.setEnclosingDefinition(def);
  ...
  @Override public PType caseALetBeStExp(ALetBeStExp node, TypeCheckInfo question) throws AnalysisException {
  ...
  @Override public PType caseALetDefExp(ALetDefExp node, TypeCheckInfo question) throws AnalysisException {
    node.setType(typeCheckLet(node, node.getLocalDefs(), node.getExpression(), question));
    return node.getType();
  }

  @Override public PType caseADefExp(ADefExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    PType r = node.getExpression().apply(THIS, new TypeCheckInfo(question.assistantFactory, local, question.scope, null, question.constraint, null, question.fromModule));
    local.unusedCheck(question.env);
    node.setType(r);
    return r;
  }

  @Override public PType caseAMapCompMapExp(AMapCompMapExp node, TypeCheckInfo question) throws AnalysisException {
    PDefinition def = AstFactory.newAMultiBindListDefinition(node.getLocation(), node.getBindings());
    def.apply(THIS, question.newConstraint(null));
    Environment local = new FlatCheckedEnvironment(question.assistantFactory, def, question.env, question.scope);
    PExp predicate = node.getPredicate();
    TypeCheckInfo pquestion = new TypeCheckInfo(question.assistantFactory, local, question.scope, null, AstFactory.newABooleanBasicType(node.getLocation()), null, question.fromModule);
    if (predicate != null && !question.assistantFactory.createPTypeAssistant().isType(predicate.apply(THIS, pquestion), ABooleanBasicType.class)) {
  ...
  @Override public PType caseAMapEnumMapExp(AMapEnumMapExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    for (AMapletExp ex : node.getMembers()) {
      ...
      if (!question.assistantFactory.createPTypeAssistant().isMap(mt, question.fromModule)) {
        TypeCheckerErrors.report(3121, "Element is not of maplet type", node.getLocation(), node);
      } else {
        SMapType maplet = question.assistantFactory.createPTypeAssistant().getMap(mt, question.fromModule);
  ...
  @Override public PType caseAMapletExp(AMapletExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo domConstraint = question;
    TypeCheckInfo rngConstraint = question;
    if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isMap(question.constraint, question.fromModule)) {
      PType dtype = question.assistantFactory.createPTypeAssistant().getMap(question.constraint, question.fromModule).getFrom();
      domConstraint = question.newConstraint(dtype);
      PType rtype = question.assistantFactory.createPTypeAssistant().getMap(question.constraint, question.fromModule).getTo();
  ...
  @Override public PType caseAMkBasicExp(AMkBasicExp node, TypeCheckInfo question) throws AnalysisException {
    PType argtype = node.getArg().apply(THIS, question.newConstraint(null));
    if (!(node.getType() instanceof ATokenBasicType) && !question.assistantFactory.createPTypeAssistant().equals(argtype, node.getType())) {
      TypeCheckerErrors.report(3125, "Argument of mk_" + node.getType() + " is the wrong type", node.getLocation(), node);
    }
    return question.assistantFactory.createPTypeAssistant().checkConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseAMkTypeExp(AMkTypeExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    if (typeDef instanceof ATypeDefinition) {
      ...
      if (typeDef instanceof AStateDefinition) {
    ...
    if (TypeChecker.isOpaque(node.getRecordType(), question.fromModule)) {
      TypeCheckerErrors.report(3127, "Type \'" + node.getTypeName() + "\' has no struct export", node.getLocation(), node);
      node.setType(rec);
      return rec;
    }
  ...
  @Override public PType caseAMuExp(AMuExp node, TypeCheckInfo question) throws AnalysisException {
    PType rtype = node.getRecord().apply(THIS, question.newConstraint(null));
    if (rtype instanceof AUnknownType) {
      node.setType(rtype);
      return rtype;
    }
    if (question.assistantFactory.createPTypeAssistant().isRecord(rtype, question.fromModule)) {
      node.setRecordType(question.assistantFactory.createPTypeAssistant().getRecord(rtype, question.fromModule));
  ...
  @Override public PType caseANarrowExp(ANarrowExp node, TypeCheckInfo question) throws AnalysisException {
  ...
  @Override public PType caseANewExp(ANewExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    if (classdef.getIsAbstract()) {
      TypeCheckerErrors.report(3330, "Cannot instantiate abstract class " + classdef.getName(), node.getLocation(), node);
    ...
    if (opdef == null) {
      if (!node.getArgs().isEmpty()) {
        ...
        if (classdef instanceof ACpuClassDefinition || classdef instanceof ABusClassDefinition) {
      ...
      if (!question.assistantFactory.createPDefinitionAssistant().isCallableOperation(opdef)) {
        ...
        if (!question.assistantFactory.createSClassDefinitionAssistant().isAccessible(question.env, opdef, false)) {
  ...
  @Override public PType caseANilExp(ANilExp node, TypeCheckInfo question) {
    node.setType(AstFactory.newAOptionalType(node.getLocation(), AstFactory.newAUnknownType(node.getLocation())));
    return question.assistantFactory.createPTypeAssistant().checkConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseANotYetSpecifiedExp(ANotYetSpecifiedExp node, TypeCheckInfo question) {
    node.setType(typeCheckANotYetSpecifiedExp(node, node.getLocation()));
    return node.getType();
  }

  @Override public PType caseAPostOpExp(APostOpExp node, TypeCheckInfo question) throws AnalysisException {
    node.setType(node.getPostexpression().apply(THIS, question.newConstraint(null)));
    return node.getType();
  }

  @Override public PType caseAPreExp(APreExp node, TypeCheckInfo question) throws AnalysisException {
  ...
  @Override public PType caseAPreOpExp(APreOpExp node, TypeCheckInfo question) throws AnalysisException {
    node.setType(node.getExpression().apply(THIS, question.newConstraint(null)));
    return node.getType();
  }

  @Override public PType caseAQuoteLiteralExp(AQuoteLiteralExp node, TypeCheckInfo question) {
    node.setType(AstFactory.newAQuoteType(node.getValue().clone()));
    return question.assistantFactory.createPTypeAssistant().checkConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseARealLiteralExp(ARealLiteralExp node, TypeCheckInfo question) {
  ...
  @Override public PType caseASameBaseClassExp(ASameBaseClassExp node, TypeCheckInfo question) throws AnalysisException {
    PExp left = node.getLeft();
    PExp right = node.getRight();
    question.qualifiers = null;
    PType lt = left.apply(THIS, question.newConstraint(null));
    if (!question.assistantFactory.createPTypeAssistant().isClass(lt, question.env, question.fromModule)) {
  ...
  @Override public PType caseASameClassExp(ASameClassExp node, TypeCheckInfo question) throws AnalysisException {
    PExp left = node.getLeft();
    PExp right = node.getRight();
    question.qualifiers = null;
    PType lt = left.apply(THIS, question.newConstraint(null));
  ...
  @Override public PType caseASelfExp(ASelfExp node, TypeCheckInfo question) {
  ...
  @Override public PType caseASeqCompSeqExp(ASeqCompSeqExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    def.apply(THIS, question.newConstraint(null));
    if (node.getSetBind() != null && (question.assistantFactory.createPPatternAssistant(question.fromModule).getVariableNames(node.getSetBind().getPattern()).size() > 1 || !question.assistantFactory.createPTypeAssistant().isOrdered(question.assistantFactory.createPDefinitionAssistant().getType(def), node.getLocation()))) {
  ...
  @Override public PType caseASeqEnumSeqExp(ASeqEnumSeqExp node, TypeCheckInfo question) throws AnalysisException {
    PTypeSet ts = new PTypeSet(question.assistantFactory);
    node.setTypes(new LinkedList<PType>());
    List<PType> types = node.getTypes();
    TypeCheckInfo elemConstraint = question;
    if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isSeq(question.constraint, question.fromModule)) {
      PType stype = question.assistantFactory.createPTypeAssistant().getSeq(question.constraint, question.fromModule).getSeqof();
    ...
    node.setType(ts.isEmpty() ? AstFactory.newASeqSeqType(node.getLocation()) : AstFactory.newASeq1SeqType(node.getLocation(), ts.getType(node.getLocation())));
    return question.assistantFactory.createPTypeAssistant().possibleConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseASetCompSetExp(ASetCompSetExp node, TypeCheckInfo question) throws AnalysisException {
  ...
  @Override public PType caseASetEnumSetExp(ASetEnumSetExp node, TypeCheckInfo question) throws AnalysisException {
    PTypeSet ts = new PTypeSet(question.assistantFactory);
    node.setTypes(new LinkedList<PType>());
    List<PType> types = node.getTypes();
    TypeCheckInfo elemConstraint = question;
    if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isSet(question.constraint, question.fromModule)) {
      PType setType = question.assistantFactory.createPTypeAssistant().getSet(question.constraint, question.fromModule).getSetof();
    ...
    node.setType(ts.isEmpty() ? AstFactory.newASetSetType(node.getLocation()) : AstFactory.newASet1SetType(node.getLocation(), ts.getType(node.getLocation())));
    return question.assistantFactory.createPTypeAssistant().possibleConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseASetRangeSetExp(ASetRangeSetExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    if (!question.assistantFactory.createPTypeAssistant().isNumeric(ftype, question.fromModule)) {
    ...
    SNumericBasicType ntype = question.assistantFactory.createPTypeAssistant().getNumeric(ftype, question.fromModule);
  ...
  @Override public PType caseAStateInitExp(AStateInitExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    PPattern pattern = node.getState().getInitPattern();
    PExp exp = node.getState().getInitExpression();
    boolean canBeExecuted = false;
    if (pattern instanceof AIdentifierPattern && exp instanceof AEqualsBinaryExp) {
      ...
      if (ee.getLeft() instanceof AVariableExp) {
        ...
        if (question.assistantFactory.createPTypeAssistant().isTag(rhs, question.fromModule)) {
          ARecordInvariantType rt = question.assistantFactory.createPTypeAssistant().getRecord(rhs, question.fromModule);
  ...
  @Override public PType caseAStringLiteralExp(AStringLiteralExp node, TypeCheckInfo question) {
  ...
  @Override public PType caseASubclassResponsibilityExp(ASubclassResponsibilityExp node, TypeCheckInfo question) {
    node.setType(AstFactory.newAUnknownType(node.getLocation()));
    return node.getType();
  }

  @Override public PType caseASubseqExp(ASubseqExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo noConstraint = question.newConstraint(null);
    question.qualifiers = null;
    ...
    if (!question.assistantFactory.createPTypeAssistant().isSeq(stype, question.fromModule)) {
    ...
    question.assistantFactory.createPTypeAssistant();
    if (!question.assistantFactory.createPTypeAssistant().isNumeric(ttype, question.fromModule)) {
  ...
  @Override public PType caseAThreadIdExp(AThreadIdExp node, TypeCheckInfo question) {
    PDefinition encl = question.env.getEnclosingDefinition();
  ...
  @Override public PType caseATimeExp(ATimeExp node, TypeCheckInfo question) {
    PDefinition encl = question.env.getEnclosingDefinition();
    if (encl != null && encl.getAccess().getPure()) {
  ...
  @Override public PType caseATupleExp(ATupleExp node, TypeCheckInfo question) throws AnalysisException {
    node.setTypes(new LinkedList<PType>());
    List<PType> types = node.getTypes();
    List<PType> elemConstraints = null;
    if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isProduct(question.constraint, question.fromModule)) {
      elemConstraints = question.assistantFactory.createPTypeAssistant().getProduct(question.constraint, question.fromModule).getTypes();
  ...
  @Override public PType caseAUndefinedExp(AUndefinedExp node, TypeCheckInfo question) {
    node.setType(AstFactory.newAUnknownType(node.getLocation()));
    return node.getType();
  }

  @Override public PType caseAVariableExp(AVariableExp node, TypeCheckInfo question) {
      ...
      if (vardef != null) {
        if (vardef.getClassDefinition() != null) {
          ...
          if (!question.assistantFactory.createSClassDefinitionAssistant().isAccessible(env, vardef, true)) {
            TypeCheckerErrors.report(3180, "Inaccessible member " + name + " of class " + vardef.getClassDefinition().getName().getName(), node.getLocation(), node);
            node.setType(AstFactory.newAUnknownType(node.getLocation()));
            return node.getType();
          } else {
            if (!question.assistantFactory.createPAccessSpecifierAssistant().isStatic(vardef.getAccess()) && env.isStatic()) {
        ...
        if (question.qualifiers != null) {
          ...
          for (PDefinition possible : env.findMatches(name)) {
            if (question.assistantFactory.createPDefinitionAssistant().isFunctionOrOperation(possible)) {
              if (vardef != null) {
                TypeCheckerErrors.report(3269, "Ambiguous function/operation name: " + name.getName(), node.getLocation(), node);
  ...
  /**
	 ...
	 */
  @Override public PType caseALessEqualNumericBinaryExp(ALessEqualNumericBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    checkOrdered(node, THIS, question);
    node.setType(AstFactory.newABooleanBasicType(node.getLocation()));
    return question.assistantFactory.createPTypeAssistant().checkConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseALessNumericBinaryExp(ALessNumericBinaryExp node, TypeCheckInfo question) throws AnalysisException {
    checkOrdered(node, THIS, question);
    node.setType(AstFactory.newABooleanBasicType(node.getLocation()));
    return question.assistantFactory.createPTypeAssistant().checkConstraint(question.constraint, node.getType(), node.getLocation());
  }
  ...
  /**
	 ...
	 * @throws AnalysisException
	 */
  @Override public PType caseAAbsoluteUnaryExp(AAbsoluteUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    question.qualifiers = null;
    TypeCheckInfo absConstraint = question.newConstraint(null);
    if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isNumeric(question.constraint, question.fromModule)) {
      if (question.constraint instanceof AIntNumericBasicType || question.constraint instanceof ANatOneNumericBasicType) {
    ...
    if (!question.assistantFactory.createPTypeAssistant().isNumeric(t, question.fromModule)) {
      ...
      if (t instanceof AIntNumericBasicType) {
  ...
  @Override public PType caseAAnnotatedUnaryExp(AAnnotatedUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    TypeCheckInfo unconstrained = question.newConstraint(null);
    node.getAnnotation().apply(THIS, unconstrained);
  ...
  @Override public PType caseACardinalityUnaryExp(ACardinalityUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    node.setType(set1 ? AstFactory.newANatOneNumericBasicType(node.getLocation()) : AstFactory.newANatNumericBasicType(node.getLocation()));
    return question.assistantFactory.createPTypeAssistant().possibleConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseADistConcatUnaryExp(ADistConcatUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    ...
    if (question.assistantFactory.createPTypeAssistant().isSeq(result, question.fromModule)) {
      PType inner = question.assistantFactory.createPTypeAssistant().getSeq(result, question.fromModule).getSeqof();
      if (question.assistantFactory.createPTypeAssistant().isSeq(inner, question.fromModule)) {
        node.setType(question.assistantFactory.createPTypeAssistant().getSeq(inner, question.fromModule));
        return node.getType();
      }
    }
  ...
  @Override public PType caseADistIntersectUnaryExp(ADistIntersectUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    PType arg = exp.apply(THIS, question.newConstraint(null));
    if (question.assistantFactory.createPTypeAssistant().isSet(arg, question.fromModule)) {
      SSetType set = question.assistantFactory.createPTypeAssistant().getSet(arg, question.fromModule);
      if (set.getEmpty() || question.assistantFactory.createPTypeAssistant().isSet(set.getSetof(), question.fromModule)) {
  ...
  @Override public PType caseADistMergeUnaryExp(ADistMergeUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    TypeCheckInfo expConstraint = question;
    if (question.constraint != null) {
    ...
    if (question.assistantFactory.createPTypeAssistant().isSet(arg, question.fromModule)) {
      SSetType set = question.assistantFactory.createPTypeAssistant().getSet(arg, question.fromModule);
      if (!set.getEmpty() && question.assistantFactory.createPTypeAssistant().isMap(set.getSetof(), question.fromModule)) {
        node.setType(set.getSetof());
        return set.getSetof();
      }
    }
    TypeCheckerErrors.report(3077, "Merge argument is not a set of maps", node.getLocation(), node);
    return AstFactory.newAMapMapType(node.getLocation());
  }

  @Override public PType caseADistUnionUnaryExp(ADistUnionUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    TypeCheckInfo expConstraint = question;
    if (question.constraint != null) {
    ...
    if (question.assistantFactory.createPTypeAssistant().isSet(type, question.fromModule)) {
      SSetType set = question.assistantFactory.createPTypeAssistant().getSet(type, question.fromModule);
      if (question.assistantFactory.createPTypeAssistant().isSet(set.getSetof(), question.fromModule)) {
        node.setType(set.getSetof());
        return set.getSetof();
      }
    }
  ...
  @Override public PType caseAFloorUnaryExp(AFloorUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    if (!question.assistantFactory.createPTypeAssistant().isNumeric(exp.apply(THIS, question.newConstraint(null)), question.fromModule)) {
  ...
  @Override public PType caseAHeadUnaryExp(AHeadUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    PType etype = exp.apply(THIS, question.newConstraint(null));
    ...
    node.setType(question.assistantFactory.createPTypeAssistant().getSeq(etype, question.fromModule).getSeqof());
    return node.getType();
  }

  @Override public PType caseAIndicesUnaryExp(AIndicesUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    PType etype = exp.apply(THIS, question.newConstraint(null));
    boolean empty = false;
    if (!question.assistantFactory.createPTypeAssistant().isSeq(etype, question.fromModule)) {
      ...
      empty = question.assistantFactory.createPTypeAssistant().getSeq(etype, question.fromModule).getEmpty();
    }
  ...
  @Override public PType caseALenUnaryExp(ALenUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    boolean seq1 = false;
    PType etype = exp.apply(THIS, question.newConstraint(null));
    ...
    node.setType(seq1 ? AstFactory.newANatOneNumericBasicType(node.getLocation()) : AstFactory.newANatNumericBasicType(node.getLocation()));
    return question.assistantFactory.createPTypeAssistant().possibleConstraint(question.constraint, node.getType(), node.getLocation());
  }

  @Override public PType caseAMapDomainUnaryExp(AMapDomainUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    PType etype = exp.apply(THIS, question.newConstraint(null));
    if (!question.assistantFactory.createPTypeAssistant().isMap(etype, question.fromModule)) {
      TypeCheckerErrors.report(3120, "Argument to \'dom\' is not a map", node.getLocation(), node);
      node.setType(AstFactory.newAUnknownType(node.getLocation()));
      return node.getType();
    }
    SMapType mt = question.assistantFactory.createPTypeAssistant().getMap(etype, question.fromModule);
    node.setType(AstFactory.newASetSetType(node.getLocation(), mt.getFrom()));
    return node.getType();
  }

  @Override public PType caseAMapInverseUnaryExp(AMapInverseUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    PType etype = exp.apply(THIS, question.newConstraint(null));
    if (!question.assistantFactory.createPTypeAssistant().isMap(etype, question.fromModule)) {
    ...
    node.setMapType(question.assistantFactory.createPTypeAssistant().getMap(etype, question.fromModule));
    AMapMapType mm = AstFactory.newAMapMapType(node.getLocation(), node.getMapType().getTo(), node.getMapType().getFrom());
    node.setType(mm);
    return node.getType();
  }

  @Override public PType caseAMapRangeUnaryExp(AMapRangeUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    PType etype = exp.apply(THIS, question.newConstraint(null));
    if (!question.assistantFactory.createPTypeAssistant().isMap(etype, question.fromModule)) {
  ...
  @Override public PType caseANotUnaryExp(ANotUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
  ...
  @Override public PType caseAPowerSetUnaryExp(APowerSetUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    TypeCheckInfo argConstraint = question.newConstraint(null);
    if (question.constraint != null && question.assistantFactory.createPTypeAssistant().isSet(question.constraint, question.fromModule)) {
      PType stype = question.assistantFactory.createPTypeAssistant().getSet(question.constraint, question.fromModule).getSetof();
    ...
    SSetType eset = question.assistantFactory.createPTypeAssistant().getSet(etype, question.fromModule);
    node.setType(AstFactory.newASetSetType(node.getLocation(), AstFactory.newASetSetType(node.getLocation(), eset.getSetof())));
    return node.getType();
  }

  @Override public PType caseAReverseUnaryExp(AReverseUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
  ...
  @Override public PType caseATailUnaryExp(ATailUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    PExp exp = node.getExp();
    question.qualifiers = null;
    PType etype = exp.apply(THIS, question.newConstraint(null));
    if (!question.assistantFactory.createPTypeAssistant().isSeq(etype, question.fromModule)) {
  ...
  @Override public PType caseAUnaryMinusUnaryExp(AUnaryMinusUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    question.qualifiers = null;
  ...
  @Override public PType caseAUnaryPlusUnaryExp(AUnaryPlusUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    question.qualifiers = null;
    node.setType(node.getExp().apply(THIS, question));
    return node.getType();
  }

  @Override public PType caseAElementsUnaryExp(AElementsUnaryExp node, TypeCheckInfo question) throws AnalysisException {
    ...
    if (!question.assistantFactory.createPTypeAssistant().isSeq(arg, question.fromModule)) {
      TypeCheckerErrors.report(3085, "Argument of \'elems\' is not a sequence", node.getLocation(), node);
      node.setType(AstFactory.newASetSetType(node.getLocation(), AstFactory.newAUnknownType(node.getLocation())));
      return node.getType();
    }
    SSeqType seq = question.assistantFactory.createPTypeAssistant().getSeq(arg, question.fromModule);
    node.setType(seq.getEmpty() ? AstFactory.newASetSetType(node.getLocation()) : AstFactory.newASetSetType(node.getLocation(), seq.getSeqof()));
    return node.getType();
  }

  private void checkNumeric(SNumericBinaryExp node, IQuestionAnswer<TypeCheckInfo, PType> rootVisitor, TypeCheckInfo question) throws AnalysisException {
    node.getLeft().apply(rootVisitor, question.newConstraint(null));
    node.getRight().apply(rootVisitor, question.newConstraint(null));
    if (!question.assistantFactory.createPTypeAssistant().isNumeric(node.getLeft().getType(), question.fromModule)) {
    ...
    if (!question.assistantFactory.createPTypeAssistant().isNumeric(node.getRight().getType(), question.fromModule)) {
  ...
  private void checkOrdered(SNumericBinaryExp node, IQuestionAnswer<TypeCheckInfo, PType> rootVisitor, TypeCheckInfo question) throws AnalysisException {
    node.getLeft().apply(rootVisitor, question.newConstraint(null));
    node.getRight().apply(rootVisitor, question.newConstraint(null));
    if (!question.assistantFactory.createPTypeAssistant().isOrdered(node.getLeft().getType(), node.getLocation())) {
      TypeCheckerErrors.report(3139, "Left hand of " + node.getOp() + " is not ordered", node.getLocation(), node);
      TypeCheckerErrors.detail("Actual", node.getLeft().getType());
      node.getLeft().setType(AstFactory.newARealNumericBasicType(node.getLocation()));
    }
    if (!question.assistantFactory.createPTypeAssistant().isOrdered(node.getRight().getType(), node.getLocation())) {
      TypeCheckerErrors.report(3140, "Right hand of " + node.getOp() + " is not ordered", node.getLocation(), node);
      TypeCheckerErrors.detail("Actual", node.getRight().getType());
      node.getRight().setType(AstFactory.newARealNumericBasicType(node.getLocation()));
    }
  }

  public PType functionApply(AApplyExp node, boolean isSimple, AFunctionType ft, TypeCheckInfo question) {
    ...
    for (PType at : node.getArgtypes()) {
      ...
      if (!question.assistantFactory.getTypeComparator().compatible(pt, at)) {
        TypeCheckerErrors.concern(isSimple, 3061, "Inappropriate type for argument " + i, node.getArgs().get(i - 1).getLocation(), node);
        TypeCheckerErrors.detail2(isSimple, "Expect", pt, "Actual", at);
      } else {
        if (at instanceof AFunctionType) {
          AFunctionType fat = (AFunctionType) at;
          if (fat.getInstantiated() != null && !fat.getInstantiated()) {
            TypeCheckerErrors.concern(isSimple, 3354, "Function argument must be instantiated", node.getArgs().get(i - 1).getLocation(), node);
          }
        }
      }
    }
  ...
  public PType operationApply(AApplyExp node, boolean isSimple, AOperationType ot, TypeCheckInfo question) {
  ...
  public PType sequenceApply(AApplyExp node, boolean isSimple, SSeqType seq, TypeCheckInfo question) {
    if (node.getArgs().size() != 1) {
      ...
      if (!question.assistantFactory.createPTypeAssistant().isNumeric(node.getArgtypes().get(0), question.fromModule)) {
  ...
  public PDefinition getRecursiveDefinition(AApplyExp node, TypeCheckInfo question) {
  ...
  /**
	 ...
	 * @return
	 */
  public String getMeasureApply(AApplyExp node, ILexNameToken measure, boolean close) {
    String start = null;
    PExp root = node.getRoot();
    if (root instanceof AApplyExp) {
      AApplyExp aexp = (AApplyExp) root;
  ...
  public PType typeCheck(ACaseAlternative c, IQuestionAnswer<TypeCheckInfo, PType> rootVisitor, TypeCheckInfo question, PType expType) throws AnalysisException {
    if (c.getDefs().size() == 0) {
      question.assistantFactory.createPPatternAssistant(question.fromModule).typeResolve(c.getPattern(), rootVisitor, new TypeCheckInfo(question.assistantFactory, question.env));
      ...
      try {
        question.assistantFactory.createPPatternAssistant(question.fromModule).typeResolve(c.getPattern(), rootVisitor, new TypeCheckInfo(question.assistantFactory, question.env));
        c.getDefs().addAll(question.assistantFactory.createPPatternAssistant(question.fromModule).getDefinitions(c.getPattern(), expType, NameScope.LOCAL));
      } catch (TypeCheckException e) {
        c.getDefs().clear();
        throw e;
      }
    }
    question.assistantFactory.createPPatternAssistant(question.fromModule).typeCheck(c.getPattern(), question, rootVisitor);
    ...
    if (!question.assistantFactory.createPPatternAssistant(question.fromModule).matches(c.getPattern(), expType)) {
      TypeCheckerErrors.report(3311, "Pattern cannot match", c.getPattern().getLocation(), c.getPattern());
    }
  ...
  public ABooleanBasicType binaryCheck(SBooleanBinaryExp node, ABooleanBasicType expected, IQuestionAnswer<TypeCheckInfo, PType> rootVisitor, TypeCheckInfo question) throws AnalysisException {
