...
public class PromotableCandidateItemOfferImpl extends AbstractPromotionRounding implements PromotableCandidateItemOffer, OfferHolder {
  ...
  @Override public Money getPotentialSavingsQtyOne() {
  ...
  @Override public void setPotentialSavingsQtyOne(Money potentialSavingsQtyOne) {
  ...
  @Override public void setCandidateQualifiersMap(HashMap<OfferItemCriteria, List<PromotableOrderItem>> candidateItemsMap) {
    this.candidateQualifiersMap = candidateItemsMap;
  }

  @Override public HashMap<OfferItemCriteria, List<PromotableOrderItem>> getCandidateTargetsMap() {
    return candidateTargetsMap;
  }

  @Override public void setCandidateTargetsMap(HashMap<OfferItemCriteria, List<PromotableOrderItem>> candidateItemsMap) {
    this.candidateTargetsMap = candidateItemsMap;
  }

  @Override public HashMap<OfferPriceData, List<PromotableOrderItem>> getCandidateFixedTargetsMap() {
    return candidateFixedTargetsMap;
  }

  @Override public void setCandidateFixedTargetsMap(HashMap<OfferPriceData, List<PromotableOrderItem>> candidateFixedTargetsMap) {
  ...
  @Override public void resetUses() {
    uses = 0;
  }

  @Override public List<PromotableOrderItem> getLegacyCandidateTargets() {
    return legacyCandidateTargets;
  }

  @Override public void setLegacyCandidateTargets(List<PromotableOrderItem> candidateTargets) {
    this.legacyCandidateTargets = candidateTargets;
  }

  @Override public BigDecimal getWeightedPercentSaved() {
  ...
  @Override public void setWeightedPercentSaved(BigDecimal weightedPercentSaved) {
    this.weightedPercentSaved = weightedPercentSaved;
  }

  @Override public Money getOriginalPrice() {
    return originalPrice;
  }

  @Override public void setOriginalPrice(Money originalPrice) {
  ...
  @Override public boolean isUseQtyOnlyTierCalculation() {
    return useQtyOnlyTierCalculation;
  }

  @Override public void setUseQtyOnlyTierCalculation(boolean useQtyOnlyTierCalculation) {
    this.useQtyOnlyTierCalculation = useQtyOnlyTierCalculation;
  }
}