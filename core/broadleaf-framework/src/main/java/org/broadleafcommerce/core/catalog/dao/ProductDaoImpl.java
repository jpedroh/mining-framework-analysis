 ...
 */
@Repository(value = "blProductDao") public class ProductDaoImpl implements ProductDao {
  ...
  @Resource(name = "blProductDaoExtensionManager") protected ProductDaoExtensionManager extensionManager;

  @Value(value = "${query.dateResolution.product:10000}") protected Long currentDateResolution;

  @Resource(name = "blSiteMapExtensionManager") protected SiteMapExtensionManager productTypeSiteMapExtensionManager;
  ...
  @Override public Product readProductById(Long productId) {
    return em.find(ProductImpl.class, productId);
  }

  @Override public Product readProductByExternalId(String externalId) {
  ...
  @Override public List<Product> readProductsByIds(List<Long> productIds) {
  ...
  @Override public List<Product> readProductsByName(String searchName) {
  ...
  @Override public List<Product> readProductsByName(@Nonnull String searchName, @Nonnull int limit, @Nonnull int offset) {
    TypedQuery<Product> query = em.createNamedQuery("BC_READ_PRODUCTS_BY_NAME", Product.class);
    query.setParameter("name", searchName + '%');
  ...
  @Override public List<Product> readActiveProductsByCategory(Long categoryId) {
  ...
  @Override @Deprecated public List<Product> readActiveProductsByCategory(Long categoryId, Date currentDate) {
    return readActiveProductsByCategoryInternal(categoryId, currentDate);
  }
  ...
  @Override public List<Product> readFilteredActiveProductsByQuery(String query, SearchCriteria searchCriteria) {
    Date currentDate = DateUtil.getCurrentDateAfterFactoringInDateResolution(cachedDate, getCurrentDateResolution());
    return readFilteredActiveProductsByQueryInternal(query, currentDate, searchCriteria);
  }

  @Override @Deprecated public List<Product> readFilteredActiveProductsByQuery(String query, Date currentDate, SearchCriteria searchCriteria) {
    return readFilteredActiveProductsByQueryInternal(query, currentDate, searchCriteria);
  }
  ...
  @Override public List<Product> readFilteredActiveProductsByCategory(Long categoryId, SearchCriteria searchCriteria) {
    Date currentDate = DateUtil.getCurrentDateAfterFactoringInDateResolution(cachedDate, getCurrentDateResolution());
    return readFilteredActiveProductsByCategoryInternal(categoryId, currentDate, searchCriteria);
  }

  @Override @Deprecated public List<Product> readFilteredActiveProductsByCategory(Long categoryId, Date currentDate, SearchCriteria searchCriteria) {
    return readFilteredActiveProductsByCategoryInternal(categoryId, currentDate, searchCriteria);
  }
  ...
  protected void attachSearchCriteria(SearchCriteria searchCriteria, From<?, ? extends Product> product, From<?, ? extends Sku> sku, List<Predicate> restrictions) {
    ...
    for (Entry<String, String[]> entry : searchCriteria.getFilterCriteria().entrySet()) {
      ...
      if (key.contains("defaultSku.")) {
        ...
        if (key.contains("productAttributes.")) {
  ...
  @Override public List<Product> readActiveProductsByCategory(Long categoryId, int limit, int offset) {
    Date currentDate = DateUtil.getCurrentDateAfterFactoringInDateResolution(cachedDate, getCurrentDateResolution());
    return readActiveProductsByCategoryInternal(categoryId, currentDate, limit, offset);
  }

  @Override @Deprecated public List<Product> readActiveProductsByCategory(Long categoryId, Date currentDate, int limit, int offset) {
    return readActiveProductsByCategoryInternal(categoryId, currentDate, limit, offset);
  }
  ...
  @Override public List<Product> readProductsByCategory(Long categoryId) {
  ...
  @Override public List<Product> readProductsByCategory(Long categoryId, int limit, int offset) {
    TypedQuery<Product> query = em.createNamedQuery("BC_READ_PRODUCTS_BY_CATEGORY", Product.class);
    query.setParameter("categoryId", sandBoxHelper.mergeCloneIds(CategoryImpl.class, categoryId));
    query.setFirstResult(offset);
    query.setMaxResults(limit);
  ...
  @Override public Product create(ProductType productType) {
    return (Product) entityConfiguration.createEntityInstance(productType.getType());
  }

  @Override public List<ProductBundle> readAutomaticProductBundles() {
    Date currentDate = DateUtil.getCurrentDateAfterFactoringInDateResolution(cachedDate, getCurrentDateResolution());
  ...
  @Override public List<Product> findProductByURI(String uri) {
    ...
    query.setHint(QueryHints.HINT_CACHEABLE, true);
    query.setHint(QueryHints.HINT_CACHE_REGION, "query.Catalog");
    @SuppressWarnings(value = { "unchecked" }) List<Product> results = query.getResultList();
    return results;
  }

  @Override public List<Product> readAllActiveProducts(int page, int pageSize) {
    Date currentDate = DateUtil.getCurrentDateAfterFactoringInDateResolution(cachedDate, getCurrentDateResolution());
    return readAllActiveProductsInternal(page, pageSize, currentDate);
  }

  @Override public List<Product> readAllActiveProducts(Integer pageSize, Long lastId) {
    Date currentDate = DateUtil.getCurrentDateAfterFactoringInDateResolution(cachedDate, getCurrentDateResolution());
    return readAllActiveProductsInternal(pageSize, currentDate, lastId);
  }

  @Override @Deprecated public List<Product> readAllActiveProducts(int page, int pageSize, Date currentDate) {
    return readAllActiveProductsInternal(page, pageSize, currentDate);
  }

  @Override public List<Product> readAllActiveProductsForSiteMap(int page, int pageSize) {
    Date currentDate = DateUtil.getCurrentDateAfterFactoringInDateResolution(cachedDate, getCurrentDateResolution());
  ...
  @Override public List<Long> readAllActiveProductIds(Long lastId, int pageSize) {
    Date currentDate = DateUtil.getCurrentDateAfterFactoringInDateResolution(cachedDate, getCurrentDateResolution());
  ...
  @Override public List<Product> readAllActiveProducts() {
    Date currentDate = DateUtil.getCurrentDateAfterFactoringInDateResolution(cachedDate, getCurrentDateResolution());
    return readAllActiveProductsInternal(currentDate);
  }

  @Override @Deprecated public List<Product> readAllActiveProducts(Date currentDate) {
    return readAllActiveProductsInternal(currentDate);
  }
  ...
  @Override public Long readCountAllActiveProducts() {
    Date currentDate = DateUtil.getCurrentDateAfterFactoringInDateResolution(cachedDate, getCurrentDateResolution());
    return readCountAllActiveProductsInternal(currentDate);
  }

  @Override @Deprecated public Long readCountAllActiveProducts(Date currentDate) {
    return readCountAllActiveProductsInternal(currentDate);
  }
