 ...
 */
@Entity @Inheritance(strategy = InheritanceType.JOINED) @javax.persistence.Table(name = "BLC_PRODUCT") @org.hibernate.annotations.Table(appliesTo = "BLC_PRODUCT", indexes = { @Index(name = "PRODUCT_URL_INDEX", columnNames = { "URL", "URL_KEY" }), @Index(name = "PRODUCT_URL_KEY_INDEX", columnNames = { "URL_KEY" }) }) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProducts") @AdminPresentationMergeOverrides(value = { @AdminPresentationMergeOverride(name = "defaultSku.displayTemplate", mergeEntries = @AdminPresentationMergeEntry(propertyType = PropertyType.AdminPresentation.EXCLUDED, booleanOverrideValue = true)), @AdminPresentationMergeOverride(name = "defaultSku.urlKey", mergeEntries = @AdminPresentationMergeEntry(propertyType = PropertyType.AdminPresentation.EXCLUDED, booleanOverrideValue = true)), @AdminPresentationMergeOverride(name = "defaultSku.retailPrice", mergeEntries = @AdminPresentationMergeEntry(propertyType = PropertyType.AdminPresentation.REQUIREDOVERRIDE, overrideValue = "REQUIRED")), @AdminPresentationMergeOverride(name = "defaultSku.name", mergeEntries = @AdminPresentationMergeEntry(propertyType = PropertyType.AdminPresentation.REQUIREDOVERRIDE, overrideValue = "REQUIRED")), @AdminPresentationMergeOverride(name = "defaultSku.activeEndDate", mergeEntries = @AdminPresentationMergeEntry(propertyType = PropertyType.AdminPresentation.VALIDATIONCONFIGURATIONS, validationConfigurations = { @ValidationConfiguration(validationImplementation = "blAfterStartDateValidator", configurationItems = { @ConfigurationItem(itemName = "otherField", itemValue = "defaultSku.activeStartDate") }) })), @AdminPresentationMergeOverride(name = "defaultSku.auditable.createdBy", mergeEntries = @AdminPresentationMergeEntry(propertyType = PropertyType.AdminPresentation.EXCLUDED, booleanOverrideValue = true)), @AdminPresentationMergeOverride(name = "defaultSku.auditable.dateCreated", mergeEntries = @AdminPresentationMergeEntry(propertyType = PropertyType.AdminPresentation.EXCLUDED, booleanOverrideValue = true)), @AdminPresentationMergeOverride(name = "defaultSku.auditable.dateUpdated", mergeEntries = @AdminPresentationMergeEntry(propertyType = PropertyType.AdminPresentation.EXCLUDED, booleanOverrideValue = true)), @AdminPresentationMergeOverride(name = "defaultSku.auditable.updatedBy", mergeEntries = @AdminPresentationMergeEntry(propertyType = PropertyType.AdminPresentation.EXCLUDED, booleanOverrideValue = true)) }) @DirectCopyTransform(value = { @DirectCopyTransformMember(templateTokens = DirectCopyTransformTypes.SANDBOX, skipOverlaps = true), @DirectCopyTransformMember(templateTokens = DirectCopyTransformTypes.MULTITENANT_CATALOG) }) public class ProductImpl implements Product, ProductAdminPresentation, Status, AdminMainEntity, Locatable, TemplatePathContainer {
  ...
  /**
     * The id.
     */
  @Id @GeneratedValue(generator = "ProductId") @GenericGenerator(name = "ProductId", strategy = "org.broadleafcommerce.common.persistence.IdOverrideTableGenerator", parameters = { @Parameter(name = "segment_value", value = "ProductImpl"), @Parameter(name = "entity_name", value = "org.broadleafcommerce.core.catalog.domain.ProductImpl") }) @Column(name = "PRODUCT_ID") @AdminPresentation(friendlyName = "ProductImpl_Product_ID", visibility = VisibilityEnum.HIDDEN_ALL) protected Long id;

  @Column(name = "URL") @AdminPresentation(friendlyName = "ProductImpl_Product_Url", group = GroupName.General, order = FieldOrder.URL, prominent = true, gridOrder = 3, columnWidth = "260px", requiredOverride = RequiredOverride.REQUIRED, validationConfigurations = { @ValidationConfiguration(validationImplementation = "blUriPropertyValidator"), @ValidationConfiguration(validationImplementation = "blUniqueValueValidator", configurationItems = { @ConfigurationItem(itemName = ConfigurationItem.ERROR_MESSAGE, itemValue = "This URL is already in use. Please provide a unique URL.") }) }) protected String url;

  @Column(name = "OVERRIDE_GENERATED_URL") @AdminPresentation(friendlyName = "ProductImpl_Override_Generated_Url", group = GroupName.General, order = FieldOrder.URL + 10, defaultValue = "false") protected Boolean overrideGeneratedUrl = false;

  @Column(name = "URL_KEY") @AdminPresentation(friendlyName = "ProductImpl_Product_UrlKey", group = GroupName.Advanced, excluded = true) protected String urlKey;

  @Column(name = "DISPLAY_TEMPLATE") @AdminPresentation(friendlyName = "ProductImpl_Product_Display_Template", group = GroupName.Advanced) protected String displayTemplate;

  @Column(name = "MODEL") @AdminPresentation(friendlyName = "ProductImpl_Product_Model", excluded = true) protected String model;

  @Column(name = "MANUFACTURE") @AdminPresentation(friendlyName = "ProductImpl_Product_Manufacturer", group = GroupName.General, order = FieldOrder.MANUFACTURER, prominent = true, gridOrder = 4) protected String manufacturer;

  @Deprecated @Column(name = "IS_FEATURED_PRODUCT", nullable = false) protected Boolean isFeaturedProduct = false;

  @OneToOne(targetEntity = SkuImpl.class, cascade = { CascadeType.ALL }) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProducts") @Cascade(value = { org.hibernate.annotations.CascadeType.ALL }) @JoinColumn(name = "DEFAULT_SKU_ID") @ClonePolicy(toOneProperty = "defaultProduct") protected Sku defaultSku;

  @Column(name = "CAN_SELL_WITHOUT_OPTIONS") @AdminPresentation(friendlyName = "ProductImpl_Can_Sell_Without_Options", group = GroupName.ProductOptionsAdvanced, tooltip = "ProductImpl_Can_Sell_Without_Options_Tooltip", defaultValue = "false") protected Boolean canSellWithoutOptions = false;

  @Column(name = "META_TITLE") @AdminPresentation(friendlyName = "ProductImpl_MetaTitle", group = GroupName.Miscellaneous, order = 4000, tooltip = "ProductImpl_MetaTitle_Tooltip") protected String metaTitle;

  @Column(name = "META_DESC") @AdminPresentation(friendlyName = "ProductImpl_MetaDescription", group = GroupName.Miscellaneous, order = 5000, tooltip = "ProductImpl_MetaDescription_Tooltip") protected String metaDescription;

  @Column(name = "CANONICAL_URL") @AdminPresentation(friendlyName = "ProductImpl_Canonical_Url", group = GroupName.Miscellaneous, order = 6000, tooltip = "ProductImpl_Canonical_Url_Tooltip") protected String canonicalUrl;

  @Transient protected List<Sku> skus = new ArrayList<Sku>();

  @Transient protected String promoMessage;

  @OneToMany(mappedBy = "product", targetEntity = CrossSaleProductImpl.class, cascade = { CascadeType.ALL }) @Cascade(value = { org.hibernate.annotations.CascadeType.ALL, org.hibernate.annotations.CascadeType.DELETE_ORPHAN }) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blRelatedProducts") @OrderBy(value = "sequence") @AdminPresentationAdornedTargetCollection(friendlyName = "crossSaleProductsTitle", tab = TabName.Marketing, order = 1000, targetObjectProperty = "relatedSaleProduct", sortProperty = "sequence", customCriteria = { "crossSaleProduct" }, maintainedAdornedTargetFields = { "promotionMessage" }, gridVisibleFields = { "defaultSku.name", "promotionMessage" }) protected List<RelatedProduct> crossSaleProducts = new ArrayList<RelatedProduct>();

  @OneToMany(mappedBy = "product", targetEntity = UpSaleProductImpl.class, cascade = { CascadeType.ALL }) @Cascade(value = { org.hibernate.annotations.CascadeType.ALL, org.hibernate.annotations.CascadeType.DELETE_ORPHAN }) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blRelatedProducts") @OrderBy(value = "sequence") @AdminPresentationAdornedTargetCollection(friendlyName = "upsaleProductsTitle", tab = TabName.Marketing, order = 2000, targetObjectProperty = "relatedSaleProduct", sortProperty = "sequence", customCriteria = { "upsaleProduct" }, maintainedAdornedTargetFields = { "promotionMessage" }, gridVisibleFields = { "defaultSku.name", "promotionMessage" }) protected List<RelatedProduct> upSaleProducts = new ArrayList<RelatedProduct>();

  @OneToMany(fetch = FetchType.LAZY, targetEntity = SkuImpl.class, mappedBy = "product", cascade = CascadeType.ALL) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProducts") @BatchSize(size = 50) @AdminPresentationCollection(friendlyName = "ProductImpl_Additional_Skus", tab = TabName.ProductOptions, order = 1000) protected List<Sku> additionalSkus = new ArrayList<Sku>();

  @ManyToOne(targetEntity = CategoryImpl.class) @JoinColumn(name = "DEFAULT_CATEGORY_ID") @Index(name = "PRODUCT_CATEGORY_INDEX", columnNames = { "DEFAULT_CATEGORY_ID" }) @AdminPresentation(friendlyName = "ProductImpl_Product_Default_Category", order = FieldOrder.DEFAULT_CATEGORY, group = GroupName.General, prominent = true, gridOrder = 2, requiredOverride = RequiredOverride.REQUIRED) @AdminPresentationToOneLookup @Deprecated protected Category defaultCategory;

  @OneToMany(targetEntity = CategoryProductXrefImpl.class, mappedBy = "product", cascade = { CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH }) @OrderBy(value = "displayOrder") @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blCategoryProduct") @BatchSize(size = 50) @AdminPresentationAdornedTargetCollection(friendlyName = "allParentCategoriesTitle", tab = TabName.Marketing, order = 3000, targetObjectProperty = "category", parentObjectProperty = "product", gridVisibleFields = { "name" }) protected List<CategoryProductXref> allParentCategoryXrefs = new ArrayList<CategoryProductXref>();

  @OneToMany(mappedBy = "product", targetEntity = ProductAttributeImpl.class, cascade = { CascadeType.ALL }) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProductAttributes") @BatchSize(size = 50) @AdminPresentationCollection(friendlyName = "productAttributesTitle", tab = TabName.General, order = 6000) protected List<ProductAttribute> productAttributes = new ArrayList<ProductAttribute>();

  @OneToMany(targetEntity = ProductOptionXrefImpl.class, mappedBy = "product", cascade = { CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH }) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProductOptions") @BatchSize(size = 50) @AdminPresentationAdornedTargetCollection(friendlyName = "productOptionsTitle", tab = TabName.ProductOptions, joinEntityClass = "org.broadleafcommerce.core.catalog.domain.ProductOptionXrefImpl", targetObjectProperty = "productOption", parentObjectProperty = "product", gridVisibleFields = { "name", "type", "required" }) protected List<ProductOptionXref> productOptions = new ArrayList<ProductOptionXref>();

  @Column(name = "ENABLE_DEFAULT_SKU_IN_INVENTORY") @AdminPresentation(friendlyName = "ProductImpl_enableDefaultSkuInInventory", group = GroupName.Miscellaneous, order = 7000, tooltip = "ProductImpl_enableDefaultSkuInInventory_Tooltip", defaultValue = "false") protected Boolean enableDefaultSkuInventory = false;

  @Transient protected Map<String, Set<String>> productOptionMap;

  @Transient protected List<String> allParentCategoryIds;

  @Embedded protected ArchiveStatus archiveStatus = new ArchiveStatus();

  @Override public Boolean getEnableDefaultSkuInInventory() {
    return this.enableDefaultSkuInventory == null ? false : this.enableDefaultSkuInventory;
  }

  @Override public void setEnableDefaultSkuInInventory(Boolean enableDefaultSkuInventory) {
  ...
  @Deprecated @Override public boolean isFeaturedProduct() {
    return isFeaturedProduct;
  }

  @Deprecated @Override public void setFeaturedProduct(boolean isFeaturedProduct) {
  ...
  @Override public void setCanonicalUrl(String canonicalUrl) {
  ...
  @Override public List<Sku> getAllSellableSkus() {
  ...
  @Override @Deprecated public List<Sku> getSkus() {
    if (skus.size() == 0) {
  ...
  @Override @Deprecated public void setAdditionalSkus(List<Sku> skus) {
  ...
  @Override @Deprecated public Category getDefaultCategory() {
    Category response;
  ...
  @Override @Deprecated public void setDefaultCategory(Category defaultCategory) {
  ...
  @Override public List<Long> getParentCategoryHierarchyIds() {
  ...
  @Override public List<String> getAllParentCategoryIds() {
  ...
  @Override @Deprecated public Map<String, ProductAttribute> getProductAttributes() {
  ...
  @Override public Map<String, ProductAttribute> getMultiValueProductAttributes() {
  ...
  @Override public List<ProductOptionXref> getProductOptionXrefs() {
  ...
  @Override public void setProductOptionXrefs(List<ProductOptionXref> productOptions) {
  ...
  @Override public Map<String, Set<String>> getProductOptionValuesMap() {
  ...
  @Override public <G extends Product> CreateResponse<G> createOrRetrieveCopyInstance(MultiTenantCopyContext context) throws CloneNotSupportedException {
