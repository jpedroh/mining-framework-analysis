...
public interface Product extends Serializable, MultiTenantCloneable<Product>, Indexable {
  ...
  /**
     ...
     */
  @Deprecated public boolean isFeaturedProduct();

  /**
     * Sets whether or not the product is featured
     * @param isFeaturedProduct
     */
  @Deprecated public void setFeaturedProduct(boolean isFeaturedProduct);
  ...
  /**
     ...
     */
  @Deprecated public List<ProductOption> getProductOptions();
  ...
  /**
     ...
     */
  @Deprecated public void setProductOptions(List<ProductOption> productOptions);
