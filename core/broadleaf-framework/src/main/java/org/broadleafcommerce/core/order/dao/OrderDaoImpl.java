...
@Repository(value = "blOrderDao") public class OrderDaoImpl implements OrderDao {
  ...
  @Resource(name = "blOrderDaoExtensionManager") protected OrderDaoExtensionManager extensionManager;
  ...
  @Override public Order readOrderByIdIgnoreCache(final Long orderId) {
  ...
  @Override public Order readOrderByExternalId(String orderExternalId) {
    TypedQuery<Order> query = new TypedQueryBuilder<Order>(Order.class, "ord").addRestriction("ord.embeddedOmsOrder.externalId", "=", orderExternalId).toQuery(em);
    try {
  ...
  @Override @Transactional(value = "blTransactionManager") public Order readOrderById(final Long orderId, boolean refresh) {
  ...
  @Override public List<Order> readOrdersByIds(List<Long> orderIds) {
  ...
  @Override public List<Order> readBatchOrders(int start, int pageSize, List<OrderStatus> statuses) {
    CriteriaBuilder builder = em.getCriteriaBuilder();
    CriteriaQuery<Order> criteria = builder.createQuery(Order.class);
    Root<OrderImpl> order = criteria.from(OrderImpl.class);
    criteria.select(order);
  ...
  @Override public List<Order> readBatchOrdersFromLastID(Long lastID, int pageSize, List<OrderStatus> statuses) {
    CriteriaBuilder builder = em.getCriteriaBuilder();
    CriteriaQuery<Order> criteria = builder.createQuery(Order.class);
    Root<OrderImpl> order = criteria.from(OrderImpl.class);
    criteria.select(order);
  ...
  @Override @SuppressWarnings(value = { "unchecked" }) public List<Order> readOrdersForCustomer(final Customer customer, final OrderStatus orderStatus) {
    if (orderStatus == null) {
  ...
  @Override @SuppressWarnings(value = { "unchecked" }) public List<Order> readOrdersForCustomer(final Long customerId) {
  ...
  @Override public Order readCartForCustomer(final Customer customer) {
    ...
    query.setHint(QueryHints.HINT_CACHEABLE, true);
    query.setHint(QueryHints.HINT_CACHE_REGION, "query.Order");
    @SuppressWarnings(value = { "rawtypes" }) final List temp = query.getResultList();
  ...
  @Override @SuppressWarnings(value = { "unchecked" }) public Order readNamedOrderForCustomer(final Customer customer, final String name) {
  ...
  @Override @SuppressWarnings(value = { "unchecked" }) public Order readOrderByOrderNumber(final String orderNumber) {
  ...
  @Override public List<Order> readOrdersByDateRange(final Date startDate, final Date endDate) {
    CriteriaBuilder builder = em.getCriteriaBuilder();
    CriteriaQuery<Order> criteria = builder.createQuery(Order.class);
    Root<OrderImpl> order = criteria.from(OrderImpl.class);
    criteria.select(order);
  ...
  @Override public List<Order> readOrdersOlderThanDaysCount(final Integer daysCount, final Integer batchSize) {
  ...
  @Override public List<Order> readOrdersForCustomersInDateRange(List<Long> customerIds, Date startDate, Date endDate) {
    CriteriaBuilder builder = em.getCriteriaBuilder();
    CriteriaQuery<Order> criteria = builder.createQuery(Order.class);
    Root<OrderImpl> order = criteria.from(OrderImpl.class);
    criteria.select(order);
  ...
  @Override @Transactional(value = "blTransactionManager") public Order updatePrices(Order order) {
  ...
  @Override public boolean acquireLock(Order order) {
  ...
  @Override public boolean releaseLock(final Order order) {
  ...
  @Override public List<Order> readOrdersByEmail(String email) {
