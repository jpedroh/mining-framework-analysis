 ...
 */
@Service(value = "blOfferService") public class OfferServiceImpl implements OfferService {
  private static final Log LOG = LogFactory.getLog(OfferServiceImpl.class);

  @Resource(name = "blCustomerOfferDao") protected CustomerOfferDao customerOfferDao;

  @Resource(name = "blOfferCodeDao") protected OfferCodeDao offerCodeDao;
  ...
  @Resource(name = "blOrderOfferProcessor") protected OrderOfferProcessor orderOfferProcessor;

  @Resource(name = "blItemOfferProcessor") protected ItemOfferProcessor itemOfferProcessor;

  @Resource(name = "blFulfillmentGroupOfferProcessor") protected FulfillmentGroupOfferProcessor fulfillmentGroupOfferProcessor;
  ...
  @Resource(name = "blStreamingTransactionCapableUtil") protected StreamingTransactionCapableUtil transUtil;
  ...
  /**
     ...
     */
  @Deprecated protected EntityDuplicateModifier<Offer> offerDuplicateModifier;

  @Override public List<Offer> findAllOffers() {
    return offerDao.readAllOffers();
  }

  @Override @Transactional(value = "blTransactionManager") public Offer save(Offer offer) {
    return offerDao.save(offer);
  }

  @Override @Transactional(value = "blTransactionManager") public OfferCode saveOfferCode(OfferCode offerCode) {
  ...
  @Override public List<Offer> lookupAllOffersByCode(String code) {
  ...
  @Override public List<OfferCode> lookupAllOfferCodesByCode(String code) {
  ...
  @Override public List<OfferCode> buildOfferCodeListForCustomer(Order order) {
  ...
  @Deprecated @Override public List<OfferCode> buildOfferCodeListForCustomer(Customer customer) {
  ...
  @Override @Transactional(value = "blTransactionManager") public Order applyAndSaveOffersToOrder(List<Offer> offers, Order order) throws PricingException {
  ...
  @Override @Transactional(value = "blTransactionManager") @Deprecated public void applyOffersToOrder(List<Offer> offers, Order order) throws PricingException {
    applyAndSaveOffersToOrder(offers, order);
  }

  @Override @Transactional(value = "blTransactionManager") @Deprecated public void applyFulfillmentGroupOffersToOrder(List<Offer> offers, Order order) throws PricingException {
    applyAndSaveFulfillmentGroupOffersToOrder(offers, order);
  }

  @Override @Transactional(value = "blTransactionManager") public Order applyAndSaveFulfillmentGroupOffersToOrder(List<Offer> offers, Order order) throws PricingException {
    OfferContext offerContext = OfferContext.getOfferContext();
    if (offerContext == null || offerContext.executePromotionCalculation) {
  ...
  @Override public boolean verifyMaxCustomerUsageThreshold(Order order, Offer offer) {
  ...
  @Deprecated @Override public boolean verifyMaxCustomerUsageThreshold(Customer customer, Offer offer) {
    if (offer.isLimitedUsePerCustomer()) {
  ...
  @Override public boolean verifyMaxCustomerUsageThreshold(Order order, OfferCode code) {
  ...
  @Deprecated @Override public boolean verifyMaxCustomerUsageThreshold(Customer customer, OfferCode code) {
    boolean underCodeMaxUses = true;
    if (code.isLimitedUse()) {
  ...
  @Override @SuppressWarnings(value = { "unchecked" }) public Set<Offer> getUniqueOffersFromOrder(Order order) {
  ...
  @Override public Map<Offer, OfferCode> getOffersRetrievedFromCodes(Order order) {
    return getOffersRetrievedFromCodes(order.getAddedOfferCodes(), getUniqueOffersFromOrder(order));
  }

  @Override public Map<Offer, OfferCode> getOffersRetrievedFromCodes(List<OfferCode> codes, Set<Offer> appliedOffers) {
  ...
  @Override @Transactional(value = "blTransactionManager") public Boolean deleteOfferCode(OfferCode code) {
  ...
  @Transactional(value = "blTransactionManager") @Override public Offer duplicate(Long originalOfferId) {
  ...
  @Override public void setFulfillmentGroupOfferProcessor(FulfillmentGroupOfferProcessor fulfillmentGroupOfferProcessor) {
  ...
  @Override public List<OfferCode> findOfferCodesByIds(Collection<Long> ids) {
  ...
  @Override public Offer findOfferById(Long offerId) {
