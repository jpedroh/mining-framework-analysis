 ...
 */
@AdminPresentationClass(populateToOneFields = PopulateToOneFieldsEnum.TRUE, friendlyName = "OfferImpl_baseOffer", tabs = { @AdminTabPresentation(name = OfferAdminPresentation.TabName.General, order = OfferAdminPresentation.TabOrder.General, groups = { @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.Description, order = OfferAdminPresentation.GroupOrder.Description, untitled = true), @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.RuleConfiguration, order = OfferAdminPresentation.GroupOrder.RuleConfiguration, untitled = true), @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.ActivityRange, order = OfferAdminPresentation.GroupOrder.ActivityRange, column = 1), @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.Customer, order = OfferAdminPresentation.GroupOrder.Customer, column = 1), @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.CombineStack, order = OfferAdminPresentation.GroupOrder.CombineStack, column = 1, collapsed = true), @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.Restrictions, order = OfferAdminPresentation.GroupOrder.Restrictions, column = 1, collapsed = true) }), @AdminTabPresentation(name = OfferAdminPresentation.TabName.Qualifiers, order = OfferAdminPresentation.TabOrder.Qualifiers, groups = { @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.ShouldBeRelated, order = OfferAdminPresentation.GroupOrder.ShouldBeRelated, column = 1, untitled = true), @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.QualifierRuleRestriction, order = OfferAdminPresentation.GroupOrder.QualifierRuleRestriction, column = 1), @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.TargetRuleRestriction, order = OfferAdminPresentation.GroupOrder.TargetRuleRestriction, column = 1) }), @AdminTabPresentation(name = OfferAdminPresentation.TabName.Marketing, order = OfferAdminPresentation.TabOrder.Marketing, groups = { @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.Marketing, order = OfferAdminPresentation.GroupOrder.Marketing, untitled = true) }), @AdminTabPresentation(name = OfferAdminPresentation.TabName.Codes, order = OfferAdminPresentation.TabOrder.Codes, groups = { @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.Codes, order = OfferAdminPresentation.GroupOrder.Codes, untitled = true) }), @AdminTabPresentation(name = OfferAdminPresentation.TabName.Advanced, order = OfferAdminPresentation.TabOrder.Advanced, groups = { @AdminGroupPresentation(name = OfferAdminPresentation.GroupName.Advanced, order = OfferAdminPresentation.GroupOrder.Advanced, untitled = true) }) }) public interface OfferAdminPresentation {
