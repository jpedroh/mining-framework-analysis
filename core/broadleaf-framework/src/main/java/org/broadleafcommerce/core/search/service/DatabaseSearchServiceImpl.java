 ...
 */
@Deprecated @Service(value = "blSearchService") public class DatabaseSearchServiceImpl implements SearchService {
  ...
  @Resource(name = "blFieldDao") protected FieldDao fieldDao;
  ...
  @Override public SearchResult findExplicitSearchResultsByCategory(Category category, SearchCriteria searchCriteria) throws ServiceException {
    throw new UnsupportedOperationException("See findProductsByCategory or use the SolrSearchService implementation");
  }

  @Override public SearchResult findSearchResultsByCategoryAndQuery(Category category, String query, SearchCriteria searchCriteria) throws ServiceException {
    throw new UnsupportedOperationException("This operation is only supported by the SolrSearchService by default");
  }

  @Override public SearchResult findSearchResultsByCategory(Category category, SearchCriteria searchCriteria) {
  ...
  @Override public SearchResult findSearchResultsByQuery(String query, SearchCriteria searchCriteria) {
    SearchResult result = new SearchResult();
    setQualifiedKeys(searchCriteria);
  ...
  @Override public SearchResult findSearchResults(SearchCriteria searchCriteria) throws ServiceException {
    return findSearchResultsByQuery(searchCriteria.getQuery(), searchCriteria);
  }

  @Override public List<SearchFacetDTO> getSearchFacets() {
  ...
  @Override public List<SearchFacetDTO> getSearchFacets(Category category) {
    return getSearchFacets();
  }

  @Override public List<SearchFacetDTO> getCategoryFacets(Category category) {
