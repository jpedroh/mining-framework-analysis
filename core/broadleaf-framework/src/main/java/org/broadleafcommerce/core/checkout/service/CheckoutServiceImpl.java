...
@Service(value = "blCheckoutService") public class CheckoutServiceImpl implements CheckoutService {
  @Resource(name = "blCheckoutWorkflow") protected Processor<CheckoutSeed, CheckoutSeed> checkoutWorkflow;
  ...
  /**
     ...
     */
  @Deprecated protected static ConcurrentMap<Long, Object> lockMap = new ConcurrentHashMap<>();

  @Override public CheckoutResponse performCheckout(Order order) throws CheckoutException {
  ...
  /**
     * @deprecated no longer supported - simplifying interface
     */
  @Deprecated protected Object putLock(Long orderId) {
