...
public interface ProductDao {
  /**
     ...
     */
  @Nonnull public Product readProductById(@Nonnull Long productId);
  ...
  /**
     ...
     */
  @Nonnull public Product save(@Nonnull Product product);
  ...
  /**
     ...
     */
  @Nonnull public List<Product> readProductsByName(@Nonnull String searchName);
  ...
  /**
     ...
     */
  @Nonnull public List<Product> readProductsByName(@Nonnull String searchName, @Nonnull int limit, @Nonnull int offset);
  ...
  /**
     ...
     */
  @Nonnull public List<Product> readFilteredActiveProductsByCategory(Long categoryId, SearchCriteria searchCriteria);
  ...
  /**
     ...
     * @return the matching products
     */
  @Nonnull public List<Product> readFilteredActiveProductsByQuery(String query, SearchCriteria searchCriteria);
  ...
  /**
     ...
     * @return the matching products
     */
  @Deprecated @Nonnull public List<Product> readFilteredActiveProductsByCategory(Long categoryId, Date currentDate, SearchCriteria searchCriteria);
  ...
  /**
     ...
     * @return the list of products qualified for the category and date
     */
  @Deprecated @Nonnull public List<Product> readActiveProductsByCategory(@Nonnull Long categoryId, @Nonnull Date currentDate);
  ...
  /**
     ...
     * @return the matching products
     */
  @Deprecated @Nonnull public List<Product> readFilteredActiveProductsByQuery(String query, Date currentDate, SearchCriteria searchCriteria);

  /**
     * @deprecated Use {@link #readActiveProductsByCategory(Long)}
     */
  @Deprecated @Nonnull public List<Product> readActiveProductsByCategory(@Nonnull Long categoryId, @Nonnull Date currentDate, @Nonnull int limit, @Nonnull int offset);
  ...
  /**
     ...
     */
  @Nonnull public List<Product> readProductsByCategory(@Nonnull Long categoryId);
  ...
  /**
     ...
     * @return the list of products qualified for the category
     */
  @Nonnull public List<Product> readProductsByCategory(@Nonnull Long categoryId, @Nonnull int limit, @Nonnull int offset);
  ...
  /**
     ...
     * @return a list of all active products
     */
  @Deprecated public List<Product> readAllActiveProducts(@Nonnull Date currentDate);
