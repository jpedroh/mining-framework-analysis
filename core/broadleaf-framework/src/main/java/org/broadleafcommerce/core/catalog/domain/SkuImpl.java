 ...
 * @see {@link Sku}
 */
@Entity @Inheritance(strategy = InheritanceType.JOINED) @Table(name = "BLC_SKU") @org.hibernate.annotations.Table(appliesTo = "BLC_SKU", indexes = { @Index(name = "SKU_URL_KEY_INDEX", columnNames = { "URL_KEY" }) }) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProducts") @DirectCopyTransform(value = { @DirectCopyTransformMember(templateTokens = DirectCopyTransformTypes.SANDBOX, skipOverlaps = true), @DirectCopyTransformMember(templateTokens = DirectCopyTransformTypes.MULTITENANT_CATALOG) }) public class SkuImpl implements Sku, SkuAdminPresentation {
  private static final Log LOG = LogFactory.getLog(SkuImpl.class);

  private static final long serialVersionUID = 1L;

  @Id @GeneratedValue(generator = "SkuId") @GenericGenerator(name = "SkuId", strategy = "org.broadleafcommerce.common.persistence.IdOverrideTableGenerator", parameters = { @Parameter(name = "segment_value", value = "SkuImpl"), @Parameter(name = "entity_name", value = "org.broadleafcommerce.core.catalog.domain.SkuImpl") }) @Column(name = "SKU_ID") @AdminPresentation(friendlyName = "SkuImpl_Sku_ID", visibility = VisibilityEnum.HIDDEN_ALL) protected Long id;

  @Column(name = "EXTERNAL_ID") @Index(name = "SKU_EXTERNAL_ID_INDEX", columnNames = { "EXTERNAL_ID" }) @AdminPresentation(friendlyName = "SkuImpl_Sku_ExternalID", group = GroupName.Miscellaneous, order = FieldOrder.EXTERNAL_ID, tooltip = "SkuImpl_Sku_ExternalID_Tooltip") protected String externalId;

  @Column(name = "URL_KEY") @AdminPresentation(friendlyName = "SkuImpl_Sku_UrlKey", group = GroupName.Advanced, order = 4000, excluded = true) protected String urlKey;

  @Column(name = "DISPLAY_TEMPLATE") @AdminPresentation(friendlyName = "SkuImpl_Sku_Display_Template", group = GroupName.Advanced, order = 5000, excluded = true) protected String displayTemplate;

  @Column(name = "UPC") @Index(name = "SKU_UPC_INDEX", columnNames = { "UPC" }) @AdminPresentation(friendlyName = "SkuImpl_Sku_UPC", group = GroupName.Miscellaneous, order = FieldOrder.UPC) protected String upc;

  @Column(name = "SALE_PRICE", precision = 19, scale = 5) @AdminPresentation(friendlyName = "SkuImpl_Sku_Sale_Price", group = GroupName.Price, order = FieldOrder.SALE_PRICE, tooltip = "SkuImpl_Sku_Sale_Price_tooltip", prominent = true, gridOrder = 6, fieldType = SupportedFieldType.MONEY) protected BigDecimal salePrice;

  @Column(name = "RETAIL_PRICE", precision = 19, scale = 5) @AdminPresentation(friendlyName = "SkuImpl_Sku_Retail_Price", group = GroupName.Price, order = FieldOrder.RETAIL_PRICE, prominent = true, gridOrder = 5, fieldType = SupportedFieldType.MONEY) protected BigDecimal retailPrice;

  @Column(name = "COST", precision = 19, scale = 5) @AdminPresentation(friendlyName = "SkuImpl_Sku_Cost", group = GroupName.Price, order = FieldOrder.COST, fieldType = SupportedFieldType.MONEY) protected BigDecimal cost;

  @Column(name = "NAME") @Index(name = "SKU_NAME_INDEX", columnNames = { "NAME" }) @AdminPresentation(friendlyName = "SkuImpl_Sku_Name", group = GroupName.General, order = FieldOrder.NAME, prominent = true, gridOrder = 1, columnWidth = "260px", translatable = true) protected String name;

  @Column(name = "DESCRIPTION") @AdminPresentation(friendlyName = "SkuImpl_Sku_Description", group = GroupName.General, order = FieldOrder.SHORT_DESCRIPTION, largeEntry = true, excluded = true, translatable = true) protected String description;

  @Lob @Type(type = "org.hibernate.type.MaterializedClobType") @Column(name = "LONG_DESCRIPTION", length = Integer.MAX_VALUE - 1) @AdminPresentation(friendlyName = "SkuImpl_Sku_Large_Description", group = GroupName.General, order = FieldOrder.LONG_DESCRIPTION, largeEntry = true, fieldType = SupportedFieldType.HTML_BASIC, translatable = true) protected String longDescription;

  @Column(name = "TAX_CODE") @AdminPresentation(friendlyName = "SkuImpl_Sku_TaxCode", order = 1001, group = GroupName.Financial) @AdminPresentationDataDrivenEnumeration(optionCanEditValues = true, optionHideIfEmpty = true, optionFilterParams = { @OptionFilterParam(param = "type.key", value = "TAX_CODE", paramType = OptionFilterParamType.STRING) }) protected String taxCode;

  @Column(name = "TAXABLE_FLAG") @Index(name = "SKU_TAXABLE_INDEX", columnNames = { "TAXABLE_FLAG" }) @AdminPresentation(friendlyName = "SkuImpl_Sku_Taxable", group = GroupName.Financial, order = FieldOrder.TAXABLE) protected Character taxable;

  @Column(name = "DISCOUNTABLE_FLAG") @Index(name = "SKU_DISCOUNTABLE_INDEX", columnNames = { "DISCOUNTABLE_FLAG" }) @AdminPresentation(friendlyName = "SkuImpl_Sku_Discountable", group = GroupName.Discountable, helpText = "SkuImpl_Sku_Discountable_helptext", defaultValue = "Y") protected Character discountable;

  @Column(name = "AVAILABLE_FLAG") @Index(name = "SKU_AVAILABLE_INDEX", columnNames = { "AVAILABLE_FLAG" }) @AdminPresentation(excluded = true) @Deprecated protected Character available;

  @Column(name = "ACTIVE_START_DATE") @Index(name = "SKU_ACTIVE_START_INDEX") @AdminPresentation(friendlyName = "SkuImpl_Sku_Start_Date", group = GroupName.ActiveDateRange, order = FieldOrder.ACTIVE_START_DATE, tooltip = "skuStartDateTooltip", defaultValue = "today") protected Date activeStartDate;

  @Column(name = "ACTIVE_END_DATE") @Index(name = "SKU_ACTIVE_END_INDEX") @AdminPresentation(friendlyName = "SkuImpl_Sku_End_Date", group = GroupName.ActiveDateRange, order = FieldOrder.ACTIVE_END_DATE, tooltip = "skuEndDateTooltip", validationConfigurations = { @ValidationConfiguration(validationImplementation = "blAfterStartDateValidator", configurationItems = { @ConfigurationItem(itemName = "otherField", itemValue = "activeStartDate") }) }) protected Date activeEndDate;

  @Embedded protected Dimension dimension = new Dimension();

  @Embedded protected Weight weight = new Weight();

  @Column(name = "IS_MACHINE_SORTABLE") @AdminPresentation(friendlyName = "ProductImpl_Is_Product_Machine_Sortable", group = GroupName.ShippingOther, order = FieldOrder.IS_MACHINE_SORTABLE, defaultValue = "false") protected Boolean isMachineSortable;

  @OneToMany(mappedBy = "sku", targetEntity = SkuMediaXrefImpl.class, cascade = { CascadeType.ALL }) @MapKey(name = "key") @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProducts") @BatchSize(size = 50) @AdminPresentationMap(friendlyName = "SkuImpl_Sku_Media", tab = TabName.Media, keyPropertyFriendlyName = "SkuImpl_Sku_Media_Key", deleteEntityUponRemove = true, mediaField = "media.url", toOneTargetProperty = "media", toOneParentProperty = "sku", forceFreeFormKeys = true) @AdminPresentationMapFields(mapDisplayFields = { @AdminPresentationMapField(fieldName = "primary", fieldPresentation = @AdminPresentation(fieldType = SupportedFieldType.MEDIA, group = GroupName.Image, order = FieldOrder.PRIMARY_MEDIA, friendlyName = "SkuImpl_Primary_Media")) }) protected Map<String, SkuMediaXref> skuMedia = new HashMap<String, SkuMediaXref>();

  @Transient protected Map<String, Media> legacySkuMedia = new HashMap<String, Media>();

  /**
     * This will be non-null if and only if this Sku is the default Sku for a Product
     */
  @OneToOne(optional = true, targetEntity = ProductImpl.class, cascade = { CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REFRESH }) @Cascade(value = { org.hibernate.annotations.CascadeType.PERSIST, org.hibernate.annotations.CascadeType.MERGE, org.hibernate.annotations.CascadeType.REFRESH }) @JoinColumn(name = "DEFAULT_PRODUCT_ID") @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProducts") @IgnoreEnterpriseBehavior protected Product defaultProduct;
  ...
  /**
     ...
     */
  @ManyToOne(optional = true, targetEntity = ProductImpl.class, cascade = { CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REFRESH }) @JoinColumn(name = "ADDL_PRODUCT_ID") protected Product product;

  @OneToMany(mappedBy = "sku", targetEntity = SkuAttributeImpl.class, cascade = { CascadeType.ALL }) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProducts") @BatchSize(size = 50) @AdminPresentationCollection(friendlyName = "skuAttributesTitle", tab = TabName.Advanced, order = 1000) protected List<SkuAttribute> skuAttributes = new ArrayList<SkuAttribute>();

  @OneToMany(targetEntity = SkuProductOptionValueXrefImpl.class, cascade = CascadeType.ALL, mappedBy = "sku") @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProducts") @BatchSize(size = 50) @ClonePolicyCollectionOverride @ClonePolicyArchive protected Set<SkuProductOptionValueXref> productOptionValueXrefs = new HashSet<SkuProductOptionValueXref>();

  @Transient protected Set<ProductOptionValue> legacyProductOptionValues = new HashSet<ProductOptionValue>();

  @ManyToMany(fetch = FetchType.LAZY, targetEntity = SkuFeeImpl.class) @JoinTable(name = "BLC_SKU_FEE_XREF", joinColumns = @JoinColumn(name = "SKU_ID", referencedColumnName = "SKU_ID", nullable = true), inverseJoinColumns = @JoinColumn(name = "SKU_FEE_ID", referencedColumnName = "SKU_FEE_ID", nullable = true)) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProducts") @BatchSize(size = 50) protected List<SkuFee> fees = new ArrayList<SkuFee>();

  @ElementCollection @CollectionTable(name = "BLC_SKU_FULFILLMENT_FLAT_RATES", joinColumns = @JoinColumn(name = "SKU_ID", referencedColumnName = "SKU_ID", nullable = true)) @MapKeyJoinColumn(name = "FULFILLMENT_OPTION_ID", referencedColumnName = "FULFILLMENT_OPTION_ID") @MapKeyClass(value = FulfillmentOptionImpl.class) @Column(name = "RATE", precision = 19, scale = 5) @Cascade(value = org.hibernate.annotations.CascadeType.ALL) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProducts") @BatchSize(size = 50) protected Map<FulfillmentOption, BigDecimal> fulfillmentFlatRates = new HashMap<FulfillmentOption, BigDecimal>();

  @ManyToMany(targetEntity = FulfillmentOptionImpl.class) @JoinTable(name = "BLC_SKU_FULFILLMENT_EXCLUDED", joinColumns = @JoinColumn(name = "SKU_ID", referencedColumnName = "SKU_ID"), inverseJoinColumns = @JoinColumn(name = "FULFILLMENT_OPTION_ID", referencedColumnName = "FULFILLMENT_OPTION_ID")) @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "blProducts") @BatchSize(size = 50) protected List<FulfillmentOption> excludedFulfillmentOptions = new ArrayList<FulfillmentOption>();

  @Column(name = "INVENTORY_TYPE") @AdminPresentation(friendlyName = "SkuImpl_Sku_InventoryType", group = GroupName.Inventory, order = 1000, helpText = "skuInventoryTypeHelpText", fieldType = SupportedFieldType.BROADLEAF_ENUMERATION, broadleafEnumeration = "org.broadleafcommerce.core.inventory.service.type.InventoryType", columnWidth = "180px", prominent = true) protected String inventoryType;

  @Column(name = "QUANTITY_AVAILABLE") @AdminPresentation(friendlyName = "SkuImpl_Sku_QuantityAvailable", group = GroupName.Inventory, order = 1010) protected Integer quantityAvailable = 0;

  @Column(name = "FULFILLMENT_TYPE") @AdminPresentation(friendlyName = "SkuImpl_Sku_FulfillmentType", group = GroupName.ShippingFulfillment, order = FieldOrder.FULFILLMENT_TYPE, fieldType = SupportedFieldType.BROADLEAF_ENUMERATION, broadleafEnumeration = "org.broadleafcommerce.core.order.service.type.FulfillmentType") protected String fulfillmentType;
  ...
  /**
     ...
     */
  @ManyToOne(targetEntity = BroadleafCurrencyImpl.class) @JoinColumn(name = "CURRENCY_CODE") @AdminPresentation(friendlyName = "SkuImpl_Currency", group = GroupName.Advanced, order = 3000, visibility = VisibilityEnum.HIDDEN_ALL) @AdminPresentationToOneLookup(lookupType = LookupType.DROPDOWN, lookupDisplayProperty = "friendlyName") protected BroadleafCurrency currency;
  ...
  @Override public boolean hasSalePrice() {
  ...
  @Override public DynamicSkuPrices getPriceData() {
    if (SkuPricingConsiderationContext.hasDynamicPricing()) {
      DynamicSkuPrices dynamicPrices = SkuPricingConsiderationContext.getDynamicSkuPrices(this);
  ...
  @Override public boolean hasRetailPrice() {
  ...
  @Override @Deprecated public Money getListPrice() {
    return getRetailPrice();
  }

  @Override @Deprecated public void setListPrice(Money listPrice) {
    this.retailPrice = Money.toAmount(listPrice);
  }

  @Override public Money getCost() {
  ...
  @Override public void setCost(Money cost) {
    this.cost = Money.toAmount(cost);
  }

  @Override public Money getMargin() {
    Money margin = null;
  ...
  @Override @Deprecated public Map<String, Media> getSkuMedia() {
  ...
  @Override @Deprecated public void setSkuMedia(Map<String, Media> skuMedia) {
    this.skuMedia.clear();
  ...
  @Override public Map<String, SkuMediaXref> getSkuMediaXref() {
  ...
  @Override public Map<String, SkuMediaXref> getSkuMediaXrefIgnoreDefaultSku() {
    Map<String, SkuMediaXref> skuMediaMap = skuMedia;
    if (isOrderedSkuMedia(skuMediaMap)) {
      skuMediaMap = sortSkuMedia(skuMediaMap);
    }
  ...
  @Override public Media getPrimarySkuMedia() {
    Map<String, SkuMediaXref> skuMediaMap = getSkuMediaXrefIgnoreDefaultSku();
    if (MapUtils.isNotEmpty(skuMediaMap)) {
      if (isOrderedSkuMedia(skuMediaMap)) {
        return skuMediaMap.values().stream().map(OrderedSkuMediaXref.class::cast).filter(OrderedSkuMediaXref::getShowInGallery).findFirst().map(SkuMediaXref.class::cast).map(SkuMediaXref::getMedia).orElse(null);
      } else {
  ...
  @Override public void setSkuMediaXref(Map<String, SkuMediaXref> skuMediaXref) {
    this.skuMedia = skuMediaXref;
  }

  protected boolean isOrderedSkuMedia(Map<String, SkuMediaXref> skuMedia) {
    return skuMedia.values().stream().anyMatch(OrderedSkuMediaXref.class::isInstance);
  }

  protected Map<String, SkuMediaXref> sortSkuMedia(Map<String, SkuMediaXref> skuMedia) {
    return skuMedia.values().stream().sorted(Comparator.comparing((xref) -> ((OrderedSkuMediaXref) xref).getDisplayOrder())).collect(Collectors.toMap(SkuMediaXref::getKey, Function.identity(), (key1, key2) -> {
      throw new IllegalStateException(String.format("Duplicate key %s", key1));
    }, LinkedHashMap::new));
  }
  ...
  @Override public Set<SkuProductOptionValueXref> getProductOptionValueXrefs() {
    return productOptionValueXrefs;
  }

  @Override public void setProductOptionValueXrefs(Set<SkuProductOptionValueXref> productOptionValueXrefs) {
    this.productOptionValueXrefs = productOptionValueXrefs;
  }

  @Override public Set<ProductOptionValue> getProductOptionValuesCollection() {
  ...
  @Override public void setProductOptionValuesCollection(Set<ProductOptionValue> productOptionValues) {
  ...
  @Override @Deprecated public void setProductOptionValues(List<ProductOptionValue> productOptionValues) {
    setProductOptionValuesCollection(new HashSet<ProductOptionValue>(productOptionValues));
  }

  @Override @Deprecated public Boolean isMachineSortable() {
  ...
  @Override @Deprecated public void setMachineSortable(Boolean isMachineSortable) {
  ...
  @Override public Integer getQuantityAvailable() {
    return quantityAvailable;
  }

  @Override public void setQuantityAvailable(Integer quantityAvailable) {
  ...
  @Override @Deprecated public Map<String, SkuAttribute> getSkuAttributes() {
  ...
  @Override @SuppressWarnings(value = { "unchecked" }) public Map<String, Collection<SkuAttribute>> getMultiValueSkuAttributes() {
  ...
  @Override public String getUpc() {
    return upc;
  }

  @Override public void setUpc(String upc) {
    this.upc = upc;
  }

  @Override public FieldEntity getFieldEntityType() {
    return FieldEntity.SKU;
  }

  @Override public <G extends Sku> CreateResponse<G> createOrRetrieveCopyInstance(MultiTenantCopyContext context) throws CloneNotSupportedException {
