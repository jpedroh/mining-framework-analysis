 ...
 */
@Service(value = "blPaymentGatewayCheckoutService") public class DefaultPaymentGatewayCheckoutService implements PaymentGatewayCheckoutService {
  ...
  @Resource(name = "blPaymentResponseDTOToEntityService") protected PaymentResponseDTOToEntityService dtoToEntityService;

  @Value(value = "${default.payment.gateway.checkout.useGatewayBillingAddress}") protected boolean useBillingAddressFromGateway = true;

  @Override public Long applyPaymentToOrder(PaymentResponseDTO responseDTO, PaymentGatewayConfiguration config) {
  ...
  @Override public void markPaymentAsInvalid(Long orderPaymentId) {
  ...
  @Override public String initiateCheckout(Long orderId) throws Exception {
  ...
  @Override public String lookupOrderNumberFromOrderId(PaymentResponseDTO responseDTO) {
