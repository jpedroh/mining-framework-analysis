...
public interface FulfillmentGroup extends Serializable, MultiTenantCloneable<FulfillmentGroup> {
  ...
  /**
     ...
     * @see {@link FulfillmentOption}
     */
  @Deprecated public void setMethod(String fulfillmentMethod);
  ...
  /**
     ...
     * @return
     */
  @Deprecated public Money getRetailShippingPrice();

  /**
     * @deprecated - use {@link #setRetailFulfillmentPrice(Money)} instead.
     * @return
     */
  @Deprecated public void setRetailShippingPrice(Money retailShippingPrice);

  /**
     * @deprecated - use {@link #getSaleFulfillmentPrice()} instead.
     * @return
     */
  @Deprecated public Money getSaleShippingPrice();

  /**
     * @deprecated - use {@link #setSaleFulfillmentPrice(Money)} instead.
     * @param saleShippingPrice
     */
  @Deprecated public void setSaleShippingPrice(Money saleShippingPrice);

  /**
     * @deprecated - use {@link #getFulfillmentPrice()} instead.
     * @return
     */
  @Deprecated public Money getShippingPrice();

  /**
     * @deprecated - use {@link #setRetailFulfillmentPrice(Money)} instead.
     * @param shippingPrice
     */
  @Deprecated public void setShippingPrice(Money shippingPrice);
