...
@Component(value = "blCompleteOrderActivity") public class CompleteOrderActivity extends BaseActivity<ProcessContext<CheckoutSeed>> {
  public static final int ORDER = 7000;

  @Autowired public CompleteOrderActivity(@Qualifier(value = "blCompleteOrderRollbackHandler") CompleteOrderRollbackHandler rollbackHandler) {
