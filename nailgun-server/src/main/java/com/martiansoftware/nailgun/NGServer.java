...
>>>>>>> /usr/src/app/output/martylamb/nailgun/5396f2f1911f43a2063bf0700ea1d7344ae2291f/nailgun-server/src/main/java/com/martiansoftware/nailgun/NGServer.java/right.java
    } catch (Throwable t) {

<<<<<<< /usr/src/app/output/martylamb/nailgun/5396f2f1911f43a2063bf0700ea1d7344ae2291f/nailgun-server/src/main/java/com/martiansoftware/nailgun/NGServer.java/left.java
...
>>>>>>> /usr/src/app/output/martylamb/nailgun/5396f2f1911f43a2063bf0700ea1d7344ae2291f/nailgun-server/src/main/java/com/martiansoftware/nailgun/NGServer.java/right.java
  ...
  public static void main(String[] args) throws NumberFormatException, UnknownHostException {
    ...
    if (args.length != 0) {
      ...
      if ("local".equals(addrPart) && portPart != null) {
        ...
        if (addrPart != null && portPart != null) {
          listeningAddress = new NGListeningAddress(InetAddress.getByName(addrPart), Integer.parseInt(portPart));
        } else {
          if (addrPart != null && portPart == null) {
            listeningAddress = new NGListeningAddress(InetAddress.getByName(addrPart), NGConstants.DEFAULT_PORT);
          } else {
  ...
  private String getStartMessage() {
    return String.format("%s %s started on %s.", new Object[] { getClass().getSimpleName(), NGConstants.VERSION, listeningAddress.toString() });
  }

  private String getStopMessage() {
    return String.format("%s %s running on %s stopped.", new Object[] { getClass().getSimpleName(), NGConstants.VERSION, listeningAddress.toString() });
  }
