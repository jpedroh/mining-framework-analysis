...
public final class FormatTools {
   ...
   */
  @Deprecated public static final String PROPERTY_FILE = null;
  ...
  public static final String[] NON_GRAPHICS_DOMAINS = new String[] { LM_DOMAIN, EM_DOMAIN, SPM_DOMAIN, SEM_DOMAIN, FLIM_DOMAIN, MEDICAL_DOMAIN, HISTOLOGY_DOMAIN, GEL_DOMAIN, ASTRONOMY_DOMAIN, HCS_DOMAIN, UNKNOWN_DOMAIN };

  /** List of non-HCS domains. */
  public static final String[] NON_HCS_DOMAINS = new String[] { LM_DOMAIN, EM_DOMAIN, SPM_DOMAIN, SEM_DOMAIN, FLIM_DOMAIN, MEDICAL_DOMAIN, HISTOLOGY_DOMAIN, GEL_DOMAIN, ASTRONOMY_DOMAIN, UNKNOWN_DOMAIN };
   ...
   * {@link #HCS_DOMAIN}.
   */
  public static final String[] NON_SPECIAL_DOMAINS = new String[] { LM_DOMAIN, EM_DOMAIN, SPM_DOMAIN, SEM_DOMAIN, FLIM_DOMAIN, MEDICAL_DOMAIN, HISTOLOGY_DOMAIN, GEL_DOMAIN, ASTRONOMY_DOMAIN, UNKNOWN_DOMAIN };

  /** List of all supported domains. */
  public static final String[] ALL_DOMAINS = new String[] { HCS_DOMAIN, LM_DOMAIN, EM_DOMAIN, SPM_DOMAIN, SEM_DOMAIN, FLIM_DOMAIN, MEDICAL_DOMAIN, HISTOLOGY_DOMAIN, GEL_DOMAIN, ASTRONOMY_DOMAIN, GRAPHICS_DOMAIN, UNKNOWN_DOMAIN };
  ...
  public static final String URL_BIO_FORMATS_LIBRARIES = "https://docs.openmicroscopy.org/bio-formats/" + VERSION + "/developers/java-library.html";
  ...
  public static int getIndex(IFormatReader reader, int z, int c, int t, int moduloZ, int moduloC, int moduloT) {
    ...
    int num = reader.getImageCount();
    return getIndex(order, zSize, cSize, tSize, moduloZSize, moduloCSize, moduloTSize, num, z, c, t, moduloZ, moduloC, moduloT);
  }
  ...
  public static int getIndex(String order, int zSize, int cSize, int tSize, int moduloZSize, int moduloCSize, int moduloTSize, int num, int z, int c, int t, int moduloZ, int moduloC, int moduloT) {
    return getIndex(order, zSize, cSize, tSize, num, (z * moduloZSize) + moduloZ, (c * moduloCSize) + moduloC, (t * moduloTSize) + moduloT);
  }
  ...
  public static int getReorderedIndex(IFormatReader reader, String newOrder, int newIndex) throws FormatException {
    ...
    int tSize = reader.getSizeT();
    int num = reader.getImageCount();
    return getReorderedIndex(origOrder, newOrder, zSize, cSize, tSize, num, newIndex);
  }
  ...
  public static int getReorderedIndex(String origOrder, String newOrder, int zSize, int cSize, int tSize, int num, int newIndex) {
    ...
    return getIndex(origOrder, zSize, cSize, tSize, num, zct[0], zct[1], zct[2]);
  }
  ...
  public static int pixelTypeFromString(String pixelTypeAsString) {
    ...
    for (int i = 0; i < pixelTypes.length; i++) {
      if (pixelTypes[i].equals(lowercaseTypeAsString)) {
        return i;
      }
    }
  ...
  public static void checkPlaneParameters(IFormatReader r, int no, int bufLength, int x, int y, int w, int h) throws FormatException {
    ...
    if (bufLength >= 0) {
      checkBufferSize(r, bufLength, w, h);
    }
  }
  ...
  public static IFormatReader getReader(IFormatReader r, Class<? extends IFormatReader> c) {
    ...
    if (underlying != null) {
      for (int i = 0; i < underlying.length; i++) {
        if (underlying[i].getClass().isInstance(c)) {
          return underlying[i];
        }
      }
      for (int i = 0; i < underlying.length; i++) {
  ...
  public static boolean equalReaders(IFormatReader a, IFormatReader b) {
    ...
    if (!a.getMetadataOptions().getMetadataLevel().equals(b.getMetadataOptions().getMetadataLevel())) {
      return false;
    }
    return true;
  }
  ...
  public static boolean isPositiveValue(Double value) {
    return (value != null && value - Constants.EPSILON > 0 && value < Double.POSITIVE_INFINITY);
  }
  ...
  public static Length getEmissionWavelength(Double value) {
    if (value != null && value - Constants.EPSILON > 0 && value < Double.POSITIVE_INFINITY) {
      return createLength(new PositiveFloat(value), UNITS.NANOMETER);
    }
    LOGGER.debug("Expected positive value for EmissionWavelength; got {}", value);
    return null;
  }
  ...
  public static Length getExcitationWavelength(Double value) {
    ...
    LOGGER.debug("Expected positive value for ExcitationWavelength; got {}", value);
    return null;
  }
  ...
  public static PositiveInteger getMaxFieldCount(Integer value) {
    ...
    LOGGER.debug("Expected positive value for MaximumFieldCount; got {}", value);
    return null;
  }
