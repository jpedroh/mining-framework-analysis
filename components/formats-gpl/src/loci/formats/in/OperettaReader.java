...
public class OperettaReader extends FormatReader {
  ...
  public OperettaReader() {
    ...
    datasetDescription = "Directory with XML file and one .tif/.tiff file per plane";
  }

  @Override public int getRequiredDirectories(String[] files) throws FormatException, IOException {
    return 1;
  }
  ...
  @Override public String[] getUsedFiles(boolean noPixels) {
      ...
      if (p != null && p.filename != null && new Location(p.filename).exists()) {
        ...
        if (reader.getSizeX() >= getSizeX() && reader.getSizeY() >= getSizeY()) {
          ...
          if (x < reader.getSizeX() && y < reader.getSizeY()) {
            ...
            byte[] realPixels = reader.openBytes(0, x, y, realWidth, realHeight);
  ...
  @Override protected void initFile(String id) throws FormatException, IOException {
    ...
    if (getMetadataOptions().getMetadataLevel() != MetadataLevel.MINIMUM) {
      ...
      for (int i = 0; i < getSeriesCount(); i++) {
        ...
        for (int c = 0; c < getSizeC(); c++) {
          ...
          if (plane != null) {
            ...
            if (plane.acqType != null) {
              store.setChannelAcquisitionMode(MetadataTools.getAcquisitionMode(plane.acqType), i, c);
            }
            if (plane.channelType != null) {
              store.setChannelContrastMethod(MetadataTools.getContrastMethod(plane.channelType), i, c);
            }
            store.setChannelColor(getColor(plane.emWavelength), i, c);
            store.setChannelEmissionWavelength(FormatTools.getEmissionWavelength(plane.emWavelength), i, c);
            store.setChannelExcitationWavelength(FormatTools.getExcitationWavelength(plane.exWavelength), i, c);
          }
        }
        Plane last = null;
        ...
        if (first != null) {
          store.setPixelsPhysicalSizeX(FormatTools.getPhysicalSizeX(first.resolutionX), i);
          store.setPixelsPhysicalSizeY(FormatTools.getPhysicalSizeY(first.resolutionY), i);
  ...
  class OperettaHandler extends BaseHandler {
    ...
    @Override public void endElement(String uri, String localName, String qName) {
      ...
      if ("User".equals(currentName)) {
        ...
        if ("InstrumentType".equals(currentName)) {
          instrumentType = value;
        } else {
          if ("PlateID".equals(currentName)) {
            plateID = value;
          } else {
            if ("MeasurementID".equals(currentName)) {
              measurementID = value;
            } else {
              if ("MeasurementStartTime".equals(currentName)) {
                measurementTime = value;
              } else {
                if ("Name".equals(currentName)) {
                  plateName = value;
                } else {
                  if ("PlateTypeName".equals(currentName)) {
                    plateDescription = value;
                  } else {
                    if ("PlateRows".equals(currentName)) {
                      plateRows = Integer.parseInt(value);
                    } else {
                      if ("PlateColumns".equals(currentName)) {
                        plateCols = Integer.parseInt(value);
                      } else {
                        if (activePlane != null || activeChannel != null) {
                          if ("ImageSizeX".equals(currentName)) {
                            ...
                            if ("ImageSizeY".equals(currentName)) {
                              ...
                              if ("ChannelName".equals(currentName)) {
                                ...
                                if ("ImageResolutionX".equals(currentName)) {
                                  ...
                                  if ("ImageResolutionY".equals(currentName)) {
                                    Double resolution = Double.parseDouble(value) * 1000000;
                                    if (activePlane != null) {
                                    ...
                                    if ("ObjectiveMagnification".equals(currentName)) {
                                      ...
                                      if ("ObjectiveNA".equals(currentName)) {
                                        ...
                                        if ("MainEmissionWavelength".equals(currentName)) {
                                          ...
                                          if ("MainExcitationWavelength".equals(currentName)) {
                                            Double wavelength = Double.parseDouble(value);
                                            if (activePlane != null) {
                                            ...
                                            if ("ExposureTime".equals(currentName)) {
                                              ...
                                              if ("AcquisitionType".equals(currentName)) {
                                                if (activePlane != null) {
                                                ...
                                                if ("ChannelType".equals(currentName)) {
                                                  if (activePlane != null) {
                                                  ...
                                                  if ("OrientationMatrix".equals(currentName)) {
  ...
  class Plane {
    ...
    public void applyMatrix() {
      if (positionX == null || positionY == null || positionZ == null || orientationMatrix == null) {
        return;
      }
      double[] v = new double[] { positionX.value().doubleValue(), positionY.value().doubleValue(), positionZ.value().doubleValue() };
  ...
  @Override protected AcquisitionMode getAcquisitionMode(String mode) throws FormatException {
    if (mode == null) {
      return null;
    }
