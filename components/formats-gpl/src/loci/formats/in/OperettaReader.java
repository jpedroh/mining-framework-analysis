        ...
        for (int c = 0; c < getSizeC(); c++) {
          ...
          if (planes[i][c] != null) {
            if (planes[i][c].acqType != null) {
              store.setChannelAcquisitionMode(MetadataTools.getAcquisitionMode(planes[i][c].acqType), i, c);
            }
            if (planes[i][c].channelType != null) {
              store.setChannelContrastMethod(MetadataTools.getContrastMethod(planes[i][c].channelType), i, c);
            }
