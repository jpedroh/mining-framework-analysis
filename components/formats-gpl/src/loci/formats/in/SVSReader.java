...
public class SVSReader extends BaseTiffReader {
  ...
  @Override public byte[] openThumbBytes(int no) throws FormatException, IOException {
        ...
        for (String line : lines) {
          ...
          for (String t : tokens) {
            if (t.indexOf('=') == -1) {
              ...
              switch (key) {
                case "MPP":
                ((SVSCoreMetadata) currentCore()).pixelSize = FormatTools.getPhysicalSizeX(DataTools.parseDouble(value));
                break;
                case "Date":
                date = value;
                break;
  ...
  @Override protected void initMetadataStore() throws FormatException {
