...
public class ClientBasicFlowsTest {
  ...
  @Test public void testSimpleRequestResponse() throws Exception {
  ...
  @Test @Ignore public void testStream() throws Exception {
  ...
  @Test public void testRequestWithBody() throws Exception {
  ...
  @Test public void testRequestWithQueryParam() throws Exception {
    dispatcher.enqueue((request) -> {
  ...
  @Test public void testRequestWithPathParam() throws Exception {
    dispatcher.enqueue((request) -> {
      return new MockResponse().setBody(request.getPath());
    });
    final HttpClient httpClient = HttpClient.createDefault();
  ...
  @Test(expected = ExecutionException.class) public void testRequestTimeout() throws Exception {
  ...
  @Test(expected = ExecutionException.class) public void testResponseMaxSize() throws Exception {
  ...
  @Test(expected = RuntimeException.class) public void testStreamWithResponseMaxSize() throws Exception {
    dispatcher.enqueue(new MockResponse().setChunkedBody("Hello World", 2));
    final HttpClient httpClient = HttpClient.createDefault();
    final String url = server.url("/stream").toString();
    final Observable<Response> responseObservable = httpClient.get(url).setResponseMaxSize(1).asStream();
  ...
  @Test public void testBasicAuth() throws Exception {
    dispatcher.enqueue((input) -> {
      ...
      final String credentials = new String(Base64.getDecoder().decode(
<<<<<<< /usr/src/app/output/outbrain/ob1k/3f7bdcaadc669ba2d14a424104ee4e09433edf88/ob1k-http/src/test/java/com/outbrain/ob1k/http/ClientBasicFlowsTest.java/left.java
      authHeader
=======
      (authHeader)
>>>>>>> /usr/src/app/output/outbrain/ob1k/3f7bdcaadc669ba2d14a424104ee4e09433edf88/ob1k-http/src/test/java/com/outbrain/ob1k/http/ClientBasicFlowsTest.java/right.java
      ));
