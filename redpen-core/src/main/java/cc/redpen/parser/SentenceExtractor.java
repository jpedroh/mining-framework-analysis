...
public final class SentenceExtractor {
  ...
  public SentenceExtractor() {
    ...
    this.fullStopPattern = Pattern.compile(this.constructEndSentencePattern());
    this.endOfSentenceDetector = new EndOfSentenceDetector(this.fullStopPattern, this.whiteWords);
  }
   ...
   */
  public SentenceExtractor(List<String> fullStopList, List<String> rightQuotationList) {
    this.fullStopList = fullStopList;
  ...
  private List<String> whiteWords = generateUmList("Mr.", "Mrs.", "Dr.", "genn.ai", "Co., Ltd.", "Miss.", "a.m.", "U.S.A.", "Jan.", "Feb.", "Mar.", "Apr.", "May.", "Jun.", "Jul.", "Aug.", "Sep.", "Oct.", "Nov.", "Dec.", "Feb.", "B.C", "A.D.");
  ...
  public String extract(String line, List<Sentence> outputSentences, int position) {
    ...
    if (periodPosition == -1) {
      ...
      while (true) {
        Sentence sentence = new Sentence(line.substring(0, periodPosition + 1), position);
  ...
  private static void generateQutotationPattern(List<String> endCharacters, StringBuilder patternString, String quotation) {
  ...
  private static void generateSimplePattern(List<String> endCharacters, StringBuilder patternString) {
    for (String endChar : endCharacters) {
  ...
  private static void appendPattern(StringBuilder patternString, String newPattern) {
  ...
  private static <E extends java.lang.Object> List<E> generateUmList(E... args) {
