...
public class DAOApplicationImpl extends AbstractDAO<ApplicationEntity, JPAApplicationEntity> implements DAOApplication {
  @Inject public DAOApplicationImpl(Provider<EntityManager> emProvider) {
    super(emProvider);
  }

  @Override protected Class<? extends JPAApplicationEntity> getEntityClass() {
    return JPAApplicationEntity.class;
  }

  @Override public ApplicationEntity getEntityInstance() {
