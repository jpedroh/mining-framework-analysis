...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "CONTEXT") public class JPAContextEntity extends JPABaseEntity implements ContextEntity {
  ...
  @ManyToOne(targetEntity = JPAContextEntity.class) @JoinColumn(name = "ID_CONTEXT_PARENT", referencedColumnName = "ID") protected Context parent;
