...
public class DAOTicketImpl extends AbstractDAO<TicketEntity, JPATicketEntity> implements DAOTicket {
  @Inject public DAOTicketImpl(Provider<EntityManager> emProvider) {
    super(emProvider);
  }

  @Override protected Class<? extends JPATicketEntity> getEntityClass() {
    return JPATicketEntity.class;
  }

  @Override public TicketEntity getEntityInstance() {
    return new JPATicketEntity();
  }

  @Override public UID getObjectEntityUID(String ticketUID) throws NoResultException {
