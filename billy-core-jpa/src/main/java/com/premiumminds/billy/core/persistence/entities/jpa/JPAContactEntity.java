...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "CONTACT") public class JPAContactEntity extends JPABaseEntity implements ContactEntity {
  ...
  @Column(name = "MOBILE") protected String mobile;

  @Column(name = "FAX") protected String fax;
