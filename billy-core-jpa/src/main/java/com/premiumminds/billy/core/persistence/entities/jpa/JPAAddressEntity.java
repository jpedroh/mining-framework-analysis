...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "ADDRESS") public class JPAAddressEntity extends JPABaseEntity implements AddressEntity {
  private static final long serialVersionUID = 1L;

  @Column(name = "NUMBER") protected String number;

  @Column(name = "DETAILS") protected String details;

  @Column(name = "BUILDING") protected String building;

  @Column(name = "CITY") protected String city;

  @Column(name = "POSTAL_CODE") protected String postalCode;

  @Column(name = "REGION") protected String region;

  @Column(name = "COUNTRY") protected String country;

  @Column(name = "STREET_NAME") protected String streetName;
