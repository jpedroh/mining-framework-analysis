...
@Entity @Audited @Table(name = Config.TABLE_PREFIX + "BANK_ACCOUNT") public class JPABankAccountEntity extends JPABaseEntity implements BankAccountEntity {
  private static final long serialVersionUID = 1L;

  @Column(name = "IBAN") protected String iban;

  @Column(name = "BANK_IDENTIFIER") protected String bankIdentifier;

  @Column(name = "BANK_ACCOUNT_NUMBER") protected String bankAccountNumber;

  @Column(name = "OWNER_NAME") protected String ownerName;
