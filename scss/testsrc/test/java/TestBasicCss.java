...
public class TestBasicCss extends TestBase {
  ...
  @Test public void testNesting() {
    String[] lines = { "@media hello,world {", "  body, head {}", "}" };
  ...
  @Test public void testPropertiesMultivalues() {
  ...
  @Test public void testPropertyFunctionMath() {
    ...
    Assert.assertEquals(exp.functionCall().values().commandStatement(0).mathStatement().commandStatement().expression(0).measurement().Number().getText(), "3");
  }
  ...
  @Test public void testPropertyFunctionMathMinus() {
    ...
    Assert.assertEquals(exp.functionCall().values().commandStatement(0).mathStatement().mathCharacter().getText(), "-");
    ScssParser.MeasurementContext measure = exp.functionCall().values().commandStatement(0).mathStatement().commandStatement().expression(0).measurement();
  ...
  @Test public void testPropertyFunctionMathParen() {
    ...
    Assert.assertEquals(exp.functionCall().Identifier().getText(), "calc");
    Assert.assertEquals(exp.functionCall().values().commandStatement(0).commandStatement().commandStatement().expression(0).measurement().Number().getText(), "100");
  }
  ...
  @Test public void testInterpolation() {
    ...
    Assert.assertEquals(context.selector(0).element(1).identifier().identifierVariableName().getText(), "$name");
  ...
  @Test public void testPseudoClassWithClassParameter() {
    ...
    Assert.assertEquals(context.selector(0).element(0).pseudo().selector().getText(), ".fullscreen");
  }
