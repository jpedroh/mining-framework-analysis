...
@RunWith(value = JUnit4.class) public class TestBasicCss extends TestBase {
  ...
  @Test public void testBlockWithNoSpacing() {
    String[] lines = { "#id1{}" };
    assertThat(getSelector(lines).selector(0).element(0).identifier().getText()).isEqualTo("id1");
  }
  ...
  @Test public void testOneSelectorMultipleParts() {
    String[] lines = { "body .cls {}" };
  ...
  @Test public void testMultipleSelectorsDifferentSelectors() {
    String[] lines = { "body .cls, h1 {}" };
    ScssParser.SelectorsContext context = getSelector(lines);
  ...
  @Test public void testMultipleSelectorsSameElement() {
    String[] lines = { "body .cls, h1.cls1 {}" };
    ScssParser.SelectorsContext context = getSelector(lines);
    assertThat(context.selector(0).element(0).identifier().getText()).isEqualTo("body");
    assertThat(context.selector(0).element(1).getText()).isEqualTo(".cls");
    assertThat(context.selector(1).element(0).getText()).isEqualTo("h1");
  ...
  @Test public void testMultipleSelectorsMix() {
    String[] lines = { ".cls1 .cls2, .cls3, .cls4 > .cls5 {}" };
    ScssParser.SelectorsContext context = getSelector(lines);
  ...
  @Test public void testNestingWithCombinatorAtStartOfLine() {
    String[] lines = { "p {", "  > p {}", "}" };
    ScssParser.StylesheetContext context = parse(lines);
    assertThat(context.statement(0).ruleset().selectors().selector(0).element(0).getText()).isEqualTo("p");
    assertThat(context.statement(0).ruleset().block().statement(0).ruleset().selectors().selector(0).element(0).combinator().getText()).isEqualTo(">");
    assertThat(context.statement(0).ruleset().block().statement(0).ruleset().selectors().selector(0).element(1).getText()).isEqualTo("p");
  }

  @Test public void testProperties() {
    String[] lines = { "h1 {", "  display: block", "}" };
    ...
    assertThat(context.lastProperty().propertyValue().commandStatement(0).getText()).isEqualTo("block");
  }

  @Test public void testPropertyValuesSpaceSeparated() {
    ...
    assertThat(val.commandStatement(0).expression().measurement().Number().getText()).isEqualTo("2");
  ...
  @Test public void testPropertyValuesCommaSeparated() {
  ...
  @Test public void testPropertiesValuesMixedSeparators() {
    String[] lines = { "h1 {", "  background: url(\'a\'), 1px 2px", "}" };
    ScssParser.BlockContext context = parse(lines).statement(0).ruleset().block();
    ...
    assertThat(val.commandStatement(1).expression().measurement().Number().getText()).isEqualTo("1");
    assertThat(val.commandStatement(1).expression().measurement().Unit().getText()).isEqualTo("px");
    assertThat(val.commandStatement(2).expression().measurement().Number().getText()).isEqualTo("2");
    assertThat(val.commandStatement(2).expression().measurement().Unit().getText()).isEqualTo("px");
  }

  @Test public void testPropertiesMultiLines() {
    String[] lines = { "h1 {", "  color: 1px;", "  font-size: #fff", "}" };
    ScssParser.BlockContext context = parse(lines).statement(0).ruleset().block();
    ...
    assertThat(val.commandStatement(0).expression().measurement().Number().getText()).isEqualTo("1");
    assertThat(val.commandStatement(0).expression().measurement().Unit().getText()).isEqualTo("px");
  ...
  @Test public void testPropertyMeasurement() {
  ...
  @Test public void testPropertyNamespacedVariable() {
  ...
  @Test public void testPropertyFunctionMath() {
    ...
    assertThat(exp.functionCall().passedParams().passedParam(0).commandStatement().expression().getText()).isEqualTo("100%");
    assertThat(exp.functionCall().passedParams().passedParam(0).commandStatement().mathStatement().mathCharacter().getText()).isEqualTo("/");
    assertThat(exp.functionCall().passedParams().passedParam(0).commandStatement().mathStatement().commandStatement().expression().measurement().Number().getText()).isEqualTo("3");
  }

  @Test public void testPropertyFunctionMathMinus() {
    ScssParser.ExpressionContext exp = createProperty("p1: calc(100% - 80px);");
    assertThat(exp.functionCall().FunctionIdentifier().getText()).isEqualTo("calc(");
    assertThat(exp.functionCall().passedParams().passedParam(0).commandStatement().expression().measurement().Number().getText()).isEqualTo("100");
    assertThat(exp.functionCall().passedParams().passedParam(0).commandStatement().expression().measurement().Unit().getText()).isEqualTo("%");
    assertThat(exp.functionCall().passedParams().passedParam(0).commandStatement().mathStatement().mathCharacter().getText()).isEqualTo("-");
    ScssParser.MeasurementContext measure = exp.functionCall().passedParams().passedParam(0).commandStatement().mathStatement().commandStatement().expression().measurement();
    assertThat(measure.Number().getText()).isEqualTo("80");
    assertThat(measure.Unit().getText()).isEqualTo("px");
  }

  @Test public void testPropertyFunctionMathVar() {
    ScssParser.ExpressionContext exp = createProperty("p1: calc(100% - $var);");
    assertThat(exp.functionCall().FunctionIdentifier().getText()).isEqualTo("calc(");
    assertThat(exp.functionCall().passedParams().passedParam(0).commandStatement().expression().measurement().Number().getText()).isEqualTo("100");
    assertThat(exp.functionCall().passedParams().passedParam(0).commandStatement().expression().measurement().Unit().getText()).isEqualTo("%");
    assertThat(exp.functionCall().passedParams().passedParam(0).commandStatement().mathStatement().mathCharacter().getText()).isEqualTo("-");
    assertThat(exp.functionCall().passedParams().passedParam(0).commandStatement().mathStatement().commandStatement().expression().variableName().getText()).isEqualTo("$var");
  }

  @Test public void testPropertyFunctionMathParen() {
    ScssParser.ExpressionContext exp = createProperty("p1: calc(((100%)));");
    assertThat(exp.functionCall().FunctionIdentifier().getText()).isEqualTo("calc(");
    assertThat(exp.functionCall().passedParams().passedParam(0).commandStatement().commandStatement().commandStatement().expression().measurement().Number().getText()).isEqualTo("100");
  }

  @Test public void testPropertyWithNegatedMathValue() {
    String[] lines = { "h1 { p1: -$my-var; }" };
    ScssParser.BlockContext context = parse(lines).statement(0).ruleset().block();
    assertThat(context.property(0).identifier().getText()).isEqualTo("p1");
    ScssParser.ExpressionContext expression = context.property(0).propertyValue().commandStatement(0).expression();
  ...
  @Test public void testPropertyWithPlusPrefix() {
    String[] lines = { "h1 { p1: +(400px - 200px); }" };
    ScssParser.BlockContext context = parse(lines).statement(0).ruleset().block();
    assertThat(context.property(0).identifier().getText()).isEqualTo("p1");
    assertThat(context.property(0).propertyValue().commandStatement(0).getText()).isEqualTo("+(400px-200px)");
    assertThat(context.property(0).propertyValue().commandStatement(0).PLUS_LPAREN()).isNotNull();
    assertThat(context.property(0).propertyValue().commandStatement(0).commandStatement().expression().getText()).isEqualTo("400px");
    assertThat(context.property(0).propertyValue().commandStatement(0).commandStatement().mathStatement().mathCharacter().MINUS().getText()).isEqualTo("-");
    assertThat(context.property(0).propertyValue().commandStatement(0).commandStatement().mathStatement().commandStatement().expression().getText()).isEqualTo("200px");
  }

  @Test public void testInterpolation() {
    String[] lines = { "p.#{$name} > select2 {}" };
    ScssParser.SelectorsContext context = getSelector(lines);
    assertThat(context.selector(0).element(0).identifier().getText()).isEqualTo("p");
    assertThat(context.selector(0).element(1).identifier().identifierVariableName().getText()).isEqualTo("$name");
  ...
  @Test public void testInterpolationSpace() {
    String[] lines = { "p #{$name} {}" };
    ScssParser.SelectorsContext context = getSelector(lines);
    assertThat(context.selector(0).element(0).identifier().getText()).isEqualTo("p");
    assertThat(context.selector(0).element(1).identifier().identifierVariableName().getText()).isEqualTo("$name");
  ...
  @Test public void testPseudoClassWithClassParameter() {
    String[] lines = { ":host(.fullscreen) {}" };
    ScssParser.SelectorsContext context = getSelector(lines);
    assertThat(context.selector(0).element(0).pseudo().getText()).isEqualTo(":host(.fullscreen)");
    assertThat(context.selector(0).element(0).pseudo().selector().getText()).isEqualTo(".fullscreen");
  }

  @Test public void testPseudoClassWithAttributeParameter() {
    ...
    assertThat(context.selector(0).element(1).pseudo().selector().getText()).isEqualTo("[disabled]");
  }

  @Test public void testPseudoClassWithNumberParameter() {
  ...
  @Test public void testAttributeSelector() {
  ...
  @Test public void testStandAloneAttributeSelector() {
    String[] lines = { "[disabled] {}" };
    ScssParser.SelectorsContext context = getSelector(lines);
    assertThat(context.selector(0).element(0).attrib().getText()).isEqualTo("[disabled]");
    assertThat(context.selector(0).element(0).attrib().Identifier(0).getText()).isEqualTo("disabled");
  }

  @Test public void testPseudoClassAtEndOfSelector() {
  ...
  @Test public void testPseudoElementAndPseudoClass() {
  ...
  @Test public void testStandAlonePseudoElement() {
    String[] lines = { "::placeholder { color: blue; }" };
    ScssParser.SelectorsContext context = getSelector(lines);
    assertThat(context.selector(0).element(0).pseudo().getText()).isEqualTo("::placeholder");
  }

  @Test public void testDefaultVariableDeclartion() {
    String[] lines = { "$black: #000 !default;", "$white: #fff;" };
    ScssParser.StylesheetContext context = parse(lines);
  ...
  @Test public void important() {
    String[] lines = { "p {", "  color: blue;", "  background-color: red !important;", "}" };
    ScssParser.StylesheetContext context = parse(lines);
  ...
  @Test public void importantWithBlockProperty() {
    String[] lines = { "h {", "  margin: 5px !important {", "    top: 2px;", "    bottom: 2px !important", "  }", "}" };
    ScssParser.StylesheetContext context = parse(lines);
    assertThat(context.statement(0).ruleset().block().property(0).IMPORTANT()).isNotNull();
    assertThat(context.statement(0).ruleset().block().property(0).block().property(0).IMPORTANT()).isNull();
    assertThat(context.statement(0).ruleset().block().property(0).block().lastProperty().IMPORTANT()).isNotNull();
  }

  @Test public void nestedPropertyDeclaration() {
    String[] lines = { ".enlarge {", "  font-size: 14px;", "  transition: {", "    property: font-size;", "    duration: 4s;", "    delay: 2s;", "  }", "", "  &:hover { font-size: 36px; }", "}" };
    ScssParser.StylesheetContext context = parse(lines);
    assertThat(context.statement(0).ruleset().block().property(1).identifier().getText()).isEqualTo("transition");
    assertThat(context.statement(0).ruleset().block().property(1).propertyValue()).isNull();
    assertThat(context.statement(0).ruleset().block().property(1).block().property(0).getText()).isEqualTo("property:font-size;");
    assertThat(context.statement(0).ruleset().block().property(1).block().property(1).getText()).isEqualTo("duration:4s;");
    assertThat(context.statement(0).ruleset().block().property(1).block().property(2).getText()).isEqualTo("delay:2s;");
  }

  @Test public void nestedPropertyDeclarationWithShorthandValue() {
    String[] lines = { ".info-page {", "  margin: auto {", "    bottom: 10px;", "    top: 2px;", "  }", "}" };
    ScssParser.StylesheetContext context = parse(lines);
    assertThat(context.statement(0).ruleset().block().property(0).identifier().getText()).isEqualTo("margin");
    assertThat(context.statement(0).ruleset().block().property(0).propertyValue().getText()).isEqualTo("auto");
    assertThat(context.statement(0).ruleset().block().property(0).block().property(0).getText()).isEqualTo("bottom:10px;");
    assertThat(context.statement(0).ruleset().block().property(0).block().property(1).getText()).isEqualTo("top:2px;");
  }

  @Test public void nestedPropertyDeclarationWithMixin() {
    String[] lines = { "@mixin my-margin {", "  bottom: 10px;", "  top: 2px;", "}", ".info-page {", "  margin: {", "    @include my-margin;", "  }", "}" };
    ScssParser.StylesheetContext context = parse(lines);
    assertThat(context.statement(1).ruleset().block().property(0).identifier().getText()).isEqualTo("margin");
    assertThat(context.statement(1).ruleset().block().property(0).propertyValue()).isNull();
    assertThat(context.statement(1).ruleset().block().property(0).block().statement(0).includeDeclaration().Identifier().getText()).isEqualTo("my-margin");
  }

  @Test public void toKeywordAsAnIdentifier() {
    String[] lines = { "background-image: linear-gradient(", "  to bottom right,", "  rgba(200, 200, 200, 0.3) 0%,", "  rgba(200, 200, 200, 0.5) 50%,", "  rgba(200, 200, 200, 0.7) 100%", ");" };
    ...
    ScssParser.ListSpaceSeparatedContext list = context.functionCall().passedParams().passedParam(0).listSpaceSeparated();
    assertThat(list.listElement(0).commandStatement().expression().identifier().getText()).isEqualTo("to");
    assertThat(list.listElement(1).commandStatement().expression().identifier().getText()).isEqualTo("bottom");
    assertThat(list.listElement(2).commandStatement().expression().identifier().getText()).isEqualTo("right");
  }
