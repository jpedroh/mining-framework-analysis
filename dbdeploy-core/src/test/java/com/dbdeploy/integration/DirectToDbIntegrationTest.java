...
public class DirectToDbIntegrationTest {
  @Test public void shouldSuccessfullyApplyAValidSetOfDeltas() throws Exception {
  ...
  @Test public void shouldSuccessfullyApplyAValidSetOfDeltasIncludingMutliStatementDeltas() throws Exception {
  ...
  @Test public void shouldBeAbleToRecoverFromBadScriptsJustByRunningCorrectedScriptsAgain() throws Exception {
