...
public class ScriptGenerationTest {
  @Test public void generateConsolidatedChangesScriptForAllDatabasesAndCompareAgainstTemplate() throws Exception {
  ...
  private class StubSchemaManager extends DatabaseSchemaVersionManager {
    ...
    @Override public List<Long> getAppliedChanges() throws SchemaVersionTrackingException {
