 ...
 */
@Mojo(name = "generate", defaultPhase = LifecyclePhase.PROCESS_CLASSES, requiresDependencyResolution = ResolutionScope.COMPILE) public class GenerateMojo extends AbstractMojo {
  /**
  ...
  /**
     ...
     */
  @Parameter private TypeScriptFileType outputFileType;
  ...
  /**
     ...
     */
  @Parameter private List<String> classPatterns;
  ...
  /**
     ...
     */
  @Parameter private String classesFromJaxrsApplication;

  /**
     * Scans JAX-RS resources for JSON classes to process.
     * It is possible to exclude particular REST resource classes using {@link #excludeClasses} parameter.
     */
  @Parameter private boolean classesFromAutomaticJaxrsApplication;

  /**
     * List of classes excluded from processing.
     */
  @Parameter private List<String> excludeClasses;

  /**
     * Excluded classes specified using glob patterns.
     * For more information and examples see <a href="https://github.com/vojtechhabarta/typescript-generator/wiki/Class-Names-Glob-Patterns">Class Names Glob Patterns</a> Wiki page.
     */
  @Parameter private List<String> excludeClassPatterns;
  ...
  /**
     ...
     */
  @Parameter private List<String> includePropertyAnnotations;
  ...
  /**
     ...
     */
  @Parameter(required = true) private JsonLibrary jsonLibrary;

  /**
     * <b>Deprecated</b>, use {@link #optionalProperties} parameter.
     */
  @Deprecated @Parameter private boolean declarePropertiesAsOptional;
  ...
  /**
     ...
     */
  @Parameter private OptionalProperties optionalProperties;

  /**
     * If <code>true</code> declared properties will be <code>readonly</code>.
     */
  @Parameter private boolean declarePropertiesAsReadOnly;
  ...
  /**
     ...
     */
  @Parameter private String removeTypeNamePrefix;
  ...
  /**
     ...
     */
  @Parameter private String removeTypeNameSuffix;
  ...
  /**
     ...
     */
  @Parameter private String addTypeNamePrefix;
  ...
  /**
     ...
     */
  @Parameter private String addTypeNameSuffix;
  ...
  /**
     ...
     */
  @Parameter private List<String> customTypeNaming;
  ...
  /**
     ...
     */
  @Parameter private String customTypeNamingFunction;
  ...
  /**
     ...
     */
  @Parameter private List<String> referencedFiles;
  ...
  /**
     ...
     */
  @Parameter private List<String> customTypeMappings;
  ...
  /**
     ...
     */
  @Parameter private DateMapping mapDate;
  ...
  /**
     ...
     */
  @Parameter private ClassMapping mapClasses;
  ...
  /**
     ...
     */
  @Parameter private JaxrsNamespacing jaxrsNamespacing;
  ...
  /**
     ...
     * </ul>
     */
  @Parameter private String jaxrsNamespacingAnnotation;
  ...
  /**
     ...
     */
  @Parameter private String restResponseType;
  ...
  /**
     ...
     */
  @Parameter private String restOptionsType;
  ...
  /**
     ...
     */
  @Parameter private boolean noFileComment;
  ...
  /**
     ...
     */
  @Parameter private List<File> javadocXmlFiles;
...
<<<<<<< /usr/src/app/output/vojtechhabarta/typescript-generator/d44a704cd00045c731f3d66de3d6a2079567af88/typescript-generator-maven-plugin/src/main/java/cz/habarta/typescript/generator/maven/GenerateMojo.java/left.java
  /**
     ...
     * </ul>
     */
  @Parameter private List<Settings.ConfiguredExtension> extensionsWithConfiguration;
=======
  /**
     * Turns on Class to Enum Transformations for given class name pattern.
     */
  @Parameter private String classEnumPattern;
>>>>>>> /usr/src/app/output/vojtechhabarta/typescript-generator/d44a704cd00045c731f3d66de3d6a2079567af88/typescript-generator-maven-plugin/src/main/java/cz/habarta/typescript/generator/maven/GenerateMojo.java/right.java
  ...
  /**
     ...
     */
  @Parameter private List<String> optionalAnnotations;
  ...
  /**
     ...
     */
  @Parameter private boolean generateNpmPackageJson;
  ...
  /**
     ...
     */
  @Parameter private String npmName;
  ...
  /**
     ...
     */
  @Parameter private String npmVersion;
  ...
  /**
     ...
     */
  @Parameter private StringQuotes stringQuotes;

  /**
     * Specifies indentation string.
     */
  @Parameter private String indentString;

  /**
     * Display warnings when bean serializer is not found.
     */
  @Parameter(defaultValue = "true") private boolean displaySerializerWarning;

  /**
     * <b>Deprecated</b>, see {@link #jackson2ModuleDiscovery} and {@link #jackson2Modules} parameters.
     */
  @Deprecated @Parameter private boolean disableJackson2ModuleDiscovery;

  /**
     * Turns on Jackson2 automatic module discovery.
     */
  @Parameter private boolean jackson2ModuleDiscovery;

  /**
     * Specifies Jackson2 modules to use.
     */
  @Parameter private List<String> jackson2Modules;
  ...
  @Parameter(defaultValue = "${project.build.directory}", readonly = true, required = true) private String projectBuildDirectory;
  ...
  @Override public void execute() {
    try {
      ...
      final File output = outputFile != null ? outputFile : new File(new File(projectBuildDirectory, "typescript-generator"), project.getArtifactId() + settings.getExtension());
