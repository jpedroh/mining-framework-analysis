 ...
 */
@Mojo(name = "generate", defaultPhase = LifecyclePhase.PROCESS_CLASSES, requiresDependencyResolution = ResolutionScope.COMPILE, threadSafe = true) public class GenerateMojo extends AbstractMojo {
  /**
  ...
  /**
     ...
     */
  @Parameter private List<ModuleDependency> moduleDependencies;
  ...
  /**
     ...
     */
  @Parameter private List<String> classesWithAnnotations;

  /**
     * Classes to process specified by implemented interface.
     */
  @Parameter private List<String> classesImplementingInterfaces;

  /**
     * Classes to process specified by extended superclasses.
     */
  @Parameter private List<String> classesExtendingClasses;
  ...
  /**
     ...
     */
  @Parameter private List<String> scanningAcceptedPackages;
  ...
  /**
     ...
     */
  @Parameter private List<String> excludePropertyAnnotations;
  ...
  /**
     ...
     */
  @Parameter private Jackson2Configuration jackson2Configuration;
  ...
  /**
     ...
     * class on GitHub (latest version).
     */
  @Parameter private GsonConfiguration gsonConfiguration;
  ...
  /**
     ...
     * class on GitHub (latest version).
     */
  @Parameter private JsonbConfiguration jsonbConfiguration;
  ...
  /**
     ...
     * </ul>
     */
  @Parameter private List<String> additionalDataLibraries;
  ...
  /**
     ...
     */
  @Parameter private OptionalPropertiesDeclaration optionalPropertiesDeclaration;
  ...
  /**
     ...
     */
  @Parameter private NullabilityDefinition nullabilityDefinition;
  ...
  /**
     ...
     */
  @Parameter private List<String> customTypeAliases;
  ...
  /**
     ...
     */
  @Parameter private IdentifierCasing enumMemberCasing;
  ...
  /**
     ...
     *
     */
  @Parameter private List<String> nonConstEnumAnnotations;
  ...
  /**
     ...
     * This parameter can only be used when <code>mapClasses</code> parameter is set to <code>asClasses</code> value.
     */
  @Parameter private boolean generateConstructors;
  ...
  /**
     ...
     */
  @Parameter private List<String> disableTaggedUnionAnnotations;
  ...
  /**
     ...
     */
  @Parameter private boolean generateReadonlyAndWriteonlyJSDocTags;
  ...
  /**
     ...
     */
  @Parameter private boolean generateSpringApplicationInterface;

  /**
     * If <code>true</code> client for Spring REST application will be generated.
     */
  @Parameter private boolean generateSpringApplicationClient;
  ...
  /**
     ...
     */
  @Parameter private boolean scanSpringApplication;

  /**
     * Deprecated, use {@link #restNamespacing}.
     */
  @Deprecated @Parameter private RestNamespacing jaxrsNamespacing;

  /**
     * Deprecated, use {@link #restNamespacingAnnotation}.
     */
  @Deprecated @Parameter private String jaxrsNamespacingAnnotation;
  ...
  /**
     ...
     */
  @Parameter private RestNamespacing restNamespacing;
  ...
  /**
     ...
     * </ul>
     */
  @Parameter private String restNamespacingAnnotation;
  ...
  /**
     ...
     */
  @Parameter private boolean noTslintDisable;
  ...
  /**
     ...
     */
  @Parameter private List<String> requiredAnnotations;
  ...
  /**
     ...
     */
  @Parameter private List<String> nullableAnnotations;
  ...
  /**
     ...
     * Only applicable when {@link #outputKind} is set to <code>module</code>.
     */
  @Parameter private boolean generateInfoJson;


<<<<<<< /usr/src/app/output/vojtechhabarta/typescript-generator/6b97c3cfe4c797d0cb1f187bd78184ed2716845e/typescript-generator-maven-plugin/src/main/java/cz/habarta/typescript/generator/maven/GenerateMojo.java/left.java
  /**
     ...
     */
  @Parameter private List<String> npmPeerDependencies;
=======
  /**
     ...
     */
  @Parameter private boolean primitivePropertiesRequired;
>>>>>>> /usr/src/app/output/vojtechhabarta/typescript-generator/6b97c3cfe4c797d0cb1f187bd78184ed2716845e/typescript-generator-maven-plugin/src/main/java/cz/habarta/typescript/generator/maven/GenerateMojo.java/right.java
  ...
  /**
     ...
     */
  @Parameter private String npmTypescriptVersion;
  ...
  /**
     ...
     */
  @Parameter private String npmBuildScript;
  ...
  /**
     ...
     * Item format is: <code>name:version</code>.
     */
  @Parameter private List<String> npmDependencies;
  ...
  /**
     ...
     * Item format is: <code>name:version</code>.
     */
  @Parameter private List<String> npmDevDependencies;
  ...
  /**
     * <b>Deprecated</b>.
     */
  @Parameter @Deprecated private boolean displaySerializerWarning;
  ...
  /**
     ...
     */
  @Parameter @Deprecated private boolean debug;
  ...
  /**
     ...
     */
  @Parameter private Logger.Level loggingLevel;

  @Parameter(property = "typescript.generator.skip") private boolean skip;
