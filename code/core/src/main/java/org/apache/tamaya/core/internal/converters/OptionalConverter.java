 ...
 */
@Component(service = PropertyConverter.class) public class OptionalConverter implements PropertyConverter<Optional> {
  @Override public Optional convert(String value, ConversionContext context) {
    if (value == null) {
