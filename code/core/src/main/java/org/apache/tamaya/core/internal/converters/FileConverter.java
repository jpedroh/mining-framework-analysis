 ...
 */
@Component(service = PropertyConverter.class) public class FileConverter implements PropertyConverter<File> {
  private final Logger LOG = Logger.getLogger(getClass().getName());

  @Override public File convert(String value, ConversionContext context) {
