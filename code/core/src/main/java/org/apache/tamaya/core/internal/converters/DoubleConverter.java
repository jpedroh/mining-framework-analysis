 ...
 * </ul>
 */
@Component(service = PropertyConverter.class) public class DoubleConverter implements PropertyConverter<Double> {
  /**
     * The logger.
     */
  ...
  @Override public Double convert(String value, ConversionContext context) {
    ...
    switch (trimmed.toUpperCase(Locale.ENGLISH)) {
      ...
      try {
        ...
        LOG.finest("Parsing of double as floating number failed, trying parsing integral" + " number/hex instead...");
      }
