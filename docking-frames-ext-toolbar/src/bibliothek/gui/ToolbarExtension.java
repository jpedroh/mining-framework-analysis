...
public class ToolbarExtension implements Extension {
  ...
  @Override public void install(DockController controller) {
  ...
  private Collection<DockThemeExtension> createDockThemeExtension() {
    DockThemeExtension extension = new DockThemeExtension() {
      @Override public void installed(DockController controller, DockTheme theme) {
        ...
        titles.registerTheme(ToolbarDockStation.TITLE_ID, ToolbarDockTitlePoint.createFactory(new Color(80, 80, 80)));
