...
public class ToolbarDockStationMerger implements Merger {
  @Override public boolean canMerge(StationDropOperation operation, DockStation parent, DockStation child) {
    return (operation == null || !operation.isMove()) && parent.getClass() == ToolbarDockStation.class && child.getClass() == ToolbarDockStation.class;
  }

  @Override public void merge(StationDropOperation operation, DockStation parent, DockStation child) {
