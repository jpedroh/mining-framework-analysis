...
public class SimpleToolbarDockStation extends AbstractDockableStation implements ToolbarInterface, ToolbarElementInterface, ExpandableToolbarItem {
  ...
  @Override public ExpandedState getExpandedState() {
    return state;
  }
  ...
  @Override public void setExpandedState(ExpandedState state) {
    if (this.state != state) {
  ...
  @Override public void addExpandableListener(ExpandableToolbarItemListener listener) {
    if (listener == null) {
  ...
  @Override public void removeExpandableListener(ExpandableToolbarItemListener listener) {
...
abstract class SimpleToolbarDropInfo implements StationDropOperation {
  ...
  @Override public Dockable getItem() {
    return dragDockable;
  }

  @Override public SimpleToolbarDockStation getTarget() {
    return stationHost;
  }
  ...
  @Override public CombinerTarget getCombination() {
    return null;
  }

  @Override public DisplayerCombinerTarget getDisplayerCombination() {
    return null;
  }
