...
||||||| /usr/src/app/output/benoker/dockingframes/ee7fa99567bdcb72ebca8df25a6b110b5ac2b93d/docking-frames-ext-toolbar/src/bibliothek/gui/dock/ToolbarContainerDockStation.java/base.java
	@Override
	public void setPlaceholders( PlaceholderMap placeholders ){
		// Todo LATER. needed to implement persistent storage
	}
...
>>>>>>> /usr/src/app/output/benoker/dockingframes/ee7fa99567bdcb72ebca8df25a6b110b5ac2b93d/docking-frames-ext-toolbar/src/bibliothek/gui/dock/ToolbarContainerDockStation.java/right.java
	...
	public void drop( Dockable dockable ){
		...
		if( getToolbarStrategy().isToolbarPart( dockable ) ) {
<<<<<<< /usr/src/app/output/benoker/dockingframes/ee7fa99567bdcb72ebca8df25a6b110b5ac2b93d/docking-frames-ext-toolbar/src/bibliothek/gui/dock/ToolbarContainerDockStation.java/left.java
			this.drop( dockable,  createSidePanel(Position.NORTH).dockables().size(), Position.NORTH );
||||||| /usr/src/app/output/benoker/dockingframes/ee7fa99567bdcb72ebca8df25a6b110b5ac2b93d/docking-frames-ext-toolbar/src/bibliothek/gui/dock/ToolbarContainerDockStation.java/base.java
			this.drop( dockable,  .dockables().size(), Position.NORTH );
=======
...
||||||| /usr/src/app/output/benoker/dockingframes/ee7fa99567bdcb72ebca8df25a6b110b5ac2b93d/docking-frames-ext-toolbar/src/bibliothek/gui/dock/ToolbarContainerDockStation.java/base.java
			northPanel = ;
=======
			northPanel = getDockables( Position.NORTH );
>>>>>>> /usr/src/app/output/benoker/dockingframes/ee7fa99567bdcb72ebca8df25a6b110b5ac2b93d/docking-frames-ext-toolbar/src/bibliothek/gui/dock/ToolbarContainerDockStation.java/right.java
			...
			if ( indexBeneathMouse != null ){
				...
				if ( indexBeneathMouse == -1 ){
					...
					Rectangle rectComponentBeneathMouse = getDockables(
							areaBeneathMouse).dockables().get( indexBeneathMouse )
