...
<<<<<<< /usr/src/app/output/benoker/dockingframes/ee7fa99567bdcb72ebca8df25a6b110b5ac2b93d/docking-frames-ext-toolbar/src/bibliothek/gui/dock/ToolbarContainerDockStation.java/left.java
...
>>>>>>> /usr/src/app/output/benoker/dockingframes/ee7fa99567bdcb72ebca8df25a6b110b5ac2b93d/docking-frames-ext-toolbar/src/bibliothek/gui/dock/ToolbarContainerDockStation.java/right.java
  ...
  public void setPlaceholders(PlaceholderMap placeholders, Map<Integer, Dockable> children) {
    createConverter().setPlaceholders(this, new ToolbarContainerConverterCallback() {
      ...
      @Override public void adding(Position area, Dockable dockable) {
        listeners.fireDockableAdding(dockable);
      }

      @Override public void added(Position area, Dockable dockable) {
      ...
      @Override public void setDockables(Position area, DockablePlaceholderList<Dockable> list) {
  ...
  public StationDropOperation prepareDrop(int mouseX, int mouseY, int titleX, int titleY, boolean checkOverrideZone, Dockable dockable) {
    ...
    if (this.accept(dockable) & dockable.accept(this)) {
      ...
      if (westPanel.getBounds().contains(mousePoint)) {
        ...
        if (eastPanel.getBounds().contains(mousePoint)) {
          associateToolbars = eastDockables;
          area = Position.EAST;
        } else {
          if (northPanel.getBounds().contains(mousePoint)) {
            associateToolbars = northDockables;
            area = Position.NORTH;
          } else {
            if (southPanel.getBounds().contains(mousePoint)) {
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  protected class OverpaintablePanelBase extends OverpaintablePanel {
    ...
    public OverpaintablePanelBase() {
      ...
      this.setPreferredSize(new Dimension(content.getPreferredSize().width, content.getPreferredSize().height));
      setBasePane(content);
    ...
    @Override protected void paintOverlay(Graphics g) {
      ...
      if (indexBeneathMouse != null) {
        Rectangle rectangleAreaBeneathMouse = getPanel(areaBeneathMouse).getBounds();
        if (indexBeneathMouse == -1) {
          paint.drawDivider(g, rectangleAreaBeneathMouse);
        } else {
          Rectangle 
<<<<<<< /usr/src/app/output/benoker/dockingframes/ee7fa99567bdcb72ebca8df25a6b110b5ac2b93d/docking-frames-ext-toolbar/src/bibliothek/gui/dock/ToolbarContainerDockStation.java/left.java
          rectComponentBeneathMouse = getDockables(areaBeneathMouse).get(indexBeneathMouse).getComponent().getBounds()
=======
          rect = getDockables(areaBeneathMouse).dockables().get(indexBeneathMouse).getComponent().getBounds()
>>>>>>> /usr/src/app/output/benoker/dockingframes/ee7fa99567bdcb72ebca8df25a6b110b5ac2b93d/docking-frames-ext-toolbar/src/bibliothek/gui/dock/ToolbarContainerDockStation.java/right.java
          ;
...
<<<<<<< /usr/src/app/output/benoker/dockingframes/ee7fa99567bdcb72ebca8df25a6b110b5ac2b93d/docking-frames-ext-toolbar/src/bibliothek/gui/dock/ToolbarContainerDockStation.java/left.java
      this.titleVersion = titleManager.getVersion(TITLE_ID, BasicDockTitle.FACTORY);
=======
