...
public class ComponentDockable extends AbstractDockable implements ToolbarElementInterface, ExpandableToolbarItem {
  ...
  private final Component[] components = new Component[ExpandedState.values().length];
  ...
  @Override protected DockIcon createTitleIcon() {
    return new DockableIcon("dockable.default", this) {
      @Override protected void changed(Icon oldValue, Icon newValue) {
  ...
  @Override public boolean accept(DockStation base, Dockable neighbour) {
    return false;
  }
