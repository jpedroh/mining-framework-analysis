...
public class QueryBuilder<T extends java.lang.Object> {
  ...
  public static <T extends java.lang.Object> QueryBuilder<T> q(Class<T> clazz, Repository r) {
    return new QueryBuilder<>(clazz, r);
  }

  public <N extends java.lang.Object> QueryTransformer<T, N> transform(String transformName) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private T executeQueryById() {
