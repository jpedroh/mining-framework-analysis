...
<<<<<<< /usr/src/app/output/tomitribe/crest/abe0f0401628afe1d21123c90299efa53d5ebe81/tomitribe-crest-archetype/src/main/resources/archetype-resources/src/main/java/App.java/left.java
package $groupId;
...
public class App {
  ...
  /**
     ...
     */
  @Command @Table(fields = "parent name absolutePath", sort = "name parent") public Stream<File> ls(final File directory) {
    return Stream.of(directory.listFiles()).filter(File::isFile);
  }
  ...
  /**
     ...
     */
  @Command public String hello(@Option(value = "name") @Default(value = "World") String name, @Option(value = "language") @Default(value = "EN") Language language) {
...
>>>>>>> /usr/src/app/output/tomitribe/crest/abe0f0401628afe1d21123c90299efa53d5ebe81/tomitribe-crest-archetype/src/main/resources/archetype-resources/src/main/java/App.java/right.java
