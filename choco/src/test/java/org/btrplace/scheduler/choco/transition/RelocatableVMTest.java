...
public class RelocatableVMTest {
  @Test public void testForcedToMove() throws SchedulerException, ContradictionException {
    ...
    ReconfigurationProblem rp = new DefaultReconfigurationProblemBuilder(mo).setNextVMsStates(Collections.<VM>emptySet(), map.getAllVMs(), Collections.<VM>emptySet(), Collections.<VM>emptySet()).setParams(ps).build();
  ...
  @Test public void testForcedToStay() throws SchedulerException, ContradictionException {
    Model mo = new DefaultModel();
    Mapping map = mo.getMapping();
    final VM vm1 = mo.newVM();
    Node n1 = mo.newNode();
  ...
  /**
     ...
     */
  @Test public void testNotWorthyReInstantiation() throws SchedulerException, ContradictionException {
    Model mo = new DefaultModel();
    Mapping map = mo.getMapping();
    final VM vm1 = mo.newVM();
    Node n1 = mo.newNode();
  ...
  /**
     ...
     * @throws ContradictionException
     */
  @Test public void testWorthyReInstantiation() throws SchedulerException, ContradictionException {
    Model mo = new DefaultModel();
    Mapping map = mo.getMapping();
    Node n1 = mo.newNode();
    Node n2 = mo.newNode();
    ...
    ReconfigurationProblem rp = new DefaultReconfigurationProblemBuilder(mo).setNextVMsStates(Collections.<VM>emptySet(), map.getAllVMs(), Collections.<VM>emptySet(), Collections.<VM>emptySet()).setParams(ps).setManageableVMs(map.getAllVMs()).build();
  ...
  /**
     ...
     * @throws ContradictionException
     */
  @Test public void testWorthlessReInstantiation() throws SchedulerException, ContradictionException {
    Model mo = new DefaultModel();
    Mapping map = mo.getMapping();
  ...
  @Test public void testForcedReInstantiation() throws SchedulerException, ContradictionException {
    Model mo = new DefaultModel();
    Mapping map = mo.getMapping();
    final VM vm10 = mo.newVM();
    Node n1 = mo.newNode();
    ...
    for (Action a : p) {
      if (a instanceof org.btrplace.plan.event.ForgeVM) {
        ...
        if (a instanceof org.btrplace.plan.event.ShutdownVM) {
          Assert.assertEquals(a.getEnd() - a.getStart(), 1);
        } else {
          if (a instanceof org.btrplace.plan.event.BootVM) {
  ...
  @Test public void testForcedMigration() throws SchedulerException, ContradictionException {
    Model mo = new DefaultModel();
    Mapping map = mo.getMapping();
    final VM vm10 = mo.newVM();
    Node n1 = mo.newNode();
  ...
  @Test public void testReinstantiationWithPreserve() throws SchedulerException {
    Model mo = new DefaultModel();
    Mapping map = mo.getMapping();
    VM vm5 = mo.newVM();
    VM vm6 = mo.newVM();
  ...
  @Test public void testStayRunning() throws SchedulerException {
    Model mo = new DefaultModel();
    Mapping map = mo.getMapping();
    final VM vm1 = mo.newVM();
    Node n1 = mo.newNode();
    map.addOnlineNode(n1);
    map.addRunningVM(vm1, n1);
    ReconfigurationProblem rp = new DefaultReconfigurationProblemBuilder(mo).setManageableVMs(Collections.<VM>emptySet()).build();
