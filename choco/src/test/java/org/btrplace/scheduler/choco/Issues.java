...
public class Issues {
  /**
     ...
     */
  @Test public void testIssue5a() throws SchedulerException, ContradictionException {
    ...
    for (Node n : map.getAllNodes()) {
      ...
      IntVar[] c = new IntVar[] { VF.fixed(-1, rp.getSolver()), VMsOnAllNodes[rp.getNode(n)], state, vmsOnInvolvedNodes[i] };
    ...
    solver.post(IntConstraintFactory.arithm(sumStates, "=", sumIB));
  ...
  /**
     ...
     */
  @Test public void testIssue5b() throws SchedulerException {
    Model model = new DefaultModel();
    Node n1 = model.newNode();
    Node n2 = model.newNode();
    Node n3 = model.newNode();
    ...
    VM vm3 = model.newVM();
    VM vm4 = model.newVM();
    Mapping map = new MappingFiller(model.getMapping()).on(n1, n2, n3).run(n2, vm1, vm2, vm3, vm4).get();
    ReconfigurationProblem rp = new DefaultReconfigurationProblemBuilder(model).build();
  ...
  /**
     * Test a suspicious bug in issue #5
     */
  @Test public void testIssue5c() throws SchedulerException, ContradictionException {
    Model model = new DefaultModel();
    Node n1 = model.newNode();
    Node n2 = model.newNode();
    Node n3 = model.newNode();
  ...
  @Test public void testIssue10() throws SchedulerException, ContradictionException {
    Model model = new DefaultModel();
    Node n1 = model.newNode();
    Node n2 = model.newNode();
    Node n3 = model.newNode();
    ...
    for (Node n : map.getAllNodes()) {
      ...
      IntVar state = rp.getNodeAction(n).getState();
      IntVar[] c = new IntVar[] { VF.fixed(-1, solver), VMsOnAllNodes[rp.getNode(n)], state, vmsOnInvolvedNodes[i] };
      Constraint elem = IntConstraintFactory.element(vmsOnInvolvedNodes[i], new IntVar[] { VF.fixed(-1, solver), VMsOnAllNodes[rp.getNode(n)] }, state, 0);
      elms.add(elem);
      solver.post(elem);
  ...
  /**
     ...
     * @throws org.btrplace.scheduler.SchedulerException
     */
  @Test public void test16b() throws SchedulerException {
    Model model = new DefaultModel();
    Node n1 = model.newNode();
    Node n2 = model.newNode();
    Node n3 = model.newNode();
    ...
    VM vm5 = model.newVM();
    VM vm6 = model.newVM();
    Mapping map = new MappingFiller(model.getMapping()).on(n1, n2, n3, n4).run(n1, vm1, vm2).run(n2, vm3, vm4).run(n3, vm5, vm6).get();
  ...
  @Test public void issue33() throws SchedulerException, ContradictionException {
    Model mo = new DefaultModel();
    Node n = mo.newNode();
    VM v = mo.newVM();
    mo.getMapping().addOnlineNode(n);
    mo.getMapping().addRunningVM(v, n);
    ReconfigurationProblem rp = new DefaultReconfigurationProblemBuilder(mo).setNextVMsStates(Collections.<VM>emptySet(), Collections.<VM>emptySet(), Collections.singleton(v), Collections.<VM>emptySet()).build();
  ...
  @Test public void issue72() throws Exception {
  ...
  @Test public void issue72b() throws SchedulerException {
    Model mo = new DefaultModel();
  ...
  @Test public void issue72c() throws Exception {
