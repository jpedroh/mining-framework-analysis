...
public class VectorPackingPropagator extends Propagator<IntVar> {
  ...
  /**
     ...
     */
  @Override public int getPropagationConditions(int idx) {
  ...
  /**
     ...
     */
  @Override @SuppressWarnings(value = { "squid:S3346" }) public void propagate(int evtMask) throws ContradictionException {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "squid:S3346" }) private void fixPoint() throws ContradictionException {
  ...
  /**
     ...
     * @throws ContradictionException if a contradiction (rule 2) is raised
     */
  @Override public void propagate(int idx, int mask) throws ContradictionException {
    if (idx < bins.length) {
  ...
  private static class RemProc implements UnaryIntProcedure<Integer> {
    ...
    @Override public UnaryIntProcedure<Integer> set(Integer idxVar) {
      this.idxVar = idxVar;
      return this;
    }

    @Override public void execute(int val) throws ContradictionException {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "squid:S3346" }) private void initialize() throws ContradictionException {
  ...
  @SuppressWarnings(value = { "squid:S106" }) private boolean checkDimension(int d, int[][] rs, int[][] cs) {
    boolean check = true;
    int sli = 0;
    int sls = 0;
