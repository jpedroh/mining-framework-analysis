...
public class SourceCode {
  ...
  public static class FileCodeLoader extends CodeLoader {
    ...
    @Override public Reader getReader() throws Exception {
      BOMInputStream inputStream = new BOMInputStream(new FileInputStream(file), ByteOrderMark.UTF_8, ByteOrderMark.UTF_16BE, ByteOrderMark.UTF_16LE);
