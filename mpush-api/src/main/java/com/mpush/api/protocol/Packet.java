...
public class Packet {
  ...
  public <T extends java.lang.Object> T getBody() {
    return (T) body;
  }

  public <T extends java.lang.Object> void setBody(T body) {
    this.body = (byte[]) body;
  }
  ...
  public byte calcLrc() {
    byte[] data = Unpooled.buffer(HEADER_LEN - 1).writeInt(getBodyLength()).writeByte(cmd).writeShort(cc).writeByte(flags).writeInt(sessionId).array();
    byte lrc = 0;
  ...
  @Override public String toString() {
    return "{" + "cmd=" + cmd + ", cc=" + cc + ", flags=" + flags + ", sessionId=" + sessionId + ", lrc=" + lrc + ", body=" + (body == null ? 0 : body.length) + '}';
  }
