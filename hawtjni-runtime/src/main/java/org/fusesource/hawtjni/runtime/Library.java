...
public class Library {
  ...
  static final String STRATEGY = System.getProperty(STRATEGY_PROPERTY, "windows".equals(getOperatingSystem()) ? STRATEGY_SHA1 : STRATEGY_TEMP);
  ...
  @Deprecated final public String getArchSpecifcResourcePath() {
  ...
  @Deprecated final public String getOperatingSystemSpecifcResourcePath() {
  ...
  @Deprecated final public String getPlatformSpecifcResourcePath() {
  ...
  @Deprecated final public String getPlatformSpecifcResourcePath(String platform) {
  ...
  @Deprecated final public String getResorucePath() {
  ...
  final public String[] getSpecificSearchDirs() {
    return new String[] { getPlatform() + "/" + System.getProperty("os.arch"), getPlatform(), getOperatingSystem(), null };
  }
  ...
  private boolean extractAndLoad(ArrayList<Throwable> errors, String customPath, String dir, String libName, String targetLibName) {
    ...
    if (resource != null) {
      ...
      for (File path : Arrays.asList(customPath != null ? file(customPath) : null, file(System.getProperty("java.io.tmpdir")), file(System.getProperty("user.home"), ".hawtjni", name))) {
        if (path != null) {
          File target;
