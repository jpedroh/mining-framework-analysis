...
@RunWith(value = MockitoJUnitRunner.class) public class ContextImplTest {
  ...
  @Mock private 
<<<<<<< /usr/src/app/output/ninjaframework/ninja/31737c1a105967cc5fa2570accad072b6d7b6565/ninja-servlet/src/test/java/ninja/servlet/ContextImplTest.java/left.java
  ServletContext
=======
  NinjaProperties
>>>>>>> /usr/src/app/output/ninjaframework/ninja/31737c1a105967cc5fa2570accad072b6d7b6565/ninja-servlet/src/test/java/ninja/servlet/ContextImplTest.java/right.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void testGetRemoteAddrReturnsDefaultRemoteAddr() {
    when(httpServletRequest.getRemoteAddr()).thenReturn("mockedRemoteAddr");
  ...
  @Test public void testGetRemoteAddrParsesXForwardedForIfSetInApplicationConf() {
    when(httpServletRequest.getRemoteAddr()).thenReturn("mockedRemoteAddr");
  ...
  @Test public void testGetRemoteAddrParsesXForwardedForIfMoreThanOneHostPresent() {
    when(httpServletRequest.getRemoteAddr()).thenReturn("mockedRemoteAddr");
  ...
  @Test public void testGetRemoteAddrUsesFallbackIfXForwardedForIsNotValidInetAddr() {
    when(httpServletRequest.getRemoteAddr()).thenReturn("mockedRemoteAddr");
  ...
  @Test public void testGetParameterAs() {
    context.init(servletContext, httpServletRequest, httpServletResponse);
  ...
  /**
     ...
     */
  @Test public void testInitEnforcingOfCorrectEncoding() throws Exception {
    context.init(servletContext, httpServletRequest, httpServletResponse);
  ...
  /**
     ...
     * This must also return null safely.
     */
  @Test public void testGetServletContext() {
    context.init(servletContext, httpServletRequest, httpServletResponse);
