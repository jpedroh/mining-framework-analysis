...
public class ContextImplTest {
    ...
    public void setUp() {
        ...
        context = new ContextImpl(bodyParserEngineManager, flashCookie, ninjaProperties, resultHandler, sessionCookie, validation);
    }
    ...
    public void getCookieTest() {
        ...
        servlet[] servletCookies = new javax.servlet.http.Cookie[]{ servletCookie1, servletCookie2 };
        when(httpServletRequest.getCookies()).thenReturn(servletCookies);
        context.init(servletContext, httpServletRequest, httpServletResponse);
        // negative test:
        Cookie doesNotExist = context.getCookie("doesNotExist");
        assertNull(doesNotExist);
        // test  against cookie that is really there
        Cookie cookie1 = context.getCookie("contextCookie1");
        ...
        Cookie cookie2 = context.getCookie("contextCookie2");
    ...
    public void getCookiesTest() {
        ...
        servlet[] servletCookiesEmpty = new javax.servlet.http.Cookie[]{  };
        servlet[] servletCookies = new javax.servlet.http.Cookie[]{ servletCookie1, servletCookie2 };
    ...
    public void testGetParameterAs() {
        ...
        // this will not work and return null
        assertEquals(null, context.getParameterAs("key", java.lang.Long.class));
        assertEquals(new Integer(100), context.getParameterAs("key1", java.lang.Integer.class));
        assertEquals(new Long(100), context.getParameterAs("key1", java.lang.Long.class));
        assertEquals(Boolean.TRUE, context.getParameterAs("key2", java.lang.Boolean.class));
        assertEquals(new Float(10.1), context.getParameterAs("key3", java.lang.Float.class));
        assertEquals(new Character('x'), context.getParameterAs("key4", java.lang.Character.class));
    }
    ...
    public void testParseBodyJsonWorks() {
        ...
        when(bodyParserEngine.invoke(context, ContextImplTest.Dummy.class)).thenReturn(new Dummy());
        Object o = context.parseBody(ContextImplTest.Dummy.class);
    ...
    public void testParseBodyPostWorks() {
        ...
        dummy.name = "post";
        dummy.count = 245L;
        when(bodyParserEngine.invoke(context, ContextImplTest.Dummy.class)).thenReturn(dummy);
        Dummy o = context.parseBody(ContextImplTest.Dummy.class);
