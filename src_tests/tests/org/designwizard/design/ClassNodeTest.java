...
public class ClassNodeTest {
  ...
  @Test public void testLoadClass() throws IOException, InexistentEntityException {
  ...
  @Test public void testIsPrimitive() throws IOException, InexistentEntityException {
    ClassNode entity;
  ...
  @Test public void testIsArray() throws IOException, InexistentEntityException {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "returnmethod.jar");
  ...
  @Test public void testImplementedInterfaces() throws InexistentEntityException, IOException {
  ...
  @Test public void testGetPackage() throws IOException, InexistentEntityException {
  ...
  @Test public void testIsInterface() throws InexistentEntityException {
  ...
  @Test public void testGetCallers() throws InexistentEntityException {
  ...
  @Test public void testInheritedFieldsAndMethods() throws IOException, InexistentEntityException {
    this.dw = new DesignWizard(DESIGNWIZARD_DIR);
    ClassNode classNode = this.dw.getClass(ClassNode.class);
  ...
  @Test(expected = NotAnInterfaceException.class) public void testGetEntitiesThatImplements() throws IOException, InexistentEntityException, NotAnInterfaceException {
  ...
  @Test public void testGetAllMethodsWithVisibilityAndStaticOption() throws IOException, InvalidTypeOfVisibility, InexistentEntityException {
  ...
  @Test public void testGetAllMethods() throws IOException, InexistentEntityException {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "accessmodifiers.jar");
  ...
  @Test public void testGetWithVisibilityAndStaticOption() throws IOException, InexistentEntityException, InvalidTypeOfVisibility {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "accessmodifiers.jar");
    ...
    for (MethodNode method : methods) {
      if (method.containsModifiers(Modifier.STATIC)) {
        count += 1;
      }
    }
  ...
  @Test public void testGetWithVisibility() throws IOException, InexistentEntityException, InvalidTypeOfVisibility {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "accessmodifiers.jar");
    Set<MethodNode> allMethods = this.dw.getClass("AccessModifiers").getAllMethods();
    Assert.assertEquals(allMethods.size(), 9);
  ...
  @Test public void testGetAllMethodsInClass() throws IOException, InexistentEntityException {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "accessmodifiers.jar");
  ...
  @Test public void testGetSubClasses() throws InexistentEntityException, IOException {
  ...
  @Test public void testGetClass() throws InexistentEntityException, IOException {
  ...
  @Test public void testGetSuperClasses() throws InexistentEntityException, IOException {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "hierarchy.jar");
  ...
  /**
	 ...
	 *
	 */
  @Test public void testNumStaticMethods() throws InexistentEntityException, IOException {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "accessmodifiers.jar");
    Set<MethodNode> staticMethods = this.dw.getClass("AccessModifiers").getStaticMethods();
    Assert.assertEquals(4, staticMethods.size());
  }

  @Test public void testGetClassesThatUses() throws InexistentEntityException, IOException {
  ...
  @Test public void testGetClassesUsedBy() throws InexistentEntityException, IOException {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "edados1.jar");
...
<<<<<<< /usr/src/app/output/joaoarthurbm/designwizard/e6622431f3d8f4212901815a6b367fe10d3e81d3/src_tests/tests/org/designwizard/design/ClassNodeTest.java/left.java
    assertEquals(2, usedBy.size())
=======
    Assert.assertEquals(0, usedBy.size())
>>>>>>> /usr/src/app/output/joaoarthurbm/designwizard/e6622431f3d8f4212901815a6b367fe10d3e81d3/src_tests/tests/org/designwizard/design/ClassNodeTest.java/right.java
    ;
  ...
  @Test public void testGetAllClasses() throws IOException {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "edados1.jar");
    Assert.assertEquals(10, dw.getAllClasses().size());
  }

  @Test public void testInnerClass() throws InexistentEntityException, IOException {
  ...
  @Test public void testGetConstructors() throws InexistentEntityException, IOException {
  ...
  @Test public void testClassesWithRegularExpressions() throws InexistentEntityException {
