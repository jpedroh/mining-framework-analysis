...
public class MethodNodeTest {
  ...
  @Test public void testGetPackageName() throws IOException, InexistentEntityException {
  ...
  @Test public void testGetShortName() throws IOException, InexistentEntityException {
  ...
  @Test public void testReturnMethod() throws InexistentEntityException, IOException {
  ...
  @Test public void testMainThrows() throws InexistentEntityException, IOException {
  ...
  @Test public void testThrowsNothing() throws Exception {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "throws.jar");
  ...
  @Test public void testThrowsException() throws Exception {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "throws.jar");
  ...
  @Test public void testReturn() throws IOException, InexistentEntityException {
    this.dw = new DesignWizard("resources" + File.separator + "testFiles" + File.separator + "returnmethod.jar");
  ...
  @Test public void testGetAllMethodsWithVisibility() throws IOException, InvalidTypeOfVisibility, InexistentEntityException {
  ...
  @Test public void testMethodsWithRegularExpressions() throws InexistentEntityException, IOException {
    this.dw = new DesignWizard(DESIGNWIZARD_DIR);
    ...
    Assert.assertTrue(methodThatCointainsGet.contains(dw.getMethod("org.designwizard.design.Entity.getClassNode()")));
    Assert.assertTrue(methodThatCointainsGet.contains(dw.getMethod("org.designwizard.design.PackageNode.getAllMethods()")));
    ...
    Assert.assertTrue(methodsFinishingWithParenteses.contains(dw.getMethod("org.designwizard.design.Design.packageExtracted(java.lang.String)")));
    ...
    Assert.assertTrue(methodsThatContainsGetOrSet.contains(dw.getMethod("org.designwizard.design.Design.setReturnType(java.lang.String,java.lang.String)")));
    Assert.assertTrue(methodsThatContainsGetOrSet.contains(dw.getMethod("org.designwizard.design.PackageNode.getAllMethods()")));
    Assert.assertFalse(methodsThatContainsGetOrSet.contains(dw.getMethod("org.designwizard.api.util.FileUtil.reset()")));

<<<<<<< /usr/src/app/output/joaoarthurbm/designwizard/58fcd555cc6909bb7ca3df27d277600d8c871a81/src_tests/tests/org/designwizard/design/MethodNodeTest.java/left.java
    Assert.assertTrue(methodsThatContainsGetOrSet.size() == 218)
=======
    assertTrue(methodsThatContainsGetOrSet.size() == 220)
>>>>>>> /usr/src/app/output/joaoarthurbm/designwizard/58fcd555cc6909bb7ca3df27d277600d8c871a81/src_tests/tests/org/designwizard/design/MethodNodeTest.java/right.java
    ;
  }
}