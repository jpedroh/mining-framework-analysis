...
public class Config {
  ...
  /**
     ...
     * @throws Exception
     */
  @SuppressWarnings(value = { "unchecked" }) public static String parseConfig(String configFile, String overridePath, String overrideIP) throws Exception {
    try {
  ...
  /**
     ...
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillEqualityExcludes() {
  ...
  /**
     ...
     * @param state
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillCascade(String cascadeType, TreeMap<String, CascadeState> state) {
  ...
  /**
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillSuffix() {
  ...
  /**
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillFakeFK() {
  ...
  /**
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillCustomPluralization() {
  ...
  @SuppressWarnings(value = { "unchecked" }) private static void fillVersionCheck() {
    try {
  ...
  /**
	 *
	 */
  @SuppressWarnings(value = { "unchecked" }) private static void fillMaven() {
  ...
  /** Lazy fetchtype
     ...
     * @param state
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillLazy(String fetchType, TreeMap<String, Boolean> state) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillCascadeList() {
  ...
  /**
     * Fills the cascade exception list.
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillFetchTypeList() {
  ...
  /**
	 *
	 */
  @SuppressWarnings(value = { "unchecked" }) private static void fillNoOutputForSchema() {
  ...
  /**
	 *
	 */
  @SuppressWarnings(value = { "unchecked" }) private static void fillDisableBackLinks() {
  ...
  /**
    *
    */
  @SuppressWarnings(value = { "unchecked" }) private static void fillNoFollowLinks() {
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillIgnoreTableList() {
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillPreventCleanList() {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillAbstractTablesList() {
  ...
  /**
     * Fills in the list of Abstract tables - chrisp
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillImmutableTablesList() {
  ...
  private static String fillBasicEntries() {
    ...
    if (State.getInstance().dbType != null) {
      if (State.getInstance().dbType.equalsIgnoreCase("MYSQL")) {
        ...
        if (State.getInstance().dbType.equalsIgnoreCase("MSSQL")) {
          State.getInstance().dbMode = 1;
        } else {
          if (State.getInstance().dbType.equalsIgnoreCase("PostgreSQL")) {
    ...
    if (schemaRestrictTmp.equalsIgnoreCase(Constants.RESTRICT)) {
      ...
      if (schemaRestrictTmp.equalsIgnoreCase(Constants.PARTIAL)) {
        ...
        if (schemaRestrictTmp.equalsIgnoreCase(Constants.FULL)) {
          ...
          if (schemaRestrictTmp.equalsIgnoreCase(Constants.ALL)) {
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillTestValuesList() {
    ...
    for (int i = 0; i < testValues.size(); i++) {
      ...
      for (int j = 0; j < fieldValues.size(); j++) {
        properties.put(fieldValues.get(j).toString().toUpperCase(), Config.config.getString("testValues.tables.table(" + i + ").fields(" + j + ").value"));
      }
    }
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillNaturalKeysList() {
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillOne2OneList() {
  ...
  /**
     ...
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillCyclicTableExclusionList() {
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillLinkTableList() {
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked", "cast" }) private static void fillAnnotationList() {
    config.setDelimiterParsingDisabled(true);
    Config.config.clear();
    try {
      config.load();
    ...
    for (int i = 0; i < tmpAnnotationClasses.size(); i++) {
      ...
      State.getInstance().customClassAnnotations.put(tmpAnnotationClasses.get(i).toString(), Config.config.getString(String.format("annotations.class(%d).classAnnotation", i)));
      State.getInstance().customClassCode.put(tmpAnnotationClasses.get(i).toString(), Config.config.getString(String.format("annotations.class(%d).customClassCode", i)));
      State.getInstance().customClassCodeFields.put(tmpAnnotationClasses.get(i).toString(), Config.config.getString(String.format("annotations.class(%d).customClassCodeFields", i)));
      ...
      ArrayList<Object> tmpAnnotationProperties = (ArrayList<Object>) Config.config.getList(String.format("annotations.class(%d).property[@name]", i));
      for (int j = 0; j < tmpAnnotationProperties.size(); j++) {
        ArrayList<Object> tmpProperties = (ArrayList<Object>) Config.config.getList(String.format("annotations.class(%d).property(%d).annotation", i, j));
        ...
        for (int k = 0; k < tmpProperties.size(); k++) {
          String type = Config.config.getString(String.format("annotations.class(%d).property(%d).annotation(%d)[@type]", i, j, k)).toUpperCase();
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillEnumMap() {
    ...
    for (int i = 0; i < tmpEnumMap.size(); i++) {
      ...
      for (int j = 0; j < tmpEnum.size(); j++) {
        ...
        ArrayList<Object> fieldList = (ArrayList<Object>) Config.config.getList(String.format("coalesceEnums.schema(%d).enum(%d).field", i, j));
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillPackageMap() {
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillTreatAsEnum() {
    ...
    for (int i = 0; i < tmpEnumLink.size(); i++) {
      ...
      ArrayList<Object> tmpEnumLinkField = (ArrayList<Object>) Config.config.getList(String.format("treatLinkAsEnum.schema(%d).field[@src]", i));
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillRenameSection() {
    ...
    for (int i = 0; i < tmpRename.size(); i++) {
      ...
      ArrayList<Object> tmpRenameField = (ArrayList<Object>) Config.config.getList(String.format("renaming.schema(%d).field[@srcName]", i));
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillPreExecuteList() {
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillGeneratorMap() {
  ...
  /**
     *
     */
  @SuppressWarnings(value = { "unchecked" }) private static void fillPrepopulateList() {
