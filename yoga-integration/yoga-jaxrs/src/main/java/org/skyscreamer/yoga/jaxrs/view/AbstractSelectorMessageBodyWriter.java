...
public abstract class AbstractSelectorMessageBodyWriter implements MessageBodyWriter<Object> {
  ...
  @Inject protected SelectorParser _selectorParser;

  @Inject protected RenderingListenerRegistry _renderingListenerRegistry = new RenderingListenerRegistry();

  @Inject protected CoreSelector _selector;

  @Context protected HttpServletRequest _request;

  @Context protected HttpServletResponse _response;

  protected ClassFinderStrategy _classFinderStrategy;

  @javax.inject.Inject public void setClassFinderStrategy(ClassFinderStrategy classFinderStrategy) {
  ...
  @Override public boolean isWriteable(Class<?> arg0, Type arg1, Annotation[] arg2, MediaType arg3) {
    return true;
  }

  @Override public void writeTo(Object t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, Object> httpHeaders, OutputStream entityStream) throws IOException, WebApplicationException {
    try {
