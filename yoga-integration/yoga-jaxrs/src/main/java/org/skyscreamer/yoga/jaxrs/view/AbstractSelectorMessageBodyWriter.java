...
public abstract class AbstractSelectorMessageBodyWriter implements MessageBodyWriter<Object> {
  ...
  @Autowired protected SelectorParser _selectorParser;

  @Autowired protected RenderingListenerRegistry _renderingListenerRegistry = new RenderingListenerRegistry();

  @Autowired protected CoreSelector _selector;
  ...
  @Autowired public void setClassFinderStrategy(ClassFinderStrategy classFinderStrategy) {
