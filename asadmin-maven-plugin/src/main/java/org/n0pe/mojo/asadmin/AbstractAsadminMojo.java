 ...
 * @author Paul Merlin
 */
@SuppressWarnings(value = { "ProtectedField" }) public abstract class AbstractAsadminMojo extends AbstractMojo implements IAsAdminConfig {
  /**
  ...
  /**
     ...
     */
  protected String 
<<<<<<< /usr/src/app/output/eskatos/asadmin/6fb154963dfd021025038412792ef1dcc5399017/asadmin-maven-plugin/src/main/java/org/n0pe/mojo/asadmin/AbstractAsadminMojo.java/left.java
  dbHost
=======
  okayErrorOutputRegex = null
>>>>>>> /usr/src/app/output/eskatos/asadmin/6fb154963dfd021025038412792ef1dcc5399017/asadmin-maven-plugin/src/main/java/org/n0pe/mojo/asadmin/AbstractAsadminMojo.java/right.java
  ;
...
>>>>>>> /usr/src/app/output/eskatos/asadmin/6fb154963dfd021025038412792ef1dcc5399017/asadmin-maven-plugin/src/main/java/org/n0pe/mojo/asadmin/AbstractAsadminMojo.java/right.java
  ...
  @Override public final String getGlassfishHome() {
    return glassfishHome;
  }

  @Override public final String getUser() {
    return user;
  }

  @Override public final String getPasswordFile() {
    return passwordfile;
  }
  ...
  private void checkConfig() throws MojoExecutionException, MojoFailureException {
    ...
    if (StringUtils.isEmpty(passwordfile) || "HOME".equals(passwordfile)) {
      ...
      if (new File(System.getenv("HOME") + File.separator + ".asadminpass").exists()) {
        ...
        if (new File(System.getenv("HOME") + File.separator + ".asadmintruststore").exists()) {
