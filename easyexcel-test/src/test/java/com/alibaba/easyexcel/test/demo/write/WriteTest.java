...
public class WriteTest {
  ...
  /**
     ...
     * 3. 直接写即可
     */
  @Test public void DataValidationHandlerWrite() {
    String fileName = TestFileUtil.getPath() + "customHandlerWrite" + System.currentTimeMillis() + ".xlsx";
    EasyExcel.write(fileName, DemoData.class).registerWriteHandler(new DataValidationSheetWriteHandler()).sheet("\u6a21\u677f").doWrite(new ArrayList<>());
  }

  @Test public void sheetCol() {
