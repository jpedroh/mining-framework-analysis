...
@Slf4j public class Lock2Test {
  ...
  @Test public void test() throws Exception {
    ...
    List<Object> list = EasyExcel.read("/Users/zhuangjiaju/IdeaProjects/easyexcel/easyexcel-test/target/test-classes/simpleWrite1674051907397.xlsx").sheet(0).headRowNumber(0).doReadSync();
  ...
  @Test public void test33() throws Exception {
    ...
    EasyExcel.read(file, LockData.class, new LockDataListener()).sheet(0).headRowNumber(0).doRead();
  }
  ...
  @Test public void test335() throws Exception {
  ...
  @Test public void numberforamt() throws Exception {
    SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
    LOGGER.info("data4:{}", DateUtil.getJavaDate(BigDecimal.valueOf(44729.999988368058).setScale(4, RoundingMode.HALF_UP).doubleValue(), false));
    LOGGER.info("data5:{}", DateUtil.getJavaDate(BigDecimal.valueOf(44729.999988368058).setScale(5, RoundingMode.HALF_UP).doubleValue(), false));
    LOGGER.info("data6:{}", DateUtil.getJavaDate(BigDecimal.valueOf(44729.999988368058).setScale(6, RoundingMode.HALF_UP).doubleValue(), false));
    LOGGER.info("data7:{}", DateUtil.getJavaDate(BigDecimal.valueOf(44729.999988368058).setScale(7, RoundingMode.HALF_UP).doubleValue(), false));
    LOGGER.info("data8:{}", DateUtil.getJavaDate(BigDecimal.valueOf(44729.999988368058).setScale(8, RoundingMode.HALF_UP).doubleValue(), false));
    ...
    LOGGER.info("data:{}", DateUtil.getJavaDate(BigDecimal.valueOf(44729.999976851854).setScale(10, RoundingMode.HALF_UP).doubleValue(), false));
    LOGGER.info("data:{}", DateUtil.getJavaDate(BigDecimal.valueOf(44729.99998842592).setScale(10, RoundingMode.HALF_UP).doubleValue(), false));
    LOGGER.info("data:{}", DateUtil.getJavaDate(BigDecimal.valueOf(44729.999976851854).setScale(5, RoundingMode.HALF_UP).doubleValue(), false));
    LOGGER.info("data:{}", DateUtil.getJavaDate(BigDecimal.valueOf(44729.99998842592).setScale(5, RoundingMode.HALF_UP).doubleValue(), false));
  }
  ...
  @Test public void testDateAll() throws Exception {
    SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    while (true) {
      ...
      Assert.assertEquals("\u6d4b\u8bd5\u57fa\u672c\u8f6c\u6362\u9519\u8bef" + dateTime, format.format(date), format.format(DateUtil.getJavaDate(excelDate, false)));
      Assert.assertEquals("\u6d4b\u8bd5\u7cbe\u5ea65\u8f6c\u6362\u9519\u8bef" + dateTime, format.format(date), format.format(DateUtil.getJavaDate(BigDecimal.valueOf(excelDate).setScale(10, RoundingMode.HALF_UP).doubleValue(), false)));
      LOGGER.info("date:{}", format2.format(DateUtil.getJavaDate(BigDecimal.valueOf(excelDate).setScale(10, RoundingMode.HALF_UP).doubleValue())));
      dateTime += 1000L;
  ...
  @Test public void numberforamt3() throws Exception {
    SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
    List<Map<Integer, ReadCellData>> list = EasyExcel.read("/Users/zhuangjiaju/Downloads/date3.xlsx").useDefaultListener(false).sheet(0).headRowNumber(0).doReadSync();
    LOGGER.info("\u6570\u636e\uff1a{}", list.size());
    for (Map<Integer, ReadCellData> readCellDataMap : list) {
      ReadCellData data = readCellDataMap.get(0);
      LOGGER.info("data:{}", format.format(DateUtil.getJavaDate(data.getNumberValue().setScale(10, RoundingMode.HALF_UP).doubleValue(), false)));
    }
  }

  @Test public void numberforamt4() throws Exception {
  ...
  @Test public void numberforamt77() throws Exception {
    String fileName = TestFileUtil.getPath() + "simpleWrite" + System.currentTimeMillis() + ".xlsx";
  ...
  @Test public void numberforamt99() throws Exception {
  ...
  @Test public void numberforamt5() throws Exception {
    String fileName = TestFileUtil.getPath() + "simpleWrite" + System.currentTimeMillis() + ".xlsx";
    EasyExcel.write(fileName, DemoData.class).sheet("\u6a21\u677f").doWrite(() -> {
      return data3();
    });
  ...
  @Test public void numberforamt6() throws Exception {
  ...
  @Test public void numberforamt7() throws Exception {
    DecimalFormat decimalFormat = new DecimalFormat("#.#");
