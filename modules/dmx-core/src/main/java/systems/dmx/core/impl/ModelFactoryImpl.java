...
public class ModelFactoryImpl implements ModelFactory {
  ...
  @Override public TopicModelImpl newTopicModel(long id, String uri, String typeUri, SimpleValue value, ChildTopicsModel childTopics) {
    return new TopicModelImpl(newDMXObjectModel(id, uri, typeUri, value, childTopics));
  }

  @Override public TopicModelImpl newTopicModel(ChildTopicsModel childTopics) {
    return newTopicModel(-1, null, null, null, childTopics);
  }

  @Override public TopicModelImpl newTopicModel(String typeUri) {
    return newTopicModel(-1, null, typeUri, null, null);
  }

  @Override public TopicModelImpl newTopicModel(String typeUri, SimpleValue value) {
    return newTopicModel(-1, null, typeUri, value, null);
  }

  @Override public TopicModelImpl newTopicModel(String typeUri, ChildTopicsModel childTopics) {
    return newTopicModel(-1, null, typeUri, null, childTopics);
  }

  @Override public TopicModelImpl newTopicModel(String uri, String typeUri) {
    return newTopicModel(-1, uri, typeUri, null, null);
  }

  @Override public TopicModelImpl newTopicModel(String uri, String typeUri, SimpleValue value) {
    return newTopicModel(-1, uri, typeUri, value, null);
  }

  @Override public TopicModelImpl newTopicModel(String uri, String typeUri, ChildTopicsModel childTopics) {
    return newTopicModel(-1, uri, typeUri, null, childTopics);
  }

  @Override public TopicModelImpl newTopicModel(long id) {
    return newTopicModel(id, null, null, null, null);
  }

  @Override public TopicModelImpl newTopicModel(long id, ChildTopicsModel childTopics) {
    return newTopicModel(id, null, null, null, childTopics);
  }

  @Override public TopicModelImpl newTopicModel(TopicModel topic) {
    return new TopicModelImpl((TopicModelImpl) topic);
  }

  @Override public TopicModelImpl newTopicModel(JSONObject topic) {
    try {
  ...
  @Override public AssociationModelImpl newAssociationModel(long id, String uri, String typeUri, RoleModel roleModel1, RoleModel roleModel2, SimpleValue value, ChildTopicsModel childTopics) {
    return new AssociationModelImpl(newDMXObjectModel(id, uri, typeUri, value, childTopics), (RoleModelImpl) roleModel1, (RoleModelImpl) roleModel2);
  }

  @Override public AssociationModelImpl newAssociationModel(String typeUri, RoleModel roleModel1, RoleModel roleModel2) {
    return newAssociationModel(-1, null, typeUri, roleModel1, roleModel2, null, null);
  }

  @Override public AssociationModelImpl newAssociationModel(String typeUri, RoleModel roleModel1, RoleModel roleModel2, ChildTopicsModel childTopics) {
    return newAssociationModel(-1, null, typeUri, roleModel1, roleModel2, null, childTopics);
  }

  @Override public AssociationModelImpl newAssociationModel() {
    return newAssociationModel(-1, null, null, null, null, null, null);
  }

  @Override public AssociationModelImpl newAssociationModel(ChildTopicsModel childTopics) {
    return newAssociationModel(null, childTopics);
  }

  @Override public AssociationModelImpl newAssociationModel(String typeUri, ChildTopicsModel childTopics) {
    return newAssociationModel(typeUri, null, null, childTopics);
  }

  @Override public AssociationModelImpl newAssociationModel(long id, String uri, String typeUri, RoleModel roleModel1, RoleModel roleModel2) {
    return newAssociationModel(id, uri, typeUri, roleModel1, roleModel2, null, null);
  }

  @Override public AssociationModelImpl newAssociationModel(AssociationModel assoc) {
    return new AssociationModelImpl((AssociationModelImpl) assoc);
  }

  @Override public AssociationModelImpl newAssociationModel(JSONObject assoc) {
    try {
      return new AssociationModelImpl(newDMXObjectModel(assoc), assoc.has("role1") ? parseRole(assoc.getJSONObject("role1")) : null, assoc.has("role2") ? parseRole(assoc.getJSONObject("role2")) : null);
    } catch (Exception e) {
  ...
  DMXObjectModelImpl newDMXObjectModel(JSONObject object) throws JSONException {
    return newDMXObjectModel(object.optLong("id", -1), object.optString("uri", null), object.optString("typeUri", null), object.has("value") ? new SimpleValue(object.get("value")) : null, object.has("childs") ? newChildTopicsModel(object.getJSONObject("childs")) : null);
  }

  @Override public ChildTopicsModelImpl newChildTopicsModel() {
    return new ChildTopicsModelImpl(new HashMap(), this);
  }

  @Override public ChildTopicsModelImpl newChildTopicsModel(JSONObject values) {
    try {
  ...
  @Override public String childTypeUri(String assocDefUri) {
  ...
  @Override public TopicRoleModelImpl newTopicRoleModel(long topicId, String roleTypeUri) {
    return new TopicRoleModelImpl(topicId, roleTypeUri, pl());
  }

  @Override public TopicRoleModelImpl newTopicRoleModel(String topicUri, String roleTypeUri) {
    return new TopicRoleModelImpl(topicUri, roleTypeUri, pl());
  }

  @Override public TopicRoleModelImpl newTopicRoleModel(JSONObject topicRoleModel) {
    try {
  ...
  @Override public AssociationRoleModelImpl newAssociationRoleModel(long assocId, String roleTypeUri) {
    return new AssociationRoleModelImpl(assocId, roleTypeUri, pl());
  }

  @Override public AssociationRoleModelImpl newAssociationRoleModel(JSONObject assocRoleModel) {
    try {
  ...
  @Override public RelatedTopicModelImpl newRelatedTopicModel(long topicId) {
    return new RelatedTopicModelImpl(newTopicModel(topicId), newAssociationModel());
  }

  @Override public RelatedTopicModelImpl newRelatedTopicModel(long topicId, AssociationModel relatingAssoc) {
    return new RelatedTopicModelImpl(newTopicModel(topicId), (AssociationModelImpl) relatingAssoc);
  }

  @Override public RelatedTopicModelImpl newRelatedTopicModel(String topicUri) {
    return new RelatedTopicModelImpl(newTopicModel(topicUri, (String) null), newAssociationModel());
  }

  @Override public RelatedTopicModelImpl newRelatedTopicModel(String topicUri, AssociationModel relatingAssoc) {
    return new RelatedTopicModelImpl(newTopicModel(topicUri, (String) null), (AssociationModelImpl) relatingAssoc);
  }

  @Override public RelatedTopicModelImpl newRelatedTopicModel(String topicTypeUri, SimpleValue value) {
    return new RelatedTopicModelImpl(newTopicModel(topicTypeUri, value), newAssociationModel());
  }

  @Override public RelatedTopicModelImpl newRelatedTopicModel(String topicTypeUri, ChildTopicsModel childTopics) {
    return new RelatedTopicModelImpl(newTopicModel(topicTypeUri, childTopics), newAssociationModel());
  }

  @Override public RelatedTopicModelImpl newRelatedTopicModel(TopicModel topic) {
    return new RelatedTopicModelImpl((TopicModelImpl) topic, newAssociationModel());
  }

  @Override public RelatedTopicModelImpl newRelatedTopicModel(TopicModel topic, AssociationModel relatingAssoc) {
    return new RelatedTopicModelImpl((TopicModelImpl) topic, (AssociationModelImpl) relatingAssoc);
  }

  @Override public RelatedAssociationModelImpl newRelatedAssociationModel(AssociationModel assoc, AssociationModel relatingAssoc) {
    return new RelatedAssociationModelImpl((AssociationModelImpl) assoc, (AssociationModelImpl) relatingAssoc);
  }

  @Override public TopicReferenceModel newTopicReferenceModel(long topicId) {
    return new TopicReferenceModelImpl(newRelatedTopicModel(topicId));
  }

  @Override public TopicReferenceModel newTopicReferenceModel(long topicId, AssociationModel relatingAssoc) {
    return new TopicReferenceModelImpl(newRelatedTopicModel(topicId, relatingAssoc));
  }

  @Override public TopicReferenceModel newTopicReferenceModel(String topicUri) {
    return new TopicReferenceModelImpl(newRelatedTopicModel(topicUri));
  }

  @Override public TopicReferenceModel newTopicReferenceModel(String topicUri, AssociationModel relatingAssoc) {
    return new TopicReferenceModelImpl(newRelatedTopicModel(topicUri, relatingAssoc));
  }

  @Override public TopicReferenceModel newTopicReferenceModel(long topicId, ChildTopicsModel relatingAssocChildTopics) {
    return new TopicReferenceModelImpl(newRelatedTopicModel(topicId, newAssociationModel(relatingAssocChildTopics)));
  }

  @Override public TopicReferenceModel newTopicReferenceModel(String topicUri, ChildTopicsModel relatingAssocChildTopics) {
    return new TopicReferenceModelImpl(newRelatedTopicModel(topicUri, newAssociationModel(relatingAssocChildTopics)));
  }

  @Override public TopicReferenceModel newTopicReferenceModel(Object topicIdOrUri) {
    RelatedTopicModelImpl relTopic;
    if (topicIdOrUri instanceof Long) {
      relTopic = newRelatedTopicModel((Long) topicIdOrUri);
    } else {
      if (topicIdOrUri instanceof String) {
  ...
  @Override public TopicDeletionModel newTopicDeletionModel(long topicId) {
    return new TopicDeletionModelImpl(newRelatedTopicModel(topicId));
  }

  @Override public TopicDeletionModel newTopicDeletionModel(String topicUri) {
    return new TopicDeletionModelImpl(newRelatedTopicModel(topicUri));
  }

  @Override public TopicTypeModelImpl newTopicTypeModel(TopicModel typeTopic, String dataTypeUri, List<IndexMode> indexModes, List<AssociationDefinitionModel> assocDefs, ViewConfigurationModel viewConfig) {
    return new TopicTypeModelImpl(newTypeModel(typeTopic, dataTypeUri, indexModes, assocDefs, (ViewConfigurationModelImpl) viewConfig));
  }

  @Override public TopicTypeModelImpl newTopicTypeModel(String uri, String value, String dataTypeUri) {
    return new TopicTypeModelImpl(newTypeModel(uri, "dmx.core.topic_type", new SimpleValue(value), dataTypeUri));
  }

  @Override public TopicTypeModelImpl newTopicTypeModel(JSONObject topicType) {
    try {
  ...
  @Override public AssociationTypeModelImpl newAssociationTypeModel(TopicModel typeTopic, String dataTypeUri, List<IndexMode> indexModes, List<AssociationDefinitionModel> assocDefs, ViewConfigurationModel viewConfig) {
    return new AssociationTypeModelImpl(newTypeModel(typeTopic, dataTypeUri, indexModes, assocDefs, (ViewConfigurationModelImpl) viewConfig));
  }

  @Override public AssociationTypeModelImpl newAssociationTypeModel(String uri, String value, String dataTypeUri) {
    return new AssociationTypeModelImpl(newTypeModel(uri, "dmx.core.assoc_type", new SimpleValue(value), dataTypeUri));
  }

  @Override public AssociationTypeModelImpl newAssociationTypeModel(JSONObject assocType) {
    try {
  ...
  TypeModelImpl newTypeModel(String uri, String typeUri, SimpleValue value, String dataTypeUri) {
    return new TypeModelImpl(newTopicModel(uri, typeUri, value), dataTypeUri, new ArrayList(), new ArrayList(), newViewConfigurationModel());
  }

  TypeModelImpl newTypeModel(JSONObject typeModel) throws JSONException {
    TopicModelImpl typeTopic = newTopicModel(typeModel);
    return new TypeModelImpl(typeTopic, typeModel.optString("dataTypeUri", null), parseIndexModes(typeModel.optJSONArray("indexModeUris")), parseAssocDefs(typeModel.optJSONArray("assocDefs"), typeTopic.getUri()), newViewConfigurationModel(typeModel.optJSONArray("viewConfigTopics")));
  }
  ...
  private List<AssociationDefinitionModel> parseAssocDefs(JSONArray assocDefs, String parentTypeUri) throws JSONException {
    ...
    if (assocDefs != null) {
      for (int i = 0; i < assocDefs.length(); i++) {
        JSONObject assocDef = assocDefs.getJSONObject(i).put("parentTypeUri", parentTypeUri);
  ...
  @Override public AssociationDefinitionModelImpl newAssociationDefinitionModel(String parentTypeUri, String childTypeUri, String childCardinalityUri) {
    return newAssociationDefinitionModel(-1, null, null, false, false, parentTypeUri, childTypeUri, childCardinalityUri, null);
  }

  @Override public AssociationDefinitionModelImpl newAssociationDefinitionModel(String parentTypeUri, String childTypeUri, String childCardinalityUri, ViewConfigurationModel viewConfig) {
    return newAssociationDefinitionModel(-1, null, null, false, false, parentTypeUri, childTypeUri, childCardinalityUri, viewConfig);
  }

  @Override public AssociationDefinitionModelImpl newAssociationDefinitionModel(String customAssocTypeUri, boolean isIdentityAttr, boolean includeInLabel, String parentTypeUri, String childTypeUri, String childCardinalityUri) {
    return newAssociationDefinitionModel(-1, null, customAssocTypeUri, isIdentityAttr, includeInLabel, parentTypeUri, childTypeUri, childCardinalityUri, null);
  }
  ...
  /**
     ...
     */
  @Override public AssociationDefinitionModelImpl newAssociationDefinitionModel(AssociationModel assoc, String childCardinalityUri, ViewConfigurationModel viewConfig) {
    return new AssociationDefinitionModelImpl((AssociationModelImpl) assoc, childCardinalityUri, (ViewConfigurationModelImpl) viewConfig);
  }

  @Override public AssociationDefinitionModelImpl newAssociationDefinitionModel(JSONObject assocDef) {
    try {
      return new AssociationDefinitionModelImpl(newAssociationModel(assocDef.optLong("id", -1), null, TYPE_COMP_DEF, parentRole(assocDef.getString("parentTypeUri")), childRole(assocDef.getString("childTypeUri")), null, childTopics(assocDef)), assocDef.getString("childCardinalityUri"), newViewConfigurationModel(assocDef.optJSONArray("viewConfigTopics")));
    } catch (Exception e) {
  ...
  AssociationDefinitionModelImpl newAssociationDefinitionModel(long id, String uri, String customAssocTypeUri, boolean isIdentityAttr, boolean includeInLabel, String parentTypeUri, String childTypeUri, String childCardinalityUri, ViewConfigurationModel viewConfig) {
    return new AssociationDefinitionModelImpl(newAssociationModel(id, uri, TYPE_COMP_DEF, parentRole(parentTypeUri), childRole(childTypeUri), null, childTopics(customAssocTypeUri, isIdentityAttr, includeInLabel)), childCardinalityUri, (ViewConfigurationModelImpl) viewConfig);
  }
  ...
  private ChildTopicsModel childTopics(JSONObject assocDef) throws JSONException {
    return childTopics(assocDef.isNull("customAssocTypeUri") ? null : assocDef.getString("customAssocTypeUri"), assocDef.optBoolean("isIdentityAttr"), assocDef.optBoolean("includeInLabel"));
  }

  private ChildTopicsModel childTopics(String customAssocTypeUri, boolean isIdentityAttr, boolean includeInLabel) {
    ChildTopicsModel childTopics = newChildTopicsModel().put("dmx.core.identity_attr", isIdentityAttr).put("dmx.core.include_in_label", includeInLabel);
    if (customAssocTypeUri != null) {
      if (customAssocTypeUri.startsWith(DEL_URI_PREFIX)) {
        childTopics.putDeletionRef("dmx.core.assoc_type#dmx.core.custom_assoc_type", delTopicUri(customAssocTypeUri));
      } else {
  ...
  @Override public ViewConfigurationModelImpl newViewConfigurationModel() {
    return new ViewConfigurationModelImpl(new HashMap(), pl());
  }

  @Override public ViewConfigurationModelImpl newViewConfigurationModel(Iterable<? extends TopicModel> configTopics) {
  ...
  /**
     ...
     */
  @Override public ViewConfigurationModelImpl newViewConfigurationModel(JSONArray configTopics) {
    try {
      Map<String, TopicModelImpl> _configTopics = new HashMap();
  ...
  @Override public TopicViewModel newTopicViewModel(TopicModel topic, ViewProperties viewProps) {
    return new TopicViewModelImpl((TopicModelImpl) topic, viewProps);
  }

  @Override public AssociationViewModel newAssociationViewModel(AssociationModel assoc, ViewProperties viewProps) {
    return new AssociationViewModelImpl((AssociationModelImpl) assoc, viewProps);
  }

  @Override public FacetValueModel newFacetValueModel(String childTypeUri) {
    return new FacetValueModelImpl(childTypeUri, this);
  }

  @Override public FacetValueModel newFacetValueModel(JSONObject facetValue) {
    try {
