...
public class Neo4jStorage implements DeepaMehtaStorage {
  ...
  @Override public TopicModel fetchTopic(long topicId) {
    return buildTopic(fetchTopicNode(topicId));
  }

  @Override public TopicModel fetchTopic(String key, Object value) {
    Node node = topicContentExact.get(key, value).getSingle();
    return node != null ? buildTopic(node) : null;
  }

  @Override public List<TopicModel> fetchTopics(String key, Object value) {
    return buildTopics(topicContentExact.query(key, value));
  }

  @Override public List<TopicModel> queryTopics(Object value) {
    return queryTopics(null, value);
  }

  @Override public List<TopicModel> queryTopics(String key, Object value) {
    if (key == null) {
      key = KEY_FULLTEXT;
    }
    if (value == null) {
  ...
  @Override public Iterator<TopicModel> fetchAllTopics() {
    return new TopicModelIterator(this);
  }

  @Override public void storeTopic(TopicModel topicModel) {
  ...
  @Override public void storeTopicUri(long topicId, String uri) {
    storeAndIndexTopicUri(fetchTopicNode(topicId), uri);
  }

  @Override public void storeTopicTypeUri(long topicId, String topicTypeUri) {
  ...
  @Override public void storeTopicValue(long topicId, SimpleValue value, List<IndexMode> indexModes, String indexKey, SimpleValue indexValue) {
    Node topicNode = fetchTopicNode(topicId);
  ...
  @Override public void indexTopicValue(long topicId, IndexMode indexMode, String indexKey, SimpleValue indexValue) {
  ...
  @Override public AssociationModel fetchAssociation(long assocId) {
    return buildAssociation(fetchAssociationNode(assocId));
  }

  @Override public AssociationModel fetchAssociation(String key, Object value) {
    Node node = assocContentExact.get(key, value).getSingle();
    return node != null ? buildAssociation(node) : null;
  }

  @Override public List<AssociationModel> fetchAssociations(String key, Object value) {
    return buildAssociations(assocContentExact.query(key, value));
  }

  @Override public List<AssociationModel> fetchAssociations(String assocTypeUri, long topicId1, long topicId2, String roleTypeUri1, String roleTypeUri2) {
    return queryAssociationIndex(assocTypeUri, roleTypeUri1, NodeType.TOPIC, topicId1, null, roleTypeUri2, NodeType.TOPIC, topicId2, null);
  }

  @Override public List<AssociationModel> fetchAssociationsBetweenTopicAndAssociation(String assocTypeUri, long topicId, long assocId, String topicRoleTypeUri, String assocRoleTypeUri) {
    return queryAssociationIndex(assocTypeUri, topicRoleTypeUri, NodeType.TOPIC, topicId, null, assocRoleTypeUri, NodeType.ASSOC, assocId, null);
  }

  @Override public Iterator<AssociationModel> fetchAllAssociations() {
    return new AssociationModelIterator(this);
  }

  @Override public long[] fetchPlayerIds(long assocId) {
    List<Relationship> rels = fetchRelationships(fetchAssociationNode(assocId));
    long[] playerIds = { playerId(rels.get(0)), playerId(rels.get(1)) };
    return playerIds;
  }

  @Override public void storeAssociation(AssociationModel assocModel) {
  ...
  @Override public void storeAssociationUri(long assocId, String uri) {
    storeAndIndexAssociationUri(fetchAssociationNode(assocId), uri);
  }

  @Override public void storeAssociationTypeUri(long assocId, String assocTypeUri) {
    Node assocNode = fetchAssociationNode(assocId);
    storeAndIndexAssociationTypeUri(assocNode, assocTypeUri);
    indexAssociationType(assocNode, assocTypeUri);
    reindexTypeUri(assocNode, assocTypeUri);
  }

  @Override public void storeAssociationValue(long assocId, SimpleValue value, List<IndexMode> indexModes, String indexKey, SimpleValue indexValue) {
    Node assocNode = fetchAssociationNode(assocId);
  ...
  @Override public void indexAssociationValue(long assocId, IndexMode indexMode, String indexKey, SimpleValue indexValue) {
    indexAssociationNodeValue(fetchAssociationNode(assocId), asList(indexMode), indexKey, indexValue.value());
  }

  @Override public void storeRoleTypeUri(long assocId, long playerId, String roleTypeUri) {
    Node assocNode = fetchAssociationNode(assocId);
  ...
  @Override public DeepaMehtaObjectModel fetchObject(long id) {
  ...
  @Override public List<AssociationModel> fetchTopicAssociations(long topicId) {
    return fetchAssociations(fetchTopicNode(topicId));
  }

  @Override public List<AssociationModel> fetchAssociationAssociations(long assocId) {
    return fetchAssociations(fetchAssociationNode(assocId));
  }

  @Override public List<RelatedTopicModel> fetchTopicRelatedTopics(long topicId, String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersTopicTypeUri) {
    return buildRelatedTopics(queryAssociationIndex(assocTypeUri, myRoleTypeUri, NodeType.TOPIC, topicId, null, othersRoleTypeUri, NodeType.TOPIC, -1, othersTopicTypeUri), topicId);
  }

  @Override public List<RelatedAssociationModel> fetchTopicRelatedAssociations(long topicId, String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersAssocTypeUri) {
    return buildRelatedAssociations(queryAssociationIndex(assocTypeUri, myRoleTypeUri, NodeType.TOPIC, topicId, null, othersRoleTypeUri, NodeType.ASSOC, -1, othersAssocTypeUri), topicId);
  }

  @Override public List<RelatedTopicModel> fetchAssociationRelatedTopics(long assocId, String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersTopicTypeUri) {
    return buildRelatedTopics(queryAssociationIndex(assocTypeUri, myRoleTypeUri, NodeType.ASSOC, assocId, null, othersRoleTypeUri, NodeType.TOPIC, -1, othersTopicTypeUri), assocId);
  }

  @Override public List<RelatedAssociationModel> fetchAssociationRelatedAssociations(long assocId, String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersAssocTypeUri) {
    return buildRelatedAssociations(queryAssociationIndex(assocTypeUri, myRoleTypeUri, NodeType.ASSOC, assocId, null, othersRoleTypeUri, NodeType.ASSOC, -1, othersAssocTypeUri), assocId);
  }

  @Override public List<RelatedTopicModel> fetchRelatedTopics(long id, String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersTopicTypeUri) {
    return buildRelatedTopics(queryAssociationIndex(assocTypeUri, myRoleTypeUri, null, id, null, othersRoleTypeUri, NodeType.TOPIC, -1, othersTopicTypeUri), id);
  }

  @Override public List<RelatedAssociationModel> fetchRelatedAssociations(long id, String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersAssocTypeUri) {
    return buildRelatedAssociations(queryAssociationIndex(assocTypeUri, myRoleTypeUri, null, id, null, othersRoleTypeUri, NodeType.ASSOC, -1, othersAssocTypeUri), id);
  }

  @Override public Object fetchProperty(long id, String propUri) {
  ...
  @Override public List<TopicModel> fetchTopicsByProperty(String propUri, Object propValue) {
    return buildTopics(queryIndexByProperty(topicContentExact, propUri, propValue));
  }

  @Override public List<TopicModel> fetchTopicsByPropertyRange(String propUri, Number from, Number to) {
    return buildTopics(queryIndexByPropertyRange(topicContentExact, propUri, from, to));
  }

  @Override public List<AssociationModel> fetchAssociationsByProperty(String propUri, Object propValue) {
    return buildAssociations(queryIndexByProperty(assocContentExact, propUri, propValue));
  }

  @Override public List<AssociationModel> fetchAssociationsByPropertyRange(String propUri, Number from, Number to) {
    return buildAssociations(queryIndexByPropertyRange(assocContentExact, propUri, from, to));
  }

  @Override public void storeTopicProperty(long topicId, String propUri, Object propValue, boolean addToIndex) {
  ...
  @Override public void storeAssociationProperty(long assocId, String propUri, Object propValue, boolean addToIndex) {
  ...
  @Override public void indexTopicProperty(long topicId, String propUri, Object propValue) {
    indexExactValue(fetchTopicNode(topicId), propUri, propValue, topicContentExact);
  }

  @Override public void indexAssociationProperty(long assocId, String propUri, Object propValue) {
    storeAndIndexExactValue(fetchAssociationNode(assocId), propUri, propValue, assocContentExact);
  }

  @Override public void deleteTopicProperty(long topicId, String propUri) {
    Node topicNode = fetchTopicNode(topicId);
    topicNode.removeProperty(propUri);
    removeTopicPropertyFromIndex(topicNode, propUri);
  }

  @Override public void deleteAssociationProperty(long assocId, String propUri) {
    Node assocNode = fetchAssociationNode(assocId);
  ...
  @Override public boolean setupRootNode() {
    try {
  ...
  @Override public Object getDatabaseVendorObject(long objectId) {
  ...
  private void indexExactValue(Node node, String key, Object value, Index<Node> exactIndex) {
    ...
    indexNodeValue(node, value, asList(IndexMode.KEY), key, exactIndex, null);
  }
    ...
    for (IndexMode indexMode : indexModes) {
      if (indexMode == IndexMode.OFF) {
        ...
        if (indexMode == IndexMode.KEY) {
          exactIndex.remove(node, indexKey);
          exactIndex.add(node, indexKey, value);
        } else {
          if (indexMode == IndexMode.FULLTEXT) {
            fulltextIndex.remove(node, KEY_FULLTEXT);
            fulltextIndex.add(node, KEY_FULLTEXT, value);
          } else {
            if (indexMode == IndexMode.FULLTEXT_KEY) {
              fulltextIndex.remove(node, indexKey);
              fulltextIndex.add(node, indexKey, value);
            } else {
  ...
  private List<AssociationModel> queryAssociationIndex(String assocTypeUri, String roleTypeUri1, NodeType playerType1, long playerId1, String playerTypeUri1, String roleTypeUri2, NodeType playerType2, long playerId2, String playerTypeUri2) {
    return buildAssociations(assocMetadata.query(buildAssociationQuery(assocTypeUri, roleTypeUri1, playerType1, playerId1, playerTypeUri1, roleTypeUri2, playerType2, playerId2, playerTypeUri2)));
  }
  ...
  private void addRole(BooleanQuery query, int pos, String roleTypeUri, NodeType playerType, long playerId, String playerTypeUri) {
    if (roleTypeUri != null) {
      addTermQuery(KEY_ROLE_TPYE_URI + pos, roleTypeUri, query);
    }
    if (playerType != null) {
      addTermQuery(KEY_PLAYER_TPYE + pos, playerType, query);
    }
    if (playerId != -1) {
      addTermQuery(KEY_PLAYER_ID + pos, playerId, query);
    }
    if (playerTypeUri != null) {
      addTermQuery(KEY_PLAYER_TYPE_URI + pos, playerTypeUri, query);
    }
  }
  ...
  TopicModel buildTopic(Node topicNode) {
    return mf.newTopicModel(topicNode.getId(), uri(topicNode), typeUri(topicNode), simpleValue(topicNode), null);
  }
  ...
  AssociationModel buildAssociation(Node assocNode) {
    ...
    return mf.newAssociationModel(assocNode.getId(), uri(assocNode), typeUri(assocNode), roleModels.get(0), roleModels.get(1), simpleValue(assocNode), null);
  }
  ...
  private Node storePlayerRelationship(Node assocNode, RoleModel roleModel) {
    ...
    assocNode.createRelationshipTo(playerNode, getRelationshipType(roleModel.getRoleTypeUri()));
    return playerNode;
  }
  ...
  private Node fetchTopicNode(long topicId) {
    return checkNodeType(fetchNode(topicId), NodeType.TOPIC);
  }

  private Node fetchAssociationNode(long assocId) {
    return checkNodeType(fetchNode(assocId), NodeType.ASSOC);
  }
  ...
  private List<RelatedTopicModel> buildRelatedTopics(List<AssociationModel> assocs, long playerId) {
    ...
    for (AssociationModel assoc : assocs) {
      relTopics.add(mf.newRelatedTopicModel(fetchTopic(assoc.getOtherPlayerId(playerId)), assoc));
    }
    return relTopics;
  }
  ...
  private List<RelatedAssociationModel> buildRelatedAssociations(List<AssociationModel> assocs, long playerId) {
    ...
    for (AssociationModel assoc : assocs) {
      relAssocs.add(mf.newRelatedAssociationModel(fetchAssociation(assoc.getOtherPlayerId(playerId)), assoc));
    }
    return relAssocs;
  }
