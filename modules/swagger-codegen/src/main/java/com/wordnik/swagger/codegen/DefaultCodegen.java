          ...
          for (String key : impl.getProperties().keySet()) {
            ...
            if (prop == null) {
              ...
              if (cp.isContainer != null) {
                ...
                if (arrayImport != null && !languageSpecificPrimitives.contains(arrayImport) && !defaultIncludes.contains(arrayImport)) {
                  m.imports.add(arrayImport);
                }
              }
              if (cp.complexType != null && !languageSpecificPrimitives.contains(cp.complexType) && !defaultIncludes.contains(cp.complexType)) {
                m.imports.add(cp.complexType);
              }
              if (cp.baseType != null && !languageSpecificPrimitives.contains(cp.baseType) && !defaultIncludes.contains(cp.baseType)) {
