...
public class CSharpClientCodegen extends AbstractCSharpCodegen {
  @SuppressWarnings(value = { "unused", "hiding" }) private static final Logger LOGGER = LoggerFactory.getLogger(CSharpClientCodegen.class);
  ...
  public CSharpClientCodegen() {
    ...
    frameworks = new ImmutableMap.Builder<String, String>().put(NET35, ".NET Framework 3.5 compatible").put(NET45, ".NET Framework 4.5+ compatible").put(UWP, "Universal Windows Platform - beta support").build();
  ...
  @Override public Map<String, Object> postProcessModels(Map<String, Object> objMap) {
  ...
  @Override public String toEnumValue(String value, String datatype) {
    if ("int?".equalsIgnoreCase(datatype) || "long?".equalsIgnoreCase(datatype) || "double?".equalsIgnoreCase(datatype) || "float?".equalsIgnoreCase(datatype)) {
      return value;
    } else {
  ...
  @Override public String toEnumVarName(String value, String datatype) {
    if ("int?".equals(datatype) || "long?".equals(datatype) || "double?".equals(datatype) || "float?".equals(datatype)) {
