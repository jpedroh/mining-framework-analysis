...
public class TypeScriptAngular2ClientCodegen extends AbstractTypeScriptClientCodegen {
  ...
  @Override protected void addAdditionPropertiesToCodeGenModel(CodegenModel codegenModel, ModelImpl swaggerModel) {
  ...
  @Override public Map<String, Object> postProcessOperations(Map<String, Object> operations) {
