...
public class DefaultCodegen {
  ...
  @SuppressWarnings(value = { "unused" }) public void preprocessSwagger(Swagger swagger) {
  }

  @SuppressWarnings(value = { "unused" }) public void processSwagger(Swagger swagger) {
  }
        ...
        if (param instanceof QueryParameter) {
          ...
          if (qp.getCollectionFormat() != null) {
            ...
            if ("csv".equals(qp.getCollectionFormat())) {
              ...
              if ("pipes".equals(qp.getCollectionFormat())) {
                paramPart.append("|");
              } else {
                if ("tsv".equals(qp.getCollectionFormat())) {
                  paramPart.append("\t");
                } else {
                  if ("multi".equals(qp.getCollectionFormat())) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) public String toDefaultValue(Property p) {
    if (p instanceof StringProperty) {
      return "null";
    } else {
      if (p instanceof BooleanProperty) {
  ...
  /**
     ...
     * @return string presentation of the default value of the property
     */
  @SuppressWarnings(value = { "static-method" }) public String toDefaultValueWithParam(String name, Property p) {
    return " = data." + name + ";";
  }
  ...
  /**
     ...
     **/
  @SuppressWarnings(value = { "static-method" }) public String getSwaggerType(Property p) {
    String datatype = null;
    if (p instanceof StringProperty && "number".equals(p.getFormat())) {
      datatype = "BigDecimal";
    } else {
      if ((p instanceof ByteArrayProperty) || (p instanceof StringProperty && "byte".equals(p.getFormat()))) {
        datatype = "ByteArray";
      } else {
        ...
        if (model instanceof ComposedModel) {
          ...
          if (composed.getInterfaces() != null) {
            ...
            for (RefModel _interface : composed.getInterfaces()) {
              ...
              if (parent == null && ((interfaceModel instanceof ModelImpl && ((ModelImpl) interfaceModel).getDiscriminator() != null) || (interfaceModel instanceof ComposedModel && isDiscriminatorInInterfaceTree((ComposedModel) interfaceModel, allDefinitions)))) {
                parent = _interface;
              } else {
  ...
  private CodegenProperty fromProperty(String name, Property p, Integer itemsDepth) {
    ...
    if (p instanceof ArrayProperty) {
      ...
      CodegenProperty cp = fromProperty(itemName, ap.getItems(), itemsDepth == null ? 1 : itemsDepth.intValue() + 1);
      ...
      if (p instanceof MapProperty) {
        ...
        CodegenProperty cp = fromProperty("inner", ap.getAdditionalProperties(), itemsDepth == null ? 1 : itemsDepth.intValue() + 1);
  ...
  public CodegenOperation fromOperation(String path, String httpMethod, Operation operation, Map<String, Model> definitions, Swagger swagger) {
    ...
    if (operation.getConsumes() != null) {
      ...
      if (swagger != null && swagger.getConsumes() != null && swagger.getConsumes().size() > 0) {
    ...
    if (operation.getProduces() != null) {
      ...
      if (swagger != null && swagger.getProduces() != null && swagger.getProduces().size() > 0) {
      ...
      if (methodResponse != null) {
        ...
        if (responseProperty != null) {
          ...
          if (responseProperty instanceof ArrayProperty) {
            ...
            if (responseProperty instanceof MapProperty) {
      ...
      if (Boolean.TRUE.equals(cm.isString) && Boolean.TRUE.equals(cm.isUuid)) {
        ...
        if (Boolean.TRUE.equals(cm.isByteArray)) {
          ...
          if (Boolean.TRUE.equals(cm.isString)) {
            ...
            if (Boolean.TRUE.equals(cm.isBoolean)) {
              r.isBoolean = true;
            } else {
              if (Boolean.TRUE.equals(cm.isLong)) {
                r.isLong = true;
                r.isNumeric = true;
              } else {
                if (Boolean.TRUE.equals(cm.isInteger)) {
                  r.isInteger = true;
                  r.isNumeric = true;
                } else {
                  if (Boolean.TRUE.equals(cm.isNumber)) {
                    r.isNumber = true;
                    r.isNumeric = true;
                  } else {
                    if (Boolean.TRUE.equals(cm.isDouble)) {
                      r.isDouble = true;
                      r.isNumeric = true;
                    } else {
                      if (Boolean.TRUE.equals(cm.isFloat)) {
                        r.isFloat = true;
                        r.isNumeric = true;
                      } else {
                        if (Boolean.TRUE.equals(cm.isBinary)) {
                          r.isBinary = true;
                        } else {
                          if (Boolean.TRUE.equals(cm.isFile)) {
                            r.isFile = true;
                          } else {
                            if (Boolean.TRUE.equals(cm.isDate)) {
                              r.isDate = true;
                            } else {
                              if (Boolean.TRUE.equals(cm.isDateTime)) {
                                r.isDateTime = true;
                              } else {
  ...
  public CodegenParameter fromParameter(Parameter param, Set<String> imports) {
    ...
    if (p.vendorExtensions != null && p.vendorExtensions.containsKey("x-example")) {
      ...
      if (Boolean.TRUE.equals(p.isUuid) && (Boolean.TRUE.equals(p.isString))) {
        p.example = "38400000-8cf0-11bd-b23e-10b96e4ef00d";
      } else {
        if (Boolean.TRUE.equals(p.isString)) {
          p.example = p.paramName + "_example";
        } else {
          if (Boolean.TRUE.equals(p.isBoolean)) {
            p.example = "true";
          } else {
            if (Boolean.TRUE.equals(p.isLong)) {
              ...
              if (Boolean.TRUE.equals(p.isInteger)) {
                ...
                if (Boolean.TRUE.equals(p.isFloat)) {
                  p.example = "3.4";
                } else {
                  if (Boolean.TRUE.equals(p.isNumber)) {
                    p.example = "8.14";
                  } else {
                    if (Boolean.TRUE.equals(p.isDouble)) {
                      p.example = "1.2";
                    } else {
                      if (Boolean.TRUE.equals(p.isBinary)) {
                        p.example = "BINARY_DATA_HERE";
                      } else {
                        if (Boolean.TRUE.equals(p.isByteArray)) {
                          p.example = "B";
                        } else {
                          if (Boolean.TRUE.equals(p.isFile)) {
                            p.example = "/path/to/file.txt";
                          } else {
                            if (Boolean.TRUE.equals(p.isDate)) {
                              p.example = "2013-10-20";
                            } else {
                              if (Boolean.TRUE.equals(p.isDateTime)) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) public List<CodegenSecurity> fromSecurity(Map<String, SecuritySchemeDefinition> schemes) {
    if (schemes == null) {
    ...
    for (Iterator<Map.Entry<String, SecuritySchemeDefinition>> it = schemes.entrySet().iterator(); it.hasNext(); ) {
      ...
      if (schemeDefinition instanceof ApiKeyAuthDefinition) {
        ...
        if (schemeDefinition instanceof BasicAuthDefinition) {
    ...
    if (allDefinitions != null) {
      for (Map.Entry<String, Model> entry : allDefinitions.entrySet()) {
        ...
        if (m instanceof ModelImpl) {
          ...
          if (impl.getType() != null && !impl.getType().equals("object") && impl.getEnum() == null) {
