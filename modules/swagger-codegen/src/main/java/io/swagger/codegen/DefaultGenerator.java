...
public class DefaultGenerator extends AbstractGenerator implements Generator {
  ...
  @Override public Generator opts(ClientOptInput opts) {
    this.opts = opts;
  ...
  private void configureSwaggerInfo() {
    ...
    if (StringUtils.isEmpty(info.getDescription())) {
      config.additionalProperties().put("appDescription", "No description provided (generated by Swagger Codegen https://github.com/swagger-api/swagger-codegen)");
    ...
    for (String tag : paths.keySet()) {
      try {
        ...
        Collections.sort(ops, new Comparator<CodegenOperation>() {
          @Override public int compare(CodegenOperation one, CodegenOperation another) {
        ...
        if (ignoreProcessor.allowsFile(new File(outputFilename))) {
          if (templateFile.endsWith("mustache")) {
            ...
            Template tmpl = compiler.withLoader(new Mustache.TemplateLoader() {
              @Override public Reader getTemplate(String name) {
