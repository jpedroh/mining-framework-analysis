...
public class PhpClientCodegen extends DefaultCodegen implements CodegenConfig {
  ...
  public String toPackagePath(String packageName, String basePath) {
    ...
    return (getPackagePath() + File.separatorChar + basePath + packageName.replaceAll("[\\.\\\\/]", File.separator).replaceAll(regFirstPathSeparator, "")).replaceAll(regLastPathSeparator + "$", "");
  }
    ...
    if (p instanceof ArrayProperty) {
      ...
      if (p instanceof MapProperty) {
        ...
        if (p instanceof RefProperty) {
          ...
          return (!languageSpecificPrimitives.contains(type)) ? "\\" + modelPackage + "\\" + type : type;
        }
      }
    }
