...
public class PhpClientCodegen extends DefaultCodegen implements CodegenConfig {
  @SuppressWarnings(value = { "hiding" }) static Logger LOGGER = LoggerFactory.getLogger(PhpClientCodegen.class);
  ...
  public PhpClientCodegen() {
    ...
    cliOptions.add(new CliOption(VARIABLE_NAMING_CONVENTION, "naming convention of variable name, e.g. camelCase.").defaultValue("snake_case"));
  ...
  @Override public String escapeText(String input) {
    if (input != null) {
      ...
      if ("Integer".equals(type) || "int".equals(type)) {
        ...
        if ("Float".equalsIgnoreCase(type) || "Double".equalsIgnoreCase(type)) {
          ...
          if ("BOOLEAN".equalsIgnoreCase(type) || "bool".equalsIgnoreCase(type)) {
            ...
            if ("\\SplFileObject".equalsIgnoreCase(type)) {
              if (example == null) {
