...
>>>>>>> /usr/src/app/output/swagger-api/swagger-codegen/b8b003bc838197c1b5cfe92820fa2822451f3baa/modules/swagger-codegen/src/main/java/io/swagger/codegen/languages/PhpClientCodegen.java/right.java
    ...
    reservedWords = new HashSet<String>(Arrays.asList("__halt_compiler", "abstract", "and", "array", "as", "break", "callable", "case", "catch", "class", "clone", "const", "continue", "declare", "default", "die", "do", "echo", "else", "elseif", "empty", "enddeclare", "endfor", "endforeach", "endif", "endswitch", "endwhile", "eval", "exit", "extends", "final", "for", "foreach", "function", "global", "goto", "if", "implements", "include", "include_once", "instanceof", "insteadof", "interface", "isset", "list", "namespace", "new", "or", "print", "private", "protected", "public", "require", "require_once", "return", "static", "switch", "throw", "trait", "try", "unset", "use", "var", "while", "xor"));
    ...
    languageSpecificPrimitives = new HashSet<String>(Arrays.asList("bool", "boolean", "int", "integer", "double", "float", "string", "object", "DateTime", "mixed", "number", "void", "byte"));
...
>>>>>>> /usr/src/app/output/swagger-api/swagger-codegen/b8b003bc838197c1b5cfe92820fa2822451f3baa/modules/swagger-codegen/src/main/java/io/swagger/codegen/languages/PhpClientCodegen.java/right.java
    ...
    cliOptions.add(new CliOption("rootNamespace", 
<<<<<<< /usr/src/app/output/swagger-api/swagger-codegen/b8b003bc838197c1b5cfe92820fa2822451f3baa/modules/swagger-codegen/src/main/java/io/swagger/codegen/languages/PhpClientCodegen.java/left.java
    "root namespace from which other namespaces derive"
=======
    toPackagePath(invokerPackage, "lib")
>>>>>>> /usr/src/app/output/swagger-api/swagger-codegen/b8b003bc838197c1b5cfe92820fa2822451f3baa/modules/swagger-codegen/src/main/java/io/swagger/codegen/languages/PhpClientCodegen.java/right.java
    ));
...
>>>>>>> /usr/src/app/output/swagger-api/swagger-codegen/b8b003bc838197c1b5cfe92820fa2822451f3baa/modules/swagger-codegen/src/main/java/io/swagger/codegen/languages/PhpClientCodegen.java/right.java
    , 
<<<<<<< /usr/src/app/output/swagger-api/swagger-codegen/b8b003bc838197c1b5cfe92820fa2822451f3baa/modules/swagger-codegen/src/main/java/io/swagger/codegen/languages/PhpClientCodegen.java/left.java
    "namespace for core, non-api-specific classes"
=======
    getPackagePath()
>>>>>>> /usr/src/app/output/swagger-api/swagger-codegen/b8b003bc838197c1b5cfe92820fa2822451f3baa/modules/swagger-codegen/src/main/java/io/swagger/codegen/languages/PhpClientCodegen.java/right.java
    , "autoload.php"));
  ...
  public String toPackagePath(String packageName, String basePath) {
    ...
    return (getPackagePath() + File.separatorChar + basePath + packageName.replaceAll("[\\.\\\\/]", File.separator).replaceAll("^" + File.separator, "")).replaceAll(File.separator + "$", "");
  }
    ...
    if (p instanceof ArrayProperty) {
      ...
      if (p instanceof MapProperty) {
        ...
        if (p instanceof RefProperty) {
          ...
          return 
<<<<<<< /usr/src/app/output/swagger-api/swagger-codegen/b8b003bc838197c1b5cfe92820fa2822451f3baa/modules/swagger-codegen/src/main/java/io/swagger/codegen/languages/PhpClientCodegen.java/left.java
          "\\\\" + modelNamespace.replace("\\", "\\\\") + "\\\\" + getSwaggerType(p)
=======
          (!languageSpecificPrimitives.contains(type)) ? "\\" + modelPackage + "\\" + type : type
>>>>>>> /usr/src/app/output/swagger-api/swagger-codegen/b8b003bc838197c1b5cfe92820fa2822451f3baa/modules/swagger-codegen/src/main/java/io/swagger/codegen/languages/PhpClientCodegen.java/right.java
          ;
        }
      }
  ...
  @Override public String getSwaggerType(Property p) {
    ...
    if (typeMapping.containsKey(swaggerType)) {
      ...
      if (languageSpecificPrimitives.contains(type)) {
        ...
        if (instantiationTypes.containsKey(type)) {
          return type;
        }
      }
    } else {
