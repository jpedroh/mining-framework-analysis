...
public class JavaClientCodegen extends AbstractJavaCodegen implements BeanValidationFeatures, PerformBeanValidationFeatures, GzipFeatures {
  ...
  @SuppressWarnings(value = { "hiding" }) private static final Logger LOGGER = LoggerFactory.getLogger(JavaClientCodegen.class);
    ...
    if ("feign".equals(getLibrary())) {
      ...
      if ("okhttp-gson".equals(getLibrary()) || StringUtils.isEmpty(getLibrary())) {
        ...
        if (usesAnyRetrofitLibrary()) {
          ...
          if ("jersey2".equals(getLibrary()) || "resteasy".equals(getLibrary())) {
            supportingFiles.add(new SupportingFile("JSON.mustache", invokerFolder, "JSON.java"));
            additionalProperties.put("jackson", "true");
          } else {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public Map<String, Object> postProcessAllModels(Map<String, Object> objs) {
