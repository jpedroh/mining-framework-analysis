...
public class OSCMessageTest extends junit.framework.TestCase {
  ...
  public static void checkResultEqualsAnswer(byte[] result, byte[] answer) {
    if (result.length != answer.length) {
      fail("Result and answer aren\'t the same length " + result.length + " vs " + answer.length);
    }
  ...
  public void testDecreaseVolume() {
    ...
    byte[] answer = { 47, 115, 99, 47, 109, 105, 120, 101, 114, 47, 118, 111, 108, 117, 109, 101, 0, 0, 0, 0, 44, 105, 102, 0, 0, 0, 0, 1, 62, 76, -52, -51 };
  ...
  public void testIncreaseVolume() {
    ...
    OSCMessage message = new OSCMessage("/sc/mixer/volume", args);
    byte[] answer = { 47, 115, 99, 47, 109, 105, 120, 101, 114, 47, 118, 111, 108, 117, 109, 101, 0, 0, 0, 0, 44, 105, 102, 0, 0, 0, 0, 1, 63, (byte) 128, 0, 0 };
    byte[] result = message.getByteArray();
    checkResultEqualsAnswer(result, answer);
  }
...
<<<<<<< /usr/src/app/output/hoijui/javaosc/f806396898fdfbf9533f2ff881b05ff5b6df5f6e/modules/core/src/test/java/com/illposed/osc/OSCMessageTest.java/left.java
