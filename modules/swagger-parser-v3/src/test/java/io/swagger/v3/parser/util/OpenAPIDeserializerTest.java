...
public class OpenAPIDeserializerTest {
  @Test public void testIssue1072() throws Exception {
  ...
  @Test public void testEmptyDefinitions() throws Exception {
  ...
  @Test public void testSecurityDeserialization() throws Exception {
    String yaml = "openapi: 3.0.0\n" + "security:\n" + "  - api_key1: []\n" + "    api_key2: []\n" + "  - api_key3: []\n";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    SwaggerParseResult result = parser.readContents(yaml, null, null);
    OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test public void testArraySchema() throws Exception {
  ...
  @Test public void testSecurityDefinition() {
  ...
  @Test public void testSecurityDefinitionWithMissingAttribute() {
    String yaml = "openapi: 3.0.0\n" + "components:\n" + "  securitySchemes:\n" + "    api_key:\n" + "      description: api key description";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    SwaggerParseResult result = parser.readContents(yaml, null, null);
    List<String> messageList = result.getMessages();
  ...
  @Test public void testResponses() {
    String yaml = "openapi: 3.0.0\n" + "servers: []\n" + "info:\n" + "  version: \'\'\n" + "  title: \'\'\n" + "paths: {}\n" + "components:\n" + "  responses:\n" + "    foo:\n" + "      description: description\n" + "      bar: baz\n" + "      x-foo: bar";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    SwaggerParseResult result = parser.readContents(yaml, null, null);
    List<String> messageList = result.getMessages();
  ...
  @Test public void testNestedDefinitions() {
  ...
  @Test public void testPathsWithRefResponse() {
  ...
  @Test public void testArrayModelDefinition() {
  ...
  @Test public void testAdditionalPropertiesBoolean() {
  ...
  @Test public void testArrayQueryParam() throws Exception {
  ...
  @Test(description = "it should read a top-level extension per https://github.com/openAPI-api/validator-badge/issues/59") public void testToplevelExtension() throws Exception {
    String yaml = "openapi: 3.0.0\n" + "servers: []\n" + "x-foo: woof\n" + "info:\n" + "  version: 0.0.0\n" + "  title: Simple API\n" + "paths:\n" + "  /:\n" + "    get:\n" + "      responses:\n" + "        \'200\':\n" + "          description: OK";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    SwaggerParseResult result = parser.readContents(yaml, null, null);
  ...
  @Test public void testDeserializeBinaryString() {
    String yaml = "openapi: 3.0.0\n" + "servers: []\n" + "info:\n" + "  title: foo\n" + "  version: \'\'\n" + "paths:\n" + "  /test:\n" + "    post:\n" + "      responses:\n" + "        \'200\':\n" + "          description: ok\n" + "      requestBody:\n" + "        content:\n" + "          application/json:\n" + "            schema:\n" + "              type: string\n" + "              format: binary";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    SwaggerParseResult result = parser.readContents(yaml, null, null);
  ...
  @Test public void testDeserializeEnum() {
  ...
  @Test public void testDeserializeDateString() {
  ...
  @Test public void testDeserializeDateTimeString() {
  ...
  @Test public void testDeserializeByteString() {
  ...
  @Test public void testStyleInvalid() {
  ...
  @Test public void testDeserializeWithMessages() {
    String yaml = "openapi: \'3.0.0\'\n" + "info:\n" + "  version: 0.0.0\n" + "  title:\n" + "    - bar";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    SwaggerParseResult result = parser.readContents(yaml, null, null);
  ...
  @Test public void testDeserializeWithDiscriminator() {
  ...
  @Test public void testDeserializeWithEnumDiscriminator() {
    String yaml = "openapi: 3.0.0\n" + "components:\n" + "  schemas:\n" + "    Animal:\n" + "      type: object\n" + "      discriminator:\n" + "        propertyName: petType\n" + "      description: |\n" + "        A basic `Animal` object which can extend to other animal types.\n" + "      required:\n" + "        - commonName\n" + "        - petType\n" + "      properties:\n" + "        commonName:\n" + "          description: the household name of the animal\n" + "          type: string\n" + "        petType:\n" + "          description: |\n" + "            The discriminator for the animal type.  It _must_\n" + "            match one of the concrete schemas by name (i.e. `Cat`)\n" + "            for proper deserialization\n" + "          enum:\n" + "            - cat\n" + "            - dog";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    SwaggerParseResult result = parser.readContents(yaml, null, null);
  ...
  @Test public void testDeserializeWithNumericEnumDiscriminator() {
    String yaml = "openapi: 3.0.0\n" + "components:\n" + "  schemas:\n" + "    Animal:\n" + "      type: object\n" + "      discriminator:\n" + "        propertyName: petType\n" + "      description: |\n" + "        A basic `Animal` object which can extend to other animal types.\n" + "      required:\n" + "        - commonName\n" + "        - petType\n" + "      properties:\n" + "        commonName:\n" + "          description: the household name of the animal\n" + "          type: string\n" + "        petType:\n" + "          enum:\n" + "            - 1\n" + "            - 2";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    SwaggerParseResult result = parser.readContents(yaml, null, null);
    Map<String, Schema> properties = result.getOpenAPI().getComponents().getSchemas().get("Animal").getProperties();
  ...
  @Test public void testDeserializeWithBooleanEnumDiscriminator() {
    String yaml = "openapi: 3.0.0\n" + "components:\n" + "  schemas:\n" + "    Animal:\n" + "      type: object\n" + "      discriminator:\n" + "        propertyName: petType\n" + "      description: |\n" + "        A basic `Animal` object which can extend to other animal types.\n" + "      required:\n" + "        - commonName\n" + "        - petType\n" + "      properties:\n" + "        commonName:\n" + "          description: the household name of the animal\n" + "          type: string\n" + "        petType:\n" + "          enum:\n" + "            - true\n" + "            - false";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    SwaggerParseResult result = parser.readContents(yaml, null, null);
    Map<String, Schema> properties = result.getOpenAPI().getComponents().getSchemas().get("Animal").getProperties();
  ...
  @Test public void testValidatorIssue50() {
  ...
  @Test public void testIssue151() throws Exception {
  ...
  @Test public void testIssue204_allOf() throws Exception {
  ...
  @Test public void testPR246() throws Exception {
    String yaml = "openapi: 3.0.0\n" + "servers: []\n" + "info:\n" + "  description: \'Tests the allOf API for parent, interface and child models.\'\n" + "  version: 2.0.0\n" + "  title: Test allOf API\n" + "paths:\n" + "  /:\n" + "    get:\n" + "      responses:\n" + "        \'200\':\n" + "          description: OK\n" + "    parameters: []\n" + "components:\n" + "  schemas:\n" + "    Pet:\n" + "      type: object\n" + "      required:\n" + "        - id\n" + "      properties:\n" + "        id:\n" + "          type: integer\n" + "          format: int64\n" + "    Furry:\n" + "      type: object\n" + "      required:\n" + "        - coatColour\n" + "      properties:\n" + "        coatColour:\n" + "          type: string\n" + "    Dog:\n" + "      allOf:\n" + "        - $ref: \'#/components/schemas/Pet\'\n" + "        - $ref: \'#/components/schemas/Furry\'\n" + "        - type: object\n" + "          required:\n" + "            - name\n" + "          properties:\n" + "            name:\n" + "              type: string";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    SwaggerParseResult result = parser.readContents(yaml, null, null);
    OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test public void testIssue343Parameter() {
    String yaml = "openapi: 3.0.0\n" + "servers: []\n" + "info:\n" + "  description: bleh\n" + "  version: 2.0.0\n" + "  title: Test\n" + "paths:\n" + "  /foo:\n" + "    post:\n" + "      parameters:\n" + "        - in: query\n" + "          name: skip\n" + "          schema:\n" + "            type: integer\n" + "            format: int32\n" + "            multipleOf: 3\n" + "      responses:\n" + "        \'200\':\n" + "          description: OK\n" + "      requestBody:\n" + "        content:\n" + "          application/json:\n" + "            schema:\n" + "              type: object\n" + "              additionalProperties:\n" + "                type: string\n" + "        required: true\n" + "components:\n" + "  schemas:\n" + "    Fun:\n" + "      properties:\n" + "        id:\n" + "          type: integer\n" + "          format: int32\n" + "          multipleOf: 5\n" + "        mySet:\n" + "          type: array\n" + "          uniqueItems: true\n" + "          items:\n" + "            type: string";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    SwaggerParseResult result = parser.readContents(yaml, null, null);
    OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test public void testAllOfSchema(@Injectable List<AuthorizationValue> auths) {
  ...
  @Test public void testOneOfSchema(@Injectable List<AuthorizationValue> auths) {
  ...
  @Test public void testAnyOfSchema(@Injectable List<AuthorizationValue> auths) {
    String yaml = "openapi: \'3.0\'\n" + "components:\n" + "  schemas:\n" + "    id:\n" + "      anyOf: \n" + "       - type: string\n" + "       - type: number\n";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void propertyTest(@Injectable List<AuthorizationValue> auths) {
  ...
  @Test public void testExamples(@Injectable List<AuthorizationValue> auths) {
  ...
  @Test public void testSchemaExample(@Injectable List<AuthorizationValue> auths) {
  ...
  @Test public void testExampleVsExamples() {
  ...
  @Test public void testOptionalParameter(@Injectable List<AuthorizationValue> auths) {
  ...
  @Test public void testEmpty(@Injectable List<AuthorizationValue> auths) {
    String json = "{}";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testAlmostEmpty(@Injectable List<AuthorizationValue> auths) {
    String yaml = "openapi: \'3.0.1\'\n" + "new: extra";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test(dataProvider = "data") public void readInfoObject(JsonNode rootNode) throws Exception {
  ...
  @Test(dataProvider = "data") public void readServerObject(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test public void readMissingServerObject() throws Exception {
  ...
  @Test public void readEmptySecurityRequirement() throws Exception {
    final ObjectMapper mapper = new ObjectMapper(new YAMLFactory());
    final JsonNode rootNode = mapper.readTree(Files.readAllBytes(java.nio.file.Paths.get(getClass().getResource("/oas.yaml").toURI())));
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
  ...
  @Test public void readEmptyServerObject() throws Exception {
    final ObjectMapper mapper = new ObjectMapper(new YAMLFactory());
  ...
  @Test(dataProvider = "data") public void readContentObject(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test(dataProvider = "data") public void readRequestBodyObject(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test(dataProvider = "data") public void readSecurityRequirementsObject(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test(dataProvider = "data") public void readSecuritySchemesObject(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
  ...
  @Test(dataProvider = "data") public void readExtensions(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test(dataProvider = "data") public void readTagObject(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test(dataProvider = "data") public void readExamplesObject(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test(dataProvider = "data") public void readSchemaObject(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test(dataProvider = "data") public void readSchemaArray(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test(dataProvider = "data") public void readProducesTestEndpoint(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test(dataProvider = "data") public void readExternalDocsObject(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test(dataProvider = "data") public void readPathsObject(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test(dataProvider = "data") public void readComponentsObject(JsonNode rootNode) throws Exception {
    final OpenAPIDeserializer deserializer = new OpenAPIDeserializer();
    final SwaggerParseResult result = deserializer.deserialize(rootNode);
    Assert.assertNotNull(result);
    final OpenAPI openAPI = result.getOpenAPI();
  ...
  @Test public void readOAS() throws Exception {
    final ObjectMapper mapper = new ObjectMapper(new YAMLFactory());
  ...
  @DataProvider(name = "data") private Object[][] getRootNode() throws Exception {
    final ObjectMapper mapper = new ObjectMapper(new YAMLFactory());
