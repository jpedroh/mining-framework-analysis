...
public class OpenAPIV3ParserTest {
  ...
  @Test public void testIssueDereferencingComposedSchemaOneOf() {
  ...
  @Test public void testIssue1621() {
    ...
    assertEquals(api.getPaths().get("/example").getPost().getRequestBody().getContent().get("application/json").getSchema().getTitle(), "POST Example");
  }

  @Test public void testIssue1865() throws Exception {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue1777() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testIssue1802() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolveFully(true);
  ...
  @Test public void testIssue1780() {
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testParametersAndResponsesAsNumbers() throws Exception {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue1758() throws Exception {
    ParseOptions options = new ParseOptions();
  ...
  @Test(description = "Test for not setting the schema type as default") public void testNotDefaultSchemaType() {
    ParseOptions options = new ParseOptions();
    options.setInferSchemaType(false);
  ...
  @Test public void testIssue1637_StyleAndContent() throws IOException {
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testIssue1643_True() throws Exception {
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testIssue1643_False() throws Exception {
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testExampleFormatByte() throws Exception {
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testIssue1658() throws Exception {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue1889_ArrayReferenceNull() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    SwaggerParseResult result = new OpenAPIV3Parser().readLocation("src/test/resources/issue-1889/issue1889.yaml", null, options);
    Assert.assertNotNull(result);
    Assert.assertNotNull(result.getOpenAPI());
    OpenAPI openAPI = result.getOpenAPI();
    String expectedReference = openAPI.getPaths().get("/pets").getGet().getResponses().get("200").getContent().get("application/json").getSchema().get$ref();
    assertEquals(expectedReference, "#/components/schemas/Pet");
  }

  @Test public void testIssue1644_NullValue() throws Exception {
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testIssue1644_EmptyValue() throws Exception {
    ParseOptions options = new ParseOptions();
    String issue1644 = "openapi: 3.0.0\n" + "info:\n" + "  title: Operations\n" + "  version: 0.0.0\n" + "paths:\n" + "  \"/operations\":\n" + "    post:\n" + "      parameters:\n" + "        - name: param0\n" + "          in: \'\'\n" + "          schema:\n" + "            type: string\n" + "      responses:\n" + "        default:\n" + "          description: None\n";
    SwaggerParseResult result = new OpenAPIV3Parser().readContents(issue1644, null, options);
    Assert.assertNotNull(result);
  ...
  @Test public void testEmptyStrings_False() throws Exception {
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testEmptyStrings_True() throws Exception {
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testIssue1561() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testAnonymousModelAllOf() {
    ParseOptions options = new ParseOptions();
    options.setResolveFully(true);
  ...
  @Test public void testIssue1518() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue1518StackOverFlow() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    try {
  ...
  @Test public void testIssue251() throws IOException {
    String pathFile = FileUtils.readFileToString(new File("src/test/resources/domain.yaml"), "UTF-8");
    WireMock.stubFor(get(urlPathMatching("/domain")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/json").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
  ...
  @Test public void testCantReadDeepProperties() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolveFully(true);
    options.setValidateInternalRefs(false);
  ...
  @Test public void testIssueSameRefsDifferentModel() throws IOException {
  ...
  @Test public void testIssueSameRefsDifferentModelValid() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setResolveFully(true);
  ...
  @Test public void testIssue1398() {
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testIssue1367() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testDeserializeExampleFlag() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setResolveCombinators(true);
  ...
  @Test public void testExampleFlag() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setResolveCombinators(true);
  ...
  @Test public void testIssueFlattenArraySchemaItemsInlineModelTrue() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test public void testCamelCaseFlattenNamingFalse() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test public void testIssueFlattenComposedSchemaInlineModel() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test public void testIssueFlattenComposedSchemaInlineModelFlagFalse() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test public void testIssue1309() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue1316() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue_1292() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue_505() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testNotFlattenComposedSchema() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test public void testCodegenIssue8601() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test public void testCodegenIssue9773() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test public void testIssueResolveCallBacks() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test public void testIssue1190() {
    OpenAPIV3Parser openApiParser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test public void testIssue1147() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test public void testIssue1148_Flatten_Dot() {
    ParseOptions options = new ParseOptions();
    options.setFlatten(true);
  ...
  @Test public void testIssue1169() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue1169noSplit() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue339() throws Exception {
  ...
  @Test public void testIssue1119() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void testIssue1108() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void testRemoteParameterIssue1094(@Injectable final List<AuthorizationValue> auths) throws Exception {
  ...
  @Test public void testIssue1071() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue1071True() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue1071False() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue1039() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue1015() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setResolveCombinators(true);
  ...
  @Test public void testIssueIntegerDefault() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue901_2() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testIssue1131() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    final OpenAPI openAPI = new OpenAPIV3Parser().readLocation("issue-837-853-1131/main.yaml", null, options).getOpenAPI();
    Assert.assertNotNull(openAPI);
  ...
  @Test public void testIssue811_RefSchema_ToRefSchema() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void issue682() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void issue941() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void issueRelativeRefs2() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testPattern() {
    ...
    Assert.assertEquals(s.getPattern(), "^[A-Z]+$");
  }

  @BeforeClass private void setUpWireMockServer() throws IOException {
    ...
    WireMock.stubFor(get(urlPathMatching("/remote/path")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/yaml").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
    pathFile = FileUtils.readFileToString(new File("src/test/resources/remote_references/remote_schema.yaml"));
    WireMock.stubFor(get(urlPathMatching("/remote/schema")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/yaml").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
    pathFile = FileUtils.readFileToString(new File("src/test/resources/remote_references/remote_responses.yaml.template"));
    pathFile = pathFile.replace("${dynamicPort}", String.valueOf(this.serverPort));
    WireMock.stubFor(get(urlPathMatching("/remote/response")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/yaml").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
    pathFile = FileUtils.readFileToString(new File("src/test/resources/remote_references/remote_requestBody.yaml"));
    WireMock.stubFor(get(urlPathMatching("/remote/requestBody")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/yaml").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
    pathFile = FileUtils.readFileToString(new File("src/test/resources/remote_references/remote_parameter.yaml.template"));
    pathFile = pathFile.replace("${dynamicPort}", String.valueOf(this.serverPort));
    WireMock.stubFor(get(urlPathMatching("/remote/parameter")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/yaml").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
    pathFile = FileUtils.readFileToString(new File("src/test/resources/remote_references/remote_example.yaml"));
    WireMock.stubFor(get(urlPathMatching("/remote/example")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/yaml").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
    pathFile = FileUtils.readFileToString(new File("src/test/resources/remote_references/remote_link.yaml"));
    WireMock.stubFor(get(urlPathMatching("/remote/link")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/yaml").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
    pathFile = FileUtils.readFileToString(new File("src/test/resources/remote_references/remote_callback.yaml"));
    WireMock.stubFor(get(urlPathMatching("/remote/callback")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/yaml").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
    pathFile = FileUtils.readFileToString(new File("src/test/resources/remote_references/remote_securityScheme.yaml"));
    WireMock.stubFor(get(urlPathMatching("/remote/security")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/yaml").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
    pathFile = FileUtils.readFileToString(new File("src/test/resources/oas4.yaml"));
    WireMock.stubFor(get(urlPathMatching("/remote/spec")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/yaml").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
    pathFile = FileUtils.readFileToString(new File("src/test/resources/flatten.json"));
    WireMock.stubFor(get(urlPathMatching("/remote/json")).willReturn(aResponse().withStatus(HttpURLConnection.HTTP_OK).withHeader("Content-type", "application/json").withBody(pathFile.getBytes(StandardCharsets.UTF_8))));
  }

  @AfterClass private void tearDownWireMockServer() {
    this.wireMockServer.stop();
  }

  @Test public void test30(@Injectable final List<AuthorizationValue> auths) throws Exception {
  ...
  @Test public void testResolveFully() throws Exception {
    String pathFile = FileUtils.readFileToString(new File("src/test/resources/oas3.yaml.template"));
    pathFile = pathFile.replace("${dynamicPort}", String.valueOf(this.serverPort));
    ParseOptions options = new ParseOptions();
    options.setResolveFully(true);
  ...
  @Test public void issue1455_testResolveFullyV2_shouldNotThrowNPE() throws Exception {
  ...
  @Test public void testResolveEmpty(@Injectable final List<AuthorizationValue> auths) throws Exception {
  ...
  @Test public void testResolveFullyExample() throws Exception {
    String pathFile = FileUtils.readFileToString(new File("src/test/resources/oas3.yaml.template"));
    pathFile = pathFile.replace("${dynamicPort}", String.valueOf(this.serverPort));
    ParseOptions options = new ParseOptions();
    options.setResolveFully(true);
  ...
  @Test public void testInlineModelResolver(@Injectable final List<AuthorizationValue> auths) throws Exception {
  ...
  @Test public void testRemotePathItemIssue1103(@Injectable final List<AuthorizationValue> auths) throws Exception {
  ...
  @Test public void testRemoteParameterIssue1103(@Injectable final List<AuthorizationValue> auths) throws Exception {
    OpenAPI result = new OpenAPIV3Parser().read("issue-1103/remote-parameter-swagger.yaml");
    Assert.assertNotNull(result);
    Assert.assertEquals(result.getPaths().get("/Translation/{lang}").getPut().getParameters().get(0).getName(), "lang");
  }

  @Test public void test30NoOptions(@Injectable final List<AuthorizationValue> auths) throws Exception {
    String pathFile = FileUtils.readFileToString(new File("src/test/resources/oas3.yaml.template"));
    pathFile = pathFile.replace("${dynamicPort}", String.valueOf(this.serverPort));
  ...
  @Test public void testShellMethod(@Injectable final List<AuthorizationValue> auths) {
  ...
  @Test public void testIssue1105() throws Exception {
  ...
  @Test public void testRefAdditionalProperties() throws Exception {
  ...
  @Test public void testRefAndInlineAllOf(@Injectable final List<AuthorizationValue> auths) throws Exception {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setResolveFully(true);
  ...
  @Test public void testComposedRefResolvingIssue628(@Injectable final List<AuthorizationValue> auths) throws Exception {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testComposedSchemaAdjacent(@Injectable final List<AuthorizationValue> auths) throws Exception {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    OpenAPI openAPI = new OpenAPIV3Parser().read("src/test/resources/composedSchemaRef.yaml", auths, options);
    Assert.assertNotNull(openAPI);
  ...
  @Test public void testOneOfExternalRefConflictName() throws Exception {
  ...
  @Test public void int64ExampleWithoutOverflow() throws Exception {
  ...
  @Test public void testRefPaths() throws Exception {
  ...
  @Test public void testModelParameters() throws Exception {
    String yaml = "openapi: \'2.0\'\n" + "info:\n" + "  version: \"0.0.0\"\n" + "  title: test\n" + "paths:\n" + "  /foo:\n" + "    get:\n" + "      parameters:\n" + "      - name: amount\n" + "        in: body\n" + "        schema:\n" + "          type: integer\n" + "          format: int64\n" + "          description: amount of money\n" + "          default: 1000\n" + "          maximum: 100000\n" + "      responses:\n" + "        200:\n" + "          description: ok";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    OpenAPI openAPI = (parser.readContents(yaml, null, null)).getOpenAPI();
  }

  @Test public void testParseSharedPathParameters() throws Exception {
    String yaml = "openapi: \'3.0.0\'\n" + "info:\n" + "  version: \"0.0.0\"\n" + "  title: test\n" + "paths:\n" + "  /persons/{id}:\n" + "    parameters:\n" + "      - in: path\n" + "        name: id\n" + "        type: string\n" + "        required: true\n" + "        description: \"no\"\n" + "    get:\n" + "      parameters:\n" + "        - name: id\n" + "          in: path\n" + "          required: true\n" + "          type: string\n" + "          description: \"yes\"\n" + "        - name: name\n" + "          in: query\n" + "          type: string\n" + "      responses:\n" + "        200:\n" + "          description: ok\n";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    OpenAPI openAPI = (parser.readContents(yaml, null, null)).getOpenAPI();
  ...
  @Test public void testParseRefPathParameters() throws Exception {
    String yaml = "openAPI: \'2.0\'\n" + "info:\n" + "  title: test\n" + "  version: \'0.0.0\'\n" + "parameters:\n" + "  report-id:\n" + "    name: id\n" + "    in: path\n" + "    type: string\n" + "    required: true\n" + "paths:\n" + "  /reports/{id}:\n" + "    parameters:\n" + "        - $ref: \'#/parameters/report-id\'\n" + "    put:\n" + "      parameters:\n" + "        - name: id\n" + "          in: body\n" + "          required: true\n" + "          schema:\n" + "            $ref: \'#/components/schemas/report\'\n" + "      responses:\n" + "        200:\n" + "          description: ok\n" + "definitions:\n" + "  report:\n" + "    type: object\n" + "    properties:\n" + "      id:\n" + "        type: string\n" + "      name:\n" + "        type: string\n" + "    required:\n" + "    - id\n" + "    - name\n";
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    OpenAPI openAPI = (parser.readContents(yaml, null, null)).getOpenAPI();
  }

  @Test public void testUniqueParameters() throws Exception {
  ...
  @Test public void testLoadRelativeFileTree_Json() throws Exception {
    final OpenAPI openAPI = doRelativeFileTest("src/test/resources/relative-file-references/json/parent.json");
  }

  @Test public void testLoadExternalNestedDefinitions() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void testLoadExternalNestedDefinitionsWithReferenceWithinSubfolder() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ...
    String greetingMessageRef = ((Schema) definitions.get("GreetingResponse").getProperties().get("GreetingMessage")).get$ref();
    ...
    String description = ((Schema) definitions.get("greeting-message").getProperties().get("Text")).getDescription();
    assertEquals(description, "Text message");
  }

  @Test public void testLoadExternalNestedDefinitionsWithReferenceWithinSameFolder() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void testLoadExternalNestedDefinitionsWithReferenceOnDifferentFolderLevels() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void testFileReferenceWithVendorExt() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void testTroublesomeFile() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    final OpenAPI openAPI = parser.read("src/test/resources/troublesome.yaml");
  }

  @Test public void testLoadRelativeFileTree_Yaml() throws Exception {
    JsonToYamlFileDuplicator.duplicateFilesInYamlFormat("src/test/resources/relative-file-references/json", "src/test/resources/relative-file-references/yaml");
  ...
  @Test public void testLoadRecursiveExternalDef() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void testLoadNestedItemsReferences() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test(enabled = false, description = "see https://github.com/openAPI-api/openAPI-parser/issues/337") public void testIssue62() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test(description = "Test (path & form) parameter\'s required attribute") public void testParameterRequired() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void testIssue292WithCSVCollectionFormat() {
  ...
  @Test public void testRelativePath2() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  private void assertParamDetails(List<Parameter> parameters, int index, Class<?> expectedType, String expectedName, String expectedIn) {
  ...
  @Test public void testNestedReferences() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void testCodegenPetstore() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void testCodegenIssue4555() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
  ...
  @Test public void testConverterIssue17() throws Exception {
    String yaml = "openapi: 3.0.0\n" + "info:\n" + "  version: 0.0.0\n" + "  title: nada\n" + "paths:\n" + "  /persons:\n" + "    get:\n" + "      parameters:\n" + "        - name: testParam\n" + "          in: query\n" + "          style: form\n" + "          schema:\n" + "            type: array\n" + "            items:\n" + "              type: string\n" + "      responses:\n" + "        \'200\':\n" + "          description: Successful response\n" + "          content:\n" + "            \'*/*\':\n" + "              schema:\n" + "                $ref: \'#/components/schemas/Content\'\n" + "components:\n" + "  schemas:\n" + "    Content:\n" + "      type: object";
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testIncompatibleRefs() {
    String yaml = "openapi: 3.0.0\n" + "servers: []\n" + "paths:\n" + "  /test:\n" + "    post:\n" + "      responses:\n" + "        \'200\':\n" + "          $ref: \'#/components/schemas/Schema\'\n" + "        \'400\':\n" + "          definitions: this is right\n" + "          description: Bad Request\n" + "          content:\n" + "            \'*/*\':\n" + "              schema:\n" + "                $ref: \'#/components/schemas/Schema\'\n" + "      requestBody:\n" + "        content:\n" + "          application/json:\n" + "            schema:\n" + "              $ref: \'#/components/schemas/Schema\'\n" + "        required: true\n" + "info:\n" + "  version: \'\'\n" + "  title: \'\'\n" + "components:\n" + "  schemas:\n" + "    Schema: {}";
    SwaggerParseResult result = new OpenAPIV3Parser().readContents(yaml, null, null);
    assertNotNull(result.getOpenAPI());
  }

  @Test public void testIssue243() {
    String yaml = "openapi: 3.0.0\n" + "servers: []\n" + "info:\n" + "  version: 0.0.0\n" + "  title: Simple API\n" + "paths:\n" + "  /:\n" + "    get:\n" + "      responses:\n" + "        \'200\':\n" + "          description: OK\n" + "          content:\n" + "            \'*/*\':\n" + "              schema:\n" + "                $ref: \'#/components/schemas/Simple\'\n" + "components:\n" + "  schemas:\n" + "    Simple:\n" + "      type: string";
    SwaggerParseResult result = new OpenAPIV3Parser().readContents(yaml, null, null);
    assertNotNull(result.getOpenAPI());
  }

  @Test public void testIssue594() {
  ...
  @Test public void checkAllOfAreTaken() {
  ...
  @Test public void checkPathParameterRequiredValue() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test(description = "Issue #616 Relative references inside of \'allOf\'") public void checkAllOfWithRelativeReferencesAreFound() {
  ...
  @Test(description = "Issue #616 Relative references inside of \'allOf\'") public void checkAllOfWithRelativeReferencesIssue604() {
    OpenAPI openAPI = new OpenAPIV3Parser().read("src/test/resources/allOf-relative-file-references/swagger.yaml");
    assertEquals(2, openAPI.getComponents().getSchemas().size());
  }

  @Test(description = "A string example should not be over quoted when parsing a yaml string") public void readingSpecStringShouldNotOverQuotingStringExample() throws Exception {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolve(false);
  ...
  @Test(description = "A string example should not be over quoted when parsing a yaml node") public void readingSpecNodeShouldNotOverQuotingStringExample() throws Exception {
  ...
  @Test(description = "Issue 855: Request Body internal refs are not being resolved") public void shouldParseRequestBody() {
  ...
  @Test public void testLinkIssue() {
    ParseOptions parseOptions = new ParseOptions();
    parseOptions.setResolveFully(true);
  ...
  @SuppressWarnings(value = { "unchecked" }) private Map<String, Schema> issue975ExtractPropertiesFromTestResource() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test(description = "Test that relative references are resolvable when property is a reference to a relative file.") public void testIssue975_property() {
  ...
  @Test(description = "Test that relative references are resolvable when property is an array with a reference to a relative file.") public void testIssue975_array() {
    Map<String, Schema> properties = issue975ExtractPropertiesFromTestResource();
  ...
  @Test(description = "Test that relative references are resolvable when property is a map with a reference to a relative file.") public void testIssue975_map() {
    Map<String, Schema> properties = issue975ExtractPropertiesFromTestResource();
  ...
  @Test(description = "Test that relative references are resolvable when property is an array with a map with a reference to a relative file.") public void testIssue975_array_map() {
    Map<String, Schema> properties = issue975ExtractPropertiesFromTestResource();
  ...
  @Test(description = "Test that relative references are resolvable when property is a map with an array with a reference to a relative file.") public void testIssue975_map_array() {
    Map<String, Schema> properties = issue975ExtractPropertiesFromTestResource();
    ArraySchema imagesArray = (ArraySchema) properties.get("imagesMapArray").getAdditionalProperties();
    assertEquals(imagesArray.getItems().get$ref(), "#/components/schemas/Image");
  }

  @Test(description = "Test that relative references are resolvable when property is an array with an array with a reference to a relative file.") public void testIssue975_array_array() {
    Map<String, Schema> properties = issue975ExtractPropertiesFromTestResource();
  ...
  @Test(description = "Test that relative references are resolvable when property is a map with a map with a reference to a relative file.") public void testIssue975_map_map() {
    Map<String, Schema> properties = issue975ExtractPropertiesFromTestResource();
  ...
  @Test(description = "Test that relative references are resolvable when property is an oneOf a reference to a relative file.") public void testIssue975_oneOf() {
    Map<String, Schema> properties = issue975ExtractPropertiesFromTestResource();
  ...
  @Test(description = "Test that relative references are resolvable when property is an anyOf a reference to a relative file.") public void testIssue975_anyOf() {
    Map<String, Schema> properties = issue975ExtractPropertiesFromTestResource();
  ...
  @Test(description = "Test that relative references are resolvable when property is an allOf a reference to a relative file.") public void testIssue975_allOf() {
    Map<String, Schema> properties = issue975ExtractPropertiesFromTestResource();
  ...
  @Test public void testValidationIssue() {
    ParseOptions parseOptions = new ParseOptions();
    parseOptions.setResolveFully(true);
  ...
  @Test public void shouldParseExternalSchemaModelHavingReferenceToItsLocalModel() {
  ...
  @Test(description = "Test that extensions can be found on the class classloader in addition to tccl.") public void testIssue1003_ExtensionsClassloader() {
  ...
  @Test public void shouldParseApiWithMultipleParameterReferences() {
  ...
  @Test public void shouldParseApiWithParametersUsingContentvsSchema() {
  ...
  @Test public void testIssue1063() {
  ...
  @Test public void testIssue1177(@Injectable final List<AuthorizationValue> auths) {
  ...
  @Test public void testResolveFullyMap() {
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testParseOptionsSkipMatchesFalse() {
  ...
  @Test public void testParseOptionsSkipMatchesTrue() {
    final String location = "src/test/resources/skipMatches.yaml";
    final ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test public void testIssue1335() {
    final ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testEmptyQueryParameterExample() {
    final ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testBlankQueryParameterExample() {
    final ParseOptions options = new ParseOptions();
    options.setResolve(true);
    SwaggerParseResult result = new OpenAPIV3Parser().readLocation("src/test/resources/blankQueryParameter.yaml", null, options);
    assertEquals(" ", result.getOpenAPI().getPaths().get("/foo").getGet().getParameters().get(0).getExample());
  }

  @Test public void testRegressionIssue1236() {
    final ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testSampleParser() {
  ...
  @Test public void testDuplicateHttpStatusCodesJson() {
  ...
  @Test public void testDuplicateHttpStatusCodesYaml() {
  ...
  @Test public void testDiscriminatorSingleFileNoMapping() throws Exception {
  ...
  @Test public void testDiscriminatorSeparateFileNoMapping() throws Exception {
  ...
  @Test public void testDiscriminatorSingleFilePlainMapping() throws Exception {
  ...
  @Test public void testDiscriminatorSeparateFilePlainMapping() throws Exception {
  ...
  @Test public void testDiscriminatorSingleFileInternalMapping() throws Exception {
  ...
  @Test public void testDiscriminatorSeparateFileInternalMapping() throws Exception {
  ...
  @Test public void testDiscriminatorSameFileExternalMapping() throws Exception {
  ...
  @Test public void testDiscriminatorSeparateFileExternalMapping() throws Exception {
  ...
  @Test public void testRelativePathIssue1543() {
    OpenAPIV3Parser parser = new OpenAPIV3Parser();
    ParseOptions options = new ParseOptions();
    options.setResolveFully(true);
    options.setResolve(true);
  ...
  @Test public void testIssue1540() throws Exception {
  ...
  @Test public void testIssue1592() throws Exception {
  ...
  @Test public void testIssue1266() throws Exception {
  ...
  @Test(description = "option true, adds Original Location to messages when ref is relative/local") public void testValidateExternalRefsTrue() {
    ParseOptions options = new ParseOptions();
  ...
  @Test(description = "test that a model in a folder that has a ref to a model in the classpath is properly resolved.") public void testIssue1891() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setFlatten(true);
  ...
  @Test(description = "directly parsed  definition, tested in previous method as reference relative/local ") public void testValidateDefinition() {
    ParseOptions options = new ParseOptions();
  ...
  @Test(description = "option false, does not add Original Location to messages when ref is relative/local") public void testValidateExternalRefsFalse() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setValidateExternalRefs(false);
    SwaggerParseResult result = new OpenAPIV3Parser().readLocation("./swos-443/root.yaml", null, options);
  ...
  @Test public void testNullExample() throws Exception {
  ...
  @Test public void testInternalRefsValidation() throws Exception {
  ...
  @Test public void testIssue1902_component_example_not_parse_ordinal_json() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    SwaggerParseResult result = new OpenAPIV3Parser().readLocation("src/test/resources/issue1902/1902-string-example-in-component.yaml", null, options);
    Assert.assertNotNull(result);
    Assert.assertNotNull(result.getOpenAPI());
    OpenAPI openAPI = result.getOpenAPI();
