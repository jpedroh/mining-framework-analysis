...
public class OpenAPIV3ParserTest {
  ...
  @Test public void testRemoteParameterIssue1094() throws Exception {
  ...
  @Test public void testRemotePathItemIssue1103() throws Exception {
  ...
  @Test public void testRemoteParameterIssue1103() throws Exception {
  ...
  @Test public void testRefAndInlineAllOf() throws Exception {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    options.setResolveFully(true);
  ...
  @Test public void testComposedRefResolvingIssue628() throws Exception {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
  ...
  @Test public void testComposedSchemaAdjacent() throws Exception {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
    OpenAPI openAPI = new OpenAPIV3Parser().read("src/test/resources/composedSchemaRef.yaml", auths, options);
    Assert.assertNotNull(openAPI);
  ...
  @Test(description = "Test that extensions can be found on the class classloader in addition to tccl.") public void testIssue1003_ExtensionsClassloader() {
    ...
    OpenAPI api = null;
    try {
      final ClassLoader tcclTemp = new java.net.URLClassLoader(new URL[] {  }, ClassLoader.getSystemClassLoader());
  ...
  @Test public void testIssue1177() {
