...
public class CoreServiceTest extends CoreServiceTestEnvironment {
  ...
  @Test public void createWithoutComposite() {
  ...
  @Test public void createWithComposite() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
  ...
  @Test public void onDemandChildTopicLoading() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
  ...
  @Test public void onDemandChildTopicLoadingWithConvenienceAccessor() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      dm4.createTopic(mf.newTopicModel("de.deepamehta.notes", "dm4.core.plugin", mf.newChildTopicsModel().put("dm4.core.plugin_migration_nr", 23)));
      TopicImpl topic = dm4.getTopicByUri("de.deepamehta.notes");
  ...
  @Test public void changeLabelWithSetChildTopics() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
  ...
  @Test public void changeLabelWithChildTopicsSet() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      Topic topic = dm4.createTopic(mf.newTopicModel("dm4.core.plugin"));
      assertEquals("", topic.getSimpleValue().toString());
  ...
  @Test public void setLabelChildWhileChildsAreNotLoaded() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
  ...
  @Test public void setNonlabelChildWhileChildsAreNotLoaded() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      Topic topic = dm4.createTopic(mf.newTopicModel("dm4.core.plugin", mf.newChildTopicsModel().put("dm4.core.plugin_name", "My Plugin").put("dm4.core.plugin_symbolic_name", "dm4.test.my_plugin").put("dm4.core.plugin_migration_nr", 1)));
      assertEquals("My Plugin", topic.getSimpleValue().toString());
  ...
  @Test public void assocDefSequence() {
  ...
  @Test public void insertAssocDefAtPos0() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
  ...
  @Test public void insertAssocDefAtPos1() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.name", "Name", "dm4.core.text"));
  ...
  @Test public void getTopicsByType() {
  ...
  @Test public void getAssociationsByType() {
  ...
  @Test public void retypeAssociation() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    Topic type;
  ...
  @Test public void retypeAssociationRoles() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    Topic type;
    List<RelatedTopic> childTypes;
    try {
  ...
  @Test public void retypeTopicAndTraverse() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    Topic t0;
  ...
  @Test public void retypeAssociationAndTraverse() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    Topic t0;
    List<RelatedAssociation> assocs;
    try {
  ...
  @Test public void retypeTopicAndTraverseInstantiations() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    Topic type;
    List<RelatedTopic> topics;
    try {
  ...
  @Test public void updateAggregationOne() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    TopicImpl comp1;
    Topic item1, item2;
    try {
  ...
  @Test public void updateAggregationOneFacet() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    TopicImpl name;
    Topic item1, item2;
    try {
  ...
  @Test public void createManyChildRefViaModel() {
    DeepaMehtaTransaction tx = dm4.beginTx();
  ...
  @Test public void createManyChildRefViaObject() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    Topic parent1, child1;
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.child", "Child", "dm4.core.text"));
  ...
  @Test public void createManyChildViaObject() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    Topic parent1;
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.child", "Child", "dm4.core.text"));
  ...
  @Test public void createAndUpdateAggregationOne() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.child", "Child", "dm4.core.text"));
  ...
  @Test public void createCompositionWithChildRef() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.child", "Child", "dm4.core.text"));
  ...
  @Test public void createAggregationWithChildRef() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.child", "Child", "dm4.core.text"));
  ...
  @Test public void coreACAssignTopicToWorkspace() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
  ...
  @Test public void coreACAssignAssociationToWorkspace() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      Topic t1 = dm4.createTopic(mf.newTopicModel("dm4.core.plugin"));
