...
public class CoreServiceTest extends CoreServiceTestEnvironment {
  ...
  @Test public void changeLabelWithSetRefComposite() {
    ...
    try {
      ...
      TopicType pn = dm4.createTopicType(mf.newTopicTypeModel("dm4.test.person_name", "Person Name", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.test.person_name", "dm4.test.first_name", "dm4.core.one", "dm4.core.one")).addAssocDef(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.test.person_name", "dm4.test.last_name", "dm4.core.one", "dm4.core.one")));
