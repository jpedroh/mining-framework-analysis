...
public class CoreServiceTest extends CoreServiceTestEnvironment {
  ...
  @Test public void compositeModel() {
    ChildTopicsModel person = mf.newChildTopicsModel().put("dm4.core.name", "Karl Blum").put("dm4.contacts.home_address", mf.newChildTopicsModel().put("dm4.contacts.postal_code", 13206).put("dm4.contacts.city", "Berlin")).put("dm4.contacts.office_address", mf.newChildTopicsModel().put("dm4.contacts.postal_code", 14345).put("dm4.contacts.city", "Berlin"));
    ...
    assertEquals(13206, code);
  }

  @Test public void typeDefinition() throws Exception {
  ...
  @Test public void createWithoutComposite() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      Topic topic = dm4.createTopic(mf.newTopicModel("de.deepamehta.notes", "dm4.core.plugin", new SimpleValue("DeepaMehta 4 Notes")));
  ...
  @Test public void createWithComposite() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      TopicImpl topic = dm4.createTopic(mf.newTopicModel("de.deepamehta.notes", "dm4.core.plugin", mf.newChildTopicsModel().put("dm4.core.plugin_migration_nr", 23)));
  ...
  @Test public void onDemandChildTopicLoading() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      dm4.createTopic(mf.newTopicModel("de.deepamehta.notes", "dm4.core.plugin", mf.newChildTopicsModel().put("dm4.core.plugin_migration_nr", 23)));
      TopicImpl topic = dm4.getTopicByUri("de.deepamehta.notes");
      ChildTopicsImpl comp = topic.getChildTopics();
      assertFalse(comp.has("dm4.core.plugin_migration_nr"));
      Topic childTopic = comp.getTopic("dm4.core.plugin_migration_nr");
      assertEquals(23, childTopic.getSimpleValue().intValue());
      assertTrue(comp.has("dm4.core.plugin_migration_nr"));
      tx.success();
    }
  }

  @Test public void onDemandChildTopicLoadingWithConvenienceAccessor() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      dm4.createTopic(mf.newTopicModel("de.deepamehta.notes", "dm4.core.plugin", mf.newChildTopicsModel().put("dm4.core.plugin_migration_nr", 23)));
      TopicImpl topic = dm4.getTopicByUri("de.deepamehta.notes");
      ChildTopicsImpl comp = topic.getChildTopics();
      assertFalse(comp.has("dm4.core.plugin_migration_nr"));
      assertEquals(23, comp.getInt("dm4.core.plugin_migration_nr"));
      assertTrue(comp.has("dm4.core.plugin_migration_nr"));
      tx.success();
    }
  }

  @Test public void changeLabelWithSetChildTopics() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
  ...
  @Test public void changeLabelWithChildTopicsSet() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      Topic topic = dm4.createTopic(mf.newTopicModel("dm4.core.plugin"));
      assertEquals("", topic.getSimpleValue().toString());
  ...
  @Test public void setLabelChildWhileChildsAreNotLoaded() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      Topic topic = dm4.createTopic(mf.newTopicModel("dm4.core.plugin", mf.newChildTopicsModel().put("dm4.core.plugin_name", "My Plugin").put("dm4.core.plugin_symbolic_name", "dm4.test.my_plugin").put("dm4.core.plugin_migration_nr", 1)));
      assertEquals("My Plugin", topic.getSimpleValue().toString());
      topic = dm4.getTopic(topic.getId());
      assertEquals("My Plugin", topic.getSimpleValue().toString());
      topic.getChildTopics().set("dm4.core.plugin_name", "HuHu");
      assertEquals("HuHu", topic.getSimpleValue().toString());
      tx.success();
    }
  }

  @Test public void setNonlabelChildWhileChildsAreNotLoaded() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      Topic topic = dm4.createTopic(mf.newTopicModel("dm4.core.plugin", mf.newChildTopicsModel().put("dm4.core.plugin_name", "My Plugin").put("dm4.core.plugin_symbolic_name", "dm4.test.my_plugin").put("dm4.core.plugin_migration_nr", 1)));
      assertEquals("My Plugin", topic.getSimpleValue().toString());
      topic = dm4.getTopic(topic.getId());
      assertEquals("My Plugin", topic.getSimpleValue().toString());
      topic.getChildTopics().set("dm4.core.plugin_migration_nr", 3);
      assertEquals("My Plugin", topic.getSimpleValue().toString());
      tx.success();
    }
  }

  @Test public void changeLabelWithSetRefSimple() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.person_name", "Person Name", "dm4.core.text"));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.comment", "Comment", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.test.comment", "dm4.test.person_name", "dm4.core.one", "dm4.core.one")));
  ...
  @Test public void changeLabelWithSetRefComposite() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      ...
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.person_name", "Person Name", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.composition_def", null, true, "dm4.test.person_name", "dm4.test.first_name", "dm4.core.one", "dm4.core.one")).addAssocDef(mf.newAssociationDefinitionModel("dm4.core.composition_def", null, true, "dm4.test.person_name", "dm4.test.last_name", "dm4.core.one", "dm4.core.one")));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.comment", "Comment", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.test.comment", "dm4.test.person_name", "dm4.core.one", "dm4.core.one")));
      Topic karl = dm4.createTopic(mf.newTopicModel("dm4.test.person_name", mf.newChildTopicsModel().put("dm4.test.first_name", "Karl").put("dm4.test.last_name", "Albrecht")));
      assertEquals("Karl Albrecht", karl.getSimpleValue().toString());
      Topic comment = dm4.createTopic(mf.newTopicModel("dm4.test.comment"));
      comment.getChildTopics().setRef("dm4.test.person_name", karl.getId());
      assertEquals(karl.getId(), comment.getChildTopics().getTopic("dm4.test.person_name").getId());
  ...
  @Test public void changeLabelWithSetComposite() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.first_name", "First Name", "dm4.core.text"));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.last_name", "Last Name", "dm4.core.text"));
      ...
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.comment", "Comment", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.test.comment", "dm4.test.person_name", "dm4.core.one", "dm4.core.one")));
      Topic comment = dm4.createTopic(mf.newTopicModel("dm4.test.comment"));
      comment.getChildTopics().set("dm4.test.person_name", mf.newChildTopicsModel().put("dm4.test.first_name", "Karl").put("dm4.test.last_name", "Albrecht"));
      assertEquals("Karl Albrecht", comment.getSimpleValue().toString());
      tx.success();
    }  finally {
      tx.finish();
  ...
  @Test public void hasIncludeInLabel() {
    RelatedTopic includeInLabel = dm4.getTopicType("dm4.core.plugin").getAssocDef("dm4.core.plugin_name").getChildTopics().getTopicOrNull("dm4.core.include_in_label");
    assertNotNull(includeInLabel);
    assertEquals(false, includeInLabel.getSimpleValue().booleanValue());
  }

  @Test public void hasIncludeInLabelForAddedAssocDef() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.date", "Date", "dm4.core.text"));
      dm4.getTopicType("dm4.core.plugin").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.core.plugin", "dm4.test.date", "dm4.core.one", "dm4.core.one"));
      RelatedTopic includeInLabel = dm4.getTopicType("dm4.core.plugin").getAssocDef("dm4.test.date").getChildTopics().getTopicOrNull("dm4.core.include_in_label");
      assertNotNull(includeInLabel);
      assertEquals(false, includeInLabel.getSimpleValue().booleanValue());
      tx.success();
    }  finally {
  ...
  @Test public void setIncludeInLabel() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      TopicTypeImpl tt = dm4.getTopicType("dm4.core.plugin");
      ChildTopics ct = tt.getAssocDef("dm4.core.plugin_name").getChildTopics().set("dm4.core.include_in_label", true);
  ...
  @Test public void setIncludeInLabelWhenCustomAssocTypeIsSet() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.date", "Date", "dm4.core.text"));
      dm4.createAssociationType(mf.newAssociationTypeModel("dm4.test.birthday", "Birthday", "dm4.core.text"));
      TopicTypeImpl tt = dm4.createTopicType(mf.newTopicTypeModel("dm4.test.person", "Person", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.test.birthday", false, "dm4.test.person", "dm4.test.date", "dm4.core.one", "dm4.core.one")));
  ...
  @Test public void editAssocDefViaAssoc() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
  ...
  @Test public void editAssocDefSetCustomAssocType() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      dm4.getTopicType("dm4.core.plugin").getAssocDef("dm4.core.plugin_name").getChildTopics().setRef("dm4.core.assoc_type#dm4.core.custom_assoc_type", "dm4.core.association");
      Topic assocType = dm4.getTopicType("dm4.core.plugin").getAssocDef("dm4.core.plugin_name#dm4.core.association").getChildTopics().getTopic("dm4.core.assoc_type#dm4.core.custom_assoc_type");
  ...
  @Test public void editAssocDefViaAssocSetCustomAssocType() {
    DeepaMehtaTransaction tx = dm4.beginTx();
    try {
      long assocDefId = dm4.getTopicType("dm4.core.plugin").getAssocDef("dm4.core.plugin_name").getId();
      dm4.getAssociation(assocDefId).getChildTopics().setRef("dm4.core.assoc_type#dm4.core.custom_assoc_type", "dm4.core.association");
      Topic assocType = dm4.getTopicType("dm4.core.plugin").getAssocDef("dm4.core.plugin_name#dm4.core.association").getChildTopics().getTopic("dm4.core.assoc_type#dm4.core.custom_assoc_type");
      assertEquals("dm4.core.association", assocType.getUri());
      tx.success();
    }  finally {
  ...
  @Test public void uriUniquenessCreateTopic() {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
  ...
  @Test public void uriUniquenessSetUri() {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
  ...
  @Test public void uriUniquenessUpdate() {
    long topic2Id = -1;
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      Topic topic1 = dm4.createTopic(mf.newTopicModel("dm4.my.uri", "dm4.core.plugin"));
      assertEquals("dm4.my.uri", topic1.getUri());
  ...
  @Test public void assocDefSequence() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      DeepaMehtaType type = dm4.getTopicType("dm4.core.plugin");
      RelatedAssociation assocDef = type.getRelatedAssociation("dm4.core.aggregation", "dm4.core.type", "dm4.core.sequence_start", null);
      logger.info("### assoc def ID 1/3 = " + assocDef.getId() + ", relating assoc ID = " + assocDef.getRelatingAssociation().getId());
      assertNotNull(assocDef);
      assocDef = assocDef.getRelatedAssociation("dm4.core.sequence", "dm4.core.predecessor", "dm4.core.successor", null);
      logger.info("### assoc def ID 2/3 = " + assocDef.getId() + ", relating assoc ID = " + assocDef.getRelatingAssociation().getId());
      assertNotNull(assocDef);
      assocDef = assocDef.getRelatedAssociation("dm4.core.sequence", "dm4.core.predecessor", "dm4.core.successor", null);
      logger.info("### assoc def ID 3/3 = " + assocDef.getId() + ", relating assoc ID = " + assocDef.getRelatingAssociation().getId());
      assertNotNull(assocDef);
      assocDef = assocDef.getRelatedAssociation("dm4.core.sequence", "dm4.core.predecessor", "dm4.core.successor", null);
      assertNull(assocDef);
    }
  ...
  @Test public void insertAssocDefAtPos0() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      DeepaMehtaType type = dm4.getTopicType("dm4.core.plugin");
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.name", "Name", "dm4.core.text"));
      type.addAssocDefBefore(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.core.plugin", "dm4.test.name", "dm4.core.one", "dm4.core.one"), "dm4.core.plugin_name");
      Collection<AssociationDefinition> assocDefs = type.getAssocDefs();
      assertSame(4, assocDefs.size());
      Iterator<AssociationDefinition> i = assocDefs.iterator();
      assertEquals("dm4.test.name", i.next().getChildTypeUri());
      assertEquals("dm4.core.plugin_name", i.next().getChildTypeUri());
      tx.success();
    }
...
=======
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.name", "Name", "dm4.core.text"));
      dm4.getTopicType("dm4.core.plugin").addAssocDefBefore(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.core.plugin", "dm4.test.name", "dm4.core.one", "dm4.core.one"), "dm4.core.plugin_name");
      Collection<AssociationDefinition> assocDefs = dm4.getTopicType("dm4.core.plugin").getAssocDefs();
      assertSame(4, assocDefs.size());
      Iterator<AssociationDefinition> i = assocDefs.iterator();
      assertEquals("dm4.test.name", i.next().getChildTypeUri());
...
>>>>>>> /usr/src/app/output/jri/deepamehta/37172781f64d355147e6e77761d1423e238480c7/modules/dm4-test/src/test/java/de/deepamehta/core/impl/CoreServiceTest.java/right.java
  ...
  @Test public void insertAssocDefAtPos1() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      DeepaMehtaType type = dm4.getTopicType("dm4.core.plugin");
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.name", "Name", "dm4.core.text"));
      type.addAssocDefBefore(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.core.plugin", "dm4.test.name", "dm4.core.one", "dm4.core.one"), "dm4.core.plugin_symbolic_name");
      Collection<AssociationDefinition> assocDefs = type.getAssocDefs();
      assertSame(4, assocDefs.size());
      Iterator<AssociationDefinition> i = assocDefs.iterator();
      assertEquals("dm4.core.plugin_name", i.next().getChildTypeUri());
      assertEquals("dm4.test.name", i.next().getChildTypeUri());
      assertEquals("dm4.core.plugin_symbolic_name", i.next().getChildTypeUri());
      tx.success();
    }
...
=======
    try {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.name", "Name", "dm4.core.text"));
      dm4.getTopicType("dm4.core.plugin").addAssocDefBefore(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.core.plugin", "dm4.test.name", "dm4.core.one", "dm4.core.one"), "dm4.core.plugin_symbolic_name");
      Collection<AssociationDefinition> assocDefs = dm4.getTopicType("dm4.core.plugin").getAssocDefs();
      assertSame(4, assocDefs.size());
      Iterator<AssociationDefinition> i = assocDefs.iterator();
      assertEquals("dm4.core.plugin_name", i.next().getChildTypeUri());
...
>>>>>>> /usr/src/app/output/jri/deepamehta/37172781f64d355147e6e77761d1423e238480c7/modules/dm4-test/src/test/java/de/deepamehta/core/impl/CoreServiceTest.java/right.java
  ...
  @Test public void getTopicsByType() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
  ...
  @Test public void getAssociationsByType() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
...
>>>>>>> /usr/src/app/output/jri/deepamehta/37172781f64d355147e6e77761d1423e238480c7/modules/dm4-test/src/test/java/de/deepamehta/core/impl/CoreServiceTest.java/right.java
  ...
  @Test public void retypeAssociation() throws Exception {
    Topic type;
  ...
  @Test public void retypeAssociationRoles() throws Exception {
    Topic type;
    List<RelatedTopic> childTypes;
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      type = dm4.getTopicByUri("dm4.core.plugin");
  ...
  @Test public void retypeTopicAndTraverse() throws Exception {
    Topic t0;
  ...
  @Test public void retypeAssociationAndTraverse() throws Exception {
    Topic t0;
    List<RelatedAssociation> assocs;
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
  ...
  @Test public void retypeTopicAndTraverseInstantiations() throws Exception {
    Topic type;
    List<RelatedTopic> topics;
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
  ...
  @Test public void updateAggregationOne() throws Exception {
    TopicImpl comp1;
    Topic item1, item2;
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.name", "Name", "dm4.core.text"));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.item", "Item", "dm4.core.text"));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.composite", "Composite", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.test.composite", "dm4.test.name", "dm4.core.one", "dm4.core.one")).addAssocDef(mf.newAssociationDefinitionModel("dm4.core.aggregation_def", "dm4.test.composite", "dm4.test.item", "dm4.core.many", "dm4.core.one")));
      ...
      comp1 = dm4.createTopic(mf.newTopicModel("dm4.test.composite", mf.newChildTopicsModel().put("dm4.test.name", "Composite 1")));
      tx.success();
    }
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
    ...
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      comp1.update(mf.newTopicModel(comp1.getId(), mf.newChildTopicsModel().putRef("dm4.test.item", item2.getId())));
      tx.success();
    }
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      assertEquals("Composite 1", comp1.getChildTopics().getString("dm4.test.name"));
    ...
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      comp1.update(mf.newTopicModel(comp1.getId(), mf.newChildTopicsModel().putRef("dm4.test.item", item1.getId())));
      tx.success();
    }
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      assertEquals("Composite 1", comp1.getChildTopics().getString("dm4.test.name"));
  ...
  @Test public void updateAggregationOneFacet() throws Exception {
    TopicImpl name;
    Topic item1, item2;
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.item", "Item", "dm4.core.text"));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.item_facet", "Item Facet", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.aggregation_def", "dm4.test.item_facet", "dm4.test.item", "dm4.core.many", "dm4.core.one")));
      item1 = dm4.createTopic(mf.newTopicModel("dm4.test.item", new SimpleValue("Item 1")));
      item2 = dm4.createTopic(mf.newTopicModel("dm4.test.item", new SimpleValue("Item 2")));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.name", "Name", "dm4.core.text"));
  ...
  @Test public void createManyChildRefViaModel() throws Exception {
    Topic parent1, child1;
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.child", "Child", "dm4.core.text"));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.parent", "Parent", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.aggregation_def", "dm4.test.parent", "dm4.test.child", "dm4.core.many", "dm4.core.many")));
      child1 = dm4.createTopic(mf.newTopicModel("dm4.test.child", new SimpleValue("Child 1")));
      parent1 = dm4.createTopic(mf.newTopicModel("dm4.test.parent", mf.newChildTopicsModel().addRef("dm4.test.child", child1.getId())));
      tx.success();
    }
  ...
  @Test public void createManyChildRefViaObject() throws Exception {
    Topic parent1, child1;
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.child", "Child", "dm4.core.text"));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.parent", "Parent", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.aggregation_def", "dm4.test.parent", "dm4.test.child", "dm4.core.many", "dm4.core.many")));
  ...
  @Test public void createManyChildViaObject() throws Exception {
    Topic parent1;
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.child", "Child", "dm4.core.text"));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.parent", "Parent", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.aggregation_def", "dm4.test.parent", "dm4.test.child", "dm4.core.many", "dm4.core.many")));
  ...
  @Test public void createAndUpdateAggregationOne() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.child", "Child", "dm4.core.text"));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.parent", "Parent", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.aggregation_def", "dm4.test.parent", "dm4.test.child", "dm4.core.many", "dm4.core.one")));
      Topic parent1 = dm4.createTopic(mf.newTopicModel("dm4.test.parent", mf.newChildTopicsModel().put("dm4.test.child", "Child 1")));
  ...
  @Test public void createCompositionWithChildRef() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.child", "Child", "dm4.core.text"));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.parent", "Parent", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.composition_def", "dm4.test.parent", "dm4.test.child", "dm4.core.one", "dm4.core.one")));
      Topic child1 = dm4.createTopic(mf.newTopicModel("dm4.test.child", new SimpleValue("Child 1")));
      Topic parent1 = dm4.createTopic(mf.newTopicModel("dm4.test.parent", mf.newChildTopicsModel().putRef("dm4.test.child", child1.getId())));
      assertEquals("Child 1", parent1.getChildTopics().getTopic("dm4.test.child").getSimpleValue().toString());
      tx.success();
    }
  }

  @Test public void createAggregationWithChildRef() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.child", "Child", "dm4.core.text"));
      dm4.createTopicType(mf.newTopicTypeModel("dm4.test.parent", "Parent", "dm4.core.composite").addAssocDef(mf.newAssociationDefinitionModel("dm4.core.aggregation_def", "dm4.test.parent", "dm4.test.child", "dm4.core.one", "dm4.core.one")));
      Topic child1 = dm4.createTopic(mf.newTopicModel("dm4.test.child", new SimpleValue("Child 1")));
      Topic parent1 = dm4.createTopic(mf.newTopicModel("dm4.test.parent", mf.newChildTopicsModel().putRef("dm4.test.child", child1.getId())));
      assertEquals("Child 1", parent1.getChildTopics().getTopic("dm4.test.child").getSimpleValue().toString());
      tx.success();
  ...
  @Test public void deleteTopic() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
  ...
  @Test public void coreACAssignTopicToWorkspace() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
  ...
  @Test public void coreACAssignAssociationToWorkspace() throws Exception {
    try (DeepaMehtaTransaction tx = dm4.beginTx()) {
      Topic t1 = dm4.createTopic(mf.newTopicModel("dm4.core.plugin"));
  ...
  private List<RelatedTopic> getTopicInstancesByTraversal(Topic type) {
    return type.getRelatedTopics("dm4.core.instantiation", "dm4.core.type", "dm4.core.instance", type.getUri());
  }

  private List<RelatedAssociation> getAssociationInstancesByTraversal(String assocTypeUri) {
    return dm4.getTopicByUri(assocTypeUri).getRelatedAssociations("dm4.core.instantiation", "dm4.core.type", "dm4.core.instance", assocTypeUri);
  }

  private List<RelatedTopic> getChildTypes(Topic type) {
    return type.getRelatedTopics(asList("dm4.core.aggregation_def", "dm4.core.composition_def"), "dm4.core.parent_type", "dm4.core.child_type", "dm4.core.topic_type");
  }
  ...
  private Association createAssociation(Topic topic1, Topic topic2) {
    return dm4.createAssociation(mf.newAssociationModel("dm4.core.association", mf.newTopicRoleModel(topic1.getId(), "dm4.core.default"), mf.newTopicRoleModel(topic2.getId(), "dm4.core.default")));
  }

  private Association createAssociation(Topic topic, Association assoc) {
    return dm4.createAssociation(mf.newAssociationModel("dm4.core.association", mf.newTopicRoleModel(topic.getId(), "dm4.core.default"), mf.newAssociationRoleModel(assoc.getId(), "dm4.core.default")));
  }

  private List<RelatedTopic> getTestTopics(Topic topic) {
    return topic.getRelatedTopics("dm4.core.association", "dm4.core.default", "dm4.core.default", "dm4.core.plugin");
  }

  private List<RelatedAssociation> getTestAssociations(Topic topic) {
    return topic.getRelatedAssociations("dm4.core.association", "dm4.core.default", "dm4.core.default", "dm4.core.association");
  }
}