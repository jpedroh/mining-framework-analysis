 ...
 */
@ConvertAsProperties(dtd = "-//org.gephi.desktop.datalab//DataTable//EN", autostore = false) @TopComponent.Description(preferredID = "DataTableTopComponent", iconBase = "org/gephi/desktop/datalab/resources/small.png", persistenceType = TopComponent.PERSISTENCE_ALWAYS) @TopComponent.Registration(mode = "editor", openAtStartup = true, roles = { "datalab" }) @ActionID(category = "Window", id = "org.gephi.desktop.datalab.DataTableTopComponent") @ActionReference(path = "Menu/Window", position = 300) @TopComponent.OpenActionRegistration(displayName = "#CTL_DataTableTopComponent", preferredID = "DataTableTopComponent") public class DataTableTopComponent extends TopComponent implements AWTEventListener, DataTablesEventListener {
  ...
  private void initEvents() {
    ...
    }, 0, AUTO_REFRESH_RATE_MILLISECONDS);
    if (dynamicFiltering) {
  ...
  @Override public boolean isAutoRefreshEnabled() {
    return autoRefreshEnabled;
  }

  @Override public void setAutoRefreshEnabled(boolean enabled) {
  ...
  private AvailableColumnsModel getTableAvailableColumnsModel(Table table) {
    if (Lookup.getDefault().lookup(GraphController.class).getGraphModel().getNodeTable() == table) {
      ...
      if (Lookup.getDefault().lookup(GraphController.class).getGraphModel().getEdgeTable() == table) {
  ...
  @Override public void selectNodesTable() {
    SwingUtilities.invokeLater(new Runnable() {
      @Override public void run() {
  ...
  @Override public void selectEdgesTable() {
    SwingUtilities.invokeLater(new Runnable() {
      @Override public void run() {
  ...
  @Override public void refreshCurrentTable() {
    SwingUtilities.invokeLater(new Runnable() {
      @Override public void run() {
        refreshAllOnce();
      }
  ...
  @Override public Node[] getNodeTableSelection() {
    return nodeTable.getElementsFromSelectedRows().toArray(new Node[0]);
  }

  @Override public void setNodeTableSelection(final Node[] nodes) {
    SwingUtilities.invokeLater(new Runnable() {
      @Override public void run() {
  ...
  @Override public Edge[] getEdgeTableSelection() {
    return edgeTable.getElementsFromSelectedRows().toArray(new Edge[0]);
  }

  @Override public void setEdgeTableSelection(final Edge[] edges) {
    SwingUtilities.invokeLater(new Runnable() {
      @Override public void run() {
  ...
  @Override public boolean isNodeTableMode() {
    return isShowingNodesTable();
  }

  @Override public boolean isEdgeTableMode() {
    return isShowingEdgesTable();
  }

  @Override public boolean isShowOnlyVisible() {
    return visibleOnly;
  }

  @Override public void setShowOnlyVisible(boolean showOnlyVisible) {
    visibleOnly = showOnlyVisible;
    refreshCurrentTable();
  }

  @Override public boolean isUseSparklines() {
    return useSparklines;
  }

  @Override public void setUseSparklines(boolean useSparklines) {
  ...
  @Override public boolean isTimeIntervalGraphics() {
    return timeIntervalGraphics;
  }

  @Override public void setTimeIntervalGraphics(boolean timeIntervalGraphics) {
  ...
  @Override public boolean isShowEdgesNodesLabels() {
    return showEdgesNodesLabels;
  }

  @Override public void setShowEdgesNodesLabels(boolean showEdgesNodesLabels) {
    this.showEdgesNodesLabels = showEdgesNodesLabels;
    edgeTable.setShowEdgesNodesLabels(showEdgesNodesLabels);
    refreshCurrentTable();
  }

  @Override public void exportCurrentTable() {
  ...
  private JCommandButton prepareJCommandButton(final GraphModel graphModel, final Table table, final Column[] columns, final AttributeColumnsManipulator acm) {
    ...
    if (!availableColumns.isEmpty()) {
      manipulatorButton.setPopupCallback(new PopupPanelCallback() {
        @Override public JPopupPanel getPopupPanel(JCommandButton jcb) {
  ...
  private void initComponents() {
    ...
    org.openide.awt.Mnemonics.setLocalizedText(nodesButton, org.openide.util.NbBundle.getMessage(DataTableTopComponent.class, "DataTableTopComponent.nodesButton.text"));
    ...
    org.openide.awt.Mnemonics.setLocalizedText(edgesButton, org.openide.util.NbBundle.getMessage(DataTableTopComponent.class, "DataTableTopComponent.edgesButton.text"));
    ...
    org.openide.awt.Mnemonics.setLocalizedText(configurationButton, org.openide.util.NbBundle.getMessage(DataTableTopComponent.class, "DataTableTopComponent.configurationButton.text"));
    ...
    org.openide.awt.Mnemonics.setLocalizedText(boxGlue, org.openide.util.NbBundle.getMessage(DataTableTopComponent.class, "DataTableTopComponent.boxGlue.text"));
    boxGlue.setMaximumSize(new java.awt.Dimension(32767, 32767));
    controlToolbar.add(boxGlue);
    org.openide.awt.Mnemonics.setLocalizedText(labelFilter, org.openide.util.NbBundle.getMessage(DataTableTopComponent.class, "DataTableTopComponent.labelFilter.text"));
    controlToolbar.add(labelFilter);
    filterTextField.setText(org.openide.util.NbBundle.getMessage(DataTableTopComponent.class, "DataTableTopComponent.filterTextField.text"));
    filterTextField.setToolTipText(org.openide.util.NbBundle.getMessage(DataTableTopComponent.class, "DataTableTopComponent.filterTextField.toolTipText"));
    ...
    org.openide.awt.Mnemonics.setLocalizedText(availableColumnsButton, org.openide.util.NbBundle.getMessage(DataTableTopComponent.class, "DataTableTopComponent.availableColumnsButton.text"));
    availableColumnsButton.setToolTipText(org.openide.util.NbBundle.getMessage(DataTableTopComponent.class, "DataTableTopComponent.availableColumnsButton.toolTipText"));
    ...
    org.openide.awt.Mnemonics.setLocalizedText(labelBanner, org.openide.util.NbBundle.getMessage(DataTableTopComponent.class, "DataTableTopComponent.labelBanner.text"));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 0;
    ...
    org.openide.awt.Mnemonics.setLocalizedText(refreshButton, org.openide.util.NbBundle.getMessage(DataTableTopComponent.class, "DataTableTopComponent.refreshButton.text"));
  ...
  @Override protected void componentDeactivated() {
