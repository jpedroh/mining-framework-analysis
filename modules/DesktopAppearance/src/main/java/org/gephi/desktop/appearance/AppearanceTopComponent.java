...
@ConvertAsProperties(dtd = "-//org.gephi.desktop.appearance//Appearance//EN", autostore = false) @TopComponent.Description(preferredID = "AppearanceTopComponent", iconBase = "org/gephi/desktop/appearance/resources/small.png", persistenceType = TopComponent.PERSISTENCE_ALWAYS) @TopComponent.Registration(mode = "rankingmode", openAtStartup = true, roles = { "overview" }) @ActionID(category = "Window", id = "org.gephi.desktop.appearance.AppearanceTopComponent") @ActionReference(path = "Menu/Window", position = 1100) @TopComponent.OpenActionRegistration(displayName = "#CTL_AppearanceAction", preferredID = "AppearanceTopComponent") public class AppearanceTopComponent extends TopComponent implements Lookup.Provider, AppearanceUIModelListener {
  ...
  @Override public void propertyChange(PropertyChangeEvent pce) {
    if (pce.getPropertyName().equals(AppearanceUIModelEvent.MODEL)) {
      ...
      if (pce.getPropertyName().equals(AppearanceUIModelEvent.SELECTED_CATEGORY) || pce.getPropertyName().equals(AppearanceUIModelEvent.SELECTED_ELEMENT_CLASS) || pce.getPropertyName().equals(AppearanceUIModelEvent.SELECTED_TRANSFORMER_UI)) {
        refreshCenterPanel();
        refreshCombo();
        refreshControls();
      } else {
        if (pce.getPropertyName().equals(AppearanceUIModelEvent.SELECTED_FUNCTION)) {
          refreshCenterPanel();
          refreshCombo();
          refreshControls();
        } else {
          if (pce.getPropertyName().equals(AppearanceUIModelEvent.SET_AUTO_APPLY)) {
            refreshControls();
          } else {
            if (pce.getPropertyName().equals(AppearanceUIModelEvent.START_STOP_AUTO_APPLY)) {
              refreshControls();
            } else {
              if (pce.getPropertyName().equals(AppearanceUIModelEvent.SET_LOCAL_SCALE)) {
                refreshControls();
              } else {
                if (pce.getPropertyName().equals(AppearanceUIModelEvent.ATTRIBUTE_LIST)) {
                  refreshCombo();
                } else {
                  if (pce.getPropertyName().equals(AppearanceUIModelEvent.REFRESH_FUNCTION)) {
                    refreshCenterPanel();
                  } else {
                    if (pce.getPropertyName().equals(AppearanceUIModelEvent.SET_TRANSFORM_NULL_VALUES)) {
                      refreshControls();
                      refreshCenterPanel();
                    }
                  }
  ...
  private void refreshCombo() {
    if (model != null && model.getSelectedTransformerUI() != null && model.isAttributeTransformerUI(model.getSelectedTransformerUI())) {
  ...
  private void initComponents() {
    ...
    rankingLocalScaleButton.setToolTipText(org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.localScaleButton.toolTipText"));
    ...
    partitionLocalScaleButton.setToolTipText(org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.partitionLocalScaleButton.toolTipText"));
    ...
    transformNullValuesButton.setToolTipText(org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.transformNullValues.toolTipText"));
    ...
    org.openide.awt.Mnemonics.setLocalizedText(splineButton, org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.splineButton.text"));
    splineButton.setToolTipText(org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.splineButton.toolTipText"));
    ...
    org.openide.awt.Mnemonics.setLocalizedText(applyButton, org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.applyButton.text"));
    applyButton.setToolTipText(org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.applyButton.toolTipText"));
    ...
    stopAutoApplyButton.setSelected(true);
    org.openide.awt.Mnemonics.setLocalizedText(stopAutoApplyButton, org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.stopAutoApplyButton.text"));
    stopAutoApplyButton.setToolTipText(org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.stopAutoApplyButton.toolTipText"));
    ...
    enableAutoButton.setToolTipText(org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.enableAutoButton.toolTipText"));
    ...
    org.openide.awt.Mnemonics.setLocalizedText(autoApplyButton, org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.autoApplyButton.text"));
    autoApplyButton.setToolTipText(org.openide.util.NbBundle.getMessage(AppearanceTopComponent.class, "AppearanceTopComponent.autoApplyButton.toolTipText"));
