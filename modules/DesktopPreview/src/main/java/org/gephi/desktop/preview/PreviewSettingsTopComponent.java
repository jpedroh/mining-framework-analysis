 ...
 */
@ConvertAsProperties(dtd = "-//org.gephi.desktop.preview//PreviewSettings//EN", autostore = false) @TopComponent.Description(preferredID = "PreviewSettingsTopComponent", iconBase = "org/gephi/desktop/preview/resources/settings.png", persistenceType = TopComponent.PERSISTENCE_NEVER) @TopComponent.Registration(mode = "layoutmode", openAtStartup = true, roles = { "preview" }) @ActionID(category = "Window", id = "org.gephi.desktop.preview.PreviewSettingsTopComponent") @ActionReference(path = "Menu/Window", position = 1000) @TopComponent.OpenActionRegistration(displayName = "#CTL_PreviewSettingsTopComponent", preferredID = "PreviewSettingsTopComponent") public final class PreviewSettingsTopComponent extends TopComponent implements PropertyChangeListener {
  ...
  @Override public void propertyChange(PropertyChangeEvent evt) {
    if (evt.getPropertyName().equals(PreviewUIController.SELECT)) {
      ...
      if (evt.getPropertyName().equals(PreviewUIController.REFRESHED)) {
      } else {
        if (evt.getPropertyName().equals(PreviewUIController.REFRESHING)) {
  ...
  private void initComponents() {
    ...
    org.openide.awt.Mnemonics.setLocalizedText(box, org.openide.util.NbBundle.getMessage(PreviewSettingsTopComponent.class, "PreviewSettingsTopComponent.box.text"));
    box.setMaximumSize(new java.awt.Dimension(32767, 32767));
    presetToolbar.add(box);
    saveButton.setIcon(ImageUtilities.loadImageIcon("org/gephi/desktop/preview/resources/save.png", false));
    org.openide.awt.Mnemonics.setLocalizedText(saveButton, org.openide.util.NbBundle.getMessage(PreviewSettingsTopComponent.class, "PreviewSettingsTopComponent.saveButton.text"));
    saveButton.setToolTipText(org.openide.util.NbBundle.getMessage(PreviewSettingsTopComponent.class, "PreviewSettingsTopComponent.saveButton.toolTipText"));
    saveButton.setEnabled(false);
    ...
    labelPreset.setIcon(ImageUtilities.loadImageIcon("org/gephi/desktop/preview/resources/preset.png", false));
    org.openide.awt.Mnemonics.setLocalizedText(labelPreset, org.openide.util.NbBundle.getMessage(PreviewSettingsTopComponent.class, "PreviewSettingsTopComponent.labelPreset.text"));
    labelPreset.setEnabled(false);
    ...
    refreshButton.setIcon(ImageUtilities.loadImageIcon("org/gephi/desktop/preview/resources/refresh.png", false));
    org.openide.awt.Mnemonics.setLocalizedText(refreshButton, org.openide.util.NbBundle.getMessage(PreviewSettingsTopComponent.class, "PreviewSettingsTopComponent.refreshButton.text"));
    refreshButton.setEnabled(false);
    ...
    org.openide.awt.Mnemonics.setLocalizedText(labelRatio, org.openide.util.NbBundle.getMessage(PreviewSettingsTopComponent.class, "PreviewSettingsTopComponent.labelRatio.text"));
    labelRatio.setEnabled(false);
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 0;
    gridBagConstraints.gridy = 2;
    ...
    org.openide.awt.Mnemonics.setLocalizedText(ratioLabel, org.openide.util.NbBundle.getMessage(PreviewSettingsTopComponent.class, "PreviewSettingsTopComponent.ratioLabel.text"));
    ratioLabel.setEnabled(false);
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 1;
    gridBagConstraints.gridy = 2;
    ...
    org.openide.awt.Mnemonics.setLocalizedText(labelExport, org.openide.util.NbBundle.getMessage(PreviewSettingsTopComponent.class, "PreviewSettingsTopComponent.labelExport.text"));
    labelExport.setEnabled(false);
    southToolbar.add(labelExport);
    org.openide.awt.Mnemonics.setLocalizedText(svgExportButton, org.openide.util.NbBundle.getMessage(PreviewSettingsTopComponent.class, "PreviewSettingsTopComponent.svgExportButton.text"));
    svgExportButton.setToolTipText(org.openide.util.NbBundle.getMessage(PreviewSettingsTopComponent.class, "PreviewSettingsTopComponent.svgExportButton.toolTipText"));
    svgExportButton.setEnabled(false);
