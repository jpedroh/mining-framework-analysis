...
public class SpringCodegenTest {
  ...
  @Test public void doAnnotateDatesOnModelParameters() throws IOException {
    ...
    assertFileContains(Paths.get(outputPath + "/src/main/java/org/openapitools/api/ZebrasApi.java"), "AnimalParams");
    assertFileContains(Paths.get(outputPath + "/src/main/java/org/openapitools/model/AnimalParams.java"), "@DateTimeFormat(iso = DateTimeFormat.ISO.DATE)", "@DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)");
    assertFileContains(Paths.get(outputPath + "/src/main/java/org/openapitools/model/AnimalParams.java"), "import org.springframework.format.annotation.DateTimeFormat;");
  }
  ...
  @Test public void generateFormatForDateAndDateTimeQueryParam() throws IOException {
    ...
    generator.setGeneratorPropertyDefault(CodegenConstants.SUPPORTING_FILES, "false");
    generator.opts(input).generate();
    assertFileContains(Paths.get(outputPath + "/src/main/java/org/openapitools/api/ElephantsApi.java"), "import org.springframework.format.annotation.DateTimeFormat;");
    assertFileContains(Paths.get(outputPath + "/src/main/java/org/openapitools/api/ElephantsApi.java"), "@DateTimeFormat(iso = DateTimeFormat.ISO.DATE)");
    assertFileContains(Paths.get(outputPath + "/src/main/java/org/openapitools/api/ZebrasApi.java"), "import org.springframework.format.annotation.DateTimeFormat;");
    assertFileContains(Paths.get(outputPath + "/src/main/java/org/openapitools/api/ZebrasApi.java"), "@DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)");
  }
  ...
  @Test public void shouldGenerateRequestParamForRefParams_3248_Regression() throws IOException {
    ...
    generator.setGeneratorPropertyDefault(CodegenConstants.SUPPORTING_FILES, "false");
    generator.opts(input).generate();
    assertFileContains(Paths.get(outputPath + "/src/main/java/org/openapitools/api/ExampleApi.java"), "@RequestParam(value = \"format\"", "@RequestParam(value = \"query\"");
  }
  ...
  @Test public void shouldGenerateRequestParamForRefParams_3248_RegressionDates() throws IOException {
    ...
    generator.setGeneratorPropertyDefault(CodegenConstants.SUPPORTING_FILES, "false");
    generator.opts(input).generate();
    assertFileContains(Paths.get(outputPath + "/src/main/java/org/openapitools/api/ExampleApi.java"), "@RequestParam(value = \"start\"");
  }
  ...
  @Test public void springcloudWithAsyncHasResponseWrapperCallable() {
    final SpringCodegen codegen = new SpringCodegen();
  ...
  @Test public void testMultipartBoot() throws IOException {
    ...
    assertFileContains(multipartArrayApi.toPath(), "List<MultipartFile> files", "@ApiParam(value = \"Many files\")", "@RequestPart(value = \"files\", required = false)");
    final File multipartSingleApi = files.get("MultipartSingleApi.java");
    assertFileContains(multipartSingleApi.toPath(), "MultipartFile file", "@ApiParam(value = \"One file\")", "@RequestPart(value = \"file\", required = false)");
    final File multipartMixedApi = files.get("MultipartMixedApi.java");
    assertFileContains(multipartMixedApi.toPath(), "MultipartFile file", "@RequestPart(value = \"file\", required = true)", "@Valid @RequestPart(value = \"marker\", required = false)");
  }
  ...
  @Test public void oneOf_5381() throws IOException {
    File output = Files.createTempDirectory("test").toFile().getCanonicalFile();
    output.deleteOnExit();
    String outputPath = output.getAbsolutePath().replace('\\', '/');
  ...
  /**
     ...
     * fix issue #10287
     */
  @Test public void testConfigFileGeneration() {
    final SpringCodegen codegen = new SpringCodegen();
