...
public class ModelUtilsTest {
  ...
  @Test public void testGetUnusedSchemas() {
    final OpenAPI openAPI = TestUtils.parseFlattenSpec("src/test/resources/3_0/unusedSchemas.yaml");
    List<String> unusedSchemas = ModelUtils.getUnusedSchemas(openAPI);
    List<String> expectedUnusedSchemas = Arrays.asList("UnusedObj1", "UnusedObj2", "UnusedObj3", "UnusedObj4", "Parent29", "AChild29", "BChild29", "AChild29_allOf", "BChild29_allOf");
  ...
  @Test public void testReferencedSchema() {
  ...
  @Test public void testReferencedRequestBody() {
  ...
  @Test public void testReferencedApiResponse() {
  ...
  @Test public void testReferencedParameter() {
  ...
  /**
     ...
     */
  @Test public void testComposedSchemasAreNotUnaliased() {
  ...
  /**
     ...
     */
  @Test public void testIsFreeFormObject() {
  ...
  @Test public void testIsSetForValidSet() {
    ArraySchema as = new ArraySchema().items(new StringSchema());
    as.setUniqueItems(true);
    Assert.assertTrue(ModelUtils.isSet(as));
  }

  @Test public void testIsSetFalseForInvalidSet() {
    ArraySchema as = new ArraySchema().items(new StringSchema());
    as.setUniqueItems(false);
    Assert.assertFalse(ModelUtils.isSet(as));
  }

  @Test public void testIsSetFailsForNullSchema() {
    ArraySchema as = null;
    Assert.assertFalse(ModelUtils.isSet(as));
  }

  @Test public void testSimpleRefDecoding() {
