...
public class ConfluenceWikiTest {
  @Test(description = "convert a model with an enum") public void converterTest() {
  ...
  @Test(description = "convert a model with an enum inside a list") public void converterInArrayTest() {
  ...
  @Test(description = "convert a model with an enum inside a list") public void converterInArrayInArrayTest() {
