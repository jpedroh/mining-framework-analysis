...
<<<<<<< /usr/src/app/output/openapitools/openapi-generator/e2671599651e455f56e662e7f91c5cee443edbbf/modules/openapi-generator/src/main/java/org/openapitools/codegen/DefaultGenerator.java/left.java
  private final boolean dryRun;
=======
  private static final String METADATA_DIR = ".openapi-generator";
>>>>>>> /usr/src/app/output/openapitools/openapi-generator/e2671599651e455f56e662e7f91c5cee443edbbf/modules/openapi-generator/src/main/java/org/openapitools/codegen/DefaultGenerator.java/right.java
  ...
  @SuppressWarnings(value = { "unchecked" }) void generateModels(List<File> files, List<Object> allModels, List<String> unusedModels) {
    if (!generateModels) {
  ...
  @Override public List<File> generate() {
    ...
    if (dryRun) {
      ...
      if (generateMetadata) {
        ...
        Optional.of(files).map(Collection::stream).orElseGet(Stream::empty).filter(Objects::nonNull).map(File::toPath).sorted(Path::compareTo).forEach((f) -> {
