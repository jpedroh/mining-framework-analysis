...
<<<<<<< /usr/src/app/output/openapitools/openapi-generator/a1c75d77d04f010ada34c2b6d4223a62d9630087/modules/openapi-generator/src/main/java/org/openapitools/codegen/languages/PythonNextgenClientCodegen.java/left.java
  allowStringInDateTimeParameters = false
=======
...
>>>>>>> /usr/src/app/output/openapitools/openapi-generator/a1c75d77d04f010ada34c2b6d4223a62d9630087/modules/openapi-generator/src/main/java/org/openapitools/codegen/languages/PythonNextgenClientCodegen.java/right.java
  ...
  public PythonNextgenClientCodegen() {
    ...
    setReservedWordsLowerCase(Arrays.asList("schema", "base64", "json", "date", "property", "and", "del", "from", "not", "while", "as", "elif", "global", "or", "with", "assert", "else", "if", "pass", "yield", "break", "except", "import", "print", "class", "exec", "in", "raise", "continue", "finally", "is", "return", "def", "for", "lambda", "try", "self", "nonlocal", "None", "True", "False", "async", "await"));
...
<<<<<<< /usr/src/app/output/openapitools/openapi-generator/a1c75d77d04f010ada34c2b6d4223a62d9630087/modules/openapi-generator/src/main/java/org/openapitools/codegen/languages/PythonNextgenClientCodegen.java/left.java
    ALLOW_STRING_IN_DATETIME_PARAMETERS
=======
    FLOAT_STRICT_TYPE
>>>>>>> /usr/src/app/output/openapitools/openapi-generator/a1c75d77d04f010ada34c2b6d4223a62d9630087/modules/openapi-generator/src/main/java/org/openapitools/codegen/languages/PythonNextgenClientCodegen.java/right.java
    , 
<<<<<<< /usr/src/app/output/openapitools/openapi-generator/a1c75d77d04f010ada34c2b6d4223a62d9630087/modules/openapi-generator/src/main/java/org/openapitools/codegen/languages/PythonNextgenClientCodegen.java/left.java
    "Allow string as input to datetime/date parameters for backward compartibility."
=======
    "Use strict type for float, i.e. StrictFloat or confloat(strict=true, ...)"
>>>>>>> /usr/src/app/output/openapitools/openapi-generator/a1c75d77d04f010ada34c2b6d4223a62d9630087/modules/openapi-generator/src/main/java/org/openapitools/codegen/languages/PythonNextgenClientCodegen.java/right.java
...
>>>>>>> /usr/src/app/output/openapitools/openapi-generator/a1c75d77d04f010ada34c2b6d4223a62d9630087/modules/openapi-generator/src/main/java/org/openapitools/codegen/languages/PythonNextgenClientCodegen.java/right.java
  ...
  private String getPydanticType(CodegenParameter cp, Set<String> typingImports, Set<String> pydanticImports, Set<String> datetimeImports, Set<String> modelImports) {
    if (cp == null) {
    ...
    if (cp.isArray) {
      ...
      if (cp.isMap) {
        ...
        if (cp.isString || cp.isBinary || cp.isByteArray) {
          if (cp.hasValidation) {
          ...
          if (cp.isNumber || cp.isFloat || cp.isDouble) {
            if (cp.hasValidation) {
              ...
              return String.format(Locale.ROOT, "%s(%s)", "confloat", StringUtils.join(fieldCustomization, ", "));
            } else {
              if (floatStrictType) {
            ...
            if (cp.isInteger || cp.isLong || cp.isShort || cp.isUnboundedInteger) {
              if (cp.hasValidation) {
                ...
                return String.format(Locale.ROOT, "%s(%s)", "conint", StringUtils.join(fieldCustomization, ", "));
              } else {
  ...
  private String getPydanticType(CodegenProperty cp, Set<String> typingImports, Set<String> pydanticImports, Set<String> datetimeImports, Set<String> modelImports) {
    if (cp == null) {
      LOGGER.warn("Codegen property is null (e.g. map/dict of undefined type). Default to string (StrictStr in Pydantic)");
      pydanticImports.add("StrictStr");
      return "StrictStr";
  ...
  @Override public OperationsMap postProcessOperationsWithModels(OperationsMap objs, List<ModelMap> allModels) {
    ...
    for (CodegenOperation operation : operations) {
      ...
      for (CodegenParameter param : params) {
        ...
        if (param.isArray && param.getUniqueItems()) {
      ...
      if (!StringUtils.isEmpty(operation.returnType)) {
        String typing = getPydanticType(operation.returnProperty, typingImports, new TreeSet<>(), datetimeImports, modelImports);
      }
    }
  ...
  private ModelsMap postProcessModelsMap(ModelsMap objs) {
    ...
    for (ModelMap m : objs.getModels()) {
      ...
      for (CodegenProperty cp : codegenProperties) {
        ...
        if (cp.isArray && cp.getUniqueItems()) {
          fields.add("unique_items=True");
        }
        String fieldCustomization;
        if ("None".equals(firstField)) {
