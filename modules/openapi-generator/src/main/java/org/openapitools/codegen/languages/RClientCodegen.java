...
public class RClientCodegen extends DefaultCodegen implements CodegenConfig {
  ...
  public RClientCodegen() {
    ...
    setReservedWordsLowerCase(Arrays.asList("if", "else", "repeat", "while", "function", "for", "in", "next", "break", "TRUE", "FALSE", "NULL", "Inf", "NaN", "NA", "NA_integer_", "NA_real_", "NA_complex_", "NA_character_", "ApiResponse"));
