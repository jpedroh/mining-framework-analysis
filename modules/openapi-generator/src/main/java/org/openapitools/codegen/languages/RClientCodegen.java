...
public class RClientCodegen extends DefaultCodegen implements CodegenConfig {
  ...
  public RClientCodegen() {
    ...
    setReservedWordsLowerCase(Arrays.asList("if", "else", "repeat", "while", "function", "for", "in", "next", "break", "TRUE", "FALSE", "NULL", "Inf", "NaN", "NA", "NA_integer_", "NA_real_", "NA_complex_", "NA_character_", "ApiResponse", "data_file"));
    ...
    importMapping.clear();
    cliOptions.clear();
    cliOptions.add(new CliOption(CodegenConstants.PACKAGE_NAME, "R package name (convention: lowercase).").defaultValue("openapi"));
    cliOptions.add(new CliOption(CodegenConstants.PACKAGE_VERSION, "R package version.").defaultValue("1.0.0"));
    ...
    cliOptions.add(new CliOption(CodegenConstants.EXCEPTION_ON_FAILURE, CodegenConstants.EXCEPTION_ON_FAILURE_DESC).defaultValue(Boolean.FALSE.toString()));
