...
public class CrystalClientCodegen extends DefaultCodegen {
  ...
  @Override public String getSchemaType(Schema schema) {
  ...
  @Override public String toApiFilename(final String name) {
      ...
      if (ModelUtils.isStringSchema(p)) {
        if (p.getDefault() != null) {
          if (p.getDefault() instanceof Date) {
            ...
            if (p.getDefault() instanceof java.time.OffsetDateTime) {
  ...
  @Override public String toVarName(final String name) {
    String varName;
  ...
  @Override public void postProcessFile(File file, String fileType) {
    ...
    if ("cr".equals(FilenameUtils.getExtension(file.toString()))) {
      ...
      try {
        ...
        if (exitValue != 0) {
          try (InputStreamReader inputStreamReader = new InputStreamReader(p.getErrorStream(), StandardCharsets.UTF_8); BufferedReader br = new BufferedReader(inputStreamReader)) {
