...
public class TypeScriptAngularClientCodegen extends AbstractTypeScriptClientCodegen {
  ...
  public TypeScriptAngularClientCodegen() {
    ...
    this.cliOptions.add(new CliOption(TAGGED_UNIONS, "Use discriminators to create tagged unions instead of extending interfaces.", SchemaTypeUtil.BOOLEAN_TYPE).defaultValue(Boolean.FALSE.toString()));
  ...
  @Override public void processOpts() {
    ...
    if (ngVersion.atLeast("6.0.0")) {
      if (!additionalProperties.containsKey(PROVIDED_IN_ROOT)) {
        ...
        additionalProperties.put(PROVIDED_IN_ROOT, Boolean.valueOf((String) additionalProperties.get(PROVIDED_IN_ROOT)));
      }
    } else {
  ...
  @Override public boolean isDataTypeFile(final String dataType) {
  ...
  @Override public Map<String, Object> postProcessOperationsWithModels(Map<String, Object> operations, List<Object> allModels) {
...
<<<<<<< /usr/src/app/output/openapitools/openapi-generator/3c436a83518c2050d9e0adb32db72173adeb810b/modules/openapi-generator/src/main/java/org/openapitools/codegen/languages/TypeScriptAngularClientCodegen.java/left.java
    this.convertUsingFileNamingConvention(name)
=======
    org.openapitools.codegen.utils.StringUtils.camelize(removeModelSuffixIfNecessary(name), true)
...
<<<<<<< /usr/src/app/output/openapitools/openapi-generator/3c436a83518c2050d9e0adb32db72173adeb810b/modules/openapi-generator/src/main/java/org/openapitools/codegen/languages/TypeScriptAngularClientCodegen.java/left.java
    this.convertUsingFileNamingConvention(name)
=======
    org.openapitools.codegen.utils.StringUtils.camelize(removeModelSuffixIfNecessary(modelName), true)
>>>>>>> /usr/src/app/output/openapitools/openapi-generator/3c436a83518c2050d9e0adb32db72173adeb810b/modules/openapi-generator/src/main/java/org/openapitools/codegen/languages/TypeScriptAngularClientCodegen.java/right.java
     + modelFileSuffix;
  }
