...
public class JavaClientCodegen extends AbstractJavaCodegen implements BeanValidationFeatures, PerformBeanValidationFeatures, GzipFeatures {
  ...
  public JavaClientCodegen() {
    super();
    modifyFeatureSet((features) -> features.includeDocumentationFeatures(DocumentationFeature.Readme).includeGlobalFeatures(GlobalFeature.ParameterizedServer));
  ...
  @Override public void processOpts() {
    if ((WEBCLIENT.equals(getLibrary()) && "threetenbp".equals(dateLibrary)) || NATIVE.equals(getLibrary())) {
      ...
      if (MICROPROFILE.equals(getLibrary()) && "threetenbp".equals(dateLibrary)) {
        dateLibrary = "legacy";
      }
    }
    super.processOpts();
    if (additionalProperties.containsKey(USE_RX_JAVA) && additionalProperties.containsKey(USE_RX_JAVA2) && additionalProperties.containsKey(USE_RX_JAVA3)) {
      ...
      if (additionalProperties.containsKey(USE_RX_JAVA) && additionalProperties.containsKey(USE_RX_JAVA2)) {
        ...
        if (additionalProperties.containsKey(USE_RX_JAVA) && additionalProperties.containsKey(USE_RX_JAVA3)) {
        ...
        if (RETROFIT_2.equals(getLibrary())) {
          ...
          if (JERSEY2.equals(getLibrary())) {
            ...
            if (NATIVE.equals(getLibrary())) {
              ...
              if (RESTEASY.equals(getLibrary())) {
                setJava8ModeAndAdditionalProperties(true);
                supportingFiles.add(new SupportingFile("JSON.mustache", invokerFolder, "JSON.java"));
                forceSerializationLibrary(SERIALIZATION_LIBRARY_JACKSON);
              } else {
                if (JERSEY1.equals(getLibrary())) {
                  forceSerializationLibrary(SERIALIZATION_LIBRARY_JACKSON);
                } else {
                  if (RESTTEMPLATE.equals(getLibrary())) {
                    ...
                    if (WEBCLIENT.equals(getLibrary())) {
                      ...
                      if (VERTX.equals(getLibrary())) {
                        ...
                        if (GOOGLE_API_CLIENT.equals(getLibrary())) {
                          forceSerializationLibrary(SERIALIZATION_LIBRARY_JACKSON);
                        } else {
                          if (REST_ASSURED.equals(getLibrary())) {
    ...
    if (usePlayWS) {
      ...
      if (PLAY_24.equals(playVersion)) {
        ...
        supportingFiles.add(new SupportingFile("play24/Play24CallAdapterFactory.mustache", invokerFolder, "Play24CallAdapterFactory.java"));
      }
      ...
      if (PLAY_26.equals(playVersion)) {
        ...
        supportingFiles.add(new SupportingFile("play26/Play26CallAdapterFactory.mustache", invokerFolder, "Play26CallAdapterFactory.java"));
        setJava8ModeAndAdditionalProperties(true);
      }
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public Map<String, Object> postProcessOperationsWithModels(Map<String, Object> objs, List<Object> allModels) {
  ...
  static List<Map<String, String>> prioritizeContentTypes(List<Map<String, String>> consumes) {
    ...
    for (Map<String, String> consume : consumes) {
      if (isJsonVendorMimeType(consume.get(MEDIA_TYPE))) {
        ...
        if (isJsonMimeType(consume.get(MEDIA_TYPE))) {
  ...
  public void setSerializationLibrary(String serializationLibrary) {
    if (SERIALIZATION_LIBRARY_JACKSON.equalsIgnoreCase(serializationLibrary)) {
      ...
      if (SERIALIZATION_LIBRARY_GSON.equalsIgnoreCase(serializationLibrary)) {
        this.serializationLibrary = SERIALIZATION_LIBRARY_GSON;
      } else {
        if (SERIALIZATION_LIBRARY_JSONB.equalsIgnoreCase(serializationLibrary)) {
  ...
  public void forceSerializationLibrary(String serializationLibrary) {
    if ((this.serializationLibrary != null) && !this.serializationLibrary.equalsIgnoreCase(serializationLibrary)) {
      LOGGER.warn("The configured serializationLibrary \'{}\', is not supported by the library: \'{}\', switching back to: {}", this.serializationLibrary, getLibrary(), serializationLibrary);
    }
