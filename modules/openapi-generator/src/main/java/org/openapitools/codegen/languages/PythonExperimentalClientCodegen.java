...
public class PythonExperimentalClientCodegen extends AbstractPythonCodegen {
  ...
  public PythonExperimentalClientCodegen() {
    ...
    modifyFeatureSet((features) -> features.includeSchemaSupportFeatures(SchemaSupportFeature.Simple, SchemaSupportFeature.Composite, SchemaSupportFeature.Polymorphism, SchemaSupportFeature.Union).includeDocumentationFeatures(DocumentationFeature.Readme).wireFormatFeatures(EnumSet.of(WireFormatFeature.JSON, WireFormatFeature.Custom)).securityFeatures(EnumSet.of(SecurityFeature.BasicAuth, SecurityFeature.BearerToken, SecurityFeature.ApiKey, SecurityFeature.OAuth2_Implicit)).includeGlobalFeatures(GlobalFeature.ParameterizedServer, GlobalFeature.ParameterStyling).excludeGlobalFeatures(GlobalFeature.XMLStructureDefinitions, GlobalFeature.Callbacks, GlobalFeature.LinkObjects).excludeSchemaSupportFeatures().excludeParameterFeatures(ParameterFeature.Cookie));
    importMapping.clear();
    modelPackage = "model";
    apiPackage = "api";
    ...
    cliOptions.clear();
    cliOptions.add(new CliOption(CodegenConstants.PACKAGE_NAME, "python package name (convention: snake_case).").defaultValue("openapi_client"));
    cliOptions.add(new CliOption(CodegenConstants.PROJECT_NAME, "python project name in setup.py (e.g. petstore-api)."));
    cliOptions.add(new CliOption(CodegenConstants.PACKAGE_VERSION, "python package version.").defaultValue("1.0.0"));
    ...
    cliOptions.add(new CliOption(CodegenConstants.SOURCECODEONLY_GENERATION, CodegenConstants.SOURCECODEONLY_GENERATION_DESC).defaultValue(Boolean.FALSE.toString()));
    cliOptions.add(CliOption.newBoolean(USE_NOSE, "use the nose test framework").defaultValue(Boolean.FALSE.toString()));
  ...
  @Override public void processOpts() {
    ...
    templateProcessor = new TemplateManager(templateManagerOptions, te, new TemplatePathLocator[] { generatorTemplateLocator, commonTemplateLocator });
    ...
    Map<String, SecurityScheme> securitySchemeMap = openAPI != null ? (openAPI.getComponents() != null ? openAPI.getComponents().getSecuritySchemes() : null) : null;
  ...
  @Override protected void addVarsRequiredVarsAdditionalProps(Schema schema, IJsonSchemaValidationProperties property) {
                ...
                if (ModelUtils.isObjectSchema(ref)) {
                  if (ref.getProperties() != null && !ref.getProperties().isEmpty()) {
                    ...
                    if (ModelUtils.hasValidation(ref)) {
                      ...
                      if (getAllOfDescendants(simpleRef, openAPI).size() > 0) {
                        return schema;
                      }
                    }
                    return unaliasSchema(allSchemas.get(ModelUtils.getSimpleRef(schema.get$ref())), usedImportMappings);
  ...
  @Override public String toDefaultValue(Schema p) {
    ...
    if (ModelUtils.isDateSchema(p)) {
      ...
      if (ModelUtils.isDateTimeSchema(p)) {
        ...
        if (ModelUtils.isStringSchema(p) && !ModelUtils.isByteArraySchema(p) && !ModelUtils.isBinarySchema(p) && !ModelUtils.isFileSchema(p) && !ModelUtils.isUUIDSchema(p) && !ModelUtils.isEmailSchema(p)) {
  ...
  /**
     ...
     */
  @Override public CodegenProperty fromProperty(String name, Schema p) {
  ...
  /***
     ...
     */
  @Override public CodegenParameter fromRequestBody(RequestBody body, Set<String> imports, String bodyParameterName) {
  ...
  /***
     ...
     */
  @Override protected void addBodyModelSchema(CodegenParameter codegenParameter, String name, Schema schema, Set<String> imports, String bodyParameterName, boolean forceSimpleRef) {
    if (name != null) {
  ...
  public String toEnumVarName(String value, String datatype) {
    ...
    if (intMatch || floatMatch) {
      ...
      if (Pattern.matches(plusSign, value)) {
        ...
        if (Pattern.matches(negSign, value)) {
  ...
  @Override public void postProcessParameter(CodegenParameter p) {
  ...
  /**
     ...
     */
  @Override protected void addParentContainer(CodegenModel model, String name, Schema schema) {
  ...
  /**
     ...
     **/
  @SuppressWarnings(value = { "static-method" }) @Override public String getSchemaType(Schema schema) {
  ...
  @Override public String toInstantiationType(Schema property) {
  ...
  @Override public void setParameterExampleValue(CodegenParameter codegenParameter, Parameter parameter) {
    ...
    if (codegenParameter.vendorExtensions != null && codegenParameter.vendorExtensions.containsKey("x-example")) {
      ...
      if (parameter.getExample() != null) {
        ...
        if (parameter.getExamples() != null && !parameter.getExamples().isEmpty() && parameter.getExamples().values().iterator().next().getValue() != null) {
  ...
  @Override public void setParameterExampleValue(CodegenParameter codegenParameter, RequestBody requestBody) {
    ...
    if (mediaType.getExample() != null) {
      ...
      if (mediaType.getExamples() != null && !mediaType.getExamples().isEmpty() && mediaType.getExamples().values().iterator().next().getValue() != null) {
  ...
  /**
     ...
     * @return the resultant CodegenParameter
     */
  @Override public CodegenParameter fromFormProperty(String name, Schema propertySchema, Set<String> imports) {
  ...
  @Override protected void setAddProps(Schema schema, IJsonSchemaValidationProperties property) {
  ...
  /**
     ...
     */
  @Override protected void updatePropertyForArray(CodegenProperty property, CodegenProperty innerProperty) {
  ...
  @Override protected void updatePropertyForObject(CodegenProperty property, Schema p) {
    addVarsRequiredVarsAdditionalProps(p, property);
  }

  @Override protected void updatePropertyForAnyType(CodegenProperty property, Schema p) {
  ...
  @Override protected void updateModelForAnyType(CodegenModel m, Schema schema) {
  ...
  @Override protected void updateModelForComposedSchema(CodegenModel m, Schema schema, Map<String, Schema> allDefinitions) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) public String generatePackageName(String packageName) {
  ...
  /**
     ...
     */
  @Override public List<CodegenParameter> fromRequestBodyToFormParameters(RequestBody body, Set<String> imports) {
