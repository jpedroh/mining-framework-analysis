...
public class ModelUtils {
  ...
  public static boolean isInternalOnly(Schema schema) {
    if (schema != null && schema.getExtensions() != null && Boolean.valueOf(String.valueOf(schema.getExtensions().get("x-oag-internal-only")))) {
      return true;
    }
    return false;
  }
  ...
  public static boolean isInternalOnlySet(Schema schema) {
    if (schema != null && schema.getExtensions() != null && schema.getExtensions().get("x-oag-internal-only") != null) {
      return true;
    }
    return false;
  }
