...
public class DefaultCodegen implements CodegenConfig {
  ...
  @SuppressWarnings(value = { "static-method" }) public Map<String, Object> postProcessOperations(Map<String, Object> objs) {
    return objs;
  }
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) public String snakeCase(String name) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) public String initialCaps(String name) {
    ...
    if (schema.getDiscriminator().getMapping() != null && !schema.getDiscriminator().getMapping().isEmpty()) {
      ...
      allDefinitions.forEach((childName, child) -> {
        if (child instanceof ComposedSchema && ((ComposedSchema) child).getAllOf() != null) {
          Set<String> parentSchemas = ((ComposedSchema) child).getAllOf().stream().filter((s) -> s.get$ref() != null).map((s) -> ModelUtils.getSimpleRef(s.get$ref())).collect(Collectors.toSet());
  ...
  public CodegenOperation fromOperation(String path, String httpMethod, Operation operation, Map<String, Schema> schemas, OpenAPI openAPI) {
    ...
    if (requestBody != null) {
      if ("application/x-www-form-urlencoded".equalsIgnoreCase(getContentType(requestBody)) || "multipart/form-data".equalsIgnoreCase(getContentType(requestBody))) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) protected String dashize(String word) {
