...
public class DefaultCodegen implements CodegenConfig {
  ...
  public void setCircularReferences(Map<String, CodegenModel> models) {
    final Map<String, List<CodegenProperty>> dependencyMap = models.entrySet().stream().collect(Collectors.toMap(Entry::getKey, (entry) -> getModelDependencies(entry.getValue())));
