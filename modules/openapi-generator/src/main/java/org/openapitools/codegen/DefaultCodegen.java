...
public class DefaultCodegen implements CodegenConfig {
  ...
  public void processOpts() {
    ...
    if (additionalProperties.containsKey(CodegenConstants.DISCRIMINATOR_EXPLICIT_MAPPING_VERBOSE)) {
      this.setDiscriminatorExplicitMappingVerbose(Boolean.valueOf(additionalProperties.get(CodegenConstants.DISCRIMINATOR_EXPLICIT_MAPPING_VERBOSE).toString()));
    }
  }
  ...
  protected ImmutableMap.Builder<String, Lambda> addMustacheLambdas() {
    return new ImmutableMap.Builder<String, Mustache.Lambda>().put("lowercase", new LowercaseLambda().generator(this)).put("uppercase", new UppercaseLambda()).put("titlecase", new TitlecaseLambda()).put("camelcase", new CamelCaseLambda().generator(this)).put("indented", new IndentedLambda()).put("indented_8", new IndentedLambda(8, " ")).put("indented_12", new IndentedLambda(12, " ")).put("indented_16", new IndentedLambda(16, " "));
  }
  ...
  public DefaultCodegen() {
    ...
    cliOptions.add(CliOption.newBoolean(CodegenConstants.DISCRIMINATOR_EXPLICIT_MAPPING_VERBOSE, CodegenConstants.DISCRIMINATOR_EXPLICIT_MAPPING_VERBOSE_DESC).defaultValue(Boolean.FALSE.toString()));
                ...
                if (ModelUtils.isFreeFormObject(p)) {
                  ...
                  if (ModelUtils.isArraySchema(p)) {
                    ...
                    if (ModelUtils.isMapSchema(p)) {
                      Schema innerSchema = ModelUtils.unaliasSchema(this.openAPI, ModelUtils.getAdditionalProperties(p), importMapping);
                      if (innerSchema == null) {
  ...
  public CodegenOperation fromOperation(String path, String httpMethod, Operation operation, List<Server> servers) {
    ...
    if (requestBody != null) {
      ...
      if (contentType != null && (contentType.toLowerCase(Locale.ROOT).startsWith("application/x-www-form-urlencoded") || contentType.toLowerCase(Locale.ROOT).startsWith("multipart"))) {
