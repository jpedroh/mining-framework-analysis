...
public class DefaultCodegen implements CodegenConfig {
  ...
  public DefaultCodegen() {
    ...
    generatorMetadata = GeneratorMetadata.newBuilder().stability(Stability.STABLE).generationMessage(String.format(Locale.ROOT, "OpenAPI Generator: %s (%s)", getName(), codegenType.toValue())).build();
  ...
  private static Map<String, Map<String, Map<List<String>, String>>> sanitizedNames = new HashMap<String, Map<String, Map<List<String>, String>>>();
  ...
  /**
     ...
     * @return sanitized string
     */
  @SuppressWarnings(value = { "static-method" }) public String sanitizeName(String name, String removeCharRegEx, ArrayList<String> exceptionList) {
    if (name == null) {
  ...
  @Override public void setFeatureSet(final FeatureSet featureSet) {
