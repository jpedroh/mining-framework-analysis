...
public class DefaultCodegen implements CodegenConfig {
  ...
  @SuppressWarnings(value = { "static-method", "unchecked" }) public Map<String, Object> postProcessAllModels(Map<String, Object> objs) {
    ...
    for (Map.Entry<String, Object> entry : objs.entrySet()) {
      ...
      for (Map<String, Object> mo : models) {
        ...
        for (CodegenProperty cp : cm.allVars) {
          if (cp.dataType.equalsIgnoreCase(cm.classname) || (cp.isContainer && cp.items != null && cp.items.dataType.equalsIgnoreCase(cm.classname))) {
  ...
  @SuppressWarnings(value = { "static-method" }) public Map<String, Object> postProcessModels(Map<String, Object> objs) {
    return objs;
  }
  ...
  @SuppressWarnings(value = { "static-method" }) public void postProcess() {
    System.out.println("################################################################################");
  ...
  @SuppressWarnings(value = { "static-method" }) public Map<String, Object> postProcessOperationsWithModels(Map<String, Object> objs, List<Object> allModels) {
    return objs;
  }

  @SuppressWarnings(value = { "static-method" }) public Map<String, Object> postProcessSupportingFileData(Map<String, Object> objs) {
    return objs;
  }

  @SuppressWarnings(value = { "unused" }) public void postProcessModelProperty(CodegenModel model, CodegenProperty property) {
  }

  @SuppressWarnings(value = { "unused" }) public void postProcessParameter(CodegenParameter parameter) {
  }

  @SuppressWarnings(value = { "unused" }) public void preprocessOpenAPI(OpenAPI openAPI) {
  ...
  @SuppressWarnings(value = { "unused" }) public void processOpenAPI(OpenAPI openAPI) {
  }

  @SuppressWarnings(value = { "unused" }) public Compiler processCompiler(Compiler compiler) {
    return compiler;
  }

  @SuppressWarnings(value = { "unused" }) public TemplatingEngineAdapter processTemplatingEngine(TemplatingEngineAdapter templatingEngine) {
    return templatingEngine;
  }

  @SuppressWarnings(value = { "static-method" }) public String escapeText(String input) {
    if (input == null) {
      return input;
    }
  ...
  @SuppressWarnings(value = { "static-method" }) public String encodePath(String input) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) public String escapeReservedWord(String name) {
  ...
  public DefaultCodegen() {
    ...
    defaultIncludes = new HashSet<String>(Arrays.asList("double", "int", "long", "short", "char", "float", "String", "boolean", "Boolean", "Double", "Void", "Integer", "Long", "Float"));
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) public String generateExamplePath(String path, Operation operation) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) public String getTypeDeclaration(String name) {
    return name;
  }
    ...
    if (r.schema != null) {
      ...
      if (Boolean.TRUE.equals(cp.isString) && Boolean.TRUE.equals(cp.isEmail)) {
        ...
        if (Boolean.TRUE.equals(cp.isString) && Boolean.TRUE.equals(cp.isUuid)) {
          ...
          if (Boolean.TRUE.equals(cp.isByteArray)) {
            r.isByteArray = true;
          } else {
            if (Boolean.TRUE.equals(cp.isString)) {
              r.isString = true;
            } else {
              if (Boolean.TRUE.equals(cp.isBoolean)) {
                r.isBoolean = true;
              } else {
                if (Boolean.TRUE.equals(cp.isLong)) {
                  r.isLong = true;
                  r.isNumeric = true;
                } else {
                  if (Boolean.TRUE.equals(cp.isInteger)) {
                    r.isInteger = true;
                    r.isNumeric = true;
                    if (Boolean.TRUE.equals(cp.isShort)) {
                      r.isShort = true;
                    } else {
                      if (Boolean.TRUE.equals(cp.isUnboundedInteger)) {
                        r.isUnboundedInteger = true;
                      }
                    }
                  } else {
                    if (Boolean.TRUE.equals(cp.isNumber)) {
                      r.isNumber = true;
                      r.isNumeric = true;
                    } else {
                      if (Boolean.TRUE.equals(cp.isDouble)) {
                        r.isDouble = true;
                        r.isNumeric = true;
                      } else {
                        if (Boolean.TRUE.equals(cp.isFloat)) {
                          r.isFloat = true;
                          r.isNumeric = true;
                        } else {
                          if (Boolean.TRUE.equals(cp.isDecimal)) {
                            r.isDecimal = true;
                            r.isNumeric = true;
                          } else {
                            if (Boolean.TRUE.equals(cp.isBinary)) {
                              r.isFile = true;
                              r.isBinary = true;
                            } else {
                              if (Boolean.TRUE.equals(cp.isFile)) {
                                r.isFile = true;
                              } else {
                                if (Boolean.TRUE.equals(cp.isDate)) {
                                  r.isDate = true;
                                } else {
                                  if (Boolean.TRUE.equals(cp.isDateTime)) {
                                    r.isDateTime = true;
                                  } else {
                                    if (Boolean.TRUE.equals(cp.isFreeFormObject)) {
                                      r.isFreeFormObject = true;
                                    } else {
                                      if (Boolean.TRUE.equals(cp.isAnyType)) {
                                        r.isAnyType = true;
                                      } else {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) public List<CodegenSecurity> fromSecurity(Map<String, SecurityScheme> securitySchemeMap) {
        ...
        if (SecurityScheme.Type.HTTP.equals(securityScheme.getType())) {
          ...
          if ("basic".equals(securityScheme.getScheme())) {
            ...
            if ("bearer".equals(securityScheme.getScheme())) {
              ...
              if ("signature".equals(securityScheme.getScheme())) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) public void addOperationToGroup(String tag, String resourcePath, Operation operation, CodegenOperation co, Map<String, List<CodegenOperation>> operations) {
  ...
  private void addVars(CodegenModel m, Map<String, Schema> properties, List<String> required, Map<String, Schema> allProperties, List<String> allRequired) {
    ...
    if (properties != null && !properties.isEmpty()) {
      m.hasVars = true;
      m.hasEnums = false;
      Set<String> mandatory = required == null ? Collections.<String>emptySet() : new TreeSet<String>(required);
    ...
    if (allProperties != null) {
      Set<String> allMandatory = allRequired == null ? Collections.<String>emptySet() : new TreeSet<String>(allRequired);
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "static-method" }) public String sanitizeName(String name) {
    ...
    if (ModelUtils.isMapSchema(schema)) {
      ...
      if (ModelUtils.isArraySchema(schema)) {
        ...
        if (isFreeFormObject(schema)) {
          ...
          if (ModelUtils.isObjectSchema(schema) || ModelUtils.isComposedSchema(schema)) {
