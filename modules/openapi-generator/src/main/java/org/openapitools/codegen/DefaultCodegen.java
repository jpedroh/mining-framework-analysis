...
public class DefaultCodegen implements CodegenConfig {
  ...
  @Override @SuppressWarnings(value = { "static-method", "unchecked" }) public Map<String, Object> postProcessAllModels(Map<String, Object> objs) {
  ...
  /**
     ...
     */
  @Override public Map<String, Object> updateAllModels(Map<String, Object> objs) {
  ...
  @Override @SuppressWarnings(value = { "static-method" }) public Map<String, Object> postProcessModels(Map<String, Object> objs) {
    return objs;
  }
  ...
  @Override @SuppressWarnings(value = { "static-method" }) public Map<String, Object> postProcessOperationsWithModels(Map<String, Object> objs, List<Object> allModels) {
    return objs;
  }
  ...
  @Override public Schema unaliasSchema(Schema schema, Map<String, String> usedImportMappings) {
    ...
    for (Entry<String, MediaType> contentEntry : content.entrySet()) {
      ...
      if (mt.getEncoding() != null) {
        ...
        for (Entry<String, Encoding> encodingEntry : encMap.entrySet()) {
          ...
          CodegenEncoding ce = new CodegenEncoding(enc.getContentType(), headers, enc.getStyle().toString(), enc.getExplode().booleanValue(), enc.getAllowReserved().booleanValue());
  ...
  private CodegenComposedSchemas getComposedSchemas(Schema schema) {
    ...
    ComposedSchema cs = (ComposedSchema) schema;
    return new CodegenComposedSchemas(getComposedProperties(cs.getAllOf(), "allOf"), getComposedProperties(cs.getOneOf(), "oneOf"), getComposedProperties(cs.getAnyOf(), "anyOf"));
  }
