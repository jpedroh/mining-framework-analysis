      ...
      if (model instanceof ComposedModel) {
        ...
        for (Model allOfModel : listOfAllOF) {
          if (allOfModel instanceof RefModel) {
            ...
            if (allOfModel instanceof ModelImpl) {
      ...
      if (model instanceof ModelImpl) {
        ...
        if (additionalProperties != null) {
          if (additionalProperties instanceof RefProperty) {
            ...
            if (additionalProperties instanceof ArrayProperty) {
              ...
              if (additionalProperties instanceof MapProperty) {
                ...
                if (mapProp.getAdditionalProperties() instanceof RefProperty) {
                  ...
                  if (mapProp.getAdditionalProperties() instanceof ArrayProperty && ((ArrayProperty) mapProp.getAdditionalProperties()).getItems() instanceof RefProperty) {
    ...
    for (Map.Entry<String, Property> prop : subProps.entrySet()) {
      if (prop.getValue() instanceof RefProperty) {
        ...
        if (prop.getValue() instanceof ArrayProperty) {
          ...
          if (prop.getValue() instanceof MapProperty) {
