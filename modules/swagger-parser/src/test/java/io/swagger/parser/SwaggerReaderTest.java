...
public class SwaggerReaderTest {
  @Test(description = "it should read the uber api with file scheme") public void readUberApiFromFile() {
  ...
  @Test(description = "it should read the uber api with file scheme and spaces") public void readUberApiFromFileWithSpaces() {
    final SwaggerParser parser = new SwaggerParser();
    java.nio.file.Path currentRelativePath = Paths.get("");
    String curPath = currentRelativePath.toAbsolutePath().toString();
  ...
  @Test(description = "it should read the uber api from Path URI") public void readUberApiFromPathUri() {
    final SwaggerParser parser = new SwaggerParser();
  ...
  @Test(description = "it should read the uber api from File URI") public void readUberApiFromFileUri() {
    final SwaggerParser parser = new SwaggerParser();
  ...
  @Test(description = "it should read the uber api with url string without file scheme") public void readUberApiFromFileNoScheme() {
    final SwaggerParser parser = new SwaggerParser();
    final Swagger swagger = parser.read("src/test/resources/uber.json");
    assertNotNull(swagger);
  }

  @Test(description = "it should read the uber api") public void readUberApi() {
    final SwaggerParser parser = new SwaggerParser();
    final Swagger swagger = parser.read("uber.json");
    assertNotNull(swagger);
  }

  @Test(description = "it should read the simple example with minimum values") public void readSimpleExampleWithMinimumValues() {
    final SwaggerParser parser = new SwaggerParser();
  ...
  @Test(description = "it should read the simple example with model extensions") public void readSimpleExampleWithModelExtensions() {
    final SwaggerParser parser = new SwaggerParser();
    final Swagger swagger = parser.read("sampleWithMinimumValues.yaml");
  ...
  @Test(description = "it should detect yaml") public void detectYaml() {
    final SwaggerParser parser = new SwaggerParser();
    final Swagger swagger = parser.read("minimal_y");
    assertEquals(swagger.getSwagger(), "2.0");
  }

  @Test(description = "it should detect json") public void detectJson() {
    final SwaggerParser parser = new SwaggerParser();
    final Swagger swagger = parser.read("minimal_j");
    assertEquals(swagger.getSwagger(), "2.0");
  }

  @Test(description = "it should read the issue 16 resource") public void testIssue16() {
    final SwaggerParser parser = new SwaggerParser();
    final Swagger swagger = parser.read("issue_16.yaml");
    assertNotNull(swagger);
  }

  @Test(description = "it should test https://github.com/swagger-api/swagger-codegen/issues/469") public void testIssue469() {
    final SwaggerParser parser = new SwaggerParser();
    final Swagger swagger = parser.read("issue_469.json");
    final String expectedJson = "{" + "  \"id\" : 12345," + "  \"name\" : \"Gorilla\"" + "}";
    SerializationMatchers.assertEqualsToJson(swagger.getDefinitions().get("Pet").getExample(), expectedJson);
  }

  @Test(description = "it should read the issue 59 resource") public void testIssue59() throws IOException {
    final SwaggerParser parser = new SwaggerParser();
  ...
  @Test public void testIssueSwaggerUi1792() throws Exception {
    final SwaggerParser parser = new SwaggerParser();
  ...
  @Test public void testIssue207() throws Exception {
  ...
  @Test public void testIssue208() throws Exception {
    String spec = "{\n" + "  \"swagger\": \"2.0\",\n" + "  \"paths\": {},\n" + "  \"definitions\": {\n" + "    \"Dog\": {\n" + "      \"title\": \"Dog\",\n" + "      \"type\": \"object\",\n" + "      \"allOf\": [\n" + "        {\n" + "          \"$ref\": \"#/definitions/Pet\"\n" + "        }\n" + "      ],\n" + "      \"x-color\": \"red\"\n" + "    }\n" + "  }\n" + "}";
    SwaggerDeserializationResult result = new SwaggerParser().readWithInfo(spec);
    assertNotNull(result);
  ...
  @Test(description = "issue 206, not supported yet") public void testIssue206() {
    String spec = "swagger: \'2.0\'\n" + "paths: {}\n" + "definitions:\n" + "  Model:\n" + "    properties:\n" + "      name:\n" + "        type: string\n" + "        required: true";
    SwaggerDeserializationResult result = new SwaggerParser().readWithInfo(spec);
  }

  @Test public void testIssue205() {
  ...
  @Test(description = "it should read an example within an inlined schema") public void testIssue1261InlineSchemaExample() {
    final SwaggerParser parser = new SwaggerParser();
