...
public class OpenAPIParserTest {
  @Test public void testIssue1608() {
  ...
  @Test public void testIssue1143() {
    ParseOptions options = new ParseOptions();
  ...
  @Test public void testConverterWithFlatten() {
  ...
  @Test public void testParsingPrettifiedExtensions() throws Exception {
  ...
  @Test public void testIssue813() throws Exception {
  ...
  @Test public void testIssueRelativeRefs1() {
  ...
  @Test public void testIssue879() {
    OpenAPIParser openApiParser = new OpenAPIParser();
    ParseOptions options = new ParseOptions();
    OpenAPI openAPI = openApiParser.readLocation("issue_879.yaml", null, options).getOpenAPI();
    String ref = openAPI.getPaths().get("/register").getPost().getCallbacks().get("myEvent").get$ref();
    assertEquals(ref, "#/components/callbacks/callbackEvent");
  }

  @Test public void testIssue959() {
    OpenAPIParser openAPIParser = new OpenAPIParser();
  ...
  @Test public void testIssue1003_ExtensionsClassloader() {
  ...
  @Test public void testIssue1070() {
  ...
  @Test public void testIssue1433_ResolveSchemaWithoutType() {
    OpenAPIParser openApiParser = new OpenAPIParser();
    ParseOptions options = new ParseOptions();
    options.setResolveFully(true);
  ...
  @Test public void testMultipleOfBetweenZeroAndOne() {
  ...
  @Test public void testConvertWindowsPathsToUnixWhenResolvingServerPaths() {
    ParseOptions options = new ParseOptions();
    options.setResolve(true);
