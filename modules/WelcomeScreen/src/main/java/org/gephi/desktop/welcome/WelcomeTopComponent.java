...
public final class WelcomeTopComponent extends JPanel {
                ...
                if (fileObject.hasExt(GEPHI_EXTENSION)) {
                    ...
                    try {
                        ...
                        NotifyDescriptor.Message msg = new NotifyDescriptor.Message(
                            NbBundle.getMessage(WelcomeTopComponent.class, "WelcomeTopComponent.openGephiError"),
    ...
    private void initComponents() {
        ...
        newProjectLink = new JXHyperlink();
        labelSamples = new javax.swing.JLabel();
        samplesPanel = new JPanel();
        openFileLink = new JXHyperlink();
        ...
        header.setBorder(new org.jdesktop.swingx.border.DropShadowBorder());
            // NOI18N
        header.setIcon(ImageUtilities.loadImageIcon("org/gephi/desktop/welcome/resources/logo_transparent_small.png", false));
        header.setTitle(NbBundle.getMessage(WelcomeTopComponent.class, "WelcomeTopComponent.header.title"));// NOI18N

        header.setTitleFont(header.getTitleFont().deriveFont(header.getTitleFont().getSize() + 4.0F));
        ...
        org.openide.awt.Mnemonics.setLocalizedText(labelRecent, NbBundle.getMessage(WelcomeTopComponent.class, "WelcomeTopComponent.labelRecent.text"));// NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(labelNew, NbBundle.getMessage(WelcomeTopComponent.class, "WelcomeTopComponent.labelNew.text"));// NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(newProjectLink, NbBundle.getMessage(WelcomeTopComponent.class, "WelcomeTopComponent.newProjectLink.text"));// NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(openOnStartupCheckbox, NbBundle.getMessage(WelcomeTopComponent.class, "WelcomeTopComponent.openOnStartupCheckbox.text"));// NOI18N
