...
=======
  @POST @Path(value = "/user/{username}/workspace/{workspace_id}") @Transactional @Override public void joinWorkspace(@PathParam(value = "username") String username, @PathParam(value = "workspace_id") long workspaceId) {
    joinWorkspace(getUsername(username), workspaceId);
  }
>>>>>>> /usr/src/app/output/jri/deepamehta/94766fe941edd75a81ee48a809b8b61530f3a1e4/modules/dm4-accesscontrol/src/main/java/de/deepamehta/plugins/accesscontrol/AccessControlPlugin.java/right.java
...
<<<<<<< /usr/src/app/output/jri/deepamehta/94766fe941edd75a81ee48a809b8b61530f3a1e4/modules/dm4-accesscontrol/src/main/java/de/deepamehta/plugins/accesscontrol/AccessControlPlugin.java/left.java
...
>>>>>>> /usr/src/app/output/jri/deepamehta/94766fe941edd75a81ee48a809b8b61530f3a1e4/modules/dm4-accesscontrol/src/main/java/de/deepamehta/plugins/accesscontrol/AccessControlPlugin.java/right.java
  ...
  @Override public void postUpdateTopic(Topic topic, TopicModel newModel, TopicModel oldModel) {
