...
<<<<<<< /usr/src/app/output/jri/deepamehta/0ce773da1c5562123306ac01d0bac3a1b050fab4/modules/dm4-accesscontrol/src/main/java/de/deepamehta/plugins/accesscontrol/AccessControlPlugin.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Override @ConsumesService(value = WorkspacesService.class) public void serviceArrived(PluginService service) {
  ...
  private Permissions getPermissions(Type type) {
    String username = getUsername();
    return createPermissions(hasPermission(username, Operation.WRITE, type.getId()), hasPermission(username, Operation.CREATE, type.getId()));
  }
