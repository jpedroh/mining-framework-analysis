...
public class V2ConverterTest {
  ...
  private static final String ARRAY_VALUES = "[{\"id\":-1,\"name\":\"Marvin the Paranoid Android\"}," + "{\"id\":1000000,\"name\":\"Zaphod Beeblebrox\",\"friends\":[15]}]";
  ...
  @Test public void testConvertPetstore() throws Exception {
    SwaggerConverter converter = new SwaggerConverter();
    String swaggerAsString = new String(Files.readAllBytes(Paths.get(getClass().getClassLoader().getResource(PET_STORE_YAML).toURI())));
    SwaggerParseResult result = converter.readContents(swaggerAsString, null, null);
    assertNotNull(result.getOpenAPI());
  }

  @Test public void testIssue455() throws Exception {
  ...
  @Test(description = "Missing array item type in parameters") public void testIssue1() throws Exception {
  ...
  @Test(description = "Response Code") public void testIssue2() throws Exception {
  ...
  @Test(description = "Servers when Hosts, basePath, scheme") public void testIssue3() throws Exception {
  ...
  @Test(description = "Contents in Responses") public void testIssue4() throws Exception {
  ...
  @Test(description = "Tags are missing in the converted spec") public void testIssue5() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(PET_STORE_JSON);
  ...
  @Test(description = "Default value in parameters") public void testIssue6() throws Exception {
  ...
  @Test(description = "Body Converted to RequestBody") public void testIssue8() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_8_JSON);
    assertNotNull(oas.getPaths().get(PETS_PATH).getGet().getRequestBody());
  }

  @Test(description = "Response Headers") public void testIssue10() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(PET_STORE_JSON);
  ...
  @Test(description = "Minimal Spec error") public void testIssue11() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_11_JSON);
    assertNotNull(oas);
  }

  @Test(description = "Extensions in External Docs") public void testIssue12() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(PET_STORE_JSON);
  ...
  @Test(description = "Extensions in External Docs") public void testIssue13() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_13_JSON);
    assertNotNull(oas.getExternalDocs());
  }

  @Test(description = "X-example in parameters") public void testIssue14() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_14_JSON);
    assertEquals(VALUE, oas.getPaths().get(PETS_PATH).getGet().getParameters().get(0).getExample());
  }

  @Test(description = "Convert extensions everywhere applicable #15") public void testIssue15() throws Exception {
  ...
  @Test(description = "Security missing") public void testIssue16() throws Exception {
  ...
  @Test(description = "Referenced parameters are converted incorrectly") public void testIssue17() throws Exception {
  ...
  @Test(description = "External Docs in Operations") public void testIssue18() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_18_JSON);
    assertNotNull(oas.getPaths().get(PETS_PATH).getGet().getExternalDocs());
  }

  @Test(description = "Request Body Completions") public void testIssue19() throws Exception {
  ...
  @Test(description = "Response $ref\'s ") public void testIssue20() throws Exception {
  ...
  @Test(description = "File Responses to Binary") public void testIssue21() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_21_JSON);
    assertEquals(BINARY_FORMAT, oas.getPaths().get(FILE_PATH).getGet().getResponses().get("200").getContent().get(APPLICATION_PDF).getSchema().getFormat());
  }

  @Test(description = "Converting Hosts Without Schema") public void testIssue22() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_22_JSON);
    assertNotNull(oas);
  }

  @Test(description = "$ref not updated in components (additional properties)") public void testIssue23() throws Exception {
  ...
  @Test(description = "Covert path item $refs") public void testIssue25() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_25_JSON);
    assertNotNull(oas);
    assertEquals(oas.getPaths().get("/foo2").get$ref(), "#/paths/~1foo");
  }

  @Test(description = "Convert allOff") public void testIssue26() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_26_JSON);
    ComposedSchema extendedErrorModel = (ComposedSchema) oas.getComponents().getSchemas().get(EXTENDED_ERROR_MODEL);
  ...
  @Test(description = "500 Error Models with discriminator") public void testIssue27() throws Exception {
  ...
  @Test(description = "OAuth 2 flows and URLs were lost ") public void testIssue28() throws Exception {
  ...
  @Test(description = "Convert collectionFormat #1 - path, query, header parameters") public void testIssue30() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_30_JSON);
    assertNotNull(oas);
  }

  @Test(description = "Expect a default server object when a swagger without host, basePath and scheme is converted to openAPI") public void testIssue31() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_31_JSON);
    assertNotNull(oas.getServers());
  }

  @Test(description = "Convert schema, property and array examples") public void testIssue32() throws Exception {
  ...
  @Test(description = "Convert response examples") public void testIssue33() throws Exception {
  ...
  @Test(description = "Nice to have: Convert x-nullable to nullable") public void testIssue35() throws Exception {
    ...
    assertEquals(getOperation.getResponses().get("200").getContent().get("*/*").getSchema().getNullable(), Boolean.TRUE);
  ...
  @Test(description = "Nice to have: Convert x-example to example") public void testIssue36() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - examples are lost") public void testIssue540() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - enum values for array parameters are lost ") public void testIssue597() throws Exception {
  ...
  @Test(description = "Parser Issue: OpenAPI v2 converter - HEAD and OPTIONS operations are lost") public void testIssue599() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - required Form parameters are converted as optional ") public void testIssue600() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - ref in RequestBodies are correctly updated") public void testIssue647() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - NPE when no \"paths\" is empty") public void testIssue662() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_662_JSON);
    assertTrue(oas.getPaths().isEmpty());
  }

  @Test(description = "OpenAPI v2 converter - NullPointerException when converting an spec #") public void testIssue672() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_672_JSON);
    assertNotNull(oas);
  }

  @Test(description = "OpenAPI v2 converter - integer elements of enum are converted to String") public void testIssue676() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - Error in BodyParameter convertion") public void testIssue673() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - Migrate minLength, maxLength and pattern of String property") public void testIssue708() throws Exception {
  ...
  @Test(description = "Issue in converting server url in RFC 3986 format from OpenAPI Spec 2 to Open API Spec 3") public void testIssue745() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_745_YAML);
    assertTrue(oas.getServers().get(0).getUrl().startsWith("//"));
  }

  @Test(description = "OpenAPIParser.readLocation fails when fetching valid Swagger 2.0 resource with AuthorizationValues provided") public void testIssue785() {
  ...
  @Test(description = "OpenAPI v2 converter - Migrate a schema with AllOf") public void testIssue740() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - no model in body parameter") public void testIssue756() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_756_JSON);
    assertNotNull(oas);
  }

  @Test(description = "OpenAPI v2 converter - NPE when \'enum\' field is available and \'type\' field is missing in query parameter") public void testIssue758() throws Exception {
    final OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_758_JSON);
    assertNotNull(oas);
  }

  @Test(description = "OpenAPI v2 Converter: NPE when type is array and \'items\' field is missing in array property") public void testIssue762() throws Exception {
    final OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_762_JSON);
    assertNotNull(oas);
  }

  @Test(description = "OpenAPI v2 Converter: Ensure body name is preserved in x-codegen-request-body-name extension") public void testPreserveBodyParameterName() throws Exception {
    final OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_762_JSON);
    assertNotNull(oas);
    assertEquals(oas.getPaths().get("/").getPut().getExtensions().get("x-codegen-request-body-name"), "pet");
  }

  @Test(description = "requestBody not correctly populated when Parameters is a list of $refs (OAS 2 to 3 conversion)") public void testIssue765() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - Missing Parameter.style property") public void testParameterConversion() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - SwaggerParseResult has message") public void testSwaggerParseResultHasMessage() throws Exception {
    SwaggerConverter converter = new SwaggerConverter();
  ...
  @Test(description = "OpenAPI v2 converter - Migrate minLength, maxLength and pattern of String property") public void testIssue786() throws Exception {
    final OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_768_JSON);
    assertNotNull(oas);
  }

  @Test(description = "OpenAPI v2 converter - Conversion of a spec without a info section") public void testIssue755() throws Exception {
    final OpenAPI oas = getConvertedOpenAPIFromJsonFile(ISSUE_755_YAML);
    assertNotNull(oas);
  }

  @Test(description = "OpenAPI v2 converter - top-level extensions should be preserved") public void testTopLevelExtensions() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - Conversion param extensions should be preserved") public void testIssue820() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - proper IntegerSchema parsing") public void testIssue1032() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - converts URL correctly when it begins with forward slash") public void testIssue1113() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - uses specialized schema subclasses where available") public void testIssue1164() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - verifies the references inside composed schema is resolved") public void testissue1261() throws Exception {
  ...
  @Test(description = "OpenAPI v2 converter - vendor extensions on body parameters copied to output RequestBody") public void testissue1715() throws Exception {
  ...
  @Test public void testInlineDefinitionProperty() throws Exception {
    SwaggerConverter converter = new SwaggerConverter();
    ParseOptions parseOptions = new ParseOptions();
  ...
  @Test public void testConvertFormDataAsObjectSchema() throws Exception {
    OpenAPI oas = getConvertedOpenAPIFromJsonFile("issue-1529.json");
    assertNotNull(oas);
    Schema companiesSchema = oas.getPaths().get("/companies/").getPost().getRequestBody().getContent().get("multipart/form-data").getSchema();
