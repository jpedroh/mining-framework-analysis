...
public class SwaggerConverter implements SwaggerParserExtension {
  ...
  @Override public SwaggerParseResult readLocation(String url, List<AuthorizationValue> auths, ParseOptions options) {
  ...
  @Override public SwaggerParseResult readContents(String swaggerAsString, List<AuthorizationValue> auth, ParseOptions options) {
        ...
        if ("formData".equals(param.getIn())) {
          ...
          if ("body".equals(param.getIn())) {
            ...
            if ($ref != null && $ref.startsWith("#/components/requestBodies/") && isRefABodyParam(param)) {
              ...
              if ($ref != null && $ref.startsWith("#/components/schemas/") && isRefAFormParam(param)) {
                formParams.add(param);
              } else {
  ...
  private Map<String, Object> convert(Map<String, Object> vendorExtensions) {
    if (vendorExtensions != null && vendorExtensions.size() > 0) {
      vendorExtensions.entrySet().removeIf((extension) -> (extension.getKey().equals("x-example")) || extension.getKey().equals("x-examples") || extension.getKey().equals("x-nullable"));
    }
    ...
    if (v2Parameter instanceof RefParameter) {
      ...
      if (ref.get$ref().indexOf("#/parameters") == 0) {
        ...
        if (components.getRequestBodies() != null && components.getRequestBodies().get(ref.getSimpleRef()) != null) {
          ...
          if (components.getSchemas() != null && components.getSchemas().get("formData_" + ref.getSimpleRef()) != null) {
            updatedRef += "schemas";
          } else {
        ...
        if ("array".equals(sp.getType())) {
          ...
          switch (cf) {
            ...
            if ("query".equals(v2Parameter.getIn())) {
              ...
              if ("header".equals(v2Parameter.getIn()) || "path".equals(v2Parameter.getIn())) {
  ...
  public Schema convert(io.swagger.models.Model v2Model) {
    ...
    if (v2Model instanceof ArrayModel) {
      ...
      if (v2Model instanceof ComposedModel) {
        ...
        if (v2Model instanceof ModelImpl) {
          ...
          if (v2Model instanceof RefModel) {
