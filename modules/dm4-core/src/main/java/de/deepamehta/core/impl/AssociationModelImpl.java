...
class AssociationModelImpl extends DeepaMehtaObjectModelImpl implements AssociationModel {
  ...
  @Override public RoleModelImpl getRoleModel1() {
    return roleModel1;
  }

  @Override public RoleModelImpl getRoleModel2() {
    return roleModel2;
  }

  @Override public void setRoleModel1(RoleModel roleModel1) {
    this.roleModel1 = (RoleModelImpl) roleModel1;
  }

  @Override public void setRoleModel2(RoleModel roleModel2) {
    this.roleModel2 = (RoleModelImpl) roleModel2;
  }

  @Override public RoleModelImpl getRoleModel(String roleTypeUri) {
  ...
  @Override public boolean hasSameRoleTypeUris() {
    return roleModel1.getRoleTypeUri().equals(roleModel2.getRoleTypeUri());
  }

  @Override public boolean matches(String roleTypeUri1, long playerId1, String roleTypeUri2, long playerId2) {
  ...
  @Override public long getOtherPlayerId(long id) {
  ...
  @Override public JSONObject toJSON() {
    try {
      return super.toJSON().put("role1", roleModel1 != null ? roleModel1.toJSON() : null).put("role2", roleModel2 != null ? roleModel2.toJSON() : null);
    } catch (Exception e) {
      throw new RuntimeException("Serialization failed", e);
    }
  }

  @Override public AssociationModel clone() {
    try {
  ...
  @Override AssociationImpl instantiate() {
    return new AssociationImpl(this, pl);
  }

  @Override AssociationModelImpl createModelWithChildTopics(ChildTopicsModel childTopics) {
    return mf.newAssociationModel(childTopics);
  }

  @Override final AssociationTypeModelImpl getType() {
    return pl.typeStorage.getAssociationType(typeUri);
  }

  @Override final List<AssociationModelImpl> getAssociations() {
    return pl.fetchAssociationAssociations(id);
  }

  @Override final RelatedTopicModelImpl getRelatedTopic(String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersTopicTypeUri) {
    return pl.fetchAssociationRelatedTopic(id, assocTypeUri, myRoleTypeUri, othersRoleTypeUri, othersTopicTypeUri);
  }

  @Override final List<RelatedTopicModelImpl> getRelatedTopics(String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersTopicTypeUri) {
    return pl.fetchAssociationRelatedTopics(id, assocTypeUri, myRoleTypeUri, othersRoleTypeUri, othersTopicTypeUri);
  }

  @Override final List<RelatedTopicModelImpl> getRelatedTopics(List assocTypeUris, String myRoleTypeUri, String othersRoleTypeUri, String othersTopicTypeUri) {
    return pl.fetchAssociationRelatedTopics(id, assocTypeUris, myRoleTypeUri, othersRoleTypeUri, othersTopicTypeUri);
  }
  ...
  @Override final void storeSimpleValue() {
    TypeModel type = getType();
    pl.storeAssociationValue(id, value, type.getIndexModes(), type.getUri(), getIndexValue());
  }

  @Override final void indexSimpleValue(IndexMode indexMode) {
    pl.indexAssociationValue(id, indexMode, typeUri, getIndexValue());
  }

  @Override final void storeProperty(String propUri, Object propValue, boolean addToIndex) {
    pl.storeAssociationProperty(id, propUri, propValue, addToIndex);
  }

  @Override final void removeProperty(String propUri) {
    pl.removeAssociationProperty(id, propUri);
  }

  @Override final void _delete() {
    pl._deleteAssociation(id);
  }

  @Override final void checkReadAccess() {
    pl.checkAssociationReadAccess(id);
  }

  @Override final void checkWriteAccess() {
    pl.checkAssociationWriteAccess(id);
  }

  @Override final DeepaMehtaEvent getPreUpdateEvent() {
    return CoreEvent.PRE_UPDATE_ASSOCIATION;
  }

  @Override final DeepaMehtaEvent getPostUpdateEvent() {
    return CoreEvent.POST_UPDATE_ASSOCIATION;
  }

  @Override final DeepaMehtaEvent getPreDeleteEvent() {
    return CoreEvent.PRE_DELETE_ASSOCIATION;
  }

  @Override final DeepaMehtaEvent getPostDeleteEvent() {
    return CoreEvent.POST_DELETE_ASSOCIATION;
  }

  @Override final Directive getUpdateDirective() {
    return Directive.UPDATE_ASSOCIATION;
  }

  @Override final Directive getDeleteDirective() {
    return Directive.DELETE_ASSOCIATION;
  }

  @Override void preCreate() {
    duplicateCheck();
  }

  @Override void postUpdate(DeepaMehtaObjectModel updateModel, DeepaMehtaObjectModel oldObject) {
  ...
  void updateRoleTypeUri(RoleModelImpl role, String roleTypeUri) {
    ...
    pl.storeRoleTypeUri(id, role.playerId, role.roleTypeUri);
  }

  private void duplicateCheck() {
    if (!(roleModel1 instanceof TopicRoleModel) || ((TopicRoleModel) roleModel1).topicIdentifiedByUri() || !(roleModel2 instanceof TopicRoleModel) || ((TopicRoleModel) roleModel2).topicIdentifiedByUri()) {
      return;
    }
    for (AssociationModelImpl assoc : pl._getAssociations(typeUri, roleModel1.playerId, roleModel2.playerId, roleModel1.roleTypeUri, roleModel2.roleTypeUri)) {
      if (assoc.id != id && assoc.value.equals(value)) {
        throw new RuntimeException("Duplicate: such an association exists already (ID=" + assoc.id + ", typeUri=\"" + typeUri + "\", value=\"" + value + "\")");
      }
    }
  }
  ...
  private RoleModelImpl getRole(RoleModel roleModel) {
    if (roleModel1.refsSameObject(roleModel)) {
      ...
      if (roleModel2.refsSameObject(roleModel)) {
        return roleModel2;
      }
    }
  ...
  private AssociationModelImpl fetchInstantiation() {
    RelatedTopicModelImpl assocType = getRelatedTopic("dm4.core.instantiation", "dm4.core.instance", "dm4.core.type", "dm4.core.assoc_type");
    if (assocType == null) {
  ...
  private boolean isAssocDef(AssociationModel assoc) {
    ...
    if (assoc.getRoleModel("dm4.core.parent_type") == null || assoc.getRoleModel("dm4.core.child_type") == null) {
      return false;
    }
    return true;
  }
