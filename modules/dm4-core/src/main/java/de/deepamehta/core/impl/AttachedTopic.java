...
class AttachedTopic extends AttachedDeepaMehtaObject implements Topic {
  ...
  @Override public void update(TopicModel model) {
    loadChildTopics();
    _update(model);
  ...
  @Override public Topic loadChildTopics() {
    return (Topic) super.loadChildTopics();
  }

  @Override public Topic loadChildTopics(String childTypeUri) {
  ...
  private Association fetchInstantiation() {
    RelatedTopic topicType = getRelatedTopic("dm4.core.instantiation", "dm4.core.instance", "dm4.core.type", "dm4.core.topic_type");
    if (topicType == null) {
