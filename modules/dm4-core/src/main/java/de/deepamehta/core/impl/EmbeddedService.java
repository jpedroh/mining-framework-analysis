...
public class EmbeddedService implements DeepaMehtaService {
  ...
  @Override public void updateTopic(TopicModel model) {
    try {
      getTopic(model.getId(), true).update(model);
    } catch (Exception e) {
  ...
  @Override public void updateAssociation(AssociationModel model) {
    try {
      getAssociation(model.getId(), true).update(model);
    } catch (Exception e) {
  ...
  @Override public void deleteAssociation(long assocId) {
    try {
      getAssociation(assocId, false).delete();
    } catch (Exception e) {
  ...
  @Override public void updateTopicType(TopicTypeModel model) {
    try {
  ...
  @Override public void updateAssociationType(AssociationTypeModel model) {
    try {
