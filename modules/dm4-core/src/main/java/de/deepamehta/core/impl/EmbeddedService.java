...
<<<<<<< /usr/src/app/output/jri/deepamehta/252dd7d58ffcd2d89fd494cfa4be9dfdfff70839/modules/dm4-core/src/main/java/de/deepamehta/core/impl/EmbeddedService.java/left.java
  AccessControl
=======
  String
>>>>>>> /usr/src/app/output/jri/deepamehta/252dd7d58ffcd2d89fd494cfa4be9dfdfff70839/modules/dm4-core/src/main/java/de/deepamehta/core/impl/EmbeddedService.java/right.java
   
<<<<<<< /usr/src/app/output/jri/deepamehta/252dd7d58ffcd2d89fd494cfa4be9dfdfff70839/modules/dm4-core/src/main/java/de/deepamehta/core/impl/EmbeddedService.java/left.java
  accessControl
=======
  URI_PREFIX_ROLE_TYPE = "domain.project.role_type_"
>>>>>>> /usr/src/app/output/jri/deepamehta/252dd7d58ffcd2d89fd494cfa4be9dfdfff70839/modules/dm4-core/src/main/java/de/deepamehta/core/impl/EmbeddedService.java/right.java
  ;
  ...
  @Override public Topic getTopic(long topicId) {
    ...
    try {
      return instantiateTopic(storageDecorator.fetchTopic(topicId), false);
    } catch (Exception e) {
      throw new RuntimeException("Fetching topic " + topicId + " failed", e);
    }
  }

  @Override public Topic getTopic(String key, SimpleValue value) {
    try {
      TopicModel topic = storageDecorator.fetchTopic(key, value);
      return topic != null ? instantiateTopic(topic, true) : null;
    } catch (Exception e) {
      throw new RuntimeException("Fetching topic failed (key=\"" + key + "\", value=\"" + value + "\")", e);
    }
  }

  @Override public List<Topic> getTopics(String key, SimpleValue value) {
    try {
  ...
  @Override public ResultList<RelatedTopic> getTopics(String topicTypeUri, int maxResultSize) {
    try {
      return getTopicType(topicTypeUri).getRelatedTopics("dm4.core.instantiation", "dm4.core.type", "dm4.core.instance", topicTypeUri, maxResultSize);
    } catch (Exception e) {
  ...
  @Override public Association getAssociation(long assocId) {
    ...
    try {
      return instantiateAssociation(storageDecorator.fetchAssociation(assocId), false);
    } catch (Exception e) {
  ...
  @Override public Association getAssociation(String assocTypeUri, long topic1Id, long topic2Id, String roleTypeUri1, String roleTypeUri2) {
    ...
    try {
      ...
      return assoc != null ? instantiateAssociation(assoc, true) : null;
    } catch (Exception e) {
  ...
  @Override public ResultList<RelatedAssociation> getAssociations(String assocTypeUri) {
    try {
      return getAssociationType(assocTypeUri).getRelatedAssociations("dm4.core.instantiation", "dm4.core.type", "dm4.core.instance", assocTypeUri);
    } catch (Exception e) {
  ...
  @Override public List<Association> getAssociations(long topic1Id, long topic2Id, String assocTypeUri) {
    ...
    try {
      return instantiateAssociations(storageDecorator.fetchAssociations(assocTypeUri, topic1Id, topic2Id, null, null));
    } catch (Exception e) {
  ...
  @Override public List<String> getTopicTypeUris() {
    try {
      Topic metaType = instantiateTopic(storageDecorator.fetchTopic("uri", new SimpleValue("dm4.core.topic_type")), false);
  ...
  @Override public List<String> getAssociationTypeUris() {
    try {
      Topic metaType = instantiateTopic(storageDecorator.fetchTopic("uri", new SimpleValue("dm4.core.assoc_type")), false);
  ...
  private List<Topic> instantiateTopics(List<TopicModel> models) {
    ...
    for (TopicModel model : models) {
      try {
        topics.add(instantiateTopic(model, true));
  ...
  ResultList<RelatedTopic> instantiateRelatedTopics(ResultList<RelatedTopicModel> models) {
    ...
    for (RelatedTopicModel model : models) {
      try {
        relTopics.add(instantiateRelatedTopic(model, true));
      } catch (AccessControlException e) {
      }
    }
  ...
  /**
     ...
     */
  Association instantiateAssociation(AssociationModel model, boolean checkAccess) {
    checkAccess(model, checkAccess);
  ...
  List<Association> instantiateAssociations(List<AssociationModel> models) {
    ...
    for (AssociationModel model : models) {
      try {
        assocs.add(instantiateAssociation(model, true));
      } catch (AccessControlException e) {
      }
    }
    return assocs;
  ...
  ResultList<RelatedAssociation> instantiateRelatedAssociations(Iterable<RelatedAssociationModel> models) {
    ...
    for (RelatedAssociationModel model : models) {
      try {
        relAssocs.add(instantiateRelatedAssociation(model, true));
      } catch (AccessControlException e) {
      }
    }
    return relAssocs;
  ...
  private TopicType topicTypeFactory(TopicTypeModel model) {
    topicFactory(model, URI_PREFIX_TOPIC_TYPE);
  ...
  private AssociationType associationTypeFactory(AssociationTypeModel model) {
    topicFactory(model, URI_PREFIX_ASSOCIATION_TYPE);
    typeStorage.storeType(model);
