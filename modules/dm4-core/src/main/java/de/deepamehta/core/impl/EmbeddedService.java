...
public class EmbeddedService implements DeepaMehtaService {
  ...
  @Override public Topic getTopic(long topicId, boolean fetchComposite) {
    fireEvent(CoreEvent.PRE_GET_TOPIC, topicId);
    try {
      return instantiateTopic(storageDecorator.fetchTopic(topicId), fetchComposite, false);
    } catch (Exception e) {
      throw new RuntimeException("Fetching topic " + topicId + " failed", e);
    }
  }

  @Override public Topic getTopic(String key, SimpleValue value, boolean fetchComposite) {
    try {
      TopicModel topic = storageDecorator.fetchTopic(key, value);
      return topic != null ? instantiateTopic(topic, fetchComposite, true) : null;
    } catch (Exception e) {
      throw new RuntimeException("Fetching topic failed (key=\"" + key + "\", value=\"" + value + "\")", e);
    }
  }

  @Override public List<Topic> getTopics(String key, SimpleValue value, boolean fetchComposite) {
    try {
  ...
  @Override public ResultList<RelatedTopic> getTopics(String topicTypeUri, boolean fetchComposite, int maxResultSize) {
    try {
      return getTopicType(topicTypeUri).getRelatedTopics("dm4.core.instantiation", "dm4.core.type", "dm4.core.instance", topicTypeUri, fetchComposite, false, maxResultSize);
    } catch (Exception e) {
  ...
  @Override public Topic createTopic(TopicModel model) {
  ...
  @Override public Directives updateTopic(TopicModel model) {
    DeepaMehtaTransaction tx = beginTx();
    try {
      Directives directives = new Directives();
      getTopic(model.getId(), true).update(model, directives);
      tx.success();
      return directives;
    } catch (Exception e) {
      logger.warning("ROLLBACK!");
  ...
  @Override public Directives deleteTopic(long topicId) {
    DeepaMehtaTransaction tx = beginTx();
    try {
      Directives directives = new Directives();
      getTopic(topicId, false).delete(directives);
      tx.success();
      return directives;
    } catch (Exception e) {
      logger.warning("ROLLBACK!");
  ...
  @Override public Association getAssociation(long assocId, boolean fetchComposite) {
    logger.info("assocId=" + assocId + ", fetchComposite=" + fetchComposite);
    fireEvent(CoreEvent.PRE_GET_ASSOCIATION, assocId);
    try {
  ...
  @Override public Association getAssociation(String assocTypeUri, long topic1Id, long topic2Id, String roleTypeUri1, String roleTypeUri2, boolean fetchComposite) {
    String info = "assocTypeUri=\"" + assocTypeUri + "\", topic1Id=" + topic1Id + ", topic2Id=" + topic2Id + ", roleTypeUri1=\"" + roleTypeUri1 + "\", roleTypeUri2=\"" + roleTypeUri2 + "\", fetchComposite=" + fetchComposite;
    try {
      AssociationModel assoc = storageDecorator.fetchAssociation(assocTypeUri, topic1Id, topic2Id, roleTypeUri1, roleTypeUri2);
      return assoc != null ? instantiateAssociation(assoc, fetchComposite, true) : null;
    } catch (Exception e) {
      throw new RuntimeException("Fetching association failed (" + info + ")", e);
    }
  }

  @Override public Association getAssociationBetweenTopicAndAssociation(String assocTypeUri, long topicId, long assocId, String topicRoleTypeUri, String assocRoleTypeUri, boolean fetchComposite) {
    String info = "assocTypeUri=\"" + assocTypeUri + "\", topicId=" + topicId + ", assocId=" + assocId + ", topicRoleTypeUri=\"" + topicRoleTypeUri + "\", assocRoleTypeUri=\"" + assocRoleTypeUri + "\", fetchComposite=" + fetchComposite;
    logger.info(info);
    try {
      AssociationModel assoc = storageDecorator.fetchAssociationBetweenTopicAndAssociation(assocTypeUri, topicId, assocId, topicRoleTypeUri, assocRoleTypeUri);
      return assoc != null ? instantiateAssociation(assoc, fetchComposite, true) : null;
    } catch (Exception e) {
      throw new RuntimeException("Fetching association failed (" + info + ")", e);
    }
  ...
  @Override public List<RelatedAssociation> getAssociations(String assocTypeUri) {
    try {
      return getAssociationType(assocTypeUri).getRelatedAssociations("dm4.core.instantiation", "dm4.core.type", "dm4.core.instance", assocTypeUri, false, false);
    } catch (Exception e) {
  ...
  @Override public List<Association> getAssociations(long topic1Id, long topic2Id, String assocTypeUri) {
    ...
    try {
      return instantiateAssociations(storageDecorator.fetchAssociations(assocTypeUri, topic1Id, topic2Id, null, null), false);
    } catch (Exception e) {
  ...
  @Override public Association createAssociation(AssociationModel model) {
    DeepaMehtaTransaction tx = beginTx();
    try {
  ...
  @Override public Directives updateAssociation(AssociationModel model) {
    DeepaMehtaTransaction tx = beginTx();
    try {
      Directives directives = new Directives();
      getAssociation(model.getId(), true).update(model, directives);
      tx.success();
      return directives;
    } catch (Exception e) {
      logger.warning("ROLLBACK!");
  ...
  @Override public Directives deleteAssociation(long assocId) {
    DeepaMehtaTransaction tx = beginTx();
    try {
      Directives directives = new Directives();
      getAssociation(assocId, false).delete(directives);
      tx.success();
      return directives;
    } catch (Exception e) {
      logger.warning("ROLLBACK!");
  ...
  @Override public List<String> getTopicTypeUris() {
    try {
      Topic metaType = instantiateTopic(storageDecorator.fetchTopic("uri", new SimpleValue("dm4.core.topic_type")), false, false);
      ResultList<RelatedTopic> topicTypes = metaType.getRelatedTopics("dm4.core.instantiation", "dm4.core.type", "dm4.core.instance", "dm4.core.topic_type", false, false, 0);
  ...
  @Override public TopicType getTopicType(String uri) {
    try {
  ...
  @Override public TopicType createTopicType(TopicTypeModel model) {
    DeepaMehtaTransaction tx = beginTx();
    try {
  ...
  @Override public Directives updateTopicType(TopicTypeModel model) {
    DeepaMehtaTransaction tx = beginTx();
    try {
      String topicTypeUri = getTopic(model.getId(), false).getUri();
  ...
  @Override public Directives deleteTopicType(String topicTypeUri) {
    DeepaMehtaTransaction tx = beginTx();
    try {
      TopicType topicType = getTopicType(topicTypeUri);
      Directives directives = new Directives();
  ...
  @Override public List<String> getAssociationTypeUris() {
    try {
      Topic metaType = instantiateTopic(storageDecorator.fetchTopic("uri", new SimpleValue("dm4.core.assoc_type")), false, false);
      ResultList<RelatedTopic> assocTypes = metaType.getRelatedTopics("dm4.core.instantiation", "dm4.core.type", "dm4.core.instance", "dm4.core.assoc_type", false, false, 0);
  ...
  @Override public AssociationType getAssociationType(String uri) {
    try {
  ...
  @Override public AssociationType createAssociationType(AssociationTypeModel model) {
    DeepaMehtaTransaction tx = beginTx();
    try {
  ...
  @Override public Directives updateAssociationType(AssociationTypeModel model) {
    DeepaMehtaTransaction tx = beginTx();
    try {
      String assocTypeUri = getTopic(model.getId(), false).getUri();
  ...
  @Override public Directives deleteAssociationType(String assocTypeUri) {
    DeepaMehtaTransaction tx = beginTx();
    try {
      AssociationType assocType = getAssociationType(assocTypeUri);
      Directives directives = new Directives();
  ...
  @Override public Plugin getPlugin(String pluginUri) {
  ...
  @Override public void deliverEvent(String pluginUri, DeepaMehtaEvent event, Object... params) {
  ...
  @Override public TypeStorage getTypeStorage() {
    return typeStorage;
  }
  ...
  private List<Topic> instantiateTopics(List<TopicModel> models, boolean fetchComposite) {
    ...
    for (TopicModel model : models) {
      try {
        topics.add(instantiateTopic(model, fetchComposite, true));
  ...
  RelatedTopic instantiateRelatedTopic(RelatedTopicModel model, boolean fetchComposite, boolean fetchRelatingComposite, boolean checkAccess) {
    checkAccess(model, checkAccess);
  ...
  List<Association> instantiateAssociations(List<AssociationModel> models, boolean fetchComposite) {
    ...
    for (AssociationModel model : models) {
      try {
        assocs.add(instantiateAssociation(model, fetchComposite, true));
      } catch (AccessControlException e) {
      }
    }
    return assocs;
  ...
  RelatedAssociation instantiateRelatedAssociation(RelatedAssociationModel model, boolean fetchComposite, boolean fetchRelatingComposite, boolean checkAccess) {
    checkAccess(model, checkAccess);
  ...
  private void checkAccess(TopicModel model, boolean checkAccess) {
    if (checkAccess) {
      fireEvent(CoreEvent.PRE_GET_TOPIC, model.getId());
    }
  }

  private void checkAccess(AssociationModel model, boolean checkAccess) {
    if (checkAccess) {
      fireEvent(CoreEvent.PRE_GET_ASSOCIATION, model.getId());
    }
  }
  ...
  private void createTypeTopic(TopicModel model, String defaultUriPrefix) {
    Topic typeTopic = topicFactory(model, null);
  ...
  private void bootstrapTypeCache() {
    typeCache.putTopicType(new AttachedTopicType(new TopicTypeModel("dm4.core.meta_meta_type", "dm4.core.meta_meta_meta_type", "Meta Meta Type", "dm4.core.text"), this));
  }
}