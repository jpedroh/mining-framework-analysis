...
<<<<<<< /usr/src/app/output/jri/deepamehta/13402e44c98b885e450f0eada839e0efcf18da1b/modules/dm4-core/src/main/java/de/deepamehta/core/impl/service/PluginImpl.java/left.java
      registerListeners()
=======
      initializePlugin()
>>>>>>> /usr/src/app/output/jri/deepamehta/13402e44c98b885e450f0eada839e0efcf18da1b/modules/dm4-core/src/main/java/de/deepamehta/core/impl/service/PluginImpl.java/right.java
      ;
      registerPlugin();
  ...
  private void createPluginTopic() {
    pluginTopic = dms.createTopic(new TopicModel(pluginUri, "dm4.core.plugin", new CompositeValue().put("dm4.core.plugin_name", pluginName).put("dm4.core.plugin_symbolic_name", pluginUri).put("dm4.core.plugin_migration_nr", 0)), null);
  }

  private Topic fetchPluginTopic() {
    return dms.getTopic("uri", new SimpleValue(pluginUri), false, null);
  }
  ...
  private void introduceTypesToPlugin() {
    for (String topicTypeUri : dms.getTopicTypeUris()) {
      try {
        ...
        deliverEvent(CoreEvent.INTRODUCE_TOPIC_TYPE, topicType, null);
      } catch (Exception e) {
  ...
  private void registerListeners() {
    ...
    if (events.size() == 0) {
      logger.info("Registering listeners of " + this + " at DeepaMehta 4 core service ABORTED " + "-- no listeners implemented");
      return;
    }
  ...
  private void registerWebResources() {
    ...
    try {
      ...
      throw new RuntimeException("Registering Web resources of " + this + " failed " + "(uriNamespace=\"" + uriNamespace + "\")", e);
    }
  }
  ...
  private void registerRestResources() {
    ...
    try {
      ...
      unregisterWebResources();
      throw new RuntimeException("Registering REST resources of " + this + " failed " + "(uriNamespace=\"" + uriNamespace + "\")", e);
    }
  }
