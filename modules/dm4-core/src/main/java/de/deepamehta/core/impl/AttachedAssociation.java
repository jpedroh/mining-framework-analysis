...
class AttachedAssociation extends AttachedDeepaMehtaObject implements Association {
  ...
  /**
     ...
     */
  @Override public void update(AssociationModel model) {
    loadChildTopics();
  ...
  @Override public Association loadChildTopics() {
    return (Association) super.loadChildTopics();
  }

  @Override public Association loadChildTopics(String childTypeUri) {
  ...
  @Override public ResultList<RelatedTopic> getRelatedTopics(List assocTypeUris, String myRoleTypeUri, String othersRoleTypeUri, String othersTopicTypeUri, int maxResultSize) {
  ...
  @Override public RelatedAssociation getRelatedAssociation(String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersAssocTypeUri) {
    RelatedAssociationModel assoc = dms.storageDecorator.fetchAssociationRelatedAssociation(getId(), assocTypeUri, myRoleTypeUri, othersRoleTypeUri, othersAssocTypeUri);
    return assoc != null ? dms.instantiateRelatedAssociation(assoc, true) : null;
  }

  @Override public ResultList<RelatedAssociation> getRelatedAssociations(String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersAssocTypeUri) {
    ResultList<RelatedAssociationModel> assocs = dms.storageDecorator.fetchAssociationRelatedAssociations(getId(), assocTypeUri, myRoleTypeUri, othersRoleTypeUri, othersAssocTypeUri);
  ...
  @Override Directive getUpdateDirective() {
  ...
  private Association fetchInstantiation() {
    RelatedTopic assocType = getRelatedTopic("dm4.core.instantiation", "dm4.core.instance", "dm4.core.type", "dm4.core.assoc_type");
    if (assocType == null) {
