...
abstract class AttachedDeepaMehtaObject implements DeepaMehtaObject {
  ...
  @Override public AttachedChildTopics getChildTopics() {
    return childTopics;
  }

  @Override public void setChildTopics(ChildTopicsModel childTopics) {
    try {
  ...
  @Override public DeepaMehtaObject loadChildTopics() {
    getChildTopics().loadChildTopics();
    return this;
  }

  @Override public DeepaMehtaObject loadChildTopics(String childTypeUri) {
  ...
  @Override public void update(DeepaMehtaObjectModel newModel) {
    updateUri(newModel.getUri());
    updateTypeUri(newModel.getTypeUri());
    updateValue(newModel);
  }

  @Override public void updateChildTopic(TopicModel newChildTopic, AssociationDefinition assocDef) {
    getChildTopics().updateChildTopics(newChildTopic, null, assocDef);
  }

  @Override public void updateChildTopics(List<TopicModel> newChildTopics, AssociationDefinition assocDef) {
  ...
  @Override public void delete() {
    ResultList<RelatedTopic> childTopics = getRelatedTopics("dm4.core.composition", "dm4.core.parent", "dm4.core.child", null, 0);
  ...
  @Override public RelatedTopic getRelatedTopic(String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersTopicTypeUri) {
  ...
  @Override public ResultList<RelatedTopic> getRelatedTopics(String assocTypeUri, String myRoleTypeUri, String othersRoleTypeUri, String othersTopicTypeUri, int maxResultSize) {
