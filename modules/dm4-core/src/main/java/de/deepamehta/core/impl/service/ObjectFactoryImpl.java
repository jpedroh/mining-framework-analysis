...
class ObjectFactoryImpl implements ObjectFactory {
  ...
  RelatedTopicModel fetchTopicTypeTopic(long topicId) {
    return dms.storage.getTopicRelatedTopic(topicId, "dm4.core.instantiation", "dm4.core.instance", "dm4.core.type", "dm4.core.topic_type");
  }

  RelatedTopicModel fetchAssociationTypeTopic(long assocId) {
    return dms.storage.getAssociationRelatedTopic(assocId, null, "dm4.core.instance", "dm4.core.type", "dm4.core.assoc_type");
  }
  ...
  private RelatedTopicModel fetchDataTypeTopic(long typeId, String typeUri, String className) {
    try {
      RelatedTopicModel dataType = dms.storage.getTopicRelatedTopic(typeId, "dm4.core.aggregation", "dm4.core.type", null, "dm4.core.data_type");
      if (dataType == null) {
        throw new RuntimeException("No data type topic is associated to " + className + " \"" + typeUri + "\"");
      }
      return dataType;
    } catch (Exception e) {
      throw new RuntimeException("Fetching the data type topic for " + className + " \"" + typeUri + "\" failed", e);
    }
  }
  ...
  void storeDataTypeUri(long typeId, String typeUri, String className, String dataTypeUri) {
    ...
    dms.deleteAssociation(assocId, null);
    associateDataType(typeUri, dataTypeUri);
  }

  private void associateDataType(String typeUri, String dataTypeUri) {
    try {
      dms.createAssociation("dm4.core.aggregation", new TopicRoleModel(typeUri, "dm4.core.type"), new TopicRoleModel(dataTypeUri, "dm4.core.default"));
    } catch (Exception e) {
  ...
  private Set<IndexMode> fetchIndexModes(long typeId) {
    ResultSet<RelatedTopicModel> indexModes = dms.storage.getTopicRelatedTopics(typeId, "dm4.core.aggregation", "dm4.core.type", null, "dm4.core.index_mode", 0);
  ...
  void storeIndexModes(String typeUri, Set<IndexMode> indexModes) {
    for (IndexMode indexMode : indexModes) {
      dms.createAssociation("dm4.core.aggregation", new TopicRoleModel(typeUri, "dm4.core.type"), new TopicRoleModel(indexMode.toUri(), "dm4.core.default"));
    }
  }
  ...
  private Map<Long, AssociationDefinitionModel> fetchAssociationDefinitionsUnsorted(Topic typeTopic) {
    ...
    ResultSet<RelatedTopic> partTypes = typeTopic.getRelatedTopics(asList("dm4.core.aggregation_def", "dm4.core.composition_def"), "dm4.core.whole_type", "dm4.core.part_type", null, false, false, 0, null);
    for (RelatedTopic partType : partTypes) {
      AssociationDefinitionModel assocDef = fetchAssociationDefinition(partType.getAssociation(), typeTopic.getUri(), partType.getUri());
      assocDefs.put(assocDef.getId(), assocDef);
    }
    return assocDefs;
  }

  @Override public AssociationDefinitionModel fetchAssociationDefinition(Association assoc) {
    return fetchAssociationDefinition(assoc, fetchWholeType(assoc).getUri(), fetchPartType(assoc).getUri());
  }

  private AssociationDefinitionModel fetchAssociationDefinition(Association assoc, String wholeTypeUri, String partTypeUri) {
    try {
      long assocId = assoc.getId();
      return new AssociationDefinitionModel(assocId, assoc.getTypeUri(), wholeTypeUri, partTypeUri, fetchWholeCardinality(assocId).getUri(), fetchPartCardinality(assocId).getUri(), fetchAssocDefViewConfig(assoc));
    } catch (Exception e) {
      throw new RuntimeException("Fetching association definition failed (wholeTypeUri=\"" + wholeTypeUri + "\", partTypeUri=" + partTypeUri + ", " + assoc + ")", e);
    }
  }
  ...
  void storeAssociationDefinition(AssociationDefinitionModel assocDef) {
    try {
      if (assocDef.getId() == -1) {
        dms.createAssociation(assocDef, null);
      }
      ...
      throw new RuntimeException("Storing association definition \"" + assocDef.getUri() + "\" of type \"" + assocDef.getWholeTypeUri() + "\" failed", e);
    }
  }

  @Override public Topic fetchWholeType(Association assoc) {
    Topic wholeTypeTopic = assoc.getTopic("dm4.core.whole_type");
    if (wholeTypeTopic == null) {
      throw new RuntimeException("Invalid association definition: topic role dm4.core.whole_type " + "is missing in " + assoc);
    }
    return wholeTypeTopic;
  }

  @Override public Topic fetchPartType(Association assoc) {
    Topic partTypeTopic = assoc.getTopic("dm4.core.part_type");
    if (partTypeTopic == null) {
      throw new RuntimeException("Invalid association definition: topic role dm4.core.part_type " + "is missing in " + assoc);
    }
    return partTypeTopic;
  }

  private void associateWholeRoleType(long assocDefId, String wholeRoleTypeUri) {
    dms.createAssociation("dm4.core.aggregation", new TopicRoleModel(wholeRoleTypeUri, "dm4.core.whole_role_type"), new AssociationRoleModel(assocDefId, "dm4.core.assoc_def"));
  }

  private void associatePartRoleType(long assocDefId, String partRoleTypeUri) {
    dms.createAssociation("dm4.core.aggregation", new TopicRoleModel(partRoleTypeUri, "dm4.core.part_role_type"), new AssociationRoleModel(assocDefId, "dm4.core.assoc_def"));
  }

  private RelatedTopicModel fetchWholeCardinality(long assocDefId) {
    RelatedTopicModel wholeCard = dms.storage.getAssociationRelatedTopic(assocDefId, "dm4.core.aggregation", "dm4.core.assoc_def", "dm4.core.whole_cardinality", "dm4.core.cardinality");
    if (wholeCard == null) {
      throw new RuntimeException("Invalid association definition: whole cardinality is missing (assocDefId=" + assocDefId + ")");
    }
    return wholeCard;
  }

  private RelatedTopicModel fetchPartCardinality(long assocDefId) {
    RelatedTopicModel partCard = dms.storage.getAssociationRelatedTopic(assocDefId, "dm4.core.aggregation", "dm4.core.assoc_def", "dm4.core.part_cardinality", "dm4.core.cardinality");
    if (partCard == null) {
      throw new RuntimeException("Invalid association definition: part cardinality is missing (assocDefId=" + assocDefId + ")");
    }
    return partCard;
  }
  ...
  private void associateWholeCardinality(long assocDefId, String wholeCardinalityUri) {
    dms.createAssociation("dm4.core.aggregation", new TopicRoleModel(wholeCardinalityUri, "dm4.core.whole_cardinality"), new AssociationRoleModel(assocDefId, "dm4.core.assoc_def"));
  }

  private void associatePartCardinality(long assocDefId, String partCardinalityUri) {
    dms.createAssociation("dm4.core.aggregation", new TopicRoleModel(partCardinalityUri, "dm4.core.part_cardinality"), new AssociationRoleModel(assocDefId, "dm4.core.assoc_def"));
  }

  List<RelatedAssociationModel> fetchSequence(Topic typeTopic) {
    try {
      List<RelatedAssociationModel> sequence = new ArrayList();
      RelatedAssociation assocDef = typeTopic.getRelatedAssociation("dm4.core.aggregation", "dm4.core.type", "dm4.core.sequence_start", null, false, false);
      if (assocDef != null) {
        sequence.add(assocDef.getModel());
        while ((assocDef = assocDef.getRelatedAssociation("dm4.core.sequence", "dm4.core.predecessor", "dm4.core.successor")) != null) {
          sequence.add(assocDef.getModel());
        }
      }
      return sequence;
  ...
  private void storeSequenceStart(String typeUri, long assocDefId) {
    dms.createAssociation("dm4.core.aggregation", new TopicRoleModel(typeUri, "dm4.core.type"), new AssociationRoleModel(assocDefId, "dm4.core.sequence_start"));
  }

  private void storeSequenceSegment(long predAssocDefId, long succAssocDefId) {
    dms.createAssociation("dm4.core.sequence", new AssociationRoleModel(predAssocDefId, "dm4.core.predecessor"), new AssociationRoleModel(succAssocDefId, "dm4.core.successor"));
  }
  ...
  private RelatedTopicModel fetchLabelConfigTopic(long assocDefId) {
    return dms.storage.getAssociationRelatedTopic(assocDefId, "dm4.core.composition", "dm4.core.whole", "dm4.core.part", "dm4.core.include_in_label");
  }
  ...
  void storeLabelConfig(List<String> labelConfig, Collection<AssociationDefinitionModel> assocDefs) {
    for (AssociationDefinitionModel assocDef : assocDefs) {
      ...
      new AttachedAssociationDefinition(assocDef, dms).setChildTopicValue("dm4.core.include_in_label", new SimpleValue(includeInLabel));
    }
  }

  private ViewConfigurationModel fetchTypeViewConfig(Topic typeTopic) {
    try {
      ResultSet<RelatedTopic> configTopics = typeTopic.getRelatedTopics("dm4.core.aggregation", "dm4.core.type", "dm4.core.view_config", null, true, false, 0, null);
  ...
  private ViewConfigurationModel fetchAssocDefViewConfig(Association assocDef) {
    try {
      ResultSet<RelatedTopic> configTopics = assocDef.getRelatedTopics("dm4.core.aggregation", "dm4.core.assoc_def", "dm4.core.view_config", null, true, false, 0, null);
      return new ViewConfigurationModel(DeepaMehtaUtils.toTopicModels(configTopics.getItems()));
    } catch (Exception e) {
  ...
  private RelatedTopicModel fetchTypeViewConfigTopic(long typeId, String configTypeUri) {
    return dms.storage.getTopicRelatedTopic(typeId, "dm4.core.aggregation", "dm4.core.type", "dm4.core.view_config", configTypeUri);
  }

  private RelatedTopicModel fetchAssocDefViewConfigTopic(long assocDefId, String configTypeUri) {
    return dms.storage.getAssociationRelatedTopic(assocDefId, "dm4.core.aggregation", "dm4.core.assoc_def", "dm4.core.view_config", configTypeUri);
  }
  ...
  private void storeConfigTopic(RoleModel configurable, TopicModel configTopic) {
    Topic topic = dms.createTopic(configTopic, null);
    dms.createAssociation("dm4.core.aggregation", configurable, new TopicRoleModel(topic.getId(), "dm4.core.view_config"));
  }
