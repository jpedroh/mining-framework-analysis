...
public class GraphGenerator {
  ...
  public GraphGenerator addIntervalDoubleColumn() {
    ...
    for (Node node : graphModel.getGraph().getNodes()) {
      node.setAttribute(INTERVAL_DOUBLE_COLUMN, new IntervalDoubleMap(new double[] { 2000, 2001 }, new double[] { Math.random() * 100.0 }));
    }
    return this;
  }
  ...
  public GraphGenerator addTimestampDoubleColumn() {
    ...
    for (Node node : graphModel.getGraph().getNodes()) {
      node.setAttribute(TIMESTAMP_DOUBLE_COLUMN, new TimestampDoubleMap(new double[] { value }, TIMESTAMP_DOUBLE_COLUMN_VALUES[index++]));
    }
    return this;
  }
  ...
  public GraphGenerator addTimestampSetColumn() {
    ...
    int index = 0;
    for (Node node : graphModel.getGraph().getNodes()) {
      node.setAttribute(TIMESTAMP_SET_COLUMN, new TimestampSet(new double[] { TIMESTAMP_SET_VALUES[index++] }));
    }
    return this;
  }
  ...
  public GraphGenerator addIntervalSetColumn() {
    ...
    for (Node node : graphModel.getGraph().getNodes()) {
      node.setAttribute(INTERVAL_SET_COLUMN, new IntervalSet(new double[] { 2000, 2001 }));
    }
    return this;
  }
