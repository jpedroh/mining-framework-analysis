...
<<<<<<< /usr/src/app/output/gephi/gephi/6d122ed8d5aa839543625e58cf7eb7235576d866/modules/DesktopWindow/src/main/java/org/gephi/desktop/banner/BannerComponent.java/left.java
  private static class JPerspectiveButton extends JToggleButton {
    public JPerspectiveButton(String text, Icon icon) {
      ...
      setIcon(ImageUtilities.image2Icon(ImageUtilities.mergeImages(ImageUtilities.loadImage("org/gephi/desktop/banner/perspective/resources/aqua-enabled.png", false), ImageUtilities.icon2Image(icon), 6, 3)));
      setRolloverIcon(ImageUtilities.image2Icon(ImageUtilities.mergeImages(ImageUtilities.loadImage("org/gephi/desktop/banner/perspective/resources/aqua-mouseover.png", false), ImageUtilities.icon2Image(icon), 6, 3)));
      setSelectedIcon(ImageUtilities.image2Icon(ImageUtilities.mergeImages(ImageUtilities.loadImage("org/gephi/desktop/banner/perspective/resources/aqua-selected.png", false), ImageUtilities.icon2Image(icon), 6, 3)));
    }
  }
=======
>>>>>>> Unknown file: This is a bug in JDime.
