...
public class CamusJobTestWithMock {
  ...
  @Before public void before() throws IOException, NoSuchFieldException, IllegalAccessException {
  ...
  @After public void after() throws IOException, SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    folder.delete();
    mocks.clear();
  ...
  @Test public void testRegularJob() throws Exception {
    setupRegularJob();
    job = new CamusJob(props);
  ...
  private SimpleConsumer mockSimpleConsumer(TopicMetadataResponse metadataResponse, OffsetResponse offsetResponse, FetchResponse fetchResponse) {
  ...
  @Test(expected = RuntimeException.class) public void testJobFailDueToOffsetRangeCallException() throws Exception {
  ...
  @Test(expected = RuntimeException.class) public void testJobFailDueToOffsetRangeCallError() throws Exception {
  ...
  @Test public void testJobOffsetRangeCallThirdTrySucceed() throws Exception {
  ...
  @Test(expected = RuntimeException.class) public void testJobFailTooManySkippedMsgSchemaNotFound() throws Exception {
  ...
  @Test public void testJobSucceedWithSkippedMsgSchemaNotFound() throws Exception {
  ...
  @Test(expected = RuntimeException.class) public void testJobFailTooManySkippedMsgOther() throws Exception {
  ...
  @Test public void testJobSucceedWithSkippedMsgOther() throws Exception {
  ...
  @Test(expected = RuntimeException.class) public void testJobFailOffsetTooEarly() throws Exception {
  ...
  @Test(expected = RuntimeException.class) public void testJobFailOffsetTooLate() throws Exception {
  ...
  @Test(expected = RuntimeException.class) public void testJobFailDueToPublishCountsException() throws Exception {
  ...
  @Test public void testJobPublishCountsThirdTimeSucceed() throws Exception {
  ...
  private void assertCamusContains(String topic, List<MyMessage> messages) throws InstantiationException, IllegalAccessException, IOException {
