...
<<<<<<< /usr/src/app/output/linkedin/camus/afe16bd0816776894fd39f6605651d8b566312b0/camus-etl-kafka/src/test/java/com/linkedin/camus/etl/kafka/mapred/EtlMultiOutputCommitterTest.java/left.java
...
public class EtlMultiOutputCommitterTest implements Partitioner {
  ...
  @Test public void testWorkingFilenameIsCorrectUsingDefaultPartitioner() throws IOException {
  ...
  @Test public void testWorkingFilenameRemovesDotsFromTopicName() throws IOException {
    long now = System.currentTimeMillis();
  ...
  @Test public void testPartitionedFilenameIsCorrectUsingDefaultPartitioner() throws IOException {
    String workingFilename = "data.topic-name.1.0.1361656800000-m-00000.avro";
    assertEquals("topic-name/hourly/2013/02/23/14/topic-name.1.0.10.10000.avro", committer.getPartitionedPath(taskAttemptContext, workingFilename, 10, 10000));
  }

  @Test public void testDefaultPartitionerIsTheDefault() {
    assertTrue(EtlMultiOutputFormat.getDefaultPartitioner(taskAttemptContext) instanceof DefaultPartitioner);
  }

  @Test public void testConfiguredDefaultPartitionerIsCorrect() throws ClassNotFoundException {
    taskAttemptContext.getConfiguration().set(EtlMultiOutputFormat.ETL_DEFAULT_PARTITIONER_CLASS, "com.linkedin.camus.etl.kafka.mapred.EtlMultiOutputCommitterTest");
    assertTrue(EtlMultiOutputFormat.getDefaultPartitioner(taskAttemptContext) instanceof EtlMultiOutputCommitterTest);
  }

  @Test public void testPerTopicPartitioner() throws IOException {
    taskAttemptContext.getConfiguration().set(EtlMultiOutputFormat.ETL_DEFAULT_PARTITIONER_CLASS + ".test-topic", "com.linkedin.camus.etl.kafka.mapred.EtlMultiOutputCommitterTest");
    assertTrue(EtlMultiOutputFormat.getDefaultPartitioner(taskAttemptContext) instanceof DefaultPartitioner);
  ...
  @Test public void testDefaultOutputCodecIsDeflate() {
    assertEquals("deflate", EtlMultiOutputFormat.getEtlOutputCodec(taskAttemptContext));
  }

  @Test public void testSetOutputCodec() {
  ...
  @Override public String encodePartition(JobContext context, IEtlKey etlKey) {
    return null;
  }

  @Override public String generatePartitionedPath(JobContext context, String topic, int brokerId, int partitionId, String encodedPartition) {
    return null;
  }
}
=======
...
>>>>>>> /usr/src/app/output/linkedin/camus/afe16bd0816776894fd39f6605651d8b566312b0/camus-etl-kafka/src/test/java/com/linkedin/camus/etl/kafka/mapred/EtlMultiOutputCommitterTest.java/right.java
