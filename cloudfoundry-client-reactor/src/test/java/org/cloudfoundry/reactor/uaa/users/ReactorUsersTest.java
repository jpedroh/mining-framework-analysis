...
public final class ReactorUsersTest extends AbstractUaaApiTest {
  ...
  @Test public void userInfo() {
    ...
    this.users.userInfo(UserInfoRequest.builder().build()).as(StepVerifier::create).expectNext(UserInfoResponse.builder().email("anO0Lv@test.org").emailVerified(true).familyName("PasswordResetUserLast").givenName("PasswordResetUserFirst").name("PasswordResetUserFirst PasswordResetUserLast").phoneNumber("+15558880000").previousLogonTime(null).sub("ab485a4f-168a-4de8-b3ac-ab501767bfc9").userId("ab485a4f-168a-4de8-b3ac-ab501767bfc9").userName("anO0Lv@test.org").build()).expectComplete().verify(Duration.ofSeconds(5));
  }
