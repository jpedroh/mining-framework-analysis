...
public class DOTImporterTest extends TestCase {
  ...
  public void testAttributesWithNoQuotes() throws ImportException {
    ...
    Multigraph<TestVertex, TestEdge> result = new Multigraph<TestVertex, TestEdge>(DOTImporterTest.TestEdge.class);
    DOTImporter<TestVertex, TestEdge> importer = new DOTImporter<TestVertex, TestEdge>(new VertexProvider<TestVertex>() {
      ...
      @Override
      public TestEdge buildEdge(TestVertex from, TestVertex to, String label, Map<String, String> attributes) {
  ...
  public void testInvalidAttributes() {
    ...
    Multigraph<TestVertex, TestEdge> graph = new Multigraph<TestVertex, TestEdge>(DOTImporterTest.TestEdge.class);
    DOTImporter<TestVertex, TestEdge> importer = new DOTImporter<TestVertex, TestEdge>(new VertexProvider<TestVertex>() {
      @Override
      public TestVertex buildVertex(String label, Map<String, String> attributes) {
        return new TestVertex(label, attributes);
  ...
  public void testUpdatingVertex() throws ImportException {
    ...
    DOTImporter<TestVertex, DefaultEdge> importer = new DOTImporter<TestVertex, DefaultEdge>(new VertexProvider<TestVertex>() {
      ...
      @Override
      public DefaultEdge buildEdge(TestVertex from, TestVertex to, String label, Map<String, String> attributes) {
        return new DefaultEdge();
      }
