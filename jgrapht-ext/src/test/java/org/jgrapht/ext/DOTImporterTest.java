...
public class DOTImporterTest extends TestCase {
  public void testUndirectedWithLabels() throws ImportException {
    ...
    Multigraph<String, DefaultEdge> expected = new Multigraph<String, DefaultEdge>(DefaultEdge.class);
  ...
  public void testDirectedNoLabels() throws ImportException {
    ...
    DirectedMultigraph<String, DefaultEdge> expected = new DirectedMultigraph<String, DefaultEdge>(DefaultEdge.class);
  ...
  public void testDirectedSameLabels() throws ImportException {
    String input = "digraph sample {\n" + "  a -> b;" + "  b -> c;\n" + "  a [ label=\"Test\"];\n" + "  b [ label=\"Test\"];\n" + "  c [ label=\"Test\"];\n" + "}";
    DirectedMultigraph<String, DefaultEdge> expected = new DirectedMultigraph<String, DefaultEdge>(DefaultEdge.class);
    expected.addVertex("a");
    expected.addVertex("b");
    expected.addVertex("c");
    expected.addEdge("a", "b");
    expected.addEdge("b", "c");
    DOTImporter<String, DefaultEdge> importer = new DOTImporter<String, DefaultEdge>(new VertexProvider<String>() {
      @Override public String buildVertex(String label, Map<String, String> attributes) {
        return label;
      }
    }, new EdgeProvider<String, DefaultEdge>() {
      @Override public DefaultEdge buildEdge(String from, String to, String label, Map<String, String> attributes) {
        return new DefaultEdge();
      }
    }, new VertexUpdater<String>() {
      @Override public void updateVertex(String vertex, Map<String, String> attributes) {
      }
    });
    DirectedMultigraph<String, DefaultEdge> result = new DirectedMultigraph<String, DefaultEdge>(DefaultEdge.class);
  ...
  public void testExportImportLoop() throws ImportException, ExportException, UnsupportedEncodingException {
    DirectedMultigraph<String, DefaultEdge> start = new DirectedMultigraph<String, DefaultEdge>(DefaultEdge.class);
    start.addVertex("a");
    start.addVertex("b");
    start.addVertex("c");
    start.addVertex("d");
    ...
    start.addEdge("b", "c");
    start.addEdge("b", "d");
    DOTExporter<String, DefaultEdge> exporter = new DOTExporter<String, DefaultEdge>(new VertexNameProvider<String>() {
      @Override public String getVertexName(String vertex) {
        return vertex;
      }
  ...
  public void testDashLabelVertex() throws ImportException {
    ...
    DOTImporter<String, DefaultEdge> importer = new DOTImporter<String, DefaultEdge>(new VertexProvider<String>() {
      @Override public String buildVertex(String label, Map<String, String> attributes) {
        if (label.equals("a")) {
          Assert.assertTrue(attributes.get("label").equals("------this------contains-------dashes------"));
        }
        return label;
      }
    }, new EdgeProvider<String, DefaultEdge>() {
  ...
  public void testAttributesWithNoQuotes() throws ImportException {
    ...
    Multigraph<TestVertex, TestEdge> result = new Multigraph<TestVertex, TestEdge>(TestEdge.class);
    DOTImporter<TestVertex, TestEdge> importer = new DOTImporter<TestVertex, TestEdge>(new VertexProvider<TestVertex>() {
      @Override public TestVertex buildVertex(String label, Map<String, String> attributes) {
        return new TestVertex(label, attributes);
      }
    }, new EdgeProvider<TestVertex, TestEdge>() {
      @Override public TestEdge buildEdge(TestVertex from, TestVertex to, String label, Map<String, String> attributes) {
  ...
  public void testInvalidAttributes() {
    ...
    Multigraph<TestVertex, TestEdge> graph = new Multigraph<TestVertex, TestEdge>(TestEdge.class);
    DOTImporter<TestVertex, TestEdge> importer = new DOTImporter<TestVertex, TestEdge>(new VertexProvider<TestVertex>() {
      @Override public TestVertex buildVertex(String label, Map<String, String> attributes) {
        return new TestVertex(label, attributes);
      }
  ...
  public void testUpdatingVertex() throws ImportException {
    String input = "graph G {\n" + "a -- b;\n" + "a [foo=\"bar\"];\n" + "}";
    Multigraph<TestVertex, DefaultEdge> result = new Multigraph<TestVertex, DefaultEdge>(DefaultEdge.class);
    DOTImporter<TestVertex, DefaultEdge> importer = new DOTImporter<TestVertex, DefaultEdge>(new VertexProvider<TestVertex>() {
      @Override public TestVertex buildVertex(String label, Map<String, String> attributes) {
        return new TestVertex(label, attributes);
      }
    }, new EdgeProvider<TestVertex, DefaultEdge>() {
      @Override public DefaultEdge buildEdge(TestVertex from, TestVertex to, String label, Map<String, String> attributes) {
        return new DefaultEdge();
      }
    }, new VertexUpdater<TestVertex>() {
      @Override public void updateVertex(TestVertex vertex, Map<String, String> attributes) {
  ...
  public void testLabelsWithEscapedSemicolons() throws ImportException {
...
>>>>>>> /usr/src/app/output/jgrapht/jgrapht/c27c35b595c2f687c5537fa9663e7ea3fc9f2fe7/jgrapht-ext/src/test/java/org/jgrapht/ext/DOTImporterTest.java/right.java
  ...
  public void testNonConfiguredUpdate() {
    ...
    try {
      ...
      Assert.assertEquals("exception not as expected", "Update required for vertex a but no vertexUpdater provided", e.getMessage());
    }
  }
