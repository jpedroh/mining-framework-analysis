 ...
 * @author jdcasey
 */
@Named public class DefaultMojoScanner extends AbstractLogEnabled implements MojoScanner {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public void populatePluginDescriptor(PluginToolsRequest request) throws ExtractionException, InvalidPluginDescriptorException {
  ...
  @Override public void setActiveExtractors(Set<String> extractors) {
    if (extractors == null) {
