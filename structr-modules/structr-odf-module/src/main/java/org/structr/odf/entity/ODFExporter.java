...
public interface ODFExporter extends NodeInterface {
	static class Impl {
		static {
			...
			type.addMethod("setResultDocument").addParameter("resultDocument", File.class.getName()).setSource("setProperty(resultDocumentProperty, (org.structr.dynamic.File)resultDocument);").addException(FrameworkException.class.getName());
			type.addMethod("createDocumentFromTemplate").addParameter("ctx", SecurityContext.class.getName()).setSource(ODFExporter.class.getName() + ".createDocumentFromTemplate(this, ctx);").addException(FrameworkException.class.getName()).setDoExport(true);
			type.addMethod("exportImage").addParameter("ctx", SecurityContext.class.getName()).addParameter("uuid", java.lang.String.class.getName()).setSource(ODFExporter.class.getName() + ".exportImage(this, uuid);").addException(FrameworkException.class.getName()).setDoExport(true);
	...
	*/
	public static void createDocumentFromTemplate(final ODFExporter thisNode, final SecurityContext securityContext) throws FrameworkException {
		...
		try {
			...
			templateOdt = OdfDocument.loadDocument(
<<<<<<< LEFT
StorageProviderFactory
=======
StorageProviderFactory
>>>>>>> RIGHT
			.getStorageProvider(template).getInputStream());
	...
	public static void exportImage(final ODFExporter thisNode, final String uuid) {
		...
		try {
			...
			OdfDocument doc = OdfDocument.loadDocument(
<<<<<<< LEFT
StorageProviderFactory
=======
StorageProviderFactory
>>>>>>> RIGHT
			...
			pkg.insert(
<<<<<<< LEFT
StorageProviderFactory.getStorageProvider(result).getInputStream()
=======
StorageProviderFactory.getStorageProvider(result).getInputStream()
>>>>>>> RIGHT
			, ODF_IMAGE_DIRECTORY + imageName, contentType);
			pkg.save(
<<<<<<< LEFT
StorageProviderFactory
=======
StorageProviderFactory
>>>>>>> RIGHT
			.getStorageProvider(result).getOutputStream());
			pkg.close();
			doc.close();
		} catch (java.lang.Exception e) {
			final Logger logger = LoggerFactory.getLogger(ODFExporter.class);
