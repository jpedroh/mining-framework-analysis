...
public interface ODFExporter extends NodeInterface {
  static class Impl {
    static {
      ...
      type.addMethod("exportImage").addParameter("ctx", SecurityContext.class.getName()).addParameter("uuid", String.class.getName()).setSource(ODFExporter.class.getName() + ".exportImage(this, uuid);").addException(FrameworkException.class.getName()).setDoExport(true);
