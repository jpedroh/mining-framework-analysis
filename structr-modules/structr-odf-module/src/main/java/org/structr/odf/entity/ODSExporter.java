...
public interface ODSExporter extends ODFExporter {
  static class Impl {
    static {
      ...
      type.addMethod("exportAttributes").addParameter("ctx", SecurityContext.class.getName()).addParameter("uuid", String.class.getName()).setSource(ODSExporter.class.getName() + ".exportAttributes(this, uuid, ctx);").addException(FrameworkException.class.getName()).setDoExport(true);
    }
  }
      ...
      if (val instanceof Integer) {
        ...
        if (val instanceof Double) {
          ...
          if (val instanceof Boolean) {
            ...
            if (val instanceof AbstractNode) {
