...
public class StructrFileAttributes implements PosixFileAttributes, DosFileAttributes, PosixFileAttributeView {
  ...
  @Override public void setPermissions(final Set<PosixFilePermission> perms) throws IOException {
    if (file == null) {
      return;
    }
    try (Tx tx = StructrApp.getInstance(securityContext).tx()) {
  ...
  @Override public void setGroup(final GroupPrincipal group) throws IOException {
  }

  @Override public void setTimes(final FileTime lastModifiedTime, final FileTime lastAccessTime, final FileTime createTime) throws IOException {
  }
  ...
  @Override public void setOwner(final UserPrincipal owner) throws IOException {
  }
}