...
public class ExternalWrapperIntegrationTest {
    ...
    public void should_wrap_with_external_wrappers_correctly_using_enhanced_profile_using_manual_override_to_disable_output() {
        ...
        String result = TraceeContextLogger.create().config().enforceProfile(Profile.ENHANCED).disable(TestContextDataWrapper.PROPERTY_NAME).apply()
                .build().createJson(new WrappedTestContextData());
    ...
    public void should_wrap_with_implicit_context_provider_correctly_using_basic_profile() {
        ...
        String result = TraceeContextLogger.create().config().enforceProfile(Profile.BASIC).apply().build()
                .createJson(new TestImplicitContextDataProvider());
    ...
    public void should_wrap_with_implicit_context_provider_correctly_using_enhanced_profile_using_manual_override_to_disable_output() {
        ...
        String result = TraceeContextLogger.create().config().enforceProfile(Profile.ENHANCED).disable(TestImplicitContextDataProvider.PROPERTY_NAME)
                .apply().build().createJson(new TestImplicitContextDataProvider());
