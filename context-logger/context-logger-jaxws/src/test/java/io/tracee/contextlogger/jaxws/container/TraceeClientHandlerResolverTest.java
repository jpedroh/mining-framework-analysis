 ...
 */
@RunWith(value = PowerMockRunner.class) @PrepareForTest(value = { TraceeContextLogger.class, Tracee.class }) public class TraceeClientHandlerResolverTest {
  ...
  @Mock private PortInfo portInfo;
  ...
  @Test public void shouldCreateSimpleHandlerResolver() {
  ...
  @Test public void shouldCreateHandlerResolverWithOtherHandlerByType() {
  ...
  @Test public void shouldCreateHandlerResolverWithOtherHandlerByInstance() {
  ...
  @Test public void shouldCreateHandlerResolverAndIgnoreNullValuedHandlerType() {
