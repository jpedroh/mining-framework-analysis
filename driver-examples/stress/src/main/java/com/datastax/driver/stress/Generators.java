...
public class Generators {
    ...
    private abstract static class AbstractGenerator extends QueryGenerator {
    ...
    public static final QueryGenerator.Builder INSERTER = new QueryGenerator.Builder() {
        ...
        public OptionParser addOptions(OptionParser parser) {
            ...
            parser.accepts("columns-per-row", "Number of columns per CQL3 row").withRequiredArg().ofType(java.lang.Integer.class).defaultsTo(5);
            parser.accepts("value-size", "The size in bytes for column values").withRequiredArg().ofType(java.lang.Integer.class).defaultsTo(34);
