 ...
 */
@SuppressWarnings(value = { "serial" }) public class DefaultDoubleSolution extends AbstractSolution<Double> implements DoubleSolution {
  protected List<Bounds<Double>> bounds;

  /**
   * Constructor
   */
  public DefaultDoubleSolution(int numberOfObjectives, int numberOfConstraints, List<Bounds<Double>> boundsList) {
   ...
   * Constructor
   */
  public DefaultDoubleSolution(int numberOfObjectives, List<Bounds<Double>> boundsList) {
  ...
  @Override public Bounds<Double> getBounds(int index) {
    return this.bounds.get(index);
  }

  @Override public DefaultDoubleSolution copy() {
