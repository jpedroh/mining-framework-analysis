...
public class SolutionUtilsTest {
   ...
   */
  @Test public void shouldDistanceBetweenObjectivesWorkProperlyWithTwoSolutionsWithOneObjectiveCaseA() {
   ...
   */
  @Test public void shouldDistanceBetweenObjectivesWorkProperlyWithTwoSolutionsWithOneObjectiveCaseB() {
    DoubleProblem problem = new MockedDoubleProblem(1);
    DoubleSolution solution1 = problem.createSolution();
    DoubleSolution solution2 = problem.createSolution();
    solution1.setObjective(0, 0.1);
   ...
   * Case A: the two solutions are the same
   */
  @Test public void shouldDistanceBetweenObjectivesWorkProperlyWithTwoSolutionsWithTwoObjectivesCaseA() {
    DoubleProblem problem = new MockedDoubleProblem(1);
    DoubleSolution solution1 = problem.createSolution();
    DoubleSolution solution2 = problem.createSolution();
    solution1.setObjective(0, 0.1);
   ...
   * Case B: the two solutions are not the same
   */
  @Test public void shouldDistanceBetweenObjectivesWorkProperlyWithTwoSolutionsWithTwoObjectivesCaseB() {
   ...
   */
  @Test public void shouldAverageDistanceToSolutionListWorkProperlyCaseA() {
    DoubleProblem problem = new MockedDoubleProblem(1);
    DoubleSolution solution1 = problem.createSolution();
    DoubleSolution solution2 = problem.createSolution();
   ...
   */
  @Test public void shouldAverageDistanceToSolutionListWorkProperlyCaseB() {
    DoubleProblem problem = new MockedDoubleProblem(1);
    DoubleSolution solution1 = problem.createSolution();
    DoubleSolution solution2 = problem.createSolution();
    solution1.setObjective(0, 1.0);
   ...
   */
  @Test public void shouldAverageDistanceToSolutionListWorkProperlyCaseC() {
    DoubleProblem problem = new MockedDoubleProblem(1);
    DoubleSolution solution1 = problem.createSolution();
    DoubleSolution solution2 = problem.createSolution();
  ...
  @Test(expected = JMetalException.class) public void shouldNormalizeThrowsAnExceptionWhenTheSolutionIsNull() {
    SolutionUtils.normalize(null, new double[] { 0.1 }, new double[] { 0.2 });
  }

  @Test(expected = JMetalException.class) public void shouldNormalizeThrowsAnExceptionWhenTheMinValueIsNull() {
    DoubleProblem problem = new MockedDoubleProblem(0);
    DoubleSolution solution = problem.createSolution();
    SolutionUtils.normalize(solution, null, new double[] { 0.2 });
  }

  @Test(expected = JMetalException.class) public void shouldNormalizeThrowsAnExceptionWhenTheMaxValueIsNull() {
    DoubleProblem problem = new MockedDoubleProblem(0);
    DoubleSolution solution = problem.createSolution();
    SolutionUtils.normalize(solution, new double[] { 0.2 }, null);
  }

  @Test(expected = JMetalException.class) public void shouldNormalizeThrowsAnExceptionWhenMinAndMaxValuesHaveDifferentLength() {
    DoubleProblem problem = new MockedDoubleProblem(0);
    DoubleSolution solution = problem.createSolution();
    SolutionUtils.normalize(solution, new double[] { 0.2, 0.2 }, new double[] { 0.3 });
  }

  @Test(expected = JMetalException.class) public void shouldNormalizeThrowsAnExceptionWhenMinIsEmpty() {
    DoubleProblem problem = new MockedDoubleProblem(0, 0);
    DoubleSolution solution = problem.createSolution();
    SolutionUtils.normalize(solution, new double[] {  }, new double[] { 0.2 });
  }

  @Test(expected = JMetalException.class) public void shouldNormalizeThrowsAnExceptionWhenMaxIsEmpty() {
    DoubleProblem problem = new MockedDoubleProblem(0, 0);
    DoubleSolution solution = problem.createSolution();
    SolutionUtils.normalize(solution, new double[] { 0.2 }, new double[] {  });
  }

  @Test(expected = JMetalException.class) public void shouldNormalizeThrowsAnExceptionWhenMinAndMaxValuesHaveDifferentNumberOfObjective() {
    DoubleProblem problem = new MockedDoubleProblem(3, 1);
    DoubleSolution solution = problem.createSolution();
    SolutionUtils.normalize(solution, new double[] { 0.2, 0.2 }, new double[] { 0.3, 0.3 });
  }

  @Test public void shouldNormalizeReturnsCorrectNormalizedNumber() {
  ...
  @SuppressWarnings(value = { "serial" }) private class MockedDoubleProblem extends AbstractDoubleProblem {
