...
public class ConstraintHandlingTest {
  ...
  @Test public void shouldIsFeasibleReturnTrueIfTheSolutionHasNoConstraints() {
    DoubleSolution solution = new DummyDoubleProblem(2, 2, 0).createSolution();
    assertTrue(ConstraintHandling.isFeasible(solution));
  }

  @Test public void shouldIsFeasibleReturnTrueIfTheSolutionHasConstraintsAndItIsFeasible() {
    DoubleSolution solution = new DummyDoubleProblem(2, 2, 1).createSolution();
    solution.constraints()[0] = 0.0;
    assertTrue(ConstraintHandling.isFeasible(solution));
  }

  @Test public void shouldIsFeasibleReturnFalseIfTheSolutionIsNotFeasible() {
    DoubleSolution solution = new DummyDoubleProblem(2, 2, 1).createSolution();
    solution.constraints()[0] = -1.0;
    assertFalse(ConstraintHandling.isFeasible(solution));
  }

  @Test public void shouldNumberOfViolatedConstraintsReturnZeroIfTheSolutionHasNoConstraints() {
    DoubleSolution solution = new DummyDoubleProblem(2, 2, 0).createSolution();
    assertEquals(0, ConstraintHandling.numberOfViolatedConstraints(solution));
  }

  @Test public void shouldNumberOfViolatedConstraintsReturnZeroIfTheSolutionHasNotViolatedConstraints() {
    DoubleSolution solution = new DummyDoubleProblem(2, 2, 1).createSolution();
    solution.constraints()[0] = 0.0;
    assertEquals(0, ConstraintHandling.numberOfViolatedConstraints(solution));
  }

  @Test public void shouldNumberOfViolatedConstraintsReturnTheRightNumberOfViolatedConstraints() {
  ...
  @Test public void shouldOverallConstraintViolationDegreeReturnZeroIfTheSolutionHasNotViolatedConstraints() {
    DoubleSolution solution = new DummyDoubleProblem(2, 2, 1).createSolution();
    solution.constraints()[0] = 0.0;
    assertEquals(0.0, ConstraintHandling.overallConstraintViolationDegree(solution), EPSILON);
  }

  @Test public void shouldOverallConstraintViolationDegreeReturnTheRightViolationDegree() {
    DoubleSolution solution = new DummyDoubleProblem(2, 2, 2).createSolution();
    solution.constraints()[0] = -1.0;
  ...
  @Test public void shouldFeasibilityRatioRaiseAndExceptionIfTheSolutionListIsEmpty() {
    assertThrows(EmptyCollectionException.class, () -> ConstraintHandling.feasibilityRatio(new ArrayList<>()));
  }

  @Test public void shouldFeasibilityRatioReturnZeroIfAllTheSolutionsAreUnFeasible() {
  ...
  @Test public void shouldFeasibilityRatioReturnOneIfAllTheSolutionsAreFeasible() {
    DoubleSolution solution1 = new DummyDoubleProblem(2, 2, 2).createSolution();
  ...
  @Test public void shouldFeasibilityRatioReturnTheRightPercentageOfFeasibleSolutions() {
    DoubleSolution solution1 = new DummyDoubleProblem(2, 2, 2).createSolution();
    solution1.constraints()[0] = 0.0;
  ...
  @Test public void shouldOverallConstraintViolationDegreeWorkProperly() {
    DoubleSolution solution = new DummyDoubleProblem(2, 2, 2).createSolution();
  ...
  @Test public void shouldOverallNumberOfViolatedConstraintsProperly() {
    DoubleSolution solution = new DummyDoubleProblem(2, 2, 2).createSolution();
