...
public class EuclideanDistanceBetweenVectorsTest {
  ...
  @Test public void shouldFirstPointToCompareEqualsToNullRaiseAnException() {
    assertThrows(NullParameterException.class, () -> distance.compute(null, new double[] { 1, 2 }));
  }

  @Test public void shouldSecondPointToCompareEqualsToNullRaiseAnException() {
    assertThrows(NullParameterException.class, () -> distance.compute(new double[] { 1, 2 }, null));
  }

  @Test public void shouldPassingPointsWithDifferentDimensionsRaiseAnException() {
