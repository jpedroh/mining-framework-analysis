...
public class JsonIdentityBackend extends AbstractIdentityBackend {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public boolean supportBatchTrans() {
    return true;
  }
  ...
  /**
     * {@inheritDoc}
     */
  @Override public BatchTrans startBatchTrans() throws KrbException {
    if (lock.tryLock()) {
      checkAndReload();
  ...
  /**
     * {@inheritDoc}
     */
  @Override protected void doInitialize() throws KrbException {
  ...
  private void load() throws KrbException {
    ...
    if (lock.tryLock()) {
      try {
        ...
        Map<String, KrbIdentity> reloadedEntries = gson.fromJson(reloadedJsonContent, new TypeToken<HashMap<String, KrbIdentity>>() { }.getType());
  ...
  /**
     * {@inheritDoc}
     */
  @Override protected KrbIdentity doGetIdentity(String principalName) throws KrbException {
    checkAndReload();
  ...
  /**
     * {@inheritDoc}
     */
  @Override protected KrbIdentity doAddIdentity(KrbIdentity identity) throws KrbException {
    checkAndReload();
    if (lock.tryLock()) {
      try {
  ...
  /**
     * {@inheritDoc}
     */
  @Override protected KrbIdentity doUpdateIdentity(KrbIdentity identity) throws KrbException {
    checkAndReload();
    if (lock.tryLock()) {
      try {
        identities.put(identity.getPrincipalName(), identity);
  ...
  /**
     * {@inheritDoc}
     */
  @Override protected void doDeleteIdentity(String principalName) throws KrbException {
    checkAndReload();
  ...
  /**
     * {@inheritDoc}
     */
  @Override protected Iterable<String> doGetIdentities() throws KrbException {
  ...
  class JsonBatchTrans implements BatchTrans {
    @Override public void commit() throws KrbException {
      try {
        persistToFile();
      }  finally {
        lock.unlock();
    ...
    @Override public void rollback() throws KrbException {
      try {
        load();
      }  finally {
        lock.unlock();
    ...
    @Override public BatchTrans addIdentity(KrbIdentity identity) throws KrbException {
    ...
    @Override public BatchTrans updateIdentity(KrbIdentity identity) throws KrbException {
      if (identity != null && identities.containsKey(identity.getPrincipalName())) {
        identities.put(identity.getPrincipalName(), identity);
      }
      return this;
    ...
    @Override public BatchTrans deleteIdentity(String principalName) throws KrbException {
