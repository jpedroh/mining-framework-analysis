...
public class AttributesTest {
  /**
     ...
     */
  @Test public void testGetDateLongDate() {
  ...
  /**
     ...
     */
  @Test public void testGetDateRangeIntDateRange() {
    Attributes a = new Attributes();
    a.setString(Tag.StudyDate, VR.DA, "20110404-20110405");
    DateRange range = a.getDateRange(Tag.StudyDate, null);
    assertEquals("20110404000000.000", DateUtils.formatDT(null, range.getStartDate()));
    assertEquals("20110405235959.999", DateUtils.formatDT(null, range.getEndDate()));
  }

  /**
     * Test method for {@link org.dcm4che3.data.Attributes#getDateRange(long, org.dcm4che3.data.DateRange)}.
     */
  @Test public void testGetDateRangeLongDateRange() {
    Attributes a = new Attributes();
    a.setString(Tag.StudyDate, VR.DA, "20110404");
    a.setString(Tag.StudyTime, VR.TM, "15-20");
    DateRange range = a.getDateRange(Tag.StudyDateAndTime, null);
    assertEquals("20110404150000.000", DateUtils.formatDT(null, range.getStartDate()));
    assertEquals("20110404205959.999", DateUtils.formatDT(null, range.getEndDate()));
  }

  /**
     * Test method for {@link org.dcm4che3.data.Attributes#setDate(long, java.util.Date)}.
     */
  @Test public void testSetDateLongDate() {
    Attributes a = new Attributes();
    a.setDate(Tag.StudyDateAndTime, DateUtils.parseDT(null, "20110404150000.000", new DatePrecision()));
  ...
  /**
     ...
     */
  @Test public void testSetDateRangeIntVRDateRange() {
    Attributes a = new Attributes();
  ...
  /**
     ...
     */
  @Test public void testSetDateRangeLongDateRange() {
    Attributes a = new Attributes();
  ...
  @Test public void testCreatorTagOf() {
    Attributes a = new Attributes();
  ...
  @Test public void testEqualsPrivate() {
  ...
  @Test public void testPrivateTagEqualsWithoutPrivateCreator() {
    Attributes a1 = new Attributes();
    a1.setString(0x00091010, VR.LO, "VALUE1");
    Attributes a2 = new Attributes();
  ...
  @Test public void testPrivateTagNotEqualsWithoutPrivateCreator() {
    Attributes a1 = new Attributes();
    a1.setString(0x00090010, VR.LO, "CREATOR1");
    a1.setString(0x00091010, VR.LO, "VALUE1");
    Attributes a2 = new Attributes();
  ...
  @Test public void testEqualValues() {
    Attributes a = new Attributes();
  ...
  @Test public void testTreatWhiteSpacesAsNoValue() {
    byte[] WHITESPACES = { ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' };
    Attributes a = new Attributes();
  ...
  @Test public void testSetSpecificCharacterSet() throws Exception {
  ...
  @Test public void testReadWronglyEncodedDatasetByChangingDefaultCharacterSet() throws Exception {
    Attributes a = new Attributes();
    a.setString(Tag.SpecificCharacterSet, VR.CS, "ISO 2022 IR 6");
    String NAME = "\u00c4neas^R\u00fcdiger";
    a.setBytes(Tag.PatientName, VR.PN, NAME.getBytes("ISO-8859-1"));
  ...
  @Test public void testGetModified() {
  ...
  @Test public void testGetModified_LIB_363() {
  ...
  @Test public void testGetRemovedOrModified() {
    Attributes original = createOriginal();
    Attributes other = modify(original);
  ...
  @Test public void testItemPointer() {
    ...
    ItemPointer[] ipd = { new ItemPointer(Tag.ContentSequence, 0), new ItemPointer("DCM4CHE", 0x99990010, 0) };
  ...
  private Attributes modify(Attributes original) {
    ...
    other.getNestedDataset(Tag.OtherPatientIDsSequence).setString(Tag.PatientID, VR.LO, "ModifiedOtherPatientID");
  ...
  @Test public void testRemovePrivateAttributes() {
    Attributes original = createOriginal();
  ...
  @Test public void testRemovePrivateAttributes2() {
    Attributes original = createOriginal();
    assertEquals(11, original.size());
  ...
  @Test public void testDiffPN() {
    ...
    int[] selection = { Tag.ReferringPhysicianName, Tag.PatientName, Tag.RequestingPhysician };
    assertEquals(0, a.diff(b, selection, null));
    assertEquals(0, b.diff(a, selection, null));
  }

  @Test public void testContainsTagInRange_First() {
    Attributes a = new Attributes(1);
  ...
  @Test public void testContainsTagInRange_Last() {
    Attributes a = new Attributes(1);
    a.newSequence(Tag.SourcePatientGroupIdentificationSequence, 0);
    assertTrue(a.containsTagInRange(Tag.IssuerOfPatientID, Tag.SourcePatientGroupIdentificationSequence));
  }

  @Test public void testContainsTagInRange_Middle() {
    Attributes a = new Attributes(1);
    a.setString(Tag.TypeOfPatientID, VR.CS, "RFID");
    assertTrue(a.containsTagInRange(Tag.IssuerOfPatientID, Tag.SourcePatientGroupIdentificationSequence));
  }

  @Test public void testContainsTagInRange_Not() {
    Attributes a = new Attributes(2);
  ...
  @Test public void testContainsTagInRange_Not_Empty() {
    Attributes a = new Attributes();
    assertFalse(a.containsTagInRange(Tag.IssuerOfPatientID, Tag.SourcePatientGroupIdentificationSequence));
  }
...
=======
  @Test public void testBulkdata() throws IOException {
    byte[] BYTES = { Byte.MIN_VALUE, 0, Byte.MAX_VALUE, 0 };
    String[] BYTES_AS_STRING = { "-128", "0", "127", "0" };
    ...
    int[] TAGS = { Tag.SelectorAEValue, Tag.SelectorASValue, Tag.SelectorATValue, Tag.SelectorDAValue, Tag.SelectorCSValue, Tag.SelectorDTValue, Tag.SelectorISValue, Tag.SelectorOBValue, Tag.SelectorLOValue, Tag.SelectorOFValue, Tag.SelectorLTValue, Tag.SelectorOWValue, Tag.SelectorPNValue, Tag.SelectorTMValue, Tag.SelectorSHValue, Tag.SelectorUNValue, Tag.SelectorSTValue, Tag.SelectorUCValue, Tag.SelectorUTValue, Tag.SelectorURValue, Tag.SelectorDSValue, Tag.SelectorODValue, Tag.SelectorFDValue, Tag.SelectorOLValue, Tag.SelectorFLValue, Tag.SelectorULValue, Tag.SelectorUSValue, Tag.SelectorSLValue, Tag.SelectorSSValue, Tag.SelectorUIValue, Tag.SelectorOVValue, Tag.SelectorSVValue, Tag.SelectorUVValue };
    int[] INTS = { Short.MIN_VALUE, Short.MAX_VALUE };
    String[] INTS_AS_STRING = { "-32768", "32767" };
    long[] LONGS = { Long.MIN_VALUE, Long.MAX_VALUE };
    String[] LONGS_AS_STRINGS = { "-9223372036854775808", "9223372036854775807" };
    String[] ULONGS_AS_STRINGS = { "9223372036854775808", "9223372036854775807" };
    int[] UINTS = { 0xffff, Short.MAX_VALUE };
    String[] UINTS_AS_STRINGS = { "65535", "32767" };
    float[] FLOATS = { -Float.MIN_VALUE, 0.1234f, Float.MAX_VALUE };
    String[] FLOATS_AS_STRINGS = { "-1.4E-45", "0.1234", "3.4028235E38" };
    ...
    try {
      ...
      assertArrayEquals(INTS_AS_STRING, b.getStrings(Tag.SelectorISValue));
      ...
      assertArrayEquals(FLOATS_AS_STRINGS, b.getStrings(Tag.SelectorDSValue));
...
>>>>>>> /usr/src/app/output/dcm4che/dcm4che/c7f5d09264ed359bc451f53dd0c58b9f7ba1bf43/dcm4che-core/src/test/java/org/dcm4che3/data/AttributesTest.java/right.java


  @Test public void testAddSelectedWithSelectionAttributes() {
    Attributes original = new Attributes();
    Attributes otherPID = new Attributes();
    original.setString(Tag.AccessionNumber, VR.SH, "AccessionNumber");
    original.setNull(Tag.PatientName, VR.PN);
  ...
  @Test public void testAddSelectedWithSelectionAttributesInsideSequence() {
    Attributes original = new Attributes();
    Sequence requestAttributesSequence = original.newSequence(Tag.RequestAttributesSequence, 2);
    Attributes rqAttrs1 = new Attributes();
    rqAttrs1.setString(Tag.RequestedProcedureID, VR.LO, "RequestedProcedureID1");
    ...
    requestAttrsSeqSelection.add(rqAttrsIgnoredSelection);
    Attributes filtered = new Attributes();
    filtered.addSelected(original, selection);
    Attributes filteredExpected = new Attributes();
    Sequence requestAttributesSequenceFilteredExpected = filteredExpected.newSequence(Tag.RequestAttributesSequence, 2);
  ...
  @Test public void testAddSelectedWithSelectionAttributesPrivateTags() {
    Attributes original = new Attributes();
    original.setString("PrivateCreatorA", 0x00990001, VR.LO, "0099xx01A");
    original.setString("PrivateCreatorB", 0x00990001, VR.LO, "0099xx01B");
    Attributes selection = new Attributes();
  ...
  @Test public void testAddSelectedWithSelectionAttributesPrivateTags2() {
    Attributes original = new Attributes();
    original.setString("PrivateCreatorA", 0x00990001, VR.LO, "0099xx01A");
    original.setString("PrivateCreatorB", 0x00990001, VR.LO, "0099xx01B");
  ...
  @Test public void testAddSelectedWithSelectionAttributesInsidePrivateSequence() {
    Attributes original = new Attributes();
    original.setString("PrivateCreatorA", 0x00990001, VR.LO, "0099xx01A");
  ...
  @Test public void testPreserveEmptyPrivateCreator() {
    Attributes original = new Attributes();
  ...
  @Test public void testPreserveDuplicatePrivateCreator() {
    Attributes original = new Attributes();
    original.setString(0x00990010, VR.LO, "PrivateCreatorA");
  ...
  @Test public void testMergePrivateGroups() {
  ...
  @Test public void testRemoveOverlayData() {
    Attributes attrs = new Attributes();
  ...
  @Test public void testNullPrivateCreator() {
    Attributes attrs = new Attributes();
    attrs.setNull(0x00990010, VR.LO);
    assertTrue(new Attributes(attrs).contains(0x00990010));
  }

  @Test(expected = IllegalArgumentException.class) public void testAddFromIncompatibleCharacterSet() {
    Attributes a = new Attributes();
  ...
  @Test(expected = IllegalArgumentException.class) public void testAddIncompatibleCharacterSet() {
    Attributes a = new Attributes();
  ...
  @Test public void testAddFromCompatibleCharacterSet() {
    Attributes a = new Attributes();
  ...
  @Test public void testAddCompatibleCharacterSet() {
    Attributes a = new Attributes();
    a.setString(Tag.SpecificCharacterSet, VR.CS, "ISO_IR 100");
    a.setBytes(Tag.PatientName, VR.PN, "\u00c4neas^R\u00fcdiger".getBytes(StandardCharsets.ISO_8859_1));
    Attributes b = new Attributes();
  ...
  @Test public void testAddCompatibleCharacterSet2() {
    Attributes a = new Attributes();
    a.setString(Tag.SpecificCharacterSet, VR.CS, "ISO_IR 100");
    a.setBytes(Tag.PatientName, VR.PN, "\u00c4neas^R\u00fcdiger".getBytes(StandardCharsets.ISO_8859_1));
  ...
  @Test public void testGetValuePrivateCreatorSh() {
  ...
  @Test public void testMixedEndian() throws IOException {
    ...
    bigEndian.addOriginalAttributes(null, new Date(), "COERCE", "dcm4che", modifiedAttributes);
