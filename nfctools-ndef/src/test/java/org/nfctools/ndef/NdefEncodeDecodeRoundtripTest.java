...
<<<<<<< /usr/src/app/output/grundid/nfctools/15659385c0127435a9d7ed840ff8f444d3d63053/nfctools-ndef/src/test/java/org/nfctools/ndef/NdefEncodeDecodeRoundtripTest.java/left.java
  unsupportedRecord = new UnsupportedRecord(NdefConstants.TNF_RESERVED, "abc".getBytes(), "id".getBytes(), "DEF".getBytes())
=======
  addressInformationGeoRecord = new GeoRecord("Oslo")
>>>>>>> /usr/src/app/output/grundid/nfctools/15659385c0127435a9d7ed840ff8f444d3d63053/nfctools-ndef/src/test/java/org/nfctools/ndef/NdefEncodeDecodeRoundtripTest.java/right.java
  ;

  private static GeoRecord coordinatesGeoRecord = new GeoRecord(59.949444, 10.756389);

  public static Record[] records = new Record[] { absoluteUriRecord, actionRecord, androidApplicationRecord, emptyRecord, textMimeRecord, binaryMimeRecord, smartPosterRecord, textRecord, unknownRecord, uriRecord, collisionResolutionRecord, errorRecord, alternativeCarrierRecord, handoverSelectRecord, handoverCarrierRecord, handoverRequestRecord, signatureRecordMarker, signatureRecord, 
<<<<<<< /usr/src/app/output/grundid/nfctools/15659385c0127435a9d7ed840ff8f444d3d63053/nfctools-ndef/src/test/java/org/nfctools/ndef/NdefEncodeDecodeRoundtripTest.java/left.java
  unsupportedRecord
=======
  addressInformationGeoRecord
>>>>>>> /usr/src/app/output/grundid/nfctools/15659385c0127435a9d7ed840ff8f444d3d63053/nfctools-ndef/src/test/java/org/nfctools/ndef/NdefEncodeDecodeRoundtripTest.java/right.java
  , coordinatesGeoRecord };
