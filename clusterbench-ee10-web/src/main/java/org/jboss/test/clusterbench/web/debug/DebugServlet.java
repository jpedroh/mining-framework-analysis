 ...
 */
@WebServlet(name = "DebugServlet", urlPatterns = { "/debug", "/debug/*" }) public class DebugServlet extends AbstractCommonDebugServlet {
  @Resource(lookup = "java:jboss/infinispan/container/web") private EmbeddedCacheManager container;

  @Override public String getContainerSpecificDebugInfo(HttpServletRequest req) {
