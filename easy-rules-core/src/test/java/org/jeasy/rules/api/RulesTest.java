...
public class RulesTest {
  ...
  @Test public void rulesMustHaveUniqueName() {
  ...
  @Test public void unregisterByName() {
  ...
  @Test public void unregisterByNameNonExistingRule() {
    Rule r1 = new BasicRule("rule1");
    Set<Rule> ruleSet = new HashSet<>();
    ruleSet.add(r1);
    rules = new Rules(ruleSet);
  ...
  @Test(expected = NullPointerException.class) public void whenRegisterNullRule_thenShouldThrowNullPointerException() {
    rules.register(null);
  }

  @Test(expected = NullPointerException.class) public void whenUnregisterNullRule_thenShouldThrowNullPointerException() {
    rules.unregister(null);
  }

  @org.jeasy.rules.annotation.Rule static class DummyRule {
    @Condition public boolean when() {
      return true;
    }

    @Action public void then() {
    }
  }
}