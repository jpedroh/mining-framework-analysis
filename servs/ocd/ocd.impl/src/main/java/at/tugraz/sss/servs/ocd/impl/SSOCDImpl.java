...
public class SSOCDImpl extends SSServImplWithDBA implements SSOCDClientI, SSOCDServerI {
  ...
  @Override public void ocdCreateGraph(SSSocketCon sSCon, SSServPar parA) throws Exception {
  ...
  @Override public String ocdCreateGraph(SSOCDCreateGraphPar parA) throws Exception {
    return SSOCDResource.requestCreateGraph(parA);
  }

  @Override public void ocdGetGraphs(SSSocketCon sSCon, SSServPar parA) throws Exception {
  ...
  @Override public String ocdGetGraphs(SSOCDGetGraphsPar parA) throws Exception {
    return SSOCDResource.requestGetGraphs(parA);
  }

  @Override public void ocdDeleteGraph(SSSocketCon sSCon, SSServPar parA) throws Exception {
  ...
  @Override public void ocdGetGraph(SSSocketCon sSCon, SSServPar parA) throws Exception {
    final SSOCDGetGraphPar par = (SSOCDGetGraphPar) parA.getFromJSON(SSOCDGetGraphPar.class);
    String response = ocdGetGraph(par);
    sSCon.writeRetFullToClient(response, parA.op);
  }

  @Override public String ocdGetGraph(SSOCDGetGraphPar parA) throws Exception {
    return SSOCDResource.requestGetGraph(parA);
  }

  @Override public String ocdDeleteGraph(SSOCDDeleteGraphPar parA) throws Exception {
    return SSOCDResource.requestDeleteGraph(parA);
  }

  @Override public void ocdCreateCover(SSSocketCon sSCon, SSServPar parA) throws Exception {
  ...
  @Override public String ocdCreateCover(SSOCDCreateCoverPar parA) throws Exception {
    return "coverID";
  }

  @Override public void ocdGetCovers(SSSocketCon sSCon, SSServPar parA) throws Exception {
    throw new UnsupportedOperationException("Not supported yet.");
  }

  @Override public String ocdGetCovers(SSOCDGetCoversPar parA) throws Exception {
    throw new UnsupportedOperationException("Not supported yet.");
  }

  @Override public void ocdDeleteCover(SSSocketCon sSCon, SSServPar parA) throws Exception {
    throw new UnsupportedOperationException("Not supported yet.");
  }

  @Override public String ocdDeleteCover(SSOCDDeleteCoverPar parA) throws Exception {
    throw new UnsupportedOperationException("Not supported yet.");
  }

  @Override public String ocdGetAlgorithmNames() throws Exception {
