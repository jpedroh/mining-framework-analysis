...
public class EventBus {
  ...
  @IgnoreJRERequirement private void initLookup() {
    try {
  ...
  private Map<Class<?>, Map<Byte, Set<Method>>> findHandlers(Object listener) {
    ...
    for (final Method m : methods) {
      ...
      if (annotation != null) {
        ...
        if (params.length != 1) {
          logger.log(Level.INFO, "Method {0} in class {1} annotated with {2} does not have exactly one argument", new Object[] { m, listener.getClass(), annotation });
          continue;
        }
  ...
  @IgnoreJRERequirement @SuppressWarnings(value = { "unchecked" }) private Consumer<Object> createMethodInvoker(Object listener, Method method) {
    try {
      MethodHandles.Lookup lookup = LOOKUP_FUNCTION.apply(listener.getClass());
      return (Consumer<Object>) LambdaMetafactory.metafactory(lookup, "accept", MethodType.methodType(Consumer.class, listener.getClass()), MethodType.methodType(void.class, Object.class), lookup.unreflect(method), MethodType.methodType(void.class, method.getParameterTypes()[0])).getTarget().invoke(listener);
    } catch (Throwable t) {
      throw new RuntimeException("Could not create invoker for method " + method + " of listener " + listener + " (" + listener.getClass() + ")", t);
    }
  }

  @SuppressWarnings(value = { "unchecked" }) public void register(Object listener) {
...
<<<<<<< /usr/src/app/output/spigotmc/bungeecord/30bea1c1aeb2cff8fbdd1f75856068426dd38171/event/src/main/java/net/md_5/bungee/event/EventBus.java/left.java
          Consumer<Object>[] baked = entry.getValue().stream().map((method) -> createMethodInvoker(listener, method)).toArray(Consumer[]::new);
=======
>>>>>>> Unknown file: This is a bug in JDime.

          prioritiesMap.
<<<<<<< /usr/src/app/output/spigotmc/bungeecord/30bea1c1aeb2cff8fbdd1f75856068426dd38171/event/src/main/java/net/md_5/bungee/event/EventBus.java/left.java
          computeIfAbsent(entry.getKey(), (k) -> new HashMap<>()).put(listener, baked)
=======
