...
abstract class FileImportJob extends ScheduledJob {
  ...
  @Override public Map<String, Object> getStatusData(final JobStatusMessageSubtype subtype) {
  ...
  @Override public Map<String, Object> getJobInfo() {
  ...
  @Override public void reportException(Exception ex) {
