...
public interface File extends AbstractFile , Indexable , Linkable , JavaScriptSource , Favoritable , DataSource {
	static class Impl {
		static {
			...
			type.addPropertyGetter("cacheForSeconds", java.lang.Integer.class);
			type.addPropertyGetter("checksum", java.lang.Long.class);
			type.addPropertyGetter("md5", java.lang.String.class);
			type.addPropertyGetter("version", java.lang.Integer.class);
			type.addPropertyGetter("contentType", java.lang.String.class);
			type.addPropertyGetter("extractedContent", java.lang.String.class);
			type.addPropertyGetter("basicAuthRealm", java.lang.String.class);
			type.addPropertyGetter("size", java.lang.Long.class);
		...
		// override setProperty methods, but don't call super first (we need the previous value)
			...
			type.overrideMethod("setProperties", false, File.class.getName() + ".OnSetProperties(this, arg0, arg1, arg2);\n\t\tsuper.setProperties(arg0, arg1, arg2);").setReturnType("void").addParameter("arg0", SecurityContext.class.getName()).addParameter("arg1", "java.util.Map<java.lang.String, java.lang.Object>").addParameter("arg2", "boolean").addException(FrameworkException.class.getName());
			...
			type.addMethod("doCSVImport").setReturnType(java.lang.Long.class.getName()).addParameter("ctx", SecurityContext.class.getName()).addParameter("parameters", "java.util.Map<java.lang.String, java.lang.Object>").setSource(("return " + File.class.getName()) + ".doCSVImport(this, parameters, ctx);").addException(FrameworkException.class.getName()).setDoExport(true);
			type.addMethod("doXMLImport").addParameter("ctx", SecurityContext.class.getName()).addParameter("parameters", "java.util.Map<java.lang.String, java.lang.Object>").setReturnType(java.lang.Long.class.getName()).setSource(("return " + File.class.getName()) + ".doXMLImport(this, parameters, ctx);").addException(FrameworkException.class.getName()).setDoExport(true);
			type.addMethod("getFirstLines").addParameter("ctx", SecurityContext.class.getName()).addParameter("parameters", "java.util.Map<java.lang.String, java.lang.Object>").setReturnType("java.util.Map<java.lang.String, java.lang.Object>").setSource(("return " + File.class.getName()) + ".getFirstLines(this, parameters, ctx);").setDoExport(true);
			type.addMethod("getCSVHeaders").addParameter("ctx", SecurityContext.class.getName()).addParameter("parameters", "java.util.Map<java.lang.String, java.lang.Object>").setReturnType("java.util.Map<java.lang.String, java.lang.Object>").setSource(("return " + File.class.getName()) + ".getCSVHeaders(this, parameters, ctx);").addException(FrameworkException.class.getName()).setDoExport(true);
			type.addMethod("getXMLStructure").addParameter("ctx", SecurityContext.class.getName()).setReturnType("java.lang.String").setSource(("return " + File.class.getName()) + ".getXMLStructure(this);").addException(FrameworkException.class.getName()).setDoExport(true);
			type.addMethod("extractStructure").addParameter("ctx", SecurityContext.class.getName()).addParameter("parameters", "java.util.Map<java.lang.String, java.lang.Object>").setReturnType("java.util.Map<java.lang.String, java.lang.Object>").setSource(("return " + File.class.getName()) + ".extractStructure(this);").addException(FrameworkException.class.getName()).setDoExport(true);
			// view configuration
	...
	public abstract OutputStream getOutputStream(final boolean notifyIndexerAfterClosing, final boolean append);
	...
	public static <T> void OnSetProperty(final File thisFile, final PropertyKey<T> key, T value) {
		OnSetProperty(thisFile, key, value, false);
	}

	public static <T> void OnSetProperty(final File thisFile, final PropertyKey<T> key, T value, final boolean isCreation) {
	...
	public static void OnSetProperties(final File thisFile, final SecurityContext securityContext, final PropertyMap properties, final boolean isCreation) throws FrameworkException {
		if (isCreation) {
			return;
		}
		PropertyKey<String> storageProviderKey = StructrApp.key(File.class, "storageProvider");
	...
	public static String getFormattedSize(final File thisFile) {
<<<<<<< LEFT
...
<<<<<<< LEFT
StorageProviderFactory.getStorageProvider(thisFile).getInputStream()
=======
StorageProviderFactory.getStorageProvider(thisFile).getInputStream()
>>>>>>> RIGHT
			;
	...
	public static OutputStream getOutputStream(final File thisFile) {
		return thisFile.getOutputStream(true, false);
	}

	public static OutputStream getOutputStream(final File thisFile, final boolean notifyIndexerAfterClosing, final boolean append) {
		if (thisFile.isTemplate()) {
			final Logger logger = LoggerFactory.getLogger(File.class);
	...
	public static void checkMoveBinaryContents(final File thisFile, final Folder previousParent, final Folder newParent) {
<<<<<<< LEFT
...
>>>>>>> RIGHT
	...
	public static void checkMoveBinaryContents(final File thisFile, final String newProvider) {
