...
public interface DOMElement extends DOMNode, Element, NamedNodeMap, NonIndexed {
  ...
  @Override Set<PropertyKey> getPropertyKeys(String propertyView);
  ...
  @Export default Object event(final SecurityContext securityContext, final java.util.Map<String, java.lang.Object> parameters) throws FrameworkException {
      ...
      switch (editMode) {
        ...
        if (triggeredActions != null && !triggeredActions.isEmpty()) {
          ...
          if (StringUtils.isNotBlank(successTargetString)) {
            out.append(" data-structr-reload-target=\"").append(successTargetString).append("\"");
