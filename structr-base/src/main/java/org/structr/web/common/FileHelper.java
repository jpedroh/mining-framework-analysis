...
public class FileHelper {
  ...
  /**
	 ...
	 * @throws IOException
	 */
  public static <T extends File> T createFile(final SecurityContext securityContext, final InputStream fileStream, final String contentType, final Class<T> fileType, final String name) throws FrameworkException, IOException {
  ...
  /**
	 ...
	 * @throws IOException
	 */
  public static <T extends File> T createFile(final SecurityContext securityContext, final java.io.File existingFileOnDisk, final String contentType, final String name) throws FrameworkException, IOException {
  ...
  /**
	 ...
	 * @throws IOException
	 */
  public static <T extends File> T createFile(final SecurityContext securityContext, final InputStream fileStream, final String contentType, final Class<T> fileType, final String name, final Folder parentFolder) throws FrameworkException, IOException {
    final PropertyMap props = new PropertyMap();
    props.put(StructrApp.key(AbstractFile.class, "name"), name);
    props.put(StructrApp.key(File.class, "contentType"), contentType);
  ...
  /**
	 ...
	 * @throws IOException
	 */
  public static <T extends File> T createFile(final SecurityContext securityContext, final InputStream fileStream, final Class<T> fileType, final PropertyMap props) throws FrameworkException, IOException {
  ...
  /**
	 ...
	 * @throws IOException
	 */
  public static <T extends File> T createFile(final SecurityContext securityContext, final byte[] fileData, final String contentType, final Class<T> t, final String name, final boolean updateMetadata) throws FrameworkException, IOException {
    final PropertyMap props = new PropertyMap();
  ...
  /**
	 ...
	 * @throws IOException
	 */
  public static <T extends File> T createFile(final SecurityContext securityContext, final byte[] fileData, final String contentType, final Class<T> t) throws FrameworkException, IOException {
  ...
  public static void writeToFile(final File fileNode, final byte[] data) throws FrameworkException, IOException {
    ...
    try (InputStream is = new ByteArrayInputStream(data); OutputStream os = StorageProviderFactory.getStorageProvider(fileNode).getOutputStream()) {
      IOUtils.copy(is, os);
    }
  }
  ...
  public static void writeToFile(final File fileNode, final InputStream data) throws FrameworkException, IOException {
    setFilePropertiesOnCreation(fileNode);
    try (OutputStream out = StorageProviderFactory.getStorageProvider(fileNode).getOutputStream()) {
  ...
  public static String getContentMimeType(final File file, final String name) throws IOException {
    ...
    try (InputStream is = new BufferedInputStream(StorageProviderFactory.getStorageProvider(file).getInputStream())) {
  ...
  public static void unarchive(final SecurityContext securityContext, final File file, final String parentFolderId) throws ArchiveException, IOException, FrameworkException {
    ...
    if (parentFolderId != null) {
      try (Tx tx = app.tx(true, true, true)) {
    ...
    switch (ArchiveStreamFactory.detect(bufferedIs)) {
      ...
      case ArchiveStreamFactory.ZIP:
      {
        ...
        try (ZipArchiveInputStream in = new ZipArchiveInputStream(bufferedIs, null, false, true)) {
      ...
      default:
      {
        ...
        try (ArchiveInputStream in = new ArchiveStreamFactory().createArchiveInputStream(bufferedIs)) {
          handleArchiveInputStream(in, app, securityContext, existingParentFolder);
        }
      }
    }
  ...
  public static Long getChecksum(final InputStream inputStream, long size) throws IOException {
    try (BufferedInputStream is = new BufferedInputStream(inputStream, 131072)) {
      final long hash = LongHashFunction.xx().hash(is, new Access<BufferedInputStream>() {
        @Override public int getByte(BufferedInputStream input, long offset) {
          try {
            return input.read();
          } catch (IOException ex) {
          }
        ...
        @Override public ByteOrder byteOrder(BufferedInputStream input) {
  ...
  public static String getMD5Checksum(final java.io.File fileOnDisk) {
    try (InputStream is = FileUtils.openInputStream(fileOnDisk)) {
      return DigestUtils.md5Hex(is);
    } catch (final IOException ex) {
