...
final class DefaultNodeAndNPMInstaller implements NodeAndNPMInstaller {
  ...
  @Override public void install(String nodeVersion, String npmVersion) throws InstallationException {
    install(nodeVersion, npmVersion, null, null);
  }

  @Override public void install(String nodeVersion, String npmVersion, String nodeDownloadRoot, String npmDownloadRoot) throws InstallationException {
