...
public class JsonFluentAssertTest {
  ...
  @Test public void testAssertNode() throws IOException {
    try {
  ...
  @Test public void testAssertNodeInExpectOnly() throws IOException {
    try {
  ...
  @Test public void testAssertReader() throws IOException {
    try {
  ...
  @Test public void testOkNumber() throws IOException {
    assertThatJson("{\"test\":1}").node("test").isEqualTo(1);
  }

  @Test public void testOkFloat() throws IOException {
    assertThatJson("{\"test\":1.1}").node("test").isEqualTo(1.1);
  }

  @Test public void testOkNull() throws IOException {
    assertThatJson("{\"test\":null}").node("test").isEqualTo(null);
  }

  @Test public void testNotEqualTo() throws IOException {
    try {
  ...
  @Test public void testSameStructureOk() throws IOException {
    assertThatJson("{\"test\":1}").hasSameStructureAs("{\"test\":21}");
  }

  @Test public void testDifferentStructure() throws IOException {
    try {
  ...
  @Test public void testEqualsToArray() throws IOException {
    assertThatJson("{\"test\":[1,2,3]}").node("test").isEqualTo(new int[] { 1, 2, 3 });
  }

  @Test(expected = AssertionError.class) public void testNotEqualsToToArray() throws IOException {
    assertThatJson("{\"test\":[1,2,3]}").node("test").isNotEqualTo(new int[] { 1, 2, 3 });
  }

  @Test public void testEqualsToBoolean() throws IOException {
    assertThatJson("{\"test\":true}").node("test").isEqualTo(true);
  }

  @Test public void testEqualsToNull() throws IOException {
    assertThatJson("{\"test\":null}").node("test").isEqualTo(null);
  }

  @Test(expected = AssertionError.class) public void testEqualsToNullFail() throws IOException {
    assertThatJson("{\"test\":1}").node("test").isEqualTo(null);
  }

  @Test public void testNotEqualsToNull() throws IOException {
    assertThatJson("{\"test\":1}").node("test").isNotEqualTo(null);
  }

  @Test public void testIssue3() throws IOException {
    assertThatJson("{\"someKey\":\"111 text\"}").node("someKey").isEqualTo("\"111 text\"");
  }

  @Test public void testIssue3NoSpace() throws IOException {
    assertThatJson("{\"someKey\":\"111text\"}").node("someKey").isEqualTo("\"111text\"");
  }

  @Test public void testIssue3SpaceStrings() throws IOException {
    assertThatJson("{\"someKey\":\"a b\"}").node("someKey").isEqualTo("a b");
  }

  @Test public void testIssue3Original() throws IOException {
    assertThatJson("{\"someKey\":\"111 text\"}").node("someKey").isEqualTo("111 text");
  }
}