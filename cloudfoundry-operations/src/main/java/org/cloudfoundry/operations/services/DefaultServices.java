...
<<<<<<< /usr/src/app/output/cloudfoundry/cf-java-client/959fe97a816ce0e9039d08e43d890b6fd47b1f0b/cloudfoundry-operations/src/main/java/org/cloudfoundry/operations/services/DefaultServices.java/left.java
    flatMap(function((cloudFoundryClient, spaceId) -> requestCreateUserProvidedServiceInstance(cloudFoundryClient, request.getName(), request.getCredentials(), request.getRouteServiceUrl(), spaceId, request.getSyslogDrainUrl())))
=======
    then(function((cloudFoundryClient, spaceId) -> requestCreateUserProvidedServiceInstance(cloudFoundryClient, request.getName(), request.getCredentials(), request.getRouteServiceUrl(), spaceId, request.getSyslogDrainUrl(), request.getTags())))
>>>>>>> /usr/src/app/output/cloudfoundry/cf-java-client/959fe97a816ce0e9039d08e43d890b6fd47b1f0b/cloudfoundry-operations/src/main/java/org/cloudfoundry/operations/services/DefaultServices.java/right.java
