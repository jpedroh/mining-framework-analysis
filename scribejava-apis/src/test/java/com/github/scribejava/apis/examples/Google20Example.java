...
<<<<<<< /usr/src/app/output/fernandezpablo85/scribe-java/b4e5895a364746923caa75cfbcaf05772b9fa927/scribejava-apis/src/test/java/com/github/scribejava/apis/examples/Google20Example.java/left.java
    (OAuth20ServiceImpl) new ServiceBuilder().provider(GoogleApi20.class).apiKey(clientId).apiSecret(clientSecret).scope("profile").state(secretState).build()
=======
    new ServiceBuilder().apiKey(clientId).apiSecret(clientSecret).scope("profile").state(secretState).callback("http://example.com/callback").build(GoogleApi20.instance())
>>>>>>> /usr/src/app/output/fernandezpablo85/scribe-java/b4e5895a364746923caa75cfbcaf05772b9fa927/scribejava-apis/src/test/java/com/github/scribejava/apis/examples/Google20Example.java/right.java
    ;
