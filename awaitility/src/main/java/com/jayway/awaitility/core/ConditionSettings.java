...
class ConditionSettings {
  ...
  /**
     ...
     */
  public ConditionSettings(String alias, boolean catchUncaughtExceptions, Duration maxWaitTime, Duration pollInterval, Duration pollDelay, IntermediaryResultHandler intermediaryResultHandler) {
    if (maxWaitTime == null) {
