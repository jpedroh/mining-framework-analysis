...
@RunWith(value = SpringJUnit4ClassRunner.class) @ContextConfiguration public class OutboundBufferTest {
  ...
  @Autowired private WorkerRecoveryManager recoveryManager;

  @Autowired private OutboundBuffer buffer;
  ...
  /**
	 ...
	 */
  @Test public void testAggregation() throws InterruptedException {
  ...
  /**
	 ...
	 */
  @Test public void testProducerBlocking() throws InterruptedException {
  ...
  /**
	 ...
	 * @throws InterruptedException
	 */
  @Test public void testConsumerBlocking() throws InterruptedException {
  ...
  @Test public void longevityTest() throws InterruptedException {
    int THREADS_NUM = 5;
    ...
    doAnswer((Answer<Object>) (invocation) -> {
      @SuppressWarnings(value = { "unchecked" }) List<Message> messages = (List<Message>) invocation.getArguments()[0];
      int weight = 0;
  ...
  @Configuration static class config {
    ...
    @Bean public RetryTemplate retryTemplate() {
      return new RetryTemplate();
    }

    @Bean public OutboundBuffer outboundBuffer() {
      return new OutboundBufferImpl();
    }

    @Bean public String workerUuid() {
      return "1234";
    }

    @Bean public Integer numberOfExecutionThreads() {
      return 10;
    }
  }
}