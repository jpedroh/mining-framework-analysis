 ...
 * Time: 14:11
 */
@RunWith(value = SpringJUnit4ClassRunner.class) @ContextConfiguration public class ExecutionServiceTest {
  ...
  @Autowired private ExecutionServiceImpl executionService;
  ...
  @Test public void executeStepTest() throws InterruptedException {
    ...
    Assert.assertEquals(0, exe.getPosition().longValue());
  ...
  @Configuration static class ConfigurationForTest {
    ...
    @Bean public ExecutionServiceImpl getExecutionService() {
