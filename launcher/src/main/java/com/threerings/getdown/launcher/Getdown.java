...
public abstract class Getdown extends Thread implements Application.StatusDisplay, RotatingBackgrounds.ImageLoader {
  ...
  private void fail(Exception e) {
    ...
    if (msg == null) {
      ...
      if (!msg.startsWith("m.")) {
        msg = e instanceof FileNotFoundException ? MessageUtil.compose("m.missing_resource", MessageUtil.taint(msg), _ifc.installError) : MessageUtil.compose("m.init_error", MessageUtil.taint(msg), _ifc.installError);
      }
    }
    fail(msg);
  }
