    ...
    if (StringUtil.isBlank(host) && LaunchUtil.isWindows()) {
      try {
        ...
        for (Iterator<?> iter = r.values(); iter.hasNext(); ) {
          ...
          if ("ProxyServer".
<<<<<<< /usr/src/app/output/threerings/getdown/f087863098a6bc43551643f94cbe1893348773e6/launcher/src/main/java/com/threerings/getdown/launcher/ProxyUtil.java/left.java
          equals(value.getName())
=======
          getName().equals("AutoConfigURL")
>>>>>>> /usr/src/app/output/threerings/getdown/f087863098a6bc43551643f94cbe1893348773e6/launcher/src/main/java/com/threerings/getdown/launcher/ProxyUtil.java/right.java
          ) {
...
<<<<<<< /usr/src/app/output/threerings/getdown/f087863098a6bc43551643f94cbe1893348773e6/launcher/src/main/java/com/threerings/getdown/launcher/ProxyUtil.java/left.java
            cidx = strval.indexOf(':')
=======
            acjs = new InputStreamReader(new URL(acurl).openStream())
>>>>>>> /usr/src/app/output/threerings/getdown/f087863098a6bc43551643f94cbe1893348773e6/launcher/src/main/java/com/threerings/getdown/launcher/ProxyUtil.java/right.java
            ;
    ...
    try {
      ...
      if (conn instanceof HttpURLConnection) {
        ...
        try {
          ...
          if (rcode == HttpURLConnection.HTTP_PROXY_AUTH || rcode == HttpURLConnection.HTTP_FORBIDDEN) {
