...
public class SparseIntGraphTest {
  ...
  public static void testUndirected(BiFunction<Integer, List<Pair<Integer, Integer>>, Graph<Integer, Integer>> graphSupplier) {
    ...
    assertEquals(IntStream.range(0, edges.size()).mapToObj(Integer::valueOf).collect(Collectors.toSet()), g.edgeSet());
    assertEquals(IntStream.range(0, 6).mapToObj(Integer::valueOf).collect(Collectors.toSet()), g.vertexSet());
  ...
  public static void testUndirectedWithLoops(BiFunction<Integer, List<Pair<Integer, Integer>>, Graph<Integer, Integer>> graphSupplier) {
    final int vertexCount = 4;
    List<Pair<Integer, Integer>> edges = Arrays.asList(Pair.of(0, 0), Pair.of(0, 1), Pair.of(0, 2), Pair.of(0, 0), Pair.of(0, 1), Pair.of(1, 1), Pair.of(1, 2));
    Graph<Integer, Integer> g = graphSupplier.apply(vertexCount, edges);
    ...
    assertEquals(IntStream.range(0, edges.size()).mapToObj(Integer::valueOf).collect(Collectors.toSet()), g.edgeSet());
    assertEquals(IntStream.range(0, 4).mapToObj(Integer::valueOf).collect(Collectors.toSet()), g.vertexSet());
    GraphType type = g.getType();
    assertTrue(type.isAllowingCycles());
    assertTrue(type.isAllowingMultipleEdges());
    assertTrue(type.isAllowingSelfLoops());
  ...
  public static void testUndirectedWeighted(BiFunction<Integer, List<Triple<Integer, Integer, Double>>, Graph<Integer, Integer>> graphSupplier) {
    final Integer vertexCount = 6;
    List<Triple<Integer, Integer, Double>> edges = Arrays.asList(Triple.of(0, 5, 1d), Triple.of(0, 2, 2d), Triple.of(3, 4, 3d), Triple.of(1, 4, 4d), Triple.of(0, 1, 5d), Triple.of(3, 1, 6d), Triple.of(2, 4, 7d));
    Graph<Integer, Integer> g = graphSupplier.apply(vertexCount, edges);
  ...
  public static void testDirected(BiFunction<Integer, List<Pair<Integer, Integer>>, Graph<Integer, Integer>> graphSupplier) {
    final Integer vertexCount = 8;
    List<Pair<Integer, Integer>> edges = Arrays.asList(Pair.of(0, 1), Pair.of(1, 0), Pair.of(1, 4), Pair.of(1, 5), Pair.of(1, 6), Pair.of(2, 4), Pair.of(2, 4), Pair.of(2, 4), Pair.of(3, 4), Pair.of(4, 5), Pair.of(5, 6), Pair.of(7, 6), Pair.of(7, 7));
    Graph<Integer, Integer> g = graphSupplier.apply(vertexCount, edges);
    assertEquals(vertexCount.intValue(), g.vertexSet().size());
    assertEquals(edges.size(), g.edgeSet().size());
    assertEquals(IntStream.range(0, edges.size()).mapToObj(Integer::valueOf).collect(Collectors.toSet()), g.edgeSet());
    assertEquals(IntStream.range(0, vertexCount).mapToObj(Integer::valueOf).collect(Collectors.toSet()), g.vertexSet());
  ...
  public static void testDirectedNoIncoming(BiFunction<Integer, List<Pair<Integer, Integer>>, Graph<Integer, Integer>> graphSupplier) {
    final Integer vertexCount = 8;
    List<Pair<Integer, Integer>> edges = Arrays.asList(Pair.of(0, 1), Pair.of(1, 0), Pair.of(1, 4), Pair.of(1, 5), Pair.of(1, 6), Pair.of(2, 4), Pair.of(2, 4), Pair.of(2, 4), Pair.of(3, 4), Pair.of(4, 5), Pair.of(5, 6), Pair.of(7, 6), Pair.of(7, 7));
    Graph<Integer, Integer> g = graphSupplier.apply(vertexCount, edges);
    assertEquals(vertexCount.intValue(), g.vertexSet().size());
  ...
  public static void testDirectedWeighted(BiFunction<Integer, List<Triple<Integer, Integer, Double>>, Graph<Integer, Integer>> graphSupplier) {
    List<Triple<Integer, Integer, Double>> edges = Arrays.asList(Triple.of(0, 1, 0d), Triple.of(1, 0, 1d), Triple.of(1, 4, 2d), Triple.of(1, 5, 3d), Triple.of(1, 6, 4d), Triple.of(2, 4, 5d), Triple.of(2, 4, 6d), Triple.of(2, 4, 7d), Triple.of(3, 4, 8d), Triple.of(4, 5, 9d), Triple.of(5, 6, 10d), Triple.of(7, 6, 11d), Triple.of(7, 7, 12d));
    int vertices = 8;
    Graph<Integer, Integer> g = graphSupplier.apply(vertices, edges);
    assertEquals(vertices, g.vertexSet().size());
    assertEquals(edges.size(), g.edgeSet().size());
    assertEquals(IntStream.range(0, edges.size()).mapToObj(Integer::valueOf).collect(Collectors.toSet()), g.edgeSet());
    assertEquals(IntStream.range(0, vertices).mapToObj(Integer::valueOf).collect(Collectors.toSet()), g.vertexSet());
