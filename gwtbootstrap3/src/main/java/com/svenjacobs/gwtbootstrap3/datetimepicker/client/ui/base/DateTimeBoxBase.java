 ...
 * @author Joshua Godi
 */
public class DateTimeBoxBase extends Widget implements HasValue<Date>, HasEnabled, HasValueChangeHandlers<Date>, HasVisibility, HasChangeHandlers, HasVisibleHandlers, HasId, HasResponsiveness, HasDateIcon, HasShowDatePicker, HasShowTimePicker, HasDownIcon, HasEndDate, HasStartDate, HasStrict, HasTimeIcon, HasUpIcon, HasFormat, HasPlaceholder {
...
>>>>>>> /usr/src/app/output/gwtbootstrap3/gwtbootstrap3/4fc9137691f262d79c1f7844d85659dea906122c/gwtbootstrap3/src/main/java/com/svenjacobs/gwtbootstrap3/datetimepicker/client/ui/base/DateTimeBoxBase.java/right.java
  ...
  @Override public void setEndDate(final Date endDate) {
    setEndDate(textBox.getElement(), endDate);
  }

  @Override public void setStartDate(final Date startDate) {
    setStartDate(textBox.getElement(), startDate);
  }

  @Override public void setUseStrict(final boolean useStrict) {
    this.useStrict = useStrict;
  }

  @Override public void setDateIcon(final Icon icon) {
    dateIconClass = icon.getStyleName();
  }

  @Override public void setDownIcon(final Icon icon) {
    downIconClass = icon.getStyleName();
  }

  @Override public void setTimeIcon(final Icon icon) {
    timeIconClass = icon.getStyleName();
  }

  @Override public void setUpIcon(final Icon icon) {
    upIconClass = icon.getStyleName();
  }

  @Override public void setShowDatePicker(final boolean showDatePicker) {
    showDate = showDatePicker;
  }

  @Override public void setShowTimePicker(final boolean showTimePicker) {
  ...
  @Override public HandlerRegistration addHideHandler(final HideHandler handler) {
    return addHandler(handler, HideEvent.getType());
  }

  @Override public HandlerRegistration addShowHandler(final ShowHandler handler) {
  ...
  @Override public void setValue(final Date value) {
    setValue(value, false);
  }

  @Override public void setValue(final Date value, final boolean fireEvents) {
  ...
  @Override public HandlerRegistration addValueChangeHandler(final ValueChangeHandler<Date> handler) {
  ...
  protected native void configure(Element e, boolean showTime, boolean showDate, boolean useStrict, String timeIconClass, String dateIconClass, String upIconClass, String downIconClass);
}