...
public class Popover implements IsWidget, HasWidgets, HasOneWidget, HasId, HasHover {
  ...
  @Override public void setWidget(final Widget w) {
    if (w == widget) {
      return;
    }
    if (w != null) {
  ...
  @Override public void setWidget(final IsWidget w) {
  ...
  @Override public void setIsAnimated(final boolean isAnimated) {
  ...
  @Override public void setIsHtml(final boolean isHTML) {
    this.isHTML = isHTML;
  }
  ...
  @Override public void setPlacement(final Placement placement) {
    this.placement = placement;
  }

  @Override public Placement getPlacement() {
    return placement;
  }

  @Override public void setTrigger(final Trigger trigger) {
  ...
  @Override public void setShowDelayMs(final int showDelayMs) {
    this.showDelayMs = showDelayMs;
  }

  @Override public int getShowDelayMs() {
    return showDelayMs;
  }

  @Override public void setHideDelayMs(final int hideDelayMs) {
    this.hideDelayMs = hideDelayMs;
  }

  @Override public int getHideDelayMs() {
    return hideDelayMs;
  }

  @Override public void setContainer(final String container) {
  ...
  public void reconfigure() {
    ...
    if (container != null && selector != null) {
      popover(widget.getElement(), isAnimated, isHTML, placement.getCssName(), selector, title, content, trigger.getCssName(), showDelayMs, hideDelayMs, container);
    } else {
      if (container != null) {
        popover(widget.getElement(), isAnimated, isHTML, placement.getCssName(), title, content, trigger.getCssName(), showDelayMs, hideDelayMs, container);
      } else {
        if (selector != null) {
          popover(widget.getElement(), isAnimated, isHTML, placement.getCssName(), selector, title, content, trigger.getCssName(), showDelayMs, hideDelayMs);
        } else {
          popover(widget.getElement(), isAnimated, isHTML, placement.getCssName(), title, content, trigger.getCssName(), showDelayMs, hideDelayMs);
        }
      }
    }
  }
  ...
  @Override public boolean remove(final Widget w) {
    if (widget != w) {
      return false;
    }
    clear();
  ...
  private native void popover(Element e, boolean animation, boolean html, String placement, String selector, String title, String content, String trigger, int showDelay, int hideDelay, String container);

  private native void popover(Element e, boolean animation, boolean html, String placement, String title, String content, String trigger, int showDelay, int hideDelay, String container);

  private native void popover(Element e, boolean animation, boolean html, String placement, String selector, String title, String content, String trigger, int showDelay, int hideDelay);

  private native void popover(Element e, boolean animation, boolean html, String placement, String title, String content, String trigger, int showDelay, int hideDelay);
}