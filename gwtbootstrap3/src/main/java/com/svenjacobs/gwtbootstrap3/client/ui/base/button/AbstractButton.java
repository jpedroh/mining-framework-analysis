...
public abstract class AbstractButton extends ComplexWidget implements HasEnabled, HasActive, HasType<ButtonType>, HasSize<ButtonSize>, HasTarget, HasClickHandlers, HasResponsiveness {
  ...
  /**
     ...
     */
  @Override public void setType(final ButtonType type) {
  ...
  /**
     ...
     */
  @Override public void setSize(final ButtonSize size) {
    StyleHelper.addUniqueEnumStyleName(this, ButtonSize.class, size);
  }

  @Override public ButtonSize getSize() {
    return ButtonSize.fromStyleName(getStyleName());
  }

  @Override public void setTarget(final String target) {
