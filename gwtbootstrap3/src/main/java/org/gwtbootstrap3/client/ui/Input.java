...
public class Input extends ComplexWidget implements HasInputType, HasPlaceholder, HasFormValue {
  ...
  @UiConstructor public Input(final InputType type) {
    this();
    setType(type);
  }
  ...
  @Override public void setType(final InputType inputType) {
    getElement().setAttribute(TYPE, inputType.getType());
  }

  @Override public InputType getType() {
  ...
  @Override public void setFormValue(final String value) {
