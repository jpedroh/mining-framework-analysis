 ...
 */
public class SimpleRadioButton extends com.google.gwt.user.client.ui.SimpleRadioButton implements HasResponsiveness, HasId, HasPull, HasFormValue, HasChangeHandlers {
  ...
  /**
     * {@inheritDoc}
     */
  @Override public void setPull(final Pull pull) {
