 ...
 * @author Sven Jacobs
 */
public class IconTextMixin<T extends ComplexWidget & HasText & HasIcon & HasIconPosition> implements HasText, HasIcon, HasIconPosition {
  ...
  @Override public void setIconFlip(IconFlip iconFlip) {
    this.iconFlip = iconFlip;
    render(icon);
  }

  @Override public IconFlip getIconFlip() {
    return iconFlip;
  }

  @Override public void setIconRotate(IconRotate iconRotate) {
    this.iconRotate = iconRotate;
    render(icon);
  }

  @Override public IconRotate getIconRotate() {
    return iconRotate;
  }

  @Override public void setIconBordered(boolean iconBordered) {
    this.iconBordered = iconBordered;
    render(icon);
  }

  @Override public boolean isIconBordered() {
    return iconBordered;
  }

  @Override public void setIconMuted(boolean iconMuted) {
    this.iconMuted = iconMuted;
    render(icon);
  }

  @Override public boolean isIconMuted() {
    return iconMuted;
  }

  @Override public void setIconLight(boolean iconLight) {
    this.iconLight = iconLight;
    render(icon);
  }

  @Override public boolean isIconLight() {
    return iconLight;
  }

  @Override public void setIconSpin(boolean iconSpin) {
    this.iconSpin = iconSpin;
    render(icon);
  }

  @Override public boolean isIconSpin() {
    return iconSpin;
  }
