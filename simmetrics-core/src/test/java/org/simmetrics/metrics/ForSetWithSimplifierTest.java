...
@SuppressWarnings(value = { "javadoc" }) public class ForSetWithSimplifierTest extends StringMetricTest {
  ...
  @Override protected ForSetWithSimplifier getMetric() {
    return new ForSetWithSimplifier(metric, simplifier, tokenizer);
  }

  @Override protected T[] getTests() {
    return new T[] { new T(0.0f, "To repeat repeat is to repeat", ""), new T(1.0f, "To repeat repeat is to repeat", "to repeat repeat is to repeat"), new T(1.0f, "To repeat repeat is to repeat", "to  repeat  is  to  repeat") };
  }
