...
public final class JaroTest {
	...
	public static final class Defaults extends StringMetricTest {
		...
		protected T<String>[] getTests() {
			return new T[] {
<<<<<<< /usr/src/app/output/simmetrics/simmetrics/1b1577d4bb64cde3a360e8024099e98d1b19638c/simmetrics-core/src/test/java/org/simmetrics/metrics/JaroTest.java/left.java
...
||||||| /usr/src/app/output/simmetrics/simmetrics/1b1577d4bb64cde3a360e8024099e98d1b19638c/simmetrics-core/src/test/java/org/simmetrics/metrics/JaroTest.java/base.java
					new T(0.9444f, "test string1", "test string2"),
					new T(0.8667f, "aaa bbb ccc ddd", "aaa bbb ccc eee"),
					new T(0.9048f, "a b c d", "a b c e"),
					new T(0.8889f, "Healed", "Sealed"),
