...
@SuppressWarnings(value = { "javadoc" }) public class ForMultisetWithSimplifierTest extends StringMetricTest {
  ...
  @Override protected ForMultisetWithSimplifier getMetric() {
    return new ForMultisetWithSimplifier(metric, simplifier, tokenizer);
  }

  @Override protected T[] getTests() {
    return new T[] { new T(0.0f, "To repeat repeat is to repeat", ""), new T(1.0f, "To repeat repeat is to repeat", "to repeat repeat is to repeat"), new T(1.0f, "To repeat repeat is to repeat", "to  repeat  repeat  is  to  repeat") };
  }
