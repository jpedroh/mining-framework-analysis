...
public class StringMetricBuilder {
  ...
  public abstract class TokenMetricBuilder<T extends java.lang.Object> {
    ...
    /**
		 ...
		 */
    public StringMetric build() {
      Preconditions.checkNotNull(tokenizer, "A tokenizer must be set to build a tokenizing metric");
      Simplifier simplifier;
      if (simplifiers.isEmpty()) {
    ...
    protected abstract StringMetric build(T metric, Simplifier simplifier, Tokenizer tokenizer);
  }

  public class TokenListMetricBuilder extends TokenMetricBuilder<ListMetric<String>> {
    TokenListMetricBuilder(ListMetric<String> metric) {
      super(metric);
    }

    @Override protected StringMetric build(ListMetric<String> metric, Simplifier simplifier, Tokenizer tokenizer) {
      return new CompositeTokenListMetric(metric, simplifier, tokenizer);
    }
  }

  public class TokenSetMetricBuilder extends TokenMetricBuilder<SetMetric<String>> {
    TokenSetMetricBuilder(SetMetric<String> metric) {
      super(metric);
    }

    @Override protected StringMetric build(SetMetric<String> metric, Simplifier simplifier, Tokenizer tokenizer) {
  ...
  public final class CompositeTokenListMetric implements StringMetric {
    ...
    CompositeTokenListMetric(ListMetric<String> metric, Simplifier simplifier, Tokenizer tokenizer) {
      super();
      this.metric = metric;
      this.simplifier = simplifier;
      this.tokenizer = tokenizer;
  ...
  public final class CompositeTokenSetMetric implements StringMetric {
    ...
    CompositeTokenSetMetric(SetMetric<String> metric, Simplifier simplifier, Tokenizer tokenizer) {
      super();
      this.metric = metric;
      this.simplifier = simplifier;
      this.tokenizer = tokenizer;
