...
final class Math {
  ...
  static float min(final float a, final float b, final float c, final float d) {
  ...
  static <T extends java.lang.Object> Multiset<T> union(Multiset<T> a, Multiset<T> b) {
    if (a.size() < b.size()) {
  ...
  static <T extends java.lang.Object> Multiset<T> intersection(Multiset<T> a, Multiset<T> b) {
    if (a.size() < b.size()) {
  ...
  static <T extends java.lang.Object> Set<T> intersection(Set<T> a, Set<T> b) {
    if (a.size() < b.size()) {
