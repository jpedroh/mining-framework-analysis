...
public final class HammingDistance {
  ...
  private static final class HammingListDistance<T extends java.lang.Object> implements ListDistance<T> {
    HammingListDistance() {
    }
    ...
    /**
		 ...
		 */
    @Override public float distance(List<T> a, List<T> b) {
  ...
  private static final class HammingStringDistance implements StringDistance {
    ...
    /**
		 ...
		 */
    @Override public float distance(String a, String b) {
  ...
  /**
	 ...
	 */
  public static <T extends java.lang.Object> ListDistance<T> forList() {
