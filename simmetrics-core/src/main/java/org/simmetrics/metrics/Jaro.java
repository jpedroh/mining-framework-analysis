...
public class Jaro implements StringMetric {
  @Override public float compare(final String a, final String b) {
  ...
  private static char[] getCommonCharacters(final char[] charsA, final char[] charsB, final int separation) {
  ...
  private static int indexOf(char character, char[] buffer, int fromIndex, int toIndex) {
