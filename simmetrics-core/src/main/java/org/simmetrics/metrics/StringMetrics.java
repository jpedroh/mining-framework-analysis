...
public final class StringMetrics {
  ...
  public static StringMetric identity() {
    return new StringMetric() {
      ...
      @Override public float compare(String a, String b) {
  ...
  public static StringMetric simonWhite() {
    return with(new SimonWhite<String>()).tokenize(whitespace()).tokenize(qGram(2)).build();
  }
  ...
  /**
	 ...
	 */
  @Deprecated public static StringMetric create(Metric<String> metric) {
  ...
  /**
	 ...
	 */
  @Deprecated public static StringMetric create(Metric<String> metric, Simplifier simplifier) {
  ...
  /**
	 ...
	 * @see StringMetricBuilder
	 */
  @Deprecated public static StringMetric createForListMetric(Metric<List<String>> metric, Simplifier simplifier, Tokenizer tokenizer) {
  ...
  /**
	 ...
	 * @see StringMetricBuilder
	 */
  @Deprecated public static StringMetric createForListMetric(Metric<List<String>> metric, Tokenizer tokenizer) {
  ...
  /**
	 ...
	 * @see StringMetricBuilder
	 */
  @Deprecated public static StringMetric createForSetMetric(Metric<Set<String>> metric, Simplifier simplifier, Tokenizer tokenizer) {
  ...
  /**
	 ...
	 * @see StringMetricBuilder
	 */
  @Deprecated public static StringMetric createForSetMetric(Metric<Set<String>> metric, Tokenizer tokenizer) {
  ...
  /**
	 ...
	 * @see StringMetricBuilder
	 */
  @Deprecated public static StringMetric createForMultisetMetric(Metric<Multiset<String>> metric, Simplifier simplifier, Tokenizer tokenizer) {
  ...
  /**
	 ...
	 * @see StringMetricBuilder
	 */
  @Deprecated public static StringMetric createForMultisetMetric(Metric<Multiset<String>> metric, Tokenizer tokenizer) {
