 ...
 */
@Deprecated public final class DaitchMokotoffSoundex implements Simplifier {
  ...
  public DaitchMokotoffSoundex(boolean folding) {
    this.simplifier = new org.apache.commons.codec.language.DaitchMokotoffSoundex(folding);
  }
