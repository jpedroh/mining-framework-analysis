...
public final class StringMetricBuilder {
  ...
  @SuppressWarnings(value = { "javadoc" }) public interface StringMetricInitialSimplifierStep extends BuildStep {
    /**
    ...
    /**
		 ...
		 * @return a metric
		 */
    @Override StringMetric build();
  }

  @SuppressWarnings(value = { "javadoc" }) public interface StringMetricSimplifierStep extends StringMetricInitialSimplifierStep {
    /**
		 * Adds a simplifier to the metric.
		 * 
		 * @param simplifier
		 ...
		 * @return this for fluent chaining
		 */
    @Override StringMetricSimplifierStep simplify(Simplifier simplifier);
  ...
  @SuppressWarnings(value = { "javadoc" }) public interface CollectionMetricInitialSimplifierStep<T extends Collection<String>> {
    /**
		 * Adds a simplifier to the metric.
		 * 
		 * @param simplifier
  ...
  @SuppressWarnings(value = { "javadoc" }) public interface CollectionMetricSimplifierStep<T extends Collection<String>> extends CollectionMetricInitialSimplifierStep<T> {
    /**
		 * Adds a simplifier to the metric.
		 * 
		 * @param simplifier
		 ...
		 * @return this for fluent chaining
		 */
    @Override CollectionMetricSimplifierStep<T> simplify(Simplifier simplifier);
    ...
    /**
		 ...
		 * @return this for fluent chaining
		 */
    @Override CollectionMetricTokenizerStep<T> tokenize(Tokenizer tokenizer);
  }

  @SuppressWarnings(value = { "javadoc" }) public interface CollectionMetricInitialTokenizerStep<T extends Collection<String>> {
    /**
		 * Adds a tokenization step to the metric.
		 * 
		 * @param tokenizer
  ...
  @SuppressWarnings(value = { "javadoc" }) public interface CollectionMetricTokenizerStep<T extends Collection<String>> extends BuildStep, CollectionMetricInitialTokenizerStep<T> {
    /**
		 * Adds a tokenization step to the metric.
		 * 
		 * @param tokenizer
  ...
  private static final class CompositeStringMetricBuilder implements StringMetricSimplifierStep {
    ...
    @Override public BuildStep cacheStrings(Cache<String, String> cache) {
      checkNotNull(cache);
    ...
    @Override public StringMetricSimplifierStep simplify(Simplifier simplifier) {
  ...
  private static abstract class CompositeCollectionMetricBuilder<T extends Collection<String>> implements CollectionMetricSimplifierStep<T>, CollectionMetricTokenizerStep<T> {
    ...
    @Override public final StringMetric build() {
    ...
    @Override public final BuildStep cacheTokens(Cache<String, T> cache) {
      checkNotNull(cache);
    ...
    @Override public final CollectionMetricInitialTokenizerStep<T> cacheStrings(Cache<String, String> cache) {
      checkNotNull(cache);
      CachingSimplifier cachingSimplifier = new CachingSimplifier(cache, chainSimplifiers());
      this.simplifiers.add(cachingSimplifier);
      return this;
    ...
    @Override public final CollectionMetricSimplifierStep<T> simplify(Simplifier simplifier) {
      checkNotNull(simplifier);
      simplifiers.add(simplifier);
      return this;
    }

    @Override public final CollectionMetricTokenizerStep<T> tokenize(Tokenizer tokenizer) {
      checkNotNull(tokenizer);
      tokenizers.add(tokenizer);
      return this;
    }

    @Override public final CollectionMetricTokenizerStep<T> filter(Predicate<String> predicate) {
    ...
    @Override public final CollectionMetricTokenizerStep<T> transform(Function<String, String> function) {
  ...
  private static final class CompositeListMetricBuilder extends CompositeCollectionMetricBuilder<List<String>> {
    ...
    @Override StringMetric build(Metric<List<String>> metric, Tokenizer tokenizer) {
      return createForListMetric(metric, tokenizer);
    }

    @Override protected Tokenizer createCachingTokenizer(Cache<String, List<String>> cache, Tokenizer tokenizer) {
  ...
  private static final class CompositeSetMetricBuilder extends CompositeCollectionMetricBuilder<Set<String>> {
    ...
    @Override StringMetric build(Metric<Set<String>> metric, Tokenizer tokenizer) {
      return createForSetMetric(metric, tokenizer);
    }

    @Override protected Tokenizer createCachingTokenizer(Cache<String, Set<String>> cache, Tokenizer tokenizer) {
  ...
  private static final class CompositeMultisetMetricBuilder extends CompositeCollectionMetricBuilder<Multiset<String>> {
    ...
    @Override StringMetric build(Metric<Multiset<String>> metric, Simplifier simplifier, Tokenizer tokenizer) {
      return createForMultisetMetric(metric, simplifier, tokenizer);
    }

    @Override StringMetric build(Metric<Multiset<String>> metric, Tokenizer tokenizer) {
      return createForMultisetMetric(metric, tokenizer);
    }

    @Override protected Tokenizer createCachingTokenizer(Cache<String, Multiset<String>> cache, Tokenizer tokenizer) {
  ...
  static final class CachingSimplifier implements Simplifier {
    ...
    @Override public String simplify(final String input) {
      try {
  ...
  static final class CachingMultisetTokenizer implements Tokenizer {
    ...
    @Override public List<String> tokenizeToList(final String input) {
    ...
    @Override public Multiset<String> tokenizeToMultiset(final String input) {
      try {
        return cache.get(input, new Callable<Multiset<String>>() {
          @Override public Multiset<String> call() {
