...
public class BinaryAsEscapedTextIT {
  ...
  @Specification(value = { "echo.non.escaped.characters/request", "echo.non.escaped.characters/response" }) public void shouldEchoNonEscapedCharacters() throws Exception {
    k3po.finish();
  }
  ...
  @Test @Ignore(value = "To be completed when wse spec is complete") @Specification(value = { "echo.payload.length.127/request", "echo.payload.length.127/response" }) public void shouldEchoFrameWithPayloadLength127() throws Exception {
    k3po.finish();
  }
}