...
public final class Functions {
  ...
  @Function public static byte[] uniqueId() {
  ...
  @Function public static byte[] randomBytesIncludingNumberOfEscapedBytes(int length, int numberOfEscapedBytesToInclude) {
    byte[] bytes = new byte[length];
  ...
  @Function public static byte[] escapeBytes(byte[] bytes) {
  ...
  @Function public static byte[] padding(int size) {
    if ((size & 1) != 0) {
      size += 1;
    }
  ...
  @Function public static int randomInt(int upperBound) {
    return RANDOM.nextInt(upperBound);
  }

  @Function public static String asString(int value) {
