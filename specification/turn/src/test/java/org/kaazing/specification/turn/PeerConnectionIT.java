...
public class PeerConnectionIT {
  ...
  /**
     * See <a href="https://tools.ietf.org/html/rfc5766">RFC 5766: Turn Protocol</a>.
     */
  @Test @Specification(value = { "incorrect.channel.data.message.short.lenght/request", "incorrect.channel.data.message.short.lenght/response" }) public void shouldFailSendingDataMessageTooShortLength() throws Exception {
    k3po.finish();
  }
