...
public final class Functions {
  ...
  @Function public static String base64Encode(String login) {
    byte[] bytes = login.getBytes();
    return new String(Base64.encode(bytes));
  }

  @Function public static String append(String... strings) {
  ...
  @Function public static byte[] handshakeKey() {
    byte[] bytes = new byte[16];
    RANDOM.nextBytes(bytes);
    return Base64.encode(bytes);
  }

  @Function public static byte[] handshakeHash(byte[] wsKeyBytes) throws NoSuchAlgorithmException {
  ...
  @Function public static byte[] randomBytes(int length) {
  ...
  @Function public static byte[] randomBytesUTF8(int length) {
    byte[] bytes = new byte[length];
    randomBytesUTF8(bytes, 0, length);
    return bytes;
  }

  @Function public static byte[] randomBytesInvalidUTF8(int length) {
    byte[] bytes = new byte[length];
    bytes[0] = (byte) 0x80;
  ...
  @Function public static byte[] randomBytesUnalignedUTF8(int length, int unalignAt) {
  ...
  @Function public static byte[] copyOfRange(byte[] original, int from, int to) {
  ...
  /**
     ...
     * @return
     */
  @Function public static String randomizeLetterCase(String text) {
  ...
  @Function public static String randomHeaderNot(String header) {
    String commonHeaderChars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ" + "1234567890!@#$%^&*()_+-=`~[]\\{}|;\':\",./<>?";
    StringBuilder result = new StringBuilder();
    do {
  ...
  @Function public static String randomMethodNot(String method) {
  ...
  public static class Mapper extends FunctionMapperSpi.Reflective {
    ...
    @Override public String getPrefixName() {
      return "ws";
    }
  }
