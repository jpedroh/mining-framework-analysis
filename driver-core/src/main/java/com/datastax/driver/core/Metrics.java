...
public class Metrics {
  ...
  private final Gauge<Integer> connectedTo = registry.
<<<<<<< /usr/src/app/output/datastax/java-driver/aede0e8d32b985ff839f607714f128c528a91e2f/driver-core/src/main/java/com/datastax/driver/core/Metrics.java/left.java
  register("connected-to", new Gauge<Integer>() {
    @Override public Integer getValue() {
...
=======
  newGauge(Metrics.class, "connected-to", new Gauge<Integer>() {
...
>>>>>>> /usr/src/app/output/datastax/java-driver/aede0e8d32b985ff839f607714f128c528a91e2f/driver-core/src/main/java/com/datastax/driver/core/Metrics.java/right.java
  ;

  private final Gauge<Integer> openConnections = registry.
<<<<<<< /usr/src/app/output/datastax/java-driver/aede0e8d32b985ff839f607714f128c528a91e2f/driver-core/src/main/java/com/datastax/driver/core/Metrics.java/left.java
  register("open-connections", new Gauge<Integer>() {
    @Override public Integer getValue() {
...
=======
  newGauge(Metrics.class, "open-connections", new Gauge<Integer>() {
    @Override public Integer value() {
      int value = manager.controlConnection.isOpen() ? 1 : 0;
      for (SessionManager session : manager.sessions) {
