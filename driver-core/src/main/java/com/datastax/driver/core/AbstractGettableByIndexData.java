...
abstract class AbstractGettableByIndexData implements GettableByIndexData {
  ...
  /**
     * {@inheritDoc}
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public <T extends java.lang.Object> List<T> getList(int i, Class<T> elementsClass) {
  ...
  /**
     * {@inheritDoc}
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public <T extends java.lang.Object> Set<T> getSet(int i, Class<T> elementsClass) {
    DataType type = getType(i);
  ...
  /**
     * {@inheritDoc}
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public <K extends java.lang.Object, V extends java.lang.Object> Map<K, V> getMap(int i, Class<K> keysClass, Class<V> valuesClass) {
    DataType type = getType(i);
  ...
  /**
     * {@inheritDoc}
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public UDTValue getUDTValue(int i) {
    DataType type = getType(i);
  ...
  /**
     * {@inheritDoc}
     */
  @Override @SuppressWarnings(value = { "unchecked" }) public TupleValue getTupleValue(int i) {
    DataType type = getType(i);
