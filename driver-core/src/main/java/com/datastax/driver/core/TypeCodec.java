...
abstract class TypeCodec<T extends java.lang.Object> {
  ...
  private static class PrimitiveCollectionCodecs {
    ...
    @SuppressWarnings(value = { "unchecked", "rawtypes" }) public PrimitiveCollectionCodecs(ProtocolVersion protocolVersion) {
  ...
  @SuppressWarnings(value = { "unchecked" }) static <T extends java.lang.Object> TypeCodec<List<T>> listOf(DataType arg, ProtocolVersion protocolVersion) {
  ...
  @SuppressWarnings(value = { "unchecked" }) static <T extends java.lang.Object> TypeCodec<Set<T>> setOf(DataType arg, ProtocolVersion protocolVersion) {
    PrimitiveCollectionCodecs codecs = PrimitiveCollectionCodecs.forVersion(protocolVersion);
  ...
  @SuppressWarnings(value = { "unchecked" }) static <K extends java.lang.Object, V extends java.lang.Object> TypeCodec<Map<K, V>> mapOf(DataType keys, DataType values, ProtocolVersion protocolVersion) {
    PrimitiveCollectionCodecs codecs = PrimitiveCollectionCodecs.forVersion(protocolVersion);
