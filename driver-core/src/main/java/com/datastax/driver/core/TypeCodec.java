...
abstract class TypeCodec<T extends java.lang.Object> {
  ...
  private static class PrimitiveCollectionCodecs {
    ...
    @SuppressWarnings(value = { "unchecked", "rawtypes" }) public PrimitiveCollectionCodecs(int protocolVersion) {
  ...
  @SuppressWarnings(value = { "unchecked" }) static <T extends java.lang.Object> TypeCodec<T> createFor(DataType.Name name) {
    assert !name.isCollection();
    return (TypeCodec<T>) primitiveCodecs.get(name);
  }

  @SuppressWarnings(value = { "unchecked" }) static <T extends java.lang.Object> TypeCodec<List<T>> listOf(DataType arg, int protocolVersion) {
  ...
  @SuppressWarnings(value = { "unchecked" }) static <T extends java.lang.Object> TypeCodec<Set<T>> setOf(DataType arg, int protocolVersion) {
    PrimitiveCollectionCodecs codecs = protocolVersion <= 2 ? primitiveCollectionCodecsV2 : primitiveCollectionCodecsV3;
  ...
  @SuppressWarnings(value = { "unchecked" }) static <K extends java.lang.Object, V extends java.lang.Object> TypeCodec<Map<K, V>> mapOf(DataType keys, DataType values, int protocolVersion) {
    PrimitiveCollectionCodecs codecs = protocolVersion <= 2 ? primitiveCollectionCodecsV2 : primitiveCollectionCodecsV3;
  ...
  static DataType getDataTypeFor(Object value) {
    ...
    if (value instanceof Map) {
      ...
      return keyType == null || valueType == null ? null : DataType.map(keyType, valueType);
    }
  ...
  private static int sizeOfValue(ByteBuffer value, int version) {
    return version >= 3 ? (value == null ? 4 : 4 + value.remaining()) : 2 + value.remaining();
  }
  ...
  static class StringCodec extends TypeCodec<String> {
    ...
    @Override public String deserialize(ByteBuffer bytes) {
  ...
  static class LongCodec extends TypeCodec<Long> {
    ...
    @Override public String format(Long value) {
    ...
    @Override public Long deserialize(ByteBuffer bytes) {
  ...
  static class BytesCodec extends TypeCodec<ByteBuffer> {
    ...
    @Override public ByteBuffer parse(String value) {
      return Bytes.fromHexString(value);
    }

    @Override public String format(ByteBuffer value) {
      return Bytes.toHexString(value);
    }

    @Override public ByteBuffer serialize(ByteBuffer value) {
      return value.duplicate();
    }

    @Override public ByteBuffer deserialize(ByteBuffer bytes) {
  ...
  static class BooleanCodec extends TypeCodec<Boolean> {
    ...
    @Override public String format(Boolean value) {
      return value ? "true" : "false";
    }

    @Override public ByteBuffer serialize(Boolean value) {
      return serializeNoBoxing(value);
    }
    ...
    @Override public Boolean deserialize(ByteBuffer bytes) {
      return deserializeNoBoxing(bytes);
    }
  ...
  static class DecimalCodec extends TypeCodec<BigDecimal> {
    ...
    @Override public BigDecimal parse(String value) {
      try {
    ...
    @Override public ByteBuffer serialize(BigDecimal value) {
    ...
    @Override public BigDecimal deserialize(ByteBuffer bytes) {
  ...
  static class DoubleCodec extends TypeCodec<Double> {
    ...
    @Override public ByteBuffer serialize(Double value) {
      return serializeNoBoxing(value);
    }
    ...
    @Override public Double deserialize(ByteBuffer bytes) {
      return deserializeNoBoxing(bytes);
    }
  ...
  static class FloatCodec extends TypeCodec<Float> {
    ...
    @Override public String format(Float value) {
      return Float.toString(value);
    }

    @Override public ByteBuffer serialize(Float value) {
      return serializeNoBoxing(value);
    }
    ...
    @Override public Float deserialize(ByteBuffer bytes) {
      return deserializeNoBoxing(bytes);
    }
  ...
  static class InetCodec extends TypeCodec<InetAddress> {
    ...
    @Override public InetAddress parse(String value) {
      try {
    ...
    @Override public String format(InetAddress value) {
      return value.getHostAddress();
    }

    @Override public ByteBuffer serialize(InetAddress value) {
      return ByteBuffer.wrap(value.getAddress());
    }

    @Override public InetAddress deserialize(ByteBuffer bytes) {
      try {
  ...
  static class IntCodec extends TypeCodec<Integer> {
    ...
    @Override public String format(Integer value) {
      return Integer.toString(value);
    }

    @Override public ByteBuffer serialize(Integer value) {
      return serializeNoBoxing(value);
    }
    ...
    @Override public Integer deserialize(ByteBuffer bytes) {
      return deserializeNoBoxing(bytes);
    }
  ...
  static class DateCodec extends TypeCodec<Date> {
    ...
    @Override public String format(Date value) {
      return Long.toString(value.getTime());
    }

    @Override public ByteBuffer serialize(Date value) {
      return LongCodec.instance.serializeNoBoxing(value.getTime());
    }

    @Override public Date deserialize(ByteBuffer bytes) {
  ...
  static class UUIDCodec extends TypeCodec<UUID> {
    ...
    @Override public UUID parse(String value) {
      try {
    ...
    @Override public String format(UUID value) {
      return value.toString();
    }

    @Override public ByteBuffer serialize(UUID value) {
    ...
    @Override public UUID deserialize(ByteBuffer bytes) {
  ...
  static class BigIntegerCodec extends TypeCodec<BigInteger> {
    ...
    @Override public BigInteger parse(String value) {
      try {
    ...
    @Override public String format(BigInteger value) {
      return value.toString();
    }

    @Override public ByteBuffer serialize(BigInteger value) {
      return ByteBuffer.wrap(value.toByteArray());
    }

    @Override public BigInteger deserialize(ByteBuffer bytes) {
      return new BigInteger(Bytes.getArray(bytes));
    }
  }

  static class ListCodec<T extends java.lang.Object> extends TypeCodec<List<T>> {
    ...
    @Override public List<T> parse(String value) {
    ...
    @Override public String format(List<T> value) {
    ...
    @Override public ByteBuffer serialize(List<T> value) {
    ...
    @Override public List<T> deserialize(ByteBuffer bytes) {
      try {
  ...
  static class SetCodec<T extends java.lang.Object> extends TypeCodec<Set<T>> {
    private final TypeCodec<T> eltCodec;
    ...
    @Override public Set<T> parse(String value) {
      int idx = ParseUtils.skipSpaces(value, 0);
      if (value.charAt(idx++) != '{') {
    ...
    @Override public String format(Set<T> value) {
      StringBuilder sb = new StringBuilder();
      sb.append("{");
      int i = 0;
      for (T v : value) {
    ...
    @Override public ByteBuffer serialize(Set<T> value) {
      List<ByteBuffer> bbs = new ArrayList<ByteBuffer>(value.size());
      for (T elt : value) {
        bbs.add(eltCodec.serialize(elt));
      }
    ...
    @Override public Set<T> deserialize(ByteBuffer bytes) {
      try {
        ByteBuffer input = bytes.duplicate();
        int n = readCollectionSize(input, protocolVersion);
  ...
  static class MapCodec<K extends java.lang.Object, V extends java.lang.Object> extends TypeCodec<Map<K, V>> {
    ...
    @Override public Map<K, V> parse(String value) {
      int idx = ParseUtils.skipSpaces(value, 0);
      if (value.charAt(idx++) != '{') {
    ...
    @Override public String format(Map<K, V> value) {
      StringBuilder sb = new StringBuilder();
      sb.append("{");
      int i = 0;
    ...
    @Override public ByteBuffer serialize(Map<K, V> value) {
    ...
    @Override public Map<K, V> deserialize(ByteBuffer bytes) {
      try {
        ByteBuffer input = bytes.duplicate();
        int n = readCollectionSize(input, protocolVersion);
  ...
  static class UDTCodec extends TypeCodec<UDTValue> {
    ...
    @Override public String format(UDTValue value) {
      return value.toString();
    }
  ...
  static class TupleCodec extends TypeCodec<TupleValue> {
    ...
    @Override public String format(TupleValue value) {
      return value.toString();
    }
