...
class RequestHandler implements Connection.ResponseCallback {
  ...
  @Override public void onSet(Connection connection, Message.Response response) {
    ...
    try {
      switch (response.type) {
        ...
        RetryPolicy retryPolicy = query.getRetryPolicy() == null ? manager.configuration().getPolicies().getRetryPolicy() : query.getRetryPolicy();
