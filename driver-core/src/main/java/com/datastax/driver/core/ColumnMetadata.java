...
public class ColumnMetadata {
    ...
    public static class IndexMetadata {
        ...
        public String asCQLQuery() {
            ...
            return isCustomIndex() ? String.format("CREATE CUSTOM INDEX %s ON %s.%s (%s) USING '%s'", name, ksName, table.getName(), column.getName(), customClassName) : String.format("CREATE INDEX %s ON %s.%s (%s);", name, ksName, table.getName(), column.getName());
        }
