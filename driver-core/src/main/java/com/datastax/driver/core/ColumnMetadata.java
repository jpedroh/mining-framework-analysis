...
public class ColumnMetadata {
  ...
  public static class IndexMetadata {
    ...
    public String asCQLQuery() {
      ...
      return 
<<<<<<< /usr/src/app/output/datastax/java-driver/127c2a211dd58cc81b61efa85310396aedf7bcae/driver-core/src/main/java/com/datastax/driver/core/ColumnMetadata.java/left.java
      isCustomIndex() ? String.format("CREATE CUSTOM INDEX %s ON %s.%s (%s) USING \'%s\'", name, ksName, table.getName(), column.getName(), customClassName) : String.format("CREATE INDEX %s ON %s.%s (%s)", name, ksName, table.getName(), column.getName())
=======
      String.format("CREATE INDEX %s ON %s.%s (%s);", name, table.getKeyspace().getName(), table.getName(), column.getName())
>>>>>>> /usr/src/app/output/datastax/java-driver/127c2a211dd58cc81b61efa85310396aedf7bcae/driver-core/src/main/java/com/datastax/driver/core/ColumnMetadata.java/right.java
      ;
    }
