...
<<<<<<< /usr/src/app/output/datastax/java-driver/0dd96ea21f85de3a8323926450891971cb36d2e1/driver-core/src/main/java/com/datastax/driver/core/TableMetadata.java/left.java
      is210OrMore || row.isNull(REPLICATE_ON_WRITE)
=======
      (version.getMajor() > 2 || (version.getMajor() == 2 && version.getMinor() >= 1)) || isNullOrAbsent(row, REPLICATE_ON_WRITE)
>>>>>>> /usr/src/app/output/datastax/java-driver/0dd96ea21f85de3a8323926450891971cb36d2e1/driver-core/src/main/java/com/datastax/driver/core/TableMetadata.java/right.java
       ? DEFAULT_REPLICATE_ON_WRITE : row.getBool(REPLICATE_ON_WRITE);
...
>>>>>>> /usr/src/app/output/datastax/java-driver/0dd96ea21f85de3a8323926450891971cb36d2e1/driver-core/src/main/java/com/datastax/driver/core/TableMetadata.java/right.java
      ...
      if (is210OrMore) {
        this.minIndexInterval = row.isNull(MIN_INDEX_INTERVAL) ? DEFAULT_MIN_INDEX_INTERVAL : row.getInt(MIN_INDEX_INTERVAL);
        this.maxIndexInterval = row.isNull(MAX_INDEX_INTERVAL) ? DEFAULT_MAX_INDEX_INTERVAL : row.getInt(MAX_INDEX_INTERVAL);
      } else {
