...
public class TableMetadata {
  ...
  private final 
<<<<<<< /usr/src/app/output/datastax/java-driver/3eb34e67852dd8ff746560b6d1cc0f9004f7a65d/driver-core/src/main/java/com/datastax/driver/core/TableMetadata.java/left.java
  Comparator
=======
  List
>>>>>>> /usr/src/app/output/datastax/java-driver/3eb34e67852dd8ff746560b6d1cc0f9004f7a65d/driver-core/src/main/java/com/datastax/driver/core/TableMetadata.java/right.java
  <ColumnMetadata, Order> 
<<<<<<< /usr/src/app/output/datastax/java-driver/3eb34e67852dd8ff746560b6d1cc0f9004f7a65d/driver-core/src/main/java/com/datastax/driver/core/TableMetadata.java/left.java
  columnMetadataComparator = new Comparator<ColumnMetadata>() {
...
>>>>>>> /usr/src/app/output/datastax/java-driver/3eb34e67852dd8ff746560b6d1cc0f9004f7a65d/driver-core/src/main/java/com/datastax/driver/core/TableMetadata.java/right.java
  ...
  private TableMetadata(KeyspaceMetadata keyspace, String name, List<ColumnMetadata> partitionKey, List<ColumnMetadata> clusteringKey, LinkedHashMap<String, ColumnMetadata> columns, Options options, List<Order> clusteringOrder) {
...
=======
    try {
      ...
      List<AbstractType<?>> columnTypes = isComposite ? ((CompositeType) ct).types : Collections.<AbstractType<?>>singletonList(ct);
      ...
      List<AbstractType<?>> keyTypes = kt instanceof CompositeType ? ((CompositeType) kt).types : Collections.<AbstractType<?>>singletonList(kt);
      ...
      for (int i = 0; i < keyTypes.size(); i++) {
        String cn = keyAliases.size() > i ? keyAliases.get(i) : (i == 0 ? DEFAULT_KEY_ALIAS : DEFAULT_KEY_ALIAS + (i + 1));
...
>>>>>>> /usr/src/app/output/datastax/java-driver/3eb34e67852dd8ff746560b6d1cc0f9004f7a65d/driver-core/src/main/java/com/datastax/driver/core/TableMetadata.java/right.java
  ...
  private static <T extends java.lang.Object> List<T> nullInitializedList(int size) {
  ...
  @SuppressWarnings(value = { "unchecked" }) static Map<String, String> fromJsonMap(String json) {
    try {
