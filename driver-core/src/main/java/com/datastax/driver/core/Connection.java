...
<<<<<<< /usr/src/app/output/datastax/java-driver/f7a4ac1d5b3052a1feb55ba56843c4c0916a56b7/driver-core/src/main/java/com/datastax/driver/core/Connection.java/left.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  <E extends Exception> E defunct(E e) {
    ...
    if (host != null) {
      boolean belongsToReconnectingPool = host.state != Host.State.UP && this instanceof PooledConnection && (((PooledConnection) this).pool == null || !((PooledConnection) this).pool.isClosed());
  ...
  private class Dispatcher extends IdleStateAwareChannelUpstreamHandler {
    ...
    @Override public void channelIdle(ChannelHandlerContext ctx, IdleStateEvent e) throws Exception {
