...
class Connection extends com.datastax.cassandra.transport.Connection {
  ...
  static class Future extends SimpleFuture<com.datastax.cassandra.transport.Message.Response> implements RequestHandler.Callback {
    ...
    @Override public void onSet(Connection connection, com.datastax.cassandra.transport.Message.Response response, ExecutionInfo info) {
      onSet(connection, response);
    }

    @Override public void onSet(Connection connection, com.datastax.cassandra.transport.Message.Response response) {
      this.address = connection.address;
      super.set(response);
    }

    @Override public void onException(Connection connection, Exception exception) {
      this.address = connection.address;
      super.setException(exception);
    }

    @Override public void onTimeout(Connection connection) {
      this.address = connection.address;
