...
abstract class ArrayBackedResultSet implements ResultSet {
  ...
  private static class SinglePage extends ArrayBackedResultSet {
    ...
    private SinglePage(ColumnDefinitions metadata, int protocolVersion, Queue<List<ByteBuffer>> rows, ExecutionInfo info) {
  ...
  private static class MultiPage extends ArrayBackedResultSet {
    ...
    private MultiPage(ColumnDefinitions metadata, int protocolVersion, Queue<List<ByteBuffer>> rows, ExecutionInfo info, ByteBuffer pagingState, SessionManager session, Statement statement) {
      super(metadata, protocolVersion);
