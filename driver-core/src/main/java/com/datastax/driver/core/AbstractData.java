...
abstract class AbstractData<T extends SettableData<T>> extends AbstractGettableData implements SettableData<T> {
  ...
  @SuppressWarnings(value = { "unchecked" }) protected AbstractData(ProtocolVersion protocolVersion, int size) {
  ...
  public T setUUID(int i, UUID v) {
    ...
    return type == DataType.Name.UUID ? setValue(i, TypeCodec.UUIDCodec.instance.serialize(v)) : setValue(i, TypeCodec.TimeUUIDCodec.instance.serialize(v));
  }
  ...
  public <E extends java.lang.Object> T setList(int i, List<E> v) {
  ...
  public <E extends java.lang.Object> T setList(String name, List<E> v) {
    int[] indexes = getAllIndexesOf(name);
    for (int i = 0; i < indexes.length; i++) {
      setList(indexes[i], v);
    }
  ...
  public <K extends java.lang.Object, V extends java.lang.Object> T setMap(int i, Map<K, V> v) {
    DataType type = getType(i);
  ...
  public <K extends java.lang.Object, V extends java.lang.Object> T setMap(String name, Map<K, V> v) {
    int[] indexes = getAllIndexesOf(name);
    for (int i = 0; i < indexes.length; i++) {
      setMap(indexes[i], v);
    }
  ...
  public <E extends java.lang.Object> T setSet(int i, Set<E> v) {
    DataType type = getType(i);
  ...
  public <E extends java.lang.Object> T setSet(String name, Set<E> v) {
    int[] indexes = getAllIndexesOf(name);
    for (int i = 0; i < indexes.length; i++) {
      setSet(indexes[i], v);
    }
