...
<<<<<<< /usr/src/app/output/datastax/java-driver/5a6a084a6ed84a2742a7c2211c1071193df4c2e7/driver-core/src/main/java/com/datastax/driver/core/PoolingOptions.java/left.java
  DEFAULT_MAX_REQUESTS_PER_HOST_LOCAL = 1024
=======
  DEFAULT_IDLE_TIMEOUT_SECONDS = 120
>>>>>>> /usr/src/app/output/datastax/java-driver/5a6a084a6ed84a2742a7c2211c1071193df4c2e7/driver-core/src/main/java/com/datastax/driver/core/PoolingOptions.java/right.java
  ;

  private static final int 
<<<<<<< /usr/src/app/output/datastax/java-driver/5a6a084a6ed84a2742a7c2211c1071193df4c2e7/driver-core/src/main/java/com/datastax/driver/core/PoolingOptions.java/left.java
  DEFAULT_MAX_REQUESTS_PER_HOST_REMOTE = 256
=======
  DEFAULT_POOL_TIMEOUT_MILLIS = 5000
>>>>>>> /usr/src/app/output/datastax/java-driver/5a6a084a6ed84a2742a7c2211c1071193df4c2e7/driver-core/src/main/java/com/datastax/driver/core/PoolingOptions.java/right.java
  ;
...
<<<<<<< /usr/src/app/output/datastax/java-driver/5a6a084a6ed84a2742a7c2211c1071193df4c2e7/driver-core/src/main/java/com/datastax/driver/core/PoolingOptions.java/left.java
  maxSimultaneousRequestsPerHostLocal = DEFAULT_MAX_REQUESTS_PER_HOST_LOCAL
=======
...
>>>>>>> /usr/src/app/output/datastax/java-driver/5a6a084a6ed84a2742a7c2211c1071193df4c2e7/driver-core/src/main/java/com/datastax/driver/core/PoolingOptions.java/right.java
  ...
  private volatile int 
<<<<<<< /usr/src/app/output/datastax/java-driver/5a6a084a6ed84a2742a7c2211c1071193df4c2e7/driver-core/src/main/java/com/datastax/driver/core/PoolingOptions.java/left.java
  maxSimultaneousRequestsPerHostRemote = DEFAULT_MAX_REQUESTS_PER_HOST_REMOTE
=======
  poolTimeoutMillis = DEFAULT_POOL_TIMEOUT_MILLIS
>>>>>>> /usr/src/app/output/datastax/java-driver/5a6a084a6ed84a2742a7c2211c1071193df4c2e7/driver-core/src/main/java/com/datastax/driver/core/PoolingOptions.java/right.java
  ;
  ...
  public PoolingOptions setMaxSimultaneousRequestsPerHostThreshold(HostDistance distance, int newMaxRequests) {
    if (newMaxRequests <= 0 || newMaxRequests > StreamIdGenerator.MAX_STREAM_PER_CONNECTION_V3) {
      throw new IllegalArgumentException(String.format("Max requests must be in the range (1, %d)", StreamIdGenerator.MAX_STREAM_PER_CONNECTION_V3));
    }
    switch (distance) {
      case LOCAL:
  ...
  private static void checkRequestsPerConnectionRange(int value, String description, HostDistance distance) {
    if (value < 0 || value > StreamIdGenerator.MAX_STREAM_PER_CONNECTION_V2) {
      throw new IllegalArgumentException(String.format("%s for %s hosts must be in the range (0, %d)", description, distance, StreamIdGenerator.MAX_STREAM_PER_CONNECTION_V2));
    }
  }

  private static void checkRequestsPerConnectionOrder(int min, int max, HostDistance distance) {
    if (min > max) {
      throw new IllegalArgumentException(String.format("Min simultaneous requests per connection for %s hosts must be less than max (%d > %d)", distance, min, max));
    }
  }

  private static void checkConnectionsPerHostOrder(int core, int max, HostDistance distance) {
    if (core > max) {
      throw new IllegalArgumentException(String.format("Core connections for %s hosts must be less than max (%d > %d)", distance, core, max));
    }
  }
}