...
public abstract class BuiltStatement extends RegularStatement {
  ...
  @Override public ByteBuffer[] getValues(ProtocolVersion protocolVersion) {
    maybeRebuildCache();
  ...
  abstract static class ForwardingStatement<T extends BuiltStatement> extends BuiltStatement {
    ...
    @Override StringBuilder buildQueryString(List<Object> values) {
    ...
    @Override public RegularStatement setForceNoValues(boolean forceNoValues) {
      statement.setForceNoValues(forceNoValues);
      return this;
    }

    @Override List<Object> getRawValues() {
