...
public class Cluster implements Closeable {
  ...
  class Manager implements Host.StateListener, Connection.DefaultResponseHandler {
    ...
    public PreparedStatement addPrepared(PreparedStatement stmt) {
      ...
      if (
<<<<<<< /usr/src/app/output/datastax/java-driver/cd5f6315bc048309311d1d1f77b696d9f48cf511/driver-core/src/main/java/com/datastax/driver/core/Cluster.java/left.java
      preparedQueries.putIfAbsent(stmt.getPreparedId().id, stmt)
=======
      previous
>>>>>>> /usr/src/app/output/datastax/java-driver/cd5f6315bc048309311d1d1f77b696d9f48cf511/driver-core/src/main/java/com/datastax/driver/core/Cluster.java/right.java
       != null) {
