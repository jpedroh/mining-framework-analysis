...
public class Cluster {
  ...
  class Manager implements Host.StateListener, Connection.DefaultResponseHandler {
    ...
    final 
<<<<<<< /usr/src/app/output/datastax/java-driver/5e108acf46ad0d498d814c533b3820c687d92dea/driver-core/src/main/java/com/datastax/driver/core/Cluster.java/left.java
    AtomicReference
=======
    Set
>>>>>>> /usr/src/app/output/datastax/java-driver/5e108acf46ad0d498d814c533b3820c687d92dea/driver-core/src/main/java/com/datastax/driver/core/Cluster.java/right.java
    <ShutdownFuture, LatencyTracker> 
<<<<<<< /usr/src/app/output/datastax/java-driver/5e108acf46ad0d498d814c533b3820c687d92dea/driver-core/src/main/java/com/datastax/driver/core/Cluster.java/left.java
    shutdownFuture = new AtomicReference<ShutdownFuture>()
=======
    trackers = new CopyOnWriteArraySet<LatencyTracker>()
>>>>>>> /usr/src/app/output/datastax/java-driver/5e108acf46ad0d498d814c533b3820c687d92dea/driver-core/src/main/java/com/datastax/driver/core/Cluster.java/right.java
    ;
    ...
    @Override public void onUp(final Host host) {
    ...
    @Override public void onAdd(final Host host) {
    ...
    private class ClusterShutdownFuture extends ShutdownFuture.Forwarding {
      ...
      @Override public ShutdownFuture force() {
