...
public class Configuration {
  ...
  public Configuration() {
    this(new Policies(), new ProtocolOptions(), new PoolingOptions(), new SocketOptions(), AuthProvider.NONE, new MetricsOptions());
  }
  ...
  /**
     ...
     */
  public Configuration(Policies policies, ProtocolOptions protocolOptions, PoolingOptions poolingOptions, SocketOptions socketOptions, AuthProvider authProvider, MetricsOptions metricsOptions) {
