...
public class QueryBuilderExecutionTest extends CCMBridge.PerClassSingleNodeCluster {
  ...
  @Override protected Collection<String> getTableDefinitions() {
    return Arrays.asList(String.format(TestUtils.CREATE_TABLE_SIMPLE_FORMAT, TABLE1), "CREATE TABLE dateTest (t timestamp PRIMARY KEY)", "CREATE TYPE udt (i int)");
  }
  ...
  @Test(groups = "short") public void dateHandlingTest() throws Exception {
    Date d = new Date();
  ...
  @Test(groups = "unit") public void prepareTest() throws Exception {
  ...
  @Test(groups = "short") public void batchNonBuiltStatementTest() throws Exception {
  ...
  @Test(groups = "short") public void insertUdtTest() throws Exception {
