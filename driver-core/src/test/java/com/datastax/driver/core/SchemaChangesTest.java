...
public class SchemaChangesTest {
  ...
  @DataProvider(name = "existingKeyspaceName") public static Object[][] existingKeyspaceName() {
  ...
  @Test(groups = "short", dataProvider = "existingKeyspaceName") public void should_notify_of_table_creation(String keyspace) {
  ...
  @Test(groups = "short", dataProvider = "existingKeyspaceName") public void should_notify_of_table_update(String keyspace) {
    session.execute(String.format("CREATE TABLE %s.table1(i int primary key)", keyspace));
  ...
  @Test(groups = "short", dataProvider = "existingKeyspaceName") public void should_notify_of_table_drop(String keyspace) {
    session.execute(String.format("CREATE TABLE %s.table1(i int primary key)", keyspace));
  ...
  @Test(groups = "short", dataProvider = "existingKeyspaceName") @CassandraVersion(major = 2.1) public void should_notify_of_udt_creation(String keyspace) {
  ...
  @Test(groups = "short", dataProvider = "existingKeyspaceName") @CassandraVersion(major = 2.1) public void should_notify_of_udt_update(String keyspace) {
    session.execute(String.format("CREATE TYPE %s.type1(i int)", keyspace));
  ...
  @Test(groups = "short", dataProvider = "existingKeyspaceName") @CassandraVersion(major = 2.1) public void should_notify_of_udt_drop(String keyspace) {
    session.execute(String.format("CREATE TYPE %s.type1(i int)", keyspace));
  ...
  @DataProvider(name = "newKeyspaceName") public static Object[][] newKeyspaceName() {
    return new Object[][] { { "lowercase2" }, { "\"CaseSensitive2\"" } };
  }

  @Test(groups = "short", dataProvider = "newKeyspaceName") public void should_notify_of_keyspace_creation(String keyspace) {
  ...
  @Test(groups = "short", dataProvider = "newKeyspaceName") public void should_notify_of_keyspace_update(String keyspace) {
    session.execute(String.format(CREATE_KEYSPACE, keyspace));
    for (Metadata m : metadatas) {
  ...
  @Test(groups = "short", dataProvider = "newKeyspaceName") public void should_notify_of_keyspace_drop(String keyspace) {
    session.execute(String.format(CREATE_KEYSPACE, keyspace));
    for (Metadata m : metadatas) {
  ...
  @AfterMethod(groups = "short") public void cleanup() {
