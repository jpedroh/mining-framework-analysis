...
public class LargeDataTest {
  ...
  /**
     ...
     * @throws Throwable
     */
  @Test(groups = "integration") public void wideRows() throws Throwable {
  ...
  /**
     ...
     * @throws Throwable
     */
  @Test(groups = "integration") public void wideBatchRows() throws Throwable {
    Cluster.Builder builder = Cluster.builder();
    CCMBridge.CCMCluster c = CCMBridge.buildCluster(1, builder);
    c.session.execute(String.format(CREATE_KEYSPACE_SIMPLE_FORMAT, "large_data", 1));
    c.session.execute("USE large_data");
  ...
  /**
     ...
     * @throws Throwable
     */
  @Test(groups = "integration") public void wideByteRows() throws Throwable {
    Cluster.Builder builder = Cluster.builder();
    CCMBridge.CCMCluster c = CCMBridge.buildCluster(1, builder);
    c.session.execute(String.format(CREATE_KEYSPACE_SIMPLE_FORMAT, "large_data", 1));
    c.session.execute("USE large_data");
  ...
  /**
     ...
     * @throws Throwable
     */
  @Test(groups = "integration") public void largeText() throws Throwable {
    Cluster.Builder builder = Cluster.builder();
    CCMBridge.CCMCluster c = CCMBridge.buildCluster(1, builder);
    c.session.execute(String.format(CREATE_KEYSPACE_SIMPLE_FORMAT, "large_data", 1));
    c.session.execute("USE large_data");
  ...
  /**
     ...
     * @throws Throwable
     */
  @Test(groups = "integration") public void wideTable() throws Throwable {
    Cluster.Builder builder = Cluster.builder();
    CCMBridge.CCMCluster c = CCMBridge.buildCluster(1, builder);
    c.session.execute(String.format(CREATE_KEYSPACE_SIMPLE_FORMAT, "large_data", 1));
    c.session.execute("USE large_data");
  ...
  /**
     ...
     * @throws Throwable
     */
  @Test(groups = "duration") public void mixedDurationTest() throws Throwable {
    Cluster.Builder builder = Cluster.builder();
