...
public class LoadBalancingPolicyTest {
  ...
  @Test(groups = "integration") public void roundRobinTest() throws Throwable {
  ...
  @Test(groups = "integration") public void DCAwareRoundRobinTest() throws Throwable {
  ...
  @Test(groups = "integration") public void tokenAwareTest() throws Throwable {
    tokenAwareTest(false);
  }

  @Test(groups = "integration") public void tokenAwarePreparedTest() throws Throwable {
    tokenAwareTest(true);
  }
