...
public class DataTypeIntegrationTest extends CCMBridge.PerClassSingleNodeCluster {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "fallthrough" }) private static String helperStringifiedData(DataType dataType) {
  ...
  /**
     * Generates the insert statements that will be used in testing
     */
  @SuppressWarnings(value = { "unchecked" }) private static Collection<String> getCollectionInsertStatements() {
    ArrayList<String> insertStatements = new ArrayList<String>();
    String tableName;
    String key;
    String value;
  ...
  /**
     ...
     */
  @Test(groups = "long") public void primitiveTests() throws Throwable {
    primitiveInsertTest();
    primitiveSelectTest();
  }

  @Test(groups = "short") public void primitiveInsertWithValueTest() throws Throwable {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public void collectionSelectTest() throws Throwable {
  ...
  /**
     ...
     */
  @Test(groups = "long") public void collectionTest() throws Throwable {
  ...
  /**
     ...
     */
  @Test(groups = "doc") public void printTableDefinitions() {
  ...
  /**
     ...
     * (for exporting purposes)
     */
  @Test(groups = "doc") public void printSampleData() {
  ...
  /**
     ...
     * (for exporting purposes)
     */
  @Test(groups = "doc") @SuppressWarnings(value = { "unchecked" }) public void printSampleCollections() {
  ...
  /**
     ...
     * (for exporting purposes)
     */
  @Test(groups = "doc") public void printPrimitiveInsertStatements() {
  ...
  /**
     ...
     * (for exporting purposes)
     */
  @Test(groups = "doc") public void printPrimitiveSelectStatements() {
  ...
  /**
     ...
     * (for exporting purposes)
     */
  @Test(groups = "doc") public void printCollectionInsertStatements() {
  ...
  /**
     ...
     * (for exporting purposes)
     */
  @Test(groups = "doc") public void printCollectionSelectStatements() {
