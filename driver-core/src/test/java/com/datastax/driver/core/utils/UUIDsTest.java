...
public class UUIDsTest {
  @Test(groups = "unit") public void conformanceTest() {
    UUIDs.random();
  ...
  @Test(groups = "unit") public void uniquenessTest() {
  ...
  @Test(groups = "unit") public void multiThreadUniquenessTest() throws Exception {
    int nbThread = 10;
  ...
  @Test(groups = "unit") public void timestampIncreasingTest() {
    int nbGenerated = 1000000;
    long previous = 0;
    for (int i = 0; i < nbGenerated; ++i) {
