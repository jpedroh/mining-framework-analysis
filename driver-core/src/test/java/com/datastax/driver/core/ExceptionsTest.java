...
public class ExceptionsTest {
  /**
     ...
     */
  @Test(groups = "short") public void alreadyExistsException() throws Throwable {
  ...
  /**
     ...
     */
  @Test(groups = "unit") public void driverInternalError() throws Exception {
  ...
  /**
     ...
     */
  @Test(groups = "unit") public void invalidConfigurationInQueryException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     */
  @Test(groups = "unit") public void invalidQueryException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     * Tests basic message and copy abilities.
     */
  @Test(groups = "unit") public void invalidTypeException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     */
  @Test(groups = "short") public void noHostAvailableException() throws Exception {
    try {
  ...
  /**
     ...
     */
  @Test(groups = "long") public void readTimeoutException() throws Throwable {
    Cluster.Builder builder = Cluster.builder();
  ...
  /**
     ...
     * Tests basic message and copy abilities.
     */
  @Test(groups = "unit") public void syntaxError() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     * Tests basic message and copy abilities.
     */
  @Test(groups = "unit") public void traceRetrievalException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     * Tests basic message and copy abilities.
     */
  @Test(groups = "unit") public void truncateException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     * Tests basic message and copy abilities.
     */
  @Test(groups = "unit") public void unauthorizedException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     * Catch and test all available exception methods.
     */
  @Test(groups = "long") public void unavailableException() throws Throwable {
    Cluster.Builder builder = Cluster.builder();
    CCMBridge.CCMCluster c = CCMBridge.buildCluster(3, builder);
    try {
      String keyspace = "TestKeyspace";
  ...
  /**
     ...
     * Catch and test all available exception methods.
     */
  @Test(groups = "long") public void writeTimeoutException() throws Throwable {
    Cluster.Builder builder = Cluster.builder();
    CCMBridge.CCMCluster c = CCMBridge.buildCluster(3, builder);
    try {
      String keyspace = "TestKeyspace";
