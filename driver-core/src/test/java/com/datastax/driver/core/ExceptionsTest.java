...
public class ExceptionsTest {
  /**
     ...
     */
  @Test(groups = "integration") public void alreadyExistsException() throws Throwable {
  ...
  /**
     ...
     */
  @Test(groups = "integration") public void driverInternalError() throws Exception {
  ...
  /**
     ...
     */
  @Test(groups = "integration") public void invalidConfigurationInQueryException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     */
  @Test(groups = "integration") public void invalidQueryException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     * Tests basic message and copy abilities.
     */
  @Test(groups = "integration") public void invalidTypeException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     */
  @Test(groups = "integration") public void noHostAvailableException() throws Exception {
  ...
  /**
     ...
     */
  @Test(groups = "integration") public void readTimeoutException() throws Throwable {
    Cluster.Builder builder = Cluster.builder();
  ...
  /**
     ...
     * Tests basic message and copy abilities.
     */
  @Test(groups = "integration") public void syntaxError() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     * Tests basic message and copy abilities.
     */
  @Test(groups = "integration") public void traceRetrievalException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     * Tests basic message and copy abilities.
     */
  @Test(groups = "integration") public void truncateException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     * Tests basic message and copy abilities.
     */
  @Test(groups = "integration") public void unauthorizedException() throws Exception {
    String errorMessage = "Test Message";
    try {
  ...
  /**
     ...
     * Catch and test all available exception methods.
     */
  @Test(groups = "integration") public void unavailableException() throws Throwable {
    Cluster.Builder builder = Cluster.builder();
    CCMBridge.CCMCluster cluster = CCMBridge.buildCluster(3, builder);
    try {
      Session session = cluster.session;
  ...
  /**
     ...
     * Catch and test all available exception methods.
     */
  @Test(groups = "integration") public void writeTimeoutException() throws Throwable {
    Cluster.Builder builder = Cluster.builder();
    CCMBridge.CCMCluster cluster = CCMBridge.buildCluster(3, builder);
    try {
      Session session = cluster.session;
