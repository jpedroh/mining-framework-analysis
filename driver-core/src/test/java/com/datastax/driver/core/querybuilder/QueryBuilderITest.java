...
public class QueryBuilderITest extends CCMBridge.PerClassSingleNodeCluster {
  ...
  @Test(groups = "short") public void remainingDeleteTests() throws Exception {
    Statement query;
  ...
  @Test(groups = "short") public void selectInjectionTests() throws Exception {
    String query;
    Statement select;
  ...
  @Test(groups = "short") @SuppressWarnings(value = { "serial" }) public void insertInjectionTest() throws Exception {
    String query;
    Statement insert;
  ...
  @Test(groups = "short") public void updateInjectionTest() throws Exception {
    String query;
    Statement update;
  ...
  @Test(groups = "short") public void deleteInjectionTests() throws Exception {
    String query;
    Statement delete;
