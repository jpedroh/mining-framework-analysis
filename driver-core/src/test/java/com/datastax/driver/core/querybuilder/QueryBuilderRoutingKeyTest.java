...
public class QueryBuilderRoutingKeyTest extends CCMBridge.PerClassSingleNodeCluster {
  ...
  @Test(groups = "short") public void textRoutingKeyTest() throws Exception {
    Statement query;
  ...
  @Test(groups = "short") public void intRoutingKeyTest() throws Exception {
    Statement query;
  ...
  @Test(groups = "short") public void intRoutingBatchKeyTest() throws Exception {
