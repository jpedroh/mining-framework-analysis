...
public class PreparedStatementTest extends CCMBridge.PerClassSingleNodeCluster {
  ...
  @Test(groups = "short") public void preparedNativeTest() {
    for (DataType type : DataType.allPrimitiveTypes()) {
      if (exclude(type)) {
        continue;
      }
  ...
  /**
     ...
     */
  @Test(groups = "short") public void preparedNativeTest2() {
    for (DataType type : DataType.allPrimitiveTypes()) {
      if (exclude(type)) {
        continue;
      }
  ...
  @Test(groups = "short") @SuppressWarnings(value = { "unchecked" }) public void prepareListTest() {
  ...
  /**
     ...
     */
  @Test(groups = "short") @SuppressWarnings(value = { "unchecked" }) public void prepareListTest2() {
    for (DataType rawType : DataType.allPrimitiveTypes()) {
      if (exclude(rawType)) {
        continue;
      }
  ...
  @Test(groups = "short") @SuppressWarnings(value = { "unchecked" }) public void prepareSetTest() {
    for (DataType rawType : DataType.allPrimitiveTypes()) {
      if (exclude(rawType)) {
        continue;
      }
  ...
  /**
     ...
     */
  @Test(groups = "short") @SuppressWarnings(value = { "unchecked" }) public void prepareSetTest2() {
    for (DataType rawType : DataType.allPrimitiveTypes()) {
      if (exclude(rawType)) {
        continue;
      }
  ...
  @Test(groups = "short") @SuppressWarnings(value = { "unchecked" }) public void prepareMapTest() {
  ...
  /**
     ...
     */
  @Test(groups = "short") @SuppressWarnings(value = { "unchecked" }) public void prepareMapTest2() {
    for (DataType rawKeyType : DataType.allPrimitiveTypes()) {
      if (exclude(rawKeyType)) {
        continue;
      }
  ...
  @Test(groups = "long") public void reprepareOnNewlyUpNodeTest() throws Exception {
    reprepareOnNewlyUpNodeTest(null, session);
  }

  @Test(groups = "long") public void reprepareOnNewlyUpNodeNoKeyspaceTest() throws Exception {
    reprepareOnNewlyUpNodeTest(keyspace, cluster.connect());
  }

  @Test(groups = "short") public void prepareWithNullValuesTest() throws Exception {
  ...
  @Test(groups = "short") public void prepareStatementInheritPropertiesTest() {
  ...
  /**
     ...
     */
  @Test(groups = { "docs" }) public void printTableDefinitions() {
    for (String definition : getTableDefinitions()) {
      System.out.println(definition);
    }
  }

  @Test(groups = "short") public void batchTest() throws Exception {
    try {
  ...
  @Test(groups = "short", expectedExceptions = { IllegalStateException.class }) public void unboundVariableInBoundStatementTest() {
  ...
  @Test(groups = "short", expectedExceptions = { IllegalStateException.class }) @CassandraVersion(major = 2.0) public void unboundVariableInBatchStatementTest() {
    PreparedStatement ps = session.prepare("INSERT INTO " + SIMPLE_TABLE + " (k, i) VALUES (?, ?)");
  ...
  @Test(groups = "short") public void should_set_routing_key_on_case_sensitive_keyspace_and_table() {
