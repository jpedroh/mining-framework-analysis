...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test(groups = "unit") public void parseNativeTest() {
  ...
  @Test(groups = "unit") public void formatNativeTest() {
    for (DataType dt : DataType.allPrimitiveTypes()) {
      if (exclude(dt)) {
        continue;
      }
  ...
  @Test(groups = "unit") public void parseFormatListTest() {
  ...
  @SuppressWarnings(value = { "serial" }) @Test(groups = "unit") public void parseFormatSetTest() {
    String toParse = "{\'Foo\', \'Bar\', \'Foo\'\'bar\'}";
  ...
  @SuppressWarnings(value = { "serial" }) @Test(groups = "unit") public void parseFormatMapTest() {
  ...
  @SuppressWarnings(value = { "serial" }) @Test(groups = "unit") public void parseFormatUDTTest() {
    ...
    UserType udt2 = new UserType("ks", "t", Arrays.asList(new UserType.Field("t", DataType.text()), new UserType.Field("i", DataType.cint()), new UserType.Field("l", DataType.list(DataType.text())), new UserType.Field("s", DataType.map(DataType.cint(), udt1))));
  ...
  @Test(groups = "unit") public void parseFormatTupleTest() {
  ...
  @Test(groups = "unit") public void serializeDeserializeTest() {
...
>>>>>>> /usr/src/app/output/datastax/java-driver/4106cdc51127c8d742ef83d3ba8b0d14d648d0d3/driver-core/src/test/java/com/datastax/driver/core/DataTypeTest.java/right.java
  ...
  @Test(groups = "unit") public void serializeDeserializeCollectionsTest() {
    for (ProtocolVersion v : ProtocolVersion.values()) {
...
>>>>>>> /usr/src/app/output/datastax/java-driver/4106cdc51127c8d742ef83d3ba8b0d14d648d0d3/driver-core/src/test/java/com/datastax/driver/core/DataTypeTest.java/right.java
  ...
  @Test(groups = "unit") public void should_check_which_java_type_it_can_be_deserialized_to() {
    assertThat(DataType.cint()).canBeDeserializedAs(TypeToken.of(Integer.class)).canBeDeserializedAs(TypeToken.of(Number.class)).cannotBeDeserializedAs(TypeToken.of(String.class));
    assertThat(DataType.list(DataType.cint())).canBeDeserializedAs(new TypeToken<List<Integer>>() { }).canBeDeserializedAs(new TypeToken<Collection<Integer>>() { }).cannotBeDeserializedAs(new TypeToken<Set<Integer>>() { }).cannotBeDeserializedAs(new TypeToken<List<String>>() { });
    assertThat(DataType.map(DataType.cint(), DataType.frozenList(DataType.text()))).canBeDeserializedAs(new TypeToken<Map<Integer, List<String>>>() { }).canBeDeserializedAs(new TypeToken<Map<Number, Collection<String>>>() { }).cannotBeDeserializedAs(new TypeToken<Map<Integer, Collection<Integer>>>() { });
  }
}