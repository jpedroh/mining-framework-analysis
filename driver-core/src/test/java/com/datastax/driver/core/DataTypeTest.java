...
public class DataTypeTest {
  ...
  @SuppressWarnings(value = { "serial" }) @Test(groups = "unit") public void parseFormatUDTTest() {
    ...
    UDTDefinition udt2 = new UDTDefinition("ks", "t", Arrays.asList(new UDTDefinition.Field("t", DataType.text()), new UDTDefinition.Field("i", DataType.cint()), new UDTDefinition.Field("l", DataType.list(DataType.text())), new UDTDefinition.Field("s", DataType.map(DataType.cint(), DataType.userType(udt1)))));
