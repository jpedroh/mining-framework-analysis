 ...
 *
 */
public class PreferencesHL7Configuration extends PreferencesDicomConfiguration implements HL7Configuration {
  ...
  @Override public synchronized HL7Application findHL7Application(String name) throws ConfigurationException {
    return ((HL7Device) findDevice("hl7Application", name)).getHL7Application(name);
  }

  @Override protected Device newDevice(Preferences deviceNode) {
  ...
  @Override protected void storeChilds(Device device, Preferences deviceNode) {
  ...
  protected void storeTo(HL7Application hl7App, Preferences prefs, List<Connection> devConns) {
  ...
  @Override protected void loadChilds(Device device, Preferences deviceNode) throws BackingStoreException, ConfigurationException {
  ...
  private void loadHL7Applications(HL7Device hl7dev, Preferences deviceNode) throws BackingStoreException {
    ...
    for (String appName : appsNode.childrenNames()) {
      ...
      for (int i = 0; i < n; i++) {
        hl7app.addConnection(devConns.get(appNode.getInt("dicomNetworkConnectionReference." + (i + 1), 0) - 1));
      }
  ...
  protected void loadFrom(HL7Application hl7app, Preferences prefs) {
    hl7app.setAcceptedSendingApplications(stringArray(prefs, "hl7AcceptedSendingApplication"));
  ...
  @Override protected void mergeChilds(Device prev, Device device, Preferences devicePrefs) throws BackingStoreException {
  ...
  private void mergeHL7Apps(HL7Device prevDev, HL7Device dev, Preferences deviceNode) throws BackingStoreException {
    Preferences appsNode = deviceNode.node("hl7Application");
  ...
  protected void storeDiffs(Preferences prefs, HL7Application a, HL7Application b) {
    storeDiffConnRefs(prefs, a.getConnections(), a.getDevice().listConnections(), b.getConnections(), b.getDevice().listConnections());
    storeDiff(prefs, "hl7AcceptedSendingApplication", a.getAcceptedSendingApplications(), b.getAcceptedSendingApplications());
    storeDiff(prefs, "hl7AcceptedMessageType", a.getAcceptedMessageTypes(), b.getAcceptedMessageTypes());
    storeDiff(prefs, "hl7DefaultCharacterSet", a.getHL7DefaultCharacterSet(), b.getHL7DefaultCharacterSet());
    storeDiff(prefs, "dicomInstalled", a.getInstalled(), b.getInstalled());
  }

  protected void mergeChilds(HL7Application prev, HL7Application app, Preferences appNode) {
  }
}