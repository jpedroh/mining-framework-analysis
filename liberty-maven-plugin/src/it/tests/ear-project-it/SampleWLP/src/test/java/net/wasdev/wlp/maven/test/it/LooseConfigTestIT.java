...
public class LooseConfigTestIT {
    ...
    public final String LOOSE_APP = "target/liberty/wlp/usr/servers/test/apps/SampleEAR.ear.xml";
    ...
    public void testLooseApplicationFileContent() throws Exception {
        ...
        assertEquals("archive targetInArchive attribute value", "/modules/web.war", 
                nodes.item(1).getAttributes().getNamedItem("targetInArchive").getNodeValue());
<<<<<<< /usr/src/app/output/wasdev/ci.maven/b7c37eab73d658f90da6b0a6e9149b26a00bb332/liberty-maven-plugin/src/it/tests/ear-project-it/SampleWLP/src/test/java/net/wasdev/wlp/maven/test/it/LooseConfigTestIT.java/left.java
...
||||||| /usr/src/app/output/wasdev/ci.maven/b7c37eab73d658f90da6b0a6e9149b26a00bb332/liberty-maven-plugin/src/it/tests/ear-project-it/SampleWLP/src/test/java/net/wasdev/wlp/maven/test/it/LooseConfigTestIT.java/base.java
=======
        ...
        assertEquals("file targetInArchive attribute value", "/WEB-INF/lib/log4j-1.2.17.jar", 
                nodes.item(2).getAttributes().getNamedItem("targetInArchive").getNodeValue());
>>>>>>> /usr/src/app/output/wasdev/ci.maven/b7c37eab73d658f90da6b0a6e9149b26a00bb332/liberty-maven-plugin/src/it/tests/ear-project-it/SampleWLP/src/test/java/net/wasdev/wlp/maven/test/it/LooseConfigTestIT.java/right.java
    }
}
