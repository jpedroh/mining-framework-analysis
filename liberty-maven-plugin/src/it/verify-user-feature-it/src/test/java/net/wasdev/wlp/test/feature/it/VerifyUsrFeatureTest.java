...
public class VerifyUsrFeatureTest {
  ...
  @Test public void testVerifyUsrFeature() throws Exception {
    try {
  ...
  @Test public void testVerifyAll() throws Exception {
  ...
  @Test public void testVerifyWarnWrongKeyId() throws Exception {
  ...
  @Test public void testVerifyEnforceWithoutUserKeyId() throws Exception {
