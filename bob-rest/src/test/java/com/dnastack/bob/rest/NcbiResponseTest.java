 ...
 * @version 1.0
 */
@RunWith(value = Arquillian.class) @RunAsClient public class NcbiResponseTest extends AbstractResponseTest {
  private static final String BEACON = "ncbi";

  @Test @Override public void testAllRefsFound(@ArquillianResource URL url) throws JAXBException, MalformedURLException {
    String[] query = { "2", "41403", "A", null };
