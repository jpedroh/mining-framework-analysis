 ...
 * @version 1.0
 */
@RunWith(value = Arquillian.class) @RunAsClient public class CafeVariomeResponseTest extends AbstractResponseTest {
  ...
  @Test public void testFoundCafeCardioKit(@ArquillianResource URL url) throws JAXBException, MalformedURLException {
  ...
  @Test public void testFoundCafeCentral(@ArquillianResource URL url) throws JAXBException, MalformedURLException {
