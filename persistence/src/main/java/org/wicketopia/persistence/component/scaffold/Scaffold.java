 ...
 * @author James Carman
 */
public class Scaffold<T extends java.lang.Object> extends Panel implements IHeaderContributor {
  ...
  private final class ActionsColumn extends FragmentColumn<T> {
    ...
    @Override protected Fragment createFragment(String componentId, IModel<T> rowModel) {
  ...
  private final class CreateFragment extends Fragment {
    private CreateFragment() {
      ...
      add(new AjaxCreateLink<T>("saveButton", form, persistenceProvider) {
        @Override protected void afterCreate(T object, AjaxRequestTarget target) {
  ...
  private final class EditFragment extends Fragment {
    private EditFragment() {
      ...
      add(new AjaxUpdateLink<T>("saveButton", form, persistenceProvider) {
        @Override protected void afterUpdate(T object, AjaxRequestTarget target) {
          mode = ScaffoldMode.View;
