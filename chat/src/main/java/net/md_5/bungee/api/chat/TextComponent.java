...
@Getter @Setter @AllArgsConstructor public class TextComponent extends BaseComponent {
  ...
  @Override public BaseComponent duplicateWithoutFormatting() {
    return new TextComponent(this.text);
  }

  @Override protected void toPlainText(StringBuilder builder) {
    builder.append(text);
    super.toPlainText(builder);
  }

  @Override protected void toLegacyText(StringBuilder builder) {
