...
public class Bridge {
  ...
  public void publishService(String name, BridgeObjectBase bridgeObject, BridgeObjectBase callback) {
    ...
    if (callback instanceof BridgeObject) {
      ...
      if (callback instanceof BridgeRemoteObject) {
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> T getService(String serviceName, Class<T> serviceInterface) {
  ...
  /**
	 ...
	 */
  public <T extends java.lang.Object> T getChannel(String channelName, Class<T> channelInterface) {
  ...
  public void joinChannel(String channelName, BridgeObjectBase handler, BridgeObjectBase callback) {
    ...
    if (handler instanceof BridgeObject) {
      ...
      if (handler instanceof BridgeRemoteObject) {
