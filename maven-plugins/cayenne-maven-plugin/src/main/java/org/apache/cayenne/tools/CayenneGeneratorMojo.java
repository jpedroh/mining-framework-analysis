 ...
 * @since 3.0
 */
@Mojo(name = "cgen", defaultPhase = LifecyclePhase.GENERATE_SOURCES) public class CayenneGeneratorMojo extends AbstractMojo {
  public static final File[] NO_FILES = new File[0];

  /**
	 * Path to additional DataMap XML files to use for class generation.
	 */
  @Parameter private File additionalMaps;

  /**
	 * Default destination directory for Java classes (ignoring their package names).
	 */
  @Parameter(defaultValue = "${project.build.sourceDirectory}") private File defaultDir;

  /**
	 * Destination directory for Java classes (ignoring their package names).
	 */
  @Parameter private File destDir;
  ...
  /**
	 ...
	 */
  @Parameter private String excludeEmbeddables;
  ...
  /**
	 ...
	 * <code>true</code>).
	 */
  @Parameter private Boolean makePairs;

  /**
	 * DataMap XML file to use as a base for class generation.
	 */
  @Parameter(required = true) private File map;
  ...
  /**
	 ...
	 */
  @Parameter private String outputPattern;
  ...
  /**
	 ...
	 */
  @Parameter private Boolean overwrite;
  ...
  /**
	 ...
	 */
  @Parameter private String superPkg;
  ...
  /**
	 ...
	 */
  @Parameter private String superTemplate;
  ...
  /**
	 ...
	 * omitted, default template is used.
	 */
  @Parameter private String embeddableSuperTemplate;

  /**
	 * Location of Velocity template file for Embeddable class generation. If
	 * omitted, default template is used.
	 */
  @Parameter private String embeddableTemplate;
  ...
  /**
	 ...
	 */
  @Parameter private Boolean usePkgPath;

  /**
     * If set to <code>true</code>, will generate String Property names.
     * Default is <code>false</code>.
     */
  @Parameter private Boolean createPropertyNames;
  ...
  /**
	 ...
	 * @since 4.1
	 */
  @Parameter(defaultValue = "false", property = "force") private boolean force;
  ...
  /**
	 ...
	 */
  @Parameter private String dataMapTemplate;
  ...
  /**
	 ...
	 */
  @Parameter private String dataMapSuperTemplate;
  ...
  /**
     ...
     * @since 4.1
     */
  @Parameter private Boolean createPKProperties;

  /**
     * Optional path (classpath or filesystem) to external velocity tool configuration file
     * @since 4.2 
     */
  @Parameter private String externalToolConfig;
