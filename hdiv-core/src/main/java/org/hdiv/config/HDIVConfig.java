...
<<<<<<< /usr/src/app/output/hdiv/hdiv/9f06aa7519eaeb4ce3778d78e4751aeb251ec0d4/hdiv-core/src/main/java/org/hdiv/config/HDIVConfig.java/left.java
  pentestingActive = false
=======
  editableFieldsRequiredByDefault = false
>>>>>>> /usr/src/app/output/hdiv/hdiv/9f06aa7519eaeb4ce3778d78e4751aeb251ec0d4/hdiv-core/src/main/java/org/hdiv/config/HDIVConfig.java/right.java
  ;
  ...
  @Deprecated public void setStrategy(final Strategy strategy) {
  }
  ...
  /**
	 ...
	 */
  @Deprecated public void setRandomName(final boolean randomName) {
    if (randomName) {
      noLongerSupportedDisclaimer("RandomName");
    }
  }

  @Deprecated public Strategy getStrategy() {
  ...
  /**
	 ...
	 */
  @Deprecated public void setStateParameterName(final String stateParameterName) {
  ...
  /**
	 ...
	 */
  @Deprecated public void setModifyStateParameterName(final String modifyStateParameterName) {
