...
public abstract class AbstractDataComposer implements IDataComposer {
  ...
  /**
	 ...
	 * @return Codified value to send to the client
	 */
  public String compose(final String action, final String parameter, final String value, final boolean editable, final boolean isActionParam, final String charEncoding) {
  ...
  /**
	 ...
	 * @return Codified value to send to the client
	 */
  public String compose(final String parameter, final String value, final boolean editable, final boolean isActionParam, final String charEncoding) {
  ...
  /**
	 ...
	 * @since HDIV 2.1.5
	 */
  public String compose(final String parameter, final String value, final boolean editable, final String editableName, final boolean isActionParam, final Method method) {
  ...
  /**
	 ...
	 * @since HDIV 2.1.5
	 */
  public String compose(final String parameterName, final String value, final boolean editable, final String editableName, final boolean isActionParam, Method method, final String charEncoding) {
    if (!isRequestStarted()) {
      return value;
    }
    if (method == null) {
  ...
  /**
	 ...
	 * @since HDIV 1.1
	 */
  protected IParameter composeParameter(final String parameterName, final String value, final boolean editable, final String editableDataType, final boolean isActionParam, final String charEncoding) {
  ...
  /**
	 ...
	 */
  protected IParameter createParameter(final String parameterName, final String decodedValue, final boolean editable, final String editableDataType, final boolean isActionParam, final String charEncoding) {
  ...
  public void mergeParameters(final String oldParameter, final String newParameter) {
    ...
    if (!storedParameter.getValues().isEmpty()) {
      IParameter parameter = composeParameter(newParameter, storedParameter.getValuePosition(0), false, "", false, Constants.ENCODING_UTF_8);
