...
public interface ISession {
  ...
  @Deprecated void addPage(RequestContext context, int pageId, IPage page);
  ...
  @Deprecated void addPartialPage(RequestContext context, int pageId, IPage page);
  ...
  /**
	 ...
	 * @since HDIV 2.0.3
	 */
  @Deprecated void removeEndedPages(RequestContext context, String conversationId);
  ...
  /**
	 ...
	 * @since HDIV 3.0.1
	 */
  public <T extends java.lang.Object> T getAttribute(RequestContext context, String name, Class<T> requiredType);
