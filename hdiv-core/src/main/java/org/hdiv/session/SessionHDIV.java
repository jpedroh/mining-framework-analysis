...
public class SessionHDIV implements ISession, BeanFactoryAware {
  ...
  protected void addPage(final RequestContext context, final IPage newPage, final boolean isPartial) {
    ...
    boolean isRefreshRequest = newPage != null && lastPage != null && newPage.getParentStateId() != null && lastPage.getParentStateId() != null && newPage.getParentStateId().equals(lastPage.getParentStateId());
  ...
  @SuppressWarnings(value = { "unchecked" }) public <T extends java.lang.Object> T getAttribute(RequestContext context, String name, Class<T> requiredType) {
    Assert.notNull(context);
    Assert.notNull(name);
  ...
  @Deprecated public void addPage(final RequestContext context, final int pageId, final IPage page) {
    addPage(context, page);
  }

  @Deprecated public void addPartialPage(final RequestContext context, final int pageId, final IPage page) {
