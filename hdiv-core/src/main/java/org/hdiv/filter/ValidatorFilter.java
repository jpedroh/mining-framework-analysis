...
public class ValidatorFilter extends OncePerRequestFilter {
  ...
  /**
	 ...
	 */
  @Override protected void doFilterInternal(final HttpServletRequest request, final HttpServletResponse response, final FilterChain filterChain) throws ServletException, IOException {
    ...
    @SuppressWarnings(value = { "deprecation" }) RequestWrapper requestWrapper = (RequestWrapper) ctx.getRequest();
    ...
    if (current instanceof SharedHdivException) {
      ...
      if (!allowUncontrolledOrigin) {
        ...
        while ((invalid = invalid.getCause()) != null) {
          if (invalid instanceof NullPointerException || invalid instanceof IndexOutOfBoundsException || invalid instanceof OutOfMemoryError || invalid instanceof ClassNotFoundException || invalid instanceof StackOverflowError || invalid instanceof ClassCastException) {
            return null;
          }
        }
      }
  ...
  /**
	 ...
	 */
  protected final void processRequest(final RequestContextHolder ctx, final HttpServletRequest requestWrapper, final ResponseWrapper responseWrapper, final FilterChain filterChain, final String obfuscated) throws IOException, ServletException {
