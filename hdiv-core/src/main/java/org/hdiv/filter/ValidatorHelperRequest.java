...
public class ValidatorHelperRequest implements IValidationHelper {
  ...
  protected ValidatorHelperResult validateRequestCookies(HttpServletRequest request, String target) {
    ...
    @SuppressWarnings(value = { "unchecked" }) Map<String, SavedCookie> sessionCookies = (Map<String, SavedCookie>) request.getSession().getAttribute(Constants.HDIV_COOKIES_KEY);
  ...
  /**
	 ...
	 * @since HDIV 1.1
	 */
  protected void validateEditableParameter(HttpServletRequest request, String target, String parameter, String[] values, String dataType, List<ValidatorError> unauthorizedParameters) {
  ...
  /**
	 ...
	 * @since HDIV 2.1.5
	 */
  protected ValidatorHelperResult validateParameter(HttpServletRequest request, IParameter stateParameter, String[] actionParamValues, List<ValidatorError> unauthorizedEditableParameters, String hdivParameter, String target, String parameter) {
...
<<<<<<< /usr/src/app/output/hdiv/hdiv/c99a61a046a1cc2b7897a9866fb405ce151e1099/hdiv-core/src/main/java/org/hdiv/filter/ValidatorHelperRequest.java/left.java
      new ValidatorHelperResult(error)
=======
      validateExtraParameter(request, stateParameter, actionParamValues, unauthorizedEditableParameters, hdivParameter, target, parameter)
>>>>>>> /usr/src/app/output/hdiv/hdiv/c99a61a046a1cc2b7897a9866fb405ce151e1099/hdiv-core/src/main/java/org/hdiv/filter/ValidatorHelperRequest.java/right.java
  ...
  /**
	 ...
	 * @since HDIV 2.1.13
	 */
  protected ValidatorHelperResult validateExtraParameter(HttpServletRequest request, IParameter stateParameter, String[] actionParamValues, Map<String, String[]> unauthorizedEditableParameters, String hdivParameter, String target, String parameter) {
  ...
  /**
	 ...
	 */
  protected ValidatorHelperResult validateParameterValues(HttpServletRequest request, String target, IParameter stateParameter, String[] actionParamValues, String parameter, String[] values) {
    try {
  ...
  /**
	 ...
	 */
  protected ValidatorHelperResult hasRepeatedOrInvalidValues(String target, String parameter, String[] values, List<String> stateValues) {
  ...
  /**
	 ...
	 */
  protected ValidatorHelperResult hasConfidentialIncorrectValues(String target, String parameter, String[] values, List<String> stateValues) {
...
>>>>>>> /usr/src/app/output/hdiv/hdiv/c99a61a046a1cc2b7897a9866fb405ce151e1099/hdiv-core/src/main/java/org/hdiv/filter/ValidatorHelperRequest.java/right.java
  ...
  /**
	 ...
	 */
  protected ValidatorHelperResult validateReceivedValuesInState(HttpServletRequest request, String target, IParameter stateParameter, String[] actionParamValues, String parameter, String[] values) {
