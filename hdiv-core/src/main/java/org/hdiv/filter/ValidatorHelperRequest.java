...
public class ValidatorHelperRequest implements IValidationHelper, StateRestorer {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unused" }) public ValidatorHelperResult validate(final ValidationContext context) {
  ...
  @Deprecated protected final boolean isStartPage(final HttpServletRequest request, final String target) {
  ...
  @Deprecated protected final ValidatorHelperResult isTheSameAction(final HttpServletRequest request, final String target, final IState state) {
    return isTheSameAction(request, target, state.getAction());
  }

  @Deprecated protected final ValidatorHelperResult isTheSameAction(final HttpServletRequest request, final String target, final String stateAction) {
    throw new UnsupportedOperationException();
  }
  ...
  @Deprecated protected final ValidatorHelperResult validateStartPageParameters(final HttpServletRequest request, final String target) {
    throw new UnsupportedOperationException();
  }
  ...
  protected final ValidatorHelperResult validateRequestCookies(final ValidationContext context, final String target) {
    ...
    @SuppressWarnings(value = { "unchecked" }) Map<String, SavedCookie> sessionCookies = session.getAttribute(context.getRequestContext(), Constants.HDIV_COOKIES_KEY, Map.class);
  ...
  @Deprecated protected final ValidatorHelperResult allRequiredParametersReceived(final HttpServletRequest request, final IState state, final String target, final Map<String, String[]> stateParams) {
    throw new UnsupportedOperationException();
  }
  ...
  @Deprecated protected final ValidatorHelperResult validateMissingParameters(final HttpServletRequest request, final IState state, final String target, final Map<String, String[]> stateParams, final List<String> missingParameters) {
    throw new UnsupportedOperationException();
  }
  ...
  @Deprecated protected final ValidatorHelperResult validateParameter(final HttpServletRequest request, final Map<String, String[]> stateParams, final IParameter stateParameter, final String[] actionParamValues, final List<ValidatorError> unauthorizedEditableParameters, final String hdivParameter, final String target, final String parameter) {
    throw new UnsupportedOperationException();
  }
  ...
  @Deprecated protected final ValidatorHelperResult validateExtraParameter(final HttpServletRequest request, final Map<String, String[]> stateParams, final IParameter stateParameter, final String[] actionParamValues, final List<ValidatorError> unauthorizedEditableParameters, final String hdivParameter, final String target, final String parameter) {
    throw new UnsupportedOperationException();
  }
  ...
  @Deprecated protected final ValidatorHelperResult restoreState(final String hdivParameter, final ValidationContext context) {
  ...
  @Deprecated protected final ValidatorHelperResult restoreState(final String hdivParameter, final String hdivState, final ValidationContext context) {
    return restoreState(hdivParameter, context.getRequestContext(), context.getRequestedTarget(), hdivState);
  }

  @Deprecated protected final ValidatorHelperResult restoreState(final String hdivParameter, final HttpServletRequest request, final String target, final String requestState) {
    return restoreState(hdivParameter, HDIVUtil.getRequestContext(request), target, requestState);
  }

  @Deprecated protected final ValidatorHelperResult restoreState(final String hdivParameter, final RequestContextHolder context, final String target, final String requestState) {
    throw new UnsupportedOperationException();
  }
  ...
  @Deprecated protected final ValidatorHelperResult validateParameterValues(final HttpServletRequest request, final String target, final IParameter stateParameter, final String[] actionParamValues, final String parameter, final String[] values) {
    throw new UnsupportedOperationException();
  }
  ...
  @Deprecated protected final ValidatorHelperResult hasRepeatedOrInvalidValues(final HttpServletRequest request, final String target, final String parameter, final String[] values, final List<String> stateValues) {
    throw new UnsupportedOperationException();
  }

  @Deprecated protected final ValidatorHelperResult hasRepeatedOrInvalidValues(final RequestContextHolder request, final String target, final String parameter, final String[] values, final List<String> stateValues) {
  ...
  @Deprecated protected final ValidatorHelperResult hasConfidentialIncorrectValues(final HttpServletRequest request, final String target, final String parameter, final String[] values, final List<String> stateValues) {
    throw new UnsupportedOperationException();
  }

  @Deprecated protected final ValidatorHelperResult hasConfidentialIncorrectValues(final RequestContextHolder request, final String target, final String parameter, final String[] values, final List<String> stateValues) {
  ...
  @Deprecated protected final ValidatorHelperResult validateReceivedValuesInState(final HttpServletRequest request, final String target, final IParameter stateParameter, final String[] actionParamValues, final String parameter, final String[] values) {
    throw new UnsupportedOperationException();
  }
  ...
  @Deprecated protected final void addParameterToRequest(final HttpServletRequest request, final String name, final String[] value) {
    throw new UnsupportedOperationException();
  }

  @Deprecated protected final void addEditableParameter(final HttpServletRequest request, final String name) {
    throw new UnsupportedOperationException();
  }
  ...
  @Deprecated protected final ValidatorHelperResult preValidate(final HttpServletRequest request, final String target) {
    throw new UnsupportedOperationException();
  }
