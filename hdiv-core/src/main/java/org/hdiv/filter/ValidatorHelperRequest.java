...
public class ValidatorHelperRequest implements IValidationHelper, StateRestorer {
  ...
  public ValidatorHelperResult validate(final ValidationContext context) {
    ...
    while (parameters.hasMoreElements()) {
      ...
      result = validateParameter(request, stateParams, state.getParameter(parameter), stateParams.get(parameter), unauthorizedEditableParameters, hdivParameter, target, parameter);
      if (!result.isValid()) {
        return result;
      }
    }
  ...
  /**
	 ...
	 */
  protected ValidatorHelperResult allRequiredParametersReceived(final HttpServletRequest request, final IState state, final String target, final Map<String, String[]> stateParams) {
  ...
  /**
	 ...
	 */
  protected ValidatorHelperResult validateMissingParameters(final HttpServletRequest request, final IState state, final String target, final Map<String, String[]> stateParams, final List<String> missingParameters) {
  ...
  /**
	 ...
	 * @return valid result if restored state is valid. False in otherwise.
	 */
  protected ValidatorHelperResult restoreState(final String hdivParameter, final HttpServletRequest request, final String target, String requestState) {
