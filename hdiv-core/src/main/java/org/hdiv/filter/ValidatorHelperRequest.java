...
public class ValidatorHelperRequest implements IValidationHelper {
  ...
  public ValidatorHelperResult validate(final HttpServletRequest request) {
    ...
    while (parameters.hasMoreElements()) {
      ...
      result = validateParameter(request, state.getParameter(parameter), stateParams.get(parameter), unauthorizedEditableParameters, hdivParameter, target, parameter);
      if (!result.isValid()) {
        return result;
      }
    }
  ...
  protected ValidatorHelperResult validateRequestCookies(final HttpServletRequest request, final String target) {
    ...
    @SuppressWarnings(value = { "unchecked" }) Map<String, SavedCookie> sessionCookies = this.session.getAttribute(new RequestContext(request), Constants.HDIV_COOKIES_KEY, Map.class);
    ...
    for (int i = 0; i < requestCookies.length; i++) {
      ...
      if (!found) {
        ValidatorError error = new ValidatorError(HDIVErrorCodes.COOKIE_INCORRECT, target, "cookie:" + requestCookies[i].getName(), requestCookies[i].getValue());
        return new ValidatorHelperResult(error);
      }
    }
    return ValidatorHelperResult.VALID;
  ...
  /**
	 ...
	 * @since HDIV 1.1
	 */
  protected void validateEditableParameter(final HttpServletRequest request, final String target, String parameter, final String[] values, final String dataType, List<ValidatorError> unauthorizedParameters) {
    ...
    if (!result.isValid()) {
      ...
      ValidatorError error = new ValidatorError(HDIVErrorCodes.EDITABLE_VALIDATION_ERROR, target, parameter, value, null, result.getValidationId());
  ...
  /**
	 ...
	 * @since HDIV 2.1.5
	 */
  protected ValidatorHelperResult validateParameter(final HttpServletRequest request, final IParameter stateParameter, String[] actionParamValues, final List<ValidatorError> unauthorizedEditableParameters, String hdivParameter, final String target, final String parameter) {
    if (isUserDefinedNonValidationParameter(target, parameter, hdivParameter)) {
      return ValidatorHelperResult.VALIDATION_NOT_REQUIRED;
    }
    if (stateParameter == null && actionParamValues == null) {
      return validateExtraParameter(request, stateParameter, actionParamValues, unauthorizedEditableParameters, hdivParameter, target, parameter);
    }
    String[] values = request.getParameterValues(parameter);
  ...
  /**
	 ...
	 * @since HDIV 2.1.13
	 */
  protected ValidatorHelperResult validateExtraParameter(final HttpServletRequest request, IParameter stateParameter, final String[] actionParamValues, List<ValidatorError> unauthorizedEditableParameters, final String hdivParameter, final String target, String parameter) {
    if (log.isDebugEnabled()) {
    ...
    try {
      ...
      if (stateUtil.isMemoryStrategy(requestState)) {
        if (!validateHDIVSuffix(request, requestState, state)) {
          ValidatorError error = new ValidatorError(HDIVErrorCodes.HDIV_PARAMETER_INCORRECT_VALUE, target, hdivParameter, requestState);
          return new ValidatorHelperResult(error);
        }
      }
  ...
  /**
	 ...
	 */
  protected ValidatorHelperResult validateParameterValues(final HttpServletRequest request, final String target, IParameter stateParameter, final String[] actionParamValues, final String parameter, String[] values) {
    try {
  ...
  /**
	 ...
	 */
  protected ValidatorHelperResult hasRepeatedOrInvalidValues(final HttpServletRequest request, final String target, String parameter, final String[] values, final List<String> stateValues) {
  ...
  /**
	 ...
	 */
  protected ValidatorHelperResult hasConfidentialIncorrectValues(final HttpServletRequest request, String target, final String parameter, final String[] values, final List<String> stateValues) {
  ...
  /**
	 ...
	 * @return True If repeated or no valid values have been received for the parameter <code>parameter</code>.
	 */
  protected ValidatorHelperResult hasNonConfidentialIncorrectValues(final String target, final String parameter, String[] values, final List<String> tempStateValues) {
    Set<String> receivedValues = new HashSet<String>();
    for (int i = 0; i < values.length; i++) {
      ...
      if (!exists) {
        ...
        ValidatorError error = new ValidatorError(HDIVErrorCodes.PARAMETER_VALUE_INCORRECT, target, parameter, values[i], originalValue);
        return new ValidatorHelperResult(error);
      }
      receivedValues.add(values[i]);
    }
  ...
  /**
	 ...
	 */
  protected ValidatorHelperResult validateReceivedValuesInState(final HttpServletRequest request, final String target, IParameter stateParameter, final String[] actionParamValues, final String parameter, String[] values) {
  ...
  protected String getHdivParameter(final HttpServletRequest request) {
    String paramName = HDIVUtil.
<<<<<<< /usr/src/app/output/hdiv/hdiv/2f9993190a5d9e153c693e8060ef8050f2fe2baa/hdiv-core/src/main/java/org/hdiv/filter/ValidatorHelperRequest.java/left.java
    getHDIVParameter(request)
=======
    getHdivStateParameterName(request)
>>>>>>> /usr/src/app/output/hdiv/hdiv/2f9993190a5d9e153c693e8060ef8050f2fe2baa/hdiv-core/src/main/java/org/hdiv/filter/ValidatorHelperRequest.java/right.java
    ;
    if (paramName == null) {
