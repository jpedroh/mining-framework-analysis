...
public final class NettyConnection implements Connection, ChannelFutureListener {
  ...
  @Override public void init(Channel channel, boolean security) {
  ...
  @Override public void setSessionContext(SessionContext context) {
  ...
  @Override public ChannelFuture send(Packet packet, final ChannelFutureListener listener) {
    if (channel.isActive()) {
  ...
  @Override public void updateLastWriteTime() {
    lastWriteTime = System.currentTimeMillis();
  }

  @Override public String toString() {
    return "[channel=" + channel + ", context=" + context + ", status=" + status + ", lastReadTime=" + lastReadTime + ", lastWriteTime=" + lastWriteTime + "]";
  }
