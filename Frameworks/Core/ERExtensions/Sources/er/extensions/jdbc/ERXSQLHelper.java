...
public class ERXSQLHelper {
  ...
  /**
	 ...
	 *         tables
	 */
  @SuppressWarnings(value = { "unchecked" }) public String createSchemaSQLForEntitiesInModelAndOptions(NSArray<EOEntity> entities, EOModel model, NSDictionary optionsCreate) {
  ...
  @SuppressWarnings(value = { "unchecked" }) public String createIndexSQLForEntities(NSArray<EOEntity> entities, NSArray<String> externalTypesToIgnore) {
    ...
    for (Enumeration entitiesEnum = entities.objectEnumerator(); entitiesEnum.hasMoreElements(); ) {
      ...
      for (Enumeration<String> keys = d.keyEnumerator(); keys.hasMoreElements(); ) {
        ...
        if (key.startsWith("index")) {
          ...
          if (key.equals("additionalIndexes")) {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) public NSArray<EOAttribute> attributesToFetchForEntity(EOFetchSpecification fetchSpec, EOEntity entity) {
  ...
  public String customQueryExpressionHintAsString(Object hint) {
    ...
    if (hint instanceof String) {
      ...
      if (hint instanceof EOSQLExpression) {
  ...
  /**
	 ...
	 */
  @SuppressWarnings(value = { "unchecked" }) public String externalTypeForJDBCType(JDBCAdaptor adaptor, int jdbcType) {
    ...
    if (sql != null) {
      ...
      try {
        ...
        while (nextLine != null) {
          ...
          if (nextLine.length() == 0 || (statementBuffer.length() == 0 && commentPattern.matcher(nextLine).find())) {
                ...
                if (databaseProductName.equalsIgnoreCase("mysql")) {
                  ...
                  if (databaseProductName.equalsIgnoreCase("oracle")) {
                    ...
                    if (databaseProductName.equalsIgnoreCase("postgresql")) {
                      ...
                      if (databaseProductName.equalsIgnoreCase("openbase")) {
                        sqlHelper = new OpenBaseSQLHelper();
                      } else {
                        if (databaseProductName.equalsIgnoreCase("derby")) {
                          sqlHelper = new DerbySQLHelper();
                        } else {
                          if (databaseProductName.equalsIgnoreCase("microsoft")) {
                            ...
                            if (databaseProductName.equalsIgnoreCase("h2")) {
                              ...
                              if (databaseProductName.equalsIgnoreCase("db2")) {
                                ...
                                if (databaseProductName.equalsIgnoreCase("firebird")) {
  ...
  public static class OracleSQLHelper extends ERXSQLHelper {
    @Override protected String sqlForSubquery(String subquery, String alias) {
      return "(" + subquery + ") " + alias;
    }

    @Override protected String sqlForGetNextValFromSequencedNamed(String sequenceName) {
    ...
    /**
		 ...
		 */
    @Override public String createSchemaSQLForEntitiesInModelWithNameAndOptions(NSArray<EOEntity> entities, String modelName, NSDictionary optionsCreate) {
      ...
      for (Enumeration e = a.objectEnumerator(); e.hasMoreElements(); ) {
        ...
        for (Enumeration e1 = b.objectEnumerator(); e1.hasMoreElements(); ) {
          ...
          if (oldConstraintName == null) {
            ...
            if (oldConstraintName.equals(newConstraintName)) {
              constraintName += "_" + ++i;
            } else {
              i = 0;
            }
    ...
    @Override public String limitExpressionForSQL(EOSQLExpression expression, EOFetchSpecification fetchSpecification, String sql, long start, long end) {
      String limitSQL;
    ...
    @Override protected String commandSeparatorString() {
      String lineSeparator = System.getProperty("line.separator");
      String commandSeparator = lineSeparator + "/" + lineSeparator;
      return commandSeparator;
    }

    @Override public String createIndexSQLForEntities(NSArray<EOEntity> entities, NSArray<String> externalTypesToIgnore) {
    ...
    @Override public String sqlForCreateUniqueIndex(String indexName, String tableName, ColumnIndex... columnIndexes) {
    ...
    @Override public String sqlForCreateIndex(String indexName, String tableName, ColumnIndex... columnIndexes) {
      NSMutableArray<String> columnNames = new NSMutableArray<>();
      for (ColumnIndex columnIndex : columnIndexes) {
        columnNames.addObject(columnIndex.columnName());
      }
    ...
    @Override public String sqlForRegularExpressionQuery(String key, String value) {
      return "REGEXP_LIKE(" + key + ", " + value + ")";
    }

    @Override public String migrationTableName() {
      return "dbupdater";
    }

    @Override public String externalTypeForJDBCType(JDBCAdaptor adaptor, int jdbcType) {
      String externalType;
    ...
    @Override public boolean reassignExternalTypeForValueTypeOverride(EOAttribute attribute) {
      return false;
    }

    @Override protected boolean canReliablyPerformDistinctWithSortOrderings() {
      return false;
    }
    ...
    /**
		 ...
		 */
    @Override public int varcharLargeJDBCType() {
      return Types.CLOB;
    }

    @Override public int varcharLargeColumnWidth() {
      return -1;
    }
  }
  ...
  public static class DerbySQLHelper extends ERXSQLHelper {
    @Override public boolean shouldExecute(String sql) {
  ...
  public static class FrontBaseSQLHelper extends ERXSQLHelper {
    ...
    @Override public String sqlForFullTextQuery(ERXFullTextQualifier qualifier, EOSQLExpression expression) {
      StringBuilder sb = new StringBuilder();
      sb.append("satisfies(");
      ...
      for (String term : terms) {
        ...
        for (String termWord : termWords) {
          ...
          if (matchType == ERXFullTextQualifier.MatchType.ALL) {
            ...
            if (matchType == ERXFullTextQualifier.MatchType.ANY) {
              sb.append('|');
            }
          }
        }
    ...
    @Override public void prepareConnectionForSchemaChange(EOEditingContext ec, EOModel model) {
      ERXEOAccessUtilities.ChannelAction action = new ERXEOAccessUtilities.ChannelAction() {
        @Override protected int doPerform(EOAdaptorChannel channel) {
          try {
    ...
    @Override @SuppressWarnings(value = { "unchecked" }) public void restoreConnectionSettingsAfterSchemaChange(EOEditingContext ec, EOModel model) {
      ...
      for (String urlComponent : urlComponents) {
        if (urlComponent.toLowerCase().startsWith(PREFIX_LOCKING)) {
          ...
          if (urlComponent.toLowerCase().startsWith(PREFIX_ISOLATION_LEVEL)) {
    ...
    /**
		 ...
		 * @return regex pattern that indicates this line is an SQL comment
		 */
    @Override protected Pattern commentPattern() {
      return Pattern.compile("^--");
    }

    @Override public String quoteColumnName(String columnName) {
      if (columnName == null) {
        return null;
      }
    ...
    /**
		 ...
		 * @return database specific limit, or or most efficient number, of elements in an IN clause in a statement
		 */
    @Override protected int maximumElementPerInClause(EOEntity entity) {
      return 15000;
    }
  ...
  public static class PostgresqlSQLHelper extends ERXSQLHelper {
    ...
    /**
		 ...
		 */
    @Override public boolean reassignExternalTypeForValueTypeOverride(EOAttribute attr) {
    ...
    @Override public boolean handleDatabaseException(EODatabaseContext databaseContext, Throwable throwable) {
    ...
    @Override protected String sqlForCountDistinct(EOEntity entity) {
      NSArray<String> primaryKeyAttributeNames = entity.primaryKeyAttributeNames();
  ...
  public static class FirebirdSQLHelper extends ERXSQLHelper {
    ...
    private static final NSSet reservedWords = new NSSet(new String[] { "active", "password" });
  ...
  public static class MicrosoftSQLHelper extends ERXSQLHelper {
    ...
    @Override public String externalTypeForJDBCType(JDBCAdaptor adaptor, int type) {
      if (type == Types.BLOB) {
        return "binary";
      }
  ...
  public static class DB2SQLHelper extends ERXSQLHelper {
    ...
    @Override public String limitExpressionForSQL(EOSQLExpression expression, EOFetchSpecification fetchSpecification, String sql, long start, long end) {
      ...
      innerSql = innerSql.replaceAll("FETCH FIRST\\W+[0-9]+\\W+ROWS ONLY", " ");
