...
public class ERXRestUtils {
  ...
  public static boolean isPrimitive(Class<?> valueType) {
    ...
    if (String.class.isAssignableFrom(valueType)) {
      ...
      if (Boolean.class.isAssignableFrom(valueType)) {
        ...
        if (Character.class.isAssignableFrom(valueType)) {
          primitive = true;
        } else {
                      ...
                      if (Double.class.isAssignableFrom(valueType)) {
                        ...
                        if (Date.class.isAssignableFrom(valueType)) {
                          ...
                          if (Calendar.class.isAssignableFrom(valueType)) {
                            ...
                            if (org.joda.time.LocalDateTime.class.isAssignableFrom(valueType)) {
                              primitive = true;
                            } else {
                              if (org.joda.time.LocalDate.class.isAssignableFrom(valueType)) {
                                primitive = true;
                              } else {
                                if (Enum.class.isAssignableFrom(valueType)) {
                                  primitive = true;
                                } else {
                                  if (NSKeyValueCoding.Null.class.isAssignableFrom(valueType)) {
                                    primitive = true;
                                  } else {
                                    if (ERXCryptoString.class.isAssignableFrom(valueType)) {
                                      primitive = true;
                                    } else {
                                      if (LocalDate.class.isAssignableFrom(valueType)) {
                                        ...
                                        if (LocalDateTime.class.isAssignableFrom(valueType)) {
                                          ...
                                          if (LocalTime.class.isAssignableFrom(valueType)) {
                                            ...
                                            if (OffsetDateTime.class.isAssignableFrom(valueType)) {
                                              primitive = true;
                                            }
                                          }
                                        }
                ...
                if (value instanceof LocalDateTime) {
                  ...
                  if (value instanceof LocalTime) {
                    ...
                    if (value instanceof OffsetDateTime) {
                      ...
                      if (value instanceof NSData && ((NSData) value).length() == 24) {
  ...
  @SuppressWarnings(value = { "unchecked" }) public static Object coerceValueToTypeNamed(Object value, String valueTypeName, ERXRestContext context, boolean resolveEntities) {
    Object parsedValue;
    ...
    if (valueType != null && int.class.isAssignableFrom(valueType)) {
      ...
      if (valueType != null && boolean.class.isAssignableFrom(valueType)) {
        ...
        if (valueType != null && char.class.isAssignableFrom(valueType)) {
                      ...
                      if (valueType != null && String.class.isAssignableFrom(valueType)) {
                        ...
                        if (valueType != null && Boolean.class.isAssignableFrom(valueType)) {
                          ...
                          if (valueType != null && Character.class.isAssignableFrom(valueType)) {
                            parsedValue = Character.valueOf(((String) value).charAt(0));
                          } else {
                            if (valueType != null && Byte.class.isAssignableFrom(valueType)) {
                              parsedValue = Byte.valueOf((String) value);
                            } else {
                              if (valueType != null && BigDecimal.class.isAssignableFrom(valueType)) {
                                ...
                                if (valueType != null && Integer.class.isAssignableFrom(valueType)) {
                                  ...
                                  if (valueType != null && Short.class.isAssignableFrom(valueType)) {
                                    parsedValue = Short.valueOf((String) value);
                                  } else {
                                    if (valueType != null && Long.class.isAssignableFrom(valueType)) {
                                      ...
                                      if (valueType != null && Float.class.isAssignableFrom(valueType)) {
                                        ...
                                        if (valueType != null && Double.class.isAssignableFrom(valueType)) {
                                          ...
                                          if (valueType != null && NSData.class.isAssignableFrom(valueType)) {
                                            ...
                                            if (valueType != null && NSTimestamp.class.isAssignableFrom(valueType)) {
                                              ...
                                              if (valueType != null && Date.class.isAssignableFrom(valueType)) {
                                                ...
                                                if (valueType != null && org.joda.time.LocalDateTime.class.isAssignableFrom(valueType)) {
                                                  if (value instanceof NSTimestamp) {
                                                    parsedValue = value;
                                                  } else {
                                                    String strValue = (String) value;
                                                  ...
                                                  if (valueType != null && org.joda.time.LocalDate.class.isAssignableFrom(valueType)) {
                                                    if (value instanceof NSTimestamp) {
                                                      parsedValue = value;
                                                    } else {
                                                      String strValue = (String) value;
                                                    ...
                                                    if (valueType != null && TemporalAccessor.class.isAssignableFrom(valueType)) {
                                                      if (value instanceof NSTimestamp) {
                                                        parsedValue = value;
                                                      } else {
                                                        ...
                                                        if (valueTypeClass.equals(LocalDate.class)) {
                                                          ...
                                                          if (valueTypeClass.equals(LocalDateTime.class)) {
                                                            query = LocalDateTime::from;
                                                          } else {
                                                            if (valueTypeClass.equals(LocalTime.class)) {
                                                              query = LocalTime::from;
                                                            } else {
                                                              if (valueTypeClass.equals(OffsetDateTime.class)) {
                                                      ...
                                                      if (valueType != null && Enum.class.isAssignableFrom(valueType)) {
                                                        ...
                                                        if (valueType != null && ERXCryptoString.class.isAssignableFrom(valueType)) {
