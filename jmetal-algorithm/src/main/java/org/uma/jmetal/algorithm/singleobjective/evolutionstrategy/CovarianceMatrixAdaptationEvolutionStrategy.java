 ...
 */
@SuppressWarnings(value = { "serial" }) public class CovarianceMatrixAdaptationEvolutionStrategy extends AbstractEvolutionStrategy<DoubleSolution, DoubleSolution> {
  ...
  private DoubleSolution sampleSolution() {
    ...
    for (int i = 0; i < numberOfVariables; i++) {
      ...
      if (value > ((DoubleProblem) getProblem()).getUpperBound(i)) {
        ...
        if (value < ((DoubleProblem) getProblem()).getLowerBound(i)) {
