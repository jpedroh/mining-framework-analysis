...
public class ABYSSBuilder implements AlgorithmBuilder {
  ...
  } // The problem to solve // Crossover operator // Operator for improvement // Mutation operator //subranges //Maximum size of the population //Maximum size of the reference set one //Maximum size of the reference set two //Maximum size of the external archive //Maximum number of getEvaluations to carry out public ABYSSBuilder(DoubleProblem problem,Archive archive){
    this.populationSize = 20;
    this.maxEvaluations = 25000;
    this.archiveSize = 100;
    this.refSet1Size = 10;
