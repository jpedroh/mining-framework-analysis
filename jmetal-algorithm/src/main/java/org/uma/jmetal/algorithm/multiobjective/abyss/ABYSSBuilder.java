...
public class ABYSSBuilder implements AlgorithmBuilder {
  ...
  @Override public Algorithm build() {
    return new ABYSS(numberOfSubranges, populationSize, refSet1Size, refSet2Size, archiveSize, maxEvaluations, archive, crossoverOperator, improvementOperator, problem);
  }
