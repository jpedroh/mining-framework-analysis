...
public class ABYSSTest {
  ...
  @Test public void shouldIsStoppingConditionReachedReturnTrueIfTheConditionFulfills() {
    ABYSS abyss;
  ...
  @Test public void shouldIsStoppingConditionReachedReturnFalseIfTheConditionDoesNotFulfill() {
    int maxEvaluations = 100;
  ...
  @Test public void shouldInitializationPhaseLeadToAPopulationFilledWithEvaluatedSolutions() {
  ...
  @Test public void shouldReferenceSetUpdateCreateTheTwoRefSetsAfterBeingInvokedTheFirstTime() {
    int populationSize = 20;
    int numberOfSubRanges = 4;
    int referenceSet1Size = 6;
    int referenceSet2Size = 4;
    DoubleProblem problem = new MockProblem();
    ABYSS abyss = new ABYSS(problem, 0, populationSize, referenceSet1Size, referenceSet2Size, 0, null, localSearch, null, numberOfSubRanges);
    abyss.initializationPhase();
  ...
  @Test public void shouldReferenceSetUpdateCreateAReducedSizeReferenceSet2IfThePopulationIsNotBigEnough() {
  ...
  @Test public void shouldSubsetGenerationProduceAnEmptyListIfAllTheSolutionsAreMarked() {
    int populationSize = 10;
    int numberOfSubRanges = 4;
  ...
  @Test public void shouldSolutionCombinationProduceTheRightNumberOfSolutions() {
    int populationSize = 10;
    int numberOfSubRanges = 4;
    int referenceSet1Size = 4;
    int referenceSet2Size = 4;
    DoubleProblem problem = new MockProblem();
    ABYSS abyss = new ABYSS(problem, 0, populationSize, referenceSet1Size, referenceSet2Size, 0, null, localSearch, new SBXCrossover(1.0, 20.0), numberOfSubRanges);
    abyss.initializationPhase();
    abyss.referenceSetUpdate();
    List<List<DoubleSolution>> list = abyss.subsetGeneration();
  ...
  @Test public void shouldRestartCreateANewPopulationWithTheRefSet1Solutions() {
    int populationSize = 10;
    int numberOfSubRanges = 4;
    int referenceSet1Size = 4;
    int referenceSet2Size = 4;
    DoubleProblem problem = new MockProblem();
    ABYSS abyss = new ABYSS(problem, 0, populationSize, referenceSet1Size, referenceSet2Size, 10, new CrowdingDistanceArchive<DoubleSolution>(10), localSearch, new SBXCrossover(1.0, 20.0), numberOfSubRanges);
    abyss.initializationPhase();
    abyss.referenceSetUpdate();
    List<List<DoubleSolution>> list = abyss.subsetGeneration();
    List<DoubleSolution> combinedSolutions = abyss.solutionCombination(list);
  ...
  @SuppressWarnings(value = { "serial" }) private class MockProblem extends AbstractDoubleProblem {
