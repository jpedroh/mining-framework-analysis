...
public class ABYSSConstrainedProblemIT {
  ...
  @Before public void setup() {
    ...
    Comparator<DoubleSolution> comparator = new DominanceWithConstraintsComparator<>(new OverallConstraintViolationDegreeComparator<>());
  ...
  @Test public void shouldTheHypervolumeHaveAMinimumValue() throws Exception {
    ...
    algorithm.run();
    List<DoubleSolution> population = algorithm.getResult();
    QualityIndicator hypervolume = new PISAHypervolume(VectorUtils.readVectors("../resources/referenceFrontsCSV/Tanaka.csv", ","));
