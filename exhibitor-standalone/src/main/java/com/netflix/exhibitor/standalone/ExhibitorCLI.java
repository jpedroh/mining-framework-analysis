...
public class ExhibitorCLI {
  ...
  public void printHelp() {
    ...
    HelpFormatter formatter = new HelpFormatter() {
      @Override public void printUsage(PrintWriter pw, int width, String cmdLineSyntax) {
      }

      @Override public void printUsage(PrintWriter pw, int width, String app, Options options) {
      }
    };
  ...
  private static String getStyleOptions() {
    Iterable<String> transformed = Arrays.stream(JQueryStyle.values()).map((style) -> style.name().toLowerCase()).collect(Collectors.toList());
