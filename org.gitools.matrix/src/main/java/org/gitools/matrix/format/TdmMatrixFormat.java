...
@ApplicationScoped public class TdmMatrixFormat extends AbstractMatrixFormat {
  ...
  @Override public boolean isDefaultExtension() {
    return true;
  }

  @Override protected IMatrix readResource(IResourceLocator resourceLocator, IProgressMonitor progressMonitor) throws PersistenceException {
    try {
  ...
  @Override protected void writeResource(IResourceLocator resourceLocator, IMatrix results, IProgressMonitor monitor) throws PersistenceException {
  ...
  @Deprecated public static String[] readHeader(File file) throws PersistenceException {
