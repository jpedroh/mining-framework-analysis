 ...
 */
@SuppressWarnings(value = { "WeakerAccess" }) public final class JWTCreator {
...
<<<<<<< /usr/src/app/output/auth0/java-jwt/75ee6a33c14697af6c1b18b10c6a3603f0f8d121/lib/src/main/java/com/auth0/jwt/JWTCreator.java/left.java
        "Claim values must only be of types Map, List, Boolean, Integer, Long, Double, String, Date and Null"
=======
        "Claim values must only be of types Map, List, Boolean, Integer, " + "Long, Double, String and Date"
