...
public class JWTDecoderTest {
  ...
  @Test public void shouldThrowIfTheContentIsNotProperlyEncoded() {
  ...
  @Test public void shouldThrowIfLessThan3Parts() {
    exception.expect(JWTDecodeException.class);
  ...
  @Test public void shouldThrowIfPayloadHasInvalidJSONFormat() {
    String validJson = "{}";
    String invalidJson = "}{";
    exception.expect(JWTDecodeException.class);
  ...
  @Test public void shouldThrowIfHeaderHasInvalidJSONFormat() {
    String validJson = "{}";
    String invalidJson = "}{";
    exception.expect(JWTDecodeException.class);
    exception.expectMessage(String.format("The string \'%s\' doesn\'t have a valid JSON format.", invalidJson));
  ...
  @Test public void shouldThrowWhenHeaderNotValidBase64() {
    exception.expect(JWTDecodeException.class);
  ...
  @Test public void shouldThrowWhenPayloadNotValidBase64() {
    exception.expect(JWTDecodeException.class);
    exception.expectCause(isA(IllegalArgumentException.class));
  ...
  @Test public void shouldGetStringToken() {
  ...
  @Test public void shouldGetArrayAudience() {
  ...
  @Test public void shouldGetStringAudience() {
  ...
  @Test public void shouldGetExpirationTime() {
  ...
  @Test public void shouldGetNotBefore() {
  ...
  @Test public void shouldGetIssuedAt() {
  ...
  @Test public void shouldGetContentType() {
  ...
  @Test public void shouldGetType() {
  ...
  @Test public void shouldGetAlgorithm() {
    DecodedJWT jwt = JWT.decode("eyJhbGciOiJIUzI1NiJ9.e30.XmNK3GpH3Ys_7wsYBfq4C3M6goz71I7dTgUkuIa5lyQ");
    assertThat(jwt, is(notNullValue()));
    assertThat(jwt.getAlgorithm(), is("HS256"));
  }

  @Test public void shouldGetMissingClaimIfClaimDoesNotExist() {
  ...
  @Test public void shouldGetValidClaim() {
  ...
  @Test public void shouldNotGetNullClaimIfClaimIsEmptyObject() {
  ...
  @Test public void shouldGetCustomClaimOfTypeInteger() {
  ...
  @Test public void shouldGetCustomClaimOfTypeDouble() {
  ...
  @Test public void shouldGetCustomClaimOfTypeBoolean() {
  ...
  @Test public void shouldGetCustomClaimOfTypeDate() {
  ...
  @Test public void shouldGetCustomClaimOfTypeInstant() {
    String token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoxNDc4ODkxNTIxfQ.mhioumeok8fghQEhTKF3QtQAksSvZ_9wIhJmgZLhJ6c";
  ...
  @Test public void shouldGetCustomArrayClaimOfTypeString() {
  ...
  @Test public void shouldGetCustomArrayClaimOfTypeInteger() {
  ...
  @Test public void shouldGetCustomMapClaim() {
  ...
  @Test public void shouldGetCustomNullClaim() {
  ...
  @Test public void shouldGetListClaim() {
  ...
  @Test public void shouldGetAvailableClaims() {
  ...
  @Test public void shouldSerializeAndDeserialize() throws Exception {
    ...
    assertThat(originalJwt.getClaims().get("extraClaim").asString(), is(equalTo(deserializedJwt.getClaims().get("extraClaim").asString())));
  }

  @Test public void shouldDecodeHeaderClaims() {
