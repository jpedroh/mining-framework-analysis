...
public class JWTCreatorTest {
  ...
  @Test public void shouldThrowWhenRequestingSignWithoutAlgorithm() {
    exception.expect(IllegalArgumentException.class);
    exception.expectMessage("The Algorithm cannot be null");
    JWTCreator.init().sign(null);
  }

  @Test public void shouldAddHeaderClaim() {
  ...
  @Test public void shouldReturnBuilderIfNullMapIsProvided() {
    String signed = JWTCreator.init().withHeader(null).sign(Algorithm.HMAC256("secret"));
    assertThat(signed, is(notNullValue()));
  }

  @Test public void shouldOverwriteExistingHeaderIfHeaderMapContainsTheSameKey() {
    Map<String, Object> header = new HashMap<>();
  ...
  @Test public void shouldOverwriteExistingHeadersWhenSettingSameHeaderKey() {
    Map<String, Object> header = new HashMap<>();
    header.put(PublicClaims.KEY_ID, "xyz");
  ...
  @Test public void shouldRemoveHeaderIfTheValueIsNull() {
    Map<String, Object> header = new HashMap<>();
  ...
  @Test public void shouldAddKeyId() {
  ...
  @Test public void shouldAddKeyIdIfAvailableFromRSAAlgorithms() throws Exception {
  ...
  @Test public void shouldNotOverwriteKeyIdIfAddedFromRSAAlgorithms() throws Exception {
    RSAPrivateKey privateKey = (RSAPrivateKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_RSA, "RSA");
    RSAKeyProvider provider = mock(RSAKeyProvider.class);
    when(provider.getPrivateKeyId()).thenReturn("my-key-id");
    when(provider.getPrivateKey()).thenReturn(privateKey);
  ...
  @Test public void shouldAddKeyIdIfAvailableFromECDSAAlgorithms() throws Exception {
  ...
  @Test public void shouldNotOverwriteKeyIdIfAddedFromECDSAAlgorithms() throws Exception {
    ECPrivateKey privateKey = (ECPrivateKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_EC_256, "EC");
    ECDSAKeyProvider provider = mock(ECDSAKeyProvider.class);
    when(provider.getPrivateKeyId()).thenReturn("my-key-id");
    when(provider.getPrivateKey()).thenReturn(privateKey);
  ...
  @Test public void shouldAddIssuer() {
  ...
  @Test public void shouldAddSubject() {
  ...
  @Test public void shouldAddAudience() {
  ...
  @Test public void shouldAddExpiresAt() {
  ...
  @Test public void shouldAddExpiresAtInstant() {
    String signed = JWTCreator.init().withExpiresAt(Instant.ofEpochSecond(1477592)).sign(Algorithm.HMAC256("secret"));
    System.out.println(signed);
    assertThat(signed, is(notNullValue()));
    assertThat(TokenUtils.splitToken(signed)[1], is("eyJleHAiOjE0Nzc1OTJ9"));
  }

  @Test public void shouldAddNotBefore() {
  ...
  @Test public void shouldAddNotBeforeInstant() {
    String signed = JWTCreator.init().withNotBefore(Instant.ofEpochSecond(1477592)).sign(Algorithm.HMAC256("secret"));
    assertThat(signed, is(notNullValue()));
    assertThat(TokenUtils.splitToken(signed)[1], is("eyJuYmYiOjE0Nzc1OTJ9"));
  }

  @Test public void shouldAddIssuedAt() {
  ...
  @Test public void shouldAddIssuedAtInstant() {
    String signed = JWTCreator.init().withIssuedAt(Instant.ofEpochSecond(1477592)).sign(Algorithm.HMAC256("secret"));
    assertThat(signed, is(notNullValue()));
    assertThat(TokenUtils.splitToken(signed)[1], is("eyJpYXQiOjE0Nzc1OTJ9"));
  }

  @Test public void shouldAddJWTId() {
  ...
  @Test public void shouldSetDefaultTypeInTheHeader() {
    String signed = JWTCreator.init().sign(Algorithm.HMAC256("secret"));
    assertThat(signed, is(notNullValue()));
    String[] parts = signed.split("\\.");
    String headerJson = new String(Base64.getUrlDecoder().decode(parts[0]), StandardCharsets.UTF_8);
  ...
  @Test public void shouldSetCustomTypeInTheHeader() {
  ...
  @Test public void shouldSetEmptySignatureIfAlgorithmIsNone() {
  ...
  @Test public void shouldAcceptCustomClaimOfTypeString() {
  ...
  @Test public void shouldAcceptCustomClaimOfTypeInteger() {
  ...
  @Test public void shouldAcceptCustomClaimOfTypeLong() {
  ...
  @Test public void shouldAcceptCustomClaimOfTypeDouble() {
  ...
  @Test public void shouldAcceptCustomClaimOfTypeBoolean() {
  ...
  @Test public void shouldAcceptCustomClaimOfTypeDate() {
  ...
  @Test public void shouldAcceptCustomClaimOfTypeDateInstant() {
    Instant instant = Instant.ofEpochSecond(1478891521);
    String jwt = JWTCreator.init().withClaim("name", instant).sign(Algorithm.HMAC256("secret"));
    assertThat(jwt, is(notNullValue()));
    String[] parts = jwt.split("\\.");
    assertThat(parts[1], is("eyJuYW1lIjoxNDc4ODkxNTIxfQ"));
  }

  @Test public void shouldAcceptCustomArrayClaimOfTypeString() {
  ...
  @Test public void shouldAcceptCustomArrayClaimOfTypeInteger() {
  ...
  @Test public void shouldAcceptCustomArrayClaimOfTypeLong() {
  ...
  @Test public void shouldAcceptCustomClaimOfTypeMap() {
  ...
  @Test public void shouldRefuseCustomClaimOfTypeUserPojo() {
    Map<String, Object> data = new HashMap<>();
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void shouldAcceptCustomMapClaimOfBasicObjectTypes() throws Exception {
    Map<String, Object> data = new HashMap<>();
    data.put("string", "abc");
    data.put("integer", 1);
  ...
  @SuppressWarnings(value = { "unchecked" }) @Test public void shouldAcceptCustomListClaimOfBasicObjectTypes() throws Exception {
  ...
  @Test public void shouldAcceptCustomClaimForNullListItem() {
    Map<String, Object> data = new HashMap<>();
    data.put("test1", Arrays.asList("a", null, "c"));
    JWTCreator.init().withClaim("pojo", data).sign(Algorithm.HMAC256("secret"));
  }

  @Test public void shouldRefuseCustomClaimForNullMapKey() {
    Map<String, Object> data = new HashMap<>();
  ...
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) @Test public void shouldRefuseCustomMapClaimForNonStringKey() {
  ...
  @Test public void shouldRefuseCustomListClaimForUnknownListElement() {
  ...
  @Test public void shouldRefuseCustomListClaimForUnknownArrayType() {
  ...
  @Test public void withPayloadShouldAddBasicClaim() {
    Map<String, Object> payload = new HashMap<>();
    payload.put("asd", 123);
    String jwt = JWTCreator.init().withPayload(payload).sign(Algorithm.HMAC256("secret"));
    assertThat(jwt, is(notNullValue()));
    String[] parts = jwt.split("\\.");
  ...
  @Test public void withPayloadShouldCreateJwtWithEmptyBodyIfPayloadNull() {
    String jwt = JWTCreator.init().withPayload(null).sign(Algorithm.HMAC256("secret"));
    assertThat(jwt, is(notNullValue()));
    String[] parts = jwt.split("\\.");
    String payloadJson = new String(Base64.getUrlDecoder().decode(parts[1]), StandardCharsets.UTF_8);
  ...
  @Test public void withPayloadShouldOverwriteExistingClaimIfPayloadMapContainsTheSameKey() {
    Map<String, Object> payload = new HashMap<>();
    payload.put(PublicClaims.KEY_ID, "xyz");
    String jwt = JWTCreator.init().withKeyId("abc").withPayload(payload).sign(Algorithm.HMAC256("secret"));
    assertThat(jwt, is(notNullValue()));
    String[] parts = jwt.split("\\.");
    String payloadJson = new String(Base64.getUrlDecoder().decode(parts[1]), StandardCharsets.UTF_8);
  ...
  @Test public void shouldOverwriteExistingPayloadWhenSettingSamePayloadKey() {
    Map<String, Object> payload = new HashMap<>();
    payload.put(PublicClaims.ISSUER, "xyz");
    String jwt = JWTCreator.init().withPayload(payload).withIssuer("abc").sign(Algorithm.HMAC256("secret"));
    assertThat(jwt, is(notNullValue()));
    String[] parts = jwt.split("\\.");
    String payloadJson = new String(Base64.getUrlDecoder().decode(parts[1]), StandardCharsets.UTF_8);
  ...
  @Test public void withPayloadShouldNotAllowCustomType() {
    ...
    JWTCreator.init().withPayload(payload).sign(Algorithm.HMAC256("secret"));
  }

  @Test public void withPayloadShouldAllowNullListItems() {
    Map<String, Object> payload = new HashMap<>();
  ...
  @Test public void withPayloadShouldNotAllowListWithCustomType() {
    exception.expect(IllegalArgumentException.class);
    exception.expectMessage("Claim values must only be of types Map, List, Boolean, Integer, Long, Double, String, Date and Null");
    Map<String, Object> payload = new HashMap<>();
  ...
  @Test public void withPayloadShouldNotAllowMapWithCustomType() {
    exception.expect(IllegalArgumentException.class);
    exception.expectMessage("Claim values must only be of types Map, List, Boolean, Integer, Long, Double, String, Date and Null");
    Map<String, Object> payload = new HashMap<>();
    payload.put("entry", "value");
  ...
  @Test public void withPayloadShouldAllowNestedSupportedTypes() {
  ...
  @Test public void withPayloadShouldSupportNullValuesEverywhere() {
    ...
    String jwt = JWTCreator.init().withPayload(payload).withHeader(payload).sign(Algorithm.HMAC256("secret"));
    assertThat(jwt, is(notNullValue()));
    String[] parts = jwt.split("\\.");
    String payloadJson = new String(Base64.getUrlDecoder().decode(parts[1]), StandardCharsets.UTF_8);
    String headerJson = new String(Base64.getUrlDecoder().decode(parts[0]), StandardCharsets.UTF_8);
