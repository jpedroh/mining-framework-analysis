...
public class UriDecoder {
   ...
   */
  protected static List<QueryOption> splitAndDecodeOptions(final String queryOptionString) throws UriParserSyntaxException {
    ...
    for (final String option : splitSkipEmpty(queryOptionString, '&')) {
      ...
      queryOptions.add(new CustomQueryOptionImpl().setName(decode(pair.get(0))).setText(decode(pair.get(1))));
    }
    return queryOptions;
  }
