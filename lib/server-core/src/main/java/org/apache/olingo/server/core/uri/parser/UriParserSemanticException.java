...
public class UriParserSemanticException extends UriParserException {
  ...
  public UriParserSemanticException(final String developmentMessage, final MessageKey messageKey, final String... parameters) {
    super(developmentMessage, messageKey, parameters);
  }

  public UriParserSemanticException(final String developmentMessage, final Throwable cause, final MessageKey messageKey, final String... parameters) {
