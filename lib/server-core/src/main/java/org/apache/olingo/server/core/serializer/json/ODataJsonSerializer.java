...
public class ODataJsonSerializer extends AbstractODataSerializer {
  ...
  @Override public SerializerResult metadataDocument(final ServiceMetadata serviceMetadata) throws SerializerException {
    throw new SerializerException("Metadata in JSON format not supported!", SerializerException.MessageKeys.JSON_METADATA);
  }
  ...
  @Override public SerializerResult entityCollection(final ServiceMetadata metadata, final EdmEntityType entityType, final AbstractEntityCollection entitySet, final EntityCollectionSerializerOptions options) throws SerializerException {
    ...
    try {
      ...
      if (options == null) {
        ...
        writeEntitySet(metadata, entityType, entitySet, contextURL, options.getExpand(), options.getSelect(), options.getWriteOnlyReferences(), json);
      }
  ...
  public void entityCollectionIntoStream(final ServiceMetadata metadata, final EdmEntityType entityType, final EntityIterator entitySet, final EntityCollectionSerializerOptions options, final OutputStream outputStream) throws SerializerException {
    ...
    try {
      ...
      if (options == null) {
        ...
        writeEntitySet(metadata, entityType, entitySet, options.getExpand(), options.getSelect(), options.getWriteOnlyReferences(), json);
      }
      json.close();
    } catch (final IOException e) {
      cachedException = new SerializerException(IO_EXCEPTION_TEXT, e, SerializerException.MessageKeys.IO_EXCEPTION);
  ...
  @Override public SerializerResult entity(final ServiceMetadata metadata, final EdmEntityType entityType, final Entity entity, final EntitySerializerOptions options) throws SerializerException {
    ...
    try {
      ...
      outputStream = buffer.getOutputStream();
      JsonGenerator json = new JsonFactory().createGenerator(outputStream);
      writeEntity(metadata, entityType, entity, contextURL, options == null ? null : options.getExpand(), options == null ? null : options.getSelect(), options == null ? false : options.getWriteOnlyReferences(), true, json);
      json.close();
      outputStream.close();
      return SerializerResultImpl.with().content(buffer.getInputStream()).build();
    } catch (final IOException e) {
  ...
  public void writeEntity(final ServiceMetadata metadata, final EdmEntityType entityType, final Entity entity, final ContextURL contextURL, final ExpandOption expand, final SelectOption select, final boolean onlyReference, final boolean isTopEntity, final JsonGenerator json) throws IOException, SerializerException {
    json.writeStartObject();
    if (!isODataMetadataNone) {
      if (isTopEntity) {
        writeContextURL(contextURL, json);
    ...
    if (onlyReference) {
      ...
      if (!isODataMetadataNone && !resolvedType.equals(entityType)) {
        ...
        if (isODataMetadataFull) {
          json.writeStringField(Constants.JSON_TYPE, "#" + resolvedType.getFullQualifiedName().getFullQualifiedNameAsString());
        }
      }

<<<<<<< /usr/src/app/output/apache/olingo-odata4/dc30c51de9b626a3d5376bde2ca8bb8af12ecfa3/lib/server-core/src/main/java/org/apache/olingo/server/core/serializer/json/ODataJsonSerializer.java/left.java
...
>>>>>>> /usr/src/app/output/apache/olingo-odata4/dc30c51de9b626a3d5376bde2ca8bb8af12ecfa3/lib/server-core/src/main/java/org/apache/olingo/server/core/serializer/json/ODataJsonSerializer.java/right.java
  ...
  protected void writeNavigationProperties(final ServiceMetadata metadata, final EdmStructuredType type, final Linked linked, final ContextURL contextURL, final ExpandOption expand, final JsonGenerator json) throws SerializerException, IOException {
    if (ExpandSelectHelper.hasExpand(expand)) {
      final boolean expandAll = ExpandSelectHelper.isExpandAll(expand);
      final Set<String> expanded = expandAll ? new HashSet<String>() : ExpandSelectHelper.getExpandedPropertyNames(expand.getExpandItems());
      for (final String propertyName : type.getNavigationPropertyNames()) {
        if (expandAll || expanded.contains(propertyName)) {
          ...
          final ExpandItem innerOptions = expandAll ? null : ExpandSelectHelper.getExpandItem(expand.getExpandItems(), propertyName);
          if (innerOptions != null && innerOptions.getLevelsOption() != null) {
            throw new SerializerException("Expand option $levels is not supported.", SerializerException.MessageKeys.NOT_IMPLEMENTED);
          }
          writeExpandedNavigationProperty(metadata, property, contextURL, navigationLink, innerOptions == null ? null : innerOptions.getExpandOption(), innerOptions == null ? null : innerOptions.getSelectOption(), innerOptions == null ? null : innerOptions.getCountOption(), innerOptions == null ? false : innerOptions.hasCountPath(), innerOptions == null ? false : innerOptions.isRef(), json);
        }
      }
    } else {
  ...
  protected void writeExpandedNavigationProperty(final ServiceMetadata metadata, final EdmNavigationProperty property, final ContextURL contextURL, final Link navigationLink, final ExpandOption innerExpand, final SelectOption innerSelect, final CountOption innerCount, final boolean writeOnlyCount, final boolean writeOnlyRef, final JsonGenerator json) throws IOException, SerializerException {
...
<<<<<<< /usr/src/app/output/apache/olingo-odata4/dc30c51de9b626a3d5376bde2ca8bb8af12ecfa3/lib/server-core/src/main/java/org/apache/olingo/server/core/serializer/json/ODataJsonSerializer.java/left.java
        if (navigationLink == null || navigationLink.getInlineEntitySet() == null) {
          ...
          json.writeFieldName(property.getName());
          writeEntitySet(metadata, property.getType(), navigationLink.getInlineEntitySet(), innerExpand, innerSelect, writeOnlyRef, json);
        }
=======
        writeEntitySet(metadata, property.getType(), navigationLink.getInlineEntitySet(), contextURL, innerExpand, innerSelect, false, json);
>>>>>>> /usr/src/app/output/apache/olingo-odata4/dc30c51de9b626a3d5376bde2ca8bb8af12ecfa3/lib/server-core/src/main/java/org/apache/olingo/server/core/serializer/json/ODataJsonSerializer.java/right.java
      }
    } else {
      json.writeFieldName(property.getName());
      if (navigationLink == null || navigationLink.getInlineEntity() == null) {
        ...
        writeEntity(metadata, property.getType(), navigationLink.getInlineEntity(), contextURL, innerExpand, innerSelect, 
<<<<<<< /usr/src/app/output/apache/olingo-odata4/dc30c51de9b626a3d5376bde2ca8bb8af12ecfa3/lib/server-core/src/main/java/org/apache/olingo/server/core/serializer/json/ODataJsonSerializer.java/left.java
        writeOnlyRef
=======
        false
>>>>>>> /usr/src/app/output/apache/olingo-odata4/dc30c51de9b626a3d5376bde2ca8bb8af12ecfa3/lib/server-core/src/main/java/org/apache/olingo/server/core/serializer/json/ODataJsonSerializer.java/right.java
  ...
  protected void writeProperty(final ServiceMetadata metadata, final EdmProperty edmProperty, final Property property, final Set<List<String>> selectedPaths, final JsonGenerator json) throws IOException, SerializerException {
    if (isODataMetadataFull) {
      ...
      if (edmProperty.isPrimitive()) {
        ...
        if (edmProperty.isCollection()) {
          json.writeStringField(key, "#Collection(" + edmProperty.getType().getFullQualifiedName().getFullQualifiedNameAsString() + ")");
        } else {
  ...
  private void writePrimitive(final EdmPrimitiveType type, final Property property, final Boolean isNullable, final Integer maxLength, final Integer precision, final Integer scale, final Boolean isUnicode, final JsonGenerator json) throws EdmPrimitiveTypeException, IOException, SerializerException {
    if (property.isPrimitive()) {
      writePrimitiveValue(type, property.asPrimitive(), isNullable, maxLength, precision, scale, isUnicode, json);
    } else {
      if (property.isGeospatial()) {
        throw new SerializerException("Property type not yet supported!", SerializerException.MessageKeys.UNSUPPORTED_PROPERTY_TYPE, property.getName());
      } else {
        if (property.isEnum()) {
          writePrimitiveValue(type, property.asEnum(), isNullable, maxLength, precision, scale, isUnicode, json);
        } else {
  ...
  protected void writePrimitiveValue(final EdmPrimitiveType type, final Object primitiveValue, final Boolean isNullable, final Integer maxLength, final Integer precision, final Integer scale, final Boolean isUnicode, final JsonGenerator json) throws EdmPrimitiveTypeException, IOException {
...
>>>>>>> /usr/src/app/output/apache/olingo-odata4/dc30c51de9b626a3d5376bde2ca8bb8af12ecfa3/lib/server-core/src/main/java/org/apache/olingo/server/core/serializer/json/ODataJsonSerializer.java/right.java
  ...
  @Override public SerializerResult complex(final ServiceMetadata metadata, final EdmComplexType type, final Property property, final ComplexSerializerOptions options) throws SerializerException {
    ...
    try {
      ...
      if (!property.isNull() && property.isComplex()) {
        writeNavigationProperties(metadata, type, property.asComplex(), contextURL, options == null ? null : options.getExpand(), json);
      }
      json.writeEndObject();
      json.close();
      outputStream.close();
  ...
  @Override public SerializerResult complexCollection(final ServiceMetadata metadata, final EdmComplexType type, final Property property, final ComplexSerializerOptions options) throws SerializerException {
    ...
    try {
      ...
      writeMetadataETag(metadata, json);
      if (isODataMetadataFull) {
        json.writeStringField(Constants.JSON_TYPE, "#Collection(" + type.getFullQualifiedName().getFullQualifiedNameAsString() + ")");
      }
      json.writeFieldName(Constants.VALUE);
  ...
  void writeMetadataETag(final ServiceMetadata metadata, final JsonGenerator json) throws IOException {
    if (!isODataMetadataNone && metadata != null && metadata.getServiceMetadataETagSupport() != null && metadata.getServiceMetadataETagSupport().getMetadataETag() != null) {
      json.writeStringField(Constants.JSON_METADATA_ETAG, metadata.getServiceMetadataETagSupport().getMetadataETag());
    }
  }
  ...
  private boolean isODataIEEE754Compatible(final ContentType contentType) {
    return contentType.getParameters().containsKey(ContentType.PARAMETER_IEEE754_COMPATIBLE) && Boolean.TRUE.toString().equalsIgnoreCase(contentType.getParameter(ContentType.PARAMETER_IEEE754_COMPATIBLE).toLowerCase());
  }
}