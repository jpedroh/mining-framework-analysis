...
public class ContainerProvider {
  ...
  CsdlEntityContainerInfo entityContainerInfoTest1 = new CsdlEntityContainerInfo().setContainerName(nameContainer);
  ...
  public CsdlEntityContainerInfo getEntityContainerInfo(final FullQualifiedName entityContainerName) throws ODataException {
    if (entityContainerName == null) {
      ...
      if (entityContainerName.equals(nameContainer)) {
        return entityContainerInfoTest1;
      }
    }
    return null;
  ...
  public CsdlEntitySet getEntitySet(final FullQualifiedName entityContainer, final String name) throws ODataException {
    if (entityContainer == nameContainer) {
      if (name.equals("ESAllPrim")) {
        return new CsdlEntitySet().setName("ESAllPrim").setType(EntityTypeProvider.nameETAllPrim).setNavigationPropertyBindings(Arrays.asList(new CsdlNavigationPropertyBinding().setPath("NavPropertyETTwoPrimOne").setTarget("ESTwoPrim"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETTwoPrimMany").setTarget("ESTwoPrim"))).setAnnotations(Arrays.asList(new CsdlAnnotation().setTerm("Core.Description").setExpression(new CsdlConstantAnnotationExpression(ConstantAnnotationExpression.Type.String, "Contains entities with all primitive types")), new CsdlAnnotation().setTerm("Core.LongDescription").setQualifier("EnabledForEntitySet").setExpression(new CsdlConstantAnnotationExpression(ConstantAnnotationExpression.Type.String, "System Query Options: $filter, $count, $orderby, $skip, $top, $expand, $select, $format; " + "Operations: Create, Create with Deep Insert, Create with Bind Operation, Read")), new CsdlAnnotation().setTerm("Core.LongDescription").setQualifier("EnabledForEntity").setExpression(new CsdlConstantAnnotationExpression(ConstantAnnotationExpression.Type.String, "System Query Options: $expand, $select, $format; Operations: " + "Read, Update, Update with Bind Operation, Delete")), new CsdlAnnotation().setTerm("Core.LongDescription").setQualifier("EnabledNavigationProperties").setExpression(new CsdlConstantAnnotationExpression(ConstantAnnotationExpression.Type.String, "NavPropertyETTwoPrimOne, NavPropertyETTwoPrimMany"))));
      } else {
        if (name.equals("ESCollAllPrim")) {
          return new CsdlEntitySet().setName("ESCollAllPrim").setType(EntityTypeProvider.nameETCollAllPrim);
        } else {
          if (name.equals("ESTwoPrim")) {
            return new CsdlEntitySet().setName("ESTwoPrim").setType(EntityTypeProvider.nameETTwoPrim).setNavigationPropertyBindings(Arrays.asList(new CsdlNavigationPropertyBinding().setPath("NavPropertyETAllPrimOne").setTarget("ESAllPrim"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETAllPrimMany").setTarget("ESAllPrim")));
          } else {
            if (name.equals("ESMixPrimCollComp")) {
              return new CsdlEntitySet().setName("ESMixPrimCollComp").setType(EntityTypeProvider.nameETMixPrimCollComp);
            } else {
              if (name.equals("ESBase")) {
                return new CsdlEntitySet().setName("ESBase").setType(EntityTypeProvider.nameETBase);
              } else {
                if (name.equals("ESTwoBase")) {
                  return new CsdlEntitySet().setName("ESTwoBase").setType(EntityTypeProvider.nameETTwoBase);
                } else {
                  if (name.equals("ESTwoKeyTwoPrim")) {
                    return new CsdlEntitySet().setName("ESTwoKeyTwoPrim").setType(EntityTypeProvider.nameETTwoKeyTwoPrim);
                  } else {
                    if (name.equals("ESBaseTwoKeyTwoPrim")) {
                      return new CsdlEntitySet().setName("ESBaseTwoKeyTwoPrim").setType(EntityTypeProvider.nameETBaseTwoKeyTwoPrim);
                    } else {
                      if (name.equals("ESTwoBaseTwoKeyTwoPrim")) {
                        return new CsdlEntitySet().setName("ESTwoBaseTwoKeyTwoPrim").setType(EntityTypeProvider.nameETTwoBaseTwoKeyTwoPrim);
                      } else {
                        if (name.equals("ESAllKey")) {
                          return new CsdlEntitySet().setName("ESAllKey").setType(EntityTypeProvider.nameETAllKey);
                        } else {
                          if (name.equals("ESCompAllPrim")) {
                            return new CsdlEntitySet().setName("ESCompAllPrim").setType(EntityTypeProvider.nameETCompAllPrim);
                          } else {
                            if (name.equals("ESCompCollAllPrim")) {
                              return new CsdlEntitySet().setName("ESCompCollAllPrim").setType(EntityTypeProvider.nameETCompCollAllPrim);
                            } else {
                              if (name.equals("ESCompComp")) {
                                return new CsdlEntitySet().setName("ESCompComp").setType(EntityTypeProvider.nameETCompComp);
                              } else {
                                if (name.equals("ESCompCollComp")) {
                                  return new CsdlEntitySet().setName("ESCompCollComp").setType(EntityTypeProvider.nameETCompCollComp);
                                } else {
                                  if (name.equals("ESMedia")) {
                                    return new CsdlEntitySet().setName("ESMedia").setType(EntityTypeProvider.nameETMedia).setIncludeInServiceDocument(true);
                                  } else {
                                    if (name.equals("ESKeyTwoKeyComp")) {
                                      return new CsdlEntitySet().setName("ESKeyTwoKeyComp").setType(EntityTypeProvider.nameETKeyTwoKeyComp);
                                    } else {
                                      if (name.equals("ESInvisible")) {
                                        return new CsdlEntitySet().setName("ESInvisible").setIncludeInServiceDocument(false).setType(EntityTypeProvider.nameETAllPrim);
                                      } else {
                                        if (name.equals("ESServerSidePaging")) {
                                          return new CsdlEntitySet().setName("ESServerSidePaging").setType(EntityTypeProvider.nameETServerSidePaging);
                                        } else {
                                          if (name.equals("ESAllNullable")) {
                                            return new CsdlEntitySet().setName("ESAllNullable").setType(EntityTypeProvider.nameETAllNullable);
                                          } else {
                                            if (name.equals("ESKeyNav")) {
                                              return new CsdlEntitySet().setName("ESKeyNav").setType(EntityTypeProvider.nameETKeyNav).setNavigationPropertyBindings(Arrays.asList(new CsdlNavigationPropertyBinding().setPath("NavPropertyETKeyNavOne").setTarget("ESKeyNav"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETKeyNavMany").setTarget("ESKeyNav"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETTwoKeyNavOne").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETTwoKeyNavMany").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETMediaOne").setTarget("ESMedia"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETMediaMany").setTarget("ESMedia"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNav/NavPropertyETTwoKeyNavOne").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNav/NavPropertyETTwoKeyNavMany").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNav/NavPropertyETMediaOne").setTarget("ESMedia"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNav/NavPropertyETMediaMany").setTarget("ESMedia"), new CsdlNavigationPropertyBinding().setPath("PropertyCompCompNav/PropertyCompNav/NavPropertyETTwoKeyNavOne").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompCompNav/PropertyCompNav/NavPropertyETTwoKeyNavMany").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompCompNav/PropertyCompNav/NavPropertyETMediaOne").setTarget("ESMedia"), new CsdlNavigationPropertyBinding().setPath("PropertyCompCompNav/PropertyCompNav/NavPropertyETMediaMany").setTarget("ESMedia"), new CsdlNavigationPropertyBinding().setPath("ETKeyNav/PropertyCompNav/NavPropertyETTwoKeyNavMany").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("ETKeyNav/PropertyCompNav/NavPropertyETTwoKeyNavMany").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNav/com.corp.odata.test1.CTNavFiveProp/NavPropertyETTwoKeyNavMany").setTarget("ESTwoKeyNav")));
                                            } else {
                                              if (name.equals("ESTwoKeyNav")) {
                                                return new CsdlEntitySet().setName("ESTwoKeyNav").setType(EntityTypeProvider.nameETTwoKeyNav).setNavigationPropertyBindings(Arrays.asList(new CsdlNavigationPropertyBinding().setPath("NavPropertyETKeyNavOne").setTarget("ESKeyNav"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETKeyNavMany").setTarget("ESKeyNav"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETTwoKeyNavOne").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETTwoKeyNavMany").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNav/NavPropertyETTwoKeyNavOne").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNav/NavPropertyETTwoKeyNavMany").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNav/NavPropertyETKeyNavOne").setTarget("ESKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNav/NavPropertyETKeyNavMany").setTarget("ESKeyNav"), new CsdlNavigationPropertyBinding().setPath("CollPropertyCompNav/NavPropertyETTwoKeyNavOne").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("CollPropertyCompNav/NavPropertyETTwoKeyNavMany").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("CollPropertyCompNav/NavPropertyETMediaOne").setTarget("ESMedia"), new CsdlNavigationPropertyBinding().setPath("CollPropertyCompNav/NavPropertyETMediaMany").setTarget("ESMedia"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETTwoBaseTwoKeyNavOne").setTarget("ESBaseTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("ETBaseTwoKeyNav/CollPropertyCompNav/NavPropertyETTwoKeyNavMany").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("ETBaseTwoKeyNav/NavPropertyETTwoBaseTwoKeyNavOne").setTarget("ESBaseTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("NavPropertySINav").setTarget("SINav")));
                                              } else {
                                                if (name.equals("ESKeyNavCont")) {
                                                  return new CsdlEntitySet().setName("ESKeyNavCont").setType(EntityTypeProvider.nameETKeyNavCont).setNavigationPropertyBindings(Arrays.asList(new CsdlNavigationPropertyBinding().setPath("NavPropertyETTwoKeyNavContOne/NavPropertyETKeyNavOne").setTarget("ESKeyNav"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETTwoKeyNavContMany/NavPropertyETKeyNavOne").setTarget("ESKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNavCont/NavPropertyETKeyNavContMany/NavPropertyETKeyNavOne").setTarget("ESKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNavCont/NavPropertyETKeyNavContOne/NavPropertyETKeyNavOne").setTarget("ESKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNavCont/NavPropertyETTwoKeyNavContMany/NavPropertyETKeyNavOne").setTarget("ESKeyNav"), new CsdlNavigationPropertyBinding().setPath("PropertyCompNavCont/NavPropertyETTwoKeyNavContOne/NavPropertyETKeyNavOne").setTarget("ESKeyNav")));
                                                } else {
                                                  if (name.equals("ESBaseTwoKeyNav")) {
                                                    return new CsdlEntitySet().setName("ESBaseTwoKeyNav").setType(EntityTypeProvider.nameETBaseTwoKeyNav).setNavigationPropertyBindings(Arrays.asList(new CsdlNavigationPropertyBinding().setPath("NavPropertyETKeyNavMany").setTarget("ESKeyNav")));
                                                  } else {
                                                    if (name.equals("ESTwoBaseTwoKeyNav")) {
                                                      return new CsdlEntitySet().setName("ESTwoBaseTwoKeyNav").setType(EntityTypeProvider.nameETTwoBaseTwoKeyNav);
                                                    } else {
                                                      if (name.equals("ESCompMixPrimCollComp")) {
                                                        return new CsdlEntitySet().setName("ESCompMixPrimCollComp").setType(EntityTypeProvider.nameETCompMixPrimCollComp);
                                                      } else {
                                                        if (name.equals("ESFourKeyAlias")) {
                                                          return new CsdlEntitySet().setName("ESFourKeyAlias").setType(EntityTypeProvider.nameETFourKeyAlias);
                                                        } else {
                                                          if (name.equals("ESMixEnumDefCollComp")) {
                                                            return new CsdlEntitySet().setName("ESMixEnumDefCollComp").setType(EntityTypeProvider.nameETMixEnumDefCollComp);
                                                          }
                                                        }
                                                      }
                                                    }
  ...
  public CsdlFunctionImport getFunctionImport(final FullQualifiedName entityContainer, final String name) throws ODataException {
    if (entityContainer.equals(nameContainer)) {
      if (name.equals("FINRTInt16")) {
        return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFNRTInt16).setIncludeInServiceDocument(true);
      } else {
        if (name.equals("FINInvisibleRTInt16")) {
          return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFNRTInt16);
        } else {
          if (name.equals("FINInvisible2RTInt16")) {
            return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFNRTInt16);
          } else {
            if (name.equals("FICRTETKeyNav")) {
              return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTETKeyNav);
            } else {
              if (name.equals("FICRTESTwoKeyNav")) {
                return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTETTwoKeyNav).setEntitySet(entityContainer.getFullQualifiedNameAsString() + "/ESTwoKeyNav").setIncludeInServiceDocument(true);
              } else {
                if (name.equals("FICRTETTwoKeyNavParam")) {
                  return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTETTwoKeyNavParam).setIncludeInServiceDocument(true);
                } else {
                  if (name.equals("FICRTStringTwoParam")) {
                    return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTStringTwoParam).setIncludeInServiceDocument(true);
                  } else {
                    if (name.equals("FICRTCollStringTwoParam")) {
                      return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTCollStringTwoParam).setIncludeInServiceDocument(true);
                    } else {
                      if (name.equals("FICRTCTAllPrimTwoParam")) {
                        return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTCTAllPrimTwoParam).setIncludeInServiceDocument(true);
                      } else {
                        if (name.equals("FICRTESMixPrimCollCompTwoParam")) {
                          return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTESMixPrimCollCompTwoParam).setIncludeInServiceDocument(true);
                        } else {
                          if (name.equals("FINRTCollETMixPrimCollCompTwoParam")) {
                            return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFNRTCollETMixPrimCollCompTwoParam).setIncludeInServiceDocument(true);
                          } else {
                            if (name.equals("FICRTCollETMixPrimCollCompTwoParam")) {
                              return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTCollETMixPrimCollCompTwoParam).setIncludeInServiceDocument(true);
                            } else {
                              if (name.equals("FICRTCollCTTwoPrim")) {
                                return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTCollCTTwoPrim).setIncludeInServiceDocument(true);
                              } else {
                                if (name.equals("FICRTESMedia")) {
                                  return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTETMedia).setEntitySet(entityContainer.getFullQualifiedNameAsString() + "/ESMedia").setIncludeInServiceDocument(true);
                                } else {
                                  if (name.equals("FICRTCollESMedia")) {
                                    return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTCollETMedia).setEntitySet(entityContainer.getFullQualifiedNameAsString() + "/ESMedia").setIncludeInServiceDocument(true);
                                  } else {
                                    if (name.equals("FICRTCTTwoPrimTwoParam")) {
                                      return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTCTTwoPrimTwoParam).setIncludeInServiceDocument(true);
                                    } else {
                                      if (name.equals("FICRTCTTwoPrim")) {
                                        return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTCTTwoPrim).setIncludeInServiceDocument(true);
                                      } else {
                                        if (name.equals("FICRTCollString")) {
                                          return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTCollString).setIncludeInServiceDocument(true);
                                        } else {
                                          if (name.equals("FICRTString")) {
                                            return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTString).setIncludeInServiceDocument(true);
                                          } else {
                                            if (name.equals("FICRTCollESTwoKeyNavParam")) {
                                              return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTCollETTwoKeyNavParam).setEntitySet(entityContainer.getFullQualifiedNameAsString() + "/ESTwoKeyNav").setIncludeInServiceDocument(true);
                                            } else {
                                              if (name.equals("FICRTCollCTTwoPrimTwoParam")) {
                                                return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTCollCTTwoPrimTwoParam).setIncludeInServiceDocument(true);
                                              } else {
                                                if (name.equals("FINRTCollCTNavFiveProp")) {
                                                  return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFNRTCollCTNavFiveProp).setIncludeInServiceDocument(true);
                                                } else {
                                                  if (name.equals("FICRTCollESKeyNavContParam")) {
                                                    return new CsdlFunctionImport().setName(name).setFunction(FunctionProvider.nameUFCRTCollETKeyNavContParam).setEntitySet("ESKeyNavCont").setIncludeInServiceDocument(true);
                                                  }
                                                }
                                              }
                                            }
  ...
  public CsdlSingleton getSingleton(final FullQualifiedName entityContainer, final String name) throws ODataException {
    if (entityContainer.equals(nameContainer)) {
      if (name.equals("SI")) {
        return new CsdlSingleton().setName("SI").setType(EntityTypeProvider.nameETTwoPrim);
      } else {
        if (name.equals("SINav")) {
          return new CsdlSingleton().setName("SINav").setType(EntityTypeProvider.nameETTwoKeyNav).setNavigationPropertyBindings(Arrays.asList(new CsdlNavigationPropertyBinding().setPath("NavPropertyETTwoKeyNavMany").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETTwoKeyNavOne").setTarget("ESTwoKeyNav"), new CsdlNavigationPropertyBinding().setPath("NavPropertyETKeyNavOne").setTarget("ESKeyNav")));
        } else {
          if (name.equals("SIMedia")) {
