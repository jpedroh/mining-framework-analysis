...
public class ODataXmlDeserializerTest extends AbstractODataDeserializerTest {
  ...
  protected byte[] edmBinary(String value) throws EdmPrimitiveTypeException {
    return EdmBinary.getInstance().valueOfString(value, true, null, null, null, true, byte[].class);
  }

  protected Object edmDate(String value) throws EdmPrimitiveTypeException {
    return EdmDate.getInstance().valueOfString(value, true, null, null, null, true, EdmDate.getInstance().getDefaultType());
  }

  protected Object edmDateTimeOffset(String value) throws EdmPrimitiveTypeException {
    return EdmDateTimeOffset.getInstance().valueOfString(value, true, null, null, null, true, EdmDateTimeOffset.getInstance().getDefaultType());
  }

  protected Object edmTimeOfDay(String value) throws EdmPrimitiveTypeException {
    return EdmTimeOfDay.getInstance().valueOfString(value, true, null, null, null, true, EdmTimeOfDay.getInstance().getDefaultType());
  }
  ...
  @Test public void entitySimple() throws Exception {
    ...
    Assert.assertEquals(edmDateTimeOffset("2012-12-03T07:16:23Z"), result.getProperty("PropertyDateTimeOffset").asPrimitive());
    Assert.assertEquals(BigDecimal.valueOf(6), result.getProperty("PropertyDuration").asPrimitive());
    Assert.assertEquals(UUID.fromString("01234567-89ab-cdef-0123-456789abcdef"), result.getProperty("PropertyGuid").asPrimitive());
    Assert.assertEquals(edmTimeOfDay("03:26:05"), result.getProperty("PropertyTimeOfDay").asPrimitive());
  }

  @Test public void entitySimpleWithTypes() throws Exception {
    final EdmEntitySet edmEntitySet = entityContainer.getEntitySet("ESAllPrim");
  ...
  @Test public void entityMixPrimCollComp() throws Exception {
    ...
    Assert.assertEquals(0, result.getNavigationLinks().size());
    Assert.assertEquals(Arrays.asList("Employee1@company.example", "Employee2@company.example", "Employee3@company.example"), result.getProperty("CollPropertyString").getValue());
    Property comp = result.getProperty("PropertyComp");
  ...
  @Test public void entityWithNavigation() throws Exception {
  ...
  @Test public void primitiveProperty() throws Exception {
    ...
    String payload = "<?xml version=\'1.0\' encoding=\'UTF-8\'?>" + "<metadata:value xmlns:metadata=\"http://docs.oasis-open.org/odata/ns/metadata\">" + "234</metadata:value>";
  ...
  @Test public void primitivePropertyNull() throws Exception {
    final EdmEntitySet edmEntitySet = entityContainer.getEntitySet("ESAllPrim");
    final EdmProperty edmProperty = (EdmProperty) edmEntitySet.getEntityType().getProperty("PropertyString");
    String payload = "<?xml version=\'1.0\' encoding=\'UTF-8\'?>" + "<metadata:value xmlns:metadata=\"http://docs.oasis-open.org/odata/ns/metadata\" " + "metadata:null=\"true\"/>";
    Property result = deserializer.property(new ByteArrayInputStream(payload.getBytes()), edmProperty).getProperty();
  ...
  @Test public void primitiveCollectionProperty() throws Exception {
    ...
    String payload = "<?xml version=\'1.0\' encoding=\'UTF-8\'?>" + "<metadata:value xmlns:metadata=\"http://docs.oasis-open.org/odata/ns/metadata\"> " + "<metadata:element>Employee1@company.example</metadata:element>" + "<metadata:element>Employee2@company.example</metadata:element>" + "<metadata:element>Employee3@company.example</metadata:element>" + "</metadata:value>";
    Property result = deserializer.property(new ByteArrayInputStream(payload.getBytes()), edmProperty).getProperty();
    Assert.assertEquals(Arrays.asList("Employee1@company.example", "Employee2@company.example", "Employee3@company.example"), result.getValue());
  }
...
<<<<<<< /usr/src/app/output/apache/olingo-odata4/b1d03d6ba98677e71a9db13b27f75fab77862058/lib/server-test/src/test/java/org/apache/olingo/server/core/deserializer/xml/ODataXmlDeserializerTest.java/left.java
    new EdmPropertyImpl(edm, prop)
=======
    (EdmProperty) edmEntitySet.getEntityType().getProperty("PropertyComp")
>>>>>>> /usr/src/app/output/apache/olingo-odata4/b1d03d6ba98677e71a9db13b27f75fab77862058/lib/server-test/src/test/java/org/apache/olingo/server/core/deserializer/xml/ODataXmlDeserializerTest.java/right.java
    ;
    final String payload = "<data:PropertyComp xmlns:data=\"http://docs.oasis-open.org/odata/ns/data\" " + " xmlns:metadata=\"http://docs.oasis-open.org/odata/ns/metadata\"\n" + " metadata:type=\"#olingo.odata.test1.CTTwoPrim\">\n" + "  <data:PropertyInt16>123</data:PropertyInt16>\n" + "  <data:PropertyString metadata:null=\"true\"/>\n" + "</data:PropertyComp>";
    final Property result = deserializer.property(new ByteArrayInputStream(payload.getBytes()), edmProperty).getProperty();
  ...
  @Test public void complexCollectionProperty() throws Exception {
    ...
    Assert.assertEquals((short) 123, getCVProperty((ComplexValue) complexCollection.get(0), "PropertyInt16").asPrimitive());
    Assert.assertEquals("TEST 1", getCVProperty((ComplexValue) complexCollection.get(0), "PropertyString").asPrimitive());
    Assert.assertEquals((short) 789, getCVProperty((ComplexValue) complexCollection.get(2), "PropertyInt16").asPrimitive());
    Assert.assertEquals("TEST 3", getCVProperty((ComplexValue) complexCollection.get(2), "PropertyString").asPrimitive());
  }

  @Test public void entityReference() throws Exception {
    String payload = "<metadata:ref xmlns:metadata=\"http://docs.oasis-open.org/odata/ns/metadata\"\n" + "              metadata:context=\"http://host/service/$metadata#$ref\"\n" + "              xmlns=\"http://www.w3.org/2005/Atom\" " + "              id=\"http://host/service/Orders(10643)\" />";
    List<URI> result = deserializer.entityReferences(new ByteArrayInputStream(payload.getBytes())).getEntityReferences();
    Assert.assertEquals(1, result.size());
    Assert.assertEquals("http://host/service/Orders(10643)", result.get(0).toASCIIString());
  }

  @Test public void entityReferences() throws Exception {
