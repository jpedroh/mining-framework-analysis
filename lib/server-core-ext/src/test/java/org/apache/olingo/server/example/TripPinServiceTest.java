...
public class TripPinServiceTest {
  ...
  @Test public void testXMLInvalidChars() throws Exception {
    ...
    String expected = "<m:properties>" + "<d:AirlineCode>FM</d:AirlineCode>" + "<d:Name>Shanghai xxxAirlinexxx</d:Name>" + "<d:Picture m:null=\"true\"></d:Picture>" + "</m:properties>" + "</a:content>" + "</a:entry>";
  ...
  @Test public void testReadEntitySetWithPaging() throws Exception {
  ...
  @Test public void testReadEntityWithKey() throws Exception {
  ...
  @Test public void testReadEntityWithFullMetadata() throws Exception {
    HttpResponse response = httpGET(baseURL + "/People(\'russellwhyte\')?$format=application/json;odata.metadata=full", 200);
    JsonNode node = getJSONNode(response);
    assertEquals("#Collection(String)", node.get("Emails@odata.type").asText());
    assertEquals("Microsoft.OData.SampleService.Models.TripPin.ShareTrip", node.get("#Microsoft.OData.SampleService.Models.TripPin.ShareTrip").get("title").asText());
    assertEquals("/People(\'russellwhyte\')/Microsoft.OData.SampleService.Models.TripPin.ShareTrip", node.get("#Microsoft.OData.SampleService.Models.TripPin.ShareTrip").get("target").asText());
    assertEquals("Microsoft.OData.SampleService.Models.TripPin.GetFavoriteAirline", node.get("#Microsoft.OData.SampleService.Models.TripPin.GetFavoriteAirline").get("title").asText());
    assertEquals("/People(\'russellwhyte\')/Microsoft.OData.SampleService.Models.TripPin.GetFavoriteAirline", node.get("#Microsoft.OData.SampleService.Models.TripPin.GetFavoriteAirline").get("target").asText());
    assertEquals("Microsoft.OData.SampleService.Models.TripPin.GetFriendsTrips", node.get("#Microsoft.OData.SampleService.Models.TripPin.GetFriendsTrips(userName)").get("title").asText());
    assertEquals("/People(\'russellwhyte\')/Microsoft.OData." + "SampleService.Models.TripPin.GetFriendsTrips(userName=@userName)", node.get("#Microsoft.OData.SampleService.Models.TripPin.GetFriendsTrips(userName)").get("target").asText());
  }
  ...
  @Test public void testErrorResponse() throws Exception {
    ...
    assertEquals("{\"error\":{\"code\":null,\"message\":\"The key value \'\' is invalid.\"}}", IOUtils.toString(response.getEntity().getContent()));
  }

  @Test public void testReadEntityWithNonExistingKey() throws Exception {
    HttpResponse response = httpGET(baseURL + "/Airlines(\'OO\')", 404);
    EntityUtils.consumeQuietly(response.getEntity());
  }

  @Test public void testRead$Count() throws Exception {
    HttpResponse response = httpGET(baseURL + "/Airlines/$count", 200);
    assertEquals("15", IOUtils.toString(response.getEntity().getContent()));
  }

  @Test public void testReadPrimitiveProperty() throws Exception {
  ...
  @Test public void testReadNonExistentProperty() throws Exception {
    HttpResponse response = httpGET(baseURL + "/Airlines(\'AA\')/Unknown", 404);
    EntityUtils.consumeQuietly(response.getEntity());
  }

  @Test public void testReadPrimitiveArrayProperty() throws Exception {
  ...
  @Test public void testReadPrimitivePropertyValue() throws Exception {
  ...
  @Test public void testUpdateRawValue() throws Exception {
  ...
  @Test @Ignore public void testReadComplexProperty() throws Exception {
  }

  @Test public void testReadComplexArrayProperty() throws Exception {
  ...
  @Test public void testReadMedia() throws Exception {
    HttpResponse response = httpGET(baseURL + "/Photos(1)/$value", 200);
    EntityUtils.consumeQuietly(response.getEntity());
  }

  @Test public void testCreateMedia() throws Exception {
  ...
  @Test public void testDeleteMedia() throws Exception {
    String editUrl = baseURL + "/Photos(1)/$value";
  ...
  @Test public void testCreateStream() throws Exception {
  ...
  @Test public void testCreateStream2() throws Exception {
    String editUrl = baseURL + "/Airlines(\'AA\')/Picture";
    HttpPut request = new HttpPut(editUrl);
    request.setEntity(new ByteArrayEntity("bytecontents".getBytes(), ContentType.APPLICATION_OCTET_STREAM));
    HttpResponse response = httpSend(request, 204);
  ...
  @Test public void testDeleteStream() throws Exception {
    String editUrl = baseURL + "/Airlines(\'AA\')/Picture";
    HttpDelete request = new HttpDelete(editUrl);
    HttpResponse response = httpSend(request, 204);
    EntityUtils.consumeQuietly(response.getEntity());
  ...
  @Test public void testLambdaAny() throws Exception {
  ...
  @Test public void testSelectOption() throws Exception {
  ...
  @Test public void testActionImportWithNoResponse() throws Exception {
    HttpPost request = new HttpPost(baseURL + "/ResetDataSource");
    HttpResponse response = httpSend(request, 204);
    EntityUtils.consumeQuietly(response.getEntity());
  }

  @Test public void testAllowHeader() throws Exception {
  ...
  @Test public void testBadReferences() throws Exception {
    HttpResponse response = httpGET(baseURL + "/People(\'russelwhyte\')/$ref", 405);
    EntityUtils.consumeQuietly(response.getEntity());
  }

  @Test public void testReadReferences() throws Exception {
  ...
  @Test public void testEntityId() throws Exception {
    HttpResponse response = httpGET(baseURL + "/$entity?$id=" + baseURL + "/People(\'kristakemp\')&$select=FirstName", 200);
    JsonNode node = getJSONNode(response);
  ...
  @Test public void testCreateReadDeleteEntity() throws Exception {
  ...
  @Test public void testUpdateEntity() throws Exception {
  ...
  @Test public void testDeleteEntity() throws Exception {
    HttpDelete deleteRequest = new HttpDelete(baseURL + "/People");
    HttpResponse response = httpSend(deleteRequest, 405);
    EntityUtils.consumeQuietly(response.getEntity());
  }

  @Test public void testCreateEntityWithLinkToRelatedEntities() throws Exception {
    String payload = "{\n" + "         \"UserName\":\"olingo\",\n" + "         \"FirstName\":\"Olingo\",\n" + "         \"LastName\":\"Apache\",\n" + "         \"Emails\":[\n" + "            \"olingo@apache.org\"\n" + "         ],\n" + "         \"AddressInfo\":[\n" + "            {\n" + "               \"Address\":\"100 apache Ln.\",\n" + "               \"City\":{\n" + "                  \"CountryRegion\":\"United States\",\n" + "                  \"Name\":\"Boise\",\n" + "                  \"Region\":\"ID\"\n" + "               }\n" + "            }\n" + "         ],\n" + "         \"Gender\":\"0\",\n" + "         \"Concurrency\":635585295719432047,\n" + "\"Friends@odata.bind\":[\"" + baseURL + "/People(\'russellwhyte\')\",\"" + baseURL + "/People(\'scottketchum\')\"" + "]" + "}";
    HttpPost postRequest = new HttpPost(baseURL + "/People");
    postRequest.setEntity(new StringEntity(payload, ContentType.APPLICATION_JSON));
  ...
  @Ignore(value = "4.01 style binding not supported") @Test public void testCreateEntityWithLinkToRelatedEntitiesIds() throws Exception {
    String payload = "{\n" + "         \"UserName\":\"olingo\",\n" + "         \"FirstName\":\"Olingo\",\n" + "         \"LastName\":\"Apache\",\n" + "         \"Emails\":[\n" + "            \"olingo@apache.org\"\n" + "         ],\n" + "         \"AddressInfo\":[\n" + "            {\n" + "               \"Address\":\"100 apache Ln.\",\n" + "               \"City\":{\n" + "                  \"CountryRegion\":\"United States\",\n" + "                  \"Name\":\"Boise\",\n" + "                  \"Region\":\"ID\"\n" + "               }\n" + "            }\n" + "         ],\n" + "         \"Gender\":\"0\",\n" + "         \"Concurrency\":635585295719432047,\n" + "\"Friends\":[" + "{\"@id\": \"People(\'russellwhyte\')\"},\n" + "{\"@id\": \"People(\'scottketchum\')\"}\n" + "]" + "}";
    HttpPost postRequest = new HttpPost(baseURL + "/People");
    postRequest.setEntity(new StringEntity(payload, ContentType.APPLICATION_JSON));
    postRequest.setHeader("Prefer", "return=minimal");
    HttpResponse response = httpSend(postRequest, 204);
  ...
  @Test public void testUpdatePrimitiveProperty() throws Exception {
  ...
  @Test public void testUpdatePrimitiveArrayProperty() throws Exception {
  ...
  @Test public void testDeleteProperty() throws Exception {
    String editUrl = baseURL + "/People(\'russellwhyte\')/FirstName";
    HttpResponse response = httpGET(editUrl, 200);
    JsonNode node = getJSONNode(response);
  ...
  @Test public void testReadNavigationPropertyEntityCollection() throws Exception {
  ...
  @Test public void testReadNavigationPropertyNoContainsTarget() throws Exception {
  ...
  @Test public void testReadNavigationPropertyNonExistingNavigation() throws Exception {
    String editUrl = baseURL + "/People(\'russellwhyte\')/Foobar";
    httpGET(editUrl, 404);
  }

  @Test public void testReadNavigationPropertyEntityCollection2() throws Exception {
    String editUrl = baseURL + "/People(\'russellwhyte\')/Friends(\'scottketchum\')/Trips";
    HttpResponse response = httpGET(editUrl, 200);
    JsonNode node = getJSONNode(response);
    assertEquals(baseURL + "/$metadata#People(\'russellwhyte\')/Friends(\'scottketchum\')/Trips", node.get("@odata.context").asText());
    assertTrue(node.get("value").isArray());
    assertEquals("1001", ((ArrayNode) node.get("value")).get(0).get("TripId").asText());
  }

  @Test public void testReadNavigationPropertyEntity() throws Exception {
    String editUrl = baseURL + "/People(\'russellwhyte\')/Trips(1003)";
    HttpResponse response = httpGET(editUrl, 200);
    JsonNode node = getJSONNode(response);
    assertEquals(baseURL + "/$metadata#People(\'russellwhyte\')/Trips/$entity", node.get("@odata.context").asText());
    assertEquals("f94e9116-8bdd-4dac-ab61-08438d0d9a71", node.get("ShareId").asText());
  }

  @Test public void testReadNavigationPropertyEntityNotExisting() throws Exception {
    String editUrl = baseURL + "/People(\'russellwhyte\')/Trips(9999)";
    HttpResponse response = httpGET(editUrl, 204);
    EntityUtils.consumeQuietly(response.getEntity());
  }

  @Test public void testReadNavigationPropertyEntitySetNotExisting() throws Exception {
    String editUrl = baseURL + "/People(\'jhondoe\')/Trips";
    HttpResponse response = httpGET(editUrl, 200);
    JsonNode node = getJSONNode(response);
    assertEquals(baseURL + "/$metadata#People(\'jhondoe\')/Trips", node.get("@odata.context").asText());
    assertEquals(0, ((ArrayNode) node.get("value")).size());
  }

  @Test public void testBadNavigationProperty() throws Exception {
    String editUrl = baseURL + "/People(\'russellwhyte\')/Unknown";
    HttpResponse response = httpGET(editUrl, 404);
    EntityUtils.consumeQuietly(response.getEntity());
  }

  @Test public void testReadNavigationPropertyEntityProperty() throws Exception {
    String editUrl = baseURL + "/People(\'russellwhyte\')/Trips(1003)/PlanItems(5)/ConfirmationCode";
    HttpResponse response = httpGET(editUrl, 200);
    JsonNode node = getJSONNode(response);
    assertEquals(baseURL + "/$metadata#People(\'russellwhyte\')/Trips(1003)/PlanItems(5)/ConfirmationCode", node.get("@odata.context").asText());
    assertEquals("JH58494", node.get("value").asText());
  }

  @Test public void testReadNavigationPropertyEntityMultipleDerivedTypes() throws Exception {
    String editUrl = baseURL + "/People(\'russellwhyte\')/Trips(1003)/PlanItems";
    HttpResponse response = httpGET(editUrl, 200);
    JsonNode node = getJSONNode(response);
    assertEquals(baseURL + "/$metadata#People(\'russellwhyte\')/Trips(1003)/PlanItems", node.get("@odata.context").asText());
    assertEquals("#Microsoft.OData.SampleService.Models.TripPin.Flight", ((ArrayNode) node.get("value")).get(0).get("@odata.type").asText());
  }

  @Test public void testReadNavigationPropertyEntityCoolectionDerivedFilter() throws Exception {
    String editUrl = baseURL + "/People(\'russellwhyte\')/Trips(1003)/PlanItems/Microsoft.OData.SampleService.Models.TripPin.Event";
    HttpResponse response = httpGET(editUrl, 200);
    JsonNode node = getJSONNode(response);
    assertEquals(baseURL + "/$metadata#People(\'russellwhyte\')/Trips(1003)/PlanItems/" + "Microsoft.OData.SampleService.Models.TripPin.Event", node.get("@odata.context").asText());
    assertEquals("#Microsoft.OData.SampleService.Models.TripPin.Event", ((ArrayNode) node.get("value")).get(0).get("@odata.type").asText());
  }

  @Test public void testReadNavigationPropertyEntityDerivedFilter() throws Exception {
    String editUrl = baseURL + "/People(\'russellwhyte\')/Trips(1003)/PlanItems(56)/" + "Microsoft.OData.SampleService.Models.TripPin.Event";
    HttpResponse response = httpGET(editUrl, 200);
    JsonNode node = getJSONNode(response);
    assertEquals(baseURL + "/$metadata#People(\'russellwhyte\')/Trips(1003)/PlanItems/" + "Microsoft.OData.SampleService.Models.TripPin.Event/$entity", node.get("@odata.context").asText());
  ...
  @Test public void testUpdateReference() throws Exception {
  ...
  @Test public void testAddDelete2ReferenceCollection() throws Exception {
  ...
  @Test public void testAddEntityToNavigationFailsNotEntitySet() throws Exception {
  ...
  @Test public void testAddEntityToNavigation() throws Exception {
    String msg = "{\n" + "\"Id\": 1010,\n" + "\"Name\": \"Grand Prize\"\n" + "}";
  ...
  @Test public void testAddEntityToNavigationSelf() throws Exception {
    String payload = "{\n" + "         \"UserName\":\"olingo\",\n" + "         \"FirstName\":\"Olingo\",\n" + "         \"LastName\":\"Apache\",\n" + "         \"Emails\":[\n" + "            \"olingo@apache.org\"\n" + "         ],\n" + "         \"AddressInfo\":[\n" + "            {\n" + "               \"Address\":\"100 apache Ln.\",\n" + "               \"City\":{\n" + "                  \"CountryRegion\":\"United States\",\n" + "                  \"Name\":\"Boise\",\n" + "                  \"Region\":\"ID\"\n" + "               }\n" + "            }\n" + "         ],\n" + "         \"Gender\":\"0\",\n" + "         \"Concurrency\":635585295719432047\n" + "}";
  ...
  @Test public void testDeleteReference() throws Exception {
  ...
  @Test public void crossJoin() throws Exception {
    String editUrl = baseURL + "/$crossjoin(People,Airlines)?$filter=" + "People/UserName%20eq%20Airlines/AirlineCode";
    HttpResponse response = httpGET(editUrl, 501);
    EntityUtils.consumeQuietly(response.getEntity());
  }

  @Test public void dataIsolation() throws Exception {
    String url = baseURL + "/People";
    HttpRequest request = new HttpGet(url);
  ...
  @Test public void batchAccept() throws Exception {
    final String batchtUrl = baseURL + "/$batch";
    final String content = "" + "--batch_12345" + CRLF + "Content-Type: application/http" + CRLF + "Content-Transfer-Encoding: binary" + CRLF + CRLF + "GET Airlines(\'FM\') HTTP/1.1" + CRLF + CRLF + CRLF + "--batch_12345--";
