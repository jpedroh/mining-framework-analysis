    ...
    try {
      ...
      while (propIterator.hasNext()) {
        ...
        if (!property.getDefinition().isProtected()) {
          ...
          if (PROTECTED_PROPERTIES_TO_STASH.contains(property.getName())) {
    ...
    if (tmpNode != null) {
      ...
      while (iter.hasNext()) {
        ...
        try {
          ...
          log.warn("Unable to move child back to new location at {} due to: {}. Node will remain in temporary location: {}", newPath, e.getMessage(), child.getPath());
          if (importInfo != null) {
      ...
      try {
        ...
        log.warn("Unable to restore properties at {} due to: {}. Properties will remain in temporary location: {}", path, e.getMessage(), tmpNode.getPath());
        if (importInfo != null) {
