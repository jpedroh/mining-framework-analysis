 ...
 */
public class ReuseTree<S extends java.lang.Object, I extends java.lang.Object, O extends java.lang.Object> extends AbstractGraph<ReuseNode<S, I, O>, ReuseEdge<S, I, O>> implements DOTPlottableGraph<ReuseNode<S, I, O>, ReuseEdge<S, I, O>> {
  public static class ReuseTreeBuilder<S extends java.lang.Object, I extends java.lang.Object, O extends java.lang.Object> {
  ...
  private ReuseTree(ReuseTreeBuilder<S, I, O> builder) {
    ...
    if (handler == null) {
      handler = new SystemStateHandler<S>() {
        @Override public void dispose(S state) {
        }
      };
    }
    this.systemStateHandler = handler;
    this.invariantInputSymbols = (builder.invariantInputSymbols != null) ? builder.invariantInputSymbols : Collections.<I>emptySet();
    this.failureOutputSymbols = (builder.failureOutputSymbols != null) ? builder.failureOutputSymbols : Collections.<O>emptySet();
  ...
  /**
	 ...
	 * @throws ReuseException if non deterministic behavior is detected
	 */
  public synchronized void insert(Word<I> query, ReuseNode<S, I, O> sink, QueryResult<S, O> queryResult) {
    if (queryResult == null) {
    ...
    for (int i = 0; i < query.size(); i++) {
      ...
      if (failureOutputSymbols.contains(out)) {
        ...
        if (invariantInputSymbols.contains(in)) {
          rn = sink;
        } else {
          rn = createNode();
        }
  ...
  @Override public Collection<ReuseNode<S, I, O>> getNodes() {
  ...
  @Override public synchronized Collection<ReuseEdge<S, I, O>> getOutgoingEdges(ReuseNode<S, I, O> node) {
    return node.getEdges();
  }

  @Override public synchronized ReuseNode<S, I, O> getTarget(ReuseEdge<S, I, O> edge) {
    if (edge != null) {
  ...
  @Override public synchronized GraphDOTHelper<ReuseNode<S, I, O>, ReuseEdge<S, I, O>> getGraphDOTHelper() {
