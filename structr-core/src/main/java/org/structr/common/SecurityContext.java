...
public class SecurityContext {
  ...
  public <T extends java.lang.Object> T getAttribute(String key, final T defaultValue) {
  ...
  private static class SuperUserSecurityContext extends SecurityContext {
    ...
    @Override public Principal getUser(final boolean tryLogin) {
      return new SuperUser();
    }

    @Override public Principal getCachedUser() {
      return superUser;
    }

    @Override public String getCachedUserId() {
      return Principal.SUPERUSER_ID;
    }

    @Override public String getCachedUserName() {
      return "superadmin";
    }

    @Override public AccessMode getAccessMode() {
      return (AccessMode.Backend);
    }

    @Override public boolean isReadable(final NodeInterface node, final boolean includeHidden, final boolean publicOnly) {
      return true;
    }

    @Override public boolean isVisible(AccessControllable node) {
      return true;
    }
    ...
    @Override public boolean isSuperUserSecurityContext() {
      return true;
    }
  }
}