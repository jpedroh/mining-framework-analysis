...
public class ScriptingTest extends StructrTest {
  ...
  @Test public void testSetPropertyWithDynamicNodes() {
  ...
  @Test public void testGrantViaScripting() {
    try (Tx tx = app.tx()) {
      final SchemaNode sourceNode = createTestNode(SchemaNode.class, "Source");
  ...
  @Test public void testWrappingUnwrapping() {
    try (Tx tx = app.tx()) {
      final ActionContext actionContext = new ActionContext(securityContext);
  ...
  @Test public void testEnumPropertyGet() {
    try (Tx tx = app.tx()) {
      final ActionContext actionContext = new ActionContext(securityContext);
      final TestOne context = app.create(TestOne.class);
  ...
  @Test public void testCollectionOperations() {
  ...
  @Test public void testPropertyConversion() {
    TestOne testOne = null;
    try (Tx tx = app.tx()) {
      testOne = app.create(TestOne.class);
      tx.success();
  ...
  @Test public void testVariableReplacement() {
  ...
  @Test public void testFunctionRollbackOnError() {
    final ActionContext ctx = new ActionContext(securityContext, null);
  ...
  @Test public void testPrivilegedFind() {
    final ActionContext ctx = new ActionContext(securityContext, null);
  ...
  @Test public void testDateOutput() {
    final Date now = new Date();
    final SimpleDateFormat isoDateFormat = new SimpleDateFormat("yyyy-MM-dd\'T\'HH:mm:ssZ");
    try (Tx tx = app.tx()) {
      final ActionContext ctx = new ActionContext(securityContext, null);
  ...
  @Test public void testGeoCoding() {
    try (Tx tx = app.tx()) {
      final ActionContext ctx = new ActionContext(securityContext, null);
  ...
  @Test public void testNonPrimitiveReturnValue() {
    try (Tx tx = app.tx()) {
  ...
  @Test public void testJavascriptBatchFunction() {
    try (Tx tx = app.tx()) {
  ...
  @Test public void testStructrScriptBatchFunction() {
    try (Tx tx = app.tx()) {
      createTestNodes(TestOne.class, 1000);
      tx.success();
    } catch (FrameworkException fex) {
  ...
  @Test public void testBulkDeleteWithoutBatching() {
    try (Tx tx = app.tx()) {
      createTestNodes(TestOne.class, 1000);
      tx.success();
    } catch (FrameworkException fex) {
  ...
  @Test public void testQuotesInScriptComments() {
    final String script = "${{\n" + "\n" + "\t// test\'\n" + "\tStructr.print(\'test\');\n" + "\n" + "}}";
    try (Tx tx = app.tx()) {
      final ActionContext ctx = new ActionContext(securityContext, null);
  ...
  @Test public void testNewlineAtEndOfScriptingCode() {
  ...
  @Test public void testIncludeJs() {
  ...
  @Test public void testAfterCreateMethod() {
  ...
  @Test public void testFindNewlyCreatedObjectByOwner() {
    this.cleanDatabaseAndSchema();
    String userObjects = "[";
    try (Tx tx = app.tx()) {
  ...
  @Test public void testConversionError() {
    try (Tx tx = app.tx()) {
  ...
  @Test public void testScriptCodeWithNewlines() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
  ...
  @Test public void testScriptCodeWithWhitespace() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
  ...
  @Test public void testContextStoreTransferToAndFromDoPrivileged() {
  ...
  @Test public void testCryptoFunctions() {
    this.cleanDatabaseAndSchema();
  ...
  @Test public void testFunctionPropertyTypeHint() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
    ...
    try (Tx tx = app.tx()) {
      app.create(type, new NodeAttribute<>(key1, "test1"), new NodeAttribute<>(key2, "test2"));
      tx.success();
    } catch (Throwable fex) {
      fex.printStackTrace();
      fail("Unexpected exception.");
  ...
  @Test public void testStringConcatenationInJavaScript() {
    try (Tx tx = app.tx()) {
      final ActionContext ctx = new ActionContext(securityContext);
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
      final JsonType project = schema.addType("Project");
  ...
  @Test public void testNewFindSyntaxInStructrScript() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
      schema.addType("Test");
      final JsonType project = schema.addType("Project");
    ...
    try (Tx tx = app.tx()) {
      app.create(projectType, new NodeAttribute<>(AbstractNode.name, "group1"), new NodeAttribute<>(name1, "structr"), new NodeAttribute<>(name2, "test"), new NodeAttribute<>(name3, "other"), new NodeAttribute<>(age, 22), new NodeAttribute<>(count, 100));
      app.create(projectType, new NodeAttribute<>(AbstractNode.name, "group2"), new NodeAttribute<>(name1, "structr"), new NodeAttribute<>(name2, "test"), new NodeAttribute<>(name3, "other"), new NodeAttribute<>(age, 33), new NodeAttribute<>(count, 102));
      app.create(projectType, new NodeAttribute<>(name1, "structr"), new NodeAttribute<>(name2, "other"), new NodeAttribute<>(name3, "other"), new NodeAttribute<>(age, 44), new NodeAttribute<>(count, 104));
      for (int i = 0; i < 100; i++) {
  ...
  @Test public void testAdvancedFindPrivilegedInJavaScript() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
      schema.addType("Test");
      final JsonType project = schema.addType("Project");
    ...
    String group3 = null;
    try (Tx tx = app.tx()) {
      group1 = app.create(type, new NodeAttribute<>(AbstractNode.name, "group1"), new NodeAttribute<>(name1, "structr"), new NodeAttribute<>(name2, "test"), new NodeAttribute<>(name3, "other"), new NodeAttribute<>(age, 22), new NodeAttribute<>(count, 100)).getUuid();
      group2 = app.create(type, new NodeAttribute<>(AbstractNode.name, "group2"), new NodeAttribute<>(name1, "structr"), new NodeAttribute<>(name2, "test"), new NodeAttribute<>(name3, "other"), new NodeAttribute<>(age, 33), new NodeAttribute<>(count, 102)).getUuid();
      group3 = app.create(type, new NodeAttribute<>(name1, "structr"), new NodeAttribute<>(name2, "other"), new NodeAttribute<>(name3, "other"), new NodeAttribute<>(age, 44), new NodeAttribute<>(count, 104)).getUuid();
      for (int i = 0; i < 100; i++) {
        createTestNode(testType, "test" + StringUtils.leftPad(Integer.toString(i), 3, "0"));
      }
      tx.success();
  ...
  @Test public void testAdvancedFindForRemoteProperties() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
      final JsonObjectType project = schema.addType("Project");
      final JsonObjectType task = schema.addType("Task");
  ...
  @Test public void testNewFindSyntaxInJavaScript() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
      schema.addType("Test");
      final JsonType project = schema.addType("Project");
  ...
  @Test public void testJavascriptArrayWrapping() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
  ...
  @Test public void testNamespaceHandling() {
    final ActionContext ctx = new ActionContext(securityContext);
    try (Tx tx = app.tx()) {
  ...
  @Test public void testJavascriptFindDateRange() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
      schema.addType("Test");
      final JsonType project = schema.addType("Project");
  ...
  @Test public void testDatePropertyWithNonStandardFormatInScripting() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
      schema.addType("Test");
      final JsonType project = schema.addType("Project");
  ...
  @Test public void testBatchErrorHandler() {
    final ActionContext ctx = new ActionContext(securityContext);
    try (Tx tx = app.tx()) {
  ...
  @Test public void testLoggingOfGraphObjects() {
    final ActionContext ctx = new ActionContext(securityContext);
    try (Tx tx = app.tx()) {
      app.create(Group.class, "group1");
      app.create(Group.class, "group2");
  ...
  @Test public void testAssignmentOfStringArrayProperties() {
    final ActionContext ctx = new ActionContext(securityContext);
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
    ...
    try (Tx tx = app.tx()) {
      ...
      app.create(type, new NodeAttribute<>(AbstractNode.name, "source"), new NodeAttribute<>(key, new String[] { "one", "two", "three" }));
      app.create(type, new NodeAttribute<>(AbstractNode.name, "target"));
      tx.success();
    } catch (FrameworkException fex) {
      fex.printStackTrace();
      fail("Unexpected exception.");
  ...
  @Test public void testEmptyArrayProperty() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
  ...
  @Test public void testDifferentArrayPropertyAssignmentAndPush() {
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
    ...
    try (Tx tx = app.tx()) {
      final ActionContext ac = new ActionContext(securityContext);
      Scripting.evaluate(ac, null, "${{" + "let n = $.create(\'ArrayPropertiesTest\', {name: \'emptyTest\'});" + "}}", null);
      Scripting.evaluate(ac, null, "${{" + "let n = $.create(\'ArrayPropertiesTest\', {name: \'emptyPushTest\'});" + "n.strings.push(\'test\');" + "n.ints.push(42);" + "n.doubles.push(42);" + "n.longs.push(42);" + "n.bools.push(true);" + "n.dates.push(new Date());" + "}}", null);
      Scripting.evaluate(ac, null, "${{" + "let n = $.create(\'ArrayPropertiesTest\', {name: \'emptySetTest\'});" + "n.strings = [\'a\', \'b\', \'c\'];" + "n.ints = [3, 4, 5];" + "n.doubles = [3.14, 4, 5.05];" + "n.longs = [3, 4, 5];" + "n.bools = [true, false, true];" + "n.dates = [new Date(), $.get(\'now\'), new Date()];" + "}}", null);
      Scripting.evaluate(ac, null, "${{" + "let n = $.create(\'ArrayPropertiesTest\', {name: \'setAndPushTest\'});" + "n.strings = [\'a\', \'b\', \'c\'];" + "n.strings.push(\'d\');" + "n.ints = [3, 4, 5];" + "n.ints.push(6);" + "n.doubles = [3.14, 4, 5.05];" + "n.doubles.push(6);" + "n.longs = [3, 4, 5];" + "n.longs.push(6);" + "n.bools = [true, false, true];" + "n.bools.push(false);" + "n.dates = [new Date(), $.get(\'now\'), new Date()];" + "n.dates.push(new Date());" + "}}", null);
      tx.success();
    } catch (FrameworkException ex) {
      fail();
    }
  ...
  @Test public void testAdvancedFindNamespaceHandlingWithException() {
    final ActionContext ctx = new ActionContext(securityContext);
    try (Tx tx = app.tx()) {
      final JsonSchema schema = StructrSchema.createFromDatabase(app);
      final JsonType type = schema.addType("Test");
  ...
  @Test public void testStructrScriptArrayIndexingWithVariable() {
    final ActionContext ctx = new ActionContext(securityContext);
  ...
  @Test public void testSortingByMultipleKeysInJavascript() {
    final ActionContext ctx = new ActionContext(securityContext);
    try (Tx tx = app.tx()) {
  ...
  @Test public void testSortingByMultipleKeysInStructrScriptAdvancedFind() {
    final ActionContext ctx = new ActionContext(securityContext);
    try (Tx tx = app.tx()) {
      app.create(TestOne.class, new NodeAttribute<>(AbstractNode.name, "name7"), new NodeAttribute<>(TestOne.anInt, 3), new NodeAttribute<>(TestOne.aLong, 20L));
      app.create(TestOne.class, new NodeAttribute<>(AbstractNode.name, "name5"), new NodeAttribute<>(TestOne.anInt, 2), new NodeAttribute<>(TestOne.aLong, 20L));
  ...
  @Test public void testSortingByMultipleKeysInStructrScriptNormalFind() {
    final ActionContext ctx = new ActionContext(securityContext);
    try (Tx tx = app.tx()) {
      app.create(TestOne.class, new NodeAttribute<>(AbstractNode.name, "name7"), new NodeAttribute<>(TestOne.anInt, 3), new NodeAttribute<>(TestOne.aLong, 20L));
      app.create(TestOne.class, new NodeAttribute<>(AbstractNode.name, "name5"), new NodeAttribute<>(TestOne.anInt, 2), new NodeAttribute<>(TestOne.aLong, 20L));
  ...
  @Test public void testJavaScriptQuirksDuckTypingNumericalMapIndex() {
    final ActionContext ctx = new ActionContext(securityContext);
    try (Tx tx = app.tx()) {
  ...
  @Test public void testHMCAFunction() {
    final ActionContext ctx = new ActionContext(securityContext);
    try (Tx tx = app.tx()) {
  ...
  @Test public void testSlice() {
    ...
    try (Tx tx = app.tx()) {
      ...
      assertEquals("Invalid slice() result for invalid inputs", Iterables.toList(testOne.getProperty(TestOne.manyToManyTestSixs)).toString(), Scripting.replaceVariables(ctx, testOne, "${slice(this.manyToManyTestSixs, 0, 1000)}"));
      tx.success();
    } catch (FrameworkException fex) {
      fex.printStackTrace();
    } finally {
  ...
  private void assertMapPathValueIs(final Map<String, Object> map, final String mapPath, final Object value) {
    ...
    for (int i = 0; i < parts.length; i++) {
      ...
      if (StringUtils.isNumeric(part)) {
        ...
        if ("#".equals(part) && current instanceof List) {
