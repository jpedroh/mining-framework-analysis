...
@RestController @RequestMapping(value = "/wx/cart") @Validated public class WxCartController {
  private final Log logger = LogFactory.getLog(WxCartController.class);

  @Autowired private LitemallCartService cartService;

  @Autowired private LitemallGoodsService goodsService;

  @Autowired private LitemallProductService productService;

  @Autowired private LitemallAddressService addressService;

  @Autowired private LitemallGrouponRulesService grouponRulesService;
  ...
  /**
     ...
     */
  @GetMapping(value = "index") public Object index(@LoginUser Integer userId) {
    if (userId == null) {
  ...
  /**
     ...
     * 失败则 { errno: XXX, errmsg: XXX }
     */
  @PostMapping(value = "add") public Object add(@LoginUser Integer userId, @RequestBody LitemallCart cart) {
    if (userId == null) {
      return ResponseUtil.unlogin();
    }
    if (cart == null) {
  ...
  /**
     ...
     * 失败则 { errno: XXX, errmsg: XXX }
     */
  @PostMapping(value = "fastadd") public Object fastadd(@LoginUser Integer userId, @RequestBody LitemallCart cart) {
    if (userId == null) {
      return ResponseUtil.unlogin();
    }
    if (cart == null) {
  ...
  /**
     ...
     * 失败则 { errno: XXX, errmsg: XXX }
     */
  @PostMapping(value = "update") public Object update(@LoginUser Integer userId, @RequestBody LitemallCart cart) {
    if (userId == null) {
      return ResponseUtil.unlogin();
    }
    if (cart == null) {
  ...
  /**
     ...
     * 失败则 { errno: XXX, errmsg: XXX }
     */
  @PostMapping(value = "checked") public Object checked(@LoginUser Integer userId, @RequestBody String body) {
    if (userId == null) {
      return ResponseUtil.unlogin();
    }
    if (body == null) {
  ...
  /**
     ...
     * 失败则 { errno: XXX, errmsg: XXX }
     */
  @PostMapping(value = "delete") public Object delete(@LoginUser Integer userId, @RequestBody String body) {
    if (userId == null) {
      return ResponseUtil.unlogin();
    }
    if (body == null) {
  ...
  /**
     ...
     * 失败则 { errno: XXX, errmsg: XXX }
     */
  @GetMapping(value = "goodscount") public Object goodscount(@LoginUser Integer userId) {
    if (userId == null) {
  ...
  /**
     ...
     * 失败则 { errno: XXX, errmsg: XXX }
     */
  @GetMapping(value = "checkout") public Object checkout(@LoginUser Integer userId, Integer cartId, Integer addressId, Integer couponId, Integer grouponRulesId) {
    if (userId == null) {
      return ResponseUtil.unlogin();
    }
  ...
  /**
     ...
     * 失败则 { errno: XXX, errmsg: XXX }
     */
  @GetMapping(value = "checkedCouponList") public Object checkedCouponList(@LoginUser Integer userId) {
    if (userId == null) {
      return ResponseUtil.unlogin();
    }
