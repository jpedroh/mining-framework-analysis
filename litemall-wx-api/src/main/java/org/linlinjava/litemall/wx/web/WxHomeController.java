 ...
 * 首页服务
 */
@RestController @RequestMapping(value = "/wx/home") @Validated public class WxHomeController {
  private final Log logger = LogFactory.getLog(WxHomeController.class);

  @Autowired private LitemallAdService adService;

  @Autowired private LitemallGoodsService goodsService;

  @Autowired private LitemallBrandService brandService;

  @Autowired private LitemallTopicService topicService;
  ...
  @Autowired private LitemallCouponService couponService;
  ...
  @GetMapping(value = "/cache") public Object cache(@NotNull String key) {
