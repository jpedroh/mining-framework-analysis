 ...
 */
@SuppressWarnings(value = { "unchecked" }) public class MapDBContext implements DBContext {
      ...
      if (value instanceof Set) {
        ...
        if (value instanceof Map) {
          ...
          if (name.equals(USERS)) {
            entryMap = entryMap.entrySet().stream().map((entry) -> Pair.of(Integer.parseInt(entry.getKey().toString()), entry.getValue())).collect(toMap(Pair::a, Pair::b));
          }
