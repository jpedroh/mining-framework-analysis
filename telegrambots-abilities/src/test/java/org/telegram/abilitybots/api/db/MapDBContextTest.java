...
public class MapDBContextTest {
  ...
  @Test public void canFallbackDBIfRecoveryFails() {
  ...
  @Test public void canGetSummary() {
  ...
  @Test(expected = IllegalStateException.class) public void cantGetInfoFromNonexistentDBStructureName() {
    db.info(TEST);
  }

  @Test public void canGetAndSetVariables() {
