...
public class AbilityBotTest {
  ...
  @Test public void sendsPrivacyViolation() {
  ...
  @Test public void canRecoverDB() throws TelegramApiException, IOException {
  ...
  @Test public void canFilterOutReplies() {
    Update update = mock(Update.class);
    when(update.hasMessage()).thenReturn(false);
    assertTrue(bot.filterReply(update));
  }

  @Test public void canDemote() {
    addUsers(MUSER);
  ...
  @Test public void cannotBanCreator() {
  ...
  @Test public void creatorCanClaimBot() {
    MessageContext context = mockContext(TG_CREATOR, GROUP_ID);
  ...
  @Test public void bannedCreatorPassesBlacklistCheck() {
  ...
  @Test public void canValidateAbility() {
  ...
  @Test public void canCheckInput() {
  ...
  @Test public void canCheckPrivacy() {
    Update update = mock(Update.class);
    Message message = mock(Message.class);
  ...
  @Test public void canValidateGroupAdminPrivacy() {
    Update update = mock(Update.class);
    Message message = mock(Message.class);
    org.telegram.telegrambots.api.objects.User user = mock(User.class);
    Ability groupAdminAbility = getDefaultBuilder().privacy(GROUP_ADMIN).build();
  ...
  @Test public void canRestrictNormalUsersFromGroupAdminAbilities() {
    Update update = mock(Update.class);
    Message message = mock(Message.class);
    org.telegram.telegrambots.api.objects.User user = mock(User.class);
    Ability groupAdminAbility = getDefaultBuilder().privacy(GROUP_ADMIN).build();
  ...
  @Test public void canBlockAdminsFromCreatorAbilities() {
    Update update = mock(Update.class);
    Message message = mock(Message.class);
    org.telegram.telegrambots.api.objects.User user = mock(User.class);
    Ability creatorAbility = getDefaultBuilder().privacy(Privacy.CREATOR).build();
  ...
  @Test public void canCheckLocality() {
    Update update = mock(Update.class);
    Message message = mock(Message.class);
    User user = mock(User.class);
  ...
  @Test public void canRetrieveContext() {
    Update update = mock(Update.class);
    Message message = mock(Message.class);
    User user = mock(User.class);
  ...
  @Test public void defaultGlobalFlagIsTrue() {
    Update update = mock(Update.class);
    assertEquals("Unexpected result when checking for the default global flags", true, bot.checkGlobalFlags(update));
  }

  @Test(expected = ArithmeticException.class) public void canConsumeUpdate() {
  ...
  @Test public void canFetchAbility() {
    Update update = mock(Update.class);
    Message message = mock(Message.class);
    String text = "/test";
  ...
  @Test public void canFetchAbilityCaseInsensitive() {
    Update update = mock(Update.class);
    Message message = mock(Message.class);
    String text = "/tESt";
    when(update.hasMessage()).thenReturn(true);
  ...
  @Test public void canFetchDefaultAbility() {
    Update update = mock(Update.class);
    Message message = mock(Message.class);
  ...
  @Test public void canCheckAbilityFlags() {
    Update update = mock(Update.class);
    Message message = mock(Message.class);
    when(update.hasMessage()).thenReturn(true);
    when(update.getMessage()).thenReturn(message);
  ...
  @Test public void canReportCommands() {
    MessageContext context = mockContext(TG_USER, GROUP_ID);
    bot.reportCommands().action().accept(context);
    verify(silent, times(1)).send("default - dis iz default command", GROUP_ID);
  }

  @NotNull public static MessageContext mockContext(User user) {
    return mockContext(user, user.getId());
  }

  @NotNull public static MessageContext mockContext(User user, long groupId) {
    Update update = mock(Update.class);
    Message message = mock(Message.class);
  ...
  @NotNull private Update mockFullUpdate(EndUser fromUser, String args) {
