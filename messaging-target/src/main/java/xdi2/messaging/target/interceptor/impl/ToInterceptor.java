...
public class ToInterceptor extends AbstractInterceptor<MessagingTarget> implements MessageInterceptor, Prototype<ToInterceptor> {
  ...
  @Override public ToInterceptor instanceFor(PrototypingContext prototypingContext) {
    return this;
  }
  ...
  @Override public InterceptorResult before(Message message, ExecutionContext executionContext, ExecutionResult executionResult) throws Xdi2MessagingException {
    ...
    if (toPeerRootXDIArc == null) {
      throw new Xdi2MessagingException("No TO peer root found in message.", null, executionContext);
    }
    if (!toPeerRootXDIArc.equals(ownerPeerRootXDIArc)) {
      throw new Xdi2MessagingException("Invalid TO peer root: " + toPeerRootXDIArc, null, executionContext);
    }
