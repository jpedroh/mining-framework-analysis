...
@SuppressWarnings(value = { "unchecked" }) public class Javalin implements JavalinDefaultRoutingApi<Javalin> {
  /**
  ...
  @NotNull public JavalinConfig unsafeConfig() {
    return cfg;
  }
  ...
  public static Javalin create(Consumer<JavalinConfig> config) {
    ...
    JavalinConfig.applyUserConfig(app.cfg, config);
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> T attribute(String key) {
    return (T) cfg.pvt.appAttributes.get(key);
  }

  @NotNull @Override public <E extends Exception> Javalin exception(@NotNull Class<E> exceptionClass, @NotNull ExceptionHandler<? super E> exceptionHandler) {
    cfg.pvt.internalRouter.addHttpExceptionHandler(exceptionClass, exceptionHandler);
    return this;
  }

  @NotNull @Override public Javalin error(int status, @NotNull String contentType, @NotNull Handler handler) {
    cfg.pvt.internalRouter.addHttpErrorHandler(status, contentType, handler);
    return this;
  }

  @NotNull @Override public Javalin addHttpHandler(@NotNull HandlerType handlerType, @NotNull String path, @NotNull Handler handler, @NotNull RouteRole... roles) {
    cfg.pvt.internalRouter.addHttpHandler(handlerType, path, handler, roles);
    return this;
  }

  @NotNull @Override public <E extends Exception> Javalin wsException(@NotNull Class<E> exceptionClass, @NotNull WsExceptionHandler<? super E> exceptionHandler) {
    cfg.pvt.internalRouter.addWsExceptionHandler(exceptionClass, exceptionHandler);
    return this;
  }

  @NotNull @Override public Javalin addWsHandler(@NotNull WsHandlerType handlerType, @NotNull String path, @NotNull Consumer<WsConfig> wsConfig, @NotNull RouteRole... roles) {
