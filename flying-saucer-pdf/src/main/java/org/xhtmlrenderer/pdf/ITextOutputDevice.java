...
public class ITextOutputDevice extends AbstractOutputDevice implements OutputDevice {
  ...
  @Override public void drawImageNoAccessible(FSImage fsImage, int x, int y) {
  }

  @Override public void drawImageAsHorizontalBandAccessible(FSImage image, int left, int top, int bottom) {
  }

  @Override public void drawImageAsVerticalBandAccessible(FSImage image, int left, int top, int bottom) {
  }
}