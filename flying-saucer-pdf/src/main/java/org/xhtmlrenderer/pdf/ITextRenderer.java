...
public class ITextRenderer {
  ...
  private final char[] validPdfVersions = new char[] { PdfWriter.VERSION_1_2, PdfWriter.VERSION_1_3, PdfWriter.VERSION_1_4, PdfWriter.VERSION_1_5, PdfWriter.VERSION_1_6, PdfWriter.VERSION_1_7 };

  private PDFCreationListener _listener;


<<<<<<< /usr/src/app/output/flyingsaucerproject/flyingsaucer/9b83c56a8c1de53c9ea1c2a3141e48b36bb2d3e0/flying-saucer-pdf/src/main/java/org/xhtmlrenderer/pdf/ITextRenderer.java/left.java
  private boolean _timeouted;
=======
  private Integer _pdfXConformance;
>>>>>>> /usr/src/app/output/flyingsaucerproject/flyingsaucer/9b83c56a8c1de53c9ea1c2a3141e48b36bb2d3e0/flying-saucer-pdf/src/main/java/org/xhtmlrenderer/pdf/ITextRenderer.java/right.java
  ...
  public void writeNextDocument(int initialPageNo) throws DocumentException {
    ...
    com.lowagie.text.Rectangle firstPageSize = new com.lowagie.text.Rectangle(0, 0, firstPage.getWidth(c) / _dotsPerPoint, firstPage.getHeight(c) / _dotsPerPoint);
  ...
  public void createPDF(OutputStream os, boolean finish, int initialPageNo) throws DocumentException {
    ...
    if (_pdfEncryption != null) {
      writer.setEncryption(_pdfEncryption.getUserPassword(), _pdfEncryption.getOwnerPassword(), _pdfEncryption.getAllowedPrivileges(), _pdfEncryption.getEncryptionType());
    }
    _pdfDoc = doc;
    _writer = writer;
    firePreOpen();
  ...
  private void writePDF(List pages, RenderingContext c, com.lowagie.text.Rectangle firstPageSize, com.lowagie.text.Document doc, PdfWriter writer) throws DocumentException {
    ...
    for (int i = 0; i < pageCount; i++) {
      ...
      if (i != pageCount - 1) {
        ...
        com.lowagie.text.Rectangle nextPageSize = new com.lowagie.text.Rectangle(0, 0, nextPage.getWidth(c) / _dotsPerPoint, nextPage.getHeight(c) / _dotsPerPoint);
