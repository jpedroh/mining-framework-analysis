...
public class SegmentStatsBolt extends BaseRichBolt {
  ...
  private void emitCurrentWindowCounts() {
    ...
    for (SegmentIdentifier xsd : segmentList) {
      ...
      this.collector.emit(new Values(xsd.getXWay(), xsd.getSegment(), xsd.getDirection(), segmentCarCount, speedAverage, prevMinute));
    }
  }
  ...
  @Override public void declareOutputFields(OutputFieldsDeclarer declarer) {
    declarer.declare(new Fields(TopologyControl.XWAY_FIELD_NAME, TopologyControl.SEGMENT_FIELD_NAME, TopologyControl.DIRECTION_FIELD_NAME, TopologyControl.NUMBER_OF_VEHICLES_FIELD_NAME, TopologyControl.LAST_AVERAGE_SPEED_FIELD_NAME, TopologyControl.MINUTE_FIELD_NAME));
  }
}