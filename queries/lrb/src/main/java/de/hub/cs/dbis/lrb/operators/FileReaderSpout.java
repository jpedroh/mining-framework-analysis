...
public class FileReaderSpout extends AbstractOrderedFileInputSpout {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public void open(@SuppressWarnings(value = { "rawtypes" }) Map conf, TopologyContext context, SpoutOutputCollector collector) {
  ...
  /**
	 ...
	 */
  @Override protected long extractTimestamp(String line) throws ParseException {
    int p1 = line.indexOf(",");
