...
public class VehicleRoutingAlgorithms {
  static class TypedMap {
    static interface AbstractKey<K extends java.lang.Object> {
      Class<K> getType();
    }
    ...
    static class AcceptorKey implements AbstractKey<SolutionAcceptor> {
      ...
      @Override public Class<SolutionAcceptor> getType() {
    ...
    static class SelectorKey implements AbstractKey<SolutionSelector> {
      ...
      @Override public Class<SolutionSelector> getType() {
    ...
    static class StrategyModuleKey implements AbstractKey<SearchStrategyModule> {
      ...
      @Override public Class<SearchStrategyModule> getType() {
    ...
    static class RuinStrategyKey implements AbstractKey<RuinStrategy> {
      ...
      @Override public Class<RuinStrategy> getType() {
    ...
    static class InsertionStrategyKey implements AbstractKey<InsertionStrategy> {
      ...
      @Override public Class<InsertionStrategy> getType() {
    ...
    public <T extends java.lang.Object> T get(AbstractKey<T> key) {
      if (map.get(key) == null) {
        return null;
      }
    ...
    public <T extends java.lang.Object> T put(AbstractKey<T> key, T value) {
  ...
  public static VehicleRoutingAlgorithm readAndCreateAlgorithm(final VehicleRoutingProblem vrp, AlgorithmConfig config, int nuOfThreads, SolutionCostCalculator solutionCostCalculator, final StateManager stateManager, ConstraintManager constraintManager, boolean addDefaultCostCalculators) {
  ...
  public static VehicleRoutingAlgorithm readAndCreateAlgorithm(final VehicleRoutingProblem vrp, AlgorithmConfig config, int nuOfThreads, SolutionCostCalculator solutionCostCalculator, final StateManager stateManager, ConstraintManager constraintManager, boolean addDefaultCostCalculators, boolean addCoreConstraints) {
  ...
  private static VehicleRoutingAlgorithm readAndCreateAlgorithm(final VehicleRoutingProblem vrp, XMLConfiguration config, int nuOfThreads, final SolutionCostCalculator solutionCostCalculator, final StateManager stateManager, ConstraintManager constraintManager, boolean addDefaultCostCalculators) {
  ...
  private static VehicleRoutingAlgorithm readAndCreateAlgorithm(final VehicleRoutingProblem vrp, XMLConfiguration config, int nuOfThreads, final SolutionCostCalculator solutionCostCalculator, final StateManager stateManager, ConstraintManager constraintManager, Map<String, SolutionAcceptor> solutionAcceptors, boolean addDefaultCostCalculators, boolean addCoreConstraints) {
    ...
    if (stateManager.timeWindowUpdateIsActivated()) {
      ...
      timeWindowUpdater.setVehiclesToUpdate(new UpdateVehicleDependentPracticalTimeWindows.VehiclesToUpdate() {
        ...
        @Override public Collection<Vehicle> get(VehicleRoute vehicleRoute) {
  ...
  private static SearchStrategyModule buildModule(HierarchicalConfiguration moduleConfig, final VehicleRoutingProblem vrp, VehicleFleetManager vehicleFleetManager, final StateManager routeStates, Set<PrioritizedVRAListener> algorithmListeners, TypedMap definedClasses, ExecutorService executorService, int nuOfThreads, ConstraintManager constraintManager, boolean addDefaultCostCalculators) {
    ...
    if (moduleName.equals("ruin_and_recreate")) {
      ...
      if (ruin_name.equals("randomRuin")) {
        ...
        if (ruin_name.equals("radialRuin")) {
          String shareToRuinString = moduleConfig.getString("ruin.share");
          if (shareToRuinString == null) {
            throw new IllegalStateException("module.ruin.share is missing.");
          }
          ...
          if (ruin_name.equals("clusterRuin")) {
