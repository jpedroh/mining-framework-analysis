...
@Path(value = "/document") public class DocumentValidateResource {
  ...
  @Path(value = "/validate") @GET @Produces(value = MediaType.APPLICATION_JSON) public Response validateDocument(@QueryParam(value = "doc") @DefaultValue(value = "") String document) throws JSONException, DocumentValidatorException, UnsupportedEncodingException {
