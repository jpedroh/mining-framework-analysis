...
@Entity @Table(name = "mailboxes") public class MBox extends AbstractEntity implements Serializable {
  ...
  @JsonIgnore private boolean autoRemove;
  ...
  /**
     ...
     */
  @JsonProperty(value = "expired") public boolean isExpired() {
    return expired;
  }
  ...
  /**
     ...
     *         otherwise
     */
  @JsonIgnore public boolean isExpiredByTimestamp() {
  ...
  /**
     ...
     */
  @JsonIgnore public void setExpired(boolean expired) {
    this.expired = expired;
  }
  ...
  /**
     ...
     */
  @JsonIgnore public void setUsr(User usr) {
    this.usr = usr;
  }
  ...
  /**
     ...
     */
  @JsonProperty(value = "forwards") public int getForwards() {
    return forwards;
  }
  ...
  /**
     ...
     */
  @JsonIgnore public void setForwards(int forwards) {
  ...
  /**
     ...
     */
  @JsonProperty(value = "suppressions") public int getSuppressions() {
    return suppressions;
  }
  ...
  /**
     ...
     */
  @JsonIgnore public void setSuppressions(int suppressions) {
  ...
  /**
     ...
     */
  @JsonProperty(value = "ts_Active") public long getTs_Active() {
    return ts_Active;
  }
  ...
  /**
     ...
     */
  @JsonIgnore public void setTs_Active(long ts_Active) {
  ...
  /**
     ...
     * @param dateTime
     */
  @JsonProperty(value = "datetime") public void setDateTime(String dateTime) {
  ...
  /**
     ...
     */
  @JsonIgnore public Long getVersion() {
    return version;
  }
  ...
  /**
     ...
     */
  @JsonIgnore public void setVersion(Long version) {
  ...
  /**
     ...
     */
  @JsonProperty(value = "fullAddress") public String getFullAddress() {
  ...
  /**
     ...
     * @param dummy
     */
  @JsonIgnore public void setFullAddress(String dummy) {
  }
  ...
  public void increaseFwd() {
    increaseForwards();
    Ebean.createSqlUpdate("update mailboxes set forwards = ? where id = ?;").setParameter(1, getForwards()).setParameter(2, getId()).execute();
  }
  ...
  public void increaseSup() {
    ...
    Ebean.createSqlUpdate("update mailboxes set suppressions = ? where id = ?;").setParameter(1, getSuppressions()).setParameter(2, getId()).execute();
  }
  ...
  /**
     ...
     */
  @JsonIgnore public String getTSAsStringWithNull() {
    if (this.ts_Active == 0) {
      return "0";
    } else {
      if (this.ts_Active == -1) {
  ...
  public static List<MBox> getNextBoxes(int minutes) {
    ...
    return Ebean.find(MBox.class).where().eq("expired", false).lt("ts_Active", dt.getMillis()).ne("ts_Active", 0).findList();
  }
  ...
  public static List<MBox> findBoxLike(String input, long userId) {
    ...
    if (input.contains("@")) {
      ...
      switch (split.length) {
        case (1):
        return exList1.or(Expr.ilike("address", "%" + split[0] + "%"), Expr.ilike("domain", "%" + split[0] + "%")).findList();
        case (2):
  ...
  public static String getSelectedMailsForTxt(Long userId, List<Long> boxIds) {
    ...
    processMailboxesInChunks(baseStmt.toString(), boxIds, new Consumer<String>() {
  ...
  /**
     ...
     */
  @JsonIgnore public boolean isAutoRemove() {
    return autoRemove;
  }
