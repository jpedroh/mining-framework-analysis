...
@Entity @Table public class Mail extends AbstractEntity implements Serializable {
  /**
     * 
     */
  private static final long serialVersionUID = 7644423623786133196L;

  @NotEmpty @Length(max = 255) private String sender;

  @NotNull @Length(max = 255) private String subject;

  /**
     * timestamp when the email was received
     */
  @NotNull private long receiveTime;

  @Lob @NotNull private byte[] message;

  @NotNull @Column(name = "mailbox_id") private long mailbox;
