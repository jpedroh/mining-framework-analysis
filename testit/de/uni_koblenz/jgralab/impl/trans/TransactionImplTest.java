...
public class TransactionImplTest {
  ...
  @Before public void setUp() throws InterruptedException {
    motorwayMap = MotorwayMapSchema.instance().createMotorwayMapWithTransactionSupport(V, E);
    readWriteTransaction1 = (TransactionImpl) motorwayMap.newTransaction();
    readOnlyTransaction = (TransactionImpl) motorwayMap.newReadOnlyTransaction();
  ...
  /**
	 ...
	 */
  @Test public void testInvalidCommit() {
    try {
      readWriteTransaction2 = (TransactionImpl) motorwayMap.newTransaction();
  ...
  /**
	 ...
	 * <code>readWriteTransaction1</code> is not active in current thread.
	 */
  @Test public void testInvalidAbort() {
    try {
      readWriteTransaction2 = (TransactionImpl) motorwayMap.newTransaction();
  ...
  /**
	 ...
	 */
  @Test public void testNoCurrentTransaction() {
    try {
      readWriteTransaction1.commit();
  ...
  /**
	 ...
	 */
  @Test public void testAddVertexReadOnly() {
    try {
  ...
  /**
	 ...
	 * GraphException is expected to be thrown.
	 */
  @Test public void testAddEdgeReadOnly() {
    try {
      testAddVertex();
      motorwayMap.commit();
      readOnlyTransaction = (TransactionImpl) motorwayMap.newReadOnlyTransaction();
  ...
  /**
	 ...
	 */
  @Test public void test1DeleteVertex() {
    testAddVertex();
    c1.delete();
    c2.delete();
    c3.delete();
  ...
  /**
	 ...
	 * .deletedVertices.
	 */
  @Test public void test2DeleteVertex() {
    testAddVertex();
    try {
      motorwayMap.commit();
      readWriteTransaction2 = (TransactionImpl) motorwayMap.newTransaction();
      ...
      assertEquals(readWriteTransaction2.deletedVertices, deletedVerticesList);
    } catch (CommitFailedException e) {
      e.printStackTrace();
      fail();
    }
  ...
  /**
	 ...
	 * GraphException is expected to be thrown.
	 */
  @Test public void testDeleteVertexReadOnly() {
    try {
      testAddVertex();
      motorwayMap.commit();
      readOnlyTransaction = (TransactionImpl) motorwayMap.newReadOnlyTransaction();
  ...
  /**
	 ...
	 * .deletedEdges.
	 */
  @Test public void test1DeleteEdge() {
    testAddEdge();
    ex1.delete();
    ex2.delete();
    ex3.delete();
  ...
  /**
	 ...
	 * .deletedVertices.
	 */
  @Test public void test2DeleteEdge() {
    testAddEdge();
    try {
      motorwayMap.commit();
      readWriteTransaction2 = (TransactionImpl) motorwayMap.newTransaction();
  ...
  /**
	 ...
	 * GraphException is expected to be thrown.
	 */
  @Test public void testDeleteEdgeReadOnly() {
    try {
      testAddEdge();
      motorwayMap.commit();
      readOnlyTransaction = (TransactionImpl) motorwayMap.newReadOnlyTransaction();
  ...
  /**
	 ...
	 * .changedVseqVertices.
	 */
  @Test public void testPutVertexAfter() {
    testAddVertex();
    c1.putAfter(c2);
    ...
    assertEquals(readWriteTransaction1.changedVseqVertices, changedVseqVerticesMap);
  }
  ...
  /**
	 ...
	 */
  @Test public void testPutVertexAfterReadOnly() {
    try {
      testAddVertex();
      motorwayMap.commit();
      readOnlyTransaction = (TransactionImpl) motorwayMap.newReadOnlyTransaction();
  ...
  /**
	 ...
	 * .changedVseqVertices.
	 */
  @Test public void testPutVertexBefore() {
    testAddVertex();
    c2.putBefore(c1);
    Map<Vertex, Map<ListPosition, Boolean>> changedVseqVerticesMap = new HashMap<Vertex, Map<ListPosition, Boolean>>();
    Map<ListPosition, Boolean> changedPosition1 = new HashMap<ListPosition, Boolean>();
  ...
  /**
	 ...
	 * GraphException is expected to be thrown.
	 */
  @Test public void testPutVertexBeforeReadOnly() {
    try {
      testAddVertex();
      motorwayMap.commit();
      readOnlyTransaction = (TransactionImpl) motorwayMap.newReadOnlyTransaction();
  ...
  /**
	 ...
	 */
  @Test public void testPutEdgeAfterInGraph() {
    testAddEdge();
    ...
    assertEquals(readWriteTransaction1.changedEseqEdges, changedEseqEdgesMap);
  }
  ...
  /**
	 ...
	 * . This is not allowed, so a GraphException is expected to be thrown.
	 */
  @Test public void testPutEdgeAfterInGraphReadOnly() {
    try {
      testAddEdge();
      motorwayMap.commit();
      readOnlyTransaction = (TransactionImpl) motorwayMap.newReadOnlyTransaction();
  ...
  /**
	 ...
	 * .changedEseqEdges.
	 */
  @Test public void testPutEdgeBeforeInGraph() {
    testAddEdge();
  ...
  /**
	 ...
	 * GraphException is expected to be thrown.
	 */
  @Test public void testPutEdgeBeforeInGraphReadOnly() {
    try {
      testAddEdge();
      motorwayMap.commit();
      readOnlyTransaction = (TransactionImpl) motorwayMap.newReadOnlyTransaction();
  ...
  /**
	 ...
	 * remarked in <code>readWriteTransaction1</code> .changedEseqEdges.
	 */
  @Test public void testPutEdgeAfter() {
    testAddEdge();
    ...
    assertEquals(readWriteTransaction1.changedIncidences, vertexChangedIncidencesMap);
  }
  ...
  /**
	 ...
	 * GraphException is expected to be thrown.
	 */
  @Test public void testPutEdgeAfterReadOnly() {
    try {
      testAddEdge();
      motorwayMap.commit();
      readOnlyTransaction = (TransactionImpl) motorwayMap.newReadOnlyTransaction();
  ...
  /**
	 ...
	 * .changedEseqEdges.
	 */
  @Test public void testPutEdgeBefore() {
    testAddEdge();
  ...
  /**
	 ...
	 * GraphException is expected to be thrown.
	 */
  @Test public void testPutEdgeBeforeReadOnly() {
    try {
      testAddEdge();
      motorwayMap.commit();
      readOnlyTransaction = (TransactionImpl) motorwayMap.newReadOnlyTransaction();
  ...
  /**
	 ...
	 * GraphException is expected to be thrown.
	 */
  @Test public void testSetAlphaReadOnly() {
    try {
      testAddEdge();
      c2 = motorwayMap.createCity();
      motorwayMap.commit();
  ...
  /**
	 ...
	 * GraphException is expected to be thrown.
	 */
  @Test public void testSetOmegaReadOnly() {
    try {
      testAddEdge();
      mw2 = motorwayMap.createMotorway();
      motorwayMap.commit();
  ...
  /**
	 ...
	 * <code>readWriteTransaction1</code> .changedEdges.
	 */
  @Test public void testSetAlphaOmega() {
    testAddEdge();
    c2 = motorwayMap.createCity();
    ((InternalEdge) ex1).setAlpha(c2);
    mw2 = motorwayMap.createMotorway();
  ...
  /**
	 ...
	 */
  @Test public void testSetAttribute() throws ClassNotFoundException {
    testAddVertex();
    ...
    c1Impl.set_testRecord(new TestRecord("test", list, set, 2, 2D, 2L, false));
    ...
    assertEquals(readWriteTransaction1.changedAttributes, changedAttributesMap);
  }
  ...
  /**
	 ...
	 */
  @Test public void testSetAttributeReadOnly() {
    try {
      testAddVertex();
      motorwayMap.commit();
      readOnlyTransaction = (TransactionImpl) motorwayMap.newReadOnlyTransaction();
  ...
  /**
	 ...
	 */
  @Test public void testDeleteVertexAfterChanges() {
    try {
      testAddEdge();
      motorwayMap.commit();
      readWriteTransaction2 = (TransactionImpl) motorwayMap.newTransaction();
      ...
      c1.putAfter(c3);
      assertTrue(readWriteTransaction2.changedVseqVertices.containsKey(c1) && readWriteTransaction2.changedVseqVertices.containsKey(c3));
      ex1.putIncidenceAfter(ex3);
      assertTrue(readWriteTransaction2.changedIncidences.containsKey(c1));
      c1.delete();
      assertTrue(!readWriteTransaction2.changedAttributes.containsKey(c1));
      assertTrue(!(readWriteTransaction2.changedVseqVertices.containsKey(c1)));
      assertTrue(!readWriteTransaction2.changedIncidences.containsKey(c1));
  ...
  /**
	 ...
	 */
  @Test public void testDeleteEdgeAfterChanges() {
    try {
      testAddEdge();
      motorwayMap.commit();
      readWriteTransaction2 = (TransactionImpl) motorwayMap.newTransaction();
      ...
      assertTrue(readWriteTransaction2.changedEseqEdges.containsKey(ex1) && readWriteTransaction2.changedEseqEdges.containsKey(ex3));
      ex1.putIncidenceAfter(ex3);
      assertTrue(readWriteTransaction2.changedIncidences.get(c1).containsKey(ex1) && readWriteTransaction2.changedIncidences.get(c1).containsKey(ex3));
      ex1.delete();
      ex3.delete();
      assertTrue(!readWriteTransaction2.changedAttributes.containsKey(ex1));
      assertTrue(!(readWriteTransaction2.changedEseqEdges.containsKey(ex1)) && !(readWriteTransaction2.changedEseqEdges.containsKey(ex3)));
