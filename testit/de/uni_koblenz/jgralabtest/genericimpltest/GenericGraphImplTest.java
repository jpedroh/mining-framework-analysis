...
public class GenericGraphImplTest {
  public static final String SCHEMAFOLDER = "testit" + File.separator + "testschemas" + File.separator;

  public static final String GRAPHFOLDER = "testit" + File.separator + "testgraphs" + File.separator;

  public static final String DATAFOLDER = "testit" + File.separator + "testdata" + File.separator;
  ...
  private void testDefaultValue(Object value, Attribute attribute) {
    try {
      if (attribute.getDefaultValueAsString() != null) {
        Object expected = attribute.getDomain().parseGenericAttribute(GraphIO.createStringReader(attribute.getDefaultValueAsString(), attribute.getAttributedElementClass().getSchema()));
        assertEquals(expected, value);
      } else {
        assertEquals(GenericGraphImpl.genericAttributeDefaultValue(attribute.getDomain()), value);
      }
  ...
  @Test public void testCreateGraph1() {
    try {
      Schema schema;
  ...
  @Test public void testCreateGraph2() {
    try {
      ...
      assertEquals(de.uni_koblenz.jgralab.impl.RecordImpl.empty().plus("boolRecord", true).plus("doubleRecord", new Double(1.1)).plus("enumRecord", "FIRST").plus("intRecord", new Integer(1)).plus("listRecord", JGraLab.vector().plus(true).plus(false).plus(true)).plus("longRecord", new Long(1)).plus("mapRecord", JGraLab.map().plus(1, true).plus(2, false).plus(3, true)).plus("setRecord", JGraLab.set().plus(true).plus(false)).plus("stringRecord", "test"), g.getAttribute("recordGraph"));
  ...
  @Test public void testCreateVertex1() {
    try {
      Schema schema;
      schema = GraphIO.loadSchemaFromFile(SCHEMAFOLDER + "MinimalSchema.tg");
      Graph g = schema.createGraph(ImplementationType.GENERIC);
  ...
  @Test public void testCreateVertex2() {
    try {
      Schema schema = GraphIO.loadSchemaFromFile(SCHEMAFOLDER + "DefaultValueTestSchema.tg");
      Graph g = schema.createGraph(ImplementationType.GENERIC);
      Vertex v1 = g.createVertex(schema.getGraphClass().getVertexClass("TestVertex"));
      Vertex v2 = g.createVertex(schema.getGraphClass().getVertexClass("TestSubVertex"));
  ...
  @Test public void testCreateEdge1() {
    try {
  ...
  @Test public void testDeleteEdge() {
    try {
      Schema schema = GraphIO.loadSchemaFromFile(SCHEMAFOLDER + "VertexTestSchema.tg");
      Graph g = schema.createGraph(ImplementationType.GENERIC, 100, 100);
      Vertex v1 = g.createVertex(schema.getGraphClass().getVertexClass("DoubleSubNode"));
      Vertex v2 = g.createVertex(schema.getGraphClass().getVertexClass("SuperNode"));
      Edge e1 = g.createEdge(schema.getGraphClass().getEdgeClass("SubLink"), v1, v2);
      Edge e2 = g.createEdge(schema.getGraphClass().getEdgeClass("LinkBack"), v2, v1);
      g.deleteEdge(e1);
  ...
  @Test(expected = GraphException.class) public void testCreateEdgeFailure1() {
    Graph g1 = null;
    try {
  ...
  @Test(expected = GraphException.class) public void testCreateEdgeFailure2() {
    try {
  ...
  @Test(expected = GraphException.class) public void testCreateEdgeFailure3() {
    try {
      Schema schema = GraphIO.loadSchemaFromFile(SCHEMAFOLDER + "VertexTestSchema.tg");
      Graph g = schema.createGraph(ImplementationType.GENERIC);
  ...
  @Test(expected = GraphException.class) public void testCreateVertexFailure1() {
    Graph g1 = null;
    try {
      ...
      g1.createVertex(greqltestschema.getGraphClass().getVertexClass("junctions.Crossroad"));
    } catch (GraphIOException e) {
      e.printStackTrace();
      fail();
    } catch (GraphException e) {
  ...
  public void testSetTraversalContext() {
    try {
      final Graph g = GraphIO.loadGraphFromFile(GRAPHFOLDER + "greqltestgraph.tg", null, null, ImplementationType.GENERIC);
      g.setTraversalContext(new TraversalContext() {
        @Override public boolean containsVertex(Vertex v) {
          return v.getAttributedElementClass().equals(g.getGraphClass().getVertexClass("Crossroad"));
        }

        @Override public boolean containsEdge(Edge e) {
          return e.getAttributedElementClass().equals(g.getGraphClass().getEdgeClass("Street"));
        }
      });
      for (Vertex v : g.vertices()) {
        assertEquals(g.getGraphClass().getVertexClass("Crossroad"), v.getAttributedElementClass());
      }
      for (Edge e : g.edges()) {
        assertEquals(g.getGraphClass().getEdgeClass("Street"), e.getAttributedElementClass());
      }
      g.setTraversalContext(new TraversalContext() {
        @Override public boolean containsVertex(Vertex v) {
          return g.getGraphClass().getVertexClass("Plaza").equals(v.getAttributedElementClass());
        }
      ...
      for (Vertex v : g.vertices()) {
        assertEquals(g.getGraphClass().getVertexClass("Plaza"), v.getAttributedElementClass());
      }
  ...
  @Test public void testAccessAttributes1() throws GraphIOException {
    Schema schema = GraphIO.loadSchemaFromFile(SCHEMAFOLDER + "DefaultValueTestSchema.tg");
    Graph g = schema.createGraph(ImplementationType.GENERIC);
    ...
    g.setAttribute("complexListGraph", JGraLab.vector().plus(JGraLab.vector().plus(true)).plus(JGraLab.vector().plus(false)).plus(JGraLab.vector().plus(false)));
    assertEquals(JGraLab.vector().plus(JGraLab.vector().plus(true)).plus(JGraLab.vector().plus(false)).plus(JGraLab.vector().plus(false)), g.getAttribute("complexListGraph"));
  ...
  @Test(expected = NoSuchAttributeException.class) public void testAccessAttributesFailure1() throws GraphIOException {
    Schema schema = GraphIO.loadSchemaFromFile(SCHEMAFOLDER + "DefaultValueTestSchema.tg");
    Graph g = schema.createGraph(ImplementationType.GENERIC);
    g.setAttribute("doesNotExist", true);
  }

  @Test(expected = NoSuchAttributeException.class) public void testAccessAttributesFailure2() throws GraphIOException {
    Schema schema = GraphIO.loadSchemaFromFile(SCHEMAFOLDER + "DefaultValueTestSchema.tg");
    Graph g = schema.createGraph(ImplementationType.GENERIC);
    g.setAttribute("boolgraph", true);
  }

  @Test(expected = ClassCastException.class) public void testAccessAttributesFailure3() throws GraphIOException {
    Schema schema = GraphIO.loadSchemaFromFile(SCHEMAFOLDER + "DefaultValueTestSchema.tg");
    Graph g = schema.createGraph(ImplementationType.GENERIC);
    g.setAttribute("boolGraph", JGraLab.set().plus(1));
  }

  @Test(expected = ClassCastException.class) public void testAccessAttributesFailure4() throws GraphIOException {
    Schema schema = GraphIO.loadSchemaFromFile(SCHEMAFOLDER + "DefaultValueTestSchema.tg");
    Graph g = schema.createGraph(ImplementationType.GENERIC);
    g.setAttribute("boolGraph", null);
  }

  @Test public void testVertexIteration() {
    try {
      Schema s = GraphIO.loadSchemaFromFile(SCHEMAFOLDER + "VertexTestSchema.tg");
      ...
      assertEquals(v1, g.getFirstVertex(s.getGraphClass().getVertexClass("A")));
      assertEquals(v3, g.getFirstVertex(s.getGraphClass().getVertexClass("B")));
      assertEquals(v5, g.getFirstVertex(s.getGraphClass().getVertexClass("C")));
      assertEquals(v7, g.getFirstVertex(s.getGraphClass().getVertexClass("D")));
      assertEquals(v9, g.getFirstVertex(s.getGraphClass().getVertexClass("C2")));
  ...
  @Test public void testEdgeIteration() {
    try {
      Schema s = GraphIO.loadSchemaFromFile(SCHEMAFOLDER + "VertexTestSchema.tg");
      Graph g = s.createGraph(ImplementationType.GENERIC);
      Vertex v1 = g.createVertex(s.getGraphClass().getVertexClass("A"));
  ...
  @Test public void testSave() {
    try {
      ...
      Graph g2 = GraphIO.loadGraphFromFile(DATAFOLDER + "GenericTestGraph1.tg", schema, null, ImplementationType.GENERIC);
      ...
      while (vertexIterator1.hasNext()) {
        ...
        assertEquals(vg1.getAttributedElementClass(), vg2.getAttributedElementClass());
      }
      ...
      while (edgeIterator1.hasNext()) {
        ...
        assertEquals(eg2.getAttributedElementClass(), eg2.getAttributedElementClass());
      }
  ...
  @Test public void testLoadGraph1() {
    try {
      Schema s = GraphIO.loadSchemaFromFile(GRAPHFOLDER + "citymapgraph.tg");
      Graph g = GraphIO.loadGraphFromFile(GRAPHFOLDER + "citymapgraph.tg", s, null, ImplementationType.GENERIC);
  ...
  @Test public void testLoadGraph2() {
    try {
      Schema s = GraphIO.loadSchemaFromFile(GRAPHFOLDER + "greqltestgraph.tg");
      Graph g1 = GraphIO.loadGraphFromFile(GRAPHFOLDER + "greqltestgraph.tg", s, null, ImplementationType.GENERIC);
      assertEquals(s.getGraphClass(), g1.getAttributedElementClass());
      assertEquals(157, g1.getVCount());
      assertEquals(357, g1.getECount());
      Graph g2 = GraphIO.loadGraphFromFile(GRAPHFOLDER + "greqltestgraph.tg", s, null, ImplementationType.STANDARD);
      for (Vertex v : g2.vertices()) {
        assertEquals(v.getAttributedElementClass(), g1.getVertex(v.getId()).getAttributedElementClass());
        for (Attribute a : v.getAttributedElementClass().getAttributeList()) {
          try {
            assertEquals(v.writeAttributeValueToString(a.getName()), g2.getVertex(v.getId()).writeAttributeValueToString(a.getName()));
          } catch (IOException e) {
            e.printStackTrace();
            fail();
          }
      ...
      for (Edge edge : g2.edges()) {
        assertEquals(edge.getAttributedElementClass(), g1.getEdge(edge.getId()).getAttributedElementClass());
        for (Attribute a : edge.getAttributedElementClass().getAttributeList()) {
          try {
            assertEquals(edge.writeAttributeValueToString(a.getName()), g2.getEdge(edge.getId()).writeAttributeValueToString(a.getName()));
          } catch (IOException e) {
            e.printStackTrace();
            fail();
          }
