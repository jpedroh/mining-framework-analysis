...
public class ParserTest {
  ...
  private Greql2Graph parseQuery(String query, String file) throws ParsingException {
  ...
  @Test public void testGreql2TestGraph() throws ParsingException {
    parseQuery("from i:c report i end where d:=\"dr\u00f6lfundf\u00fcnfzig\", c:=b, b:=a, a:=\"Mensaessen\"");
  }

  @Test public void testWhereWithSameScope() throws ParsingException {
  ...
  @Test public void testExistsOne() throws Exception {
  ...
  @Test public void testOrExpression() throws Exception {
  ...
  @Test public void testAndExpression() throws Exception {
  ...
  @Test public void testXorExpression() throws Exception {
  ...
  @Test public void testEqualityExpression() throws Exception {
  ...
  @Test public void testMatchExpression() throws Exception {
    Greql2Graph graph = parseQuery("true =~ false");
    FunctionApplication funAp = graph.getFirstFunctionApplication();
    assertNotNull(funAp);
    IsFunctionIdOf isIdOf = funAp.getFirstIsFunctionIdOfIncidence();
  ...
  @Test public void testIdentifierWithDollar() throws Exception {
  ...
  @Test public void testIdentifierWithDollar2() throws Exception {
  ...
  @Test public void testTypeId() throws Exception {
  ...
  @Test public void testTypeId2() throws Exception {
    Greql2Graph graph = parseQuery("V{^Part!}");
    TypeId t = graph.getFirstTypeId();
    assertNotNull(t);
    assertEquals("Part", t.get_name());
  ...
  @Test public void testTypeId3() throws Exception {
    Greql2Graph graph = parseQuery("V{^Part}");
    TypeId t = graph.getFirstTypeId();
    assertNotNull(t);
    assertEquals("Part", t.get_name());
  ...
  @Test public void testNotEqualExpression() throws Exception {
    Greql2Graph graph = parseQuery("true <> false");
    FunctionApplication funAp = graph.getFirstFunctionApplication();
    assertNotNull(funAp);
    IsFunctionIdOf isIdOf = funAp.getFirstIsFunctionIdOfIncidence();
  ...
  @Test public void testLessThanExpression() throws Exception {
  ...
  @Test public void testLessOrEqualExpression() throws Exception {
  ...
  @Test public void testIntegerLiteral() throws Exception {
  ...
  @Test public void testHexLiteral() throws Exception {
  ...
  @Test public void testOctLiteral() throws Exception {
  ...
  @Test public void testLongLiteral() throws Exception {
  ...
  @Test public void testUnaryExpressionNeg() throws Exception {
    Greql2Graph graph = parseQuery("-5");
    FunctionApplication funAp = graph.getFirstFunctionApplication();
    assertNotNull(funAp);
    IsFunctionIdOf isIdOf = funAp.getFirstIsFunctionIdOfIncidence();
  ...
  @Test public void testUnaryExpressionNot() throws Exception {
  ...
  @Test public void testListConstruction() throws Exception {
  ...
  @Test public void testGreTLQuery() throws Exception {
    String query = "from t : V{Vertex}    " + "report t --> " + "     & {@hasType(thisVertex, \"MyType\")} " + "end";
  ...
  @Test public void testRole() throws Exception {
  ...
  @Test public void testListRangeConstruction() throws Exception {
  ...
  @Test public void testSetConstruction() throws Exception {
  ...
  @Test public void testRecordConstruction() throws Exception {
  ...
  @Test public void testRecordConstruction2() throws Exception {
    parseQuery("rec(T2: 1).T2");
  }

  @Test public void testForallExpression() throws Exception {
    ...
    assertNotNull(expr);
    Quantifier quantifier = (Quantifier) expr.getFirstIsQuantifierOfIncidence().getAlpha();
    assertNotNull(quantifier);
    assertEquals(QuantificationType.FORALL, quantifier.get_type());
  }

  @Test public void testExistsExpression() throws Exception {
  ...
  @Test public void testExistsOneExpression() throws Exception {
    Greql2Graph graph = parseQuery("exists! v:set(1,2,3) @ v < 7");
    Variable var = graph.getFirstVariable();
    assertNotNull(var);
    assertEquals("v", var.get_name());
  ...
  @Test public void testVariableList() throws Exception {
  ...
  @Test public void testSimpleQueryWithConstraint() throws Exception {
    ...
    FunctionId funId = (FunctionId) funAp.getFirstIsFunctionIdOfIncidence().getAlpha();
    assertEquals("isPrime", funId.get_name());
  }

  @Test public void testSimpleQueryWithMultipleDeclarations() throws Exception {
    ...
    SimpleDeclaration simpleDecl = (SimpleDeclaration) simpleDeclEdge.getAlpha();
  ...
  @Test public void testSimpleQuery1() throws Exception {
    ...
    assertNotNull(simpleDeclEdge);
    SimpleDeclaration simpleDecl = (SimpleDeclaration) simpleDeclEdge.getAlpha();
    Variable var = (Variable) simpleDecl.getFirstIsDeclaredVarOfIncidence().getAlpha();
    assertEquals("var", var.get_name());
    VertexSetExpression vset = (VertexSetExpression) simpleDecl.getFirstIsTypeExprOfIncidence().getAlpha();
    IsTypeRestrOfExpression typeRestrEdge = vset.getFirstIsTypeRestrOfExpressionIncidence();
    assertNotNull(typeRestrEdge);
    ...
    EdgeRestriction edgeRestr = (EdgeRestriction) simplePath.getFirstIsEdgeRestrOfIncidence().getAlpha();
    ...
    edgeRestr = (EdgeRestriction) simplePath.getFirstIsEdgeRestrOfIncidence().getAlpha();
    typeId = (TypeId) edgeRestr.getFirstIsTypeIdOfIncidence().getAlpha();
  ...
  @Test public void testSimpleQuery2() throws Exception {
  ...
  @Test public void testUsing() throws Exception {
  ...
  @Test public void testDefinitionList() throws Exception {
    parseQuery("let a:=7, b:=5 in a+b");
  }

  @Test public void testEvaluateListAccess() throws Exception {
    String queryString = "let x := list ( \"bratwurst\", \"currywurst\") in from i:V{Identifier} report x[3] end";
    parseQuery(queryString);
  }

  @Test public void testDoubleIdentifiers() throws Exception {
    String queryString = "let COL := list(1..10) in " + "( " + " from i:COL report \'a\' end " + " ++" + " from i:COL report \'b\' end " + ")";
    parseQuery(queryString);
  }

  @Test public void testDoubleIdentifiers2() throws Exception {
    String queryString = "from i:list(1..10) report \'a\' end " + "++" + "from i:list(1..10) report \'b\' end";
    parseQuery(queryString);
  }

  @Test public void testLetExpression2() throws Exception {
    Greql2Graph graph = parseQuery("let x:= list (5..13) in count(x)");
    assertNotNull(graph);
  }

  @Test public void testFRQuery() throws Exception {
  ...
  @Test public void testFunctionApplication() throws Exception {
  ...
  @Test public void testConditionalExpression() throws Exception {
    ...
    FunctionId conditionId = (FunctionId) condition.getFirstIsFunctionIdOfIncidence().getAlpha();
    ...
    IntLiteral arg2 = (IntLiteral) condition.getFirstIsArgumentOfIncidence().getNextIsArgumentOfIncidence().getAlpha();
  ...
  @Test public void testConditionalExpression2() throws Exception {
  ...
  @Test public void testVertexSetExpression() throws Exception {
  ...
  @Test public void testEdgeSetExpression() throws Exception {
  ...
  @Test public void testReportAsQuery() throws Exception {
    parseQuery("from v:V report v as \"Vertex\" end");
  }

  @Test public void testSimplePathDescription() throws Exception {
  ...
  @Test public void testAlternativePathDescriptionWithTypes() throws Exception {
    ...
    EdgeRestriction edgeRestriction = (EdgeRestriction) restrEdge.getAlpha();
  ...
  @Test public void testPathDescriptionWithParantheses1() throws Exception {
  ...
  @Test public void testTypedPathDescription() throws Exception {
  ...
  @Test public void testAlternativePathDescription() throws Exception {
    Greql2Graph graph = parseQuery("using v: v --> | <-- ");
    Variable var = graph.getFirstVariable();
    assertNotNull(var);
    assertEquals("v", var.get_name());
  ...
  @Test public void testIntermediateVertexPathDescription() throws Exception {
  ...
  @Test public void testSequentialPathDescription() throws Exception {
    Greql2Graph graph = parseQuery("using v: v --> <-- ");
    ForwardVertexSet vset = graph.getFirstForwardVertexSet();
    assertNotNull(vset);
  ...
  @Test public void testStartRestrictedPathDescriptionWithExpression() throws Exception {
    ...
    FunctionId funId = (FunctionId) restr.getFirstIsFunctionIdOfIncidence().getAlpha();
    assertEquals("equals", funId.get_name());
    ForwardVertexSet vset = graph.getFirstForwardVertexSet();
    assertNotNull(vset);
  }

  @Test public void testStartRestrictedPathDescriptionWithType() throws Exception {
  ...
  @Test public void testGoalRestrictedPathDescription() throws Exception {
  ...
  @Test public void testIteratedPathDescription() throws Exception {
    Greql2Graph graph = parseQuery("using v: v -->* ");
    ForwardVertexSet vset = graph.getFirstForwardVertexSet();
    assertNotNull(vset);
  ...
  @Test public void testPathExistence() throws Exception {
  ...
  @Test public void testEdgePathDescription() throws Exception {
  ...
  @Test public void testErrorInTypeExpression() throws Exception {
    String query = "from v:V{Greql2Expression, ^TypeExpression, ^Quantifier} report v end";
    parseQuery(query);
  }

  @Test(timeout = 5000) public void testParsingSpeed2() throws Exception {
    parseQuery("3 + (((3) + (((3)) - 3) * (((((((((9 - 6))) + 3 - 6)) + 3))))) - 3)");
  }

  @Test(timeout = 5000) public void testParsingSpeed3() throws Exception {
    parseQuery("((((((((((((9))))))))))))");
  }

  @Test(timeout = 5000) public void testParsingSpeed4() throws Exception {
    parseQuery("(((((((((((((((((((((((((((((((((((((((9)))))))))))))))))))))))))))))))))))))))");
  }

  @Test public void testStringWithoutEscapes() {
  ...
  @Test public void testStringWithEscape1() {
  ...
  @Test public void testStringWithEscape2() {
  ...
  @Test public void testParsingError2() {
    try {
  ...
  @Test public void testGetKnownVariables() {
    String query = "//test \n \n from var:V{} \n with \n var ";
  ...
  @Test public void testKeywordsInPackageNames() {
  ...
  @Test public void testWhereExpressionComplicated() {
    String query = "from c: V{JavaType} " + "with c.kind = \"CLASS\"" + "and count(deps)>0 " + "report c.qualifiedName as \"Class\", " + "deps as \"depends on\" " + "end " + "where " + "deps := from d: V{JavaType} " + "with c <--{Defines} -->{Imports} d " + "report d.qualifiedName as \"Class\" " + "end";
    parseQuery(query);
  }
}