...
=======
  @Test public void testLetExpression() throws Exception {
    Greql2Graph graph = parseQuery("let a:=7 in from b:list(1..a) report b end");
    Variable var = graph.getFirstVariable();
    assertNotNull(var);
    assertEquals("b", var.get_name());
  }
>>>>>>> /usr/src/app/output/jgralab/jgralab/07f3d40d100dd1732f351a53d077239d42a05151/testit/de/uni_koblenz/jgralabtest/greql2/ParserTest.java/right.java
...
<<<<<<< Unknown file: This is a bug in JDime.
=======
  @Test public void testEdgeSubgraphExpression() throws Exception {
...
<<<<<<< Unknown file: This is a bug in JDime.
=======
  @Test public void testVertexSubgraphExpression() throws Exception {
    Greql2Graph graph = parseQuery("on vSubgraph{^FirstType, ^SecondType, ThirdType} : true");
    VertexTypeSubgraph vertexTypesubgraph = graph.getFirstVertexTypeSubgraph();
