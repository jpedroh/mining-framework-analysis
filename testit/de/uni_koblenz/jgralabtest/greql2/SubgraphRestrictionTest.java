...
public class SubgraphRestrictionTest extends GenericTest {
  @Test public void testVertexTypeRestrictedSubgraph() throws Exception {
  ...
  @Test public void testEdgeTypeRestrictedSubgraph() throws Exception {
  ...
  @Test public void testExpressionCreatedSubgraph() throws Exception {
    String queryString = "on vertexTypeSubgraph{junctions.Crossroad}() : from v:V report v end";
    PVector result = (PVector) evalTestQuery(queryString);
    int crossroads = (Integer) evalTestQuery("count(V{junctions.Crossroad})");
    int num = 0;
  ...
  @Test public void testElementSetCreatedSubgraph() throws Exception {
