...
@RunWith(value = Parameterized.class) public class EdgeTest extends InstanceTest {
  ...
  @Before public void setUp() {
    switch (implementationType) {
      ...
      break;
      case TRANSACTION:
      g = VertexTestSchema.instance().createVertexTestGraphWithTransactionSupport();
      break;
      case DATABASE:
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void getIdTest0() throws Exception {
    createTransaction(g);
  ...
  /**
	 ...
	 */
  @Test public void getNextEdgeTestEdgeDirection0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v0 = g.createDoubleSubNode();
    DoubleSubNode v1 = g.createDoubleSubNode();
    Edge e0 = g.createLink(v0, v1);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeTestEdgeDirection1() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    ...
    assertEquals(e5.getReversedEdge(), e3.getReversedEdge().getNextIncidence(EdgeDirection.IN));
    ...
    assertEquals(e2.getReversedEdge(), e1.getReversedEdge().getNextIncidence(EdgeDirection.INOUT));
    assertEquals(e3, e1.getReversedEdge().getNextIncidence(EdgeDirection.OUT));
    assertEquals(e2.getReversedEdge(), e1.getReversedEdge().getNextIncidence(EdgeDirection.IN));
    ...
    assertEquals(e4.getReversedEdge(), e2.getReversedEdge().getNextIncidence(EdgeDirection.IN));
  ...
  /**
	 ...
	 * @throws Exception
	 */
  @Test public void getNextEdgeTestEdgeDirection2() throws Exception {
    for (int i = 0; i < RANDOM_GRAPH_COUNT; i++) {
      ...
      for (int k = 0; k < edges.length; k++) {
        ...
        if (e.getAlpha() == v0) {
          ...
          assertEquals(v1inout[k], e.getReversedEdge().getNextIncidence(EdgeDirection.INOUT));
          assertEquals(v1out[k], e.getReversedEdge().getNextIncidence(EdgeDirection.OUT));
          assertEquals(v1in[k], e.getReversedEdge().getNextIncidence(EdgeDirection.IN));
        } else {
          assertEquals(v0inout[k], e.getReversedEdge().getNextIncidence(EdgeDirection.INOUT));
          assertEquals(v0out[k], e.getReversedEdge().getNextIncidence(EdgeDirection.OUT));
          assertEquals(v0in[k], e.getReversedEdge().getNextIncidence(EdgeDirection.IN));
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClass0() throws CommitFailedException {
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClass1() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClass2() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    for (int i = 0; i < RANDOM_GRAPH_COUNT; i++) {
      switch (implementationType) {
        case STANDARD:
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClass0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClass1() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClass2() throws CommitFailedException {
    for (int i = 0; i < RANDOM_GRAPH_COUNT; i++) {
      switch (implementationType) {
        case STANDARD:
        g = VertexTestSchema.instance().createVertexTestGraph();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClassEdgeDirection0() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClassEdgeDirection1() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    ...
    commit(g);
    createReadOnlyTransaction(g);
    assertEquals(e3.getReversedEdge(), e1.getNextIncidence(ecs[0], EdgeDirection.INOUT));
    assertEquals(e3.getReversedEdge(), e1.getNextIncidence(ecs[1], EdgeDirection.INOUT));
    ...
    assertEquals(e3.getReversedEdge(), e1.getNextIncidence(ecs[0], EdgeDirection.IN));
    assertEquals(e3.getReversedEdge(), e1.getNextIncidence(ecs[1], EdgeDirection.IN));
    assertNull(e1.getNextIncidence(ecs[2], EdgeDirection.IN));
    assertEquals(e3.getReversedEdge(), e2.getNextIncidence(ecs[0], EdgeDirection.INOUT));
    assertEquals(e3.getReversedEdge(), e2.getNextIncidence(ecs[1], EdgeDirection.INOUT));
    ...
    assertEquals(e3.getReversedEdge(), e2.getNextIncidence(ecs[0], EdgeDirection.IN));
    assertEquals(e3.getReversedEdge(), e2.getNextIncidence(ecs[1], EdgeDirection.IN));
    assertNull(e2.getNextIncidence(ecs[2], EdgeDirection.IN));
    assertEquals(e4, e3.getReversedEdge().getNextIncidence(ecs[0], EdgeDirection.INOUT));
    assertNull(e3.getReversedEdge().getNextIncidence(ecs[1], EdgeDirection.INOUT));
    assertEquals(e5, e3.getReversedEdge().getNextIncidence(ecs[2], EdgeDirection.INOUT));
    assertEquals(e4, e3.getReversedEdge().getNextIncidence(ecs[0], EdgeDirection.OUT));
    assertNull(e3.getReversedEdge().getNextIncidence(ecs[1], EdgeDirection.OUT));
    assertEquals(e5, e3.getReversedEdge().getNextIncidence(ecs[2], EdgeDirection.OUT));
    assertEquals(e4.getReversedEdge(), e3.getReversedEdge().getNextIncidence(ecs[0], EdgeDirection.IN));
    assertNull(e3.getReversedEdge().getNextIncidence(ecs[1], EdgeDirection.IN));
    assertNull(e3.getReversedEdge().getNextIncidence(ecs[2], EdgeDirection.IN));
    assertEquals(e4.getReversedEdge(), e4.getNextIncidence(ecs[0], EdgeDirection.INOUT));
    ...
    assertEquals(e4.getReversedEdge(), e4.getNextIncidence(ecs[0], EdgeDirection.IN));
    assertNull(e4.getNextIncidence(ecs[1], EdgeDirection.IN));
    assertNull(e4.getNextIncidence(ecs[2], EdgeDirection.IN));
    assertNull(e4.getReversedEdge().getNextIncidence(ecs[0], EdgeDirection.INOUT));
    assertNull(e4.getReversedEdge().getNextIncidence(ecs[1], EdgeDirection.INOUT));
    assertEquals(e5, e4.getReversedEdge().getNextIncidence(ecs[2], EdgeDirection.INOUT));
    assertNull(e4.getReversedEdge().getNextIncidence(ecs[0], EdgeDirection.OUT));
    assertNull(e4.getReversedEdge().getNextIncidence(ecs[1], EdgeDirection.OUT));
    assertEquals(e5, e4.getReversedEdge().getNextIncidence(ecs[2], EdgeDirection.OUT));
    assertNull(e4.getReversedEdge().getNextIncidence(ecs[0], EdgeDirection.IN));
    assertNull(e4.getReversedEdge().getNextIncidence(ecs[1], EdgeDirection.IN));
    assertNull(e4.getReversedEdge().getNextIncidence(ecs[2], EdgeDirection.IN));
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClassEdgeDirection2() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    for (int i = 0; i < RANDOM_GRAPH_COUNT; i++) {
      switch (implementationType) {
        case STANDARD:
      ...
      for (int j = 0; j < RANDOM_EDGE_COUNT; j++) {
        ...
        if (edgetype == 0) {
          Edge e = direction ? g.createLink(v0, v1) : g.createLink(v1, v0);
          if (direction) {
            edges[j] = e;
            if (!first) {
        ...
        if (edgetype == 1) {
          Edge e = direction ? g.createSubLink(v0, v1) : g.createSubLink(v1, v0);
          if (direction) {
            edges[j] = e;
            if (!first) {
              while (lastlinkinout < j) {
          ...
          Edge e = direction ? g.createLinkBack(v0, v1) : g.createLinkBack(v1, v0);
          if (direction) {
            edges[j] = e;
            if (!first) {
      ...
      for (int k = 0; k < edges.length; k++) {
        Edge e = edges[k];
        assertEquals(linkinout[k], e.getNextIncidence(ecs[0], EdgeDirection.INOUT));
        assertEquals(sublinkinout[k], e.getNextIncidence(ecs[1], EdgeDirection.INOUT));
        assertEquals(linkbackinout[k], e.getNextIncidence(ecs[2], EdgeDirection.INOUT));
        assertEquals(linkout[k], e.getNextIncidence(ecs[0], EdgeDirection.OUT));
        assertEquals(sublinkout[k], e.getNextIncidence(ecs[1], EdgeDirection.OUT));
        assertEquals(linkbackout[k], e.getNextIncidence(ecs[2], EdgeDirection.OUT));
        assertEquals(linkin[k], e.getNextIncidence(ecs[0], EdgeDirection.IN));
        assertEquals(sublinkin[k], e.getNextIncidence(ecs[1], EdgeDirection.IN));
        assertEquals(linkbackin[k], e.getNextIncidence(ecs[2], EdgeDirection.IN));
      }
      commit(g);
    }
  }
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClassEdgeDirection0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClassEdgeDirection1() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
    ...
    commit(g);
    createReadOnlyTransaction(g);
    assertEquals(e3.getReversedEdge(), e1.getNextIncidence(Link.class, EdgeDirection.INOUT));
    assertEquals(e3.getReversedEdge(), e1.getNextIncidence(SubLink.class, EdgeDirection.INOUT));
    assertEquals(e2, e1.getNextIncidence(LinkBack.class, EdgeDirection.INOUT));
    ...
    assertEquals(e3.getReversedEdge(), e1.getNextIncidence(Link.class, EdgeDirection.IN));
    assertEquals(e3.getReversedEdge(), e1.getNextIncidence(SubLink.class, EdgeDirection.IN));
    assertNull(e1.getNextIncidence(LinkBack.class, EdgeDirection.IN));
    assertEquals(e3.getReversedEdge(), e2.getNextIncidence(Link.class, EdgeDirection.INOUT));
    assertEquals(e3.getReversedEdge(), e2.getNextIncidence(SubLink.class, EdgeDirection.INOUT));
    assertEquals(e5, e2.getNextIncidence(LinkBack.class, EdgeDirection.INOUT));
    ...
    assertEquals(e3.getReversedEdge(), e2.getNextIncidence(Link.class, EdgeDirection.IN));
    assertEquals(e3.getReversedEdge(), e2.getNextIncidence(SubLink.class, EdgeDirection.IN));
    assertNull(e2.getNextIncidence(LinkBack.class, EdgeDirection.IN));
    assertEquals(e4, e3.getReversedEdge().getNextIncidence(Link.class, EdgeDirection.INOUT));
    assertNull(e3.getReversedEdge().getNextIncidence(SubLink.class, EdgeDirection.INOUT));
    assertEquals(e5, e3.getReversedEdge().getNextIncidence(LinkBack.class, EdgeDirection.INOUT));
    assertEquals(e4, e3.getReversedEdge().getNextIncidence(Link.class, EdgeDirection.OUT));
    assertNull(e3.getReversedEdge().getNextIncidence(SubLink.class, EdgeDirection.OUT));
    assertEquals(e5, e3.getReversedEdge().getNextIncidence(LinkBack.class, EdgeDirection.OUT));
    assertEquals(e4.getReversedEdge(), e3.getReversedEdge().getNextIncidence(Link.class, EdgeDirection.IN));
    assertNull(e3.getReversedEdge().getNextIncidence(SubLink.class, EdgeDirection.IN));
    assertNull(e3.getReversedEdge().getNextIncidence(LinkBack.class, EdgeDirection.IN));
    assertEquals(e4.getReversedEdge(), e4.getNextIncidence(Link.class, EdgeDirection.INOUT));
    assertNull(e4.getNextIncidence(SubLink.class, EdgeDirection.INOUT));
    assertEquals(e5, e4.getNextIncidence(LinkBack.class, EdgeDirection.INOUT));
    ...
    assertEquals(e4.getReversedEdge(), e4.getNextIncidence(Link.class, EdgeDirection.IN));
    ...
    assertNull(e4.getReversedEdge().getNextIncidence(Link.class, EdgeDirection.INOUT));
    assertNull(e4.getReversedEdge().getNextIncidence(SubLink.class, EdgeDirection.INOUT));
    assertEquals(e5, e4.getReversedEdge().getNextIncidence(LinkBack.class, EdgeDirection.INOUT));
    assertNull(e4.getReversedEdge().getNextIncidence(Link.class, EdgeDirection.OUT));
    assertNull(e4.getReversedEdge().getNextIncidence(SubLink.class, EdgeDirection.OUT));
    assertEquals(e5, e4.getReversedEdge().getNextIncidence(LinkBack.class, EdgeDirection.OUT));
    assertNull(e4.getReversedEdge().getNextIncidence(Link.class, EdgeDirection.IN));
    assertNull(e4.getReversedEdge().getNextIncidence(SubLink.class, EdgeDirection.IN));
    assertNull(e4.getReversedEdge().getNextIncidence(LinkBack.class, EdgeDirection.IN));
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClassEdgeDirection2() throws CommitFailedException {
    for (int i = 0; i < RANDOM_GRAPH_COUNT; i++) {
      switch (implementationType) {
        case STANDARD:
        g = VertexTestSchema.instance().createVertexTestGraph();
      ...
      for (int k = 0; k < edges.length; k++) {
        Edge e = edges[k];
        assertEquals(linkinout[k], e.getNextIncidence(Link.class, EdgeDirection.INOUT));
        assertEquals(sublinkinout[k], e.getNextIncidence(SubLink.class, EdgeDirection.INOUT));
        assertEquals(linkbackinout[k], e.getNextIncidence(LinkBack.class, EdgeDirection.INOUT));
        assertEquals(linkout[k], e.getNextIncidence(Link.class, EdgeDirection.OUT));
        assertEquals(sublinkout[k], e.getNextIncidence(SubLink.class, EdgeDirection.OUT));
        assertEquals(linkbackout[k], e.getNextIncidence(LinkBack.class, EdgeDirection.OUT));
        assertEquals(linkin[k], e.getNextIncidence(Link.class, EdgeDirection.IN));
        assertEquals(sublinkin[k], e.getNextIncidence(SubLink.class, EdgeDirection.IN));
        assertEquals(linkbackin[k], e.getNextIncidence(LinkBack.class, EdgeDirection.IN));
      }
      commit(g);
    }
  }
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClassBoolean0() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClassBoolean1() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClassBoolean2() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    for (int i = 0; i < RANDOM_GRAPH_COUNT; i++) {
      switch (implementationType) {
        case STANDARD:
      ...
      for (int j = 0; j < RANDOM_EDGE_COUNT; j++) {
        ...
        direction = rand.nextBoolean();
        if (edgetype == 0) {
          Edge e = direction ? g.createLink(v0, v1) : g.createLink(v1, v0).getReversedEdge();
          edges[j] = e;
          if (!first) {
        ...
        if (edgetype == 1) {
          Edge e = direction ? g.createSubLink(v0, v1) : g.createSubLink(v1, v0).getReversedEdge();
          edges[j] = e;
          if (!first) {
            while (lastlinkfalse < j) {
              linkfalse[lastlinkfalse] = e;
          ...
          Edge e = direction ? g.createLinkBack(v0, v1) : g.createLinkBack(v1, v0).getReversedEdge();
          edges[j] = e;
          if (!first) {
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClassBoolean0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClassBoolean1() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClassBoolean2() throws CommitFailedException {
    for (int i = 0; i < RANDOM_GRAPH_COUNT; i++) {
      switch (implementationType) {
        case STANDARD:
        g = VertexTestSchema.instance().createVertexTestGraph();
      ...
      for (int k = 0; k < edges.length; k++) {
        ...
        assertEquals(linkbackfalse[k], e.getNextIncidence(LinkBack.class));
      }
      commit(g);
    }
  }
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClassEdgeDirectionBoolean0() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClassEdgeDirectionBoolean1() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestEdgeClassEdgeDirectionBoolean2() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    for (int i = 0; i < RANDOM_GRAPH_COUNT; i++) {
      switch (implementationType) {
        case STANDARD:
      ...
      for (int j = 0; j < RANDOM_EDGE_COUNT; j++) {
        ...
        if (edgetype == 0) {
          ...
          if (direction) {
            ...
            if (!first) {
              while (lastlinkinoutfalse < j) {
                linkinoutfalse[lastlinkinoutfalse] = e.getReversedEdge();
                lastlinkinoutfalse++;
              }
              while (lastlinkinfalse < j) {
                linkinfalse[lastlinkinfalse] = e.getReversedEdge();
                lastlinkinfalse++;
              }
              while (lastlinkinouttrue < j) {
                linkinouttrue[lastlinkinouttrue] = e.getReversedEdge();
                lastlinkinouttrue++;
              }
              while (lastlinkintrue < j) {
                linkintrue[lastlinkintrue] = e.getReversedEdge();
                lastlinkintrue++;
              }
            }
          }
      ...
      for (int k = 0; k < edges.length; k++) {
        Edge e = edges[k];
        assertEquals(linkinoutfalse[k], e.getNextIncidence(ecs[0], EdgeDirection.INOUT));
        assertEquals(sublinkinout[k], e.getNextIncidence(ecs[1], EdgeDirection.INOUT));
        assertEquals(linkbackinout[k], e.getNextIncidence(ecs[2], EdgeDirection.INOUT));
        assertEquals(linkoutfalse[k], e.getNextIncidence(ecs[0], EdgeDirection.OUT));
        assertEquals(sublinkout[k], e.getNextIncidence(ecs[1], EdgeDirection.OUT));
        assertEquals(linkbackout[k], e.getNextIncidence(ecs[2], EdgeDirection.OUT));
        assertEquals(linkinfalse[k], e.getNextIncidence(ecs[0], EdgeDirection.IN));
        assertEquals(sublinkin[k], e.getNextIncidence(ecs[1], EdgeDirection.IN));
        assertEquals(linkbackin[k], e.getNextIncidence(ecs[2], EdgeDirection.IN));
      }
      commit(g);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClassEdgeDirectionBoolean0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClassEdgeDirectionBoolean1() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassTestClassEdgeDirectionBoolean2() throws CommitFailedException {
    for (int i = 0; i < RANDOM_GRAPH_COUNT; i++) {
      switch (implementationType) {
        case STANDARD:
        g = VertexTestSchema.instance().createVertexTestGraph();
      ...
      for (int k = 0; k < edges.length; k++) {
        Edge e = edges[k];
        assertEquals(linkinoutfalse[k], e.getNextIncidence(Link.class, EdgeDirection.INOUT));
        assertEquals(sublinkinout[k], e.getNextIncidence(SubLink.class, EdgeDirection.INOUT));
        assertEquals(linkbackinout[k], e.getNextIncidence(LinkBack.class, EdgeDirection.INOUT));
        assertEquals(linkoutfalse[k], e.getNextIncidence(Link.class, EdgeDirection.OUT));
        assertEquals(sublinkout[k], e.getNextIncidence(SubLink.class, EdgeDirection.OUT));
        assertEquals(linkbackout[k], e.getNextIncidence(LinkBack.class, EdgeDirection.OUT));
        assertEquals(linkinfalse[k], e.getNextIncidence(Link.class, EdgeDirection.IN));
        assertEquals(sublinkin[k], e.getNextIncidence(SubLink.class, EdgeDirection.IN));
        assertEquals(linkbackin[k], e.getNextIncidence(LinkBack.class, EdgeDirection.IN));
      }
      commit(g);
  ...
  private Vertex[] createRandomGraph(boolean retThis) throws CommitFailedException {
    createTransaction(g);
    Vertex[] nodes = new Vertex[] { g.createSubNode(), g.createDoubleSubNode(), g.createSuperNode() };
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getThisTest0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getThisTest1() throws CommitFailedException {
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getThatTest0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    DoubleSubNode v3 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getThatTest1() throws CommitFailedException {
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getThisRoleTest() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getThatRoleTest() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeInGraphTestR0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  private ArrayList<ArrayList<Edge>> createRandomGraph(boolean edgeClass, boolean nosubclasses) throws CommitFailedException {
    createTransaction(g);
    Vertex[] nodes = new Vertex[] { g.createSubNode(), g.createDoubleSubNode(), g.createSuperNode() };
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getPrevEdgeInGraphTestR0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getPrevEdgeInGraphTest0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getPrevEdgeInGraphTest1() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v1);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getPrevEdgeInGraphTest2() throws CommitFailedException {
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassInGraphTestEdgeClass0() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassInGraphTestEdgeClass1() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassInGraphTestEdgeClass2() throws CommitFailedException {
    EdgeClass[] ecs = getEdgeClasses();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassInGraphTestClass0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassInGraphTestClass1() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassInGraphTestClass2() throws CommitFailedException {
    ArrayList<ArrayList<Edge>> result = createRandomGraph(true, false);
    createReadOnlyTransaction(g);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNextEdgeOfClassInGraphTestClassBoolean0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void isBeforeTest2() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void isBeforeTest3() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void isAfterTest2() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void isAfterTest3() throws CommitFailedException {
    Edge e1;
    Edge e2;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void isBeforeInGraphTest0() throws CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    Edge e1 = g.createLink(v1, v1);
    commit(g);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void isAfterInGraphTest0() throws CommitFailedException {
    Edge e1;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getNormalEdgeTest0() throws CommitFailedException {
    Edge e1;
    Edge e2;
    Edge e3;
    createTransaction(g);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getReversedEdgeTest0() throws CommitFailedException {
    Edge e1;
    Edge e2;
    Edge e3;
    createTransaction(g);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void isNormalTest0() throws CommitFailedException {
    Edge e1;
    Edge e2;
    Edge e3;
    createTransaction(g);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void isValidTest0() throws CommitFailedException {
    Edge e1;
    Edge e2;
    Edge e3;
    createTransaction(g);
  ...
  private VertexTestGraph createAnotherGraph() {
    ...
    switch (implementationType) {
      ...
      break;
      case TRANSACTION:
      anotherGraph = VertexTestSchema.instance().createVertexTestGraphWithTransactionSupport();
      break;
      case DATABASE:
      anotherGraph = dbHandler.createVertexTestGraphWithDatabaseSupport("anotherGraph");
      break;
      default:
      fail("Implementation " + implementationType + " not yet supported by this test.");
    }
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void writeReadAttributeValues0() throws GraphIOException, IOException, CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    ...
    g.save("test.tg");
    commit(g);
    LineNumberReader reader = new LineNumberReader(new FileReader("test.tg"));
    String line = "";
    String[] parts = null;
    while ((line = reader.readLine()) != null) {
      ...
      parts = line.split(" ");
      createReadOnlyTransaction(g);
      if (parts[0].equals(((Integer) e1.getId()).toString()) && parts[1].equals(e1.getClass().getName())) {
        commit(g);
        break;
      }
      commit(g);
  ...
  private VertexTestGraph loadTestGraph() throws GraphIOException {
    ...
    switch (implementationType) {
      case DATABASE:
      case STANDARD:
      loadedgraph = (VertexTestGraph) GraphIO.loadGraphFromFileWithStandardSupport("test.tg", null);
      break;
      case TRANSACTION:
      loadedgraph = (VertexTestGraph) GraphIO.loadGraphFromFileWithTransactionSupport("test.tg", null);
      break;
      default:
      fail("Implementation " + implementationType + " not yet supported by this test.");
    }
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void writeReadAttributeValues1() throws GraphIOException, IOException, CommitFailedException {
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    DoubleSubNode v2 = g.createDoubleSubNode();
    SubLink e1 = g.createSubLink(v1, v2);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void getAttributeTestR0() throws CommitFailedException {
    SubLink e;
    createTransaction(g);
    DoubleSubNode v = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void setAttributeTestR0() throws CommitFailedException {
    SubLink e;
    createTransaction(g);
    DoubleSubNode v = g.createDoubleSubNode();
    e = (SubLink) g.createSubLink(v, v).getReversedEdge();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void compareToTestR0() throws CommitFailedException {
    Edge e1;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void compareToTestR1() throws CommitFailedException {
    Edge e1;
    Edge e2;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void compareToTestR2() throws CommitFailedException {
    Edge e1;
    Edge e2;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void compareToTestM0() throws CommitFailedException {
    Edge e1;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    e1 = g.createLink(v1, v1);
  ...
  /**
	 ...
	 * @throws CommitFailedException
	 */
  @Test public void compareToTestM1() throws CommitFailedException {
    Edge e1;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    e1 = g.createLink(v1, v1);
  ...
  @Test public void getAnIntTest() throws CommitFailedException {
    SubLink e1;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
  ...
  @Test public void getAStringTest() throws CommitFailedException {
    SubLink e1;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
    e1 = g.createSubLink(v1, v1);
  ...
  @Test public void getNextLinkInGraphTest() throws CommitFailedException {
    SubLink e1;
    SubLink e3;
    Link e4;
    createTransaction(g);
  ...
  @Test public void getNextSubLinkInGraphTest() throws CommitFailedException {
    SubLink e1;
    SubLink e4;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
  ...
  @Test public void getNextLinkTest() throws CommitFailedException {
    SubLink e1;
    Link e3;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
  ...
  @Test public void getNextSubLinkTest() throws CommitFailedException {
    SubLink e1;
    SubLink e4;
    createTransaction(g);
    DoubleSubNode v1 = g.createDoubleSubNode();
  ...
  @Test public void getNextLinkTestEdgeDirection() throws CommitFailedException {
    SubLink e1;
    Link e3;
    Link e5;
    createTransaction(g);
    ...
    assertEquals(e3.getReversedEdge(), ((SubLink) e1.getReversedEdge()).getNextLinkIncidence(EdgeDirection.INOUT));
    assertEquals(e3.getReversedEdge(), ((SubLink) e1.getReversedEdge()).getNextLinkIncidence(EdgeDirection.IN));
    assertEquals(e5, ((SubLink) e1.getReversedEdge()).getNextLinkIncidence(EdgeDirection.OUT));
    assertEquals(e5, ((Link) e3.getReversedEdge()).getNextLinkIncidence(EdgeDirection.INOUT));
    assertEquals(null, ((Link) e3.getReversedEdge()).getNextLinkIncidence(EdgeDirection.IN));
    assertEquals(e5, ((Link) e3.getReversedEdge()).getNextLinkIncidence(EdgeDirection.OUT));
  ...
  @Test public void getNextSubLinkTestEdgeDirection() throws CommitFailedException {
    SubLink e1;
    SubLink e5;
    SubLink e6;
    createTransaction(g);
    ...
    commit(g);
    createReadOnlyTransaction(g);
    assertEquals(e1.getReversedEdge(), e1.getNextSubLinkIncidence(EdgeDirection.INOUT));
    assertEquals(e1.getReversedEdge(), e1.getNextSubLinkIncidence(EdgeDirection.IN));
    assertEquals(e5, e1.getNextLinkIncidence(EdgeDirection.OUT));
    assertEquals(e5, ((SubLink) e1.getReversedEdge()).getNextSubLinkIncidence(EdgeDirection.INOUT));
    assertEquals(e6.getReversedEdge(), ((SubLink) e1.getReversedEdge()).getNextSubLinkIncidence(EdgeDirection.IN));
    assertEquals(e5, ((SubLink) e1.getReversedEdge()).getNextSubLinkIncidence(EdgeDirection.OUT));
    assertEquals(e6.getReversedEdge(), e5.getNextSubLinkIncidence(EdgeDirection.INOUT));
    ...
    assertEquals(null, ((SubLink) e6.getReversedEdge()).getNextSubLinkIncidence(EdgeDirection.INOUT));
    assertEquals(null, ((SubLink) e6.getReversedEdge()).getNextSubLinkIncidence(EdgeDirection.IN));
    assertEquals(null, ((SubLink) e6.getReversedEdge()).getNextSubLinkIncidence(EdgeDirection.OUT));
    commit(g);
  }
}