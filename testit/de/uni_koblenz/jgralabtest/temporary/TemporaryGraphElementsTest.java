...
public class TemporaryGraphElementsTest {
  ...
  @Test public void testCreatingTemporaryGraphElements() throws GraphIOException {
  ...
  @Test public void testBlessTemporaryVertices() {
    ...
    assertEquals(alphaIncidence.getNormalEdge(), omegaIncidence.getNormalEdge());
  }

  @Test public void testTransformVertex() throws GraphIOException {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    Vertex v1 = g.createVertex(schema.getGraphClass().getVertexClass("ParkingGarage"));
    Vertex v2 = g.createVertex(schema.getGraphClass().getVertexClass("Intersection"));
    ...
    e2.setPreliminaryType(schema.getGraphClass().getEdgeClass("Street"));
    int e2_id = e2.getId();
    TemporaryEdge e3 = g.createTemporaryEdge(schema.getGraphClass().getEdgeClass("Bridge"), v2, tempv);
    int e3_id = e3.getId();
    TemporaryEdge e4 = g.createTemporaryEdge(schema.getGraphClass().getEdgeClass("Street"), tempv, v1);
    int e4_id = e4.getId();
    ...
    Vertex v = tempv.bless(schema.getGraphClass().getVertexClass("Intersection"));
    assertTrue(v.isValid());
    assertFalse(tempv.isValid());
    assertEquals(g.getEdge(e2_id).getReversedEdge(), v.getFirstIncidence());
    assertEquals(g.getEdge(e3_id).getReversedEdge(), v.getFirstIncidence().getNextIncidence());
    assertEquals(g.getEdge(e4_id), v.getFirstIncidence().getNextIncidence().getNextIncidence());
  ...
  @Test(expected = GraphIOException.class) public void testExceptionWhileSaving() throws GraphIOException {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    Vertex v1 = g.createVertex(schema.getGraphClass().getVertexClass("ParkingGarage"));
    Vertex v2 = g.createVertex(schema.getGraphClass().getVertexClass("Intersection"));
  ...
  @Test public void testFirstVertexTemp() throws GraphIOException {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    TemporaryVertex tempv = g.createTemporaryVertex();
    Edge e = g.createTemporaryEdge(schema.getGraphClass().getEdgeClass("Street"), tempv, tempv);
    Vertex v = g.createVertex(schema.getGraphClass().getVertexClass("Intersection"));
    Vertex transformed = tempv.bless(schema.getGraphClass().getVertexClass("Intersection"));
  ...
  @Test public void testTransformEdge() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    Vertex v1 = g.createVertex(schema.getGraphClass().getVertexClass("ParkingGarage"));
    Vertex v2 = g.createVertex(schema.getGraphClass().getVertexClass("Intersection"));
    TemporaryEdge tempEdge1 = g.createTemporaryEdge(v1, v2);
    Edge transEdge1 = tempEdge1.bless(schema.getGraphClass().getEdgeClass("Bridge"));
  ...
  @Test public void testTransformEdge2() throws GraphIOException {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    Vertex v1 = g.createVertex(schema.getGraphClass().getVertexClass("ParkingGarage"));
    Vertex v2 = g.createVertex(schema.getGraphClass().getVertexClass("Intersection"));
  ...
  @Test(expected = TemporaryGraphElementException.class) public void testWrongAttributeValue() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
  ...
  @Test public void testTransformFreeID() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
  ...
  @Test public void testIsTemporary() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    Vertex v1 = g.createVertex(g.getGraphClass().getVertexClass("Intersection"));
    ...
    Edge e1 = g.createTemporaryEdge(schema.getGraphClass().getEdgeClass("Bridge"), v1, v2);
    assertTrue(e1.isTemporary());
    Edge e2 = g.createTemporaryEdge(v2, v1);
    assertTrue(e2.isTemporary());
  }

  @Test public void testGetTemporaryClasses() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    Vertex v1 = g.createVertex(g.getGraphClass().getVertexClass("Intersection"));
  ...
  @Test public void testConvertTemporaryEdge() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    Vertex v1 = g.createVertex(g.getGraphClass().getVertexClass("Intersection"));
    Vertex v2 = g.createVertex(g.getGraphClass().getVertexClass("Intersection"));
    ...
    Edge e6_3_2 = e6_3_2_t.bless(schema.getGraphClass().getEdgeClass("Bridge"));
  ...
  @Test public void testConvertTemporaryVertex() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    Vertex v1 = g.createVertex(g.getGraphClass().getVertexClass("Intersection"));
    Vertex v2 = g.createVertex(g.getGraphClass().getVertexClass("Intersection"));
    Vertex v3 = g.createVertex(g.getGraphClass().getVertexClass("Intersection"));
    Edge e2_2_3 = g.createTemporaryEdge(schema.getGraphClass().getEdgeClass("Street"), v2, v3);
    int id_e2_2_3 = e2_2_3.getId();
    TemporaryVertex v4_t = g.createTemporaryVertex();
    Edge e4_4_2 = g.createTemporaryEdge(schema.getGraphClass().getEdgeClass("Street"), v4_t, v2);
    int id_e4_4_2 = e4_4_2.getId();
    e2_2_3.setOmega(v4_t);
    Edge e5_1_4 = g.createTemporaryEdge(schema.getGraphClass().getEdgeClass("Street"), v1, v4_t);
    ...
    Vertex v4 = v4_t.bless(schema.getGraphClass().getVertexClass("Intersection"));
  ...
  @Test public void testHasTemporaryGraphElements() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
  ...
  @Test public void testCreateTempEdgeAtTempVertexAuto() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
  ...
  @Test public void testFailBlessEdge() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    Vertex v1 = g.createVertex(schema.getGraphClass().getVertexClass("Intersection"));
    TemporaryVertex tempv2 = g.createTemporaryVertex();
  ...
  @Test public void testPreliminaryTypeForTemporaryVertex() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    TemporaryVertex tempV1 = g.createTemporaryVertex(schema.getGraphClass().getVertexClass("Intersection"));
  ...
  @Test public void testBlessNonTemporaryElements() {
    Schema schema = CityMapSchema.instance();
    Graph g = schema.createGraph(impl);
    Vertex v1 = g.createVertex(schema.getGraphClass().getVertexClass("Intersection"));
