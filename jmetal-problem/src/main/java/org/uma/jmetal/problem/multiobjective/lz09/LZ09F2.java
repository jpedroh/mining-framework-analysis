 ...
 */
@SuppressWarnings(value = { "serial" }) public class LZ09F2 extends AbstractDoubleProblem {
  private LZ09 lz09;
   ...
   */
  public LZ09F2(Integer ptype, Integer dtype, Integer ltype) throws JMetalException {
    setNumberOfVariables(30);
    setNumberOfObjectives(2);
    setNumberOfConstraints(0);
    setName("LZ09F2");
    lz09 = new LZ09(getNumberOfVariables(), getNumberOfObjectives(), ptype, dtype, ltype);
