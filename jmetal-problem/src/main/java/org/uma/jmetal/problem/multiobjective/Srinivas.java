...
@SuppressWarnings(value = { "serial" }) public class Srinivas extends AbstractDoubleProblem {
  /** Constructor */
  public Srinivas() {
  ...
  public void evaluateConstraints(DoubleSolution solution) {
    ...
    IntStream.range(0, getNumberOfConstraints()).forEach((i) -> solution.constraints()[i] = constraint[i]);
  }
}