 ...
 */
@SuppressWarnings(value = { "serial" }) public class LZ09F6 extends AbstractDoubleProblem {
  private LZ09 lz09;
   ...
   */
  public LZ09F6(Integer ptype, Integer dtype, Integer ltype) throws JMetalException {
