...
public class CgenTask extends BaseCayenneTask {
  ...
  /**
     ...
     */
  @Input @Optional private String excludeEmbeddables;
  ...
  /**
     ...
     * <code>true</code>).
     */
  @Input @Optional private Boolean makePairs;
  ...
  /**
     ...
     * (Default is &quot;entity&quot;)
     */
  @Input @Optional private String mode;

  /**
     * Name of file for generated output. (Default is &quot;*.java&quot;)
     */
  @Input @Optional private String outputPattern;
  ...
  /**
     ...
     */
  @Input @Optional private Boolean overwrite;
  ...
  /**
     ...
     */
  @Input @Optional private String superPkg;
  ...
  /**
     ...
     */
  @Input @Optional private String superTemplate;

  /**
     * Location of Velocity template file for Entity class generation. If
     * omitted, default template is used.
     */
  @Input @Optional private String template;
  ...
  /**
     ...
     * omitted, default template is used.
     */
  @Input @Optional private String embeddableSuperTemplate;

  /**
     * Location of Velocity template file for Embeddable class generation. If
     * omitted, default template is used.
     */
  @Input @Optional private String embeddableTemplate;
  ...
  /**
     ...
     */
  @Input @Optional private Boolean usePkgPath;

  /**
     * If set to <code>true</code>, will generate String Property names.
     * Default is <code>false</code>.
     */
  @Input @Optional private Boolean createPropertyNames;

  /**
     * Force run (skip check for files modification time)
     * @since 4.1
     */
  @Input private boolean force;
  ...
  /**
     ...
     */
  @Input @Optional private String dataMapTemplate;
  ...
  /**
     ...
     */
  @Input @Optional private String dataMapSuperTemplate;
  ...
  /**
     ...
     * @since 4.1
     */
  @Input @Optional private Boolean createPKProperties;

  /**
     * Optional path (classpath or filesystem) to external velocity tool configuration file
     * @since 4.2
     */
  @Input @Optional private String externalToolConfig;
  ...
  @TaskAction public void generate() {
    ...
    injector = new ToolsInjectorBuilder().addModule(new ToolsModule(LoggerFactory.getLogger(CgenTask.class))).create();
  ...
  CgenConfiguration buildConfiguration(DataMap dataMap) {
    ...
    if (hasConfig()) {
      ...
      if (metaData != null && metaData.get(dataMap, CgenConfiguration.class) != null) {
    ...
    if (destDir != null) {
      ...
      if (destDirName != null) {
        ...
        getProject().getPlugins().withType(JavaPlugin.class, new Action<JavaPlugin>() {
          @Override public void execute(final JavaPlugin plugin) {
  ...
  @InputFile public File getDataMapFile() {
    return super.getDataMapFile();
  }

  @Optional @OutputDirectory public File getDestDir() {
    return destDir;
  }
  ...
  @Optional @InputDirectory public File getAdditionalMaps() {
