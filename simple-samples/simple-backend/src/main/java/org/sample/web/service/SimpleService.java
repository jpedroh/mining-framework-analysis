...
@Service public class SimpleService {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "person") public ExtDirectStoreReadResult<Person> loadPeople(ExtDirectStoreReadRequest request) throws Exception {
    logger.info("listPeople -> " + request);
    PersonForm form = beanUtils.buildFormFromParams(request.getParams(), PersonForm.class);
    SqlStandardControl sqlControl = (form.getId() == null) ? beanUtils.buildControlFromParams(request) : new SqlStandardControl();
    ...
    ExtDirectStoreReadResult<Person> result = new ExtDirectStoreReadResult<Person>(new Long(count.getCount()), people, true);
    logger.info("listPeople <- " + result);
    return result;
  }

  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "person") public ExtDirectFormPostResult createPerson(@Valid Person person, BindingResult result) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "person") public ExtDirectFormPostResult updatePerson(@Valid Person person, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Person resultPerson = null;
    if (!result.hasErrors()) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "person") public ExtDirectFormPostResult deletePerson(Person person, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Person resultPerson = null;
    if (!result.hasErrors()) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "person") public ExtDirectStoreReadResult<Contact> loadContacts(ExtDirectStoreReadRequest request) throws Exception {
    ...
    ExtDirectStoreReadResult<Contact> result = new ExtDirectStoreReadResult<Contact>(new Long(count.getCount()), contacts, true);
    logger.info("loadContacts <- " + result);
    return result;
  }

  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "person") public ExtDirectFormPostResult createContact(@Valid Contact contact, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "person") public ExtDirectFormPostResult updateContact(@Valid Contact contact, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Contact resultContact = null;
    if (!result.hasErrors()) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "person") public ExtDirectFormPostResult deleteContact(Contact contact, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Contact resultContact = null;
    if (!result.hasErrors()) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "person") public ExtDirectStoreReadResult<Country> loadCountries(ExtDirectStoreReadRequest request) throws Exception {
    ...
    ExtDirectStoreReadResult<Country> result = new ExtDirectStoreReadResult<Country>(new Long(count.getCount()), contacts, true);
    logger.info("loadCountries <- " + result);
    return result;
  }

  @ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "person") public ExtDirectStoreReadResult<Relative> loadRelatives(ExtDirectStoreReadRequest request) throws Exception {
    ...
    ExtDirectStoreReadResult<Relative> result = new ExtDirectStoreReadResult<Relative>(new Long(count.getCount()), relatives, true);
    logger.info("loadRelatives <- " + result);
    return result;
  }

  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "person") public ExtDirectFormPostResult createRelative(@Valid Relative relative, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "person") public ExtDirectFormPostResult updateRelative(@Valid Relative relative, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Relative resultRelative = null;
    if (!result.hasErrors()) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "person") public ExtDirectFormPostResult deleteRelative(Relative relative, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Relative resultRelative = null;
    if (!result.hasErrors()) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "auth") public ExtDirectStoreReadResult<Authuser> loadAuthusers(ExtDirectStoreReadRequest request) throws Exception {
    ...
    ExtDirectStoreReadResult<Authuser> result = new ExtDirectStoreReadResult<Authuser>(new Long(count.getCount()), authusers, true);
    logger.info("loadAuthusers <- " + result);
    return result;
  }

  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "auth") public ExtDirectFormPostResult createAuthuser(@Valid Authuser authuser, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "auth") public ExtDirectFormPostResult updateAuthuser(@Valid Authuser authuser, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Authuser resultAuthuser = null;
    if (!result.hasErrors()) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "auth") public ExtDirectFormPostResult deleteAuthuser(Authuser authuser, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Authuser resultAuthuser = null;
    if (!result.hasErrors()) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "auth") public ExtDirectStoreReadResult<Authrole> loadAuthroles(ExtDirectStoreReadRequest request) throws Exception {
    ...
    ExtDirectStoreReadResult<Authrole> result = new ExtDirectStoreReadResult<Authrole>(new Long(count.getCount()), authroles, true);
    logger.info("loadAuthroles <- " + result);
    return result;
  }

  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "auth") public ExtDirectFormPostResult createAuthrole(@Valid Authrole authrole, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "auth") public ExtDirectFormPostResult updateAuthrole(@Valid Authrole authrole, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Authrole resultAuthrole = null;
    if (!result.hasErrors()) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "auth") public ExtDirectFormPostResult deleteAuthrole(Authrole authrole, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Authrole resultAuthrole = null;
    if (!result.hasErrors()) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "auth") public ExtDirectStoreReadResult<Userrole> loadUserroles(ExtDirectStoreReadRequest request) throws Exception {
    ...
    ExtDirectStoreReadResult<Userrole> result = new ExtDirectStoreReadResult<Userrole>(new Long(count.getCount()), userroles, true);
    logger.info("loadUserroles <- " + result);
    return result;
  }

  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "auth") public ExtDirectFormPostResult createUserrole(@Valid Userrole userrole, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "auth") public ExtDirectFormPostResult updateUserrole(@Valid Userrole userrole, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Userrole resultUserrole = null;
    if (!result.hasErrors()) {
  ...
  @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "auth") public ExtDirectFormPostResult deleteUserrole(Userrole userrole, BindingResult result) {
    ExtDirectFormPostResult postResult = new ExtDirectFormPostResult(result);
    Userrole resultUserrole = null;
    if (!result.hasErrors()) {
  ...
  @Required public void setContactService(ContactService contactService) {
    this.contactService = contactService;
  }

  @Required public void setPersonService(PersonService personService) {
    this.personService = personService;
  }

  @Required public void setCountryService(CountryService countryService) {
    this.countryService = countryService;
  }

  @Required public void setRelativeService(RelativeService relativeService) {
    this.relativeService = relativeService;
  }

  @Required public void setAuthuserService(AuthuserService authuserService) {
    this.authuserService = authuserService;
  }

  @Required public void setAuthroleService(AuthroleService authroleService) {
    this.authroleService = authroleService;
  }

  @Required public void setUserroleService(UserroleService userroleService) {
    this.userroleService = userroleService;
  }

  @Required public void setBeanUtils(BeanExtJsUtils beanUtils) {
