...
public class SampleSqlProcessingIdPlugin implements SqlProcessingIdPlugin {
  ...
  @Override public String getProcessingId(String name, Object dynamicInputValues, SqlControl sqlControl) {
    String processingId = sqlControl != null ? sqlControl.getProcessingId() : null;
    if (processingId != null) {
      logger.info("name {}, id provided {}, input {}", name, processingId, (dynamicInputValues != null ? dynamicInputValues.getClass() : null));
      if (name.toUpperCase().startsWith("INSERT")) {
        return processingId;
      }
      Method gpiMethod = MethodUtils.getAccessibleMethod(dynamicInputValues.getClass(), "getProcessingId", new Class[] { Object[].class });
      if (gpiMethod != null) {
        Object[] firstMax = new Object[] { new Integer[] { (sqlControl != null ? sqlControl.getFirstResult() : null), (sqlControl != null ? sqlControl.getMaxResults() : null) } };
        try {
...
>>>>>>> /usr/src/app/output/hudec/sql-processor/4e7851a544957454ab1795647f56cee208cdabb5/simple-samples/simple-hsqldb/src/main/java/org/sample/SampleSqlProcessingIdPlugin.java/right.java
    ...
    Integer[] firstMax = { (sqlControl != null ? sqlControl.getFirstResult() : null), (sqlControl != null ? sqlControl.getMaxResults() : null) };
    if (dynamicInputValues instanceof Contact) {
      processingId = ((Contact) dynamicInputValues).getProcessingId(firstMax);
    } else {
      if (dynamicInputValues instanceof Person) {
        processingId = ((Person) dynamicInputValues).getProcessingId(firstMax);
      }
    }
    logger.info("name {}, id {}, input {}, sqlcid {}", name, processingId, (dynamicInputValues != null ? dynamicInputValues.getClass() : null), (sqlControl != null ? sqlControl.getProcessingId() : null));
    return processingId;
  }
}