...
@Pojo @SuppressWarnings(value = { "all" }) public class Contact implements Serializable {
  ...
  @NotNull @Size(max = 100) private String address;
  ...
  @Size(max = 100) private String phoneNumber;
  ...
  @Size(max = 100) private String xNote;
