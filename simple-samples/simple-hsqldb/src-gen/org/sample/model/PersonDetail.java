...
@Pojo @SuppressWarnings(value = { "all" }) public class PersonDetail implements Serializable {
  ...
  @Size(max = 200) private String disposition;
  ...
  @Size(max = 100) private String titles;
