...
public class GUIBackendTest {
  ...
  @Test public void adjustManualLocationShouldBeOk() throws Exception {
  ...
  @Test public void adjustManualLocationWithNoDirectionShouldNotMoveTheMachine() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
  ...
  @Test public void probeShouldBeOk() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
  ...
  @Test public void pauseResumeWhenInIdleShouldThrowException() throws Exception {
  ...
  @Test public void pauseResumeWhenDisconnectedShouldThrowException() throws Exception {
  ...
  @Test public void pauseResumeWhenSendingShouldPause() throws Exception {
  ...
  @Test public void pauseResumeWhenPausedShouldResume() throws Exception {
  ...
  @Test public void getSendRemainingDuration() throws Exception {
  ...
  @Test public void offsetShouldBeOk() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
  ...
  @Test public void connectShouldBeOk() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
  ...
  @Test(expected = Exception.class) public void connectWithUnknownFirmwareShouldNotBeOk() throws Exception {
    instance.connect("unknown", PORT, BAUD_RATE);
  }

  @Test(expected = Exception.class) public void connectWhenFailingToOpenControllerConnectionShouldNotBeOk() throws Exception {
    when(controller.openCommPort(settings.getConnectionDriver(), PORT, BAUD_RATE)).thenThrow(new Exception());
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
  }

  @Test public void connectWhenOpenControllerConnectionWasNotPossibleShouldNotBeOk() throws Exception {
  ...
  @Test public void isConnectedShouldReturnTrueIfConnected() throws Exception {
    when(controller.isCommOpen()).thenReturn(true);
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    assertTrue(instance.isConnected());
  }

  @Test public void isConnectedShouldReturnFalseIfNotConnected() throws Exception {
    when(controller.isCommOpen()).thenReturn(false);
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    assertFalse(instance.isConnected());
  }

  @Test public void isConnectedShouldReturnFalseIfNeverConnected() throws Exception {
    assertFalse(instance.isConnected());
  }

  @Test public void disconnectShouldCloseTheConnection() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    instance.disconnect();
  ...
  @Test public void sendGcodeCommandWhenConnectedShouldBeOk() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    when(controller.isCommOpen()).thenReturn(true);
  ...
  @Test(expected = Exception.class) public void sendGcodeCommandWhenNotConnectedShouldThrowException() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    when(controller.isCommOpen()).thenReturn(false);
    GcodeCommand gcodeCommand = new GcodeCommand("G00");
    when(controller.createCommand(any())).thenReturn(gcodeCommand);
  ...
  @Test public void getSettingsShouldBeOk() {
    Settings result = instance.getSettings();
    assertEquals(settings, result);
  }

  @Test public void getControlStateShouldBeOkWhenConnected() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    when(controller.getControlState()).thenReturn(ControlState.COMM_IDLE);
  ...
  @Test public void getControlStateShouldReturnStateDisconnectedWhenNotConnected() {
    ControlState result = instance.getControlState();
    assertEquals(ControlState.COMM_DISCONNECTED, result);
  }

  @Test public void getControllerShouldBeOkWhenConnected() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    IController result = instance.getController();
    assertEquals(controller, result);
  }

  @Test public void setGcodeFileShouldBeOk() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
  ...
  @Test(expected = IOException.class) public void getGcodeFileThatDoesNotExistShouldThrowException() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    instance.setGcodeFile(new File("does_not_exist.gcode"));
  }

  @Test public void getNumRowsShouldReturnNumberFromController() throws Exception {
  ...
  @Test public void getNumSentRowsShouldReturnNumberFromController() throws Exception {
  ...
  @Test public void setWorkPositionWithValueExpressionShouldSetPosition() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
  ...
  @Test public void setWorkPositionWithExpressionShouldSetPosition() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    ControllerStatus status = new ControllerStatus(ControllerState.IDLE, new Position(0, 0, 0, UnitUtils.Units.MM), new Position(11, 11, 11, UnitUtils.Units.MM));
    instance.statusStringListener(status);
  ...
  @Test public void setWorkPositionWithExpressionShouldSetNegativePosition() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    ControllerStatus status = new ControllerStatus(ControllerState.IDLE, new Position(0, 0, 0, UnitUtils.Units.MM), new Position(11, 11, 11, UnitUtils.Units.MM));
    instance.statusStringListener(status);
  ...
  @Test public void setWorkPositionWithAdditionExpression() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    ControllerStatus status = new ControllerStatus(ControllerState.IDLE, new Position(0, 0, 0, UnitUtils.Units.MM), new Position(11, 11, 11, UnitUtils.Units.MM));
    instance.statusStringListener(status);
  ...
  @Test public void setWorkPositionWithMultiplicationExpression() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    ControllerStatus status = new ControllerStatus(ControllerState.IDLE, new Position(0, 0, 0, UnitUtils.Units.MM), new Position(11, 11, 11, UnitUtils.Units.MM));
    instance.statusStringListener(status);
  ...
  @Test public void setWorkPositionWithMultiplicationExpressionWithoutValue() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    ControllerStatus status = new ControllerStatus(ControllerState.IDLE, new Position(0, 0, 0, UnitUtils.Units.MM), new Position(11, 11, 11, UnitUtils.Units.MM));
    instance.statusStringListener(status);
    instance.setWorkPositionUsingExpression(Axis.Z, "* 10");
  ...
  @Test public void setWorkPositionWithDivisionExpression() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    ControllerStatus status = new ControllerStatus(ControllerState.IDLE, new Position(0, 0, 0, UnitUtils.Units.MM), new Position(11, 11, 11, UnitUtils.Units.MM));
    instance.statusStringListener(status);
    instance.setWorkPositionUsingExpression(Axis.Z, "# / 10");
  ...
  @Test public void setWorkPositionWithDivisionExpressionhouldConvertHashToWorkPositionUnits() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
  ...
  @Test public void setWorkPositionWithDivisionExpressionWithoutValue() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    ControllerStatus status = new ControllerStatus(ControllerState.IDLE, new Position(0, 0, 0, UnitUtils.Units.MM), new Position(11, 11, 11, UnitUtils.Units.MM));
    instance.statusStringListener(status);
    instance.setWorkPositionUsingExpression(Axis.Z, "/ 10");
  ...
  @Test public void setWorkPositionWithDivisionExpressionShouldConvertToWorkPositionUnits() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
  ...
  @Test public void setWorkPositionWithSubtractionExpression() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    ControllerStatus status = new ControllerStatus(ControllerState.IDLE, new Position(0, 0, 0, UnitUtils.Units.MM), new Position(11, 11, 11, UnitUtils.Units.MM));
    instance.statusStringListener(status);
  ...
  @Test public void setWorkPositionMultipleAxes() throws Exception {
    instance.connect(FIRMWARE, PORT, BAUD_RATE);
    ControllerStatus status = new ControllerStatus(ControllerState.IDLE, new Position(0, 0, 0, UnitUtils.Units.MM), new Position(11, 11, 11, UnitUtils.Units.MM));
    instance.statusStringListener(status);
