...
public class BufferedCommunicatorTest {
  ...
  @AfterClass static public void teardown() throws IOException {
    FileUtils.forceDeleteOnExit(tempDir);
  }

  @Before public void setUp() throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException {
  ...
  /**
     ...
     */
  @Test public void testQueueStringForComm() {
  ...
  /**
     ...
     */
  @Test public void testSimpleQueueStringsStream() throws Exception {
  ...
  @Test public void testSimpleStreamStream() throws Exception {
  ...
  /**
     ...
     */
  @Test public void testActiveCommands() throws Exception {
  ...
  /**
     ...
     */
  @Test public void testPauseSendResume() throws Exception {
  ...
  /**
     ...
     */
  @Test public void testCancelSend() {
  ...
  /**
     ...
     */
  @Test public void testOpenCommPort() throws Exception {
  ...
  /**
     ...
     */
  @Test public void testCloseCommPort() throws Exception {
  ...
  /**
     ...
     */
  @Test public void testSendByteImmediately() throws Exception {
  ...
  /**
     ...
     */
  @Test public void testProcessedCommand() {
    System.out.println("processedCommand");
    System.out.println("-N/A for abstract class-");
  }

  @Test public void testStreamCommandsOrderStringCommandsFirst() throws Exception {
  ...
  @Test public void softResetShouldClearBuffersAndResumeOperation() {
    Connection connection = mock(Connection.class);
    instance.setConnection(connection);
  ...
  @Test public void responseMessageOnErrorShouldPauseTheCommunicator() {
    Connection connection = mock(Connection.class);
    instance.setConnection(connection);
    asl.add(new GcodeCommand("G0"));
    asl.add(new GcodeCommand("G0"));
  ...
  @Test public void responseMessageOnErrorShouldDispatchPauseEvent() {
    Connection connection = mock(Connection.class);
    instance.setConnection(connection);
  ...
  @Test public void responseMessageOnErrorOnManualCommandShouldPauseTheCommunicator() {
    Connection connection = mock(Connection.class);
    instance.setConnection(connection);
    cb.add(new GcodeCommand("G0"));
    cb.add(new GcodeCommand("G0"));
  ...
  @Test public void responseMessageOnErrorOnLastManualCommandShouldNotPauseTheCommunicator() {
    Connection connection = mock(Connection.class);
    instance.setConnection(connection);
    cb.add(new GcodeCommand("G0"));
    instance.streamCommands();
  ...
  @Test public void responseMessageOnErrorOnLastCommandShouldNotPauseTheCommunicator() {
    Connection connection = mock(Connection.class);
    instance.setConnection(connection);
    asl.add(new GcodeCommand("G0"));
    instance.streamCommands();
  ...
  @Test public void responseMessageOnErrorOnCommandStreamShouldPauseTheCommunicator() throws IOException, GcodeStreamReader.NotGcodeStreamFile {
    Connection connection = mock(Connection.class);
    instance.setConnection(connection);
    File gcodeFile = new File(tempDir, "gcodeFile");
    GcodeStreamWriter gcodeStreamWriter = new GcodeStreamWriter(gcodeFile);
  ...
  @Test public void responseMessageOnErrorOnLastCommandStreamShouldNotPauseTheCommunicator() throws IOException, GcodeStreamReader.NotGcodeStreamFile {
    Connection connection = mock(Connection.class);
    instance.setConnection(connection);
    File gcodeFile = new File(tempDir, "gcodeFile");
    GcodeStreamWriter gcodeStreamWriter = new GcodeStreamWriter(gcodeFile);
