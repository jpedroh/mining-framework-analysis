...
public class GcodeParserTest {
  ...
  /**
     ...
     */
  @Test public void testAddCommand_String() throws Exception {
  ...
  /**
     * Test of addCommand method, of class GcodeParser.
     */
  @Test public void testAddCommand_String_int() throws Exception {
    GcodeParser instance = new GcodeParser();
  ...
  /**
     ...
     */
  @Test public void testAddCommandProcessor() {
  ...
  /**
     ...
     */
  @Test public void testResetCommandProcessors() {
  ...
  /**
     ...
     */
  @Test public void testPreprocessCommandGood() throws Exception {
  ...
  @Test public void testPreprocessCommandFeedOverride() throws Exception {
  ...
  @Test public void testPreprocessCommandException() throws Exception {
  ...
  @Test public void autoLevelerProcessorSet() throws Exception {
  ...
  @Test public void nonGcodeIgnoresImplicitGcode() throws Exception {
    GcodeParser gcp = new GcodeParser();
    gcp.addCommandProcessor(new CommentProcessor());
  ...
  @Test public void doubleParenCommentWithCommentProcessorTest() throws Exception {
