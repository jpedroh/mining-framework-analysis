...
public class Settings {
  ...
  public void setFirmwareVersion(String firmwareVersion) {
    if (StringUtils.equals(firmwareVersion, this.firmwareVersion)) {
      return;
    }
  ...
  public void setPort(String port) {
    if (StringUtils.equals(port, this.port)) {
      return;
    }
    this.port = port;
    changed();
  ...
  public void setPortRate(String portRate) {
    if (StringUtils.equals(portRate, this.portRate)) {
      return;
    }
