...
public class CommandPanel extends JPanel implements UGSEventListener, MessageListener {
  ...
  private final JCheckBoxMenuItem showVerboseMenuItem = new JCheckBoxMenuItem(Localization.getString("mainWindow.swing.showVerboseOutputCheckBox"));

  private final JCheckBoxMenuItem scrollWindowMenuItem = new JCheckBoxMenuItem(Localization.getString("mainWindow.swing.scrollWindowCheckBox"));

  private final JMenuItem clearMenuItem = new JMenuItem(Localization.getString("mainWindow.swing.clearOutput"));
  ...
  /**
     ...
     */
  @Deprecated public CommandPanel() {
    this(null);
  }
  ...
  /**
     ...
     */
  @Override public void onMessage(MessageType messageType, String message) {
