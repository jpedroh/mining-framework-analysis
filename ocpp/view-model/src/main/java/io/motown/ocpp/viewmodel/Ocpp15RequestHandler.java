...
public class Ocpp15RequestHandler {
  ...
  @EventHandler public void handle(ConfigurationRequestedEvent event) {
  ...
  @EventHandler public void handle(StopTransactionRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(SoftResetChargingStationRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(HardResetChargingStationRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(StartTransactionRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(UnlockEvseRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(ChangeChargingStationAvailabilityToInoperativeRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(ChangeChargingStationAvailabilityToOperativeRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(DataTransferEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(ChangeConfigurationEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(DiagnosticsRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(ClearCacheRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(FirmwareUpdateRequestedEvent event) {
  ...
  @EventHandler public void handle(AuthorizationListVersionRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(SendAuthorizationListRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
  ...
  @EventHandler public void handle(ReserveNowRequestedEvent event, @MetaData(value = CorrelationToken.KEY) CorrelationToken statusCorrelationToken) {
