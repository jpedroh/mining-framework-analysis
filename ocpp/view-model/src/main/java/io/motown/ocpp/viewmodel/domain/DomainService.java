...
public class DomainService {
  ...
  public BootChargingStationResult bootChargingStation(ChargingStationId chargingStationId, String chargingStationAddress, String vendor, String model, String protocol, String chargingStationSerialNumber, String firmwareVersion, String iccid, String imsi, String meterType, String meterSerialNumber) {
    ...
    if (chargingStation == null) {
      ...
      commandGateway.send(new CreateChargingStationCommand(chargingStationId), new CreateChargingStationCommandCallback(chargingStationId, chargingStationAddress, vendor, model, protocol, chargingStationSerialNumber, firmwareVersion, iccid, imsi, meterType, meterSerialNumber, chargingStationRepository, this));
      return new BootChargingStationResult(false, heartbeatInterval, new Date());
    }
