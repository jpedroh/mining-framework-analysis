...
class VerifyMojoParametersTest {
  ...
  @BeforeEach void setup() throws SecurityException, IllegalArgumentException {
  ...
  @Test void parameterNrOfIndentSpaceShouldEndUpInXmlProcessor() {
  ...
  @Test void parameterSortDependenciesShouldEndUpInElementWrapperCreator() {
  ...
  @Test void parameterSortPluginsShouldEndUpInWrapperFactoryImpl() {
  ...
  private void testParameterMoveFromMojoToRestOfApplication(String parameterName, Object parameterValue, Object... whereParameterCanBeFound) {
  ...
  private void testParameterMoveFromMojoToRestOfApplicationForBoolean(String parameterName, Object... whereParameterCanBeFound) {
