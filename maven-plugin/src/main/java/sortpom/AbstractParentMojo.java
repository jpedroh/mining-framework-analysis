...
abstract class AbstractParentMojo extends AbstractMojo {
   ...
   * /&gt; or &lt;configuration/&gt;
   */
  @Parameter(property = "sort.spaceBeforeCloseEmptyElement", defaultValue = "false") boolean spaceBeforeCloseEmptyElement;

  /**
   * Should blank lines in the pom-file be preserved. A maximum of one line is preserved between
   * each tag.
   */
  @Parameter(property = "sort.keepBlankLines", defaultValue = "true") boolean keepBlankLines;
  ...
  @Parameter(property = "sort.predefinedSortOrder", defaultValue = "recommended_2008_06") String predefinedSortOrder;
   ...
   * present.
   */
  @Parameter(property = "sort.sortDependencyManagement") String sortDependencyManagement;
