...
public class RanksysRecommenderRunner extends AbstractRunner<Long, Long> {
  ...
  @Override public TemporalDataModelIF<Long, Long> run(final RUN_OPTIONS opts) throws RecommenderException, IOException {
  ...
  @Override public TemporalDataModelIF<Long, Long> run(final RUN_OPTIONS opts, final net.recommenders.rival.core.TemporalDataModelIF<Long, Long> trainingModel, final net.recommenders.rival.core.TemporalDataModelIF<Long, Long> testModel) throws RecommenderException {
    if (isAlreadyRecommended()) {
      return null;
    }
  ...
  public TemporalDataModelIF<Long, Long> runRanksysRecommender(final RUN_OPTIONS opts, final FastUserIndex<Long> userIndex, final FastItemIndex<Long> itemIndex, final FastPreferenceData<Long, Long> trainingModel, final FastPreferenceData<Long, Long> testModel) throws RecommenderException {
    if (isAlreadyRecommended()) {
      return null;
    }
