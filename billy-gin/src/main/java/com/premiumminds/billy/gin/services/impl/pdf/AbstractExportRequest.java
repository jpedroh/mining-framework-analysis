...
public class AbstractExportRequest implements ExportServiceRequest {
  private static final String DEFAULT_PATH_TEMPLATE = System.getProperty("java.io.tmpdir") + "/billy_export_request_%s_%d.pdf";
  ...
  public AbstractExportRequest(UID uid, BillyTemplateBundle bundle) {
    this.uid = uid;
    this.bundle = bundle;
    this.resultPath = String.format(AbstractExportRequest.DEFAULT_PATH_TEMPLATE, uid.toString(), System.currentTimeMillis());
  }
  ...
  @Override public BillyTemplateBundle getBundle() {
    return this.bundle;
  }

  @Override public String getResultPath() {
