...
public interface ExportService {
  ...
  @Deprecated public void addHandler(Class<? extends ExportServiceRequest> requestClass, ExportServiceHandler handler);

  public <T extends GenericInvoiceData> void addDataExtractor(Class<T> dataClass, BillyDataExtractor<T> dataExtractor);

  public void addTransformerMapper(Class<? extends ExportServiceRequest> requestClazz, Class<? extends BillyExportTransformer<? extends GenericInvoiceData, OutputStream>> transformerClazz);

  public <T extends GenericInvoiceData, O extends java.lang.Object> void export(UID uidDoc, BillyExportTransformer<T, O> dataTransformer, O output) throws ExportServiceException;
}