...
public class SymbolSolverWithJavassistEnumTest extends AbstractTest {
  ...
  @Test public void testSolveSymbolInTypeCanResolveFirstEnumValue() {
    assertCanSolveSymbol("ENUM_VAL_ONE", enumDeclarationConcrete);
  }

  @Test public void testSolveSymbolInTypeCanResolveSecondEnumValue() {
    assertCanSolveSymbol("ENUM_VAL_TWO", enumDeclarationConcrete);
  }

  @Test public void testSolveSymbolInTypeCanResolveFirstNormalField() {
