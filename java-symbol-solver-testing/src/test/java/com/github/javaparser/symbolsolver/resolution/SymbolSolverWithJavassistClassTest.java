...
public class SymbolSolverWithJavassistClassTest extends AbstractTest {
  ...
  @Test public void testSolveSymbolInTypeCanSolveFirstOwnField() {
    assertCanSolveSymbol("STATIC_STRING", classDeclarationConcreteClass);
  }

  @Test public void testSolveSymbolInTypeCanSolveSecondOwnField() {
    assertCanSolveSymbol("SECOND_STRING", classDeclarationConcreteClass);
  }

  @Test public void testSolveSymbolInTypeCantResolveNonExistentField() {
  ...
  @Test public void testSolveSymbolInTypeCanResolveFieldInSuper() {
    assertCanSolveSymbol("SUPER_FIELD", classDeclarationSubClassOwnJar);
  }

  @Test public void testSolveSymbolInTypeCanResolveFieldInSuperIncludedJar() {
    assertCanSolveSymbol("SUPER_FIELD", classDeclarationSubClassIncludedJar);
  }

  @Test public void testSolveSymbolInTypeThrowsExceptionOnResolveFieldInSuperExcludedJar() {
    try {
  ...
  @Test public void testSolveSymbolInTypeCanResolveFieldInInterface() {
    assertCanSolveSymbol("INTERFACE_FIELD", classDeclarationInterfaceUserOwnJar);
  }

  @Test public void testSolveSymbolInTypeCanResolveFieldInInterfaceIncludedJar() {
    assertCanSolveSymbol("INTERFACE_FIELD", classDeclarationInterfaceUserIncludedJar);
  }

  @Test public void testSolveSymbolInTypeThrowsExceptionOnResolveFieldInInterfaceExcludedJar() {
    try {
