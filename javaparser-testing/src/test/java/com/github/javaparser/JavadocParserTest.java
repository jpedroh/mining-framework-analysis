...
public class JavadocParserTest {
  @Test public void parseSimplestContent() {
    Assert.assertEquals(new Javadoc(JavadocDescription.parseText("A simple line of text")), JavadocParser.parse("A simple line of text"));
  }

  @Test public void parseSingleLineWithSpacing() {
  ...
  @Test public void parseSingleLineWithNewLines() {
    assertEquals(new Javadoc(JavadocDescription.parseText("The string image of the token.")), JavadocParser.parse(EOL + "   * The string image of the token." + EOL + "   "));
  }

  @Test public void parseCommentWithNewLines() {
  ...
  @Test public void parseCommentWithIndentation() {
  ...
  @Test public void parseBlockTagsAndEmptyDescription() {
  ...
  @Test public void parseBlockTagsAndProvideTagName() {
  ...
  @Test public void parseParamBlockTags() {
  ...
  @Test public void parseMultilineParamBlockTags() {
  ...
  @Test public void startsWithAsteriskEmpty() {
    assertEquals(-1, JavadocParser.startsWithAsterisk(""));
  }

  @Test public void startsWithAsteriskNoAsterisk() {
    assertEquals(-1, JavadocParser.startsWithAsterisk(" ciao"));
  }

  @Test public void startsWithAsteriskAtTheBeginning() {
    assertEquals(0, JavadocParser.startsWithAsterisk("* ciao"));
  }

  @Test public void startsWithAsteriskAfterSpaces() {
