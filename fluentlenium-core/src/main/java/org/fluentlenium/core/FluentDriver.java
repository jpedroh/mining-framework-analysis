 ...
 */
@SuppressWarnings(value = { "PMD.GodClass" }) public class FluentDriver extends FluentControlImpl implements FluentControl {
  ...
  @Override public void takeHtmlDump() {
    takeHtmlDump(new Date().getTime() + ".html");
  }

  @Override public void takeHtmlDump(String fileName) {
    File destFile = null;
    try {
  ...
  @Override public boolean canTakeScreenShot() {
  ...
  @Override public void takeScreenshot(String fileName) {
  ...
  @Override public EventsRegistry events() {
    if (events == null) {
  ...
  @Override public MouseActions mouse() {
    return mouseActions;
  }

  @Override public KeyboardActions keyboard() {
    return keyboardActions;
  }

  @Override public WindowAction window() {
    return windowAction;
  }

  @Override public FluentWait await() {
  ...
  @Override public String pageSource() {
    return getDriver().getPageSource();
  }

  @Override public <P extends FluentPage> P goTo(P page) {
    if (page == null) {
  ...
  @Override public void goTo(String url) {
    if (url == null) {
  ...
  @Override public void goToInNewTab(String url) {
    if (url == null) {
      throw new IllegalArgumentException("Url is mandatory");
    }
    String newTab;
  ...
  @Override public Capabilities capabilities() {
    ...
    Capabilities capabilities = currentDriver instanceof HasCapabilities ? ((HasCapabilities) currentDriver).getCapabilities() : null;
  ...
  @Override public FluentJavascript executeScript(String script, Object... args) {
    return new FluentJavascript((JavascriptExecutor) getDriver(), false, script, args);
  }

  @Override public FluentJavascript executeAsyncScript(String script, Object... args) {
    return new FluentJavascript((JavascriptExecutor) getDriver(), true, script, args);
  }

  @Override public FluentList<FluentWebElement> find(String selector, SearchFilter... filters) {
    return getSearch().find(selector, filters);
  }

  @Override public FluentList<FluentWebElement> find(By locator, SearchFilter... filters) {
    return getSearch().find(locator, filters);
  }

  @Override public FluentList<FluentWebElement> find(SearchFilter... filters) {
    return getSearch().find(filters);
  }

  @Override public FluentList<FluentWebElement> find(List<WebElement> rawElements) {
    return getSearch().find(rawElements);
  }

  @Override public FluentList<FluentWebElement> $(List<WebElement> rawElements) {
    return getSearch().$(rawElements);
  }

  @Override public FluentWebElement el(WebElement rawElement) {
    return getSearch().el(rawElement);
  }

  @Override public void switchTo(FluentList<? extends FluentWebElement> elements) {
    switchTo(elements.first());
  }

  @Override public void switchTo(FluentWebElement element) {
  ...
  @Override public void switchToDefault() {
    switchTo((FluentWebElement) null);
  }
  ...
  @Override public <L extends List<T>, T extends java.lang.Object> L newComponentList(Class<L> listClass, Class<T> componentClass) {
    return getComponentsManager().newComponentList(listClass, componentClass);
  }

  @Override public <T extends java.lang.Object> ComponentList asComponentList(Class<T> componentClass, Iterable<WebElement> elements) {
    return getComponentsManager().asComponentList(componentClass, elements);
  }

  @Override public <L extends List<T>, T extends java.lang.Object> L newComponentList(Class<L> listClass, Class<T> componentClass, T... componentsList) {
    return getComponentsManager().newComponentList(listClass, componentClass, componentsList);
  }

  @Override public <T extends FluentWebElement> FluentList<T> asFluentList(Class<T> componentClass, Iterable<WebElement> elements) {
    return getComponentsManager().asFluentList(componentClass, elements);
  }

  @Override public boolean isComponentClass(Class<?> componentClass) {
    return getComponentsManager().isComponentClass(componentClass);
  }

  @Override public <T extends java.lang.Object> ComponentList<T> asComponentList(Class<T> componentClass, List<WebElement> elements) {
    return getComponentsManager().asComponentList(componentClass, elements);
  }

  @Override public <T extends FluentWebElement> FluentList<T> asFluentList(Class<T> componentClass, WebElement... elements) {
    return getComponentsManager().asFluentList(componentClass, elements);
  }

  @Override public <T extends FluentWebElement> FluentList<T> newFluentList(Class<T> componentClass) {
    return getComponentsManager().newFluentList(componentClass);
  }

  @Override public FluentWebElement newFluent(WebElement element) {
    return getComponentsManager().newFluent(element);
  }

  @Override public boolean isComponentListClass(Class<? extends List<?>> componentListClass) {
    return getComponentsManager().isComponentListClass(componentListClass);
  }

  @Override public FluentList<FluentWebElement> asFluentList(WebElement... elements) {
    return getComponentsManager().asFluentList(elements);
  }

  @Override public FluentList<FluentWebElement> asFluentList(Iterable<WebElement> elements) {
    return getComponentsManager().asFluentList(elements);
  }

  @Override public <L extends List<T>, T extends java.lang.Object> L asComponentList(Class<L> listClass, Class<T> componentClass, WebElement... elements) {
    return getComponentsManager().asComponentList(listClass, componentClass, elements);
  }

  @Override public <L extends List<T>, T extends java.lang.Object> L asComponentList(Class<L> listClass, Class<T> componentClass, Iterable<WebElement> elements) {
    return getComponentsManager().asComponentList(listClass, componentClass, elements);
  }

  @Override public FluentList<FluentWebElement> asFluentList(List<WebElement> elements) {
    return getComponentsManager().asFluentList(elements);
  }

  @Override public <T extends FluentWebElement> FluentList<T> asFluentList(Class<T> componentClass, List<WebElement> elements) {
    return getComponentsManager().asFluentList(componentClass, elements);
  }

  @Override public <T extends java.lang.Object> ComponentList<T> asComponentList(Class<T> componentClass, WebElement... elements) {
    return getComponentsManager().asComponentList(componentClass, elements);
  }

  @Override public <T extends java.lang.Object> T newComponent(Class<T> componentClass, WebElement element) {
    return getComponentsManager().newComponent(componentClass, element);
  }

  @Override public <T extends java.lang.Object> ComponentList<T> newComponentList(Class<T> componentClass, T... componentsList) {
    return getComponentsManager().newComponentList(componentClass, componentsList);
  }

  @Override public <T extends java.lang.Object> ComponentList<T> newComponentList(Class<T> componentClass, List<T> componentsList) {
    return getComponentsManager().newComponentList(componentClass, componentsList);
  }

  @Override public <L extends List<T>, T extends java.lang.Object> L newComponentList(Class<L> listClass, Class<T> componentClass, List<T> componentsList) {
    return getComponentsManager().newComponentList(listClass, componentClass, componentsList);
  }

  @Override public FluentList<FluentWebElement> newFluentList() {
    return getComponentsManager().newFluentList();
  }

  @Override public FluentList<FluentWebElement> newFluentList(List<FluentWebElement> elements) {
    return getComponentsManager().newFluentList(elements);
  }

  @Override public <T extends java.lang.Object> ComponentList<T> newComponentList(Class<T> componentClass) {
    return getComponentsManager().newComponentList(componentClass);
  }

  @Override public FluentList<FluentWebElement> newFluentList(FluentWebElement... elements) {
    return getComponentsManager().newFluentList(elements);
  }

  @Override public <T extends FluentWebElement> FluentList<T> newFluentList(Class<T> componentClass, List<T> elements) {
    return getComponentsManager().newFluentList(componentClass, elements);
  }

  @Override public <T extends FluentWebElement> FluentList<T> newFluentList(Class<T> componentClass, T... elements) {
    return getComponentsManager().newFluentList(componentClass, elements);
  }

  @Override public <L extends List<T>, T extends java.lang.Object> L asComponentList(Class<L> listClass, Class<T> componentClass, List<WebElement> elements) {
    return getComponentsManager().asComponentList(listClass, componentClass, elements);
  }

  @Override public ContainerContext inject(Object container) {
    return getFluentInjector().inject(container);
  }

  @Override public <T extends java.lang.Object> T newInstance(Class<T> cls) {
    return getFluentInjector().newInstance(cls);
  }

  @Override public ContainerContext injectComponent(Object componentContainer, Object parentContainer, SearchContext searchContext) {
    return getFluentInjector().injectComponent(componentContainer, parentContainer, searchContext);
  }

  @Override public CssSupport css() {
