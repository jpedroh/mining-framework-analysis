 ...
 */
@SuppressWarnings(value = { "PMD.GodClass", "PMD.ExcessivePublicCount" }) public class FluentWebElement extends Component implements WrapsElement, FluentActions<FluentWebElement, FluentWebElement>, FluentProxyState<FluentWebElement>, SearchControl<FluentWebElement>, HookControl<FluentWebElement>, FluentLabel<FluentWebElement> {
  ...
  public <T extends java.lang.Object> T newComponent(Class<T> componentClass, WebElement element) {
  ...
  public <T extends java.lang.Object> ComponentList<T> newComponentList(Class<T> componentClass) {
    return control.newComponentList(componentClass);
  }

  public <T extends java.lang.Object> ComponentList<T> asComponentList(Class<T> componentClass, WebElement... elements) {
    return control.asComponentList(componentClass, elements);
  }

  public <T extends java.lang.Object> ComponentList asComponentList(Class<T> componentClass, Iterable<WebElement> elements) {
    return control.asComponentList(componentClass, elements);
  }

  public <T extends java.lang.Object> ComponentList<T> asComponentList(Class<T> componentClass, List<WebElement> elements) {
    return control.asComponentList(componentClass, elements);
  }

  public <T extends java.lang.Object> ComponentList<T> newComponentList(Class<T> componentClass, T... componentsList) {
    return control.newComponentList(componentClass, componentsList);
  }

  public <T extends java.lang.Object> ComponentList<T> newComponentList(Class<T> componentClass, List<T> componentsList) {
    return control.newComponentList(componentClass, componentsList);
  }

  public <L extends List<T>, T extends java.lang.Object> L newComponentList(Class<L> listClass, Class<T> componentClass) {
    return control.newComponentList(listClass, componentClass);
  }

  public <L extends List<T>, T extends java.lang.Object> L asComponentList(Class<L> listClass, Class<T> componentClass, WebElement... elements) {
    return control.asComponentList(listClass, componentClass, elements);
  }

  public <L extends List<T>, T extends java.lang.Object> L asComponentList(Class<L> listClass, Class<T> componentClass, Iterable<WebElement> elements) {
    return control.asComponentList(listClass, componentClass, elements);
  }

  public <L extends List<T>, T extends java.lang.Object> L asComponentList(Class<L> listClass, Class<T> componentClass, List<WebElement> elements) {
    return control.asComponentList(listClass, componentClass, elements);
  }

  public <L extends List<T>, T extends java.lang.Object> L newComponentList(Class<L> listClass, Class<T> componentClass, T... componentsList) {
    return control.newComponentList(listClass, componentClass, componentsList);
  }

  public <L extends List<T>, T extends java.lang.Object> L newComponentList(Class<L> listClass, Class<T> componentClass, List<T> componentsList) {
    return control.newComponentList(listClass, componentClass, componentsList);
  }
  ...
  @Override public FluentWebElement click() {
    webElement.click();
    return this;
  }

  @Override public FluentWebElement doubleClick() {
    mouse().doubleClick();
    return this;
  }

  @Override public FluentWebElement contextClick() {
    mouse().contextClick();
    return this;
  }
  ...
  @Override public FluentWebElement now() {
    LocatorProxies.now(webElement);
    return this;
  }

  @Override public FluentWebElement now(boolean force) {
    if (force) {
      reset();
    }
    return now();
  ...
  @Override public FluentWebElement reset() {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> T as(Class<T> componentClass) {
  ...
  @Override public Fill fill() {
    return new Fill(this);
  }

  @Override public FillSelect fillSelect() {
    return new FillSelect(this);
  }

  @Override public FluentWebElement frame() {
    control.window().switchTo().frame(this);
    return this;
  }

  @Override public Optional<FluentWebElement> optional() {
    if (present()) {
  ...
  @Override public <R extends java.lang.Object> R noHook(Class<? extends FluentHook> hook, Function<FluentWebElement, R> function) {
    return getHookControl().noHook(hook, function);
  }

  @Override public <O extends java.lang.Object, H extends FluentHook<O>> FluentWebElement withHook(Class<H> hook, O options) {
    return getHookControl().withHook(hook, options);
  }

  @Override public <O extends java.lang.Object, H extends FluentHook<O>> FluentWebElement withHook(Class<H> hook) {
    return getHookControl().withHook(hook);
  }

  @Override public FluentWebElement noHook(Class<? extends FluentHook>... hooks) {
    return getHookControl().noHook(hooks);
  }

  @Override public <R extends java.lang.Object> R noHook(Function<FluentWebElement, R> function) {
    return getHookControl().noHook(function);
  }

  @Override public FluentWebElement noHookInstance(Class<? extends FluentHook>... hooks) {
    return getHookControl().noHookInstance(hooks);
  }

  @Override public FluentWebElement restoreHooks() {
    return getHookControl().restoreHooks();
  }

  @Override public FluentWebElement noHookInstance() {
    return getHookControl().noHookInstance();
  }

  @Override public FluentWebElement noHook() {
    return getHookControl().noHook();
  }

  @Override public FluentWebElement scrollToCenter() {
    return getJavascriptActions().scrollToCenter();
  }

  @Override public FluentWebElement scrollIntoView() {
    return getJavascriptActions().scrollIntoView();
  }

  @Override public FluentWebElement scrollIntoView(boolean alignWithTop) {
    return getJavascriptActions().scrollIntoView(alignWithTop);
  }

  @Override public FluentWebElement modifyAttribute(String attributeName, String attributeValue) {
    return getJavascriptActions().modifyAttribute(attributeName, attributeValue);
  }

  @Override public FluentWebElement withLabelHint(String... labelHint) {
    return getLabel().withLabelHint(labelHint);
  }

  @Override public FluentWebElement withLabel(String label) {
