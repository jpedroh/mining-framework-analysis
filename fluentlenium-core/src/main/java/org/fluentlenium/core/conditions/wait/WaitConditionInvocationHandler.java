...
public class WaitConditionInvocationHandler<C extends Conditions<?>> implements InvocationHandler {
  ...
  private Object buildChildProxy(Method method, Object[] args) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    ...
    Conditions<?> childProxy = WaitConditionProxy.custom((Class<Conditions<?>>) method.getReturnType(), wait, context, () -> childConditions);
...
<<<<<<< /usr/src/app/output/fluentlenium/fluentlenium/acff62c50f349e5aa4eb516656f2f45e64c33661/fluentlenium-core/src/main/java/org/fluentlenium/core/conditions/wait/WaitConditionInvocationHandler.java/left.java
        "An internal error has occurred while waiting"
=======
        "An internal error has occured while waiting"
>>>>>>> /usr/src/app/output/fluentlenium/fluentlenium/acff62c50f349e5aa4eb516656f2f45e64c33661/fluentlenium-core/src/main/java/org/fluentlenium/core/conditions/wait/WaitConditionInvocationHandler.java/right.java
        , e);
