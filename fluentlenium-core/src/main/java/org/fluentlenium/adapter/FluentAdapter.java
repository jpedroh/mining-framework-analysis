...
public class FluentAdapter implements FluentControl {
  ...
  /**
     ...
     */
  @Delegate public Configuration getConfiguration() {
    return configuration;
  }

  @Delegate(types = FluentControl.class, excludes = { SeleniumDriverControl.class, Configuration.class }) private ContainerFluentControl getFluentControl() {
  ...
  @Override public final WebDriver getDriver() {
