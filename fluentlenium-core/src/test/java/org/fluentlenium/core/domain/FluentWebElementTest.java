...
@RunWith(value = MockitoJUnitRunner.class) @SuppressWarnings(value = { "PMD.ExcessivePublicCount" }) public class FluentWebElementTest {
  @Mock private LocatableElement element;

  @Mock private InputDevicesDriver driver;
  ...
  @Test public void testContextClick() {
    fluentElement.contextClick();
    verify(mouse).contextClick(any());
  }

  @Test public void testHoverOver() {
  ...
  @Test(expected = ComponentException.class) public void testAsInvalidClass() {
  ...
  @Test public void testClearReactInputEmpty() {
    when(fluentElement.attribute("value")).thenReturn("");
    fluentElement.clearReactInput();
    verify(fluentElement, times(2)).attribute("value");
    verify(driver, times(0)).executeScript("arguments[0].value = arguments[1]", element, "");
  }

  @Test public void testClearReactInputNonEmpty() {
    when(fluentElement.attribute("value")).thenReturn("nonEmpty");
    fluentElement.clearReactInput();
    verify(fluentElement, times(2)).attribute("value");
    verify(driver, times(1)).executeScript("arguments[0].value = arguments[1]", element, "");
  }
  ...
  @Test public void testIsDisplayed() {
    assertThat(fluentElement.displayed()).isFalse();
    when(element.isDisplayed()).thenReturn(true);
    assertThat(fluentElement.displayed()).isTrue();
  }

  @Test public void shouldReturnFalseForDisplayedIfNoSuchElement() {
  ...
  @Test public void shouldReturnFalseForEnabledIfNoSuchElement() {
  ...
  @Test public void shouldReturnFalseForSelectedIfNoSuchElement() {
    when(element.isSelected()).thenThrow(NoSuchElementException.class);
    assertThat(fluentElement.selected()).isFalse();
  }

  @Test public void testIsClickable() {
  ...
  @Test public void testGetTagName() {
  ...
  @Test public void testFillSelect() {
  ...
  @Test(expected = NoSuchElementException.class) public void testFillSelectInvalidElement() {
