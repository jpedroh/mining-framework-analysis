...
public class FakeContext implements Context {
  ...
  @Deprecated private String requestUri;
  ...
  /**
     ...
     * @return
     */
  @Deprecated public FakeContext setRequestUri(String requestUri) {
  ...
  /**
     ...
     * @return
     */
  @Override @Deprecated public String getRequestUri() {
    return requestUri;
  }
  ...
  @Override public Map<String, String[]> getParameters() {
    return Maps.transformValues(params.asMap(), new Function<Collection<String>, String[]>() {
      @Override public String[] apply(Collection<String> s) {
  ...
  @Override public Map<String, List<String>> getHeaders() {
    @SuppressWarnings(value = { "rawtypes" }) Map rawHeaders = headers.asMap();
    return rawHeaders;
  }
  ...
  @Override public String getPathParameterEncoded(String name) {
  ...
  @Override public FileItem getParameterAsFileItem(String name) {
    throw new UnsupportedOperationException("Not supported in fake context");
  }

  @Override public List<FileItem> getParameterAsFileItems(String name) {
    throw new UnsupportedOperationException("Not supported in fake context");
  }
