...
import org.uma.jmetal.util.aggregativefunction.PenaltyBoundaryIntersection;
...
public class MOEAD3DProblemWithChartExample extends AbstractAlgorithmRunner {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    algorithm = new MOEAD<>(problem, populationSize, mutation, crossover, aggregativeFunction, neighborhoodSelectionProbability, maximumNumberOfReplacedSolutions, neighborhoodSize, "resources/weightVectorFiles/moead", new TerminationByEvaluations(50000));
    RunTimeChartObserver<DoubleSolution> runTimeChartObserver = new RunTimeChartObserver<>("MOEA/D", 80, 1000, referenceParetoFront);
