...
public class MOEADDefaultConfigurationExample extends AbstractAlgorithmRunner {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    algorithm = new MOEAD<>(problem, populationSize, mutation, crossover, aggregativeFunction, neighborhoodSelectionProbability, maximumNumberOfReplacedSolutions, neighborhoodSize, "resources/weightVectorsFiles/moead", new TerminationByEvaluations(25000));
    algorithm.run();
