...
public class ParallelNSGAIIExample extends AbstractAlgorithmRunner {
  public static void main(String[] args) throws JMetalException, FileNotFoundException {
    ...
    algorithm = new NSGAII<>(problem, populationSize, offspringPopulationSize, crossover, mutation, termination).withEvaluation(new MultithreadedEvaluation<>(8, problem));
    algorithm.run();
