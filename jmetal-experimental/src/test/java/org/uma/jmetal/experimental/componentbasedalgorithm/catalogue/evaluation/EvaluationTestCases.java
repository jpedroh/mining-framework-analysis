...
public abstract class EvaluationTestCases<S extends Solution<?>> {
  ...
  @Test public void shouldACallToEvaluateComputeTheRightNumberOfEvaluationsCase1() {
  ...
  @Test public void shouldACallToEvaluateComputeTheRightNumberOfEvaluationsCase2() {
    List<S> solutions = new ArrayList<>();
  ...
  @Test public void shouldACallToEvaluateComputeTheRightNumberOfEvaluationsCase3() {
    List<S> solutions = new ArrayList<>();
