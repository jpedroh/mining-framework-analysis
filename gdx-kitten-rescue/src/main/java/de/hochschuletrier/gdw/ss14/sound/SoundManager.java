  ...
  public static void performAction(Enum action) {
    ...
    switch (actualGamestate) {
      ...
      switch (actionString) {
        ...
        switch (tmp) {
          case 0:
          SoundManager.playSound("gp_cat_fall1");
          break;
          case 1:
          SoundManager.playSound("gp_cat_fall2");
          break;
        }
        break;
        case "JUMP":
        ...
        switch (tmp) {
          case 0:
          SoundManager.playSound("gp_cat_box_in1");
          break;
          case 1:
          SoundManager.playSound("gp_cat_box_in2");
          break;
        }
        break;
        case "KILLING":
        ...
        switch (tmp) {
          case 0:
          SoundManager.playSound("gp_dog_bite1");
          break;
          case 1:
          SoundManager.playSound("gp_dog_bite2");
          break;
          case 2:
          SoundManager.playSound("gp_dog_bite3");
          break;
        }
        break;
      }
