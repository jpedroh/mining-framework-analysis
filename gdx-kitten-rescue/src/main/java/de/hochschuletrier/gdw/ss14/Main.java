...
public class Main extends StateBasedGame {
  ...
  private void loadAssetLists() {
    ...
    fontParam.flip = true;
    assetManager.loadAssetList("data/json/fonts_bitmap.json", BitmapFont.class, fontParam);
    assetManager.loadAssetList("data/json/fonts_truetype.json", TrueTypeFont.class, null);
  }
  ...
  @Override protected void postRender() {
    DrawUtil.batch.end();
  ...
  @Override protected void preUpdate(float delta) {
    if (consoleView.isVisible()) {
