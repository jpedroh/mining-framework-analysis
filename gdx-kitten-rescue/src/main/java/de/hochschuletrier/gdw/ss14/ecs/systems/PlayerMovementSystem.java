  ...
  @Override public void update(float delta) {
    ...
    for (Integer integer : compos) {
      ...
      if (moveCompo.velocity == 0) {
        ...
        if (moveCompo.velocity > 0 && moveCompo.velocity < moveCompo.middleVelocity) {
          catStateCompo.state = CatStateEnum.WALK;
          catStateCompo.jumpBuffer = 0;
        } else {
          if (moveCompo.velocity > moveCompo.middleVelocity && moveCompo.velocity < moveCompo.maxVelocity) {
