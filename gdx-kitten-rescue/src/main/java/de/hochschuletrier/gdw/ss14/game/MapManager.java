...
public class MapManager {
  ...
  private void createPhysics() {
    ...
    generator.generate(tiledMap, (Layer layer, TileInfo info) -> info.getBooleanProperty("blocked", false), (Rectangle rect) -> addShape(physixManager, rect, tileWidth, tileHeight, floor, "wall"));
    generator.generate(tiledMap, (Layer layer, TileInfo info) -> info.getBooleanProperty("deadzone", false), (Rectangle rect) -> addShape(physixManager, rect, tileWidth, tileHeight, floor, tile2entity.deadzone));
    generator.generate(tiledMap, (Layer layer, TileInfo info) -> info.getBooleanProperty("blood puddle", false), (Rectangle rect) -> addShape(physixManager, rect, tileWidth, tileHeight, floor, tile2entity.bloodpuddle));
    generator.generate(tiledMap, (Layer layer, TileInfo info) -> info.getBooleanProperty("water puddle", false), (Rectangle rect) -> addShape(physixManager, rect, tileWidth, tileHeight, floor, tile2entity.waterpuddle));
    generator.generate(tiledMap, (Layer layer, TileInfo info) -> info.getBooleanProperty("woodfloor", false), (Rectangle rect) -> addShape(physixManager, rect, tileWidth, tileHeight, floor, tile2entity.parketfloor));
    generator.generate(tiledMap, (Layer layer, TileInfo info) -> info.getBooleanProperty("woodbeam", false), (Rectangle rect) -> addShape(physixManager, rect, tileWidth, tileHeight, floor, tile2entity.parketfloor));
    generator.generate(tiledMap, (Layer layer, TileInfo info) -> info.getBooleanProperty("kitchenfloor", false), (Rectangle rect) -> addShape(physixManager, rect, tileWidth, tileHeight, floor, tile2entity.kitchenfloor));
  }
  ...
  private void addShape(PhysixManager physixManager, Rectangle rect, int tileWidth, int tileHeight, int floor, tile2entity t2e) {
    ...
    PhysixFixtureDef fixturedef = new PhysixFixtureDef(physixManager).density(1).friction(0.5f).shapeBox(width, height).category((short) floor);
    switch (t2e) {
      case none:
