...
public class DeploymentServlet extends AbstractServletBase implements HttpServiceServlet {
  ...
  private static final int MEMORY_THRESHOLD = 10 * MEGABYTE;
  ...
  @Override public void configureServletHolder(final ServletHolder servletHolder) {
  ...
  @Override public StructrHttpServiceConfig getConfig() {
    return config;
  }
  ...
  @Override protected void doGet(final HttpServletRequest request, final HttpServletResponse response) throws ServletException {
  ...
  @Override protected void doPost(final HttpServletRequest request, final HttpServletResponse response) throws ServletException {
    initRequest(request, response);
    SecurityContext securityContext = null;
    setCustomResponseHeaders(response);
    try (Tx tx = StructrApp.getInstance().tx()) {
      ...
      while (fileItemsIterator.hasNext()) {
        ...
        if (item.isFormField()) {
          ...
          if (DOWNLOAD_URL_PARAMETER.equals(fieldName)) {
            ...
            if (REDIRECT_URL_PARAMETER.equals(fieldName)) {
              redirectUrl = fieldValue;
            } else {
              if (MODE_PARAMETER.equals(fieldName)) {
                mode = fieldValue;
              } else {
                if (FILE_PARAMETER.equals(fieldName)) {
...
>>>>>>> /usr/src/app/output/structr/structr/740899f953a0830eeae8397ca1b652455d90e6a1/structr-ui/src/main/java/org/structr/web/servlet/DeploymentServlet.java/right.java
        ...
        for (String fieldName : p.getHeaderNames()) {
          ...
          if (DOWNLOAD_URL_PARAMETER.equals(fieldName)) {
            ...
            if (REDIRECT_URL_PARAMETER.equals(fieldName)) {
              ...
              if (DeployDataCommand.REBUILDALLINDEXES_PARAMTER_NAME.equals(fieldName)) {
