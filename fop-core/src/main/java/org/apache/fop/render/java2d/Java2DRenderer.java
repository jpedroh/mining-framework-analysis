...
public abstract class Java2DRenderer extends AbstractPathOrientedRenderer implements Printable {
  ...
  public void setupFontInfo(FontInfo inFontInfo) {
    ...
    FontCollection[] fontCollections = new FontCollection[] { new Base14FontCollection(java2DFontMetrics), new InstalledFontCollection(java2DFontMetrics), new ConfiguredFontCollection(fontManager.getResourceResolver(), getFontList(), userAgent.isComplexScriptFeaturesEnabled()) };
  ...
  protected void startVParea(CTM ctm, Rectangle clippingRect) {
    ...
    if (clippingRect != null) {
      clipRect((float) clippingRect.getX() / 1000f, (float) clippingRect.getY() / 1000f, (float) clippingRect.getWidth() / 1000f, (float) clippingRect.getHeight() / 1000f);
    }
...
<<<<<<< /usr/src/app/output/apache/fop/7403425be8d6fe84d9ebd9614109629fadc8a752/fop-core/src/main/java/org/apache/fop/render/java2d/Java2DRenderer.java/left.java
    while (iter.hasNext()) {
