...
public abstract class OpenFont {
  ...
  public Rectangle[] getBoundingBoxes() {
    ...
    for (int i = 0; i < boundingBoxes.length; i++) {
      ...
      boundingBoxes[i] = new Rectangle(convertTTFUnit2PDFUnit(boundingBox[0]), convertTTFUnit2PDFUnit(boundingBox[1]), convertTTFUnit2PDFUnit(boundingBox[2] - boundingBox[0]), convertTTFUnit2PDFUnit(boundingBox[3] - boundingBox[1]));
    }
  ...
  protected void determineAscDesc() {
    ...
    if (os2Ascender > 0 && os2BoxHeight <= upem) {
      ...
      if (hheaAscender > 0 && hheaBoxHeight <= upem) {
