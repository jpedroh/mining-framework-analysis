...
public class GameplayState extends GameState implements InputProcessor {
    ...
    public void init(AssetManagerX assetManager) {
        ...
        camera.updateForced();
<<<<<<< /usr/src/app/output/lusito/gamedevweek/d09b4cd1f960946a232cdd912f0ba8ce6195eb67/gdx-test/src/main/java/de/hochschuletrier/gdw/ss14/states/GameplayState.java/left.java
        Main.getInstance().addScreenListener(camera);
        InputManager.init();
||||||| /usr/src/app/output/lusito/gamedevweek/d09b4cd1f960946a232cdd912f0ba8ce6195eb67/gdx-test/src/main/java/de/hochschuletrier/gdw/ss14/states/GameplayState.java/base.java
        Main.getInstance().addScreenListener(camera);
=======
        Main.getInstance().addScreenListener(camera);*/
>>>>>>> /usr/src/app/output/lusito/gamedevweek/d09b4cd1f960946a232cdd912f0ba8ce6195eb67/gdx-test/src/main/java/de/hochschuletrier/gdw/ss14/states/GameplayState.java/right.java
    }
