...
public class EntityFactory {
    ...
    public static void constructCat(Vector2 pos, float maxVelocity,
        ...
        MovementComponent catMove = new MovementComponent(maxVelocity,
                middleVelocity, minVelocity, acceleration);
        InputComponent catInput = new InputComponent();
        catPhysix.initPhysics(phyManager);
        // catPhysix.physicsBody.setLinearVelocity(catMove.velocity,
        // catMove.velocity);
    ...
    public static void constructDog(Vector2 pos, float maxVelocity,
        ...
        MovementComponent dogMove = new MovementComponent(maxVelocity,
                middleVelocity, minVelocity, acceleration);
