 ...
 */
public abstract class AbstractSolver<GenericSolutionType extends java.lang.Object> implements Solver<GenericSolutionType> {
  ...
  @Override public void addStateListener(SolverStateListener<GenericSolutionType> listener) {
    stateListeners.add(listener);
  }

  @Override public void removeStateListener(SolverStateListener<GenericSolutionType> listener) {
  ...
  @Override public abstract GenericSolutionType getCurrentSolution();
