 ...
 *
 */
@XmlAccessorType(value = XmlAccessType.FIELD) @XmlType(name = "Settings", propOrder = {  }) @SuppressWarnings(value = { "all" }) public class Settings extends SettingsBase implements Serializable, Cloneable {
  private final static long serialVersionUID = 31100L;

  @XmlElement(defaultValue = "true") protected Boolean renderCatalog = true;

  @XmlElement(defaultValue = "true") protected Boolean renderSchema = true;

  protected RenderMapping renderMapping;

  @XmlElement(defaultValue = "QUOTED") @XmlSchemaType(name = "string") protected RenderNameStyle renderNameStyle = RenderNameStyle.QUOTED;

  @XmlElement(defaultValue = "AS_IS") @XmlSchemaType(name = "string") protected RenderKeywordStyle renderKeywordStyle = RenderKeywordStyle.AS_IS;

  @XmlElement(defaultValue = "false") protected Boolean renderFormatted = false;

  protected RenderFormatting renderFormatting;

  @XmlElement(defaultValue = "false") protected Boolean renderScalarSubqueriesForStoredFunctions = false;

  @XmlElement(defaultValue = "DEFAULT") @XmlSchemaType(name = "string") protected BackslashEscaping backslashEscaping = BackslashEscaping.DEFAULT;

  @XmlElement(defaultValue = "INDEXED") @XmlSchemaType(name = "string") protected ParamType paramType = ParamType.INDEXED;

  @XmlElement(defaultValue = "DEFAULT") @XmlSchemaType(name = "string") protected ParamCastMode paramCastMode = ParamCastMode.DEFAULT;

  @XmlElement(defaultValue = "PREPARED_STATEMENT") @XmlSchemaType(name = "string") protected StatementType statementType = StatementType.PREPARED_STATEMENT;

  @XmlElement(defaultValue = "true") protected Boolean executeLogging = true;

  @XmlElement(defaultValue = "false") protected Boolean executeWithOptimisticLocking = false;

  @XmlElement(defaultValue = 
<<<<<<< /usr/src/app/output/jooq/jooq/9f9d4f5bceaf6d7419d2e478d008513918c8eefc/jOOQ/src/main/java/org/jooq/conf/Settings.java/left.java
  "FAIL"
=======
  "DEBUG"
>>>>>>> /usr/src/app/output/jooq/jooq/9f9d4f5bceaf6d7419d2e478d008513918c8eefc/jOOQ/src/main/java/org/jooq/conf/Settings.java/right.java
  ) @XmlSchemaType(name = "string") protected 
<<<<<<< /usr/src/app/output/jooq/jooq/9f9d4f5bceaf6d7419d2e478d008513918c8eefc/jOOQ/src/main/java/org/jooq/conf/Settings.java/left.java
...
<<<<<<< /usr/src/app/output/jooq/jooq/9f9d4f5bceaf6d7419d2e478d008513918c8eefc/jOOQ/src/main/java/org/jooq/conf/Settings.java/left.java
  parseUnknownFunctions = ParseUnknownFunctions.FAIL
=======
  executeLoggingBindVariables = Log.Level.DEBUG
>>>>>>> /usr/src/app/output/jooq/jooq/9f9d4f5bceaf6d7419d2e478d008513918c8eefc/jOOQ/src/main/java/org/jooq/conf/Settings.java/right.java
  ;

  @XmlElement(defaultValue = "false") protected Boolean executeLoggingAbbreviatedBindVariables = false;

  @XmlElement(defaultValue = "DEBUG") protected Log.Level executeLoggingSqlString = Log.Level.DEBUG;

  @XmlElement(defaultValue = "DEBUG") protected Log.Level executeLoggingResult = Log.Level.DEBUG;

  @XmlElement(defaultValue = "5") protected Integer executeLoggingResultNumberOfRows = 5;

  @XmlElement(defaultValue = "50") protected Integer executeLoggingResultNumberOfColumns = 50;

  @XmlElement(defaultValue = "DEBUG") protected Log.Level executeLoggingRoutine = Log.Level.DEBUG;

  @XmlElement(defaultValue = "DEBUG") protected Log.Level executeLoggingException = Log.Level.DEBUG;

  @XmlElement(defaultValue = "false") protected Boolean executeWithOptimisticLockingExcludeUnversioned = false;

  @XmlElement(defaultValue = "true") protected Boolean attachRecords = true;

  @XmlElement(defaultValue = "false") protected Boolean updatablePrimaryKeys = false;

  @XmlElement(defaultValue = "true") protected Boolean reflectionCaching = true;

  @XmlElement(defaultValue = "true") protected Boolean cacheRecordMappers = true;

  @XmlElement(defaultValue = "THROW_ALL") @XmlSchemaType(name = "string") protected ThrowExceptions throwExceptions = ThrowExceptions.THROW_ALL;

  @XmlElement(defaultValue = "true") protected Boolean fetchWarnings = true;

  @XmlElement(defaultValue = "0") protected Integer fetchServerOutputSize = 0;

  @XmlElement(defaultValue = "false") protected Boolean returnAllOnUpdatableRecord = false;

  @XmlElement(defaultValue = "true") protected Boolean returnRecordToPojo = true;

  @XmlElement(defaultValue = "true") protected Boolean mapJPAAnnotations = true;

  @XmlElement(defaultValue = "false") protected Boolean mapConstructorParameterNames = false;

  @XmlElement(defaultValue = "0") protected Integer queryTimeout = 0;

  @XmlElement(defaultValue = "0") protected Integer maxRows = 0;

  @XmlElement(defaultValue = "0") protected Integer fetchSize = 0;

  @XmlElement(defaultValue = "true") protected Boolean debugInfoOnStackTrace = true;

  @XmlElement(defaultValue = "false") protected Boolean inListPadding = false;

  @XmlElement(defaultValue = "2") protected Integer inListPadBase = 2;

  @XmlElement(defaultValue = ";") protected String delimiter = ";";

  @XmlElement(defaultValue = "LOG_DEBUG") @XmlSchemaType(name = "string") protected ExecuteWithoutWhere executeUpdateWithoutWhere = ExecuteWithoutWhere.LOG_DEBUG;

  @XmlElement(defaultValue = "LOG_DEBUG") @XmlSchemaType(name = "string") protected ExecuteWithoutWhere executeDeleteWithoutWhere = ExecuteWithoutWhere.LOG_DEBUG;

  @XmlElement(defaultValue = "IGNORE_ON_FAILURE") @XmlSchemaType(name = "string") protected ParseWithMetaLookups parseWithMetaLookups = ParseWithMetaLookups.IGNORE_ON_FAILURE;
