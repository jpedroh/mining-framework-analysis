...
final class Tools {
  ...
  static class Cache {
    ...
    /**
         ...
         */
    @SuppressWarnings(value = { "unchecked" }) static final <V extends java.lang.Object> V run(Configuration configuration, CachedOperation<V> operation, String type, Object key) {
      if (configuration == null) {
