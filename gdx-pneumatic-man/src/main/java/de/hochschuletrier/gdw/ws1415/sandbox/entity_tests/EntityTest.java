...
<<<<<<< /usr/src/app/output/lusito/gamedevweek/3b60719cc1442023d225617f9051285b6605f9f9/gdx-pneumatic-man/src/main/java/de/hochschuletrier/gdw/ws1415/sandbox/entity_tests/EntityTest.java/left.java
  private final RenderSystem DestructableBlockRender = new RenderSystem();
=======
  float unitSpeed = 1;
>>>>>>> /usr/src/app/output/lusito/gamedevweek/3b60719cc1442023d225617f9051285b6605f9f9/gdx-pneumatic-man/src/main/java/de/hochschuletrier/gdw/ws1415/sandbox/entity_tests/EntityTest.java/right.java
  ...
  @Override public void init(AssetManagerX assetManager) {
    ...
    ac.reset();
    assetManager.loadAssetListWithParam("data/json/animations.json", AnimationExtended.class, AnimationExtendedLoader.AnimationExtendedParameter.class);
    ...
    Arrow.add(Damage);
    PositionComponent ArrowPosition = engine.createComponent(PositionComponent.class);
    ArrowPosition.x = 10;
  ...
  @Override public void update(float delta) {
    ...
    float DH = 100.0f;
    float DW = 100.0f;
    PositionComponent ArrowPosition = Arrow.getComponent(PositionComponent.class);
    ...
    HealthComponent HealthOfBlock = BlockEntity.getComponent(HealthComponent.class);
    DrawRect(BlockEntity.getComponent(PositionComponent.class).x, BlockEntity.getComponent(PositionComponent.class).y, DW * 0.5f, DH * 0.5f, new Color(HealthOfBlock.Value / 10.0f, 1.0f, 1.0f, 1.0f));
