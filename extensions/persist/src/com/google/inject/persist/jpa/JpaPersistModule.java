...
public final class JpaPersistModule extends PersistModule {
   ...
   */
  public <T extends java.lang.Object> JpaPersistModule addFinder(Class<T> iface) {
    dynamicFinders.add(iface);
    return this;
  }

  private <T extends java.lang.Object> void bindFinder(Class<T> iface) {
    ...
    @SuppressWarnings(value = { "unchecked" }) T proxy = (T) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), new Class<?>[] { iface }, finderInvoker);
