...
public class SpringTest {
  @Test public void testAnnotationUtils() {
  ...
  private static Method getMethod(Class<?> cls, String methodName) {
    final Method greetingMethod = Utils.getAllMethods(cls).stream().filter((method) -> method.getName().equals(methodName)).findFirst().get();
    return greetingMethod;
  }

  @Test public void testApplicationScan() {
  ...
  @Test public void testPathParametersWithoutValue() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @Test public void testPathParameterWithReservedWord() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @RestController @RequestMapping public static class ControllerWithReservedWord {
    @GetMapping(value = "/logs/{class}") public Collection<String> getLogs(@PathVariable(value = "class") String clazz) {
      return null;
    }
  }
  ...
  @Test public void testAllOptionalQueryParameters() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @Test public void testEntityParameter() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @Test public void testExclusion() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @RestController @RequestMapping(value = "/owners/{ownerId}") public static class Controller1 {
    @GetMapping(value = "/pets/{petId}") public Pet findPet(@PathVariable(value = "ownerId") Long ownerId, @PathVariable(name = "petId") Long petId) {
      return null;
    }
  }

  @RestController public static class Controller2 {
    @RequestMapping(value = "/echo") public String echo(@RequestParam(value = "message") String message, @RequestParam(name = "count", defaultValue = "1") Integer count, @RequestParam(required = false) Integer optionalRequestParam) {
      return message;
    }
  }

  @RestController public static class Controller7 {
    @RequestMapping(value = "/echo2") public String echo(@RequestParam(required = false) String message) {
      return message;
    }
  }

  @Test public void testQueryParametersWithModel() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @RestController public static class ControllerWithModelAttribute {
    @RequestMapping(value = "/echoWithModelAttribute") public String echoWithModelAttribute(@ModelAttribute FilterParams nested) {
  ...
  @RestController public static class Controller3 {
    @RequestMapping(path = "/data1", method = RequestMethod.PUT) public void setEntity(@RequestBody Data1 data) {
    }
  }

  @RestController public static class Controller4 {
    @RequestMapping(path = "/data2", method = RequestMethod.GET) public ResponseEntity<Data2> getEntity() {
      return null;
    }
  }

  @RestController @RequestMapping(value = "/owners2/{ownerId}") public static class Controller5 {
    @GetMapping(value = "/pets2/{petId}") public Pet findPet(@PathVariable Long ownerId, @PathVariable Long petId) {
      return null;
    }
  }
  ...
  @RestController @RequestMapping(value = "/test") public static class Controller6 extends Controller6Super<Controller6Enum, Integer> {
    @Override int doSomethingElse(@PathVariable long id) {
      return 3;
    }

    @GetMapping(value = "/c") @Override int doSomethingElseAgain() {
      return super.doSomethingElseAgain();
    }
  }

  static abstract class Controller6Super<A extends Enum<A>, B extends java.lang.Object> {
    @PostMapping(value = "a") List<Map<A, ?>> doSomething(@RequestBody List<B> input) {
      return null;
    }

    @GetMapping(value = "/{id}") int doSomethingElse(@PathVariable long id) {
      return 1;
    }

    @GetMapping(value = "/b") int doSomethingElseAgain() {
      return 1;
    }
  }
  ...
  @Test public void testUnwrappingNew() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @RestController public static class ControllerWithWrapper {
    @RequestMapping(path = "/data", method = RequestMethod.GET) public Wrapper<String> getEntity() {
      return null;
    }
  }

  public static class Wrapper<T extends java.lang.Object> {
    public T value;
  }

  @Test public void testGenericController() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @RestController public static abstract class AbstractGenerticController<T extends java.lang.Object, R extends java.lang.Object> {
    @PostMapping(value = "/generic") public R post(@RequestBody T input) {
      return map(input);
    }
  ...
  @Test public void testPageableController() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @RestController public static abstract class PageableController {
    @GetMapping(value = "/pageable") public Page<String> post(Pageable page) {
      return null;
    }
  }

  @Test public void testDoubleGenericController() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @RestController public class DoubleGenericController {
    @GetMapping(value = "/generic2") public ResponseEntity<List<String>> get() {
      return ResponseEntity.ok(Arrays.asList("a", "b", "c"));
    }
  }

  @Test public void testCustomControllerAnnotaion() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @MyRestController public class CustomAnnotatedController {
    @GetMapping(value = "/text") public String getText() {
      return "";
    }
  }

  @Retention(value = RetentionPolicy.RUNTIME) @Component public @interface MyRestController {
  }

  @Test public void testUrlTrailingSlash() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @RestController @RequestMapping(value = "/controller") public class TestUrlTrailingSlashController {
    @GetMapping(value = "/") public void response() {
    }

    @GetMapping(value = "") public void response2() {
    }
  }

  @Test public void testMultiValueMapRequestParam() {
    final Settings settings = TestUtils.settings();
    settings.outputFileType = TypeScriptFileType.implementationFile;
    settings.generateSpringApplicationClient = true;
  ...
  @RestController public class ControllerWithMultiValueMap {
    @GetMapping(value = "/search") public String search(@RequestParam MultiValueMap<String, String> params) {
      return "";
    }
  }
}