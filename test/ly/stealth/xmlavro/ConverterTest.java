...
public class ConverterTest {
  ...
  @Test public void attributes() {
    ...
    assertEquals(Arrays.asList(Schema.create(Schema.Type.STRING), Schema.create(Schema.Type.NULL)), optional.schema().getTypes());
  ...
  @Test public void optionalElementValues() {
    ...
    assertEquals(Arrays.asList(Schema.create(Schema.Type.STRING), Schema.create(Schema.Type.NULL)), optionalSchema.getTypes());
  ...
  @Test public void choiceElements() {
    ...
    assertEquals(Arrays.asList(Schema.create(Schema.Type.STRING), Schema.create(Schema.Type.NULL)), sField.schema().getTypes());
