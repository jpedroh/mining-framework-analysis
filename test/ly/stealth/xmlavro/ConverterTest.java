...
public class ConverterTest {
  ...
  @Test public void rootPrimitive() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "   <xs:element name=\'i\' type=\'xs:int\'/>" + "</xs:schema>";
  ...
  @Test public void recordWithWildcardField() {
    ...
    @SuppressWarnings(value = { "unchecked" }) java.util.Map<String, String> map = (java.util.Map<String, String>) record.get(Converter.WILDCARD);
