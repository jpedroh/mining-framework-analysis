...
public class ConverterTest {
  ...
  @Test public void rootIntPrimitive() {
  ...
  @Test public void rootLongPrimitive() {
  ...
  public <T extends java.lang.Object> void rootPrimitiveWithType(String xmlType, String xmlValue, Schema.Type avroType, T avroValue) {
  ...
  @Test public void severalRoots() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "   <xs:element name=\'i\' type=\'xs:int\'/>" + "   <xs:element name=\'r\'>" + "     <xs:complexType>" + "       <xs:sequence>" + "         <xs:element name=\'s\' type=\'xs:string\'/>" + "       </xs:sequence>" + "     </xs:complexType>" + "   </xs:element>" + "</xs:schema>";
    Schema schema = Converter.createSchema(xsd);
  ...
  @Test public void nestedRecursiveRecords() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "  <xs:complexType name=\'type\'>" + "    <xs:sequence>" + "      <xs:element name=\'node\' type=\'type\' minOccurs=\'0\'/>" + "    </xs:sequence>" + "  </xs:complexType>" + "  <xs:element name=\'root\' type=\'type\'/>" + "</xs:schema>";
    Schema schema = Converter.createSchema(xsd);
  ...
  @Test public void attributes() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "  <xs:element name=\'root\'>" + "    <xs:complexType>" + "      <xs:attribute name=\'required\' use=\'required\'/>" + "      <xs:attribute name=\'prohibited\' use=\'prohibited\'/>" + "      <xs:attribute name=\'optional\' use=\'optional\'/>" + "    </xs:complexType>" + "  </xs:element>" + "</xs:schema>";
    Schema schema = Converter.createSchema(xsd);
    ...
    assertEquals(Arrays.asList(Schema.create(Schema.Type.NULL), Schema.create(Schema.Type.STRING)), optional.schema().getTypes());
  ...
  @Test public void uniqueFieldNames() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "  <xs:complexType name=\'type\'>" + "    <xs:sequence>" + "      <xs:element name=\'field\' type=\'xs:string\'/>" + "    </xs:sequence>" + "    <xs:attribute name=\'field\' type=\'xs:string\'/>" + "  </xs:complexType>" + "  <xs:element name=\'root\' type=\'type\'/>" + "</xs:schema>";
    Schema schema = Converter.createSchema(xsd);
    assertEquals(2, schema.getFields().size());
  ...
  @Test public void recordWithWildcardField() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "  <xs:complexType name=\'type\'>" + "    <xs:sequence>" + "      <xs:element name=\'field\' type=\'xs:string\'/>" + "      <xs:any/>" + "    </xs:sequence>" + "  </xs:complexType>" + "  <xs:element name=\'root\' type=\'type\'/>" + "</xs:schema>";
    Schema schema = Converter.createSchema(xsd);
    assertEquals(2, schema.getFields().size());
    Schema.Field wildcardField = schema.getField(Source.WILDCARD);
    assertEquals(Schema.Type.MAP, wildcardField.schema().getType());
    String xml = "<root>" + "  <field>field</field>" + "  <field0>field0</field0>" + "  <field1>field1</field1>" + "</root>";
    GenericData.Record record = Converter.createDatum(schema, xml);
    assertEquals("field", record.get("field"));
    @SuppressWarnings(value = { "unchecked" }) java.util.Map<String, String> map = (java.util.Map<String, String>) record.get(Source.WILDCARD);
  ...
  @Test public void severalWildcards() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "  <xs:element name=\'root\'>" + "    <xs:complexType>" + "      <xs:sequence>" + "        <xs:any/>" + "        <xs:any/>" + "      </xs:sequence>" + "    </xs:complexType>" + "  </xs:element>" + "</xs:schema>";
    Schema schema = Converter.createSchema(xsd);
  ...
  @Test public void optionalElementValues() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "  <xs:element name=\'root\'>" + "    <xs:complexType>" + "      <xs:sequence>" + "        <xs:element name=\'required\' type=\'xs:string\'/>" + "        <xs:element name=\'optional\' type=\'xs:string\' minOccurs=\'0\'/>" + "      </xs:sequence>" + "    </xs:complexType>" + "  </xs:element>" + "</xs:schema>";
    Schema schema = Converter.createSchema(xsd);
    assertEquals(2, schema.getFields().size());
    ...
    assertEquals(Arrays.asList(Schema.create(Schema.Type.NULL), Schema.create(Schema.Type.STRING)), optionalSchema.getTypes());
  ...
  @Test public void array() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "  <xs:element name=\'root\'>" + "    <xs:complexType>" + "      <xs:sequence>" + "        <xs:element name=\'value\' type=\'xs:string\' maxOccurs=\'unbounded\'/>" + "      </xs:sequence>" + "    </xs:complexType>" + "  </xs:element>" + "</xs:schema>";
    Schema schema = Converter.createSchema(xsd);
  ...
  @Test public void choiceElements() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "  <xs:element name=\'root\'>" + "    <xs:complexType>" + "      <xs:choice>" + "        <xs:element name=\'s\' type=\'xs:string\'/>" + "        <xs:element name=\'i\' type=\'xs:int\'/>" + "      </xs:choice>" + "    </xs:complexType>" + "  </xs:element>" + "</xs:schema>";
    Schema schema = Converter.createSchema(xsd);
    assertEquals(Schema.Type.RECORD, schema.getType());
    assertEquals(2, schema.getFields().size());
    Schema.Field sField = schema.getField("s");
    assertEquals(Schema.Type.UNION, sField.schema().getType());
    assertEquals(Arrays.asList(Schema.create(Schema.Type.NULL), Schema.create(Schema.Type.STRING)), sField.schema().getTypes());
  ...
  @Test public void arrayOfUnboundedChoiceElements() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "  <xs:element name=\'root\'>" + "    <xs:complexType>" + "      <xs:choice maxOccurs=\'unbounded\'>" + "        <xs:element name=\'s\' type=\'xs:string\'/>" + "        <xs:element name=\'i\' type=\'xs:int\'/>" + "      </xs:choice>" + "    </xs:complexType>" + "  </xs:element>" + "</xs:schema>";
    Schema schema = Converter.createSchema(xsd);
  ...
  @Test public void arrayOfChoiceElements() {
    String xsd = "<xs:schema xmlns:xs=\'http://www.w3.org/2001/XMLSchema\'>" + "  <xs:element name=\'root\'>" + "    <xs:complexType>" + "      <xs:choice maxOccurs=\'3\'>" + "        <xs:element name=\'s\' type=\'xs:string\'/>" + "        <xs:element name=\'i\' type=\'xs:int\'/>" + "      </xs:choice>" + "    </xs:complexType>" + "  </xs:element>" + "</xs:schema>";
    Schema schema = Converter.createSchema(xsd);
    assertEquals(Schema.Type.ARRAY, schema.getType());
    final Schema elementType = schema.getElementType();
    assertEquals(Schema.Type.RECORD, elementType.getType());
  ...
  @Test public void SchemaBuilder_validName() {
