...
public class Args {
  ...
  public boolean 
<<<<<<< /usr/src/app/output/aerospike/aerospike-client-java/dfa7c508145f2b09066c7f0ccf67e828a5279eab/test/src/com/aerospike/test/util/Args.java/left.java
  useProxyClient
=======
  hasTtl
>>>>>>> /usr/src/app/output/aerospike/aerospike-client-java/dfa7c508145f2b09066c7f0ccf67e828a5279eab/test/src/com/aerospike/test/util/Args.java/right.java
  ;
  ...
  public void setServerSpecific(IAerospikeClient client) {
    ...
    if (editionToken == null) {
      throw new AerospikeException(String.format("Failed to get edition: host=%s port=%d", host, port));
    }
