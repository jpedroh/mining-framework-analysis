...
public class TestUDF extends TestSync {
  @BeforeClass public static void register() {
  ...
  @Test public void writeUsingUdf() {
  ...
  @Test public void writeIfGenerationNotChanged() {
  ...
  @Test public void writeIfNotExists() {
  ...
  @Test public void writeWithValidation() {
  ...
  @Test public void writeListMapUsingUdf() {
  ...
  @Test public void appendListUsingUdf() {
    Key key = new Key(args.namespace, args.set, "udfkey5");
    String binName = "udfbin5";
    ...
    fail("UDF data mismatch" + System.lineSeparator() + "Expected: " + value + System.lineSeparator() + "Received: " + received);
  }

  @Test public void writeBlobUsingUdf() {
  ...
  @Test public void batchUDF() {
    Key[] keys = new Key[] { new Key(args.namespace, args.set, 20000), new Key(args.namespace, args.set, 20001) };
  ...
  @Test public void batchUDFError() {
    Key[] keys = new Key[] { new Key(args.namespace, args.set, 20002), new Key(args.namespace, args.set, 20003) };
    client.delete(null, null, keys);
  ...
  @Test public void batchUDFComplex() {
    String bin = "B5";
