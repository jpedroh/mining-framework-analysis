...
public class NullableMapFieldBuilderTest {
  ...
  @AutoMatter interface NullableMap {
  ...
  @Test public void testAddingEntryInstantiatesMap() {
    builder.putPrice("red", 17);
    final NullableMap map = builder.build();
    assertThat(map.prices(), is((Map<String, Integer>) ImmutableMap.of("red", 17)));
  }

  @Test public void testAddingEntriesInstantiatesMap() {
    builder.prices("red", 17, "green", 18);
    final NullableMap map = builder.build();
    assertThat(map.prices(), is((Map<String, Integer>) ImmutableMap.of("red", 17, "green", 18)));
  }

  @Test public void testAddingNullEntries() {
