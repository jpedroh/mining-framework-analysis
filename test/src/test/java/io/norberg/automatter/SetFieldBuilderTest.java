...
public class SetFieldBuilderTest {
  ...
  @Test public void verifyBuilderSetIsMutable() {
  ...
  @Test public void verifyMutatingBuilderSetDoesNotChangeValue() {
  ...
  @Test(expected = UnsupportedOperationException.class) public void verifyValueSetIsImmutable1() {
    final Sets lists = builder.addApple("red").addApple("green").build();
    lists.apples().remove("red");
  }

  @Test(expected = UnsupportedOperationException.class) public void verifyValueSetIsImmutable2() {
    final Sets lists = builder.addApple("red").addApple("green").build();
    lists.apples().add("blue");
  }

  @Test(expected = UnsupportedOperationException.class) public void verifyValueSetIsImmutable3() {
    final Sets lists = builder.addApple("red").addApple("green").build();
    lists.apples().clear();
  }
  ...
  private <T extends java.lang.Object> Set<T> set(final T... items) {
