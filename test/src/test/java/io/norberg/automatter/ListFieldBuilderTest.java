...
public class ListFieldBuilderTest {
  ...
  @Test public void verifyBuilderListIsMutable() {
  ...
  @Test public void verifyMutatingBuilderListDoesNotChangeValue() {
  ...
  @Test(expected = UnsupportedOperationException.class) public void verifyValueListIsImmutable1() {
    final Lists lists = builder.addApple("red").addApple("green").build();
    lists.apples().remove("red");
  }

  @Test(expected = UnsupportedOperationException.class) public void verifyValueListIsImmutable2() {
    final Lists lists = builder.addApple("red").addApple("green").build();
    lists.apples().add("blue");
  }

  @Test(expected = UnsupportedOperationException.class) public void verifyValueListIsImmutable3() {
    final Lists lists = builder.addApple("red").addApple("green").build();
    lists.apples().clear();
  }

  @Test public void testEnglishPlurals() {
  ...
  @Test public void verifyAddingNullThrowsNPE() {
    expectedException.expect(NullPointerException.class);
    expectedException.expectMessage("apple");
    builder.addApple(null);
  }

  @Test public void verifySettingNullIterableThrowsNPE() {
    expectedException.expect(NullPointerException.class);
    expectedException.expectMessage("apples");
    builder.apples((Iterable<String>) null);
  }

  @Test public void verifySettingNullArrayThrowsNPE() {
    expectedException.expect(NullPointerException.class);
    expectedException.expectMessage("apples");
    builder.apples((String[]) null);
  }

  @Test public void verifySettingExtendingValue() {
    builder.maps(ImmutableList.of(ImmutableMap.of("foo", 17)));
  }

  @Test public void testListMethodsReplaceOldValue() {
