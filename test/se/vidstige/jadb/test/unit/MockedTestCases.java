...
public class MockedTestCases {
  ...
  @Test(expected = JadbException.class) public void testPushToInvalidPath() throws Exception {
    server.add("serial-123");
  ...
  @Test public void testExecuteShell() throws Exception {
    server.add("serial-123");
  ...
  @Test public void testExecuteShellQuotesSpace() throws Exception {
    server.add("serial-123");
