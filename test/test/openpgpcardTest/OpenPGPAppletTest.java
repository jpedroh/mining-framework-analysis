...
public class OpenPGPAppletTest {
  ...
  @Test public void testBadVerify() {
  ...
  @Test public void testRcUnblock() {
  ...
  @Test public void testSetPintries() {
  ...
  @Test public void testSetCertificate() {
  ...
  @Test public void testPrivateUseDo1() {
  ...
  @Test public void testPrivateUseDo2() {
  ...
  @Test public void testPrivateUseDo3() {
  ...
  @Test public void testPrivateUseDo4() {
  ...
  @Test public void testSignWithoutPin() {
    doVerify("12345678", (byte) 0x83, State.GOOD);
    byte[] command = { 0x00, 0x47, (byte) 0x80, 0x00, 0x01, (byte) 0xb6 };
    simulator.transmitCommand(command);
  ...
  @Test public void testDecipherWithoutPin() {
    doVerify("12345678", (byte) 0x83, State.GOOD);
  ...
  @Test public void testAuthenticateWithoutPin() {
    doVerify("12345678", (byte) 0x83, State.GOOD);
  ...
  @SuppressWarnings(value = { "unused" }) private void dumpHex(byte[] data) {
    String out = "";
    for (byte b : data) {
