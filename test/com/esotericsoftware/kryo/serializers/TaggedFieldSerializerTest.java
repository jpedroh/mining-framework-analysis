...
@SuppressWarnings(value = { "synthetic-access" }) class TaggedFieldSerializerTest extends KryoTestCase {
  {
    supportsCopy = true;
  }

  @Test void testTaggedFieldSerializer() {
  ...
  /** Serializes an array with a Class with two tagged fields. Then deserializes it using a serializer that has removed some
	 ...
	 * unaffected. */
  @Test void testForwardCompatibility() {
    ...
    presentSerializer.removeField("futureString");
    ...
    presentSerializer2.removeField("zzz");
    presentSerializer2.removeField("fc2");
  ...
  @Test void testTaggedRecordNewToOld() {
  ...
  @Test void testTaggedRecordOldToNew() {
  ...
  public static class TestClass {
    @Tag(value = 0) public String text = "something";

    @Tag(value = 1) public int moo = 120;

    @Tag(value = 2) public long moo2 = 1234120;

    @Tag(value = 3) public TestClass child;

    @Tag(value = 4) public int zzz = 123;

    @Tag(value = 5) public AnotherClass other;

    @Tag(value = 6) public RecordClass record;

    @Tag(value = 7) @Deprecated public int ignored;
  ...
  public static class IncompatibleClass extends TestClass {
    @Tag(value = 3) public int poorlyTaggedField = 5;
  }

  public static class AnotherClass {
    @Tag(value = 1) String value;
  }

  public record OldRecordClass(@Tag(value = 0) long x, @Tag(value = 1) double y, @Tag(value = 2) int width) {
  }

  public record RecordClass(@Tag(value = 3) String height, @Tag(value = 2) int width, @Tag(value = 0) long x, @Tag(value = 1) double y) {
  }

  private static class FutureClass {
    @Tag(value = 0) public Integer value;

    @Tag(value = 1) public FutureClass2 futureClass2;
