...
public class CompatibleFieldSerializerTest extends KryoTestCase {
  ...
  @Test public void testCompatibleFieldSerializer() {
  ...
  private void testCompatibleFieldSerializer(int length, boolean references, final boolean chunked) {
    ...
    CompatibleFieldSerializerFactory factory = new CompatibleFieldSerializerFactory() {
      @Override public CompatibleFieldSerializer newSerializer(Kryo kryo, Class type) {
  ...
  @Test public void testAddedField() {
  ...
  @Test public void testAddedFieldToClassWithManyFields() {
  ...
  private void testAddedFieldToClassWithManyFields(int length, boolean references, boolean chunked, boolean readUnknownTagData) {
    kryo.setReferences(references);
  ...
  @Test public void testRemovedField() {
  ...
  @Test public void testChangeFieldTypeWithChunkedEncodingEnabled() {
    testChangeFieldType(16, true);
  }

  @Test public void testChangeFieldTypeWithChunkedEncodingDisabled() {
  ...
  @Test public void testChangePrimitiveAndWrapperFieldTypes() {
  ...
  @Test public void testRemovedFieldFromClassWithManyFields() {
  ...
  private void testRemovedFieldFromClassWithManyFields(int length, boolean references, boolean chunked, boolean readUnknownTagData) {
    kryo.setReferences(references);
    CompatibleFieldSerializer serializer = new CompatibleFieldSerializer(kryo, ClassWithManyFields.class);
    serializer.getCompatibleFieldSerializerConfig().setReadUnknownFieldData(readUnknownTagData);
    serializer.getCompatibleFieldSerializerConfig().setChunkedEncoding(chunked);
  ...
  @Test public void testRemovedMultipleFieldsFromClassWithManyFields() {
  ...
  private void testRemovedMultipleFieldsFromClassWithManyFields(int length, boolean references, boolean chunked, boolean readUnknownTagData) {
    kryo.setReferences(references);
    CompatibleFieldSerializer serializer = new CompatibleFieldSerializer(kryo, ClassWithManyFields.class);
    serializer.getCompatibleFieldSerializerConfig().setReadUnknownFieldData(readUnknownTagData);
    serializer.getCompatibleFieldSerializerConfig().setChunkedEncoding(chunked);
  ...
  @Test public void testClassWithSuperTypeFields() {
    kryo.setReferences(false);
    kryo.setRegistrationRequired(false);
    CompatibleFieldSerializer<ClassWithSuperTypeFields> serializer = new CompatibleFieldSerializer<>(kryo, ClassWithSuperTypeFields.class);
  ...
  @Test public void testClassWithObjectField() {
  ...
  public static class ClassWithSuperTypeFields {
    ...
    @Override public boolean equals(Object o) {
      ...
      return Objects.equals(value, that.value) && Objects.equals(list, that.list) && Objects.equals(serializable, that.serializable);
    }
...
<<<<<<< /usr/src/app/output/esotericsoftware/kryo/eb5c55a645d4fae27c02742df6c5768a61d27658/test/com/esotericsoftware/kryo/serializers/CompatibleFieldSerializerTest.java/left.java
...
>>>>>>> /usr/src/app/output/esotericsoftware/kryo/eb5c55a645d4fae27c02742df6c5768a61d27658/test/com/esotericsoftware/kryo/serializers/CompatibleFieldSerializerTest.java/right.java


  @Test public void testLogWarningOnDuplicateFieldInClassHierarchy() {
