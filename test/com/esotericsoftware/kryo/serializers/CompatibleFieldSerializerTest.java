...
class CompatibleFieldSerializerTest extends KryoTestCase {
  ...
  @Test void testCompatibleFieldSerializer() {
  ...
  @Test void testAddedFieldToClassWithManyFields() {
  ...
  @Test void testChangeFieldTypeWithChunkedEncodingEnabled() {
    testChangeFieldType(16, true);
  }

  @Test void testChangeFieldTypeWithChunkedEncodingDisabled() {
    assertThrows(KryoException.class, () -> testChangeFieldType(14, false), "Read type is incompatible with the field type: String -> Long");
  }
  ...
  @Test void testChangePrimitiveAndWrapperFieldTypes() {
  ...
  @Test void testRemovedFieldFromClassWithManyFields() {
  ...
  @Test void testRemovedMultipleFieldsFromClassWithManyFields() {
  ...
  @Test void testRemoveAllFieldsFromClassWithManyFields() {
    CompatibleFieldSerializer serializer = new CompatibleFieldSerializer<>(kryo, ClassWithManyFields.class);
    kryo.register(ClassWithManyFields.class, serializer);
    ClassWithManyFields object1 = new ClassWithManyFields();
  ...
  @Test void testClassWithSuperTypeFields() {
    kryo.setReferences(false);
  ...
  @Test void testClassWithObjectField() {
  ...
  @Test void testClassWithLambdaField() {
  ...
  @Test void testClassWithGenericField() {
    CompatibleFieldSerializer.CompatibleFieldSerializerConfig config = new CompatibleFieldSerializer.CompatibleFieldSerializerConfig();
    kryo.setDefaultSerializer(new CompatibleFieldSerializerFactory(config));
  ...
  public static class ClassWithLambdaField {
    @FunctionalInterface public interface Callback extends Serializable {
      int call();
    }
