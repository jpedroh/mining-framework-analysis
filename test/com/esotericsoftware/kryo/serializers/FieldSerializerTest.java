...
/** @author Nathan Sweet */
@SuppressWarnings(value = { "synthetic-access" }) class FieldSerializerTest extends KryoTestCase {
  {
    supportsCopy = true;
  }

  @Test void testDefaultTypes() {
  ...
  @Test void testFieldRemovalOnGenerics() {
  ...
  @Test void testOptionalRegistration() {
  ...
  @Test void testRegistrationOrder() {
    A a = new A();
    a.value = 100;
    a.b = new B();
    a.b.value = 200;
  ...
  @Test void testNoDefaultConstructor() {
    ...
    roundTrip(2, object1);
    kryo.register(ComplexNoDefaultConstructor.class, new FieldSerializer<ComplexNoDefaultConstructor>(kryo, ComplexNoDefaultConstructor.class) {
  ...
  @Test void testDefaultSerializerAnnotation() {
    kryo = new Kryo();
    kryo.setRegistrationRequired(false);
    kryo.setReferences(true);
  ...
  @Test void testOptionalAnnotation() {
    kryo = new Kryo();
    kryo.setRegistrationRequired(false);
    kryo.setReferences(true);
  ...
  @Test void testInstantiatorStrategy() {
  ...
  @Test void testDefaultInstantiatorStrategy() {
    kryo.register(HasArgumentConstructor.class);
  ...
  @Test void testStdInstantiatorStrategy() {
    kryo.register(HasArgumentConstructor.class);
    kryo.setInstantiatorStrategy(new StdInstantiatorStrategy());
    HasArgumentConstructor test = new HasPrivateConstructor();
    HasPrivateConstructor.invocations = 0;
    kryo.register(HasPrivateConstructor.class);
    roundTrip(4, test);
    assertEquals(0, HasPrivateConstructor.invocations, "Default constructor should not be invoked with StdInstantiatorStrategy strategy");
  }

  @Test void testGenericTypes() {
    kryo.setReferences(true);
  ...
  @Test void testTransients() {
    ...
    assertTrue(!objectWithTransients3.equals(objectWithTransients1), "Objects should be different if copy does not include transient fields");
  ...
  @Test void testTransientsUsingGlobalConfig() {
  ...
  @Test void testSerializeTransients() {
    kryo.register(HasTransients.class);
    HasTransients objectWithTransients1 = new HasTransients();
    objectWithTransients1.transientField1 = "Test";
    objectWithTransients1.anotherField2 = 5;
    ...
    assertTrue(!objectWithTransients3.equals(objectWithTransients1), "Objects should be different if write does not include transient fields");
    assertNull(objectWithTransients3.transientField1, "transient fields should be null");
  ...
  @Test void testSerializeTransientsUsingGlobalConfig() {
    FieldSerializerFactory factory = new FieldSerializerFactory();
  ...
  @Test void testCorrectlyAnnotatedFields() {
  ...
  @Test void testWronglyAnnotatedCollectionFields() {
    try {
      ...
      assertTrue(ex.getMessage().contains("only be used with a field implementing Collection"), "Exception should complain about a field not implementing java.util.Collection");
      return;
    }
    fail("Exception was expected");
  }

  @Test void testWronglyAnnotatedMapFields() {
    try {
      kryo.register(WronglyAnnotatedMapFields.class);
      WronglyAnnotatedMapFields obj1 = new WronglyAnnotatedMapFields();
      roundTrip(31, obj1);
    } catch (RuntimeException ex) {
      assertTrue(ex.getMessage().contains("can only be used with a field implementing Map"), "Exception should complain about a field not implementing java.util.Map ");
      return;
    }
    fail("Exception was expected");
  }

  @Test void testMultipleTimesAnnotatedMapFields() {
    try {
      ...
      assertTrue(ex.getMessage().contains("already has a serializer"), "Exception should complain about a field that has a serializer already");
      return;
    }
    fail("Exception was expected");
  }
  ...
  public static class DefaultTypes {
    ...
    public boolean equals(Object obj) {
      ...
      if (ByteField == null) {
        ...
        if (!ByteField.equals(other.ByteField)) {
          return false;
        }
      }
      if (CharacterField == null) {
        ...
        if (!CharacterField.equals(other.CharacterField)) {
          return false;
        }
      }
      if (DoubleField == null) {
      ...
      if (FloatField == null) {
        ...
        if (!FloatField.equals(other.FloatField)) {
          return false;
        }
      }
      ...
      if (LongField == null) {
        ...
        if (!LongField.equals(other.LongField)) {
          return false;
        }
      }
      if (ShortField == null) {
        ...
        if (!ShortField.equals(other.ShortField)) {
          return false;
        }
      }
      if (StringField == null) {
  ...
  public static class HasTransients {
    ...
    public boolean equals(Object obj) {
      ...
      if (anotherField3 == null) {
        ...
        if (!anotherField3.equals(other.anotherField3)) {
          return false;
        }
      }
      if (transientField1 == null) {
        ...
        if (!transientField1.equals(other.transientField1)) {
          return false;
        }
      }
      return true;
  ...
  public static class ComplexNoDefaultConstructor {
    ...
    public boolean equals(Object obj) {
      ...
      if (anotherField2 == null) {
        ...
        if (!anotherField2.equals(other.anotherField2)) {
          return false;
        }
      }
      if (name == null) {
  ...
  @DefaultSerializer(value = FieldSerializer.class) public static class HasNonNull {
    ...
    public boolean equals(Object obj) {
      ...
      if (nonNullText == null) {
        ...
        if (!nonNullText.equals(other.nonNullText)) {
          return false;
        }
      }
      return true;
  ...
  @DefaultSerializer(serializerFactory = FieldSerializerFactory.class) public static class HasStringField {
    public String text;
  ...
  @DefaultSerializer(value = HasDefaultSerializerAnnotationSerializer.class) public static class HasDefaultSerializerAnnotation {
    long time;
  ...
  public static class HasGenerics<T extends java.lang.Object> {
  ...
  public static class MultipleTimesAnnotatedCollectionFields {
    @BindCollection(elementSerializer = LongArraySerializer.class, elementClass = long[].class, elementsCanBeNull = false) @Bind(serializer = CollectionSerializer.class) Collection collection;
  }
  ...
  public static class AnnotatedFields {
    ...
    public boolean equals(Object obj) {
      ...
      if (!Objects.equals(listOfHasFields, other.listOfHasFields)) {
        return false;
      }
      return true;
    }
  ...
  public static class IsGeneric<T extends java.lang.Object> {
    T item;
