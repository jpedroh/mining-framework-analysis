...
/** @author Nathan Sweet */
@SuppressWarnings(value = { "synthetic-access" }) class MapSerializerTest extends KryoTestCase {
  {
    supportsCopy = true;
  }
  ...
  @Test void testEmptyHashMap() {
    execute(new HashMap(), 0);
  }

  @Test void testNotEmptyHashMap() {
    execute(new HashMap(), 1000);
  }

  @Test void testEmptyConcurrentHashMap() {
    execute(new ConcurrentHashMap(), 0);
  }

  @Test void testNotEmptyConcurrentHashMap() {
    execute(new ConcurrentHashMap(), 1000);
  }

  @Test void testGenerics() {
  ...
  @Test void testConcurrentSkipListMapSerializer() {
  ...
  @Test void testTreeMapWithReferences() {
  ...
  @Test void testSerializingMapAfterDeserializingMultipleReferencesToSameMap() {
    Kryo kryo = new Kryo();
    ...
    Map<Integer, List<String>> deserializedMap = (Map<Integer, List<String>>) kryo.readClassAndObject(new Input(new ByteArrayInputStream(output.getBuffer())));
    assertEquals(1, deserializedMap.size());
  }

  @Test void testArrayListKeys() {
  ...
  public static class TreeMapSubclass<K extends java.lang.Object, V extends java.lang.Object> extends TreeMap<K, V> {
  ...
  public static class ConcurrentSkipListMapSubclass<K extends java.lang.Object, V extends java.lang.Object> extends ConcurrentSkipListMap<K, V> {
