...
public class WarnUnregisteredClassesTest {
  ...
  @Test public void testLogOnlyOneTimePerClass() {
    Kryo kryo = new Kryo();
  ...
  @Test public void testDontLogIfNotRequired() {
    Kryo kryo = new Kryo();
    kryo.setRegistrationRequired(false);
  ...
  @Test public void testDontLogClassIsRegistered() {
    Kryo kryo = new Kryo();
    kryo.setRegistrationRequired(false);
    kryo.setWarnUnregisteredClasses(true);
  ...
  @Test public void testLogShouldBeWarn() {
    Kryo kryo = new Kryo();
    kryo.setRegistrationRequired(false);
    kryo.setWarnUnregisteredClasses(true);
    write(kryo, new UnregisteredClass());
  ...
  @Test public void testLogMessageShouldContainClassName() {
    Kryo kryo = new Kryo();
    kryo.setRegistrationRequired(false);
    kryo.setWarnUnregisteredClasses(true);
    write(kryo, new UnregisteredClass());
  ...
  @Test public void testLogMessageShouldContainRegistrationHintWithCanonicalName() {
    Kryo kryo = new Kryo();
    kryo.setRegistrationRequired(false);
    kryo.setWarnUnregisteredClasses(true);
    write(kryo, new UnregisteredClass());
    assertTrue(log.messages.get(0).contains("kryo.register(com.esotericsoftware.kryo.WarnUnregisteredClassesTest.UnregisteredClass.class)"));
  }
  ...
  public static class LoggerStub extends Logger {
    ...
    @Override public void log(int level, String category, String message, Throwable ex) {
      levels.add(level);
