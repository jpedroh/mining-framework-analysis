...
public abstract class KryoTestCase {
  ...
  public <T extends java.lang.Object> void roundTrip(int lengthGenerics, int lengthNoGenerics, T object1) {
  ...
  private <T extends java.lang.Object> void roundTrip(int length, T object1, boolean optimizedGenerics) {
    try {
