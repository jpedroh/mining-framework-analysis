...
@SuppressWarnings(value = { "Duplicates" }) public class MantaEncryptedObjectInputStream extends MantaObjectInputStream {
  ...
  /**
     ...
     */
  public MantaEncryptedObjectInputStream(final MantaObjectInputStream backingStream, final SecretKey secretKey) {
    super(backingStream);
  ...
  private SupportedCipherDetails findCipherDetails() {
    ...
    if (details == null) {
      String msg = "Unsupported cipher id / cipher type " + "used to encrypt object";
      MantaClientEncryptionException e = new MantaClientEncryptionException(msg);
      annotateException(e);
      throw e;
    }
