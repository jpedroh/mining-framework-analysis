...
public abstract class AbstractJsonFluentAssertTest {
  @Test public void testAssertString() {
    try {
  ...
  @Test public void testAssertDifferentType() {
    try {
  ...
  @Test public void testAssertDifferentTypeInt() {
    try {
      assertThatJson("{\"test\":\"1\"}").node("test").isEqualTo(1);
      failIfNoException();
    } catch (AssertionError e) {
  ...
  @Test public void testAssertToleranceDifferentOrder() {
    assertThatJson("{\"test\":1.00001}").withTolerance(0.001).node("test").isEqualTo(1);
  }

  @Test public void testAssertToleranceDirect() {
    assertThatJson("{\"test\":1.00001}").withTolerance(0.001).isEqualTo("{\"test\":1}");
  }

  @Test public void testAssertToleranceFailure() {
    try {
  ...
  @Test public void testAssertReader() {
    try {
  ...
  @Test public void testOkNumber() {
    assertThatJson("{\"test\":1}").node("test").isEqualTo(1);
  }

  @Test public void testOkNumberInString() {
    assertThatJson("{\"test\":1}").node("test").isEqualTo("1");
  }

  @Test public void testOkFloat() {
    assertThatJson("{\"test\":1.1}").node("test").isEqualTo(1.1);
  }

  @Test public void testOkNull() {
  ...
  @Test public void testSameStructureOk() {
    assertThatJson("{\"test\":1}").hasSameStructureAs("{\"test\":21}");
  }

  @Test public void testDifferentStructure() {
    try {
  ...
  @Test public void testAssertPath() {
    try {
  ...
  @Test public void testAssertPathArrayOk() {
    assertThatJson("{\"root\":{\"test\":[1,2,3]}}").node("root.test[1]").isEqualTo(2);
  }

  @Test public void testLongPaths() {
    try {
  ...
  @Test public void testMoreNodes() {
    try {
  ...
  @Test public void shouldAllowWeirdCharsInArrayPattern() {
  ...
  @Test public void anyNumberShouldAcceptAnInt() {
    assertThatJson("{\"test\":1}").isEqualTo("{\"test\":\"${json-unit.any-number}\"}");
  }

  @Test public void anyNumberShouldAcceptAFloat() {
    assertThatJson("{\"test\":1.1}").isEqualTo("{\"test\":\"${json-unit.any-number}\"}");
  }

  @Test public void anyNumberShouldFailOnString() {
    try {
  ...
  @Test public void anyBooleanShouldFailOnString() {
    try {
      assertThatJson("{\"test\":\"true\"}").isEqualTo("{\"test\":\"${json-unit.any-boolean}\"}");
      failIfNoException();
    } catch (AssertionError e) {
  ...
  @Test public void anyBooleanShouldFailOnNull() {
    try {
  ...
  @Test public void anyBooleanShouldFailOnObject() {
    try {
  ...
  @Test public void anyStringShouldAcceptAString() {
    assertThatJson("{\"test\":\"value\"}").isEqualTo("{test:\'${json-unit.any-string}\'}");
  }

  @Test public void anyStringShouldFailOnBoolean() {
    try {
  ...
  @Test public void anyStringShouldFailOnNull() {
    try {
  ...
  @Test public void anyStringShouldFailOnObject() {
    try {
  ...
  @Test public void comparisonShouldFailOnDifferentType() {
    try {
      assertThatJson("{\"test\":1}").isEqualTo("{\"test\":\"1\"}");
      failIfNoException();
    } catch (AssertionError e) {
  ...
  @Test public void isArrayShouldFailIfItIsNotArray() {
    try {
      ...
      assertEquals("Node \"test\" has invalid type, expected: <array> but was: <\"1\">.", e.getMessage());
    }
  }
  ...
  @Test public void intValueShouldMatch() {
  ...
  @Test public void intValueShouldFailIfDoesNotMatch() {
    try {
  ...
  @Test public void floatValueShouldMatch() {
    assertThatJson("{\"test\":1.10001}").node("test").matches(closeTo(valueOf(1.1), valueOf(0.001)));
  }

  @Test public void floatValueShouldFailIfDoesNotMatch() {
    try {
      assertThatJson("{\"test\":1}").node("test").matches(equalTo(valueOf(2)));
      failIfNoException();
    } catch (AssertionError e) {
  ...
  @Test public void booleanValueShouldMatch() {
    assertThatJson("{\"test\":true}").node("test").matches(equalTo(true));
  }

  @Test public void booleanValueShouldFailIfDoesNotMatch() {
    try {
  ...
  @Test public void missingValueShouldFail() {
    try {
  ...
  @Test public void stringValueShouldMatch() {
    assertThatJson("{\"test\":\"one\"}").node("test").matches(equalTo("one"));
  }

  @Test public void stringValueShouldFailIfDoesNotMatch() {
    try {
  ...
  @Test public void nullValueShouldMatch() {
    assertThatJson("{\"test\":null}").node("test").matches(nullValue());
  }

  @Test public void nullValueShouldFailIfDoesNotMatch() {
    try {
  ...
  @Test public void arrayShouldMatch() {
    assertThatJson("{\"test\":[1,2,3]}").node("test").matches(hasItem(valueOf(1)));
  }

  @Test public void arraySizeShouldMatch() {
    assertThatJson("{\"test\":[1,2,3]}").node("test").matches(hasSize(3));
  }

  @Test public void arrayMatcherShouldFailIfNotFound() {
    try {
  ...
  @Test public void isStringShouldFailIfItDoesNotExist() {
    try {
  ...
  @Test public void shouldChainStringEquals() {
    assertThatJson("{ \"key1\": \"[value1]\", \"key2\": \"[value2]\" }").node("key1").isStringEqualTo("[value1]").node("key2").isStringEqualTo("[value2]");
  }
  ...
  @Test public void isStringShouldFailIfItIsNotAString() {
    try {
      ...
      assertEquals("Node \"test\" has invalid type, expected: <string> but was: <1>.", e.getMessage());
    }
  }

  @Test public void isStringEqualToShouldFailIfItIsNotAString() {
    try {
  ...
  @Test public void isStringEqualToShouldFailIfItDiffers() {
    try {
      assertThatJson("{\"test\":\"2\"}").node("test").isStringEqualTo("1");
      failIfNoException();
    } catch (AssertionError e) {
      assertEquals("Different value found in node \"test\", expected: <\"1\"> but was: <\"2\">.", e.getMessage());
    }
  }
  ...
  @Test public void equalsShouldFailOnStringAndANumber() {
    try {
      assertThatJson("{\"test\":\"1\"}").node("test").isEqualTo("1");
      failIfNoException();
    } catch (AssertionError e) {
  ...
  @Test public void isStringShouldFailOnNull() {
    try {
      assertThatJson("{\"test\":null}").node("test").isStringEqualTo("1");
      failIfNoException();
    } catch (AssertionError e) {
      assertEquals("Node \"test\" has invalid type, expected: <string> but was: <null>.", e.getMessage());
    }
  }

  @Test public void isStringShouldPass() {
    assertThatJson("{\"test\":\"1\"}").node("test").isString();
  }

  @Test public void arrayOfLengthShouldPass() {
    assertThatJson("{\"test\":[1,2,3]}").node("test").isArray().ofLength(3);
  }

  @Test public void arrayThatContainsShouldPass() {
    assertThatJson("{\"test\":[{\"id\":36},{\"id\":37},{\"id\":38}]}").node("test").isArray().thatContains("{\"id\":37}");
  }

  @Test public void isObjectShouldPassOnObject() {
    assertThatJson("{\"test\":{\"a\":true}}").node("test").isObject();
  }

  @Test public void isObjectShouldFailOnBoolean() {
    try {
      assertThatJson("{\"test\":{\"a\":true}}").node("test.a").isObject();
      failIfNoException();
    } catch (AssertionError e) {
      assertEquals("Node \"test.a\" has invalid type, expected: <object> but was: <true>.", e.getMessage());
    }
  }

  @Test public void isObjectShouldFailOnMissing() {
    try {
  ...
  @Test(expected = AssertionError.class) public void testNotEqualsToToArray() {
    assertThatJson("{\"test\":[1,2,3]}").node("test").isNotEqualTo(new int[] { 1, 2, 3 });
  }

  @Test public void testEqualsToBoolean() {
    assertThatJson("{\"test\":true}").node("test").isEqualTo(true);
  }

  @Test public void testEqualsToNull() {
    assertThatJson("{\"test\":null}").node("test").isEqualTo(null);
  }

  @Test(expected = AssertionError.class) public void testEqualsToNullFail() {
    assertThatJson("{\"test\":1}").node("test").isEqualTo(null);
  }

  @Test public void testNotEqualsToNull() {
    assertThatJson("{\"test\":1}").node("test").isNotEqualTo(null);
  }

  @Test public void testIssue3() {
    assertThatJson("{\"someKey\":\"111 text\"}").node("someKey").isEqualTo("\"111 text\"");
  }

  @Test public void testIssue3NoSpace() {
  ...
  @Test public void testIssue3Original() {
    assertThatJson("{\"someKey\":\"111 text\"}").node("someKey").isEqualTo("111 text");
  }

  @Test public void testNullAndAbsent() {
    try {
