...
public class TestEval {
  ...
  @Test public void testInvalidExpressions1() {
    String err = "";
    try {
  ...
  @Test public void testInvalidExpressions2() {
    String err = "";
    try {
  ...
  @Test public void testInvalidExpressions3() {
    String err = "";
    try {
      Expression expression = new Expression("12 + * 18");
      expression.eval();
  ...
  @Test public void testInvalidExpressions4() {
    String err = "";
    try {
  ...
  @Test public void testWrongBrackets1() {
    String err = "";
    try {
  ...
  @Test public void testWrongBrackets2() {
    String err = "";
    try {
      Expression expression = new Expression("2*(3((5*3)))");
      expression.eval();
  ...
  @Test(expected = RuntimeException.class) public void testUnknow1() {
    assertEquals("", new Expression("7#9").eval().toPlainString());
  }

  @Test(expected = RuntimeException.class) public void testUnknow2() {
  ...
  @Test public void testExpectedParameterNumbers() {
    String err = "";
    try {
  ...
  @Test public void testVariableParameterNumbers() {
    String err = "";
    try {
  ...
  @Test public void testOrphanedOperators() {
    String err = "";
    try {
      new Expression("/").eval();
    } catch (ExpressionException e) {
  ...
  @Test(expected = ExpressionException.class) public void closeParenAtStartCausesExpressionException() throws Exception {
    new Expression("(").eval();
  }

  @Test public void testOrphanedOperatorsInFunctionParameters() {
    String err = "";
    try {
  ...
  @Test public void testExtremeFunctionNesting() {
    assertNotSame("1.5", new Expression("Random()").eval().toPlainString());
  ...
  @Test public void testTrigonometry() {
  ...
  @Test public void testMinMaxAbs() {
  ...
  @Test public void unknownFunctionsFailGracefully() throws Exception {
    String err = "";
    try {
  ...
  @Test public void unknownOperatorsFailGracefully() throws Exception {
    String err = "";
    try {
  ...
  @Test public void canEvalHexExpression() throws Exception {
    BigDecimal result = new Expression("0xcafe").eval();
    assertEquals("51966", result.toPlainString());
  }

  @Test public void testCalculationWithNull() {
    String err = "";
    try {
  ...
  @Test public void hexExpressionCanUseUpperCaseCharacters() throws Exception {
    BigDecimal result = new Expression("0XCAFE").eval();
    assertEquals("51966", result.toPlainString());
  }

  @Test public void longHexExpressionWorks() throws Exception {
    BigDecimal result = new Expression("0xcafebabe", MathContext.DECIMAL128).eval();
    assertEquals("3405691582", result.toPlainString());
  }

  @Test(expected = ExpressionException.class) public void hexExpressionDoesNotAllowNonHexCharacters() throws Exception {
    BigDecimal result = new Expression("0xbaby").eval();
  }

  @Test(expected = NumberFormatException.class) public void throwsExceptionIfDoesNotContainHexDigits() throws Exception {
    BigDecimal result = new Expression("0x").eval();
  }

  @Test public void hexExpressionsEvaluatedAsExpected() throws Exception {
