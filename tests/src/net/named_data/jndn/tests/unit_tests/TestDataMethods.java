...
class CredentialStorage {
  ...
  public void verifyData(Data data, OnVerified verifiedCallback, OnVerifyFailed failedCallback) throws SecurityException {
...
public class TestDataMethods {
  ...
  private static ArrayList dumpData(Data data) {
    ...
    result.add(dump("metaInfo.freshnessPeriod (milliseconds):", data.getMetaInfo().getFreshnessPeriod() >= 0 ? "" + data.getMetaInfo().getFreshnessPeriod() : "<none>"));
  ...
  private static ArrayList initialDump = new ArrayList(Arrays.asList(new Object[] { "name: /ndn/abc", "content (raw): SUCCESS!", "content (hex): 5355434345535321", "metaInfo.freshnessPeriod (milliseconds): 5000.0", "metaInfo.finalBlockId: %00%09", "signature.signature: ", "signature.keyLocator: KeyName: /testname/KEY/DSK-123/ID-CERT" }));
  ...
  @Test public void testEncodeDecode() {
    ...
    assertEquals("Re-decoded data does not match original dump", initialDump, dumpData(reDecodedData));
  }
