    ...
    if (activityInsertionCostCalculator == null && addDefaultCostCalc) {
      ...
      if (activityInsertionCostCalculator == null && !addDefaultCostCalc) {
        actInsertionCalc = new ActivityInsertionCostsCalculator() {
          @Override public double getCosts(JobInsertionContext iContext, TourActivity prevAct, TourActivity nextAct, TourActivity newAct, double depTimeAtPrevAct) {
            return 0.;
          }
        };
      } else {
...
<<<<<<< /usr/src/app/output/jsprit/jsprit/2503a96237209122a3410850fc3c86334bf3231d/jsprit-core/src/main/java/jsprit/core/algorithm/recreate/JobInsertionCostsCalculatorBuilder.java/left.java
...
>>>>>>> /usr/src/app/output/jsprit/jsprit/2503a96237209122a3410850fc3c86334bf3231d/jsprit-core/src/main/java/jsprit/core/algorithm/recreate/JobInsertionCostsCalculatorBuilder.java/right.java
