...
<<<<<<< /usr/src/app/output/jsprit/jsprit/a9d1e03c5618623bfd3fbf1c1bb59e205f50c775/jsprit-core/src/main/java/jsprit/core/algorithm/VehicleRoutingAlgorithm.java/left.java
      logger.trace("discovered solution: {}", discoveredSolution);
=======
      if (logger.isTraceEnabled()) {
        log(discoveredSolution);
      }
>>>>>>> /usr/src/app/output/jsprit/jsprit/a9d1e03c5618623bfd3fbf1c1bb59e205f50c775/jsprit-core/src/main/java/jsprit/core/algorithm/VehicleRoutingAlgorithm.java/right.java
  ...
  private void memorizeIfBestEver(DiscoveredSolution discoveredSolution) {
    ...
    if (bestEver == null) {
      ...
      if (discoveredSolution.getSolution().getCost() < bestEver.getCost()) {
        bestEver = discoveredSolution.getSolution();
      }
    }
  }
