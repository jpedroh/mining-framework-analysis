...
public class StateManager implements RouteAndActivityStateGetter, IterationStartsListener, RuinListener, InsertionStartsListener, JobInsertedListener, InsertionEndsListener {
  static class States_ {
    ...
    public <T extends java.lang.Object> void putState(StateId id, Class<T> type, T state) {
      states.put(id, type.cast(state));
    }

    public <T extends java.lang.Object> T getState(StateId id, Class<T> type) {
...
>>>>>>> /usr/src/app/output/jsprit/jsprit/9c4bd498c41594d2634c177e7309e0e365c58859/jsprit-core/src/main/java/jsprit/core/algorithm/state/StateManager.java/right.java
  ...
  @Deprecated public <T extends java.lang.Object> void addDefaultProblemState(StateId stateId, Class<T> type, T defaultState) {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> void putProblemState(StateId stateId, Class<T> type, T state) {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> T getProblemState(StateId stateId, Class<T> type) {
    return problemStates_.getState(stateId, type);
  }

  @Deprecated <T extends java.lang.Object> T getDefaultProblemState(StateId stateId, Class<T> type) {
    if (defaultProblemStates_.containsKey(stateId)) {
      return defaultProblemStates_.getState(stateId, type);
    }
    return null;
  }

  @Deprecated public <T extends java.lang.Object> void addDefaultRouteState(StateId stateId, Class<T> type, T defaultState) {
    if (StateFactory.isReservedId(stateId)) {
      StateFactory.throwReservedIdException(stateId.toString());
    }
    defaultRouteStates_.put(stateId, type.cast(defaultState));
  }

  @Deprecated public <T extends java.lang.Object> void addDefaultActivityState(StateId stateId, Class<T> type, T defaultState) {
    if (StateFactory.isReservedId(stateId)) {
      StateFactory.throwReservedIdException(stateId.toString());
    }
  ...
  /**
	 ...
	 */
  @Override public <T extends java.lang.Object> T getActivityState(TourActivity act, StateId stateId, Class<T> type) {
    if (act.getIndex() == 0) {
  ...
  /**
     ...
     * @throws java.lang.ClassCastException if type class is not equal to the associated type class of the requested state value
     */
  public <T extends java.lang.Object> T getActivityState(TourActivity act, Vehicle vehicle, StateId stateId, Class<T> type) {
    if (act.getIndex() == 0) {
      throw new IllegalStateException("activity index is 0. this should not be.");
    }
    if (act.getIndex() < 0) {
  ...
  @Deprecated private <T extends java.lang.Object> T getDefaultTypedActivityState(TourActivity act, StateId stateId, Class<T> type) {
  ...
  /**
     ...
     * @throws java.lang.ClassCastException if type class is not equal to the associated type class of the requested state value
     */
  @Override public <T extends java.lang.Object> T getRouteState(VehicleRoute route, StateId stateId, Class<T> type) {
    if (route.isEmpty()) {
      return null;
    }
    T state;
    int index_of_first_act = route.getActivities().get(0).getIndex();
    if (index_of_first_act == 0) {
      throw new IllegalStateException("first activity in route has no index. this should not be.");
    }
    try {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> T getRouteState(VehicleRoute route, Vehicle vehicle, StateId stateId, Class<T> type) {
    if (route.isEmpty()) {
      return null;
    }
    int index_of_first_act = route.getActivities().get(0).getIndex();
  ...
  @Deprecated private <T extends java.lang.Object> T getDefaultTypedRouteState(StateId stateId, Class<T> type) {
  ...
  @Deprecated public <T extends java.lang.Object> void putTypedActivityState(TourActivity act, StateId stateId, Class<T> type, T state) {
    if (stateId.getIndex() < 10) {
  ...
  /**
     ...
     */
  @Deprecated public <T extends java.lang.Object> void putActivityState(TourActivity act, StateId stateId, Class<T> type, T state) {
    if (act.getIndex() == 0) {
      throw new IllegalStateException("activity index is 0. this should not be.");
    }
    if (stateId.getIndex() < 10) {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> void putActivityState(TourActivity act, StateId stateId, T state) {
    if (act.getIndex() == 0) {
      throw new IllegalStateException("activity index is 0. this should not be.");
    }
    if (stateId.getIndex() < 10) {
  ...
  /**
     ...
     * @throws java.lang.IllegalStateException if stateId is equall to a stateId that is already used internally.
     */
  public <T extends java.lang.Object> void putActivityState(TourActivity act, Vehicle vehicle, StateId stateId, T state) {
    if (act.getIndex() == 0) {
      throw new IllegalStateException("activity index is 0. this should not be.");
    }
    if (stateId.getIndex() < 10) {
  ...
  <T extends java.lang.Object> void putInternalTypedActivityState(TourActivity act, StateId stateId, T state) {
    activity_states[act.getIndex()][stateId.getIndex()] = state;
  }

  <T extends java.lang.Object> void putInternalTypedActivityState(TourActivity act, Vehicle vehicle, StateId stateId, T state) {
    vehicle_dependent_activity_states[act.getIndex()][vehicle.getVehicleTypeIdentifier().getIndex()][stateId.getIndex()] = state;
  }

  @Deprecated public <T extends java.lang.Object> void putTypedRouteState(VehicleRoute route, StateId stateId, Class<T> type, T state) {
    putRouteState(route, stateId, state);
  }

  <T extends java.lang.Object> void putTypedInternalRouteState(VehicleRoute route, StateId stateId, T state) {
    if (route.isEmpty()) {
      return;
    }
  ...
  /**
     ...
     * @throws java.lang.IllegalStateException if stateId is equall to a stateId that is already used internally.
     */
  public <T extends java.lang.Object> void putRouteState(VehicleRoute route, StateId stateId, T state) {
    if (stateId.getIndex() < 10) {
      StateFactory.throwReservedIdException(stateId.toString());
    }
  ...
  /**
     ...
     * @throws java.lang.IllegalStateException if stateId is equall to a stateId that is already used internally.
     */
  public <T extends java.lang.Object> void putRouteState(VehicleRoute route, Vehicle vehicle, StateId stateId, T state) {
  ...
  <T extends java.lang.Object> void putTypedInternalRouteState(VehicleRoute route, Vehicle vehicle, StateId stateId, T state) {
    if (route.isEmpty()) {
      return;
    }
  ...
  public void addStateUpdater(StateUpdater updater) {
    if (updater instanceof ActivityVisitor) {
      addActivityVisitor((ActivityVisitor) updater);
    }
    if (updater instanceof ReverseActivityVisitor) {
      addActivityVisitor((ReverseActivityVisitor) updater);
    }
    if (updater instanceof RouteVisitor) {
      addRouteVisitor((RouteVisitor) updater);
    }
    if (updater instanceof InsertionListener) {
      addListener((InsertionListener) updater);
    }
    if (updater instanceof RuinListener) {
      addListener((RuinListener) updater);
    }
  ...
  @Override public void informInsertionEnds(Collection<VehicleRoute> vehicleRoutes) {
