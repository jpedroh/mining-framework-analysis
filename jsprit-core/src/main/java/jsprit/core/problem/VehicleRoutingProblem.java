...
public class VehicleRoutingProblem {
  public static class Builder {
    ...
    /**
         ...
         */
    @Deprecated public Builder addJob(Job job) {
    ...
    /**
         ...
         */
    @Deprecated public Builder addVehicle(Vehicle vehicle) {
    ...
    @SuppressWarnings(value = { "UnusedDeclaration" }) public Builder addLocation(String locationId, Coordinate coordinate) {
    ...
    /**
         ...
         * @return this builder
         */
    @SuppressWarnings(value = { "deprecation" }) public Builder addAllJobs(Collection<? extends Job> jobs) {
      for (Job j : jobs) {
        addJob(j);
      }
      return this;
    ...
    /**
         ...
         * @return this builder
         */
    @SuppressWarnings(value = { "deprecation" }) public Builder addAllVehicles(Collection<? extends Vehicle> vehicles) {
  ...
  @Override public String toString() {
    return "[fleetSize=" + fleetSize + "][#jobs=" + jobs.size() + "][#vehicles=" + vehicles.size() + "][#vehicleTypes=" + vehicleTypes.size() + "][" + "transportCost=" + transportCosts + "][activityCosts=" + activityCosts + "]";
  }
