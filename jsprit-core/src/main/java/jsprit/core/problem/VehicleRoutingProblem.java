 ...
 */
	...
	public Builder setRoutingCost(VehicleRoutingTransportCosts costs){
		 ...
		 *
		 * @param fleetSize
		 * 		the fleet size used in this problem. it can either be FleetSize.INFINITE or FleetSize.FINITE
		 * @return this builder
		 */
		 ...
		 * 		if job is neither a shipment nor a service, or jobId has already been added.
