...
public class VehicleTypeImpl implements VehicleType {
  ...
  public static class Builder {
    ...
    public static VehicleTypeImpl.Builder newInstance(String id) {
      if (capacity < 0) {
        throw new IllegalStateException("capacity cannot be smaller than zero");
      }
      if (id == null) {
        throw new IllegalStateException("typeId must be null");
      }
  ...
  /**
	 ...
	 */
  @Deprecated public static VehicleTypeImpl newInstance(String typeId, int capacity, VehicleTypeImpl.VehicleCostParams para) {
  ...
  @Deprecated public VehicleTypeImpl(String typeId, int capacity, VehicleTypeImpl.VehicleCostParams vehicleCostParams) {
    super();
    this.typeId = typeId;
    this.capacity = capacity;
