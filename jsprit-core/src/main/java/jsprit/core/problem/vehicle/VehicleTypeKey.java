...
public class VehicleTypeKey extends AbstractVehicle.AbstractTypeKey {
  ...
  @Override public String toString() {
    ...
    stringBuilder.append(type).append("_").append(startLocationId).append("_").append(endLocationId).append("_").append(Double.toString(earliestStart)).append("_").append(Double.toString(latestEnd));
