...
public class VehicleRoute {
  ...
  public static class Builder {
    ...
    /**
         ...
         */
    @Deprecated public Builder setServiceActivityFactory(TourActivityFactory serviceActivityFactory) {
    ...
    /**
         ...
         */
    @Deprecated public Builder setShipmentActivityFactory(TourShipmentActivityFactory shipmentActivityFactory) {
    ...
    /**
         ...
         */
    @Deprecated public Builder setRouteEndArrivalTime(double endTime) {
