...
public final class Start extends AbstractActivity implements TourActivity {
  ...
  @Deprecated public static int creation;
  ...
  @Deprecated public Start(String locationId, double theoreticalStart, double theoreticalEnd) {
    super();
    if (locationId != null) {
  ...
  @Deprecated public void setLocationId(String locationId) {
    if (locationId == null) {
      return;
    }
    this.location = Location.Builder.newInstance().setId(locationId).build();
  ...
  @Deprecated public void setTheoreticalEarliestOperationStartTime(double time) {
    this.theoretical_earliestOperationStartTime = time;
  }

  @Deprecated public void setTheoreticalLatestOperationStartTime(double time) {
    this.theoretical_latestOperationStartTime = time;
  }

  @Deprecated @Override public String getLocationId() {
    if (location == null) {
      return null;
    }
  ...
  @Override public String toString() {
    return "[type=" + getName() + "][location=" + location + "][twStart=" + Activities.round(theoretical_earliestOperationStartTime) + "][twEnd=" + Activities.round(theoretical_latestOperationStartTime) + "]";
  }
