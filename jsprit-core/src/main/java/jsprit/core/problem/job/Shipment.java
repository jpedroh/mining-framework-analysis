...
public class Shipment implements Job {
  public static class Builder {
    ...
    public Builder setDeliveryLocation(String deliveryLocation) {
      if (deliveryLocation == null) {
        throw new IllegalArgumentException("delivery location must not be null");
      }
    ...
    public Shipment build() {
      if (pickupLocation == null) {
        if (pickupCoord == null) {
          throw new IllegalStateException("either locationId or a coordinate must be given. But is not.");
        }
  ...
  @Override public int getCapacityDemand() {
    return demand;
  }
  ...
  @Override public Capacity getCapacity() {
    return capacity;
  }
}