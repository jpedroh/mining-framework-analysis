...
final class CalculatesServiceInsertion implements JobInsertionCalculator {
  ...
  private HardConstraint hardConstraint = new HardConstraint() {
    @Override public boolean fulfilled(InsertionScenario iScenario) {
      return true;
    }
  };
...
>>>>>>> /usr/src/app/output/jsprit/jsprit/c60ab8afd055cab1b8c7826b493fcae8b619e9c4/jsprit-core/src/main/java/algorithms/CalculatesServiceInsertion.java/right.java
  ...
  /**
	 ...
	 *  
	 */
  @Override public InsertionData calculate(final VehicleRoute currentRoute, final Job jobToInsert, final Vehicle newVehicle, double newVehicleDepartureTime, final Driver newDriver, final double bestKnownCosts) {
    if (jobToInsert == null) {
      throw new IllegalStateException("jobToInsert is missing.");
    }
    if (newVehicle == null || newVehicle instanceof NoVehicle) {
      throw new IllegalStateException("newVehicle is missing.");
    }
