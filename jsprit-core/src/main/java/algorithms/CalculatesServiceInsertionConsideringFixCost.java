...
final class CalculatesServiceInsertionConsideringFixCost implements JobInsertionCalculator {
  ...
  @Override public InsertionData calculate(final VehicleRoute currentRoute, final Job jobToInsert, final Vehicle newVehicle, double newVehicleDepartureTime, final Driver newDriver, final double bestKnownPrice) {
