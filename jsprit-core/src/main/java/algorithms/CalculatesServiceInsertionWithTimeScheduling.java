...
class CalculatesServiceInsertionWithTimeScheduling implements JobInsertionCostsCalculator {
  ...
  @Override public InsertionData getInsertionData(VehicleRoute currentRoute, Job jobToInsert, Vehicle newVehicle, double newVehicleDepartureTime, Driver newDriver, double bestKnownScore) {
...
=======
  @Override public InsertionData calculate(VehicleRoute currentRoute, Job jobToInsert, Vehicle newVehicle, double newVehicleDepartureTime, Driver newDriver, double bestKnownScore) {
    List<Double> vehicleDepartureTimes = new ArrayList<Double>();
    double currentStart;
    if (currentRoute.getStart() == null) {
      currentStart = newVehicleDepartureTime;
...
>>>>>>> /usr/src/app/output/jsprit/jsprit/97ff935abba1ddeb8ba877e70a406600ca8efbfb/jsprit-core/src/main/java/algorithms/CalculatesServiceInsertionWithTimeScheduling.java/right.java
}