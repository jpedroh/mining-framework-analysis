...
public class VehicleRoutingProblem {
  ...
  public static class Builder {
    ...
    public void addProblemConstraint(Constraint constraint) {
      if (!problemConstraints.contains(constraint)) {
    ...
    public Builder addJob(Job job) {
      if (job instanceof Service) {
        ...
        throw new IllegalStateException("job can only be a shipment or a service, but is instance of " + job.getClass());
      }
      return this;
    }
  ...
  @Override public String toString() {
    return "[fleetSize=" + fleetSize + "][fleetComposition=" + fleetComposition + "][#jobs=" + jobs.size() + "][#vehicles=" + vehicles.size() + "][#vehicleTypes=" + vehicleTypes.size() + "][" + "transportCost=" + transportCosts + "][activityCosts=" + activityCosts + "]";
  }
