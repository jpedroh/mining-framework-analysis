...
public class Shipment extends AbstractJob {
  ...
  public PickupShipmentDEPRECATED getPickupActivity() {
    return (PickupShipmentDEPRECATED) getActivityList().findByType(PickupShipmentDEPRECATED.NAME).get();
  }

  public DeliverShipmentDEPRECATED getDeliveryActivity() {
    return (DeliverShipmentDEPRECATED) getActivityList().findByType(DeliverShipmentDEPRECATED.NAME).get();
  }

  @Deprecated public Location getPickupLocation() {
  ...
  /**
     ...
     * @return service-time
     */
  @Deprecated public double getPickupServiceTime() {
    return getPickupActivity().getOperationTime();
  }

  @Deprecated public Location getDeliveryLocation() {
  ...
  /**
     ...
     */
  @Deprecated public double getDeliveryServiceTime() {
  ...
  /**
     ...
     */
  @Deprecated public TimeWindow getDeliveryTimeWindow() {
    return getDeliveryTimeWindows().iterator().next();
  }

  @Deprecated public Collection<TimeWindow> getDeliveryTimeWindows() {
  ...
  /**
     ...
     */
  @Deprecated public TimeWindow getPickupTimeWindow() {
    return getPickupTimeWindows().iterator().next();
  }

  @Deprecated public Collection<TimeWindow> getPickupTimeWindows() {
