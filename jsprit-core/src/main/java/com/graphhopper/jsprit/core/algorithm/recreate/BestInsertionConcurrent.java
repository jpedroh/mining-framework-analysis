...
public final class BestInsertionConcurrent extends AbstractInsertionStrategy {
  ...
  @Override public Collection<Job> insertUnassignedJobs(Collection<VehicleRoute> vehicleRoutes, Collection<Job> unassignedJobs) {
    ...
    for (final Job unassignedJob : unassignedJobList) {
      ...
      for (final Batch batch : batches) {
        completionService.submit(new Callable<Insertion>() {
          @Override public Insertion call() throws Exception {
