...
public class SolutionAnalyser {
  ...
  private static class LoadAndActivityCounter implements StateUpdater, ActivityVisitor {
    ...
    @Override public void visit(TourActivity activity) {
      if (activity instanceof PickupActivityNEW) {
        ...
        if (activity instanceof DeliveryActivityNEW) {
          deliveryCounter++;
  ...
  private static class BackhaulAndShipmentUpdater implements StateUpdater, ActivityVisitor {
    ...
    @Override public void visit(TourActivity activity) {
      if (activity instanceof PickupShipmentDEPRECATED) {
        ...
        if (activity instanceof DeliverShipmentDEPRECATED) {
  ...
  public SizeDimension getCapacityViolation(VehicleRoute route) {
    ...
    return SizeDimension.max(SizeDimension.Builder.newInstance().build(), maxLoad.subtract(route.getVehicle().getType().getCapacityDimensions()));
  }
  ...
  public SizeDimension getCapacityViolationAtBeginning(VehicleRoute route) {
    ...
    return SizeDimension.max(SizeDimension.Builder.newInstance().build(), atBeginning.subtract(route.getVehicle().getType().getCapacityDimensions()));
  }
  ...
  public SizeDimension getCapacityViolationAtEnd(VehicleRoute route) {
    ...
    return SizeDimension.max(SizeDimension.Builder.newInstance().build(), atEnd.subtract(route.getVehicle().getType().getCapacityDimensions()));
  }
  ...
  public SizeDimension getCapacityViolationAfterActivity(TourActivity activity, VehicleRoute route) {
    ...
    return SizeDimension.max(SizeDimension.Builder.newInstance().build(), afterAct.subtract(route.getVehicle().getType().getCapacityDimensions()));
  }
