...
public class VehicleImpl extends AbstractVehicle {
  public static class NoVehicle extends AbstractVehicle {
    ...
    @Override public boolean isReturnToDepot() {
      return false;
    }
    ...
    @Override public Location getEndLocation() {
      return null;
    }
    ...
    @Override public Break getBreak() {
      return null;
    }
  }
  ...
  public static class Builder {
    ...
    public Builder addAllSkills(Collection<String> skills) {
      if (skills == null) {
        throw new IllegalArgumentException("Skills of vehicle " + id + " must not be null");
      }
    ...
    public Builder addSkill(String skill) {
      if (skill == null) {
        throw new IllegalArgumentException("Skill of vehicle " + id + " must not be null");
      }
    ...
    public VehicleImpl build() {
      ...
      if (startLocation != null && endLocation != null) {
        if (!startLocation.getId().equals(endLocation.getId()) && !returnToDepot) {
          throw new IllegalArgumentException("You specified both the end location and that the vehicle " + id + " does not need to return to its end location. This must not be. " + "Either specify end location and return to depot or leave end location unspecified.");
        }
      }
      if (startLocation != null && endLocation == null) {
  ...
  @Override public String toString() {
    return "[id=" + id + "]" + "[type=" + type + "]" + "[startLocation=" + startLocation + "]" + "[endLocation=" + endLocation + "]" + "[isReturnToDepot=" + isReturnToDepot() + "]" + "[skills=" + skills + "]";
  }
