...
public class InsertionData {
  ...
  /**
     ...
     */
  @Deprecated public void setAdditionalTime(double additionalTime) {
    this.additionalTime = additionalTime;
  }

  @Deprecated public InsertionData(double insertionCost, int pickupInsertionIndex, int deliveryInsertionIndex, Vehicle vehicle, Driver driver) {
  ...
  /**
     ...
     * @return
     */
  @Deprecated public int getDeliveryInsertionIndex() {
  ...
  /**
     ...
     * @return
     */
  @Deprecated public int getPickupInsertionIndex() {
  ...
  /**
     ...
     */
  @Deprecated public void setVehicleDepartureTime(double departureTime) {
