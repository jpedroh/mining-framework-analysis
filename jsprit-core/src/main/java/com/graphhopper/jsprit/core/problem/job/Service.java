...
public class Service extends AbstractJob {
  public static abstract class BuilderBase<T extends Service, B extends BuilderBase<T, B>> extends JobBuilder<T, B> {
    ...
    /**
         ...
         * @return the builder
         */
    @SuppressWarnings(value = { "unchecked" }) protected B setType(String name) {
      type = name;
      return (B) this;
    }
    ...
    /**
         ...
         * @return builder
         */
    @SuppressWarnings(value = { "unchecked" }) public B setLocation(Location location) {
    ...
    /**
         ...
         */
    @SuppressWarnings(value = { "unchecked" }) public B setServiceTime(double serviceTime) {
      if (serviceTime < 0) {
    ...
    /**
         ...
         */
    @Override @SuppressWarnings(value = { "unchecked" }) public B addSizeDimension(int dimensionIndex, int dimensionValue) {
      if (dimensionValue < 0) {
    ...
    @SuppressWarnings(value = { "unchecked" }) public B setTimeWindow(TimeWindow tw) {
      if (tw == null) {
    ...
    @SuppressWarnings(value = { "unchecked" }) public B addTimeWindow(TimeWindow timeWindow) {
      if (timeWindow == null) {
        throw new IllegalArgumentException("time-window arg must not be null");
      }
  ...
  public static class Builder extends BuilderBase<Service, Builder> {
    ...
    @Override protected Service createInstance() {
  ...
  /**
     ...
     */
  @Deprecated public double getServiceDuration() {
  ...
  /**
     ...
     *
     */
  @Deprecated public TimeWindow getTimeWindow() {
    return getServiceTimeWindows().iterator().next();
  }

  @Deprecated public Collection<TimeWindow> getServiceTimeWindows() {
  ...
  @Override public String toString() {
    return "[id=" + getId() + "][name=" + getName() + "][type=" + type + "][location=" + getLocation() + "][capacity=" + getSize() + "][serviceTime=" + getServiceDuration() + "][timeWindow=" + getTimeWindows() + "]";
  }
