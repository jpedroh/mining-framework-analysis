 ...
 */
@Deprecated public class Service extends AbstractJob {
  @Deprecated public static class Builder<T extends Service> {
    /**
  ...
  Service(Builder<?> builder) {
    BuilderActivityInfo activityInfo = new BuilderActivityInfo(ActivityType.SERVICE, builder.location);
    ...
    customJobBuilder.addActivity(activityInfo).addAllRequiredSkills(builder.skills).setName(builder.name).addUserData(builder.userData).setPriority(builder.priority);
    theRealJob = customJobBuilder.build();
    theRealActivity = (ServiceActivity) theRealJob.getActivityList().getAll().get(0);
  }

  @Override public Collection<TimeWindow> getTimeWindows() {
  ...
  @Override public String toString() {
    return "[id=" + getId() + "][name=" + getName() + "][type=" + getType() + "][location=" + getLocation() + "][capacity=" + getSize() + "][serviceTime=" + getServiceDuration() + "][timeWindow=" + getTimeWindow() + "]";
  }
  ...
  @Override public Object getUserData() {
  ...
  @Override public void impl_setIndex(FriendlyHandshake handshake, int index) {
  ...
  @Override public SizeDimension getSizeAtStart() {
    return theRealJob.getSizeAtStart();
  }

  @Override public SizeDimension getSizeAtEnd() {
