...
public class Service extends AbstractJob {
  public static class Builder<T extends Service> {
    ...
    public T build() {
      if (location == null) {
        throw new IllegalArgumentException("The location of service " + id + " is missing.");
      }
  ...
  @Override public String toString() {
    return "[id=" + id + "][name=" + name + "][type=" + type + "][location=" + location + "][capacity=" + size + "][serviceTime=" + serviceTime + "][timeWindows=" + timeWindows + "]";
  }
