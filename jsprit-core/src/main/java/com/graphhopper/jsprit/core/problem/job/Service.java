...
<<<<<<< /usr/src/app/output/jsprit/jsprit/9fe0b3315e0376479ad9be196dc988ad75af06ac/jsprit-core/src/main/java/com/graphhopper/jsprit/core/problem/job/Service.java/left.java
  public static final class Builder extends AbstractSingleActivityJob.BuilderBase<Service, Builder> {
...
>>>>>>> /usr/src/app/output/jsprit/jsprit/9fe0b3315e0376479ad9be196dc988ad75af06ac/jsprit-core/src/main/java/com/graphhopper/jsprit/core/problem/job/Service.java/right.java
  ...
  @Override protected ServiceActivity createActivity(AbstractSingleActivityJob.BuilderBase<? extends AbstractSingleActivityJob<?>, ?> builder) {
    return new ServiceActivity(this, builder.type, builder.location, builder.serviceTime, builder.getCapacity(), builder.timeWindows.getTimeWindows());
  }

  @SuppressWarnings(value = { "unchecked" }) @Override public Builder getBuilder(String id) {
