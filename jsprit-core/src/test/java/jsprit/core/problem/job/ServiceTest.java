...
public class ServiceTest {
  ...
  @Test(expected = IllegalStateException.class) public void whenSettingNeitherLocationIdNorCoord_throwsException() {
  ...
  @Test(expected = IllegalStateException.class) public void whenMultipleTWOverlap_throwEx() {
  ...
  @Test(expected = IllegalStateException.class) public void whenMultipleTWOverlap2_throwEx() {
