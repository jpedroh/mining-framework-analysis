...
public class ShipmentTest {
  ...
  @Test(expected = IllegalStateException.class) public void whenPickupLocationIsNull_itThrowsException() {
  ...
  @Test(expected = IllegalStateException.class) public void whenAddingMultipleOverlappingDeliveryTimeWindows_itShouldThrowException() {
  ...
  @Test(expected = IllegalStateException.class) public void whenAddingMultipleOverlappingPickupTimeWindows_itShouldThrowException() {
