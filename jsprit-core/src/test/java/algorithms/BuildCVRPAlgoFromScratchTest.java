...
public class BuildCVRPAlgoFromScratchTest {
  ...
  @Before public void setup() {
    ...
    HardActivityLevelConstraint hardActLevelConstraint = new HardActivityLevelConstraint() {
      @Override public boolean fulfilled(InsertionContext iFacts, TourActivity prevAct, TourActivity newAct, TourActivity nextAct, double prevActDepTime) {
        return true;
      }
    };
...
>>>>>>> /usr/src/app/output/jsprit/jsprit/e21d1ff7c5a66960a6eabd7e225d73d757c5ad0a/jsprit-core/src/test/java/algorithms/BuildCVRPAlgoFromScratchTest.java/right.java
     marginalCalculus = new LocalActivityInsertionCostsCalculator(vrp.getTransportCosts(), vrp.getActivityCosts(), hardActLevelConstraint);
