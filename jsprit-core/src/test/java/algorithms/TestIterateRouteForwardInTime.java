...
public class TestIterateRouteForwardInTime {
  ...
  @Before public void setUp() {
    ...
    vehicle = VehicleImpl.Builder.newInstance("testvehicle").setType(type).setLocationId("0,0").setEarliestStart(0.0).setLatestArrival(50.0).build();
  ...
  @Test public void whenIteratingWithoutUpdate_itShouldUpdateNothing() {
  ...
  @Test public void whenIteratingWithActivityTimeUpdater_itShouldUpdateActivityTimes() {
  ...
  @Test public void whenIteratingWithLoadUpdateAtActLocations_itShouldUpdateLoad() {
    RouteActivityVisitor forwardInTime = new RouteActivityVisitor();
  ...
  @Test public void testStatesOfAct0() {
    RouteActivityVisitor forwardInTime = new RouteActivityVisitor();
    forwardInTime.visit(vehicleRoute);
  ...
  @Test public void testStatesOfAct1() {
    RouteActivityVisitor forwardInTime = new RouteActivityVisitor();
    forwardInTime.addActivityVisitor(new UpdateLoadAtAllLevels(stateManager));
  ...
  @Test public void testStatesOfAct2() {
    RouteActivityVisitor forwardInTime = new RouteActivityVisitor();
    forwardInTime.addActivityVisitor(new UpdateLoadAtAllLevels(stateManager));
    forwardInTime.addActivityVisitor(new UpdateEarliestStartTimeWindowAtActLocations(stateManager, cost));
    forwardInTime.addActivityVisitor(new UpdateCostsAtAllLevels(new DefaultVehicleRoutingActivityCosts(), cost, stateManager));
  ...
  @Test public void testStatesOfAct3() {
    RouteActivityVisitor forwardInTime = new RouteActivityVisitor();
    forwardInTime.addActivityVisitor(new UpdateActivityTimes(cost));
    forwardInTime.addActivityVisitor(new UpdateCostsAtAllLevels(new DefaultVehicleRoutingActivityCosts(), cost, stateManager));
    forwardInTime.visit(vehicleRoute);
