...
public class ServiceLoadRouteLevelConstraintTest {
  ...
  @Test public void whenLoadPlusDeliverySizeDoesNotExceedsVehicleCapacity_itShouldReturnTrue() {
    Service service = Delivery.Builder.newInstance("del").setLocation(l()).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 1).addDimension(1, 1).addDimension(2, 1).build()).build();

<<<<<<< /usr/src/app/output/jsprit/jsprit/bf597eb8ec5d4fe4917d750f18d7339c90890435/jsprit-core/src/test/java/com/graphhopper/jsprit/core/problem/constraint/ServiceLoadRouteLevelConstraintTest.java/left.java
    when(service.getSize()).thenReturn(SizeDimension.Builder.newInstance().addDimension(0, 1).addDimension(1, 1).addDimension(2, 1).build());
=======
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenLoadPlusDeliverySizeExceedsVehicleCapacityInAllDimension_itShouldReturnFalse() {
    Service service = Delivery.Builder.newInstance("d").setLocation(l()).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 3).addDimension(1, 3).addDimension(2, 3).build()).build();

<<<<<<< /usr/src/app/output/jsprit/jsprit/bf597eb8ec5d4fe4917d750f18d7339c90890435/jsprit-core/src/test/java/com/graphhopper/jsprit/core/problem/constraint/ServiceLoadRouteLevelConstraintTest.java/left.java
    when(service.getSize()).thenReturn(SizeDimension.Builder.newInstance().addDimension(0, 3).addDimension(1, 3).addDimension(2, 3).build());
=======
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenLoadPlusDeliverySizeExceedsVehicleCapacityInOneDimension_itShouldReturnFalse() {
    Service service = Delivery.Builder.newInstance("d").setLocation(l()).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 1).addDimension(1, 1).addDimension(2, 3).build()).build();

<<<<<<< /usr/src/app/output/jsprit/jsprit/bf597eb8ec5d4fe4917d750f18d7339c90890435/jsprit-core/src/test/java/com/graphhopper/jsprit/core/problem/constraint/ServiceLoadRouteLevelConstraintTest.java/left.java
    when(service.getSize()).thenReturn(SizeDimension.Builder.newInstance().addDimension(0, 1).addDimension(1, 1).addDimension(2, 3).build());
=======
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenLoadPlusDeliverySizeJustFitIntoVehicle_itShouldReturnTrue() {
    Service service = Delivery.Builder.newInstance("d").setLocation(l()).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 2).addDimension(1, 2).addDimension(2, 2).build()).build();

<<<<<<< /usr/src/app/output/jsprit/jsprit/bf597eb8ec5d4fe4917d750f18d7339c90890435/jsprit-core/src/test/java/com/graphhopper/jsprit/core/problem/constraint/ServiceLoadRouteLevelConstraintTest.java/left.java
    when(service.getSize()).thenReturn(SizeDimension.Builder.newInstance().addDimension(0, 2).addDimension(1, 2).addDimension(2, 2).build());
=======
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenLoadPlusPickupSizeDoesNotExceedsVehicleCapacity_itShouldReturnTrue() {
    Service service = Pickup.Builder.newInstance("p").setLocation(l()).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 1).addDimension(1, 1).addDimension(2, 1).build()).build();
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenLoadPlusPickupSizeExceedsVehicleCapacityInAllDimension_itShouldReturnFalse() {
    Service service = Pickup.Builder.newInstance("p").setLocation(l()).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 3).addDimension(1, 3).addDimension(2, 3).build()).build();
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenLoadPlusPickupSizeExceedsVehicleCapacityInOneDimension_itShouldReturnFalse() {
    Service service = Pickup.Builder.newInstance("p").setLocation(l()).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 1).addDimension(1, 1).addDimension(2, 3).build()).build();
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenLoadPlusPickupSizeJustFitIntoVehicle_itShouldReturnTrue() {
    Service service = Pickup.Builder.newInstance("p").setLocation(l()).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 2).addDimension(1, 2).addDimension(2, 2).build()).build();
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenLoadPlusServiceSizeDoesNotExceedsVehicleCapacity_itShouldReturnTrue() {
    Service service = Service.Builder.newInstance("s").setLocation(l()).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 1).addDimension(1, 1).addDimension(2, 1).build()).build();
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenLoadPlusServiceSizeExceedsVehicleCapacityInAllDimension_itShouldReturnFalse() {
    Service service = Service.Builder.newInstance("s").setLocation(l()).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 3).addDimension(1, 3).addDimension(2, 3).build()).build();
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenLoadPlusServiceSizeExceedsVehicleCapacityInOneDimension_itShouldReturnFalse() {
    Service service = Service.Builder.newInstance("s").setLocation(l()).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 1).addDimension(1, 1).addDimension(2, 3).build()).build();
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenLoadPlusServiceSizeJustFitIntoVehicle_itShouldReturnTrue() {
    Service service = Service.Builder.newInstance("s").setLocation(Location.newInstance(0)).addAllSizeDimensions(Capacity.Builder.newInstance().addDimension(0, 2).addDimension(1, 2).addDimension(2, 2).build()).build();
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test public void whenNewVehicleCapacityIsNotSufficiant1_returnFalse() {
  ...
  @Test public void whenNewVehicleCapacityIsNotSufficiant2_returnFalse() {
