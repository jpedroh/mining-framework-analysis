...
public class SolutionAnalyserTest {
  ...
  @Before public void doBefore() {
    ...
    Service s1 = new Service.Builder("s1").setTimeWindow(TimeWindow.newInstance(10, 20)).setLocation(Location.newInstance(-10, 1)).addSizeDimension(0, 2).addRequiredSkill("skill1").build();
    Service s2 = new Service.Builder("s2").setLocation(Location.newInstance(-10, 10)).addSizeDimension(0, 3).addRequiredSkill("skill2").addRequiredSkill("skill1").build();
    ...
    Service s3 = new Service.Builder("s3").setTimeWindow(TimeWindow.newInstance(10, 20)).setLocation(TestUtils.loc(Coordinate.newInstance(10, 1))).addSizeDimension(0, 2).build();
    ...
    vrpBuilder.setRoutingCost(new DefaultCosts(ManhattanDistanceCalculator.getInstance()).withCoordinateConverter(vrpBuilder.getLocations()));
  ...
  public void buildAnotherScenarioWithOnlyOneVehicleAndWithoutAnyConstraintsBefore() {
    ...
    Pickup s1 = new Pickup.Builder("s1").setTimeWindow(TimeWindow.newInstance(10, 20)).setLocation(Location.newInstance(-10, 1)).addSizeDimension(0, 10).build();
    Delivery s2 = new Delivery.Builder("s2").setLocation(Location.newInstance(-10, 10)).setTimeWindow(TimeWindow.newInstance(10, 20)).addSizeDimension(0, 20).build();
    ...
    Pickup s3 = new Pickup.Builder("s3").setTimeWindow(TimeWindow.newInstance(10, 20)).setLocation(TestUtils.loc(Coordinate.newInstance(10, 1))).addSizeDimension(0, 10).build();
    Delivery s4 = new Delivery.Builder("s4").setLocation(Location.newInstance(10, 10)).addSizeDimension(0, 20).setTimeWindow(TimeWindow.newInstance(10, 20)).build();
