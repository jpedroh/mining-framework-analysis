...
public class ShipmentTest {
  ...
  @Test public void whenAddingMaxTimeInVehicle_itShouldBeSet() {
  ...
  @Test public void whenSettingUserData_itIsAssociatedWithTheJob() {
  ...
  @Test public void whenNotAddingMaxTimeInVehicle_itShouldBeDefault() {
    Shipment s = Shipment.Builder.newInstance("s").setPickupLocation(Location.newInstance("loc")).setDeliveryLocation(Location.newInstance("loc")).build();
