...
public class PickupTest {
  @Test(expected = IllegalArgumentException.class) public void whenNeitherLocationIdNorCoordIsSet_itThrowsException() {
  ...
  @Test public void whenNotSettingPriorities_defaultShouldBe() {
