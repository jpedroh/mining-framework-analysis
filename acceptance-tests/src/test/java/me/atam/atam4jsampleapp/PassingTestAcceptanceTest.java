...
public class PassingTestAcceptanceTest extends AcceptanceTest {
  @Test public void givenPassingTest_whenTestsEndpointCalledBeforeTestRun_thenTooEarlyMessageReceived() {
  ...
  @Test public void givenPassingTest_whenTestsEndpointCalledAfterTestRun_thenOKMessageReceived() {
  ...
  @Test public void givenSampleApplicationStartedWithPassingTest_whenCriticalHealthCheckCalledBeforeTestRun_thenTooEarlyMessageReceived() {
    dropwizardTestSupportAppConfig = Atam4jApplicationStarter.startApplicationWith(TEN_SECONDS_IN_MILLIS, PassingTest.class);
