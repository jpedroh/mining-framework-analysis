...
@Service public class PlanGenerationService {
  ...
  @Inject public PlanGenerationService(CsarStorageService storage, WineryExporter planBuilderExporter, Importer planBuilderImporter) {
