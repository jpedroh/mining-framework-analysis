...
@Service @NonNullByDefault public class OpenToscaControlServiceImpl implements OpenToscaControlService {
  ...
  @Inject public OpenToscaControlServiceImpl(DeploymentTracker deploymentTracker, IPlanEngineService planEngine, IPlanInvocationEngine planInvocationEngine, CsarStorageService storage) {
  ...
  @Override public boolean invokeToscaProcessing(CsarId csar) {
  ...
  @Override public boolean generatePlans(CsarId csarId, ServiceTemplateId serviceTemplate) {
  ...
  @Override public String invokePlanInvocation(CsarId csarId, TServiceTemplate serviceTemplate, long instanceId, TPlanDTO plan) {
  ...
  @Override public Set<DeploymentProcessOperation> executableDeploymentProcessOperations(CsarId csar) {
  ...
  @Override public boolean declareStored(CsarId csar) {
    LOGGER.trace("Forcibly marking csar {} as STORED", csar.csarName());
    deploymentTracker.storeDeploymentState(csar, STORED);
    return true;
  }

  @Override public DeploymentProcessState currentDeploymentProcessState(CsarId csar) {
    return deploymentTracker.getDeploymentState(csar);
  }

  @Override public List<String> deleteCsar(CsarId csarId) {
  ...
  /**
     ...
     */
  @Override public boolean undeployAllPlans(Csar csar) {
  ...
  /**
     ...
     * @return true, if undeploying all plans was successful, false otherwise
     */
  @Override public boolean undeployAllPlans(CsarId csarId, TServiceTemplate serviceTemplate) {
  ...
  @Override public boolean invokePlanDeployment(CsarId csar, TServiceTemplate serviceTemplate, List<TPlan> plans, TPlan plan) {
  ...
  @Override public boolean invokePlanDeployment(CsarId csar, TServiceTemplate serviceTemplate) {
