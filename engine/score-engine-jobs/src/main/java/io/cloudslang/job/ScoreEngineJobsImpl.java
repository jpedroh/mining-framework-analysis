...
public class ScoreEngineJobsImpl implements ScoreEngineJobs {
  @Autowired private QueueCleanerService queueCleanerService;

  @Autowired private SplitJoinService splitJoinService;

  @Autowired private VersionService versionService;

  @Autowired private ExecutionRecoveryService executionRecoveryService;

  @Autowired private SuspendedExecutionCleanerService suspendedExecutionCleanerService;
  ...
  /**
     ...
     */
  @Override public void cleanQueueJob() {
    try {
  ...
  /**
     ...
     */
  @Override public void joinFinishedSplitsJob() {
    try {
      if (logger.isDebugEnabled()) {
        logger.debug("SplitJoinJob woke up at " + new Date());
      }
      ...
      stopWatch.stop();
      if (logger.isDebugEnabled()) {
        logger.debug("finished SplitJoinJob in " + stopWatch);
      }
    } catch (Exception ex) {
  ...
  /**
     ...
     */
  @Override public void recoveryVersionJob() {
  ...
  /**
     ...
     */
  @Override public void executionRecoveryJob() {
    if (logger.isDebugEnabled()) {
  ...
  /**
     ...
     */
  @Override public void cleanSuspendedExecutionsJob() {
    if (logger.isDebugEnabled()) {
  ...
  @Override public void miMergeBranchesContexts() {
    try {
      if (logger.isDebugEnabled()) {
  ...
  @Override public void monitorLargeMessagesJob() {
    if (logger.isDebugEnabled()) {
