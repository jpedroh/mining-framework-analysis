...
public class Utils {
  ...
  public static boolean isSupportedVirtualMachineIPProperty(final String name) {
    return name.equals(Properties.OPENTOSCA_DECLARATIVE_PROPERTYNAME_SERVERIP) || name.equals(Properties.OPENTOSCA_DECLARATIVE_PROPERTYNAME_VMIP) || name.equals(Properties.OPENTOSCA_DECLARATIVE_PROPERTYNAME_CONTAINERIP) || name.equals(Properties.OPENTOSCA_DECLARATIVE_PROPERTYNAME_RASPBIANIP);
  }
  ...
  public static boolean isSupportedCloudProviderNodeType(final QName nodeType) {
    return nodeType.equals(Types.localHypervisor) || nodeType.equals(Types.KVM_QEMU_HYPERVISOR_TYPE) || isCloudProvider(nodeType);
  }

  public static boolean isCloudProvider(QName nodeType) {
    NodeTypeId nodeTypeId = new NodeTypeId(nodeType);
    return nodeType.equals(Types.amazonEc2NodeType) || nodeType.equals(Types.vmWareVsphere55NodeType) || nodeType.equals(Types.openStackLiberty12NodeType) || nodeType.equals(Types.openStackTrainNodeType_legacy) || nodeType.equals(Types.openStackTrainNodeType) || (nodeType.getNamespaceURI().equals(Types.openStackLiberty12NodeTypeGenerated.getNamespaceURI()) && (nodeType.getLocalPart().startsWith(Types.openStackLiberty12NodeTypeGenerated.getLocalPart()) || nodeType.getLocalPart().startsWith(Types.openStackTrainNodeType.getLocalPart()) || nodeType.getLocalPart().startsWith(Types.openStackTrainNodeType_legacy.getLocalPart())) || nodeTypeId.getNameWithoutVersion().equalsIgnoreCase("OpenStack") || nodeTypeId.getNameWithoutVersion().equalsIgnoreCase("AmazonEC2"));
  }
  ...
  public static boolean isSupportedVMNodeType(final QName nodeType) {
    return nodeType.equals(Types.ubuntu1404ServerVmNodeType) || nodeType.equals(Types.ubuntu1404ServerVmNodeType2) || (nodeType.getNamespaceURI().toLowerCase().startsWith(Types.versionedUbuntuServerVmNodeType.getNamespaceURI().toLowerCase()) && VersionUtils.getNameWithoutVersion(nodeType.getLocalPart()).equalsIgnoreCase(Types.versionedUbuntuServerVmNodeType.getLocalPart()));
  }

  public static boolean isSupportedOSNodeType(final QName nodeType) {
    return nodeType.getNamespaceURI().equalsIgnoreCase(Types.raspbianJessieOSNodeType.getNamespaceURI()) && VersionUtils.getNameWithoutVersion(nodeType.getLocalPart()).equalsIgnoreCase(Types.raspbianJessieOSNodeType.getLocalPart());
  }
  ...
  public static boolean isSupportedDockerEngineNodeType(final QName nodeType) {
    return nodeType.getNamespaceURI().equalsIgnoreCase(Types.dockerEngineNodeType.getNamespaceURI()) && VersionUtils.getNameWithoutVersion(nodeType.getLocalPart()).equalsIgnoreCase(Types.dockerEngineNodeType.getLocalPart());
  }

  public static boolean isSupportedContainerNodeType(final QName nodeType) {
    return nodeType.getNamespaceURI().equalsIgnoreCase(Types.dockerContainerNodeType.getNamespaceURI()) && VersionUtils.getNameWithoutVersion(nodeType.getLocalPart()).equalsIgnoreCase(Types.dockerContainerNodeType.getLocalPart());
  }

  public static boolean isSupportedPlanQKPlatformNodeType(final QName nodeType) {
    return nodeType.getNamespaceURI().equalsIgnoreCase(Types.planQKPlatformNodeType.getNamespaceURI()) && VersionUtils.getNameWithoutVersion(nodeType.getLocalPart()).equalsIgnoreCase(Types.planQKPlatformNodeType.getLocalPart());
  }
