...
<<<<<<< /usr/src/app/output/apache/avro/af0f29cb6366e1997da5b76477ca8ee70441f26f/lang/java/avro/src/main/java/org/apache/avro/reflect/ReflectData.java/left.java
  /** Lookup to store user specified schemas for classes */
  private static final Map<Class<?>, Schema> CLASS_SCHEMAS = new HashMap<Class<?>, Schema>();
=======
  static final String NS_MAP_KEY = "key";
>>>>>>> /usr/src/app/output/apache/avro/af0f29cb6366e1997da5b76477ca8ee70441f26f/lang/java/avro/src/main/java/org/apache/avro/reflect/ReflectData.java/right.java
  ...
  public static class AllowNull extends ReflectData {
    ...
    @Override protected Schema createFieldSchema(Field field, Map<String, Schema> names) {
...
<<<<<<< /usr/src/app/output/apache/avro/af0f29cb6366e1997da5b76477ca8ee70441f26f/lang/java/avro/src/main/java/org/apache/avro/reflect/ReflectData.java/left.java
  ...
  private static final Map<Field, Schema> FIELD_SCHEMAS = new HashMap<Field, Schema>();
=======
...
>>>>>>> /usr/src/app/output/apache/avro/af0f29cb6366e1997da5b76477ca8ee70441f26f/lang/java/avro/src/main/java/org/apache/avro/reflect/ReflectData.java/right.java
  ...
  @Override public void setField(Object record, String name, int position, Object o) {
    setField(record, name, position, o, null);
  }

  @Override protected void setField(Object record, String name, int pos, Object o, Object state) {
  ...
  @Override public Object getField(Object record, String name, int position) {
    return getField(record, name, position, null);
  }

  @Override protected Object getField(Object record, String name, int pos, Object state) {
    if (record instanceof IndexedRecord) {
  ...
  @Override protected boolean isArray(Object datum) {
    if (datum == null) {
      return false;
    }
    return (datum instanceof Collection) || datum.getClass().isArray() || isNonStringMap(datum);
  }

  @Override protected Collection getArrayAsCollection(Object datum) {
    return (datum instanceof Map) ? ((Map) datum).entrySet() : (Collection) datum;
  }

  @Override protected boolean isBytes(Object datum) {
    if (datum == null) {
      return false;
    }
  ...
  @Override protected Schema getRecordSchema(Object record) {
  ...
  @Override public boolean validate(Schema schema, Object datum) {
  ...
  static final ConcurrentHashMap<Class<?>, ClassAccessorData> ACCESSOR_CACHE = new ConcurrentHashMap<Class<?>, ClassAccessorData>();
  ...
  private static class ClassAccessorData {
    ...
    private final IdentityHashMap<Schema, FieldAccessor[]> bySchema = new IdentityHashMap<Schema, FieldAccessor[]>();
  ...
  @Override public Class getClass(Schema schema) {
    switch (schema.getType()) {
      case ARRAY:
  ...
  private String getNameForNonStringMapRecord(Type keyType, Type valueType, Schema keySchema, Schema valueSchema) {
    ...
    try {
      ...
      String msg = "Unable to create fingerprint for (" + keyType + ", " + valueType + ") pair";
  ...
  @Override protected Schema createSchema(Type type, Map<String, Schema> names) {
          ...
          if ((type == Short.class) || (type == Short.TYPE)) {
            ...
            if ((type == Character.class) || (type == Character.TYPE)) {
              ...
              if (type instanceof Class) {
                ...
                if (CLASS_SCHEMAS.containsKey(c)) {
  ...
  private static final Map<Class<?>, Field[]> FIELDS_CACHE = new ConcurrentHashMap<Class<?>, Field[]>();
  ...
  protected Schema createFieldSchema(Field field, Map<String, Schema> names) {
    ...
    if (FIELD_SCHEMAS.containsKey(field)) {
  ...
  @Override public Protocol getProtocol(Class iface) {
  ...
  @Override protected int compare(Object o1, Object o2, Schema s, boolean equals) {
    switch (s.getType()) {
      case ARRAY:
      ...
      for (int i = 0; i < l; i++) {
        int compare = compare(java.lang.reflect.Array.get(o1, i), java.lang.reflect.Array.get(o2, i), elementType, equals);
        if (compare != 0) {
          return compare;
        }
      }
  ...
  @Override protected Object getRecordState(Object record, Schema schema) {
