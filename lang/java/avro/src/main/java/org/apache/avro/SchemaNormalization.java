...
public class SchemaNormalization {
  ...
  public static String toCanonicalForm(Schema s, LinkedHashSet<String> properties) {
    LinkedHashSet<String> reservedProperties = new LinkedHashSet<>(Arrays.asList("name", "type", "fields", "symbols", "items", "values", "logicalType", "size", "order", "doc", "aliases", "default"));
