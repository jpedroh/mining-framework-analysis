...
public class TestSchemas {
  ...
  static final Schema INT_LONG_FLOAT_DOUBLE_UNION_SCHEMA = Schema.createUnion(list(INT_SCHEMA, LONG_SCHEMA, FLOAT_SCHEMA, DOUBLE_SCHEMA));
  ...
  static final Schema 
<<<<<<< /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/left.java
  BYTES_DECIMAL_3_3 = LogicalTypes.decimal(3, 3).addToSchema(Schema.create(Schema.Type.BYTES))
=======
  A_DINT_B_DFIXED_4_BYTES_RECORD1 = Schema.createRecord("Record1", null, null, false)
>>>>>>> /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/right.java
  ;
  ...
  static final Schema 
<<<<<<< /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/left.java
  BYTES_DECIMAL_3_2 = LogicalTypes.decimal(3, 2).addToSchema(Schema.create(Schema.Type.BYTES))
=======
  A_DINT_B_DFIXED_8_BYTES_RECORD1 = Schema.createRecord("Record1", null, null, false)
>>>>>>> /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/right.java
  ;

  static final Schema 
<<<<<<< /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/left.java
  BYTES_DECIMAL_4_3 = LogicalTypes.decimal(4, 3).addToSchema(Schema.create(Schema.Type.BYTES))
=======
  A_DINT_B_DINT_STRING_UNION_RECORD1 = Schema.createRecord("Record1", null, null, false)
>>>>>>> /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/right.java
  ;

  static final Schema 
<<<<<<< /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/left.java
  FIXED_DECIMAL_3_3 = LogicalTypes.decimal(3, 3).addToSchema(Schema.createFixed("Fixed", null, null, 8))
=======
  A_DINT_B_DINT_UNION_RECORD1 = Schema.createRecord("Record1", null, null, false)
>>>>>>> /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/right.java
  ;

  static final Schema 
<<<<<<< /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/left.java
  FIXED_DECIMAL_3_2 = LogicalTypes.decimal(3, 2).addToSchema(Schema.createFixed("Fixed", null, null, 8))
=======
  A_DINT_B_DENUM_1_RECORD1 = Schema.createRecord("Record1", null, null, false)
>>>>>>> /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/right.java
  ;

  static final Schema 
<<<<<<< /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/left.java
  FIXED_DECIMAL_4_3 = LogicalTypes.decimal(4, 3).addToSchema(Schema.createFixed("Fixed", null, null, 8))
=======
  A_DINT_B_DENUM_2_RECORD1 = Schema.createRecord("Record1", null, null, false)
>>>>>>> /usr/src/app/output/apache/avro/0ccc51fc382fa82adecc092562b89b9d0bfb5cdd/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/right.java
  ;
  ...
  static {
    ...
    A_DINT_B_DFIXED_4_BYTES_RECORD1.setFields(list(new Field("a", INT_SCHEMA, null, 0), new Field("b", FIXED_4_BYTES, null, 0)));
    A_DINT_B_DFIXED_8_BYTES_RECORD1.setFields(list(new Field("a", INT_SCHEMA, null, 0), new Field("b", FIXED_8_BYTES, null, 0)));
    A_DINT_B_DINT_STRING_UNION_RECORD1.setFields(list(new Field("a", INT_SCHEMA, null, 0), new Field("b", INT_STRING_UNION_SCHEMA, null, 0)));
    A_DINT_B_DINT_UNION_RECORD1.setFields(list(new Field("a", INT_SCHEMA, null, 0), new Field("b", INT_UNION_SCHEMA, null, 0)));
    A_DINT_B_DENUM_1_RECORD1.setFields(list(new Field("a", INT_SCHEMA, null, 0), new Field("b", ENUM1_AB_SCHEMA, null, 0)));
    A_DINT_B_DENUM_2_RECORD1.setFields(list(new Field("a", INT_SCHEMA, null, 0), new Field("b", ENUM2_AB_SCHEMA, null, 0)));
  }
  ...
  static {
    INT_LIST_RECORD.setFields(list(new Field("head", INT_SCHEMA, null, null), new Field("tail", INT_LIST_RECORD, null, null)));
    LONG_LIST_RECORD.setFields(list(new Field("head", LONG_SCHEMA, null, null), new Field("tail", LONG_LIST_RECORD, null, null)));
  }
  ...
  static <E extends java.lang.Object> ArrayList<E> list(E... elements) {
