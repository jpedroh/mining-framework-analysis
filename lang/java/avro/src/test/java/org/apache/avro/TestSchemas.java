...
public class TestSchemas {
  ...
  static {
    ENUM_ABC_ENUM_DEFAULT_A_RECORD.setFields(list(new Schema.Field("Field", Schema.createEnum("Schema", null, null, list("A", "B", "C"), "A"), null, null)));
    ENUM_AB_ENUM_DEFAULT_A_RECORD.setFields(list(new Schema.Field("Field", Schema.createEnum("Schema", null, null, list("A", "B"), "A"), null, null)));
    ENUM_ABC_FIELD_DEFAULT_B_ENUM_DEFAULT_A_RECORD.setFields(list(new Schema.Field("Field", Schema.createEnum("Schema", null, null, list("A", "B", "C"), "A"), null, "B")));
    ENUM_AB_FIELD_DEFAULT_A_ENUM_DEFAULT_B_RECORD.setFields(list(new Schema.Field("Field", Schema.createEnum("Schema", null, null, list("A", "B"), "B"), null, "A")));
  }
  ...
  static final Schema 
<<<<<<< /usr/src/app/output/apache/avro/ee88deaf22b35b2ba90b5d6231816c182b4d886e/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/left.java
  NULL_INT_ARRAY_UNION_SCHEMA = Schema.createUnion(list(NULL_SCHEMA, INT_ARRAY_SCHEMA))
=======
  NS_INNER_RECORD2 = Schema.createRecord("InnerRecord1", null, "ns2", false)
>>>>>>> /usr/src/app/output/apache/avro/ee88deaf22b35b2ba90b5d6231816c182b4d886e/lang/java/avro/src/test/java/org/apache/avro/TestSchemas.java/right.java
  ;
  ...
  static {
    ...
    A_DINT_B_DFIXED_4_BYTES_RECORD1.setFields(list(new Field("a", INT_SCHEMA, null, 0), new Field("b", FIXED_4_BYTES, null, null)));
    A_DINT_B_DFIXED_8_BYTES_RECORD1.setFields(list(new Field("a", INT_SCHEMA, null, 0), new Field("b", FIXED_8_BYTES, null, null)));
    ...
    A_DINT_B_DENUM_1_RECORD1.setFields(list(new Field("a", INT_SCHEMA, null, 0), new Field("b", ENUM1_AB_SCHEMA, null, null)));
    A_DINT_B_DENUM_2_RECORD1.setFields(list(new Field("a", INT_SCHEMA, null, 0), new Field("b", ENUM2_AB_SCHEMA, null, null)));
    ...
    NS_RECORD1.setFields(list(new Schema.Field("f1", Schema.createUnion(NULL_SCHEMA, Schema.createArray(NS_INNER_RECORD1)))));
    NS_RECORD2.setFields(list(new Schema.Field("f1", Schema.createUnion(NULL_SCHEMA, Schema.createArray(NS_INNER_RECORD2)))));
  }
