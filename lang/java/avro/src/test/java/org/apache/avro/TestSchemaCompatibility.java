...
public class TestSchemaCompatibility {
  ...
  private static final Schema WRITER_SCHEMA = Schema.createRecord(list(new Schema.Field("oldfield1", INT_SCHEMA, null, null), new Schema.Field("oldfield2", STRING_SCHEMA, null, null)));
  ...
  @Test public void testValidateSchemaPairMissingField() throws Exception {
    ...
    final SchemaCompatibility.SchemaPairCompatibility expectedResult = new SchemaCompatibility.SchemaPairCompatibility(SchemaCompatibility.SchemaCompatibilityResult.compatible(), reader, WRITER_SCHEMA, SchemaCompatibility.READER_WRITER_COMPATIBLE_MESSAGE);
  ...
  @Test public void testValidateArrayWriterSchema() throws Exception {
    ...
    final SchemaCompatibility.SchemaPairCompatibility validResult = new SchemaCompatibility.SchemaPairCompatibility(SchemaCompatibility.SchemaCompatibilityResult.compatible(), validReader, STRING_ARRAY_SCHEMA, SchemaCompatibility.READER_WRITER_COMPATIBLE_MESSAGE);
    final SchemaCompatibility.SchemaPairCompatibility invalidResult = new SchemaCompatibility.SchemaPairCompatibility(SchemaCompatibility.SchemaCompatibilityResult.incompatible(SchemaIncompatibilityType.TYPE_MISMATCH, invalidReader, STRING_ARRAY_SCHEMA, "reader type: MAP not compatible with writer type: ARRAY", Arrays.asList("")), invalidReader, STRING_ARRAY_SCHEMA, String.format("Data encoded using writer schema:%n%s%n" + "will or may fail to decode using reader schema:%n%s%n", STRING_ARRAY_SCHEMA.toString(true), invalidReader.toString(true)));
  ...
  @Test public void testValidatePrimitiveWriterSchema() throws Exception {
    ...
    final SchemaCompatibility.SchemaPairCompatibility validResult = new SchemaCompatibility.SchemaPairCompatibility(SchemaCompatibility.SchemaCompatibilityResult.compatible(), validReader, STRING_SCHEMA, SchemaCompatibility.READER_WRITER_COMPATIBLE_MESSAGE);
    final SchemaCompatibility.SchemaPairCompatibility invalidResult = new SchemaCompatibility.SchemaPairCompatibility(SchemaCompatibility.SchemaCompatibilityResult.incompatible(SchemaIncompatibilityType.TYPE_MISMATCH, INT_SCHEMA, STRING_SCHEMA, "reader type: INT not compatible with writer type: STRING", Arrays.asList("")), INT_SCHEMA, STRING_SCHEMA, String.format("Data encoded using writer schema:%n%s%n" + "will or may fail to decode using reader schema:%n%s%n", STRING_SCHEMA.toString(true), INT_SCHEMA.toString(true)));
  ...
  public static final List<ReaderWriter> COMPATIBLE_READER_WRITER_TEST_CASES = list(new ReaderWriter(BOOLEAN_SCHEMA, BOOLEAN_SCHEMA), new ReaderWriter(INT_SCHEMA, INT_SCHEMA), new ReaderWriter(LONG_SCHEMA, INT_SCHEMA), new ReaderWriter(LONG_SCHEMA, LONG_SCHEMA), new ReaderWriter(FLOAT_SCHEMA, INT_SCHEMA), new ReaderWriter(FLOAT_SCHEMA, LONG_SCHEMA), new ReaderWriter(DOUBLE_SCHEMA, LONG_SCHEMA), new ReaderWriter(DOUBLE_SCHEMA, INT_SCHEMA), new ReaderWriter(DOUBLE_SCHEMA, FLOAT_SCHEMA), new ReaderWriter(STRING_SCHEMA, STRING_SCHEMA), new ReaderWriter(BYTES_SCHEMA, BYTES_SCHEMA), new ReaderWriter(INT_ARRAY_SCHEMA, INT_ARRAY_SCHEMA), new ReaderWriter(LONG_ARRAY_SCHEMA, INT_ARRAY_SCHEMA), new ReaderWriter(INT_MAP_SCHEMA, INT_MAP_SCHEMA), new ReaderWriter(LONG_MAP_SCHEMA, INT_MAP_SCHEMA), new ReaderWriter(ENUM1_AB_SCHEMA, ENUM1_AB_SCHEMA), new ReaderWriter(ENUM1_ABC_SCHEMA, ENUM1_AB_SCHEMA), new ReaderWriter(STRING_SCHEMA, BYTES_SCHEMA), new ReaderWriter(BYTES_SCHEMA, STRING_SCHEMA), new ReaderWriter(EMPTY_UNION_SCHEMA, EMPTY_UNION_SCHEMA), new ReaderWriter(FLOAT_UNION_SCHEMA, EMPTY_UNION_SCHEMA), new ReaderWriter(INT_UNION_SCHEMA, INT_UNION_SCHEMA), new ReaderWriter(INT_STRING_UNION_SCHEMA, STRING_INT_UNION_SCHEMA), new ReaderWriter(INT_UNION_SCHEMA, EMPTY_UNION_SCHEMA), new ReaderWriter(LONG_UNION_SCHEMA, EMPTY_UNION_SCHEMA), new ReaderWriter(FLOAT_UNION_SCHEMA, INT_UNION_SCHEMA), new ReaderWriter(DOUBLE_UNION_SCHEMA, INT_UNION_SCHEMA), new ReaderWriter(LONG_UNION_SCHEMA, EMPTY_UNION_SCHEMA), new ReaderWriter(FLOAT_UNION_SCHEMA, LONG_UNION_SCHEMA), new ReaderWriter(DOUBLE_UNION_SCHEMA, LONG_UNION_SCHEMA), new ReaderWriter(DOUBLE_UNION_SCHEMA, FLOAT_UNION_SCHEMA, EMPTY_UNION_SCHEMA), new ReaderWriter(DOUBLE_UNION_SCHEMA, 
<<<<<<< /usr/src/app/output/apache/avro/9e0edfa879cfd02ebb0f5864d48b2a66b05418ae/lang/java/avro/src/test/java/org/apache/avro/TestSchemaCompatibility.java/left.java
  INT_FLOAT_UNION_SCHEMA
=======
  FLOAT_UNION_SCHEMA
>>>>>>> /usr/src/app/output/apache/avro/9e0edfa879cfd02ebb0f5864d48b2a66b05418ae/lang/java/avro/src/test/java/org/apache/avro/TestSchemaCompatibility.java/right.java
  ), new ReaderWriter(STRING_UNION_SCHEMA, EMPTY_UNION_SCHEMA), new ReaderWriter(STRING_UNION_SCHEMA, BYTES_UNION_SCHEMA), new ReaderWriter(BYTES_UNION_SCHEMA, EMPTY_UNION_SCHEMA), new ReaderWriter(BYTES_UNION_SCHEMA, STRING_UNION_SCHEMA), new ReaderWriter(DOUBLE_UNION_SCHEMA, INT_FLOAT_UNION_SCHEMA), new ReaderWriter(FLOAT_SCHEMA, INT_FLOAT_UNION_SCHEMA), new ReaderWriter(LONG_SCHEMA, INT_LONG_UNION_SCHEMA), new ReaderWriter(DOUBLE_SCHEMA, INT_FLOAT_UNION_SCHEMA), new ReaderWriter(DOUBLE_SCHEMA, INT_LONG_FLOAT_DOUBLE_UNION_SCHEMA), new ReaderWriter(FLOAT_SCHEMA, FLOAT_UNION_SCHEMA), new ReaderWriter(INT_UNION_SCHEMA, INT_SCHEMA), new ReaderWriter(INT_SCHEMA, INT_UNION_SCHEMA), new ReaderWriter(FIXED_4_BYTES, FIXED_4_BYTES), new ReaderWriter(EMPTY_RECORD1, EMPTY_RECORD1), new ReaderWriter(EMPTY_RECORD1, A_INT_RECORD1), new ReaderWriter(A_INT_RECORD1, A_INT_RECORD1), new ReaderWriter(A_DINT_RECORD1, A_INT_RECORD1), new ReaderWriter(A_DINT_RECORD1, A_DINT_RECORD1), new ReaderWriter(A_INT_RECORD1, A_DINT_RECORD1), new ReaderWriter(A_LONG_RECORD1, A_INT_RECORD1), new ReaderWriter(A_INT_RECORD1, A_INT_B_INT_RECORD1), new ReaderWriter(A_DINT_RECORD1, A_INT_B_INT_RECORD1), new ReaderWriter(A_INT_B_DINT_RECORD1, A_INT_RECORD1), new ReaderWriter(A_DINT_B_DINT_RECORD1, EMPTY_RECORD1), new ReaderWriter(A_DINT_B_DINT_RECORD1, A_INT_RECORD1), new ReaderWriter(A_INT_B_INT_RECORD1, A_DINT_B_DINT_RECORD1), new ReaderWriter(INT_LIST_RECORD, INT_LIST_RECORD), new ReaderWriter(LONG_LIST_RECORD, LONG_LIST_RECORD), new ReaderWriter(LONG_LIST_RECORD, INT_LIST_RECORD), new ReaderWriter(NULL_SCHEMA, NULL_SCHEMA));
  ...
  public static void validateIncompatibleSchemas(Schema reader, Schema writer, SchemaIncompatibilityType incompatibility, String message, String location) {
    validateIncompatibleSchemas(reader, writer, Arrays.asList(incompatibility), Arrays.asList(message), Arrays.asList(location));
  }
...
<<<<<<< /usr/src/app/output/apache/avro/9e0edfa879cfd02ebb0f5864d48b2a66b05418ae/lang/java/avro/src/test/java/org/apache/avro/TestSchemaCompatibility.java/left.java
    compatibilityResult = compatibility.getResult()
=======
    compatibilityDetails = compatibility.getResult()
>>>>>>> /usr/src/app/output/apache/avro/9e0edfa879cfd02ebb0f5864d48b2a66b05418ae/lang/java/avro/src/test/java/org/apache/avro/TestSchemaCompatibility.java/right.java
    ;
    ...
    assertEquals(
<<<<<<< /usr/src/app/output/apache/avro/9e0edfa879cfd02ebb0f5864d48b2a66b05418ae/lang/java/avro/src/test/java/org/apache/avro/TestSchemaCompatibility.java/left.java
    incompatibilityTypes.size()
=======
    details
>>>>>>> /usr/src/app/output/apache/avro/9e0edfa879cfd02ebb0f5864d48b2a66b05418ae/lang/java/avro/src/test/java/org/apache/avro/TestSchemaCompatibility.java/right.java
    , 
<<<<<<< /usr/src/app/output/apache/avro/9e0edfa879cfd02ebb0f5864d48b2a66b05418ae/lang/java/avro/src/test/java/org/apache/avro/TestSchemaCompatibility.java/left.java
    compatibilityResult.getIncompatibilities().size()
=======
    compatibilityDetails.getMessage()
>>>>>>> /usr/src/app/output/apache/avro/9e0edfa879cfd02ebb0f5864d48b2a66b05418ae/lang/java/avro/src/test/java/org/apache/avro/TestSchemaCompatibility.java/right.java
    );
  ...
  @Ignore(value = "should float unions be compatible with other number unions, or not?") @Test public void testFloatUnionReaderAndIntLongUnionWriterIncompatibility() {
    SchemaPairCompatibility result = checkReaderWriterCompatibility(FLOAT_UNION_SCHEMA, INT_UNION_SCHEMA);
    assertEquals(String.format("Expecting reader %s to be incompatible with writer %s, but tested compatible.", FLOAT_UNION_SCHEMA, INT_UNION_SCHEMA), SchemaCompatibilityType.INCOMPATIBLE, result.getType());
    result = checkReaderWriterCompatibility(FLOAT_UNION_SCHEMA, LONG_UNION_SCHEMA);
    assertEquals(String.format("Expecting reader %s to be incompatible with writer %s, but tested compatible.", FLOAT_UNION_SCHEMA, LONG_UNION_SCHEMA), SchemaCompatibilityType.INCOMPATIBLE, result.getType());
    result = checkReaderWriterCompatibility(FLOAT_UNION_SCHEMA, INT_LONG_UNION_SCHEMA);
    assertEquals(String.format("Expecting reader %s to be incompatible with writer %s, but tested compatible.", FLOAT_UNION_SCHEMA, INT_LONG_UNION_SCHEMA), SchemaCompatibilityType.INCOMPATIBLE, result.getType());
  }
  ...
  public static final List<DecodingTestCase> DECODING_COMPATIBILITY_TEST_CASES = list(new DecodingTestCase(INT_SCHEMA, 1, INT_SCHEMA, 1), new DecodingTestCase(INT_SCHEMA, 1, LONG_SCHEMA, 1L), new DecodingTestCase(INT_SCHEMA, 1, FLOAT_SCHEMA, 1.0f), new DecodingTestCase(INT_SCHEMA, 1, DOUBLE_SCHEMA, 1.0d), new DecodingTestCase(INT_SCHEMA, (1 << 24) + 1, FLOAT_SCHEMA, (float) ((1 << 24) + 1)), new DecodingTestCase(ENUM1_AB_SCHEMA, new EnumSymbol(ENUM1_AB_SCHEMA, "A"), ENUM1_ABC_SCHEMA, new EnumSymbol(ENUM1_ABC_SCHEMA, "A")), new DecodingTestCase(ENUM1_ABC_SCHEMA, new EnumSymbol(ENUM1_ABC_SCHEMA, "A"), ENUM1_AB_SCHEMA, new EnumSymbol(ENUM1_AB_SCHEMA, "A")), new DecodingTestCase(ENUM1_ABC_SCHEMA, new EnumSymbol(ENUM1_ABC_SCHEMA, "B"), ENUM1_BC_SCHEMA, new EnumSymbol(ENUM1_BC_SCHEMA, "B")), new DecodingTestCase(INT_STRING_UNION_SCHEMA, "the string", STRING_SCHEMA, new Utf8("the string")), new DecodingTestCase(INT_STRING_UNION_SCHEMA, "the string", STRING_UNION_SCHEMA, new Utf8("the string")));
