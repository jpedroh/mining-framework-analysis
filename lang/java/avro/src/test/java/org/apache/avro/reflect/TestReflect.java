...
public class TestReflect {
  ...
  @Union(value = { R7.class, R8.class }) public static class R6 {
  }
  ...
  public static interface P0 {
    @Union(value = { Void.class, String.class }) String foo(@Union(value = { Void.class, String.class }) String s);
  }
  ...
  public static class R12 {
    @AvroSchema(value = "\"int\"") Object x;

    @AvroSchema(value = "{\"type\":\"array\",\"items\":[\"null\",\"string\"]}") List<String> strings;
  }
  ...
  @Test public void testR12() throws Exception {
    ...
    assertEquals(Schema.parse("{\"type\":\"array\",\"items\":[\"null\",\"string\"]}"), s.getField("strings").schema());
  }

  @AvroSchema(value = "\"null\"") public class R13 {
  }
  ...
  public interface P4 {
    @AvroSchema(value = "\"int\"") Object foo(@AvroSchema(value = "\"int\"") Object x);
  }
  ...
  @SuppressWarnings(value = { "serial" }) public static class E1 extends Exception {
  }
  ...
  @Test(expected = Exception.class) public void testAnnotationAvroNameCollide() throws Exception {
  ...
  public static class AvroEncRecord {
    @AvroEncode(using = DateAsLongEncoding.class) java.util.Date date;
  ...
  public static class multipleAnnotationRecord {
    ...
    @AvroIgnore @AvroName(value = "j") Integer i3;

    @AvroIgnore @AvroEncode(using = DateAsLongEncoding.class) java.util.Date i4;

    @Stringable @Nullable Integer i5;

    @Stringable @AvroName(value = "j6") Integer i6 = 6;

    @Stringable @AvroEncode(using = DateAsLongEncoding.class) java.util.Date i7 = new java.util.Date(7L);

    @Nullable @AvroName(value = "j8") Integer i8;

    @Nullable @AvroEncode(using = DateAsLongEncoding.class) java.util.Date i9;

    @AvroName(value = "j10") @AvroEncode(using = DateAsLongEncoding.class) java.util.Date i10 = new java.util.Date(10L);

    @Stringable @Nullable @AvroName(value = "j11") @AvroEncode(using = DateAsLongEncoding.class) java.util.Date i11;
  }
  ...
  @Test public void testAvroEncodeInducing() throws IOException {
  ...
  @Test public void testForwardReference() {
  ...
  @Test(expected = AvroTypeException.class) public void testOverloadedMethod() {
    ReflectData.get().getProtocol(P3.class);
  }

  @Test public void testNoPackageSchema() throws Exception {
    ReflectData.get().getSchema(Class.forName("NoPackage"));
  }

  @Test public void testNoPackageProtocol() throws Exception {
  ...
  @Test public void testReflectWithinGeneric() throws Exception {
    ReflectData data = ReflectData.get();
  ...
  @Test public void testPrimitiveArray() throws Exception {
    testPrimitiveArrays(false);
  }

  @Test public void testPrimitiveArrayBlocking() throws Exception {
  ...
  @Test public void testNullArray() throws Exception {
  ...
  @SuppressWarnings(value = { "unchecked", "rawtypes" }) public void checkStringable(Class c, String value) throws Exception {
    ReflectData data = new ReflectData();
  ...
  @AvroAlias(alias = "a", space = "b") private static class AliasA {
  }

  @AvroAlias(alias = "a", space = "") private static class AliasB {
  }

  @AvroAlias(alias = "a") private static class AliasC {
  }

  @Test public void testAvroAliasOnClass() {
  ...
  private static class ClassWithAliasOnField {
    @AvroAlias(alias = "aliasName") int primitiveField;
  }

  private static class ClassWithAliasAndNamespaceOnField {
    @AvroAlias(alias = "aliasName", space = "forbidden.space.entry") int primitiveField;
  }

  @Test public void testAvroAliasOnField() {
    Schema expectedSchema = SchemaBuilder.record(ClassWithAliasOnField.class.getSimpleName()).namespace("org.apache.avro.reflect.TestReflect$").fields().name("primitiveField").aliases("aliasName").type(Schema.create(org.apache.avro.Schema.Type.INT)).noDefault().endRecord();
    check(ClassWithAliasOnField.class, expectedSchema.toString());
  }

  @Test(expected = AvroRuntimeException.class) public void namespaceDefinitionOnFieldAliasMustThrowException() {
    ReflectData.get().getSchema(ClassWithAliasAndNamespaceOnField.class);
  }

  private static class DefaultTest {
    @AvroDefault(value = "1") int foo;
  }

  @Test public void testAvroDefault() {
  ...
  @Test public void testNullableByteArrayNotNullValue() throws Exception {
    checkReadWrite(new NullableBytesTest("foo".getBytes()));
  }

  @Test public void testNullableByteArrayNullValue() throws Exception {
