...
public class TestSchemaValidation {
  ...
  Schema rec5 = SchemaBuilder.record("test.Rec").fields().name("a").type().stringType().stringDefault("").name("b").type().longType().noDefault().name("c").type().intType().intDefault(0).endRecord();

  @Test public void testAllTypes() throws SchemaValidationException {
  ...
  @Test public void testReadOnePrior() throws SchemaValidationException {
  ...
  @Test public void testReadAllPrior() throws SchemaValidationException {
  ...
  @Test public void testOnePriorCanRead() throws SchemaValidationException {
  ...
  @Test public void testAllPriorCanRead() throws SchemaValidationException {
  ...
  @Test public void testOnePriorCompatible() throws SchemaValidationException {
  ...
  @Test public void testAllPriorCompatible() throws SchemaValidationException {
  ...
  @Test(expected = AvroRuntimeException.class) public void testInvalidBuild() {
  ...
  @Test public void testReflectMatchStructure() throws SchemaValidationException {
  ...
  @Test public void testReflectWithAllowNullMatchStructure() throws SchemaValidationException {
  ...
  @Test public void testUnionWithIncompatibleElements() throws SchemaValidationException {
  ...
  @Test public void testUnionWithCompatibleElements() throws SchemaValidationException {
    Schema union1 = Schema.createUnion(Collections.singletonList(rec));
  ...
  @Test public void testSchemaCompatibilitySuccesses() throws SchemaValidationException {
  ...
  @Test public void testSchemaCompatibilityFailures() throws SchemaValidationException {
   ...
   */
  @Test public void testRecursiveSchemaValidation() throws SchemaValidationException {
