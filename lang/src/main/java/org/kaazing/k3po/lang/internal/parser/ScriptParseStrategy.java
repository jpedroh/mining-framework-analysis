...
public abstract class ScriptParseStrategy<T extends AstRegion> {
  public static final ScriptParseStrategy<AstScriptNode> SCRIPT = new ScriptParseStrategy<AstScriptNode>() {
    @Override public AstScriptNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstPropertyNode> PROPERTY_NODE = new ScriptParseStrategy<AstPropertyNode>() {
    @Override public AstPropertyNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstStreamNode> STREAM = new ScriptParseStrategy<AstStreamNode>() {
    @Override public AstStreamNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstStreamableNode> STREAMABLE = new ScriptParseStrategy<AstStreamableNode>() {
    @Override public AstStreamableNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstEventNode> EVENT = new ScriptParseStrategy<AstEventNode>() {
    @Override public AstEventNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstCommandNode> COMMAND = new ScriptParseStrategy<AstCommandNode>() {
    @Override public AstCommandNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstBarrierNode> BARRIER = new ScriptParseStrategy<AstBarrierNode>() {
    @Override public AstBarrierNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstAcceptNode> ACCEPT = new ScriptParseStrategy<AstAcceptNode>() {
    @Override public AstAcceptNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstAcceptableNode> ACCEPTABLE = new ScriptParseStrategy<AstAcceptableNode>() {
    @Override public AstAcceptableNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstConnectNode> CONNECT = new ScriptParseStrategy<AstConnectNode>() {
    @Override public AstConnectNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstCloseNode> CLOSE = new ScriptParseStrategy<AstCloseNode>() {
    @Override public AstCloseNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstDisconnectNode> DISCONNECT = new ScriptParseStrategy<AstDisconnectNode>() {
    @Override public AstDisconnectNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
      return new AstDisconnectNodeVisitor(elFactory, elContext).visit(parser.disconnectNode());
    }
  };

  public static final ScriptParseStrategy<AstReadOptionNode, AstAbortNode> 
<<<<<<< /usr/src/app/output/kaazing/robot/0a20ba6d4542a2224374351137a13f58957bcd54/lang/src/main/java/org/kaazing/k3po/lang/internal/parser/ScriptParseStrategy.java/left.java
  READ_CHUNK_EXTENSION_OPTION = new ScriptParseStrategy<AstReadOptionNode>() {
    @Override public AstReadOptionNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
      return (AstReadOptionNode) new AstOptionNodeVisitor(elFactory, elContext).visit(parser.readOptionHttpChunkExtensionNode());
    }
  }
=======
  ABORT = new ScriptParseStrategy<AstAbortNode>() {
    @Override public AstAbortNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
...
>>>>>>> /usr/src/app/output/kaazing/robot/0a20ba6d4542a2224374351137a13f58957bcd54/lang/src/main/java/org/kaazing/k3po/lang/internal/parser/ScriptParseStrategy.java/right.java
  ;

  public static final ScriptParseStrategy<AstUnbindNode> UNBIND = new ScriptParseStrategy<AstUnbindNode>() {
    @Override public AstUnbindNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstWriteValueNode> WRITE = new ScriptParseStrategy<AstWriteValueNode>() {
    @Override public AstWriteValueNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstChildOpenedNode> CHILD_OPENED = new ScriptParseStrategy<AstChildOpenedNode>() {
    @Override public AstChildOpenedNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstChildClosedNode> CHILD_CLOSED = new ScriptParseStrategy<AstChildClosedNode>() {
    @Override public AstChildClosedNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstBoundNode> BOUND = new ScriptParseStrategy<AstBoundNode>() {
    @Override public AstBoundNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstClosedNode> CLOSED = new ScriptParseStrategy<AstClosedNode>() {
    @Override public AstClosedNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstConnectedNode> CONNECTED = new ScriptParseStrategy<AstConnectedNode>() {
    @Override public AstConnectedNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
      return new AstConnectedNodeVisitor(elFactory, elContext).visit(parser.connectedNode());
    }
  };

  public static final ScriptParseStrategy<AstWriteOptionNode, AstAbortedNode> 
<<<<<<< /usr/src/app/output/kaazing/robot/0a20ba6d4542a2224374351137a13f58957bcd54/lang/src/main/java/org/kaazing/k3po/lang/internal/parser/ScriptParseStrategy.java/left.java
  WRITE_CHUNK_EXTENSION_OPTION = new ScriptParseStrategy<AstWriteOptionNode>() {
    @Override public AstWriteOptionNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
      return (AstWriteOptionNode) new AstOptionNodeVisitor(elFactory, elContext).visit(parser.writeOptionHttpChunkExtensionNode());
    }
  }
=======
  ABORTED = new ScriptParseStrategy<AstAbortedNode>() {
    @Override public AstAbortedNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
...
>>>>>>> /usr/src/app/output/kaazing/robot/0a20ba6d4542a2224374351137a13f58957bcd54/lang/src/main/java/org/kaazing/k3po/lang/internal/parser/ScriptParseStrategy.java/right.java
  ...
  public static final ScriptParseStrategy<AstDisconnectedNode> DISCONNECTED = new ScriptParseStrategy<AstDisconnectedNode>() {
    @Override public AstDisconnectedNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstOpenedNode> OPENED = new ScriptParseStrategy<AstOpenedNode>() {
    @Override public AstOpenedNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstReadValueNode> READ = new ScriptParseStrategy<AstReadValueNode>() {
    @Override public AstReadValueNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstReadConfigNode> READ_HTTP_HEADER = new ScriptParseStrategy<AstReadConfigNode>() {
    @Override public AstReadConfigNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstWriteConfigNode> WRITE_HTTP_HEADER = new ScriptParseStrategy<AstWriteConfigNode>() {
    @Override public AstWriteConfigNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
      return new AstWriteConfigNodeVisitor(elFactory, elContext).visit(parser.writeHttpHeaderNode());
    }
  };

  public static final ScriptParseStrategy<AstReadConfigNode> READ_CHUNK_EXTENSION = new ScriptParseStrategy<AstReadConfigNode>() {
    @Override public AstReadConfigNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
      return new AstReadHttpConfigNodeVisitor(elFactory, elContext).visit(parser.readHttpHeaderNode());
    }
  };

  public static final ScriptParseStrategy<AstReadConfigNode> WRITE_CHUNK_EXTENSION = new ScriptParseStrategy<AstReadConfigNode>() {
    @Override public AstReadConfigNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
      return new AstReadHttpConfigNodeVisitor(elFactory, elContext).visit(parser.readHttpHeaderNode());
    }
  };
  ...
  public static final ScriptParseStrategy<AstWriteFlushNode> WRITE_FLUSH = new ScriptParseStrategy<AstWriteFlushNode>() {
    @Override public AstWriteFlushNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstReadClosedNode> READ_CLOSED = new ScriptParseStrategy<AstReadClosedNode>() {
    @Override public AstReadClosedNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstWriteCloseNode> WRITE_CLOSE = new ScriptParseStrategy<AstWriteCloseNode>() {
    @Override public AstWriteCloseNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstUnboundNode> UNBOUND = new ScriptParseStrategy<AstUnboundNode>() {
    @Override public AstUnboundNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstReadAwaitNode> READ_AWAIT = new ScriptParseStrategy<AstReadAwaitNode>() {
    @Override public AstReadAwaitNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstReadNotifyNode> READ_NOTIFY = new ScriptParseStrategy<AstReadNotifyNode>() {
    @Override public AstReadNotifyNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstWriteAwaitNode> WRITE_AWAIT = new ScriptParseStrategy<AstWriteAwaitNode>() {
    @Override public AstWriteAwaitNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstWriteNotifyNode> WRITE_NOTIFY = new ScriptParseStrategy<AstWriteNotifyNode>() {
    @Override public AstWriteNotifyNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstValueMatcher> MATCHER = new ScriptParseStrategy<AstValueMatcher>() {
    @Override public AstValueMatcher parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstExactTextMatcher> EXACT_TEXT_MATCHER = new ScriptParseStrategy<AstExactTextMatcher>() {
    @Override public AstExactTextMatcher parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstExactBytesMatcher> EXACT_BYTES_MATCHER = new ScriptParseStrategy<AstExactBytesMatcher>() {
    @Override public AstExactBytesMatcher parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstRegexMatcher> REGEX_MATCHER = new ScriptParseStrategy<AstRegexMatcher>() {
    @Override public AstRegexMatcher parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstExpressionMatcher> EXPRESSION_MATCHER = new ScriptParseStrategy<AstExpressionMatcher>() {
    @Override public AstExpressionMatcher parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstFixedLengthBytesMatcher> FIXED_LENGTH_BYTES_MATCHER = new ScriptParseStrategy<AstFixedLengthBytesMatcher>() {
    @Override public AstFixedLengthBytesMatcher parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstVariableLengthBytesMatcher> VARIABLE_LENGTH_BYTES_MATCHER = new ScriptParseStrategy<AstVariableLengthBytesMatcher>() {
    @Override public AstVariableLengthBytesMatcher parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
      return new AstVariableLengthBytesMatcherVisitor(elFactory, elContext).visit(parser.variableLengthBytesMatcher());
    }
  };

  public static final ScriptParseStrategy<AstValue> VALUE = new ScriptParseStrategy<AstValue>() {
    @Override public AstValue parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstLiteralTextValue> LITERAL_TEXT_VALUE = new ScriptParseStrategy<AstLiteralTextValue>() {
    @Override public AstLiteralTextValue parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstLiteralBytesValue> LITERAL_BYTES_VALUE = new ScriptParseStrategy<AstLiteralBytesValue>() {
    @Override public AstLiteralBytesValue parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstExpressionValue> EXPRESSION_VALUE = new ScriptParseStrategy<AstExpressionValue>() {
    @Override public AstExpressionValue parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
  ...
  public static final ScriptParseStrategy<AstWriteOptionNode> WRITE_MASK_OPTION = new ScriptParseStrategy<AstWriteOptionNode>() {
    @Override public AstWriteOptionNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
      return (AstWriteOptionNode) new AstOptionNodeVisitor(elFactory, elContext).visit(parser.writeOptionMaskNode());
    }
  };

  public static final ScriptParseStrategy<AstReadConfigNode> READ_CHUNK_TRAILER = new ScriptParseStrategy<AstReadConfigNode>() {
    @Override public AstReadConfigNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
      return new AstReadHttpConfigNodeVisitor(elFactory, elContext).visit(parser.readHttpChunkTrailerNode());
    }
  };

  public static final ScriptParseStrategy<AstWriteConfigNode> WRITE_CHUNK_TRAILER = new ScriptParseStrategy<AstWriteConfigNode>() {
    @Override public AstWriteConfigNode parse(RobotParser parser, ExpressionFactory elFactory, ExpressionContext elContext) throws RecognitionException {
      return (AstWriteConfigNode) new AstWriteConfigNodeVisitor(elFactory, elContext).visit(parser.writeHttpChunkTrailerNode());
    }
  };
  ...
  private static class AstVisitor<T extends java.lang.Object> extends RobotBaseVisitor<T> {
  ...
  private static class AstNodeVisitor<T extends AstNode> extends AstVisitor<T> {
    ...
    @Override protected T defaultResult() {
      return node;
    }
  }
  ...
  private static class AstScriptNodeVisitor extends AstNodeVisitor<AstScriptNode> {
    ...
    @Override public AstScriptNode visitScriptNode(ScriptNodeContext ctx) {
    ...
    @Override public AstScriptNode visitPropertyNode(PropertyNodeContext ctx) {
    ...
    @Override public AstScriptNode visitStreamNode(StreamNodeContext ctx) {
  ...
  private static class AstPropertyNodeVisitor extends AstNodeVisitor<AstPropertyNode> {
    ...
    @Override public AstPropertyNode visitPropertyNode(PropertyNodeContext ctx) {
  ...
  private static class AstStreamNodeVisitor extends AstNodeVisitor<AstStreamNode> {
    ...
    @Override public AstAcceptNode visitAcceptNode(AcceptNodeContext ctx) {
    ...
    @Override public AstAcceptableNode visitAcceptableNode(AcceptableNodeContext ctx) {
    ...
    @Override public AstConnectNode visitConnectNode(ConnectNodeContext ctx) {
  ...
  private static class AstAcceptNodeVisitor extends AstNodeVisitor<AstAcceptNode> {
    ...
    @Override public AstAcceptNode visitServerStreamableNode(ServerStreamableNodeContext ctx) {
  ...
  private static class AstAcceptedNodeVisitor extends AstNodeVisitor<AstAcceptableNode> {
    ...
    @Override public AstAcceptableNode visitStreamableNode(StreamableNodeContext ctx) {
      AstStreamableNodeVisitor visitor = new AstStreamableNodeVisitor(elFactory, elContext);
  ...
  private static class AstConnectNodeVisitor extends AstNodeVisitor<AstConnectNode> {
    ...
    @Override public AstConnectNode visitStreamableNode(StreamableNodeContext ctx) {
      AstStreamableNodeVisitor visitor = new AstStreamableNodeVisitor(elFactory, elContext);
      AstStreamableNode streamableNode = visitor.visitStreamableNode(ctx);
      if (streamableNode != null) {
        node.getStreamables().add(streamableNode);
  ...
  private static class AstStreamableNodeVisitor extends AstNodeVisitor<AstStreamableNode> {
    ...
    @Override public AstBarrierNode visitBarrierNode(BarrierNodeContext ctx) {
    ...
    @Override public AstEventNode visitEventNode(EventNodeContext ctx) {
    ...
    @Override public AstCommandNode visitCommandNode(CommandNodeContext ctx) {
    ...
    @Override public AstOptionNode visitOptionNode(OptionNodeContext ctx) {
  ...
  private static class AstOptionNodeVisitor extends AstNodeVisitor<AstOptionNode> {
    ...
    @Override public AstOptionNode visitReadOptionMaskNode(ReadOptionMaskNodeContext ctx) {
    ...
    @Override public AstOptionNode visitReadOptionOffsetNode(ReadOptionOffsetNodeContext ctx) {
      AstValueVisitor visitor = new AstValueVisitor(elFactory, elContext);
      AstValue value = visitor.visit(ctx);
      childInfos().add(value.getRegionInfo());
      node = new AstReadOptionNode();
    ...
    @Override public AstOptionNode visitWriteOptionMaskNode(WriteOptionMaskNodeContext ctx) {
      AstValueVisitor visitor = new AstValueVisitor(elFactory, elContext);
      AstValue value = visitor.visit(ctx);
      childInfos().add(value.getRegionInfo());
    ...
    @Override public AstOptionNode visitWriteOptionOffsetNode(WriteOptionOffsetNodeContext ctx) {
      AstValueVisitor visitor = new AstValueVisitor(elFactory, elContext);
      AstValue value = visitor.visit(ctx);
      childInfos().add(value.getRegionInfo());
      node = new AstWriteOptionNode();
    ...
    @Override public AstOptionNode visitWriteOptionHttpChunkExtensionNode(WriteOptionHttpChunkExtensionNodeContext ctx) {
      AstValueVisitor visitor = new AstValueVisitor(elFactory, elContext);
      AstValue value = visitor.visit(ctx);
      childInfos().add(value.getRegionInfo());
      node = new AstWriteOptionNode();
    ...
    @Override public AstOptionNode visitReadOptionHttpChunkExtensionNode(ReadOptionHttpChunkExtensionNodeContext ctx) {
      AstValueVisitor visitor = new AstValueVisitor(elFactory, elContext);
      AstValue value = visitor.visit(ctx);
      childInfos().add(value.getRegionInfo());
      node = new AstReadOptionNode();
  ...
  private static class AstBarrierNodeVisitor extends AstNodeVisitor<AstBarrierNode> {
    ...
    @Override public AstReadAwaitNode visitReadAwaitNode(ReadAwaitNodeContext ctx) {
    ...
    @Override public AstReadNotifyNode visitReadNotifyNode(ReadNotifyNodeContext ctx) {
    ...
    @Override public AstWriteAwaitNode visitWriteAwaitNode(WriteAwaitNodeContext ctx) {
    ...
    @Override public AstWriteNotifyNode visitWriteNotifyNode(WriteNotifyNodeContext ctx) {
  ...
  private static class AstEventNodeVisitor extends AstNodeVisitor<AstEventNode> {
    ...
    @Override public AstBoundNode visitBoundNode(BoundNodeContext ctx) {
    ...
    @Override public AstClosedNode visitClosedNode(ClosedNodeContext ctx) {
    ...
    @Override public AstConnectedNode visitConnectedNode(ConnectedNodeContext ctx) {
    ...
    @Override public AstDisconnectedNode visitDisconnectedNode(DisconnectedNodeContext ctx) {
    ...
    @Override public AstOpenedNode visitOpenedNode(OpenedNodeContext ctx) {
    ...
    @Override public AstReadValueNode visitReadNode(ReadNodeContext ctx) {
    ...
    @Override public AstReadClosedNode visitReadClosedNode(ReadClosedNodeContext ctx) {
    ...
    @Override public AstUnboundNode visitUnboundNode(UnboundNodeContext ctx) {
    ...
    @Override public AstReadConfigNode visitReadHttpHeaderNode(ReadHttpHeaderNodeContext ctx) {
    ...
    @Override public AstReadConfigNode visitReadHttpMethodNode(ReadHttpMethodNodeContext ctx) {
      AstReadHttpConfigNodeVisitor visitor = new AstReadHttpConfigNodeVisitor(elFactory, elContext);
    ...
    @Override public AstReadConfigNode visitReadHttpParameterNode(ReadHttpParameterNodeContext ctx) {
      AstReadHttpConfigNodeVisitor visitor = new AstReadHttpConfigNodeVisitor(elFactory, elContext);
    ...
    @Override public AstReadConfigNode visitReadHttpVersionNode(ReadHttpVersionNodeContext ctx) {
      AstReadHttpConfigNodeVisitor visitor = new AstReadHttpConfigNodeVisitor(elFactory, elContext);
    ...
    @Override public AstReadConfigNode visitReadHttpStatusNode(ReadHttpStatusNodeContext ctx) {
      AstReadHttpConfigNodeVisitor visitor = new AstReadHttpConfigNodeVisitor(elFactory, elContext);
  ...
  private static class AstCommandNodeVisitor extends AstNodeVisitor<AstCommandNode> {
    ...
    @Override public AstUnbindNode visitUnbindNode(UnbindNodeContext ctx) {
    ...
    @Override public AstWriteValueNode visitWriteNode(WriteNodeContext ctx) {
    ...
    @Override public AstWriteFlushNode visitWriteFlushNode(WriteFlushNodeContext ctx) {
    ...
    @Override public AstWriteCloseNode visitWriteCloseNode(WriteCloseNodeContext ctx) {
    ...
    @Override public AstCloseNode visitCloseNode(CloseNodeContext ctx) {
    ...
    @Override public AstAbortNode visitAbortNode(AbortNodeContext ctx) {
    ...
    @Override public AstWriteConfigNode visitWriteHttpRequestNode(WriteHttpRequestNodeContext ctx) {
    ...
    @Override public AstWriteConfigNode visitWriteHttpHeaderNode(WriteHttpHeaderNodeContext ctx) {
      AstWriteConfigNodeVisitor visitor = new AstWriteConfigNodeVisitor(elFactory, elContext);
    ...
    @Override public AstWriteConfigNode visitWriteHttpContentLengthNode(WriteHttpContentLengthNodeContext ctx) {
      AstWriteConfigNodeVisitor visitor = new AstWriteConfigNodeVisitor(elFactory, elContext);
    ...
    @Override public AstWriteConfigNode visitWriteHttpHostNode(WriteHttpHostNodeContext ctx) {
      AstWriteConfigNodeVisitor visitor = new AstWriteConfigNodeVisitor(elFactory, elContext);
    ...
    @Override public AstWriteConfigNode visitWriteHttpMethodNode(WriteHttpMethodNodeContext ctx) {
      AstWriteConfigNodeVisitor visitor = new AstWriteConfigNodeVisitor(elFactory, elContext);
    ...
    @Override public AstWriteConfigNode visitWriteHttpParameterNode(WriteHttpParameterNodeContext ctx) {
      AstWriteConfigNodeVisitor visitor = new AstWriteConfigNodeVisitor(elFactory, elContext);
    ...
    @Override public AstWriteConfigNode visitWriteHttpVersionNode(WriteHttpVersionNodeContext ctx) {
      AstWriteConfigNodeVisitor visitor = new AstWriteConfigNodeVisitor(elFactory, elContext);
    ...
    @Override public AstWriteConfigNode visitWriteHttpStatusNode(WriteHttpStatusNodeContext ctx) {
      AstWriteConfigNodeVisitor visitor = new AstWriteConfigNodeVisitor(elFactory, elContext);
  ...
  private static class AstDisconnectNodeVisitor extends AstNodeVisitor<AstDisconnectNode> {
    ...
    @Override public AstDisconnectNode visitDisconnectNode(DisconnectNodeContext ctx) {
  ...
  private static class AstWriteValueNodeVisitor extends AstNodeVisitor<AstWriteValueNode> {
    ...
    @Override public AstWriteValueNode visitWriteValue(WriteValueContext ctx) {
      AstValueVisitor visitor = new AstValueVisitor(elFactory, elContext);
      AstValue value = visitor.visit(ctx);
      node.addValue(value);
      childInfos().add(value.getRegionInfo());
  ...
  private static class AstChildOpenedNodeVisitor extends AstNodeVisitor<AstChildOpenedNode> {
    ...
    @Override public AstChildOpenedNode visitChildOpenedNode(ChildOpenedNodeContext ctx) {
  ...
  private static class AstChildClosedNodeVisitor extends AstNodeVisitor<AstChildClosedNode> {
    ...
    @Override public AstChildClosedNode visitChildClosedNode(ChildClosedNodeContext ctx) {
  ...
  private static class AstAbortedNodeVisitor extends AstNodeVisitor<AstAbortedNode> {
    ...
    @Override public AstAbortedNode visitAbortedNode(AbortedNodeContext ctx) {
  ...
  private static class AstReadValueNodeVisitor extends AstNodeVisitor<AstReadValueNode> {
    ...
    @Override public AstReadValueNode visitMatcher(MatcherContext ctx) {
  ...
  private static class AstValueMatcherVisitor extends AstVisitor<AstValueMatcher> {
    ...
    @Override public AstValueMatcher visitExactTextMatcher(ExactTextMatcherContext ctx) {
    ...
    @Override public AstExactBytesMatcher visitExactBytesMatcher(ExactBytesMatcherContext ctx) {
    ...
    @Override public AstRegexMatcher visitRegexMatcher(RegexMatcherContext ctx) {
    ...
    @Override public AstExpressionMatcher visitExpressionMatcher(ExpressionMatcherContext ctx) {
    ...
    @Override public AstFixedLengthBytesMatcher visitFixedLengthBytesMatcher(FixedLengthBytesMatcherContext ctx) {
    ...
    @Override public AstVariableLengthBytesMatcher visitVariableLengthBytesMatcher(VariableLengthBytesMatcherContext ctx) {
  ...
  private static class AstExactTextMatcherVisitor extends AstVisitor<AstExactTextMatcher> {
    ...
    @Override public AstExactTextMatcher visitExactTextMatcher(ExactTextMatcherContext ctx) {
    ...
    @Override public AstFixedLengthBytesMatcher visitFixedLengthBytesMatcher(FixedLengthBytesMatcherContext ctx) {
      if (ctx.lastIndex != null) {
        ...
        if (ctx.capture != null) {
          ...
          AstFixedLengthBytesMatcher matcher = new AstFixedLengthBytesMatcher(parseInt(lastIndex), captureName, elContext);
          matcher.setRegionInfo(asSequentialRegion(childInfos, ctx));
          return matcher;
        } else {
  ...
  private static class AstLocationLiteralVisitor extends AstVisitor<AstLocationLiteral> {
    ...
    @Override public AstLocationLiteral visitUriValue(UriValueContext ctx) {
  ...
  private static class AstLocationExpressionVisitor extends AstVisitor<AstLocationExpression> {
    ...
    @Override public AstLocationExpression visitExpressionValue(ExpressionValueContext ctx) {
  ...
  private static class AstLocationVisitor extends AstVisitor<AstLocation> {
    ...
    @Override public AstLocation visitUriValue(UriValueContext ctx) {
    ...
    @Override public AstLocation visitExpressionValue(ExpressionValueContext ctx) {
  ...
  private static class AstValueVisitor extends AstVisitor<AstValue> {
    ...
    @Override public AstValue visitLiteralBytes(LiteralBytesContext ctx) {
    ...
    @Override public AstValue visitLiteralText(LiteralTextContext ctx) {
    ...
    @Override public AstValue visitExpressionValue(ExpressionValueContext ctx) {
  ...
  private static class AstLiteralTextValueVisitor extends AstVisitor<AstLiteralTextValue> {
    ...
    @Override public AstLiteralTextValue visitLiteralText(LiteralTextContext ctx) {
      String text = ctx.text.getText();
  ...
  private static class AstLiteralBytesValueVisitor extends AstVisitor<AstLiteralBytesValue> {
    ...
    @Override public AstLiteralBytesValue visitLiteralBytes(LiteralBytesContext ctx) {
  ...
  private static class AstExpressionValueVisitor extends AstVisitor<AstExpressionValue> {
    ...
    @Override public AstExpressionValue visitExpressionValue(ExpressionValueContext ctx) {
  ...
  private static class AstReadHttpConfigNodeVisitor extends AstNodeVisitor<AstReadConfigNode> {
    ...
    @Override public AstReadConfigNode visitMatcher(MatcherContext ctx) {
      AstValueMatcherVisitor visitor = new AstValueMatcherVisitor(elFactory, elContext);
      AstValueMatcher matcher = visitor.visit(ctx);
      if (matcher != null) {
        node.addMatcher(matcher);
    ...
    @Override public AstReadConfigNode visitReadHttpChunkTrailerNode(@NotNull RobotParser.ReadHttpChunkTrailerNodeContext ctx) {
      AstLiteralTextValueVisitor visitor = new AstLiteralTextValueVisitor(elFactory, elContext);
      AstLiteralTextValue value = visitor.visit(ctx.name);
      childInfos().add(value.getRegionInfo());
      node = new AstReadConfigNode();
  ...
  private static class AstWriteConfigNodeVisitor extends AstNodeVisitor<AstWriteConfigNode> {
    ...
    @Override public AstWriteConfigNode visitWriteValue(WriteValueContext ctx) {
      AstValueVisitor visitor = new AstValueVisitor(elFactory, elContext);
      AstValue value = visitor.visit(ctx);
      if (value != null) {
        node.addValue(value);
    ...
    @Override public AstWriteConfigNode visitWriteHttpChunkTrailerNode(RobotParser.WriteHttpChunkTrailerNodeContext ctx) {
      AstValueVisitor visitor = new AstValueVisitor(elFactory, elContext);
      AstValue value = visitor.visit(ctx.name);
      childInfos().add(value.getRegionInfo());
      node = new AstWriteConfigNode();
