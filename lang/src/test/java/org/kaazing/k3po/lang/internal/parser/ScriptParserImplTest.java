...
public class ScriptParserImplTest {
    ...
    public void shouldParseLiteralBytesValue() throws Exception {
        ...
        AstLiteralBytesValue expected = new AstLiteralBytesValue(new byte[]{ 0x1, ((byte) (0xff)), ((byte) (0xfa)) });
        assertEquals(expected, actual);
    }
    ...
    public void shouldParseIntLiteral() throws Exception {
        ...
        ScriptParserImpl parser = new ScriptParserImpl();
        AstExactBytesMatcher actual = parser.parseWithStrategy(scriptFragment, EXACT_BYTES_MATCHER);
        byte[] arr = new byte[]{ 0x0, 0x0, 0x0, 0x5 };
        AstExactBytesMatcher expected = new AstExactBytesMatcher(arr, parser.getExpressionContext());
        assertEquals(expected, actual);
    }
    ...
    public void shouldParseLongLiteral() throws Exception {
        ...
        ScriptParserImpl parser = new ScriptParserImpl();
        AstExactBytesMatcher actual = parser.parseWithStrategy(scriptFragment, EXACT_BYTES_MATCHER);
        byte[] arr = new byte[]{ 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x5 };
        AstExactBytesMatcher expected = new AstExactBytesMatcher(arr, parser.getExpressionContext());
        assertEquals(expected, actual);
    }
    ...
    public void shouldParseVariableLengthBytesMatcher() throws Exception {
        ...
        ValueExpression length = factory.createValueExpression(context, "${len+2}", java.lang.Integer.class);
    ...
    public void shouldParseCapturingVariableLengthBytesMatcher() throws Exception {
        ...
        ExpressionFactory factory = parser.getExpressionFactory();
        ExpressionContext context = parser.getExpressionContext();
        ValueExpression length = factory.createValueExpression(context, "${len-45}", java.lang.Integer.class);
    ...
    public void shouldParseMultiExactBytes() throws Exception {
        ...
        AstReadValueNode actual = parser.parseWithStrategy(scriptFragment, READ);
        AstReadValueNode expected = new AstReadValueNode();
        expected.setMatchers(Arrays.<AstValueMatcher>asList(new AstExactBytesMatcher(new byte[]{ 0x1, ((byte) (0xff)), ((byte) (0xfa)) }, parser.getExpressionContext()), new AstExactBytesMatcher(new byte[]{ 0x0, ((byte) (0xf0)), ((byte) (0x3)), ((byte) (0x5)), ((byte) (0x8)), ((byte) (0x4)) }, parser.getExpressionContext())));
        assertEquals(expected, actual);
        assertEquals(2, actual.getRegionInfo().children.size());
    }
    ...
    public void shouldParseMultVariableLengthBytes() throws Exception {
        ...
        ExpressionFactory factory = parser.getExpressionFactory();
        ExpressionContext context = parser.getExpressionContext();
        ValueExpression value = factory.createValueExpression(context, "${len1}", java.lang.Integer.class);
        ValueExpression value2 = factory.createValueExpression(context, "${len2}", java.lang.Integer.class);
        AstReadValueNode expected = new AstReadValueNode();
        ExpressionContext environment = parser.getExpressionContext();
    ...
    public void shouldParseMultLiteralBytesValue() throws Exception {
        ...
        AstWriteValueNode actual = parser.parseWithStrategy(scriptFragment, WRITE);
        AstWriteValueNode expected = new AstWriteValueNode();
        expected.setValues(Arrays.<AstValue>asList(new AstLiteralBytesValue(new byte[]{ ((byte) (0x1)), ((byte) (0x2)) }), new AstLiteralBytesValue(new byte[]{ ((byte) (0x3)), ((byte) (0x4)) })));
        assertEquals(expected, actual);
        assertEquals(2, actual.getRegionInfo().children.size());
    }
    ...
    public void shouldParseMultAllValue() throws Exception {
        ...
        ValueExpression value1 = factory.createValueExpression(context, "${var1}", byte[].class);
        AstWriteValueNode expected = new AstWriteValueNode();
        expected.setValues(Arrays.<AstValue>asList(new AstLiteralTextValue("Hello"), new AstLiteralBytesValue(new byte[]{ ((byte) (0x1)), ((byte) (0x2)) }), new AstExpressionValue(value1, parser.getExpressionContext())));
        assertEquals(expected, actual);
    ...
    public void shouldParseWriteMultAllValue() throws Exception {
        ...
        ExpressionFactory factory = parser.getExpressionFactory();
        ExpressionContext context = parser.getExpressionContext();
        AstWriteValueNode expected = new AstWriteNodeBuilder().addExactText("Hello").addExactBytes(new byte[]{ 0x1, ((byte) (0x2)) }).addExpression(factory.createValueExpression(context, "${var1}", byte[].class), parser.getExpressionContext()).done();
        assertEquals(expected, actual);
        assertEquals(3, actual.getRegionInfo().children.size());
    }
    ...
    public void shouldParseReadExactByte() throws Exception {
        ...
        ScriptParserImpl parser = new ScriptParserImpl();
        AstReadValueNode actual = parser.parseWithStrategy(scriptFragment, READ);
        AstReadValueNode expected = new AstReadNodeBuilder().addExactBytes(new byte[]{ 0x5 }, parser.getExpressionContext()).done();
        assertEquals(expected, actual);
        assertEquals(1, actual.getRegionInfo().children.size());
    }
    ...
    public void shouldParseReadExactShort() throws Exception {
        ...
        ScriptParserImpl parser = new ScriptParserImpl();
        AstReadValueNode actual = parser.parseWithStrategy(scriptFragment, READ);
        AstReadValueNode expected = new AstReadNodeBuilder().addExactBytes(new byte[]{ 0x0, 0x5 }, parser.getExpressionContext()).done();
        assertEquals(expected, actual);
        assertEquals(1, actual.getRegionInfo().children.size());
    }
    ...
    public void shouldParseReadExactInt() throws Exception {
        ...
        ScriptParserImpl parser = new ScriptParserImpl();
        AstReadValueNode actual = parser.parseWithStrategy(scriptFragment, READ);
        AstReadValueNode expected = new AstReadNodeBuilder().addExactBytes(new byte[]{ 0x0, 0x0, 0x0, 0x5 }, parser.getExpressionContext()).done();
        assertEquals(expected, actual);
        assertEquals(1, actual.getRegionInfo().children.size());
    }
    ...
    public void shouldParseReadExactLong() throws Exception {
        ...
        ScriptParserImpl parser = new ScriptParserImpl();
        AstReadValueNode actual = parser.parseWithStrategy(scriptFragment, READ);
        AstReadValueNode expected = new AstReadNodeBuilder().addExactBytes(new byte[]{ 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x5 }, parser.getExpressionContext()).done();
        assertEquals(expected, actual);
        assertEquals(1, actual.getRegionInfo().children.size());
    }
    ...
    public void shouldParseReadLiteralBytes() throws Exception {
        ...
        ScriptParserImpl parser = new ScriptParserImpl();
        AstReadValueNode actual = parser.parseWithStrategy(scriptFragment, READ);
        AstReadValueNode expected = new AstReadNodeBuilder().addExactBytes(new byte[]{ 0x1, 0x2, ((byte) (0xff)) }, parser.getExpressionContext()).done();
        assertEquals(expected, actual);
        assertEquals(1, actual.getRegionInfo().children.size());
    }
    ...
    public void shouldParseNonClosingConnectScript() throws Exception {
        ...
        AstScriptNode actual = parser.parseWithStrategy(script, SCRIPT);
        AstLocation location7788 = new AstLocationLiteral(URI.create("tcp://localhost:7788"));
        AstScriptNode expected = new AstScriptNodeBuilder().addConnectStream().setLocation(location7788).addConnectedEvent().done().addReadEvent().addExactText("foo").done().addWriteCommand().addExactBytes(new byte[]{ 0x1, 0x2, ((byte) (0xff)) }).done().addClosedEvent().done().done().done();
        assertEquals(expected, actual);
    }
    ...
    @Ignore("Not implemented and perhaps not designed correctly.  " + "Need to access the use and proper syntax for child channels")
    @Test
    ...
    public void shouldParseReadOptionMask() throws Exception {
        ...
        AstReadOptionNode expected = new AstReadOptionNodeBuilder().setOptionName("mask").setOptionValue(new byte[]{ 0x1, 0x2, 0x3, 0x4 }).done();
        assertEquals(expected, actual);
    }
    ...
    public void shouldParseWriteOptionMask() throws Exception {
        ...
        AstWriteOptionNode expected = new AstWriteOptionNodeBuilder().setOptionName("mask").setOptionValue(new byte[]{ 0x1, 0x2, 0x3, 0x4 }).done();
        assertEquals(expected, actual);
    }
    ...
    public void shouldParseNamedPropertyWithLiteralBytes() throws Exception {
        ...
        ScriptParserImpl parser = new ScriptParserImpl();
        AstPropertyNode actual = parser.parseWithStrategy(scriptFragment, PROPERTY_NODE);
        AstPropertyNode expected = new AstPropertyNodeBuilder().setPropertyName("location").setPropertyValue(new byte[]{ 0x0, 0x1, 0x2, 0x3 }).done();
        assertEquals(expected, actual);
    }
    ...
    public void shouldParseNamedPropertyWithExpression() throws Exception {
        ...
        ExpressionContext context = parser.getExpressionContext();
        AstPropertyNode actual = parser.parseWithStrategy(scriptFragment, PROPERTY_NODE);
        ValueExpression expression = factory.createValueExpression(context, "${expression}", java.lang.Object.class);
