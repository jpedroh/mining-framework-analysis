...
public class ParserEventStream extends AbstractParserEventStream {
  ...
  @Override protected boolean lastChild(Parse child, Parse parent) {
  ...
  @Override protected void addParseEvents(List<Event> parseEvents, Parse[] chunks) {
      ...
      if (ci == 0) {
        ...
        if (attachNode != null) {
          if (Parser.ATTACH_DAUGHTER.equals(attachType)) {
            ...
            if (debug) {
              System.err.println("daughter attach a=" + attachNode.getType() + ":" + attachNode + " d=" + daughter + " com=" + lastChild(chunks[ci], rightFrontier.get(attachNodeIndex)));
            }
            ...
            if (Parser.ATTACH_SISTER.equals(attachType)) {
              ...
              if (debug) {
                System.err.println("sister attach a=" + attachNode.getType() + ":" + attachNode + " s=" + sister + " ap=" + attachNode.getParent() + " com=" + lastChild(chunks[ci], rightFrontier.get(attachNodeIndex)));
              }
