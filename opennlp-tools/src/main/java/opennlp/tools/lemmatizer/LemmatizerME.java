...
public class LemmatizerME implements Lemmatizer {
  ...
  public LemmatizerME(LemmatizerModel model) {
    ...
    if (model.getLemmatizerSequenceModel() != null) {
      ...
      this.model = new opennlp.tools.ml.BeamSearch<>(beamSize, (MaxentModel) model.getLemmatizerSequenceModel(), 0);
    }
  }
  ...
  @Override public List<List<String>> lemmatize(List<String> toks, List<String> tags) {
