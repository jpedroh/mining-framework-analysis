...
public class TwoPassDataIndexer extends AbstractDataIndexer {
   ...
   */
  @Deprecated public TwoPassDataIndexer(ObjectStream<Event> eventStream) throws IOException {
    this(eventStream, 0);
  }

  @Deprecated public TwoPassDataIndexer(ObjectStream<Event> eventStream, int cutoff) throws IOException {
   ...
   */
  @Deprecated public TwoPassDataIndexer(ObjectStream<Event> eventStream, int cutoff, boolean sort) throws IOException {
  ...
  @Override public void index(ObjectStream<Event> eventStream) throws IOException {
