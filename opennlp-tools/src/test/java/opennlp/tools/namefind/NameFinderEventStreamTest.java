...
public class NameFinderEventStreamTest {
  private static final String[] SENTENCE = new java.lang.String[]{ "Elise", "Wendel", "appreciated", "the", "hint", "and", "enjoyed", "a", "delicious", "traditional", "meal", "." };
  ...
  void testOutcomesForSingleTypeSentence() throws IOException {
    ...
    try (final ObjectStream<Event> eventStream = new NameFinderEventStream(ObjectStreamUtils.createObjectStream(nameSample), "person", CG, null)) {
