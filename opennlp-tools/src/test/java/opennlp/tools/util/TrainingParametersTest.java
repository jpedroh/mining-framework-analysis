...
public class TrainingParametersTest {
  ...
  @Test public void testSetParamsWithCLIParams() {
    ...
    Assert.assertEquals(50, tr.getIntParameter(TrainingParameters.ITERATIONS_PARAM, TrainingParameters.ITERATIONS_DEFAULT_VALUE));
    Assert.assertEquals(10, tr.getIntParameter(TrainingParameters.CUTOFF_PARAM, TrainingParameters.CUTOFF_DEFAULT_VALUE));
  }
  ...
  @Test public void testSetParamsWithoutCLIParams() {
    ...
    TrainingParameters tr = TrainingParameters.setParams(args);
    Assert.assertEquals("MAXENT", tr.algorithm());
    Assert.assertEquals(100, tr.getIntParameter(TrainingParameters.ITERATIONS_PARAM, TrainingParameters.ITERATIONS_DEFAULT_VALUE));
    Assert.assertEquals(5, tr.getIntParameter(TrainingParameters.CUTOFF_PARAM, TrainingParameters.CUTOFF_DEFAULT_VALUE));
  }
