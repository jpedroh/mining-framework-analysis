...
public class NgramLanguageModelTest {
  @Test public void testEmptyVocabularyProbability() {
    NGramLanguageModel model = new NGramLanguageModel();
    Assertions.assertEquals(0d, model.calculateProbability(""), 0d, "probability with an empty vocabulary is always 0");
    Assertions.assertEquals(0d, model.calculateProbability("1", "2", "3"), 0d, "probability with an empty vocabulary is always 0");
  }
  ...
  @Test public void testRandomVocabularyAndSentence() {
    ...
    Assertions.assertTrue(probability >= 0 && probability <= 1, "a probability measure should be between 0 and 1 [was " + probability + "]");
  }
  ...
  @Test public void testBigramProbability() {
  ...
  @Test public void testSerializedNGramLanguageModel() throws Exception {
  ...
  @Test public void testTrigramLanguageModelCreationFromText() throws Exception {
    int ngramSize = 3;
...
=======
    Assertions.assertNotNull(tokens);
>>>>>>> /usr/src/app/output/apache/opennlp/2b3da98ce263962eb229a0023199ed5286834af1/opennlp-tools/src/test/java/opennlp/tools/languagemodel/NgramLanguageModelTest.java/right.java
