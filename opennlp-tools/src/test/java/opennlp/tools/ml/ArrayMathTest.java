...
public class ArrayMathTest {
  @Test public void testInnerProductDoubleNaN() {
    ...
    Assertions.assertTrue(Double.isNaN(ArrayMath.innerProduct(new double[] { 0, 1, 2 }, new double[] { 0, 1, 2, 3 })));
  }
  ...
  @Test public void testInvL2Norm() {
  ...
  @Test public void testLogSumOfExps() {
  ...
  @Test public void testArgmaxException1() {
    Assertions.assertThrows(IllegalArgumentException.class, () -> {
      ArrayMath.argmax(null);
    });
  }

  @Test public void testArgmaxException2() {
    Assertions.assertThrows(IllegalArgumentException.class, () -> {
  ...
  @Test public void testToDoubleArray() {
    ...
    Assertions.assertArrayEquals(new double[] { 0, 1, -2.5, -0.3, 4 }, ArrayMath.toDoubleArray(Arrays.asList(0D, 1D, -2.5D, -0.3D, 4D)), 0);
  }

  @Test public void testToIntArray() {
    ...
    Assertions.assertArrayEquals(new int[] { 0, 1, -2, -3, 4 }, ArrayMath.toIntArray(Arrays.asList(0, 1, -2, -3, 4)));
  }
}