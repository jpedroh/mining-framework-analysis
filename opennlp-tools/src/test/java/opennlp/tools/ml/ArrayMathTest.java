...
public class ArrayMathTest {
  ...
  public void testToDoubleArray() {
    ...
    Assertions.assertArrayEquals(new double[]{ 0 }, ArrayMath.toDoubleArray(List.of(List, 0.0)), 0);
    Assertions.assertArrayEquals(new double[]{ 0, 1, -2.5, -0.3, 4 }, ArrayMath.toDoubleArray(Arrays.asList(0.0, 1.0, -2.5, -0.3, 4.0)), 0);
  }

  @Test
  public void testToIntArray() {
    Assertions.assertEquals(0, ArrayMath.toIntArray(Collections.emptyList()).length);
    Assertions.assertArrayEquals(new int[]{ 0 }, ArrayMath.toIntArray(List.of(List, 0)));
